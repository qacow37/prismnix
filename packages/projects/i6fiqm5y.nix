...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _lCUXuH7l;
        "pkg-1.0.4" = _ETnGOR3z;
        "pkg-1.16.5-1.2.1" = _asHjrPUs;
        "pkg-1.16.5-1.2.2" = _vNHcLMKs;
        "pkg-1.16.5-1.2.3" = _yoQIrBjn;
        "pkg-1.16.5-1.2.4" = _sXpET8b9;
        "pkg-1.16.5-1.2.5" = _oCgdL86K;
        "pkg-1.19.2-1.2.5" = _sLhB9lnN;
        "pkg-1.20.1-1.2.5" = _xyYnF3G6;
        "pkg-1.20.1-1.2.6" = _iQrlJpTp;
        "pkg-1.19.2-1.2.6" = _yjCOTG42;
        "pkg-1.19.2-1.2.7" = _nleZYm9S;
        "pkg-1.20.1-1.2.7" = _eOqsbEIQ;
        "pkg-1.20.1-1.2.7.1" = _cS1YqodR;
        "pkg-1.21.1-1.2.7" = _6iBfoelO;
        "pkg-1.21.1-1.2.7.1" = _DBJOeEnL;
        "pkg-1.19.2-1.2.8" = _SObSxyt2;
        "pkg-1.21.1-1.2.8" = _ZWhvZIDU;
        "pkg-1.21.1-1.2.9" = _cJ52FVmK;
        "pkg-1.20.1-1.2.10" = _AHKBvlNR;
        "pkg-1.20.1-1.2.10.1" = _JbxK24WC;
        "pkg-1.21.1-1.2.10.1" = _t5XG8MBA;
        "pkg-1.21.1-1.2.10.2" = _CcI8gluH;
        "pkg-1.20.1-1.2.11" = _yUHIQLHo;
        "pkg-1.21.1-1.2.11" = _QosyGmwq;
        "pkg-1.21.1-1.2.11.1" = _XQToSXEO;
        "pkg-1.2.11.1" = _P3RyOqGH;
        "pkg-1.21.1-1.2.11.2" = _ZsKD8ObT;
        "pkg-1.20.1-1.2.11.1" = _XQxu4D0b;
        "pkg-1.2.11.3" = _jCKlMABP;
        "pkg-1.2.11.4" = _VMO1CWO4;
        "pkg-1.2.11.5" = _kPtnViap;
        "pkg-1.2.11.6" = _zqmAj1K7;
        "pkg-1.2.11.6.1" = _XH89ujUq;
        "pkg-1.2.11.6.2" = _XCJNVCRh;
        "pkg-1.3" = _WeSu6O41;
        "pkg-1.3.1" = _wChxnREv;
        "pkg-1.3.2" = _gOYE22Qa;
        "pkg-1.3.3" = _BbIdNbF1;
