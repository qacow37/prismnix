...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.1" = _7JBqHeHf;
        "pkg-1.0.0+1.21.3" = _OdSLQQ8x;
        "pkg-1.0.1+1.21.1" = _tuUQVATB;
        "pkg-1.0.1+1.21.3" = _Bw1PdGbL;
        "pkg-1.0.2+1.21.1" = _RNigN97C;
        "pkg-1.0.2+1.21.3" = _3x3djVux;
        "pkg-1.0.4+1.21.1" = _wVcGdenL;
        "pkg-1.0.4+1.21.3" = _BXvD4I65;
        "pkg-1.1.0+1.21.1" = _5AoTW1Fb;
        "pkg-1.1.1+1.21.1" = _a5Xn631z;
        "pkg-1.1.1+1.21.3" = _W8QD4G4B;
        "pkg-1.1.2+1.21.1" = _qDfxedq3;
        "pkg-1.1.2+1.21.3" = _YbD7exlK;
        "pkg-1.1.3+1.21.1" = _6FVp23Db;
        "pkg-1.1.3+1.21.3" = _zKS3kPuT;
        "pkg-1.1.4+1.21.1" = _BOGSdWlU;
        "pkg-1.1.4+1.21.3" = _VZvC6Zaf;
        "pkg-1.2.0+1.21.1" = _6onJeWnp;
        "pkg-1.2.0+1.21.3" = _K3JedhRD;
        "pkg-1.2.0hf+1.21.3" = _jNMvMkXx;
        "pkg-1.3.0+1.21.1" = _1zmgE9Zo;
        "pkg-1.3.0+1.21.3" = _WqSkfme4;
        "pkg-1.3.1+1.21.1" = _XlMfaM9F;
        "pkg-1.3.1+1.21.3" = _ztGTgKi8;
        "pkg-1.3.2+1.21.1" = _uwmbKiRJ;
        "pkg-1.3.2+1.21.4" = _UznSkSSy;
        "pkg-1.3.3+1.21.1" = _rMFgWDFX;
        "pkg-1.3.3+1.21.4" = _1Xv9JmCt;
        "pkg-1.3.4+1.21.1" = _FTizYj52;
        "pkg-1.3.4+1.21.4" = _hBiFTBiS;
        "pkg-1.3.5+1.21.1" = _S4FqE6SL;
        "pkg-1.3.5+1.21.4" = _oQaI4aR8;
        "pkg-1.4.0+1.21.1" = _oUy29JRS;
        "pkg-1.4.0+1.21.4" = _bTDrV1HU;
        "pkg-1.4.1+1.21.1" = _V2nDenxh;
        "pkg-1.4.1+1.21.4" = _ScnzLKP4;
        "pkg-1.4.2+1.21.1" = _tQjS8BUN;
        "pkg-1.4.2+1.21.4" = _gVQo9tUq;
        "pkg-1.4.3+1.21.1" = _apM3ULtZ;
        "pkg-1.4.3+1.21.4" = _wWPGKua9;
        "pkg-1.4.4+1.21.1" = _1rjvWsWp;
        "pkg-1.4.4+1.21.4" = _GVitoLwV;
        "pkg-2.0.0+1.20.1" = _6Lzt8tQA;
        "pkg-2.0.0+1.21.1" = _e5AddrAE;
        "pkg-2.0.0+1.21.4" = _kRsudAs6;
        "pkg-2.0.1+1.20.1" = _HrdN1LtB;
        "pkg-2.0.1+1.21.1" = _XUx9qogq;
        "pkg-2.0.1+1.21.4" = _Owkh9ld1;
        "pkg-2.1.0+1.21.1" = _bBjEWrXk;
        "pkg-2.1.0+1.20.1" = _SuCRuw50;
        "pkg-2.1.0+1.21.4" = _6t7y66sb;
        "pkg-2.1.1+1.20.1" = _ZW0Txv82;
        "pkg-2.1.1+1.21.1" = _mDwBOU8f;
        "pkg-2.1.1+1.21.4" = _zT7AIy3H;
        "pkg-2.1.2+1.21.1" = _NlkxKvJu;
        "pkg-2.1.2+1.20.1" = _CbfMURmm;
        "pkg-2.1.2+1.21.4" = _lTxfxRVd;
        "pkg-2.1.3+1.21.4" = _bQKEOtvR;
        "pkg-2.1.3+1.20.1" = _5HIUNrnu;
        "pkg-2.1.3+1.21.1" = _ar1L1W2B;
        "pkg-2.1.4+1.21.4" = _PVrflm2G;
        "pkg-2.1.4+1.21.1" = _kvmn3irE;
        "pkg-2.1.4+1.20.1" = _YgHYADHB;
        "pkg-2.1.5+1.21.4" = _fq0F3s8l;
        "pkg-2.1.5+1.20.1" = _7kx07oEj;
        "pkg-2.1.5+1.21.1" = _phMQhDeY;
        "pkg-2.1.6+1.21.1" = _srM5BLat;
        "pkg-2.1.6+1.20.1" = _aL5Wntzb;
        "pkg-2.1.6+1.21.4" = _tmXRV9wH;
        "pkg-2.2.0+1.21.4" = _btJvRTY0;
        "pkg-2.2.0+1.21.8" = _hAtfja7P;
        "pkg-2.2.0+1.21.1" = _XLs1Egpv;
        "pkg-2.2.0+1.20.1" = _3EMCb4Ro;
        "pkg-2.2.1+1.20.1" = _6fLukzoR;
        "pkg-2.2.1+1.21.4" = _P13XIWOH;
        "pkg-2.2.1+1.21.8" = _U6KlccfQ;
        "pkg-2.2.1+1.21.1" = _GL10XO65;
        "pkg-2.3.0+1.21.1" = _BkJGicQO;
        "pkg-2.3.0+1.21.8" = _3OHcUOqC;
        "pkg-2.3.0+1.20.1" = _XzHTlwfX;
        "pkg-2.3.1+1.21.1" = _LVKd9FhM;
        "pkg-2.3.1+1.21.8" = _fbKIqfQ7;
        "pkg-2.3.2+1.20.1" = _eKpiurC3;
        "pkg-2.3.2+1.21.10" = _vvUAnL1Q;
        "pkg-2.3.2+1.21.1" = _wvzn6r1O;
        "pkg-2.3.3+1.21.10" = _OsVohAr8;
        "pkg-2.3.3+1.21.1" = _xCKs0Hlw;
        "pkg-2.3.4+1.20.1" = _cJ2KSXyc;
        "pkg-2.3.5+1.21.10" = _Ddy3lKQb;
        "pkg-2.3.5+1.21.1" = _tyFJPHza;
        "pkg-2.3.6+1.21.10" = _20SGTOml;
        "pkg-2.3.6+1.21.1" = _CmysSYMR;
        "pkg-2.4.0-beta.1+1.21.1-neoforge" = _jYpozTKX;
        "pkg-2.4.0-beta.1+1.21.10-fabric" = _UJENDJGU;
        "pkg-2.4.0-beta.1+1.21.1-fabric" = _aYXbylxf;
        "pkg-2.4.0-beta.1+1.20.1-fabric" = _n61pJfTz;
        "pkg-2.4.0-beta.1+1.21.10-neoforge" = _PPRE4yYH;
        "pkg-2.4.0-beta.2+1.21.10-neoforge" = _axvlzUW5;
        "pkg-2.4.0-beta.2+1.21.1-neoforge" = _5kz5KXuY;
        "pkg-2.4.0-beta.2+1.21.10-fabric" = _U7rzRDJc;
        "pkg-2.4.0-beta.2+1.20.1-fabric" = _Z5v3Tr4R;
        "pkg-2.4.0-beta.2+1.21.1-fabric" = _6NDhKNQl;
        "pkg-2.4.0-beta.3+1.21.1-neoforge" = _mhfNJkui;
        "pkg-2.4.0-beta.3+1.21.10-fabric" = _3HOPbRYs;
        "pkg-2.4.0-beta.3+1.21.10-neoforge" = _AQ7iDZmi;
        "pkg-2.4.0-beta.3+1.20.1-fabric" = _abQrSCNy;
        "pkg-2.4.0-beta.3+1.21.1-fabric" = _deBLzeXl;
        "pkg-2.4.0-beta.4+1.21.1-neoforge" = _oMZ6IpYL;
        "pkg-2.4.0-beta.4+1.21.10-neoforge" = _jdQqj9mx;
        "pkg-2.4.0-beta.4+1.21.1-fabric" = _1SQnuYGh;
        "pkg-2.4.0-beta.4+1.21.10-fabric" = _m7kOmDVe;
        "pkg-2.4.0-beta.4+1.20.1-fabric" = _6O2himwB;
        "pkg-2.4.0-beta.5+1.21.10-neoforge" = _3fvqqHLn;
        "pkg-2.4.0-beta.5+1.21.1-neoforge" = _IuFUIaK4;
        "pkg-2.4.0-beta.5+1.20.1-fabric" = _rVGx9E0W;
        "pkg-2.4.0-beta.5+1.21.1-fabric" = _UlfvVcjz;
        "pkg-2.4.0-beta.5+1.21.10-fabric" = _uFDW75jv;
        "default" = _uFDW75jv;
    });
