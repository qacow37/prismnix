...
let
    ...
    in {
        ...
        "pkg-0.6.1" = _akgQDz1g;
        "pkg-0.6.2" = _lLL2nkXl;
        "pkg-0.7.0-1.19.2" = _qFMMeotC;
        "pkg-0.7.0-1.19.3" = _SAWUqdoy;
        "pkg-0.7.1-1.19.2" = _SqFs54LZ;
        "pkg-0.7.1-1.19.3" = _LoVD9Jeo;
        "pkg-0.7.1-1.19.4" = _nSu9BzJo;
        "pkg-0.8.0-1.19.4" = _JaHYsT4L;
        "pkg-0.8.0-1.19.3" = _slVBFd5z;
        "pkg-0.8.0-1.19.2" = _1FZuGkxs;
        "pkg-0.8.1-1.20" = _dfKre8Zz;
        "pkg-0.9.0-1.20.1" = _tnqdDHvg;
        "pkg-0.9.1-1.20.1" = _F8gKqRRG;
        "pkg-0.9.2-1.20.1" = _Jy5533lU;
        "pkg-0.9.2-1.19.4" = _W9I1kUqQ;
        "pkg-0.9.2-1.20" = _bXxBWM2V;
        "pkg-0.9.2-1.20.2" = _ue0g7PV6;
        "pkg-1.0.0-beta" = _uyIih5sM;
        "default" = _uyIih5sM;
    });
