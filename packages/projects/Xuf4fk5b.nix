...
let
    ...
    in {
        ...
        "pkg-0.1.2-1.21" = _HcBF1JNF;
        "pkg-0.1.3-1.21.1" = _bpeL06xr;
        "pkg-0.1.3-24w39a" = _qO0IGi1J;
        "pkg-0.1.3-1.21.2-pre1" = _mN90G1zr;
        "pkg-0.1.4-1.21.1" = _bc0TAOH3;
        "pkg-0.1.4-1.21.2" = _SuL0VocM;
        "pkg-0.1.4-1.21.3" = _HJqFAAz7;
        "pkg-0.1.4-1.21.4" = _QUNHxena;
        "pkg-0.1.4-1.20.1" = _sxBQgPnT;
        "pkg-0.1.4-25w02a" = _gtF0UO7B;
        "pkg-0.1.4-25w03a" = _orDSaLTu;
        "pkg-0.1.4-1.21.5" = _o9n1yIrv;
        "pkg-0.1.4-1.21.6" = _rLSOH69a;
        "pkg-0.1.4-1.21.7" = _dPEIBlvT;
        "pkg-0.1.4-1.21.8" = _CzzLRc4S;
        "pkg-0.1.4-1.21.9" = _rgUVHD4z;
        "pkg-0.1.5-1.21.1" = _ojpzQond;
        "pkg-0.1.5-1.21.9" = _hcj5evBX;
        "pkg-0.1.5-1.21.11" = _k8q9TipF;
        "pkg-0.1.6-1.21.1" = _13EE9lsB;
        "pkg-0.2.0-26.1" = _ANvd1xpg;
