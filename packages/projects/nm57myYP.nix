...
let
    ...
    in {
        ...
        "pkg-mc1.16.x-v1.0.2-Hotfix" = _uhwKTSUR;
        "pkg-mc1.18.x-v1.0.2-Hotfix" = _30xX4rnP;
        "pkg-mc1.19.x-v1.0.2" = _j8iPaGUa;
        "pkg-mc1.16.x-v1.0.3" = _2rSyyoXm;
        "pkg-mc1.18.x-v1.0.3" = _TduSIZ0u;
        "pkg-mc1.19.x-v1.0.3" = _Ml0miliW;
        "pkg-mc1.19.x-v1.0.3-Hotfix" = _OAfclAbj;
        "pkg-mc1.19.x-v1.0.4" = _507L78pY;
        "pkg-mc1.18.x-v1.0.4" = _C9b5VmzQ;
        "pkg-mc1.16.5-v1.0.4" = _9bBnkSWi;
        "pkg-mc1.19.3-v1.0.4" = _NwkbdV3T;
        "pkg-mc1.19.2-v1.0.5" = _GkrhXFpJ;
        "pkg-mc1.19.3-v1.0.5" = _OKdAmKX0;
        "pkg-mc1.19.4-v1.0.0" = _NY3PSAva;
        "pkg-mc1.18.2-v1.0.5" = _wUVMQhUL;
        "pkg-mc1.16.5-v1.0.5" = _LOCe2xeT;
        "pkg-mc1.16.5-v1.0.5hotfix" = _hUI2T2nK;
        "pkg-1.0.0-mc1.20" = _blyXB7r0;
        "pkg-1.0.1-mc1.19.4" = _b9QjyAau;
        "pkg-1.0.6-mc1.18.2" = _O6vzBwI8;
        "pkg-1.0.6-mc1.16.5" = _vquU9QfW;
        "pkg-1.0.7-mc1.16.5" = _NAtnNQnL;
        "pkg-1.0.7-mc1.18.2" = _p8BRyiYc;
        "pkg-1.0.6-mc1.19.2" = _pVuf3Lgm;
        "pkg-1.0.2-mc1.19.4" = _ZTm7mGdT;
        "pkg-1.0.1-mc1.20.1" = _BxGSYuDQ;
        "pkg-1.0.0+23H1+Rb0.6.5-mc1.20.1" = _VHqtIIYr;
        "pkg-1.0.0+23H1.1+Rb0.6.5+mc1.20.1" = _8nX1gKG6;
        "pkg-1.0.3-mc1.19.4" = _kKm8XdJv;
        "pkg-1.0.8-mc1.16.5" = _hsVDO8q9;
        "pkg-1.0.7-mc1.19.2" = _Ksl8Edi0;
        "pkg-1.0.3+mc1.20.1" = _1pNPAjey;
        "pkg-1.0.8-mc1.18.2" = _LZEqZhdJ;
        "pkg-1.0.4+mc1.20.1" = _GrFAFtHs;
        "pkg-1.0.5+mc1.20.1" = _s9fmksrN;
        "default" = _s9fmksrN;
    });
