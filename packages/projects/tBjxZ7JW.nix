...
let
    ...
    in {
        ...
        "pkg-1.9.9" = _KVUbLOAq;
        "pkg-1.2.6" = _VjFck4cq;
        "pkg-1.9.10" = _YbLgHBjQ;
        "pkg-1.9.11" = _ZZWR3dp1;
        "pkg-1.9.12" = _4Sg9VBNH;
        "pkg-1.10.0" = _cB4Mlmtj;
        "pkg-1.10.1" = _NtsgJBWu;
        "pkg-1.10.2" = _m1VhCC3W;
        "pkg-1.10.3" = _aDZAYxIx;
        "pkg-1.10.4" = _sIgo3dj8;
        "pkg-1.10.5" = _KFo4JsUX;
        "pkg-1.10.6" = _FwRBVq5M;
        "pkg-1.11.0" = _4T10wVav;
        "pkg-1.11.1" = _9WJCQbnh;
        "pkg-1.11.2" = _RbyfCrQJ;
        "pkg-1.11.3" = _sozFFGwl;
        "pkg-1.12.0" = _3W6uEYVd;
        "pkg-1.12.1" = _ZrlnNzGR;
        "pkg-1.12.2" = _82HpdG3L;
        "pkg-1.12.3" = _XpxboW0M;
        "pkg-1.12.4" = _Oog1O05l;
        "pkg-1.12.5" = _R5rSFFVA;
        "pkg-1.12.6" = _APNaCeOi;
        "pkg-1.12.7" = _uL9npJTz;
        "pkg-1.12.8" = _Dk0385bM;
        "pkg-1.12.9" = _4R50XoBC;
