...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _B4qrQLUI;
        "pkg-1.0.9" = _xCu8B0DG;
        "pkg-1.0.10" = _ovcwedXh;
        "pkg-1.0.11" = _tUi984cK;
        "pkg-2.0.0" = _mTjBgiDb;
        "pkg-2.0.1" = _qmWCUMmu;
        "pkg-2.0.2" = _vk0yBdV3;
        "pkg-2.0.3" = _uAllEzq6;
        ...
        "pkg-2.0.5" = _wm0Wuhdo;
        "pkg-1.11" = _9sk3Ji4h;
        "pkg-2.0.5.6" = _mgMRdjBW;
        "pkg-2.0.5.7" = _8mioeRHL;
        "pkg-2.0.5.8" = _v9bqmQoC;
        "pkg-2.0.5.14" = _6L0WhmZD;
        "pkg-1.1.1.19" = _52NV0fxK;
        "pkg-1.1.1.21" = _JsFLxjwp;
        "pkg-2.0.5.26" = _Nxl4BZxO;
        "pkg-3.0.0.33" = _xPnDTUsZ;
        "pkg-3.0.0.35" = _UG6FyGet;
        "pkg-2.1.0.36" = _o9vbbOuk;
        "pkg-3.0.0.37" = _hqP1fEnX;
        "pkg-3.0.0.38" = _ILhAO51M;
        "pkg-2.1.0.39" = _8czJjzbN;
        "pkg-3.0.0.40" = _tpyoKMZH;
        "pkg-3.0.0.41" = _GnOkiHfY;
        "pkg-3.0.0.42" = _mcIngxPn;
        "pkg-3.0.0.43" = _Pl8MTNJp;
        "pkg-3.0.0.44" = _4PtQzElW;
        "pkg-3.0.0.45" = _7vAV5pdI;
        "pkg-3.0.0.46" = _EJVRCpIz;
        "pkg-2.1.0.47" = _ucDYKPHg;
        "pkg-3.0.0.48" = _j1vkqczD;
        "pkg-3.0.0.49" = _Z9oDDUIO;
        "pkg-3.0.0.50" = _p896WBNs;
        "pkg-2.1.0.51" = _1QGh4EL2;
        "pkg-3.0.0.52" = _eLuEwrVw;
        "pkg-3.0.0.53" = _WTz1u4Bj;
        "pkg-3.0.0.54" = _H0mp2ZL5;
        "pkg-1.1.1.55" = _i6ZLBp11;
        "pkg-3.0.0.56" = _7TAmCSVK;
        "pkg-3.0.0.57" = _IWG6CQTl;
        "pkg-3.0.0.58" = _R5uoayXz;
        "pkg-3.0.0.59" = _u20yMFjN;
        "pkg-3.0.0.60" = _6OGPjq0u;
        "pkg-2.1.0.61" = _3YfxdLcp;
        "pkg-3.0.0.62" = _fdOmYAlF;
        "pkg-2.1.0.63" = _QFN0fnfo;
        "pkg-3.0.0.64" = _QIeuUMB6;
        "pkg-2.1.0.65" = _rVR7XpTd;
        "pkg-1.1.1.66" = _8c0gHDpR;
        "pkg-3.0.0.67" = _1opDWHkX;
        "pkg-3.0.0.68" = _wXqOtOyA;
        "pkg-3.0.0.69" = _7MNvKFXQ;
        "pkg-3.0.0.70" = _OMHZ7HWa;
        "pkg-3.0.0.71" = _8M3buMmw;
        "pkg-3.0.0.72" = _kcBhCggx;
        "pkg-3.1.0.73" = _vfH0DZs5;
        "pkg-3.1.0.82" = _KinOF2Gi;
        "pkg-3.1.0.83" = _l8fond7n;
        "pkg-3.1.0.84" = _kJyQFhEB;
        "pkg-3.1.0.85" = _jxvAV46b;
        "pkg-3.1.0.86" = _B2GCbHoV;
        "pkg-3.1.0.87" = _bW6Iv3ow;
        "pkg-3.1.0.88" = _hmdHhlfF;
        "pkg-3.1.0.89" = _nPzn2j0r;
        "pkg-3.1.0.90" = _Zdb1p8dT;
        "pkg-3.1.0.91" = _WrAwOe9C;
        "pkg-3.1.0.93" = _FLwlDqZ2;
        "pkg-3.1.0.94" = _bVXveBmN;
        "pkg-3.1.0.95" = _1zCghgQ7;
        "pkg-3.1.0.96" = _O6yJzmku;
        "pkg-3.1.0.97" = _E0vIVEUd;
        "pkg-3.1.0.100" = _uonW0DJl;
        "pkg-3.1.0.101" = _JZHtssqQ;
        "pkg-3.1.0.102" = _zTCv9lTg;
        "pkg-3.1.0.103" = _s5ozEGWP;
        "pkg-3.1.0.104" = _cqoH6xqZ;
        "pkg-3.1.0.105" = _7I7X89ll;
        "pkg-3.1.0.106" = _Tgn0FNEX;
        "pkg-3.1.0.107" = _PcqeLgJf;
        "pkg-3.1.0.108" = _K2RtTHkA;
        "pkg-3.1.0.109" = _2NwS4Ey3;
        "pkg-3.1.0.110" = _xoEP4fCI;
        "pkg-3.1.0.111" = _DOt7AaXF;
        "pkg-3.1.0.112" = _dpo60Ds1;
        "pkg-3.1.0.113" = _J0JptMY8;
        "pkg-3.1.0.114" = _E2O8HYYO;
        "pkg-3.1.0.115" = _700E1SHP;
        "pkg-3.1.0.116" = _DUxifcMy;
        "pkg-3.1.0.117" = _FEQb2mIa;
        "pkg-3.1.0.118" = _yZDLmYvv;
        "pkg-3.1.0.119" = _m1CT5ndk;
        "pkg-3.1.0.120" = _2OKSljbp;
        "pkg-3.1.0.121" = _ueEWjKeD;
        "pkg-3.1.0.122" = _4jo7mNAE;
        "pkg-3.1.0.123" = _K1YDubix;
        "pkg-3.1.0.124" = _6qaduaV1;
        "pkg-3.1.0.125" = _bhrNtWXh;
        "pkg-3.1.0.126" = _ofkyG6Hh;
        "pkg-3.1.0.127" = _ysaTtIvX;
        "pkg-3.1.0.128" = _JkHFzGYS;
        "pkg-3.1.0.129" = _KiFl2AQI;
        "pkg-3.1.0.132" = _BTpsjNzy;
        "pkg-3.1.0.133" = _smNTXu05;
        "pkg-3.1.0.135" = _rmrai302;
        "pkg-3.1.0.136" = _uRwyTWVY;
        "pkg-3.1.0.137" = _p2PkcG34;
        "pkg-3.1.0.138" = _ZIHF7Qck;
        "pkg-3.1.0.139" = _ujzbyfMe;
        "pkg-3.1.0.140" = _OS2Tlxxj;
        "pkg-3.1.0.141" = _QWJ0uEnl;
        "pkg-4.0.0.8" = _DqeQXhCo;
        "pkg-4.0.0.9" = _8vzhJh1e;
        "pkg-4.0.1.10" = _j4KhYBTp;
        "pkg-4.0.1.11" = _I3An1C30;
        "pkg-4.0.1.12" = _kUe6mThM;
        "pkg-4.0.1.13" = _RLNKVR5z;
        "pkg-4.0.1.14" = _GQusCPXa;
        "pkg-4.0.1.15" = _ov07j8Cr;
        "pkg-4.0.1.19" = _fFFu91Ai;
        "pkg-4.0.1.20" = _QuciUCp0;
        "pkg-4.0.1.21" = _XNrAEvQq;
        "pkg-4.0.1.22" = _MRvXHkxW;
        "pkg-4.0.1.23" = _gRu71tmR;
        "pkg-4.0.1.8" = _5CMhMIXn;
        "pkg-4.1.0.9" = _qWhRJofs;
        "pkg-5.0.0.10" = _sC1BFEDY;
        "pkg-5.0.0.11" = _6UwdObiz;
        "pkg-5.0.0.13" = _HsvL93IP;
        "pkg-5.0.0.14" = _UW8i74Bj;
        "pkg-5.0.0.15" = _6JXM4CIC;
        "pkg-5.0.0.16" = _C02SIOyu;
        "pkg-5.0.0.17" = _yQRlRAad;
        "pkg-5.0.0.18" = _pe2EH7lo;
        "pkg-5.0.0.19" = _7RHsekI6;
        "pkg-5.0.0.21" = _FBqdPlXh;
        "pkg-5.0.0.22" = _9Cm0QLdm;
        "pkg-5.0.0.23" = _HWSbQfWy;
        "pkg-5.0.0.25" = _nr9f2wFy;
        "pkg-5.0.0.26" = _WGPIJyHB;
        "pkg-5.0.0.27" = _3ZWqXG0b;
        "pkg-5.0.0.28" = _wAQivdgp;
        "pkg-5.0.0.29" = _S7JachUx;
        "pkg-5.0.0.30" = _CiPYQQ3o;
        "pkg-5.0.0.31" = _EvOKA54y;
        "pkg-5.0.0.32" = _mt1teTjQ;
        "pkg-5.0.0.33" = _4bwuvBcn;
        "pkg-5.0.0.34" = _Kh0UfozY;
        "pkg-5.0.0.35" = _DT84Y5Dz;
        "pkg-5.0.0.36" = _6O1pVG7N;
        "pkg-5.0.0.37" = _mj5xo9us;
        "pkg-5.0.0.38" = _dtJISta8;
        "pkg-5.0.0.39" = _J1R9CctR;
        "pkg-5.0.0.40" = _jWOqA2Qe;
        "pkg-5.0.0.41" = _VhWkh4BT;
        "pkg-5.0.0.42" = _o8LrzxPt;
        "pkg-5.0.0.43" = _k7kbHBtD;
        "pkg-5.0.0.44" = _lMIUTYHk;
        "pkg-5.0.0.45" = _xmfQ7dNe;
        "pkg-6.0.0.49" = _hV1kNUqW;
        "pkg-6.0.0.50" = _ZjMn5NHt;
        "pkg-6.0.0.51" = _7vp7odRa;
        "pkg-6.0.0.52" = _Bk26WL0i;
        "pkg-6.0.0.53" = _yvd6RFkk;
        "pkg-6.0.0.54" = _yzVfX3wM;
        "pkg-6.0.0.55" = _CAV8fD3w;
        "pkg-6.0.0.56" = _vVFtQAh9;
        "pkg-6.0.0.57" = _EzUsk6Fx;
        "pkg-6.0.0.58" = _Bj1wutMx;
        "pkg-6.0.0.59" = _iZExQhNv;
        "pkg-6.0.0.60" = _cAipv715;
        "pkg-6.0.0.61" = _WOovOXqU;
        "pkg-6.0.0.62" = _Y3b5UYRx;
        "pkg-6.0.0.63" = _gjQvnkRt;
        "pkg-6.0.0.64" = _ABDwpdqx;
        "pkg-6.0.0.65" = _PZjYJC6W;
        "pkg-6.0.0.66" = _OoOJQT6E;
        "pkg-6.0.0.67" = _txkhh4ca;
        "pkg-6.0.0.68" = _dZhg4WZX;
        "pkg-7.0.0.69" = _6p20Qecf;
        "pkg-7.0.0.70" = _XsJcHXQR;
        "pkg-7.0.0.71" = _i8o1huNu;
        "pkg-7.0.0.72" = _LevXrrpI;
        "pkg-7.0.0.73" = _9y5RMfoL;
        "pkg-8.0.0.74" = _WclELULx;
        "pkg-8.0.0.75" = _7H4YpoZ4;
        "pkg-8.0.0.76" = _18qkWaXx;
        "pkg-8.0.0.77" = _ATyaua4e;
        "pkg-8.0.0.78" = _lVYKR10d;
        "pkg-8.1.0.79" = _LqaYmtEj;
        "pkg-8.1.0.80" = _HiojHCPQ;
        "pkg-8.1.0.81" = _LziXFiTs;
        "pkg-8.1.0.82" = _uoke8VFp;
        "pkg-8.1.0.83" = _we5l5Lfg;
        "pkg-8.1.0.84" = _XfLWbxHB;
        "pkg-8.1.0.85" = _NMFVxws2;
        "pkg-8.1.0.86" = _hQranH1O;
        "pkg-8.1.0.87" = _gzQvnZgm;
        "pkg-8.1.0.88" = _gdaLIw0u;
        "pkg-8.1.0.89" = _9VQdanQ2;
        "pkg-8.2.0.90" = _obhyz0qG;
        "pkg-9.0.0.91" = _OxlNkfBh;
        "pkg-9.0.0.92" = _TKG1YYIA;
        "pkg-9.0.0.93" = _ofTAiQYC;
        "pkg-9.0.0.94" = _ldxBE3qf;
        "pkg-9.0.0.95" = _brPwxPkV;
        "pkg-9.0.0.96" = _40SuKdWl;
        "pkg-9.1.0.97" = _dCdHtM1G;
        "pkg-9.1.0.98" = _4ea90aiT;
        "pkg-9.1.0.99" = _t4D9HHdm;
        "pkg-9.2.0.1" = _dBeb6pE5;
        "pkg-9.2.0.2" = _e2rZDRjl;
        "pkg-9.2.0.3" = _cwF8wuua;
        "pkg-9.2.0.4" = _hsdMvmYT;
        "pkg-9.2.0.5" = _kdR2dfhR;
        "pkg-9.2.0.6" = _8oxT8cyB;
        "pkg-9.2.0.7" = _aydw6CIU;
        "pkg-9.2.0.8" = _ZM5FPtbS;
        "pkg-9.2.0.10" = _j4iuOdzi;
        "pkg-9.2.0.11" = _yhyYYRno;
        "pkg-9.2.0.13" = _4WNOrIi1;
        "pkg-9.2.0.14" = _HcPegfg1;
        "pkg-9.2.0.38" = _DQsCZMfI;
        "pkg-9.2.0.39" = _dyVUOCns;
        "pkg-9.2.0.40" = _kIPserXs;
        "pkg-9.2.0.41" = _PuYO8Blb;
        "pkg-9.2.0.42" = _XDKwOtX7;
        "pkg-9.2.0.43" = _j3JCy7l3;
        "pkg-9.2.0.44" = _zsDpZYuQ;
        "pkg-9.2.0.45" = _ydxKS66G;
        "pkg-9.2.0.46" = _Ab9F54nk;
        "pkg-9.2.0.47" = _vfHuBgZD;
        "pkg-9.2.0.48" = _nsXeliU4;
        "pkg-9.2.0.49" = _aOaQU2WT;
        "pkg-9.2.0.50" = _uBGCowTm;
        "pkg-9.2.0.51" = _cnFo8Hsp;
        "pkg-9.2.0.52" = _UpCKxzY6;
        "pkg-9.2.0.53" = _w8Lwdppt;
        "pkg-9.2.0.54" = _FIMxhDpS;
        "pkg-9.2.0.55" = _F1KEb4bZ;
        "pkg-9.2.0.56" = _BUhHLiG1;
        "pkg-9.2.0.57" = _FoVjUDKm;
        "pkg-9.2.0.58" = _nvjruXAx;
        "pkg-9.2.0.59" = _yFNoAztE;
        "pkg-9.2.0.60" = _lDawZUqA;
        "pkg-9.2.0.61" = _b4HLMjtB;
        "pkg-9.2.0.62" = _8nQ0Ms4y;
        "pkg-9.2.0.63" = _ni4YEpjH;
        "pkg-9.2.0.64" = _Ax5t4PvX;
        "pkg-9.2.0.65" = _GeKi20d0;
        "pkg-9.2.0.66" = _LT7lL28P;
        "pkg-9.2.0.67" = _5uHCmMZR;
        "pkg-9.2.0.68" = _mP3LkdIJ;
        "pkg-9.2.0.69" = _4Z1uWLtE;
        "pkg-9.2.0.70" = _CVAASDEM;
        "pkg-9.2.0.71" = _Ezn3lmNB;
        "pkg-9.2.0.72" = _NOMI8Ezi;
        "pkg-9.2.0.73" = _PrMvSR2R;
        "pkg-9.2.0.74" = _bkGwBB1C;
        "pkg-9.2.0.75" = _COA85Zmo;
        "pkg-9.2.0.76" = _50iwkbwK;
        "pkg-9.2.0.77" = _K7wp7XhP;
        "pkg-9.2.0.78" = _5faALO51;
        "pkg-9.2.0.79" = _vvuwEbnN;
        "pkg-9.2.0.80" = _XVTTWuZo;
        "pkg-9.2.0.81" = _w2OS5Z3z;
        "pkg-9.2.0.82" = _ZN3cgKcb;
        "pkg-9.2.0.83" = _K9cOIuu5;
        "pkg-9.2.0.84" = _28fbCmbX;
        "pkg-9.2.0.85" = _TGeZvkRu;
        "pkg-9.2.0.86" = _C6C74vxy;
        "pkg-9.2.0.87" = _mkYovI5S;
        "pkg-9.2.0.88" = _4N1GOK7d;
        "pkg-9.2.0.89" = _e3x8wfUj;
        "pkg-9.2.0.90" = _zgBQL4nh;
        "pkg-9.2.0.91" = _jLbPnnTM;
        "pkg-9.2.0.92" = _GQsK9G1Q;
        "pkg-9.2.0.93" = _FgOLJI1F;
        "pkg-9.2.0.94" = _pv5oJMoD;
        "pkg-9.2.0.95" = _rzp9RbXZ;
        "pkg-9.2.0.96" = _bGv7efrF;
        "pkg-9.2.0.97" = _JJUjZNRl;
        "pkg-9.2.0.98" = _yUONbUPW;
        "pkg-9.2.0.99" = _Oz2RRrD7;
        "pkg-9.2.0.100" = _4AMBhiem;
        "pkg-9.2.0.101" = _at0DfuPp;
        "pkg-9.2.0.102" = _TwTY93WU;
        "pkg-9.2.0.103" = _9axIpdkF;
        "pkg-9.2.0.104" = _qQmr30A5;
        "pkg-9.2.0.105" = _iLX3czp5;
        "pkg-9.2.0.106" = _MxkoNhG4;
        "pkg-9.2.0.108" = _XfinpkEO;
        "pkg-9.2.0.109" = _8DPKX1Bf;
        "pkg-9.2.0.110" = _WlVTd7yG;
        "pkg-9.2.0.111" = _F0mI9Ox3;
        "pkg-9.2.0.112" = _Xr7WjmGu;
        "pkg-9.2.0.113" = _tzIIM01w;
        "pkg-9.2.0.114" = _Cco6GnbP;
        "pkg-9.2.0.115" = _3fSDTnSo;
        "pkg-9.2.0.116" = _UsfAhm9O;
        "pkg-9.2.0.117" = _TdR10iBT;
        "pkg-9.2.0.118" = _NilkuxJY;
        "pkg-9.2.0.119" = _b86ReZrK;
        "pkg-9.2.0.120" = _uU0Dj5d6;
        "pkg-9.2.0.121" = _KZf4nYtv;
        "pkg-9.2.0.122" = _b3omHdcD;
        "pkg-9.2.0.123" = _Tkb8zwv1;
        "pkg-9.2.0.124" = _KQVNSymN;
        "pkg-9.2.0.125" = _hiFTrJN6;
        "pkg-9.2.0.126" = _2rESdP5m;
        "pkg-9.2.0.127" = _ZOXrl0xV;
        "pkg-9.2.0.128" = _lpsFpyWK;
        "pkg-9.2.0.129" = _edMiRQSa;
        "pkg-9.2.0.131" = _OrN6nB8s;
        "pkg-9.2.0.132" = _TnygateO;
        "pkg-9.2.0.133" = _KnKwwIDH;
        "pkg-9.2.0.134" = _A141TFSN;
        "pkg-9.2.0.135" = _3sYDkOaK;
        "pkg-9.2.0.136" = _KJzvIdnP;
        "pkg-9.2.0.137" = _5umrDwhJ;
        "pkg-9.2.0.138" = _sDP2Y5Dk;
        "pkg-9.2.0.139" = _z5RRHzfk;
        "pkg-9.2.0.140" = _DIn137CC;
        "pkg-9.2.0.141" = _GyOKmwNx;
        "pkg-9.2.0.142" = _mxa3Im9A;
        "pkg-9.2.0.143" = _nSiDv3JP;
        "pkg-9.2.0.144" = _TMfdDcWa;
        "pkg-9.2.0.145" = _vpLo4jI8;
        "pkg-9.2.0.146" = _ejDVH1U1;
        "pkg-9.2.0.147" = _m5VnxQgr;
        "pkg-9.2.0.148" = _iScMSzn6;
        "pkg-9.2.0.149" = _wcBWPxjm;
        "pkg-9.2.0.150" = _k1MNWBpE;
        "pkg-9.2.0.151" = _8wTXjRjT;
        "pkg-9.2.0.152" = _yKRwKT9Q;
        "pkg-9.2.0.153" = _ajDnxXRk;
        "pkg-9.2.0.154" = _zUGayqlZ;
        "pkg-9.2.0.155" = _FLMlv1O3;
        "pkg-9.2.0.156" = _fyBa6sbr;
        "pkg-9.2.0.157" = _RSOo7CWv;
        "pkg-9.2.0.158" = _nQmvyISm;
        "pkg-9.2.0.159" = _ck1kw7lJ;
        "pkg-9.2.0.160" = _mAXtW2pb;
        "pkg-9.2.0.161" = _faa1zquI;
        "pkg-9.2.0.162" = _ZNkPfdYj;
        "pkg-9.2.0.163" = _y4zpggCD;
        "pkg-9.2.0.164" = _ZtPwcvSd;
        "pkg-9.2.0.165" = _bozQwhyA;
        "pkg-9.2.0.166" = _31g9mt8f;
        "pkg-9.2.0.167" = _QuwfzXWv;
        "pkg-9.2.0.168" = _uaS00DB6;
        "pkg-9.2.0.169" = _WLP5xfHn;
        "pkg-9.2.0.170" = _jEQh6AFV;
        "pkg-9.2.0.176" = _i8qYAFba;
        "pkg-9.2.0.177" = _zKBjEPjH;
        "pkg-9.2.0.178" = _R8y5Tn29;
        "pkg-9.2.0.179" = _wc4oiBkX;
        "pkg-9.2.0.180" = _tR6QnBNY;
        "pkg-10.0.0.0" = _LXFXXPzQ;
        "pkg-10.0.0.1" = _GNRYxLW8;
        "pkg-10.0.0.2" = _8YR110HE;
        "pkg-10.0.0.3" = _DK11bS8r;
        "pkg-10.0.0.4" = _EW4rvHC8;
        "pkg-10.0.0.5" = _bsfTTi7G;
        "pkg-10.0.0.6" = _aOTjy8Sy;
        "pkg-10.0.0.7" = _uUjhMnpa;
        "pkg-10.0.0.8" = _rERT0l9V;
        "pkg-10.0.0.9" = _dulJKigs;
        "pkg-10.1.0.1" = _O6iJ6sv8;
        "pkg-10.1.0.2" = _S9fgnsGG;
        "pkg-10.0.0.10" = _gKzakhFk;
        "pkg-10.1.0.3" = _ZVlM33uK;
        "pkg-10.1.0.4" = _lhCbDMVV;
        "pkg-10.0.0.11" = _xzRzm9nT;
        "pkg-10.1.0.5" = _JZnCjbch;
        "pkg-10.0.0.12" = _6FU6Ag1x;
        "pkg-10.1.0.7" = _1r3dsPwK;
        "pkg-10.1.0.8" = _J41JHgCI;
        "pkg-10.1.0.9" = _Jgfjh7Y0;
        "pkg-10.1.0.10" = _JUq4kUc0;
        "pkg-10.1.0.11" = _LD5MJetV;
        "pkg-10.1.0.12" = _1wGQsa0w;
        "pkg-9.2.0.171" = _VaFrDMPi;
        "pkg-10.1.0.13" = _mboAbksk;
        "pkg-10.1.0.17" = _8xpAO4GJ;
        "pkg-10.2.0.0" = _AdQUWWjw;
        "pkg-10.4.0.0" = _KnkMlB5a;
        "pkg-10.4.0.1" = _7BnYcgWD;
        "pkg-10.2.0.1" = _LAOOlIdA;
        "pkg-10.4.0.2" = _UmGspWVO;
        "pkg-10.4.0.3" = _Ut7LTr3M;
        "pkg-10.5.0.0" = _XuAAM5EF;
        "pkg-10.5.0.1" = _ViaF3zK0;
        "pkg-10.5.0.2" = _mHHP3OXP;
        "pkg-10.5.0.3" = _GWhJe6Wj;
        "pkg-10.5.0.4" = _hNIbxOj6;
        "pkg-10.5.0.5" = _KKG3ZjAi;
        "pkg-21.7.0.0" = _E2xQPYZD;
        "pkg-21.7.0.1" = _OS7EjShg;
        "pkg-21.8.0.0" = _muh2RQrT;
        "pkg-21.8.0.1" = _RfyLgMDu;
        "pkg-21.8.0.2" = _gSgi8S6P;
        "pkg-21.8.0.3" = _RtYkC5dn;
        "pkg-21.10.0.0" = _s0cgc1Lt;
        "pkg-21.10.0.1" = _Nkrx1cqD;
        "pkg-21.11.0.0" = _X3c4YUvS;
        "pkg-21.11.0.1" = _nhT8xvEt;
        "pkg-21.11.0.2" = _DSAFKXno;
        "pkg-21.11.0.3" = _Q9iXHxOV;
        "pkg-21.11.0.4" = _WPscGvLW;
        "pkg-21.11.0.6" = _vCvDP82P;
        "pkg-21.11.0.8" = _bZ9oibj4;
        "default" = _bZ9oibj4;
    });
