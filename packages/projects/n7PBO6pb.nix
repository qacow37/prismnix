...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.6-forge" = _QS8Ffjpt;
        "pkg-1.18.2-2.6-forge" = _2RjDnjQY;
        "pkg-1.19.2-2.6-forge" = _WkQUgYzt;
        "pkg-1.19.3-2.6-forge" = _pZVy8AbW;
        "pkg-1.18.2-3.0-forge+fabric" = _eqzvEnMO;
        "pkg-1.19.2-3.0-forge+fabric" = _Vkd0J926;
        "pkg-1.19.3-3.0-forge+fabric" = _PRfewnhe;
        "pkg-1.18.2-3.1-forge+fabric" = _GKkuvHaY;
        "pkg-1.19.2-3.1-forge+fabric" = _i6FsqsBI;
        "pkg-1.19.3-3.1-forge+fabric" = _H7l6CnJq;
        "pkg-1.19.4-3.1-forge+fabric" = _OdYbnKdp;
        "pkg-1.20-3.1-forge+fabric" = _z9EUke16;
        "pkg-1.20.1-3.1-forge+fabric" = _Herzzqf5;
        "pkg-1.18.2-3.2-forge+fabric" = _Ug0OEL5J;
        "pkg-1.19.2-3.2-forge+fabric" = _5H5wAD2N;
        "pkg-1.20.1-3.2-forge+fabric" = _CdOs59JS;
        "pkg-1.20.2-3.2-forge+fabric" = _80cj0qUX;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _ZxaE0WFU;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _sPQmRUVJ;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _p2h7VsyB;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _lWZqIfEz;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _jyjly9YS;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _SyODUBto;
        "pkg-1.20.5-3.3-fabric+neo" = _B6cq7swo;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _OZkt1bV9;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _S34ZEn8y;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _I3Xt6W0u;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _sFHNL6Rg;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _alRhJyag;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _QpT9MhLr;
        "pkg-1.21.2-3.4-fabric+neo" = _bWWbtjvc;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _onjMJUIq;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _pDB79QxY;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _ghyoynsj;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _L0uScEG4;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _YtjPenIw;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _3n4jZRr8;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _P36LD0Qh;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _XXkHo97v;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _8LXZ5AW4;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _G85cIf6e;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _BgZZc9TH;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _2DdBKns9;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _9NGr2Ci4;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _TOq5llE3;
