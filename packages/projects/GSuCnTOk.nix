...
let
    ...
    in {
        ...
        "pkg-V.B1.3-1.12.2" = _1w5tOmxi;
        "pkg-V.B1.4-1.12.2" = _TBO7CB0h;
        "pkg-V.B1.0-1.13.2" = _Elvn3ONa;
        "pkg-V.B1.1-1.13.2" = _AFEkkXuF;
        "pkg-V.B1.2-1.13.2" = _DB5J5orJ;
        "pkg-V.B1.3-1.13.2" = _xXL5SOSS;
        "pkg-V.B1.4-1.13.2" = _wQtcnY3I;
        "pkg-V.B1.0-1.14.4" = _4N9wlPMm;
        "pkg-V.B1.1-1.14.4" = _wFKX4WA1;
        "pkg-V.B1.2-1.14.4" = _MnAGKAFu;
        "pkg-V.B1.3-1.14.4" = _auZh8aQg;
        "pkg-V.A0.5" = _qjBlrj0B;
        "pkg-V.A0.6" = _JmPALnHk;
        "pkg-V.A0.7" = _XriPp93k;
        "pkg-V.R1.0-1.15.2" = _u4M0rT5U;
        "pkg-V.R1.0-1.16.5" = _caS49aVC;
        "pkg-V.A0.5-1.17.1" = _5f32hCeL;
        "pkg-V.R1.0-1.17.1" = _qLpAqHFN;
        "pkg-V.R1.0-1.18.1" = _DOay1rUJ;
        "pkg-V.R1.1-1.18.1" = _wg7MXZ2j;
        "pkg-V.R1.2-1.18.1" = _lB4cqAWj;
        "pkg-V.R1.0-1.19-1.19.1" = _YpFh47fp;
        "pkg-V.R1.1-1.19.1-1.19.2" = _oCo4mVhB;
        "pkg-V.R1.1-1.19.4" = _qcuqEGcy;
        "pkg-V.R1.0-1.20-1.20.1" = _edCc04l8;
        "pkg-V.R1.0-1.21.1" = _oytYh4b4;
        "pkg-V.R1.1-1.20.6-1.21.1" = _jN1HbvTS;
        "pkg-V.R1.2-1.20.6-1.21.1" = _bjD5C3ZC;
        "pkg-V.R1.3-1.21.4" = _BUeEsins;
        "pkg-V.R1.3.1-1.21.4" = _UBzmQg9S;
        "pkg-V.R1.3.2-1.21.4" = _ms5PYBp3;
        "pkg-V.R1.3.3-1.21.4" = _mf51Uzlh;
        "pkg-V.R1.4-1.21.5" = _j4LcobAE;
        "pkg-V.R1.4.1-1.21.5" = _lWKXsQ8Q;
        "pkg-V.R1.4.2-1.21.5" = _nuLYbTqg;
        "pkg-V.R1.4.3-1.21.5" = _MqoVhXjU;
        "pkg-1.5" = _GUBBheJA;
        "pkg-1.5.1" = _5WMpFzsh;
        "pkg-1.6" = _Xqp7Ramj;
        "pkg-1.7" = _7vFSub4E;
