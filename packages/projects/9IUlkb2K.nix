...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0-fabric+forge+neo" = _IVM84A8u;
        "pkg-1.19.2-1.1-fabric+forge" = _57Vpwkxg;
        "pkg-1.20.1-1.1-fabric+forge+neo" = _IG7FZCAt;
        "pkg-1.20.2-1.1-fabric+forge+neo" = _v7C8YCFL;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _8z9KumnX;
        "pkg-1.20.5-1.1-fabric+neo" = _2qpWxl0K;
        "pkg-1.20.6-1.1-fabric+forge+neo" = _bMRKgWaJ;
        "pkg-1.21.0-1.1-fabric+forge+neo" = _mr9vWH6d;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _fKktV3dS;
        "pkg-1.20.6-1.2-fabric+forge+neo" = _fUP0bW20;
        "pkg-1.21.0-1.2-fabric+forge+neo" = _fxvByUgS;
        "pkg-1.21.1-1.2-fabric+forge+neo" = _VRwAOcqG;
        "pkg-1.21.2-1.2-fabric+neo" = _eDN8gmzV;
        "pkg-1.21.3-1.2-fabric+forge+neo" = _TbrRI2zc;
        "pkg-1.21.4-1.2-fabric+forge+neo" = _AyMfZOH7;
        "pkg-1.21.5-1.2-fabric+forge+neo" = _x2DpQQLp;
        "pkg-1.21.6-1.2-fabric+forge+neo" = _hUvuBXai;
        "pkg-1.21.7-1.2-fabric+forge+neo" = _Hl4MdbpZ;
        "pkg-1.21.8-1.2-fabric+forge+neo" = _ZkZNnZIo;
        "pkg-1.21.9-1.2-fabric+forge+neo" = _SLgyVl6h;
        "pkg-1.21.10-1.2-fabric+forge+neo" = _XuSP0eDo;
        "pkg-1.21.11-1.2-fabric+forge+neo" = _OvGmGDx9;
        "pkg-26.1.0-1.2-fabric+forge+neo" = _ua3yqxti;
