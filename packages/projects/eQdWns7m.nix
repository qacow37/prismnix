...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.0.0" = _gifCrdc5;
        "pkg-1.18.2-1.0.0" = _qGhq7MlY;
        "pkg-1.16.5-1.1.0" = _Yho64IAL;
        "pkg-1.18.2-1.1.0" = _24AkSvTO;
        "pkg-1.16.5-1.2.0" = _xg7HhJMl;
        "pkg-1.18.2-1.2.0" = _PISpQAOX;
        "pkg-1.16.5-1.2.1" = _D2mJKb5c;
        "pkg-1.18.2-1.2.1" = _4BHFFbIp;
        "pkg-1.19-1.0.0" = _mYTXcFBc;
        "pkg-1.19-1.1.0" = _vdfMr0nU;
        "pkg-1.18.2-1.3.0" = _QKBerJQW;
        "pkg-1.16.5-1.3.0" = _QQA6rqjM;
        "pkg-1.19-1.2.0" = _9ItVcphD;
        "pkg-1.19.1-1.0.0" = _D5ToeRMD;
        "pkg-1.19.2-1.0.0" = _pjhoTDLu;
        "pkg-1.19.3-1.0.0" = _eQmKUwzd;
        "pkg-1.16.5-2.0.0" = _RPYR5o3E;
        "pkg-1.18.2-2.0.0" = _6T19KxtY;
        "pkg-1.16.5-2.0.1" = _v2RQjUO6;
        "pkg-1.18.2-2.0.1" = _LpYwVeIy;
        "pkg-1.19.2-2.0.0" = _UaGEg8Fv;
        "pkg-1.19.3-2.0.0" = _sCFnNVFu;
        "pkg-1.19.4-0.1.0" = _De2yWxcf;
        "pkg-1.19.4-0.2.0" = _miCTeJDK;
        "pkg-1.19.4-0.3.0" = _tedlvKLz;
        "pkg-1.19.2-2.1.0" = _rVGEHjaX;
        "pkg-1.19.3-2.1.0" = _dXs0flGe;
        "pkg-1.18.2-2.1.0" = _Ih9CLio0;
        "pkg-1.19.4-0.3.1" = _mJOfSXKB;
        "pkg-1.16.5-2.1.0" = _MI4YVTuW;
        "pkg-1.18.2-2.1.1" = _4CEgspTu;
        "pkg-1.19.4-0.3.2" = _lODJkzlH;
        "default" = _lODJkzlH;
    });
