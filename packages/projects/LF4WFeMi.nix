...
let
    ...
    in {
        ...
        "pkg-1.7.2+1.20.4" = _o91i7nyL;
        "pkg-1.7.4+1.20.6" = _qJHXzcH2;
        "pkg-1.7.5+1.20.6" = _mn4B0SkM;
        "pkg-1.7.6+1.20.6" = _AiiQTalD;
        "pkg-1.7.7+1.21" = _EjI0PWT6;
        "pkg-1.7.8+1.21.1" = _Qhn0BTK1;
        "pkg-1.7.8+1.21.2" = _YKW2xL0m;
        "pkg-1.7.9+1.21.2" = _lZ0HWYul;
        "pkg-1.7.9+1.21.4" = _Hv5BPLTa;
        "pkg-1.7.11+1.21.5" = _4sk152Rz;
        "pkg-1.7.8.1+1.21.1" = _DVBjPAjW;
        "pkg-1.7.9.1+1.21.2" = _5WhiDUhw;
        "pkg-1.7.9.1+1.21.4" = _AxkW2KfR;
        "pkg-1.7.12+1.21.5" = _Cl6SL5Vh;
        "pkg-1.7.12+1.21.6" = _2vi9wFH0;
        "pkg-1.7.12+1.21.9" = _kTH5v24z;
        "pkg-1.7.12+1.21.11" = _du5p7QLx;
        "pkg-1.7.13+1.21.11" = _DIxVULw5;
        "pkg-1.7.2.1+1.20.1" = _b4c7A6FT;
        "pkg-1.7.2.1+1.20.4" = _fh62rdNA;
        "pkg-1.7.2.1+1.20.2" = _DlFZsLYL;
        "pkg-1.7.6.1+1.20.6" = _sYP3B4Ad;
        "pkg-1.7.8.2+1.21.1" = _1gHymxcJ;
        "pkg-1.7.9.2+1.21.2" = _AitKcLEF;
        "pkg-1.7.9.2+1.21.4" = _xiazc59z;
        "pkg-1.7.12.1+1.21.5" = _V2HCZ1of;
        "pkg-1.7.12.1+1.21.6" = _mmtOmOpN;
        "pkg-1.7.12.1+1.21.9" = _adRCc9w5;
        "pkg-1.7.14+1.21.11" = _WKf16zXo;
        "pkg-1.7.14+26.1" = _6WwGtKvg;
        "pkg-1.7.15+26.1.2" = _WJs1Jed5;
        "pkg-1.7.16+26.1.2" = _mBBA8a9a;
