...
let
    ...
    in {
        ...
        "pkg-2.4.0" = _2AwJq3dr;
        "pkg-2.4.1" = _JMiL5yId;
        "pkg-3.0.0-alpha.1" = _Zim1EM8S;
        "pkg-3.0.0-alpha.2" = _dy6qIjx8;
        "pkg-3.0.0-alpha.3" = _k9i98cTN;
        "pkg-3.0.0-alpha.4" = _cRaW2d65;
        "pkg-3.0.0-beta.1" = _7iDn7ZqP;
        "pkg-3.0.0-beta.2" = _hFQ8Etww;
        "pkg-3.0.0" = _1iZh3NxP;
        "pkg-3.1.0" = _baWvfSNQ;
        "pkg-3.2.0" = _SzXOaleB;
        "pkg-3.3.0" = _zVuktDuN;
