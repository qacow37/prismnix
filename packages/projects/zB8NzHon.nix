...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.0-Fabric" = _PSR2vr4Q;
        "pkg-1.18.2-1.0.0-Forge" = _gZVyyVf3;
        "pkg-1.19-1.0.0-Fabric" = _zv3vcIIZ;
        "pkg-1.19-1.0.0-Forge" = _E0z5LOtB;
        "pkg-1.19.3-1.0.0-Fabric" = _NwWQA8zJ;
        "pkg-1.19.3-1.0.0-Forge" = _LHkUPs6O;
        "pkg-1.18.2-1.1.0-Fabric" = _FjiyNQQq;
        "pkg-1.18.2-1.1.0-Forge" = _HqhOW203;
        "pkg-1.19-1.1.0-Fabric" = _FgGHBaMR;
        "pkg-1.19-1.1.0-Forge" = _H997zAxx;
        "pkg-1.19.3-1.1.0-Fabric" = _cnS7zhMa;
        "pkg-1.19.3-1.1.0-Forge" = _LDJAU8w4;
        "pkg-1.18.2-1.2.0-Fabric" = _kN48AeMX;
        "pkg-1.18.2-1.2.0-Forge" = _Zob11SWX;
        "pkg-1.19-1.2.0-Fabric" = _wMyelsH0;
        "pkg-1.19-1.2.0-Forge" = _d74oQWGN;
        "pkg-1.19.3-1.2.0-Fabric" = _HY2v48rF;
        "pkg-1.19.3-1.2.0-Forge" = _J6e7icVS;
        "pkg-1.19.4-1.2.0-Fabric" = _2xuhTu61;
        "pkg-1.19.4-1.2.0-Forge" = _bUmiyGqo;
        "pkg-1.20.1-1.2.0-Fabric" = _C4L5l0Xg;
        "pkg-1.20.1-1.2.0-Forge" = _tQ052JUQ;
        "pkg-1.20.4-1.2.0-Neoforge" = _ITSLeNx3;
        "pkg-1.20.4-1.2.0-Fabric" = _BaWVaRRA;
        "pkg-1.20.4-1.2.0-Forge" = _QY2udYHI;
        "pkg-1.20.4-1.2.1-NeoForge" = _lwPJfM4v;
        "pkg-1.20.4-1.2.1-Fabric" = _ggNJLADG;
        "pkg-1.20.4-1.2.1-Forge" = _CouJd2LI;
        "pkg-1.20.4-1.2.2-Forge" = _AvhLVU36;
        "pkg-1.20.6-1.2.2-NeoForge" = _5qwNSbS3;
        "pkg-1.20.6-1.2.2-Fabric" = _2hD9Yogx;
        "pkg-1.20.6-1.2.2-Forge" = _8RKcjEgw;
        "pkg-1.21.1-1.2.2-NeoForge" = _fSNgZKeG;
        "pkg-1.21.1-1.2.2-Fabric" = _JDcpl9uP;
        "pkg-1.21.1-1.2.2-Forge" = _RGJZez1k;
        "pkg-1.21.3-1.2.2-NeoForge" = _H1RcH3fN;
        "pkg-1.21.3-1.2.2-Fabric" = _zNVU8reR;
        "pkg-1.21.3-1.2.2-Forge" = _7fGFtE21;
        "pkg-1.18.2-1.2.3-Fabric" = _cPVMw5iP;
        "pkg-1.18.2-1.2.3-Forge" = _TKTUSHee;
        "pkg-1.19-1.2.3-Fabric" = _Z1xiADds;
        "pkg-1.19-1.2.3-Forge" = _IdkVgH7b;
        "pkg-1.19.4-1.2.3-Fabric" = _1deglXNF;
        "pkg-1.19.4-1.2.3-Forge" = _NUcb9F0d;
        "pkg-1.20.4-1.2.3-NeoForge" = _4XDCMLi4;
        "pkg-1.20.4-1.2.3-Fabric" = _moK7SY3j;
        "pkg-1.20.4-1.2.3-Forge" = _h1306PP0;
        "pkg-1.20.6-1.2.3-NeoForge" = _UTkb7ZWe;
        "pkg-1.20.6-1.2.3-Fabric" = _90dXPVuf;
        "pkg-1.20.6-1.2.3-Forge" = _ZwWmVmiv;
        "pkg-1.21.1-1.2.3-NeoForge" = _8PW02w1k;
        "pkg-1.21.1-1.2.3-Fabric" = _uR19vSCt;
        "pkg-1.21.1-1.2.3-Forge" = _JA9De9TD;
        "pkg-1.21.3-1.2.3-NeoForge" = _8HSDBeuI;
        "pkg-1.21.3-1.2.3-Fabric" = _O7l0SbmK;
        "pkg-1.21.3-1.2.3-Forge" = _yurFv4DZ;
        "default" = _yurFv4DZ;
    });
