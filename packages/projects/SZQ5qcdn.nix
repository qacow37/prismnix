...
let
    ...
    in {
        ...
        "pkg-0.6.4" = _fDvMkNrJ;
        "pkg-0.6.5" = _VBvRYDoc;
        "pkg-0.11.1" = _l0X7cvH0;
        "pkg-0.11.2" = _rcOIpEpd;
        "pkg-0.12" = _61PeB7bq;
        "pkg-0.12.1" = _sCgkEPPh;
        "pkg-0.13" = _sIpGGY6I;
        "pkg-0.6.6" = _cMUbc5bf;
        "pkg-0.14" = _tobNnf9b;
        "pkg-0.14.1" = _jkXYgBGq;
        "pkg-0.15-beta.1" = _41KoFjV7;
        "pkg-0.15+1.21.1" = _JasvlYWj;
        "pkg-0.15+1.21.3" = _MYeVazRQ;
        "pkg-0.15.1+1.21.1" = _ZUvCuLHL;
        "pkg-0.15.1+1.21.4" = _AIVbDEUC;
        "pkg-0.15.3+1.21.1" = _7o87J8Qi;
        "pkg-0.15.2+1.21.4" = _UnXB6e5b;
        "pkg-0.15.4+1.21.1" = _Mv9npqMV;
        "pkg-0.15.3+1.21.4" = _Q1OP90eK;
        "pkg-0.15.5+1.21.1" = _bLXJlonN;
        "pkg-0.15.4+1.21.4" = _2jQkZiqP;
        "pkg-0.15.6+1.21.1" = _5m4wAd9c;
        "pkg-0.15.5+1.21.4" = _J28GDrCp;
        "pkg-0.15.6+1.21.5" = _8dVdibCD;
        "pkg-0.15.7+1.21.7" = _uXjQeyPD;
        "pkg-0.15.8+1.21.7" = _4rQhZh8f;
        "pkg-0.16.0+1.21.9" = _HcNzcEb2;
        "pkg-0.16.0+1.21.10" = _a04DRc8r;
        "pkg-0.15.7+1.21.1" = _LlguwEhq;
        "pkg-0.16.1+1.21.10" = _ulvPdglH;
        "pkg-0.16.2+1.21.10" = _vfT6qUjL;
        "pkg-0.15.8+1.21.1" = _yqE0MkKe;
        "pkg-0.16.3+1.21.10" = _u1cZOF9J;
        "pkg-0.15.9+1.21.1" = _FRX2k9aC;
        "pkg-0.16.4+1.21.10" = _KFIwg8jo;
        "pkg-0.16.5+1.21.11" = _cxbTwvca;
        "pkg-0.16.6+1.21.11" = _ZdBhTYPI;
        "pkg-0.16.7+1.21.11" = _8RRzW4s2;
        "pkg-0.15.10+1.21.1" = _Nx8FoZMe;
        "pkg-0.16.8+1.21.11" = _2nDWvc38;
        "pkg-0.16.9+26.1-pre.1" = _mLTExe8L;
        "pkg-0.16.9+26.1" = _bmewKBOl;
        "pkg-0.17.0+26.1" = _lCqCbKMp;
        "pkg-0.18.0+26.1" = _pBwQLSVY;
        "pkg-0.15.11+1.21.1" = _LPSA13Y8;
        "pkg-0.18.1+26.1" = _uv2gyVAr;
