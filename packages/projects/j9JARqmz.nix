...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _h7xOPlj3;
        "pkg-0.1.1" = _7cYwR5Hx;
        "pkg-0.1.2+MC1.18.2" = _sW9UEoRa;
        "pkg-0.1.2+mc1.19" = _AjWVyohU;
        "pkg-0.1.3+MC1.18.2" = _nNYW38z1;
        "pkg-0.1.3+MC1.19" = _BWcQUanY;
        "pkg-0.1.4+MC1.18.2" = _drUL9QnZ;
        "pkg-0.1.4+MC1.19" = _8YFRttJW;
        "pkg-0.1.5+MC1.18.2" = _1SannFio;
        "pkg-0.1.5+MC1.19" = _E8VwVLQv;
        "pkg-0.1.6+MC1.18.2" = _hd64RA1W;
        "pkg-0.1.6+MC1.19" = _JAA7U24q;
        "pkg-0.1.7+MC1.18.2" = _V18of5Y4;
        "pkg-0.1.7+MC1.19.2" = _XWPjBmyD;
        "pkg-0.1.8+MC1.19.2" = _3I797Oek;
        "pkg-0.1.9+MC1.18.2" = _JmWyFGir;
        "pkg-0.1.9+MC1.19.2" = _NUlQP1mh;
        "pkg-0.1.10+MC1.19.2" = _Rrvumk4S;
        "pkg-0.1.10+MC1.18.2" = _44BYdTUj;
        "pkg-0.1.10+mc1.19.3" = _do03Xi1l;
        "pkg-0.1.11+mc.1.19.3" = _G1uTxjzo;
        "pkg-0.1.11+mc.1.19.2" = _rvLCQTKX;
        "pkg-1.0.0-beta.1+mc.1.20.1" = _YuKQDP5d;
        "pkg-1.0.0-beta.2+mc.1.20.1" = _uLevCNPB;
        "pkg-1.0.0-beta.3+mc.1.20.1" = _i70v7pXd;
        "pkg-1.0.0-beta.4+mc.1.20.1" = _vkrmmrFW;
        "pkg-1.0.0+mc.1.20.1" = _Xgwvhj78;
        "pkg-2.0.0+mc.1.20.6" = _jotqdMVb;
        "default" = _jotqdMVb;
    });
