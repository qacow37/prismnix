...
let
    ...
    in {
        ...
        "pkg-2.1" = _MFNWCPQ3;
        "pkg-4.0" = _cm07y2Ps;
        "pkg-3.8-1.19.2" = _SzgN54u3;
        "pkg-4.1-1.19.3" = _ZZ9hoTHY;
        "pkg-3.9-1.19.3" = _RBRXqxV6;
        "pkg-1.19-2.2" = _TWnpfaSN;
        "pkg-1.19.2-3.9" = _rpiJf1XK;
        "pkg-1.19.2-4.1" = _MHQwWwev;
        "pkg-1.19.3-4.2" = _yPGfnhR6;
        "pkg-1.19.3-4.0" = _O5Cc3JhK;
        "pkg-2.3-1.19" = _CILA9uKD;
        "pkg-4.0-1.19.2" = _dKXDN0PQ;
        "pkg-1.19.2-4.2" = _haZJ8HxT;
        "pkg-1.19.3-4.3" = _pRDxNMbv;
        "pkg-1.19.2-4.3" = _3Z7A0yRI;
        "pkg-1.19.3-4.4" = _R3l6knso;
        "pkg-1.19.2-4.4" = _C31G1Wzr;
        "pkg-1.19.3-4.5" = _FJT3tsAI;
        "pkg-1.19.2-4.5-Fabric" = _OSJQcLTo;
        "pkg-1.19.3-4.6-Fabric" = _k6FlO2LV;
        "pkg-1.19.2-4.6" = _2JL6ReVG;
        "pkg-1.19.3-4.7" = _nMW8ByN3;
        "pkg-1.19.2-4.5" = _k3xDz3iE;
        "pkg-1.19.2-4.7" = _kqceH9DW;
        "pkg-1.19.3-4.6" = _1vWa0eiT;
        "pkg-1.19.3-4.8" = _h0z1GtUb;
        "pkg-1.19.2-4.8" = _HzNQ7qG4;
        "pkg-1.19.3-4.9" = _6CxtYVLh;
        "pkg-4.7" = _UxpVSLzO;
        "pkg-1.19.2-4.9" = _SttAk3Cs;
        "pkg-1.19.3-5.0" = _YJryv62d;
        "pkg-1.19.2-5.0" = _mTKMkV1N;
        "pkg-1.19.3-5.1" = _ogEdjGJ9;
        "pkg-1.19.2-5.1" = _O5QHQUVE;
        "pkg-1.19.3-5.2" = _PjTbJblr;
        "pkg-1.19.2-4.9.1" = _E3Jg9aT4;
        "pkg-1.19.2-5.1.1" = _2LKkflBr;
        "pkg-1.19.3-5.0.1" = _uARohb0S;
        "pkg-1.19.3-5.2.1" = _HueTMJbQ;
        "pkg-1.19.2-5.2" = _mU2mh3cJ;
        "pkg-1.19.3-5.3" = _AK5pDAgY;
        "pkg-1.19.4-1.0" = _nY99vWmx;
        "pkg-1.19.2-5.3" = _cLRUnKTl;
        "pkg-1.19.3-5.4" = _UbmI4fi5;
        "pkg-1.19.4-1.1" = _M6fsihKY;
        "pkg-5.2" = _6mmyPYk8;
        "pkg-1.19.2-5.4" = _IQdPTAwN;
        "pkg-1.19.3-5.5" = _hUh8DYuq;
        "pkg-1.2" = _NK94b3vs;
        "pkg-1.19.4-1.2" = _huSDNaie;
        "pkg-1.19.2-5.5" = _dap68yKo;
        "pkg-1.19.3-5.6" = _9vcfXoII;
        "pkg-1.19.4-1.3" = _wCPFpQgO;
        "pkg-1.19.2-5.6" = _P2PCwAnj;
        "pkg-1.19.3-5.7" = _N3or2NSs;
        "pkg-1.19.4-1.4" = _6pwEXJgt;
        "pkg-1.19.2-5.7" = _Hqfo6wp2;
        "pkg-1.19.3-5.8" = _KcYoPUj4;
        "pkg-1.19.4-1.5" = _jJL5ce83;
        "pkg-1.19.2-5.8" = _vkUuoW4K;
        "pkg-1.19.3-5.9" = _UPYO9zjo;
        "pkg-1.19.4-1.6" = _9aKGbWxG;
        "pkg-1.19.2-5.9" = _L3YpG7lK;
        "pkg-1.19.3-6.0" = _83O3BWfH;
        "pkg-1.19.4-1.7" = _31YoMIz7;
        "pkg-1.19.2-5.7.1" = _ozCAXHAH;
        "pkg-1.19.2-5.9.1" = _O1YDk7fK;
        "pkg-1.19.3-5.8.1" = _1Lq627Os;
        "pkg-1.19.3-6.0.1" = _vabEDNFP;
        "pkg-1.19.4-1.7.1" = _aBN9wttL;
        "pkg-1.19.2-6.0" = _N4Eo4MHN;
        "pkg-1.19.3-6.1" = _Jv8yNzr0;
        "pkg-1.19.4-1.8" = _TcbGH5A4;
        "pkg-1.19.2-6.1" = _mdGSXqPY;
        "pkg-1.19.3-6.2" = _ZclyTukD;
        "pkg-1.19.4-1.9" = _NlarvbRv;
        "pkg-1.19.2-6.2" = _oyEjYlWr;
        "pkg-1.19.3-6.3" = _IUIbTQnO;
        "pkg-1.19.4-2.0" = _mNF7Hwqw;
        "pkg-1.19.2-6.3" = _g77DSGv6;
        "pkg-1.19.3-6.4" = _z9TCKewC;
        "pkg-1.19.4-2.1" = _wqzkwWYb;
        "pkg-1.20-1.0" = _GfK4fzEK;
        "pkg-1.19.2-6.4" = _WzomDDoe;
        "pkg-1.19.3-6.5" = _uHnMbsD2;
        "pkg-1.19.4-2.2" = _PZvuvGq8;
        "pkg-1.20-1.1" = _AnH5FTmi;
        "pkg-1.20.1-1.0" = _DI1LnAYz;
        "pkg-1.19.2-6.5" = _MoYbiLzO;
        "pkg-1.19.3-6.6" = _qUu8ek5M;
        "pkg-1.19.4-2.3" = _vn4Csykm;
        "pkg-1.20-1.2" = _5UwjD5HT;
        "pkg-1.20.1-1.1" = _buGHrW9o;
        "pkg-1.19.2-6.6" = _eInKwm1I;
        "pkg-1.19.3-6.7" = _BnGeYiFK;
        "pkg-1.19.4-2.4" = _WdmCMwrd;
        "pkg-1.20-1.3" = _9XF0ZmOk;
        "pkg-1.20.1-1.2" = _adxAG30L;
        "pkg-1.19.2-6.7" = _RzW5jE7Q;
        "pkg-1.19.3-6.8" = _IIOqCD5B;
        "pkg-1.19.4-2.5" = _L486skT2;
        "pkg-1.20-1.4" = _kI3kfOnu;
        "pkg-1.20.1-1.3" = _Aj7XqnDY;
        "pkg-1.19.2-6.8" = _MOwCgXFn;
        "pkg-1.19.3-6.9" = _1J9CyG7M;
        "pkg-1.19.4-2.6" = _Ltr6D3yo;
        "pkg-1.20-1.5" = _yvuB2vx6;
        "pkg-1.20.1-1.4" = _uk0K070J;
        "pkg-1.19.2-6.9" = _OPvZxqHA;
        "pkg-1.19.3-7.0" = _p0cTWvw4;
        "pkg-1.19.4-2.7" = _Z09teozb;
        "pkg-1.20-1.6" = _KbotKsAZ;
        "pkg-1.20.1-1.5" = _sy7NRXTc;
        "pkg-1.19.2-7.0" = _WQAqaVh1;
        "pkg-1.19.3-7.1" = _ItBwTJ5j;
        "pkg-1.19.4-2.8" = _XPUupIjT;
        "pkg-1.20-1.7" = _biY2CXXp;
        "pkg-1.20.1-1.6" = _vHe9azZr;
        "pkg-1.19.2-7.1" = _97qiidUq;
        "pkg-1.19.3-7.2" = _EX0Ot2kZ;
        "pkg-1.19.4-2.9" = _OnflmRP2;
        "pkg-1.20-1.8" = _yM2BuddR;
        "pkg-1.20.1-1.7." = _XXTgi11j;
        "pkg-1.20.1-1.7" = _jDpk6Xz1;
        "pkg-1.19.2-7.2" = _gUJs1s5c;
        "pkg-1.19.3-7.3" = _3j9BMhHT;
        "pkg-1.19.4-3.0" = _WIsgAWI3;
        "pkg-1.20-1.9" = _IOkHPaO6;
        "pkg-1.20.1-1.8" = _mFodfMkB;
        "pkg-1.19.2-7.3" = _FOqjXeC4;
        "pkg-1.19.3-7.4" = _57Pr6aVa;
        "pkg-1.19.4-3.1" = _1GIRgy9w;
        "pkg-1.20-2.0" = _L3cVvtRm;
        "pkg-1.20.1-1.9" = _ZN1gkqFl;
        "pkg-1.19.2-7.4" = _Ss4pmPF1;
        "pkg-1.19.3-7.5" = _Qc4tSQtv;
        "pkg-1.19.4-3.2" = _9skzlfO5;
        "pkg-1.20-2.1." = _oei5TK9R;
        "pkg-1.20-2.1" = _g2IOCfnG;
        "pkg-1.20.1-2.0" = _DgoO47f0;
        "pkg-1.19.2-7.5" = _Ser9cAWE;
        "pkg-1.19.3-7.6" = _BWnXVEdp;
        "pkg-1.19.4-3.3" = _ml4awPGY;
        "pkg-1.20-2.2" = _TuutYVtw;
        "pkg-1.20.1-2.1" = _p66QKtKo;
        "pkg-1.19.2-7.6" = _Ek7kMacZ;
        "pkg-1.20-2.3" = _VCCFLgJ3;
        "pkg-1.20.1-2.2" = _CdBOhLdR;
        "pkg-1.20.2-1.0" = _oLRr65AS;
        "pkg-1.19.2-7.7" = _OvCBWME9;
        "pkg-1.20-2.4" = _zgX2EETa;
        "pkg-1.20.1-2.3" = _9uEmWB9g;
        "pkg-1.20.2-1.1" = _JxLEyB0V;
        "pkg-1.19.2-7.8" = _BxIjDqCj;
        "pkg-1.20-2.5" = _lJiiWEO6;
        "pkg-1.20.1-2.4" = _z1JCT7q3;
        "pkg-1.20.2-1.2" = _S8OkPVXF;
        "pkg-1.19.2-7.9" = _uIS5WMoL;
        "pkg-1.20-2.6" = _7efHrZ7z;
        "pkg-1.20.1-2.5" = _Fyd0F0r0;
        "pkg-1.20.2-1.3" = _GnZvYfSA;
        "pkg-1.19.2-8.0" = _pPxqLmBb;
        "pkg-1.20-2.7" = _4wzMJprx;
        "pkg-1.20.1-2.6" = _RthlL7I7;
        "pkg-1.20.2-1.4" = _OaUb3hVx;
        "pkg-1.19.2-8.1" = _S3FE86ek;
        "pkg-1.20-2.8" = _KraXWCjh;
        "pkg-1.20.1-2.7" = _8b4mOjYu;
        "pkg-1.20.2-1.5" = _pvL32dFw;
        "pkg-1.19.2-8.2" = _q91T5BV9;
        "pkg-1.20.1-2.8" = _mjn7ghyD;
        "pkg-1.20.2-1.6" = _q6VeDkoE;
        "pkg-1.20.4-1.0" = _bv5gHv2t;
        "pkg-1.19.2-8.3" = _8e4f6kpg;
        "pkg-1.20.1-2.9" = _HYQoj3KG;
        "pkg-1.20.2-1.7" = _NWXbM89w;
        "pkg-1.20.4-1.1" = _DYrYvX5l;
        "pkg-8.2" = _AfEwmpX1;
        "pkg-1.19.2-8.4" = _JBkrP7LC;
        "pkg-1.20.1-3.0" = _i1sit5zK;
        "pkg-1.20.2-1.8" = _LUHQcpxJ;
        "pkg-Philips-Ruins1.20.2-1.8" = _N1E2Snn5;
        "pkg-Philips-Ruins1.20.2-1.2" = _41aIRYd5;
        "pkg-1.20.4-1.2" = _JJRxVE6m;
        "pkg-Philips-Ruins1.20.4-1.2" = _wnd9mlvW;
        "pkg-1.19.2-8.2.1" = _RKE8K6VS;
        "pkg-1.19.2-8.4.1" = _TbExHDrM;
        "pkg-1.20.1-3.0.1" = _gNK2oBjq;
        "pkg-1.20.2-1.2.1" = _HQ6sFf0H;
        "pkg-1.20.2-1.8.1" = _S4kxphDB;
        "pkg-1.20.4-1.2.1" = _aW8j90qx;
        "pkg-1.19.2-8.5" = _U3DvcjAr;
        "pkg-1.20.1-3.1" = _J9FqMm0V;
        "pkg-1.20.2-1.9" = _t5Yj680w;
        "pkg-1.20.4-1.3" = _x1jug4GN;
        "pkg-1.19.2-8.6" = _56OjbTXn;
        "pkg-1.20.1-3.2" = _XXpzFBM3;
        "pkg-1.20.2-2.0" = _tYzv5Vc9;
        "pkg-1.20.4-1.4" = _OAUTiYqE;
        "pkg-1.19.2-8.7" = _YtNIWw1H;
        "pkg-1.20.1-3.3" = _8iqb3MV1;
        "pkg-1.20.2-2.1" = _Podcbq6h;
        "pkg-1.20.4-1.5" = _Aqk6rjeg;
        "pkg-1.19.2-8.8" = _JDalTMdG;
        "pkg-1.20.1-3.4" = _dKxorfcO;
        "pkg-1.20.2-2.2" = _GCmPw5Aw;
        "pkg-1.20.4-1.6" = _QDcKmpbK;
        "pkg-1.19.2-8.9" = _Opd0Oscj;
        "pkg-1.20.1-3.5" = _cWTZdO21;
        "pkg-1.20.2-2.3" = _vugWkdJm;
        "pkg-1.20.4-1.7" = _w96if1NM;
        "pkg-1.19.2-9.0" = _7sgVfGzF;
        "pkg-1.20.1-3.6" = _Tk4y7RX3;
        "pkg-1.20.2-2.4" = _FTbtrRsI;
        "pkg-1.20.4-1.8" = _klPuE53O;
        "pkg-1.19.2-9.1" = _szBaxeDq;
        "pkg-1.20.1-3.7" = _rULdtIFq;
        "pkg-1.20.2-2.5" = _sUPbXqC4;
        "pkg-1.20.4-1.9" = _CRiduaGO;
        "pkg-1.19.2-9.2" = _SiiC5CAY;
        "pkg-3.81.20.1-3.8" = _uEHuZaFg;
        "pkg-1.20.1-3.8" = _SZBvy2kB;
        "pkg-1.20.2-2.6" = _s5DVqw7G;
        "pkg-1.20.4-2.0" = _uY5XHdHt;
        "pkg-1.20.6-1.0" = _njyNnfrZ;
        "pkg-1.20.2-2.7" = _lP9FPRxO;
        "pkg-1.20.4-2.1" = _xjWxskNO;
        "pkg-1.20.6-1.1" = _Us0BWeVV;
        "pkg-1.20.1-3.9.1" = _FL8ahBzS;
        "pkg-1.19.2-9.3.1" = _U6qlXGMr;
        "pkg-1.20.2-2.7.1" = _gJiznXm2;
        "pkg-1.20.4-2.1.1" = _Da1cngH7;
        "pkg-1.20.6-1.1.1" = _uPkr4iFC;
        "pkg-1.19.2-9.4" = _y7bKyJIL;
        "pkg-1.20.1-4.0" = _fsJkyOvc;
        "pkg-1.20.2-2.8" = _L9Ldt9XC;
        "pkg-1.20.4-2.2" = _HpMdcsaI;
        "pkg-1.20.6-1.2" = _2BsGAQ7o;
        "pkg-1.21-1.2" = _TDmZ48Cy;
        "pkg-1.19.2-9.3" = _4EADIxzA;
        "pkg-1.19.2-9.5" = _N48tvcls;
        "pkg-1.20.1-4.1" = _GW9mSF7a;
        "pkg-1.20.2-2.9" = _wDhq7YJE;
        "pkg-1.20.4-2.3" = _MclYGcWq;
        "pkg-1.20.6-1.3" = _OxkCMOxr;
        "pkg-1.21-1.3" = _8nNEktkg;
        "pkg-1.19.2-9.6" = _6iyMMRQM;
        "pkg-1.20.1-4.2" = _WNNtAieB;
        "pkg-1.20.2-3.0" = _lrdrfece;
        "pkg-1.20.4-2.4" = _pdrBsupD;
        "pkg-1.20.6-1.4" = _jkOeRu3i;
        "pkg-1.21-1.4" = _MkqWE9nU;
        "pkg-1.19.2-9.7" = _agOTeJ0S;
        "pkg-1.20.1-4.3" = _iPoaQyzw;
        "pkg-1.20.2-3.1" = _3Y0aNOK6;
        "pkg-1.20.4-2.5" = _8GJMDgri;
        "pkg-1.20.6-1.5" = _ZOdsmBG7;
        "pkg-1.21-1.5" = _3pkhK6a9;
        "pkg-1.19.2-9.9" = _NfCSvlFR;
        "pkg-1.20.1-4.4" = _toV4CreW;
        "pkg-1.20.4-2.6" = _4RhJfMC0;
        "pkg-1.20.6-1.6" = _xK9dQjxr;
        "pkg-1.21-1.6" = _Twxz7JNM;
        "pkg-1.21.1-1.6" = _XuPPmaZY;
        "pkg-1.20.1-4.4.1" = _xXzUmeYC;
        "pkg-1.19.2-10.0" = _v0Z34GxZ;
        "pkg-1.20.1-4.5" = _RghQgIDL;
        "pkg-1.20.4-2.7" = _M5KEpzlY;
        "pkg-1.20.6-1.7" = _MgPD8iyc;
        "pkg-1.21-1.7" = _hKg6skNX;
        "pkg-1.21.1-1.7" = _AkhTxac5;
        "pkg-1.21.1-1.7.1" = _ZsaWHEZ5;
        "pkg-1.21-1.7.1" = _6FRBsN2a;
        "pkg-1.19.2-9.8" = _pixxcg0t;
        "pkg-1.19.2-10.1" = _6vEZ3i1y;
        "pkg-1.20.1-4.6" = _jLHLFjce;
        "pkg-1.20.4-2.8" = _PqRVpi8L;
        "pkg-1.20.6-1.8" = _HuA5KEST;
        "pkg-1.21-1.8" = _Yi8MbhNz;
        "pkg-1.21.1-1.8" = _kQ7I8Irq;
        "pkg-1.19.2-10.2" = _ipqMlhQS;
        "pkg-1.20.4-2.9" = _lJH1JGNb;
        "pkg-1.21-1.9" = _oTtpJbfK;
        "pkg-1.21.1-1.9" = _hWBO2GFM;
        "pkg-1.21.3-1.9" = _U7lXDl53;
        "pkg-1.21.4-2.0" = _nihfoTCe;
        "pkg-1.19.2-10.3" = _qL8MJ8zo;
        "pkg-1.20.1-4.8" = _H9o7mbiI;
        "pkg-1.21-2.0" = _LibOaK23;
        "pkg-1.21.3-2.0" = _p0YeNcjq;
        "pkg-1.21.1-2.0" = _EQHGxQAv;
        "pkg-2.0.1" = _gH8PQCwd;
        "pkg-1.21.4-2.0.1" = _GoCntwio;
        "pkg-1.21.4-2.0.2" = _n0B4RmXz;
        "pkg-1.21.4-2.1" = _w6pHqrkh;
        "pkg-1.19.2-10.4" = _rK5D4AAf;
        "pkg-1.20.1-4.9" = _d6lga1k5;
        "pkg-1.19.2-10.5" = _7if6Lqzx;
        "pkg-1.20.1-5.0" = _qrb966v5;
        "pkg-1.19.2-10.6" = _NcpeMaek;
        "pkg-1.20.1-5.1" = _a5LyAtHL;
        "pkg-1.21.4-2.2" = _kXiu2ceH;
        "pkg-1.21.5-2.2" = _YCML63sP;
        "pkg-1.19.2-10.7" = _2KylgTMc;
        "pkg-1.20.1-5.2" = _FkA4xUlT;
        "pkg-1.21-2.1" = _sMCXbllQ;
        "pkg-1.19.2-10.8" = _MeimcfJv;
        "pkg-1.20.1-5.3" = _H7XuSkio;
        "pkg-1.19.2-10.9" = _GhPguxxG;
        "pkg-1.20.1-5.4" = _87ryMdzT;
        "pkg-1.19.2-11.0" = _L6vFeDx4;
        "pkg-1.20.1-5.5" = _O9ZZUNsr;
        "pkg-1.21.6-2.3" = _WKjnah4e;
        "pkg-1.21.6-2.4" = _gEEWSdIM;
        "pkg-1.21.7-2.3" = _zGdJf8MW;
        "pkg-1.21.8-1.0" = _VjJwU68a;
        "pkg-1.19.2-11.1" = _oGcZwMVc;
        "pkg-1.20.1-5.7" = _VbesHzqU;
        "pkg-PhilipsRuins-1.21.11-1.0-Fabric" = _X5XWc1ik;
        "default" = _X5XWc1ik;
    });
