...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _Wcyiwkk8;
        "pkg-1.0.0+mod" = _WfWa7W5Z;
        "pkg-1.1.0" = _byaVcmWw;
        "pkg-1.1.0+mod" = _B27Jdn1h;
        "pkg-1.1.0+legacy" = _WYxx2C6V;
        "pkg-1.1.0+mod+legacy" = _RLvFCnae;
        "pkg-1.1.1" = _rZ9JXMWZ;
        "pkg-1.1.1+mod" = _OLtpSLx7;
        "pkg-1.2.0" = _ZkgXODwQ;
        "pkg-1.2.0+mod" = _Ho1Cb96h;
        "pkg-1.2.1" = _34P8Wlp0;
        "pkg-1.2.1+mod" = _F16FOXz5;
        "pkg-1.2.2" = _VO7FHcYq;
        "pkg-1.2.2+mod" = _FmMnnJfw;
        "pkg-1.3.0" = _yfjLj5MK;
        "pkg-1.3.0+mod" = _cslakmgp;
        "pkg-1.3.1" = _Qo6whabR;
        "pkg-1.3.1+mod" = _6kQgoxtY;
        "pkg-1.3.2" = _OCMDeiMC;
        "pkg-1.3.2+mod" = _vthXuJMV;
        "pkg-1.3.3" = _m4OVQv5L;
        "pkg-1.3.3+mod" = _KqFvKo2a;
        "pkg-1.3.4" = _VOEKTgti;
        "pkg-1.3.4+mod" = _K47ySeCt;
        "pkg-1.4.0" = _w8D6achd;
        "pkg-1.4.0+mod" = _pIl7Bbfy;
        "pkg-1.5.0" = _z4BVxjJL;
        "pkg-1.5.0+mod" = _PrxlFtdl;
        "pkg-1.5.1" = _MRfOWuML;
        "pkg-1.5.1+mod" = _4JRUNVkN;
        "default" = _4JRUNVkN;
    });
