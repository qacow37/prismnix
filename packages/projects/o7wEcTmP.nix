...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _GZsOQZbW;
        "pkg-1.2.0" = _Rlegsr3D;
        "pkg-1.2.1-fabric+mc1.21" = _EEzZCuE3;
        "pkg-1.2.1-fabric+mc1.20.5" = _XlqcUPPb;
        "pkg-1.2.1-fabric+mc1.20" = _epYmprJq;
        "pkg-1.3.0-fabric+mc1.21" = _fT7Ic1T9;
        "pkg-1.3.0-fabric+mc1.17.1" = _PVTyX2OF;
        "pkg-1.3.0-neoforge+mc1.21" = _eupSTmIX;
        "pkg-1.4.0-fabric+mc1.17.1" = _UJ6Hq8vw;
        "pkg-1.4.0-fabric+mc1.20" = _EHrQ4dyY;
        "pkg-1.4.0-fabric+mc1.21" = _GYDPpjnp;
        "pkg-1.4.0-fabric+mc1.21.2" = _ATUlDBHb;
        "pkg-1.4.0-fabric+mc1.21.6" = _kHiWx4fl;
        "pkg-1.4.0-fabric+mc1.21.9" = _39lPYzbT;
        "pkg-1.4.0-fabric+mc26.1" = _QXVXJOek;
        "pkg-1.4.0-neoforge+mc1.21" = _MMn50PzL;
        "pkg-1.4.0-neoforge+mc1.21.2" = _apKHLdSo;
        "pkg-1.4.0-neoforge+mc1.21.6" = _VMmfKuGc;
        "pkg-1.4.0-neoforge+mc1.21.9" = _U5yfFuds;
        "pkg-1.4.0-neoforge+mc26.1" = _u2vLy5lt;
        "pkg-1.4.0-fabric+mc26.2" = _Mc8wnfuR;
        "pkg-1.4.0-neoforge+mc26.2" = _qqX0xeEi;
        "default" = _qqX0xeEi;
    });
