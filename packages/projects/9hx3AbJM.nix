...
let
    ...
    in {
        ...
        "pkg-v4.1.0-1.19.1-Fabric" = _MO6Lug0U;
        "pkg-v4.2.0-1.19.1-Forge" = _M0uDW0Bw;
        "pkg-v4.2.0-1.19.1-Fabric" = _lkyHBlXD;
        "pkg-v4.3.0-1.19.2-Fabric" = _UHPjhPzF;
        "pkg-v4.3.0-1.19.2-Forge" = _9pmlqdhw;
        "pkg-v4.3.1-1.19.2-Fabric" = _uV37wyXD;
        "pkg-v4.3.1-1.19.2-Forge" = _Zaxyw3Mg;
        "pkg-v4.3.2-1.19.2-Fabric" = _8aLDK0o2;
        "pkg-v4.3.2-1.19.2-Forge" = _1MXiOPNu;
        "pkg-v4.3.3-1.19.2-Forge" = _yYI8kLD9;
        "pkg-v4.3.3-1.19.2-Fabric" = _GjLNFYQU;
        "pkg-v5.0.0-1.19.3-Fabric" = _e8DGTLZX;
        "pkg-v5.0.0-1.19.3-Forge" = _sk1CUI3B;
        "pkg-v5.0.1-1.19.3-Fabric" = _lLFRXi9V;
        "pkg-v5.0.1-1.19.3-Forge" = _mLAtBvPu;
        "pkg-v6.0.0-1.19.4-Fabric" = _R7hHOxn3;
        "pkg-v6.0.0-1.19.4-Forge" = _Uv6PKgi7;
        "pkg-v7.0.0-1.20-Forge" = _s3eAd9ch;
        "pkg-v7.0.0-1.20-Fabric" = _UUnGaZnn;
        "pkg-v8.0.0-1.20.1-Forge" = _p7l3vBEe;
        "pkg-v8.0.0-1.20.1-Fabric" = _oAEhMFyC;
        "pkg-v8.0.1-1.20.1-Fabric" = _9Jw4urvo;
        "pkg-v8.0.1-1.20.1-Forge" = _W2xPEG9I;
        "pkg-v20.4.0-1.20.4-Fabric" = _sOgHnxbz;
        "pkg-v20.4.0-1.20.4-NeoForge" = _ApzhLylX;
        "pkg-v20.4.0-1.20.4-Forge" = _LTqzxRKJ;
        "pkg-v21.0.0-1.21-Fabric" = _xG5K1L6j;
        "pkg-v21.0.0-1.21-NeoForge" = _W3oGYo0X;
        "pkg-v21.0.1-1.21-Fabric" = _2GX2kGu1;
        "pkg-v21.0.1-1.21-NeoForge" = _zHVaWHWN;
        "pkg-v21.0.2-1.21-Fabric" = _5RNV4ylW;
        "pkg-v21.0.2-1.21-NeoForge" = _Fbxr96xw;
        "pkg-v21.0.3-1.21-Fabric" = _CgcCuvCO;
        "pkg-v21.0.3-1.21-NeoForge" = _9IUH28sV;
        "pkg-v21.0.4-1.21-Fabric" = _lRBz0IRk;
        "pkg-v21.0.4-1.21-NeoForge" = _VRKcGtpj;
        "pkg-v21.1.0-1.21.1-Fabric" = _tCAHAPQW;
        "pkg-v21.1.0-1.21.1-NeoForge" = _hQ2X894I;
        "pkg-v21.3.0-1.21.3-Fabric" = _Mw2xHUf4;
        "pkg-v21.3.0-1.21.3-NeoForge" = _GmU09ALS;
        "pkg-v21.3.1-1.21.3-Fabric" = _EFCCikxa;
        "pkg-v21.3.1-1.21.3-NeoForge" = _GqmXNfL8;
        "pkg-v21.3.2-1.21.3-Fabric" = _IE3Komex;
        "pkg-v21.3.2-1.21.3-NeoForge" = _KEcTGMjT;
        "pkg-v21.4.0-1.21.4-Fabric" = _PhJ05USB;
        "pkg-v21.4.0-1.21.4-NeoForge" = _hyewXrX1;
        "pkg-v21.4.1-1.21.4-Fabric" = _y2C3V7qg;
        "pkg-v21.4.1-1.21.4-NeoForge" = _xQER0HMY;
        "pkg-v21.5.0-1.21.5-Fabric" = _QQpiapTJ;
        "pkg-v21.5.0-1.21.5-NeoForge" = _lySWUhVt;
        "pkg-v21.6.0-1.21.6-Fabric" = _JctbJ2Ys;
        "pkg-v21.6.0-1.21.6-NeoForge" = _KtqXAVSO;
        "pkg-v21.7.0-1.21.7-Fabric" = _bc0Ywnmx;
        "pkg-v21.7.0-1.21.7-NeoForge" = _7nv3L0W6;
        "pkg-v21.8.0-1.21.8-Fabric" = _HgAK2dAb;
        "pkg-v21.8.0-1.21.8-NeoForge" = _ssOsWuO8;
        "pkg-21.9.0" = _8GLU8Ljf;
        "pkg-21.10.0" = _eIWkFqlv;
        "pkg-v21.1.2-1.21.1-Fabric" = _jXFKyC1V;
        "pkg-v21.1.2-1.21.1-NeoForge" = _kladR4Mf;
        "pkg-v21.1.3-1.21.1-Fabric" = _PeWjgCmW;
        "pkg-v21.1.3-1.21.1-NeoForge" = _ARdNPYag;
        "pkg-v21.1.4-1.21.1-Fabric" = _LLLfoeWJ;
        "pkg-v21.1.4-1.21.1-NeoForge" = _MxbfrOEv;
