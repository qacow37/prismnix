...
let
    ...
    in {
        ...
        "pkg-fabric-0.3" = _AVJ9ZjwW;
        "pkg-forge-0.3" = _u2t1NMDi;
        "pkg-fabric-1.0-1.19.2" = _2zA2BkLM;
        "pkg-forge-1.0-1.19.2" = _V1iJ8qx7;
        "pkg-fabric-1.0-1.20.1" = _pob1DUc7;
        "pkg-forge-1.0-1.20.1" = _ZbfnvOJK;
        "pkg-fabric-1.1-1.20.1" = _mIgyCja6;
        "pkg-forge-1.1-1.20.1" = _nhzOpgtq;
        "pkg-fabric-1.2-1.20.1" = _nc7cIV4L;
        "pkg-forge-1.2-1.20.1" = _VxPZlN4E;
        "pkg-fabric-1.2-1.19.2" = _XvKvnTk0;
        "pkg-forge-1.2-1.19.2" = _k56ck00q;
        "pkg-fabric-1.3-1.20.1" = _wNIyxkDm;
        "pkg-forge-1.3-1.20.1" = _UwyI4jIv;
        "pkg-fabric-1.3-1.19.2" = _qUSY31OW;
        "pkg-forge-1.3-1.19.2" = _PKjP71DG;
        "pkg-fabric-1.4-1.20.1" = _o42cY3cq;
        "pkg-forge-1.4-1.20.1" = _vxcFu8gZ;
        "pkg-fabric-1.5-1.20.1" = _8kwDzRzA;
        "pkg-forge-1.5-1.20.1" = _CM5kznp9;
        "pkg-fabric-1.6-1.20.1" = _vOawa2yG;
        "pkg-forge-1.6-1.20.1" = _9sjD5f0U;
        "pkg-fabric-1.6-1.19.2" = _JJS51fBB;
        "pkg-forge-1.6-1.19.2" = _KGV5lLEz;
        "pkg-fabric-1.7-1.20.1" = _w06BqmQT;
        "pkg-forge-1.7-1.20.1" = _3VKyTYXW;
        "pkg-fabric-1.7-1.19.2" = _fr3HF1nC;
        "pkg-forge-1.7-1.19.2" = _RmREt4sZ;
        "pkg-fabric-1.7.1-1.20.1" = _DeyUv09u;
        "pkg-forge-1.7.1-1.20.1" = _rlWDjKMG;
        "pkg-fabric-1.7.1-1.19.2" = _bvUf0dwH;
        "pkg-forge-1.7.1-1.19.2" = _4ymCZv2B;
        "pkg-2.0-beta" = _cUDp3dhA;
        "pkg-fabric-1.7.2-1.20.1" = _sscO4c1M;
        "pkg-forge-1.7.2-1.20.1" = _uuGz5kjU;
        "pkg-2.1" = _UDnDICqB;
        "pkg-2.2" = _p1bWES0u;
        "pkg-2.2.1" = _ThZNPqDG;
        "pkg-2.2.2" = _iAcy1lM6;
        "pkg-fabric-1.7.3-1.20.1" = _ZUw8Y8R9;
        "pkg-forge-1.7.3-1.20.1" = _GVhIUJHN;
        "pkg-2.3.0" = _RBNxgHr9;
        "pkg-2.3.1" = _Vxur5M9o;
        "pkg-2.3.2" = _P07H5h3F;
        "default" = _P07H5h3F;
