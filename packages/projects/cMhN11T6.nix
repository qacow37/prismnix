...
let
    ...
    in {
        ...
        "pkg-3.4.1" = _Nv7zTZwk;
        "pkg-3.4.4" = _USDFrvI2;
        "pkg-3.6B.0" = _4IJxoPAl;
        "pkg-3.6B.1" = _po8Vckl6;
        "pkg-3.7B.0" = _JcUwp7Jj;
        "pkg-3.7B2.0" = _exLS3w6f;
        "pkg-3.7B5.0" = _zBpqZVEE;
        "pkg-3.7.6.1" = _VDQwIE64;
        "pkg-3.7.15.0" = _E59bULK8;
        "pkg-3.7.16.0" = _ahhHl59d;
        "pkg-3.7.17.0" = _Kr5V250i;
        "pkg-3.8.0.0" = _jyY4Yj29;
        "pkg-3.8.7.4" = _zXm8RsRa;
        "pkg-3.9.0.1" = _R9JJUETY;
        "pkg-3.9.0.3" = _oRnl7QgD;
        "pkg-3.9.1.6" = _1TJVodKH;
        "pkg-3.9.5.6" = _WOO2NjE1;
        "pkg-3.10.2.0" = _MLenw2qw;
        "pkg-3.10.2.2" = _6pkAboGv;
        "pkg-3.10.3.2" = _UaXQ3WSS;
        "pkg-3.10.4.4" = _fR1rkD4M;
        "pkg-3.10.4.6" = _JiIX9OCM;
        "pkg-3.10.9.6" = _rVSTl6yY;
        "pkg-3.10.9.7" = _L4f5h67y;
        "pkg-3.10.12.8" = _hb5Mx2xf;
        "pkg-3.10.15.8" = _5zhjtkmn;
        "pkg-3.10.15.9" = _kOFLvtko;
        "pkg-3.10.15.11" = _99M0nhlm;
        "pkg-3.10.16.11" = _cXwzF4MO;
        "pkg-3.10.17.14" = _exIIbX3k;
        "pkg-3.10.17.15" = _gqmLmJ8x;
        "pkg-3.10.17.16" = _Z9nioxrI;
        "default" = _Z9nioxrI;
    });
