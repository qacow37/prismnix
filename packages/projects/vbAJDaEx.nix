...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.21.5" = _jIbcDjm3;
        "pkg-1.2.0+1.21.5" = _nPDRbkAe;
        "pkg-1.2.1+1.21.4" = _qfor4VG6;
        "pkg-1.2.1+1.21.5" = _3U01AcSj;
        "pkg-1.2.1+1.21.1" = _P7GasdG2;
        "pkg-1.2.2+1.21.4" = _wvDa7sTe;
        "pkg-1.2.2+1.21.5" = _1exZIqjT;
        "pkg-1.2.2+1.21.1" = _O1A8HRJM;
        "pkg-1.3.0+1.21.5" = _1oPsm6RU;
        "pkg-1.3.0+1.21.4" = _gO4GqPDU;
        "pkg-1.3.0+1.21.1" = _C6259zJK;
        "pkg-1.3.0+1.21.6-rc1" = _lCe27aaI;
        "pkg-1.3.1+1.21.6-rc1" = _tiZ44Rl1;
        "pkg-1.3.1+1.21.4" = _1KbHz93d;
        "pkg-1.3.1+1.21.5" = _mec39h8i;
        "pkg-1.3.1+1.21.1" = _mrMBLBSc;
        "pkg-1.3.2+1.21.6" = _oKuboz0x;
        "pkg-1.3.2+1.21.5" = _Jnaiv6ug;
        "pkg-1.3.2+1.21.4" = _4iC4RGhx;
        "pkg-1.3.2+1.21.1" = _i4pMLzM8;
        "pkg-1.3.3+1.21.6" = _blCxUQPe;
        "pkg-1.3.3+1.21.5" = _WwIzGkXd;
        "pkg-1.3.3+1.21.4" = _BwmgKPGV;
        "pkg-1.3.3+1.21.1" = _o5LPg2uP;
        "pkg-1.3.4+1.21.6" = _VJWSVMNk;
        "pkg-1.3.4+1.21.5" = _sM9yslNQ;
        "pkg-1.3.4+1.21.4" = _3HdklCd5;
        "pkg-1.3.4+1.21.1" = _iFdbhaHH;
        "pkg-1.3.5+1.21.8" = _YNrjFPqU;
        "pkg-1.3.5+1.21.5" = _8YzblFWf;
        "pkg-1.3.5+1.21.4" = _Aldce86s;
        "pkg-1.3.5+1.21.1" = _1ufxRLLt;
        "pkg-1.3.6+1.21.4" = _8WxM1Yio;
        "pkg-1.3.6+1.21.1" = _Gu4sT2m7;
        "pkg-1.3.6+1.21.5" = _D8RqCiKG;
        "pkg-1.3.6+1.21.8" = _1RgfUTFV;
        "pkg-1.3.6+1.21.9" = _HSwiHn8V;
        "pkg-1.3.7+1.21.4" = _3t7kZBPp;
        "pkg-1.3.7+1.21.5" = _uzre7eFn;
        "pkg-1.3.7+1.21.8" = _wTbE6Lwg;
        "pkg-1.3.7+1.21.1" = _2855LCO8;
        "pkg-1.3.7+1.21.10" = _giHnp5zh;
        "pkg-1.4.0+1.21.1" = _QhlDK9E9;
        "pkg-1.4.0+1.21.4" = _qxZeTSuF;
        "pkg-1.4.0+1.21.5" = _iQEMvzWR;
        "pkg-1.4.0+1.21.8" = _YBrN6CaC;
        "pkg-1.4.0+1.21.10" = _1kGNTt2z;
        "pkg-1.4.0+1.21.11" = _Z52r4unS;
        "pkg-1.4.1+1.21.1" = _uQUgb4cp;
        "pkg-1.4.1+1.21.4" = _NxEuVmKz;
        "pkg-1.4.1+1.21.5" = _L2BqgQMO;
        "pkg-1.4.1+1.21.8" = _khdWi0KF;
        "pkg-1.4.1+1.21.10" = _lMbJXrEs;
        "pkg-1.4.1+1.21.11" = _yg0k1HMR;
        "pkg-1.4.2+1.21.1" = _CRH7quEP;
        "pkg-1.4.2+1.21.4" = _t3F0bBJG;
        "pkg-1.4.2+1.21.5" = _BJ4SGOvS;
        "pkg-1.4.2+1.21.8" = _Ugc8aK2G;
        "pkg-1.4.2+1.21.10" = _GP2FK0ui;
        "pkg-1.4.2+1.21.11" = _jx7C8msw;
        "pkg-1.4.3+1.21.1" = _48YihImt;
        "pkg-1.4.3+1.21.4" = _E4Sy4wO3;
        "pkg-1.4.3+1.21.5" = _B32pGmaW;
        "pkg-1.4.3+1.21.8" = _Ytk95BKJ;
        "pkg-1.4.3+1.21.10" = _sHe9eDpW;
        "pkg-1.4.3+1.21.11" = _iyNYdycw;
        "pkg-1.4.4+1.21.1" = _ujQsXYr9;
        "pkg-1.4.4+1.21.4" = _MeojTspt;
        "pkg-1.4.4+1.21.5" = _m3oyAAYV;
        "pkg-1.4.4+1.21.8" = _2eTyPaog;
        "pkg-1.4.4+1.21.10" = _M0jONumV;
        "pkg-1.4.4+1.21.11" = _aEXjCSW3;
        "pkg-1.4.4+26.1.2" = _LKCZGwOG;
        "pkg-1.4.4+26.2" = _PhuP3nvL;
        "pkg-1.5.0+26.1.2" = _Jv4hbciF;
