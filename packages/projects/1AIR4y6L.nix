...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.21.1" = _Zx6tXXVa;
        "pkg-1.0.1+1.21.1-fabric" = _zuyo6X5X;
        "pkg-1.0.1+1.21.1-neoforge" = _HRTxSrKK;
        "pkg-1.0.2+1.21.1-fabric" = _viOVrbYy;
        "pkg-1.0.2+1.21.1-neoforge" = _BAj7sf1A;
        "pkg-1.0.2a+1.21.1-fabric" = _jsXyhn8l;
        "pkg-1.0.2a+1.21.1-neoforge" = _LceOlgcD;
        "pkg-1.0.3+1.21.1-fabric" = _msjv7kSq;
        "pkg-1.0.3+1.21.1-neoforge" = _FE4AMLuj;
        "pkg-1.0.4+1.20.1-fabric" = _XSBH2zdJ;
        "pkg-1.0.4+1.20.1-forge" = _7h1dYbSu;
        "pkg-1.0.4+1.21.1-fabric" = _FXJc8ByY;
        "pkg-1.0.4+1.21.1-neoforge" = _gTU5mtIo;
        "pkg-1.0.4a+1.20.1-forge" = _Ir12j58n;
        "pkg-1.0.5+1.20.1-fabric" = _9o3TYhdm;
        "pkg-1.0.5+1.20.1-forge" = _VwBjxZTN;
        "pkg-1.0.5+1.21.1-fabric" = _WPCyFROK;
        "pkg-1.0.5+1.21.1-neoforge" = _Z9fbwjUD;
        "pkg-1.0.6+1.20.1-fabric" = _TeEMfKDH;
        "pkg-1.0.6+1.20.1-forge" = _l6UbptsB;
        "pkg-1.0.6+1.21.1-fabric" = _LEreG6Ec;
        "pkg-1.0.6+1.21.1-neoforge" = _aUyXtMFK;
        "pkg-1.0.7+1.20.1-fabric" = _AvZSu24s;
        "pkg-1.0.7+1.20.1-forge" = _AbM9NSD5;
        "pkg-1.0.7+1.21.1-fabric" = _aEMNjfsr;
        "pkg-1.0.7+1.21.1-neoforge" = _GUfBmrSH;
        "pkg-1.0.8+1.20.1-fabric" = _19nag6Qu;
        "pkg-1.0.8+1.20.1-forge" = _RYqGupIw;
        "pkg-1.0.8+1.21.1-fabric" = _sYfkngq9;
        "pkg-1.0.8+1.21.1-neoforge" = _LICBeYE6;
        "pkg-1.0.9+1.20.1-fabric" = _KAX6nErq;
        "pkg-1.0.9+1.20.1-forge" = _nwOMo15V;
        "pkg-1.0.9+1.21.1-fabric" = _66MZ5Rld;
        "pkg-1.0.9+1.21.1-neoforge" = _M223gWsI;
        "default" = _M223gWsI;
    });
