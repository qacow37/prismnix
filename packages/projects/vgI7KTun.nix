...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.6-fabric" = _RDDYTutG;
        "pkg-1.18.2-1.6-fabric" = _yMF3YQmP;
        "pkg-1.19.2-1.7-fabric" = _UHqMvuWs;
        "pkg-1.16.5-1.2-forge" = _l2UAZ5ZC;
        "pkg-1.18.2-1.3-forge" = _hA47VRR8;
        "pkg-1.19.2-1.5-forge" = _txIqDEC2;
        "pkg-1.16.5-1.8-fabric" = _wHIghfeN;
        "pkg-1.18.2-1.8-fabric" = _buGU57uF;
        "pkg-1.19.2-1.8-fabric" = _GTbRagqA;
        "pkg-1.19.3-1.9-fabric" = _zFq0gJhe;
        "pkg-1.19.3-1.5-forge" = _GSUfS2Sx;
        "pkg-1.18.2-2.0-forge+fabric" = _KMoEwlo8;
        "pkg-1.19.2-2.0-forge+fabric" = _8C21uyAD;
        "pkg-1.19.3-2.0-forge+fabric" = _kwJ1TMCe;
        "pkg-1.18.2-2.1-forge+fabric" = _MLOSNrUY;
        "pkg-1.19.2-2.1-forge+fabric" = _bnFBNUXZ;
        "pkg-1.19.3-2.1-forge+fabric" = _Qxfcd104;
        "pkg-1.18.2-2.2-forge+fabric" = _U5XWfgCD;
        "pkg-1.19.2-2.2-forge+fabric" = _Q9I6YnJe;
        "pkg-1.19.3-2.2-forge+fabric" = _UH9W5cdO;
        "pkg-1.18.2-2.3-forge+fabric" = _dxMDDWyL;
        "pkg-1.19.2-2.3-forge+fabric" = _MQPdkjeW;
        "pkg-1.19.3-2.3-forge+fabric" = _msGoswYQ;
        "pkg-1.19.4-2.3-forge+fabric" = _Nj8HYtg8;
        "pkg-1.20-2.3-forge+fabric" = _lROYFLRb;
        "pkg-1.20.1-2.3-forge+fabric" = _5lbkquiF;
        "pkg-1.20.2-2.3-forge+fabric" = _3I2yh7nz;
        "pkg-1.18.2-2.4-forge+fabric" = _miYj11HU;
        "pkg-1.19.2-2.4-forge+fabric" = _Q1gAjqlo;
        "pkg-1.20.1-2.4-forge+fabric" = _JDXDpYyz;
        "pkg-1.20.2-2.4-forge+fabric" = _9Y5E6Xeq;
        "pkg-1.20.3-2.4-fabric+forge+neo" = _mDqDV15R;
        "pkg-1.20.4-2.4-fabric+forge+neo" = _3JUb1cOt;
        "pkg-1.19.2-2.5-fabric+forge+neo" = _Jwk2gH4j;
        "pkg-1.20.1-2.5-fabric+forge+neo" = _sD4AQ7VH;
        "pkg-1.20.2-2.5-fabric+forge+neo" = _9kpjkFzE;
        "pkg-1.20.4-2.5-fabric+forge+neo" = _S8nsvu3w;
        "pkg-1.20.5-2.5-fabric+neo" = _LeRSpnm5;
        "pkg-1.20.5-2.6-fabric+neo" = _KE1uQ3oE;
        "pkg-1.20.6-2.6-fabric+forge+neo" = _UTPV1YpN;
        "pkg-1.21.0-2.6-fabric+forge+neo" = _RquLWRVb;
        "pkg-1.20.1-2.7-fabric+forge+neo" = _8dmeSvWh;
        "pkg-1.20.6-2.7-fabric+forge+neo" = _h9KNn5Wr;
        "pkg-1.21.0-2.7-fabric+forge+neo" = _69plvjiV;
        "pkg-1.21.1-2.7-fabric+forge+neo" = _Abct19gw;
        "pkg-1.21.2-2.7-fabric+neo" = _f6pwFkZ8;
        "pkg-1.21.3-2.7-fabric+forge+neo" = _Gfjy49fZ;
        "pkg-1.21.4-2.7-fabric+forge+neo" = _MkJ8OWxw;
        "pkg-1.20.1-2.8-fabric+forge+neo" = _pFlRKdNB;
        "pkg-1.21.1-2.8-fabric+forge+neo" = _fAAi76Fv;
        "pkg-1.21.4-2.8-fabric+forge+neo" = _iHvvYx8y;
        "pkg-1.21.5-2.8-fabric+forge+neo" = _n38NVMmw;
        "pkg-1.21.6-2.8-fabric+forge+neo" = _xMxAkpnE;
        "pkg-1.21.7-2.8-fabric+forge+neo" = _6weY8d5L;
        "pkg-1.21.8-2.8-fabric+forge+neo" = _iE07U5j1;
        "pkg-1.21.9-2.8-fabric+forge+neo" = _dKiVAjS5;
        "pkg-1.21.10-2.8-fabric+forge+neo" = _SsLeKzcF;
        "pkg-1.21.11-2.8-fabric+forge+neo" = _q4kPQSby;
        "pkg-26.1.0-2.8-fabric+forge+neo" = _qaEq5quf;
        "pkg-26.1.1-2.8-fabric+forge+neo" = _KiPcHDZf;
        "pkg-26.1.2-2.8-fabric+forge+neo" = _VrIrvcG7;
        "pkg-26.2.0-2.8-fabric+forge+neo" = _4Zc2dlyC;
        "default" = _4Zc2dlyC;
    });
