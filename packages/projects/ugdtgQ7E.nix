...
let
    ...
    in {
        ...
        "pkg-0.4.0+1.20.1+forge" = _bWWL2PVZ;
        "pkg-0.4.0+1.20.1+fabric" = _LlRWznBU;
        "pkg-0.4.1+1.19.2+forge" = _N0ssxtfn;
        "pkg-0.4.1+1.19.2+fabric" = _yfO9ixn9;
        "pkg-0.4.1+1.20.1+forge" = _LB2DgdPJ;
        "pkg-0.4.1+1.20.1+fabric" = _X2rE3VGV;
        "pkg-0.4.2+1.19.2+forge" = _d8hzlI63;
        "pkg-0.4.2+1.19.2+fabric" = _uZ5xtNed;
        "pkg-0.4.2+1.20.1+forge" = _h3q4sdam;
        "pkg-0.4.2+1.20.1+fabric" = _qIijE7px;
        "pkg-0.4.2+1.20.2+forge" = _ZmP6ZiAc;
        "pkg-0.4.2+1.20.2+fabric" = _RwFK1nNw;
        "pkg-0.4.2+1.20.2+neoforge" = _JolrKzLX;
        "pkg-0.4.3+1.19.2+forge" = _BIij2RGW;
        "pkg-0.4.3+1.19.2+fabric" = _es40jIyI;
        "pkg-0.4.3+1.20.1+forge" = _t4DtLiJ0;
        "pkg-0.4.3+1.20.1+fabric" = _BiSsnEmv;
        "pkg-0.4.3+1.20.2+forge" = _2ikik8wI;
        "pkg-0.4.3+1.20.2+fabric" = _oThnaqco;
        "pkg-0.4.4+1.19.2+forge" = _5iHvYLP0;
        "pkg-0.4.4+1.19.2+fabric" = _Fe6cLhwG;
        "pkg-0.4.4+1.20.1+forge" = _fjMQXWNf;
        "pkg-0.4.4+1.20.1+fabric" = _u3yInf8z;
        "pkg-0.4.4+1.20.2+forge" = _45iCDxrO;
        "pkg-0.4.4+1.20.2+neoforge" = _vR8uXM7v;
        "pkg-0.4.4+1.20.2+fabric" = _OoiMYBMp;
        "pkg-0.4.4+1.20.4+forge" = _6ambIlzY;
        "pkg-0.4.4+1.20.4+neoforge" = _QvjJGESf;
        "pkg-0.4.4+1.20.4+fabric" = _shzUqm3d;
        "pkg-0.4.4+1.20.5+fabric" = _MfFSTxYv;
        "pkg-0.4.4+1.20.6+fabric" = _Sg5XB8bB;
        "pkg-0.4.4+1.21+fabric" = _rw93dWiV;
        "pkg-0.4.5+1.19.2+forge" = _HSEZNM6u;
        "pkg-0.4.5+1.19.2+fabric" = _I7WYxUqj;
        "pkg-0.4.5+1.20.1+forge" = _k8jqdNvR;
        "pkg-0.4.5+1.20.1+fabric" = _5K89Pusp;
        "pkg-0.4.5+1.20.2+forge" = _X7nsMVBx;
        "pkg-0.4.5+1.20.2+neoforge" = _50yXoJiO;
        "pkg-0.4.5+1.20.2+fabric" = _4DXQIl5l;
        "pkg-0.4.5+1.20.4+forge" = _gbIosfO3;
        "pkg-0.4.5+1.20.4+neoforge" = _GVkpXZI7;
        "pkg-0.4.5+1.20.4+fabric" = _KwszC6ZX;
        "pkg-0.4.5+1.21+forge" = _leCqguaU;
        "pkg-0.4.5+1.21+neoforge" = _GPjx9VnO;
        "pkg-0.4.5+1.21+fabric" = _jmaZUwug;
        "pkg-0.4.5+1.21.1+forge" = _88bQx1V1;
        "pkg-0.4.5+1.21.1+neoforge" = _nOxsORYr;
        "pkg-0.4.5+1.21.1+fabric" = _hTNYy66r;
        "pkg-0.4.6+1.19.2+forge" = _hpRGrjZU;
        "pkg-0.4.6+1.19.2+fabric" = _HVBKr7AU;
        "pkg-0.4.6+1.20.1+forge" = _cO9BEdjV;
        "pkg-0.4.6+1.20.1+fabric" = _gEw7yHTX;
        "pkg-0.4.6+1.20.2+forge" = _Ho1cE4ag;
        "pkg-0.4.6+1.20.2+neoforge" = _F6y5StGG;
        "pkg-0.4.6+1.20.2+fabric" = _4WqBNVUw;
        "pkg-0.4.6+1.20.4+forge" = _Yed7RELx;
        "pkg-0.4.6+1.20.4+neoforge" = _jssGWsVa;
        "pkg-0.4.6+1.20.4+fabric" = _zPXvL19v;
        "pkg-0.4.6+1.21.1+forge" = _6c11nuYz;
        "pkg-0.4.6+1.21.1+neoforge" = _72iorDgu;
        "pkg-0.4.6+1.21.1+fabric" = _AkF4e7B1;
        "pkg-0.4.6+1.21.3+forge" = _DFFUHJod;
        "pkg-0.4.6+1.21.3+neoforge" = _KYHmF95r;
        "pkg-0.4.6+1.21.3+fabric" = _A90xYMs9;
        "pkg-0.4.7+1.19.2+forge" = _f4IYZxce;
        "pkg-0.4.7+1.19.2+fabric" = _qHU1dm6Q;
        "pkg-0.4.7+1.20.1+forge" = _IpyESPWk;
        "pkg-0.4.7+1.20.1+fabric" = _orV1IzBZ;
        "pkg-0.4.7+1.20.2+forge" = _iHdZchyT;
        "pkg-0.4.7+1.20.2+neoforge" = _FOqy5V2a;
        "pkg-0.4.7+1.20.2+fabric" = _yn48Yyui;
        "pkg-0.4.7+1.20.4+forge" = _tMWQsA9w;
        "pkg-0.4.7+1.20.4+neoforge" = _WuPQ0NSd;
        "pkg-0.4.7+1.20.4+fabric" = _kK0Wq12f;
        "pkg-0.4.7+1.21.1+forge" = _mJzoAx10;
        "pkg-0.4.7+1.21.1+neoforge" = _3qzSTNkR;
        "pkg-0.4.7+1.21.1+fabric" = _3Fbp74q9;
        "pkg-0.4.7+1.21.3+forge" = _mXziT1Bi;
        "pkg-0.4.7+1.21.3+neoforge" = _N3t9httz;
        "pkg-0.4.7+1.21.3+fabric" = _cZ78IWBS;
        "pkg-0.4.8+1.21.3+forge" = _486eT3h7;
        "pkg-0.4.8+1.21.3+neoforge" = _QkKyJx2f;
        "pkg-0.4.8+1.21.3+fabric" = _UrEPsXrG;
        "pkg-0.4.8+1.21.4+forge" = _fKyGKcvz;
        "pkg-0.4.8+1.21.4+neoforge" = _zDAycbml;
        "pkg-0.4.8+1.21.4+fabric" = _XJEtB9oX;
        "pkg-0.4.8+1.21.5+forge" = _76spG1sA;
        "pkg-0.4.8+1.21.5+neoforge" = _JWz324A4;
        "pkg-0.4.8+1.21.5+fabric" = _3AyoMUpZ;
        "pkg-0.4.8+1.21.6+forge" = _PxerSbyC;
        "pkg-0.4.8+1.21.6+neoforge" = _c4njJaPn;
        "pkg-0.4.8+1.21.6+fabric" = _VxRMQej9;
        "pkg-0.4.8+1.21.7+forge" = _zm8ODRsa;
        "pkg-0.4.8+1.21.7+neoforge" = _VjMgMfyo;
        "pkg-0.4.8+1.21.7+fabric" = _3dJgQFMj;
        "pkg-0.4.8+1.21.8+forge" = _QAxDSvLw;
        "pkg-0.4.8+1.21.8+neoforge" = _iAZ6FLjx;
        "pkg-0.4.8+1.21.8+fabric" = _nxm111lt;
        "pkg-0.4.9+1.19.2+forge" = _tTwuARsO;
        "pkg-0.4.9+1.19.2+fabric" = _n27R8XwA;
        "pkg-0.4.9+1.20.1+forge" = _VEjWBHnw;
        "pkg-0.4.9+1.20.1+fabric" = _nL7QaZ0l;
        "pkg-0.4.9+1.20.2+forge" = _ZbgXNSWA;
        "pkg-0.4.9+1.20.2+neoforge" = _VlIj7qcN;
        "pkg-0.4.9+1.20.2+fabric" = _cTzZXSjd;
        "pkg-0.4.9+1.20.4+forge" = _F86Ar6pp;
        "pkg-0.4.9+1.20.4+neoforge" = _ES1wpdDA;
        "pkg-0.4.9+1.20.4+fabric" = _rIl6uSxe;
        "pkg-0.4.9+1.21.1+forge" = _1OF9X1GK;
        "pkg-0.4.9+1.21.1+neoforge" = _nIUQ78oK;
        "pkg-0.4.9+1.21.1+fabric" = _3ilsTZ7D;
        "pkg-0.4.9+1.21.9+forge" = _Aam4I5TR;
        "pkg-0.4.9+1.21.9+neoforge" = _hH0NVCJa;
        "pkg-0.4.9+1.21.9+fabric" = _i9D7KI5n;
        "pkg-0.4.9+1.21.10+forge" = _F0kKZk8o;
        "pkg-0.4.9+1.21.10+neoforge" = _lmlm9DBt;
        "pkg-0.4.9+1.21.10+fabric" = _4CMIQQmI;
        "pkg-0.4.10+1.19.2+forge" = _SLjr1Gp7;
        "pkg-0.4.10+1.19.2+fabric" = _oO6afJlf;
        "pkg-0.4.10+1.20.1+forge" = _nHTfObN2;
        "pkg-0.4.10+1.20.1+fabric" = _ss4Xd9Nc;
        "pkg-0.4.10+1.20.2+forge" = _btg2jQed;
        "pkg-0.4.10+1.20.2+neoforge" = _GDYEgslj;
        "pkg-0.4.10+1.20.2+fabric" = _rDBCnT7L;
        "pkg-0.4.10+1.20.4+forge" = _WbRMikoQ;
        "pkg-0.4.10+1.20.4+neoforge" = _CeI0hieO;
        "pkg-0.4.10+1.20.4+fabric" = _q8uTr3fF;
        "pkg-0.4.10+1.21.1+forge" = _nPFRX99h;
        "pkg-0.4.10+1.21.1+neoforge" = _OCJrR8Fs;
        "pkg-0.4.10+1.21.1+fabric" = _LCHBvgxs;
        "pkg-0.4.10+1.21.10+forge" = _auVli5Ho;
        "pkg-0.4.10+1.21.10+neoforge" = _sHIcvXn1;
        "pkg-0.4.10+1.21.10+fabric" = _EqZ69w59;
        "pkg-0.4.10+1.21.11+forge" = _2p0iZeK1;
        "pkg-0.4.10+1.21.11+neoforge" = _DdQbFzKx;
        "pkg-0.4.10+1.21.11+fabric" = _sJXn0bZb;
        "pkg-0.4.10+26.1+fabric" = _xBcoYy5V;
        "pkg-0.4.10+26.1+neoforge" = _pxbpeJIG;
        "pkg-0.4.10+26.1+forge" = _7gFuQb9P;
