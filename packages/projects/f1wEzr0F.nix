...
let
    ...
    in {
        ...
        "pkg-0.1.3+1.21.1-neoforge" = _SqO6Ao6L;
        "pkg-0.1.3.1+1.21.1-neoforge" = _BfeTeZ50;
        "pkg-0.1.2.1+1.20.1-forge" = _pWAqKQyn;
        "pkg-0.1.4+1.21.1-neoforge" = _gPv2nSzU;
        "pkg-0.1.4.1+1.21.1-neoforge" = _J28JvQPx;
        "pkg-0.1.4.2+1.21.1-neoforge" = _Fbgq02As;
        "pkg-0.1.4.3+1.21.1-neoforge" = _eHK4OTSS;
        "pkg-0.1.4.4+1.21.1-neoforge" = _koDnOMye;
        "pkg-0.1.4.5+1.21.1" = _C4nwNpVu;
        "pkg-0.1.4.6+1.21.1" = _TJsEWWGe;
        "pkg-0.1.4.7+1.21.1" = _px29JzFF;
        "pkg-0.1.4.8+1.21.1" = _BFKLVfw5;
        "pkg-0.1.4.9+1.21.1" = _F6BQodDW;
        "pkg-0.1.4.9.1+1.21.1" = _G7fH1eAb;
        "pkg-0.1.4.9.2+1.21.1" = _1grZbFsh;
        "pkg-0.1.5+1.21.1" = _NF6CLSaq;
        "pkg-0.1.5.1+1.21.1" = _wt6aPdsb;
        "pkg-0.1.5.2+1.21.1" = _DC6ikKvm;
        "pkg-0.1.6+1.21.1" = _ZFNIih0r;
        "pkg-0.1.7+1.21.1" = _ceUKqDs8;
        "pkg-0.1.7.1+1.21.1" = _1PSLu0Uy;
        "pkg-0.1.7.2+1.21.1" = _dGnnN1dc;
        "pkg-0.1.7.3+1.21.1" = _CnQJ5OZs;
        "pkg-0.1.7.4+1.21.1" = _wxWA2IgN;
        "pkg-0.26-april-foods" = _ODnfYWc7;
        "default" = _ODnfYWc7;
    });
