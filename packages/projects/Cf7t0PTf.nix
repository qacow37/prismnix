...
let
    ...
    in {
        ...
        "pkg-1.21.2-1.0.1" = _RWGeK6bw;
        "pkg-1.21.1-1.0.2" = _K2R2m19G;
        "pkg-1.21.2-1.0.2" = _355WTAoU;
        "pkg-1.21.5-1.0.2" = _4DDWsQEn;
        "pkg-1.21.1-1.0.3" = _uKYSqEgs;
        "pkg-1.21.2-1.0.3" = _qlG8Uygc;
        "pkg-1.21.5-1.0.3" = _ZTE68j38;
        "pkg-1.21.6-1.0.3" = _r0SXPnrO;
        "pkg-1.20-1.0.4" = _lunihuwr;
        "pkg-1.21.1-1.0.4" = _A6z6oCWs;
        "pkg-1.21.2-1.0.4" = _kSlnadAt;
        "pkg-1.21.5-1.0.4" = _x6XfVwO5;
        "pkg-1.21.6-1.0.4" = _NzsDxUYV;
        "pkg-1.21.9-1.0.4" = _VpGpONcV;
        "pkg-1.21.11-1.0.4" = _V6kPGAxr;
        "pkg-1.21.11-1.0.4+hotfix.1" = _v9bBv2g9;
