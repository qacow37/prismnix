...
let
    ...
    in {
        ...
        "pkg-1.9.4-0.4.5.13" = _HnaPALbm;
        "pkg-1.10.2-0.4.5.49" = _29cP26iq;
        "pkg-1.11.2-0.4.5.49" = _q6eZgnW3;
        "pkg-1.12.2-0.4.5.68" = _lXY8AQnu;
        "pkg-1.16.5-2.0.55" = _qb93c55m;
        "pkg-1.17.1-2.0.51" = _O76WSn3r;
        "pkg-1.18.2-2.0.55" = _yk4Vc39G;
        "pkg-1.19.2-2.0.55" = _2WVMMW6H;
        "pkg-1.16.5-2.0.57" = _NfRN5BFW;
        "pkg-1.16.5-2.0.58" = _xHyu5PeP;
        "pkg-1.16.5-2.0.60" = _YAUrhKii;
        "pkg-1.18.2-2.0.60" = _X49ifA8H;
        "pkg-1.19.2-2.0.60" = _q1zYEzRt;
        "pkg-1.18.2-2.0.61" = _NB4zEHJK;
        "pkg-1.19.2-2.0.62" = _WYlgL8NK;
        "pkg-1.16.5-2.0.64" = _qSp5oA64;
        "pkg-1.18.2-2.0.64" = _xWhrtnGG;
        "pkg-1.19.2-2.0.64" = _GEXjCRxl;
        "pkg-1.20-2.0.66" = _rnzB7p2Y;
        "pkg-1.20.1-2.0.67" = _lpEA1SCq;
        "pkg-1.20.1-2.0.68" = _H8hwL9KY;
        "pkg-1.20.1-2.0.69" = _OFI6WnhE;
        "pkg-1.16.5-2.0.70" = _WjWzQcbH;
        "pkg-1.18.2-2.0.70" = _tQHXTlmS;
        "pkg-1.19.2-2.0.70" = _162lYZcb;
        "pkg-1.20.1-2.0.70" = _JZOQJiht;
        "pkg-1.16.5-2.0.71" = _ZaHjUOrO;
        "pkg-1.18.2-2.0.71" = _1L7HJQWM;
        "pkg-1.19.2-2.0.71" = _aWj4vg3e;
        "pkg-1.20.1-2.0.71" = _lzg72TTO;
        "pkg-1.20.1-2.0.73" = _xwLWlGec;
        "pkg-1.20.1-2.0.74" = _lu5PWrmf;
        "pkg-1.20.1-2.0.75" = _5CYl80HP;
        "pkg-1.20.1-2.0.83" = _Vck952PD;
        "pkg-1.21-2.4.4" = _12uaejjC;
        "pkg-1.20.1-2.0.84" = _5A5jbWkI;
        "pkg-1.21-2.4.5" = _oURqnxrr;
        "pkg-1.21.1-2.4.9" = _wABJBBTd;
        "default" = _wABJBBTd;
    });
