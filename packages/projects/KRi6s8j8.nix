...
let
    ...
    in {
        ...
        "pkg-1.12.2-1.2.3.1" = _d167xwRP;
        "pkg-1.18.2-2.3.10.6" = _3e1eplEO;
        "pkg-1.18.2-2.3.12.1" = _Fhz2TuGV;
        "pkg-1.18.2-2.3.12.2" = _Fpw1I2JQ;
        "pkg-1.18.2-2.3.12.3" = _yncTitQ7;
        "pkg-1.19.2-4.0.0.4" = _TaW8FrHr;
        "pkg-1.19.2-4.1.0.1" = _5XUNrCcz;
        "pkg-1.19.2-4.1.1.1" = _GAVZ9cts;
        "pkg-1.19.2-4.1.1.2" = _6vBkyRPa;
        "pkg-1.19.2-4.1.1.3" = _bKeAsRYm;
        "pkg-1.19.2-4.1.1.4" = _azpfImHO;
        "pkg-1.19.2-4.1.1.5" = _lmtD8Xbz;
        "pkg-1.19.2-4.1.1.6" = _vIHa0dUD;
        "pkg-1.19.2-4.1.1.7" = _k77llIex;
        "pkg-1.20.1-5.0.0.0" = _y9uqSzAM;
        "pkg-1.20.1-5.0.0.1" = _SvMFDkKL;
        "pkg-1.18.2-2.3.12.4" = _tbKrrz1R;
        "pkg-1.19.2-4.1.1.8" = _pLONXK2f;
        "pkg-1.20.1-5.0.0.2" = _S7UTPufK;
        "pkg-1.18.2-2.3.12.5" = _FZkGkuxF;
        "pkg-1.19.2-4.1.1.9" = _mS04JOiK;
        "pkg-1.20.1-5.0.0.3" = _QsrzS2Qb;
        "pkg-1.18.2-2.3.12.6" = _9LHwFzBs;
        "pkg-1.19.2-4.1.1.10" = _c3lYvdjz;
        "pkg-1.20.1-5.0.0.4" = _bcPBrvMt;
        "pkg-1.20.1-5.0.0.5" = _zQG5506O;
        "pkg-1.20.1-5.0.0.6" = _hkOddnab;
        "pkg-1.20.1-5.0.0.7" = _CBE1iHrg;
        "pkg-1.18.2-2.3.12.7" = _7VEvGqA6;
        "default" = _7VEvGqA6;
    });
