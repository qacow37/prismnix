...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.5-55.1.4" = _O7BdkQXr;
        "pkg-1.0.0-forge-1.21.4-54.1.11" = _WFAK4WlR;
        "pkg-1.0.0-forge-1.21.1-52.1.8" = _oMi9I3IP;
        "pkg-1.0.0-forge-1.20.1-47.4.10" = _A77ppSdN;
        "pkg-1.0.0-fabric-1.20.1-0.92.7" = _ZvCDjgyr;
        "pkg-1.0.0-neoforge-1.21.1-21.1.219" = _pol9Crkj;
        "pkg-1.0.0-neoforge-1.21.4-21.4.156" = _1trXnZPB;
        "pkg-1.0.0-neoforge-1.21.5-21.5.96" = _hUggZtyP;
        "pkg-1.0.0-neoforge-1.21.8-21.8.52" = _UwYVRVL0;
        "pkg-1.0.0-neoforge-1.21.10-21.10.64" = _BBXIBWWy;
        "pkg-1.0.0-neoforge-1.21.11-21.11.37b" = _XYx40lXI;
        "pkg-1.0.0-fabric-1.21.1-0.116.8" = _FWMVL67k;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _vOwAwFr0;
        "pkg-1.0.0-fabric-1.21.5-0.128.2" = _IkgTX4CB;
        "pkg-1.0.0-fabric-1.21.8-0.136.1" = _diZ7PXGW;
        "pkg-1.0.0-fabric-1.21.10-0.138.4" = _DVpM82wy;
        "pkg-1.0.0-fabric-1.21.11-0.141.2" = _skkk19ah;
        "pkg-1.0.1-fabric-26.1.6-0.143.2" = _PvjCKzLK;
        "pkg-1.0.2-fabric-26.1.1-0.145.4" = _m3nu9MPY;
        "pkg-1.0.2-neoforge-26.1.1.10" = _R0rMCpaI;
        "pkg-1.0.2-forge-26.1.1-63.0.0" = _cOes8m7b;
