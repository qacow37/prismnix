...
let
    ...
    in {
        ...
        "pkg-v3.0.1-1.18.2-Fabric" = _M8DY4gPE;
        "pkg-v20.4.0-1.20.4-Fabric" = _KJmThLZO;
        "pkg-v20.4.0-1.20.4-NeoForge" = _I6Va70r8;
        "pkg-v20.4.0-1.20.4-Forge" = _jpavsTnm;
        "pkg-v20.4.1-1.20.4-Fabric" = _JQZOqwIH;
        "pkg-v20.4.1-1.20.4-Forge" = _fHYgh2S9;
        "pkg-v20.4.1-1.20.4-NeoForge" = _i557SMk0;
        "pkg-v8.0.2-1.20.1-Forge" = _kMhwKoWa;
        "pkg-v8.0.2-1.20.1-Fabric" = _bEztYypw;
        "pkg-v20.4.2-1.20.4-Fabric" = _DbJ66fg4;
        "pkg-v20.4.2-1.20.4-Forge" = _vuFVEZQo;
        "pkg-v20.4.2-1.20.4-NeoForge" = _X4W2G4RO;
        "pkg-v8.0.3-1.20.1-Forge" = _mfWYc7Qo;
        "pkg-v8.0.3-1.20.1-Fabric" = _dSfZSR22;
        "pkg-v20.4.3-1.20.4-Fabric" = _DyuAbRQG;
        "pkg-v20.4.3-1.20.4-Forge" = _MwSpELw5;
        "pkg-v20.4.3-1.20.4-NeoForge" = _paKKERS9;
        "pkg-v3.0.2-1.18.2-Forge" = _IXAmnLUs;
        "pkg-v3.0.2-1.18.2-Fabric" = _Kwj0vQdh;
        "pkg-v8.0.4-1.20.1-Forge" = _CUdEQguO;
        "pkg-v8.0.4-1.20.1-Fabric" = _gabhTk7m;
        "pkg-v20.4.4-1.20.4-Fabric" = _faLQEM61;
        "pkg-v20.4.4-1.20.4-Forge" = _ZZbTOYyK;
        "pkg-v20.4.4-1.20.4-NeoForge" = _ugWv16Z5;
        "pkg-v3.0.3-1.18.2-Forge" = _LmVlhKrr;
        "pkg-v3.0.3-1.18.2-Fabric" = _Dyxfevhf;
        "pkg-v8.0.5-1.20.1-Forge" = _rB3qvqaE;
        "pkg-v8.0.5-1.20.1-Fabric" = _vZ3OuAQk;
        "pkg-v20.4.5-1.20.4-Fabric" = _Quu4gBAn;
        "pkg-v20.4.5-1.20.4-Forge" = _5trhTPe8;
        "pkg-v20.4.5-1.20.4-NeoForge" = _5Kqlocdp;
        "pkg-v21.1.0-1.21.1-Fabric" = _h2PYYlqa;
        "pkg-v21.1.0-1.21.1-NeoForge" = _aDLsLB6R;
        "pkg-v21.1.1-1.21.1-Fabric" = _i9tRQ8bf;
        "pkg-v21.1.1-1.21.1-NeoForge" = _O72HWWUK;
        "pkg-v21.3.0-1.21.3-Fabric" = _XuWk0Oka;
        "pkg-v21.3.0-1.21.3-NeoForge" = _WCMaw7th;
        "pkg-v21.4.0-1.21.4-Fabric" = _jfscxQrU;
        "pkg-v21.4.0-1.21.4-NeoForge" = _vzKBa4We;
        "pkg-v21.5.0-1.21.5-Fabric" = _rSzl0U1v;
        "pkg-v21.5.0-1.21.5-NeoForge" = _mOKqqZ9m;
        "pkg-v21.7.0-1.21.7-Fabric" = _56i1rF85;
        "pkg-v21.7.0-1.21.7-NeoForge" = _DQU08sVn;
        "pkg-v21.8.0-1.21.8-Fabric" = _YbF6bhtn;
        "pkg-v21.8.0-1.21.8-NeoForge" = _p5f8v8sb;
        "pkg-v21.8.1-1.21.8-Fabric" = _BClosOoB;
        "pkg-v21.8.1-1.21.8-NeoForge" = _n6VvazVd;
        "pkg-21.9.0" = _EjSMwCa8;
        "pkg-21.10.0" = _VVS2cBgh;
        "pkg-21.11.0" = _35DZfE7S;
        "pkg-21.11.1" = _gOOgcs45;
        "pkg-v21.1.2-1.21.1-Fabric" = _cY1lrXVu;
