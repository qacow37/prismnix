...
let
    ...
    in {
        ...
        "pkg-mc1.16.5-v0.1.0" = _nhrA7pmt;
        "pkg-mc1.17.x-v0.1.0" = _GlnCyjBU;
        "pkg-mc1.18.x-v0.1.0" = _EMPE6Bnd;
        "pkg-mc1.19.x-v0.1.0" = _zdXxkfK1;
        "pkg-0.1.1+1.16.5" = _MfxCaFiR;
        "pkg-0.1.1+1.17.1" = _lWDwkyH5;
        "pkg-0.1.1+1.18.2" = _e0AMcerb;
        "pkg-0.1.1+1.19.2" = _jOk8nBqp;
        "pkg-0.1.2alpha1+1.19.2" = _iCD8j4KF;
        "pkg-0.1.0+1.20.1" = _6nqB5MZS;
        "pkg-0.1.2+1.16.5" = _wXjXts30;
        "pkg-0.1.2+1.18.2" = _SHEY54BQ;
        "pkg-0.1.2+1.19.2" = _28uyUjSd;
        "pkg-0.1.2+1.19.3" = _RlgJIDi3;
        "pkg-0.1.3+1.19.4" = _A5iA87QD;
        "pkg-0.1.1+1.20.1" = _lVD80jln;
        "pkg-0.1.2+1.20.1" = _9pO8kpUE;
        "pkg-0.1.4+1.19.4" = _xQivt6fz;
        "pkg-0.1.3+1.19.3" = _ojuVJ5SC;
        "pkg-0.1.3+1.19.2" = _vU78L01a;
        "pkg-0.1.3+1.18.2" = _QUGgrFhE;
        "pkg-0.1.3+1.16.5" = _QapVxe77;
        "pkg-0.1.4+1.16.5" = _4mhX7ACl;
        "pkg-lexforge-0.1.0+1.20.2" = _onywOd0V;
        "pkg-lexforge-0.1.1+1.20.2" = _nCHuaTnK;
        "pkg-lexforge-0.1.2+1.20.2" = _IopXW7oa;
        "pkg-neoforge-0.1.0-1.20.2" = _esJK1mwt;
        "pkg-neoforge-0.1.1-1.20.2" = _rrOCbjnq;
        "pkg-0.1.3-1.20.2-lexforge" = _xtkor376;
        "pkg-0.1.3-1.20.2-neoforge" = _2u2sOQMT;
        "pkg-0.1.0+1.20.4" = _7HMuWvRX;
        "pkg-0.2.0-neoforge" = _6PvxnDgE;
        "pkg-0.2.0-fabric" = _MaXlMySo;
        "pkg-0.2.1+mc1.20.4-fabric" = _zuzENcAi;
        "pkg-0.2.1+mc1.20.4-neoforge" = _hsjjzpzN;
        "pkg-0.2.0+mc1.20.1-fabric" = _zfhMSi9y;
        "pkg-0.2.0+mc1.20.1-forge" = _oBuE2e4V;
        "pkg-0.2.0+mc1.20.2-fabric" = _Z37l39yZ;
        "pkg-0.2.0+mc1.20.2-neoforge" = _g2tj2uVQ;
        "pkg-0.2.1+mc1.20.1-fabric" = _MtxW9OmO;
        "pkg-0.2.1+mc1.20.1-forge" = _7Mz0mUtM;
        "pkg-0.2.0+mc1.19.2-fabric" = _ks4enNe7;
        "pkg-0.2.0+mc1.19.2-forge" = _fy68rieS;
        "pkg-0.2.0+mc1.18.2-fabric" = _TgOruZkV;
        "pkg-0.2.0+mc1.18.2-forge" = _nHEBn9RY;
        "pkg-0.2.0+mc1.16.5-fabric" = _rv6s4BXy;
        "pkg-0.2.0+mc1.16.5-forge" = _bQ4sudgD;
        "pkg-0.2.1+mc1.16.5-fabric" = _pAPejgad;
        "pkg-0.2.1+mc1.16.5-forge" = _dHVcMXdQ;
        "pkg-0.2.2+mc1.16.5-fabric" = _vu2cVo7G;
        "pkg-0.2.2+mc1.16.5-forge" = _jR8UEZW1;
        "pkg-0.2.3+mc1.16.5-fabric" = _yNu3KHtj;
        "pkg-0.2.3+mc1.16.5-forge" = _HWvUXPtJ;
        "pkg-0.2.1+mc1.19.2-fabric" = _rpw7n9dQ;
        "pkg-0.2.1+mc1.19.2-forge" = _VLjdyw11;
        "pkg-0.2.4+mc1.16.5-fabric" = _REAmWq80;
        "pkg-0.2.4+mc1.16.5-forge" = _EvlCc5tT;
        "pkg-0.2.1+mc1.18.2-fabric" = _AvIvEnkT;
        "pkg-0.2.1+mc1.18.2-forge" = _LIHAUszB;
        "pkg-0.2.2+mc1.19.2-fabric" = _nq6OpHaD;
        "pkg-0.2.2+mc1.19.2-forge" = _kxZ4gE2k;
        "pkg-0.2.3+mc1.20.4-neoforge" = _NP3fE2aV;
        "pkg-0.2.2+mc1.20.1-fabric" = _JkoHXXbQ;
        "pkg-0.2.1+mc1.20.2-neoforge" = _RqcPdQMq;
        "pkg-0.2.2+mc1.20.1-forge" = _K5ZxDde9;
        "pkg-0.2.4+mc1.20.4-neoforge" = _fiDnb9vk;
        "pkg-0.2.2+mc1.20.2-neoforge" = _JlrQYkUv;
        "pkg-0.2.3+mc1.20.1-fabric" = _3osMYaKS;
        "pkg-0.2.3+mc1.20.1-forge" = _3UXTHiK6;
        "pkg-0.2.2+mc1.18.2-fabric" = _5HrYkjOo;
        "pkg-0.2.2+mc1.18.2-forge" = _SsM7M9wW;
        "pkg-0.2.3+mc1.19.2-fabric" = _wVJCoaD6;
        "pkg-0.2.3+mc1.19.2-forge" = _ByWvmLqV;
        "pkg-0.2.5+mc1.16.5-fabric" = _J7IhuTCk;
        "pkg-0.2.5+mc1.16.5-forge" = _5X8yST6c;
        "pkg-0.2.4+mc1.20.6-fabric" = _q2f8tZMO;
        "pkg-0.2.4+mc1.20.6-neoforge" = _1M5pXAOs;
        "pkg-0.2.5+mc1.20.6-fabric" = _nWdeIZxW;
        "pkg-0.2.5+mc1.20.6-neoforge" = _19PaO9YL;
        "pkg-0.2.6+mc1.21-fabric" = _EX8HocE0;
        "pkg-0.2.6+mc1.21-neoforge" = _c2m3O2oT;
        "pkg-0.2.6+mc1.20.6-fabric" = _qdZyR5a1;
        "pkg-0.2.6+mc1.20.6-neoforge" = _DFiV4IQI;
        "pkg-0.2.7+mc1.21-fabric" = _Yt9IWzuL;
        "pkg-0.2.7+mc1.21-neoforge" = _ILqin340;
        "pkg-0.2.9+mc1.21.1-fabric" = _j7blxBm6;
        "pkg-0.2.9+mc1.21.1-neoforge" = _UzYZy4w6;
        "pkg-0.2.10+mc1.21.3-fabric" = _kOGFM47J;
        "pkg-0.2.10+mc1.21.3-neoforge" = _m7WVqIsG;
        "pkg-0.2.11+mc1.21.4-fabric" = _y6SqMjzy;
        "pkg-0.2.11+mc1.21.4-neoforge" = _lnFnirdR;
        "pkg-0.2.11+mc1.21.5-fabric" = _2Tc3JJ8z;
        "pkg-0.2.11+mc1.21.5-neoforge" = _lt4bGdQi;
        "pkg-0.2.12+mc1.21.5-fabric" = _pwBFJXAD;
        "pkg-0.2.12+mc1.21.5-neoforge" = _fjdMyQh0;
        "pkg-0.2.12+mc1.21.6-fabric" = _apnfIehn;
        "pkg-0.2.12+mc1.21.6-neoforge" = _1gFO3LwA;
        "default" = _1gFO3LwA;
    });
