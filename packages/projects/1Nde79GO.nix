...
let
    ...
    in {
        ...
        "pkg-1.20.1-10.3.0" = _fwhEGsoa;
        "pkg-1.20-9.2.0" = _ImL9PHoB;
        "pkg-1.20.1-10.4.0" = _6fLrCOaA;
        "pkg-1.20.1-10.5.0" = _5xELrRlh;
        "pkg-1.20.1-10.6.0" = _wS9vTU6m;
        "pkg-11.0.0" = _LWNaZ06L;
        "pkg-12.0.0" = _VWnAzJ9b;
        "pkg-13.0.0" = _Aj3dT2JD;
        "pkg-14.0.0" = _xAHMTMjJ;
        "pkg-15.0.0" = _RKTR2rAp;
        "pkg-16.0.0" = _JCXLPIsr;
        "pkg-16.1.0" = _GAFZuaQY;
        "pkg-17.0.0" = _Yx82UhBz;
        "pkg-18.0.0" = _eHk8dVhg;
        "pkg-19.0.0" = _TAbAOkL3;
        "pkg-20.0.0" = _xH63rVSx;
        "pkg-21.0.0" = _YSP5GKV9;
        "pkg-22.0.0" = _DzYkzevm;
        "pkg-23.0.0" = _QxzPdwi9;
        "pkg-24.0.0" = _C1w0AeVI;
        "pkg-25.0.0" = _dRYOVdBy;
        "pkg-26.0.0" = _ajKIzZoN;
        "pkg-21.1.0" = _M3PoXtUA;
        "pkg-22.1.0" = _UVYO43Ut;
        "pkg-27.0.0" = _jaUOUmyp;
        "pkg-28.0.0" = _9o1gFwqU;
        "pkg-29.0.0" = _3WFNEHxQ;
        "pkg-30.0.0" = _3v4iwfuH;
        "pkg-31.0.0" = _rye48emj;
        "pkg-27.1.0" = _sBYLFk0o;
        "pkg-28.1.0" = _gFGJNEBm;
        "pkg-29.1.0" = _GYodVCEe;
        "pkg-30.1.0" = _pWDFR3si;
        "pkg-31.1.0" = _Ia3dhPEz;
        "default" = _Ia3dhPEz;
    });
