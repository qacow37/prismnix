...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _QBbwjqz3;
        "pkg-2.0.2-fabric" = _2oJU1zKm;
        "pkg-2.0.2-neoforge" = _xOy8qjml;
        "pkg-2.0.3-fabric" = _zw0Z1i04;
        "pkg-2.0.3-neoforge" = _d7xDRVUM;
        "pkg-2.0.4-neoforge" = _sUXMZIFR;
        "pkg-2.0.4-fabric" = _hThDrf6j;
        "pkg-2.0.5" = _squWuU5W;
        "default" = _squWuU5W;
    });
