...
let
    ...
    in {
        ...
        "pkg-v1.0.0" = _k8tzFYIh;
        "pkg-v1.0.1" = _GbgcPaNN;
        "pkg-v1.0.2" = _7sFE7fFe;
        "pkg-v1.0.3" = _ge32aRv3;
        "pkg-v1.0.4" = _Kyn8GGGA;
        "pkg-v1.0.5" = _84PImI4F;
        "pkg-v1.0.6" = _PNbxDiOo;
        "pkg-v1.0.7" = _EVKSkqBw;
        "pkg-v1.0.8" = _aBIL1V45;
        "pkg-v1.0.9" = _bHW3go2j;
        "pkg-v1.1" = _pM218T5J;
        "pkg-v1.2.2-fabric" = _RA28MpJG;
        "pkg-v1.3.0-fabric" = _6JIb9VPs;
        "pkg-v1.3.0-neoforge" = _aVBKqjPj;
        "pkg-v1.3.2-fabric" = _yp8bxB6l;
        "pkg-v1.3.2-neoforge" = _rfEhUFBP;
        "pkg-v1.3.3-fabric" = _SOazhD98;
        "pkg-v1.3.3-neoforge" = _G1qTBe1W;
        "pkg-v1.3.4-fabric" = _PlwA05NK;
        "pkg-v1.3.4-neoforge" = _fJM2Y7E4;
        "pkg-v1.3.5-fabric" = _M0ZSAQR1;
        "pkg-v1.3.5-neoforge" = _qVnKtjbx;
        "pkg-v1.3.5" = _fvmQiXnP;
        "pkg-v1.3.6" = _v8KI8Eeq;
        "pkg-v1.3.6-fabric" = _1Z3SUhiw;
        "pkg-v1.3.6-neoforge" = _j9t41FQ6;
        "pkg-v1.3.7-fabric" = _K0x5Wyjb;
        "pkg-v1.3.7-neoforge" = _NxQLkNj6;
        "pkg-v1.3.7" = _CEu8O8eO;
        "pkg-v1.4.0-fabric" = _NCYibhZP;
        "pkg-v1.4.0-neoforge" = _BBDPgllj;
        "pkg-v1.4.0" = _DxeTgDjn;
        "default" = _DxeTgDjn;
    });
