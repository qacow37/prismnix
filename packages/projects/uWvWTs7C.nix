...
let
    ...
    in {
        ...
        "pkg-3.3" = _iWezjJRr;
        "pkg-3.3.0.2" = _IsDL6grh;
        "pkg-3.3.0.3" = _jb4rgav3;
        "pkg-3.3.0.5" = _2YZwP5aF;
        "pkg-3.3.0.7" = _FIcjXdi1;
        "pkg-3.3.0.8" = _500SvOjg;
        "pkg-1.1" = _iaHB86p1;
        "pkg-3.3.0.9" = _YwvRkBWn;
        "pkg-3.3.0.10" = _JKCsKnEz;
        "pkg-3.3.0.11" = _7zfOTwym;
        "pkg-3.3.0.12" = _b1zH5aES;
        "pkg-3.3.0.13" = _shJSLYFZ;
        "pkg-3.3.0.14" = _62oJjRKq;
        "pkg-3.3.0.15" = _479SK6xa;
        "pkg-3.3.0.16" = _sOHUrhM1;
        "pkg-3.3.0.17" = _YiYK5KjM;
        "pkg-3.3.0.18" = _wfL7xFvI;
        "pkg-3.3.0.19" = _jdmsswsi;
        "pkg-3.3.0.20" = _ouq59U4P;
        "pkg-3.3.0.21" = _cwNwQEEI;
        "pkg-3.3.0.22" = _r2ldAgO2;
        "pkg-3.3.0.23" = _Am4Podzq;
        "pkg-1.2" = _p8DLGIW6;
        "pkg-3.3.0.24" = _mOKrLkbC;
        "pkg-3.3.0.25" = _LktNDVGV;
        "pkg-1.3" = _bp1PnPWq;
        "pkg-1.5" = _rcB6bdev;
        "pkg-1.6" = _V6AYY2bx;
        "pkg-3.3.0.27" = _MtXzhWZM;
        "pkg-1.7" = _zHmjyDFQ;
        "pkg-1.8" = _mYJQ1xgO;
        "pkg-3.3.0.28" = _PT0qzH7B;
        "pkg-2.0" = _vVRTBeBC;
        "pkg-2.1" = _drNnSBLG;
        "pkg-2.2" = _NEMgUJ4W;
        "pkg-2.3" = _mfwqdjiD;
        "pkg-2.4" = _j8KAtw6z;
        "pkg-2.5" = _KjFJnryT;
        "pkg-3.3.0.29" = _DFzXbOh4;
        "pkg-3.3-RC1" = _kyIkJqJ6;
        "pkg-3.3-RC3" = _WgeFcb23;
        "pkg-3.3-RC4" = _TIvCLNeJ;
        "pkg-3.3-RC5" = _qN5qq5qj;
        "pkg-3.3-RC6" = _c7nYygIv;
        "pkg-3.3-RC7" = _t0EL9PKR;
        "pkg-3.3-RC8" = _HVOdExAR;
        "pkg-3.3-RC9" = _FNPd7A6x;
        "pkg-3.3-RC10" = _nbk8G81z;
        "pkg-3.3.0.30" = _lp7onhgC;
        "pkg-3.3.0.1" = _1xo3iP3n;
        "pkg-3.3.0.31" = _EIG8wD0H;
        "pkg-3.3.0.4" = _x1RzEiY8;
        "pkg-3.3.0.6" = _izWPBIn2;
        "pkg-3.3.0.32" = _SqOGiZyC;
        "pkg-3.3.0.33" = _ESZO7GsH;
        "pkg-3.3.0.34" = _vQnLgcDb;
        "pkg-2.6" = _NMhyl4sZ;
        "pkg-3.3.0.35" = _9xb4GDsg;
        "pkg-3.3.0.36" = _fhrl1g4z;
        "pkg-3.3.0.37" = _4HnOBcaU;
        "pkg-3.3.0.38" = _PVSHgqvA;
        "pkg-3.3.0.39" = _nUmcGCfN;
        "pkg-3.3.0.40" = _6QFBaTP9;
        "pkg-3.3.0.41" = _Dux3CBca;
        "pkg-3.3.0.43" = _nbhpVdpk;
        "pkg-3.3.1" = _HcbkOMzM;
        "pkg-3.3.1.2" = _bpgDW3zS;
        "pkg-3.3.1.3" = _KLDT9f9E;
        "pkg-3.3.1.4" = _OtPi2Y2v;
        "pkg-3.3.1.6" = _sFYI7l1Z;
        "pkg-3.3.1.7" = _vWQEQYe8;
        "pkg-3.3.1.8" = _451vAuV9;
        "pkg-3.3.1.9" = _oLonFXS2;
        "pkg-3.3.1.10" = _W1DoKkMm;
        "pkg-3.3.1.11" = _EKq8bSfL;
        "pkg-3.3.1.12" = _ycC8xVqF;
        "pkg-3.3.1.13" = _FzzDqsLF;
        "pkg-3.3.1.14" = _zYAsqUs5;
        "pkg-3.3.1.15" = _qjRq3XwI;
        "pkg-3.3.2.8" = _NhkSPLm8;
        "pkg-3.3.2.7" = _yhqO3ZCA;
        "pkg-3.3.2.16" = _967ilJgB;
        "pkg-3.3.2.14" = _7vJVaeMK;
        "pkg-3.3.2.24" = _T5QOvVIe;
        "pkg-3.3.2.23" = _iT6guH5H;
        "pkg-3.3.2.25" = _v6feFoGx;
        "pkg-3.3.2.26" = _RZ5ZTahf;
        "pkg-3.3.2.28" = _oaNgn71B;
        "pkg-3.3.2.27" = _RrS7S8D7;
        "pkg-3.3.2.29" = _1hePuUw6;
        "pkg-3.3.2.30" = _E60YU3I6;
        "pkg-3.3.2.31" = _NpCfFSA8;
        "pkg-3.3.2.32" = _BS0OpWHW;
        "pkg-3.4" = _TiiwAx6T;
        "pkg-3.4.0.4" = _fJYftz7n;
        "pkg-3.4.0.9" = _zhok3w3m;
        "pkg-3.4.0.11" = _HykawKs8;
        "default" = _HykawKs8;
    });
