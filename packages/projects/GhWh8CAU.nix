...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0-forge+fabric" = _sjorSLN5;
        "pkg-1.19.2-1.0-forge+fabric" = _6jeSHK0D;
        "pkg-1.19.4-1.0-forge+fabric" = _K6Rp3JJc;
        "pkg-1.20.1-1.0-forge+fabric" = _X2d6CeQo;
        "pkg-1.20.2-1.0-forge+fabric" = _u1wOxkqA;
        "pkg-1.18.2-1.1-forge+fabric" = _aT8b3R1v;
        "pkg-1.19.2-1.1-forge+fabric" = _B5tKl0lF;
        "pkg-1.20.1-1.1-forge+fabric" = _Aj85vTn5;
        "pkg-1.20.2-1.1-forge+fabric" = _oLmkAgy6;
        "pkg-1.20.2-1.2-forge+fabric" = _iF8VHGty;
        "pkg-1.20.3-1.2-fabric+forge+neo" = _WcnhfFQw;
        "pkg-1.20.4-1.2-fabric+forge+neo" = _4ijaqu1J;
        "pkg-1.19.2-1.3-fabric+forge+neo" = _ixo57WqC;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _g1MVF7Cj;
        "pkg-1.20.2-1.3-fabric+forge+neo" = _OkUoRUuI;
        "pkg-1.20.4-1.3-fabric+forge+neo" = _BXgVzBBU;
        "pkg-1.19.2-1.4-fabric+forge" = _8WeGdRrc;
        "pkg-1.20.1-1.4-fabric+forge+neo" = _Aen5OKsI;
        "pkg-1.20.2-1.4-fabric+forge+neo" = _hzT1Ccso;
        "pkg-1.20.4-1.4-fabric+forge+neo" = _NA2n08Q8;
        "pkg-1.19.2-1.5-fabric+forge" = _FpRH4ocY;
        "pkg-1.20.1-1.5-fabric+forge+neo" = _5UjHG6QJ;
        "pkg-1.20.4-1.5-fabric+forge+neo" = _E4BZN4lM;
        "pkg-1.20.5-1.5-fabric+neo" = _53tqLDhH;
        "pkg-1.20.6-1.5-fabric+forge+neo" = _rVxTvcPK;
        "pkg-1.21.0-1.5-fabric+forge+neo" = _lsrkWLor;
        "pkg-1.20.1-1.6-fabric+forge+neo" = _yAczhNz3;
        "pkg-1.20.6-1.6-fabric+forge+neo" = _1V1BhkbI;
        "pkg-1.21.0-1.6-fabric+forge+neo" = _BaSQl9WS;
        "pkg-1.21.1-1.6-fabric+forge+neo" = _iTQDwHzD;
        "pkg-1.21.2-1.6-fabric+neo" = _7BiVJCiR;
        "pkg-1.21.3-1.6-fabric+forge+neo" = _WufFbUXW;
        "pkg-1.21.4-1.6-fabric+forge+neo" = _kNQ0o955;
        "pkg-1.20.1-1.7-fabric+forge+neo" = _I5HtCHmD;
        "pkg-1.21.1-1.7-fabric+forge+neo" = _Bf5QnXI2;
        "pkg-1.21.4-1.7-fabric+forge+neo" = _D5q6w2ra;
        "pkg-1.21.5-1.7-fabric+forge+neo" = _OtEoOllX;
        "pkg-1.21.6-1.7-fabric+forge+neo" = _yFtmqe4Q;
        "pkg-1.21.7-1.7-fabric+forge+neo" = _CRiE8H5S;
        "pkg-1.21.8-1.7-fabric+forge+neo" = _35U54QmW;
        "pkg-1.21.9-1.7-fabric+forge+neo" = _V21gxMvv;
        "pkg-1.21.10-1.7-fabric+forge+neo" = _AvZYpMEf;
        "pkg-1.21.11-1.7-fabric+forge+neo" = _thiVD4v4;
        "pkg-26.1.0-1.7-fabric+forge+neo" = _ScZKYfNT;
        "pkg-26.1.1-1.7-fabric+forge+neo" = _HPSmaVlz;
        "pkg-26.1.2-1.7-fabric+forge+neo" = _zFs8sRiS;
        "pkg-1.20.1-1.8-fabric+forge+neo" = _dzSjFZjQ;
        "pkg-1.21.1-1.8-fabric+forge+neo" = _JWGClgbL;
        "pkg-1.21.11-1.8-fabric+forge+neo" = _q8s5cGyW;
        "pkg-26.1.2-1.8-fabric+forge+neo" = _TON3EPtQ;
        "pkg-26.2.0-1.8-fabric+forge+neo" = _apNpAwQM;
        "pkg-26.1.2-1.9-fabric+forge+neo" = _xwetsg9H;
        "pkg-26.2.0-1.9-fabric+forge+neo" = _4W8f2kOL;
        "default" = _4W8f2kOL;
    });
