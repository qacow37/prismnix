...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _Y1lE8N6R;
        "pkg-1.0.3" = _tVtWHwOM;
        "pkg-2.0.2+1.19.2" = _hIb8OFyf;
        "pkg-3.0.0" = _bjkwsD3z;
        "pkg-4.0.0" = _OixcyW45;
        "pkg-5.0.0" = _KrD56IaN;
        "pkg-3.0.1+1.20.1-fabric" = _IHSHVW0X;
        "pkg-3.0.1+1.20.1-forge" = _OtxMAVxH;
        "pkg-4.0.1+1.21.1-fabric" = _YPEZRkbo;
        "pkg-4.0.1+1.21.1-neoforge" = _gyrVc1YG;
        "pkg-5.0.1+1.20.1-fabric" = _VVvsRaUS;
        "pkg-5.0.1+1.20.1-forge" = _GeOc6PIX;
        "pkg-3.0.2+1.20.1-fabric" = _5vejO6hJ;
        "pkg-3.0.2+1.20.1-forge" = _yiHnHsc7;
        "pkg-4.0.2+1.21.1-fabric" = _jRfOpQAK;
        "pkg-4.0.2+1.21.1-neoforge" = _jMBjksDu;
        "pkg-5.0.2+1.21.8-fabric" = _lnfsZ78n;
        "pkg-5.0.2+1.21.8-neoforge" = _ncoUzMvQ;
        "default" = _ncoUzMvQ;
    });
