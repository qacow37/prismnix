...
let
    ...
    in {
        ...
        "pkg-1.1.3" = _1oZ1kmRm;
        "pkg-1.1.4" = _ZFp8it47;
        "pkg-2.0.0-fabric" = _Uz13KTT4;
        "pkg-2.0.0-forge" = _n4PaAqWZ;
        "pkg-2.1.0-fabric" = _hAEKTwEB;
        "pkg-2.1.0-forge" = _qoFPSsTe;
        "pkg-2.1.1-fabric" = _NQDiv8Nn;
        "pkg-2.1.1-forge" = _MJqLAIyV;
        "pkg-2.1.2-fabric" = _3Zom0Bkx;
        "pkg-2.1.2-forge" = _K2eeq01a;
        "pkg-2.1.3-fabric" = _jrW2wXbV;
        "pkg-2.1.3-forge" = _IZRShNGi;
        "pkg-2.1.4-fabric" = _ESqBNwAB;
        "pkg-2.1.4-forge" = _QnCBivJQ;
        "pkg-2.2.0" = _MAz5TUC3;
        "pkg-2.2.0+1.20.1-forge" = _uvukXD3s;
        "pkg-1.7.2+1.20.1-fabric" = _ivf6XjnK;
        "default" = _ivf6XjnK;
    });
