...
let
    ...
    in {
        ...
        "pkg-2.9.5" = _erZamzME;
        "pkg-2.9.6" = _TGLOmaQt;
        "pkg-2.10.0" = _dDKoYeig;
        "pkg-2.10.1" = _gdLrFouB;
        "pkg-2.10.2" = _ErIZXxzI;
        "pkg-2.10.3" = _PX9A0yrV;
        "pkg-2.10.4" = _27mFLj2C;
        "pkg-2.10.5" = _TUSBQh8H;
        "pkg-2.10.6" = _9EIeFbpr;
        "pkg-2.10.7" = _y9gWhe6d;
        "pkg-2.10.8" = _iwejw5Cr;
        "pkg-2.10.9" = _Pw6JzyA4;
        "pkg-2.10.10" = _EvGRSbwf;
        "pkg-2.10.11" = _crHcn6zi;
        "pkg-2.11.0" = _Tve8yifU;
        "pkg-2.11.1" = _PC8mtqDp;
        "pkg-2.12.0" = _wzH19jHo;
        "pkg-2.12.1" = _HNFGyeYi;
        "pkg-3.0.0" = _55EsDpNP;
        "pkg-3.1.0" = _GZYHH5hA;
        "pkg-3.0.1" = _gI8tUntu;
        "pkg-3.1.1" = _MVNXLhET;
        ...
        "pkg-3.0.8" = _DzP3MNLx;
        "pkg-3.0.9" = _oVF9IVr0;
        "pkg-3.0.10" = _oiWrACWS;
        "pkg-3.0.11" = _oV7wbIAO;
        "pkg-3.0.12" = _dm3qmfdC;
        "pkg-3.2.1" = _CSCAZ0A4;
        "pkg-3.2.2" = _9t7niJC4;
        "pkg-3.0.13" = _1U5CLYg8;
        "pkg-3.2.3" = _KgjPzAXS;
        "pkg-3.2.4" = _Gs4JRDQy;
        "pkg-3.0.14" = _iBEWFdUC;
        "pkg-3.2.5" = _EnfukgJv;
        "pkg-3.0.15" = _iNvtWcpT;
        "pkg-3.0.16" = _RzW8vh8K;
        "pkg-3.0.17" = _qM6FwIsK;
        "pkg-3.2.6" = _RaH63bh9;
        "pkg-3.0.18" = _ZdcmVeyo;
        "pkg-3.0.19" = _oAoslPRS;
        "pkg-3.0.20" = _FQU1p8Yw;
        "pkg-3.0.21" = _4QGZT3p1;
        "pkg-3.0.22" = _MtJnxN90;
        "pkg-3.3.0" = _1pyYlidb;
        "pkg-3.0.23" = _9lCDAULu;
        "pkg-3.0.24" = _nunEU2sp;
        "pkg-3.3.1" = _LKXx63hU;
        "pkg-3.0.25" = _qULSQeBl;
        "pkg-3.3.2" = _l5mC4wK0;
        "pkg-3.0.26" = _yJoTpCcg;
        "pkg-3.3.3" = _NbAiyLOP;
        "pkg-3.0.27" = _HzNgGWV8;
        "pkg-3.3.4" = _HlQXa171;
        "pkg-3.0.28" = _B65TlrnZ;
        "pkg-3.0.29" = _9eiBMaPX;
        "default" = _9eiBMaPX;
    });
