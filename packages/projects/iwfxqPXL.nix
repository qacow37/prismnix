...
let
    ...
    in {
        ...
        "pkg-48.0.1" = _8adsqlz8;
        "pkg-48.1.0" = _eXAtCcus;
        "pkg-48.2.1" = _GC8qGcGn;
        "pkg-49.0.4" = _EuKAK7Iz;
        "pkg-49.0.5" = _6VjD2rXy;
        "pkg-49.0.7" = _n3YSCtqa;
        "pkg-49.1.0" = _To6gijDZ;
        "pkg-49.1.1" = _8piMvxnB;
        "pkg-49.1.3" = _9gzZdi0f;
        "pkg-49.2.0" = _nnqCHVKk;
        "pkg-49.2.1" = _J4YKSNIr;
        "pkg-49.2.2" = _SPcaG5yB;
        "pkg-50.0.0pr1" = _kdBoDvgV;
        "pkg-50.0.0pr2" = _MLVLTOdr;
        "pkg-50.0.0pr3" = _Yp4KfIof;
        "pkg-50.0.1" = _5P0iiuGs;
        "pkg-50.0.2" = _IHLzE3tG;
        "pkg-50.0.3" = _6KnYlEzf;
        "pkg-50.1.0" = _I1JpDVnQ;
        "pkg-50.1.1" = _GYOwR8xn;
        "pkg-50.2.0" = _ODF30Ho0;
        "pkg-50.2.1" = _Od7UMLso;
        "pkg-50.2.2" = _yHAYM7qc;
        "pkg-50.2.3" = _CeNFm1tY;
        "pkg-50.2.4" = _WU3T8qq3;
        "pkg-51.0.0" = _Q0SH63mt;
        "pkg-51.0.1" = _sZGRAhvS;
        "pkg-51.0.2" = _mPHyoYJV;
        "pkg-51.0.3" = _Slzp3STz;
        "pkg-51.0.4" = _uhEpQgnX;
        "pkg-51.0.5" = _fKA9dm7r;
        "pkg-52.0.0" = _KXg15BdU;
        "pkg-52.0.1" = _AOykfBAp;
        "pkg-52.0.2" = _5fDtilSo;
        "pkg-52.0.3" = _pvLLSBzd;
        "pkg-52.0.4" = _OzslMOEn;
        "pkg-52.0.5" = _G2ELCpXk;
        "pkg-52.1.0" = _BXpbDez5;
        "pkg-52.2.0" = _lHdjbqcm;
        "pkg-52.2.1" = _UgHdRB5G;
        "pkg-52.2.2" = _YSpm22c6;
        "pkg-52.2.3" = _wdEZAnhJ;
        "pkg-52.2.4" = _M0vRY2Z0;
        "pkg-52.2.5" = _KGNCxtdZ;
        "pkg-52.2.6" = _zrYsVOmd;
        "pkg-52.3.0" = _LcbDdfLJ;
        "pkg-52.3.1" = _iep6s0eU;
        "pkg-52.3.2" = _FHQFNUMh;
        "pkg-52.3.3" = _gtz76InX;
        "pkg-52.3.4" = _I0V0Qtb6;
        "pkg-52.3.5" = _gLog52WI;
        "pkg-52.3.6" = _1MGa5UWs;
        "pkg-52.3.7" = _xYIlFL93;
        "pkg-52.4.0" = _YjFeglgR;
        "pkg-52.4.1" = _N96aBeAk;
        "pkg-52.4.2" = _vomsQ7eB;
        "pkg-52.4.3" = _rI1MfJte;
        "pkg-52.4.4" = _BbzOI3CD;
        "pkg-52.4.5" = _n4nsXukg;
        "pkg-52.4.6" = _kpH2fnti;
        "pkg-53.0.0" = _aP7zoaes;
        "pkg-54.0.0" = _Uph1ka5P;
        "pkg-54.0.1" = _voHp2Sii;
        "pkg-54.0.2" = _wKB7ZZNg;
        "pkg-55.0.0" = _1YGYGhaK;
        "pkg-55.0.1" = _fpidKhPt;
        "pkg-55.1.0" = _GliZbvCh;
        "pkg-55.1.1" = _FqxDev8F;
        "pkg-55.1.2" = _5JkWRAic;
        "pkg-55.1.3" = _fYxc6T34;
        "pkg-55.1.4" = _78paZhR9;
        "pkg-55.1.5" = _Fn14RYHP;
        "pkg-55.1.6" = _QYc29phj;
        "pkg-56.0.0" = _1htzIqmj;
        "pkg-56.0.1" = _qCOl3rbd;
        "pkg-56.0.2" = _86jrGf5M;
        "pkg-56.0.3" = _VkwfDEdf;
        "pkg-56.0.4" = _ajIiqACr;
        "pkg-56.0.5" = _dbOErryy;
        "pkg-57.0.0" = _dMyICYlp;
        "pkg-57.1.0" = _zopivoB0;
        "pkg-57.1.1" = _4oUoDuRe;
        "pkg-57.1.10" = _D92PunIx;
        "pkg-57.1.2" = _2nwQ87wk;
        "pkg-57.1.3" = _8JdS3FBV;
        "pkg-57.1.4" = _EzJsj3Do;
        "pkg-57.1.5" = _VeSncwyB;
        "pkg-57.1.6" = _wOPh0L6X;
        "pkg-57.1.7" = _8KpAG94N;
        "pkg-57.1.8" = _G774xQeG;
        "pkg-57.1.9" = _Wq6fjp8X;
        "pkg-57.1.91" = _IFcBeXbN;
        "pkg-57.1.92" = _Rr9ocozf;
        "pkg-57.1.93" = _sw9gC6zu;
        "pkg-57.1.94" = _svgOI2vn;
        "pkg-57.2.0" = _JKjPFFOF;
        "pkg-59.0.0" = _aT8htaEh;
        "pkg-59.0.1" = _yPShkLjH;
        "pkg-59.0.2" = _WgVzeILJ;
        "pkg-59.0.3" = _8hzFm5k3;
        "pkg-59.0.4" = _mVcZyAI6;
        "pkg-59.0.5" = _oUzYLHUX;
        "pkg-59.0.6" = _4UKebjSW;
        "pkg-59.0.7" = _1I8sDmZ7;
        "pkg-59.0.8" = _34cReX3l;
        "pkg-59.1.0" = _DqYd4z96;
        "pkg-59.1.1" = _xuexUTaf;
        "pkg-59.1.2" = _75oJeoFO;
        "pkg-59.1.3" = _S1l0IjEY;
        "pkg-59.1.4" = _QlL6BVEI;
        "pkg-58.0.0" = _nGr6dRIh;
        "pkg-58.0.1" = _45emT6CX;
        "pkg-58.0.2" = _12NGEoZa;
        "pkg-58.0.3" = _4Rz3ABzX;
        "pkg-58.1.0" = _zrIcLrWO;
        "pkg-58.1.1" = _nvsBTAaN;
        "pkg-58.1.2" = _GNNP6PLC;
        "pkg-58.1.3" = _boyhrbiy;
        "pkg-58.1.4" = _CpP0uXGw;
        "default" = _CpP0uXGw;
    });
