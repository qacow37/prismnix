...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.1" = _uon22Xdj;
        "pkg-1.0.0+1.21.4" = _DZbY6EAa;
        "pkg-1.0.1+1.21.1" = _vTtDBphJ;
        "pkg-1.0.1+1.21.4" = _E2urVfOZ;
        "pkg-1.1.0+1.21.1" = _WBcVqReI;
        "pkg-1.1.0+1.21.4" = _F0QXSNkX;
        "default" = _F0QXSNkX;
    });
