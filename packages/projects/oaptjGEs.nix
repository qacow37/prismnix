...
let
    ...
    in {
        ...
        "pkg-0.1.0+mc1.21.4" = _XmVcsnS9;
        "pkg-0.1.0+mc1.21.5" = _9IbzqGw8;
        "pkg-0.1.0+mc1.21.8" = _J8E9xEJM;
        "pkg-0.1.1+mc1.21.1" = _QX5xmwk3;
        "pkg-0.1.1+mc1.21.10" = _rKCUZl8d;
        "pkg-0.1.1+mc1.21.11" = _VcEWWzve;
        "pkg-0.1.1+mc1.21.4" = _ftFgpOAi;
        "pkg-0.1.1+mc1.21.5" = _Iyle6vNm;
        "pkg-0.1.1+mc1.21.8" = _PNqpQ4LD;
        "pkg-0.1.2+mc1.21.1" = _Tz6h9wPP;
        "pkg-0.1.2+mc1.21.10" = _dLaXCNJG;
        "pkg-0.1.2+mc1.21.11" = _oo3A5ALF;
        "pkg-0.1.2+mc1.21.4" = _qicQLaKo;
        "pkg-0.1.2+mc1.21.5" = _91qbV2W1;
        "pkg-0.1.2+mc1.21.8" = _srSwnl2n;
        "pkg-0.1.3+mc1.21.1" = _U2JU0Pjg;
        "pkg-0.1.3+mc1.21.10" = _ydmxbgIx;
        "pkg-0.1.3+mc1.21.11" = _q82Ptog1;
        "pkg-0.1.3+mc1.21.4" = _ITuHYZfJ;
        "pkg-0.1.3+mc1.21.5" = _TJqdbMGn;
        "pkg-0.1.3+mc1.21.8" = _5M3TELUM;
        "pkg-0.2.0+mc1.21.1" = _3EsW1knD;
        "pkg-0.2.0+mc1.21.10" = _OavAvXMv;
        "pkg-0.2.0+mc1.21.11" = _KkGLW2Wy;
        "pkg-0.2.0+mc1.21.4" = _6UScwQbR;
        "pkg-0.2.0+mc1.21.5" = _KUPWrpWd;
        "pkg-0.2.0+mc1.21.8" = _ckoiRSlp;
        "pkg-0.2.1+mc1.21.1" = _ge9ca6PD;
        "pkg-0.2.1+mc1.21.10" = _nAjhFSs2;
        "pkg-0.2.1+mc1.21.11" = _TW3lz0ZE;
        "pkg-0.2.1+mc1.21.4" = _H9psahzH;
        "pkg-0.2.1+mc1.21.5" = _wVfiHksC;
        "pkg-0.2.1+mc1.21.8" = _Tbo3bef9;
        "pkg-0.2.2+mc1.21.1" = _Yhad9aKi;
        "pkg-0.2.2+mc1.21.10" = _jtuHcu57;
        "pkg-0.2.2+mc1.21.11" = _l4Iau8eZ;
        "pkg-0.2.2+mc1.21.4" = _NV5svmk1;
        "pkg-0.2.2+mc1.21.5" = _GgDPF8m1;
        "pkg-0.2.2+mc1.21.8" = _EG2BW3zn;
        "pkg-0.3.0+mc1.21.1" = _fN9k1adN;
        "pkg-0.3.0+mc1.21.11" = _bymjQ6De;
        "pkg-0.3.0+mc26.1.2" = _6BPPNd8k;
        "pkg-0.3.0+mc26.2" = _Nqptcz1g;
        "pkg-0.4.0+mc1.21.1" = _erKYEKbn;
