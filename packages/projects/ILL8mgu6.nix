...
let
    ...
    in {
        ...
        "pkg-1.5.1" = _RqeIMT1y;
        "pkg-1.5.2" = _Ugeq9Gcu;
        "pkg-1.5.2.1" = _7NTsENeP;
        "pkg-1.5.1.1" = _3ktPPGzk;
        "pkg-1.6.0.0" = _PMYDT1Mm;
        "pkg-1.6.0.1" = _cf27pJMr;
        "pkg-1.6.0.2" = _3ShCINuS;
        "pkg-1.6.1.0" = _akd0a7ZT;
        "pkg-1.6.1.1" = _34xS5Hm2;
        "pkg-1.6.1.1+mod" = _ulAu9dwq;
        "pkg-1.7.0.0" = _50d9sC6u;
        "pkg-1.7.0.0+mod" = _hWFAjDl5;
        "pkg-1.7.0.1" = _cWwE8Ynt;
        "pkg-1.7.0.1+mod" = _xUoTu6fP;
        "pkg-1.7.1.0" = _bLkbjElu;
        "pkg-1.7.1.0+mod" = _EFtQGBnF;
        "pkg-1.7.2.0" = _ONsz4QmK;
        "pkg-1.7.2.0+mod" = _rvo6H3MZ;
        "default" = _rvo6H3MZ;
    });
