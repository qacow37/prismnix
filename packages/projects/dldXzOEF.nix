...
let
    ...
    in {
        ...
        "pkg-beta1" = _BPlpKLVb;
        "pkg-beta1+mod" = _YLwQwYUg;
        "pkg-beta2" = _VY8yRSeo;
        "pkg-beta2+mod" = _aCbEoN7k;
        "pkg-beta3" = _A41INdug;
        "pkg-beta3+mod" = _1AvVzbCP;
        "pkg-beta3-hotfix1" = _iYT2ajpu;
        "pkg-beta3-hotfix1+mod" = _LXv5tR1v;
        "pkg-beta3-hotfix2" = _wFgZWYW7;
        "pkg-beta3-hotfix2+mod" = _MSyShIJQ;
        "pkg-beta4p1" = _UBvHr3DH;
        "pkg-beta4p1+mod" = _HrsdxLZF;
        "pkg-beta4p2" = _2YnUqtxX;
        "pkg-beta4p2+mod" = _O62c7MA9;
        "pkg-beta4-hotfix1" = _Agp0bhki;
        "pkg-beta4-hotfix1+mod" = _CEwXPUmB;
        "pkg-beta5" = _lqJXlRW1;
        "pkg-beta5+mod" = _l8fDvwc7;
        "pkg-beta6" = _5PWDudax;
        "pkg-beta6+mod" = _3B4fvA2I;
        "pkg-beta6-hotfix1" = _GQiXDjmg;
        "pkg-beta6-hotfix1+fabric" = _qSF7NyX8;
        "pkg-beta6-hotfix1+neoforge" = _6MdwQIe5;
        "default" = _6MdwQIe5;
    });
