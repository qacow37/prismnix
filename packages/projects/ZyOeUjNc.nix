...
let
    ...
    in {
        ...
        "pkg-1.0.0+jimmer.0.9.94" = _bOnS3T0U;
        "pkg-1.0.0+jimmer.0.9.96" = _bpQwgU5V;
        "pkg-1.0.1+jimmer.0.9.100" = _D4q6dYHI;
        "pkg-1.0.2+jimmer.0.9.105" = _k4CRbFVi;
        "pkg-1.0.2+jimmer.0.9.106" = _Lt6FrMda;
        "pkg-1.0.2+jimmer.0.9.107" = _TmU2Tnt3;
        "pkg-1.0.2+jimmer.0.9.109" = _o05xWlEj;
        "pkg-1.0.2+jimmer.0.9.110" = _tkV4xOeI;
        "pkg-1.0.2+jimmer.0.9.111" = _BOwI0BBe;
        "pkg-1.0.2+jimmer.0.9.112" = _ZcQts6Yf;
        "pkg-1.0.2+jimmer.0.9.113" = _RdxUYkSM;
        "pkg-1.0.2+jimmer.0.9.114" = _bIHVd0j5;
        "pkg-1.0.2+jimmer.0.9.115" = _gpHSACg4;
        "pkg-1.0.2+jimmer.0.9.116" = _jFYnzyT1;
        "pkg-1.0.2+jimmer.0.9.119" = _5yIkYz8m;
        "pkg-1.0.2+jimmer.0.9.120" = _tBFuAyPJ;
        "pkg-1.0.2+jimmer.0.10.6" = _xrHaMUjs;
        "pkg-1.0.3+jimmer.0.10.6" = _ZNwK7CVw;
        "pkg-1.0.3+jimmer.0.10.10" = _sfM3p67a;
        "pkg-1.0.5+jimmer.0.10.10" = _jATiH6D4;
        "pkg-1.0.5+jimmer.0.10.11" = _GZBwtvzG;
        "pkg-1.0.5+jimmer.0.11.2" = _yEWyZhz9;
        "default" = _yEWyZhz9;
    });
