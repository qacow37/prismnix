...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _2byuYR0C;
        "pkg-1.0.1" = _eYiesoTH;
        "pkg-1.0.1+mod" = _jpFIjKJl;
        "pkg-1.1.0" = _sc83BNfK;
        "pkg-1.1.1" = _yF857mMJ;
        "pkg-1.1.2" = _sJpztub9;
        "pkg-1.1.2+mod" = _blFmVplI;
        "pkg-1.2.0" = _pPJib2mR;
        "pkg-1.2.0_01" = _7CoYGMi6;
        "pkg-1.2.0_01+mod" = _RRpi2ry4;
        "pkg-1.3.0" = _Ng8LzwpP;
        "pkg-1.3.0+mod" = _TASrqciy;
        "pkg-1.2.0_02" = _EIB2PeZJ;
        "pkg-1.4.0" = _td4Pwc8n;
        "pkg-1.4.0+mod" = _vYDxTZV3;
        "pkg-1.4.1" = _qGX9S874;
        "pkg-1.4.1+mod" = _16dKdo4F;
        "pkg-1.4.2" = _5anOAQWu;
        "pkg-1.4.2+mod" = _TpGz3Ixj;
        "pkg-1.5.0" = _dpTS00cG;
        "pkg-1.5.0+mod" = _hzMWikgV;
        "pkg-1.6.0" = _yl5sqMf2;
        "pkg-1.6.0+mod" = _shozeNFq;
        "pkg-1.7.0" = _SfoQZOiZ;
        "pkg-1.7.0+mod" = _w2gaOgTb;
        "pkg-1.8.0" = _Jr330bmW;
        "pkg-1.8.1" = _I4Cv2wPZ;
        "pkg-1.8.1+mod" = _gX9UzU6F;
        "pkg-1.9.0" = _dskUFL1z;
        "pkg-1.9.0+mod" = _W1nW4ecQ;
        "pkg-1.10.0" = _GKppYHaJ;
        "pkg-1.10.0+mod" = _R7d3ZYvO;
        "pkg-1.11.0" = _IssSyGTr;
        "pkg-1.11.0+mod" = _1w5WYj8T;
        "pkg-1.11.1" = _2f0ndK3p;
        "pkg-1.11.1+mod" = _MnGFcYKz;
        "pkg-1.11.1_a" = _lJK2BscA;
        "pkg-1.11.1_a+mod" = _7YaI5K1y;
        "pkg-1.12.0" = _tsAZgzhm;
        "pkg-1.12.0+mod" = _gO2pRbOZ;
        "pkg-1.12.1" = _bNN2ypEE;
        "pkg-1.12.1+mod" = _rutnSMNO;
        "pkg-1.13.0" = _5aooZIvb;
        "pkg-1.13.0+mod" = _jmmuwNt8;
        "pkg-1.14.0" = _4Vzjfuwu;
        "pkg-1.14.0+mod" = _yIG7YURs;
        "pkg-1.14.1" = _AlyqXfpY;
        "pkg-1.14.1+mod" = _gR5tX4b0;
        "pkg-1.15.0" = _alNqZsPu;
        "pkg-1.15.0+mod" = _1jpJYzNa;
        "pkg-1.13.0_01" = _Zi3Y0Vco;
        "pkg-1.13.0_01+mod" = _iT6WNWLA;
        "pkg-1.16.0" = _zBJ29CLh;
        "pkg-1.16.0+mod" = _vbKd1wMq;
        "pkg-1.17.0" = _PDRFcuS4;
        "pkg-1.17.0+mod" = _JToiLryC;
        "pkg-1.18.0" = _ZRzV9DaA;
        "pkg-1.18.0+mod" = _WP16eDTl;
        "pkg-1.19.0" = _vGG3CY1E;
        "pkg-1.19.0+mod" = _DghgI8jO;
        "pkg-1.20.0" = _LpOLQ0eR;
        "pkg-1.20.0+mod" = _UxIDLUUG;
        "pkg-1.20.1" = _G7RaqUSC;
        "pkg-1.20.1+mod" = _QvknZGzC;
        "pkg-1.20.2" = _hpj4Ckr7;
        "pkg-1.20.2+mod" = _skGb9vmA;
        "pkg-1.20.3" = _27YjXfCj;
        "pkg-1.20.3+mod" = _BeujEEGh;
        "pkg-1.20.4" = _NLgIGehe;
        "pkg-1.20.4+mod" = _UULa73kB;
        "pkg-1.21.0" = _LOQtabrx;
        "pkg-1.21.0+mod" = _tdfkZpp1;
        "pkg-1.20.4_01" = _8n7j3AaZ;
        "pkg-1.20.4_01+mod" = _IuLZDA9f;
        "pkg-1.22.0" = _Iwh77Nb7;
        "pkg-1.22.0+mod" = _gxrAzSdO;
        "pkg-1.20.4_02" = _8zHU2YGl;
        "pkg-1.20.4_02+mod" = _lNF7zCos;
        "pkg-1.22.1" = _pYsiXSbk;
        "pkg-1.22.1+mod" = _7ef715mC;
        "pkg-1.23.0" = _bNHOkwya;
        "pkg-1.23.0+mod" = _J1n3lvhg;
        "pkg-1.24.0" = _tjFRerLK;
        "pkg-1.24.0+mod" = _vqm5ojTe;
        "pkg-1.24.1" = _keDVhKFe;
        "pkg-1.24.1+mod" = _PZ97ZcIb;
        "pkg-1.25.0" = _Q1mTkgMn;
        "pkg-1.25.0+mod" = _kLfQNpaV;
        "pkg-1.25.1" = _qEGo6px7;
        "pkg-1.25.1+mod" = _khVCP1v4;
        "pkg-1.26.0" = _m3SSOOUV;
        "pkg-1.26.0+mod" = _hyCEJ2rc;
        "pkg-1.26.1" = _q7Iyun9W;
        "pkg-1.26.1+mod" = _KcOzumgC;
        "pkg-1.20.4_03" = _hXJAZNdo;
        "pkg-1.20.4_03+mod" = _r9kt1cS7;
        "pkg-1.26.2" = _IfKchMQC;
        "pkg-1.26.2+mod" = _IGvMRjTx;
        "pkg-1.20.4_04" = _BudTRUgU;
        "pkg-1.20.4_04+mod" = _DLnBN6Io;
        "pkg-1.26.2_01" = _AzifzPH3;
        "pkg-1.26.2_01+mod" = _BEOW79aJ;
        "default" = _BEOW79aJ;
    });
