...
let
    ...
    in {
        ...
        "pkg-0.1.4+1.19.2" = _5yr5Y911;
        "pkg-0.1.5+mc1.19.2" = _v3qtCp4n;
        "pkg-0.1.5+mc1.19.3" = _P762vbTe;
        "pkg-forge-1.1.0+mc1.20.1" = _c5beN2ls;
        "pkg-fabric-1.1.0+mc1.20.1" = _OoNIwRm0;
        "pkg-forge-1.1.1+mc1.20.1" = _5pUxyTP9;
        "pkg-fabric-1.1.1+mc1.20.1" = _snwqJj9A;
        "pkg-fabric-1.1.2+mc1.20.1" = _BslzSzGd;
        "pkg-forge-1.1.2+mc1.20.1" = _cwzXpY1E;
        "pkg-2.0.0+mc1.20.1" = _aB4YDafn;
        "pkg-2.0.0+mc1.20.4" = _wVhb4ro2;
        "pkg-2.0.0+mc1.20.6" = _lCz7RMci;
        "pkg-2.0.0+mc1.21.1" = _MFP2nfPE;
        "pkg-2.1.0+mc1.20.4" = _NWuZnmzx;
        "pkg-2.1.0+mc1.20.1" = _Coo8ZTx2;
        "pkg-2.1.0+mc1.20.6" = _fe0JAtVl;
        "pkg-2.1.0+mc1.21.1" = _kdfEzpfJ;
        "pkg-2.1.1+mc1.20.1" = _ek4naojI;
        "pkg-2.1.1+mc1.20.4" = _Ulixazyr;
        "pkg-2.1.1+mc1.20.6" = _eqRGXgwS;
        "pkg-2.1.1+mc1.21.1" = _5BsSPAa9;
        "pkg-2.1.2+mc1.20.1" = _pdiWF9H8;
        "pkg-2.1.2+mc1.20.4" = _D2cH6nk0;
        "pkg-2.1.2+mc1.20.6" = _p79jSMhH;
        "pkg-2.1.2+mc1.21.1" = _gK260vKX;
        "pkg-2.1.3+mc1.20.4" = _X5lehnvT;
        "pkg-2.1.3+mc1.20.1" = _GXx6RyO3;
        "pkg-2.1.3+mc1.20.6" = _JPeP0gCe;
        "pkg-2.1.3+mc1.21.1" = _eWAeFO56;
        "pkg-2.1.4+mc1.20.4" = _kFEBB6uS;
        "pkg-2.1.4+mc1.20.1" = _3oY5ykB4;
        "pkg-2.1.4+mc1.20.6" = _8oJ83CEK;
        "pkg-2.1.4+mc1.21.1" = _bngRZDFw;
        "pkg-2.1.5+mc1.20.4" = _I7V8Ycj7;
        "pkg-2.1.5+mc1.20.1" = _veoEeVpk;
        "pkg-2.1.5+mc1.20.6" = _WIauSDB2;
        "pkg-2.1.5+mc1.21.1" = _8t6Kpge9;
        "pkg-2.1.6+mc1.20.4" = _5ej9JOpG;
        "pkg-2.1.6+mc1.20.1" = _i1zyA9dn;
        "pkg-2.1.6+mc1.20.6" = _WuNZmcsp;
        "pkg-2.1.6+mc1.21.1" = _S6Q6duUj;
        "default" = _S6Q6duUj;
    });
