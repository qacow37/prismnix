...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.1+forge" = _YfOv6135;
        "pkg-1.0.0+1.21.1+neoforge" = _EFFKEtWj;
        "pkg-1.0.0+1.21.4+neoforge" = _hIBqttxO;
        "pkg-1.0.0+1.21.5+neoforge" = _TUsei8GM;
        "pkg-1.0.0+1.21.8+neoforge" = _GY0Ng89V;
        "pkg-1.0.0+1.21.10+neoforge" = _rEpISMjk;
        "pkg-1.0.0+1.21.11+neoforge" = _3xPSw1nk;
        "pkg-1.0.0+26.1+neoforge" = _TPd4kwj9;
        "pkg-1.0.0+1.20.1+fabric" = _geuKeFEl;
        "pkg-1.0.0+1.20.4+fabric" = _fRdWaZO8;
        "pkg-1.0.0+1.21.1+fabric" = _rCDNA1ju;
        "pkg-1.0.0+1.21.4+fabric" = _lPIeiNHl;
        "pkg-1.0.0+1.21.5+fabric" = _xG2uf31I;
        "pkg-1.0.0+1.21.8+fabric" = _x4KjbjQ3;
        "pkg-1.0.0+1.21.10+fabric" = _gUg8a9m9;
        "pkg-1.0.0+1.21.11+fabric" = _THyDTmzN;
        "pkg-1.0.0+26.1+fabric" = _57iBH3on;
        "pkg-1.0.1+1.20.1+forge" = _oxRUgRAm;
        "pkg-1.0.1+1.21.1+neoforge" = _AWH0Ycuw;
        "pkg-1.0.1+1.21.4+neoforge" = _ELkNarU2;
        "pkg-1.0.1+1.21.5+neoforge" = _TH7mRP2d;
        "pkg-1.0.1+1.21.8+neoforge" = _AulWu5Hy;
        "pkg-1.0.1+1.21.10+neoforge" = _5vtWsf6G;
        "pkg-1.0.1+1.21.11+neoforge" = _uWQYIDCw;
        "pkg-1.0.1+26.1+neoforge" = _eRnKc43p;
        "pkg-1.0.1+26.2+neoforge" = _vUJRbTUw;
        "pkg-1.0.1+1.20.1+fabric" = _uXgYl97Y;
        "pkg-1.0.1+1.20.4+fabric" = _SSDfBCtE;
        "pkg-1.0.1+1.21.1+fabric" = _IrBKyGtB;
        "pkg-1.0.1+1.21.4+fabric" = _aeLIZP9t;
        "pkg-1.0.1+1.21.5+fabric" = _AQW9x7I7;
        "pkg-1.0.1+1.21.8+fabric" = _eCD6a9v1;
        "pkg-1.0.1+1.21.10+fabric" = _r6M5QjMb;
        "pkg-1.0.1+1.21.11+fabric" = _84WiysyP;
        "pkg-1.0.1+26.1+fabric" = _2fNSuSXm;
        "pkg-1.0.1+26.2+fabric" = _GKXO9gpo;
        "default" = _GKXO9gpo;
    });
