...
let
    ...
    in {
        ...
        "pkg-2.7.1" = _XJv0jYnp;
        "pkg-2.7.2" = _NvJ8cQyl;
        "pkg-2.7.3-Modern" = _h5U2FcQN;
        "pkg-2.7.3-Legacy" = _aT2xedhL;
        "pkg-2.7.4-Legacy" = _NTxESqUa;
        "pkg-2.7.4-Modern" = _wuIbX7p9;
        "pkg-2.7.5-Legacy" = _ZscmC93j;
        "pkg-2.7.5-Modern" = _C8l8heE6;
        "pkg-2.7.6-Legacy" = _RyGvu6ra;
        "pkg-2.7.6-Modern" = _Cyhwtozw;
        "pkg-2.7.7-Modern" = _tM90thf8;
        "pkg-2.7.7-Legacy" = _ydPngXep;
        "pkg-2.7.8-Modern" = _M7fHDsSi;
        "pkg-2.7.8-Legacy" = _IDVpJIhD;
        "pkg-2.7.9-Modern" = _tQ99lu8L;
        "pkg-2.7.9-Legacy" = _aAoRdzDC;
        "pkg-2.7.10-Modern" = _OMvSdl1x;
        "pkg-2.7.10-Legacy" = _pkzaESX1;
        "pkg-2.7.11-Modern" = _DSkFHSze;
        "pkg-2.7.11-Legacy" = _avODXCaQ;
        "pkg-2.7.12-Legacy" = _d0Q8Lwv2;
        "pkg-2.7.12-Modern" = _xCZkiqjU;
        "default" = _xCZkiqjU;
    });
