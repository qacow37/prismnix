...
let
    ...
    in {
        ...
        "pkg-1.0" = _SmmtiYaY;
        "pkg-1.0_mod" = _OtzomN1A;
        "pkg-1.1" = _zFiHae9A;
        "pkg-1.2" = _zUu6AbYw;
        "pkg-1.2+mod" = _3Tz90LyT;
        "pkg-1.4" = _zjm3cDie;
        "pkg-1.4+mod" = _BRkQlNxt;
        "pkg-1.5" = _aqENVfCw;
        "pkg-1.5+mod" = _vFPCyOE9;
        "pkg-2.0" = _dFwS3uTE;
        "pkg-2.0+mod" = _KkusokFK;
        "pkg-2.1" = _khf4rqth;
        "pkg-3.0" = _gM08GaJZ;
        "pkg-3.0+mod" = _cJV4xEFE;
        "pkg-3.1" = _nUbge9a9;
        "pkg-3.1+mod" = _ILQ3BvKt;
        "pkg-3.2" = _fSzbjycc;
        "pkg-3.3" = _l9vgjEVe;
        "pkg-3.3+mod" = _uBtX36Lr;
        "pkg-3.4" = _8ov1vd0M;
        "pkg-3.4+mod" = _y6v1ZN9r;
        "pkg-3.5" = _am1NdaqW;
        "pkg-3.5+mod" = _xxhFopxV;
        "pkg-3.6" = _bheFAsMy;
        "pkg-3.6+mod" = _9uLUsavS;
        "pkg-3.7" = _JdrIvIlb;
        "pkg-3.7-fabric" = _LFIh386H;
        "pkg-3.7-forge" = _7uw6oiww;
        "pkg-3.11" = _bJCR23lO;
        "pkg-3.11-fabric" = _pETKIjcW;
        "pkg-3.11-quilt" = _JBo9ZHRr;
        "pkg-3.11-forge" = _4v1hFflj;
        "pkg-3.11-neoforge" = _i6HnCh4J;
        "pkg-3.12" = _WynBsMSh;
        "pkg-3.12-fabric" = _HIGXAuDA;
        "pkg-3.12-quilt" = _xV6Yiewa;
        "pkg-3.12-forge" = _hz1t1amz;
        "pkg-3.12-neoforge" = _5klcNXSZ;
        "default" = _5klcNXSZ;
    });
