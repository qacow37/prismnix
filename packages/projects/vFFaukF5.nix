...
let
    ...
    in {
        ...
        "pkg-0.0.1" = _z8NxRc13;
        "pkg-0.0.2" = _i0BdGAMk;
        "pkg-0.1.0-neoforge" = _5UXaLhjV;
        "pkg-0.1.0-fabric" = _zRHh57rA;
        "pkg-0.1.1-neoforge" = _kvOgRrIr;
        "pkg-0.2.0-fabric+1.21" = _WnZ2OjZB;
        "pkg-0.2.0-fabric+1.21.3" = _RZQDWfqn;
        "pkg-0.2.0-fabric+1.21.4" = _P6v7sJkM;
        "pkg-0.2.1-fabric+1.21" = _GINl2ktY;
        "pkg-0.2.1-fabric+1.21.3" = _8QhZhWPu;
        "pkg-0.2.1-fabric+1.21.4" = _2hDkZCoo;
        "pkg-0.2.2-fabric+1.21" = _yx8bMWX6;
        "pkg-0.2.2-fabric+1.21.3" = _eRBqo98j;
        "pkg-0.2.2-fabric+1.21.4" = _eJ43UekF;
        "pkg-0.2.2-neoforge+1.21" = _ISWSXtQL;
        "pkg-0.2.2-neoforge+1.21.3" = _w8cIiGhj;
        "pkg-0.2.2-neoforge+1.21.4" = _64BJcwLG;
        "pkg-0.2.3-fabric+1.21" = _cQaBeEgC;
        "pkg-0.2.3-fabric+1.21.3" = _TB6WWhFG;
        "pkg-0.2.3-fabric+1.21.4" = _CagDqsJV;
        "pkg-0.2.3-neoforge+1.21" = _42fC7Sd3;
        "pkg-0.2.3-neoforge+1.21.3" = _hYgZpWy3;
        "pkg-0.2.3-neoforge+1.21.4" = _5muhLgGG;
        "pkg-0.2.4-fabric+1.21" = _MnHzjRZV;
        "pkg-0.2.4-fabric+1.21.3" = _bgZBdzdc;
        "pkg-0.2.4-fabric+1.21.4" = _JyFfDbK4;
        "pkg-0.2.4-neoforge" = _l7fsO20d;
        "default" = _l7fsO20d;
    });
