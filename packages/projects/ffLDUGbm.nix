...
let
    ...
    in {
        ...
        "pkg-1.0.3+1.20.1+fabric" = _EED4SM4M;
        "pkg-1.0.3+1.21.1+fabric" = _8HBbK32w;
        "pkg-1.0.3+1.21.4+fabric" = _txYwi2kB;
        "pkg-1.0.3+1.21.5+fabric" = _fegLl0nd;
        "pkg-1.0.3+1.21.6+fabric" = _BWpFX3MH;
        "pkg-1.0.3+1.21.7+fabric" = _Ji4eCpzG;
        "pkg-1.0.3+1.21.8+fabric" = _ZxtyMLKR;
        "pkg-1.0.3+1.21.9+fabric" = _ez4NARo2;
        "pkg-1.0.3+1.21.10+fabric" = _jR8pZYe8;
        "pkg-1.0.4+1.20.1+forge" = _pL12CtVy;
        "pkg-1.0.4+1.21.1+neoforge" = _siddvQLL;
        "pkg-1.0.4+1.21.10+neoforge" = _zflXuVaC;
        "pkg-1.0.4+1.20.1+fabric" = _DaHEF7Zo;
        "pkg-1.0.4+1.21.1+fabric" = _YjZNyZpk;
        "pkg-1.0.4+1.21.4+fabric" = _R8wAKyk6;
        "pkg-1.0.4+1.21.5+fabric" = _EUOaRXVu;
        "pkg-1.0.4+1.21.6+fabric" = _ZcXxifFP;
        "pkg-1.0.4+1.21.7+fabric" = _mYJax1ts;
        "pkg-1.0.4+1.21.8+fabric" = _OI6XfJ5C;
        "pkg-1.0.4+1.21.9+fabric" = _cOV4Gki8;
        "pkg-1.0.4+1.21.10+fabric" = _m2xoJHtz;
        "pkg-1.0.4+1.21.11+neoforge" = _ZUvbGBs1;
        "pkg-1.0.4+1.21.11+fabric" = _7HOlFfuh;
        "pkg-1.0.5+1.21.1+neoforge" = _oQnviVr0;
        "pkg-1.0.5+1.20.1+fabric" = _tbclqoYS;
        "pkg-1.0.5+1.20.1+forge" = _FRH7oiCB;
        "pkg-1.0.5+1.21.10+neoforge" = _gJUu7tu8;
        "pkg-1.0.5+1.21.1+fabric" = _sHwgYsHp;
        "pkg-1.0.5+1.21.11+neoforge" = _SkE5B70Q;
        "pkg-1.0.5+1.21.4+fabric" = _Ccpu7VpS;
        "pkg-1.0.5+1.21.5+fabric" = _vXiOgV5S;
        "pkg-1.0.5+1.21.6+fabric" = _6wnRqS9V;
        "pkg-1.0.5+1.21.7+fabric" = _16YpWnGX;
        "pkg-1.0.5+1.21.8+fabric" = _UsaiupXT;
        "pkg-1.0.5+1.21.9+fabric" = _4ohVNHNE;
        "pkg-1.0.5+1.21.10+fabric" = _1XLTjCUs;
        "pkg-1.0.5+1.21.11+fabric" = _p83vq887;
        "pkg-1.1.0+1.20.1+fabric" = _j6bXQ5V5;
        "pkg-1.1.0+1.21.1+fabric" = _dL53YwI5;
        "pkg-1.1.0+1.21.4+fabric" = _qQP9uWKc;
        "pkg-1.1.0+1.21.5+fabric" = _bcgeUHNk;
        "pkg-1.1.0+1.21.6+fabric" = _rdbOWE2D;
        "pkg-1.1.0+1.21.7+fabric" = _SO43mpTX;
        "pkg-1.1.0+1.21.8+fabric" = _H3MeapgP;
        "pkg-1.1.0+1.21.9+fabric" = _LgBeAmAd;
        "pkg-1.1.0+1.21.10+fabric" = _J3eP4u2O;
        "pkg-1.1.0+1.21.11+fabric" = _6SVXscXs;
        "pkg-1.1.0+1.20.1+forge" = _tT5NL3ck;
        "pkg-1.1.0+1.21.1+neoforge" = _eXqQAiDq;
        "pkg-1.1.0+1.21.10+neoforge" = _DmzL4Ud2;
        "pkg-1.1.0+1.21.11+neoforge" = _JMqGqqRa;
        "pkg-1.1.0+26.1+fabric" = _OtEsyeDx;
        "pkg-1.1.0+26.1+neoforge" = _dY6M9OhM;
        "pkg-1.3.0+1.20.1+fabric" = _wwVPK5Bn;
        "pkg-1.3.0+1.21.1+fabric" = _HmShQbcB;
        "pkg-1.3.0+1.21.4+fabric" = _db37Xv7K;
        "pkg-1.3.0+1.21.5+fabric" = _cwTrjo9C;
        "pkg-1.3.0+1.21.8+fabric" = _gFx1dVDj;
        "pkg-1.3.0+1.21.10+fabric" = _RfpvMMcb;
        "pkg-1.3.0+1.21.11+fabric" = _vAwOEc4v;
        "pkg-1.3.0+26.1+fabric" = _mcALzvdn;
        "pkg-1.3.0+1.21.1+neoforge" = _xX1t0g41;
        "pkg-1.3.0+1.21.10+neoforge" = _SY0RhYj6;
        "pkg-1.3.0+1.21.11+neoforge" = _LgzDcsu5;
        "pkg-1.3.0+26.1+neoforge" = _MPfTzFYz;
        "pkg-1.3.0+1.20.1+forge" = _HzcP32St;
        "pkg-1.4.0+1.20.1+fabric" = _r5HwAhaP;
        "pkg-1.4.0+1.21.1+fabric" = _YY5FDVRy;
        "pkg-1.4.0+1.21.4+fabric" = _nfqQTal2;
        "pkg-1.4.0+1.21.5+fabric" = _1Wryz0fb;
        "pkg-1.4.0+1.21.8+fabric" = _VDfJXUEN;
        "pkg-1.4.0+1.21.10+fabric" = _GItAUzHP;
        "pkg-1.4.0+1.21.11+fabric" = _lt1N158r;
        "pkg-1.4.0+26.1+fabric" = _VeHy34RO;
        "pkg-1.4.0+1.21.1+neoforge" = _fDm6GVFP;
        "pkg-1.4.0+1.21.10+neoforge" = _zMbeeO2f;
        "pkg-1.4.0+1.21.11+neoforge" = _gaJ6M9c5;
        "pkg-1.4.0+26.1+neoforge" = _EvR15GRg;
        "pkg-1.4.0+1.20.1+forge" = _qJE7Ogss;
        "pkg-1.5.0+1.20.1+fabric" = _fTFQmxAC;
        "pkg-1.5.0+1.21.1+fabric" = _IuKEg8pG;
        "pkg-1.5.0+1.21.11+fabric" = _Ami8thh8;
        "pkg-1.5.0+26.1+fabric" = _O2Pxh9e1;
        "pkg-1.5.0+26.2+fabric" = _AMj4XA2a;
        "pkg-1.5.0+1.21.1+neoforge" = _hCxrHerd;
        "pkg-1.5.0+1.21.11+neoforge" = _QjfAqGKF;
        "pkg-1.5.0+26.1+neoforge" = _eCQsMFpb;
        "pkg-1.5.0+26.2+neoforge" = _FPHduoka;
