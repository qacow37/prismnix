...
let
    ...
    in {
        ...
        "pkg-1.18-1.0.0" = _38ZG3B1G;
        "pkg-1.19-1.0.0" = _Gqp36cAh;
        "pkg-1.20-1.0.0" = _miZGvcra;
        "pkg-1.19-1.0.0-fabric" = _4zrlJgKo;
        "pkg-1.18-1.0.0-fabric" = _xX5NzqjF;
        "pkg-1.18-1.1.0" = _6j5atv2M;
        "pkg-1.19-1.1.0" = _lmw58hUb;
        "pkg-1.20-1.1.0" = _PHVyloX8;
        "pkg-1.18-1.1.0-fabric" = _utLUiM1x;
        "pkg-1.19-1.1.0-fabric" = _hQpNetXG;
        "pkg-1.20-1.1.0-fabric" = _s0Qv9vI1;
        "pkg-1.20-1.1.1" = _WYKnYl7N;
        "pkg-1.20-1.1.1-fabric" = _JQodU7v0;
        "pkg-1.18-1.1.1" = _XNfjXQcm;
        "pkg-1.19-1.1.1" = _pZVJjwhQ;
        "pkg-1.20-1.1.2" = _j1Vh4xp4;
        "pkg-1.18-1.1.1-fabric" = _rbw9FRLD;
        "pkg-1.19-1.1.1-fabric" = _UkuUd8fK;
        "pkg-1.20-1.1.2-fabric" = _obAUJrZ0;
        "pkg-1.18-1.2.0" = _JaF12E7L;
        "pkg-1.19-1.2.0" = _7mEXlYxh;
        "pkg-1.20-1.2.0" = _xhDB4Y9w;
        "pkg-1.18-1.2.0-fabric" = _kVcysi6E;
        "pkg-1.19-1.2.0-fabric" = _pJAkCmlD;
        "pkg-1.20-1.2.0-fabric" = _LIcSXsRE;
        "pkg-1.18-1.2.1" = _gDCzjZxT;
        "pkg-1.19-1.2.1" = _HWRcg1Wl;
        "pkg-1.20-1.2.1" = _m08yLfX4;
        "pkg-1.18-1.2.1-fabric" = _rOu8fCZs;
        "pkg-1.19-1.2.1-fabric" = _cE5dE02U;
        "pkg-1.20-1.2.1-fabric" = _zo3MUFDm;
        "pkg-1.21-1.2.2" = _qIfb6y4t;
        "pkg-1.21-1.2.2-fabric" = _y79J9XLn;
        "pkg-1.18-1.2.2-fabric" = _HmzbFhIq;
        "pkg-1.19-1.2.2-fabric" = _5sfHi2ZU;
        "pkg-1.20-1.2.2-fabric" = _eZtY3QsU;
        "pkg-1.20-1.3.0" = _9B5CPuxC;
        "pkg-1.21-1.3.0" = _pS7OROMk;
        "pkg-1.20-1.3.0-fabric" = _45JnCEaJ;
        "pkg-1.21-1.3.0-fabric" = _tEEMnKM7;
        "pkg-1.20-1.3.1" = _cVKrrVdt;
        "pkg-1.21-1.3.1" = _y8svVJBV;
        "pkg-1.20-1.3.1-fabric" = _EuxLhYvY;
        "pkg-1.21-1.3.1-fabric" = _AqBcfeck;
        "default" = _AqBcfeck;
    });
