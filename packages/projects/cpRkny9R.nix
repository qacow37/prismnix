...
let
    ...
    in {
        ...
        "pkg-3.0.2" = _rjJMbJbv;
        "pkg-3.0.3" = _r9DqVW1O;
        "pkg-build.55+mc1.20.1" = _Saf0DF5b;
        "pkg-build.54+mc1.20" = _Fpxu23Tv;
        "pkg-build.53+mc1.19.4" = _JrdidSRq;
        "pkg-build.45+mc1.18.2" = _d21GPkti;
        "pkg-build.42+mc1.18.2" = _Io5LFdBp;
        "pkg-build.36+mc1.18.2" = _5p5RTqz7;
        "pkg-build.35+mc1.18.2" = _jcmaEECN;
        "pkg-build.34+mc1.18.2" = _lrwIfXTn;
        "pkg-build.33+mc1.19.2" = _BGmcHGA9;
        "pkg-build.32+mc1.19.2" = _KHFnFVYy;
        "pkg-build.31+mc1.18.2" = _OLG1JNBU;
        "pkg-build.30+mc1.19.2" = _J6kprmMy;
        "pkg-build.29+mc1.18.2" = _G45aDN2Q;
        "pkg-build.28+mc1.18.2" = _Xqu7zOjJ;
        "pkg-build.27+mc1.19.2" = _8jpu2axy;
        "pkg-build.26+mc1.19.2" = _TQUkqZoW;
        "pkg-build.25+mc1.19.2" = _bzXswSq4;
        "pkg-build.24+mc1.19.2" = _ImGsY7Ze;
        "pkg-build.23+mc1.19.2" = _1xGNi3Qn;
        "pkg-build.21+mc1.19.2" = _NIY8GH22;
        "pkg-build.20+mc1.19.1" = _S47yLqhq;
        "pkg-build.18+mc1.19" = _GU5BNZYi;
        "pkg-build.19+mc1.19.1" = _kzHLTb04;
        "pkg-build.17+mc1.19" = _xZRPQKNi;
        "pkg-build.16+mc1.19" = _bSMkTxRu;
        "pkg-build.15+mc1.19" = _DVfhBZDv;
        "pkg-build.14+mc1.18.2" = _rEGTr7rW;
        "pkg-build.13+mc1.18.2" = _XWu2gWUQ;
        "pkg-build.12+mc1.18.2" = _hvk5iGUX;
        "pkg-build.11+mc1.18.1" = _56tEdv2I;
        "pkg-build.10+mc1.18.1" = _uaRvxckM;
        "pkg-build.9+mc1.18.1" = _1G4RK2MV;
        "pkg-build.8+mc1.18" = _wT03uEnp;
        "pkg-build.7+mc1.18" = _joZyTTZD;
        "pkg-forge" = _an5zwVJE;
        "pkg-build.6+mc1.17.1" = _4ao2I8Zp;
        "pkg-build.4+mc1.17.1" = _sBK39Ax0;
        "pkg-build.3+mc1.17.1" = _cad32Jhv;
        "pkg-build.2+mc1.17.1" = _GN23UgeH;
        "pkg-1.0.1" = _JU3Ye1eV;
        "pkg-1.0.0" = _6U7jiYpO;
        "pkg-1.5.0" = _60vVxbmG;
        "pkg-1.4.0" = _WIf0732c;
        ...
        "pkg-1.1.3" = _ZdisHPkg;
        "pkg-1.1.2" = _ShnY5Nci;
        "pkg-build.49+mc1.19.3" = _Ytp12KYn;
        "pkg-4.0.0" = _6eJsf0PA;
        "pkg-4.1.0" = _h8yzewlC;
        "pkg-21.0.0" = _sutJi4Sy;
        "pkg-21.0.1" = _jdlgQ5EB;
        "pkg-21.0.2" = _iTIetlP7;
        "pkg-21.1.0" = _eBCFJvvm;
        "pkg-21.1.1" = _1f2T0vKt;
        "pkg-21.1.2" = _l401evM2;
        "default" = _l401evM2;
    });
