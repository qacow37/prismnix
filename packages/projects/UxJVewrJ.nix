...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.1-fabric+forge+neo" = _wVNJRCjp;
        "pkg-1.20.2-1.1-fabric+forge+neo" = _myW2Daj1;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _8d9ef0HT;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _Cmr09kQx;
        "pkg-1.20.2-1.2-fabric+forge+neo" = _U666WiuH;
        "pkg-1.20.4-1.2-fabric+forge+neo" = _hC1v2DDs;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _PJZnpe09;
        "pkg-1.20.4-1.3-fabric+forge+neo" = _91NGEFiJ;
        "pkg-1.20.5-1.3-fabric+neo" = _2EgNVegj;
        "pkg-1.20.6-1.3-fabric+forge+neo" = _RHWM2xMN;
        "pkg-1.21.0-1.3-fabric+forge+neo" = _iXwlZojI;
        "pkg-1.20.1-1.4-fabric+forge+neo" = _tMrWQF9b;
        "pkg-1.20.6-1.4-fabric+forge+neo" = _HijsmbCU;
        "pkg-1.21.0-1.4-fabric+forge+neo" = _ogqosM5K;
        "pkg-1.21.1-1.4-fabric+forge+neo" = _1kYuKyAt;
        "pkg-1.21.2-1.4-fabric+neo" = _kVKTDQkd;
        "pkg-1.21.3-1.4-fabric+forge+neo" = _SSgSX1nB;
        "pkg-1.21.4-1.4-fabric+forge+neo" = _49Cp28wl;
        "pkg-1.21.5-1.4-fabric+forge+neo" = _MW2aaMOP;
        "pkg-1.21.6-1.4-fabric+forge+neo" = _7UweMQSy;
        "pkg-1.21.7-1.4-fabric+forge+neo" = _IROxaIQQ;
        "pkg-1.21.8-1.4-fabric+forge+neo" = _fUxQqAR2;
        "pkg-1.21.9-1.4-fabric+forge+neo" = _Zj7U4Jdj;
        "pkg-1.21.10-1.4-fabric+forge+neo" = _QPrjLwpy;
        "pkg-1.21.11-1.4-fabric+forge+neo" = _DmJK6Uba;
        "pkg-26.1.0-1.4-fabric+forge+neo" = _HPUtlxik;
