...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.20.1-fabric" = _6ANjkwQz;
        "pkg-1.0.1+1.20.1-forge" = _hECN4RGq;
        "pkg-1.0.1+1.21.1-fabric" = _s1YqkyRA;
        "pkg-1.0.1+1.21.1-neoforge" = _CuWl9fBi;
        "pkg-1.0.2+1.20.1-fabric" = _Rlbd3iAi;
        "pkg-1.0.2+1.20.1-forge" = _S7hroMya;
        "pkg-1.0.2+1.21.1-fabric" = _KgYrARGR;
        "pkg-1.0.2+1.21.1-neoforge" = _t1RemUqU;
        "pkg-1.0.3+1.20.1-fabric" = _XIWKcnMf;
        "pkg-1.0.3+1.20.1-forge" = _yevFrVD4;
        "pkg-1.0.3+1.21.1-fabric" = _xercpv0G;
        "pkg-1.0.3+1.21.1-neoforge" = _zdZf5C6P;
        "pkg-1.0.4+1.20.1-fabric" = _YOWG7QaE;
        "pkg-1.0.4+1.20.1-forge" = _5UMZlDAk;
        "pkg-1.0.4+1.21.1-fabric" = _lUQ1HNUg;
        "pkg-1.0.4+1.21.1-neoforge" = _U23PyL82;
        "pkg-1.0.5+1.20.1-fabric" = _U65UVU5a;
        "pkg-1.0.5+1.20.1-forge" = _56FWqJ7d;
        "pkg-1.0.5+1.21.1-fabric" = _T7s97cF4;
        "pkg-1.0.5+1.21.1-neoforge" = _3Fp65npI;
        "pkg-1.0.6+1.20.1-fabric" = _5X4fB0hS;
        "pkg-1.0.6+1.20.1-forge" = _Kb3l9d4n;
        "pkg-1.0.6+1.21.1-fabric" = _hgY6Rba5;
        "pkg-1.0.6+1.21.1-neoforge" = _EJnlPzwh;
        "pkg-1.0.7+1.20.1-fabric" = _SrQBc027;
        "pkg-1.0.7+1.20.1-forge" = _SrMjVLOa;
        "pkg-1.0.7+1.21.1-fabric" = _47ws8Z0w;
        "pkg-1.0.7+1.21.1-neoforge" = _LitgXy0Y;
        "pkg-1.1.0+1.20.1-fabric" = _DXi0tRhO;
        "pkg-1.1.0+1.20.1-forge" = _XKZcaWag;
        "pkg-1.1.0+1.21.1-fabric" = _MOEN9Q9I;
        "pkg-1.1.0+1.21.1-neoforge" = _G8GHtm8c;
        "pkg-1.2.0+1.20.1-fabric" = _TMBMqDkd;
        "pkg-1.2.0+1.20.1-forge" = _JgFyOBpH;
        "pkg-1.2.0+1.21.1-fabric" = _Fzy97vCh;
        "pkg-1.2.0+1.21.1-neoforge" = _C3fFXGy1;
        "pkg-1.2.1+1.20.1-fabric" = _eWnFH87n;
        "pkg-1.2.1+1.20.1-forge" = _lspwvDJW;
        "pkg-1.2.1+1.21.1-fabric" = _W3naEwKe;
        "pkg-1.2.1+1.21.1-neoforge" = _HT2dh1w8;
        "pkg-1.2.2+1.20.1-fabric" = _lyH6q4ME;
        "pkg-1.2.2+1.20.1-forge" = _UcSjjx4l;
        "pkg-1.2.2+1.21.1-fabric" = _epYGWzop;
        "pkg-1.2.2+1.21.1-neoforge" = _eEN5VSlV;
        "pkg-1.3.0+1.16.5-fabric" = _yXSSlrDu;
        "pkg-1.3.0+1.16.5-forge" = _kgTqZRw4;
        "pkg-1.3.0+1.18.2-fabric" = _nHTwwIcp;
        "pkg-1.3.0+1.18.2-forge" = _6d75WZZZ;
        "pkg-1.3.0+1.19.2-forge" = _AVmQgEK0;
        "pkg-1.3.0+1.20.1-fabric" = _jJgcwcfd;
        "pkg-1.3.0+1.20.1-forge" = _UM09o72E;
        "pkg-1.3.0+1.21.1-fabric" = _6vawSwLm;
        "pkg-1.3.0+1.21.1-neoforge" = _cBudaJke;
        "pkg-1.3.1+1.16.5-fabric" = _LyaNmDmR;
        "pkg-1.3.1+1.16.5-forge" = _N7n8dHhC;
        "pkg-1.3.1+1.18.2-fabric" = _M81M8mA4;
        "pkg-1.3.1+1.18.2-forge" = _UUSNr75p;
        "pkg-1.3.1+1.19.2-fabric" = _LqrwI0yq;
        "pkg-1.3.1+1.19.2-forge" = _NKQg1Kiv;
        "pkg-1.3.1+1.20.1-fabric" = _GrFF9ytN;
        "pkg-1.3.1+1.20.1-forge" = _njHdGbOr;
        "pkg-1.3.1+1.21.1-fabric" = _96ajpZxQ;
        "pkg-1.3.1+1.21.1-neoforge" = _Yqz71MfR;
        "pkg-1.3.2+1.16.5-fabric" = _5p7ogMIu;
        "pkg-1.3.2+1.16.5-forge" = _cDiz7q0K;
        "pkg-1.3.2+1.18.2-fabric" = _QxFDybni;
        "pkg-1.3.2+1.18.2-forge" = _2rdkXr39;
        "pkg-1.3.2+1.19.2-fabric" = _xcJljsWR;
        "pkg-1.3.2+1.19.2-forge" = _QuFjW72X;
        "pkg-1.3.2+1.20.1-fabric" = _pmyXy5qa;
        "pkg-1.3.2+1.20.1-forge" = _SaAPsP1U;
        "pkg-1.3.2+1.21.1-fabric" = _JGDoVXCY;
        "pkg-1.3.2+1.21.1-neoforge" = _MsiyjxjP;
        "default" = _MsiyjxjP;
    });
