...
let
    ...
    in {
        ...
        "pkg-0.10.1" = _OEV9MtWt;
        "pkg-0.10.2" = _OXSlU6GY;
        "pkg-0.10.3" = _Ii7cv0Qz;
        "pkg-0.10.4" = _VvlyRHUy;
        "pkg-0.10.4.1" = _DnswZxvY;
        "pkg-0.10.5" = _7cIeFB4L;
        "pkg-0.10.6" = _VFbxORDA;
        "pkg-0.10.7-rc1+1.19.2" = _V3oF1a8J;
        "pkg-0.10.7-rc2-1.19.2" = _yxwzv3OK;
        "pkg-0.10.7-rc4-BETA-1.19.2" = _bBOe2Szc;
        "pkg-0.10.7-rc4-BETA-1.19.3" = _4CoJb6Go;
        "pkg-0.10.7+1.19.2" = _638l6NBP;
        "pkg-0.10.7-BETA-1.19.3" = _e3A2Jheu;
        "pkg-0.10.8+1.19.2" = _jxE0Rtp7;
        "pkg-0.10.8+1.19.3" = _wsTNBQEY;
        "pkg-0.10.8+1.19.4" = _grMZ1EvB;
        "pkg-0.10.9-pre1+1.19.2" = _ro1qobq7;
        "pkg-0.10.9-pre2+1.19.2" = _8B8i1led;
        "pkg-0.10.9-rc1+1.19.2" = _mQqntjWS;
        "pkg-0.10.9-rc1+1.19.3" = _ZB8zUgF6;
        "pkg-0.10.9-rc1+1.18.2" = _9oG3Yly4;
        "pkg-0.10.9-rc1+1.19.4" = _cpTR4z7G;
        "pkg-0.10.9-rc2+1.19.2" = _3oFbUAzi;
        "pkg-0.10.9-rc3+1.19.2" = _ntnFdLLQ;
        "pkg-0.10.9-rc3+1.19.3" = _QzLKpa85;
        "pkg-0.10.9-rc3+1.19.4" = _IETlwTC3;
        "pkg-0.10.9-rc3+1.20-pre5" = _tY3Hhuqa;
        "pkg-0.10.9-rc3+1.18.2" = _um2N384c;
        "pkg-0.10.9+1.19.2" = _9NNlGeGd;
        "pkg-0.10.9+1.19.3" = _Uwd40zi3;
        "pkg-0.10.9+1.19.4" = _M7uLgMBj;
        "pkg-0.10.9+1.20-pre5" = _UQjwpaQ9;
        "pkg-0.10.9+1.18.2" = _hgsDSoRk;
        "pkg-0.10.9+1.20" = _WDUgq4SL;
        "pkg-0.10.9.1+1.20" = _78WMklDU;
        "pkg-0.10.9.2+1.20" = _99wyuKcx;
        "pkg-0.10.10-rc1+1.19.2" = _Aj1iKBKm;
        "pkg-0.10.9.2+1.20.1" = _pqWwipLd;
        "pkg-0.10.9.3+1.20.1" = _l9qMC8Sc;
        "pkg-0.10.9.4+1.20.1" = _euq80e1A;
        "pkg-0.10.10-rc2+1.19.2" = _xQ6TleUc;
        "pkg-0.10.10+1.19.2-rc3" = _9Q6SxS74;
        "pkg-0.10.10+1.19.2" = _xyRCIryP;
        "pkg-0.11-rc-1+1.19.2" = _1VsiWe36;
        "pkg-0.11+1.19.2" = _HWVN0BMl;
        "pkg-0.11.1+1.19.2" = _B5QudfbA;
        "pkg-0.11.1+1.20.1" = _bhhxLobO;
        "pkg-0.11.2+1.19.2" = _Dqn5EKII;
        "pkg-0.11.2+1.20.1" = _7nZYRERo;
        "pkg-0.11.3+1.19.2" = _iC0z6YcP;
        "pkg-0.11.3+1.20.1" = _KyTdVYcX;
        "pkg-0.11.3+1.20.2" = _lMtTWvQK;
        "pkg-0.11.4+1.19.2" = _fZb7yheE;
        "pkg-0.11.4+1.20.1" = _1Js8Zch0;
        "pkg-0.11.4+1.20.2" = _bNKQe4kV;
        "pkg-0.11.5+1.19.2" = _OX8ZhG9E;
        "pkg-0.11.5+1.20.1" = _qGIxHQBP;
        "pkg-0.11.5+1.20.2" = _9pNuXbt6;
        "pkg-0.11.6-rc-1+1.19.2" = _NYOpz5uL;
        "pkg-0.11.6-rc-2+1.19.2" = _9wtMtXSJ;
        "pkg-0.11.5.1+1.20.1" = _ARvcQKks;
        "pkg-0.11.6-rc-3+1.19.2" = _R9K3lL35;
        "pkg-0.11.6-rc-4+1.19.2" = _bzpPAuGZ;
        "pkg-0.11.6-rc-4+1.20.1" = _M5uzWVbU;
        "pkg-0.11.6+1.19.2" = _u5nyHxki;
        "pkg-0.11.6+1.20.1" = _GAsfCX77;
        "pkg-0.11.7+1.19.2" = _ubXji2vQ;
        "pkg-0.11.7+1.20.1" = _QsM7bvSV;
        "pkg-0.11.8+1.20.1" = _CXkQzmff;
        "pkg-0.11.8+1.19.2" = _EcQblgSB;
        "pkg-0.11.9+1.20.1" = _c6islZal;
        "pkg-0.11.10+1.20.1" = _8hrT8eLa;
        "pkg-0.11.11+1.20.1" = _jzv2zzpA;
        "pkg-0.11.12+1.20.1" = _VUziPAYc;
        "pkg-0.12.0-rc-1+1.20.1" = _NJUfh6eN;
        "pkg-0.12.0-rc-2+1.20.1" = _E3jtruiO;
        "pkg-0.12.0-rc-3+1.20.1" = _CdTwayw0;
        "pkg-0.12.0-rc-4+1.20.1" = _JBgMcrb6;
        "pkg-0.12.0-rc-5+1.20.1" = _cmNt6jud;
        "pkg-0.12.0-rc-5+1.20.4" = _3UTRPWRt;
        "pkg-0.12.0+1.20.1" = _daiSTtfU;
        "pkg-0.12.0+1.20.4" = _vOUVx1Bm;
        "pkg-0.12.1+1.20.1" = _lMvUoGE6;
        "pkg-0.12.3+1.20.1" = _cejc2bRC;
        "pkg-0.12.4+1.20.1" = _5KNAd9wQ;
        "pkg-0.12.5+1.20.1" = _2sB2SQM5;
        "pkg-0.12.6+1.20.1" = _wCSUtTcQ;
        "pkg-0.12.7+1.20.1" = _ngdwDTho;
        "pkg-0.13-RC-1+1.20.1" = _D8DlkqjI;
        "pkg-0.12.8+1.20.1" = _LFE5DAPx;
        "pkg-0.13-RC-2+1.20.1" = _I0CTfX02;
        "pkg-0.12.9+1.20.1" = _yZwQCU4O;
        "pkg-0.13.0+1.20.1" = _J97Z2emi;
        "pkg-0.13.1+1.20.1" = _RV6DxsBl;
        "pkg-0.13.2+1.20.1" = _TAgL0gBP;
        "default" = _TAgL0gBP;
    });
