...
let
    ...
    in {
        ...
        "pkg-24.0.10beta" = _xkl2tjQ6;
        "pkg-25.0.30beta" = _SOwm8XAp;
        "pkg-25.1" = _rSMLbWeU;
        "pkg-25.2" = _5E34jRk2;
        "pkg-25.3beta" = _AeH67qvm;
        "pkg-25.3.5" = _Nri3hY2p;
        "pkg-25.4" = _hxwVACuI;
        "pkg-25.4.1" = _mKZPdFV2;
        "pkg-25.4.2" = _drKiuONN;
        "pkg-25.4.3" = _LznLSvaQ;
        "pkg-25.4.3.10" = _wrLUDnXA;
        "pkg-25.5" = _EIPDlIxL;
        "pkg-25.5.1" = _zFyVvL7F;
        "pkg-25.6" = _n1vN5N0q;
        "pkg-25.6.5" = _KaSdiZhI;
        "pkg-25.6.6" = _Q0pkLEkU;
        "pkg-25.6.7" = _gpW6yeTb;
        "pkg-25.7" = _JTgLRJjV;
        "pkg-25.7.1" = _utb4dQ6u;
        "pkg-25.7.2" = _SxL8MHgM;
        "pkg-25.7.21Beta" = _NoEijcjS;
        "pkg-25.8" = _xbbefwiE;
        "pkg-25.8.1" = _duk4ViDO;
        "pkg-25.9" = _qr1knFcI;
        "pkg-25.9.1" = _aKHmqPs0;
        "pkg-25.9.5" = _WWgQIEm5;
        "pkg-25.10" = _MA0wBiF8;
        "pkg-25.10.1" = _ENbWnYkx;
        "pkg-26.10.2" = _mHImatlF;
        "pkg-26.10.2.1" = _1RpnYdtz;
        "pkg-26.11Beta_1" = _JGKbYB6I;
        "pkg-26.11Beta_2" = _YrwPbHul;
        "pkg-26.11Beta_3" = _M791SEBe;
        "pkg-26.11" = _N7RIJnnC;
        "pkg-26.11.1" = _JpMIXJiI;
        "pkg-26.11.5" = _CAHw7n5c;
        "pkg-26.11.6" = _5F9RwDwV;
        "pkg-26.11.7" = _3LnOh443;
        "pkg-26.11.8" = _Vkgxv2Sn;
        "default" = _Vkgxv2Sn;
    });
