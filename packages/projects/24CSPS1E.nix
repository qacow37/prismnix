...
let
    ...
    in {
        ...
        "pkg-v5.0.0-1.19.3-Forge" = _c0VcZqhT;
        "pkg-v5.0.1-1.19.3-Fabric" = _5nNa2qVh;
        "pkg-v5.0.1-1.19.3-Forge" = _nqETQaM5;
        "pkg-v6.0.0-1.19.4-Fabric" = _38WzqOQU;
        "pkg-v6.0.0-1.19.4-Forge" = _N1MIWniU;
        "pkg-v7.0.0-1.20-Forge" = _pFSean0S;
        "pkg-v7.0.0-1.20-Fabric" = _TfFWv1aI;
        "pkg-v8.0.0-1.20.1-Forge" = _ADPIsMeG;
        "pkg-v8.0.0-1.20.1-Fabric" = _NwgMPRp5;
        "pkg-v3.0.0-1.18.2-Forge" = _wXbWV54t;
        "pkg-v3.0.0-1.18.2-Fabric" = _zwKOp46A;
        "pkg-v8.0.1-1.20.1-Fabric" = _3jSQHYXd;
        "pkg-v8.0.1-1.20.1-Forge" = _JcY0llah;
        "pkg-v8.1.0-1.20.1-Forge" = _G8FwZfAU;
        "pkg-v8.1.0-1.20.1-Fabric" = _iXuCtJlY;
        "pkg-v8.1.1-1.20.1-Forge" = _HlwDHWL1;
        "pkg-v8.1.1-1.20.1-Fabric" = _2PKqsWR7;
        "pkg-v20.4.0-1.20.4-Fabric" = _1UC6utfF;
        "pkg-v20.4.0-1.20.4-Forge" = _ZsZiaSPM;
        "pkg-v20.4.0-1.20.4-NeoForge" = _F8TYxmjy;
        "pkg-v20.4.1-1.20.4-Fabric" = _EvWv4KvU;
        "pkg-v20.4.1-1.20.4-Forge" = _eDCg8rSD;
        "pkg-v20.4.1-1.20.4-NeoForge" = _9hjJtPHT;
        "pkg-v21.0.0-1.21-Fabric" = _hGn7Awth;
        "pkg-v21.0.0-1.21-NeoForge" = _pnAy9WaJ;
        "pkg-v21.1.0-1.21.1-Fabric" = _CNjKTf98;
        "pkg-v21.1.0-1.21.1-NeoForge" = _Li2vsMel;
        "pkg-v21.3.0-1.21.3-Fabric" = _pvzxxOO0;
        "pkg-v21.3.0-1.21.3-NeoForge" = _QAVH6XnI;
        "pkg-v21.4.0-1.21.4-Fabric" = _ZyZht1tB;
        "pkg-v21.4.0-1.21.4-NeoForge" = _fEKz8fV1;
        "pkg-v21.4.1-1.21.4-Fabric" = _FK1jbCDD;
        "pkg-v21.4.1-1.21.4-NeoForge" = _SpMj3ZhK;
        "pkg-v21.5.0-1.21.5-Fabric" = _f06PWnVG;
        "pkg-v21.5.0-1.21.5-NeoForge" = _oXGffZ1S;
        "pkg-v21.7.0-1.21.7-Fabric" = _mJeAUiOD;
        "pkg-v21.7.0-1.21.7-NeoForge" = _R25uSwIj;
        "pkg-v21.8.0-1.21.8-Fabric" = _6BPoxxXn;
        "pkg-v21.8.0-1.21.8-NeoForge" = _6bg3ygPQ;
        "pkg-21.9.0" = _dyLEzROl;
        "pkg-21.10.0" = _QQdqJsgE;
        "pkg-21.11.0" = _wSfsuwek;
        "pkg-26.1.0" = _foRx0nDv;
        "pkg-26.1.1" = _VLMpZW2o;
