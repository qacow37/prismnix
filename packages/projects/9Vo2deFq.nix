...
let
    ...
    in {
        ...
        "pkg-0.1.4" = _9W0BZH9N;
        "pkg-0.1.5" = _yt1sCRTr;
        "pkg-0.1.5b" = _JVwuOBje;
        "pkg-0.1.6" = _xG9gBT2a;
        "pkg-0.1.6b" = _P5tr4nyl;
        "pkg-0.1.7" = _fPpvZPsM;
        "pkg-0.1.7b" = _U9wneqoO;
        "pkg-0.1.8" = _OepP5FF8;
        "pkg-0.1.9" = _g3zETYth;
        "pkg-0.1.9b" = _McJyopNa;
        "pkg-0.1.7c" = _EyrYeQyY;
        "pkg-0.1.9c" = _JSl5Um0n;
        "pkg-0.1.10" = _yz6LK9it;
        "pkg-0.1.10b" = _vOYlidWf;
        "pkg-0.1.7d" = _a7l11fbz;
        "pkg-0.1.10c" = _XxlicXKA;
        "pkg-0.1.7e" = _jQDwaWxw;
        "pkg-0.1.10d" = _HLdLDcbN;
        "pkg-0.1.11" = _Vhsk9Hta;
        "pkg-0.1.11b" = _HX3GVV8o;
        "pkg-0.1.12" = _6nf5j8mL;
        "pkg-0.1.12b" = _oe9B4zXP;
        "pkg-0.1.13" = _yuqF1Fjj;
        "pkg-0.1.13b" = _By0tny5s;
        "pkg-0.1.13c" = _Nz1CrwvD;
        "default" = _Nz1CrwvD;
    });
