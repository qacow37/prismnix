...
let
    ...
    in {
        ...
        "pkg-1.4" = _qCmLnSxy;
        "pkg-1.5" = _6p0dzN83;
        "pkg-1.5+mod" = _I22FK4xu;
        "pkg-1.6" = _B83d66qQ;
        "pkg-1.6+mod" = _wrMYk5n0;
        "pkg-1.7" = _IswgJEgs;
        "pkg-1.7+mod" = _r3WfUSTS;
        "pkg-1.8" = _RwycHyJt;
        "pkg-1.8+mod" = _Vk5sKueH;
        "pkg-1.9" = _sDbUf8us;
        "pkg-1.9+mod" = _MQCEVfnC;
        "pkg-1.9.1" = _nkCcFUOt;
        "pkg-1.9.1+mod" = _z0QNIiqR;
        "pkg-2.0" = _UfNIF5U6;
        "pkg-2.0+mod" = _v0tEzvPl;
        "pkg-2.1" = _OnS0HLbg;
        "pkg-2.1+mod" = _WE8IEdUN;
        "pkg-2.2" = _365GoOxI;
        "pkg-2.2+mod" = _7Yt7fg4Q;
        "pkg-2.3" = _BFL33Lrp;
        "pkg-2.3+mod" = _rHMeLkZF;
        "pkg-2.4" = _6HsIokuD;
        "pkg-2.4+mod" = _BMQgEEbl;
        "pkg-2.5" = _FaNfzZjo;
        "pkg-2.5+mod" = _b75FySdU;
        "default" = _b75FySdU;
    });
