...
let
    ...
    in {
        ...
        "pkg-0.1.1-mc1.16.5" = _867F0oIE;
        "pkg-0.1.1-mc1.17.1" = _6vmRVnhI;
        "pkg-0.1.1-mc1.18.2" = _ZrOwjqqN;
        "pkg-0.1.1-mc1.19.2" = _ElvLjeCs;
        "pkg-0.1.1-mc1.19.4" = _LbaNXlFn;
        "pkg-0.1.2-mc1.16.5" = _PyzrfHB1;
        "pkg-0.1.2-mc1.17.1" = _vHDyOBfI;
        "pkg-0.1.2-mc1.18.2" = _3wuG7UoR;
        "pkg-0.1.2-mc1.19.2" = _VqZOGmRL;
        "pkg-0.1.2-mc1.19.4" = _O7PxC7A3;
        "pkg-0.1.0-mc1.20.1" = _aWEPBrL7;
        "pkg-0.1.3-mc1.19.4" = _4AR8LrGv;
        "pkg-0.1.1-mc1.20.1" = _vpV2G00o;
        "pkg-0.1.3-mc1.19.2" = _6Wh1Qh8L;
        "pkg-0.1.3-mc1.16.5" = _b3NVENiP;
        "pkg-0.1.3-mc1.18.2" = _qVKAtMNh;
        "pkg-0.1.2-mc1.20.1" = _npWWOVPP;
        "pkg-0.1.4-mc1.19.4" = _UuQhlpaq;
        "pkg-0.1.4-mc1.19.2" = _cY3A1OBJ;
        "pkg-0.1.4-mc1.18.2" = _zHfPtren;
        "pkg-0.1.4-mc1.16.5" = _JQcKqnNx;
        "pkg-0.1.0-mc1.20.4" = _GVNxONva;
        "pkg-0.1.5-mc1.16.5" = _FUXAgCB5;
        "pkg-0.1.5-mc1.18.2" = _ZRivunVl;
        "pkg-0.1.5-mc1.19.2" = _EBOvJvyX;
        "pkg-0.1.4-mc1.20.1" = _dK2ZJOGe;
        "pkg-0.1.1-mc1.20.4" = _xAYy6rdJ;
        "pkg-0.1.2-mc1.20.4" = _6i4ZZBIB;
        "pkg-0.1.5-mc1.20.1" = _mFoTwEtC;
        "pkg-0.1.6-mc1.19.2" = _UQhzduo7;
        "pkg-0.1.6-mc1.18.2" = _6qs0KWBY;
        "pkg-0.1.6-mc1.16.5" = _IGUagwsu;
        "pkg-0.1.6-mc1.20.1" = _9JcBy2av;
        "pkg-0.1.2-mc1.20.6" = _TyWJ1BSM;
        "pkg-0.1.7-mc1.18.2" = _LIon1utZ;
        "pkg-0.1.7-mc1.16.5" = _cjpHk9p2;
        "pkg-0.1.7-mc1.20.1" = _nQSvjdu7;
        "pkg-0.1.7-mc1.19.2" = _eDEP9at0;
        "pkg-0.1.4-mc1.21" = _1ngNVc6f;
        "pkg-0.1.3-mc1.20.4" = _BeZ2svsG;
        "pkg-0.1.4-mc1.20.6" = _VX2EnnMM;
        "pkg-0.1.5-mc1.21" = _iBqHfOSi;
        "pkg-0.1.6-mc1.21" = _d7ccPo4u;
        "pkg-0.1.8-mc1.21.1" = _JiwCROrv;
        "pkg-0.1.9-mc1.21.1" = _1BU42CSJ;
        "pkg-0.1.9-mc1.21.3" = _cyGpDLPc;
        "pkg-0.1.10-mc1.21.1" = _qFzRI7eI;
        "pkg-0.1.11-mc1.21.1" = _1pSqdRsd;
        "pkg-0.1.11-mc1.21.3" = _48Gqisoo;
        "pkg-0.1.11-mc1.21.4" = _Ha82DU44;
        "pkg-0.2.1-mc1.21.1" = _SzcZYc3U;
        "pkg-0.2.1-mc1.21.3" = _X592yZPF;
        "pkg-0.2.1-mc1.21.4" = _6EftGML6;
        "pkg-0.2.2-mc1.21.1" = _gsMihO2e;
        "pkg-0.2.2-mc1.21.3" = _mO4bPWSR;
        "pkg-0.2.2-mc1.21.4" = _vbyEGMwR;
        "pkg-0.3.1-mc1.21.1" = _DunnJcDQ;
        "pkg-0.3.1-mc1.21.3" = _WsXzBSRG;
        "pkg-0.3.1-mc1.21.4" = _mSV1YmMm;
        "pkg-0.3.1-mc1.21.5" = _UskP3IFV;
        "pkg-0.3.2-mc1.21.5" = _6x58gfvS;
        "pkg-0.4.0+mc1.21.8" = _V8Fu6Ujo;
        "pkg-0.4.0+mc1.21.5" = _goZG8brk;
        "pkg-0.4.0+mc1.21.4" = _AN7lTKUJ;
        "pkg-0.4.0+mc1.21.3" = _ozmqQDnD;
        "pkg-0.4.0+mc1.21.1" = _b9OUONUG;
        "pkg-0.4.1+mc1.21.10" = _LtVTzrAI;
        "pkg-0.4.0+mc1.21.11" = _Mf15UolG;
        "pkg-0.4.1+mc1.21.8" = _ZQvCmTp0;
        "pkg-0.4.1+mc1.21.5" = _IIyG9tgx;
        "pkg-0.4.3+mc1.21.10" = _iiJQeCG3;
        "pkg-0.4.1+mc1.21.4" = _k0RbL4lt;
        "pkg-0.4.1+mc1.21.3" = _nsHa8Fnr;
        "pkg-0.4.1+mc1.21.1" = _tOP74nwE;
        "pkg-0.4.1+mc1.21.11" = _ytE13tzI;
        "pkg-0.5.0+mc26.1.1" = _xSzF54oI;
        "pkg-0.5.1+mc26.1.2" = _bY4WNmuC;
        "default" = _bY4WNmuC;
    });
