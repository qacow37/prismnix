...
let
    ...
    in {
        ...
        "pkg-0.1-alpha" = _RYaNaVMm;
        "pkg-0.2-alpha" = _J7z3OEJZ;
        "pkg-0.3-alpha" = _OsC2n85e;
        "pkg-0.4-beta" = _rrJSmxnU;
        "pkg-0.5-beta" = _pAkJekRA;
        "pkg-0.6-beta" = _gQhWP0Sv;
        "pkg-0.6.1-beta" = _4NgFXJwi;
        "pkg-0.6.2-beta" = _UGDaLvFg;
        "pkg-0.8-beta" = _fEtGVUan;
        "pkg-0.9-beta" = _nwWKMC0J;
        "pkg-0.6.3-beta" = _xY0bD3iW;
        "pkg-0.9.1-beta" = _jMCR5yku;
        "pkg-0.10-beta" = _jU9Z0YHY;
        "pkg-0.10.1-beta" = _2J3tJfnb;
        "pkg-0.10.2-beta" = _nfya99La;
        "pkg-0.5.1-beta" = _l9fah0Qj;
        "pkg-0.11-beta" = _Fn8z0qnk;
        "pkg-0.12-beta" = _49UjoMaQ;
        "pkg-0.13-beta" = _OvcCOTgX;
        "pkg-0.14-beta" = _TmQpqoN7;
        "pkg-0.14.1-beta" = _JA7jvsmL;
        "pkg-0.14.2-beta" = _QHVsGXHS;
        "pkg-0.14.3-beta" = _U2Ig3A7X;
        "pkg-0.14.4-beta" = _gezn3MQt;
        "default" = _gezn3MQt;
    });
