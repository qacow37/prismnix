...
let
    ...
    in {
        ...
        "pkg-5.3.0" = _IBZVrThp;
        "pkg-5.4.0" = _DObEjZD4;
        "pkg-6.0.0-beta.1" = _jYO4yNFS;
        "pkg-6.0.0-beta.2" = _aZhN0ofV;
        "pkg-6.0.0-beta.3" = _ba9S2OFd;
        "pkg-6.0.0-pre1" = _QZ2WtYGD;
        "pkg-6.0.0-pre2" = _PrBgg2Mj;
        "pkg-6.0.0-rc1" = _6sn1ODwV;
        "pkg-6.0.0" = _YdQa8zdn;
        "pkg-6.1.0" = _quTFtjka;
        "pkg-6.1.1" = _tVPYyTPV;
        "pkg-6.1.2" = _xzMJDzyx;
        ...
        "pkg-6.2.2" = _iKXDXx3i;
        "pkg-5.2.3" = _Ielhod3p;
        "pkg-6.3.0-alpha.1+25w09b" = _AYKRzqea;
        "pkg-6.3.0" = _74T4Ovhm;
        "pkg-6.3.1" = _wOvzypca;
        "pkg-7.0.0-beta.1" = _TUd65hQI;
        "pkg-7.1.0-beta.1" = _Rp6YpDwy;
        "pkg-7.2.0" = _LfKjIXlt;
        "pkg-6.1.3" = _nLsCe2VD;
        "pkg-7.3.0" = _tEsBSUgb;
        "pkg-7.3.1" = _O2RJYZwD;
        "pkg-8.0.0-alpha.3+26.1-pre-2" = _U2Rstnmd;
        "pkg-8.0.0-alpha.4+26.1-rc-2" = _BblTfK18;
        "pkg-8.0.0-alpha.5+26.1" = _2fyoMLJG;
        "pkg-8.0.0" = _RRJmyPMW;
        "pkg-8.0.1" = _d78LiKJ8;
        "pkg-7.3.2" = _HZMLTuxY;
        "default" = _HZMLTuxY;
