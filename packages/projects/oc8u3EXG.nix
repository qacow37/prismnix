...
let
    ...
    in {
        ...
        "pkg-1.1.2+1.20.6" = _2c6HbBbx;
        "pkg-1.0.2+1.20.4" = _vR8N4ZdJ;
        "pkg-1.1.3+1.21" = _RC02lRLT;
        "pkg-1.2.3+1.21.1" = _7Yju1w6B;
        "pkg-1.0.5+1.20-1.20.4" = _KMG8I4kp;
        "pkg-1.2.4+1.21.1" = _oncQzoXq;
        "pkg-1.1.4+1.21" = _hCfiJR6q;
        "pkg-1.3.4+1.21.2-1.21.3" = _L1JaMJSy;
        "pkg-1.2.5+1.21-1.21.1" = _7nQgij8Y;
        "pkg-1.4.0+1.20-1.20.4" = _P3mXGV1V;
        "pkg-1.4.0+1.20.5-1.20.6" = _NqApPUWD;
        "pkg-1.4.0+1.21-1.21.1" = _JAw9lP8d;
        "pkg-1.4.0+1.21.2-1.21.3" = _vqXj34xt;
        "pkg-1.4.0+1.21.2-1.21.4" = _TKgBHy2i;
        "pkg-1.4.0+1.21.2-1.21.5" = _ZD78u7v6;
        "pkg-1.4.0+1.21.2-1.21.7" = _yhEJZcKw;
        "pkg-1.4.0+1.21.2-1.21.8" = _LDN31ImE;
        "pkg-1.4.0+1.21.2-1.21.10" = _Y3lqBcVd;
        "pkg-1.4.0+1.21.11" = _KpzzGoS6;
