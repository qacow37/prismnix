...
let
    ...
    in {
        ...
        "pkg-2.0.2" = _1FZCLBgU;
        "pkg-2.0.3" = _YwzsVvRE;
        "pkg-2.1.0-a1" = _vxQG6wTO;
        "pkg-2.1.0-a2" = _QChy8WVq;
        "pkg-2.1.0-a3" = _p0UsX7rs;
        "pkg-2.1.0-a4" = _q0Al7xej;
        "pkg-2.1.0-a5" = _hPrWSskq;
        "pkg-2.1.0-a6" = _iXyu3PtX;
        "pkg-2.1.0-a7c" = _CBN3oxdZ;
        "pkg-2.1.0-a7d" = _k85y1Eqw;
        "pkg-2.1.0-b1" = _5B4Gnv7e;
        "pkg-2.1.0-b2" = _DIXQY0Sg;
        "pkg-2.1.0-b3" = _3grXii8d;
        "pkg-2.1.0-b4" = _i31JE0JJ;
        "pkg-2.1.0-b5" = _nnbjTH52;
        "pkg-2.1.0-b6" = _KBdX97UD;
        "pkg-2.1.0-b7" = _pjxAtMYG;
        "pkg-2.1.0-b8" = _vLAF9bi8;
        "pkg-2.1.0-1.20.1" = _XS0x2DPP;
        "pkg-2.1.0-1.20.4" = _UNyMg0ZA;
        "pkg-2.1.0-1.20.6" = _RZfdvMdv;
        "pkg-2.1.0-1.21" = _TEFxViOm;
        "pkg-2.1.1-1.20.1" = _dAXeNCIU;
        "pkg-2.1.1-1.20.4" = _bIWL8uaJ;
        "pkg-2.1.1-1.20.6" = _UJY6keNp;
        "pkg-2.1.1-1.21" = _2pApCupk;
        "pkg-2.1.2-1.20.1" = _Ls2PMViJ;
        "pkg-2.1.2-1.20.4" = _TOlmY9LY;
        "pkg-2.1.2-1.20.6" = _dy4n6mQZ;
        "pkg-2.1.2-1.21" = _AfSMFGUo;
        "pkg-2.1.4-1.20.1" = _i0SdcuVv;
        "pkg-2.1.5-1.20.1" = _kUw2kNQW;
        "pkg-2.1.5-1.20.4" = _iPMd8tki;
        "pkg-2.1.5-1.20.6" = _8FRNYyqJ;
        "pkg-2.1.5-1.21" = _EzuXWHFW;
        "pkg-2.1.7-1.21" = _EEptpZ9r;
        "pkg-2.1.8-1.20.1" = _SC2ZU5Uh;
        "pkg-2.1.8-1.20.6" = _IKpZrCCr;
        "pkg-2.1.8-1.21" = _tzRySWNb;
        "pkg-2.1.9-1.20.1" = _aGxLNeWC;
        "pkg-2.1.9-1.20.6" = _RhoAgnAe;
        "pkg-2.1.9-1.21" = _4MOCsbla;
        "pkg-2.1.10-1.20.1" = _g2iRFpUW;
        "pkg-2.1.10-1.20.6" = _W0g1SR61;
        "pkg-2.1.10-1.21" = _vltjYbEZ;
        "pkg-2.1.11-1.20.1" = _UYILVYmA;
        "pkg-2.1.11-1.20.6" = _jLRJ9djn;
        "pkg-2.1.11-1.21" = _KyEwKaBv;
        "pkg-2.1.12-1.20.1" = _wS2xQf45;
        "pkg-2.1.12-1.20.6" = _ZAgj1KtU;
        "pkg-2.1.12-1.21" = _i3HAKF3V;
        "pkg-2.2.0-1.20.1" = _NaLtVSaz;
        "pkg-2.2.0-1.20.6" = _yzAnxEm6;
        "pkg-2.2.0-1.21" = _UdxyDxi4;
        "pkg-2.2.1-1.20.1" = _bWwMrGL1;
        "pkg-2.2.1-1.20.6" = _OcblefMK;
        "pkg-2.2.1-1.21" = _X5PhRAMM;
        "pkg-2.3.0-1.20.1" = _vMdj2zdH;
        "pkg-2.3.0-1.20.6" = _yZuCSKYl;
        "pkg-2.3.0-1.21" = _tEDldLsq;
        "pkg-2.3.1-1.20.1" = _D1peFObb;
        "pkg-2.3.1-1.20.6" = _JsOqKmIH;
        "pkg-2.3.1-1.21" = _D7LSrQZj;
        "pkg-2.3.2-1.20.1" = _kBRfzqMv;
        "pkg-2.3.2-1.20.6" = _VkIv1Uk8;
        "pkg-2.3.2-1.21" = _ZeHzusCQ;
        "pkg-2.3.3-1.20.1" = _ch5qFnv4;
        "pkg-2.3.3-1.20.6" = _AcAX3pbI;
        "pkg-2.3.3-1.21" = _rX2fjlGh;
        "pkg-2.3.4-1.20.1" = _FiAw9tiy;
        "pkg-2.3.4-1.20.6" = _c0pv2Rxi;
        "pkg-2.3.4-1.21" = _1jmeiVHX;
        "pkg-2.4.0-1.20.1" = _lBxHMfMf;
        "pkg-2.4.0-1.20.4" = _RElrnBlV;
        "pkg-2.4.0-1.21.1" = _3sJiYZsi;
        "pkg-2.4.0-1.21.4" = _5QXII8W4;
        "pkg-2.4.1-1.20.1" = _EAhn9BBx;
        "pkg-2.4.1-1.20.4" = _amFiF6t0;
        "pkg-2.4.1-1.21.1" = _RonFusaO;
        "pkg-2.4.1-1.21.4" = _bnu1Kh83;
        "pkg-2.4.2-1.20.1" = _NuumgYEZ;
        "pkg-2.4.3-1.20.1" = _8DYvVY5Y;
        "pkg-2.4.4-1.20.1" = _fKNyrIPV;
        "pkg-2.4.5-1.20.1" = _fq52Oemm;
        "pkg-2.4.5-1.21.1" = _paCrb6It;
        "pkg-2.4.5-1.21.4" = _biuLmtzJ;
        "pkg-2.4.6-1.21.1" = _skQ72WYr;
        "pkg-2.4.7-1.21.4" = _q5Me0Txe;
        "pkg-2.4.8-1.21.1" = _s2Wx0BSg;
        "pkg-2.4.8-1.21.4" = _5BZMsKlo;
        "pkg-2.4.9-1.21.1" = _dNkclUvv;
        "pkg-2.4.10+1.21.1" = _QvFApOoI;
        "pkg-2.4.10-1.21.4" = _PcAcPb2B;
        "pkg-3.0.0+1.21.1" = _izrxnsgM;
        "pkg-3.0.1+1.21.1" = _ae6bgo3c;
        "pkg-3.0.2+1.21.1" = _b2hg12nm;
        "pkg-3.0.3+1.21.1" = _X5pKzaMk;
        "pkg-3.0.4+1.21.1" = _xbZ4AkeB;
        "pkg-3.0.5+1.21.1" = _1XQ1bWBe;
        "pkg-3.0.6+1.21.1" = _lr4wuR0Y;
        "pkg-3.0.7+1.21.1" = _iR827c29;
        "pkg-3.0.8+1.21.1" = _32vvtOrb;
        "pkg-3.0.9+1.21.1" = _BLomhlgp;
        "pkg-3.0.9+1.21.4" = _tfWutHIk;
        "pkg-3.0.10+1.21.1" = _wZ124c1o;
        "pkg-3.0.11+1.21.1" = _7IGc9crQ;
        "pkg-3.0.12+1.21.1" = _LuHJyzja;
        "pkg-3.0.13+1.21.1" = _1kzpe25N;
        "pkg-3.0.14+1.21.1" = _CDHJXg46;
        "pkg-3.0.15+1.21.1" = _1tnkqkfU;
        "pkg-3.0.16+1.21.1" = _yz6XKhXs;
        "pkg-3.0.17+1.21.1" = _9AJkQoVP;
        "pkg-3.0.18+1.21.1" = _VxvL5SQ9;
        "pkg-3.0.19+1.21.1" = _Tnz2bzb0;
        "pkg-3.0.20+1.21.1" = _yugXKjiK;
        "pkg-3.0.21+1.21.1" = _r2ECRWFD;
        "pkg-3.0.22+1.21.1" = _bqZEUZdZ;
        "pkg-3.0.23+1.21.1" = _oSbslWyQ;
        "pkg-3.1.0" = _OKl0ejqX;
        "pkg-3.1.1+1.21.1-fabric" = _YahK2Qra;
        "pkg-3.1.1+1.21.1-neoforge" = _6eNvd5Pb;
        "pkg-3.1.2+1.21.1-fabric" = _rHtIKv1g;
        "pkg-3.1.2+1.21.1-neoforge" = _IvLjsHic;
        "default" = _IvLjsHic;
    });
