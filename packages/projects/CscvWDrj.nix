...
let
    ...
    in {
        ...
        "pkg-1.21.5-1.3.0.0" = _VoH8MUXj;
        "pkg-1.21.8-1.4.0.0" = _YQDCP7Qd;
        "pkg-1.21.10-1.5.0.0" = _88JJaFjv;
        "pkg-1.21.11-1.6.0.0" = _qxXa29TU;
        "pkg-26.1-2.0.0.0" = _Gjyn8Kvj;
        "pkg-1.21.1-1.0.0.1" = _mTLSXcTL;
        "pkg-1.21.3-1.1.0.1" = _WcFyoCFn;
        "pkg-26.1-2.0.0.1" = _1a9KdyQP;
        "pkg-1.21.4-1.2.0.1" = _GlcUmZRV;
        "pkg-1.21.5-1.3.0.1" = _eL7Drt7l;
        "pkg-1.21.8-1.4.0.1" = _qIgf4eQj;
        "pkg-1.21.10-1.5.0.1" = _hkT0GB1h;
        "pkg-1.21.11-1.6.0.1" = _fsU59gHO;
        "pkg-26.1-2.0.1.0" = _wCC9U4Bi;
        "pkg-1.21.11-1.6.1.0" = _xfHiUyjd;
        "pkg-1.21.10-1.5.1.0" = _HEGLBggJ;
        "pkg-26.1-2.0.2.0" = _tfbceu3C;
