...
let
    ...
    in {
        ...
        "pkg-0.1" = _8yggcxze;
        "pkg-0.1+mod" = _K5uvNEE8;
        "pkg-0.2" = _q7DBJ9x4;
        "pkg-0.2+mod" = _Kpi8b5sG;
        "pkg-0.3" = _TfkhOxQl;
        "pkg-0.3+mod" = _fI7LMlBS;
        "pkg-0.4" = _wMq0F8mf;
        "pkg-0.4+mod" = _yTsYMWg5;
        "pkg-0.5" = _Wguh4lxn;
        "pkg-0.5+mod" = _RK6KHBYz;
        "pkg-0.6.1" = _M4JsyDTF;
        "pkg-0.6.1+mod" = _rJZwImvZ;
        "pkg-0.7" = _t5xkRL89;
        "pkg-0.7+mod" = _J3BNUTni;
        "pkg-0.8" = _nduA0LK3;
        "pkg-0.8+mod" = _1gzKSQnb;
        "pkg-0.9" = _DWMoXeGN;
        "pkg-0.9+mod" = _lnQR1hQe;
        "pkg-1.0" = _k3AHaTVp;
        "pkg-1.0+mod" = _Ho0WBgWG;
        "pkg-1.0-1.21.1" = _2FQsRhCw;
        "pkg-1.0-1.21.1+mod" = _imnyjWY8;
        "default" = _imnyjWY8;
    });
