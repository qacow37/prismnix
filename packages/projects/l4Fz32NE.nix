...
let
    ...
    in {
        ...
        "pkg-0.1.8" = _6eHU46OC;
        "pkg-0.1.9" = _ZiG84zdV;
        "pkg-0.1.10+1.21.4" = _Jbj0AcjP;
        "pkg-0.1.10+1.21.1" = _FVbec7O9;
        "pkg-0.1.10+1.21.5" = _TvnCvrj1;
        "pkg-0.1.11+1.21.5" = _8xdxT9O3;
        "pkg-0.1.12+1.21.5" = _O7MvWl5K;
        "pkg-0.1.13+1.21.5" = _Kfn9PJXv;
        "pkg-0.1.14+1.21.6" = _5u51tOf1;
        "pkg-0.1.14+1.21.7" = _CpatWPtf;
        "pkg-0.1.15+1.21.7" = _prySn85H;
        "pkg-0.1.15+1.21.10" = _utoHWS3y;
        "pkg-0.1.16+1.21.10" = _SIErvFda;
        "pkg-0.1.17+1.21.10" = _fAK28lFw;
        "pkg-0.2.0+1.21.11" = _RKb96tqV;
        "default" = _RKb96tqV;
    });
