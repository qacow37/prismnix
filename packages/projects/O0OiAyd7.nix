...
let
    ...
    in {
        ...
        "pkg-1.0.0-Alpha+1.18.2" = _SC2qwaD2;
        "pkg-1.0.0-Alpha+1.19.2" = _kCaIGpU7;
        "pkg-1.0.0-Alpha+1.19.4" = _jWDdqEoS;
        "pkg-1.0.0-Alpha+1.20.1" = _q5NQFQIV;
        "pkg-1.0.0-Alpha+1.20.4" = _2jzavtPI;
        "pkg-1.0.0-Alpha+1.21.1" = _Z5i8BODH;
        "pkg-1.0.0-Alpha+1.21.4" = _dXxlThEM;
        "pkg-1.0.1-Alpha+1.21.4" = _2u9W2i6I;
        "pkg-1.0.1-Alpha+1.21.1" = _vaTVFzEs;
        "pkg-1.0.1-Alpha+1.20.4" = _Kwqhd2NE;
        "pkg-1.0.1-Alpha+1.20.1" = _Gfwx3jrh;
        "pkg-1.0.1-Alpha+1.19.4" = _6lP3InVT;
        "pkg-1.0.1-Alpha+1.19.2" = _JJFNHKuF;
        "pkg-1.0.1-Alpha+1.18.2" = _yu6laaY1;
        "pkg-1.1.0-Alpha+1.21.4" = _xh48IXg1;
        "pkg-1.1.0-Alpha+1.21.1" = _l1WfRQ2A;
        "pkg-1.1.0-Alpha+1.20.4" = _7nWh9TlY;
        "pkg-1.1.0-Alpha+1.20.1" = _OxHEjKnd;
        "pkg-1.1.0-Alpha+1.19.4" = _8WOR4pdN;
        "pkg-1.1.0-Alpha+1.19.2" = _dmJJrpkE;
        "pkg-1.1.0-Alpha+1.18.2" = _sl8WsXvm;
        "pkg-1.2.1-Alpha+1.20.1" = _gJ0VQEVf;
        "pkg-1.2.1-Alpha+1.20.4" = _YZ7sLBB0;
        "pkg-1.2.1-Alpha+1.21.1" = _PaOmJqLZ;
        "pkg-1.2.1-Alpha+1.21.4" = _uAJvmgHF;
        "pkg-1.3.0-Alpha+1.21.1" = _r0dCHPnN;
        "pkg-1.3.0-Alpha+1.21.4" = _IUaKxJRS;
        "pkg-1.3.0-Alpha+1.21.8" = _cv8PtmUZ;
        "pkg-1.3.0-Alpha+1.21.10" = _xEpmOikL;
        "pkg-1.3.0-Alpha+1.21.11" = _fulVkoAe;
        "pkg-1.4.0-Alpha+1.21.1" = _PmtNA4vb;
        "pkg-1.4.0-Alpha+1.21.4" = _DjgUAlfJ;
        "pkg-1.4.0-Alpha+1.21.8" = _KGwsVEcI;
        "pkg-1.4.0-Alpha+1.21.10" = _STtwJUXK;
        "pkg-1.4.0-Alpha+1.21.11" = _snZs0vXe;
        "default" = _snZs0vXe;
    });
