...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _KgRYbZNS;
        "pkg-1.0.4" = _yHThBtxZ;
        "pkg-1.17 1.2.1" = _JuyVAiGQ;
        "pkg-1.16 1.2.0" = _ybwsMxnF;
        "pkg-1.16-1.2.2" = _uQPkw4fk;
        "pkg-1.17-1.2.2" = _aB8kbcfu;
        "pkg-1.16-1.3.1" = _1z9kdviV;
        "pkg-1.17-1.3.1" = _STX5hrqZ;
        "pkg-1.16-1.3.5" = _YuZrYaHK;
        "pkg-1.17-1.3.5" = _DFjCyH95;
        "pkg-1.18-1.3.8" = _yEuIctGl;
        "pkg-1.18.2-1.3.8" = _QW0FB8DZ;
        "pkg-1.19-1.3.9" = _LcgnSnn1;
        "pkg-1.19.2-1.3.9" = _Y1tlTNKm;
        "pkg-1.19.2-2.0.0" = _ablHCQWw;
        "pkg-1.19.2-2.0.1" = _RY30YMui;
        "pkg-1.19-2.0.1" = _2ioYHt3z;
        "pkg-1.19-2.0.2" = _oE34t4eR;
        "pkg-1.19.2-2.0.2" = _ENB98ztE;
        "pkg-1.19-2.0.2.1" = _HJ6FWzuM;
        "pkg-v2.1.0" = _y4coZ02g;
        "pkg-v2.1.1" = _BjcWCUm3;
        "pkg-v2.2" = _p0RzCJOl;
        "pkg-v2.3" = _WLtFE9ck;
        "pkg-v2.3.1" = _UoBgHvdX;
        "pkg-v2.3.2" = _X2NlJr1d;
        "pkg-v2.3.3" = _Ne6ur7It;
        "pkg-1.20.2-2.3.4" = _sZpIBsZS;
        "pkg-1.20.2-2.4.0" = _l1PpVR8F;
        "pkg-1.20.3-2.4.0" = _u0WPOzVB;
        "pkg-1.20.4-2.4.0" = _vmFPqeCP;
        "default" = _vmFPqeCP;
    });
