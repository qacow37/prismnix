...
let
    ...
    in {
        ...
        "pkg-1.16.5-3.0-fabric" = _JnxwA0Jq;
        "pkg-1.18.2-3.0-fabric" = _sZLelu1S;
        "pkg-1.19.2-3.1-fabric" = _w07ObQXU;
        "pkg-1.16.5-3.0-forge" = _sKlCpDCJ;
        "pkg-1.18.2-3.0-forge" = _n7177zh9;
        "pkg-1.19.2-3.0-forge" = _O01CPTCY;
        "pkg-1.16.5-3.2-fabric" = _CBbdGdmD;
        "pkg-1.18.2-3.2-fabric" = _NoOPW36F;
        "pkg-1.19.2-3.2-fabric" = _7P0NltvP;
        "pkg-1.19.3-3.3-fabric" = _QbYqyq44;
        "pkg-1.19.3-3.0-forge" = _RcyuTnZR;
        "pkg-1.18.2-4.0-forge+fabric" = _AVaZ7gYt;
        "pkg-1.19.2-4.0-forge+fabric" = _37lvTXBW;
        "pkg-1.19.3-4.0-forge+fabric" = _rybcZaX1;
        "pkg-1.18.2-4.1-forge+fabric" = _dPDdTA9K;
        "pkg-1.19.2-4.1-forge+fabric" = _hK6IwdqG;
        "pkg-1.19.3-4.1-forge+fabric" = _vX1U6y7e;
        "pkg-1.18.2-4.2-forge+fabric" = _hsptAaT5;
        "pkg-1.19.2-4.2-forge+fabric" = _oDX51PSC;
        "pkg-1.19.3-4.2-forge+fabric" = _YbKEPIG5;
        "pkg-1.19.4-4.2-forge+fabric" = _QfQovweI;
        "pkg-1.20-4.2-forge+fabric" = _89aEYHF8;
        "pkg-1.20.1-4.2-forge+fabric" = _gyknVvA9;
        "pkg-1.20.2-4.2-forge+fabric" = _LCGP7CGd;
        "pkg-1.18.2-4.3-forge+fabric" = _Ha41vnMn;
        "pkg-1.19.2-4.3-forge+fabric" = _js11qBDs;
        "pkg-1.20.1-4.3-forge+fabric" = _pisIiOUW;
        "pkg-1.20.2-4.3-forge+fabric" = _3bGFcknt;
        "pkg-1.20.2-4.4-forge+fabric" = _4JzeD7Ck;
        "pkg-1.20.3-4.4-fabric+forge+neo" = _e6jEqQuZ;
        "pkg-1.20.4-4.4-fabric+forge+neo" = _XsAUce12;
        "pkg-1.19.2-4.5-fabric+forge+neo" = _iBnwMfrh;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _jgc9Rtqb;
        "pkg-1.20.2-4.5-fabric+forge+neo" = _IAEvCZ8r;
        "pkg-1.20.4-4.5-fabric+forge+neo" = _YoDdOJmj;
        "pkg-1.19.2-4.6-fabric+forge+neo" = _KU4eJjJ3;
        "pkg-1.20.1-4.6-fabric+forge+neo" = _9Wr3aT6O;
        "pkg-1.20.2-4.6-fabric+forge+neo" = _QveVMXYx;
        "pkg-1.20.4-4.6-fabric+forge+neo" = _MDGsVHZ2;
        "pkg-1.20.5-4.6-fabric+neo" = _8tLVRyfK;
        "pkg-1.20.6-4.6-fabric+forge+neo" = _kFXeJpKi;
        "pkg-1.21.0-4.6-fabric+forge+neo" = _sCnQG4k5;
        "pkg-1.21.0-4.7-fabric+forge+neo" = _3KKL28H7;
        "pkg-1.20.1-4.8-fabric+forge+neo" = _YEcfMWUH;
        "pkg-1.20.6-4.8-fabric+forge+neo" = _H5UwKbiR;
        "pkg-1.21.0-4.8-fabric+forge+neo" = _1rskvtmF;
        "pkg-1.21.1-4.8-fabric+forge+neo" = _yAOEluvQ;
        "pkg-1.21.2-4.8-fabric+neo" = _fXfXWZvQ;
        "pkg-1.21.3-4.8-fabric+forge+neo" = _pOR4bJ84;
        "pkg-1.21.4-4.8-fabric+forge+neo" = _fqgXAcQC;
        "pkg-1.21.5-4.8-fabric+forge+neo" = _1Qz9Kt7Z;
        "pkg-1.21.5-4.9-fabric+forge+neo" = _fo7ULkID;
        "pkg-1.21.6-4.9-fabric+forge+neo" = _kfLLOFox;
        "pkg-1.21.7-4.9-fabric+forge+neo" = _fkSCStTn;
        "pkg-1.21.8-4.9-fabric+forge+neo" = _liIxm8HE;
        "pkg-1.21.9-4.9-fabric+forge+neo" = _RG3HCfbT;
        "pkg-1.21.10-4.9-fabric+forge+neo" = _3hpHXwWq;
        "pkg-1.21.11-4.9-fabric+forge+neo" = _rCAxVuKe;
        "pkg-26.1.0-4.9-fabric+forge+neo" = _LyDKdVcV;
        "pkg-26.1.1-4.9-fabric+forge+neo" = _SGNuRjuS;
        "pkg-26.1.2-4.9-fabric+forge+neo" = _HAVLbo0r;
        "pkg-26.2.0-4.9-fabric+forge+neo" = _53I5bvsA;
        "default" = _53I5bvsA;
    });
