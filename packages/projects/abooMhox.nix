...
let
    ...
    in {
        ...
        "pkg-1.16.5-5.1-forge" = _r0WXdw4S;
        "pkg-1.18.2-5.1-forge" = _oKJKqRrl;
        "pkg-1.19.2-5.3-forge" = _1SR7kqrH;
        "pkg-1.16.5-5.7-fabric" = _TuoPLbXf;
        "pkg-1.18.2-5.7-fabric" = _p9sKzpQ9;
        "pkg-1.19.2-5.7-fabric" = _BysmJ7e2;
        "pkg-1.16.5-5.7-forge" = _beNsyMfa;
        "pkg-1.18.2-5.7-forge" = _X1xlU7PU;
        "pkg-1.19.2-5.7-forge" = _Z0yiJ7Pe;
        "pkg-1.16.5-5.8-fabric" = _NIk9iVsV;
        "pkg-1.18.2-5.8-fabric" = _W29fjbqm;
        "pkg-1.19.2-5.8-fabric" = _IOyITv4Q;
        "pkg-1.16.5-5.9-fabric" = _TRYojAfG;
        "pkg-1.18.2-5.9-fabric" = _GRFXmyHa;
        "pkg-1.19.2-5.9-fabric" = _GoWprxtv;
        "pkg-1.16.5-5.9-forge" = _cwRqubKX;
        "pkg-1.18.2-5.9-forge" = _DHjNGwHk;
        "pkg-1.19.2-5.9-forge" = _zPltm7dM;
        "pkg-1.19.3-6.0-fabric" = _A8zf7jNo;
        "pkg-1.19.3-5.9-forge" = _Ub7adkZs;
        "pkg-1.18.2-7.0-forge+fabric" = _bsfO3PRY;
        "pkg-1.19.2-7.0-forge+fabric" = _mFlGg2RO;
        "pkg-1.19.3-7.0-forge+fabric" = _PX5Uw4ht;
        "pkg-1.18.2-7.1-forge+fabric" = _v8dn2mHO;
        "pkg-1.19.2-7.1-forge+fabric" = _HvbJWkau;
        "pkg-1.19.3-7.1-forge+fabric" = _reARPJ2m;
        "pkg-1.18.2-7.2-forge+fabric" = _tahR6pcO;
        "pkg-1.19.2-7.2-forge+fabric" = _ITlQv4hw;
        "pkg-1.19.3-7.2-forge+fabric" = _U1gv6TaW;
        "pkg-1.18.2-7.3-forge+fabric" = _2c24QSQG;
        "pkg-1.19.2-7.3-forge+fabric" = _qJZTisPY;
        "pkg-1.19.3-7.3-forge+fabric" = _sr8MdEGn;
        "pkg-1.18.2-7.4-forge+fabric" = _oXuoKk8N;
        "pkg-1.19.2-7.4-forge+fabric" = _bcjhmjKV;
        "pkg-1.19.3-7.4-forge+fabric" = _1QXrKFyb;
        "pkg-1.18.2-8.0-forge+fabric" = _Dp0LmRcM;
        "pkg-1.19.2-8.0-forge+fabric" = _EOHG0Eu5;
        "pkg-1.19.3-8.0-forge+fabric" = _m1JO2qF9;
        "pkg-1.19.4-8.0-forge+fabric" = _Aqof5Za5;
        "pkg-1.18.2-8.1-forge+fabric" = _FPCgPg4h;
        "pkg-1.19.2-8.1-forge+fabric" = _V2g2cSGo;
        "pkg-1.19.3-8.1-forge+fabric" = _241rvKhG;
        "pkg-1.19.4-8.1-forge+fabric" = _fE70xiGU;
        "pkg-1.20-8.1-forge+fabric" = _aGmMikTd;
        "pkg-1.20.1-8.1-forge+fabric" = _RfbLOyxv;
        "pkg-1.18.2-8.2-forge+fabric" = _gRFApj4P;
        "pkg-1.19.2-8.2-forge+fabric" = _wdrPqJX1;
        "pkg-1.19.4-8.2-forge+fabric" = _W4ncrk8M;
        "pkg-1.20.1-8.2-forge+fabric" = _c2klaSgQ;
        "pkg-1.20.2-8.2-forge+fabric" = _modil7mJ;
        "pkg-1.18.2-8.3-forge+fabric" = _d5yDhqXz;
        "pkg-1.19.2-8.3-forge+fabric" = _9KvWetes;
        "pkg-1.20.1-8.3-forge+fabric" = _wkiPy9BG;
        "pkg-1.20.2-8.3-forge+fabric" = _hT1zDWz0;
        "pkg-1.20.3-8.3-fabric+forge+neo" = _LuAPF5Ti;
        "pkg-1.20.4-8.3-fabric+forge+neo" = _WcF18AuY;
        "pkg-1.19.2-8.4-fabric+forge+neo" = _w6UGSJs8;
        "pkg-1.20.1-8.4-fabric+forge+neo" = _U8q0tjZW;
        "pkg-1.20.2-8.4-fabric+forge+neo" = _VDWJqvI9;
        "pkg-1.20.4-8.4-fabric+forge+neo" = _aBETJlK8;
        "pkg-1.19.2-8.5-fabric+forge" = _lUBIE56Z;
        "pkg-1.20.1-8.5-fabric+forge+neo" = _7FmJCfv1;
        "pkg-1.20.2-8.5-fabric+forge+neo" = _dtXOwGxX;
        "pkg-1.20.4-8.5-fabric+forge+neo" = _EsdGXXxN;
        "pkg-1.19.2-8.6-fabric+forge" = _26psviKo;
        "pkg-1.20.1-8.6-fabric+forge+neo" = _zz5yoC3K;
        "pkg-1.20.2-8.6-fabric+forge+neo" = _esFh0i83;
        "pkg-1.20.4-8.6-fabric+forge+neo" = _W3fKNikl;
        "pkg-1.19.2-8.7-fabric+forge" = _4hvlRkFi;
        "pkg-1.20.1-8.7-fabric+forge+neo" = _3xpkqLbJ;
        "pkg-1.20.4-8.7-fabric+forge+neo" = _e0hMx5X8;
        "pkg-1.20.5-8.7-fabric+neo" = _zDniYvrg;
        "pkg-1.20.5-8.8-fabric+neo" = _HiVSJc3w;
        "pkg-1.20.5-8.9-fabric+neo" = _HAYcnWRD;
        "pkg-1.20.6-8.9-fabric+forge+neo" = _6LuaCv12;
        "pkg-1.21.0-8.9-fabric+forge+neo" = _astoQXO2;
        "pkg-1.20.1-9.0-fabric+forge+neo" = _1AYcO1Sw;
        "pkg-1.20.6-9.0-fabric+forge+neo" = _XFK8zDSh;
        "pkg-1.21.0-9.0-fabric+forge+neo" = _5jVHdxJw;
        "pkg-1.21.1-9.0-fabric+forge+neo" = _e5QeVPP0;
        "pkg-1.20.1-9.1-fabric+forge+neo" = _EQYmDYvI;
        "pkg-1.20.6-9.1-fabric+forge+neo" = _8Qdgu5Qo;
        "pkg-1.21.1-9.1-fabric+forge+neo" = _OtzwmSlR;
        "pkg-1.21.2-9.0-fabric+neo" = _yPvf5YvI;
        "pkg-1.21.3-9.0-fabric+forge+neo" = _aROMAonE;
        "pkg-1.21.4-9.0-fabric+forge+neo" = _klxo2KdO;
        "pkg-1.21.4-9.1-fabric+forge+neo" = _ilGj0jiA;
        "pkg-1.21.5-9.1-fabric+forge+neo" = _NEuiaGve;
        "pkg-1.21.6-9.1-fabric+forge+neo" = _JX6NIonf;
        "pkg-1.21.6-9.2-fabric+forge+neo" = _yyNad7Ud;
        "pkg-1.21.7-9.2-fabric+forge+neo" = _z65gXB1c;
        "pkg-1.21.8-9.2-fabric+forge+neo" = _LG3WQ1fx;
        "pkg-1.21.9-9.2-fabric+forge+neo" = _UxUbDtwv;
        "pkg-1.21.9-9.3-fabric+forge+neo" = _MqJXjw5q;
        "pkg-1.21.10-9.3-fabric+forge+neo" = _8urgnvK3;
        "pkg-1.21.11-9.3-fabric+forge+neo" = _8mfyGsIg;
        "pkg-26.1.0-9.3-fabric+forge+neo" = _MiUnJkVx;
        "pkg-26.1.1-9.3-fabric+forge+neo" = _P9sZwCYu;
