...
let
    ...
    in {
        ...
        "pkg-1.19-0.1" = _zNNlxJlV;
        "pkg-1.19.1-0.1" = _RUPUMs8S;
        "pkg-1.19.2-0.1" = _hgI7JMDJ;
        "pkg-1.19.3-0.1" = _ztQlEhoR;
        "pkg-1.19.4-0.1" = _ipUHkNTE;
        "pkg-1.20-0.1" = _6rIQzbHo;
        "pkg-1.20.1-0.1" = _qVuIYJt3;
        "pkg-1.20.2-0.1" = _e79U0xWq;
        "pkg-0.1" = _PjsuTNUj;
        "pkg-1.20.4-0.1" = _BvDFh0fG;
        "pkg-1.20.3-0.1" = _nk82Kcrd;
        "pkg-1.20.5-0.1" = _YFZsDy5q;
        "pkg-1.20.6-0.1" = _rqWDWpd1;
        "pkg-1.21-0.1" = _9dMzqAry;
        "pkg-1.21-0.2" = _kqG4CsDG;
        "pkg-1.20.6-0.2" = _wOOVDHXm;
        "pkg-1.21-0.3" = _Qkyynw6E;
        "pkg-1.21.1-0.1" = _OiOKHn7f;
        "pkg-1.21.3-0.1" = _8RH4o8jU;
        "pkg-1.21.4-0.1" = _GZRbs0d0;
        "pkg-1.21.5-0.1" = _vb49PIXa;
        "pkg-1.21.5-0.2" = _abLMXrcH;
        "pkg-1.21.6-0.1" = _Skrmubii;
        "pkg-1.21.7-0.1" = _gXtm39Ai;
        "pkg-1.21.8-0.1" = _LWte8y42;
        "pkg-1.21.9-0.1" = _KYbWEmAk;
        "pkg-1.21.10-0.1" = _zn3xvc6E;
        "pkg-1.21.11-0.1" = _t0MJV6DH;
        "pkg-CraftableChainArmor" = _vFEdFTzC;
        "pkg-26.1-0.1" = _x92CTjcm;
        "pkg-26.1.1-0.1" = _vbjpy9R6;
        "pkg-26.1.2-0.1" = _KATg6k5D;
        "pkg-26.1.2-0.2" = _JbwRhNTY;
        "pkg-26.1.1-0.2" = _Q495xIF1;
        "pkg-26.1-0.2" = _GMnNtjrQ;
        "pkg-0.3" = _ppspyKDr;
        "pkg-26.2-0.1" = _Zuf6jzgz;
        "default" = _Zuf6jzgz;
    });
