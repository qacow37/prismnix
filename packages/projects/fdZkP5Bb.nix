...
let
    ...
    in {
        ...
        "pkg-0.1.4" = _nJXR4vTh;
        "pkg-0.1.5" = _Kd8ae2WN;
        "pkg-0.2.0+1.19.2" = _IDGEsa8u;
        "pkg-0.2.0+1.19.4" = _QRggCax3;
        "pkg-0.2.0+1.20" = _naGPAAhs;
        "pkg-0.2.2+1.20.1" = _POy2ZtwI;
        "pkg-0.2.2+1.20.2" = _No5mDVrC;
        "pkg-0.2.3-1.20.4" = _I9QawL7F;
        "pkg-0.2.3+1.20.5" = _kn35b43I;
        "pkg-0.2.3+1.21" = _spx7Hv3u;
        "pkg-0.2.4+1.21.1" = _pDaHPTD2;
        "pkg-0.2.4+1.21.3" = _7awQNHzw;
        "pkg-0.2.5+1.21.5-rc1" = _SAwDLirG;
        "pkg-0.2.5+1.21.5" = _Vq0h7noe;
        "pkg-0.2.5+1.21.1" = _A1V3qPzU;
        "pkg-0.2.6+1.21.1" = _f3SYswRb;
        "pkg-0.2.6+1.21.5" = _vIVK1mCS;
        "pkg-0.2.7+1.21.5" = _BSo5xMfu;
        "pkg-0.2.7+1.21.1" = _peLyuD87;
        "pkg-0.2.8+1.21.4" = _ELB4gClM;
        "pkg-0.2.8+1.21.5" = _tKiTysDm;
        "pkg-0.2.8+1.21.1" = _jPM2Lc5D;
        "pkg-0.2.8+1.20.1" = _2wBHDQmh;
        "pkg-0.2.9+1.21.6-pre1" = _3FOgIH3v;
        "pkg-0.2.9+1.21.5" = _mlfm5hi3;
        "pkg-0.2.9+1.21.4" = _PYYDl95q;
        "pkg-0.2.9+1.21.1" = _q2Sx2SPR;
        "pkg-0.2.9+1.20.1" = _Qw3egHgT;
        "pkg-0.2.10+1.21.6" = _xKC3g1t3;
        "pkg-0.2.11+1.21.7" = _wN1MEhme;
        "pkg-0.3.0+1.20.1" = _W8QrwXIR;
        "pkg-0.3.0+1.21.1" = _7yL4ZVJE;
        "pkg-0.3.0+1.21.4" = _PLMewdAA;
        "pkg-0.3.0+1.21.5" = _fmnd7nXD;
        "pkg-0.3.0+1.21.8" = _ahAB7Z2s;
        "pkg-0.3.1+1.20.1" = _3OoY1EnF;
        "pkg-0.3.1+1.21.1" = _u3icC2GG;
        "pkg-0.3.1+1.21.4" = _zuH4biaz;
        "pkg-0.3.1+1.21.5" = _x6TXNO3G;
        "pkg-0.3.1+1.21.8" = _2u0i1eQc;
        "pkg-0.3.1+1.21.9-rc1" = _QYU98Z30;
        "pkg-0.3.1+1.21.11-rc2" = _qux5aobv;
        "pkg-0.3.2+1.20.1" = _dcnYifk3;
        "pkg-0.3.2+1.21.1" = _itZD9uy2;
        "pkg-0.3.2+1.21.10" = _gXewo0Oy;
        "pkg-0.3.2+1.21.11" = _BHK5dckP;
        "pkg-0.3.2+1.21.4" = _K8DLWDk1;
        "pkg-0.3.2+1.21.5" = _WNcXNIEy;
        "pkg-0.3.2+1.21.8" = _AsgUhPIm;
        "pkg-0.3.3+1.20.1" = _bteTpJzU;
        "pkg-0.3.3+1.21.1" = _AReshRra;
        "pkg-0.3.3+1.21.4" = _EKLYXBkZ;
        "pkg-0.3.3+1.21.5" = _oOzKQtGT;
        "pkg-0.3.3+1.21.8" = _uV6EPMdL;
        "pkg-0.3.3+1.21.10" = _eegcNEjI;
        "pkg-0.3.3+1.21.11" = _hA27RLKS;
        "pkg-0.3.4+1.21.8" = _ABwIkaRy;
        "pkg-0.3.4+1.21.10" = _HHDkjr6n;
        "pkg-0.3.5+1.20.1" = _TguS2qGT;
        "pkg-0.3.5+26.1" = _T76gKrsg;
        "pkg-0.3.6+26.1.2" = _bpq3ZDRl;
        "default" = _bpq3ZDRl;
    });
