...
let
    ...
    in {
        ...
        "pkg-4.3.11-1.7.10" = _mNeyO93F;
        "pkg-4.3.11-1.8.9" = _vj3c25Tn;
        "pkg-4.3.11-1.9.4" = _TXroWqbW;
        "pkg-4.3.11-1.10.2" = _9ZvkwOWv;
        "pkg-4.3.11-1.11.2" = _Up7Ygpum;
        "pkg-4.3.11-1.12.2" = _5XnRh9Wm;
        "pkg-4.3.12-1.7.10" = _kcZCckMT;
        "pkg-4.3.12-1.8.9" = _2GP4pu8D;
        "pkg-4.3.12-1.9.4" = _8VE0weUi;
        "pkg-4.3.12-1.10.2" = _zGKxsP2p;
        "pkg-4.3.12-1.11.2" = _aIUjVVyS;
        "pkg-4.3.12-1.12.2" = _60XIoLzH;
        "pkg-4.4.0-1.12.2" = _DUyHpKAH;
        "pkg-4.4.0-1.11.2" = _dxsApeOc;
        "pkg-4.4.0-1.10.2" = _kNeX73B7;
        "pkg-4.4.0-1.9.4" = _BVrTDgUA;
        "pkg-4.4.0-1.8.9" = _knyuc3TD;
        "pkg-4.4.0-1.7.10" = _O3UOMJ0Y;
        "pkg-4.4.1-1.7.10" = _ERE4r9K9;
        "pkg-4.4.1-1.8.9" = _uxLlqF1C;
        "pkg-4.4.1-1.9.4" = _MEhEUmub;
        "pkg-4.4.1-1.10.2" = _ufC3Z0Ys;
        "pkg-4.4.1-1.11.2" = _uIlTvsUG;
        "pkg-4.4.1-1.12.2" = _BsILmc41;
        "pkg-4.4.1a-1.9.4" = _OCGUalWg;
        "pkg-4.4.1a-1.10.2" = _x1EeYl9m;
        "pkg-4.4.1a-1.11.2" = _byWUjQnA;
        "pkg-4.4.1a-1.12.2" = _UfocYS5k;
        "pkg-4.4.1b-1.7.10" = _3m5bFsfU;
        "pkg-4.4.2-1.7.10" = _lxZThkcO;
        "pkg-4.4.2-1.8.9" = _yDunzhrX;
        "pkg-4.4.2-1.9.4" = _GttN48Sq;
        "pkg-4.4.2-1.10.2" = _2byBkQHF;
        "pkg-4.4.2-1.11.2" = _CY467qVp;
        "pkg-4.4.2-1.12.2" = _iyAMIz73;
        "pkg-4.4.3-1.7.10" = _cbNrQark;
        "pkg-4.4.3-1.8.9" = _Avee2nTD;
        "pkg-4.4.3-1.9.4" = _d8qHLfOe;
        "pkg-4.4.3-1.10.2" = _VPWjVkmw;
        "pkg-4.4.3-1.11.2" = _Qg0DkvtN;
        "pkg-4.4.3-1.12.2" = _4qLeHEVo;
        "pkg-4.4.4-1.7" = _SEAzz6yy;
        "pkg-4.4.4-1.8" = _au3LYxFv;
        "pkg-4.4.4-1.9" = _1dMKJret;
        "pkg-4.4.4-1.10" = _jqwLxITy;
        "pkg-4.4.4-1.11" = _NKgQlz2j;
        "pkg-4.4.4-1.12" = _5CX8Ky0k;
        "pkg-4.4.5-1.7" = _nsS8a6bs;
        "pkg-4.4.5-1.8" = _Bux9CJSy;
        "pkg-4.4.5-1.9" = _FWenLACG;
        "pkg-4.4.5-1.10" = _MAnwzxrX;
        "pkg-4.4.5-1.11" = _IgJsxGHw;
        "pkg-4.4.5-1.12" = _pOuuT8v1;
        "pkg-4.4.5a-1.7" = _P1ahs6At;
        "pkg-4.4.6-1.7" = _LLHAJC3x;
        "pkg-4.4.6-1.8" = _7lYXy2sC;
        "pkg-4.4.6-1.9" = _Cfyrpi5n;
        "pkg-4.4.6-1.10" = _iCRuPUir;
        "pkg-4.4.6-1.11" = _buSFGB5L;
        "pkg-4.4.6-1.12" = _emUqp7Gm;
        "pkg-4.4.7-1.7" = _QYNsC7kK;
        "pkg-4.4.7-1.8" = _I4NnQG6E;
        "pkg-4.4.7-1.9" = _H5XQIdzE;
        "pkg-4.4.7-1.10" = _plQ1jfVy;
        "pkg-4.4.7-1.11" = _dGfFLmiD;
        "pkg-4.4.7-1.12" = _zUovvPBu;
        "pkg-4.4.8-1.7" = _HYPFatFy;
        "pkg-4.4.8-1.8" = _R28Zg52r;
        "pkg-4.4.8-1.9" = _60vGSeLN;
        "pkg-4.4.8-1.10" = _uZGe39vp;
        "pkg-4.4.8-1.11" = _CBdUL87d;
        "pkg-4.4.8-1.12" = _t7HbpFJW;
        "pkg-4.4.9-1.7" = _vDvfTDyg;
        "pkg-4.4.10-1.7" = _axqQ5zYr;
        "pkg-4.4.10-1.8" = _k0zgrNk7;
        "pkg-4.4.10-1.9" = _zzZ37Rlk;
        "pkg-4.4.10-1.10" = _FSTgDDZA;
        "pkg-4.4.10-1.11" = _h4fXXUSS;
        "pkg-4.4.10-1.12" = _J1ACRcBt;
        "pkg-4.4.10a-1.7" = _ahTpxdLj;
        "pkg-4.4.11-1.7" = _sD34mP7i;
        "pkg-4.4.11-1.8" = _UlEB2aQS;
        "pkg-4.4.11-1.9" = _EljH7wkL;
        "pkg-4.4.11-1.10" = _9ObcR62D;
        "pkg-4.4.11-1.11" = _dNaY2GqW;
        "pkg-4.4.11-1.12" = _mRoeGVIv;
        "pkg-4.4.12-1.7" = _PkFP27os;
        "pkg-4.4.12-1.8" = _wNc3sCUA;
        "pkg-4.4.12-1.9" = _PpZDz87P;
        "pkg-4.4.12-1.10" = _hOjukoWY;
        "pkg-4.4.12-1.11" = _mtMt6ZCL;
        "pkg-4.4.12-1.12" = _PwRDxERf;
        "pkg-4.4.13-1.7" = _dbqnvxNP;
        "pkg-4.4.13-1.8" = _RaWRtYWi;
        "pkg-4.4.13-1.9" = _Hl2c8q5S;
        "pkg-4.4.13-1.10" = _QV0nVHIr;
        "pkg-4.4.13-1.11" = _6WhenFip;
        "pkg-4.4.13-1.12" = _kkKXh6H7;
        "default" = _kkKXh6H7;
    });
