...
let
    ...
    in {
        ...
        "pkg-22" = _orX2FOl5;
        "pkg-23" = _RXqlRlR3;
        "pkg-1.19.4-1.20" = _bGtPVnai;
        "pkg-1.19.4-1.21" = _fiwxFK24;
        "pkg-1.19.4-1.22" = _vOlbMkLh;
        "pkg-1.19.4-1.23" = _50a0NDHX;
        "pkg-1.19.4-1.25" = _Nvc1uYZi;
        "pkg-1.20-1.25" = _J9WYUyQL;
        "pkg-1.20-1.26" = _ecd8f97n;
        "pkg-1.20-1.28" = _CNUpTNpZ;
        "pkg-1.20-1.29" = _EeTvYqCc;
        "pkg-1.20-1.30" = _XHZMR9TX;
        "pkg-1.20-1.31" = _nI0fDYqC;
        "pkg-1.20-1.32" = _D3Csn2WQ;
        "pkg-neoforge_1.21-1.33.0" = _c9kWgyZz;
        "pkg-fabric_1.21-1.33.0" = _DlqqHEFn;
        "pkg-neoforge_1.21-1.33.1" = _e4WXMV8q;
        "pkg-neoforge_1.21-1.33.2" = _fqrRL3GM;
        "pkg-fabric_1.21-1.33.2" = _NmmhICJB;
        "pkg-fabric_1.21-1.33.3" = _LgdOqS4Y;
        "pkg-neoforge_1.21-1.33.3" = _tmQSfhRW;
        "default" = _tmQSfhRW;
    });
