...
let
    ...
    in {
        ...
        "pkg-v5.0.0-1.19.3-Forge" = _PNGvUyIg;
        "pkg-v6.0.0-1.19.4-Fabric" = _MNvBFo7J;
        "pkg-v6.0.0-1.19.4-Forge" = _fG06ALW8;
        "pkg-v7.0.0-1.20-Forge" = _XxugqFTw;
        "pkg-v7.0.0-1.20-Fabric" = _5Hpoj2gN;
        "pkg-v8.0.0-1.20.1-Forge" = _KTwi0wP7;
        "pkg-v8.0.0-1.20.1-Fabric" = _T8yr3NSt;
        "pkg-v20.4.0-1.20.4-Fabric" = _4FoyIw6i;
        "pkg-v20.4.0-1.20.4-Forge" = _yUDGe8Km;
        "pkg-v20.4.0-1.20.4-NeoForge" = _jkL9yiZn;
        "pkg-v20.4.1-1.20.4-Fabric" = _p7G0noty;
        "pkg-v20.4.1-1.20.4-Forge" = _Hk5l7rCe;
        "pkg-v20.4.1-1.20.4-NeoForge" = _gfwyM0Mn;
        "pkg-v21.1.0-1.21.1-Fabric" = _c3hjI337;
        "pkg-v21.1.0-1.21.1-NeoForge" = _GLzG8UbN;
        "pkg-v21.3.0-1.21.3-Fabric" = _DhDAIdkO;
        "pkg-v21.3.0-1.21.3-NeoForge" = _NrxxieZW;
        "pkg-v21.4.0-1.21.4-Fabric" = _6MXtRjG0;
        "pkg-v21.4.0-1.21.4-NeoForge" = _yJbGyomK;
        "pkg-v21.5.0-1.21.5-Fabric" = _sPjMDmII;
        "pkg-v21.5.0-1.21.5-NeoForge" = _9IYWiuoz;
        "pkg-v21.7.0-1.21.7-Fabric" = _B6Br3Tva;
        "pkg-v21.7.0-1.21.7-NeoForge" = _xda36UO6;
        "pkg-v21.8.0-1.21.8-Fabric" = _Caxy7RyV;
        "pkg-v21.8.0-1.21.8-NeoForge" = _YgDfkg3P;
        "pkg-21.9.0" = _jztkmiGb;
        "pkg-21.10.0" = _CsawIKVd;
        "pkg-21.11.0" = _shncOuRO;
        "pkg-26.1.0" = _N9uuFb9B;
