...
let
    ...
    in {
        ...
        "pkg-0.0.3" = _rlswAMgZ;
        "pkg-0.0.3.1" = _ldXsIBe7;
        "pkg-0.1.0" = _fUaSyHBH;
        "pkg-0.1.1" = _WiV8ZEWj;
        "pkg-0.1.1.1" = _V0zKAxkt;
        "pkg-0.1.2" = _V2Ccr8aG;
        "pkg-0.1.2.1" = _glrQ5RZW;
        "pkg-0.1.2.2" = _yNlAO0jv;
        "pkg-0.1.2.3" = _Z8BhkeVM;
        "pkg-0.1.2.4" = _BAgWXyEV;
        "pkg-0.2.0" = _L8lR3atL;
        "pkg-0.3.0" = _VFcdJCsS;
        "pkg-0.3.1" = _NAAATlm7;
        "pkg-0.3.2" = _CY3KTqHz;
        "pkg-0.3.2.1" = _u433drHR;
        "pkg-0.3.2.2" = _8FIlHJBC;
        "pkg-0.3.2.3" = _k5E6HmiC;
        "pkg-0.3.2.4" = _3hcPWVI1;
        "pkg-0.4.0" = _lCotv2HN;
        "pkg-0.4.1" = _Pm2r7HG7;
        "pkg-0.4.1.1" = _CgvJu9J4;
        "pkg-0.4.2" = _jKJWl38h;
        "pkg-0.4.2.1" = _HgJuzykl;
        "pkg-0.5.0-SNAPSHOT" = _2qGLnfMW;
        "pkg-0.5.0-SNAPSHOT-2" = _zBJIgqDg;
        "pkg-0.5.0-SNAPSHOT-3" = _QTZc9onz;
        "pkg-0.5.0-SNAPSHOT-3hotfix" = _tfBmaCBA;
        "pkg-0.5.0" = _3vQQIjcb;
        "pkg-0.5.1" = _mmmqhkjr;
        "pkg-0.6.0" = _azGuLDVP;
        "pkg-0.6.1" = _TkzO0vOY;
