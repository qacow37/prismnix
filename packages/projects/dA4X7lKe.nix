...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.5-55.1.4" = _WPOayI3L;
        "pkg-1.0.0-forge-1.21.8-58.1.11" = _Ly5K9bnY;
        "pkg-1.0.0-forge-1.21.10-60.1.0" = _4Gz5sxkQ;
        "pkg-1.0.0-forge-1.21.11-61.0.7" = _ITeBuv6V;
        "pkg-1.0.0-fabric-1.20.1-0.92.7" = _s89GnGsk;
        "pkg-1.0.0-fabric-1.21.1-0.116.8" = _7T6GHmCm;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _KfitKCQc;
        "pkg-1.0.0-fabric-1.21.5-0.128.2" = _wjpfY0PS;
        "pkg-1.0.0-fabric-1.21.8-0.136.1" = _7iaJYk7U;
        "pkg-1.0.0-fabric-1.21.10-0.138.4" = _QmIz8vGK;
        "pkg-1.0.0-fabric-1.21.11-0.141.2" = _iaAB8EN1;
        "pkg-1.0.0-neoforge-1.21.1-21.1.218" = _l37WfrVy;
        "pkg-1.0.0-neoforge-1.21.4-21.4.156" = _LA3hcnR9;
        "pkg-1.0.0-neoforge-1.21.5-21.5.96" = _H51BCQNc;
        "pkg-1.0.0-neoforge-1.21.8-21.8.52" = _dTtX8g2K;
        "pkg-1.0.0-neoforge-1.21.10-21.10.64" = _xZAj5U64;
        "pkg-1.0.0-neoforge-1.21.11-21.11.37b" = _218KCFY4;
        "pkg-1.0.1-fabric-26.1-0.142.2" = _9wr5xdyp;
        "pkg-1.0.2-fabric-26.1-0.142.2" = _XgBLvFNa;
        "pkg-1.0.0-forge-1.18.2-40.3.12" = _YKs922MJ;
        "pkg-1.0.3-fabric-26.1.1-0.145.3" = _i3exk6jv;
        "pkg-1.0.3-forge-26.1.1-63.0.0" = _fTMfJZ1H;
        "pkg-1.0.3-neoforge-26.1.1.1" = _4lSRj2MX;
