...
let
    ...
    in {
        ...
        "pkg-0.6.2" = _cuU3SFjF;
        "pkg-0.7.0" = _KCV7X1vA;
        "pkg-0.7.0-forge" = _SQlIosLZ;
        "pkg-0.8.0-build.1-22w43a" = _iVYYDiDZ;
        "pkg-0.8.0-1.16.5" = _Dzz9FkAu;
        "pkg-0.8.0-1.17.1" = _vA88X7uE;
        "pkg-0.8.0-1.18.1" = _6tkZrNyx;
        "pkg-0.8.0-1.18.2" = _umDYhsTx;
        "pkg-0.8.0-1.19.2" = _3SpJslgg;
        "pkg-0.8.1-mc1.16.5-fabric" = _tKxhUOtK;
        "pkg-0.8.1-mc1.16.5-forge" = _LzrO6rfT;
        "pkg-0.8.1-mc1.17.1-fabric" = _pNNEJG3T;
        "pkg-0.8.1-mc1.17.1-forge" = _8QFXxELM;
        "pkg-0.8.1-mc1.18.1-forge" = _DedV30iU;
        "pkg-0.8.1-mc1.18.2-forge" = _VG4xwtdh;
        "pkg-0.8.1-mc1.18.2-fabric" = _AF6L2T9H;
        "pkg-0.8.1-mc1.18.1-fabric" = _N6E2M0pN;
        "pkg-0.8.1-mc1.19.2-forge" = _lmTI25r3;
        "pkg-0.8.1-mc1.19.2-fabric" = _rzwV0WaH;
        "pkg-0.8.1-build.1-mc22w45a-fabric" = _n43G4GAi;
        "pkg-0.8.1-build.3-mc1.19.3-pre2" = _UVJ1YNgd;
        "pkg-0.8.1-mc1.19.3-fabric" = _5OSPFKXi;
        "pkg-0.8.2-mc1.19.3-fabric" = _WkAOFyuR;
        "pkg-0.8.2-mc1.19.3-forge" = _kfaauP2d;
        "pkg-0.8.2-mc1.19.2-fabric" = _4AJPHzZ7;
        "pkg-0.8.2-mc1.19.2-forge" = _XOO2UMGh;
        "pkg-0.8.2-mc1.18.2-fabric" = _OY90k7jS;
        "pkg-0.8.2-mc1.18.2-forge" = _8IRT7zqv;
        "pkg-0.8.2-mc1.18.1-fabric" = _cnJlnvDM;
        "pkg-0.8.2-mc1.18.1-forge" = _ZDZb13d1;
        "pkg-0.8.2-mc1.17.1-fabric" = _3yqP8XMN;
        "pkg-0.8.2-mc1.17.1-forge" = _K2eXuNao;
        "pkg-0.8.2-mc1.16.5-fabric" = _qRR8fZSX;
        "pkg-0.8.2-mc1.16.5-forge" = _J3pxXfQy;
        "pkg-0.9.0-build.1-mc23w07a-fabric" = _Vmsff6NQ;
        "pkg-0.9.0-build.1-mc1.19.3-fabric" = _p6QKMT7o;
        "pkg-0.9.0-build.1-mc1.19.3-forge" = _FRV0SICP;
        "pkg-0.9.0-build.1-mc1.19.2-fabric" = _52yXRQFx;
        "pkg-0.9.0-build.1-mc1.19.2-forge" = _Q47tuVnD;
        "pkg-0.9.0-build.1-mc1.18.2-fabric" = _91zA44qZ;
        "pkg-0.9.0-build.1-mc1.18.2-forge" = _xshj03Ox;
        "pkg-0.9.0-build.1-mc1.18.1-fabric" = _EYIYJj5P;
        "pkg-0.9.0-build.1-mc1.17.1-fabric" = _edVfb0c7;
        "pkg-0.9.0-build.1-mc1.16.5-fabric" = _wjxyCpKl;
        "pkg-0.9.0-mc1.19.2-fabric" = _e6QsgJuz;
        "pkg-0.9.0-mc1.19.2-forge" = _rOqmFbfW;
        "pkg-0.9.0-mc1.19.3-fabric" = _jKMRc4Pu;
        "pkg-0.9.0-mc1.19.3-forge" = _YWCjwlvX;
        "pkg-0.9.0-mc1.18.2-fabric" = _zYhI4Jkd;
        "pkg-0.9.0-mc1.18.2-forge" = _zrFdVWki;
        "pkg-0.9.0-mc1.18.1-fabric" = _cAzJcAJx;
        "pkg-0.9.0-mc1.17.1-fabric" = _S8eRLHUF;
        "pkg-0.9.0-mc1.16.5-fabric" = _ducNBGEq;
        "pkg-0.9.0-mc1.19.4-fabric" = _AZQn5xSm;
        "pkg-1.0.0+mc1.16.5-fabric" = _qBQF16iX;
        "pkg-1.0.0-mc1.17.1-fabric" = _JkMpHEfB;
        "pkg-1.0.0-mc1.18.1-fabric" = _OxSO6D78;
        "pkg-1.0.0-mc1.18.2-fabric" = _7QA1rCRf;
        "pkg-1.0.0-mc1.19.2.fabric" = _IYDgJuEe;
        "pkg-1.0.0-mc1.19.3-fabric" = _wF8rfN5J;
        "pkg-1.0.0-mc1.19.4-fabric" = _Rv7tkZGi;
        "pkg-1.0.0-mc1.16.5-forge" = _sdfdVcMa;
        "pkg-1.0.0-mc1.17.1-forge" = _LRcCSiCC;
        "pkg-1.0.0-mc1.18.1-forge" = _vLbAIDLx;
        "pkg-1.0.0-mc1.18.2-forge" = _IJqCOM84;
        "pkg-1.0.0-mc1.19.2-forge" = _cEwT3xF3;
        "pkg-1.0.0-mc1.19.3-forge" = _vjDJJzSo;
        "pkg-1.0.0-mc1.19.4-forge" = _eDgdEIR5;
        "pkg-1.0.0-beta.1-mc1.20-pre1-fabric" = _KHuDGBZv;
        "pkg-1.0.0-beta.2-mc1.20-pre4-fabric" = _cMxXn6jc;
        "pkg-1.0.0-mc1.20-fabric" = _k6MIFN5x;
        "pkg-1.0.0-mc1.20.1-fabric" = _urNv28Qs;
        "pkg-1.0.1-mc1.20.1-fabric" = _67aRXMZe;
        "pkg-1.0.1-mc1.19.4-fabric" = _qRQ76Rf0;
        "pkg-1.0.1-mc1.19.4-forge" = _Zgc9xEVM;
        "pkg-1.0.1-mc1.19.3-fabric" = _BO2q9L5k;
        "pkg-1.0.1-mc1.19.3-forge" = _pA5bZGgL;
        "pkg-1.0.1-mc1.19.2-fabric" = _hlpWCpdb;
        "pkg-1.0.1-mc1.19.2-forge" = _VtQ780B7;
        "pkg-1.0.1-mc1.18.2-fabric" = _GPFTSix5;
        "pkg-1.0.1-mc1.18.2-forge" = _GbfFMHDv;
        "pkg-1.0.1-beta.1-mc1.20.2-pre4" = _lc9jtbrx;
        "pkg-1.0.1-mc1.20.2" = _KKxCR20y;
        "pkg-1.0.2-mc1.20.2-fabric" = _Bv2bqjH8;
        "pkg-1.0.3-beta.3-mc1.20.4-fabric" = _v5QzCYz2;
        "pkg-1.0.3-mc1.20.4-fabric" = _D4RsNyWU;
        "pkg-1.0.3-alpha.1-mc24w10a-fabric" = _AskCrA18;
        "pkg-1.0.3-beta.1-mc1.20.5-fabric" = _xPjPWWwA;
        "pkg-1.0.3-mc1.20.6-fabric" = _2kePi0X3;
        "pkg-1.0.3-mc1.21-fabric" = _W5GM0HWw;
        "pkg-1.0.4-mc1.21.1-fabric" = _GDRn4kzl;
        "pkg-1.0.4-mc1.20.6-fabric" = _o6QAlUqu;
        "default" = _o6QAlUqu;
    });
