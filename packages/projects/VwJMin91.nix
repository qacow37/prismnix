...
let
    ...
    in {
        ...
        "pkg-universal" = _nFU2ZchA;
        "pkg-1.10.2" = _q1SbziFw;
        "pkg-v1.0.17" = _1VHeaknE;
        "pkg-v1.0.18" = _Jc6WlWSk;
        "pkg-v1.0.20" = _6eukldtL;
        "pkg-v1.0.21" = _atDRf85o;
        "pkg-v1.1.0" = _7Ep30hyG;
        "pkg-v1.1.1" = _sqZIaOXw;
        "pkg-v1.1.2" = _TqtF8ZVb;
        "pkg-v1.2.0" = _LqLUdjyX;
        "pkg-v1.2.1" = _2PkkBtz8;
        "pkg-v1.2.2" = _1h6asTYm;
        "pkg-v1.2.3" = _Yo6h9RDL;
        "pkg-v1.2.4" = _MUluajZE;
        "pkg-v1.3.0" = _7g6ARycJ;
        "pkg-v1.4.0" = _3AJ9k1IZ;
        "pkg-2.0.0" = _mTFHQtrU;
        "pkg-2.1.0" = _HNKqVrzI;
        "pkg-3.0.0" = _8HonUPMm;
        "pkg-3.2.0" = _ZSF9nLbf;
        ...
        "pkg-3.8.1" = _sPZxLE28;
        "pkg-3.9.0" = _AFAYAlBx;
        "pkg-3.10.0" = _Ru3tMmFG;
        "pkg-3.11.0" = _Fpfh5fVp;
        "pkg-3.11.1" = _HUW3K6dL;
        "pkg-3.12.0" = _qkSLHB0O;
        "pkg-3.12.1" = _qiHFtgW2;
        "pkg-3.13.0" = _z7bEhh3v;
        "pkg-3.14.0" = _ZnHY9XYS;
        "default" = _ZnHY9XYS;
    });
