...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.4-fabric" = _UZjNa2XL;
        "pkg-1.18.2-1.4-fabric" = _wCIwG192;
        "pkg-1.19.2-1.5-fabric" = _PtggrDDv;
        "pkg-1.16.5-1.0-forge" = _lXe4PfnN;
        "pkg-1.18.2-1.1-forge" = _zTLKjbms;
        "pkg-1.19.2-1.3-forge" = _Ty5GQvJ7;
        "pkg-1.16.5-1.6-fabric" = _qcyuhs8T;
        "pkg-1.18.2-1.6-fabric" = _Frw8mGBV;
        "pkg-1.19.2-1.6-fabric" = _z2vKpGr7;
        "pkg-1.19.3-1.7-fabric" = _RvuRLT7I;
        "pkg-1.19.3-1.3-forge" = _YwEVnMl7;
        "pkg-1.18.2-2.0-forge+fabric" = _E2Ev5toH;
        "pkg-1.19.2-2.0-forge+fabric" = _Azw8J5on;
        "pkg-1.19.3-2.0-forge+fabric" = _pRIgxYKa;
        "pkg-1.18.2-2.1-forge+fabric" = _dbKQgpxx;
        "pkg-1.19.2-2.1-forge+fabric" = _BNntnuEO;
        "pkg-1.19.3-2.1-forge+fabric" = _eD0X93uy;
        "pkg-1.19.4-2.1-forge+fabric" = _5N0Y2rCG;
        "pkg-1.20-2.1-forge+fabric" = _z4GLa982;
        "pkg-1.20.1-2.1-forge+fabric" = _RxHrXoDP;
        "pkg-1.20.2-2.1-forge+fabric" = _PtmavMPK;
        "pkg-1.18.2-2.2-forge+fabric" = _FpHkyjqc;
        "pkg-1.19.2-2.2-forge+fabric" = _VVl5gfb2;
        "pkg-1.20.1-2.2-forge+fabric" = _8zmObhtc;
        "pkg-1.20.2-2.2-forge+fabric" = _IvEnUCfF;
        "pkg-1.20.3-2.2-fabric+forge+neo" = _7tsmwYxj;
        "pkg-1.20.4-2.2-fabric+forge+neo" = _cvxdDC2C;
        "pkg-1.19.2-2.3-fabric+forge+neo" = _sYfoiCjI;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _XeWjtUyn;
        "pkg-1.20.2-2.3-fabric+forge+neo" = _irNOlEuK;
        "pkg-1.20.4-2.3-fabric+forge+neo" = _pCktIoP8;
        "pkg-1.20.5-2.3-fabric+neo" = _2VD6GpFn;
        "pkg-1.20.6-2.3-fabric+forge+neo" = _swdT8x5N;
        "pkg-1.21.0-2.3-fabric+forge+neo" = _8zjw3koa;
        "pkg-1.20.1-2.4-fabric+forge+neo" = _eLUj8D1W;
        "pkg-1.20.6-2.4-fabric+forge+neo" = _f1zwyRFF;
        "pkg-1.21.0-2.4-fabric+forge+neo" = _LzRtgz7s;
        "pkg-1.21.1-2.4-fabric+forge+neo" = _bSuPPF6l;
        "pkg-1.21.2-2.4-fabric+neo" = _ece2UuWp;
        "pkg-1.21.3-2.4-fabric+forge+neo" = _nnau9ayM;
        "pkg-1.21.4-2.4-fabric+forge+neo" = _62kczl3J;
        "pkg-1.20.1-2.5-fabric+forge+neo" = _3IZ4kaOz;
        "pkg-1.21.1-2.5-fabric+forge+neo" = _Qn8CvY3A;
        "pkg-1.21.4-2.5-fabric+forge+neo" = _Ob8lZeEf;
        "pkg-1.21.5-2.5-fabric+forge+neo" = _ZtBptSAS;
        "pkg-1.21.6-2.5-fabric+forge+neo" = _AMrPcJjU;
        "pkg-1.21.7-2.5-fabric+forge+neo" = _QKuN0MQj;
        "pkg-1.21.8-2.5-fabric+forge+neo" = _p2v4udV4;
        "pkg-1.21.9-2.5-fabric+forge+neo" = _9q2cNOFv;
        "pkg-1.21.10-2.5-fabric+forge+neo" = _i8AXAWlt;
        "pkg-1.21.11-2.5-fabric+forge+neo" = _rOXXcpMw;
        "pkg-26.1.0-2.5-fabric+forge+neo" = _qfS7josE;
        "pkg-26.1.1-2.5-fabric+forge+neo" = _meilNEjZ;
        "pkg-26.1.2-2.5-fabric+forge+neo" = _kQ7suYg4;
        "pkg-26.2.0-2.5-fabric+forge+neo" = _4DrSPUvI;
        "default" = _4DrSPUvI;
    });
