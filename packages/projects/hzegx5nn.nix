...
let
    ...
    in {
        ...
        "pkg-39.2.0" = _3bz4IMk6;
        "pkg-40.0.0" = _afZ6GDgl;
        "pkg-40.1.0" = _GX0pkark;
        "pkg-40.2.0" = _4miqnw0m;
        "pkg-41.0.0" = _e1yrKMTw;
        "pkg-41.0.1" = _ppUqOXZg;
        "pkg-43.0.0" = _9wK3B5Bk;
        "pkg-44.0.0" = _30B2K2gx;
        "pkg-45.0.0" = _FQvDzdTm;
        "pkg-46.0.0" = _cmsuXNFN;
        "pkg-47.0.0" = _PENPCALk;
        "pkg-43.1.0" = _ifNfzUrI;
        "pkg-47.1.0" = _EEmqBaiV;
        "pkg-202.0.0" = _GiaHdFOh;
        "pkg-204.0.0" = _7zbEU60d;
        "pkg-206.0.0" = _dwop3Kpf;
        "pkg-206.1.0" = _mzzlPFzz;
        "pkg-204.1.0" = _wllFSPa0;
        "pkg-202.1.0" = _hGTr5wvj;
        "pkg-47.2.0" = _ju9FzN0S;
        "pkg-47.2.1" = _SSXwHiab;
        "pkg-210.0.0" = _w7ynVnSk;
        "pkg-211.0.0" = _Fl2N5cFl;
        "pkg-214.0.0" = _jhOTn27z;
        "pkg-211.1.0" = _lxFjVEXy;
        "pkg-218.0.0" = _OQsts9oE;
        "default" = _OQsts9oE;
    });
