...
let
    ...
    in {
        ...
        "pkg-1.2.8" = _bEExvezI;
        "pkg-1.2.9" = _SFDfNp0O;
        "pkg-1.2.10" = _J4B2BaWk;
        "pkg-1.2.11" = _ax0CK7UA;
        "pkg-1.2.12" = _Py5aLJrO;
        "pkg-1.2.13" = _6rBEMx1E;
        "pkg-1.2.14" = _JuMNLwUQ;
        "pkg-1.2.15" = _8jiycNq7;
        "pkg-1.2.16" = _uUHeOsqi;
        "pkg-1.2.17" = _6bgYUYfT;
