...
let
    ...
    in {
        ...
        "pkg-1.0.7" = _XCRGvs1V;
        "pkg-1.0.9" = _tm2YCMTu;
        "pkg-1.0.9+SNAPSHOT" = _TUoyZ5kK;
        "pkg-1.0.10" = _2AJlS5P6;
        "pkg-1.0.11" = _lp8D0Lex;
        "pkg-1.0.12" = _wepWZosO;
        "pkg-1.0.13" = _BuKbIu1P;
        "pkg-1.0.14.2" = _zKKqSgiT;
        "pkg-1.0.17" = _ttnh6wIr;
        "pkg-1.0.18" = _KQDZ5UuK;
        "pkg-1.0.19" = _tQ1XxByg;
        "default" = _tQ1XxByg;
    });
