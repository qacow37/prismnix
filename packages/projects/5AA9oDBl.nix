...
let
    ...
    in {
        ...
        "pkg-0.2.1-Fabric" = _2XOTHXoj;
        "pkg-0.2.1-NeoForge" = _pcLIVfoB;
        "pkg-0.2.2+1.21.4-Fabric" = _kwXoFjK3;
        "pkg-0.2.2+1.21.4-NeoForge" = _5icLda7M;
        "pkg-0.3.0+1.21.5-Fabric" = _Of7qK3pD;
        "pkg-0.3.0+1.21.5-NeoForge" = _7BCdRfrk;
        "pkg-0.3.1-Fabric" = _bHp34WaO;
        "pkg-0.3.1-NeoForge" = _P5Vf4WJ1;
        "pkg-0.4.0-Fabric" = _Y1Ukn58x;
        "pkg-0.4.0-NeoForge" = _jGUBXFSo;
        "pkg-0.4.1-Fabric" = _bJrMt327;
        "pkg-0.4.1-NeoForge" = _ljDogng7;
        "pkg-0.5.0-Fabric" = _n9biWiHg;
        "pkg-0.5.0-NeoForge" = _qop27sWk;
        "pkg-0.6.0+1.21.8-neoforge" = _7oYl4UKp;
        "pkg-0.6.0+1.21.8-fabric" = _GEjqYs3B;
        "pkg-0.7.0+1.21.10-neoforge" = _YxmR3daH;
        "pkg-0.7.0+1.21.8-neoforge" = _QrGYjn3x;
        "pkg-0.7.0+1.21.10-fabric" = _JJGOZ08F;
        "pkg-0.7.0+1.21.8-fabric" = _qa9kROq3;
        "pkg-0.8.0+1.21.11-neoforge" = _Osr2Cz9A;
        "pkg-0.8.0+1.21.11-fabric" = _cSBluuH9;
        "pkg-0.8.1+1.21.10-neoforge" = _tSLoa5GZ;
        "pkg-0.8.1+1.21.10-fabric" = _2dd31VRi;
        "pkg-0.8.1+1.21.11-neoforge" = _VSPiWjiV;
        "pkg-0.8.1+1.21.11-fabric" = _qWmtnAcT;
        "pkg-0.8.2+1.21.10-neoforge" = _cto8khgE;
        "default" = _cto8khgE;
    });
