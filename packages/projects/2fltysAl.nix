...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _GQ28BZyM;
        "pkg-v4.0.2-1.19.2-Forge" = _CbOsjKQF;
        "pkg-v4.0.2-1.19.2-Fabric" = _tUcWQae7;
        "pkg-v4.0.3-1.19.2-Fabric" = _mp31lNix;
        "pkg-v4.0.3-1.19.2-Forge" = _hqZUge6D;
        "pkg-v4.0.4-1.19.2-Forge" = _uDyzke9L;
        "pkg-v4.0.4-1.19.2-Fabric" = _Qsa2ypsE;
        "pkg-v4.0.5-1.19.2-Forge" = _PiYbdt9Y;
        "pkg-v4.0.5-1.19.2-Fabric" = _KlR8unJD;
        "pkg-v4.0.6-1.19.2-Forge" = _NXIZJIih;
        "pkg-v4.0.6-1.19.2-Fabric" = _2nHvYTYh;
        "pkg-v4.0.7-1.19.2-Fabric" = _P8OPfR4E;
        "pkg-v4.0.7-1.19.2-Forge" = _L5NCPVR8;
        "pkg-v4.0.8-1.19.2-Fabric" = _d1ypmz2G;
        "pkg-v4.0.8-1.19.2-Forge" = _Qx2ygP15;
        "pkg-v4.0.9-1.19.2-Forge" = _l8Hf44cC;
        "pkg-v4.0.9-1.19.2-Fabric" = _VULkhNOw;
        "pkg-v4.0.10-1.19.2-Forge" = _CsQ4WDtI;
        "pkg-v4.0.10-1.19.2-Fabric" = _Z3KDFjiO;
        "pkg-v4.0.11-1.19.2-Fabric" = _pg6SrAXG;
        "pkg-v4.0.11-1.19.2-Forge" = _E4dWwbm1;
        "pkg-v4.0.12-1.19.2-Fabric" = _21BmY6yg;
        "pkg-v4.0.12-1.19.2-Forge" = _zCFnww90;
        "pkg-v8.0.0-1.20.1-Forge" = _EXUUsW9u;
        "pkg-v8.0.0-1.20.1-Fabric" = _t479d3kt;
        "pkg-v8.0.1-1.20.1-Forge" = _A4T4rsdu;
        "pkg-v8.0.1-1.20.1-Fabric" = _oSOp0Uo2;
        "pkg-v8.0.2-1.20.1-Forge" = _hMD9Htay;
        "pkg-v8.0.2-1.20.1-Fabric" = _WjnRG2fS;
        "pkg-v20.4.0-1.20.4-Fabric" = _j3jrjbwo;
        "pkg-v20.4.0-1.20.4-Forge" = _eJwqLGNg;
        "pkg-v20.4.0-1.20.4-NeoForge" = _8HuycqSZ;
        "pkg-v20.4.1-1.20.4-Fabric" = _z8f4DU8x;
        "pkg-v20.4.1-1.20.4-Forge" = _GVJfcWjf;
        "pkg-v20.4.1-1.20.4-NeoForge" = _UiuVpktP;
        "pkg-v8.0.3-1.20.1-Forge" = _1WbJR9ka;
        "pkg-v8.0.3-1.20.1-Fabric" = _frXSmfj0;
        "pkg-v21.0.0-1.21-Fabric" = _QfKvMHe7;
        "pkg-v21.0.0-1.21-NeoForge" = _FXj1fCWC;
        "pkg-v21.0.1-1.21-Fabric" = _93TJzNiu;
        "pkg-v21.0.1-1.21-NeoForge" = _FUnXXKlT;
        "pkg-v21.1.0-1.21.1-Fabric" = _Pz1Lahgc;
        "pkg-v21.1.0-1.21.1-NeoForge" = _C7j9WWVp;
        "pkg-v4.0.13-1.19.2-Fabric" = _Yo1pCauk;
        "pkg-v4.0.13-1.19.2-Forge" = _qEzScnte;
        "pkg-v21.3.0-1.21.3-Fabric" = _Fp5EH9FZ;
        "pkg-v21.3.0-1.21.3-NeoForge" = _tRrZMt53;
        "pkg-v21.3.1-1.21.3-Fabric" = _kBBUN7j9;
        "pkg-v21.3.1-1.21.3-NeoForge" = _luNQsQ1K;
        "pkg-v21.4.0-1.21.4-Fabric" = _oA2STMwn;
        "pkg-v21.4.0-1.21.4-NeoForge" = _GzvdmO3g;
        "pkg-v21.5.0-1.21.5-Fabric" = _Y0ytw9x3;
        "pkg-v21.5.0-1.21.5-NeoForge" = _Wr9CJgEP;
        "pkg-v21.6.0-1.21.6-Fabric" = _rPbFJDAX;
        "pkg-v21.6.0-1.21.6-NeoForge" = _KQDGt6ye;
        "pkg-v21.7.0-1.21.7-Fabric" = _hk8SXOGP;
        "pkg-v21.7.0-1.21.7-NeoForge" = _HtvzZZ3O;
        "pkg-v21.8.0-1.21.8-Fabric" = _465YtmQj;
        "pkg-v21.8.0-1.21.8-NeoForge" = _RTLyBVKa;
        "pkg-21.10.0" = _1GBiKEie;
        "pkg-21.10.1" = _qsjMKQf3;
        "pkg-21.10.2" = _wMx0GSyB;
