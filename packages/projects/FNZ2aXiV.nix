...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.9-fabric" = _N3qwD0Yi;
        "pkg-1.18.2-1.9-fabric" = _822DgYEN;
        "pkg-1.19.2-2.1-fabric" = _KMk5du1Z;
        "pkg-1.16.5-1.4-forge" = _1QrN37wh;
        "pkg-1.18.2-1.6-forge" = _WVSWU7qh;
        "pkg-1.19.2-1.8-forge" = _217Bsecj;
        "pkg-1.16.5-2.2-fabric" = _krW5Mqvr;
        "pkg-1.18.2-2.2-fabric" = _lr6MZazm;
        "pkg-1.19.2-2.2-fabric" = _ccMF6iVx;
        "pkg-1.19.3-2.3-fabric" = _u39tHXGV;
        "pkg-1.19.3-1.8-forge" = _3Vrg3byp;
        "pkg-1.18.2-3.0-forge+fabric" = _BSjz2n0z;
        "pkg-1.19.2-3.0-forge+fabric" = _IfihCHPJ;
        "pkg-1.19.3-3.0-forge+fabric" = _fd8NOX3j;
        "pkg-1.19.4-3.0-forge+fabric" = _m9L1ZkCJ;
        "pkg-1.20-3.0-forge+fabric" = _X8Xm5KLY;
        "pkg-1.20.1-3.0-forge+fabric" = _9t4jJrv2;
        "pkg-1.20.2-3.0-forge+fabric" = _2sUke6vm;
        "pkg-1.18.2-3.1-forge+fabric" = _rdpRzZ4C;
        "pkg-1.19.2-3.1-forge+fabric" = _NZf6xZiY;
        "pkg-1.20.1-3.1-forge+fabric" = _K2h9wz8j;
        "pkg-1.20.2-3.1-forge+fabric" = _rpM8Sbfc;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _DDIJXE1l;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _fHpW6UGq;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _d0SLBPj3;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _jr2YodzM;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _cCR0mAAd;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _mJtUZzmp;
        "pkg-1.20.5-3.2-fabric+neo" = _4033Rwt0;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _eSyeExfz;
        "pkg-1.21.0-3.2-fabric+forge+neo" = _HAIceWBF;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _T4y102eC;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _DD6LnXUb;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _RanA0JU6;
        "pkg-1.21.1-3.3-fabric+forge+neo" = _ClkmT8m7;
        "pkg-1.21.2-3.3-fabric+neo" = _8sUArqFd;
        "pkg-1.21.3-3.3-fabric+forge+neo" = _YVMScAx5;
        "pkg-1.21.4-3.3-fabric+forge+neo" = _4bwOewGt;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _eWK4D6LL;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _7EaTSvuT;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _oa1xvC4Q;
        "pkg-1.21.5-3.4-fabric+forge+neo" = _QeMwQckX;
        "pkg-1.21.6-3.4-fabric+forge+neo" = _TYFTHb1T;
        "pkg-1.21.7-3.4-fabric+forge+neo" = _eLf6m3oF;
        "pkg-1.21.8-3.4-fabric+forge+neo" = _s844KbyE;
        "pkg-1.21.9-3.4-fabric+forge+neo" = _7FTCQ9yx;
        "pkg-1.21.10-3.4-fabric+forge+neo" = _SIJlvotz;
        "pkg-1.21.11-3.4-fabric+forge+neo" = _bs6CqfXy;
        "pkg-26.1.0-3.4-fabric+forge+neo" = _eWPOgR7T;
        "pkg-26.1.1-3.4-fabric+forge+neo" = _cAYt1cBG;
        "pkg-26.1.2-3.4-fabric+forge+neo" = _mQKyCveB;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _QuSVHxU1;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _BiuSnC5U;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _6lIslk9U;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _hv7Zilgi;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _2aUz4EW8;
        "default" = _2aUz4EW8;
    });
