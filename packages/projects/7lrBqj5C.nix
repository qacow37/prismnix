...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.9-fabric" = _EqGgJVv6;
        "pkg-1.18.2-1.9-fabric" = _QFq29QTR;
        "pkg-1.19.2-2.1-fabric" = _8tHUtac5;
        "pkg-1.16.5-1.4-forge" = _qsdvgE18;
        "pkg-1.18.2-1.6-forge" = _pX0Rn0ir;
        "pkg-1.19.2-1.8-forge" = _wt3e4QjR;
        "pkg-1.16.5-2.2-fabric" = _ziUZGr9j;
        "pkg-1.18.2-2.2-fabric" = _JVfYxcGO;
        "pkg-1.19.2-2.2-fabric" = _dDiGvjtN;
        "pkg-1.19.3-2.3-fabric" = _xbRooHTt;
        "pkg-1.19.3-1.8-forge" = _IFyLnK8v;
        "pkg-1.18.2-3.0-forge+fabric" = _JgKGEN1Q;
        "pkg-1.19.2-3.0-forge+fabric" = _dTOfFwXi;
        "pkg-1.19.3-3.0-forge+fabric" = _XHJ1NXAV;
        "pkg-1.19.4-3.0-forge+fabric" = _hgLXgocS;
        "pkg-1.20-3.0-forge+fabric" = _OpJ83zv7;
        "pkg-1.20.1-3.0-forge+fabric" = _rBQ1ur7l;
        "pkg-1.20.2-3.0-forge+fabric" = _yt6c3zWq;
        "pkg-1.18.2-3.1-forge+fabric" = _YLqkNXfO;
        "pkg-1.19.2-3.1-forge+fabric" = _Ymk20bgX;
        "pkg-1.20.1-3.1-forge+fabric" = _6J4MLcw8;
        "pkg-1.20.2-3.1-forge+fabric" = _Gilu8GPr;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _n1amuTBe;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _DXDdlSWr;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _dVr87WJX;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _8fPrCfNx;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _WA6nMLtP;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _DQHz2Wf1;
        "pkg-1.20.5-3.2-fabric+neo" = _RxNinZGo;
        "pkg-1.20.5-3.3-fabric+neo" = _AxLbjCDW;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _bBbfixgq;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _2hhYRNTV;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _NxfV7llo;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _E7H8w0nj;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _M4bOvOoQ;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _2YtOHhmL;
        "pkg-1.21.2-3.4-fabric+neo" = _uQ2o92f0;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _YrvokyPE;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _F9Tc9NvR;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _A6pHMsTK;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _5VtNIDJA;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _73bOFNVG;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _SlNtn0gS;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _4DUxtXaq;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _NaVWmKeo;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _YIvxTU5p;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _dwxntG7X;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _N7eACU3W;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _iKU1ucHN;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _Vylnb40N;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _73kvRbkc;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _Hrx7mevG;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _Onb8latt;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _5A3bQvPO;
        "default" = _5A3bQvPO;
    });
