...
let
    ...
    in {
        ...
        "pkg-0.2.2" = _ZNGFwsdt;
        "pkg-0.2.3" = _dzOutmq7;
        "pkg-0.2.3-fix1" = _bxYOiNXQ;
        "pkg-0.2.3-fix2" = _kCDMYp51;
        "pkg-0.2.4" = _nHRHzlYo;
        "pkg-0.2.4-fix1" = _6JxRUyLT;
        "pkg-0.2.4-fix2" = _QK0pHWZ5;
        "pkg-0.2.4-fix3" = _lplfijkc;
        "pkg-0.2.4-fix4" = _e5GfBcVR;
        "pkg-0.2.5" = _eyqqGWO0;
        "pkg-0.2.5-fix1" = _hywKXUVq;
        "pkg-0.3.0" = _TFkzBmfd;
        "pkg-3.0.1" = _TndhN61t;
        "pkg-3.0.2" = _rWLl0Uvk;
        "default" = _rWLl0Uvk;
