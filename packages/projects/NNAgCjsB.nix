...
let
    ...
    in {
        ...
        "pkg-1.5.2-fabric-1.16" = _Qek7k92S;
        "pkg-1.5.0-forge-1.17" = _2WBkUuat;
        "pkg-1.5.0-fabric-1.17" = _2mzFyULh;
        "pkg-1.5.1-forge-1.18" = _mlP64Wt9;
        "pkg-1.5.1-fabric-1.18" = _4GD4dwQK;
        "pkg-1.5.1-fabric-1.19" = _LQ3vI7aU;
        "pkg-1.5.2-forge-1.19" = _WdlVJYKE;
        "pkg-1.5.2-fabric-1.19" = _R0KPBo5r;
        "pkg-1.5.2-forge-1.19-fix" = _1Vc3QD0W;
        "pkg-1.5.2-1.19.3-pre2" = _b2cBCjB4;
        "pkg-1.5.2-1.19.3" = _bRBO9ZzX;
        "pkg-1.5.2-1.19.3-forge" = _Wq0up4B4;
        "pkg-1.6.0-1.19.3" = _reIgRPky;
        "pkg-1.6.1-1.19.3" = _AdkBUIRs;
        "pkg-1.6.1" = _WR6z6MYC;
        "pkg-1.6.1-mc1.19.2" = _twdGLDHv;
        "pkg-1.6.1-1.18.2" = _d3CbGntl;
        "pkg-1.6.2-1.19.4" = _NB6TPjI8;
        "pkg-1.6.2-1.20" = _d20sUcYn;
        "pkg-1.6.2-1.20.2" = _BDwHAdWc;
        "pkg-1.6.3-1.20.2" = _tUVHg6HN;
        "pkg-1.6.3-1.20.4" = _KSu61vcB;
        "pkg-1.6.3.1-1.20.4" = _HSirwtwV;
        "pkg-1.6.3-b1.7.3" = _2I1m95aJ;
        "pkg-1.6.3-1.7.10" = _M5k1QJL1;
        "pkg-1.6.3-1.12.2" = _knltv3Vh;
        "pkg-1.6.4-1.20.4" = _7JR5qJ8f;
        "pkg-1.6.4-1.20.5" = _dmSSEQmZ;
        "pkg-1.6.4-1.20.6" = _sXviAk4G;
        "pkg-1.6.4-1.7.10" = _SLiFyIon;
        "pkg-1.6.5" = _92bPVm5F;
        "pkg-1.6.6" = _Bu3hSiJb;
        "pkg-1.6.7" = _uh3DtMnM;
        "pkg-1.7.0" = _kPbJu8eF;
        ...
        "pkg-1.9.4" = _ZNt94SE8;
        "pkg-1.9.5" = _PnGREVMN;
        "pkg-1.10.0" = _YSbzFHRt;
        "pkg-1.10.1" = _NaRJu6ah;
        "pkg-1.10.2" = _DhN0G638;
