...
let
    ...
    in {
        ...
        "pkg-1.0.7-alpha.3" = _JWuU0tpO;
        "pkg-1.0.11" = _Oxfvi9OO;
        "pkg-1.0.11-alpha.1" = _VqvVG9Ks;
        "pkg-1.0.11-alpha.2" = _lK3ve0T0;
        "pkg-1.0.11-alpha.3" = _XPKsKxES;
        "pkg-1.0.11-alpha.4" = _fkxGzuq8;
        "pkg-1.0.11-alpha.5" = _hyXVrNYc;
        "pkg-1.0.11-alpha.6" = _jM5LoQlF;
        "pkg-1.0.11-alpha.7" = _HwAnmdvP;
        "pkg-1.1.0-alpha.1" = _3VJr2Orp;
        "pkg-1.1.0-alpha.2" = _VchKJzNl;
        "pkg-1.1.0-alpha.3" = _P6yhDF3j;
        "pkg-1.1.0-alpha.4" = _LXoCnIkf;
        "pkg-1.1.0-alpha.5" = _dKgNDTza;
        "pkg-1.1.0-alpha.6" = _A9nGIJP1;
        "pkg-1.1.0-alpha.7" = _f3dZ6hjH;
        "pkg-1.1.0-alpha.8" = _SNxHhylx;
        "pkg-1.1.0-alpha.9" = _FPr7vPJ6;
        "pkg-1.1.0-alpha.10" = _VSqvVYjY;
        "pkg-1.1.0-alpha.11" = _1HInpQMI;
        "pkg-1.1.0-alpha.12" = _nwwAboEy;
        "pkg-1.1.0-alpha.13" = _PbucNz54;
        "pkg-1.1.0-alpha.14" = _5rwrAR6M;
        "pkg-1.1.0-alpha.15" = _AOUrgFmV;
        "pkg-1.1.0-alpha.16" = _MzBg50F9;
        "default" = _3VJr2Orp;
    });
