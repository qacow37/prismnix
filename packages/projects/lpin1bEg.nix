...
let
    ...
    in {
        ...
        "pkg-mc1.15.2-v1.4.4" = _DPIhc4zF;
        "pkg-mc1.15.2-v1.5.0" = _D9ZoqMlr;
        "pkg-mc1.14.4-v1.5.0" = _iPXn7Qxx;
        "pkg-mc1.17.1-v1.5.0" = _GiGjUCYl;
        "pkg-mc1.16.5-v1.5.0" = _irGTdYNQ;
        "pkg-mc1.18.2-v1.5.0" = _VOHDADeq;
        "pkg-mc1.19-v1.5.0" = _X4yUBymy;
        "pkg-mc1.19.3-v1.5.0" = _CmfxRKcu;
        "pkg-mc1.19.4-rc2-v1.5.0" = _4UGRwpyD;
        "pkg-mc1.19.4-v1.5.0" = _K3i1h2Nh;
        "pkg-mc1.20-v1.5.0" = _T96e9vvK;
        "pkg-mc1.18.2-v1.6.0" = _uunC9bHY;
        "pkg-mc1.14.4-v1.6.0" = _86FYHnhn;
        "pkg-mc1.19.4-v1.6.0" = _mVXUJPPl;
        "pkg-mc1.20.4-v1.6.0" = _HFGQJeCC;
        "pkg-mc1.17.1-v1.6.0" = _oZnGoHfw;
        "pkg-mc1.16.5-v1.6.0" = _wXaXey0l;
        "pkg-mc1.15.2-v1.6.0" = _hJTpKLsS;
        "pkg-mc1.16.5-v1.6.1" = _4Ml4K4pX;
        "pkg-mc1.15.2-v1.6.1" = _DvtH6Dcm;
        "pkg-mc1.20.4-v1.6.1" = _DtmnYZ6W;
        "pkg-mc1.18.2-v1.6.1" = _8SR3my6h;
        "pkg-mc1.19.4-v1.6.1" = _cFKF929x;
        "pkg-mc1.14.4-v1.6.1" = _ciPSMRQz;
        "pkg-mc1.17.1-v1.6.1" = _drQMoGxG;
        "pkg-mc1.15.2-v1.6.2" = _hq8YYeO9;
        "pkg-mc1.20.1-v1.6.2" = _elTctS0E;
        "pkg-mc1.14.4-v1.6.2" = _GzSMMFX1;
        "pkg-mc1.18.2-v1.6.2" = _IpS6Rv4g;
        "pkg-mc1.17.1-v1.6.2" = _sKSELy1B;
        "pkg-mc1.20.4-v1.6.2" = _Fb9b50px;
        "pkg-mc1.19.4-v1.6.2" = _aLX3Bk7V;
        "pkg-mc1.16.5-v1.6.2" = _Y9UBnjsf;
        "pkg-mc1.20.2-v1.6.2" = _ElthJOk1;
        "pkg-mc1.16.5-v1.6.3" = _KZo2CIPJ;
        "pkg-mc1.20.1-v1.6.3" = _plbS6S4h;
        "pkg-mc1.18.2-v1.6.3" = _JB82xxdd;
        "pkg-mc1.20.4-v1.6.3" = _yD5yAurg;
        "pkg-mc1.20.2-v1.6.3" = _WSJRPrET;
        "pkg-mc1.19.4-v1.6.3" = _jclEFtRk;
        "pkg-mc1.15.2-v1.6.3" = _aiNh0y21;
        "pkg-mc1.17.1-v1.6.3" = _iQ0uM1DT;
        "pkg-mc1.14.4-v1.6.3" = _py6bbYnj;
        "pkg-mc1.15.2-v1.6.4" = _sRuHAv8Z;
        "pkg-mc1.16.5-v1.6.4" = _8rRyyvyH;
        "pkg-mc1.17.1-v1.6.4" = _tt1HeCh2;
        "pkg-mc1.20.1-v1.6.4" = _u4lO86XH;
        "pkg-mc1.14.4-v1.6.4" = _wloVrwEt;
        "pkg-mc1.18.2-v1.6.4" = _KL6Xuyss;
        "pkg-mc1.19.4-v1.6.4" = _UhCs6pKZ;
        "pkg-mc1.20.4-v1.6.4" = _tXzGcNKD;
        "pkg-mc1.20.2-v1.6.4" = _FVr7MHmE;
        "pkg-mc1.20.5-v1.6.4" = _cFnZ7tGA;
        "pkg-mc1.20.6-v1.6.5" = _BAtIOrji;
        "pkg-mc1.17.1-v1.6.5" = _Pbl4BkcK;
        "pkg-mc1.19.4-v1.6.5" = _vwPpwLFY;
        "pkg-mc1.14.4-v1.6.5" = _9Ss0nvLO;
        "pkg-mc1.16.5-v1.6.5" = _JjN4hCbJ;
        "pkg-mc1.15.2-v1.6.5" = _j7Q9sEEz;
        "pkg-mc1.21-v1.6.5" = _dHKfEZE4;
        "pkg-mc1.20.2-v1.6.5" = _7sD30NY5;
        "pkg-mc1.18.2-v1.6.5" = _Y0GJGAfy;
        "pkg-mc1.20.1-v1.6.5" = _sUXniqoh;
        "pkg-mc1.20.4-v1.6.5" = _h4x8YuBB;
        "pkg-v1.6.6-mc1.15.2" = _BDdREWyt;
        "pkg-v1.6.6-mc1.21.1" = _n16UUHJa;
        "pkg-v1.6.6-mc1.16.5" = _qJgbW2wX;
        "pkg-v1.6.6-mc1.21.2" = _Sv0yna8I;
        "pkg-v1.6.6-mc1.20.4" = _WODDaClX;
        "pkg-v1.6.6-mc1.20.2" = _ACJojR1a;
        "pkg-v1.6.6-mc1.20.6" = _1VS4JFFR;
        "pkg-v1.6.6-mc1.17.1" = _pckS7wwH;
        "pkg-v1.6.6-mc1.20.1" = _VEZpIp6t;
        "pkg-v1.6.6-mc1.18.2" = _t3cgLxCq;
        "pkg-v1.6.6-mc1.19.4" = _v5TIIQ3i;
        "pkg-v1.6.6-mc1.14.4" = _nJWJJkRf;
        "pkg-v1.6.7-mc1.16.5" = _KVQaBBdB;
        "pkg-v1.6.7-mc1.18.2" = _2ro4ja2m;
        "pkg-v1.6.7-mc1.21.3" = _tqGisX0n;
        "pkg-v1.6.7-mc1.21.4" = _juqnb6Wt;
        "pkg-v1.6.7-mc1.21.1" = _OSzaJibN;
        "pkg-v1.6.7-mc1.20.2" = _1TUtpGVs;
        "pkg-v1.6.7-mc1.19.4" = _tKFtvdws;
        "pkg-v1.6.7-mc1.20.1" = _OLpdVOUt;
        "pkg-v1.6.7-mc1.15.2" = _iPv7AeGA;
        "pkg-v1.6.7-mc1.14.4" = _2aqNkpde;
        "pkg-v1.6.7-mc1.20.6" = _zpo5ilAu;
        "pkg-v1.6.7-mc1.17.1" = _2DYAJdLP;
        "pkg-v1.6.7-mc1.20.4" = _UDCk7FWa;
        "pkg-v1.6.8-mc1.14.4" = _R8wulm36;
        "pkg-v1.6.8-mc1.18.2" = _mQxazpbi;
        "pkg-v1.6.8-mc1.21.1" = _3r5T6acG;
        "pkg-v1.6.8-mc1.20.6" = _uuWBt1xp;
        "pkg-v1.6.8-mc1.16.5" = _Li7pieMd;
        "pkg-v1.6.8-mc1.21.5" = _pPG4mmtp;
        "pkg-v1.6.8-mc1.21.4" = _Stlo7UTB;
        "pkg-v1.6.8-mc1.20.2" = _27NDRWJc;
        "pkg-v1.6.8-mc1.15.2" = _v42j4lQx;
        "pkg-v1.6.8-mc1.20.1" = _vLbnelll;
        "pkg-v1.6.8-mc1.20.4" = _lCLwb8Yo;
        "pkg-v1.6.8-mc1.21.3" = _2HDTcTIk;
        "pkg-v1.6.8-mc1.17.1" = _fzTyYi24;
        "pkg-v1.6.8-mc1.19.4" = _9wQGajy3;
        "pkg-v1.6.9-mc1.20.6" = _t1eZtHZb;
        "pkg-v1.6.9-mc1.21.3" = _DeAhWWVD;
        "pkg-v1.6.9-mc1.20.1" = _lUycSH1n;
        "pkg-v1.6.9-mc1.14.4" = _A9g4EDEZ;
        "pkg-v1.6.9-mc1.20.4" = _SJqdg2pJ;
        "pkg-v1.6.9-mc1.21.5" = _EuanfeqE;
        "pkg-v1.6.9-mc1.18.2" = _eI9hnq6i;
        "pkg-v1.6.9-mc1.21.1" = _539fXMct;
        "pkg-v1.6.9-mc1.15.2" = _9wt4XMqv;
        "pkg-v1.6.9-mc1.16.5" = _7SnUWggd;
        "pkg-v1.6.9-mc1.20.2" = _pyeLQfvu;
        "pkg-v1.6.9-mc1.19.4" = _qhb5VlQK;
        "pkg-v1.6.9-mc1.17.1" = _iLVT3Aov;
        "pkg-v1.6.9-mc1.21.4" = _llffej31;
        "pkg-v1.6.9-mc1.21.6" = _Nseq2DIl;
        "pkg-v1.6.10-mc1.15.2" = _i5nZRrGj;
        "pkg-v1.6.10-mc1.20.1" = _yFDFaJnW;
        "pkg-v1.6.10-mc1.21.5" = _6xWc1Zih;
        "pkg-v1.6.10-mc1.21.1" = _qcEtJwsp;
        "pkg-v1.6.10-mc1.20.6" = _SI1FtTZD;
        "pkg-v1.6.10-mc1.21.3" = _wMFirZfN;
        "pkg-v1.6.10-mc1.20.2" = _4RHqXVrt;
        "pkg-v1.6.10-mc1.18.2" = _VAZMcdN0;
        "pkg-v1.6.10-mc1.14.4" = _q8rrWFPu;
        "pkg-v1.6.10-mc1.17.1" = _1XqBsiUC;
        "pkg-v1.6.10-mc1.20.4" = _ERHuNeW2;
        "pkg-v1.6.10-mc1.16.5" = _FXuA6sPc;
        "pkg-v1.6.10-mc1.21.4" = _jFOL9OxL;
        "pkg-v1.6.10-mc1.19.4" = _e1lTqIdg;
        "pkg-v1.6.10-mc1.21.7" = _w5vNGjc0;
        "pkg-v1.6.10-mc1.21.8" = _YptWNOB3;
        "pkg-v1.6.11-mc1.20.4" = _jjy6rfVU;
        "pkg-v1.6.11-mc1.14.4" = _VEirm0aZ;
        "pkg-v1.6.11-mc1.21.8" = _WJj2f4Ay;
        "pkg-v1.6.11-mc1.15.2" = _vAK90MwL;
        "pkg-v1.6.11-mc1.21.3" = _cBb9TcrM;
        "pkg-v1.6.11-mc1.17.1" = _8WRxXeSl;
        "pkg-v1.6.11-mc1.21.5" = _BYXa4Oe4;
        "pkg-v1.6.11-mc1.18.2" = _uzaEOT36;
        "pkg-v1.6.11-mc1.21.1" = _KMXuinc0;
        "pkg-v1.6.11-mc1.21.9" = _LcOBR2EP;
        "pkg-v1.6.11-mc1.19.4" = _XJ07Zc8w;
        "pkg-v1.6.11-mc1.20.1" = _nX9mhFsR;
        "pkg-v1.6.11-mc1.21.4" = _mvAIRVOZ;
        "pkg-v1.6.11-mc1.20.2" = _ZJastaC4;
        "pkg-v1.6.11-mc1.20.6" = _iuRVV3zz;
        "pkg-v1.6.11-mc1.16.5" = _y177IoUw;
        "pkg-v1.6.12-mc1.15.2" = _hasEecLo;
        "pkg-v1.6.12-mc1.17.1" = _3lA1Hzyp;
        "pkg-v1.6.12-mc1.14.4" = _xfMeKwKN;
        "pkg-v1.6.12-mc1.21.5" = _oJEq9ds0;
        "pkg-v1.6.12-mc1.21.10" = _6cQRzPUq;
        "pkg-v1.6.12-mc1.21.4" = _yYqE2AdG;
        "pkg-v1.6.12-mc1.20.2" = _JBlzgkdG;
        "pkg-v1.6.12-mc1.21.8" = _t9FDUpMo;
        "pkg-v1.6.12-mc1.16.5" = _6IuNXwWJ;
        "pkg-v1.6.12-mc1.18.2" = _mEPVwYhz;
        "pkg-v1.6.12-mc1.21.1" = _Hk0XIjEj;
        "pkg-v1.6.12-mc1.20.1" = _oHMAGjWe;
        "pkg-v1.6.12-mc1.19.4" = _Z4nyYV4A;
        "pkg-v1.6.12-mc1.21.3" = _OtY7op9p;
        "pkg-v1.6.12-mc1.20.4" = _OC6KDfCQ;
        "pkg-v1.6.12-mc1.20.6" = _ZoGdAYGK;
        "pkg-v1.6.13-mc1.21.11" = _yLYIhvqm;
        "pkg-v1.6.13-mc1.21.3" = _o40QHzdQ;
        "pkg-v1.6.13-mc1.16.5" = _yzbVjZGN;
        "pkg-v1.6.13-mc1.21.8" = _o1GrATuk;
        "pkg-v1.6.13-mc1.21.1" = _nLCuXk0k;
        "pkg-v1.6.13-mc1.20.2" = _3sA5nNpI;
        "pkg-v1.6.13-mc1.18.2" = _xdvSWiSB;
        "pkg-v1.6.13-mc1.15.2" = _F72YbbNP;
        "pkg-v1.6.13-mc1.20.4" = _ASfCNzPt;
        "pkg-v1.6.13-mc1.20.1" = _qOISGEG1;
        "pkg-v1.6.13-mc1.19.4" = _CiMDGcfD;
        "pkg-v1.6.13-mc1.20.6" = _s5nutpoO;
        "pkg-v1.6.13-mc1.21.5" = _B9aj7COE;
        "pkg-v1.6.13-mc1.14.4" = _H8ZZLfDO;
        "pkg-v1.6.13-mc1.21.4" = _TsXtyy4w;
        "pkg-v1.6.13-mc1.21.10" = _cRxXpg71;
        "pkg-v1.6.13-mc1.17.1" = _6XWwX2qD;
        "pkg-v1.6.14-mc1.17.1" = _YAP6Q5tC;
        "pkg-v1.6.14-mc1.16.5" = _zYOarSUZ;
        "pkg-v1.6.14-mc1.15.2" = _CGG6hf0M;
        "pkg-v1.6.14-mc1.14.4" = _O3YfKFy7;
        "pkg-v1.6.14-mc1.20.1" = _M3lT0sbV;
        "pkg-v1.6.14-mc1.18.2" = _4dQfFhOC;
        "pkg-v1.6.14-mc1.19.4" = _DwGqr0xP;
        "pkg-v1.6.14-mc1.20.2" = _e4jLxHeH;
        "pkg-v1.6.14-mc1.20.6" = _RK8lfnbg;
        "pkg-v1.6.14-mc1.20.4" = _r0GSmiwB;
        "pkg-v1.6.14-mc1.21.1" = _CyPJG2Es;
        "pkg-v1.6.14-mc1.21.3" = _W6l1HhtI;
        "pkg-v1.6.14-mc1.21.4" = _bj0xJ48H;
        "pkg-v1.6.14-mc1.21.5" = _oNH2KSQX;
        "pkg-v1.6.14-mc1.21.8" = _UTuHhW6T;
        "pkg-v1.6.14-mc1.21.10" = _LZsVTiFe;
        "pkg-v1.6.14-mc1.21.11" = _SnJqvcTH;
        "pkg-v1.6.14-mc26.1.2" = _nqVFSzU1;
        "pkg-v1.6.15-mc1.16.5" = _G4VCiCP5;
        "pkg-v1.6.15-mc1.14.4" = _OkSLgp4w;
        "pkg-v1.6.15-mc1.17.1" = _MZEIppoR;
        "pkg-v1.6.15-mc1.15.2" = _pd5Jamec;
        "pkg-v1.6.15-mc1.18.2" = _DPbsV7Dy;
        "pkg-v1.6.15-mc1.19.4" = _lvk32U1d;
        "pkg-v1.6.15-mc1.20.2" = _Kn99wXZm;
        "pkg-v1.6.15-mc1.20.1" = _ak3SuwN3;
        "pkg-v1.6.15-mc1.20.4" = _ZlgakOJ8;
        "pkg-v1.6.15-mc1.20.6" = _IHzv89dT;
        "pkg-v1.6.15-mc1.21.3" = _w7SyjAeX;
        "pkg-v1.6.15-mc1.21.1" = _iZ8ueoOo;
        "pkg-v1.6.15-mc1.21.4" = _RACKBLGp;
        "pkg-v1.6.15-mc1.21.5" = _fWc6gtYz;
        "pkg-v1.6.15-mc1.21.8" = _BkOJAdKe;
        "pkg-v1.6.15-mc1.21.10" = _53L6aocL;
        "pkg-v1.6.15-mc26.1.2" = _NpcpLfSS;
        "pkg-v1.6.15-mc1.21.11" = _R5v4june;
        "pkg-v1.6.15-mc26.2" = _SokaTUaS;
        "default" = _SokaTUaS;
    });
