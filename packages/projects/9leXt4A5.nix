...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _ypv0tRYH;
        "pkg-2.0.0" = _Tw5zPYET;
        "pkg-fabric-1.20.1-2.1.0" = _fks1hD8T;
        "pkg-forge-1.20.1-2.1.0" = _ogfsiWTJ;
        "pkg-fabric-1.21.1-2.1.0" = _bn7dR3Ir;
        "pkg-forge-1.21.1-2.1.0" = _SZnPqjqf;
        "pkg-neoforge-1.21.1-2.1.0" = _mdyJwxhY;
        "pkg-2.1.0" = _9jZG5lvV;
        "pkg-3.0.0" = _QkXHgcmA;
        "pkg-3.0.1" = _eN5jmQOC;
        "pkg-neoforge-1.21.8-3.0.2" = _ADr7v0Tw;
        "pkg-forge-1.21.8-3.0.2" = _iEkkNIpS;
        "pkg-fabric-1.21.8-3.0.2" = _1Uckrhnn;
        "pkg-fabric-1.21.9-3.1.0" = _a3i8V39M;
        "pkg-neoforge-1.21.9-3.1.0" = _uhAqUT6B;
        "pkg-fabric-1.21.9-3.1.1" = _Hfxuwz5W;
        "pkg-neoforge-1.21.9-3.1.1" = _90TiHb2i;
        "pkg-fabric-1.21.10-3.1.1" = _mkvClsE6;
        "pkg-neoforge-1.21.10-3.1.1" = _DRJ4URob;
        "pkg-fabric-1.21.11-3.2.0" = _ROoCtAcV;
        "pkg-neoforge-1.21.11-3.2.0" = _d35oXanF;
        "pkg-forge-1.20.1-4.0.0" = _QRX0iPb3;
        "pkg-fabric-1.20.1-4.0.0" = _MiDlid12;
        "pkg-neoforge-1.21.1-4.0.0" = _efrvuVJo;
        "pkg-fabric-1.21.1-4.0.0" = _mUjXm5SN;
        "pkg-fabric-26.1.2-4.0.0" = _IpPEceYI;
        "pkg-neoforge-26.1.2-4.0.0" = _Biet0YAv;
        "pkg-fabric-1.20.1-4.0.1" = _yZNcMkZ7;
        "pkg-fabric-26.1.2-4.0.1" = _CByZTzfI;
        "pkg-fabric-1.20.1-4.0.2" = _Cggv1Swz;
        "pkg-forge-1.20.1-4.0.2" = _dfbmSud0;
        "pkg-fabric-1.21.1-4.0.2" = _XdED0p25;
        "pkg-neoforge-1.21.1-4.0.2" = _Es84N2XL;
        "pkg-fabric-26.1.2-4.0.2" = _hkYCNbeF;
        "pkg-neoforge-26.1.2-4.0.2" = _1OOFZQjw;
        "pkg-fabric-1.20.1-4.1.0" = _1s2VdvAV;
        "pkg-forge-1.20.1-4.1.0" = _CjLpnfRF;
        "pkg-fabric-1.21.1-4.1.0" = _zRO2wNRN;
        "pkg-neoforge-1.21.1-4.1.0" = _nL0TTR3C;
        "pkg-fabric-26.1.2-4.1.0" = _P3Lfmj0C;
