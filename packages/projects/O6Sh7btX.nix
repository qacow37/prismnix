...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0-forge+fabric" = _9KZOsGqG;
        "pkg-1.19.2-1.0-forge+fabric" = _sFH1Kmp5;
        "pkg-1.19.4-1.0-forge+fabric" = _vKAt1yXK;
        "pkg-1.20.1-1.0-forge+fabric" = _C9CzifuO;
        "pkg-1.18.2-1.1-forge+fabric" = _rH2eMjdJ;
        "pkg-1.19.2-1.1-forge+fabric" = _1BKT5tcm;
        "pkg-1.19.4-1.1-forge+fabric" = _8Osi2zXN;
        "pkg-1.20.1-1.1-forge+fabric" = _lERElWXl;
        "pkg-1.20.2-1.1-forge+fabric" = _nayGf4Fu;
        "pkg-1.18.2-1.2-forge+fabric" = _lw1XCltR;
        "pkg-1.19.2-1.2-forge+fabric" = _Ht6Iyuks;
        "pkg-1.20.1-1.2-forge+fabric" = _e1Lrka9L;
        "pkg-1.20.2-1.2-forge+fabric" = _VA6kDy5o;
        "pkg-1.20.2-1.3-forge+fabric" = _G4pIW4Vx;
        "pkg-1.20.3-1.3-fabric+forge+neo" = _Tiu8tcMe;
        "pkg-1.20.4-1.3-fabric+forge+neo" = _vItUqx3C;
        "pkg-1.19.2-1.4-fabric+forge+neo" = _UcX4gv7q;
        "pkg-1.20.1-1.4-fabric+forge+neo" = _KoDXZCem;
        "pkg-1.20.2-1.4-fabric+forge+neo" = _Jt0jGmo5;
        "pkg-1.20.4-1.4-fabric+forge+neo" = _P4j9be2E;
        "pkg-1.19.2-1.5-fabric+forge+neo" = _je0ZXW6Z;
        "pkg-1.20.1-1.5-fabric+forge+neo" = _xAyaBcFP;
        "pkg-1.20.2-1.5-fabric+forge+neo" = _IAgVSUlX;
        "pkg-1.20.4-1.5-fabric+forge+neo" = _cafS40iZ;
        "pkg-1.20.5-1.5-fabric+neo" = _jWB255ui;
        "pkg-1.20.6-1.5-fabric+forge+neo" = _6Ij6E2Jc;
        "pkg-1.21.0-1.5-fabric+forge+neo" = _ahcjrWd5;
        "pkg-1.20.1-1.6-fabric+forge+neo" = _jeoBVRvR;
        "pkg-1.20.6-1.6-fabric+forge+neo" = _dprmyuzV;
        "pkg-1.21.0-1.6-fabric+forge+neo" = _64bda2KB;
        "pkg-1.21.1-1.6-fabric+forge+neo" = _a40un6os;
        "pkg-1.21.2-1.6-fabric+neo" = _NYCiEPnh;
        "pkg-1.21.3-1.6-fabric+forge+neo" = _CMg2QxMA;
        "pkg-1.21.4-1.6-fabric+forge+neo" = _Ozaw5PBm;
        "pkg-1.21.5-1.6-fabric+forge+neo" = _2KT13IuM;
        "pkg-1.21.5-1.7-fabric+forge+neo" = _zDKPvII4;
        "pkg-1.21.6-1.7-fabric+forge+neo" = _mrPJC30q;
        "pkg-1.21.7-1.7-fabric+forge+neo" = _RGNal7lZ;
        "pkg-1.21.8-1.7-fabric+forge+neo" = _Zba4QwUD;
        "pkg-1.21.9-1.7-fabric+forge+neo" = _jo73Qzxw;
        "pkg-1.21.10-1.7-fabric+forge+neo" = _SSKBqGcc;
        "pkg-1.21.11-1.7-fabric+forge+neo" = _8JigPexx;
        "pkg-26.1.0-1.7-fabric+forge+neo" = _HMl0wl3W;
        "pkg-26.1.1-1.7-fabric+forge+neo" = _3Yl7aKak;
        "pkg-26.1.2-1.7-fabric+forge+neo" = _TuyPKdkq;
        "pkg-26.2.0-1.7-fabric+forge+neo" = _GkQDPT5k;
        "default" = _GkQDPT5k;
    });
