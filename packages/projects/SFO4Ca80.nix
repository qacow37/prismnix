...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0.1" = _bUF9uhmT;
        "pkg-1.17.1-2.0.1" = _SDRqBi68;
        "pkg-1.18_experimental-snapshot-6-2.0.1" = _E2nGI2gq;
        "pkg-1.16.5-2.0.2" = _cbRZUbXX;
        "pkg-1.18_experimental-snapshot-6-2.0.2" = _TzBsPQGu;
        "pkg-1.17.1-2.0.2" = _Cyg036t9;
        "pkg-1.17.1-2.0.3" = _QGf4ylKe;
        "pkg-1.16.5-2.0.3" = _6BcAxFSQ;
        "pkg-1.18_experimental-snapshot-6-2.0.3" = _h3Y2JVrQ;
        "pkg-1.15.2-2.0.4" = _WcwvO52O;
        "pkg-1.16.5-2.0.4" = _C3j7OwWF;
        "pkg-21w37a-2.0.4" = _5TginLzq;
        "pkg-1.17.1-2.0.4" = _APJjECf8;
        "pkg-1.15.2-2.0.5" = _n8AKAtUT;
        "pkg-1.16.5-2.0.5" = _938vc1lO;
        "pkg-1.17.1-2.0.5" = _STzfbIJm;
        "pkg-21w38a-2.0.5" = _KyDzWWNy;
        "pkg-1.16.5-2.0.6" = _fTSvZVt6;
        "pkg-1.15.2-2.0.6" = _y5hBIKT6;
        "pkg-1.17.1-2.0.6" = _EaYra8Yb;
        "pkg-21w41a-2.0.6" = _ZXuBddrV;
        "pkg-2.0.7" = _RhJoq3Cd;
        "pkg-2.0.7-1.15.2" = _naTzZoq3;
        "pkg-2.0.7-1.16.5" = _OBrvDPXr;
        "pkg-2.0.7-1.17.1" = _Qo79U23a;
        "pkg-2.0.7-1.18.1" = _rleQbqKN;
        "pkg-2.0.8-1.18.1" = _wqfns7di;
        "pkg-2.0.8-1.17.1" = _3CZ0cybz;
        "pkg-2.0.8-1.16.5" = _YzLp49ti;
        "pkg-2.0.8-1.15.2" = _kcs5qlVX;
        "pkg-2.0.9-1.15.2" = _hJsREtUy;
        "pkg-2.0.9-1.17.1" = _Auwh5jCd;
        "pkg-2.0.9-1.16.5" = _r1GTq0dU;
        "pkg-2.0.9-1.18.2" = _pMtkkzBX;
        "pkg-2.0.9.1-1.15.2" = _7D8z8kJ1;
        "pkg-2.0.9.1-1.16.5" = _LCXCBQWZ;
        "pkg-2.0.9.1-1.17.1" = _qT3G553I;
        "pkg-2.0.9.1-1.18.2" = _eHdoae4c;
        "pkg-3.0.0" = _rhohFCGA;
        "pkg-3.0.1" = _FJvlQpo9;
        "pkg-3.1" = _jxmqdeMy;
        "pkg-3.2" = _ZLtODfoM;
        "pkg-3.2-patch.1" = _CfdK45To;
        "pkg-3.2-patch.2" = _uQHMplKF;
        "pkg-3.2-patch.3" = _pKxah3ZF;
        "pkg-3.2-patch.4" = _zor5PPqN;
        "pkg-3.2-patch.5" = _R1XupIBR;
        "pkg-mc-1.14.4-fabric-v4.0.344" = _R1Ij3gLm;
        "pkg-mc-1.20.2-fabric-v4.0.344" = _aQJhKkQt;
        "pkg-mc-1.19.2-fabric-v4.0.344" = _oU6mLkKJ;
        "pkg-mc-1.19.3-fabric-v4.0.344" = _unjq9zFB;
        "pkg-mc-1.19.4-fabric-v4.0.344" = _l1ql0pea;
        "pkg-mc-1.20.6-fabric-v4.0.344" = _oggrGP2b;
        "pkg-mc-1.20.4-fabric-v4.0.344" = _vGJCMt1J;
        "pkg-mc-1.16.5-fabric-v4.0.344" = _Z2r2yN5e;
        "pkg-mc-1.17.1-fabric-v4.0.344" = _hGCOY45J;
        "pkg-mc-1.18.2-fabric-v4.0.344" = _YirlWMV8;
        "pkg-mc-1.15.2-fabric-v4.0.344" = _dQZoFUcJ;
        "pkg-mc-1.20.1-fabric-v4.0.344" = _UHrPXLWJ;
        "pkg-mc-1.21.0-fabric-v4.0.344" = _FRfjfsYl;
        "pkg-mc-1.14.4-fabric-v4.0.347" = _wG3KByop;
        "pkg-mc-1.15.2-fabric-v4.0.347" = _S1YjPWfP;
        "pkg-mc-1.17.1-fabric-v4.0.347" = _dKVEz6PQ;
        "pkg-mc-1.20.2-fabric-v4.0.347" = _r4BFR5hW;
        "pkg-mc-1.20.4-fabric-v4.0.347" = _r6z3wqO0;
        "pkg-mc-1.20.6-fabric-v4.0.347" = _CrVHF5iN;
        "pkg-mc-1.20.1-fabric-v4.0.347" = _rG0RFS0F;
        "pkg-mc-1.21.0-fabric-v4.0.347" = _NaW1l2EH;
        "pkg-mc-1.18.2-fabric-v4.0.347" = _KeR41LlJ;
        "pkg-mc-1.16.5-fabric-v4.0.347" = _QLmY9Jnz;
        "pkg-mc-1.19.3-fabric-v4.0.347" = _39JtfqaI;
        "pkg-mc-1.19.2-fabric-v4.0.347" = _uSOSd8JD;
        "pkg-mc-1.19.4-fabric-v4.0.347" = _RuRossgk;
        "pkg-mc-1.15.2-fabric-v4.0.350" = _n2Ihdu2G;
        "pkg-mc-1.18.2-fabric-v4.0.350" = _dvRv6Qk4;
        "pkg-mc-1.20.2-fabric-v4.0.350" = _abhLDPti;
        "pkg-mc-1.20.6-fabric-v4.0.350" = _z3ew50Px;
        "pkg-mc-1.21.0-fabric-v4.0.350" = _13ZuMCUi;
        "pkg-mc-1.19.2-fabric-v4.0.350" = _RdOk9A04;
        "pkg-mc-1.14.4-fabric-v4.0.350" = _oTtgkcrh;
        "pkg-mc-1.19.4-fabric-v4.0.350" = _QmeWHiD5;
        "pkg-mc-1.16.5-fabric-v4.0.350" = _4pC70O1D;
        "pkg-mc-1.19.3-fabric-v4.0.350" = _7WTOGgF1;
        "pkg-mc-1.20.1-fabric-v4.0.350" = _ITHfMPiF;
        "pkg-mc-1.17.1-fabric-v4.0.350" = _2AiPWtCs;
        "pkg-mc-1.20.4-fabric-v4.0.350" = _90qpOpk2;
        "pkg-mc-1.14.4-fabric-v4.0.355" = _TvkgoCxe;
        "pkg-mc-1.19.4-fabric-v4.0.355" = _TSmkV256;
        "pkg-mc-1.19.2-fabric-v4.0.355" = _jmxIXR7X;
        "pkg-mc-1.17.1-fabric-v4.0.355" = _4vtO8AyM;
        "pkg-mc-1.18.2-fabric-v4.0.355" = _NPakzUfI;
        "pkg-mc-1.21.0-fabric-v4.0.355" = _7TxxxcGz;
        "pkg-mc-1.20.1-fabric-v4.0.355" = _gpi8XQOt;
        "pkg-mc-1.15.2-fabric-v4.0.355" = _mW9LJjcp;
        "pkg-mc-1.16.5-fabric-v4.0.355" = _J93k9ofu;
        "pkg-mc-1.20.2-fabric-v4.0.355" = _rx1bCiVe;
        "pkg-mc-1.19.3-fabric-v4.0.355" = _locRs9Wm;
        "pkg-mc-1.20.6-fabric-v4.0.355" = _o5MEvckn;
        "pkg-mc-1.20.4-fabric-v4.0.355" = _ERYDlHpi;
        "pkg-mc-1.19.4-fabric-v4.0.364" = _mxPf0pCx;
        "pkg-mc-1.19.2-fabric-v4.0.364" = _qh6f6Zph;
        "pkg-mc-1.14.4-fabric-v4.0.364" = _LwTomi6q;
        "pkg-mc-1.20.4-fabric-v4.0.364" = _dqCplRLY;
        "pkg-mc-1.17.1-fabric-v4.0.364" = _DBIK0Wat;
        "pkg-mc-1.19.3-fabric-v4.0.364" = _5c6fYbjp;
        "pkg-mc-1.18.2-fabric-v4.0.364" = _xCOdFCmD;
        "pkg-mc-1.21.0-fabric-v4.0.364" = _ukG49jYV;
        "pkg-mc-1.15.2-fabric-v4.0.364" = _R4Xop6wn;
        "pkg-mc-1.20.2-fabric-v4.0.364" = _wYQdvloF;
        "pkg-mc-1.16.5-fabric-v4.0.364" = _x4pI9j8v;
        "pkg-mc-1.20.6-fabric-v4.0.364" = _3v03sdWZ;
        "pkg-mc-1.20.1-fabric-v4.0.364" = _Y96gQNWO;
        "pkg-mc-1.15.2-fabric-v4.0.373" = _UUoic7BG;
        "pkg-mc-1.18.2-fabric-v4.0.373" = _eF1rsXZs;
        "pkg-mc-1.20.1-fabric-v4.0.373" = _U9PdvnVb;
        "pkg-mc-1.19.4-fabric-v4.0.373" = _l7EJfBMU;
        "pkg-mc-1.17.1-fabric-v4.0.373" = _UUSPOPfT;
        "pkg-mc-1.16.5-fabric-v4.0.373" = _7gmEVgmE;
        "pkg-mc-1.21.1-neoforge-v4.0.373" = _ZcJAppeU;
        "pkg-mc-1.20.4-fabric-v4.0.373" = _cbkQPARv;
        "pkg-mc-1.20.6-fabric-v4.0.373" = _wZhbeHrJ;
        "pkg-mc-1.19.3-fabric-v4.0.373" = _en9mq0Lw;
        "pkg-mc-1.20.2-fabric-v4.0.373" = _sL8sQPaD;
        "pkg-mc-1.19.2-fabric-v4.0.373" = _hPgwuuWk;
        "pkg-mc-1.14.4-fabric-v4.0.373" = _Dh0xi4OU;
        "pkg-mc-1.21.1-fabric-v4.0.373" = _wiZyDxsI;
        "pkg-v4.0.391-mc1.14.4-fabric" = _tin8V76G;
        "pkg-v4.0.391-mc1.16.5-fabric" = _GT1WJpx1;
        "pkg-v4.0.391-mc1.19.3-fabric" = _OzAqmnLO;
        "pkg-v4.0.391-mc1.21.1-neoforge" = _YJjoQCEc;
        "pkg-v4.0.391-mc1.20.6-fabric" = _3zioR4AH;
        "pkg-v4.0.391-mc1.20.4-fabric" = _fbx6JLqt;
        "pkg-v4.0.391-mc1.21.1-fabric" = _YIJrkvKI;
        "pkg-v4.0.391-mc1.21.4-fabric" = _dpW9S9Le;
        "pkg-v4.0.391-mc1.19.2-fabric" = _4T6KsNkp;
        "pkg-v4.0.391-mc1.19.4-fabric" = _ff6V0MZS;
        "pkg-v4.0.391-mc1.18.2-fabric" = _zxvgAjQD;
        "pkg-v4.0.391-mc1.21.3-fabric" = _22nIgtG0;
        "pkg-v4.0.391-mc1.20.1-fabric" = _DRRWohgT;
        "pkg-v4.0.391-mc1.17.1-fabric" = _owO9wjqn;
        "pkg-v4.0.391-mc1.20.2-fabric" = _5gJ0q0zM;
        "pkg-v4.0.391-mc1.21.5-fabric" = _CkQebpvD;
        "pkg-v4.0.391-mc1.15.2-fabric" = _LCYkTzCQ;
        "pkg-v4.0.394-mc1.18.2-fabric" = _xMAVMDCU;
        "pkg-v4.0.394-mc1.21.5-fabric" = _m1GzDtGY;
        "pkg-v4.0.394-mc1.19.2-fabric" = _bOjpkTjv;
        "pkg-v4.0.394-mc1.16.5-fabric" = _Mf4mQQuc;
        "pkg-v4.0.394-mc1.19.4-fabric" = _UChxSMYH;
        "pkg-v4.0.394-mc1.21.1-neoforge" = _guFYVCOU;
        "pkg-v4.0.394-mc1.21.4-fabric" = _ORBWOttI;
        "pkg-v4.0.394-mc1.14.4-fabric" = _ZowCfcrJ;
        "pkg-v4.0.394-mc1.20.1-fabric" = _B5ZQWqlj;
        "pkg-v4.0.394-mc1.20.2-fabric" = _gnx60NC8;
        "pkg-v4.0.394-mc1.20.4-fabric" = _gtiFnWDd;
        "pkg-v4.0.394-mc1.17.1-fabric" = _F48heaRn;
        "pkg-v4.0.394-mc1.21.1-fabric" = _Fvs6P10k;
        "pkg-v4.0.394-mc1.21.3-fabric" = _x3o1N8qY;
        "pkg-v4.0.394-mc1.20.6-fabric" = _DHujh797;
        "pkg-v4.0.394-mc1.19.3-fabric" = _V7LptdUn;
        "pkg-v4.0.394-mc1.15.2-fabric" = _NDmCNImk;
        "pkg-v4.0.395-mc1.20.1-fabric" = _F2ZXK7uH;
        "pkg-v4.0.395-mc1.21.1-fabric" = _OgRdKmsv;
        "pkg-v4.0.395-mc1.19.4-fabric" = _HjUUaEmn;
        "pkg-v4.0.395-mc1.16.5-fabric" = _grZuD2Nl;
        "pkg-v4.0.395-mc1.21.4-fabric" = _9Umig4v6;
        "pkg-v4.0.395-mc1.18.2-fabric" = _rF19sViH;
        "pkg-v4.0.395-mc1.21.1-neoforge" = _WXeeMpXi;
        "pkg-v4.0.395-mc1.19.2-fabric" = _RWgeDCBE;
        "pkg-v4.0.395-mc1.20.6-fabric" = _qBVHCqcl;
        "pkg-v4.0.395-mc1.20.4-fabric" = _E3oxTe2G;
        "pkg-v4.0.395-mc1.17.1-fabric" = _dNoMdmTp;
        "pkg-v4.0.395-mc1.21.5-fabric" = _XsYjt1Zr;
        "pkg-v4.0.395-mc1.19.3-fabric" = _8q9V7qTl;
        "pkg-v4.0.395-mc1.20.2-fabric" = _WsPjdThJ;
        "pkg-v4.0.395-mc1.14.4-fabric" = _7Cw27cp8;
        "pkg-v4.0.395-mc1.21.3-fabric" = _h45uQiUu;
        "pkg-v4.0.395-mc1.15.2-fabric" = _6YnVqOs9;
        "default" = _6YnVqOs9;
    });
