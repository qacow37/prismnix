...
let
    ...
    in {
        ...
        "pkg-(Forge-Fabric-1.20-1.20.6)-1.0" = _gRKCIVPL;
        "pkg-(Forge-Fabric-1.20-1.20.6)-2.0" = _lu8ENous;
        "pkg-(Forge-Fabric-1.20-1.20.6)-2.1" = _Qp31whNc;
        "pkg-(Forge-Fabric-1.21-1.21.6)-2.1" = _nhUWXHPi;
        "pkg-(NeoForge-1.21-1.21.6)-2.1" = _zVtUvuCJ;
        "pkg-(Forge-Fabric-1.20.x)-3.0" = _Ebr8tcJa;
        "pkg-(Forge-Fabric-1.21.x)-3.0" = _cCeCur8H;
        "pkg-(NeoForge-1.21.x)-3.0" = _DYatRm3H;
        "pkg-(Forge-Fabric-1.20.x)-3.1" = _JTQXNifK;
        "pkg-(Forge-Fabric-1.21.x)-3.1" = _jeKpMv6H;
        "pkg-(Forge-Fabric-1.20.x)-3.2" = _1679pywy;
        "pkg-(Forge-Fabric-1.21.x)-3.2" = _OaWDdo0Y;
        "pkg-(NeoForge-1.21.x)-3.2" = _UC9rzAoT;
        "pkg-(Forge-Fabric-1.20.x)-3.3" = _W1Y5HBLv;
        "pkg-(Forge-Fabric-1.21.x)-3.3" = _PsFBcMr1;
        "pkg-(NeoForge-1.21.x)-3.3" = _625GO9Lx;
        "pkg-(Forge-Fabric-1.20.x)-3.4" = _Kcw0L339;
        "pkg-(Forge-Fabric-1.21.x-26.1.x)-3.4" = _A62AtorJ;
        "pkg-(NeoForge-1.21.x-26.1.x)-3.4" = _Iixo6u48;
        "pkg-(Forge-Fabric-1.20.x)-3.5" = _CBLv5f0p;
        "pkg-(Forge-Fabric-1.21.x-26.1.x)-3.5" = _H61nS0wB;
        "pkg-(NeoForge-1.21.x-26.1.x)-3.5" = _sfOyQNRo;
        "pkg-(Forge-Fabric-1.20.x)-3.6.0" = _9WXVyDIF;
        "pkg-(Forge-Fabric-1.21.x-26.2-3.6.0" = _BGyn1Qtc;
        "pkg-(NeoForge-1.21.x-26.2)-3.6.0" = _SPxHPTRR;
        "pkg-(Forge-Fabric-1.20-1.20.4)-3.7.0" = _DQ3orks6;
        "pkg-(Fabric-1.21.x-26.2)-3.7.0" = _wjBgXBTK;
        "pkg-(NeoForge-1.21.x-26.2)-3.7.0" = _1mJTB5f8;
        "default" = _1mJTB5f8;
    });
