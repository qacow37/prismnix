...
let
    ...
    in {
        ...
        "pkg-1.18.1-v1" = _XbOLLWyw;
        "pkg-1.18.2-v1" = _TKGO8cl7;
        "pkg-1.17.1-v3" = _h5qLYco7;
        "pkg-1.16.5-v1" = _KJm12ocf;
        "pkg-1.19-v1" = _53Ll4gh9;
        "pkg-1.19.3-v1" = _WIbLec9x;
        "pkg-1.19.4-v1" = _ZIpy4Zmp;
        "pkg-1.19.4-v2" = _uKGyE6Wj;
        "pkg-1.20-v1" = _ZaObZwH6;
        "pkg-1.20-v2" = _R9iOJAi2;
        "pkg-1.20.6-v1" = _SOqESda5;
        "pkg-1.21-v1" = _pJf6Me2F;
        "pkg-1.21.3-v1" = _zdTkzQ2E;
        "pkg-1.21.5-v1" = _Lkua9Kyg;
        "pkg-1.21.6-v1" = _QYkGzYJW;
        "pkg-1.21.10-v1" = _NVNHkJCj;
