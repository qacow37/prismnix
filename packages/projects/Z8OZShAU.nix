...
let
    ...
    in {
        ...
        "pkg-1.1.6" = _S1GcFdRa;
        "pkg-1.3.2" = _f4YY0MzA;
        "pkg-1.6.0+1.19.2" = _GcX7bayT;
        "pkg-1.7.0+1.19.2" = _dr3x2xCg;
        "pkg-1.5.5+1.16.5" = _hSlxr9nX;
        "pkg-1.6.6+1.18.2" = _mheET77D;
        "pkg-1.7.4+1.19.2" = _YjONvCI8;
        "pkg-1.8.0+1.20.1" = _TUflOXIT;
        "pkg-1.8.1+1.20.1" = _lXmAhRu6;
        "pkg-1.8.2+1.20.1" = _hmMqfLXx;
        "pkg-1.8.3+1.20.1" = _oDvonMEX;
        "pkg-1.8.4+1.20.1" = _sXufAKEU;
        "pkg-1.8.5+1.20.1" = _TrnmVSvC;
        "pkg-1.8.6+1.20.1" = _Zjg7QVo6;
        "pkg-1.8.7+1.20.1" = _BHpDrPT9;
        "pkg-1.9.0+1.20.1" = _gPapvi8c;
        "pkg-1.9.1+1.20.1" = _vDWfXHwj;
        "pkg-1.7.7+1.19.2" = _LFB0KTRS;
        "pkg-1.6.7+1.18.2" = _DtuVtAE2;
        "pkg-1.9.2+1.20.1" = _AItnd8Y0;
        "pkg-1.9.3+1.20.1" = _iqoaC22M;
        "pkg-1.10.0+1.20.1" = _zALLSVxZ;
        "pkg-1.10.1+1.20.1" = _V7CKHwQI;
        "pkg-1.10.3+1.20.1" = _5BjGiw0X;
        "pkg-1.13.2+1.21.1-neoforge" = _rMhT7h8a;
        "pkg-1.13.0+1.20.1" = _mgwwWo3b;
        "pkg-1.13.3+1.21.1-neoforge" = _GD4GaMj6;
        "pkg-1.13.4+1.21.1-neoforge" = _6Vwdcz9e;
        "pkg-1.13.5+1.21.1-neoforge" = _gqIS9SQG;
        "pkg-1.13.6+1.21.1-neoforge" = _zDlRv8F5;
        "pkg-1.13.7+1.21.1-neoforge" = _bpMwZSKf;
        "default" = _bpMwZSKf;
    });
