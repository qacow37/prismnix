...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.7-Forge" = _A6SQD3u5;
        "pkg-1.16.5-2.8-Forge" = _VJt4EPIJ;
        "pkg-1.17.1-3.0-Fabric" = _PrJDPpOb;
        "pkg-1.17.1-3.0-Forge" = _C5w40qnR;
        "pkg-1.18.1-3.1-Fabric" = _aIYvtuRy;
        "pkg-1.18.1-3.1-Forge" = _pNpBlxDw;
        "pkg-1.18.1-3.2-Fabric" = _MY9r4BpI;
        "pkg-1.18.1-3.2-Forge" = _1qArNGRN;
        "pkg-1.18.1-3.3-Fabric" = _5R2x0cGE;
        "pkg-1.18.1-3.3-Forge" = _5K6F8r7S;
        "pkg-1.18.1-3.4-Fabric" = _oBLtNvmh;
        "pkg-1.18.1-3.4-Forge" = _gv2Jqw2F;
        "pkg-1.18.2-3.5-Fabric" = _SqhqtWCU;
        "pkg-1.18.2-3.5-Forge" = _du4GyrEO;
        "pkg-1.18.2-3.6-Fabric" = _6pOF4KxK;
        "pkg-1.18.2-3.7-Fabric" = _ecscc6Dd;
        "pkg-1.18.2-3.7-Forge" = _XkpBwfKo;
        "pkg-1.18.2-3.8-Fabric" = _w7aBplGV;
        "pkg-1.18.2-3.8-Forge" = _5vjMaDbn;
        "pkg-1.16.5-2.9-Forge" = _q4mq5ePS;
        "pkg-1.16.5-2.10-Forge" = _rab243vq;
        "pkg-1.18.2-3.9-Fabric" = _MCecxO19;
        "pkg-1.18.2-3.9-Forge" = _oIa88ef3;
        "pkg-1.18.2-3.10-Fabric" = _U4jxC01p;
        "pkg-1.18.2-3.10-Forge" = _q4ZBlvHj;
        "pkg-1.18.2-3.11-Fabric" = _CfQjQP9Y;
        "pkg-1.18.2-3.11-Forge" = _anRNjO4J;
        "pkg-1.18.2-3.12-Fabric" = _lMpCdLcn;
        "pkg-1.18.2-3.12-Forge" = _LNYjBVm9;
        "pkg-1.18.2-3.13-Fabric" = _8kOL2oc9;
        "pkg-1.18.2-3.13-Forge" = _oqmWX2W8;
        "pkg-1.18.2-3.14-Fabric" = _eHLOr3eC;
        "pkg-1.18.2-3.14-Forge" = _e1Yle9Cu;
        "pkg-1.18.2-3.15-Fabric" = _aMwytUAf;
        "pkg-1.18.2-3.15-Forge" = _TZzWkbBg;
        "pkg-1.18.2-3.16-Fabric" = _3dE2hQip;
        "pkg-1.18.2-3.16-Forge" = _e1wBXmNG;
        "pkg-1.18.2-3.16.1-Fabric" = _TYeHsMxX;
        "pkg-1.18.2-3.16.1-Forge" = _VykbtwEo;
        "pkg-1.19.2-3.17-Fabric" = _EkUYfYT0;
        "pkg-1.19.2-3.17-Forge" = _Sdfy3tJH;
        "pkg-1.19.2-3.18-Fabric" = _VQ0YoLQe;
        "pkg-1.19.2-3.18-Forge" = _x5BhvG1s;
        "pkg-1.19.2-3.19.0-Fabric" = _4L0R0ZHV;
        "pkg-1.19.2-3.19.0-Forge" = _lkE6BxP7;
        "pkg-1.19.2-3.19.1-Fabric" = _FY6hJ2Rf;
        "pkg-1.19.2-3.19.1-Forge" = _Asnz0UMh;
        "pkg-1.18.2-3.16.2-Fabric" = _Wfmvy7ah;
        "pkg-1.18.2-3.16.2-Forge" = _V45h5HLp;
        "pkg-1.19.2-3.19.2-Fabric" = _Q2UxBNoH;
        "pkg-1.19.2-3.19.2-Forge" = _5wlHvo5U;
        "pkg-1.19.2-3.19.3-Fabric" = _3XvIzvAW;
        "pkg-1.19.2-3.19.3-Forge" = _PHODppIQ;
        "pkg-1.19.2-3.19.4-Fabric" = _ZRga0jCH;
        "pkg-1.19.2-3.19.4-Forge" = _EF7IhW7E;
        "pkg-1.19.2-3.19.5-Fabric" = _wg4UepQF;
        "pkg-1.19.2-3.19.5-Forge" = _dvTtLoWz;
        "pkg-1.19.3-3.20.0-alpha.1-Fabric" = _wyNTFWWk;
        "pkg-1.19.3-3.20.0-alpha.1-Forge" = _fFRNllgD;
        "pkg-1.19.3-3.20.0-alpha.2-Fabric" = _KKWH82tx;
        "pkg-1.19.3-3.20.0-alpha.2-Forge" = _BsrHfhhT;
        "pkg-1.19.2-3.19.6-Fabric" = _SrUzRL4Q;
        "pkg-1.19.2-3.19.6-Forge" = _9WhsLj99;
        "pkg-1.19.3-3.20.0-beta.1-Fabric" = _KXwidG7p;
        "pkg-1.19.3-3.20.0-beta.1-Forge" = _Q6nlORr0;
        "pkg-1.19.3-3.20.0-Fabric" = _k3ngZVYx;
        "pkg-1.19.3-3.20.0-Forge" = _4NKNTLwg;
        "pkg-1.19.3-3.20.1-Fabric" = _XA2oKAtL;
        "pkg-1.19.3-3.20.1-Forge" = _4ofJiudf;
        "pkg-1.19.4-3.21.0-alpha.1-Fabric" = _yVbodOm3;
        "pkg-1.19.4-3.21.0-alpha.1-Forge" = _VLM75r7a;
        "pkg-1.19.4-3.21.0-Fabric" = _DrZk5q5V;
        "pkg-1.19.4-3.21.0-Forge" = _12oRHo4N;
        "pkg-1.19.2-3.19.7-Fabric" = _sCe2zJ0O;
        "pkg-1.19.2-3.19.7-Forge" = _QBwotYOA;
        "pkg-1.19.4-3.21.1-Fabric" = _MUMdaslk;
        "pkg-1.19.4-3.21.1-Forge" = _xHovHco9;
        "pkg-1.19.2-3.19.8-Fabric" = _5qrrVl2C;
        "pkg-1.19.2-3.19.8-Forge" = _dlC0hftx;
        "pkg-1.19.4-3.21.2-Fabric" = _rbrMXJPh;
        "pkg-1.19.4-3.21.2-Forge" = _SPdo4E8D;
        "pkg-1.19.4-3.21.3-Fabric" = _X3FPheg2;
        "pkg-1.19.4-3.21.3-Forge" = _9rv1UCWN;
        "pkg-1.19.2-3.19.9-Fabric" = _jUrmceaS;
        "pkg-1.19.2-3.19.9-Forge" = _2cZhaL7J;
        "pkg-1.18.2-3.16.3-Fabric" = _A0J50K5n;
        "pkg-1.18.2-3.16.3-Forge" = _7RuejqMS;
        "pkg-1.18.2-3.16.4-Fabric" = _OO5uym3l;
        "pkg-1.18.2-3.16.4-Forge" = _SmIBzG0m;
        "pkg-1.19.3-3.20.2-Fabric" = _AlICoWuc;
        "pkg-1.19.3-3.20.2-Forge" = _75s84Qrv;
        "pkg-1.19.4-3.21.4-Fabric" = _9ApgC9Ev;
        "pkg-1.19.4-3.21.4-Forge" = _deZUlvI5;
        "pkg-1.20-3.22.0-alpha.1-Fabric" = _PB50OHi6;
        "pkg-1.20-3.22.0-alpha.1-Forge" = _XXVPa8f5;
        "pkg-1.20-3.22.0-alpha.2-Fabric" = _Rgv6mxgB;
        "pkg-1.20-3.22.0-alpha.2-Forge" = _K5r9F0vW;
        "pkg-1.19.4-3.21.5-Fabric" = _ZQjMeUuJ;
        "pkg-1.19.4-3.21.5-Forge" = _TbMCJxj7;
        "pkg-1.19.2-3.19.10-Fabric" = _MEoNqzcL;
        "pkg-1.19.2-3.19.10-Forge" = _vBJv0k02;
        "pkg-1.19.3-3.20.3-Fabric" = _zOloRwvD;
        "pkg-1.19.3-3.20.3-Forge" = _xRlx3cuT;
        "pkg-1.18.2-3.16.5-Fabric" = _CUgnEKKO;
        "pkg-1.18.2-3.16.5-Forge" = _SU2vtvY8;
        "pkg-1.20-3.22.0-alpha.3-Fabric" = _G5MBrrub;
        "pkg-1.20-3.22.0-alpha.3-Forge" = _uq8ZGcDk;
        "pkg-1.19.4-3.21.6-Fabric" = _Y0uyBXIw;
        "pkg-1.19.4-3.21.6-Forge" = _yMUNUqSF;
        "pkg-1.19.2-3.19.11-Fabric" = _qoZywd6N;
        "pkg-1.19.2-3.19.11-Forge" = _HKiHjRbf;
        "pkg-1.20-3.22.0-alpha.4-Fabric" = _PhJHdfCq;
        "pkg-1.20-3.22.0-alpha.4-Forge" = _ozviYKAq;
        "pkg-1.19.4-3.21.7-Fabric" = _Sch3YbFh;
        "pkg-1.19.4-3.21.7-Forge" = _xXw38FWP;
        "pkg-1.18.2-3.16.6-Fabric" = _tSDAP82h;
        "pkg-1.18.2-3.16.6-Forge" = _Dp2L0dhz;
        "pkg-1.19.2-3.19.12-Fabric" = _3n0ZLZyN;
        "pkg-1.19.2-3.19.12-Forge" = _R5zV5ROi;
        "pkg-1.20-3.22.0-alpha.5-Fabric" = _p35CST3F;
        "pkg-1.20-3.22.0-alpha.5-Forge" = _vYutIurF;
        "default" = _vYutIurF;
    });
