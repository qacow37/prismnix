...
let
    ...
    in {
        ...
        "pkg-1.3.2" = _xKaU7rFf;
        "pkg-1.3.3" = _jrlgKkbv;
        "pkg-1.3.5+forge-1.21.4" = _2p1vo0k8;
        "pkg-1.3.5+fabric-1.21.4" = _QrbScRDm;
        "pkg-1.3.5+fabric-1.21.1" = _xh7d4jMA;
        "pkg-1.3.5+forge-1.21.1" = _tQtECLS6;
        "pkg-1.3.7+fabric-1.21.4" = _MJjrfgAy;
        "pkg-1.3.7+forge-1.21.4" = _qK2lM5tG;
        "pkg-1.3.7+forge-1.21.1" = _92LoNJ9G;
        "pkg-1.3.7+fabric-1.21.1" = _zNCYkWCY;
        "pkg-1.4.2+fabric-1.21.1" = _ENZi5zx3;
        "pkg-1.4.2+fabric-1.21.4" = _QmWj3l1y;
        "pkg-1.4.2+fabric-1.21.9" = _c5AGaq6z;
        "pkg-1.4.2+neoforge-1.21.9" = _VvypAnVn;
        "pkg-1.4.2+fabric-1.21.11" = _LEhYbbmh;
        "pkg-1.4.2+neoforge-1.21.11" = _KMGpEmSW;
        "pkg-1.4.3+fabric-1.21.1" = _GvAFWtqO;
        "pkg-1.4.3+fabric-1.21.4" = _ZeuoGT8q;
        "pkg-1.4.3+fabric-1.21.9" = _3av7fYPQ;
        "pkg-1.4.3+neoforge-1.21.9" = _BFb0kE6H;
        "pkg-1.4.3+fabric-1.21.11" = _EN9s8XSe;
        "pkg-1.4.3+neoforge-1.21.11" = _tIl54eqw;
        "default" = _tIl54eqw;
    });
