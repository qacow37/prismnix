...
let
    ...
    in {
        ...
        "pkg-v5.0.0-1.19.3-Forge" = _cLr9anxf;
        "pkg-v6.0.0-1.19.4-Forge" = _ZmwN9Jay;
        "pkg-v6.0.0-1.19.4-Fabric" = _5bdjiGig;
        "pkg-v7.0.0-1.20-Fabric" = _R3PGlhdh;
        "pkg-v7.0.0-1.20-Forge" = _mFTo7QBO;
        "pkg-v8.0.0-1.20.1-Forge" = _bgysSoBj;
        "pkg-v8.0.0-1.20.1-Fabric" = _JGuJYpJ7;
        "pkg-v3.0.0-1.18.2-Forge" = _u5S8gxPd;
        "pkg-v3.0.0-1.18.2-Fabric" = _Hjhd0V2i;
        "pkg-v20.4.0-1.20.4-Fabric" = _cCyeeEFW;
        "pkg-v20.4.0-1.20.4-Forge" = _AyuBTp8B;
        "pkg-v20.4.0-1.20.4-NeoForge" = _dC0w2lwk;
        "pkg-v20.4.1-1.20.4-Fabric" = _1VAq09nG;
        "pkg-v20.4.1-1.20.4-Forge" = _2BxtAzge;
        "pkg-v20.4.1-1.20.4-NeoForge" = _AH8bvJcH;
        "pkg-v21.0.0-1.21-Fabric" = _I2KtZEPm;
        "pkg-v21.0.0-1.21-NeoForge" = _XBfRrsUk;
        "pkg-v21.1.0-1.21.1-Fabric" = _13TefZSt;
        "pkg-v21.1.0-1.21.1-NeoForge" = _V6PVdKh9;
        "pkg-v21.3.0-1.21.3-Fabric" = _mRvZk3Cl;
        "pkg-v21.3.0-1.21.3-NeoForge" = _vNirqp3l;
        "pkg-v21.4.0-1.21.4-Fabric" = _wrZcrbwT;
        "pkg-v21.4.0-1.21.4-NeoForge" = _7BD8zAA4;
        "pkg-v21.5.0-1.21.5-Fabric" = _TIfAsU3R;
        "pkg-v21.5.0-1.21.5-NeoForge" = _iEylwkQh;
        "pkg-v21.5.1-1.21.5-Fabric" = _GLVUaJR6;
        "pkg-v21.5.1-1.21.5-NeoForge" = _iIerDkpr;
        "pkg-v21.6.0-1.21.6-Fabric" = _pDbT94mz;
        "pkg-v21.6.0-1.21.6-NeoForge" = _xupNWQVR;
        "pkg-v21.7.0-1.21.7-Fabric" = _JO4mNSyq;
        "pkg-v21.7.0-1.21.7-NeoForge" = _JqwwLQz5;
        "pkg-v21.8.0-1.21.8-Fabric" = _UKyYYRDj;
        "pkg-v21.8.0-1.21.8-NeoForge" = _QdvuxnzM;
        "pkg-21.9.0" = _M3rpNPrf;
        "pkg-21.10.0" = _zOOCyUJ4;
