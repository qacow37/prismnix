...
let
    ...
    in {
        ...
        "pkg-1.0.51" = _GabxbD5O;
        "pkg-1.0.6" = _qmmRBBgH;
        "pkg-1.0.81" = _XU9XelX2;
        "pkg-1.0.9" = _Nh8qfKGr;
        "pkg-1.0.91" = _lRmjeOyg;
        "pkg-1.0.92" = _SdHCGVf5;
        "pkg-1.1.01" = _Ro4Jt6Hr;
        "pkg-1.01.02" = _sVHZOAhJ;
        "pkg-1.0.1.036" = _qbz273zk;
        "pkg-1.01.037" = _KjL8MJxl;
        "pkg-1.01.04" = _u084iKRG;
        "pkg-1.01.045" = _S2pAYW5m;
        "pkg-1.02.12" = _DPjHfwEB;
        "pkg-1.02.13" = _ntu5PG0K;
        "pkg-1.02.131" = _wz245kyd;
        "pkg-1.02.14" = _ju2uiQLN;
        "pkg-1.02.14.1" = _DAXzcmS1;
        "pkg-1.02.14.2" = _EPYBSbcr;
        "pkg-1.02.20" = _h6aIJExe;
        "pkg-1.02.22" = _1mFmKyBw;
        "pkg-1.02.23" = _Mw6oxSFB;
        "pkg-1.03.01" = _mjIOYEOa;
        "pkg-1.03.02" = _B2JFoizS;
        "pkg-1.03.03" = _2DTDZtUA;
        "pkg-1.03.03.001" = _cXRoEgFb;
        "pkg-1.03.03.002" = _JJdmFfvn;
        "pkg-1.03.04" = _BaMuLAzZ;
        "pkg-1.03.05" = _vhdc3ywQ;
        "pkg-1.03.06" = _tkSFlMh4;
        "pkg-1.03.07" = _pNyth13x;
        "pkg-1.03.08" = _lupYZXUm;
        "pkg-1.04.00" = _XD2t5HIa;
        "pkg-1.04.01" = _43vxIIwL;
        "pkg-1.04.03" = _Uk5GwtF5;
        "pkg-1.04.04" = _h2VtJdW0;
        "pkg-1.04.05" = _iUbyuuxM;
        "pkg-1.04.06" = _kBizmwz6;
        "default" = _kBizmwz6;
    });
