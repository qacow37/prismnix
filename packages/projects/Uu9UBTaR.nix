...
let
    ...
    in {
        ...
        "pkg-2.3.73-9d4849d" = _Nl9QdP4K;
        "pkg-2.3.73-cb6382f" = _5lS9aiNK;
        "pkg-2.3.73-0827316" = _EKZ6TgCB;
        "pkg-2.3.73-1187ce4" = _sBxbXeLs;
        "pkg-2.3.73-b157c7b" = _tTklo4cr;
        "pkg-2.3.73-54d5f88" = _VjUcnVIY;
        "pkg-2.3.73-eccec08" = _DHgUIYvD;
        "pkg-2.3.73-30f1d83" = _IXPg0AiG;
        "pkg-2.3.73-15c96c3" = _SRFU9VzB;
        "pkg-2.3.73-2067d02" = _qfVD6kBC;
        "pkg-2.3.73-68c2a51" = _dYVRCeXv;
        "pkg-2.3.73-1afc8f5" = _lvPuFkBv;
        "pkg-2.3.73-699cb7e" = _JSNixpVd;
        "pkg-2.3.73-9aa048c" = _oXOlTDW2;
        "pkg-2.3.73-7396b08" = _csT4A4Ne;
        "pkg-2.3.73-3825790" = _eWZKX14H;
        "pkg-2.3.73-7ae9930" = _nyMogh74;
        "pkg-2.3.73-2e3b7cd" = _58yZmvMo;
        "pkg-2.3.73-1f43444" = _s8MgKrcl;
        "pkg-2.3.73-08c8c22" = _Grquuq6s;
        "pkg-2.3.73-d20bd5b" = _JN89CIKP;
        "pkg-2.3.73-f09ab2e" = _aimlYCq7;
        "pkg-2.3.73-b8db1d4" = _jeGNuiLa;
        "pkg-2.3.73-9127059" = _2fuPtoVl;
        "pkg-2.3.73-d69f904" = _XuKDPvio;
        "pkg-2.3.73-b45ccdd" = _4M8KAIU8;
        "pkg-2.3.73-dbe118a" = _dGAmAhLK;
        "pkg-2.3.73-8b05559" = _zKPCf1QB;
        "pkg-2.3.73-bbcfc62" = _oidIx50A;
        "pkg-2.3.73-d3917dd" = _nti5t3yZ;
        "pkg-2.3.73-e33ec2f" = _R1jVpe1g;
        "pkg-2.3.74" = _mCY5tFS9;
        "pkg-2.3.73-3027a99" = _RLfsAQ1s;
        "pkg-2.3.73-350c773" = _lg3Vy7xD;
        "pkg-2.3.73-e5e1b4a" = _UsxQTpSh;
        "pkg-2.3.73-fb5b631" = _zq5PVDKk;
        "pkg-2.3.73-f2cbf16" = _dMDze1u1;
        "pkg-2.3.73-dd350af" = _g2HdivlP;
        "pkg-2.3.73-11541e5" = _w2tNob6V;
        "pkg-2.3.73-3455265" = _Cnid5Pjk;
        "pkg-2.3.73-97071e9" = _nteOQkiP;
        "pkg-2.3.73-9b791e9" = _TLAs0DOD;
        "pkg-2.3.73-8e20a12" = _TWiUWSzh;
        "pkg-2.3.73-9f59492" = _y1Y0ANzs;
        "pkg-2.3.73-de2a1ce" = _3jWEuRgZ;
        "pkg-2.3.73-e0d0a9b" = _cj9s0BoN;
        "pkg-2.3.73-b0e43b0" = _aSrjVo8e;
        "pkg-2.3.73-4b8b39c" = _pQEv44Px;
        "pkg-2.3.73-4e82779" = _rheM58rh;
        "pkg-2.3.73-633f752" = _iMW5Pbw4;
        "pkg-2.3.73-79306ba" = _N5KZokxD;
        "pkg-2.3.73-1c13a08" = _VUV9JLQs;
        "pkg-2.3.73-bcd0048" = _3dAoiuEt;
        "pkg-2.3.74-2a46681" = _1lgOk9eq;
        "pkg-2.3.74-d88e290" = _MypQAPNc;
        "pkg-2.3.74-afc6756" = _1AGiVU6j;
        "pkg-2.3.74-4014ed6" = _hnyd9LnU;
        "pkg-2.3.74-6e5dfb4" = _lpTvr4bn;
        "pkg-2.3.74-604db3f" = _9AMnTejR;
        "pkg-2.3.74-0279e3f" = _ZimmDgfq;
        "pkg-2.3.74-a484bd3" = _jIW3lm1d;
        "pkg-2.3.74-ba361c6" = _4XMXC8gF;
        "pkg-2.3.74-8147384" = _ySIpIl79;
        "pkg-2.3.74-bc1545f" = _EyDv09lv;
        "pkg-2.3.74-e545903" = _fGYGNvc7;
        "pkg-2.3.74-b44b195" = _WhPeV4nh;
        "pkg-2.3.74-d503ece" = _3XorYSqv;
        "pkg-2.3.74-54ffd42" = _l8HmEncH;
        "pkg-2.3.74-675fba3" = _7EhSfpzM;
        "pkg-2.3.74-aad5c59" = _cjeRecYc;
        "pkg-2.3.74-a3a95cc" = _wnFr2wIn;
        "default" = _wnFr2wIn;
    });
