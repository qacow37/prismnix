...
let
    ...
    in {
        ...
        "pkg-0.1.1+1.20.1-0f8b7a9" = _4IW3S96F;
        "pkg-0.1.2+1.20.1" = _8892Wqoi;
        "pkg-0.1.2+1.19.4" = _dZE1NNlF;
        "pkg-0.1.2+1.19.3" = _Bdf9vHIF;
        "pkg-0.1.2+1.19.2" = _68pcF68H;
        "pkg-0.1.2+1.18.2" = _H6QWSHtz;
        "pkg-0.1.4+1.20.4" = _m8a82uVo;
        "pkg-0.1.4+1.20.2" = _ulEKyIjx;
        "pkg-0.1.4+1.20.1" = _vo8jpIKn;
        "pkg-0.1.4+1.19.3" = _s1efSLTr;
        "pkg-0.1.4+1.19.2" = _s8mttfVP;
        "pkg-0.1.4+1.18.2" = _9YVrv5Mn;
        "pkg-0.1.4+1.16.5" = _DVLIX9eq;
        "pkg-0.1.4+1.19.4" = _2Biyqps2;
        "pkg-0.1.5+1.16.5" = _59sTrX0T;
        "pkg-0.1.5+1.18.2" = _g3MYqNZu;
        "pkg-0.1.5+1.19.2" = _Th6hJi2q;
        "pkg-0.1.5+1.19.3" = _6hZovjjg;
        "pkg-0.1.5+1.19.4" = _VUU6bf3d;
        "pkg-0.1.5+1.20.1" = _4HqSmvZ6;
        "pkg-0.1.5+1.20.2" = _K59ON55d;
        "pkg-0.1.5+1.20.4" = _BtzRAN8G;
        "pkg-0.1.5+1.20.6" = _D9poLKNg;
        "pkg-0.1.5+1.21.1" = _yXFi1fed;
        "pkg-0.1.5+1.21.3" = _nW9gA0t6;
        "pkg-0.1.5+1.21.4" = _jwkgiBA0;
        "pkg-0.1.5b+1.21.4" = _caTeyUwg;
        "pkg-0.1.6+1.16.5" = _1aM7wzQx;
        "pkg-0.1.6+1.18.2" = _xdGYzHU3;
        "pkg-0.1.6+1.19.2" = _SH4GA5Ld;
        "pkg-0.1.6+1.19.3" = _EaSdf2wU;
        "pkg-0.1.6+1.19.4" = _mOvu1lhz;
        "pkg-0.1.6+1.20.1" = _LXMnmMxn;
        "pkg-0.1.6+1.20.2" = _iQCiV8xX;
        "pkg-0.1.6+1.20.4" = _Qse7fJCS;
        "pkg-0.1.6+1.20.6" = _pK938qix;
        "pkg-0.1.6+1.21.1" = _AvgeQoZm;
        "pkg-0.1.6+1.21.3" = _67cTlF79;
        "pkg-0.1.6+1.21.4" = _zsrG9CmF;
        "default" = _zsrG9CmF;
    });
