...
let
    ...
    in {
        ...
        "pkg-1.18.2.11" = _ZTTiumPr;
        "pkg-1.19.2.11" = _XyPD4r6y;
        "pkg-1.19.4.11" = _9JnEkviE;
        "pkg-1.20.1.11" = _CCN3uISP;
        "pkg-1.20.4.11" = _wouIx1mL;
        "pkg-1.20.6.11" = _NGZFxnpT;
        "pkg-1.18.2.12" = _2ZLGdHnq;
        "pkg-1.19.2.12" = _ViAyIFMN;
        "pkg-1.19.4.12" = _RfKNFdeY;
        "pkg-1.20.1.12" = _Ew24swK1;
        "pkg-1.20.4.12" = _W5y4YJHR;
        "pkg-1.20.6.12" = _r54UvvRU;
        "pkg-1.21.1.12" = _VjJSZbFw;
        "pkg-1.18.2.13" = _OMlIKfCv;
        "pkg-1.19.2.13" = _hlzE3wvx;
        "pkg-1.19.4.13" = _YC6ML0Hr;
        "pkg-1.20.1.13" = _aiUqfLoe;
        "pkg-1.20.4.13" = _7cbnYPxC;
        "pkg-1.20.6.13" = _XBd9VfKK;
        "pkg-1.21.1.13" = _9pdmmwkK;
        "pkg-1.18.2.14" = _3yEryHNa;
        "pkg-1.19.2.14" = _irlg4l3n;
        "pkg-1.19.4.14" = _HwKaq380;
        "pkg-1.20.1.14" = _5ISwQFqz;
        "pkg-1.20.4.14" = _dMQyg2ky;
        "pkg-1.20.6.14" = _G8CWTqCt;
        "pkg-1.21.1.14" = _Yv1BmJGH;
        "pkg-1.18.2.15" = _cSn8cKKH;
        "pkg-1.19.2.15" = _UUxlE6Wt;
        "pkg-1.19.4.15" = _URIHOQaF;
        "pkg-1.20.1.15" = _vlkzrEQO;
        "pkg-1.20.4.15" = _oFRDhiwT;
        "pkg-1.20.6.15" = _zbgFXQaZ;
        "pkg-1.21.1.15" = _NAg0ZWCd;
        "pkg-1.18.2.16" = _ManOc1pv;
        "pkg-1.19.2.16" = _SF3NR0Op;
        "pkg-1.19.4.16" = _v6nGDjMc;
        "pkg-1.20.1.16" = _JSZvYXTh;
        "pkg-1.20.4.16" = _QaTZcW1X;
        "pkg-1.20.6.16" = _REEAbRFb;
        "pkg-1.21.1.16" = _7jZqLWzJ;
        "default" = _7jZqLWzJ;
    });
