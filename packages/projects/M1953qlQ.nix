...
let
    ...
    in {
        ...
        "pkg-1.0.13" = _yaKkGeBn;
        "pkg-1.0.14" = _uyEnPWwc;
        "pkg-1.0.15" = _ImsXyeAn;
        "pkg-1.0.16" = _Jz5eewAo;
        "pkg-1.0.17" = _OHgqw2cM;
        "pkg-1.1.1" = _EDFKAsEd;
        "pkg-1.0.18" = _QUCEXsuZ;
        "pkg-1.1.2" = _eQYA6EPm;
        "pkg-1.1.3" = _Mk4JvsHk;
        "pkg-1.0.19" = _Z9VrRna2;
        "pkg-1.2.0" = _CDqoVuzU;
        "pkg-1.1.4" = _zrSzjHIt;
        "pkg-1.0.20" = _TIzyR4bY;
        "pkg-2.0.0" = _JXU6RJAv;
        "pkg-2.1.0" = _nVDWZ9N7;
        "pkg-2.2.0" = _HaBv9PTz;
        "pkg-2.2.1" = _9jltWR8L;
        ...
        "pkg-3.6.2" = _o55iW2hj;
        "pkg-3.6.3" = _yNfFCumq;
        "pkg-3.5.10" = _r1NCEJq0;
        "pkg-3.5.11" = _ainjLObZ;
        "pkg-3.6.4" = _bG35KluP;
        "pkg-3.5.12" = _rifuJXe5;
        "pkg-3.5.13" = _9duMI0ZZ;
        "pkg-3.5.14" = _7IQGFD9U;
        "pkg-3.7.0" = _Eby2lL9x;
        "pkg-3.7.1" = _dhQbt1rr;
        "pkg-3.5.15" = _8OSre7Qa;
        "pkg-3.7.2" = _cDu7RHev;
        "pkg-3.7.3" = _Juv6PsWA;
        "pkg-3.5.16" = _PCHBx4iE;
        "pkg-3.7.4" = _I0ETJQnh;
        "pkg-3.5.17" = _ePQmdj7g;
        "pkg-3.7.5" = _QXLATWIS;
        "pkg-3.9.0" = _vK3REr6N;
        "pkg-3.7.6" = _YwwLmDz9;
        "pkg-3.9.1" = _bjepA5CF;
        "pkg-3.11.0" = _wJQBpEpg;
        "pkg-3.11.1" = _xbGf0GR1;
        "pkg-3.11.2" = _nC6Zw8Lx;
        "pkg-3.9.2" = _GEaeaZS0;
        "pkg-3.5.18" = _xP9NdAK3;
        "pkg-3.7.7" = _GRfZvjzt;
        "pkg-3.11.3" = _8bR7M6K7;
        "pkg-4.0.0" = _wqvqzKdc;
        "pkg-4.0.1" = _GMW14IUd;
        "pkg-5.0.0" = _RqoPv70U;
        "default" = _RqoPv70U;
