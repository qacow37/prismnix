...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0-Fabric" = _TrBeD0VE;
        "pkg-1.18.2-1.0-Forge" = _o3d4hiGh;
        "pkg-1.18.2-1.1-Fabric" = _qziORD8T;
        "pkg-1.18.2-1.1-Forge" = _LXi9JA0t;
        "pkg-1.18.2-1.2-Fabric" = _pmSlJE3a;
        "pkg-1.18.2-1.2-Forge" = _bTzWcXn9;
        "pkg-1.19-1.3-Fabric" = _hgrJcyhJ;
        "pkg-1.19-1.3-Forge" = _vACOywvG;
        "pkg-1.19.3-1.4.0-Fabric" = _qvMXhRPO;
        "pkg-1.19.3-1.4.0-Forge" = _VoPuWSiQ;
        "pkg-1.19-1.3.1-Fabric" = _LLMrIbKB;
        "pkg-1.19-1.3.1-Forge" = _fzX6F8pE;
        "pkg-1.19.3-1.4.1-Fabric" = _21mWDMSP;
        "pkg-1.19.3-1.4.1-Forge" = _x40FWRFu;
        "pkg-1.19-1.3.2-Fabric" = _MICLELC4;
        "pkg-1.19-1.3.2-Forge" = _CFRuOvDA;
        "pkg-1.19.3-1.4.2-Fabric" = _uuvby4hl;
        "pkg-1.19.3-1.4.2-Forge" = _dW5k76ew;
        "pkg-1.19.4-1.5.0-Fabric" = _WjEilcFm;
        "pkg-1.19.4-1.5.0-Forge" = _hVE8v36O;
        "pkg-1.20-1.6.0-Fabric" = _3ZAVSk1T;
        "pkg-1.20-1.6.0-Forge" = _msU5FraE;
        "pkg-1.20.2-1.7.0-Fabric" = _H8Ze2qmV;
        "pkg-1.20.2-1.7.0-Forge" = _s2XguDw1;
        "pkg-1.20.2-1.7.0-NeoForge" = _3NKLN2vA;
        "pkg-1.20-1.6.1-Fabric" = _CMZ4o7jB;
        "pkg-1.20-1.6.1-Forge" = _fsY9zL8C;
        "pkg-1.21.1-1.8.0-NeoForge" = _LWpDbDEs;
        "pkg-1.21.1-1.8.0-Fabric" = _Ntd2sRi7;
        "default" = _Ntd2sRi7;
    });
