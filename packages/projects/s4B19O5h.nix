...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.4" = _Hwd34pJE;
        "pkg-1.18.2-1.3" = _akc5PtxP;
        "pkg-1.19-1.1" = _Klk35XFY;
        "pkg-1.19.2-1.1" = _kKqWW0Ab;
        "pkg-1.19.2-1.0" = _8fzZhJne;
        "pkg-1.16.5-2.5" = _KJOf5qmE;
        "pkg-1.18.2-1.4" = _meo2yHW5;
        "pkg-1.19.2-1.2" = _opOBKI5F;
        "pkg-1.19-1.2" = _DX1sndTm;
        "pkg-1.19.3-1.0" = _o9xV8k4Q;
        "pkg-1.16.5-2.6" = _rpxLvYBe;
        "pkg-1.18.2-1.5" = _BZCeSzQl;
        "pkg-1.19.2-1.3" = _GtEA50Y5;
        "pkg-1.19.3-1.1" = _26vuQuQQ;
        "pkg-1.16.5-2.8" = _sbZ4rIvm;
        "pkg-1.18.2-1.6" = _TOjUITg9;
        "pkg-1.19.2-1.4" = _QrFJKnVe;
        "pkg-1.19.3-1.2" = _6hOSeOum;
        "pkg-1.18.2-1.7" = _TgByVplH;
        "pkg-1.19.2-1.5" = _OwwSOX9o;
        "pkg-1.20.1-1.0" = _jKIGTarS;
        "pkg-1.19-1.3" = _NgDdaVZC;
        "pkg-1.19.3-1.3" = _yLN3Ldrb;
        "pkg-1.16.5-2.9" = _lLjYyBnB;
        "pkg-1.16.5-3.0" = _4h4Q6NC4;
        "pkg-1.18.2-1.8" = _nhHDnQCO;
        "pkg-1.19.2-1.6" = _Ei981lBx;
        "pkg-1.19.3-1.4" = _IQW9N2dY;
        "pkg-1.19-1.4" = _L9De0s89;
        "pkg-1.20.1-1.1" = _vl1x25KR;
        "pkg-1.16.5-1.0" = _Rw4YH8cg;
        "pkg-1.18.2-1.0" = _36yVDQBa;
        "pkg-1.19-1.0" = _lLx8NFQC;
        "pkg-1.21.1-1.0" = _z5ZMfM6M;
        "pkg-1.16.5-1.1" = _JjUzc32a;
        "pkg-1.18.2-1.1" = _zfK0jjEj;
        "pkg-1.21.1-1.1" = _Qe1yDsl2;
        "pkg-1.20.1-1.2" = _c8A3eMMk;
        "pkg-1.21.1-1.2" = _qJFeC87p;
        "pkg-1.16.5-1.2" = _lcSdXFEG;
        "pkg-1.16.5-1.2.1" = _d0iARBNK;
        "pkg-1.18.2-1.2" = _QiRc8Ouk;
        "pkg-1.20.1-1.2.1" = _DoQDvBq5;
        "pkg-1.21.1-1.2.1" = _Xv69MOvZ;
        "pkg-1.21.4-1.2.1" = _62rtkRrr;
        "pkg-1.21.4-1.2.2" = _4sRJIqiZ;
        "pkg-1.16.5-1.3" = _7qTqMX0i;
        "pkg-1.21.4-1.4" = _CCEFyAKZ;
        "pkg-1.21.1-1.4" = _twwRDK19;
        "pkg-1.21.1-1.4.1" = _3yqtSHzi;
        "pkg-1.21.4-1.4.1" = _Cp1k89zy;
        "pkg-1.20.1-1.4" = _7j4lfPd3;
        "pkg-1.21.4-1.4.2" = _JL4cVNLO;
        "pkg-1.21.8-1.4" = _6nGrbTVv;
        "pkg-1.19.3-1.4.1" = _cFwZYxSH;
        "pkg-1.19.3-1.4.2" = _HQKpXtv9;
        "pkg-1.16.5-1.4" = _1mZtkmvd;
        "pkg-1.16.5-1.5" = _cAwg6UHv;
        "pkg-1.16.5-1.5.1" = _vNWe4kI2;
        "pkg-1.19-1.5" = _nZ2ExJFd;
        "pkg-1.19.3-1.5" = _vmuSgXQK;
        "pkg-1.20.1-1.5" = _WbazS2Dk;
        "pkg-1.21.1-1.5" = _POZ8yWWK;
        "pkg-1.21.4-1.5" = _uB5u5hqB;
        "pkg-1.21.8-1.5" = _Pj4Ulowm;
        "pkg-1.16.5-1.5.2" = _jN0CxJJ2;
        "pkg-1.18.2-1.5.1" = _wgmBLMTr;
        "pkg-1.19-1.5.1" = _gVa4iuM8;
        "pkg-1.19.3-1.5.1" = _JbS2albX;
        "pkg-1.21.8-1.6" = _djHHClSa;
        "pkg-1.21.4-1.6" = _TfU1VfHa;
        "pkg-1.21.1-1.6" = _poodD3ex;
        "pkg-1.20.1-1.6" = _pB4gR4iX;
        "pkg-1.19.3-1.6" = _mqlbQ9O3;
        "pkg-1.19-1.6" = _AsoAH7u6;
        "pkg-1.16.5-1.6" = _MqHcG1qa;
        "default" = _MqHcG1qa;
    });
