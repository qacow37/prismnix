...
let
    ...
    in {
        ...
        "pkg-18.7" = _YpvRJLgt;
        "pkg-18.8" = _oXukYfDI;
        "pkg-19.4.1" = _VLo7iBji;
        "pkg-19.8" = _cdIMj72J;
        "pkg-20.2.1" = _lpsqjLnb;
        "pkg-20.8" = _sX39iiuh;
        "pkg-20.9" = _wpWkYFbH;
        "pkg-20.10" = _67KTm0Gx;
        "pkg-20.11" = _rT4ZFo4Z;
        "pkg-20.12" = _KdswIjQZ;
        "pkg-20.13" = _wQ9KpnjZ;
        "pkg-21.0.1" = _89K7KOAD;
        "pkg-21.0.2" = _bNSDTiZK;
        "pkg-21.1.0" = _6ymhQ0N4;
        "pkg-21.1.1" = _fk6ZSTUf;
        "pkg-21.1.2" = _2fRMwwGH;
        "pkg-21.3.0" = _yoMJNkXe;
        "pkg-21.4.0" = _GePXBRWg;
        "pkg-21.4.1" = _nZTk57qx;
        "pkg-21.5.0" = _5LsW0Vi7;
        "pkg-21.6.0" = _BZqqB60X;
        "pkg-21.7.0" = _GO5y8PEs;
        "pkg-21.8.0" = _WRe4N3Gi;
        "pkg-21.8.1" = _xizGpeEm;
        "pkg-21.10.0" = _mmE93Uya;
        "pkg-21.11.0" = _VmrmcQf5;
        "pkg-21.11.3" = _zx3unlQV;
        "pkg-21.1.3" = _5f4wSDlW;
        "pkg-21.11.4" = _lyGwKLsF;
        "pkg-21.4.2" = _Y6A46TqL;
        "pkg-26.1.0" = _DSRS1eHF;
        "pkg-21.11.6" = _LzoZD4Wj;
