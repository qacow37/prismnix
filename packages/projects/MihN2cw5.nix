...
let
    ...
    in {
        ...
        "pkg-v1.1.9.1" = _UpoxR7Jy;
        "pkg-v1.1.9.2" = _b84zvuhA;
        "pkg-v1.1.9.3" = _4dG5R5rD;
        "pkg-v1.1.10" = _QOYjLHi6;
        "pkg-1.1.11" = _bQLxkKGr;
        "pkg-1.1.12" = _8WOCE3Pg;
        "pkg-1.1.12.1" = _cJGFLfxu;
        "pkg-1.1.13" = _Pc3mIz9j;
        "pkg-1.1.13.1" = _XCrUloap;
        "pkg-1.1.14" = _A7IEF7Cf;
        "pkg-1.1.15" = _Y7ENkcPF;
        "pkg-1.1.15.1" = _CI1lZ1Ru;
        "pkg-1.1.16" = _T7NF2hZD;
        "pkg-1.1.17" = _RTOIIQOq;
        "pkg-1.1.17.1" = _DPEcQEss;
        "pkg-1.1.18" = _ntqQP0fn;
        "pkg-1.1.18.1" = _ksQDHZ6C;
