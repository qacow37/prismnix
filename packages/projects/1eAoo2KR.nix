...
let
    ...
    in {
        ...
        "pkg-2.1.1" = _GkKQsCJ6;
        "pkg-2.2.0" = _3EWbdCzX;
        "pkg-2.2.0-for-1.19.2" = _bIVYcRpm;
        "pkg-2.3.0+beta.1" = _eQtAB8nC;
        "pkg-2.3.0+beta.2" = _TWgoDEtx;
        "pkg-2.3.0+beta.3" = _TXnYvmpI;
        "pkg-2.3.0" = _RmZvIqeu;
        "pkg-2.3.1" = _A04AftxZ;
        "pkg-2.4.0" = _RLTQViRg;
        "pkg-2.4.1" = _51iCmuDG;
        "pkg-2.4.2" = _sj4aPwnQ;
        "pkg-2.5.0+1.19.4-fabric" = _NZpUvhBc;
        "pkg-2.5.0+1.19.4-forge" = _nMuzsoQt;
        "pkg-2.5.1+1.19.4-fabric" = _M5iKxVFU;
        "pkg-2.5.1+1.19.4-forge" = _VHMFG82e;
        "pkg-2.5.1-beta.1+1.20-fabric" = _6EBKvxyG;
        "pkg-3.0.0-beta.1+1.20-fabric" = _qHhZ3Mlp;
        "pkg-3.0.0-beta.2+1.20-fabric" = _CSXeGyWW;
        "pkg-3.0.0-beta.4+1.20-fabric" = _zRlTTWFK;
        "pkg-3.0.0-beta.5+1.20-fabric" = _yShEHkWR;
        "pkg-3.0.0-beta.6+1.20-fabric" = _kr3UvTk4;
        "pkg-3.0.0-beta.1+1.19.4-fabric" = _jZFsc9tg;
        "pkg-3.0.0-beta.1+1.19.4-forge" = _oIlFdLZI;
        "pkg-3.0.0-beta.7+1.20-fabric" = _8WHpxnmg;
        "pkg-3.0.0-beta.2+1.19.4-fabric" = _SiEAKMh4;
        "pkg-3.0.0-beta.2+1.19.4-forge" = _gfyPkvYv;
        "pkg-3.0.0+1.19.4-fabric" = _Vc0cNGqC;
        "pkg-3.0.0+1.19.4-forge" = _uRw9Zalc;
        "pkg-3.0.0+1.20-fabric" = _HOxWjhyo;
        "pkg-3.0.1+1.19.4-fabric" = _9ACWUOXp;
        "pkg-3.0.1+1.19.4-forge" = _wa9YGZhd;
        "pkg-3.0.1+1.20-fabric" = _ZqWkEgYo;
        "pkg-3.0.1+1.20-forge" = _zoMzOEbl;
        "pkg-3.0.2+1.19.4-fabric" = _LM15Ky9N;
        "pkg-3.0.2+1.19.4-forge" = _vASIPGay;
        "pkg-3.0.2+1.20-fabric" = _zJ1Wh6pM;
        "pkg-3.0.2+1.20-forge" = _DjwHtlVp;
        "pkg-3.0.3+1.19.4-fabric" = _omClzsLe;
        "pkg-3.0.3+1.19.4-forge" = _zU7Ejh24;
        "pkg-3.0.3+1.20-fabric" = _g38uL3ti;
        "pkg-3.0.3+1.20-forge" = _3vGF9MOJ;
        "pkg-3.0.4+1.19.4-fabric" = _SqpDFYpa;
        "pkg-3.0.4+1.19.4-forge" = _M1u6F79I;
        "pkg-3.1.0+1.19.4-fabric" = _3HHSMwA9;
        "pkg-3.1.0+1.19.4-forge" = _IsGTmmrV;
        "pkg-3.1.0+1.20-fabric" = _CgwTUAR2;
        "pkg-3.1.0+1.20-forge" = _RPlKFmas;
        "pkg-3.1.1+1.20-fabric" = _VPm1SrE4;
        "pkg-3.1.1+1.20-forge" = _RpevhOax;
        "pkg-3.1.1+1.19.4-fabric" = _gJ6ZmZ4Z;
        "pkg-3.1.1+1.19.4-forge" = _Jf2pciI1;
        "pkg-3.2.0+1.20.2-fabric" = _HM9McfrA;
        "pkg-3.2.0+1.20.2-forge" = _O7kIps9X;
        "pkg-3.2.0+1.20-fabric" = _RBAUxw9P;
        "pkg-3.2.0+1.20-forge" = _4EU2xyVo;
        "pkg-3.2.1+1.20.2-fabric" = _u6jV7Q7R;
        "pkg-3.2.1+1.20.2-forge" = _lVQpbXSe;
        "pkg-3.2.1+1.20-fabric" = _3hsIB5yP;
        "pkg-3.2.1+1.20-forge" = _smEdHeFU;
        "pkg-3.3.0-beta.1+1.20.2-fabric" = _vede4iWJ;
        "pkg-3.3.0-beta.1+1.20.2-forge" = _n8X2J9Hh;
        "pkg-3.3.0-beta.1+1.20.3-fabric" = _ZytICJS4;
        "pkg-3.3.0+1.20.4-fabric" = _IHHNzQkV;
        "pkg-3.3.0+1.20.4-neoforge" = _3TfeWIWo;
        "pkg-3.3.1+1.20.4-fabric" = _cwavYrLH;
        "pkg-3.3.1+1.20.4-neoforge" = _vMzBhYIk;
        "pkg-3.3.2+1.20.4-fabric" = _StXMrAsz;
        "pkg-3.3.2+1.20.4-neoforge" = _5Y3n1Apc;
        "pkg-3.2.2+1.20-fabric" = _DretS191;
        "pkg-3.2.2+1.20-forge" = _WdbHS4uT;
        "pkg-3.4.0+1.20.5-fabric" = _elFOHmh9;
        "pkg-3.4.0+1.20.4-neoforge" = _R7WWpY0Z;
        "pkg-3.4.0+1.20.4-fabric" = _G8Aq3OEv;
        "pkg-3.4.0+1.20.1-forge" = _WTCAdLsq;
        "pkg-3.4.0+1.20.1-fabric" = _MJUxq3kq;
        "pkg-3.4.1+1.20.5-fabric" = _LXUa8bFw;
        "pkg-3.4.1+1.20.4-neoforge" = _h61Z2iVZ;
        "pkg-3.4.1+1.20.4-fabric" = _dLAG06tP;
        "pkg-3.4.1+1.20.1-forge" = _CL7AHQsm;
        "pkg-3.4.1+1.20.1-fabric" = _HHrwznjQ;
        "pkg-3.4.2+1.20.5-neoforge" = _XNQUud9H;
        "pkg-3.4.2+1.20.5-fabric" = _rsM9VY0D;
        "pkg-3.4.2+1.20.4-neoforge" = _bovSU7Mt;
        "pkg-3.4.2+1.20.4-fabric" = _EkAJiIZH;
        "pkg-3.4.2+1.20.1-forge" = _lALu7fvN;
        "pkg-3.4.2+1.20.1-fabric" = _TD5Fv92S;
        "pkg-3.4.3+1.20.6-neoforge" = _ePcFYsKB;
        "pkg-3.4.3+1.20.6-fabric" = _hf7D9v77;
        "pkg-3.4.3+1.20.4-neoforge" = _8DXWiiaq;
        "pkg-3.4.3+1.20.4-fabric" = _mkXoQQMn;
        "pkg-3.4.4+1.20.6-neoforge" = _ZHFdxhFP;
        "pkg-3.4.4+1.20.4-neoforge" = _hCwZI62j;
        "pkg-3.4.4+1.20.6-fabric" = _sDwfolBP;
        "pkg-3.4.4+1.20.4-fabric" = _G2PcCpZl;
        "pkg-3.4.4+1.20.1-forge" = _3jH5u49m;
        "pkg-3.4.4+1.20.1-fabric" = _RXrT2ogA;
        "pkg-3.5.0+1.20.1-fabric" = _gQuF6HNa;
        "pkg-3.5.0+1.20.1-forge" = _C0nuSdTs;
        "pkg-3.5.0+1.20.4-fabric" = _Jl7pSXPu;
        "pkg-3.5.0+1.20.4-neoforge" = _Ha6NtXW8;
        "pkg-3.5.0+1.20.6-fabric" = _xiSmTJ03;
        "pkg-3.5.0+1.20.6-neoforge" = _zoyKoGDQ;
        "pkg-3.5.0+1.21-fabric" = _Y8Wa10Re;
        "pkg-3.5.0+1.21-neoforge" = _sjARwr7i;
        "pkg-3.6.0+1.21.2-fabric" = _TQN6aweQ;
        "pkg-3.6.0+1.20.1-fabric" = _uvooYjoA;
        "pkg-3.6.0+1.20.1-forge" = _N8IUa6T3;
        "pkg-3.6.0+1.21-neoforge" = _pV6YTxUa;
        "pkg-3.6.0+1.21-fabric" = _wUxT9toF;
        "pkg-3.6.0+1.20.6-neoforge" = _ORSMwyh9;
        "pkg-3.6.0+1.20.4-neoforge" = _JtyrFSor;
        "pkg-3.6.0+1.20.6-fabric" = _AAvOQ5xy;
        "pkg-3.6.0+1.20.4-fabric" = _WKFetSnp;
        "pkg-3.6.1+1.21.2-fabric" = _HlJ8azv1;
        "pkg-3.6.1+1.21.2-neoforge" = _QOOfByC6;
        "pkg-3.6.1+1.20.4-neoforge" = _8vBjGVX8;
        "pkg-3.6.1+1.20.6-neoforge" = _gghJ3kOy;
        "pkg-3.6.1+1.21-neoforge" = _TC62OAaO;
        "pkg-3.6.1+1.20.1-forge" = _R3Sxv49H;
        "pkg-3.6.1+1.21-fabric" = _f9ZVX07g;
        "pkg-3.6.1+1.20.6-fabric" = _BYPuUVlm;
        "pkg-3.6.1+1.20.1-fabric" = _nYfjbBJd;
        "pkg-3.6.1+1.20.4-fabric" = _nrWoaGZB;
        "pkg-3.6.2+1.21.4-neoforge" = _IECszfbl;
        "pkg-3.6.2+1.21.4-fabric" = _VtWuZoXP;
        "pkg-3.6.2+1.21-neoforge" = _MCJlLTYc;
        "pkg-3.6.2+1.21.2-neoforge" = _geakVWB5;
        "pkg-3.6.2+1.21.2-fabric" = _TOvVcn1z;
        "pkg-3.6.2+1.20.6-fabric" = _bMaDkSXq;
        "pkg-3.6.2+1.21-fabric" = _iu96ISLv;
        "pkg-3.6.2+1.20.6-neoforge" = _n9bPef7m;
        "pkg-3.6.2+1.20.4-neoforge" = _9kiT28QY;
        "pkg-3.6.2+1.20.1-forge" = _PI0hRkb0;
        "pkg-3.6.2+1.20.4-fabric" = _bxECa7VA;
        "pkg-3.6.2+1.20.1-fabric" = _yDSgD8Iz;
        "pkg-3.6.3+1.21.1-neoforge" = _5APbkNF6;
        "pkg-3.6.3+1.21.4-neoforge" = _d8PQvEwL;
        "pkg-3.6.3+1.21.3-neoforge" = _eZawmC6O;
        "pkg-3.6.3+1.21.1-fabric" = _yY173HWg;
        "pkg-3.6.3+1.20.6-fabric" = _EU5MKMQQ;
        "pkg-3.6.3+1.20.6-neoforge" = _wIRu2SEH;
        "pkg-3.6.3+1.20.4-neoforge" = _479sfekG;
        "pkg-3.6.3+1.21.4-fabric" = _4PdMGo3P;
        "pkg-3.6.3+1.20.1-fabric" = _kkPxieHD;
        "pkg-3.6.3+1.21.3-fabric" = _In9neXQ3;
        "pkg-3.6.3+1.20.4-fabric" = _yrYPPc63;
        "pkg-3.6.4+1.21.4-fabric" = _jX8BiV3k;
        "pkg-3.6.4+1.21.4-neoforge" = _gUD16yld;
        "pkg-3.6.4+1.21.5-fabric" = _sv3JfGCo;
        "pkg-3.6.4+1.21.3-fabric" = _JqKJBKgz;
        "pkg-3.6.4+1.21.3-neoforge" = _pbxW1jnh;
        "pkg-3.6.4+1.21.1-fabric" = _J3PB7Og6;
        "pkg-3.6.4+1.21.1-neoforge" = _1jGsUG9H;
        "pkg-3.6.4+1.20.6-fabric" = _XEiohqZg;
        "pkg-3.6.4+1.20.6-neoforge" = _NdKizYOg;
        "pkg-3.6.4+1.20.4-fabric" = _cvImGHtR;
        "pkg-3.6.4+1.20.4-neoforge" = _1HCuwggY;
        "pkg-3.6.4+1.20.1-fabric" = _bfMUNH5J;
        "pkg-3.6.4+1.20.1-forge" = _Z34WRRoh;
        "pkg-3.6.5+1.21.4-fabric" = _XbXdhxJQ;
        "pkg-3.6.5+1.21.4-neoforge" = _ZD4qkUCB;
        "pkg-3.6.5+1.21.5-fabric" = _N8BEH8su;
        "pkg-3.6.5+1.21.3-fabric" = _TB4VxY7q;
        "pkg-3.6.5+1.21.3-neoforge" = _iW8SNpjh;
        "pkg-3.6.5+1.21.1-fabric" = _BMVCssHI;
        "pkg-3.6.5+1.21.1-neoforge" = _XoVxAvc2;
        "pkg-3.6.5+1.20.6-fabric" = _fOW6d7Rp;
        "pkg-3.6.5+1.20.6-neoforge" = _SHCusVSt;
        "pkg-3.6.5+1.20.4-fabric" = _2MuykWUS;
        "pkg-3.6.5+1.20.4-neoforge" = _8vlgP4zE;
        "pkg-3.6.5+1.20.1-fabric" = _WbNpnXcF;
        "pkg-3.6.5+1.20.1-forge" = _KN3TLTr4;
        "pkg-3.6.6+1.21.3-neoforge" = _eOTnMlJ6;
        "pkg-3.6.6+1.21.4-neoforge" = _RvW4E8OR;
        "pkg-3.6.6+1.21.1-neoforge" = _ACDNgCDA;
        "pkg-3.6.6+1.20.6-neoforge" = _oSxS9XbH;
        "pkg-3.6.6+1.21.1-fabric" = _equv2TRU;
        "pkg-3.6.6+1.21.5-fabric" = _5yBEzonb;
        "pkg-3.6.6+1.21.4-fabric" = _XeXZrziK;
        "pkg-3.6.6+1.21.3-fabric" = _mHeau9Ek;
        "pkg-3.6.6+1.20.6-fabric" = _PCMRFynj;
        "pkg-3.6.6+1.20.4-neoforge" = _7xuP5E9e;
        "pkg-3.6.6+1.20.4-fabric" = _xBXboBnE;
        "pkg-3.6.6+1.20.1-fabric" = _dvS5DjUA;
        "pkg-3.6.6+1.20.1-forge" = _sCWgXDYQ;
        "pkg-3.6.6+1.21.5-neoforge" = _uyCELnjo;
        "pkg-3.7.0+1.21.1-neoforge" = _QmZ6hqcE;
        "pkg-3.7.0+1.21.4-neoforge" = _E6G9sd0D;
        "pkg-3.7.0+1.21.3-neoforge" = _nuMB898F;
        "pkg-3.7.0+1.21.3-fabric" = _vym5PKaA;
        "pkg-3.7.0+1.21.4-fabric" = _fUcJNvbr;
        "pkg-3.7.0+1.21.5-neoforge" = _iWNsC7V0;
        "pkg-3.7.0+1.21.5-fabric" = _6SBW2VwU;
        "pkg-3.7.0+1.21.1-fabric" = _QIFl3sOB;
        "pkg-3.7.0+1.21.6-fabric" = _qcmOhKMi;
        "pkg-3.7.0+1.21.6-neoforge" = _tZWvcIfE;
        "pkg-3.7.1+1.21.6-neoforge" = _DKPJinOD;
        "pkg-3.7.1+1.21.1-neoforge" = _zwRKksBU;
        "pkg-3.7.1+1.21.4-neoforge" = _muf1MYGT;
        "pkg-3.7.1+1.21.3-neoforge" = _aOIhTMAz;
        "pkg-3.7.1+1.21.5-neoforge" = _omcPuPpY;
        "pkg-3.7.1+1.21.4-fabric" = _axFpNOZX;
        "pkg-3.7.1+1.21.3-fabric" = _aJOxMQk8;
        "pkg-3.7.1+1.21.1-fabric" = _kVxtKPT4;
        "pkg-3.7.1+1.21.5-fabric" = _Fp5lATXW;
        "pkg-3.7.1+1.21.6-fabric" = _WxYlHLu6;
        "pkg-3.7.1+1.21.9-fabric" = _DoxOKI76;
        "pkg-3.7.2+1.21.9-fabric" = _wG7rlnNb;
        "pkg-3.8.0+1.21.1-neoforge" = _d5rKuZdL;
        "pkg-3.8.0+1.21.3-neoforge" = _odEZvINT;
        "pkg-3.8.0+1.21.5-neoforge" = _adbkiupi;
        "pkg-3.8.0+1.21.4-neoforge" = _CtFI8N1m;
        "pkg-3.8.0+1.21.5-fabric" = _fBTCjR8O;
        "pkg-3.8.0+1.21.6-fabric" = _XrJR9TSj;
        "pkg-3.8.0+1.21.6-neoforge" = _HBei83tn;
        "pkg-3.8.0+1.21.3-fabric" = _xrdCTVnO;
        "pkg-3.8.0+1.21.4-fabric" = _F67XvT8M;
        "pkg-3.8.0+1.21.1-fabric" = _7lgiCSAC;
        "pkg-3.8.0+1.21.9-fabric" = _UZmV6xf4;
        "pkg-3.8.0+1.21.9-neoforge" = _mTfGoKKV;
        "pkg-3.8.1+1.21.4-fabric" = _3anMb7WX;
        "pkg-3.8.1+1.21.4-neoforge" = _rKcyA4p5;
        "pkg-3.8.1+1.21.3-neoforge" = _Yz6uiukz;
        "pkg-3.8.1+1.21.10-neoforge" = _Sgjikn9U;
        "pkg-3.8.1+1.21.1-neoforge" = _h8Px82QV;
        "pkg-3.8.1+1.21.1-fabric" = _UCDofDYx;
        "pkg-3.8.1+1.21.11-fabric" = _NWFsMIGn;
        "pkg-3.8.1+1.21.6-neoforge" = _s8ypywq7;
        "pkg-3.8.1+1.21.5-neoforge" = _xdXfKtth;
        "pkg-3.8.1+1.21.6-fabric" = _KyQmNIz8;
        "pkg-3.8.1+1.21.10-fabric" = _ORi1nScg;
        "pkg-3.8.1+1.21.3-fabric" = _TG9vHGKh;
        "pkg-3.8.1+1.21.5-fabric" = _ka4m3l77;
        "pkg-3.8.1+1.21.11-neoforge" = _UKmMbOe7;
        "pkg-3.8.2+1.21.1-fabric" = _o3cDn8Vp;
        "pkg-3.8.2+1.21.1-neoforge" = _7TVdVtxF;
        "pkg-3.8.2+1.21.10-fabric" = _skcT0J9K;
        "pkg-3.8.2+1.21.10-neoforge" = _x0OuAu2c;
        "pkg-3.8.2+1.21.11-neoforge" = _HZs9mrWM;
        "pkg-3.8.2+1.21.11-fabric" = _pHWDw3Vc;
        "pkg-3.8.2+1.21.3-neoforge" = _CHwpX6mB;
        "pkg-3.8.2+1.21.3-fabric" = _2lffyjXX;
        "pkg-3.8.2+1.21.4-fabric" = _kcTd0BNZ;
        "pkg-3.8.2+1.21.5-neoforge" = _4DqAZZT7;
        "pkg-3.8.2+1.21.4-neoforge" = _U3RHt3Tk;
        "pkg-3.8.2+1.21.6-neoforge" = _N6p4pajA;
        "pkg-3.8.2+1.21.5-fabric" = _oReM1Qvh;
        "pkg-3.8.2+1.21.6-fabric" = _iPLhsWMM;
        "pkg-3.8.2+26.1.0-fabric" = _xLcBtLUV;
        "pkg-3.9.0+26.1-fabric" = _zcX2KOE4;
        "pkg-3.9.1+26.1-neoforge" = _cxSWMNad;
        "pkg-3.9.1+26.1-fabric" = _D39gcNZP;
        "pkg-3.9.2+26.1-fabric" = _h2FGeDHG;
        "pkg-3.9.2+26.1-neoforge" = _bW8oaRN6;
        "pkg-3.9.3+26.1-fabric" = _hzww5Tor;
        "pkg-3.9.3+26.1-neoforge" = _ZFQrFafF;
        "pkg-3.9.3+26.2-fabric" = _jveY2yY0;
        "pkg-3.9.4+26.2-fabric" = _Sq2GH95j;
        "pkg-3.9.4+26.1-neoforge" = _ClVlCJ5t;
        "pkg-3.9.4+26.1-fabric" = _ylPbYWi9;
        "pkg-3.9.4+26.2-neoforge" = _1umoPxQw;
        "pkg-3.9.5+26.2-fabric" = _LlSShNCR;
        "pkg-3.9.5+26.3-fabric" = _zjZChhNt;
        "pkg-3.9.5+26.2-neoforge" = _I01Wcg6G;
        "pkg-3.9.5+26.1-neoforge" = _8WL6ywQa;
        "pkg-3.9.5+26.1-fabric" = _A6V2zTVY;
        "pkg-3.9.6+26.1-neoforge" = _StuyKSnK;
        "pkg-3.9.6+26.3-fabric" = _rSnhz5tr;
