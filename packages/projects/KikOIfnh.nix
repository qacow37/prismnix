...
let
    ...
    in {
        ...
        "pkg-1.21.11-0.0.1+build.7" = _IMK4nzj2;
        "pkg-1.21.11-0.0.1+build.8" = _5m3C2xm8;
        "pkg-26.1.2-0.0.1+build.10" = _1wc9ZMpH;
        "pkg-26.1.2-0.0.1+build.11" = _8tGoImNQ;
        "pkg-1.21.11-0.0.1+build.12" = _kmejrVm5;
        "pkg-1.21.10-0.0.1+build.13" = _LMzZH79I;
        "pkg-1.21.1-0.0.1+build.14" = _WLBlSaxt;
        "pkg-1.21.1-0.0.1+build.15" = _r0zILciY;
        "pkg-1.21.1-0.0.1+build.16" = _46CKVZD8;
        "pkg-1.21.1-0.0.1+build.17" = _f3ih0y9s;
        "pkg-1.21.1-0.0.1+build.18" = _xpTR4xaQ;
        "pkg-26.1.2-0.0.1+build.19" = _Lmnulfjg;
        "pkg-26.1.2-0.0.1+build.20" = _gEQUAGId;
        "pkg-26.1.2-0.0.1+build.21" = _rBlPar7W;
        "pkg-26.1.2-0.0.1+build.22" = _EkMnvlCg;
        "pkg-26.1.2-0.0.1+build.23" = _3h17ZjhB;
        "pkg-26.1.2-0.0.1+build.24" = _G1aW56Ji;
        "pkg-26.1.2-0.0.1+build.25" = _Ll00QYuh;
        "pkg-26.1.2-0.0.1+build.26" = _l275cyVr;
        "pkg-26.1.2-0.0.1+build.27" = _twME0HQn;
        "pkg-26.1.2-0.0.1+build.28" = _pAIAl95x;
        "pkg-26.1.2-0.0.1+build.29" = _EeFj6OdW;
        "default" = _EeFj6OdW;
    });
