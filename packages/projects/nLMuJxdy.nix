...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.8-fabric" = _sknRXzzq;
        "pkg-1.18.2-1.8-fabric" = _gNzSAUtK;
        "pkg-1.19.2-1.9-fabric" = _xrwVeXL9;
        "pkg-1.16.5-1.4-forge" = _pCIzZqOI;
        "pkg-1.18.2-1.5-forge" = _qnMINOYW;
        "pkg-1.19.2-1.7-forge" = _tiRE8sum;
        "pkg-1.16.5-2.0-fabric" = _r4d9frKW;
        "pkg-1.18.2-2.0-fabric" = _5KBEQZMA;
        "pkg-1.19.2-2.0-fabric" = _UscDYMLS;
        "pkg-1.19.3-2.1-fabric" = _3YvDKFNw;
        "pkg-1.19.3-1.7-forge" = _Me7yiWae;
        "pkg-1.18.2-3.0-forge+fabric" = _1FFUtpAM;
        "pkg-1.19.2-3.0-forge+fabric" = _lLblISve;
        "pkg-1.19.3-3.0-forge+fabric" = _EwRK6lOV;
        "pkg-1.19.4-3.0-forge+fabric" = _803RyNgP;
        "pkg-1.20-3.0-forge+fabric" = _55SDomZT;
        "pkg-1.20.1-3.0-forge+fabric" = _Y8rIUYkv;
        "pkg-1.20.2-3.0-forge+fabric" = _lasCJltc;
        "pkg-1.18.2-3.1-forge+fabric" = _Rmhj83V2;
        "pkg-1.19.2-3.1-forge+fabric" = _7Wgcyh6T;
        "pkg-1.20.1-3.1-forge+fabric" = _90e5SYcN;
        "pkg-1.20.2-3.1-forge+fabric" = _X8D0aZE5;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _GzXfBfL4;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _PeoN1sSB;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _vSN4kffL;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _OzG4fMNr;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _jSnYBE2J;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _Mb2B2aMz;
        "pkg-1.20.5-3.2-fabric+neo" = _kNh7X8gF;
        "pkg-1.20.5-3.3-fabric+neo" = _1UhbIexb;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _ofSSL7en;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _gLB9VHE6;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _xZ5dULK2;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _tDPJBYl8;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _NcSaBxgb;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _NcnoECSI;
        "pkg-1.21.2-3.4-fabric+neo" = _Cgs9ghoL;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _lGVhQUCi;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _1WexFsh7;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _iHpt75vb;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _IJUhIuHV;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _9YwtNGyT;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _AAQvNTDV;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _w6jTiYdr;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _ywpOwGkg;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _xxosa8zc;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _QxH3SGlU;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _T6IBS5Yn;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _QOE2swWu;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _gNY0bjSu;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _U8oELlQy;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _tjrnGjzH;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _OgZ6WfXX;
        "default" = _OgZ6WfXX;
    });
