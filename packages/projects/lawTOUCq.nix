...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.2" = _un9w3yKm;
        "pkg-1.0.0+1.20.6" = _yQJGRtbG;
        "pkg-1.0.0+1.21.3" = _9WRxKFP2;
        "pkg-1.0.1+1.21.2" = _2yatpyOY;
        "pkg-1.0.1+1.20.6" = _QMnL3Lu5;
        "pkg-1.0.1+1.21.3" = _Be4LThFn;
        "pkg-1.0.2+1.21.2" = _7pqBePTz;
        "pkg-1.0.2+1.21.5" = _llLA7TNo;
        "pkg-1.0.2+1.21.3" = _dJhErjlf;
        "pkg-1.0.2+1.20.6" = _o99Lj70M;
        "pkg-1.0.3+1.21.5" = _Uj8PfO2z;
        "pkg-1.0.3+1.20" = _RtbpfTPo;
        "pkg-1.0.3+1.20.6" = _uCHf1cbi;
        "pkg-1.0.3+1.21.3" = _2ApezXyp;
        "pkg-1.0.3+1.21.2" = _rIbonGHa;
        "pkg-1.2.0+1.20" = _A5itJ60n;
        "pkg-1.2.0+1.21.2" = _sRj5avGP;
        "pkg-1.2.0+1.20.6" = _B5J6qGFg;
        "pkg-1.2.0+1.21.5" = _1lZultVf;
        "pkg-1.2.0+1.21.6" = _cxtB5ofO;
        "pkg-1.2.0+1.21.3" = _vuNsti6a;
        "pkg-1.2.1+1.20.6" = _tYICPOlx;
        "pkg-1.2.1+1.21.2" = _5U4ukm22;
        "pkg-1.2.1+1.21.6" = _y3mflz4r;
        "pkg-1.2.1+1.20.2" = _P0t96Lcf;
        "pkg-1.2.1+1.21.5" = _Sm5TfJ5p;
        "pkg-1.2.1+1.21.3" = _z4nNLiGD;
        "pkg-1.2.1+1.20" = _vjoiw2Ts;
        "pkg-1.2.2+1.21.5" = _9BpAAIKO;
        "pkg-1.2.2+1.20.6" = _rtx0l62F;
        "pkg-1.2.2+1.21.6" = _6oOTLT5D;
        "pkg-1.2.2+1.21.3" = _CUb5aVVg;
        "pkg-1.2.2+1.21.2" = _vJz1TNS0;
        "pkg-1.2.2+1.20.2" = _frGRdShl;
        "pkg-1.2.2+1.20" = _7PsNTtet;
        "pkg-1.3.0+1.20.6" = _g9U6Y6k0;
        "pkg-1.3.0+1.20" = _hVZRsOxA;
        "pkg-1.3.0+1.20.2" = _hrFFV2vO;
        "pkg-1.3.0+1.21.3" = _yQ1oAmi8;
        "pkg-1.3.0+1.21.5" = _NXGWdc5u;
        "pkg-1.3.0+1.21.6" = _6YoA7dpc;
        "pkg-1.3.1+1.20" = _rmbwv6Fq;
        "pkg-1.3.1+1.20.2" = _6aN4aYB6;
        "pkg-1.3.1+1.20.6" = _Lsu8WKra;
        "pkg-1.3.1+1.21.3" = _QanZKhwD;
        "pkg-1.3.1+1.21.6" = _FjHmpP2u;
        "pkg-1.3.1+1.21.5" = _qwuZhksI;
        "pkg-1.3.2+1.20" = _xcODJsI6;
        "pkg-1.3.2+1.20.2" = _FWAvKcCw;
        "pkg-1.3.2+1.20.6" = _Av1PpvmW;
        "pkg-1.3.2+1.21.3" = _NbSoQn89;
        "pkg-1.3.2+1.21.5" = _3wHXOXlt;
        "pkg-1.3.2+1.21.6" = _N2kgkYm7;
        "pkg-1.3.3+1.20" = _AxKUGr8B;
        "pkg-1.3.3+1.20.2" = _7MC2gf0s;
        "pkg-1.3.3+1.20.6" = _E30ohQRl;
        "pkg-1.3.3+1.21.3" = _pKzl856y;
        "pkg-1.3.3+1.21.5" = _P97Zih4N;
        "pkg-1.3.3+1.21.6" = _voOfjzE2;
        "default" = _voOfjzE2;
    });
