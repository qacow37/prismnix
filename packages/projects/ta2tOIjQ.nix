...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19.x" = _BekkPAED;
        "pkg-1.0.0+1.19" = _Xa2tdnEU;
        "pkg-1.0.1+1.16-1.16.1" = _UDBeQRCo;
        "pkg-1.0.1+1.16.2-1.16.5" = _UScOQf7W;
        "pkg-1.0.1+1.17.x" = _2S85U0gK;
        "pkg-1.0.1+1.18.x" = _KX85DAPw;
        "pkg-1.0.1+1.19" = _wlNOfUlT;
        "pkg-1.0.1+1.19.x" = _1TzGdZ2F;
        "pkg-1.0.2+1.20" = _STKaifG5;
        "pkg-1.0.3+1.20.5-1.20.6" = _ZjPCooyO;
        "pkg-1.0.3+1.21-1.21.10" = _hpTAvWNV;
        "pkg-1.0.4+1.21.11" = _o0KzRfhX;
        "pkg-1.0.5+26.1.x" = _nq2crotx;
        "pkg-1.1.0+26.1.x" = _Cnc3zqea;
        "pkg-1.2.0+1.16.5-Fabric" = _1cK3bfhV;
        "pkg-1.2.0+1.16.5-Forge" = _v3GFZrj6;
        "pkg-1.2.0+1.17.1+Fabric" = _IaPbCR7H;
        "pkg-1.2.0+1.17.1-Forge" = _G60NInCu;
        "pkg-1.2.1+1.16.5-Fabric" = _1zMImEIz;
        "pkg-1.2.1+1.17.1-Fabric" = _KlrpnV00;
        "pkg-1.2.1+1.18-Fabric" = _tL5oOKh7;
        "pkg-1.2.1+1.18-Forge" = _BlLkqea8;
        "pkg-1.2.1+1.18.1-Fabric" = _V11bGUnf;
        "pkg-1.2.1+1.18.1-Forge" = _oqQKLDNG;
        "pkg-1.2.1+1.18.2-Fabric" = _jegKbcZe;
        "pkg-1.2.1+1.18.2-Forge" = _ZGueMfxJ;
        "pkg-1.2.1+1.19-Fabric" = _MuKCamJX;
        "pkg-1.2.1+1.19-Forge" = _ux5qaKOM;
        "pkg-1.2.1+1.19.1-Fabric" = _7CmcOvf0;
        "pkg-1.2.1+1.19.1-Forge" = _AFVXTsqv;
        "pkg-1.2.1+1.19.2-Fabric" = _ssRrYWYV;
        "pkg-1.2.1+1.19.2-Forge" = _phRDHOTE;
        "pkg-1.2.1+1.19.3-Fabric" = _glyYgjoy;
        "pkg-1.2.1+1.19.3-Forge" = _Ch8N8tYL;
        "pkg-1.2.1+1.19.4-Fabric" = _eMwDqlqj;
        "pkg-1.2.1+1.19.4-Forge" = _hp2OOklc;
        "pkg-1.2.1+1.20-Fabric" = _9WAxZvj2;
        "pkg-1.2.1+1.20-Forge" = _tlDIMPQk;
        "pkg-1.2.1+1.20.1-Fabric" = _c05iRTGS;
        "pkg-1.2.1+1.20.1-Forge" = _bu8gXAQd;
        "pkg-1.2.1+1.20.2-Fabric" = _CZ8J1AXl;
        "pkg-1.2.1+1.20.2-Forge" = _LlQ5SxfK;
        "pkg-1.2.1+1.20.2-NeoForge" = _djeEIDGK;
        "pkg-1.2.1+1.20.4-Fabric" = _1lqyPp6C;
        "pkg-1.2.1+1.20.4-Forge" = _amEyswx9;
        "pkg-1.2.1+1.20.4-NeoForge" = _k5NxeNI3;
        "pkg-1.2.1+1.20.5-Fabric" = _MKc2Bksu;
        "pkg-1.2.1+1.20.5-NeoForge" = _ilz2hlVR;
        "pkg-1.2.1+1.20.6-Fabric" = _iw1eCQkq;
        "pkg-1.2.1+1.20.6-Forge" = _sKVfl3MG;
        "pkg-1.2.1+1.20.6-NeoForge" = _B8ZdpsUT;
        "pkg-1.2.1+1.21-Fabric" = _W3e9tr4d;
        "pkg-1.2.1+1.21-Forge" = _rQWf3SrD;
        "pkg-1.2.1+1.21-NeoForge" = _Q80qWSvs;
        "pkg-1.2.1+1.21.1-Fabric" = _8AEHpuTy;
        "pkg-1.2.1+1.21.1-Forge" = _xO0YBLVV;
        "pkg-1.2.1+1.21.1-NeoForge" = _khZgNJa3;
        "pkg-1.2.1+1.21.2-Fabric" = _U3XtOP8d;
        "pkg-1.2.1+1.21.2-NeoForge" = _kUwMPEsc;
        "pkg-1.2.1+1.21.3-Fabric" = _O5DepXCi;
        "pkg-1.2.1+1.21.3-Forge" = _um8ohRne;
        "pkg-1.2.1+1.21.3-NeoForge" = _P5AmohR4;
        "pkg-1.2.1+1.21.4-Fabric" = _RAuMvNVr;
        "pkg-1.2.1+1.21.4-Forge" = _lGGu0CUM;
        "pkg-1.2.1+1.21.4-NeoForge" = _Va8kIBiS;
        "pkg-1.2.1+1.21.5-Fabric" = _qJAzgqJi;
        "pkg-1.2.1+1.21.5-NeoForge" = _aUoJ1mvV;
        "pkg-1.2.1+1.21.6-Fabric" = _5Js2rMOc;
        "pkg-1.2.1+1.21.6-NeoForge" = _VlCLHZkN;
        "pkg-1.2.1+1.21.7-Fabric" = _KWsxSWuo;
        "pkg-1.2.1+1.21.7-NeoForge" = _UrkVMOgk;
        "pkg-1.2.1+1.21.8-Fabric" = _OokoXjau;
        "pkg-1.2.1+1.21.8-NeoForge" = _X5lzOXEJ;
        "pkg-1.2.1+1.21.9-Fabric" = _XMgEMAps;
        "pkg-1.2.1+1.21.9-NeoForge" = _xG5XUXPd;
        "pkg-1.2.1+1.21.10-Fabric" = _sGIqTGPn;
        "pkg-1.2.1+1.21.10-NeoForge" = _4AIHf2J1;
        "pkg-1.2.1+1.21.11-Fabric" = _5KN9eY7D;
        "pkg-1.2.1+1.21.11-NeoForge" = _O9mz5ZHM;
        "pkg-1.2.1+26.1-Fabric" = _v5baTKWv;
        "pkg-1.2.1+26.1-NeoForge" = _IFKBLDWz;
        "pkg-1.2.1+26.1.1-Fabric" = _aUAy1I1J;
        "pkg-1.2.1+26.1.1-NeoForge" = _ZAbBLcdO;
        "pkg-1.2.1+26.1.2-Fabric" = _ve4oWFqi;
        "pkg-1.2.1+26.1.2-NeoForge" = _6rPBcXLY;
        "pkg-1.2.1+26.2-Fabric" = _rbEyg7qS;
        "pkg-1.2.1+26.2-NeoForge" = _uNlCdzUS;
        "default" = _uNlCdzUS;
    });
