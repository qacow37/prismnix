...
let
    ...
    in {
        ...
        "pkg-1.19-1.19.2" = _V3vVz0hC;
        "pkg-1.19.3" = _uXKwL5wA;
        "pkg-1.19.4" = _4vXwu0zO;
        "pkg-1.20-1.20.1" = _DoIzBi7D;
        "pkg-1.20.2" = _JNqQnTHW;
        "pkg-1.16" = _z3VmtX4f;
        "pkg-1.17" = _1UkBs4EC;
        "pkg-1.18" = _ZIRo3VCR;
        "pkg-1.19" = _NNUjgu7F;
        "pkg-1.20" = _u4IyiN6U;
        "pkg-1.20.3-1.20.4" = _jVEb7NJ0;
        "pkg-1.20.5-1.20.6" = _JGcCMjXA;
        "pkg-1.21-1.21.1" = _RTclMfVE;
        "pkg-4.0" = _uZDntThQ;
        "pkg-1.21.4" = _dQFpbNPt;
        "pkg-4.1" = _FSNWn6u0;
