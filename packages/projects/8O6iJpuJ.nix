...
let
    ...
    in {
        ...
        "pkg-0.2.0+1.20" = _FSIhPBhL;
        "pkg-0.2.0+1.21" = _iWlsfSP6;
        "pkg-0.3.0+1.20" = _tgMWAEKn;
        "pkg-0.3.0+1.21" = _zJrYLiu8;
        "pkg-0.3.1+1.20" = _wAcw2Fno;
        "pkg-0.3.1+1.21" = _qCFrLhgX;
        "pkg-0.4.0+1.20" = _k7z6gArb;
        "pkg-0.4.0+1.21" = _wNzE9XGH;
        "pkg-0.4.1+1.20" = _l1ajlqxJ;
        "pkg-0.4.2+1.20" = _LdoRyIao;
        "pkg-0.4.2+1.21" = _MRuDTAyV;
        "pkg-0.5.0+1.20" = _qLT6DsLd;
        "pkg-0.5.0+1.21" = _mu3MvvdY;
        "pkg-0.5.1+1.20" = _4o8MFbJy;
        "pkg-0.5.1+1.21" = _EeHdyJiT;
        "pkg-0.5.2+1.20" = _VtmBOdVM;
        "pkg-0.5.2+1.21" = _Eufq7TiR;
        "pkg-0.5.3+1.20" = _uC39VVNU;
        "pkg-0.5.3+1.21" = _5CjsJ2W0;
        "pkg-0.5.4+1.20" = _INRqWy8A;
        "pkg-0.5.4+1.21" = _iiCBbOGq;
        "pkg-0.5.5+1.21" = _tRZc7NuZ;
        "pkg-0.5.6+1.20" = _T7kIABxc;
        "pkg-0.5.6+1.21" = _IFau8jIo;
        "pkg-0.6.0+1.20" = _hgDoZG4f;
        "pkg-0.6.0+1.21" = _Yv1vPXGL;
        "pkg-0.6.1+1.20" = _7NENjuSQ;
        "pkg-0.6.1+1.21" = _eQg3QhD8;
        "pkg-0.7.0+1.20" = _OoBpn34N;
        "pkg-0.7.0+1.21" = _7SL16FQr;
        "pkg-1.0.0+1.20" = _22tCXr0T;
        "pkg-1.0.0+1.21" = _Cn8gGZIf;
        "pkg-1.0.0+1.22" = _OZ0xIQHp;
        "pkg-1.1.0+1.20" = _zQGCkx5S;
        "pkg-1.1.0+1.21" = _60WlAnXM;
        "pkg-1.1.0+1.22" = _LgamsjWE;
        "pkg-1.1.1+1.21" = _Ri6oYIDp;
        "pkg-1.1.2+1.20" = _R0Htff3Q;
        "pkg-1.1.2+1.21" = _kgJW8eBR;
        "pkg-1.1.2+1.22" = _RHscu4xw;
        "pkg-1.2.0+1.20" = _eF1FI7XG;
        "pkg-1.2.0+1.21" = _GYygtjnU;
        "pkg-1.2.0+1.22" = _VijG9HHt;
        "pkg-1.2.1+1.20" = _1u0Xl0C5;
        "pkg-1.2.1+1.21" = _vXFAABN1;
        "pkg-1.2.1+1.22" = _DM5GH3cY;
        "pkg-1.3.0+1.20" = _GuyDuEgp;
        "pkg-1.3.0+1.21" = _YQxLELnA;
        "pkg-1.3.0+1.22" = _efnA7Mom;
        "pkg-1.3.0+26.1" = _56RNymNK;
        "default" = _56RNymNK;
    });
