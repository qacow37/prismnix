...
let
    ...
    in {
        ...
        "pkg-v1.0.0-beta" = _nFvoDWks;
        "pkg-v1.0.1-beta" = _kYOyggGF;
        "pkg-v1.0.3" = _nRn11EgN;
        "pkg-v1.0.3-patch1" = _l9tozF3E;
        "pkg-v1.14" = _CiCzm3Zy;
        "pkg-v1.15" = _WkK504Ui;
        "pkg-v1.17" = _WjoYffhQ;
        "pkg-v2.0.0" = _6zLCTZti;
        "pkg-v2.0.1" = _ySLjTJdX;
        "pkg-v2.0.2" = _4UHbbW66;
        "pkg-v2.0.3" = _fhWna27k;
        "pkg-v2.0.4" = _jcEz0yfO;
        "pkg-v2.0.5" = _Cmkdf5LY;
        "pkg-v2.0.6" = _Nt2iIEm6;
        "pkg-v2.0.7" = _5O8blg2J;
        "pkg-v2.1.0" = _i0O3ItF7;
        "pkg-v2.1.1" = _3jzoufzx;
        "pkg-v2.1.2" = _BUS9lRx3;
        "pkg-v2.1.4" = _2OSXWzun;
        "pkg-v2.2.0" = _moUR4t0A;
        "pkg-v2.2.2" = _4OZyUQmZ;
        "pkg-v2.3.0" = _YzgsIUMj;
        "pkg-1.19.4-v2.4.0" = _YWoXTDjG;
        "pkg-1.19.3-v2.4.0" = _vxXJeIr2;
        "pkg-1.19-v2.4.0" = _HH47QY0K;
        "pkg-1.18-v2.4.0" = _e2e6crk7;
        "pkg-1.19.4-v2.4.1" = _kovJXmqQ;
        "pkg-1.19.3-v2.4.1" = _hsh19RFO;
        "pkg-1.19-v2.4.1" = _a48HbbXJ;
        "pkg-1.18-v2.4.1" = _WycUb6D0;
        "pkg-1.19.4-v2.4.2" = _GsoxTpK0;
        "pkg-1.19.3-v2.4.2" = _kZodCgNc;
        "pkg-1.19-v2.4.2" = _ZI6YfJRC;
        "pkg-1.18-v2.4.2" = _yR6U8C4a;
        "pkg-1.20-v2.4.2" = _H9lgZyEu;
        "pkg-1.20-v2.4.4" = _nQ9DLwfi;
        "pkg-1.19-v2.4.4" = _MyUzk0xi;
        "pkg-1.19.4-v2.4.4" = _zEJFHkNT;
        "pkg-1.19.3-v2.4.4" = _LIWXkoHU;
        "pkg-1.18-v2.4.4" = _jRqgxuyx;
        "pkg-1.20-v2.5.0" = _ZCYkhnra;
        "pkg-1.19.4-v2.5.0" = _XymwAuWP;
        "pkg-1.19.3-v2.5.0" = _oXLYdzIV;
        "pkg-1.19-v2.5.0" = _5XTP6B5v;
        "pkg-1.18-v2.5.0" = _32XF15jF;
        "pkg-1.20-v2.5.0.1" = _VyaYyLCx;
        "pkg-1.19.4-v2.5.0.1" = _w0ImUjuq;
        "pkg-1.19.3-v2.5.0.1" = _Cc8Xi9VB;
        "pkg-1.19-v2.5.0.1" = _ltEX7qU4;
        "pkg-1.18-v2.5.0.1" = _2ywLB3Ya;
        "pkg-1.20-v2.5.1" = _p8hLkDZr;
        "pkg-1.19.4-v2.5.1" = _r29pm8uC;
        "pkg-1.19.3-v2.5.1" = _Mc6whO9W;
        "pkg-1.19-v2.5.1" = _WthyVEsx;
        "pkg-1.18-v2.5.1" = _CP03OrKI;
        "pkg-1.18-v2.5.1.1" = _p6pHcotY;
        "pkg-1.19-v2.5.1.1" = _NnMaCVE2;
        "pkg-1.19.3-v2.5.1.1" = _wcqyD3tk;
        "pkg-1.19.4-v2.5.1.1" = _R0v6teLP;
        "pkg-1.20-v2.5.1.1" = _myqNuwlk;
        "pkg-1.20-v2.5.1.2" = _qtxhU6hP;
        "pkg-1.19.4-v2.5.1.2" = _KnI4g024;
        "pkg-1.19.3-v2.5.1.2" = _SkuqR78d;
        "pkg-1.19-v2.5.1.2" = _nO6l8Iap;
        "pkg-1.18-v2.5.1.2" = _qdNmxjiH;
        "pkg-1.18-v2.5.1.3" = _5mruAxIr;
        "pkg-1.19-v2.5.1.3" = _BNEX5xJn;
        "pkg-1.19.3-v2.5.1.3" = _to2avxeH;
        "pkg-1.19.4-v2.5.1.3" = _5E2uuHft;
        "pkg-1.20-v2.5.1.3" = _k5LSFh0W;
        "pkg-1.18-v2.5.2" = _1wa0ThaY;
        "pkg-1.19-v2.5.2" = _zpea8FXF;
        "pkg-1.19.3-v2.5.2" = _5ujcXZ0h;
        "pkg-1.19.4-v2.5.2" = _naqSCs7x;
        "pkg-1.20-v2.5.2" = _v5qLnGCb;
        "pkg-1.18-v2.5.2.1" = _HackGsYm;
        "pkg-1.19-v2.5.2.1" = _aSNZ6Ral;
        "pkg-1.19.3-v2.5.2.1" = _baXi9KHm;
        "pkg-1.19.4-v2.5.2.1" = _sEqrKZHH;
        "pkg-1.20-v2.5.2.1" = _3B8xZa6e;
        "pkg-1.18-v2.5.2.2" = _PiaYfrjx;
        "pkg-1.19-v2.5.2.2" = _uhHrm10t;
        "pkg-1.19.3-v2.5.2.2" = _xGVomXf3;
        "pkg-1.19.4-v2.5.2.2" = _jvPgeJkr;
        "pkg-1.20-v2.5.2.2" = _HodWm6t8;
        "pkg-1.19-v2.5.3" = _e32V17pl;
        "pkg-1.19.3-v2.5.3" = _l3fCngw9;
        "pkg-1.19.4-v2.5.3" = _q6VoM6zS;
        "pkg-1.20-v2.5.3" = _KGOaa4uO;
        "pkg-1.18-v2.5.3" = _7yhIAm3o;
        "pkg-1.18-v2.5.4" = _CQMtNTs7;
        "pkg-1.19-v2.5.4" = _QrV4zJ5k;
        "pkg-1.19.3-v2.5.4" = _DGkh3gn0;
        "pkg-1.19.4-v2.5.4" = _cQj5bNn2;
        "pkg-1.20-v2.5.4" = _IlOaSy35;
        "pkg-2.6.0-mc1.20" = _S46aTNR5;
        "pkg-2.6.1-mc1.20" = _cPk3IQCr;
        "pkg-2.6.2-mc1.20" = _CxS1Ja2k;
        "pkg-2.6.3-mc1.20" = _vkSNVfhO;
        "pkg-2.6.4-mc1.20" = _kVWUgkbC;
        "pkg-2.6.4-mc1.21" = _L6lbsWDi;
        "default" = _L6lbsWDi;
    });
