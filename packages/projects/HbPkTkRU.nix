...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _oaz8eF4f;
        "pkg-1.0.9" = _dn763HgE;
        "pkg-1.0.10" = _9xQvLyQr;
        "pkg-1.0.11" = _wt2glLHw;
        "pkg-1.0.13" = _qstAsIYA;
        "pkg-1.0.14" = _BsLvjFkO;
        "pkg-1.0.15" = _XEB3peiX;
        "pkg-1.0.16" = _1P6dYMiZ;
        "pkg-1.0.17" = _Ay5goMTy;
        "pkg-1.0.18" = _Kv8nxAqx;
        "pkg-1.0.19" = _Ljn8TQU1;
        "pkg-1.0.21" = _P3l0bnSL;
        "pkg-1.0.22" = _WWWRqvRL;
        "pkg-1.0.23" = _S3pUEGGO;
        "pkg-1.0.26" = _jbYoJZgP;
        "pkg-1.1.0" = _sBrHshEh;
        "pkg-1.1.1" = _QccD1AF5;
        "pkg-1.1.2" = _Wn9odPAj;
        "pkg-1.1.3" = _bnuCQ0rI;
        ...
        "pkg-1.1.8" = _2m9vzWjM;
        "pkg-1.1.9" = _6Jx3q0ti;
        "pkg-1.1.10" = _CkCwxi8b;
        "pkg-1.1.11" = _FKysti7J;
        "pkg-1.1.13" = _R7mpRSYf;
        "pkg-1.1.14" = _3iKaZQIb;
        "default" = _3iKaZQIb;
    });
