...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.21" = _dqRkbGHB;
        "pkg-1.2.0+1.21.5" = _ibSODuZ1;
        "pkg-fabric-1.2.0+26.1-rc-3" = _74Pluc0e;
        "pkg-neoforge-1.2.0+26.1-rc-3" = _Iz1jZJoI;
        "pkg-forge-2.0.0+1.21.11" = _XT70Ohaq;
        "pkg-fabric-2.0.0+26.1.2" = _swKJ2UvC;
        "pkg-fabric-2.0.0+1.16.5" = _5Jl7q6Tb;
        "pkg-fabric-2.0.0+1.14.4" = _yvmymG6L;
        "pkg-fabric-2.0.0+1.15.2" = _PieoBw6i;
        "pkg-fabric-2.0.0+1.17.1" = _mZwSQJnp;
        "pkg-fabric-2.0.0+1.18.2" = _b4fDFUZP;
        "pkg-fabric-2.0.0+1.20.4" = _i4jbJP6H;
        "pkg-fabric-2.0.0+1.21.4" = _8z12PQd0;
        "pkg-fabric-2.0.0+1.21.11" = _p0XtMKe2;
        "pkg-fabric-2.0.0+1.21.9" = _dasEbk5P;
        "pkg-forge-2.0.0+1.21.9" = _Zw9wY8rO;
        "pkg-forge-2.0.0+1.21.4" = _GKtaLPDw;
        "pkg-forge-2.0.0+26.1.2" = _qM89ArQL;
        "pkg-neoforge-2.0.0+1.21.11" = _5EpouiaB;
        "pkg-neoforge-2.0.0+1.21.4" = _8foOfmdZ;
        "pkg-neoforge-2.0.0+1.21.9" = _tI37YfZx;
        "pkg-neoforge-2.0.0+26.1.2" = _OwIBxYpI;
