...
let
    ...
    in {
        ...
        "pkg-1.8.2" = _mYVoixpl;
        "pkg-b1.8.3" = _GHlqxKNT;
        "pkg-b1.8.4" = _8x3nLuOt;
        "pkg-b1.9.0" = _e9irGarG;
        "pkg-b1.9.1" = _NtQeoKMw;
        "pkg-b1.9.2" = _mEIrPltU;
        "pkg-b1.9.3" = _q7sWdntq;
        "pkg-b1.9.4" = _1pdawJSj;
        "pkg-b1.9.5" = _4JfwbTle;
        "pkg-b1.9.6" = _M2CJ9ytD;
        "pkg-b1.10.0" = _jUbcD6vx;
        "pkg-b1.10.1" = _rN5u7Tuk;
        "pkg-b1.11.0" = _9Ryxm5tP;
        "pkg-b1.11.1" = _FNtGnvoH;
        "pkg-b1.11.2" = _uDGf72Wl;
        "pkg-b1.11.2a" = _vZ8p5zlk;
        "pkg-b1.11.3" = _bMQIYcyQ;
        "pkg-b1.11.4" = _8ZhhlPNk;
        "pkg-b1.11.5" = _A0vUhI6W;
        "pkg-b1.12.0" = _ep4QGxS2;
        "pkg-b1.13.0" = _HP1reBZ6;
        "pkg-b1.13.1" = _l7BjXCe2;
        "pkg-b1.13.2" = _oTjm8Vwt;
        "pkg-b1.13.3" = _PYKhAtJc;
        "pkg-v1.0.0" = _cmWgW9lh;
        "pkg-v1.0.1" = _UJMpC5Op;
        "pkg-v1.0.2" = _emZWbmCS;
        "pkg-v1.0.3" = _WgBdnrsK;
        "pkg-v1.0.4" = _fiDWg1wr;
        "pkg-v1.0.5" = _ke567UOO;
        "pkg-v1.0.6" = _dQHfu5QO;
        "pkg-v1.0.7" = _cPEYIz0L;
        "pkg-v1.0.8" = _z0qQeJe0;
        "pkg-v1.0.9" = _IQsWzbsO;
        "pkg-v1.1.0" = _EjGwRncs;
        "pkg-v1.1.1" = _X22wvxOu;
        "pkg-v1.1.2" = _VcxJsEjH;
        "pkg-v1.1.3" = _BEpEUx2q;
        "pkg-v1.2.0" = _roPYxIg4;
        "pkg-v1.2.0b" = _uIjcrFdG;
        "pkg-v1.2.0c" = _TzipFmNW;
        "pkg-v1.2.1" = _zPnemhYG;
        "pkg-v1.2.2" = _MPJRzvG5;
        "pkg-v1.3.0" = _MD8eXTHH;
        "pkg-v1.3.1" = _7gUdgdke;
        "pkg-v1.3.2" = _dagbORN9;
        "pkg-v1.3.3" = _M0NgcO0L;
        "pkg-v1.3.3b" = _uLwCWQYU;
        "pkg-v1.3.4" = _eJ1NTG1A;
        "pkg-v1.3.4b" = _EIkZTonC;
        "pkg-v1.3.5" = _5XZ87HwT;
        "pkg-v1.3.6" = _QQzVzQSI;
        "pkg-v1.3.6b" = _nV1tAcTT;
        "pkg-v1.3.7" = _FJ2HWpul;
        "pkg-v1.3.7b" = _hTsN7d1l;
        "pkg-v1.4.0" = _uKknrxkY;
        "pkg-v1.4.0b" = _qf7yB73o;
        "pkg-v1.4.1" = _wQlQeGRh;
        "pkg-v1.4.2" = _ZNoJ147m;
        "pkg-v1.4.2b" = _mlRHgUyG;
        "pkg-v1.4.3" = _Tn7LLgbU;
        "pkg-v1.4.3b" = _l0pOsrwj;
        "pkg-v1.4.3c" = _gAzVMQPa;
        "pkg-v1.4.4" = _WSYjUhNi;
        "default" = _WSYjUhNi;
    });
