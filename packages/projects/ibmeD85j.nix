...
let
    ...
    in {
        ...
        "pkg-2.0.0" = _ZAW5tI1e;
        "pkg-3.0.1" = _rFoPFryh;
        "pkg-4.0.3+1.19.2" = _hmmwPVaL;
        "pkg-4.0.4+1.19.2" = _bfd5chO8;
        "pkg-4.0.6+1.19.2" = _OR7POGi0;
        "pkg-4.0.9+1.19.2" = _FUlB6LP4;
        "pkg-4.1.1+1.19.2" = _e2WaoIkD;
        "pkg-4.1.2+1.19.2" = _QkhdeB40;
        "pkg-4.1.3+1.19.2" = _5B2vywze;
        "pkg-4.1.3+1.20.1" = _ztgFUVOH;
        "pkg-4.1.4+1.20.1" = _d7FLstam;
        "pkg-4.1.5+1.20.1" = _ieA80dX5;
        "pkg-4.1.6+1.20.1" = _azlwLDfi;
        "pkg-4.1.7+1.20.1" = _r3Clz712;
        "pkg-4.1.10+1.20.1" = _zB9qo81b;
        "pkg-4.1.11+1.20.1" = _pZT4qjha;
        "pkg-4.1.12+1.20.1" = _2eVXlNUp;
        "pkg-4.1.13+1.20.1" = _ICGcnY3p;
        "pkg-5.0.0+1.20.3" = _YSe8aX4u;
        "pkg-5.0.0+1.20.1" = _uwQwUNgX;
        "pkg-5.0.1+1.20.1" = _osUG0Ooa;
        "pkg-5.0.2+1.20.1" = _h8PUJ80u;
        "pkg-5.0.3+1.20.1" = _ryRjIGbA;
        "pkg-5.0.4+1.20.1" = _aakMPgeR;
        "pkg-5.1.0+1.20.1" = _C3Mh4INT;
        "pkg-5.2.0+1.20.1" = _ttzb9VTn;
        "pkg-5.2.1+1.20.1" = _wUFowCJS;
        "pkg-5.2.1+1.20.2" = _Q0nxcdfq;
        "pkg-5.2.1+1.20.3" = _7vVkAwXz;
        "pkg-5.2.1+1.20.4" = _ZW2IS0wk;
        "pkg-5.2.1+1.20.5" = _6ZI0hQCN;
        "pkg-5.2.1+1.20.6" = _jB7XRr6G;
        "pkg-5.2.2+1.20.6" = _37cX3QWK;
        "pkg-5.2.2+1.21" = _8GLJRfc7;
        "pkg-5.2.3+1.21" = _ftD0yYYt;
        "pkg-5.2.3+1.21.1" = _AWTuJumv;
        "default" = _AWTuJumv;
    });
