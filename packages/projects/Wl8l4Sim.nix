...
let
    ...
    in {
        ...
        "pkg-9.0.1" = _BokieVNB;
        "pkg-9.1.2" = _s0VCglFX;
        "pkg-10.0.1" = _O0ofSIrE;
        "pkg-9.1.3" = _IfmFbXO5;
        "pkg-10.0.2" = _FEHHySmV;
        "pkg-6.0.3" = _xBYKGcck;
        "pkg-11.0.1" = _6KY2iUrv;
        "pkg-12.0.1" = _mPxA5ya4;
        "pkg-5.0.5" = _7BV0vjEU;
        "pkg-13.0.1" = _3ynRAC6b;
        "pkg-13.0.2" = _kF7hMms8;
        "pkg-14.0.1" = _bXiFqr6w;
        "pkg-14.0.2" = _pGwggo83;
        "pkg-15.0.1" = _9uU34M9X;
        "pkg-16.0.1" = _vvV0krAR;
        "pkg-13.0.3" = _wPwSjIQd;
        "pkg-16.0.2" = _TEH61MXV;
        "pkg-13.0.4" = _4GVb08yt;
        "default" = _4GVb08yt;
    });
