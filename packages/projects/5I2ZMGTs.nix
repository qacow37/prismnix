...
let
    ...
    in {
        ...
        "pkg-1.0+RP" = _pO1LDS57;
        "pkg-1.0.1+mod+RP" = _GlCFba3z;
        "pkg-1.1+RP" = _NTqvHeNH;
        "pkg-1.1.1+mod+RP" = _c8oBx5gj;
        "pkg-2.0" = _FcPhFamc;
        "pkg-2.0.1+mod" = _6qw2NsC4;
        "pkg-2.1" = _YTVKl2Qz;
        "pkg-2.1.1+mod" = _SRxAOUkw;
        "pkg-2.2" = _NSRlKw6b;
        "pkg-2.2.1+mod" = _XMWA3acj;
        "pkg-2.3" = _Ul9nDQ1H;
        "pkg-2.3.1+mod" = _JvyP0BeY;
        "pkg-2.4" = _mjoAmr8h;
        "pkg-2.4.1+mod" = _ja0zPIVH;
        "pkg-2.5" = _aDXA6JaY;
        "pkg-2.5.1+mod" = _sjsI5hYm;
        "pkg-2.5.2" = _9nfrC8QD;
        "pkg-2.5.3+mod" = _WXwuTPUz;
        "pkg-2.6" = _OD6E4eBV;
        "pkg-2.6.1+mod" = _QAkPy2g3;
        "pkg-3.0" = _MXQNbNut;
        "pkg-3.0.1+mod" = _8BVvmSIy;
        "pkg-2.7" = _aEYQzJ6R;
        "pkg-2.7.1+mod" = _BLGWJoG5;
        "pkg-2.8" = _P3tjvZ9d;
        "pkg-2.8.1+mod" = _aV1LqQBZ;
        "pkg-2.13" = _WqUNCn5d;
        "pkg-2.13.1+mod" = _MLIfRp8z;
        "pkg-3.1" = _fLbunzZn;
        "pkg-3.1.1+mod" = _buNoGf1w;
        "pkg-3.2" = _st99mqjz;
        "pkg-3.2.1+mod" = _VXs71mCa;
        "pkg-3.3" = _1sOh3Zem;
        "pkg-3.3.1+mod" = _jeKThdjf;
        "pkg-3.4" = _7PEWnaFl;
        "pkg-3.4.1+mod" = _jsuHEFj4;
        "pkg-3.5" = _2UxQLcpT;
        "pkg-3.5.1+mod" = _BSWy1arw;
        "pkg-3.6" = _8vjyzXUR;
        "pkg-3.6.1+mod" = _yW70rdK7;
        "pkg-3.7" = _2fXTlI6q;
        "pkg-3.7.1+mod" = _qiF3K5FA;
        "pkg-3.8" = _5YDQLqg3;
        "pkg-3.8.1+mod" = _PmV9V6BK;
        "pkg-3.9" = _gtcObBCG;
        "pkg-3.9.1+mod" = _ykUzGtGd;
        "default" = _ykUzGtGd;
    });
