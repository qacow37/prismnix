...
let
    ...
    in {
        ...
        "pkg-1.21.1-2.0-fabric+forge+neo" = _JVTho74U;
        "pkg-1.21.4-2.0-fabric+forge+neo" = _ZkX4KD7g;
        "pkg-1.21.1-2.1-fabric+forge+neo" = _jAuUcVQN;
        "pkg-1.21.4-2.1-fabric+forge+neo" = _fdPWeET6;
        "pkg-1.21.1-2.2-fabric+forge+neo" = _3RAcWwV3;
        "pkg-1.21.4-2.2-fabric+forge+neo" = _2hWOM7AO;
        "pkg-1.21.1-2.3-fabric+forge+neo" = _ZZHE2Tr5;
        "pkg-1.21.4-2.3-fabric+forge+neo" = _9gtnnRi4;
        "pkg-1.21.5-2.3-fabric+forge+neo" = _RHUCTx1H;
        "pkg-1.21.1-2.4-fabric+forge+neo" = _S6fECUEX;
        "pkg-1.21.5-2.4-fabric+forge+neo" = _Q9Qv3ngO;
        "pkg-1.21.6-2.4-fabric+forge+neo" = _mzO0xSH0;
        "pkg-1.21.7-2.4-fabric+forge+neo" = _FgWyBHKu;
        "pkg-1.21.1-2.5-fabric+forge+neo" = _sI0v4UuH;
        "pkg-1.21.7-2.5-fabric+forge+neo" = _GO8Ugrqw;
        "pkg-1.21.8-2.5-fabric+forge+neo" = _MEgr2Dmv;
        "pkg-1.21.1-2.6-fabric+forge+neo" = _z0c8ETWi;
        "pkg-1.21.11-2.6-fabric+forge+neo" = _ZiDwCKkM;
        "pkg-26.1.2-2.6-fabric+forge+neo" = _orJ5BSq2;
        "pkg-1.21.1-2.7-fabric+forge+neo" = _c508VsR6;
        "pkg-1.21.11-2.8-fabric+forge+neo" = _EhACGidY;
        "pkg-26.1.2-2.8-fabric+forge+neo" = _jDziPt4Y;
        "pkg-1.21.1-2.9-fabric+forge+neo" = _wMsvsLjP;
