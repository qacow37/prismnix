...
let
    ...
    in {
        ...
        "pkg-v1.0.5" = _e8p952We;
        "pkg-v1.0.6" = _R9NSqCbH;
        "pkg-v1.0.7" = _nT8uMUEq;
        "pkg-25w33a" = _oMjF6es5;
        "pkg-v1.0.7+mod" = _zYkdgfgX;
        "pkg-25w33a+mod" = _Rw4tBMQi;
        "pkg-25w34b" = _wN6BP5Ah;
        "pkg-25w34b+mod" = _tOuTj6EV;
        "pkg-25w35a" = _ry4Rolr3;
        "pkg-25w35a+mod" = _DY5TionJ;
        "pkg-1.0.7-1.21.9pre1" = _VyNHkknJ;
        "pkg-1.0.7-1.21.9pre1+mod" = _KoU1jkAe;
        "pkg-v1.0.8b" = _4n5CTSdm;
        "pkg-v1.0.8b+mod" = _9NLDy8me;
        "pkg-v1.0.8a" = _cS86Kppf;
        "pkg-v1.0.8a+mod" = _CghyLJq8;
        "pkg-25w41a" = _pifBUJKk;
        "pkg-25w41a+mod" = _Ssu51Ilr;
        "pkg-v1.0.8c" = _OK5eMiw1;
        "pkg-v1.0.8c+mod" = _9kD7uSYz;
        "pkg-v1.0.8d" = _molpLrfQ;
        "pkg-v1.0.8d+mod" = _DnOzHwtZ;
        "pkg-v1.0.9" = _8ptSvQKS;
        "pkg-v1.0.9+mod" = _NwQidCD5;
        "pkg-v1.1.0" = _IuYNmfoo;
