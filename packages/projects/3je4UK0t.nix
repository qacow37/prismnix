...
let
    ...
    in {
        ...
        "pkg-0.0.1-Alpha+1.20" = _fpGfXTIU;
        "pkg-0.1.0.beta+1.20" = _3NvpgidQ;
        "pkg-1.20-0.1.0-beta2" = _t6OP7hkT;
        "pkg-1.20-0.1.0-beta3" = _j2EoWNVL;
        "pkg-1.20-0.1.0-beta4" = _v9MBzTPH;
        "pkg-1.20.2-0.1.0-beta1" = _X0dRYQ2v;
        "pkg-1.20-0.1.0" = _omON2bCV;
        "pkg-1.20.2-0.1.0" = _txmGdId2;
        "pkg-1.20.3-0.1.0" = _TJKlSDzL;
        "pkg-1.20-0.1.1" = _1t3W2C1P;
        "pkg-1.20.2-0.1.1" = _GWUBTxnE;
        "pkg-1.20.3-0.1.1" = _6qJVSRdc;
        "pkg-1.20.4-0.1.1" = _ehsArMor;
        "pkg-1.20-0.1.2" = _AzXvl5cW;
        "pkg-1.20.2-0.1.2" = _Dj4JW8EY;
        "pkg-1.20.4-0.1.2" = _klYEs8w2;
        "pkg-1.20-0.1.3" = _EMn7EOyx;
        "pkg-1.20.2-0.1.3" = _hgjCYxBk;
        "pkg-1.20.4-0.1.3" = _mgoY2d1K;
        "pkg-1.20.5-0.1.3-beta" = _7bz5dE9Q;
        "pkg-1.20-0.1.3+fixed" = _nNAVbzAf;
        "pkg-1.20.2-0.1.3+fixed" = _QLlbr0gQ;
        "pkg-1.20.5-0.1.3-beta.2" = _1a5egUlc;
        "pkg-1.20-0.2.0" = _ZnTGoFtC;
        "pkg-1.20.2-0.2.0" = _C6SwZmQ8;
        "pkg-1.20.4-0.2.0" = _ud0G7feH;
        "pkg-1.20.5-0.2.0-beta" = _WZViIIZb;
        "pkg-1.20-0.2.0+fixed" = _sL3BAV9S;
        "pkg-1.20.2-0.2.0+fixed" = _sg1qANKX;
        "pkg-1.20-0.2.1" = _nolXMSrI;
        "pkg-1.20.2-0.2.1" = _I3r9ArXj;
        "pkg-1.20.4-0.2.1" = _OaDn5LbL;
        "pkg-1.20.5-0.2.1-beta" = _GG01dz4j;
        "pkg-1.20.4-0.2.1+fixed" = _5pbgb6Of;
        "pkg-1.20.5-0.2.1-beta.2" = _5US3DLPL;
        "pkg-1.20.5-0.2.1-beta.3" = _KxDLqCK8;
        "pkg-1.20.5-0.2.1-beta.4" = _3hnLgADQ;
        "pkg-1.20-0.3.0" = _SrKjSBfC;
        "pkg-1.20.4-0.3.0" = _nyCCs3vw;
        "pkg-1.20.5-0.3.0-beta" = _gx1wv4Us;
        "pkg-1.20-0.3.1" = _FcB0DigX;
        "pkg-1.20.4-0.3.1" = _8uoWj7cL;
        "pkg-1.20.5-0.3.1-beta" = _w30ncZXI;
        "pkg-1.20.5-0.3.1-beta.2" = _PQgD8HAV;
        "pkg-1.20.5-0.3.1-beta.3" = _cNH8IVD7;
        "pkg-1.20.5-0.3.1-beta.4" = _H4ACE64m;
        "pkg-1.20.5-0.3.1" = _7rlx0KnE;
        "pkg-1.20.5-0.3.1+fixed" = _EO2QWb5G;
        "pkg-1.20.4-1.0.0-beta" = _55vYWTIp;
        "pkg-1.20.4-1.0.0-beta.2" = _OKELuPeP;
        "pkg-1.20.4-1.0.0-beta.3" = _OTH3OOfN;
        "pkg-1.20.4-1.0.0" = _tTOdZdRr;
        "pkg-1.20.4-1.0.1" = _dXsOp4BE;
        "pkg-1.20.4-1.0.2" = _zXJ8ykLu;
        "pkg-1.20.4-1.0.3" = _p9YchUIf;
        "pkg-1.0.3+1.20.4" = _YZ9WtwNC;
        "pkg-1.0.4+1.20.6" = _fJsprDMy;
        "pkg-1.0.4+1.21.1" = _IH16dLDX;
        "default" = _IH16dLDX;
    });
