...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.20.4" = _DiQvvLLM;
        "pkg-0.1.1+1.20.4" = _DdQQjm2T;
        "pkg-0.1.1+1.20.2" = _BkqfeGIw;
        "pkg-0.1.1+1.19.4" = _zJdARxM8;
        "pkg-0.1.2+1.20.4" = _JEYYnhwl;
        "pkg-0.1.2+1.20.2" = _3rJNAYyl;
        "pkg-0.1.2+1.19.4" = _TEURCMX9;
        "pkg-0.1.2+1.20.5" = _kspXW1Ut;
        "pkg-0.1.2+1.20.6" = _rCm0vCoS;
        "pkg-0.1.3+1.19.4" = _te6LrBUM;
        "pkg-0.1.3+1.20.4" = _shaPfY0g;
        "pkg-0.1.3+1.20.6" = _qE9PQFrR;
        "pkg-0.1.3+1.21" = _BFg0lYA4;
        "pkg-0.1.3+1.21.1" = _4KlXByrS;
        "pkg-0.1.4+1.20.4" = _mye0ozuw;
        "pkg-0.1.4+1.20.6" = _bJ4F984w;
        "pkg-0.1.4+1.19.4" = _mU4RdJbh;
        "pkg-0.1.4+.1.20.2" = _Jc0c9Ol3;
        "pkg-0.1.4+1.21" = _cwV4mI4Y;
        "pkg-0.1.4+1.21.1" = _mDSK6KHr;
        "pkg-0.1.5+1.19.4" = _eXk6b1Pe;
        "pkg-0.1.5+1.20.4" = _ISO9sqdh;
        "pkg-0.1.5+1.20.2" = _5TJuLUjL;
        "pkg-0.1.5+1.20.6" = _FDdtscyQ;
        "pkg-0.1.5+1.21" = _uP00LeD4;
        "default" = _uP00LeD4;
    });
