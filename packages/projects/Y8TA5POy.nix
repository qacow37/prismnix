...
let
    ...
    in {
        ...
        "pkg-0.1-alpha.1+1.20.3" = _i5JxtJPY;
        "pkg-0.1-alpha.2+1.20.3" = _KPgSdopM;
        "pkg-0.1-alpha.3+1.20.3" = _zYbbnU8Q;
        "pkg-0.1-alpha.4+1.20.3" = _8EwnBPJK;
        "pkg-0.1-alpha.5+1.20.3" = _Ra5PLSGy;
        "pkg-0.1-alpha.6+1.20.3" = _SIYIGRuh;
        "pkg-0.1-alpha.7+1.20.3" = _XjPyVztX;
        "pkg-0.1-alpha.8+1.20.3" = _NAhkWdkG;
        "pkg-0.1-alpha.9+1.20.3" = _pygywZRP;
        "pkg-0.1-alpha.10+1.20.3" = _GTf0sNMP;
        "pkg-0.1-alpha.11+1.20.3" = _3ATyK1iJ;
        "pkg-0.1-alpha.11+1.20" = _lT0RhtmT;
        "pkg-0.1-alpha.12+1.20.3" = _UI9eOVyC;
        "pkg-0.1-alpha.12+1.20" = _F0DeKvxh;
        "pkg-0.1-alpha.13+1.20.3" = _nnaKwZR5;
        "pkg-0.1-alpha.13+1.20" = _pf8hXeMZ;
        "pkg-0.1-alpha.14+1.20.3" = _MUpW91jk;
        "pkg-0.1-alpha.14+1.20" = _DaGAC9SS;
        "pkg-0.1.0+1.20" = _Q80iR4ig;
        "pkg-0.1.0+1.20.3" = _BPq5RS3Z;
        "pkg-0.1.1+1.20" = _Arnvai01;
        "pkg-0.1.1+1.21" = _QsIJeZlc;
        "pkg-0.1.2+1.21" = _alm7GM7M;
        "pkg-0.1.3+1.21" = _v7AsZII6;
        "pkg-0.1.4+1.21" = _g9Zj1XKJ;
        "pkg-0.1.5+1.21" = _VIgWKL0Z;
        "pkg-0.1.6+1.21" = _MK9IN86N;
        "pkg-0.1.7+1.21.1" = _nvuFlaqm;
        "pkg-0.1.8+1.21.1" = _v96Pfyak;
        "pkg-0.1.8+1.20" = _DszCg5TQ;
        "pkg-0.1.9+1.21.1" = _8E7EHxIv;
        "pkg-0.1.10+1.21.1" = _IZPHYpvz;
        "pkg-0.1.11+1.21.1" = _tMq5wrUP;
        "pkg-0.1.12+1.21.1" = _GRl0ur5Q;
        "pkg-0.1.13+1.21.1" = _8e3GJKd9;
        "default" = _8e3GJKd9;
    });
