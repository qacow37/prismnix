...
let
    ...
    in {
        ...
        "pkg-V1.1" = _buyLXPHY;
        "pkg-V1.1.1" = _tqRtZnCi;
        "pkg-V1.1.2-data" = _VfolyZWp;
        "pkg-V1.1.2-mod" = _YmDsMfhE;
        "pkg-V1.1.3-data" = _NzBYU56m;
        "pkg-V1.1.3-mod" = _xh3Xviko;
        "pkg-V1.1.4-data" = _3dJw6ljB;
        "pkg-V1.1.4-mod" = _bRwJMzaY;
        "pkg-V1.1.5-data" = _BCUpWQ7J;
        "pkg-V1.1.5-mod" = _1BUnbscM;
        "pkg-V1.1.6-data" = _KytNDYH9;
        "pkg-V1.1.6-mod" = _K7OjyDhU;
        "pkg-V1.2-data" = _CK0CDcRp;
        "pkg-V1.2-mod" = _4pkzfqlP;
        "pkg-V1.2.1-data" = _TXwWk7Ox;
        "pkg-V1.2.1-mod" = _DStuKjHu;
        "pkg-V1.2.2-data" = _KYfAzATm;
        "pkg-V1.2.2-mod" = _D4fZtwsI;
        "pkg-V1.2.3-data" = _lGSBUEs0;
        "pkg-V1.2.3-mod" = _akSmyorP;
        "pkg-V1.2.4-data" = _RkYg4qTp;
        "pkg-V1.2.4-mod" = _988FihGJ;
        "default" = _988FihGJ;
    });
