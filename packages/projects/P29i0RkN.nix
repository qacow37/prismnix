...
let
    ...
    in {
        ...
        "pkg-0.0.4b" = _EnhdUhHJ;
        "pkg-0.0.4c" = _a8mt5INR;
        "pkg-0.0.4d" = _LptCPSdR;
        "pkg-0.0.4e" = _4VXVwDYr;
        "pkg-0.0.5a" = _h6IdLyv1;
        "pkg-0.0.5b" = _M0wjysNd;
        "pkg-0.0.5c" = _ffcMmM5j;
        "pkg-0.0.6a" = _jnoA1h1S;
        "pkg-0.0.6c" = _lTq9i0vW;
        "pkg-0.0.6d" = _yjvhAlnr;
        "pkg-0.0.7b" = _kd66lHtu;
        "pkg-0.0.7d" = _vzizsIPS;
        "pkg-1.0.0a" = _jRi9nmAV;
        "pkg-1.0.1a" = _mWkQh94N;
        "pkg-1.1.0a" = _UiT7XzwF;
        "pkg-1.1.1a" = _aOW27Z8D;
        "pkg-1.2" = _QNZKcpPN;
        "pkg-1.2.1" = _2YOYDZxc;
        "pkg-1.2.2b" = _pTlslh1e;
        "pkg-1.2.3a" = _YJTwwezf;
        "pkg-1.3.0" = _D05fANIx;
        "pkg-1.4.0" = _ERhPQ9d9;
        "pkg-1.4.1" = _6BAYr1CQ;
        "pkg-1.4.2" = _LgSCgBIm;
        "pkg-1.4.2b" = _wrgeTdn7;
        "pkg-1.4.2c" = _8oGqczJd;
        "pkg-2.0" = _iAgjhPh9;
        "pkg-2.1" = _EHtLhWOA;
        "pkg-2.1b" = _ABlJX4EH;
        "default" = _ABlJX4EH;
