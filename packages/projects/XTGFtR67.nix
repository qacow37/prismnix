...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _hfgSZm9h;
        "pkg-1.21.1-1.0.0" = _GQ7LteQQ;
        "pkg-1.21.1-1.0.1" = _QUb7ebct;
        "pkg-1.21.4-1.0.1" = _q8moZBti;
        "pkg-1.20.1-1.0.1" = _lxUkexbT;
        "pkg-1.21.4-1.1.0" = _I2T3SkKn;
        "pkg-1.21.11-1.2.0" = _RsMxmmI6;
