...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _ZWJyav17;
        "pkg-1.0-686a7af" = _PtgfB9as;
        "pkg-1.0-598c253" = _GFqwzMYj;
        "pkg-1.0-3cb34b7" = _yFgOnKXB;
        "pkg-1.0-d6717a1" = _v7BeJsX8;
        "pkg-1.0-be0659c" = _y5frO9rW;
        "pkg-1.0-3b69fc3" = _85YnmMRi;
        "pkg-1.0-39bf3ae" = _zGzAgfKn;
        "pkg-1.0-6b51e01" = _EPn7QyLn;
        "pkg-1.0-8bd877b" = _4zpF3tBZ;
        "pkg-1.0-3ee9ce3" = _HnxtWUW7;
        "pkg-1.0-a69dd4f" = _bIJ8XSM2;
        "pkg-1.0-403aaeb" = _aFW60A5I;
        "pkg-1.0-b55b0a1" = _AonNkKUy;
        "pkg-1.0-615edf7" = _AnJqX2Un;
        "pkg-1.0-4a07e9f" = _IvPTVTB0;
        "pkg-1.0-06f3db5" = _eMq4kxRu;
        "pkg-1.0-0d15b19" = _GOf2JlUe;
        "pkg-1.0-c8c2897" = _v0izfBih;
        "pkg-1.0-83adf9b" = _4t40BFHJ;
        "pkg-1.0-3ddec8b" = _Bv5w9ugb;
        "pkg-1.0-b078515" = _XRpGN5ep;
        "pkg-1.0-d7de938" = _qu7G8GlA;
        "pkg-1.0-6263a76" = _gvk1vLAv;
        "pkg-1.0-3078173" = _xmlhaVVN;
        "pkg-2.0-1" = _smuQ2wZw;
        "pkg-2.0-1.1" = _Ml6ipSl8;
        "pkg-3" = _Z8UilGX6;
        "pkg-4" = _FEaMVuiw;
        "pkg-5" = _JIv27Fg5;
        "default" = _JIv27Fg5;
