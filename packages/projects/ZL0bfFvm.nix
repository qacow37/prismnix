...
let
    ...
    in {
        ...
        "pkg-1.3" = _QCDc5GDg;
        "pkg-1.4" = _3iHRNLiC;
        "pkg-1.18.2-1.0" = _nmP9NDXY;
        "pkg-1.5" = _WTnAQkgP;
        "pkg-1.18.2-1.1" = _KiRQFG7J;
        "pkg-1.20-1.1" = _RsPRGjCo;
        "pkg-1.6" = _uHUmpqIP;
        "pkg-1.20-1.2" = _EXnnNxbK;
        "pkg-1.7" = _NW9LuqmU;
        "pkg-1.20-1.3" = _gnxq5238;
        "pkg-1.18.2-1.2" = _9Sk4txnt;
        "pkg-1.8" = _No8Vc1wG;
        "pkg-1.9" = _m7GOikPk;
        "pkg-1.18.2-1.3" = _OqUxbcIn;
        "pkg-1.20-1.4" = _BqVSoD9H;
        "pkg-1.10" = _L0KHTg2X;
        "pkg-1.20-1.5" = _Dm1VO5jh;
        "pkg-1.18.2-1.4" = _bcMTqRB9;
        "pkg-1.20-1.6" = _kUot2mDx;
        "pkg-1.20-1.7" = _MNWX2jCt;
        "pkg-1.11" = _zxPgDkxv;
        "pkg-1.20-1.8" = _CzUgXgZK;
        "pkg-1.12" = _liMsYAaf;
        "pkg-1.20-1.9" = _JtTM7rCt;
        "default" = _JtTM7rCt;
    });
