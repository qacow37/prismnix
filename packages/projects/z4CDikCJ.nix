...
let
    ...
    in {
        ...
        "pkg-1.4" = _DMSPCh8J;
        "pkg-1.4.1" = _DpN6Dfz5;
        "pkg-1.4.1+1.19.2" = _FqPgMCl4;
        "pkg-1.4.2+1.20.2" = _vYi4J5eF;
        "pkg-1.4.2+1.19.2" = _nOkSlDWo;
        "pkg-1.5+1.19.2" = _9ieIOgRQ;
        "pkg-1.5+1.20.2" = _d1BuzLNE;
        "pkg-1.6+1.19.2" = _aVJXUXnp;
        "pkg-1.6+1.20.2" = _L0VqfUyw;
        "pkg-1.7+1.19.2-FORGE" = _Je1WJedB;
        "pkg-1.7+1.20-FORGE" = _ov3ZDAPS;
        "pkg-1.7+1.19.2-FABRIC" = _o171JuCu;
        "pkg-1.7+1.20-FABRIC" = _XRI4vaNj;
        "pkg-1.8+1.19.2-FORGE" = _O0LNDSSL;
        "pkg-1.8+1.20-FORGE" = _PukRSLhd;
        "pkg-1.8+1.19.2-FABRIC" = _B9qk7AA7;
        "pkg-1.8+1.20-FABRIC" = _AHwJ0TTu;
        "pkg-1.8.1+1.20-FORGE" = _c7xuOh7X;
        "pkg-1.8.2+1.20-FORGE" = _trAKsuGX;
        "pkg-1.8.2+1.21-NEOFORGE" = _wWj9KcWg;
        "pkg-1.8.2+1.20-FABRIC" = _1p1BJ6SY;
        "pkg-1.8.2+1.21-FABRIC" = _qRxxpqBx;
        "pkg-1.8.3+1.20-FORGE" = _8uz8puUF;
        "pkg-1.8.3+1.21-NEOFORGE" = _21PWGuTN;
        "pkg-1.8.3+1.20.1-FABRIC" = _DfGraAt1;
        "pkg-1.8.3+1.21-FABRIC" = _aayHb3Ar;
        "pkg-1.8.4+1.21-NEOFORGE" = _9pY3KIHc;
        "pkg-1.8.4+1.21-FABRIC" = _WNISZHee;
        "pkg-1.8.5+1.20-FORGE" = _wVIIZq27;
        "pkg-1.8.5+1.21-NEOFORGE" = _VwYj1Sfh;
        "pkg-1.8.5+1.20.1-FABRIC" = _bydrUEVW;
        "pkg-1.8.5+1.21-FABRIC" = _sozOa537;
        "pkg-1.8.6+1.21-FABRIC" = _a51Wfmza;
        "pkg-1.8.6+1.21-NEOFORGE" = _eubnPMw5;
        "pkg-1.8.6+1.21.4-FABRIC" = _Jg2uK5yv;
        "pkg-1.8.6+1.21.4-NEOFORGE" = _Qorl4022;
        "pkg-1.8.6.1+1.21-FABRIC" = _LMHCHqDi;
        "pkg-1.8.6.1+1.21-NEOFORGE" = _BZAPfuD4;
        "pkg-1.8.6.1+1.21.4-FABRIC" = _QchjGsqM;
        "pkg-1.8.6.1+1.21.4-NEOFORGE" = _2vtVjK3M;
        "pkg-1.8.6.2+1.21-FABRIC" = _I4NhGF7E;
        "pkg-1.8.6.2+1.21-NEOFORGE" = _wL1hJSvY;
        "pkg-1.8.6.3+1.21-FABRIC" = _1b8WQoWg;
        "pkg-1.8.6.3+1.21-NEOFORGE" = _Opv0Bskq;
        "pkg-1.8.6.4+1.21-FABRIC" = _QUOEEkdJ;
        "pkg-1.8.6.4+1.21-NEOFORGE" = _zai9OfV5;
        "pkg-1.8.6.5+1.21-NEOFORGE" = _ilxLfdWN;
        "pkg-1.8.6.6+1.21-NEOFORGE" = _9Iwvafgv;
        "pkg-1.8.6.7+1.21-NEOFORGE" = _BZmd2uY0;
        "pkg-1.8.7+1.21-FABRIC" = _BERGwud2;
        "pkg-1.8.7+1.21-NEOFORGE" = _tJ8WdpkK;
        "pkg-1.8.7+1.20.1-FORGE" = _E5OYgzQE;
        "pkg-1.8.7+1.21.4-FABRIC" = _JAs2TnVy;
        "pkg-1.8.7+1.21.4-NEOFORGE" = _eDFMf70K;
        "pkg-1.8.7.1+1.21.4-NEOFORGE" = _wf6IlAs2;
        "pkg-1.8.8+1.21-FABRIC" = _IWMGDZAq;
        "pkg-1.8.9+1.21-FABRIC" = _EttzDkE8;
        "pkg-1.9+1.21+FABRIC" = _ldzmreVI;
        "pkg-1.9+1.21.4-FABRIC" = _MI7tvwkA;
        "pkg-1.9+1.21.5+FABRIC" = _2a07DJes;
        "pkg-1.9+1.21+NEOFORGE" = _aP7A8SIq;
        "pkg-1.9+1.21.4-NEOFORGE" = _BjWoFTnO;
        "pkg-1.9+1.21.5-NEOFORGE" = _aVlx211p;
        "pkg-1.9.1+1.21-FABRIC" = _R3I9uNOS;
        "pkg-1.9.1+1.21.4-FABRIC" = _axIfK9T3;
        "pkg-1.9.1+1.21.5-FABRIC" = _NvrWQPno;
        "pkg-1.9.1+1.21-NEOFORGE" = _qowA00gI;
        "pkg-1.9.1+1.21.4-NEOFORGE" = _QGxetvjH;
        "pkg-1.9.1+1.21.5-NEOFORGE" = _wYZGQCK4;
        "pkg-1.9.2+1.21.5-NEOFORGE" = _pjRVmavb;
        "pkg-1.9.3+1.21-FABRIC" = _Wzs2jREb;
        "pkg-1.9.3+1.21.4-FABRIC" = _SrBrm1Y4;
        "pkg-1.9.3+1.21.5-FABRIC" = _OHgqaesq;
        "pkg-1.9.3+1.21-NEOFORGE" = _xWjv7WYK;
        "pkg-1.9.3+1.21.4-NEOFORGE" = _jVlC9hf2;
        "pkg-1.9.3+1.21.5-NEOFORGE" = _9uiOqspH;
        "pkg-1.9.4+1.21-FABRIC" = _Dd7hTsHg;
        "pkg-1.9.4+1.21.4-FABRIC" = _j3xTR0Bs;
        "pkg-1.9.4+1.21.5-FABRIC" = _pt7cdMH4;
        "pkg-1.9.4+1.21.6-FABRIC" = _RbKMaFGX;
        "pkg-1.9.4+1.21-NEOFORGE" = _dRFwM7wB;
        "pkg-1.9.4+1.21.4-NEOFORGE" = _FsdkSPJI;
        "pkg-1.9.4+1.21.5-NEOFORGE" = _qopb9iwv;
        "pkg-1.9.4+1.21.6-NEOFORGE" = _TyGLUMAK;
        "pkg-1.9.5+1.21.10-NEOFORGE" = _1MMeIVqL;
        "pkg-1.9.5+1.21.10-FABRIC" = _cTy3q7BU;
        "pkg-1.9.5+1.21.11-FABRIC" = _h6tay9G6;
        "pkg-1.9.5+1.21.11-NEOFORGE" = _1V5TnRCe;
        "default" = _1V5TnRCe;
    });
