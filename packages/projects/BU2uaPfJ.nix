...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _JwgExi7E;
        "pkg-1.0.1-forge-1.19.2" = _JTyt3VMx;
        "pkg-1.0.1-fabric-1.19.2" = _ZVvbvfJ0;
        "pkg-1.0.1-forge-1.20.1" = _wZTBG8Wq;
        "pkg-1.0.1-fabric-1.20.1" = _Wflx7TcJ;
        "pkg-1.0.2-fabric-1.20.1" = _QpYsq1K8;
        "pkg-1.0.2-forge-1.20.1" = _LEoHJw6G;
        "pkg-1.1.0" = _nvkHo7tp;
        "pkg-1.1.1" = _GkBW2gVC;
        "pkg-1.1.2" = _RGzVBBxR;
        "pkg-1.2.0" = _SPYVECdn;
