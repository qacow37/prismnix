...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.0" = _bF3CDkWa;
        "pkg-1.20.1-1.0.1" = _5YHoYOJp;
        "pkg-1.20.1-1.0.2" = _cbIGDLHU;
        "pkg-1.20.1-1.0.3" = _o6jR6gkg;
        "pkg-1.20.1-1.1.0" = _dHJ5mIdv;
        "pkg-1.20.1-1.1.1" = _Se0nBtlw;
        "pkg-1.20.1-1.2.0" = _QxujASM6;
        "pkg-1.20.1-1.2.1" = _1vOLvTUE;
        "pkg-1.20.1-1.2.2" = _ZaBb2ZHe;
        "pkg-1.20.1-1.2.3" = _EyPsS7hp;
        "pkg-1.20.1-1.3.0" = _OXAZeSeD;
        "pkg-1.20.1-1.3.1" = _YQujLxK8;
        "pkg-1.20.1-1.3.2" = _DsinjnQg;
        "pkg-1.20.1-1.3.3" = _QpPwmBx5;
        "pkg-1.20.1-1.3.4" = _xxOHDzgV;
        "pkg-1.20.1-1.3.5" = _uvkSjQir;
        "pkg-1.20.1-1.3.6" = _PTigfT3O;
        "pkg-1.20.1-1.3.7" = _TcTnaOxi;
        "pkg-1.20.1-1.3.8" = _eT8fc1i0;
        "pkg-1.20.1-1.3.9" = _sVamBl5z;
        "pkg-1.20.1-1.3.10" = _HiIaxKNa;
        "pkg-1.20.1-1.3.11" = _zLcxXORD;
        "pkg-1.20.1-1.4.0" = _lFpXEBrC;
        "pkg-1.20.1-1.4.1" = _v0fkymGC;
        "pkg-1.20.1-1.4.2" = _LPS5MjQ9;
        "pkg-1.20.1-1.4.3" = _EFZIOpW8;
        "pkg-1.20.1-1.4.4" = _KMsiWZWi;
        "pkg-1.20.1-1.4.5" = _uAOjV8X3;
        "pkg-1.20.1-1.4.6" = _yXZ90ayB;
        "pkg-1.20.1-1.4.7" = _QNWjEwxw;
        "default" = _QNWjEwxw;
    });
