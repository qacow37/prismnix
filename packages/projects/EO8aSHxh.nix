...
let
    ...
    in {
        ...
        "pkg-fabric-1.16.5-eureka-v1.0-alpha0" = _4iigJLOg;
        "pkg-1.16.5-fabric-1.0.0-alpha1" = _GrKPsmh4;
        "pkg-1.16.5-forge-1.0.0-alpha1" = _VbuY8zfn;
        "pkg-1.16.5-fabric-1.0.0-alpha2" = _QZIoO12W;
        "pkg-1.16.5-forge-1.0.0-alpha2" = _QAljsR5c;
        "pkg-1.16.5-fabric-1.0.0-alpha3" = _RIogt1rp;
        "pkg-1.16.5-forge-1.0.0-alpha3" = _kDi0nC2m;
        "pkg-1.16.5-fabric-1.0.0-alpha4" = _eJsL2llB;
        "pkg-1.16.5-forge-1.0.0-alpha4" = _VzG6iJQR;
        "pkg-1.16.5-fabric-1.0.0-alpha5" = _By4j2U2G;
        "pkg-1.16.5-forge-1.0.0-alpha5" = _I4OhOSNk;
        "pkg-1.16.5-fabric-1.0.0-alpha6" = _ivDWRpQr;
        "pkg-1.16.5-forge-1.0.0-alpha6" = _BHaIvOIy;
        "pkg-1.18.2-forge-1.1.0-beta1" = _f9Q5N7L6;
        "pkg-1.1.0-beta1" = _XuWA3103;
        "pkg-1.18.2-forge-1.1.0-beta3" = _6Ad0NlMh;
        "pkg-1.18.2-forge-1.1.0-beta4" = _jhKCYiJi;
        "pkg-1.16.5-fabric-1.0.0-alpha7" = _nqpsFEww;
        "pkg-1.16.5-forge-1.0.0-alpha7" = _btYrFzgl;
        "pkg-1.18.2-fabric-1.1.0-beta5" = _ynOYkPbR;
        "pkg-1.18.2-forge-1.1.0-beta5" = _wKRTETtk;
        "pkg-1.18.2-fabric-1.1.0-beta.6" = _fbzvNPEN;
        "pkg-1.18.2-forge-1.1.0-beta.6" = _Cl1mJf0c;
        "pkg-1.18.2-fabric-1.1.0-beta.8" = _XBNR2K72;
        "pkg-1.18.2-forge-1.1.0-beta.8" = _qaUMXbid;
        "pkg-1.18.2-fabric-1.1.0-beta.9" = _TWQvBrKh;
        "pkg-1.18.2-forge-1.1.0-beta.9" = _y6VYLPRx;
        "pkg-1.19.2-fabric-1.2.0-beta.1" = _UAXUHqaW;
        "pkg-1.19.2-forge-1.2.0-beta.1" = _5rHDW66W;
        "pkg-1.20.1-fabric-1.3.0-beta.1" = _WNu0snY0;
        "pkg-1.20.1-forge-1.3.0-beta.1" = _l9jeCn6L;
        "pkg-1.20.1-fabric-1.3.0-beta.2" = _inFFe9Gn;
        "pkg-1.20.1-forge-1.3.0-beta.2" = _5cxjyjUI;
        "pkg-1.18.2-fabric-1.1.0-beta.10" = _Qj7XNydO;
        "pkg-1.18.2-forge-1.1.0-beta.10" = _TxfUDq9t;
        "pkg-1.18.2-fabric-1.1.1-beta.1" = _xj9aNfvS;
        "pkg-1.18.2-forge-1.1.1-beta.1" = _okGr9FAQ;
        "pkg-1.18.2-fabric-1.4.0-beta.1" = _B4zaacZX;
        "pkg-1.18.2-forge-1.4.0-beta.1" = _ImOFwQEv;
        "pkg-1.19.2-fabric-1.2.0-beta.2" = _eQyJjpSH;
        "pkg-1.19.2-forge-1.2.0-beta.2" = _oN3JaHEJ;
        "pkg-1.20.1-fabric-1.3.0-beta.3" = _fEbw0KrK;
        "pkg-1.20.1-forge-1.3.0-beta.3" = _GGXjIHN0;
        "pkg-1.20.1-fabric-1.3.0-beta.4" = _fIvEEzek;
        "pkg-1.20.1-forge-1.3.0-beta.4" = _bE87wEgk;
        "pkg-1.18.2-fabric-1.5.0-beta.1" = _B8YxXI26;
        "pkg-1.18.2-forge-1.5.0-beta.1" = _vgMYgYN5;
        "pkg-1.19.2-fabric-1.5.0-beta.2" = _yB510jQy;
        "pkg-1.19.2-forge-1.5.0-beta.2" = _Sf9xDu3q;
        "pkg-1.20.1-fabric-1.5.0-beta.3" = _mYC19qvT;
        "pkg-1.20.1-forge-1.5.0-beta.3" = _Krq42JBx;
        "pkg-1.18.2-fabric-1.5.1-beta.1" = _a9ig4zeM;
        "pkg-1.18.2-forge-1.5.1-beta.1" = _pgwgxAIv;
        "pkg-1.19.2-fabric-1.5.1-beta.2" = _oh7Jnn8E;
        "pkg-1.19.2-forge-1.5.1-beta.2" = _3jvU69Oz;
        "pkg-1.20.1-fabric-1.5.1-beta.3" = _sXx5EPib;
        "pkg-1.20.1-forge-1.5.1-beta.3" = _9gbnRz82;
        "pkg-1.18.2-fabric-1.5.2-beta.1" = _kkUGJLpK;
        "pkg-1.18.2-forge-1.5.2-beta.1" = _YPB9eGcp;
        "pkg-1.19.2-fabric-1.5.2-beta.2" = _WRhOTZXO;
        "pkg-1.19.2-forge-1.5.2-beta.2" = _A7pYK9gA;
        "pkg-1.20.1-fabric-1.5.2-beta.3" = _bGtt7Eah;
        "pkg-1.20.1-forge-1.5.2-beta.3" = _4ndrYYeb;
        "pkg-1.20.1-fabric-1.5.2-beta.4" = _1bAWyx2t;
        "pkg-1.18.2-fabric-1.5.3-beta.1" = _RAX1zSlH;
        "pkg-1.18.2-forge-1.5.3-beta.1" = _f7aZM6IK;
        "pkg-1.19.2-fabric-1.5.3-beta.2" = _R4Y0Ijeh;
        "pkg-1.19.2-forge-1.5.3-beta.2" = _n07RGKr7;
        "pkg-1.20.1-fabric-1.5.3-beta.3" = _1B2Fp65F;
        "pkg-1.20.1-forge-1.5.3-beta.3" = _aMsPYKuR;
        "pkg-1.20.1-forge-1.5.3-beta.4" = _z2iRvMpj;
        "pkg-1.19.2-fabric-1.5.4-beta.2" = _63yF415H;
        "pkg-1.19.2-forge-1.5.4-beta.2" = _afuKYGOT;
        "pkg-1.18.2-fabric-1.5.4-beta.1" = _Z78UhkVg;
        "pkg-1.18.2-forge-1.5.4-beta.1" = _t74lDHyg;
        "pkg-1.20.1-fabric-1.5.4-beta.3" = _EV3SzyJ8;
        "pkg-1.20.1-forge-1.5.4-beta.3" = _a8GXRdXm;
        "pkg-1.20.1-fabric-1.6.0" = _yiGnI1dQ;
        "pkg-1.20.1-forge-1.6.0" = _dWwTr8Ds;
        "pkg-1.20.1-fabric-1.6.1" = _K3IdXWKo;
        "pkg-1.20.1-forge-1.6.1" = _gkwkGpv4;
        "pkg-1.20.1-fabric-1.6.2" = _bgDqM3VY;
        "pkg-1.20.1-forge-1.6.2" = _QPGzLtos;
        "pkg-1.20.1-fabric-1.6.3" = _aJWa3eWO;
        "pkg-1.20.1-forge-1.6.3" = _w2tkVjFR;
        "default" = _w2tkVjFR;
    });
