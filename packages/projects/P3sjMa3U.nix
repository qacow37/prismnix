...
let
    ...
    in {
        ...
        "pkg-0.1.0-1.19.3" = _PqV105Ep;
        "pkg-0.1.1-1.19.3" = _md6PL1vr;
        "pkg-0.1.1-1.19.4" = _mgQN59dC;
        "pkg-0.1.2-1.19.4" = _jMJinB8v;
        "pkg-0.1.3-1.19.4" = _5pxdM8OG;
        "pkg-0.1.4-1.19.4" = _7yNqJxdk;
        "pkg-0.1.5-1.19.4" = _nYCgIJSf;
        "pkg-0.1.6-1.19.4" = _QxHyi05C;
        "pkg-0.1.7-1.19.4" = _lFVzUgA5;
        "pkg-0.1.7-1.18.2" = _tOGYm9WD;
        "pkg-0.1.7-1.19.2" = _YoKtKfwv;
        "pkg-0.1.8-1.19.4" = _hHQuMYrU;
        "pkg-0.1.9-1.19.4" = _XglekO8K;
        "pkg-0.1.10-1.19.4" = _E5XKpgK5;
        "pkg-0.1.11-1.20-beta.6" = _PImh18fV;
        "pkg-0.1.11-1.20" = _wElr72ds;
        "pkg-0.1.11-1.20.1" = _ngpv6unB;
        "pkg-0.1.12-1.20.1" = _pBeLyLjv;
        "pkg-0.1.13-1.20.1" = _cjlxNDzh;
        "pkg-0.1.14-1.20.1" = _1xBJBmZn;
        "pkg-0.1.15-1.20.1" = _EUuVvC7E;
        "pkg-0.1.16-1.20.1" = _u4uXw6pX;
        "pkg-0.1.17-1.20.1" = _O4FIcOMD;
        "pkg-0.1.18-1.20.1" = _KdLxhFtQ;
        "pkg-0.1.19-1.20.1" = _4UJH67JO;
        "pkg-0.1.20-1.20.1" = _AxChNhLz;
        "pkg-0.1.21-1.20.1" = _rH4J2ptv;
        "pkg-0.1.22-1.20.1" = _ikscKKjt;
        "pkg-0.1.23-1.20.1" = _ntqh83Xy;
        "pkg-0.1.25-1.20.1" = _eKRRahQw;
        "pkg-0.1.26-1.20.1" = _gKGfRXrM;
        "pkg-0.1.27-1.20.1" = _UdxJIdC2;
        "default" = _UdxJIdC2;
    });
