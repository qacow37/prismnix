...
let
    ...
    in {
        ...
        "pkg-4.1.0" = _MUk2Z2Zv;
        "pkg-4.1.1" = _OXBkbR1M;
        "pkg-5.0.0-forge" = _z8qd9WuG;
        "pkg-5.0.0-fabric" = _QE4IlQoJ;
        "pkg-5.0.0-quilt" = _QHceqD2V;
        "pkg-5.0.1-forge" = _ebyijdsw;
        "pkg-5.0.1-fabric" = _WisLIPQ9;
        "pkg-5.0.1-quilt" = _lqH98CUx;
        "pkg-5.1.0-fabric" = _2evcQb3y;
        "pkg-5.1.0-neoforge" = _2hskTr6k;
        "pkg-5.2.0-fabric" = _4nC7lhgG;
        "pkg-5.2.0-neoforge" = _76fbCyTt;
        "pkg-5.2.1-neoforge" = _TMOdQHDi;
        "pkg-5.2.1-fabric" = _GngqTZ0E;
        "pkg-6.0.0-neoforge" = _zLwvzM9F;
        "pkg-6.0.0-fabric" = _GuYuJjdK;
        "default" = _GuYuJjdK;
    });
