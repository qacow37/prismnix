...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _BOmkSBKa;
        "pkg-1.1.0+mod" = _Glo8lW7M;
        "pkg-1.1.1" = _6GULRYvE;
        "pkg-1.1.1+mod" = _2yrgdEuc;
        "pkg-1.1.2" = _BIbkvXRk;
        "pkg-1.1.2+mod" = _slK0lgvf;
        "pkg-1.1.3" = _pwKoZChA;
        "pkg-1.1.3+mod" = _NGgB5umj;
        "pkg-1.2.0" = _cpYIG3d1;
        "pkg-1.2.0+mod" = _zGW3M1VF;
        "pkg-1.2.1" = _kTzr3Ndg;
        "pkg-1.2.1+mod" = _o01fSxat;
        "pkg-1.2.2" = _O8uW6g0v;
        "pkg-1.2.2+mod" = _JNGKC17Q;
        "pkg-1.2.3" = _5N5NW8Z8;
        "pkg-1.2.3+mod" = _T4QPotDo;
        "pkg-1.2.4" = _W285fTjj;
        "pkg-1.2.4+mod" = _AOkdkkjW;
        "pkg-1.2.5" = _DhdgaLY2;
        "pkg-1.2.5+mod" = _kFL2A7ov;
        "pkg-1.2.6" = _F5jtcqsC;
        "pkg-1.2.6+mod" = _Rz7StyN3;
        "pkg-1.2.7" = _zpVr1EX0;
        "pkg-1.2.7+mod" = _BN88AKe6;
        "pkg-1.3.0-mc1.21.8" = _I2KDIpQi;
        "pkg-1.3.0-mc1.21.8+mod" = _yVddnlJE;
        "pkg-1.3.1-mc1.21.8" = _NlJo41Cb;
        "pkg-1.3.1-mc1.21.8+mod" = _Mjvi1lAW;
        "pkg-1.3.2" = _93CA3A9P;
        "pkg-1.3.3" = _80rCiyJO;
        "pkg-1.3.3+mod" = _9zI8K33v;
        "default" = _9zI8K33v;
    });
