...
let
    ...
    in {
        ...
        "pkg-1.0" = _GZgFJ3Qy;
        "pkg-1.0.3-1.19.2" = _yBlXTol5;
        "pkg-0.0.1-1.19.2" = _Lw53Jrxy;
        "pkg-1.0-1.18.2" = _UieIHsQL;
        "pkg-1.0.1-1.20.1" = _Pljc8qAE;
        "pkg-1.0.0-1.20.2" = _kTBvzu0Y;
        "pkg-1.0.2-1.20.1" = _932tOIwE;
        "pkg-1.0.1-1.20.2" = _55LN3Hxw;
        "pkg-1.0.0-1.20.4" = _An5OUT0j;
        "pkg-1.0.3-1.20.1" = _5HQjgIyo;
        "pkg-1.0.2-1.20.2" = _VEwbIZHl;
        "pkg-1.0.1-1.20.4" = _Ihq9FLDB;
        "pkg-1.0.4-1.19.2" = _KBFPXttM;
        "pkg-1.0.1-1.19.2" = _8ULk18Da;
        "pkg-1.0.2-1.19.2-fabric" = _YvzIc6U6;
        "pkg-1.0.4-1.20.1-fabric" = _Y2UTmyuG;
        "pkg-1.0.3-1.20.2-fabric" = _dHh4upgW;
        "pkg-1.0.2-1.20.4-fabric" = _B6hUqet6;
        "pkg-1.0.5-1.19.2-forge" = _gOiQKIQd;
        "pkg-1.0.4-1.20.1-forge" = _RXoegkYc;
        "pkg-1.0.0-1.20.2-forge" = _HLf3dJsn;
        "pkg-1.0.5-1.20.1-forge" = _vrYUciTl;
        "pkg-1.0.3-1.20.4-fabric" = _saif5glL;
        "pkg-1.0.5-1.20.1-fabric" = _8la8tb0W;
        "pkg-1.0.0-1.21(.1)-neoforge" = _7TMhSuRK;
        "pkg-1.0.1-1.21(.1)-neoforge" = _jXSYKjpP;
        "pkg-1.0.0-1.21(.1)-fabric" = _OmIFPkOl;
        "pkg-1.0.1-1.21(.1)-fabric" = _iFS9Q6tP;
        "default" = _iFS9Q6tP;
    });
