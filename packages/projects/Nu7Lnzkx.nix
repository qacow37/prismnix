...
let
    ...
    in {
        ...
        "pkg-2.2.1" = _eCXwR20V;
        "pkg-2.2.2" = _nUUfuUFo;
        "pkg-1.15.2-4.0.0-Beta4" = _yqqRkRmQ;
        "pkg-2.2.3" = _ZUszSIFM;
        "pkg-2.2.4" = _8prYmEGH;
        "pkg-2.2.5" = _FOsX4NHa;
        "pkg-1.15.2-4.0.0-Beta7" = _y2IxR3Rj;
        "pkg-2.3.0.Beta1" = _mM9cs3jX;
        "pkg-2.3.0RC1" = _3Hkilx2S;
        "pkg-2.3.0RC2" = _G7CQYPWQ;
        "pkg-2.3.0" = _ioqVGCQU;
        "pkg-2.3.1" = _5wt1VH3q;
        "pkg-2.3.2" = _83y24uOg;
        "pkg-1.15.2-4.1.0-Beta1" = _E5vD35Tg;
        "pkg-2.3.4beta1" = _LnKuEzEq;
        "pkg-1.15.2-4.1.0-Beta2" = _bi4rYKFH;
        "pkg-2.3.4beta2" = _8z5B1On7;
        "pkg-1.15.2-4.1.0-Beta3" = _CRf1PJjh;
        "pkg-2.3.6" = _ibKwKkk9;
        "pkg-1.15.2-4.1.1" = _5uyYiXNe;
        "pkg-2.3.7" = _fFn23qwd;
        "pkg-2.3.8" = _ttU2nipK;
        "pkg-1.15.2-4.1.3" = _rNW6Kdhb;
        "pkg-2.3.9" = _ac7w4gGd;
        "pkg-1.15.2-4.1.4" = _qY041MlN;
        "pkg-1.15.2-4.1.5" = _yokh8sfh;
        "pkg-2.4.0" = _NzFlnzjq;
        "pkg-2.4.1" = _kmmlBtff;
        "pkg-2.4.2" = _SM562aGf;
        "pkg-2.4.4RC1" = _AFb2WeKa;
        "pkg-2.4.5" = _arHI47DI;
        "pkg-1.16.5-5.0.0Alpha6" = _LkDHMvVV;
        "pkg-1.16.5-5.0.1" = _4eTCOInb;
        "pkg-1.16.5-5.0.2" = _UwEqH7zq;
        "pkg-1.16.5-5.0.5" = _79PhCAkv;
        "pkg-1.16.5-5.1.0" = _vLl6ZGy0;
        "pkg-1.16.5-5.1.1" = _aAorI4eC;
        "pkg-1.16.5-5.1.2" = _y79ry3mZ;
        "pkg-1.18-5.2.0" = _xD6S4JEG;
        "pkg-6.0.15" = _Jnh0plKU;
        "pkg-6.0.16" = _y5r9k7bm;
        "pkg-6.0.18" = _g2UspXqA;
        "pkg-6.1.0" = _PVhktw76;
        "pkg-6.1.1" = _QmPez96j;
        "pkg-6.1.2" = _npPPyje8;
        "pkg-2.4.6" = _qxJX4CKY;
