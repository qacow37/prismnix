...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.12.2-forge" = _tNPVp1BG;
        "pkg-0.1.0+1.16.5-fabric" = _5mrfwKPw;
        "pkg-0.1.0+1.16.5-forge" = _I7MVzwZI;
        "pkg-0.1.0+1.17.1-fabric" = _sM6BKvbS;
        "pkg-0.1.0+1.17.1-forge" = _SR3hbVIo;
        "pkg-0.1.0+1.18.2-fabric" = _QbliWeig;
        "pkg-0.1.0+1.18.2-forge" = _Jf6VzCWH;
        "pkg-0.1.0+1.19.2-fabric" = _9sCnVKEN;
        "pkg-0.1.0+1.19.2-forge" = _XVFctHYH;
        "pkg-0.1.0+1.19.4-fabric" = _zSgU0ual;
        "pkg-0.1.0+1.19.4-forge" = _r7ELYF15;
        "pkg-0.1.0+1.20.1-fabric" = _F5nzbxWO;
        "pkg-0.1.0+1.20.1-forge" = _p895dFyo;
        "pkg-0.1.0+1.20.2-fabric" = _W8dVWt3T;
        "pkg-0.1.0+1.20.2-forge" = _GAnoQBCo;
        "pkg-0.1.0+1.20.2-neoforge" = _euDu5oGi;
        "pkg-0.1.0+1.20.4-fabric" = _mFQsXfHi;
        "pkg-0.1.0+1.20.4-forge" = _7Dnb13Ur;
        "pkg-0.1.0+1.20.4-neoforge" = _ONh64yun;
        "pkg-0.1.0+1.20.6-fabric" = _B6bIgRUi;
        "pkg-0.1.0+1.20.6-neoforge" = _gO2C8rwU;
        "pkg-0.1.0+1.21-fabric" = _GCtgWMcq;
        "pkg-0.1.0+1.21-neoforge" = _uESefHbX;
        "pkg-0.1.0+1.8.9-forge" = _evnZ0ex0;
        "pkg-0.1.1+1.12.2-forge" = _xE28bM6n;
        "pkg-0.1.1+1.16.5-fabric" = _CwzsorVv;
        "pkg-0.1.1+1.16.5-forge" = _io7PmCsS;
        "pkg-0.1.1+1.17.1-fabric" = _Q2iFUjYM;
        "pkg-0.1.1+1.17.1-forge" = _hzDgJj5L;
        "pkg-0.1.1+1.18.2-fabric" = _jaFw53H4;
        "pkg-0.1.1+1.18.2-forge" = _6oGu1nzI;
        "pkg-0.1.1+1.19.2-fabric" = _NjUe64zy;
        "pkg-0.1.1+1.19.2-forge" = _etYsTXYK;
        "pkg-0.1.1+1.19.4-fabric" = _vzsj0RQr;
        "pkg-0.1.1+1.19.4-forge" = _li7a4KRs;
        "pkg-0.1.1+1.20.1-fabric" = _D0NkRzLa;
        "pkg-0.1.1+1.20.1-forge" = _jXOit9Md;
        "pkg-0.1.1+1.20.2-fabric" = _CMnv0FzI;
        "pkg-0.1.1+1.20.2-forge" = _uqnoiIFV;
        "pkg-0.1.1+1.20.2-neoforge" = _DXLJeWAs;
        "pkg-0.1.1+1.20.4-fabric" = _lOqIbvh7;
        "pkg-0.1.1+1.20.4-forge" = _Pw5RGSnk;
        "pkg-0.1.1+1.20.4-neoforge" = _pzdpobVc;
        "pkg-0.1.1+1.20.6-fabric" = _A5EGEuwa;
        "pkg-0.1.1+1.20.6-neoforge" = _Qrvyri7f;
        "pkg-0.1.1+1.21-fabric" = _jRGAI3Av;
        "pkg-0.1.1+1.21-neoforge" = _z12uaiMy;
        "pkg-0.1.1+1.8.9-forge" = _TwHr8yLU;
        "pkg-0.3.0+1.12.2-fabric" = _3GmrrjxV;
        "pkg-0.3.0+1.12.2-forge" = _Gl2bRxsb;
        "pkg-0.3.0+1.16.5-fabric" = _ySlsjQC1;
        "pkg-0.3.0+1.16.5-forge" = _3NwgqPP7;
        "pkg-0.3.0+1.17.1-fabric" = _DdCebqpv;
        "pkg-0.3.0+1.17.1-forge" = _XpIHwq1m;
        "pkg-0.3.0+1.18.2-fabric" = _J3FHcL8h;
        "pkg-0.3.0+1.18.2-forge" = _fVtrjPuu;
        "pkg-0.3.0+1.19.2-fabric" = _zt7Kf7Oy;
        "pkg-0.3.0+1.19.2-forge" = _gPeDICQm;
        "pkg-0.3.0+1.19.4-fabric" = _HrphYi5j;
        "pkg-0.3.0+1.19.4-forge" = _jxaaEEFV;
        "pkg-0.3.0+1.20.1-fabric" = _7T3nqA2J;
        "pkg-0.3.0+1.20.1-forge" = _XJIXSttH;
        "pkg-0.3.0+1.20.4-fabric" = _Ki64sZkq;
        "pkg-0.3.0+1.20.4-forge" = _W3kIGM5S;
        "pkg-0.3.0+1.20.4-neoforge" = _a3aCSqoE;
        "pkg-0.3.0+1.20.6-fabric" = _3ekBZUMY;
        "pkg-0.3.0+1.20.6-neoforge" = _qXGxF4zr;
        "pkg-0.3.0+1.21.1-fabric" = _W8MAh6Zo;
        "pkg-0.3.0+1.21.1-neoforge" = _cN0T2FKe;
        "pkg-0.3.0+1.21.2-fabric" = _CXJGYKi1;
        "pkg-0.3.0+1.21.2-neoforge" = _xzFygcxQ;
        "pkg-0.3.0+1.21.3-fabric" = _7xEQJYWh;
        "pkg-0.3.0+1.21.3-neoforge" = _9b03n79H;
        "pkg-0.3.0+1.21.4-fabric" = _dHnICmII;
        "pkg-0.3.0+1.21.4-neoforge" = _tXCDomxm;
        "pkg-0.3.0+1.8.9-fabric" = _sr4an9Ib;
        "pkg-0.3.0+1.8.9-forge" = _5qJ4i1Lc;
        "pkg-0.3.1+1.12.2-fabric" = _8rm3SQfW;
        "pkg-0.3.1+1.12.2-forge" = _rc4CmQHA;
        "pkg-0.3.1+1.16.5-fabric" = _G7tGnsAx;
        "pkg-0.3.1+1.16.5-forge" = _x4wEY3qS;
        "pkg-0.3.1+1.17.1-fabric" = _NIPDrSNa;
        "pkg-0.3.1+1.17.1-forge" = _PPLVDyfg;
        "pkg-0.3.1+1.18.2-fabric" = _J9lXpBjb;
        "pkg-0.3.1+1.18.2-forge" = _fFCz4Fik;
        "pkg-0.3.1+1.19.2-fabric" = _bligEn2u;
        "pkg-0.3.1+1.19.2-forge" = _zrx3Zh6l;
        "pkg-0.3.1+1.19.4-fabric" = _E7YAUMoK;
        "pkg-0.3.1+1.19.4-forge" = _xhSU8B4D;
        "pkg-0.3.1+1.20.1-fabric" = _syv9J3SD;
        "pkg-0.3.1+1.20.1-forge" = _szECII5Z;
        "pkg-0.3.1+1.20.4-fabric" = _MyZL3ipN;
        "pkg-0.3.1+1.20.4-forge" = _2yjgIE2C;
        "pkg-0.3.1+1.20.4-neoforge" = _sU7paTuT;
        "pkg-0.3.1+1.20.6-fabric" = _dcFKsEot;
        "pkg-0.3.1+1.20.6-neoforge" = _mXYi5dmt;
        "pkg-0.3.1+1.21.1-fabric" = _quMuxszz;
        "pkg-0.3.1+1.21.1-neoforge" = _AVS2yG5U;
        "pkg-0.3.1+1.21.2-fabric" = _Wv9wJr13;
        "pkg-0.3.1+1.21.2-neoforge" = _E6MBpzro;
        "pkg-0.3.1+1.21.3-fabric" = _G6impMM6;
        "pkg-0.3.1+1.21.3-neoforge" = _KSAHS4Bl;
        "pkg-0.3.1+1.21.4-fabric" = _mFxIZzWW;
        "pkg-0.3.1+1.21.4-neoforge" = _Wasm8gOg;
        "pkg-0.3.1+1.8.9-fabric" = _Hd4OoM46;
        "pkg-0.3.1+1.8.9-forge" = _6TG7qXoi;
        "pkg-0.4.0+1.12.2-fabric" = _ooS2JwfJ;
        "pkg-0.4.0+1.12.2-forge" = _VoPOHfU4;
        "pkg-0.4.0+1.16.5-fabric" = _qB7PCLNZ;
        "pkg-0.4.0+1.16.5-forge" = _k6awwkxa;
        "pkg-0.4.0+1.17.1-fabric" = _ch8JbGS4;
        "pkg-0.4.0+1.17.1-forge" = _2VRF0pSU;
        "pkg-0.4.0+1.18.2-fabric" = _ubzL18bV;
        "pkg-0.4.0+1.18.2-forge" = _dXP9W6z0;
        "pkg-0.4.0+1.19.2-fabric" = _p0Gi5Em8;
        "pkg-0.4.0+1.19.2-forge" = _UQrDK0RD;
        "pkg-0.4.0+1.19.4-fabric" = _fWt1Vqvu;
        "pkg-0.4.0+1.19.4-forge" = _uujcOnfv;
        "pkg-0.4.0+1.20.1-fabric" = _kPpkE7KT;
        "pkg-0.4.0+1.20.1-forge" = _7p7S59N3;
        "pkg-0.4.0+1.20.4-fabric" = _wj4J8w9l;
        "pkg-0.4.0+1.20.4-forge" = _w0KOfHV5;
        "pkg-0.4.0+1.20.4-neoforge" = _rxnRFSlN;
        "pkg-0.4.0+1.20.6-fabric" = _IjP6pRQK;
        "pkg-0.4.0+1.20.6-neoforge" = _fclPcFGO;
        "pkg-0.4.0+1.21.1-fabric" = _jQiCO1pG;
        "pkg-0.4.0+1.21.1-neoforge" = _8rHKsIqm;
        "pkg-0.4.0+1.21.2-fabric" = _gPmwAu9a;
        "pkg-0.4.0+1.21.2-neoforge" = _hRohYqci;
        "pkg-0.4.0+1.21.3-fabric" = _ute1VibE;
        "pkg-0.4.0+1.21.3-neoforge" = _arqiKcNX;
        "pkg-0.4.0+1.21.4-fabric" = _uKepl8RH;
        "pkg-0.4.0+1.21.4-neoforge" = _17BWb98w;
        "pkg-0.4.0+1.8.9-fabric" = _aGE7twhd;
        "pkg-0.4.0+1.8.9-forge" = _XpT3fqmq;
        "default" = _XpT3fqmq;
    });
