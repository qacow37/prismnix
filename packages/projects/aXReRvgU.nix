...
let
    ...
    in {
        ...
        "pkg-1.19.0-fabric-1.0.0" = _qfXke6MD;
        "pkg-1.18-fabric-1.0.2" = _bcNJuGoU;
        "pkg-1.17.1-fabric-1.0.2" = _rpSjc3AQ;
        "pkg-1.16.5-fabric-1.0.2" = _X0D313GT;
        "pkg-1.12.2-forge-1.0.2" = _SOJRZK0C;
        "pkg-1.8.9-forge-1.0.2" = _C1brJyKK;
        "pkg-1.8.9-fabric-1.0.2" = _HA1ZVHPd;
        "pkg-1.17.1-forge-1.0.0" = _Jt7NxCdF;
        "pkg-1.16.5-forge-1.0.0" = _hKb4hR4b;
        "pkg-1.18-forge-1.0.0" = _ilV7uaMn;
        "pkg-1.19-forge-1.0.0" = _BWjR2Gsg;
        "pkg-1.20-fabric-1.0.0" = _YW0YiKah;
        "pkg-1.20-forge-1.0.0" = _mhWe3rxI;
        "pkg-1.21-neoforge-1.0.0" = _HmNhCkUx;
        "pkg-1.21-fabric-1.0.0" = _BRPwGTRu;
        "pkg-1.20-forge-1.0.1" = _kra98POb;
        "pkg-1.21-neoforge-1.0.1" = _Gb0f41Fx;
        "pkg-1.21.9-fabric-1.0.0" = _oz3IIZZa;
        "pkg-1.21.9-neoforge-1.0.0" = _LONwjP2l;
        "pkg-1.21.11-neoforge-1.0.0" = _zOga5QeM;
        "pkg-1.20-neoforge-1.0.1" = _kspYAuQT;
        "pkg-1.8.9-forge-1.0.3" = _wrXBdoQ8;
        "pkg-1.8.9-fabric-1.0.3" = _cL90eVsQ;
        "pkg-1.12.2-forge-1.0.3" = _gt2CoyDy;
        "pkg-26.1-fabric-1.0.0" = _Y41YRybk;
        "pkg-26.1-neoforge-1.0.0" = _OEQs7mFy;
        "pkg-1.10.2-forge-1.0.0" = _x4b0Q562;
        "pkg-1.7.10-forge-1.0.0" = _1RPxFnmK;
        "default" = _1RPxFnmK;
    });
