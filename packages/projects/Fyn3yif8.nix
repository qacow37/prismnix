...
let
    ...
    in {
        ...
        "pkg-1.19.2-5" = _g0mHpzAa;
        "pkg-1.19.1-4" = _9isI24qC;
        "pkg-1.19-3" = _Dmnq3Xue;
        "pkg-1.18.2-2" = _AIIeW2KE;
        "pkg-1.18.1-1" = _wIygwiUm;
        "pkg-1.19.3-5" = _ziRI3pGL;
        "pkg-1.19.4-5" = _vI3V6ZRn;
        "pkg-1.18.1-6-fabric" = _6eQN6M1G;
        "pkg-1.18.2-6-fabric" = _lo8YWi2o;
        "pkg-1.19-6-fabric" = _MoOhaQCC;
        "pkg-1.19.1-6-fabric" = _As2gaVFb;
        "pkg-1.19.2-6-fabric" = _S70aPkcx;
        "pkg-1.19.3-6-fabric" = _Llnl0z3M;
        "pkg-1.19.4-5-fabric" = _CpMaH8KZ;
        "pkg-1.20-6-fabric" = _uJCFzJO6;
        "pkg-1.20.1-6-fabric" = _zaW5MOC0;
        "pkg-1.20.2-6-fabric" = _HQFqNElF;
        "pkg-1.18.1-7-fabric" = _dNVdaOZ2;
        "pkg-1.18.2-7-fabric" = _pphsuNaR;
        "pkg-1.19-7-fabric" = _Upq2s4e6;
        "pkg-1.19.1-7-fabric" = _ldzie0hL;
        "pkg-1.19.2-7-fabric" = _chPElP9x;
        "pkg-1.19.3-7-fabric" = _HFYFgCp0;
        "pkg-1.19.4-7-fabric" = _O4ITxqer;
        "pkg-1.20-7-fabric" = _JBflA5Eo;
        "pkg-1.20.1-7-fabric" = _3Uz8gwlc;
        "pkg-1.20.2-7-fabric" = _Wdohq0mP;
        "pkg-1.20.3-7-fabric" = _yeci8WDj;
        "pkg-1.20.4-7-fabric" = _xxhnfNBi;
        "pkg-1.20.5-7-fabric" = _wkoHxHPN;
        "pkg-1.20.6-7-fabric" = _WxtnEYC6;
        "default" = _WxtnEYC6;
    });
