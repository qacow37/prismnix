...
let
    ...
    in {
        ...
        "pkg-0.1.1" = _zQQSASMz;
        "pkg-0.2.0+1.20.1" = _6jx2mvO9;
        "pkg-0.2.0+1.20.4" = _y9g3nP1r;
        "pkg-0.2.0+1.20.6" = _TJnd7wVJ;
        "pkg-0.2.0+1.21.1" = _AF8BDRmL;
        "pkg-0.2.0+1.21.4" = _6s6wxgfp;
        "pkg-0.2.0+1.21.5" = _U63gzReq;
        "pkg-0.2.1+1.20.1" = _jerp8hPT;
        "pkg-0.2.1+1.20.4" = _ThVigjCj;
        "pkg-0.2.1+1.20.6" = _ERIKL9Sx;
        "pkg-0.2.1+1.21.1" = _CzFg8Rfo;
        "pkg-0.2.1+1.21.4" = _1eDMrAkh;
        "pkg-0.2.1+1.21.5" = _rRWxY80A;
        "pkg-0.2.1+1.21.6" = _zmfgQMgC;
        "pkg-0.2.2+1.20.1" = _IQbEOYMF;
        "pkg-0.2.2+1.20.4" = _6JBQJtCu;
        "pkg-0.2.2+1.20.6" = _m4yjUqSj;
        "pkg-0.2.2+1.21" = _s5lbprvj;
        "pkg-0.2.3+1.20.1" = _U7iZGrnL;
        "pkg-0.2.3+1.20.4" = _y7CgobVQ;
        "pkg-0.2.3+1.20.6" = _jgdOLglc;
        "pkg-0.2.3+1.21" = _fJxmq6Cs;
        "pkg-0.2.4+1.20.1" = _LrvKwx7J;
        "pkg-0.2.4+1.20.4" = _mDUxmxkq;
        "pkg-0.2.4+1.20.6" = _e35yMgsU;
        "pkg-0.2.4+1.21" = _BAAQMXWP;
        "pkg-0.2.4+26.1" = _LqEKJKVP;
        "default" = _LqEKJKVP;
    });
