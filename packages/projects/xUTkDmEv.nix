...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _NaX3tkJv;
        "pkg-1.1.0" = _gdmQSCqv;
        "pkg-2.0.0-1.20" = _88JsJEPJ;
        "pkg-2.0.0-1.20.1" = _AT5vcUb5;
        "pkg-2.0.0-1.20.2" = _n96x2m7p;
        "pkg-2.0.0-1.20.4" = _QpxNS2am;
        "pkg-2.0.1-1.20" = _TCnAbwlh;
        "pkg-2.0.1-1.20.1" = _9nE26BOG;
        "pkg-2.0.1-1.20.2" = _ZWZ4QWxD;
        "pkg-2.0.1-1.20.4" = _7hHuPuil;
        "pkg-2.1.0-1.20" = _rh7fH8Cz;
        "pkg-2.1.0-1.20.1" = _qnDL2g01;
        "pkg-2.1.0-1.20.2" = _tPT0UcSf;
        "pkg-2.1.0-1.20.4" = _ciix7F5J;
        "pkg-2.2.0-1.20" = _3WEmd3q0;
        "pkg-2.2.0-1.20.1" = _KZ9Ra2JP;
        "pkg-2.2.0-1.20.2" = _myplDJ7P;
        "pkg-2.2.0-1.20.4" = _G4zCEaPd;
        "pkg-2.3.0-1.20" = _JHxt03gK;
        "pkg-2.3.0-1.20.1" = _8oHMFnbe;
        "pkg-2.3.0-1.20.2" = _TI6fSpYJ;
        "pkg-2.3.0-1.20.4" = _ngVB4OqB;
        "pkg-2.3.1-1.20" = _Ov2rbaun;
        "pkg-2.3.1-1.20.1" = _7v32iici;
        "pkg-2.3.1-1.20.2" = _gyB05IR0;
        "pkg-2.3.1-1.20.4" = _MUSOilxS;
        "pkg-2.3.1-1.20.6" = _RQFVVCFg;
        "pkg-2.4.0-1.20.1" = _XM7x0sf0;
        "pkg-2.4.0-1.20.4" = _21ANORjs;
        "pkg-2.4.0-1.20.6" = _YAigcSyk;
        "pkg-2.4.1-1.20.6" = _qxcZjd7R;
        "pkg-2.4.2-1.20.6" = _13FKPFJl;
        "pkg-2.4.2-1.21" = _CQjdDfCV;
        "pkg-2.5-1.20.1" = _7Pxlbgz6;
        "pkg-2.5-1.20.4" = _3B0dzK3K;
        "pkg-2.5-1.20.6" = _qdO6Jfb0;
        "pkg-2.5-1.21" = _6lliH3RY;
        "pkg-2.5.1-1.20.1" = _xkj8TtZC;
        "pkg-2.5.1-1.20.4" = _1InX8ZSt;
        "pkg-2.5.1-1.20.6" = _tqQaOe8q;
        "pkg-2.5.1-1.21" = _XAqdSgJh;
        "pkg-2.5.1-1.21.1" = _4Wzmguxz;
        "pkg-2.5.2-1.20.1" = _ko4ugzx1;
        "pkg-2.5.2-1.20.4" = _BFkzsAQQ;
        "pkg-2.5.2-1.20.6" = _ObfVfthf;
        "pkg-2.5.2-1.21.1" = _sgvsVS0B;
        "pkg-2.5.3-1.20.1" = _1hWPZR0w;
        "pkg-2.5.3-1.20.4" = _L4aw5OhJ;
        "pkg-2.5.3-1.20.6" = _PBZkYxm1;
        "pkg-2.5.3-1.21.1" = _6oqSqE7X;
        "pkg-2.5.3-1.21.3" = _PkaztUDW;
        "pkg-1.21.4-2.5.3" = _z3MKOWpp;
        "pkg-1.21.3-3.0.1" = _EWnmA0Ql;
        "pkg-1.21.4-3.0.1" = _yDSzXvzQ;
        "pkg-1.21.5-3.0.1" = _oN9vNArz;
        "pkg-1.21.8-4.0" = _qmNUkdrD;
        "pkg-1.21.8-4.0.1" = _Mu1lKpUo;
        "pkg-1.21.10-4.0.1" = _E9Ybmbvx;
        "pkg-1.21.11-4.0.2" = _AlBVMO9F;
        "default" = _AlBVMO9F;
    });
