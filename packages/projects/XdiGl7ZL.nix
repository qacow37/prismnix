...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.5-fabric" = _kr2udK7q;
        "pkg-1.18.2-1.5-fabric" = _f6bYqipX;
        "pkg-1.19.2-1.6-fabric" = _lYHGpPga;
        "pkg-1.16.5-1.1-forge" = _j9mYzJMs;
        "pkg-1.18.2-1.2-forge" = _d3pTVaPA;
        "pkg-1.19.2-1.4-forge" = _mkZLhMda;
        "pkg-1.16.5-1.7-fabric" = _KmgAPtDV;
        "pkg-1.18.2-1.7-fabric" = _sQWouPdE;
        "pkg-1.19.2-1.7-fabric" = _VlT4FU1o;
        "pkg-1.19.3-1.8-fabric" = _Y5GtpbLy;
        "pkg-1.19.3-1.4-forge" = _VLlZQkSU;
        "pkg-1.18.2-2.0-forge+fabric" = _Vg1WFgC8;
        "pkg-1.19.2-2.0-forge+fabric" = _WYUAJW5J;
        "pkg-1.19.3-2.0-forge+fabric" = _jdZu0pcK;
        "pkg-1.18.2-2.1-forge+fabric" = _9mv3mwa0;
        "pkg-1.19.2-2.1-forge+fabric" = _f75udDMh;
        "pkg-1.19.3-2.1-forge+fabric" = _xQLsU20g;
        "pkg-1.19.4-2.1-forge+fabric" = _RFHh9QbF;
        "pkg-1.20-2.1-forge+fabric" = _Ggz2gEKF;
        "pkg-1.20.1-2.1-forge+fabric" = _Qv0IdZEt;
        "pkg-1.18.2-2.2-forge+fabric" = _BT7fJz5T;
        "pkg-1.19.2-2.2-forge+fabric" = _SxaCZMoB;
        "pkg-1.19.4-2.2-forge+fabric" = _R3P6ckZ7;
        "pkg-1.20.1-2.2-forge+fabric" = _puoEWa6Y;
        "pkg-1.18.2-2.3-forge+fabric" = _G38qFsO0;
        "pkg-1.19.2-2.3-forge+fabric" = _1xks7svo;
        "pkg-1.19.4-2.3-forge+fabric" = _xBbDfuGb;
        "pkg-1.20.1-2.3-forge+fabric" = _hqVgkw1I;
        "pkg-1.20.2-2.3-forge+fabric" = _sqS34IaN;
        "pkg-1.18.2-2.4-forge+fabric" = _juFjGpQO;
        "pkg-1.19.2-2.4-forge+fabric" = _sd5bdPvh;
        "pkg-1.20.1-2.4-forge+fabric" = _bnudVzaO;
        "pkg-1.20.2-2.4-forge+fabric" = _MF3ZRv1n;
        "pkg-1.20.3-2.4-fabric+forge+neo" = _YX750YDh;
        "pkg-1.20.4-2.4-fabric+forge+neo" = _CKXNJ1Wk;
        "pkg-1.19.2-2.5-fabric+forge+neo" = _tcCBugKh;
        "pkg-1.20.1-2.5-fabric+forge+neo" = _rZuiSYtu;
        "pkg-1.20.2-2.5-fabric+forge+neo" = _cR4yzk71;
        "pkg-1.20.4-2.5-fabric+forge+neo" = _kM59hnpT;
        "pkg-1.19.2-2.6-fabric+forge" = _F7aDqeyY;
        "pkg-1.20.1-2.6-fabric+forge+neo" = _l4ff1td7;
        "pkg-1.20.4-2.6-fabric+forge+neo" = _Zn5CP345;
        "pkg-1.20.5-2.6-fabric+neo" = _mqHKhefg;
        "pkg-1.20.6-2.6-fabric+forge+neo" = _fQVEtQFZ;
        "pkg-1.21.0-2.6-fabric+forge+neo" = _L9mF96Bz;
        "pkg-1.20.1-2.7-fabric+forge+neo" = _5WqQwFiT;
        "pkg-1.20.6-2.7-fabric+forge+neo" = _tjvH1aQF;
        "pkg-1.21.0-2.7-fabric+forge+neo" = _wxVSsMqO;
        "pkg-1.21.1-2.7-fabric+forge+neo" = _us1uhLvj;
        "pkg-1.21.2-2.7-fabric+neo" = _zSgjuV9H;
        "pkg-1.21.3-2.7-fabric+forge+neo" = _1G2Anj30;
        "pkg-1.21.4-2.7-fabric+forge+neo" = _TivaOLr7;
        "pkg-1.20.1-2.8-fabric+forge+neo" = _XFe3hXob;
        "pkg-1.21.1-2.8-fabric+forge+neo" = _pWrEKMmV;
        "pkg-1.21.4-2.8-fabric+forge+neo" = _JBHidcCQ;
        "pkg-1.21.5-2.8-fabric+forge+neo" = _O6D1RDAG;
        "pkg-1.21.6-2.8-fabric+forge+neo" = _BnPnhpG4;
        "pkg-1.21.7-2.8-fabric+forge+neo" = _bKa5wzYR;
        "pkg-1.21.8-2.8-fabric+forge+neo" = _xDf1o80Y;
        "pkg-1.21.9-2.8-fabric+forge+neo" = _5T61ZSl7;
        "pkg-1.21.10-2.8-fabric+forge+neo" = _wsVoSuD9;
        "pkg-1.21.11-2.8-fabric+forge+neo" = _OIqmkkly;
        "pkg-26.1.0-2.8-fabric+forge+neo" = _iOP6fgvA;
        "pkg-26.1.1-2.8-fabric+forge+neo" = _6bMjBWJq;
        "pkg-26.1.2-2.8-fabric+forge+neo" = _Yyy6FjPi;
        "pkg-1.20.1-2.9-fabric+forge+neo" = _sXLxdWNf;
        "pkg-1.21.1-2.9-fabric+forge+neo" = _zIPcy87u;
        "pkg-1.21.11-2.9-fabric+forge+neo" = _Uo0h0wud;
        "pkg-26.1.2-2.9-fabric+forge+neo" = _QI0rNSae;
        "pkg-26.2.0-2.9-fabric+forge+neo" = _C1XTh9aZ;
        "default" = _C1XTh9aZ;
    });
