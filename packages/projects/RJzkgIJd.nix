...
let
    ...
    in {
        ...
        "pkg-version1" = _wk76d3au;
        "pkg-version1.1" = _D9qMQRsF;
        "pkg-version1.2" = _mas4hNBW;
        "pkg-version1.3" = _eeOfJAJX;
        "pkg-version1.4" = _eDtHp8Le;
        "pkg-version1.5" = _e3GGqFih;
        "pkg-version1.6" = _c5619uuY;
        "pkg-version1.7" = _sOdtyvOq;
        "pkg-version1.8" = _JN2kitzP;
        "pkg-version1.9" = _jhSL0LTr;
        "pkg-version1.10" = _S9Os7a7B;
        "pkg-version1.11" = _x3YHrrz6;
        "pkg-version1.12" = _rsUkaytV;
        "pkg-2.0" = _TWyXIu9C;
        "pkg-2.1" = _YBc7cSHI;
        "pkg-2.2" = _pRPwDjyb;
        "pkg-2.3" = _ythXPrkY;
