...
let
    ...
    in {
        ...
        "pkg-1.12.2-6.0" = _LaPwPohM;
        "pkg-1.16.5-6.0" = _pGETLErx;
        "pkg-1.18.2-6.0" = _azYHsPuE;
        "pkg-1.19.2-6.0" = _uotwUTqg;
        "pkg-1.18.2-fabric-6.0" = _bGcu8PsY;
        "pkg-1.19.2-fabric-6.0" = _ufkq3bOu;
        "pkg-1.12.2-6.1" = _83VC110L;
        "pkg-1.16.5-6.1" = _1rZ7WdmZ;
        "pkg-1.18.2-6.1" = _rAU0zXhI;
        "pkg-1.19.2-6.1" = _24r7AH39;
        "pkg-1.18.2-fabric-6.1" = _fhruWug9;
        "pkg-1.19.2-fabric-6.1" = _EFb0Rl0a;
        "pkg-1.12.2-6.2" = _uiekWkVN;
        "pkg-1.16.5-6.2" = _tiJIRFcW;
        "pkg-1.18.2-6.2" = _6GGMMzjf;
        "pkg-1.19.2-6.2" = _hvwQC5EB;
        "pkg-1.18.2-fabric-6.2" = _gJa4LbNW;
        "pkg-1.19.2-fabric-6.2" = _JHZeDyoC;
        "pkg-1.12.2-6.3" = _lQM4dz8r;
        "pkg-1.16.5-6.3" = _IbuWitjp;
        "pkg-1.18.2-6.3" = _pmUVbzbY;
        "pkg-1.19.2-6.3" = _9OGmKXMy;
        "pkg-1.18.2-fabric-6.3" = _vocHX8Ct;
        "pkg-1.19.2-fabric-6.3" = _EIdltWrv;
        "pkg-1.12.2-6.3.1" = _VKijDJJj;
        "pkg-1.16.5-6.3.1" = _UIgBIoRn;
        "pkg-1.18.2-6.3.1" = _ohP3Q3HP;
        "pkg-1.19.2-6.3.1" = _x0IEQMjC;
        "pkg-1.18.2-fabric-6.3.1" = _1fq2BcKQ;
        "pkg-1.19.2-fabric-6.3.1" = _lwdnAPeu;
        "pkg-7.0.0" = _tmbqhL4J;
        "pkg-7.0.1" = _HutZXu9g;
        "pkg-7.0.2" = _7X0l1QrP;
        "pkg-7.0.3" = _ZNAk25GM;
