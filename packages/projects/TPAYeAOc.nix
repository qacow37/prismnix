...
let
    ...
    in {
        ...
        "pkg-0.1b" = _5Hk4B8a5;
        "pkg-0.1b-1.16" = _avkmrdnS;
        "pkg-0.1.1b" = _hHP2eTD0;
        "pkg-0.1.1b-1.16" = _y6Tz19DN;
        "pkg-0.1.3" = _Kwy6OyWJ;
        "pkg-0.2.0" = _zafughz7;
        "pkg-0.2.1" = _a8xRGBIg;
        "pkg-0.1.2" = _ZSkuH3mn;
        "pkg-0.2.2" = _thKmxFTX;
        "pkg-0.2.2+1.18" = _AOQ0edOn;
        "pkg-0.2.3+1.18" = _8wzH8ivt;
        "pkg-0.2.4+1.18" = _rEiqCoIB;
        "pkg-0.2.5+1.18" = _lwe8c3rX;
        "pkg-0.2.6+1.18" = _hiRCXg45;
        "pkg-0.2.7+1.18" = _spSCFTOo;
        "pkg-0.2.8+1.18" = _vfRvLlCU;
        "pkg-0.2.9+1.18" = _eO6uUonB;
        "pkg-0.2.9+1.19" = _kC6nNbfa;
        "pkg-0.2.10+1.19" = _A3jmeepA;
        "pkg-0.2.11+1.19" = _vlidCmeD;
        "pkg-0.3.0+1.19.3" = _RrO5QPbR;
        "pkg-0.3.1+1.19.3" = _oWQcKQVO;
        "pkg-0.3.2+1.19.3" = _7leIrcSH;
        "pkg-0.3.2+1.19.4" = _pSACQOYr;
        "pkg-0.3.2+1.20" = _V0Hz3q2W;
        "pkg-0.3.2+1.20.2" = _iyH37xsn;
        "pkg-0.3.2+1.20.3" = _CWNevmPz;
        "pkg-0.4.0+1.21" = _kzo0m0Wn;
        "pkg-0.4.1+1.21" = _lGjkPimB;
        "pkg-0.4.1+1.21.2" = _8W0ZsQ3h;
        "default" = _8W0ZsQ3h;
    });
