...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _q6h5YRIp;
        "pkg-1.0.0+mod" = _BTFeD4hC;
        "pkg-1.0.1" = _NCHwQgff;
        "pkg-1.0.1+mod" = _Bq69CyS2;
        "pkg-1.0.1a" = _nk0GxBIA;
        "pkg-1.0.1a+mod" = _aTS9qbQh;
        "pkg-1.0.1b" = _hGZ5IWji;
        "pkg-1.0.1b+mod" = _gwa2Atr1;
        "pkg-v1.1.0" = _yeXHljEt;
        "pkg-1.1.0+mod" = _jzqnt2VV;
        "pkg-1.1.0a" = _hftfsOtY;
        "pkg-1.1.0a+mod" = _idjGPflj;
        "pkg-1.1.0b" = _TNrWJqWs;
        "pkg-1.1.0b+mod" = _ICaor2G2;
        "pkg-1.1.0c" = _reTqSC7O;
        "pkg-1.1.0c+mod" = _TO1g4SDa;
        "pkg-1.1.1" = _9U2Cbspu;
        "pkg-1.1.2" = _XzfCtx40;
        "pkg-1.1.2a" = _d6wzhJha;
        "pkg-1.1.2b" = _ofBHHt77;
        "pkg-1.1.2c" = _NFfuOSPX;
        "pkg-1.1.2d" = _FBAAEUsA;
        "pkg-1.1.3" = _OegcvXrX;
        "pkg-1.1.4" = _hx2V0T5w;
        "pkg-1.1.4a" = _KQ4qKNac;
        "pkg-1.1.4b" = _9vOSLya4;
        "pkg-1.1.4c" = _KOkqCDJu;
        "pkg-1.1.4d" = _BWvn4Jtr;
        "default" = _BWvn4Jtr;
    });
