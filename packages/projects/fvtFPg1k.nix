...
let
    ...
    in {
        ...
        "pkg-1.0.0.17" = _zQu0oQVc;
        "pkg-1.0.0.16" = _d3jEE8Pc;
        "pkg-1.0.1+1.16.5" = _boSbabjE;
        "pkg-1.0.1+1.17.0" = _W7J5blvl;
        "pkg-1.0.1+1.17.1" = _jkaAt3Cs;
        "pkg-1.0.2.18" = _IjdtgJ70;
        "pkg-1.1+1.16.5" = _CXyB6xS9;
        "pkg-1.1+1.17.1" = _yVn8YX43;
        "pkg-1.1+1.18" = _Q0A0Gkay;
        "pkg-2.0-fabric-1.18.1" = _LPgTjMps;
        "pkg-2.0-forge-1.18.1" = _yU8etwlt;
        "pkg-2.1-forge-1.18.2" = _7LNEWujV;
        "pkg-1.18.2" = _q9UyNSmV;
        "pkg-2.2-fabric-1.18.2" = _zAOmTTp5;
        "pkg-2.2-forge-1.18.2" = _NzlTBw5t;
        "pkg-2.3-fabric-1.18.2" = _9ZQEwrxj;
        "pkg-2.3-forge-1.18.2" = _MmaYFX1L;
        "pkg-2.4-fabric-1.18.2" = _xVNo4TQ6;
        "pkg-2.4-forge-1.18.2" = _q2pUnIh6;
        "pkg-1.1.1-fabric-1.16.5" = _A7pMzXsx;
        "pkg-1.1.1-fabric-1.17.1" = _iB1ksYrW;
        "pkg-2.4.1-fabric-1.18.2" = _iM4Ur9oD;
        "pkg-2.4.1-forge-1.18.2" = _GDfGVfkQ;
        "pkg-2.4.1-fabric-1.19.2" = _rRmQKRlx;
        "pkg-2.4.1-forge-1.19.2" = _dvwgbTgy;
        "pkg-2.5-fabric-1.16.5" = _AWswKigy;
        "pkg-2.5-fabric-1.18.2" = _TMqhNlO3;
        "pkg-2.5-fabric-1.19.2" = _8fylF3kI;
        "pkg-2.5-fabric-1.19.4" = _m2oTSMLt;
        "pkg-2.5-forge-1.18.2" = _Xjj705TU;
        "pkg-2.5-forge-1.19.2" = _HfjNqe9v;
        "pkg-2.5-forge-1.19.4" = _9Vr2dekh;
        "pkg-2.6-fabric-1.16.5" = _Apmh2zI8;
        "pkg-2.6-fabric-1.18.2" = _aZYFBLAo;
        "pkg-2.6-fabric-1.19.2" = _cPKk8vAE;
        "pkg-2.6-fabric-1.19.4" = _pyZwbIoa;
        "pkg-2.6-forge-1.18.2" = _2GRZVJId;
        "pkg-2.6-forge-1.19.2" = _inuboEt2;
        "pkg-2.6-forge-1.19.4" = _SwPmhMKo;
        "pkg-2.7-fabric-1.16.5" = _XSD24Z7N;
        "pkg-2.7-fabric-1.18.2" = _ZeeEfKaV;
        "pkg-2.7-fabric-1.19.2" = _f0hI0mbN;
        "pkg-2.7-fabric-1.19.4" = _ct0mXNpJ;
        "pkg-2.7-fabric-1.20.0" = _K1KXzoHJ;
        "pkg-2.7-forge-1.18.2" = _fbI72jHH;
        "pkg-2.7-forge-1.19.2" = _MsO7WycG;
        "pkg-2.7-forge-1.19.4" = _KkMUo8x1;
        "pkg-2.7-forge-1.20.0" = _SuqhHfiz;
        "pkg-2.7.1-fabric-1.16.5" = _Ei2foLUx;
        "pkg-2.7.1-fabric-1.18.2" = _mnvB5ICT;
        "pkg-2.7.1-fabric-1.19.2" = _PQMSqBZ3;
        "pkg-2.7.1-fabric-1.19.4" = _VhRrUlgm;
        "pkg-2.7.1-fabric-1.20.1" = _2v7E22NN;
        "pkg-2.7.1-forge-1.18.2" = _bC8NgG9C;
        "pkg-2.7.1-forge-1.19.2" = _KjIyu2yU;
        "pkg-2.7.1-forge-1.19.4" = _OvNePgcs;
        "pkg-2.7.1-forge-1.20.1" = _Gksy3aQg;
        "pkg-2.7.1-neoforge-1.21.1" = _dYySFHgE;
        "pkg-2.7.1-fabric-1.21.1" = _wp4EAkvg;
        "pkg-2.7.2-fabric-1.20.1" = _Szwl5syc;
        "pkg-2.7.2-fabric-1.21.1" = _nxNp5LBx;
        "pkg-2.7.2-forge-1.20.1" = _aNH8jZ7p;
        "pkg-2.7.2-neoforge-1.21.1" = _rpKjoIfw;
        "default" = _rpKjoIfw;
    });
