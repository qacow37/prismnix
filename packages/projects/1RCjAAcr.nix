...
let
    ...
    in {
        ...
        "pkg-v0.2.2+1.20.2" = _E0HcKzx8;
        "pkg-v0.2.3+1.20.2" = _3mAy0Yay;
        "pkg-v0.2.4+1.20.2" = _j5dU8Ls9;
        "pkg-v0.2.4.1+1.20.2" = _IrQKhKdB;
        "pkg-v0.2.4.1.1+1.20.2" = _swaYu6Ve;
        "pkg-v0.2.4.2+1.20.2" = _hnoycC0b;
        "pkg-v0.2.5+1.20.2" = _wwWmsqKJ;
        "pkg-v0.2.6+1.20.2" = _UdziTDX1;
        "pkg-v0.4+1.21" = _RaQGoryB;
        "pkg-v0.4+1.21.1" = _DwuxdbAq;
        "pkg-v0.4.1+1.21" = _3bw33uGu;
        "pkg-v0.4.2+1.21.1" = _Mogtq3ZQ;
        "pkg-v0.4.2+1.21" = _jFiSmAnH;
        "pkg-v0.4.3+1.21.1" = _kfTwJm2J;
        "pkg-v0.4.3+1.21" = _ExDQ1x3E;
        "pkg-v0.4.4+1.21.1" = _FHkF6GiF;
        "pkg-v0.4.4+1.21" = _RIbGY5MX;
        "pkg-v0.4.4.1+1.21.1" = _wRbhPujh;
        "pkg-v0.4.4.1+1.21" = _z8Ue9hhd;
        "pkg-v0.4.4.2+1.21" = _Fhc3yje7;
        "pkg-v0.4.4.2+1.21.1" = _GyTBGCtf;
        "pkg-v0.4.4.3+1.21" = _toDFxs8j;
        "pkg-v0.4.4.3+1.21.1" = _NA7RXWHZ;
        "pkg-v0.4.4.3.1+1.21" = _BJzRNjOg;
        "pkg-v0.4.4.3.1+1.21.1" = _U4t37aCU;
        "pkg-v0.4.4.3.2+1.21.1" = _h8PY7eCb;
        "pkg-v0.4.4.3.2+1.21" = _tHumwXdW;
        "pkg-v0.4.4.3.3+1.21" = _Ghd7cXie;
        "pkg-v0.4.4.3.3+1.21.1" = _NsQOsd6D;
        "pkg-v1.0.0+1.21" = _KRNyCYKj;
        "pkg-1.0.1+1.21" = _nw0K1N8N;
        "pkg-1.0.2+1.21" = _hdell4OP;
        "pkg-1.0.2+1.21.4" = _izr9IlsG;
        "pkg-1.0.3+1.21.4" = _Moh1a9Fl;
        "pkg-1.1.0+1.21.4" = _Jl8dyXK3;
        "pkg-1.1.1+1.21.4" = _8S5JfytS;
        "pkg-1.1.2+1.21.4" = _w3lzsqKT;
        "pkg-1.1.3+1.21.4" = _zUvC1TJf;
        "pkg-1.2.0+1.21.4" = _3qdKhMU1;
        "pkg-2.0.0+1.21.4" = _Sxeliikk;
        "pkg-2.0.1+1.21.4" = _T85yVzNP;
        "pkg-2.0.2+1.21.4" = _2OohE2Lv;
        "pkg-2.0.3+1.21.4" = _ZM6ITIBc;
        "pkg-2.0.4+1.21.4" = _qoMJLRNp;
        "pkg-2.0.5+1.21.4" = _pkanoHNO;
        "pkg-2.0.6+1.21.4" = _cmKAQetE;
        "pkg-3.0.0-beta.0+1.21.11" = _PvmsqhLO;
        "pkg-3.0.0+1.21.11" = _ZBpdZ48w;
        "pkg-3.0.1+1.21.11" = _HVmOGCpD;
        "pkg-3.1.0+1.21.11" = _cavwVzub;
        "pkg-3.1.0-hotfix0+1.21.11" = _BIBy0AZs;
        "pkg-3.1.1+1.21.11" = _3FOpT2CU;
