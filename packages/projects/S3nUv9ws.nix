...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.6.1-1.8.9" = _IgevjzXt;
        "pkg-1.0.0+1.9-1.10.2" = _WnqlRqlq;
        "pkg-1.0.0+1.11-1.12.2" = _6BffoXQ8;
        "pkg-1.0.0+1.13-1.14.4" = _ZpJRXoN3;
        "pkg-1.0.0+1.15-1.15.2" = _7PxwbYad;
        "pkg-1.0.0+1.16-1.16.1" = _S6rXluvS;
        "pkg-1.0.0+1.16.2-1.16.5" = _4SkLOUNo;
        "pkg-1.0.0+1.17-1.17.1" = _PJIAksm6;
        "pkg-1.0.0+1.18-1.18.2" = _BOBbRnt0;
        "pkg-1.0.0+1.19-1.19.2" = _UsxZNj6c;
        "pkg-1.0.0+1.19.3" = _IA1t7wVT;
        "pkg-1.0.0+1.19.4" = _pjhu1IH4;
        "pkg-1.0.0+1.20" = _jfmyouq3;
        "pkg-1.1.0+1.6.1-1.8.9" = _JbVJaNmE;
        "pkg-1.1.0+1.9-1.10.2" = _AICGMNfr;
        "pkg-1.1.0+1.11-1.12.2" = _MMK9Itmo;
        "pkg-1.1.0+1.13-1.14.4" = _L9dqfdbi;
        "pkg-1.1.0+1.15-1.15.2" = _LezsMSbA;
        "pkg-1.1.0+1.16-1.16.1" = _ktQQQD3n;
        "pkg-1.1.0+1.16.2-1.16.5" = _ZVrroMb7;
        "pkg-1.1.0+1.17-1.17.1" = _NQ0BFAtF;
        "pkg-1.1.0+1.18-1.18.2" = _T9g1BkBr;
        "pkg-1.1.0+1.19-1.19.2" = _3SvYM5jU;
        "pkg-1.1.0+1.19.3" = _Uz47Tr8a;
        "pkg-1.1.0+1.19.4" = _i9SUApgd;
        "pkg-1.1.0+1.20-1.20.1" = _nmCSu1fw;
        "pkg-1.2.0+1.11-1.12.2" = _by4FkVoR;
        "pkg-1.2.0+1.13-1.14.4" = _mNaKT7jC;
        "pkg-1.2.0+1.15-1.15.2" = _ONKUGyJp;
        "pkg-1.2.0+1.16-1.16.1" = _Sj11nVGq;
        "pkg-1.2.0+1.16.2-1.16.5" = _CRqUdbVZ;
        "pkg-1.2.0+1.17-1.17.1" = _lHycabcO;
        "pkg-1.2.0+1.18-1.18.2" = _fyAL0czk;
        "pkg-1.2.0+1.19-1.19.2" = _Op8wbRh3;
        "pkg-1.2.0+1.19.3" = _8aoqHClu;
        "pkg-1.2.0+1.19.4" = _Zn6InXZT;
        "pkg-1.2.0+1.20-1.20.1" = _Ffdvu3VO;
        "pkg-1.3.0+1.6.1-1.8.9" = _RxZKo1oj;
        "pkg-1.3.0+1.9-1.10.2" = _k23Ubae8;
        "pkg-1.3.0+1.11-1.12.2" = _uEeBHvFq;
        "pkg-1.3.0+1.13-1.14.4" = _AWiOD8vY;
        "pkg-1.3.0+1.15-1.15.2" = _rdyjaxEA;
        "pkg-1.3.0+1.16-1.16.1" = _DPBAbDki;
        "pkg-1.3.0+1.16.2-1.16.5" = _HZruWsX0;
        "pkg-1.3.0+1.17-1.17.1" = _AEY7ilY4;
        "pkg-1.3.0+1.18-1.18.2" = _NSbt6unI;
        "pkg-1.3.0+1.19-1.19.2" = _9q85G4W7;
        "pkg-1.3.0+1.19.3" = _FGHKkQC9;
        "pkg-1.3.0+1.19.4" = _pRBxAeWC;
        "pkg-1.3.0+1.20-1.20.1" = _OWUPLYHf;
        "pkg-1.3.0+1.20.2" = _fN3tD1m7;
        "pkg-1.3.1+1.20.2" = _3yVOprCr;
        "pkg-1.4.0+1.20-1.20.1" = _K6WwLhuZ;
        "pkg-1.4.0+1.20.2" = _IEoaQIRR;
        "pkg-1.5.0+1.20.2" = _besqdorx;
        "pkg-1.6.0+1.20.2" = _uzrgtcJO;
        "pkg-1.7.0+1.20.2" = _JLZy6TQk;
        "pkg-1.8.0+1.20.2" = _fKdggcd9;
        "pkg-1.9.0+1.20-1.20.1" = _V1q4XG6W;
        "pkg-1.9.0+1.20.2" = _znzS3kCV;
        "default" = _znzS3kCV;
    });
