...
let
    ...
    in {
        ...
        "pkg-1.8.0" = _lLJMzSZ0;
        "pkg-1.9.0" = _RCACxrOD;
        "pkg-1.10.0" = _mTr4Xpv4;
        "pkg-1.11.0" = _tciaAVhT;
        "pkg-1.12.0" = _jNCK8cC1;
        "pkg-1.13.0" = _3uctRK8c;
        "pkg-1.14.0" = _jHCNNmsn;
        "pkg-1.15.0" = _ZOujgdMo;
        "pkg-1.16.0" = _XSbThh7M;
        "pkg-1.17.0" = _UhwLkiza;
        "pkg-1.15.1+mc1.21" = _GFE1QorU;
        "pkg-1.18.0+mc1.21.3" = _ETC4FI11;
        "pkg-2.0.0+mc1.21.3" = _xKTxlfSj;
        "pkg-2.0.1+mc1.21.4" = _MYYdwDRs;
        "pkg-2.1.0+mc1.21.4" = _n3q0WVH5;
        "pkg-2.2.0+mc1.21.4" = _Oh5oGhm2;
        "pkg-2.3.0+mc1.21.4" = _sTDlM1jO;
        "pkg-2.3.1+mc1.21.4" = _rCLBPAUE;
        "pkg-2.3.2+mc1.21.4" = _kovCdtQ8;
        "pkg-2.4.0+mc1.21.4" = _JZFkkNZ0;
        "pkg-2.4.1+mc1.21.4" = _O5bdUFSG;
        "pkg-2.4.2+mc1.21.4" = _SzwFd8DT;
        "pkg-2.5.0+mc1.21.4" = _gIAertrj;
        "pkg-2.5.0+mc1.21.5" = _kzGHpJNu;
        "pkg-2.5.1+mc1.21.5" = _WUv199YF;
        "pkg-2.6.0+mc1.21.4" = _oekpBfrl;
        "pkg-2.6.0+mc1.21.5" = _lrim407I;
        "pkg-2.7.0+mc1.21.5" = _R4KcydKe;
        "pkg-3.0.0+mc1.21.5" = _cjxJkhVy;
        "pkg-3.1.0+mc1.21.5" = _MAOpD0r5;
        "pkg-3.2.0+mc1.21.5" = _KQuAx2a6;
        "pkg-3.3.0+mc1.21.5" = _sdjfG3jV;
        "pkg-3.4.0+mc1.21.5" = _X7NMk0Vr;
        "pkg-3.5.0+mc1.21.7" = _GBCMPAmA;
        "pkg-3.7.0+mc1.21.5" = _uarX0WJ6;
        "pkg-3.8.0+mc1.21.7" = _N0ILBPJd;
        "pkg-3.7.1+mc1.21.5" = _tEDjiypt;
        "pkg-3.8.1+mc1.21.7" = _nIjTipX5;
        "pkg-3.9.0+mc1.21.7" = _fcGimGLk;
        "pkg-3.10.0+mc1.21.7" = _vIRBqB97;
        "pkg-3.10.1+mc1.21.7" = _zzI1LgBT;
        "pkg-3.10.2+mc1.21.7" = _s98rdW92;
        "pkg-3.11.0+mc1.21.7" = _elkc3NYq;
        "pkg-4.0.0+mc1.21.10" = _JCRIDEJc;
        "pkg-4.1.0+mc1.21.10" = _Y969Ntd1;
        "pkg-42.0.0+mc1.21.7" = _z7MBUxa0;
        "pkg-42.0.0+mc1.21.10" = _yJVtzuDH;
        "pkg-43.0.0+mc1.21.10" = _LTrDSXXB;
        "pkg-44.0.0+mc1.21.11" = _LTM46fmT;
        "pkg-44.1.0+mc1.21.11" = _sHz3FhOs;
        "pkg-44.0.1+mc1.21.11" = _bXane87F;
        "pkg-44.2.0+mc1.21.11" = _UStVdgbF;
        "pkg-44.3.0+mc-26.1" = _dGADU4XX;
        "pkg-44.3.0+mc26.1" = _J4SP0hOE;
        "default" = _J4SP0hOE;
    });
