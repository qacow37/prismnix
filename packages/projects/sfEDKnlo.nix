...
let
    ...
    in {
        ...
        "pkg-1.4.12" = _XTsFZAYw;
        "pkg-1.4.13" = _EVMsKruB;
        "pkg-1.4.14" = _1ouYRaE0;
        "pkg-1.4.15" = _vCwRR0sh;
        "pkg-1.4.16" = _eadNF942;
        "pkg-1.5" = _ugDloBcV;
        "pkg-1.5.1" = _gAo4PdL0;
        "pkg-1.5.2" = _B14fqsqF;
        "pkg-1.5.3" = _IT2rAWiJ;
        ...
        "pkg-1.5.8" = _iwFYNsEZ;
        "pkg-1.5.9" = _jPQL5bGk;
        "pkg-1.5.10" = _IDKevfDx;
        "pkg-1.6-beta.11" = _B4Zy7eCZ;
        "pkg-1.6-beta.12" = _To0b5RAM;
        "pkg-1.6-beta.13" = _UDTEsEe1;
        "pkg-1.6-beta.14" = _NanrzRz2;
        "pkg-1.6-beta.15" = _UCq14aRG;
        "pkg-1.6-beta.16" = _hEqk0voH;
        "pkg-1.6-beta.17" = _MTZkeq97;
        "pkg-1.4.17" = _mjWt4j9m;
        "pkg-1.5.11" = _KixkoloM;
        "pkg-1.6-beta.18" = _TxMSJ89o;
        "pkg-1.6-beta.19" = _2EWfD3PK;
        "pkg-1.6-beta.20" = _F6RpZYYV;
        "pkg-1.6-beta.21" = _mbxXqFcB;
        "pkg-1.6-beta.22" = _Gow50tG2;
        "pkg-1.6-beta.23" = _UHi1MIWU;
        "pkg-1.6-beta.24" = _30VxsmYw;
        "pkg-1.6-beta.25" = _N45MuPro;
        "pkg-1.6-beta.26" = _wZ5T1YdU;
        "default" = _wZ5T1YdU;
    });
