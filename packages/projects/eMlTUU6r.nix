...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _N4AuvR7W;
        "pkg-alpha-1.0.1" = _BTnGIrzJ;
        "pkg-alpha-1.0.3" = _Qer915O8;
        "pkg-alpha-1.0.4" = _eqWaOWrW;
        "pkg-alpha-1.1.0" = _oZegHYG9;
        "pkg-release-1.0.00" = _NZnwRWrY;
        "pkg-release-1.0.01" = _V7MRb7z8;
        "pkg-release-1.0.02" = _dgT7xT2a;
        "pkg-release-1.0.03" = _Pug1iuMU;
        "pkg-release-1.0.04" = _8CUJbzZo;
        "pkg-release-1.0.05" = _xXZIm08j;
        "pkg-release-1.1.00" = _wVPSPXYV;
        "pkg-release-1.1.01" = _WDFsDXhM;
        "pkg-release-1.1.02" = _BEMgqr5I;
        "pkg-release-1.1.03" = _UXIn8eAV;
        "pkg-release-1.1.04" = _3tvP720M;
        "pkg-1.1.05" = _oGvQBMLk;
        "pkg-1.1.10" = _cE0aTMeq;
        "pkg-1.1.11" = _d0eJr2KM;
        "pkg-release-1.2.00" = _Y7HLhFeg;
        "pkg-1.2.01" = _w1LCpbcn;
        "pkg-1.2.02" = _7L18s0se;
        "pkg-1.2.10" = _f2KlL3Vm;
        "pkg-1.2.11" = _iW4ktPV6;
        "pkg-1.2.12" = _fnQzvQMw;
        "pkg-1.2.13" = _kw2jPVBf;
        "default" = _kw2jPVBf;
    });
