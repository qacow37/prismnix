...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.6.1" = _eOjuy2Ht;
        "pkg-1.0.0-1.7.1" = _fx01gBoh;
        "pkg-1.0.1-1.6.1" = _YRCnCzaJ;
        "pkg-1.0.1-1.7.1" = _51xR9Xhy;
        "pkg-fabric-1.0.2-for-cobblemon-1.6.1" = _CzakDi02;
        "pkg-neo-1.0.2-for-cobblemon-1.6.1" = _gLWakI6M;
        "pkg-fabric-1.0.2-for-cobblemon-1.7.1" = _wKU87oUy;
        "pkg-neo-1.0.2-for-cobblemon-1.7.1" = _uzOMPQgU;
        "pkg-fabric-1.0.3-for-cobblemon-1.6.1" = _LNjYGWgL;
        "pkg-neo-1.0.3-for-cobblemon-1.6.1" = _Y9bWwTIJ;
        "pkg-neo-1.0.3-for-cobblemon-1.7.1" = _HYSz0CO1;
        "pkg-fabric-1.0.3-for-cobblemon-1.7.1" = _vUWSQ7V8;
        "pkg-fabric-1.1.0-for-cobblemon-1.6.1" = _AgdPHDVM;
        "pkg-neo-1.1.0-for-cobblemon-1.6.1" = _d0wmlKPG;
        "pkg-neo-1.1.0-for-cobblemon-1.7.3" = _jiqzNrIO;
        "pkg-fabric-1.1.0-for-cobblemon-1.7.3" = _8qDvGm8w;
        "pkg-fabric-1.1.1-for-cobblemon-1.7.3" = _PizcnKgT;
        "pkg-neo-1.1.1-for-cobblemon-1.7.3" = _g8ExYDMo;
        "pkg-fabric-1.1.2-for-cobblemon-1.7.3" = _tDDUdW42;
        "pkg-neo-1.1.2-for-cobblemon-1.7.3" = _z6QR7NSm;
        "pkg-neo-1.1.3-for-cobblemon-1.7.3" = _D5Ak4diF;
        "pkg-fabric-1.1.3-for-cobblemon-1.7.3" = _YKJzkHX1;
        "pkg-fabric-1.1.4-for-cobblemon-1.7.3" = _m8lQC8Um;
        "default" = _m8lQC8Um;
    });
