...
let
    ...
    in {
        ...
        "pkg-git-8325c8e" = _7Cm9BAKq;
        "pkg-v1.1.0" = _9aTcwuvV;
        "pkg-git-86694e3" = _Le4eyvyA;
        "pkg-v1.2.0" = _9dny8Dkx;
        "pkg-git-a0cb4f9" = _vqujOngO;
        "pkg-git-716628d" = _bqghIeLx;
        "pkg-git-9310bb4" = _1w89by2w;
        "pkg-git-1d70950" = _wjRvhz17;
        "pkg-v1.2.1" = _HRCynp0M;
        "pkg-git-741f91a" = _ZoYMQ4wt;
        "pkg-git-6c3d1ce" = _QFs2hBq6;
        "pkg-git-a414b90" = _6iyljjCv;
        "pkg-git-dd2012f" = _8pzwyyyz;
        "pkg-git-e017300" = _ZmE5brwF;
        "pkg-v1.3.0" = _eJQquWmb;
        "pkg-git-05add47" = _uzD66bQH;
        "pkg-git-95c5501" = _tXChKYLQ;
        "pkg-git-c451d41" = _pw19mD8F;
        "pkg-git-a4f5a7b" = _OX1YDJyY;
        "pkg-git-9070817" = _Bbhf7pUC;
        "pkg-git-d872f8a" = _DlxQM2Fg;
        "pkg-git-3d48396" = _MaS4W1kY;
        "pkg-git-71dcddf" = _ET1OKcHl;
        "pkg-git-4963c5c" = _sKwXtsLb;
        "pkg-git-5babaec" = _tloqcgLb;
        "pkg-git-45563d9" = _yYyvqIvx;
        "pkg-git-231bb6a" = _QWmGcase;
        "pkg-git-8a7eafc" = _pSg7yQwG;
        "pkg-git-12d45c3" = _SP19zc9x;
        "pkg-v1.4.0" = _48km0B7F;
        "pkg-git-4ce5ee6" = _rW8tujZn;
        "pkg-v1.4.1" = _NTK4LgXu;
        "pkg-git-f40f3ee" = _r7DYg1Hi;
        "pkg-git-f2dd9aa" = _jw7dMLIe;
        "pkg-v1.5.0" = _INJPAjXR;
        "pkg-git-b177fcd" = _7AIlAr6D;
        "pkg-git-a938b79" = _GB16MoKZ;
        "pkg-git-f71892a" = _MkDF6OFZ;
        "pkg-git-4a94321" = _EBYy9P3s;
        "pkg-git-fc152b0" = _IDWwSZKZ;
        "pkg-git-e584a9a" = _o22OOMZn;
        "pkg-git-f04f9ac" = _gtnRFXFw;
        "pkg-git-c18f957" = _YhwTnMM3;
        "pkg-git-6850e85" = _dIKlM8Sp;
        "pkg-git-1ea6dc8" = _QOozFQxO;
        "pkg-git-e501c82" = _2wY9SU6j;
        "pkg-v1.6.0" = _aIx2VtBO;
        "pkg-git-301bfe1" = _8kTTCVLD;
        "pkg-git-cc316af" = _kkbL1hLe;
        "pkg-git-005a4a4" = _S3HmZzjb;
        "pkg-git-8a9ef6e" = _itSfVRe6;
        "pkg-git-562a718" = _J2wsLwK0;
        "pkg-git-8f21e29" = _dhr9VhzM;
        "pkg-git-508d140" = _uzNg8BrL;
        "pkg-git-9fd9619" = _8odEofDH;
        "pkg-v1.7.0" = _6uthXxCj;
        "pkg-git-5a1a2ec" = _gh7oLFWE;
        "pkg-git-0bf7a49" = _LpIRlScz;
        "pkg-v1.8.0" = _iJWDMQDK;
        "pkg-git-f63f44b" = _KcSQM2t9;
        "pkg-git-9edc50d" = _aveziuZ6;
        "pkg-git-1a8459e" = _1fdmyHkf;
        "pkg-git-d148dc1" = _FcofHbeR;
        "pkg-git-8900f9c" = _H72TS4De;
        "pkg-git-7d43868" = _7oYwTBVp;
        "pkg-git-e394d4f" = _mp25pIHl;
        "pkg-git-ed96aa9" = _WpUFbNDc;
        "pkg-git-67a9f43" = _6joDce2P;
        "pkg-git-526a92d" = _mk8b0mVX;
        "pkg-git-c45fc74" = _a4Yv0tUm;
        "pkg-git-695dc26" = _6ONdrXJE;
        "pkg-v1.9.0" = _nwij66MR;
        "pkg-git-3ad8982" = _6KIjjcAu;
        "default" = _6KIjjcAu;
    });
