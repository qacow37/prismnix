...
let
    ...
    in {
        ...
        "pkg-2.7.3" = _UoqfD6QN;
        "pkg-2.7.3.1" = _IDx2iG7G;
        "pkg-2.7.3.2" = _XXpCRM0J;
        "pkg-2.7.3.3" = _AW5FY0Ra;
        "pkg-2.7.3.4" = _wWrCeakg;
        "pkg-2.7.4" = _dGd0z1xY;
        "pkg-2.7.5" = _eEHSQ2iR;
        "pkg-2.7.5.1" = _YK42vDEa;
        "pkg-2.7.5.2" = _C0gZuaWp;
        "pkg-2.7.6" = _jvkbhqZ9;
        "pkg-2.7.6.1" = _idp4TPis;
        "pkg-2.7.7" = _FAd346jP;
        "pkg-2.7.8" = _ZKEXJTuH;
        "pkg-2.7.9" = _siWEF54a;
        "pkg-2.7.10" = _2Cee7xRe;
        "pkg-2.7.12.1" = _HjvS5zIO;
        "pkg-2.7.12.2" = _cu7gSX9Z;
        "pkg-2.7.12.3" = _zdVh7gBc;
        "pkg-2.7.12.4" = _8R6HCa6J;
        "pkg-2.7.14" = _4OLikIyQ;
        "pkg-2.7.15" = _a8MBszYd;
        "pkg-2.7.16" = _VqjGwfNS;
        "pkg-2.7.17" = _aDBVo11u;
        "pkg-2.8.0" = _RhOlTanF;
        "pkg-2.8.2" = _e2QgXsWW;
        "pkg-2.8.3" = _UvuyWyhD;
        "pkg-2.9.0" = _ssQ2KEQd;
        ...
        "pkg-2.9.3" = _rv0tZbG9;
        "pkg-2.9.4" = _1uVZSFRI;
        "pkg-2.10.0" = _e0oo9ZiM;
        "pkg-2.10.1" = _27ftKgSF;
        "pkg-2.10.2" = _oqVrtZTo;
        "pkg-2.11.0" = _uHNRrjQ1;
        "pkg-2.13.0" = _HhWQXvwj;
        "pkg-2.13.1" = _ZIVix7of;
        "pkg-2.13.2" = _mZ0vYbWr;
        "pkg-2.13.3" = _YnxL23zA;
        "pkg-2.14.0" = _CdZPdmrX;
        "pkg-2.14.0.1" = _OCnRk4EZ;
        "pkg-2.15.0" = _7KWvGa30;
        "pkg-2.15.1" = _tZYRIRIl;
        "pkg-2.15.2" = _Pgcu4VkO;
        "pkg-2.16.0" = _dgxTcBEl;
        "pkg-2.16.1" = _6lDamjIK;
        "pkg-2.16.2" = _V3X0pOQr;
        "pkg-2.16.3" = _WPkYIP4c;
        "pkg-2.16.4" = _vDmXDRvE;
        "default" = _vDmXDRvE;
    });
