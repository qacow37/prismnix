...
let
    ...
    in {
        ...
        "pkg-1.0" = _GD8FqK2a;
        "pkg-1.0_mod" = _fNWSUa5m;
        "pkg-2.0" = _kvoLHxAY;
        "pkg-2.0_mod" = _W6DOkN6s;
        "pkg-2.1" = _S82UDOwX;
        "pkg-2.2" = _6IjH0zWE;
        "pkg-2.2+mod" = _Uh21gfCy;
        "pkg-2.3" = _KdLokZEq;
        "pkg-2.3+mod" = _3Qy6hoB8;
        "pkg-3.0" = _5cxKpL9b;
        "pkg-3.0+mod" = _F7AbV32Y;
        "pkg-4.0" = _hznXQLXP;
        "pkg-4.0+mod" = _r2gxhkDC;
        "pkg-4.1" = _AP84Y9KH;
        "pkg-5.0" = _7iCRb70V;
        "pkg-5.0+mod" = _gFMcz1hF;
        "pkg-5.1" = _AoUr8UV7;
        "pkg-5.1+mod" = _zqqJwBl6;
        "pkg-5.2" = _wN9GUqZ0;
        "pkg-5.2+mod" = _hWL35wP0;
        "pkg-5.3" = _QDzPCnwG;
        "pkg-5.3+mod" = _ebZcJCNR;
        "pkg-5.4" = _d3ht9e2G;
        "pkg-5.4+mod" = _52TTH4Jl;
        "pkg-5.5" = _12Dm4XFy;
        "pkg-5.5+mod" = _wg7VsfPV;
        "pkg-5.6" = _IMTHxOrA;
        "pkg-5.6+mod" = _Z0syHaHZ;
        "pkg-5.7" = _lhfP91Qv;
        "pkg-5.7-fabric" = _d4MICr1Y;
        "pkg-5.7-forge" = _6IyrcZ9n;
        "pkg-5.11" = _sdvZNoYp;
        "pkg-5.11-fabric" = _Uu8YVbZz;
        "pkg-5.11-quilt" = _E9gBK5bV;
        "pkg-5.11-forge" = _Qt3l0dLR;
        "pkg-5.11-neoforge" = _HRzlAFpX;
        "pkg-5.12" = _KFOauwJS;
        "pkg-5.12-fabric" = _tKuGprVI;
        "pkg-5.12-quilt" = _E61ffVYf;
        "pkg-5.12-forge" = _ONdzewpA;
        "pkg-5.12-neoforge" = _nCCYNI5f;
        "pkg-5.13" = _STeEMkKn;
        "pkg-5.13-fabric" = _mL65IYsx;
        "pkg-5.13-quilt" = _D1xwgPck;
        "pkg-5.13-forge" = _zNwWMQj9;
        "pkg-5.13-neoforge" = _sliu5Nj3;
        "default" = _sliu5Nj3;
    });
