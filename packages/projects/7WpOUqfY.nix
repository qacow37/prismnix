...
let
    ...
    in {
        ...
        "pkg-V1.2.1" = _vM2hqcGM;
        "pkg-V1.2.2-data" = _JGkxokWF;
        "pkg-V1.2.2-resource" = _yeDbbRNz;
        "pkg-V1.2.3-resource" = _Wn9v3ia3;
        "pkg-V1.2.3-data" = _htxyqoVk;
        "pkg-V1.2.3-mod" = _OlKqtK54;
        "pkg-V1.2.4-resource" = _NG7j81Wh;
        "pkg-V1.2.4-data" = _Ju8Bkiqk;
        "pkg-V1.2.4-mod" = _j4B2WpFB;
        "pkg-V1.2.5-resource" = _A5J0NgeR;
        "pkg-V1.2.5-data" = _2YZUcq9F;
        "pkg-V1.2.5-mod" = _VCYRoy1U;
        "pkg-V1.3-resource" = _qIAajRIk;
        "pkg-V1.3-data" = _RtbZgMzW;
        "pkg-V1.3-mod" = _XQl9HS7u;
        "pkg-V1.3.1-resource" = _auje3ghs;
        "pkg-V1.3.1-data" = _XRte8wFL;
        "pkg-V1.3.1-mod" = _IYIMayT5;
        "pkg-V1.3.2-resource" = _mibdY0LT;
        "pkg-V1.3.2-data" = _DUO8XHvg;
        "pkg-V1.3.2-mod" = _sKSfscmW;
        "pkg-V1.3.3-resource" = _nkNk3U3A;
        "pkg-V1.3.3-data" = _TLEAmY7c;
        "pkg-V1.3.3-mod" = _2jGiLmP2;
        "pkg-V1.3.4-resource" = _nqMwCYod;
        "pkg-V1.3.4-data" = _3eqeZTP0;
        "pkg-V1.3.4-mod" = _xYf3h56h;
        "pkg-V1.3.5-resource" = _7qKmeLjr;
        "pkg-V1.3.5-data" = _4j8SPGbA;
        "pkg-V1.3.5-mod" = _rStNJdFc;
        "pkg-V1.3.6-resource" = _D19IeAeG;
        "pkg-1.3.6-data" = _1JNKWsxU;
        "pkg-1.3.6-mod" = _p73uUpQ5;
        "default" = _p73uUpQ5;
    });
