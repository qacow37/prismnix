...
let
    ...
    in {
        ...
        "pkg-0.4" = _QV0z2nDK;
        "pkg-0.5" = _yVPddGPw;
        "pkg-0.5.1+1.19" = _Zp8JqntR;
        "pkg-0.5.1+1.20" = _xjv3LnWe;
        "pkg-0.5.1+1.18.2" = _FLrVaKRb;
        "pkg-0.5.2" = _SSxJn7Q3;
        "pkg-0.6.0-beta" = _RZQTaZZg;
        "pkg-0.6.0-beta.2" = _6J24paz6;
        "pkg-0.6.0+1.21" = _R70VxyyO;
        "pkg-0.6.0+1.21.2" = _pe7eWXsm;
        "pkg-0.7.0+1.21" = _KZ2VNjc6;
        "pkg-0.7.0+1.21.2" = _tuwmG0wF;
        "pkg-0.7.1+1.21.2" = _Rf5H4l5H;
        "pkg-0.7.1+1.21.6" = _Eo7sAgUw;
        "pkg-0.7.1+1.21" = _pwUtENvI;
        "pkg-0.7.2+1.21.5" = _kYuzOJnp;
        "pkg-0.7.3+1.21.5" = _ItYp3AKt;
        "pkg-0.7.3+1.21.9" = _DMfIAyAY;
