...
let
    ...
    in {
        ...
        "pkg-1.12.2-0.1.2" = _9KOuBMX0;
        "pkg-1.12.2-0.2.0" = _Ver44c11;
        "pkg-1.12.2-0.3.5" = _SDyMoN0t;
        "pkg-1.14.4-0.4.7" = _pJzAp9F5;
        "pkg-1.15.2-0.5.9" = _nTkiFVmp;
        "pkg-1.15.2-0.5.12" = _yvkO2A87;
        "pkg-1.15.2-0.5.13" = _QEL6It4i;
        "pkg-1.19.2-0.6.0-alpha.10" = _eOs023JI;
        "pkg-1.19.2-0.6.0-alpha.11" = _RODd0Gdo;
        "pkg-1.19.4-0.6.0-alpha.12" = _9nhFplcL;
        "pkg-1.19.4-0.6.0-alpha.13" = _uWCTLy3e;
        "pkg-1.19.4-0.6.0" = _w8eVwATN;
        "pkg-1.19.4-0.6.1" = _rwoyVzMB;
        "pkg-1.20.1-0.6.2-beta.1" = _tbLTmhAs;
        "pkg-1.20.1-0.6.2-beta.3" = _dxNpfqHj;
        "pkg-0.6.2-beta.4" = _RzCFEdNF;
        "pkg-0.6.2" = _sG5v82R0;
        "pkg-0.6.3" = _DVzEjbLw;
        "pkg-0.6.4" = _ROwkgvvf;
        "pkg-0.6.5" = _dtbuhYTI;
