...
let
    ...
    in {
        ...
        "pkg-1604.1.0.3" = _Kh7LFyqz;
        "pkg-1604.1.0.4" = _8a5MeRNn;
        "pkg-1604.1.0.5" = _b5VQPWoZ;
        "pkg-1604.1.0.6" = _EYFRgowg;
        "pkg-1604.1.0.7" = _oHEI0BXD;
        "pkg-1604.1.0.8" = _octDkgL6;
        "pkg-1604.1.0.9" = _SsYkHi5m;
        "pkg-1604.1.0.10" = _ks0uqOv9;
        "pkg-1604.1.0.11" = _NWEt2sl4;
        "pkg-1604.1.0.12" = _jUJVTh1p;
        "pkg-1605.1.1-build.1" = _pZJvd6Ry;
        "pkg-1605.1.1-build.2" = _BqqXLJhX;
        "pkg-1605.1.2-build.4" = _VkYe26oy;
        "pkg-1801.2.0-build.8" = _O5jnHnAq;
        "pkg-1801.2.0-build.11" = _ChMJ8YgE;
        "pkg-1801.2.0-build.14" = _jUFg25jJ;
        "pkg-1801.2.0-build.16" = _w8H5Vg5a;
        "pkg-1605.1.2-build.19" = _iUZzRvRs;
        "pkg-1801.2.0-build.20" = _1DYoBO6F;
        "pkg-1801.2.0-build.24" = _Y0QCfoxp;
        "pkg-1605.1.2-build.25" = _kv3qcyxs;
        "pkg-1801.2.0-build.29" = _oVNT1jhH;
        "pkg-1605.1.2-build.28" = _aluqfRV1;
        "pkg-1801.2.0-build.31" = _F1bhYmXH;
        "pkg-1802.2.1-build.35" = _TNDXu8rF;
        "pkg-1902.2.2-build.40" = _pNgjufVx;
        "pkg-1902.2.3-build.14" = _u2LNQqM2;
        "pkg-1902.2.3-build.18" = _Czk5Kt7t;
        "default" = _Czk5Kt7t;
    });
