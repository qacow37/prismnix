...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _G0qJi2fQ;
        "pkg-1.0.3" = _2bObFY2j;
        "pkg-0.14.0" = _vNbIz24d;
        "pkg-0.15.0" = _UEyfycAJ;
        "pkg-0.16.10.0" = _jQ7GPXsN;
        "pkg-0.1.0" = _mfz6rZTt;
        "pkg-1.0.6" = _AyFzwH8e;
        "pkg-0.1.1" = _kL6Lrfku;
        "pkg-0.14.1" = _uhdTSDmP;
        "pkg-0.15.1" = _5gymKfU4;
        "pkg-0.16.10.1" = _KyXkyPeo;
        "pkg-1.0.6+26.1" = _f0WpOg7n;
        "pkg-0.01.0" = _Ih9flJYO;
        "pkg-0.1.2" = _YhkkALPn;
        "pkg-1.0.7" = _PlD0cN3E;
        "pkg-0.16.10.2" = _qkeKrXVX;
        "pkg-0.15.2" = _hUgQjYWr;
        "pkg-1.0.8" = _uVhjsBNL;
        "pkg-0.16.10.3" = _UDNTT6zD;
        "pkg-0.15.3" = _xGfON8Q6;
        "pkg-0.14.2" = _GJOdzioS;
        "pkg-1.0.9" = _7vnmlhul;
        "pkg-1.1.0" = _A1VBvpOx;
        "pkg-1.1.0+26.1" = _oVAPB6Bi;
        "pkg-1.1.1+26.2" = _PrRdpn5o;
        "pkg-1.1.2+26.3" = _YtMWZP6y;
        "pkg-1.1.3+26.3" = _DXBjbwlB;
        "pkg-1.1.4+26.3" = _FjliU16r;
        "pkg-1.1.4+1.21.11" = _2BvcoPHo;
        "pkg-1.1.4+1.21.6-1.21.10" = _MhtSuMST;
        "default" = _MhtSuMST;
    });
