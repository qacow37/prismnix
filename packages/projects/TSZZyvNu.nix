...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta" = _e9Z0kiJy;
        "pkg-1.0.0-beta.1" = _UlVk9SuQ;
        "pkg-1.0.0" = _cRNjFYKq;
        "pkg-1.0.1" = _cN3Ipx4s;
        "pkg-1.1.0-beta" = _MjL8lE2H;
        "pkg-1.1.0" = _h8qCgtnL;
        "pkg-1.2.0" = _clWyduGc;
        "pkg-1.2.1" = _Z4DEfipb;
        "pkg-1.3.0" = _lwUaoN9k;
        ...
        "pkg-1.9.2" = _kCHt4NTD;
        "pkg-1.9.3" = _BzZ72l2y;
        "pkg-1.10.0" = _PRdWTv5D;
        "pkg-1.10.1" = _fTyPtqcW;
        "pkg-1.10.2" = _SUhimC5u;
        "pkg-1.10.3" = _pvSTdE2m;
        "pkg-1.10.4" = _OgJumLeZ;
        "pkg-1.10.5" = _IPwPm1Da;
        "default" = _IPwPm1Da;
    });
