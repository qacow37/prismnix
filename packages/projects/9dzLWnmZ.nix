...
let
    ...
    in {
        ...
        "pkg-1.0.1-beta" = _KQc1AM3C;
        "pkg-1.1.0-beta" = _Vwg268Fs;
        "pkg-1.1.1" = _eYiJruLa;
        "pkg-1.1.2" = _6MXNJUsC;
        "pkg-1.1.3" = _gQHGRjqb;
        "pkg-1.1.4" = _nTCrlDus;
        "pkg-1.1.5+mc1.20.4" = _9jixSSwh;
        "pkg-1.1.5+mc1.20.1" = _pJvTvLTP;
        "pkg-1.2.0+mc1.20.4" = _WweH75lH;
        "pkg-1.2.0+mc1.20.1" = _JMHUHZdw;
        "pkg-1.2.1+mc1.20.4" = _l9sbUwQZ;
        "pkg-1.2.1+mc1.20.1" = _nSUNkgVA;
        "pkg-1.3.0+mc1.20.4" = _yUY0aa1B;
        "pkg-1.3.0+mc1.20.1" = _W2BY6OpM;
        "pkg-1.3.1+mc1.20.4" = _4d8noljS;
        "pkg-1.3.1+mc1.20.1" = _xYrMyXSn;
        "pkg-1.4.0+mc1.20.4" = _5YsWPec2;
        "pkg-1.4.0+mc1.20.1" = _9NVzWlE5;
        "pkg-1.4.0+mc1.21" = _yEnSFU3N;
        "pkg-1.4.1+mc1.20.4" = _afsdT9Iw;
        "pkg-1.4.1+mc1.20.1" = _pqiV4col;
        "pkg-1.4.1+mc1.21" = _4GVVGExy;
        "pkg-1.4.2+mc1.21" = _Mtr0Vd5f;
        "pkg-1.5.0+mc1.20.4" = _tTAh3P3w;
        "pkg-1.5.0+mc1.21" = _DQBXMmVB;
        "pkg-1.5.0+mc1.20.1" = _iM1tuZqP;
        "pkg-1.6.0+mc1.21" = _5BuTgH8U;
        "pkg-1.6.0+mc1.20.4" = _EknhsCd4;
        "pkg-1.6.0+mc1.20.1" = _1YyaPXfy;
        "pkg-1.6.1+mc1.21" = _hDXu5Odt;
        "pkg-1.6.2+mc1.21" = _ZbZelrDh;
        "pkg-1.6.2+mc1.20.4" = _NVtwFnr5;
        "pkg-1.6.2+mc1.20.1" = _DFPVBpg0;
        "pkg-1.6.3+mc1.20.4" = _8z4cNDCF;
        "pkg-1.6.3+mc1.21" = _y3IaHj52;
        "pkg-1.6.3+mc1.20.1" = _dLj8uh73;
        "pkg-1.6.4+mc1.20.4" = _MmcGhRdJ;
        "pkg-1.6.4+mc1.21" = _AhWh9VMW;
        "pkg-1.6.4+mc1.20.1" = _H54gG8cJ;
        "pkg-1.7.0-alpha+mc1.21.4-fabric" = _IprgB1T9;
        "pkg-1.7.0-alpha+mc1.21.4-neoforge" = _UbV514uD;
        "pkg-1.7.0-alpha+mc1.21.1-fabric" = _WgvWnth1;
        "pkg-1.7.0-alpha+mc1.21.1-neoforge" = _sYjDvcva;
        "pkg-1.7.0-alpha+mc1.20.1-fabric" = _vife1XPv;
        "pkg-1.7.0-alpha+mc1.20.1-forge" = _O65Fz8HQ;
        "pkg-1.7.1+mc1.21.4-fabric" = _nRHm1sgL;
        "pkg-1.7.1+mc1.21.4-neoforge" = _iPbpbYrL;
        "pkg-1.7.1+mc1.20.1-forge" = _PPfid3wF;
        "pkg-1.7.1+mc1.20.1-fabric" = _olCOobYC;
        "pkg-1.7.1+mc1.21.1-neoforge" = _2IG2cn2p;
        "pkg-1.7.1+mc1.21.1-fabric" = _WNEYcWmo;
        "pkg-1.7.2+mc1.20.1-fabric" = _1NwKew4L;
        "pkg-1.7.2+mc1.20.1-forge" = _vMrKrjMm;
        "pkg-1.8.0+mc1.20.1-forge" = _D9Bc9hy3;
        "pkg-1.8.0+mc1.20.1-fabric" = _vJXBdhJi;
        "pkg-1.8.0+mc1.21.1-fabric" = _tfQeMPmY;
        "pkg-1.8.0+mc1.21.1-neoforge" = _hKoPHo0E;
        "pkg-1.8.0+mc1.21.4-neoforge" = _4j1Rxlb4;
        "pkg-1.8.0+mc1.21.4-fabric" = _lPTPKKcT;
        "pkg-1.8.1+mc1.20.1-forge" = _IjLrAYVs;
        "pkg-1.8.1+mc1.20.1-fabric" = _Io18kKIU;
        "pkg-1.9.0+mc1.21.1-neoforge" = _qAbOwber;
        "pkg-1.9.0+mc1.21.1-fabric" = _TOsS9owT;
        "pkg-1.9.0+mc1.21.4-fabric" = _fRo2clh4;
        "pkg-1.9.0+mc1.21.4-neoforge" = _71KKVQkm;
        "pkg-1.9.0+mc1.20.1-fabric" = _18INkyUt;
        "pkg-1.9.0+mc1.20.1-forge" = _tda0Spv3;
        "pkg-1.9.1+mc1.21.1-neoforge" = _ZhDCOIpY;
        "pkg-1.9.1+mc1.21.1-fabric" = _lB4FlORc;
        "pkg-1.9.1+mc1.21.4-neoforge" = _9oMAN2zk;
        "pkg-1.9.1+mc1.21.4-fabric" = _sB6eWRwP;
        "pkg-1.9.1+mc1.20.1-fabric" = _TSWo6pzn;
        "pkg-1.9.1+mc1.20.1-forge" = _yPdqK8rp;
        "pkg-1.10.0+mc1.20.1-fabric" = _ivvVq6Zt;
        "pkg-1.10.0+mc1.20.1-forge" = _VMUHekEZ;
        "pkg-1.10.0+mc1.21.4-neoforge" = _2GBCrroN;
        "pkg-1.10.0+mc1.21.4-fabric" = _vSNha10j;
        "pkg-1.10.0+mc1.21.5-neoforge" = _QOuuFdOU;
        "pkg-1.10.0+mc1.21.5-fabric" = _atFaCkxM;
        "pkg-1.10.0+mc1.21.1-neoforge" = _hSVJUcrS;
        "pkg-1.10.0+mc1.21.1-fabric" = _NrGXS1dw;
        "pkg-1.10.1+mc1.21.1-neoforge" = _1GWOEnZK;
        "pkg-1.10.1+mc1.21.1-fabric" = _av7zrZht;
        "pkg-1.10.1+mc1.21.5-neoforge" = _V2JUhtSG;
        "pkg-1.10.1+mc1.21.5-fabric" = _uFeUx6xG;
        "pkg-1.10.1+mc1.21.4-neoforge" = _25FByh7a;
        "pkg-1.10.1+mc1.21.4-fabric" = _WHLsrUlG;
        "pkg-1.10.1+mc1.20.1-fabric" = _qQjd793J;
        "pkg-1.10.1+mc1.20.1-forge" = _5rXUeA9e;
        "pkg-1.10.3+mc1.21.6-neoforge" = _sStnOznb;
        "pkg-1.10.3+mc1.21.6-fabric" = _kLvbvy83;
        "pkg-1.10.4+mc1.21.1-neoforge" = _ico4KSNS;
        "pkg-1.10.4+mc1.21.1-fabric" = _4JYScafk;
        "pkg-1.10.4+mc1.20.1-fabric" = _yCksvPVX;
        "pkg-1.10.4+mc1.20.1-forge" = _DdYA8atU;
        "pkg-1.10.4+mc1.21.6-neoforge" = _Ilp8BTY3;
        "pkg-1.10.4+mc1.21.6-fabric" = _g8fILZ7V;
        "pkg-1.10.5+mc1.21.7-fabric" = _Ln0vuCVw;
        "pkg-1.10.5+mc1.21.7-neoforge" = _R1Erayax;
        "pkg-1.10.6+mc1.21.1-neoforge" = _EFay80RV;
        "pkg-1.10.6+mc1.21.1-fabric" = _Njoo8LM0;
        "pkg-1.10.7+mc1.21.8-fabric" = _ymcv9UOH;
        "pkg-1.10.7+mc1.21.8-neoforge" = _RznOXzCb;
        "pkg-1.10.8+mc1.21.8-fabric" = _xBXCZHwX;
        "pkg-1.10.8+mc1.21.8-neoforge" = _UU0HnIFh;
        "pkg-1.10.8+mc1.21.9-neoforge" = _oHXnwabz;
        "pkg-1.10.8+mc1.21.9-fabric" = _etbU3bQT;
        "pkg-1.10.8+mc1.20.1-fabric" = _FaaKtiri;
        "pkg-1.10.8+mc1.20.1-forge" = _NlyAPWLR;
        "pkg-1.10.8+mc1.21.1-fabric" = _EoCccWQx;
        "pkg-1.10.8+mc1.21.1-neoforge" = _F6N0Xi1M;
        "pkg-1.10.9+mc1.21.11-fabric" = _Qo9xk2l9;
        "pkg-1.10.9+mc1.21.11-neoforge" = _uSN2m0xg;
        "pkg-1.10.10+mc1.21.11-fabric" = _BPpTo6wI;
        "pkg-1.10.10+mc1.21.11-neoforge" = _6KWYCIv1;
        "pkg-1.10.11+mc1.21.11-neoforge" = _jCuB4N9P;
        "pkg-1.10.11+mc1.21.11-fabric" = _9MCZSrcM;
        "pkg-1.10.12+mc1.21.1-fabric" = _RYOi2mzR;
        "pkg-1.10.12+mc1.21.1-neoforge" = _bCB7PwmA;
        "pkg-1.10.12+mc1.21.11-neoforge" = _6dtqo6yy;
        "pkg-1.10.12+mc1.21.11-fabric" = _F6poauPB;
        "pkg-1.10.12+mc1.20.1-fabric" = _1vM6GzIZ;
        "pkg-1.10.12+mc1.20.1-forge" = _VNpCbFx3;
        "pkg-1.10.13+mc26.1" = _3SEwT02J;
        "pkg-1.10.13+mc26.1.1" = _LLNWpGvi;
