...
let
    ...
    in {
        ...
        "pkg-1.1-1.19.4" = _bEKIK55Z;
        "pkg-1.1-1.20" = _ejDcObrJ;
        "pkg-1.1-1.20.2" = _naqr0c4j;
        "pkg-1.1-1.20.4" = _osKIFdxz;
        "pkg-1.1-1.20.6" = _HgAgpUVJ;
        "pkg-1.1-1.21" = _QJa63ZKX;
        "pkg-1.1-1.21.2" = _qk1kakxx;
        "pkg-1.1-1.21.4" = _1aEYhJs8;
        "pkg-1.2-1.18.2" = _6R8q2mH9;
        "pkg-1.2-1.19.3" = _VJuKeIYX;
        "pkg-1.2-1.19.4" = _vhBmZYdu;
        "pkg-1.2-1.19" = _SLdAYtQL;
        "pkg-1.2-1.20.2" = _qivQpjVi;
        "pkg-1.2-1.20.4" = _yh8g811z;
        "pkg-1.2-1.20" = _3sUSJ9CP;
        "pkg-1.2-1.20.6" = _bDwGL8nO;
        "pkg-1.2-1.21.2" = _OzZeiXqR;
        "pkg-1.2-1.21.4" = _9VbB8Xpk;
        "pkg-1.2-1.21" = _wKRxB9GA;
        "pkg-1.3.1-1.18.2" = _gjWgwuwN;
        "pkg-1.3.1-1.19" = _f7VkBwSu;
        "pkg-1.3.1-1.19.3" = _XYUwkseq;
        "pkg-1.3.1-1.19.4" = _gQUtKVpc;
        "pkg-1.3.1-1.20" = _G3R5WFWM;
        "pkg-1.3.1-1.20.2" = _W6xuWOsV;
        "pkg-1.3.1-1.20.4" = _N9o7LbzK;
        "pkg-1.3.1-1.20.6" = _3za9iPZO;
        "pkg-1.3.1-1.21" = _QJomZSCF;
        "pkg-1.3.1-1.21.2" = _PMkVbgbX;
        "pkg-1.3.1-1.21.4" = _jkGhUcBk;
        "pkg-1.3.2-1.21.2" = _HIKaSnMA;
        "pkg-1.3.2-1.21.4" = _pedOJY6B;
        "pkg-1.4.0-1.18.2" = _1ZClAFJq;
        "pkg-1.4.0-1.19" = _RoP5NN79;
        "pkg-1.4.0-1.19.3" = _1UFzskrM;
        "pkg-1.4.0-1.19.4" = _JD4OPsvo;
        "pkg-1.4.0-1.20" = _p7BQpGFb;
        "pkg-1.4.0-1.20.2" = _QBJA8NNe;
        "pkg-1.4.0-1.20.4" = _Hoeh6vB3;
        "pkg-1.4.0-1.20.6" = _RZbBfW9U;
        "pkg-1.4.0-1.21" = _kMW7zQwA;
        "pkg-1.4.0-1.21.2" = _HLV3JRRJ;
        "pkg-1.4.0-1.21.4" = _jIXg9FUl;
        "pkg-1.4.0-1.21.5" = _5oyCojGV;
        "pkg-1.4.1-1.18.2" = _98uHzu1S;
        "pkg-1.4.1-1.19" = _z9OZ0aMR;
        "pkg-1.4.1-1.19.3" = _XKWNdEDU;
        "pkg-1.4.1-1.19.4" = _HgrFfV2p;
        "pkg-1.4.1-1.20" = _DCeus1OR;
        "pkg-1.4.1-1.20.2" = _UJ4Va1PX;
        "pkg-1.4.1-1.20.4" = _mC1DZHuF;
        "pkg-1.4.1-1.20.6" = _Mze8WZXd;
        "pkg-1.4.1-1.21" = _QJvHgM8K;
        "pkg-1.4.1-1.21.2" = _qfqUz7YK;
        "pkg-1.4.1-1.21.4" = _m1zexUKq;
        "pkg-1.4.1-1.21.5" = _6DqQdXxp;
        "pkg-1.4.2-1.18.2" = _dvXHZ982;
        "pkg-1.4.2-1.19" = _T0TCFuiC;
        "pkg-1.4.2-1.19.3" = _gq2pX97i;
        "pkg-1.4.2-1.19.4" = _EomnnVfB;
        "pkg-1.4.2-1.20" = _tUt8frgc;
        "pkg-1.4.2-1.20.2" = _FxlApIAA;
        "pkg-1.4.2-1.20.4" = _PBUgM5rU;
        "pkg-1.4.2-1.20.6" = _TKRYLFXo;
        "pkg-1.4.2-1.21" = _kg9Z9lHq;
        "pkg-1.4.2-1.21.2" = _EsKQze2r;
        "pkg-1.4.2-1.21.4" = _bI8FbgdY;
        "pkg-1.4.2-1.21.5" = _EFlC33Bi;
        "pkg-1.5.0-1.18.2" = _Xmf8UcjZ;
        "pkg-1.5.0-1.19" = _NUCwysvX;
        "pkg-1.5.0-1.19.3" = _ba9yMT8D;
        "pkg-1.5.0-1.19.4" = _9aEnvTDd;
        "pkg-1.5.0-1.20" = _ZXs1vIhO;
        "pkg-1.5.0-1.20.2" = _lUWOwKTT;
        "pkg-1.5.0-1.20.4" = _BZuvBoKX;
        "pkg-1.5.0-1.20.6" = _Gl2Jw1Q7;
        "pkg-1.5.0-1.21" = _tnqW2j6c;
        "pkg-1.5.0-1.21.2" = _KM0We9C7;
        "pkg-1.5.0-1.21.4" = _PrB9EFCq;
        "pkg-1.5.0-1.21.5" = _juCboALD;
        "pkg-1.5.0-1.21.6" = _zCkql34Z;
        "pkg-1.5.1-1.18.2" = _A5REE5yA;
        "pkg-1.5.1-1.19" = _BZYIwvUw;
        "pkg-1.5.1-1.19.1" = _rpgY9II9;
        "pkg-1.5.1-1.19.3" = _VpA1dPz6;
        "pkg-1.5.1-1.19.4" = _Ore6jrtg;
        "pkg-1.5.1-1.20" = _YQ7Dczoy;
        "pkg-1.5.1-1.20.2" = _nrevUh1l;
        "pkg-1.5.1-1.20.4" = _LnhH9LuX;
        "pkg-1.5.1-1.20.6" = _6utwwz4L;
        "pkg-1.5.1-1.21" = _udDzXR5H;
        "pkg-1.5.1-1.21.2" = _g1IpF0lK;
        "pkg-1.5.1-1.21.4" = _vSDfgLkA;
        "pkg-1.5.1-1.21.5" = _hlRE0rQx;
        "pkg-1.5.1-1.21.6" = _elRDvEkF;
        "pkg-1.6.0-1.18.2" = _au1Z5DKX;
        "pkg-1.6.0-1.19" = _580FNWmd;
        "pkg-1.6.0-1.19.1" = _5YNsUPF5;
        "pkg-1.6.0-1.19.3" = _n5balwsc;
        "pkg-1.6.0-1.19.4" = _kMmApA6H;
        "pkg-1.6.0-1.20" = _rMqUCRxW;
        "pkg-1.6.0-1.20.2" = _QngS6IF6;
        "pkg-1.6.0-1.20.4" = _1jCAKuUT;
        "pkg-1.6.0-1.20.6" = _nUxEztca;
        "pkg-1.6.0-1.21" = _de8hvlWl;
        "pkg-1.6.0-1.21.2" = _qb43xh8J;
        "pkg-1.6.0-1.21.4" = _ZNLa2LFG;
        "pkg-1.6.0-1.21.5" = _Ai7uiJWJ;
        "pkg-1.6.0-1.21.6" = _PDzt3zFi;
        "pkg-1.6.1-1.18.2" = _pDHzF0X0;
        "pkg-1.6.1-1.19" = _V94wOseH;
        "pkg-1.6.1-1.19.1" = _rHnQ4bLl;
        "pkg-1.6.1-1.19.3" = _WERflVQF;
        "pkg-1.6.1-1.19.4" = _Dx7pAuNB;
        "pkg-1.6.1-1.20" = _bG0OyY3P;
        "pkg-1.6.1-1.20.2" = _CE4RoHgx;
        "pkg-1.6.1-1.20.4" = _NeeRQxfr;
        "pkg-1.6.1-1.20.6" = _U6iLK1xC;
        "pkg-1.6.1-1.21" = _knjeiO42;
        "pkg-1.6.1-1.21.2" = _QqvCgXgz;
        "pkg-1.6.1-1.21.4" = _lWyxeLVQ;
        "pkg-1.6.1-1.21.5" = _5Y0eqxWx;
        "pkg-1.6.1-1.21.6" = _Mbee4QUy;
        "pkg-1.6.1-1.21.9" = _9E4HfhLK;
        "pkg-1.6.2-1.21.2" = _w325qvab;
        "pkg-1.6.2-1.21.4" = _X3dv5J55;
        "pkg-1.6.2-1.21.5" = _xr3yOJQP;
        "pkg-1.6.2-1.21.6" = _YCiLjiGx;
        "pkg-1.6.2-1.21.9" = _Omo9qkv4;
        "pkg-1.6.2-1.21.11" = _Nc2ov1Ga;
        "pkg-2.0.0-1.18.2" = _zSfndFwf;
        "pkg-2.0.0-1.19" = _dHfMvHH5;
        "pkg-2.0.0-1.19.1" = _TpBkQsdo;
        "pkg-2.0.0-1.19.3" = _POyWwTmH;
        "pkg-2.0.0-1.19.4" = _lJkkRiOa;
        "pkg-2.0.0-1.20" = _BXkcftt8;
        "pkg-2.0.0-1.20.2" = _UsVawPCX;
        "pkg-2.0.0-1.20.4" = _CMnFpeTX;
        "pkg-2.0.0-1.20.6" = _yeIFTf45;
        "pkg-2.0.0-1.21" = _ZWxYRZVf;
        "pkg-2.0.0-1.21.2" = _skeo8kin;
        "pkg-2.0.0-1.21.4" = _I6TDojuy;
        "pkg-2.0.0-1.21.5" = _LBxNY2r6;
        "pkg-2.0.0-1.21.6" = _5pObW9eP;
        "pkg-2.0.0-1.21.9" = _8zjfNtJM;
        "pkg-2.0.0-1.21.11" = _Dn7h7f4w;
        "pkg-2.0.1-1.18.2" = _SbjgmVvr;
        "pkg-2.0.1-1.19" = _eJYyNcKf;
        "pkg-2.0.1-1.19.1" = _oIktSYxH;
        "pkg-2.0.1-1.19.3" = _pK11tqcA;
        "pkg-2.0.1-1.19.4" = _9JMQB1wO;
        "pkg-2.0.1-1.20" = _LMovb39F;
        "pkg-2.0.1-1.20.2" = _JliXDOTz;
        "pkg-2.0.1-1.20.4" = _69FxJ6Om;
        "pkg-2.0.1-1.20.6" = _lQo9r5Qk;
        "pkg-2.0.1-1.21" = _hrPJIks2;
        "pkg-2.0.1-1.21.2" = _AaB8s4M4;
        "pkg-2.0.1-1.21.4" = _4ibEyHAs;
        "pkg-2.0.1-1.21.5" = _UxqzlT8l;
        "pkg-2.0.1-1.21.6" = _meY6Yns6;
        "pkg-2.0.1-1.21.9" = _17K4YDZR;
        "pkg-2.0.1-1.21.11" = _yslVUYgG;
        "pkg-2.1.0-1.18.2" = _Xya1gK5u;
        "pkg-2.1.0-1.19" = _g8QqsfFs;
        "pkg-2.1.0-1.19.1" = _fOy8Bbpg;
        "pkg-2.1.0-1.19.3" = _jUskUe04;
        "pkg-2.1.0-1.19.4" = _pLYc6ByX;
        "pkg-2.1.0-1.20" = _oQe7Hp3f;
        "pkg-2.1.0-1.20.2" = _DdXg2TYD;
        "pkg-2.1.0-1.20.4" = _NpCt2s7M;
        "pkg-2.1.0-1.20.6" = _KFBiiTfv;
        "pkg-2.1.0-1.21" = _CLLWAim2;
        "pkg-2.1.0-1.21.2" = _mDbSfhwc;
        "pkg-2.1.0-1.21.4" = _i1RmhfGO;
        "pkg-2.1.0-1.21.5" = _uzVbBBgG;
        "pkg-2.1.0-1.21.6" = _B5WUq56X;
        "pkg-2.1.0-1.21.9" = _dibPmN59;
        "pkg-2.1.0-1.21.11" = _60opAxno;
        "pkg-2.2.0-1.18.2" = _G0KeNBs4;
        "pkg-2.2.0-1.19" = _kJc3WcfZ;
        "pkg-2.2.0-1.19.1" = _ODW3wnoq;
        "pkg-2.2.0-1.19.3" = _fwyOaN0H;
        "pkg-2.2.0-1.19.4" = _a8zQ1g1z;
        "pkg-2.2.0-1.20" = _80FiOjcE;
        "pkg-2.2.0-1.20.2" = _yDI9Olv0;
        "pkg-2.2.0-1.20.4" = _cIphCHoC;
        "pkg-2.2.0-1.20.6" = _Arxaz5Tj;
        "pkg-2.2.0-1.21" = _bvwobIGR;
        "pkg-2.2.0-1.21.2" = _oLH2HRB3;
        "pkg-2.2.0-1.21.4" = _OnaT8FOy;
        "pkg-2.2.0-1.21.5" = _TlWUJndT;
        "pkg-2.2.0-1.21.6" = _fQnHeI4K;
        "pkg-2.2.0-1.21.9" = _2IK6bEDr;
        "pkg-2.2.0-1.21.11" = _olIWvoOW;
        "pkg-2.3.0-1.18.2" = _eVvrtzUY;
        "pkg-2.3.0-1.19" = _GViJb309;
        "pkg-2.3.0-1.19.1" = _i6N33wzq;
        "pkg-2.3.0-1.19.3" = _WIkiDT0W;
        "pkg-2.3.0-1.19.4" = _YMskctzX;
        "pkg-2.3.0-1.20" = _hlvgcaLA;
        "pkg-2.3.0-1.20.2" = _9B8xqosF;
        "pkg-2.3.0-1.20.4" = _H7qswFEj;
        "pkg-2.3.0-1.20.6" = _y38AiQ8L;
        "pkg-2.3.0-1.21" = _JpvM2uQZ;
        "pkg-2.3.0-1.21.2" = _dh0BFFjX;
        "pkg-2.3.0-1.21.4" = _3wAC2OSB;
        "pkg-2.3.0-1.21.5" = _aEAi4ecI;
        "pkg-2.3.0-1.21.6" = _r8M34fK5;
        "pkg-2.3.0-1.21.9" = _KNp13KPu;
        "pkg-2.3.0-1.21.11" = _KIo6afCZ;
        "pkg-2.3.1-1.18.2" = _XpLApzQA;
        "pkg-2.3.1-1.19" = _m3e97oxY;
        "pkg-2.3.1-1.19.1" = _qcyPenC8;
        "pkg-2.3.1-1.19.3" = _wlFA93wb;
        "pkg-2.3.1-1.19.4" = _jqzEVsBY;
        "pkg-2.3.1-1.20" = _khcEYD3p;
        "pkg-2.3.1-1.20.2" = _JCcpmnIO;
        "pkg-2.3.1-1.20.4" = _XFzh9hMj;
        "pkg-2.3.1-1.20.6" = _QxywRuWJ;
        "pkg-2.3.1-1.21" = _frfvfPFL;
        "pkg-2.3.1-1.21.2" = _5c4bOWDC;
        "pkg-2.3.1-1.21.4" = _Yysfdaxu;
        "pkg-2.3.1-1.21.5" = _c1rKG15x;
        "pkg-2.3.1-1.21.6" = _p5RzmpTf;
        "pkg-2.3.1-1.21.9" = _1lPLV6oW;
        "pkg-2.3.1-1.21.11" = _ZOqQ4PpG;
        "pkg-2.3.2-1.18.2" = _lm8TXbIm;
        "pkg-2.3.2-1.19" = _vRIKQaiu;
        "pkg-2.3.2-1.19.1" = _TO3x5B18;
        "pkg-2.3.2-1.19.3" = _bsDVq9G8;
        "pkg-2.3.2-1.19.4" = _V0Zb7mzx;
        "pkg-2.3.2-1.20" = _keGrQCC6;
        "pkg-2.3.2-1.20.2" = _zXX0dj6C;
        "pkg-2.3.2-1.20.4" = _69Lbovjg;
        "pkg-2.3.2-1.20.6" = _a9RVz4Nt;
        "pkg-2.3.2-1.21" = _4PW6nHth;
        "pkg-2.3.2-1.21.2" = _NMLlZ0Bs;
        "pkg-2.3.2-1.21.4" = _7yPFc2KW;
        "pkg-2.3.2-1.21.5" = _gAImU5aV;
        "pkg-2.3.2-1.21.6" = _sqIr1egd;
        "pkg-2.3.2-1.21.9" = _bnRmC0IQ;
        "pkg-2.3.2-1.21.11" = _BkDcsGt2;
        "pkg-2.3.2-26.1" = _VBmwXMUw;
        "pkg-2.3.3-26.1" = _fRYh6UwB;
        "pkg-2.4.0-1.18.2" = _eiGkAxEW;
        "pkg-2.4.0-1.19" = _aBxN6VmX;
        "pkg-2.4.0-1.19.1" = _3CFPqZDt;
        "pkg-2.4.0-1.19.3" = _fQgq04Jd;
        "pkg-2.4.0-1.19.4" = _R7MAWT5B;
        "pkg-2.4.0-1.20" = _t54CHuRa;
        "pkg-2.4.0-1.20.2" = _wMsjzmr0;
        "pkg-2.4.0-1.20.4" = _2cpBdwsB;
        "pkg-2.4.0-1.20.6" = _ohANUtiv;
        "pkg-2.4.0-1.21" = _PBJL6hQg;
        "pkg-2.4.0-1.21.2" = _rn6XV28A;
        "pkg-2.4.0-1.21.4" = _9Pb9TKeJ;
        "pkg-2.4.0-1.21.5" = _9SbQyF6y;
        "pkg-2.4.0-1.21.6" = _ngdCmCgf;
        "pkg-2.4.0-1.21.9" = _zhGmhHGi;
        "pkg-2.4.0-1.21.11" = _CrEujes8;
        "pkg-2.4.0-26.1" = _2cqEU5fv;
        "pkg-2.4.0.1-1.21" = _i7dXX4Df;
        "pkg-2.4.1-1.18.2" = _rDoUN17N;
        "pkg-2.4.1-1.19" = _dmagUxOJ;
        "pkg-2.4.1-1.19.1" = _944yihYs;
        "pkg-2.4.1-1.19.3" = _rgdc9edB;
        "pkg-2.4.1-1.19.4" = _SXDioihy;
        "pkg-2.4.1-1.20" = _gtbHETif;
        "pkg-2.4.1-1.20.2" = _CFc7Aj89;
        "pkg-2.4.1-1.20.4" = _ibFeGXpr;
        "pkg-2.4.1-1.20.6" = _v4MrMKRY;
        "pkg-2.4.1-1.21" = _fHmMGZbZ;
        "pkg-2.4.1-1.21.2" = _KxeYzyQY;
        "pkg-2.4.1-1.21.4" = _zFvKnsFu;
        "pkg-2.4.1-1.21.5" = _C4SBXpkF;
        "pkg-2.4.1-1.21.6" = _jYdg8mAz;
        "pkg-2.4.1-1.21.9" = _zirVtoH9;
        "pkg-2.4.1-1.21.11" = _KI8S2zfw;
        "pkg-2.4.1-26.1" = _RtdlgpdS;
        "pkg-2.4.2-1.18.2" = _g2OGwzc6;
        "pkg-2.4.2-1.19" = _JZq9Mnrw;
        "pkg-2.4.2-1.19.1" = _GNa6WWx0;
        "pkg-2.4.2-1.19.3" = _b8F9WkwV;
        "pkg-2.4.2-1.19.4" = _nTZfiKcW;
        "pkg-2.4.2-1.20" = _w4W4Nruz;
        "pkg-2.4.2-1.20.2" = _e7nwwls9;
        "pkg-2.4.2-1.20.4" = _tppJssCp;
        "pkg-2.4.2-1.20.6" = _rhZOHLc8;
        "pkg-2.4.2-1.21" = _XrbBFtbw;
        "pkg-2.4.2-1.21.2" = _Q247ytQd;
        "pkg-2.4.2-1.21.4" = _rZeIUmsP;
        "pkg-2.4.2-1.21.5" = _isYm2NXM;
        "pkg-2.4.2-1.21.6" = _Ec4lCQD9;
        "pkg-2.4.2-1.21.9" = _NgjcQCFS;
        "pkg-2.4.2-1.21.11" = _6DJIHnpy;
        "pkg-2.4.2-26.1" = _5UMDzMV0;
        "pkg-2.4.2-26.2" = _Ombkv7CJ;
        "pkg-2.4.3-1.18.2" = _OnxuneCg;
        "pkg-2.4.3-1.19" = _2wrjM6Zt;
        "pkg-2.4.3-1.19.1" = _Xc0e1AF3;
        "pkg-2.4.3-1.19.3" = _eyc1PdES;
        "pkg-2.4.3-1.19.4" = _1CUYTueg;
        "pkg-2.4.3-1.20" = _iNC7Dw6Q;
        "pkg-2.4.3-1.20.2" = _Kmoz6w0l;
        "pkg-2.4.3-1.20.4" = _JcZKsi45;
        "pkg-2.4.3-1.20.6" = _4K6e9Epg;
        "pkg-2.4.3-1.21" = _tpzOtzDP;
        "pkg-2.4.3-1.21.2" = _mx3J6htG;
        "pkg-2.4.3-1.21.4" = _FSEnntfM;
        "pkg-2.4.3-1.21.5" = _asbHSfGr;
        "pkg-2.4.3-1.21.6" = _HO0zRdSF;
        "pkg-2.4.3-1.21.9" = _VcVw6Akh;
