...
let
    ...
    in {
        ...
        "pkg-8.0.1" = _iOQU4IQb;
        "pkg-9.0.1" = _YIhWZpHM;
        "pkg-12.0.1" = _aGWaw8LF;
        "pkg-13.0.1" = _qc6CM1hY;
        "pkg-15.1.1" = _DWqgDVCW;
        "pkg-15.2.0" = _VeCmLgkx;
        "pkg-15.3.0" = _Wy1GeLVl;
        "pkg-15.4.0" = _zbLqXhjO;
        "pkg-15.5.0" = _ZJf8CEJU;
        "pkg-15.6.0" = _4jRmgKXq;
        "pkg-15.7.0" = _6t8kEa9F;
        "pkg-15.8.0" = _2G6zkVuk;
        "pkg-15.9.0" = _kfryD0Am;
        "pkg-15.10.0" = _q9dLqvlH;
        "pkg-15.11.0" = _ptRzfcmm;
        "default" = _ptRzfcmm;
    });
