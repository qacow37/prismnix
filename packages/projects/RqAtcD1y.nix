...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.21.0-fabric" = _rotYrQyM;
        "pkg-1.0.0-1.21.1-fabric" = _xSCUC1el;
        "pkg-1.0.1-1.21.4-fabric" = _QRKAikwP;
        "pkg-1.1.0-1.21.4-fabric" = _9nzoPbOG;
        "pkg-1.1.1-1.21.4-fabric" = _MbdBinkR;
        "pkg-1.1.1-1.21.5-fabric" = _kWI3sDeh;
        "pkg-1.1.2-1.21.5-fabric" = _6DbYmHsl;
        "pkg-1.1.2-1.21.4-fabric" = _eysIkbRO;
        "pkg-1.1.3-1.21.5-fabric" = _wNHyxXFM;
        "pkg-1.1.3-1.21.4-fabric" = _aqzUlTtC;
        "pkg-1.1.4-1.21.5-fabric" = _njrq20TY;
        "pkg-1.1.4-1.21.4-fabric" = _cvqgKx1Z;
        "pkg-1.2.0-1.21.5-fabric" = _YdHiTwjS;
        "pkg-1.2.0-1.21.4-fabric" = _N7m4pshh;
        "pkg-1.1.0-1.21.0-fabric" = _ZOpc9tvf;
        "pkg-1.1.0-1.21.1-fabric" = _64qOurzv;
        "pkg-1.2.0-1.21.3-fabric" = _VALiJX0a;
        "pkg-1.2.0-1.21.2-fabric" = _S5U4MPwb;
        "pkg-1.1.0-1.20.6-fabric" = _VQnKJXPR;
        "pkg-1.1.0-1.19.4-fabric" = _VMgcUH8J;
        "pkg-1.1.0-1.18.2-fabric" = _IIL1mxGi;
        "pkg-1.1.0-1.17.1-fabric" = _bwmTCCQG;
        "pkg-1.1.0-1.16.5-fabric" = _b5TqvJiK;
        "pkg-1.1.1-1.16.5-fabric" = _GbJBp6vC;
        "pkg-1.1.1-1.15.2-fabric" = _ZD1gejd8;
        "pkg-1.1.1-1.14.4-fabric" = _ezuykXgI;
        "pkg-1.2.1-1.21.5-fabric" = _FJyZ1bYN;
        "pkg-1.2.1-1.21.5-forge" = _CNNV7xcv;
        "pkg-1.2.1-1.21.5-neoforge" = _KcVfoOZj;
        "pkg-1.2.1-1.21.6+-fabric" = _2xAQ3mcD;
        "pkg-1.2.1-1.21.6+-forge" = _ukBvRCf7;
        "pkg-1.2.1-1.21.6+-neoforge" = _iKIwqXTT;
        "default" = _iKIwqXTT;
    });
