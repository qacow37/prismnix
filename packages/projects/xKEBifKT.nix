...
let
    ...
    in {
        ...
        "pkg-0.2" = _q4c5R8rJ;
        "pkg-0.3" = _q6IZQ7bp;
        "pkg-0.6-1.20" = _FTIslr8I;
        "pkg-0.6-1.20.1" = _hgjxD92F;
        "pkg-0.6-1.20.2" = _DODMI6cC;
        "pkg-0.6-1.20.3" = _nXArWwHr;
        "pkg-0.6-1.20.4" = _Wx9NzfMp;
        "pkg-0.6-1.20.5" = _nJjB7ElX;
        "pkg-0.6-1.20.6" = _CSfNHD9C;
        "pkg-0.6-1.21" = _976NF6Bz;
        "pkg-0.6-1.21.1" = _qlek8vW4;
        "pkg-0.6-1.21.2" = _ppOYokdV;
        "pkg-0.6-1.21.3" = _yprkNXiA;
        "pkg-0.6-1.21.4" = _tJ4MTNZr;
        "pkg-0.6-1.21.5" = _DmTNFp22;
        "pkg-0.7-1.20.3" = _riVb64Eq;
        "pkg-0.7-1.20" = _t6o0ubgq;
        "pkg-0.7-1.20.1" = _z3PwoCpz;
        "pkg-0.7-1.20.4" = _qyenz6FE;
        "pkg-0.7-1.20.2" = _5o6o0Spu;
        "pkg-0.7-1.21.1" = _NezqnEgP;
        "pkg-0.7-1.20.6" = _awhmTHMr;
        "pkg-0.7-1.20.5" = _EQvr116A;
        "pkg-0.7-1.21" = _9MbfcSLB;
        "pkg-0.7-1.21.3" = _JsVQ18GF;
        "pkg-0.7-1.21.2" = _DsNLBUkR;
        "pkg-0.7-1.21.5" = _nJ23D0AJ;
        "pkg-0.7-1.21.4" = _cNMQZQsf;
        "pkg-0.8-1.20" = _nEaJ1WGf;
        "pkg-0.8-1.20.1" = _955dgVe6;
        "pkg-0.8-1.20.2" = _J23chThW;
        "pkg-0.8-1.20.3" = _1yt5BUFO;
        "pkg-0.8-1.20.4" = _ueU5ytDJ;
        "pkg-0.8-1.20.5" = _g9LK71O3;
        "pkg-0.8-1.20.6" = _xb15IYwF;
        "pkg-0.8-1.21" = _oG0X1vhn;
        "pkg-0.8-1.21.1" = _fBnkNOBL;
        "pkg-0.8-1.21.2" = _8Wy2Ywzj;
        "pkg-0.8-1.21.3" = _IhFpRE2q;
        "pkg-0.8-1.21.4" = _E7gDcyUX;
        "pkg-0.8-1.21.5" = _qeEeICqP;
        "pkg-0.8-1.21.6" = _gCsWtwWE;
        "pkg-0.9-1.20" = _poGNbgCu;
        "pkg-0.9-1.20.1" = _lAp0wbXO;
        "pkg-0.9-1.20.2" = _5fll9j0I;
        "pkg-0.9-1.20.3" = _lCmzqiVL;
        "pkg-0.9-1.20.4" = _eMBn8jST;
        "pkg-0.9-1.20.5" = _2HjMxKJh;
        "pkg-0.9-1.20.6" = _YoTQZBvV;
        "pkg-0.9-1.21" = _JBULjS0i;
        "pkg-0.9-1.21.1" = _hnNav07W;
        "pkg-0.9-1.21.2" = _DKaBmfLB;
        "pkg-0.9-1.21.3" = _GrGFiEkL;
        "pkg-0.9-1.21.4" = _K673BCoa;
        "pkg-0.9-1.21.5" = _Tf6ZZjtd;
        "pkg-0.9-1.21.6" = _cfpIINs9;
        "pkg-0.10-1.20" = _xWJuVXD4;
        "pkg-0.10-1.20.1" = _8DZxcjcP;
        "pkg-0.10-1.20.2" = _Cj8cJx3Q;
        "pkg-0.10-1.20.3" = _3spSRDWc;
        "pkg-0.10-1.20.4" = _4OXGUiTs;
        "pkg-0.10-1.20.5" = _pdX8v5vI;
        "pkg-0.10-1.20.6" = _fGSsWS56;
        "pkg-0.10-1.21" = _AL6nSllf;
        "pkg-0.10-1.21.1" = _8WGazZk4;
        "pkg-0.10-1.21.2" = _DHUtJYk0;
        "pkg-0.10-1.21.3" = _VWxYqABX;
        "pkg-0.10-1.21.4" = _Hefs8cax;
        "pkg-0.10-1.21.5" = _Px4SEA1R;
        "pkg-0.10-1.21.6" = _sTRVW5hY;
        "pkg-0.11-1.20" = _jkXY8XEX;
        "pkg-0.11-1.20.1" = _vcz2HfXK;
        "pkg-0.11-1.20.2" = _Qnwqyj7A;
        "pkg-0.11-1.20.3" = _dCSloqiQ;
        "pkg-0.11-1.20.4" = _od9jsbX2;
        "pkg-0.11-1.20.5" = _P9WR9CRj;
        "pkg-0.11-1.20.6" = _F56iy626;
        "pkg-0.11-1.21" = _4RvxafYA;
        "pkg-0.11-1.21.1" = _GV5qXRhk;
        "pkg-0.11-1.21.2" = _jP2OQvP4;
        "pkg-0.11-1.21.3" = _DmZLsBRD;
        "pkg-0.11-1.21.4" = _3EhpkMzg;
        "pkg-0.11-1.21.5" = _lCNJWgYq;
        "pkg-0.11-1.21.6" = _DMf6JkhY;
        "pkg-0.11-1.21.7" = _6eixs8d3;
        "pkg-0.11-1.21.8" = _IA7aRDRH;
        "pkg-0.12-1.20" = _MBLVbxhY;
        "pkg-0.12-1.20.1" = _5HjRin6T;
        "pkg-0.12-1.20.2" = _Xg74Z5aA;
        "pkg-0.12-1.20.3" = _8AneZOJw;
        "pkg-0.12-1.20.4" = _kz8e04ET;
        "pkg-0.12-1.20.5" = _3APHCBdK;
        "pkg-0.12-1.20.6" = _n4rit9PA;
        "pkg-0.12-1.21" = _P8zkPo9y;
        "pkg-0.12-1.21.1" = _8DgPoDAx;
        "pkg-0.12-1.21.2" = _RxhXnOW6;
        "pkg-0.12-1.21.3" = _bATxt1x3;
        "pkg-0.12-1.21.4" = _OBUuYq3v;
        "pkg-0.12-1.21.5" = _taa8jx1k;
        "pkg-0.12-1.21.6" = _yiTNDQff;
        "pkg-0.12-1.21.7" = _aXYyeLsS;
        "pkg-0.12-1.21.8" = _KsIvmGnK;
        "pkg-0.12-1.21.9" = _SykTnIyW;
        "pkg-0.12-1.21.10" = _CjTC174T;
        "pkg-0.12-1.21.11" = _pYnBzRja;
        "pkg-0.12-26.1" = _byHj86XV;
        "pkg-0.12-26.1.1" = _Amuhlz6S;
        "pkg-0.12-26.1.2" = _vrGt1eQl;
        "default" = _vrGt1eQl;
    });
