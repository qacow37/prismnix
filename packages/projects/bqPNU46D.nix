...
let
    ...
    in {
        ...
        "pkg-1.0.5" = _4EAKW6g8;
        "pkg-1.0.6" = _y3V6rym0;
        "pkg-1.0.6.1" = _MHQWYw78;
        "pkg-1.0.6.1.1" = _y9m40CFI;
        "pkg-1.0.7" = _ITAkWbL6;
        "pkg-1.0.8" = _PqkzDRty;
        "pkg-1.0.8.1" = _MVGn5GNN;
        "pkg-1.0.8.2" = _Twgp5iHV;
        "pkg-1.0.9" = _UJVJBovR;
        "pkg-1.1.0" = _9zGD0EcW;
        "pkg-1.1.1" = _Frz2BXXu;
        "pkg-1.1.2" = _QCInhP09;
        ...
        "pkg-1.1.9" = _tMe5dZEB;
        "pkg-1.2.0" = _z73LJyil;
        "pkg-1.2.0.7" = _8F79Qiir;
        "pkg-1.2.1" = _UWLQV6aJ;
        "pkg-1.2.1.2" = _So4cbqtT;
        "pkg-1.2.2.2" = _FnNtDlsR;
        "pkg-1.2.4.1" = _O8tq4I5n;
        "pkg-1.2.4.2" = _L4RHgtsj;
        "pkg-1.2.5.1" = _H1zEnC4i;
        "pkg-1.2.5.2" = _MZQZCodE;
        "default" = _MZQZCodE;
    });
