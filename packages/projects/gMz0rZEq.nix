...
let
    ...
    in {
        ...
        "pkg-1.0.0+fabric+1.20.1" = _4RrhCuyH;
        "pkg-1.0.0+fabric+1.21.1" = _R4C2aYYE;
        "pkg-1.0.0+neoforge+1.21.4" = _L8JW1dhg;
        "pkg-1.0.0+forge+1.21.4" = _C3UaIAvX;
        "pkg-1.0.1-fabric-1.21.4" = _MrQ6t50j;
        "pkg-v1.1.0-1.21.5-forge-55.0.4" = _uYXKUCJW;
        "pkg-1.1.0-1.21.4-forge-54.1.3" = _fYC86aBJ;
        "pkg-1.1.0-1.21.1-forge-52.1.1" = _7Q5e2SA5;
        "pkg-1.1.1-1.21.5-fabric-0.120.0" = _D8k2SsHB;
        "pkg-1.1.1-1.21.4-fabric-0.110.5" = _7FY4ekmP;
        "pkg-1.1.0-1.20.1-forge-47.4.0" = _Ys8kfNls;
        "pkg-1.1.1-fabric-1.21.1-0.115.0" = _tNjgvD1s;
        "pkg-1.1.1-fabric-1.20.1-0.92.5" = _V19FkPsU;
        "pkg-1.1.1-fabric-1.21.6-0.127.0" = _9bKgfaTE;
        "pkg-1.2.1-forge-1.21.6-56.0.7" = _sead6Y1Z;
        "pkg-1.2.1-neoforge-1.21.8-21.8.39" = _NkXYNCJN;
        "pkg-1.2.2-neoforge-1.21.1-21.1.206" = _HmY1lxuI;
        "pkg-1.2.4-neoforge-1.21.9-21.9.2-b" = _Tilf6Lot;
        "pkg-1.2.4-forge-1.21.9-59.0.1" = _I4huyhMX;
        "pkg-1.2.5-fabric-1.21.9-0.134.0" = _fKLEuJhx;
        "pkg-1.2.6-fabric-1.21.9-0.134.0" = _JvpwM0Pe;
        "pkg-1.2.6-neoforge-1.21.9-21.9.2-b" = _uqoryt3r;
        "pkg-1.2.6-forge-1.21.9-59.0.5" = _wS9hDnuj;
        "pkg-1.2.6-forge-1.19.2-43.5.0" = _PosGypep;
        "pkg-1.2.7-forge-1.21.8-58.1.7" = _2WnvXtay;
        "pkg-1.2.7-forge-1.21.9-59.0.5" = _PAZo4au5;
        "pkg-1.2.7-neoforge-1.21.9-21.9.2-b" = _nEDgvfb7;
        "pkg-1.2.7-fabric-1.21.9-0.134.0" = _myDicFRf;
        "pkg-1.2.7-forge-1.21.11-61.0.2" = _RcXfg28B;
        "pkg-1.2.7-fabric-1.21.11-0.140.0" = _WVy9J5sD;
        "pkg-1.2.7-neoforge-1.21.11-21.11.10-" = _Yli9gBXZ;
        "pkg-1.2.8-fabric-26.1.2-0.145.4" = _EWQGjm2c;
        "pkg-1.2.8-forge-26.1.2-64.0.0" = _nQaIu09p;
        "pkg-1.2.8-neoforge-26.1.2.4" = _KVP4PkDH;
