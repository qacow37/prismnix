...
let
    ...
    in {
        ...
        "pkg-8.9.0" = _7BKAVGJT;
        "pkg-9.9.0" = _2ebnQT3v;
        "pkg-10.9.0" = _a6kFkfCM;
        "pkg-1.9.1" = _OF5nW0Gi;
        "pkg-7.9.1" = _xtHzgcQc;
        "pkg-10.9.1" = _w27d2z3C;
        "pkg-11.9.1" = _ddnHfvj8;
        "pkg-12.9.1" = _DzrkgHk0;
        "pkg-13.9.1" = _NJ5URd7a;
        "pkg-14.9.1" = _zRBcAPpt;
        "pkg-1.10.0" = _UMHeKk9P;
        "pkg-15.10.0" = _hSInlaUA;
        "default" = _hSInlaUA;
    });
