...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _NMakE28k;
        "pkg-1.1.1" = _EhkIRUzi;
        "pkg-1.1.4+1.21.8" = _3Zknl72T;
        "pkg-1.1.4+1.21.7" = _LBFsNP3h;
        "pkg-1.1.5+1.21.8" = _3jBrLIOw;
        "pkg-1.1.5+1.21.7" = _uiOMxyeA;
        "pkg-1.1.6+1.21.8" = _5BkrKenK;
        "pkg-1.1.6+1.21.7" = _MUVdKUwQ;
        "pkg-1.1.7+1.21.8" = _8nSds2B4;
        "pkg-1.2.2" = _7Rfs78eu;
        "pkg-1.2.3" = _cph64vzs;
        "pkg-1.2.6" = _1s8bRoyO;
        "pkg-1.2.7" = _sBmEsJrr;
