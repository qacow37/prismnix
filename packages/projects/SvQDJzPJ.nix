...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _Sq9u6PaS;
        "pkg-1.18.2-2.0-fabric" = _6HprHw0L;
        "pkg-1.19.2-2.2-fabric" = _ydNhUYzK;
        "pkg-1.16.5-1.5-forge" = _45c2C8SY;
        "pkg-1.18.2-1.7-forge" = _HYtTR6lW;
        "pkg-1.19.2-1.9-forge" = _11BB7JkA;
        "pkg-1.16.5-2.3-fabric" = _rNSipwLB;
        "pkg-1.18.2-2.3-fabric" = _2qgCfpD5;
        "pkg-1.19.2-2.3-fabric" = _AZWfo5z4;
        "pkg-1.19.3-2.4-fabric" = _GxLoIqFQ;
        "pkg-1.19.3-1.9-forge" = _i0EOr6HF;
        "pkg-1.18.2-3.0-forge+fabric" = _6ojJgAy4;
        "pkg-1.19.2-3.0-forge+fabric" = _uYlSmJvR;
        "pkg-1.19.3-3.0-forge+fabric" = _UAON3uln;
        "pkg-1.18.2-3.1-forge+fabric" = _K5dIaLLt;
        "pkg-1.19.2-3.1-forge+fabric" = _jf9pGxxl;
        "pkg-1.19.3-3.1-forge+fabric" = _cLNSegEm;
        "pkg-1.19.4-3.1-forge+fabric" = _yhvLoSJt;
        "pkg-1.20-3.1-forge+fabric" = _ohxBCFFr;
        "pkg-1.20.1-3.1-forge+fabric" = _cqhw2Fzy;
        "pkg-1.20.2-3.1-forge+fabric" = _i3iz5uqr;
        "pkg-1.18.2-3.2-forge+fabric" = _6fi1nsqd;
        "pkg-1.19.2-3.2-forge+fabric" = _aag6CLfm;
        "pkg-1.20.1-3.2-forge+fabric" = _wwINdMEc;
        "pkg-1.20.2-3.2-forge+fabric" = _6ShJh0oP;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _Ts2y498D;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _AGEMCxzu;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _9SmcoKij;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _A9BwfZ2g;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _Yglv1IPH;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _at7hvdzs;
        "pkg-1.20.5-3.3-fabric+neo" = _laHA3dfD;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _KNAh8Isp;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _Q7j8BoII;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _YqsTeJIN;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _KPRjtmoj;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _iGSZOr6p;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _eQgPApfI;
        "pkg-1.21.2-3.4-fabric+neo" = _RNFlbHnz;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _tXFmonf3;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _LT0XbYuT;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _a8XHhEE2;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _Rxv5hOfr;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _uB5oVtPi;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _TsCBSu24;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _ELS9yWO6;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _79sSQAO0;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _8zBdSlus;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _agAs2OjW;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _Wy7EwcPV;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _XpsSIJ9c;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _aENL8pHs;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _v1VnVrQh;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _HKaQH12y;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _5ZX8jhcH;
        "default" = _5ZX8jhcH;
    });
