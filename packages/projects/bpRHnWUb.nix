...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.19.2" = _zkXM1MQ0;
        "pkg-0.0.1+1.18.2" = _JjBDui5l;
        "pkg-0.1.1+1.19.2" = _MIE6CJpz;
        "pkg-0.0.2+1.18.2" = _IH4rYB6v;
        "pkg-0.2.0+1.19.3" = _cidyrqss;
        "pkg-0.3.0+1.19.4" = _c0TRVjro;
        "pkg-0.0.3+1.18.2" = _O2NqCpFM;
        "pkg-0.1.2+1.19.2" = _PonhJfmU;
        "pkg-0.4.0+1.20.1" = _OH8w3wQs;
        "pkg-0.4.1+1.20.1" = _juXS5CaW;
        "pkg-0.4.2+1.20.1" = _InD7xPaR;
        "pkg-0.4.3+1.20.1" = _YSn9Of5z;
        "pkg-0.4.4+1.20.1" = _kTtFhI1L;
        "pkg-0.4.5+1.20.1" = _3MNWOVKW;
        "pkg-0.4.6+1.20.1" = _IobIopQf;
        "pkg-0.4.7+1.20.1" = _V1QbMdYW;
        "pkg-1.0.0+1.21.1.neoforge" = _thKvgaKO;
        "pkg-1.0.0+1.21.1.fabric" = _d5p7j8TM;
        "pkg-1.0.1+1.21.1.neoforge" = _sxnnAXQg;
        "pkg-1.0.1+1.21.1.fabric" = _o9mJcnve;
        "pkg-1.0.2+1.21.1.fabric" = _ZYDIdTej;
        "pkg-1.0.2+1.21.1.neoforge" = _tNXLlCY0;
        "pkg-1.0.3+1.21.1.fabric" = _YCTD39C5;
        "pkg-1.0.3+1.21.1.neoforge" = _bxgGyUjY;
        "default" = _bxgGyUjY;
    });
