...
let
    ...
    in {
        ...
        "pkg-1.3.2" = _RwoLWHcT;
        "pkg-1.3.4" = _PXi5nPLl;
        "pkg-1.21.1-1.4.0" = _RFlseZTl;
        "pkg-1.21.1-1.4.1" = _QjHyXWkq;
        "pkg-1.21.1-1.4.2" = _q0iCRJ18;
        "pkg-1.21.1-1.4.3" = _GblmvvKI;
        "pkg-1.21.1-1.4.4" = _Pz3rqYvh;
        "pkg-1.21.1-1.4.5" = _dUUaarL5;
        "pkg-1.21.1-1.4.6" = _m04H34z7;
        "pkg-1.21.1-1.4.7" = _qmAPIQdh;
        "pkg-1.21.1-1.4.8" = _USH5Tvjw;
        "pkg-1.21.1-1.0.2" = _Q5cFf2dx;
        "pkg-1.21.1-1.4.9" = _xEt5UtgN;
        "pkg-1.21.1-1.4.10" = _9J7fmvHr;
        "pkg-1.21.1-1.4.11" = _kSXfnXlJ;
        "pkg-1.21.1-1.4.12" = _8NdIZ9Lk;
        "pkg-1.21.1-1.4.13" = _Sj7yaDZR;
