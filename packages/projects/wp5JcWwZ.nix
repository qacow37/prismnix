...
let
    ...
    in {
        ...
        "pkg-1.0.5" = _hnvCq2yf;
        "pkg-1.0.6" = _AJlFl4Pa;
        "pkg-2.0.8-beta+forge-1.20.6" = _r6WbopqH;
        "pkg-2.0.8-beta+forge-1.18" = _sfn9TXBM;
        "pkg-2.0.8-beta+forge-1.16.5" = _AAiky6hg;
        "pkg-2.0.8-beta+neoforge-1.20.6" = _Oh2ZcFe0;
        "pkg-2.0.8-beta+fabric-1.20.6" = _kkod7xKP;
        "pkg-2.0.8-beta+fabric-1.19" = _SGAyo9r5;
        "pkg-2.0.8-beta+fabric-1.18" = _s7oNjUwZ;
        "pkg-2.0.8-beta+forge-1.19" = _nyuEVuMP;
        "pkg-2.0.9-beta+forge-1.19" = _lQsa9jxY;
        "pkg-2.0.9-beta+neoforge-1.20.6" = _IzWIRDlV;
        "pkg-2.0.9-beta+forge-1.18" = _5NPdXgZM;
        "pkg-2.0.9-beta+forge-1.20.6" = _6XnVm0hH;
        "pkg-2.0.9-beta+forge-1.16.5" = _Ki3ybuej;
        "pkg-2.0.9-beta+fabric-1.18" = _Xayyhmbk;
        "pkg-2.0.9-beta+fabric-1.20.6" = _xfYUzr54;
        "pkg-2.0.9-beta+fabric-1.19" = _CmbZ8twD;
        "pkg-2.0.10-beta+forge-1.16.5" = _7ATmIPLR;
        "pkg-2.0.10-beta+forge-1.19" = _TNiXc5l0;
        "pkg-2.0.10-beta+neoforge-1.20.6" = _xJdsYIpM;
        "pkg-2.0.10-beta+forge-1.18" = _lSpSt94g;
        "pkg-2.0.10-beta+fabric-1.20.6" = _QPG0OXiz;
        "pkg-2.0.10-beta+forge-1.20.6" = _fYtxO0o4;
        "pkg-2.0.10-beta+fabric-1.19" = _rayyXzLx;
        "pkg-2.0.10-beta+fabric-1.18" = _7Hi89cD0;
        "pkg-3.0.0-beta+forge-1.20.6" = _RUmEvBmH;
        "pkg-3.0.0-beta+forge-1.16.5" = _v1ZIEORx;
        "pkg-3.0.0-beta+forge-1.19" = _rhUphGzI;
        "pkg-3.0.0-beta+neoforge-1.20.6" = _Z3GLYUyB;
        "pkg-3.0.0-beta+forge-1.18" = _K5TvaZtF;
        "pkg-3.0.0-beta+fabric-1.19" = _qf6QEWSv;
        "pkg-3.0.0-beta+fabric-1.18" = _1WJ1im3z;
        "pkg-3.0.0-beta+fabric-1.20.6" = _zEN0iMA6;
        "pkg-3.1.0-beta+forge-1.18" = _Sy6CbucB;
        "pkg-3.1.0-beta+neoforge-1.20.6" = _aQ3wDBal;
        "pkg-3.1.0-beta+forge-1.19" = _MaZlab3P;
        "pkg-3.1.0-beta+forge-1.20.6" = _tLxOZjWR;
        "pkg-3.1.0-beta+forge-1.16.5" = _5xj5BPB2;
        "pkg-3.1.0-beta+fabric-1.20.6" = _FiCOaP6B;
        "pkg-3.1.0-beta+fabric-1.19" = _O4MfpTA6;
        "pkg-3.1.0-beta+fabric-1.18" = _Tu4arENa;
        "pkg-3.1.1-beta+forge-1.16.5" = _kIFjFxWc;
        "pkg-3.1.1-beta+forge-1.20.6" = _ZtXusHky;
        "pkg-3.1.1-beta+neoforge-1.20.6" = _i6p42LXG;
        "pkg-3.1.1-beta+fabric-1.20.6" = _ZYBO92eO;
        "pkg-3.1.1-beta+forge-1.18" = _9lDk216z;
        "pkg-3.1.1-beta+fabric-1.19" = _VzPhzRSu;
        "pkg-3.1.1-beta+forge-1.19" = _UcYEOnZw;
        "pkg-3.1.1-beta+fabric-1.18" = _ek6Pa4RI;
        "pkg-4.1.3-alpha+neoforge-1.20.6" = _pyTfKUsa;
        "pkg-4.1.3-alpha+forge-1.20.6" = _6rUu4nIP;
        "pkg-4.1.3-alpha+forge-1.16.5" = _xEWZbfug;
        "pkg-4.1.3-alpha+neoforge-1.21.11" = _P7jxipae;
        "pkg-4.1.3-alpha+fabric-1.18" = _jR1UAkUE;
        "pkg-4.1.3-alpha+fabric-1.20.6" = _uZxK1DSH;
        "pkg-4.1.3-alpha+fabric-1.19" = _1LEL42rm;
        "pkg-4.1.3-alpha+fabric-1.21.11" = _1x8882Yf;
        "pkg-4.1.3-alpha+forge-1.19" = _BCGdDq50;
        "pkg-4.1.3-alpha+forge-1.18" = _ORb7DTUn;
        "pkg-4.1.4-alpha+forge-1.16.5" = _kwxjFMkT;
        "pkg-4.1.4-alpha+forge-1.18" = _QleA3s4L;
        "pkg-4.1.4-alpha+fabric-1.18" = _uexVXlU9;
        "pkg-4.1.4-alpha+forge-1.19" = _dZNdYAnF;
        "pkg-4.1.4-alpha+fabric-1.19" = _2riiDrph;
        "pkg-4.1.4-alpha+forge-1.20.6" = _J1bd4DgD;
        "pkg-4.1.4-alpha+neoforge-1.20.6" = _DjaVLcyw;
        "pkg-4.1.4-alpha+fabric-1.21.11" = _Q0WzKkNv;
        "pkg-4.1.4-alpha+neoforge-1.21.11" = _wsjXjTLu;
        "pkg-4.1.4-alpha+fabric-1.20.6" = _YWupiSpL;
        "pkg-4.2.1-alpha+forge-1.17.1" = _hDUIJEp8;
        "pkg-4.2.1-alpha+forge-1.18.2" = _EXEpAEJy;
        "pkg-4.2.1-alpha+fabric-1.18.2" = _oNZFwPXh;
        "pkg-4.2.1-alpha+forge-1.20.4" = _uKKnCUA7;
        "pkg-4.2.1-alpha+fabric-1.20.4" = _lfe3afbG;
        "pkg-4.2.1-alpha+forge-1.20.6" = _no8UYd5Q;
        "pkg-4.2.1-alpha+fabric-1.20.5" = _BUwaCgIV;
        "pkg-4.2.1-alpha+neoforge-1.20.6" = _rxUpIOw1;
        "pkg-4.2.1-alpha+fabric-1.20.6" = _lVRtn3JF;
        "pkg-4.2.1-alpha+fabric-1.21.10" = _ZP01VCac;
        "pkg-4.2.1-alpha+neoforge-1.21.10" = _gNuv3GhC;
        "pkg-4.2.1-alpha+fabric-1.21.11" = _lHsjZDBr;
        "pkg-4.2.1-alpha+neoforge-1.21.11" = _PNUTvUNo;
        "pkg-5.0.0-beta+forge-1.20.6" = _Wm9XGSC6;
        "pkg-5.0.0-beta+forge-1.16.5" = _S1lDlIHN;
        "pkg-5.0.0-beta+forge-1.19" = _gNrOWefr;
        "pkg-5.0.0-beta+neoforge-1.20.6" = _T2NA1yvR;
        "pkg-5.0.0-beta+forge-1.18" = _mCFpLjnM;
        "pkg-5.0.0-beta+fabric-1.19" = _SiZOofcy;
        "pkg-5.0.0-beta+fabric-1.20.5" = _K8AyNQI4;
        "pkg-5.0.0-beta+fabric-1.18" = _Ud1flrxY;
        "pkg-5.0.0-beta+fabric-1.20.6" = _vdU3FW4Y;
        "pkg-5.0.0-beta+fabric-1.21.1" = _GpYLdYUM;
        "pkg-5.0.0-beta+neoforge-1.21.1" = _uHcq5Uoa;
        "pkg-5.0.0-beta+neoforge-1.21.11" = _rcmmY8xE;
        "pkg-5.0.0-beta+fabric-1.21.11" = _6MWetDVo;
        "pkg-5.0.1-beta+forge-1.18" = _lRLfVEaO;
        "pkg-5.0.1-beta+forge-1.19" = _bRYVwjKU;
        "pkg-5.0.1-beta+forge-1.16.5" = _vvwZhlB4;
        "pkg-5.0.1-beta+forge-1.20.6" = _twIsacJf;
        "pkg-5.0.1-beta+fabric-1.18" = _Cg3dxiH4;
        "pkg-5.0.1-beta+fabric-1.19" = _H0SuZoqI;
        "pkg-5.0.1-beta+fabric-1.20.6" = _4L5mG66V;
        "pkg-5.0.1-beta+fabric-1.20.5" = _1CmH91Gh;
        "pkg-5.0.1-beta+neoforge-1.20.6" = _KZmoWsVI;
        "pkg-5.0.1-beta+fabric-1.21.1" = _xMHy3zC6;
        "pkg-5.0.1-beta+neoforge-1.21.1" = _S5LtIQFb;
        "pkg-5.0.1-beta+neoforge-1.21.11" = _GJA77gu0;
        "pkg-5.0.1-beta+fabric-1.21.11" = _Cr0LObmf;
        "pkg-5.0.2-beta+neoforge-1.20.6" = _H1rPV4iH;
        "pkg-5.0.2-beta+forge-1.18" = _63Cg5dcE;
        "pkg-5.0.2-beta+forge-1.19" = _jX4DLD7V;
        "pkg-5.0.2-beta+forge-1.20.6" = _g3Wn4dwH;
        "pkg-5.0.2-beta+fabric-1.19" = _Hbbuyvv9;
        "pkg-5.0.2-beta+fabric-1.20.6" = _E7rXOKIv;
        "pkg-5.0.2-beta+fabric-1.20.5" = _3jga79yL;
        "pkg-5.0.2-beta+fabric-1.21.1" = _zwOBdGxq;
        "pkg-5.0.2-beta+fabric-1.18" = _i8XVXEyD;
        "pkg-5.0.2-beta+forge-1.16.5" = _37AbLKaW;
        "pkg-5.0.2-beta+neoforge-1.21.1" = _UyOIaXss;
        "pkg-5.0.2-beta+neoforge-1.21.11" = _CiqPLWd4;
        "pkg-5.0.2-beta+fabric-1.21.11" = _4aqIhgAG;
        "pkg-5.1.0-beta+forge-1.16.5" = _Kdq7E01o;
        "pkg-5.1.0-beta+forge-1.18" = _Wv4FMxBh;
        "pkg-5.1.0-beta+forge-1.19" = _P5T7eGUs;
        "pkg-5.1.0-beta+fabric-1.18" = _OBZVQqTG;
        "pkg-5.1.0-beta+fabric-1.19" = _dS73hDQT;
        "pkg-5.1.0-beta+fabric-1.20.5" = _9zFlBPJn;
        "pkg-5.1.0-beta+forge-1.20.6" = _bY4XmLaI;
        "pkg-5.1.0-beta+fabric-1.20.6" = _9c6I1Pj7;
        "pkg-5.1.0-beta+neoforge-1.21.1" = _CKinC4b1;
        "pkg-5.1.0-beta+fabric-1.21.11" = _Dm67LIjb;
        "pkg-5.1.0-beta+fabric-1.21.1" = _E9g3BUgt;
        "pkg-5.1.0-beta+neoforge-1.20.6" = _FMbJq6zi;
        "pkg-5.1.0-beta+neoforge-1.21.11" = _eSl70JQU;
        "pkg-5.1.1-beta+forge-1.18" = _K20HqMZh;
        "pkg-5.1.1-beta+forge-1.19" = _DL2Is8Za;
        "pkg-5.1.1-beta+forge-1.16.5" = _xKSkwTQV;
        "pkg-5.1.1-beta+forge-1.20.6" = _5P4vPAJP;
        "pkg-5.1.1-beta+fabric-1.19" = _bnwjhnd7;
        "pkg-5.1.1-beta+fabric-1.20.5" = _PpU2XgiE;
        "pkg-5.1.1-beta+fabric-1.20.6" = _Z7C68Kd7;
        "pkg-5.1.1-beta+fabric-1.18" = _aIkN2Ggb;
        "pkg-5.1.1-beta+neoforge-1.20.6" = _7ePkjmrg;
        "pkg-5.1.1-beta+neoforge-1.21.1" = _fD5Mu69l;
        "pkg-5.1.1-beta+neoforge-1.21.11" = _L81htVD9;
        "pkg-5.1.1-beta+fabric-1.21.11" = _ZJNEViQA;
        "pkg-5.1.1-beta+fabric-1.21.1" = _P97xNoWo;
        "pkg-6.0.0-beta+forge-1.16.5" = _obWVAqLl;
        "pkg-6.0.0-beta+forge-1.18" = _iS7x8jqk;
        "pkg-6.0.0-beta+forge-1.19" = _oM6mFnMS;
        "pkg-6.0.0-beta+fabric-1.18" = _vBe1wUNc;
        "pkg-6.0.0-beta+fabric-1.19" = _CJPjGcIA;
        "pkg-6.0.0-beta+fabric-1.20.5" = _b2wsu3XV;
        "pkg-6.0.1-beta+neoforge-26.1.2" = _iByzdC9w;
        "pkg-6.0.1-beta+neoforge-26.1" = _7dydh6O2;
        "pkg-6.0.1-beta+neoforge-26.1.1" = _rowEwQyq;
        "pkg-6.0.1-beta+fabric-26.1.1" = _rD5LIqGW;
        "pkg-6.0.1-beta+fabric-26.1.2" = _Lgl6UGwE;
        "pkg-6.0.1-beta+fabric-26.1" = _NGIfq3WY;
        "pkg-6.0.1-beta+neoforge-1.21.1" = _kfKEygq1;
        "pkg-6.0.1-beta+fabric-1.21.1" = _Snd9aCkq;
        "pkg-6.0.1-beta+neoforge-1.21.11" = _Ft29pdTr;
        "pkg-6.0.1-beta+fabric-1.21.11" = _EfkDkE6V;
        "default" = _EfkDkE6V;
    });
