...
let
    ...
    in {
        ...
        "pkg-1.2.8" = _VCaAF0Th;
        "pkg-1.2.9" = _shTJNIoc;
        "pkg-1.2.9.1" = _MFStNniu;
        "pkg-1.2.9.2" = _E47BY5CQ;
        "pkg-1.2.9.3" = _zSHzVgcM;
        "pkg-1.2.7.1" = _oSihlCcg;
        "pkg-1.2.8.1" = _Cz8D6Gf4;
        "pkg-1.2.9.4" = _RbB7NE4J;
        "pkg-1.2.8.2" = _dsh461UI;
        "pkg-1.2.9.5" = _xAUlIfWt;
        "pkg-1.2.8.3" = _5cBEeWhy;
        "pkg-1.2.9.6" = _8cMtg5EZ;
        "pkg-1.2.8.4" = _19k5SN7e;
        "pkg-1.2.9.6.2" = _SD1PQa6W;
        "pkg-2.0.0" = _WNuFBTR7;
        "pkg-2.0.1" = _6rFUzbQy;
