...
let
    ...
    in {
        ...
        "pkg-0.21" = _ksVEwnmJ;
        "pkg-0.22" = _2pkUP9y8;
        "pkg-0.22+mod" = _VMyTvM0D;
        "pkg-0.23" = _dVLg06pL;
        "pkg-0.23+mod" = _H5qK5LvH;
        "pkg-0.24" = _i2zuKIqm;
        "pkg-0.24+mod" = _JfZYz6jK;
        "pkg-0.25" = _van9xSk2;
        "pkg-0.25.1" = _CqZqSMST;
        "pkg-0.25+mod" = _srB3py5k;
        "pkg-0.25.1+mod" = _HoYlm0pN;
        "pkg-0.26" = _r8EpmrTT;
        "pkg-0.26-1.20.2" = _kTB1hTuF;
        "pkg-0.26+mod" = _RdWWPZMo;
        "pkg-0.26-1.20.2+mod" = _1YTYoPPs;
        "pkg-0.27" = _PypYEyjp;
        "pkg-0.27+mod" = _Wl8Ud1cp;
        "pkg-1.0.0" = _e0AB0UJ0;
        "pkg-1.0.0+mod" = _J28MgkvI;
        "pkg-1.0.1" = _IOMhYpdd;
        "pkg-1.0.1+mod" = _Y70ZBfBv;
        "pkg-1.0.2" = _8IFtYrio;
        "pkg-1.0.2+mod" = _ALsp6iHb;
        "pkg-1.0.3" = _Qx5Pbttj;
        "pkg-1.0.3+mod" = _atbxbSOU;
        "pkg-1.0.4" = _iD4hL9pm;
        "pkg-1.0.4+mod" = _8YqxFY5D;
        "pkg-1.0.5" = _BjVbIfwf;
        "pkg-1.0.5+mod" = _kEpaZ6p7;
        "pkg-1.0.6" = _p4MWHMPb;
        "pkg-1.0.6+mod" = _f1OKB3dV;
        "pkg-1.0.7" = _Fn4TRQmH;
        "pkg-1.0.7+mod" = _VuF3h7wD;
        "default" = _VuF3h7wD;
    });
