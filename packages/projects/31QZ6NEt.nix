...
let
    ...
    in {
        ...
        "pkg-mc1.18.x-v1.0.0-forge" = _5CtkYgw6;
        "pkg-mc1.18.x-v1.0.0-fabric" = _yVTcbzIg;
        "pkg-mc1.18.x-v1.0.0-quilt" = _77VmPo1W;
        "pkg-mc1.19.x-v1.0.1-forge" = _9NcXynEW;
        "pkg-mc1.19.x-v1.0.1-fabric" = _2Dxqg50P;
        "pkg-mc1.19.x-v1.0.1-quilt" = _vaCZXgvd;
        "pkg-mc1.16.x-v1.0.1-fabric" = _AlBm9PJT;
        "pkg-mc1.18.x-v1.0.1-forge" = _Jv94E2Aq;
        "pkg-mc1.18.x-v1.0.1-fabric" = _RzIJKMDY;
        "pkg-mc1.18.x-v1.0.1-quilt" = _47sd8XG0;
        "pkg-mc1.18.x-v1.0.1-forge-Hotfix" = _C4MgV7cg;
        "pkg-mc1.17.x-v1.0.0-forge" = _5yHEwVAs;
        "pkg-mc1.17.x-v1.0.0-fabric" = _1UNqw3cw;
        "pkg-mc1.18.x-v1.0.2-forge" = _QJu458HY;
        "pkg-mc1.19.x-v1.0.2-forge" = _amCF1q1A;
        "pkg-mc1.19.x-v1.0.2-Hotfix-forge" = _flTRN0Su;
        "pkg-mc1.19.x-v1.0.2-quilt" = _erMCwVqc;
        "pkg-mc1.18.x-v1.0.2-quilt" = _TTlOVUc9;
        "pkg-mc1.19.x-v1.0.2-fabric" = _RuduTZzd;
        "pkg-mc1.18.x-v1.0.2-fabric" = _GzTBTeX0;
        "pkg-mc1.12.2-v1.0.0-legacyfabric" = _MwRv0Sc0;
        "pkg-mc1.18.x-v1.0.2-Hotfix-quilt" = _qfzfHKpH;
        "pkg-mc1.19.x-v1.0.2-Hotfix-quilt" = _sAq7MlKJ;
        "pkg-mc1.15.x-v1.0.0-forge" = _7U9OumsY;
        "pkg-mc1.15.x-v1.0.0-fabric" = _Xtfk2GPn;
        "pkg-mc1.16.5-v1.1.0-forge-arch" = _Bv5gYaZs;
        "pkg-mc1.16.5-v1.1.0-fabric-arch" = _wRL2EU7S;
        "pkg-mc1.17.x-v1.1.0-forge-arch" = _9nARg6sg;
        "pkg-mc1.17.x-v1.1.0-fabric-arch" = _ZUtlCkgi;
        "pkg-mc1.18.x-v1.1.0-forge-arch" = _K5sf06LZ;
        "pkg-mc1.18.x-v1.1.0-fabric-arch" = _Pc7uxsiy;
        "pkg-mc1.19.x-v1.1.0-forge-arch" = _HkmaLbgz;
        "pkg-mc1.19.x-v1.1.0-fabric-arch" = _5T27ZSfJ;
        "pkg-mc1.19.3-v1.0.2-Hotfix-fabric" = _BMUoYLnk;
        "pkg-mc1.19.3-v1.0.2-Hotfix-quilt" = _buWIrx7e;
        "pkg-mc1.19.3-v1.0.2-Hotfix-forge" = _bWptjNpk;
        "pkg-mc1.16.5-v1.1.1-fabric-arch" = _Tf9Uo7oj;
        "pkg-mc1.16.5-v1.1.1-forge-arch" = _FkaaFW70;
        "pkg-mc1.17.x-v1.1.1-fabric-arch" = _lHpLzeEQ;
        "pkg-mc1.17.x-v1.1.1-forge-arch" = _L6ePv7kf;
        "pkg-mc1.18.x-v1.1.1-fabric-arch" = _2uYY3R69;
        "pkg-mc1.18.x-v1.1.1-forge-arch" = _26g51yyX;
        "pkg-mc1.19.x-v1.1.1-fabric-arch" = _kzsoH607;
        "pkg-mc1.19.x-v1.1.1-forge-arch" = _dbPseR2O;
        "pkg-mc1.19.x-v1.1.2-fabric-arch" = _T55jVPzT;
        "pkg-mc1.19.x-v1.1.2-forge-arch" = _Qu5iVVaH;
        "pkg-mc1.18.x-v1.0.3beta1-fabric" = _gDCZO8Zt;
        "pkg-mc1.18.x-v1.0.3beta1-forge" = _D6IvyhdF;
        "pkg-mc1.18.x-v1.0.3beta1-quilt" = _qhZB88Ln;
        "pkg-mc1.19.x-v1.0.3beta1-fabric" = _9I5KTvUs;
        "pkg-mc1.19.x-v1.0.3beta1-forge" = _2gNPOSSS;
        "pkg-mc1.19.x-v1.0.3beta1-quilt" = _PSJ6pb1M;
        "pkg-mc1.19.3-v1.0.3beta1-fabric" = _Di8nqeKZ;
        "pkg-mc1.19.3-v1.0.3beta1-forge" = _KzlCh93Y;
        "pkg-mc1.19.3-v1.0.3beta1-quilt" = _BiU8eVuR;
        "pkg-mc1.17.x-v1.0.3beta1-fabric" = _M4Ij218I;
        "pkg-mc1.17.x-v1.0.3beta1-forge" = _1ug643Fz;
        "pkg-mc1.16.5-v1.0.3beta1-fabric" = _liUTx3zx;
        "pkg-mc1.16.5-v1.0.3beta1-forge" = _SmV4KzK2;
        "pkg-mc1.19.3-v1.0.3beta1-fix1-fabric" = _q019frqT;
        "pkg-mc1.19.3-v1.0.3beta1-fix1-forge" = _HLqEIWIj;
        "pkg-mc1.19.3-v1.0.3beta1-fix1-quilt" = _dwRqc1MU;
        "pkg-mc1.19.x-v1.0.3beta1-fix1-fabric" = _InT6rdLa;
        "pkg-mc1.19.x-v1.0.3beta1-fix1-forge" = _sgWN1odz;
        "pkg-mc1.19.x-v1.0.3beta1-fix1-quilt" = _ZZlIprmi;
        "pkg-mc1.17.x-v1.0.3beta1-fix1-fabric" = _3UNiYeK9;
        "pkg-mc1.17.x-v1.0.3beta1-fix1-forge" = _ggmjMiN7;
        "pkg-mc1.15.x-v1.0.3beta1-fabric" = _CcssVWT4;
        "pkg-mc1.15.x-v1.0.3beta1-forge" = _P69MHRsX;
        "pkg-mc1.12.2-v0.1.1b1-legacy-fabric" = _ZCm39aYn;
        "pkg-mc1.12.2-v0.1.1b1-legacy-forge" = _nYtruffZ;
        "pkg-mc1.12.2-v0.1.1b2-legacy-fabric" = _7TNUEJC6;
        "pkg-mc1.12.2-v0.1.1b2-legacy-forge" = _8xfDYDQ2;
        "pkg-mc1.18.x-v1.0.3b2-fabric" = _gJVo1HuM;
        "pkg-mc1.18.x-v1.0.3b2-forge" = _9ZlszopC;
        "pkg-mc1.18.x-v1.0.3b2-quilt" = _mb4bpgBi;
        "pkg-mc1.19.3-v1.0.3b2-fabric" = _qSLYn7Jy;
        "pkg-mc1.19.3-v1.0.3b2-forge" = _FV7LSKo9;
        "pkg-mc1.19.3-v1.0.3b2-quilt" = _nxciT2tM;
        "pkg-mc1.15.x-v1.0.3b2-fabric" = _cqmF3SNU;
        "pkg-mc1.15.x-v1.0.3b2-forge" = _oGk7wgVu;
        "pkg-mc1.16.5-v1.0.3b2-fabric" = _eZZsjddq;
        "pkg-mc1.16.5-v1.0.3b2-forge" = _hLOPemS8;
        "pkg-mc1.17.x-v1.0.3b2-fabric" = _rWIfwQgT;
        "pkg-mc1.17.x-v1.0.3b2-forge" = _n7d5dA8p;
        "pkg-mc1.12.2-v0.1.1b2-fabric" = _Nfm3FrLj;
        "pkg-mc1.12.2-v0.1.1b2-forge" = _XwRECW36;
        "pkg-1.1.3b1-1.17.1-fabric" = _giayqfT4;
        "pkg-1.1.3b1-1.17.1-forge" = _zXYkAi7U;
        "pkg-1.1.3b1-1.19.3-forge" = _q7GSYjgn;
        "pkg-1.1.3b1-1.19.3-fabric" = _sPNoD2SC;
        "pkg-1.1.3b1-1.19.2-fabric" = _SrI6MDXh;
        "pkg-1.1.3b1-1.19.2-forge" = _OxGQbp99;
        "pkg-1.1.3b1-1.18.2-fabric" = _TfS6U7EB;
        "pkg-1.1.3b1-1.18.2-forge" = _Hti3iLp9;
        "pkg-1.1.3beta1-1.16.5-fabric" = _Zw0WeU69;
        "pkg-1.1.3beta1-1.16.5-forge" = _qh6jP32J;
        "default" = _qh6jP32J;
    });
