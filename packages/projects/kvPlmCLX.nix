...
let
    ...
    in {
        ...
        "pkg-1.1.0-forge" = _KMtImfWS;
        "pkg-1.1.0-fabric" = _YLmhPs9T;
        "pkg-2.0.1-forge" = _QVn8esz6;
        "pkg-2.0.1-fabric" = _2CZnchY8;
        "pkg-3.0.0-fabric" = _2nvKRSU6;
        "pkg-2.1.0-forge" = _baEnMHnR;
        "pkg-2.1.0-fabric" = _HZCNd8SE;
        "pkg-3.1.0-forge" = _GJxLMYXG;
        "pkg-3.1.0-fabric" = _cRMOITZG;
        "pkg-4.0.0-quilt" = _bDD882aJ;
        "pkg-4.0.0-forge" = _EgWoZOaS;
        "pkg-4.0.0-fabric" = _54R7x5ju;
        "pkg-5.0.0-quilt" = _lUhagwhK;
        "pkg-5.0.0-forge" = _ILXp23Qo;
        "pkg-5.0.0-fabric" = _mKf9A3l5;
        "pkg-2.1.1-forge" = _JvhDjLAf;
        "pkg-2.1.1-fabric" = _Aqz6X2SQ;
        "pkg-3.1.1-forge" = _aqBZ3AuD;
        "pkg-3.1.1-fabric" = _HidA1YiA;
        "pkg-4.0.1-quilt" = _HgHTsaTC;
        "pkg-4.0.1-forge" = _K9dHJdQr;
        "pkg-4.0.1-fabric" = _hHiwWQIR;
        "pkg-5.0.1-quilt" = _CtLspB4e;
        "pkg-5.0.1-forge" = _It8a9HUU;
        "pkg-5.0.1-fabric" = _65HbCuIL;
        "pkg-6.0.0-forge" = _4AVZaBCq;
        "pkg-6.0.1-quilt" = _b7QwLa4D;
        "pkg-6.0.1-forge" = _VeXIIqSC;
        "pkg-6.0.1-fabric" = _JsbfxdYz;
        "pkg-7.0.0-quilt" = _zlGKhPve;
        "pkg-7.0.0-forge" = _NAc1yt1d;
        "pkg-7.0.0-fabric" = _45odkucL;
        "pkg-8.0.0-quilt" = _GeNKXJO4;
        "pkg-8.0.0-forge" = _NNJ94HqL;
        "pkg-8.0.0-fabric" = _UFVw0L3n;
        "pkg-8.1.0+1.20-quilt" = _eA1u3hGo;
        "pkg-8.1.0+1.20-forge" = _D3UlmZ5I;
        "pkg-8.1.0+1.20-fabric" = _Z2Qc3CIl;
        "pkg-9.0.0+1.20.1-quilt" = _nANDlE8t;
        "pkg-9.0.0+1.20.1-forge" = _QeOPqA8c;
        "pkg-9.0.0+1.20.1-fabric" = _MWIwz8Ky;
        "pkg-9.0.1+1.20.1-quilt" = _zBYY2IcI;
        "pkg-9.0.1+1.20.1-forge" = _9QkNF4Jt;
        "pkg-9.0.1+1.20.1-fabric" = _Zfnkk7jP;
        "pkg-20.2.0-neoforge" = _7IHrX36h;
        "pkg-20.2.0-forge" = _cdrEw8Uk;
        "pkg-20.2.0-fabric" = _YRKOh9rb;
        "pkg-20.2.1-neoforge" = _3LBfnzeN;
        "pkg-20.2.1-forge" = _SAP0PiL1;
        "pkg-20.2.1-fabric" = _e9NmteWn;
        "pkg-20.2.2-neoforge" = _YK1WxpQM;
        "pkg-20.2.2-forge" = _miVzpXfw;
        "pkg-20.2.2-fabric" = _auFIlpsh;
        "pkg-20.2.3-neoforge" = _frdtxNxr;
        "pkg-20.2.3-forge" = _Y5VjWpmM;
        "pkg-20.2.3-fabric" = _BzPbABRJ;
        "pkg-20.4.0-neoforge" = _YT40BqBU;
        "pkg-20.4.0-forge" = _XyXOSwQi;
        "pkg-20.4.0-fabric" = _cE9Ykhpx;
        "pkg-20.4.1-neoforge" = _6caMDMAT;
        "pkg-20.4.1-forge" = _ePD5zlrk;
        "pkg-20.4.1-fabric" = _pY4dj9eb;
        "pkg-20.6.0-neoforge" = _mE3r9rlF;
        "pkg-20.6.0-forge" = _r38f8ULd;
        "pkg-20.6.0-fabric" = _NQsygrG5;
        "pkg-20.6.1-neoforge" = _5utsDcUH;
        "pkg-20.6.1-forge" = _4GUBR9WE;
        "pkg-20.6.1-fabric" = _lWbAyZGn;
        "pkg-21.0.0-neoforge" = _jKkh36tw;
        "pkg-21.0.0-fabric" = _52eo05D3;
        "pkg-21.0.1-neoforge" = _6FDX9jf4;
        "pkg-21.0.1-fabric" = _cNSPxQMU;
        "pkg-21.1.0-neoforge" = _wEJ9LdtG;
        "pkg-21.1.0-fabric" = _CnQ1gH9h;
        "pkg-21.2.0-neoforge" = _eS2iF7B2;
        "pkg-21.2.0-fabric" = _pRgOKADy;
        "pkg-21.3.0-neoforge" = _98kwtm1u;
        "pkg-21.3.0-fabric" = _QN4ph7WN;
        "pkg-21.4.0-neoforge" = _cqrBP5PP;
        "pkg-21.4.0-fabric" = _PAddbzme;
        "pkg-21.5.0-neoforge" = _u3dlRx6p;
        "pkg-21.5.0-fabric" = _qvnZw9nZ;
        "pkg-20.6.2-neoforge" = _JqBnKGpz;
        "pkg-20.6.2-forge" = _c2Ft9XNm;
        "pkg-20.6.2-fabric" = _CbdA38WJ;
        "pkg-21.0.2-neoforge" = _2u9Bot8M;
        "pkg-21.0.2-fabric" = _23E6vK5K;
        "pkg-21.1.1-neoforge" = _5enXeKOr;
        "pkg-21.1.1-fabric" = _oSYsYqDO;
        "pkg-21.2.1-neoforge" = _DW7Zzygi;
        "pkg-21.2.1-fabric" = _zVM6fgxS;
        "pkg-21.3.1-neoforge" = _LN6Q3ljs;
        "pkg-21.3.1-fabric" = _jEnwFL7f;
        "pkg-21.4.1-neoforge" = _tk50yByU;
        "pkg-21.4.1-fabric" = _bldWdHub;
        "pkg-21.5.1-neoforge" = _5QcN1S1T;
        "pkg-21.5.1-fabric" = _U1ofXur7;
        "default" = _U1ofXur7;
    });
