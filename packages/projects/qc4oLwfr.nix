...
let
    ...
    in {
        ...
        "pkg-1.6.0" = _a3kUBfUT;
        "pkg-1.7.0" = _v2IdCRmH;
        "pkg-1.7.0-1.18.2" = _HF1G9ujO;
        "pkg-1.8.0" = _DQ0B7SQZ;
        "pkg-1.8.0-1.19" = _tg3hBQcE;
        "pkg-1.8.1-1.18.2" = _kB7wJlYM;
        "pkg-1.8.1-1.19.1" = _QQOh0D4t;
        "pkg-1.9.0-1.19.1" = _fcrefVzb;
        "pkg-1.9.0-1.18.2" = _qnaOYRrI;
        "pkg-1.10.0-1.18.2" = _tGp7mr7A;
        "pkg-1.10.0-1.19.1" = _ak4cHBXc;
        "pkg-1.10.1-1.18.2" = _KG68JIVC;
        "pkg-1.10.1-1.19.2" = _C7PYhqvB;
        "pkg-1.10.2-1.19.3" = _A3ipwNqL;
        "pkg-1.10.5-1.20.1" = _fY3XuhMg;
        "pkg-1.10.5-1.20.2" = _UPqHjCs8;
        "pkg-1.11.0-1.20.4" = _6wceoyx5;
        "pkg-1.11.1-1.20.4" = _3oA02nXA;
        "pkg-1.12.0-1.21" = _Rz5i8nld;
        "default" = _Rz5i8nld;
    });
