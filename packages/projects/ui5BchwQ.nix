...
let
    ...
    in {
        ...
        "pkg-1.8" = _PTZGsQQ9;
        "pkg-1.9" = _k568GbHj;
        "pkg-1.10.0" = _968rXn0m;
        "pkg-1.10.1" = _oxqXaR0U;
        "pkg-1.10.2" = _6en0Oc3s;
        "pkg-1.11.0" = _YHQ5p9rh;
        "pkg-1.12.0" = _NBjGE9do;
        "pkg-1.13.0" = _5U2aC8Er;
        "pkg-1.13.1" = _nZ3FNoLX;
        "pkg-1.13.2" = _QI7Qxy2O;
        "pkg-1.13.3" = _ig4VhsQp;
        "pkg-1.13.3.B4" = _iirNoxPJ;
        "pkg-1.13.4" = _641VZQ1l;
        "pkg-1.13.5" = _zaMHf5S7;
        "pkg-1.13.6" = _lj2c9BTd;
        "pkg-1.14.0" = _jABPTu1s;
        "pkg-1.14.1" = _Ol6BGJQZ;
        "pkg-1.14.2" = _J2KqDTQd;
        "pkg-1.14.3" = _VD6Yegwg;
        "pkg-1.15.0" = _ctV40VSa;
        "default" = _ctV40VSa;
    });
