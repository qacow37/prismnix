...
let
    ...
    in {
        ...
        "pkg-8.0.3" = _P3JOFATB;
        "pkg-9.0.1" = _vuEToW4K;
        "pkg-10.0.1" = _1p5WwWAW;
        "pkg-10.0.3" = _9CdGEW64;
        "pkg-10.0.4" = _yHHIcJvL;
        "pkg-10.0.5" = _RmQMiUe3;
        "pkg-10.0.6" = _4ryLikgZ;
        "pkg-11.0.1" = _70A9gmzM;
        "pkg-7.0.3" = _8q0PGeXU;
        "pkg-12.0.1" = _TMrujoaj;
        "pkg-12.0.2" = _aas1CbIm;
        "pkg-12.1.3" = _TukUzIcC;
        "pkg-13.0.1" = _LJWdJOSV;
        "pkg-13.0.2" = _sm61pWO7;
        "pkg-14.0.1" = _u25VqDm8;
        "pkg-14.1.2" = _hWz2Awrw;
        "pkg-14.1.3" = _cj3o84v9;
        "pkg-14.1.4" = _reRhkNTi;
        "pkg-15.0.1" = _jQ5p5ND2;
        "pkg-16.0.1" = _I2w8M4mq;
        "pkg-16.0.2" = _62AFoUvJ;
        "pkg-16.1.5" = _cKhkQvLD;
        "pkg-17.0.1" = _8NW8l8dP;
        "pkg-18.0.1" = _WoGMNiSU;
        "pkg-18.0.2" = _eIrXt8Bi;
        "pkg-19.0.1" = _HyoHijn6;
        "pkg-19.0.2" = _IYo5rw8E;
        "pkg-19.0.3" = _ywgYfcKF;
        "pkg-19.0.4" = _BMwS7nMg;
        "pkg-19.0.5" = _qqlkLMjC;
        "pkg-20.0.1" = _o3Qg7l9J;
        "pkg-21.0.2" = _yQfMlQal;
        "pkg-21.0.3" = _310JnL1O;
        "pkg-21.1.1" = _vrtgvFif;
        "pkg-21.1.2" = _7r8C3sc6;
        "pkg-21.1.3" = _SkUXPNJw;
        "pkg-21.1.4" = _hmGv7fqS;
        "pkg-21.1.5" = _gUMJzkgA;
        "pkg-18.0.4" = _sSftHJss;
        "pkg-26.1.2.1" = _9KAUh7DC;
