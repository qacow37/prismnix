...
let
    ...
    in {
        ...
        "pkg-0.1.1-mc1.20.1" = _fqucBUWS;
        "pkg-0.1.1-mc1.19.2" = _uZYQGQkf;
        "pkg-0.1.1-mc1.19.4" = _xMfSZ3hp;
        "pkg-0.1.1-mc1.18.2" = _u4EOCPMt;
        "pkg-0.1.1-mc1.16.5" = _oZzxBUXI;
        "pkg-0.1.2-mc1.19.4" = _lNRTTUyl;
        "pkg-0.1.2-mc1.19.2" = _6U6LS807;
        "pkg-0.1.2-mc1.20.1" = _S3Ker2Jb;
        "pkg-0.1.2-mc1.16.5" = _vCRirDMW;
        "pkg-0.1.2-mc1.18.2" = _jbgczWSE;
        "pkg-0.1.0-mc1.20.4" = _iYDZ7xJo;
        "pkg-0.1.3-mc1.16.5" = _ccyXiwvq;
        "pkg-0.1.3-mc1.18.2" = _qwKuaEXx;
        "pkg-0.1.3-mc1.20.1" = _QYrgiTl2;
        "pkg-0.1.1-mc1.20.4" = _MDJRQAEC;
        "pkg-0.1.4-mc1.20.1" = _rJ5AZYNA;
        "pkg-0.1.2-mc1.20.4" = _1qimlRqg;
        "pkg-0.1.4-mc1.18.2" = _MedTI41G;
        "pkg-0.1.4-mc1.19.2" = _pZWyZA2x;
        "pkg-0.1.4-mc1.16.5" = _Eb3RoAoD;
        "pkg-0.1.2-mc1.20.6" = _mA6GQPCH;
        "pkg-0.1.4-mc1.21" = _10h8CpPt;
        "pkg-0.1.3-mc1.20.6" = _ZXzjDNKX;
        "pkg-0.1.5-mc1.21" = _EBf84WQg;
        "pkg-0.1.6-mc1.21" = _2t6OdCFj;
        "pkg-0.1.8-mc1.21.1" = _p50v8Sgr;
        "pkg-0.1.10-mc1.21.3" = _IemFOuQS;
        "pkg-0.1.9-mc1.21.1" = _5C3HnXgW;
        "pkg-0.2.1-mc1.21.1" = _zhj0CaQ8;
        "pkg-0.1.11-mc1.21.4" = _wcutJwHE;
        "pkg-0.2.1-mc1.21.3" = _mQkCDRtv;
        "pkg-0.2.2-mc1.21.1" = _QWfXDfLG;
        "pkg-0.2.2-mc1.21.3" = _6Sq5rRsW;
        "pkg-0.2.2-mc1.21.4" = _fffNi4Dp;
        "pkg-0.3.1-mc1.21.1" = _Bh7YYrpG;
        "pkg-0.3.1-mc1.21.3" = _3VNSc0Ff;
        "pkg-0.3.1-mc1.21.5" = _kw22GviO;
        "pkg-0.3.1-mc1.21.4" = _J9VNU7jW;
        "pkg-0.4.0+mc1.21.8" = _G45fflf5;
        "pkg-0.4.0+mc1.21.5" = _P9cPKKks;
        "pkg-0.4.0+mc1.21.4" = _YF5JRZmU;
        "pkg-0.4.0+mc1.21.3" = _CbgGOUN9;
        "pkg-0.4.0+mc1.21.1" = _vsVKkDaQ;
        "pkg-0.4.0+mc1.21.10" = _7vPfhUM6;
        "pkg-0.4.1+mc1.21.11" = _XdnPI2Uc;
        "pkg-0.5.0+mc26.1.2" = _YnP1Jq7m;
        "default" = _YnP1Jq7m;
    });
