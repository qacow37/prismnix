...
let
    ...
    in {
        ...
        "pkg-1.20.2" = _2ZQUM6D9;
        "pkg-1.20" = _zBslFG7z;
        "pkg-1.19.4" = _sSN6a5zb;
        "pkg-1.19.3" = _jTSwySlj;
        "pkg-1.19" = _hCHdLlpf;
        "pkg-1.18" = _hF0Us7Uy;
        "pkg-1.17" = _sDAaMrKt;
        "pkg-1.16.2" = _8m3FHjHy;
        "pkg-1.15" = _aM0sjcxy;
        "pkg-1.14.4" = _BwFsJLqd;
        "pkg-1.12.2" = _30eDHFBW;
        "pkg-1.9" = _UU3rnGHu;
        "pkg-1.8.9" = _cvG3u46q;
        "pkg-1.21.3" = _vnjslFsa;
        "pkg-1.21.4" = _pJBdpxrN;
        "pkg-1.21.5" = _v0BIuSOh;
        "pkg-1.21.6" = _4xejYn29;
        "pkg-1.21.7" = _7CcQwLYN;
        "pkg-1.21.10" = _GcIdjWQM;
