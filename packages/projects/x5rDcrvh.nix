...
let
    ...
    in {
        ...
        "pkg-1.2+1.20.6" = _dAOmSg7L;
        "pkg-1.2+1.21" = _ET1OOF5p;
        "pkg-1.2+1.21+mod" = _Y1LagbDB;
        "pkg-1.2.1-mc1.21.3" = _UT0vcBtm;
        "pkg-1.2.1-mc1.21.3+mod" = _8vzoJ9dy;
        "pkg-1.3-mc1.21.4" = _HnJfUJKI;
        "pkg-1.3-mc1.21.4+mod" = _6zN5hzlh;
        "pkg-1.3.1-mc1.21.5" = _EuTycpFi;
        "pkg-1.3.1-mc1.21.5+mod" = _vlCxSRpR;
        "pkg-1.3.1-mc1.21.6" = _k9dUUtsV;
        "pkg-1.3.1-mc1.21.6+mod" = _C6Bris6f;
        "pkg-1.3.1-mc1.21.9" = _2t9pqLND;
        "pkg-1.3.1-mc1.21.9+mod" = _SEeR3mRD;
        "pkg-1.3.2-mc1.21.9" = _dkLyhF1g;
        "pkg-1.3.2-mc1.21.9+mod" = _pbuoGGKl;
        "pkg-1.3.2-mc1.21.11" = _zVnBHNHN;
        "pkg-1.3.2-mc1.21.11+mod" = _jP0B1nYL;
        "pkg-1.3.2-mc26.1" = _NY9IdFwm;
        "pkg-1.3.2-mc26.1+mod" = _xHgljoCh;
        "pkg-1.3.3-mc26.1" = _R1bwjhSS;
