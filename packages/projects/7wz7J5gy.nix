...
let
    ...
    in {
        ...
        "pkg-38.0.0" = _ZBnDupFo;
        "pkg-40.0.0" = _VyNadaSJ;
        "pkg-41.0.0" = _GZW1egyx;
        "pkg-41.0.1" = _K6Rb4tTl;
        "pkg-43.0.0" = _vRwPSg15;
        "pkg-44.0.0" = _oTvqCb9s;
        "pkg-45.0.0" = _LasrP7CT;
        "pkg-40.1.0" = _QBdsVTJc;
        "pkg-45.1.0" = _qshixAIH;
        "pkg-43.1.0" = _evUVpoRh;
        "pkg-40.2.0" = _yyNSJpI2;
        "pkg-43.2.0" = _TeZARRsI;
        "pkg-45.2.0" = _bQRVDihY;
        "pkg-40.3.0" = _NgY0TWP8;
        "pkg-43.3.0" = _FCnp5EoB;
        "pkg-45.3.0" = _Bxpm22Rt;
        "pkg-46.0.0" = _AiQn2tCM;
        "pkg-47.0.0" = _NDPkXC5r;
        "pkg-47.0.1" = _uCp5ZLcg;
        "pkg-202.0.0" = _L0klIhLR;
        "pkg-204.0.0" = _5Nva5nTW;
        "pkg-206.0.0" = _2afNn1Ew;
        "pkg-206.0.1" = _Okd6Voci;
        "pkg-210.0.0" = _Fpb8Wvb1;
        "pkg-210.0.1" = _ymT0GiPk;
        "pkg-218.0.0" = _3SMjyKX6;
        "default" = _3SMjyKX6;
    });
