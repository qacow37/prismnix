...
let
    ...
    in {
        ...
        "pkg-1.3_1.21.4" = _6K8dOM3d;
        "pkg-1.4_1.21.4" = _9laIkDCZ;
        "pkg-2.0_1.21.4" = _LAEUGrrO;
        "pkg-2.0_1.21.5" = _rqEzO2Zu;
        "pkg-2.1_1.21.4" = _SS2xA4QO;
        "pkg-2.1_1.21.5" = _k7SHM5Va;
        "pkg-2.1_1.21.6" = _zzYlMLVV;
        "pkg-2.1_1.21.7" = _5SOjLufo;
        "pkg-2.1_1.21.8" = _Tu46DiHZ;
        "pkg-2.1_1.21.9" = _K8d7HPcH;
        "pkg-2.1-1.21.10" = _k72u0yEv;
        "pkg-2.1-1.21.11" = _oqYfy6Um;
        "pkg-2.1.2-1.21.4" = _ZJW5qAQT;
        "pkg-2.1.2-1.21.5" = _wC5njH1C;
        "pkg-2.1.2-1.21.6" = _t2AOrWZ8;
        "pkg-2.1.2-1.21.7" = _el8SCPlw;
        "pkg-2.1.2-1.21.8" = _VEv3mHPd;
        "pkg-2.1.2-1.21.9" = _joUvEecH;
        "pkg-2.1.2-1.21.10" = _CV4FI8Ku;
        "pkg-2.1.2-1.21.11" = _l3zUrXBJ;
