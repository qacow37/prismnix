...
let
    ...
    in {
        ...
        "pkg-0.12.16" = _XQUzOp1N;
        "pkg-0.13-alpha.1" = _quYhJv5u;
        "pkg-0.13-alpha.2" = _eSyT8vox;
        "pkg-0.13-alpha.3" = _jFGEKbQC;
        "pkg-0.13-alpha.4" = _gPZ1fNkM;
        "pkg-0.13-alpha.5" = _oMHpnfln;
        "pkg-0.13-alpha.6" = _4b97CtsR;
        "pkg-0.13-alpha.7" = _MnTbUniE;
        "pkg-0.13-alpha.8" = _rxl9L71j;
        "pkg-0.13-alpha.9" = _K1nzL2XX;
        "pkg-0.13-alpha.10" = _yqO9cGQ9;
        "pkg-0.13-alpha.11" = _Is5WZsh3;
        "pkg-0.13-alpha.12" = _RGi8uXif;
        "pkg-0.13-RC.1" = _do52Nh9e;
        "pkg-0.13-RC.2" = _eXBkfcFX;
        "pkg-0.13" = _afQFzkv7;
        "pkg-0.13.1" = _nskite2k;
        "pkg-0.13.2" = _qc7r8a8d;
        "pkg-0.13.3" = _iTYW0NTe;
        "pkg-0.13.4" = _5Tssxwfr;
        "pkg-0.13.5" = _oqVN6JSD;
        "pkg-0.14-alpha.1" = _1LgCj5N7;
        "pkg-0.14-alpha.2" = _CZKeTPFz;
        "pkg-0.14-alpha.3" = _wr4Gox78;
        "pkg-0.14-RC.1" = _4zt7wphM;
        "pkg-0.14" = _dxG5trRt;
        "pkg-0.14.1" = _kZwN2O90;
        "pkg-0.14.2" = _w0bBjW1Z;
        "pkg-0.14.3" = _CRdg3Ihx;
        "pkg-0.14.4" = _pZflvg2X;
        "pkg-0.14.5" = _pUsaZeNU;
        "pkg-0.14.6" = _fTi0psVV;
        "pkg-0.14.7" = _1FU6q8nr;
        "pkg-0.14.8" = _ZY5TiCd3;
        "pkg-0.14.9" = _ahUNAQFa;
        "pkg-0.14.10" = _YJsDfOn9;
        "pkg-0.15-alpha.1" = _EPw676uj;
        "pkg-0.15-alpha.2" = _IrYVTEmx;
        "pkg-0.15-alpha.3" = _2M7IBl30;
        "pkg-0.15-alpha.4" = _mgFzmGN3;
        "pkg-0.15-alpha.5" = _enbHvCsk;
        "pkg-0.15-alpha.6" = _zXbbcMnf;
        "pkg-0.15-alpha.7" = _jYMUtsbi;
        "pkg-0.15-alpha.8" = _AFGWMgp1;
        "pkg-0.16-alpha.1" = _DSB4LyLD;
        "pkg-0.16-alpha.2" = _5tDpV0un;
        "pkg-0.16-alpha.3" = _yfRuIKZX;
        "pkg-0.16-alpha.4" = _1gwPo3xn;
        "pkg-0.16-RC.1" = _xIKnjMn7;
        "pkg-0.16-RC.2" = _p5PzHNhE;
        "pkg-0.16" = _2lT5dwNP;
        "pkg-0.16.1" = _y0iykp8c;
        "pkg-0.16.2" = _MsmSnSDx;
        "pkg-0.17-alpha.1" = _yipqY3br;
        "pkg-0.17-alpha.2" = _J3V2ANsA;
        "pkg-0.17-alpha.3" = _zjx32cmY;
        "pkg-0.17-alpha.4" = _eyFzfIhb;
        "pkg-0.17-alpha.5" = _SCqL3OsU;
        "pkg-0.17-alpha.6" = _FBNFVxoa;
        "pkg-0.17-alpha.7" = _PC4pBf1W;
        "pkg-0.17-alpha.8" = _C9MsWevo;
        "pkg-0.17-alpha.9" = _KS52EDAT;
        "pkg-0.17-alpha.10" = _awuIoMT4;
        "pkg-0.17-alpha.11" = _FXKtZ7Qy;
        "pkg-0.17-alpha.12" = _9eBqY62r;
        "pkg-0.17-alpha.13" = _5UesQXYg;
        "pkg-0.17-alpha.14" = _Te1sGogX;
        "pkg-0.17-alpha.15" = _p5oaxBy3;
        "pkg-0.17-alpha.16" = _7SaJnMoc;
        "pkg-0.17-alpha.17" = _xyAimIgw;
        "pkg-0.17-alpha.18" = _1l5Gk2KN;
        "pkg-0.17-alpha.19" = _UvzRIGiv;
        "pkg-0.17-alpha.20" = _88JHCW8P;
        "pkg-0.17-alpha.21" = _M3LzeYqK;
        "pkg-0.17-alpha.22" = _QOCsauMF;
        "pkg-0.17-alpha.23" = _CmxIstNG;
        "pkg-0.17-alpha.24" = _7jfmqAFu;
        "pkg-0.17-alpha.25" = _iIHEJ6Cq;
        "pkg-0.17-alpha.26" = _qDIL7ByE;
        "pkg-0.17-alpha.27" = _pcy0xklr;
        "pkg-0.17-alpha.28" = _wj15iIcl;
        "pkg-0.17-alpha.29" = _t3jXZjyh;
        "pkg-0.17-alpha.30" = _Gh2FR8KH;
        "pkg-0.17-alpha.31" = _3mMkwa5D;
        "pkg-0.17-alpha.32" = _W8cYOnbt;
        "pkg-0.17-alpha.33" = _QBgb0CMa;
        "pkg-0.17-alpha.34" = _uMsIqZia;
        "pkg-0.17-alpha.35" = _JXRxreTp;
        "pkg-0.17-alpha.36" = _BLug0hH6;
        "pkg-0.17-alpha.37" = _6Sz05INp;
        "pkg-0.17-alpha.38" = _tgMHjRVU;
        "pkg-0.17-alpha.39" = _fAoZuXMW;
        "pkg-0.18-alpha.1" = _dvqYSlFe;
        "pkg-0.18-alpha.2" = _Ct56aKyb;
        "pkg-0.18-alpha.3" = _SL7VV5BG;
        "pkg-0.18-alpha.4" = _6xYibNUl;
        "pkg-0.18-alpha.5" = _QdE3nr1u;
        "pkg-0.18-alpha.6" = _53rfnvhh;
        "pkg-0.18-alpha.7" = _sm6xdyzi;
        "pkg-0.18-alpha.8" = _cUWSzXE6;
        "pkg-0.18-alpha.9" = _bhLvA4fT;
        "pkg-0.18-alpha.10" = _3v2Y2mgE;
        "pkg-0.18-alpha.11" = _uNtx2PhG;
        "pkg-0.18-alpha.12" = _Nx5ZaXwl;
        "pkg-0.18-alpha.13" = _BA17c2Mc;
        "pkg-0.18-alpha.14" = _ylJzLR3o;
        "pkg-0.18-alpha.15" = _ToyJBRgN;
        "pkg-0.18-alpha.16" = _c7REXTsF;
        "pkg-0.18-alpha.17" = _Bnm6vnJs;
        "pkg-0.18-alpha.18" = _jzo34mCY;
        "pkg-0.18-alpha.19" = _H9OCjAPz;
        "pkg-0.18-RC.1" = _ze1hvh9q;
        "pkg-0.18-RC.2" = _CyZtU4yT;
        "pkg-0.18-RC.3" = _NGJrNDwo;
        "pkg-0.18-RC.4" = _PMTMbAP9;
        "pkg-0.18-RC.5" = _eR4kVcw1;
        "pkg-0.18-RC.6" = _gTxhQqSI;
        "pkg-0.18-RC.7" = _nyC3wAV5;
        "pkg-0.18-RC.8" = _qZ8kvC8Y;
        "pkg-0.18" = _dAtMVidu;
        "pkg-0.18.1" = _8oYJuUyD;
        "pkg-0.19-alpha.1" = _ZeDkapLP;
        "pkg-0.19-alpha.2" = _StoTCWvf;
        "pkg-0.19-alpha.3" = _a9MWwHlu;
        "pkg-0.19-alpha.4" = _B7HtZVaT;
        "pkg-0.19-alpha.5" = _X7LUoMI6;
        "pkg-0.19-alpha.6" = _SVToJ9mj;
        "pkg-0.19-alpha.7" = _mgATOfxS;
        "pkg-0.19-alpha.8" = _oLWRk4HR;
        "pkg-0.19-alpha.9" = _CyBvRHOk;
        "pkg-0.19-RC.1" = _5JsoiI9R;
        "pkg-0.19-RC.2" = _zrokpjTH;
        "pkg-0.19-RC.3" = _XDFydZAA;
        "pkg-0.19-RC.4" = _I9nJrfqu;
        "pkg-0.19" = _Pw2Nh3eR;
        "pkg-0.20-alpha.1" = _UKKaQlS7;
        "pkg-0.20-alpha.4" = _MZoF8npG;
        "pkg-0.20-alpha.5" = _tkP2BaXb;
        "pkg-0.20-alpha.6" = _erBIdRbU;
        "pkg-0.20-RC.1" = _HhmhyIKo;
        "pkg-0.20-RC.3" = _ch5LahCM;
        "pkg-0.19.1" = _I7863v2R;
        "pkg-0.20.0" = _pGxHSqiK;
        "pkg-0.20.1" = _BkFFJ07D;
        "pkg-0.20.2" = _x4WPHpzy;
        "pkg-0.20.3" = _xNY729KV;
        "pkg-0.20.4" = _hKbyI32A;
        "pkg-0.20.5" = _E0h3U32v;
        "pkg-0.21.0-alpha.1" = _Q9dkaTzc;
        "pkg-0.21.0-alpha.2" = _YxIgTrFH;
        "pkg-0.21.0-alpha.3" = _N1QrHDHr;
        "pkg-0.21.0-alpha.4" = _1zEHWJUg;
        "pkg-0.21.0-alpha.5" = _4wJv6YYp;
        "pkg-0.21.0-RC.1" = _AiL3PSQz;
        "pkg-0.21.0" = _h1vXtkvw;
        "pkg-0.21.1" = _8A0H9dJm;
        "pkg-0.21.2" = _AaavQVxK;
        "pkg-0.22.0-alpha.1" = _DoThD37D;
        "pkg-0.22.0-RC.1" = _PNILqg0w;
        "pkg-0.22.0-RC.2" = _7qcI1KBL;
        "pkg-0.22.0" = _6UBRiSmg;
        "pkg-0.22.1" = _evrDdLDq;
        "pkg-0.22.2" = _gGyps4NB;
        "pkg-0.22.3" = _NLg5mAgZ;
        "pkg-0.23.0-alpha.1" = _H47260g9;
        "pkg-0.23.0-RC.1" = _v9GTIUP5;
        "pkg-0.23.0-RC.2" = _4q8hkfsf;
        "pkg-0.23.0" = _5GcXzCBb;
        "pkg-0.24.0-alpha.1" = _dKSvmWeN;
