...
let
    ...
    in {
        ...
        "pkg-2.1.2.3" = _NRqnezmc;
        "pkg-2.1.2.2" = _CAHn7AxP;
        "pkg-2.1.2.1" = _VRIatkET;
        "pkg-1.3.1.0" = _i2Dm5KcX;
        "pkg-2.1.3.0" = _erhORix3;
        "pkg-2.1.3.1" = _9VSNySbX;
        "pkg-2.1.3.2" = _qpsfWaWs;
        "pkg-2.1.3.3" = _KPuM8I5P;
        "pkg-2.1.4" = _rcGMuWPz;
        "pkg-3.0.0" = _QovpWhJo;
        "pkg-2.2.0" = _qkM715Fv;
        "pkg-3.1.0" = _HgeYFYHb;
