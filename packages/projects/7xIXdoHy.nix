...
let
    ...
    in {
        ...
        "pkg-fabric-1.20.1-1.0.0" = _egUEDEXP;
        "pkg-forge-1.20.1-1.0.0" = _G6yB9BtG;
        "pkg-fabric-1.20.4-1.0.0" = _dG26UC3i;
        "pkg-neoforge-1.20.4-1.0.0" = _4mh3KsTQ;
        "pkg-fabric-1.20.6-1.1.0" = _6FdGylO1;
        "pkg-neoforge-1.20.6-1.1.0" = _l7tBdeyj;
        "pkg-fabric-1.21.1-1.1.0" = _Y5NBx9Vz;
        "pkg-neoforge-1.21.1-1.1.0" = _cRUWQoX0;
        "pkg-fabric-1.20.6-1.1.1" = _Yh7E7IYp;
        "pkg-neoforge-1.20.6-1.1.1" = _D9QNc1Ay;
        "pkg-fabric-1.21.1-1.1.1" = _Fjk4fKvk;
        "pkg-neoforge-1.21.1-1.1.1" = _uk9X8150;
        "pkg-fabric-1.21.3-1.1.1" = _lALyqzit;
        "pkg-neoforge-1.21.3-1.1.1" = _MJ4lVngk;
        "pkg-fabric-1.20.1-1.2.0" = _ipqjVwgW;
        "pkg-forge-1.20.1-1.2.0" = _lurGstT2;
        "pkg-fabric-1.20.4-1.2.0" = _N0dWe5Tu;
        "pkg-neoforge-1.20.4-1.2.0" = _CprFJ2jG;
        "pkg-fabric-1.20.6-1.2.0" = _EmrqNEB5;
        "pkg-neoforge-1.20.6-1.2.0" = _X1hQC3a7;
        "pkg-fabric-1.21.1-1.2.0" = _hOSfoIGj;
        "pkg-neoforge-1.21.1-1.2.0" = _iIhnJP8q;
        "pkg-fabric-1.21.3-1.2.0" = _92vQsuj7;
        "pkg-neoforge-1.21.3-1.2.0" = _RHe6fWJ1;
        "pkg-fabric-1.21.4-1.2.0" = _GR29UORu;
        "pkg-neoforge-1.21.4-1.2.0" = _Sr6J3cYs;
        "pkg-fabric-1.21.1-1.2.1" = _yYNjEq5c;
        "pkg-neoforge-1.21.1-1.2.1" = _P7A7ZY43;
        "pkg-fabric-1.20.6-1.2.1" = _wGFMf5NV;
        "pkg-neoforge-1.20.6-1.2.1" = _2DYKkJKs;
        "pkg-fabric-1.21.4-1.2.2" = _IFNiuRwa;
        "pkg-neoforge-1.21.4-1.2.2" = _XRd59RMQ;
        "pkg-fabric-1.21.6-1.2.2" = _xudYa46o;
        "pkg-neoforge-1.21.6-1.2.2" = _67rbdyPA;
        "pkg-fabric-1.21.8-1.2.2" = _J8bRyK3g;
        "pkg-neoforge-1.21.8-1.2.2" = _qHAzSs0W;
        "pkg-fabric-1.21.10-1.2.2" = _3prRCJ4n;
        "pkg-neoforge-1.21.10-1.2.2" = _GeVJr6lF;
        "pkg-fabric-1.21.10-1.2.3" = _XkiKDdU3;
        "pkg-neoforge-1.21.10-1.2.3" = _FQTgSj93;
        "pkg-fabric-1.21.11-1.2.3" = _sSqsJeEn;
        "pkg-neoforge-1.21.11-1.2.3" = _EVGYEvta;
        "default" = _EVGYEvta;
    });
