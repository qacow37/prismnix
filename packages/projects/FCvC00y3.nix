...
let
    ...
    in {
        ...
        "pkg-2.0.0+1.6-1.7" = _XcqsQhAc;
        "pkg-2.0.0+1.3-1.5" = _c6PYj6Jm;
        "pkg-2.0.0+1.0-1.2" = _4mxyIZ5v;
        "pkg-2.2.0+1.0-1.2.5-ornithe" = _93XJwggm;
        "pkg-2.2.0+1.3-1.5.2" = _UVk6lGrX;
        "pkg-2.2.0+1.3-1.5.2-ornithe" = _1S2d6tss;
        "pkg-2.2.0+1.6-1.7.10" = _DA1mSeHo;
        "pkg-2.2.0+1.6-1.7.10-ornithe" = _Y8JHwjNL;
        "pkg-2.2.0+1.8-1.12.2" = _devg1KaN;
        "pkg-2.2.0+1.8-1.12.2-ornithe" = _Ds5qPN2n;
        "pkg-2.2.0+1.13.2" = _NIvne5mx;
        "pkg-2.2.0+1.13-1.13.2-ornithe" = _k7A1PCBo;
        "pkg-2.2.1+1.6-1.7.10" = _PtrChhYC;
        "pkg-2.2.1+1.6-1.7.10-ornithe" = _BVPiewss;
        "pkg-2.2.1+1.3-1.5.2" = _JJtcRTxv;
        "pkg-2.2.1+1.3-1.5.2-ornithe" = _BE1pJ0vb;
        "pkg-2.2.1+1.0-1.2.5-ornithe" = _p4RLV5vp;
        "pkg-2.2.2+1.3-1.5.2-ornithe" = _ucW4pKhH;
        "pkg-2.3.0+1.3-1.13.2" = _Kpwn2Z2N;
        "pkg-2.3.1+1.3-1.13.2" = _dAAhwxzF;
        "pkg-2.3.2+1.3-1.13.2" = _3AxdEhm6;
        "pkg-2.3.0+b1.7.3-1.14.4" = _VvFJoG9q;
        "pkg-2.3.2+b1.7.3-1.14.4" = _IwL0U13q;
        "pkg-2.3.3+1.3-1.13.2" = _rhg59U3E;
        "pkg-2.3.4+b1.7.3-1.14.4" = _zJ2dsEYL;
        "pkg-2.3.4+1.3-1.13.2" = _gXNg8oUc;
        "pkg-2.3.5+b1.7.3-1.14.4" = _1U297zbb;
        "pkg-2.3.5+1.3.1-1.13.2" = _9lptNC7x;
        "pkg-2.3.6+1.3.1-1.13.2" = _VxbRKwpM;
        "pkg-2.3.6+b1.7.3-1.14.4" = _keYvdDsA;
        "default" = _keYvdDsA;
    });
