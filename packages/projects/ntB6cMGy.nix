...
let
    ...
    in {
        ...
        "pkg-1.18" = _JOY0xjbl;
        "pkg-1.19" = _sIpn6jBu;
        "pkg-1.19.3" = _gbUTSiMg;
        "pkg-1.19.4" = _F0xPdqKC;
        "pkg-1.20" = _SJ8s50X8;
        "pkg-1.20.2" = _imIIHJBS;
        "pkg-1.20.3-1.20.4" = _tDfB0cib;
        "pkg-1.20.5-1.20.6" = _QUCUwwTZ;
        "pkg-1.21" = _Pww3VBZu;
        "pkg-1.21.1" = _ZKDXRc7G;
        "pkg-1.21.2-1.21.3" = _9vwjlPPh;
        "pkg-1.21.4" = _qiTDKR4h;
