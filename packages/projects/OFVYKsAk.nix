...
let
    ...
    in {
        ...
        "pkg-9.1.1.1031" = _G0QlTAgX;
        "pkg-9.2.4.103" = _aRwbt5cb;
        "pkg-9.3.5.206" = _GSsriAn9;
        "pkg-9.6.9.367" = _pVOoXc9Z;
        "pkg-9.8.3.390" = _b84Y8s7p;
        "pkg-9.9.3.394" = _Eeulo9td;
        "pkg-9.10.9.422" = _cEQs9gAz;
        "pkg-10.0.9.432" = _F4LAmn30;
        "pkg-10.0.17.444" = _beWg6HYX;
        "pkg-10.0.19.446" = _XyQuycFr;
        "pkg-10.1.2.457" = _mUCrqgw0;
        "pkg-10.2.0.459" = _Fk2AhPfU;
        "pkg-10.2.1.461" = _vHLC3SKk;
        "pkg-10.2.2.462" = _XmFAvuxY;
        "pkg-10.2.3.463" = _N51JaiWT;
        "pkg-10.2.4.464" = _zPhZmsyo;
        "pkg-10.2.5.465" = _LU6dfu3A;
        "pkg-10.3.0.467" = _AZ6ZbshX;
        "pkg-10.3.1.468" = _LnQHBh0M;
        "pkg-10.3.2.469" = _qkJqKuks;
        "pkg-10.3.3.470" = _4VnhRWF0;
        "pkg-10.3.4.471" = _343e2ur0;
        "pkg-10.3.5.473" = _nw9ELE8i;
        "pkg-10.3.6.475" = _eRQ1BJdJ;
        "pkg-10.3.7.476" = _7r787MOb;
        "pkg-10.3.8.477" = _uW4ieBf2;
        "pkg-10.3.9.13" = _xPY4v0KH;
        "pkg-10.4.0.14" = _TW7K90pG;
        "pkg-10.4.1.15" = _cQetijSW;
        "pkg-10.4.2.16" = _EbmPAw4L;
        "pkg-10.4.3.17" = _AHKjDa4j;
        "pkg-10.4.4.18" = _4GDvQIV6;
        "pkg-10.4.5.19" = _n1IGOKuu;
        "pkg-10.4.6.20" = _1E44ANCP;
        "pkg-10.5.1.23" = _YiPBq0Q6;
        "pkg-10.5.2.24" = _rrmUD99u;
        "pkg-10.5.3.25" = _MngkWEjh;
        "pkg-10.5.4.26" = _XjPHb9Zt;
        "pkg-10.5.5.27" = _feKAL3ri;
        "pkg-10.5.6.28" = _joHk2LeF;
        "pkg-10.5.7.29" = _EE2Ozfio;
        "pkg-10.5.8.30" = _EIWH7AoN;
        "pkg-10.5.10.32" = _ujQsM87b;
        "pkg-10.5.11.33" = _xj07mJds;
        "pkg-10.5.12.34" = _DcGIXJRg;
        "pkg-10.5.13.35" = _QpOacmuN;
        "pkg-10.5.15.36" = _g2D1sDrW;
        "pkg-10.5.16.37" = _T49hwz4v;
        "pkg-10.5.17.38" = _rJVnmbSk;
        "pkg-10.5.18.39" = _r8Tns7y9;
        "pkg-10.5.19.40" = _z2wOV9C5;
        "pkg-10.5.20.41" = _s68xuFXt;
        "pkg-10.4.7.42" = _33mYSdIs;
        "pkg-10.4.8.43" = _UYUyLgHU;
        "pkg-10.6.0.44" = _kGPecAfd;
        "pkg-10.6.1.45" = _Us5KAIlG;
        "pkg-10.6.2.46" = _dtDfHo5q;
        "pkg-10.6.3.49" = _Zd0MboBm;
        "pkg-10.6.4.50" = _VoHOuran;
        "pkg-10.6.4.51" = _IFUrNXKE;
        "pkg-10.6.5.52" = _OVRClPOs;
        "pkg-10.6.6.53" = _foXE9inP;
        "pkg-10.6.7.54" = _sQkINXKI;
        "pkg-10.7.0.55" = _tlFziBOp;
        "pkg-10.7.1.56" = _C6fC5eSV;
        "pkg-10.7.1.57" = _8mASYbi4;
        "pkg-10.7.2.58" = _8nlDNpWT;
        "pkg-10.7.3.59" = _ku7zwGcF;
        "pkg-10.7.4.60" = _TcUSyzCY;
        "pkg-10.4.9.61" = _rgMq9U8j;
        "pkg-10.7.5.62" = _H4yrSnKg;
        "pkg-10.7.6.63" = _BgfpYKU4;
        "pkg-10.7.7.64" = _LWnvMX1j;
        "pkg-10.4.10.66" = _UpVHBgCc;
        "pkg-10.4.11.67" = _hX0ig8wx;
        "pkg-10.4.12.68" = _F6Zr7dsJ;
        "pkg-10.4.13.69" = _8IUpADYB;
        "pkg-10.7.8.70" = _rY2BPgUz;
        "pkg-10.4.14.71" = _KVJ0nNVH;
        "pkg-10.7.9.72" = _gPMOrzFc;
        "pkg-10.7.10.73" = _b6u8aoSK;
        "pkg-10.4.15.75" = _x9re7wt4;
        "pkg-10.7.11.76" = _PiBpvppf;
        "pkg-10.7.12.77" = _513IPBnN;
        "pkg-10.7.13.78" = _sRun2tP5;
        "pkg-10.7.14.79" = _3kY9ZgLx;
        "pkg-10.4.16.80" = _Th4Czz4N;
        "pkg-10.7.15.81" = _rLQkpjiL;
        "pkg-10.7.16.82" = _EN3R7Eeq;
        "pkg-10.7.17.83" = _bPzSK3o5;
        "pkg-10.7.18.84" = _5XsSoiIJ;
        "pkg-10.7.19.85" = _a6gl7srE;
        "default" = _a6gl7srE;
    });
