...
let
    ...
    in {
        ...
        "pkg-1.2.1" = _QPPcVYGy;
        "pkg-1.3.0" = _cKEqJ2kx;
        "pkg-1.3.1.1" = _8CerF7uu;
        "pkg-1.0" = _UpCHsEu9;
        "pkg-1.0.0" = _2kxD4ULO;
        "pkg-1.1.0" = _534tUMI8;
        "pkg-build.2+mc1.17.1" = _CleZ5fIC;
        "pkg-build.3+mc1.18" = _SyOkk5My;
        "pkg-build.4+mc1.18" = _xu9zKuGX;
        "pkg-build.5+mc1.18.1" = _rzJBjo7H;
        "pkg-build.6+mc1.18.1" = _rVPg9zQ6;
        "pkg-build.7+mc1.18.2" = _vVVMPYjz;
        "pkg-build.8+mc1.18.2" = _F1unNCQ6;
        "pkg-build.9+mc1.19" = _MCHJQZZ5;
        "pkg-build.10+mc1.19" = _y31ZguLq;
        "pkg-build.11+mc1.19" = _z2DdfPNO;
        "pkg-build.12+mc1.19" = _eK1MUW0j;
        "pkg-build.14+mc1.19.1" = _KkO0QLDC;
        "pkg-build.15+mc1.19.1" = _zdVWSnmQ;
        "pkg-build.16+mc1.19.2" = _HqQWYl2L;
        "pkg-build.17+mc1.19.2" = _Oa7tZnmR;
        "pkg-build.19+mc1.19.2" = _OjX9Qa4z;
        "pkg-build.22+mc1.20.1" = _uw4ySKPx;
        "pkg-3.0.1+mc1.20.1" = _TBtOEhtS;
        "pkg-4.0.0" = _OVVfuKnh;
        "pkg-4.0.1" = _XuEzxACD;
        "pkg-21.0.0" = _PNRf1S6o;
        "pkg-21.0.1" = _KufF1gx3;
        "pkg-21.0.2" = _pC083Y0W;
        "pkg-21.0.3" = _LcIqd5cm;
        "pkg-21.1.0" = _eHPTw93d;
        "pkg-26.1.1.1" = _QQRUSFwO;
        "pkg-26.1.1.2" = _wK03McSG;
        "pkg-26.1.2.0" = _v4qVR4US;
        "pkg-26.1.2.1" = _qKjonfv7;
        "pkg-26.1.2.2" = _tPOUubL5;
        "default" = _tPOUubL5;
    });
