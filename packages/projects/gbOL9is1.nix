...
let
    ...
    in {
        ...
        "pkg-2.0.2" = _9bgtyOSM;
        "pkg-2.0.3" = _nEbEMwXW;
        "pkg-2.0.3+1.19.3" = _S6Ka9khS;
        "pkg-2.0.4" = _iuDeO7gB;
        "pkg-2.0.4+1.19.3" = _CBiJ7Sdp;
        "pkg-2.0.5" = _2OhPLD8R;
        "pkg-2.0.6" = _orM7pQiD;
        "pkg-2.0.6+1.19.3" = _4d6rAm0c;
        "pkg-2.0.7" = _BwPQoCLI;
        "pkg-2.0.7+1.19.3" = _iF2I2vmf;
        "pkg-2.0.8+1.19.2" = _TLnqIl5i;
        "pkg-2.0.8+1.19.3" = _W0C1plPs;
        "pkg-2.1.0+1.19" = _EelqKOkl;
        "pkg-2.1.0+1.19.3" = _UlD3ViAf;
        "pkg-2.1.1+1.19" = _aEVIjQD5;
        "pkg-2.1.1+1.19.3" = _jZREuLeQ;
        "pkg-2.2.0+1.19" = _tnxAujB0;
        "pkg-2.2.0+1.20" = _8VZ2Ipx4;
        "pkg-2.2.0+1.21" = _TpV8VcJE;
        "pkg-2.2.1+1.19" = _eDHJ3SAp;
        "pkg-2.2.1+1.20" = _Om65Ox9A;
        "pkg-2.2.1+1.21" = _wDA6jX84;
        "pkg-2.2.2+1.18" = _rtRV9ZAz;
        "pkg-2.2.2+1.19" = _ljHAiEIZ;
        "pkg-2.2.2+1.20" = _NMzj4Cyy;
        "pkg-2.2.2+1.21" = _4bFeBufv;
        "pkg-2.2.3+1.20" = _TlhduF7R;
        "pkg-2.2.3+1.21" = _J9kgoRWn;
        "pkg-2.3.0+1.18" = _guz9cHwb;
        "pkg-2.3.0+1.19" = _17axCGcC;
        "pkg-2.3.0+1.20" = _9sHoLbfi;
        "pkg-2.3.0+1.21" = _E3HeajJF;
        "pkg-2.4.0+1.18" = _ZdY8R7gp;
        "pkg-2.4.0+1.19" = _YFbxDh7u;
        "pkg-2.4.0+1.20" = _pHkQcfzT;
        "pkg-2.4.0+1.21" = _c6E1TFhK;
        "default" = _c6E1TFhK;
    });
