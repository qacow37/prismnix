...
let
    ...
    in {
        ...
        "pkg-v1.0.0+1.16.2" = _u0u9oIDP;
        "pkg-v1.1.0+1.16.2" = _nSim7hUt;
        "pkg-v1.2.0+1.16.2" = _2kKM18vg;
        "pkg-v1.2.1+1.16.2" = _6PEDsmcG;
        "pkg-v1.2.1+1.17" = _fyUc0vpP;
        "pkg-v1.2.2+1.16.2" = _kgh1MP6x;
        "pkg-v1.2.2+1.17" = _dwpJX27W;
        "pkg-v1.2.3+1.16" = _L4tVmwPf;
        "pkg-v1.2.3+1.17" = _aCMg5KgO;
        "pkg-v1.2.3+1.18" = _k67b6H7M;
        "pkg-v2.0.0-beta.1+1.18" = _itYtyB5B;
        "pkg-v2.0.0-beta.2+1.18" = _kbUNur6K;
        "pkg-v2.0.0+1.19" = _3Z4VvhQu;
        "pkg-v2.1.0+1.19" = _War7lAYl;
        "pkg-3.0.0+1.19.2" = _CKBdGNmS;
        "pkg-v3.0.0+1.19.3" = _T7YeGGDC;
        "pkg-3.0.1+1.19.2" = _jsDzM2TZ;
        "pkg-3.0.1+1.19.3" = _2HOUPi9E;
        "pkg-3.0.1+1.19.4" = _CCiByVgI;
        "pkg-3.1.0+1.19.2" = _a67KVfJy;
        "pkg-3.1.0+1.19.3" = _4kbPOICB;
        "pkg-3.1.0+1.19.4" = _kxfhHenH;
        "pkg-3.1.0+1.20" = _zwur3MfO;
        "pkg-3.1.2+1.20.1" = _UKBaGxvE;
        "pkg-3.2.0+1.20.2" = _8xWVCpNr;
        "pkg-3.3.0+1.20.2" = _mpMNEk3W;
        "pkg-3.3.0+1.20.4" = _qgWGrBWP;
        "pkg-3.3.1+1.20.4" = _1u8AEBU6;
        "pkg-3.3.2+1.20.4" = _sLMfegXN;
        "pkg-3.4.0+1.20.5" = _WMq6rQGZ;
        "pkg-3.4.1+1.20.5" = _xo975hwO;
        "pkg-3.1.3+1.20.1" = _nhW81wdp;
        "pkg-3.4.2+1.20.5" = _9fR21Wk6;
        "pkg-3.4.2+1.21" = _i6eU8JNe;
        "pkg-3.1.4+1.20.1" = _rrAlAiEk;
        "pkg-3.4.3+1.20.5" = _A40avUtX;
        "pkg-3.4.3+1.21" = _8WgrjHKC;
        "pkg-4.0.0-beta.1+1.20.4" = _l1OFMiT8;
        "pkg-4.0.0-beta.2+1.20.4" = _y0o6Bmqy;
        "pkg-4.0.0-beta.3+1.20.4" = _1LOa6Ymn;
        "pkg-4.0.0-beta.4+1.20.4" = _uxW7Fnqy;
        "pkg-4.0.0-beta.4+1.20.6" = _GKzN9rDu;
        "pkg-4.0.0-beta.5+1.21" = _SB7exndh;
        "pkg-4.0.0-beta.6+1.21" = _h4IzZ8sy;
        "pkg-4.0.0-beta.7+1.21" = _orgqH1yj;
        "pkg-4.0.0-beta.8+1.21" = _anWcUW3D;
        "pkg-4.0.0-beta.8+1.20.6" = _rIOtEV2q;
        "pkg-4.0.0-beta.8+1.20.4" = _j4MSAAbZ;
        "pkg-4.0.0-beta.9+1.20.6" = _Vz3ly2fe;
        "pkg-4.0.0-beta.9+1.21" = _dz8YnQWH;
        "pkg-4.0.0-beta.9+1.21.2" = _NNz4bXeX;
        "pkg-4.0.0-beta.9+1.21.4" = _2gEKJln4;
        "pkg-4.0.0-beta.9+1.21.5" = _THYrww9u;
        "pkg-4.0.0+1.20.4" = _7dkB1mZ5;
        "pkg-4.0.0+1.20.6" = _VkOPaMUZ;
        "pkg-4.0.0+1.21" = _dKrKvz1B;
        "pkg-4.0.1+1.21.2" = _ROB8GZhL;
        "pkg-4.0.1+1.21.4" = _4q064dxZ;
        "pkg-4.0.1+1.21.5" = _r1ufwb0V;
        "pkg-4.1.0+1.21.5" = _9Gwj1eYd;
        "pkg-4.1.1+1.21.5" = _UDxNtglP;
        "pkg-4.1.1+1.21.6" = _H1simGEZ;
        "pkg-4.1.1+1.21.9" = _wbq0gxrs;
        "pkg-4.1.2+1.21.9" = _SsrhUfFe;
        "pkg-4.1.3+1.21.9" = _X57uiYy4;
        "default" = _X57uiYy4;
    });
