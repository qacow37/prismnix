...
let
    ...
    in {
        ...
        "pkg-1.9.4" = _pOkbkT0Z;
        "pkg-1.10" = _hpaqCG9j;
        "pkg-1.10.1" = _CrpnjFcO;
        "pkg-1.10.2" = _qzrbYdPE;
        "pkg-1.11" = _gHGt2Vdy;
        "pkg-1.11.1" = _XHiTZlwB;
        "pkg-1.11.2" = _MHKC890D;
        "pkg-1.12" = _37glnDwC;
        "pkg-1.12.1" = _z9mzqIUv;
        "pkg-1.12.2" = _DgWm1oCc;
        "pkg-1.13" = _QK0GMgnF;
        "pkg-1.13.1" = _LCUv4r8y;
        "pkg-1.13.2" = _4uVi8w0b;
        "pkg-1.14" = _ZdLpfg0N;
        "pkg-1.14.1" = _ZYPkZ0e2;
        "pkg-1.14.2" = _tRCAl879;
        "pkg-1.14.3" = _iuOpJQY6;
        "pkg-1.14.4" = _2HSn3akM;
        "pkg-1.15" = _qF8MMQMm;
        "pkg-1.15.1" = _6noNjuPi;
        "pkg-1.15.2" = _UCemHPRP;
        "pkg-1.16" = _JyYcR9cl;
        "pkg-1.16.1" = _QyK2tCgk;
        "pkg-1.16.2" = _3TSINuNI;
        "pkg-1.16.3" = _sJHjSYwi;
        "pkg-1.16.4" = _ARXICrLa;
        "pkg-1.16.5" = _w9F7W7MO;
        "pkg-1.17" = _Ir6mDoWY;
        "pkg-1.17.1" = _bkJQzFCN;
        "pkg-1.18" = _YHwUhAad;
        "pkg-1.18.1" = _2DvTbumc;
        "pkg-1.18.2" = _YVdJf0aU;
        "pkg-1.19" = _gsQLsdGY;
        "pkg-1.19.1" = _b5AkGngH;
        "pkg-1.19.2" = _brrhjW33;
        "pkg-1.19.3" = _x1WBOvJ7;
        "pkg-1.19.4" = _4ad2SY9G;
        "pkg-1.20" = _z3VL9pwG;
        "pkg-1.20.1" = _zJdXF5XV;
        "pkg-1.20.2" = _18ilemc3;
        "pkg-1.20.3" = _Q4gGVFAb;
        "pkg-1.20.4" = _VQBNZfAF;
        "pkg-1.20.5" = _fWCKUvAP;
        "pkg-1.20.6" = _tcT2KmBx;
        "pkg-1.21" = _j7zcrPk0;
        "pkg-1.21.1" = _oiU3bdSd;
        "pkg-1.21.2" = _YKz8JPaw;
        "pkg-1.21.3" = _x5Yb7jo8;
        "pkg-1.21.4" = _xZHU1Jdf;
        "pkg-1.21.5" = _k7QVCbRD;
        "pkg-1.21.6" = _NCRqO3BS;
        "pkg-1.21.7" = _QPUul7Wi;
        "pkg-1.21.8" = _ubjkxHsq;
        "pkg-1.21.9" = _R4U69EIC;
        "pkg-1.21.10" = _WGAFAXc7;
        "pkg-1.21.11" = _HHNNzG7T;
        "pkg-26.1" = _jwi3PUyq;
