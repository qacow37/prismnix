...
let
    ...
    in {
        ...
        "pkg-5.0.0-1.16.5" = _WplwolB1;
        "pkg-5.0.0-1.17.1" = _n1o9JHoC;
        "pkg-5.0.0-1.18.2" = _rERZNNDm;
        "pkg-5.0.0-1.19.3" = _r7POgXYC;
        "pkg-5.0.0-1.19.2" = _CecfaLeH;
        "pkg-5.1.0-1.19.2" = _kxWUdxJ3;
        "pkg-5.1.0-1.19.3" = _b9PPjgnG;
        "pkg-5.1.0-1.18.2" = _qn1BAip7;
        "pkg-5.1.0-1.16.5" = _x27ogrRk;
        "pkg-5.1.0-1.17.1" = _tdfnvzq5;
        "pkg-5.1.1-1.16.5" = _SUAg2EBF;
        "pkg-5.1.1-1.19.3" = _YdiGztp5;
        "pkg-5.2.0-1.18.2" = _nRuqSSRN;
        "pkg-5.2.0-1.19.2" = _7wStnvwV;
        "pkg-5.2.0-1.19.3" = _hHSHhK0o;
        "pkg-5.3.0-1.20.2" = _la1Cm3aN;
        "pkg-5.4.0-1.20.2" = _4u8v0GSn;
        "pkg-5.4.1-1.20.2" = _TkPflWpl;
        "pkg-5.4.2-1.20.2" = _VkmWdY2W;
        "pkg-5.4.3-1.20.2" = _tI8FOSGv;
        "pkg-5.4.4-1.20.2-build.133" = _Q5uOl5CL;
        "pkg-5.4.4-1.20.6-build.28" = _D2beQ8Nz;
        "pkg-5.4.5-1.20.6-build.29" = _KkB5NDDW;
        "default" = _KkB5NDDW;
    });
