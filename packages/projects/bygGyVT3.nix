...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge" = _PBJstKwN;
        "pkg-1.0.0-fabric" = _PGnXuOq1;
        "pkg-1.1.0-forge" = _cEKOkiRJ;
        "pkg-1.1.0-fabric" = _jQlKcD3S;
        "pkg-2.0.0-forge" = _ZGr250Lu;
        "pkg-2.0.0-fabric" = _8TH5mL71;
        "pkg-4.0.0-fabric" = _rXQmmGyJ;
        "pkg-4.0.0-forge" = _Z14LAk2l;
        "pkg-4.0.0-neoforge" = _yiY0cBgA;
        "pkg-3.0.0-forge" = _NWIssNHh;
        "pkg-3.0.0-neoforge" = _VBqeLBAp;
        "pkg-3.0.0-fabric" = _ZW8PkKLE;
        "pkg-5.0.0-fabric" = _xJFYIsRI;
        "pkg-5.0.0-forge" = _ay5joZdh;
        "pkg-5.0.0-neoforge" = _UpxPEGDh;
        "pkg-6.0.0-fabric" = _TXBBO0rX;
        "pkg-6.0.0-forge" = _WDE8LE1z;
        "pkg-6.0.0-neoforge" = _LfLUFAfy;
        "pkg-7.0.0-fabric" = _mlO85IdP;
        "pkg-7.0.0-forge" = _TE4cqmHp;
        "pkg-7.0.0-neoforge" = _yqkuI54J;
        "pkg-6.0.1-fabric" = _DuuFbeWk;
        "pkg-6.0.1-forge" = _CqxH81Qx;
        "pkg-6.0.1-neoforge" = _XA5bXfX8;
        "default" = _XA5bXfX8;
    });
