...
let
    ...
    in {
        ...
        "pkg-13.0.2" = _eUVuhDPJ;
        "pkg-13.0.0" = _a02mT3cw;
        "pkg-14.0.0-Boxlib" = _DlwTuuTX;
        "pkg-14.1.2-Boxlib" = _25XsIwNe;
        "pkg-2.0.0-Boxlib" = _oYxDglq4;
        "pkg-3.0.0-Boxlib" = _4uMfm8vx;
        "pkg-4.0.0-Boxlib" = _4788ePf8;
        "pkg-5.7.0" = _RnqG12QF;
        "pkg-6.1.0" = _IegAuPdu;
        "pkg-7.1.0-Boxlib" = _ab477rfS;
        "pkg-8.1.0-Boxlib" = _jtzLxZbq;
        "pkg-9.3.0-Boxlib" = _tk3RGRPn;
        "pkg-10.3.1-Boxlib" = _MjJoEu0I;
        "pkg-11.3.1-Boxlib" = _wtIspbl1;
        "pkg-12.1.1-Boxlib" = _tE4DXCOr;
        "pkg-13.2.1-Boxlib" = _Y6Wirsuv;
        "pkg-14.1.3-Boxlib" = _ijwvf3XV;
        "pkg-14.2.0-Boxlib" = _LlX2iZ3N;
        "pkg-14.2.1-Boxlib" = _iNlfgk9f;
        "pkg-13.3.1-Boxlib" = _YWVYKTtA;
        "pkg-14.2.2-Boxlib" = _rziJwScD;
        "pkg-2.0.2-Boxlib" = _720JOYCy;
        "pkg-3.0.2-Boxlib" = _vBAnMdrl;
        "pkg-5.7.1-fabric" = _6V5MIrqs;
        "pkg-5.7.1-forge" = _r5EfvNMB;
        "pkg-4.0.2-Boxlib" = _OBFHyk8y;
        "pkg-6.1.1-Boxlib" = _p6Vq8oO2;
        "pkg-7.1.1-Boxlib" = _tEmDxzQs;
        "pkg-8.1.1-Boxlib" = _ld4z1P1H;
        "pkg-9.3.1-Boxlib" = _UxisCLm4;
        "pkg-10.3.2-Boxlib" = _CyP0YDQV;
        "pkg-11.3.2-Boxlib" = _rXxdW1JV;
        "pkg-12.1.2-Boxlib" = _5Su3J3k2;
        "pkg-13.3.2-Boxlib" = _J6O8lLAa;
        "pkg-14.3.0-Boxlib" = _HFXRu9Ia;
        "pkg-9.3.2-Boxlib" = _IIaRNcZk;
        "pkg-10.4.0-Boxlib" = _xB1mfXTF;
        "pkg-12.1.4-Boxlib" = _zaDWU1hv;
        "pkg-14.4.1-Boxlib" = _woLywyyA;
        "pkg-15.0.0-Boxlib" = _8BAigAJe;
        "pkg-16.0.0-Boxlib" = _2NtddNPk;
        "pkg-16.0.1-Boxlib" = _nqWaVoeD;
        "pkg-0.161.0-Boxlib" = _IBu6cf76;
        "pkg-17.0.0-Boxlib" = _QktFJwPH;
        "pkg-17.0.1-Boxlib" = _zlRYOIJJ;
        "pkg-13.3.3-Boxlib" = _Ej4U9EEF;
        "pkg-14.4.2-Boxlib" = _8cx5eu01;
        "pkg-15.0.1-Boxlib" = _ybc5CR83;
        "pkg-16.0.2-Boxlib" = _FQFTz3GQ;
        "pkg-17.0.2-Boxlib" = _7lzlZrX9;
        "pkg-18.0.0-Boxlib" = _dfLePM55;
        "pkg-18.0.1" = _3CkJa6XJ;
        "pkg-18.0.2" = _S1OBBYgT;
        "pkg-18.0.3" = _t96K3G1G;
        "pkg-0.161.1" = _fC89DRxw;
        "pkg-13.3.4-Boxlib" = _ZlWqDvZn;
        "pkg-19.0.1" = _PT8QHLpF;
        "pkg-19.0.2" = _Jfr5BMtG;
        "pkg-19.0.3" = _OzCFHk2m;
        "pkg-20.0.0" = _SnAfAavT;
        "pkg-21.0.0" = _HFv3Q4QT;
        "pkg-22.0.1" = _ROyBrOeQ;
        "default" = _ROyBrOeQ;
    });
