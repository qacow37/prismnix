...
let
    ...
    in {
        ...
        "pkg-0.1+1.21.8-fabric" = _FjxEgNnf;
        "pkg-0.1+1.21.8-neoforge" = _50jeJz8w;
        "pkg-0.1+1.21.10-fabric" = _4Yer8mJo;
        "pkg-0.1+1.21.10-neoforge" = _TRIISw7g;
        "pkg-0.1+1.21.11-fabric" = _THkNAwHa;
        "pkg-0.1+1.21.11-neoforge" = _SCGvMKp5;
        "pkg-0.1.1+1.21.8-fabric" = _PfSCAQR0;
        "pkg-0.1.1+1.21.8-neoforge" = _XD7Z4kfx;
        "pkg-0.1.1+1.21.10-fabric" = _r74Yzs3L;
        "pkg-0.1.1+1.21.10-neoforge" = _dFi0ORNz;
        "pkg-0.1.1+1.21.11-fabric" = _IyP47fS3;
        "pkg-0.1.1+1.21.11-neoforge" = _mJIK9uFF;
        "pkg-0.1.2+1.21.1-fabric" = _zbEOO7op;
        "pkg-0.1.2+1.21.1-neoforge" = _lfYnzyAe;
        "pkg-0.1.2+1.21.3-fabric" = _ZyutqqMc;
        "pkg-0.1.2+1.21.3-neoforge" = _7Iu5kFzS;
        "pkg-0.1.2+1.21.4-fabric" = _TlW06ooV;
        "pkg-0.1.2+1.21.4-neoforge" = _RtIiOxwJ;
        "pkg-0.1.2+1.21.5-fabric" = _nkhgU5CC;
        "pkg-0.1.2+1.21.5-neoforge" = _VEJ1BN9i;
        "pkg-0.1.2+1.21.8-fabric" = _5xQ3IlKF;
        "pkg-0.1.2+1.21.8-neoforge" = _9ZUJMvSm;
        "pkg-0.1.2+1.21.10-fabric" = _nPC6YwzH;
        "pkg-0.1.2+1.21.10-neoforge" = _aC18SodU;
        "pkg-0.1.2+1.21.11-fabric" = _iko3Bbtm;
        "pkg-0.1.2+1.21.11-neoforge" = _61db9fUx;
        "pkg-0.2+1.21.1-fabric" = _6SHtnRgX;
        "pkg-0.2+1.21.8-fabric" = _1BtktMZD;
        "pkg-0.2+1.21.1-neoforge" = _zxdfggsd;
        "pkg-0.2+1.21.3-fabric" = _IgLYipqd;
        "pkg-0.2+1.21.3-neoforge" = _Vi8rPfO5;
        "pkg-0.2+1.21.4-fabric" = _55lNAYwU;
        "pkg-0.2+1.21.4-neoforge" = _EH75BI0h;
        "pkg-0.2+1.21.5-fabric" = _Kiejyypm;
        "pkg-0.2+1.21.5-neoforge" = _byS1M4ky;
        "pkg-0.2+1.21.8-neoforge" = _7IaGcQkT;
        "pkg-0.2+1.21.10-fabric" = _8SWTpwy4;
        "pkg-0.2+1.21.10-neoforge" = _97nRS1ZR;
        "pkg-0.2+1.21.11-fabric" = _gsAoS3Dv;
        "pkg-0.2+1.21.11-neoforge" = _qgnDW679;
        "pkg-0.2+26.1-fabric" = _eAv16HVM;
        "pkg-0.2+26.1-neoforge" = _yf2Nl1x1;
        "pkg-0.3+1.21.4-neoforge" = _VnvsEViH;
        "pkg-0.3+1.21.1-neoforge" = _9nuyA9Se;
        "pkg-0.3+1.21.3-neoforge" = _YJYoqNUA;
        "pkg-0.3+1.21.5-neoforge" = _spRWkeQD;
        "pkg-0.3+1.21.1-fabric" = _C7hTuMcS;
        "pkg-0.3+1.21.3-fabric" = _27eUtoDu;
        "pkg-0.3+1.21.4-fabric" = _PCW2V7sm;
        "pkg-0.3+1.21.5-fabric" = _PhgdWLxV;
        "pkg-0.3+1.21.8-fabric" = _RoU6YasK;
        "pkg-0.3+1.21.8-neoforge" = _kZS1UoOs;
        "pkg-0.3+1.21.10-fabric" = _5Z06yObl;
        "pkg-0.3+1.21.10-neoforge" = _OVZYicl0;
        "pkg-0.3+1.21.11-fabric" = _14tNkF1F;
        "pkg-0.3+1.21.11-neoforge" = _Il59WGxQ;
        "pkg-0.3+26.1-fabric" = _tm4aSGGj;
        "pkg-0.3+26.1-neoforge" = _tn7iQVK5;
        "pkg-0.3+26.2-fabric" = _ECniao0P;
        "default" = _ECniao0P;
    });
