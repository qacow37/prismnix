...
let
    ...
    in {
        ...
        "pkg-1.3.0+1.19-forge" = _1jnIJJT9;
        "pkg-1.3.0+1.16.5-1.19" = _DW0DXRt8;
        "pkg-1.3.1+1.16.5-forge" = _CCBmx5NI;
        "pkg-1.3.1+1.17.1-forge" = _6y0mtbYd;
        "pkg-1.3.1+1.18.2-forge" = _jS4iTNPW;
        "pkg-1.3.1+1.19.2-forge" = _IQ5YHNDu;
        "pkg-1.3.1+1.16.5-1.19.2" = _MWejUIC5;
        "pkg-1.3.2+1.16.5-forge" = _r0DYlVur;
        "pkg-1.3.2+1.17.1-forge" = _RHAoqgVw;
        "pkg-1.3.2+1.18.2-forge" = _DiQe5oJQ;
        "pkg-1.3.2+1.19.2-forge" = _E6iJOWF2;
        "pkg-1.3.2+1.19.3-forge" = _3Y8Jz093;
        "pkg-1.3.2+1.16.5-1.19.3" = _a3qy365D;
        "pkg-1.3.3+1.19.4-forge" = _mw1UFvrn;
        "pkg-1.3.3+1.16.5-1.19.4" = _VUcIxwh6;
        "pkg-1.3.4+1.20.1-forge" = _Gi5Zqy7k;
        "pkg-1.3.4+1.16.5-1.20.1" = _xdoG8nXs;
        "pkg-1.3.5+1.20.2-neoforge" = _ldzHDpMZ;
        "pkg-1.3.5+1.20.4-neoforge" = _qeJJYXzi;
        "pkg-1.3.5+1.16.5-1.20.4" = _JtNMrq2g;
        "pkg-1.3.6+1.16.5-forge" = _DyNxVuIp;
        "pkg-1.3.6+1.17.1-forge" = _FiRO23V9;
        "pkg-1.3.6+1.18.2-forge" = _WhNk3Svy;
        "pkg-1.3.6+1.19.2-forge" = _NLeR8PLY;
        "pkg-1.3.6+1.19.4-forge" = _wx1XkUdn;
        "pkg-1.3.6+1.20.1-forge" = _KbWwfAFV;
        "pkg-1.3.6+1.20.2-neoforge" = _g7hbb2gY;
        "pkg-1.3.6+1.20.4-neoforge" = _7B3snksY;
        "pkg-1.3.6+1.20.6-neoforge" = _G9fs0wkU;
        "pkg-1.3.6+1.21-neoforge" = _GSzjUYa3;
        "pkg-1.3.6+1.16.5-1.21" = _NrEJbYuZ;
        "default" = _NrEJbYuZ;
    });
