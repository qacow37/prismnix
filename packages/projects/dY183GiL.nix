...
let
    ...
    in {
        ...
        "pkg-0.9.1" = _W7ZAjp9R;
        "pkg-0.9.2" = _naZnv8iE;
        "pkg-0.10.0" = _q2lBZV4n;
        "pkg-0.11.0" = _F4yhRhwZ;
        "pkg-0.12.0" = _rBBY5Sux;
        "pkg-0.12.1" = _dFeAlsxD;
        "pkg-0.13.0" = _soZgHc5I;
        "pkg-0.14.0+1.18" = _NK5baL3q;
        "pkg-0.14.0+1.18.2" = _qKRjoroI;
        "pkg-0.15.0+1.18.2" = _yTLZARhe;
        "pkg-0.15.1+1.18.2" = _zl22ivo6;
        "pkg-0.15.2+1.18.2" = _lAZaAaP4;
        "pkg-0.16.0+1.18.2" = _g819DcZq;
        "pkg-0.16.1+1.18.2" = _Z2iGm3sp;
        "pkg-0.16.2+1.18.2" = _k7gSG2kY;
        "pkg-0.16.3+1.18.2" = _WbtouDpK;
        "pkg-0.17.0+1.18.2" = _YNRq0Fqy;
        "pkg-0.18.2+1.19" = _4VkdhGlP;
        "pkg-0.19.0+1.19" = _58J9F615;
        "pkg-0.19.1+1.19" = _bO6X2KJl;
        "pkg-0.19.2+1.19" = _I44x4a07;
        "pkg-0.19.3+1.19" = _GiWkYuCf;
        "pkg-0.20.0+1.19" = _XTVfSWAv;
        "pkg-0.20.1+1.19" = _mM6AcC65;
        "pkg-0.21.0+1.19" = _UZ3DDpoK;
        "pkg-0.21.1+1.19" = _ALGc6nNP;
        "pkg-0.22.0+1.19" = _Gfsb0ARG;
        "pkg-0.22.1+1.19" = _Ub6nZHEX;
        "pkg-0.22.2+1.19" = _3TCF8pIX;
        "pkg-0.23.0+1.19" = _weY7hxiz;
        "pkg-0.23.1+1.19" = _gRCim35B;
        "pkg-0.24.0+1.19" = _Dysyo3YV;
        "pkg-0.25.0+1.19" = _xgEFXMJJ;
        "pkg-0.26.0+1.19" = _9RJn72ai;
        "pkg-0.26.1+1.19-fabric" = _z7RJYk4h;
        "pkg-0.26.2+1.19-fabric" = _vWs8OkbC;
        "default" = _vWs8OkbC;
    });
