...
let
    ...
    in {
        ...
        "pkg-1+mod" = _EtSDjnXo;
        "pkg-0.9.3" = _qLN2sFd9;
        "pkg-0.9.3+mod" = _YCqF1GBY;
        "pkg-1.1" = _ojssJw3a;
        "pkg-1.1+mod" = _77LUOkkY;
        "pkg-1.2" = _Xwx1vH3J;
        "pkg-1.2+mod" = _LI6mKv7b;
        "pkg-1.3" = _x7SBd2Ln;
        "pkg-1.3+mod" = _u7CUQ1OB;
        "pkg-1.4" = _zTE4rmtv;
        "pkg-1.4+mod" = _Gd2NMQnl;
        "pkg-1.5" = _iT8h42id;
        "pkg-1.5+mod" = _1veTC13C;
        "pkg-1.5.1" = _veVeOcxu;
        "pkg-1.5.1+mod" = _uiHWvY3w;
        "pkg-1.5.2" = _rBGhp35z;
        "pkg-1.5.2+mod" = _OVp0T2Hj;
        "pkg-1.5.3" = _1fZ5riKi;
        "pkg-1.5.3+mod" = _6RFgU05T;
        "pkg-1.5.4" = _HCnE7Bpo;
        "pkg-1.5.4+mod" = _lQ7Okyr4;
        "pkg-1.5.4.1" = _5teVPeQz;
        "pkg-2.0" = _pdXkBkNV;
        "pkg-2.0.1" = _TsB7gnBd;
        "pkg-2.0.2" = _KQk5f9tv;
        "pkg-2.0.3" = _bzXjmVvs;
