...
let
    ...
    in {
        ...
        "pkg-v1.0.1-BETA2" = _diQlfhZe;
        "pkg-v1.0.1-BETA3" = _rBdYz1xR;
        "pkg-v1.0.1-BETA4" = _5ZQ2ys3i;
        "pkg-v1.0.1-BETA5" = _pGmttaCV;
        "pkg-v1.0.1" = _7NJuRHJE;
        "pkg-v1.0.2-BETA1" = _d2Ldzxfs;
        "pkg-v1.0.2-BETA2" = _2cs2cux1;
        "pkg-v1.0.2-BETA3" = _1iEk6nWI;
        "pkg-v1.0.2-BETA4" = _wmYDhUWN;
        "pkg-v1.0.2" = _nRvbCYRF;
        "pkg-v1.0.3-BETA1" = _Wrm93aJV;
        "pkg-v1.0.3-BETA2" = _mOPlayNt;
        "pkg-v1.0.3-BETA3" = _5DzUF9Vy;
        "pkg-v1.0.3" = _iSaT3V8i;
        "pkg-v1.0.4-BETA1" = _FGuBinQB;
        "pkg-v1.0.4-BETA2" = _i2SbXEB9;
        "pkg-v1.0.4-BETA3" = _aU0WGNDi;
        "pkg-v1.0.4" = _cR83Jv9r;
        "pkg-v1.0.5-BETA1" = _e7Ph5fTi;
        "pkg-v1.0.5-BETA2" = _GOYiljlf;
        "pkg-v1.0.5-BETA3" = _9vSUodcV;
        "pkg-v1.0.5-BETA4" = _k2dLxU4Q;
        "pkg-v1.0.5" = _geNiMeOP;
        "pkg-v1.0.6-BETA1" = _RGaqFfJm;
        "pkg-v1.0.6-BETA2" = _L3WusIUV;
        "pkg-v1.0.6-BETA3" = _LyGvJjZa;
        "default" = _LyGvJjZa;
    });
