...
let
    ...
    in {
        ...
        "pkg-1.1.7" = _cdROyJnf;
        "pkg-1.1.8" = _EB1byBcC;
        "pkg-1.1.9-datapack" = _udznGgvZ;
        "pkg-1.1.9" = _xcimk1G4;
        "pkg-1.2.0-datapack" = _r0MXQpkt;
        "pkg-1.2.0" = _YnxQTWyB;
        "pkg-1.2.1-datapack" = _xu1bNpw3;
        "pkg-1.2.1" = _6216ulJB;
        "pkg-1.2.2-datapack" = _E9Asuslw;
        "pkg-1.2.2" = _j5QsKFXs;
        "pkg-1.1.5b" = _jMf9oQgH;
        "pkg-1.2.3-datapack" = _yiI1EZmO;
        "pkg-1.2.3" = _BkiS9har;
        "pkg-1.2.1b-datapack" = _6S40yywo;
        "pkg-1.2.1b" = _cCUmdH6y;
        "pkg-1.2.4-datapack" = _nH5k4m2K;
        "pkg-1.2.4" = _dmRUPAhd;
        "pkg-1.2.5" = _8zsYtXZJ;
        "pkg-1.2.5-datapack" = _cn9MTN70;
        "pkg-1.2.6" = _dlYSFekQ;
        "pkg-1.2.6-datapack" = _XBMlfmVI;
        "pkg-1.2.7" = _JlvyAhFL;
        "pkg-1.2.7-datapack" = _fAhWn0su;
        "pkg-1.2.8" = _yQi8lOKM;
