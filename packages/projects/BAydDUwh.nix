...
let
    ...
    in {
        ...
        "pkg-1.0.0-mc1.21-fabric" = _tj2qyMXh;
        "pkg-1.0.0-mc1.21.1-fabric" = _FpGvQ55N;
        "pkg-1.0.0-mc1.21.2-fabric" = _PqHQywHg;
        "pkg-1.0.0-mc1.21.3-fabric" = _7iaFNMDu;
        "pkg-1.0.0-mc1.21.4-fabric" = _NeWySO38;
        "pkg-1.0.0-mc1.21.5-fabric" = _pTotl7IN;
        "pkg-1.0.0-mc1.21.6-fabric" = _hg1jdxuk;
        "pkg-1.0.0-mc1.21.7-fabric" = _T6XAzQiL;
        "pkg-1.0.0-mc1.21.8-fabric" = _Piu8l3C2;
        "pkg-1.0.0-mc1.21.9-fabric" = _ZicIy2eA;
        "pkg-1.0.0-mc1.21.10-fabric" = _tK0u03eK;
        "pkg-1.0.0-mc1.21.11-fabric" = _MFNS77DJ;
        "pkg-1.0.0-mc1.21-neoforge" = _ldPNIx6F;
        "pkg-1.0.0-mc1.21.1-neoforge" = _u6TBU1qG;
        "pkg-1.0.0-mc1.21.2-neoforge" = _U7Ypg0V0;
        "pkg-1.0.0-mc1.21.3-neoforge" = _vGXQYDFA;
        "pkg-1.0.0-mc1.21.4-neoforge" = _5HbzdBmG;
        "pkg-1.0.0-mc1.21.5-neoforge" = _GcTuWV0v;
        "pkg-1.0.0-mc1.21.6-neoforge" = _wdttTDbb;
        "pkg-1.0.0-mc1.21.7-neoforge" = _ji32PAVI;
        "pkg-1.0.0-mc1.21.8-neoforge" = _X0f6iVWB;
        "pkg-1.0.0-mc1.21.9-neoforge" = _n8iXXYcp;
        "pkg-1.0.0-mc1.21.10-neoforge" = _storhFj5;
        "pkg-1.0.0-mc1.21.11-neoforge" = _GeozJSt3;
        "pkg-1.0.1-mc1.21-fabric" = _oPrniZw3;
        "pkg-1.0.1-mc1.21.1-fabric" = _1JCn6wue;
        "pkg-1.0.1-mc1.21.2-fabric" = _6dPYTEvP;
        "pkg-1.0.1-mc1.21.3-fabric" = _UB3W8ksa;
        "pkg-1.0.1-mc1.21.4-fabric" = _ZfGYFjxU;
        "pkg-1.0.1-mc1.21.5-fabric" = _7xr2UH4I;
        "pkg-1.0.1-mc1.21.6-fabric" = _xQiBtTMW;
        "pkg-1.0.1-mc1.21.7-fabric" = _vZAVO1eG;
        "pkg-1.0.1-mc1.21.8-fabric" = _wQU78xhE;
        "pkg-1.0.1-mc1.21.9-fabric" = _9jl1Clqz;
        "pkg-1.0.1-mc1.21.10-fabric" = _MehALPkE;
        "pkg-1.0.1-mc1.21.11-fabric" = _kWy7WtsX;
        "pkg-1.0.2-mc1.21.11-fabric" = _p8gAHIo2;
        "pkg-1.0.2-mc1.21.10-fabric" = _bD1yMBVC;
        "pkg-1.0.2-mc1.21.9-fabric" = _k0Qs96Io;
        "pkg-1.0.2-mc1.21.8-fabric" = _5ZX7kzL5;
        "pkg-1.0.2-mc1.21.7-fabric" = _4B3yzcw1;
        "pkg-1.0.2-mc1.21.6-fabric" = _TLQfHhpy;
        "pkg-1.0.2-mc1.21.5-fabric" = _80dgroEz;
        "pkg-1.0.2-mc1.21.4-fabric" = _bAJd3oR8;
        "pkg-1.0.2-mc1.21.3-fabric" = _8WgsbHvr;
        "pkg-1.0.2-mc1.21.2-fabric" = _5SOajVjy;
        "pkg-1.0.2-mc1.21.1-fabric" = _LhZRIM30;
        "pkg-1.0.2-mc1.21-fabric" = _nHInzC7g;
        "pkg-1.0.2-mc1.21-neoforge" = _BK6fHQvc;
        "pkg-1.0.2-mc1.21.1-neoforge" = _USayuUNy;
        "pkg-1.0.2-mc1.21.2-neoforge" = _O5q9mpZG;
        "pkg-1.0.2-mc1.21.3-neoforge" = _YeVo5B6e;
        "pkg-1.0.2-mc1.21.4-neoforge" = _G52wMjDx;
        "pkg-1.0.2-mc1.21.5-neoforge" = _1gw2r3iT;
        "pkg-1.0.2-mc1.21.6-neoforge" = _FuiT8izj;
        "pkg-1.0.2-mc1.21.7-neoforge" = _RF8FHfNJ;
        "pkg-1.0.2-mc1.21.8-neoforge" = _U6hEKzst;
        "pkg-1.0.2-mc1.21.9-neoforge" = _oqhUSIXa;
        "pkg-1.0.2-mc1.21.10-neoforge" = _XQdRnnZ2;
        "pkg-1.0.2-mc1.21.11-neoforge" = _C2tHDojh;
        "pkg-1.0.3-mc1.21.11-fabric" = _hWrTcAHa;
        "pkg-1.0.3-mc1.21.10-fabric" = _VcyLIaqn;
        "pkg-1.0.3-mc1.21.9-fabric" = _pu2J6Oq1;
        "pkg-1.0.3-mc1.21.8-fabric" = _maVKYA0w;
        "pkg-1.0.3-mc1.21.7-fabric" = _kxKGFqWr;
        "pkg-1.0.3-mc1.21.6-fabric" = _bI2vBfmc;
        "pkg-1.0.3-mc1.21.5-fabric" = _qf8GAPls;
        "pkg-1.0.3-mc1.21.4-fabric" = _o4nFJKo5;
        "pkg-1.0.3-mc1.21.3-fabric" = _8muyYhdi;
        "pkg-1.0.3-mc1.21.2-fabric" = _LYj107CE;
        "pkg-1.0.3-mc1.21.1-fabric" = _i7dDGsqK;
        "pkg-1.0.3-mc1.21-fabric" = _4d08zlcQ;
        "pkg-1.0.4-mc1.21.11-fabric" = _kEA4HY4I;
        "pkg-1.0.4-mc1.21.10-fabric" = _udieWs2p;
        "pkg-1.0.4-mc1.21.9-fabric" = _gQKMnwzP;
        "pkg-1.0.4-mc1.21.8-fabric" = _KSrzOrkt;
        "pkg-1.0.4-mc1.21.7-fabric" = _cYymqUXo;
        "pkg-1.0.4-mc1.21.6-fabric" = _cOQHVvlf;
        "pkg-1.0.4-mc1.21.5-fabric" = _6q7P1Qfh;
        "pkg-1.0.4-mc1.21.4-fabric" = _9dMGjtdb;
        "pkg-1.0.4-mc1.21.3-fabric" = _CJZ0zP8U;
        "pkg-1.0.4-mc1.21.2-fabric" = _Yhd5FD7X;
        "pkg-1.0.4-mc1.21.1-fabric" = _ciMDdnKj;
        "pkg-1.0.4-mc1.21-fabric" = _h1THMIWS;
        "pkg-1.0.4-mc26.2-fabric" = _2YevVeij;
        "pkg-1.0.4-mc26.1.2-fabric" = _6rKy435n;
        "pkg-1.0.4-mc26.1.1-fabric" = _6MuqSGTt;
        "pkg-1.0.4-mc26.1-fabric" = _AsnnQz20;
        "default" = _AsnnQz20;
    });
