...
let
    ...
    in {
        ...
        "pkg-1.0.0-Fabric-1.18.2" = _xF9kOqGw;
        "pkg-1.0.1-Fabric-1.18.2" = _7RFR0agi;
        "pkg-1.0.1-Forge-1.18.2" = _4c6VNTTs;
        "pkg-1.0.1-Fabric-1.19" = _qr8goR9D;
        "pkg-1.0.1-Forge-1.19-alpha" = _s8Jtwktc;
        "pkg-1.1.0" = _1UX4vxMI;
        "default" = _1UX4vxMI;
    });
