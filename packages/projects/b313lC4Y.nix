...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.19.2" = _CjT8ZZlg;
        "pkg-0.1.1+1.19.2" = _KitEv2dH;
        "pkg-0.1.3+1.19.2" = _YsSuGrLX;
        "pkg-0.1.3+1.20.1" = _KdMcBayi;
        "pkg-1.0.0+1.20.1" = _Evoju5A3;
        "pkg-1.0.1+1.20.1" = _5Xj7Zq1p;
        "pkg-0.1.4+1.19.2" = _FmaG1uxz;
        "pkg-1.0.2+1.20.1" = _McmtxOB7;
        "pkg-1.0.3+1.20.1" = _lc5TaFIQ;
        "pkg-1.1.0+1.20.1" = _tVCvnPYp;
        "pkg-1.1.1+1.20.1" = _OEyHP2Gb;
        "pkg-1.1.2+1.20.1" = _FMkIG4hW;
        "pkg-1.2.0+1.20.1" = _KJoXZbRx;
        "pkg-1.2.1+1.20.1" = _md19FQI9;
        "pkg-1.2.2+1.20.1-fabric-intermediary" = _YAjJIieP;
        "pkg-1.2.2+1.20.1-forge" = _VAwu82Sh;
        "pkg-1.2.2+1.19.2-fabric-intermediary" = _uDAliaZ5;
        "pkg-1.3.0+1.20.1-forge" = _bjASzC5z;
        "pkg-1.3.0+1.20.1-fabric-intermediary" = _IVnwDZ4s;
        "pkg-1.3.1+1.20.1-forge" = _ThCpZhNJ;
        "pkg-1.3.1+1.20.1-fabric-intermediary" = _yB7PmWMu;
        "pkg-1.3.3+1.20.1-forge" = _G91l09np;
        "pkg-1.3.3+1.20.1-fabric-intermediary" = _DSp8VI7v;
        "pkg-1.3.4+1.20.1-fabric-intermediary" = _i0MZW3V0;
        "pkg-1.3.5+1.20.1-forge" = _V1vBjz1F;
        "pkg-1.3.5+1.20.1-fabric-intermediary" = _zb33afAB;
        "pkg-1.3.6+1.20.1-forge" = _RclNYRKS;
        "pkg-1.3.6+1.20.1-fabric-intermediary" = _BHEqqlI4;
        "pkg-1.3.7+1.20.1-forge" = _4AODpsSb;
        "pkg-1.3.7+1.20.1-fabric-intermediary" = _xK0NuoxF;
        "pkg-1.3.8+1.20.1-fabric-intermediary" = _ufmfF3LN;
        "pkg-1.3.8+1.20.1-forge" = _dgcWD3q5;
        "pkg-1.3.9+1.20.1-forge" = _BpPun1nz;
        "pkg-1.3.9+1.20.1-fabric-intermediary" = _ooVvj3YK;
        "pkg-1.3.10+1.20.1-forge" = _boZNdkgC;
        "pkg-1.3.10+1.20.1-intermediary" = _vzoqfTFP;
        "pkg-1.4.0+1.20.1-forge" = _AG35QGxN;
        "pkg-1.4.0+1.20.1-intermediary" = _W66CkKEI;
        "pkg-1.4.1+1.20.1-forge" = _6aMoOpG3;
        "pkg-1.4.1+1.20.1-intermediary" = _zvkSRZzJ;
        "pkg-1.4.2+1.20.1-forge" = _U3w8JQor;
        "pkg-1.4.2+1.20.1-intermediary" = _IXcVg2hQ;
        "pkg-1.4.3+1.20.1-forge" = _DrArkrfZ;
        "pkg-1.4.3+1.20.1-intermediary" = _gKQQJsCN;
        "pkg-1.4.4+1.20.1-intermediary" = _tSO793zy;
        "pkg-1.4.4+1.20.1-forge" = _dvIQrzsk;
        "pkg-1.4.5+1.20.1-forge" = _ApTopy8S;
        "pkg-1.4.5+1.20.1-intermediary" = _VYemFK85;
        "pkg-1.4.6+1.20.1-forge" = _A1BKrSA2;
        "pkg-1.4.6+1.20.1-intermediary" = _FOqSS3Gt;
        "pkg-1.4.7-intermediary" = _qmGGp5yl;
        "pkg-1.4.7-forge" = _5xH7I2MX;
        "pkg-1.4.8-intermediary" = _YBbzbQww;
        "pkg-1.4.8-forge" = _kD3LcZXO;
        "pkg-1.5.0-intermediary" = _3nMhZel6;
        "pkg-1.5.0-forge" = _Ax32hx54;
        "pkg-1.6.0-intermediary" = _ignCHtU9;
        "pkg-1.6.0-forge" = _balJEehY;
        "pkg-1.6.1-intermediary" = _S9q2gcSo;
        "pkg-1.6.1-forge" = _r4XWGB9a;
        "pkg-1.7.0-intermediary" = _oMYs65He;
        "pkg-1.7.0-forge" = _K2SkHacN;
        "pkg-1.7.1-intermediary" = _Go9SV427;
        "pkg-1.7.1-forge" = _86ijovSP;
        "pkg-1.7.2" = _ozOcfQNv;
        "pkg-1.8.0" = _nXIbnBDO;
        "pkg-1.9.0" = _OUGcNV7u;
        "pkg-1.9.1" = _WwZ4LR7g;
        ...
        "pkg-1.9.6" = _3sTqoHGu;
        "pkg-1.9.7" = _BBnnjcMQ;
        "pkg-1.10.0" = _cqaY7FNI;
        "pkg-1.10.1" = _9fcRwjWe;
        "pkg-1.10.2" = _l5BpwIPs;
        "pkg-1.10.3" = _MHhf8Kmu;
        "pkg-1.10.4" = _8RlJKwgm;
        "pkg-1.10.5" = _44JNFPXJ;
        "pkg-0.10.6" = _65HiWJ3Q;
        "pkg-0.10.7" = _e4eSpJzt;
        "pkg-0.11.0" = _dYzIIsk2;
        "pkg-1.0.0" = _FgWqXdC3;
        "pkg-1.0.1" = _evVJ3UqL;
        "pkg-1.0.2" = _t2BuXc66;
        "pkg-1.0.3" = _fKGOj2Zd;
