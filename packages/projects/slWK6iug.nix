...
let
    ...
    in {
        ...
        "pkg-v1.0.0-beta" = _V9veorhJ;
        "pkg-v1.0.0-beta+mod" = _PsfZBMhx;
        "pkg-v1.0.1-beta" = _6YcHo48e;
        "pkg-v1.0.1-beta+mod" = _vlPkOCPn;
        "pkg-v1.0.2" = _KoCTBL9W;
        "pkg-v1.0.2+mod" = _KlPJ5HA8;
        "pkg-v1.0.2.1-beta--mc1.20.4-" = _XwWQN5hS;
        "pkg-v1.0.2.1-beta--mc1.20.6" = _xHi3jaap;
        "pkg-v1.0.2.1-beta--mc1.21" = _MIFs5P6z;
        "pkg-v1.0.2.1-beta--mc1.20.4-+mod" = _jkcjGeHX;
        "pkg-v1.0.2.1-beta--mc1.20.6+mod" = _Bkvnb2yi;
        "pkg-v1.0.2.1-beta--mc1.21+mod" = _Sx6DTTFD;
        "pkg-v1.0.3-beta" = _YSrM1ovu;
        "pkg-v1.0.3-beta+mod" = _p5KDGmgv;
        "pkg-v1.0.3.1-beta--(1.21.1)" = _RI92F9Qf;
        "pkg-v1.0.3.1-beta--(1.21.3)" = _CrJFBJkn;
        "pkg-v1.0.3.1-beta--(1.21.4)" = _cNJw1mVs;
        "pkg-v1.0.3.1-beta+mod" = _gFPIGNq3;
        "pkg-v-1d2" = _cfjVFVoo;
        "pkg-v-1d2+mod" = _QV1dDjUF;
        "pkg-v-1d3" = _pPHViGGZ;
        "pkg-v-1d3+mod" = _MMbDKtHH;
        "pkg-1d4-48p61" = _lSOB8dEj;
        "pkg-1d4-71p88" = _aQEMUZVe;
        "pkg-1d4-48p61-mod" = _rbJZLfM7;
        "pkg-1d4-71p88-mod" = _uuUu77wI;
        "pkg-1d5" = _YJf7KX0Q;
        "pkg-1d5-mod" = _3Y8NhZLm;
        "default" = _3Y8NhZLm;
    });
