...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.23-Forge" = _Zo1P1zLm;
        "pkg-1.17.1-2.0-Fabric" = _4bhgKj5t;
        "pkg-1.17.1-2.0-Forge" = _wNmyFZ5R;
        "pkg-1.18.1-2.1-Fabric" = _VBB8Y3OC;
        "pkg-1.18.1-2.1-Forge" = _99wRG5DB;
        "pkg-1.18.1-2.2-Fabric" = _qaWZpY6B;
        "pkg-1.18.1-2.2-Forge" = _qHSXPbh8;
        "pkg-1.18.1-2.3-Fabric" = _KSJ6Thhz;
        "pkg-1.18.1-2.3-Forge" = _3mi3R0kW;
        "pkg-1.18.2-2.4-Fabric" = _OOVqOKa0;
        "pkg-1.18.2-2.4-Forge" = _iKev3WOM;
        "pkg-1.18.2-2.5-Fabric" = _GJZA8Jct;
        "pkg-1.18.2-2.5-Forge" = _XtCqqMay;
        "pkg-1.18.2-2.6-Fabric" = _ja2G1nZm;
        "pkg-1.18.2-2.6-Forge" = _VRIoxGiM;
        "pkg-1.18.2-2.7-Fabric" = _Jc9NIyeo;
        "pkg-1.18.2-2.7-Forge" = _WuMnaD12;
        "pkg-1.18.2-2.8-Fabric" = _hI9ILjIZ;
        "pkg-1.18.2-2.8-Forge" = _CApqCw1h;
        "pkg-1.18.2-2.9-Fabric" = _reMPisMx;
        "pkg-1.18.2-2.9-Forge" = _SsXUbfQF;
        "pkg-1.18.2-2.10-Fabric" = _v1IfEdPn;
        "pkg-1.18.2-2.10-Forge" = _tA9dYDFf;
        "pkg-1.18.2-2.11-Fabric" = _EMN5Ni08;
        "pkg-1.18.2-2.11-Forge" = _7cKlgmMr;
        "pkg-1.18.2-2.12-Fabric" = _QlUmozE4;
        "pkg-1.18.2-2.12-Forge" = _xT7DrtED;
        "pkg-1.18.2-2.13-Fabric" = _ZifeeXGm;
        "pkg-1.18.2-2.13-Forge" = _sikB7quR;
        "pkg-1.18.2-2.14-Fabric" = _S8YpyxH7;
        "pkg-1.18.2-2.14-Forge" = _bZXX69R5;
        "pkg-1.19.2-3.0-Fabric" = _lsvsFwNj;
        "pkg-1.19.2-3.0-Forge" = _glSvepwY;
        "pkg-1.19.2-3.0.1-Fabric" = _DyfxKH6l;
        "pkg-1.19.2-3.0.1-Forge" = _qasNbmqq;
        "pkg-1.19.2-3.1.0-Fabric" = _S3aTfwuV;
        "pkg-1.19.2-3.1.0-Forge" = _9S6J0J2L;
        "pkg-1.19.2-3.2.0-Fabric" = _tRZNCkeS;
        "pkg-1.19.2-3.2.0-Forge" = _K18qv9tJ;
        "pkg-1.19.3-3.3.0-alpha.1-Fabric" = _g7eSEGvv;
        "pkg-1.19.3-3.3.0-alpha.1-Forge" = _100EGSA7;
        "pkg-1.19.3-3.3.0-beta.1-Fabric" = _chzoBFT9;
        "pkg-1.19.3-3.3.0-beta.1-Forge" = _mBz1llH1;
        "pkg-1.19.3-3.3.0-Fabric" = _BjVXaGEr;
        "pkg-1.19.3-3.3.0-Forge" = _qDIb7qsT;
        "pkg-1.19.3-3.4.0-Fabric" = _Yvx2aSUg;
        "pkg-1.19.3-3.4.0-Forge" = _zXAKYL3B;
        "pkg-1.19.3-3.5.0-Fabric" = _WSNAF7BE;
        "pkg-1.19.3-3.5.0-Forge" = _Eo1Gfhom;
        "pkg-1.19.4-3.6.0-alpha.1-Fabric" = _5xqdbVT7;
        "pkg-1.19.4-3.6.0-alpha.1-Forge" = _GfnFIv7m;
        "pkg-1.19.4-3.6.0-Fabric" = _2WYW6sN8;
        "pkg-1.19.4-3.6.0-Forge" = _Z0gnnGkz;
        "pkg-1.20-3.7.0-alpha.1-Fabric" = _CNRi1jnY;
        "pkg-1.20-3.7.0-alpha.1-Forge" = _gQblmGvR;
        "pkg-1.20-3.7.0-alpha.2-Fabric" = _PyTCnFKv;
        "pkg-1.20-3.7.0-alpha.2-Forge" = _B7tw4g49;
        "default" = _B7tw4g49;
    });
