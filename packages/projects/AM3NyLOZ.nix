...
let
    ...
    in {
        ...
        "pkg-1.19.2-3.2.0-1.1" = _ORXg2lsf;
        "pkg-1.19.3-3.2.0-1.1" = _6L6IuJjJ;
        "pkg-1.18.2-3.2.0-1.1" = _GEx12AOS;
        "pkg-1.17.1-3.2.0-1.1" = _2azqTbkR;
        "pkg-1.16.5-3.2.0-1.1" = _pMmqBFYD;
        "pkg-1.19.2-3.2.0-1.1-hotfix-1" = _CEuDBcVv;
        "pkg-1.19.3-3.2.0-1.1-hotfix-1" = _MUfCvENK;
        "pkg-1.18.2-3.2.0-1.1-hotfix-1" = _xsrY5Wu0;
        "pkg-1.17.1-3.2.0-1.1-hotfix-1" = _io360Vgr;
        "pkg-1.16.5-3.2.0-1.1-hotfix-1" = _qCTYhrs9;
        "pkg-1.16.5-3.2.0-1.2" = _eTX1rfNT;
        "pkg-1.17.1-3.2.0-1.2" = _MEIwcgla;
        "pkg-1.18.2-3.2.0-1.2" = _2tjxOrvH;
        "pkg-1.19.2-3.2.0-1.2" = _3tn49UH1;
        "pkg-1.19.3-3.2.0-1.2" = _SrKQ9xw2;
        "pkg-1.16.5-3.2.0-1.3" = _l2z4J99e;
        "pkg-1.17.1-3.2.0-1.3" = _Rq1ygY8C;
        "pkg-1.18.2-3.2.0-1.3" = _px6Uivmk;
        "pkg-1.19.2-3.2.0-1.3" = _GAYEHENC;
        "pkg-1.19.3-3.2.0-1.3" = _J7eZ0tFc;
        "pkg-1.16.5-3.2.0-1.3.1" = _dSyJB34A;
        "pkg-1.17.1-3.2.0-1.3.1" = _fKxcOUH9;
        "pkg-1.18.2-3.2.0-1.3.1" = _OFMDVIdj;
        "pkg-1.19.2-3.2.0-1.3.1" = _ckz8q9lF;
        "pkg-1.19.3-3.2.0-1.3.1" = _Tp7BQcZv;
        "pkg-1.16.5-3.2.0-1.3.2" = _GiOHKQmD;
        "pkg-1.17.1-3.2.0-1.3.2" = _KdmzQak6;
        "pkg-1.18.2-3.2.0-1.3.2" = _fXullFXW;
        "pkg-1.19.2-3.2.0-1.3.2" = _uFlHuXeS;
        "pkg-1.19.3-3.2.0-1.3.2" = _sqipxylG;
        "pkg-1.16.5-3.2.0-1.3.3" = _YUAn7p6X;
        "pkg-1.17.1-3.2.0-1.3.3" = _lYq1t9Vp;
        "pkg-1.18.2-3.2.0-1.3.3" = _oILeJZM6;
        "pkg-1.19.2-3.2.0-1.3.3" = _Do8Hb443;
        "pkg-1.19.3-3.2.0-1.3.3" = _O2REe01U;
        "pkg-1.19.4-3.2.0-1.3.3" = _BaIkynvB;
        "pkg-1.16.5-3.2.0-1.3.3-hotfix-1" = _aspw8bW7;
        "pkg-1.17.1-3.2.0-1.3.3-hotfix-1" = _Jo4rK0tB;
        "pkg-1.18.2-3.2.0-1.3.3-hotfix-1" = _h4bODJWD;
        "pkg-1.19.2-3.2.0-1.3.3-hotfix-1" = _dPqHDMUs;
        "pkg-1.19.3-3.2.0-1.3.3-hotfix-1" = _Yao7rQ6R;
        "pkg-1.19.4-3.2.0-1.3.3-hotfix-1" = _WJ8K2q1j;
        "pkg-1.16.5-3.2.0-1.3.4" = _pzXLISY5;
        "pkg-1.17.1-3.2.0-1.3.4" = _Clyj8sPO;
        "pkg-1.18.2-3.2.0-1.3.4" = _fyWfelvm;
        "pkg-1.19.2-3.2.0-1.3.4" = _JITYJj2U;
        "pkg-1.19.3-3.2.0-1.3.4" = _S2TUrorO;
        "pkg-1.19.4-3.2.0-1.3.4" = _QZe6C8iB;
        "pkg-1.16.5-3.2.2-1.3.4-enhancement-1" = _LaFhhzs9;
        "pkg-1.17.1-3.2.2-1.3.4-enhancement-1" = _QwIhTG63;
        "pkg-1.18.2-3.2.2-1.3.4-enhancement-1" = _lNqvIbT2;
        "pkg-1.19.2-3.2.2-1.3.4-enhancement-1" = _WktgVh4E;
        "pkg-1.19.3-3.2.2-1.3.4-enhancement-1" = _jUN3hAMS;
        "pkg-1.19.4-3.2.2-1.3.4-enhancement-1" = _ZRHqNmxC;
        "pkg-1.3.5" = _lEHG8tQa;
        "pkg-1.3.6" = _5bbuQy23;
        "pkg-1.3.7" = _5BrGALuD;
        "pkg-1.3.8" = _UtnrAdMq;
        "pkg-1.3.9" = _12uCBiSP;
        "pkg-1.3.9-e1" = _3dmxpnDN;
        "pkg-1.3.10" = _gDepoQyP;
        "pkg-1.3.11" = _GWEFfgZO;
        "pkg-4.0.0-beta.12-1.3.13" = _TI0t7MKp;
        "pkg-4.0.0-beta.13-1.3.14" = _EXWzFnqy;
        "pkg-4.0.0-beta.14-1.3.15" = _XLeNt2nY;
        "pkg-4.0.0-beta.15+hotfix.1-1.3.16" = _6kLmYr8Z;
        "pkg-4.0.0-beta.16-1.3.17" = _H1Fl5sG4;
        "pkg-4.0.0-prerelease.1-1.3.18" = _6O1uMCKA;
        "pkg-4.0.0-prerelease.2-1.3.19" = _OUoQRPa5;
        "pkg-4.0.0-1.4.0" = _iEKuzApU;
        "pkg-4.0.1-1.4.1" = _nx537HPB;
        "pkg-4.0.2-1.4.2" = _wmFtzJjt;
        "pkg-4.0.3-1.4.3" = _nr2Gvb9O;
        "pkg-4.0.4-1.4.4" = _Gwggld3N;
        "pkg-4.0.5-1.4.5" = _4fkOZei6;
        "default" = _4fkOZei6;
    });
