...
let
    ...
    in {
        ...
        "pkg-5.0b8" = _9RB82Ty7;
        "pkg-5.0b9" = _BwCS5agN;
        "pkg-5.0b10" = _EC80Mb4l;
        "pkg-5.0b11-fabric-1.21.5" = _7s2EWsqH;
        "pkg-5.0b11-neoforge-1.21.5" = _d0UUw1Wa;
        "pkg-5.0b11-neoforge-1.21.8" = _rCWRbeHe;
        "pkg-5.0b11-fabric-1.21.8" = _uNtWJquA;
        "pkg-5.0b11-neoforge-1.21.10" = _TpxgHdRj;
        "pkg-5.0b11-fabric-1.21.10" = _Fb2gRYFQ;
        "pkg-5.0b11-neoforge-1.21.11" = _FvFzemQt;
        "pkg-5.0b11-fabric-1.21.11" = _KRYVS7EF;
        "pkg-5.0b11-neoforge-26.1" = _hbwlgDP0;
        "pkg-5.0b11-fabric-26.1" = _91uqpIGr;
        "pkg-5.0b11-neoforge-26.1.2" = _RSfcNWq2;
