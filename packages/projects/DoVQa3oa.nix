...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta.1" = _JaHU40h5;
        "pkg-1.0.0-beta.2" = _HKn6LfFQ;
        "pkg-1.1.0-beta.3" = _PK5anx6l;
        "pkg-2.0.0+1.19.4" = _msU3fpYy;
        "pkg-2.0.0+1.20" = _livMoL0V;
        "pkg-2.0.1+1.19.4" = _d1cUy87M;
        "pkg-2.0.1+1.20" = _pfqjUCvA;
        "pkg-2.0.2+1.19.4" = _3oExrTvY;
        "pkg-2.0.2+1.20.1" = _xwCriu2W;
        "pkg-2.0.2+1.20.2" = _hu5eE36z;
        "pkg-2.0.2+1.20.4" = _OzFzxlIK;
        "pkg-2.0.3+1.19.4" = _T9fvJnHI;
        "pkg-2.0.3+1.20.1" = _m6DbPaS2;
        "pkg-2.0.3+1.20.2" = _ROHsLYEA;
        "pkg-2.0.3+1.20.4" = _OGmdoG1f;
        "pkg-2.0.3+1.20.6" = _U2ldQ9R3;
        "pkg-2.1.0+1.19.4" = _M1E4zPMf;
        "pkg-2.1.0+1.20.1" = _sK4V96Ro;
        "pkg-2.1.0+1.20.2" = _YjfExZ5D;
        "pkg-2.1.0+1.20.4" = _ts2g3zjk;
        "pkg-2.1.0+1.20.6" = _esQY0gSe;
        "pkg-2.1.0+1.21" = _N6CxCnCT;
        "pkg-2.1.0+1.21.3" = _VczzsOxU;
        "pkg-2.1.1+1.21.5" = _mtm5KOo7;
        "pkg-2.1.1+1.21.6" = _kUifwgXI;
        "pkg-2.1.2+1.21.6" = _PVaLC2DX;
        "pkg-2.1.2+1.21.7" = _kqFWwtep;
        "pkg-2.1.2+1.21.9" = _Lzc5ATXl;
        "pkg-2.1.2+1.21.11" = _F60yCR0R;
        "default" = _F60yCR0R;
    });
