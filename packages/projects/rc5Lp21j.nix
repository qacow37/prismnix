...
let
    ...
    in {
        ...
        "pkg-1.4.4" = _8Y9rIjhg;
        "pkg-1.4.5" = _R5j9Ew3B;
        "pkg-1.4.5.1" = _4LnTuIJU;
        "pkg-1.4.6" = _vJslWrxC;
        "pkg-1.4.6.1" = _8yprL4H1;
        "pkg-1.4.7" = _FJYxf2e1;
        "pkg-1.4.8" = _gzscW4QH;
        "pkg-2.0-1.21.7" = _jxJzlrtG;
        "pkg-2.0-1.21.8" = _HWHmaJK3;
        "pkg-2.1-1.21.8" = _xB5oEcQI;
        "pkg-2.2-1.21.8" = _SJE3ZM73;
        "pkg-2.3-mc26.1" = _qJhpenLt;
