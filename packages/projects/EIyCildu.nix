...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20" = _IXXNm6MB;
        "pkg-1.0.0+1.20.6" = _YRhyun6Y;
        "pkg-1.0.0+1.21" = _TFPq7iAn;
        "pkg-1.0.0+1.19.2" = _RqC2X4po;
        "pkg-1.0.0+1.19.4" = _MVG8uXgo;
        "pkg-1.0.0+1.18" = _dVpc4YdK;
        "pkg-1.0.0+1.17.1" = _CNCnV2so;
        "pkg-1.0.0+1.16.5" = _oVDVkP2N;
        "pkg-1.0.1+1.20" = _7GkKy7XQ;
        "pkg-1.0.1+1.20.6" = _IlBQeE6x;
        "pkg-1.0.1+1.21" = _nf1TWWcN;
        "pkg-1.0.1+1.19.4" = _WGR4W3AD;
        "pkg-1.0.1+1.19.2" = _1YzKYn5J;
        "pkg-1.0.1+1.18" = _TAH89j6N;
        "pkg-1.0.1+1.17.1" = _tMMjyNo4;
        "pkg-1.0.1+1.16.5" = _315egtn7;
        "pkg-1.1.0+1.20" = _PeJK6BzV;
        "pkg-1.1.0+1.20.2" = _pozJjlNy;
        "pkg-1.1.0+1.20.4" = _weHDtK1V;
        "pkg-1.1.1+1.16.5" = _eqtieEfM;
        "pkg-1.1.1+1.17.1" = _Tr6QkUON;
        "pkg-1.1.1+1.18" = _lMcoZzet;
        "pkg-1.1.1+1.19.2" = _ypIz0zmm;
        "pkg-1.1.1+1.19.4" = _84il2JQU;
        "pkg-1.1.1+1.20" = _fRavCz8M;
        "pkg-1.1.1+1.20.2" = _5yNspsmX;
        "pkg-1.1.1+1.20.4" = _P0kKOSsn;
        "pkg-1.1.1+1.20.6" = _ZVZAx1fX;
        "pkg-1.1.2+1.16.5" = _jaw81PVz;
        "pkg-1.1.2+1.17.1" = _oayJMrDK;
        "pkg-1.1.2+1.18" = _SOHB1Y28;
        "pkg-1.1.2+1.19.2" = _QV47nP6O;
        "pkg-1.1.2+1.19.4" = _VC185YPt;
        "pkg-1.1.2+1.20.2" = _iX4o92lL;
        "pkg-1.1.2+1.20.4" = _etttXv6L;
        "pkg-1.1.2+1.20" = _gqH963Mj;
        "pkg-1.1.2+1.20.6" = _4UYvgC0U;
        "pkg-1.1.3+1.16.5" = _IIpXQUv0;
        "pkg-1.1.3+1.17.1" = _rIC2efSC;
        "pkg-1.1.3+1.18" = _wAI2vBFv;
        "pkg-1.1.3+1.19.2" = _DI1mILeV;
        "pkg-1.1.3+1.19.4" = _zY0cbpBU;
        "pkg-1.1.3+1.20.1" = _9mfb8glL;
        "pkg-1.1.3+1.20.2" = _clTyMR71;
        "pkg-1.1.3+1.20.4" = _BwWpEBh5;
        "pkg-1.1.3+1.20.6" = _Yu0U4iSE;
        "pkg-1.1.4+1.16.5" = _3CvzDKPA;
        "pkg-1.1.4+1.17.1" = _nfGryM0b;
        "pkg-1.1.4+1.18" = _NMqfh80F;
        "pkg-1.1.4+1.19.2" = _FNsb0aQI;
        "pkg-1.1.4+1.19.4" = _zwbmuCId;
        "pkg-1.1.4+1.20.1" = _LYhpLxcM;
        "pkg-1.1.4+1.20.2" = _OF9s4qrZ;
        "pkg-1.1.4+1.20.4" = _X50u4r3H;
        "pkg-1.1.4+1.20.6" = _4pIOkEyj;
        "pkg-1.1.5+1.16.5" = _ugJMfCEP;
        "pkg-1.1.5+1.17.1" = _iLDAtyww;
        "pkg-1.1.5+1.18" = _skpvo7BP;
        "pkg-1.1.5+1.19.2" = _Hj9abyHz;
        "pkg-1.1.5+1.19.4" = _t4bp3sAn;
        "pkg-1.1.5+1.20.1" = _akbAjdex;
        "pkg-1.1.5+1.20.2" = _ATLcmUbA;
        "pkg-1.1.5+1.20.4" = _BcCSA8OE;
        "pkg-1.1.5+1.20.6" = _PbW1cdrr;
        "default" = _PbW1cdrr;
    });
