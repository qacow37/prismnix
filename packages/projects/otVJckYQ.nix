...
let
    ...
    in {
        ...
        "pkg-0.8.0" = _V26qldGn;
        "pkg-0.8.1" = _Zhnavk8e;
        "pkg-0.8.1-1.18" = _n2100b4k;
        "pkg-0.8.2+1.17.1" = _jE0ZHEaE;
        "pkg-0.8.2+1.18.1" = _ysxlawje;
        "pkg-0.9.0+1.18.1" = _BPn79vsk;
        "pkg-0.9.0+1.17.1" = _LsLnEHfF;
        "pkg-0.9.1+1.18.1" = _PnxfNudU;
        "pkg-0.9.1+1.17.1" = _fprkWN1h;
        "pkg-1.0.0+1.18.2" = _Sn4jfAoS;
        "pkg-1.0.1+1.18.2" = _UpVioyBK;
        "pkg-1.1.0+1.19" = _C2bXAbXg;
        "pkg-1.1.0+1.18.2" = _ity0tBq3;
        "pkg-1.1.1+1.19" = _2jLdI2KI;
        "pkg-1.1.1+1.18.2" = _SwmQcI45;
        "pkg-1.1.2+1.19.2" = _lYmW1wnD;
        "pkg-1.1.3+1.19.3" = _hGatm5K8;
        "pkg-1.1.3+1.19.4" = _8oMEcc2E;
        "pkg-1.1.3+1.20" = _c7Lo4vij;
        "pkg-1.1.3+1.20.4" = _Hvp3zWWg;
        "pkg-1.1.4+1.19.4" = _12a79WxW;
        "pkg-1.1.4+1.20.1" = _ICT7jids;
        "pkg-1.1.4+1.20.4" = _VxeA5kfK;
        "pkg-1.1.5+1.19.4" = _O0trWhHX;
        "pkg-1.1.5+1.20.1" = _8uQeAHwk;
        "pkg-1.1.5+1.20.4" = _MU5nRGAS;
        "pkg-1.2.0+1.21" = _G6VEzcyZ;
        "pkg-1.2.1+1.21" = _FnarCxUt;
        "pkg-1.2.2+1.21" = _JUnP9V1A;
        "pkg-1.2.2+1.20.4" = _fLxqKl9W;
        "pkg-1.2.2+1.20.1" = _VzDTHJkq;
        "pkg-1.2.2+1.19.4" = _PWzftv7C;
        "default" = _PWzftv7C;
    });
