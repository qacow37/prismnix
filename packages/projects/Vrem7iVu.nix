...
let
    ...
    in {
        ...
        "pkg-1.5.0" = _M0y7ghm6;
        "pkg-1.5.1" = _Cj9Ln0HW;
        "pkg-1.6.0-1.21.1" = _jUQ6oeb8;
        "pkg-1.6.0-1.21.1-neoforge" = _BzEBV8Ka;
        "pkg-1.6.1-1.21.1" = _dC6r6zq4;
        "pkg-1.6.1-1.21.1-neoforge" = _UKef4h0T;
        "pkg-1.6.1-1.21.4" = _Da08yje2;
        "pkg-1.6.1-1.21.4-neoforge" = _Vm9DlfHO;
        "pkg-1.6.2-1.21.1" = _8g3C3Crj;
        "pkg-1.6.2-1.21.1-neoforge" = _n0F5Zez5;
        "pkg-1.6.2-1.21.4" = _4yFrrMFV;
        "pkg-1.6.2-1.21.4-neoforge" = _7n04YhHm;
        "pkg-1.6.3-1.21.1" = _G829rfcD;
        "pkg-1.6.3-1.21.1-neoforge" = _agpanfek;
        "pkg-1.6.3-1.21.4" = _evB8PXE1;
        "pkg-1.6.3-1.21.4-neoforge" = _DgFWS0s4;
        "pkg-1.6.3-1.21.5-fabric" = _I1FWCkNi;
        "pkg-1.6.3-1.21.5-neoforge" = _GFNHPQpx;
        "pkg-1.6.4-1.21.1" = _VbDY9kvW;
        "pkg-1.6.4-1.21.1-neoforge" = _x2ox3hWs;
        "pkg-1.6.4-1.21.4" = _H8Vzzugr;
        "pkg-1.6.4-1.21.4-neoforge" = _cPCJN9Sl;
        "pkg-1.6.4-1.21.5-fabric" = _eYRYDML1;
        "pkg-1.6.4-1.21.5-neoforge" = _y92XG3lF;
        "pkg-1.7.0-1.21.1" = _UcDvtCU6;
        "pkg-1.7.0-1.21.5" = _vcl2S9eL;
        "pkg-1.8.0-1.21.1" = _YXevWDha;
        "pkg-1.8.0-1.21.5" = _IX4KwuHe;
        "pkg-1.9.0-1.21.1" = _AbqkyqSO;
        "pkg-1.9.0-1.21.5" = _yw3JciCO;
        "pkg-1.10.0-1.21.1" = _a0DgMrFF;
        "pkg-1.10.0-1.21.5" = _8EGxfuGB;
        "pkg-1.10.0-1.21.6" = _vh3I52fM;
        "pkg-1.10.0-1.21.7" = _zkm3fdOX;
        "pkg-1.10.0-1.21.8" = _Yp6xRbHp;
        "pkg-1.10.1-1.20.1" = _42Blkiv8;
        "pkg-1.10.1-1.21.1" = _3GmsVXLt;
        "pkg-1.10.1-1.21.5" = _n6mzCkUL;
        "pkg-1.10.1-1.21.8" = _7xzfxkip;
        "pkg-1.10.1-1.21.10" = _DcVRCUVS;
        "default" = _DcVRCUVS;
    });
