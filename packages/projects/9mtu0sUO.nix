...
let
    ...
    in {
        ...
        "pkg-mc1.14.4-v1.0.0" = _YUgxKEKe;
        "pkg-mc1.19.4-v1.0.0" = _RJKJoV9U;
        "pkg-mc1.17.1-v1.0.0" = _pbhFD6Bg;
        "pkg-mc1.20.1-v1.0.0" = _frdZOP14;
        "pkg-mc1.15.2-v1.0.0" = _DYpL2epS;
        "pkg-mc1.18.2-v1.0.0" = _pPaj1gjY;
        "pkg-mc1.16.5-v1.0.0" = _CLkCjEfk;
        "pkg-mc1.14.4-v1.0.1" = _n0YIJ1YE;
        "pkg-mc1.15.2-v1.0.1" = _o8qICw9R;
        "pkg-mc1.17.1-v1.0.1" = _m2mNKXzo;
        "pkg-mc1.20.4-v1.0.1" = _U5CYxkEG;
        "pkg-mc1.16.5-v1.0.1" = _7TxWOePY;
        "pkg-mc1.18.2-v1.0.1" = _h4c0SNtB;
        "pkg-mc1.19.4-v1.0.1" = _Zxj15LVy;
        "pkg-mc1.18.2-v1.0.2" = _OvBXDH38;
        "pkg-mc1.21-v1.0.2" = _HE6szxhM;
        "pkg-mc1.19.4-v1.0.2" = _2dOWQp3B;
        "pkg-mc1.20.4-v1.0.2" = _3YxQo32x;
        "pkg-mc1.15.2-v1.0.2" = _7jnoTelr;
        "pkg-mc1.17.1-v1.0.2" = _qM03m6xi;
        "pkg-mc1.16.5-v1.0.2" = _HLmdNz5i;
        "pkg-mc1.20.6-v1.0.2" = _LJ5ISYtE;
        "pkg-mc1.14.4-v1.0.2" = _SmarpJub;
        "pkg-mc1.16.5-v1.0.3" = _DJhhcvBF;
        "pkg-mc1.15.2-v1.0.3" = _A3JRugus;
        "pkg-mc1.14.4-v1.0.3" = _706a2hEP;
        "pkg-mc1.19.4-v1.0.3" = _3YkVF6yS;
        "pkg-mc1.18.2-v1.0.3" = _X7ue7H6s;
        "pkg-mc1.20.4-v1.0.3" = _bIaMwV7B;
        "pkg-mc1.17.1-v1.0.3" = _LEEThmyo;
        "pkg-mc1.20.6-v1.0.3" = _ONAfavf9;
        "pkg-mc1.21-v1.0.3" = _bizvAOsR;
        "pkg-v1.0.4-mc1.15.2-fabric" = _PIjAvBqZ;
        "pkg-v1.0.4-mc1.20.6-neoforge" = _65naNANb;
        "pkg-v1.0.4-mc1.21.1-forge" = _8NWMHE0h;
        "pkg-v1.0.4-mc1.16.5-forge" = _y30GnKfV;
        "pkg-v1.0.4-mc1.18.2-forge" = _pgxzFutj;
        "pkg-v1.0.4-mc1.20.4-forge" = _BOVLchgc;
        "pkg-v1.0.4-mc1.21.1-fabric" = _LU2kiOwD;
        "pkg-v1.0.4-mc1.18.2-fabric" = _cExyfFjb;
        "pkg-v1.0.4-mc1.15.2-forge" = _pIiG9ejV;
        "pkg-v1.0.4-mc1.14.4-fabric" = _2ZHEV8E3;
        "pkg-v1.0.4-mc1.17.1-fabric" = _Wh0M6L5a;
        "pkg-v1.0.4-mc1.17.1-forge" = _HTtwtgyC;
        "pkg-v1.0.4-mc1.21.1-neoforge" = _U5rIC9IA;
        "pkg-v1.0.4-mc1.20.6-fabric" = _rPUNIIGC;
        "pkg-v1.0.4-mc1.19.4-forge" = _rH2a22bZ;
        "pkg-v1.0.4-mc1.19.4-fabric" = _U4b0v0n1;
        "pkg-v1.0.4-mc1.20.4-fabric" = _d90Tx6AK;
        "pkg-v1.0.4-mc1.16.5-fabric" = _TirvqY65;
        "pkg-v1.0.4-mc1.20.6-forge" = _FmEPAM0m;
        "pkg-v1.0.5-mc1.15.2-fabric" = _sgC9NGBU;
        "pkg-v1.0.5-mc1.17.1-fabric" = _HxdgEdWZ;
        "pkg-v1.0.5-mc1.20.4-forge" = _lfk0K3KM;
        "pkg-v1.0.5-mc1.16.5-forge" = _le69bPEB;
        "pkg-v1.0.5-mc1.20.6-neoforge" = _4P132Us8;
        "pkg-v1.0.5-mc1.16.5-fabric" = _Ep1D3KcH;
        "pkg-v1.0.5-mc1.18.2-forge" = _zTAVrWoj;
        "pkg-v1.0.5-mc1.15.2-forge" = _DdkZQYqb;
        "pkg-v1.0.5-mc1.18.2-fabric" = _B7Q1VpkD;
        "pkg-v1.0.5-mc1.21.1-fabric" = _24ohs0tI;
        "pkg-v1.0.5-mc1.17.1-forge" = _wUg6mKYX;
        "pkg-v1.0.5-mc1.19.4-forge" = _rWuoGgn4;
        "pkg-v1.0.5-mc1.20.4-fabric" = _G8gwjTTP;
        "pkg-v1.0.5-mc1.20.6-forge" = _WdNb7k6Q;
        "pkg-v1.0.5-mc1.20.6-fabric" = _xbPO3Xo5;
        "pkg-v1.0.5-mc1.14.4-fabric" = _5mzFleyt;
        "pkg-v1.0.5-mc1.19.4-fabric" = _opUTFCAd;
        "pkg-v1.0.5-mc1.21.1-forge" = _LqFzWgBN;
        "pkg-v1.0.5-mc1.21.1-neoforge" = _kiXzQdpL;
        "pkg-v1.0.6-mc1.21.4-forge" = _h43IK3E4;
        "pkg-v1.0.6-mc1.21.5-forge" = _72GOearL;
        "pkg-v1.0.6-mc1.16.5-fabric" = _RwDWAiGQ;
        "pkg-v1.0.6-mc1.15.2-fabric" = _9cU4l5qF;
        "pkg-v1.0.6-mc1.18.2-forge" = _53yc00JP;
        "pkg-v1.0.6-mc1.21.5-neoforge" = _5dvaBNN3;
        "pkg-v1.0.6-mc1.20.6-fabric" = _QznNK1Sl;
        "pkg-v1.0.6-mc1.21.3-fabric" = _Okxr6qqD;
        "pkg-v1.0.6-mc1.21.5-fabric" = _CpTOIjLX;
        "pkg-v1.0.6-mc1.21.6-fabric" = _ZtH66rsT;
        "pkg-v1.0.6-mc1.17.1-fabric" = _AiMCFZtz;
        "pkg-v1.0.6-mc1.18.2-fabric" = _qlnaOYQl;
        "pkg-v1.0.6-mc1.17.1-forge" = _UdwiHtZd;
        "pkg-v1.0.6-mc1.14.4-fabric" = _riGImfiQ;
        "pkg-v1.0.6-mc1.20.4-fabric" = _6m6v48ZO;
        "pkg-v1.0.6-mc1.19.4-fabric" = _bfRUDCgK;
        "pkg-v1.0.6-mc1.21.4-neoforge" = _4k4vfGzm;
        "pkg-v1.0.6-mc1.19.4-forge" = _NusSXbe3;
        "pkg-v1.0.6-mc1.21.1-neoforge" = _iGe4wKzY;
        "pkg-v1.0.6-mc1.16.5-forge" = _fOwFZrZR;
        "pkg-v1.0.6-mc1.20.6-forge" = _8V3YFLlv;
        "pkg-v1.0.6-mc1.21.4-fabric" = _Y12fYmW4;
        "pkg-v1.0.6-mc1.21.1-forge" = _WzBD9gk6;
        "pkg-v1.0.6-mc1.21.3-forge" = _S8fyqtRk;
        "pkg-v1.0.6-mc1.21.3-neoforge" = _HByDJdc2;
        "pkg-v1.0.6-mc1.21.1-fabric" = _cbxWCbkn;
        "pkg-v1.0.6-mc1.20.6-neoforge" = _Gfq1FF10;
        "pkg-v1.0.6-mc1.21.6-neoforge" = _LtrGUJuL;
        "pkg-v1.0.6-mc1.15.2-forge" = _yRkF4w9G;
        "pkg-v1.0.6-mc1.20.4-forge" = _4b0MOJVY;
        "pkg-v1.0.7-mc1.21.3-forge" = _zzcjxy4Y;
        "pkg-v1.0.7-mc1.16.5-fabric" = _EzW6MQGC;
        "pkg-v1.0.7-mc1.21.1-fabric" = _vCOimgHn;
        "pkg-v1.0.7-mc1.18.2-forge" = _K7sVuzmY;
        "pkg-v1.0.7-mc1.15.2-forge" = _cWLOsBiT;
        "pkg-v1.0.7-mc1.16.5-forge" = _uqKvMA4U;
        "pkg-v1.0.7-mc1.19.4-forge" = _fg0tuybG;
        "pkg-v1.0.7-mc1.21.5-forge" = _P7cU8tkI;
        "pkg-v1.0.7-mc1.19.4-fabric" = _68o9MU4K;
        "pkg-v1.0.7-mc1.18.2-fabric" = _UfD6eb9X;
        "pkg-v1.0.7-mc1.20.6-fabric" = _FTlINZbx;
        "pkg-v1.0.7-mc1.17.1-fabric" = _qT9SrTbD;
        "pkg-v1.0.7-mc1.15.2-fabric" = _pBW7XUEx;
        "pkg-v1.0.7-mc1.21.1-forge" = _1ACoZQZB;
        "pkg-v1.0.7-mc1.21.5-fabric" = _jgQ4ny6W;
        "pkg-v1.0.7-mc1.21.4-forge" = _1b8kdCWm;
        "pkg-v1.0.7-mc1.21.3-fabric" = _1XXpCYhn;
        "pkg-v1.0.7-mc1.21.4-fabric" = _PFHPLtMO;
        "pkg-v1.0.7-mc1.20.4-fabric" = _vUzelzwj;
        "pkg-v1.0.7-mc1.20.6-forge" = _KZImv3EX;
        "pkg-v1.0.7-mc1.14.4-fabric" = _LQDxnJkS;
        "pkg-v1.0.7-mc1.21.6-fabric" = _qpQl8tBR;
        "pkg-v1.0.7-mc1.21.1-neoforge" = _eqzWgurh;
        "pkg-v1.0.7-mc1.21.6-neoforge" = _1BNB9pCO;
        "pkg-v1.0.7-mc1.21.5-neoforge" = _jjRkhWqi;
        "pkg-v1.0.7-mc1.17.1-forge" = _jrhE7GJ3;
        "pkg-v1.0.7-mc1.21.3-neoforge" = _59eV8p1O;
        "pkg-v1.0.7-mc1.20.4-forge" = _W1Wnmkqh;
        "pkg-v1.0.7-mc1.20.6-neoforge" = _QlckUzRN;
        "pkg-v1.0.7-mc1.21.4-neoforge" = _TFtWOqLA;
        "pkg-v1.0.7-mc1.21.6-forge" = _KS1mQRKi;
        "pkg-v1.0.8-mc1.21.8-neoforge" = _scTb3qT6;
        "pkg-v1.0.8-mc1.21.4-forge" = _1VLK7kd0;
        "pkg-v1.0.8-mc1.21.11-neoforge" = _VaI75KVi;
        "pkg-v1.0.8-mc1.20.6-forge" = _7A5ajRwt;
        "pkg-v1.0.8-mc1.21.8-fabric" = _XRWzblpD;
        "pkg-v1.0.8-mc1.16.5-forge" = _hk0heEBK;
        "pkg-v1.0.8-mc1.21.1-fabric" = _ux7vO2Nl;
        "pkg-v1.0.8-mc1.21.3-neoforge" = _pUZYCWsG;
        "pkg-v1.0.8-mc1.16.5-fabric" = _9PAYbjQB;
        "pkg-v1.0.8-mc1.20.4-fabric" = _orESoHrJ;
        "pkg-v1.0.8-mc1.21.5-neoforge" = _D9zk1sSk;
        "pkg-v1.0.8-mc1.21.3-fabric" = _GsfCDIh7;
        "pkg-v1.0.8-mc1.17.1-fabric" = _a7TzvY2y;
        "pkg-v1.0.8-mc1.19.4-fabric" = _bmQoM7k0;
        "pkg-v1.0.8-mc1.21.1-forge" = _T72eQ73v;
        "pkg-v1.0.8-mc1.21.5-fabric" = _oyEiAFab;
        "pkg-v1.0.8-mc1.21.4-fabric" = _vMmX6FTn;
        "pkg-v1.0.8-mc1.21.10-neoforge" = _KSBU4OcD;
        "pkg-v1.0.8-mc1.15.2-fabric" = _7QvqWvi9;
        "pkg-v1.0.8-mc1.20.6-fabric" = _koRhswV2;
        "pkg-v1.0.8-mc1.14.4-fabric" = _7Dq745d3;
        "pkg-v1.0.8-mc1.19.4-forge" = _qHGL0oRe;
        "pkg-v1.0.8-mc1.21.11-fabric" = _qtIKi2T9;
        "pkg-v1.0.8-mc1.21.5-forge" = _uHMJhsJS;
        "pkg-v1.0.8-mc1.20.4-forge" = _1Psj7GtQ;
        "pkg-v1.0.8-mc1.20.6-neoforge" = _CJWQIQUJ;
        "pkg-v1.0.8-mc1.21.10-forge" = _Heo4M3DU;
        "pkg-v1.0.8-mc1.21.8-forge" = _pCyA5cLA;
        "pkg-v1.0.8-mc1.21.10-fabric" = _ToOpOJrb;
        "pkg-v1.0.8-mc1.21.1-neoforge" = _E7QL0wJ2;
        "pkg-v1.0.8-mc1.18.2-fabric" = _BIyi3Eqm;
        "pkg-v1.0.8-mc1.17.1-forge" = _mRQCBcAv;
        "pkg-v1.0.8-mc1.21.3-forge" = _U8b79pg4;
        "pkg-v1.0.8-mc1.18.2-forge" = _jKIIDU9J;
        "pkg-v1.0.8-mc1.21.4-neoforge" = _sIg6p4rR;
        "pkg-v1.0.9-mc26.1-fabric" = _ZYp0dup2;
        "pkg-v1.0.10-mc1.15.2-fabric" = _BTPZy7uU;
        "pkg-v1.0.10-mc1.14.4-fabric" = _gWCX212I;
        "pkg-v1.0.10-mc1.17.1-fabric" = _mm6pNn6O;
        "pkg-v1.0.10-mc1.16.5-fabric" = _H4FSuHXX;
        "pkg-v1.0.10-mc1.18.2-fabric" = _5maful5k;
        "pkg-v1.0.10-mc1.19.4-fabric" = _aMTMs4tQ;
        "pkg-v1.0.10-mc1.20.4-fabric" = _CMFSIPnF;
        "pkg-v1.0.10-mc1.20.6-fabric" = _j9xXxoAh;
        "pkg-v1.0.10-mc1.21.1-fabric" = _EkuuJ35A;
        "pkg-v1.0.10-mc1.21.3-fabric" = _TuzvhP0U;
        "pkg-v1.0.10-mc1.21.5-fabric" = _901ohihp;
        "pkg-v1.0.10-mc1.21.8-fabric" = _iGwywRWV;
        "pkg-v1.0.10-mc1.21.4-fabric" = _Az73mYAC;
        "pkg-v1.0.10-mc1.21.10-fabric" = _aDJiXCbI;
        "pkg-v1.0.10-mc1.21.11-fabric" = _QSsAk3tF;
        "pkg-v1.0.10-mc26.1.2" = _5Sggn6uD;
        "pkg-v1.0.10-mc1.16.5-forge" = _7zvfALF9;
        "pkg-v1.0.10-mc1.17.1-forge" = _jrONJ2py;
        "pkg-v1.0.10-mc1.19.4-forge" = _x4Q8kZQc;
        "pkg-v1.0.10-mc1.18.2-forge" = _N0Al4elx;
        "pkg-v1.0.10-mc1.20.6-neoforge" = _Jm15KFr8;
        "pkg-v1.0.10-mc1.20.4-forge" = _3xvZzUQi;
        "pkg-v1.0.10-mc1.21.1-neoforge" = _UR5aKL95;
        "pkg-v1.0.10-mc1.21.3-neoforge" = _JEH4qNFL;
        "pkg-v1.0.10-mc1.21.4-neoforge" = _a8pHoPrE;
        "pkg-v1.0.10-mc1.21.8-neoforge" = _HK5DcTlm;
        "pkg-v1.0.10-mc1.21.10-neoforge" = _hBuHRwR5;
        "pkg-v1.0.10-mc1.21.5-neoforge" = _4vOutNtd;
        "pkg-v1.0.10-mc1.21.11-neoforge" = _tIEaRjEW;
        "pkg-v1.0.11-mc1.17.1-fabric" = _pQYCWttn;
        "pkg-v1.0.11-mc1.14.4-fabric" = _jSBnwZNi;
        "pkg-v1.0.11-mc1.16.5-fabric" = _vxTCXrut;
        "pkg-v1.0.11-mc1.15.2-fabric" = _UuXIoVhS;
        "pkg-v1.0.11-mc1.18.2-fabric" = _zCjqARiX;
        "pkg-v1.0.11-mc1.19.4-fabric" = _izOFcggl;
        "pkg-v1.0.11-mc1.20.6-fabric" = _FdS6uLtc;
        "pkg-v1.0.11-mc1.20.4-fabric" = _NREzJQ08;
        "pkg-v1.0.11-mc1.21.1-fabric" = _NFtAZrG7;
        "pkg-v1.0.11-mc1.21.4-fabric" = _2AEYZHSA;
        "pkg-v1.0.11-mc1.21.3-fabric" = _LsjD2og7;
        "pkg-v1.0.11-mc1.21.5-fabric" = _7japr3eW;
        "pkg-v1.0.11-mc1.21.8-fabric" = _LFUtSgNM;
        "pkg-v1.0.11-mc1.21.10-fabric" = _CZ4MiQnt;
        "pkg-v1.0.11-mc1.21.11-fabric" = _E3Ei5xUe;
        "pkg-v1.0.11-mc1.16.5-forge" = _VI6s54Rl;
        "pkg-v1.0.11-mc26.1.2" = _H7KycYXE;
        "pkg-v1.0.11-mc1.17.1-forge" = _uAbKEmlZ;
        "pkg-v1.0.11-mc1.18.2-forge" = _Nx8FEAxU;
        "pkg-v1.0.11-mc1.19.4-forge" = _jtyO0Shh;
        "pkg-v1.0.11-mc1.20.6-neoforge" = _6trKxJBv;
        "pkg-v1.0.11-mc1.20.4-forge" = _WVhGsL3a;
        "pkg-v1.0.11-mc1.21.1-neoforge" = _gRe07TZL;
        "pkg-v1.0.11-mc1.21.3-neoforge" = _pHzY2iaY;
        "pkg-v1.0.11-mc1.21.4-neoforge" = _gNlSiIA6;
        "pkg-v1.0.11-mc1.21.8-neoforge" = _RLdgEHlX;
        "pkg-v1.0.11-mc1.21.5-neoforge" = _HELCqJqs;
        "pkg-v1.0.11-mc1.21.11-neoforge" = _JU2njn2L;
        "pkg-v1.0.11-mc1.21.10-neoforge" = _bca576HQ;
        "default" = _bca576HQ;
    });
