...
let
    ...
    in {
        ...
        "pkg-0.9B-Forge" = _uippMRK8;
        "pkg-0.9.1B-Forge" = _1fNmAO0F;
        "pkg-0.9.2B-Forge" = _pCnulscg;
        "pkg-0.9.3B-Forge" = _yJsdjFCx;
        "pkg-0.9.4B-Forge" = _dvQwbrAG;
        "pkg-0.9.8B-Forge" = _r7L5f5ke;
        "pkg-0.9.9B-Forge" = _Z37hCSb1;
        "pkg-0.9.9B-1.19-Fabric" = _xJf04HVg;
        "pkg-0.9.9B-Fabric" = _HNjVp04U;
        "pkg-1.0.0-Forge" = _BPLq9Tm8;
        "pkg-1.0.1-Forge" = _z4rorwcf;
        "pkg-1.0.1-1.20.1-neo" = _MYMMVIzg;
        "pkg-1.0.2-Fabric" = _bWjIu3xO;
        "pkg-1.0.2-Forge" = _pjTRxH9X;
        "pkg-1.0.3-Forge" = _3qHmO4nj;
        "pkg-1.0.4-Forge" = _sV3vL4Pj;
        "pkg-1.0.4-Fabric" = _UalT0WKy;
        "pkg-1.0.4-Neo" = _F5KJ9Dis;
        "pkg-1.0.5-1.21x-Fabric" = _Hf0F5dLJ;
        "pkg-1.0.6-1.20-1.20.4-Fabric" = _UOYZFT8w;
        "pkg-1.0.6-1.21x-Fabric" = _wsyRWr8J;
        "pkg-1.0.7-1.20-1.20.4-Fabric" = _OAtrh99A;
        "pkg-1.0.7-1.20-1.20.4-Forge" = _2VfNpQl7;
        "pkg-1.0.7-1.21x-Fabric" = _rilYpcKc;
        "pkg-1.0.9-1.21x-Fabric" = _A77sp5CA;
        "pkg-1.0.9-1.20-1.20-4-Fabric" = _fTPqC7zg;
        "pkg-1.0.9-1.21x-Neo" = _I4bxerkA;
        "pkg-1.0.9.1-1.20-1.20-4-Fabric" = _n47xhuYB;
        "pkg-1.0.9.2-1.21x-Fabric" = _tNs30YHk;
        "pkg-1.0.9.2-1.20-1.20-4-Fabric" = _lBHCN5vc;
        "pkg-1.0.9.2-1.20-1.20-4-Forge" = _JD2Ex6zm;
        "pkg-1.0.9.2-1.21x-Neo" = _MAe3xdzH;
        "pkg-1.0.9.3-1.21x-Neo" = _B6d3Nliy;
        "pkg-1.0.9.3-1.20-1.20-4-Forge" = _MdzVLJD9;
        "pkg-1.0.9.3-1.21x-Fabric" = _ZrjepwzW;
        "pkg-1.0.9.4-1.21x-Fabric" = _5Eoo0Lnr;
        "pkg-1.0.9.5-1.21x-Fabric" = _I0camD8b;
        "pkg-1.1.0-1.20-1.20.2-forge" = _uRDQDE7I;
        "pkg-1.1.1-1.20-1.20.2-forge" = _zHPT4DJX;
        "pkg-1.1.2-1.20-1.20.2-forge" = _gg01YXDc;
        "pkg-1.1.3-1.20-1.20.2-forge" = _ZIWYogML;
        "pkg-1.1.3-1.20-1.20.2-fabric" = _ZE1xlLB3;
        "pkg-1.1.3-1.21-1.21.1-fabric" = _W9rbvCVJ;
        "pkg-1.1.3-1.21.2-1.21.3-fabric" = _QvCtqCJi;
        "pkg-1.1.3.1.21.4-fabric" = _xYljhWGE;
        "pkg-1.1.4-1.20-1.20.2-fabric" = _S2ztUI4n;
        "pkg-1.1.4-1.20-1.20.2-forge" = _sfFv3y0M;
        "pkg-1.1.5-1.21.4-fabric" = _M3xkaX2o;
        "pkg-1.1.5-1.20-1.20.2-forge" = _8UzOXed2;
        "pkg-1.1.5.1-1.20-1.20.2-forge" = _YhZGG5yP;
        "pkg-1.1.5-1.20-1.20.2-fabric" = _Z2E5to4k;
        "pkg-1.1.6-1.21.2-1.21.3-Fabric" = _P9L51k3F;
        "pkg-1.1.6-1.21.4-Fabric" = _52fNoKPn;
        "pkg-1.1.7-1.21.4-Fabric" = _GCfUgm6z;
        "pkg-1.1.6.1-1.20-1.20.2-Forge" = _xqawvUAz;
        "pkg-1.1.6.1-1.21-1.21.2-Fabric" = _P5rVa1WV;
        "pkg-1.1.6.1-1.20-1.20.2" = _AxFvWdI8;
        "pkg-1.1.6.1-1.21-1.21.2" = _Z0XwYKrd;
        "pkg-1.1.7-1.21-1.21.2" = _UwnV9e6A;
        "pkg-1.1.7-1.21.5-fabric" = _c8GeeFyH;
        "pkg-1.1.7-1.21-1.21.1-neo" = _8v56tOd6;
        "pkg-1.1.7-1.21.2-1.21.4-neo" = _UpgPwIej;
        "pkg-1.1.7-1.20-1.20.2-fabric" = _lBU3335A;
        "pkg-1.1.7.1-1.21-1.21.2-fabric" = _r0h40KTE;
        "pkg-1.1.7.1-1.21-1.21.1-neo" = _NQ5Qb9PG;
        "pkg-1.1.7.1-1.21.5-1.21.8-fabric" = _bbMWgPNB;
        "pkg-1.1.6.2-1.20-1.20.2-forge" = _G1RE5I57;
        "pkg-1.1.7.3-1.20-1.20.2-fabric" = _RsQoB3fw;
        "pkg-1.1.8-1.21-1.21.1-neo" = _GCEHKiTz;
        "pkg-1.1.7.3p-1.21-1.21.2" = _lp6kFckd;
        "default" = _lp6kFckd;
    });
