...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _cNoED1H6;
        "pkg-1.1.3" = _qn8SFcD2;
        "pkg-2.0.0.4" = _ciABeNB5;
        "pkg-2.0.0.8" = _A3c5Yvc0;
        "pkg-2.0.0.9" = _eGA5g8XB;
        "pkg-2.0.0.10" = _jvX1ypMC;
        "pkg-2.0.0.11" = _1akJMDwL;
        "pkg-2.0.0.12" = _JKoSYW51;
        "pkg-2.0.0.13" = _XAYyYEnH;
        "pkg-2.0.0.14" = _VOTKRPRr;
        "pkg-2.0.0.15" = _ADTUFYM4;
        "pkg-2.0.0.16" = _gIWsF2mw;
        "pkg-2.0.0.17" = _au5Y3nLX;
        "pkg-1.1.3.7" = _DOAuNbvH;
        "pkg-2.0.0.18" = _P8R3oI9p;
        "pkg-1.1.3.8" = _QFPOlT3V;
        "pkg-2.0.0.19" = _HwBhMFOM;
        "pkg-2.0.0.20" = _oE92J00t;
        "pkg-2.0.0.21" = _qZ99BNWR;
        "pkg-3.0.0.2" = _Rv24zOQP;
        "pkg-3.0.0.4" = _V2MEYaHW;
        "pkg-3.0.0.5" = _QYi99xM6;
        "pkg-3.0.0.6" = _ghxKMkSy;
        "pkg-3.0.0.7" = _nKxqKneK;
        "pkg-3.0.0.8" = _8M4kmZ3Z;
        "pkg-3.0.0.9" = _ObvRUnU8;
        "pkg-3.0.0.10" = _5WuaZd4Z;
        "pkg-3.0.0.1" = _SDlws2C1;
        "pkg-3.0.0.3" = _JWwVJzo6;
        "pkg-4.0.0.4" = _YljjXF71;
        "pkg-4.0.0.6" = _7KvX4XBK;
        "pkg-4.0.0.7" = _dFE3cNbR;
        "pkg-7.0.0.2" = _PReDrnW0;
        "pkg-6.0.0.2" = _nrLrxxDj;
        "pkg-7.0.0.3" = _HZhjRtKH;
        "pkg-8.0.0.1" = _ysnDXjGt;
        "pkg-8.0.0.2" = _iZsXzfY9;
        "default" = _iZsXzfY9;
    });
