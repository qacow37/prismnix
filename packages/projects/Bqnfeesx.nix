...
let
    ...
    in {
        ...
        "pkg-0.1.0-1.20.2" = _fjMMFPYN;
        "pkg-0.1.0-1.20.1" = _UKVbOc12;
        "pkg-0.2.0-1.21" = _x1BzCyQy;
        "pkg-0.2.0-1.20.1" = _2rgBBIi9;
        "pkg-0.2.0-1.20.6" = _nHww0ArZ;
        "pkg-0.3.0-1.21" = _RyPgdfT4;
        "pkg-0.3.0-1.20.4" = _9Tu3vwt6;
        "pkg-0.3.0-1.20.1" = _pKbG1fqE;
        "pkg-0.3.1+1.20.1" = _4prfPYpV;
        "pkg-0.3.1-1.20.4" = _3Rb202lj;
        "pkg-0.3.1+1.21" = _fGD61cM4;
        "pkg-0.4.0+1.21" = _qcoG3rwW;
        "pkg-0.4.0+1.20.1" = _tnvJwf3X;
        "pkg-0.5.0+1.21" = _qvFNEsPr;
        "pkg-0.5.0+1.20.1" = _vJAgiRr5;
        "pkg-0.5.1+1.21" = _MI0ZGlsf;
        "pkg-0.5.1+1.20.1" = _3kNb9I08;
        "pkg-0.5.1+1.20.4" = _5zYnIrqJ;
        "pkg-0.5.1+1.21.4" = _EPoIZO75;
        "pkg-1.0.0+1.20.1" = _DEzlGrHV;
        "pkg-1.0.0+1.21" = _jl1RVKzd;
        "pkg-1.0.0+1.21.4" = _FlPuUYbn;
        "pkg-1.0.1+1.20.1" = _n25RBxVy;
        "pkg-1.0.1+1.21" = _7RR6cDQ4;
        "pkg-1.0.1+1.21.4" = _Qw57kaG2;
        "pkg-1.0.2+1.21.4" = _UvrOmYCC;
        "pkg-1.0.2+1.21" = _LGDsI9aT;
        "pkg-1.0.2+1.20.1" = _dKDjK7we;
        "pkg-1.0.3+1.21.4" = _iJxLUW6F;
        "pkg-1.0.3+1.21" = _6E0pUCfX;
        "pkg-1.0.3+1.20.1" = _WtoEOQpS;
        "pkg-1.0.4+1.21.6" = _pTVjmsXr;
        "pkg-1.0.4+1.21.8" = _xBVufbTK;
        "pkg-1.1.0+1.20.1" = _bjP81T4x;
        "pkg-1.1.0+1.21" = _BcLT8B77;
        "pkg-1.1.0+1.21.8" = _ZhnGxSoH;
        "pkg-1.2.1+1.21.9" = _YxmgaKja;
        "pkg-1.2.1+1.21.1" = _un14V49F;
        "pkg-1.2.2+1.20.1" = _60GcmBLR;
        "pkg-1.2.2+1.21.1" = _35e0Vnus;
        "pkg-1.2.2+1.21.9" = _yKESCqee;
        "pkg-1.2.2+1.21.11" = _QXXXw01C;
        "pkg-1.3.0+1.20.1-forge" = _z4GVPmVF;
        "pkg-1.3.0+1.21.1-neoforge" = _n9oYTze1;
        "pkg-1.3.1+1.21.1-neoforge" = _zaq2odZP;
        "pkg-1.3.1+1.20.1-forge" = _mjhtuxjK;
        "pkg-1.3.3+1.19.2-forge" = _pR6GbI5R;
        "pkg-1.3.3+1.20.1-forge" = _jLWO7OV9;
        "pkg-1.3.4+1.21.1-neoforge" = _1jNzI9x8;
        "pkg-1.3.5+1.19.2-fabric" = _NRJzn9dr;
        "pkg-1.3.5+1.19.2-forge" = _LoT2mtCj;
        "pkg-1.3.5+1.20.1-fabric" = _gPWhlfJm;
        "pkg-1.3.5+1.20.1-forge" = _eiVZSmbC;
        "pkg-1.3.5+1.21.1-fabric" = _CdeSdetl;
        "pkg-1.3.5+1.21.1-neoforge" = _bqvWqBAp;
        "pkg-1.3.5+1.21.11-fabric" = _S0kTKvXH;
        "default" = _S0kTKvXH;
    });
