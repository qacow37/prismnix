...
let
    ...
    in {
        ...
        "pkg-1.0.0.12" = _YMQViTRv;
        "pkg-2.2.2.124" = _jbXQSFox;
        "pkg-2.3.1.125" = _Axdaum6F;
        "pkg-2.1.11.127" = _7cHs87DT;
        "pkg-2.2.3.128" = _iUpUDSi4;
        "pkg-2.3.2.129" = _BNgAqpSc;
        "pkg-2.1.12.130" = _XTbA4SQt;
        "pkg-2.2.4.131" = _14BCLjZt;
        "pkg-2.3.3.132" = _rw4x3aGd;
        "pkg-2.1.13.133" = _ewSvrxlZ;
        "pkg-2.3.4.134" = _upQnhsff;
        "pkg-2.2.5.135" = _ElISAf2J;
        "pkg-2.1.14.137" = _wsZg86JW;
        "pkg-2.3.6.139" = _2fj1lfEU;
        "pkg-2.3.7.140" = _TVnFRmmQ;
        "pkg-2.4.0.152" = _6DMmxrbt;
        "pkg-2.4.2.157" = _EiUlCNCa;
        "pkg-2.4.3.168" = _hIpC0bCK;
        "pkg-2.4.4.173" = _57AZIo1b;
        "pkg-2.4.5.176" = _SB52pMVS;
        "pkg-2.4.7.189" = _KOgvq6ku;
        "pkg-2.4.8.194" = _rTQ08llY;
        "pkg-2.4.9.195" = _U3ucuRWA;
        "pkg-2.4.10.198" = _Tfc2xQeY;
        "pkg-2.4.12.205" = _1GMaj2ah;
        "pkg-2.4.16.207" = _eZwhuiTc;
        "pkg-2.4.17.208" = _2V4MAaDk;
        "pkg-2.4.18.210" = _xVXMpIdX;
        "pkg-2.4.19.214" = _CSp0ye66;
        "pkg-2.4.20.162" = _l0FhLr6i;
        "pkg-3.0.7.230" = _RPwJsGcB;
        "pkg-3.0.8.232" = _BINLbBk5;
        "pkg-3.0.9.235" = _WOA2cyoX;
        "pkg-3.0.10.237" = _hhWaf9JT;
        "pkg-3.0.11.238" = _oIaSMyzO;
        "pkg-3.0.12.240" = _N9q2m8BQ;
        "pkg-3.0.13.244" = _awmX1mJx;
        "pkg-3.0.14.247" = _CrfTsYQt;
        "pkg-3.0.15.248" = _7Zn24Ipu;
        "pkg-3.1.4.268" = _7BpOhcDi;
        "pkg-3.1.5.272" = _nKw72VtZ;
        "pkg-3.1.7.276" = _9T14zIXU;
        "pkg-3.1.8.277" = _Ph3rfqmm;
        "pkg-3.1.9.279" = _KCZ0ZSeU;
        "pkg-3.1.9.280" = _qJgZweXE;
        "pkg-3.1.10.283" = _J3VRHShR;
        "pkg-3.2.1.302" = _qFTHdrDH;
        "pkg-3.2.1.305" = _GrwjjTlK;
        "pkg-3.2.1.307" = _fiRrbwua;
        "pkg-3.2.2.308" = _NQHgTU4K;
        "pkg-3.2.1.309" = _56nwe5IX;
        "default" = _56nwe5IX;
    });
