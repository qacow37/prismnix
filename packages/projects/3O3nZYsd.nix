...
let
    ...
    in {
        ...
        "pkg-1.0+1.21.6" = _92Cj46iC;
        "pkg-1.0+1.21" = _oa6eczzR;
        "pkg-1.0.1+1.21.6" = _T6GXyCoX;
        "pkg-1.1+1.21" = _9t44guVO;
        "pkg-1.1+1.21.6" = _WjSQEfYw;
        "pkg-1.1.1" = _o1yOqDFb;
        "pkg-1.1.1+1.21" = _QX7vqLGk;
        "pkg-1.2+1.21" = _5X39KlMn;
        "pkg-1.2+1.21.6" = _2WBunGRj;
        "pkg-1.2.1+1.21.6" = _lSl19Rs9;
        "pkg-1.2.1+1.21" = _UZMHr3AR;
        "pkg-1.2.2+1.21" = _s6XtV14H;
        "pkg-1.2.2+121.6" = _Tgw3qieH;
        "pkg-1.3+1.21" = _Qn474Dl0;
        "pkg-1.3+1.21.6" = _SNpKYLFo;
        "pkg-1.3+1.21.9" = _69dXUqXM;
        "pkg-1.3.1+1.21" = _FFBMUfV8;
        "pkg-1.3.1+1.21.6" = _wXW2wvpq;
        "pkg-1.3.1+1.21.9" = _KdApeJK5;
        "pkg-1.3.2+1.21.9" = _kR1VBs61;
        "pkg-1.3.2+1.21" = _nHIp7Bfr;
        "pkg-1.3.2+1.21.6" = _br2QvIYf;
        "pkg-1.3.3+1.21.6" = _Eh2Yo9Tv;
        "pkg-1.3.3+1.21" = _STe3IwBi;
        "pkg-1.3.3+1.21.9" = _hYUNANiy;
        "pkg-1.4+1.21.9" = _faWt6MH6;
        "pkg-1.4+1.21" = _E4Kdoi8V;
        "pkg-1.4+1.21.6" = _cr9fHmFr;
        "pkg-1.4.1+1.21.9" = _U9EzElfz;
        "pkg-1.4.2+1.21" = _4IEm9bJP;
        "pkg-1.4.2+1.21.9" = _z0oBR666;
        "pkg-1.4.2+1.21.6" = _OlliMruL;
        "pkg-1.4.3+1.21.6" = _FeAbwoxB;
        "pkg-1.4.3+1.21" = _QcJ4aY0k;
        "pkg-1.4.3+1.21.9" = _xkrUgoG7;
        "pkg-1.5+1.21.6" = _qEUT5Az9;
        "pkg-1.5+1.21" = _s94DCYPZ;
        "pkg-1.5+1.21.9" = _7anxDHNv;
        "pkg-1.5.1+1.21.6" = _AcOa53nG;
        "pkg-1.5.1+1.21" = _taYXGP3G;
        "pkg-1.5.1+1.21.9" = _fd4UUwKV;
        "pkg-1.5.2-1.21+neoforge" = _SXr2fZ4w;
        "pkg-1.5.2-1.21.2+neoforge" = _4n5Qyv02;
        "pkg-1.5.2-1.21.5+neoforge" = _opes8nyX;
        "pkg-1.5.2-1.21.6+neoforge" = _hwRnmHae;
        "pkg-1.5.2-1.21.9+neoforge" = _NbmkPmYT;
        "pkg-1.5.2+1.21" = _2o76bNdK;
        "pkg-1.5.1+1.21.11" = _Kv0kbMYa;
        "pkg-1.5.3+1.21.9" = _U3T0J5Q0;
        "pkg-1.5.3+1.21.11" = _vaFlO7Cs;
        "pkg-1.5.4" = _x2O7Rkp4;
        "pkg-1.5.5+1.21.9" = _5BPxvgIB;
        "pkg-1.5.5+1.21.11" = _XYXslt4w;
        "pkg-1.5.6" = _pIgsaljg;
        "pkg-1.5.6+26.1-pre-1" = _2eD7ck6u;
        "default" = _2eD7ck6u;
    });
