...
let
    ...
    in {
        ...
        "pkg-1.5.1" = _4J5gJFoj;
        "pkg-1.6.0-beta.1" = _OeuBhOcQ;
        "pkg-1.6.0-beta.2" = _yWL2xVfl;
        "pkg-1.6.0-beta.3" = _wqtDzFwv;
        "pkg-1.6.0-beta.4" = _a3KOCwN5;
        "pkg-1.6.0-pre-release.1" = _N4fKuJtH;
        "pkg-1.6.0" = _vGSdP3AE;
        "pkg-1.6.1" = _zTJmStb9;
        "pkg-1.6.2-beta.1" = _ho77n9cE;
        "pkg-1.6.2-pre.1" = _3jrOHYa2;
        "pkg-1.6.2-pre.2" = _5fPSjm4W;
        "pkg-1.6.2" = _qb1ptzzN;
        "pkg-1.7.0-b1" = _tael6zRo;
        "pkg-1.7.0-b2.build.5" = _b7uy7p21;
        "pkg-1.7.0" = _1RaWMZzk;
        "pkg-1.7.1-b1" = _ls7XbTrS;
        "pkg-1.7.1-b3" = _XyMWNkzR;
        "pkg-1.7.1-pre.1" = _TOWBvcbd;
        "pkg-1.7.1-pre.2" = _oJp10sjv;
        "pkg-1.7.1" = _RSIKp3AR;
        "pkg-1.7.2-pre.1" = _n5kbacV3;
        "pkg-1.7.2-pre.2" = _mJKn6pej;
        "pkg-1.7.2" = _8mJIQSEO;
        "pkg-1.7.3-beta.1" = _qruZjqRH;
        "pkg-1.7.3-beta.2" = _EscOQo41;
        "pkg-1.7.3-pre.1" = _TPMfeJsJ;
        "pkg-1.7.3" = _WXhVHMoE;
        "pkg-2.0.0-alpha.1" = _GyWxiiZf;
        "pkg-2.0.0-alpha.2" = _U6v2fgYD;
        "pkg-2.0.0-beta.1" = _BFMqpBlV;
        "pkg-2.0.0" = _U2SfE18u;
        "pkg-2.0.1" = _MzTbQYQV;
        "pkg-2.1.0-alpha.1" = _Wr2PR1Xq;
        "pkg-2.1.0-alpha.2" = _cXlKbh7C;
        "pkg-2.1.0-alpha.3" = _ljv7a17c;
        "pkg-2.1.0-alpha.4" = _Nfl3wAVp;
        "pkg-2.1.0-beta.1" = _Pwp68m0a;
        "pkg-2.1.0-beta.2" = _xanHLNb3;
        "pkg-2.1.0-beta.3" = _4ob9Lbe3;
        "pkg-2.1.0-beta.4" = _aqmD9nSi;
        "pkg-2.1.0-beta.5" = _bRQvXMKX;
        "pkg-2.1.0" = _jiEanzFl;
        "pkg-2.1.1" = _Fjglo8zV;
        "pkg-2.1.2" = _WE0cRkJR;
        "pkg-2.1.2-hotfix" = _c0TfW7xV;
        "pkg-2.2.0-alpha.1" = _AiOFmbdJ;
        "pkg-2.2.0-alpha.1.1" = _meQvqfQ7;
        "pkg-2.2.0-alpha.2" = _AXW6uWCK;
        "pkg-2.2.0-alpha.3" = _U1Y8QUEN;
        "pkg-2.2.0-alpha.4" = _nJYb1A1B;
        "pkg-2.2.0-alpha.5" = _WGGA7LcR;
        "pkg-2.2.0-alpha.6" = _9u1MjQoX;
        "pkg-2.2.0-alpha.6.1" = _qduiF7et;
        "pkg-2.2.0-alpha.7" = _5SpWXc0m;
        "pkg-2.2.0-alpha.8" = _C7ArEtnZ;
        "pkg-2.2.0-alpha.8.1" = _Og5HmiE5;
        "pkg-2.2.0-alpha.9" = _HMHoOkrO;
        "pkg-2.2.0-alpha.10" = _Uh38gfyx;
        "pkg-2.2.0-alpha.11" = _arnnna8c;
        "pkg-2.2.0-alpha.12" = _wECF72Cs;
        "pkg-2.2.0-alpha.13" = _A5obbLHm;
        "default" = _A5obbLHm;
    });
