...
let
    ...
    in {
        ...
        "pkg-1.8.8" = _Z5KgqOzX;
        "pkg-1.8.9" = _l9Y8zr85;
        "pkg-1.7.10" = _8oUcWZTh;
        "pkg-1.8.10" = _ttE0gy2o;
        "pkg-1.8.11" = _Meda3iv2;
        "pkg-1.9.0" = _qpTQemjY;
        "pkg-1.9.1" = _gW2Uf546;
        "pkg-1.7.11" = _ELqdzknl;
        "pkg-1.7.12" = _fTyqtVpU;
        "pkg-1.7.13" = _2o2df0p6;
        "pkg-1.9.2" = _q0Ah0dIQ;
        "pkg-1.9.3" = _mjG0CpZi;
        "pkg-1.7.14" = _300f6HjL;
        "pkg-1.9.4" = _fYhLwTQs;
        "pkg-1.9.5" = _sgmPzE6v;
        "pkg-1.9.6" = _Gmh74yh1;
        "pkg-1.7.15" = _O4Fow0Po;
        "pkg-1.9.7" = _tGh5HbBD;
        "pkg-1.9.8" = _JeNgQuxf;
        "pkg-1.9.9" = _ismZzlup;
        "pkg-1.7.16" = _fiezBPPG;
        "pkg-1.9.10" = _QKCjtHWC;
        "pkg-1.9.11" = _oqPcl2Kd;
        "pkg-1.9.12" = _pOUr74FO;
        "pkg-1.9.13" = _nUDv4ZTR;
        "pkg-1.9.14" = _grvKwso1;
        "pkg-1.9.15" = _qmV8Hobk;
