...
let
    ...
    in {
        ...
        "pkg-1.9.4-0.0.8.0" = _QKkH0VZ5;
        "pkg-1.10.2-0.1.2.2" = _b0lVl5cf;
        "pkg-1.11.2-0.1.2.2" = _wWQH0uER;
        "pkg-1.12.2-0.1.2.9" = _BM8zU1AX;
        "pkg-1.16.5-2.1.26" = _1zRXshBz;
        "pkg-1.17.1-2.1.23" = _Ah1cXjVQ;
        "pkg-1.18.2-2.1.26" = _QWp054zm;
        "pkg-1.19-2.1.26" = _EiYMmj9u;
        "pkg-1.16.5-2.1.28" = _osWOCaP1;
        "pkg-1.16.5-2.1.29" = _nrffMspP;
        "pkg-1.16.5-2.1.30" = _Z8CxqXFW;
        "pkg-1.18.2-2.1.30" = _UATpIp1C;
        "pkg-1.19.2-2.1.30" = _mkPH6yvM;
        "pkg-1.18.2-2.1.31" = _JcTKQ35V;
        "pkg-1.19.2-2.1.32" = _RJmTtMKz;
        "pkg-1.16.5-2.1.35" = _joJWgzAO;
        "pkg-1.18.2-2.1.35" = _Zovt3Qfl;
        "pkg-1.19.2-2.1.35" = _nij6rcSF;
        "pkg-1.20-2.1.36" = _gDxs7QGz;
        "pkg-1.20.1-2.1.37" = _rtI5h0ZU;
        "pkg-1.20.1-2.1.38" = _oR7TENgQ;
        "pkg-1.16.5-2.1.39" = _e9Ayyags;
        "pkg-1.18.2-2.1.39" = _kLwY6kGT;
        "pkg-1.19.2-2.1.39" = _isnbiYQF;
        "pkg-1.20.1-2.1.39" = _kR2IVnv0;
        "pkg-1.20.1-2.1.44" = _eX4XRvgi;
        "pkg-1.21-2.4.0" = _UMPMbD5w;
        "pkg-1.20.1-2.1.45" = _OIzaNrPI;
        "pkg-1.21-2.4.1" = _nY6guxBr;
        "pkg-1.21.1-2.4.9" = _6AlNHOWo;
        "default" = _6AlNHOWo;
    });
