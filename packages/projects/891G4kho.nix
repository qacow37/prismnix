...
let
    ...
    in {
        ...
        "pkg-A1-pre_1" = _CvjANlqu;
        "pkg-A1-pre_2" = _niURmV4E;
        "pkg-A1-pre_3" = _Z8vAQTph;
        "pkg-A1-pre_4" = _rIjt6yYK;
        "pkg-A1-pre_5" = _sD2eDxNL;
        "pkg-A1" = _IhO593Bc;
        "pkg-A2-pre_1" = _33ZlHe9v;
        "pkg-A2-pre_2" = _CSC4ZLrB;
        "default" = _CSC4ZLrB;
    });
