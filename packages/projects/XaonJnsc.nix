...
let
    ...
    in {
        ...
        "pkg-1.1.3" = _nAJXZhhC;
        "pkg-1.1.4" = _6oDD4fRu;
        "pkg-v1.1.5" = _FI89Guzj;
        "pkg-v1.1.6" = _ar3KQHXW;
        "pkg-v1.1.7" = _Zm3xDcRG;
        "pkg-v1.1.8" = _NALFoQV6;
        "pkg-v1.1.9" = _1k3bFhYn;
        "pkg-v1.2.0" = _z50STVMz;
        "pkg-v1.2.1" = _IX4skuaG;
        "pkg-v1.2.2" = _rWV62QxS;
        "pkg-v1.2.3" = _TRNw5dLv;
        "pkg-v1.3.0" = _rGGxadlh;
        "pkg-v1.3.1" = _QBREvmrU;
        "pkg-v1.4.0" = _rH8yODrW;
        "pkg-v1.4.1" = _k5lStZDH;
        "pkg-v1.4.2" = _BPg1LBVK;
        "pkg-v1.4.3" = _MCCBXuav;
        "pkg-v1.4.4" = _qDaPIBRQ;
        "default" = _qDaPIBRQ;
    });
