...
let
    ...
    in {
        ...
        "pkg-0.0.1alpha" = _5CaY425Z;
        "pkg-0.0.2alpha" = _j0jZB84O;
        "pkg-0.1.0beta" = _86i62fPO;
        "pkg-0.1.1beta" = _9WO17myp;
        "pkg-0.1.2beta" = _ETd1kYWn;
        "pkg-0.2.0beta" = _GMSRUWPd;
        "pkg-0.3.0beta" = _9oTz6pQz;
        "pkg-1.0.0" = _BkIv0Oqv;
        "pkg-1.0.1" = _WTxB1emb;
        "pkg-1.1.0" = _P2MLg18b;
        "pkg-1.1.2" = _6Bq1WKko;
        ...
        "pkg-1.3.1" = _ECSswO3i;
        "pkg-1.3.2" = _rVGJSrFG;
        "pkg-1.12-1.3.2beta" = _Q1FB1wMy;
        "pkg-1.12-1.3.3" = _EeILOtg5;
        "pkg-1.12-1.3.4" = _h4iYE0TZ;
        "pkg-1.12-1.3.4beta2" = _OdBd1xFi;
        "pkg-1.12-1.3.4.2" = _fJnXewwk;
        "pkg-1.12-1.3.4.3" = _NMCarc1p;
        "pkg-1.12-1.3.5" = _3iRsZu90;
        "pkg-1.4.0" = _ttN0DQO2;
        "pkg-1.12-1.4.0" = _vdexSLRC;
        "pkg-1.4.1" = _z3elSm4i;
        "pkg-1.12-1.4.1" = _FneZ8i6s;
        "pkg-1.5.0" = _IEaCfUXj;
        "pkg-1.12-1.5.0" = _hF9YgIQe;
        "pkg-1.12-1.6.0" = _gwRh2JjP;
        "pkg-1.12-1.6.1" = _WAMR9cSf;
        "pkg-1.12-1.6.2" = _tWq8NOpp;
        "pkg-1.12-1.6.3" = _WIoppcn6;
        "pkg-1.12-1.6.4" = _bZqyo7MR;
        "pkg-1.12-1.6.5" = _AvooZxkh;
        "pkg-1.12-1.6.6" = _PjLJSVrM;
        "pkg-1.12-1.6.7" = _Ihb7TfD6;
        "pkg-1.12-1.6.8" = _PBY4I37D;
        "pkg-1.12-1.6.9" = _n2PnTXRx;
        "pkg-1.12-1.7.0-alpha" = _I17OxZXQ;
        "pkg-1.12-1.7.0" = _hcp8riKy;
        "pkg-1.12-1.7.1" = _z7gO4rl2;
        "pkg-1.12-1.7.2" = _X8T2eUsO;
        "pkg-1.12-1.7.3" = _V4u4puha;
        "pkg-1.12-1.7.4" = _718Y9AER;
        "pkg-1.12-1.7.5" = _nYcOiMtO;
        "pkg-1.12-1.7.6" = _2cQxbafl;
        "pkg-1.12-1.8.0" = _UgYqnPC4;
        "pkg-1.12-1.8.1" = _sHSsvZMs;
        "pkg-1.12-1.8.2" = _bcioOzsw;
        "pkg-1.14-1.8.3-alpha" = _pxWZywNd;
        "pkg-1.14-1.8.4-alpha" = _K0YmUmyq;
        "pkg-1.14-1.8.5-alpha" = _aA2fTkrQ;
        "pkg-1.14-1.8.6-alpha" = _3PopLroA;
        "pkg-1.14-1.8.7-alpha" = _J4gt4DrQ;
        "pkg-1.15-2.0.0-alpha" = _RXJ56dit;
        "pkg-1.15-2.0.1-alpha" = _phXs0ZMy;
        "pkg-1.15-2.0.2-alpha" = _ggZz6q4s;
        "pkg-1.15-2.1.1-beta" = _QvSo4P0J;
        "pkg-1.15-2.1.2-beta" = _r8gOLdK0;
        "pkg-1.15-2.1.3-beta" = _kg58gcHq;
        "pkg-1.15-2.1.4-beta" = _HduWDVjE;
        "pkg-1.15-2.1.5-beta" = _PkCm4YHf;
        "pkg-1.15-2.1.6-beta" = _fB9qQZnX;
        "pkg-1.15-2.1.7-beta" = _VYHqa3wJ;
        "pkg-1.16-3.0.0-beta" = _pWp5qGTM;
        "pkg-1.15-2.1.8" = _2SewuYXb;
        "pkg-1.16-3.0.1-beta" = _zb69UYbh;
        "pkg-1.15-2.1.9" = _mMr2SmGf;
        "pkg-1.16-3.0.2-beta" = _gzm5NzES;
        "pkg-1.16-3.0.3-beta" = _1NTzPIqS;
        "pkg-1.15-2.1.10" = _HDdRjEUY;
        "pkg-1.16-3.0.4-beta" = _XjyFstQ4;
        "pkg-1.16-3.0.5-beta" = _eeA5X30M;
        "pkg-1.16-3.0.6-beta" = _LI8Fn5lp;
        "pkg-1.15-2.1.11" = _Fugwo09Z;
        "pkg-1.16-3.0.7" = _KgvOVpOc;
        "pkg-1.15-2.1.12" = _m9LPVyX4;
        "pkg-1.16-3.0.8" = _7888iNbH;
        "pkg-1.15-2.1.13" = _T6o2TJrB;
        "pkg-1.16-3.0.9" = _c8FwOieY;
        "pkg-1.15-2.1.14" = _a33vGOlf;
        "pkg-1.16-3.0.10" = _md2uLsgh;
        "pkg-1.16-3.0.11" = _Hnjw1zlX;
        "pkg-1.16-3.0.12" = _WfDxFqpo;
        "pkg-1.16-3.0.13" = _Fdd4IJAc;
        "pkg-1.16-3.0.14" = _hX445EFc;
        "pkg-1.16-3.0.15" = _AULaOGkT;
        "pkg-1.18-4.0.0" = _YDkyOLDN;
        "pkg-1.18-4.0.1" = _xpQze5O6;
        "pkg-1.18-4.0.2" = _Jh57zZxO;
        "pkg-1.16-3.0.16" = _rIsd9tRJ;
        "pkg-1.18-4.0.3" = _2DWWErtP;
        "pkg-1.18-4.0.4" = _JwBRGqFM;
        "pkg-1.18-4.0.5" = _JmlN0LRi;
        "pkg-1.16-3.0.17" = _uIt0prUP;
        "pkg-1.19-5.0.0" = _TVYyV0FT;
        "pkg-1.19-5.0.1" = _vCWdnB9M;
        "pkg-1.18-4.0.6" = _xUynP5Np;
        "pkg-1.19-5.0.2" = _eqYmYL5j;
        "pkg-1.18-4.0.7" = _HAnS3qi4;
        "pkg-1.19-5.1.0" = _CoG2P77D;
        "pkg-1.19-5.1.1" = _uVfN5cE9;
        "pkg-1.18-4.0.8" = _2m7bU4ih;
        "pkg-1.19-5.1.2" = _xJHF2YOa;
        "pkg-1.18-4.0.9" = _bApMfE9G;
        "pkg-1.19-5.1.3" = _pvSS5MU5;
        "pkg-1.19-5.1.4" = _cNZJt2bs;
        "pkg-1.20-6.0.0" = _UDp2PN0O;
        "pkg-1.20-6.0.1" = _6nP71Bx8;
        "pkg-1.20-6.0.2" = _v7egKLKS;
        "pkg-1.19-5.2.0" = _NRMqSJF4;
        "pkg-1.20-6.1.0" = _p6HbrE1U;
        "pkg-1.19-5.2.1" = _yTnZFfmf;
        "pkg-1.20-6.1.1" = _ZyX7mRzU;
        "pkg-1.20-6.1.2" = _2EcXtgPP;
        "pkg-1.19-5.2.2" = _IGNnLoAu;
        "pkg-1.19-5.2.3" = _qno9WgsF;
        "pkg-1.20-6.1.3" = _gE0fwkm2;
        "pkg-1.19-5.2.4" = _J5gsVVJF;
        "pkg-1.20-6.1.4" = _UbcA1x5T;
        "pkg-1.19-5.2.5" = _I2jhQ3hT;
        "pkg-1.20-6.1.5" = _6R7dh0ec;
        "pkg-1.19-5.2.6" = _XxEKOkkn;
        "pkg-1.20-6.1.6" = _sZvo35G8;
        "pkg-1.21-7.0.0" = _stoUwfYZ;
        "pkg-1.21-7.0.1" = _Xis5v6zv;
        "pkg-1.21-7.0.2" = _cEvtMzxS;
        "pkg-1.21-7.0.3" = _1tes2rxY;
        "pkg-1.21-7.0.4" = _YMJuvzxp;
        "pkg-1.21-7.0.5" = _1r8JEKez;
        "pkg-1.21-7.0.6" = _3EMozZSo;
        "pkg-1.20-6.1.7" = _KM14kJoF;
        "pkg-1.21-7.0.7" = _lvCo0M5N;
        "default" = _lvCo0M5N;
    });
