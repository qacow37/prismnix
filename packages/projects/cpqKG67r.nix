...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _Aojd1r2O;
        "pkg-1.0.2" = _py6NwHrq;
        "pkg-1.1.0+fabric-1.20.1" = _N6E7mvlM;
        "pkg-1.1.1+fabric-1.20.1" = _o5N3FE4f;
        "pkg-1.1.1+forge-1.20.1" = _aYARoqT1;
        "pkg-1.1.4+fabric" = _QhLRoiXT;
        "pkg-1.1.4+forge" = _OOzG9M4c;
        "pkg-1.1.4+forge-1.19.2" = _CQvMaBa8;
        "pkg-1.1.4+fabric-1.19.2" = _FbjhnQ8Z;
        "pkg-1.1.5+fabric-1.19.2" = _PVzDrYBV;
        "pkg-1.1.5+forge-1.19.2" = _Dic6Dww1;
        "pkg-1.1.5+forge-1.20.1" = _bi3Uc9aN;
        "pkg-1.1.5+fabric-1.20.1" = _BDFMTrG6;
        "pkg-1.1.6+forge-1.20.1" = _I3xupLrF;
        "pkg-1.1.6+fabric-1.20.1" = _xEJxu87c;
        "pkg-1.1.7+forge-1.20.1" = _yQLo5wA8;
        "pkg-1.1.7+fabric-1.20.1" = _tjtyRmzS;
        "pkg-1.1.8+fabric-1.20.1" = _wehqa0OB;
        "pkg-1.1.8+forge-1.20.1" = _7ZEUHabk;
        "pkg-1.1.8+pattern_schematics-1.19.2" = _WwnShh70;
        "pkg-1.1.9+pattern_schematics-1.20.1" = _lfLL70L8;
        "pkg-1.1.10+pattern_schematics-1.20.1" = _MMQJPZNu;
        "pkg-1.1.11+pattern_schematics-1.20.1" = _c7AzXZls;
        "pkg-1.1.11+forge-1.20.1" = _IpQQntZI;
        "pkg-1.1.12+pattern_schematics-1.20.1" = _fGPaF4DT;
        "pkg-1.1.13+pattern_schematics-1.20.1" = _ZBrB0Adx;
        "pkg-1.1.13+pattern_schematics-1.19.2" = _ixe538Q9;
        "pkg-1.1.14+pattern_schematics-1.20.1" = _qbKX5wx6;
        "pkg-1.1.15+pattern_schematics-1.20.1" = _mHecdqqF;
        "pkg-1.1.15+pattern_schematics-1.19.2" = _8eNRNmfQ;
        "pkg-1.1.16+pattern_schematics-1.20.1" = _jkCFDNYt;
        "pkg-1.1.17+pattern_schematics-1.20.1" = _aeHqaBBu;
        "pkg-1.1.18+pattern_schematics-1.20.1" = _eKbsuuF3;
        "pkg-1.1.19+pattern_schematics-1.20.1" = _wRL4QNz9;
        "pkg-1.2.0+pattern_schematics-1.20.1" = _B9FS0uow;
        "pkg-2.0.0" = _GO9ru9sU;
        "pkg-2.0.1" = _RBylEIUO;
        "pkg-2.0.2" = _yTVtXAcw;
        "pkg-1.2.1+pattern_schematics-1.20.1" = _X6265CLR;
        "pkg-2.0.3" = _kBI5nfkU;
        "pkg-1.2.2+pattern_schematics-1.20.1" = _BGqqlSh7;
        "pkg-2.0.4" = _KHhKnl9x;
        "pkg-1.2.3+pattern_schematics-1.20.1" = _bLe1pVfd;
        "pkg-2.0.5" = _jryAyYnH;
        "pkg-2.0.6" = _Glvys45y;
        "pkg-2.0.7" = _iDLHGNQj;
        "pkg-2.0.8" = _TtiifZ27;
        "pkg-2.0.9" = _8uY8HiNA;
        "pkg-2.0.10" = _VSJhIkG2;
        "pkg-1.3.3" = _Rfwgb1aK;
        "pkg-1.2.0" = _zTg3iBRd;
        "pkg-1.2.1+fabric1.20.1" = _erWAeks3;
        "default" = _erWAeks3;
    });
