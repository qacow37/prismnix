...
let
    ...
    in {
        ...
        "pkg-1.21.1-1.1.0.3" = _AUtDcDgm;
        "pkg-1.21.10-1.1.0.3" = _6E8eMk5E;
        "pkg-1.21.11-1.1.0.2" = _jF52EFAX;
        "pkg-1.21.1-1.1.0.4" = _z5iAxhdM;
        "pkg-1.21.1-1.1.0.5" = _zZEfvA8c;
        "pkg-1.21.10-1.1.0.5" = _LpuksuHm;
        "pkg-1.21.11-1.1.0.5" = _YO6SGzRd;
        "pkg-26.1.1-1.1.0.5" = _Pfrp5w9J;
        "pkg-26.1.1-1.1.0.6" = _LwvqoAll;
        "pkg-26.1.1-1.1.0.7" = _JCmZzkg9;
        "pkg-26.1.2-1.1.0.7" = _PMMBbCyR;
        "pkg-26.1.2-1.1.0.9" = _Iwxj2bpE;
        "pkg-26.1.2-1.1.0.10" = _FUCGrXvg;
        "pkg-26.1.2-1.1.0.11" = _5JAVWK0G;
        "pkg-1.21.1-1.1.0.12" = _SiLEp5pk;
        "pkg-26.1.2-1.1.0.12" = _sNwG4FOT;
        "pkg-1.21.1-1.1.0.13" = _G4vHaoVl;
        "pkg-26.1.2-1.1.0.13" = _22Uj1ylr;
        "pkg-1.21.1-1.2.0.0" = _gp2345kF;
        "pkg-1.21.1-1.2.0.1" = _6hDDGea2;
        "pkg-26.1.2-1.2.0.1" = _Txh4nPEf;
        "pkg-26.1.2-1.2.0.2" = _tsiQPILB;
        "pkg-1.21.1-1.2.0.2" = _JvQGQ7Tx;
        "pkg-26.2-1.2.0.2" = _POgLksZZ;
