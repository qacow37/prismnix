...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.5" = _9IIPFRji;
        "pkg-1.1.0+1.21.5" = _tcI4Uvmy;
        "pkg-1.1.1+1.21.5" = _KNx4MuGM;
        "pkg-1.2.0+1.21.5" = _lBNQEFYm;
        "pkg-2.0.0+1.21.5" = _2j5TEYrd;
        "pkg-2.0.1+1.21.4" = _Nqa0AEQK;
        "pkg-2.0.1+1.21.5" = _1mwUJ8wZ;
        "pkg-2.1.0+1.21.4" = _tebSQe6l;
        "pkg-2.1.0+1.21.5" = _1jmjpRTG;
        "pkg-3.0.0+1.21.4" = _AjsfZ8II;
        "pkg-3.0.0+1.21.5" = _To4UxiKy;
        "pkg-4.0.0+1.21.4" = _M4jBITtN;
        "pkg-4.0.0+1.21.5" = _sbWhIGox;
        "pkg-4.1.0" = _Ue9yfoaI;
        "pkg-4.1.1+1.21.6(7)" = _wCat5VZV;
        "pkg-4.2.0+1.21.4" = _Vvp74QQn;
        "pkg-4.2.0+1.21.6(7)" = _X29ZJjxr;
        "pkg-4.2.0+1.21.5" = _MlWG2BnQ;
        "pkg-4.3.1+1.21.5" = _SMYdzj97;
        "pkg-4.3.1+1.21.4" = _gJvyyv4h;
        "pkg-4.3.1+1.21.(6+)" = _PaAHSXFD;
        "pkg-4.4.0+1.21.4" = _JmR3h1pI;
        "pkg-4.4.0+1.21.5" = _b5wfFApf;
        "pkg-4.4.0+1.21.(6+)" = _GyDPVCeZ;
        "pkg-4.5.0+1.21.5" = _ZfakRDgb;
        "pkg-4.5.0+1.21.(6+)" = _4VHkHLbu;
        "pkg-4.5.0+1.21.4" = _2SUQxQwI;
        "pkg-5.0.0+1.21.(6+)" = _NJEnnfc1;
        "pkg-5.0.0+1.21.5" = _s0YsbAbS;
        "pkg-5.0.0+1.21.4" = _IopqjnNX;
        "pkg-5.0.1+1.21.4" = _1MzFR01W;
        "pkg-5.0.1+1.21.(6+)" = _PBFWaNIk;
        "pkg-5.0.1+1.21.5" = _UoeRIQcj;
        "pkg-5.0.2+1.21.(6+)" = _OCObKqFN;
        "pkg-5.0.2+1.21.4" = _HBmouBkf;
        "pkg-5.0.2+1.21.5" = _e5shMa0x;
        "pkg-5.1.1+1.21.(2-4)" = _JWFX5BGV;
        "pkg-5.0.3+1.21.5" = _xd8eFKrB;
        "pkg-5.0.3+1.21.(6+)" = _w8jJX6eP;
        "pkg-5.1.1+1.21.1" = _RjsPdj6C;
        "pkg-5.1.0+1.21.(6+)" = _hhdtS53a;
        "pkg-5.1.0+1.21.5" = _zjaM6kpH;
        "pkg-5.2.0+1.21.5" = _O3pYp3SD;
        "pkg-5.2.0+1.21.(6+)" = _DZMiAfhK;
        "pkg-5.3.0+1.21.(6+)" = _v71Gjy9O;
        "pkg-5.3.0+1.21.5" = _FLcwfju4;
        "pkg-5.4.0+1.21.(6+)" = _nkILzWDS;
        "pkg-5.4.0+1.21.5" = _fi1pSryw;
        "pkg-5.4.0+1.21.(2-4)" = _26rvZY2l;
        "pkg-5.4.0+1.21.1" = _WETY6Ird;
        "pkg-5.4.1+1.21.1" = _Zwl1iyH6;
        "pkg-5.4.1+1.21.(2-4)" = _eRqpDQNm;
        "pkg-5.4.1+1.21.5" = _oRby1XxT;
        "pkg-5.4.1+1.21.(6+)" = _fZlEkk0N;
        "pkg-6.0.0+1.21.(6+)" = _bG9rlHz3;
        "pkg-6.0.0+1.21.(2-4)" = _qepLtgHl;
        "pkg-6.0.0+1.21.5" = _VhihIx1S;
        "pkg-6.0.0+1.21.1" = _JvRfhlDL;
        "pkg-6.0.1+1.21.1" = _9Tq4nznm;
        "pkg-6.0.1+1.21.(6+)" = _dWc8ssk3;
        "pkg-6.0.1+1.21.(2-4)" = _hZa5ATx4;
        "pkg-6.0.1+1.21.5" = _Xj2HcgCi;
        "pkg-6.0.2+1.21.5" = _V6Vd2Q2l;
        "pkg-6.0.2+1.21.(6+)" = _oKWTjGdP;
        "pkg-6.0.2+1.21.1" = _9Gx94XbU;
        "pkg-6.0.2+1.20.6" = _At84wBb3;
        "pkg-6.0.2+1.20.(2-4)" = _NpbGHZGy;
        "pkg-6.0.2+1.20.1" = _V5gNkdNh;
        "pkg-6.0.3+1.20.1" = _8F2qgK7z;
        "pkg-6.0.4+1.20.1" = _DuzTlquv;
        "pkg-6.0.3+1.20.(2-4)" = _IIEacOUH;
        "pkg-6.0.3+1.21.1" = _Kcn0tnkg;
        "pkg-6.0.3+1.20.(5-6)" = _rh3gKUTr;
        "pkg-6.0.3+1.21.(2-4)" = _Fj4GkXRQ;
        "pkg-6.0.3+1.21.5" = _yipr1alO;
        "pkg-6.0.3+1.21.(6+)" = _G947TgI9;
        "pkg-6.0.4+1.21.(6+)" = _GV49iXrK;
        "pkg-6.0.4+1.21.5" = _q2Eg7tO8;
        "pkg-6.0.4+1.21.(2-4)" = _ftiNCShR;
        "pkg-6.0.4+1.21.1" = _t1qpJWWQ;
        "pkg-6.0.5+1.21.(6+)" = _tZg2xRmQ;
        "pkg-6.0.5+1.20.1" = _fUYseTWt;
        "pkg-6.0.5+1.20.(2-4)" = _N2Snx2Pk;
        "pkg-6.0.5+1.20.(5-6)" = _msUjJrtF;
        "pkg-6.0.5+1.21.1" = _TUetBOEO;
        "pkg-6.0.5+1.21.(2-4)" = _bYF5smTy;
        "pkg-6.0.5+1.21.5" = _MkAITJJu;
        "pkg-6.1.0+1.21.(2-4)" = _Ui9k6FAR;
        "pkg-6.1.0+1.21.1" = _hGgHGp0K;
        "pkg-6.1.0+1.21.5" = _mNDCn4TI;
        "pkg-6.1.0+1.21.(6-8)" = _sIlaGbDU;
        "pkg-6.1.1+1.21.(6+)" = _r7k4hNgI;
        "pkg-6.1.0+1.21.(9+)" = _XQr5LL6X;
        "pkg-6.1.2+1.21.(6+)" = _t86MvovG;
        "pkg-6.1.1+1.21.(2-4)" = _F0RTDWvt;
        "pkg-6.1.2+1.21.(2-4)" = _ttl5yZdn;
        "pkg-6.1.1+1.21.1" = _aWkqLch8;
        "pkg-6.1.3+1.21.(6+)" = _ac5bscaq;
        "pkg-6.1.3+1.21.(2-4)" = _4Qptg3OU;
        "pkg-6.1.4+1.21.(6+)" = _7j9uXNO8;
        "pkg-6.1.2+1.21.1" = _cx3gb2lY;
        "pkg-6.1.1+1.21.5" = _HLt3sk5H;
        "pkg-7.0.0+1.21.(6+)" = _IrS0e7IC;
        "pkg-7.0.0+1.21.5" = _3Jz0wm9S;
        "pkg-7.0.0+1.21.(2-4)" = _1yNexRCP;
        "pkg-7.0.0+1.21.1" = _f068axRw;
        "pkg-7.0.1+1.21.1" = _FxzeoJOb;
        "pkg-7.0.1+1.21.(2-4)" = _cMmwCY0k;
        "pkg-7.0.1+1.21.5" = _As8eZuqq;
        "pkg-7.0.0+1.20.(5-6)" = _uXEgk6Qv;
        "pkg-7.0.0+1.20.(2-4)" = _g7m38dhR;
        "pkg-7.0.0+1.20.1" = _94bkO632;
        "pkg-7.0.1+1.20.(5-6)" = _at8EWCbc;
        "pkg-7.0.1+1.20.(2-4)" = _HgOD4XuH;
        "pkg-7.0.1+1.20.1" = _vcQBcW9W;
        "pkg-7.0.2+1.21.1" = _eD1OD5xN;
        "pkg-7.0.2+1.21.(2-4)" = _tGSczajG;
        "pkg-7.0.2+1.21.5" = _BG4MCc4X;
        "pkg-7.0.2+1.21.(6+)" = _N4BVMI53;
        "pkg-7.1.0+1.20.1" = _9hVCqJ0u;
        "pkg-7.1.0+1.20.(2-4)" = _mmwMHyGL;
        "pkg-7.1.0+1.20.(5-6)" = _4b8TQB2J;
        "pkg-7.1.0+1.21.1" = _OqYNaLDu;
        "pkg-7.1.0+1.21.(2-4)" = _XQcin4x2;
        "pkg-7.1.0+1.21.5" = _oGGgw9Hb;
        "pkg-7.1.0+1.21.(6+)" = _uVhfwhmx;
        "pkg-7.1.1+1.20.1" = _HCO0TXQV;
        "pkg-7.1.1+1.20.(2-4)" = _Va1V6U79;
        "pkg-7.1.1+1.20.(5-6)" = _4uftsiOX;
        "pkg-7.1.1+1.21.1" = _4uhcDXYb;
        "pkg-7.1.1+1.21.(6+)" = _jQ3RBdnz;
        "pkg-7.1.1+1.21.(2-4)" = _Xbyc9KXU;
        "pkg-7.1.1+1.21.5" = _lltI4Xdo;
        "pkg-7.1.2+1.20.(5-6)" = _poqQriWw;
        "pkg-7.1.2+1.21.1" = _3Cib5WFx;
        "pkg-7.1.2+1.21.(2-4)" = _Z1zNOrVv;
        "pkg-7.1.2+1.21.(6+)" = _gaogwNwj;
        "pkg-7.1.2+1.21.5" = _kMQj21Rw;
        "pkg-7.1.2+1.20.1" = _RqNIyxrA;
        "pkg-7.1.2+1.20.(2-4)" = _oeszdEmN;
        "pkg-7.1.3+1.20.(5-6)" = _tYmbAbYn;
        "pkg-7.1.3+1.21.1" = _toAl7luq;
        "pkg-7.1.3+1.20.1" = _3rJ9yX6S;
        "pkg-7.1.3+1.21.(2-4)" = _jRFMagAQ;
        "pkg-7.1.3+1.20.(2-4)" = _QKHQC6ba;
        "pkg-7.1.3+1.21.(5)" = _EsgeaAhH;
        "pkg-7.1.3+1.21.(6+)" = _EaGeVZWo;
        "pkg-7.1.4+1.20.(5-6)" = _PvmW2VaC;
        "pkg-7.1.4+1.20.(2-4)" = _9XhbYIUn;
        "pkg-7.1.4+1.21.1" = _wuGFoYd9;
        "pkg-7.1.4+1.20.1" = _QZqENOxE;
        "pkg-7.1.4+1.21.(6+)" = _DDtjNDPD;
        "pkg-7.1.4+1.21.(5)" = _4w1aPngg;
        "pkg-7.1.4+1.21.(2-4)" = _R1KE79TB;
        "pkg-7.1.5+1.20.(5-6)" = _YI0SVug4;
        "pkg-7.1.5+1.20.(2-4)" = _kqADOBT1;
        "pkg-7.1.5+1.21.1" = _QQthR7He;
        "pkg-7.1.5+1.20.1" = _QixOYO5p;
        "pkg-7.1.5+1.21.(5)" = _wleEi8Zl;
        "pkg-7.1.5+1.21.(2-4)" = _uzCEdwhF;
        "pkg-7.1.5+1.21.(6+)" = _6Y2zv8K6;
        "pkg-7.1.6+1.20.(2-4)" = _4zVRd7kl;
        "pkg-7.1.6+1.20.(5-6)" = _8VeEHSys;
        "pkg-7.1.6+1.21.1" = _tUU0lrRD;
        "pkg-7.1.6+1.21.(5)" = _saiJ9e7L;
        "pkg-7.1.6+1.21.(2-4)" = _Q9fcGmUF;
        "pkg-7.1.6+1.21.(6+)" = _xzDuq8dv;
        "pkg-7.2.0+1.21.1" = _7wqZlXRi;
        "pkg-7.2.0+1.20.(5-6)" = _aElCjy7F;
        "pkg-7.2.0+1.21.5" = _KaNpbArF;
        "pkg-7.2.0+1.21.(2-4)" = _ZzEDE6OW;
        "pkg-7.2.0+1.21.(6+)" = _VVspcr03;
        "pkg-7.2.0+1.20.1" = _KbzZig66;
        "pkg-7.2.0+1.20.(2-4)" = _XZTop52p;
        "pkg-7.2.1+1.20.1" = _ZshnQLGJ;
        "pkg-7.2.1+1.20.(5-6)" = _UDizebT9;
        "pkg-7.2.1+1.20.(2-4)" = _aNkgaV2Y;
        "pkg-7.2.1+1.21.1" = _SfgUp9tO;
        "pkg-7.2.1+1.21.(2-4)" = _53hhHPV5;
        "pkg-7.2.2+1.20.1" = _a9QWu04z;
        "pkg-7.2.2+1.21.(2-4)" = _fy6f4Y5y;
        "pkg-7.2.2+1.20.(5-6)" = _ATKXdBCv;
        "pkg-7.2.2+1.21.1" = _NBVhmDa4;
        "pkg-7.2.2+1.21.(6+)" = _J0DcPsay;
        "pkg-7.2.2+1.21.5" = _bAkUXB8q;
        "pkg-7.2.2+1.20.(2-4)" = _GeDOfSaH;
        "pkg-7.2.3+1.20.(2-4)" = _tNihyu8A;
        "pkg-7.2.3+1.20.1" = _PH2urkJ1;
        "pkg-7.2.3+1.20.(5-6)" = _UpftNKPb;
        "pkg-7.2.3+1.21.1" = _DqCws5CN;
        "pkg-7.2.3+1.21.5" = _8pEWcAI7;
        "pkg-7.2.3+1.21.(2-4)" = _pZbUWd5R;
        "pkg-7.2.3+1.21.(6+)" = _RkYJgC1w;
        "pkg-7.3.0+1.20.1" = _wLsk5YBz;
        "pkg-7.3.0+1.20.(2-4)" = _5wZ1cIe5;
        "pkg-7.3.0+1.21.1" = _epDzTGr2;
        "pkg-7.3.0+1.20.(5-6)" = _ncIUMPn3;
        "pkg-7.3.0+1.21.(2-4)" = _LskC4ZhL;
        "pkg-7.3.0+1.21.(6+)" = _BEkbHGKt;
        "pkg-7.3.0+1.21.5" = _WayQDn7d;
        "pkg-7.3.2+1.20.(5-6)" = _3Zm3RMYW;
        "pkg-7.3.2+1.20.(2-4)" = _mVoIIRnI;
        "pkg-7.3.2+1.21.(2-4)" = _ifGt5AQp;
        "pkg-7.3.2+1.21.1" = _vpwiTV7p;
        "pkg-7.3.2+1.20.1" = _XiHYm1U3;
        "pkg-7.3.2+1.21.5" = _yfy0vz3Y;
        "pkg-7.3.2+1.21.(6+)" = _OwtheOTL;
        "pkg-7.3.3+1.20.1" = _GambjgwJ;
        "pkg-7.3.3+1.20.(2-4)" = _L3mdBsf4;
        "pkg-7.3.3+1.20.(5-6)" = _DYMNR3qx;
        "pkg-7.3.3+1.21.(2-4)" = _k2XFb8pH;
        "pkg-7.3.3+1.21.1" = _jeqKQ6ki;
        "pkg-7.3.3+1.21.5" = _Nn32bjqK;
        "pkg-7.3.3+1.21.(6+)" = _H2dkrgkT;
        "pkg-7.3.3+1.21.(11+)" = _6BosIxAe;
        "pkg-7.3.4+1.20.(5-6)" = _qLhh9JzY;
        "pkg-7.3.4+1.21.1" = _IMW9gG56;
        "pkg-7.3.4+1.20.1" = _pvyFSn61;
        "pkg-7.3.4+1.20.(2-4)" = _UcgbXsOi;
        "pkg-7.3.4+1.21.(2-4)" = _4z1Jc4OH;
        "pkg-7.3.4+1.21.(6+)" = _6HrukI3a;
        "pkg-7.3.4+1.21.5" = _dyOYG54n;
        "pkg-7.3.4+1.21.(11+)" = _XNWm2wqs;
        "default" = _XNWm2wqs;
    });
