...
let
    ...
    in {
        ...
        "pkg-1.3.4" = _v4EjwBSV;
        "pkg-1.4.0" = _fELOJsXD;
        "pkg-1.4.0.1" = _c8lQ3mZq;
        "pkg-1.4.0.2" = _FNcDOdxT;
        "pkg-2.0.0" = _xQX7olw4;
        "pkg-2.1.0" = _QUfyfVYN;
        "pkg-2.1.1" = _iGllT6l1;
        "pkg-2.2.0" = _62VFJNqy;
        ...
        "pkg-2.3.5" = _tOSnHiV3;
        "pkg-2.3.6" = _bfVCX7aB;
        "pkg-2.3.6.1" = _kImyQabp;
        "pkg-2.3.6.2" = _w5rGmcCT;
        "pkg-2.3.7" = _L5Amwn6O;
        "pkg-2.3.7.1" = _Zf88kxDb;
        "pkg-2.3.8" = _aNhSjIxi;
        "pkg-2.3.9" = _7d3es0Ti;
        "pkg-2.3.9.1" = _qFd0L0Ue;
        "pkg-2.3.10" = _NDZjHbha;
        "pkg-2.3.10.1" = _euEWvSAO;
        "pkg-2.3.10.2" = _ZVZ1YfR4;
        "pkg-2.3.11" = _bpk6wlyj;
        "pkg-2.3.12" = _w031wE4y;
        "pkg-2.3.13" = _lFggxGwC;
        "pkg-2.3.14" = _n7E8umSw;
        "pkg-2.3.14.1" = _NOZ3ARy0;
        "pkg-2.3.14.2" = _gCds4bYH;
        "pkg-2.3.15" = _b3AvOxmu;
        "pkg-2.3.16" = _QmyogiBF;
        "pkg-2.3.17" = _3ikJqiLH;
        "pkg-2.3.18" = _yoQv8oeU;
        "pkg-2.3.19" = _CkWa6zjN;
        "pkg-2.4.0" = _hokiFbKM;
        "pkg-2.4.1" = _pf8UVWXD;
        "pkg-2.4.2" = _9JxPd1qZ;
        "pkg-2.4.2.1" = _aIgXiHvA;
