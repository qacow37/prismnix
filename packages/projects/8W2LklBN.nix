...
let
    ...
    in {
        ...
        "pkg-1.1.4+forge" = _rQxtsevZ;
        "pkg-1.2.3+fabric" = _ljaOBD77;
        "pkg-1.3.1+fabric" = _avCgHPeb;
        "pkg-1.2.2+forge" = _Bo27s6Gh;
        "pkg-1.1.5+forge" = _odEyvUKA;
        "pkg-1.2.5+fabric" = _jNAUSyOl;
        "pkg-1.4.0+fabric" = _XPLdYjgd;
        "pkg-1.3.0+forge" = _h4n3AuqJ;
        "pkg-1.5.0+fabric" = _iaIJtTFn;
        "pkg-1.4.0+forge" = _bvDXJ50Y;
        "pkg-1.3.1+forge" = _Knud55ae;
        "pkg-1.4.1+forge" = _p9rm5NAE;
        "pkg-1.5.0+forge" = _BlsOgZqQ;
        "pkg-1.4.1+fabric" = _j23zQgKi;
        "pkg-1.4.2+fabric" = _HSS0tCB2;
        "pkg-1.5.1+fabric" = _tjpUc93t;
        "pkg-1.6.0+fabric" = _MpaGX2uL;
        "pkg-1.5.1+forge" = _DwLCafRo;
        "pkg-1.6.0-alpha.1+forge" = _R7Wzo9Wa;
        "pkg-1.7.0-alpha.1+fabric" = _YtGRVfTx;
        "pkg-1.8.0-beta.1+fabric" = _A29hKSNf;
        "pkg-1.7.0-beta.1+fabric" = _bYQkiVXQ;
        "pkg-1.6.0-beta.1+forge" = _6Kzth3tU;
        "pkg-1.7.0-beta.1+forge" = _L0rwtsh8;
        "pkg-1.5.2+fabric" = _wf3qfWSK;
        "pkg-1.8.0+fabric" = _IxVkf6Kp;
        "pkg-1.4.2+forge" = _vejztGRI;
        "pkg-1.7.0+forge" = _eCtAOaq4;
        "pkg-1.6.0+forge" = _sl54MA3q;
        "pkg-1.7.1+forge" = _uwWytUrJ;
        "pkg-1.8.1+fabric" = _mgtBrHLy;
        "pkg-1.7.0+fabric" = _TIByBIrh;
        "pkg-1.7.1+neoforge" = _6skPz9Kr;
        "pkg-1.9.0+fabric" = _sPHKoVlg;
        "pkg-1.9.1+fabric" = _5VmoBZU4;
        "pkg-1.9.2+fabric" = _E4eoge14;
        "pkg-1.10.0+fabric" = _IKfEAB4W;
        "pkg-1.11.0+fabric" = _CDb3POxa;
        "pkg-1.9.0+neoforge" = _DI20Ezj1;
        "pkg-1.10.0+neoforge" = _3kuu8JRH;
        "default" = _3kuu8JRH;
    });
