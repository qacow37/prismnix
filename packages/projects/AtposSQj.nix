...
let
    ...
    in {
        ...
        "pkg-1.0.1.8" = _WkYqj6m4;
        "pkg-1.0.1.7" = _GBhz4aL0;
        "pkg-0.9.0.9" = _bgudnVpL;
        "pkg-0.9.0.5" = _46168Ikl;
        "pkg-1.0.4.29" = _53834E4i;
        "pkg-1.0.4.35" = _XTVxO5F2;
        "pkg-0.6.5" = _1MLE1eDM;
        "pkg-0.6.12" = _1kKOeWIU;
        "pkg-0.6.16" = _KLZ1yFgW;
        "pkg-0.8.1.3" = _gY9gKLNF;
        "pkg-0.8.1.6" = _tHDtt4Mh;
        "pkg-0.8.5" = _qetPpUf7;
        "pkg-0.8.6" = _gPbKuvEO;
        "pkg-0.8.7.3" = _fuL1kjTC;
        "pkg-1.0.2.12" = _sobDb8Rk;
        "pkg-1.0.5.34" = _B9RINJFx;
        "pkg-1.0.5.37" = _6c88NCb9;
        "pkg-1.0.6.39" = _tksKLpdP;
        "pkg-1.0.6.43" = _nQDcEViu;
        "pkg-1.0.5.36" = _YsXbzGGG;
        "pkg-1.0.7.47" = _yRtlrdoy;
        "pkg-1.0.7.48" = _8GyioK6H;
        "pkg-2.0.1.6" = _3Ld59aAo;
        "pkg-2.0.1.10" = _hxIxIaPT;
        "pkg-2.0.1.50" = _A3h8Lal4;
        "pkg-2.0.1.52" = _wpdnuAek;
        "pkg-2.0.1.53" = _tkJ78TnD;
        "pkg-2.0.1.59" = _83CwAOgy;
        "pkg-2.0.3.65" = _1hwTlPaa;
        "pkg-2.0.4.71" = _ak5c3LCY;
        "pkg-2.1.8.79" = _XukHnrQw;
        "pkg-2.3.2.82" = _tlbXFwQk;
        "pkg-2.3.4.89" = _60xpnzzW;
        "pkg-2.3.5.91" = _rhG33GRa;
        "pkg-2.4.0.100" = _eZWyfY88;
        "pkg-2.4.0.101" = _w4HtO7D3;
        "pkg-2.4.1.102" = _ZWNxYWcb;
        "default" = _ZWNxYWcb;
    });
