...
let
    ...
    in {
        ...
        "pkg-12" = _k8bjYRxt;
        "pkg-13" = _sGkfgKZh;
        "pkg-1.18.2-0.1.4.1" = _ElggSypp;
        "pkg-1.19.2-0.1.4.2" = _FNxDBFIy;
        "pkg-1.18.2-0.1.5.0" = _busXiYJD;
        "pkg-1.19.2-0.1.5.0" = _hXCi3tJS;
        "pkg-1.19.2-1.5.3" = _RlvAi1Db;
        "pkg-1.18.2-0.1.5.2" = _4vNLf7oX;
        "pkg-1.19.2-1.5.4" = _qKcgPzw7;
        "pkg-1.19.2-1.5.5" = _PQcHXlb2;
        "pkg-1.19.2-1.5.6" = _aKBD92US;
        "pkg-1.18.2-0.1.5.3" = _IJlT7LsB;
        "pkg-1.19.2-1.5.7" = _IG1VzQY6;
        "pkg-1.20.1-1.6.0" = _eHK85419;
        "default" = _eHK85419;
    });
