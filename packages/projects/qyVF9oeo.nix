...
let
    ...
    in {
        ...
        "pkg-fabric-1.19-1.0.7" = _SYSMCMTq;
        "pkg-forge-1.19-1.0.8" = _kZQoJLcW;
        "pkg-fabric-1.19-1.0.8" = _ExqJDhfb;
        "pkg-forge-1.19-1.0.9" = _MBlFcMKc;
        "pkg-fabric-1.19-1.0.9" = _xZ9UodxE;
        "pkg-forge-1.19-1.0.10" = _jRobOtd6;
        "pkg-fabric-1.19-1.0.10" = _eZELi5uU;
        "pkg-forge-1.19-1.0.11" = _dKCe780W;
        "pkg-fabric-1.19-1.0.11" = _6XE3ynnM;
        "pkg-forge-1.19.1-1.0.11" = _TuOjqGZ4;
        "pkg-fabric-1.19.1-1.0.11" = _xVwTOdDC;
        "pkg-forge-1.19.2-1.0.11" = _qZS1UvUq;
        "pkg-fabric-1.19.2-1.0.11" = _NxBIvRrx;
        "pkg-forge-1.19-1.0.12" = _btiLehDH;
        "pkg-fabric-1.19-1.0.12" = _7IdNS4GK;
        "pkg-forge-1.19.1-1.0.12" = _TVhi1tt5;
        "pkg-fabric-1.19.1-1.0.12" = _kDnIIyrT;
        "pkg-forge-1.19.2-1.0.12" = _weUdAUDs;
        "pkg-fabric-1.19.2-1.0.12" = _a37ONsXw;
        "pkg-forge-1.19-1.0.13" = _X5StGhDe;
        "pkg-fabric-1.19-1.0.13" = _5cW4koqn;
        "pkg-forge-1.19.1-1.0.13" = _14Ps1Jzh;
        "pkg-fabric-1.19.1-1.0.13" = _MAkKuumS;
        "pkg-forge-1.19.2-1.0.13" = _znriWuAi;
        "pkg-fabric-1.19.2-1.0.13" = _RWvuXxi3;
        "pkg-forge-1.19-1.0.14" = _ccEQbQJ3;
        "pkg-fabric-1.19-1.0.14" = _JHXFUvDT;
        "pkg-forge-1.19.1-1.0.14" = _mFMJ9c9z;
        "pkg-fabric-1.19.1-1.0.14" = _GBrc5892;
        "pkg-forge-1.19.2-1.0.14" = _swW70Uzh;
        "pkg-fabric-1.19.2-1.0.14" = _ej3KHCh4;
        "pkg-forge-1.19-1.0.15" = _74oofD7s;
        "pkg-fabric-1.19-1.0.15" = _34AzinYF;
        "pkg-forge-1.19.1-1.0.15" = _ZQ358klw;
        "pkg-fabric-1.19.1-1.0.15" = _8DVONifo;
        "pkg-forge-1.19.2-1.0.15" = _MsRCg9vD;
        "pkg-fabric-1.19.2-1.0.15" = _M8HvAuai;
        "pkg-forge-1.19.2-1.0.16" = _nBLV4bCJ;
        "pkg-fabric-1.19.2-1.0.16" = _UlywtXTw;
        "pkg-forge-1.19.3-1.0.16" = _dGldKfFi;
        "pkg-fabric-1.19.3-1.0.16" = _ouJkPcmR;
        "pkg-forge-1.19.3-1.0.17" = _tA2eeq37;
        "pkg-fabric-1.19.3-1.0.17" = _5kLP4E16;
        "pkg-forge-1.19.2-1.0.18" = _L9IFjX01;
        "pkg-fabric-1.19.2-1.0.18" = _xXUcyQrd;
        "pkg-forge-1.19.3-1.0.18" = _lNfifytA;
        "pkg-fabric-1.19.3-1.0.18" = _op41PVog;
        "pkg-forge-1.19.3-1.1.0" = _ImG6hq12;
        "pkg-fabric-1.19.3-1.1.0" = _vugO7mNF;
        "pkg-forge-1.19.4-1.1.0" = _qj6Fhfgl;
        "pkg-fabric-1.19.4-1.1.0" = _b6C2l51o;
        "pkg-forge-1.19.4-1.1.1" = _MZG4uxm4;
        "pkg-fabric-1.19.4-1.1.1" = _vCR4KOzC;
        "pkg-forge-1.20-1.1.1" = _BiJaNUOc;
        "pkg-fabric-1.20-1.1.1" = _jFi9wAm9;
        "pkg-forge-1.20.1-1.1.1" = _wSSDI9Rg;
        "pkg-fabric-1.20.1-1.1.1" = _gAP9590c;
        "pkg-forge-1.20.1-1.1.2" = _e0jDon7B;
        "pkg-fabric-1.20.1-1.1.2" = _tFcSgMDe;
        "pkg-forge-1.19.2-1.2.0" = _piYsWHSx;
        "pkg-fabric-1.19.2-1.2.0" = _TEiP8U4g;
        "pkg-forge-1.19.4-1.2.0" = _oVxOW2yg;
        "pkg-fabric-1.19.4-1.2.0" = _qnzq20sO;
        "pkg-forge-1.20.1-1.2.0" = _tw5iAjtN;
        "pkg-fabric-1.20.1-1.2.0" = _ZEMrXhx7;
        "pkg-forge-1.19.2-1.2.1" = _ouODHxQ8;
        "pkg-fabric-1.19.2-1.2.1" = _7P98uY0M;
        "pkg-forge-1.19.4-1.2.1" = _bKhTczPg;
        "pkg-fabric-1.19.4-1.2.1" = _I2nXZGRy;
        "pkg-forge-1.20.1-1.2.1" = _OOw4wyHN;
        "pkg-fabric-1.20.1-1.2.1" = _67Uq017p;
        "pkg-forge-1.20.2-1.2.1" = _bujm33cE;
        "pkg-neoforge-1.20.2-1.2.1" = _cBy6ZK3G;
        "pkg-fabric-1.20.2-1.2.1" = _WLNfa7ku;
        "pkg-forge-1.19.2-1.3.0" = _JPBZW9Vf;
        "pkg-fabric-1.19.2-1.3.0" = _ITaPOJ9r;
        "pkg-forge-1.20.1-1.3.0" = _sSV5WT7s;
        "pkg-fabric-1.20.1-1.3.0" = _CWAfu9W5;
        "pkg-forge-1.20.2-1.3.0" = _eMG0BbRq;
        "pkg-neoforge-1.20.2-1.3.0" = _97XHldOK;
        "pkg-fabric-1.20.2-1.3.0" = _ZiMnDFg6;
        "pkg-forge-1.20.4-1.3.0" = _nLopGrFf;
        "pkg-neoforge-1.20.4-1.3.0" = _nSYaAtGV;
        "pkg-fabric-1.20.4-1.3.0" = _w17wrgYv;
        "pkg-forge-1.19.2-1.3.1" = _DBPAu9gh;
        "pkg-fabric-1.19.2-1.3.1" = _BMZ7TDzQ;
        "pkg-forge-1.20.1-1.3.1" = _CmxXa8uE;
        "pkg-fabric-1.20.1-1.3.1" = _GdHd0uVw;
        "pkg-forge-1.20.2-1.3.1" = _i9vcidyG;
        "pkg-neoforge-1.20.2-1.3.1" = _F8triwQi;
        "pkg-fabric-1.20.2-1.3.1" = _RtbuP43K;
        "pkg-forge-1.20.4-1.3.1" = _U74mJrlB;
        "pkg-neoforge-1.20.4-1.3.1" = _GZpOvsk2;
        "pkg-fabric-1.20.4-1.3.1" = _LlnzkNS9;
        "pkg-forge-1.20.6-1.3.1" = _Vyrz7QQ2;
        "pkg-neoforge-1.20.6-1.3.1" = _KK8s1GO6;
        "pkg-fabric-1.20.6-1.3.1" = _LSLnEJbQ;
        "pkg-forge-1.19.2-1.4.0" = _x59lJ2xc;
        "pkg-fabric-1.19.2-1.4.0" = _VJwdOuqA;
        "pkg-forge-1.20.1-1.4.0" = _ahFNUMMQ;
        "pkg-fabric-1.20.1-1.4.0" = _EfBxPGaK;
        "pkg-forge-1.20.4-1.4.0" = _veANUV9l;
        "pkg-neoforge-1.20.4-1.4.0" = _WyTB3RFm;
        "pkg-fabric-1.20.4-1.4.0" = _L6oPowRU;
        "pkg-forge-1.20.6-1.4.0" = _QSvkGLBf;
        "pkg-neoforge-1.20.6-1.4.0" = _nAzJ7GlL;
        "pkg-fabric-1.20.6-1.4.0" = _o7NVGpjL;
        "pkg-forge-1.19.2-1.4.1" = _7Aji5QaG;
        "pkg-fabric-1.19.2-1.4.1" = _emDPG9Uq;
        "pkg-forge-1.20.1-1.4.1" = _mxbQTk6W;
        "pkg-fabric-1.20.1-1.4.1" = _oo6WesiS;
        "pkg-forge-1.20.4-1.4.1" = _2SX5mbvk;
        "pkg-neoforge-1.20.4-1.4.1" = _McfCXCmf;
        "pkg-fabric-1.20.4-1.4.1" = _3HhMsZ0w;
        "pkg-forge-1.20.6-1.4.1" = _sOYL3ARx;
        "pkg-neoforge-1.20.6-1.4.1" = _YG8JVSin;
        "pkg-fabric-1.20.6-1.4.1" = _eY1CBtiC;
        "pkg-forge-1.19.2-1.4.2" = _Boy7PUiT;
        "pkg-fabric-1.19.2-1.4.2" = _j2uf4Rqu;
        "pkg-forge-1.20.1-1.4.2" = _WC9KAg08;
        "pkg-fabric-1.20.1-1.4.2" = _qcWiQYte;
        "pkg-forge-1.20.4-1.4.2" = _EZCMvWJo;
        "pkg-neoforge-1.20.4-1.4.2" = _a9mFvVtk;
        "pkg-fabric-1.20.4-1.4.2" = _v82u5BX1;
        "pkg-forge-1.20.6-1.4.2" = _pG8odFUO;
        "pkg-neoforge-1.20.6-1.4.2" = _SZoH54wW;
        "pkg-fabric-1.20.6-1.4.2" = _WiNNhm4M;
        "pkg-forge-1.21-1.4.2" = _qzeuRX2k;
        "pkg-neoforge-1.21-1.4.2" = _R08tbAhr;
        "pkg-fabric-1.21-1.4.2" = _LDy1fR4w;
        "pkg-forge-1.20.6-1.4.3" = _vkj3OYhV;
        "pkg-neoforge-1.20.6-1.4.3" = _3TB8hRco;
        "pkg-fabric-1.20.6-1.4.3" = _S5qjcOcU;
        "pkg-forge-1.21-1.4.3" = _MW5MPwpE;
        "pkg-neoforge-1.21-1.4.3" = _vc4XGsIG;
        "pkg-fabric-1.21-1.4.3" = _5gC41Itp;
        "pkg-forge-1.21-1.4.4" = _1ecXPX5o;
        "pkg-neoforge-1.21-1.4.4" = _TsHpz1nS;
        "pkg-fabric-1.21-1.4.4" = _DZclhMyL;
        "pkg-forge-1.19.2-1.4.5" = _cT0aLJ8N;
        "pkg-fabric-1.19.2-1.4.5" = _D7fOLtmp;
        "pkg-forge-1.20.1-1.4.5" = _AGRkYn5p;
        "pkg-fabric-1.20.1-1.4.5" = _MmKSrFU9;
        "pkg-forge-1.20.4-1.4.5" = _mKQcogVn;
        "pkg-neoforge-1.20.4-1.4.5" = _eQg3x7U0;
        "pkg-fabric-1.20.4-1.4.5" = _Yh3XWCNn;
        "pkg-forge-1.20.6-1.4.5" = _MgbZRiG5;
        "pkg-neoforge-1.20.6-1.4.5" = _BwDWoRgh;
        "pkg-fabric-1.20.6-1.4.5" = _s5PSGIl7;
        "pkg-forge-1.21-1.4.5" = _rRjQmiWc;
        "pkg-neoforge-1.21-1.4.5" = _Tbtajy1X;
        "pkg-fabric-1.21-1.4.5" = _8w6T0wDj;
        "pkg-forge-1.21-1.4.6" = _ifR8SEdY;
        "pkg-neoforge-1.21-1.4.6" = _mzJYir2h;
        "pkg-fabric-1.21-1.4.6" = _nzrrHnMa;
        "pkg-forge-1.21.1-1.4.6" = _8S2j9Ddt;
        "pkg-neoforge-1.21.1-1.4.6" = _N3uoEoK5;
        "pkg-fabric-1.21.1-1.4.6" = _wP25tEBe;
        "pkg-forge-1.21.3-1.4.6" = _bzlrhdZr;
        "pkg-neoforge-1.21.3-1.4.6" = _zp5GhFZU;
        "pkg-fabric-1.21.3-1.4.6" = _YjuhbOW1;
        "pkg-forge-1.21.4-1.4.6" = _NbF8nhdp;
        "pkg-neoforge-1.21.4-1.4.6" = _gxqsSK7N;
        "pkg-fabric-1.21.4-1.4.6" = _dCHPc1LR;
        "pkg-forge-1.20.1-1.4.7" = _xAGLjUpc;
        "pkg-fabric-1.20.1-1.4.7" = _JpvwEsAy;
        "pkg-forge-1.21.1-1.4.7" = _g1qpCZIb;
        "pkg-neoforge-1.21.1-1.4.7" = _aBHYqVZ6;
        "pkg-fabric-1.21.1-1.4.7" = _cjZ56xjl;
        "pkg-forge-1.21.3-1.4.7" = _c0jIG24R;
        "pkg-neoforge-1.21.3-1.4.7" = _VBcz7r0j;
        "pkg-fabric-1.21.3-1.4.7" = _HQmzjJ3p;
        "pkg-forge-1.21.4-1.4.7" = _vHcOCCI4;
        "pkg-neoforge-1.21.4-1.4.7" = _YJhcrT3K;
        "pkg-fabric-1.21.4-1.4.7" = _du57eOFB;
        "pkg-forge-1.20.1-1.4.8" = _O13IgRhY;
        "pkg-fabric-1.20.1-1.4.8" = _hxEab3Tk;
        "pkg-forge-1.21.1-1.4.8" = _CEZwFiDy;
        "pkg-neoforge-1.21.1-1.4.8" = _LgdCGVoe;
        "pkg-fabric-1.21.1-1.4.8" = _Ky6uYXzW;
        "pkg-forge-1.21.4-1.4.8" = _Ered6Y6Q;
        "pkg-neoforge-1.21.4-1.4.8" = _hBxrGSJV;
        "pkg-fabric-1.21.4-1.4.8" = _jtRGevsD;
        "pkg-forge-1.20.1-1.4.10" = _qeWNOzYk;
        "pkg-fabric-1.20.1-1.4.10" = _e5jXJ6q4;
        "pkg-forge-1.21.1-1.4.10" = _rQNHYmio;
        "pkg-neoforge-1.21.1-1.4.10" = _cTTunNxQ;
        "pkg-fabric-1.21.1-1.4.10" = _m3KTcqdE;
        "pkg-forge-1.21.4-1.4.10" = _OQB7Ak8d;
        "pkg-neoforge-1.21.4-1.4.10" = _4DZBV1Tq;
        "pkg-fabric-1.21.4-1.4.10" = _NspcVzoa;
        "pkg-forge-1.21.5-1.4.10" = _Z6MGLWgB;
        "pkg-neoforge-1.21.5-1.4.10" = _2oFYMLKZ;
        "pkg-fabric-1.21.5-1.4.10" = _2EyHcj8z;
        "pkg-forge-1.20.1-1.4.11" = _cOaVh5iB;
        "pkg-fabric-1.20.1-1.4.11" = _1IkBe2X8;
        "pkg-forge-1.21.1-1.4.11" = _l712DvPe;
        "pkg-neoforge-1.21.1-1.4.11" = _hsk0FHt4;
        "pkg-fabric-1.21.1-1.4.11" = _rAwpAimy;
        "pkg-forge-1.21.4-1.4.11" = _hcUShul9;
        "pkg-neoforge-1.21.4-1.4.11" = _Haf3UAqS;
        "pkg-fabric-1.21.4-1.4.11" = _o7eGtjLK;
        "pkg-forge-1.21.5-1.4.11" = _5LhbprYa;
        "pkg-neoforge-1.21.5-1.4.11" = _wMlD1our;
        "pkg-fabric-1.21.5-1.4.11" = _wnjLxS4m;
        "pkg-forge-1.20.1-1.4.12" = _RAfxbCzO;
        "pkg-fabric-1.20.1-1.4.12" = _LrmG4rhi;
        "pkg-forge-1.21.1-1.4.12" = _yosPHq0U;
        "pkg-neoforge-1.21.1-1.4.12" = _xhIsCIPl;
        "pkg-fabric-1.21.1-1.4.12" = _GGCEmgoW;
        "pkg-forge-1.21.4-1.4.12" = _sysqsonG;
        "pkg-neoforge-1.21.4-1.4.12" = _eUjMlEUC;
        "pkg-fabric-1.21.4-1.4.12" = _YBQZz0DL;
        "pkg-forge-1.21.5-1.4.12" = _IENNXtz3;
        "pkg-neoforge-1.21.5-1.4.12" = _CCYtQorE;
        "pkg-fabric-1.21.5-1.4.12" = _twAAiZM2;
        "pkg-forge-1.20.1-1.4.13" = _fqgMU03D;
        "pkg-forge-1.21.6-1.4.13" = _VXphA177;
        "pkg-neoforge-1.21.6-1.4.13" = _B6NhJjAC;
        "pkg-fabric-1.21.6-1.4.13" = _8fgyprg5;
        "pkg-forge-1.21.6-1.4.14" = _8f3pzFkh;
        "pkg-neoforge-1.21.6-1.4.14" = _o10BGnZk;
        "pkg-fabric-1.21.6-1.4.14" = _tSRYMFnW;
        "pkg-forge-1.21.7-1.4.14" = _fVK6RBZn;
        "pkg-neoforge-1.21.7-1.4.14" = _3YkEa9hs;
        "pkg-fabric-1.21.7-1.4.14" = _acb0kJIr;
        "pkg-forge-1.21.8-1.4.14" = _ZMDdblHV;
        "pkg-neoforge-1.21.8-1.4.14" = _gJBvSOcA;
        "pkg-fabric-1.21.8-1.4.14" = _GNRF6jGz;
        "pkg-forge-1.20.1-1.4.15" = _o4QlRA76;
        "pkg-fabric-1.20.1-1.4.15" = _ulnkyugI;
        "pkg-forge-1.21.1-1.4.15" = _iPdTUkN3;
        "pkg-neoforge-1.21.1-1.4.15" = _HwU1sCQJ;
        "pkg-fabric-1.21.1-1.4.15" = _MugPtn8A;
        "pkg-forge-1.21.4-1.4.15" = _CsWOpI69;
        "pkg-neoforge-1.21.4-1.4.15" = _AuyUnCtn;
        "pkg-fabric-1.21.4-1.4.15" = _AlywueqQ;
        "pkg-forge-1.21.5-1.4.15" = _xTNY98Kr;
        "pkg-neoforge-1.21.5-1.4.15" = _JrDd9HQc;
        "pkg-fabric-1.21.5-1.4.15" = _vNMtPf2W;
        "pkg-forge-1.21.8-1.4.15" = _gfg1agtN;
        "pkg-neoforge-1.21.8-1.4.15" = _DNm8haPC;
        "pkg-fabric-1.21.8-1.4.15" = _V2V3ooIl;
        "pkg-forge-1.20.1-1.5.0" = _rWb4mB4Z;
        "pkg-fabric-1.20.1-1.5.0" = _CaSx379T;
        "pkg-forge-1.21.1-1.5.0" = _V9iRUFpY;
        "pkg-neoforge-1.21.1-1.5.0" = _YsHj3Bdn;
        "pkg-fabric-1.21.1-1.5.0" = _r5wwCUWh;
        "pkg-forge-1.21.4-1.5.0" = _R2CrcjXA;
        "pkg-neoforge-1.21.4-1.5.0" = _lzrzvG5V;
        "pkg-fabric-1.21.4-1.5.0" = _wIFDmHF8;
        "pkg-forge-1.21.5-1.5.0" = _FZWqAliK;
        "pkg-neoforge-1.21.5-1.5.0" = _LGNCXUte;
        "pkg-fabric-1.21.5-1.5.0" = _hFsAChrh;
        "pkg-forge-1.21.8-1.5.0" = _xhBYkLgY;
        "pkg-neoforge-1.21.8-1.5.0" = _1k3BlprJ;
        "pkg-fabric-1.21.8-1.5.0" = _IHzf5auf;
        "pkg-forge-1.20.1-1.5.1" = _x0sJ9PeR;
        "pkg-fabric-1.20.1-1.5.1" = _sCsWXt85;
        "pkg-forge-1.21.1-1.5.1" = _hjqFKSNL;
        "pkg-neoforge-1.21.1-1.5.1" = _Dd2tmpsk;
        "pkg-fabric-1.21.1-1.5.1" = _tVu2EZ4u;
        "pkg-forge-1.21.4-1.5.1" = _Hd5cV8ki;
        "pkg-neoforge-1.21.4-1.5.1" = _thfTQpK3;
        "pkg-fabric-1.21.4-1.5.1" = _6mKaWW6b;
        "pkg-forge-1.21.5-1.5.1" = _v0gtGOMN;
        "pkg-neoforge-1.21.5-1.5.1" = _Zec2D7gq;
        "pkg-fabric-1.21.5-1.5.1" = _VvbAHIWf;
        "pkg-forge-1.21.8-1.5.1" = _4V9NXSUN;
        "pkg-neoforge-1.21.8-1.5.1" = _yOC9aHax;
        "pkg-fabric-1.21.8-1.5.1" = _gUaL8lMJ;
        "pkg-forge-1.21.9-1.5.1" = _QoPZf0xy;
        "pkg-neoforge-1.21.9-1.5.1" = _PVce87mn;
        "pkg-fabric-1.21.9-1.5.1" = _dkg8dQOa;
        "pkg-forge-1.21.10-1.5.1" = _Zevu9NLr;
        "pkg-neoforge-1.21.10-1.5.1" = _BTy2x7RS;
        "pkg-fabric-1.21.10-1.5.1" = _pDo1ElL2;
        "pkg-forge-1.21.11-1.5.1" = _fEnVDnQy;
        "pkg-neoforge-1.21.11-1.5.1" = _kkDJ1ncH;
        "pkg-fabric-1.21.11-1.5.1" = _pfqxi9qs;
        "pkg-neoforge-1.5.1+26.1" = _8oMdRGmg;
        "pkg-fabric-1.5.1+26.1" = _XLwWIIue;
        "pkg-forge-1.5.1+26.1" = _SNuarWL0;
        "pkg-forge-1.5.1+26.1.1" = _msEsH9u5;
        "pkg-neoforge-1.5.1+26.1.1" = _nHHZNHHw;
        "pkg-fabric-1.5.1+26.1.1" = _aulCuAkE;
        "pkg-forge-1.5.1+26.1.2" = _AGRaV6qK;
        "pkg-neoforge-1.5.1+26.1.2" = _fJhWavsR;
        "pkg-fabric-1.5.1+26.1.2" = _y3vsp51g;
