...
let
    ...
    in {
        ...
        "pkg-1.0-mc1.21.2" = _inr55hNM;
        "pkg-1.0.1-mc1.21.4" = _tyrFg9Fr;
        "pkg-1.0.1-mc1.21.5" = _EAVyq8GL;
        "pkg-1.0.1-mc1.21.6" = _s47zVohf;
        "pkg-1.0.1-mc1.21.7" = _7wwBg6xB;
        "pkg-1.0.1-mc1.21.9" = _QLjjlPcf;
