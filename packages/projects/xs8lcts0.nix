...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.1.0-alpha_3c55c28a" = _RbhlpPr2;
        "pkg-1.18.2-0.1.0-alpha_1910ae3e" = _Hc782cFj;
        "pkg-1.18.2-0.1.1-alpha_f84f9069" = _M7yKwUqa;
        "pkg-1.18.2-0.2.0-alpha-e51f9bce" = _uWI6WpJg;
        "pkg-1.20.1-0.2.1-alpha-b33f4bff" = _FvxmA3qg;
        "pkg-1.20.1-0.2.2-alpha-b9a2351b" = _zUJDsolA;
        "pkg-1.20.1-0.2.3-alpha-nightly" = _gqasw8T0;
        "pkg-1.20.1-0.2.3-alpha-nightly-2" = _Z6JctIuo;
        "pkg-1.18.2-0.2.3-alpha-9cc91e74" = _k8O6VBRW;
        "pkg-1.20.1-0.2.3-alpha-5db4b282" = _TLzWttXt;
        "pkg-0.2.4-alpha-94eef3" = _97yNfOmc;
        "pkg-0.2.4-alpha-29eafc" = _NzzQmMTy;
        "pkg-0.2.5-alpha-b6bc12" = _fAL6mFYX;
        "pkg-0.2.5-alpha-843bf4" = _3ahlb5my;
        "pkg-0.2.5-alpha-bfb93a" = _QNOxZR3n;
        "pkg-0.2.6-alpha-3fc000" = _ygohCTlx;
        "pkg-0.2.5-alpha-hotfix1" = _SyDR5Gg2;
        "pkg-0.3.3-beta-27adbe" = _z5PiEQ0t;
        "pkg-0.3.3-hotfix1-beta-eee9ce" = _mBeQIvX6;
        "pkg-0.3.4-beta" = _WkRDZmRF;
        "pkg-0.3.5-beta-cb516e" = _lQyUYD09;
        "pkg-0.4.0-alpha-EXP-SIMPLE" = _5F4hnHJm;
        "pkg-0.4.0-create6.0-alpha-EXP-SIMPLE" = _WQcWjoeU;
        "pkg-0.4.0.hf1-create6.0-alpha-SIMPLE" = _2TQ6WJ7O;
        "pkg-0.4.1-create5.1-alpha-SIMPLE" = _v73ihOl3;
        "pkg-0.4.1.hf1-create5.1-alpha-SIMPLE" = _f1cVVOHE;
        "pkg-0.4.1.hf1-create6.0-alpha-SIMPLE" = _CqldUsvP;
        "pkg-0.4.2-create6.0-alpha-SIMPLE" = _ZogokYyo;
        "pkg-0.4.2-create5.1-alpha-SIMPLE" = _i3lHAeyk;
        "pkg-0.4.2.hf1-create6.0-alpha-SIMPLE" = _YNgaH9Zd;
        "pkg-0.4.2.hf1-create5.1-alpha-SIMPLE" = _9fPsesdV;
        "pkg-0.4.3-create5.1-alpha-SIMPLE" = _QX7wlmMs;
        "pkg-0.4.3-create6.0-alpha-SIMPLE" = _gNkrZXE2;
        "pkg-0.4.4-cr5.1-SIMPLE-beta" = _d07EjSqV;
        "pkg-0.4.4-cr6.0-SIMPLE-beta" = _kPQmixfM;
        "pkg-0.4.4-cr6.0-SIMPLE-beta-datapack" = _zYm01qzT;
        "default" = _zYm01qzT;
    });
