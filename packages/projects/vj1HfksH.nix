...
let
    ...
    in {
        ...
        "pkg-v.1.1.0+mod" = _RsNqB1r0;
        "pkg-v.1.2.0" = _RL0kxoWU;
        "pkg-v.1.2.0+mod" = _sS2XicpS;
        "pkg-v.2.0.0" = _gPkwFlPy;
        "pkg-v.2.0.0+mod" = _Wgv7CBQ5;
        "pkg-v.2.0.1" = _B9OpzNRb;
        "pkg-v.2.0.1+mod" = _YKVUaEB8;
        "pkg-v.2.1.1" = _RoMyhMx8;
        "pkg-v.2.1.1+mod" = _Ily08INY;
        "pkg-v2.1.2" = _MDUm4L7h;
        "pkg-v2.1.2+mod" = _mlXicrph;
        "pkg-v2.2.2" = _tUUPdHkV;
        "pkg-v2.2.2+mod" = _xWzDANHX;
        "pkg-v2.2.3" = _Qw5DSbdV;
        "pkg-v2.2.3+mod" = _2TTwPfRA;
        "pkg-v2.3.3" = _FUsnfmHo;
        "pkg-v2.3.3+mod" = _WB2YAwAa;
        "pkg-v2.3.4" = _8ABH7sxr;
        "pkg-v2.3.4+mod" = _6QVimHzQ;
        "pkg-v2.3.5" = _JUXUNJXc;
        "pkg-v2.3.5+mod" = _VRXBL253;
        "pkg-v2.3.6" = _pNxvDxEh;
        "pkg-v2.3.6+mod" = _37GwVqnb;
        "pkg-v2.3.7" = _8vDCogNK;
        "pkg-v2.3.7+mod" = _dZWGlxvY;
        "pkg-v2.3.7.1" = _oRDloWh9;
        "pkg-v2.3.7.1+mod" = _K0zMefxw;
        "pkg-v2.3.8" = _3rrDg7dg;
