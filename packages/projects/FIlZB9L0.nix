...
let
    ...
    in {
        ...
        "pkg-5.0.0-BETA+1637644b" = _6jFzKi0e;
        "pkg-5.0.0-BETA+7f988dcf" = _1TeOdIt7;
        "pkg-5.0.0-BETA+c44d26cc" = _Bu3XrzNE;
        "pkg-5.1.0-BETA+2e8cd54a" = _zQ3kJfme;
        "pkg-Terra-5.1.0-BETA+2e8cd54a" = _8PKBI4jd;
        "pkg-5.1.1-BETA" = _oVS8UkGG;
        "pkg-5.1.1-BETA+fb8c7098" = _Gj35Qm97;
        "pkg-5.1.1-BETA+ec0730ef" = _YAgTTVXU;
        "pkg-5.1.2-BETA+f8e8ce8b" = _ZRDLEqdv;
        "pkg-5.1.2-BETA+8a933609" = _IcJeyROT;
        "pkg-5.1.2-BETA+7a703ad0" = _MyOLliqX;
        "pkg-5.1.3-BETA+5ac72575" = _QFi5X6v3;
        "pkg-5.1.3-BETA+f396e0e5" = _UEeyCR8s;
        "pkg-5.2.0-BETA+eee54f50" = _WwSRJnsL;
        "pkg-5.2.1-BETA+6da89248" = _S2MR1UPS;
        "pkg-5.2.1-BETA+a7e3a028-forge" = _2N4ewkYC;
        "pkg-5.2.1-BETA+a7e3a028-fabric" = _SSmQT73f;
        "pkg-5.3.0-BETA+dbc60b1d-forge" = _tpRPSoxK;
        "pkg-5.3.0-BETA+dbc60b1d-fabric" = _as9EalBI;
        "pkg-5.3.0-BETA+fd48f5f1-forge" = _uGSeZ34X;
        "pkg-5.3.0-BETA+fd48f5f1-fabric" = _gG1VHSY5;
        "pkg-5.3.1-BETA+e00271e4-fabric" = _w1sOAxwx;
        "pkg-5.3.1-BETA+f83dcd80-fabric" = _TV5SStzQ;
        "pkg-5.3.1-BETA+96de1554-fabric" = _6LSdGHFk;
        "pkg-5.3.1-BETA+2bfaa95a-fabric" = _WIgGr0NO;
        "pkg-5.3.1-BETA+0ab94917-fabric" = _49u1xXFO;
        "pkg-fabric-5.3.1-BETA+0ab94917" = _BRrEE6Bp;
        "pkg-fabric-5.3.2-BETA+9d991dbb" = _wM9oTkoy;
        "pkg-forge-5.3.2-BETA+e86f37fd" = _lrZzc0KE;
        "pkg-fabric-5.3.2-BETA+bac026a1" = _hrYE97dR;
        "pkg-forge-5.3.3-BETA+2dc7b501" = _DYQWCFn1;
        "pkg-fabric-5.3.3-BETA+5dd00db8" = _9DWPUHbr;
        "pkg-fabric-5.3.3-BETA+6027c282" = _z4dIPu75;
        "pkg-5.4.1-BETA+40e95073" = _i38N6tkR;
        "pkg-6.0.0+2b2255a5" = _jL9oD6Ms;
        "pkg-6.0.0-BETA+b6b6cb185" = _YMpdNsRC;
        "pkg-6.0.0-BETA" = _wVxXTVIp;
        "pkg-6.1.0-BETA" = _JFSEGnQ7;
        "pkg-6.1.1-BETA" = _r2MXSYAX;
        "pkg-6.2.0-BETA-fabric" = _LAN7zThD;
        "pkg-6.2.0-BETA-quilt" = _5IA99vok;
        "pkg-6.2.0-BETA-forge" = _qkC7qvnE;
        "pkg-6.2.0-BETA-bukkit" = _Migmy332;
        "pkg-5.4.1-BETA-bukkit" = _jgqTtHpN;
        "pkg-5.3.3-BETA-bukkit" = _8klFFNIb;
        "pkg-6.2.1-BETA-bukkit" = _z42HAbff;
        "pkg-6.2.1-BETA-fabric" = _PKGL45fm;
        "pkg-6.2.1-BETA-forge" = _ASNLY5FV;
        "pkg-6.2.1-BETA-quilt" = _BMKdpZ8z;
        "pkg-6.2.2-SNAPSHOT-fabric" = _oMlwSPre;
        "pkg-6.2.2-SNAPSHOT-bukkit" = _p7qfHDRM;
        "pkg-6.3.0-BETA-bukkit" = _bggoACYQ;
        "pkg-6.3.0-BETA-fabric" = _8XNYFizX;
        "pkg-6.3.0-BETA-quilt" = _M6I6zza3;
        "pkg-6.3.1-BETA-bukkit" = _1rd4VT0w;
        "pkg-6.3.1-BETA-fabric" = _vP6oIlOO;
        "pkg-6.4.0-BETA-fabric" = _URxHMpmQ;
        "pkg-6.4.0-BETA-bukkit" = _INqCRypS;
        "pkg-6.4.1-BETA-fabric" = _MEYyvRNm;
        "pkg-6.4.1-BETA-bukkit" = _GdjpgvhN;
        "pkg-6.4.2-BETA-fabric" = _YuGbwpG5;
        "pkg-6.4.2-BETA-bukkit" = _fM95q50t;
        "pkg-6.4.3-BETA-fabric" = _EVe9wYaj;
        "pkg-6.4.3-BETA-bukkit" = _lBGwt5NT;
        "pkg-6.5.0-ALPHA-fabric" = _DHhZIIx3;
        "pkg-6.5.0-BETA-fabric" = _DErjl2jl;
        "pkg-6.5.0-BETA-bukkit" = _ZNlHHVYn;
        "pkg-6.5.1-BETA-bukkit" = _g4FkVfBM;
        "pkg-6.6.0-BETA-fabirc" = _Y1HtnyyS;
        "pkg-6.6.0-BETA-bukkit" = _OiHwKjvN;
        "pkg-6.6.1-BETA-bukkit" = _c88ENMTx;
        "pkg-6.6.2-BETA-bukkit" = _qTnvN5w4;
        "pkg-6.6.2-BETA-fabric" = _L213MXwx;
        "pkg-6.6.3-BETA-bukkit" = _GXo6GGY8;
        "pkg-6.6.3-BETA-fabric" = _wpUboVwk;
        "pkg-6.6.4-BETA-bukkit" = _Fqtr7vgW;
        "pkg-6.6.4-BETA-fabric" = _v9QlDj4w;
        "pkg-6.6.5-BETA-bukkit" = _ZmBl9whx;
        "pkg-6.6.6-BETA-fabric" = _vL7zufzn;
        "pkg-6.6.6-BETA-bukkit" = _Ufl71nST;
        "default" = _Ufl71nST;
    });
