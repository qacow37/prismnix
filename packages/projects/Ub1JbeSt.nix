...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _SIOM1RyW;
        "pkg-1.2.0" = _t6tBuxB3;
        "pkg-1.2.0+mod" = _ueYnKAe4;
        "pkg-1.3.0" = _y0OydG8D;
        "pkg-1.3.0+mod" = _zT37xweR;
        "pkg-1.3.1" = _P5g5c8mK;
        "pkg-1.3.1+mod" = _BpdEhM35;
        "pkg-1.3.2" = _r1PjlpmR;
        "pkg-1.3.2+mod" = _t74tbdnH;
        "pkg-1.3.3" = _1T8V5JZy;
        "pkg-1.3.3+mod" = _GoJ5Vpm4;
        "pkg-1.3.4" = _t42y1Ffb;
        "pkg-1.3.4+mod" = _6krDhzDa;
        "pkg-1.3.5" = _rp1kbs0J;
        "pkg-1.3.5+mod" = _VsWGqeH3;
        "pkg-1.3.6" = _NnhX8L24;
        "pkg-1.3.6+mod" = _ir8lsVYq;
        "pkg-1.3.7" = _5ySLnT8I;
        "pkg-1.3.7+mod" = _vlNgdrTX;
        "pkg-1.3.8" = _uuA2KJrS;
        "pkg-1.3.8+mod" = _JKEkUKGH;
        "pkg-1.3.9" = _WzfSxV1C;
        "pkg-1.3.9+mod" = _K0o5tfZb;
        "pkg-1.3.10" = _20r9FZX0;
        "pkg-1.3.10+mod" = _mY4usEM4;
        "pkg-1.3.11" = _IcQkr1Fg;
        "pkg-1.3.11+mod" = _lLIVtAE6;
        "pkg-1.3.12" = _VpYgR35f;
        "pkg-1.3.12+mod" = _MXMSsrLl;
        "pkg-1.4.0" = _dpTazQh7;
        "pkg-1.4.0+mod" = _drnSaiMo;
        "default" = _drnSaiMo;
    });
