...
let
    ...
    in {
        ...
        "pkg-1.1.2-Fabric" = _YrAI320X;
        "pkg-1.2-Fabric" = _TbJTiE4g;
        "pkg-1.2-Fabric-1.21.7" = _1i5ZL3dH;
        "pkg-1.3-Fabric" = _vXWMoaEh;
        "pkg-1.4-Fabric" = _lLX0TtMp;
        "pkg-1.5-Fabric" = _KW0mjHO6;
        "pkg-1.6-Fabric" = _qEGNFXLo;
