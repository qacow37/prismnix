...
let
    ...
    in {
        ...
        "pkg-1.1.5.0" = _2Es3iBEh;
        "pkg-1.1.6.2" = _ISWbFCoW;
        "pkg-2.0.1.2" = _ih7UbOQd;
        "pkg-2.0.1.3" = _PKx0XIf4;
        "pkg-2.1.3.0" = _jklQgw14;
        "pkg-2.5.0.0" = _qOR0yygs;
        "pkg-3.5.8.0" = _zZMsFRhG;
        "pkg-3.0.0.1" = _hXFpnYbM;
        "pkg-5.1.0.0" = _DvSYerNY;
        "pkg-5.1.1.0" = _gxKDVtJk;
        "pkg-5.1.2.0" = _NTjvaQHu;
        "pkg-2.0.0.0" = _CgsdIvmR;
        "pkg-2.0.1.0" = _S82vw4zs;
        "pkg-2.5.0.3" = _dDhs8sJm;
        "pkg-2.5.2.0" = _KiLnfwmM;
        "pkg-2.5.6.0" = _e4B1ztxh;
        "pkg-2.5.6.1" = _8rhSc24r;
        "pkg-2.5.7.1" = _ZMD3DTir;
        "pkg-2.5.8.0" = _zYcHOZZH;
        "pkg-2.7.0.0" = _xIb746OJ;
        "pkg-2.7.0.1" = _7FEX44Hx;
        "pkg-1.0.1.2" = _vmbJUHEr;
        "pkg-5.1.3.0" = _fe7KzBCQ;
        "pkg-5.2.1.0" = _8wReWiAS;
        "pkg-5.2.3.0" = _l2HlUgdq;
        "pkg-5.3.5.2" = _VRJD0pJM;
        "default" = _VRJD0pJM;
    });
