...
let
    ...
    in {
        ...
        "pkg-3.2+1.17.1" = _BTpT7aum;
        "pkg-3.2+1.18.1" = _dkqyno6h;
        "pkg-4.0+1.17.1" = _890qICJj;
        "pkg-4.0+1.18.1" = _RrVdJDP4;
        "pkg-4.0+1.16.5" = _u6ST2GL1;
        "pkg-4.1+1.16.5" = _Z30KTcQ3;
        "pkg-4.1+1.17.1" = _Dtyd1ApW;
        "pkg-4.1+1.18.1" = _fbBqEMvk;
        "pkg-4.1+1.18.2" = _2hjZAeLP;
        "pkg-4.2+1.16.5" = _zmGGifRN;
        "pkg-4.2+1.17.1" = _7vPT6uE9;
        "pkg-4.2+1.18.1" = _wTt2QdoG;
        "pkg-4.2+1.18.2" = _NYDog2N9;
        "pkg-4.2+1.19.2" = _Qs8ksVlp;
        "pkg-4.2+1.19.3" = _zuup1U04;
        "pkg-4.2.1+1.17.1" = _o9KYofz1;
        "pkg-4.2.1+1.18.x" = _eLfpoavI;
        "pkg-4.2.1+1.19.2" = _8P9wvqiZ;
        "pkg-4.2.1+1.16.5" = _Dlclmmqp;
        "pkg-4.2.2+1.16.5" = _9CM6kHkK;
        "pkg-4.2.2+1.17.1" = _dpDl6kIS;
        "pkg-4.2.2+1.18.x" = _5shsneLM;
        "pkg-4.2.2+1.19.2" = _Dnk1Talm;
        "pkg-4.2-1.19.4" = _YzQoeNNp;
        "pkg-4.2.2+1.19.3" = _mVp5kw7r;
        "pkg-4.2-1.20.1" = _GwlO1x2F;
        "pkg-4.2.2+1.20.1" = _ad8W5YUj;
        "pkg-4.2-1.20.4" = _A67mrCul;
        "pkg-4.2-1.21" = _9bapVUSq;
        "pkg-4.2.1-1.21" = _1xi12dao;
        "pkg-1.21.x-5.1.0+fabric" = _Y1lk0tVL;
        "default" = _Y1lk0tVL;
    });
