...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _CIXFcEdm;
        "pkg-1.0.2" = _iqbViiW3;
        "pkg-1.0.2h" = _6hCXzrQS;
        "pkg-1.0.2h2" = _5qG89Xb0;
        "pkg-1.0.3" = _cfjAcv9n;
        "pkg-1.0.4" = _2bcyK2YE;
        "pkg-1.0.5" = _ayDrs8P4;
        "pkg-1.0.5h" = _kdWT35Pe;
        "pkg-1.0.5h2" = _qiApfZW6;
        "pkg-1.0.5h3" = _j7FzXKxC;
        "pkg-1.0.5h4" = _PuCVz7GZ;
        "pkg-1.0.6" = _ASl0t94A;
        "pkg-1.0.7" = _lIXPnXi9;
        "pkg-1.0.8" = _Ysc71Vzw;
        "pkg-1.0.9" = _BeAehALQ;
        "pkg-1.0.9h1" = _nLAi2R0q;
        "pkg-1.0.9h2" = _JYB7WvEm;
        "pkg-1.0.10" = _k08q9Y4v;
        "pkg-1.0.11" = _LwkNsoAd;
        "pkg-1.0.12" = _lO7paRjC;
        "pkg-1.0.13" = _ZKAHECTG;
        "pkg-1.0.13h1" = _6Ij2vwjV;
        "pkg-1.0.14" = _PhD382kr;
        "pkg-1.0.14h1" = _fffSrLHG;
        "pkg-1.0.15" = _7DpXNV2w;
        "pkg-1.0.15h1" = _etJaeDJR;
        "pkg-1.0.16" = _QLnsKZg3;
        "pkg-1.0.16h1" = _nnup4LC3;
        "pkg-1.0.16h2" = _Qri54cGT;
        "pkg-1.0.17" = _jQVns4xM;
        "pkg-1.0.17h1" = _8V3tL0i1;
        "pkg-1.1.0" = _2zSK2mOY;
        "pkg-1.1.0h1" = _gKcUrlp9;
        "pkg-1.1.1" = _C8dKQuyK;
        "pkg-1.1.1h1" = _b77kdP3D;
        "pkg-1.1.2" = _JcDqM1sf;
        "pkg-1.1.3" = _n0U85dY1;
        "pkg-1.1.3h1" = _Kho8KaHh;
        "pkg-1.1.3h2" = _SFTY0yST;
        "pkg-1.2.0" = _TGXSl2xa;
        "pkg-1.2.1" = _Io2f6tpd;
        "pkg-1.3.0" = _PLsuUrZR;
        "pkg-1.3.1" = _hvNDvMKe;
