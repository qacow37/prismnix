...
let
    ...
    in {
        ...
        "pkg-1.1.6+1.19" = _C9wtu5rg;
        "pkg-1.1.7+1.19" = _6sku8Wk7;
        "pkg-1.1.8+1.19" = _TGrbdRj5;
        "pkg-1.2.0+1.19" = _wj2hikYn;
        "pkg-1.2.1+1.19" = _tKgj0Fno;
        "pkg-1.2.2+1.19" = _iQPaV2TR;
        "pkg-1.2.2+1.19.4" = _Mcqns5Ej;
        "pkg-1.2.2+1.20" = _TcWeahWu;
        "pkg-1.3.0+1.19" = _Et8iJPgP;
        "pkg-1.3.0+1.19.4" = _hJCWSzMY;
        "pkg-1.3.0+1.20" = _Yv5wQlmm;
        "pkg-1.4.0+1.19" = _Xl4ojiTr;
        "pkg-1.4.0+1.19.4" = _iry1QNc2;
        "pkg-1.4.0+1.20" = _8naYt5c8;
        "pkg-1.5.0+1.19" = _8HqGRVe4;
        "pkg-1.5.0+1.19.4" = _Labx6tVJ;
        "pkg-1.5.0+1.20" = _LEYaMAu2;
        "pkg-1.5.1+1.19" = _J4w738Nh;
        "pkg-1.5.1+1.19.4" = _h5XN9suE;
        "pkg-1.5.1+1.20" = _mxOWaVqy;
        "pkg-1.5.2+1.19" = _ovKG7IHm;
        "pkg-1.5.2+1.19.4" = _FEaTld6c;
        "pkg-1.5.2+1.20" = _lJve5dSz;
        "pkg-1.5.3+1.19" = _6BQaWtjB;
        "pkg-1.5.3+1.19.4" = _BmgQbIcu;
        "pkg-1.5.3+1.20" = _C5M5Vpae;
        "pkg-1.5.4+1.19" = _sKs8pmz9;
        "pkg-1.5.4+1.19.4" = _mOQJSg3I;
        "pkg-1.5.4+1.20" = _miuck0wo;
        "pkg-1.5.5+1.19" = _6NjTebX1;
        "pkg-1.5.5+1.19.4" = _3DiXxrtO;
        "pkg-1.5.5+1.20" = _F4tgCAP5;
        "pkg-1.5.6+1.19" = _re1Nozmq;
        "pkg-1.5.7+1.19" = _zwsp23J0;
        "pkg-1.5.7+1.19.4" = _g6MWmURa;
        "pkg-1.5.7+1.20" = _mTXk6PD8;
        "pkg-1.6.0+1.19" = _pOAjVzSU;
        "pkg-1.6.0+1.19.4" = _uf6GOMo4;
        "pkg-1.6.0+1.20" = _g9eRyQqi;
        "pkg-1.6.1+1.19" = _OjdQS2Pj;
        "pkg-1.6.1+1.19.4" = _UAO94oSR;
        "pkg-1.6.1+1.20" = _zFPIV3Oa;
        "pkg-1.6.1+1.18" = _NsNene2z;
        "pkg-1.7.0+1.18" = _jGZtjSd7;
        "pkg-1.7.0+1.19" = _IjgME7aB;
        "pkg-1.7.0+1.20" = _o0ArdjGO;
        "pkg-1.7.0+1.20.4" = _QOdWlcMh;
        "pkg-1.7.1+1.18" = _VIJxcY7Y;
        "pkg-1.7.1+1.19" = _ys3cHBJc;
        "pkg-1.7.1+1.20" = _dQsBu8MP;
        "pkg-1.7.1+1.21" = _bQl5d4QA;
        "default" = _bQl5d4QA;
    });
