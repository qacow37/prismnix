...
let
    ...
    in {
        ...
        "pkg-0.1.0-1.19.2" = _QWqjTMZ2;
        "pkg-0.1.1-1.19.2" = _KBSYL3Zo;
        "pkg-0.1.2-1.19.2" = _Z1VdCAQA;
        "pkg-0.1.3-1.19.2" = _7Z7Qxu31;
        "pkg-0.1.4-1.19.2" = _RvEvJsP5;
        "pkg-0.1.5-1.19.2" = _Sw7GJLCV;
        "pkg-0.1.5b-1.19.2" = _AmW7fN6j;
        "pkg-0.1.5c-1.19.2" = _5FnHeIJ1;
        "pkg-0.1.6-1.19.2" = _B56yZZ5f;
        "pkg-0.1.7-1.19.2" = _voxcAYXK;
        "pkg-0.1.9-1.19.2" = _YeHVIBUn;
        "pkg-0.2.0-1.19.2" = _F3dkeKNU;
        "pkg-0.2.1-1.19.2" = _KXDQ4bjr;
        "pkg-0.2.2-1.19.2" = _McGqTffB;
        "pkg-0.2.3-1.19.2" = _Ai5RWyDi;
        "pkg-0.2.3b-1.19.2" = _SRW4Oi0g;
        "pkg-0.2.4-1.19.2" = _StW6MJzC;
        "pkg-0.2.5-1.19.2" = _UtytOOS4;
        "pkg-0.2.6-1.19.2" = _SPPjzBhe;
        "pkg-0.3.0-1.19.2" = _hNjBdLgA;
        "pkg-0.3.1-1.19.2" = _VjiEsuWX;
        "pkg-0.3.2-1.19.2" = _tUzfuglj;
        "pkg-0.3.3-1.19.2" = _7Z9vdpFn;
        "pkg-0.3.4-1.19.2" = _8W1on78u;
        "pkg-0.4.0-1.19.2" = _pnOfIj0U;
        "default" = _pnOfIj0U;
    });
