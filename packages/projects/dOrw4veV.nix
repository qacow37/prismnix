...
let
    ...
    in {
        ...
        "pkg-1.20.1-5.2.1" = _tsPjjfum;
        "pkg-1.19.2-5.1.3" = _R1ZDfW4M;
        "pkg-1.18.2-V0.19" = _J4re3fm8;
        "pkg-1.20.1-5.3.0" = _KEanmxsN;
        "pkg-1.20.1-5.3.5" = _r5GMDmcd;
        "pkg-1.19.2-5.3.5" = _LGZqcNdF;
        "pkg-1.20.4-5.3.5" = _SBgYoLTY;
        "pkg-1.20.1-5.4.0" = _aYUNAjJ8;
        "pkg-1.19.2-5.3.6" = _40K8NLec;
        "pkg-1.20.1-5.4.1" = _l8F4n9oF;
        "pkg-1.20.1-5.4.2" = _7uvNKC6Y;
        "pkg-1.20.1-5.4.3" = _Wh3dx7xb;
        "pkg-1.18.2-5.4.3" = _RmAfkt5u;
        "pkg-1.18.2-5.4.4" = _qnf5i8rI;
        "pkg-1.18.2-5.4.4-fix" = _kGkXffpt;
        "pkg-1.20.1-5.5.0" = _fctJ3u89;
        "pkg-1.20.1-5.6.0" = _Put6m605;
        "pkg-1.19.2-5.5.0" = _lE9Rxvos;
        "pkg-1.20.1-5.6.5" = _bsGlDUoW;
        "pkg-1.20.1-5.7.0" = _gntQJL1k;
        "pkg-1.20.1-5.7.1" = _iuHnbo6W;
        "pkg-1.19.2-5.6.0" = _EwO488f9;
        "pkg-1.20.1-6.0.0" = _ik6BvOuN;
        "pkg-1.20.1-6.2.2" = _UBza5BNo;
        "pkg-1.20.1-6.3.0" = _54TLhKxj;
        "pkg-1.20.1-6.3.2" = _TGBvMSdK;
        "pkg-1.20.1-6.3.3" = _VTjwTyx2;
        "pkg-1.20.1-6.4.0" = _uycMIypd;
        "pkg-1.20.1-6.4.1" = _y44l2JTY;
        "pkg-1.20.1-6.4.2" = _qzR45mMT;
        "pkg-1.20.1-6.4.3" = _LmvWZLtj;
        "pkg-1.20.1-6.5.0" = _DfWRVZSj;
        "pkg-1.20.1-6.5.1" = _Rekoc5Ln;
        "pkg-1.20.1-6.5.2" = _H5HKP3Lq;
        "pkg-1.20.1-6.5.3" = _1DjdCvpe;
        "pkg-1.20.1-6.5.4" = _n4zNO1Xa;
        "pkg-1.0-NeoForge" = _5s0x3h9O;
        "pkg-1.20.1-6.5.5" = _q03yiexl;
        "pkg-1.1" = _G2ObL2S1;
        "pkg-1.2" = _aS3UEdpJ;
        "pkg-1.3" = _3GaF7pHw;
        "pkg-1.3.1" = _Q1fviPyY;
        "pkg-1.19.2-6.5.5" = _Jx6MCibI;
        "pkg-1.20.1-6.5.6" = _UNCDO5XT;
        "pkg-2.0" = _SVUMdcho;
        "pkg-1.20.1-6.6.0" = _M1RjupX5;
        "pkg-1.20.1-6.7.0" = _mwC9EyAC;
        "pkg-1.20.1-6.7.1" = _K8rN2aqY;
        "pkg-1.20.1-6.7.2" = _nB1UDlr8;
        "pkg-2.0.1" = _CkgZt8lQ;
        "pkg-1.20.1-6.8.0" = _WRdW9j3z;
        "pkg-1.20.1-6.8.1" = _r6roXYOH;
        "pkg-2.1" = _7TkHKGiO;
        "pkg-1.20.1-6.10.0" = _dQff25BM;
        "pkg-1.20.1-6.10.1" = _lbzvUKVZ;
        "pkg-1.20.1-6.10.2" = _qae3TSTg;
        "pkg-1.20.1-6.11-pre" = _vHjGpgIr;
        "pkg-3.1.5" = _qP6qMUht;
        "pkg-3.2.0" = _3AXzy0uT;
        "pkg-1.20.1-7.0.0" = _g8UF15A6;
        "pkg-1.20.1-7.0.1" = _242c6ma1;
        "pkg-1.20.1-7.1.0" = _8ZixAsFC;
        "pkg-1.20.1-7.1.1" = _QGW4meQa;
        "pkg-1.20.1-7.1.2" = _YJR9Bokl;
        "pkg-1.19.2-6.5.6" = _1gMmqZCz;
        "pkg-1.20.1-7.1.10" = _J6zMqSpR;
        "pkg-1.20.1-7.1.11" = _4vYYQ8EU;
        "pkg-1.20.1-7.1.12" = _Pqgu0Lm6;
        "pkg-1.20.1-7.1.13" = _Ma4z5K2J;
        "pkg-1.20.1-7.2.0" = _gqBP7S1y;
        "pkg-1.20.1-7.2.2" = _HjExzgX5;
        "default" = _HjExzgX5;
    });
