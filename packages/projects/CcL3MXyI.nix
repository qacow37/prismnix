...
let
    ...
    in {
        ...
        "pkg-2.0.0+1.18.2" = _i4Ze2u4M;
        "pkg-2.0.0+1.19" = _AZEsQBAm;
        "pkg-2.1.0+1.18.2" = _i8iWCzNR;
        "pkg-2.1.0+1.19" = _WTnLqrRT;
        "pkg-2.1.1+1.19" = _Zvr6NG1H;
        "pkg-2.1.1+1.18.2" = _QpUNqxvq;
        "pkg-2.2.1+1.19" = _oLoCMXkX;
        "pkg-2.2.1+1.18.2" = _s4tnmimw;
        "pkg-2.2.2+1.18.2" = _z4EqIpiQ;
        "pkg-2.2.2+1.19" = _5I0kr5SW;
        "pkg-2.2.3+1.19.3" = _rLd2XbMr;
        "pkg-2.2.4+1.19.4" = _COVNHcaw;
        "pkg-2.3.0+1.19" = _aZwqUTwe;
        "pkg-2.3.0+1.19.4" = _BjlchVHJ;
        "pkg-2.4.0+1.19" = _QbQfEjMT;
        "pkg-2.4.0+1.19.4" = _MLMJGYth;
        "pkg-2.4.1+1.19" = _1HQKce9w;
        "pkg-2.4.1+1.19.4" = _VsS5kaOS;
        "pkg-2.4.2+1.19" = _JETrq3jk;
        "pkg-2.4.2+1.19.4" = _85IuC3xl;
        "pkg-2.4.3+1.19" = _Jked53Rk;
        "pkg-2.4.3+1.19.4" = _xYLLilb1;
        "pkg-2.5.0+1.20" = _zFTTCwbA;
        "pkg-2.5.1+1.20" = _BDQ2pZvk;
        "pkg-2.5.2+1.20" = _p8uC28Ay;
        "pkg-2.5.2+1.20.2" = _SEfAdtuM;
        "pkg-2.5.2+1.20.4" = _IpALOkuR;
        "pkg-2.5.3+1.21" = _5nJtFxHo;
        "pkg-2.6.0+1.21.3" = _8CkuPbuc;
        "pkg-2.7.0+1.21.4" = _Loya3UdK;
        "pkg-2.7.1+1.21.4" = _cjOS4b23;
        "pkg-2.7.1+1.21.7" = _tEhStDWM;
        "pkg-2.7.2+1.21.7" = _U6SVb2YE;
        "default" = _U6SVb2YE;
    });
