...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.21.6" = _cWISB015;
        "pkg-1.0.1-1.21.1" = _BsqbWAXM;
        "pkg-1.0.1-1.21.4" = _VaC4KZmS;
        "pkg-1.0.1-1.21.5" = _mr0Tv4AI;
        "pkg-1.0.1-1.21.6" = _MXnjTYfB;
        "pkg-1.1.0-1.20.1" = _iY5ioxR1;
        "pkg-1.1.0-1.21.1" = _JMtVcWN6;
        "pkg-1.1.0-1.21.11" = _3HmU0Apw;
        "pkg-1.1.0-26.1.2" = _SrcgdZvH;
        "pkg-1.2.0-1.20.1" = _QJt4Lnh5;
        "pkg-1.2.0-1.21.1" = _8l2VDPll;
        "pkg-1.2.0-1.21.11" = _ynlTQ0A6;
        "pkg-1.2.0-26.1.2" = _F0KUkP8t;
        "pkg-1.2.0-26.2" = _rrhVFKZT;
        "pkg-1.2.1-1.20.1" = _JrMHiMwf;
        "pkg-1.2.1-1.21.1" = _Lpd83qwB;
        "pkg-1.2.1-1.21.11" = _1BBeVo8L;
        "pkg-1.2.1-26.1.2" = _DPEUowCb;
        "pkg-1.2.1-26.2" = _SskQdiM0;
        "pkg-1.3.0-1.20.1" = _GTKLpy03;
        "pkg-1.3.0-1.21.1" = _CnKN7jTd;
