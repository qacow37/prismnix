...
let
    ...
    in {
        ...
        "pkg-1.8-30" = _9dzUZXQQ;
        "pkg-1.7-27" = _K5sGQsIq;
        "pkg-1.0-1" = _NOwFHZBU;
        "pkg-1.1-3" = _CRsUvHlD;
        "pkg-1.2-9" = _GbjKbBJs;
        "pkg-1.3-12" = _hLYqiJr1;
        "pkg-1.4-13" = _Y1fEpzHw;
        "pkg-1.4-17" = _Iysnk6U1;
        "pkg-1.5-19" = _szmnv7cu;
        "pkg-1.6-22" = _mpu3wdtD;
        "pkg-1.8-31-forge" = _ic0YpYAA;
        "pkg-1.8-31-fabric" = _WDD8kQ7l;
        "pkg-1.19-32-forge" = _Gcy912fG;
        "pkg-1.19-32-fabric" = _aRpXjrn4;
        "pkg-1.19.3-33-fabric" = _TaKWCZwe;
        "pkg-1.19.3-33-forge" = _tIvVeDtU;
        "pkg-1.19.4-34-forge" = _hlyfz7o1;
        "pkg-1.19.4-34-fabric" = _M0SMQVo7;
        "pkg-1.20-35-fabric" = _rQU2ZCZX;
        "pkg-1.20-35-forge" = _8pwOuctj;
        "pkg-1.21-36-fabric" = _YhVRZabX;
        "pkg-1.21-36-neoforge" = _JfZHcYju;
        "pkg-1.20.1-37-fabric" = _7UPDuITt;
        "pkg-1.20.1-37-forge" = _FrjOZVxL;
        "pkg-1.21-38-fabric" = _g9vrCgDV;
        "pkg-1.21-38-neoforge" = _AGpD9WkV;
        "pkg-1.21-39-fabric" = _i4sG5Si1;
        "pkg-1.21-39-neoforge" = _VXOfoDuU;
        "pkg-1.21-40-fabric" = _aCuUOT50;
        "pkg-1.21-40-neoforge" = _nH3LWEc0;
        "pkg-1.20.1-41-fabric" = _lA2qbY0w;
        "pkg-1.20.1-41-forge" = _7lL1qFg0;
        "pkg-1.21.4-42-fabric" = _tsl0D0VL;
        "pkg-1.21.4-42-neoforge" = _rJ7Vz78o;
        "pkg-1.21.4-43-fabric" = _CInV7039;
        "pkg-1.21.4-43-neoforge" = _PBKWAp4Y;
        "pkg-1.21.5-44-fabric" = _dpPMBSVE;
        "pkg-1.21.5-44-neoforge" = _HR1gPVye;
        "pkg-1.21.6-45-fabric" = _Iw1GDlYQ;
        "pkg-1.21.6-45-neoforge" = _AriA9RNC;
        "pkg-1.21.1-47-fabric" = _cfkYj9oW;
        "pkg-1.21.1-47-neoforge" = _kALoScYM;
        "pkg-26.1.2-48-fabric" = _d4a7CLUH;
        "pkg-26.1.2-48-neoforge" = _rGejqbK8;
        "pkg-26.2-49-fabric" = _p2EHScB1;
        "pkg-26.2-49-neoforge" = _CkkOCs91;
        "default" = _CkkOCs91;
    });
