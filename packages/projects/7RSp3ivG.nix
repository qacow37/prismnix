...
let
    ...
    in {
        ...
        "pkg-v.1.0.1" = _hkoUvRpu;
        "pkg-v.1.1.1" = _2z7Bjnlx;
        "pkg-v.1.3.0" = _yCaZOyuj;
        "pkg-v.1.4.0" = _duCN41bh;
        "pkg-v.1.4.1" = _3KDlilX7;
        "pkg-v.1.4.2" = _epty73lz;
        "pkg-v.1.4.2-fabric" = _3g3ovcRP;
        "pkg-v.1.4.2a" = _8O3sBf5s;
        "pkg-v.1.4.3" = _5Vj32Zx9;
        "pkg-1.4.3" = _3aYfcDu6;
        "pkg-v.1.5.0" = _zXm6bpBa;
        "pkg-1.5.0" = _3Up1nwYV;
        "pkg-v.1.5.1" = _agEoB1wW;
        "pkg-v.1.5.2-fabric" = _L7SGSyIW;
        "pkg-v.1.5.2" = _PLsi306a;
        "pkg-v.1.5.3" = _1IYb9yNc;
        "pkg-v.1.6.0" = _uWRPZR4l;
        "pkg-v.1.6.1" = _q3ynddIl;
        "pkg-v.1.6.1-fabric" = _IZ5HVxAf;
        "pkg-v.1.5.4" = _qe8fxDLS;
        "pkg-v.1.7.0" = _RRQ0J1Wr;
        "pkg-v.1.7.0-fabric" = _PGG3nEos;
        "pkg-v.1.8.0" = _EvSaowni;
        "pkg-v.1.8.1" = _UIiawwq7;
        "pkg-v.1.8.1-fabric" = _qyJqT9wT;
        "pkg-v.1.8.2" = _pfTu6LXU;
        "pkg-v.2.0.0" = _yFFs6bbq;
        "pkg-v.2.1.0" = _6MmWvTiN;
        "pkg-v.2.2.0" = _RPTb7ydK;
        "pkg-v.2.3.0" = _LuVo5rvM;
        "default" = _LuVo5rvM;
    });
