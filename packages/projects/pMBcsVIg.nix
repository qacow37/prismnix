...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _9QrnNc5C;
        "pkg-1.4.0" = _rYOrt7xE;
        "pkg-1.4.1+1.21.6+A" = _HGSBU7iD;
        "pkg-1.4.1+1.21.9+A" = _ei1kMFgQ;
        "pkg-1.4.2+1.21.6+A" = _HMfhQe8K;
        "pkg-1.4.2+1.21.9+A" = _tMmd8RF1;
        "pkg-1.4.3+1.21.6+A" = _FmC0wqLO;
        "pkg-1.4.3+1.21.9+A" = _7DcfPnab;
        "pkg-1.4.4+1.21.6+A" = _dfBISojE;
        "pkg-1.4.4+1.21.9+A" = _fGElVniz;
        "pkg-1.4.5+1.21.6+A" = _2QDpltmR;
        "pkg-1.4.5+1.21.9+A" = _fDjLjlVO;
        "pkg-1.4.5+1.21.9+B" = _QzyD3lSO;
        "pkg-1.5.0+1.21.6+A" = _xtBAlEvS;
        "pkg-1.5.0+1.21.9+A" = _iNHQHpwV;
        "pkg-1.5.1+1.21.6+A" = _lIrkE4DS;
        "pkg-1.5.1+1.21.9+A" = _212mtXPP;
        "pkg-1.5.2+1.21.6+A" = _Qr7ULKwL;
        "pkg-1.5.2+1.21.9+A" = _NyIBjWc2;
        "pkg-1.5.2+26.1+A" = _dXFy2Ys4;
        "pkg-1.5.2+26.1+B" = _EE3qcHfg;
        "pkg-1.5.2+26.1+C" = _sHQP4HZT;
        "pkg-1.5.3+1.21.6+A" = _4JJDsDS1;
        "pkg-1.5.3+1.21.9+A" = _Bxvtiw39;
        "pkg-1.5.3+26.1+A" = _2ScPNrBr;
        "pkg-1.5.3+26.2+A" = _CHYrFP5J;
        "default" = _CHYrFP5J;
    });
