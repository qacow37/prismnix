...
let
    ...
    in {
        ...
        "pkg-v1.0.2" = _Hvh7HQRT;
        "pkg-v1.0.2+mod" = _YP511Ped;
        "pkg-1.0.3" = _HCYjmQQv;
        "pkg-1.0.3+mod" = _JxH2Qnjx;
        "pkg-1.0.4" = _JSvedN7B;
        "pkg-1.0.4+mod" = _yeSrkH7h;
        "pkg-1.0.5" = _RRgeyDqH;
        "pkg-1.0.5+mod" = _fDMAntBK;
        "pkg-1.0.6" = _pkZODsvd;
        "pkg-1.0.6+mod" = _RLJcIpH6;
        "pkg-1.0.7" = _Sa0UoKJj;
        "pkg-1.0.7+mod" = _WfBdeojT;
        "pkg-1.0.8" = _PxQbrWom;
        "pkg-1.0.8+mod" = _RttpAb1A;
        "pkg-1.0.9" = _oYUH817z;
        "pkg-1.0.9+mod" = _l3T95cqA;
        "pkg-1.1.0" = _Sbl1Zg6q;
        "pkg-1.1.0+mod" = _TyH521Qx;
        "pkg-1.1.1" = _z9867K7R;
        "pkg-1.1.1+mod" = _veAweWrv;
        "pkg-1.1.2" = _xPBUzxL8;
        "pkg-1.1.2+mod" = _7kpsRKez;
        "pkg-1.1.3" = _M1bT49dk;
        "pkg-1.1.3+mod" = _mNUv3Eih;
        "pkg-1.1.4" = _YNrybtzF;
        "pkg-1.1.4+mod" = _sdVLpnSi;
        "default" = _sdVLpnSi;
    });
