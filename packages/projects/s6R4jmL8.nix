...
let
    ...
    in {
        ...
        "pkg-v21.1.1-1.21.1-NeoForge" = _5T4HbjOc;
        "pkg-v21.7.0-1.21.7-Fabric" = _5sO4oSJ3;
        "pkg-v21.7.0-1.21.7-NeoForge" = _R04NJJVN;
        "pkg-v21.1.2-1.21.1-Fabric" = _1A7nR43V;
        "pkg-v21.1.2-1.21.1-NeoForge" = _f473YQ2e;
        "pkg-v21.1.3-1.21.1-Fabric" = _rDQCLVDA;
        "pkg-v21.1.3-1.21.1-NeoForge" = _wfHip7bI;
        "pkg-v21.8.0-1.21.8-Fabric" = _iwqVoQG5;
        "pkg-v21.8.0-1.21.8-NeoForge" = _8JlWvuBl;
        "pkg-v21.8.1-1.21.8-Fabric" = _qDHEeuWB;
        "pkg-v21.8.1-1.21.8-NeoForge" = _Lfqw6UZA;
        "pkg-21.10.0" = _lwVqxdtJ;
        "pkg-21.9.0" = _7a8AXaFz;
        "pkg-21.11.0" = _aVMhkKYb;
        "pkg-26.1.0" = _b7bcTwr9;
        "pkg-26.1.1" = _7XwmHa3R;
        "pkg-26.1.2" = _Z4TPN8gN;
