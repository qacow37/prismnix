...
let
    ...
    in {
        ...
        "pkg-1.0.5-1.19.2" = _9EQ3yrDk;
        "pkg-1.0.5-1.18.2" = _LTKzQzYg;
        "pkg-1.0.6-1.18.2" = _SF3YNFnA;
        "pkg-2.0.0" = _8zNRhTYe;
        "pkg-2.0.0-fabric-1.20.4" = _CGRLdUOx;
        "pkg-2.0.2-fabric-1.20.1" = _QfVL3dM1;
        "pkg-2.0.2-fabric-1.20.4" = _zXPeDSTH;
        "pkg-2.0.4-fabric-1.20.4" = _kgn7EQTl;
        "pkg-2.0.4-1.20.1" = _vNCJfVhV;
        "pkg-2.0.5-fabric-1.20.4" = _sansHhZf;
        "pkg-2.0.5-1.20.1" = _VJjTwuo1;
        "pkg-2.1.2-1.21.1" = _29o9Ux1E;
        "pkg-2.1.3-1.21.1" = _HfZBY22Y;
        "pkg-2.0.6-1.20.1" = _v49xg4B2;
        "pkg-2.1.1" = _nSpr0196;
        "pkg-2.1.2" = _gCSH5TB9;
        "pkg-2.1.1-1.20.1" = _1lZZLgQg;
        "pkg-2.1.2-fabric-1.20.1" = _oBFBt4aB;
        "pkg-2.1.2-1.20.1" = _LxFRLunU;
        "pkg-2.1.4-1.20.1" = _tbWilJvc;
        "pkg-2.1.4-1.21.1" = _Pdf9uSbh;
        "pkg-2.1.4-neoforge-1.21.1" = _C2C09gSf;
        "pkg-2.1.5-neoforge-1.21.1" = _Pm163nJX;
        "pkg-2.1.4-fabric-1.20" = _4YPsEHSK;
        "pkg-2.1.6-neoforge-1.21.1" = _xUlKuQLJ;
        "pkg-2.1.7-neoforge-1.21" = _3r4j5Xnu;
        "pkg-2.1.8-neoforge-1.21" = _yWcTCBiL;
        "pkg-2.1.5-1.20.1" = _Sds6pNGO;
        "pkg-2.2.0-1.20.1" = _u23wsOlW;
        "pkg-2.4.0-1.20.1" = _epucmkZh;
        "pkg-2.2.2-forge-1.20.1" = _M6PpqGgB;
        "pkg-2.3.0-neoforge-1.21.1" = _ZIK2Nmq2;
        "pkg-2.3.0-forge-1.20.1" = _yIRtDpZe;
        "default" = _yIRtDpZe;
    });
