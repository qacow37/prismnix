...
let
    ...
    in {
        ...
        "pkg-v.2.2.0" = _mPs3NVhG;
        "pkg-v.2.2.0a" = _QTpPJFNl;
        "pkg-v.2.0.0a" = _6MSH2nT1;
        "pkg-v.2.2.1" = _KyNX2HPD;
        "pkg-v.3.0.1" = _gxCVW4XQ;
        "pkg-v.4.0.0-pre1" = _AiYvM6Ii;
        "pkg-v.4.1.0" = _HXS6nVRs;
        "pkg-v.4.1.1" = _QtZRHV82;
        "pkg-v.4.1.2" = _IRtLh3JN;
        "pkg-v.4.2.0" = _IJ5JkPiN;
        "pkg-v.4.2.1" = _7d45RIBt;
        "pkg-4.3.0" = _8Ey7xyWi;
        "pkg-v.5.0.0" = _UnQ0qTiq;
        "pkg-v.5.0.1" = _rwZgnrGE;
        "pkg-v.5.0.2" = _WDARytrl;
        "pkg-v.5.0.3" = _HAfSjp32;
        "pkg-6.0.0" = _xTEbzHxQ;
        "pkg-v.6.0.1" = _4IFNsAFN;
        "pkg-v.6.1.0" = _apahxKZI;
        "pkg-v.6.0.2" = _hfRFN6PR;
        "pkg-v.7.0.0" = _5cOqX7nk;
        "pkg-v.7.1.0" = _mpmKrXVF;
        "pkg-v.8.0.0" = _9kHJSgFe;
        "pkg-v.8.0.1" = _eYOb84cg;
        "default" = _eYOb84cg;
    });
