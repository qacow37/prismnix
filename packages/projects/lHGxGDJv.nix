...
let
    ...
    in {
        ...
        "pkg-1.4.4" = _nCiccJuC;
        "pkg-40.0.0" = _eQlhqAUy;
        "pkg-41.0.0" = _Bu3PIpFx;
        "pkg-41.0.1" = _JuLqGl8J;
        "pkg-43.0.0" = _bYQaE62k;
        "pkg-14.0.0" = _eSJ17K9G;
        "pkg-43.1.0" = _I58SA8Pu;
        "pkg-44.0.0" = _phCCIMbi;
        "pkg-45.0.0" = _O8xOTM0D;
        "pkg-45.1.0" = _iee39PFl;
        "pkg-40.1.0" = _RU7sL1Fi;
        "pkg-43.2.0" = _JrPd0eTp;
        "pkg-46.0.0" = _oW8WXnXn;
        "pkg-46.0.1" = _gPSiS5JX;
        "pkg-47.0.0" = _Nxnc5FrX;
        "pkg-47.0.1" = _PeLqaWRN;
        "pkg-47.1.0" = _uUuIg2oe;
        "pkg-202.0.0" = _AHKov8dX;
        "pkg-204.0.0" = _HNHoV11O;
        "pkg-206.0.0" = _b1vGPpum;
        "pkg-210.0.0" = _zZU2bWwN;
        "pkg-213.0.0" = _VEIvtIlM;
        "pkg-214.0.0" = _H4Ptcetq;
        "pkg-215.0.0" = _D1WciGJj;
        "pkg-218.0.0" = _rlqPkPzp;
        "pkg-21.10.0" = _qfrWtD1m;
        "pkg-21.11.0" = _YFLrwLFs;
        "pkg-26.2.1.1" = _U0IqTnQw;
        "pkg-26.2.0.1" = _3TDiBQ15;
        "default" = _3TDiBQ15;
    });
