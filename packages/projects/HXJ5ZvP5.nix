...
let
    ...
    in {
        ...
        "pkg-1.1.1_1.21.6+1.21.7" = _oGTmTYgo;
        "pkg-2.0.0_1.21.6+1.21.7" = _mvMbbjZr;
        "pkg-2.1.0_1.21.6+1.21.8" = _NNJuERkr;
        "pkg-2.2.0_1.21.6+1.21.8" = _5RX8fcrm;
        "pkg-2.2.0_1.21.9+1.21.10" = _rZccufC8;
