...
let
    ...
    in {
        ...
        "pkg-0.2.6" = _QLIUGQ59;
        "pkg-0.3.6" = _soUbTiKc;
        "pkg-0.3.6+1.21.7" = _P2ufpXDp;
        "pkg-0.3.6+1.21.8" = _VSpGARur;
        "pkg-0.4.0" = _Aiw9bhcv;
        "pkg-0.4.0+1.20.1" = _OjzsFZXS;
        "pkg-0.4.0+1.21.8" = _9c2J1uuQ;
        "pkg-0.5.0+1.21.10" = _AHHIy0J7;
        "pkg-0.6.0+1.21.11" = _Zwetgkel;
        "pkg-0.6.0+26.1" = _Lb0UExPs;
        "pkg-0.6.1+26.1" = _OjeGPls4;
        "pkg-0.7.0+26.1" = _YKiIwz8F;
        "pkg-0.8.0+26.1" = _QD9d2GO5;
