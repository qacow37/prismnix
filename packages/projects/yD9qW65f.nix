...
let
    ...
    in {
        ...
        "pkg-1.18.2-v1.2.4" = _PFcsyk72;
        "pkg-1.19.2-v1.2.4" = _fD9ijpCU;
        "pkg-1.20.1-v1.2.4" = _XGu1jknC;
        "pkg-1.20.1-1.2.5" = _2Lih5fsH;
        "pkg-1.19.2-1.2.5" = _HlQMDcqP;
        "pkg-1.18.2-1.2.5" = _RvvVEad5;
        "pkg-1.20.4-1.2.5" = _Ix4GutUZ;
        "pkg-1.20.1-v1.2.7" = _SnZm6sY8;
        "pkg-1.19.2-v1.2.7" = _vl7EgGPN;
        "pkg-1.18.2-v1.2.7" = _FSqdb7u0;
        "pkg-1.20.4-v1.2.7" = _y1jcpGld;
        "pkg-1.20.1-v1.2.9" = _tjwfH5vc;
        "pkg-1.20.1-v1.2.10" = _XUeK7k16;
        "pkg-1.19.2-v1.2.10" = _t7UvqLdR;
        "pkg-1.18.2-v1.2.10" = _r64q5tY3;
        "pkg-1.20.1-v1.2.11" = _lqpzkKVi;
        "pkg-1.20.1-v1.2.12" = _NvLxgTXE;
        "pkg-1.19.2-v1.2.11" = _gMFaUbCN;
        "pkg-1.18.2-v1.2.11" = _xNWcxp2L;
        "pkg-1.19.2-v1.2.12" = _tuitXpp1;
        "pkg-1.18.2-v1.2.12" = _rYSKoXBv;
        "pkg-1.19.2-v1.2.13" = _zVZCuuph;
        "pkg-1.18.2-v1.2.13" = _Z5UDP0QB;
        "pkg-1.20.1-v1.2.13" = _KEd4eJfk;
        "pkg-1.18.2-v1.2.14" = _be92eXs9;
        "pkg-1.20.1-FORGE-1.5.0" = _8cnn9uOM;
        "pkg-FORGE-mc1.20.1-v1.5.2" = _kIP9iyZi;
        "pkg-FORGE-mc1.20.1-v1.5.3" = _q4AdLHoN;
        "pkg-FORGE-mc1.20.1-v1.5.4" = _K7J0jN4z;
        "pkg-FORGE-mc1.20.1-v1.5.5" = _Gv1UvVFn;
        "pkg-FORGE-mc1.20.1-v1.6.0" = _CJi9n2jZ;
        "pkg-NEOFORGE-mc1.21.1-v1.6.0" = _D547zuUV;
        "pkg-NEOFORGE-mc1.21.1-v1.6.0a" = _V9ra5T8b;
        "pkg-FORGE-mc1.20.1-v1.7.0" = _5m5UbhCs;
        "pkg-FORGE-mc1.20.1-v1.7.1" = _ZFXV7x3Y;
        "pkg-FORGE-mc1.20.1-v1.7.2" = _mhoiaJiH;
        "pkg-NEOFORGE-mc1.21.1-v1.7.2" = _nPvLHMwb;
        "pkg-FORGE-mc1.20.1-v1.7.3" = _sKGg79do;
        "pkg-NEOFORGE-mc1.21.1-v1.7.3" = _NBg7dz24;
        "pkg-FORGE-mc1.20.1-v1.7.4" = _A7OldCaG;
        "pkg-NEOFORGE-mc1.21.1-v1.7.4" = _L8MyP8qI;
        "pkg-FORGE-mc1.20.1-v1.7.5" = _sKb384Nw;
        "pkg-NEOFORGE-mc1.21.1-v1.7.5" = _4FqE7c3A;
        "pkg-FORGE-mc1.20.1-v1.7.6" = _7Ki1UUdx;
        "pkg-NEOFORGE-mc1.21.1-v1.7.6" = _WosagIoG;
        "pkg-FORGE-mc1.20.1-v1.7.7" = _6L0cXWbx;
        "pkg-NEOFORGE-mc1.21.1-v1.7.7" = _2KyOjXqM;
        "pkg-NEOFORGE-mc1.21.5-v1.7.7" = _d3Cy8lQl;
        "pkg-NEOFORGE-mc1.21.1-v1.7.8" = _wHVcHnEW;
        "pkg-NEOFORGE-mc1.21.5-v1.7.8" = _iHj6iInH;
        "pkg-NEOFORGE-mc1.21.1-v1.7.9" = _QsBt57ho;
        "pkg-1.8.0-NEO-1.21.1" = _JFeHgS8l;
        "pkg-1.8.1-NEO-1.21.1" = _IgWRdE2d;
        "pkg-1.8.1-FABRIC-1.21.1" = _TVCIPnHn;
        "pkg-1.8.1-FORGE-1.20.1" = _UDrXQjce;
        "pkg-1.8.1-NEO-1.21.11" = _6vH8mNUg;
        "pkg-1.8.1-FABRIC-1.21.11" = _rViW2Ciw;
        "pkg-1.8.1-NEO-26.1.2" = _FZpiNt8p;
        "pkg-1.8.1-FABRIC-26.1.2" = _DABSp6lg;
        "pkg-1.8.1-NEO-26.2" = _uagAKV7L;
        "pkg-1.8.1-FABRIC-26.2" = _EaROWwX9;
        "default" = _EaROWwX9;
    });
