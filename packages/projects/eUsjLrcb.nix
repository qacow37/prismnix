...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.1" = _aob4Hr9x;
        "pkg-1.0.1+1.21.1" = _675jJNfA;
        "pkg-1.0.2+1.21.1" = _HE4xycrZ;
        "pkg-1.1.0+sapling" = _LsU9n4ej;
        "pkg-1.1.0+seabreak" = _CZBkeO0M;
        "pkg-1.2.0+seabreak" = _S6l6rDIo;
        "pkg-1.2.1+seabreak" = _icBQUGEU;
        "pkg-1.2.2+seabreak" = _SxrbavXL;
        "pkg-1.2.2+sapling" = _B0C0oijM;
        "pkg-1.2.3+seabreak" = _2qpgXuRU;
        "pkg-1.2.4+seabreak" = _o9Ws6GXB;
        "pkg-1.2.4+sapling" = _mexGVZ36;
        "pkg-1.2.5+seabreak" = _4N0b2meJ;
        "pkg-1.2.5+sapling" = _rjkf1Yhu;
        "pkg-1.3.0+1.21.1" = _aPcBlsV8;
        "pkg-1.3.1+1.20.6" = _yyRbbJWG;
        "pkg-1.3.1+1.21.1" = _Klc9lhyV;
        "pkg-1.3.1+1.21.3" = _BHoA3250;
        "pkg-1.3.1+1.21.4" = _4K7dWW4x;
        "pkg-1.3.1+1.21.5" = _KzR1iWnF;
        "pkg-1.4.0+1.21.6" = _auQoTyFh;
        "pkg-1.4.0+1.21.7" = _hAZXRbdx;
        "default" = _hAZXRbdx;
    });
