...
let
    ...
    in {
        ...
        "pkg-v21.3.0-1.21.3-Fabric" = _bGTM9IRO;
        "pkg-v21.3.0-1.21.3-NeoForge" = _G0zK0WRV;
        "pkg-v21.4.0-1.21.4-Fabric" = _Qxf0s8Be;
        "pkg-v21.4.0-1.21.4-NeoForge" = _Q9DGEcGo;
        "pkg-v21.5.0-1.21.5-Fabric" = _JYpMkVfa;
        "pkg-v21.5.0-1.21.5-NeoForge" = _TRU9q6LK;
        "pkg-v21.7.0-1.21.7-Fabric" = _WEGQuD80;
        "pkg-v21.7.0-1.21.7-NeoForge" = _ML8ezPhc;
        "pkg-v21.1.1-1.21.1-Fabric" = _NgsoDIiQ;
        "pkg-v21.1.1-1.21.1-NeoForge" = _fUEADMu3;
        "pkg-v21.8.0-1.21.8-Fabric" = _iVnBS7FW;
        "pkg-v21.8.0-1.21.8-NeoForge" = _UB400QFX;
        "pkg-21.9.0" = _sSVI9ffD;
        "pkg-21.10.0" = _6iG8etT3;
        "pkg-v21.1.2-1.21.1-Fabric" = _sedCjUls;
        "pkg-v21.1.2-1.21.1-NeoForge" = _QY0WisAK;
        "pkg-21.10.1" = _Vbjo6e4h;
        "pkg-21.11.0" = _nyrlFXyg;
        "pkg-v21.1.3-1.21.1-Fabric" = _HEL6PToF;
        "pkg-v21.1.3-1.21.1-NeoForge" = _m4LRECSH;
        "pkg-21.11.1" = _rP2pIi6q;
        "pkg-v21.1.4-1.21.1-Fabric" = _K61EOYd0;
        "pkg-v21.1.4-1.21.1-NeoForge" = _FpdaIV35;
        "pkg-26.1.0" = _1XWEYiDS;
