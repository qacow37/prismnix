...
let
    ...
    in {
        ...
        "pkg-2.0.0a2.1" = _ifdiiK5n;
        "pkg-2.0.0a2.2" = _FfCQnlFv;
        "pkg-2.0.0-a2.3" = _MbPllJaI;
        "pkg-2.0.0-a2.3.1" = _Y0MpyQRj;
        "pkg-2.0.0-a2.3.2" = _w3ezhI33;
        "pkg-2.0.0-a2.3.3" = _RNtq70mF;
        "pkg-2.0.0-b1.0" = _Y8u25WPx;
        "pkg-2.0.0-b1.1" = _k16vITNY;
        "pkg-2.0.0-b1.1.1" = _b5XQPKtI;
        "pkg-2.0.0-b1.2" = _dstBXIc6;
        "pkg-2.0.0-b1.2.1" = _glbP2RKV;
        "pkg-2.0.0-b1.3" = _kr52vTkg;
        "pkg-2.0.0-b1.3.1" = _p1cdZ3mX;
        "pkg-2.0.0-b1.3.2" = _nVCiQ22z;
        "pkg-2.0.0-b1.3.3" = _nbT75YQq;
        "pkg-2.0.0-b1.3.4" = _2OL3Ocru;
        "pkg-2.0.0-b1.3.5" = _D8Faff3D;
        "pkg-2.0.0-b1.3.6" = _PVp3yvZq;
        "pkg-2.0.0-b1.4" = _BGd1zSFi;
