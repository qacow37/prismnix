...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20" = _LcshnMwE;
        "pkg-1.0.1+1.20" = _DsMb3X8H;
        "pkg-1.0.2+1.18" = _aDRikxnK;
        "pkg-1.0.2+1.19" = _68PPKAuE;
        "pkg-1.0.2+1.20" = _DL55TMoN;
        "pkg-1.0.3+1.18" = _dMlIhju0;
        "pkg-1.0.3+1.19" = _Gm8Za1ix;
        "pkg-1.0.3+1.20" = _QWO4kQpa;
        "pkg-1.0.4+1.18" = _BHjpJKFE;
        "pkg-1.0.4+1.19" = _OljO6xv5;
        "pkg-1.0.4+1.20" = _BoDn1g2j;
        "pkg-1.0.5+1.18" = _IB2MSLxC;
        "pkg-1.0.5+1.19" = _zbzyLLB4;
        "pkg-1.0.5+1.20" = _JVwFmQtt;
        "pkg-1.1.0+1.18" = _8ddRWSQt;
        "pkg-1.1.0+1.19" = _YIZD0Zqs;
        "pkg-1.1.0+1.20" = _4sCV2PSx;
        "pkg-1.1.1+1.18" = _Y1iN5TCT;
        "pkg-1.1.1+1.19" = _CqW13Nzb;
        "pkg-1.1.1+1.20" = _qOLtroYR;
        "pkg-1.1.3+1.18" = _6e7jeLyW;
        "pkg-1.1.3+1.19" = _JfFhyoOh;
        "pkg-1.1.3+1.20" = _46TT5BXo;
        "pkg-1.1.4+1.20" = _K0zEVjqd;
        "pkg-1.1.5+1.18" = _POEO81R1;
        "pkg-1.1.5+1.19" = _R4apwnTx;
        "pkg-1.1.5+1.20" = _hhBUJ1Cz;
        "pkg-1.1.6+1.18" = _JFYEjfo6;
        "pkg-1.1.6+1.19" = _99zX2buC;
        "pkg-1.1.6+1.20" = _iZwMiUju;
        "pkg-1.1.7+1.18" = _Qv5mefay;
        "pkg-1.1.7+1.19" = _h4MsuRHo;
        "pkg-1.1.7+1.20" = _zP0X3XNU;
        "pkg-1.1.8+1.18" = _rTODa9fm;
        "pkg-1.1.8+1.19" = _ZCgGnFfB;
        "pkg-1.1.8+1.20" = _lMnVgGxn;
        "pkg-1.2.0+1.20" = _8tuNrxis;
        "pkg-1.2.0+1.19" = _TXw5VWXZ;
        "pkg-1.3.0+1.20" = _C4iROPTx;
        "pkg-1.3.1+1.18" = _831vyK6u;
        "pkg-1.3.1+1.19" = _4EdBL67y;
        "pkg-1.3.1+1.20" = _ytAgho7M;
        "pkg-1.3.2+1.18" = _HKCtiQnc;
        "pkg-1.3.2+1.19" = _LkO5D6Rn;
        "pkg-1.3.2+1.20" = _tAIiHefy;
        "pkg-1.3.2+1.21" = _5bXF21DS;
        "pkg-1.3.3+1.18" = _yrXHgB2Y;
        "pkg-1.3.3+1.19" = _sKEsU7V6;
        "pkg-1.3.3+1.20" = _P53YUepR;
        "pkg-1.3.3+1.21" = _hCrHMvxV;
        "pkg-1.4.0+1.18" = _prVyqTxF;
        "pkg-1.4.0+1.19" = _4hwsjEGY;
        "pkg-1.4.0+1.20" = _2FwwwgGV;
        "pkg-1.4.0+1.21" = _kC6I6OEh;
        "pkg-1.4.1+1.20" = _EWsHt15K;
        "pkg-1.4.1+1.21" = _ozZZbuGi;
        "pkg-1.4.2+1.21" = _UJQxusE8;
        "pkg-1.4.3+1.20" = _dqYeBdnP;
        "pkg-1.4.3+1.21" = _bg89rglV;
        "pkg-1.4.4+1.21" = _kH13neOQ;
        "default" = _kH13neOQ;
    });
