...
let
    ...
    in {
        ...
        "pkg-1.17.1-2.0.0" = _EO3N2Ptf;
        "pkg-1.18-2.0.0" = _fwoAmPlu;
        "pkg-1.18.2-2.1.0" = _d9Eh7dtK;
        "pkg-1.16.2-1.4" = _VwpsrMfj;
        "pkg-0.3.0" = _KVclDbHr;
        "pkg-1.19-3.0.0" = _H9uoCDl5;
        "pkg-1.19.1-3.1.0" = _BJnh0unN;
        "pkg-1.19.3-3.1.0" = _51pfz2a9;
        "pkg-1.19.4-3.2.0" = _VCImhMca;
        "pkg-1.20.1-4.0.0" = _EuRreiRT;
        "pkg-1.20.1-4.0.1" = _sTYax4uB;
        "pkg-1.20.1-4.0.2" = _oiLqQEb6;
        "pkg-1.20.1-4.0.3" = _MqbPPsbd;
        "pkg-1.21-5.0.0" = _FkPDkD0H;
        "pkg-1.21.3-5.0.0" = _VLqu4bYg;
        "pkg-1.21.3-5.1.0" = _Qh6FZcxv;
        "pkg-1.21.4-5.2.0" = _yeqLLDb6;
        "pkg-1.21.4-5.2.1" = _QcWbKTJ0;
        "pkg-21.5.0" = _Jci1ORsD;
        "pkg-21.6.0" = _qaqjsL2D;
        "pkg-21.6.1" = _gSJNmw06;
        "pkg-21.11.0" = _BKSSsaOM;
        "pkg-26.1.0" = _8wi4PYQU;
        "pkg-26.1.1" = _1GiWAJaj;
        "pkg-26.2.0" = _NPj2ZKn5;
        "default" = _NPj2ZKn5;
    });
