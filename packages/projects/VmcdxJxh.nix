...
let
    ...
    in {
        ...
        "pkg-v4.0.0-1.19.2-Forge" = _YDH4B7Nk;
        "pkg-v4.0.0-1.19.2-Fabric" = _ci3S4pnp;
        "pkg-v5.0.0-1.19.3-Fabric" = _8Cvz3Gns;
        "pkg-v5.0.0-1.19.3-Forge" = _wF4Rkm0z;
        "pkg-v6.0.0-1.19.4-Fabric" = _7u8cijf9;
        "pkg-v6.0.0-1.19.4-Forge" = _H7xyvHAh;
        "pkg-v7.0.0-1.20-Forge" = _D1UdgdNp;
        "pkg-v7.0.0-1.20-Fabric" = _6vJRaIuz;
        "pkg-v8.0.0-1.20.1-Forge" = _mTW7OMMj;
        "pkg-v8.0.0-1.20.1-Fabric" = _S5jvxCWn;
        "pkg-v20.4.0-1.20.4-Fabric" = _aJjpHo8d;
        "pkg-v20.4.0-1.20.4-Forge" = _LOBVBxCz;
        "pkg-v20.4.0-1.20.4-NeoForge" = _dUyzKBv2;
        "pkg-v20.4.1-1.20.4-Fabric" = _Gm34rhwS;
        "pkg-v20.4.1-1.20.4-Forge" = _c0yihBCW;
        "pkg-v20.4.1-1.20.4-NeoForge" = _k29oFUzq;
        "pkg-v21.1.0-1.21.1-Fabric" = _7CbAiUp3;
        "pkg-v21.1.0-1.21.1-NeoForge" = _pFAxqKSr;
        "pkg-v21.3.0-1.21.3-Fabric" = _brWz80TV;
        "pkg-v21.3.0-1.21.3-NeoForge" = _Q5q5g9iE;
        "pkg-v21.4.0-1.21.4-Fabric" = _oKbELO6g;
        "pkg-v21.4.0-1.21.4-NeoForge" = _8fY1DWUE;
        "pkg-v21.5.0-1.21.5-Fabric" = _mgwhJ4cV;
        "pkg-v21.5.0-1.21.5-NeoForge" = _UcAXKQJN;
        "default" = _UcAXKQJN;
    });
