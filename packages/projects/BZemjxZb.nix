...
let
    ...
    in {
        ...
        "pkg-fabric+3.1.0" = _BVyYsu8W;
        "pkg-forge+3.1.0" = _ahCvCAS4;
        "pkg-kubejsadditions-fabric-3.1.1" = _KcExGVS0;
        "pkg-kubejsadditions-forge-3.1.1" = _8VjhC6Hh;
        "pkg-kubejsadditions-fabric-4.0.0" = _Aef6e7s1;
        "pkg-kubejsadditions-forge-4.0.0" = _A8TYIKm7;
        "pkg-kubejsadditions-fabric-3.2.0" = _7oJ0N45o;
        "pkg-kubejsadditions-forge-3.2.0" = _GFzbL8UY;
        "pkg-kubejsadditions-fabric-2.2.4" = _PNEKbGpq;
        "pkg-kubejsadditions-forge-2.2.4" = _bf2ueeHR;
        "pkg-kubejsadditions-fabric-4.0.1" = _WtvOe5M2;
        "pkg-kubejsadditions-forge-4.0.1" = _Gy1HpL0n;
        "pkg-kubejsadditions-fabric-3.2.1" = _c1rzzAZJ;
        "pkg-kubejsadditions-forge-3.2.1" = _YnBeipmE;
        "pkg-kubejsadditions-fabric-3.2.2" = _vhcg2tUh;
        "pkg-kubejsadditions-forge-3.2.2" = _Red8hzqq;
        "pkg-kubejsadditions-fabric-4.0.2" = _JnFkPXyk;
        "pkg-kubejsadditions-forge-4.0.2" = _vxmgUfCo;
        "pkg-kubejsadditions-fabric-4.1.0" = _4JDDIqGS;
        "pkg-kubejsadditions-forge-4.1.0" = _u9FKNiTK;
        "pkg-kubejsadditions-fabric-4.2.0" = _pNo5FnBQ;
        "pkg-kubejsadditions-forge-4.2.0" = _nXEbhtZp;
        "pkg-kubejsadditions-fabric-4.3.0" = _uG930BAd;
        "pkg-kubejsadditions-forge-4.3.0" = _FqQD7IFz;
        "pkg-kubejsadditions-fabric-4.3.1" = _3jFNBsSH;
        "pkg-kubejsadditions-forge-4.3.1" = _T4yldDwj;
        "pkg-kubejsadditions-fabric-4.3.2" = _7f4UTGHH;
        "pkg-kubejsadditions-forge-4.3.2" = _rCurWfsx;
        "pkg-kubejsadditions-fabric-4.3.3" = _WmkiAFFH;
        "pkg-kubejsadditions-forge-4.3.3" = _peAxAwpF;
        "pkg-kubejsadditions-fabric-3.2.3" = _REwdqj8q;
        "pkg-kubejsadditions-forge-3.2.3" = _VTosEGuN;
        "pkg-kubejsadditions-fabric-4.3.4" = _SlqE1dii;
        "pkg-kubejsadditions-forge-4.3.4" = _6D8WV9Cf;
        "pkg-kubejsadditions-neoforge-6.0.0" = _EK0wJfqY;
        "default" = _EK0wJfqY;
    });
