...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.20.4" = _dHIcrk6b;
        "pkg-1.2.0+1.20.1" = _fqN8RQow;
        "pkg-1.2.0+1.20.4" = _LYebiLXX;
        "pkg-1.2.1+1.20.1" = _ste0tIjc;
        "pkg-1.2.1+1.20.4" = _si7dmBsx;
        "pkg-1.2.2+1.20.6-beta.1" = _A1Njn4T5;
        "pkg-1.2.2+1.20.6" = _xvtZGONB;
        "pkg-1.2.2+1.21" = _4QztjbAL;
        "pkg-1.3.0+1.20.1" = _QO445VyY;
        "pkg-1.3.0+1.20.6" = _7ampEUaW;
        "pkg-1.3.0+1.21" = _jmv9C89R;
        "pkg-1.3.1+1.21" = _avvjJDpZ;
        "pkg-1.3.1+1.20.6" = _pVzWE34Y;
        "pkg-1.3.2+1.21.1" = _Rsvucpm8;
        "pkg-1.3.3+1.21.3-beta.1" = _5PakR6oI;
        "pkg-1.3.3+1.21.3" = _WRi6xm8e;
        "pkg-1.3.3+1.21.4-beta.1" = _rt2BIDC7;
        "pkg-1.3.3+1.21.4" = _uWOn7dwe;
        "pkg-1.3.3+1.21.5" = _zsM3qIe6;
        "pkg-1.3.3+1.21.7" = _2LKGLtUD;
        "pkg-1.3.3+1.21.8" = _xdFnZomM;
        "pkg-1.3.0+1.20.4" = _RIGR1zre;
        "pkg-1.3.3+1.21.9" = _vK10fQO4;
        "pkg-1.3.3+1.21.10" = _8CtwZLKu;
        "pkg-1.3.3+1.21.11" = _PXV2M9B6;
        "pkg-1.3.4+1.21.11" = _AkM1HTyx;
        "pkg-1.3.5+1.21.11" = _gD7EPe9v;
        "pkg-1.3.6+1.21.11" = _LsBthK7b;
