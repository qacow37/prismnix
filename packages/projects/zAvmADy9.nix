...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.4" = _1MrXvlkA;
        "pkg-1.0.0+1.21.5" = _5fxfyOsH;
        "pkg-1.0.1+1.21.5" = _ly1Mccmm;
        "pkg-1.0.1+1.21.4" = _QEXk6bZq;
        "pkg-2.0.1+1.21.5" = _9JecRw5D;
        "pkg-2.1.1+1.21.5" = _maRKxcp2;
        "pkg-2.2.1+1.21.5" = _9491OESJ;
        "pkg-2.2.2+1.21.5" = _NtiPIcMA;
        "pkg-2.3.2+1.21.5" = _hAsYAkbA;
        "pkg-2.3.2+1.21.4" = _v8pJMfEl;
        "pkg-2.4.2+1.21.4" = _4XXUJZ6i;
        "pkg-2.4.2+1.21.5" = _R86R008n;
        "pkg-2.4.3+1.21.5" = _E1zMIhYz;
        "pkg-2.4.3+1.21.4" = _Bw6r5JTn;
        "pkg-2.5.3+1.21.5" = _vEbhTY1q;
        "pkg-2.5.3+1.21.4" = _amBV1Ly9;
        "pkg-2.6.0+1.21.4" = _xjiokKT9;
        "pkg-2.6.0+1.21.5" = _vuVuwe1v;
        "pkg-3.0.2+1.21.8" = _tKcVf7YY;
        "pkg-2.6.1+1.21.5" = _UbXtgAAH;
        "pkg-3.0.3+1.21.8" = _H9fCXxYn;
        "pkg-4.0.0+1.21.8" = _K3kBlJcX;
        "pkg-3.0.2+1.21.4" = _AYflUSFr;
        "pkg-3.0.2+1.21.5" = _AAdO6jP8;
        "pkg-4.0.2+1.21.8" = _McOheSry;
        "pkg-4.0.3+1.21.8" = _imnubK1r;
        "pkg-4.0.4+1.21.8" = _p3NuGKuK;
        "pkg-4.0.5+1.21.8" = _2Wds3IoM;
        "pkg-4.0.6+1.21.8" = _KJGUyRZT;
        "pkg-5.0.0+1.21.10" = _gFBlIiC3;
        "pkg-5.0.1+1.21.10" = _Lihd18PV;
        "pkg-4.0.7+1.21.8" = _dIMMAAQI;
        "pkg-4.0.8+1.21.8" = _vCg6vWtZ;
        "pkg-5.0.2+1.21.10" = _OOYzxZud;
        "pkg-5.1.0+1.21.10" = _4DsxTCAU;
        "pkg-4.1.0+1.21.8" = _TDz1WVIZ;
        "pkg-5.2.0+1.21.10" = _OruPXPo8;
        "pkg-6.0.0+1.21.11" = _HIwRBhEr;
        "pkg-6.1.0+1.21.11" = _JLQu5zqi;
        "pkg-7.0.0+26.1" = _sHB8lPRF;
        "pkg-8.0.0+26.1.2" = _q8cudQ66;
        "default" = _q8cudQ66;
    });
