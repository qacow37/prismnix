...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19.3" = _jludrP7s;
        "pkg-1.0.0+1.19.4" = _m43kS07K;
        "pkg-1.0.0+1.20.1" = _zXL5mxI3;
        "pkg-1.0.0+1.20.2" = _fXCg9GaB;
        "pkg-1.0.0+1.20.4" = _PdoJM0mW;
        "pkg-1.0.0+1.20.6" = _Wx8YStDz;
        "pkg-1.1.0+1.17.1" = _WtZDrvZF;
        "pkg-1.1.0+1.18.2" = _uB2qxHLy;
        "pkg-1.1.0+1.19.2" = _AbkLjZ0Y;
        "pkg-1.1.0+1.19.3" = _kvNI92KB;
        "pkg-1.1.0+1.19.4" = _lg3iRMVc;
        "pkg-1.1.0+1.20.1" = _Mip8ifjw;
        "pkg-1.1.0+1.20.2" = _AmhlRO6x;
        "pkg-1.1.0+1.20.4" = _9LbDtZqp;
        "pkg-1.1.0+1.20.6" = _A3W7Z5SG;
        "pkg-1.1.0+1.21" = _2iYvhmJj;
        "pkg-1.2.0+1.17.1" = _IfrTT7U2;
        "pkg-1.2.0+1.18.2" = _1Y4DOCv3;
        "pkg-1.2.0+1.19.2" = _cW3mAbSv;
        "pkg-1.2.0+1.19.3" = _SRvymgxf;
        "pkg-1.2.0+1.19.4" = _dcgyjAnx;
        "pkg-1.2.0+1.20.1" = _i4YLo3yS;
        "pkg-1.2.0+1.20.2" = _tkjBao2O;
        "pkg-1.2.0+1.20.4" = _2d11uzMY;
        "pkg-1.2.0+1.20.6" = _UqGTmQHs;
        "pkg-1.2.0+1.21.1" = _npBx9JPe;
        "pkg-1.3.0+1.17.1" = _EdG3dqzn;
        "pkg-1.3.0+1.18.2" = _n5nwqWSB;
        "pkg-1.3.0+1.19.2" = _78R0FVx6;
        "pkg-1.3.0+1.19.3" = _7bRfuWAh;
        "pkg-1.3.0+1.19.4" = _CV4ocYoZ;
        "pkg-1.3.0+1.20.1" = _fON75Dne;
        "pkg-1.3.0+1.20.2" = _madAsAcF;
        "pkg-1.3.0+1.20.4" = _JR8uv1VK;
        "pkg-1.3.0+1.20.6" = _hsoXFTJ3;
        "pkg-1.3.0+1.21.1" = _oRhyXNDS;
        "pkg-1.3.0+1.21.3" = _wf9ypujk;
        "pkg-1.4.0" = _t2LpoHuE;
        "pkg-1.5.0" = _T3VUWZVw;
        "pkg-1.5.1" = _CsTLgxfp;
        "pkg-1.5.2" = _t2s7FBTg;
