...
let
    ...
    in {
        ...
        "pkg-3.0.0" = _pz5DRFUD;
        "pkg-3.0.1" = _wRzT4tjg;
        "pkg-1.16.5-3.0.2" = _ajsdW4u6;
        "pkg-1.16.5-3.0.3" = _1Knloh3N;
        "pkg-1.16.5-3.0.4" = _gPak4C7O;
        "pkg-1.16.5-3.0.5" = _ll5EJIvH;
        "pkg-1.18-3.0.5" = _zUQpgRHH;
        "pkg-1.19-3.0.5" = _Q6AZvcBF;
        "pkg-1.19-3.0.6" = _3i26Ec7j;
        "pkg-1.16-3.0.6" = _HDR4310L;
        "pkg-1.18-3.0.6" = _8Udp7pHw;
        "pkg-1.19-3.0.7" = _p2Gy07CD;
        "pkg-1.18-4.0.0" = _pjUFTBwR;
        "pkg-1.19-4.0.0" = _n7a6j2wK;
        "pkg-4.1.0" = _S3tDdqV9;
        "pkg-1.19-4.1.1" = _s2nMYXNE;
        "pkg-1.18-4.1.1" = _eV4nOSwb;
        "pkg-1.19-4.1.2" = _QkLaxPTP;
        "pkg-1.18-4.1.2" = _4AvlFSFk;
        "pkg-1.18-4.1.3" = _vj8OG4ie;
        "pkg-1.19-4.1.3" = _2ejVOXaS;
        "pkg-1.19.2-4.1.4" = _DAG6dnJS;
        "pkg-4.1.3" = _nS5d6tAJ;
        "default" = _nS5d6tAJ;
    });
