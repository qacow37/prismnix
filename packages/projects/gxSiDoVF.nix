...
let
    ...
    in {
        ...
        "pkg-1.10.2" = _bqpCOeMI;
        "pkg-1.1.2" = _JsVmrCb0;
        "pkg-1.10.3" = _UW0U22qV;
        "pkg-1.1.3" = _21xfNAtP;
        "pkg-1.10.5" = _MBQD4Pb9;
        "pkg-1.1.4" = _3ceDt7Gz;
        "pkg-1.10.6" = _cYT9uodM;
        "pkg-1.1.5" = _klVgdiZD;
        "pkg-1.20.1-1.0" = _HSJNwdJK;
        "pkg-1.1.6" = _bEVaM5Dw;
        "pkg-1.10.7" = _y7dFWdRC;
        "pkg-1.20.1-1.1" = _DML8bFMK;
        "pkg-1.20.2-1.1" = _u4x16k5l;
        "pkg-1.0.14" = _GwVhTpBq;
        "pkg-1.1.7" = _FFUA4WLo;
        "pkg-1.20.1-1.2" = _ir9qP0bw;
        "pkg-1.20.2-1.2" = _mE2cJ83z;
        "pkg-1.9.12" = _ID7WBiMP;
        "pkg-1.10.8" = _43VUuaeJ;
        "pkg-1.20.4-1.2" = _X8O1Ezft;
        "pkg-1.7.20" = _mYpBzYCv;
        "pkg-1.9.13" = _V1quWywY;
        "pkg-1.10.9" = _pUeLPsWD;
        "pkg-1.1.8" = _5FRRltnP;
        "pkg-1.20.1-1.3" = _WdcVOx5X;
        "pkg-1.20.4-1.3" = _5NyoW2k6;
        "pkg-1.21.1-0.1" = _WJ2pmlYH;
        "pkg-1.7.21" = _3iKYTXJl;
        "pkg-1.9.14" = _SIrtJhW6;
        "pkg-1.10.10" = _4Hh0rGgt;
        "pkg-1.1.9" = _nH2Xdwtd;
        "pkg-1.20.1-1.4" = _NxTnFA9F;
        "pkg-1.20.4-1.4" = _5c94No3c;
        "pkg-1.21.1-1.0" = _h1wflNQi;
        "default" = _h1wflNQi;
    });
