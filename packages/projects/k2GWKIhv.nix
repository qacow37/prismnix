...
let
    ...
    in {
        ...
        "pkg-V1.14.6-data" = _3rfmIN5J;
        "pkg-V1.14.7-data" = _i1gNf1xZ;
        "pkg-V1.14.8-data" = _GYSZAcdC;
        "pkg-V1.14.9-data" = _CWOKub9S;
        "pkg-V1.14.10-data" = _IGkoXIR5;
        "pkg-V1.15-data" = _HJjQjy3l;
        "pkg-V1.15.1-data" = _GO6jxlGl;
        "pkg-V1.15.1-mod" = _a9p9oqXx;
        "pkg-V1.16-data" = _DGkCRbqW;
        "pkg-V1.16-mod" = _vUzCxuIC;
        "pkg-V1.16.1-data" = _b5vUL7Lb;
        "pkg-V1.16.1-mod" = _UHEqEpsD;
        "pkg-V1.16.2-data" = _tJhSbn3Y;
        "pkg-V1.16.2-mod" = _1ZAAL1FT;
        "pkg-V1.16.3-data" = _nO8KGdEx;
        "pkg-V1.16.3-mod" = _8rXYrm8z;
        "pkg-V1.16.4-data" = _ASqHx8OC;
        "pkg-V1.16.4-mod" = _wfO1kA2u;
        "pkg-V1.16.5-data" = _Fnp0KuQo;
        "pkg-V1.16.5-mod" = _JlJmdEwO;
        "pkg-V1.17-data" = _REDxftGK;
        "pkg-V1.17-mod" = _FmSOxqnG;
        "pkg-V1.18-data" = _rDw4G8w6;
        "pkg-V1.18-mod" = _pbpNmU0v;
        "pkg-V1.19-data" = _PIQmrhZO;
        "pkg-V1.19-mod" = _Jw1ACF9m;
        "pkg-V1.19.1-data" = _x7L1ZYXi;
        "pkg-V1.19.1-mod" = _RvCyQyCB;
        "pkg-V1.19.2-data" = _SEVzqtOr;
        "pkg-V1.19.2-mod" = _IkNGUmRh;
        "pkg-V1.19.3-data" = _qQEz8otn;
        "pkg-V1.19.3-mod" = _KZxPIsjP;
        "pkg-V1.19.4-data" = _IELbgypg;
        "pkg-V1.19.4-mod" = _RDZkJIoI;
        "pkg-V1.19.5-data" = _gNErTWuW;
        "pkg-V1.19.5-mod" = _3y9kRgLl;
        "pkg-V1.19.6-data" = _v3dQE6UO;
        "pkg-V1.19.6-mod" = _k5lW9Nh1;
        "pkg-V1.19.7-data" = _hBpMwGqI;
        "pkg-V1.19.7-mod" = _Arpp8bbo;
        "pkg-V1.19.8-data" = _UYdtGWKQ;
        "pkg-V1.19.8-mod" = _VCboMj2s;
        "default" = _VCboMj2s;
    });
