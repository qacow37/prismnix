...
let
    ...
    in {
        ...
        "pkg-8.3.1" = _JMytVVLP;
        "pkg-10.0" = _YEbR91eX;
        "pkg-10.8.1" = _44xPHidC;
        "pkg-10.9" = _AMIihjwv;
        "pkg-10.17+1.7.2" = _4skHVyrI;
        "pkg-10.17+1.7.4" = _EhiBivuV;
        "pkg-10.17+1.7.10" = _lZY6Tff5;
        "pkg-10.17+1.8" = _f0xHrLx6;
        "pkg-10.17+15w14a" = _yuVMgN7b;
        "pkg-10.17+1.8.9" = _SUP9ZsLD;
        "pkg-10.17+1.9.4" = _geohkZu0;
        "pkg-10.17+1.10.2" = _ZtQgbure;
        "pkg-10.17+1.11.2" = _X0NtuqIC;
        "pkg-10.17+1.12.2" = _4qQ0ipND;
        "pkg-10.17+1.13.2" = _mCqHYh3I;
        "pkg-10.17+1.14.4" = _BJZgtCXx;
        "pkg-10.17+1.15.2" = _XpOibAj5;
        "pkg-10.17+20w14infinite" = _rWvM9qDQ;
        "pkg-10.17+1.16.1" = _jQc8Hj57;
        "pkg-10.17+1.16.5" = _zWhWhDqW;
        "pkg-10.17+1.17.1" = _Wim4rpax;
        "pkg-10.17+1.18.2" = _BAEdCQER;
        "pkg-10.17+22w13aoneblockatatime" = _Yv71Ze5u;
        "pkg-10.17+1.19.1" = _OE29GeWt;
        "pkg-10.17+1.19.2" = _o49H1YKd;
        "pkg-12.2+1.7.2" = _CEb9wO39;
        "pkg-12.2+1.7.4" = _HsZs9KMg;
        "pkg-12.2+1.7.10" = _DFYLSAd6;
        "pkg-12.2+1.8.9" = _9zimlyic;
        "pkg-12.2+1.8" = _iCo8NVRU;
        "pkg-12.2+1.11.2" = _daBvcY5u;
        "pkg-12.2+15w14a" = _Ae1EgsPw;
        "pkg-12.2+1.10.2" = _qNDwwqEt;
        "pkg-12.2+20w14infinite" = _wq0ED8jB;
        "pkg-12.2+1.17" = _ekeR0D1b;
        "pkg-12.2+1.12.2" = _yQ0ysFfG;
        "pkg-12.2+1.17.1" = _jUxCXuHR;
        "pkg-12.2+1.15.2" = _Ba76qytv;
        "pkg-12.2+1.16.5" = _uqHsDsSE;
        "pkg-12.2+22w13oneblockatatime" = _P5GLDV1H;
        "pkg-12.2+1.19.2" = _pkj6Yd6Q;
        "pkg-12.2+1.13.2" = _o6wdd9Hc;
        "pkg-12.2+1.9.4" = _saJUX0aE;
        "pkg-12.2+1.14.4" = _njrorPST;
        "pkg-12.2+1.18.2" = _YG5bB0na;
        "pkg-12.2+1.16.1" = _tFJU6jcG;
        "pkg-12.2.1+1.7.2" = _f9BuElVJ;
        "pkg-12.2.1+1.8.9" = _pAiZqy3O;
        "pkg-12.2.1+1.10.2" = _JBLlrzkj;
        "pkg-12.2.1+1.7.10" = _sWqPb9UI;
        "pkg-12.2.1+1.7.4" = _J5Gfp9Sw;
        "pkg-12.2.1+1.15.2" = _VBxxQr7S;
        "pkg-12.2.1+1.16.1" = _kNgWkHV0;
        "pkg-12.2.1+1.16.5" = _unsStOV9;
        "pkg-12.2.1+1.17.1" = _3tO2jDd2;
        "pkg-12.2.1+1.17" = _IWJT1ggu;
        "pkg-12.2.1+20w14infinite" = _15W8qIV0;
        "pkg-12.2.1+15w14a" = _xody4a3H;
        "pkg-12.2.1+1.8" = _Rsedkz5p;
        "pkg-12.2.1+1.12.2" = _FdNQSk0D;
        "pkg-12.2.1+1.11.2" = _HKWn4Jbk;
        "pkg-12.2.1+1.13.2" = _u8iElm99;
        "pkg-12.2.1+1.19.2" = _uKK5Nrse;
        "pkg-12.2.1+1.14.4" = _aJDTLyLO;
        "pkg-12.2.1+1.18.2" = _yzcrQ2GF;
        "pkg-12.2.1+22w13oneblockatatime" = _R2U4W8yk;
        "pkg-12.2.1+1.9.4" = _m39efeIV;
        "pkg-12.3+1.7.4" = _H4XjfSjQ;
        "pkg-12.3+1.7.2" = _4PSMNdvV;
        "pkg-12.3+1.10.2" = _JmEjWwJy;
        "pkg-12.3+1.11.2" = _PgZxbXyo;
        "pkg-12.3+15w14a" = _uKhWbFbZ;
        "pkg-12.3+1.14.4" = _d8yf3qYo;
        "pkg-12.3+1.16.5" = _UH6Pcske;
        "pkg-12.3+1.16.1" = _wccuMmkt;
        "pkg-12.3+1.8" = _BGIMQrtg;
        "pkg-12.3+1.7.10" = _3bHVejga;
        "pkg-12.3+1.17" = _cf32VLbs;
        "pkg-12.3+1.15.2" = _NxqbJvvT;
        "pkg-12.3+1.13.2" = _UWU5kNYN;
        "pkg-12.3+1.9.4" = _nVraARch;
        "pkg-12.3+1.12.2" = _ttjNqQwo;
        "pkg-12.3+1.8.9" = _9Bc7CdND;
        "pkg-12.3+22w13oneblockatatime" = _XKxZ8ZI7;
        "pkg-12.3+20w14infinite" = _eZMDGn3t;
        "pkg-12.3+1.19.2" = _ywhBRWSH;
        "pkg-12.3+1.18.2" = _sPVTwSne;
        "pkg-12.3+1.17.1" = _ZZWV7UAS;
        "pkg-12.4+1.7.10" = _trOKmSZt;
        "pkg-12.4+1.7.4" = _sFJOgbEU;
        "pkg-12.4+15w14a" = _bnU2JIrg;
        "pkg-12.4+1.7.2" = _CqqP306m;
        "pkg-12.4+1.10.2" = _HTMqFEQB;
        "pkg-12.4+1.12.2" = _OKjzxBTU;
        "pkg-12.4+20w14infinite" = _iRriWZZm;
        "pkg-12.4+1.16.1" = _TcI050CI;
        "pkg-12.4+1.8" = _y8WWDvis;
        "pkg-12.4+1.8.9" = _m5v1kIlN;
        "pkg-12.4+1.14.4" = _ZaO7Psba;
        "pkg-12.4+1.13.2" = _rDxyVlK9;
        "pkg-12.4+1.15.2" = _hk8ROnQT;
        "pkg-12.4+1.16.5" = _n0tpREc4;
        "pkg-12.4+1.11.2" = _AhVj3pVc;
        "pkg-12.4+1.17.1" = _dTAQajeP;
        "pkg-12.4+1.17" = _XOY9X7Ro;
        "pkg-12.4+1.18.2" = _g0a3uJAX;
        "pkg-12.4+1.19.2" = _7aQikfuH;
        "pkg-12.4+1.9.4" = _1pC8lWav;
        "pkg-12.4+22w13oneblockatatime" = _1AVEovW4;
        "pkg-12.4.1+1.11.2" = _Z5qOdtTX;
        "pkg-12.4.1+1.8" = _ByQ7uDg1;
        "pkg-12.4.1+1.7.2" = _EOleyoj0;
        "pkg-12.4.1+1.7.4" = _C8sQK8cv;
        "pkg-12.4.1+1.10.2" = _7TmuPvpG;
        "pkg-12.4.1+1.7.10" = _rTVLm5kC;
        "pkg-12.4.1+1.16.5" = _Zk6my2UQ;
        "pkg-12.4.1+1.15.2" = _JGboc5mA;
        "pkg-12.4.1+1.13.2" = _52GjZOU8;
        "pkg-12.4.1+1.16.1" = _4ciBh7q5;
        "pkg-12.4.1+1.17" = _g7M5IUic;
        "pkg-12.4.1+1.17.1" = _X0uVbKzt;
        "pkg-12.4.1+22w13oneblockatatime" = _w0MvKZXN;
        "pkg-12.4.1+1.18.2" = _XoGfbq6c;
        "pkg-12.4.1+1.14.4" = _TJkRhhM7;
        "pkg-12.4.1+1.8.9" = _Pi9qlTjw;
        "pkg-12.4.1+15w14a" = _QKvlQCdn;
        "pkg-12.4.1+1.12.2" = _tecvVMLD;
        "pkg-12.4.1+20w14infinite" = _et81Di3k;
        "pkg-12.4.1+1.9.4" = _RJDwRcNU;
        "pkg-12.4.1+1.19.2" = _BR8s4Et9;
        "pkg-13.0.1+1.10.2" = _iHg4bMmv;
        "pkg-13.0.1+15w14a" = _9cXguz5I;
        "pkg-13.0.1+1.13.2" = _wzOYk6Nw;
        "pkg-13.0.1+1.16.5" = _5TtS3jVP;
        "pkg-13.0.1+1.8.9" = _AjtrgKYC;
        "pkg-13.0.1+1.17" = _cByHRizY;
        "pkg-13.0.1+22w13oneblockatatime" = _mmt5SOYN;
        "pkg-13.0.1+1.7.2" = _jYQvRQd5;
        "pkg-13.0.1+1.19.2" = _JTgD6bJ2;
        "pkg-13.0.1+1.14.4" = _8M4DZBst;
        "pkg-13.0.1+1.7.10" = _7RNgohBo;
        "pkg-13.0.1+20w14infinite" = _oUMIMIUN;
        "pkg-13.0.1+1.18.2" = _qG1kXeCI;
        "pkg-13.0.1+1.8" = _6t5gaukB;
        "pkg-13.0.1+1.7.4" = _VnSlQWIf;
        "pkg-13.0.1+1.9.4" = _QUx7DsMO;
        "pkg-13.0.1+1.15.2" = _g1ZkcINS;
        "pkg-13.0.1+1.11.2" = _kHZChe7y;
        "pkg-13.0.1+1.17.1" = _uUdyYcyI;
        "pkg-13.0.1+1.12.2" = _Wym4BhoM;
        "pkg-13.0.1+1.16.1" = _8IlYUXgc;
        "pkg-13.0.2+1.7.10" = _P6tJkhD5;
        "pkg-13.0.2+1.7.4" = _N4NxyTPV;
        "pkg-13.0.2+1.10.2" = _z9yW46tb;
        "pkg-13.0.2+1.11.2" = _yHE3rB1x;
        "pkg-13.0.2+1.14.4" = _OFls6CfT;
        "pkg-13.0.2+1.15.2" = _n5FO75up;
        "pkg-13.0.2+15w14a" = _QCrhgDzE;
        "pkg-13.0.2+1.16.1" = _vsfOtQ6z;
        "pkg-13.0.2+1.12.2" = _K2KIcGKG;
        "pkg-13.0.2+1.16.5" = _Xpx7N3Dq;
        "pkg-13.0.2+1.7.2" = _Zkf5jABg;
        "pkg-13.0.2+20w14infinite" = _4aTmj4D0;
        "pkg-13.0.2+1.8" = _wHERqLpY;
        "pkg-13.0.2+1.17" = _b6AI5L1K;
        "pkg-13.0.2+1.8.9" = _G0GrijD3;
        "pkg-13.0.2+1.17.1" = _wPdCzRjq;
        "pkg-13.0.2+1.18.2" = _YmIBxIVS;
        "pkg-13.0.2+22w13oneblockatatime" = _NDlyEZfB;
        "pkg-13.0.2+1.13.2" = _1Ghdi8Aq;
        "pkg-13.0.2+1.9.4" = _ZNb9oR7j;
        "pkg-13.0.2+1.19.2" = _wp9y6bqI;
        "pkg-13.1+1.7.10" = _LXJnkH7h;
        "pkg-13.1+1.8" = _JWloFnBx;
        "pkg-13.1+1.11.2" = _d3RY1AAL;
        "pkg-13.1+1.10.2" = _fXyZQhw7;
        "pkg-13.1+1.7.4" = _XyuU6iYV;
        "pkg-13.1+1.8.9" = _4FTTQwrW;
        "pkg-13.1+1.12.2" = _CFeroHrv;
        "pkg-13.1+1.13.2" = _6H3iierY;
        "pkg-13.1+1.15.2" = _6n3tKK4x;
        "pkg-13.1+20w14infinite" = _XacErSdV;
        "pkg-13.1+1.17" = _AWrDgP93;
        "pkg-13.1+1.18.2" = _lPvfRaRn;
        "pkg-13.1+1.7.2" = _6eRbwnxr;
        "pkg-13.1+1.19.2" = _Y5uay20b;
        "pkg-13.1+15w14a" = _CQvFeYbW;
        "pkg-13.1+1.17.1" = _CCuFduTD;
        "pkg-13.1+22w13oneblockatatime" = _5KOcaJDr;
        "pkg-13.1+1.14.4" = _7Py8c8bu;
        "pkg-13.1+1.16.1" = _2wv3skCh;
        "pkg-13.1+1.16.5" = _ofoCmSec;
        "pkg-13.1+1.9.4" = _WFDp4yQD;
        "pkg-13.1+1.19.3" = _RPL8kcpm;
        "pkg-13.2+1.7.4" = _5YST8vk1;
        "pkg-13.2+1.7.2" = _DiLU8xgP;
        "pkg-13.2+1.7.10" = _EgFJmib1;
        "pkg-13.2+1.8.9" = _pdhoPmlm;
        "pkg-13.2+1.10.2" = _TDBSO545;
        "pkg-13.2+15w14a" = _pGlKpwkN;
        "pkg-13.2+1.11.2" = _mBFslUm9;
        "pkg-13.2+1.8" = _lSwIdCSL;
        "pkg-13.2+1.13.2" = _eEXDUSZp;
        "pkg-13.2+1.16.5" = _ccz0UWSe;
        "pkg-13.2+1.16.1" = _9N18AWQq;
        "pkg-13.2+1.14.4" = _qQkU3OPq;
        "pkg-13.2+1.18.2" = _7knCbpcR;
        "pkg-13.2+22w13oneblockatatime" = _4TrT8gYY;
        "pkg-13.2+1.19.3" = _hN102Rb9;
        "pkg-13.2+1.12.2" = _6UCWlqbr;
        "pkg-13.2+1.15.2" = _tksVueuC;
        "pkg-13.2+1.17" = _VDULJlTl;
        "pkg-13.2+20w14infinite" = _lpbh2Grg;
        "pkg-13.2+1.17.1" = _3smF7QPU;
        "pkg-13.2+1.9.4" = _spDwGuF4;
        "pkg-13.3+1.7.4" = _YJpsq1Uj;
        "pkg-13.3+1.7.10" = _2sTFK0Oj;
        "pkg-13.3+1.11.2" = _GhunD0aj;
        "pkg-13.3+1.14.4" = _9NBNHDAh;
        "pkg-13.3+1.8" = _mTyNAN55;
        "pkg-13.3+1.15.2" = _rsPmJric;
        "pkg-13.3+1.16.5" = _XsXpngi5;
        "pkg-13.3+1.16.1" = _ezWoZFV5;
        "pkg-13.3+1.7.2" = _l6kEXYpX;
        "pkg-13.3+1.10.2" = _7if511Si;
        "pkg-13.3+15w14a" = _6fXR7Ygb;
        "pkg-13.3+1.9.4" = _I8iWr2bB;
        "pkg-13.3+1.17.1" = _rDNDn7IL;
        "pkg-13.3+1.13.2" = _Vv388CHz;
        "pkg-13.3+1.12.2" = _KkBf10bp;
        "pkg-13.3+20w14infinite" = _R7tRP53B;
        "pkg-13.3+1.18.2" = _99wsk3bj;
        "pkg-13.3+22w13oneblockatatime" = _rgh7HOXj;
        "pkg-13.3+1.17" = _Tur2MjHP;
        "pkg-13.3+1.8.9" = _nZuxP3qc;
        "pkg-13.3+1.19.3" = _dU40a6dK;
        "pkg-13.3+1.19.4" = _8OSlon61;
        "pkg-13.4+1.7.4" = _ACbNgpGP;
        "pkg-13.4+1.10.2" = _I1xcwX3P;
        "pkg-13.4+1.7.2" = _r35L6NZl;
        "pkg-13.4+1.11.2" = _s79eIXUU;
        "pkg-13.4+1.7.10" = _KuYdDXNd;
        "pkg-13.4+15w14a" = _ylybCd9x;
        "pkg-13.4+1.12.2" = _AL2zVY0b;
        "pkg-13.4+1.14.4" = _KaJYiJDb;
        "pkg-13.4+20w14infinite" = _mqfXtYRg;
        "pkg-13.4+1.15.2" = _H2hQjlto;
        "pkg-13.4+1.16.5" = _c7pps1AB;
        "pkg-13.4+1.13.2" = _yLgqMfnj;
        "pkg-13.4+1.8" = _9Au84lbb;
        "pkg-13.4+1.17.1" = _CH67HIzi;
        "pkg-13.4+1.18.2" = _PYWGbo9n;
        "pkg-13.4+23w13a_or_b" = _FGYxcliJ;
        "pkg-13.4+1.17" = _zkCWwcnM;
        "pkg-13.4+22w13oneblockatatime" = _UFkAzd2J;
        "pkg-13.4+1.19.4" = _OJqahh3n;
        "pkg-13.4+1.8.9" = _L3VqPUQK;
        "pkg-13.4+1.9.4" = _4JhFNGfo;
        "pkg-13.4+1.16.1" = _GnJ219Nj;
        "pkg-13.4.1+1.7.4" = _ZciALRWT;
        "pkg-13.4.1+1.7.2" = _JyMcYPxa;
        "pkg-13.4.1+1.11.2" = _mqgApJSN;
        "pkg-13.4.1+15w14a" = _bY5iRhny;
        "pkg-13.4.1+1.8" = _Jx53qcha;
        "pkg-13.4.1+1.10.2" = _lQI11bSC;
        "pkg-13.4.1+1.12.2" = _aP8htdkM;
        "pkg-13.4.1+1.7.10" = _VZ4NAMei;
        "pkg-13.4.1+1.18.2" = _TTh0zqIC;
        "pkg-13.4.1+1.16.5" = _t2Kq87Z7;
        "pkg-13.4.1+1.14.4" = _TklaZhBl;
        "pkg-13.4.1+1.13.2" = _Hfs27mRs;
        "pkg-13.4.1+1.17" = _a8cOvQnV;
        "pkg-13.4.1+22w13oneblockatatime" = _Bnp9Rlir;
        "pkg-13.4.1+1.17.1" = _Rpyv9cmr;
        "pkg-13.4.1+1.19.4" = _uv2G6LQ4;
        "pkg-13.4.1+20w14infinite" = _4XQ8tAlS;
        "pkg-13.4.1+23w13a_or_b" = _gLwaljXq;
        "pkg-13.4.1+1.15.2" = _tgIThTUy;
        "pkg-13.4.1+1.9.4" = _aOCuJQwh;
        "pkg-13.4.1+1.8.9" = _XVX8Twjk;
        "pkg-13.4.1+1.16.1" = _61DpL2hS;
        "pkg-13.5+1.8" = _zBK15a9G;
        "pkg-13.5+1.7.2" = _TusMVYbS;
        "pkg-13.5+1.11.2" = _rSOoUJKD;
        "pkg-13.5+1.13.2" = _5LomPWK2;
        "pkg-13.5+1.12.2" = _HFxQIYEi;
        "pkg-13.5+1.16.1" = _IJajEw8R;
        "pkg-13.5+20w14infinite" = _lsHGX4yZ;
        "pkg-13.5+1.17" = _MtBnKP1t;
        "pkg-13.5+1.18.2" = _guieDIty;
        "pkg-13.5+22w13oneblockatatime" = _S7B8WBgl;
        "pkg-13.5+1.7.4" = _hXikSY2h;
        "pkg-13.5+1.7.10" = _uYLFL0N2;
        "pkg-13.5+1.15.2" = _eEycQFZu;
        "pkg-13.5+15w14a" = _gtuZFB8X;
        "pkg-13.5+1.16.5" = _oRiiqTKv;
        "pkg-13.5+1.14.4" = _x4URyecH;
        "pkg-13.5+1.19.2" = _Ipo3GiMQ;
        "pkg-13.5+1.17.1" = _fVX2RkZc;
        "pkg-13.5+23w13a_or_b" = _sL9ZYdQC;
        "pkg-13.5+1.19.4" = _wOwg8i6F;
        "pkg-13.5+1.8.9" = _sOh8Itea;
        "pkg-13.5+1.9.4" = _M0BjCs1K;
        "pkg-13.5+1.10.2" = _lthI5zir;
        "pkg-13.6+1.7.4" = _4tTwA1Nk;
        "pkg-13.6+15w14a" = _pWwitCAA;
        "pkg-13.6+1.10.2" = _UKUKjdgz;
        "pkg-13.6+1.7.10" = _SmNjUwvA;
        "pkg-13.6+1.7.2" = _WLTZlLH9;
        "pkg-13.6+1.11.2" = _xcGFUiZO;
        "pkg-13.6+1.8" = _wF2Y5k0r;
        "pkg-13.6+1.13.2" = _AYpaUVnv;
        "pkg-13.6+1.14.4" = _14GSXAH5;
        "pkg-13.6+1.17.1" = _mE4gCbq7;
        "pkg-13.6+1.18.2" = _Ay1Ixxmq;
        "pkg-13.6+1.19.4" = _ahppqu3q;
        "pkg-13.6+1.17" = _S620nLtf;
        "pkg-13.6+22w13oneblockatatime" = _SqESBSVB;
        "pkg-13.6+23w13a_or_b" = _Z9O7HxCo;
        "pkg-13.6+1.12.2" = _Jhn3nb2u;
        "pkg-13.6+1.15.2" = _VVGq6X9W;
        "pkg-13.6+1.16.5" = _PIRw1nuC;
        "pkg-13.6+20w14infinite" = _82d2RnFI;
        "pkg-13.6+1.19.2" = _5JS5JH7j;
        "pkg-13.6+1.9.4" = _6yTMkQpU;
        "pkg-13.6+1.8.9" = _7oa3cgo4;
        "pkg-13.6+1.16.1" = _Dt71AmSX;
        "pkg-13.6+1.20" = _kEEGkXk9;
        "pkg-13.6+1.20.1" = _zZkuSxNV;
        "pkg-13.6+1.20.2" = _RJ3mGDTZ;
        "pkg-13.6+1.20.3" = _czmrPWAc;
        "pkg-13.6+1.20.4" = _uj2vojNb;
        "pkg-14.1-beta.1+1.20.5" = _OonlfpcH;
        "pkg-14.1-beta.2+1.20.5" = _ZnJWGphQ;
        "pkg-14.1-beta.2+1.20.6" = _pBafoOf9;
        "pkg-14.1+1.10.2" = _7Yv0QnHS;
        "pkg-14.1+1.12" = _GLserYk6;
        "pkg-14.1+1.11.2" = _g3flG6R6;
        "pkg-14.1+1.12.2" = _wIy6DrMm;
        "pkg-14.1+1.16.5" = _2FxoGQGw;
        "pkg-14.1+20w14infinite" = _DP5Cb4Ef;
        "pkg-14.1+1.17" = _I7cea3dI;
        "pkg-14.1+1.13.2" = _tP1rIm0G;
        "pkg-14.1+1.18.2" = _v2YokoDA;
        "pkg-14.1+1.17.1" = _zJ9H0T6G;
        "pkg-14.1+1.18.1" = _Fm0siLFb;
        "pkg-14.1+1.20.1" = _ZB0P8PBf;
        "pkg-14.1+1.19.2" = _IYUdH3Pe;
        "pkg-14.1+22w13oneblockatatime" = _2Fox5P9n;
        "pkg-14.1+1.20.4" = _dUhXnBMW;
        "pkg-14.1+24w14potato" = _KasY5v23;
        "pkg-14.1+23w13a_or_b" = _rHCBsBJg;
        "pkg-14.1+1.19.4" = _nXXF7CP6;
        "pkg-14.1+1.4.2" = _tWq4l8Tx;
        "pkg-14.1+1.6.4" = _OWsCmhre;
        "pkg-14.1+1.3.1" = _ssILgF8X;
        "pkg-14.1+1.7.2" = _v5ow4Zns;
        "pkg-14.1+1.4.7" = _uT44krZi;
        "pkg-14.1+1.7.10" = _O68G7JPX;
        "pkg-14.1+1.8" = _kg6H5woa;
        "pkg-14.1+15w14a" = _w3DUJYsp;
        "pkg-14.1+1.5.2" = _Q8sfAfOw;
        "pkg-14.1+1.8.9" = _kTUiS97a;
        "pkg-14.1+1.9.4" = _MLyOqrXS;
        "pkg-14.1+1.7.4" = _ve40WYhr;
        "pkg-14.1+1.16.1" = _JTkvwmfw;
        "pkg-14.1+1.20.6" = _VYGqRk8b;
        "pkg-14.1+1.14.4" = _HjSIfE45;
        "pkg-14.1+1.15.2" = _BofC2mPW;
        "pkg-14.1.1+1.20.6" = _4IBbtqLo;
        "pkg-14.1.1+1.21" = _yF1dGJqu;
        "pkg-14.2+1.11.2" = _Ls5SFUnf;
        "pkg-14.2+1.13.2" = _w1wloRzn;
        "pkg-14.2+1.10.2" = _CLK88Iqg;
        "pkg-14.2+1.17.1" = _CGbPeLgN;
        "pkg-14.2+1.18.1" = _UvrzUgsm;
        "pkg-14.2+1.12.2" = _dZzuqGwe;
        "pkg-14.2+1.20.1" = _ti0VUd3G;
        "pkg-14.2+1.20.4" = _MLjhetqG;
        "pkg-14.2+1.19.4" = _tqpiOyrX;
        "pkg-14.2+1.14.4" = _hdqvbrTA;
        "pkg-14.2+1.12" = _CvCDQr43;
        "pkg-14.2+1.15.2" = _halmSxAG;
        "pkg-14.2+1.16.5" = _FG9j1fHt;
        "pkg-14.2+1.17" = _lS6HW9DM;
        "pkg-14.2+1.18.2" = _BckZs7qb;
        "pkg-14.2+1.19.2" = _DbgqEQ12;
        "pkg-14.2+1.4.2" = _qRKZ6BjH;
        "pkg-14.2+1.8.9" = _FxPgbC03;
        "pkg-14.2+1.8" = _xSUbWT1r;
        "pkg-14.2+1.6.4" = _bYdpbJE2;
        "pkg-14.2+1.4.7" = _kwtZEHzF;
        "pkg-14.2+1.5.2" = _MtPABcoS;
        "pkg-14.2+1.9.4" = _9JRI4V5J;
        "pkg-14.2+1.7.4" = _ppO9MiAf;
        "pkg-14.2+1.7.2" = _JUucPW6x;
        "pkg-14.2+1.7.10" = _OnxTFoaI;
        "pkg-14.2+1.3.1" = _OSkCtSLU;
        "pkg-14.2+1.16.1" = _X2Uz4pYS;
        "pkg-14.2+1.20.6" = _T2VZlKxT;
        "pkg-14.2+1.21" = _WjIHXA7n;
        "pkg-14.2+15w14a" = _Rknn9RLx;
        "pkg-14.2+20w14infinite" = _6ovMEHZR;
        "pkg-14.2+22w13oneblockatatime" = _uEjpLcqc;
        "pkg-14.2+23w13a_or_b" = _sFgbdkDi;
        "pkg-14.2+24w14potato" = _Ozk7HKe5;
        "pkg-14.2+1.21.1" = _4N0MyGyT;
        "pkg-15.0+1.16.1" = _3zsk2F07;
        "pkg-15.1+1.16.1" = _lzqfBKFO;
        "pkg-14.2+1.21.2" = _cDKnT0Fm;
        "pkg-14.2+1.21.3" = _SaoCVBcS;
        "pkg-14.2+1.21.4" = _deCktRsJ;
        "pkg-14.2+1.21.5" = _VKuxr9lP;
        "pkg-14.2+1.21.6" = _8alz9bCM;
        "pkg-14.2+1.21.7" = _YjArA4DC;
        "pkg-14.2+1.21.8" = _jPUP2JUm;
        "pkg-14.2+1.21.9" = _c1XaBHoS;
        "pkg-14.2+1.21.10" = _nUGwRemm;
        "pkg-14.2+1.21.11" = _pRgcKfd4;
        "pkg-14.2+26.1.1-alpha.26.14.a" = _kGokSgpS;
        "pkg-14.2+26.2.x" = _BycaaQor;
        "default" = _BycaaQor;
    });
