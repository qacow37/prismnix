...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19" = _LyExFQKD;
        "pkg-1.0.0+1.19.2" = _7AXPvwzz;
        "pkg-1.0.0+1.19.3" = _fg9sjSB6;
        "pkg-1.0.0+1.19.4" = _xNdOnfPF;
        "pkg-1.0.0+1.20" = _qaC7rMuO;
        "pkg-1.0.0+1.20.1" = _8qaFHDRD;
        "pkg-1.0.0+1.20.2" = _wT7uQjV1;
        "pkg-1.1.0+1.16.5" = _xAZyUYba;
        "pkg-1.1.0+1.17.1" = _pW4w4ar1;
        "pkg-1.1.0+1.18.2" = _MTB4NUzg;
        "pkg-1.1.0+1.19" = _FMM1ah0x;
        "pkg-1.1.0+1.19.2" = _3FhnomVH;
        "pkg-1.1.0+1.19.3" = _daGl2O58;
        "pkg-1.1.0+1.19.4" = _xtFJrOvM;
        "pkg-1.1.0+1.20" = _JTg71UUB;
        "pkg-1.1.0+1.20.1" = _mDdylvll;
        "pkg-1.1.0+1.20.2" = _3HzfbS0A;
        "pkg-1.2.0+1.16.5" = _Vgpn5bQV;
        "pkg-1.2.0+1.17.1" = _Mwgh6ufo;
        "pkg-1.2.0+1.18.2" = _heahG6Nj;
        "pkg-1.2.0+1.19" = _mdqkmXMv;
        "pkg-1.2.0+1.19.2" = _4mJn1Ril;
        "pkg-1.2.0+1.19.3" = _gq7fJAz2;
        "pkg-1.2.0+1.19.4" = _KNUlNlMc;
        "pkg-1.2.0+1.20" = _WKxB0kic;
        "pkg-1.2.0+1.20.1" = _cTUtUncw;
        "pkg-1.2.0+1.20.2" = _YAv3sR20;
        "pkg-1.2.1+1.16.5" = _Gby9g2OI;
        "pkg-1.2.1+1.17.1" = _SPuOzUje;
        "pkg-1.2.1+1.18.2" = _wkcgENhE;
        "pkg-1.2.1+1.19" = _md4OhThK;
        "pkg-1.2.1+1.19.2" = _ojFs0ppA;
        "pkg-1.2.1+1.19.3" = _8iMlM3sm;
        "pkg-1.2.1+1.19.4" = _VykZuEoV;
        "pkg-1.2.1+1.20" = _lRcpelFn;
        "pkg-1.2.1+1.20.1" = _mkAxzG3L;
        "pkg-1.2.1+1.20.2" = _c8a23gxy;
        "pkg-1.2.2+1.16.5" = _WeaPa963;
        "pkg-1.2.2+1.17.1" = _CPZMJ4B9;
        "pkg-1.2.2+1.18.2" = _IW8MIGkS;
        "pkg-1.2.2+1.19" = _hV7w5eGE;
        "pkg-1.2.2+1.19.2" = _xIp4whfY;
        "pkg-1.2.2+1.19.3" = _kpcLNT38;
        "pkg-1.2.2+1.19.4" = _nmx7IXNC;
        "pkg-1.2.2+1.20" = _YK8nJrwA;
        "pkg-1.2.2+1.20.1" = _v6Zv6myb;
        "pkg-1.2.2+1.20.2" = _dXB80wDJ;
        "pkg-1.2.2+1.20.4" = _5HqZXGn6;
        "pkg-1.2.3+1.16.5" = _fyvYcK0h;
        "pkg-1.2.3+1.17.1" = _fuHXr7kh;
        "pkg-1.2.3+1.18.2" = _vkm1JSFW;
        "pkg-1.2.3+1.19" = _CD2Mlhdb;
        "pkg-1.2.3+1.19.2" = _PbzZTc93;
        "pkg-1.2.3+1.19.3" = _IJXlGBLB;
        "pkg-1.2.3+1.19.4" = _NTRBEZ4l;
        "pkg-1.2.3+1.20" = _ixOLRuDi;
        "pkg-1.2.3+1.20.1" = _E7XQPTtX;
        "pkg-1.2.3+1.20.2" = _gFL7oyOS;
        "pkg-1.2.3+1.20.4" = _13SHwHP7;
        "pkg-1.2.4" = _SvnyFadU;
        "pkg-1.3.0" = _GgrNbN8w;
        "pkg-1.3.1" = _eYrABAYp;
        "pkg-1.3.2" = _zHYEtKwE;
        "pkg-1.3.3" = _XCjL3qLG;
        "pkg-1.3.4" = _JxMTyrow;
        "pkg-1.3.4.1" = _YEvDddpV;
        "pkg-2.0.0" = _ituRsZ38;
        "pkg-2.0.1" = _g9wSNfls;
        "pkg-2.0.2" = _ITpO74ZL;
        "pkg-2.0.3" = _E1HHUyKw;
        "pkg-1.3.4.2" = _hDHUPPG4;
        "pkg-2.0.3.1" = _ToWCJJTV;
        "pkg-2.0.3.2" = _4VymLu9m;
        "default" = _4VymLu9m;
    });
