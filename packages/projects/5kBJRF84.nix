...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta" = _aQ4ksXAw;
        "pkg-1.20.1-1.0.1" = _YJB1erdu;
        "pkg-1.20.1-1.0.3" = _JDSMrwYI;
        "pkg-1.20.1-1.1.1" = _7cIKwuk6;
        "pkg-1.19.2-1.1.1" = _2ln4kTuC;
        "pkg-1.20.1-1.2.0" = _umlZx0W4;
        "pkg-1.19.2-1.2.0" = _5ZXcMRAc;
        "pkg-1.19.2-1.2.1" = _kPcMqKWV;
        "pkg-1.19.2-1.2.2" = _VxylitAy;
        "pkg-1.19.2-1.2.3" = _WJ3lcT0r;
        "pkg-1.19.2-1.2.4" = _RFsxciXL;
        "pkg-1.20.1-1.3.0" = _7Nuo9FCE;
        "pkg-1.20.1-1.3.1" = _HUYicsmC;
        "pkg-1.20.1-1.3.2" = _oIH3wLdR;
        "pkg-1.21.1-1.0.0" = _B61KBvEk;
        "pkg-1.20.1-1.3.3" = _JOBXYEqg;
        "pkg-1.20.1-1.3.4" = _MhA9qIBu;
        "pkg-1.21.1-1.0.1" = _Z6abD3Zb;
        "pkg-1.21.1-1.0.2" = _oOAPDaXl;
        "pkg-1.20.1-1.3.5" = _u4uhxNWL;
        "pkg-1.21.1-1.1.0" = _7uKpC6gg;
        "pkg-1.21.1-1.2.0" = _E5dT03Pp;
        "pkg-1.20.1-1.4.0" = _RIJsuEK4;
        "default" = _RIJsuEK4;
    });
