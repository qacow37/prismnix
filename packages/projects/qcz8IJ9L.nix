...
let
    ...
    in {
        ...
        "pkg-0.2.4-1.18.2" = _xDNt7SqU;
        "pkg-0.2.4-1.19.2" = _9P7e0Jg0;
        "pkg-0.2.4-1.19.3" = _Adfk3xZC;
        "pkg-0.2.4-1.19.4" = _iV3KuZp5;
        "pkg-0.3.0-1.19.2" = _mBnu72iu;
        "pkg-0.3.0-1.19.3" = _2ZppCG6X;
        "pkg-0.3.0-1.18.2" = _A7JY9VZl;
        "pkg-0.3.0-1.19.4" = _pqEfxhmM;
        "pkg-0.3.1-1.19.2" = _bzKKLa7R;
        "pkg-0.3.1-1.19.3" = _3BA39kFb;
        "pkg-0.3.1-1.18.2" = _vHjfXzJk;
        "pkg-0.3.1-1.19.4" = _FQ7eZo1v;
        "pkg-0.3.2-1.19.2" = _VWsPSRti;
        "pkg-0.3.2-1.18.2" = _IX4wryzd;
        "pkg-0.3.2-1.19.4" = _2pEdgBqo;
        "pkg-0.3.2-1.19.3" = _VwYCYaBL;
        "pkg-0.3.3-1.19.2" = _Ys0zDB03;
        "pkg-0.3.3-1.19.3" = _Tg2s3Ni0;
        "pkg-0.3.3-1.19.4" = _7yr3AGys;
        "pkg-0.3.3-1.18.2" = _avTQdQR6;
        "pkg-0.4.0-1.18.2" = _xCDQq5qe;
        "pkg-0.4.0-1.19.3" = _X497m1yp;
        "pkg-0.4.0-1.19.2" = _J9iStxcf;
        "pkg-0.4.0-1.19.4" = _vrpJFc4h;
        "pkg-0.4.1-1.19.3" = _Sk1KaAbI;
        "pkg-0.4.1-1.19.2" = _xhZOrgBT;
        "pkg-0.4.1-1.18.2" = _M6IznTyR;
        "pkg-0.4.1-1.16.5" = _LmGiRMAN;
        "pkg-0.4.2-1.19.2" = _Yp1nvIZy;
        "pkg-0.4.2-1.16.5" = _Lsww5yjl;
        "pkg-0.4.2-1.19.3" = _Rq6AoOZl;
        "pkg-0.4.2-1.18.2" = _3OhQPQRp;
        "pkg-0.4.2-1.19.4" = _OO8SxW5r;
        "pkg-0.5.0-1.16.5" = _7ZZL6LJC;
        "pkg-0.5.0-1.18.2" = _vq1b4SUy;
        "pkg-0.5.0-1.19.2" = _6NO6CFtK;
        "pkg-0.5.0-1.19.3" = _Ew6PjG1H;
        "pkg-0.5.0-1.19.4" = _eMMbsBmR;
        "pkg-0.5.0-1.20" = _QKphCRVr;
        "pkg-0.5.1-1.19.2" = _Y1r8gnuI;
        "pkg-0.5.1-1.18.2" = _MYxPHSfW;
        "pkg-0.5.1-1.19.3" = _huhrlxpO;
        "pkg-0.5.1-1.19.4" = _e7RHw7l3;
        "pkg-0.5.1-1.20" = _cBeOxUJB;
        "pkg-0.6.0-1.19.2" = _Nq1J8QiD;
        "pkg-0.6.0-1.18.2" = _Oi5nOSyT;
        "pkg-0.6.0-1.19.3" = _O6W3yxcF;
        "pkg-0.6.0-1.20" = _AfIPPnmc;
        "pkg-0.6.0-1.19.4" = _oirpVVnR;
        "pkg-0.6.1-1.19.4" = _pHam13Y7;
        "pkg-0.6.1-1.19.3" = _LyQx0Ms1;
        "pkg-0.6.1-1.19.2" = _KjJITaMS;
        "pkg-0.6.1-1.20" = _HDDmwh0f;
        "pkg-0.6.1-1.18.2" = _Scz9fiuR;
        "pkg-0.6.2-1.19.2" = _6upQ1f9W;
        "pkg-0.6.2-1.18.2" = _PdViTNjW;
        "pkg-0.6.2-1.19.3" = _xoot2Qh6;
        "pkg-0.6.2-1.19.4" = _zDpv5zzq;
        "pkg-0.6.2-1.20" = _xG4dmNC9;
        "pkg-0.7.0-1.18.2" = _VT3wkfjR;
        "pkg-0.7.0-1.19.2" = _Q040EKwK;
        "pkg-0.7.0-1.19.3" = _hQFzGjcY;
        "pkg-0.7.0-1.19.4" = _H6gtIzuV;
        "pkg-0.7.0-1.20" = _l4KZRQh0;
        "pkg-0.8.0-1.18.2" = _vaWGpEUc;
        "pkg-0.8.0-1.19.2" = _yzrW2Wwu;
        "pkg-0.8.0-1.19.4" = _WzTqcXeE;
        "pkg-0.8.0-1.20" = _sPMb8Y9q;
        "pkg-0.8.0-1.19.3" = _IN086B0g;
        "pkg-1.0.0-1.18.2" = _gO1U9cIY;
        "pkg-1.0.0-1.19.2" = _NEnrkpSa;
        "pkg-1.0.0-1.19.3" = _TFNfv3Qa;
        "pkg-1.0.0-1.19.4" = _MJIaP52N;
        "pkg-1.0.0-1.20" = _u6VjokQF;
        "pkg-1.1.0-1.18.2" = _RSSSUV3d;
        "pkg-1.1.0-1.19.2" = _AZqWDP75;
        "pkg-1.1.0-1.19.3" = _DAt4WG7X;
        "pkg-1.1.0-1.19.4" = _yCbbmyrn;
        "pkg-1.1.0-1.20" = _nYigBPGJ;
        "pkg-2.0.0-1.19.2" = _HQ2Lk4jM;
        "pkg-2.0.0-1.18.2" = _vYewQNDC;
        "pkg-2.0.0-1.19.3" = _KAEizGX3;
        "pkg-2.0.0-1.19.4" = _GXYmS1RN;
        "pkg-2.0.0-1.20" = _y0BqaBla;
        "pkg-2.1.0-1.18.2" = _5VCqW0VU;
        "pkg-2.1.0-1.19.3" = _Guobhckx;
        "pkg-2.1.0-1.19.4" = _tnrkzfjV;
        "pkg-2.1.0-1.19.2" = _XDBIu4sI;
        "pkg-2.1.0-1.20" = _iQ1iBhjc;
        "pkg-2.1.1-1.18.2" = _kMU6mme5;
        "pkg-2.1.1-1.19.2" = _cVjbPGC7;
        "pkg-2.1.1-1.19.4" = _dUzRigSr;
        "pkg-2.1.1-1.19.3" = _ZjIgAOrj;
        "pkg-2.1.1-1.20" = _N0sSUuRB;
        "pkg-2.2.0-1.18.2" = _vZpKSNgH;
        "pkg-2.2.0-1.19.2" = _ny7gY23X;
        "pkg-2.2.0-1.19.4" = _Gyu18rCr;
        "pkg-2.2.0-1.19.3" = _YCjUIyDX;
        "pkg-2.2.0-1.20" = _fFyWn2Be;
        "pkg-3.0.0-1.18.2" = _4BJ1h1XM;
        "pkg-3.0.0-1.20" = _WARwi7mU;
        "pkg-3.0.0-1.19.2" = _58uFbPbj;
        "pkg-3.0.1-1.20" = _ElvoBmbh;
        "pkg-3.0.2-1.20" = _keTffSne;
        "pkg-3.0.3-1.20" = _ilmAjcWH;
        "pkg-3.0.3-1.20.4" = _ZfjuAXk7;
        "pkg-3.1.0-1.20" = _dW35vo48;
        "pkg-3.1.0-1.18.2" = _HEdRL8Ns;
        "pkg-3.1.0-1.19.2" = _gcmKeiku;
        "pkg-3.1.0-1.20.4" = _a2XhCgGz;
        "pkg-3.1.1-1.20.4" = _v6WVfMCa;
        "pkg-4.0.0-1.20.1-build.481" = _ZWRvJnnB;
        "pkg-4.0.0-1.20.4-build.482" = _BPZnlpZr;
        "pkg-4.0.1-1.20.1-build.76" = _ilxDJrKt;
        "pkg-4.0.1-1.20.4-build.77" = _hkAE64lQ;
        "pkg-4.0.1-1.20.5-build.79" = _gHIXHL95;
        "pkg-4.0.2-1.20.4-build.81" = _XAj7DEwu;
        "pkg-4.0.2-1.20.1-build.80" = _3cLIRL1x;
        "pkg-4.0.2-1.20.5-build.82" = _mSQl7nUD;
        "pkg-4.1.0-1.20.1-build.86" = _O24TC7mW;
        "pkg-4.1.0-1.20.4-build.87" = _S6dXhs0O;
        "pkg-4.1.0-1.20.5-build.88" = _z7hJVRMQ;
        "pkg-4.1.0-1.21-build.89" = _FaqI2xrm;
        "pkg-4.1.1-1.20.1-build.90" = _Ur5nMH7Y;
        "pkg-4.1.1-1.20.4-build.91" = _8MhreZZN;
        "pkg-4.1.1-1.20.5-build.92" = _h2fqRgA6;
        "pkg-4.1.1-1.21-build.93" = _uQShPMNc;
        "default" = _uQShPMNc;
    });
