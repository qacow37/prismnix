...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _VXZvkh8I;
        "pkg-1.0.5" = _qZiHv6w4;
        "pkg-1.0.6-1.21.5" = _yzwRmhep;
        "pkg-1.0.7-1.21.5" = _JS8RciW6;
        "pkg-1.0.8-1.21.5" = _S131bzCP;
        "pkg-1.0.9-1.21.5" = _zlHAAvZn;
        "pkg-1.1.0-1.21.5" = _VqCzwFDw;
        "pkg-1.1.1-1.21.5" = _bGPKbNIS;
        "pkg-1.1.2-1.21.1" = _fn9y6Uef;
        "pkg-1.1.2-1.21.5" = _JCe66CkF;
        "pkg-1.1.3-1.21.5" = _cPS41Zzf;
        "pkg-1.1.3-1.21.1" = _HiTqa2KB;
        "pkg-1.1.3-1.21.7" = _2R1KQMDy;
        "pkg-1.1.3-1.21.7+8" = _vzYeJci3;
        "pkg-1.1.4-1.21.8" = _WfLTnWe6;
        "pkg-1.1.4-1.12.2" = _BeEFuKL7;
        "pkg-1.1.5-1.21.8" = _4AEbYMLc;
        "pkg-1.1.5-1.21.7-8" = _RiuYhKTn;
        "pkg-1.1.5-1.21.5" = _qeo801KM;
        "pkg-1.1.5-1.21.1" = _F1tMQ5kF;
        "pkg-1.1.6-1.21.8" = _en5pPOx2;
        "pkg-1.1.7-1.21.1" = _7lNCnaPm;
        "pkg-1.1.7-1.21.10" = _4E6OG1k1;
        "pkg-1.1.7-1.12.2" = _4F5YZvwW;
        "pkg-1.1.8-1.21.10" = _yOlJddAS;
        "pkg-1.1.8-1.21.1" = _fteMhHF1;
        "pkg-1.2.0-1.21.1" = _tny6v66C;
        "pkg-1.2.0-1.21.10" = _I9RW5Wuo;
        "pkg-1.2.1-1.21.11" = _mqwJhlvN;
        "pkg-1.2.1-1.21.1" = _s0xezMDk;
        "pkg-1.2.2-1.21.11" = _ICGEn1md;
        "pkg-1.2.2-1.21.1" = _BQXPBdhW;
        "pkg-1.2.3-1.21.11" = _QXRo9sFp;
        "pkg-1.2.3-1.21.10" = _fLW7QvYw;
        "pkg-1.2.4-26.1" = _HIH1IIip;
        "pkg-1.2.4-26.1.1" = _33U5H4jv;
        "pkg-1.2.4-1.21.11" = _Z1mO2CAV;
        "pkg-1.2.4-1.21.1" = _qrnXiyEj;
        "pkg-1.2.4-26.1.x" = _IInjDgRZ;
        "pkg-1.2.5-26.1.x" = _kyar2X9t;
        "pkg-1.2.5-1.21.1" = _jVRgEzCO;
        "pkg-1.2.5-1.21.11" = _d0VCnKde;
        "pkg-1.2.6-26.1.2" = _aBN4iE3d;
        "pkg-1.2.7-26.1.2" = _sCenOUMD;
        "pkg-1.2.7-1.21.11" = _ACfeNR72;
        "pkg-1.2.7-1.21.1" = _GS9QXZjE;
        "pkg-1.2.8-26.1.2" = _HpkKE1G4;
        "pkg-1.2.8-1.21.11" = _7cXXmjWo;
        "pkg-1.2.8-1.21.1" = _vNbKZTqA;
        "default" = _vNbKZTqA;
    });
