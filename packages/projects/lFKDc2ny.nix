...
let
    ...
    in {
        ...
        "pkg-1.21-1.0-fabric" = _7WZUP6eT;
        "pkg-1.21-1.0-fabric+mod" = _pbGkhyxP;
        "pkg-1.21-1.0-neoforge" = _DcHfOxzh;
        "pkg-1.21-1.0-neoforge+mod" = _1Y3Dnw1P;
        "pkg-1.21-1.1-fabric" = _oWsDyVMV;
        "pkg-1.21-1.1-fabric+mod" = _HvVwZdo3;
        "pkg-1.21-1.1-neoforge" = _v017oZ6l;
        "pkg-1.21-1.1-neoforge+mod" = _yLP4WdlV;
        "pkg-1.21-1.1a-fabric" = _xw84le7t;
        "pkg-1.21-1.1a-fabric+mod" = _geQLUsh0;
        "pkg-1.21-1.1a-neoforge" = _Ti95Mv3g;
        "pkg-1.21-1.1a-neoforge+mod" = _HKjlgJZD;
        "pkg-1.20.1-1.1a-fabric" = _5BOzJ9YS;
        "pkg-1.20.1-1.1a-fabric+mod" = _u0Qu8Fds;
        "pkg-1.20.1-1.1a-forge" = _m6UZW4EL;
        "pkg-1.20.1-1.1a-forge+mod" = _wfwJ4JY8;
        "pkg-1.21.1-1.1a-fabric+mod" = _GrhjtZEe;
        "pkg-1.20.1-1.1b-fabric" = _d640Tm8D;
        "pkg-1.20.1-1.1b-fabric+mod" = _kKIRCI6Y;
        "pkg-1.20.1-1.1b-forge" = _YJOw0s0T;
        "pkg-1.20.1-1.1b-forge+mod" = _kkwIGh7i;
        "pkg-1.21.1-1.1b-fabric" = _Z7HBqCdi;
        "pkg-1.21.1-1.1b-fabric+mod" = _R2Vidzqh;
        "pkg-1.21.1-1.1b-neoforge" = _l1OJGprS;
        "pkg-1.21.1-1.1b-neoforge+mod" = _HjwPIJ3o;
        "default" = _HjwPIJ3o;
    });
