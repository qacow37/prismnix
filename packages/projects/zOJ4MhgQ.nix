...
let
    ...
    in {
        ...
        "pkg-v1.0.1-forge-1.20.1-47.3.33" = _StmyDxB1;
        "pkg-v1.0.1-forge-1.21.1-52.0.53" = _8IKiLc1S;
        "pkg-v1.0.1-forge-1.21.4-54.1.1" = _9i2t5Rkx;
        "pkg-v1.0.1-fabric-1.21.5-0.119.9" = _hG0aQeKY;
        "pkg-v1.0.1-forge-1.21.5-55.0.4" = _tLryTw0K;
        "pkg-v1.0.2-forge-1.21.5-55.0.4" = _asc4ZJQ7;
        "pkg-1.0.1-fabric-1.21.6-0.127.0" = _tQnpLLwx;
        "pkg-1.0.2-forge-1.21.6-56.0.5" = _Z982ICF3;
        "pkg-1.0.2-neoforge-1.21.8-21.8.39" = _KgNtJS0y;
        "pkg-1.0.2-neoforge-1.21.9-21.9.2-b" = _Na4xyOZz;
        "pkg-1.0.2-fabric-1.21.9-0.134.0" = _PY9zpaLg;
        "pkg-1.0.3-forge-1.21.9-59.0.1" = _9ilvbIvz;
        "pkg-1.0.4-forge-1.21.9-59.0.5" = _pwcUTWGh;
        "pkg-1.0.4-neoforge-1.21.4-21.4.155" = _VIv8wBd5;
        "pkg-1.0.4-neoforge-1.21.1-21.1.213" = _IeADhAt4;
        "pkg-1.0.5-forge-1.21.8-58.1.7" = _Yvp7wOIh;
        "pkg-1.0.5-forge-1.21.11-61.0.2" = _M6Zde0VJ;
        "pkg-1.0.5-fabric-1.21.11-0.140.0" = _7pDaHD6Z;
        "pkg-1.0.5-neoforge-1.21.11-21.11.10-" = _kEYcR14K;
        "pkg-1.0.6-fabric-26.1.2-0.145.2" = _HtfIRefa;
