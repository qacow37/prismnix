...
let
    ...
    in {
        ...
        "pkg-1.8.0" = _CuxS4YV0;
        "pkg-1.9.0" = _69MtWREn;
        "pkg-1.10.0" = _bMdc8CYn;
        "pkg-1.10.1" = _NtkVdpsY;
        "pkg-1.10.2" = _YpC4OWG4;
        "pkg-1.11.0" = _mghZGFZW;
        "pkg-1.12.0" = _5EplLhMw;
        "pkg-1.13.0" = _J9xm2g54;
        "pkg-1.13.1" = _bts1OGYn;
        "pkg-1.14.0" = _IqSCZdky;
