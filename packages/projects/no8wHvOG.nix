...
let
    ...
    in {
        ...
        "pkg-0.1.4.1.0" = _9guY9YLx;
        "pkg-0.1.4.1.1" = _VRzLDOab;
        "pkg-0.1.8" = _Dg7Isu2U;
        "pkg-0.2.1" = _KlmtEEXn;
        "pkg-0.3.0" = _p77wC4AD;
        "pkg-0.1.9" = _qdlCHILA;
        ...
        "pkg-0.9.6" = _w964wZ66;
        "pkg-0.9.7" = _zDdYPxys;
        "pkg-0.10.0" = _UvDOnM5W;
        "pkg-0.10.1" = _GoWwj8jD;
        "pkg-0.10.2" = _w0bApaiO;
        "pkg-0.11.0" = _EjdVc29L;
        "pkg-0.12.0" = _tmYlVzWe;
        "pkg-0.12.1" = _xdLessdB;
        "default" = _xdLessdB;
    });
