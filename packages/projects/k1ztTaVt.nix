...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _hgovJJ0d;
        "pkg-1.18.2-2.0-fabric" = _16IJAYdE;
        "pkg-1.19.2-2.2-fabric" = _BO3ij4Yk;
        "pkg-1.16.5-1.5-forge" = _l5J3cu0U;
        "pkg-1.18.2-1.7-forge" = _T8xUbiFb;
        "pkg-1.19.2-1.9-forge" = _DP8VkG33;
        "pkg-1.16.5-2.3-fabric" = _v2eIi7r8;
        "pkg-1.18.2-2.3-fabric" = _hXICD9py;
        "pkg-1.19.2-2.3-fabric" = _P5zRDZdo;
        "pkg-1.19.3-2.4-fabric" = _NKH5n5HY;
        "pkg-1.19.3-1.9-forge" = _xpzIm79l;
        "pkg-1.18.2-3.0-forge+fabric" = _dcf87Jlq;
        "pkg-1.19.2-3.0-forge+fabric" = _N75KpU5f;
        "pkg-1.19.3-3.0-forge+fabric" = _b8DJq9TM;
        "pkg-1.19.4-3.0-forge+fabric" = _BvrHMmAX;
        "pkg-1.20-3.0-forge+fabric" = _lUlK2UqP;
        "pkg-1.20.1-3.0-forge+fabric" = _ssAHEfFJ;
        "pkg-1.20.2-3.0-forge+fabric" = _u3IzDC6K;
        "pkg-1.18.2-3.1-forge+fabric" = _d76lSXNO;
        "pkg-1.19.2-3.1-forge+fabric" = _23kar3tQ;
        "pkg-1.20.1-3.1-forge+fabric" = _ajBZfdYp;
        "pkg-1.20.2-3.1-forge+fabric" = _UDgVBVtK;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _8jjbG7Or;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _8r6JGg3m;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _AD9Rzw32;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _AxKCYRYO;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _uKkYBfGd;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _ZCWQA4uL;
        "pkg-1.19.2-3.3-fabric+forge" = _QXHZ3405;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _pRNXQKsw;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _AI8LSone;
        "pkg-1.20.5-3.3-fabric+neo" = _C5MQEW2d;
        "pkg-1.20.5-3.4-fabric+neo" = _yRaYeCX0;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _OVAaQtuu;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _iiHqjQYG;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _Fxju2k6A;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _ZMA0Tfm3;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _xhVN1Wrq;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _mVgG3OSh;
        "pkg-1.21.2-3.5-fabric+neo" = _KndW00LP;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _IQu957bV;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _ZqOmUp5E;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _SeEvTCdP;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _mP5tOfBq;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _RsOxXupU;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _bz5ZAZoe;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _jnhu24oR;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _uQy9iPXT;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _2Jrfe3At;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _KoP70YGj;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _TbcKtKsA;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _Ud3Fsuy5;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _NRphoJj5;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _BDLpNyKV;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _Zr0ysqQf;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _qKsiH7Rw;
        "default" = _qKsiH7Rw;
    });
