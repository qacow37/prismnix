...
let
    ...
    in {
        ...
        "pkg-1.5.2" = _JQ7Z8yno;
        "pkg-1.5.3" = _4J0NvPtK;
        "pkg-v2.0.0-plugin" = _CIMRvZ4e;
        "pkg-v2.0.0-proxy" = _pbSKjPiN;
        "pkg-v2.0.0-mod" = _sNdAydnB;
        "pkg-v2.0.1-plugin" = _k0UWFwoP;
        "pkg-v2.0.1-proxy" = _wabkfBhj;
        "pkg-v2.0.1-mod" = _obei1E9v;
        "pkg-v2.0.2-plugin" = _GvlQYMVN;
        "pkg-v2.0.2-proxy" = _rPdhOM21;
        "pkg-v2.0.2-mod" = _BZ9pUde2;
        "pkg-v2.0.3-plugin" = _IxP39Rod;
        "pkg-v2.0.3-proxy" = _sV4ZADCW;
        "pkg-v2.0.3-mod" = _vDPmiDbc;
        "pkg-v2.0.4-plugin" = _6xQXQB2c;
        "pkg-v2.0.4-proxy" = _TAKqtAkJ;
        "pkg-v2.0.4-mod" = _5gk39HJM;
        "pkg-v2.0.5-plugin" = _qEwn001o;
        "pkg-v2.0.5-proxy" = _wjDiJyZc;
        "pkg-v2.0.5-mod" = _vmizay4P;
        "pkg-v2.0.6-plugin" = _R1UuyVnA;
        "pkg-v2.0.6-proxy" = _GrpkyO58;
        "pkg-v2.0.6-mod" = _HsuMFmyg;
        "pkg-v2.0.7-plugin" = _yo2vicLb;
        "pkg-v2.0.7-proxy" = _LHrETZRX;
        "pkg-v2.0.7-mod" = _bpswwN41;
        "pkg-v2.0.8-plugin" = _VY55bJwc;
        "pkg-v2.0.8-proxy" = _scRtKFS1;
        "pkg-v2.0.8-mod" = _ltpE95OV;
        "pkg-v2.0.9-plugin" = _JgGZIpEj;
        "pkg-v2.0.9-proxy" = _NMrtRbyO;
        "pkg-v2.0.9-mod" = _Hh7DpGYa;
        "pkg-v2.0.10-plugin" = _wxH7lKsf;
        "pkg-v2.0.10-proxy" = _DQQL7mIB;
        "pkg-v2.0.10-mod" = _PDXwErgC;
        "pkg-v2.0.11-proxy" = _1hixJAlN;
        "pkg-v2.0.11-mod" = _J138VMv0;
        "default" = _J138VMv0;
    });
