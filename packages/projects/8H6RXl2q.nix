...
let
    ...
    in {
        ...
        "pkg-1.0.0+fabric.1.20.6" = _ONOdfy5H;
        "pkg-1.0.0+fabric.1.20.4" = _AenUVoxW;
        "pkg-1.0.0+fabric.1.20.2" = _Zrjs298C;
        "pkg-1.0.0+fabric.1.20.1" = _bEXLsz8d;
        "pkg-1.1.0+fabric.1.21.4" = _H36gGBua;
        "pkg-1.1.0+fabric.1.21.3" = _IaR0lgWg;
        "pkg-1.1.0+fabric.1.21.1" = _d9rEVCxp;
        "pkg-1.1.0+fabric.1.20.6" = _yYxKPNX3;
        "pkg-1.1.0+fabric.1.20.2" = _JK5yhtnb;
        "pkg-1.1.0+fabric.1.20.4" = _wQyHsHri;
        "pkg-1.1.0+fabric.1.20.1" = _CJeqsSTX;
        "pkg-1.2.0+fabric.1.21.4" = _MJNQ5YNj;
        "pkg-1.2.0+fabric.1.21.3" = _Ib4SBWEg;
        "pkg-1.2.0+fabric.1.21.1" = _v2LjD2zV;
        "pkg-1.2.0+fabric.1.20.6" = _bA9SCKVx;
        "pkg-1.2.0+fabric.1.20.2" = _N7hallJj;
        "pkg-1.2.0+fabric.1.20.4" = _Qe2OpcCy;
        "pkg-1.2.0+fabric.1.20.1" = _zlmM4aU7;
        "pkg-1.2.1+fabric.1.21.4" = _k2W3PNBQ;
        "pkg-1.2.1+fabric.1.21.3" = _MBWwVpz5;
        "pkg-1.2.1+fabric.1.21.1" = _KdczQlF7;
        "pkg-1.2.1+fabric.1.20.6" = _PMdLRvu0;
        "pkg-1.2.1+fabric.1.20.2" = _MKFmwu8o;
        "pkg-1.2.1+fabric.1.20.4" = _2z7osYI1;
        "pkg-1.2.1+fabric.1.20.1" = _bhHXmyf0;
        "pkg-1.2.2+fabric.1.21.4" = _TYezNrIz;
        "pkg-1.2.2+fabric.1.21.3" = _fh2IgBi6;
        "pkg-1.2.2+fabric.1.21.1" = _hkoaAR7o;
        "pkg-1.2.2+fabric.1.20.6" = _GmQv9Wqs;
        "pkg-1.2.2+fabric.1.20.2" = _zrGyRYYG;
        "pkg-1.2.2+fabric.1.20.4" = _soD0uzIG;
        "pkg-1.2.2+fabric.1.20.1" = _zaJCUOmt;
        "pkg-1.2.3+fabric.1.21.4" = _spPojVge;
        "pkg-1.2.3+fabric.1.21.3" = _YEaV3G6g;
        "pkg-1.2.3+fabric.1.21.1" = _z7iB0e2c;
        "pkg-1.2.3+fabric.1.20.6" = _UvEQFR7A;
        "pkg-1.2.3+fabric.1.20.2" = _sYzYypLL;
        "pkg-1.2.3+fabric.1.20.4" = _kY4tqMAM;
        "pkg-1.2.3+fabric.1.20.1" = _Ng1eB6IY;
        "pkg-1.3.0+fabric.1.21.4" = _iIybWKvp;
        "pkg-1.3.0+fabric.1.21.3" = _QvZAJCSf;
        "pkg-1.3.0+fabric.1.21.1" = _KkfpWL67;
        "pkg-1.3.0+fabric.1.20.6" = _hwAH0AkZ;
        "pkg-1.3.0+fabric.1.20.2" = _OzutybrU;
        "pkg-1.3.0+fabric.1.20.4" = _HAN6xsqD;
        "pkg-1.3.0+fabric.1.20.1" = _iHpvgsqm;
        "pkg-1.3.1+fabric.1.21.4" = _W51qOykD;
        "pkg-1.3.1+fabric.1.21.3" = _aMHuHsy1;
        "pkg-1.3.1+fabric.1.21.1" = _TOMVNMZs;
        "pkg-1.3.1+fabric.1.20.6" = _HQVY0Qvv;
        "pkg-1.3.1+fabric.1.20.2" = _AETIHagx;
        "pkg-1.3.1+fabric.1.20.4" = _pCMtlhoJ;
        "pkg-1.3.1+fabric.1.20.1" = _hLVgu8hZ;
        "pkg-1.4.0+fabric.1.21.3" = _gBNrYZal;
        "pkg-1.4.0+fabric.1.21.4" = _BTnoPvB0;
        "pkg-1.4.0+fabric.1.21.1" = _1L73fF4n;
        "pkg-1.4.0+fabric.1.20.6" = _S2rT4b3q;
        "pkg-1.4.0+fabric.1.20.2" = _mLC8JGqU;
        "pkg-1.4.0+fabric.1.20.1" = _A1pmFqVV;
        "pkg-1.4.0+fabric.1.20.4" = _1ZOaMYGG;
        "pkg-1.5.0+fabric.1.21.4" = _Kr6a7c5u;
        "pkg-1.5.0+fabric.1.21.3" = _Y3dVW5bZ;
        "pkg-1.5.0+fabric.1.21.1" = _zpCfMjvO;
        "pkg-1.5.1+fabric.1.21.4" = _W5UF66ci;
        "pkg-1.5.1+fabric.1.21.3" = _cYgWiW5o;
        "pkg-1.5.1+fabric.1.21.1" = _ZR8IDu9O;
        "pkg-1.5.2+fabric.1.21.4" = _OcANmnL1;
        "pkg-1.5.2+fabric.1.21.3" = _5ABf68bZ;
        "pkg-1.5.2+fabric.1.21.1" = _HfvzgkrV;
        "pkg-1.6.0+fabric.1.21.5" = _nJyylyDE;
        "pkg-1.6.0+fabric.1.21.4" = _gdlW8EGK;
        "pkg-1.6.0+fabric.1.21.3" = _E7rmJ4X5;
        "pkg-1.6.0+fabric.1.21.1" = _wDMA9z4C;
        "pkg-1.7.0+neoforge.1.21.5" = _Sjy5qMV3;
        "pkg-1.7.0+fabric.1.21.5" = _7msYp6TQ;
        "pkg-1.7.0+neoforge.1.21.4" = _4NFB5eVm;
        "pkg-1.7.0+fabric.1.21.4" = _jqkmAPhj;
        "pkg-1.7.0+neoforge.1.21.3" = _7ZMNboJp;
        "pkg-1.7.0+fabric.1.21.3" = _209LUE0h;
        "pkg-1.7.0+neoforge.1.21.1" = _ZA9ODXZS;
        "pkg-1.7.0+fabric.1.21.1" = _Xe2tWRqh;
        "pkg-1.7.1+neoforge.1.21.5" = _geQZZ0Fy;
        "pkg-1.7.1+fabric.1.21.5" = _2n3tSEnz;
        "pkg-1.7.1+neoforge.1.21.4" = _gWPCn7CC;
        "pkg-1.7.1+fabric.1.21.4" = _kb1SRrH5;
        "pkg-1.7.1+neoforge.1.21.3" = _ZwUhNU7D;
        "pkg-1.7.1+fabric.1.21.3" = _I0nQ6On7;
        "pkg-1.7.1+neoforge.1.21.1" = _kJclxhTn;
        "pkg-1.7.1+fabric.1.21.1" = _OBV6E0m4;
        "pkg-1.8.0-beta+neoforge.1.21.8" = _Szc4Alsj;
        "pkg-1.8.0-beta+fabric.1.21.8" = _8uqIIOKM;
        "pkg-1.8.0-beta+neoforge.1.21.5" = _Cf0oEGyZ;
        "pkg-1.8.0-beta+fabric.1.21.5" = _367Wrj0T;
        "pkg-1.8.0-beta+neoforge.1.21.4" = _1wqWc19x;
        "pkg-1.8.0-beta+fabric.1.21.4" = _p0Vrge6v;
        "pkg-1.8.0-beta+neoforge.1.21.3" = _TfrYobtk;
        "pkg-1.8.0-beta+fabric.1.21.3" = _jF8hp0cq;
        "pkg-1.8.0-beta+neoforge.1.21.1" = _CNaZ45L0;
        "pkg-1.8.0-beta+neoforge.1.21.10" = _NW9SiHAN;
        "pkg-1.8.0-beta+fabric.1.21.10" = _9N21S0fu;
        "pkg-1.8.0-beta+fabric.1.21.1" = _tNUMydkf;
        "pkg-1.8.0+neoforge.1.21.8" = _tUlRohu4;
        "pkg-1.8.0+fabric.1.21.8" = _R0FcNhFV;
        "pkg-1.8.0+neoforge.1.21.5" = _PwsZ5ii6;
        "pkg-1.8.0+fabric.1.21.5" = _nVHrpdWe;
        "pkg-1.8.0+neoforge.1.21.4" = _dPOK25Tk;
        "pkg-1.8.0+fabric.1.21.4" = _aK7PIf6l;
        "pkg-1.8.0+neoforge.1.21.3" = _ZlrWjDC5;
        "pkg-1.8.0+fabric.1.21.3" = _Kmky9Ayf;
        "pkg-1.8.0+neoforge.1.21.11" = _qiHSznDZ;
        "pkg-1.8.0+fabric.1.21.11" = _qY0yC9FG;
        "pkg-1.8.0+neoforge.1.21.10" = _zNa9qRM6;
        "pkg-1.8.0+fabric.1.21.10" = _6LI0rrcK;
        "pkg-1.8.0+neoforge.1.21.1" = _QdoVzVqA;
        "pkg-1.8.0+fabric.1.21.1" = _B9yOIXhj;
        "pkg-1.9.0+fabric.1.21.1" = _xgKampfb;
        "pkg-1.9.0+neoforge.1.21.1" = _N4BBoddF;
        "pkg-1.9.0+fabric.1.21.10" = _JE9hEOIQ;
        "pkg-1.9.0+neoforge.1.21.10" = _LUXTaYDk;
        "pkg-1.9.0+neoforge.1.21.11" = _BzaBSNSW;
        "pkg-1.9.0+fabric.1.21.11" = _AXTy1AtO;
        "pkg-1.9.0+fabric.1.21.3" = _Y2eshH8m;
        "pkg-1.9.0+neoforge.1.21.3" = _9pPUS0Ql;
        "pkg-1.9.0+neoforge.1.21.4" = _QpPmsBDY;
        "pkg-1.9.0+fabric.1.21.4" = _OTYY7Yfy;
        "pkg-1.9.0+neoforge.1.21.5" = _w1fyohDA;
        "pkg-1.9.0+fabric.1.21.5" = _BLxL15Ux;
        "pkg-1.9.0+fabric.1.21.8" = _uDho77Tp;
        "pkg-1.9.0+neoforge.1.21.8" = _mOC8sm9M;
        "pkg-1.9.0+fabric.26.1" = _hwVG8Wok;
        "pkg-1.9.0+neoforge.26.1" = _7VeNXi0m;
        "pkg-1.9.1+neoforge.1.21.1" = _UfzWtspi;
        "pkg-1.9.1+fabric.1.21.1" = _sQU8dx4Y;
        "pkg-1.9.1+fabric.1.21.10" = _PrtbsLrI;
        "pkg-1.9.1+neoforge.1.21.10" = _KmFjuR7G;
        "pkg-1.9.1+fabric.1.21.11" = _SjsdgIKs;
        "pkg-1.9.1+neoforge.1.21.11" = _urb0VVYH;
        "pkg-1.9.1+fabric.1.21.3" = _DzMW2gE5;
        "pkg-1.9.1+neoforge.1.21.3" = _Fw46Q0FY;
        "pkg-1.9.1+fabric.1.21.4" = _6yOi5xUr;
        "pkg-1.9.1+neoforge.1.21.4" = _Y6Qts0PZ;
        "pkg-1.9.1+fabric.1.21.5" = _GaLt7Omg;
        "pkg-1.9.1+neoforge.1.21.5" = _sbaxrFmx;
        "pkg-1.9.1+fabric.26.1.2" = _CuIEfzjl;
        "pkg-1.9.1+fabric.1.21.8" = _yAqUlCfq;
        "pkg-1.9.1+neoforge.1.21.8" = _KeRmRkQu;
        "pkg-1.9.1+neoforge.26.1.2" = _QC8QvQq0;
        "pkg-1.10.0+neoforge.1.21.1" = _EHjgWtvl;
        "pkg-1.10.0+fabric.1.21.1" = _Yk8v8JQ5;
        "pkg-1.10.0+fabric.1.21.10" = _Ymur97xG;
        "pkg-1.10.0+neoforge.1.21.10" = _YVOXyQZa;
        "pkg-1.10.0+neoforge.1.21.11" = _jwyh3QWy;
        "pkg-1.10.0+fabric.1.21.11" = _PluKKtqe;
        "pkg-1.10.0+fabric.1.21.3" = _1LndhYzy;
        "pkg-1.10.0+neoforge.1.21.3" = _RwkW6Aob;
        "pkg-1.10.0+fabric.1.21.4" = _ZJTesyg8;
        "pkg-1.10.0+neoforge.1.21.4" = _FgPHPwyF;
        "pkg-1.10.0+fabric.1.21.5" = _BiCtswmO;
        "pkg-1.10.0+neoforge.1.21.5" = _UlmdfufI;
        "pkg-1.10.0+fabric.26.1.2" = _nG0MQM8t;
        "pkg-1.10.0+fabric.1.21.8" = _S3rOo2kz;
        "pkg-1.10.0+neoforge.1.21.8" = _vInXOHpA;
