...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18.2" = _ZdhYKZGS;
        "pkg-1.0.1" = _AjQg5Lpl;
        "pkg-1.1.0+1.18.2" = _lgZYlnH2;
        "pkg-1.2.0+1.18.2" = _wcIRLOzJ;
        "pkg-1.3.0+1.18" = _zUrhsSLh;
        "pkg-1.3.0+1.19" = _tZrY52ps;
        "pkg-1.3.1+1.18" = _XfPoeW2N;
        "pkg-1.3.1+1.19" = _QMu4uAkS;
        "pkg-1.3.2+1.19" = _vzfwXY9k;
        "pkg-1.3.2+1.18" = _Sxm1L8um;
        "pkg-1.3.4+1.18" = _cFeFD601;
        "pkg-1.3.4+1.19" = _uLDltYqQ;
        "pkg-1.3.4+1.19.3" = _fBc4nl0T;
        "pkg-1.3.4+1.19.4" = _KCUO6od9;
        "pkg-1.4.0+1.18" = _q1FUWvkz;
        "pkg-1.4.0+1.19" = _LfTMD3R1;
        "pkg-1.4.0+1.19.3" = _HpWqk4YX;
        "pkg-1.4.0+1.19.4" = _XjPzIbdJ;
        "pkg-2.0.0+1.18" = _p0PH9t70;
        "pkg-2.0.0+1.19" = _I3fF2fzR;
        "pkg-2.0.0+1.19.3" = _NPaZYXhs;
        "pkg-2.1.0+1.18" = _uZah19r1;
        "pkg-2.1.0+1.19" = _DCpSGQix;
        "pkg-2.1.0+1.19.3" = _ozr8IFMm;
        "pkg-2.1.1+1.18" = _gXRsNxEW;
        "pkg-2.1.1+1.19" = _4hyzneXX;
        "pkg-2.1.1+1.19.3" = _W37IRl5R;
        "pkg-2.1.2+1.18" = _pUrFZOp5;
        "pkg-2.1.2+1.19" = _Wfv9wpDh;
        "pkg-2.1.2+1.19.3" = _ck6a6OzW;
        "pkg-2.1.3+1.18" = _a15f8nkS;
        "pkg-2.1.3+1.19" = _P5xLGWpm;
        "pkg-2.1.3+1.19.3" = _MvRbK4Fu;
        "pkg-2.2.0+1.18" = _ThtYh2Eo;
        "pkg-2.2.0+1.19" = _qjyw5Mk0;
        "pkg-2.2.0+1.19.3" = _cteskq27;
        "pkg-2.2.1+1.19" = _MaeoeYhk;
        "pkg-2.2.1+1.19.3" = _Vk4WePaR;
        "pkg-3.0.0+1.21" = _ubqirf2f;
        "pkg-3.0.0+1.20" = _mKK2i1OB;
        "pkg-3.0.0+1.19" = _KKzFRGLD;
        "pkg-3.0.0+1.18" = _rdOLRKir;
        "pkg-3.0.1+1.21" = _2pPlNZEh;
        "pkg-3.0.1+1.20" = _PooYK0Jh;
        "pkg-3.0.1+1.19" = _YlnSAzaz;
        "pkg-3.0.1+1.18" = _ysyWzRTl;
        "pkg-3.0.2+1.21" = _A6Ipvw1T;
        "pkg-3.0.2+1.20" = _cG3zOZfk;
        "pkg-3.0.2+1.19" = _7bjZ0m0H;
        "pkg-3.0.2+1.18" = _uTFJ5xBP;
        "pkg-3.0.3+1.21" = _smVFxka8;
        "pkg-3.0.3+1.20" = _SUWmIGqu;
        "pkg-3.0.3+1.19" = _52Vyvzz5;
        "pkg-3.0.3+1.18" = _V9VIocK0;
        "pkg-3.0.4+1.21" = _pgHHLnA1;
        "pkg-3.0.5+1.21" = _Em8UdNuJ;
        "default" = _Em8UdNuJ;
    });
