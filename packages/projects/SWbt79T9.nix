...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _C5z2i6DM;
        "pkg-1.0.0+mod" = _o4OM1E0K;
        "pkg-1.1.0" = _MMJv8jRd;
        "pkg-1.1.0+mod" = _XGHyt6gY;
        "pkg-1.2.0" = _opSG1zWK;
        "pkg-1.2.0+mod" = _jcJQVCHH;
        "pkg-1.3.0" = _DkJpSLZm;
        "pkg-1.3.0+mod" = _ptO9A8f8;
        "pkg-1.4.0" = _R9AShapY;
        "pkg-1.4.0+mod" = _ofUBoFEV;
        "pkg-1.4.1" = _jKsogw64;
        "pkg-1.4.1+mod" = _q4fndWLx;
        "pkg-1.5.0" = _JwOwtCxx;
        "pkg-1.5.0+mod" = _zozA2JAe;
        "pkg-1.6.0" = _DWbApCIF;
        "pkg-1.6.0+mod" = _ty11BlI3;
        "pkg-1.6.1" = _aQxUdpCs;
        "pkg-1.6.1+mod" = _cMh3iU8C;
        "pkg-1.7.0" = _HrZpOsID;
        "pkg-1.7.0+mod" = _VTA5KhFv;
        "pkg-1.8.0" = _Og1d4ABm;
        "pkg-1.8.0+mod" = _KMIqqkNe;
        "pkg-1.8.1" = _QfYs4QAS;
        "pkg-1.8.1+mod" = _8ZjmTLuG;
        "pkg-1.8.2" = _zjlq7h6I;
        "pkg-1.8.2+mod" = _zjPgN5OK;
        "pkg-1.8.3" = _vQD8vda9;
        "pkg-1.8.3+mod" = _QWNnJS9q;
        "pkg-1.8.4" = _XCirjkY0;
        "pkg-1.8.4+mod" = _TxdWQiae;
        "pkg-1.8.5" = _bKryAT8V;
        "pkg-1.8.5+mod" = _VHv5kG54;
        "pkg-1.8.6" = _Z8vpiPn1;
        "pkg-1.8.6+mod" = _m0TipcG0;
        "pkg-1.9.0" = _CJGFztFl;
        "pkg-1.9.0+mod" = _IRQxHySH;
        "pkg-1.9.1" = _zyJflYFm;
        "pkg-1.9.1+mod" = _eJPtWy8x;
        "pkg-2.0.0" = _pZeh6QT3;
        "pkg-2.0.0+mod" = _Eu6ba4SC;
        "pkg-2.0.1" = _MBQKFbuc;
        "pkg-2.0.1+mod" = _yaDziCKB;
        "pkg-2.0.2" = _j5B3jVgc;
        "pkg-2.0.2+mod" = _UI4AstOm;
        "pkg-2.1.0" = _Iz9LdOk1;
        "pkg-2.1.0+mod" = _yXSFwBs8;
        "pkg-2.2.0" = _80kuOHIK;
        "pkg-2.2.0+mod" = _l6b6rjXC;
        "pkg-2.2.1-beta1" = _yyts0tI5;
        "pkg-2.2.1-beta1+mod" = _5jETUk8i;
        "pkg-2.2.1-beta2" = _UbzNtplD;
        "pkg-2.2.1-beta2+mod" = _Wt6BNRUi;
        "pkg-2.2.1-beta3" = _6Cbam9jJ;
        "pkg-2.2.1-beta3+mod" = _MaksW8ku;
        "pkg-2.2.1-beta4" = _NrCfJdDI;
        "pkg-2.2.1-beta4+mod" = _riSfmflG;
        "pkg-2.2.1" = _uoSaAe8n;
        "pkg-2.2.1+mod" = _TA0hVhWW;
        "pkg-2.3.0" = _zW779oL0;
        "pkg-2.3.0+mod" = _tbKxu5p4;
        "pkg-2.3.1" = _BXxCzfcp;
        "pkg-2.3.1+mod" = _Rl8QQ13j;
        "pkg-2.4.0" = _TVH0tnRb;
        "pkg-2.4.0+mod" = _SlfJqQhC;
        "pkg-2.4.1" = _vSSVmOmk;
        "pkg-2.4.1+mod" = _9QUN0hV3;
        "pkg-2.5.0" = _2vMSRx4v;
        "pkg-2.5.0+mod" = _3qD6oKTT;
        "pkg-2.6.0" = _fKVYePU4;
        "pkg-2.6.0+mod" = _dLabb7t7;
        "pkg-2.7.0" = _XRkoEX27;
        "pkg-2.7.0+mod" = _16irx4Fy;
        "pkg-2.7.1" = _nH5nZb1W;
        "pkg-2.7.1+mod" = _DS4o9oP0;
        "pkg-2.7.2" = _SDMeO3lR;
        "pkg-2.7.2+mod" = _9gpWgO9t;
        "pkg-2.7.3" = _11eQNIp3;
        "pkg-2.7.3+mod" = _KtjEEuwB;
        "pkg-2.7.4" = _cebi2InW;
        "pkg-2.7.4+mod" = _8npNuxum;
        "pkg-2.7.5" = _rWeEcNot;
        "pkg-2.7.5+mod" = _x17pPeaW;
        "pkg-2.7.6" = _6jEpOI6a;
        "pkg-2.7.6+mod" = _BPg5SDJF;
        "pkg-2.7.7" = _w8HC4c5t;
        "pkg-2.7.7+mod" = _KTlLTJB0;
        "pkg-2.8.0" = _dljlmU8P;
        "pkg-2.8.0+mod" = _LlCmKdmQ;
        "pkg-2.8.1" = _SweU2Ut9;
        "pkg-2.8.1+mod" = _HG8HR4d4;
        "pkg-2.8.2" = _FnNXiCtQ;
        "pkg-2.8.2+mod" = _wRCyx2gF;
        "pkg-2.8.3" = _AJU5v7Ni;
        "pkg-2.8.3+mod" = _O0ppL2xa;
        "pkg-2.8.4" = _uqUV6If1;
        "pkg-2.8.4+mod" = _3Ck0CZtz;
        "pkg-2.8.5" = _IYWSCXgk;
        "pkg-2.8.5+mod" = _KA4XqD8k;
        "pkg-2.8.6" = _wCY6g6xJ;
        "pkg-2.8.6+mod" = _HzJD2PEN;
        "pkg-2.8.7" = _6TwidkL4;
        "pkg-2.8.7+mod" = _5zkX2msC;
        "pkg-2.8.8" = _E8ANI1tc;
        "pkg-2.8.8+mod" = _pxBwpnwU;
        "pkg-2.8.9" = _lbtSWEOJ;
        "pkg-2.8.9+mod" = _kqw9b4rX;
        "pkg-2.9.0" = _m0qAsTn3;
        "pkg-2.9.0+mod" = _HqC1zEYr;
        "pkg-2.9.1" = _l5LrxdRd;
        "pkg-2.9.1+mod" = _kUfUOfSK;
        "pkg-2.9.2" = _cP4W65x2;
        "pkg-2.9.2+mod" = _MNsvCcpQ;
        "pkg-2.9.3" = _YIg74RhV;
        "pkg-2.9.3+mod" = _k555TgET;
        "pkg-2.9.4" = _lUxDoHXP;
        "pkg-2.9.4+mod" = _IPCDHXEn;
        "pkg-2.9.5" = _rkcHRDi5;
        "pkg-2.9.5+mod" = _9X32t0A7;
        "pkg-2.9.6" = _Oh7j8MBV;
        "pkg-2.9.6+mod" = _MWlyK0Uh;
        "pkg-2.10.0" = _a5GjHYOq;
        "pkg-2.10.0+mod" = _kcOVr9Ua;
        "pkg-2.10.1" = _IksWbb6e;
        "pkg-2.10.1+mod" = _PyAVUvTy;
        "pkg-2.10.2" = _GOHL8fTb;
        "pkg-2.10.2+mod" = _DcdSWtsw;
        "pkg-2.10.3" = _borT2GgB;
        "pkg-2.10.3+mod" = _wWgrjYDm;
        "pkg-2.10.4" = _qXYvpztq;
        "pkg-2.10.4+mod" = _qtX2sMM5;
        "pkg-2.10.5" = _YdfAcazp;
        "pkg-2.10.5+mod" = _cmOImNKA;
        "pkg-2.10.6" = _jR1LHNrv;
        "pkg-2.10.6+mod" = _AoKCy3xn;
        "pkg-2.10.7" = _iqkNzCxd;
        "pkg-2.10.7+mod" = _Ucl9kaKb;
        "pkg-2.10.8" = _R8mL5nTx;
        "pkg-2.10.8+mod" = _swFPcwia;
        "pkg-2.10.9" = _Lsn2YvU5;
        "pkg-2.10.9+mod" = _ZTE3cs6D;
        "pkg-2.10.10" = _GUbnpVWU;
        "pkg-2.10.10+mod" = _xoIogpGH;
        "pkg-2.10.11" = _IUHlgM8E;
        "pkg-2.10.11+mod" = _J2doRvZe;
        "default" = _J2doRvZe;
    });
