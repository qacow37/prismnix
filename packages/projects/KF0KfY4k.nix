...
let
    ...
    in {
        ...
        "pkg-V1.1" = _IqOk06fX;
        "pkg-V1.0" = _DCskZhvz;
        "pkg-V1.0+mod" = _bfeFVazO;
        "pkg-V1.0.1" = _OhOmMeDp;
        "pkg-V1.0.1+mod" = _4ghqnkEb;
        "pkg-V1.0.2" = _28eIe7QY;
        "pkg-V1.0.2+mod" = _XGDSN4lS;
        "pkg-V1.0.3" = _xEDQyxH7;
        "pkg-V1.0.3+mod" = _N4Sk7Bnu;
        "pkg-V1.1+mod" = _LT0eyFby;
        "pkg-V1.1.1" = _AuEJgogS;
        "pkg-V1.1.1+mod" = _vbXADFnQ;
        "pkg-v1.2.0" = _uVLxylVY;
        "pkg-v1.2.0+mod" = _HKYhiFeq;
        "pkg-v1.2.1" = _LUZjmjKA;
        "pkg-v1.2.1+mod" = _3qRBV0rw;
        "pkg-v1.2.2" = _ZRhjPLaD;
        "pkg-v1.2.2+mod" = _f5lf5spe;
        "pkg-1.2.4" = _O9f3CtQD;
        "pkg-1.2.4+mod" = _htaNfhHI;
        "pkg-1.2.5" = _DXGnMDK9;
        "pkg-1.2.5+mod" = _7Jn2aeV5;
        "pkg-1.2.6" = _sC1ktjVU;
        "pkg-1.2.6+mod" = _MW4R3BJi;
        "pkg-1.2.7" = _ZD2CBOfZ;
        "pkg-1.2.7+mod" = _dXQJmbgW;
        "pkg-1.2.8" = _WQgxYL1D;
        "pkg-1.2.8+mod" = _dCGt81z7;
        "default" = _dCGt81z7;
    });
