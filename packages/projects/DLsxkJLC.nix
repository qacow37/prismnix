...
let
    ...
    in {
        ...
        "pkg-2.1.0+1.21-1.21.1" = _58WlW85A;
        "pkg-2.1.0+1.21.2-rc1" = _u8Gjr9nC;
        "pkg-2.1.1+1.21.2-1.21.3" = _5Tob96Cb;
        "pkg-2.1.1+1.21.4" = _BjqYiaQm;
        "pkg-2.1.2+1.21.4" = _JOM9NOTK;
        "pkg-2.1.3+1.21.4" = _CuXLegeC;
        "pkg-2.1.4+1.21.5" = _xUya3ggY;
        "pkg-2.1.5+1.21.5" = _gkdXQW6F;
        "pkg-2.1.6+1.21.5" = _DILLXbPo;
        "pkg-2.1.6+1.21.6" = _4EzJvBAL;
        "pkg-2.1.7+1.21.6" = _mHI69wyB;
        "pkg-2.1.8+1.21.6" = _8NRfXLnI;
        "pkg-2.1.9+1.21.9" = _UqquvcY1;
        "pkg-2.1.10+1.21.9" = _kHQd7Igw;
        "pkg-2.1.11+1.21.9" = _u6zgGgQF;
        "pkg-2.1.0-patch.1+1.21-1.21.1" = _nOuYwhh8;
        "pkg-2.1.12+1.21.9" = _mK1itgsT;
        "pkg-2.1.0-patch.2+1.21-1.21.1" = _SkKZAFtn;
        "pkg-2.1.13+1.21.11" = _DWFauvm6;
        "pkg-2.1.14+1.21.11" = _oNjOArT1;
