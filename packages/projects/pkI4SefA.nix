...
let
    ...
    in {
        ...
        "pkg-1.0" = _qiBPpAtO;
        "pkg-1.1" = _4i0EHdzx;
        "pkg-1.2-backport" = _UxFKiTOV;
        "pkg-1.3" = _W4xVo934;
        "pkg-1.3-backport" = _xm5YzAkU;
        "pkg-1.4" = _j0GO14k6;
        "pkg-1.4-backport" = _PzzsinVa;
        "pkg-1.4.5" = _XXT2MuD2;
        "pkg-1.4.5-backport-2" = _veinXBO6;
        "pkg-1.4.6" = _eI0fJ52X;
        "pkg-1.4.6-backport" = _HxtGnIs9;
        "pkg-1.5" = _QVSrln4M;
        "pkg-1.5-backport" = _Kml1mri0;
        "pkg-1.5.1" = _AwGY1mmW;
        "pkg-1.6" = _Cp9cvTsW;
        "pkg-1.6.2" = _FHVBpLRB;
        "pkg-1.6.3" = _GjbssRT5;
        ...
        "pkg-2.4" = _gCfJSojX;
        "pkg-2.5.0" = _a9byOIPF;
        "pkg-3.0.0-ALPHA" = _yuF0NuIN;
        "pkg-3.0.0-BETA" = _3XEEPkrE;
        "pkg-3.0.0" = _PkacOMW6;
        "pkg-3.2.0" = _4w3dvVQu;
        "pkg-3.3.0" = _7YtlJ3VT;
        "pkg-3.4.0" = _3OZiCxO9;
