...
let
    ...
    in {
        ...
        "pkg-1.0.0.1" = _OuGmiS5f;
        "pkg-1.0.0.2" = _U2Vr3swZ;
        "pkg-1.0.0.3" = _u5r0JDiV;
        "pkg-1.0.0.4" = _U1eFwhYM;
        "pkg-1.0.1.0" = _myWQgeY2;
        "pkg-1.0.1.1" = _gsyuLy1c;
        "pkg-1.0.2.0" = _IknqYyh2;
        "pkg-1.0.2.1" = _lIiRJz4G;
        "pkg-1.0.2.2" = _mdS06pl8;
        "pkg-1.0.2.3" = _Ed5BY5As;
        "pkg-1.0.2.4" = _V3uFXhQR;
        "pkg-1.0.2.5" = _FPytJLns;
        "pkg-1.0.2.6" = _x6ByTow5;
        "pkg-1.0.3.0" = _xj5op8jn;
        "pkg-1.0.3.1" = _qC7CM3Fq;
        "pkg-1.0.3.2" = _YkH3OHfZ;
        "pkg-1.0.3.3" = _66pTQhtG;
        "pkg-1.0.3.4" = _mbiWlmzK;
        "pkg-1.0.4.0" = _OXmGEWXc;
        "pkg-1.0.4.1" = _QwE0IvFI;
        "pkg-1.0.4.2" = _32d6Nxty;
        "pkg-1.0.4.3" = _GNHHGACv;
        "pkg-1.19.2-1.0.4.4" = _CpPjnSPB;
        "pkg-1.21.1-2.0.0.0" = _HOghVJna;
        "pkg-1.21.1-2.0.0.1" = _DMZ3hO3X;
        "default" = _DMZ3hO3X;
    });
