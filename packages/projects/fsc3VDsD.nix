...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.x" = _ywbwrZfc;
        "pkg-1.0.0+1.20.1" = _LGxTtPRq;
        "pkg-1.1.0+1.21.x" = _ufP5oX6u;
        "pkg-1.1.0+1.20.1" = _tl1hOsPD;
        "pkg-1.1.1+1.20.1" = _DP9Tp0FN;
        "pkg-1.1.1+1.21.x" = _WMjrhZsb;
        "pkg-1.2.0+1.21.x" = _tzUGvFcI;
        "pkg-1.2.0+1.20.1" = _DEn6kbdo;
        "pkg-1.2.1+1.21.x" = _kcvVt1uP;
        "pkg-1.2.1+1.20.1" = _BuAIypGu;
        "pkg-1.2.2+1.21.x" = _yTCpQZKL;
        "pkg-1.2.2+1.20.1" = _LDnnVzd0;
        "pkg-1.3.0+1.21.x" = _PcUViTUk;
        "pkg-1.3.0+1.20.1" = _Vv3TPOME;
        "pkg-1.3.1+1.21.x" = _t3XkyGVu;
        "pkg-1.3.1+1.20.1" = _3dsjXggP;
        "pkg-1.3.2+1.21.x" = _fv8DZBXi;
        "pkg-1.3.2+1.20.1" = _agOZyrSN;
        "pkg-1.4.0+1.21.x" = _F2LrJiJi;
        "pkg-1.4.0+1.20.1" = _lPOZ3OM9;
        "pkg-1.4.1+1.21.x" = _dFZMfLAX;
        "pkg-1.4.1+1.20.1" = _vGNcE1uI;
        "pkg-1.4.2+1.21.x" = _Peyy1O6c;
        "pkg-1.4.2+1.20.1" = _me8qwtuH;
        "default" = _me8qwtuH;
    });
