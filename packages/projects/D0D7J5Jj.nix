...
let
    ...
    in {
        ...
        "pkg-1.0.0-mc1.20.4" = _awFtyaMm;
        "pkg-1.1.0-mc1.20.4" = _Zndsvggp;
        "pkg-1.1.0-mc1.20.5" = _b0aIpMxQ;
        "pkg-1.2.0-mc1.20.4" = _ShYbglAD;
        "pkg-1.2.0-mc1.20.6" = _1SkFVr74;
        "pkg-1.2.0-mc1.21.0" = _YeaK6IyT;
        "pkg-1.2.1-mc1.20.4" = _iGPy7Bt4;
        "pkg-1.2.1-mc1.20.6" = _7sCv4NNl;
        "pkg-1.2.1-mc1.21.0" = _FEg58vv9;
        "pkg-1.2.2-mc1.20.4" = _JnTCWSeW;
        "pkg-1.2.2-mc1.20.6" = _hVkqzrYo;
        "pkg-1.2.2-mc1.21.0" = _kekK9hXp;
        "pkg-1.2.3-mc1.20.4" = _vxlaz8Sg;
        "pkg-1.2.3-mc1.20.6" = _vFnKB2rc;
        "pkg-1.2.3-mc1.21.0" = _x5dckbNH;
        "pkg-1.2.3-mc1.21.2" = _kTTMaDNg;
        "pkg-1.2.4-mc1.20.4" = _hr1uBha0;
        "pkg-1.2.4-mc1.20.6" = _y1ofRhQa;
        "pkg-1.2.4-mc1.21.2" = _Jd34MvTH;
        "pkg-1.2.4-mc1.21.0" = _BWvtfWsv;
        "pkg-1.2.5-mc1.20.4" = _RHTgzTYP;
        "pkg-1.2.5-mc1.20.6" = _IKuJY0La;
        "pkg-1.2.5-mc1.21.0" = _oxmNyGy3;
        "pkg-1.2.5-mc1.21.2" = _QXwlFeAG;
        "pkg-1.2.6-mc1.21.6" = _uprdP0Xk;
        "pkg-1.2.6-mc1.21.9" = _t03ClsIk;
        "pkg-1.2.7-mc1.20.4" = _Ucn6F0KQ;
        "pkg-1.2.7-mc1.20.6" = _2FMrFVJj;
        "pkg-1.2.7-mc1.21.0" = _LD99mDi3;
        "pkg-1.2.7-mc1.21.2" = _gsbm0Ds9;
        "pkg-1.2.7-mc1.21.9" = _JzAwj9BR;
        "pkg-1.2.7-mc1.21.6" = _qlx2hPDP;
        "pkg-1.2.8-mc26.1" = _Cq1cSSdf;
        "default" = _Cq1cSSdf;
    });
