...
let
    ...
    in {
        ...
        "pkg-1.0" = _PGlemMyA;
        "pkg-1.0+mod" = _hz8wzjMD;
        "pkg-1.0.1" = _Mbd1HJoB;
        "pkg-1.0.1+mod" = _AFmaeWzt;
        "pkg-1.0.2" = _YY1a4oG6;
        "pkg-1.0.2+mod" = _wRoz6GPt;
        "pkg-1.0.3" = _Frsq5RUw;
        "pkg-1.0.3+mod" = _sOteVM4R;
        "pkg-1.0.3a" = _cTNtVe7X;
        "pkg-1.0.3a+mod" = _ewr4uZoN;
        "pkg-1.0.4" = _GosCdOuu;
        "pkg-1.0.5" = _e8Sxju8w;
        "pkg-1.0.6" = _qsg5bbYU;
        "pkg-2.0.0" = _Nd1BnZJP;
        "pkg-2.0.1" = _nPLFMnRF;
        "pkg-2.0.1a" = _sRwIHcLM;
        "pkg-2.0.2" = _sin8SvZ4;
        "pkg-2.0.3" = _gXtiZYub;
        "pkg-2.0.4" = _5ITGRDDt;
        "pkg-2.0.5" = _Uovpa2lA;
        ...
        "pkg-2.0.7" = _yrx2Hkrb;
        "pkg-2.1.0" = _vJojmZED;
        "pkg-2.1.0-fabric-26.1" = _HRt6OEc7;
        "pkg-2.1.0-neoforge-26.1" = _5NqoAYiM;
        "pkg-2.1.1-fabric-21.1" = _GldkL6Pm;
        "pkg-2.1.1-neoforge-21.1" = _ywx8hTAR;
        "pkg-2.1.1-fabric-26.1" = _VAG2BYYG;
        "pkg-2.1.1-neoforge-26.1" = _58YaHBI1;
        "pkg-2.1.1-fabric-26.2" = _cNSXeDpz;
        "pkg-2.1.1-neoforge-26.2" = _T7cIjDlq;
        "default" = _T7cIjDlq;
    });
