...
let
    ...
    in {
        ...
        "pkg-v1.19.1" = _F0LwxG3S;
        "pkg-v1.20.0" = _dLwxAVZD;
        "pkg-v1.21.0" = _gk7dPJnZ;
        "pkg-v1.22.0" = _V3WqnjgB;
        "pkg-v1.22.1" = _cKesl7M1;
        "pkg-v1.23.0" = _w60JPGhg;
        "pkg-1.24.0" = _JFHpetzC;
        "pkg-1.25.0" = _s2KA8Gx0;
        "pkg-1.26.0" = _f3jk3HfM;
        "pkg-1.27.0" = _bST9MQmT;
        "pkg-1.28.0" = _Q2oGUeTm;
        "pkg-1.28.1" = _chdO8CY2;
        "pkg-1.28.2" = _je6Y2c8c;
        "pkg-1.29.0" = _TLF51fCO;
        "pkg-1.30.0" = _Dkw0MZWN;
        "pkg-1.31.0" = _hDCS1EzF;
        "pkg-1.31.1" = _B0gDnLuX;
        "pkg-1.32.0" = _sbrJxSwl;
        "pkg-1.33.0" = _EfYubucq;
        "pkg-1.34.0" = _EyNZnXS9;
        "pkg-1.34.1" = _wKf2ImKX;
        "pkg-1.34.2" = _GxLzUeZa;
        "pkg-1.34.3" = _hYRDYNLq;
        "pkg-1.34.4" = _8BUTy8aC;
        "pkg-1.34.5" = _MdOzDTVn;
        "pkg-1.35.0" = _sTsoYxIG;
        "pkg-1.35.1" = _zKHSTaIM;
        "pkg-1.36.0" = _CDqR4k7K;
        "pkg-1.36.1" = _MwetIWLU;
        "pkg-1.36.2" = _CTBBC4Ui;
        "pkg-1.36.3" = _W4NNLVeB;
        "pkg-1.37.0" = _VfuqkKDQ;
        "pkg-1.37.1" = _zyysnl5l;
        "pkg-1.37.2" = _oHcryM75;
        "default" = _oHcryM75;
    });
