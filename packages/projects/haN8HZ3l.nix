...
let
    ...
    in {
        ...
        "pkg-0.5.0-pre.0" = _cDKEAEAC;
        "pkg-0.5.0-pre.1" = _4TcJLsQe;
        "pkg-0.5.0.pre.2" = _Bjizz1yy;
        "pkg-0.5.2" = _YgDIjE53;
        "pkg-0.5.3" = _a64moqsT;
        "pkg-0.8.21" = _L98tmmGs;
        "pkg-1.0.0+preview.1" = _ZTPAXs9v;
        "pkg-1.0.0+preview.1+fix.1" = _KA8y8Aib;
        "pkg-26.1-0" = _g2zKDPCX;
