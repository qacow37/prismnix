...
let
    ...
    in {
        ...
        "pkg-0.4.2" = _lH8qJ76L;
        "pkg-0.4.3" = _yJDqUQBZ;
        "pkg-0.4.3.1" = _Z70oWTcf;
        "pkg-0.4.3.2" = _kOlS3mTQ;
        "pkg-0.4.3.3" = _Sr6PElth;
        "pkg-0.4.3.4" = _w0l0ycda;
        "pkg-0.4.3.5" = _fKWJlG19;
        "pkg-0.5.0" = _guS5slYX;
        "pkg-0.5.1" = _fP67RwtT;
        "pkg-0.5.2" = _NUusgR9e;
        "pkg-0.5.3" = _qFkCEsxk;
        ...
        "pkg-0.9.2" = _witM64XR;
        "pkg-1.0.0" = _LQ2f0QRC;
        "pkg-1.0.0-rev1" = _UROzhNAh;
        "pkg-1.0.0-rev2" = _E3X5Neb0;
        "pkg-1.0.0-rev3" = _UoopXnzs;
        "pkg-1.0.0-rev4" = _4WGuMBGn;
        "pkg-1.0.0-rev5" = _k93KPx4H;
        "pkg-1.0.0-rev6" = _xGtsONJp;
