...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.9-fabric" = _LCaqWi3c;
        "pkg-1.18.2-1.9-fabric" = _JB7ERqex;
        "pkg-1.19.2-2.1-fabric" = _dW2tYzQm;
        "pkg-1.16.5-1.4-forge" = _xVaqGq22;
        "pkg-1.18.2-1.6-forge" = _eKGzjrsU;
        "pkg-1.19.2-1.8-forge" = _Ukrb1qe9;
        "pkg-1.16.5-2.2-fabric" = _S4rUVOzv;
        "pkg-1.18.2-2.2-fabric" = _HqvBT0Kt;
        "pkg-1.19.2-2.2-fabric" = _qKdsywH6;
        "pkg-1.19.3-2.3-fabric" = _gbf1L0fS;
        "pkg-1.19.3-1.8-forge" = _JmBZWsVd;
        "pkg-1.18.2-3.0-forge+fabric" = _TnvyBjWk;
        "pkg-1.19.2-3.0-forge+fabric" = _zIcFfZXc;
        "pkg-1.19.3-3.0-forge+fabric" = _78Tl2e8e;
        "pkg-1.19.4-3.0-forge+fabric" = _s5QW91Lw;
        "pkg-1.20-3.0-forge+fabric" = _3NFJHmMB;
        "pkg-1.20.1-3.0-forge+fabric" = _FRA4lNsV;
        "pkg-1.20.2-3.0-forge+fabric" = _vX4fq7zV;
        "pkg-1.18.2-3.1-forge+fabric" = _ZfMXVxxd;
        "pkg-1.19.2-3.1-forge+fabric" = _Em4odTeh;
        "pkg-1.20.1-3.1-forge+fabric" = _58vpWdbf;
        "pkg-1.20.2-3.1-forge+fabric" = _AiMesBuF;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _zk1iu1iH;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _w9t3pAGf;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _wmgHQrOJ;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _zSTzYkJu;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _SPyw7ntt;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _BKRP4oCQ;
        "pkg-1.20.5-3.2-fabric+neo" = _rVkPbo2X;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _DAAvHmNn;
        "pkg-1.21.0-3.2-fabric+forge+neo" = _E6UcE4NX;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _g4Sod5Qo;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _mcGN42FN;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _O1yHrm8U;
        "pkg-1.21.1-3.3-fabric+forge+neo" = _QdMkn3AB;
        "pkg-1.21.2-3.3-fabric+neo" = _3fsnUzZo;
        "pkg-1.21.3-3.3-fabric+forge+neo" = _AbxOFC1O;
        "pkg-1.21.4-3.3-fabric+forge+neo" = _3jOi6Qi7;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _PrrHinLr;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _y1BpbvCk;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _LkQOIfCI;
        "pkg-1.21.5-3.4-fabric+forge+neo" = _NVtZi4Mw;
        "pkg-1.21.6-3.4-fabric+forge+neo" = _3aLardcO;
        "pkg-1.21.7-3.4-fabric+forge+neo" = _bE8nUFUv;
        "pkg-1.21.8-3.4-fabric+forge+neo" = _mWwBuVO5;
        "pkg-1.21.9-3.4-fabric+forge+neo" = _Cx9z1y3M;
        "pkg-1.21.10-3.4-fabric+forge+neo" = _VH8dI1rx;
        "pkg-1.21.11-3.4-fabric+forge+neo" = _7uLr7YmD;
        "pkg-26.1.0-3.4-fabric+forge+neo" = _vgJehsxC;
        "pkg-26.1.1-3.4-fabric+forge+neo" = _RrkdGVG6;
        "pkg-26.1.2-3.4-fabric+forge+neo" = _jFDr6BRY;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _6IlLmP0j;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _huSwHsgo;
        "default" = _huSwHsgo;
    });
