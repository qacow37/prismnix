...
let
    ...
    in {
        ...
        "pkg-0.1.4-alpha-MC-1.21.4" = _5Cqvt175;
        "pkg-0.1.4-alpha-MC-1.21.1" = _4FsoDe2H;
        "pkg-0.1.4-hf1-alpha-MC-1.21.1" = _KIGoZK5Q;
        "pkg-0.2.0-beta" = _2Jz3fzfB;
        "pkg-0.2.1-beta" = _F7NGWMff;
        "pkg-0.2.1-hf1-beta" = _TSRM39t4;
        "pkg-0.2.1-hf2-beta" = _SON6LmdT;
        "pkg-0.2.2-beta" = _NK3uTQPQ;
        "pkg-0.2.3-beta" = _CxsGuJ7R;
        "pkg-0.3.0-beta" = _KelDww3I;
        "pkg-0.3.0-hf1-beta" = _XtSGUr9b;
        "pkg-0.4.1-beta" = _G9VtumjN;
        "pkg-0.5.0-NFG-1.21.4" = _v8dBhOfD;
        "pkg-0.5.0-FBR-1.21.6" = _SL7e05iS;
        "pkg-0.5.0-FBR-1.21.4" = _3LiklJZu;
        "pkg-0.5.0-FBR-1.21.1" = _IyK6EsER;
        "pkg-0.5.0-FBR-1.20.1" = _8ETnfmph;
        "pkg-0.5.0-NFG-1.21.1" = _EFKwxZAc;
        "pkg-0.5.1-NFG-1.21.8" = _wMGMVWB2;
        "pkg-0.5.1-NFG-1.21.4" = _5my953nE;
        "pkg-0.5.1-NFG-1.21.1" = _YBZ7VQuY;
        "pkg-0.5.1-FBR-1.21.6" = _j1Yq7YAs;
        "pkg-0.5.1-FBR-1.21.4" = _O1d1nBWx;
        "pkg-0.5.1-FBR-1.20.1" = _XMVylomU;
        "pkg-0.5.1-FBR-1.21.1" = _AW8KVwoK;
        "pkg-0.5.2-NFG-1.21.8" = _Aool47e3;
        "pkg-0.5.2-NFG-1.21.1" = _SU8hAAMM;
        "pkg-0.5.2-NFG-1.21.4" = _5d26RSrf;
        "pkg-0.5.2-FBR-1.21.4" = _WH6RRHO4;
        "pkg-0.5.2-FBR-1.21.6" = _nN10ZzNc;
        "pkg-0.5.2-FBR-1.20.1" = _xjwI6W10;
        "pkg-0.5.2-FBR-1.21.1" = _sfl4I8ZU;
        "pkg-0.5.3-NFG-1.21.8" = _lOHu6YdW;
        "pkg-0.5.3-FBR-1.21.6" = _dkOajuEu;
        "pkg-0.5.3-NFG-1.21.4" = _PB1IN5g0;
        "pkg-0.5.3-FBR-1.21.4" = _IuZj8wjl;
        "pkg-0.5.3-NFG-1.21.1" = _KFzjzSff;
        "pkg-0.5.3-FBR-1.21.1" = _h5Znx2yX;
        "pkg-0.5.3-FBR-1.20.1" = _ltrX1TgR;
        "pkg-0.6.0-NFG-1.21.8" = _3jDKSMhG;
        "pkg-0.6.0-NFG-1.21.4" = _nwZYQWy4;
        "pkg-0.6.0-FBR-1.21.6" = _Ef3f9mY2;
        "pkg-0.6.0-FBR-1.21.4" = _YjlYYfZf;
        "pkg-0.6.0-NFG-1.21.1" = _c9uwUEtq;
        "pkg-0.6.0-FBR-1.21.1" = _daEC3Ulj;
        "pkg-0.6.0-FBR-1.20.1" = _WMLLCf4Z;
        "pkg-0.6.1-NFG-1.21.8" = _QHyEKHvx;
        "pkg-0.6.1-NFG-1.21.4" = _ZS7I2grK;
        "pkg-0.6.1-NFG-1.21.1" = _14sDqhRd;
        "pkg-0.6.1-FBR-1.21.6" = _ZokaUSBc;
        "pkg-0.6.1-FBR-1.21.4" = _2V8YsR5h;
        "pkg-0.6.1-FBR-1.20.1" = _p3IP14FE;
        "pkg-0.6.1-FBR-1.21.1" = _hHhTNJyF;
        "pkg-0.6.2-NFG-1.21.5" = _WwU9VBZX;
        "pkg-0.6.2-NFG-1.21.8" = _LMVdym1g;
        "pkg-0.6.2-NFG-1.21.4" = _tPUuTrSO;
        "pkg-0.6.2-NFG-1.21.1" = _l6gQBFNZ;
        "pkg-0.6.2-FBR-1.21.6" = _CT9nk6tK;
        "pkg-0.6.2-FBR-1.21.5" = _JPpZKfK1;
        "pkg-0.6.2-FBR-1.21.4" = _1Vt7B2cI;
        "pkg-0.6.2-FBR-1.21.1" = _A4Fy6KiF;
        "pkg-0.6.2-FBR-1.20.1" = _ORaQmvOY;
        "pkg-0.7.0-NFG-1.21.8" = _VvQ1LXNt;
        "pkg-0.7.0-FBR-1.21.6" = _ETJlFd68;
        "pkg-0.7.0-NFG-1.21.5" = _tQe6Izfj;
        "pkg-0.7.0-NFG-1.21.4" = _LYphFv6X;
        "pkg-0.7.0-FBR-1.21.5" = _Qt1DMgNK;
        "pkg-0.7.0-NFG-1.21.1" = _IUCEcDSW;
        "pkg-0.7.0-FBR-1.21.4" = _vBaGGkCC;
        "pkg-0.7.0-FBR-1.20.1" = _n1zI6wEJ;
        "pkg-0.7.0-FBR-1.21.1" = _imrnv4tw;
        "pkg-0.7.1-NFG-1.21.8" = _yxbM86RA;
        "pkg-0.7.1-NFG-1.21.5" = _K52YimWX;
        "pkg-0.7.1-NFG-1.21.4" = _shKjSY8w;
        "pkg-0.7.1-FBR-1.21.6" = _ulnIseHx;
        "pkg-0.7.1-FBR-1.21.5" = _3AuXLPrH;
        "pkg-0.7.1-NFG-1.21.1" = _X0T2TOiU;
        "pkg-0.7.1-FBR-1.21.4" = _bepXB3O4;
        "pkg-0.7.1-FBR-1.20.1" = _Ya93KrGF;
        "pkg-0.7.1-FBR-1.21.1" = _4zL5UMBe;
        "pkg-0.7.2-NFG-1.21.8" = _ydJTscxR;
        "pkg-0.7.2-NFG-1.21.5" = _u1D5NJb7;
        "pkg-0.7.2-FBR-1.21.9" = _pCiVbJAX;
        "pkg-0.7.2-FBR-1.21.6" = _trxu0Wnv;
        "pkg-0.7.2-FBR-1.21.5" = _mNNGAnNm;
        "pkg-0.7.2-NFG-1.21.4" = _CHjVbxcS;
        "pkg-0.7.2-FBR-1.21.4" = _YqKIW1Kp;
        "pkg-0.7.2-HF1-NFG-1.21.8" = _oUiyuxZw;
        "pkg-0.7.2-HF1-FBR-1.21.9" = _PJZZHynX;
        "pkg-0.7.2-HF1-FBR-1.21.6" = _lb1tCm6y;
        "pkg-0.7.2-HF1-NFG-1.21.5" = _SS92F7CF;
        "pkg-0.7.2-HF1-NFG-1.21.4" = _gaYHX81q;
        "pkg-0.7.2-HF1-FBR-1.21.5" = _aNx5V7Ym;
        "pkg-0.7.2-HF1-NFG-1.21.1" = _Y6I3vrl1;
        "pkg-0.7.2-HF1-FBR-1.21.4" = _8PYv0ZC8;
        "pkg-0.7.2-HF1-FBR-1.21.1" = _kQj89RqF;
        "pkg-0.7.3-NFG-1.21.8" = _aEcbJpWL;
        "pkg-0.7.3-FBR-1.21.6" = _7EtrQy8D;
        "pkg-0.7.3-NFG-1.21.5" = _DY13cRrO;
        "pkg-0.7.3-NFG-1.21.4" = _LKqoElpM;
        "pkg-0.7.3-FBR-1.21.5" = _t9WoaMI6;
        "pkg-0.7.3-NFG-1.21.1" = _JCtD1KtP;
        "pkg-0.7.3-FBR-1.21.4" = _8Itg1idr;
        "pkg-0.7.3-FBR-1.21.1" = _KksVnroO;
        "pkg-0.7.3-FBR-1.21.10" = _7ywjVPBt;
        "pkg-0.8.0-NFG-1.21.8" = _VLsXAkJ8;
        "pkg-0.8.0-NFG-1.21.5" = _AolROXpW;
        "pkg-0.8.0-NFG-1.21.4" = _8qjO9kd6;
        "pkg-0.8.0-FBR-1.21.6" = _fWleFORy;
        "pkg-0.8.0-FBR-1.21.5" = _bNXAPoJx;
        "pkg-0.8.0-FBR-1.21.4" = _10IukaB7;
        "pkg-0.8.0-FBR-1.21.10" = _Xr1tz20G;
        "pkg-0.8.0-FBR-1.21.1" = _q6Kysgl1;
        "pkg-0.8.0-NFG-1.21.1" = _sJvGqYyg;
        "pkg-0.8.1-NFG-1.21.4" = _GFVVC9Kx;
        "pkg-0.8.1-NFG-1.21.5" = _QvQnALia;
        "pkg-0.8.1-NFG-1.21.8" = _qOFRN77G;
        "pkg-0.8.1-NFG-1.21.1" = _vdzfZAQF;
        "pkg-0.8.1-FBR-1.21.8" = _toeMlrDj;
        "pkg-0.8.1-FBR-1.21.5" = _62z3KNko;
        "pkg-0.8.1-FBR-1.21.10" = _IZcYzXKM;
        "pkg-0.8.1-FBR-1.21.4" = _iMw4Mhfs;
        "pkg-0.8.1-FBR-1.21.1" = _lOqy1viX;
        "pkg-0.8.1-HF1-NFG-1.21.8" = _izzc01Lf;
        "pkg-0.8.1-HF1-NFG-1.21.5" = _etSFZQix;
        "pkg-0.8.1-HF1-NFG-1.21.4" = _uXFoiZgh;
        "pkg-0.8.1-HF1-FBR-1.21.5" = _a8jNhBtN;
        "pkg-0.8.1-HF1-FBR-1.21.8" = _EX6VyH4h;
        "pkg-0.8.1-HF1-NFG-1.21.1" = _sFyv61U9;
        "pkg-0.8.1-HF1-FBR-1.21.4" = _SnTZxzeL;
        "pkg-0.8.1-HF1-FBR-1.21.10" = _HN6ZtMGd;
        "pkg-0.8.1-HF1-FBR-1.21.1" = _7ojE1ffS;
        "pkg-0.8.1-HF1-FBR-1.21.11-pre3" = _duywTceK;
        "pkg-0.8.2-FBR-1.21.1" = _Vf3vZnst;
        "pkg-0.8.2-NFG-1.21.1" = _owePslaK;
        "pkg-0.8.2-FBR-1.21.10" = _XnuwDybd;
        "pkg-0.8.2-NFG-1.21.10" = _ekBM2373;
        "pkg-0.8.2-FBR-1.21.4" = _PnHDMD4J;
        "pkg-0.8.2-NFG-1.21.4" = _CNqwXoks;
        "pkg-0.8.2-NFG-1.21.5" = _tU0ijnhx;
        "pkg-0.8.2-FBR-1.21.5" = _5jMQYas1;
        "pkg-0.8.2-FBR-1.21.8" = _qA98T1iV;
        "pkg-0.8.2-NFG-1.21.8" = _62xy1FpP;
        "pkg-0.8.2-FBR-1.21.11" = _17mRuXks;
        "pkg-0.9.0-FBR-1.21.10" = _2ubgucjl;
        "pkg-0.9.0-NFG-1.21.10" = _VM56ozOv;
        "pkg-0.9.0-FBR-1.21.11" = _AxZeRHoS;
        "pkg-0.9.0-NFG-1.21.4" = _4Lc9GAIo;
        "pkg-0.9.0-FBR-1.21.5" = _FSOlLrP2;
        "pkg-0.9.0-FBR-1.21.4" = _zLfBeBn8;
        "pkg-0.9.0-NFG-1.21.5" = _nIoybQ4Q;
        "pkg-0.9.0-FBR-1.21.8" = _lFJybCLv;
        "pkg-0.9.0-NFG-1.21.8" = _JqSXG9qa;
        "pkg-0.9.2-FBR-1.21.4" = _9cx3a3oQ;
        "pkg-0.9.2-NFG-1.21.4" = _PNAGxN5O;
        "pkg-0.9.2-FBR-1.21.5" = _LdqqbmVz;
        "pkg-0.9.2-NFG-1.21.5" = _SHDc5PQg;
        "pkg-0.9.2-FBR-1.21.8" = _ROg82AlR;
        "pkg-0.9.2-NFG-1.21.8" = _tyK9TpJ4;
        "pkg-0.9.2-FBR-1.21.10" = _TzRxfhvO;
        "pkg-0.9.2-NFG-1.21.10" = _pw1X0iNH;
        "pkg-0.9.2-FBR-1.21.11" = _4QLVbHVU;
        "pkg-0.9.2-HF2-FBR-1.21.4" = _60DBbX7m;
        "pkg-0.9.2-HF2-FBR-1.21.5" = _mr85qyer;
        "pkg-0.9.2-HF2-FBR-1.21.8" = _pOYNXnWb;
        "pkg-0.9.2-HF2-FBR-1.21.10" = _rdPZJ0WO;
        "pkg-0.9.2-HF2-FBR-1.21.11" = _Ua6yqLTz;
        "pkg-0.9.2-HF3-FBR-1.21.11" = _Bpv0ZVOK;
        "pkg-0.9.2-HF3-FBR-1.21.10" = _Mv3tRm3Y;
        "pkg-0.9.2-HF3-FBR-1.21.8" = _teaHHSte;
        "pkg-0.9.2-HF3-FBR-1.21.5" = _JuCz1AU4;
        "pkg-0.9.2-HF3-FBR-1.21.4" = _kSX61JBA;
        "pkg-0.9.2-HF3-FBR-26.1-snapshot-2" = _9Swgs2jZ;
        "pkg-0.9.2-HF2-FBR-26.1" = _PPiMew22;
        "pkg-0.9.3-NFG-1.21.10" = _hC7ozA4b;
        "pkg-0.9.3-FBR-1.21.10" = _OZ1BWPlO;
        "pkg-0.9.3-NFG-1.21.4" = _hZm7w1r7;
        "pkg-0.9.3-FBR-1.21.11" = _jOIkbFDD;
        "pkg-0.9.3-FBR-1.21.4" = _Md3vHZG3;
        "pkg-0.9.3-NFG-1.21.5" = _1FBbigFZ;
        "pkg-0.9.3-FBR-1.21.5" = _CS0sVTS8;
        "pkg-0.9.3-NFG-1.21.8" = _v85JaXxn;
        "pkg-0.9.3-FBR-1.21.8" = _C3H4KCys;
        "pkg-0.9.3-FBR-26.1" = _GT5OGHH5;
        "pkg-0.9.4-FBR-1.21.10" = _fDvvhvis;
        "pkg-0.9.4-NFG-1.21.10" = _MWHVKF2b;
        "pkg-0.9.4-FBR-1.21.11" = _VRubwHTr;
        "pkg-0.9.4-FBR-1.21.4" = _UORwN1kh;
        "pkg-0.9.4-NFG-1.21.4" = _TUSmf70B;
        "pkg-0.9.4-FBR-1.21.5" = _PeABNMWk;
        "pkg-0.9.4-NFG-1.21.5" = _IbRklU7t;
        "pkg-0.9.4-FBR-1.21.8" = _e4KemYtc;
        "pkg-0.9.4-NFG-1.21.8" = _Irm9sRPM;
        "pkg-0.9.4-FBR-26.1" = _ou7rEcol;
        "pkg-0.9.5-FBR-1.21.10" = _18XGMGCV;
        "pkg-0.9.5-NFG-1.21.10" = _7uGD4Vud;
        "pkg-0.10.0-FBR-26.1" = _OJayDCtl;
