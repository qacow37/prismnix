...
let
    ...
    in {
        ...
        "pkg-v1.0.0" = _aIgnC7B3;
        "pkg-v1.0.0-mod" = _Ped0gKfE;
        "pkg-v1.0.1" = _ldB2FP0p;
        "pkg-v1.0.1-mod" = _AXbnuOm2;
        "pkg-v1.1.0" = _HejYxzb7;
        "pkg-v1.1.0-mod" = _4ksVJ9wG;
        "pkg-v1.1.1" = _5kI2MM3h;
        "pkg-v1.1.1-mod" = _79LJUOyc;
        "pkg-v1.1.2" = _9OZO8LEY;
        "pkg-v1.1.2-mod" = _Bv0CbJO6;
        "pkg-v1.2.0" = _SHKOi3O4;
        "pkg-v1.2.0-mod" = _ZFhz9gLZ;
        "pkg-v1.2.1" = _u73wE4Xd;
        "pkg-v1.2.1-mod" = _lGcONIce;
        "pkg-v1.3.0" = _L4LP4Tmr;
        "pkg-v1.3.0-mod" = _OMjTFEd5;
        "pkg-v1.3.1" = _RJKlZkh8;
        "pkg-v1.3.1-mod" = _RXj3WB7p;
        "pkg-v1.3.2" = _vtJ2U9mR;
        "pkg-v1.3.2-mod" = _eLQ2OIk1;
        "pkg-v1.3.3" = _A1Rku3aD;
        "pkg-v1.3.3-mod" = _tbTo9nrJ;
        "pkg-v1.3.4" = _xf62Hfwv;
        "pkg-v1.3.4-mod" = _fIFdwOoC;
        "pkg-v1.3.5" = _XbhyNiox;
        "pkg-v1.3.5-mod" = _BEzSDiNb;
        "pkg-v1.3.6" = _g4ZGJjbN;
        "pkg-v1.3.6-mod" = _Q8sdtMVi;
        "pkg-v1.3.7" = _OGr0bCXY;
        "pkg-v1.3.7-mod" = _bFWGbghW;
        "pkg-v1.3.8" = _9U1rZrIA;
        "pkg-v1.3.8-mod" = _ffN2Rl6i;
        "pkg-v1.3.9" = _Dg3dE2Kr;
        "pkg-v1.3.9-mod" = _Cxk7evdA;
        "pkg-v1.3.10" = _EcauB8Q7;
        "pkg-v1.3.10-mod" = _Bomn1OPo;
        "pkg-v1.3.11" = _6KHR4naf;
        "pkg-v1.3.11-mod" = _rkR8T0Dz;
        "pkg-v1.3.12" = _5yeVJo7e;
        "pkg-v1.3.12-mod" = _atvrDscs;
        "pkg-v1.4.0" = _xS5dPMpv;
        "pkg-v1.4.0-mod" = _9gmJ3ZfV;
        "pkg-v1.4.1" = _AzmH0hWX;
        "pkg-v1.4.1-mod" = _RVlOnAPw;
        "pkg-v1.4.2" = _b93VSzx9;
        "pkg-v1.4.2-mod" = _qJk8VBBb;
        "pkg-v1.4.3" = _8gaPbrQc;
        "pkg-v1.4.3-mod" = _MZVJoo8k;
        "pkg-v1.4.4" = _NtLffaqo;
        "pkg-v1.4.4-mod" = _Pb1HFeA1;
        "pkg-v1.4.5" = _H7ei3TLH;
        "pkg-v1.4.5-mod" = _5zwDoaUV;
        "pkg-v2.0.0" = _9ZPOF8qd;
        "pkg-v2.0.0-mod" = _yr4QARlM;
        "pkg-v2.1.0" = _A9t7utWT;
        "pkg-v2.1.0-mod" = _GcXGEuWL;
        "pkg-v2.2.0" = _WlUtIPRz;
        "pkg-v2.2.0-mod" = _Qh96isqj;
        "pkg-v2.2.1" = _cXlZbNgF;
        "pkg-v2.2.1-mod" = _3dnzcTzE;
        "pkg-v2.3.0" = _dvxmZK4n;
        "pkg-v2.3.0-mod" = _i9mGT6K8;
        "pkg-v2.4.0" = _TUUW9zcM;
        "pkg-v2.4.0-mod" = _Mo6JK7gr;
        "pkg-v3.0.0" = _F7X1XC17;
        "pkg-v3.0.0-mod" = _qIGe0qMj;
        "pkg-v3.0.1" = _IAUpCtcS;
        "pkg-v3.0.1-mod" = _OysnWxxS;
        "pkg-v3.0.2" = _x2wHaJRw;
        "pkg-v3.0.2-mod" = _Ar2SX18i;
        "pkg-v3.0.3" = _XWeWrv0i;
        "pkg-v3.0.3-mod" = _jWQTYFr4;
        "pkg-v3.1.0" = _AcGg6AYH;
        "pkg-v3.1.0-mod" = _fw5R3f3j;
        "pkg-v3.1.1" = _UOD8mP3r;
        "pkg-v3.1.1-mod" = _JT3wqyxR;
        "pkg-v3.2.0" = _gi9goQ9e;
        "pkg-v3.2.0-mod" = _PemuBF20;
        "pkg-v3.3.0" = _rsOmoaID;
        "pkg-v3.3.0-mod" = _OZGnoNS0;
        "pkg-v3.3.1" = _C0l5i0CT;
        "pkg-v3.3.1-mod" = _tVuJpwBR;
        "pkg-v3.3.2" = _DDlA4cTS;
        "pkg-v3.3.2-mod" = _oPdacgtG;
        "pkg-v3.3.3" = _6xYQZWJB;
        "pkg-v3.3.3-mod" = _t4MRO5h1;
        "pkg-v3.3.4" = _4nhTT7SV;
        "pkg-v3.3.4-mod" = _EIqNX0JU;
        "pkg-v3.4.0" = _9uV5CTpp;
        "pkg-v3.4.0-mod" = _DTfDUStz;
        "pkg-v3.4.1" = _h2IdZwEa;
        "pkg-v3.4.1-mod" = _1mbyof7h;
        "pkg-v3.4.2" = _UJ6RM4ih;
        "pkg-v3.4.2-mod" = _nR1Kkgzz;
        "pkg-v3.5.0" = _2f3uNQeJ;
        "pkg-v3.5.0-mod" = _6N3fp7TF;
        "pkg-v3.5.1" = _7KiYXcJk;
        "pkg-v3.5.1-mod" = _yjg4ek3V;
        "pkg-v3.6.0" = _HY8h4Nah;
        "pkg-v3.6.0-mod" = _xUVXvmsa;
        "pkg-v3.6.1" = _hPjZxHnL;
        "pkg-v3.6.1-mod" = _thfy6GqG;
        "pkg-v3.7.0" = _jSyDyGL9;
        "pkg-v3.7.0-mod" = _aHnmLY8R;
        "pkg-v3.7.1" = _2CZSvYAU;
        "pkg-v3.7.1-mod" = _hFMAU8vZ;
        "pkg-v3.8.0" = _WdtHpG3N;
        "pkg-v3.8.0-mod" = _AuBpHd9q;
        "pkg-v3.8.1" = _d7U31UMc;
        "pkg-v3.8.1-mod" = _zzXef5Gq;
        "pkg-v3.8.2" = _h2cQwWv7;
        "pkg-v3.8.2-mod" = _DcbbeRi8;
        "pkg-v3.8.3" = _fI75cuwb;
        "pkg-v3.8.3-mod" = _MTiPGtKR;
        "pkg-v3.8.4" = _Bnhfg9bY;
        "pkg-v3.8.4-mod" = _6HC3Avd1;
        "pkg-v3.8.5" = _HDYRO9Lb;
        "pkg-v3.8.5-mod" = _P24yCl6T;
        "pkg-v3.9.0" = _26ni8JMC;
        "pkg-v3.9.0-mod" = _MHlWPzEz;
        "pkg-v3.9.1" = _aozdXzo7;
        "pkg-v3.9.1-mod" = _yqiQ1t7D;
        "pkg-v3.9.2" = _hIam5h47;
        "pkg-v3.9.2-mod" = _u05f0Kvj;
        "pkg-v3.9.3" = _1trOrzOP;
        "pkg-v3.9.3-mod" = _N22jsaBy;
        "pkg-v3.10.0" = _RcsRhS2k;
        "pkg-v3.10.0-mod" = _XpX7nwvp;
        "pkg-v3.11.0" = _rS1imNPn;
        "pkg-v3.11.0-mod" = _FVqhyYuE;
        "pkg-v3.11.1" = _VjEE1QzA;
        "pkg-v3.11.1-mod" = _gYVAhFMI;
        "pkg-v3.12.0" = _qRFHTChS;
        "pkg-v3.12.0-mod" = _JJMoeQsl;
        "pkg-v3.12.1" = _6DXkHW06;
        "pkg-v3.12.1-mod" = _6Beoueel;
        "pkg-v3.13.0" = _s7Hwq2EW;
        "pkg-v3.13.0-mod" = _nxx1XhhP;
        "pkg-v3.13.1" = _zcqgrLXJ;
        "pkg-v3.13.1-mod" = _smAldtLS;
        "pkg-v3.13.2" = _UMdgykWM;
        "pkg-v3.13.2-mod" = _8fZ0cvom;
        "pkg-v3.14.0" = _zHqYBxxi;
        "pkg-v3.14.0-mod" = _SfcbVmJb;
        "pkg-v3.14.1" = _b3N2UjjY;
        "pkg-v3.14.1-mod" = _pnTVhzZ9;
        "pkg-v3.14.2" = _bNDThw35;
        "pkg-v3.14.2-mod" = _ds97loGH;
        "pkg-v3.14.3" = _2QZpRVFT;
        "pkg-v3.14.3-mod" = _NCM2Tu3g;
        "pkg-v3.15.0" = _nzfyPR10;
        "pkg-v3.15.0-mod" = _aGVhrLlW;
        "pkg-v3.15.1" = _SJexhCTe;
        "pkg-v3.15.1-mod" = _hiDimqhN;
        "pkg-v3.16.0" = _vwboDv64;
        "pkg-v3.16.0-mod" = _w0CHFXJs;
        "pkg-v3.16.1" = _1LgCR19X;
        "pkg-v3.16.1-mod" = _1sb29csy;
        "pkg-v3.16.2" = _4S452alB;
        "pkg-v3.16.2-mod" = _KUkDaFHC;
        "default" = _KUkDaFHC;
    });
