...
let
    ...
    in {
        ...
        "pkg-1.7" = _tZLEfQ6Y;
        "pkg-1.7.1" = _N5RQyB1G;
        "pkg-1.7.1+mod" = _g3vTesmz;
        "pkg-1.7.2" = _R4rEjyxs;
        "pkg-1.7.2+mod" = _HssXmw47;
        "pkg-1.8" = _ezHfZkqs;
        "pkg-1.8+mod" = _qq9gEKCG;
        "pkg-1.8.1" = _gpc5KzVN;
        "pkg-1.8.1+mod" = _Rk8QGmhA;
        "pkg-1.9" = _iJiqCqjI;
        "pkg-1.9+mod" = _Lsf0Xjpo;
        "pkg-1.10" = _mlQrbCLA;
        "pkg-1.10+mod" = _fuBpmcst;
        "pkg-1.10.1" = _3IeHLzPm;
        "pkg-1.10.1+mod" = _yHOTocNp;
        "pkg-1.11" = _mEChzNpR;
        "pkg-1.11+mod" = _WSugUjbH;
        "pkg-1.11.1" = _KvPOJWr4;
        "pkg-1.11.1+mod" = _28qr7Zxx;
        "pkg-1.11.2" = _K9S3hC1R;
        "pkg-1.11.2+mod" = _IRv3aqEu;
        "pkg-1.12" = _Ns3vw3d5;
        "pkg-1.12+mod" = _ZgJa8H4C;
        "pkg-1.13" = _fUnxdo5H;
        "pkg-1.13+mod" = _Tnd4E5JU;
        "pkg-1.14" = _b3SyKI1V;
        "pkg-1.14+Mod" = _gXAJ26GU;
        "pkg-1.14+mod" = _JhvW4Rvb;
        "pkg-1.14.1" = _Yny4eha0;
        "pkg-1.14.1+mod" = _WxPNJH7q;
        "pkg-1.14.2" = _1yo6racO;
        "pkg-1.14.2+mod" = _Ht4cuH3i;
        "pkg-1.15" = _OmjucbPw;
        "pkg-1.15+mod" = _mMn3CKRW;
        "pkg-1.15.1" = _FDFrz9F5;
        "pkg-1.15.1+mod" = _cHcnb3tv;
        "pkg-1.15.2" = _y8Yj8fPA;
        "pkg-1.15.2+mod" = _jL9iUNee;
        "pkg-1.15.3" = _e3TBvZq3;
        "pkg-1.15.3+mod" = _nt39x0cG;
        "pkg-1.16+mod" = _IDLFxzQl;
        "pkg-1.16" = _Dzo69Lep;
        "default" = _Dzo69Lep;
    });
