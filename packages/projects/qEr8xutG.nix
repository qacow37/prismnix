...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _J8T5totm;
        "pkg-1.0.9" = _K8PaW2nO;
        "pkg-1.0.9.1" = _mN0st4tY;
        "pkg-1.0.9.2" = _JhBWxnZx;
        "pkg-1.0.9.3" = _djWeDl3F;
        "pkg-1.0.9.4" = _psG91Ri0;
        "pkg-1.0.9.5" = _UgLHTxSU;
        "pkg-1.0.9.6" = _DgXG2lOX;
        "pkg-1.0.9.7" = _368FYtPu;
        "pkg-1.0.9.8" = _a8T14hAq;
        "pkg-1.0.9.82" = _yPcrIwoS;
        "pkg-1.0.9.9" = _AlsMFKiz;
        "pkg-1.0.9.91" = _OTbZKp3i;
        "pkg-1.0.9.92" = _eJYDTQR7;
        "pkg-1.1.0" = _bh3ueM5Q;
        "pkg-1.1.1" = _Zwuw6yjT;
        "default" = _Zwuw6yjT;
    });
