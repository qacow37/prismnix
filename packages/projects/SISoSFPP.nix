...
let
    ...
    in {
        ...
        "pkg-v8.0.1-1.20.1-Forge" = _A2wzQZLe;
        "pkg-v21.1.0-1.21.1-Fabric" = _gIZr1SQU;
        "pkg-v21.1.0-1.21.1-NeoForge" = _XrWMQGnG;
        "pkg-v21.3.0-1.21.3-Fabric" = _8jvqhJWE;
        "pkg-v21.3.0-1.21.3-NeoForge" = _PYgLoWmW;
        "pkg-v21.3.1-1.21.3-Fabric" = _FACUPMAh;
        "pkg-v21.3.1-1.21.3-NeoForge" = _RZhesUt0;
        "pkg-v8.0.2-1.20.1-Forge" = _bCOmbM3K;
        "pkg-v8.0.2-1.20.1-Fabric" = _skzobhC5;
        "pkg-v21.1.1-1.21.1-Fabric" = _1WLcSEIH;
        "pkg-v21.1.1-1.21.1-NeoForge" = _pFKGwLfy;
        "pkg-v8.0.3-1.20.1-Forge" = _n0AuZc8k;
        "pkg-v8.0.3-1.20.1-Fabric" = _KVprSXXM;
        "pkg-v21.1.2-1.21.1-Fabric" = _1FqW71Li;
        "pkg-v21.1.2-1.21.1-NeoForge" = _fIn2exfa;
        "pkg-v21.3.2-1.21.3-Fabric" = _rdcSvqsT;
        "pkg-v21.3.2-1.21.3-NeoForge" = _Opx7npUD;
        "pkg-v8.0.4-1.20.1-Forge" = _5OURZGyn;
        "pkg-v8.0.4-1.20.1-Fabric" = _40ZQedAc;
        "pkg-v21.1.3-1.21.1-Fabric" = _DsINYFQi;
        "pkg-v21.1.3-1.21.1-NeoForge" = _HJxTPhTM;
        "pkg-v21.3.3-1.21.3-Fabric" = _N9ehzdf0;
        "pkg-v21.3.3-1.21.3-NeoForge" = _CPzink4Z;
        "pkg-v21.4.0-1.21.4-Fabric" = _Zv7Qf4Yp;
        "pkg-v21.4.0-1.21.4-NeoForge" = _mAuWsrDx;
        "pkg-v21.5.0-1.21.5-Fabric" = _J2jwgRto;
        "pkg-v21.5.0-1.21.5-NeoForge" = _eM6hTKay;
        "pkg-v21.7.0-1.21.7-Fabric" = _RmNa0X4M;
        "pkg-v21.7.0-1.21.7-NeoForge" = _bVOEdXZ2;
        "pkg-v21.8.0-1.21.8-Fabric" = _xGaEX1NS;
        "pkg-v21.8.0-1.21.8-NeoForge" = _natMQQfs;
        "pkg-21.9.0" = _GNzpRmxo;
        "pkg-21.10.0" = _GpuW9yDQ;
