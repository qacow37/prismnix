...
let
    ...
    in {
        ...
        "pkg-1.0.0-fabric-1.21.5-0.127.1" = _rjhfxiUb;
        "pkg-1.0.0-forge-1.21.1-52.1.1" = _ESAKO2h8;
        "pkg-1.0.0-fabric-1.21.1-0.116.3" = _X1yjFvAh;
        "pkg-1.0.0-forge-1.20.1-47.4.0" = _JXpBLEeN;
        "pkg-1.0.0-fabric-1.20.1-0.92.6" = _YA0oMYc4;
        "pkg-1.0.0-neoforge-1.21.8-21.8.39" = _hCwlrnfV;
        "pkg-1.0.0-neoforge-1.21.9-21.9.2-b" = _2xV8KW60;
        "pkg-1.0.0-fabric-1.21.9-0.134.0" = _73bLKWoQ;
        "pkg-1.0.0-forge-1.21.9-59.0.1" = _ZceEncLL;
        "pkg-1.0.1-neoforge-1.21.9-21.9.2-b" = _pF4rI6XR;
        "pkg-1.0.1-fabric-1.21.9-0.134.0" = _XMd6E66G;
        "pkg-1.0.1-forge-1.21.9-59.0.5" = _XmJCZYmz;
        "pkg-1.0.1-fabric-1.21.11-0.140.0" = _hSVU4bcP;
        "pkg-1.0.1-neoforge-1.21.11-21.11.10b" = _YltVRWaT;
        "pkg-1.0.1-forge-1.21.11-61.0.2" = _6sWqB32b;
        "pkg-1.0.1-forge-26.1.1-63.0.0" = _XdFU2w1L;
        "pkg-1.0.1-neoforge-26.1.1.1" = _8GU9OeQS;
        "pkg-1.0.1-fabric-26.1.1-0.145.3" = _RdtkEhM1;
        "pkg-1.0.0-neoforge-1.21.1" = _z57djj6F;
        "pkg-1.0.0-forge-1.20.4-49.2.4" = _z3a8k4Qn;
