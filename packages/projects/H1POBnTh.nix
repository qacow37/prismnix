...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _AJFVTaL5;
        "pkg-1.0.2+mod" = _gZcwqVGB;
        "pkg-1.0.2.1" = _y9JjBhpd;
        "pkg-1.0.2.1+mod" = _h9bNwh9Q;
        "pkg-1.0.3" = _5Sqea24K;
        "pkg-1.0.3+mod" = _38mc3VpM;
        "pkg-1.0.3.1" = _86MFKpu4;
        "pkg-1.0.3.1+mod" = _n7zhJNF9;
        "pkg-1.0.4" = _ht9GHbkD;
        "pkg-1.0.4exp" = _UjbfHymr;
        "pkg-1.0.4+mod" = _MlHPA0g5;
        "pkg-1.0.4.1" = _kSdVmyua;
        "pkg-1.0.4.1exp" = _Ve5iGwP8;
        "pkg-1.0.4.1+mod" = _jvFD4xmd;
        "pkg-1.0.4.2" = _zFGfwfbY;
        "pkg-1.0.4.2+mod" = _NdUgDeUT;
        "pkg-1.0.4.3" = _dS8GsPlJ;
        "pkg-1.0.4.4" = _RuPJ9eeJ;
        "pkg-1.0.4.4+mod" = _HyBcVBv1;
        "pkg-1.0.4.5" = _62pfzcSo;
        "pkg-1.0.4.5+mod" = _5K1yCsCZ;
        "pkg-1.0.4.6" = _G7EBbgGB;
        "pkg-1.0.4.6+mod" = _Ekow6HL4;
        "pkg-1.0.5" = _tNjQrQmU;
        "pkg-1.0.5+mod" = _GHWfAUZr;
        "pkg-1.0.5.3" = _ScJ5Dqmd;
