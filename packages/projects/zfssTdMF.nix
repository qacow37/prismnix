...
let
    ...
    in {
        ...
        "pkg-1.0-1.8.8-Forge" = _DQehftVc;
        "pkg-1.0-1.9-Forge" = _rgupmltZ;
        "pkg-1.0-1.9.4-Forge" = _mdzGGLjc;
        "pkg-1.0-1.10.2-Forge" = _Hd8q4pt6;
        "pkg-1.0-1.11.2-Forge" = _167uyiez;
        "pkg-1.0.1-1.12.2-Forge" = _q0lsOtsD;
        "pkg-1.0.2.1-1.13-Rift" = _thUISbL3;
        "pkg-1.0.2-1.13.2-Forge-20200124" = _L8PThjPK;
        "pkg-1.0.2-1.14.2-Forge-20200124" = _Gq519RMa;
        "pkg-1.0.2-1.15.2-Fabric-20200125" = _rmXz1lWw;
        "pkg-1.0.2-1.15.2-Forge-20200126" = _jaLzdrKn;
        "pkg-1.0.2-1.16.1-Fabric-20200802" = _VAMV9bqi;
        "pkg-1.0.2-1.16.1-Forge-20200715" = _MhgY6WRT;
        "pkg-1.0.2-1.17.1-Fabric-20211111" = _iF4djp7Q;
        "pkg-1.0.2-1.17.1-Forge-20211111" = _MOA07pEX;
        "pkg-1.1.0-1.17.1-Fabric-20211122" = _DHP6ysKy;
        "pkg-1.1.0-1.17.1-Forge-20211122" = _KrJzm7gl;
        "pkg-1.1.1-1.17.1-Forge-20211124" = _eVZppD1u;
        "pkg-1.1.1-1.17.1-Fabric-20211124" = _OBddrKov;
        "pkg-1.1.1-1.18-Forge-20211205" = _ouyjm6BM;
        "pkg-1.1.1-1.18-Fabric-20211207" = _RhD9rHF1;
        "pkg-1.2.3-1.16.5-Fabric-20211212" = _rFQ16XlD;
        "pkg-1.2.3-1.19-Fabric-20220629" = _TKKYuyFf;
        "pkg-1.2.3-1.19-Forge-20220629" = _SPJQxEXz;
        "pkg-1.2.4-1.19-Forge-20220630" = _UVRnknt4;
        "pkg-1.2.4-1.19-Fabric-20220630" = _JmzhZ9Ew;
        "pkg-1.2.4-1.20.6-Fabric-20250927" = _opQaT8Hv;
        "pkg-1.2.4-1.21.8-Fabric-20250929" = _vOqGIzD5;
        "pkg-1.0.2-1.13.2-LegacyFabric-202509" = _eMLR87MA;
        "default" = _eMLR87MA;
    });
