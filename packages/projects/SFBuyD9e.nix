...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.8-fabric" = _jSaJI5M9;
        "pkg-1.18.2-1.8-fabric" = _NQh3jZDs;
        "pkg-1.19.2-1.9-fabric" = _sSAbAEbN;
        "pkg-1.16.5-1.4-forge" = _FTmCV2bk;
        "pkg-1.18.2-1.5-forge" = _TKOWNUfs;
        "pkg-1.19.2-1.7-forge" = _wWXyAYGS;
        "pkg-1.16.5-2.0-fabric" = _mO9clHEr;
        "pkg-1.18.2-2.0-fabric" = _QUNHMQJl;
        "pkg-1.19.2-2.0-fabric" = _DH5V4BYe;
        "pkg-1.19.3-2.1-fabric" = _uWUcofeX;
        "pkg-1.19.3-1.7-forge" = _zY640v0w;
        "pkg-1.18.2-3.0-forge+fabric" = _6DLyEnUa;
        "pkg-1.19.2-3.0-forge+fabric" = _LSVcB7xz;
        "pkg-1.19.3-3.0-forge+fabric" = _jFsim3Pe;
        "pkg-1.18.2-3.1-forge+fabric" = _xCyMJIHv;
        "pkg-1.19.2-3.1-forge+fabric" = _tbXgxlh4;
        "pkg-1.19.3-3.1-forge+fabric" = _Kq6QCFP6;
        "pkg-1.19.4-3.1-forge+fabric" = _DO22AIG5;
        "pkg-1.20-3.1-forge+fabric" = _Rsmo8uUo;
        "pkg-1.20.1-3.1-forge+fabric" = _9LIsUW6i;
        "pkg-1.20.2-3.1-forge+fabric" = _svaJMAWK;
        "pkg-1.18.2-3.2-forge+fabric" = _5bS2BH1g;
        "pkg-1.19.2-3.2-forge+fabric" = _barjBxHw;
        "pkg-1.20.1-3.2-forge+fabric" = _w03fLAy1;
        "pkg-1.20.2-3.2-forge+fabric" = _mG5oBVp2;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _3fUx2zuU;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _amlM01jQ;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _t5GaQTsF;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _8P29yw47;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _WrTQ7P3W;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _wftW82ZD;
        "pkg-1.20.5-3.3-fabric+neo" = _MLMqKjdx;
        "pkg-1.20.5-3.4-fabric+neo" = _AwjNd7Q3;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _uo2cbJQy;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _pp7tUxqf;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _YjJUarkz;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _6HP1ZlKc;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _Y41ItwPU;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _Voz9nSDJ;
        "pkg-1.21.2-3.5-fabric+neo" = _PiqVFjak;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _t3x1J5B1;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _448VVwPb;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _RkX2LE1w;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _sHj9Owc4;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _UYOoKifm;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _qsrlpaxo;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _b5EDJgBK;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _jz7u5IMM;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _VfO1O1EP;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _PSkz87kK;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _UqlXXX6G;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _NWWzgshR;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _n6ge0YUa;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _JqS1I1I6;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _ubLbtaEH;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _wHydnp74;
        "default" = _wHydnp74;
    });
