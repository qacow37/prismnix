...
let
    ...
    in {
        ...
        "pkg-V1.0" = _PvcQcUe9;
        "pkg-V1.1" = _1aA473ci;
        "pkg-V1.1.1" = _pfPnRwxo;
        "pkg-V1.2-data" = _8TujbNbo;
        "pkg-V1.2-mod" = _gkVppi9I;
        "pkg-V1.2.1-data" = _U6RkXKhE;
        "pkg-V1.2.1-mod" = _rGOw4eU9;
        "pkg-V1.3-resource" = _ZLmvEJj6;
        "pkg-V1.3-data" = _a91aovml;
        "pkg-V1.3-mod" = _4VvTGEWq;
        "pkg-V1.4-resources" = _NbzE72ha;
        "pkg-V1.4-data" = _uL2Mq5xN;
        "pkg-V1.4-mod" = _xrAC599A;
        "pkg-V1.5-resource" = _6Rq7A1Cw;
        "pkg-V1.5-data" = _elfrydN2;
        "pkg-V1.5-mod" = _EnSy80ea;
        "pkg-V1.5.1-resource" = _jjBmzAzF;
        "pkg-V1.5.1-data" = _k3yCIbQT;
        "pkg-V1.5.1-mod" = _vat5dwIS;
        "pkg-V1.6-resource" = _MIMVp81P;
        "pkg-V1.6-data" = _RBmqfQBM;
        "pkg-V1.6-mod" = _50rvNKrt;
        "pkg-V1.6.1-resource" = _ezXXcZK5;
        "pkg-V1.6.1-data" = _Cqzubeus;
        "pkg-V1.6.1-mod" = _siEe7uii;
        "pkg-V1.6.2-resource" = _EbKf2IIH;
        "pkg-V1.6.2-data" = _LjavixwG;
        "pkg-V1.6.2-mod" = _KHHVtQrY;
        "pkg-V1.7-resource" = _l8dVMwq9;
        "pkg-V1.7-data" = _WEQsMAw6;
        "pkg-V1.7-mod" = _UbVI5P0F;
        "pkg-V1.7.1-resource" = _CXS9DfHx;
        "pkg-V1.7.1-data" = _STs7ldJ8;
        "pkg-V1.7.1-mod" = _pGF6yb6n;
        "pkg-V1.7.2-resource" = _ed6Lc3UU;
        "pkg-V1.7.2-data" = _TDLzqELA;
        "pkg-V1.7.2-mod" = _RAyLNKZM;
        "pkg-V1.7.3-resource" = _3QXdIhBk;
        "pkg-V1.7.3-data" = _iTWHI8QV;
        "pkg-V1.7.3-mod" = _I6oBcntJ;
        "pkg-V1.7.4-resource" = _MmNPjyWp;
        "pkg-V1.7.4-data" = _jTmZtyYO;
        "pkg-V1.7.4-mod" = _wTLqzo4P;
        "pkg-V1.8-resource" = _VV7STyTn;
        "pkg-V1.8-data" = _FF20ZwZE;
        "pkg-V1.8-mod" = _mxroKxBk;
        "pkg-V1.9-resource" = _OKT5P0B4;
        "pkg-V1.9-data" = _17v5tc3q;
        "pkg-V1.9-mod" = _Sfp8hZPz;
        "pkg-V1.9.1-resource" = _VGAS49mE;
        "pkg-V1.9.1-data" = _3W93Hhj5;
        "pkg-V1.9.1-mod" = _RFLppGC0;
        "pkg-V1.9.2-resource" = _qgne9sdp;
        "pkg-V1.9.2-data" = _131f9Vxj;
        "pkg-V1.9.2-mod" = _D6eB8i7a;
        "pkg-V1.9.3-resource" = _LygtHpHC;
        "pkg-V1.9.3-data" = _bcKCNJp2;
        "pkg-V1.9.3-mod" = _RmXgQSyP;
        "default" = _RmXgQSyP;
    });
