...
let
    ...
    in {
        ...
        "pkg-4.0.0" = _LdlEM7bZ;
        "pkg-3.4.0" = _z6L4ACjc;
        "pkg-1.18.2-3.4.2" = _3lvEBLhC;
        "pkg-1.18.2-3.4.3" = _EiwTxQEY;
        "pkg-1.19.2-4.1.2" = _E6hgEr4k;
        "pkg-1.16.5-2.15.12" = _Ng0gixug;
        "pkg-1.18.2-3.4.4" = _rhuD5Qyo;
        "pkg-1.19.2-4.1.3" = _YmXiBzYw;
        "pkg-1.19.2-4.2.0" = _nZios8Gw;
        "pkg-1.18.2-3.5.0" = _FWYGsUsp;
        "pkg-1.19.2-4.3.0" = _56nYAc6g;
        "pkg-1.19.2-4.3.1" = _NMzkhLd4;
        "pkg-1.18.2-3.6.0" = _S69uHAZo;
        "pkg-1.19.2-4.3.2" = _IQjGFlJ2;
        "pkg-1.19.2-4.3.3" = _83gYGTxX;
        "pkg-1.19.3-5.0.0" = _QnimH6Qp;
        "pkg-1.19.2-4.3.4" = _6oOOTpbH;
        "pkg-1.19.2-4.3.5" = _SuZGBv0D;
        "pkg-1.20.1-6.0.0" = _50pqhctd;
        "pkg-1.19.2-4.3.6" = _ZKQIAQLk;
        "pkg-6.0.2+mc1.20.1" = _IEtskeCq;
        "pkg-1.18.2-3.6.1" = _SvS1xjsI;
        "pkg-1.19.2-4.3.7" = _mjl3s691;
        "pkg-6.0.4+mc1.20.1" = _BXPItvP9;
        "pkg-6.0.5+mc1.20.1" = _eKS7FZQj;
        "pkg-6.0.6+mc1.20.1" = _jCkn3vuB;
        "pkg-6.0.7+mc1.20.1" = _rUtADWR9;
        "pkg-1.19.2-4.3.8" = _YpdnthMR;
        "pkg-6.0.8+mc1.20.1" = _aGBUMBK0;
        "pkg-1.18.2-3.6.3" = _yPP7LsDv;
        "pkg-6.0.9+mc1.20.1" = _LgnJYfJj;
        "pkg-1.19.2-4.3.9" = _mGiYyrqw;
        "pkg-6.0.10+mc1.20.1" = _at6NiV7i;
        "pkg-6.0.11+mc1.20.1" = _u7bkB6Cg;
        "pkg-1.19.2-4.3.10" = _KdKKUDhI;
        "pkg-1.19.2-4.3.11" = _1FYXlVUJ;
        "pkg-6.0.12+mc1.20.1" = _mcrdWaCP;
        "pkg-1.18.2-3.6.4" = _MKLPzhtU;
        "pkg-1.19.2-4.3.12" = _5HcytIZm;
        "pkg-1.19.2-4.3.13" = _N6tvlgrJ;
        "pkg-6.0.13+mc1.20.1" = _KWELaxTw;
        "pkg-1.19.2-4.3.14" = _UAmTdr3o;
        "pkg-6.0.14" = _iSaY43NM;
        "pkg-6.0.15" = _Pq4YT1ta;
        "pkg-1.19.2-4.3.15" = _yl0p1Hfn;
        "pkg-7.0.0" = _mHHm8TsN;
        "pkg-7.0.1" = _K2TDNcqi;
        "pkg-7.0.2" = _eKioPRj9;
        "pkg-7.0.3" = _eoIifOhN;
        "pkg-8.0.0" = _ZO0LxqTP;
        "pkg-8.0.1" = _dIbCRq1q;
        "pkg-6.0.16" = _T1JaBU0q;
        "pkg-8.0.2" = _bwoDpOh7;
        "pkg-8.0.3" = _Rx21nfz4;
        "pkg-8.1.0" = _xD5AnyJa;
        "pkg-8.1.1" = _83vjBvJt;
        "pkg-6.0.17" = _sfxkp6WL;
        "pkg-8.1.2" = _EpwY6iTU;
        "pkg-8.1.3" = _p8vCn8Xk;
        "pkg-8.1.4" = _vqeyN3Bp;
        "pkg-8.2.0" = _Jk0XjJrE;
        ...
        "pkg-8.2.3" = _vrp8HVC8;
        "pkg-8.2.4" = _qggLUJ3m;
        "pkg-6.0.18" = _4zFDhXRf;
        "pkg-8.2.5" = _JanVFFek;
        "pkg-7.0.4" = _UQ1lGWH5;
        "pkg-8.2.6" = _KyZSSrXB;
        "pkg-6.0.19" = _K5Lei05X;
        "pkg-8.2.7" = _tXfoxl47;
        "pkg-8.2.8" = _WrDegCJ0;
        "pkg-6.0.20" = _RWh8lJj7;
        "pkg-8.2.9" = _es56JqRF;
        "pkg-8.2.10" = _eCqknbLK;
        "pkg-8.2.11" = _MYDwnSTO;
        "pkg-8.2.12" = _L5G0uUMd;
        "pkg-8.2.13" = _5Vpj4ZfC;
        "pkg-6.0.21" = _AuQD3oA8;
        "pkg-6.0.22" = _kjsVKEOw;
        "pkg-8.2.14" = _BHuKt5iQ;
        "pkg-8.2.15" = _ZAVbKVFX;
        "pkg-8.2.16" = _IgHNccWK;
        "pkg-8.2.17" = _XJJu9sbw;
        "pkg-8.2.18" = _xiSEBiVi;
        "pkg-8.2.19" = _Gh5D7hbW;
        "pkg-8.2.20" = _jExIFMt7;
        "pkg-7.0.5" = _QK8s3Tm6;
        "pkg-6.0.23" = _ohRZqkHb;
        "pkg-8.2.21" = _JKqGh7uZ;
        "pkg-8.2.22" = _Dd6V8eOF;
        "pkg-8.2.23" = _TNzeuLH3;
        "default" = _TNzeuLH3;
    });
