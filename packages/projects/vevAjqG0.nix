...
let
    ...
    in {
        ...
        "pkg-1.3.1+1.20.3-4" = _5zPr6Wuk;
        "pkg-1.3.1+1.20.X" = _Ee574oBo;
        "pkg-1.3.2+1.20" = _8IgK5YW9;
        "pkg-1.3.3+1.20" = _D8D1a3SY;
        "pkg-1.3.3+1.20.5" = _c2KoMgox;
        "pkg-1.3.3+1.20.6" = _EdptI9jv;
        "pkg-1.3.3+1.21" = _BjLufrJq;
        "pkg-1.3.4+1.20" = _T8aQ6ZYJ;
        "pkg-1.3.4+1.20.6" = _5jQpe9eN;
        "pkg-1.3.4+1.21" = _pmQy7Ffz;
        "pkg-1.4.0+1.21" = _xHeYa9k1;
        "pkg-1.4.0+1.20.6" = _J2Zlmkhu;
        "pkg-1.4.0+1.20" = _Jq4UH8La;
        "pkg-1.4.0+1.21.3" = _BRHk8KEL;
        "pkg-1.4.0+1.21.4" = _cN7DWRiR;
        "pkg-1.4.0+1.21.5" = _HApESTHO;
        "pkg-1.5.0+1.21.9" = _5LF2tuXL;
        "pkg-1.5.1+1.21.9" = _7cmo2VCf;
