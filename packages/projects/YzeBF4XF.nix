...
let
    ...
    in {
        ...
        "pkg-0.1.6-1.8" = _SON9UtfI;
        "pkg-0.5-1.8" = _IYINTPfI;
        "pkg-0.5.1-1.8" = _kIgIIXi8;
        "pkg-0.5.3-1.8" = _9IQQew35;
        "pkg-0.5.4-1.8" = _tYG0jmxm;
        "pkg-0.5.5-1.8" = _vPsqek34;
        "pkg-0.5.8-1.8" = _f5GutS7N;
        "pkg-0.5.8-1.8.9" = _71ZW2YKi;
        "pkg-0.5.9-1.8" = _ZwUahcRZ;
        "pkg-0.5.9-1.8.9" = _dxHTFOnf;
        "pkg-0.6-pre1-1.8" = _2NVtmIDX;
        "pkg-0.6-pre1-1.8.9" = _8rTMSOIs;
        "pkg-0.6-pre2-1.8" = _4rqKuFQZ;
        "pkg-0.6-pre2-1.8.9" = _tZh7OusE;
        "pkg-0.6-1.8" = _m0IthMYk;
        "pkg-0.6-1.8.9" = _YJx8Behw;
        "pkg-0.6.1-1.8" = _A7uyYbeQ;
        "pkg-0.6.1-1.8.9" = _O5IJCCgf;
        "pkg-0.7-pre1-1.8" = _JF1r8jF5;
        "pkg-0.7-pre1-1.8.9" = _DLu3aXLM;
        "pkg-0.7-pre2-1.8" = _J80vGG4r;
        "pkg-0.7-pre2-1.8.9" = _A2xNZ6ah;
        "pkg-0.7-pre3-1.8" = _hyDnYYMP;
        "pkg-0.7-pre3-1.8.9" = _YX8ieYrd;
        "pkg-0.7-pre4-1.8" = _2goqeyaY;
        "pkg-0.7-pre4-1.8.9" = _FPI0Gm1p;
        "pkg-0.7-1.8" = _gp9i90ms;
        "pkg-0.7-1.8.9" = _NLdl3tNI;
        "pkg-0.7.1-1.8" = _PsxsouIy;
        "pkg-0.7.1-1.8.9" = _f2ltc9KE;
        "pkg-0.7.1-1.9.4" = _10i8Qx1l;
        "pkg-0.7.1-1.10" = _uRJ4JKT8;
        "pkg-0.7.1-1.10.2" = _HJhLBc2z;
        "pkg-0.7.1-1.11+" = _4NAFwSly;
        "pkg-0.7.1-hotfix1-1.9.4" = _7S7PONyp;
        "pkg-0.7.1-hotfix1-1.10" = _zzDkfKgT;
        "pkg-0.7.1-hotfix1-1.10.2" = _gHIEgNzA;
        "pkg-0.7.1-hotfix1-1.11+" = _ecFi68wR;
        "pkg-0.7.2-1.9.4" = _kKe8cJ4Z;
        "pkg-0.7.2-1.10" = _Xy9RjcgB;
        "pkg-0.7.2-1.10.2" = _c7CwBY5B;
        "pkg-0.7.2-1.11+" = _uyh2wjNJ;
        "pkg-0.7.2-hotfix1-1.9.4" = _tMybedEn;
        "pkg-0.7.2-hotfix1-1.10+" = _2yzso3LJ;
        "pkg-0.7.3-1.9.4" = _2BHDnDh6;
        "pkg-0.7.3-1.10+" = _knozrExj;
        "pkg-0.7.3-1.11+" = _t7NbOZJh;
        "pkg-0.7.4-1.8" = _cqxgWRRu;
        "pkg-0.7.4-1.8.9" = _wjBxSwoX;
        "pkg-0.7.4-1.9.4" = _bSPpTW8O;
        "pkg-0.7.4-1.10+" = _RmguaXhh;
        "pkg-0.7.4-1.11+" = _cfPGtzx3;
        "pkg-0.7.4-1.12+" = _vQz6X04M;
        "pkg-0.7.5-1.9.4" = _DlccnZBf;
        "pkg-0.7.5-1.10+" = _jliO1Msn;
        "pkg-0.7.5-1.11+" = _BMCt575F;
        "pkg-0.7.5-1.12+" = _sXiXjk8i;
        "pkg-0.7.6-1.12+" = _gzkYEsIz;
        "pkg-0.7.7-1.12+" = _SSVDmm0U;
        "pkg-0.7.8-1.9.4" = _jwO9htZ8;
        "pkg-0.7.8-1.10+" = _mCp22xgI;
        "pkg-0.7.8-1.11+" = _GlM3I30V;
        "pkg-0.7.8-1.12+" = _RucbGVb8;
        "pkg-0.7.9-1.9.4" = _UaE2ty3Z;
        "pkg-0.7.9-1.10+" = _qyqpEjLy;
        "pkg-0.7.9-1.11+" = _bo7lE7xq;
        "pkg-0.7.9-1.12+" = _WZJxVb8L;
        "default" = _WZJxVb8L;
    });
