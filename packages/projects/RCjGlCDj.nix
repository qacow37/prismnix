...
let
    ...
    in {
        ...
        "pkg-1.1.2" = _Xwuw1jQx;
        "pkg-1.1.3" = _yJucqC2j;
        "pkg-1.1.3+1.19" = _9BVmeWZ1;
        "pkg-1.2.0+1.19.3" = _9z5rcnIT;
        "pkg-1.2.0+1.19.4" = _HY4wTK3E;
        "pkg-1.2.1+1.19.4" = _TYK2ibS2;
        "pkg-1.2.1+1.20.1" = _2sM7WaLc;
        "pkg-1.3.0+1.19.4" = _j9gqnGlI;
        "pkg-1.3.0+1.20.1" = _W6U5wR5M;
        "pkg-1.3.0+1.20.4" = _NCxG0H9m;
        "pkg-1.3.0+1.20.2" = _1xFd2xgj;
        "pkg-1.3.1+1.19.4" = _VCyKZBZ4;
        "pkg-1.3.1+1.20.2" = _8fsQ3H4C;
        "pkg-1.3.1+1.20.4" = _G2oSdEe5;
        "pkg-1.3.1+1.20.1" = _10Zx1M0l;
        "pkg-1.4.0+1.20.2" = _7GYvFIEr;
        "pkg-1.4.0+1.19.4" = _oh2Lb1rf;
        "pkg-1.4.0+1.20.4" = _Jrd3bRov;
        "pkg-1.4.0+1.20.1" = _vYl8MwGp;
        "pkg-1.4.1+1.19.4" = _Y2wLks3c;
        "pkg-1.4.1+1.20.1" = _OVpOhpFF;
        "pkg-1.4.1+1.20.2" = _NdErDOkh;
        "pkg-1.4.1+1.20.4" = _itOhCClD;
        "pkg-1.4.2+1.21" = _zJVO2F59;
        "pkg-1.4.2+1.20.2" = _PNgDVixK;
        "pkg-1.4.2+1.19.4" = _PW3TNGQO;
        "pkg-1.4.2+1.20.6" = _R1JA4caZ;
        "pkg-1.4.2+1.20.1" = _sefnXuKK;
        "pkg-1.4.2+1.20.4" = _gLzYkRuq;
        "pkg-1.4.3+1.21.4" = _rrfo48uF;
        "pkg-1.4.3+1.19.4" = _BNsPreVA;
        "pkg-1.4.3+1.20.2" = _rwdiMcuS;
        "pkg-1.4.3+1.21" = _WIo80jNT;
        "pkg-1.4.3+1.20.1" = _DwKcByvE;
        "pkg-1.4.3+1.20.4" = _tUJgUnlS;
        "pkg-1.4.3+1.20.6" = _3Fv85ZaL;
        "pkg-1.4.3+1.21.3" = _lZrGrkjS;
        "default" = _lZrGrkjS;
    });
