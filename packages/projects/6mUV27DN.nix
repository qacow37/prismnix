...
let
    ...
    in {
        ...
        "pkg-1.0-pre-release-1.20.1" = _93qZzazH;
        "pkg-1.0-pre-release.2-1.20.1" = _Jmq4SOR1;
        "pkg-1.0-pre-release-3-1.20.1-forge" = _fC8kEVJP;
        "pkg-1.0-pre-release-3-1.20.1-fabric" = _n4gbs4YB;
        "pkg-Armory-1.0-1.20.1-fabric" = _YU6cBnfH;
        "pkg-Armory-1.0-1.20.1-forge" = _sachmENV;
        "pkg-Armory-1.2-1.20.1-fabric" = _kY88SnMC;
        "pkg-Armory-1.2-1.20.1-forge" = _c2h5DEYL;
        "pkg-Armory-1.3-1.20.1-fabric" = _hFDQM6uK;
        "pkg-Armory-1.3-1.20.1-forge" = _96Gdjfug;
        "pkg-1.4-1.20.1" = _YYxWlWWI;
        "pkg-1.5-1.20.1" = _gM7GAnm8;
        "pkg-1.6-1.20.1-fabric" = _s6LC9sBA;
        "pkg-1.6-1.20.1-forge" = _nvsPqFQr;
        "pkg-1.7-1.20.1-fabric" = _wk4snfsU;
        "pkg-1.7-1.20.1-neoforge" = _UBL7FkgY;
        "pkg-1.8-1.20.1-fabric" = _7RuqqQxz;
        "pkg-1.8-1.20.1-neoforge" = _ft1Cvx5q;
        "pkg-1.9-1.20.1-neoforge" = _o3mAzo1x;
        "pkg-1.9-1.20.1-fabric" = _xbPHEkOE;
        "pkg-1.10-1.20.1-neoforge" = _3Qz2ml2Y;
        "pkg-1.10-1.20.1-fabric" = _BVPGDnQ1;
        "pkg-1.11-1.20.1-fabric" = _OtYr2rBn;
        "pkg-1.11-1.20.1-neoforge" = _Vsr6VwpJ;
        "pkg-2.0-1.21-neoforge" = _6toxutdO;
        "pkg-2.0-1.21-fabric" = _LlkC4TaG;
        "pkg-2.1-1.21-fabric" = _cq8EAcAB;
        "pkg-2.1-1.21-neoforge" = _rDzSXt6o;
        "pkg-1.12-1.20.1-neoforge" = _JlhETQ2N;
        "pkg-1.12-1.20.1-fabric" = _TIUNDHMY;
        "pkg-1.13-1.20.1-fabric" = _tg1HIp72;
        "pkg-1.13-1.20.1-neoforge" = _9RRFLJ2U;
        "pkg-2.2-1.21-fabric" = _E0iFK6Lx;
        "pkg-2.2-1.21-neoforge" = _hZbHexQd;
        "default" = _hZbHexQd;
    });
