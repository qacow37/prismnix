...
let
    ...
    in {
        ...
        "pkg-1.8.9-4.20beta11" = _OWChLWQZ;
        "pkg-1.8.9-4.20beta12" = _Zv4i0o7h;
        "pkg-1.8.9-4.20beta13" = _457ntuoM;
        "pkg-1.8.9-4.20beta15" = _1XWrPzyj;
        "pkg-1.8.9-4.21beta18" = _kyzYnvGk;
        "pkg-1.8.9-4.22beta19" = _RsOtLrmn;
        "pkg-1.8.9-4.22beta20" = _h5FyMTwx;
        "pkg-1.8.9-4.22beta21" = _t1hGLa8X;
        "pkg-1.8.9-4.22beta22" = _yz7aO7S7;
        "pkg-1.8.9-4.22beta25" = _m9cEETHY;
        "pkg-1.8.9-4.22beta26" = _FY7gbpnz;
        "pkg-1.8.9-4.22beta27" = _kcSKL2nW;
        "pkg-1.8.9-4.22beta28" = _UYlMMudi;
        "pkg-1.8.9-4.22beta29" = _i8LGh6Ij;
        "pkg-1.8.9-4.22beta30" = _79iu97YZ;
        "pkg-1.8.9-4.22beta31" = _G8xvU3Ky;
        "pkg-1.9.0-4.23beta32" = _uhIa9izs;
        "pkg-1.9.0-4.23beta33" = _QNae8IFv;
        "pkg-1.9.0-4.23beta34" = _TeJLZWzt;
        "pkg-1.9.0-4.23beta35" = _ycH57jiq;
        "pkg-1.9.0-4.23beta36" = _qJsW10BN;
        "pkg-1.9.0-4.23beta37" = _bqo3bGpT;
        "pkg-1.9.0-4.23beta38" = _yRXtGgAQ;
        "pkg-1.8.9-4.22beta32" = _QlPCFHjP;
        "pkg-1.9.0-4.23beta40" = _XvneCeI2;
        "pkg-1.9.4-4.23beta40" = _Wu7gCLZD;
        "pkg-1.9.4-4.23beta41" = _gn207msX;
        "pkg-1.9.4-4.30beta42" = _St4FLklI;
        "pkg-1.9.4-4.30beta43" = _OuXpv5Nz;
        "pkg-1.10-4.30beta44" = _MCtHEo5t;
        "pkg-1.9.4-4.30beta44" = _U21QunSy;
        "pkg-1.9.4-4.30beta45" = _v9waqBJ2;
        "pkg-1.10-4.30beta45" = _b3RqSGIc;
        "pkg-1.9.4-4.30beta46" = _2uHmWGXU;
        "pkg-1.10-4.30beta46" = _65oalDNG;
        "pkg-1.10-4.30beta47" = _lJuniLv5;
        "pkg-1.10-4.30beta48" = _8K4zqBNz;
        "pkg-1.10-4.30beta49" = _BBKk0gD8;
        "pkg-1.10-4.30beta50" = _pU6ACfqs;
        "pkg-1.10-4.40" = _95SMgmV1;
        "pkg-1.10-4.41" = _5rvdKgta;
        "pkg-1.10-4.42" = _a6IB16xZ;
        "pkg-1.10-4.43" = _5gYl5Q6s;
        "pkg-1.10-4.44" = _hWZEAIrw;
        "pkg-1.10-4.45" = _iICamiw4;
        "pkg-1.11-4.45alpha1" = _2XDtTvBa;
        "pkg-1.11-4.45alpha2" = _DKk7CkVl;
        "pkg-1.11-4.45beta1" = _RlRp73Mo;
        "pkg-1.1x-4.50" = _FEJbqGJf;
        "pkg-1.1x-4.51" = _HeAbyq3n;
        "pkg-1.1x-4.52" = _WVw8Aww1;
        "pkg-1.1x-4.53" = _s9S8Bfaq;
        "pkg-1.1x-4.54" = _l7P4tt4x;
        "pkg-1.1x-4.55" = _Cn2cLt89;
        "pkg-1.1x-5.00" = _ePSns3So;
        "pkg-1.1x-5.01" = _9YFZE5jL;
        "pkg-1.1x-5.02" = _Pb6bXgGs;
        "pkg-1.12-5.02beta1" = _JOZm9UKV;
        "pkg-1.12-5.02beta3" = _3bQAEe8A;
        "pkg-1.12-5.02" = _BkPBy2dV;
        "pkg-1.12-5.03" = _11VimZ4y;
        "pkg-1.1x-5.04" = _DEfH64fO;
        "pkg-1.12-5.04" = _U6pdwr9P;
        "pkg-1.1x-5.05" = _UNcdQqq9;
        "pkg-1.12-5.05" = _CryOtpYN;
        "pkg-1.12-5.10" = _xQSmNk2w;
        "pkg-1.12-5.50" = _4ZOL6IQK;
        "pkg-1.12-5.51" = _n2gkurc9;
        "pkg-1.12-5.52" = _IL4wGtXQ;
        "pkg-1.12-5.53" = _Ir6hHwYA;
        "pkg-1.12-5.60-alpha" = _F3AK24fX;
        "pkg-1.12-5.60" = _XX28JQsk;
        "pkg-1.12-5.61" = _muOlHpK1;
        "pkg-1.12-5.62" = _EbrtOeWy;
        "pkg-1.12-5.63" = _iUrsRQRS;
        "pkg-1.12-5.64" = _a2zLtifO;
        "pkg-1.12-5.70" = _rTj5JaaV;
        "pkg-1.12-5.71" = _AiNwflHn;
        "pkg-1.16-7.0.0-alpha" = _dmge8ulM;
        "pkg-1.16-7.0.1-beta" = _SqSdRvlL;
        "pkg-1.16-7.0.2-beta" = _UwZQ735V;
        "pkg-1.16-7.0.3-beta" = _uSwfTRQD;
        "pkg-1.16-7.0.4-beta" = _NrZsU6OD;
        "pkg-1.16-7.0.5-beta" = _SoNTRBYj;
        "pkg-1.16-7.0.6-beta" = _6KzEhyUX;
        "pkg-1.16-7.0.7-beta" = _8by60NGB;
        "pkg-1.16-7.0.8-beta" = _YaYqSAtF;
        "pkg-1.16-7.0.9-beta" = _rbW4wvLr;
        "pkg-1.16-7.0.10-beta" = _Vk5282L1;
        "pkg-1.16-7.0.11-beta" = _xYkmhalb;
        "pkg-1.16-7.0.12-beta" = _wSSm0hW8;
        "pkg-1.16-7.0.13-beta" = _dYoghDWs;
        "pkg-1.16-7.0.14-beta" = _4XfUdWWl;
        "pkg-1.16-7.0.15-beta" = _Ks2t8YEy;
        "pkg-1.16-7.0.16-beta" = _oFtirqmE;
        "pkg-1.16-7.0.17-beta" = _WRboylLo;
        "pkg-1.16-7.0.18-beta" = _quTe6j8r;
        "pkg-1.16-7.0.19-beta" = _5iWUjpZn;
        "pkg-1.16-7.0.20-beta" = _e2jHf85I;
        "pkg-1.18-8.0.0" = _NWcebxqT;
        "pkg-1.18-8.0.1" = _yjBDZvfg;
        "pkg-1.18-8.0.2" = _R4JbRwko;
        "pkg-1.18-8.0.3" = _KtBCb5Cw;
        "pkg-1.18-8.0.4" = _so5B5fdM;
        "pkg-1.18-8.0.5" = _lcGNolCw;
        "pkg-1.18-8.0.6" = _dLlb1U03;
        "pkg-1.18-8.0.7" = _MzPIHotq;
        "pkg-1.16-7.0.21" = _9MLsLI7k;
        "pkg-1.18-8.0.8" = _dvyM0NWX;
        "pkg-1.18-8.0.9" = _atNf7v6d;
        "pkg-1.19-9.0.0" = _hQlKB4IF;
        "pkg-1.19-9.0.1" = _pHUNQ2J3;
        "pkg-1.19-9.0.2" = _FJTZNvUj;
        "pkg-1.19-9.0.3" = _9JwscaAI;
        "pkg-1.19-9.1.0" = _fQkVzvuE;
        "pkg-1.19.3-9.0.4" = _1LkTxKJh;
        "pkg-1.19.3-9.0.5" = _yDDN99rc;
        "pkg-1.19.3-9.1.1" = _fvVdc1eY;
        "pkg-1.19.2-9.1.2" = _jPBTyhry;
        "pkg-1.19.3-10.0.0" = _HzKlyJRX;
        "pkg-1.18-8.0.10" = _okS0wEo4;
        "pkg-1.19.2-9.1.3" = _FuNQdvih;
        "pkg-1.19.3-10.0.1" = _xSYpsKkj;
        "pkg-1.19.4-10.1.1" = _OuZDCNNJ;
        "pkg-1.19.2-9.1.5" = _1uU6c3zX;
        "pkg-1.19.3-10.0.2" = _JlnOl21K;
        "pkg-1.19.4-10.1.2" = _6MWjiA5a;
        "pkg-1.19.2-9.1.6" = _qXYne1eN;
        "pkg-1.19.2-9.1.7" = _X2PJlstr;
        "pkg-1.19.3-10.0.3" = _cQi9SnrN;
        "pkg-1.19.4-10.1.3" = _sFln5pzA;
        "pkg-1.20-11.0.0" = _EOcvt3mF;
        "pkg-1.20-11.0.1" = _BmLW9aDP;
        "pkg-1.20-11.0.2" = _9FTkdID3;
        "pkg-1.19.2-9.1.8" = _DiQENQg7;
        "pkg-1.19.2-9.1.9" = _1NhgENNP;
        "pkg-1.20-11.0.3" = _Tz0ET3b2;
        "pkg-1.20-11.0.4" = _2YpNACps;
        "pkg-1.20-11.0.5" = _4966r5JZ;
        "pkg-1.20-11.0.6" = _st6rs4Zv;
        "pkg-1.18-8.0.11" = _DnRkVQ2f;
        "pkg-1.19.2-9.1.10" = _qhBZfxT2;
        "pkg-1.20-11.0.7" = _YMxK9ZBE;
        "pkg-1.20-11.0.8" = _SOoSemK3;
        "pkg-1.20-11.0.9" = _MpUrIon9;
        "pkg-1.20-11.0.10" = _SxzunA0z;
        "pkg-1.21-12.0.0" = _1Uhd2GU0;
        "pkg-1.21-12.0.1" = _MhjhtMCi;
        "pkg-1.21-12.0.2" = _4kio5dl3;
        "pkg-1.21-12.0.3" = _6FkzLPvJ;
        "pkg-1.20-11.0.11" = _dv3MV75w;
        "pkg-1.21-12.0.4" = _40u98jc1;
        "default" = _40u98jc1;
    });
