...
let
    ...
    in {
        ...
        "pkg-0.1.4-mc1.16.5" = _v2Go6lOt;
        "pkg-0.1.4-mc1.17.1" = _T33y0dh7;
        "pkg-0.1.4-mc1.18.2" = _4CcJKl75;
        "pkg-0.1.4-mc1.19.2" = _9T9h3LpS;
        "pkg-0.1.4fix-mc1.17.1" = _Jo9ep8VJ;
        "pkg-0.1.5-mc1.19.4" = _xoK1eekQ;
        "pkg-0.1.6-mc1.19.4" = _wDRccgiQ;
        "pkg-0.1.5-mc1.19.2" = _DgVBlC3C;
        "pkg-0.1.5-mc1.18.2" = _IxBQdeze;
        "pkg-0.1.5-mc1.17.1" = _WwyVk2vB;
        "pkg-0.1.5-mc1.16.5" = _AEP1Plyv;
        "pkg-0.1.0-mc1.20.1" = _wl1s5bz0;
        "pkg-0.1.6-mc1.18.2" = _zY7YT7fE;
        "pkg-0.1.6-mc1.16.5" = _RjjwOeyx;
        "pkg-0.1.2-mc1.20.1" = _wnOadWEr;
        "pkg-0.1.6-mc1.19.2" = _DqWf1Zyy;
        "pkg-0.1.8-mc1.19.4" = _w1zanluW;
        "pkg-0.1.7-mc1.18.2" = _n1r2HSiJ;
        "pkg-0.1.3-mc1.20.1" = _AHZKR25G;
        "pkg-0.1.9-mc1.19.4" = _otvvyz8m;
        "pkg-0.1.7-mc1.19.2" = _oHsZFtrK;
        "pkg-0.1.7-mc1.16.5" = _3XizL61k;
        "pkg-0.1.8-mc1.18.2" = _GKwbAIFK;
        "pkg-0.1.0-mc1.20.4" = _YugGAFCm;
        "pkg-0.1.1-mc1.20.4" = _3EVNHjYE;
        "pkg-0.1.2-mc1.20.4" = _ukZuIHNg;
        "pkg-0.1.8-mc1.16.5" = _WIofLUZr;
        "pkg-0.1.8-mc1.19.2" = _KczNELCT;
        "pkg-0.1.9-mc1.18.2" = _IuV7JVoB;
        "pkg-0.1.4-mc1.20.1" = _sjZmzfbr;
        "pkg-0.1.3-mc1.20.4" = _AhmoeTl2;
        "pkg-0.1.4-mc1.20.4" = _h8wOvbBy;
        "pkg-0.1.5-mc1.20.1" = _ugidQIT1;
        "pkg-0.1.9-mc1.19.2" = _3CPbjHDF;
        "pkg-0.1.10-mc1.18.2" = _FxppkGXi;
        "pkg-0.1.9-mc1.16.5" = _FkXW8Dgc;
        "pkg-0.1.4-mc1.20.6" = _YGnzqeUR;
        "pkg-0.1.10-mc1.16.5" = _2doOrjJG;
        "pkg-0.1.6-mc1.21" = _WJP0sXp9;
        "pkg-0.1.6-mc1.20.6" = _z5QtX0R0;
        "pkg-0.1.7-mc1.21" = _baZXVT7z;
        "pkg-0.1.7-mc1.20.6" = _XxOGVXEH;
        "pkg-0.1.5-mc1.20.4" = _h1RBYEuZ;
        "pkg-0.1.8-mc1.21" = _GUtEmbjb;
        "pkg-0.1.8-mc1.20.6" = _diIkKbcT;
        "pkg-0.1.6-mc1.20.4" = _b6hCKOq6;
        "pkg-0.1.6-mc1.20.1" = _1YPqrqGm;
        "pkg-0.1.10-mc1.19.2" = _sCQwhTzR;
        "pkg-0.1.11-mc1.18.2" = _EN0E812z;
        "pkg-0.1.11-mc1.16.5" = _SaFR1XnI;
        "pkg-0.1.7-mc1.20.4" = _Sgsa4a4Q;
        "pkg-0.1.9-mc1.21" = _BTl0qMAp;
        "pkg-0.1.10-mc1.21" = _z7uQZghO;
        "pkg-0.1.11-mc1.21.1" = _MBphtQTl;
        "pkg-0.1.7-mc1.20.1" = _KT2dpXzy;
        "pkg-0.1.13-mc1.21.1" = _xinhWUUG;
        "pkg-0.1.14-mc1.21.3" = _9hSzTeJj;
        "pkg-0.1.16-mc1.21.4" = _8kMwckUK;
        "pkg-0.1.16-mc1.21.3" = _yqgg6OtY;
        "pkg-0.1.14-mc1.21.1" = _ZenPSk20;
        "pkg-0.2.1-mc1.21.1" = _icDzNhai;
        "pkg-0.2.1-mc1.21.4" = _3DFLnSuF;
        "pkg-0.2.1-mc1.21.3" = _ddC4FJBd;
        "pkg-0.1.9-mc1.20.1" = _xe5FEkhr;
        "pkg-0.1.10-mc1.20.1" = _LV12kxm4;
        "pkg-0.1.11-mc1.20.1" = _PmidKXEm;
        "pkg-0.1.12-mc1.20.1" = _GMP9nXBg;
        "pkg-0.2.2-mc1.21.4" = _qLOyaDAu;
        "pkg-0.2.2-mc1.21.3" = _DuxvVWG4;
        "pkg-0.2.2-mc1.21.1" = _cW9mUCKz;
        "pkg-0.2.3-mc1.21.1" = _AJ2We8oz;
        "pkg-0.1.13-mc1.20.1" = _YncE2C0Y;
        "pkg-0.3.1-mc1.21.5" = _YxG2nRAc;
        "pkg-0.3.1-mc1.21.4" = _xpptLdz1;
        "pkg-0.3.1-mc1.21.1" = _xJeFfSv5;
        "pkg-0.3.1-mc1.21.3" = _yyptcbcy;
        "pkg-0.3.2-mc1.21.5" = _FPlUxyJB;
        "pkg-0.3.3-mc1.21.5" = _TQ7exCRT;
        "pkg-0.3.2-mc1.21.4" = _3vJcM72e;
        "pkg-0.3.4-mc1.21.5" = _MHvuweuD;
        "pkg-0.3.2-mc1.21.3" = _dcCxysiO;
        "pkg-0.3.2-mc1.21.1" = _LvqGzfCo;
        "pkg-0.3.3-mc1.21.4" = _sreK2wgR;
        "pkg-0.3.5-mc1.21.7" = _Uf5tTpnN;
        "pkg-0.3.5-mc1.21.5" = _VsA1C60v;
        "pkg-0.3.3-mc1.21.1" = _p2f8UUvQ;
        "pkg-0.3.3-mc1.21.3" = _Ar6Bs5zH;
        "pkg-0.3.4-mc1.21.4" = _qeNDXBSz;
        "pkg-0.4.0+mc1.21.8" = _VpHXZmPK;
        "pkg-0.4.0+mc1.21.5" = _3o3o1wLw;
        "pkg-0.4.0+mc1.21.4" = _3EXey1f7;
        "pkg-0.4.0+mc1.21.3" = _OWADOqBS;
        "pkg-0.4.0+mc1.21.1" = _60HIosRb;
        "pkg-0.4.1+mc1.21.8" = _sHxrHLkA;
        "pkg-0.4.0+mc1.21.10" = _PX5f4z2A;
        "pkg-0.4.2+mc1.21.8" = _jVHmpNMZ;
        "pkg-0.4.1+mc1.21.5" = _naX8DYRT;
        "pkg-0.4.1+mc1.21.4" = _pKEblgZR;
        "pkg-0.4.1+mc1.21.3" = _kuJSAPBL;
        "pkg-0.4.1+mc1.21.1" = _bNQ9lJbg;
        "pkg-0.4.1+mc1.21.10" = _1sGpYx72;
        "pkg-0.4.2+mc1.21.10" = _usaaYrHm;
        "pkg-0.4.2+mc1.21.4" = _i066uayj;
        "pkg-0.4.3+mc1.21.10" = _r4xJXkH8;
        "pkg-0.4.1+mc1.21.11" = _a4gutR9Z;
        "pkg-0.4.2-alpha.1+mc1.21.11" = _6ywSqDq9;
        "pkg-0.4.3+mc1.21.8" = _azhj8VEd;
        "pkg-0.4.2+mc1.21.5" = _BnGSMv0d;
        "pkg-0.4.2+mc1.21.11" = _ZE91V8aJ;
        "pkg-0.5.0+mc26.1.2" = _7jKfb0O2;
        "pkg-0.5.1+mc26.1.2" = _ZkftJFiQ;
        "pkg-0.4.2+mc1.21.1" = _71jxaAwz;
        "pkg-0.4.2+mc1.21.3" = _ui7HAtbL;
        "pkg-0.4.4+mc1.21.4" = _juqdTLsd;
        "pkg-0.4.3+mc1.21.5" = _sLvrTOZL;
        "pkg-0.4.4+mc1.21.8" = _UL6Wdcfg;
        "pkg-0.4.5+mc1.21.10" = _XJvKNYrc;
        "pkg-0.4.3+mc1.21.11" = _BJ65xT0w;
        "pkg-0.5.0+mc26.2" = _Y9EJDdgM;
        "default" = _Y9EJDdgM;
    });
