...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _T7DN584A;
        "pkg-1.17.0" = _yICOATXa;
        "pkg-1.18.0" = _fSjSKtwB;
        "pkg-1.18.4" = _f8wP58CA;
        "pkg-1.19.0" = _YPCxGCq1;
        "pkg-1.19.3" = _K5xdsaE9;
        "pkg-1.20.0" = _A9qlq6z5;
        "pkg-1.21.0" = _mcVer2k8;
        "pkg-1.22.0" = _1TZGicyx;
        "pkg-1.23.0" = _MEQvyquh;
        "pkg-1.25.0" = _VzdNaTt1;
        "pkg-1.26.0" = _GPSM0Ot1;
        "pkg-1.27.0" = _oIha37Py;
        "pkg-1.27.1" = _HHdJekTS;
        "pkg-1.27.2" = _iMr992Qg;
        "pkg-1.28.0" = _4TaTmwkG;
        "pkg-1.28.1" = _yD65jOXg;
        "pkg-1.29.0" = _k2Py7mfN;
        "pkg-1.29.1" = _n0Y680Xe;
        "pkg-1.29.2" = _dDwV3KC6;
        "pkg-1.30.0" = _3WJB9JiZ;
        "pkg-1.30.2" = _4KefTXhq;
        "default" = _4KefTXhq;
    });
