...
let
    ...
    in {
        ...
        "pkg-v1.1.1+1.21.1" = _CyCFAb5t;
        "pkg-v1.1.1+1.21.4" = _DKNNQbRZ;
        "pkg-v1.2.0+1.21.5" = _K0TBzmev;
        "pkg-v1.2.0+1.21.4" = _pP0hSFkS;
        "pkg-v1.2.0+1.21.1" = _FHk0ysUS;
        "pkg-v1.3.0+1.21.8" = _wmcT0cxF;
        "pkg-v1.4.0+1.21.9" = _pRqh4jqU;
        "pkg-v1.5.0+1.21.11" = _612O6Uzq;
        "pkg-v1.2.1+1.21.1" = _LkW9rsTX;
        "pkg-v1.5.1+1.21.11" = _S0oQPFIq;
        "pkg-v2.0.0+26.1.2-fabric" = _ijdYjPIi;
        "pkg-v2.0.0+26.1.2-neoforge" = _OkgaolPm;
        "pkg-v2.0.0+26.2-fabric" = _C7kEZ4Sp;
        "pkg-v2.0.0+26.2-neoforge" = _rz40q12L;
        "pkg-v1.2.2+1.21.1" = _VX02tNMb;
        "pkg-v2.0.1+26.1.2-fabric" = _616o09tw;
        "pkg-v2.0.1+26.1.2-neoforge" = _x46S69y3;
        "pkg-v2.0.1+26.2-fabric" = _l8u4jDxu;
        "pkg-v2.0.1+26.2-neoforge" = _3AdHOerl;
        "pkg-v2.0.2+26.1.2-fabric" = _YdiFAXND;
