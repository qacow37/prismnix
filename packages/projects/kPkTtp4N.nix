...
let
    ...
    in {
        ...
        "pkg-fabric-1.19.2-1.0.1" = _pnhazOtN;
        "pkg-fabric-1.19.3-1.0.1" = _wxT7GfHM;
        "pkg-fabric-1.19.4-1.0.1" = _mBLuqRzy;
        "pkg-fabric-1.20-1.0.1" = _K8WE5Msz;
        "pkg-fabric-1.20.1-1.0.1" = _JMOufqew;
        "pkg-fabric-1.20.2-1.0.1" = _FFuMLZag;
        "pkg-fabric-1.20.3-1.0.1" = _pj0jGWHc;
        "pkg-fabric-1.20.4-1.0.1" = _KsckrVOs;
        "pkg-fabric-1.19.2-1.1.0" = _42lMpk1w;
        "pkg-fabric-1.20.1-1.1.0" = _480Yjawx;
        "pkg-fabric-1.20.2-1.1.0" = _XKczRpNo;
        "pkg-fabric-1.20.4-1.1.0" = _MpdHyavn;
        "pkg-fabric-1.20.5-1.1.0" = _fyrtFAEf;
        "pkg-fabric-1.20.6-1.1.0" = _CtRhsAbs;
        "pkg-fabric-1.21-1.1.0" = _4Q56z2UV;
        "pkg-fabric-1.21.1-1.1.0" = _lGLXUnPw;
        "pkg-fabric-1.21.2-1.1.0" = _FnC1FJeL;
        "pkg-fabric-1.21.3-1.1.0" = _rUPl66Q8;
        "pkg-fabric-1.21.4-1.1.0" = _UacLsNLJ;
        "pkg-fabric-1.21.5-1.1.0" = _geHUXs1Q;
        "pkg-fabric-1.21.6-1.1.0" = _XMEKv4SV;
        "pkg-fabric-1.21.7-1.1.0" = _IDZVkfVK;
        "pkg-fabric-1.21.8-1.1.0" = _5MYxOr38;
        "pkg-fabric-1.21.9-1.1.0" = _hlRQ9bNn;
        "pkg-fabric-1.21.10-1.1.0" = _7qLQenlv;
        "default" = _7qLQenlv;
    });
