...
let
    ...
    in {
        ...
        "pkg-0.3.0" = _ZZcni9WD;
        "pkg-0.3.1+1.12.2-forge" = _IWxWyROI;
        "pkg-0.3.1+1.16.5-fabric" = _RQ0PTxNF;
        "pkg-0.3.1+1.16.5-forge" = _e2leXfDW;
        "pkg-0.3.1+1.17.1-fabric" = _rXLy7oL5;
        "pkg-0.3.1+1.18.2-fabric" = _HslV7Icy;
        "pkg-0.3.1+1.17.1-forge" = _6gwPksLY;
        "pkg-0.3.1+1.19.2-fabric" = _hE8r8ydX;
        "pkg-0.3.1+1.18.2-forge" = _mgHeSoOj;
        "pkg-0.3.1+1.19.3-fabric" = _idbUzQ8b;
        "pkg-0.3.1+1.19.2-forge" = _VOGLpRG0;
        "pkg-0.3.1+1.19.3-forge" = _5JTJgH6X;
        "pkg-0.3.1+1.19.4-fabric" = _myICZWTK;
        "pkg-0.3.1+1.19.4-forge" = _LzXF86b5;
        "pkg-0.3.1+1.20.1-fabric" = _p81CzQVh;
        "pkg-0.3.1+1.20.1-forge" = _WRAdpPNO;
        "pkg-0.3.1+1.20.2-fabric" = _ZybLgN7J;
        "pkg-0.3.1+1.20.3-fabric" = _q2FhSET5;
        "pkg-0.3.1+1.20.4-fabric" = _Vg3GuU2H;
        "pkg-0.3.1+1.8.9-forge" = _MSKltVkA;
        "pkg-0.3.2+1.12.2-forge" = _YpvuXtlc;
        "pkg-0.3.2+1.16.5-fabric" = _mPE0c22C;
        "pkg-0.3.2+1.16.5-forge" = _47CJdbsA;
        "pkg-0.3.2+1.17.1-fabric" = _G8uy1pVz;
        "pkg-0.3.2+1.18.2-fabric" = _5AOVXD6q;
        "pkg-0.3.2+1.17.1-forge" = _b0jGYVEg;
        "pkg-0.3.2+1.19.2-fabric" = _FQ9dDTPK;
        "pkg-0.3.2+1.18.2-forge" = _T9Xn6h8m;
        "pkg-0.3.2+1.19.3-fabric" = _lwTXmumQ;
        "pkg-0.3.2+1.19.2-forge" = _SuTx1gGN;
        "pkg-0.3.2+1.19.3-forge" = _LdADMwV2;
        "pkg-0.3.2+1.19.4-fabric" = _GJhmwYwW;
        "pkg-0.3.2+1.19.4-forge" = _8GJiv9Eg;
        "pkg-0.3.2+1.20.1-fabric" = _SzO0lA04;
        "pkg-0.3.2+1.20.1-forge" = _8LDbjAvj;
        "pkg-0.3.2+1.20.2-fabric" = _cbDC4TsR;
        "pkg-0.3.2+1.20.3-fabric" = _wRgJadqs;
        "pkg-0.3.2+1.20.4-fabric" = _gBIB4EHS;
        "pkg-0.3.2+1.8.9-forge" = _MmDXXFWf;
        "pkg-0.3.3+1.12.2-forge" = _rRwJqcMf;
        "pkg-0.3.3+1.16.5-fabric" = _bz1IZDLj;
        "pkg-0.3.3+1.16.5-forge" = _bWTzxsYC;
        "pkg-0.3.3+1.17.1-fabric" = _5Jo3N8MY;
        "pkg-0.3.3+1.18.2-fabric" = _rpuK5SJu;
        "pkg-0.3.3+1.17.1-forge" = _AD3lmMzl;
        "pkg-0.3.3+1.19.2-fabric" = _yOaEfL9i;
        "pkg-0.3.3+1.18.2-forge" = _by2uQRjP;
        "pkg-0.3.3+1.19.2-forge" = _SG6fw3Bz;
        "pkg-0.3.3+1.19.3-fabric" = _SSVyCgIO;
        "pkg-0.3.3+1.19.4-fabric" = _sdx7tjb1;
        "pkg-0.3.3+1.19.3-forge" = _DIs7FEOW;
        "pkg-0.3.3+1.19.4-forge" = _C2Q6NLUy;
        "pkg-0.3.3+1.20.1-fabric" = _mSqE74CC;
        "pkg-0.3.3+1.20.1-forge" = _l85tmrkH;
        "pkg-0.3.3+1.20.2-fabric" = _xpJkfb4K;
        "pkg-0.3.3+1.20.3-fabric" = _UxiD1H1U;
        "pkg-0.3.3+1.20.4-fabric" = _ICxVWs5e;
        "pkg-0.3.3+1.8.9-forge" = _MjAALUYe;
        "pkg-0.4.0+1.12.2-forge" = _XLah106P;
        "pkg-0.4.0+1.16.5-fabric" = _o9ZmJvwX;
        "pkg-0.4.0+1.16.5-forge" = _lh8LDISB;
        "pkg-0.4.0+1.17.1-fabric" = _AtY8vOdr;
        "pkg-0.4.0+1.18.2-fabric" = _5IETyIsG;
        "pkg-0.4.0+1.17.1-forge" = _UizWaqYp;
        "pkg-0.4.0+1.19.2-fabric" = _jC4FeRKU;
        "pkg-0.4.0+1.18.2-forge" = _ZyFYnpbr;
        "pkg-0.4.0+1.19.3-fabric" = _XbJSAVfq;
        "pkg-0.4.0+1.19.2-forge" = _cJuvji0X;
        "pkg-0.4.0+1.19.4-fabric" = _35UkXPVF;
        "pkg-0.4.0+1.19.3-forge" = _M97Ogmqo;
        "pkg-0.4.0+1.19.4-forge" = _7N3tdpRy;
        "pkg-0.4.0+1.20.1-fabric" = _VLLX4hWS;
        "pkg-0.4.0+1.20.1-forge" = _f4AWxb21;
        "pkg-0.4.0+1.20.2-fabric" = _4vv1y3lu;
        "pkg-0.4.0+1.20.3-fabric" = _WJnmogCE;
        "pkg-0.4.0+1.20.4-fabric" = _zCWEabXO;
        "pkg-0.4.0+1.8.9-forge" = _3yB2BavQ;
        "pkg-0.5.0+1.12.2-forge" = _kILkoQoA;
        "pkg-0.5.0+1.16.5-fabric" = _vdStZK7o;
        "pkg-0.5.0+1.16.5-forge" = _zyksLXlV;
        "pkg-0.5.0+1.17.1-fabric" = _Omm5CLiJ;
        "pkg-0.5.0+1.18.2-fabric" = _aOuNlGCQ;
        "pkg-0.5.0+1.17.1-forge" = _icDtr2by;
        "pkg-0.5.0+1.19.2-fabric" = _P4NQJSqS;
        "pkg-0.5.0+1.18.2-forge" = _1yHWQKHF;
        "pkg-0.5.0+1.19.2-forge" = _jGqy5cBV;
        "pkg-0.5.0+1.19.3-fabric" = _m8jW6Z8g;
        "pkg-0.5.0+1.19.4-fabric" = _O2SsPNJ3;
        "pkg-0.5.0+1.19.3-forge" = _XOCCHmhI;
        "pkg-0.5.0+1.19.4-forge" = _q6Us7DRt;
        "pkg-0.5.0+1.20.1-fabric" = _C1mUgqXx;
        "pkg-0.5.0+1.20.1-forge" = _HkL0S9fe;
        "pkg-0.5.0+1.20.2-fabric" = _pn3SCTmI;
        "pkg-0.5.0+1.20.3-fabric" = _RzYde49l;
        "pkg-0.5.0+1.20.4-fabric" = _GTI4FW4C;
        "pkg-0.5.0+1.8.9-forge" = _kTU5dYqy;
        "pkg-0.5.1+1.12.2-forge" = _Mrbzbgw3;
        "pkg-0.5.1+1.16.5-fabric" = _CLG0tCB2;
        "pkg-0.5.1+1.16.5-forge" = _r4Ioczhi;
        "pkg-0.5.1+1.17.1-fabric" = _DB3G1uZf;
        "pkg-0.5.1+1.17.1-forge" = _yp8tPwn6;
        "pkg-0.5.1+1.18.2-fabric" = _fmIsdsx0;
        "pkg-0.5.1+1.18.2-forge" = _1rCEivlW;
        "pkg-0.5.1+1.19.2-fabric" = _cSqgZYy5;
        "pkg-0.5.1+1.19.2-forge" = _sPVMUcwf;
        "pkg-0.5.1+1.19.3-fabric" = _2nDGMeyY;
        "pkg-0.5.1+1.19.3-forge" = _fu0vv742;
        "pkg-0.5.1+1.19.4-fabric" = _EKWQqSIX;
        "pkg-0.5.1+1.19.4-forge" = _rHHQ4FLX;
        "pkg-0.5.1+1.20.1-fabric" = _3wb8NBbt;
        "pkg-0.5.1+1.20.1-forge" = _nA062wMF;
        "pkg-0.5.1+1.20.2-fabric" = _VjMQ28n9;
        "pkg-0.5.1+1.20.3-fabric" = _SOu00L98;
        "pkg-0.5.1+1.20.4-fabric" = _pXDCl5qL;
        "pkg-0.5.1+1.8.9-forge" = _LNQje4kQ;
        "pkg-0.5.2+1.12.2-forge" = _DlJaQpFw;
        "pkg-0.5.2+1.16.5-forge" = _6IoSUVtR;
        "pkg-0.5.2+1.16.5-fabric" = _OuwHV4q2;
        "pkg-0.5.2+1.17.1-fabric" = _OUzEOpQp;
        "pkg-0.5.2+1.18.2-fabric" = _qGeiAjvk;
        "pkg-0.5.2+1.17.1-forge" = _yew51pEx;
        "pkg-0.5.2+1.19.2-fabric" = _GgMX1F9i;
        "pkg-0.5.2+1.18.2-forge" = _OVYryM9L;
        "pkg-0.5.2+1.19.3-fabric" = _dXNaifjC;
        "pkg-0.5.2+1.19.2-forge" = _9QjrbrW8;
        "pkg-0.5.2+1.19.4-fabric" = _PQUjagky;
        "pkg-0.5.2+1.19.3-forge" = _yUHuny5M;
        "pkg-0.5.2+1.19.4-forge" = _OLHITHwg;
        "pkg-0.5.2+1.20.1-fabric" = _cayMLkVg;
        "pkg-0.5.2+1.20.1-forge" = _OTy8hIxJ;
        "pkg-0.5.2+1.20.2-fabric" = _rNejpdeH;
        "pkg-0.5.2+1.20.3-fabric" = _S8KrQ21J;
        "pkg-0.5.2+1.20.4-fabric" = _fM4GgfYV;
        "pkg-0.5.2+1.8.9-forge" = _wcSbAIYp;
        "pkg-0.6.2+1.12.2-forge" = _TBJ0DLje;
        "pkg-0.6.2+1.16.5-fabric" = _g1L18lsX;
        "pkg-0.6.2+1.16.5-forge" = _xvYnNwHv;
        "pkg-0.6.2+1.17.1-fabric" = _s2pivj6o;
        "pkg-0.6.2+1.17.1-forge" = _DDrSbPCE;
        "pkg-0.6.2+1.18.2-fabric" = _6X4IE5JE;
        "pkg-0.6.2+1.18.2-forge" = _KxL7QOo7;
        "pkg-0.6.2+1.19.2-fabric" = _LXwht2rH;
        "pkg-0.6.2+1.19.2-forge" = _FVWgLIyd;
        "pkg-0.6.2+1.19.3-fabric" = _NlDxZFJm;
        "pkg-0.6.2+1.19.3-forge" = _drXBWrLz;
        "pkg-0.6.2+1.19.4-fabric" = _J6LII1ED;
        "pkg-0.6.2+1.19.4-forge" = _K3R0KOsA;
        "pkg-0.6.2+1.20.1-fabric" = _In2o8Wue;
        "pkg-0.6.2+1.20.1-forge" = _ISaokrVI;
        "pkg-0.6.2+1.20.2-fabric" = _kiHgatfb;
        "pkg-0.6.2+1.20.3-fabric" = _pcyry868;
        "pkg-0.6.2+1.20.4-fabric" = _zEECyHhf;
        "pkg-0.6.2+1.8.9-forge" = _DRvu26Et;
        "pkg-0.7.0+1.12.2-forge" = _y3a994c7;
        "pkg-0.7.0+1.16.5-fabric" = _iZKzb6me;
        "pkg-0.7.0+1.16.5-forge" = _klQJ5msD;
        "pkg-0.7.0+1.17.1-fabric" = _1TiYe76M;
        "pkg-0.7.0+1.17.1-forge" = _TTyvEeCA;
        "pkg-0.7.0+1.18.2-fabric" = _veGwCJtb;
        "pkg-0.7.0+1.18.2-forge" = _ffQNsYQi;
        "pkg-0.7.0+1.19.2-fabric" = _5UzTWczN;
        "pkg-0.7.0+1.19.2-forge" = _DDkFiGaC;
        "pkg-0.7.0+1.19.3-fabric" = _q9AZXmXV;
        "pkg-0.7.0+1.19.3-forge" = _NaNO68h5;
        "pkg-0.7.0+1.19.4-fabric" = _tcVk258Y;
        "pkg-0.7.0+1.19.4-forge" = _oUEeT6bf;
        "pkg-0.7.0+1.20.1-fabric" = _7lpwfDN1;
        "pkg-0.7.0+1.20.1-forge" = _NVvDV29M;
        "pkg-0.7.0+1.20.2-fabric" = _bGnV4OSe;
        "pkg-0.7.0+1.20.3-fabric" = _m7j9fKXJ;
        "pkg-0.7.0+1.20.4-fabric" = _AdKpRQ6M;
        "pkg-0.7.0+1.8.9-forge" = _VETjBdMH;
        "pkg-0.8.0+1.12.2-forge" = _I9dYgNLW;
        "pkg-0.8.0+1.16.5-fabric" = _TTyXihLg;
        "pkg-0.8.0+1.16.5-forge" = _hVtesWsD;
        "pkg-0.8.0+1.17.1-fabric" = _NPniNw8v;
        "pkg-0.8.0+1.17.1-forge" = _9wArpSxa;
        "pkg-0.8.0+1.18.2-fabric" = _QVRudElT;
        "pkg-0.8.0+1.18.2-forge" = _j9ueb9pz;
        "pkg-0.8.0+1.19.2-fabric" = _gOd52ZTO;
        "pkg-0.8.0+1.19.2-forge" = _bYbkox2p;
        "pkg-0.8.0+1.19.3-fabric" = _cojpwL9p;
        "pkg-0.8.0+1.19.3-forge" = _3nXt1EoC;
        "pkg-0.8.0+1.19.4-fabric" = _dgV0GBW4;
        "pkg-0.8.0+1.19.4-forge" = _TKiolNBf;
        "pkg-0.8.0+1.20.1-fabric" = _DdKJmhnU;
        "pkg-0.8.0+1.20.1-forge" = _8OGqYkGY;
        "pkg-0.8.0+1.20.2-fabric" = _1Llnnut4;
        "pkg-0.8.0+1.20.3-fabric" = _r1KJAQFM;
        "pkg-0.8.0+1.20.4-fabric" = _AbasJI0e;
        "pkg-0.8.0+1.8.9-forge" = _OB3tI1zo;
        "pkg-0.9.4+1.12.2-forge" = _Y2ZUr1pq;
        "pkg-0.9.4+1.16.5-fabric" = _vqkBX6v5;
        "pkg-0.9.4+1.16.5-forge" = _NdwoUseO;
        "pkg-0.9.4+1.17.1-fabric" = _EhunuThe;
        "pkg-0.9.4+1.18.2-fabric" = _yFmpIuH4;
        "pkg-0.9.4+1.17.1-forge" = _FYNPCgHo;
        "pkg-0.9.4+1.19.2-fabric" = _xVFc5aO9;
        "pkg-0.9.4+1.18.2-forge" = _cNNA2h3r;
        "pkg-0.9.4+1.19.2-forge" = _er3OVNxE;
        "pkg-0.9.4+1.19.3-fabric" = _n67zc9Nf;
        "pkg-0.9.4+1.19.4-fabric" = _RPX9VjDU;
        "pkg-0.9.4+1.19.3-forge" = _CAd9lqfs;
        "pkg-0.9.4+1.19.4-forge" = _j85s2M4Y;
        "pkg-0.9.4+1.20.1-fabric" = _uiKxUObd;
        "pkg-0.9.4+1.20.1-forge" = _shOGQPt2;
        "pkg-0.9.4+1.20.2-fabric" = _CfBK7mMm;
        "pkg-0.9.4+1.20.3-fabric" = _Msyx0lHF;
        "pkg-0.9.4+1.20.4-fabric" = _fFjtxEaQ;
        "pkg-0.9.4+1.8.9-forge" = _H6nrY0UB;
        "pkg-0.10.0+1.12.2-forge" = _K6ihgYqq;
        "pkg-0.10.0+1.16.5-fabric" = _pmvTRAJu;
        "pkg-0.10.0+1.16.5-forge" = _Qa3C69aQ;
        "pkg-0.10.0+1.17.1-fabric" = _FKVy4L7i;
        "pkg-0.10.0+1.17.1-forge" = _CbqSx7ok;
        "pkg-0.10.0+1.18.2-fabric" = _kcnKMbB7;
        "pkg-0.10.0+1.18.2-forge" = _4bpuSyRv;
        "pkg-0.10.0+1.19.2-fabric" = _XYRZaFHw;
        "pkg-0.10.0+1.19.2-forge" = _zKq7SAnd;
        "pkg-0.10.0+1.19.3-fabric" = _aGI3RbYu;
        "pkg-0.10.0+1.19.3-forge" = _hM6V2Ty9;
        "pkg-0.10.0+1.19.4-fabric" = _K9NS3t6q;
        "pkg-0.10.0+1.19.4-forge" = _DaLEgbzv;
        "pkg-0.10.0+1.20.1-fabric" = _qcYs53Wz;
        "pkg-0.10.0+1.20.1-forge" = _lPTseaWi;
        "pkg-0.10.0+1.20.2-fabric" = _7jSteQVo;
        "pkg-0.10.0+1.20.2-forge" = _Ayz5ImYp;
        "pkg-0.10.0+1.20.4-fabric" = _xWYlPtQ2;
        "pkg-0.10.0+1.20.3-fabric" = _VF1LnCZf;
        "pkg-0.10.0+1.20.6-fabric" = _IqGkPWa4;
        "pkg-0.10.0+1.8.9-forge" = _OBx5Abl4;
        "pkg-0.10.1+1.12.2-forge" = _UA4Bqjfs;
        "pkg-0.10.1+1.16.5-fabric" = _hp7anBza;
        "pkg-0.10.1+1.16.5-forge" = _LyOZQBi8;
        "pkg-0.10.1+1.17.1-fabric" = _NhQXvqeo;
        "pkg-0.10.1+1.17.1-forge" = _xzXumikz;
        "pkg-0.10.1+1.18.2-fabric" = _uFmqxbtg;
        "pkg-0.10.1+1.18.2-forge" = _ZRaXHifc;
        "pkg-0.10.1+1.19.2-fabric" = _JzaCLOWz;
        "pkg-0.10.1+1.19.2-forge" = _cdz6leDH;
        "pkg-0.10.1+1.19.3-fabric" = _9izoOlqD;
        "pkg-0.10.1+1.19.3-forge" = _cLWqFt57;
        "pkg-0.10.1+1.19.4-fabric" = _ThllH4SY;
        "pkg-0.10.1+1.19.4-forge" = _cBATpHhW;
        "pkg-0.10.1+1.20.1-fabric" = _GbOeR2su;
        "pkg-0.10.1+1.20.1-forge" = _LdmeA6VW;
        "pkg-0.10.1+1.20.2-fabric" = _oIQgjC2B;
        "pkg-0.10.1+1.20.2-forge" = _Cta7LGo9;
        "pkg-0.10.1+1.20.4-fabric" = _VRuOIsJ8;
        "pkg-0.10.1+1.20.6-fabric" = _1kJoUtht;
        "pkg-0.10.1+1.8.9-forge" = _aN7zzpeg;
        "pkg-0.10.1+1.20.3-fabric" = _tqjdHlcB;
        "pkg-0.10.2+1.12.2-forge" = _UWcJn662;
        "pkg-0.10.2+1.16.5-fabric" = _eWVtoDFn;
        "pkg-0.10.2+1.16.5-forge" = _tyrlmEm0;
        "pkg-0.10.2+1.17.1-fabric" = _G5wImzwI;
        "pkg-0.10.2+1.17.1-forge" = _KzSZZMzH;
        "pkg-0.10.2+1.18.2-fabric" = _cd2h0wsx;
        "pkg-0.10.2+1.18.2-forge" = _NuyU8Buk;
        "pkg-0.10.2+1.19.2-fabric" = _wDHngVOf;
        "pkg-0.10.2+1.19.2-forge" = _fwI55Cd0;
        "pkg-0.10.2+1.19.3-fabric" = _X9jlPhLT;
        "pkg-0.10.2+1.19.3-forge" = _LB2aVG8I;
        "pkg-0.10.2+1.19.4-fabric" = _vXrUbTR0;
        "pkg-0.10.2+1.19.4-forge" = _EQ9IxuEa;
        "pkg-0.10.2+1.20.1-fabric" = _EhNDUiZ0;
        "pkg-0.10.2+1.20.1-forge" = _FJkKtVa3;
        "pkg-0.10.2+1.20.2-fabric" = _IgXB7CgY;
        "pkg-0.10.2+1.20.2-forge" = _UK8XI7d9;
        "pkg-0.10.2+1.20.4-fabric" = _yB70tfwf;
        "pkg-0.10.2+1.20.6-fabric" = _OJ1usfv4;
        "pkg-0.10.2+1.8.9-forge" = _SZwnJc0s;
        "pkg-0.10.2+1.20.3-fabric" = _SQ3HNFqX;
        "pkg-0.11.0+1.12.2-forge" = _9js3ytNP;
        "pkg-0.11.0+1.16.5-forge" = _V5GnXrYU;
        "pkg-0.11.0+1.16.5-fabric" = _5bq3wKtX;
        "pkg-0.11.0+1.17.1-fabric" = _eJKlaplk;
        "pkg-0.11.0+1.18.2-fabric" = _6LSs3gnX;
        "pkg-0.11.0+1.17.1-forge" = _12R353pp;
        "pkg-0.11.0+1.19.2-fabric" = _KExNJces;
        "pkg-0.11.0+1.18.2-forge" = _2DwaVftU;
        "pkg-0.11.0+1.19.3-fabric" = _kgEwTozz;
        "pkg-0.11.0+1.19.2-forge" = _1JXmBcGP;
        "pkg-0.11.0+1.19.4-fabric" = _QIJYQtAy;
        "pkg-0.11.0+1.19.3-forge" = _YaP45c9s;
        "pkg-0.11.0+1.19.4-forge" = _WNjFiyfq;
        "pkg-0.11.0+1.20.1-fabric" = _QoGFrbwr;
        "pkg-0.11.0+1.20.1-forge" = _eSqeeVXI;
        "pkg-0.11.0+1.20.2-fabric" = _HVuCy2MK;
        "pkg-0.11.0+1.20.2-forge" = _7e83YOe4;
        "pkg-0.11.0+1.20.3-fabric" = _fJ00tp3w;
        "pkg-0.11.0+1.20.4-fabric" = _LKNFBRN6;
        "pkg-0.11.0+1.20.6-fabric" = _kdR4eN6F;
        "pkg-0.11.0+1.8.9-forge" = _2Vmo4gdW;
        "default" = _2Vmo4gdW;
    });
