...
let
    ...
    in {
        ...
        "pkg-v2.3.2-mc1.20.4" = _fFsVfrRc;
        "pkg-v2.3.2-mc1.21.1" = _n4gGC2re;
        "pkg-v2.3.2-mc1.20.1" = _gKXdpbAG;
        "pkg-v2.3.2-mc1.21.4" = _AQ2JpiG9;
        "pkg-v2.3.2-mc1.17.1" = _zMSNIV1G;
        "pkg-v2.3.2-mc1.21.6" = _ZOl709Qs;
        "default" = _ZOl709Qs;
    });
