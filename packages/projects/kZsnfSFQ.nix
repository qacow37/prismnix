...
let
    ...
    in {
        ...
        "pkg-1.20.2(Forge)" = _6gtVIwlx;
        "pkg-1.20.3(Forge)" = _rgqPaTpy;
        "pkg-1.20.4(Forge)" = _RAe7D7vn;
        "pkg-1.20.6(Forge)" = _1yLMfAH7;
        "pkg-1.21(Forge)" = _soGLwK9h;
        "pkg-1.21.1(Forge)" = _Axm0ZuNT;
        "pkg-1.20.5-1.20.6(Fabric)" = _3qhLWWqT;
        "pkg-1.21-1.21.1(Fabric)" = _qM88jbi7;
        "pkg-1.21.2-1.21.10(Fabric)" = _6F9Oe7cG;
        "pkg-1.21.2-1.21.10(NeoForge)" = _rKtg1nPJ;
        "pkg-1.21.3-1.21.4(Forge)" = _zl7jbrya;
        "pkg-1.21.6-1.21.10(Forge)" = _PBeVuhpq;
        "pkg-1.21.11(NeoForge)" = _8yEVwjhj;
        "pkg-1.21.11(Forge)" = _6onhcmOz;
        "pkg-1.21.11(Fabric)" = _vXU2rhq5;
        "pkg-26.1(NeoForge)" = _86vwfDgD;
        "pkg-26.1(Forge)" = _o7kB3GhD;
        "pkg-26.1(Fabric)" = _KOf5Wdqq;
        "pkg-26.1.1-26.1.2(Fabric)" = _s6L65XkC;
        "pkg-26.1.1-26.1.2(Forge)" = _WWiJdjtK;
        "pkg-26.1.1-26.1.2(NeoForge)" = _ODmVCH4V;
        "pkg-26.2(Fabric)" = _sPabFltp;
        "pkg-26.2(Forge)" = _fePuo5zm;
        "pkg-26.2(NeoForge)" = _TyM94Bvi;
        "pkg-2.0.0_1.20.6(Forge)" = _J9jLcPXA;
        "pkg-2.0.0_1.20.6(Fabric)" = _Vp4bWNda;
        "pkg-2.0.0_1.21-1.21.1(Forge)" = _rj5QQyLq;
        "pkg-2.0.0_1.21-1.21.1(Fabric)" = _aK6zjBMT;
        "pkg-2.0.0_1.21-1.21.1(NeoForge)" = _PcWo5H1C;
        "pkg-2.0.0_1.21.2-1.21.10(Forge)" = _EYZ0k5CB;
        "pkg-2.0.0_1.21.2-1.21.10(Fabric)" = _gAQ7x22t;
        "pkg-2.0.0_1.21.2-1.21.10(NeoForge)" = _LORf8J16;
