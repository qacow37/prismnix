...
let
    ...
    in {
        ...
        "pkg-1.7.2.9" = _65NBMSjg;
        "pkg-2.0.0.22" = _wj5b1Ejg;
        "pkg-2.0.0.24" = _uzgNSsG5;
        "pkg-2.0.0.27" = _Uzo8z4sf;
        "pkg-2.0.0.28" = _lBGSvVGI;
        "pkg-2.0.0.29" = _iQ3tiIzQ;
        "pkg-2.0.0.30" = _nJ5etATo;
        "pkg-2.0.0.31" = _CLmfKkju;
        "pkg-2.1.0.1" = _7j37d7vv;
        "pkg-2.1.0.2" = _namgQRoJ;
        "pkg-2.1.0.3" = _WKIOORal;
        "pkg-2.0.0.33" = _ruKu2BKh;
        "pkg-2.1.0.4" = _XEz6FEIK;
        "pkg-3.0.0.1" = _ysZCgzAj;
        "pkg-2.1.0.5" = _T5eonXSO;
        "pkg-3.0.0.2" = _kwndnYkv;
        "pkg-2.1.0.6" = _8BaTzs3Y;
        "pkg-3.0.0.4" = _1HiVdKRZ;
        "pkg-3.0.0.5" = _5ESbkJxK;
        "pkg-3.0.0.6" = _TwXO92oA;
        "pkg-3.0.0.7" = _D6590SDJ;
        "pkg-3.0.0.8" = _Dot0v7oU;
        "pkg-3.0.0.9" = _t5a6eolD;
        "pkg-3.0.0.10" = _wQyVUpFP;
        "pkg-3.0.0.11" = _w34MzwZI;
        "pkg-3.0.0.12" = _YQ2xBMuu;
        "pkg-3.0.0.14" = _w8X4SOHm;
        "pkg-3.0.0.15" = _NMkitlJl;
        "pkg-3.0.0.17" = _4SFP31Aw;
        "pkg-3.0.0.18" = _H47ZxYf1;
        "pkg-3.0.0.19" = _i6nCwjWU;
        "pkg-3.0.0.20" = _2wgn0dHj;
        "pkg-3.0.0.21" = _agIoqOEV;
        "pkg-3.0.0.22" = _RZQ0DiDI;
        "pkg-3.0.0.24" = _8UbeuXR6;
        "pkg-3.1.0.0" = _MbhthKir;
        "pkg-3.1.0.1" = _dN8E5zJw;
        "pkg-3.1.0.2" = _Hpv363ei;
        "pkg-3.1.0.3" = _4h7oU9qh;
        "pkg-3.1.0.4" = _1sLjqIP9;
        "pkg-3.1.0.5" = _esYvSBvz;
        "pkg-3.1.0.6" = _l36bkyiX;
        "pkg-3.1.0.7" = _h8EVBMNZ;
        "pkg-3.1.0.8" = _L0phIDNd;
        "pkg-3.1.10" = _ktslypSP;
        "pkg-3.1.11" = _odH1eB1x;
        "default" = _odH1eB1x;
    });
