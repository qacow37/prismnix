...
let
    ...
    in {
        ...
        "pkg-0.3.0-1.21" = _uoqZQuGD;
        "pkg-0.4.0-1.21" = _3AxSL52y;
        "pkg-0.4.1-1.21" = _pOg4tcDY;
        "pkg-0.4.2-1.21" = _KhVS4osN;
        "pkg-0.5.0+fabric-mc1.21.1" = _ULbf1HFv;
        "pkg-0.5.0+forge-mc1.21.1" = _mJ9AUuS0;
        "pkg-0.5.0+neoforge-mc1.21.1" = _7WXtmBiy;
        "pkg-0.6.0+fabric-1.21.1" = _LtL66cDz;
        "pkg-0.6.0+forge-1.21.1" = _FeE56Tre;
        "pkg-0.6.0+neoforge-1.21.1" = _wyRd0Etj;
        "pkg-0.6.1+fabric-1.21.1" = _vssWABzG;
        "pkg-0.6.1+forge-1.21.1" = _R2wlqWqy;
        "pkg-0.6.1+neoforge-1.21.1" = _bLJZSBmQ;
        "pkg-0.7.0+fabric-1.21.3" = _LO8sNMcg;
        "pkg-0.7.0+forge-1.21.3" = _rFs4qV0t;
        "pkg-0.7.0+neoforge-1.21.3" = _E8IWoKW5;
        "pkg-0.7.1+fabric-1.21.4" = _y6WWnRIA;
        "pkg-0.7.1+forge-1.21.4" = _eQAZx4cK;
        "pkg-0.7.1+neoforge-1.21.4" = _pQNthXPo;
        "pkg-0.7.2+fabric-1.21.4" = _jHt9OjJS;
        "pkg-0.7.2+forge-1.21.4" = _xzspABYb;
        "pkg-0.7.2+neoforge-1.21.4" = _dOMOqolh;
        "pkg-0.8.0+fabric-1.21.5" = _iZ6nIoTx;
        "pkg-0.8.0+forge-1.21.5" = _QhaGQiqt;
        "pkg-0.8.0+neoforge-1.21.5" = _xADFAKUu;
        "pkg-0.8.1+fabric-1.21.5" = _EPtThEa5;
        "pkg-0.8.1+forge-1.21.5" = _1Olpy4Yg;
        "pkg-0.8.1+neoforge-1.21.5" = _s53Mzb1V;
        "pkg-0.9.0+fabric-1.21.5" = _kvQg4Qdc;
        "pkg-0.9.0+forge-1.21.5" = _FUZoIdfX;
        "pkg-0.9.0+neoforge-1.21.5" = _QSvdAQKG;
        "pkg-0.10.0+fabric-1.21.7" = _Y63Sg816;
        "pkg-0.10.0+neoforge-1.21.7" = _WnMl5nES;
        "pkg-0.10.0+fabric-1.21.8" = _Gfmqtv49;
        "pkg-0.10.0+neoforge-1.21.8" = _iAREGQqW;
        "pkg-0.11.0+fabric-1.21.10" = _dTzQe0IF;
        "pkg-0.11.0+neoforge-1.21.10" = _qBYIPg2F;
        "pkg-0.11.1+fabric-1.21.10" = _r3cs0Pis;
        "pkg-0.11.1+neoforge-1.21.10" = _mFChwMT4;
        "pkg-0.12.0+fabric-1.21.11" = _7Q8Egosy;
        "pkg-0.12.0+neoforge-1.21.11" = _WTcSqupS;
        "pkg-0.13.0+fabric-26.1.1" = _Gdpw5FYe;
        "pkg-0.13.0+neoforge-26.1.1" = _Cn7F08Yi;
        "pkg-0.13.1+fabric-26.1.2" = _fj3m3ypE;
