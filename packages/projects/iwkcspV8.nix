...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _UqsZkOIJ;
        "pkg-1.0.5" = _ZLU0I7f8;
        "pkg-v1.1.0" = _aCxwiTAr;
        "pkg-v1.1.1" = _GjSwElPO;
        "pkg-v1.2.0" = _siQJYAUI;
        "pkg-v1.3.0" = _AzfotjiL;
        "pkg-v1.3.1" = _aIhKxHsx;
        "pkg-v1.3.2" = _oBxjVYh4;
        "pkg-v1.4.0" = _II9B0WfW;
        "pkg-v1.4.1" = _MYgbq09R;
        "pkg-v1.4.1-1.19.3" = _P15ILntG;
        "pkg-v1.4.1-1.19.4" = _XshoAojn;
        "pkg-v1.4.1-1.20" = _ffy7xMAp;
        "pkg-v1.4.2-1.19.2" = _Vzeg6Dde;
        "pkg-v1.4.2-1.19.3" = _7aMO5mXt;
        "pkg-v1.4.2-1.19.4" = _ksqAcgEQ;
        "pkg-v1.4.2-1.20" = _5Wna6NQB;
        "pkg-v1.5.0-1.20" = _E1A6gzR9;
        "pkg-v1.5.0-1.19.4" = _YfHBcDfX;
        "pkg-v1.5.0-1.19.2" = _xbLEPnVV;
        "pkg-v1.5.0-1.19.3" = _iJynf8BF;
        "pkg-v1.5.1-1.19.2" = _SFAnRtv4;
        "pkg-v1.5.1-1.19.3" = _o2eMgEH0;
        "pkg-v1.5.1-1.19.4" = _4BDVvKWo;
        "pkg-v1.5.1-1.20" = _vcVNWskw;
        "pkg-v1.5.2-1.19.2" = _k1hWSCwD;
        "pkg-v1.5.2-1.19.3" = _q0jtwL0O;
        "pkg-v1.5.2-1.19.4" = _3GGqnZIx;
        "pkg-v1.5.2-1.20" = _PjzwkCIg;
        "pkg-v1.5.3-1.19.2" = _YGoRtiPi;
        "pkg-v1.5.3-1.19.3" = _qSEwJPWd;
        "pkg-v1.5.3-1.19.4" = _FAUDK5bR;
        "pkg-v1.5.3-1.20" = _iqsntyQW;
        "pkg-v1.5.3.1-1.19.2" = _Lc6BKCGE;
        "pkg-v1.5.3.1-1.19.3" = _78AH9liO;
        "pkg-v1.5.3.1-1.19.4" = _2VzXZddi;
        "pkg-v1.5.3.1-1.20" = _fxxhkXl3;
        "pkg-v1.5.4-1.19.2" = _c8gipu01;
        "pkg-v1.5.4-1.19.3" = _eIhbpqef;
        "pkg-v1.5.4-1.19.4" = _widn2XMR;
        "pkg-v1.5.4-1.20" = _olQnzZLp;
        "pkg-v1.5.4.1-1.19.2" = _zgGBWe5T;
        "pkg-v1.5.4.1-1.19.3" = _mxiUNzwW;
        "pkg-v1.5.4.1-1.19.4" = _8IgYXNem;
        "pkg-v1.5.4.1-1.20" = _2cZxleBi;
        "pkg-v1.5.5-1.19.2" = _Zv3JsLJd;
        "pkg-v1.5.5-1.19.3" = _sa5TikWF;
        "pkg-v1.5.5-1.19.4" = _5RjfhqDD;
        "pkg-v1.5.5-1.20" = _WH6NmdDO;
        "pkg-v1.5.6-1.19.2" = _c6E29n8i;
        "pkg-v1.5.6-1.19.3" = _p0RaZhRD;
        "pkg-v1.5.6-1.19.4" = _odTJXohu;
        "pkg-v1.5.6-1.20" = _J2yJSrxm;
        "pkg-1.5.7-1.19.2" = _kdiekpSE;
        "pkg-1.5.7-1.19.3" = _Jy45XBDR;
        "pkg-1.5.7-1.19.4" = _MhJ1Sc9j;
        "pkg-1.5.7-1.20" = _rF87WOC9;
        "pkg-1.6.0-1.20" = _Yq6Xrivj;
        "pkg-1.6.1-1.20" = _v2iXjV0l;
        "pkg-1.6.2-1.20" = _oAcU36ku;
        "pkg-1.6.3-1.20" = _9kHmTWEj;
        "pkg-1.6.4-1.20" = _qHV2Ufmn;
        "pkg-1.6.4-1.21" = _EUJNfzzE;
        "default" = _EUJNfzzE;
    });
