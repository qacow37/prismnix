...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.14.4" = _eratCuKf;
        "pkg-1.0.5-1.14.4" = _I3g046m7;
        "pkg-1.0.5-19w35a" = _qZj87zGv;
        "pkg-1.0.8-1.14.4" = _BUTjK1uP;
        "pkg-1.0.8-19w38b" = _q0Lzcpg4;
        "pkg-1.1.0-1.14.4" = _EUzf7Fcs;
        "pkg-1.1.0-19w38b" = _UdiXsvpl;
        "pkg-1.1.0-19w39a" = _SlkFOkZR;
        "pkg-1.1.2-1.14.4" = _Dvy2NM1b;
        "pkg-1.1.2_2-1.14.4" = _FFlg7jci;
        "pkg-1.1.2-19w41a" = _8k6Oh4qw;
        "pkg-1.1.2_2-19w41a" = _2mfjAk9R;
        "pkg-1.1.3-1.14.4" = _VEe0cXzI;
        "pkg-1.1.3-19w42a" = _nXDIa5GV;
        "pkg-1.1.3_2-19w42a" = _esI3wmYK;
        "pkg-1.2.1-1.14.4" = _oyLNuCCF;
        "pkg-1.2.1-19w44a" = _yuCDihG4;
        "pkg-1.2.2-1.14.4" = _S1rABomy;
        "pkg-1.2.2-19w45a" = _iCr5Lxi8;
        "pkg-1.2.3-1.14.4" = _UHWWaQEt;
        "pkg-1.2.3-19w46a" = _cgY1dS7P;
        "pkg-1.2.4-1.14.4" = _iOi1BlbS;
        "pkg-1.2.4-1.15-pre1" = _zHv0lJ1p;
        "pkg-1.2.5-1.14.4" = _p496Lw70;
        "pkg-1.2.5-1.15-pre4" = _xnk2qnQP;
        "pkg-1.2.6-1.14.4" = _5EFTFmWO;
        "pkg-1.2.6-1.15" = _Rr12cPE1;
        "pkg-1.2.0-1.14.4" = _NyOgYNas;
        "pkg-1.2.0-19w42a" = _xXOlZNgC;
        "pkg-1.3.0-1.14.4" = _XfyZ5S4D;
        "pkg-1.3.0-1.15" = _hieSHB8h;
        "pkg-1.3.4-1.14.4" = _A4Wzrws7;
        "pkg-1.3.4-1.15.1" = _RxU247ZO;
        "pkg-1.3.5-1.14.4" = _GJm0jcqe;
        "pkg-1.3.5-1.15.2" = _hkml4tBM;
        "pkg-1.3.9-1.15.2" = _wKPXPtOF;
        "pkg-1.3.9-20w06a" = _RrQE701N;
        "pkg-1.3.13-1.15.2" = _6QobLxTd;
        "pkg-1.3.13-20w10a" = _jos404Vv;
        "pkg-1.3.14-1.15.2" = _2mi9mGuG;
        "pkg-1.3.14-20w11a" = _ja5BmG5s;
        "pkg-1.3.15-1.15.2" = _RtgA0RPP;
        "pkg-1.3.15-20w12a" = _fjVwU84q;
        "pkg-1.3.17-1.15.2" = _WPUfiXaj;
        "pkg-1.3.17-20w13b" = _90WS8oKX;
        "pkg-1.3.17-20w14a" = _rZrSaVDl;
        "pkg-1.3.18-1.15.2" = _Rd5HtU2L;
        "pkg-1.3.18-20w15a" = _f9ByY9Ub;
        "pkg-1.3.19-20w16a" = _3xOwc5wO;
        "pkg-1.3.20-20w17a" = _2aSJBmJk;
        "pkg-1.3.23-20w20b" = _M1LmMwVL;
        "pkg-1.3.24-20w21a" = _7N1R3YOs;
        "pkg-1.3.25-20w22a" = _lO4yCxxP;
        "pkg-1.3.26-1.16-pre1" = _XwyIR1bD;
        "pkg-1.3.27-1.16-pre2" = _2pPTDmkK;
        "pkg-1.3.28-1.15.2" = _PDic0LfP;
        "pkg-1.3.28-1.16-pre3" = _caw4WMme;
        "pkg-1.3.33-1.15.2" = _lrxqO2hZ;
        "pkg-1.3.33-1.16-rc1" = _N3jcSkXS;
        "pkg-1.4.0-1.15.2" = _hdxoiPaC;
        "pkg-1.4.0-1.16" = _dTOqNn8L;
        "pkg-1.4.1-20w27a" = _7uNxeumi;
        "pkg-1.4.5-1.16.2-pre1" = _33rtdN2I;
        "pkg-1.4.8-1.16.2" = _SAjv47UV;
        "pkg-1.4.11-1.16.3" = _S0UfQRMT;
        "pkg-1.4.14-1.16.4-pre2" = _enVtuKoU;
        "pkg-1.4.16-1.16.4" = _AxbaVhhg;
        "pkg-1.4.16-20w45a" = _9BhhmPnt;
        "pkg-1.4.23-1.16.5" = _nU9YQW0r;
        "pkg-1.4.23-20w51a" = _nRMllA80;
        "pkg-1.4.27-1.16.5" = _mHmqoTPm;
        "pkg-1.4.27-21w07a" = _pvlUqmNU;
        "pkg-1.4.30-1.16.5" = _kB4kbziw;
        "pkg-1.4.30-21w13a" = _ywBdooxp;
        "pkg-1.4.33-1.16.5" = _go7EWMzf;
        "pkg-1.4.33-21w16a" = _wK5kUKNf;
        "pkg-1.4.34-1.16.5" = _gOTPGADM;
        "pkg-1.4.34-21w17a" = _JYrmpHRw;
        "pkg-1.4.39-1.16.5" = _auqXIZKr;
        "pkg-1.4.39-1.17-pre2" = _GRoNjV9m;
        "pkg-1.4.40-1.16.5" = _y4hLZfVx;
        "pkg-1.4.40-1.17" = _FAJMcMe0;
        "pkg-1.4.43-1.16.5" = _cNSV3Ic1;
        "pkg-1.4.43-1.17.1" = _78EUEvxT;
        "pkg-1.4.51-1.17.1" = _w2lQrIJ9;
        "pkg-1.4.51-21w43a" = _tHBw3ezp;
        "pkg-1.4.56-1.17.1" = _F7LVluUL;
        "pkg-1.4.56-1.18" = _9xQ8TS4S;
        "pkg-1.4.57-1.17.1" = _72bj9aHc;
        "pkg-1.4.57-1.18.1" = _PtjLfcFZ;
        "pkg-1.4.64-1.18.2-pre2" = _VzWEKCl2;
        "pkg-1.4.69-1.18.2" = _DlKYS7Ww;
        "pkg-1.4.69-22w13a" = _zmKTNyVl;
        "pkg-1.4.70-22w14a" = _9XsiCVDE;
        "pkg-1.4.72-1.18.2" = _BtniZiNY;
        "pkg-1.4.72-22w16b" = _jB44a8Uv;
        "pkg-1.4.74-22w18a" = _UHVLgO4X;
        "pkg-1.4.75-22w19a" = _kHbjnOFD;
        "pkg-1.4.79-1.19" = _1lJeDZmM;
        "pkg-1.4.83-1.19.1" = _CE1Y0wos;
        "pkg-1.4.84-1.19.2" = _VyQpFhmm;
        "pkg-1.4.91-1.19.3" = _BUUkRrP9;
        "pkg-1.4.100-1.19.4" = _JCNo7QLB;
        "pkg-1.4.112" = _zKDLpefr;
        "pkg-1.4.115" = _gPJoJ3mr;
        "pkg-1.4.118" = _XiXJeZ6p;
        "pkg-1.4.128" = _APnGg1O6;
        "pkg-1.4.141" = _K5R1RGk8;
        "pkg-1.4.147" = _TjVkbhbd;
        "pkg-1.4.148" = _8gEVsK18;
        "pkg-1.4.158" = _WDB4578I;
        "pkg-1.4.161" = _jLwlJK0f;
        "pkg-1.4.169" = _S0h1eOs5;
        "pkg-1.4.170" = _4r4Fpql5;
        "pkg-1.4.176" = _eAJGDnBx;
        "pkg-1.4.185" = _aQr1yD5l;
        "pkg-26.1" = _DjOwoVgq;
        "pkg-26.2" = _Z5BJRYil;
        "default" = _Z5BJRYil;
    });
