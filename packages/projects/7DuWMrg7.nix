...
let
    ...
    in {
        ...
        "pkg-1.20.1-0.1" = _Gjpl0Bxz;
        "pkg-1.20.1-0.1.1" = _VZaaBwKM;
        "pkg-1.20.1-0.1.2" = _QA7iHna1;
        "pkg-1.20.1-0.1.3" = _BFkYDoxX;
        "pkg-1.20.1-0.1.4" = _gwK9CM9d;
        "pkg-1.20.1-0.1.5" = _7Q0ZITBq;
        "default" = _7Q0ZITBq;
    });
