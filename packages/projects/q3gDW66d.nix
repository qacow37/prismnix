...
let
    ...
    in {
        ...
        "pkg-v1.1" = _1BsUQP0w;
        "pkg-v1.2" = _9i6zo2Nr;
        "pkg-v1.2+mod" = _DY8yEJLW;
        "pkg-v2.0" = _WbDbjxmy;
        "pkg-v2.0+mod" = _139gI6T3;
        "pkg-v2.1" = _9By4UTrr;
        "pkg-v2.1+mod" = _Se4Tqlxe;
        "pkg-v2.2" = _5ZuGxBGg;
        "pkg-v2.2+mod" = _4RuB6lyb;
        "pkg-v2.3" = _Z4fAV2Yc;
        "pkg-v2.3+mod" = _rDch2W7h;
        "pkg-v2.4" = _lpXuErtc;
        "pkg-v2.4+mod" = _dSSkqMl4;
        "pkg-v2.5" = _RKQ4QQY1;
        "pkg-v2.5+mod" = _mjHSojUv;
        "pkg-v2.6" = _wo2Nh7kw;
        "pkg-v2.6+mod" = _l8MDtvTj;
        "pkg-v2.7" = _wjhl96GQ;
        "pkg-v2.7+mod" = _38O3piEp;
        "pkg-v2.8" = _PZT1bd3B;
        "pkg-v2.8+mod" = _p9AB4oNm;
        "pkg-v2.9" = _d8UeLKhF;
