...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.4-fabric" = _r3627QzD;
        "pkg-1.18.2-1.4-fabric" = _6foJAL1A;
        "pkg-1.16.5-1.0-forge" = _iugaKIG2;
        "pkg-1.18.2-1.1-forge" = _cAzsrdgw;
        "pkg-1.16.5-1.5-forge" = _GWvYUbfj;
        "pkg-1.18.2-1.5-forge" = _OvpmI5c6;
        "pkg-1.19.2-1.5-forge" = _cmapOazu;
        "pkg-1.19.2-1.6-forge" = _R61Jbneg;
        "pkg-1.16.5-1.8-fabric" = _pjrERGuQ;
        "pkg-1.18.2-1.8-fabric" = _EzHwqQP5;
        "pkg-1.16.5-1.9-fabric" = _SRbkjFBL;
        "pkg-1.18.2-1.9-fabric" = _qAV0b56S;
        "pkg-1.19.3-1.6-forge" = _4k0APz8e;
        "pkg-1.18.2-2.0-forge+fabric" = _lO3CtKOJ;
        "pkg-1.19.2-2.0-forge+fabric" = _X1YVBjGK;
        "pkg-1.19.3-2.0-forge+fabric" = _3kGhkXDs;
        "pkg-1.18.2-2.1-forge+fabric" = _tTmIrzDu;
        "pkg-1.19.2-2.1-forge+fabric" = _Ixrr4dSw;
        "pkg-1.19.3-2.1-forge+fabric" = _gVBbIQpJ;
        "pkg-1.18.2-2.2-forge+fabric" = _TNwE6BH5;
        "pkg-1.19.2-2.2-forge+fabric" = _qgsh2UD5;
        "pkg-1.19.3-2.2-forge+fabric" = _1zRYvejz;
        "pkg-1.19.4-2.2-forge+fabric" = _8WGwQRQq;
        "pkg-1.20-2.2-forge+fabric" = _IdJr4Uhe;
        "pkg-1.20.1-2.2-forge+fabric" = _tIWhK0cr;
        "pkg-1.20.2-2.2-forge+fabric" = _PjSyvojx;
        "pkg-1.18.2-2.3-forge+fabric" = _RxLmAxhn;
        "pkg-1.19.2-2.3-forge+fabric" = _vXBQmjHC;
        "pkg-1.20.1-2.3-forge+fabric" = _spwoztEo;
        "pkg-1.20.2-2.3-forge+fabric" = _fWR9d2nU;
        "pkg-1.20.3-2.3-fabric+forge+neo" = _XS3djf7C;
        "pkg-1.20.4-2.3-fabric+forge+neo" = _edfyvGDh;
        "pkg-1.19.2-2.4-fabric+forge+neo" = _j28vt7vG;
        "pkg-1.20.1-2.4-fabric+forge+neo" = _IdeOjtae;
        "pkg-1.20.2-2.4-fabric+forge+neo" = _Er3S1lAY;
        "pkg-1.20.4-2.4-fabric+forge+neo" = _R2IqDHiT;
        "pkg-1.20.5-2.4-fabric+neo" = _5TqJNj6S;
        "pkg-1.20.6-2.4-fabric+forge+neo" = _jStBzsZZ;
        "pkg-1.21.0-2.4-fabric+forge+neo" = _M01QJZKI;
        "pkg-1.19.2-2.5-fabric+forge" = _DkiNatjd;
        "pkg-1.20.1-2.5-fabric+forge+neo" = _NE3u6rOG;
        "pkg-1.20.4-2.5-fabric+forge+neo" = _lUKz6UYS;
        "pkg-1.20.6-2.5-fabric+forge+neo" = _eVPsmGbE;
        "pkg-1.21.0-2.5-fabric+forge+neo" = _GcltNQxH;
        "pkg-1.20.1-2.6-fabric+forge+neo" = _4KfntbTX;
        "pkg-1.20.6-2.6-fabric+forge+neo" = _x1wqOxiI;
        "pkg-1.21.0-2.6-fabric+forge+neo" = _JSxJhfLt;
        "pkg-1.21.1-2.6-fabric+forge+neo" = _EJozFh8a;
        "pkg-1.21.2-2.6-fabric+neo" = _pdmYLsTh;
        "pkg-1.21.3-2.6-fabric+forge+neo" = _n5RHzPJz;
        "pkg-1.21.4-2.6-fabric+forge+neo" = _904kQvXX;
        "pkg-1.20.1-2.7-fabric+forge+neo" = _b4hRWt5h;
        "pkg-1.21.1-2.7-fabric+forge+neo" = _zXdQgCC8;
        "pkg-1.21.4-2.7-fabric+forge+neo" = _WcQRVrzT;
        "pkg-1.21.5-2.7-fabric+forge+neo" = _2tb6CZkJ;
        "pkg-1.21.6-2.7-fabric+forge+neo" = _DhEA186z;
        "pkg-1.21.7-2.7-fabric+forge+neo" = _fFlhrqQB;
        "pkg-1.21.8-2.7-fabric+forge+neo" = _xK2d4GiR;
        "pkg-1.21.9-2.7-fabric+forge+neo" = _CuZZmxrC;
        "pkg-1.21.9-2.8-fabric+forge+neo" = _Aldku6So;
        "pkg-1.21.10-2.8-fabric+forge+neo" = _IKBc0uKm;
        "pkg-1.20.1-3.0-fabric+forge+neo" = _sdKJAjIz;
        "pkg-1.21.1-3.0-fabric+forge+neo" = _BUJiP8k0;
        "pkg-1.21.10-3.0-fabric+forge+neo" = _tdETXvOa;
        "pkg-1.20.1-3.1-fabric+forge+neo" = _ftqLK8zy;
        "pkg-1.21.1-3.1-fabric+forge+neo" = _UhdpVgo8;
        "pkg-1.21.10-3.1-fabric+forge+neo" = _U7FWFaHw;
        "pkg-1.21.11-3.1-fabric+forge+neo" = _BAC19mJA;
        "pkg-26.1.0-3.1-fabric+forge+neo" = _qar2ypSN;
        "pkg-26.1.1-3.1-fabric+forge+neo" = _UdaMK8GE;
        "pkg-26.1.2-3.1-fabric+forge+neo" = _HAUG4pjU;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _HYFuUXDA;
        "pkg-1.21.1-3.2-fabric+forge+neo" = _4G5TlQ8j;
        "pkg-1.21.11-3.2-fabric+forge+neo" = _XwGqfjjM;
        "pkg-26.1.2-3.2-fabric+forge+neo" = _8sYMjy6Y;
        "pkg-26.2.0-3.2-fabric+forge+neo" = _bxGOyens;
        "default" = _bxGOyens;
    });
