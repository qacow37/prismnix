...
let
    ...
    in {
        ...
        "pkg-1.9.7" = _mvvJetKK;
        "pkg-1.9.8" = _Ymh6Uy3e;
        "pkg-1.10.0" = _AhrXv1da;
        "pkg-1.10.1" = _3H0nUJhq;
        "pkg-1.10.2" = _UWywaqZa;
        "pkg-1.10.3" = _qm0TSoQL;
        "pkg-1.10.4" = _d7hhI53v;
        "pkg-1.10.5" = _cojBXOK9;
        "pkg-1.10.6" = _w9UCSaHa;
        "pkg-1.10.7" = _jrC1TCfF;
        "pkg-1.11.0" = _7WFi2tUG;
        "pkg-1.11.1" = _mIi7Urva;
        "pkg-1.11.2" = _6ppqw7Dx;
        "pkg-1.11.3" = _IeASn7sM;
        "pkg-1.11.4" = _2OisNxPN;
        "pkg-1.11.5" = _tgYliGAU;
        "pkg-1.11.6" = _q1yj6MMx;
