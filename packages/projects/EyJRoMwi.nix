...
let
    ...
    in {
        ...
        "pkg-1.16.5-Forge" = _b7EPEQ5g;
        "pkg-1.18.2-Forge" = _UtTa9A05;
        "pkg-1.19.2-Forge" = _CwW4UOzN;
        "pkg-1.19.4-Forge" = _Y8v2XZBv;
        "pkg-1.20-Forge" = _7ujNc0v4;
        "pkg-1.20.1-Forge" = _kAIGwkLj;
        "pkg-1.20.2-Forge" = _QCRooko2;
        "pkg-1.21-Forge" = _8KQTvyT8;
        "pkg-1.21.1-Forge" = _1Q1trbNc;
        "pkg-1.16.5-Fabric" = _W2SIhL2R;
        "pkg-1.18.2-Fabric-and-Quilt" = _lYsz3Ixy;
        "pkg-1.19.2-Fabric" = _43ipabM8;
        "pkg-1.19.4-Fabric" = _vL0pbv2C;
        "pkg-1.20-Fabric" = _NeXXQN1z;
        "pkg-1.20.1-Fabric" = _rSG32ZWH;
        "pkg-1.20.2-Fabric" = _Z292c5ZU;
        "pkg-1.21-Fabric" = _mb3qKUJj;
        "pkg-1.21.1-Fabric" = _p8kRzy6m;
        "pkg-1.20.1-NeoForge" = _3WxJloj9;
        "pkg-1.21-NeoForge" = _18jlbINa;
        "pkg-1.21.1-NeoForge" = _8AkNOYOn;
        "pkg-1.16.5-Quilt" = _5Nr0XtQo;
        "pkg-1.19.2-Quilt" = _1Mx6dlLk;
        "pkg-1.19.4-Quilt" = _D5wh965B;
        "pkg-1.20-Quilt" = _X3lxmHRV;
        "pkg-1.20.1-Quilt" = _P62x2M7C;
        "pkg-1.20.2-Quilt" = _vB9nVaog;
        "pkg-1.21-Quilt" = _YRH0wkVa;
        "pkg-1.21.1-Quilt" = _pmJcKo3J;
        "pkg-1.21.3-Forge" = _wW6YTjnc;
        "pkg-1.21.4-Forge" = _FymLMh8t;
        "pkg-1.21.5-Forge" = _HlMPPJKs;
        "pkg-1.21.6-Forge" = _XGxNnf2D;
        "pkg-1.21.9-Forge" = _5QZSgFtY;
        "pkg-1.21.10-Forge" = _LNYKCvTR;
        "pkg-1.21.11-Forge" = _NLGiTPLx;
        "pkg-1.21.3-NeoForge" = _N8HtFJ1W;
        "pkg-1.21.4-NeoForge" = _KN3Dmlq9;
        "pkg-1.21.5-NeoForge" = _MHczRRuy;
        "pkg-1.21.6-NeoForge" = _2E6m6QIO;
        "pkg-1.21.9-NeoForge" = _6tgJ0vrN;
        "pkg-1.21.10-NeoForge" = _3JfCOyfn;
        "pkg-1.21.11-NeoForge" = _KSypEPEc;
        "pkg-1.21.3-Fabric" = _8gQK4kxx;
        "pkg-1.21.4-Fabric" = _mWyG4yGZ;
        "pkg-1.21.5-Fabric" = _JTONCTpu;
        "pkg-1.21.6-Fabric" = _gPtKXkTO;
        "pkg-1.21.9-Fabric" = _WztvQzWK;
        "pkg-1.21.10-Fabric" = _w1PgNa13;
        "pkg-1.21.11-Fabric" = _kVdbP6Sc;
        "pkg-1.21.3-Quilt" = _RiTgfcXU;
        "pkg-1.21.4-Quilt" = _ATz0BxJl;
        "pkg-1.21.5-Quilt" = _gVUxkNfD;
        "pkg-1.21.6-Quilt" = _7pOu98Y8;
        "pkg-1.21.9-Quilt" = _UYG1RQk7;
        "pkg-1.21.10-Quilt" = _rthpBqse;
        "pkg-1.21.11-Quilt" = _spK12qzL;
        "pkg-1.16.5-(Fabric.Quilt)" = _COadZLmp;
        "pkg-1.18.2-(Fabric.Quilt)" = _btCSDvOT;
        "pkg-1.19.2-(Fabric.Quilt)" = _4JlKWAPU;
        "pkg-1.19.4-(Fabric.Quilt)" = _fx87K6HL;
        "pkg-1.20-(Fabric.Quilt)" = _Q2f6vB4c;
        "pkg-1.20.1-(Fabric.Quilt)" = _iOkZvlvl;
        "pkg-1.20.2-(Fabric.Quilt)" = _bylKBOt7;
        "pkg-1.21-(Fabric.Quilt)" = _lQlLtx5p;
        "pkg-1.21.1-(Fabric.Quilt)" = _XETrKCOV;
        "pkg-1.21.3-(Fabric.Quilt)" = _hoCGm3rc;
        "pkg-1.21.11-(Fabric.Quilt)" = _ag7s6XEF;
        "pkg-1.21.10-(Fabric.Quilt)" = _tBTXsfM4;
        "pkg-1.21.9-(Fabric.Quilt)" = _oP6EjIrX;
        "pkg-v1.2" = _AzNgwGtf;
        "pkg-v1.0" = _ZiezdDf9;
        "pkg-v1.3" = _Hn5UaBtu;
        "default" = _Hn5UaBtu;
