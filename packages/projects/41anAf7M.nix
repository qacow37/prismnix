...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18-1.20.1" = _x8Vcllsk;
        "pkg-1.0.1+1.18-1.20.1" = _2PJkP9bI;
        "pkg-1.0.2+1.18-1.20.1" = _h6oblnrU;
        "pkg-1.0.3+1.18-1.20.1" = _hlI2ks2a;
        "pkg-1.1.0+1.18-1.20.1" = _ucu5Gxku;
        "pkg-1.1.1+1.18-1.20.1" = _NoHo0Vp3;
        "pkg-1.1.2+1.18-1.20.2" = _TqlwbFm1;
        "pkg-1.1.3+1.18-1.20.2" = _COaM9CIU;
        "pkg-1.1.4+1.18-1.20.2" = _q0GJRvlm;
        "pkg-1.2.0+1.18-1.20.2" = _ThfZqox4;
        "pkg-1.2.1+1.18-1.20.2" = _YyGY9Sg6;
        "pkg-1.2.2+1.18-1.20.2" = _D60VG49z;
        "pkg-1.3.0+1.18-1.20.4" = _kv44aVQI;
        "pkg-1.3.1+1.18-1.20.4" = _nowC6KK8;
        "pkg-1.3.2+1.18-1.20.4" = _JKNROVN3;
        "pkg-1.3.3+1.18-1.20.4" = _lETsS4w4;
        "pkg-1.3.4+1.18-1.20.4" = _KZfvO1z9;
        "pkg-1.3.5+1.18-1.20.4" = _pFFfpRQP;
        "pkg-1.3.6+1.18-1.20.4" = _bZdoNNYX;
        "pkg-1.3.7+1.18-1.20.4" = _k2FXBT1T;
        "pkg-1.3.8+1.18-1.20.4" = _wRqs6UhO;
        "pkg-1.3.9+1.18-1.20.4" = _KsHtUVUX;
        "pkg-1.4.0+1.18-1.20.6" = _uSyrQF9b;
        "pkg-1.4.1+1.18-1.20.6" = _oZyJ90Ut;
        "pkg-1.4.2+1.18-1.21" = _FKWaUCUJ;
        "pkg-1.4.3+1.18-1.21.1" = _BY2qAPIf;
        "pkg-1.4.4+1.18-1.21.1" = _I3iQmfJA;
        "pkg-1.4.5+1.18-1.21.3" = _2GspPIIc;
        "default" = _2GspPIIc;
    });
