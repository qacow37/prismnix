...
let
    ...
    in {
        ...
        "pkg-fabric-1.18.2-1.0.0" = _w7uBrsjn;
        "pkg-fabric-1.18.2-1.0.1" = _fR1LzmMr;
        "pkg-fabric-1.19-1.0.1" = _SKYNvdzk;
        "pkg-fabric-1.19-1.0.2" = _iOKz3J9o;
        "pkg-fabric-1.19-1.1.0" = _ipbn59N0;
        "pkg-fabric-1.19.1-1.1.0" = _fItln6j3;
        "pkg-fabric-1.19-1.2.0" = _SHGJA6IJ;
        "pkg-fabric-1.19.1-1.2.0" = _eRBML8JG;
        "pkg-fabric-1.19.2-1.2.0" = _sUfJpumH;
        "pkg-fabric-1.19-1.2.1" = _ZxHEqs8f;
        "pkg-fabric-1.19.1-1.2.1" = _dMGLfFIc;
        "pkg-fabric-1.19.2-1.2.1" = _pvakNJbE;
        "pkg-fabric-1.19.2-1.2.2" = _UqaOBhDN;
        "pkg-fabric-1.19.2-1.2.3" = _b2bRrc9I;
        "pkg-fabric-1.19.3-1.2.3" = _7fpEbvsp;
        "pkg-fabric-1.19.3-1.2.4" = _rru0Krvp;
        "pkg-fabric-1.19.4-1.3.0" = _gzrvLCcJ;
        "pkg-fabric-1.20.1-1.3.1" = _74Jw9Pk1;
        "pkg-fabric-1.20.1-1.3.2" = _hP9WbjQS;
        "pkg-fabric-1.19.2-1.3.3" = _YWlDoqeq;
        "pkg-fabric-1.19.4-1.3.3" = _SPMb7JGQ;
        "pkg-fabric-1.20.1-1.3.3" = _Dl3G6ZNl;
        "pkg-fabric-1.20.4-1.3.3" = _t8QCaf5z;
        "pkg-fabric-1.20.4-1.3.4" = _ZoRHVoo4;
        "pkg-fabric-1.20.4-1.3.5" = _jg661emr;
        "pkg-fabric-1.20.4-1.3.6" = _s5bX0H1E;
        "pkg-fabric-1.20.4-1.3.7" = _MldM83sM;
        "pkg-fabric-1.20.4-1.3.8" = _qeI19Doy;
        "pkg-fabric-1.21-1.3.8" = _8iFaZgjd;
        "pkg-fabric-1.21.1-1.3.8" = _VCfI8Eha;
        "pkg-fabric-1.21.1-1.3.9" = _smA4z3TZ;
        "pkg-fabric-1.21.3-1.3.9" = _iZKUZft1;
        "pkg-fabric-1.21.4-1.3.9" = _aUSZQzIr;
        "pkg-fabric-1.21.4-1.3.10" = _TdlkuEi0;
        "pkg-fabric-1.21.5-1.3.10" = _VjuFWBPd;
        "pkg-fabric-1.21.7-1.3.10" = _jdLt2qkS;
        "pkg-fabric-1.21.8-1.3.10" = _1s8PRfyl;
        "pkg-fabric-1.21.8-1.3.11" = _bC2RKBAT;
        "pkg-fabric-1.21.10-1.3.12" = _2Ut2vgRb;
        "pkg-fabric-1.21.11-1.3.12" = _evo2bKJH;
        "pkg-fabric-1.3.12+26.1.2" = _E8atFbfI;
        "pkg-fabric-1.3.13+26.2" = _gb5svwmN;
        "default" = _gb5svwmN;
    });
