...
let
    ...
    in {
        ...
        "pkg-1.0" = _DXffJ6sx;
        "pkg-1.0+mod" = _WiNKymMD;
        "pkg-1.0.1" = _qqKrFwWP;
        "pkg-1.0.1+mod" = _eCDNduc7;
        "pkg-1.0.2" = _T12ZeOxU;
        "pkg-1.0.2+mod" = _XH1j59gG;
        "pkg-1.0.3" = _t6eLuuuJ;
        "pkg-1.0.3+mod" = _weh3Or0j;
        "pkg-1.0.4" = _tZdz3kJu;
        "pkg-1.0.4+mod" = _WJ1TVyw7;
        "pkg-1.0.5" = _W7h7gYKP;
        "pkg-1.0.5+mod" = _NCKDAnlm;
        "pkg-1.0.6" = _tYoG8wfW;
        "pkg-1.0.6+mod" = _3wWPMdQz;
        "pkg-1.0.6.1" = _O413FXYp;
        "pkg-1.0.6.1+mod" = _kXNxUNgM;
        "pkg-1.0.7" = _LM9fZeyJ;
        "pkg-1.0.7+mod" = _Z5hdu7Or;
        "pkg-1.0.7.1" = _JWjHOyLH;
        "pkg-1.0.7.1+mod" = _ceI9tb5e;
        "pkg-1.0.8" = _VMJcVaze;
        "pkg-1.0.8+mod" = _e1K30lmr;
        "pkg-1.0.8.1" = _KCmb0VbW;
        "pkg-1.0.8.1+mod" = _T06z27Iw;
        "pkg-1.0.7.2" = _YRteFV0d;
        "pkg-1.0.7.2+mod" = _niyTtzZO;
        "pkg-1.0.9" = _w2bu18uv;
        "pkg-1.0.9+mod" = _2dthSVIz;
        "default" = _2dthSVIz;
    });
