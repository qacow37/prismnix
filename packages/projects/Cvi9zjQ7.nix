...
let
    ...
    in {
        ...
        "pkg-0.1.0+mc1.18.2" = _oQMslkxV;
        "pkg-0.1.1+mc1.19.2" = _XrUJH1XM;
        "pkg-0.1.1+mc1.20-rc1" = _Bb7RyzVd;
        "pkg-0.1.2+mc1.18.2" = _PZRWw5uz;
        "pkg-0.1.2+mc1.19.2" = _IasGacOH;
        "pkg-0.1.2+mc1.20.1" = _4VdaWtPO;
        "pkg-0.2.0+mc1.18.2" = _FO34yEo5;
        "pkg-0.2.0+mc1.19.2" = _S8bH5goi;
        "pkg-0.2.0+mc1.20.1" = _YksLGdjW;
        "pkg-0.2.1+mc1.18.2" = _vtpODtyL;
        "pkg-0.2.1+mc1.19.2" = _MMQ3RBIc;
        "pkg-0.2.1+mc1.20.1" = _LlDlVSdi;
        "pkg-0.2.2+mc1.18.2" = _1a2iuxEL;
        "pkg-0.2.2+mc1.19.2" = _lpgcExyz;
        "pkg-0.2.2+mc1.20.1" = _ipLdJEVh;
        "pkg-0.2.2+mc1.20.3-pre1" = _jyHu2A8O;
        "pkg-0.2.3+mc1.18.2" = _SOsMt8PH;
        "pkg-0.2.3+mc1.19.2" = _n6EgMrUJ;
        "pkg-0.2.3+mc1.20.1" = _zyo5EsaM;
        "pkg-0.2.3+mc1.20.3" = _it23MUAC;
        "pkg-0.2.4+mc1.18.2" = _OR0H04ea;
        "pkg-0.2.4+mc1.19.2" = _tnIuEOrV;
        "pkg-0.2.4+mc1.20.1" = _vrkXTMz1;
        "pkg-0.2.4+mc1.20.3" = _dfvsfug4;
        "pkg-0.2.4+mc1.21" = _hq7j6nOu;
        "pkg-0.2.5+mc1.21" = _fNCVeIzp;
        "pkg-0.2.5+mc1.21.5" = _R45GFnis;
        "pkg-0.3.0+mc1.21.9" = _ovrbo9G1;
        "pkg-0.3.0+mc1.21.11" = _JIJCLNAM;
        "pkg-0.3.0+mc26.1.1" = _9vSGPiTg;
        "pkg-0.3.0+mc26.2" = _bp76d9Tg;
        "default" = _bp76d9Tg;
    });
