...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _fLeB2pd3;
        "pkg-1.0.1" = _3zWZ142z;
        "pkg-1.1.0beta1" = _WbWGRc49;
        "pkg-1.1.0beta2" = _2TPkCIdF;
        "pkg-1.1.0beta3" = _2kAR4ytr;
        "pkg-1.1.0" = _3PxB5Eii;
        "pkg-1.1.1" = _BxJcN3ra;
        "pkg-1.1.2" = _WIXs8pUt;
        "pkg-1.1.3" = _Or3NiRhS;
        "pkg-1.1.4" = _x31GwgEa;
        "pkg-1.8.9-1.1.4beta3" = _zssU3qjr;
        "pkg-1.8.9-1.1.4beta4" = _vf0DvxjN;
        "pkg-1.8.9-1.1.4beta5" = _NjIU4pdP;
        "pkg-1.8.9-1.1.4beta6" = _ZutUjHTL;
        "pkg-1.8.9-1.1.4beta7" = _FMHnlgj6;
        "pkg-1.8.9-1.1.4beta11" = _FvkJQkV1;
        "pkg-1.8.9-1.1.4beta12" = _8XGA3Usa;
        "pkg-1.8.9-1.1.4beta17" = _ft5CU4yo;
        "pkg-1.9.0-1.1.4beta18" = _zP0hqjgA;
        "pkg-1.8.9-1.1.4beta19" = _sRXSMzq1;
        "pkg-1.9.0-1.1.4beta19" = _Ji6yfxHE;
        "pkg-1.9.0-1.1.4beta20" = _u17w7345;
        "pkg-1.9.0-1.1.4beta21" = _PWNaBRXu;
        "pkg-1.8.9-1.1.4beta22" = _nk8bTKZP;
        "pkg-1.9.0-1.1.4beta22" = _3EYKoCQX;
        "pkg-1.9.0-1.1.4beta23" = _kmKtrRqp;
        "pkg-1.8.9-1.1.4beta23" = _O3nIbH9C;
        "pkg-1.9.0-1.1.4beta24" = _qnwwa0mj;
        "pkg-1.9.0-1.1.4beta25" = _HmEYriDy;
        "pkg-1.9.0-1.1.4beta26" = _5L9jim6T;
        "pkg-1.9.0-1.1.4beta27" = _V3HC9JQG;
        "pkg-1.9.0-1.1.4beta28" = _IFTys6gV;
        "pkg-1.9.0-1.1.4beta29" = _KV9h6GM6;
        "pkg-1.9.0-1.1.4beta30" = _LtmaFJ0C;
        "pkg-1.9.0-1.1.4beta32" = _2e61taEM;
        "pkg-1.9.4-1.1.4beta32" = _hIFW5QUb;
        "pkg-1.9.4-1.2.0beta33" = _EKUtYhZA;
        "pkg-1.9.4-1.2.0beta34" = _IbVGrXVi;
        "pkg-1.9.4-1.2.0beta35" = _k86d8QXh;
        "pkg-1.10-1.2.0beta36" = _GlnIzQFR;
        "pkg-1.10-1.2.1beta37" = _Ezz7y6EX;
        "pkg-1.10-1.2.1beta38" = _VXqcG7I8;
        "pkg-1.10-1.2.2" = _TSs8Edh7;
        "pkg-1.10-1.2.3" = _FMsqj2Vz;
        "pkg-1.10-1.2.4" = _vQwJVXM1;
        "pkg-1.10-1.2.5" = _3noO9Exo;
        "pkg-1.10-1.2.6" = _rW46MjtR;
        "pkg-1.10-1.2.7" = _yaBLWGl0;
        "pkg-1.10-1.2.8" = _qqMAdgkZ;
        "pkg-1.10-1.2.9" = _IJB0FKA7;
        "pkg-1.10-1.3.0" = _QUUYYBp5;
        "pkg-1.10-1.3.1" = _EEAoceVo;
        "pkg-1.11-1.3.1alpha1" = _3vCuPoj3;
        "pkg-1.11-1.3.1alpha2" = _Fr5N8ecV;
        "pkg-1.11-1.3.1beta1" = _mePNysBX;
        "pkg-1.1x-1.4.0" = _7PV3mHl4;
        "pkg-1.1x-1.4.1" = _EpFox5ob;
        "pkg-1.1x-1.4.2" = _2EXH9CPl;
        "pkg-1.1x-1.4.3" = _JszFHAka;
        "pkg-1.1x-1.4.4" = _xreMpNG7;
        "pkg-1.1x-1.4.5" = _1pAW7ZkG;
        "pkg-1.1x-1.4.6" = _kF30TwCZ;
        "pkg-1.1x-1.4.7" = _SiF0s5su;
        "pkg-1.1x-1.4.8" = _8w827QmT;
        "pkg-1.12-1.4.8beta1" = _7iELrREA;
        "pkg-1.12-1.4.8" = _VxW0BUXa;
        "pkg-1.12-1.4.9" = _km3STCe4;
        "pkg-1.12-1.5.0" = _Bda4HBmn;
        "pkg-1.1x-1.4.9" = _kWfZbiV1;
        "pkg-1.12-1.6.0" = _HaNyiURh;
        "pkg-1.12-1.7.0-alpha" = _T5ekM5RG;
        "pkg-1.12-1.7.0" = _kwmoeP40;
        "pkg-1.12-1.7.1" = _QtFMrRjV;
        "pkg-1.12-1.7.2" = _lFArnn12;
        "pkg-1.12-1.7.3" = _ZvkqHLI6;
        "pkg-1.12-1.7.4" = _E9B5bYwB;
        "pkg-1.12-1.7.5" = _hYEWQiwG;
        "pkg-1.12-1.7.6" = _sCbxE6xJ;
        "pkg-1.12-1.8.0" = _b84mmeRF;
        "pkg-1.16-2.0.0-beta" = _d3HdliSg;
        "pkg-1.16-3.0.0-beta" = _kK2OwuSI;
        "pkg-1.16-3.0.1-beta" = _DTdtDPmX;
        "pkg-1.16-2.0.1-beta" = _GNXgUCNY;
        "pkg-1.16-2.0.2-beta" = _cAogsmFf;
        "pkg-3.0.2-beta" = _EA2b7Smu;
        "pkg-3.0.3-beta" = _zmxsXfIb;
        "pkg-1.16-2.0.3-beta" = _1b1zgkIS;
        "pkg-1.16-2.0.4-beta" = _2UxxAq7l;
        "pkg-3.0.4-beta" = _yBEjZRgT;
        "pkg-1.16-2.0.5-beta" = _F1nEb7wk;
        "pkg-1.16-2.0.6" = _mniai3kG;
        "pkg-3.0.5" = _W5rmTNXD;
        "pkg-3.0.6" = _o1QryKQB;
        "pkg-1.16-2.0.7" = _I2EeAfjG;
        "pkg-1.16-2.0.8" = _rYJ6I1gi;
        "pkg-3.0.7" = _4sDLpF79;
        "pkg-3.0.8" = _2LC6dODH;
        "pkg-1.16-2.0.9" = _lmfZv0c5;
        "pkg-1.16-2.0.10" = _wgWeOfnr;
        "pkg-3.0.9" = _ToMECrgg;
        "pkg-3.0.10" = _5k88WdVF;
        "pkg-1.16-2.0.11" = _xAge37Q0;
        "pkg-1.19-4.0.0" = _4Aaq3uWE;
        "pkg-3.0.11" = _o6zj6SBH;
        "pkg-1.19-4.0.1" = _KNRzzTfn;
        "pkg-3.0.12" = _ns8G8WJJ;
        "pkg-1.19-4.0.2" = _l5MjkPPA;
        "pkg-3.0.13" = _if4fkwWr;
        "pkg-1.19-4.0.3" = _I6hva3Dq;
        "pkg-3.0.14" = _THRpNsZS;
        "pkg-3.0.15" = _BOpD1e94;
        "pkg-1.19-4.0.4" = _pAWTepNn;
        "pkg-3.0.16" = _EZrNGMi1;
        "pkg-1.19-4.0.5" = _yA2xh9wY;
        "pkg-1.19-4.0.6" = _gA92ZUnc;
        "pkg-1.18-3.0.17" = _adOfC7L1;
        "pkg-1.19-4.0.7" = _nE5GV0PG;
        "pkg-1.19-4.0.8" = _XGTrG5CH;
        "pkg-1.19-4.1.0" = _FTTf1rqX;
        "pkg-1.19-4.1.1" = _q9OjAmhp;
        "pkg-1.18-3.0.18" = _AEstM0Wc;
        "pkg-1.18-3.0.19" = _RSjGwt5C;
        "pkg-1.19-4.1.2" = _Uwb3OWBL;
        "pkg-1.19-4.1.3" = _sFo0trOx;
        "pkg-1.20-5.0.0" = _lYYSZg0g;
        "pkg-1.20-5.0.1" = _bDFvsrfh;
        "pkg-1.20-5.0.2" = _GOtRxbdX;
        "pkg-1.20-5.0.3" = _ZZ0vWy4o;
        "pkg-1.20-5.0.4" = _mehJc3PH;
        "pkg-1.20-5.0.5" = _FWBmDxW3;
        "pkg-1.21-6.0.0" = _ocwVHOch;
        "pkg-1.21-6.0.1" = _T2ESZOZB;
        "pkg-1.20-5.0.6" = _ewGRGkV6;
        "pkg-1.21-6.0.2" = _Ovv8ukvh;
        "default" = _Ovv8ukvh;
    });
