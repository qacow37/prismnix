...
let
    ...
    in {
        ...
        "pkg-0.11.5" = _2To9MgWP;
        "pkg-0.12.0" = _lZOxUjMU;
        "pkg-0.12.1" = _ormNwXFP;
        "pkg-0.12.2" = _fo1TzL4i;
        "pkg-0.12.3" = _K6cH3YIR;
        "pkg-0.13.0" = _SEwGug4i;
        "pkg-0.13.1" = _8umk9kWD;
        "pkg-0.13.2" = _uBFGl7ew;
        "pkg-0.13.3" = _aXjoovEl;
        "pkg-0.13.4" = _JTNvSpsT;
        "pkg-0.13.5" = _RXv4xAYj;
        "pkg-0.14.0" = _PbpbjLce;
        "pkg-0.14.1" = _rw5UL6ml;
        "pkg-0.14.2" = _RAEKMxXI;
        "pkg-0.14.3" = _PkGlAgPb;
        "pkg-0.15.0" = _oh0HMJvC;
        "pkg-0.15.1" = _M3ZHXjb0;
        "pkg-0.15.2" = _uVBvqyK6;
        "pkg-0.15.3" = _sjO5iEaT;
        "pkg-0.15.4" = _2DdLDaSq;
        "pkg-0.16.0" = _szTawXpR;
        "pkg-0.16.1" = _rAYMo0tv;
        "pkg-0.16.2" = _ee6vARQI;
        "pkg-0.16.3" = _nZb3MyON;
        "pkg-0.16.4" = _jWRfTfCT;
        "pkg-0.16.5" = _cmAcAmiJ;
        "pkg-0.17.0" = _OqI3TgA4;
        "pkg-0.17.1" = _VaWYNQlp;
        "pkg-0.17.2" = _RGk2cuvx;
        "pkg-0.17.3" = _9QdZiif6;
        "pkg-0.17.4" = _oAhXk1nM;
        "pkg-0.18.0" = _AgMGvx2G;
        "pkg-0.18.1" = _ilVUXbu1;
        "pkg-0.18.2" = _dCSatSNh;
        "pkg-0.18.3" = _c1iGPfpc;
        "pkg-0.19.0" = _HKipqXmK;
        "pkg-0.19.1" = _40mUlMtn;
        "pkg-0.19.2" = _W4V4eBmH;
        "pkg-0.19.3" = _91bn3xd1;
        "pkg-0.19.4" = _6WEAuW4S;
        "pkg-0.19.5" = _Jk3l4vnQ;
        "pkg-0.19.6" = _Qo7WqUbh;
        "pkg-0.20.0" = _Th5X4iYv;
        "pkg-0.20.1" = _ECKsXUcZ;
        "pkg-0.20.2" = _KsN1qiMT;
        "pkg-0.20.3" = _7KBuKHW9;
        "pkg-0.20.4" = _HDKNH1GP;
        "pkg-0.20.5" = _R4Q7kiz7;
        "pkg-0.20.6" = _sX2Xvaqt;
        "pkg-0.20.7" = _fBUtozdz;
        "pkg-0.21.0" = _ff7OfQdz;
        "pkg-0.22.0" = _eFC5EZaj;
        "pkg-0.23.0" = _XosqUy97;
        "pkg-0.23.1" = _KkmdkXsD;
        "pkg-0.24.0" = _reFUiAdB;
        "default" = _reFUiAdB;
    });
