...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _MjxXNJ9f;
        "pkg-v1.0.1-fabric" = _GR6LUBEF;
        "pkg-v1.0.1-neoforge" = _GEOF0BFC;
        "pkg-v1.0.2-fabric" = _qxR7llC2;
        "pkg-v1.0.2-neoforge" = _ese5pMWL;
        "pkg-v2.0.0-fabric" = _Bt2LRRCS;
        "pkg-v2.0.0-neoforge" = _KO8pvIaH;
        "pkg-v2.1.0-fabric" = _zAIeDf6E;
        "pkg-v2.1.0-neoforge" = _hc4BkTuo;
        "pkg-v1.1.0-fabric" = _RbU2X23Q;
        "pkg-v1.1.0-neoforge" = _y0oYVCYy;
        "pkg-v1.1.1-fabric" = _tAKtAA46;
        "pkg-v1.1.1-neoforge" = _njJiOxwl;
        "pkg-v2.1.1-fabric" = _9hrvCIrz;
        "pkg-v2.1.1-neoforge" = _ETrbFYUj;
        "pkg-v1.1.2-fabric" = _zn9EwWU8;
        "pkg-v1.1.2-neoforge" = _vwrm40mj;
        "pkg-v2.1.2-fabric" = _hD0ICyDq;
        "pkg-v2.1.2-neoforge" = _SmhpHW5F;
        "pkg-v1.1.3-fabric" = _y50zVmFY;
        "pkg-v1.1.3-neoforge" = _lwdS2CkI;
        "pkg-v2.1.3-fabric" = _rgpQQIiQ;
        "pkg-v2.1.3-neoforge" = _llMgKw4O;
        "pkg-v3.0.0-fabric" = _Al1BW3jB;
        "pkg-v3.0.0-neoforge" = _rXDKRZkw;
        "pkg-v4.0.0-fabric" = _1z6OVlye;
        "pkg-v4.0.0-neoforge" = _5u1wGnIO;
        "pkg-1.21.11-5.0.0-fabric" = _pa7vuqzc;
        "pkg-1.21.11-5.0.0-neoforge" = _81g3DbW3;
        "pkg-26.1-5.0.0-fabric" = _NElmwoGv;
        "pkg-26.1-5.0.0-neoforge" = _9ur0ZFhZ;
        "pkg-26.1.1-5.0.0-fabric" = _Ea6GFHsh;
        "pkg-26.1.1-5.0.0-neoforge" = _pGv4rTHy;
        "pkg-26.1.2-5.0.0-fabric" = _1r9GDUS3;
        "pkg-26.1.2-5.0.0-neoforge" = _BCSJaK2b;
        "pkg-1.21.11-5.1.0-fabric" = _29uZVYRg;
        "pkg-1.21.11-5.1.0-neoforge" = _lzNUhoLh;
        "pkg-26.1-5.1.0-fabric" = _5E3486iX;
        "pkg-26.1-5.1.0-neoforge" = _jhTpfuPC;
        "pkg-26.1.1-5.1.0-fabric" = _hxmX81B3;
        "pkg-26.1.1-5.1.0-neoforge" = _VQJEmou9;
        "pkg-26.1.2-5.1.0-fabric" = _hxCqVcvK;
        "pkg-26.1.2-5.1.0-neoforge" = _ISsKI7rn;
        "pkg-26.2-5.1.0-fabric" = _slEzsgjk;
        "pkg-26.2-5.1.0-neoforge" = _geS6FCIh;
        "default" = _geS6FCIh;
    });
