...
let
    ...
    in {
        ...
        "pkg-1.7.10-1.0" = _hi4KOJ24;
        "pkg-1.15-1.0" = _AOpyZJpr;
        "pkg-1.16-1.0" = _uMdERiff;
        "pkg-1.17-1.0" = _2UzOTPnj;
        "pkg-1.18-1.0" = _4MxEqgPC;
        "pkg-1.7.10-1.1" = _7VGxs4A8;
        "pkg-1.7.19-1.2" = _em9JWQpk;
        "pkg-1.15-1.2" = _U9DXARSM;
        "pkg-1.16-1.2" = _OM58aDlA;
        "pkg-1.17-1.2" = _WHi29N4P;
        "pkg-1.18-1.2" = _JH7T5pNE;
        "pkg-1.15-1.2.1" = _XeVoGdgt;
        "pkg-1.16-1.2.1" = _cRYY7kfP;
        "pkg-1.17-1.2.1" = _8mEcrxE3;
        "pkg-1.18-1.2.1" = _BFVjPCoK;
        "pkg-1.19-1.2" = _oGQ8uDya;
        "pkg-1.7.10-1.3" = _lqeuprJw;
        "pkg-1.15-1.3" = _BKIaQP8b;
        "pkg-1.16-1.3" = _UqHY6N6Z;
        "pkg-1.17-1.3" = _6RqonQS4;
        "pkg-1.18-1.3" = _chN36PMb;
        "pkg-1.19-1.3" = _fTAcVFcc;
        "pkg-1.4.0" = _ZYAF67zJ;
        "pkg-1.6.0" = _lvHSUWIO;
        "pkg-1.6.1" = _2jEUZ0tE;
        "pkg-1.6.2" = _skRBCUJW;
        "pkg-1.6.3-pre" = _1MdhwG7c;
        "pkg-1.6.4" = _eyBzd3Fn;
        "pkg-1.6.5" = _nZ5zW30D;
        "pkg-1.7.0" = _c3NMq5TG;
        "pkg-1.7.3" = _spppQJHC;
