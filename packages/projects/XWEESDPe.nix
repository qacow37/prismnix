...
let
    ...
    in {
        ...
        "pkg-1.16.5-13" = _v47bEBD5;
        "pkg-1.17-11" = _j6gp2ybp;
        "pkg-1.18-12" = _VooW9Iii;
        "pkg-1.19-2" = _rYSzefu6;
        "pkg-1.19-3" = _NywqUMOs;
        "pkg-1.19-4" = _YOOUmEcz;
        "pkg-1.19-5" = _C5JLeuBn;
        "pkg-1.20-1" = _spXxXXgx;
        "pkg-1.20-2" = _YDIlXqik;
        "pkg-1.20-3" = _DruzbANL;
        "pkg-1.20-4" = _mNel7cGC;
        "pkg-1.20-5" = _uk5NvQkB;
        "pkg-1.20-6" = _8TmpIyVa;
        "pkg-1.20-7" = _wrFytf78;
        "pkg-1.20-8" = _XCpFkTtu;
        "pkg-1.20-9" = _H2OQtWvK;
        "pkg-1.20-10" = _bHCuUmmy;
        "pkg-1.20-11" = _4GI51Jl3;
        "pkg-1.20-12" = _OwUE3dtB;
        "pkg-1.20-13" = _3LgfTY0q;
        "pkg-1.21.1-r1" = _CuSJ3WCn;
        "pkg-1.21.1-r2" = _fXaPHAoU;
        "pkg-1.21.1-r3" = _JLZ0Ymo7;
        "default" = _JLZ0Ymo7;
    });
