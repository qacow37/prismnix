...
let
    ...
    in {
        ...
        "pkg-0.1.0-1.20.1-beta" = _GwPWfydX;
        "pkg-0.1.1-1.20.1-beta-Forge" = _5dOPajna;
        "pkg-0.1.1-1.20.1-beta-Fabric" = _bHG3b24h;
        "pkg-0.1.2-1.20.1-beta-Forge" = _j2Pfybz6;
        "pkg-0.1.2-1.20.1-beta-Fabric" = _mjvcm7Cu;
        "pkg-0.1.3-1.20.1-beta-Forge" = _rtJ244Vv;
        "pkg-0.1.3-1.20.1-beta-Fabric" = _OXgFUiUZ;
        "pkg-0.1.4-1.20.1-beta-Forge" = _oP2rynNB;
        "pkg-0.1.4-1.20.1-beta-Fabric" = _Qjq7EGwU;
        "pkg-0.1.4.1-1.20.1-beta-Forge" = _fpQg2FAj;
        "pkg-0.1.4.1-1.20.1-beta-Fabric" = _IfcvJLP8;
        "pkg-0.1.5-1.20.1-beta-Forge" = _XkjL6v6T;
        "pkg-0.1.5-1.20.1-beta-Fabric" = _U5MRIEHq;
        "pkg-0.1.5-1.21.1-beta-NeoForge" = _2E524qPf;
        "pkg-0.1.5.1-1.21.1-beta-NeoForge" = _LoKckHcs;
        "pkg-0.1.6-1.20.1-beta-Fabric" = _x0a21aDV;
        "pkg-0.1.6-1.20.1-beta-Forge" = _Tb4jmXKn;
        "pkg-0.1.6-1.21.1-beta-NeoForge" = _hexHE1SW;
        "pkg-0.1.7-1.20.1-beta-Fabric" = _V5sUSWK7;
        "pkg-0.1.7-1.20.1-beta-Forge" = _zc1c4Fcb;
        "pkg-0.1.7-1.21.1-beta-NeoForge" = _9DbTqcRc;
        "pkg-0.1.8-1.20.1-beta-Fabric" = _ERahhDB1;
        "pkg-0.1.8-1.20.1-beta-Forge" = _7IvbtcQB;
        "pkg-0.1.8-1.21.1-beta-NeoForge" = _6k2mvFS4;
        "pkg-1.0.0-1.20.1-Fabric" = _N4EgCAiv;
        "pkg-1.0.0-1.20.1-Forge" = _Gz5e7zLQ;
        "pkg-1.0.0-1.21.1-NeoForge" = _PpGtmRD3;
        "pkg-1.0.1-1.20.1-Fabric" = _rz7pMt7U;
        "pkg-1.0.1-1.20.1-Forge" = _BtWYkq76;
        "pkg-1.0.1-1.21.1-NeoForge" = _uaVNRcOq;
        "pkg-1.0.2-1.20.1-Fabric" = _3U0JBxhE;
        "pkg-1.0.2-1.20.1-Forge" = _kUHxftpx;
        "pkg-1.0.2-1.21.1-NeoForge" = _9DYYGjtx;
        "pkg-1.0.3-1.20.1-Fabric" = _aOB1L9vK;
        "pkg-1.0.3-1.20.1-Forge" = _haCuXgme;
        "pkg-1.0.3-1.21.1-NeoForge" = _D55CQRgJ;
        "default" = _D55CQRgJ;
    });
