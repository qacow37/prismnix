...
let
    ...
    in {
        ...
        "pkg-1.2" = _iM079UAl;
        "pkg-1.3" = _IDNRwZF3;
        "pkg-1.3+mod" = _doL0QbtX;
        "pkg-2" = _a70MIymv;
        "pkg-2+mod" = _uSftFniz;
        "pkg-2.1" = _FaXnOYAB;
        "pkg-2.1+mod" = _Auk82Bho;
        "pkg-2.2" = _5Xf9wJ4V;
        "pkg-2.2+mod" = _rPCWSeq9;
        "pkg-2.3" = _ugzxBvD2;
        "pkg-2.3+mod" = _OVRyv5Xz;
        "pkg-2.4" = _3u05rDKQ;
        "pkg-2.4+mod" = _r0KwxrdP;
        "pkg-2.5" = _6v3o8yCO;
        "pkg-2.5+mod" = _zXD28VpV;
        "pkg-2.5.1" = _HTVdIq0i;
        "pkg-2.5.1+mod" = _2myCw41U;
        "pkg-2.6" = _tzBuyO37;
        "pkg-2.6+mod" = _E2G6bPAX;
        "pkg-2.7" = _aFwS0YV8;
        "pkg-2.7+mod" = _YnausfIh;
        "default" = _YnausfIh;
    });
