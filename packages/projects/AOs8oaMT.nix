...
let
    ...
    in {
        ...
        "pkg-0.0.7" = _b4bE7bgF;
        "pkg-0.0.8" = _9eXLggZ1;
        "pkg-0.0.10" = _993MlA7s;
        "pkg-0.0.11" = _rvTaQLih;
        "pkg-0.0.12" = _4Bj7RPEn;
        "pkg-0.0.13" = _9tbUGvpq;
        "pkg-0.0.14" = _1ScMCx3Z;
        "pkg-0.0.15" = _Mc1DM3ow;
        "pkg-0.0.16" = _dcIandYE;
        "pkg-0.0.17" = _wrSbg5fr;
        "pkg-0.0.18" = _Q944UfH1;
        "pkg-0.0.19" = _pjqwiFzi;
        "pkg-0.0.20" = _T4E27D92;
        "pkg-0.0.21" = _p4Rf6bSR;
        "pkg-0.0.22" = _GYr29K0s;
        "pkg-0.0.23" = _dngXbPZu;
        "pkg-0.0.24" = _WYKMYwxD;
        "pkg-0.0.25" = _Irc9inNO;
        "pkg-0.0.25HF" = _QxYUB0YW;
        "pkg-0.0.26" = _5k2sxyAT;
        "pkg-0.0.27" = _qYo9dHAZ;
        "pkg-0.0.28" = _7LCStg1P;
        "pkg-0.0.29" = _PrNFpOW0;
        "pkg-0.0.30" = _KxVOm1eI;
        "pkg-0.0.30b" = _oy9nx7TZ;
        "pkg-0.0.31" = _BHpD3nG6;
        "pkg-0.0.32" = _QnWFoxG8;
        "pkg-0.0.33" = _ePtJYrB5;
        "pkg-0.1.0" = _8BL3hz2c;
        "pkg-0.1.1" = _Wr1bsIwU;
        "pkg-0.2.0" = _vjNY6Jt1;
        "pkg-0.3.0" = _2yZgvTse;
