...
let
    ...
    in {
        ...
        "pkg-1.20.3-1.0-fabric+forge+neo" = _nyFCKZk1;
        "pkg-1.20.4-1.0-fabric+forge+neo" = _TiSOwprI;
        "pkg-1.19.2-1.1-fabric+forge+neo" = _tyYzgXpb;
        "pkg-1.20.1-1.1-fabric+forge+neo" = _Iq4u4zQi;
        "pkg-1.20.2-1.1-fabric+forge+neo" = _rjeiaOPw;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _QuByhW4l;
        "pkg-1.19.2-2.0-fabric+forge+neo" = _H9jnkE57;
        "pkg-1.20.1-2.0-fabric+forge+neo" = _xU2YG0p0;
        "pkg-1.20.2-2.0-fabric+forge+neo" = _heQOra6w;
        "pkg-1.20.4-2.0-fabric+forge+neo" = _WXUD95AW;
        "pkg-1.19.2-2.1-fabric+forge+neo" = _rIrxaAtp;
        "pkg-1.20.1-2.1-fabric+forge+neo" = _g40cBEAl;
        "pkg-1.20.2-2.1-fabric+forge+neo" = _KuyKMVIh;
        "pkg-1.20.4-2.1-fabric+forge+neo" = _dlJRZlvc;
        "pkg-1.20.5-2.1-fabric+neo" = _440zkWEi;
        "pkg-1.20.6-2.1-fabric+forge+neo" = _BBNNgm2i;
        "pkg-1.21.0-2.1-fabric+forge+neo" = _DDbboeK0;
        "pkg-1.20.1-2.2-fabric+forge+neo" = _xod55CnK;
        "pkg-1.20.6-2.2-fabric+forge+neo" = _HmgI0DsR;
        "pkg-1.21.0-2.2-fabric+forge+neo" = _yiV8cMlu;
        "pkg-1.21.1-2.2-fabric+forge+neo" = _iLuLZKGw;
        "pkg-1.21.2-2.2-fabric+neo" = _po84IHyH;
        "pkg-1.21.3-2.2-fabric+forge+neo" = _pArgghTZ;
        "pkg-1.21.4-2.2-fabric+forge+neo" = _q43yC7gy;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _dXErsPvw;
        "pkg-1.21.1-2.3-fabric+forge+neo" = _mMsyFk1S;
        "pkg-1.21.4-2.3-fabric+forge+neo" = _z7yvBmVY;
        "pkg-1.21.5-2.3-fabric+forge+neo" = _JyVvX7nz;
        "pkg-1.21.6-2.3-fabric+forge+neo" = _aWwd1b43;
        "pkg-1.21.7-2.3-fabric+forge+neo" = _jxwl9Fpw;
        "pkg-1.21.8-2.3-fabric+forge+neo" = _EhX2kiOy;
        "pkg-1.21.9-2.3-fabric+forge+neo" = _rrG6PxMd;
        "pkg-1.21.10-2.3-fabric+forge+neo" = _Ug9TMDwv;
        "pkg-1.21.11-2.3-fabric+forge+neo" = _F7Ic5ll1;
        "pkg-26.1.0-2.3-fabric+forge+neo" = _2Dp9XVVk;
        "pkg-26.1.1-2.3-fabric+forge+neo" = _ApaJLNMR;
