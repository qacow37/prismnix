...
let
    ...
    in {
        ...
        "pkg-1.0.3+1.17.1" = _K5g8hqs0;
        "pkg-1.0.3+1.16.5" = _vpbP0o6Q;
        "pkg-1.0.4+1.16.5" = _lPZMIs00;
        "pkg-1.0.4+1.17.1" = _K88d9gQg;
        "pkg-2.0.0+1.16.5" = _lJK30F23;
        "pkg-2.0.0+1.17.1" = _HqZ41jDB;
        "pkg-2.0.1+1.16.5" = _FRZdOBnk;
        "pkg-2.0.1+1.17.1" = _nRP1iXyg;
        "pkg-2.0.2+1.16.5" = _6qMpUFSY;
        "pkg-2.0.2+1.17.1" = _7yLRZZ09;
        "pkg-2.0.3+1.16.5" = _Zj6VGHpc;
        "pkg-2.0.3+1.17.1" = _xtL9u6pa;
        "pkg-2.0.4+1.16.5" = _OSF7P6jR;
        "pkg-2.0.4+1.17.1" = _XovdRXGN;
        "pkg-2.0.4+1.18" = _pxmTPnFk;
        "pkg-2.1.0+1.16.5" = _U2aBlPe0;
        "pkg-2.1.0+1.17.1" = _h0ugW800;
        "pkg-2.1.0+1.18.2" = _kEzWKMgt;
        "pkg-3.0.0+1.15.2+fabric" = _SZdGSlnx;
        "pkg-3.0.0+1.15.2" = _KnSNXCj4;
        "pkg-3.0.0+1.16.5+fabric" = _RCES4Wmm;
        "pkg-3.0.0+1.16.5" = _M6v17YeF;
        "pkg-3.0.0+1.17.1+fabric" = _sp1z2aa3;
        "pkg-3.0.0+1.17.1" = _UynXXzfU;
        "pkg-3.0.0+1.18.2+fabric" = _kG8pc3w9;
        "pkg-3.0.0+1.18.2" = _JlSKmwO7;
        "pkg-4.0.0+1.15.2+fabric" = _yUZM80lj;
        "pkg-4.0.0+1.15.2" = _R0AFv1gV;
        "pkg-4.0.0+1.16.5+fabric" = _1MyEYFc8;
        "pkg-4.0.0+1.16.5" = _YdXDF2ty;
        "pkg-4.0.0+1.17.1+fabric" = _A7dV5rDa;
        "pkg-4.0.0+1.17.1" = _NXYP9C1f;
        "pkg-4.0.0+1.18.2+fabric" = _DATbtvQV;
        "pkg-4.0.0+1.18.2" = _238I9tWb;
        "pkg-4.0.0+1.19+fabric" = _VU87tq9o;
        "pkg-4.0.0+1.19" = _81ieEbaA;
        "pkg-4.0.1+1.15.2+fabric" = _jW5ceZ5s;
        "pkg-4.0.1+1.15.2" = _uZgvLJWd;
        "pkg-4.0.1+1.16.5+fabric" = _bnNY6E2c;
        "pkg-4.0.1+1.16.5" = _p3nrolE3;
        "pkg-4.0.1+1.17.1+fabric" = _ZHh6xZuA;
        "pkg-4.0.1+1.17.1" = _NE05wx8m;
        "pkg-4.0.1+1.18.2+fabric" = _TMg0XmXj;
        "pkg-4.0.1+1.18.2" = _P6b69DGz;
        "pkg-4.0.1+1.19+fabric" = _G4KkFY0M;
        "pkg-4.0.1+1.19" = _p9LsSYM3;
        "pkg-4.0.2+1.19.2+fabric" = _ECS37OvX;
        "pkg-4.0.2+1.19.2" = _wXNLRxdC;
        "pkg-4.0.3+1.19.2" = _r01rTJbI;
        "pkg-4.0.3+1.18.2+fabric" = _23Idtgu9;
        "pkg-4.0.3+1.18.2" = _1Xmee7yQ;
        "pkg-4.0.3+1.19.4" = _R67kWne3;
        "pkg-4.0.3+1.20.6" = _nBXhp12g;
        "pkg-4.0.3+1.20.6+fabric" = _I9N8JQwe;
        "pkg-4.0.4+1.19.4" = _yXcCr4LE;
        "pkg-4.0.4+1.19.4+fabric" = _AtMWzmse;
        "pkg-4.0.4+1.15.2+fabric" = _6cWs1XkG;
        "pkg-4.0.4+1.15.2" = _V6w7MS5C;
        "pkg-4.0.4+1.16.5+fabric" = _lk29r4rU;
        "pkg-4.0.4+1.16.5" = _QNRarb2l;
        "pkg-4.0.4+1.17.1" = _JanyU31v;
        "pkg-4.0.4+1.17.1+fabric" = _RCXIiUEX;
        "pkg-4.0.4+1.18.2+fabric" = _AJFdCu6X;
        "pkg-4.0.4+1.18.2" = _d0Vql9UH;
        "pkg-4.0.4+1.20.6+fabric" = _aVoylucx;
        "pkg-4.0.4+1.20.6" = _vFEkVWbe;
        "pkg-4.0.4+1.20.4+fabric" = _kiPpx6Nh;
        "pkg-4.0.4+1.20.4" = _IPPyJcbk;
        "pkg-4.0.4+1.21.1+fabric" = _4Qmpr0WM;
        "pkg-4.0.5+1.21.4+fabric" = _dhGN34Dl;
        "pkg-4.0.5+1.21.5" = _T5WIQqf6;
        "pkg-4.0.6+1.15.2+fabric" = _G1ASkl38;
        "pkg-4.0.6+1.15.2" = _65bYgJ2E;
        "pkg-4.0.6+1.16.5+fabric" = _D9exZd86;
        "pkg-4.0.6+1.16.5" = _kMmLx5hw;
        "pkg-4.0.6+1.17.1" = _fI2FgPXe;
        "pkg-4.0.6+1.17.1+fabric" = _JaBFYeaE;
        "pkg-4.0.6+1.18.2+fabric" = _fn2zFrXG;
        "pkg-4.0.6+1.18.2" = _pLsISN4K;
        "pkg-4.0.6+1.19.4+fabric" = _MKiVeXeG;
        "pkg-4.0.6+1.19.4" = _Gn8pH51y;
        "pkg-4.0.6+1.20.4" = _gXkGYZ1O;
        "pkg-4.0.6+1.20.4+fabric" = _L8JBMusL;
        "pkg-4.0.6+1.20.6" = _jtdDMxRO;
        "pkg-4.0.6+1.20.6+fabric" = _fxyNVlaC;
        "pkg-4.0.6+1.21.5+fabric" = _8GMM7Nz0;
        "pkg-4.0.7+1.15.2+fabric" = _DbAZ3k0x;
        "pkg-4.0.7+1.16.5+fabric" = _79d4kLHm;
        "pkg-4.0.7+1.17.1+fabric" = _G7WMjngI;
        "pkg-4.0.7+1.18.2+fabric" = _dUL5bL1I;
        "pkg-4.0.7+1.18.2" = _ceLRMFsR;
        "pkg-4.0.7+1.19.4" = _AqKc7NPO;
        "pkg-4.0.7+1.21.5+fabric" = _SQnaz5St;
        "pkg-4.0.7+1.19.4+fabric" = _BmfArXR0;
        "pkg-4.0.7+1.20.6+fabric" = _NEDcvXhz;
        "pkg-4.0.7+1.20.4+fabric" = _lezSXoGQ;
        "pkg-4.0.7+1.20.6" = _vFdSUCYn;
        "pkg-4.0.7+1.20.4" = _6ut4oNaE;
        "pkg-4.0.8+1.15.2+fabric" = _5AQnxWW8;
        "pkg-4.0.8+1.16.5+fabric" = _CKqOA0Bc;
        "pkg-4.0.8+1.17.1+fabric" = _xoFvshUq;
        "pkg-4.0.8+1.18.2" = _NiwxkTMR;
        "pkg-4.0.8+1.18.2+fabric" = _12Y4rk7f;
        "pkg-4.0.8+1.19.4+fabric" = _vreJnhH6;
        "pkg-4.0.8+1.19.4" = _DYg5MWLb;
        "pkg-4.0.8+1.20.4" = _daAQNzxY;
        "pkg-4.0.8+1.20.4+fabric" = _rTizqJId;
        "pkg-4.0.8+1.20.6" = _tS7t2uUk;
        "pkg-4.0.8+1.20.6+fabric" = _OHbD3K4E;
        "pkg-4.0.8+1.21.7+fabric" = _WJf0Raig;
        "pkg-4.0.8+1.20.1" = _I86q8JcQ;
        "pkg-4.0.8+1.21.11+fabric" = _HGy08xSQ;
        "pkg-4.0.9+1.15.2+fabric" = _jF64Xb2H;
        "pkg-4.0.9+1.16.5+fabric" = _elUOgodI;
        "pkg-4.0.9+1.17.1+fabric" = _NYefrY53;
        "pkg-4.0.9+1.18.2" = _wxIj3nR0;
        "pkg-4.0.9+1.18.2+fabric" = _dS7m13Tr;
        "pkg-4.0.9+1.19.4" = _UOrh2QEt;
        "pkg-4.0.9+1.19.4+fabric" = _Gw0Zsnp3;
        "pkg-4.0.9+1.20.1+fabric" = _WzYScqvz;
        "pkg-4.0.9+1.20.1" = _7JvQKqmp;
        "pkg-4.0.9+1.20.4+fabric" = _C4wEaSz0;
        "pkg-4.0.9+1.20.4" = _RuhBBFg8;
        "pkg-4.0.9+1.20.6+fabric" = _2Qzn1Mbw;
        "pkg-4.0.9+1.21.11+fabric" = _AgGxkbmz;
        "default" = _AgGxkbmz;
    });
