...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha.1+1.20.5" = _6siYPnFT;
        "pkg-1.0.0-alpha.2+1.20.5" = _vfbXM81a;
        "pkg-1.0.0-alpha.3+1.20.5" = _KdauyBIP;
        "pkg-1.0.0-alpha.3+1.21" = _prpT5CW1;
        "pkg-1.0.0-alpha.4+1.21" = _9WaLO1Pm;
        "pkg-1.0.0-alpha.5+1.21.4-fabric" = _1sNowJRq;
        "pkg-1.0.0-alpha.5+1.21.4-quilt" = _8I7VyauM;
        "pkg-1.0.0-rc.1+1.21.4-fabric" = _Q0HXWv9E;
        "pkg-1.0.0-rc.1+1.21.4-quilt" = _D0ANs8lZ;
        "pkg-1.0.0-rc.2+1.21.4-fabric" = _tTyCZeII;
        "pkg-1.0.0-rc.2+1.21.4-quilt" = _FUjSzPYa;
        "pkg-1.0.0-release.1+1.21.4-fabric" = _6Olr238V;
        "pkg-1.0.0-release.1+1.21.4-quilt" = _9dhpIvXE;
        "pkg-1.0.1-release.1+1.21.4-fabric" = _UEyMGqkn;
        "pkg-1.0.1-release.1+1.21.4-quilt" = _YklB8LZP;
        "pkg-1.1.0-alpha.1+1.21.4-fabric" = _RQLNzTB9;
        "pkg-1.1.0-beta.1+fabric-1.21.11" = _gmVUV4dH;
        "pkg-1.1.0-beta.2+fabric-1.21.11" = _ins3gjdW;
        "pkg-1.1.0-beta.3+fabric-1.21.11" = _MTZw3SJZ;
        "pkg-1.1.0-beta.4+fabric-1.21.11" = _7vHC7NtH;
        "pkg-1.1.0-beta.5+fabric-1.21.11" = _5D6WdPXW;
        "pkg-1.1.0-beta.6+fabric-1.21.11" = _dWIXuRUT;
        "pkg-1.1.0-beta.7+fabric-1.21.11" = _jWCL2TNE;
        "pkg-1.1.0-beta.8+fabric-1.21.11" = _60Lh0Arb;
        "default" = _60Lh0Arb;
    });
