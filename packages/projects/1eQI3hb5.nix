...
let
    ...
    in {
        ...
        "pkg-1.20.5(.6)" = _QPl5bihp;
        "pkg-1.21(.1)" = _vCgBHjN0;
        "pkg-1.15.x" = _8h7PDSKJ;
        "pkg-1.13-1.14.4" = _EHU00Y9w;
        "pkg-1.11-1.12.2" = _kIhp5S3E;
        "pkg-1.9-1.10.2" = _30C1fCN7;
        "pkg-1.6.1-1.8.9" = _8wPrlTrT;
        "pkg-1.16-1.16.1" = _w09vjeKm;
        "pkg-1.16.2-1.16.5" = _jx396U33;
        "pkg-1.17-1.17.1" = _XiKOHKh3;
        "pkg-1.18-1.18.2" = _ufmhxuMR;
        "pkg-1.19-1.19.2" = _aNgv58l9;
        "pkg-1.19.3" = _fi9psjYa;
        "pkg-1.19.4" = _5AL9wIZ8;
        "pkg-1.21.2(.3)" = _nw7YgkQT;
        "pkg-1.21.4" = _zHoT6zwh;
        "pkg-1.21.5" = _gfrSN5wz;
        "pkg-1.21.6" = _1E6I6ohk;
        "pkg-1.21.7(.8)" = _tg7Yi3bf;
        "pkg-1.21.9(.10)" = _LQArjNrv;
