...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _lTacuHKe;
        "pkg-0.2.0" = _Ag36WuJO;
        "pkg-0.3.0-rc.1" = _IXvnyALv;
        "pkg-0.3.0" = _MTMIcme6;
        "pkg-0.3.1" = _TLBDI65f;
        "pkg-0.3.3" = _Vn4lmX12;
        "pkg-0.4.0-rc.1" = _TidpZvy8;
        "pkg-0.4.0" = _T7pFEsNx;
        "pkg-0.4.1-rc.1" = _vY1s4Ie0;
        "pkg-0.4.1-rc.2" = _bjm1YHzU;
        "pkg-0.4.1-rc.3" = _oYlFJUWi;
        "pkg-0.4.1" = _1Pqu1IWj;
        "pkg-0.4.2-rc.1" = _3MW4Ckei;
        "pkg-0.4.2" = _ZDtMN7Fm;
        "pkg-0.4.3" = _bd03iXr9;
        "pkg-0.5.0-rc.1" = _pe3KOjdY;
        "pkg-0.5.0-rc.2" = _vnDDBfmy;
        "pkg-0.5.0-rc.3" = _tXpeXwZ6;
        "pkg-0.5.0" = _TE9Gn7Bp;
        "pkg-0.5.1" = _FeTG0TRU;
        "pkg-0.5.2-rc.2" = _HVRrLFYO;
        "pkg-0.5.2-rc.3+1.20.1-forge" = _Zbefs3U5;
        "pkg-0.5.2-rc.3+1.20.1-fabric" = _Jm5dnfOK;
        "pkg-0.5.2-rc.4+1.20.1-forge" = _PHPb9MzT;
        "pkg-0.5.2-rc.4+1.20.1-fabric" = _AbENsUuc;
        "pkg-0.5.2-rc.5+1.20.1" = _AArECrjF;
        "default" = _AArECrjF;
    });
