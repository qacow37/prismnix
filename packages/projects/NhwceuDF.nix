...
let
    ...
    in {
        ...
        "pkg-v1.0.2" = _mqlv8ckh;
        "pkg-v1.0.2+mod" = _zEIyKP3H;
        "pkg-v1.0.3" = _bwkqohyD;
        "pkg-v1.0.3+mod" = _djeayJsf;
        "pkg-v1.0.4" = _tclR0x4S;
        "pkg-v1.0.4+mod" = _5TJ8TDmX;
        "pkg-v1.0.5" = _ROCQ5k3C;
