...
let
    ...
    in {
        ...
        "pkg-1.16.4-1.0.3" = _WYshnEXY;
        "pkg-1.15.2-2.0.0" = _LnSBBdYi;
        "pkg-1.16.5-2.0.0" = _OyAMqTo1;
        "pkg-2.0.1+1.16.5" = _J34Yh3Mk;
        "pkg-2.0.1+1.15.2" = _jXvo5mup;
        "pkg-2.0.2+1.16.5" = _4nX0nhWB;
        "pkg-2.0.2+1.15.2" = _JsvYXrjL;
        "pkg-2.0.3+1.15.2" = _tNOk0pfp;
        "pkg-2.0.3+1.16.5" = _HIXOdfkI;
        "pkg-2.0.4+1.15.2" = _IOf7JcHs;
        "pkg-2.0.4+1.16.5" = _EIHNQJRf;
        "pkg-2.0.5+1.16.5" = _ld8TLcTU;
        "pkg-2.0.6+1.16.5" = _Qw0sbKBi;
        "pkg-2.1.0+1.16.5" = _y989xTco;
        "pkg-2.1.1+1.16.5" = _Q5rC7tnS;
        "pkg-2.1.2+1.16.5" = _oc5crDZs;
        "pkg-2.1.2+1.15.2" = _wK7wBUqr;
        "pkg-3.0.0+1.14.4" = _THYyG7Z5;
        "pkg-3.0.0+1.15.2" = _EfXKBBX2;
        "pkg-3.0.0+1.16.5" = _YmL8lTnV;
        "pkg-3.0.1+1.14.4" = _sl81ytlS;
        "pkg-3.0.1+1.15.2" = _qHOG0bJI;
        "pkg-3.0.1+1.16.5" = _zKz4IGEt;
        "pkg-3.0.2+1.14.4" = _Cw8IHjZz;
        "pkg-3.0.2+1.15.2" = _pJ9oIsSA;
        "pkg-3.0.2+1.16.5" = _VbZLIYH3;
        "pkg-3.0.3+1.14.4" = _9Hhesfgg;
        "pkg-3.0.3+1.15.2" = _S2KbAHlw;
        "pkg-3.0.3+1.16.5" = _yxRtSPDq;
        "pkg-3.0.4+1.14.4" = _rqTZQaqY;
        "pkg-3.0.4+1.15.2" = _1YBghLN5;
        "pkg-3.0.4+1.16.5" = _x8kcLkpa;
        "pkg-3.1.0+1.14.4" = _djqLXakA;
        "pkg-3.1.0+1.15.2" = _ZjsHlpK5;
        "pkg-3.1.0+1.16.5" = _TwUAzUWQ;
        "pkg-3.2.0+1.14.4" = _7UeEGzWZ;
        "pkg-3.2.0+1.15.2" = _LEdqe5yu;
        "pkg-3.2.0+1.16.5" = _wGFefMx7;
        "pkg-3.3.0+1.14.4" = _ou1PWKIs;
        "pkg-3.3.0+1.15.2" = _IjcfIcba;
        "pkg-3.3.0+1.16.5" = _K63UGkhB;
        "pkg-3.3.0+1.17" = _Cuv4XLjN;
        "pkg-4.0.0+1.14.4" = _wMzvmekv;
        "pkg-4.0.0+1.15.2" = _BKC3IQBJ;
        "pkg-4.0.0+1.16.5" = _Y0p2ClH2;
        "pkg-4.0.0+1.17.1" = _dUvc50Sl;
        "pkg-4.0.1+1.14.4" = _c9lYwd4t;
        "pkg-4.0.1+1.15.2" = _m62jDw7U;
        "pkg-4.0.1+1.16.5" = _7RMdWC5J;
        "pkg-4.0.1+1.17.1" = _5hRB7dSf;
        "pkg-4.0.2+1.14.4" = _OSe4nP8k;
        "pkg-4.0.2+1.15.2" = _YkrXV4nS;
        "pkg-4.0.2+1.16.5" = _kSYxW6Tm;
        "pkg-4.0.2+1.17.1" = _TOgtbq5J;
        "pkg-5.0.0+1.14.4" = _m0BRIEMH;
        "pkg-5.0.0+1.15.2" = _Jr1LXkma;
        "pkg-5.0.0+1.16.5" = _O7gPMg76;
        "pkg-5.0.0+1.17.1" = _n990uPIP;
        "pkg-5.0.1+1.14.4" = _rFqnXpe8;
        "pkg-5.0.1+1.15.2" = _TEeMuREk;
        "pkg-5.0.1+1.16.5" = _THWduPOd;
        "pkg-5.0.1+1.17.1" = _w1Eho1Nu;
        "pkg-5.1.0+1.14.4" = _KVzfK2Ce;
        "pkg-5.1.0+1.15.2" = _GqnJC23h;
        "pkg-5.1.0+1.16.5" = _vQcOL9HP;
        "pkg-5.1.0+1.17.1" = _gxmdl78g;
        "pkg-5.2.0+1.14.4" = _iL7fMJso;
        "pkg-5.2.0+1.15.2" = _QZZ488U9;
        "pkg-5.2.0+1.16.5" = _5ZmXMfmr;
        "pkg-5.2.0+1.17.1" = _ze1ycqx3;
        "pkg-5.2.1+1.17.1" = _mAYvJAu7;
        "pkg-5.2.2+1.14.4" = _DyJTjdHw;
        "pkg-5.2.2+1.15.2" = _2Z6U0a0h;
        "pkg-5.2.2+1.16.5" = _D4TJTrV3;
        "pkg-5.2.2+1.17.1" = _TsCOsmlX;
        "pkg-5.2.3+1.14.4" = _eT67adkR;
        "pkg-5.3.0+1.14.4" = _TLJsfVSV;
        "pkg-5.3.0+1.15.2" = _y6WRWlMd;
        "pkg-5.3.0+1.16.5" = _hF6P5JaB;
        "pkg-5.3.1+1.16.5" = _arE4byMq;
        "pkg-5.3.0+1.17.1" = _ilkIDuJ3;
        "pkg-5.4.0+1.14.4" = _qSLzyK19;
        "pkg-5.4.0+1.15.2" = _CFFTCUWH;
        "pkg-5.4.0+1.16.5" = _Jv21hm2V;
        "pkg-5.4.0+1.17.1" = _ywV1vQod;
        "pkg-5.5.0+1.14.4" = _xXdr5VNF;
        "pkg-5.5.0+1.15.2" = _6i5Euphn;
        "pkg-5.5.0+1.16.5" = _rjChxT70;
        "pkg-5.5.0+1.17.1" = _KjpcxSoe;
        "pkg-5.6.0+1.14.4" = _kdSQCqxT;
        "pkg-5.6.0+1.15.2" = _1Aofhm98;
        "pkg-5.6.0+1.16.5" = _pE1dxyWi;
        "pkg-5.6.0+1.17.1" = _mkc5XGZe;
        "pkg-5.6.1+1.14.4" = _cuDlVWcr;
        "pkg-5.6.1+1.15.2" = _hIfpcvY4;
        "pkg-5.6.1+1.16.5" = _5cC3BgZa;
        "pkg-5.6.1+1.17.1" = _XHEj1RWr;
        "pkg-5.7.0+1.14.4" = _TwCXVPkE;
        "pkg-5.7.0+1.15.2" = _e1vVYasI;
        "pkg-5.7.0+1.16.5" = _cWhdRGFC;
        "pkg-5.7.0+1.17.1" = _myrCZC3K;
        "pkg-5.7.1+1.14.4" = _SdnLDpJK;
        "pkg-5.7.1+1.15.2" = _arEd8RjM;
        "pkg-5.7.1+1.16.5" = _4YFRYjV5;
        "pkg-5.7.1+1.17.1" = _KzoD22By;
        "pkg-5.7.2+1.14.4" = _aM8T7um8;
        "pkg-5.7.2+1.15.2" = _6dG1COKD;
        "pkg-5.7.2+1.16.5" = _yYe1Pcrz;
        "pkg-5.7.2+1.17.1" = _MYJBncP6;
        "pkg-6.0.0+1.14.4" = _T80EAk0e;
        "pkg-6.0.0+1.15.2" = _TzwJnKKn;
        "pkg-6.0.0+1.16.5" = _XpvxwKBh;
        "pkg-6.0.0+1.17.1" = _kGJzHnUr;
        "pkg-6.0.1+1.14.4" = _AKmofKDI;
        "pkg-6.0.1+1.15.2" = _XLnofatn;
        "pkg-6.0.1+1.16.5" = _V4ozfyFD;
        "pkg-6.0.1+1.17.1" = _O57lvx4R;
        "pkg-6.0.2+1.14.4" = _XgToPtkQ;
        "pkg-6.0.2+1.15.2" = _IWieYCnm;
        "pkg-6.0.2+1.16.5" = _gVvQDLbl;
        "pkg-6.0.2+1.17.1" = _KtXi8GiS;
        "pkg-6.0.3+1.14.4" = _p5eQs6ot;
        "pkg-6.0.3+1.15.2" = _scNDVBrB;
        "pkg-6.0.3+1.16.5" = _d0nJMRHY;
        "pkg-6.0.3+1.17.1" = _g6LioOgZ;
        "pkg-6.0.4+1.14.4" = _Tptp1rid;
        "pkg-6.0.4+1.15.2" = _rO8PI8n5;
        "pkg-6.0.4+1.16.5" = _VcMA7uz7;
        "pkg-6.0.4+1.17.1" = _IpDVKZVk;
        "pkg-6.0.5+1.14.4" = _61Sipv6r;
        "pkg-6.0.5+1.15.2" = _njcwgvQe;
        "pkg-6.0.5+1.16.5" = _Xb0gVheL;
        "pkg-6.0.5+1.17.1" = _kkmUZWSJ;
        "pkg-6.0.6+1.14.4" = _GK3l3q75;
        "pkg-6.0.6+1.15.2" = _fhaIrDIs;
        "pkg-6.0.6+1.16.5" = _CKbe27MI;
        "pkg-6.0.6+1.17.1" = _9UaeDQ6K;
        "pkg-6.0.7+1.14.4" = _sKvNVae9;
        "pkg-6.0.7+1.15.2" = _uhKdZ758;
        "pkg-6.0.7+1.16.5" = _HzrUNWZD;
        "pkg-6.0.7+1.17.1" = _AiwN4rFs;
        "pkg-6.0.8+1.14.4" = _yLjYx051;
        "pkg-6.0.8+1.15.2" = _N0nFzFRB;
        "pkg-6.0.8+1.16.5" = _C4xca4jk;
        "pkg-6.0.8+1.17.1" = _s6WgFmVk;
        "pkg-6.1.0+1.14.4" = _8yOT9zHq;
        "pkg-6.1.0+1.15.2" = _F3jpMDeu;
        "pkg-6.1.0+1.16.5" = _veCSMpEf;
        "pkg-6.1.0+1.17.1" = _hFzjNSd4;
        "pkg-6.2.0+1.14.4" = _T5BBMUBq;
        "pkg-6.2.0+1.15.2" = _UxNmNaTR;
        "pkg-6.2.0+1.16.5" = _NebilwnM;
        "pkg-6.2.0+1.17.1" = _fvyEGq6c;
        "pkg-6.2.2+1.18" = _xnQnxZz9;
        "pkg-6.3.0+1.14.4" = _PjT6lJcA;
        "pkg-6.3.0+1.15.2" = _EKrmIaAo;
        "pkg-6.3.0+1.16.5" = _dxIeWe62;
        "pkg-6.3.0+1.17.1" = _mjorGHp4;
        "pkg-6.3.0+1.18.2" = _nZSuZRqI;
        "pkg-6.3.1+1.14.4" = _VjkPWjDq;
        "pkg-6.3.1+1.15.2" = _fXpl0cmq;
        "pkg-6.3.1+1.16.5" = _YKIFmGWw;
        "pkg-6.3.1+1.17.1" = _Dycy7IRG;
        "pkg-6.3.1+1.18.2" = _8vti8jQp;
        "pkg-7.0.0+1.15.2" = _AdNsDd1x;
        "pkg-7.0.0+1.16.5" = _HGxY2VIG;
        "pkg-7.0.0+1.17.1+fabric" = _sWdfWgtc;
        "pkg-7.0.0+1.17.1" = _vGTX4I7g;
        "pkg-7.0.0+1.18.2+fabric" = _CXxqNR9X;
        "pkg-7.0.0+1.18.2" = _fmnxvCBS;
        "pkg-7.0.0+1.19" = _FmEPbEqx;
        "pkg-7.0.0+1.19+fabric" = _2ybYULXm;
        "pkg-7.0.1+1.15.2" = _pkXusSZu;
        "pkg-7.0.1+1.16.5" = _zC4FwqBa;
        "pkg-7.0.1+1.17.1" = _AfvNcWez;
        "pkg-7.0.1+1.17.1+fabric" = _VUYxSyPe;
        "pkg-7.0.1+1.18.2" = _H97zqvIt;
        "pkg-7.0.1+1.18.2+fabric" = _ijzNRBpI;
        "pkg-7.0.1+1.19" = _gjteWnVL;
        "pkg-7.0.1+1.19+fabric" = _BB6PBcOq;
        "pkg-7.0.2+1.15.2" = _S1W5Te9R;
        "pkg-7.0.2+1.16.5" = _r3JOLNCx;
        "pkg-7.0.2+1.17.1+fabric" = _VTSUWW3F;
        "pkg-7.0.2+1.17.1" = _8EZkZgmh;
        "pkg-7.0.2+1.18.2+fabric" = _liZKqe73;
        "pkg-7.0.2+1.18.2" = _KZ3Dbh0t;
        "pkg-7.0.2+1.19+fabric" = _rt7qixYF;
        "pkg-7.0.2+1.19" = _6v8B5cbV;
        "pkg-7.0.3+1.19+fabric" = _HqwjQxrN;
        "pkg-7.0.3+1.19" = _SigFjrik;
        "pkg-7.0.3+1.19.2+fabric" = _taLKbHvA;
        "pkg-7.0.3+1.19.2" = _nCsLahrm;
        "pkg-7.1.0+1.15.2" = _idA3DQSz;
        "pkg-7.1.0+1.16.5" = _e0RyONvO;
        "pkg-7.1.0+1.17.1" = _QDjVDjEO;
        "pkg-7.1.0+1.17.1+fabric" = _8I4njy8C;
        "pkg-7.1.0+1.18.2" = _XQvmu5fx;
        "pkg-7.1.0+1.18.2+fabric" = _JalkumwG;
        "pkg-7.1.0+1.19.2" = _GhmbYKKm;
        "pkg-7.1.0+1.19.2+fabric" = _wlvbjYJv;
        "pkg-7.1.1+1.15.2" = _U8BvxreJ;
        "pkg-7.1.1+1.16.5" = _TCJXR1K4;
        "pkg-7.1.1+1.17.1+fabric" = _a6Lxhp5r;
        "pkg-7.1.1+1.17.1" = _8uNfCoII;
        "pkg-7.1.1+1.18.2+fabric" = _Eyy1x1Sq;
        "pkg-7.1.1+1.18.2" = _l4eFCBFm;
        "pkg-7.1.1+1.19.2+fabric" = _tuktgkKG;
        "pkg-7.1.1+1.19.2" = _7Bt5TbUE;
        "pkg-7.1.2+1.15.2" = _BNkMJrkr;
        "pkg-7.1.2+1.16.5" = _Pxvh6v6P;
        "pkg-7.1.2+1.17.1+fabric" = _hi9QoKzN;
        "pkg-7.1.2+1.17.1" = _AOgGC90g;
        "pkg-7.1.2+1.18.2+fabric" = _iTinKvqb;
        "pkg-7.1.2+1.18.2" = _7NjOp50q;
        "pkg-7.1.2+1.19.2+fabric" = _P3ahuAhE;
        "pkg-7.1.2+1.19.2" = _VJwutLQ0;
        "pkg-7.1.2+1.19.4+fabric" = _mQKw1jIP;
        "pkg-7.1.2+1.19.4" = _Dc3oTbHl;
        "pkg-7.1.2+1.20.1+fabric" = _kubAPpPo;
        "pkg-7.1.2+1.20.1" = _eBswVBKg;
        "pkg-7.1.2+1.20.2+fabric" = _YRtJrHg5;
        "pkg-7.1.2+1.20.2" = _d2hKsOO7;
        "pkg-7.1.2+1.20.4+fabric" = _u7fjEb6X;
        "pkg-7.1.2+1.20.4" = _PkC4GC4I;
        "pkg-7.1.2+1.20.6+fabric" = _aw9PoKa4;
        "pkg-7.1.2+1.21+fabric" = _qFfg8orX;
        "pkg-7.1.2+1.21.1+fabric" = _bYoa4pE2;
        "pkg-7.1.3+1.17.1" = _sVYlWKUy;
        "pkg-7.1.3+1.17.1+fabric" = _FqLK3TQ2;
        "pkg-7.1.3+1.18.2+fabric" = _3P5qtt8o;
        "pkg-7.1.3+1.18.2" = _rYp9stSy;
        "pkg-7.1.3+1.19.2+fabric" = _BzogiCyd;
        "pkg-7.1.3+1.19.2" = _2UR9gica;
        "pkg-7.1.3+1.19.4+fabric" = _W91k3I6N;
        "pkg-7.1.3+1.19.4" = _SSTuCyUY;
        "pkg-7.1.3+1.20.1+fabric" = _HAiYEOUw;
        "pkg-7.1.3+1.20.1" = _YLEfYsiS;
        "pkg-7.1.3+1.20.2+fabric" = _iVZcAcll;
        "pkg-7.1.3+1.20.2" = _RCvHOFvk;
        "pkg-7.1.3+1.20.4+fabric" = _eFF02at3;
        "pkg-7.1.3+1.20.4" = _i2BtidFv;
        "pkg-7.1.3+1.20.6+fabric" = _C74ndO1k;
        "pkg-7.1.3+1.21.1+fabric" = _ENqwCDcq;
        "pkg-7.1.3+1.21.4+fabric" = _vDsbN3mR;
        "pkg-7.1.3+1.21.5+fabric" = _JiliR6px;
        "pkg-7.1.3+1.21+fabric" = _1XbaKxLB;
        "pkg-7.1.4+1.17.1+fabric" = _52tgw0DV;
        "pkg-7.1.4+1.17.1" = _kH8Ld4B2;
        "pkg-7.1.4+1.18.2+fabric" = _RUK56ObP;
        "pkg-7.1.4+1.18.2" = _PUhK8zJw;
        "pkg-7.1.4+1.19.2+fabric" = _C2A7t1u3;
        "pkg-7.1.4+1.19.2" = _SQGPLpNE;
        "pkg-7.1.4+1.19.4+fabric" = _lklbSZag;
        "pkg-7.1.4+1.19.4" = _P537860U;
        "pkg-7.1.4+1.20.1+fabric" = _4P2tGFup;
        "pkg-7.1.4+1.20.1" = _OqsbsxUj;
        "pkg-7.1.4+1.20.6+fabric" = _B41przVu;
        "pkg-7.1.4+1.20.2+fabric" = _1QKMNMEn;
        "pkg-7.1.4+1.20.2" = _QH13PEWb;
        "pkg-7.1.4+1.20.4+fabric" = _DgZJF6FD;
        "pkg-7.1.4+1.20.4" = _ikzCT5Su;
        "pkg-7.1.4+1.21+fabric" = _HuFfcFVt;
        "pkg-7.1.4+1.21.1+fabric" = _3wWKnrLP;
        "pkg-7.1.4+1.21.4+fabric" = _9CDOGdQy;
        "pkg-7.1.4+1.21.5+fabric" = _rTj4atse;
        "pkg-7.1.5+1.17.1+fabric" = _Nny85pgu;
        "pkg-7.1.5+1.18.2+fabric" = _VQcyY2pU;
        "pkg-7.1.5+1.18.2" = _5ZIl3NmO;
        "pkg-7.1.5+1.19.2+fabric" = _MhM866Ey;
        "pkg-7.1.5+1.19.2" = _o8TXP0NK;
        "pkg-7.1.5+1.19.4+fabric" = _vsaOPhZA;
        "pkg-7.1.5+1.19.4" = _QORw42wd;
        "pkg-7.1.5+1.20.1+fabric" = _go0Nu9t4;
        "pkg-7.1.5+1.20.1" = _4oeAGtMS;
        "pkg-7.1.5+1.20.2" = _KLNANUB5;
        "pkg-7.1.5+1.20.2+fabric" = _uusFH8fe;
        "pkg-7.1.5+1.20.4+fabric" = _mvpP7nX3;
        "pkg-7.1.5+1.20.4" = _GAHfwHrE;
        "pkg-7.1.5+1.20.6+fabric" = _tZEIebl7;
        "pkg-7.1.5+1.21+fabric" = _e38KNVuI;
        "pkg-7.1.5+1.21.1+fabric" = _Db9GCpuF;
        "pkg-7.1.5+1.21.4+fabric" = _CxQUSRBf;
        "pkg-7.1.5+1.21.5+fabric" = _hMMRjLy8;
        "pkg-7.1.6+1.17.1+fabric" = _dKc6SaGC;
        "pkg-7.1.6+1.18.2" = _tBPgeG1E;
        "pkg-7.1.6+1.18.2+fabric" = _OJrBVIFH;
        "pkg-7.1.6+1.19.2+fabric" = _LmljVwot;
        "pkg-7.1.6+1.19.2" = _CskOEFoa;
        "pkg-7.1.6+1.20.1+fabric" = _FPlsYK9W;
        "pkg-7.1.6+1.20.1" = _x13SrDwt;
        "pkg-7.1.6+1.19.4+fabric" = _eIJByTfc;
        "pkg-7.1.6+1.19.4" = _633i0r7x;
        "pkg-7.1.6+1.20.2+fabric" = _q5rBy9P7;
        "pkg-7.1.6+1.20.2" = _WTcFYDwY;
        "pkg-7.1.6+1.20.4+fabric" = _a6SQp700;
        "pkg-7.1.6+1.20.6+fabric" = _fCsJi6kK;
        "pkg-7.1.6+1.21+fabric" = _mJ3FqVO8;
        "pkg-7.1.6+1.21.1+fabric" = _YMfDgWHK;
        "pkg-7.1.6+1.21.4+fabric" = _R4m9dU3B;
        "pkg-7.1.6+1.21.5+fabric" = _r96fbitL;
        "pkg-7.1.6+1.21.7+fabric" = _v5QQwAQi;
        "pkg-7.1.7+1.17.1+fabric" = _wuGectm8;
        "pkg-7.1.7+1.18.2+fabric" = _iMysPhQC;
        "pkg-7.1.7+1.18.2" = _Qk6neXxD;
        "pkg-7.1.7+1.19.2+fabric" = _wyd27qkk;
        "pkg-7.1.7+1.19.2" = _hYjwcsja;
        "pkg-7.1.7+1.19.4+fabric" = _bu11UB58;
        "pkg-7.1.7+1.19.4" = _T8ZojL7k;
        "pkg-7.1.7+1.20.1+fabric" = _jegPiEtP;
        "pkg-7.1.7+1.20.1" = _ohKPb5Rd;
        "pkg-7.1.7+1.20.2+fabric" = _eQFg3Bmm;
        "pkg-7.1.7+1.20.2" = _WO2VJQYh;
        "pkg-7.1.7+1.20.4+fabric" = _34rd7HSx;
        "pkg-7.1.7+1.20.4" = _3MqfEXNC;
        "pkg-7.1.7+1.20.6+fabric" = _Cz19jhny;
        "pkg-7.1.7+1.21+fabric" = _eytVAFIs;
        "pkg-7.1.7+1.21.1+fabric" = _FGlvrYUF;
        "pkg-7.1.7+1.21.4+fabric" = _cn2AltJj;
        "pkg-7.1.7+1.21.5+fabric" = _vPK26dMv;
        "pkg-7.1.7+1.21.7+fabric" = _qwB2Wijs;
        "pkg-7.1.7+1.21.8+fabric" = _SrMIv96Z;
        "pkg-7.1.7+1.21.10+fabric" = _A9LNKZQR;
        "pkg-7.1.7+1.21.11+fabric" = _jUmTIygA;
        "default" = _jUmTIygA;
    });
