...
let
    ...
    in {
        ...
        "pkg-1.21.0-2.0-fabric+forge+neo" = _O6z1w9SX;
        "pkg-1.21.1-2.0-fabric+forge+neo" = _d0eyw5gc;
        "pkg-1.21.1-2.1-fabric+forge+neo" = _4QCTgq8v;
        "pkg-1.21.4-2.0-fabric+forge+neo" = _BzyplwcD;
        "pkg-1.21.4-2.1-fabric+forge+neo" = _YR66acoj;
        "pkg-1.21.1-2.2-fabric+forge+neo" = _n0aq9UdL;
        "pkg-1.21.4-2.2-fabric+forge+neo" = _R5WpLlJt;
        "pkg-1.21.1-2.3-fabric+forge+neo" = _2iYhyFpF;
        "pkg-1.21.4-2.3-fabric+forge+neo" = _wK4jY2v0;
        "pkg-1.21.5-2.3-fabric+forge+neo" = _8YJViRhe;
        "pkg-1.21.1-2.4-fabric+forge+neo" = _7MUQEV0Q;
        "pkg-1.21.5-2.4-fabric+forge+neo" = _uODxwBSD;
        "pkg-1.21.6-2.4-fabric+forge+neo" = _IVz4FArQ;
        "pkg-1.21.7-2.4-fabric+forge+neo" = _cblqH6kL;
        "pkg-1.21.8-2.4-fabric+forge+neo" = _lgHV1hEG;
        "pkg-1.21.11-2.4-fabric+forge+neo" = _6PMNPOiT;
        "pkg-26.1.2-2.4-fabric+forge+neo" = _1yt2NJfB;
        "pkg-1.21.1-2.5-fabric+forge+neo" = _uWNzYzZl;
        "pkg-1.21.11-2.6-fabric+forge+neo" = _zq6UhxFu;
        "pkg-26.1.2-2.6-fabric+forge+neo" = _tLLYsARm;
        "pkg-1.21.1-2.7-fabric+forge+neo" = _UoGzliSQ;
