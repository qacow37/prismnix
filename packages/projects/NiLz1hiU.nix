...
let
    ...
    in {
        ...
        "pkg-2.6.1" = _P8DuNriu;
        "pkg-2.6.2" = _3KECKxoZ;
        "pkg-1.21.11-2.6.2-beta" = _kBqSayfA;
        "pkg-2.7.0" = _GVFemSLn;
        "pkg-1.21.11-2.7.0" = _4s965CR8;
        "pkg-2.7.1" = _AxN7eHDk;
        "pkg-2.7.2" = _k1LXjX1s;
        "pkg-2.7.3" = _jRMKaaFO;
        "pkg-3.0.0" = _bTs8kSoW;
        "pkg-1.21.11-3.0.0" = _1VJuuwVX;
        "pkg-1.21.11-3.0.0-fabric" = _3TDqscY6;
        "pkg-3.0.0-26.1" = _k2A1WvkZ;
        "default" = _k2A1WvkZ;
    });
