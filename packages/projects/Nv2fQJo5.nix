...
let
    ...
    in {
        ...
        "pkg-1.8-2.6.7" = _LAdb5qRt;
        "pkg-1.8.9-2.6.7" = _Bg7RAHyJ;
        "pkg-1.9.4-2.6.7" = _sQVYgpOo;
        "pkg-1.10.2-2.6.7" = _58ltb58q;
        "pkg-1.11-2.6.7" = _4clpWNTC;
        "pkg-1.11.2-2.6.7" = _fpD0rrcN;
        "pkg-1.12-2.6.7" = _WQZaoKq7;
        "pkg-1.12.1-2.6.7" = _UlwxDwga;
        "pkg-1.12.2-2.6.7" = _sXD2DQ4C;
        "pkg-1.14.4-2.6.7" = _Wa796DiZ;
        "pkg-1.15.2-2.6.7" = _oB9rCIQ3;
        "pkg-1.16.1-2.6.7" = _pSeNqPLG;
        "pkg-1.16.4-2.6.7" = _2jcrjeH9;
        "pkg-1.17-2.6.7" = _yRzXlkbS;
        "pkg-1.17.1-2.6.7" = _iPTJ3Zg4;
        "pkg-1.18.1-2.6.7" = _d40s9baB;
        "pkg-1.18.2-2.6.7" = _8fXhWBcR;
        "pkg-1.19-2.6.7" = _5CxMrid7;
        "pkg-1.19.1-2.6.7" = _EsOxUHNK;
        "pkg-1.19-2.6.8" = _LIVeUIqD;
        "pkg-1.19.1-2.6.8" = _1IAzC6AX;
        "pkg-1.8-2.6.9" = _iMFoo1IA;
        "pkg-1.8.9-2.6.9" = _thijJjIp;
        "pkg-1.9.4-2.6.9" = _1rOZN1zo;
        "pkg-1.10.2-2.6.9" = _ndcLZoMa;
        "pkg-1.11-2.6.9" = _Qe1waaR6;
        "pkg-1.11.2-2.6.9" = _WLE7L2Tr;
        "pkg-1.12-2.6.9" = _BVuva3fz;
        "pkg-1.12.1-2.6.9" = _RCeY0aqJ;
        "pkg-1.12.2-2.6.9" = _KIWAOVvq;
        "pkg-1.14.4-2.6.9" = _volcHOdL;
        "pkg-1.15.2-2.6.9" = _QtrMwqKM;
        "pkg-1.16.1-2.6.9" = _81jL9qWp;
        "pkg-1.16.4-2.6.9" = _Cl8Krcqb;
        "pkg-1.17-2.6.9" = _IKpv0q93;
        "pkg-1.17.1-2.6.9" = _xDKX1srD;
        "pkg-1.18.1-2.6.9" = _DSbGQic7;
        "pkg-1.18.2-2.6.9" = _okcFOvQB;
        "pkg-1.19-2.6.9" = _JVvnSjwE;
        "pkg-1.19.1-2.6.9" = _z93btwUO;
        "pkg-1.19.2-2.6.9" = _YtwBv8Wx;
        "pkg-1.19.3-2.6.9" = _InlvtwmO;
        "pkg-1.19.3-2.6.10" = _EcNOFu8c;
        "pkg-1.8-2.6.11" = _6yy8gtDQ;
        "pkg-1.8.9-2.6.11" = _ke9ZuM1y;
        "pkg-1.9.4-2.6.11" = _tuL0Wy4t;
        "pkg-1.10.2-2.6.11" = _7H88dLh3;
        "pkg-1.11-2.6.11" = _2q2c14V5;
        "pkg-1.11.2-2.6.11" = _ViDqRNbv;
        "pkg-1.12-2.6.11" = _7PD0BOWI;
        "pkg-1.12.1-2.6.11" = _WcMD8WyW;
        "pkg-1.12.2-2.6.11" = _Xi51Pi93;
        "pkg-1.14.4-2.6.11" = _CmWWcgPa;
        "pkg-1.15.2-2.6.11" = _XEgvQEao;
        "pkg-1.16.1-2.6.11" = _XRiofskF;
        "pkg-1.16.4-2.6.11" = _QEnGJzQi;
        "pkg-1.17-2.6.11" = _JR4YzF0B;
        "pkg-1.17.1-2.6.11" = _hrjyOCCd;
        "pkg-1.18.1-2.6.11" = _NzL9uuuq;
        "pkg-1.18.2-2.6.11" = _Yc2W8QF2;
        "pkg-1.19-2.6.11" = _vpwF1AEt;
        "pkg-1.19.1-2.6.11" = _4KnSuv5i;
        "pkg-1.19.2-2.6.11" = _RTpOrhlB;
        "pkg-1.19.3-2.6.11" = _C1eDr4u8;
        "pkg-1.19.4-2.6.11" = _Jhu6Ce8l;
        "pkg-1.19.4-2.6.12" = _MCLmJGNL;
        "pkg-1.8-2.6.13" = _5dh4X2Px;
        "pkg-1.8.9-2.6.13" = _PltO0FTH;
        "pkg-1.9.4-2.6.13" = _HHfjk4W8;
        "pkg-1.10.2-2.6.13" = _KKjQ0MzQ;
        "pkg-1.11-2.6.13" = _eGEmvYZI;
        "pkg-1.11.2-2.6.13" = _mzW8x79q;
        "pkg-1.12-2.6.13" = _F3SjPcKJ;
        "pkg-1.12.1-2.6.13" = _tubruMpy;
        "pkg-1.12.2-2.6.13" = _cbEVNsuL;
        "pkg-1.14.4-2.6.13" = _PbeaqpgH;
        "pkg-1.15.2-2.6.13" = _zvPU39ET;
        "pkg-1.16.1-2.6.13" = _E9EK68vH;
        "pkg-1.16.4-2.6.13" = _njHRZwEj;
        "pkg-1.17.1-2.6.13" = _EgrrDQUS;
        "pkg-1.18.1-2.6.13" = _HvXgN9yg;
        "pkg-1.18.2-2.6.13" = _1eU6zO2B;
        "pkg-1.19-2.6.13" = _GYKYSHAl;
        "pkg-1.19.1-2.6.13" = _85lHULy4;
        "pkg-1.19.2-2.6.13" = _EtYipT0o;
        "pkg-1.19.3-2.6.13" = _BDSvzcm4;
        "pkg-1.19.4-2.6.13" = _zZNW7mgL;
        "pkg-1.20.1-2.6.13" = _akFkhrL8;
        "pkg-1.8-2.6.14" = _JlD16MVE;
        "pkg-1.8.9-2.6.14" = _9wdM3teK;
        "pkg-1.9.4-2.6.14" = _xwEJAW13;
        "pkg-1.10.2-2.6.14" = _bGqLpW1Q;
        "pkg-1.11-2.6.14" = _3l0HyAYX;
        "pkg-1.11.2-2.6.14" = _w4DntqI3;
        "pkg-1.12-2.6.14" = _Sh6KNIPu;
        "pkg-1.12.1-2.6.14" = _GcIiseAU;
        "pkg-1.12.2-2.6.14" = _VDZOtfyO;
        "pkg-1.14.4-2.6.14" = _xJVrMXGu;
        "pkg-1.15.2-2.6.14" = _4bIBelGg;
        "pkg-1.16.1-2.6.14" = _UdqCkUuj;
        "pkg-1.16.4-2.6.14" = _wgsQp9k2;
        "pkg-1.17.1-2.6.14" = _Sx6m0qjo;
        "pkg-1.18.1-2.6.14" = _9mhAmHed;
        "pkg-1.18.2-2.6.14" = _TQVVZ2sj;
        "pkg-1.19-2.6.14" = _B7PDdOiZ;
        "pkg-1.19.1-2.6.14" = _RnKY1fkF;
        "pkg-1.19.2-2.6.14" = _BYJF82Q8;
        "pkg-1.19.3-2.6.14" = _KnZ6lROh;
        "pkg-1.19.4-2.6.14" = _hWebWQ5c;
        "pkg-1.20.1-2.6.14" = _NIH877ct;
        "pkg-1.20.2-2.6.14" = _G3s7lNSQ;
        "pkg-1.20.4-2.6.14" = _gxDkodfS;
        "pkg-1.8-2.6.15" = _3SDkAMrN;
        "pkg-1.8.9-2.6.15" = _z86I98cl;
        "pkg-1.9.4-2.6.15" = _ayRRIyfk;
        "pkg-1.10.2-2.6.15" = _gJapwSvl;
        "pkg-1.11-2.6.15" = _GUjnhuc0;
        "pkg-1.11.2-2.6.15" = _3KscGeCR;
        "pkg-1.12-2.6.15" = _PuCJ3fXk;
        "pkg-1.12.1-2.6.15" = _LXYUZ5hR;
        "pkg-1.12.2-2.6.15" = _QJwXFDrY;
        "pkg-1.14.4-2.6.15" = _L44XSh4f;
        "pkg-1.15.2-2.6.15" = _He6IzILk;
        "pkg-1.16.1-2.6.15" = _2NCUTmsW;
        "pkg-1.16.4-2.6.15" = _pKQiOYLe;
        "pkg-1.17.1-2.6.15" = _XgiA5yWK;
        "pkg-1.18.1-2.6.15" = _sCcaaPB5;
        "pkg-1.18.2-2.6.15" = _96nDcCSh;
        "pkg-1.19-2.6.15" = _KOBmMoQY;
        "pkg-1.19.1-2.6.15" = _PWdKbWsL;
        "pkg-1.19.2-2.6.15" = _CFqKQmeU;
        "pkg-1.19.3-2.6.15" = _9ayljarM;
        "pkg-1.19.4-2.6.15" = _jkL57SOi;
        "pkg-1.20.1-2.6.15" = _MEAiQjrL;
        "pkg-1.20.2-2.6.15" = _XeL4fIxn;
        "pkg-1.20.4-2.6.15" = _TGJXKoTQ;
        "pkg-1.8.9-2.6.16" = _PnVE9Yd3;
        "pkg-1.20.1-2.6.16" = _ucF2Q5TJ;
        "pkg-1.20.2-2.6.16" = _6ZmBDE80;
        "pkg-1.20.4-2.6.16" = _LzxB2cOe;
        "pkg-1.20.6-2.6.16" = _Og7hVF1A;
        "pkg-1.21-2.6.16" = _NtlpUQgI;
        "pkg-1.8.9-2.6.17" = _1nnPSKhK;
        "pkg-1.20.1-2.6.17" = _nsLkChBp;
        "pkg-1.20.2-2.6.17" = _fww5QoQg;
        "pkg-1.20.4-2.6.17" = _RyKCdJN6;
        "pkg-1.20.6-2.6.17" = _J7VwKw9U;
        "pkg-1.21-2.6.17" = _yn3njhcI;
        "pkg-1.20.2-2.6.18" = _ENh1vals;
        "pkg-1.20.4-2.6.18" = _l7AlcGmT;
        "pkg-1.8.9-2.6.19" = _iSXLvUkz;
        "pkg-1.9.4-2.6.19" = _qeFvhCLE;
        "pkg-1.10.2-2.6.19" = _jTKqFXza;
        "pkg-1.11-2.6.19" = _76dEotM3;
        "pkg-1.11.2-2.6.19" = _hwXxYg4z;
        "pkg-1.12-2.6.19" = _RL70rBCY;
        "pkg-1.12.1-2.6.19" = _gMjrgnpO;
        "pkg-1.12.2-2.6.19" = _ZGSaakII;
        "pkg-1.14.4-2.6.19" = _64FAsc99;
        "pkg-1.15.2-2.6.19" = _kHX4cvGm;
        "pkg-1.16.1-2.6.19" = _bhAjlci5;
        "pkg-1.16.4-2.6.19" = _NnBugVkX;
        "pkg-1.17.1-2.6.19" = _O6IQy4aH;
        "pkg-1.18.1-2.6.19" = _qDtewQeI;
        "pkg-1.18.2-2.6.19" = _UCAAQNQz;
        "pkg-1.19-2.6.19" = _s1FeCCtc;
        "pkg-1.19.1-2.6.19" = _38ggnwim;
        "pkg-1.19.2-2.6.19" = _ZLTMAymx;
        "pkg-1.19.3-2.6.19" = _zT5bl27K;
        "pkg-1.19.4-2.6.19" = _PXH6TMMQ;
        "pkg-1.20.1-2.6.19" = _jax1ffrh;
        "pkg-1.20.2-2.6.19" = _fwkCpwG5;
        "pkg-1.20.4-2.6.19" = _7bUlr66G;
        "pkg-1.20.6-2.6.19" = _auai8ouQ;
        "pkg-1.21-2.6.19" = _3JKfe0Pj;
        "pkg-1.8.9-2.6.20" = _OJEjSBv2;
        "pkg-1.9.4-2.6.20" = _nK432C89;
        "pkg-1.10.2-2.6.20" = _cm3efXMy;
        "pkg-1.11-2.6.20" = _ifx7Ir86;
        "pkg-1.11.2-2.6.20" = _YdJN9dDJ;
        "pkg-1.12-2.6.20" = _f2zQZ0eY;
        "pkg-1.12.1-2.6.20" = _swVTBbTr;
        "pkg-1.12.2-2.6.20" = _5dHIcyhh;
        "pkg-1.14.4-2.6.20" = _ntyGbE9d;
        "pkg-1.15.2-2.6.20" = _uFRqSQGa;
        "pkg-1.16.1-2.6.20" = _vfpKdLlR;
        "pkg-1.16.4-2.6.20" = _9iPcalHg;
        "pkg-1.17.1-2.6.20" = _eEpyRLt9;
        "pkg-1.18.1-2.6.20" = _rmHt4NGt;
        "pkg-1.18.2-2.6.20" = _wYI49a9I;
        "pkg-1.19-2.6.20" = _LmEpViS9;
        "pkg-1.19.1-2.6.20" = _5ZMkd4VX;
        "pkg-1.19.2-2.6.20" = _zuIEL7KE;
        "pkg-1.19.3-2.6.20" = _J62gi8Wn;
        "pkg-1.19.4-2.6.20" = _YUyZQ5MV;
        "pkg-1.20.1-2.6.20" = _2VRL4210;
        "pkg-1.20.2-2.6.20" = _4f3thwUq;
        "pkg-1.20.4-2.6.20" = _yonzsJcJ;
        "pkg-1.20.6-2.6.20" = _QFFl4quX;
        "pkg-1.21-2.6.20" = _817Sc9Lc;
        "pkg-1.21.2-2.6.20" = _wTU7fLyE;
        "pkg-1.21.2-2.6.21" = _ItjtwiYA;
        "pkg-1.21.4-2.6.21" = _WuFr3FrM;
        "pkg-1.21.5-2.6.22" = _7DrS5dcr;
        "pkg-1.20.1-2.6.23" = _ReB0T2tK;
        "pkg-1.20.2-2.6.23" = _2Cnw5W77;
        "pkg-1.20.4-2.6.23" = _hrlr9DkQ;
        "pkg-1.20.6-2.6.23" = _4aanuSCT;
        "pkg-1.21-2.6.23" = _Ebft1Ejk;
        "pkg-1.21.2-2.6.23" = _kRKLQ6SQ;
        "pkg-1.21.4-2.6.23" = _Ax2S4lln;
        "pkg-1.21.5-2.6.23" = _PimUhTNX;
        "pkg-1.21.7-2.6.23" = _TUHG3lET;
        "pkg-1.8.9-2.6.24" = _BBUuSZWF;
        "pkg-1.9.4-2.6.24" = _vTp54CAP;
        "pkg-1.10.2-2.6.24" = _k5uktnRF;
        "pkg-1.11-2.6.24" = _1WAQlvOX;
        "pkg-1.11.2-2.6.24" = _DUrQJx9N;
        "pkg-1.12-2.6.24" = _l6tW9HIW;
        "pkg-1.12.1-2.6.24" = _ymUdjLH7;
        "pkg-1.12.2-2.6.24" = _V8x1l1js;
        "pkg-1.21.10-2.6.24" = _Xl13rxnj;
        "pkg-1.21.10-2.6.25" = _lwciuNZ7;
        "pkg-1.21.11-2.6.25" = _lrnVIO9F;
        "pkg-1.21.11-2.6.26" = _xdCLTfkG;
        "pkg-26.1-2.6.26" = _EJsN8H1o;
        "pkg-1.21-2.6.27" = _YQ20Mjid;
        "pkg-1.21.5-2.6.27" = _UesOWh7M;
        "pkg-1.21.7-2.6.27" = _FD6Qzce2;
        "pkg-1.21.10-2.6.27" = _SWtV2omv;
        "pkg-1.21.11-2.6.27" = _LcmLujKZ;
        "pkg-26.1-2.6.27" = _EJmaQGbB;
        "pkg-26.2-2.6.27" = _5YS1OgDP;
        "default" = _5YS1OgDP;
    });
