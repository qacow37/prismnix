...
let
    ...
    in {
        ...
        "pkg-0.8.0" = _Vxtkl48a;
        "pkg-0.9.1" = _iYkjHbiQ;
        "pkg-0.10.0" = _RazfrgDX;
        "pkg-0.11.0" = _RbPgaffr;
        "pkg-0.12.0" = _iPwNBoLf;
        "pkg-0.13.0" = _2rkqVBqC;
        "pkg-0.13.1" = _gtob8ckK;
        "pkg-0.14.0" = _wCCxw3Fg;
        "pkg-0.14.1" = _WaW20ZAl;
        "pkg-0.14.2" = _sflJi0vq;
        "pkg-0.14.3" = _TsbKEWev;
        "pkg-0.14.4" = _qSc3hAzI;
        "pkg-0.14.5" = _GSHu1VV7;
        "pkg-0.14.6" = _Np2aiJZy;
        "pkg-0.14.7" = _OBa3JvgV;
        "pkg-0.14.8" = _9ubLNIze;
        "pkg-0.15.0" = _Zvtld7JN;
        "default" = _Zvtld7JN;
    });
