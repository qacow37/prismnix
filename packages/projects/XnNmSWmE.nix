...
let
    ...
    in {
        ...
        "pkg-0.6.29" = _DbDo61AU;
        "pkg-0.6.30" = _MglsMHwK;
        "pkg-0.6.31" = _z3L4KEKv;
        "pkg-0.6.32" = _loPJhN06;
        "pkg-0.7.0" = _d6FOZJE6;
        "pkg-0.7.1" = _2BK1WzAm;
        "pkg-0.7.2" = _pD65guD9;
        "pkg-0.7.3" = _5Q1JrfiU;
        ...
        "pkg-0.9.8" = _YkaUVr6O;
        "pkg-0.9.9" = _kgV5X6Xt;
        "pkg-0.10.0" = _HHa8oZlK;
        "pkg-0.10.1" = _9WpEq8q8;
        "pkg-0.10.2" = _Uhb07KPK;
        "pkg-0.10.3" = _UTpnz6Pi;
        "pkg-0.10.4" = _5z7QzYW7;
        "pkg-0.10.5" = _PRBaJ8DX;
        "pkg-0.10.6" = _BdHrdSjd;
        "pkg-0.10.7" = _pDu34HNo;
        "default" = _pDu34HNo;
    });
