...
let
    ...
    in {
        ...
        "pkg-v.1.0.1+mod" = _U8u8pogR;
        "pkg-v2.0.0" = _kfXtuokk;
        "pkg-v2.0.0+mod" = _OnEj6NNs;
        "pkg-v2.0.1" = _qHRBh3Qz;
        "pkg-v2.0.1+mod" = _4Emi3J4z;
        "pkg-v2.0.1.1" = _glXwniR3;
        "pkg-v2.0.1.1+mod" = _j6Ag2vaq;
        "pkg-v2.1.0" = _61sryznu;
