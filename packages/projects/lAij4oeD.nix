...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.19.4-FABRIC" = _tvP8HHKK;
        "pkg-1.0.0-1.19.4-FORGE" = _G3eVpTXn;
        "pkg-1.1.0" = _xURVhjdb;
        "pkg-1.2.0" = _cZvA1a2U;
        "pkg-1.19.2" = _fRSY0JPB;
        "pkg-1.3.0" = _OUb7Uj8f;
        "pkg-1.4.0" = _8uT8hDb3;
        "pkg-1.4.1" = _IPxo0uhH;
        "pkg-1.4.2" = _ulsTXwyB;
        "pkg-1.4.3" = _JGAo9qEX;
        "pkg-1.4.4-rc1" = _vZJDm5Gv;
        "pkg-1.4.4" = _GHKZ96kk;
        "pkg-1.5.0" = _qI4nkLdu;
        "pkg-1.5.1" = _bTBjY9tL;
        "pkg-1.5.2" = _mHuFf6x1;
        ...
        "pkg-1.5.4" = _MGLzsNs9;
        "pkg-1.5.5" = _d0OlgjGU;
        "pkg-1.6.0-BETA-1" = _Nk7HaGMZ;
        "pkg-1.6.0.beta.2-1.21.1-NeoForge" = _fIqNewjP;
        "pkg-1.6.0.beta.2-1.21.1-Fabric" = _fhXfKE3D;
        "pkg-1.6.0.beta.3-1.21.1-Fabric" = _Jv86e2gz;
        "pkg-1.6.0.beta.3-1.21.1-NeoForge" = _5murmAC5;
        "pkg-1.6.0.beta.4-1.21.1-Fabric" = _PUxGRV6J;
        "pkg-1.6.0.beta.4-1.21.1-NeoForge" = _2r8pTYWh;
        "pkg-1.6.0.beta.5-1.21.1-Fabric" = _OoJBTalu;
        "pkg-1.6.0.beta.5-1.21.1-NeoForge" = _sXXc7cYk;
        "pkg-1.6.0.beta.6-26.1.2-Fabric" = _9lr3FAZq;
        "pkg-1.6.0.beta.6-26.1.2-NeoForge" = _PZHtYW3d;
        "pkg-1.6.0.beta.7-26.1.2-Fabric" = _YBZM0S0f;
        "pkg-1.6.0.beta.7-26.1.2-NeoForge" = _5pzVqzgj;
        "pkg-1.6.0.beta.8-26.1.2-Fabric" = _1NYfiuXg;
        "pkg-1.6.0.beta.8-26.1.2-NeoForge" = _mBgAxpnf;
        "pkg-1.6.0.beta.9-26.1.2-Fabric" = _atcKd03v;
        "pkg-1.6.0.beta.9-26.1.2-NeoForge" = _wKJrDlYp;
        "pkg-1.6.0.beta.10-26.1.2-Fabric" = _rJWUMB7I;
        "pkg-1.6.0.beta.10-26.1.2-NeoForge" = _KOc0rBgj;
        "pkg-1.6.0.beta.11-26.1.2-Fabric" = _PbZNev6L;
        "pkg-1.6.0.beta.11-26.1.2-NeoForge" = _1Jiu0mrS;
        "default" = _1Jiu0mrS;
    });
