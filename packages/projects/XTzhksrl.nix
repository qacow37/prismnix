...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.1" = _LLRJgKWZ;
        "pkg-1.0.0+1.17" = _rHiWPfdt;
        "pkg-1.0.0+1.19.3" = _BNz4ZSpe;
        "pkg-1.0.0+1.20" = _cNJZxDEp;
        "pkg-1.0.1+1.20" = _zqvsbRiE;
        "pkg-1.0.1+1.19.3" = _6jUTqtAr;
        "pkg-1.0.1+1.17" = _Le6DBjgs;
        "pkg-1.1.0+1.20" = _Y6aFbGpB;
        "pkg-1.1.0+1.20.2" = _G5Ygxtja;
        "pkg-1.1.0+1.20.3" = _mGFrQ12I;
        "pkg-1.1.1+1.20" = _FVhZg62f;
        "pkg-1.1.1+1.20.2" = _xcCoQVuL;
        "pkg-1.1.1+1.20.3" = _PBqAvlE4;
        "pkg-1.1.1+1.21" = _cJvWVRk7;
        "pkg-1.1.2+1.21" = _YuMpQk45;
        "pkg-1.1.3+1.20" = _SPjSF1wQ;
        "pkg-1.1.3+1.21" = _rxTF6lYq;
        "pkg-1.1.4+1.21" = _XcrG7txD;
        "pkg-1.1.4+1.20" = _lBVgOgVQ;
        "pkg-1.1.5+1.21" = _gxODptv0;
        "pkg-1.1.5+1.20" = _3CHQaaxS;
        "pkg-1.1.6" = _FCBQ6H1W;
        "pkg-1.2.0" = _o1MgrmED;
        "pkg-1.2.1" = _Y1jMq95C;
        "default" = _Y1jMq95C;
