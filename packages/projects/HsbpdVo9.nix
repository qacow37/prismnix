...
let
    ...
    in {
        ...
        "pkg-3.0.7" = _GxPN72Ck;
        "pkg-3.0.8" = _Mz96FmGJ;
        "pkg-4.0.0-beta" = _SalaYuqQ;
        "pkg-4.0.1-beta" = _6TZgUsbE;
        "pkg-4.0.2-beta" = _KXzHVmH2;
        "pkg-4.0.3-beta" = _gO9lkc02;
        "pkg-4.0.4-beta" = _X46ERTWH;
        "pkg-4.0.5-beta" = _Mx812GJS;
        "pkg-3.1.0" = _tRIxAVY5;
        "pkg-3.1.1" = _T64Q20SK;
        "pkg-4.0.6-beta" = _Npr8Ea0K;
        "pkg-3.1.2" = _GV2wh437;
        "pkg-4.0.7-beta" = _rItQRW6f;
        "pkg-3.1.3" = _LHPczQdy;
        "pkg-3.1.4" = _J4pi7Ksm;
        "pkg-4.0.8-beta" = _6S1t46Ck;
        "pkg-4.0.9-beta" = _OCkp0LaX;
        "pkg-3.1.5" = _XUaETdsU;
        "pkg-4.0.10-beta" = _mhgjDapA;
        "pkg-3.1.6" = _v4cjAA39;
        "pkg-3.1.7" = _jhmthuny;
        "pkg-4.0.11-beta" = _bpy2D4NV;
        "pkg-3.1.8" = _xwniKV8R;
        "pkg-3.1.9" = _16EHRstg;
        "pkg-4.0.12-beta" = _MCxMdpBb;
        "pkg-3.1.10" = _PtkxtDUz;
        "pkg-4.0.13-beta" = _Fm858o8C;
        "pkg-3.1.11" = _giKkV2tC;
        "pkg-4.0.14-beta" = _kLGID72L;
        "pkg-3.1.12" = _QeN4e991;
        "pkg-3.1.13" = _vJuHbboy;
        "pkg-4.0.15-beta" = _DexVMylG;
        "pkg-4.1.0-beta" = _ExUtug4e;
        "pkg-4.1.1-beta" = _hJrDwGcS;
        "pkg-4.1.2-beta" = _lv17JgBt;
        "pkg-4.1.3-beta" = _bttF0K8a;
        "pkg-4.1.4-beta" = _kSbFGjzv;
        "pkg-4.1.5-beta" = _SaA6z3Ki;
        "pkg-4.1.6-beta" = _SaIlXq71;
        "pkg-4.1.7-beta" = _fRbMlCbb;
        "pkg-4.1.8-beta" = _ycwaHjLz;
        "pkg-4.1.9-beta" = _aX5SiuhQ;
        "pkg-4.2.0" = _yLx4tujJ;
        "pkg-4.2.1" = _EQXsxI4Q;
        "pkg-4.2.2" = _w4W9qydv;
        "pkg-4.2.3" = _1jq1BxHm;
