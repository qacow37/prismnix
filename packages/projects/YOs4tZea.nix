...
let
    ...
    in {
        ...
        "pkg-1.12.2-1.3" = _a9v9DVrs;
        "pkg-1.14.4-1.2" = _U8oZPM2i;
        "pkg-1.15.2-3.3" = _1MjMd5JQ;
        "pkg-1.16.5-2.0" = _j55cqS5o;
        "pkg-1.17.1-1.0.0" = _nk3edt8d;
        "pkg-1.18.2-1.0.1" = _OgYQ1cIL;
        "pkg-1.18.2-1.01" = _dA3OcjJp;
        "pkg-1.19-1.0.0" = _d0hqmtMB;
        "pkg-1.19.2-1.0.1" = _xsKfxEjV;
        "pkg-1.19.3-1.0.0" = _97VK4LV9;
        "pkg-1.19.2-1.0.2" = _OPV3tCmc;
        "pkg-1.19.3-1.0.1" = _iE9ThHSF;
        "pkg-1.18.2-1.0.2" = _NSE7MIsk;
        "pkg-1.16.5-2.1" = _SUmTg6CI;
        "pkg-1.19.4-1.0.0" = _KSU87mw3;
        "pkg-1.20.1-1.0.0" = _IBv83UmH;
        "pkg-1.16.5-2.1.1" = _Vo9wHAvY;
        "pkg-1.18.2-1.0.3" = _TxXppIhr;
        "pkg-1.19.4-1.0.1" = _gKleHSgv;
        "pkg-1.19.2-1.0.3" = _qFVE2XIB;
        "pkg-1.20.1-1.0.1" = _laTdPpfY;
        "pkg-1.20.2-1.0.0" = _uBEbmUA6;
        "pkg-1.20.4-1.0.0" = _QcZyBQCW;
        "pkg-1.20.6-1.0.0" = _FFkXsuHY;
        "pkg-1.21.1-1.0.0" = _7GkLlQ2E;
        "pkg-1.21.1-1.0.1" = _LheqdhBz;
        "pkg-1.21.3-1.0.0" = _MX3fF2l9;
        "pkg-1.20.1-1.1.0" = _5EPykJTE;
        "pkg-1.21.1-1.1.0" = _bmbePf3v;
        "pkg-1.21.1-1.1.1" = _Oyuu70nA;
        "pkg-1.21.1-2.0.0" = _ktoYDrKP;
        "pkg-1.21.1-2.0.1" = _73U02HbA;
        "pkg-1.21.3-2.0.0" = _78NMpzH5;
        "pkg-1.21.4-1.0.0" = _gaLdWe0T;
        "pkg-1.21.5-1.0.0" = _z790Na31;
        "pkg-1.21.4-1.0.1" = _NvWiN2lp;
        "pkg-1.21.5-1.0.1" = _zX6GeoOz;
        "pkg-1.21.8-1.0.0" = _8xvQYoyr;
        "pkg-1.21.10-1.0.0" = _a4a4NBcF;
        "pkg-1.21.11-1.0.0" = _70lSAUR3;
        "pkg-1.21.8-1.0.1" = _msanydjP;
        "pkg-1.21.10-1.0.1" = _EaWv7NyH;
        "pkg-1.21.11-1.0.1" = _TgH7cIOE;
        "pkg-26.1.2-1.0.0" = _Lf0ODGD6;
        "pkg-26.2-1.0.0" = _GMbSzBYK;
        "pkg-1.20.1-2.0.0" = _lK1v231e;
        "default" = _lK1v231e;
    });
