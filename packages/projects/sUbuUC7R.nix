...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0.0.0-NEOFORGE" = _UXmrem1t;
        "pkg-1.20.6-1.0.0.0-FABRIC" = _6qGRFhVN;
        "pkg-1.20.6-1.0.0.0-NEOFORGE" = _tliGO5w3;
        "pkg-1.21-1.0.0.0-FABRIC" = _ImA0ID0r;
        "pkg-1.21-1.0.0.0-NEOFORGE" = _i7VZPAtk;
        "pkg-1.20.1-1.1.0.0-FABRIC" = _LPbbMlwg;
        "pkg-1.20.1-1.1.0.0-FORGE" = _oGrTbEVp;
        "pkg-1.20.4-1.1.0.0-FABRIC" = _lvWkYWaG;
        "pkg-1.20.4-1.1.0.0-NEOFORGE" = _ARWKK4Ki;
        "pkg-1.20.6-1.1.0.0-FABRIC" = _mil7nzvl;
        "pkg-1.20.6-1.1.0.0-NEOFORGE" = _VyL3K2MD;
        "pkg-1.21-1.1.0.0-FABRIC" = _6zXBvv7n;
        "pkg-1.21-1.1.0.0-NEOFORGE" = _cOrBwHpl;
        "pkg-1.21-1.1.0.1-FABRIC" = _77082PNK;
        "pkg-1.21-1.1.0.1-NEOFORGE" = _e9NK9Y8O;
        "pkg-1.20.4-1.1.0.1-FABRIC" = _PlxFUgn6;
        "pkg-1.20.4-1.1.0.1-NEOFORGE" = _DWNrrscN;
        "pkg-1.20.1-1.1.0.1-FABRIC" = _gcKdfFjF;
        "pkg-1.20.1-1.1.0.1-FORGE" = _4NPfg8Vr;
        "pkg-1.20.1-1.1.0.2-FABRIC" = _BVwUqxAA;
        "pkg-1.20.1-1.1.0.2-FORGE" = _O2y8BhUM;
        "pkg-1.20.4-1.1.0.2-FABRIC" = _cOcrG9Px;
        "pkg-1.20.4-1.1.0.2-NEOFORGE" = _F5mAp2NC;
        "pkg-1.20.6-1.1.0.2-FABRIC" = _vEf3zCX1;
        "pkg-1.20.6-1.1.0.2-NEOFORGE" = _ns1lMiX6;
        "pkg-1.21-1.1.0.2-NEOFORGE" = _6qkEiKDl;
        "pkg-1.21-1.1.0.2-FABRIC" = _vYenJl50;
        "pkg-1.21.1-1.1.0.2-FABRIC" = _K6ymvYzJ;
        "pkg-1.21.1-1.1.0.2-NEOFORGE" = _9kbyGLlW;
        "pkg-1.20.1-1.1.0.3-FABRIC" = _pjh1aZPj;
        "pkg-1.20.1-1.1.0.3-FORGE" = _jzWXllrh;
        "pkg-1.20.4-1.1.0.3-FABRIC" = _4gogawio;
        "pkg-1.20.4-1.1.0.3-NEOFORGE" = _wcs7Nue0;
        "pkg-1.20.6-1.1.0.3-FABRIC" = _schwEf9A;
        "pkg-1.20.6-1.1.0.3-NEOFORGE" = _86bts9zT;
        "pkg-1.21.1-1.1.0.3-FABRIC" = _RnXDNJ6k;
        "pkg-1.21.1-1.1.0.3-NEOFORGE" = _LgTa1C5T;
        "pkg-1.21.1-1.1.0.4-FABRIC" = _jmLIUP52;
        "pkg-1.21.1-1.1.0.4-NEOFORGE" = _oaqDLcQw;
        "pkg-1.20.1-1.1.0.4-FABRIC" = _nEH7vpXt;
        "pkg-1.20.1-1.1.0.4-FORGE" = _g7kWFLHn;
        "pkg-1.20.6-1.1.0.4-FABRIC" = _1gCGhDsm;
        "pkg-1.20.6-1.1.0.4-NEOFORGE" = _YRBX6tjy;
        "pkg-1.21.1-1.1.0.5-FABRIC" = _7wUFPpzk;
        "pkg-1.21.1-1.1.0.5-NEOFORGE" = _kXETEMHW;
        "pkg-1.20.1-1.1.0.5-FABRIC" = _U6UYDXpd;
        "pkg-1.20.1-1.1.0.5-FORGE" = _55QBsO5I;
        "pkg-1.20.4-1.1.0.5-FABRIC" = _aAMB2CID;
        "pkg-1.20.4-1.1.0.5-NEOFORGE" = _h7y1PUVE;
        "pkg-1.20.6-1.1.0.5-FABRIC" = _UWr0THSZ;
        "pkg-1.20.6-1.1.0.5-NEOFORGE" = _wP6OEcy6;
        "pkg-1.21.1-1.1.0.6-FABRIC" = _bz1c2jIx;
        "pkg-1.21.1-1.1.0.6-NEOFORGE" = _4yY53MvB;
        "pkg-1.20.1-1.1.0.9-FABRIC" = _DQ5A3jlg;
        "pkg-1.20.1-1.1.0.9-FORGE" = _CTVOdbqC;
        "pkg-1.20.4-1.1.0.9-FABRIC" = _cPXKl6F3;
        "pkg-1.20.4-1.1.0.9-NEOFORGE" = _RH51IiaV;
        "pkg-1.20.6-1.1.0.9-FABRIC" = _fKk6P1SY;
        "pkg-1.20.6-1.1.0.9-NEOFORGE" = _Jbbm0Pw2;
        "pkg-1.21.1-1.1.0.9-FABRIC" = _YifVDmjS;
        "pkg-1.21.1-1.1.0.9-NEOFORGE" = _p71qq2M0;
        "pkg-1.21.1-1.1.1.0-FABRIC" = _rh1R1HPE;
        "pkg-1.21.1-1.1.1.0-NEOFORGE" = _hq3nMuvg;
        "pkg-1.21.1-1.1.1.1-FABRIC" = _QEmaRn9o;
        "pkg-1.21.1-1.1.1.1-NEOFORGE" = _O3DMBKvT;
        "pkg-1.21.3-1.1.1.1-FABRIC" = _U1OTnPcv;
        "pkg-1.21.3-1.1.1.1-NEOFORGE" = _eAFdmSpQ;
        "pkg-1.21.4-1.1.1.1-FABRIC" = _rRVnILQO;
        "pkg-1.21.4-1.1.1.1-NEOFORGE" = _mVGlmVMU;
        "pkg-1.20.1-1.1.2.1-FABRIC" = _93EFWhvP;
        "pkg-1.20.1-1.1.2.1-FORGE" = _wmHaqEq1;
        "pkg-1.21.1-1.1.2.1-FABRIC" = _uMWPcwbK;
        "pkg-1.21.1-1.1.2.1-NEOFORGE" = _3P9U1Bnk;
        "pkg-1.21.4-1.1.2.1-NEOFORGE" = _vD6ejkvp;
        "pkg-1.21.4-1.1.2.1-FABRIC" = _pTmCurj7;
        "pkg-1.20.1-1.1.3.1-FABRIC" = _ft87fXPa;
        "pkg-1.20.1-1.1.3.1-FORGE" = _U0P9RdjX;
        "pkg-1.21.1-1.1.3.1-FABRIC" = _wMxSw6pk;
        "pkg-1.21.1-1.1.3.1-NEOFORGE" = _aSWyinUv;
        "pkg-1.21.4-1.1.3.1-FABRIC" = _LZ48h615;
        "pkg-1.21.4-1.1.3.1-NEOFORGE" = _pyG0SdZM;
        "pkg-1.21.5-1.1.3.1-FABRIC" = _xh5gJcTc;
        "pkg-1.21.5-1.1.3.1-NEOFORGE" = _8PXKlcr9;
        "pkg-1.21.8-1.1.3.1-FABRIC" = _SBmlBcZL;
        "pkg-1.21.8-1.1.3.1-NEOFORGE" = _iHi6IlV7;
        "pkg-1.21.1-1.1.3.2-FABRIC" = _Xci37zE9;
        "pkg-1.21.1-1.1.3.2-NEOFORGE" = _Rhj0L6yL;
        "pkg-1.20.1-1.1.3.2-FABRIC" = _XMpoAX4T;
        "pkg-1.20.1-1.1.3.2-FORGE" = _ysgQSwie;
        "pkg-1.21.8-1.1.4.0-FABRIC" = _haHFhzPH;
        "pkg-1.21.8-1.1.4.0-NEOFORGE" = _7TECOEnw;
        "pkg-1.21.8-1.1.4.1-FABRIC" = _JXL73YE4;
        "pkg-1.21.8-1.1.4.1-NEOFORGE" = _Gcqu4rJ0;
        "pkg-1.20.1-1.1.3.3-FABRIC" = _or7ZGvms;
        "pkg-1.20.1-1.1.3.3-FORGE" = _JpqQaAFL;
        "pkg-1.21.1-1.1.3.3-FABRIC" = _bsfGQH7O;
        "pkg-1.21.1-1.1.3.3-NEOFORGE" = _oqvGSyfm;
        "pkg-1.21.8-1.1.4.3-FABRIC" = _Cdp3kdTS;
        "pkg-1.21.8-1.1.4.3-NEOFORGE" = _ZpcB0H2K;
        "pkg-1.20.1-1.1.3.4-FABRIC" = _iUXla7lR;
        "pkg-1.20.1-1.1.3.4-FORGE" = _zpOi6Ilb;
        "pkg-1.20.1-1.1.3.5-FABRIC" = _FQLCFP25;
        "pkg-1.20.1-1.1.3.5-FORGE" = _WVRTCgeb;
        "pkg-1.21.1-1.1.3.5-FABRIC" = _t1vHloQE;
        "pkg-1.21.1-1.1.3.5-NEOFORGE" = _BecDPLtX;
        "pkg-1.21.8-1.1.4.5-FABRIC" = _uPYEbOAd;
        "pkg-1.21.8-1.1.4.5-NEOFORGE" = _jeudoNbw;
        "pkg-1.20.1-1.1.3.6-FABRIC" = _OkqorgLZ;
        "pkg-1.20.1-1.1.3.6-FORGE" = _UPM2iGvS;
        "pkg-1.21.1-1.1.3.6-FABRIC" = _oIGvlmZq;
        "pkg-1.21.1-1.1.3.6-NEOFORGE" = _kmrFUO7H;
        "pkg-1.21.8-1.1.4.6-FABRIC" = _iPKZptIF;
        "pkg-1.21.8-1.1.4.6-NEOFORGE" = _fd0bh1UK;
        "pkg-1.21.9-1.1.4.6-FABRIC" = _Jn0qbGpy;
        "pkg-1.21.9-1.1.4.6-NEOFORGE" = _xunznFoO;
        "pkg-1.21.1-1.1.3.7-FABRIC" = _H1H8rOot;
        "pkg-1.21.1-1.1.3.7-NEOFORGE" = _LMXXMl5J;
        "pkg-1.21.9-1.1.4.7-FABRIC" = _9sgaOCSE;
        "pkg-1.21.9-1.1.4.7-NEOFORGE" = _ySYWsVrX;
        "pkg-1.21.10-1.1.4.7-FABRIC" = _WR9YQeZy;
        "pkg-1.21.10-1.1.4.7-NEOFORGE" = _CxJ6FEm1;
        "pkg-1.21.1-1.1.5.0-FABRIC" = _eZqUhwr6;
        "pkg-1.21.1-1.1.5.0-NEOFORGE" = _yMDQS083;
        "pkg-1.21.10-1.1.5.0-FABRIC" = _kNbQ7Wma;
        "pkg-1.21.10-1.1.5.0-NEOFORGE" = _zdgu6OTv;
        "pkg-1.21.1-1.1.6.0-FABRIC" = _TCHQ8W5V;
        "pkg-1.21.1-1.1.6.0-NEOFORGE" = _PSqND6Rc;
        "pkg-1.21.10-1.1.6.0-FABRIC" = _AMz2i7Co;
        "pkg-1.21.10-1.1.6.0-NEOFORGE" = _Mr59guIh;
        "pkg-1.21.1-1.1.6.1-FABRIC" = _1gxG87qR;
        "pkg-1.21.1-1.1.6.1-NEOFORGE" = _wJ29EMkN;
        "pkg-1.21.10-1.1.6.1-FABRIC" = _54QvFZkA;
        "pkg-1.21.10-1.1.6.1-NEOFORGE" = _C9i5lKZM;
        "pkg-1.20.1-1.1.3.7-FABRIC" = _DNnKYa9z;
        "pkg-1.20.1-1.1.3.7-FORGE" = _Ps2oNnKu;
        "pkg-1.21.1-1.1.6.2-FABRIC" = _nHa9DUlW;
        "pkg-1.21.1-1.1.6.2-NEOFORGE" = _uKBTXPej;
        "pkg-1.21.10-1.1.6.2-FABRIC" = _rMp7ekW0;
        "pkg-1.21.10-1.1.6.2-NEOFORGE" = _QnQA7DlL;
        "pkg-1.21.11-1.1.6.2-FABRIC" = _acoz8pEK;
        "pkg-1.21.11-1.1.6.2-NEOFORGE" = _ZdKVctts;
        "pkg-1.20.1-1.1.4.0-FABRIC" = _Xk06pIkO;
        "pkg-1.20.1-1.1.4.0-FORGE" = _MPzbQXwU;
        "pkg-1.21.1-1.1.7.0-FABRIC" = _dEB8Mohm;
        "pkg-1.21.1-1.1.7.0-NEOFORGE" = _Zai88OLo;
        "pkg-1.21.10-1.1.7.0-FABRIC" = _Ghw2H3Nq;
        "pkg-1.21.10-1.1.7.0-NEOFORGE" = _rGkBOdmV;
        "pkg-1.21.11-1.1.7.0-FABRIC" = _dZkaUZRz;
        "pkg-1.21.11-1.1.7.0-NEOFORGE" = _URVEd2of;
        "pkg-26.1.1-1.1.7.0-FABRIC" = _HUPQyupP;
        "pkg-26.1.1-1.1.7.0-NEOFORGE" = _pMwV6vKq;
        "pkg-26.1.1-1.1.7.1-FABRIC" = _JwANHpOd;
        "pkg-26.1.1-1.1.7.1-NEOFORGE" = _Aj91zdBX;
        "pkg-26.1.2-1.1.7.1-FABRIC" = _OsvFiAZs;
        "pkg-26.1.2-1.1.7.1-NEOFORGE" = _31JDGtkw;
        "pkg-26.1.2-1.1.7.2-FABRIC" = _BQBvIPkf;
        "pkg-26.1.2-1.1.7.2-NEOFORGE" = _RiDh81eN;
        "pkg-1.21.1-1.1.7.2-FABRIC" = _nXKz08Ds;
        "pkg-1.21.1-1.1.7.2-NEOFORGE" = _9AVInV6R;
        "pkg-1.21.1-1.1.7.4-FABRIC" = _vf4c2AK1;
        "pkg-1.21.1-1.1.7.4-NEOFORGE" = _7lG8zrYh;
        "pkg-26.1.2-1.1.7.4-FABRIC" = _s88A4zeo;
        "pkg-26.1.2-1.1.7.4-NEOFORGE" = _ThbYIlWW;
        "pkg-26.1.2-1.1.7.5-FABRIC" = _jrbspLaA;
        "pkg-26.1.2-1.1.7.5-NEOFORGE" = _75cVYNpX;
        "pkg-1.21.1-1.1.7.5" = _nSxh1tlc;
        "pkg-1.21.1-1.1.7.5-NEOFORGE" = _aVi218wg;
        "pkg-1.21.1-1.1.7.6" = _Mt3M3nLx;
        "pkg-1.21.1-1.1.7.6-NEOFORGE" = _RHzgvawa;
        "pkg-26.1.2-1.1.7.6-FABRIC" = _tSEFnno8;
