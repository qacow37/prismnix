...
let
    ...
    in {
        ...
        "pkg-9.0.2" = _ZuJD8Iui;
        "pkg-9.0.3" = _eWR5j0Rw;
        "pkg-10.0.2" = _4ibIqsNC;
        "pkg-10.0.3" = _MsIt0Fn6;
        "pkg-11.0.1" = _81H607Ox;
        "pkg-11.0.2" = _bBsgAglB;
        "pkg-11.0.3" = _jtQpb6G3;
        "pkg-11.0.4" = _qoZ4MkLW;
        "pkg-12.0.1" = _RA5UXPgA;
        "pkg-13.0.1" = _GKntE5qY;
        "pkg-13.1.2" = _Rbtbi1iR;
        "pkg-14.0.1" = _jJGpL5Dr;
        "pkg-15.0.1" = _2YRMYH9r;
        "pkg-16.0.1" = _a6y24zqI;
        "pkg-17.0.1" = _mJznpCLu;
        "pkg-18.0.1" = _nc7rBudS;
        "pkg-19.0.1" = _3nf2zTDI;
        "pkg-19.0.2" = _ljyoVSiS;
        "pkg-19.0.3" = _nU5q0Vho;
        "pkg-20.0.1" = _3AY6aLGA;
        "pkg-20.0.2" = _TasAoN2w;
        "pkg-20.0.3" = _S6nXyPQU;
        "pkg-20.0.4" = _xoFDYo5b;
        "pkg-20.0.5" = _QFFMpptO;
        "pkg-20.0.6" = _fLKwebNi;
        "pkg-21.0.1" = _pHxXZ7H2;
        "pkg-22.0.1" = _1n4cOamu;
        "pkg-22.0.2" = _a6k6KnQl;
        "pkg-22.0.3" = _oEGZ9KTQ;
        "pkg-22.0.4" = _NpcfqYM3;
        "pkg-22.1.7" = _u8dasvWt;
        "pkg-19.0.4" = _x9NMb7rU;
        "pkg-21.1.1" = _Mviyd3ek;
        "pkg-21.1.2" = _zl8zPvMn;
        "pkg-21.1.3" = _JcYIPe4L;
        "pkg-21.1.4" = _n8VzIyJI;
        "pkg-21.1.5" = _Szobbnyh;
        "pkg-19.0.5" = _UFqjauYD;
        "default" = _UFqjauYD;
    });
