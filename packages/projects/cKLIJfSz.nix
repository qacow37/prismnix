...
let
    ...
    in {
        ...
        "pkg-1.16.5-0.4.1" = _IJbOxqsH;
        "pkg-1.18.2-0.4.1" = _7X8zywRb;
        "pkg-1.18.2-0.4.2" = _pTR8P89s;
        "pkg-1.18.2-0.4.3" = _JXczgMMP;
        "pkg-1.19.0-0.5.1" = _dQ7uTIV5;
        "pkg-1.18.2-0.5.2" = _BOTBmKyx;
        "pkg-1.19.0-0.5.3" = _XlqilWfO;
        "pkg-1.19.0-0.5.4" = _4NjXRHqe;
        "pkg-1.19.2-0.5.6" = _t0CffZ6W;
        "pkg-1.18.2-0.4.4" = _MaNr4LpR;
        "pkg-1.19.2-0.5.7" = _2fz4ZnYm;
        "pkg-1.19.2-v0.5.8" = _NSdcPS9F;
        "pkg-1.19.2-v0.5.11" = _aMNPMP9K;
        "pkg-1.19.3-v0.6.0" = _3zU3IJ8j;
        "pkg-1.19.3-v1.0.0" = _1vJaWbml;
        "pkg-1.19.3-v1.1.0-FIXED" = _wegonsSg;
        "pkg-1.19.3-v1.2.0" = _LUbBGu2u;
        "pkg-1.18.2-v0.4.5" = _U8IjGnJs;
        "pkg-1.19.3-v1.2.1" = _s9Q38qW0;
        "pkg-1.19.3-v1.3.0" = _OPlUCTSE;
        "pkg-1.18.2-v0.4.6" = _QDWkYgc2;
        "pkg-1.19.2-v0.5.12" = _sRnMJJLI;
        "pkg-1.19.3-v1.4.0" = _y6rlwHjQ;
        "pkg-1.19.4-v.1.5.0" = _frxme5OB;
        "pkg-1.19.4-v1.5.1" = _gahaxMoA;
        "pkg-1.19.3-v1.4.2" = _RjTBhkVe;
        "pkg-1.6.0" = _mgU1dA0x;
        "pkg-1.7.0" = _F4kAeD59;
        "pkg-1.7.1" = _msV2QL2J;
        "default" = _msV2QL2J;
