...
let
    ...
    in {
        ...
        "pkg-3.7.1+1.20.1" = _TjscZdC6;
        "pkg-3.7.2+1.20.1" = _ouGTmZwT;
        "pkg-3.7.3+1.20.1" = _QGOG9VtQ;
        "pkg-4.0.0-alpha.1+1.20.1" = _Hvmb1snX;
        "pkg-4.0.0-alpha.2+1.20.1" = _nSPEL7xq;
        "pkg-4.0.0-alpha.3+1.20.1" = _wuS39Psf;
        "pkg-4.0.0-alpha.4+1.20.1" = _NAxbuFfZ;
        "pkg-4.0.0-alpha.5+1.20.1" = _uJToAu7o;
        "pkg-4.0.0-alpha.6+1.20.1" = _MGqzGzgl;
        "pkg-4.0.0-alpha.7+1.20.1" = _kkPQ3cSE;
        "pkg-4.0.0+1.20.1-alpha.8" = _M0LGjUa5;
        "pkg-4.0.0+1.20.1-alpha.9" = _jdNLs6s1;
        "pkg-4.0.0+1.20.1-alpha.10" = _8NXRvcFe;
        "pkg-4.0.0+1.20.1-alpha.11" = _97egGA98;
        "pkg-4.0.0+1.20.1-alpha.12" = _xIFdB1vI;
        "pkg-4.0.0+1.20.1-alpha.13" = _ip351i5W;
        "pkg-4.0.0+1.20.1-alpha.14" = _OrmZD3Df;
        "pkg-4.0.0+1.20.1-beta.1" = _3WmAuRvj;
        "pkg-4.0.0+1.20.1-beta.2" = _JmwoL81R;
        "pkg-4.0.0+1.20.1-beta.3" = _ygNR0nFF;
        "pkg-4.0.0+1.20.1-beta.4" = _AGVbPmzt;
        "pkg-4.0.0+1.20.1-beta.5" = _ogWq6vVX;
        "pkg-4.0.0+1.20.1-beta.6" = _ulv06Clm;
        "pkg-4.0.0+1.20.1-beta.7" = _gM0iLa2P;
        "pkg-4.0.0+1.20.1-beta.8" = _Qjm4SJnp;
        "pkg-4.0.0+1.20.1-beta.9" = _9ThyerVT;
        "pkg-4.0.0+1.20.1-beta.10" = _mLvIuUur;
        "pkg-4.0.0+1.20.1-beta.11" = _hystFSYT;
        "pkg-4.0.0+1.20.1-beta.12" = _ZPcSwplT;
        "pkg-4.0.0+1.20.1" = _P6GLDxN9;
        "pkg-4.0.1+1.20.1" = _1FfpVjru;
        "pkg-4.0.2+1.20.1" = _D0jTfKs7;
