...
let
    ...
    in {
        ...
        "pkg-1.0" = _8Llj6VVc;
        "pkg-1.0+mod" = _CYP0dtJP;
        "pkg-1.1" = _sP5OI7Wr;
        "pkg-1.1+mod" = _NymeI9Wl;
        "pkg-1.2" = _YMoJcy36;
        "pkg-1.2+mod" = _oomkgfyz;
        "pkg-1.2.1" = _4vkNVssv;
        "pkg-1.2.1+mod" = _Fh3yOWoy;
        "pkg-1.2.2" = _5VpqFbLq;
        "pkg-1.2.2+mod" = _wGMQCt7p;
        "pkg-1.2.3" = _SqPoBx4h;
        "pkg-1.2.3+mod" = _HbCKfZ49;
        "pkg-1.2.4" = _4F3hIMs3;
        "pkg-1.2.4+mod" = _hVwyhhOC;
        "pkg-1.3" = _MEfGWwUY;
        "pkg-1.3+mod" = _I54Ckd57;
        "pkg-1.3.1" = _KBsruxPe;
        "pkg-1.3.1+mod" = _GCtPyVvW;
        "pkg-1.3.2" = _LfwmE8OP;
        "pkg-1.3.2+mod" = _DNADR4Dv;
        "pkg-1.4" = _h2tefmEI;
        "pkg-1.4+mod" = _ByF1ROSu;
        "pkg-1.5" = _v5oEly4W;
        "pkg-1.5+mod" = _zhO84Y5x;
        "pkg-1.5.1" = _LBqGc0EV;
        "pkg-1.5.1+mod" = _t9ONaNvL;
        "pkg-1.5.2" = _cngYD9kP;
        "pkg-1.5.2+mod" = _PmjQBmCi;
        "pkg-1.5.3" = _B6axxZSJ;
        "pkg-1.5.3+mod" = _W96NS0O0;
        "pkg-1.5.4" = _cKfLENH3;
        "pkg-1.5.4+mod" = _hpS7zCeA;
        "pkg-1.5.5" = _Sv8xP5bq;
        "pkg-1.5.5+mod" = _uXPbL6TJ;
        "pkg-1.6" = _y7K1HLjN;
        "pkg-1.6+mod" = _UqGJtD05;
        "pkg-1.6.1" = _2UIbkALX;
        "pkg-1.6.1+mod" = _EDyBd5rd;
        "pkg-1.6.2" = _WNOr88ht;
        "pkg-1.6.2+mod" = _1Ajwuvsk;
        "default" = _1Ajwuvsk;
    });
