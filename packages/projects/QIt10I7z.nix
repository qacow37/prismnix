...
let
    ...
    in {
        ...
        "pkg-1+mod" = _Y8fDTpiv;
        "pkg-1.1" = _sqYXceFm;
        "pkg-1.1+mod" = _rXFz7ljL;
        "pkg-v1.2" = _SoS3zxpO;
        "pkg-1.3" = _XrGaLF3D;
        "pkg-1.3+mod" = _NoewYvOT;
        "pkg-v1.4" = _zkP2X6qQ;
        "pkg-v1.4+mod" = _l3TVjkTB;
        "pkg-v2" = _jzAyspIV;
        "pkg-v2+mod" = _nq7sJLRQ;
        "pkg-v2.1" = _g55bF65W;
        "pkg-v2.1+mod" = _tO4j0uNM;
        "pkg-v2.2" = _nbVzJd9F;
        "pkg-v2.2+mod" = _4XIbhTdE;
        "pkg-v3" = _9oWkIZ94;
        "pkg-v3+mod" = _9i9QkTly;
        "pkg-v3.1" = _1s7bhI1f;
        "pkg-v3.1+mod" = _AdxRHQH1;
        "pkg-v3.2" = _IBRKxlrj;
        "pkg-v3.2+mod" = _4L3SijiI;
        "pkg-v3.2.1" = _mDlxERaY;
