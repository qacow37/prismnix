...
let
    ...
    in {
        ...
        "pkg-1.3.3" = _vMEaBCMf;
        "pkg-1.3.4" = _UluLKWwh;
        "pkg-1.3.4.1" = _257yyPKB;
        "pkg-1.3.5" = _UWWLZaO0;
        "pkg-1.3.6" = _GAIhj6Qy;
        "pkg-1.3.6.1" = _zjCV7Yqz;
        "pkg-1.3.7" = _KoFz8zzu;
        "pkg-1.3.8" = _FnU0qikT;
        "pkg-1.3.9" = _Nye20POW;
        "pkg-1.3.9.1" = _7x4JgTSn;
        "pkg-1.3.10" = _UjPVPVYZ;
        "pkg-1.3.11" = _cE8uU6On;
        "pkg-1.3.12" = _TvlqiWjt;
        "pkg-1.3.13" = _voBgTjjW;
        "pkg-1.3.14" = _1pNkIOQO;
        "pkg-1.4" = _Bf9YzEFY;
        "pkg-1.5" = _VqwvHx51;
        "pkg-1.5.1" = _siUWhOVQ;
        "pkg-1.5.2" = _sj0KzH8F;
