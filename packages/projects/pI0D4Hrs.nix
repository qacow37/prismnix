...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.5" = _sKfc2sEj;
        "pkg-1.19.2-1.5" = _eZQd7VgA;
        "pkg-1.20-1.5" = _l3Jw4bB5;
        "pkg-1.20-1.5.5" = _liPEzqex;
        "pkg-1.19.2-1.5.5" = _jpNQwnOl;
        "pkg-1.18.2-1.5.5" = _RFFCeCWj;
        "pkg-1.18.2-1.5.7" = _ID4ZUhnN;
        "pkg-1.19.2-1.5.7" = _jHG2Ttuo;
        "pkg-1.20-1.5.7" = _PBBAsb8K;
        "pkg-1.18.2-1.6" = _KPoWAnOt;
        "pkg-1.19.2-1.6" = _dW0pgHc4;
        "pkg-1.20-1.6" = _OnDD1OWL;
        "pkg-1.20.4-1.6" = _apOMcsfY;
        "pkg-1.18.2-1.6.1" = _DmvuBe8l;
        "pkg-1.19.2-1.6.1" = _jIVeMwKf;
        "pkg-1.20-1.6.1" = _Z54DvDb4;
        "pkg-1.20.4-1.6.1" = _QjlWRATm;
        "pkg-1.18.2-1.6.2" = _ctdMhMIG;
        "pkg-1.19.2-1.6.2" = _tPuGXj9B;
        "pkg-1.20-1.6.2" = _SF4R9eYn;
        "pkg-1.20.4-1.6.2" = _Jy6eQwfu;
        "pkg-1.18.2-1.6.3" = _oUkkAkm0;
        "pkg-1.19.2-1.6.3" = _FIEbCtZw;
        "pkg-1.20-1.6.3" = _6GDwTEml;
        "pkg-1.20.4-1.6.3" = _MgE5u4Ze;
        "pkg-1.20-1.6.4" = _yIYiuqQy;
        "pkg-1.20.4-1.6.4" = _bIKm15vJ;
        "pkg-1.19.2-1.6.4" = _8NzxxhgY;
        "pkg-1.18.2-1.6.4" = _N9yNZCxu;
        "pkg-1.19.2-1.7.0" = _LeoAu05K;
        "pkg-1.20-1.7.0" = _EINvQRkB;
        "pkg-1.20.4-1.7.0" = _3gOVGYti;
        "default" = _3gOVGYti;
    });
