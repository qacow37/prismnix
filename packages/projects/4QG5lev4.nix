...
let
    ...
    in {
        ...
        "pkg-3.25r" = _DMAVZOp7;
        "pkg-3.40r" = _rumPuPvT;
        "pkg-12.4.11" = _OABvRB8v;
        "pkg-43rf" = _gWopY5fi;
        "pkg-14.1.5" = _JRggLAqv;
        "pkg-15.2.3" = _jP3ulDR5;
        "pkg-16.2.5" = _UCBszajF;
        "pkg-16.4.10" = _itpEmHk0;
        "pkg-18.1.3" = _G6O62dCa;
        "pkg-18.2.4" = _OcdEhEqx;
        "pkg-19.3.10" = _cvck056Z;
        "pkg-19.5.10" = _ai8JkwNe;
        "pkg-20.0.1" = _etOcGxhk;
        "pkg-20.1.1" = _JPwsfpLd;
        "pkg-20.0.3" = _Ez9dKuZm;
        "pkg-20.1.2" = _KiLmf6d4;
        "pkg-20.1.3" = _pO6Z7fDG;
        "pkg-16.5.11" = _SsP0IyS8;
        "pkg-20.1.5" = _EzWdtRPH;
        "pkg-20.1.6" = _nj1BfCHe;
        "pkg-20.4.3" = _YMwT7HSU;
        "pkg-20.5.3" = _94Fo1Zb8;
        "pkg-19.3.11" = _K6I3zso0;
        "pkg-20.6.1" = _VcQHdsdr;
        "pkg-21.0.0" = _24Ya0uk0;
        "pkg-21.0.1" = _SFqAgjDW;
        "pkg-21.0.3" = _AcsLJetP;
        "pkg-21.0.4" = _JyuixHUa;
        "pkg-20.1.8" = _Plhbx7qG;
        "pkg-21.4.1" = _HHNokZi1;
        "pkg-20.1.10" = _ysGKNTCh;
        "pkg-20.1.11" = _bn1AYdI6;
        "pkg-21.4.2" = _BcEnJbH0;
        "pkg-21.0.5" = _L20mASfH;
        "pkg-21.0.6" = _x9thwHp2;
        "pkg-21.4.6" = _4tfvXLAz;
        "pkg-21.0.7" = _a8HCPTrR;
        "pkg-21.1.8" = _8aToYlt2;
        "default" = _8aToYlt2;
    });
