...
let
    ...
    in {
        ...
        "pkg-1.9.3.9" = _ZIFydKC9;
        "pkg-1.10.3" = _6ALf1eP8;
        "pkg-1.10.4" = _18TziSIh;
        "pkg-1.10.5" = _qgsP9gHo;
        "pkg-1.10.6" = _oWp1G2mZ;
        "pkg-1.10.7" = _RliFS3Qi;
        "pkg-1.10.7.1" = _aZQZum9m;
        "pkg-1.10.8" = _QYmpgL12;
        "pkg-1.10.9" = _BSpKX3kH;
        "pkg-1.10.10" = _nTxOwNeb;
        "pkg-1.10.11" = _c8HnJCcM;
        "pkg-1.10.12" = _NXKHyP6J;
        "pkg-1.10.13" = _zCryHJqs;
        "pkg-1.10.15" = _YndSdwjW;
        "pkg-1.11.0" = _ZDvO73ZI;
        "pkg-1.11.1" = _uB1nCEmm;
        "pkg-1.11.2" = _dbrBpAiK;
        "pkg-1.11.3" = _KzhxKeu1;
        "pkg-1.11.4.1" = _9XKdY9hX;
        "pkg-1.11.4" = _5QeRdq3W;
        "pkg-1.11.4.2" = _usAFTDtu;
        "pkg-1.11.5" = _C5GECNI9;
        "pkg-1.11.5.1" = _g3EYuow5;
        "pkg-1.12.0" = _PGe9E7oY;
        "pkg-1.12.1" = _rXcAUC99;
        "pkg-1.12.2" = _DdIQJeWI;
        "pkg-1.12.3" = _m0GuMMyR;
        "pkg-1.13.0" = _C4ZunsI9;
        "pkg-1.13.1" = _nCj3U5EU;
        "pkg-1.13.2" = _czQQilBT;
        "pkg-1.13.3" = _TVn1mJLU;
        "pkg-1.13.4" = _jxkChq5V;
        "pkg-1.13.5" = _prnJrz7o;
        "pkg-1.14.0" = _9aZapem3;
        "pkg-1.14.1" = _cZQ0KFTQ;
        "pkg-1.14.2.1" = _EqD0yvAn;
        "pkg-1.14.2.2" = _t7YRNo9I;
        "pkg-1.14.2.3" = _6VfALbSe;
        "pkg-1.15.0" = _2lCoSzFD;
        "pkg-1.15.1" = _6iraCzuN;
        "pkg-1.15.2" = _2zXpVxK4;
        "default" = _2zXpVxK4;
    });
