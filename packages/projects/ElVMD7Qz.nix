...
let
    ...
    in {
        ...
        "pkg-1.2.2" = _3ghVTOvv;
        "pkg-1.2.3" = _6SchPOR7;
        "pkg-mc1.8.8-1.2.3" = _lz0ZF6hX;
        "pkg-1.8.9-1.2.4" = _PKhtssjG;
        "pkg-1.8.9-1.2.5" = _iePHLLpz;
        "pkg-1.8.9-1.2.6" = _fg9AbAba;
        "pkg-1.8.9-1.2.7" = _2EvtIB0j;
        "pkg-1.8.9-1.2.8" = _cSHOn8C7;
        "pkg-1.8.9-1.2.9" = _1WSmvXaE;
        "pkg-1.9.0-1.2.9" = _RDcZPuiD;
        "pkg-1.8.9-1.3.0" = _FBHZizSW;
        "pkg-1.9.0-1.3.0" = _AFpDjIzJ;
        "pkg-1.9.0-1.3.1" = _4OhUKISp;
        "pkg-1.9.0-1.3.2" = _eijg937z;
        "pkg-1.9.0-1.3.3" = _XnxFCfDu;
        "pkg-1.9.4-1.3.3" = _JzY9BHug;
        "pkg-1.9.0-1.3.4" = _f5RcxJcg;
        "pkg-1.9.4-1.3.4" = _OMiJTOx1;
        "pkg-1.8.9-1.3.1" = _rINC5I6n;
        "pkg-1.9.4-1.3.5" = _NCrjZLWi;
        "pkg-1.10-1.3.6" = _SB92PJkz;
        "pkg-1.10-1.3.7" = _QGZ7GzyO;
        "pkg-1.10-1.3.8" = _wNyyXiWO;
        "pkg-1.10-1.3.9" = _hQPU1dgm;
        "pkg-1.10-1.4.0" = _w44sToDm;
        "pkg-1.1x-1.5.0" = _V9lIA7ag;
        "pkg-1.1x-1.5.1" = _vqcnCjpJ;
        "pkg-1.1x-1.5.2" = _sD4ji7wm;
        "pkg-1.1x-1.5.3" = _Erpafr72;
        "pkg-1.1x-1.5.4" = _gmayeNP6;
        "pkg-1.1x-1.5.5" = _48kvR2sQ;
        "pkg-1.12-1.5.5" = _z4x3F9u5;
        "pkg-1.12-1.5.6" = _PciwofWc;
        "pkg-1.12-1.5.7" = _zH54YRIr;
        "pkg-1.12-1.5.8" = _s42lmkqY;
        "pkg-1.12-1.5.9" = _KLI2WL7q;
        "pkg-1.12-1.6.0" = _dPrUT6OF;
        "pkg-1.12-1.6.1" = _xwRa6SfJ;
        "pkg-1.12-1.7.0-alpha" = _DrdlFkNc;
        "pkg-1.12-1.7.0" = _EMiRTpz5;
        "pkg-1.12-1.7.1" = _1mf5PNVE;
        "pkg-1.14-1.7.1.alpha" = _tWilffmc;
        "pkg-1.14-1.7.2.alpha" = _TfadgI4A;
        "pkg-1.12-1.7.2" = _xiuU9J3y;
        "pkg-1.12-1.7.3" = _imOxCm1n;
        "pkg-1.14-1.7.3.alpha" = _gDyXoBdB;
        "pkg-1.12-1.8.0" = _nLJa5G2L;
        "pkg-1.12-1.8.1" = _bOJLQlAJ;
        "pkg-1.14-1.7.4.beta" = _FzwxrRRU;
        "pkg-1.14-1.7.5.beta" = _p84YazhS;
        "pkg-1.15-2.0.0" = _j2sEHNdx;
        "pkg-1.16-3.0.0" = _wvACAOdy;
        "pkg-1.15-2.0.1" = _pGoKAw7W;
        "pkg-1.16-3.0.1" = _GC80QJ4a;
        "pkg-1.16-3.0.2" = _4XcZkKqu;
        "pkg-1.18-4.0.0" = _ZN95L3Db;
        "pkg-1.19.2-5.0.0" = _RZ3ywaSp;
        "pkg-1.19.2-5.0.1" = _zxc46V3O;
        "pkg-1.19-5.0.2" = _OET0iIJz;
        "pkg-1.20-6.0.0" = _BK8mjuFr;
        "pkg-1.20-6.0.1" = _YguhSWnU;
        "pkg-1.20-6.0.2" = _2X1skJtu;
        "pkg-1.21-7.0.0" = _2vyDvffZ;
        "pkg-1.21-7.0.1" = _TfwQaKau;
        "pkg-1.21-7.0.2" = _jH4hHVVr;
        "pkg-1.21-7.0.3" = _H6fYHWO0;
        "default" = _H6fYHWO0;
    });
