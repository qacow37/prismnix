...
let
    ...
    in {
        ...
        "pkg-1.0.1-Beta-Forge" = _9obocvbD;
        "pkg-1.0.2-Beta-Fabric" = _a7ZIrHoU;
        "pkg-1.0.2-Beta-Forge" = _T1fNZR0i;
        "pkg-1.0.3-Beta-Fabric" = _OUiKi9by;
        "pkg-1.0.3-Beta-Forge" = _Y2FJ1Qyr;
        "pkg-1.0.4-Beta-Fabric" = _YdSJaddW;
        "pkg-1.0.4-Beta-Forge" = _kaSk2CUS;
        "pkg-1.0.5-Beta-Fabric" = _ui63FbTR;
        "pkg-1.0.5-Beta-Forge" = _Bz53dHTH;
        "pkg-1.0.6-Beta-Fabric" = _RJIUQBwp;
        "pkg-1.0.6-Beta-Forge" = _hMxXL9ii;
        "pkg-1.1.0-Beta-Fabric" = _2yA2M97f;
        "pkg-1.1.0-Beta-Forge" = _WuOcvijt;
        "pkg-1.1.1-Beta-Fabric" = _mpu7ddMS;
        "pkg-1.1.1-Beta-Forge" = _jbFmjU3N;
        "pkg-1.1.2-Beta-Fabric" = _5dCfpJbk;
        "pkg-1.1.2-Beta-Forge" = _gGqCA2H2;
        "pkg-1.2.0-Beta-Fabric" = _DV0uNswd;
        "pkg-1.2.0-Beta-Forge" = _WWuhSS75;
        "pkg-1.2.1-Beta-Fabric" = _pc3KOzn3;
        "pkg-1.2.1-Beta-Forge" = _ZVZCSCGL;
        "pkg-1.2.2-Beta-Forge" = _ibTmb1OJ;
        "pkg-1.2.2-Beta-Fabric" = _J79OrR30;
        "pkg-2.0.0-Beta-Fabric" = _7FhY35OR;
        "pkg-2.0.0-Beta-Forge" = _NQdYoSHZ;
        "pkg-2.0.0-Beta-NeoForge" = _RLbMRvwa;
        "pkg-2.0.1-Beta-Fabric" = _ZbeF6TGu;
        "pkg-2.0.1-Beta-Forge" = _wDe4zcnQ;
        "pkg-2.0.1-Beta-NeoForge" = _pm6j1W0x;
        "pkg-1.2.3-Fabric" = _9dRL9CSN;
        "pkg-1.2.3-Forge" = _Qdjjcfwz;
        "pkg-2.0.2-Beta-Fabric" = _vQBZlJvD;
        "pkg-2.0.2-Beta-Forge" = _Ta9VUt5n;
        "pkg-2.0.2-Beta-NeoForge" = _nuQDidfi;
        "pkg-1.2.4-Fabric" = _1RzlAmgq;
        "pkg-1.2.4-Forge" = _t0SPSoBV;
        "pkg-2.0.3-Beta-Fabric" = _3vexuwOq;
        "pkg-2.0.3-Beta-Forge" = _Qq91oLdp;
        "pkg-2.0.3-Beta-NeoForge" = _gFDkGYyp;
        "pkg-1.2.5-Fabric" = _10zIiRPc;
        "pkg-1.2.5-Forge" = _FQLfLQZ4;
        "pkg-2.0.4-Beta-Fabric" = _GskmrszS;
        "pkg-2.0.4-Beta-Forge" = _AKp49GPQ;
        "pkg-2.0.4-Beta-NeoForge" = _yqNMLbBY;
        "pkg-1.3.0-Fabric" = _w3w2RSVi;
        "pkg-1.3.0-Forge" = _qGf8d9ep;
        "pkg-2.1.0-Beta-Fabric" = _ipOTWiSo;
        "pkg-2.1.0-Beta-Forge" = _8n1bnD24;
        "pkg-2.1.0-Beta-NeoForge" = _OPxVFBn7;
        "pkg-2.1.1-Beta-NeoForge" = _WMI6lpEi;
        "pkg-1.3.1-Fabric" = _gqqsCUtq;
        "pkg-1.3.1-Forge" = _mY1el13v;
        "pkg-2.1.2-Fabric" = _5MiLmyEZ;
        "pkg-2.1.2-Forge" = _Dn43TA8t;
        "pkg-2.1.2-NeoForge" = _iUceibmd;
        "pkg-2.1.3-Fabric" = _anaPYLOu;
        "pkg-2.1.3-Forge" = _nMRcapwr;
        "pkg-2.1.4-Forge" = _eEGFBpEh;
        "pkg-1.3.2-Fabric" = _SizbFMPf;
        "pkg-1.3.2-Forge" = _oiC1vBQp;
        "pkg-2.1.5-Fabric" = _jPHz4xD9;
        "pkg-2.1.5-Forge" = _oHvOTpKR;
        "pkg-2.1.5-NeoForge" = _1hgq7Emm;
        "pkg-1.3.3-Fabric" = _ZhDnARIs;
        "pkg-1.3.3-Forge" = _T4QFuTCx;
        "pkg-1.4.0-Fabric" = _NpS9Wp4p;
        "pkg-1.4.0-Forge" = _unzVvasR;
        "pkg-2.2.0-Fabric" = _o9VcsdeY;
        "pkg-2.2.0-Forge" = _wC35KwBo;
        "pkg-2.2.0-NeoForge" = _xY2lkb4T;
        "pkg-1.4.1-Fabric" = _TQ6OJT9g;
        "pkg-1.4.1-Forge" = _PQ0Ngceb;
        "pkg-2.2.1-Fabric" = _6UMdKIgb;
        "pkg-2.2.1-Forge" = _sJff99qM;
        "pkg-2.2.1-NeoForge" = _emlDEvRS;
        "pkg-2.2.2-Fabric" = _ZPVbMOIy;
        "pkg-2.2.2-Forge" = _O3yHPhkz;
        "pkg-2.2.2-NeoForge" = _5WDgzoZS;
        "pkg-1.4.2-Fabric" = _NXkaIrHJ;
        "pkg-1.4.2-Forge" = _ga3E2Y6x;
        "pkg-2.2.3-Fabric" = _KzzK2wRP;
        "pkg-2.2.3-Forge" = _bEEqy3zZ;
        "pkg-2.2.3-NeoForge" = _QvRsDlty;
        "pkg-1.4.3-Fabric" = _Gn7o6cKo;
        "pkg-1.4.3-Forge" = _zmpAA49y;
        "pkg-2.2.4-Fabric" = _eexILQyp;
        "pkg-2.2.4-Forge" = _vvCm2ukt;
        "pkg-2.2.4-NeoForge" = _g7kERDGk;
        "pkg-1.4.4-Fabric" = _SUb46kQD;
        "pkg-1.4.4-Forge" = _h9yRqXFn;
        "pkg-2.2.5-Fabric" = _gYKYowEM;
        "pkg-2.2.5-Forge" = _ohJCbQxT;
        "pkg-2.2.5-NeoForge" = _NSqKNNiO;
        "pkg-1.5.0-Fabric" = _dxXwPaA7;
        "pkg-1.5.0-Forge" = _Y0YNgnEf;
        "pkg-2.3.0-Fabric" = _KwpJ5fDG;
        "pkg-2.3.0-Forge" = _c9RSEqL0;
        "pkg-2.3.0-NeoForge" = _MXvrhztY;
        "pkg-1.5.1-Fabric" = _4eomS0D4;
        "pkg-1.5.1-Forge" = _bmcE5grh;
        "pkg-2.3.1-Fabric" = _FWCtUXnC;
        "pkg-2.3.1-Forge" = _oSQUphDQ;
        "pkg-2.3.1-NeoForge" = _YcuZiNYh;
        "pkg-1.5.2-Fabric" = _MV9mvFhY;
        "pkg-1.5.2-Forge" = _NiwqM1hI;
        "pkg-2.3.2-Fabric" = _uPdTR9PV;
        "pkg-2.3.2-Forge" = _BObiOohr;
        "pkg-2.3.2-NeoForge" = _AMOHKo2D;
        "pkg-2.3.3-Fabric" = _6pdrSJCA;
        "pkg-2.3.3-Forge" = _QZWp0rYk;
        "pkg-2.3.3-NeoForge" = _knlyfEvk;
        "pkg-1.5.3-Forge" = _nv5gBvol;
        "pkg-1.5.4-Fabric" = _tyDdueC7;
        "pkg-1.5.4-Forge" = _Y7hSe5BE;
        "pkg-2.3.4-Fabric" = _JobBWbnp;
        "pkg-2.3.4-Forge" = _YWlu4m0g;
        "pkg-2.3.4-NeoForge" = _SIdpuv1v;
        "pkg-2.3.5-Fabric" = _tYJYp8nA;
        "pkg-2.3.5-Forge" = _jYZ0lcdT;
        "pkg-2.3.5-NeoForge" = _Qnmn8Ahf;
        "pkg-1.5.5-Fabric" = _stWfvOxS;
        "pkg-1.5.5-Forge" = _FXDX2iIu;
        "pkg-2.3.6-Fabric" = _wt3DSIGY;
        "pkg-2.3.6-Forge" = _Wa88zVqE;
        "pkg-2.3.6-NeoForge" = _4stfb6Ok;
        "pkg-1.5.6-Fabric" = _H8LmqrmL;
        "pkg-1.5.6-Forge" = _7uH9A7ko;
        "pkg-1.5.7-Fabric" = _NYQj3oJn;
        "pkg-1.5.7-Forge" = _nxRBjuHf;
        "pkg-2.3.7-Fabric" = _lo9CGBw0;
        "pkg-2.3.7-Forge" = _pyIlSw0H;
        "pkg-2.3.7-NeoForge" = _4sZMRr9e;
        "pkg-2.3.8-Fabric" = _hcLNFbz8;
        "pkg-2.3.8-Forge" = _FLukUxvb;
        "pkg-2.3.8-NeoForge" = _d9PksrfG;
        "pkg-1.5.8-Fabric" = _paWs0umc;
        "pkg-1.5.8-Forge" = _mpGf7imr;
        "pkg-2.3.9-Fabric" = _G3zvY5GR;
        "pkg-2.3.9-Forge" = _8K1BhymA;
        "pkg-2.3.9-NeoForge" = _5BADusvn;
        "pkg-3.0.0-Fabric" = _DSv5H9Qa;
        "pkg-3.0.0-Forge" = _LA00KBol;
        "pkg-3.0.0-NeoForge" = _4osxsUki;
        "pkg-2.3.10-Forge" = _DTrxyYa4;
        "pkg-2.3.10-NeoForge" = _H0GG47aO;
        "pkg-3.0.1-Fabric" = _RDvnGMT0;
        "pkg-3.0.1-Forge" = _47mP2ngb;
        "pkg-3.0.1-NeoForge" = _XRAkyEjJ;
        "pkg-1.5.9-Fabric" = _MF06J0Ni;
        "pkg-1.5.9-Forge" = _nsSqXCdd;
        "pkg-2.3.11-Fabric" = _MwyvEfTi;
        "pkg-2.3.11-Forge" = _telR3xNg;
        "pkg-2.3.11-NeoForge" = _IyvwzYDg;
        "pkg-2.3.12-Fabric" = _ZyVzNHFy;
        "pkg-2.3.12-Forge" = _v6bxTA8l;
        "pkg-2.3.12-NeoForge" = _zzvHqN0U;
        "pkg-1.5.10-Fabric" = _XkipdXfi;
        "pkg-1.5.10-Forge" = _SUr93tcy;
        "pkg-3.0.2-Fabric" = _fdPfKF7O;
        "pkg-3.0.2-Forge" = _DvsttKxa;
        "pkg-3.0.2-NeoForge" = _m2cI8uMG;
        "pkg-1.5.11-Fabric" = _dU0iKshU;
        "pkg-1.5.11-Forge" = _qj6FvHC7;
        "pkg-2.3.13-Fabric" = _4fO3ULee;
        "pkg-2.3.13-Forge" = _Owe9Sdp8;
        "pkg-2.3.13-NeoForge" = _32kAFCKD;
        "pkg-3.0.3-Fabric" = _yVJdLICb;
        "pkg-3.0.3-Forge" = _f8GYYAfh;
        "pkg-3.0.3-NeoForge" = _b0zn4QhT;
        "pkg-3.0.4-Fabric" = _yXQhqXk4;
        "pkg-3.0.4-Forge" = _3RzgywNb;
        "pkg-3.0.4-NeoForge" = _77mrtoNb;
        "pkg-3.0.5-Fabric" = _gApk0gdu;
        "pkg-3.0.5-Forge" = _oDPQa24s;
        "pkg-3.0.5-NeoForge" = _Nuou6SDX;
        "pkg-2.4.0-Fabric" = _Ijgj2p9M;
        "pkg-2.4.0-Forge" = _HybJnrMp;
        "pkg-2.4.0-NeoForge" = _OXFipzY6;
        "pkg-2.4.1-Fabric" = _UqFOfC52;
        "pkg-2.4.1-Forge" = _xWhJ454D;
        "pkg-2.4.1-NeoForge" = _c1euAs7e;
        "pkg-2.4.2-Fabric" = _zzBvhyYJ;
        "pkg-2.4.2-Forge" = _ezy3Uz0H;
        "pkg-2.4.2-NeoForge" = _e9ztcYRU;
        "pkg-1.6.0-Fabric" = _xj6lmKhb;
        "pkg-1.6.0-Forge" = _o2E4y2Lx;
        "pkg-2.4.3-Fabric" = _LzjT0ZS9;
        "pkg-2.4.3-Forge" = _e1vnzozC;
        "pkg-2.4.3-NeoForge" = _PqK93sHA;
        "pkg-1.6.1-Fabric" = _82JkOAfK;
        "pkg-1.6.1-Forge" = _oJsYDwdu;
        "pkg-3.1.0-Fabric" = _O9B9Ny6Q;
        "pkg-3.1.0-NeoForge" = _zzdgBQdA;
        "pkg-3.1.0-Forge" = _gZhwH7Dj;
        "pkg-3.1.1-Fabric" = _8oBW6cwl;
        "pkg-3.1.1-Forge" = _CjOt43PD;
        "pkg-3.1.1-NeoForge" = _5MuDSmpM;
        "pkg-2.4.4-Fabric" = _ZcV0GAcW;
        "pkg-2.4.4-Forge" = _2VxlHwch;
        "pkg-2.4.4-NeoForge" = _vMIgVOzD;
        "pkg-1.6.2-Fabric" = _tidtpvy0;
        "pkg-1.6.2-Forge" = _xNgi207c;
        "pkg-2.4.5-Fabric" = _X0AhISls;
        "pkg-2.4.5-Forge" = _kf5dObjB;
        "pkg-2.4.5-NeoForge" = _JF98bpwU;
        "pkg-3.1.2-Fabric" = _aI9YG6ZS;
        "pkg-3.1.2-Forge" = _FTyqh37k;
        "pkg-3.1.2-NeoForge" = _hg8GuBg3;
        "pkg-1.6.3-Fabric" = _oTTacMoq;
        "pkg-1.6.3-Forge" = _y8Ji3nBC;
        "pkg-1.6.4-Fabric" = _C8KDCTER;
        "pkg-1.6.4-Forge" = _9Uuo4UtW;
        "pkg-2.4.6-Fabric" = _J76v87hR;
        "pkg-2.4.6-Forge" = _u1Yjtmfi;
        "pkg-2.4.6-NeoForge" = _72ITUVAk;
        "pkg-3.1.3-Fabric" = _Ek9vugXJ;
        "pkg-3.1.3-Forge" = _L1wwgEIH;
        "pkg-3.1.3-NeoForge" = _CpWMeiEe;
        "pkg-4.0.0-Fabric" = _czQXl4is;
        "pkg-4.0.0-Forge" = _NAlo3tzh;
        "pkg-4.0.0-NeoForge" = _N3pkn8tS;
        "pkg-1.6.5-Fabric" = _cfZsrFkD;
        "pkg-1.6.5-Forge" = _ybI7ZZBA;
        "pkg-2.4.7-Fabric" = _9aXVaJgA;
        "pkg-2.4.7-Forge" = _aGVkkf8R;
        "pkg-2.4.7-NeoForge" = _ofQ2F7NG;
        "pkg-3.1.4-Fabric" = _nGdIr2eV;
        "pkg-3.1.4-Forge" = _u0qbLcrw;
        "pkg-3.1.4-NeoForge" = _xQVeqqXI;
        "pkg-4.0.1-Fabric" = _I2fLa8kp;
        "pkg-4.0.1-Forge" = _OiYgLapH;
        "pkg-4.0.1-NeoForge" = _X2u3ho6T;
        "pkg-1.6.6-Fabric" = _zeWbP7nt;
        "pkg-1.6.6-Forge" = _Qi6nRfbd;
        "pkg-2.4.8-Fabric" = _5VH28HYk;
        "pkg-2.4.8-Forge" = _oJ9YME02;
        "pkg-2.4.8-NeoForge" = _niCvBUIy;
        "pkg-3.1.5-Fabric" = _ZzIIs9fP;
        "pkg-3.1.5-Forge" = _bZgf8dbj;
        "pkg-3.1.5-NeoForge" = _yLAV98Aj;
        "pkg-4.0.2-Fabric" = _Jtf6hgp9;
        "pkg-4.0.2-Forge" = _4tCEpvve;
        "pkg-4.0.2-NeoForge" = _iTWWr20h;
        "pkg-1.7.0-Fabric" = _pAiuo77Y;
        "pkg-1.7.0-Forge" = _aSpryQeR;
        "pkg-2.5.0-Fabric" = _8ajCHUWq;
        "pkg-2.5.0-Forge" = _s2ffXAtS;
        "pkg-2.5.0-NeoForge" = _o6OOKPei;
        "pkg-3.2.0-Fabric" = _o9imisK0;
        "pkg-3.2.0-Forge" = _ssqZI13T;
        "pkg-3.2.0-NeoForge" = _F48P6yz4;
        "pkg-4.1.0-Fabric" = _7NqPAfDP;
        "pkg-4.1.0-Forge" = _4OOziMXc;
        "pkg-4.1.0-NeoForge" = _d6YgsTlY;
        "pkg-1.7.1-Fabric" = _CgEaVfbj;
        "pkg-1.7.1-Forge" = _dZcsSoiO;
        "pkg-2.5.1-Fabric" = _1GDtBEv1;
        "pkg-2.5.1-Forge" = _5HXdstzW;
        "pkg-2.5.1-NeoForge" = _J8ruix7f;
        "pkg-3.2.1-Fabric" = _KU6j0M1T;
        "pkg-3.2.1-Forge" = _UoOjt86l;
        "pkg-3.2.1-NeoForge" = _dzPCoFsI;
        "pkg-4.1.1-Fabric" = _A0DMLFFg;
        "pkg-4.1.1-Forge" = _hJOgEaAf;
        "pkg-4.1.1-NeoForge" = _HdcvE7ki;
        "pkg-4.2.0-Fabric" = _MwPpqh2G;
        "pkg-4.2.0-Forge" = _7JNZQDpu;
        "pkg-4.2.0-NeoForge" = _Wd1peAGL;
        "pkg-1.7.2-Fabric" = _TiXHvI0Z;
        "pkg-1.7.2-Forge" = _N1BsLkDk;
        "pkg-2.5.2-Fabric" = _VjQlkWan;
        "pkg-2.5.2-Forge" = _6CIxeplK;
        "pkg-2.5.2-NeoForge" = _NiMPgHlt;
        "pkg-1.7.3-Fabric" = _HKJIyVzf;
        "pkg-1.7.3-Forge" = _O55joDsW;
        "pkg-2.5.3-Fabric" = _NKEUDM3U;
        "pkg-2.5.3-Forge" = _O2YHaejt;
        "pkg-2.5.3-NeoForge" = _FS1ccTQf;
        "pkg-3.2.2-Fabric" = _JvDSWZW1;
        "pkg-3.2.2-Forge" = _WciHrRpT;
        "pkg-3.2.2-NeoForge" = _mvF5OINd;
        "pkg-4.2.1-Fabric" = _dFObgmjj;
        "pkg-4.2.1-Forge" = _GKiMgleH;
        "pkg-4.2.1-NeoForge" = _o22LrnTg;
        "pkg-1.7.4-Fabric" = _qKtkWbpJ;
        "pkg-1.7.4-Forge" = _ZxaFRpeo;
        "pkg-2.5.4-Fabric" = _GjFvzoql;
        "pkg-2.5.4-Forge" = _XnLEXOzp;
        "pkg-2.5.4-NeoForge" = _JXws7ZiS;
        "pkg-3.2.3-Fabric" = _X2k6iElu;
        "pkg-3.2.3-Forge" = _gaTcp7s3;
        "pkg-3.2.3-NeoForge" = _80YIsjdq;
        "pkg-4.2.2-Fabric" = _wpFIFApW;
        "pkg-4.2.2-Forge" = _jZTihPGp;
        "pkg-4.2.2-NeoForge" = _xEbxZQh1;
        "pkg-4.3.0-Fabric" = _s4qEpK9f;
        "pkg-4.3.0-Forge" = _c2ZdvccB;
        "pkg-4.3.0-NeoForge" = _ellWCvao;
        "pkg-4.3.1-Fabric" = _MVNhZ3zo;
        "pkg-4.3.1-Forge" = _Y1Sm2D4m;
        "pkg-4.3.1-NeoForge" = _eHXuN8Iz;
        "pkg-3.2.4-Fabric" = _TmveJkbu;
        "pkg-3.2.4-Forge" = _OXm831wK;
        "pkg-3.2.4-NeoForge" = _xStEpWb7;
        "pkg-4.3.2-Fabric" = _F639xPiS;
        "pkg-4.3.2-Forge" = _erWX2EGR;
        "pkg-4.3.2-NeoForge" = _uA5uAURH;
        "pkg-4.3.3-Fabric" = _zfKCnGWj;
        "pkg-4.3.3-Forge" = _aoUn25Yf;
        "pkg-4.3.3-NeoForge" = _2FQe55Th;
        "pkg-2.5.5-Fabric" = _2VrEUzij;
        "pkg-2.5.5-Forge" = _wamoifg8;
        "pkg-2.5.5-NeoForge" = _6cLkgRgD;
        "pkg-1.7.5-Fabric" = _nTgMZTl1;
        "pkg-1.7.5-Forge" = _o5iLwahQ;
        "pkg-3.2.5-Fabric" = _NCZAogvP;
        "pkg-3.2.5-Forge" = _sgY3p3PH;
        "pkg-3.2.5-NeoForge" = _zHGiZEVy;
        "pkg-2.6.0-Fabric" = _ICd7oSmA;
        "pkg-2.6.0-Forge" = _iUBsVYnm;
        "pkg-2.6.0-NeoForge" = _aPEcdSHb;
        "pkg-1.8.0-Fabric" = _9hf2l2Rq;
        "pkg-1.8.0-Forge" = _8L5cwpjz;
