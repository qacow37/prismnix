...
let
    ...
    in {
        ...
        "pkg-1.0_1.16.1" = _xSsAiLZf;
        "pkg-1.0_1.16.2_1.16.5" = _1TP3sFFF;
        "pkg-1.0_1.17" = _kzCARopF;
        "pkg-1.0_1.18" = _Z3igxJ6Y;
        "pkg-1.0_1.19_1.20.2" = _1980o4SW;
        "pkg-1.0_1.20.3_1.20.4" = _2jzDtdhP;
        "pkg-1.0_1.20.6_1.21.6" = _Yf986O0a;
        "pkg-1.0_1.16_1.16.4" = _jEiDAyS7;
        "pkg-1.0_1.16.5_1.18.2" = _rhU2ij6g;
        "pkg-1.0_1.19_1.20.1" = _IQplmWdC;
        "pkg-1.0_1.20.2" = _vSibUycO;
        "pkg-1.0_1.20.3_1.21.6" = _KB7AlieM;
        "pkg-1.0_1.20.4" = _ATdi2pvB;
        "pkg-1.0_1.20.6" = _UDJjayuo;
        "pkg-1.0_1.21_1.21.6" = _rTivBLCA;
        "pkg-2.0_1.16.1" = _EkzeibyW;
        "pkg-2.0_1.16.2_1.16.5" = _gcZplDYD;
        "pkg-2.0_1.17" = _2xwZuOGS;
        "pkg-2.0_1.18" = _YghAG7ND;
        "pkg-2.0_1.19_1.20.2" = _OAsjkC5z;
        "pkg-2.0_1.20.3_1.20.4" = _ugH9f8Kk;
        "pkg-2.0_1.20.6_1.21.7" = _YThINDgR;
        "pkg-2.0_1.16_1.16.4" = _3JjFpW9h;
        "pkg-2.0_1.16.5_1.18.2" = _DVTNIQ93;
        "pkg-2.0_1.19_1.20.1" = _RKAHRLbw;
        "pkg-2.0_1.20.2" = _6zVEzgaa;
        "pkg-2.0_1.20.3_1.21.7" = _T6r1vYOl;
        "pkg-2.0_1.20.4" = _lsmKqsez;
        "pkg-2.0_1.20.6" = _I5Tv6BZ9;
        "pkg-2.0_1.21_1.21.x" = _PtGouXvt;
        "pkg-3.0_1.16.1" = _PtCLZcVo;
        "pkg-3.0_1.16.2_1.16.5" = _ltYAKdVt;
        "pkg-3.0_1.17" = _xCJu1Afy;
        "pkg-3.0_1.18" = _OBIhD3yK;
        "pkg-3.0_1.19_1.20.2" = _2GmsBATm;
        "pkg-3.0_1.20.3_1.20.4" = _y3bO1c0T;
        "pkg-3.0_1.20.6_1.21.10" = _G3U8iz0L;
        "pkg-3.0_1.16_1.16.4" = _Mkfs8Luh;
        "pkg-3.0_1.16.5_1.18.2" = _K7wr0S7P;
        "pkg-3.0_1.19_1.20.1" = _K5iWaTK9;
        "pkg-3.0_1.20.2" = _yamg8x7A;
        "pkg-3.0_1.20.3_1.21.10" = _bY2Rp3Mi;
        "pkg-3.0_1.20.4" = _S9WtpcKU;
        "pkg-3.0_1.20.6" = _KoEgOFYb;
        "pkg-3.0_1.21_1.21.10" = _ypU7lggm;
        "pkg-4.0_1.16.1" = _CSaL9Wqq;
        "pkg-4.0_1.16.2_1.16.5" = _JrugOiOg;
        "pkg-4.0_1.17" = _RkfoZyCX;
        "pkg-4.0_1.18" = _4460wzfs;
        "pkg-4.0_1.19_1.20.2" = _ny7qe9bK;
        "pkg-4.0_1.20.3_1.20.4" = _mSTbsIOG;
        "pkg-4.0_1.20.6_1.21.4" = _bpgmagEl;
        "pkg-4.0_1.16_1.16.4" = _13Ao5sWu;
        "pkg-4.0_1.16.5_1.18.2" = _9b68XSf9;
        "pkg-4.0_1.19_1.20.1" = _v9XhUIw9;
        "pkg-4.0_1.20.2" = _kWCHLMXe;
        "pkg-4.0_1.20.3_1.21.5" = _Mb1ZY4f7;
        "pkg-4.0_1.20.4" = _fvZBmHQB;
        "pkg-4.0_1.20.6" = _KFgbiyDr;
        "pkg-4.0_1.21_1.21.5" = _Co394pFp;
        "pkg-4.0_1.21.11" = _svbHuiZF;
        "default" = _svbHuiZF;
    });
