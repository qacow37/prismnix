...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.21.3" = _qAH51k9L;
        "pkg-0.2.0+1.21.4" = _bC8NGsM5;
        "pkg-0.2.1+1.21.4" = _M0lNbOzd;
        "pkg-0.2.2+1.21.4" = _o9L3RAxz;
        "pkg-0.2.3+1.21.4" = _PYjvT8km;
        "pkg-0.2.3+25w02a" = _3fCiKzYt;
        "pkg-0.2.3+1.21.1" = _AK00U2tj;
        "pkg-0.2.4+1.21.1" = _wTrHTKPE;
        "pkg-0.2.4+1.21.4" = _ebNeeFsB;
        "pkg-0.2.5+25w08a" = _Iw51dQiS;
        "pkg-0.2.6+1.21.4" = _hpF2ryYu;
        "pkg-0.2.6+1.21.1" = _SbC9rzxR;
        "pkg-0.2.6+1.20.6" = _4F0AsU79;
        "pkg-0.2.6+25w10a" = _C5PnBQfh;
        "pkg-0.2.6+1.20.1" = _bkagVQ1Q;
        "pkg-0.2.7+1.21.1" = _SNqwCANH;
        "pkg-0.2.7+1.21.4" = _cN2J9vGs;
        "pkg-0.2.7+1.21.5" = _lnsIxXms;
        "pkg-0.3.0+1.21.5" = _2LpytyRb;
        "pkg-0.3.1+1.21.5" = _qr3UUxdw;
        "pkg-0.3.2+1.21.6-pre1" = _Y6iqIGth;
        "pkg-0.4.0+1.21.5" = _RMTzpVCd;
        "pkg-0.4.0+1.21.6" = _Tkw2sOyt;
        "pkg-0.4.0+25w33a" = _ReEL16K6;
        "pkg-0.4.1+1.21.6" = _lXpeg3da;
        "pkg-0.4.1+1.21.9-pre2" = _U9KtBiia;
        "pkg-0.5.0+1.21.6" = _bAeJA8TK;
        "pkg-0.5.0+1.21.9" = _CrkTnYm7;
        "pkg-0.5.0+1.21.11" = _w21XwgDl;
        "pkg-0.5.0-neoforge_patch+1.21.11" = _Vl5d6xvi;
        "pkg-0.6.0+1.21.11" = _goWrOwmZ;
        "pkg-0.6.0+1.20.1" = _W0OJrTKY;
        "pkg-0.6.0+1.21.9" = _iObKF0Ic;
        "pkg-0.6.0+1.21.6" = _buqWcjIE;
        "pkg-0.6.0+1.21.5" = _672lsb8u;
        "pkg-0.6.1+1.21.1" = _ZxzsMlGK;
        "pkg-0.6.1+1.20.1" = _6ZCRvWsc;
        "pkg-0.6.0+26.1-snapshot-3" = _KJOPQxn0;
        "pkg-0.6.1+26.1" = _CUDF96X5;
