...
let
    ...
    in {
        ...
        "pkg-1.8.0" = _oHRmgVAo;
        "pkg-1.9.0" = _seldTJNh;
        "pkg-1.10.0" = _VliRj4Cr;
        "pkg-1.11.0" = _dbCROgJP;
        "pkg-1.12.0" = _ZzP4VVyM;
        "pkg-1.13.0" = _yNje6J0O;
        "pkg-1.14.0" = _LgLBvwyo;
        "pkg-1.15.0" = _5dIHBDDV;
        "pkg-1.16.0" = _FRCUkj5a;
        "pkg-1.17.0" = _URKlkUtU;
        "pkg-1.18.0" = _FkjSTpr7;
        "pkg-1.19.0" = _hPHSYgIt;
        "pkg-1.20.0" = _URyQePpS;
        "pkg-1.21" = _mOjuuu8q;
        "default" = _mOjuuu8q;
    });
