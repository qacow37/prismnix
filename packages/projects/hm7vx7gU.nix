...
let
    ...
    in {
        ...
        "pkg-v1.0.0+mod" = _NuJzUKNI;
        "pkg-v1.0.1" = _x1IRENtO;
        "pkg-v1.0.1+mod" = _qtZjLYth;
        "pkg-v1.0.2+1.21.6+" = _HwZoXjri;
        "pkg-v1.0.2+1.21.6++mod" = _yPI5f5wQ;
        "pkg-v1.0.3.0" = _BrJRZ3e6;
        "pkg-v1.0.3.0+mod" = _xrt9SrlJ;
        "pkg-v1.0.3.1" = _pzTBCDTX;
