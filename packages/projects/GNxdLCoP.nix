...
let
    ...
    in {
        ...
        "pkg-2.3.3" = _YEQ4O9NX;
        "pkg-2.3.4" = _NbNf9rLK;
        "pkg-3.0.0-forge" = _bfTNhqPe;
        "pkg-3.0.0-quilt" = _JSKzBziu;
        "pkg-3.0.0-fabric" = _LdgTaAbv;
        "pkg-3.0.1-forge" = _cx8ZZ7y9;
        "pkg-3.0.1-quilt" = _h5MkiE1k;
        "pkg-3.0.1-fabric" = _EqasvEFc;
        "pkg-3.0.2-forge" = _G8pojeWM;
        "pkg-3.0.2-quilt" = _N0IiuOd4;
        "pkg-3.0.2-fabric" = _lCHUsf1r;
        "pkg-3.0.3-quilt" = _DK6h46LO;
        "pkg-3.0.3-fabric" = _jAdt9S90;
        "pkg-3.1.0-forge" = _RaoQqzUR;
        "pkg-3.1.0-quilt" = _EboqCOZq;
        "pkg-3.1.0-fabric" = _2mQqYz2Y;
        "pkg-3.2.0-forge" = _VvIpk7Qs;
        "pkg-3.2.0-fabric" = _3rzOQJrq;
        "pkg-3.2.0-quilt" = _vGCKmen2;
        "pkg-3.3.0-neoforge" = _2Evn7EQY;
        "pkg-3.3.0-fabric" = _OgI2Yf72;
        "pkg-3.4.0-fabric" = _JnCn3KSm;
        "pkg-3.4.0-neoforge" = _qnt6fK9f;
        "pkg-4.0.0-fabric" = _cTK3oEis;
        "pkg-4.0.0-neoforge" = _QbFPKni5;
        "pkg-4.0.1-fabric" = _i3szHJcZ;
        "pkg-4.0.1-neoforge" = _W9HrxM8v;
        "pkg-4.0.2-fabric" = _wBuIfWID;
        "pkg-4.0.2-neoforge" = _WISbiN9f;
        "pkg-4.0.3-fabric" = _MFDifoVo;
        "pkg-4.0.3-neoforge" = _BsguttPm;
        "pkg-4.0.4-fabric" = _IOX1Nagm;
        "pkg-4.0.4-neoforge" = _mIh6QyNa;
        "pkg-4.0.5-fabric" = _nd3eGRYL;
        "pkg-4.0.5-neoforge" = _V2hm1W4A;
        "pkg-4.0.6-fabric" = _7A5M2E04;
        "pkg-4.0.6-neoforge" = _uXy8BhjT;
        "pkg-4.1.0+1.20.1-forge" = _GMVPW4xw;
        "pkg-4.1.0+1.21.10-fabric" = _7lE1b6Ao;
        "pkg-4.1.0+1.20.1-fabric" = _Vh2UWREQ;
        "pkg-4.1.0+1.21.1-neoforge" = _5mQ5ww6I;
        "pkg-4.1.0+1.21.1-fabric" = _bC1vJkMK;
        "pkg-4.1.0+1.21.5-neoforge" = _MoXHAzNs;
        "pkg-4.1.0+1.21.5-fabric" = _WN3c4myk;
        "pkg-4.1.0+1.21.10-neoforge" = _6DKZE82d;
        "pkg-4.1.0+1.21.8-neoforge" = _AT8yJAvY;
        "pkg-4.1.0+1.21.8-fabric" = _TuoAgjNJ;
        "pkg-4.1.1+1.21.1-neoforge" = _V7PU4g8I;
        "pkg-4.1.1+1.21.10-neoforge" = _3tD2XPMy;
        "pkg-4.1.1+1.21.1-fabric" = _b3VxU7eO;
        "pkg-4.1.1+1.21.11-neoforge" = _y6Q1ohGa;
        "pkg-4.1.1+1.20.1-fabric" = _jpXb8qLT;
        "pkg-4.1.1+1.21.10-fabric" = _xAVaNZcB;
        "pkg-4.1.1+1.20.1-forge" = _yFZM1Bsc;
        "pkg-4.1.1+1.21.11-fabric" = _fSknz5Rx;
        "pkg-4.1.1+1.21.5-neoforge" = _1CVO4bTn;
        "pkg-4.1.1+1.21.8-neoforge" = _LwKjdiqH;
        "pkg-4.1.1+1.21.5-fabric" = _TH6bWoGc;
        "pkg-4.1.1+1.21.8-fabric" = _x71NvPVT;
        "pkg-4.1.1.1+1.21.11-fabric" = _yrL6pwHZ;
        "pkg-4.1.1.1+1.21.11-neoforge" = _K37sxt1r;
        "pkg-4.1.2+26.1-neoforge" = _LCAZCdCv;
        "pkg-4.1.2+26.1-fabric" = _yIvrAg8G;
        "pkg-4.1.2+26.2-fabric" = _iDsSBWPv;
        "pkg-4.1.2+26.2-neoforge" = _858s49QX;
        "default" = _858s49QX;
    });
