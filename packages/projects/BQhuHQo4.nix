...
let
    ...
    in {
        ...
        "pkg-7.2.0" = _zywRome5;
        "pkg-8.0.0" = _WGt4877n;
        "pkg-3.0.14" = _Tn81upOl;
        "pkg-4.0.10" = _ub7QACvK;
        "pkg-4.4.0" = _AjyEMbZR;
        "pkg-4.6.6" = _yM4ZHygR;
        "pkg-4.9.6" = _HU2ihmcA;
        "pkg-4.10.0" = _NCeJzQIS;
        "pkg-5.0.0" = _e2KSRztK;
        "pkg-6.0.0" = _7hlA45To;
        "pkg-6.1.0" = _Z7Jr4G5N;
        "pkg-6.2.0" = _QsIvPSJA;
        ...
        "pkg-9.1.2" = _gOBO9Em2;
        "pkg-9.2.0" = _wkfuz8Xf;
        "pkg-10.0.0" = _nsvW0Vej;
        "pkg-10.1.0" = _xUbfCoAs;
        "pkg-10.2.0" = _74hEopk9;
        "pkg-9.1.3" = _hUdT2AgQ;
        "pkg-10.3.0" = _ReJs2HPk;
        "pkg-10.3.1" = _CEg1bcCD;
        "pkg-10.4.0" = _2sFKCoHS;
        "pkg-10.5.0" = _pXha7Aig;
        "pkg-10.5.1" = _djmtrwla;
        "pkg-11.0.0" = _mkRj74Iw;
        "pkg-11.0.1" = _EyTqhlTI;
        "pkg-11.0.2" = _LPSmDhkD;
        "pkg-11.0.3" = _pUiWn4Mz;
        "pkg-11.0.4" = _AwG8mcik;
        "pkg-11.1.0" = _YeLRCr1m;
        "pkg-11.1.1" = _UJCePD7k;
        "pkg-11.1.2" = _h0aSvkOv;
        "pkg-11.1.3" = _yVLdDCOC;
        "pkg-11.1.4" = _jQTZw2au;
        "pkg-10.6.0" = _xavD8Lt3;
        "pkg-11.2.0" = _Rc4eCDXl;
        "default" = _Rc4eCDXl;
    });
