...
let
    ...
    in {
        ...
        "pkg-0.1-beta" = _x5HL1vXn;
        "pkg-0.2.0-beta" = _bR5bxEXw;
        "pkg-0.2.1-beta" = _oC1T64gD;
        "pkg-0.3.0-beta" = _zaebjRcf;
        "pkg-52.0.0" = _UJieZqf7;
        "pkg-52.0.1" = _IW47TLJD;
        "pkg-52.0.2" = _yHVvXDXh;
        "pkg-53.0.0" = _toSb5d5b;
        "pkg-54.0.0" = _ZA7hNoky;
        "pkg-54.0.1" = _3WlpS2IK;
        "pkg-55.0.0" = _YgpahiVl;
        "pkg-55.0.1" = _LUru8B66;
        "pkg-55.0.2" = _p9fCVffx;
        "pkg-55.0.3" = _t9aDIWjY;
        "pkg-55.0.4" = _K7Bj2OtV;
        "pkg-55.0.5" = _3eYYpiMV;
        "pkg-55.0.6" = _J7QLzUDl;
        "pkg-56.0.0" = _6oMf8FQm;
        "pkg-56.0.1" = _lk8yXYJU;
        "pkg-57.0.0" = _xiZlZXR5;
        "pkg-57.0.1" = _Gsm02U8R;
        "pkg-57.0.2" = _McwWgPDE;
        "pkg-57.0.3" = _yN0GDY3L;
        "pkg-57.0.4" = _PWpBCN7T;
        "pkg-57.0.5" = _9fTohZIz;
        "pkg-59.0.0" = _aWcOP5wc;
        "pkg-59.0.1" = _6fOEcWI1;
        "pkg-59.0.2" = _6iikBfZv;
        "pkg-59.0.3" = _RSbB7edf;
        "pkg-59.0.4" = _V5dpddrU;
        "pkg-59.0.5" = _tzWiNxls;
        "pkg-58.1.0" = _nzx9NweP;
        "pkg-58.1.1" = _FpHfV4Eh;
        "default" = _FpHfV4Eh;
    });
