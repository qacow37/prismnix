...
let
    ...
    in {
        ...
        "pkg-1.8.10" = _OR1dIQs1;
        "pkg-1.8.17" = _UdrOlvir;
        "pkg-2.0.2" = _LVyIF4H1;
        "pkg-2.0.7" = _NmbATfVp;
        "pkg-2.3.3" = _f6UWqpYy;
        "pkg-2.4.5" = _DJnvOOZL;
        "pkg-3.0.1" = _otdKrJcG;
        "pkg-3.1.2" = _QsGImrZL;
        "pkg-3.1.6b" = _yNZzJP2H;
        "pkg-3.1.7c" = _r4pT2Wvn;
        "pkg-3.2.1" = _tPeSNwpv;
        "pkg-3.2.3" = _8RGjul5u;
        "pkg-3.2.4" = _t8RTVY4t;
        "pkg-4.0" = _szpwtYhL;
        ...
        "pkg-4.5" = _LivReB0d;
        "pkg-4.5.1" = _gztZgGGM;
        "pkg-4.5.1b" = _TL6Gv3a4;
        "pkg-4.5.2" = _En9NkxTG;
        "pkg-4.5.2b" = _JmrBfGKF;
        "pkg-4.5.2c" = _IlqaQYcI;
        "pkg-4.5.2e" = _l88I6HxT;
        "pkg-4.5.2f" = _WOPtw33x;
        "pkg-4.5.3" = _ekW8lqkX;
        "pkg-4.5.3b" = _VhreLj09;
        "pkg-4.5.3c" = _gIeIpatp;
        "pkg-4.5.4" = _8gajQEF7;
        "pkg-4.5.4b" = _OCsAO4Hq;
        "pkg-4.5.5" = _Uy42xZWc;
        "pkg-4.6" = _xpBdwNBh;
        "pkg-4.6.1" = _gSJ59XOV;
        "pkg-4.6.3" = _1JaRiWZq;
        ...
        "pkg-4.7.2" = _gHAGjKGT;
        "pkg-4.7.3" = _FUISh27T;
        "pkg-4-pre-5.0" = _D3iDOvvO;
        "pkg-4-Pre2-5.0" = _dLJeil5s;
        "pkg-4-pre3-5.0" = _3Lpj9Ggb;
        "pkg-4-pre3.1-5.0" = _zrjq66xC;
        "pkg-4-pre3.2-5.0" = _BulaJphY;
        "pkg-4-pre3.3-5.0" = _zTYazOJX;
        "pkg-4-pre3.3b-5.0" = _15naY2UM;
        "pkg-4-pre3.3c-5.0" = _ejLQeu68;
        "pkg-4-pre3.3d-5.0" = _QPRrP61e;
        "pkg-4-pre3.3e-5.0" = _8TJiEzLq;
        "pkg-4-pre3.3f-5.0" = _FBj5PFih;
        "pkg-5.0" = _X8Aq65Sc;
        "pkg-5.0.1" = _49kItUy4;
        "pkg-5.0.1c" = _m2o7pBfS;
        "pkg-5.0.2" = _sIS1HAT6;
        "default" = _sIS1HAT6;
    });
