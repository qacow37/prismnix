...
let
    ...
    in {
        ...
        "pkg-1+mod" = _Osn1V42s;
        "pkg-1.1" = _lpRMGUlr;
        "pkg-1.1+mod" = _MJKrCN6n;
        "pkg-1.2" = _ct90AZT4;
        "pkg-1.2+mod" = _AZ4ir12z;
        "pkg-1.3" = _Qkyl4YnI;
        "pkg-1.3+mod" = _Hc4R7lbk;
        "pkg-1.4" = _a8Aq1pDf;
        "pkg-1.4+mod" = _3ckPzj1l;
        "pkg-1.5" = _vJ58eurK;
        "pkg-1.5+mod" = _SjhZj1mJ;
        "pkg-1.5.1" = _55mOsIN4;
        "pkg-1.5.1+mod" = _CDErig1s;
        "pkg-1.6" = _rfzVNGM5;
        "pkg-1.6+mod" = _Vy4eBIur;
        "pkg-1.6.1" = _OZbLTTCZ;
        "pkg-1.6.1+mod" = _CEYbxgpH;
        "pkg-1.6.2" = _dGRbRzcp;
        "pkg-1.6.2+mod" = _68M4mzT3;
        "pkg-1.6.3" = _TanISfZp;
        "pkg-1.6.3+mod" = _MIRbrmxh;
        "pkg-1.7" = _j2t817Bn;
        "pkg-1.7+mod" = _H3nPU3Fg;
        "pkg-1.7.1" = _fp0uc0tg;
        "pkg-1.7.1+mod" = _A1xGuK46;
        "pkg-1.7.2" = _SWhqjPr7;
        "pkg-1.7.2+mod" = _Z1R9EyaU;
        "pkg-1.7e" = _S89lFYAA;
        "pkg-1.7e+mod" = _Y6rMu5qN;
        "pkg-1.8" = _KIz3L0op;
        "pkg-1.8+mod" = _FANyPrZx;
        "pkg-1.9" = _NC8VbkWr;
        "pkg-1.9+mod" = _ujxHPVae;
        "pkg-2.0" = _lwcX3f5w;
        "pkg-2.0+mod" = _pvjRYvoq;
        "pkg-2.1" = _waiUE7Qc;
        "pkg-2.1+mod" = _W5qlVPSv;
        "pkg-2.2" = _Y3zVEHiY;
        "pkg-2.2+mod" = _dXfiXf4m;
        "pkg-2.21" = _BDR3qSea;
        "pkg-2.21+mod" = _JQS2xZjG;
        "default" = _JQS2xZjG;
    });
