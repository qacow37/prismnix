...
let
    ...
    in {
        ...
        "pkg-0.0.1+1.19.4" = _CHnQparl;
        "pkg-0.0.2+1.19.4" = _4qd9mvES;
        "pkg-0.0.3+1.20.1" = _xXJnUnXV;
        "pkg-0.0.4+1.20.1" = _VeQUQdcR;
        "pkg-0.0.4+1.20.2" = _Hagig4EL;
        "pkg-0.0.5+1.20.1" = _7ADKDN51;
        "pkg-0.0.5+1.20.2" = _l0aNU4kq;
        "pkg-0.0.6+1.20.1" = _Ko6f9Fas;
        "pkg-0.0.6+1.20.2" = _vXK2CUgp;
        "pkg-0.0.6+1.20.4" = _OtyUm7U0;
        "pkg-0.0.7+1.20.2" = _KWPvJR5p;
        "pkg-0.0.7+1.20.4" = _qNKvOB6P;
        "pkg-0.0.7+1.20.1" = _Ktztdiuw;
        "pkg-0.0.7+1.20.6" = _zlV6rQA2;
        "pkg-0.0.7+1.21" = _rIOZo80K;
        "pkg-0.1.0+1.21" = _8vFErigr;
        "pkg-0.1.1+1.21" = _DSYUK4VH;
        "pkg-0.1.1+1.21.1" = _UaPknhUO;
        "pkg-0.1.1+1.21.3" = _68uWwZMK;
        "pkg-0.1.1+1.21.4" = _PAAUhZYD;
        "pkg-0.1.2+1.21.4" = _fkovxqly;
        "pkg-0.1.3+1.21.4" = _Nizpc0AW;
        "pkg-0.1.3+1.21.5" = _MbSBDGQj;
        "pkg-0.2.0" = _CvHXmmuR;
        "pkg-1.0.0" = _Y8BCFbqH;
        "pkg-1.0.1" = _A7871FyQ;
        "pkg-1.0.2" = _whOvA4rA;
