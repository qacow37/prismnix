...
let
    ...
    in {
        ...
        "pkg-0.1-beta.1" = _FzRBFevt;
        "pkg-fabric-0.1-beta.2" = _YuYO0gG5;
        "pkg-forge-0.1-beta.2" = _OsuwEiAX;
        "pkg-forge-0.1.1-beta.1" = _vuBXtlvA;
        "pkg-fabric-0.1.1-beta.1" = _qmIwLdTA;
        "pkg-fabric-0.1.2.1" = _5ukxGbSI;
        "pkg-forge-0.1.2.1" = _m7TTkPBn;
        "pkg-fabric-0.1.2.2" = _6IBWbTuf;
        "pkg-0.1.2.2" = _znSG4dq1;
        "pkg-fabric-0.1.2.3" = _FaXfAolE;
        "pkg-fabric-0.1.3.1" = _xFiDLNDC;
        "pkg-0.1.3.1" = _TIlocr9q;
        "pkg-fabric-0.1.3.2" = _3Bj98I1X;
        "pkg-forge-0.1.3.2" = _8e2wD23T;
        "pkg-fabric-2.1.3.3-1.20.4" = _UjUtkrOY;
        "pkg-fabric-1.1.3.3-1.20.2" = _qtqGrIEu;
        "pkg-fabric-2.1.4.1-1.20.4" = _zoOukyYV;
        "pkg-fabric-1.1.4.1-1.20.2" = _WN1a0zI4;
        "pkg-forge-0.1.4.1" = _2iKani5Z;
        "pkg-fabric-2.1.4.2-1.20.4" = _Pg76IzPm;
        "pkg-fabric-1.1.4.2-1.20.2" = _VxYrYrwm;
        "pkg-forge-0.1.4.2-1.20.1" = _omqBEsUq;
        "pkg-fabric-2.1.4.3-1.20.4" = _YKfTl0lr;
        "pkg-fabric-1.1.4.3-1.20.2" = _AyBtW9K8;
        "pkg-forge-0.1.4.3-1.20.1" = _Gm1oVCNF;
        "pkg-fabric-1.1.4.4-1.20.2" = _SCSNTezq;
        "pkg-fabric-2.1.4.4-1.20.4" = _wv8lqnGu;
        "pkg-forge-0.1.4.4-1.20.1" = _nmde1h6i;
        "pkg-fabric-2.1.4.5-1.20.4" = _cAShgEFg;
        "pkg-fabric-1.1.4.5-1.20.2" = _htCyOHUI;
        "pkg-forge-0.1.4.5-1.20.1" = _j4FoFeX6;
        "pkg-fabric-2.1.4.6-1.20.4" = _ci2HucIA;
        "pkg-forge-0.1.4.6-1.20.1" = _GVY70YTW;
        "pkg-fabric-2.1.4.7-1.20.4" = _2DOnFXbS;
        "pkg-forge-0.1.4.7-1.20.1" = _8lnodKQP;
        "pkg-fabric-2.1.4.8-1.20.4" = _jA72AaZS;
        "pkg-forge-0.1.4.8-1.20.1" = _yvmxdKo9;
        "pkg-fabric-2.1.5.0-1.20.4" = _EdMDOAd3;
        "pkg-forge-0.1.5.0-1.20.1" = _uDkaebsB;
        "pkg-2.1.5.1-1.20.4" = _iCdx9mO5;
        "pkg-0.1.5.1-1.20.1" = _HVchoGYt;
        "pkg-fabric-2.1.5.2-1.20.4" = _dqcUgPe2;
        "pkg-forge-2.1.5.2-1.20.4" = _uYUrYkJH;
        "pkg-fabric-2.2.0.0-1.20.4-alpha" = _15Bk0n4I;
        "pkg-forge-2.2.0.0-1.20.4-alpha" = _T9Ff6Z3V;
        "pkg-fabric-2.2.0.0-1.20.4-alpha.2" = _j20JHEQv;
        "pkg-forge-2.2.0.0-1.20.4-alpha.2" = _QCTp6A97;
        "pkg-fabric-2.2.0.0-1.20.4" = _f9tddFVz;
        "pkg-forge-2.2.0.0-1.20.4" = _EorUqioO;
        "pkg-fabric-2.2.1.0-1.20.4" = _SnVVr2IM;
        "pkg-forge-2.2.1.0-1.20.4" = _c0z8tepi;
        "pkg-fabric-3.0.0.0-1.21" = _CZ6C0P8S;
        "pkg-forge-3.0.0.0-1.21" = _Cho7v6Xm;
        "pkg-forge-3.0.0.0-1.21-patch.1" = _fbIrmpFB;
        "pkg-4.0.0" = _RF8TCumb;
        "pkg-4.1.0" = _zwyERzDT;
        "pkg-5.0.0" = _3vcPDACb;
        "pkg-4.1.1" = _NGWBbvSr;
