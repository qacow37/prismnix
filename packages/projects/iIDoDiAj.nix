...
let
    ...
    in {
        ...
        "pkg-0.0.4-1.19.2" = _Uh6S262A;
        "pkg-0.0.3-1.18.2" = _T9DbyJPm;
        "pkg-0.5.0-20.1" = _DHgYBLHl;
        "pkg-0.5.1-20.1" = _UOkkQcUi;
        "pkg-0.6.0-20.1" = _TqONxxGR;
        "pkg-0.7.0-20.1" = _DHDInCvX;
        "pkg-1.0.0-20.1" = _Ks0HVkoI;
        "pkg-1.0.1-20.1" = _MdvYMkYX;
        "pkg-1.1.0-20.1" = _Src6JuxG;
        "pkg-1.2.0-20.1" = _T3agSgwc;
        "pkg-1.2.1-20.1" = _aJnCDNQ8;
        "pkg-1.3.0-20.1-beta-01" = _2wwnVUyg;
        "pkg-1.3.0-20.1-beta-02" = _F25L9ubI;
        "pkg-1.3.0-20.1-beta-03" = _Qw6s4UGw;
        "pkg-1.3.0-20.1" = _yOdmuh86;
        "pkg-1.3.1-20.1" = _PFscGKy4;
        "pkg-1.3.2-20.1" = _VRTiVFcN;
        "pkg-1.3.3-20.1" = _vAv7qGtZ;
        "pkg-1.3.4-20.1" = _Z0UJ2Qkh;
        "pkg-1.3.5-20.1" = _vFfMVPMU;
        "pkg-1.3.6-20.1" = _o8ZudAtF;
        "pkg-1.4.0-20.1-beta-1" = _Wirb99J5;
        "pkg-1.4.0-20.1-beta-2" = _S2Fk6INC;
        "pkg-1.4.0-20.1-beta-3" = _uvT4uiES;
        "pkg-1.4.0-20.1-beta-4" = _A0RdfO0K;
        "default" = _A0RdfO0K;
    });
