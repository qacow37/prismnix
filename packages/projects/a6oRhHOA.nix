...
let
    ...
    in {
        ...
        "pkg-2.0.0+forge" = _UtQ7FeFJ;
        "pkg-2.0.0-fabric" = _9glHtuh3;
        "pkg-2.0.1+1.19-fabric" = _3c1DpSyg;
        "pkg-2.0.1+1.19-forge" = _pStg2YqA;
        "pkg-2.0.2+1.19-forge" = _6fMPDeDp;
        "pkg-2.0.2+1.19-fabric" = _XYmehB9g;
        "pkg-2.0.2+1.18.2-forge" = _WRrhqrK1;
        "pkg-2.0.2+1.18.2-fabric" = _ZmG0F2Rn;
        "pkg-2.0.3+1.19-forge" = _EZD81mtD;
        "pkg-2.0.3+1.19-fabric" = _bJt8U5B8;
        "pkg-2.1.0+1.19.1-forge" = _164CK2i7;
        "pkg-2.1.0+1.19.1-fabric" = _4H160Lp7;
        "pkg-2.2.0+1.20.1-fabric" = _FtI1H5Ae;
        "pkg-2.2.0+1.20.1-forge" = _l6GWajp8;
        "pkg-2.2.0+1.19.4-forge" = _f0Zo49Rb;
        "pkg-2.2.0+1.19.4-fabric" = _dMwK7hsi;
        "pkg-2.2.0+1.20.2-forge" = _uRy8nw0c;
        "pkg-2.2.0+1.20.2-fabric" = _b1UIh9wb;
        "pkg-2.2.0+1.20.6-neoforge" = _RG40EMvR;
        "pkg-2.2.0+1.20.6-fabric" = _2tLRnuVp;
        "pkg-2.2.0+1.21-neoforge" = _YSLBmXzd;
        "pkg-2.2.0+1.21-fabric" = _ppipfXIH;
        "pkg-3.0.0+1.21.1-neoforge" = _pa05ysqe;
        "pkg-3.0.0+1.21.1-fabric" = _iURfE0qA;
        "pkg-4.0.0+26.1-neoforge" = _1fSGK2At;
        "pkg-4.0.0+26.1-fabric" = _7Chdeik5;
        "pkg-4.1.0+26.1.2-neoforge" = _PbqGXTEL;
        "pkg-4.1.0+26.1.2-fabric" = _n4MoisKi;
        "default" = _n4MoisKi;
    });
