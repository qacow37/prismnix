...
let
    ...
    in {
        ...
        "pkg-0.1.1" = _ZCeH7oxn;
        "pkg-0.1.2" = _AR32jarO;
        "pkg-0.1.2-hotfix.1" = _OjcJJKnS;
        "pkg-0.1.3" = _GBWc6wQA;
        "pkg-0.1.3-hotfix.1" = _ZGRNCZFo;
        "pkg-0.1.3-hotfix.2" = _sNU5yANo;
        "pkg-0.1.4" = _QihQuZUT;
        "pkg-0.2.0" = _DJ90rnY5;
        "pkg-0.2.0-hotfix.1" = _R1guGkMb;
        "pkg-0.2.0-hotfix.2" = _vxjzWnez;
        "pkg-0.2.0-hotfix.3" = _YUP9fHHt;
        "pkg-0.2.0-hotfix.4" = _c4bMAW33;
        "pkg-0.2.1-hotfix.3+1.21.4" = _RL4ptzQm;
        "pkg-0.2.1-hotfix.3+1.21.5" = _7mgDJ9kg;
        "pkg-0.2.1-hotfix.4+1.21.5" = _P9LKPjHK;
        "pkg-0.2.1-hotfix.4+1.21.4" = _8uxqU3eq;
        "pkg-0.2.1-hotfix.5+1.21.5" = _5MotUsc2;
        "pkg-0.2.1-hotfix.5+1.21.4" = _4Ui5wXOc;
        "pkg-0.2.1-hotfix.6+1.21.5" = _ddTKEiER;
        "pkg-0.2.1-hotfix.6+1.21.4" = _ZYNh3wHt;
        "pkg-0.2.2-beta.1+1.21.4" = _10Vz74Al;
        "pkg-0.2.2-beta.1+1.21.5" = _p0gCwjG4;
        "pkg-0.2.2+1.21.4" = _T4a3HcFt;
        "pkg-0.2.2+1.21.5" = _euNFJZa7;
        "pkg-0.2.2-hotfix.1+1.21.4" = _o7j6CNRQ;
        "pkg-0.2.2-hotfix.1+1.21.5" = _81Vxtacg;
        "pkg-0.2.3+1.21.4" = _4cyJUSIg;
        "pkg-0.2.3+1.21.5" = _SiwSKkj0;
        "pkg-0.2.3-hotfix.1+1.21.4" = _eDLpXZ3B;
        "pkg-0.2.3-hotfix.1+1.21.5" = _KjmSvcux;
        "pkg-0.2.3-hotfix.2+1.21.4" = _HxG1GxNw;
        "pkg-0.2.3-hotfix.2+1.21.5" = _W0dHZPpV;
        "pkg-0.2.3-hotfix.3+1.21.4" = _DXGVM3S2;
        "pkg-0.2.3-hotfix.3+1.21.5" = _U66g46rX;
        "pkg-0.2.3-hotfix.4+1.21.4" = _GrEU60xc;
        "pkg-0.2.3-hotfix.4+1.21.5" = _B7RVfXFH;
        "pkg-0.2.3-hotfix.5+1.21.4" = _zzxnHsmU;
        "pkg-0.2.3-hotfix.5+1.21.5" = _tclU9iTd;
        "pkg-0.2.3-hotfix.6+1.21.4" = _nVCUBv3i;
        "pkg-0.2.3-hotfix.6+1.21.5" = _woQvRxPy;
        "pkg-2.4.0+1.21.4" = _lTRMqHgi;
        "pkg-2.4.0+1.21.5" = _wb9efyHq;
        "pkg-2.4.1+1.21.4" = _ZDByzw31;
        "pkg-2.4.1+1.21.5" = _ESkUXjzP;
        "pkg-2.4.2+1.21.4" = _wMTvs1xv;
        "pkg-2.4.2+1.21.5" = _CJOyKDV2;
        "pkg-2.4.3+1.21.4" = _aVYp2SJy;
        "pkg-2.4.3+1.21.5" = _mNWMvUfN;
        "pkg-2.4.4+1.21.4" = _lvjlZyKz;
        "pkg-2.4.4+1.21.5" = _NBhRi7ln;
        "pkg-2.4.5+1.21.4" = _yxiy80uX;
        "pkg-2.4.5+1.21.5" = _DRDFk2zz;
        "pkg-2.4.6+1.21.4" = _WvPZIXOr;
        "pkg-2.4.6+1.21.5" = _KbVZgg4u;
        "pkg-2.4.7+1.21.4" = _CKMveMVA;
        "pkg-2.4.7+1.21.5" = _6pxvExIU;
        "default" = _6pxvExIU;
    });
