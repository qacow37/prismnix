...
let
    ...
    in {
        ...
        "pkg-1.2-mc1.18.2+forge" = _ymAH9nkG;
        "pkg-1.2-mc1.18.2+fabric" = _LwFUlPOY;
        "pkg-1.4-mc1.19.x+forge" = _VA4K616J;
        "pkg-1.4-mc1.19.x+fabric" = _sAjAKqfY;
        "pkg-1.4-mc1.19.3+fabric" = _G6MGsxaI;
        "pkg-1.4+mc1.19.4+fabric" = _FEmKO6K3;
        "pkg-1.4+mc1.20+fabric" = _Tem7SpXI;
        "pkg-1.4+mc1.20.x" = _CLuePZBL;
        "pkg-1.4+mc1.20.2+fabric" = _Uy0s7ib8;
        "pkg-1.4+mc1.20.2+forge" = _oDSV4CeP;
        "pkg-1.5+mc1.20.2+forge" = _NeGDqdnR;
        "pkg-1.5+mc1.20+forge" = _chgnA6zJ;
        "pkg-1.5+mc1.19.4+forge" = _CQk2zK3z;
        "pkg-1.5+mc1.19+forge" = _CVPJflsb;
        "pkg-1.5+mc1.18.2+forge" = _pKP8BCQq;
        "pkg-1.5+mc1.18.2+fabric" = _K5uwF8ak;
        "pkg-1.5+mc1.19+fabric" = _DLRGIW89;
        "pkg-1.5+mc1.19.3+fabric" = _iD05Tp0Y;
        "pkg-1.5+mc1.19.4+fabric" = _xFtzM4DZ;
        "pkg-1.5+mc1.20+fabric" = _aYi3K1Il;
        "pkg-1.5+mc1.20.2+fabric" = _OoK9SObh;
        "pkg-1.5.1+mc1.18.2+fabric" = _IVvSSqme;
        "pkg-1.5.1+mc1.19.4+fabric" = _Ep1iza5M;
        "pkg-1.5.1+mc1.20.2+fabric" = _Z37XbSmi;
        "pkg-1.5.1+mc1.20+fabric" = _4PmfgG4q;
        "pkg-1.5.1+mc1.20.5+fabric" = _8BSPVmwr;
        "pkg-1.5.2+mc1.20.5+fabric" = _kSB4olUq;
        "pkg-1.5.3a+mc1.20.6+neoforge" = _xjbhD2yD;
        "pkg-1.5.3a+mc1.20.6+fabric" = _faXXEGxg;
        "pkg-1.5.3+mc1.21+neoforge" = _gbXiK0Bu;
        "pkg-1.5.3+mc1.21+fabric" = _qzLjOEpO;
        "pkg-1.5.4+mc1.21+neoforge" = _E0Q9JBxZ;
        "pkg-1.5.4+mc1.21+fabric" = _UkNlAiYY;
        "pkg-1.5.5+mc1.21+forge" = _9xu2l6wR;
        "pkg-1.5.5+mc1.21+neoforge" = _WTBzgVaF;
        "pkg-1.5.5+mc1.21+fabric" = _kLc2W7dp;
        "pkg-1.5.6+mc1.21+neoforge" = _GHjzonFH;
        "pkg-1.5.6+mc1.21+fabric" = _wzXeUDpb;
        "pkg-1.5.7+mc1.21+neoforge" = _F2s6rUr5;
        "pkg-1.5.7+mc1.21+fabric" = _HjpQCgnC;
        "pkg-1.5.7-nt+mc1.21.2+neoforge" = _bn9AZ4xk;
        "pkg-1.5.7-nt+mc1.21.2+fabric" = _P0VnDCbp;
        "pkg-1.5.8+mc1.21.2+neoforge" = _GB132itQ;
        "pkg-1.5.8+mc1.21.2+fabric" = _w1enQIMp;
        "pkg-1.5.8+mc1.21.5+neoforge" = _LtuXc3OP;
        "pkg-1.5.8+mc1.21.5+fabric" = _hCJfIJid;
        "pkg-1.5.9+mc1.21.5+neoforge" = _2DonNy7t;
        "pkg-1.5.9+mc1.21.5+fabric" = _NdgCUO3T;
        "pkg-1.5.9+mc1.21.6+neoforge" = _kA0NVmPA;
        "pkg-1.5.9+mc1.21.6+fabric" = _WuKcCwtO;
        "pkg-1.5.9+mc1.21.9+neoforge" = _rqJCXauU;
        "pkg-1.5.9+mc1.21.9+fabric" = _c0z1Y2Dr;
        "pkg-1.5.10+mc1.21.9+neoforge" = _c34cdw6Y;
        "pkg-1.5.10+mc1.21.9+fabric" = _ShkG9Y2j;
        "pkg-1.5.10+mc1.20.1+forge" = _SsBsJYQJ;
        "pkg-1.5.10+mc1.20.1+fabric" = _UzmoINQM;
        "pkg-1.5.11+mc1.20.1+forge" = _3wmIOYu8;
        "pkg-1.5.11+mc1.20.1+fabric" = _IU8U9Gz3;
        "pkg-1.5.12+mc1.20.1+forge" = _MB1xqETb;
        "pkg-1.5.12+mc1.20.1+fabric" = _ySttssF3;
        "pkg-1.5.12+mc1.21.9+neoforge" = _ULRt0iHR;
        "pkg-1.5.12+mc1.21.9+fabric" = _92ZgdOpy;
        "pkg-1.5.12b+mc1.20+forge" = _3MPiN8W6;
        "pkg-1.5.12+mc1.19+forge" = _sRCimnZ2;
        "pkg-1.5.12+mc1.19+fabric" = _18KPMUBd;
        "pkg-1.5.12+mc1.18.2+forge" = _wTDiYAxS;
        "pkg-1.5.12+mc1.18.2+fabric" = _A0JLIwrz;
        "pkg-1.5.12-beta+mc1.21.11+neoforge" = _Oj9IxbP8;
        "pkg-1.5.12-beta+mc1.21.11+fabric" = _ARIJY6Ew;
        "pkg-1.5.13+mc26.1+neoforge" = _73PooXIc;
        "pkg-1.5.13+mc26.1+fabric" = _WYxSecea;
        "pkg-1.5.14+mc26.2+neoforge" = _MNhjIkgQ;
        "pkg-1.5.14+mc26.2+fabric" = _YNz1DCpy;
        "default" = _YNz1DCpy;
    });
