...
let
    ...
    in {
        ...
        "pkg-1.9.3" = _XqkbeKGI;
        "pkg-1.9.4" = _uBrG1HJI;
        "pkg-1.10.0" = _24MsIfQb;
        "pkg-1.10.1" = _OLLhcHCi;
        "pkg-1.10.2" = _CwjNsh0q;
        "pkg-1.10.3" = _s93nO5e0;
        "pkg-1.10.4" = _6HpSzr3H;
        "pkg-1.10.5" = _cIPoTJsf;
        "pkg-1.10.6" = _BpN2l1D3;
        "pkg-1.11.0" = _jSv8THmq;
        "pkg-1.12.0" = _3PaJIy7V;
        "pkg-1.12.1" = _HZPyqn81;
        "pkg-1.12.2" = _uiArXQF7;
        "pkg-1.12.3" = _K1cGTQVQ;
        "pkg-1.12.4" = _hbiHxHKK;
        "pkg-1.12.5" = _zOyazCwM;
        "pkg-1.12.6" = _V9HkYo9e;
        "pkg-1.12.7" = _F6XQUQMJ;
        "pkg-1.12.8" = _EeVWox7E;
        "pkg-1.12.9" = _EzUKKoPG;
        "pkg-1.12.10" = _Hu2uS74n;
        "pkg-1.12.11" = _NEhK7Z9j;
        "pkg-1.12.12" = _i1ZuMh95;
        "pkg-1.12.13" = _d8cyMHwH;
