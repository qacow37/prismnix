...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _DlGoAU9E;
        "pkg-1.0.2" = _SRofOOsU;
        "pkg-1.0.3-beta1" = _dzdhtma9;
        "pkg-1.0.3" = _tk8IDZSW;
        "pkg-1.0.4-beta1" = _SmRS2ANj;
        "pkg-1.0.4-beta2" = _lvUtmEZN;
        "pkg-1.1" = _XiRB0h6c;
        "pkg-1.1.1" = _mIxwh5an;
        "pkg-1.2" = _I2HZdiqu;
        "pkg-1.2.1-beta1" = _AXLgSrSw;
        "pkg-1.3-beta1" = _sGUjov7c;
        "pkg-1.3" = _k7fV91Rl;
        "pkg-1.3.1" = _hABHaj6W;
        "pkg-1.3.2" = _elc0m1RZ;
        "pkg-1.3.3" = _rtYvxYIS;
        ...
        "pkg-1.3.8" = _kE1XOo92;
        "pkg-1.3.9" = _2frsjvi4;
        "pkg-1.3.10" = _jZ18Sybi;
        "pkg-1.3.11" = _OjgYXhCM;
        "pkg-1.3.12" = _qetm85Nz;
        "pkg-1.3.13" = _QhSzCjgz;
        "pkg-1.3.14" = _ofui29Kj;
        "default" = _ofui29Kj;
    });
