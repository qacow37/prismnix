...
let
    ...
    in {
        ...
        "pkg-1.2.1+1.20.1" = _ABv8vP2O;
        "pkg-1.3.0" = _yEPZYc4d;
        "pkg-1.3.1+1.20.1" = _QSM2v3Tb;
        "pkg-1.3.1+1.20.2" = _IM6ilNWK;
        "pkg-1.3.1+1.19.4" = _2Ib3A14Z;
        "pkg-1.3.2+1.19.4" = _XFxoQ0Mu;
        "pkg-1.4.0+1.20.1" = _BeiGXbT3;
        "pkg-1.4.0+1.20.2" = _nDKijtEf;
        "pkg-2.0.0" = _duWKG2v3;
        "pkg-3.0.0" = _Nir7IFE0;
        "pkg-3.0.0-bta" = _7WVeWaVk;
        "pkg-3.0.0-bta-7.3-pre1" = _jRJz9ZcL;
        "pkg-3.1.0" = _7Wkhuqws;
        "pkg-3.2.0" = _ip18XcuT;
        "pkg-4.0.0" = _fuLYRH6E;
        "pkg-5.0.0-beta.1" = _bPvRWuYf;
        "pkg-5.0.0" = _6ELs9AqM;
        "pkg-5.0.1" = _nMu0r59m;
        "pkg-5.0.2" = _JmiltyoM;
        "pkg-6.0.0" = _gkCYy11t;
