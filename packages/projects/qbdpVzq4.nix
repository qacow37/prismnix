...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.21.0" = _Ifcom8G2;
        "pkg-1.1.0-1.21.2" = _OYMUENEa;
        "pkg-1.2.0-1.21.4" = _e9fyztJl;
        "pkg-1.2.1-1.21.5" = _QMHkTQyM;
        "pkg-1.2.1-1.21.6" = _MyIJpFU6;
        "pkg-1.2.1-1.21.9" = _zr4BiyBf;
