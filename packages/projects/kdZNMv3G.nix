...
let
    ...
    in {
        ...
        "pkg-1.18-v1.1.0" = _Tz5ciSkL;
        "pkg-1.19-v1.1.0" = _LFJqWI5k;
        "pkg-1.19.3-v1.1.0" = _2J0dHN7o;
        "pkg-1.20-v1.1.0" = _5Hhb3qE9;
        "pkg-1.18-v1.2.0" = _ibzQh8LY;
        "pkg-1.19-v1.2.0" = _WhxKgp86;
        "pkg-1.19.3-v1.2.0" = _xQ1hf0DH;
        "pkg-1.20-v1.2.0" = _azTLnF4f;
        "pkg-1.18-v1.2.1" = _s6yi3mGI;
        "pkg-1.19-v1.2.1" = _ezfJAw0S;
        "pkg-1.19.3-v1.2.1" = _u4iFsBDg;
        "pkg-1.20-v1.2.1" = _cOdmDeXA;
        "pkg-2.0.0-mc1.20" = _LoDkCOc8;
        "pkg-3.0.0-mc1.20.2" = _kTYs6T7V;
        "pkg-3.0.1-mc1.20.2" = _1ueHOwRz;
        "pkg-3.0.2-mc1.20.2" = _HmZoaWEE;
        "pkg-3.0.2-mc1.20" = _tcSv1klE;
        "pkg-4.0.0-mc1.20" = _U5lQ0YwG;
        "pkg-4.0.0-mc1.20.2" = _g858fuKW;
        "pkg-4.0.1" = _oWwtMkXf;
        "pkg-4.0.1-mc1.20.2" = _8iUlAzlj;
        "pkg-5.0.0-mc1.20" = _c57h8TFR;
        "pkg-5.0.0-mc1.20.2" = _UEniBL87;
        "pkg-5.1.0-fabric1.20.2" = _NGrvLnTw;
        "pkg-5.1.0-fabric1.20" = _bNqLHffR;
        "pkg-5.1.1-fabric1.20.2" = _X7JOaG6N;
        "pkg-5.1.1-fabric1.20" = _8JMHo8n2;
        "pkg-5.1.2-fabric1.20" = _mA6fTe0s;
        "default" = _mA6fTe0s;
    });
