...
let
    ...
    in {
        ...
        "pkg-1.0.9+1.20.4" = _cQkkoyCl;
        "pkg-1.0.10+1.20.5" = _EBLwbar3;
        "pkg-1.0.11+1.20.6" = _H5TDr0P3;
        "pkg-1.0.2+1.20.6" = _tBix2Di1;
        "pkg-1.0.3+1.20.6" = _UB9e9NHJ;
        "pkg-1.1.0+1.20.6" = _Qqj0fGF1;
        "pkg-1.1.1+1.20.6" = _xa16UibV;
        "pkg-1.1.2+1.20.6" = _Rq69NGKN;
        "pkg-1.1.3+1.20.6" = _goIIB0PZ;
        "pkg-1.1.4+1.21" = _jzOmLsPR;
        "pkg-1.1.5+1.21" = _zGRJXubA;
        "pkg-1.1.6+1.21" = _BIfIGKPi;
        "pkg-1.1.7+1.21" = _XiPz5bv3;
        "pkg-1.1.8+1.21.1" = _6EhJaxIY;
        "pkg-1.9.3" = _f2bDEHT3;
        "pkg-1.2.0" = _BAzzKUfR;
        "pkg-1.2.1" = _zSV7rZ1t;
        "pkg-1.2.2" = _NAeoSgGc;
