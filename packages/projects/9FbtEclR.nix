...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19.1" = _42PJCKZQ;
        "pkg-1.0.0+1.19.3" = _MsNNbX9N;
        "pkg-1.0.1+1.19.3" = _L1zBs5ks;
        "pkg-1.0.1+1.19.2" = _mG4PMhHe;
        "pkg-1.0.1+1.20.1" = _A6jHycaT;
        "pkg-1.0.2+1.20.2" = _TfXwWuis;
        "default" = _TfXwWuis;
    });
