...
let
    ...
    in {
        ...
        "pkg-v1.0-1.21.4" = _CRxYt29b;
        "pkg-v1.0-1.21.3" = _8P5I4Fc7;
        "pkg-v1.0-1.21.2" = _loFBVAEM;
        "pkg-v1.0-1.21.1" = _662uov6s;
        "pkg-v1.0-1.21" = _uuzgo0ty;
        "pkg-v1.1+1.21" = _Ke8ZTHuc;
        "pkg-v1.1+1.21.1" = _812gKIoC;
        "pkg-v1.1+1.21.2" = _Q6S9YwJc;
        "pkg-v1.1+1.21.3" = _89BQtETR;
        "pkg-v1.1+1.21.4" = _uGkW39kG;
        "pkg-v1.1+1.21.5" = _B9pLSraz;
        "pkg-v1.2+1.21" = _cp8fjVco;
        "pkg-v1.2+1.21.1" = _n8CQVV9g;
        "pkg-2.0.0+1.21" = _Nk5HvZgB;
        "pkg-2.0.0+1.21.1" = _S0oUqbc7;
        "pkg-2.0.0+1.21.2" = _xa1cLGNg;
        "pkg-2.0.0+1.21.3" = _abSpXtsT;
        "pkg-2.0.0+1.21.4" = _ZxpwWwRW;
        "pkg-2.0.0+1.21.5" = _UDCu54d1;
        "pkg-2.0.0+1.21.6" = _phv4JqpF;
        "pkg-2.0.0+1.21.7" = _7lBvZgrD;
        "pkg-2.0.0+1.21.8" = _qqpgyTCf;
        "pkg-2.0.0+1.21.9" = _ykuZWmMu;
        "pkg-2.0.0+1.21.10" = _BKiVpZ4I;
        "pkg-2.0.1+1.21" = _HGjW9tEz;
        "pkg-2.0.1+1.21.1" = _21gCfvjt;
        "pkg-2.0.1+1.21.2" = _QXkw8kVW;
        "pkg-2.0.1+1.21.3" = _tTTs8tMV;
        "pkg-2.0.1+1.21.4" = _X2l60JUo;
        "pkg-2.0.1+1.21.5" = _sepBBvRt;
        "pkg-2.0.1+1.21.6" = _YCQUdIrl;
        "pkg-2.0.1+1.21.7" = _i7Z5Zq4v;
        "pkg-2.0.1+1.21.8" = _10qk16rb;
        "pkg-2.0.1+1.21.9" = _yI9zAYEy;
        "pkg-2.0.1+1.21.10" = _P7SnVRSF;
        "pkg-2.1.0+1.21" = _4EY0thIa;
        "pkg-2.1.0+1.21.1" = _oO5xuNVb;
        "pkg-2.1.0+1.21.2" = _Sxdb6B0x;
        "pkg-2.1.0+1.21.3" = _lmhdHoAA;
        "pkg-2.1.0+1.21.4" = _ohnx4nxc;
        "pkg-2.1.0+1.21.5" = _PgkanNDw;
        "pkg-2.1.0+1.21.6" = _Lb56p8ke;
        "pkg-2.1.0+1.21.7" = _sg2TnIg9;
        "pkg-2.1.0+1.21.8" = _cvENSUTJ;
        "pkg-2.1.0+1.21.9" = _qRW4fpAQ;
        "pkg-2.1.0+1.21.10" = _KEU30NOb;
        "default" = _KEU30NOb;
    });
