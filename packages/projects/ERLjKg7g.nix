...
let
    ...
    in {
        ...
        "pkg-1.0" = _kPxvuHog;
        "pkg-1.0_mod" = _xKHATB8n;
        "pkg-1.1" = _3tvAZngz;
        "pkg-1.2" = _HquXC7Bj;
        "pkg-1.2+mod" = _BQy8OZyu;
        "pkg-1.3" = _ucXBmRmO;
        "pkg-1.3+mod" = _4wkzdXaF;
        "pkg-1.4" = _YqncTWdI;
        "pkg-1.4+mod" = _DJ0Pchb4;
        "pkg-2.0" = _IGvFU4Fr;
        "pkg-2.0+mod" = _eehmcCrK;
        "pkg-2.1" = _QLm7IizN;
        "pkg-3.0" = _I6bDQmOC;
        "pkg-3.0+mod" = _xWhEHRwl;
        "pkg-3.1" = _PTXhchF7;
        "pkg-3.1+mod" = _Y7N8Otou;
        "pkg-3.2" = _kUSz4agq;
        "pkg-3.2+mod" = _OY3QunSb;
        "pkg-3.3" = _pHtJFore;
        "pkg-3.3+mod" = _L7IkjDlN;
        "pkg-3.4" = _KLXwp4uX;
        "pkg-3.4+mod" = _i1lGz5Hu;
        "pkg-3.5" = _g2jV9Zsi;
        "pkg-3.5+mod" = _yH7r8Sp9;
        "pkg-3.6" = _6jEMZ5dC;
        "pkg-3.6+mod" = _4W2UYxP1;
        "pkg-3.7" = _97btTTgZ;
        "pkg-3.7-fabric" = _a7vJIZZD;
        "pkg-3.7-forge" = _Nets0DA4;
        "pkg-3.11" = _6lQfrj4c;
        "pkg-3.11-fabric" = _JlwKG4pJ;
        "pkg-3.11-quilt" = _sj34pagq;
        "pkg-3.11-forge" = _1ylxcB1H;
        "pkg-3.11-neoforge" = _ufn4gUri;
        "pkg-3.12" = _XxLFGhRB;
        "pkg-3.12-fabric" = _FSM1xzHa;
        "pkg-3.12-quilt" = _pLDJbWDd;
        "pkg-3.12-forge" = _9v86R7r7;
        "pkg-3.12-neoforge" = _5rwn64St;
        "default" = _5rwn64St;
    });
