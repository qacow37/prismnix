...
let
    ...
    in {
        ...
        "pkg-4.9.0" = _c5yy21i0;
        "pkg-4.9.1" = _rZtJQEKa;
        "pkg-1.0.0.develop.17" = _12CCELoa;
        "pkg-1.0.0.develop.18" = _KudQ1J5Q;
        "pkg-1.0.0.develop.19" = _VqIox692;
        "pkg-1.0.0.develop.20" = _nF6t6s9s;
        "pkg-1.0.0.develop.3" = _ULOrNYvg;
        "pkg-1.0.0.develop.6" = _AjuPDJYZ;
        "pkg-1.0.0.develop.8" = _RDa5vKEG;
        "pkg-1.0.0.develop.9" = _fiYSEhLJ;
        "pkg-1.0.0.develop.10" = _CByATNYp;
        "pkg-1.0.0.develop.11" = _fKE8efIv;
        "pkg-1.0.0.develop.12" = _X0VqWwU1;
        "pkg-1.0.0.develop.13" = _ThSHZ9T5;
        "pkg-1.0.0.develop.14" = _EiJxrpx8;
        "pkg-1.0.0.develop.15" = _6UDbPrvP;
        "pkg-1.0.0.develop" = _RFewNOVW;
        "pkg-4.10.0" = _OLf2bSqp;
        "pkg-1.0.0.develop.22" = _CfoF9mFC;
        "pkg-1.0.0.develop.24" = _NsxnU4Cn;
        "pkg-1.0.0.develop.25" = _lzFJomWO;
        "pkg-1.0.0.develop.26" = _gMMMWzGJ;
        "pkg-1.0.0.develop.28" = _M2v8IIsq;
        "pkg-1.0.0.develop.29" = _GChbVBdn;
        "pkg-1.0.0.develop.30" = _wg55Irlx;
        "pkg-1.0.0.develop.31" = _WdniAZTH;
        "pkg-1.0.0.develop.32" = _HNPphGC7;
        "pkg-1.0.0.develop.33" = _69o4hfby;
        "pkg-1.0.0.develop.34" = _GnU0acOH;
        "pkg-1.0.0.develop.35" = _NmrM9BYi;
        "pkg-1.0.0.develop.36" = _A2prbOsw;
        "pkg-1.0.0+4" = _wKQmq1sf;
        "pkg-1.0.0+5" = _y3w9zkVr;
        "pkg-1.0.0+6" = _EzTyEs2D;
        "pkg-1.0.0+7" = _K1YKfUEa;
        "pkg-1.0.0+8" = _apQS8JWx;
        "pkg-1.0.0+9" = _hAWpKELL;
        "pkg-1.0.0+10" = _cRX0FoPD;
        "pkg-1.0.0+11" = _KzHgalE3;
        "pkg-1.0.0+13" = _szdMln6Y;
        "default" = _szdMln6Y;
    });
