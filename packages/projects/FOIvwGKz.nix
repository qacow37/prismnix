...
let
    ...
    in {
        ...
        "pkg-1.3.4" = _lhEVLHnb;
        "pkg-1.3.5" = _a4JKd3px;
        "pkg-1.4.0+neoforge-1.21.4" = _tcsOXrMm;
        "pkg-1.4.0+fabric-1.21.4" = _ptnlL4Gw;
        "pkg-1.4.0+neoforge-1.21" = _ebjl9fBi;
        "pkg-1.4.0+fabric-1.21" = _slfl85aS;
        "pkg-1.4.2+neoforge-1.21.5" = _6Ulv0aTI;
        "pkg-1.4.2+fabric-1.21.5" = _RtAvYAVi;
        "pkg-1.4.2+neoforge-1.21.4" = _C1Vzsy5G;
        "pkg-1.4.2+fabric-1.21.4" = _g0ajkvKS;
        "pkg-1.4.2+neoforge-1.21" = _32H7ls1w;
        "pkg-1.4.2+fabric-1.21" = _4ISZFjVj;
        "pkg-1.4.3+neoforge-1.21.5" = _6gT5D7Sa;
        "pkg-1.4.3+fabric-1.21.5" = _jRw134KJ;
        "pkg-1.4.3+neoforge-1.21.4" = _ZDMhFik5;
        "pkg-1.4.3+fabric-1.21.4" = _p8OBAH4I;
        "pkg-1.4.3+neoforge-1.21" = _ggAWnd6a;
        "pkg-1.4.3+fabric-1.21" = _j8rN09RW;
        "pkg-1.4.4+neoforge-1.21.5" = _H0s3pXRL;
        "pkg-1.4.4+fabric-1.21.5" = _OsqBANO8;
        "pkg-1.4.4+neoforge-1.21.4" = _mmwtum5t;
        "pkg-1.4.4+neoforge-1.21" = _Ym9PaSQ5;
        "pkg-1.4.4+fabric-1.21.4" = _faIxvIOY;
        "pkg-1.4.4+fabric-1.21" = _EFrtIUld;
        "pkg-1.4.4+fabric-1.19.4" = _1IGfIRWb;
        "pkg-1.4.5+neoforge-1.21.5" = _yedyJy7M;
        "pkg-1.4.5+fabric-1.21.5" = _37ZUpujd;
        "pkg-1.4.5+neoforge-1.21.4" = _F6EvNvp0;
        "pkg-1.4.5+fabric-1.21.4" = _vNfSQQfC;
        "pkg-1.4.5+neoforge-1.21" = _gJji1fQ2;
        "pkg-1.4.5+fabric-1.21" = _F2FzvDdC;
        "pkg-1.4.5+fabric-1.19.4" = _DekJ5Ovs;
        "pkg-1.4.6+neoforge-1.21.5" = _vvRa4xwO;
        "pkg-1.4.6+neoforge-1.21.4" = _gpvZ1X0o;
        "pkg-1.4.6+fabric-1.21.5" = _Hkzf0HPx;
        "pkg-1.4.6+fabric-1.21.4" = _FNNZti43;
        "pkg-1.4.6+neoforge-1.21" = _NEcC4DHk;
        "pkg-1.4.6+fabric-1.19.4" = _DizLo1TX;
        "pkg-1.4.6+fabric-1.21" = _oaqagmk3;
        "pkg-1.4.7+fabric-1.21.6" = _Y42eWl0q;
        "pkg-1.4.7+neoforge-1.21.6" = _bQ4ZAy9H;
        "pkg-1.4.7+neoforge-1.21.5" = _qvlERNRH;
        "pkg-1.4.7+fabric-1.21.5" = _YhRF9EOF;
        "pkg-1.4.7+neoforge-1.21.4" = _y2CuQSNN;
        "pkg-1.4.7+fabric-1.21.4" = _KfFIHL2l;
        "pkg-1.4.7+neoforge-1.21" = _AMwGCqy0;
        "pkg-1.4.7+fabric-1.21" = _hL4mXYOP;
        "pkg-1.4.7+fabric-1.19.4" = _HPIABBTk;
        "pkg-1.4.8+fabric-1.21.9" = _n91efLbw;
        "pkg-1.4.8+neoforge-1.21.9" = _Ve0jPms1;
        "pkg-1.4.8+neoforge-1.21.6" = _nsr95RDS;
        "pkg-1.4.8+fabric-1.21.6" = _BX4KXooG;
        "pkg-1.4.8+neoforge-1.21.5" = _UI7myHnE;
        "pkg-1.4.8+neoforge-1.21.4" = _fYaHQMNR;
        "pkg-1.4.8+fabric-1.21.5" = _SBzThLKu;
        "pkg-1.4.8+fabric-1.21.4" = _zB7dG9H3;
        "pkg-1.4.8+neoforge-1.21" = _tg817LJY;
        "pkg-1.4.8+fabric-1.19.4" = _jT63Rz3I;
        "pkg-1.4.8+fabric-1.21" = _8Ea2FkNM;
        "pkg-1.4.9+neoforge-1.21.9" = _Lyr1Cu1M;
        "pkg-1.4.9+fabric-1.21.9" = _E1NbNaFS;
        "pkg-1.4.9+neoforge-1.21.6" = _YAOxwotz;
        "pkg-1.4.9+fabric-1.21.6" = _PBXpA77e;
        "pkg-1.4.9+neoforge-1.21.5" = _eClkB117;
        "pkg-1.4.9+fabric-1.21.5" = _tXOG5U7J;
        "pkg-1.4.9+neoforge-1.21.4" = _A6sjPQtY;
        "pkg-1.4.9+fabric-1.21.4" = _YETYwjpp;
        "pkg-1.4.9+neoforge-1.21" = _WSmnDEhw;
        "pkg-1.4.9+fabric-1.21" = _ZNAxajU8;
        "pkg-1.4.9+fabric-1.19.4" = _wE4qPHaz;
        "pkg-1.4.10+fabric-1.19.4" = _zZECk5qs;
        "pkg-1.4.10+fabric-1.21" = _R1sBRDqo;
        "pkg-1.4.10+neoforge-1.21" = _GEb93zDF;
        "pkg-1.4.10+fabric-1.21.4" = _QfI0L9Nv;
        "pkg-1.4.10+neoforge-1.21.4" = _i4Ly5kii;
        "pkg-1.4.10+fabric-1.21.5" = _JIy9kOm0;
        "pkg-1.4.10+neoforge-1.21.5" = _96l7SJjV;
        "pkg-1.4.10+fabric-1.21.6" = _DU6Wb5t8;
        "pkg-1.4.10+neoforge-1.21.6" = _Op36Nk7C;
        "pkg-1.4.10+fabric-1.21.9" = _79o20fmJ;
        "pkg-1.4.10+neoforge-1.21.9" = _eeUgD12R;
        "pkg-1.4.10+fabric-1.21.11" = _m870aqpf;
        "pkg-1.4.10+neoforge-1.21.11" = _aaHdFfC6;
        "pkg-1.5.0+fabric-1.19.4" = _v7BxvuqK;
        "pkg-1.5.0+fabric-1.21" = _TqIbY7i1;
        "pkg-1.5.0+neoforge-1.21" = _Wx1o86lv;
        "pkg-1.5.0+fabric-1.21.4" = _QAcpGnsm;
        "pkg-1.5.0+neoforge-1.21.4" = _cc0p7nB4;
        "pkg-1.5.0+fabric-1.21.5" = _xSBEBgvj;
        "pkg-1.5.0+neoforge-1.21.5" = _D6INbekN;
        "pkg-1.5.0+neoforge-1.21.6" = _EiYfyj5Y;
        "pkg-1.5.0+fabric-1.21.6" = _xILTu60E;
        "pkg-1.5.0+fabric-1.21.9" = _pW0duwIC;
        "pkg-1.5.0+neoforge-1.21.9" = _TdEGsT5s;
        "pkg-1.5.0+fabric-1.21.11" = _Qax1h3iL;
        "pkg-1.5.0+neoforge-1.21.11" = _i1FEDMUg;
        "pkg-1.5.0+fabric-26.1.2" = _blRhQpuL;
        "pkg-1.5.0+neoforge-26.1.2" = _qQ5QYqZl;
        "pkg-1.5.1+fabric-1.19.4" = _Lt4X9FNl;
        "pkg-1.5.1+fabric-1.21" = _p5Y7B5XI;
        "pkg-1.5.1+neoforge-1.21" = _9xHC9QUb;
        "pkg-1.5.1+fabric-1.21.4" = _QZazMeWV;
        "pkg-1.5.1+neoforge-1.21.4" = _j7mafE3U;
        "pkg-1.5.1+fabric-1.21.5" = _zIbq1odv;
        "pkg-1.5.1+neoforge-1.21.5" = _IhmKch9x;
        "pkg-1.5.1+fabric-1.21.6" = _raci3cmj;
        "pkg-1.5.1+neoforge-1.21.6" = _orT1UVCd;
        "pkg-1.5.1+fabric-1.21.9" = _dSdxpIQ3;
        "pkg-1.5.1+neoforge-1.21.9" = _4nYDcUxi;
        "pkg-1.5.1+fabric-1.21.11" = _VwMy5J0x;
        "pkg-1.5.1+neoforge-1.21.11" = _1wgFk4au;
        "pkg-1.5.1+fabric-26.1.2" = _AEFzT1I9;
        "pkg-1.5.1+neoforge-26.1.2" = _BmDWQouX;
        "pkg-1.5.2+fabric-1.21" = _N0GVB9DV;
        "pkg-1.5.2+fabric-1.19.4" = _4U3aDYQs;
        "pkg-1.5.2+neoforge-1.21" = _v33OJbLO;
        "pkg-1.5.2+fabric-1.21.4" = _RvxX8jO4;
        "pkg-1.5.2+neoforge-1.21.4" = _sEtQRpG1;
        "pkg-1.5.2+fabric-1.21.5" = _O3POlfwL;
        "pkg-1.5.2+neoforge-1.21.5" = _T39A8PKR;
        "pkg-1.5.2+fabric-1.21.6" = _AMAocQQY;
        "pkg-1.5.2+neoforge-1.21.6" = _iXjPAR9g;
        "pkg-1.5.2+fabric-1.21.9" = _fVoKOT3P;
        "pkg-1.5.2+neoforge-1.21.9" = _iDGxyiGm;
        "pkg-1.5.2+fabric-1.21.11" = _It4jA3OD;
        "pkg-1.5.2+neoforge-1.21.11" = _Tp8hnNNJ;
        "pkg-1.5.2+fabric-26.1.2" = _dFV1XbeR;
