...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _4Zckjspt;
        "pkg-1.1" = _mO1D3gVh;
        "pkg-1.2.8-1.20.1-beta" = _tl0REvkI;
        "pkg-1.2.9-1.20.1-beta" = _WH7BB3A6;
        "pkg-1.2.10-1.20.1-beta" = _dSzq3oaM;
        "pkg-1.2.11-1.20.1-beta" = _HqCntFGZ;
        "pkg-1.2.12-1.20.1-beta" = _r3uoidRs;
        "pkg-1.2.13-1.20.1-beta" = _ka9bPKWf;
        "pkg-1.2.14-1.20.1-beta" = _PSGRMhM8;
        "pkg-1.2.15-1.20.1-beta" = _7MnI7jBN;
        "pkg-1.2.16-1.20.1-beta" = _PfeeaCmP;
        "pkg-1.2.17-1.20.1-beta" = _XIQ27K4b;
        "pkg-1.2.18-1.20.1-beta" = _tYHuh7V3;
        "pkg-1.2.19-1.20.1-beta" = _rtGXM7j0;
        "pkg-1.2.20-1.20.1-beta" = _cOy9ccUP;
        "pkg-1.2.21-1.20.1-beta" = _m6nMPf99;
        "pkg-1.2.22-1.20.1-beta" = _3zWYUggJ;
        "pkg-1.2.23-1.20.1-beta" = _tN6293EE;
        "pkg-1.2.24-1.20.1-beta" = _OSQN9G96;
        "pkg-1.2.25-1.20.1-beta" = _1zZVJ0w5;
        "pkg-1.2.26-1.20.1-beta" = _xxzQDnnx;
        "pkg-1.2.27-1.20.1-beta" = _tiD2OL0S;
        "pkg-1.2.28-1.20.1-beta" = _rCG5wELf;
        "pkg-1.2.29-1.20.1-beta" = _zgXeVxbG;
        "pkg-1.2.30-1.20.1-beta" = _Wy2Q87dC;
        "pkg-1.2.31-1.20.1-beta" = _jzBC95Tn;
        "pkg-1.2.32-1.20.1-beta" = _iDexvsw5;
        "pkg-1.2.33-1.20.1-beta" = _BgAR0TEj;
        "pkg-1.2.34-1.20.1-beta" = _oYgC4Ztz;
        "pkg-1.2.35-1.20.1-beta" = _G8hAHam3;
        "pkg-1.2.36-1.20.1-beta" = _dV2YzPTG;
        "pkg-1.2.38-1.20.1-beta" = _fd2gWJ9X;
        "pkg-1.2.39-1.20.1-beta" = _fYstii7L;
        "pkg-1.2.40-1.20.1-beta" = _1vGwWg8l;
        "pkg-1.2.41-1.20.1-beta" = _FJqi6oE5;
        "pkg-1.2.42-1.20.1-beta" = _bB7NCqjq;
        "pkg-1.2.43-1.20.1-beta" = _W5ml9TdQ;
        "pkg-1.2.44-1.20.1-beta" = _qy1yalxF;
        "pkg-1.2.45-1.20.1-beta" = _rF1MuYcT;
        "pkg-1.2.46-1.20.1-beta" = _h4B6qMJg;
        "pkg-1.3.0-1.20.1-beta" = _7m34by5d;
        "pkg-1.3.1-1.20.1-beta" = _jhBhxWcW;
        "pkg-1.3.2-1.20.1-beta" = _vx2b8JQw;
        "pkg-1.0.0-1.20.1-release" = _jfZj0OIO;
        "pkg-1.0.1-1.20.1-release" = _8KFDyg7v;
        "pkg-1.0.2-1.20.1-release" = _TM6hVuX1;
        "pkg-1.0.3-1.20.1-release" = _sO66eGTy;
        "pkg-1.0.4-1.20.1-release" = _3H0Pm1Jl;
        "pkg-1.0.4-HOTFIX-1.20.1-release" = _eI95jRqz;
        "pkg-1.0.5-1.20.1-release" = _vR39rYvm;
        "pkg-1.1.0.1167-1.20.1-release" = _eGU4HgFV;
        "pkg-1.2.0.2757-1.20.1-release" = _PaFqudHe;
        "pkg-1.2.0.2776-1.20.1" = _JZ2FXSEz;
        "pkg-1.2.0.2786-1.20.1" = _ZhYLty4p;
        "pkg-1.2.0.2788-1.20.1" = _7BuAFo2l;
        "pkg-1.2.0.2805-1.20.1" = _t5s9QWoA;
        "pkg-1.2.1.2808-1.20.1-release" = _TRbSZ6VU;
        "pkg-1.2.2.2809-1.20.1-release" = _j3IxHu2V;
        "pkg-1.2.3.2810-1.20.1-release" = _g73HgPw2;
        "pkg-1.2.4.2811-1.20.1-release" = _V8PMGLDj;
        "pkg-1.2.5.2812-1.20.1-release" = _f5kSb0JI;
        "pkg-1.2.6.2818-1.20.1-release" = _M9zBjv7C;
        "pkg-1.2.7.2820-1.20.1-release" = _wafyV92t;
        "pkg-1.2.9.2823-1.20.1-release" = _BZsFt7sC;
        "pkg-1.2.10.2824-1.20.1-release" = _dkk7bTqy;
        "pkg-1.2.11.2825-1.20.1-release" = _vQBXcmCj;
        "pkg-1.2.12-release+mc.1.20.1" = _iqoMsymS;
        "default" = _iqoMsymS;
    });
