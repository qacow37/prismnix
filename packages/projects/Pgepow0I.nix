...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.1-fabric+forge" = _KaTB20Uq;
        "pkg-1.20.1-1.1-fabric+forge+neo" = _OP7Aj8t0;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _BbWeineT;
        "pkg-1.19.2-1.2-fabric+forge" = _gPJUmgh1;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _f88ZyMrC;
        "pkg-1.20.4-1.2-fabric+forge+neo" = _ad0rMNto;
        "pkg-1.19.2-1.3-fabric+forge" = _BxvVS6Ts;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _gXdZdN8Q;
        "pkg-1.20.4-1.3-fabric+forge+neo" = _ph9DW3fM;
        "pkg-1.20.5-1.3-fabric+neo" = _aeSpfZVa;
        "pkg-1.20.6-1.3-fabric+forge+neo" = _xNGSQ7OQ;
        "pkg-1.21.0-1.3-fabric+forge+neo" = _qVInEg8y;
        "pkg-1.21.0-1.4-fabric+forge+neo" = _wh5wLYtb;
        "pkg-1.20.1-1.5-fabric+forge+neo" = _uOuM9EDg;
        "pkg-1.20.6-1.5-fabric+forge+neo" = _g6pJ8OO4;
        "pkg-1.21.0-1.5-fabric+forge+neo" = _zVRArzri;
        "pkg-1.21.1-1.5-fabric+forge+neo" = _fUAiUar3;
        "pkg-1.21.2-1.5-fabric+neo" = _PYpJIKSR;
        "pkg-1.21.3-1.5-fabric+forge+neo" = _6uvVGOWz;
        "pkg-1.21.4-1.5-fabric+forge+neo" = _IdujDcOO;
        "pkg-1.20.1-1.6-fabric+forge+neo" = _zrHekvY9;
        "pkg-1.21.1-1.6-fabric+forge+neo" = _MN1vYfVM;
        "pkg-1.21.4-1.6-fabric+forge+neo" = _6BZAPXHh;
        "pkg-1.21.5-1.6-fabric+forge+neo" = _wTBUDkX4;
        "pkg-1.21.5-1.7-fabric+forge+neo" = _q6Y9mKly;
        "pkg-1.21.6-1.7-fabric+forge+neo" = _HK6ZeoZY;
        "pkg-1.21.7-1.7-fabric+forge+neo" = _62MFt5aa;
        "pkg-1.21.8-1.7-fabric+forge+neo" = _Kv1RI5Le;
        "pkg-1.21.9-1.7-fabric+forge+neo" = _VUdisX4p;
        "pkg-1.21.9-1.8-fabric+forge+neo" = _VUpi2KwJ;
        "pkg-1.21.10-1.8-fabric+forge+neo" = _yKqb9AuX;
        "pkg-1.21.11-1.8-fabric+forge+neo" = _YB3XBpoU;
        "pkg-26.1.0-1.8-fabric+forge+neo" = _2Mzhf0Ew;
        "pkg-26.1.1-1.8-fabric+forge+neo" = _ClvbkJbg;
        "pkg-26.1.2-1.8-fabric+forge+neo" = _37cQrQRY;
        "pkg-26.1.2-1.9-fabric+forge+neo" = _YGuXs1TR;
        "pkg-1.20.1-2.0-fabric+forge+neo" = _71PON4q4;
        "pkg-1.21.1-2.0-fabric+forge+neo" = _dZW5aH1q;
