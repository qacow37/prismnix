...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.1-fabric" = _4txAS9QF;
        "pkg-1.0.0+1.21.1-neoforge" = _tQhI2uDN;
        "pkg-1.0.0+1.21.10-fabric" = _oymvmhap;
        "pkg-1.0.0+1.21.10-neoforge" = _lPjffNJL;
        "pkg-1.0.1+1.20.1-fabric" = _nwUPBUBL;
        "pkg-1.0.1+1.21.1-fabric" = _qSLwAlFb;
        "pkg-1.0.1+1.21.1-neoforge" = _5a20QQEg;
        "pkg-1.0.1+1.21.8-fabric" = _MVoQYaHG;
        "pkg-1.0.1+1.21.10-fabric" = _fqGGny9T;
        "pkg-1.0.1+1.21.10-neoforge" = _R13XB2W9;
        "pkg-1.0.2+1.20.1-fabric" = _5qXd8RMt;
        "pkg-1.0.3+1.20.1-fabric" = _FKFRsvZF;
        "pkg-1.0.3+1.21.1-fabric" = _npaaG0OL;
        "pkg-1.0.3+1.21.1-neoforge" = _WLD710NS;
        "pkg-1.0.3+1.21.8-fabric" = _Jjbyjub6;
        "pkg-1.0.3+1.21.10-fabric" = _TtMSbUaz;
        "pkg-1.0.3+1.21.10-neoforge" = _pOZapsft;
        "pkg-1.0.4+1.21.1-fabric" = _oZwwEqaj;
        "pkg-1.0.4+1.21.1-neoforge" = _lLvqNv3H;
        "pkg-1.0.4+1.21.8-fabric" = _bnquCOFQ;
        "pkg-1.0.4+1.21.10-fabric" = _CnriYlNB;
        "pkg-1.0.4+1.21.10-neoforge" = _IPKatUk8;
        "pkg-1.0.4+1.21.11-fabric" = _pzZ7fqlk;
        "pkg-1.0.4+1.21.11-neoforge" = _jlK15XQO;
        "pkg-1.0.4+26.1-snapshot-1-fabric" = _cnBgAJXu;
        "pkg-1.0.4+26.1-snapshot-4-fabric" = _IU6mpNF6;
        "pkg-1.1.0+1.20.1-forge" = _ckMiX7UM;
        "pkg-1.1.0+1.21.1-fabric" = _sVBmpMni;
        "pkg-1.1.0+1.21.1-neoforge" = _yWhjRH1D;
        "pkg-1.1.0+26.1-snapshot-4-fabric" = _upoyjWTC;
        "pkg-1.1.0+26.1-snapshot-7-fabric" = _oIZIenXN;
