...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.20.2" = _F9CJpwj4;
        "pkg-0.1.1+1.20.2" = _NJnwDh0Y;
        "pkg-0.1.2+1.20.2" = _l32w3Gux;
        "pkg-0.1.3+1.20.2" = _4oxQYHjK;
        "pkg-0.2.0+1.20.2" = _61pXVOcd;
        "pkg-0.2.1+1.20.2" = _QQQ7Vk9M;
        "pkg-0.2.1+1.20.4" = _a8oRoZnu;
        "pkg-0.2.1+1.20.1" = _OYNHhgde;
        "pkg-0.2.1+1.20" = _vOeEdlXS;
        "pkg-0.2.1+1.19.4" = _IKmXCtsy;
        "pkg-0.2.2+1.20.4" = _1s81IiDt;
        "pkg-0.2.4+1.20.4" = _nvd66GsX;
        "pkg-0.3.0+1.20.4" = _5SUKdCoB;
        "pkg-0.4.0+1.20.4" = _QA4NxOox;
        "pkg-0.4.1+1.20.4" = _I1IlpMlX;
        "pkg-0.4.2+1.20.4" = _yvql7Bsv;
        "pkg-0.5.0+1.20.4" = _9wjyJil0;
        "pkg-0.5.1+1.20.4" = _AWsO796N;
        "pkg-0.5.3+1.20.4" = _mg7aIX4v;
        "pkg-0.5.4+1.20.4" = _GkuGMUrV;
        "pkg-0.5.5+1.20.4" = _DhZNv8KF;
        "pkg-0.6.0+1.20.4" = _o07dQR5R;
        "pkg-0.7.0+1.20.6" = _rqv1Ft7U;
        "pkg-0.7.1+1.20.6" = _3IR578bo;
        "pkg-0.7.2+1.20.6" = _yvsQmhTz;
        "pkg-0.7.3+1.20.6" = _fzwUBvOM;
        "pkg-0.7.4+1.20.6" = _JMXKnTDn;
        "pkg-0.7.5+1.20.6" = _W3q6VvLu;
        "pkg-0.8.0+1.21.1" = _CfWvv6Gz;
        "pkg-0.7.6+1.20.6" = _p71sxTAL;
        "pkg-0.7.7+1.20.6" = _p177YRVY;
        "pkg-0.7.8+1.20.6" = _ncYZeUhZ;
        "pkg-0.7.9+1.20.6" = _RASUt1Yi;
        "default" = _RASUt1Yi;
    });
