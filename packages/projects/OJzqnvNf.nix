...
let
    ...
    in {
        ...
        "pkg-mc1.21.9-1.21.10-0.1.0" = _OqDH7DNY;
        "pkg-mc1.21.6-1.21.8-0.1.0" = _h58WYkbM;
        "pkg-mc1.21.5-0.1.0" = _RO12eQ9e;
        "pkg-mc1.21.2-1.21.4-0.1.0" = _JG5GHdYM;
        "pkg-mc1.21-1.21.1-0.1.0" = _Bb0v2drh;
        "pkg-0.1.0" = _49xW9gyV;
        "pkg-0.2.10+mc1.21.9" = _7OADTMwu;
        "pkg-0.2.10+mc1.21.10" = _cxtCLYEQ;
        "pkg-0.2.10+mc1.21.11" = _NXsn3kVX;
        "pkg-0.2.10+mc1.21.2" = _hYfC7pbQ;
        "pkg-0.2.10+mc1.21.3" = _or92t5Tf;
        "pkg-0.2.10+mc1.21.4" = _5du3duY0;
        "pkg-0.2.10+mc1.21.5" = _10WT8DqK;
        "pkg-0.2.10+mc1.21.6" = _D777mWfP;
        "pkg-0.2.10+mc1.21.7" = _2xWXfOxm;
        "pkg-0.2.10+mc1.21.8" = _FWCX4tm7;
        "pkg-0.2.10+mc1.21" = _wpDS3ihe;
        "pkg-0.2.10+mc1.21.1" = _MUMAJawQ;
        "pkg-0.2.10+mc1.20.1" = _nr7rGHDF;
        "pkg-0.2.10+mc1.19.2" = _eArKIOUM;
        "pkg-0.2.11+mc1.19.2" = _5cMAOjFt;
        "pkg-0.2.11+mc1.20.1" = _Q7EvrOzE;
        "pkg-0.2.11+mc1.21" = _WgGfhb6o;
        "pkg-0.2.11+mc1.21.1" = _TttAeJc7;
        "pkg-0.2.11+mc1.21.2" = _IPYyFvfg;
        "pkg-0.2.11+mc1.21.3" = _FFWOZxTV;
        "pkg-0.2.11+mc1.21.4" = _O3PRgyj2;
        "pkg-0.2.11+mc1.21.5" = _1tfcgMsI;
        "pkg-0.2.11+mc1.21.6" = _8guQv2yH;
        "pkg-0.2.11+mc1.21.7" = _vmVkqBaZ;
        "pkg-0.2.11+mc1.21.8" = _NiEGDbA5;
        "pkg-0.2.11+mc1.21.9-1.21.10" = _m3u80GGv;
        "pkg-0.2.11+mc1.21.11" = _O91V2HuA;
        "pkg-0.2.11+mc26.1-26.1.2" = _ySToQTwl;
        "pkg-0.2.11+mc26.2" = _xQrQqkGb;
        "default" = _xQrQqkGb;
    });
