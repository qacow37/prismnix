...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.21.1" = _g9K0IUOb;
        "pkg-1.0.1+mc1.21" = _p47tkp91;
        "pkg-1.0.0+mc1.21.2" = _l5Qw3GHI;
        "pkg-1.0.0+mc1.21.5" = _2V4xbvCf;
        "pkg-1.0.0+mc1.21.6" = _aDHK9Hxj;
        "pkg-1.0.0+mc1.20" = _hQfmFlJf;
        "pkg-1.0.0+mc1.20.2" = _zQqW52mn;
        "pkg-1.0.0+mc1.20.6" = _lbHqDlZ0;
        "pkg-1.0.0+mc1.19.4" = _J3GnEn24;
        "pkg-1.0.0+mc1.21.9" = _txC2GjYp;
        "pkg-1.0.0+mc1.21.10" = _qDyL5M2e;
        "pkg-1.0.1+mc1.21.6" = _2tJeSS6e;
        "pkg-1.0.1+mc1.21.9" = _HdkIKdoc;
        "pkg-1.0.2+mc1.21.6" = _NEiIP4ct;
        "pkg-1.0.1+mc1.21.5" = _eCwQzrVI;
        "pkg-1.0.1+mc1.21.2" = _sJ3lUvqb;
        "pkg-1.0.0+mc1.21.11" = _Zhd0nNlG;
        "pkg-1.0.1+mc1.21.11" = _9BVLFXS4;
        "pkg-1.0.0+mc26.1" = _CgxHO8Lz;
        "pkg-1.0.2+mc1.21.11" = _JGkg4mvo;
        "pkg-1.0.1+mc26.1" = _6ubXt5Qk;
        "pkg-1.0.0+mc26.2" = _plkP9uaP;
        "default" = _plkP9uaP;
    });
