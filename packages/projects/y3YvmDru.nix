...
let
    ...
    in {
        ...
        "pkg-0.0.2+mc1.19" = _AHOkFcFG;
        "pkg-0.0.2+mc1.19.1" = _a1c6YM34;
        "pkg-0.0.2+mc1.19.2" = _IhylwY6D;
        "pkg-0.0.2+mc1.19.3" = _R7lSF545;
        "pkg-0.0.2+mc1.19.4" = _LsQPsSWY;
        "pkg-0.1.0+mc1.19" = _shd93Ahz;
        "pkg-0.1.0+mc1.19.1" = _ybuXTgjN;
        "pkg-0.1.0+mc1.19.2" = _JkMTjAEN;
        "pkg-0.1.0+mc1.19.3" = _TgLovlkb;
        "pkg-0.1.0+mc1.19.4" = _2P6tIeIw;
        "pkg-0.1.1+mc1.19" = _5yaNM2V8;
        "pkg-0.1.1+mc1.19.1" = _7QNTNbB7;
        "pkg-0.1.1+mc1.19.2" = _lcLRGjV8;
        "pkg-0.1.1+mc1.19.3" = _vuD7yHQd;
        "pkg-0.1.1+mc1.19.4" = _z8VbeZX3;
        "pkg-0.2.0-beta-2+mc1.19.4" = _kigtXv7G;
        "pkg-0.2.0-beta-3+mc1.19.4" = _JnNfNKNE;
        "pkg-0.2.0+mc1.19" = _lrdXKbUN;
        "pkg-0.2.0+mc1.19.1" = _9AlIzWOf;
        "pkg-0.2.0+mc1.19.2" = _tPlYl2e2;
        "pkg-0.2.0+mc1.19.3" = _6ewZENIM;
        "pkg-0.2.0+mc1.19.4" = _4KMhDWUQ;
        "pkg-0.2.1+mc1.19" = _ZX9yQLMD;
        "pkg-0.2.1+mc1.19.1" = _rH7zCl0i;
        "pkg-0.2.1+mc1.19.2" = _N9IZJvv5;
        "pkg-0.2.1+mc1.19.3" = _y0EhNA9w;
        "pkg-0.2.1+mc1.19.4" = _crxsEEfv;
        "pkg-0.3.0+mc1.19" = _cAi0areu;
        "pkg-0.3.0+mc1.19.1" = _mvSVOjYL;
        "pkg-0.3.0+mc1.19.2" = _XfZdb7be;
        "pkg-0.3.0+mc1.19.3" = _R3R9uUL0;
        "pkg-0.3.0+mc1.19.4" = _uBBbrA8k;
        "pkg-0.3.1+mc1.19" = _UyCfqKec;
        "pkg-0.3.1+mc1.19.1" = _HPDRUoGH;
        "pkg-0.3.1+mc1.19.2" = _wAVipbFq;
        "pkg-0.3.1+mc1.19.3" = _C6QsE7AD;
        "pkg-0.3.1+mc1.19.4" = _QdCiTbCJ;
        "pkg-1.0.0+mc1.19" = _5Qolf6se;
        "pkg-1.0.0+mc1.19.1" = _rsC2QINf;
        "pkg-1.0.0+mc1.19.2" = _2qrmZDFN;
        "pkg-1.0.0+mc1.19.3" = _vJnWtAFN;
        "pkg-1.0.0+mc1.19.4" = _tH1iHcol;
        "pkg-1.0.1+mc1.19" = _O1QXwENZ;
        "pkg-1.0.1+mc1.19.1" = _DGfQ6Vzr;
        "pkg-1.0.1+mc1.19.2" = _mv0yiF0g;
        "pkg-1.0.1+mc1.19.3" = _5fJ4qEw6;
        "pkg-1.0.1+mc1.19.4" = _jywOqyTF;
        "pkg-1.0.1+mc1.20" = _Th83Ryd0;
        "pkg-1.0.2-beta.1+mc1.20.1-rc1" = _8BAr7GIN;
        "pkg-1.0.2+mc1.20.1" = _EUu7lF0c;
        "pkg-1.0.3" = _o7t0584p;
        "pkg-1.0.4" = _EhOUAeFn;
        "default" = _EhOUAeFn;
    });
