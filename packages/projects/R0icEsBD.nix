...
let
    ...
    in {
        ...
        "pkg-0.1-1.20.4" = _sW3P50dN;
        "pkg-0.2-1.20.4" = _i9ucpTCq;
        "pkg-0.3-1.20.4" = _AIb4JyRT;
        "pkg-1.0-1.20.4" = _JoycywVK;
        "pkg-1.0-1.20.1" = _qAjx2dEk;
        "pkg-1.1-1.20.1" = _Fb72Tpv9;
        "pkg-1.1-1.20.6" = _yQf2KK8K;
        "pkg-1.2-1.20.6" = _cUUZrUtP;
        "pkg-1.2-1.20.1" = _CrvNQC4C;
        "pkg-1.2-1.21" = _GjuLToFy;
        "pkg-1.2-1.19.2" = _uhW9Fk3n;
        "pkg-1.3-1.19.2" = _FNzEEy6Z;
        "pkg-1.3-1.20.1" = _JdJD3CM8;
        "pkg-1.3-1.21" = _JYF4Ry53;
        "pkg-1.3-1.21.1" = _OeBVt3R5;
        "pkg-1.3.1-1.21.1" = _UsBXAXQT;
        "pkg-1.3.1-1.21.4" = _EkohtICm;
        "pkg-1.3.2-1.19.2" = _YhbHnbZc;
        "pkg-1.3.2-1.20.1" = _rbcDLQQV;
        "pkg-1.3.2-1.21.1" = _V6Po8YSE;
        "pkg-1.3.2-1.21.4" = _wpcgbt4l;
        "pkg-1.3.3-1.21.4" = _YccFx980;
        "pkg-1.19-1.19.2-1.3.3" = _Moy73WIU;
        "pkg-1.20-1.20.2-1.3.3" = _VTgHjbI0;
        "pkg-1.21.1-1.3.3" = _8hNjUwwh;
        "pkg-1.21.2-1.21.4-1.3.3" = _MIdCi2Zn;
        "pkg-1.21.3-1.21.4-1.3.3" = _6xMwHnS8;
        "pkg-(Fabric-1.21.5)-1.3.3" = _HxeZynkn;
        "pkg-(NeoForge-1.21.5)-1.3.3" = _5nf9gcZi;
        "pkg-(forge-1.19-1.19.2)-1.3.4" = _NwQTp9Y1;
        "pkg-(Forge-1.20-1.20.2)-1.3.4" = _exAIrqQg;
        "pkg-(Fabric-1.20-1.20.2)-1.3.4" = _BDgAfYbh;
        "pkg-(Forge-1.20.6)-1.3.4" = _gWP6PerZ;
        "pkg-(Fabric-1.20.6)-1.3.4" = _3vAPBmae;
        "pkg-(Forge-1.21.1)-1.3.4" = _nRjLO3O4;
        "pkg-(Fabric-1.21.1)-1.3.4" = _WfZt7K5K;
        "pkg-(NeoForge-1.21.1)-1.3.4" = _PoBtOcWG;
        "pkg-(Fabric-1.21.2-1.21.4)-1.3.4" = _DBz0dYan;
        "pkg-(NeoForge-1.21.3-1.21.4)-1.3.4" = _TL93FR6P;
        "pkg-(Fabric-1.21.5)-1.3.4" = _LoFKjVks;
        "pkg-(NeoForge-1.21.5)-1.3.4" = _hF14wNYB;
        "pkg-(Fabric-1.21.5-1.21.6)-1.3.4" = _9EScQUNs;
        "pkg-(NeoForge-1.21.5-1.21.6)-1.3.4" = _DQA9ZN8k;
        "pkg-(Fabric-1.21.5-1.21.7)-1.3.4" = _x7xBhK99;
        "pkg-(NeoForge-1.21.5-1.21.7)-1.3.4" = _UA5xj2ra;
        "pkg-(Fabric-1.21.5-1.21.8)-1.3.4" = _nEG8GpfT;
        "pkg-(NeoForge-1.21.5-1.21.8)-1.3.4" = _LaF4buGd;
        "pkg-(Fabric-1.19-1.19.2)-1.3.4" = _yDxmT6Xs;
        "pkg-(Forge-1.19-1.19.2)-2.0" = _VBDCseY4;
        "pkg-(Fabric-1.19-1.19.2)-2.0" = _CMPsc6JB;
        "pkg-(Forge-1.20-1.20.2)-2.0" = _Rq3t2OCU;
        "pkg-(Fabric-1.20-1.20.2)-2.0" = _6cVpZ6Xa;
        "pkg-(Forge-1.20.6)-2.0" = _E0P82bo7;
        "pkg-(Fabric-1.20.6)-2.0" = _W0mY7Pt8;
        "pkg-(Forge-1.21.1)-2.0" = _UaJ72HnP;
        "pkg-(Fabric-1.21.1)-2.0" = _Zc1AbECU;
        "pkg-(NeoForge-1.21.1)-2.0" = _wbllpDa0;
        "pkg-(Fabric-1.21.2-1.21.4)-2.0" = _fBt5UiTr;
        "pkg-(NeoForge-1.21.3-1.21.4)-2.0" = _qhlIJ2mz;
        "pkg-(Fabric-1.21.5-1.21.11)-2.0" = _ZyB6SUOX;
        "pkg-(NeoForge-1.21.5-1.21.8)-2.0" = _o9YvSGpB;
        "pkg-(NeoForge-1.21.11)-2.0" = _tfrQuY39;
        "pkg-(Forge-1.19-1.19.2)-3.0" = _Rv1Ew31K;
        "pkg-(Fabric-1.19-1.19.2)-3.0" = _M6P287YL;
        "pkg-(Forge-1.20-1.20.2)-3.0" = _TxmSNvgL;
        "pkg-(Fabric-1.20-1.20.2)-3.0" = _j8wsCiHw;
        "pkg-(Forge-1.21.1)-3.0" = _tfDsPH4P;
        "pkg-(Fabric-1.21.1)-3.0" = _7YDoK3JG;
        "pkg-(NeoForge-1.21.1)-3.0" = _JxTdPcnL;
        "pkg-(Fabric-1.21.2-1.21.4)-3.0" = _ncRDz3oW;
        "pkg-(NeoForge-1.21.3-1.21.4)-3.0" = _zfsb9MHH;
        "pkg-(Fabric-1.21.5-1.21.11)-3.0" = _XVjDGyom;
        "pkg-(NeoForge-1.21.5-1.21.8)-3.0" = _abxzs5ag;
        "pkg-(NeoForge-1.21.11)-3.0" = _ic8MRY8X;
        "pkg-(Fabric-26.1.x)-3.0" = _tUPcKd2t;
        "pkg-(NeoForge-26.1.x)-3.0" = _O3pQj4VR;
        "default" = _O3pQj4VR;
    });
