...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta" = _pg9bPhey;
        "pkg-2.0.0" = _AvAA1DZw;
        "pkg-2.0.1" = _oFmefaSa;
        "pkg-2.1.0-beta" = _rAdQpXtv;
        "pkg-2.2.0" = _ZpjatZLC;
        "pkg-2.3.0-beta" = _VBvwKwSF;
        "pkg-2.4.0" = _GtCbVulJ;
        "pkg-2.5.0+1.20.5" = _Shn966qJ;
        "pkg-2.5.2-beta" = _JAuziay0;
        "pkg-2.5.3" = _cBh9cR9d;
        "pkg-2.5.4" = _yjhQWnkk;
        "pkg-2.5.5" = _ycpkVLjw;
        "pkg-2.5.6" = _FODsVxbx;
        "pkg-2.5.7" = _MaqaZyHD;
        "pkg-3.0.1-beta" = _HP8cf0Vq;
        "pkg-3.1.0" = _TrKWdX3m;
        "pkg-3.2.0" = _pBasCDpF;
        "pkg-3.3.0" = _sgBhbQzx;
        "pkg-3.3.1" = _VLg9fURh;
        "pkg-4.0.0-alpha" = _gZQzsiId;
        "pkg-4.1.0-beta" = _uOLilpnZ;
        "pkg-4.1.1-beta" = _mrRrd3E2;
        "pkg-4.1.2" = _SRjxrT1Y;
        "pkg-4.2.0" = _bb0KPNxs;
        "pkg-4.3.0" = _1nu3xL7i;
        "pkg-4.4.0" = _DG25d6FE;
        "pkg-4.4.1" = _jl1PtWLy;
        "pkg-21.0.0" = _xNaTONiu;
        "pkg-21.1.0" = _dH1W9nj7;
        "pkg-21.1.1" = _9IrJgq8f;
        "pkg-21.1.2" = _I8aGukuR;
        "pkg-21.1.3" = _xTI7wpuk;
        "pkg-21.2.0-beta" = _i7EqXSKC;
        "pkg-21.2.1" = _hNCCIw1X;
        "pkg-21.2.2-beta" = _oaOL1gqp;
        "pkg-21.5.0-beta" = _Vc0lZtZl;
        "pkg-21.5.1" = _WBaWouTz;
        "pkg-21.5.2" = _2hASjwSw;
        "pkg-21.6.0" = _ZRILYEDV;
        "pkg-21.9.0" = _EkA5AzUY;
        "pkg-21.9.1-beta" = _q7M5uPgX;
        "pkg-21.9.2-beta" = _lmgvOvnf;
        "pkg-21.11.0-rc.1" = _5Q4vPHx7;
        "pkg-21.11.1" = _yZzbIUkE;
        "pkg-26.1.0.0-beta" = _a7ULimab;
        "default" = _a7ULimab;
    });
