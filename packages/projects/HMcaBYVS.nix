...
let
    ...
    in {
        ...
        "pkg-1.17.1-2.0.0" = _eJKNnblA;
        "pkg-1.18-3.0.0" = _ruHEh2yK;
        "pkg-1.18.2-3.1.0" = _gfBcuZ1o;
        "pkg-1.14.4-1.0.11" = _ahJbngMb;
        "pkg-1.15.2-1.0.14" = _idXN3jw4;
        "pkg-1.16.2-1.2.2" = _danWPWJc;
        "pkg-1.19-4.0.0" = _wxdtFIh3;
        "pkg-1.19.1-4.1.0" = _EjgRkp9N;
        "pkg-1.19.3-4.2.0" = _CKDKV0ZY;
        "pkg-1.19.4-4.2.0" = _8kacpXAd;
        "pkg-1.20-5.0.0" = _KniPQT8L;
        "pkg-1.20.1-5.1.0" = _2ckyBiYo;
        "pkg-1.21-6.0.0" = _bp0TThAD;
        "pkg-1.20.1-5.1.1" = _E02rvbMY;
        "pkg-1.21-6.0.1" = _y66ojiZu;
        "pkg-1.19.1-4.1.1" = _BzXb2zaH;
        "pkg-1.19.4-4.2.1" = _7KRMRilx;
        "pkg-1.21-6.0.2" = _XhuOaUZz;
        "pkg-1.2.3" = _VfZdUujx;
        "pkg-1.18.2-3.1.1" = _esPlDR58;
        "pkg-1.19.1-4.1.2" = _7yqZXViQ;
        "pkg-1.19.4-4.2.2" = _IZSSy7y9;
        "pkg-1.20.1-5.1.2" = _8JZqPz3H;
        "pkg-1.21.3-6.0.0" = _q7DEkPoG;
        "pkg-1.21.3-6.0.1" = _dCwO5KpY;
        "pkg-21.5.0" = _P2q9PyR4;
        "pkg-21.6.0" = _9gUzoeCR;
        "pkg-21.6.1" = _BBWdEsb6;
        "pkg-21.11.0" = _P7vwzHsW;
        "pkg-26.1.0" = _gqXFBYMx;
        "pkg-26.2.0" = _qqGMt8kD;
        "default" = _qqGMt8kD;
    });
