...
let
    ...
    in {
        ...
        "pkg-0.0.2-1.20.1" = _Lqr2f7GY;
        "pkg-0.0.4-1.19.2" = _i3t7u3od;
        "pkg-0.0.3-1.20.1" = _pNK5903x;
        "pkg-0.0.5-1.19.2" = _dQdmYKw3;
        "pkg-0.0.4-1.20.1" = _HxZaGFFn;
        "pkg-0.0.6-1.19.2" = _jx8HF9br;
        "pkg-0.0.5-1.20.1" = _4wiKPAY4;
        "pkg-0.0.7-1.19.2" = _R8oOgYqd;
        "pkg-0.0.6-1.20.1" = _KXZnoLw4;
        "pkg-0.0.8-1.19.2" = _rICca35t;
        "pkg-0.0.7-1.20.1" = _nDjfA8Dt;
        "pkg-0.0.9-1.19.2" = _9BgrVgkS;
        "pkg-0.0.8-1.20.1" = _2sWyDsJI;
        "pkg-0.1.0-1.19.2" = _U1SazUIh;
        "pkg-0.0.9-1.20.1" = _3DYL0F44;
        "pkg-0.1.1-1.19.2" = _ACZ03Ipr;
        "pkg-0.1.0-1.20.1" = _UEN1cHo5;
        "pkg-0.1.2-1.19.2" = _SLMWY24A;
        "pkg-0.1.1-1.20.1" = _v9CvgqXf;
        "pkg-0.1.3-1.19.2" = _rJ03Dwyb;
        "pkg-0.1.2-1.20.1" = _pijtbaSZ;
        "pkg-0.1.4-1.19.2" = _ktf2adWv;
        "pkg-0.1.3-1.20.1" = _ttY5aYVQ;
        "pkg-0.1.5-1.19.2" = _WYeSQP1u;
        "pkg-0.1.4-1.20.1" = _OQTyjqcL;
        "pkg-0.1.6-1.19.2" = _yiPRYQ7Y;
        "pkg-0.1.5-1.20.1" = _izE7CyzB;
        "pkg-0.1.7-1.19.2" = _hNyhQIM8;
        "pkg-0.1.6-1.20.1" = _ApvpZMI2;
        "pkg-0.1.8-1.19.2" = _HZylVrfQ;
        "pkg-0.1.7-1.20.1" = _5KREkg0j;
        "pkg-0.1.9-1.19.2" = _T2pTcxCa;
        "pkg-0.1.8-1.20.1" = _HwWyBN8Z;
        "pkg-0.1.9-1.19.2-fabric" = _6GRxzcQO;
        "pkg-0.1.8-1.20.1-fabric" = _l3EECsox;
        "pkg-0.2.0-1.19.2-fabric" = _q4e1qhZr;
        "pkg-0.1.9-1.20.1-fabric" = _a7A8KUWP;
        "pkg-0.2.1-1.19.2-fabric" = _TD2wVsBh;
        "pkg-0.2.0-1.20.1-fabric" = _cgma8JKy;
        "pkg-0.2.1-1.20.1-fabric" = _Fu1GNZ7f;
        "pkg-0.1.9-1.20.1" = _pbEemkJu;
        "pkg-0.2.0-1.19.2" = _Tl8VbHeU;
        "pkg-0.2.0-1.20.1" = _f096Z0QV;
        "pkg-0.2.1-1.20.1" = _TzTFLgHO;
        "pkg-0.2.1-1.19.2" = _9xKW7RqS;
        "pkg-0.2.2-1.20.1" = _D4USvAO3;
        "pkg-0.2.2-1.19.2" = _r8lZgCHw;
        "pkg-0.2.3-1.20.1" = _odvNBcSf;
        "pkg-0.2.3-1.19.2" = _ci9PRV3P;
        "pkg-0.2.4-1.20.1" = _ox3I5Dr6;
        "pkg-0.2.2-1.19.2-fabric" = _NZEp5kE2;
        "pkg-0.2.2-1.20.1-fabric" = _7wKablxk;
        "pkg-0.2.4-1.19.2" = _jMxBWjKB;
        "pkg-0.2.5-1.20.1" = _w4XaiEKX;
        "pkg-0.2.3-1.19.2-fabric" = _KBNfrXNu;
        "pkg-0.2.3-1.20.1-fabric" = _XuxmRPGl;
        "pkg-0.2.5-1.19.2" = _OoDRc8dG;
        "pkg-0.2.6-1.20.1" = _uHOddnCS;
        "pkg-0.2.4-1.19.2-fabric" = _hpBCsVTl;
        "pkg-0.2.4-1.20.1-fabric" = _NOLKBfXi;
        "pkg-0.2.6-1.19.2" = _soTgJYL9;
        "pkg-0.2.7-1.19.2" = _vDSSClQd;
        "pkg-0.2.7-1.20.1" = _sRlCoodr;
        "pkg-0.2.8-1.19.2" = _6G9HgEfI;
        "pkg-0.2.8-1.20.1" = _Fb8kNPot;
        "pkg-1.0.0-1.21" = _bKvi5qks;
        "pkg-0.2.9-1.19.2" = _aca3gr04;
        "pkg-0.2.9-1.20.1" = _BYPLNPR4;
        "pkg-1.0.1-1.21" = _WbWjvNpQ;
        "pkg-0.3.0-1.19.2" = _94y43ZGg;
        "pkg-0.3.0-1.20.1" = _iP4nUPRK;
        "pkg-1.0.2-1.21" = _PAncau6I;
        "pkg-0.3.1-1.19.2" = _fBcvCAcL;
        "pkg-0.3.1-1.20.1" = _Rbpfeyor;
        "pkg-1.0.3-1.21" = _mK2y8uCd;
        "pkg-0.3.2-1.19.2" = _pPvnlDCN;
        "pkg-0.3.2-1.20.1" = _RgWfoCab;
        "pkg-1.0.4-1.21" = _9ueYrCZj;
        "pkg-1.0.5-1.21" = _oazfPo53;
        "pkg-1.0.6-1.21" = _EdVVcLRr;
        "pkg-0.3.3-1.19.2" = _ohqluFGX;
        "pkg-0.3.3-1.20.1" = _VJGnw9xZ;
        "pkg-1.0.7-1.21" = _AVBZbKPr;
        "pkg-0.3.4-1.19.2" = _1DTiQBdR;
        "pkg-0.3.4-1.20.1" = _UqzFOSKT;
        "pkg-1.0.8-1.21" = _70WTAbR8;
        "pkg-0.3.5-1.19.2" = _R2NAQnsm;
        "pkg-0.3.5-1.20.1" = _aLpUr3lb;
        "pkg-1.0.9-1.21" = _5zO7ARii;
        "pkg-1.1.0-1.21" = _k0qDEDq7;
        "pkg-0.3.6-1.19.2" = _6cnQU0FR;
        "pkg-0.3.6-1.20.1" = _9o9W7Czz;
        "pkg-0.2.5-1.19.2-fabric" = _UOjGELLN;
        "pkg-0.2.5-1.20.1-fabric" = _3ywJ9y2A;
        "pkg-0.3.7-1.19.2" = _pzDxHDzm;
        "pkg-0.3.7-1.20.1" = _xJe50qet;
        "pkg-1.1.1-1.21" = _7YYbh9yp;
        "pkg-0.3.8-1.19.2" = _1BskEvLd;
        "pkg-0.3.8-1.20.1" = _5TNoWVh9;
        "pkg-1.1.2-1.21" = _YjzNcNU5;
        "pkg-0.3.9-1.19.2" = _uHjsrT6u;
        "pkg-0.3.9-1.20.1" = _f94WWPN9;
        "pkg-1.1.3-1.21" = _CkvmZT4C;
        "pkg-0.4.0-1.19.2" = _42hMYl35;
        "pkg-0.4.0-1.20.1" = _w85CAgdF;
        "pkg-1.1.4-1.21" = _DS8lS82u;
        "pkg-0.4.1-1.19.2" = _IuaI57tj;
        "pkg-0.4.1-1.20.1" = _4TZO2O7l;
        "pkg-1.1.5-1.21" = _iDFIRHpX;
        "pkg-0.4.2-1.19.2" = _JMZacmtR;
        "pkg-0.4.2-1.20.1" = _3q4pib3P;
        "pkg-1.1.6-1.21" = _hmbiDRb5;
        "pkg-0.4.3-1.19.2" = _rbBOGxdT;
        "pkg-0.4.3-1.20.1" = _3XhgWZPE;
        "pkg-1.1.7-1.21" = _EpUxy82D;
        "pkg-0.2.6-1.19.2-fabric" = _tyzOkKpO;
        "pkg-0.2.6-1.20.1-fabric" = _M4MrOjt3;
        "pkg-0.2.7-1.20.1-fabric" = _QjKKbzj6;
        "pkg-0.4.4-1.19.2" = _gxKRC361;
        "pkg-0.4.4-1.20.1" = _XoUrF1ww;
        "pkg-1.1.8-1.21" = _kxqniZBd;
        "pkg-0.4.5-1.19.2" = _c0QikerA;
        "pkg-0.4.5-1.20.1" = _VId1LPuv;
        "pkg-1.1.9-1.21" = _tKbAcEhR;
        "pkg-0.4.6-1.19.2" = _vziWJRna;
        "pkg-0.4.6-1.20.1" = _qAhncBWV;
        "pkg-1.2.0-1.21" = _1KJjs63b;
        "pkg-0.2.8-1.20.1-fabric" = _8QlW3c4B;
        "pkg-0.2.9-1.20.1-fabric" = _LWusRrq1;
        "pkg-0.4.7-1.19.2" = _3g6gKk4H;
        "pkg-0.4.7-1.20.1" = _ODRE1VKg;
        "pkg-1.2.1-1.21" = _dTiquLt4;
        "pkg-0.4.8-1.19.2" = _9lMcTD57;
        "pkg-0.4.8-1.20.1" = _9YSos7y1;
        "pkg-1.2.2-1.21" = _Pg3WZS7V;
        "pkg-0.4.9-1.19.2" = _iPG1BhUW;
        "pkg-0.4.9-1.20.1" = _lzpZC9Ce;
        "pkg-1.2.3-1.21" = _O2oNGBnR;
        "pkg-0.2.7-1.19.2-fabric" = _kcpLVNIs;
        "pkg-0.3.0-1.20.1-fabric" = _xtsCh4bF;
        "pkg-0.3.1-1.20.1-fabric" = _JIndBxC6;
        "pkg-0.5.0-1.19.2" = _hyVQJWrE;
        "pkg-0.5.0-1.20.1" = _uhOnSBvH;
        "pkg-1.2.4-1.21" = _D2Lvy57X;
        "pkg-0.5.1-1.20.1" = _DEbI0Mci;
        "pkg-1.2.5-1.21" = _qq7ongQD;
        "pkg-0.5.2-1.20.1" = _nxmiMmxs;
        "pkg-1.2.6-1.21" = _2btEcO6S;
        "pkg-0.5.3-1.20.1" = _m9jtSSxT;
        "pkg-1.2.7-1.21" = _gLKxngjI;
        "pkg-0.5.4-1.20.1" = _5BgjOiK2;
        "pkg-1.2.8-1.21" = _jw3gR6xj;
        "pkg-0.5.5-1.20.1" = _oohtwLBB;
        "pkg-1.2.9-1.21" = _WKnP2UXQ;
        "pkg-0.5.6-1.20.1" = _BftUivC0;
        "pkg-1.3.0-1.21" = _MXAIVhlp;
        "pkg-0.5.7-1.20.1" = _TBCYcqsj;
        "pkg-1.3.1-1.21" = _HosUN9JR;
        "pkg-0.5.8-1.20.1" = _CrlVnyCX;
        "pkg-1.3.2-1.21" = _bUu3HXvB;
        "pkg-0.5.9-1.20.1" = _aHhuxvIA;
        "pkg-1.3.3-1.21" = _Ga0YpQ6f;
        "pkg-0.6.0-1.20.1" = _t1tw2Epl;
        "pkg-1.3.4-1.21" = _dNaKk520;
        "pkg-0.2.8-1.19.2-fabric" = _CoGNkXQF;
        "pkg-0.3.2-1.20.1-fabric" = _CnOBV9GF;
        "pkg-0.6.1-1.20.1" = _1iK7EIhO;
        "pkg-1.3.5-1.21" = _wJZ3QBPr;
        "pkg-1.3.6-1.21" = _YGX98PAR;
        "pkg-0.6.2-1.20.1" = _gC4YyIKL;
        "pkg-1.3.7-1.21" = _k9ln4xNV;
        "pkg-1.3.8-1.21" = _iyXTADAl;
        "pkg-1.3.9-1.21" = _6UxTqXYc;
        "pkg-0.6.3-1.20.1" = _xUCJSmsf;
        "pkg-1.4.0-1.21" = _8ahaezbJ;
        "pkg-1.4.1-1.21" = _JhBTeYSY;
        "pkg-0.3.3-1.20.1-fabric" = _kECscEam;
        "pkg-0.6.4-1.20.1" = _Yj5Cab9A;
        "pkg-1.4.2-1.21" = _3srC1Io8;
        "pkg-0.3.4-1.20.1-fabric" = _QjFETbsd;
        "pkg-0.3.5-1.20.1-fabric" = _gjEv6vjg;
        "pkg-0.6.5-1.20.1" = _8i8iSllW;
        "pkg-1.4.3-1.21" = _cvWqiGeE;
        "pkg-0.6.6-1.20.1" = _IuUUHpWU;
        "pkg-1.4.4-1.21" = _5bWWap87;
        "pkg-0.6.7-1.20.1" = _9Nl8KHv4;
        "pkg-1.4.5-1.21" = _7yLp83Iz;
        "pkg-0.6.9-1.20.1" = _KHfzeJWf;
        "pkg-1.4.6-1.21" = _bjAjFmRW;
        "pkg-0.7.0" = _BtxtZRMX;
        "pkg-1.4.7" = _HRHpOCTy;
        "pkg-0.7.1" = _dceesgcz;
        "pkg-1.4.8" = _SZ0Brgwo;
