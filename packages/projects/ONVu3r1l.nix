...
let
    ...
    in {
        ...
        "pkg-1.10.2-0.0.38.0" = _xCkhAc6Y;
        "pkg-1.11.2-0.0.32.0" = _3KGxWwn2;
        "pkg-1.12.2-0.0.27.0" = _gPpEhaVa;
        "pkg-1.10.2-0.0.41.0" = _J7m6vaO8;
        "pkg-1.11.2-0.0.34.0" = _VAWvhZ0h;
        "pkg-1.12.2-0.0.28.0" = _fTLrTDsq;
        "pkg-1.10.2-0.0.47.0" = _Cc0LEdgy;
        "pkg-1.11.2-0.0.39.0" = _pohmg5BR;
        "pkg-1.12.2-0.0.32.0" = _7WD5RGlt;
        "pkg-1.10.2-0.0.50.0" = _WTUXOJjT;
        "pkg-1.11.2-0.0.41.0" = _laXlFlwi;
        "pkg-1.12.2-0.0.33.0" = _c87PDqcQ;
        "pkg-1.10.2-0.0.60.0" = _63Cdkvb4;
        "pkg-1.11.2-0.0.49.0" = _2y6Sci4D;
        "pkg-1.12.2-0.0.39.1" = _7Z0BDCNF;
        "pkg-1.12.2-0.0.85.0" = _TXdof9T1;
        "pkg-1.12.2-0.0.104.0" = _TYECeqfF;
        "pkg-1.10.2-0.0.148.0" = _VwBut0Lk;
        "pkg-1.11.2-0.0.131.0" = _gvwmdt7k;
        "pkg-1.12.2-0.0.112.0" = _DXKGf5G8;
        "pkg-1.12.2-0.0.115.0" = _IncZTKOr;
        "pkg-1.12.2-0.0.126.0" = _4dHAthAu;
        "pkg-1.12.2-0.0.140.0" = _UYoG5Kb6;
        "pkg-1.12.2-0.0.152.0" = _V16X4pfb;
        "default" = _V16X4pfb;
    });
