...
let
    ...
    in {
        ...
        "pkg-1604.1.0.3" = _MO75e2sC;
        "pkg-1604.1.0.4" = _YN0T5Pmf;
        "pkg-1605.1.2-build.2" = _dvLO7wuv;
        "pkg-1605.1.2-build.3" = _T4V6Dm0l;
        "pkg-1605.1.2-build.4" = _cNEVOQ4q;
        "pkg-1605.1.2-build.7" = _bnvthbJW;
        "pkg-1605.1.4-build.12" = _uMNhEyBG;
        "pkg-1801.2.0-build.14" = _79c3Pl6W;
        "pkg-1802.2.1-build.16" = _VwLRcUBQ;
        "pkg-1802.2.2-build.23" = _b3ZbuHEY;
        "pkg-1802.2.2-build.26" = _CDoBzOhr;
        "pkg-1802.2.2-build.28" = _gUgBKKro;
        "pkg-1902.1.1-build.32" = _I3cYQ3mX;
        "pkg-1902.1.1-build.35" = _ftDL2MOo;
        "pkg-1802.2.4-build.5" = _VszJSnhB;
        "pkg-1902.2.4-build.5" = _oRValdcl;
        "pkg-1902.2.4-build.9" = _mHfUZDSO;
        "pkg-1802.2.4-build.14" = _m9lk8iMr;
        "pkg-1902.2.4-build.11" = _65oHVwN8;
        "pkg-1902.2.4-build.19" = _VLiijTOY;
        "pkg-1902.2.4-build.16" = _rJ26X7G5;
        "pkg-1902.2.4-build.18" = _2Hq8tbrn;
        "pkg-1902.2.4-build.21" = _dxY7VzQv;
        "pkg-1902.2.4-build.24" = _zWLaf3WR;
        "pkg-1902.2.4-build.26" = _Yp60zntL;
        "pkg-1902.2.4-build.20" = _B4zWSIIO;
        "pkg-1902.2.4-build.23" = _8qUQlsto;
        "pkg-1902.2.4-build.30" = _zmzcrZEp;
        "pkg-1902.2.4-build.32" = _y7FC6Rsp;
        "pkg-1902.2.4-build.25" = _YE9yQwxx;
        "pkg-1902.2.4-build.27" = _353BVKVV;
        "pkg-1902.2.4-build.34" = _hYdnSDQB;
        "pkg-1902.2.4-build.37" = _13yE1QX6;
        "pkg-1902.2.4-build.29" = _Jqn5DRIj;
        "pkg-1802.2.4-build.21+fabric" = _A0KQFxde;
        "pkg-1902.2.4-build.36+forge" = _Xe2y2pRp;
        "pkg-1902.2.4-build.44+fabric" = _FhVbUfLB;
        "pkg-1802.2.4-build.16+forge" = _ClnUsQ85;
        "pkg-1902.2.4-build.46+fabric" = _HJ0xIlkM;
        "pkg-1802.2.4-build.23+fabric" = _PB33MOc1;
        "pkg-2001.2.5-build.2+forge" = _hei9cDRa;
        "pkg-2001.3.0-build.5+forge" = _y2WfxPp9;
        "pkg-2001.3.0-build.8+forge" = _5vppyenb;
        "pkg-2101.3.1-build.18" = _1qmcLagN;
        "default" = _1qmcLagN;
    });
