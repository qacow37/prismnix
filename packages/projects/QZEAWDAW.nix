...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _I26sA6Wn;
        "pkg-0.2.0+1.21.(2+)" = _NiRHur4M;
        "pkg-0.3.0+1.21.(2+)" = _j8Oy4HTC;
        "pkg-0.4.0+1.21.(2+)" = _iu9LB5y6;
        "pkg-0.4.1+1.21.(2+)" = _jea8twkX;
        "pkg-0.4.2+1.21.(2+)" = _w5rZ7aZW;
        "pkg-0.4.3+1.21.(2+)" = _cb3aCaBz;
        "pkg-0.5.0+1.21.(2+)" = _10nsZvXv;
        "pkg-0.5.1+1.21.(2+)" = _TyoJBby2;
        "pkg-0.5.1+" = _WeaeM2Nq;
        "pkg-0.5.2+1.21.(6-8)" = _K9U2tfXJ;
        "pkg-0.5.1+1.21.(9+)" = _Z7q6xvl9;
        "pkg-0.6.0+1.21.(2-4)" = _Cgv7IbEe;
        "pkg-0.6.0+1.21.(6-8)" = _O0ktNhul;
        "pkg-0.6.0+1.21.(9+)" = _lzqOc9X2;
        "pkg-0.6.0+" = _Rp3svJOc;
        "pkg-1.0.0+1.21.(6-8)" = _zqFKUqpY;
        "pkg-1.0.0+1.21.(2-4)" = _KKYUCUrS;
        "pkg-1.0.0+" = _yMrYNRqN;
        "pkg-1.0.1+" = _7OZ0k5cq;
        "pkg-1.0.1+1.21.(6-8)" = _UtZHxw4e;
        "pkg-1.0.1+1.21.(2-4)" = _QSluO9Sx;
        "pkg-1.0.1+1.21.(9+)" = _4FQ1eIjr;
        "pkg-1.0.2+1.21.5" = _mnXOehjh;
        "pkg-1.0.2+1.21.(6-8)" = _IBFOTSFw;
        "pkg-1.0.2+1.21.(9+)" = _Jp1g8i4g;
        "pkg-1.0.2+1.21.(2-4)" = _tjmYmV04;
        "pkg-1.1.0+1.21.(6-8)" = _DnOP1v9d;
        "pkg-1.1.0+1.21.(9+)" = _dUErIwni;
        "pkg-1.1.0+1.21.5" = _oLJncrYn;
        "pkg-1.1.0+1.21.(2-4)" = _VcUW2usi;
        "pkg-1.1.1+1.21.(6-8)" = _YVNmj306;
        "pkg-1.1.1+1.21.5" = _qbfmkdZ6;
        "pkg-1.1.1+1.21.(2-4)" = _saEQUcz8;
        "pkg-1.1.2+1.21.(2-4)" = _ZApt0J9a;
        "pkg-1.1.2+1.21.5" = _JljmrLFY;
        "pkg-1.1.2+1.21.(6-8)" = _mVl40xDZ;
        "pkg-1.1.1+1.21.(9+)" = _QJk3hENt;
        "pkg-1.2.0+1.21.(9+)" = _uQ1jRHJH;
        "pkg-1.2.0+1.21.(6-8)" = _RPxMCvdY;
        "pkg-1.2.0+1.21.5" = _zvm33BDK;
        "pkg-1.2.0+1.21.(2-4)" = _eHWauN3a;
        "pkg-1.3.0+1.21.(9+)" = _M4mByN44;
        "pkg-1.3.0+1.21.(6-8)" = _XC6hRLZF;
        "pkg-1.3.0+1.21.5" = _XFcVQnIQ;
        "pkg-1.3.1+1.21.(9+)" = _HQwFgm4j;
        "pkg-1.3.1+1.21.5" = _syYw9kdc;
        "pkg-1.3.1+1.21.(6-8)" = _WNQ6LVpZ;
        "pkg-1.3.0+1.21.(2-4)" = _J98RrlGI;
        "pkg-1.4.0+1.21.5" = _aTkRzmU6;
        "pkg-1.4.0+1.21.(2-4)" = _8yYoPKkw;
        "pkg-1.4.0+1.21.(6-8)" = _rl3SFIgn;
        "pkg-1.4.0+1.21.(9+)" = _hHIfmz0y;
        "pkg-1.4.1+1.21.(2-4)" = _T2j6L3ZE;
        "pkg-1.4.1+1.21.(9+)" = _lDu523rd;
        "pkg-1.4.1+1.21.5" = _SvfHYu5W;
        "pkg-1.4.1+1.21.(6-8)" = _juUSjKLR;
        "pkg-1.5.0+1.21.(2-4)" = _rmxnkZqB;
        "pkg-1.5.0+1.21.(9+)" = _2DX9G7ma;
        "pkg-1.5.0+1.21.5" = _Z6jjePX9;
        "pkg-1.5.0+1.21.(6-8)" = _9Zvvrbs2;
        "pkg-1.6.0+1.21.(9+)" = _hWXG33Hy;
        "pkg-1.6.0+1.21.5" = _1RpA38TE;
        "pkg-1.6.0+1.21.(6-8)" = _SnUbK6kn;
        "pkg-1.6.0+1.21.(2-4)" = _fJ8ja0Ww;
        "pkg-2.0.0+1.21.5" = _kqerQtHB;
        "pkg-2.0.0+1.21.(9+)" = _xZ2jlJUO;
        "pkg-2.0.0+1.21.(6-8)" = _UvZcB5sS;
        "pkg-2.0.0+1.21.(2-4)" = _HXLPkIJN;
        "pkg-2.1.0+1.21.(2-4)" = _6CxXZsJ6;
        "pkg-2.1.0+1.21.5" = _DSG5bKuG;
        "pkg-2.1.0+1.21.(6-8)" = _MtF8Lcyh;
        "pkg-2.1.0+1.21.(9+)" = _vuN9qq1x;
        "pkg-2.1.1+1.21.(2-4)" = _5X0olMKU;
        "pkg-2.1.1+1.21.5" = _4mQe29v6;
        "pkg-2.1.1+1.21.(9+)" = _rFHrzQvs;
        "pkg-2.1.1+1.21.(6-8)" = _9cWRFN65;
        "pkg-2.2.0+1.21.5" = _OGStWXxP;
        "pkg-2.2.0+1.21.(2-4)" = _kIqDKl6c;
        "pkg-2.2.0+1.21.(6-8)" = _qXe5UwFA;
        "pkg-2.2.0+1.21.(9+)" = _bPktPMdp;
        "pkg-3.0.0+1.21.5" = _KD0H4rmC;
        "pkg-3.0.0+1.21.(2-4)" = _8vqhCU5x;
        "pkg-3.0.0+1.21.(6-8)" = _UKC6dYqt;
        "pkg-3.0.0+1.21.(9+)" = _wffT3XxS;
        "pkg-3.1.0+1.21.5" = _d2hqwRZv;
        "pkg-3.1.0+1.21.(2-4)" = _Esr5PPjv;
        "pkg-3.1.0+1.21.(6-8)" = _jwmtgbT2;
        "pkg-3.1.0+1.21.(9+)" = _3kJlfSpP;
        "pkg-3.2.0+1.21.(6-8)" = _L2MAaA4T;
        "pkg-3.2.0+1.21.5" = _ELUdziBx;
        "pkg-3.2.0+1.21.(9+)" = _fuBwvb9P;
        "pkg-3.2.0+1.21.(2-4)" = _7E9OA8Gd;
        "pkg-3.2.0+1.20.(1-4)" = _Erjzhs2o;
        "pkg-3.2.0+1.21.(11+)" = _7d3xP7LM;
        "pkg-3.3.0+1.21.5" = _RJvZO8P7;
        "pkg-3.3.0+1.21.(2-4)" = _ozPSoUp6;
        "pkg-3.3.0+1.21.(6-8)" = _dxMn4aV7;
        "pkg-3.3.0+1.21.(11+)" = _1ODXakC5;
        "pkg-3.3.0+1.21.(9-10)" = _GKNnoLvh;
        "pkg-3.4.0+1.21.(2-4)" = _qufkauaM;
        "pkg-3.4.0+1.21.5" = _dNm9PC1L;
        "pkg-3.4.0+1.21.(6-8)" = _bgTisfTi;
        "pkg-3.4.0+1.21.(9-10)" = _GzM7bC2X;
        "pkg-3.4.0+1.21.(11+)" = _2ExVhyfz;
        "pkg-4.0.0-rc.1+1.21.(6-8)" = _2dMkIEYP;
        "pkg-4.0.0-rc.1+1.21.5" = _iojumADL;
        "pkg-4.0.0-rc.2+1.21.5" = _RV0iXtEv;
        "pkg-4.0.0-rc.2+1.21.(6-8)" = _TEHYe5KG;
        "pkg-4.0.0-rc.2+1.21.(2-4)" = _mPoO9nbt;
        "pkg-4.0.0-rc.2+1.21.(9-10)" = _q1ZCfvFc;
        "pkg-4.0.0-rc.2+1.21.(11+)" = _FQ1AGjR7;
        "pkg-4.0.0-rc.2.1+1.21.(2-4)" = _wNdeHMnM;
        "pkg-4.0.0-rc.2.1+1.21.5" = _oVMhWr92;
        "pkg-4.0.0-rc.2.1+1.21.(6-8)" = _TFx9nPK9;
        "pkg-4.0.0-rc.2.1+1.21.(9-10)" = _kS4NJOoW;
        "pkg-4.0.0-rc.2.1+1.21.(11+)" = _yXfhcqEc;
        "pkg-4.0.0+1.21.(2-4)" = _IFr5BaEZ;
        "pkg-4.0.0+1.21.(6-8)" = _1pWNKHYo;
        "pkg-4.0.0+1.21.5" = _mnhQgubC;
        "pkg-4.0.0+1.21.(11+)" = _EtH91Sr1;
        "pkg-4.0.0+1.21.(9-10)" = _JaCPAHJj;
        "pkg-4.0.1+1.21.(2-4)" = _k0ZSGrOJ;
        "pkg-4.0.1+1.21.5" = _8eCDCLPE;
        "pkg-4.0.1+1.21.(6-8)" = _N2dOqpXx;
        "pkg-4.0.1+1.21.(11+)" = _XZjomvCL;
        "pkg-4.0.1+1.21.(9-10)" = _FnjwUU18;
        "pkg-4.0.2+1.21.(2-4)" = _FvCYvwTa;
        "pkg-4.0.2+1.21.5" = _YRILqiQm;
        "pkg-4.0.2+1.21.(11+)" = _EranAKsv;
        "pkg-4.0.2+1.21.(6-8)" = _BlwK5Su8;
        "pkg-4.0.2+1.21.(9-10)" = _FkKhaJyP;
        "pkg-5.0.0+1.21.(2-4)" = _3rfELYRB;
        "pkg-5.0.0+1.21.5" = _9lZsuuBS;
        "pkg-5.0.0+1.21.(6-8)" = _lRFg7ap2;
        "pkg-5.0.0+1.21.(9-10)" = _XYsDxVa6;
        "pkg-5.0.0+1.21.11" = _PGHQswZd;
        "pkg-5.0.0+1.21.1" = _ncaYIlp8;
        "pkg-5.1.0+26.1" = _fB8oWSZr;
        "default" = _fB8oWSZr;
    });
