...
let
    ...
    in {
        ...
        "pkg-0.0.4+1.19.2" = _e9bhoZYD;
        "pkg-0.0.5+1.19.2" = _4B5lgP7J;
        "pkg-0.0.5+1.18.2" = _9EJ3WHxp;
        "pkg-0.1.0+1.19.3" = _BCGMMHme;
        "pkg-0.2.0+1.19.4" = _cTJR03eQ;
        "pkg-0.2.1+1.19.4" = _RNJJaD2v;
        "pkg-0.3.0+1.20.0" = _cFQ0QVNH;
        "pkg-0.4.0+1.20.1" = _AFZia5J9;
        "pkg-0.0.3+1.18.2" = _3zWBaQtz;
        "pkg-0.2.2+1.19.4" = _6QmbnIHs;
        "pkg-0.4.1+1.20.1" = _dWnJ9ELP;
        "pkg-0.5.0+1.20.2" = _eUys0mLj;
        "pkg-0.5.1+1.20.2" = _sjsaoQwG;
        "pkg-0.6.0+1.20.2" = _osPWB833;
        "pkg-0.7.0+1.20.4" = _XlWGNC2K;
        "pkg-0.7.1+1.20.4" = _1WAUxra2;
        "pkg-0.7.2+1.20.4" = _9NPrdSlk;
        "pkg-0.8.0+1.20.4" = _VUhVVM23;
        "pkg-0.8.1+1.20.4" = _EAsNk1d8;
        "pkg-0.4.2+1.20.1" = _jjjsoRT4;
        "pkg-0.9.0+1.20.6" = _vlgNKr7B;
        "pkg-0.10.0+1.21" = _oCO8Rxth;
        "pkg-0.11.0+1.21.1" = _BbRMUWpK;
        "pkg-0.11.1+1.21.1" = _cQoLEyTg;
        "pkg-0.11.2+1.21.1" = _gBCTQ0w8;
        "pkg-0.13.0+1.21.3" = _IoOmOdaT;
        "pkg-0.14.0+1.21.4" = _CsBa9WID;
        "pkg-0.14.1+1.21.4" = _gWiglNPc;
        "pkg-0.14.2+1.21.4" = _XWSRyVTh;
        "pkg-0.14.3+1.21.4" = _8hIxFHDE;
        "pkg-0.4.3+1.20.1" = _n8tOB06w;
        "pkg-0.14.4+1.21.4" = _cvJNkwby;
        "pkg-0.15.0+1.21.5" = _5yfPa7Cb;
        "pkg-0.16.0+1.21.6" = _BzcOQYrf;
        "pkg-0.16.1+1.21.6" = _EcYTAWhY;
        "pkg-0.17.0+1.21.6" = _GAXsRrCy;
        "pkg-0.18.0+1.21.7" = _2AxEthoh;
        "pkg-0.19.0+1.21.7" = _iUH9B7GK;
        "pkg-0.19.1+1.21.7" = _tfyYpGlk;
        "pkg-0.20.0+1.21.8" = _YpCm2u6w;
        "pkg-0.21.0+1.21.9" = _kwkZkeIk;
        "pkg-0.22.0+1.21.10" = _I1ejHHLO;
        "pkg-0.23.0+1.21.10" = _NGlGMRXU;
        "pkg-0.24.0+1.21.11" = _36Vp59QH;
        "pkg-0.25.0+26.1" = _FF3fm7w3;
