...
let
    ...
    in {
        ...
        "pkg-1.1.7" = _90Bm5Jv7;
        "pkg-1.1.8" = _shTedfcQ;
        "pkg-1.1.8-hotfix" = _Ddn0DrEw;
        "pkg-1.1.8-hotfix2" = _np3Res6x;
        "pkg-1.1.9" = _JlK5s9lf;
        "pkg-1.1.10" = _5wnDqiWV;
        "pkg-1.1.10-hotfix" = _blyXYxhV;
        "pkg-1.1.11" = _p6prajBr;
        "pkg-1.1.12" = _Bz0T4DFp;
        "pkg-1.1.12-hotfix" = _CfpXYUY2;
        "pkg-1.1.12-hotfix2" = _ZSKbmDse;
        "pkg-1.1.13" = _oTDAYryf;
        "pkg-1.1.14" = _LuP1RuAc;
        "pkg-1.2.0" = _DZ2GoCpw;
        "pkg-1.2.1" = _hWplbBvP;
        "pkg-1.2.2" = _8GusOiXO;
        "pkg-1.2.2-hotfix" = _jNfoDrwb;
        "pkg-1.3.0" = _C6f0awOS;
        "pkg-1.3.1" = _d4p6NwSu;
        "pkg-1.3.2" = _wNm2nNz6;
        "pkg-1.3.3" = _x0mip3HW;
        ...
        "pkg-1.3.5" = _BPzbZ8Bm;
        "pkg-1.3.6" = _3XPwCAVd;
        "pkg-1.3.7-forge+mc1.20.1" = _dJtowD4o;
        "pkg-1.3.7-neoforge+mc1.21.1" = _hWYgzsHb;
        "pkg-1.3.8-forge+mc1.20.1" = _kkdKN8dZ;
        "pkg-1.3.8-neoforge+mc1.21.1" = _FBv3nLoS;
        "pkg-1.4.0-forge+mc1.20.1" = _Ji0Bz3hv;
        "pkg-1.4.0-neoforge+mc1.21.1" = _YNhJ0P2x;
        "pkg-1.4.1-neoforge+mc1.21.1" = _sEzEsHRj;
        "pkg-1.4.2-forge+mc1.20.1" = _NfrPPLRl;
        "pkg-1.4.2-neoforge+mc1.21.1" = _hgn9Jv7U;
        "pkg-1.4.3-forge+mc1.20.1" = _3tXE802a;
        "pkg-1.4.3-neoforge+mc1.21.1" = _UlsaSAJh;
        "pkg-1.4.4-forge+mc1.20.1" = _B8dVy5Dy;
        "pkg-1.4.4-neoforge+mc1.21.1" = _KKfhP8r7;
        "pkg-1.4.5-forge+mc1.20.1" = _Qqc2oJtO;
        "pkg-1.4.5-neoforge+mc1.21.1" = _cIRBnvlf;
        "pkg-1.4.6-forge+mc1.20.1" = _iwdMzV8V;
        "pkg-1.4.6-neoforge+mc1.21.1" = _X9LKPySd;
        "pkg-1.5.0-forge+mc1.20.1" = _tuOQjuRE;
        "pkg-1.5.0-neoforge+mc1.21.1" = _GASkwyV4;
        "pkg-1.5.1-forge+mc1.20.1" = _quesqoeZ;
        "pkg-1.5.1-neoforge+mc1.21.1" = _jCG0XH1H;
        "pkg-1.5.2-forge+mc1.20.1" = _YpdxfSC2;
        "pkg-1.5.2-neoforge+mc1.21.1" = _Dbjwcs2u;
        "pkg-1.5.3-forge+mc1.20.1" = _g1SKoGQJ;
        "pkg-1.5.3-neoforge+mc1.21.1" = _tXG1TkGx;
        "default" = _tXG1TkGx;
    });
