...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha-fabric" = _tGb7qP3Q;
        "pkg-1.0.0-alpha-paper" = _6njJKtL4;
        "pkg-1.0.0-alpha-sponge" = _cyE8eaNA;
        "pkg-1.0.0-alpha-forge" = _O89o9MDm;
        "pkg-1.0.0-beta-sponge" = _P2jLhb3u;
        "pkg-1.0.0-beta-forge" = _HzzprFni;
        "pkg-1.0.0-beta-paper" = _g53OxTgg;
        "pkg-1.0.0-beta-fabric" = _H8I9yxz4;
        "pkg-1.0.0-release-fabric" = _KeUG8Bv6;
        "pkg-1.0.1-beta-sponge" = _siowtEdw;
        "pkg-1.0.1-beta-forge" = _8CVMUwhf;
        "pkg-1.0.1-release-paper" = _1M9IQemX;
        "pkg-1.0.1-release-fabric" = _gYwKQNSb;
        "pkg-1.0.1-release-forge" = _GtACbtV2;
        "pkg-1.1.0-release-sponge" = _qbdOoC64;
        "pkg-1.1.0-release-forge" = _HaBtgh9d;
        "pkg-1.1.0-release-paper" = _XI1R2w6Z;
        "pkg-1.1.0-release-fabric" = _JtmdrDhb;
        "pkg-1.1.1-release-sponge" = _unr6wDff;
        "pkg-1.1.1-release-forge" = _mr0xFZSg;
        "pkg-1.1.1-release-paper" = _k0yWLigg;
        "pkg-1.1.1-release-fabric" = _xDCor14I;
        "pkg-1.2.0-release-sponge" = _a7irWvTD;
        "pkg-1.2.0-release-forge" = _jGcwejGi;
        "pkg-1.2.0-release-paper" = _i6PsZ8WK;
        "pkg-1.2.0-release-fabric" = _e7EfbvTE;
        "pkg-1.3.0-release-fabric" = _799AyD0p;
        "pkg-1.3.0-release-paper" = _UXiJRLU2;
        "default" = _UXiJRLU2;
    });
