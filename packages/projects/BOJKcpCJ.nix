...
let
    ...
    in {
        ...
        "pkg-0.0.1-mc1.21.4" = _L6CAF3Jd;
        "pkg-0.0.1-mc1.21.3" = _Tm5pkHnY;
        "pkg-0.0.1-hotfix-mc1.21.3" = _y9CxwQlk;
        "pkg-0.0.1-hotfix-mc1.21.4" = _nnAHTfMU;
        "pkg-0.0.2-mc1.21.1" = _RJ2ZkBCA;
        "pkg-0.0.2-mc1.21.3" = _5BtBZa9V;
        "pkg-0.0.2-mc1.21.4" = _VqKv3iet;
        "pkg-0.0.2-hotfix-mc1.21.1" = _OaWbUlXq;
        "pkg-0.0.2-hotfix-mc1.21.3" = _jwATcrGH;
        "pkg-0.0.2-hotfix-mc1.21.4" = _n87EAHYi;
        "pkg-0.0.3-mc1.21.1" = _wCkkZcjX;
        "pkg-0.0.3-mc1.21.3" = _vDO7iYsh;
        "pkg-0.0.3-mc1.21.4" = _O1Kf5SLD;
        "pkg-0.0.3-hotfix-mc1.21.1" = _fNzhsClp;
        "pkg-0.0.3-hotfix-mc1.21.3" = _9yvoAWse;
        "pkg-0.0.3-hotfix-mc1.21.4" = _e7Ze3vyR;
        "pkg-0.0.4-mc1.20.1" = _rcYYJCis;
        "pkg-0.0.4-mc1.21.1" = _YfBC2yVo;
        "pkg-0.0.4-mc1.21.3" = _XH4RQk95;
        "pkg-0.0.4-mc1.21.4" = _erImpa6H;
        "pkg-0.0.5-mc1.20.1" = _Ineqw06E;
        "pkg-0.0.5-mc1.21.1" = _xXKMzSor;
        "pkg-0.0.5-mc1.21.3" = _fBxl24Iy;
        "pkg-0.0.5-mc1.21.4" = _qh2WxZl8;
        "pkg-0.0.6-mc1.20.1" = _XyDjIXds;
        "pkg-0.0.6-mc1.21.1" = _I7epnYLh;
        "pkg-0.0.6-mc1.21.3" = _Q0HDji7E;
        "pkg-0.0.6-mc1.21.4" = _SyYD5Pe4;
        "pkg-0.0.6-hotfix-mc1.21.1" = _u149kdAV;
        "pkg-0.0.6-hotfix-mc1.21.3" = _smaDM3VW;
        "pkg-0.0.6-hotfix-mc1.21.4" = _4oy1gDTg;
        "pkg-0.0.6-hotfix-mc1.20.1" = _7Vusdg0g;
        "pkg-0.0.7-mc1.21.1" = _wCc00xIj;
        "pkg-0.0.7-mc1.21.3" = _cwviY1Bt;
        "pkg-0.0.7-mc1.21.4" = _h8BAHa2T;
        "pkg-0.0.7-mc1.20.1" = _GFhArhW0;
        "pkg-0.0.8-mc1.21.1" = _uSvjsZrG;
        "pkg-0.0.8-mc1.21.3" = _aXXJKoJj;
        "pkg-0.0.8-mc1.21.4" = _6RrdE44a;
        "pkg-0.0.8-mc1.20.1" = _29jtScUx;
        "pkg-0.0.8-mc1.18.2" = _Nor9o8Sy;
        "pkg-0.0.8-hotfix-mc1.18.2" = _3kwStFXv;
        "pkg-0.0.8-hotfix-mc1.20.1" = _lzhwkFgv;
        "default" = _lzhwkFgv;
    });
