...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.8-fabric" = _iFEKNBDD;
        "pkg-1.18.2-1.8-fabric" = _8inJ89GU;
        "pkg-1.19.2-2.1-fabric" = _FXsKFLPp;
        "pkg-1.16.5-1.3-forge" = _sxEcvoJc;
        "pkg-1.18.2-1.5-forge" = _sOvbQGOk;
        "pkg-1.19.2-1.7-forge" = _jSwVdtlb;
        "pkg-1.16.5-2.2-fabric" = _BFlpLtKW;
        "pkg-1.18.2-2.2-fabric" = _VAhp8xPV;
        "pkg-1.19.2-2.2-fabric" = _RbDK3aUx;
        "pkg-1.19.3-2.3-fabric" = _djNcYXxM;
        "pkg-1.19.3-1.7-forge" = _Di5p6OlT;
        "pkg-1.18.2-3.0-forge+fabric" = _qaFKlceB;
        "pkg-1.19.2-3.0-forge+fabric" = _5bjld48F;
        "pkg-1.19.3-3.0-forge+fabric" = _ysKXr32E;
        "pkg-1.19.4-3.0-forge+fabric" = _XzOUtdeZ;
        "pkg-1.20-3.0-forge+fabric" = _ugub64SE;
        "pkg-1.20.1-3.0-forge+fabric" = _8JR9tOg6;
        "pkg-1.20.2-3.0-forge+fabric" = _7ZwKa0Gf;
        "pkg-1.18.2-3.1-forge+fabric" = _A81HS4WH;
        "pkg-1.19.2-3.1-forge+fabric" = _XIiCn18Q;
        "pkg-1.20.1-3.1-forge+fabric" = _7dEzmMej;
        "pkg-1.20.2-3.1-forge+fabric" = _BZ4Fvu1j;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _lgOC8sP9;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _7qwMbJi5;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _X9z8omoQ;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _AY2xlBOQ;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _BOHkt1Fp;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _KAk9nGbb;
        "pkg-1.20.5-3.2-fabric+neo" = _qRHEQvm2;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _UHgn47L1;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _cKAJqm2b;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _SR5Lotym;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _CIqlfOw5;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _fEJ94oqF;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _pU5nhQIf;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _sG9XjYvT;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _8egFcGvg;
        "pkg-1.21.2-3.5-fabric+neo" = _SOZG2ieW;
        "pkg-1.21.2-3.6-fabric+neo" = _XWJO5rWh;
        "pkg-1.21.3-3.6-fabric+forge+neo" = _e8nUak5a;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _WKe090Tb;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _aOVan9ta;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _TDChX8rW;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _infKPRn0;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _TIr2ljt1;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _eZHRjnAJ;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _UE7A3DWp;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _xjcNtDpz;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _Bwbd7cbt;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _opAVDRgv;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _d1pG5ro2;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _9h3NTjYH;
        "default" = _9h3NTjYH;
    });
