...
let
    ...
    in {
        ...
        "pkg-v2.4" = _V1qrnadW;
        "pkg-v2.5" = _9cNMvX7g;
        "pkg-v2.0-compat" = _27zeCGiw;
        "pkg-v2.6" = _cMfYRIp5;
        "pkg-v2.7" = _5fLLwVZh;
        "pkg-v2.8" = _k9dhnv81;
        "pkg-v2.9-1.19.1-pre1" = _u6sVu9fx;
        "pkg-v2.9-1.19.1-rc1" = _tcmJz2yT;
        "pkg-v2.12" = _K0YebORX;
        "pkg-v2.13-1.19.2" = _mmSUxmL9;
        "pkg-v2.13-22w42a" = _daZHZLRy;
        "pkg-v2.13-22w43a" = _vrIC6lpd;
        "pkg-v2.13-22w44a" = _djSBuh5C;
        "pkg-v2.14-1.19.2" = _xXxL1OOY;
        "pkg-v2.14-22w42a" = _vH3whZTb;
        "pkg-v2.14-22w43a" = _G4mMkRbo;
        "pkg-v2.14-22w44a" = _giq0qxtH;
        "pkg-v2.14-22w45a" = _oECsVE6T;
        "pkg-v2.15-1.19.2" = _nT8fB0Cz;
        "pkg-v2.15-22w42a" = _sLf4MERL;
        "pkg-v2.15-22w43a" = _RJjV6IXg;
        "pkg-v2.15-22w44a" = _ArmBM9kW;
        "pkg-v2.15-22w45a" = _mUiLB0Fj;
        "pkg-v2.15-22w46a" = _K4ACGF0G;
        "pkg-v2.16-1.19.2" = _Xt4wLuQQ;
        "pkg-v2.16-22w42a" = _9yMFwX9G;
        "pkg-v2.16-22w43a" = _nECb5ldk;
        "pkg-v2.16-22w44a" = _2IyEwOnO;
        "pkg-v2.16-22w45a" = _stW60zk8;
        "pkg-v2.16-22w46a" = _19EsDZdu;
        "pkg-v2.16-1.19.3-pre1" = _E9GOVaT5;
        "pkg-v2.16-1.19.3-pre2" = _jZMSEN8Y;
        "pkg-v2.16-1.19.3-pre3" = _KJRPGwfs;
        "pkg-v2.16-1.19.3-rc1" = _vQwzS30S;
        "pkg-v2.16-1.19.3-rc2" = _fn8guJiK;
        "pkg-v2.16-1.19.3-rc3" = _IrImqetF;
        "pkg-v2.16-1.19.3" = _ufhrRpID;
        "pkg-v2.17-1.19.2" = _sF88upro;
        "pkg-v2.17-22w42a" = _jIS2OfFF;
        "pkg-v2.17-22w43a" = _xNcxVqSu;
        "pkg-v2.17-22w44a" = _wAqcRV8u;
        "pkg-v2.17-22w45a" = _cg7zoHYJ;
        "pkg-v2.17-22w46a" = _ESVxMoCr;
        "pkg-v2.17-1.19.3-pre1" = _vtI6SCsD;
        "pkg-v2.17-1.19.3-pre2" = _K1OhgcRO;
        "pkg-v2.17-1.19.3-pre3" = _NKCAcD1L;
        "pkg-v2.17-1.19.3-rc1" = _ggKBYzLr;
        "pkg-v2.17-1.19.3-rc2" = _QYTlrGPG;
        "pkg-v2.17-1.19.3-rc3" = _EUO5eSDV;
        "pkg-v2.17-1.19.3" = _rVg969Tr;
        "pkg-v2.17-23w03a" = _NfaPTrsb;
        "pkg-v2.18-1.19.2" = _3YrL6UG1;
        "pkg-v2.18-22w42a" = _nzP6Wz0p;
        "pkg-v2.18-22w43a" = _IQFBfdzP;
        "pkg-v2.18-22w44a" = _xDvfH0fc;
        "pkg-v2.18-22w45a" = _3nT5nx4R;
        "pkg-v2.18-22w46a" = _aqpTWNiA;
        "pkg-v2.18-1.19.3-pre1" = _OaVExe72;
        "pkg-v2.18-1.19.3-pre2" = _kjE0qe0e;
        "pkg-v2.18-1.19.3-pre3" = _nsEjLKvE;
        "pkg-v2.18-1.19.3-rc1" = _m5zlwf86;
        "pkg-v2.18-1.19.3-rc2" = _kIST0Evj;
        "pkg-v2.18-1.19.3-rc3" = _zAcrDkNb;
        "pkg-v2.18-1.19.3" = _o02eQOuX;
        "pkg-v2.18-23w03a" = _WBevVXJo;
        "pkg-v2.18-23w04a" = _xtV4LxAm;
        "pkg-v2.18-23w05a" = _VVZzRrG9;
        "pkg-v2.18-23w06a" = _x2FxHiBg;
        "pkg-v2.18-23w07a" = _j1jyP5G6;
        "pkg-v2.18-1.19.4-pre1" = _MDFTopFf;
        "pkg-v2.18-1.19.4-pre2" = _f1v5yUgv;
        "pkg-v2.18-1.19.4-pre3" = _XQiEXndY;
        "pkg-v2.19-1.19.2" = _3Pjh6SW3;
        "pkg-v2.19-1.19.3" = _bqrve0Oh;
        "pkg-v2.19-1.19.4" = _FM61Xdbr;
        "pkg-v2.19-1.20" = _H8NZoGDW;
        "pkg-v2.19-1.20.1" = _W7Zt2Avg;
        "pkg-v2.19-23w31a" = _FQKApsjR;
        "pkg-v2.19-23w32a" = _jIyV32vL;
        "pkg-v2.19-23w33a" = _rMIoil3p;
        "pkg-v2.19-23w35a" = _KwPWNNSY;
        "pkg-v2.19-1.20.2-pre1" = _S9tdy7eK;
        "pkg-v2.19-1.20.2-pre2" = _e9bnXx7u;
        "pkg-v2.19-1.20.2-pre3" = _9z8eFYAu;
        "pkg-v2.19-1.20.2-pre4" = _24KHbcV1;
        "pkg-v2.19-1.20.2-rc1" = _eFvUYObS;
        "pkg-v2.19-1.20.2-rc2" = _6bQQ642b;
        "pkg-v2.19-1.20.2" = _AHNcDb4G;
        "pkg-v2.19-1.20.3" = _knVPRhpl;
        "pkg-v2.19-1.20.4" = _Os7j95pl;
        "pkg-v2.20-1.19.4" = _wz5TIwRR;
        "pkg-v2.20-1.20.2" = _oe4CZA6O;
        "pkg-v2.20-1.20.6" = _ufqYF5k1;
        "pkg-v2.20-1.21.1" = _LGGt3Lo1;
        "pkg-v2.20-1.21.3" = _sF7NtJmk;
        "pkg-v2.20-1.21.4" = _5zIITqWe;
        "pkg-v2.20-1.21.5" = _heCai3xz;
        "pkg-v2.20-1.21.6-pre1" = _7cYs7ldF;
        "pkg-v2.20-1.21.6" = _26NMWdKd;
        "default" = _26NMWdKd;
    });
