...
let
    ...
    in {
        ...
        "pkg-0.6.4" = _VLOOuq3n;
        "pkg-0.6.5" = _HNIe27ll;
        "pkg-0.6.6.578" = _THxOJggi;
        "pkg-0.6.6.738" = _asbuxQAs;
        "pkg-0.6.7.328" = _1u0mVKhM;
        "pkg-0.6.7.747" = _yW86N5TP;
        "pkg-0.6.8.73" = _28WOBX34;
        "pkg-0.6.8.267" = _AKszRw1f;
        "pkg-0.6.8.557" = _F8RO06V9;
        "pkg-0.6.8.921" = _rRo6cnFo;
        "pkg-0.6.9" = _yHEU8S6c;
        "pkg-0.6.10" = _6UfijJJg;
        "pkg-0.6.11" = _oRI18aAD;
        "pkg-0.6.12" = _NN8CfEFv;
        "pkg-0.6.13" = _dkhDywsu;
        "pkg-0.7.0" = _vcc0xyMb;
        "pkg-0.7.1" = _PF4F37n6;
        "pkg-0.7.2" = _poO9B41r;
        "pkg-0.7.3" = _iZjGZG45;
        ...
        "pkg-0.7.8" = _A5JWbmCv;
        "pkg-0.7.9" = _TDzuF8wM;
        "pkg-0.7.10" = _popf0YrR;
        "pkg-0.7.11" = _V6SZ6Djc;
        "pkg-0.7.12" = _OnvuWdHe;
        "pkg-0.7.13" = _1pmUlxeH;
        "pkg-0.7.15" = _ccL0do1g;
        "pkg-0.7.16" = _jQYciRJI;
        "pkg-0.7.17" = _1YgEI2hH;
        "pkg-0.7.18" = _bZvSBFdK;
        "pkg-0.7.19" = _w4ZeEocx;
        "pkg-0.7.20" = _ZjiCm2fV;
        "pkg-0.7.21" = _bDL4xFNb;
        "pkg-0.7.22" = _P5UVJ6G3;
        "pkg-0.7.23" = _5PsFEbBn;
        "pkg-0.7.24" = _ZoAExrqd;
        "pkg-0.7.25" = _JZwjxAo1;
        "pkg-0.7.26" = _9hmQcxFp;
        "pkg-0.7.27" = _MKw3Y1pT;
        "pkg-0.7.30" = _LGxn9xFc;
        "pkg-0.7.31" = _8ekOQCY6;
        "pkg-0.7.32" = _emK5b9FH;
        "pkg-0.7.34" = _BfxuJvZk;
        "pkg-0.7.35" = _dWQTFXmf;
        "pkg-0.7.36" = _Yd5tGPaA;
        "pkg-0.7.37" = _afiH7OoA;
        "pkg-0.8.00.dev1" = _Rg4QbZIi;
        "pkg-0.8.00.dev2" = _l0Wn7iiI;
        "pkg-0.8.00.dev3" = _6cVxYw4Z;
        "pkg-0.8.00.dev4" = _cI9E5DTb;
        "pkg-0.8.00.dev6" = _GV11Jgd4;
        "pkg-0.8.00.dev7" = _VNqm3LmR;
        "pkg-0.8.00.dev8" = _iDymZIST;
        "pkg-0.8.00.dev9" = _qAovL0XA;
        "pkg-0.8.00.dev10" = _NY4cfRFR;
        "pkg-0.8.00.dev11" = _VwHbYUVA;
        "pkg-0.8.00.dev12" = _lCnfPWtM;
        "pkg-0.8.00.dev13" = _5oHH0quW;
        "pkg-0.8.01" = _45BguMor;
        "pkg-0.8.03dev0" = _FbwAX4I1;
        "pkg-0.8.03dev1" = _cu0kBSPW;
        "pkg-0.8.03dev2" = _5kMauwMQ;
        "pkg-0.8.03dev4" = _BhOCEj7j;
        "pkg-0.8.03dev5" = _sgvoud0W;
        "pkg-0.8.03dev6" = _hHcSS7WR;
        "pkg-0.8.04beta1" = _5jsREfTz;
        "pkg-0.8.04beta2" = _CfFMIIfw;
        "pkg-0.8.04beta3" = _GRNLGQ3M;
        "pkg-0.8.04beta6" = _T4os4Asl;
        "pkg-0.8.04beta7" = _nmZUIu8Z;
        "pkg-0.8.04beta8" = _CkRcAOIu;
        "pkg-0.8.04beta9" = _lclJmfQX;
        "pkg-0.8.04beta11" = _DHm08W3x;
        "pkg-0.8.04beta12" = _qWLvff6R;
        "pkg-0.8.04beta13" = _xlZxp2C1;
        "pkg-0.8.04beta14" = _IAXTU6HB;
        "pkg-0.8.04beta15" = _ph9VVlPJ;
        "pkg-0.8.04beta16" = _SD1lqGgk;
        "pkg-0.8.04beta17" = _ASwmu8KU;
        "pkg-0.8.04beta18" = _eeB1kqw6;
        "pkg-0.8.05beta01" = _HI3F0ae1;
        "pkg-0.8.06b01" = _15AQfbJ8;
        "pkg-0.8.06b02" = _TtW3MPar;
        "pkg-0.8.06b03" = _nlwEfl0u;
        "pkg-0.8.06b04" = _IlOxRVmj;
        "pkg-0.8.06b05" = _zFnMm3rs;
        "pkg-0.8.06b06" = _r7oV3Gsh;
        "pkg-0.8.06b07" = _KUHl2ktS;
        "pkg-0.8.06" = _B66SQi1b;
        "pkg-0.8.07b01" = _SPz64Vba;
        "pkg-0.8.08" = _rdTIfo9H;
        "pkg-0.8.09" = _TZixJE3d;
        "pkg-0.8.10" = _aPPyTWMM;
        "pkg-0.8.11" = _s3s8kxlI;
        "pkg-0.8.12" = _sRkpayP6;
        "pkg-0.8.13" = _c9rb3oiV;
        "pkg-0.8.14" = _ctCzItT7;
        "pkg-0.8.15" = _bh4GWmY7;
        "pkg-0.8.16" = _5HN4ppXr;
        "pkg-0.8.17" = _LvA9Ry4p;
        "pkg-0.8.18" = _4oTi2mri;
        "pkg-0.8.19" = _22uAPCYY;
        "pkg-0.8.20" = _N5FEO0NX;
        "pkg-0.8.22" = _6VxLEvKX;
        "pkg-0.8.23" = _LQ5fKiNT;
        "pkg-0.8.24" = _1GJXjDSN;
        "pkg-0.8.25" = _k0iRNZ0A;
        "pkg-0.8.25mark2" = _8E4otpmS;
        "pkg-0.8.26" = _hrnd0XHH;
        "pkg-0.8.27" = _EVj9qIYD;
        "pkg-0.8.28" = _ztv9J81J;
        "pkg-0.8.29" = _btZdarUL;
        "pkg-0.8.30" = _RKaSuqwc;
        "pkg-0.8.31" = _uWGqqGl4;
        "pkg-0.8.32" = _TDZab7mC;
        "pkg-0.8.33" = _TrBK9r8E;
        "pkg-0.8.34" = _INyrb6Kr;
        "pkg-0.8.35" = _5jmAxwjU;
        "pkg-0.8.68" = _SXz8bCA9;
        "pkg-0.8.72" = _q3XCWGLC;
        "pkg-0.8.76" = _OTbqQQJK;
        "pkg-0.8.77" = _qxblaki6;
        "pkg-0.8.79" = _kkINkm3s;
        "pkg-0.8.80" = _ZckwaFfC;
        "pkg-0.8.82" = _LQ0CvlKr;
        "pkg-0.8.82+1.7.10" = _aADsrGRx;
        "pkg-0.8.83" = _KVd69X2Y;
        "pkg-0.8.84" = _7O0om1l7;
        "pkg-0.8.85" = _l9FPuzl4;
        "pkg-0.8.86" = _9i45bkaA;
        "pkg-0.8.87" = _J76g7rV1;
        "pkg-0.8.87.1" = _EEpG6nU9;
        "pkg-0.8.87.2" = _XxpACXta;
        "pkg-0.8.87.3" = _OVDqZe8G;
        "pkg-0.8.87.4" = _Te4nSVMf;
        "pkg-0.8.87.5" = _yx9i2xFN;
        "pkg-0.8.87.6" = _Of3JFN0g;
        "pkg-0.8.88" = _KbNC3Vrl;
        "pkg-0.8.88.1" = _Xkx6jdbH;
        "pkg-0.8.88.2" = _dXbyXpnY;
        "pkg-0.8.88.4" = _ckgPtEWl;
        "pkg-0.8.88.5" = _hzU7CSx1;
        "pkg-0.8.88.6" = _jEOYknVJ;
        "pkg-0.8.88.7" = _DxMquQuS;
        "pkg-0.8.88.8.8888" = _SYBY62xT;
        "pkg-0.8.88.8.8888a" = _JqzyPYqB;
        "pkg-0.8.88.8.8888b" = _l6aFIn2X;
        "pkg-0.8.88.8.8888c" = _4RzOUDAZ;
        "pkg-0.8.88.8.8888d" = _QV1Pij3K;
        "pkg-0.8.88.8.8888e" = _DySyOMFH;
        "pkg-0.8.88.8.8888f" = _UweDgL9R;
        "pkg-0.8.88.8.8888g" = _v7PMlHbA;
        "pkg-0.8.88.8.8888h" = _E2JcBwwH;
        "pkg-0.8.88.9" = _5LSBXQQi;
        "pkg-0.8.89" = _PB0wl27E;
        "pkg-0.8.89.8.8888h" = _oFUR87AH;
        "pkg-0.8.90" = _30Gw2usK;
        "pkg-0.8.91" = _vdPegL4v;
        "pkg-0.8.92" = _PIokzk6V;
        "pkg-0.8.93" = _ATvfSw9Y;
        "pkg-0.8.94" = _vHsIIWXe;
        "pkg-0.8.95" = _Y5SsHBPY;
        "pkg-0.8.95a" = _3GH1F89O;
        "pkg-0.8.95b" = _y9RmYm8c;
        "pkg-0.8.95c" = _Yw5BK8io;
        "pkg-0.8.95d" = _CiiSCjYn;
        "pkg-0.8.95e" = _LBkcEKo0;
        "pkg-0.8.95f" = _VYpYKBe9;
        "pkg-0.8.95g" = _U6CFBl78;
        "pkg-0.8.95h" = _uUTwy78w;
        "pkg-0.8.95i" = _31rWO9h2;
        "pkg-0.8.95j" = _UlS6Had5;
        "pkg-0.8.95k" = _uz6qHLxv;
        "pkg-0.8.96" = _9T8izbGd;
        "pkg-0.8.96a" = _9CNeiWjY;
        "pkg-0.8.96b" = _nnWbL3Ks;
        "pkg-0.8.96c" = _39KSbBBA;
        "pkg-0.8.96d" = _yAlubK4h;
        "pkg-0.8.96e" = _4HpCBizx;
        "pkg-0.8.96f" = _H7I04Jwe;
        "pkg-0.8.96g" = _Joy1IfPJ;
        "pkg-0.8.96h" = _FbaDBlzA;
        "pkg-0.8.96i" = _ttPWCMV7;
        "pkg-0.8.96j" = _H5Tfm8mn;
        "pkg-0.8.96k" = _v2QbuP5c;
        "pkg-0.8.96l" = _FkYDYw1G;
        "pkg-0.8.96m" = _p4Yyvbrx;
        "pkg-0.8.96n" = _yQJJYeXx;
        "pkg-0.8.97" = _Kos7YHM7;
        "pkg-0.8.98" = _aWjqehUi;
        "pkg-0.8.98a" = _IUYVu0nP;
        "pkg-0.8.98b" = _HZpbeiTK;
        "pkg-0.8.98c" = _Rfx4Zv7S;
        "pkg-0.8.98d" = _qkGUETDx;
        "pkg-0.8.98e" = _XMjCOPSn;
        "pkg-0.8.98f" = _DG1kqkSA;
        "pkg-0.8.98g" = _ry2aFmUI;
        "pkg-0.8.98h" = _uwdfAPYC;
        "pkg-0.8.98i" = _P6I4Zyfy;
        "pkg-0.8.98k" = _fg13fsB0;
        "pkg-0.8.98l" = _77oWXGaK;
        "pkg-0.8.98m" = _r2xDa3HS;
        "pkg-0.8.98n" = _W0q01AcV;
        "pkg-0.8.98o" = _RfqT9wWZ;
        "pkg-0.8.98p" = _qSbHCJoA;
        "pkg-0.8.98q" = _bDzxEm2j;
        "pkg-0.8.98r" = _Nv2POQOH;
        "pkg-0.8.98s" = _SaPg2EG6;
        "pkg-0.8.99" = _Bae4li4K;
        "pkg-0.8.99a" = _JT0OZJCV;
        "pkg-0.8.99b" = _A5DMA94S;
        "pkg-0.8.99c" = _EfvVSErU;
        "pkg-0.8.99d" = _8bVyeBjm;
        "pkg-0.8.100" = _bDmdm7SU;
        "pkg-0.8.101" = _Zts4noV1;
        "pkg-0.8.102" = _Dg7jAxn3;
        "pkg-0.8.103" = _yJJa1cM5;
        "pkg-0.8.104" = _FVOm39CI;
        "pkg-0.8.105" = _9cHeT1N9;
        "pkg-0.8.106" = _dqZfrcNr;
        "pkg-0.8.107" = _WttgPcXU;
        "pkg-0.8.108" = _klnwYCDE;
        "pkg-0.9.35" = _lfdgYWrF;
        "pkg-0.8.109" = _KJerrW8i;
        "default" = _KJerrW8i;
    });
