...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0-forge+fabric" = _Rkw6SbPd;
        "pkg-1.19.2-1.0-forge+fabric" = _ov3D4KLo;
        "pkg-1.19.4-1.0-forge+fabric" = _HpORgTLN;
        "pkg-1.20.1-1.0-forge+fabric" = _ZQ8UNIXL;
        "pkg-1.20.2-1.0-forge+fabric" = _yftPJPhR;
        "pkg-1.18.2-1.1-forge+fabric" = _gxj6B3m3;
        "pkg-1.19.2-1.1-forge+fabric" = _Gf5IJODT;
        "pkg-1.20.1-1.1-forge+fabric" = _Zb1YcwxE;
        "pkg-1.20.2-1.1-forge+fabric" = _7GGyYoHV;
        "pkg-1.20.2-1.2-forge+fabric" = _6RBTteX6;
        "pkg-1.20.3-1.2-fabric+forge+neo" = _fhfr3nPO;
        "pkg-1.20.4-1.2-fabric+forge+neo" = _RONboss1;
        "pkg-1.19.2-1.3-fabric+forge+neo" = _1xTlx0wL;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _z0DxO8gu;
        "pkg-1.20.2-1.3-fabric+forge+neo" = _fKOKSwTX;
        "pkg-1.20.4-1.3-fabric+forge+neo" = _DVh7ANEn;
        "pkg-1.19.2-1.4-fabric+forge+neo" = _SOPsabwC;
        "pkg-1.20.1-1.4-fabric+forge+neo" = _aU3X09rh;
        "pkg-1.20.2-1.4-fabric+forge+neo" = _LKwBWVNm;
        "pkg-1.20.4-1.4-fabric+forge+neo" = _X15ETIZn;
        "pkg-1.20.5-1.4-fabric+neo" = _EL7gUDpi;
        "pkg-1.20.6-1.4-fabric+forge+neo" = _vs8AbcX9;
        "pkg-1.21.0-1.4-fabric+forge+neo" = _tMptyck1;
        "pkg-1.20.1-1.5-fabric+forge+neo" = _abfEKxIh;
        "pkg-1.20.6-1.5-fabric+forge+neo" = _qQ7Mq5dk;
        "pkg-1.21.0-1.5-fabric+forge+neo" = _XpAzAV0G;
        "pkg-1.21.1-1.5-fabric+forge+neo" = _ey8EuwwW;
        "pkg-1.21.2-1.5-fabric+neo" = _DACXLbCG;
        "pkg-1.21.3-1.5-fabric+forge+neo" = _6AEUSGIm;
        "pkg-1.21.4-1.5-fabric+forge+neo" = _wHUTNacB;
        "pkg-1.21.5-1.5-fabric+forge+neo" = _xGlulDWA;
        "pkg-1.21.6-1.5-fabric+forge+neo" = _LMCuq7h6;
        "pkg-1.21.7-1.5-fabric+forge+neo" = _bPKnL8tX;
        "pkg-1.21.8-1.5-fabric+forge+neo" = _6LERH2uq;
        "pkg-1.21.9-1.5-fabric+forge+neo" = _Bg3UoB2u;
        "pkg-1.21.9-1.6-fabric+forge+neo" = _Ll6xUl18;
        "pkg-1.21.10-1.6-fabric+forge+neo" = _uSBG0Ik3;
        "pkg-1.21.11-1.6-fabric+forge+neo" = _nkhul8Fx;
        "pkg-26.1.0-1.6-fabric+forge+neo" = _6Na590c2;
        "pkg-26.1.1-1.6-fabric+forge+neo" = _gcJ1zl3I;
        "pkg-26.1.2-1.6-fabric+forge+neo" = _jI5FsgbQ;
        "pkg-26.2.0-1.6-fabric+forge+neo" = _gSfUPcOh;
        "default" = _gSfUPcOh;
    });
