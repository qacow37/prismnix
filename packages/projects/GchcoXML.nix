...
let
    ...
    in {
        ...
        "pkg-1.2.5" = _Ti8TJ58B;
        "pkg-1.18.2-1.2.5" = _rhj7Nexq;
        "pkg-1.16.5-1.2.5" = _sl4bJ9He;
        "pkg-1.18.2-1.2.5a" = _E7vz516D;
        "pkg-1.16.5-1.2.5a" = _ZjN0wxRC;
        "pkg-1.19-1.2.5a" = _rR8ZrdCw;
        "pkg-1.16.5-1.2.6" = _zxDW8JVW;
        "pkg-1.16.5-1.4.3" = _9KaQ8Nei;
        "pkg-1.18.2-1.4.3" = _YM91QDuZ;
        "pkg-1.19.2-1.2.8" = _A6aEs4bJ;
        "pkg-1.19.2-1.2.8a" = _nApEYsZi;
        "pkg-1.16.5-1.4.5" = _uNDmEO4n;
        "pkg-1.18.2-1.4.3a" = _zuJ1306r;
        "pkg-1.19.4-1.5.2" = _KyxZ315g;
        "pkg-1.18.2-1.5.2" = _mGoSRprD;
        "pkg-1.19.2-1.6.4" = _Af4brqYV;
        "pkg-1.20-1.6.4" = _HxUtDCCe;
        "pkg-1.18.2-1.6.4" = _UynWw2df;
        "pkg-1.16.5-1.4.6" = _Uz28Wi1p;
        "pkg-1.19.2-1.6.9" = _4lE9D01D;
        "pkg-1.20.1-1.6.9" = _6xfXhsvf;
        "pkg-1.20.1-1.16.3" = _yUsIHXQX;
        "pkg-1.16.5-1.4.7" = _ZFTuwymb;
        "pkg-1.20.1-1.16.5" = _KexKV6k0;
        "pkg-1.20.1-1.6.15a" = _Bj8M79wL;
        "pkg-1.16.5-1.4.8" = _SPCLqJn1;
        "pkg-1.20.1-1.7.0" = _vVuYfukI;
        "pkg-1.20.1-1.8.0" = _iQ1SwGc3;
        "pkg-1.19.2-1.6.9a" = _Mw8aFpWF;
        "default" = _Mw8aFpWF;
    });
