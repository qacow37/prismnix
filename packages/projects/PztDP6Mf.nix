...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _OPUkYr8g;
        "pkg-0.1.1+1.20.3" = _r48VVbmv;
        "pkg-0.1.1+1.20" = _aQK4aphN;
        "pkg-0.1.1+1.20.2" = _RIPYEqcJ;
        "pkg-0.1.2+1.21" = _9Zr5JAS4;
        "pkg-0.1.2+1.20.3" = _49VTe8RF;
        "pkg-0.1.2+1.20.5" = _CLThCUQO;
        "pkg-0.1.2+1.20.2" = _s1dnZpuo;
        "pkg-0.1.2+1.20" = _oJA2h1ir;
        "pkg-0.2.0+1.20.3" = _6wJ2NrIG;
        "pkg-0.2.0+1.21" = _pJQR86v0;
        "pkg-0.2.0+1.20.5" = _kS6zo2l1;
        "pkg-0.2.0+1.20.2" = _U2pqXfpo;
        "pkg-0.2.0+1.20" = _hH9bB4y2;
        "pkg-0.2.1+1.20.5" = _cOdn5650;
        "pkg-0.2.1+1.21" = _rOCmikMT;
        "pkg-0.2.1+1.21.2" = _B0QWvfV7;
        "pkg-0.2.1+1.20.3" = _ywbJeNDV;
        "pkg-0.2.1+1.20.2" = _UEMvPjgL;
        "pkg-0.2.1+1.20" = _U5KJ8Fd8;
        "pkg-0.3.0+1.20.3" = _icgB3Dyu;
        "pkg-0.3.0+1.20.5" = _J8GnsIrU;
        "pkg-0.3.0+1.21.2" = _qnAwnFQD;
        "pkg-0.3.0+1.21" = _CSu1kJZk;
        "pkg-0.3.0+1.20.2" = _e9vQxdVu;
        "pkg-0.3.0+1.20" = _ZhxImpNx;
        "default" = _ZhxImpNx;
    });
