...
let
    ...
    in {
        ...
        "pkg-v4.1.0-1.19.1-Fabric" = _WWicLhnx;
        "pkg-v4.1.1-1.19.1-Forge" = _ehrLL7QC;
        "pkg-v4.1.1-1.19.1-Fabric" = _SfwL8TIC;
        "pkg-v4.1.2-1.19.1-Forge" = _l3jMig0h;
        "pkg-v4.1.2-1.19.1-Fabric" = _Clo4Ou99;
        "pkg-v4.2.0-1.19.2-Fabric" = _eSHRJkhP;
        "pkg-v4.2.0-1.19.2-Forge" = _TNX3OWP4;
        "pkg-v4.2.1-1.19.2-Forge" = _OmsqC7z6;
        "pkg-v4.2.1-1.19.2-Fabric" = _Qtj0eqdC;
        "pkg-v5.0.0-1.19.3-Forge" = _4yLqxMg1;
        "pkg-v5.0.0-1.19.3-Fabric" = _UbDAHXPS;
        "pkg-v6.0.0-1.19.4-Forge" = _TxISAMem;
        "pkg-v6.0.0-1.19.4-Fabric" = _D8LYGT5l;
        "pkg-v7.0.0-1.20-Forge" = _k6jSH6bg;
        "pkg-v7.0.0-1.20-Fabric" = _rDEivCOp;
        "pkg-v8.0.0-1.20.1-Forge" = _afGEsJqq;
        "pkg-v8.0.0-1.20.1-Fabric" = _Yf6Mw7GF;
        "pkg-v3.3.0-1.18.2-Fabric" = _DpsLba8t;
        "pkg-v3.3.0-1.18.2-Forge" = _Lmq7SPq6;
        "pkg-v8.0.1-1.20.1-Forge" = _2zZCctvF;
        "pkg-v8.0.1-1.20.1-Fabric" = _fT3Ka4ZV;
        "pkg-v20.4.0-1.20.4-Fabric" = _94BNurOK;
        "pkg-v20.4.0-1.20.4-NeoForge" = _TU7cQ1ps;
        "pkg-v20.4.0-1.20.4-Forge" = _4fWy5OWI;
        "pkg-v8.0.2-1.20.1-Forge" = _oyg2PFvx;
        "pkg-v8.0.2-1.20.1-Fabric" = _8l8ZXn2b;
        "pkg-v20.4.1-1.20.4-Fabric" = _RcNaTsvZ;
        "pkg-v20.4.1-1.20.4-NeoForge" = _fEy47br4;
        "pkg-v20.4.1-1.20.4-Forge" = _YGMctvGV;
        "pkg-v21.1.0-1.21.1-Fabric" = _8V0RYIWS;
        "pkg-v21.1.0-1.21.1-NeoForge" = _jKt2foO0;
        "pkg-v21.3.0-1.21.3-Fabric" = _2lBAtyTL;
        "pkg-v21.3.0-1.21.3-NeoForge" = _7ZaxunmW;
        "pkg-v21.4.0-1.21.4-Fabric" = _yHCLlydp;
        "pkg-v21.4.0-1.21.4-NeoForge" = _pJKia7Ia;
        "pkg-v21.5.0-1.21.5-Fabric" = _NDOTE4Mw;
        "pkg-v21.5.0-1.21.5-NeoForge" = _zexmlDM3;
        "pkg-v21.6.0-1.21.6-Fabric" = _kA1cqXoD;
        "pkg-v21.6.0-1.21.6-NeoForge" = _R0IayrBE;
        "pkg-v21.7.0-1.21.7-Fabric" = _hduSL35v;
        "pkg-v21.7.0-1.21.7-NeoForge" = _GNuMCTGK;
        "pkg-v21.8.0-1.21.8-Fabric" = _XQW2SjEh;
        "pkg-v21.8.0-1.21.8-NeoForge" = _M41KRqKd;
        "pkg-21.9.0" = _a7RRbDsU;
        "pkg-21.10.0" = _RFdfKivK;
