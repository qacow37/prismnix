...
let
    ...
    in {
        ...
        "pkg-1.31.2" = _yDUlYk38;
        "pkg-1.31.3" = _fj6w5lf5;
        "pkg-1.31.4" = _7drDsXxk;
        "pkg-1.31.5" = _aw7s3UEm;
        "pkg-1.31.6" = _J4UQOtW2;
        "pkg-1.32.1" = _vfY5MGze;
        "pkg-1.33.0" = _rRZYMvlP;
        "pkg-1.33.1" = _dwgk3n8c;
        "pkg-1.33.2" = _N9TiAE2r;
        "pkg-1.34" = _8uuFUfrC;
        "pkg-1.34.1" = _unQTN85d;
        "pkg-1.34.2" = _tprdWCrQ;
        "pkg-1.35.0" = _WDcqxfJD;
        "pkg-1.35.1" = _IOKWGmHr;
        "pkg-1.35.2" = _LIiNbF4n;
        "pkg-1.35.3" = _xBEU2nFc;
        "pkg-1.35.4" = _13OGhmoz;
        "pkg-1.35.5" = _p1SonBQ8;
        "pkg-1.35.6" = _rl5zWOzP;
        "pkg-1.35.7" = _Iw8qnd3K;
        "pkg-1.35.8" = _TORUQvva;
        "pkg-1.35.9" = _hrjalDp5;
        "pkg-1.35.10" = _Ypi6nV9o;
        "pkg-1.36.0" = _TYJHlRUJ;
        "pkg-1.36.1" = _La1QFYsp;
        "pkg-1.36.2" = _glcE5wzj;
        "pkg-1.36.3" = _EHQiyXCp;
        "pkg-1.36.4" = _jpuo45JZ;
        "pkg-1.37.0" = _PCheBYnf;
        "pkg-1.37.1" = _23yQqsRC;
        "pkg-1.37.2" = _sksbwIjO;
        "pkg-1.37.3" = _zbzklWMd;
        "pkg-1.37.4" = _bOwReJhO;
        "pkg-1.37.5" = _BYR2BVmv;
        "pkg-1.37.6" = _NXELhimu;
        "pkg-1.37.7" = _K2Wyc0b3;
        "pkg-1.37.8" = _rfLSzTWO;
        "pkg-1.37.9" = _EuVPHzQO;
        "pkg-1.37.10" = _LHXaRZXu;
        "pkg-1.37.11" = _tEHzcx79;
        "pkg-1.0.0" = _uHXFxH1F;
        "default" = _uHXFxH1F;
    });
