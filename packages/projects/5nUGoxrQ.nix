...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _mlSnW4uE;
        "pkg-1.0.0+mod" = _DoXk7zZL;
        "pkg-1.0.1" = _HuTj6pQT;
        "pkg-1.0.1+mod" = _y29FhDQc;
        "pkg-1.2.0" = _npE5w7Zg;
        "pkg-1.2.1" = _It1mXTeM;
        "pkg-1.2.1+mod" = _xKKAW654;
        "pkg-1.2.2" = _BwyCVsMx;
        "pkg-1.2.2+mod" = _5Ejl6ftT;
        "pkg-1.2.3" = _IG17f5ME;
        "pkg-1.2.3+mod" = _h5XkvuAp;
        "pkg-1.2.4" = _iQ83w4Nn;
        "pkg-1.2.4+mod" = _YFi4q4iQ;
        "pkg-1.2.5" = _ZYq1Kire;
        "pkg-1.2.5+mod" = _3XySMiZX;
        "pkg-1.2.6" = _eO2aOhn8;
        "pkg-1.2.6+mod" = _96A36iI9;
        "pkg-1.2.7" = _otrfUcY5;
        "pkg-1.2.7+mod" = _SGGGBo8p;
        "pkg-1.2.8" = _W7qJSbxi;
        "pkg-1.2.8+mod" = _F4ZMVAiq;
        "pkg-1.2.9" = _b0V2i7D9;
        "pkg-1.2.9+mod" = _vZW3KFH2;
        "pkg-1.2.10" = _hZd20INc;
        "pkg-1.2.10+mod" = _Bl4wwHH9;
        "pkg-1.2.11" = _JiyJwWJw;
        "pkg-1.2.11+mod" = _IdFKXHFh;
        "pkg-1.2.12" = _ZfzO2BW8;
        "pkg-1.2.12+mod" = _cZCFyDWN;
        "pkg-1.2.13" = _17aN1mhg;
        "pkg-1.2.14" = _xCJQRM6X;
        "pkg-1.2.15" = _6AFu5qu9;
        "pkg-1.2.15+mod" = _ZyXi1fEH;
        "pkg-1.2.16" = _kIz9YS5p;
        "pkg-1.2.16+mod" = _QNJiyj87;
        "default" = _QNJiyj87;
    });
