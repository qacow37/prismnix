...
let
    ...
    in {
        ...
        "pkg-0.3" = _A0anelw7;
        "pkg-0.4" = _XYQFHu2W;
        "pkg-0.5+forge-1.19" = _wtB6LjXO;
        "pkg-0.5+fabric-1.19" = _35YhUNH5;
        "pkg-0.5+forge-1.20" = _ONxAV7a7;
        "pkg-0.5+fabric-1.20" = _KXyVCtl3;
        "pkg-0.5.1+fabric-1.20" = _H7E3oTwZ;
        "pkg-0.5.1+forge-1.20" = _aPC8Z8O3;
        "pkg-0.5.1+forge-1.19" = _KjRwVfnC;
        "pkg-0.5.1+fabric-1.19" = _swQxhb2Q;
        "pkg-0.5.2+fabric-1.19" = _4YrG3umU;
        "pkg-0.5.2+fabric-1.20" = _gDswrgdN;
        "pkg-0.6-forge+1.19" = _kMhhHFX4;
        "pkg-0.6-forge+1.20" = _j2dFiJKc;
        "pkg-0.6-fabric+1.19" = _mMcwVgO8;
        "pkg-0.6-fabric+1.20" = _xSz3QE8y;
        "pkg-0.8-fabric+1.20" = _Tr3g2jcl;
        "pkg-0.8-forge+1.20" = _FEUVA5A1;
        "pkg-0.8-fabric+1.19" = _diGNiw9g;
        "pkg-0.9-fabric+1.19" = _Aw1ssozL;
        "pkg-0.9-fabric+1.20" = _Dip09YXu;
        "pkg-0.9-forge+1.19" = _ip8BcCgA;
        "pkg-0.9-forge+1.20" = _DEv7xRtt;
        "pkg-0.10-forge+1.19" = _d1LDoqva;
        "pkg-0.10-fabric+1.19" = _4qP09QMI;
        "pkg-0.10-forge+1.20" = _SeE1Ntg7;
        "pkg-0.10-fabric+1.20" = _uI6Zjvdf;
        "default" = _uI6Zjvdf;
    });
