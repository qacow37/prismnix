...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _f1RboUQu;
        "pkg-2.0.0" = _zTGnWPt2;
        "pkg-2.0.0-1.20.2" = _wgykUJxK;
        "pkg-2.0.0-1.20.3" = _Gc9fd2pj;
        "pkg-2.0.0-1.20.4" = _EcNBZWIC;
        "pkg-2.0.0-1.20.5" = _B5ZHmkmF;
        "pkg-2.0.0-1.20.6" = _XRsiFTgW;
        "pkg-2.0.0-1.21" = _kpudBuAv;
        "pkg-2.0.0-1.21.1" = _Jc9jLH03;
        "pkg-2.0.1-1.20.5" = _dY8qsFfw;
        "pkg-2.0.1-1.20.6" = _Uokonkv3;
        "pkg-2.0.1-1.21" = _xmwpxf6e;
        "pkg-2.0.1-1.21.1" = _StfGAn0M;
        "pkg-2.0.0-1.21.2" = _fXC4KSem;
        "pkg-2.0.0-1.21.3" = _XS68CBIb;
        "pkg-2.0.0-1.21.4" = _uTwA6ajq;
        "pkg-2.0.0-1.21.5" = _SVTkUKXc;
        "pkg-2.0.0-1.21.6" = _6lQeC9sg;
        "pkg-2.0.0-1.21.7" = _JTjIfmxf;
        "pkg-2.0.0-1.21.8" = _NB1FrJuK;
        "pkg-2.0.0-1.21.9" = _hmOlpabl;
        "pkg-2.0.0-1.21.10" = _lh9Sv50n;
        "pkg-2.0.0-1.21.11" = _IwOMwVgH;
        "pkg-2.0.0-1.21.0" = _14yauD6l;
        "pkg-2.0.0-1.21.9-neoforge" = _vyOaVE54;
        "pkg-2.0.0-1.21.10-neoforge" = _cdGvON2U;
        "pkg-2.0.0-1.21.11-neoforge" = _jvr7n7bR;
        "pkg-2.0.0-1.20.2-forge" = _UO0QjnZv;
        "pkg-2.0.0-1.20.3-forge" = _lQQzck6a;
        "pkg-2.0.0-1.20.4-forge" = _VJO0zpkL;
        "pkg-2.0.0-1.20.6-forge" = _qdxUUdJL;
        "pkg-2.0.0-1.21.0-forge" = _hgm904bg;
        "pkg-2.0.0-1.21.1-forge" = _SOI2aucD;
        "pkg-2.1.0-1.21.1-fabric" = _ujOCI9Vx;
        "pkg-2.1.0-1.21.1-neoforge" = _HiQPog5e;
        "pkg-2.1.0-1.21.2-Fabric" = _SU7bWyK5;
        "pkg-2.1.0-1.21.4-Fabric" = _dy0wMgaK;
        "pkg-2.1.0-1.21.5-Fabric" = _9LW2X0nT;
        "pkg-2.1.0-1.21.6-Fabric" = _40sZWCFa;
        "pkg-2.1.0-1.21.9-Fabric" = _syrGyglh;
        "pkg-2.1.0-1.21.11-Fabric" = _JuHSiXt4;
        "pkg-2.1.0-26.1-Fabric" = _SstAX5rv;
        "pkg-2.1.0-26.2-Fabric" = _2a3lC6HV;
        "default" = _2a3lC6HV;
    });
