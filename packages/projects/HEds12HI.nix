...
let
    ...
    in {
        ...
        "pkg-0.0.5+1.21" = _EgjvDGiD;
        "pkg-0.0.5-1.21.3" = _T9yduWfZ;
        "pkg-0.0.5-1.21.4" = _Oj8DwPwq;
        "pkg-0.0.6+1.21" = _Cf6c2EvD;
        "pkg-0.0.6-1.21.3" = _B3YVw2nR;
        "pkg-0.0.6-1.21.4" = _zNurbmod;
        "pkg-0.0.7+1.21" = _i7KlEYsj;
        "pkg-0.0.7-1.21.3" = _xSkmkyGT;
        "pkg-0.0.7-1.21.4" = _2jR6XUZH;
        "pkg-0.0.8+1.21" = _xibnTcEJ;
        "pkg-0.0.8-1.21.3" = _gbS6f6fi;
        "pkg-0.0.8-1.21.4" = _ErTZpqzc;
        "pkg-0.0.8-1.21.5" = _P2Kor1Ep;
        "pkg-0.0.9+1.21" = _fxD8AOmU;
        "pkg-0.0.9-1.21.3" = _FB2KPVCH;
        "pkg-0.0.9-1.21.4" = _b1i3bNo7;
        "pkg-0.0.9-1.21.5" = _Szd9f6nN;
        "pkg-0.0.9-1.21.6" = _CO9OfShw;
        "pkg-0.0.10-1.21.6" = _SMJhWisa;
        "pkg-0.0.10-1.21.9" = _tpvxlOkT;
        "pkg-0.0.11-1.21.9" = _4beV1yx6;
