...
let
    ...
    in {
        ...
        "pkg-v1.0.0+minecraft-1.16.1" = _sz2ipujC;
        "pkg-v1.0.1+minecraft-1.16.2" = _ATiDVkLs;
        "pkg-v1.0.1+minecraft-1.16.3" = _FQMlJCVx;
        "pkg-v1.0.2+minecraft-1.16.4" = _DQ53Sdjg;
        "pkg-v3.0.0-beta.0+fabric" = _vFZA7GZn;
        "pkg-v3.0.0-beta.0+forge" = _O8wgGXXo;
        "pkg-v3.0.0-beta.1+fabric" = _zOo4LIrF;
        "pkg-v3.0.0-beta.1+forge" = _ywQKsJJT;
        "pkg-3.0.0+2022.9d216ef038.fabric" = _guMmOdAO;
        "pkg-3.0.0+2022.9d216ef038.forge" = _pk8Zueqg;
        "pkg-3.0.1+2022.f0aaabc24a.fabric" = _PyeVyxTP;
        "pkg-3.0.1+2022.f0aaabc24a.forge" = _ZC6ollRo;
        "pkg-3.0.2+2022.8c39440dfb.fabric" = _A9UszNwE;
        "pkg-3.0.2+2022.8c39440dfb.forge" = _y4oFFBXM;
        "pkg-3.0.3+2022.03de7282c1.fabric" = _M0GPvjWA;
        "pkg-3.0.3+2022.03de7282c1.forge" = _VtEkcIgE;
        "pkg-3.0.4-old.1.18+2022.5561cf1570.fabric" = _s42WqtL9;
        "pkg-3.0.4-old.1.18+2022.5561cf1570.forge" = _UO4C1QBa;
        "pkg-3.0.4+2022.5561cf1570.fabric" = _zfXbhEsh;
        "pkg-3.0.4+2022.5561cf1570.forge" = _QosFDi6T;
        "pkg-3.0.4-old.1.16.5+2022.5561cf1570.fabric" = _weQJ0TgU;
        "pkg-3.0.4-old.1.16.5+2022.5561cf1570.forge" = _yczz2Gv3;
        "pkg-3.0.5-old.1.16.5+2022.00f9f18481.fabric" = _J7rYY5GX;
        "pkg-3.0.5-old.1.16.5+2022.00f9f18481.forge" = _VLytVo9P;
        "pkg-3.0.5-old.1.18+2022.a69712eeaf.fabric" = _sWM3kUdO;
        "pkg-3.0.5-old.1.18+2022.a69712eeaf.forge" = _9Rh047QT;
        "pkg-3.0.5+2022.31517584c2.fabric" = _s6NEqhIP;
        "pkg-3.0.5+2022.31517584c2.forge" = _dxNgrcvy;
        "pkg-3.0.6-old.1.16.5+2022.2e6cccc6e1.fabric" = _5nddMmyd;
        "pkg-3.0.6-old.1.16.5+2022.2e6cccc6e1.forge" = _tV696GaZ;
        "pkg-3.0.6-old.1.18+2022.5ba5a1f51b.fabric" = _y1k6LX46;
        "pkg-3.0.6-old.1.18+2022.5ba5a1f51b.forge" = _DZDrstso;
        "pkg-3.0.6+2022.107dae3340.fabric" = _eDdevKpn;
        "pkg-3.0.6+2022.107dae3340.forge" = _HTf95a89;
        "pkg-3.1.0+2022.5cf1626f4f.fabric" = _1D5qCUwg;
        "pkg-3.1.0+2022.5cf1626f4f.forge" = _2UiOZOjC;
        "pkg-3.1.0-old.1.18+2022.fffa3c6d3f.fabric" = _xGwHYcI7;
        "pkg-3.1.0-old.1.18+2022.fffa3c6d3f.forge" = _WsFMWtPw;
        "pkg-3.1.0-old.1.16.5+2022.c977262271.fabric" = _dISEd1vU;
        "pkg-3.1.0-old.1.16.5+2022.c977262271.forge" = _lRxWiQN4;
        "pkg-3.2.0-old.1.16.5+2022.222647e4a6.fabric" = _SgLlEq6y;
        "pkg-3.2.0-old.1.16.5+2022.222647e4a6.forge" = _HOAVJeaU;
        "pkg-3.1.0-old.1.18+2022.10af157d70.fabric" = _top5QDDw;
        "pkg-3.1.0-old.1.18+2022.10af157d70.forge" = _RyuYNi3g;
        "pkg-3.2.0+2022.e000b2a529.fabric" = _fzHAM74E;
        "pkg-3.2.0+2022.e000b2a529.forge" = _o2e3B4Py;
        "pkg-3.2.0+2022.e000b2a529.quilt" = _M6jNmDTz;
        "pkg-3.2.0-1.19.2+2022.ca873bd9d2.forge" = _TyfPvL5V;
        "pkg-4.0.1-alpha.fabric" = _oieGz98Q;
        "pkg-4.0.1-alpha.forge" = _aIwRRiM6;
        "pkg-4.0.1-alpha.quilt" = _vc56OG5s;
        "default" = _vc56OG5s;
    });
