...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20" = _Yw9abw5P;
        "pkg-1.0.0+1.20.2" = _bGm2CeFF;
        "pkg-1.0.0+1.20.4" = _V0cp9QtB;
        "pkg-1.0.1+1.20" = _2d1hFMLb;
        "pkg-1.0.1+1.20.4" = _b57oC7dU;
        "pkg-1.0.1+1.20.5" = _yExJpFSp;
        "pkg-1.0.1+26.1" = _ZDZUjaFr;
        "default" = _ZDZUjaFr;
    });
