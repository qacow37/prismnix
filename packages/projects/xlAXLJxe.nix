...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.3" = _7cE4d72i;
        "pkg-1.17.1-1.2" = _kR0ycxoj;
        "pkg-1.18.2-1.2" = _rpu1IDMZ;
        "pkg-1.19.2-1.2" = _nBjPtd03;
        "pkg-1.19.4-1.1" = _q4nBNo52;
        "pkg-1.20.1-1.0" = _3B86zQRw;
        "pkg-1.16.5-1.0" = _Ai3rNrdn;
        "pkg-1.17.1-1.0" = _7m2JWGFm;
        "pkg-1.18.2-1.0" = _PC92yZj5;
        "pkg-1.19.2-1.0" = _pIpkXimh;
        "pkg-1.19.3-1.0" = _bDuwobF5;
        "pkg-1.20.4-1.0" = _JGXrjCTX;
        "pkg-1.16.5-1.1" = _wkwuY2Ow;
        "pkg-1.17.1-1.1" = _V6eF3NtF;
        "pkg-1.18.2-1.1" = _XMn5QtW9;
        "pkg-1.19.2-1.1" = _UOS46OyX;
        "pkg-1.19.3-1.1" = _nn3BrJQP;
        "pkg-1.20.1-1.1" = _NXEXnR6m;
        "pkg-1.20.4-1.1" = _OuT2Be6n;
        "pkg-1.21.3-1.1" = _GxyBTWGw;
        "pkg-1.21.4-1.1" = _uPUPGYq6;
        "pkg-1.21.3-1.1.1" = _acipnlNm;
        "pkg-1.21.4-1.1.1" = _cBUtmdmc;
        "pkg-1.16.5-1.2" = _pTBJG3pM;
        "pkg-1.16.5-1.2.1" = _5e5d9imU;
        "pkg-1.19.3-1.2" = _1GJq4w3t;
        "pkg-1.20.1-1.2" = _Hhst6nGT;
        "pkg-1.20.4-1.2" = _QYhk2DiO;
        "pkg-1.21.3-1.2" = _qFvCKXJ5;
        "pkg-1.21.4-1.2" = _fFtSCj3C;
        "pkg-1.21.6-1.2" = _KzRTeqUF;
        "pkg-1.17.1-1.3" = _IfgwB9Oi;
        "pkg-1.18.2-1.3" = _vSI22Ojz;
        "pkg-1.19.2-1.3" = _VYnaDL66;
        "pkg-1.19.3-1.3" = _mVMj8cZq;
        "pkg-1.21.6-1.2.1" = _XOCqeTKg;
        "pkg-1.21.6-1.4" = _qRu3wNQr;
        "pkg-1.21.4-1.4" = _tXUERuYp;
        "pkg-1.21.3-1.4" = _rvU9nG3B;
        "pkg-1.20.1-1.4" = _2u8hKV67;
        "pkg-1.20.4-1.4" = _MHR2g5zA;
        "pkg-1.19.3-1.4" = _fOqCNHBh;
        "pkg-1.19.2-1.4" = _hx65reAX;
        "pkg-1.18.2-1.4" = _U5taFZMi;
        "pkg-1.17.1-1.4" = _jLtlngJ0;
        "pkg-1.16.5-1.4" = _1bmg36Uz;
        "pkg-1.16.5-1.5" = _naHjm9YG;
        "pkg-1.17.1-1.5" = _IlVf0lgV;
        "pkg-1.18.2-1.5" = _GOF9vmFU;
        "pkg-1.19.2-1.5" = _WHhOAlWE;
        "pkg-1.19.3-1.5" = _wrAvmqQa;
        "pkg-1.20.1-1.5" = _UwatrdaU;
        "pkg-1.20.4-1.5" = _9NHbxPBM;
        "pkg-1.21.3-1.5" = _Ykv9HWif;
        "pkg-1.21.4-1.5" = _ddEujQ2w;
        "pkg-1.21.6-1.5" = _EgQwo3jt;
        "pkg-1.21.6-1.6" = _C4aH7CT2;
        "pkg-1.21.4-1.6" = _TFgpSwdI;
        "pkg-1.21.3-1.6" = _utKYj6Nw;
        "pkg-1.20.4-1.6" = _yceFelEs;
        "pkg-1.20.1-1.6" = _CzWK2Aoc;
        "pkg-1.19.3-1.6" = _2sz1nFKB;
        "pkg-1.19.2-1.6" = _8aO54KrV;
        "pkg-1.18.2-1.6" = _OyKiLCuW;
        "pkg-1.17.1-1.6" = _jmzljigs;
        "pkg-1.16.5-1.6" = _iiUDhTqh;
        "default" = _iiUDhTqh;
    });
