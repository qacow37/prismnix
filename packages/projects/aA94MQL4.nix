...
let
    ...
    in {
        ...
        "pkg-1.12.2-1.0.2.15" = _UxhzzdE5;
        "pkg-1.16.5-2.N.0.1" = _WKkBV11s;
        "pkg-1.18.2-2.0.0.11" = _qkdCsK1I;
        "pkg-1.19.2-2.1.0.1" = _kjEKavwK;
        "pkg-1.20.1-2.2.0.1" = _pi3Ascyu;
        "pkg-1.12.2-1.0.2.16" = _FErnuRG5;
        "pkg-1.16.5-2.N.0.2" = _79jJP0Wv;
        "pkg-1.18.2-2.0.0.12" = _9Pw4DcY9;
        "pkg-1.19.2-2.1.0.2" = _Va7hbcE2;
        "pkg-1.20.1-2.2.0.2" = _h8HmR2E0;
        "pkg-1.20.1-2.2.0.3" = _ENEiTXzB;
        "pkg-1.12.2-1.0.2.17" = _aUqjRJjU;
        "pkg-1.16.5-2.N.0.3" = _pVi74zF8;
        "pkg-1.18.2-2.0.0.13" = _hyG2OQDO;
        "pkg-1.19.2-2.1.0.3" = _FuxQ6FIv;
        "pkg-1.20.1-2.2.0.4" = _9eT6u2qZ;
        "pkg-1.12.2-1.0.2.18" = _6Q0666Ra;
        "pkg-1.16.5-2.N.0.4" = _j3JC2JmA;
        "pkg-1.18.2-2.0.0.14" = _Ot76uwf6;
        "pkg-1.19.2-2.1.0.4" = _UCoxeVY2;
        "pkg-1.20.1-2.2.0.5" = _bgPJ9RnT;
        "pkg-1.12.2-1.0.2.19" = _3tjJSKFS;
        "pkg-1.12.2-1.0.2.20" = _MtydguSz;
        "pkg-1.16.5-2.N.0.5" = _HHKBsG0z;
        "pkg-1.18.2-2.0.0.15" = _6Xqgz7FS;
        "pkg-1.19.2-2.1.0.5" = _SM47Cn3W;
        "pkg-1.20.1-2.2.0.6" = _WD4W7aQx;
        "pkg-1.12.2-1.0.2.21" = _ByW5QvPY;
        "pkg-1.16.5-2.N.0.6" = _q1UH2OuZ;
        "pkg-1.18.2-2.0.0.16" = _gewoA3PH;
        "pkg-1.19.2-2.1.0.6" = _kWyLYS0X;
        "pkg-1.20.1-2.2.0.7" = _eEdbzJri;
        "pkg-1.12.2-1.0.2.22" = _vjhsTHEA;
        "pkg-1.16.5-Endless-2.N.0.7" = _PRje6YDm;
        "pkg-1.18.2-2.0.0.17" = _FtLmaNYE;
        "pkg-1.19.2-Re-2.1.0.7" = _YNPcOdgp;
        "pkg-1.20.1-Re-2.2.0.8" = _mKHjf8MF;
        "pkg-1.16.5-Universal-2.N.0.0" = _U7Tt4BXy;
        "pkg-1.18.2-Universal-2.0.0.0" = _6jqggh58;
        "pkg-1.19.2-Universal-2.1.0.0" = _ztRAtTjF;
        "pkg-1.20.1-Universal-2.2.0.0" = _dAeyCFFN;
        "pkg-1.18.2-Re-2.0.0.0" = _LYsnViGq;
        "pkg-1.21.1-Neo-3.0.0.0" = _3Uz6ljz2;
        "pkg-1.16.5-Endless-2.N.0.8" = _q3phqQfg;
        "pkg-1.16.5-Endless-2.N.0.9" = _hKfhjSZ1;
        "pkg-1.18.2-Endless-2.0.0.0" = _L7soNUWu;
        "pkg-1.16.5-Endless-2.N.1.10" = _StwSISAz;
        "pkg-1.20.1-Re-2.2.1.9" = _BENo6ZBz;
        "pkg-1.21.1-Neo-3.0.0.1" = _Rd0ujryU;
        "pkg-1.21.1-Re-3.0.0.0" = _YuS4ZiIQ;
        "pkg-1.12.2-1.0.2.23" = _mCdrAa85;
        "pkg-1.16.5-Endless-2.N.1.11" = _nEAIB8i9;
        "pkg-1.16.5-Universal-2.N.0.1" = _4nZzBb1O;
        "pkg-1.18.2-2.0.0.18" = _dk0LA3yG;
        "pkg-1.18.2-Endless-2.0.0.1" = _xlnQlGx9;
        "pkg-1.18.2-Re-2.0.0.1" = _JFnGisEP;
        "pkg-1.18.2-Universal-2.0.0.1" = _SPFbTnKq;
        "pkg-1.19.2-Re-2.1.0.8" = _TnT9axjw;
        "pkg-1.19.2-Universal-2.1.0.1" = _kl5aSRl8;
        "pkg-1.20.1-Re-2.2.1.10" = _RrtK4i1Y;
        "pkg-1.20.1-Universal-2.2.0.1" = _zwZgqGUx;
        "pkg-1.21.1-Neo-3.0.0.2" = _wsLg9x1D;
        "pkg-1.21.1-Re-3.0.0.1" = _1r2ym43K;
        "pkg-1.20.1-Re-2.2.1.11" = _fEbbd3zs;
        "pkg-1.21.1-Re-3.0.0.2" = _tyCzijeg;
        "pkg-1.20.1-Neo-2.2.0.0" = _Mq4XCARP;
        "pkg-1.12.2-1.0.2.24" = _8UPsOAk0;
        "pkg-1.16.5-Endless-2.N.1.12" = _okRxR1DI;
        "pkg-1.16.5-Universal-2.N.1.2" = _Os9WWgQN;
        "pkg-1.18.2-2.0.1.19" = _g0qWoKYz;
        "pkg-1.18.2-Endless-2.0.0.2" = _jjta5EJt;
        "pkg-1.18.2-Re-2.0.1.2" = _3f6ojHjM;
        "pkg-1.18.2-Universal-2.0.1.2" = _jACMd6JN;
        "pkg-1.19.2-Re-2.1.1.9" = _chZedRQq;
        "pkg-1.19.2-Universal-2.1.1.2" = _9NRmdA1O;
        "pkg-1.20.1-Neo-2.2.1.1" = _nqyzX6MI;
        "pkg-1.20.1-Re-2.2.2.12" = _FyKsffur;
        "pkg-1.20.1-Universal-2.2.1.2" = _M2U9D593;
        "pkg-1.21.1-Neo-3.0.1.3" = _un4wDDRN;
        "pkg-1.21.1-Re-3.0.1.3" = _dS3rMJ7j;
        "pkg-1.20.1-Universal-2.2.1.3" = _THSY9UTu;
        "pkg-1.21.1-Neo-3.0.1.4" = _188Mr63O;
        "pkg-1.21.1-Re-3.0.1.4" = _8pNqb2qz;
        "pkg-1.21.1-Neo-3.0.1.5" = _HAuMyVND;
        "pkg-1.21.1-Re-3.0.1.5" = _S3poB44N;
        "pkg-1.12.2-1.0.3.25" = _YBNjDfZW;
        "pkg-1.20.1-Re-2.2.2.13" = _c3Hq27mc;
        "default" = _c3Hq27mc;
    });
