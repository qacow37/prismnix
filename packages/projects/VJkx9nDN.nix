...
let
    ...
    in {
        ...
        "pkg-1.0.16.4" = _1RmAodX6;
        "pkg-1.0.17" = _rZnJbEKf;
        "pkg-1.0.18" = _xcVBigGH;
        "pkg-1.0.18.1" = _TcDojLGl;
        "pkg-1.0.18.2" = _V0996g4n;
        "pkg-1.0.18.3" = _Hr8qvvuq;
        "pkg-1.0.18.4" = _jOe5mgg8;
        "pkg-1.0.19.0" = _f5cA0oNm;
        "pkg-1.0.19.1" = _lC6HEkuk;
        "pkg-1.0.20.0" = _clj7Dkig;
        "pkg-1.0.20.1" = _5ZTja0VI;
        "pkg-1.0.20.2" = _WkQkKmJU;
        "pkg-1.0.20.3" = _SZ85vKZ2;
        "pkg-1.0.20.3.1" = _NqMUd7lu;
        "pkg-1.0.21.2" = _FfGYlaxg;
        "pkg-1.0.21.4" = _5L89LTQP;
        "pkg-1.0.22" = _csO9pXh5;
        "pkg-1.0.23" = _4H03B2MS;
        "pkg-1.0.23.1" = _7ICi153w;
        "pkg-1.0.23.2" = _L0gP90iM;
        "pkg-1.0.23.3" = _KmvtCn5w;
        "pkg-1.0.24.1" = _62iiuM65;
        "pkg-1.0.26.1.hotfix1" = _wOgteZ6t;
        "pkg-1.0.27.1.2" = _5dnCu2gw;
        "pkg-1.0.27.1.3" = _gN4hJo8p;
        "pkg-1.1.0.hotfix1" = _EhhuyOF5;
        "pkg-1.1.2" = _MiZfAQ0R;
        "pkg-1.1.3" = _LLOBuNd4;
        "pkg-1.1.4" = _YD862eFb;
        "pkg-1.2" = _XWyUxmFh;
        ...
        "pkg-1.7.1" = _M8X6zvl5;
        "pkg-1.7.2" = _WiEShoiD;
        "pkg-1.7.2.1" = _uBreIzKv;
        "pkg-1.8" = _wRC5myix;
        "pkg-1.9.0" = _21Zi5lDT;
        "pkg-1.10.0" = _EL0JYZad;
        "pkg-1.10.1" = _Fx9u7Tvx;
        "pkg-1.11.0" = _NCqgiihL;
        "pkg-1.13.0" = _vmMgfk4g;
        "pkg-1.13.1" = _BiDPneRT;
        "pkg-1.15.2" = _lQwrd0gY;
        "pkg-1.17.2" = _iy0IEOOv;
        "pkg-1.17.3" = _FYogcd3o;
        "pkg-1.18.0" = _cvf11ZXX;
        "pkg-1.18.1" = _q6KicZmq;
        "pkg-1.18.2" = _wUF1Mn7v;
        "pkg-1.18.3" = _YAs96KR3;
        "pkg-1.18.4" = _2vWHxSO9;
        "pkg-1.19.0" = _SZklCHE4;
        "pkg-1.20.0" = _kEbkOieH;
        "pkg-1.20.1" = _wdomz5DV;
        "pkg-1.20.2" = _IpWQwuRN;
        "pkg-1.20.3" = _d41GdOBl;
        "pkg-1.20.4" = _C31x0hOs;
        "pkg-1.21.0" = _cizXZjRK;
        "pkg-1.0.15.3+1.21.1" = _qH6TK1N1;
        "pkg-1.21.1+1.20.1" = _pK1DAMy7;
        "pkg-1.21.2+1.20.1" = _xQiGZGsg;
        "pkg-1.21.3+1.20.1" = _id8i8ceJ;
        "pkg-1.0.17.0+1.21.1" = _33arS5WH;
        "pkg-1.0.19.7+1.21.1" = _97Gmpkjp;
        "pkg-2.0.1+1.20.1" = _41tRB3HK;
        "pkg-2.0.2+1.20.1" = _cr90H6Ky;
        "pkg-2.1.0+1.20.1" = _fvONitmB;
        "pkg-2.2.0+1.20.1" = _M2ywemer;
        "pkg-1.0.20.0+1.21.1" = _cd5TnSQs;
        "pkg-2.3.0+1.20.1" = _720mYNSd;
        "pkg-1.0.23.0+1.21.1" = _ENhj6KNL;
        "pkg-2.1.0+1.21.1" = _EgCqzEIn;
        "default" = _EgCqzEIn;
    });
