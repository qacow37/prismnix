...
let
    ...
    in {
        ...
        "pkg-0.5b" = _hQ38Z2j4;
        "pkg-0.6b" = _vWdY0sHS;
        "pkg-0.6.1b" = _l4AFTLK0;
        "pkg-0.6.2b" = _l5gUpyY8;
        "pkg-0.6.3b" = _k8Nrjlms;
        "pkg-0.6.4b" = _2jEJ1hs0;
        "pkg-0.6.5b" = _dD2wn0aj;
        "pkg-0.6.6b" = _cmQ3YHTk;
        "pkg-0.6.7b" = _gkWxyQf3;
        "pkg-0.6.8b" = _YxS9mT5w;
        "pkg-0.6.9b" = _bypIFzde;
        "pkg-0.6.10b" = _NPAT9vIc;
        "pkg-0.6.11b" = _oQaxw8AG;
        "pkg-0.7b" = _CarzIhui;
        "pkg-0.7.1b" = _Z1gDLGq2;
        "pkg-0.7.2b" = _9ma5IZ4M;
        "pkg-1.0" = _iG2K2lT2;
        "pkg-1.0.1" = _MQVM6fZR;
        "pkg-1.0.2" = _BL3uOBmu;
        "pkg-1.0.3" = _LOMX7lfY;
