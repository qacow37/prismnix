...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.4" = _fUiA12Qa;
        "pkg-1.19.2-1.2.2" = _NWvTVZUx;
        "pkg-1.19.3-1.3.0" = _maBbTSYH;
        "pkg-1.18.2-1.0.2" = _kfYrNGOM;
        "pkg-1.19.2-1.0.2" = _WVbfx6UX;
        "pkg-1.19.3-1.1.0" = _ZXs1JjIl;
        "pkg-1.19.4-1.4.0" = _D9tU4cc6;
        "pkg-1.19.4-1.2.0" = _TIUz7BWG;
        "pkg-1.18.2-1.0.3" = _D0n4MRgR;
        "pkg-1.19.2-1.0.3" = _uYPK5LNR;
        "pkg-1.19.3-1.1.1" = _N1inzGEr;
        "pkg-1.19.4-1.2.1" = _20uHqGM4;
        "pkg-1.20.1-1.0.0" = _v9uvp9hF;
        "pkg-1.20.2-1.1.0" = _X0z9UBh0;
        "pkg-1.18.2-1.0.5" = _ny7BpBp4;
        "pkg-1.19.2-1.2.3" = _pHPv8ehp;
        "pkg-1.19.2-1.0.4" = _oacLZCFC;
        "pkg-1.20.1-1.0.1" = _1pPxukir;
        "pkg-1.20.4-1.4.0" = _9e7lrZQh;
        "pkg-1.21.1-1.0.0" = _VC8Ed8TB;
        "pkg-1.20.1-1.0.2" = _swfELFeq;
        "pkg-1.21.1-1.0.1" = _Af5WYQot;
        "pkg-1.21.1-1.0.2" = _Bgh3YdOv;
        "pkg-1.21.1-1.0.3" = _z0c5GzC8;
        "pkg-1.21.5-1.0.3" = _IdFjsqr0;
        "pkg-1.21.8-1.0.3" = _55F7NjUV;
        "pkg-1.21.10-1.0.3" = _UHelJ6CC;
        "pkg-1.21.11-1.0.3" = _15Bfsb9j;
        "pkg-1.20.1-1.0.3" = _nb4j0G1s;
        "pkg-1.20.1-1.0.4" = _6do801Qm;
        "pkg-1.20.1-1.0.5" = _GWBSFwtZ;
        "pkg-1.21.5-1.0.5" = _xULjj7L7;
        "pkg-1.21.8-1.0.5" = _dgV2sNqh;
        "pkg-1.21.11-1.0.5" = _IMx78ApO;
        "pkg-1.21.1-1.0.5" = _QuOacUHh;
        "pkg-1.21.5-1.0.6" = _X8fNItxP;
        "default" = _X8fNItxP;
    });
