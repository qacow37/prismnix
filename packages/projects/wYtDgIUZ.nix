...
let
    ...
    in {
        ...
        "pkg-forge-mc1.19.2-1.0.0" = _Y17p12a1;
        "pkg-forge-mc1.19.3-1.0.0" = _n4P2S03p;
        "pkg-forge-mc1.19.4-1.0.0" = _kKbMxIUZ;
        "pkg-forge-mc1.20-1.1.0" = _ni2Yo1fA;
        "pkg-forge-mc1.19.2-2.0.0" = _uiZPrR2Y;
        "pkg-forge-mc1.19.3-2.0.0" = _FE01JvgF;
        "pkg-forge-mc1.19.4-2.0.0" = _3TNBmPgc;
        "pkg-forge-mc1.20.1-2.0.0" = _EW9t0cYC;
        "pkg-forge-mc1.19.2-2.0.1" = _9O2PHDbl;
        "pkg-forge-mc1.19.3-2.0.1" = _KJPaPXaS;
        "pkg-forge-mc1.19.4-2.0.1" = _ZnjSvbDR;
        "pkg-forge-mc1.20.1-2.0.1" = _ilQrpVsH;
        "pkg-forge-mc1.20.2-2.0.1" = _ettqXFwK;
        "pkg-neoforge-mc1.20.2-2.0.1" = _FPFCCx5x;
        "pkg-neoforge-mc1.20.4-2.0.1" = _LHxsUDmt;
        "pkg-forge-mc1.19.2-2.0.2" = _MwifMlri;
        "pkg-forge-mc1.19.3-2.0.2" = _HFVyXpwQ;
        "pkg-forge-mc1.19.4-2.0.2" = _lsXYWQtW;
        "pkg-forge-mc1.20.1-2.0.2" = _ERHo4m8y;
        "pkg-neoforge-mc1.20.2-2.0.2" = _CajDUkJP;
        "pkg-forge-mc1.20.2-2.0.2" = _gdsFLKn2;
        "pkg-neoforge-mc1.20.6-2.0.2" = _RwZz64Ve;
        "pkg-neoforge-mc1.21-2.0.2" = _HuP9oz9B;
        "pkg-neoforge-3.0.0+mc1.21.1" = _c3rVRLH1;
        "pkg-neoforge-3.0.0+mc1.21.4" = _SzQumg4p;
        "pkg-neoforge-3.0.0+mc1.21.5" = _reM1W9h9;
        "pkg-neoforge-3.0.1+mc1.21.4" = _6fy6YxTu;
        "pkg-neoforge-3.0.1+mc1.21.1" = _qweMeTSH;
        "pkg-neoforge-3.0.1+mc1.21.5" = _O2jWb9l6;
        "pkg-neoforge-3.0.1+mc1.21.6" = _dLcl6yTe;
        "pkg-neoforge-3.0.2+mc1.21.1" = _3rBPej8a;
        "pkg-neoforge-3.0.2+mc1.21.4" = _SAIm3YdJ;
        "pkg-neoforge-3.0.2+mc1.21.5" = _kjXKVOk9;
        "pkg-neoforge-3.0.2+mc1.21.8" = _ywjkrrtU;
        "pkg-neoforge-3.0.2+mc1.21.10" = _rYvvj3rp;
        "pkg-neoforge-3.0.2+mc1.21.11" = _zDmSJ1zE;
        "pkg-neoforge-3.0.3+mc1.21.1" = _Kz3PjwHn;
        "pkg-neoforge-3.0.3+mc1.21.4" = _QJkjWMTx;
        "pkg-neoforge-3.0.3+mc1.21.5" = _slWa9aAa;
        "pkg-neoforge-3.0.3+mc1.21.8" = _EOAed0FN;
        "pkg-neoforge-3.0.3+mc26.1.2" = _iIbvdJIH;
        "pkg-neoforge-3.0.3+mc1.21.10" = _1wn9dPLd;
        "pkg-neoforge-3.0.3+mc1.21.11" = _UDUWKakf;
        "pkg-neoforge-3.0.3+mc26.2" = _IYR1HQHE;
        "default" = _IYR1HQHE;
    });
