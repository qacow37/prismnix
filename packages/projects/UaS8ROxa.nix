...
let
    ...
    in {
        ...
        "pkg-2.12" = _FdRzk8sn;
        "pkg-2.13" = _G3JrgSaB;
        "pkg-2.13.1" = _q1U7MxrF;
        "pkg-2.13.2" = _Z2SvmQZV;
        "pkg-2.13.3" = _8aAgasMP;
        "pkg-2.13.5" = _QJ1Kp1Nq;
        "pkg-2.13.6" = _sWWhCIN1;
        "pkg-2.14" = _oGPTDEGy;
        "pkg-2.14.1" = _5gw3AWh6;
        "pkg-2.14.2" = _qID9I2j3;
        "pkg-2.14.3" = _k4R8d7M1;
        "pkg-2.14.4" = _OvQyseAz;
        "pkg-2.14.5" = _Jyt2HsbQ;
        "pkg-2.14.6" = _vAGU7y92;
        "pkg-2.14.7" = _ogJXEBUW;
        "pkg-2.15" = _KyRo8Ilb;
        "pkg-2.15.1" = _xJ3F9yrh;
        "pkg-2.15.2" = _4kudV28N;
        "pkg-2.15.3" = _RMhrmckJ;
        "pkg-2.16" = _gom1N7c2;
        "pkg-2.16.1" = _NngviH0C;
        "pkg-2.17" = _6QqrizAz;
        "pkg-2.18" = _EaOXeA0L;
        "pkg-2.18.1" = _lhao8exj;
        "pkg-2.18.2" = _NCYmUhOl;
        "pkg-2.18.3" = _ogLvarPZ;
        "pkg-2.18.4" = _lAjiQ57F;
        "pkg-2.18.5" = _Ic9EfpRi;
        "pkg-2.18.6" = _NIqFXspW;
        "pkg-2.18.7" = _c0BXHeqs;
        "pkg-2.18.8" = _QyqbsSGD;
        "pkg-2.18.9" = _tyB7b4ka;
        "pkg-2.18.10" = _vXsOqSYt;
        "pkg-2.18.11" = _hOUPzbJs;
        "pkg-2.18.12" = _8f0PCWn5;
        "pkg-2.18.13" = _ErR6TZYu;
        "pkg-2.19" = _LWmZ94RG;
        "default" = _LWmZ94RG;
    });
