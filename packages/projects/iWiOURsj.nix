...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _TZtVNuYx;
        "pkg-1.0.0.1" = _Zc8vFW6q;
        "pkg-1.0.0.2" = _5RZ80eFV;
        "pkg-1.0.1.0" = _u7Tjujxd;
        "pkg-1.0.2.0" = _YzjpKS1f;
        "pkg-1.0.2.1" = _QxFKUgDd;
        "pkg-1.0.2.2" = _ElEJP1E3;
        "pkg-1.0.2.3" = _2Nly6Knt;
        "pkg-1.0.2.4" = _Iu0fHUXG;
        "pkg-1.0.2.5" = _afDy9WCW;
        "pkg-1.1.0.0" = _spk2xl6t;
        "pkg-1.2.0.0" = _fVRdcKTS;
        "pkg-1.2.0.1" = _jmZ3fYxf;
        "pkg-1.2.0.2" = _REhM9EYl;
        "pkg-1.2.0.3" = _6a8kupOf;
        "pkg-1.2.0.4" = _R91nGxPl;
        "pkg-1.2.0.5" = _x6vRDKln;
        "pkg-1.3.0.0" = _xoYpuLjF;
        "pkg-1.3.1.0" = _bY1sQV1B;
        "pkg-1.3.1.1" = _SixkTvRI;
        "pkg-1.3.2.0" = _69aj5x1o;
        "pkg-1.3.2.1" = _nfj4QIwX;
        "pkg-1.3.3.0" = _mK2koySS;
        "pkg-1.3.3.1" = _jtgyBpJV;
        "pkg-1.3.3.2" = _UbxOtmPt;
        "pkg-1.3.3.3" = _LeqAypjp;
        "pkg-1.3.3.4" = _Gv9GPGjR;
        "pkg-1.3.3.5" = _Uer8G3Ue;
        "default" = _Uer8G3Ue;
    });
