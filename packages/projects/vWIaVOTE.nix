...
let
    ...
    in {
        ...
        "pkg-1.5.5" = _bqemN9eB;
        "pkg-1.5.6" = _sBHMavsZ;
        "pkg-1.5.6-1.18.2-fabric" = _f9dBgqlK;
        "pkg-1.5.6-1.18.2-forge" = _I6N9p1gm;
        "pkg-1.6" = _lUbM1JGl;
        "pkg-1.6-forge" = _IWbm8VBR;
        "pkg-1.7.0" = _I9eQMljf;
        "pkg-1.7.1" = _K4RW6XPf;
        "pkg-1.7.3" = _SKwDwf3w;
        "pkg-1.7.2" = _f2O5t75V;
        ...
        "pkg-1.9.0" = _Yrf13Sfb;
        "pkg-1.8.2" = _JaOf5NeD;
        "pkg-1.10.0-rc1+1.20.2" = _p5XCg5u1;
        "pkg-1.10.0-rc2+1.20.0-1" = _FVxTX90Y;
        "pkg-1.10.0-rc2+1.20.2" = _UGZZuYxK;
        "pkg-1.10.0+1.20.4" = _HbyGW9Gs;
        "pkg-1.10.0+1.20.2" = _SOwfoVms;
        "pkg-1.10.0+1.20.0-1" = _YTf1OYmI;
        "pkg-1.10.0-rc5+1.20.0-1" = _OCCEkTGv;
        "pkg-1.10.0-rc5+1.20.2" = _9p2fpy18;
        "pkg-1.10.0-rc5+1.20.4" = _u2BbnOJr;
        "pkg-1.10.0-rc5" = _RnmfcMrs;
        "pkg-1.10.0-rc5+1.21" = _rj0f0Vtq;
        "default" = _rj0f0Vtq;
    });
