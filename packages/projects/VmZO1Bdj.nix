...
let
    ...
    in {
        ...
        "pkg-FABRIC-1.16.5-3.0.1-prerelease-1" = _KSHjsxis;
        "pkg-FABRIC-1.17.1-3.0.0-prerelease-1" = _A8zzT9m7;
        "pkg-FABRIC-1.18.1-3.0.0-prerelease-1" = _1ocwuGja;
        "pkg-FABRIC-1.18.2-3.0.0-prerelease-1" = _lu34Zizw;
        "pkg-FABRIC-1.19-3.0.0-prerelease-1" = _24QL4bDP;
        "pkg-FORGE-1.16.5-3.0.0-prerelease-1" = _orHVVZr3;
        "pkg-FORGE-1.17.1-3.0.0-prerelease-1" = _mTGTa4yk;
        "pkg-FORGE-1.18.1-3.0.0-prerelease-1" = _Qnh5eLyc;
        "pkg-FORGE-1.18.2-3.0.0-prerelease-1" = _EbTcYnCU;
        "pkg-FORGE-1.19-3.0.0-prerelease-1" = _5ZAD7iUJ;
        "pkg-FABRIC-1.16.5-3.1.0" = _p6mxNZdG;
        "pkg-FABRIC-1.17.1-3.1.0" = _kXLYe1Rl;
        "pkg-FABRIC-1.18.2-3.1.0" = _BHl19FvE;
        "pkg-FABRIC-1.19.2-3.1.0" = _EP6tWEA3;
        "pkg-FORGE-1.16.5-3.1.0" = _XJo2ck1R;
        "pkg-FORGE-1.17.1-3.1.0" = _OmH9hdkf;
        "pkg-FORGE-1.18.2-3.1.0" = _bvzawt6h;
        "pkg-FORGE-1.19.2-3.1.0" = _K17bS7rE;
        "pkg-FABRIC-1.16.5-3.1.6" = _WqNiRfk3;
        "pkg-FORGE-1.16.5-3.1.6" = _V60lDoUg;
        "pkg-FABRIC-1.17.1-3.1.6" = _p6e5bozo;
        "pkg-FORGE-1.17.1-3.1.6" = _FZuhL1u3;
        "pkg-FABRIC-1.18.2-3.1.6" = _s0oAH6wq;
        "pkg-FORGE-1.18.2-3.1.6" = _aSYJUj4g;
        "pkg-FABRIC-1.19.2-3.1.6" = _XWEEBacE;
        "pkg-FORGE-1.19.2-3.1.6" = _HdURFfHa;
        "default" = _HdURFfHa;
    });
