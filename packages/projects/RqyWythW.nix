...
let
    ...
    in {
        ...
        "pkg-1.19-1.19.2" = _J37eXmoi;
        "pkg-1.19.3" = _6OG0ivju;
        "pkg-1.19.4" = _zV6dvXJl;
        "pkg-1.20-1.20.2" = _iGrhwRBY;
        "pkg-1.20.2" = _mEQjggsK;
        "pkg-1.20-1.20.1" = _Mq1FHDOT;
        "pkg-1.20.3-1.20.4" = _8Qi6nH31;
        "pkg-1.16" = _PC8Mfbej;
        "pkg-1.17" = _33fs3zCU;
        "pkg-1.18" = _v75BoIog;
        "pkg-1.19" = _mkY4VF0a;
        "pkg-1.20" = _S9TBnYb9;
        "pkg-1.20.5-1.20.6" = _4ApOGG9A;
        "pkg-1.21" = _e7GZJ9oM;
        "pkg-1.21-1.21.1" = _mmC0lF1I;
        "pkg-1.21.2-1.21.3" = _V3qzVBrf;
        "pkg-1.21.4" = _Y2ZWIJ5D;
        "pkg-1.21.5" = _t2Ks8NaF;
        "pkg-2" = _j0i9LCIl;
        "pkg-1.21.6" = _WlsAb80h;
