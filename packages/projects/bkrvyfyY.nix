...
let
    ...
    in {
        ...
        "pkg-1.12.2-1.0.2.11" = _7s8WFzUU;
        "pkg-1.16.5-2.0.2.10" = _23czizMG;
        "pkg-1.12.2-1.0.2.12" = _SfKdrNAB;
        "pkg-1.16.5-2.0.2.11" = _nBZaZHD1;
        "pkg-1.12.2-1.0.2.13" = _aeefZPT1;
        "pkg-1.12.2-1.0.2.14" = _A1rxheaP;
        "pkg-1.16.5-2.0.2.12" = _aadCyl8O;
        "pkg-1.16.5-2.0.2.13" = _Hi623oob;
        "pkg-1.12.2-1.0.2.15" = _v7St4yKk;
        "pkg-1.12.2-1.0.2.16" = _OuITXFYv;
        "pkg-1.16.5-2.0.2.14" = _8DKlD07H;
        "pkg-1.12.2-1.0.2.17" = _W2gDatjV;
        "pkg-1.16.5-2.0.2.15" = _XJas0Hh8;
        "pkg-1.12.2-1.0.3.18" = _qQqXieFm;
        "pkg-1.16.5-2.0.3.16" = _4UlzwdNt;
        "pkg-1.12.2-1.0.3.19" = _taarA3cB;
        "pkg-1.16.5-2.0.3.17" = _YaM0SNvA;
        "pkg-1.12.2-1.0.3.20" = _GRWFjTFR;
        "pkg-1.16.5-2.0.3.18" = _B9rREpOe;
        "pkg-1.12.2-1.0.3.21" = _fShRRMpN;
        "pkg-1.16.5-2.0.3.19" = _SD0uO0Te;
        "pkg-1.12.2-1.0.4.22" = _3oYk2x7K;
        "pkg-1.12.2-1.0.4.23" = _bN0qzUPs;
        "pkg-1.16.5-2.0.3.20" = _orOopclW;
        "pkg-1.12.2-1.0.5.24" = _VuCysXKs;
        "default" = _VuCysXKs;
    });
