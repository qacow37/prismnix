...
let
    ...
    in {
        ...
        "pkg-1.2.1" = _kcGZoDaQ;
        "pkg-1.3.0" = _rr2dZZ0R;
        "pkg-1.3.0-mc1.21.10" = _TO0kwbGs;
        "pkg-1.3.1-mc1.21.10" = _sZSpUo95;
        "pkg-1.3.1" = _RHVCKlBE;
        "pkg-1.3.2" = _iqE2OXve;
        "pkg-1.3.2-mc1.21.10" = _WvoQuAWb;
        "pkg-1.3.3" = _OzXAf7hd;
        "pkg-1.3.3-mc1.21.10" = _LzQEB5dS;
        "pkg-1.3.4-mc1.21.10" = _kBa12dIq;
        "pkg-1.3.4" = _nyCGycpE;
        "pkg-1.3.5" = _sPeh2FxS;
        "pkg-1.3.5-mc1.21.10" = _OdZWiGOW;
        "pkg-1.4.0" = _P5SMuL4Q;
        "pkg-1.4.0-mc1.21.10" = _PrbSybOw;
        "pkg-1.5.0" = _fLV9swBm;
        "pkg-1.5.0-mc1.21.10" = _GC4rjHwQ;
        "pkg-1.5.1" = _oEwWCuH1;
        "pkg-1.5.1-mc1.21.10" = _sGM7GQxM;
        "pkg-1.6.0" = _uiAPC8da;
        "pkg-1.6.1" = _sIXwYMBs;
        "pkg-1.6.2" = _qawnexIr;
        "pkg-1.6.3" = _gPNfYHZh;
        "pkg-1.6.3-mc1.21.11" = _XQDjPBwL;
        "default" = _XQDjPBwL;
    });
