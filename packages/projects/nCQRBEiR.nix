...
let
    ...
    in {
        ...
        "pkg-Fabric-1.18.2-1.0.3" = _voG9c1tF;
        "pkg-Fabric-1.18.2-1.0.4" = _iJFIsXSH;
        "pkg-Forge-1.18.2-1.0.5" = _eWsnHWIN;
        "pkg-Fabric-1.18.2-1.0.5" = _nbQFTeN0;
        "pkg-Fabric-22w13a-1.0.5" = _anjpaMLy;
        "pkg-Forge-1.18.2-1.0.6" = _tGa0VDde;
        "pkg-Fabric-1.18.2-1.0.6" = _EM4xqghR;
        "pkg-Fabric-22w13a-1.0.6" = _mLrOzkiZ;
        "pkg-Forge-1.18.2-1.0.7" = _CADpT9Yp;
        "pkg-Fabric-1.18.2-1.0.7" = _e7P9ftjJ;
        "pkg-Fabric-22w15a-1.0.7" = _inx0cTXA;
        "pkg-Forge-1.18.2-1.0.8" = _KvlVwSpu;
        "pkg-Fabric-1.18.2-1.0.8" = _sMhSIsCw;
        "pkg-Fabric-22w17a-1.0.8" = _1MKpFALX;
        "pkg-Forge-1.18.2-1.1.0" = _nKd1DMaF;
        "pkg-Fabric-1.18.2-1.1.0" = _BkKsV507;
        "pkg-Fabric-22w18a-1.1.0" = _P3KFE42x;
        "pkg-Forge-1.18-1.1.0" = _L6coCFDC;
        "pkg-Forge-1.18-1.1.1" = _vt9JFf4y;
        "pkg-Fabric-1.18.2-1.1.1" = _ICVoYvSO;
        "pkg-Fabric-1.19-pre1-1.1.1" = _tAh01sZ2;
        "pkg-Forge-1.19-1.1.1" = _O6dRiePm;
        "pkg-Fabric-1.16.5-1.1.1" = _5aQbopFC;
        "pkg-Forge-1.16.5-1.1.1" = _k4Ivz0m8;
        "pkg-Forge-1.16.5-1.1.2" = _L51G3L13;
        "pkg-Fabric-1.16.5-1.1.2" = _JSZzwchl;
        "pkg-Forge-1.17.1-1.1.2" = _mYRGkzkC;
        "pkg-Fabric-1.17.1-1.1.2" = _5Ev11em5;
        "pkg-Forge-1.18-1.1.2" = _ztlRhD3B;
        "pkg-Fabric-1.18.2-1.1.2" = _4blSgtRD;
        "pkg-Forge-1.19-1.1.2" = _sCLFdRTJ;
        "pkg-Fabric-1.19-1.1.2" = _aQodpQkK;
        "pkg-Forge-1.19.2-1.1.2" = _o8N4mq1r;
        "pkg-Forge-1.16.5-1.1.3" = _t4gFDlvw;
        "pkg-Fabric-1.16.5-1.1.3" = _eudDNI3F;
        "pkg-Forge-1.17.1-1.1.3" = _5TGisEsZ;
        "pkg-Fabric-1.17.1-1.1.3" = _6m9dUcNY;
        "pkg-Forge-1.18.2-1.1.3" = _6QrlFyuY;
        "pkg-Fabric-1.18.2-1.1.3" = _JsBwcURe;
        "pkg-Forge-1.19.2-1.1.3" = _icDLnuB4;
        "pkg-Fabric-1.19.2-1.1.3" = _13hdMKsl;
        "pkg-Forge-1.16.5-1.1.4" = _FTlqKIZQ;
        "pkg-Fabric-1.16.5-1.1.4" = _Y6vl1KRa;
        "pkg-Forge-1.17.1-1.1.4" = _vWHpVKpR;
        "pkg-Fabric-1.17.1-1.1.4" = _K09wGkkS;
        "pkg-Forge-1.18.2-1.1.4" = _KbnZk37O;
        "pkg-Fabric-1.18.2-1.1.4" = _GHkPHvaV;
        "pkg-Forge-1.19.2-1.1.4" = _VX80zoju;
        "pkg-Fabric-1.19.2-1.1.4" = _41yzExMY;
        "pkg-Forge-1.19.3-1.1.4" = _3yNpZjbP;
        "pkg-Fabric-1.19.3-1.1.4" = _OvtfPyeu;
        "pkg-Forge-1.16.5-1.2.0" = _pinmzjEK;
        "pkg-Fabric-1.16.5-1.2.0" = _OG0UlDuq;
        "pkg-Forge-1.17.1-1.2.0" = _KGMIcfCn;
        "pkg-Fabric-1.17.1-1.2.0" = _nky5QifH;
        "pkg-Forge-1.18.2-1.2.0" = _BSfs3edT;
        "pkg-Fabric-1.18.2-1.2.0" = _DG7ePOB1;
        "pkg-Forge-1.19.3-1.2.0" = _CD22K73L;
        "pkg-Fabric-1.19.3-1.2.0" = _eNq0HhNw;
        "pkg-Forge-1.16.5-1.2.1" = _w90q3vfM;
        "pkg-Fabric-1.16.5-1.2.1" = _dhNdQDJO;
        "pkg-Forge-1.17.1-1.2.1" = _nB6VMSyf;
        "pkg-Fabric-1.17.1-1.2.1" = _f712j6yD;
        "pkg-Forge-1.18.2-1.2.1" = _h81rdSsk;
        "pkg-Fabric-1.18.2-1.2.1" = _KAENcdL9;
        "pkg-Forge-1.19.2-1.2.1" = _ckjsbSW7;
        "pkg-Fabric-1.19.2-1.2.1" = _nJxPEe8y;
        "pkg-Forge-1.19.3-1.2.1" = _CxXnoTb7;
        "pkg-Fabric-1.19.3-1.2.1" = _ats3EOfX;
        "pkg-Forge-1.19.4-1.2.1" = _zbiI7YR0;
        "pkg-Fabric-1.19.4-1.2.1" = _sJyU9Qno;
        "pkg-Forge-1.16.5-1.2.2" = _3OmuM4NO;
        "pkg-Fabric-1.16.5-1.2.2" = _mfszOTlr;
        "pkg-Forge-1.17.1-1.2.2" = _LaMXnOQ6;
        "pkg-Fabric-1.17.1-1.2.2" = _38xohg5D;
        "pkg-Forge-1.18.2-1.2.2" = _URteYbbr;
        "pkg-Fabric-1.18.2-1.2.2" = _rRKRAkPC;
        "pkg-Forge-1.19.2-1.2.2" = _pOlsT4lW;
        "pkg-Fabric-1.19.2-1.2.2" = _iLLh4T3C;
        "pkg-Forge-1.19.3-1.2.2" = _qu1dLyr9;
        "pkg-Fabric-1.19.3-1.2.2" = _n3qWKnBY;
        "pkg-Forge-1.19.4-1.2.2" = _3Kq2ZkV2;
        "pkg-Fabric-1.19.4-1.2.2" = _ADrMa5Bu;
        "pkg-Fabric-23w12a-1.2.2" = _PUMABAWd;
        "pkg-Fabric-23w16a-1.2.2" = _fSun9BwT;
        "pkg-Forge-1.20.1-1.2.2" = _4CU8avme;
        "pkg-Forge-1.16.5-1.2.3" = _iuQCq5I9;
        "pkg-Fabric-1.16.5-1.2.3" = _RBQ3njfY;
        "pkg-Forge-1.17.1-1.2.3" = _qvYkv8Ia;
        "pkg-Fabric-1.17.1-1.2.3" = _FwrI9wGk;
        "pkg-Forge-1.18.2-1.2.3" = _XKfIYdJv;
        "pkg-Fabric-1.18.2-1.2.3" = _2jC5hQNS;
        "pkg-Forge-1.19.2-1.2.3" = _U0ix2Gb6;
        "pkg-Fabric-1.19.2-1.2.3" = _oVcjOfd4;
        "pkg-Forge-1.19.3-1.2.3" = _fMrZ4y5t;
        "pkg-Fabric-1.19.3-1.2.3" = _1fhYpH11;
        "pkg-Forge-1.19.4-1.2.3" = _sWd5X5Il;
        "pkg-Fabric-1.19.4-1.2.3" = _IITCXMnb;
        "pkg-Forge-1.20.1-1.2.3" = _R6xvalZp;
        "pkg-Fabric-1.20.1-1.2.3" = _b58GxkTh;
        "pkg-Forge-1.16.5-2.0.0" = _Y8y7QnJ3;
        "pkg-Fabric-1.16.5-2.0.0" = _hmXgdCth;
        "pkg-Forge-1.17.1-2.0.0" = _99spFBzR;
        "pkg-Fabric-1.17.1-2.0.0" = _pDadPO0P;
        "pkg-Forge-1.18.2-2.0.0" = _vokUeB4I;
        "pkg-Fabric-1.18.2-2.0.0" = _iMR4gFHg;
        "pkg-Forge-1.19.2-2.0.0" = _H7vwnsim;
        "pkg-Fabric-1.19.2-2.0.0" = _GqRaAEgd;
        "pkg-Forge-1.19.3-2.0.0" = _xmMQrRLX;
        "pkg-Fabric-1.19.3-2.0.0" = _GazMrLyl;
        "pkg-Forge-1.19.4-2.0.0" = _KTtBu34h;
        "pkg-Fabric-1.19.4-2.0.0" = _tMRKXh5a;
        "pkg-Forge-1.20.1-2.0.0" = _53n884oz;
        "pkg-Fabric-1.20.1-2.0.0" = _l1xjmRyA;
        "pkg-Fabric-23w31a-2.0.0" = _B0q0dgBt;
        "pkg-Forge-1.16.5-3.0.0" = _xbU1UjqG;
        "pkg-Fabric-1.16.5-3.0.0" = _awTUEEHU;
        "pkg-Forge-1.17.1-3.0.0" = _yuv6NK3c;
        "pkg-Fabric-1.17.1-3.0.0" = _e4kF51S5;
        "pkg-Forge-1.18.2-3.0.0" = _kTcdq6Ee;
        "pkg-Fabric-1.18.2-3.0.0" = _WNGIxiKA;
        "pkg-Forge-1.19.2-3.0.0" = _RTxwKVQ1;
        "pkg-Fabric-1.19.2-3.0.0" = _xPPzPsFY;
        "pkg-Forge-1.19.3-3.0.0" = _NDmmVPJ7;
        "pkg-Fabric-1.19.3-3.0.0" = _Hnn0v77x;
        "pkg-Forge-1.19.4-3.0.0" = _mR0EDA1K;
        "pkg-Fabric-1.19.4-3.0.0" = _fG0kEHrQ;
        "pkg-Forge-1.20.1-3.0.0" = _Do3PBJgD;
        "pkg-Fabric-1.20.1-3.0.0" = _xLyoYRQN;
        "pkg-Forge-1.20.2-3.0.0" = _uWLfM8hq;
        "pkg-Fabric-1.20.2-3.0.0" = _QchbR697;
        "pkg-Forge-1.16.5-3.1.0" = _Z6Gkt3eV;
        "pkg-Fabric-1.16.5-3.1.0" = _105Z8SCt;
        "pkg-Forge-1.17.1-3.1.0" = _eLqpYKvh;
        "pkg-Fabric-1.17.1-3.1.0" = _kXWTUhDg;
        "pkg-Forge-1.18.2-3.1.0" = _SMhdUW9W;
        "pkg-Fabric-1.18.2-3.1.0" = _u4ohRWJy;
        "pkg-Forge-1.19.2-3.1.0" = _x26Z2ovL;
        "pkg-Fabric-1.19.2-3.1.0" = _7njHDHoE;
        "pkg-Forge-1.19.3-3.1.0" = _Pp8Zz7E7;
        "pkg-Fabric-1.19.3-3.1.0" = _CCY82ACZ;
        "pkg-Forge-1.19.4-3.1.0" = _U1SEuNvg;
        "pkg-Fabric-1.19.4-3.1.0" = _4f663cAF;
        "pkg-Forge-1.20.1-3.1.0" = _sly00x0X;
        "pkg-Fabric-1.20.1-3.1.0" = _hJe5aLGc;
        "pkg-Forge-1.20.2-3.1.0" = _ttEMULIV;
        "pkg-Fabric-1.20.2-3.1.0" = _ZSvD52HS;
        "pkg-Forge-1.16.5-3.1.1" = _tf1qJmWO;
        "pkg-Fabric-1.16.5-3.1.1" = _sbZEfbGA;
        "pkg-Forge-1.17.1-3.1.1" = _m0Nba7G3;
        "pkg-Fabric-1.17.1-3.1.1" = _3lSqUIuF;
        "pkg-Forge-1.18.2-3.1.1" = _2uqsQ2w6;
        "pkg-Fabric-1.18.2-3.1.1" = _uNqJW1ru;
        "pkg-Forge-1.19.2-3.1.1" = _ogd75I6C;
        "pkg-Fabric-1.19.2-3.1.1" = _aqGhxEnL;
        "pkg-Forge-1.19.3-3.1.1" = _ZppqSgCf;
        "pkg-Fabric-1.19.3-3.1.1" = _8l1zd99I;
        "pkg-Forge-1.19.4-3.1.1" = _hqafXtqr;
        "pkg-Fabric-1.19.4-3.1.1" = _EwiIpfJ2;
        "pkg-Forge-1.20.1-3.1.1" = _fOVI7LEu;
        "pkg-Fabric-1.20.1-3.1.1" = _YKPYz4Pv;
        "pkg-Forge-1.20.4-3.1.1" = _s2REJFoq;
        "pkg-Fabric-1.20.4-3.1.1" = _UGlyrR8o;
        "pkg-Fabric-23w51b-3.1.1" = _kYt1qprK;
        "pkg-Forge-1.16.5-3.1.2" = _t824zlTY;
        "pkg-Fabric-1.16.5-3.1.2" = _wX9baPbW;
        "pkg-Forge-1.17.1-3.1.2" = _6CjOjFhE;
        "pkg-Fabric-1.17.1-3.1.2" = _VbOs3Yrs;
        "pkg-Forge-1.18.2-3.1.2" = _wOEkPlVn;
        "pkg-Fabric-1.18.2-3.1.2" = _azBIj6og;
        "pkg-Forge-1.19.2-3.1.2" = _Tnykuvbj;
        "pkg-Fabric-1.19.2-3.1.2" = _Ek8uJgPz;
        "pkg-Forge-1.19.3-3.1.2" = _pgOmwjXG;
        "pkg-Fabric-1.19.3-3.1.2" = _uAd9m7sM;
        "pkg-Forge-1.19.4-3.1.2" = _VnyNTlOx;
        "pkg-Fabric-1.19.4-3.1.2" = _3fhNNfPc;
        "pkg-Forge-1.20.1-3.1.2" = _lis6LECk;
        "pkg-Fabric-1.20.2-3.1.2" = _l9ZAm4Gj;
        "pkg-Forge-1.20.2-3.1.2" = _zK3wgnuY;
        "pkg-Forge-1.20.4-3.1.2" = _H4PNzeNs;
        "pkg-Fabric-1.20.4-3.1.2" = _X5OadXgy;
        "pkg-Fabric-24w07a-3.1.2" = _BDBN5sp8;
        "pkg-Forge-1.16.5-3.1.3" = _VNwCnFXV;
        "pkg-Fabric-1.16.5-3.1.3" = _oP0XxdV5;
        "pkg-Forge-1.17.1-3.1.3" = _uRdcY28H;
        "pkg-Fabric-1.17.1-3.1.3" = _lL6puqcV;
        "pkg-Forge-1.18.2-3.1.3" = _R8LspEIJ;
        "pkg-Fabric-1.18.2-3.1.3" = _WKb2PXDO;
        "pkg-Forge-1.19.2-3.1.3" = _PQWpBYW2;
        "pkg-Fabric-1.19.2-3.1.3" = _hj61VR6N;
        "pkg-Forge-1.19.3-3.1.3" = _ea7kR9VI;
        "pkg-Fabric-1.19.3-3.1.3" = _kaS8bPs5;
        "pkg-Forge-1.19.4-3.1.3" = _QDQfMili;
        "pkg-Fabric-1.19.4-3.1.3" = _O5eUKWiH;
        "pkg-Forge-1.20.1-3.1.3" = _rHORzYiO;
        "pkg-Fabric-1.20.1-3.1.3" = _aMjZUToX;
        "pkg-Forge-1.20.2-3.1.3" = _NY6sUHsX;
        "pkg-Fabric-1.20.2-3.1.3" = _5LlNtGmd;
        "pkg-Forge-1.20.4-3.1.3" = _p4j7a2aN;
        "pkg-Fabric-1.20.4-3.1.3" = _WVWOylk7;
        "pkg-Fabric-24w10a-3.1.3" = _PQjtulWI;
        "pkg-Forge-1.16.5-4.0.0" = _ZwX96Rzc;
        "pkg-Fabric-1.16.5-4.0.0" = _lZdQcQT7;
        "pkg-Forge-1.17.1-4.0.0" = _fUYHt42R;
        "pkg-Fabric-1.17.1-4.0.0" = _xwIwxXaM;
        "pkg-Forge-1.18.2-4.0.0" = _WQiHbiF5;
        "pkg-Fabric-1.18.2-4.0.0" = _RjnS6ies;
        "pkg-Forge-1.19.2-4.0.0" = _nWO1hQz3;
        "pkg-Fabric-1.19.2-4.0.0" = _ivAUaqGm;
        "pkg-Forge-1.19.3-4.0.0" = _8AQtrqYh;
        "pkg-Fabric-1.19.3-4.0.0" = _EEjmkKJu;
        "pkg-Forge-1.19.4-4.0.0" = _kSEoqI1G;
        "pkg-Fabric-1.19.4-4.0.0" = _bu4WpaBk;
        "pkg-Forge-1.20.1-4.0.0" = _Q9gvujWU;
        "pkg-Fabric-1.20.1-4.0.0" = _1m9dDk0l;
        "pkg-Forge-1.20.2-4.0.0" = _pES95J7y;
        "pkg-NeoForge-1.20.2-4.0.0" = _XkBiNGLR;
        "pkg-Fabric-1.20.2-4.0.0" = _zoNhxHwW;
        "pkg-Forge-1.20.4-4.0.0" = _2h5XWda2;
        "pkg-NeoForge-1.20.4-4.0.0" = _jtBFLnUz;
        "pkg-Fabric-1.20.4-4.0.0" = _CYPtTGZY;
        "pkg-Forge-1.20.6-4.0.0" = _tSkHOepW;
        "pkg-NeoForge-1.20.6-4.0.0" = _oGk0tJrK;
        "pkg-Fabric-1.20.6-4.0.0" = _1yQXwaMM;
        "pkg-Forge-1.21-4.0.0" = _7TMruxbx;
        "pkg-NeoForge-1.21-4.0.0" = _kjkHKtIq;
        "pkg-Fabric-1.21-4.0.0" = _v1zAblQ8;
        "pkg-Forge-1.16.5-4.0.1" = _aTNEIpeY;
        "pkg-Fabric-1.16.5-4.0.1" = _RebRCMtn;
        "pkg-Forge-1.17.1-4.0.1" = _f0I1iein;
        "pkg-Fabric-1.17.1-4.0.1" = _Iko8jgZX;
        "pkg-Forge-1.18.2-4.0.1" = _cqs6MYpF;
        "pkg-Fabric-1.18.2-4.0.1" = _MR2EX0MY;
        "pkg-Forge-1.19.2-4.0.1" = _5Jjefu9c;
        "pkg-Fabric-1.19.2-4.0.1" = _nbHl3CP1;
        "pkg-Forge-1.19.3-4.0.1" = _ZLLg0QdX;
        "pkg-Fabric-1.19.3-4.0.1" = _6gjbGQ9E;
        "pkg-Forge-1.19.4-4.0.1" = _1bCgbeLa;
        "pkg-Fabric-1.19.4-4.0.1" = _fFPmEMmi;
        "pkg-Forge-1.20.1-4.0.1" = _KikwC56L;
        "pkg-Fabric-1.20.1-4.0.1" = _rJuvV8zU;
        "pkg-Forge-1.20.2-4.0.1" = _kABxcjbO;
        "pkg-NeoForge-1.20.2-4.0.1" = _LGxquZLZ;
        "pkg-Fabric-1.20.2-4.0.1" = _4VwX6FGr;
        "pkg-Forge-1.20.4-4.0.1" = _wdHA0EiV;
        "pkg-NeoForge-1.20.4-4.0.1" = _bW0Emrgf;
        "pkg-Fabric-1.20.4-4.0.1" = _rMV2ZMZe;
        "pkg-Forge-1.20.6-4.0.1" = _BqZ1aFK9;
        "pkg-NeoForge-1.20.6-4.0.1" = _hUC51Wzv;
        "pkg-Fabric-1.20.6-4.0.1" = _d3hKoTBA;
        "pkg-Forge-1.21.1-4.0.1" = _yd9TKZXe;
        "pkg-NeoForge-1.21.1-4.0.1" = _Cr0vV65c;
        "pkg-Fabric-1.21.1-4.0.1" = _MGosc5Yb;
        "pkg-Forge-1.21.3-4.0.1" = _wIoymwx9;
        "pkg-NeoForge-1.21.3-4.0.1" = _uNGLdEOA;
        "pkg-Fabric-1.21.3-4.0.1" = _ydNmmdDT;
        "pkg-Forge-1.21.5-4.0.1" = _D5mHUU3h;
        "pkg-NeoForge-1.21.5-4.0.1" = _ee00nVuN;
        "pkg-Fabric-1.21.5-4.0.1" = _qPVmvjcC;
        "pkg-Fabric-25w18a-4.0.1" = _8SR5SN29;
        "pkg-Fabric-25w19a-4.0.1" = _OKn7jOOb;
        "pkg-Forge-1.16.5-5.0.0" = _uUFlZPLQ;
        "pkg-Fabric-1.16.5-5.0.0" = _yrpggucC;
        "pkg-Forge-1.17.1-5.0.0" = _zGOrxC81;
        "pkg-Fabric-1.17.1-5.0.0" = _V3ECKBIv;
        "pkg-Forge-1.18.2-5.0.0" = _ut2G4J6C;
        "pkg-Fabric-1.18.2-5.0.0" = _WFbGn6QC;
        "pkg-Forge-1.19-5.0.0" = _Yzoitu70;
        "pkg-Fabric-1.19-5.0.0" = _sztmjnx2;
        "pkg-Forge-1.19.2-5.0.0" = _6NjNDoOr;
        "pkg-Fabric-1.19.2-5.0.0" = _F6SFBnlW;
        "pkg-Forge-1.19.3-5.0.0" = _BHMkX65G;
        "pkg-Fabric-1.19.3-5.0.0" = _WZXyTGIi;
        "pkg-Forge-1.19.4-5.0.0" = _vpFLxz6i;
        "pkg-Fabric-1.19.4-5.0.0" = _21C4vPjo;
        "pkg-Forge-1.20.1-5.0.0" = _DFiV1O6k;
        "pkg-Fabric-1.20.1-5.0.0" = _VuOZpctY;
        "pkg-Forge-1.20.2-5.0.0" = _4GmNZzSA;
        "pkg-NeoForge-1.20.2-5.0.0" = _X4TGC4Ul;
        "pkg-Fabric-1.20.2-5.0.0" = _MUrTsE7e;
        "pkg-Forge-1.20.4-5.0.0" = _irQrKz83;
        "pkg-NeoForge-1.20.4-5.0.0" = _2ooUG93W;
        "pkg-Fabric-1.20.4-5.0.0" = _UiCz28tj;
        "pkg-Forge-1.20.6-5.0.0" = _9nTicgCM;
        "pkg-NeoForge-1.20.6-5.0.0" = _BLeKLaDZ;
        "pkg-Fabric-1.20.6-5.0.0" = _8iZIGcGb;
        "pkg-Forge-1.21.1-5.0.0" = _7RidWc6W;
        "pkg-NeoForge-1.21.1-5.0.0" = _CiwoldjO;
        "pkg-Fabric-1.21.1-5.0.0" = _b92O5XvD;
        "pkg-Forge-1.21.4-5.0.0" = _dqhZW0ek;
        "pkg-NeoForge-1.21.4-5.0.0" = _xA1XREZq;
        "pkg-Fabric-1.21.4-5.0.0" = _Ml75JpfF;
        "pkg-Forge-1.21.5-5.0.0" = _c5TXLr8J;
        "pkg-NeoForge-1.21.5-5.0.0" = _SPfp8xiO;
        "pkg-Fabric-1.21.5-5.0.0" = _Sno2z0g4;
        "pkg-Forge-1.21.6-5.0.0" = _knlFp83e;
        "pkg-NeoForge-1.21.6-5.0.0" = _oRTweRam;
        "pkg-Fabric-1.21.6-5.0.0" = _31FXpLlF;
        "pkg-Forge-1.16.5-5.0.1" = _oW6ntakq;
        "pkg-Fabric-1.16.5-5.0.1" = _35gd5iGF;
        "pkg-Forge-1.17.1-5.0.1" = _6177tygB;
        "pkg-Fabric-1.17.1-5.0.1" = _Wp0Kd9B9;
        "pkg-Forge-1.18.2-5.0.1" = _cSFvrydO;
        "pkg-Fabric-1.18.2-5.0.1" = _1CU2XfwC;
        "pkg-Forge-1.19-5.0.1" = _Uj4rsLUw;
        "pkg-Fabric-1.19-5.0.1" = _eOYJ1BcC;
        "pkg-Forge-1.19.2-5.0.1" = _qAg0Msoz;
        "pkg-Fabric-1.19.2-5.0.1" = _GwW3bUVy;
        "pkg-Forge-1.19.3-5.0.1" = _r36FOZLO;
        "pkg-Fabric-1.19.3-5.0.1" = _i3pk9eGF;
        "pkg-Forge-1.19.4-5.0.1" = _B9PQWQBC;
        "pkg-Fabric-1.19.4-5.0.1" = _AhkYdclI;
        "pkg-Forge-1.20.1-5.0.1" = _hDkDEjbP;
        "pkg-Fabric-1.20.1-5.0.1" = _XK7ULeRj;
        "pkg-Forge-1.20.2-5.0.1" = _HhuiVhSO;
        "pkg-NeoForge-1.20.2-5.0.1" = _enq0rL7R;
        "pkg-Fabric-1.20.2-5.0.1" = _RTHo91Ud;
        "pkg-Forge-1.20.4-5.0.1" = _NYK9v7vh;
        "pkg-NeoForge-1.20.4-5.0.1" = _IgetAwy6;
        "pkg-Fabric-1.20.4-5.0.1" = _GTWXFmsS;
        "pkg-Forge-1.20.6-5.0.1" = _G5dsbxJI;
        "pkg-NeoForge-1.20.6-5.0.1" = _MZVyTbkY;
        "pkg-Fabric-1.20.6-5.0.1" = _5nGkaTxw;
        "pkg-Forge-1.21.1-5.0.1" = _CJhvaSow;
        "pkg-NeoForge-1.21.1-5.0.1" = _A9o5RReR;
        "pkg-Fabric-1.21.1-5.0.1" = _xvdnTE1d;
        "pkg-Forge-1.21.3-5.0.1" = _f7hqhKUG;
        "pkg-NeoForge-1.21.3-5.0.1" = _rEzQNQjS;
        "pkg-Fabric-1.21.3-5.0.1" = _gZiqri6p;
        "pkg-Forge-1.21.4-5.0.1" = _qrZTpDMA;
        "pkg-NeoForge-1.21.4-5.0.1" = _J6iUphkh;
        "pkg-Fabric-1.21.4-5.0.1" = _1NVtA7Gq;
        "pkg-Forge-1.21.5-5.0.1" = _aYtJ1Wo3;
        "pkg-NeoForge-1.21.5-5.0.1" = _uE9wc4wo;
        "pkg-Fabric-1.21.5-5.0.1" = _iYTTNVsO;
        "pkg-Forge-1.21.8-5.0.1" = _XJ4ME5Om;
        "pkg-NeoForge-1.21.8-5.0.1" = _Dj34Jec1;
        "pkg-Fabric-1.21.8-5.0.1" = _rxaGgRuA;
        "pkg-Fabric-25w31a-5.0.1" = _WuYxNznb;
        "pkg-Forge-1.16.5-5.0.2" = _jXneAdME;
        "pkg-Fabric-1.16.5-5.0.2" = _bhR7Qq5G;
        "pkg-Forge-1.17.1-5.0.2" = _eUic0XHZ;
        "pkg-Fabric-1.17.1-5.0.2" = _PSRqI46Q;
        "pkg-Forge-1.18.2-5.0.2" = _KnyQrC3y;
        "pkg-Fabric-1.18.2-5.0.2" = _lPc0NeVo;
        "pkg-Forge-1.19-5.0.2" = _bJeXINYD;
        "pkg-Fabric-1.19-5.0.2" = _LTwgrTIX;
        "pkg-Forge-1.19.2-5.0.2" = _aZRuKqUv;
        "pkg-Fabric-1.19.2-5.0.2" = _JtxeTjU1;
        "pkg-Forge-1.19.3-5.0.2" = _KAZQfXM3;
        "pkg-Fabric-1.19.3-5.0.2" = _QIfjrhWo;
        "pkg-Forge-1.19.4-5.0.2" = _nz7N4GuK;
        "pkg-Fabric-1.19.4-5.0.2" = _mGchQR2E;
        "pkg-Forge-1.20.1-5.0.2" = _HtwEAWG3;
        "pkg-Fabric-1.20.1-5.0.2" = _J0KaVWxA;
        "pkg-Forge-1.20.2-5.0.2" = _eiNXbwNc;
        "pkg-NeoForge-1.20.2-5.0.2" = _G6Rc00NM;
        "pkg-Fabric-1.20.2-5.0.2" = _mhQzisNg;
        "pkg-Forge-1.20.4-5.0.2" = _bhV9JNeY;
        "pkg-NeoForge-1.20.4-5.0.2" = _8N1xCQcO;
        "pkg-Fabric-1.20.4-5.0.2" = _e2H4v6Ik;
        "pkg-Forge-1.20.6-5.0.2" = _qGBsTGjn;
        "pkg-NeoForge-1.20.6-5.0.2" = _V3PtsNpL;
        "pkg-Fabric-1.20.6-5.0.2" = _5mSNqxqm;
        "pkg-Forge-1.21.1-5.0.2" = _zyothfWs;
        "pkg-NeoForge-1.21.1-5.0.2" = _kKefaugy;
        "pkg-Fabric-1.21.1-5.0.2" = _SeSlOPJ2;
        "pkg-Forge-1.21.3-5.0.2" = _GPrJTEpB;
        "pkg-NeoForge-1.21.3-5.0.2" = _s3SiVtoY;
        "pkg-Fabric-1.21.3-5.0.2" = _BsonOvL2;
        "pkg-Forge-1.21.4-5.0.2" = _q9D0QroL;
        "pkg-NeoForge-1.21.4-5.0.2" = _TYfmqJDO;
        "pkg-Fabric-1.21.4-5.0.2" = _zZTzZ4sv;
        "pkg-Forge-1.21.5-5.0.2" = _4BDdq5rM;
        "pkg-NeoForge-1.21.5-5.0.2" = _1rTszyaX;
        "pkg-Fabric-1.21.5-5.0.2" = _A2KFNe0E;
        "pkg-Forge-1.21.8-5.0.2" = _C75H4O4Q;
        "pkg-NeoForge-1.21.8-5.0.2" = _imOubAJa;
        "pkg-Fabric-1.21.8-5.0.2" = _Z6E2YMYG;
        "pkg-Forge-1.21.9-5.0.2" = _RM4MBHYF;
        "pkg-NeoForge-1.21.9-5.0.2" = _bxLl5gcZ;
        "pkg-Fabric-1.21.9-5.0.2" = _M8ZoDZDb;
        "pkg-Forge-1.21.10-5.0.2" = _8jItHOdd;
        "pkg-Forge-1.16.5-5.1.0" = _t5XhiHlM;
        "pkg-Fabric-1.16.5-5.1.0" = _nY129ErM;
        "pkg-Forge-1.17.1-5.1.0" = _JRNhxMtM;
        "pkg-Fabric-1.17.1-5.1.0" = _3B3YYWmx;
        "pkg-Forge-1.18.2-5.1.0" = _cOUDsuwj;
        "pkg-Fabric-1.18.2-5.1.0" = _H1prtT0a;
        "pkg-Forge-1.19-5.1.0" = _wiWoNlDz;
        "pkg-Fabric-1.19-5.1.0" = _tzuQtbi1;
        "pkg-Forge-1.19.2-5.1.0" = _BPBMcbM7;
        "pkg-Fabric-1.19.2-5.1.0" = _RGRjSS6x;
        "pkg-Forge-1.19.3-5.1.0" = _D0cifHFZ;
        "pkg-Fabric-1.19.3-5.1.0" = _ESZxNSk1;
        "pkg-Forge-1.19.4-5.1.0" = _797iPT16;
        "pkg-Fabric-1.19.4-5.1.0" = _V5A48JZT;
        "pkg-Forge-1.20.1-5.1.0" = _IzWImbXp;
        "pkg-Fabric-1.20.1-5.1.0" = _bvgpKKZO;
        "pkg-Forge-1.20.2-5.1.0" = _Zo1xcyim;
        "pkg-NeoForge-1.20.2-5.1.0" = _D454Rrou;
        "pkg-Fabric-1.20.2-5.1.0" = _6z3dUIpA;
        "pkg-Forge-1.20.4-5.1.0" = _bcYKUGue;
        "pkg-NeoForge-1.20.4-5.1.0" = _9W4IDQyy;
        "pkg-Fabric-1.20.4-5.1.0" = _KQtzb0OS;
        "pkg-Forge-1.20.6-5.1.0" = _SAlylV34;
        "pkg-NeoForge-1.20.6-5.1.0" = _vWixyYV4;
        "pkg-Fabric-1.20.6-5.1.0" = _YhxGWtyb;
        "pkg-Forge-1.21.1-5.1.0" = _LJKR8cpj;
        "pkg-NeoForge-1.21.1-5.1.0" = _TZq4bC0D;
        "pkg-Fabric-1.21.1-5.1.0" = _FPFLksdA;
        "pkg-Forge-1.21.3-5.1.0" = _6EG1hfVR;
        "pkg-NeoForge-1.21.3-5.1.0" = _iYmNx7cr;
        "pkg-Fabric-1.21.3-5.1.0" = _yn8lxtVe;
        "pkg-Forge-1.21.4-5.1.0" = _uB3tR8zj;
        "pkg-NeoForge-1.21.4-5.1.0" = _XqtwX28t;
        "pkg-Fabric-1.21.4-5.1.0" = _ndc7GDu8;
        "pkg-Forge-1.21.5-5.1.0" = _agspftWM;
        "pkg-NeoForge-1.21.5-5.1.0" = _6zmvroE8;
        "pkg-Fabric-1.21.5-5.1.0" = _TJKxcVQ9;
        "pkg-Forge-1.21.8-5.1.0" = _FixRawEk;
        "pkg-NeoForge-1.21.8-5.1.0" = _DOte0GVq;
        "pkg-Fabric-1.21.8-5.1.0" = _XOE5yXxi;
        "pkg-Forge-1.21.10-5.1.0" = _Nn1KAosD;
        "pkg-NeoForge-1.21.10-5.1.0" = _zNyzZbFg;
        "pkg-Fabric-1.21.10-5.1.0" = _yajtey3T;
        "pkg-Forge-1.21.11-5.1.0" = _UOfVv4YE;
        "pkg-NeoForge-1.21.11-5.1.0" = _Jc7UwhLn;
        "pkg-Fabric-1.21.11-5.1.0" = _gWLpmT3V;
        "pkg-Forge-1.19-5.1.1" = _O1WmrFvJ;
        "pkg-Forge-1.17.1-5.1.1" = _TaVcOam2;
        "pkg-Forge-1.19.3-5.1.1" = _iV4CRD3z;
        "pkg-Fabric-1.17.1-5.1.1" = _o32h0kAL;
        "pkg-Forge-1.16.5-5.1.1" = _J1Od8mOv;
        "pkg-Fabric-1.18.2-5.1.1" = _dQuRh5oa;
        "pkg-Forge-1.20.2-5.1.1" = _xYYqWUYM;
        "pkg-Forge-1.19.4-5.1.1" = _s65BwhP8;
        "pkg-Forge-1.18.2-5.1.1" = _MUO0tQKa;
        "pkg-Fabric-1.16.5-5.1.1" = _5ii9yzXJ;
        "pkg-Forge-1.19.2-5.1.1" = _IHyi28Yc;
        "pkg-Forge-1.20.1-5.1.1" = _XAtORAMo;
        "pkg-Fabric-1.19.2-5.1.1" = _bI3xAms6;
        "pkg-Fabric-1.19-5.1.1" = _kH7XwRnX;
        "pkg-NeoForge-1.21.10-5.1.1" = _Fq8DZBmA;
        "pkg-NeoForge-1.21.1-5.1.1" = _nO20bpBG;
        "pkg-Forge-1.20.6-5.1.1" = _vAzaXb2v;
        "pkg-Fabric-1.20.4-5.1.1" = _CPw2FciQ;
        "pkg-Fabric-1.21.11-5.1.1" = _zcFSHjM1;
        "pkg-Fabric-1.20.2-5.1.1" = _cDehZ60t;
        "pkg-NeoForge-1.20.2-5.1.1" = _a8EVE07i;
        "pkg-Fabric-1.21.1-5.1.1" = _ixWwwfaa;
        "pkg-Forge-1.21.8-5.1.1" = _SluNe4JK;
        "pkg-Fabric-1.21.4-5.1.1" = _FpDE2bAl;
        "pkg-Fabric-1.21.8-5.1.1" = _ASixodZL;
        "pkg-Forge-1.21.3-5.1.1" = _KF1g4HVX;
        "pkg-Fabric-1.19.3-5.1.1" = _mgq0YoU7;
        "pkg-Fabric-1.21.10-5.1.1" = _ZJhbJwS1;
        "pkg-Forge-1.21.1-5.1.1" = _YoYBgekr;
        "pkg-Fabric-1.21.5-5.1.1" = _cT5i73tK;
        "pkg-Fabric-1.20.1-5.1.1" = _ZVhBArON;
        "pkg-Forge-1.20.4-5.1.1" = _njhVIbcM;
        "pkg-Forge-1.21.5-5.1.1" = _KCAMGn7V;
        "pkg-NeoForge-1.21.11-5.1.1" = _og6tE7cS;
        "pkg-Forge-1.21.4-5.1.1" = _yD2Ivudm;
        "pkg-Fabric-1.21.3-5.1.1" = _uW4fiUzf;
        "pkg-Fabric-1.19.4-5.1.1" = _K7FEtqfu;
        "pkg-Fabric-1.20.6-5.1.1" = _4a4cpFAy;
        "pkg-NeoForge-1.21.5-5.1.1" = _xg2wy2lG;
        "pkg-NeoForge-1.20.6-5.1.1" = _gCDTv1Wz;
        "pkg-Forge-1.21.11-5.1.1" = _p3c6eaqN;
        "pkg-NeoForge-1.20.4-5.1.1" = _rHsXA31Y;
        "pkg-NeoForge-1.21.8-5.1.1" = _jYUkXg5X;
        "pkg-NeoForge-1.21.4-5.1.1" = _p3q5MwFq;
        "pkg-Forge-1.21.10-5.1.1" = _yxX8JLQ6;
        "pkg-NeoForge-1.21.3-5.1.1" = _UWTondMP;
        "pkg-Forge-1.18.2-5.1.2" = _OCkVV1PR;
        "pkg-Forge-1.19-5.1.2" = _NlIZxOhp;
        "pkg-Forge-1.16.5-5.1.2" = _rXuTTc3h;
        "pkg-Fabric-1.18.2-5.1.2" = _eGo8Ync8;
        "pkg-Forge-1.17.1-5.1.2" = _2yyrLnMy;
        "pkg-Fabric-1.19-5.1.2" = _oDjuUZvR;
        "pkg-Fabric-1.16.5-5.1.2" = _BVFrxdVA;
        "pkg-Fabric-1.19.2-5.1.2" = _bvPmY5F8;
        "pkg-Forge-1.19.4-5.1.2" = _abhPznv0;
        "pkg-Forge-1.19.2-5.1.2" = _RPfQZ8wj;
        "pkg-Forge-1.20.1-5.1.2" = _NKkYYxY0;
        "pkg-Fabric-1.19.3-5.1.2" = _zAqgWo0k;
        "pkg-Fabric-1.17.1-5.1.2" = _5gRkWKr7;
        "pkg-Forge-1.19.3-5.1.2" = _LAfeOYDr;
        "pkg-Forge-1.20.2-5.1.2" = _aMca4URD;
        "pkg-Fabric-1.19.4-5.1.2" = _BmrV5vHw;
        "pkg-Fabric-1.20.1-5.1.2" = _BdDqlMae;
        "pkg-NeoForge-1.20.2-5.1.2" = _q3uWXGes;
        "pkg-NeoForge-1.20.4-5.1.2" = _UnHbR5dJ;
        "pkg-Forge-1.20.4-5.1.2" = _S0iPVFyG;
        "pkg-Fabric-1.20.6-5.1.2" = _Tu4efFSO;
        "pkg-Forge-1.20.6-5.1.2" = _2OVM3qoq;
        "pkg-Fabric-1.21.11-5.1.2" = _lgLBYQO3;
        "pkg-Fabric-1.21.8-5.1.2" = _DWo2ZGkb;
        "pkg-Forge-1.21.11-5.1.2" = _xr8B2GDt;
        "pkg-NeoForge-1.21.4-5.1.2" = _phb0o8FN;
        "pkg-Fabric-1.20.2-5.1.2" = _QXfGTXmH;
        "pkg-Forge-1.21.10-5.1.2" = _7fdSEGQL;
        "pkg-Forge-1.21.8-5.1.2" = _2XfnfPoH;
        "pkg-Fabric-1.21.4-5.1.2" = _SlRlVIiD;
        "pkg-NeoForge-1.21.5-5.1.2" = _EQJ1JVp7;
        "pkg-NeoForge-1.21.8-5.1.2" = _w1Ey5der;
        "pkg-Fabric-1.21.1-5.1.2" = _eRjPC9vV;
        "pkg-NeoForge-1.21.1-5.1.2" = _i6O64Eyw;
        "pkg-NeoForge-1.21.11-5.1.2" = _iemPnWdX;
        "pkg-Fabric-1.21.5-5.1.2" = _oQcNdlB7;
        "pkg-Forge-1.21.4-5.1.2" = _VGnyp9Gz;
        "pkg-NeoForge-1.20.6-5.1.2" = _9NdLvG71;
        "pkg-Forge-1.21.5-5.1.2" = _rkmkS60j;
        "pkg-Fabric-1.21.3-5.1.2" = _wUk5hcQM;
        "pkg-Fabric-1.21.10-5.1.2" = _reuAQlDz;
        "pkg-NeoForge-1.21.3-5.1.2" = _w9xb3hyF;
        "pkg-Forge-1.21.1-5.1.2" = _mL0mXrYm;
        "pkg-NeoForge-1.21.10-5.1.2" = _XqrFLEXM;
        "pkg-Forge-1.21.3-5.1.2" = _xkxdLWto;
        "pkg-Fabric-1.20.4-5.1.2" = _LM0utvJI;
        "pkg-NeoForge-26.1.1-5.1.2" = _LBzwZnNE;
        "pkg-Fabric-26.1.1-5.1.2" = _j71IOYcV;
        "pkg-Forge-26.1.2-5.1.2" = _rMiiZuKT;
