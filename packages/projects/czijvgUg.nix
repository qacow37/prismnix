...
let
    ...
    in {
        ...
        "pkg-52.0.0" = _X7zrXW9o;
        "pkg-52.0.1" = _qgLZSjkw;
        "pkg-52.0.2" = _kQBt6geg;
        "pkg-52.0.3" = _7fYofmA8;
        "pkg-52.0.4" = _E69icRKO;
        "pkg-52.0.5" = _HzT18xHt;
        "pkg-52.0.6" = _SOBp96jA;
        "pkg-52.0.7" = _IX5tOafY;
        "pkg-53.0.0" = _TP6COMF8;
        "pkg-54.0.0" = _F89C16SX;
        "pkg-54.0.1" = _zaelJNeK;
        "pkg-54.0.2" = _GIqr7drQ;
        "pkg-55.0.0" = _KkrecMAD;
        "pkg-55.1.0" = _irCkqnJO;
        "pkg-55.1.1" = _316m7rBC;
        "pkg-55.1.2" = _G929HElo;
        "pkg-55.1.3" = _7uSVZq5o;
        "pkg-55.1.4" = _quvymUla;
        "pkg-55.1.5" = _RjjjslL3;
        "pkg-55.1.6" = _i9Ezvu5V;
        "pkg-56.0.0" = _It44capt;
        "pkg-56.0.1" = _Wz7m06cr;
        "pkg-56.0.2" = _CTP2gvKE;
        "pkg-57.0.0" = _AdG7DyZw;
        "pkg-57.1.0" = _F5d4Of6v;
        "pkg-57.1.1" = _xc96ZOLZ;
        "pkg-57.1.2" = _mihNumG7;
        "pkg-59.0.0" = _RIZvxfTK;
        "pkg-59.0.1" = _SYuMEr9w;
        "pkg-59.0.2" = _SOUaborJ;
        "pkg-58.0.0" = _wQMKCOTe;
        "pkg-58.1.0" = _XlXzYbCT;
        "pkg-58.1.1" = _sekiTZHB;
        "default" = _sekiTZHB;
    });
