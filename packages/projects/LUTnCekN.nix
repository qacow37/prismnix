...
let
    ...
    in {
        ...
        "pkg-48.0.3" = _hiplDY62;
        "pkg-48.1.0" = _O7LhkwlV;
        "pkg-48.2.0" = _bQ0vBWm5;
        "pkg-48.2.1" = _S13JBAOA;
        "pkg-49.0.4" = _NoENRTCl;
        "pkg-49.0.5" = _vqq2J1Yp;
        "pkg-49.0.6" = _gm0IRLMR;
        "pkg-49.0.7" = _i6pG0I4k;
        "pkg-49.0.8" = _NDQHa75Z;
        "pkg-49.1.0" = _JUUFeVMQ;
        "pkg-49.1.1" = _STsiNM9W;
        "pkg-49.1.2" = _8f7DNG5i;
        "pkg-49.1.3" = _5DQkMvC6;
        "pkg-49.2.0" = _abDeJb5b;
        "pkg-49.3.0" = _dJBgsxiG;
        "pkg-50.0.0pr1" = _szlCVtsW;
        "pkg-50.0.0pr2" = _GvpDTHIJ;
        "pkg-50.0.1" = _rB1oZk6g;
        "pkg-50.0.2" = _cbppN1ZJ;
        "pkg-50.1.0" = _8bGBe1rn;
        "pkg-50.1.1" = _ean278GA;
        "pkg-50.1.2" = _TanC8hOU;
        "pkg-50.1.3" = _HGKeve1F;
        "pkg-50.1.4" = _tShrxdOU;
        "pkg-51.0.0" = _wjpOnvQx;
        "pkg-51.0.1" = _FtW99eh4;
        "pkg-51.0.2" = _HLrafePq;
        "pkg-51.0.3" = _wxddi8MF;
        "pkg-51.0.4" = _37Xrsw7R;
        "pkg-52.0.0" = _2YdUtHHA;
        "pkg-52.0.1" = _LLb8d2jj;
        "pkg-52.0.2" = _M8Nv4KSy;
        "pkg-52.0.3" = _piVG5KpV;
        "pkg-52.0.4" = _xB51zZeI;
        "pkg-52.0.5" = _LZXAxO9V;
        "pkg-52.0.6" = _jG2g2GXe;
        "pkg-52.0.7" = _gPyPsVol;
        "pkg-52.0.8" = _kb8kBXmY;
        "pkg-52.1.0" = _2HeBJJCa;
        "pkg-52.1.1" = _UuDRmoio;
        "pkg-52.1.2" = _tbyWGHac;
        "pkg-52.1.3" = _7c4jS9AJ;
        "pkg-52.2.0" = _DFxu6cqN;
        "pkg-52.2.1" = _2ka0FIHc;
        "pkg-52.2.2" = _aC19kR7j;
        "pkg-52.3.0" = _aCRAw6Pu;
        "pkg-52.3.1" = _vjcA5KEo;
        "pkg-52.3.2" = _dXMyAnEf;
        "pkg-53.0.0" = _NAmGjUY1;
        "pkg-53.0.2" = _Kma0QCjn;
        "pkg-54.0.0" = _PkYHXQqe;
        "pkg-55.0.0" = _7dRmmPEL;
        "pkg-55.0.1" = _62vYmYdc;
        "pkg-55.0.2" = _ACPHGaHf;
        "pkg-55.0.3" = _v3FTHwM3;
        "pkg-55.0.4" = _xozmcgWm;
        "pkg-55.0.5" = _6nSJeXon;
        "pkg-56.0.0" = _hJaFs26H;
        "pkg-56.0.1" = _Y2IWYy3D;
        "pkg-56.0.3" = _4xGVl5Ev;
        "pkg-57.0.0" = _yceNZNkW;
        "pkg-57.0.1" = _ZnSnRqe9;
        "pkg-57.0.2" = _VKJCYb7j;
        "pkg-57.1.0" = _hFfDyT4Y;
        "pkg-57.1.1" = _gjXDEl5I;
        "pkg-57.1.2" = _xIF1BSld;
        "pkg-57.1.3" = _TAeGOduE;
        "pkg-59.0.0" = _5HgWFqMe;
        "pkg-59.0.1" = _4bNIEdSx;
        "pkg-59.0.2" = _ilbS0XZQ;
        "pkg-59.0.3" = _gC1UebIs;
        "pkg-59.0.4" = _nOg9prbL;
        "pkg-58.1.0" = _iPtaqLvB;
        "pkg-58.1.1" = _nAKlfnm0;
        "pkg-58.1.2" = _2PI7kgQ5;
        "pkg-58.1.3" = _YLjM9wYa;
        "default" = _YLjM9wYa;
    });
