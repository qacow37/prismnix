...
let
    ...
    in {
        ...
        "pkg-1.14.4-1.1.0" = _JEzcxVvA;
        "pkg-1.15.2-1.1.0" = _JbajrClQ;
        "pkg-1.16.5-1.1.0" = _Ct8wea16;
        "pkg-1.17.1-1.1.0" = _G0YoXwoq;
        "pkg-1.18.2-1.1.0" = _cBHXnGrl;
        "pkg-1.19.4-1.1.0" = _OMrEaEtR;
        "pkg-1.20-1.1.0" = _s0H0QMhi;
        "pkg-1.20.1-1.1.0" = _b9hyLtg7;
        "pkg-1.20.2-1.1.0" = _fuGo4b9N;
        "pkg-1.20.5-1.1.0" = _GDDtQOOI;
        "pkg-1.20.6-1.1.0" = _lNzdkFtE;
        "pkg-1.21-1.1.0" = _InPNXp3i;
        "pkg-1.21.1-1.1.0" = _i1yJAnIQ;
        "pkg-1.21.3-1.1.0" = _ksWuBebY;
        "pkg-1.21.5-1.1.0" = _OgkAiPKJ;
        "pkg-1.21.6-1.1.0" = _QE9zhlj7;
        "pkg-1.21.7-1.1.0" = _PUgEUkMD;
        "pkg-1.21.8-1.1.1" = _ExXhuDK6;
        "pkg-1.21.10-1.1.1" = _m22v9VT3;
        "pkg-1.21.11-1.1.1" = _MaN7Xk5l;
        "pkg-26.1-snapshot-10-1.1.1" = _ceNutvtU;
        "pkg-26.1-snapshot-11-1.1.1" = _bdDnJllz;
        "pkg-26.1-pre-1-1.1.1" = _QdtIAMml;
        "pkg-26.1-pre-2-1.1.1" = _mTJCjkYm;
        "pkg-1.14.4-1.1.2" = _UkI2Xqlf;
        "pkg-1.15.2-1.1.2" = _uTT45NVY;
        "pkg-1.17.1-1.1.2" = _woRtUpR1;
        "pkg-1.18.2-1.1.2" = _4eAF85kI;
        "pkg-1.16.5-1.1.2" = _oN6x1tLp;
        "pkg-26.1-1.1.2" = _KMevvEf2;
        "pkg-1.14.4-1.2.0" = _uqRjt0VR;
        "pkg-1.15.2-1.2.0" = _rKREnfDn;
        "pkg-1.16.5-1.2.0" = _aITU3181;
        "pkg-1.17.1-1.2.0" = _wUvKxjP1;
        "pkg-1.18.2-1.2.0" = _XND51bFp;
        "pkg-1.19.4-1.2.0" = _8cGnSgIR;
        "pkg-1.20.6-1.2.0" = _VEVgPCnT;
