...
let
    ...
    in {
        ...
        "pkg-1.20.1-6.1.1.5" = _2tCFTA3g;
        "pkg-1.18.2-3.1.2.1" = _zlGBHjUz;
        "pkg-1.19-1.19.2-4.1.2.0" = _fegDi6Ww;
        "pkg-1.19.4-5.0.2.0" = _ARRomJMS;
        "pkg-1.20.1-6.1.2.0" = _BgJNlmbN;
        "pkg-1.18.2-3.1.2.2" = _z0DUQeTC;
        "pkg-1.19-1.19.2-4.1.2.1" = _upZsA7Ni;
        "pkg-1.19.4-5.0.2.1" = _tJcdOPNK;
        "pkg-1.20.1-6.1.2.1" = _TqbeGJPN;
        "pkg-1.18.2-3.1.2.3" = _QRUvTPLM;
        "pkg-1.19-1.19.2-4.1.2.2" = _YiT9w1B6;
        "pkg-1.19.4-5.0.2.2" = _ASMRdX2U;
        "pkg-1.20.1-6.1.2.2" = _ExkG14eZ;
        "pkg-1.19-1.19.2-4.1.3.2" = _ma2PoNIL;
        "pkg-1.19.4-5.0.3.0" = _43XVkhZo;
        "pkg-1.20.1-6.1.2.3" = _UwEyQJv3;
        "pkg-1.19-1.19.2-4.1.3.3" = _ahnLUjSi;
        "pkg-1.19-1.19.2-4.1.4.0" = _Dy2RsHZk;
        "pkg-1.19-1.19.2-4.1.4.1" = _35ypQmMT;
        "pkg-1.19.4-5.0.3.1" = _spTHZsLV;
        "pkg-1.20.1-6.1.2.4" = _AYGSp9GV;
        "pkg-1.19-1.19.2-4.2.0.1" = _FCRxS4xJ;
        "pkg-1.19-1.19.2-4.2.0.2" = _u1ZasgPm;
        "pkg-1.19-1.19.2-4.2.0.3" = _vjbrjOmj;
        "pkg-1.19.4-5.1.0.1" = _aUYhKUv9;
        "pkg-1.20.1-6.2.0.1" = _n1MjGHo2;
        "pkg-1.19-1.19.2-4.2.0.4" = _2Y4LVLWG;
        "pkg-1.19-1.19.2-4.2.0.10" = _CVhfyS8i;
        "pkg-1.19-1.19.2-4.2.0.11" = _c6ELbevN;
        "pkg-1.19.2-4.2.0.13" = _qerxz8Id;
        "pkg-1.19.2-4.2.0.14" = _mD7npGOf;
        "pkg-1.19.2-4.2.0.15" = _tyPRs9Fe;
        "pkg-1.18.2-3.1.2.4" = _lL3u0AlP;
        "pkg-1.19.2-4.2.0.16" = _2uH8nZUp;
        "pkg-1.20.1-6.2.0.2" = _Q3XTByPW;
        "pkg-1.20.4-6.2.0.2" = _3xqdNNQK;
        "pkg-1.21-6.2.0.2" = _6WpzEoUt;
        "pkg-1.21-6.2.0.3" = _KvhjMlTe;
        "pkg-1.21-6.2.0.5" = _Z9F09rVt;
        "pkg-1.20.1-6.2.0.3" = _DmLzzfG1;
        "pkg-1.20.4-6.2.0.3" = _k1XE4q9Q;
        "pkg-1.21-6.2.0.6" = _t0QVnYI7;
        "pkg-1.21.1-6.2.0.6" = _tdvdkl2b;
        "pkg-1.21.1-6.2.0.7" = _9uHONm38;
        "pkg-1.19.2-4.2.0.17" = _fKpgNaKF;
        "pkg-1.20.1-6.2.0.4" = _fa9kyj5c;
        "pkg-1.20.4-6.2.0.4" = _c3rTdvG1;
        "pkg-1.21.1-6.2.0.9" = _tnKxzwd8;
        "pkg-1.19.2-4.2.0.18" = _pZjoJk77;
        "pkg-1.20.1-6.2.0.5" = _uEkvZexO;
        "pkg-1.20.4-6.2.0.5" = _3ZOgmf4X;
        "pkg-1.21.1-6.2.0.10" = _oc2R5UZN;
        "pkg-1.18.2-3.1.2.5" = _VdDf6RiC;
        "pkg-1.19.2-4.2.0.19" = _z2PCJ8dk;
        "pkg-1.20.1-6.2.0.6" = _x3tcOQ46;
        "pkg-1.21.1-6.2.0.12" = _glcYPb8z;
        "pkg-1.21.3-6.2.0.12" = _fn8CUu16;
        "pkg-1.19.2-4.2.0.20" = _XBhIECVB;
        "pkg-1.20.1-6.2.0.7" = _ik6Dahc3;
        "pkg-1.21.1-6.2.0.13" = _cqV7eSXp;
        "pkg-1.21.3-6.2.0.13" = _pqLYdeBA;
        "pkg-1.20.1-6.2.1.0" = _eeSznw1j;
        "pkg-1.21.1-6.2.1.0" = _GYAuFl9u;
        "pkg-1.21.3-6.2.1.0" = _ylck9dCK;
        "pkg-1.20.1-6.2.1.1" = _kexlQq0V;
        "pkg-1.21.1-6.2.1.1" = _G7el02tH;
        "pkg-1.21.3-6.2.1.1" = _SgShSVWZ;
        "pkg-1.21.1-6.2.1.2" = _1PBPdpf2;
        "pkg-1.21.3-6.2.1.2" = _ThNTkBGE;
        "pkg-1.20.1-6.2.1.2" = _Iy3BHTGE;
        "pkg-1.19.2-4.2.1.0" = _CzrRZ9bS;
        "pkg-1.20.1-6.2.3.0" = _Vne2ToAu;
        "pkg-1.21.1-6.2.2.0" = _KYIiKtkv;
        "pkg-1.19.2-4.2.1.1" = _5Ih5ZvRe;
        "pkg-1.21.4-6.2.1.3" = _C5eAE6WF;
        "pkg-1.20.1-6.2.3.1" = _Ce6XSyor;
        "pkg-1.20.1-1.0.0.0" = _4shVDw7p;
        "pkg-1.20.1-6.2.3.2" = _FJV1dSmg;
        "pkg-1.20.1-6.2.3.3" = _WTNqEbmf;
        "pkg-1.18.2-3.1.2.6" = _MpFNW4NX;
        "pkg-1.19.2-4.2.1.2" = _luqn5oYw;
        "pkg-1.20.1-6.2.3.4" = _rYsl6S9O;
        "pkg-1.18.2-3.1.2.8" = _r8X2u75Z;
        "pkg-1.19.2-4.2.1.3" = _galPYcS5;
        "pkg-1.20.1-6.2.3.5" = _MB7i1RUl;
        "pkg-1.21.1-6.2.2.1" = _II5Nmhgp;
        "pkg-1.18.2-3.1.2.9" = _GGepnX7u;
        "pkg-1.19.2-4.2.1.4" = _fxIS6dJd;
        "pkg-1.20.1-6.2.3.6" = _oHmPNI97;
        "pkg-1.20.1-6.2.4.1" = _NCeXJnlw;
        "pkg-1.21.1-6.2.3.0" = _uB84jROn;
        "pkg-1.20.1-6.2.4.2" = _RR8L9jhD;
        "pkg-1.21.1-6.2.3.1" = _GmU9soVx;
        "pkg-1.20.1-6.2.4.3" = _o3ePt224;
        "pkg-1.21.1-6.2.4.0" = _YFyqF5Ac;
        "pkg-1.21.1-6.2.4.3" = _owJhogQn;
        "pkg-1.21.1-6.3.0.0-FABRIC" = _beRSv0vm;
        "pkg-1.21.1-6.3.0.0-NEOFORGE" = _MTQzK107;
        "pkg-1.21.1-6.3.0.1-FABRIC" = _VDfWs7Ku;
        "pkg-1.21.1-6.3.0.1-NEOFORGE" = _2IazrSW4;
        "pkg-1.21.10-6.3.0.1-FABRIC" = _fNCjN2Bs;
        "pkg-1.21.10-6.3.0.1-NEOFORGE" = _ANilMIWW;
        "pkg-1.21.1-6.3.0.2-FABRIC" = _W4YIicDX;
        "pkg-1.21.1-6.3.0.2-NEOFORGE" = _AZSJGwLG;
        "pkg-1.21.10-6.3.0.2-FABRIC" = _VEnoKaEp;
        "pkg-1.21.10-6.3.0.2-NEOFORGE" = _AfgZuVP9;
        "pkg-1.21.1-6.3.1.0-FABRIC" = _WKHX7yFM;
        "pkg-1.21.1-6.3.1.0-NEOFORGE" = _eo7T54Py;
        "pkg-1.21.10-6.3.1.0-FABRIC" = _Wk0qB7Uv;
        "pkg-1.21.10-6.3.1.0-NEOFORGE" = _u5qgbGnq;
        "pkg-1.21.1-6.3.1.1-FABRIC" = _j1zzxJOH;
        "pkg-1.21.1-6.3.1.1-NEOFORGE" = _EhlridDJ;
        "pkg-1.21.10-6.3.1.1-FABRIC" = _YcE2FsRy;
        "pkg-1.21.10-6.3.1.1-NEOFORGE" = _IyxdsFY9;
        "pkg-1.20.1-6.2.4.4" = _fNOprQEK;
        "pkg-1.21.1-6.3.1.2-FABRIC" = _gnNZYRdq;
        "pkg-1.21.1-6.3.1.2-NEOFORGE" = _25aeKbOU;
        "pkg-1.21.10-6.3.1.2-FABRIC" = _pl7JEyl9;
        "pkg-1.21.10-6.3.1.2-NEOFORGE" = _sefvlvMS;
        "pkg-1.20.1-6.2.4.5" = _pg9B3CXH;
        "pkg-1.21.11-6.3.1.2-FABRIC" = _b5IC5Tsi;
        "pkg-1.21.11-6.3.1.2-NEOFORGE" = _fkbLMlFv;
        "pkg-1.21.10-6.3.1.3-FABRIC" = _v5JlRPrf;
        "pkg-1.21.10-6.3.1.3-NEOFORGE" = _fuTLrt3o;
        "pkg-1.21.11-6.3.1.3-FABRIC" = _bN3XaZCO;
        "pkg-1.21.11-6.3.1.3-NEOFORGE" = _WSdVFuki;
        "pkg-1.21.11-6.3.1.4-FABRIC" = _Jix0OoCn;
        "pkg-1.21.11-6.3.1.4-NEOFORGE" = _UEAbDyO5;
        "pkg-1.21.11-6.3.1.5-FABRIC" = _HI4C1e7j;
        "pkg-1.21.11-6.3.1.5-NEOFORGE" = _sgbpPQJR;
        "pkg-1.21.11-6.3.2.0-FABRIC" = _9V1qCV8L;
        "pkg-1.21.11-6.3.2.0-NEOFORGE" = _f1G6cRBR;
        "pkg-1.21.10-6.3.2.0-FABRIC" = _FdziKotX;
        "pkg-1.21.10-6.3.2.0-NEOFORGE" = _MPXNikYq;
        "pkg-1.21.10-6.3.2.1-FABRIC" = _PJtsMLFt;
        "pkg-1.21.10-6.3.2.1-NEOFORGE" = _MP2JKd7h;
        "pkg-1.21.11-6.3.2.1-FABRIC" = _mAPu896K;
        "pkg-1.21.11-6.3.2.1-NEOFORGE" = _bhYztaTV;
        "pkg-26.1.1-6.3.2.1-FABRIC" = _tQADBB6n;
        "pkg-26.1.1-6.3.2.1-NEOFORGE" = _lxOCo0hp;
        "pkg-1.21.1-6.3.1.3-FABRIC" = _U3imcZbO;
        "pkg-1.21.1-6.3.1.3-NEOFORGE" = _oAnLkIS9;
        "pkg-26.1.2-6.3.2.1-FABRIC" = _jLgPAmtV;
        "pkg-26.1.2-6.3.2.1-NEOFORGE" = _Dt81LfGa;
        "pkg-26.1.2-6.3.2.2-FABRIC" = _gobephOb;
        "pkg-26.1.2-6.3.2.2-NEOFORGE" = _mk1pPOES;
        "pkg-26.1.2-6.3.2.3-FABRIC" = _1rKMMYyF;
        "pkg-26.1.2-6.3.2.3-NEOFORGE" = _z3Bb5OfV;
        "pkg-26.1.2-6.3.2.4-FABRIC" = _up2vPHiS;
        "pkg-26.1.2-6.3.2.4-NEOFORGE" = _dF5RCfde;
        "pkg-1.21.1-6.3.1.4-FABRIC" = _7Om3slKM;
        "pkg-1.21.1-6.3.1.4-NEOFORGE" = _VVFFHMnT;
        "pkg-26.1.2-6.3.2.5-FABRIC" = _IWua02nW;
        "pkg-26.1.2-6.3.2.5-NEOFORGE" = _PJjsXDwT;
        "pkg-26.1.2-6.3.2.6-FABRIC" = _PAJxLIeP;
        "pkg-26.1.2-6.3.2.6-NEOFORGE" = _54NrjH9j;
        "pkg-1.21.1-6.3.1.5" = _ifet2gr1;
