...
let
    ...
    in {
        ...
        "pkg-0.1.6" = _LHUdi8A7;
        "pkg-0.1.7" = _HGIqCwVx;
        "pkg-0.1.8.1" = _rFpL3x6R;
        "pkg-0.2" = _FfcAcvCO;
        "pkg-0.1.9.1" = _QVuQqHfi;
        "pkg-0.2.5" = _fWJXTJ4j;
        "pkg-0.3.0" = _ZopGKUns;
        "pkg-0.3.0.1" = _ZAdcdYj9;
        "pkg-0.3.0.2" = _Corz4OBb;
        "pkg-0.3.0.3" = _2F4IeJS3;
        "pkg-0.3.1" = _ZeqoW6AU;
        "pkg-0.1.1-neoforge" = _LTsPepNM;
        "pkg-0.1.1.1-neoforge" = _6rPoNNG7;
        "pkg-0.1.2-neoforge" = _GFkMKksh;
        "pkg-0.1.2.1-neoforge" = _ZwGjGEOj;
        "pkg-0.2.5.2" = _7xSVX6Py;
        "pkg-0.1.2.2-neoforge" = _bDKZTska;
        "pkg-0.3.2-fabric" = _4KEfJPHI;
        "pkg-0.1.3-neoforge" = _M3uGMhGd;
        "pkg-0.1.3.1-neoforge" = _6ieFvLdP;
        "pkg-0.1.3.2-neoforge" = _Ybvh4AVr;
        "pkg-0.1.4-neoforge" = _RTRYPIJp;
        "default" = _RTRYPIJp;
    });
