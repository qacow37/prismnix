...
let
    ...
    in {
        ...
        "pkg-1.19.4-1.4.3" = _l1CU5HAF;
        "pkg-1.4.3" = _QgM2Oqyk;
        "pkg-1.19.4-1.4.4" = _XoKO2xuy;
        "pkg-1.18.2-1.4.4" = _EBzuP60v;
        "pkg-1.19.4-1.4.4.1" = _sjeJfBpO;
        "pkg-1.19.2-1.4.4.1" = _jYBvr1Te;
        "pkg-1.4.4.1" = _YF9pzR1G;
        "pkg-1.19.2-1.4.4.2" = _LFhLHK3Z;
        "pkg-1.19.4-1.4.4.2" = _tu5THRdA;
        "pkg-1.20.1-1.4.4.2" = _iyEtB1EB;
        "pkg-1.18.2-1.4.4.2" = _KBXxHUcz;
        "pkg-1.5" = _CXIyS369;
        "pkg-1.5.1" = _8qokxZaV;
        "pkg-1.5.2" = _FIODiJxi;
        "pkg-1.6" = _5ugbqqs7;
        ...
        "pkg-1.7.1" = _AoQDrVPU;
        "pkg-1.7.2" = _2F0mvgPY;
        "pkg-1.7.2LTS" = _twBRLLDE;
        "pkg-1.8" = _JZoRV7Lb;
        "pkg-1.8.1" = _1sCYGOfj;
        "pkg-1.8.2LTS" = _rxmrcQ9c;
        "pkg-1.8.2" = _dVgwWeEE;
        "pkg-1.9" = _CmR8rlV7;
        "pkg-1.9LTS" = _2PTnP0C4;
        "pkg-1.9.1" = _WA2yKHEi;
        "pkg-1.9.1LTS" = _4J68TATw;
        "pkg-1.9.2" = _WoFaTE9o;
        "pkg-1.9.2.1" = _Uvs0dL5A;
        "pkg-1.9.2.1LTS" = _5E8gTBTf;
        "pkg-1.9.3LTS" = _DDhQxn8s;
        "pkg-1.9.3" = _Se2JgjrL;
        "pkg-1.9.4" = _yx7SeEnH;
        "pkg-1.9.4a" = _4w5jI6G6;
        "pkg-1.9.4.craftmine.beta.1" = _ja6PGwek;
        "pkg-1.9.4.craftmine.beta.2" = _VgDEUHAR;
        "pkg-1.9.4.craftmine.release.1" = _ugK7YIEu;
        "pkg-craftmine.1.0.1" = _I5rkSL5P;
        "pkg-craftmine-1.0.2" = _7mbeX1xU;
        "pkg-2.0.0" = _bA1eq6c8;
        "pkg-2.0.1" = _cx5B4Q0k;
        "default" = _cx5B4Q0k;
    });
