...
let
    ...
    in {
        ...
        "pkg-0.0.1-beta.6+3.1.4+1.20.1" = _Aa9rzVhB;
        "pkg-0.0.1-beta.6+3.1.4+1.21.7" = _ygV7b9ea;
        "pkg-0.0.1-beta.6+3.1.4+1.8.9" = _nGGNo35m;
        "pkg-0.0.1-beta.6+3.1.4+1.21.1" = _E3MLMZQr;
        "pkg-0.0.1-beta.7+3.1.5+1.8.9" = _nOW5l7hd;
        "pkg-0.0.1-beta.7+3.1.5+1.21.1" = _qZgJqNAK;
        "pkg-0.0.1-beta.7+3.1.5+1.21.8" = _NqZQziiM;
        "pkg-0.0.1-beta.7+3.1.5+1.20.1" = _hzBFNEsn;
        "pkg-0.0.1-beta.8+3.1.5+1.8.9" = _cVdZpikn;
        "pkg-0.0.1-beta.8+3.1.5+1.21.8" = _ZKkaHOY3;
        "pkg-0.0.1-beta.8+3.1.5+1.20.1" = _e95Fud2R;
        "pkg-0.0.1-beta.8+3.1.5+1.21.1" = _OZpzUrHW;
        "pkg-0.0.1-beta.9+3.1.5+1.8.9" = _iBHdI4jh;
        "pkg-0.0.1-beta.9+3.1.5+1.21.8" = _FvfT81YL;
        "pkg-0.0.1-beta.9+3.1.5+1.20.1" = _wh6y9Ons;
        "pkg-0.0.1-beta.9+3.1.5+1.21.1" = _cutqqK6B;
        "pkg-0.0.1-beta.10+3.1.5+1.8.9" = _45xQqKi4;
        "pkg-0.0.1-beta.10+3.1.5+1.21.1" = _Y5qbUP1n;
        "pkg-0.0.1-beta.10+3.1.5+1.21.8" = _7fV22BUD;
        "pkg-0.0.1-beta.10+3.1.5+1.20.1" = _ubssYd17;
        "pkg-0.0.1-beta.11+3.1.5+1.8.9" = _Gucx21iY;
        "pkg-0.0.1-beta.11+3.1.5+1.20.1" = _HgGiUVSx;
        "pkg-0.0.1-beta.11+3.1.5+1.21.1" = _yRzHcQc3;
        "pkg-0.0.1-beta.11+3.1.5+1.21.8" = _V3HG81pw;
        "pkg-0.0.1-beta.12+3.1.5+1.8.9" = _awTvROYv;
        "pkg-0.0.1-beta.12+3.1.5+1.20.1" = _np0F9coS;
        "pkg-0.0.1-beta.12+3.1.5+1.21.1" = _wIVYPZUx;
        "pkg-0.0.1-beta.12+3.1.5+1.21.8" = _I0ZwJAsl;
        "pkg-0.0.1-beta.13+3.1.5+1.8.9" = _FYAL3n6O;
        "pkg-0.0.1-beta.13+3.1.5+1.20.1" = _7sE3vhVv;
        "pkg-0.0.1-beta.13+3.1.5+1.21.8" = _ZEEkSFXt;
        "pkg-0.0.1-beta.13+3.1.5+1.21.1" = _bM2cMHri;
        "pkg-0.0.1-beta.14+3.1.5+1.8.9" = _GDPDL31J;
        "pkg-0.0.1-beta.14+3.1.5+1.20.1" = _MYBv0HxQ;
        "pkg-0.0.1-beta.14+3.1.5+1.21.8" = _LqeWp3St;
        "pkg-0.0.1-beta.14+3.1.5+1.21.1" = _AtL9a7RR;
        "pkg-0.0.1-beta.15+3.1.5+1.8.9" = _eFGydg6y;
        "pkg-0.0.1-beta.15+3.1.5+1.20.1" = _tN3CSIr1;
        "pkg-0.0.1-beta.15+3.1.5+1.21.8" = _VfB2OCFn;
        "pkg-0.0.1-beta.15+3.1.5+1.21.1" = _fFPd56VM;
        "pkg-0.0.1-beta.16+3.1.5+1.8.9" = _qh43SP3H;
        "pkg-0.0.1-beta.16+3.1.5+1.20.1" = _W8qzjQ4u;
        "pkg-0.0.1-beta.16+3.1.5+1.21.1" = _nm3SptKn;
        "pkg-0.0.1-beta.16+3.1.5+1.21.8" = _awFkclfF;
        "pkg-0.0.1-beta.17+3.1.5+1.8.9" = _6hxnQB7Z;
        "pkg-0.0.1-beta.17+3.1.5+1.21.8" = _4hF3tMGz;
        "pkg-0.0.1-beta.17+3.1.5+1.21.1" = _m87WkPdF;
        "pkg-0.0.1-beta.17+3.1.5+1.20.1" = _6hXUqk8j;
        "pkg-0.0.1-beta.18+3.1.5+1.8.9" = _svQymXEl;
        "pkg-0.0.1-beta.18+3.1.5+1.21.8" = _VdvXAu4I;
        "pkg-0.0.1-beta.18+3.1.5+1.21.1" = _NSeWUdkh;
        "pkg-0.0.1-beta.18+3.1.5+1.20.1" = _shP2EQlA;
        "pkg-0.0.1-beta.19+3.1.5+1.8.9" = _35NeAKdG;
        "pkg-0.0.1-beta.19+3.1.5+1.20.1" = _V2Evz4ZN;
        "pkg-0.0.1-beta.19+3.1.5+1.21.1" = _jazYhXel;
        "pkg-0.0.1-beta.19+3.1.5+1.21.8" = _56ke2xKq;
        "pkg-0.0.1-beta.20+3.1.5+1.8.9" = _l4gEu0Tl;
        "pkg-0.0.1-beta.20+3.1.5+1.21.1" = _WP09pEi1;
        "pkg-0.0.1-beta.20+3.1.5+1.20.1" = _JirM2nPA;
        "pkg-0.0.1-beta.20+3.1.5+1.21.8" = _ttKC1huq;
        "pkg-0.0.1+3.1.5+1.8.9" = _Ra5BooNC;
        "pkg-0.0.1+3.1.5+1.20.1" = _8pn2DDXa;
        "pkg-0.0.1+3.1.5+1.21.1" = _Y4f8yS1D;
        "pkg-0.0.1+3.1.5+1.21.8" = _TLZel0KO;
        "pkg-0.0.2+3.1.6+1.8.9" = _6jqqlFNs;
        "pkg-0.0.2+3.1.6+1.21.1" = _hTxE48BR;
        "pkg-0.0.2+3.1.6+1.21.10" = _7fAU7VwC;
        "pkg-0.0.2+3.1.6+1.20.1" = _Sa1uoOXt;
        "pkg-0.0.2+3.1.8+1.20.1" = _sTIr6UN3;
        "pkg-0.0.2+3.1.8+1.8.9" = _Rf1Xf0fn;
        "pkg-0.0.2+3.1.8+1.21.1" = _OLb4bw5x;
        "pkg-0.0.2+3.1.8+1.21.11" = _Px59T0xL;
        "pkg-0.0.3+3.1.8+1.21.1" = _UoAZb0YA;
        "pkg-0.0.3+3.1.8+1.20.1" = _dkUSpE8c;
        "pkg-0.0.3+3.1.8+1.21.11" = _hAKgnReb;
        "pkg-0.0.3+3.1.8+1.8.9" = _wYncBniX;
        "pkg-0.0.4+3.2.0+1.8.9" = _xxFFkQdU;
        "pkg-0.0.4+3.2.0+1.20.1" = _lCwkyJ31;
        "pkg-0.0.4+3.2.0+1.21.1" = _xlfHe947;
        "pkg-0.0.4+3.2.0+1.21.11" = _SLwQqoCN;
        "pkg-0.0.4+3.2.0+26.1" = _jhWmiXz8;
        "pkg-0.0.4+3.2.0+26.2" = _Q4fXj5dG;
        "default" = _Q4fXj5dG;
    });
