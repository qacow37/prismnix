...
let
    ...
    in {
        ...
        "pkg-0.3.3+1.20.1" = _ktnV6FgF;
        "pkg-0.3.4+1.20.4" = _cSAtR7Ue;
        "pkg-0.3.4+1.20.1" = _86ULJRuO;
        "pkg-0.3.5+1.20.1" = _pMo4p2B3;
        "pkg-0.3.5+1.20.4" = _ueI6nEWE;
        "pkg-0.3.4-SNAPSHOT+1.20.6" = _nMvZfcoi;
        "pkg-0.3.4-SNAPSHOT+1.21" = _PmsQdAsb;
        "pkg-0.4-SNAPSHOT+1.21" = _jz4FuEZC;
        "pkg-0.5.0+1.20.1" = _xMPBiklG;
        "pkg-0.5.0+1.20.6" = _Ahf6WiKI;
        "pkg-0.5.0+1.20.4" = _jpecue9O;
        "pkg-0.5.0+1.21" = _YB3UFt2C;
        "pkg-0.5.1+1.21" = _F0HRIt4h;
        "pkg-0.5.2+1.21" = _yoBWqgSB;
        "pkg-0.6.1+1.21" = _5oKj4e3n;
        "pkg-0.6.2+1.21" = _6AP2cnMO;
        "pkg-0.7.0+1.21-1.21.1" = _m9hEZRfy;
        "pkg-0.7.1+1.21" = _zPvEDOQy;
        "pkg-0.7.2+1.21" = _WdyvdFkC;
        "pkg-0.7.3+1.21" = _EebrbJA6;
        "pkg-0.7.4+1.21-1.21.1" = _oPQJ9drW;
        "pkg-0.8.0+1.21" = _cUpq9VFY;
        "pkg-0.8.1+1.21" = _X3n2wej2;
        "pkg-0.8.2+1.21" = _LNStpPRf;
        "pkg-0.8.3+1.21" = _sG0gSeNx;
        "pkg-0.8.4+1.21" = _QN4TH7B6;
        "pkg-0.8.5+1.21" = _6tmYKrOw;
        "pkg-0.8.6+1.21" = _kZ5Wuup9;
        "pkg-0.8.6+24w40a" = _AcKXqXRb;
        "pkg-0.9.0+1.21" = _eV9qqHJm;
        "pkg-0.9.1+1.21" = _KFIQFiwo;
        "pkg-0.9.2+1.21" = _NfI5h37a;
        "pkg-0.9.3+1.21" = _b2v0zAak;
        "pkg-0.9.3+1.21.2-rc1" = _cIqpb7KE;
        "pkg-0.9.3+1.21.2" = _10X1SUoE;
        "pkg-0.9.4+1.21" = _1TaYpKT3;
        "pkg-0.9.4+1.21.2" = _W7yWdewq;
        "pkg-0.9.5+1.21.2" = _fdQWJtsm;
        "pkg-0.9.6+1.21.2" = _mZAt25tB;
        "pkg-0.9.6+1.21" = _UF00x07B;
        "pkg-0.9.7+1.21" = _c7WbafQ4;
        "pkg-0.9.7+1.21.2" = _h4xogIi9;
        "pkg-0.9.8+1.21" = _h8mwM2aT;
        "pkg-0.9.9+1.21" = _PYORp1p0;
        "pkg-0.9.9+1.21.2-1.21.3" = _TouSr1si;
        "pkg-0.9.10+1.21.2" = _Hqk15tX2;
        "pkg-0.9.10+1.21" = _EE22qOnr;
        "pkg-0.9.11+1.21" = _IpTRzj2a;
        "pkg-0.9.11+1.21.2" = _hhIpKFnC;
        "pkg-0.9.12+1.21" = _2dqxwuWP;
        "pkg-0.9.12+1.21.2" = _EZn6xvAn;
        "pkg-0.9.13+1.21.1" = _LPgULlwr;
        "pkg-0.9.13+1.21.2" = _Wd6Lprrf;
        "pkg-0.9.14+1.21.1" = _jl0oJo9K;
        "pkg-0.9.14+1.21.2" = _KQ6dpG8w;
        "pkg-0.9.14+1.21.4" = _QTlwx2l0;
        "pkg-0.10.0+1.21.1" = _JHY93z2Z;
        "pkg-0.10.0+1.21.2" = _x7iPZXKn;
        "pkg-0.10.0+1.21.4" = _h1L7dzNo;
        "pkg-0.10.1+1.21.4" = _S17wsb2g;
        "pkg-0.10.1+build.2+1.21.4" = _sX2Y21Ih;
        "pkg-0.10.2+1.21.1" = _lqVYEqnl;
        "pkg-0.10.2+1.21.2" = _hMEbzT9F;
        "pkg-0.10.2+1.21.4" = _ag28iyZR;
        "pkg-0.10.3+1.21.1" = _IHugCFAO;
        "pkg-0.10.3+1.21.2" = _voKIlxUr;
        "pkg-0.10.3+1.21.4" = _sy3ztYHM;
        "pkg-0.10.4+1.21.1" = _N7bNOodD;
        "pkg-0.10.4+1.21.2" = _tRsfns8J;
        "pkg-0.10.4+1.21.4" = _yIxjLdpY;
        "pkg-0.10.5+1.21.1" = _auPy9c9N;
        "pkg-0.10.5+1.21.2" = _C0RbWfCw;
        "pkg-0.10.5+1.21.4" = _6XGjrCpU;
        "pkg-0.10.6+1.21.1" = _bjeIgSXX;
        "pkg-0.10.6+1.21.2" = _SFlGAJrd;
        "pkg-0.10.6+1.21.4" = _SMg02Nqa;
        "pkg-0.10.7+1.21.1" = _J04myxho;
        "pkg-0.10.7+1.21.2" = _z45FPidx;
        "pkg-0.10.7+1.21.4" = _RRdeHkrk;
        "pkg-0.11.0+1.21.4" = _7KAm3Z7f;
        "pkg-0.11.1+1.21.1" = _sKhNI6AS;
        "pkg-0.11.1+1.21.4" = _stdwqCTR;
        "pkg-0.11.2+1.21.1" = _XsPawsji;
        "pkg-0.11.2+1.21.4" = _vVmlcKe3;
        "pkg-0.11.3+1.21.4" = _SwA5iMUr;
        "pkg-0.12.0+1.21.4" = _PGTuIXw9;
        "pkg-0.12.0+1.21.1" = _CbEu0awr;
        "pkg-0.12.1+1.21.1" = _ySzZBImI;
        "pkg-0.12.1+1.21.4" = _o7lDsTJe;
        "pkg-0.12.2+1.21.1" = _ftRFgzCq;
        "pkg-0.12.2+1.21.4" = _PqOCCa2T;
        "pkg-0.12.3+1.21.1" = _LxBlIfPQ;
        "pkg-0.12.3+1.21.4" = _8URCs128;
        "pkg-0.12.4+1.21.1" = _3GLmnqwq;
        "pkg-0.12.4+1.21.4" = _JUIqQflG;
        "pkg-0.12.5+1.21.1" = _phhdpmtF;
        "pkg-0.12.5+1.21.4" = _uoOViH2k;
        "pkg-0.12.6+1.21.1" = _whFj4XG0;
        "pkg-0.12.6+1.21.4" = _PbXwH8Aw;
        "pkg-0.13.0+1.21.1" = _6r4FFc6l;
        "pkg-0.13.0+1.21.4" = _M7GUsVJ2;
        "pkg-0.13.1+1.21.1" = _SPrWH5jb;
        "pkg-0.13.1+1.21.4" = _fXONAfvm;
        "pkg-0.14.0+1.21.1" = _ziwxP0Ts;
        "pkg-0.14.0+1.21.4" = _cVhpNR4j;
        "pkg-0.14.1+1.21.1" = _JbUfhHSU;
        "pkg-0.14.1+1.21.4" = _lrT8aNTl;
        "pkg-0.14.2+1.21.4" = _TdrMDatQ;
        "pkg-0.14.3+1.21.5" = _4n7HACrl;
        "pkg-0.15.0+1.21.4" = _9tVknrDS;
        "pkg-0.15.0+1.21.5" = _PUayWTX5;
        "pkg-0.15.1+1.21.4" = _RdRMsrJz;
        "pkg-0.15.1+1.21.5" = _yMAuJu51;
        "pkg-0.14.3+1.21.1" = _2Jmqze3w;
        "pkg-0.14.4+1.21.1" = _xU5ZUhG4;
        "pkg-0.16.0+1.21.5" = _TevAzqJ4;
        "pkg-0.16.1+1.21.5" = _oHynh6jf;
        "pkg-0.16.2+1.21.5" = _1RXJSynY;
        "pkg-0.16.3+1.21.5" = _Y7CIgsak;
        "pkg-0.17.0+1.21.5" = _78LaJvpK;
        "pkg-0.17.1+1.21.5" = _lQRNWPV7;
        "pkg-0.17.2+1.21.5" = _6TFcW7nB;
        "pkg-0.17.3+1.21.5" = _S4aKO1j1;
        "pkg-0.14.6+1.21.1" = _cT8d9FJ3;
        "pkg-0.17.4+1.21.5" = _fXCkd6vr;
        "pkg-0.17.6+1.21.5" = _LcoxSXn4;
        "pkg-0.14.7+1.21.1" = _5cXHF2rS;
        "pkg-0.17.7+1.21.5" = _pw610dX9;
        "pkg-0.18.0+1.21.6-pre2" = _Ty1IX7Vn;
        "pkg-0.17.8+1.21.5" = _FyVOkGTM;
        "pkg-0.14.8-beta.3+1.21.1" = _bCs2Qp54;
        "pkg-1.0.0-beta.1+1.21.6" = _nJ13BCV7;
        "pkg-1.0.0-beta.2+1.21.6" = _I7gpUg5H;
        "pkg-1.0.0-beta.3+1.21.6" = _HrtrrBjg;
        "pkg-1.0.0-beta.4+1.21.6" = _rnHDsbC6;
        "pkg-1.0.0-beta.5+1.21.6" = _HcJMtFBk;
        "pkg-1.0.0-beta.6+1.21.6" = _I1lUGlTV;
        "pkg-1.0.0-beta.7+1.21.6" = _r4TGmGuW;
        "pkg-1.0.0+1.21.6" = _FXAMBUqe;
        "pkg-1.0.1+1.21.6" = _Q7KzuX4g;
        "pkg-1.0.3+1.21.7" = _IPRSmIFK;
        "pkg-1.0.5+1.21.7" = _P242h5IW;
        "pkg-1.0.6+1.21.7" = _F1bmANzQ;
        "pkg-1.1.0+1.21.7" = _pCeGAj6X;
        "pkg-0.14.9+1.21.1" = _EpLhTBVC;
        "pkg-1.1.1+1.21.7" = _az1YlVJc;
        "pkg-1.1.2+1.21.7" = _cdY7YQEE;
        "pkg-0.14.10+1.21.1" = _357gorG7;
        "pkg-1.2.0+1.21.7" = _rAgcsrJu;
        "pkg-0.14.11+1.21.1" = _iIr1sOYo;
        "pkg-1.3.0+1.21.7" = _itY8X3d9;
        "pkg-1.3.1+1.21.7" = _H2yLR3Ko;
        "pkg-1.3.2+1.21.9-rc1" = _OgVX5sUq;
        "pkg-1.3.3+1.21.9" = _zLn6K3qq;
        "pkg-0.14.12+1.21.1" = _YYnU03kx;
        "pkg-1.3.5+1.21.7" = _cgUlzsv0;
        "pkg-1.3.5+1.21.9" = _GW0OsfRx;
        "pkg-1.3.6+1.21.7" = _Gve4niZg;
        "pkg-1.3.6+1.21.9" = _xMPLUq7n;
        "pkg-1.3.7+1.21.7" = _bgqmK66w;
        "pkg-1.3.7+1.21.9" = _zVk01QlY;
        "pkg-1.3.8+1.21.7" = _e6JHjJzv;
        "pkg-1.3.8+1.21.9" = _ehQZwEfe;
        "pkg-0.14.13+1.21.1" = _a0rzZFVX;
        "pkg-1.3.9+1.21.9" = _AQ6fpsJj;
        "pkg-1.3.10+1.21.1" = _BKmotSGP;
        "pkg-1.3.10+1.21.10" = _oBkk6Yk9;
        "pkg-1.3.11+1.21.1" = _ld7U90mE;
        "pkg-1.3.12+1.21.1" = _3EZZBpi4;
        "pkg-1.3.13+1.21.1" = _DBziPXoC;
        "pkg-1.3.14+1.21.1" = _eDyFWfSq;
        "pkg-1.3.15+1.21.1" = _wolAxO2X;
        "pkg-1.3.15+1.21.10" = _ulPj8yH0;
        "pkg-1.3.16+1.21.1" = _FyqVyrF7;
        "pkg-1.3.16+1.21.10" = _lVsppXZx;
        "pkg-1.3.17+1.21.1" = _q96Z3xoj;
        "pkg-1.3.17+1.21.10" = _WvPCrggR;
        "pkg-1.3.17+1.21.11" = _MyG1eWgR;
        "pkg-1.3.18+1.21.10" = _35FWZshn;
        "pkg-1.3.18+1.21.11" = _EbRri8l9;
        "pkg-1.3.20+1.21.10" = _NGX1jVdc;
        "pkg-1.3.20+1.21.11" = _mBm72Ocn;
        "pkg-1.3.17-patch1+1.21.1" = _OmZjiNm9;
        "pkg-1.3.17-patch2+1.21.1" = _Pz1R98lV;
        "pkg-1.3.17-patch3+1.21.1" = _X1oxiSGv;
        "pkg-1.3.21+1.21.11" = _vGhPhMTk;
        "pkg-1.3.22+1.21.1" = _fl9eWKsT;
        "pkg-1.3.22+1.21.11" = _Lu08IKJy;
        "pkg-1.3.22-patch1+1.21.1" = _LPpVgWGY;
        "pkg-1.4.0+1.21.11" = _lk5t4rsl;
        "pkg-1.4.1+26.1" = _TWRMXnF0;
        "pkg-1.4.4+26.1" = _F8RKyg3M;
        "pkg-1.4.5+26.1" = _sZ6kgyff;
        "pkg-1.4.6+26.1" = _DMJq9fx8;
        "pkg-1.4.7+26.1" = _oOdTkhls;
        "pkg-1.5.0+26.1" = _LwFe9pQL;
        "pkg-1.4.0-patch.2+1.21.11" = _qSWjck9d;
        "pkg-1.5.2+26.1" = _ViaOXauB;
        "pkg-1.5.3+26.1" = _kjT6mnSn;
