...
let
    ...
    in {
        ...
        "pkg-1.18.x-1.5.0" = _TBBMUG9r;
        "pkg-1.19-1.5.0" = _pG5NPlnE;
        "pkg-1.19-1.5.1" = _mzcT7MTa;
        "pkg-1.19.2-1.5.3" = _243ESwKL;
        "pkg-1.5.5" = _9AXNr0QH;
        "pkg-1.5.6" = _7FXb20M1;
        "pkg-1.5.7" = _MrJhmT55;
        "pkg-193.0.1" = _1xacIWvm;
        "pkg-193.1.0" = _l88z20nu;
        "pkg-193.1.1" = _umIMH7nh;
        "pkg-192.0.0" = _YsDqsLoB;
        "pkg-193.1.2" = _ccnqllV5;
        "pkg-192.1.0" = _ftpbGARS;
        "pkg-193.2.0" = _qLYGesDs;
        "pkg-193.2.1" = _Hxb0TdO6;
        "pkg-193.2.2" = _N2JveFUL;
        "pkg-192.2.0" = _AMqWHq6z;
        "pkg-192.2.1" = _mkSBPVio;
        "pkg-193.2.3" = _3nBkrqCu;
        "pkg-182.0.0" = _qC5vnv9F;
        "pkg-182.0.2" = _JMrqdKRS;
        "pkg-194.3.0" = _CNkfvfgA;
        "pkg-194.4.0" = _IU2NpQdC;
        "pkg-194.4.1" = _p9vyGSUA;
        "pkg-194.4.2" = _3v7NKbwy;
        "pkg-194.4.3" = _PXjUBLOF;
        "pkg-194.4.4" = _q2ipKuqv;
        "pkg-194.4.5" = _b3ZL3st2;
        "pkg-194.4.6" = _mjlFxkfG;
        "pkg-194.5.0" = _lyjYrZZr;
        "pkg-194.5.1" = _yAnJTT2l;
        "pkg-201.5.1" = _MTvcOi4I;
        "pkg-201.5.2" = _AKNqioZO;
        "pkg-201.5.3" = _Xuy9EuwZ;
        "pkg-201.5.4" = _Qo2u33Ns;
        "pkg-201.5.5" = _C3BmhD5L;
        "pkg-202.5.6" = _SuJk5vFM;
        "pkg-202.5.7" = _rIcsIYC8;
        "pkg-202.6.0" = _lXK3AMbd;
        "pkg-203.6.0" = _7uhNBAzE;
        "pkg-204.6.1" = _3Y4dmZD1;
        "pkg-202.6.2" = _AWV0aVEo;
        "pkg-204.6.2" = _TC2Pejkl;
        "pkg-202.6.3" = _LPwnOOhD;
        "pkg-202.6.4" = _CJSA1rj9;
        "pkg-204.6.4" = _DFrrKCKP;
        "pkg-204.6.5" = _taEC8YQD;
        "pkg-206.6.5" = _ECh8lQdZ;
        "pkg-210.6.5" = _B91cShwU;
        "pkg-210.6.5.1" = _7ZefzlQj;
        "pkg-201.5.6" = _qGRpQZNY;
        "pkg-206.6.6" = _mFNwP2dV;
        "pkg-211.6.7" = _RaPF8LqB;
        "pkg-211.6.8" = _fg4SYeqU;
        "pkg-211.6.9" = _bpymkDNH;
        "pkg-213.6.9" = _mZBQP94c;
        "pkg-214.6.10" = _EQvrprMd;
        "pkg-214.6.11" = _GA6xeN9U;
        "pkg-214.6.12" = _K4gphpI9;
        "pkg-214.6.14" = _1hzsOtom;
        "pkg-215.6.14" = _FCFnpHOa;
        "pkg-204.6.10-secure" = _utHSsPTQ;
        "pkg-206.6.7-secure" = _EFOZURiS;
        "pkg-211.6.9-secure" = _a6Wyit4Y;
        "pkg-214.6.14-secure" = _gJxTOzD8;
        "pkg-215.6.14-secure" = _e7zhRzsQ;
        "pkg-216.6.15" = _Tb9gWfQ0;
        "pkg-215.6.15" = _XdkOQ4T2;
        "pkg-217.6.16" = _ILMkWywG;
        "pkg-216.6.16" = _Wod1lsz2;
        "pkg-215.6.16" = _1VRxlvuW;
        "pkg-8.0-alpha.1+1.20.1-fabric" = _RwzR8odP;
        "pkg-8.0-alpha.1+1.20.2-fabric" = _eGb9UoPl;
        "pkg-8.0-alpha.1+1.20.4-fabric" = _PTFb7BAr;
        "pkg-8.0-alpha.1+1.20.6-fabric" = _iTEpC3KD;
        "pkg-8.0-alpha.1+1.21.1-fabric" = _W9oeQ6YV;
        "pkg-8.0-alpha.1+1.21.4-fabric" = _IQYIa2mK;
        "pkg-8.0-alpha.1+1.21.5-fabric" = _FdfiSqCi;
        "pkg-8.0-alpha.1+1.21.6-fabric" = _7M07nl8Y;
        "pkg-8.0-alpha.1+1.21.7-fabric" = _TPGiNuiM;
        "pkg-8.0-alpha.2+1.20.1-fabric" = _NmzcJw1l;
        "pkg-8.0-alpha.2+1.20.2-fabric" = _LmOkPa3j;
        "pkg-8.0-alpha.2+1.20.4-fabric" = _I8L2HQ0V;
        "pkg-8.0-alpha.2+1.20.6-fabric" = _IuQV9R4C;
        "pkg-8.0-alpha.2+1.21.1-fabric" = _uHFkyYGX;
        "pkg-8.0-alpha.2+1.21.4-fabric" = _QiuZwSHM;
        "pkg-8.0-alpha.2+1.21.5-fabric" = _K76fJMQg;
        "pkg-8.0-alpha.2+1.21.6-fabric" = _i4TEPIac;
        "pkg-8.0-alpha.2+1.21.8-fabric" = _hPqE3W8Q;
        "pkg-8.0-alpha.3+1.20.1-fabric" = _cO5XgxKI;
        "pkg-8.0-alpha.3+1.20.2-fabric" = _O09MGkT0;
        "pkg-8.0-alpha.3+1.20.4-fabric" = _b3giESGr;
        "pkg-8.0-alpha.3+1.20.6-fabric" = _uOI3C9sr;
        "pkg-8.0-alpha.3+1.21.1-fabric" = _XemFuAwv;
        "pkg-8.0-alpha.3+1.21.4-fabric" = _ZF68IPZ7;
        "pkg-8.0-alpha.3+1.21.5-fabric" = _b8VahcWF;
        "pkg-8.0-alpha.3+1.21.6-fabric" = _3NsCUJVS;
        "pkg-8.0-alpha.3+1.21.8-fabric" = _N503TQdu;
        "pkg-8.0-alpha.4+1.20.1-fabric" = _Wa4gUsd7;
        "pkg-8.0-alpha.4+1.20.2-fabric" = _lQpPHyLy;
        "pkg-8.0-alpha.4+1.20.4-fabric" = _A36lo5tG;
        "pkg-8.0-alpha.4+1.20.6-fabric" = _iXHVwPQv;
        "pkg-8.0-alpha.4+1.21.1-fabric" = _SlSMkeDH;
        "pkg-8.0-alpha.4+1.21.4-fabric" = _31ZQHvxm;
        "pkg-8.0-alpha.4+1.21.5-fabric" = _VBCq2wYx;
        "pkg-8.0-alpha.4+1.21.6-fabric" = _EUvjPu6c;
        "pkg-8.0-alpha.4+1.21.8-fabric" = _vLhkHfDo;
        "pkg-8.0-alpha.5+1.20.1-fabric" = _lKEO9kul;
        "pkg-8.0-alpha.5+1.20.2-fabric" = _U0GxJ8OK;
        "pkg-8.0-alpha.5+1.20.4-fabric" = _kHgP6pGX;
        "pkg-8.0-alpha.5+1.20.6-fabric" = _Uzud52se;
        "pkg-8.0-alpha.5+1.21.1-fabric" = _yqCVgE2Z;
        "pkg-8.0-alpha.5+1.21.4-fabric" = _yByRPgua;
        "pkg-8.0-alpha.5+1.21.5-fabric" = _JbfuIp5L;
        "pkg-8.0-alpha.5+1.21.6-fabric" = _mRRJ2Bic;
        "pkg-8.0-alpha.5+1.21.8-fabric" = _mNmuDtjy;
        "pkg-8.0-alpha.5+1.21.10-fabric" = _ilGw104s;
        "pkg-8.0-alpha.6+1.20.1-fabric" = _rFqd1A66;
        "pkg-8.0-alpha.6+1.20.2-fabric" = _P3CNc76P;
        "pkg-8.0-alpha.6+1.20.4-fabric" = _paMFgmoZ;
        "pkg-8.0-alpha.6+1.20.6-fabric" = _Xen6npEu;
        "pkg-8.0-alpha.6+1.21.1-fabric" = _PREyJMQN;
        "pkg-8.0-alpha.6+1.21.4-fabric" = _tV41c8gF;
        "pkg-8.0-alpha.6+1.21.5-fabric" = _LGoeo7yQ;
        "pkg-8.0-alpha.6+1.21.6-fabric" = _NiHNEJe3;
        "pkg-8.0-alpha.6+1.21.8-fabric" = _VuX1THAF;
        "pkg-8.0-alpha.6+1.21.10-fabric" = _58jlJewZ;
        "pkg-8.0-alpha.7+1.20.1-fabric" = _96H9dSv5;
        "pkg-8.0-alpha.7+1.20.2-fabric" = _AgpoaPTk;
        "pkg-8.0-alpha.7+1.20.4-fabric" = _zZNW3FkP;
        "pkg-8.0-alpha.7+1.20.6-fabric" = _YgcKJLWE;
        "pkg-8.0-alpha.7+1.21.1-fabric" = _rR1zwu4V;
        "pkg-8.0-alpha.7+1.21.4-fabric" = _VCqt6jeV;
        "pkg-8.0-alpha.7+1.21.5-fabric" = _E6lXDcYl;
        "pkg-8.0-alpha.7+1.21.6-fabric" = _Y6WuE0Nx;
        "pkg-8.0-alpha.7+1.21.8-fabric" = _2kh67Tem;
        "pkg-8.0-alpha.7+1.21.10-fabric" = _D36wvTmc;
        "pkg-8.0-alpha.7+1.21.11-fabric" = _49fhleVN;
        "pkg-8.0-alpha.8+1.20.1-fabric" = _D1dBdn6u;
        "pkg-8.0-alpha.8+1.20.2-fabric" = _GGNMxVqv;
        "pkg-8.0-alpha.8+1.20.4-fabric" = _8eTsvuzh;
        "pkg-8.0-alpha.8+1.20.6-fabric" = _Eb5BGpyY;
        "pkg-8.0-alpha.8+1.21.1-fabric" = _t5pTDAz1;
        "pkg-8.0-alpha.8+1.21.4-fabric" = _zhAef8Sf;
        "pkg-8.0-alpha.8+1.21.5-fabric" = _36KydlCX;
        "pkg-8.0-alpha.8+1.21.6-fabric" = _NG41nesT;
        "pkg-8.0-alpha.8+1.21.8-fabric" = _qm9AjvTz;
        "pkg-8.0-alpha.8+1.21.10-fabric" = _Vl89V05I;
        "pkg-8.0-alpha.8+1.21.11-fabric" = _4TNAPaVq;
        "pkg-8.0-alpha.8+26.1-fabric" = _OBeXtfrq;
        "pkg-8.0-alpha.9+1.20.1-fabric" = _yILRImzl;
        "pkg-8.0-alpha.9+26.1.2-fabric" = _qyYyrZZa;
        "pkg-8.0-alpha.9+1.21.1-fabric" = _TLYJfH0h;
        "pkg-8.0-alpha.9+1.21.5-fabric" = _oaDiP2qn;
        "pkg-8.0-alpha.9+1.21.8-fabric" = _JaOgPYLZ;
        "pkg-8.0-alpha.9+1.21.10-fabric" = _UCiwrHMd;
        "pkg-8.0-alpha.9+26.2-fabric" = _pveyRYML;
        "pkg-8.0-alpha.9+1.21.11-fabric" = _EYhZ10lX;
        "pkg-8.0-alpha.10+1.20.1-fabric" = _SgKeOszX;
        "pkg-8.0-alpha.10+1.21.1-fabric" = _g6UfYs8u;
        "pkg-8.0-alpha.10+1.21.5-fabric" = _xCLHJSKC;
        "pkg-8.0-alpha.10+1.21.8-fabric" = _KZ1cmY6Z;
        "pkg-8.0-alpha.10+1.21.10-fabric" = _LFI7TGtu;
        "pkg-8.0-alpha.10+1.21.11-fabric" = _gPWR3aWi;
        "pkg-8.0-alpha.10+26.1.2-fabric" = _WkegsqJ8;
        "pkg-8.0-alpha.10+26.2-fabric" = _tcMHDdnC;
        "pkg-8.0-alpha.11+1.20.1-fabric" = _La8YU14Y;
        "pkg-8.0-alpha.11+1.21.1-fabric" = _VRPAQrSm;
        "pkg-8.0-alpha.11+1.21.5-fabric" = _oSwRINUk;
        "pkg-8.0-alpha.11+1.21.8-fabric" = _9x9AixxR;
        "pkg-8.0-alpha.11+1.21.10-fabric" = _7mBtsf10;
