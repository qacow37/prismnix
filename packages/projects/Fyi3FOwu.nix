...
let
    ...
    in {
        ...
        "pkg-1.1.3" = _qCTfh00H;
        "pkg-1.1.4" = _DOR2BExv;
        "pkg-1.1.4+mod" = _d0OJxmQD;
        "pkg-1.1.5" = _Pxsn4HLr;
        "pkg-1.1.5+mod" = _PWA0Q9By;
        "pkg-1.1.6" = _16cYzOD3;
        "pkg-1.1.6+mod" = _doNkY3xU;
        "pkg-1.1.7" = _QFY9ptCj;
        "pkg-1.1.7+fabric" = _NdL9OxQP;
        "pkg-1.1.7+neoforge" = _9U6rZcn1;
        "pkg-1.1.8" = _K8XKaWCL;
        "pkg-1.1.8+mod" = _YiiyymJ3;
        "pkg-1.2" = _aV303Ktu;
        "pkg-1.2+mod" = _cZmx9NLr;
        "default" = _cZmx9NLr;
    });
