...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _p3CefGT8;
        "pkg-1.0.2" = _zwZMGWBW;
        "pkg-2.0.0-alpha.1" = _W0g4Rf6U;
        "pkg-2.0.0-alpha.2" = _sil8u0Pn;
        "pkg-2.0.0-beta.1" = _xryKb5vS;
        "pkg-2.0.0-beta.2" = _JQrzrsRW;
        "pkg-2.0.0" = _ey50m2Ri;
        "pkg-2.1.0-beta.1+mc1.20.x" = _hHel3A1h;
        "pkg-2.1.0-beta.2+mc1.20.x" = _4PVqDYYW;
        "pkg-2.1.0+mc1.20.x" = _SGsOHArv;
        "pkg-2.2.0-alpha.1+mc1.20.x" = _84pALEKw;
        "pkg-2.2.0-beta.1+mc1.20.x" = _vGbH0Vci;
        "pkg-2.2.0+mc1.20.4" = _OfGswtgx;
        "pkg-2.2.0+mc1.20.6" = _so4mEjz9;
        "pkg-2.3.0-alpha.1+mc1.20.4" = _NhE8aehz;
        "pkg-2.3.0-alpha.1+mc1.20.5" = _fSl1Nzx7;
        "pkg-2.3.0-alpha.1+mc1.21" = _h8i7PGGM;
        "pkg-2.3.0-alpha.2+mc1.20.4" = _OaTJoZPZ;
        "pkg-2.3.0-alpha.2+mc1.20.5" = _UVyI6nsE;
        "pkg-2.3.0-alpha.2+mc1.21" = _ATlcUskQ;
        "pkg-2.3.0+mc1.20.4" = _OOc3WFkr;
        "pkg-2.3.0+mc1.20.5" = _jLO17aiS;
        "pkg-2.3.0+mc1.21" = _iziPH9oo;
        "pkg-2.3.1+mc1.20.4" = _YEpzt6C7;
        "pkg-2.3.1+mc1.20.5" = _oP8jBRXT;
        "pkg-2.3.1+mc1.21" = _OHH6QKdv;
        "pkg-2.3.3+mc1.20.4" = _9E98fRW4;
        "pkg-2.3.3+mc1.20.5" = _RV2DWRUe;
        "pkg-2.3.3+mc1.21" = _5whljHrB;
        "pkg-2.3.4-beta.1+mc1.20.4" = _a0wWDWz7;
        "pkg-2.3.4-beta.1+mc1.20.5" = _m8a109o5;
        "pkg-2.3.4-beta.1+mc1.21" = _cISNuyXO;
        "pkg-2.3.4+mc1.20.4" = _3favhDJH;
        "pkg-2.3.4+mc1.20.5" = _Gp3aUW9x;
        "pkg-2.3.4+mc1.21" = _uowJDifa;
        "pkg-2.3.4+mc1.21.2" = _VWAQ3RMd;
        "pkg-3.0.0-alpha.1+mc1.21-neoforge" = _98DigVX3;
        "pkg-3.0.0-alpha.1+mc1.20.1-fabric" = _WtT56QYR;
        "pkg-3.0.0-alpha.1+mc1.21.4-neoforge" = _a5zhmFMk;
        "pkg-3.0.0-alpha.1+mc1.20.1-forge" = _JilT5GwX;
        "pkg-3.0.0-alpha.1+mc1.21-fabric" = _nWlJi7b3;
        "pkg-3.0.0-alpha.1+mc1.21.4-fabric" = _enJPSf9X;
        "pkg-3.0.0-alpha.2+mc1.21.4-fabric" = _ZEQOPPEJ;
        "pkg-3.0.0-alpha.2+mc1.21.4-neoforge" = _KiceACl1;
        "pkg-3.0.0-alpha.2+mc1.21-neoforge" = _CM85kLaj;
        "pkg-3.0.0-alpha.2+mc1.21-fabric" = _MYQHdnW7;
        "pkg-3.0.0-alpha.2+mc1.20.1-fabric" = _hdw80hcf;
        "pkg-3.0.0-alpha.2+mc1.20.1-forge" = _F1D2mnzH;
        "pkg-3.0.0-alpha.3+mc1.21.4-neoforge" = _dozk3OWn;
        "pkg-3.0.0-alpha.3+mc1.21-fabric" = _N0YL9Cna;
        "pkg-3.0.0-alpha.3+mc1.20.1-forge" = _OkhgDQV8;
        "pkg-3.0.0-alpha.3+mc1.21-neoforge" = _1B3uysVx;
        "pkg-3.0.0-alpha.3+mc1.20.1-fabric" = _U0px7MSL;
        "pkg-3.0.0-alpha.3+mc1.21.4-fabric" = _flyFTG62;
        "pkg-3.0.0-alpha.4+mc1.21.4-neoforge" = _fqoN9RnC;
        "pkg-3.0.0-alpha.4+mc1.21-fabric" = _djAijVgP;
        "pkg-3.0.0-alpha.4+mc1.21.4-fabric" = _wSQ5XvKl;
        "pkg-3.0.0-alpha.4+mc1.21-neoforge" = _zwCjA0uj;
        "pkg-3.0.0-alpha.4+mc1.20.1-forge" = _jKMFDQhP;
        "pkg-3.0.0-alpha.4+mc1.20.1-fabric" = _Nd9S0gOZ;
        "pkg-3.0.0-alpha.5+mc1.20.1-fabric" = _jWR5G6lH;
        "pkg-3.0.0-alpha.5+mc1.21.4-neoforge" = _rUEpNvD5;
        "pkg-3.0.0-alpha.5+mc1.20.1-forge" = _dBOwLBfB;
        "pkg-3.0.0-alpha.5+mc1.21-fabric" = _yYF4UkMl;
        "pkg-3.0.0-alpha.5+mc1.21.4-fabric" = _AUYF8maV;
        "pkg-3.0.0-alpha.5+mc1.21-neoforge" = _ziNWn82b;
        "pkg-3.0.0-alpha.6+mc1.21-neoforge" = _HP1MShGC;
        "pkg-3.0.0-alpha.6+mc1.21.4-neoforge" = _QUjxZUFb;
        "pkg-3.0.0-alpha.6+mc1.20.1-forge" = _i8iATATf;
        "pkg-3.0.0-alpha.6+mc1.21.4-fabric" = _ahJqYL9b;
        "pkg-3.0.0-alpha.6+mc1.21-fabric" = _IjjpejM9;
        "pkg-3.0.0-alpha.6+mc1.20.1-fabric" = _MBf1Mr6j;
        "pkg-3.0.0-alpha.7+mc1.21-neoforge" = _8vcSVOY2;
        "pkg-3.0.0-alpha.7+mc1.20.1-forge" = _y6XPhUG7;
        "pkg-3.0.0-alpha.7+mc1.20.1-fabric" = _OS3JJLDI;
        "pkg-3.0.0-alpha.7+mc1.21.4-neoforge" = _yNNyWVpx;
        "pkg-3.0.0-alpha.7+mc1.21-fabric" = _6ffQYzkz;
        "pkg-3.0.0-alpha.7+mc1.21.4-fabric" = _ktvvReUs;
        "pkg-3.0.0-alpha.8+mc1.20.1-fabric" = _MGKuDcvh;
        "pkg-3.0.0-alpha.8+mc1.21.4-neoforge" = _3ZOopHdD;
        "pkg-3.0.0-alpha.8+mc1.21-neoforge" = _GDZvKLPY;
        "pkg-3.0.0-alpha.8+mc1.20.1-forge" = _ufcX6lKY;
        "pkg-3.0.0-alpha.8+mc1.21-fabric" = _vDXR81Wf;
        "pkg-3.0.0-alpha.8+mc1.21.4-fabric" = _qxHWgJnA;
        "pkg-3.0.0-alpha.9+mc1.20.1-fabric" = _4JLKWz4l;
        "pkg-3.0.0-alpha.9+mc1.21-neoforge" = _iCeKArzV;
        "pkg-3.0.0-alpha.9+mc1.21.4-neoforge" = _87UuhAbC;
        "pkg-3.0.0-alpha.9+mc1.21.4-fabric" = _SfDz4mtM;
        "pkg-3.0.0-alpha.9+mc1.20.1-forge" = _pNQSjV1t;
        "pkg-3.0.0-alpha.9+mc1.21-fabric" = _YZ4crdEX;
        "pkg-3.0.0-alpha.9+mc1.21.5-fabric" = _9xKGtNEX;
        "pkg-3.0.0-alpha.10+mc1.20.1-fabric" = _4hZbhBrK;
        "pkg-3.0.0-alpha.10+mc1.21-neoforge" = _F0CntR9T;
        "pkg-3.0.0-alpha.10+mc1.21.4-fabric" = _ysJqSOHZ;
        "pkg-3.0.0-alpha.10+mc1.21.5-fabric" = _x2uvJ2pb;
        "pkg-3.0.0-alpha.10+mc1.20.1-forge" = _1u2X2ra7;
        "pkg-3.0.0-alpha.10+mc1.21-fabric" = _nxAp4Wpw;
        "pkg-3.0.0-alpha.10+mc1.21.6-fabric" = _LditacJd;
        "pkg-3.0.0-alpha.11+mc1.21.1-neoforge" = _U24uOxAd;
        "pkg-3.0.0-alpha.11+mc1.20.1-fabric" = _d81Vpv8E;
        "pkg-3.0.0-alpha.11+mc1.20.1-forge" = _oL09G4D7;
        "pkg-3.0.0-alpha.11+mc1.21.1-fabric" = _VN7hBfES;
        "pkg-3.0.0-alpha.11+mc1.21.4-fabric" = _oxdWL3op;
        "pkg-3.0.0-alpha.11+mc1.21.5-fabric" = _h0z8muB2;
        "pkg-3.0.0-alpha.11+mc1.21.6-fabric" = _am2WnMM9;
        "pkg-3.0.0-alpha.12+mc1.21.1-neoforge" = _FHfWwaQE;
        "pkg-3.0.0-alpha.12+mc1.21.1-fabric" = _WAmoDkUU;
        "pkg-3.0.0-alpha.12+mc1.20.1-fabric" = _C66m20Nf;
        "pkg-3.0.0-alpha.12+mc1.21.4-fabric" = _rf4qMcwG;
        "pkg-3.0.0-alpha.12+mc1.21.6-fabric" = _9hwUbiK3;
        "pkg-3.0.0-alpha.12+mc1.21.5-fabric" = _ALPuq5KL;
        "pkg-3.0.0-alpha.12+mc1.20.1-forge" = _xfgfisIh;
        "pkg-3.0.0-beta.1+mc1.21.1-neoforge" = _jReb68sG;
        "pkg-3.0.0-beta.1+mc1.21.1-fabric" = _ERmGuKcL;
        "pkg-3.0.0-beta.1+mc1.21.6-fabric" = _XUSDN641;
        "pkg-3.0.0-beta.1+mc1.21.4-fabric" = _YQgM7PPI;
        "pkg-3.0.0-beta.1+mc1.21.5-fabric" = _lztPM5bW;
        "pkg-3.0.0-beta.1+mc1.20.1-forge" = _hsXE797w;
        "pkg-3.0.0-beta.1+mc1.20.1-fabric" = _xtrOey1j;
        "pkg-3.0.0-beta.1+mc1.21.9-fabric" = _jUlXH7kZ;
        "pkg-3.0.0+mc1.21.1-neoforge" = _euoKWzF4;
        "pkg-3.0.0+mc1.20.1-fabric" = _RVg38Uik;
        "pkg-3.0.0+mc1.21.1-fabric" = _pyCIpUIw;
        "pkg-3.0.0+mc1.21.6-fabric" = _fkRz8kHg;
        "pkg-3.0.0+mc1.21.9-fabric" = _wR27qyO8;
        "pkg-3.0.0+mc1.20.1-forge" = _DYE1LjLu;
        "pkg-3.0.0+mc1.21.11-fabric" = _zyWyhnDS;
        "pkg-3.0.1+mc1.21.1-fabric" = _el1y5aSO;
        "pkg-3.0.1+mc1.20.1-fabric" = _CFjsLwCy;
        "pkg-3.0.1+mc1.21.1-neoforge" = _4BrkHe7j;
        "pkg-3.0.1+mc1.20.1-forge" = _KmhOlVGR;
        "pkg-3.0.1+mc1.21.11-fabric" = _THfiVv8l;
        "pkg-3.0.1+mc1.21.9-fabric" = _qAGpD7AK;
        "pkg-3.0.1+mc1.21.6-fabric" = _lvaCjUbC;
        "default" = _lvaCjUbC;
    });
