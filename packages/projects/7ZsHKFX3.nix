...
let
    ...
    in {
        ...
        "pkg-2.0.8" = _2YHsdgXX;
        "pkg-2.0.9" = _blRSHzC2;
        "pkg-2.0.10" = _4Q0QTcO8;
        "pkg-2.0.11" = _KCV6B95L;
        "pkg-2.0.12" = _3iybPjjd;
        "pkg-3.0.0" = _IZoKTOjm;
        "pkg-3.0.1" = _uL1OuBmr;
        "pkg-2.0.13" = _2nZq7gOx;
        "pkg-4.0.0" = _OOVgTF1K;
        "pkg-4.0.1" = _SASJ1r5p;
        "pkg-3.0.2" = _vjEc5NNq;
        "pkg-4.0.2" = _jqPzrNjV;
        ...
        "pkg-4.0.8" = _o0TAn0ju;
        "pkg-4.0.9" = _fMhTDZW1;
        "pkg-4.0.10" = _oQYyBjna;
        "pkg-4.0.11" = _Mif17vZC;
        "pkg-4.0.12" = _uu4ZB5sf;
        "pkg-4.0.13" = _zH16MWcR;
        "pkg-4.0.14" = _c4SkGpTQ;
        "pkg-4.0.15" = _mt4ngsFv;
        "pkg-4.0.16" = _aK6PUAYm;
        "pkg-4.0.17" = _BxjEjylb;
        "pkg-4.0.18" = _dT0xn4cU;
        "pkg-4.0.19" = _B1WJKWgW;
        "pkg-4.0.20.4" = _Kv58X32q;
        "pkg-4.0.20.5" = _YkE9jdi8;
        "pkg-4.0.20.11" = _bwLUzXub;
        "default" = _bwLUzXub;
    });
