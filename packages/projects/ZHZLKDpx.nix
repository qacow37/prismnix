...
let
    ...
    in {
        ...
        "pkg-v.2.0.0+mod" = _RwQVy7W9;
        "pkg-v.2.1.0" = _LQhiQhFI;
        "pkg-v.2.1.0+mod" = _eszRExd4;
        "pkg-v.2.2.0" = _qshUJbnB;
        "pkg-v.2.2.0+mod" = _E2PkNbZk;
        "pkg-v2.0.0" = _4rhByWal;
        "pkg-v2.0.0+mod" = _Bb4JnQbz;
        "pkg-v2.2.1" = _Kk8x0iDW;
        "pkg-v2.2.1+mod" = _SDEpheXg;
        "pkg-v2.3.1" = _aWrQ8XrY;
        "pkg-v2.3.1+mod" = _aEDvbZmh;
        "pkg-v2.3.2" = _6I9kognB;
        "pkg-v2.3.2+mod" = _PLaR6Isz;
        "pkg-v2.3.3" = _OJXU6Ldl;
        "pkg-v2.3.3+mod" = _GBzjTlBd;
        "pkg-v2.3.4" = _yW9uuEyn;
        "pkg-v2.3.4+mod" = _DSAAW9vq;
        "pkg-v2.3.4.1" = _bSUorVjz;
