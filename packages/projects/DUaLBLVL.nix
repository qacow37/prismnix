...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _1DHBzWz3;
        "pkg-v4.0.2-1.19.2-Forge" = _potVedzz;
        "pkg-v4.0.2-1.19.2-Fabric" = _AmQ2BX0a;
        "pkg-v4.0.3-1.19.2-Fabric" = _AP8rAhCy;
        "pkg-v4.0.3-1.19.2-Forge" = _gELPLr5L;
        "pkg-v4.0.4-1.19.2-Fabric" = _e2xCnn6z;
        "pkg-v4.0.4-1.19.2-Forge" = _4m6QC5Xu;
        "pkg-v4.0.5-1.19.2-Fabric" = _gv1hI5KK;
        "pkg-v4.0.5-1.19.2-Forge" = _w77PW9bT;
        "pkg-v4.0.6-1.19.2-Fabric" = _q82mRj3N;
        "pkg-v4.0.6-1.19.2-Forge" = _tpFlcIJb;
        "pkg-v4.0.7-1.19.2-Fabric" = _fBSEYzN4;
        "pkg-v4.0.7-1.19.2-Forge" = _sKl3DcXw;
        "pkg-v4.0.8-1.19.2-Fabric" = _kTuxkjw6;
        "pkg-v4.0.8-1.19.2-Forge" = _LtHlXmcy;
        "pkg-v5.0.0-1.19.3-Fabric" = _JPPSUZSA;
        "pkg-v5.0.0-1.19.3-Forge" = _5au5b5qi;
        "pkg-v6.0.0-1.19.4-Forge" = _uPMTx5cK;
        "pkg-v6.0.0-1.19.4-Fabric" = _gzeyELvf;
        "pkg-v7.0.0-1.20-Forge" = _6Em9jcAK;
        "pkg-v7.0.0-1.20-Fabric" = _A2Bx8qQG;
        "pkg-v8.0.0-1.20.1-Forge" = _pqT6h2Eb;
        "pkg-v8.0.0-1.20.1-Fabric" = _RkAZUbPE;
        "pkg-v8.0.1-1.20.1-Forge" = _QQKfj8ye;
        "pkg-v8.0.1-1.20.1-Fabric" = _tSperk8u;
        "pkg-v3.0.0-1.18.2-Forge" = _qF4Cx6nI;
        "pkg-v3.0.0-1.18.2-Fabric" = _MuI9ERJT;
        "pkg-v20.4.0-1.20.4-Fabric" = _t2WG9PJ9;
        "pkg-v20.4.0-1.20.4-Forge" = _a8BhjgEL;
        "pkg-v20.4.0-1.20.4-NeoForge" = _qGK74yc5;
        "pkg-v20.4.1-1.20.4-Fabric" = _BIFZKKe8;
        "pkg-v20.4.1-1.20.4-Forge" = _rhJM9Hhk;
        "pkg-v20.4.1-1.20.4-NeoForge" = _mTGUf8eh;
        "pkg-v21.0.0-1.21-Fabric" = _QT6YreEo;
        "pkg-v21.0.0-1.21-NeoForge" = _7M17ENZQ;
        "pkg-v21.1.0-1.21.1-Fabric" = _IgpDL3U7;
        "pkg-v21.1.0-1.21.1-NeoForge" = _VmjxNG8x;
        "pkg-v21.3.0-1.21.3-Fabric" = _PfkivyWY;
        "pkg-v21.3.0-1.21.3-NeoForge" = _jqR9bWO6;
        "pkg-v21.4.0-1.21.4-Fabric" = _qJ21OCzm;
        "pkg-v21.4.0-1.21.4-NeoForge" = _QLczNuNp;
        "pkg-v21.4.1-1.21.4-Fabric" = _Syd6BW8k;
        "pkg-v21.4.1-1.21.4-NeoForge" = _F0cHZaLB;
        "pkg-v21.5.0-1.21.5-Fabric" = _4LyRIOoH;
        "pkg-v21.5.0-1.21.5-NeoForge" = _S86iP5Lf;
        "pkg-v21.5.1-1.21.5-Fabric" = _etYfOblY;
        "pkg-v21.5.1-1.21.5-NeoForge" = _451PqasA;
        "pkg-v8.0.2-1.20.1-Forge" = _BDQJ0bR5;
        "pkg-v8.0.2-1.20.1-Fabric" = _AhsqFptf;
        "pkg-v21.1.1-1.21.1-Fabric" = _SnEecxrB;
        "pkg-v21.1.1-1.21.1-NeoForge" = _d2L3RCzs;
        "pkg-v21.6.0-1.21.6-Fabric" = _QixWhkzj;
        "pkg-v21.6.0-1.21.6-NeoForge" = _b7w4ec5P;
        "pkg-v21.7.0-1.21.7-Fabric" = _RV9NNVZn;
        "pkg-v21.7.0-1.21.7-NeoForge" = _jKGEqSuA;
        "pkg-v21.8.0-1.21.8-Fabric" = _Lt4IyDwv;
        "pkg-v21.8.0-1.21.8-NeoForge" = _RkHvVPIQ;
        "pkg-v8.0.3-1.20.1-Forge" = _C73pXlBE;
        "pkg-v8.0.3-1.20.1-Fabric" = _3NdmZxor;
        "pkg-v21.1.2-1.21.1-Fabric" = _BAfZV3f0;
        "pkg-v21.1.2-1.21.1-NeoForge" = _abYjOQe6;
        "pkg-v21.8.1-1.21.8-Fabric" = _M7KwCFYc;
        "pkg-v21.8.1-1.21.8-NeoForge" = _OzEeMyQB;
        "pkg-21.9.0" = _jbzR2MYh;
        "pkg-21.10.0" = _1ZNJY2RN;
