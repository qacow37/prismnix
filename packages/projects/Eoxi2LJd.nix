...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20" = _NlvheuQ7;
        "pkg-1.0.0+1.20.2" = _Bm55zAsV;
        "pkg-1.0.1+1.20" = _vs3tCoK7;
        "pkg-1.0.1+1.20.2" = _70HUb5Z8;
        "pkg-1.0.2+1.20.2" = _PyEcwaOk;
        "pkg-1.0.2+1.20" = _awbk83Wo;
        "pkg-1.1.0+1.20" = _uxhYwZC4;
        "pkg-1.1.0+1.20.2" = _ioEVDEq6;
        "pkg-1.2.0+1.20.2" = _R7C9D7WE;
        "pkg-1.2.0+1.20" = _2zhcvrjC;
        "pkg-1.2.1+1.20.2" = _HFWW52oi;
        "pkg-1.2.1+1.20" = _I961AU6T;
        "pkg-1.3.0+1.20.1" = _zvngAyeg;
        "pkg-1.3.0+1.20.2" = _MTf8mYYG;
        "pkg-1.4.0+1.20.1" = _gxceji6a;
        "pkg-1.4.0+1.20.2" = _KAyA2HRt;
        "pkg-1.4.0+1.20.4" = _MtFhjqI1;
        "pkg-1.5.0+1.20.1" = _Ag7cEvX9;
        "pkg-1.5.0+1.20.4" = _X4pbzQ01;
        "pkg-1.5.0+1.20.2" = _Qws5dkxO;
        "pkg-1.6.0+1.21" = _Tzt5jAX1;
        "pkg-1.6.0+1.20.6" = _kAWLHz9F;
        "pkg-1.6.0+1.20.1" = _vchu5t50;
        "pkg-1.6.0+1.20.4" = _rIC7NMQO;
        "pkg-1.6.1+1.20.6" = _4yVYEdU2;
        "pkg-1.6.1+1.20.4" = _oyKYZZcB;
        "pkg-1.6.1+1.20.1" = _X2MFakfo;
        "pkg-1.6.1+1.21" = _bSAnHcjE;
        "pkg-2.0.0+1.21" = _mDVRfmqZ;
        "pkg-2.0.0+1.20.4" = _RSrAMheU;
        "pkg-2.0.0+1.20.6" = _otu0eUQE;
        "pkg-2.0.0+1.20.1" = _n5M2t2uD;
        "pkg-2.0.1+1.21" = _noiLXOZ1;
        "pkg-2.0.1+1.20.6" = _jGLKGs4c;
        "pkg-2.0.1+1.20.1" = _I4LG0cWl;
        "pkg-2.0.1+1.20.4" = _3f4uKyFk;
        "pkg-2.1.0+1.20.4" = _vNfp4wqs;
        "pkg-2.1.0+1.20.1" = _zDyNr4PN;
        "pkg-2.1.0+1.20.6" = _w5KUwZ4L;
        "pkg-2.1.0+1.21" = _njq5GseJ;
        "pkg-2.1.1+1.21" = _g8T7flgK;
        "pkg-2.1.1+1.20.1" = _lj4R9uLI;
        "pkg-2.1.1+1.20.4" = _EDpKgY8P;
        "pkg-2.1.1+1.20.6" = _rtfTvgKz;
        "pkg-2.1.2+1.20.6" = _ZZ3zZK1v;
        "pkg-2.1.2+1.20.1" = _XzyLedDH;
        "pkg-2.1.2+1.21" = _Qml1EqHb;
        "pkg-2.1.2+1.20.4" = _g99BnxqQ;
        "pkg-2.2.0+1.21" = _HcbVIxAm;
        "pkg-2.2.0+1.20.1" = _KrbfqB5y;
        "default" = _KrbfqB5y;
    });
