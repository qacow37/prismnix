...
let
    ...
    in {
        ...
        "pkg-V1.0-resource" = _wK1194Mw;
        "pkg-V1.0-data" = _x6BWbCrR;
        "pkg-V1.0-mod" = _X6dGwNgb;
        "pkg-V1.1-resource" = _EAx5TfeP;
        "pkg-V1.1-data" = _N15HaZFa;
        "pkg-V1.1-mod" = _IxoTbaGJ;
        "pkg-V1.1.1-resource" = _hCkJZsp8;
        "pkg-V1.1.1-data" = _oKev9WnF;
        "pkg-V1.1.1-mod" = _S7LSYlzm;
        "pkg-V1.1.2-resource" = _DGSnHoPG;
        "pkg-V1.1.2-data" = _qbWv6Ns3;
        "pkg-V1.1.2-mod" = _mo50nu8F;
        "pkg-V1.1.3-resource" = _mIHormLp;
        "pkg-V1.1.3-data" = _NF9lmUIU;
        "pkg-V1.1.3-mod" = _LHkNGKGG;
        "pkg-V1.1.4-resource" = _99qXCENN;
        "pkg-V1.1.4-data" = _VH6Lrueh;
        "pkg-V1.1.4-mod" = _re1fMMjT;
        "pkg-V1.1.5-resource" = _d5CFL7Ho;
        "pkg-V1.1.5-data" = _fLnLSKRa;
        "pkg-V1.1.5-mod" = _DEk1JAhP;
        "pkg-V1.1.6-resource" = _GLyE8XnH;
        "pkg-V1.1.6-data" = _9XisbIUe;
        "pkg-V1.1.6-mod" = _ZaZs3cvt;
        "pkg-V1.1.7-resource" = _go4qNLvi;
        "pkg-V1.1.7-data" = _7ADHOmKU;
        "pkg-V1.1.7-mod" = _17x7JyIY;
        "pkg-V1.1.8-resource" = _GqJQtlLa;
        "pkg-V1.1.8-data" = _jC3m24zu;
        "pkg-V1.1.8-mod" = _ozruN43X;
        "default" = _ozruN43X;
    });
