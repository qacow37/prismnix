...
let
    ...
    in {
        ...
        "pkg-3.0.0+1.19-fabric" = _8L4WBRE4;
        "pkg-3.0.1+1.19-fabric" = _wzQDigyh;
        "pkg-4.0.0-beta.1+1.19" = _7WzLceCq;
        "pkg-4.0.0-beta.2+1.19" = _F3ZUMLVd;
        "pkg-4.0.0-beta.3+1.19" = _iLIpUVzR;
        "pkg-4.0.0-beta.4+1.19" = _6jsLKVaL;
        "pkg-4.0.0-beta.5+1.19" = _WiY8QkZR;
        "pkg-4.0.0-beta.6+1.19" = _MtwYfuPb;
        "pkg-4.0.0-beta.7+1.19" = _XjKX2HUi;
        "pkg-4.0.0-beta.8+1.19" = _VSruIujc;
        "pkg-4.0.0-beta.9+1.19" = _DznfEWtF;
        "pkg-4.0.0-beta.10+1.19" = _pN4qLIeB;
        "pkg-4.0.0-beta.11+1.19" = _DHOvPjoI;
        "pkg-4.0.0-beta.12+1.19" = _WDCf381t;
        "pkg-4.0.0-beta.13+1.19" = _FY3r5llZ;
        "pkg-4.0.0-beta.14+1.19" = _KZgCvQTT;
        "pkg-4.0.0-beta.15+1.19" = _BnDb48bc;
        "pkg-4.0.0-beta.16+1.19" = _214ImIke;
        "pkg-4.0.0-beta.17+1.19" = _eEFz1oXs;
        "pkg-4.0.0-beta.18+1.19" = _CBRik1y8;
        "pkg-4.0.0-beta.19+1.19" = _N1MFhtB6;
        "pkg-4.0.0-beta.20+1.19" = _gZNjxkXw;
        "pkg-4.0.0-beta.21+1.19" = _LtlnBAId;
        "pkg-4.0.0-beta.22+1.19.3" = _27orlhzY;
        "pkg-4.0.0-beta.23+1.19.3" = _3xzTFwOr;
        "pkg-4.0.0-beta.24+1.19.3" = _ZzCC45Be;
        "pkg-4.0.0-beta.25+1.19.3" = _MZlY9h2n;
        "pkg-4.0.0-beta.26+1.19.3" = _OE6LDNKf;
        "pkg-4.0.0-beta.27+1.19.3" = _Bqdfhh8k;
        "pkg-4.0.0-beta.28+1.19.3" = _X5NkeKF9;
        "pkg-4.0.0-beta.29+1.19.3" = _Mvxja1U2;
        "pkg-4.0.0-beta.30+1.19.3" = _SGA8nlFJ;
        "pkg-4.0.0-beta.31+1.19.3" = _PS2fkUpW;
        "pkg-4.0.0-beta.32+1.19.3" = _uFi9zbFq;
        "pkg-4.0.0-beta.33+1.19.4" = _TVE0wX8X;
        "pkg-4.0.0-beta.34+1.19.4" = _5YXsiIva;
        "pkg-4.0.0+1.19.4" = _PEXwHxoh;
        "pkg-4.0.0+1.20" = _rL8AQPPX;
        "pkg-4.0.1+1.20" = _WxxMivTP;
        "pkg-5.0.0-alpha.1" = _5GUpSkCa;
        "pkg-5.0.0-alpha.2" = _n5ZhNRyH;
        "pkg-5.0.0-alpha.3" = _lNk5z6lE;
        "pkg-5.0.0-alpha.4" = _REzrvdOG;
        "pkg-5.0.0-alpha.5" = _kwGLZM7H;
        "default" = _kwGLZM7H;
    });
