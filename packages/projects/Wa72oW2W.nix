...
let
    ...
    in {
        ...
        "pkg-1.2.0" = _MIUUc9mQ;
        "pkg-1.2.1" = _BXU6EAaV;
        "pkg-1.18.2-1.2.2" = _oWbhi1md;
        "pkg-1.19-1.2.2" = _Gghg0kqc;
        "pkg-1.18.2-1.2.3" = _v75JdkoP;
        "pkg-1.19-1.2.3" = _b9lvsEQQ;
        "pkg-1.19.3-1.2.3" = _thdvjjgr;
        "pkg-1.18.2-1.2.4" = _2GCUGDLJ;
        "pkg-1.19-1.2.4" = _jV03BG0h;
        "pkg-1.19.3-1.2.4" = _KaPO9zkg;
        "pkg-1.19.4-1.2.5" = _p1eOSB9U;
        "pkg-1.19.2-1.2.5" = _V6cSjDNf;
        "pkg-1.20-1.2.6" = _61CQfJPF;
        "pkg-1.18.2-1.2.6" = _4G4STeCV;
        "pkg-1.19.2-1.2.6" = _4Adb39DY;
        "pkg-1.19-1.2.6" = _AdBJ4xOW;
        "pkg-1.19.3-1.2.6" = _pDQTcFmh;
        "pkg-1.19.4-1.2.6" = _fvG9qulz;
        "pkg-1.20-1.2.7" = _vaw7Vb8R;
        "pkg-1.20.2-1.2.8" = _IGnWnbNs;
        "pkg-1.20.4-1.2.8" = _ErZF1Cev;
        "pkg-1.20.6-1.2.8" = _NlEThsvA;
        "pkg-1.21-1.2.8" = _XAG8m7Hj;
        "default" = _XAG8m7Hj;
    });
