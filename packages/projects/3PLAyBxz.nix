...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.4-fabric" = _DZEhNppi;
        "pkg-1.18.2-2.4-fabric" = _6PeAKJDr;
        "pkg-1.19.2-2.5-fabric" = _v5sedBtQ;
        "pkg-1.16.5-2.4-forge" = _V1cEiNbL;
        "pkg-1.18.2-2.4-forge" = _WCRyOkx2;
        "pkg-1.19.2-2.4-forge" = _crdCdOwp;
        "pkg-1.16.5-2.6-fabric" = _mcKln5Py;
        "pkg-1.18.2-2.6-fabric" = _7H2lZZ7J;
        "pkg-1.19.2-2.6-fabric" = _7VJYNx3S;
        "pkg-1.19.3-2.7-fabric" = _72HXaa8w;
        "pkg-1.19.3-2.4-forge" = _P4Hqqx3m;
        "pkg-1.18.2-3.0-forge+fabric" = _achNxH1y;
        "pkg-1.19.2-3.0-forge+fabric" = _HTL0pumJ;
        "pkg-1.19.3-3.0-forge+fabric" = _Lonri7iW;
        "pkg-1.18.2-3.1-forge+fabric" = _cIQnr2zU;
        "pkg-1.19.2-3.1-forge+fabric" = _KoxvKzkn;
        "pkg-1.19.3-3.1-forge+fabric" = _gVsNA5LD;
        "pkg-1.19.4-3.1-forge+fabric" = _apKcA6TQ;
        "pkg-1.20-3.1-forge+fabric" = _2JXohXTI;
        "pkg-1.20.1-3.1-forge+fabric" = _cfNshH9q;
        "pkg-1.20.2-3.1-forge+fabric" = _HwUougdK;
        "pkg-1.18.2-3.2-forge+fabric" = _gQy5DKEU;
        "pkg-1.19.2-3.2-forge+fabric" = _nzLE6V4J;
        "pkg-1.20.1-3.2-forge+fabric" = _PsEU7cR9;
        "pkg-1.20.2-3.2-forge+fabric" = _HPf8fslM;
        "pkg-1.20.2-3.3-forge+fabric" = _lnycfWC3;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _NydNvPOk;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _ndu6DPgw;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _kBF8Cx1J;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _JZn3twT5;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _wkiPtGu0;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _kOHRb5rI;
        "pkg-1.19.2-3.5-fabric+forge" = _P6jDUvJE;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _Xo4NMpxH;
        "pkg-1.20.2-3.5-fabric+forge+neo" = _CktwrUJV;
        "pkg-1.20.4-3.5-fabric+forge+neo" = _ZbcwQ3F6;
        "pkg-1.20.5-3.5-fabric+neo" = _o6mrA1Lt;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _jpZnTIv6;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _1GFsU0fF;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _cvBIrG9w;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _bLkpOjv0;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _hPbM7q9G;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _2ojlvbJh;
        "pkg-1.20.6-3.7-fabric+forge+neo" = _qYqmnZjG;
        "pkg-1.21.0-3.7-fabric+forge+neo" = _y3wzQ03h;
        "pkg-1.21.1-3.7-fabric+forge+neo" = _u4GmuQ8n;
        "pkg-1.21.2-3.7-fabric+neo" = _l7Vh0Bbu;
        "pkg-1.21.3-3.7-fabric+forge+neo" = _ZgQzvMSt;
        "pkg-1.21.4-3.7-fabric+forge+neo" = _QKyPvApF;
        "pkg-1.21.5-3.7-fabric+forge+neo" = _zRibZtqY;
        "pkg-1.21.6-3.7-fabric+forge+neo" = _WnUSDqWa;
        "pkg-1.21.7-3.7-fabric+forge+neo" = _kLsi5Ch3;
        "pkg-1.21.8-3.7-fabric+forge+neo" = _tmU71N15;
        "pkg-1.21.9-3.7-fabric+forge+neo" = _D6JY9Ib0;
        "pkg-1.21.10-3.7-fabric+forge+neo" = _WZ2EHCie;
        "pkg-1.21.11-3.7-fabric+forge+neo" = _KzkF169B;
        "pkg-26.1.0-3.7-fabric+forge+neo" = _nFPEwkhN;
        "pkg-26.1.1-3.7-fabric+forge+neo" = _De2hgLbA;
        "pkg-26.1.2-3.7-fabric+forge+neo" = _EUl1ytvB;
        "pkg-26.2.0-3.7-fabric+forge+neo" = _MymmL3sV;
        "default" = _MymmL3sV;
    });
