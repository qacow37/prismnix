...
let
    ...
    in {
        ...
        "pkg-0.0.1-1.20.1" = _8FpiEbzc;
        "pkg-0.0.2-1.20.1" = _FTt3T4Zw;
        "pkg-0.0.3-1.20.1" = _YoAY4e57;
        "pkg-0.0.4-1.20.1" = _adr2mMyf;
        "pkg-0.0.5-1.20.1" = _CMKJAJ12;
        "pkg-0.0.6-1.20.1" = _SmOyTKYy;
        "pkg-0.0.7-1.20.1" = _1eK1MfxY;
        "pkg-0.0.8-1.20.1" = _EzqFwg9w;
        "pkg-0.0.9-1.20.1" = _OC2RmfHs;
        "pkg-0.1.0-1.20.1" = _CK858US2;
        "pkg-0.1.1-1.20.1" = _kIAfvDfx;
        "pkg-0.1.2-1.20.1" = _PVdnZ3X4;
        "pkg-0.1.3-1.20.1" = _ek3LIC9X;
        "pkg-0.1.4-1.20.1" = _sp9nDrPz;
        "pkg-0.1.5-1.20.1" = _5tlaM7YM;
        "pkg-0.1.6-1.20.1" = _SlbwzuEh;
        "pkg-0.1.6-hotfix-1.20.1" = _55DZrxXV;
        "pkg-0.1.6-1.21.1" = _yFtXHRU7;
        "pkg-0.1.6-neofroge-1.21.1" = _YNPNfBHf;
        "pkg-0.1.7-1.20.1" = _XFYILH9o;
        "pkg-0.1.7-1.21.1" = _52abzT9l;
        "pkg-0.1.7-neofroge-1.21.1" = _lms85HFr;
        "pkg-1.0.0-1.20.1" = _Vde2GtlC;
        "pkg-1.0.0-neofroge-1.21.1" = _K2D8ew4i;
        "pkg-1.0.1-1.20.1" = _bToxQySN;
        "pkg-1.0.1-neofroge-1.21.1" = _79cJi8lU;
        "default" = _79cJi8lU;
    });
