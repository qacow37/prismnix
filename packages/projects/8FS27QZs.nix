...
let
    ...
    in {
        ...
        "pkg-2.0r14_1.5.13H" = _WWnyOfEC;
        "pkg-2.0r14_1.5.13" = _FCdwPPSi;
        "pkg-2.0.0.2_1.5.15H" = _TOEGe7J0;
        "pkg-2.0.0.2_1.5.15" = _WwjyJb9G;
        "pkg-2.0.0.3_1.5.16.1H" = _a9CpAUbY;
        "pkg-2.0.0.3_1.5.16.1" = _2O4mj4XB;
        "default" = _2O4mj4XB;
    });
