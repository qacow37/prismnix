...
let
    ...
    in {
        ...
        "pkg-1.5" = _SH6RbjKe;
        "pkg-1.6" = _cFm7Zdv2;
        "pkg-1.18-1.6.0" = _5hJh4qSf;
        "pkg-1.18-1.6.1" = _hAEJ254R;
        "pkg-1.19-1.7.0" = _EAsQ1Rqg;
        "pkg-1.18-1.7.0" = _Xv2or2lB;
        "pkg-1.17-1.7.0" = _iUd1D5lx;
        "pkg-1.16-1.7.0" = _69ohJQN1;
        "pkg-1.18-1.8" = _66LtJeDx;
        "pkg-1.19.2-1.8" = _vOnkqoYm;
        "pkg-1.8.0" = _LEXIMrpP;
        "pkg-1.16.1-2.0.2" = _UJirhiyv;
        "pkg-1.17.1-2.0.2" = _nHyyNCqL;
        "pkg-1.18-2.0.2" = _oubGG8ML;
        "pkg-1.19-2.0.2" = _UCHfIo5T;
        "pkg-1.19.3-2.0.2" = _qIMV8YYK;
        "pkg-1.20.6-2.0.2" = _mKE0nRtM;
        "pkg-1.21-2.0.2" = _9j4YLgKx;
        "pkg-1.13.2-2.0.3" = _eBWvEY3n;
        "pkg-1.14.4-2.0.3" = _uYYNcYEE;
        "pkg-1.15-2.0.3" = _b7QIVb8x;
        "pkg-1.16.1-2.0.3" = _kSKDDqXe;
        "pkg-1.17.1-2.0.3" = _AW6p5qdF;
        "pkg-1.18-2.0.3" = _gk42eb0i;
        "pkg-1.19-2.0.3" = _G0oQtyG8;
        "pkg-1.19.3-2.0.3" = _VpA4roMg;
        "pkg-1.20.6-2.0.3" = _mY7NZaUC;
        "pkg-1.21-2.0.3" = _qdZORzuz;
        "pkg-1.21.3-2.0.3" = _jTp3R809;
        "pkg-1.21.4-2.0.3" = _2d7vtIf0;
        "default" = _2d7vtIf0;
    });
