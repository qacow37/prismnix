...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _LAuKeQzC;
        "pkg-1.1" = _gaQAVJq1;
        "pkg-1.1-neoforge-1.21.6" = _SzODTYd5;
        "pkg-1.1-fabric-1.21.6" = _9X9znDSY;
        "pkg-1.2-forge-1.21.1" = _9WDGQpO8;
        "pkg-1.2-neoforge-1.21.1" = _gGNKHuc2;
        "pkg-1.2-fabric-1.21.1" = _XOCxzBWF;
        "pkg-1.2-neoforge-1.21.4" = _t7ZLIV8r;
        "pkg-1.2-fabric-1.21.4" = _Kwuhrhe6;
        "pkg-1.2-neoforge-1.21.5" = _N1dljjNN;
        "pkg-1.2-fabric-1.21.5" = _eM5Chqr8;
        "pkg-1.2-neoforge-1.21.8" = _pVaNUC6F;
        "pkg-1.2-fabric-1.21.8" = _U29wZTfX;
        "pkg-1.2-neoforge-1.21.9" = _GoD2ToLH;
        "pkg-1.2-fabric-1.21.9" = _HhJsLXLy;
        "pkg-1.2-neoforge-1.21.11" = _zaa5QLAq;
        "pkg-1.2-fabric-1.21.11" = _T8j42Ae6;
        "pkg-1.2-neoforge-26.1" = _5qDjDEFb;
