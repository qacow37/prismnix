...
let
    ...
    in {
        ...
        "pkg-B0.1" = _JjjcGn9a;
        "pkg-B0.2" = _aNYZgbrw;
        "pkg-B0.2+mod" = _yAsk4MKR;
        "pkg-B0.3" = _T2LjeCIx;
        "pkg-B0.3+mod" = _2e6uQlDG;
        "pkg-B0.4" = _Uz1Qqkd0;
        "pkg-B0.4+mod" = _D9ulw5h7;
        "pkg-B0.4.1" = _BvOhDtEm;
        "pkg-B0.4.1+mod" = _WoW6wEPl;
        "pkg-B0.5" = _LpHKXajn;
        "pkg-B0.5+mod" = _8AoxSbXx;
        "pkg-B0.5.1" = _KNzGgMKk;
        "pkg-B0.5.1+mod" = _uL5wpiOE;
        "pkg-B0.5.1.1" = _208nUQAz;
        "pkg-B0.5.1.1+mod" = _G869t1bH;
        "pkg-B0.5.1.2" = _83BCs8t6;
        "pkg-B0.5.1.2+mod" = _UQT3TzsF;
        "pkg-B0.6" = _IACiWvmj;
        "pkg-B0.6+mod" = _fMlqHMUb;
        "pkg-B0.6.1" = _p9jf62KT;
        "pkg-B0.6.1+mod" = _WWeeYKPf;
        "pkg-B0.6.1.1" = _JnzRBH1v;
        "pkg-B0.6.1.1+mod" = _O1utQuJh;
        "pkg-B0.6.2" = _c92jt3Xd;
        "pkg-B0.6.2+mod" = _OYbFzi8L;
        "default" = _OYbFzi8L;
    });
