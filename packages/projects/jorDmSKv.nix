...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19-Fabric" = _BsFle2vV;
        "pkg-v4.1.0-1.19.1-Fabric" = _ub1g4CvW;
        "pkg-v4.1.0-1.19.1-Forge" = _LiPInWuO;
        "pkg-v4.2.0-1.19.2-Fabric" = _n5QQRSeT;
        "pkg-v4.2.0-1.19.2-Forge" = _Fb0Zaoti;
        "pkg-v4.2.1-1.19.2-Fabric" = _DAYzr8yH;
        "pkg-v4.2.1-1.19.2-Forge" = _x9KiconR;
        "pkg-v5.0.0-1.19.3-Fabric" = _hgOua1zR;
        "pkg-v5.0.0-1.19.3-Forge" = _3Ir3KTRW;
        "pkg-v5.0.1-1.19.3-Fabric" = _t0iw2U2Z;
        "pkg-v5.0.1-1.19.3-Forge" = _1113d6EP;
        "pkg-v5.0.2-1.19.3-Fabric" = _dpcqq7NV;
        "pkg-v5.0.2-1.19.3-Forge" = _kJ3hEf4z;
        "pkg-v4.2.2-1.19.2-Fabric" = _3R2flbZ6;
        "pkg-v4.2.2-1.19.2-Forge" = _tYUue5Bb;
        "pkg-v6.0.0-1.19.4-Fabric" = _PqIFeWkA;
        "pkg-v6.0.0-1.19.4-Forge" = _R4n8nOvW;
        "pkg-v7.0.0-1.20-Forge" = _d6eip4O3;
        "pkg-v7.0.0-1.20-Fabric" = _GFgJcr4S;
        "pkg-v8.0.0-1.20.1-Forge" = _zeqKFBgH;
        "pkg-v8.0.0-1.20.1-Fabric" = _84RheOgF;
        "pkg-v4.2.3-1.19.2-Fabric" = _GFyG7nKa;
        "pkg-v4.2.3-1.19.2-Forge" = _ZVPHXuR1;
        "pkg-v3.1.4-1.18.2-Forge" = _li8zAgk9;
        "pkg-v3.1.4-1.18.2-Fabric" = _f3z1Nmta;
        "pkg-v8.0.1-1.20.1-Forge" = _eUgNAoUG;
        "pkg-v8.0.1-1.20.1-Fabric" = _YdSjDfKM;
        "pkg-v8.0.2-1.20.1-Forge" = _LrsjuUiA;
        "pkg-v8.0.2-1.20.1-Fabric" = _JCiAyLV3;
        "pkg-v20.4.0-1.20.4-Fabric" = _44OZ9Ikk;
        "pkg-v20.4.0-1.20.4-NeoForge" = _zLnttgJz;
        "pkg-v20.4.0-1.20.4-Forge" = _AKpV63tO;
        "pkg-v21.0.0-1.21-Fabric" = _t8nDUXVo;
        "pkg-v21.0.0-1.21-NeoForge" = _4r8cFJcL;
        "pkg-v21.1.0-1.21.1-Fabric" = _jbMPqW6d;
        "pkg-v21.1.0-1.21.1-NeoForge" = _wuc5gqR2;
        "pkg-v21.3.0-1.21.3-Fabric" = _ArsY6QFw;
        "pkg-v21.3.0-1.21.3-NeoForge" = _eDDy92kf;
        "pkg-v21.4.0-1.21.4-Fabric" = _rFb8QA0s;
        "pkg-v21.4.0-1.21.4-NeoForge" = _F0skBsa6;
        "pkg-v21.5.0-1.21.5-Fabric" = _eqqvKbbs;
        "pkg-v21.5.0-1.21.5-NeoForge" = _3jkTpUT5;
        "pkg-v21.5.1-1.21.5-Fabric" = _ebFj0sv8;
        "pkg-v21.5.1-1.21.5-NeoForge" = _Dk1BGxFH;
        "pkg-v21.6.0-1.21.6-Fabric" = _II5BNRFC;
        "pkg-v21.6.0-1.21.6-NeoForge" = _rji9nY8E;
        "pkg-v21.7.0-1.21.7-Fabric" = _XOKfXiQO;
        "pkg-v21.7.0-1.21.7-NeoForge" = _dNkhvKXs;
        "pkg-v21.8.0-1.21.8-Fabric" = _E6igA225;
        "pkg-v21.8.0-1.21.8-NeoForge" = _GxmtmnKP;
        "pkg-21.9.0" = _EbUk4wLj;
        "pkg-21.10.0" = _sVV4E3nf;
        "pkg-v21.1.1-1.21.1-Fabric" = _85ZLqags;
        "pkg-v21.1.1-1.21.1-NeoForge" = _BZAhwo2r;
        "pkg-21.10.1" = _ABdoNhbC;
