...
let
    ...
    in {
        ...
        "pkg-1.12.2-forge-1.2" = _m9gAXteZ;
        "pkg-1.7.10-forge-1.2" = _q3oBFO2I;
        "pkg-1.10.2-forge-1.2" = _zGtEPOcb;
        "pkg-1.11.2-forge-1.2" = _7uUXxE7z;
        "pkg-1.14.4-forge-1.2" = _gTWGvyxI;
        "pkg-1.15.2-forge-1.2" = _EtZxgzTM;
        "pkg-1.16.5-forge-1.2" = _ND45lx9Q;
        "pkg-1.7.10-forge-1.3" = _3BrKHDzH;
        "pkg-1.10.2-forge-1.3" = _EAmy7LOw;
        "pkg-1.11.2-forge-1.3" = _rhlV7QnI;
        "pkg-1.12.2-forge-1.3" = _JIaHYd0x;
        "pkg-1.14.4-forge-1.3" = _f06oa2xj;
        "pkg-1.15.2-forge-1.3" = _dBBUxUlv;
        "pkg-1.16.5-forge-1.3" = _k42KdeRl;
        "pkg-1.17.1-forge-1.3" = _1Jqsvs3I;
        "pkg-1.18.2-forge-1.3" = _EvNwfbmP;
        "pkg-1.19.4-forge-1.3" = _DLDehtjW;
        "pkg-1.20.1-forge-1.3" = _InOSYmZv;
        "pkg-1.21.1-neoforge-1.3" = _HUL3JKm5;
        "pkg-1.21.4-neoforge-1.3" = _uNCDwCw3;
        "pkg-1.21.8-neoforge-1.3" = _EMsNcTTM;
        "pkg-26.1.2-neoforge-1.3" = _axF9sXAp;
        "pkg-1.21.1-forge-1.3" = _7v3rJNkW;
        "default" = _7v3rJNkW;
    });
