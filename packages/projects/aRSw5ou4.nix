...
let
    ...
    in {
        ...
        "pkg-1.20.1-2.0.0" = _Mt60PXUb;
        "pkg-1.19.2-1.0.1" = _vaaJprqn;
        "pkg-1.19.2-1.1.0" = _wtXI1Wya;
        "pkg-1.20.1-2.1.0" = _YmZvlNvs;
        "pkg-1.20.1-2.2.0" = _RGsY5aZu;
        "pkg-1.20.1-2.2.1" = _zzgVOdwL;
        "pkg-1.20.1-2.4.0" = _sYjICkjH;
        "pkg-1.20.1-2.4.1" = _60pRQU81;
        "pkg-1.19.2-1.2.0" = _ZQLpodyQ;
        "pkg-1.20.1-2.5.0" = _V2hLO4kv;
        "pkg-1.19.2-1.3.0" = _EBdP6yMR;
        "pkg-1.20.1-3.0.0" = _vcpaxF1z;
        "pkg-1.21-4.0.0" = _4xYP16Xf;
        "pkg-1.21-4.0.1" = _ULqb1JGE;
        "pkg-1.20.1-3.1.0" = _RMDpXNCY;
        "pkg-1.21-4.1.0" = _qDpmRnHP;
        "pkg-1.21.1-4.2.0" = _bnfkMkIC;
        "pkg-1.21.1-4.2.1" = _RJfx1XUf;
        "pkg-1.20.1-3.2.0" = _IunHe4gQ;
        "pkg-1.21.1-4.2.2" = _FIxuTKKW;
        "pkg-1.21.1-4.3.0" = _Z9cpRVWB;
        "pkg-1.21.1-4.5.0" = _nGPEILyp;
        "pkg-1.20.1-4.0.0" = _lsZpaEfr;
        "pkg-1.21.1-5.0.0" = _wrBhsmLZ;
        "pkg-1.21.1-6.0.0" = _4ybv4NUz;
        "pkg-1.21.1-6.1.0" = _JItiSU2Q;
        "pkg-1.21.1-6.2.0" = _2OMsBga1;
        "pkg-1.21.1-6.3.0" = _YahVLvqN;
        "pkg-1.21.1-6.4.0" = _d0H5fwIg;
        "pkg-1.21.1-6.5.0" = _r6R7j0be;
        "pkg-1.21.1-6.7.0" = _VSV1jgLU;
        "pkg-1.20.1-4.1.0" = _ERIpMgna;
        "default" = _ERIpMgna;
    });
