...
let
    ...
    in {
        ...
        "pkg-1.1-DP" = _nt0uazrB;
        "pkg-1.1.1-DP" = _WGOzoD7S;
        "pkg-1.1.1-MOD" = _D6TVXxwz;
        "pkg-1.2-DP" = _FulH4tVV;
        "pkg-1.2-MOD" = _vhvgwHyP;
        "pkg-1.2.1-DP" = _46E74tCn;
        "pkg-1.2.1-MOD" = _ZktseKNj;
        "pkg-1.2.2-DP" = _RXhxmH6R;
        "pkg-1.2.2-MOD" = _GyRdXvSD;
        "pkg-1.2.3-DP" = _BculHh5t;
        "pkg-1.2.3-MOD" = _Mc3qILpR;
        "pkg-1.3-DP" = _mFywwmTJ;
        "pkg-1.3-MOD" = _TeRwxsW3;
        "pkg-1.3.1-DP" = _D8Aam9CE;
        "pkg-1.3.1-MOD" = _15kphxoV;
        "pkg-1.3.2-DP" = _MULihgJv;
        "pkg-1.3.2-MOD" = _ebRIJIxR;
        "pkg-1.4-DP" = _9Sd0bhbJ;
        "pkg-1.4-MOD" = _NzDuIxwW;
        "pkg-1.4.1-DP" = _bPt6fHrH;
        "pkg-1.4.1-MOD" = _i4b4Xouw;
        "pkg-1.4.2-DP" = _6SrHPpgL;
        "pkg-1.4.2-MOD" = _ftyJmzCl;
        "pkg-1.4.3-DP" = _CL70uhur;
        "pkg-1.4.3-MOD" = _SYhLvkH1;
        "default" = _SYhLvkH1;
    });
