...
let
    ...
    in {
        ...
        "pkg-1.14.4-1.0.2" = _hBFmnThK;
        "pkg-1.15.1-1.0.3" = _1Xb6aqfM;
        "pkg-1.15.2-1.0.3" = _i9LwJhqE;
        "pkg-1.16.1-1.0.3" = _MqX8rksk;
        "pkg-1.16.3-1.0.3" = _51OJ9m5z;
        "pkg-1.16.4-1.1.0" = _jnJfsV31;
        "pkg-1.17.1-1.1.1" = _XyrP12bm;
        "pkg-1.18.2-1.1.1" = _aAkeMYgN;
        "pkg-1.19.4-1.1.2" = _xGPY2UlD;
        "pkg-1.20.1-1.1.3" = _5BfQm2pk;
        "pkg-1.21-1.3.1" = _CuIDcxC4;
        "pkg-1.21.5-1.3.3" = _NshJVGZX;
        "pkg-1.21.9-1.3.5" = _qGZttFZ3;
        "pkg-1.21.10-1.3.5" = _WvNeKaWA;
        "pkg-1.21.10-1.3.6" = _LPv3PHAA;
        "pkg-1.21.11-1.3.6" = _gxeXEbtN;
        "pkg-1.21.1-1.3.2" = _ucGlpx4x;
