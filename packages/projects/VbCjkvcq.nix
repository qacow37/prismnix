...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.9-fabric" = _sILlgqgj;
        "pkg-1.18.2-2.9-fabric" = _jjYapRn0;
        "pkg-1.19.2-3.0-fabric" = _ZoANWicZ;
        "pkg-1.16.5-2.5-forge" = _QfYwXBAT;
        "pkg-1.18.2-2.6-forge" = _4Z7e04uL;
        "pkg-1.19.2-2.8-forge" = _cORxYWUR;
        "pkg-1.16.5-4.0-fabric" = _3sHJeF1K;
        "pkg-1.18.2-4.0-fabric" = _OC9Yw9wF;
        "pkg-1.19.2-4.0-fabric" = _5uZCHuP4;
        "pkg-1.16.5-4.0-forge" = _wuepvQsj;
        "pkg-1.18.2-4.0-forge" = _6b9WrO5i;
        "pkg-1.19.2-4.0-forge" = _4d14rNvS;
        "pkg-1.16.5-4.1-fabric" = _VbnJkKdj;
        "pkg-1.18.2-4.1-fabric" = _8sClcYNd;
        "pkg-1.19.2-4.1-fabric" = _qLptseIl;
        "pkg-1.19.3-4.2-fabric" = _ORhYjAOJ;
        "pkg-1.19.3-4.0-forge" = _CUzVX3un;
        "pkg-1.18.2-5.0-forge+fabric" = _bUHZvmkX;
        "pkg-1.19.2-5.0-forge+fabric" = _xmgOqaJ4;
        "pkg-1.19.3-5.0-forge+fabric" = _8akfXAPD;
        "pkg-1.19.4-5.0-forge+fabric" = _QWlFqX6i;
        "pkg-1.20-5.0-forge+fabric" = _2L4zGTV8;
        "pkg-1.20.1-5.0-forge+fabric" = _OdmIsKE8;
        "pkg-1.20.2-5.0-forge+fabric" = _zQl5pAk5;
        "pkg-1.18.2-5.1-forge+fabric" = _C3MI3hXU;
        "pkg-1.19.2-5.1-forge+fabric" = _SmwrB9uv;
        "pkg-1.20.1-5.1-forge+fabric" = _1KDIHdHH;
        "pkg-1.20.2-5.1-forge+fabric" = _aZTRFqCL;
        "pkg-1.20.3-5.1-fabric+forge+neo" = _u4sx74dE;
        "pkg-1.20.4-5.1-fabric+forge+neo" = _YGZuKR4c;
        "pkg-1.19.2-5.2-fabric+forge+neo" = _IuU1ixfB;
        "pkg-1.20.1-5.2-fabric+forge+neo" = _kBQ2CAa6;
        "pkg-1.20.2-5.2-fabric+forge+neo" = _XoSy9oOO;
        "pkg-1.20.4-5.2-fabric+forge+neo" = _Nw2fdmkd;
        "pkg-1.20.5-5.2-fabric+neo" = _V86V5cL2;
        "pkg-1.20.6-5.2-fabric+forge+neo" = _8jrG43Zz;
        "pkg-1.20.6-5.3-fabric+forge+neo" = _5CdGDLPP;
        "pkg-1.21.0-5.3-fabric+forge+neo" = _yJbc4ypF;
        "pkg-1.21.0-5.4-fabric+forge+neo" = _IMM6ddhQ;
        "pkg-1.20.1-5.5-fabric+forge+neo" = _kMGXPiLj;
        "pkg-1.20.6-5.5-fabric+forge+neo" = _qwYoE6oW;
        "pkg-1.21.0-5.5-fabric+forge+neo" = _TmZAqlO8;
        "pkg-1.21.1-5.5-fabric+forge+neo" = _RZiZLyAK;
        "pkg-1.21.2-5.5-fabric+neo" = _Z5Gkonbt;
        "pkg-1.21.2-5.6-fabric+neo" = _SQEqlmcu;
        "pkg-1.21.3-5.6-fabric+forge+neo" = _coCMVfHJ;
        "pkg-1.21.4-5.6-fabric+forge+neo" = _9u9YDHgW;
        "pkg-1.20.1-5.7-fabric+forge+neo" = _laOcMdQ2;
        "pkg-1.21.1-5.7-fabric+forge+neo" = _gZQXxKYQ;
        "pkg-1.21.4-5.7-fabric+forge+neo" = _jLkCQ4zS;
        "pkg-1.21.5-5.7-fabric+forge+neo" = _vi1ENlUJ;
        "pkg-1.21.6-5.7-fabric+forge+neo" = _q7VpJM9N;
        "pkg-1.21.7-5.7-fabric+forge+neo" = _EmqUEXNU;
        "pkg-1.21.8-5.7-fabric+forge+neo" = _akD9BjXl;
        "pkg-1.21.9-5.7-fabric+forge+neo" = _hAL1KAUy;
        "pkg-1.21.10-5.7-fabric+forge+neo" = _LwwnYC7J;
        "pkg-1.21.11-5.7-fabric+forge+neo" = _KXDO0Gh7;
        "pkg-26.1.0-5.7-fabric+forge+neo" = _umboOJWi;
        "pkg-26.1.1-5.7-fabric+forge+neo" = _rjWaoPJC;
        "pkg-26.1.2-5.7-fabric+forge+neo" = _cbJtfBYv;
        "pkg-1.20.1-5.8-fabric+forge+neo" = _a1XElYGy;
        "pkg-1.21.1-5.8-fabric+forge+neo" = _mQYG2fNE;
        "pkg-1.21.11-5.8-fabric+forge+neo" = _yHqlJIHZ;
        "pkg-26.1.2-5.8-fabric+forge+neo" = _mfZyuY8Y;
        "pkg-26.2.0-5.8-fabric+forge+neo" = _qIY17z0b;
        "default" = _qIY17z0b;
    });
