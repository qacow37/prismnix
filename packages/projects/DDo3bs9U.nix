...
let
    ...
    in {
        ...
        "pkg-0.3.0" = _yQsKgKwE;
        "pkg-0.3.1" = _ZAwxYMII;
        "pkg-0.4.0+1.20.4" = _Ktl9Ut9G;
        "pkg-0.5.0+1.21" = _rt1hTv48;
        "pkg-0.6.1+1.21" = _MwOxU5zd;
        "pkg-0.7.0+1.21" = _w6Sa6WBe;
        "pkg-0.8.0+1.21.1" = _1VshIHEg;
        "pkg-0.9.0+1.21.1" = _ni7IAL4Q;
        "pkg-0.9.1+1.21.2" = _16IReoms;
        "pkg-0.9.2+1.21.2" = _ihBknnzK;
        "pkg-0.9.3+1.21.3" = _XawQOnPO;
        "pkg-0.10.0+1.21.3" = _qVAHOVMw;
        "pkg-0.10.0+1.21.4" = _k6G5RbH4;
        "pkg-0.10.1" = _FTZkO7sP;
        "pkg-0.10.1+1.21.5" = _4MmycW82;
        "pkg-0.10.2+1.21.5" = _5OMDCp9v;
        "pkg-0.10.2+1.21.6" = _CHtZVGlr;
        "pkg-0.10.2+1.21.7" = _dL06QEpO;
        "pkg-0.10.2+1.21.8" = _1ks7vdf7;
        "pkg-0.10.2+1.21.9" = _OawR5Fts;
        "pkg-0.10.2+1.21.1" = _6ZrOSBRi;
        "pkg-0.10.2+1.21.10" = _NiYq2fOG;
        "pkg-0.10.2+1.21.11" = _AM2Q9cIc;
        "pkg-0.10.3+1.21.11" = _JJEnwAXq;
        "pkg-0.10.3+26.1" = _2vO7xC8R;
        "default" = _2vO7xC8R;
    });
