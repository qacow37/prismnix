...
let
    ...
    in {
        ...
        "pkg-2.9.2" = _p5RjeOJL;
        "pkg-2.9.4" = _mIiMyney;
        "pkg-2.10.0" = _1mKrqlvv;
        "pkg-2.11.0" = _tv8GIQDa;
        "pkg-2.11.1" = _1AYfSJ9O;
        "pkg-2.11.2" = _gZr7EykF;
        "pkg-2.12.0" = _QRQLkNPJ;
        "pkg-2.13.0" = _JiEpJuon;
        "pkg-2.13.1" = _8cY8HQIg;
        "pkg-2.13.2" = _BalILUb7;
        "pkg-2.13.3" = _LIBdkZvZ;
        "pkg-2.13.4+1.20.6" = _FiLFLGIB;
        "pkg-2.13.4+1.20.4" = _VfWNmPC4;
        "pkg-2.13.4+1.20.1" = _eLEIUtBo;
        "pkg-2.13.5+1.20.6" = _8BIz17tA;
        "pkg-2.13.5+1.20.4" = _OggLUOr6;
        "pkg-2.13.5+1.20.1" = _66iHgfN8;
        "pkg-2.14.0+1.21" = _vg7GaKbh;
        "pkg-2.14.0+1.20.6" = _twJQAslW;
        "pkg-2.14.0+1.20.4" = _hzEfkIGF;
        "pkg-2.14.0+1.20.1" = _8VBKUY5S;
        "pkg-2.14.2+1.21.1" = _mGFci27z;
        "pkg-2.14.2+1.21.3" = _RKRjd2h1;
        "pkg-2.14.2+1.20.6" = _R3KFePo9;
        "pkg-2.14.2+1.20.4" = _oK8ySMgf;
        "pkg-2.14.2+1.20.1" = _RW06GEHk;
        "pkg-2.14.4+1.20.4" = _Wx2ZD5GR;
        "pkg-2.14.4+1.20.6" = _JemvJ3wf;
        "pkg-2.14.4+1.21.3" = _VXNImMZ9;
        "pkg-2.14.4+1.21.1" = _BTXkmTHl;
        "pkg-2.14.4+1.21.6" = _Smt2Lxmo;
        "pkg-2.14.4+1.20.1" = _VsZyF8DS;
        "pkg-2.14.5+1.20.1" = _BJgR1rfP;
        "pkg-2.14.6+1.21.6" = _qMqviL3t;
        "pkg-2.14.6+1.20.6" = _Ij1GY765;
        "pkg-2.14.6+1.21.9" = _jF5geVmV;
        "pkg-2.14.6+1.21.1" = _4IZeSKNU;
        "pkg-2.14.6+1.20.4" = _UP7R13O6;
        "pkg-2.14.6+1.21.3" = _DrLtEbE4;
        "pkg-2.14.6+1.20.1" = _hWl13Hjr;
        "pkg-2.14.6+1.21.11" = _6T6WQ6NZ;
        "pkg-2.15.0+1.20.4" = _Qk7hfNUD;
        "pkg-2.15.0+1.21.1" = _m0JCKYXm;
        "pkg-2.15.0+1.20.1" = _gSTBZ91p;
        "pkg-2.15.0+1.20.6" = _Cms9EDRx;
        "pkg-2.15.0+1.21.11" = _LNLOUu9x;
        "pkg-2.15.0+1.21.5" = _sfHUNckZ;
        "pkg-2.15.0+1.21.6" = _augXOLWB;
        "pkg-2.15.0+1.21.9" = _2qcHhKCL;
        "pkg-2.15.1+1.20.1" = _zMG5hXjT;
        "pkg-2.15.1+1.20.4" = _PN7Yoipn;
        "pkg-2.15.1+1.20.6" = _yXkcc7yD;
        "pkg-2.15.1+1.21.1" = _WmVN03jQ;
        "pkg-2.15.1+1.21.11" = _YphN3CnL;
        "pkg-2.15.1+1.21.5" = _hFQfRvX1;
        "pkg-2.15.1+1.21.6" = _OwKsg9JX;
        "pkg-2.15.1+1.21.9" = _luy40xRK;
        "pkg-2.15.2+1.20.4" = _eM4pcNnS;
        "pkg-2.15.2+1.20.1" = _PEJt9yRp;
        "pkg-2.15.2+1.20.6" = _arkLkvnQ;
        "pkg-2.15.2+1.21.1" = _6jrMC48Z;
        "pkg-2.15.2+1.21.5" = _r2ewk22o;
        "pkg-2.15.2+1.21.11" = _gI5KZI8V;
        "pkg-2.15.2+1.21.6" = _LpSqZyo1;
        "pkg-2.15.2+1.21.9" = _Vdx09fu6;
