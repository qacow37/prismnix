...
let
    ...
    in {
        ...
        "pkg-1.17.x-1.0.0" = _fHlHqOEN;
        "pkg-1.18.x-1.0.0" = _CeUSPb9J;
        "pkg-1.18.x-1.1.0" = _Rrc4bb3y;
        "pkg-1.19.x-1.2.0" = _SaOn06Vv;
        "pkg-1.19.x-1.2.1" = _R1OUUIUl;
        "pkg-1.19.x-1.2.2" = _PK9pUrx0;
        "pkg-1.19.x-1.2.3" = _QoSOCDZS;
        "pkg-1.19.x-1.2.4" = _nyTDv34N;
        "pkg-1.19.x-1.2.5" = _ijsDaK5l;
        "pkg-1.19.x-1.3.0" = _8kA96aNS;
        "pkg-1.19.x-1.3.1" = _YBxjgYCA;
        "pkg-fabric-1.19.x-1.4.0" = _njuyJH9j;
        "pkg-fabric-1.19.x-1.4.1" = _ecPLyXca;
        "pkg-fabric-1.19.x-1.5.0" = _3e8bRREh;
        "pkg-fabric-1.19.x-1.6.0" = _DdIyvPXF;
        "pkg-1.19.3-1.6.0" = _MgpD1Klf;
        "pkg-fabric-1.19.3-1.6.1" = _eWtjdA7Z;
        "pkg-fabric-1.19.3-1.6.2" = _TpmNuRlo;
        "pkg-fabric-1.19.3-1.6.3" = _LL3C3Z5e;
        "pkg-fabric-1.19.4-1.6.4" = _zKfXGkaO;
        "pkg-fabric-1.19.4-1.6.5" = _f5aZ5OAl;
        "pkg-fabric-1.19.3-1.6.5-compatfix" = _6aErRT8p;
        "pkg-fabric-1.19.2-backport-1.6.5" = _p4W5KzFD;
        "pkg-fabric-1.19.4-1.6.6" = _tLRyYvbW;
        "pkg-fabric-1.19.3-1.6.6-compatfix" = _9LFhWArv;
        "pkg-fabric-1.20-1.6.7" = _qDS5teJT;
        "pkg-fabric-1.20-1.6.8" = _t63ZAtGQ;
        "pkg-fabric-1.20-1.6.9" = _glS8CV4b;
        "pkg-fabric-1.20-1.7.0-alpha" = _BrhmZQDc;
        "pkg-fabric-1.20.2+1.7.2" = _i78tiLsu;
        "pkg-1.8+1.21.4" = _bJdIIA9b;
        "pkg-fabric-1.21.5+1.8" = _DTIsCwha;
        "pkg-fabric-1.21.6+1.8" = _52dLgYnO;
        "pkg-fabric-1.21.8+1.8" = _7DyLsSXl;
        "pkg-fabric-1.21.9+1.8" = _ZZIAtivj;
        "pkg-fabric-1.21.10+1.8" = _blqukHwO;
        "pkg-fabric-1.21.11+1.8.1" = _rk5e9w3q;
        "default" = _rk5e9w3q;
    });
