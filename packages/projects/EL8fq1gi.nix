...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.5-fabric" = _ETjGoZO5;
        "pkg-1.18.2-2.5-fabric" = _Npee0yuJ;
        "pkg-1.19.2-2.5-fabric" = _rKQ3coQj;
        "pkg-1.16.5-2.5-forge" = _NNxlN0F6;
        "pkg-1.18.2-2.5-forge" = _R7jWweAr;
        "pkg-1.19.2-2.5-forge" = _abTSzlDg;
        "pkg-1.16.5-2.6-fabric" = _Yixx6rtq;
        "pkg-1.18.2-2.6-fabric" = _r7wCaOfT;
        "pkg-1.19.2-2.6-fabric" = _w0bDDLPi;
        "pkg-1.16.5-2.7-fabric" = _TAI4bXED;
        "pkg-1.18.2-2.7-fabric" = _fcDhDKie;
        "pkg-1.19.2-2.7-fabric" = _mAixLlP9;
        "pkg-1.16.5-2.7-forge" = _AsPdJDAB;
        "pkg-1.18.2-2.7-forge" = _vki0tpDJ;
        "pkg-1.19.2-2.7-forge" = _3i5tG2Ax;
        "pkg-1.19.3-2.8-fabric" = _NfVP6X8i;
        "pkg-1.19.3-2.7-forge" = _xTs5fNg4;
        "pkg-1.18.2-3.0-forge+fabric" = _JLwBkOLl;
        "pkg-1.19.2-3.0-forge+fabric" = _xvyYVCYS;
        "pkg-1.19.3-3.0-forge+fabric" = _P0Ib9gC3;
        "pkg-1.18.2-3.1-forge+fabric" = _xEeKhV8u;
        "pkg-1.19.2-3.1-forge+fabric" = _wHsY9t3G;
        "pkg-1.19.3-3.1-forge+fabric" = _aMwiNMrV;
        "pkg-1.19.4-3.1-forge+fabric" = _R7EhQ83U;
        "pkg-1.20-3.1-forge+fabric" = _WrV5ZYDm;
        "pkg-1.20.1-3.1-forge+fabric" = _pnndZl7H;
        "pkg-1.20.2-3.1-forge+fabric" = _9tIxuRBz;
        "pkg-1.18.2-3.2-forge+fabric" = _QSXrLGYT;
        "pkg-1.19.2-3.2-forge+fabric" = _IpswgRaS;
        "pkg-1.20.1-3.2-forge+fabric" = _9jxB8QKA;
        "pkg-1.20.2-3.2-forge+fabric" = _sGdl1uaF;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _Qxhd47gS;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _l0sgo9EC;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _BC2UAtbN;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _y78ZvGQi;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _6JsPFnLa;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _SFS2Ur2c;
        "pkg-1.20.5-3.3-fabric+neo" = _8vzdDdl7;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _oFUGp5Lb;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _sm7hIuIu;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _vwkQhAOg;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _79QOIGpV;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _orjviHYU;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _UQq6EWJo;
        "pkg-1.21.2-3.4-fabric+neo" = _d8VtYAF8;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _5T1E63Ew;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _9GjBpXzm;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _W33wMExg;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _9jApRI0P;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _BCkJsXs5;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _3COCi3IT;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _qV33Dpdy;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _iShLoZAP;
        "pkg-1.21.6-3.7-fabric+forge+neo" = _NWHBvYPa;
        "pkg-1.21.7-3.7-fabric+forge+neo" = _zqEyTXqZ;
        "pkg-1.21.8-3.7-fabric+forge+neo" = _i9zA1Dup;
        "pkg-1.21.9-3.7-fabric+forge+neo" = _zlQz35Tm;
        "pkg-1.21.9-3.8-fabric+forge+neo" = _T7TtJKR2;
        "pkg-1.21.10-3.8-fabric+forge+neo" = _gIu9zC7M;
        "pkg-1.21.11-3.8-fabric+forge+neo" = _wQ11FK2R;
        "pkg-26.1.0-3.8-fabric+forge+neo" = _w5hhzftI;
        "pkg-26.1.1-3.8-fabric+forge+neo" = _dPBH6DNl;
        "pkg-26.1.2-3.8-fabric+forge+neo" = _3aN0OEjC;
        "pkg-26.2.0-3.8-fabric+forge+neo" = _YpMQkGqw;
        "default" = _YpMQkGqw;
    });
