...
let
    ...
    in {
        ...
        "pkg-3.4.3" = _ZP0bEgXY;
        "pkg-3.5.0" = _Enq42H9J;
        "pkg-3.6.0+1.8.9" = _GjwgjV2r;
        "pkg-3.6.0+1.12.2" = _H5IipAR8;
        "pkg-3.6.0+1.16.5" = _nM3VdyTu;
        "pkg-3.6.0+1.17.1" = _3CBxvR4I;
        "pkg-3.6.0+1.18.2" = _3G2uoK93;
        "pkg-3.6.0+1.19.4" = _R94RUZsl;
        "pkg-3.6.0+1.20.4" = _ITrKM2b5;
        "pkg-3.6.1+1.8.9" = _9kcIycgN;
        "pkg-3.7.0+1.8.9" = _YgtfLF5x;
        "pkg-3.7.0+1.12.2" = _m1VcZW6s;
        "pkg-3.7.0+1.16.5" = _fiCDtXt4;
        "pkg-3.7.0+1.17.1" = _YpRaHDHG;
        "pkg-3.7.0+1.18.2" = _PYgmipXx;
        "pkg-3.7.0+1.19.4" = _I3BIw0TQ;
        "pkg-3.7.0+1.20.4" = _D1bkzAyZ;
        "pkg-3.8.0+1.8.9" = _nOFnE4q4;
        "pkg-3.8.0+1.12.2" = _VtVnPe2r;
        "pkg-3.8.0+1.16.5" = _FfRfzg65;
        "pkg-3.8.0+1.17.1" = _iCpFUDVu;
        "pkg-3.8.0+1.18.2" = _blKffCzw;
        "pkg-3.8.0+1.19.2" = _7qdpmys3;
        "pkg-3.8.0+1.19.4" = _q7iVmZRc;
        "pkg-3.8.0+1.20.4" = _tgFvSIQW;
        "pkg-3.8.0+1.20.6" = _nw9nsQFQ;
        "pkg-3.9.0+1.8.9" = _zHocd0rb;
        "pkg-3.9.0+1.12.2" = _hb6hIoAB;
        "pkg-3.9.0+1.16.5" = _mdH39yQy;
        "pkg-3.9.0+1.17.1" = _OgpsuZ3T;
        "pkg-3.9.0+1.18.2" = _PqvVWBak;
        "pkg-3.9.0+1.19.2" = _Mlji922g;
        "pkg-3.9.0+1.19.4" = _9iTa9NMa;
        "pkg-3.9.0+1.20.4" = _BrV9EU8X;
        "pkg-3.9.0+1.20.6" = _8e4UmMvg;
        "pkg-3.10.0+1.8.9" = _ZPPl9Jn7;
        "pkg-4.0.0+1.12.2" = _MsfXu6c4;
        "pkg-4.0.0+1.16.5" = _f8NNvBlh;
        "pkg-4.0.0+1.17.1" = _mSvDh3ny;
        "pkg-4.0.0+1.18.2" = _Lej5rn6k;
        "pkg-4.0.0+1.19.2" = _lphLpeU1;
        "pkg-4.0.0+1.19.4" = _cbBMtF0n;
        "pkg-4.0.0+1.20.1" = _Yzr0RCd2;
        "pkg-4.0.0+1.20.6" = _vVR2vg45;
        "pkg-4.0.0+1.21.4" = _ytr1hE1f;
        "pkg-4.0.0+1.20.4" = _VqRLoXVk;
        "pkg-4.1.0+1.12.2" = _AL4jG6Vs;
        "pkg-4.1.0+1.16.5" = _OIPd0K0t;
        "pkg-4.1.0+1.17.1" = _5NgnZdhf;
        "pkg-4.1.0+1.18.2" = _KchDdMVH;
        "pkg-4.1.0+1.19.2" = _WsBGurn7;
        "pkg-4.1.0+1.19.4" = _cTGLsDP3;
        "pkg-4.1.0+1.20.1" = _6caigRlT;
        "pkg-4.1.0+1.20.4" = _bE3mGsRl;
        "pkg-4.1.0+1.20.6" = _RiVuIqlN;
        "pkg-4.1.0+1.8.9" = _S7wPlveQ;
        "pkg-4.1.0+1.21.5" = _Y5fqqlun;
        "pkg-4.1.1+1.12.2" = _EVvILgHL;
        "pkg-4.1.1+1.16.5" = _7bJI9VuP;
        "pkg-4.1.1+1.17.1" = _yL87nckj;
        "pkg-4.1.1+1.18.2" = _7eM357zH;
        "pkg-4.1.1+1.19.2" = _bFRbh5lT;
        "pkg-4.1.1+1.19.4" = _gHUq4WCO;
        "pkg-4.1.1+1.20.1" = _Aq4LZMV4;
        "pkg-4.1.1+1.21.5" = _KFS0j1Hd;
        "pkg-4.1.1+1.20.6" = _DBYcQsuv;
        "pkg-4.1.1+1.20.4" = _R9enjcg3;
        "pkg-4.1.1+1.8.9" = _nQLkMNsz;
        "pkg-4.2.0+1.12.2" = _PhfyeGKK;
        "pkg-4.2.0+1.16.5" = _uVULUqW1;
        "pkg-4.2.0+1.17.1" = _hyGSydOi;
        "pkg-4.2.0+1.18.2" = _MR1W4qJJ;
        "pkg-4.2.0+1.19.2" = _oHYfDTcF;
        "pkg-4.2.0+1.19.4" = _2wB8NVvI;
        "pkg-4.2.0+1.20.1" = _lYWQXfqa;
        "pkg-4.2.0+1.20.6" = _Hwk4zTY6;
        "pkg-4.2.0+1.21.7" = _R5z6eNw5;
        "pkg-4.2.0+1.20.4" = _uy2ILk9N;
        "pkg-4.2.0+1.8.9" = _M1h8qd9Y;
        "pkg-4.3.0+1.12.2" = _fXnCQoeb;
        "pkg-4.3.0+1.16.5" = _wftZmZMo;
        "pkg-4.3.0+1.17.1" = _Yi8y4DCn;
        "pkg-4.3.0+1.18.2" = _nUXOj8l7;
        "pkg-4.3.0+1.19.2" = _d0HWAeU6;
        "pkg-4.3.0+1.19.4" = _107DWA50;
        "pkg-4.3.0+1.20.1" = _N0TynQUJ;
        "pkg-4.3.0+1.20.6" = _ThJbjYGi;
        "pkg-4.3.0+1.20.4" = _qepk4Lvd;
        "pkg-4.3.0+1.8.9" = _Hc8i8DPx;
        "pkg-4.3.0+1.21.9" = _fI8sCZqd;
        "pkg-4.3.1+1.12.2" = _q7LyhIVl;
        "pkg-4.3.1+1.16.5" = _abEfBtXD;
        "pkg-4.3.1+1.17.1" = _MCgqltBm;
        "pkg-4.3.1+1.18.2" = _FurBMHXB;
        "pkg-4.3.1+1.19.2" = _ltgO3ls6;
        "pkg-4.3.1+1.19.4" = _QdWNPxBf;
        "pkg-4.3.1+1.20.1" = _oY3SyCCx;
        "pkg-4.3.1+1.20.4" = _YBcuRycw;
        "pkg-4.3.1+1.20.6" = _zK8QHvZG;
        "pkg-4.3.1+1.21.10" = _WeFHGPCd;
        "pkg-4.3.1+1.8.9" = _vEgzX7kU;
        "pkg-4.3.2+1.12.2" = _xdCEhlBp;
        "pkg-4.3.2+1.16.5" = _QIbCyvO8;
        "pkg-4.3.2+1.17.1" = _SwnUMbE8;
        "pkg-4.3.2+1.18.2" = _mdbajLEt;
        "pkg-4.3.2+1.19.2" = _qADX8mUV;
        "pkg-4.3.2+1.19.4" = _9T1ymitZ;
        "pkg-4.3.2+1.20.1" = _Oc4iX0u3;
        "pkg-4.3.2+1.8.9" = _PBHerSA6;
        "pkg-4.3.2+1.20.4" = _tTpM24Ur;
        "pkg-4.3.2+1.21.11" = _Xo43FsEi;
        "pkg-4.3.2+1.20.6" = _ftgPX0dS;
        "pkg-4.4.0+3+1.16.5" = _fdBu54zP;
        "pkg-4.4.0+3+1.17.1" = _BRldBwPZ;
        "pkg-4.4.0+3+1.18.2" = _zhL6Z9MI;
        "pkg-4.4.0+3+1.19.2" = _ZRsyKgsW;
        "pkg-4.4.0+3+1.19.4" = _9J4wTHP3;
        "pkg-4.4.0+3+1.20.1" = _oOMeMzQf;
        "pkg-4.4.0+3+1.20.4" = _WGqEzdxx;
        "pkg-4.4.0+3+1.20.6" = _vUZa4zZs;
        "pkg-4.4.0+3+1.21.11" = _tsqyngCZ;
        "pkg-4.4.0+4+1.12.2" = _4Gn5kVSe;
        "pkg-4.4.0+4+1.8.9" = _K7zjrRsd;
        "default" = _K7zjrRsd;
    });
