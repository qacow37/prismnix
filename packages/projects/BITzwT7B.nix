...
let
    ...
    in {
        ...
        "pkg-0.1+spigot" = _oUJMLDhz;
        "pkg-0.2+spigot" = _DfUyEmsH;
        "pkg-0.3+spigot" = _O9nndrTu;
        "pkg-0.4+spigot" = _WHWREL0t;
        "pkg-0.4.1+spigot" = _OCMguKKN;
        "pkg-0.4.2+spigot" = _kWrUtFJD;
        "pkg-0.4.3+spigot" = _h0JZJyxI;
        "pkg-0.5+spigot" = _fHbGFMHY;
        "pkg-fabric-1.0+1.21.4" = _o8hVTiIh;
        "pkg-fabric-1.0.1+1.21.1" = _8GNwfgl0;
        "pkg-fabric-1.0.1+1.21.4" = _2WhU8f9K;
        "pkg-fabric-1.0.1+1.20.1" = _LQAaJ6Xx;
        "pkg-spigot-1.1" = _fLcvIQmJ;
        "pkg-spigot-1.1.1" = _AfxI5DFe;
        "pkg-fabric-1.1+1.21.4" = _YETQL5av;
        "pkg-fabric-1.1+1.21.1" = _v4hRHylC;
        "pkg-fabric-1.1+1.20.1" = _vLNU1jDF;
        "pkg-spigot-1.2" = _B8JeJLN6;
        "pkg-fabric-1.2+1.21.4" = _JIAc7Z3R;
        "pkg-fabric-1.2+1.21.1" = _2RQUpEgG;
        "pkg-fabric-1.2+1.20.1" = _jS6Vhy5l;
        "pkg-fabric-1.2.1+1.21.1" = _CCOZ8aPE;
        "pkg-fabric-1.2.1+1.20.1" = _2ls64XlM;
        "pkg-fabric-1.2.1+1.21.4" = _VeVEl03Y;
        "pkg-spigot-1.2.1" = _ryVpOD6p;
        "pkg-fabric-1.2.1+1.21.3" = _Idiy27eP;
        "pkg-fabric-1.2.1+1.20.6" = _FSo0kqUk;
        "pkg-spigot-1.2.2" = _saZcvOtu;
        "pkg-spigot-1.2.3" = _vtfbrJMA;
        "pkg-fabric-1.2.2+1.21.4" = _QwXX6CUx;
        "pkg-fabric-1.2.2+1.21.1" = _XYmN1VDf;
        "pkg-fabric-1.2.2+1.20.6" = _6iJ3k1f0;
        "pkg-fabric-1.2.2+1.21.3" = _pudcqdug;
        "pkg-fabric-1.2.2+1.20.1" = _TYGbQdrZ;
        "pkg-fabric-1.2.2-hotfix+1.20.1" = _AEmeu3C2;
        "pkg-spigot-1.3" = _K5I9pPys;
        "pkg-spigot-1.3.1" = _tmydZhlQ;
        "pkg-fabric-1.3+1.21.4" = _LC7chzcN;
        "pkg-fabric-1.3+1.21.1" = _7zr1JSlK;
        "pkg-fabric-1.3+1.20.1" = _zquA404h;
        "pkg-fabric-1.3+1.21.5" = _dCPqfRJu;
        "pkg-fabric-1.3.1+1.21.5" = _jyPc6utA;
        "pkg-fabric-1.3.1+1.21.4" = _4qRFmXsR;
        "pkg-fabric-1.3.1+1.20.1" = _t1iLAgoL;
        "pkg-fabric-1.3.1+1.21.1" = _HFO83Qpg;
        "pkg-fabric-1.3.2+1.21.1" = _V8BUkrPX;
        "pkg-fabric-1.3.2+1.21.5" = _jMg9JEDU;
        "pkg-fabric-1.3.2+1.20.1" = _g6mFzJcL;
        "pkg-fabric-1.3.2+1.21.4" = _J4qPX3ng;
        "pkg-1.4" = _d0suMx81;
        "pkg-fabric-1.3.2+1.21.6" = _rRknlNGJ;
        "pkg-fabric-1.3.2-hotfix+1.21.6" = _J0i2HKE1;
        "pkg-fabric-1.3.2+1.21.7" = _PhLZ6lNp;
        "pkg-fabric-1.4+1.21.4" = _btjd7qzh;
        "pkg-fabric-1.4+1.21.1" = _d0W6j86b;
        "pkg-fabric-1.4+1.21.7" = _snY5vrPs;
        "pkg-fabric-1.4+1.21.5" = _2XQxwpdB;
        "pkg-fabric-1.4+1.20.1" = _tmFyhdnU;
        "pkg-fabric-1.4+1.21.8" = _130whT9c;
        "pkg-fabric-1.4.1+1.21.4" = _KH2mjdLr;
        "pkg-fabric-1.4.1+1.21.5" = _FZ63m2q8;
        "pkg-fabric-1.4.1+1.21.8" = _k1aGqnNN;
        "pkg-fabric-1.4.1+1.20.1" = _Ct3OCzZc;
        "pkg-fabric-1.4.1+1.21.1" = _6G14KoOD;
        "pkg-1.4.1" = _Xgk9ijBK;
        "pkg-1.4.2" = _rrIT17fR;
        "pkg-fabric-1.4.2+1.20.1" = _t7NZ0jkr;
        "pkg-fabric-1.4.2+1.21.8" = _1NMeO75Y;
        "pkg-fabric-1.4.2+1.21.4" = _d6qgNFwz;
        "pkg-fabric-1.4.2+1.21.1" = _e7ojz23C;
        "pkg-fabric-1.4.2+1.21.5" = _zAEkklIr;
        "pkg-fabric-1.4.2+1.21.9" = _2ijKpW9h;
        "pkg-fabric-1.4.2-hotfix+1.21.8" = _E8p5CKa9;
        "pkg-fabric-1.4.2-hotfix+1.21.9" = _hmSOQ95g;
        "pkg-fabric-1.4.2-hotfix+1.21.10" = _i3mkHfio;
        "pkg-1.4.3" = _oeDtrDto;
        "pkg-1.4.4" = _mlcnO2FI;
        "pkg-1.5" = _gDfPJ4Xb;
        "pkg-fabric-1.5+1.21.4" = _j7iZNP5t;
        "pkg-fabric-1.5+1.20.1" = _QYlwl9C5;
        "pkg-fabric-1.5+1.21.10" = _KzNBb7oE;
        "pkg-fabric-1.5+1.21.5" = _pDObXdmA;
        "pkg-fabric-1.5+1.21.1" = _qjDwpNDN;
        "pkg-fabric-1.5+1.21.8" = _odng5S7N;
        "pkg-fabric-1.5+1.21.11" = _6fAksWaM;
        "pkg-fabric-1.5.1+1.21.11" = _tJyI7Cg9;
        "pkg-fabric-1.5.1+1.21.10" = _g1FIa6sK;
        "pkg-fabric-1.5.1+1.21.4" = _n5wTD2NT;
        "pkg-fabric-1.5.1+1.20.1" = _rJ1BBE6j;
        "pkg-fabric-1.5.1+1.21.1" = _QD8H3HMX;
        "pkg-fabric-1.5.1+1.21.5" = _ZYnxNa2z;
        "pkg-fabric-1.5.1+1.21.8" = _djb83m5i;
        "pkg-paper-1.5.1" = _1olXBSPe;
        "pkg-paper-1.6" = _h8eaY22N;
        "pkg-fabric-1.6+1.21.11" = _Gujp8K6P;
        "pkg-fabric-1.6+1.20.1" = _2jnMh1lR;
        "pkg-fabric-1.6+1.21.1" = _X17rWdfX;
        "pkg-fabric-1.6+1.21.4" = _fKVCp0lC;
        "pkg-fabric-1.6+1.21.8" = _2YEkSpqG;
        "pkg-fabric-1.6+1.21.10" = _uPXqMqEG;
        "pkg-fabric-1.6+1.21.5" = _qroLKS6T;
        "pkg-fabric-1.6.1+1.21.1" = _itSMYFi8;
        "pkg-fabric-1.6.1+1.21.11" = _rh7qvOzr;
        "pkg-fabric-1.6.1+1.21.10" = _amTC1yYI;
        "pkg-fabric-1.6.1+1.20.1" = _iIFLgEaS;
        "pkg-fabric-1.6.1+1.21.5" = _OrMagufT;
        "pkg-fabric-1.6.1+1.21.8" = _ziuaiLiB;
        "pkg-fabric-1.6.1+1.21.4" = _MD7NNXkn;
        "pkg-paper-1.6.1" = _FoL8traR;
        "pkg-1.6.2+1.21.11-neoforge" = _H0GYyXYM;
        "pkg-1.6.2+1.21.1-fabric" = _YLmYFfue;
        "pkg-1.6.2+1.21.10-fabric" = _9ykI7rwv;
        "pkg-1.6.2+1.21.1-neoforge" = _w7tjt3H2;
        "pkg-1.6.2+1.21.11-fabric" = _2GuUAg13;
        "pkg-1.6.2+1.21.10-neoforge" = _KEC8F5GA;
        "pkg-1.6.2+1.21.5-fabric" = _gPqO5bf0;
        "pkg-1.6.2+1.21.4-neoforge" = _WsTPbARv;
        "pkg-1.6.2+1.21.4-fabric" = _bXuUFTwD;
        "pkg-1.6.2+1.21.5-neoforge" = _keM46Vmp;
        "pkg-1.6.2+1.21.8-fabric" = _XBamI5y3;
        "pkg-1.6.3+1.21.4-fabric" = _3mR1vAOt;
        "pkg-1.6.3+1.21.8-fabric" = _JvhN65Xd;
        "pkg-1.6.3+1.21.11-fabric" = _wtxzVwUN;
        "pkg-1.6.3+1.21.1-fabric" = _rsnGpsOc;
        "pkg-1.6.3+1.21.10-fabric" = _saCdl5X2;
        "pkg-1.6.3+1.21.5-fabric" = _qmRSC7Uf;
        "pkg-paper-1.6.2" = _TA8iVq8Y;
        "pkg-1.6.4+1.21.1-fabric" = _gTmqzSAX;
        "pkg-1.6.4+1.21.10-fabric" = _CRHCB6rR;
        "pkg-1.6.4+1.21.11-fabric" = _Ch7qPyUu;
        "pkg-1.6.4+1.21.10-neoforge" = _itsdLhde;
        "pkg-1.6.4+1.21.1-neoforge" = _IlQu0v4J;
        "pkg-1.6.4+1.21.11-neoforge" = _n4m8gm8F;
        "pkg-1.6.4+1.21.4-fabric" = _Y955dfQ8;
        "pkg-1.6.4+1.21.4-neoforge" = _do2HmiA0;
        "pkg-1.6.4+1.21.5-neoforge" = _605dR2ps;
        "pkg-1.6.4+1.21.5-fabric" = _YcMhf6mr;
        "pkg-1.6.4+1.21.8-fabric" = _1JO9202B;
        "pkg-1.6.4+1.21.8-neoforge" = _5ms9DFeF;
        "pkg-1.6.4+26.1-fabric" = _exumwhay;
        "pkg-1.6.5+26.1-fabric" = _avzQbGaA;
        "pkg-paper-1.6.3" = _iMS3EoIW;
        "pkg-1.6.6+26.2-fabric" = _W76SNUH7;
        "pkg-1.6.6+26.1-fabric" = _7zIxQoXe;
        "pkg-1.6.6+1.21.1-fabric" = _avVz7QlW;
        "pkg-1.6.6+1.21.11-fabric" = _6mH5Xg7N;
        "pkg-1.6.6+1.21.11-neoforge" = _8rTtUqoM;
        "pkg-1.6.6+1.21.1-neoforge" = _heJjmYZt;
        "pkg-1.6.7+26.2-fabric" = _pgrV6m6I;
        "pkg-1.6.7+1.21.1-neoforge" = _6Df6UqGc;
        "pkg-1.6.7+26.1-fabric" = _aqjfLH4Z;
