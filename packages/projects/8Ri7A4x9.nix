...
let
    ...
    in {
        ...
        "pkg-1.0-SNAPSHOT" = _nHlBTvD4;
        "pkg-1.0.2" = _zipFiDC9;
        "pkg-1.1.0" = _NabcLTPZ;
        "pkg-1.1.2" = _ZHzvLoQO;
        "pkg-neoforge-1.21-1.2.0" = _3PpZFZLQ;
        "pkg-fabric-1.21-1.2.0" = _XACH8MrE;
        "pkg-neoforge-1.21-1.2.1.1" = _90UhfBD3;
        "pkg-fabric-1.21-1.2.1.1" = _kk0SApFG;
        "pkg-neoforge-1.21-1.2.2" = _R9EhIQ14;
        "pkg-fabric-1.21-1.2.2" = _uPWfoJtG;
        "pkg-neoforge-1.21-1.2.3" = _eB40XmYq;
        "pkg-fabric-1.21-1.2.3" = _JizykVGt;
        "pkg-neoforge-1.21-1.2.4" = _qnW1UKte;
        "pkg-fabric-1.21-1.2.4" = _XU2hVRI7;
        "pkg-neoforge-1.21-1.2.5" = _b0RqRIHC;
        "pkg-fabric-1.21-1.2.5" = _GC2jQwIw;
        "pkg-neoforge-1.21-1.2.6" = _KiZ3Y2hs;
        "pkg-fabric-1.21-1.2.6" = _nunmolRP;
        "pkg-neoforge-1.21-1.2.6.1" = _xbh7nTa0;
        "pkg-fabric-1.21-1.2.6.1" = _exbi9Tjs;
        "pkg-neoforge-1.21-1.2.6.2" = _3f7IzCKs;
        "pkg-fabric-1.21-1.2.6.2" = _TogmeOyH;
        "pkg-neoforge-1.21-1.2.7" = _1tbzSa9D;
        "pkg-fabric-1.21-1.2.7" = _6ywER7V0;
        "pkg-neoforge-1.21.2-1.2.7" = _PjFilBTi;
        "pkg-fabric-1.21.2-1.2.7" = _qTvF1dCA;
        "pkg-neoforge-1.21.4-1.2.7" = _ErmbfNon;
        "pkg-fabric-1.21.4-1.2.7" = _t66zW5n9;
        "default" = _t66zW5n9;
    });
