...
let
    ...
    in {
        ...
        "pkg-7.0.8" = _QfQBwx1f;
        "pkg-7.0.9" = _qaOaQxVN;
        "pkg-7.0.10" = _Pwh9XbDK;
        "pkg-7.0.11" = _k1OtjRlu;
        "pkg-7.0.12" = _Ce5LWzK4;
        "pkg-7.0.13" = _459iRlm2;
        "pkg-7.0.14" = _9l5jjgcG;
        "pkg-7.0.15" = _Y2dMc3fJ;
        "pkg-7.0.16" = _8VwoCy6g;
        "pkg-7.0.17" = _9b1TwIZz;
        "pkg-7.0.18" = _k4IogROh;
        "pkg-7.0.19" = _SMQbOby6;
        "pkg-7.0.20" = _KKKIuPpw;
        "pkg-7.0.21" = _HnHL56Oq;
        "pkg-7.0.22" = _WAHZuK90;
        "pkg-7.0.23" = _LJTxMCGl;
        "pkg-7.0.25" = _s1zBGxnY;
        "pkg-7.0.26" = _6SB6Yfou;
        "pkg-7.1.0" = _S1GOrDBJ;
        "pkg-7.1.1" = _XswYB5SW;
        "pkg-7.1.2" = _Y1v3cCmo;
        "pkg-7.1.3" = _Xkgm3itf;
        ...
        "pkg-7.1.8" = _LOZQLx8l;
        "pkg-7.1.9" = _WaLyHl6u;
        "pkg-7.1.10" = _sosuIGTW;
        "pkg-7.1.11" = _848coesO;
        "pkg-7.1.12" = _VXWFSX0B;
        "pkg-7.1.13" = _c4iTlrxf;
        "pkg-7.1.14" = _7PFFn2BQ;
        "pkg-7.1.15" = _uNLbT44V;
        "pkg-7.1.16" = _w8C1VSww;
        "pkg-7.1.17" = _qDsd7Xuj;
        "pkg-7.1.18" = _TKmxTEe5;
        "pkg-7.1.19" = _pkBVCVxa;
        "pkg-7.1.20" = _PD2OzzgU;
        "pkg-7.2.0" = _RwuGOoE8;
        "pkg-7.2.1" = _aczb2T1I;
        "pkg-7.2.2" = _Wlv30th5;
        "pkg-7.2.3" = _vAqlfahg;
        ...
        "pkg-7.2.7" = _4ZzVwuVr;
        "pkg-7.2.8" = _H0bqhVjK;
        "pkg-7.1.21" = _YDonGmMi;
        "pkg-7.1.22" = _vYd8V9Zb;
        "pkg-7.1.23" = _tL8BOnnj;
        "pkg-7.1.24" = _QkCbJOx0;
        "pkg-7.1.25" = _AgEIhiJv;
        "pkg-7.1.26" = _XKDKPrha;
        "pkg-7.99.5" = _gd68TY8p;
        "pkg-7.99.6" = _zfPPCkz4;
        "pkg-7.99.7" = _Jl68DgWT;
        "pkg-7.99.8" = _oZOgGQd8;
        "pkg-7.99.8.1" = _ZdeMZfFL;
        "pkg-7.99.8.2" = _PoUpf8Tc;
        "pkg-7.99.12" = _NK6HSFuW;
        "pkg-7.99.13" = _iz7AGc75;
        "pkg-7.99.14" = _edpag2CI;
        "pkg-7.99.15" = _W8N21Si3;
        "pkg-7.99.16" = _N7Ae81FX;
        "pkg-7.99.17" = _7iIESS6d;
        "pkg-7.99.18" = _lHJSCUvU;
        "pkg-7.99.19" = _buLfNHn5;
        "pkg-7.99.20" = _9U8ejAKk;
        "pkg-7.99.21" = _ihErg24Z;
        "pkg-7.99.22" = _dWBJvsnT;
        "pkg-7.99.23" = _Mx1z4j82;
        "pkg-7.99.24" = _ZFesPasN;
        "pkg-7.99.24.1" = _FF75vap1;
        "pkg-7.99.24.2" = _vWm5dwyh;
        "pkg-7.99.24.3" = _HB9n5hJp;
        "pkg-7.99.24.4" = _NFU38dqy;
        "pkg-7.99.24.5" = _2DcYQodd;
        "pkg-7.99.24.6" = _dcMReptE;
        "pkg-7.99.24.7" = _PTMKu0Nj;
        "pkg-7.99.24.8" = _XTuMYCPy;
        "pkg-7.1.27" = _LmhuTj3G;
        "pkg-8.0.0" = _3J0W6YR1;
        "default" = _3J0W6YR1;
    });
