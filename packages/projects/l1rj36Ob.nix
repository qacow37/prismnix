...
let
    ...
    in {
        ...
        "pkg-1.0.4+forge+1.18.0-1" = _sy1Uomje;
        "pkg-1.0.4+fabric+1.18.0-1" = _niLphfw9;
        "pkg-1.0.4+forge+1.18.2" = _paBI0xMy;
        "pkg-1.0.4+fabric+1.18.2" = _KAiycgAx;
        "pkg-1.1.0+forge+1.19" = _DuyGBbQX;
        "pkg-1.1.0+fabric+1.19" = _4bB4IiBq;
        "pkg-1.0.5+forge+1.18.2" = _6Aj3HtQ7;
        "pkg-1.0.5+fabric+1.18.2" = _8Ejtz0mY;
        "pkg-1.1.1+forge+1.19" = _kImT44Y4;
        "pkg-1.1.1+fabric+1.19" = _wxACwpxt;
        "pkg-1.2.0+forge+1.19.2" = _luKlaUe2;
        "pkg-1.2.0+fabric+1.19.2" = _OAOMoQkE;
        "pkg-1.0.6+forge+1.18.2" = _eec2yBeO;
        "pkg-1.0.6+fabric+1.18.2" = _qC6XyUQx;
        "pkg-1.1.2+forge+1.19" = _1PnMPc17;
        "pkg-1.1.2+fabric+1.19" = _jhAdusFM;
        "pkg-1.2.1+forge+1.19.2" = _uyb5VT92;
        "pkg-1.2.1+fabric+1.19.2" = _Yrca90bX;
        "pkg-1.0.7+forge+1.18.2" = _G1Yphyo1;
        "pkg-1.0.7+fabric+1.18.2" = _SLeWDjvS;
        "pkg-1.1.3+forge+1.19" = _d2yCdssm;
        "pkg-1.1.3+fabric+1.19" = _EuB0XDWJ;
        "pkg-1.2.2+forge+1.19.2" = _S3eraBzo;
        "pkg-1.2.2+fabric+1.19.2" = _BIv1brha;
        "pkg-1.18.2+forge+2.0.0-beta-8.2" = _YE1hl6kL;
        "pkg-1.18.2+fabric+2.0.0-beta-8.2" = _KXY4npNy;
        "pkg-1.19.2+forge+2.0.0-beta-8.2" = _h7lTrbSJ;
        "pkg-1.19.2+fabric+2.0.0-beta-8.2" = _5O5wLX9z;
        "pkg-1.19.3+forge+2.0.0-beta-8.2" = _kH7Wlz2l;
        "pkg-1.19.3+fabric+2.0.0-beta-8.2" = _CxMhi6Ey;
        "pkg-1.18.2+forge+2.0.0-beta-8.3" = _DCi1KmVn;
        "pkg-1.18.2+fabric+2.0.0-beta-8.3" = _FWENwA69;
        "pkg-1.19.2+forge+2.0.0-beta-8.3" = _ckw1NUdH;
        "pkg-1.19.2+fabric+2.0.0-beta-8.3" = _4RmT63Og;
        "pkg-1.19.4+forge+2.0.0-beta-8.3" = _LMXXxMsU;
        "pkg-1.19.4+fabric+2.0.0-beta-8.3" = _mq2O1m2g;
        "pkg-1.18.2+fabric+2.0.0-beta-8.4" = _i3PP7IeC;
        "pkg-1.18.2+forge+2.0.0-beta-8.4" = _RjGMlQkH;
        "pkg-1.19.2+fabric+2.0.0-beta-8.4" = _7nar2bj6;
        "pkg-1.19.2+forge+2.0.0-beta-8.4" = _b1JTPMBr;
        "pkg-1.19.4+fabric+2.0.0-beta-8.4" = _2LXvBR4e;
        "pkg-1.19.4+forge+2.0.0-beta-8.4" = _XPZv5cwo;
        "pkg-1.20.1+fabric+2.0.0-beta-8.4" = _5Z67tZK6;
        "pkg-1.20.1+forge+2.0.0-beta-8.4" = _5XW3Z9uI;
        "pkg-1.20.1+forge+2.0.0-beta-8.4.1" = _McdLGKv5;
        "pkg-1.20.1+fabric+2.0.0-beta-8.4.1" = _4opJruu2;
        "pkg-2.0.0-beta.900" = _8I3gSxit;
        "pkg-2.0.0-beta.901" = _KrA3wQ5g;
        "pkg-2.0.0-beta.902" = _J1vmb9Fu;
        "pkg-2.0.0-beta.903" = _tycVUDMt;
        "pkg-2.0.0-beta.904" = _Y5zCl3gF;
        "pkg-2.0.0-beta.910" = _dQ41WNcA;
        "pkg-2.0.0-beta.920" = _gRWfeZh2;
        "pkg-2.0.0-beta.921" = _j3UeLYRB;
        "pkg-2.0.0-beta.922" = _z9xtzBS1;
        "default" = _z9xtzBS1;
    });
