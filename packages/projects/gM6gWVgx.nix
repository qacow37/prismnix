...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _CO8Z4RZW;
        "pkg-2.0.0" = _9U4KJxpZ;
        "pkg-2.0.0+26.1-fabric" = _IVeUrcS0;
        "pkg-2.0.0+1.21.1-fabric" = _Bop0ErpO;
        "pkg-2.0.0+1.21.2-fabric" = _Q5Ik7AGs;
        "pkg-2.0.0+1.21.6-fabric" = _bKANMpXv;
        "pkg-2.0.0+1.21.11-fabric" = _j8y860N0;
        "pkg-2.0.0+1.21.5-fabric" = _ylUx47KO;
        "pkg-2.0.0+1.21.10-fabric" = _cXxdhTMp;
        "pkg-2.0.0+1.20.1-fabric" = _cDkOe3A2;
        "pkg-2.0.0+1.20.1-forge" = _hoLoHDRL;
        "pkg-2.0.0+1.21.1-neoforge" = _5JZKVJqA;
        "pkg-2.0.1+1.20.1-forge" = _eO0Ibx2l;
        "pkg-2.0.1+1.21.1-neoforge" = _bCgftCmJ;
        "pkg-2.0.1+1.21.10-fabric" = _na7qbYxC;
        "pkg-2.0.1+1.21.2-fabric" = _81dxNSj2;
        "pkg-2.0.1+1.21.1-fabric" = _hQetQRX2;
        "pkg-2.0.1+1.20.1-fabric" = _tevZOyYz;
        "pkg-2.0.1+1.21.11-fabric" = _qEwkzd2h;
        "pkg-2.0.1+1.21.5-fabric" = _gCbJnL7O;
        "pkg-2.0.1+1.21.6-fabric" = _3xzv3Q00;
        "pkg-2.0.1+26.1-fabric" = _6XsR2618;
        "pkg-2.0.2+1.20.1-forge" = _Z1vEPfQf;
        "pkg-2.0.2+1.21.1-neoforge" = _npbt3kIV;
        "pkg-2.0.2+26.1-fabric" = _Br94VMA3;
        "pkg-2.0.2+1.21.10-fabric" = _wFXWV7GV;
        "pkg-2.0.2+1.21.11-fabric" = _nuN5upVb;
        "pkg-2.0.2+1.20.1-fabric" = _mp0Zrm1I;
        "pkg-2.0.2+1.21.1-fabric" = _SGB0D7EW;
        "pkg-2.0.2+1.21.2-fabric" = _bxUVlzqf;
        "pkg-2.0.2+1.21.5-fabric" = _QqI8zJnF;
        "pkg-2.0.2+1.21.6-fabric" = _q0i5wNym;
        "default" = _q0i5wNym;
    });
