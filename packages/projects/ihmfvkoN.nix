...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _M9M2rnoz;
        "pkg-1.1.0" = _sPjy7Tlj;
        "pkg-1.1.0+mod" = _bbOm5Ylz;
        "pkg-1.0.1+mod" = _SGXCO0dD;
        "pkg-1.0.0+mod" = _42HB9gHf;
        "pkg-1.1.1" = _E6SDnV6R;
        "pkg-1.1.1+mod" = _CozLs81O;
        "pkg-1.1.2" = _Y3HmD3wF;
        "pkg-1.1.2+mod" = _Sk6O9V0b;
        "pkg-1.2.0" = _YTjQqcCn;
        "pkg-1.2.0+mod" = _DiJHsHKO;
        "pkg-1.2.1" = _g5I8j5GH;
        "pkg-1.2.1+mod" = _JXOWtUlO;
        "pkg-1.2.2" = _a39q8Xye;
        "pkg-1.2.2+mod" = _EqKja7iM;
        "pkg-1.2.3" = _zvYYYc7q;
        "pkg-1.2.3+mod" = _qWQkC8F1;
        "pkg-1.2.4" = _nI6515k7;
        "pkg-1.2.4+mod" = _rV5Mgj1C;
        "pkg-1.2.5" = _NaswFg04;
        "pkg-1.2.5+mod" = _t72lNrP6;
        "pkg-1.2.6" = _1xb9nIDq;
        "pkg-1.2.6+mod" = _Qtr8sIC3;
        "pkg-1.2.7" = _I8DWrmQ0;
        "pkg-1.2.7+forge" = _pyx0skwD;
        "pkg-1.2.7+fabric" = _bNzSEHh5;
        "pkg-1.2.7+quilt" = _z76d8d6Q;
        "pkg-1.2.7+neoforge" = _SQdkcVTh;
        "default" = _SQdkcVTh;
    });
