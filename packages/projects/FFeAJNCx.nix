...
let
    ...
    in {
        ...
        "pkg-0.0.4" = _twwkfCfS;
        "pkg-0.0.5" = _2ndG2gRE;
        "pkg-0.0.10" = _ERf032O4;
        "pkg-0.0.11" = _h5DswyVu;
        "pkg-0.0.12" = _pSLDVn9q;
        "pkg-0.0.13" = _BCiAOdHD;
        "pkg-0.0.14" = _G9TrZzqI;
        "pkg-1.0.0" = _DXlFj2Vd;
        "pkg-1.0.1" = _SF2MEbKh;
        "pkg-1.0.2" = _p4AQQbiO;
        "pkg-1.0.3" = _so8oelWQ;
        ...
        "pkg-3.5.8" = _eVsJDXOq;
        "pkg-3.5.9" = _jmxdAhMg;
        "pkg-3.5.10" = _TnFx9XfJ;
        "pkg-3.5.13" = _vrWOXTQ7;
        "pkg-3.5.14" = _mxr12sx1;
        "pkg-3.5.15" = _FEbRxZQM;
        "pkg-3.6.0" = _viCbImym;
        "pkg-3.6.2" = _MArIVN8T;
        "pkg-3.6.3" = _cxQcG6FU;
        "pkg-3.7.0" = _fCXEQzRd;
