...
let
    ...
    in {
        ...
        "pkg-v1.2.1" = _3lUQXkr5;
        "pkg-v1.2.2" = _8aEjaWCe;
        "pkg-v1.3.0" = _SnsitZtd;
        "pkg-v1.3.1" = _LwI2fIyX;
        "pkg-v1.3.2" = _6EQNZ9Fp;
        "pkg-v1.3.3" = _qGYRhAea;
        "pkg-v1.4.0" = _xw1Bq1ss;
        "pkg-v1.4.0+mod" = _JGGW0FjO;
        "pkg-v1.4.1" = _JnAuzTWC;
        "pkg-v1.4.1+mod" = _BCpqBELz;
        "pkg-v1.5.0" = _QmXwFgxE;
        "pkg-v1.5.0+mod" = _egileK9E;
        "pkg-v1.6.0" = _U9GaA95X;
        "pkg-v1.6.0+mod" = _nikxsbuS;
        "pkg-v2.0.0" = _4AmYhSTk;
        "pkg-v2.0.0+mod" = _lKYSU3K4;
        "pkg-v2.1.0" = _JjVwdkC1;
        "pkg-v2.1.0+mod" = _Padco8Ns;
        "pkg-v2.1.1" = _1aOL9EPn;
        "pkg-v2.1.1+mod" = _agOq969N;
        "pkg-v2.1.2" = _QM5VmHW8;
