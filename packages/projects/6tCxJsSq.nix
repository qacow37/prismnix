...
let
    ...
    in {
        ...
        "pkg-0.1.0-mc1.20" = _10pbkb4e;
        "pkg-0.2.0-mc1.20" = _oHu6j9O4;
        "pkg-0.0.3-mc1.19.2" = _SEypxIEh;
        "pkg-1.0.0-mc1.21.11" = _qJvDYW3Y;
        "pkg-1.1.0-mc1.21.11" = _MSf6fYWa;
        "pkg-1.1.0-mc26.2" = _5whvQMJ8;
