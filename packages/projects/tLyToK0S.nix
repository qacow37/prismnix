...
let
    ...
    in {
        ...
        "pkg-0.5.0" = _cWSBvjRd;
        "pkg-1.0.0" = _sNV3D0ld;
        "pkg-1.0.1-notworking" = _lUTcTRoZ;
        "pkg-1.0.1" = _IddlaNrz;
        "pkg-1.1.0" = _ksNZ7ti5;
        "pkg-1.2.0" = _NwlfJrSc;
        "pkg-1.2.1" = _rC0snkSV;
        ...
        "pkg-1.4.0" = _EpUNwXvE;
        "pkg-2.0.0" = _moSwqn2N;
        "pkg-2.0.0+forge" = _EsggNamd;
        "pkg-2.0.1" = _JhVhRKtJ;
        "pkg-2.0.1+forge" = _F65lGLhy;
        "pkg-2.0.2+forge" = _gcO5UYr5;
        "pkg-2.1.0+fabric_1.20.1" = _2G3h9aX5;
        "pkg-2.1.1+fabric_1.20.1" = _naVC4uPy;
        "pkg-2.2.0+fabric_1.20.1" = _SCJ0wWMh;
        "pkg-2.2.1+fabric_1.20.1" = _iszDRe3V;
        "pkg-2.2.2+fabric_1.20.1" = _RV72MYqK;
        "pkg-2.2.3+fabric_1.20.1" = _U3JdIuGK;
        "pkg-2.2.4+fabric_1.20.4" = _xLdjDYML;
        "pkg-2.2.4+fabric_1.20.2" = _funrWfPU;
        "pkg-3.0.0+fabric_1.20+nocca" = _IquAMyqi;
        "pkg-3.0.0+fabric_1.20.4" = _a0hFKTjX;
        "pkg-3.0.1+fabric_1.20.4+nocca" = _2w6aOzLc;
        "pkg-3.0.1+fabric_1.20.4" = _W3tdq8JO;
        "pkg-3.0.1+fabric_1.20.1" = _9NHX8Bg5;
        "pkg-3.0.1+fabric_1.20.1+nocca" = _zukdP44e;
        "pkg-3.0.1+fabric_1.19.2" = _itqF8dMm;
        "pkg-3.1.0+fabric_1.20.6" = _nZUq5Sap;
        "pkg-3.1.0+fabric_1.20.6+nocca" = _WHWKBcDH;
        "pkg-3.1.1+fabric_1.20.6" = _sMzSM1Mw;
        "pkg-3.1.1+fabric_1.20.6+nocca" = _VXPA9MHw;
        "pkg-3.1.1+fabric_1.21" = _uaYqUueG;
        "pkg-3.1.1+fabric_1.21+nocca" = _OC0HEwAn;
        "pkg-3.2.0+fabric_1.21+nocca" = _88oYCyTl;
        "pkg-3.2.0+fabric_1.21" = _3YAAD3HD;
        "pkg-3.2.0+fabric_1.20.1+nocca" = _nKO66YDh;
        "pkg-3.2.0+fabric_1.20.1" = _4YwRDoMH;
        "pkg-3.2.0+fabric_1.19.2+nocca" = _nWonCNwv;
        "pkg-3.2.0+fabric_1.19.2" = _hfr0VDwK;
        "pkg-3.2.1+fabric_1.19.2+nocca" = _jmVZLWC4;
        "pkg-3.2.1+fabric_1.20.1+nocca" = _aQjYNFFm;
        "pkg-3.2.1+fabric_1.21+nocca" = _rqj8SnIc;
        "pkg-3.2.1+fabric_1.19.2" = _peua6XGM;
        "pkg-3.2.1+fabric_1.20.1" = _Bpn6II1k;
        "pkg-3.2.1+fabric_1.21" = _WxqTKTJc;
        "pkg-3.2.1+1.21.4" = _lvZcrP2r;
        "pkg-3.2.1+1.21.5" = _6le0kvSg;
        "pkg-3.2.1+1.21.5+nocca" = _3xZcy9jj;
        "pkg-3.2.1+1.21.11" = _o2EVsVEZ;
        "pkg-3.2.1+26.1" = _OYZh3L9f;
        "default" = _OYZh3L9f;
    });
