...
let
    ...
    in {
        ...
        "pkg-1.18.1-1.2.2.0" = _z67KE11f;
        "pkg-1.19-1.3.2.0" = _FM8Dd106;
        "pkg-1.19-1.3.2.1" = _xgmAZPC9;
        "pkg-1.18.1-1.2.2.1" = _tcxiR0cm;
        "pkg-1.19.3-1.3.3.0" = _MzyzgGVF;
        "pkg-1.19.3-1.3.3.1" = _sWYfU3k5;
        "pkg-1.19.4-1.4.0.0" = _KhaFaXwz;
        "pkg-1.20-1.5.0.0" = _GuFnPajN;
        "pkg-1.20.1-1.5.1.0" = _qwc8WnsE;
        "pkg-1.20.1-1.6.0.0" = _MzT85mjX;
        "pkg-1.20.1-1.6.0.1" = _pLSXXFEn;
        "pkg-1.19.4-1.4.0.1" = _hQpXBHfK;
        "pkg-1.20.2-1.7.0.0" = _fJMK4msK;
        "pkg-1.20.2-2.0.0.0" = _rhFV5ATi;
        "pkg-1.20.2-2.0.0.1" = _kzf7MPin;
        "pkg-1.20.4-2.1.0.0" = _aSDbBkiH;
        "pkg-1.20.4-2.1.0.1" = _u4dYRVwv;
        "pkg-1.20.4-2.2.0.0" = _JjVcqiC2;
        "pkg-1.20.4-2.2.0.1" = _8vbPKUbl;
        "pkg-1.20.4-2.2.1.0" = _BumHSxIj;
        "pkg-1.20.6-2.3.0.0" = _dIXskxnW;
        "pkg-1.21-3.0.0.0" = _TblL3uDG;
        "pkg-1.21-3.1.0.0" = _ZV8YcKWt;
        "pkg-1.21-3.1.1.0" = _feZfrfEl;
        "pkg-1.21.1-3.2.0.0" = _bJfe05J7;
        "pkg-1.21.3-3.3.0.0" = _iRxbqd6r;
        "pkg-1.21.4-3.4.0.0" = _1S38NvmO;
        "pkg-1.21.5-3.5.0.0" = _pEUstX86;
        "pkg-1.21.6-3.6.0.0" = _z3sfzC8G;
        "pkg-1.20.6-2.3.1.0" = _AtpfwBUy;
        "pkg-1.21.5-3.5.1.0" = _8A9cgn4c;
        "pkg-1.21.6-3.6.1.0" = _OpGx7pm5;
        "pkg-1.21.1-3.2.1.0" = _Ig0VLHEQ;
        "pkg-1.21.3-3.3.1.0" = _s5pwxiF0;
        "pkg-1.20.4-2.2.2.0" = _OsDwnhWY;
        "pkg-1.21.4-3.4.1.0" = _qS1aQmG2;
        "pkg-1.21.9-3.7.0.0" = _EzYUNA9V;
