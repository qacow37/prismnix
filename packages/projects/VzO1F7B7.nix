...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta1" = _1U72D51I;
        "pkg-1.0.0-beta2" = _yaqrKli0;
        "pkg-1.0.0-beta3" = _TOxDkrL9;
        "pkg-1.0.0-beta4" = _zjjzq8eJ;
        "pkg-1.0.0-beta5" = _WzYFUISF;
        "pkg-1.0.0-beta6+1.20.1" = _RrplPUYU;
        "pkg-1.0.0-beta6+1.21.1" = _DXyylk7g;
        "pkg-1.0.0-beta7+1.21.1" = _eUVfZwMe;
        "pkg-1.0.0-beta7+1.20.1" = _AxhF45iW;
        "pkg-1.0.0-beta7+1.20.4" = _2NaU1Mxq;
        "pkg-1.0.0-beta7+1.21.9" = _Ak4571Dl;
        "pkg-1.0.0+1.20.1" = _fs7h8NsL;
        "pkg-1.0.0+1.21.1" = _tAYaTF7y;
        "pkg-1.0.0+1.20.4" = _nGOhHwni;
        "pkg-1.0.0+1.21.9" = _Dv5Hm21S;
        "pkg-1.0.1+1.20.4" = _3QdpzowM;
        "pkg-1.0.1+1.20.1" = _FCfmpcVo;
        "pkg-1.0.1+1.21.9" = _3nGSmOVh;
        "pkg-1.0.1+1.21.1" = _M89qso01;
        "pkg-1.0.2+1.21.1" = _JC1lswU5;
        "pkg-1.0.2+1.21.7" = _xDLE53RR;
        "pkg-1.0.2+1.21.9" = _vjkMiyZ4;
        "pkg-1.0.2+1.20.4" = _Oi10w6sH;
        "pkg-1.0.2+1.20.1" = _lZa0f4kK;
        "pkg-1.0.3+1.21.7" = _nMhcObtC;
        "pkg-1.0.3+1.21.1" = _z4hoVQWg;
        "pkg-1.0.3+1.21.9" = _MRh2Eems;
        "pkg-1.0.3+1.20.1" = _1L5FtzmD;
        "pkg-1.0.3+1.20.4" = _CczXiHBz;
        "pkg-1.1.0+1.21.11" = _wVPOjZj0;
        "pkg-1.1.0+1.21.1" = _UUnozvLf;
        "pkg-1.1.0+1.20.1" = _nhdLvcav;
        "pkg-1.1.0+1.21.9" = _Herub0dt;
        "pkg-1.1.0+1.21.7" = _ktOfMcxk;
        "pkg-1.1.0+1.20.4" = _Iu4BzbM6;
        "default" = _Iu4BzbM6;
    });
