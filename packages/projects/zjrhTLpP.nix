...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.21.4" = _vJBHiapD;
        "pkg-1.0.0+mc1.21" = _FGePnLW5;
        "pkg-1.0.0+mc1.21.1" = _JHSGO9kb;
        "pkg-1.0.0+mc1.21.2" = _ttv5mmm8;
        "pkg-1.0.0+mc1.21.3" = _3Ed7vaTN;
        "pkg-1.0.0+mc1.21.5" = _9vuxdalh;
        "pkg-1.0.0+mc1.21.6" = _c3Foioph;
        "pkg-1.0.0+mc1.21.7" = _F6VqLoqO;
        "pkg-1.0.0+mc1.21.8" = _LR3q87lr;
        "pkg-1.0.0+mc1.21.9" = _cE5J9zS1;
        "pkg-1.0.0+mc1.21.10" = _UztxjB8Q;
        "pkg-1.0.0+mc1.21.11" = _AaYdeH2t;
        "pkg-1.0.2+mc1.21" = _kfxLE7fR;
        "pkg-1.0.2+mc1.21.1" = _N2jgWoOQ;
        "pkg-1.0.2+mc1.21.2" = _z1hFCcsq;
        "pkg-1.0.2+mc1.21.3" = _Ntu9Ud8V;
        "pkg-1.0.2+mc1.21.4" = _FW63o9r1;
        "pkg-1.0.2+mc1.21.5" = _tlYCuuPs;
        "pkg-1.0.2+mc1.21.6" = _zvcEfufV;
        "pkg-1.0.2+mc1.21.7" = _dpVK5Hl9;
        "pkg-1.0.2+mc1.21.8" = _w8gVOKXS;
        "pkg-1.0.2+mc1.21.9" = _NntyfYb7;
        "pkg-1.0.2+mc1.21.10" = _g48Jan3s;
        "pkg-1.0.2+mc1.21.11" = _NtYebpki;
        "pkg-1.0.2-mc1.20" = _F1qixuSs;
        "pkg-1.0.2-mc1.20.1" = _B576JXJK;
        "pkg-1.0.2-mc1.20.2" = _AoIlz864;
        "pkg-1.0.2-mc1.20.3" = _ZfVHA9Bw;
        "pkg-1.0.2-mc1.20.4" = _9IOMUqID;
        "pkg-1.0.2-mc1.20.5" = _5TqCFNpW;
        "pkg-1.0.2-mc1.20.6" = _ceCd8IIX;
        "pkg-1.1.0+mc26.1.x" = _j78evHl8;
        "default" = _j78evHl8;
    });
