...
let
    ...
    in {
        ...
        "pkg-1.0.5-mc1.19.4" = _WgrZ7rGK;
        "pkg-1.0.5-mc1.20.1" = _3diVP2GJ;
        "pkg-1.0.6-mc1.19.4" = _FC1zqKPz;
        "pkg-1.0.6-mc1.20.1" = _pIv8loe9;
        "pkg-1.0.7-mc1.19.4" = _A7f1y8Zr;
        "pkg-1.0.7-mc1.20.1" = _PQSaWavG;
        "pkg-1.0.8-mc1.19.4" = _6R26UbPd;
        "pkg-1.0.8-mc1.20.1" = _ZvavCpAu;
        "pkg-1.0.9-mc1.19.4" = _DsY1fKKI;
        "pkg-1.0.9-mc1.20.1" = _1bN6Y1zS;
        "pkg-1.0.12-mc1.20.1" = _ZLA5Lduf;
        "pkg-1.0.13-mc1.19.4" = _e1gNXuS7;
        "pkg-1.0.13-mc1.20.1" = _UkjucZbU;
        "pkg-1.0.14-mc1.19.4" = _G175f3eO;
        "pkg-1.0.14-mc1.20.1" = _XCFLsMeh;
        "pkg-1.0.15-mc1.19.4" = _MDuIaD0e;
        "pkg-1.0.15-mc1.20.1" = _SdOmbKR0;
        "pkg-1.0.18+1.17.1+fabric" = _Zx2aply2;
        "pkg-1.0.18+1.17.1+foge" = _ebdRUuj8;
        "pkg-1.0.18+1.18.2+fabric" = _GH5tvH66;
        "pkg-1.0.18+1.18.2+forge" = _8zXlomhw;
        "pkg-1.0.18+1.19.4+fabric" = _VCbufBnU;
        "pkg-1.0.18+1.19.4+forge" = _PFH8qE31;
        "pkg-1.0.18+1.20+fabric" = _LrAb1k3R;
        "pkg-1.0.18+1.20+forge" = _rSetTKht;
        "pkg-1.0.18+1.20.2+fabric" = _qOcQxymH;
        "pkg-1.0.18+1.20.2+forge" = _1fx62Pre;
        "pkg-1.0.18+1.20.4+fabric" = _p1hSnI9i;
        "pkg-1.0.18+1.20.4+forge" = _mCbSyspB;
        "pkg-1.0.30+1.17.1+fabric" = _zhANYb1V;
        "pkg-1.0.30+1.18.2+fabric" = _dKuSJyS7;
        "pkg-1.0.30+1.19.4+fabric" = _sYuOrpns;
        "pkg-1.0.30+1.20+fabric" = _j8JUdKOP;
        "pkg-1.0.30+1.20.2+fabric" = _JQxSQ9V6;
        "pkg-1.0.30+1.20.4+fabric" = _u9Vp2Nkk;
        "pkg-1.1+1.20.1+fabric" = _MHJfzvWp;
        "pkg-1.1+1.20.4+fabric" = _TdRqZznw;
        "pkg-1.1+1.21+fabric" = _SC69kR1x;
        "pkg-1.1+1.21.2+fabric" = _pNekQ7Hc;
        "pkg-1.1+1.21.4+fabric" = _vHyFS02S;
        "pkg-1.2-b.1.20.1-fabric" = _WlkY6iaT;
        "pkg-1.2-b.1.21.1-fabric" = _B2aQ1EVP;
        "pkg-1.2-b.1.21.1-neoforge" = _irmbg5bY;
        "pkg-1.2-b.1.21.3-fabric" = _8F4eZmid;
        "pkg-1.2-b.1.21.3-neoforge" = _nlM3jc12;
        "pkg-1.2-b.1.21.4-fabric" = _NA4YH0Xi;
        "pkg-1.2-b.1.21.4-neoforge" = _9EpGFoeZ;
        "pkg-1.2-b.1.21.5-fabric" = _OEhnnokX;
        "pkg-1.2-b.1.21.5-neoforge" = _afUsoVNN;
        "pkg-1.2-b.1.21.8-fabric" = _dsuL3BYZ;
        "pkg-1.2-b.1.21.8-neoforge" = _dnXYbhuy;
        "pkg-1.2.1-b.1.20.1-fabric" = _5sbnzLZs;
        "pkg-1.2.1-b.1.21.1-fabric" = _oLtHgoxp;
        "pkg-1.2.1-b.1.21.1-neoforge" = _60WqLyeW;
        "pkg-1.2.1-b.1.21.10-fabric" = _rzbpqwWf;
        "pkg-1.2.1-b.1.21.10-neoforge" = _JNx3r60S;
        "pkg-1.2.1-b.1.21.3-fabric" = _RTFiGVyC;
        "pkg-1.2.1-b.1.21.3-neoforge" = _qllrhxQh;
        "pkg-1.2.1-b.1.21.4-fabric" = _u4yKq6Qa;
        "pkg-1.2.1-b.1.21.4-neoforge" = _817V2oyc;
        "pkg-1.2.1-b.1.21.5-fabric" = _Cqv03ukg;
        "pkg-1.2.1-b.1.21.5-neoforge" = _9lJFKn7M;
        "pkg-1.2.1-b.1.21.8-fabric" = _xLa4Bh0D;
        "pkg-1.2.1-b.1.21.8-neoforge" = _tMlgQnHC;
        "pkg-1.2.2-b.1.20.1-fabric" = _IKkX1zNX;
        "pkg-1.2.2-b.1.20.1-forge" = _jOEDRjvI;
        "pkg-1.2.2-b.1.21.1-fabric" = _40rxaCYj;
        "pkg-1.2.2-b.1.21.1-neoforge" = _UqKxcf6F;
        "pkg-1.2.2-b.1.21.10-fabric" = _rFsV02vc;
        "pkg-1.2.2-b.1.21.10-neoforge" = _P0H6m5gT;
        "pkg-1.2.2-b.1.21.11-fabric" = _6EuDAJkz;
        "pkg-1.2.2-b.1.21.11-neoforge" = _jEIf84wP;
        "pkg-1.2.2-b.1.21.3-fabric" = _Fz3kBmA4;
        "pkg-1.2.2-b.1.21.3-neoforge" = _ygjiZ3ts;
        "pkg-1.2.2-b.1.21.4-fabric" = _PQOLn0yF;
        "pkg-1.2.2-b.1.21.4-neoforge" = _4FJbIzsy;
        "pkg-1.2.2-b.1.21.5-fabric" = _13dFgalq;
        "pkg-1.2.2-b.1.21.5-neoforge" = _UlaeDpjs;
        "pkg-1.2.2-b.1.21.8-neoforge" = _HLoQ129Q;
        "pkg-1.2.2-b.1.21.8-fabric" = _l6n4iryC;
        "pkg-1.2.3-b.1.20.1-fabric" = _mbtqmCmG;
        "pkg-1.2.3-b.1.20.1-forge" = _oufJKHlG;
        "pkg-1.2.3-b.1.21.1-fabric" = _THI9kiFM;
        "pkg-1.2.3-b.1.21.1-neoforge" = _mTHolcQA;
        "pkg-1.2.3-b.1.21.10-fabric" = _w2ZqrSMz;
        "pkg-1.2.3-b.1.21.10-neoforge" = _RCgI7gg4;
        "pkg-1.2.3-b.1.21.11-fabric" = _PszOMnXZ;
        "pkg-1.2.3-b.1.21.11-neoforge" = _fUVvCPQU;
        "pkg-1.2.3-b.1.21.3-fabric" = _8g1l4Yws;
        "pkg-1.2.3-b.1.21.3-neoforge" = _7c0C1VUu;
        "pkg-1.2.3-b.1.21.4-fabric" = _TRLazqiC;
        "pkg-1.2.3-b.1.21.4-neoforge" = _wWAwpTch;
        "pkg-1.2.3-b.1.21.5-fabric" = _2C9R4TEO;
        "pkg-1.2.3-b.1.21.5-neoforge" = _i9vBMPBO;
        "pkg-1.2.3-b.1.21.8-fabric" = _AAGiJMsM;
        "pkg-1.2.3-b.26.1-fabric" = _S3mooElt;
        "pkg-1.2.3-b.1.21.8-neoforge" = _bQH33FcM;
        "pkg-1.2.3-b.26.1-neoforge" = _bUMk1ESR;
        "default" = _bUMk1ESR;
    });
