...
let
    ...
    in {
        ...
        "pkg-2.2.0.0-1.16.5" = _iL0NUBPU;
        "pkg-2.2.0.2-1.16.5" = _P6n2BIyz;
        "pkg-2.2.0.3-1.16.5" = _IsBOxwYb;
        "pkg-2.2.0.4-1.16.5" = _g9DCwaPM;
        "pkg-2.2.1-1.16.5" = _ZBlADqpP;
        "pkg-2.2.2-1.16.5" = _ooyi9neG;
        "pkg-2.3.0-1.20" = _HLVh83B4;
        "pkg-2.3.1-1.20" = _eCaabeJ9;
        "pkg-2.3.2-1.20" = _UyUNZyBK;
        "pkg-2.2.3-1.16.5" = _LhPBlkVW;
        "pkg-2.3.3-1.20" = _uo15mRqU;
        "pkg-2.2.4-1.16.5" = _kktQVKeb;
        "pkg-2.3.4-1.20" = _D41doRYQ;
        "pkg-2.3.5-1.20" = _q6u8l3V0;
        "pkg-2.2.5-1.16.5" = _w5yDeG1U;
        "pkg-2.3.6-1.20" = _kk6y3rks;
        "pkg-2.3.6.1-1.20.2" = _1dV661tz;
        "pkg-2.3.6.2-1.20.2" = _oLOgRLQB;
        "pkg-2.3.7-1.20.2" = _Z9Qttqox;
        "pkg-2.3.7.1-1.20.2-Fabric" = _N9PQ5HeL;
        "pkg-2.3.7.2-1.20.2-Fabric" = _mhy4pM2h;
        "pkg-2.3.7.2-1.20.2" = _GpqmJz3d;
        "pkg-2.2.6-1.16.5" = _sdyDKH0s;
        "pkg-2.4.0-1.21-Fabric" = _5BN8MhHv;
        "pkg-2.4.1-1.21-Fabric" = _4TgkJGTV;
        "pkg-2.4.2-1.21.4-Fabric" = _lGAXI933;
        "pkg-2.5.0-1.21.4-Fabric" = _VnUVSuc1;
        "pkg-2.5.0-1.21.1-Fabric" = _87Ed8bP4;
        "pkg-2.5.0-1.21.5" = _FO0G96oO;
        "pkg-2.5.1-1.21.1" = _wvwWqknj;
        "pkg-2.5.1-1.21.4" = _h5JEuhox;
        "pkg-2.5.1-1.21.5-Fabric" = _sBNxtrGU;
        "pkg-2.5.1-1.21.8-Fabric" = _Sz2mXuaM;
        "pkg-2.5.2-1.21.8-Fabric" = _Llo36gBU;
        "pkg-2.5.2-1.21.5-Fabric" = _2UWQc2fw;
        "pkg-2.5.2-1.21.4-Fabric" = _QzdZH83u;
        "pkg-2.5.2-1.21.1-Fabric" = _fiqhwrNF;
        "pkg-2.5.1-1.21.9-Fabric" = _5UibbbAT;
        "pkg-2.5.0-25w45a-Fabric" = _UFFOEnep;
        "pkg-2.6.0-25w46a-Fabric" = _Xl84v8DY;
        "pkg-2.6.0-1.21.9-Fabric" = _7P3n4KEp;
        "pkg-2.6.0-1.21.8-Fabric" = _WIdhlNmB;
        "pkg-2.6.0-1.21.1-Fabric" = _ca7xV1N2;
        "pkg-2.6.0-1.20.1-Fabric" = _nBcILnrv;
        "pkg-2.6.0-1.20.1-Forge" = _dWVsJp67;
        "pkg-2.6.1-1.20.1-Forge" = _fngZukL2;
        "pkg-2.6.1-1.20.1-Fabric" = _LgHqq5Pn;
        "pkg-2.6.1-1.21.1-Fabric" = _rzcYFQ2Y;
        "pkg-2.6.1-1.21.8-Fabric" = _p8BwKx1n;
        "pkg-2.6.1-1.21.9-Fabric" = _EdZiK7gI;
        "pkg-2.6.1-1.21.11-Fabric" = _qOXSdzMz;
        "pkg-2.6.2-1.20.1-Forge" = _UM7kzTtV;
        "pkg-2.6.2-1.20.1-Fabric" = _p0PQ2Lst;
        "pkg-2.6.2-1.21.1-Fabric" = _Fh5GW2be;
        "pkg-2.6.2-1.21.8-Fabric" = _JJkhDHvM;
        "pkg-2.6.2-1.21.9-Fabric" = _V6wkmwt9;
        "pkg-2.6.2-1.21.11-Fabric" = _Mx5KC4Lo;
        "pkg-2.6.3-1.20.1-Fabric" = _k7mwuH6Y;
        "pkg-2.6.3-1.20.1-Forge" = _hly1QD1k;
        "pkg-2.6.3-1.21.1-Fabric" = _fdUWKEzP;
        "pkg-2.6.3-1.21.8-Fabric" = _mMIo0ZUp;
        "pkg-2.6.3-1.21.9-Fabric" = _YsAjpP9X;
        "pkg-2.6.3-1.21.11-Fabric" = _mNnShUHd;
        "pkg-2.6.3.HF1-1.21.1-Fabric" = _CrBPesdP;
        "default" = _CrBPesdP;
    });
