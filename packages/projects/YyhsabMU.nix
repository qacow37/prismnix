...
let
    ...
    in {
        ...
        "pkg-v0.0.1+1.18.2" = _JYXiISEO;
        "pkg-v0.1.0+1.18.2" = _mTUimx7f;
        "pkg-v0.1.1+1.18.2" = _juDwKAsq;
        "pkg-v0.2.0-pre1+1.18.2" = _x53xKK7C;
        "pkg-v0.2.0-pre2+1.18.2" = _mRf6Kl4W;
        "pkg-v0.2.0-pre3+1.18.2" = _PVDFs6fb;
        "pkg-v0.2.0-pre4+1.18.2" = _l6j74ZUA;
        "pkg-v0.2.0-pre5+1.18.2" = _bRhbr16Z;
        "pkg-v0.2.0+1.18.2" = _jPvUhgW2;
        "pkg-v0.3.2+1.18.2" = _hOgci2fI;
        "pkg-v0.3.4+1.18.2" = _1dv3uoPr;
        "pkg-v0.3.4+1.19" = _ES1WLcin;
        "pkg-v0.3.5+1.19" = _PPVcdFoT;
        "pkg-v0.3.6+1.19" = _FNWQCeoy;
        "pkg-v0.4.0+1.19" = _G2xXfD5X;
        "pkg-v0.4.1+1.19" = _lNZdB3EW;
        "pkg-v0.4.1+1.18.2" = _XivYnFaF;
        "pkg-1.0.0+1.18.2" = _iB3eaexv;
        "pkg-1.0.0+1.19" = _NJcLywCr;
        "pkg-1.0.1+1.18.2" = _ArCaWzZv;
        "pkg-1.0.1+1.19" = _Sn7zmPJL;
        "pkg-1.0.2+1.18.2" = _UmeuiAr1;
        "pkg-1.1.0+1.19" = _tdroZ67U;
        "pkg-1.1.1+1.18.2" = _zo7M6Kr4;
        "pkg-1.1.1+1.19" = _sweOupoy;
        "pkg-2.0.0+1.19" = _OJoGrUG7;
        "pkg-2.1.0+1.19" = _NvDsCpJD;
        "pkg-1.1.2+1.19" = _DF8HUvsg;
        "pkg-1.1.3+1.19" = _oaZ2KzWK;
        "pkg-3.0.0+1.20.1" = _PQMEuq5K;
        "pkg-3.1.0+1.20.1" = _cMuH27sQ;
        "pkg-3.1.1+1.20.1" = _NtmfAZdX;
        "pkg-3.2.0+1.20.1" = _6nlQqNme;
        "pkg-3.2.1+1.20.1" = _kKzyAKj8;
        "pkg-3.3.0+1.20.1" = _AIFoTBLD;
        "pkg-3.4.0+1.20.1" = _12lKJUO4;
        "pkg-3.4.1+1.20.1" = _miq1ZGFf;
        "pkg-3.4.2+1.20.1" = _5t9TBJlc;
        "pkg-3.4.3+1.20.1" = _dx5l3doE;
        "pkg-3.4.4+1.20.1" = _xghRQYP1;
        "pkg-3.5.0+1.20.1" = _quIy1Qya;
        "pkg-3.5.1+1.20.1" = _bJiFDa56;
        "pkg-3.6.0+1.20.4" = _pPyaQ1GW;
        "default" = _pPyaQ1GW;
    });
