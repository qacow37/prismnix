...
let
    ...
    in {
        ...
        "pkg-0.5.1" = _YqXzpn4x;
        "pkg-0.5.2" = _5z9VlZ1f;
        "pkg-0.6.0+1.19" = _MSmq1ClL;
        "pkg-0.6.0+1.19.3" = _Lt2odJXF;
        "pkg-0.6.0+1.19.4" = _6e5QJ96a;
        "pkg-0.6.0+1.20.x" = _7ktgSN8K;
        "pkg-0.6.1+1.20.x" = _vVYtBiuW;
        "pkg-0.6.1+1.19.4" = _COPcxuWe;
        "pkg-0.6.1+1.19.3" = _LyuLtRRr;
        "pkg-0.6.1+1.19-1.19.2" = _vlsKDiFO;
        "pkg-0.6.2+1.20.2" = _WzCfX0n2;
        "pkg-1.0.0" = _m6ujIi5t;
        "pkg-1.0.1" = _cW863D3j;
        "pkg-1.0.2" = _LF2xPlbr;
        "pkg-1.0.3+1.20.2" = _lF4LF38M;
        "pkg-1.0.3+1.20.4" = _KNXnSvPw;
        "pkg-1.0.4+1.20.4" = _6tvcp5cu;
        "pkg-1.0.5+1.20.4" = _AybaGS6h;
        "pkg-1.0.6+1.20.4" = _oU35eVBn;
        "pkg-1.0.7+1.20.4" = _sUA7mivB;
        "pkg-1.0.8+1.20.4" = _hOv0jdab;
        "pkg-1.0.9+1.20.4" = _rewr84oy;
        "pkg-1.0.9+1.20.6" = _EekjtCkO;
        "pkg-1.0.9+1.21" = _lOS15Bkq;
        "pkg-1.0.10+1.21" = _GuJVwwK1;
        "pkg-1.0.11+1.21" = _7NY3wW64;
        "pkg-1.2.0+1.21" = _nZ0oFCBX;
        "pkg-1.2.1+1.21" = _3HYN8gKf;
        "pkg-1.2.2+1.21.3" = _Ijeku3Wd;
        "pkg-1.2.2+1.21.1" = _phAG7F4U;
        "pkg-1.2.2+1.21.4" = _2J8TKset;
        "pkg-1.2.1-build.2+1.21.3" = _IAPgISUT;
        "pkg-1.2.2-build.2+1.21.1" = _LhGEQAZ5;
        "pkg-1.3.0+1.21.4" = _i1WBudmi;
        "pkg-1.3.1+1.21.3" = _h64cgRGg;
        "pkg-1.3.1+1.21.4" = _2pCTdfv1;
        "pkg-1.3.1+1.21.1" = _Cb5M9FfZ;
        "pkg-1.3.2+1.21.4" = _mX2Rcbu4;
        "pkg-1.3.2+1.21.3" = _VxSBGN1T;
        "pkg-1.3.2+1.21.1" = _jfn6ss7Y;
        "pkg-1.3.1+1.20.1" = _HMtNyv6G;
        "pkg-1.3.2+1.20.1" = _bprmhL0K;
        "pkg-1.3.2+1.20.1-patch.1" = _qRRTuVNC;
        "pkg-1.3.3+1.21.4" = _Qwt7wGRc;
        "pkg-1.3.3+1.21.1" = _SfDLDxor;
        "pkg-1.3.3+1.20.1" = _RJwORXAv;
        "pkg-1.3.4+1.21.5" = _xMIK28vo;
        "pkg-1.3.4+1.21.4" = _Es2Gb2dq;
        "pkg-1.3.4+1.21.1" = _lRLVPv6y;
        "pkg-1.3.5+1.20.1" = _85aSniKx;
        "pkg-1.3.5+1.21.1" = _8Ph8BKRh;
        "pkg-1.3.5+1.21.4" = _GlnbTtG1;
        "pkg-1.3.5+1.21.5" = _VCYj0LFy;
        "pkg-1.3.5+1.21.6" = _O6TOzi9O;
        "pkg-1.3.5+1.21.7" = _tvt4TZ72;
        "pkg-1.3.5+1.21.8" = _wsvZ2UHL;
        "pkg-1.3.5+1.21.9" = _Iu4JSlY9;
        "pkg-1.3.5+1.21.9-patch.1" = _W9FYq3Kj;
        "pkg-1.3.5+1.21.10" = _C0PstXFz;
        "pkg-1.3.5+1.21.11" = _sJHBVUrL;
        "pkg-1.3.6+1.21.11" = _OrTaMVAB;
        "pkg-1.3.6+1.21.10" = _iIJrNofR;
        "pkg-1.3.6+1.21.1" = _n6UM6TcS;
        "pkg-1.3.6+1.20.1" = _TLQnUGxQ;
        "pkg-2.0.0+1.21.11" = _NqetNNTw;
        "pkg-2.0.0+26.1.x" = _8XLXjgeO;
        "pkg-2.1.0+26.1.x" = _MPu7Sui7;
        "pkg-2.1.1+26.1.x" = _mkN4DOfG;
        "pkg-1.3.6+1.20.1-patch.1" = _PDIowNff;
        "pkg-2.2.0+26.1.x" = _WdE88Dd2;
        "pkg-2.3.0+26.1.x" = _VrJKxbI9;
