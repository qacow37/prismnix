...
let
    ...
    in {
        ...
        "pkg-0.1.0-1.19.4" = _wagmovrp;
        "pkg-0.1.1-1.19.4" = _TEgP1tXQ;
        "pkg-0.1.2-1.19.4" = _FjwXvHqV;
        "pkg-0.1.3-1.19.4" = _mt5ovc71;
        "pkg-0.1.4-1.19.4" = _UIHnLI9p;
        "pkg-0.1.5-1.19.4" = _2UYeiwiI;
        "pkg-0.1.6-1.19.4" = _FBDETmex;
        "pkg-0.1.7-1.19.4" = _FOOg6kWu;
        "pkg-0.1.8-1.19.4" = _o3C7sAZh;
        "pkg-0.1.9-1.19.4" = _VY6J8F85;
        "pkg-0.1.10-1.19.4" = _pJK4qBvg;
        "pkg-0.1.11-1.19.4" = _saHrfqfQ;
        "pkg-0.1.12-1.19.4" = _zrjCUxj1;
        "pkg-1.0.0-1.19.4" = _DcO4BCD0;
        "pkg-1.0.1-1.19.4" = _S1E9KAg7;
        "pkg-1.1.0-1.20.1" = _s2efkATS;
        "pkg-1.1.1-1.20.1" = _75id264l;
        "pkg-1.1.2-1.20.1" = _X2Rkxg1P;
        "pkg-1.1.3-1.20.1" = _MCPk8yIi;
        "pkg-1.1.3-1.20.1+trinkets" = _vxplNHY9;
        "pkg-1.1.3.a-1.20.1" = _8Pl3AAxI;
        "pkg-1.1.3.a-1.20.1+trinkets" = _Qjz5Mg35;
        "pkg-1.1.4-1.20.2" = _9xu5YZtu;
        "pkg-1.1.4-1.20.2+trinkets" = _xuKXHHJb;
        "pkg-1.1.5-1.20.4" = _FbktDqYM;
        "pkg-1.1.5-1.20.4+trinkets" = _lKfwckDY;
        "pkg-1.1.6-1.20.5" = _MyrJthOI;
        "pkg-1.1.6-1.20.6+trinkets" = _OsslvBZ7;
        "pkg-1.1.7-1.20.6" = _CZZXPBl9;
        "pkg-1.1.7-1.20.6+trinkets" = _9fkM076z;
        "pkg-1.2.0-1.21" = _miNI64qV;
        "pkg-1.2.0.a-1.21" = _tt2SBZC9;
        "pkg-1.2.0.b-1.21" = _7d0afFOT;
        "pkg-1.2.0.c-1.21" = _PVrwJQQv;
        "pkg-1.2.1-1.21" = _QXQxWg1V;
        "pkg-1.2.1-1.21+trinkets" = _4nblzth6;
        "pkg-1.2.2-1.21.1" = _IMKrtsKH;
        "pkg-1.2.2-1.21.1+trinkets" = _UARAMfgx;
        "default" = _UARAMfgx;
    });
