...
let
    ...
    in {
        ...
        "pkg-3.0.1" = _3jhKYm4p;
        "pkg-3.0.2" = _D224bBhq;
        "pkg-3.0.2.1" = _y4jCABVW;
        "pkg-3.0.3" = _WQtMJXsM;
        "pkg-3.0.3.1" = _TD5eVUGb;
        "pkg-3.0.3.2" = _ZBQqLQCm;
        "pkg-3.0.4" = _ocOhfaI2;
        "pkg-3.0.4.1" = _JUXBmQ2p;
        "pkg-3.0.4.2" = _q7ggLb46;
        "pkg-3.0.4.3" = _4NSpNL35;
        "pkg-3.0.5" = _VaLlF2DI;
        "pkg-3.0.5.1" = _ciPFBQKj;
        "pkg-3.0.5.2" = _DHGKpJzN;
        "pkg-3.0.6" = _7Zu9TgD7;
        "pkg-3.0.6.1" = _4329iXQx;
        "pkg-3.0.6.2" = _XlzAiYS7;
        "pkg-3.0.7" = _VKgow2oN;
        "pkg-3.0.8" = _BdlumO1L;
        "pkg-3.0.9" = _1bBXmkrB;
        "pkg-3.0.10" = _u7BjC6OV;
        "pkg-3.0.11" = _jeMJgVVq;
        "pkg-3.0.12" = _l2bbROgb;
        "pkg-3.1.0" = _GbhqVMp3;
        "pkg-3.2.0" = _qwiW5MPi;
        "pkg-3.2.1" = _mqXidCwW;
        "pkg-3.2.2" = _eeJpeB8t;
