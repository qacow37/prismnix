...
let
    ...
    in {
        ...
        "pkg-0.4.0+1.20-multisplit" = _dkRTGVJb;
        "pkg-0.4.0+1.20.5-multisplit" = _IscPU6IR;
        "pkg-0.4.0+1.20.2-multisplit" = _BcJn3QGi;
        "pkg-0.4.1+1.20-multisplit" = _oj8VJg2I;
        "pkg-0.4.1+1.20.2-multisplit" = _AX9WttF3;
        "pkg-0.4.1+1.20.5-multisplit" = _cokz03HX;
        "pkg-0.4.1+1.21-multisplit" = _YOp6uPAF;
        "pkg-0.5.0+1.20.5-multisplit" = _ODnk1Vja;
        "pkg-0.5.0+1.21-multisplit" = _8KQwsTQ9;
        "pkg-0.5.1+1.20.5-multisplit" = _ucOyn1hA;
        "pkg-0.5.1+1.21-multisplit" = _umnS0Mm8;
        "pkg-0.6.0+1.21" = _SYAjbkLE;
        "pkg-0.6.0+1.20.5" = _u5hGr6rk;
        "pkg-0.6.0+1.20" = _6tv2bUIh;
        "pkg-0.6.0+1.20.2" = _sm4W4n7g;
        "pkg-0.6.1+1.20.2" = _VeaeI1WM;
        "pkg-0.6.1+1.20" = _NFhiLDHT;
        "pkg-0.6.1+1.20.5" = _XuboKsKm;
        "pkg-0.6.1+1.21" = _oT9HgUAg;
        "pkg-0.6.1+1.21.2" = _FpSQm2qQ;
        "pkg-0.6.1+1.21.4" = _4CV67tI2;
        "pkg-0.6.1+1.21.6" = _ArWlx4lf;
        "pkg-0.6.1+1.21.5" = _u40gABi4;
        "pkg-0.6.1+1.21.7" = _p7nVm6Rx;
        "default" = _p7nVm6Rx;
    });
