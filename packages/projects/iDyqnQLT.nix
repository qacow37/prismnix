...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.21.1" = _Zgb0GWf1;
        "pkg-1.0.1-1.20.1" = _8x5VeWli;
        "pkg-1.0.2-1.16.5" = _n1JVJnlR;
        "pkg-1.0.2-1.18.2" = _GIk6twdN;
        "pkg-1.0.2-1.19.2" = _UKzxZBvz;
        "pkg-1.0.2-1.20.1" = _4hEpJIcf;
        "pkg-1.0.2-1.21.1" = _uJ2Et7WR;
        "pkg-1.0.2-1.21.4" = _eCjbSuTL;
        "pkg-1.1.0-1.16.5" = _ppXXL1cg;
        "pkg-1.1.0-1.18.2" = _hydLAJCR;
        "pkg-1.1.0-1.19.2" = _InF5f7hQ;
        "pkg-1.1.0-1.20.1" = _YEnuoMXW;
        "pkg-1.1.0-1.21.1" = _HGSFL9lL;
        "pkg-1.1.0-1.21.4" = _QODCvn8P;
        "pkg-1.1.0-1.21.5" = _78Qtciaf;
        "pkg-1.1.0-1.21" = _O2V59IT6;
        "pkg-1.2.0-1.21.5" = _JOaiQRgE;
        "pkg-1.1.0" = _cK1oKt4o;
        "pkg-1.2.0-1.20.1" = _6r3KQJqu;
        "pkg-1.2.0-1.21.6" = _nPIIUlgb;
        "pkg-1.2.0-1.21.7" = _azPseuhF;
        "pkg-1.2.0-1.21.8" = _aW2I2g3V;
        "pkg-1.3.0-1.21.8" = _k8MDsGhO;
        "pkg-1.3.0-1.21.9" = _yFO7vBxx;
        "pkg-1.3.0-1.21.10" = _PYf2cmBb;
        "pkg-1.3.0-1.21.1" = _RVH5ihnz;
        "pkg-1.3.0-1.20.1" = _Wbb5zXWc;
        "pkg-1.3.1-1.21.10" = _4X997uit;
        "pkg-1.3.1-1.21.9" = _knS7h1ow;
        "pkg-1.3.1-1.21.8" = _M2vBOw4b;
        "pkg-1.3.1-1.21.7" = _HT3l8zYj;
        "pkg-1.3.1-1.21.6" = _tldK7jUa;
        "pkg-1.3.1-1.21.5" = _jOoGEJqi;
        "pkg-1.3.1-1.21.4" = _xHb5kyEo;
        "pkg-1.3.1" = _hQWnG72L;
        "pkg-1.3.1-1.21.1" = _T6cHMWwt;
        "pkg-1.3.1-1.20.1" = _prsLl8Qm;
        "pkg-1.3.1-1.21.11" = _iDZ18ExC;
        "pkg-1.4.0-1.21.1" = _i2dHlstR;
        "pkg-1.4.0-1.18.2" = _62vVSWDE;
        "pkg-1.4.0-1.91.2" = _m5riUCl0;
        "pkg-1.4.0-1.20.1" = _WE57O4zN;
        "pkg-1.4.0-1.21.10" = _fJ7c76Oo;
        "pkg-1.4.0-1.21.11" = _c3u5hXlJ;
