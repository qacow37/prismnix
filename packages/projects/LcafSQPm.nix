...
let
    ...
    in {
        ...
        "pkg-1.9.2" = _yCK9uexB;
        "pkg-1.9.3" = _VLEKCJKW;
        "pkg-1.10.0+1.20.4" = _gEQlYnTr;
        "pkg-1.10.0+1.20.2" = _HkqA7WFL;
        "pkg-1.10.0+1.20.1" = _6UqtFgM4;
        "pkg-1.10.1+1.20.2" = _3I0Ojf0W;
        "pkg-1.10.1+1.20.4" = _9hww2qsR;
        "pkg-1.10.1+1.20.1" = _dAS9vfWn;
        "pkg-1.10.2+1.20.2" = _Wk2fa5cV;
        "pkg-1.10.2+1.20.4" = _Gzataqbm;
        "pkg-1.10.2+1.20.1" = _aUduJTH6;
        "pkg-1.10.3+1.20.1" = _nXciVrDv;
        "pkg-1.10.3+1.20.4" = _GX7qPAzO;
        "pkg-1.10.3+1.20.2" = _KkFHr7rG;
        "pkg-1.10.4+1.20.2" = _stkhhlfv;
        "pkg-1.10.4+1.20.1" = _11nerhMX;
        "pkg-1.10.4+1.20.4" = _yZWrXbPr;
        "pkg-1.11.0+1.20.6" = _DBYTR6ME;
        "pkg-1.11.0+1.21.1" = _ZD9NX8Js;
        "default" = _ZD9NX8Js;
    });
