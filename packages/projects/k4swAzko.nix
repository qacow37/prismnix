...
let
    ...
    in {
        ...
        "pkg-1.0" = _Au0fibcA;
        "pkg-1.0+mod" = _SWTwtW0g;
        "pkg-1.1" = _IjkYaUsO;
        "pkg-1.1+mod" = _Blc59oML;
        "pkg-1.2" = _cpesKiEQ;
        "pkg-1.2+mod" = _BGGy7NO2;
        "pkg-1.3" = _cPcQhUh2;
        "pkg-1.3+mod" = _Z4TLKUun;
        "pkg-1.4" = _wiYPUXgQ;
        "pkg-1.4+mod" = _bZbWgHKB;
        "pkg-1.5" = _J0wOoAsb;
        "pkg-1.5+mod" = _BPnwAUrr;
        "pkg-1.6" = _QpVFhqG0;
        "pkg-1.6+mod" = _pR89kIY1;
        "pkg-1.7" = _FycDCs0w;
        "pkg-1.7+mod" = _feDmPPQZ;
        "pkg-1.8" = _sHBYsONA;
        "pkg-1.8-fabric" = _ubxnJM4b;
        "pkg-1.8-forge" = _hNWt6m8w;
        "pkg-1.12" = _PitySwp3;
        "pkg-1.12-fabric" = _Ym7BTP8z;
        "pkg-1.12-quilt" = _gPrfLACC;
        "pkg-1.12-forge" = _4ntcS26r;
        "pkg-1.12-neoforge" = _Dn1kgd48;
        "pkg-1.13" = _aIsd3x1O;
        "pkg-1.13-fabric" = _IWpLusOK;
        "pkg-1.13-quilt" = _DsPCVwCV;
        "pkg-1.13-forge" = _ZggUdwpi;
        "pkg-1.13-neoforge" = _cJvXz7Zs;
        "default" = _cJvXz7Zs;
    });
