...
let
    ...
    in {
        ...
        "pkg-1.8.5" = _rNf6xXyf;
        "pkg-1.9.5" = _eMThlBy1;
        "pkg-1.10.0" = _rhXD4Y8x;
        "pkg-1.11.0" = _deSHjARh;
        "pkg-1.12.0" = _51g4gHTi;
        "pkg-1.13.0" = _4WjCOkEa;
        "pkg-1.12.1" = _GQdQ5AtQ;
        "pkg-1.13.1" = _dlHgLo0j;
        "pkg-1.12.2" = _5Tn5w8HU;
        "pkg-1.13.2" = _UBhdJokt;
        "pkg-1.12.3" = _yeCxir7c;
        "pkg-1.13.3" = _cyIvK0Zw;
        "pkg-1.13.4" = _fgYhrgG9;
        "pkg-1.14.0" = _mEqB0jH4;
        "pkg-1.15.0" = _hUgm8mHN;
        "pkg-1.14.1" = _IEgzseFp;
        "pkg-1.15.1" = _3Bi6FFbC;
        "pkg-1.14.2" = _WLmz3kkF;
        "pkg-1.15.2" = _RI92IM5J;
        "pkg-1.16.0" = _H0Vpa7Cz;
        "pkg-1.16.1" = _pnJVbP7R;
        "pkg-1.16.2" = _imISxzZR;
        "pkg-1.16.3" = _EmXgLkp3;
        "pkg-1.16.4" = _R7wXKrKL;
        "pkg-1.16.5" = _sEebMI45;
        "pkg-1.17.0" = _NoVXEUM7;
        "pkg-1.17.1" = _30GHOsCt;
        "pkg-1.17.2" = _SVUIQtOV;
        "pkg-1.17.3" = _fQ4fX2HG;
        "pkg-1.17.4" = _AIxJHAEC;
        "pkg-1.17.5" = _bT122AAd;
        "pkg-1.17.6" = _ZoDHw7ov;
        "pkg-1.17.7" = _VyUEUSw9;
        "pkg-1.17.8" = _93dptTZN;
        "pkg-1.17.9" = _z8xUvUaR;
        "pkg-1.18.0" = _umJVLBQr;
        "pkg-1.18.1" = _YwatyUhi;
        "pkg-1.18.2" = _XgmzrxT4;
        "pkg-1.18.3" = _bpreZeJn;
        "pkg-1.18.4" = _RqXmzxKF;
        "pkg-1.18.5" = _YceW3u9n;
        "pkg-1.18.6" = _eWkCqEhF;
        "pkg-1.18.7" = _lYb6ab4b;
        "pkg-1.19.0" = _kUjKsjw3;
        "pkg-1.19.1" = _B2Ud5Ox4;
        "pkg-1.19.2" = _4eM0kYBB;
        "pkg-1.19.3" = _kJVK1Isb;
        "pkg-1.19.4" = _of0YOXeK;
        "pkg-1.19.5" = _WT261JFr;
        "pkg-1.19.6" = _hHo0Gy5o;
        "pkg-1.19.7" = _Aa7UnsYd;
        "pkg-1.19.8" = _rRli8Ybi;
        "default" = _rRli8Ybi;
    });
