...
let
    ...
    in {
        ...
        "pkg-1.2.1" = _GmXm4sXb;
        "pkg-1.3.2d_exp" = _YQfb9dct;
        "pkg-1.4.9.3-prerelease" = _iqjSZ0Mo;
        "pkg-1.4.9.4-prerelease" = _84tDEhAV;
        "pkg-1.4.9.5-prerelease-build" = _Vp3hAbAP;
        "pkg-1.4.9.6-prerelease" = _rNHRWSMJ;
        "pkg-1.4.9.14-prerelease" = _5KmJZ3Wh;
        "pkg-1.4.9.23-prerelease" = _vmDsidd8;
        "pkg-1.4.9.26-prerelease" = _HP7aXERQ;
        "pkg-1.5.0.0" = _J59DLxPv;
        "pkg-1.5.0.1" = _nguwIHaw;
        "pkg-1.5.0.2" = _tKx3O2uS;
        "pkg-1.5.0.3" = _IBZTprbK;
        "pkg-1.5.0.5" = _hyOwGVAc;
        "pkg-1.5.0.6" = _gvcYEnoV;
        "pkg-1.5.0.6b" = _M2AYm5ln;
        "pkg-1.6-pre7" = _TqZtnQRf;
        "pkg-1.6-pre8" = _B4g9SDtG;
        "pkg-1.6-pre9" = _qxsCRiLv;
        "pkg-1.6-pre10" = _Zv3LvQA4;
        "pkg-1.6-pre11" = _A9H74sms;
        "pkg-1.6-pre12" = _E8KGJ6FF;
        "pkg-1.6-pre13" = _yX31iBST;
        "pkg-1.6-pre14b" = _8vFNPrUK;
        "pkg-1.6-pre15" = _4R6c6MCC;
        "pkg-1.7.0b" = _iVA9bKch;
        "pkg-1.7.1" = _EFPHYyWv;
        "pkg-1.7.2" = _evaEls0d;
        "pkg-1.7.3" = _O6YvXWTJ;
        "pkg-1.7.3b" = _WUHnTOWU;
        "pkg-1.8-dev1" = _TwJyBk8u;
        "pkg-1.8-dev2" = _qRM1Sxfl;
        "pkg-1.8-pre1" = _dvA1qm9P;
        "pkg-1.8-pre2" = _iTNtK4gB;
        "pkg-1.8.0" = _Fm6LE4rZ;
        "pkg-2.0-dev1" = _qdcdKLXk;
        "pkg-2.0-dev2" = _iwg3MpII;
        "pkg-2.0-dev3" = _BlitI5mL;
        "pkg-2.0-dev4" = _XffO1VHR;
        "pkg-2.0-dev5" = _MdXolapO;
        "pkg-2.0-pre1" = _PbqdnXEr;
        "pkg-2.0-pre2" = _mw5pPGQc;
        "pkg-2.0-pre3" = _vTv2fc0g;
        "pkg-2.0-pre4" = _fzNpadDf;
        "pkg-2.0-pre5" = _SCEGBYAh;
        "pkg-2.0-pre6" = _EHavy1CZ;
        "pkg-2.0-pre6b" = _qVDxlkyS;
        "pkg-2.0-pre7" = _Rg8mhJOZ;
        "pkg-2.0-pre8" = _ahwEuSr2;
        "pkg-2.0-pre9" = _NdXKcw79;
        "pkg-2.0-pre10" = _4Hontqc2;
        "pkg-2.0-pre11" = _6a9Gg123;
        "pkg-2.0-pre12" = _TSUxBI4v;
        "pkg-2.0-pre13" = _s8WrkfKk;
        "pkg-2.0-pre14" = _iViroJdE;
        "pkg-2.0-pre15" = _TvjslYZz;
        "pkg-2.0-pre16" = _6Y5mPk56;
        "pkg-2.0-pre17" = _egWVpb4E;
        "pkg-2.0-pre18" = _beKQrwqX;
        "pkg-2.0.19" = _F6kw19A6;
        "pkg-2.0.20" = _oRYxqdQk;
        "pkg-2.0.21" = _teKfvo35;
        "pkg-2.0.22.7" = _ptanreoH;
        "default" = _ptanreoH;
    });
