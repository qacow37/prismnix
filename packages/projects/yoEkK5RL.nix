...
let
    ...
    in {
        ...
        "pkg-0.1.0-beta" = _5wrN8npt;
        "pkg-0.2.0-beta" = _uTfBw35h;
        "pkg-0.3.0-beta" = _VFWn4jsm;
        "pkg-1.0.0" = _bUKAvU5i;
        "pkg-1.1.0" = _CVWdIlqc;
        "pkg-1.2.0" = _UoEdx9mt;
        "pkg-2.0.0" = _G3EEEyW2;
        ...
        "pkg-2.2.1" = _JQRzAHPG;
        "pkg-2.2.2" = _xBAJ5WkR;
        "pkg-2.3.0-fabric" = _ARSWPEiH;
        "pkg-2.3.0-quilt" = _ayKj70Ct;
        "pkg-2.3.1+fabric-1.18.2" = _QYtHyYed;
        "pkg-2.3.1+quilt-1.18.2" = _V78Sb7zf;
        "pkg-3.0.0-beta.1+fabric-1.19" = _PT31MEzQ;
        "pkg-2.3.2+fabric-1.18.2" = _Tqqaf3nP;
        "pkg-3.0.0+fabric-1.19" = _xOaTMH16;
        "pkg-2.3.3+fabric-1.18.2" = _aoqVkUum;
        "pkg-2.3.2+quilt-1.18.2" = _LsYk6IDM;
        "pkg-3.1.0+fabric-1.19" = _zEWEZkSa;
        "pkg-3.2.0+fabric-1.19" = _aOv1NGf3;
        "pkg-3.2.1-alpha.1+fabric-1.19" = _1501j0bu;
        "pkg-3.2.1+fabric-1.19" = _9lbTroa6;
        "pkg-3.2.2+fabric-1.19" = _28TfdTSF;
        "pkg-3.2.3+fabric-1.19" = _ISO0U9hL;
        "default" = _ISO0U9hL;
    });
