...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.19" = _FmZ4RCDJ;
        "pkg-0.1.0+1.19.3" = _r6HEi147;
        "pkg-0.1.1+1.19" = _bViUOztQ;
        "pkg-0.1.1+1.19.3" = _PC2vK2N8;
        "pkg-0.1.2+1.19" = _IQqG4H5J;
        "pkg-0.1.2+1.19.3" = _ePaeOIUe;
        "pkg-0.1.3+1.19" = _C2PLiajf;
        "pkg-0.1.3+1.19.3" = _ZW8158zx;
        "pkg-0.1.4+1.19" = _o5Su4s8D;
        "pkg-0.1.4+1.19.3" = _kUzF9qv4;
        "pkg-0.1.5+1.19" = _ocF9m2ZL;
        "pkg-0.1.5+1.19.3" = _8wNghLEz;
        "pkg-0.2.0+1.19" = _1yRpYVuc;
        "pkg-0.2.0+1.19.3" = _K3u8oy66;
        "pkg-0.2.1+1.19" = _lqgAc4BF;
        "pkg-0.2.1+1.19.3" = _5r1dpWI4;
        "pkg-0.3.0+1.19" = _YueNxhaT;
        "pkg-0.3.0+1.19.3" = _aeLBM9OS;
        "pkg-0.4.0+1.19" = _do3sVE6D;
        "pkg-0.4.0+1.19.3" = _l8QmP0jG;
        "pkg-0.4.1+1.19" = _rhE142vM;
        "pkg-0.4.1+1.19.3" = _Jo4Slnc6;
        "pkg-0.4.1+1.19.4" = _ILHKR1xY;
        "pkg-0.4.1+1.20.1" = _QbJylXe5;
        "pkg-0.5.0+1.20.1" = _93EbDM3D;
        "pkg-0.5.1+1.20.1" = _oL4DGbb5;
        "pkg-0.5.2+1.20.1" = _HVf51ytM;
        "pkg-0.6.0+1.20.1" = _sbFOk0K1;
        "pkg-0.6.1+1.20.1" = _WDssGgQo;
        "pkg-0.7.0+1.20.1" = _KVC9lAEE;
        "default" = _KVC9lAEE;
    });
