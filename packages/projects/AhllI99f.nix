...
let
    ...
    in {
        ...
        "pkg-0.0.3" = _cDB6sG0B;
        "pkg-0.0.4" = _9CopIc96;
        "pkg-0.0.4.1" = _Qj40VhC7;
        "pkg-0.0.5" = _unWA25fI;
        "pkg-0.0.6" = _11FOUKTi;
        "pkg-0.0.7" = _EOETg0fL;
        "pkg-0.0.7.1" = _OXoi6R1p;
        "pkg-0.0.8" = _CVVwjE5C;
        "pkg-0.0.9" = _3TglBQPJ;
        "pkg-0.1.0" = _DRtGfbwZ;
        "pkg-0.1.0.1" = _WH8AV6LV;
        "pkg-0.1.0.2" = _YfhaEO1e;
        "pkg-0.1.1" = _JJe7V0lU;
        "pkg-0.1.1.1" = _Qoh9CCFc;
        "pkg-0.1.1.2" = _69Qp9Mtu;
        "pkg-0.1.2" = _dekfaADl;
        "pkg-0.1.2.1" = _pG3MIy92;
        "pkg-0.1.2.2" = _45kmUYHV;
        "pkg-0.1.3" = _FekcuuI8;
        "pkg-0.1.3.1" = _fXBOaf8v;
        "pkg-1.3.2" = _nEDGMR8b;
        "pkg-2.0.0" = _sPLEihKP;
        "pkg-2.2.0" = _aY7gpav6;
        "pkg-2.3.0" = _rjAAIIMk;
