...
let
    ...
    in {
        ...
        "pkg-1.3.1" = _s5yQoZUZ;
        "pkg-1.3.2" = _RgnDkatJ;
        "pkg-1.3.2+mod" = _ZmshfACe;
        "pkg-1.3.3" = _R3RWQJ6o;
        "pkg-1.3.3+mod" = _EHV57V4z;
        "pkg-1.4" = _4NLEwRCR;
        "pkg-1.4+mod" = _ofjxhIPM;
        "pkg-1.4.1" = _ORshP8b6;
        "pkg-1.4.1+mod" = _twSqyMLE;
        "pkg-1.4.2" = _StzPqeJP;
        "pkg-1.4.2+mod" = _t6BoYtwj;
        "pkg-1.4.3" = _lB1ZbGec;
        "pkg-1.4.3+mod" = _kPsTjpkT;
        "pkg-1.5" = _NYf6FuSw;
        "pkg-1.5+mod" = _xiFh6rm7;
        "pkg-1.5.1" = _pTJd8zJq;
        "pkg-1.5.1+mod" = _sYdb7PgL;
        "pkg-1.5.2" = _gVdYG9DD;
        "pkg-1.5.2+mod" = _3Boo22gb;
        "pkg-1.5.3" = _xc9tIKTI;
        "pkg-1.5.3+mod" = _nZjS6Rgu;
        "pkg-1.6" = _XPyiqosD;
        "pkg-1.6+mod" = _mSVDw6ZO;
        "pkg-1.6.1" = _EEuA65eL;
        "pkg-1.6.1+mod" = _uRJO6LL5;
        "pkg-1.7" = _oah6s9jl;
        "pkg-1.7+mod" = _u83dBtYu;
        "pkg-1.7.1" = _9zZ4eVMh;
        "pkg-1.7.1+mod" = _gZ4FORD6;
        "pkg-1.8" = _wUm5Vtyj;
        "pkg-1.8+mod" = _IIdjEoY7;
        "pkg-1.9" = _nuJu80Yb;
        "pkg-1.9.1" = _eq7EfvlR;
        "pkg-1.9.1+mod" = _2g1Hj4mX;
        "pkg-1.10" = _eSNGRmQn;
        "pkg-1.10+mod" = _w7DgbHjD;
        "pkg-1.10.1" = _30okm6f9;
        "pkg-1.10.1+mod" = _tYGp19Fg;
        "pkg-1.11" = _qe5GMlwl;
        "pkg-1.11+mod" = _uxLJfX25;
        "pkg-1.11.1" = _GhHL530R;
        "pkg-1.11.1+mod" = _pOzHYOCP;
        "pkg-1.11.2" = _p07amYqf;
        "pkg-1.11.2+mod" = _qMjnkTwx;
        "pkg-1.11.1b" = _sS7bNvd1;
        "pkg-1.11.1b+mod" = _DkWq69V3;
        "pkg-1.11.2b" = _VG1ZXp51;
        "pkg-1.11.2b+mod" = _bQQboG4F;
        "pkg-1.11.2c" = _bBYydjAT;
        "pkg-1.11.2c+mod" = _T5WBSQmi;
        "pkg-1.10.1b" = _KmLAxSpJ;
        "pkg-1.10.1b+mod" = _Zlc5Ede5;
        "pkg-1.11.3" = _mpa5v9Rs;
        "pkg-1.11.3+mod" = _P2wzxJRL;
        "pkg-2.0" = _qJZ3WsQ0;
        "pkg-2.0+mod" = _14dB0liw;
        "pkg-V2.1" = _KGahYgX8;
