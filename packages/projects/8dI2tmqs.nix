...
let
    ...
    in {
        ...
        "pkg-v1.0.1" = _7Pfsv1Mg;
        "pkg-v1.1.0" = _YVMQTgz2;
        "pkg-v1.1.1" = _HnXgqLgP;
        "pkg-v1.1.2" = _Aa4ltboH;
        "pkg-v1.1.3" = _2VMz1ONW;
        "pkg-v1.1.4" = _yENVxKfk;
        "pkg-v1.1.5" = _4mdGBekc;
        "pkg-v1.1.6" = _KUX0HBRJ;
        "pkg-v2.0.0" = _QP9gE54u;
        "pkg-v2.1.0" = _tDg4itgr;
        "pkg-v2.1.1" = _2Yvbf5hW;
        "pkg-v2.2.0" = _9bCnXZF6;
        "pkg-v2.3.0" = _7li6CmhZ;
        "pkg-v2.4.0" = _rCwKd1CC;
        "pkg-v2.5.0" = _HuwRuGXe;
        "pkg-v2.6.0" = _XJmDAnj5;
        "pkg-v2.7.0" = _Mxw3Cbsk;
        "pkg-v2.8.0" = _pKclvAHk;
        "pkg-v2.9.0" = _AQhF7kvw;
        "pkg-v2.10.0" = _7Juknjr6;
        "pkg-v2.10.1" = _KqB3UA0q;
        "pkg-v2.11.0" = _nR8AIdvx;
        "pkg-v2.12.0" = _CsEpiziv;
        "default" = _CsEpiziv;
    });
