...
let
    ...
    in {
        ...
        "pkg-v1.2.0" = _lEztSgBo;
        "pkg-v1.2.1" = _QztdYnbq;
        "pkg-v1.2.1-hotupdate" = _E1hj9c57;
        "pkg-v1.2.2" = _O54LUgBt;
        "pkg-v1.2.2-hotupdate" = _zqh0B298;
        "pkg-v1.3.0" = _HdmzWEGF;
        "pkg-v1.3.1" = _lxkzMCV3;
        "pkg-v1.3.1-hotupdate" = _Jji1stSj;
        "pkg-1.3.2" = _Prhph5Ii;
        "pkg-1.x.x" = _PnkzUMgn;
        "pkg-v1.0.0" = _8BrD0KU0;
        "pkg-v1.0.1" = _GJatygJA;
        "pkg-v1.0.2" = _c67GTBcu;
        "pkg-v1.4.0" = _rrZGfQMp;
        "pkg-1.4.1" = _9BKRRGCB;
        "pkg-v1.4.2" = _PjWxuDH4;
        "pkg-v1.4.4" = _BgP7qSk8;
        "pkg-1.0.3" = _qH6Ddwwd;
        "pkg-v1.4.5" = _sAraItIB;
        "pkg-v1.5.0" = _bjPAc3yy;
        "pkg-2.x.x" = _NZzgTTEr;
        "pkg-v1.1.0" = _uXfCfiws;
        "pkg-v1.1.1" = _QOokbCuQ;
        "pkg-v3.x.x" = _oeFlcVfg;
        "pkg-v1.5.1" = _VQcFKLga;
        "pkg-v1.5.2" = _qKLRyd6s;
        "pkg-v1.5.3" = _IvVvZVuN;
        "pkg-v1.5.4" = _V6BPgYym;
        "pkg-v3.x" = _J0cgcZC3;
        "pkg-v5.x" = _PPVnVYYh;
        "pkg-v6.x" = _Y33LXEFy;
        "pkg-v1.5.5" = _XiUW8kav;
        "pkg-v7.x.x" = _FXhB42Ls;
        "pkg-v0" = _r7A2jHMw;
        "pkg-v1.5.6" = _wcbPtlyX;
        "pkg-v8.x.x" = _CkRE6NTM;
        "pkg-v1.5.7" = _9YWn960w;
        "pkg-v9.x.x" = _hRsA8Dbc;
        "pkg-v1.5.8" = _u3qJdNrX;
        "pkg-v1.6.0" = _R1wsi6Z4;
        "pkg-v1.1.x" = _KpEh4BvO;
        "pkg-v1.6.1" = _UL2nOno0;
        "pkg-v1.2.x" = _byGDmdc6;
        "pkg-v1.4.1" = _8XF1L2fD;
        "pkg-v1.7.0" = _f8UeDojz;
        "pkg-v1.7.1" = _rUo8Lttn;
        "pkg-v1.7.2" = _kUgbo6Dw;
        "pkg-v1.1.2" = _zD3QE3xp;
        "pkg-v0.0" = _9jgE9JtI;
        "pkg-v1.7.3" = _VbM2XpuY;
        "pkg-v1.7.3-hotupdate" = _6xkviC62;
        "pkg-v1.8.1" = _qKrJQF9h;
        "pkg-v1.1.3" = _VOMB33rS;
        "pkg-v1.8.2" = _pdR4PcFI;
        "pkg-v1.8.3" = _fCFfKQCt;
        "pkg-1.8.4" = _1u7bO1oD;
        "pkg-v1.8.5" = _D1vHDfYq;
        "pkg-v0.1" = _lbvZG1Ft;
        "pkg-v2.0.0" = _7MOy6b3a;
        "pkg-v1.1" = _ZjdQy7Iw;
        "pkg-v1.2" = _xAZuGsOC;
        "pkg-v2.0.1" = _iH8OAy72;
        "pkg-v2.0.2" = _Pq33RKCw;
        "default" = _Pq33RKCw;
    });
