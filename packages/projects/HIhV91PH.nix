...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.8-fabric" = _9NMYfWub;
        "pkg-1.18.2-1.8-fabric" = _JHdorQaj;
        "pkg-1.19.2-1.9-fabric" = _clNbgCFp;
        "pkg-1.16.5-1.4-forge" = _qSEqwg6Y;
        "pkg-1.18.2-1.5-forge" = _C9O6ihnl;
        "pkg-1.19.2-1.7-forge" = _s8oZiPDc;
        "pkg-1.16.5-2.0-fabric" = _rDOqdHlH;
        "pkg-1.18.2-2.0-fabric" = _EUotYPTD;
        "pkg-1.19.2-2.0-fabric" = _k4xJRVJG;
        "pkg-1.16.5-3.0-fabric" = _ZWlMNfNg;
        "pkg-1.18.2-3.0-fabric" = _MHZrDGB6;
        "pkg-1.19.2-3.0-fabric" = _uY1f7bib;
        "pkg-1.16.5-3.0-forge" = _53FyPdTN;
        "pkg-1.18.2-3.0-forge" = _wbF1RftI;
        "pkg-1.19.2-3.0-forge" = _b5uuvxM5;
        "pkg-1.19.3-3.1-fabric" = _1msGrsYo;
        "pkg-1.19.3-3.0-forge" = _pRtZsu1C;
        "pkg-1.18.2-4.0-forge+fabric" = _BVuvTFbO;
        "pkg-1.19.2-4.0-forge+fabric" = _S2SXoRGb;
        "pkg-1.19.3-4.0-forge+fabric" = _KxP4oG6u;
        "pkg-1.19.4-4.0-forge+fabric" = _2m28PiFW;
        "pkg-1.20-4.0-forge+fabric" = _wguHDb0G;
        "pkg-1.20.1-4.0-forge+fabric" = _vk0mFvEm;
        "pkg-1.20.2-4.0-forge+fabric" = _6HqHGaVJ;
        "pkg-1.18.2-4.1-forge+fabric" = _1kCUbZZ1;
        "pkg-1.19.2-4.1-forge+fabric" = _t5T75Lfb;
        "pkg-1.20.1-4.1-forge+fabric" = _vpgNe66r;
        "pkg-1.20.2-4.1-forge+fabric" = _r19kokOv;
        "pkg-1.20.3-4.1-fabric+forge+neo" = _wuiztH4v;
        "pkg-1.20.4-4.1-fabric+forge+neo" = _aTyULMY3;
        "pkg-1.19.2-4.2-fabric+forge+neo" = _Ph5aNjXP;
        "pkg-1.20.1-4.2-fabric+forge+neo" = _49PVk0F5;
        "pkg-1.20.2-4.2-fabric+forge+neo" = _XwpbiofZ;
        "pkg-1.20.4-4.2-fabric+forge+neo" = _5ew6SSiC;
        "pkg-1.20.5-4.2-fabric+neo" = _3Eo5YT2D;
        "pkg-1.20.6-4.2-fabric+forge+neo" = _46E5VrHT;
        "pkg-1.21.0-4.2-fabric+forge+neo" = _eyoTfhUN;
        "pkg-1.20.1-4.3-fabric+forge+neo" = _sHS2beiV;
        "pkg-1.20.6-4.3-fabric+forge+neo" = _h2ksbVbK;
        "pkg-1.21.0-4.3-fabric+forge+neo" = _tZwhSQzD;
        "pkg-1.20.1-4.4-fabric+forge+neo" = _lwKKxwil;
        "pkg-1.20.6-4.4-fabric+forge+neo" = _h9aTOJ04;
        "pkg-1.21.0-4.4-fabric+forge+neo" = _FF6R4Bwo;
        "pkg-1.21.1-4.4-fabric+forge+neo" = _JZQfnEpA;
        "pkg-1.21.2-4.4-fabric+neo" = _yCuc0Iv9;
        "pkg-1.21.3-4.4-fabric+forge+neo" = _TLr9v6Hu;
        "pkg-1.21.4-4.4-fabric+forge+neo" = _J3IgWeSA;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _7HtcRDxN;
        "pkg-1.21.1-4.5-fabric+forge+neo" = _sKtpqwx2;
        "pkg-1.21.4-4.5-fabric+forge+neo" = _YW1OpVEB;
        "pkg-1.21.5-4.5-fabric+forge+neo" = _OoLpqy1h;
        "pkg-1.21.6-4.5-fabric+forge+neo" = _a6BWmvDO;
        "pkg-1.21.7-4.5-fabric+forge+neo" = _eea7nZIB;
        "pkg-1.21.8-4.5-fabric+forge+neo" = _PxZ2Joe3;
        "pkg-1.21.9-4.5-fabric+forge+neo" = _3mJMzQSo;
        "pkg-1.21.9-4.6-fabric+forge+neo" = _aXW8QFU7;
        "pkg-1.21.10-4.6-fabric+forge+neo" = _lsv0jmFq;
        "pkg-1.21.11-4.6-fabric+forge+neo" = _JWrqSq3m;
        "pkg-26.1.0-4.6-fabric+forge+neo" = _cYndQePV;
        "pkg-26.1.1-4.6-fabric+forge+neo" = _PuIiMUlf;
        "pkg-26.1.2-4.6-fabric+forge+neo" = _sBTKLL2b;
        "pkg-26.2.0-4.6-fabric+forge+neo" = _AZpo6AAH;
        "default" = _AZpo6AAH;
    });
