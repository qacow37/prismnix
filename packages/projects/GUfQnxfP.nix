...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta.1" = _TB11OLBP;
        "pkg-1.0.0-beta.1b" = _CCfCVC8t;
        "pkg-1.1.0" = _MRGpbtr9;
        "pkg-1.2.0" = _LOJlMBr0;
        "pkg-1.2.1" = _dmlWbvUn;
        "pkg-1.3.0" = _FNR0PAjZ;
        ...
        "pkg-1.4.1" = _oILQn1i4;
        "pkg-1.4.2" = _xVET8eFV;
        "pkg-1.4.2-1.19" = _aP7lMC1Y;
        "pkg-1.4.3-1.19" = _oFLDqfKf;
        "pkg-1.5-1.19" = _yotEwAIc;
        "pkg-1.5.1-1.19" = _BMJ4jDs4;
        "pkg-1.6-1.19" = _IVPDjbmC;
        "pkg-1.7-1.19.3" = _vPSWvX1A;
        "pkg-1.8-1.19.3" = _xPVxvLP6;
        "pkg-1.9-1.19.3" = _9sh2F7yW;
        "pkg-1.10-mc1.19.3" = _95VZNzxm;
        "pkg-1.11-mc1.19.3" = _ISft0rqu;
        "pkg-1.12-mc1.19.4" = _r8lG6Gx9;
        "pkg-1.13+mc1.20.1" = _uy6eLYbs;
        "pkg-1.13+mc1.20.2" = _jtLZN5pF;
        "pkg-1.13+mc1.20.4" = _4gq2wLnp;
        "pkg-1.13+mc1.20.6" = _G3ckszMH;
        "pkg-1.13+mc1.21.1" = _RbjiJvIE;
        "pkg-1.13.1+mc1.21.3" = _3jVxF6JL;
        "pkg-1.13.1+mc1.21.4" = _unKsUa4b;
        "pkg-1.13.2+mc1.21.4" = _1nxzvTC0;
        "pkg-1.13.2+mc1.21.3" = _kwyeturW;
        "pkg-1.13.2+mc1.21.1" = _SidxJprv;
        "pkg-1.13.2+mc1.20.6" = _7WtAJZQL;
        "pkg-1.13.2+mc1.21.5" = _Hgv6bTPC;
        "pkg-1.14+mc1.21.6" = _cgvng1Vs;
        "pkg-1.15+mc1.21.8" = _zMr6lim5;
        "pkg-1.15+mc1.21.11" = _1c3mfxxS;
        "default" = _1c3mfxxS;
    });
