...
let
    ...
    in {
        ...
        "pkg-1.2.0-build.2" = _Lh1XXX8y;
        "pkg-3.0.0-build.16+mc1.20" = _mQEhhrbi;
        "pkg-3.0.1" = _m86evOWI;
        "pkg-build.17+mc1.20.1" = _wmSE9DVH;
        "pkg-build.11+mc1.19" = _nwjMsWr3;
        "pkg-build.10+mc1.18.2" = _hngJuHpL;
        "pkg-build.9+mc1.18.2" = _rCHX0xbw;
        "pkg-build.8+mc1.18.1" = _SLoyfMec;
        "pkg-build.6+mc1.18.1" = _dVHZuudZ;
        "pkg-build.5+mc1.18.1" = _W0S3meai;
        "pkg-build.4+mc1.18" = _2YFREjiQ;
        "pkg-build.3+mc1.17.1" = _DuwrHGuO;
        "pkg-build.2+mc1.16.5" = _l5kliceT;
        "pkg-build.18+mc1.20.1" = _dEGPNZwJ;
        "pkg-build.12+mc1.19.1" = _SQQdP4jS;
        "pkg-1.1.5" = _1Ivg9igB;
        "pkg-1.1.3" = _ido01tzH;
        "pkg-1.1.2" = _JSSDEiHU;
        "pkg-1.1.1" = _Vto2Vhqg;
        "pkg-1.0.2" = _qUpqSPCi;
        "pkg-84.0.0" = _4ftoHVNW;
        "pkg-84.0.1" = _esadCwGA;
        "pkg-85.0.0" = _bexTTIeR;
        "pkg-86.0.0" = _8sungwuT;
        "pkg-87.0.0" = _n9f2ny34;
