...
let
    ...
    in {
        ...
        "pkg-1.16.5-0.1.0" = _YtmyfrQV;
        "pkg-1.18.2-1.0.1" = _GzEp0EQy;
        "pkg-1.18.2-1.0.3" = _xeaA2UNU;
        "pkg-1.18.2-1.0.4" = _mS1UlDfS;
        "pkg-1.19.2-1.1.0" = _RroeCDhD;
        "pkg-1.19.2-1.1.1" = _hPh4l67t;
        "pkg-1.19.2-1.1.2" = _kjQicvdF;
        "pkg-1.18.2-1.0.5" = _Hbgz12i4;
        "pkg-1.19.2-1.1.3" = _sm0aMNbo;
        "pkg-1.19.2-1.1.4" = _f0rfhSdt;
        "pkg-1.20.1-1.2.0-BETA1" = _SzLYPHwQ;
        "pkg-1.20.1-1.2.0-BETA2" = _nyeH146i;
        "pkg-1.20.1-1.2.0-BETA3" = _nOJ2Yzpr;
        "pkg-1.20.1-1.2.0" = _sJZnwwJr;
        "pkg-1.3.0-BETA01" = _zFKBUZtX;
        "pkg-1.3.0-BETA02" = _z50KCKEK;
        "pkg-1.20.1-1.2.1" = _KXHtN7Rf;
        "pkg-1.3.0-BETA03" = _yMjxI0pF;
        "pkg-1.3.0-BETA04" = _Nh6AebuG;
        "pkg-1.3.1-BETA01" = _g9FoBmM0;
        "pkg-1.20.1-1.2.2" = _MzWoA26x;
        "pkg-1.3.1" = _unWb9uuK;
        "pkg-1.3.2" = _LX5fWOvU;
        "default" = _LX5fWOvU;
    });
