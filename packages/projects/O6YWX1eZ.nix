...
let
    ...
    in {
        ...
        "pkg-1.0-1.21" = _d0g6eIHt;
        "pkg-1.0-1.21.1" = _aZFYZbYy;
        "pkg-1.0-1.21.2" = _XXOTnLB8;
        "pkg-1.0-1.21.3" = _voE0gxPS;
        "pkg-1.0-1.21.4" = _3D9peD9E;
        "pkg-1.0-1.21.5" = _1Qz2Scsk;
        "pkg-1.1-1.21.1" = _KMLUvtmz;
        "pkg-1.1-1.21.2" = _ifT2IUuG;
        "pkg-1.1-1.21.3" = _LVD50tua;
        "pkg-1.1-1.21.4" = _GQBThbcZ;
        "pkg-1.1-1.21.5" = _sqmW9xwK;
        "pkg-1.2-1.21" = _KaqnNKJA;
        "pkg-1.2-1.21.2-1.21.3" = _iViLwD2l;
        "pkg-1.2-1.21.4" = _oKcNC1JL;
        "pkg-1.2-1.21.5" = _NDYczRr6;
        "pkg-1.2.1" = _90DGCfY9;
        "pkg-1.2.2+1.21" = _fIt29OpS;
        "pkg-1.2.2+1.21.1" = _GSX0uSPI;
        "pkg-1.2.2+1.21.2" = _eb8s1lBS;
        "pkg-1.2.2+1.21.3" = _snpk5eus;
        "pkg-1.2.2+1.21.4" = _nD7327R6;
        "pkg-1.2.2+1.21.5" = _VVfQ4FWL;
        "default" = _VVfQ4FWL;
    });
