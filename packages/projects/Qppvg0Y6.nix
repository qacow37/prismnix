...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.21" = _O4DwZ9eT;
        "pkg-0.1.0+1.21.10" = _nKjuGSLe;
        "pkg-0.1.0+1.21.11" = _F4oEPypm;
        "pkg-0.1.0+1.21.5" = _8odMjQMk;
        "pkg-0.1.0+1.21.8" = _A9dqwh3j;
        "pkg-0.1.1+1.21" = _Orsvc9Ll;
        "pkg-0.1.1+1.21.10" = _WWpk1pG1;
        "pkg-0.1.1+1.21.11" = _hcfZsKtr;
        "pkg-0.1.1+1.21.5" = _4uqUbSLp;
        "pkg-0.1.1+1.21.8" = _Y1B8T8JC;
        "pkg-0.1.2+1.21" = _z1zOFkwg;
        "pkg-0.1.2+1.21.10" = _zTUwmvGZ;
        "pkg-0.1.2+1.21.11" = _lT5Srkkl;
        "pkg-0.1.2+1.21.5" = _uT2ExE7E;
        "pkg-0.1.2+1.21.8" = _Vgai8BVM;
        "pkg-0.1.3+1.21" = _Ke9QHJHz;
        "pkg-0.1.3+1.21.10" = _MIp91e2u;
        "pkg-0.1.3+1.21.11" = _f91ZBqbP;
        "pkg-0.1.3+1.21.5" = _6qLgyPwG;
        "pkg-0.1.3+1.21.8" = _IT6piM9L;
        "pkg-0.2.0+1.21" = _SXFNeKQh;
        "pkg-0.2.0+1.21.10" = _19Ptkmxw;
        "pkg-0.2.0+1.21.11" = _hmnwCjDm;
        "pkg-0.2.0+1.21.5" = _LeR4KTwd;
        "pkg-0.2.0+1.21.8" = _BlRNAeN9;
        "pkg-0.2.1+1.21" = _isWpy8hy;
        "pkg-0.2.1+1.21.10" = _pdr3XpZr;
        "pkg-0.2.1+1.21.11" = _q5yXRZ3s;
        "pkg-0.2.1+1.21.5" = _6cnWBbkH;
        "pkg-0.2.1+1.21.8" = _ucfS1Q2U;
        "pkg-0.2.2+1.21" = _2kjmO0h3;
        "pkg-0.2.2+1.21.11" = _8t1esB5P;
        "pkg-0.2.2+1.21.8" = _naKybqic;
        "pkg-0.2.2+1.21.10" = _iBHlfBpf;
        "pkg-0.2.2+1.21.5" = _lTUrX4yW;
        "pkg-0.2.3+1.21" = _m8hFnKAU;
        "pkg-0.2.3+1.21.5" = _5obpvlLx;
        "pkg-0.2.3+1.21.8" = _tccTPCfj;
        "pkg-0.2.3+1.21.10" = _nbRftuBU;
        "pkg-0.2.3+1.21.11" = _kJSwUOID;
        "pkg-0.2.4+1.21" = _3ZPNpeyB;
        "pkg-0.2.4+1.21.5" = _MsCEtKhN;
        "pkg-0.2.4+1.21.8" = _7m0SVNVt;
        "pkg-0.2.4+1.21.10" = _kREqW3LW;
        "pkg-0.2.4+1.21.11" = _aez9Re3w;
        "pkg-0.2.5+1.21" = _JFbkwHCF;
        "pkg-0.2.5+1.21.5" = _xheB0Y7x;
        "pkg-0.2.5+1.21.8" = _AXft6Lza;
        "pkg-0.2.5+1.21.10" = _tuYZdnKq;
        "pkg-0.2.5+1.21.11" = _TjOG2Hu4;
        "pkg-0.3.0+1.21" = _4AHm1JYV;
        "pkg-0.3.0+1.21.5" = _xGpI38MD;
        "pkg-0.3.0+1.21.8" = _CYe9f3SF;
        "pkg-0.3.0+1.21.10" = _nUfB1hOg;
        "pkg-0.3.0+1.21.11" = _BFEGWImv;
        "pkg-0.3.1+1.21" = _sTsZ1CS6;
        "pkg-0.3.1+1.21.5" = _qHMCrbc2;
        "pkg-0.3.1+1.21.8" = _1s7sd87D;
        "pkg-0.3.1+1.21.10" = _VDfRhUlJ;
        "pkg-0.3.1+1.21.11" = _DxFcLRi9;
        "pkg-0.3.2+1.21" = _cDFhoGkX;
        "pkg-0.3.2+1.21.5" = _CWqPZeIB;
        "pkg-0.3.2+1.21.8" = _jusSvV4I;
        "pkg-0.3.2+1.21.10" = _T6dMLCPG;
        "pkg-0.3.2+1.21.11" = _yx8Tp8xO;
        "pkg-0.3.3+1.20.1" = _FYsoPgrg;
        "pkg-0.3.3+1.20.2" = _R2olifqx;
        "pkg-0.3.3+1.20.4" = _YouASHhV;
        "pkg-0.3.3+1.20.6" = _ig4Gi7w0;
        "pkg-0.3.3+1.21" = _FjA6oKbw;
        "pkg-0.3.3+1.21.5" = _2mCkxw5h;
        "pkg-0.3.3+1.21.8" = _XxV2AC1T;
        "pkg-0.3.3+1.21.10" = _qrHalysk;
        "pkg-0.3.3+1.21.11" = _ITctkqcr;
        "pkg-0.4.0+1.17.1" = _niFuDlVj;
        "pkg-0.4.0+1.19.4" = _l9dsKz1m;
        "pkg-0.4.0+1.20.1" = _FfNn4jJe;
        "pkg-0.4.0+1.20.2" = _dDThdPi9;
        "pkg-0.4.0+1.20.4" = _tw8UtqJm;
        "pkg-0.4.0+1.20.5" = _9Vodv0mr;
        "pkg-0.4.0+1.20.6" = _Gd7vjTmB;
        "pkg-0.4.0+1.21" = _87l97xVB;
        "pkg-0.4.0+1.21.5" = _crVlYAxJ;
        "pkg-0.4.0+1.21.8" = _6zHtqNO6;
        "pkg-0.4.0+1.21.10" = _IC9xNEI4;
        "pkg-0.4.0+1.21.11" = _MKocRZnJ;
        "pkg-0.5.0+1.15.2" = _t5GV6wxm;
        "pkg-0.5.0+1.16.5" = _fARaVqzQ;
        "pkg-0.5.0+1.17.1" = _mkSi0VP3;
        "pkg-0.5.0+1.19.4" = _rz4j7ZF3;
        "pkg-0.5.0+1.20.1" = _RWVNy4Ct;
        "pkg-0.5.0+1.20.2" = _Oouh0HuK;
        "pkg-0.5.0+1.20.4" = _aFFY7tNU;
        "pkg-0.5.0+1.20.5" = _VrAbTVUR;
        "pkg-0.5.0+1.20.6" = _o5uwXgN3;
        "pkg-0.5.0+1.21" = _CjIVzHAh;
        "pkg-0.5.0+1.21.5" = _Kpo1xRJG;
        "pkg-0.5.0+1.21.8" = _fr3Ea9xU;
        "pkg-0.5.0+1.21.10" = _ABintpcf;
        "pkg-0.5.0+1.21.11" = _UXosEdG4;
        "pkg-0.5.1+1.15.2" = _Y2Fb5PJL;
        "pkg-0.5.1+1.16.5" = _4XqyTLlo;
        "pkg-0.5.1+1.17.1" = _1BUiQkan;
        "pkg-0.5.1+1.19.4" = _bRfRushW;
        "pkg-0.5.1+1.20.1" = _s7wdy8B5;
        "pkg-0.5.1+1.20.2" = _GAnQ9073;
        "pkg-0.5.1+1.20.4" = _ijlHQEiT;
        "pkg-0.5.1+1.20.5" = _MwEBx86v;
        "pkg-0.5.1+1.20.6" = _Nv1Xj32h;
        "pkg-0.5.1+1.21" = _DbQ0mgwb;
        "pkg-0.5.1+1.21.5" = _euQf38x4;
        "pkg-0.5.1+1.21.8" = _VU5jzwf9;
        "pkg-0.5.1+1.21.10" = _QmtiF0ZC;
        "pkg-0.5.1+1.21.11" = _km1SkOAy;
        "pkg-0.6.0+1.15.2" = _HFwcOXpP;
        "pkg-0.6.0+1.16.5" = _uD9YicGk;
        "pkg-0.6.0+1.17.1" = _98VbSq3b;
        "pkg-0.6.0+1.19.4" = _xZcqBSt9;
        "pkg-0.6.0+1.20.1" = _VvKwymxc;
        "pkg-0.6.0+1.20.2" = _HOocxS0i;
        "pkg-0.6.0+1.20.4" = _sWpahiCt;
        "pkg-0.6.0+1.20.5" = _9zNpUgWV;
        "pkg-0.6.0+1.20.6" = _Nouw1vOU;
        "pkg-0.6.0+1.21" = _itnBGx5I;
        "pkg-0.6.0+1.21.5" = _lI8NyeLO;
        "pkg-0.6.0+1.21.8" = _eeHqroT4;
        "pkg-0.6.0+1.21.10" = _RqQJ99kJ;
        "pkg-0.6.0+1.21.11" = _9qB3okIu;
        "pkg-0.6.0+26.1" = _4RglCnc0;
        "pkg-0.6.1+1.15.2" = _19hRm5QT;
        "pkg-0.6.1+1.16.5" = _EreKNpSb;
        "pkg-0.6.1+1.17.1" = _vNsKyHeF;
        "pkg-0.6.1+1.19.4" = _zzeBK3do;
        "pkg-0.6.1+1.20.1" = _V2QdiCQ9;
        "pkg-0.6.1+1.20.2" = _znYG5u52;
        "pkg-0.6.1+1.20.4" = _QEKCqx7e;
        "pkg-0.6.1+1.20.5" = _3CBANjQZ;
        "pkg-0.6.1+1.20.6" = _BgJCpwYH;
        "pkg-0.6.1+1.21" = _3N3otIQy;
        "pkg-0.6.1+1.21.5" = _uaUfwCC8;
        "pkg-0.6.1+1.21.8" = _mxVCnkC9;
        "pkg-0.6.1+1.21.10" = _6CsZJcxS;
        "pkg-0.6.1+1.21.11" = _pAdaTVq2;
        "pkg-0.6.1+26.1" = _tTzguAqB;
        "pkg-0.7.0+1.15.2" = _xuuXczsP;
        "pkg-0.7.0+1.16.5" = _7UnF6qx8;
        "pkg-0.7.0+1.17.1" = _enGNRsGf;
        "pkg-0.7.0+1.19.4" = _M4bLlSM7;
        "pkg-0.7.0+1.20.1" = _RnY4aBDs;
        "pkg-0.7.0+1.20.2" = _s0Ic5ncN;
        "pkg-0.7.0+1.20.4" = _1XdSWfaY;
        "pkg-0.7.0+1.20.5" = _2Unqj2ZU;
        "pkg-0.7.0+1.20.6" = _EES9AKqv;
        "pkg-0.7.0+1.21" = _ofgc9Jyi;
        "pkg-0.7.0+1.21.5" = _wuz8VMYg;
        "pkg-0.7.0+1.21.8" = _ZMabLhaz;
        "pkg-0.7.0+1.21.10" = _uYg3lUef;
        "pkg-0.7.0+1.21.11" = _v17GvGXb;
        "pkg-0.7.0+26.1" = _QFZgCrpX;
        "pkg-0.8.0+1.15.2" = _isxEbVtU;
        "pkg-0.8.0+1.16.5" = _yIlZNx4y;
        "pkg-0.8.0+1.17.1" = _LYoD8Wti;
        "pkg-0.8.0+1.19.4" = _UzGPt7cr;
        "pkg-0.8.0+1.20.1" = _hsL2Jyaw;
        "pkg-0.8.0+1.20.2" = _LuCCeVaQ;
        "pkg-0.8.0+1.20.4" = _KQCCjzoM;
        "pkg-0.8.0+1.20.5" = _l0YEIsn5;
        "pkg-0.8.0+1.20.6" = _BtEeR8bH;
        "pkg-0.8.0+1.21" = _rvxeC1qk;
        "pkg-0.8.0+1.21.5" = _rBHX5uS2;
        "pkg-0.8.0+1.21.8" = _ihJpfp5E;
        "pkg-0.8.0+1.21.10" = _oKwfQYHU;
        "pkg-0.8.0+1.21.11" = _Tk4Kl6pE;
        "pkg-0.8.0+26.1" = _VaB7xK4d;
        "pkg-0.8.1+1.15.2" = _eVLGqXPm;
        "pkg-0.8.1+1.16.5" = _YZVBR0NO;
        "pkg-0.8.1+1.17.1" = _Q19ye2gw;
        "pkg-0.8.1+1.19.4" = _XYy2Lu3H;
        "pkg-0.8.1+1.20.1" = _Kn1dufGo;
        "pkg-0.8.1+1.20.2" = _BFZmyBYZ;
        "pkg-0.8.1+1.20.4" = _xK1K4aaR;
        "pkg-0.8.1+1.20.5" = _4VI7nJj9;
        "pkg-0.8.1+1.20.6" = _YmasIh5G;
        "pkg-0.8.1+1.21" = _vvz0ANUo;
        "pkg-0.8.1+1.21.5" = _UKbQnwBt;
        "pkg-0.8.1+1.21.8" = _ULUtmANz;
        "pkg-0.8.1+1.21.10" = _UAOFoxup;
        "pkg-0.8.1+1.21.11" = _F26phaIl;
        "pkg-0.8.1+26.1" = _w0OQDfpR;
        "pkg-0.8.2+1.15.2" = _h0qZDHgk;
        "pkg-0.8.2+1.16.5" = _qxvkVSlN;
        "pkg-0.8.2+1.17.1" = _xtlqMn6c;
        "pkg-0.8.2+1.19.4" = _fRj0bDnz;
        "pkg-0.8.2+1.20.1" = _1iuoGxu1;
        "pkg-0.8.2+1.20.2" = _3rYGYuxK;
        "pkg-0.8.2+1.20.4" = _CS9bb6Yl;
        "pkg-0.8.2+1.20.5" = _2zEVNjkG;
        "pkg-0.8.2+1.20.6" = _44jfV3gh;
        "pkg-0.8.2+1.21" = _n5bbISsq;
        "pkg-0.8.2+1.21.5" = _49Q1xaEg;
        "pkg-0.8.2+1.21.8" = _DiHJpdjI;
        "pkg-0.8.2+1.21.10" = _VV3EUOnB;
        "pkg-0.8.2+1.21.11" = _vrEo93jA;
        "pkg-0.8.2+26.1" = _tTDFcowy;
        "pkg-0.8.3+1.15.2" = _gipPRxsH;
        "pkg-0.8.3+1.16.5" = _Be797wA2;
        "pkg-0.8.3+1.17.1" = _HPikGInV;
        "pkg-0.8.3+1.19.4" = _6SJA4q9N;
        "pkg-0.8.3+1.20.1" = _PqFt409m;
        "pkg-0.8.3+1.20.2" = _Dk9W0gmM;
        "pkg-0.8.3+1.20.4" = _oos2ZbwZ;
        "pkg-0.8.3+1.20.5" = _UB0FbcWt;
        "pkg-0.8.3+1.20.6" = _IaPTj2QM;
        "pkg-0.8.3+1.21" = _Dwa3kak9;
        "pkg-0.8.3+1.21.5" = _jvCYDkbu;
        "pkg-0.8.3+1.21.8" = _GgMySTVe;
        "pkg-0.8.3+1.21.10" = _D3tzCcge;
        "pkg-0.8.3+1.21.11" = _XkuK5De3;
        "pkg-0.8.3+26.1" = _qR7R8N1L;
        "pkg-0.8.3+26.2" = _eQCKfoUV;
        "default" = _eQCKfoUV;
    });
