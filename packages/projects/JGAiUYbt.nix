...
let
    ...
    in {
        ...
        "pkg-1.19.4-1.0.1" = _wGjXrq1B;
        "pkg-1.19.4-1.0.2" = _8JMH8UsZ;
        "pkg-1.19.4-1.0.3" = _3fTLS5VS;
        "pkg-1.20.1-1.1.0" = _5kM7rkFq;
        "pkg-1.20.1-1.1.1" = _o2KZlnlq;
        "pkg-1.20.1-1.1.2" = _TFpGRprD;
        "pkg-1.20.1-1.1.3" = _yl0Z6xhA;
        "pkg-1.20.1-1.1.4" = _rCOnmVOR;
        "pkg-1.20.1-1.1.5" = _qa3n4nOI;
        "pkg-1.20.1-2.0.0" = _kekp4xVn;
        "pkg-1.20.1-2.0.1" = _om8MeC6s;
        "pkg-1.20.1-2.0.2" = _3RxAysVG;
        "pkg-1.20.1-2.0.3" = _jGMmIzyR;
        "pkg-1.20.1-2.0.4" = _FXap1lpQ;
        "pkg-1.20.1-2.1.0" = _ZjeO96Qp;
        "pkg-1.20.1-2.1.1" = _9evCvUoV;
        "pkg-1.20.1-2.1.2" = _o9JwOA6j;
        "pkg-1.20.1-2.1.2b" = _HS9FkmR9;
        "pkg-1.20.1-2.1.pride" = _kWnGlVLS;
        "pkg-1.20.1-2.1.pride2" = _5pawlEyU;
        "pkg-1.20.1-2.1.3" = _rrpkI19y;
        "pkg-1.20.1-2.2.0" = _aniUpiN0;
        "pkg-1.20.1-2.2.1" = _qTb0ZBzs;
        "pkg-1.20.1-2.2.2" = _6mAsNpBn;
        "default" = _6mAsNpBn;
    });
