...
let
    ...
    in {
        ...
        "pkg-1.0.6" = _f1EM4a0u;
        "pkg-1.0.7" = _7uQPT2jG;
        "pkg-1.1.0-1.19.2" = _4NTLuoeq;
        "pkg-1.1.1-1.19.2" = _wmqwWsI5;
        "pkg-1.1.2-1.20.1" = _Ac87Pghx;
        "pkg-1.0.7-1.16.5" = _3QPrNC6b;
        "pkg-1.0.8-1.18.2" = _5IPVazZi;
        "pkg-1.1.3-1.19.2" = _fSiyOqGa;
        "pkg-1.1.4-1.20.1" = _CNKHkUk0;
        "pkg-1.1.4-fix.1-1.20.1" = _1FIyOu3S;
        "pkg-1.1.5-1.21" = _zREdhtVT;
        "pkg-1.1.6-1.21.1" = _e62sQJdq;
        "pkg-1.1.6.182-1.18.2" = _o8HzJ9iC;
        "pkg-1.1.7-1.21.1" = _RWkFwMlI;
        "pkg-1.1.8-1.21.1" = _2OwSdp7w;
        "default" = _2OwSdp7w;
    });
