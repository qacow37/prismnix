...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.4.6" = _njhaGLgG;
        "pkg-1.19.2-0.2.7" = _JQpEcgQ8;
        "pkg-1.19.4-0.4.4" = _dMBwSOdh;
        "pkg-1.20.1-0.4.4" = _T2A3n3Ny;
        "pkg-1.20.1-0.4.6" = _BioXa03K;
        "pkg-1.20.1-0.4.8" = _v3C7WDUL;
        "pkg-0.5.0" = _w11JGdQ8;
        "pkg-1.20.1-0.4.9" = _wAYHNkKT;
        "pkg-1.20.1-0.4.10" = _PPBoDUdl;
        "pkg-1.20.1-0.4.12" = _LNnBjKso;
        "pkg-1.21.1-0.5.2" = _RNz7HI6o;
        "pkg-1.20.1-0.4.13" = _vwu0c3R2;
        "pkg-1.21.1-0.5.3" = _LKgJmyWY;
        "pkg-1.21.1-0.5.5" = _dG9w5D2d;
        "pkg-1.21.1-0.5.6" = _L0bQ1LVv;
        "pkg-26.1.2-6.0-alpha2" = _q6tL8bke;
        "pkg-26.1.2-6.0" = _yTcRgu2K;
        "pkg-26.1.2-6.0.1" = _SSmBlhDp;
        "pkg-26.1.2-6.0.2" = _kHpVceYc;
        "pkg-26.1.2-6.0.3" = _gY6W18vf;
        "pkg-26.1.2-6.0.5" = _VyTv4JKA;
        "pkg-26.1.2-6.0.6" = _47cBBRFK;
        "pkg-26.1.2-6.1.0" = _BoqiNknZ;
        "pkg-26.1.2-6.1.1" = _3l8do7YO;
        "pkg-26.1.2-6.1.2" = _SV8Vicys;
        "pkg-26.1.2-6.1.3" = _I9CrJqHp;
        "pkg-26.1.2-6.1.4" = _9qgMsLy7;
        "default" = _9qgMsLy7;
    });
