...
let
    ...
    in {
        ...
        "pkg-1.7.10-1.0.0" = _zykF5vwQ;
        "pkg-1.7.10-1.0.1" = _5lHe21Vr;
        "pkg-1.8.9-1.0.0" = _vDHVFabr;
        "pkg-1.8.9-1.0.1" = _1jopyVYm;
        "pkg-1.8.9-1.0.2" = _GSZhJGko;
        "pkg-1.8.9-1.0.3" = _Dw2Jpes8;
        "pkg-1.8.9-1.1.0" = _liTyS6NZ;
        "pkg-1.8.9-1.2.0" = _1tcE0Erf;
        "pkg-Beta-1.10.2-1.0.0" = _UGELqSXP;
        "pkg-Beta-1.10.2-1.0.1" = _A2c4ETHo;
        "pkg-Beta-1.10.2-1.0.2" = _rJBSzpXP;
        "pkg-Beta-1.10.2-1.0.3" = _nAO4IIkf;
        "pkg-Beta-1.10.2-1.0.4" = _vijc405s;
        "pkg-1.10.2-1.0.0" = _FyMHBmJu;
        "pkg-1.10.2-1.0.1" = _jdiCVvH0;
        "pkg-1.10.2-1.1.0" = _oiwd59l6;
        "pkg-1.10.2-1.1.1" = _pzDNccJC;
        "pkg-1.10.2-1.1.2" = _eJ27ckmu;
        "pkg-1.12-1.2.0" = _K1NyWORV;
        "pkg-1.12-1.2.1" = _mrxTPgwN;
        "pkg-1.12-1.2.2" = _oLdoNfHK;
        "pkg-1.12-1.2.3" = _bWl2mdU7;
        "pkg-1.12.2-2.0.0" = _IQsBuOoU;
        "pkg-1.12.2-2.0.1" = _FWR65iiM;
        "pkg-1.12.2-2.0.2" = _s6TaWB2a;
        "pkg-1.12.2-2.0.3" = _2eFn4ubY;
        "pkg-1.12.2-2.0.4" = _eT2GtP6k;
        "pkg-1.12.2-2.0.5" = _wMzm2a0M;
        "pkg-1.12.2-2.1.0" = _x3i9rjv2;
        "pkg-1.12.2-2.1.1" = _N23MVcAF;
        "pkg-1.12.2-2.1.2" = _1bmekrPo;
        "pkg-1.12.2-2.2.0" = _MsQdSb0d;
        "pkg-1.12.2-2.2.1" = _ZfNnyHcu;
        "pkg-1.12.2-2.2.2" = _wJE0FOFS;
        "pkg-1.12.2-2.2.3" = _LiFcykzH;
        "pkg-1.12.2-2.2.4" = _Jg9YA9yk;
        "pkg-1.12.2-2.2.5" = _oLOds5it;
        "pkg-1.12.2-2.2.6" = _csEqFkjH;
        "pkg-1.12.2-2.2.7" = _wOe2uHqZ;
        "pkg-1.12.2-2.3.0" = _HCB5DOuw;
        "pkg-1.12.2-2.3.1" = _hATAghRi;
        "pkg-1.12.2-2.3.2" = _7ztSSRXy;
        "pkg-1.12.2-2.3.3" = _cQXzwuNp;
        "pkg-1.12.2-2.3.4" = _p9FW6pl8;
        "pkg-1.12.2-2.3.5" = _hmDq7Qmk;
        "pkg-1.12.2-2.4.0" = _2w0QaUab;
        "pkg-1.12.2-2.4.1" = _VBzT1hKA;
        "pkg-1.12.2-2.4.2" = _4tye0RYx;
        "pkg-1.12.2-2.4.3" = _zWE09agQ;
        "pkg-1.12.2-2.4.4" = _1pQWZPcY;
        "pkg-1.12.2-2.4.5" = _xfhxzQPh;
        "pkg-1.12.2-2.4.6" = _ebvqyPDz;
        "pkg-1.12.2-2.4.7" = _oCgNTeAk;
        "pkg-1.12.2-2.4.8" = _kTf0Uy7N;
        "pkg-1.12.2-2.4.9" = _LUbpzxBm;
        "pkg-1.12.2-2.4.10" = _UgS0yM7J;
        "pkg-1.12.2-2.4.11" = _zPpeMN8b;
        "pkg-1.12.2-2.4.12" = _64uwk3tp;
        "pkg-1.12.2-2.4.13" = _nCc3TRL6;
        "pkg-1.12.2-2.4.14" = _QenJU5iA;
        "pkg-1.12.2-2.4.15" = _y9G56JNW;
        "pkg-1.12.2-2.4.16" = _Rl94Dw7x;
        "pkg-1.12.2-2.4.17" = _6XgUGXC4;
        "default" = _6XgUGXC4;
    });
