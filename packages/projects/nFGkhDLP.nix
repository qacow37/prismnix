...
let
    ...
    in {
        ...
        "pkg-1.20-0.0.6-beta" = _uyQHOWYm;
        "pkg-1.20.1-0.0.6-beta" = _JtrR8NhL;
        "pkg-1.20.2-0.0.6-beta" = _CeaglNoo;
        "pkg-1.20.2-0.0.6-beta-neoforge" = _BofiZCJv;
        "pkg-1.20.3-0.0.6-beta" = _ttrOhaoY;
        "pkg-1.20.3-0.0.6-beta-neoforge" = _uLlpF9c6;
        "pkg-1.20.4-0.0.6-beta" = _HoXZVcn4;
        "pkg-1.20.4-0.0.6-beta-neoforge" = _CJxVfnJ5;
        "pkg-1.20.5-0.0.6-beta-neoforge" = _D9xEwipt;
        "pkg-1.20.6-0.0.6-beta" = _wdaoBCP1;
        "pkg-1.20.6-0.0.6-beta-neoforge" = _sH51z1xp;
        "pkg-1.21-0.0.6-beta" = _m8PoCX85;
        "pkg-1.21-0.0.6-beta-neoforge" = _XYR4HKav;
        "pkg-1.21.1-0.0.6-beta" = _apWUeJNW;
        "pkg-1.21.1-0.0.6-beta-neoforge" = _p3ZjyDCE;
        "pkg-1.21.2-0.0.6-beta-neoforge" = _l0bp5myt;
        "pkg-1.21.3-0.0.6-beta" = _xCJWVCpX;
        "pkg-1.21.3-0.0.6-beta-neoforge" = _DDsb06XK;
        "pkg-1.21.4-0.0.6-beta" = _VITqt12K;
        "pkg-1.21.4-0.0.6-beta-neoforge" = _6wXD1Rl6;
        "pkg-1.21.4-0.0.7-beta" = _Vh4p8HUn;
        "pkg-1.21.4-0.0.7-beta-neoforge" = _GQHBicGR;
        "pkg-1.21.4-0.0.7-beta-fabric" = _s5S8Hat5;
        "pkg-1.21.4-0.0.1-release" = _VnoJq08K;
        "pkg-1.21.4-0.0.1-release-neoforge" = _Ck1B8IGK;
        "pkg-1.21.4-0.0.1-release-fabric" = _3imjxjvJ;
        "pkg-1.21.3-0.0.1-release" = _TlpAaY5m;
        "pkg-1.21.3-0.0.1-release-fabric" = _hKtGaodJ;
        "pkg-1.21.3-0.0.1-release-neoforge" = _e06mYzE5;
        "pkg-1.21.2-0.0.1-release-fabric" = _BiFlUGAM;
        "pkg-1.21.2-0.0.1-release-neoforge" = _XAgxvkDQ;
        "pkg-1.21.1-0.0.1-release-fabric" = _ndISYxua;
        "pkg-1.21.1-0.0.1-release" = _eMOadT7p;
        "pkg-1.21.1-0.0.1-release-neoforge" = _Lc6GHGmO;
        "pkg-1.21-0.0.1-release" = _tx1lYl9t;
        "pkg-1.21-0.0.1-release-neoforge" = _aZ1HahIJ;
        "pkg-1.21-0.0.1-release-fabric" = _ttehfpzy;
        "pkg-1.20.6-0.0.1-release" = _m884tNtH;
        "pkg-1.20.6-0.0.1-release-neoforge" = _qlbipKMk;
        "pkg-1.20.6-0.0.1-release-fabric" = _ZLTUS7Vp;
        "pkg-1.20.5-0.0.1-release-neoforge" = _fyTmHpD6;
        "pkg-1.20.5-0.0.1-release-fabric" = _QjrPAuwV;
        "pkg-1.20.4-0.0.1-release" = _baqU6rkK;
        "pkg-1.20.4-0.0.1-release-neoforge" = _qpniILTQ;
        "pkg-1.20.4-0.0.1-release-fabric" = _nM3nmf9M;
        "pkg-1.20.3-0.0.1-release" = _p2wfdBVV;
        "pkg-1.20.3-0.0.1-release-neoforge" = _zAaNRteY;
        "pkg-1.20.3-0.0.1-release-fabric" = _joTj9aHv;
        "pkg-1.20.2-0.0.1-release" = _nyJlNvdy;
        "pkg-1.20.2-0.0.1-release-neoforge" = _owJpRonB;
        "pkg-1.20.2-0.0.1-release-fabric" = _WbErNXDZ;
        "pkg-1.20.1-0.0.1-release" = _cLOnbw7r;
        "pkg-1.20.1-0.0.1-release-fabric" = _bxJrUEEs;
        "pkg-1.20-0.0.1-release" = _l70lLI0A;
        "pkg-1.20-0.0.1-release-fabric" = _4oNiboib;
        "pkg-1.21.5-0.0.1-release-fabric" = _oIJW2Xub;
        "pkg-1.21.5-0.0.1-release" = _tyfS8xOw;
        "pkg-1.21.5-0.0.1-release-neoforge" = _Qmz3cPQc;
        "default" = _Qmz3cPQc;
    });
