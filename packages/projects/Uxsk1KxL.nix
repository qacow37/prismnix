...
let
    ...
    in {
        ...
        "pkg-1.21.3" = _sYxV45v9;
        "pkg-1.21" = _IHLoNN1X;
        "pkg-1.20.6" = _NEdvEfNG;
        "pkg-1.20.4" = _1bWeArXo;
        "pkg-1.20" = _7dwvTjqX;
        "pkg-1.21.4" = _pE3mP0et;
        "pkg-1.21.4+mod" = _Pn3gKrmj;
        "pkg-1.21.5" = _r7oS8dnR;
        "pkg-1.21.5+mod" = _pIjLtsXR;
        "pkg-1.21.4.2" = _xw04nZAg;
        "pkg-1.21.4.2+mod" = _jufKrNhI;
        "pkg-1.21.5.2" = _chTrzGZK;
        "pkg-1.21.5.2+mod" = _CiDplo0H;
        "pkg-1.21.6" = _y6ta5I5t;
        "pkg-1.21.6+mod" = _r6WliF5F;
        "pkg-1.21.7" = _qn6jf19v;
        "pkg-1.21.7+mod" = _qi4cCGfW;
        "pkg-1.21.9" = _gtLqX1mr;
        "pkg-1.21.9+mod" = _N4WYgrEG;
        "pkg-1.21.11" = _8kGUvHty;
        "pkg-1.21.11+mod" = _7Dum5SjL;
        "pkg-26.1.2" = _z0dIwhgL;
        "pkg-26.1.2+mod" = _Mzwe7S2N;
        "pkg-26.1.2+recoded" = _WR1h7tBY;
        "pkg-26.1.2+mod+recoded" = _1aYH03B9;
        "default" = _1aYH03B9;
    });
