...
let
    ...
    in {
        ...
        "pkg-1.18" = _KLqo3XMS;
        "pkg-1.19" = _duI2lOQf;
        "pkg-1.19.3" = _SgHdnbRy;
        "pkg-1.19.4" = _VrrSEIUN;
        "pkg-1.20" = _buWryb1y;
        "pkg-1.20.2" = _cNM9Eg6B;
        "pkg-1.20.4" = _b6Stsb9u;
        "pkg-1.20.6" = _AYUkNVCu;
        "pkg-1.21" = _gfvi9eyJ;
        "pkg-1.21.2" = _FxUyzDqp;
        "pkg-1.21.4" = _vEAwUKb0;
        "pkg-1.21.5" = _DKSpcs4z;
        "pkg-1.21.6" = _vLrhHiZl;
        "pkg-1.21.8" = _igVBNNKg;
        "pkg-1.21.10" = _R73nMLcy;
        "pkg-1.21.11" = _nNKmk6vU;
        "pkg-26.1" = _vhKRBVFm;
        "pkg-26.2" = _hW5Z5VsG;
        "pkg-26.1-fix-1" = _zf7eURbA;
        "default" = _zf7eURbA;
    });
