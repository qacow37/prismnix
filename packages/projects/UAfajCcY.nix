...
let
    ...
    in {
        ...
        "pkg-4.2.5" = _KNsK39OM;
        "pkg-5.2.9" = _8yua2KfL;
        "pkg-5.3.10" = _v0jbUMEd;
        "pkg-5.3.11" = _rMsZduqp;
        "pkg-6.2.0" = _MOtHvWYa;
        "pkg-7.0.0" = _m3P6FcQQ;
        "pkg-7.1.1" = _tFGw00HI;
        "pkg-8.0.0" = _7PC3PJ7w;
        ...
        "pkg-8.0.4" = _jEIpaFCl;
        "pkg-8.1.4" = _GlzjToup;
        "pkg-10.0.0" = _DpIIVcTF;
        "pkg-10.1.1" = _mjKLctKv;
        "pkg-10.1.2" = _RL5zDula;
        "pkg-10.1.3" = _Qct1R3FK;
        "pkg-11.0.0" = _b0il7Yo7;
        "pkg-12.0.0" = _BuOppeBF;
        "pkg-21.1.0" = _a0ooMBs4;
        "pkg-21.1.1" = _vMZ7g5MY;
        "pkg-21.11.0" = _WGVhvWz3;
        "pkg-21.11.1" = _ui2sRaua;
        "pkg-26.2.0" = _p6a0OZ7t;
        "default" = _p6a0OZ7t;
    });
