...
let
    ...
    in {
        ...
        "pkg-1.20.2-7.0.0" = _nmUwbQq4;
        "pkg-1.20.2-8.0.0" = _z0FLTyga;
        "pkg-1.20.2-8.1.0" = _oT6cOPMf;
        "pkg-1.20.4-9.0.0" = _c0Wefhvx;
        "pkg-1.20.4-9.0.1" = _579B8TjG;
        "pkg-1.20.4-9.1.0" = _oJHVvlE6;
        "pkg-1.20.4-9.2.0" = _LVBNRioa;
        "pkg-1.20.4-9.3.0" = _pyyXLf9T;
        "pkg-1.20.5-10.0.0" = _7ttxIvAB;
        "pkg-1.20.5-10.0.1" = _xzdBkEs7;
        "pkg-1.20.6-11.0.0" = _2BUqQWyc;
        "pkg-1.20.6-11.0.1" = _K2eY5NNc;
        "pkg-1.21-12.0.0" = _hqdK55Dl;
        "pkg-1.21-12.0.1" = _86kY8hn5;
        "pkg-1.21-12.0.3" = _8yLpiacj;
        "pkg-1.21.1-13.0.0" = _CgQqPROG;
        "pkg-1.20.1-6.0.0" = _UBkBDDO3;
        "pkg-1.20.1-6.0.1" = _VPBthOgD;
        "pkg-1.21.3-14.0.0" = _1FH4eqvY;
        "pkg-1.20.1-6.0.2" = _tWeVb8m0;
        "pkg-1.21.4-15.0.0" = _u237PQRr;
        "pkg-1.21.5-16.0.0" = _QX3x515G;
        "pkg-1.21.6-17.0.0" = _rS181jD5;
        "pkg-1.21.6-17.0.1" = _MPb2u9WW;
        "pkg-1.20.1-6.1.0" = _pY7zBjxD;
        "pkg-1.21.7-18.0.0" = _8NhQeXqG;
        "pkg-1.21.8-19.0.0" = _rbxi37iQ;
        "pkg-1.21.8-19.1.0" = _8JIwyFEX;
        "pkg-1.21.9-20.0.0" = _U7QkvlNR;
        "pkg-1.21.11-21.0.0" = _1UmXEgZR;
        "pkg-26.1-snapshot-1-22.0.0" = _FvKUzpuT;
        "pkg-26.1-snapshot-23.0.0" = _IUUyQkq3;
        "pkg-26.1-24.0.0" = _Ty9Mkx6P;
        "pkg-26.1.2-25.0.0" = _TEH0IhR6;
        "pkg-26.1.2-25.1.0" = _1iKqWGxT;
        "pkg-1.21.1-13.1.0" = _RLDoUqEL;
        "pkg-26.2.0-26.0.0" = _KKixjJBv;
        "default" = _KKixjJBv;
    });
