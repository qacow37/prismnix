...
let
    ...
    in {
        ...
        "pkg-1.19.1-0-forge" = _Zn4ZTBo5;
        "pkg-1.19.2-0-forge" = _xQSigWYu;
        "pkg-1.19.3-0-forge" = _YRHkpPgz;
        "pkg-1.19.4-0-forge" = _p6CKaRUw;
        "pkg-1.20-0-forge" = _Co4TfcEZ;
        "pkg-1.16.5-0-fabric" = _AhW1ENEh;
        "pkg-1.18.2-0-fabric" = _TKOucQLi;
        "pkg-1.19-0-fabric" = _hSamkcW2;
        "pkg-1.19.1-0-fabric" = _57t4ogNW;
        "pkg-1.19.2-0-fabric" = _21OGLTh7;
        "pkg-1.19.3-0-fabric" = _KpluUnUN;
        "pkg-1.19.4-0-fabric" = _ct15LONM;
        "pkg-1.20-0-fabric" = _UffAxy9P;
        "pkg-1.20.1-0-fabric" = _DKqBQGGF;
        "pkg-1.20.1-0-forge" = _8mbn8Wdf;
        "pkg-1.20.2-0-fabric" = _5jo0rQOF;
        "pkg-1.20.2-0-forge" = _2VMnsEBC;
        "pkg-1.20.3-1-fabric" = _YUaCb0iT;
        "pkg-1.20.3-0-forge" = _omlcnNIU;
        "pkg-1.20.4-0-forge" = _co51CvWj;
        "pkg-1.20.4-1-fabric" = _MQ8vx5LJ;
        "pkg-1.20.4-0-neoforge" = _kSHAzIEv;
        "pkg-1.20.6-0-neoforge" = _WrDHAsBG;
        "pkg-1.20.6-0-forge" = _4usTyhqm;
        "pkg-1.20.5-1-fabric" = _del3jsUX;
        "pkg-1.20.6-1-fabric" = _KexI6D6P;
        "pkg-1.21-1-fabric" = _VL9OvHwg;
        "pkg-1.21-0-forge" = _PFB1krSl;
        "pkg-1.21-0-neoforge" = _Zyz6jcDc;
        "pkg-1.21.1-0-neoforge" = _Z4cPayfU;
        "pkg-1.21.1-1-fabric" = _fnwRjhMR;
        "pkg-1.21.1-0-forge" = _Zz6Eil3q;
        "pkg-1.21.2-1-fabric" = _WzQvfK6k;
        "pkg-1.21.3-0-forge" = _CL2jUSfw;
        "pkg-1.21.3-0-neoforge" = _dM8mIqkb;
        "pkg-1.21.4-1-fabric" = _Mk7CD5mZ;
        "pkg-1.21.4-0-neoforge" = _djJjn2kD;
        "pkg-1.21.4-0-forge" = _ZmbyP4j4;
        "pkg-1.18.2-fabric-2" = _ioEQw3eF;
        "pkg-1.18.2-forge-2" = _jGA9fRp8;
        "pkg-1.19.2-fabric-2" = _zrnTtamF;
        "pkg-1.19.2-forge-2" = _iXSLycBg;
        "pkg-1.19.4-fabric-2" = _Zs6LmWuu;
        "pkg-1.19.4-forge-2" = _muRV1bce;
        "pkg-1.20.1-fabric-2" = _W3uLWFgW;
        "pkg-1.20.1-forge-2" = _JYTq09Gu;
        "pkg-1.20.2-fabric-2" = _r0eGgtCl;
        "pkg-1.20.2-forge-2" = _gUD5qrMf;
        "pkg-1.20.4-fabric-2" = _Wvkx1ySx;
        "pkg-1.20.4-forge-2" = _UO8IJFIi;
        "pkg-1.20.6-fabric-2" = _S2s6lQiO;
        "pkg-1.20.6-forge-2" = _xSeUjsIN;
        "pkg-1.20.6-neoforge-2" = _D1VmktaQ;
        "pkg-1.21.1-fabric-2" = _3ZKZ4Wgf;
        "pkg-1.21.1-forge-2" = _XW9gs75P;
        "pkg-1.21.1-neoforge-2" = _r3q6XqKo;
        "pkg-1.21.3-fabric-2" = _wbQvgh3o;
        "pkg-1.21.3-forge-2" = _T0XtTyDv;
        "pkg-1.21.3-neoforge-2" = _3yzvlaCE;
        "pkg-1.21.4-fabric-2" = _IynktYuz;
        "pkg-1.21.4-forge-2" = _2KdXAPt5;
        "pkg-1.21.4-neoforge-2" = _VRS9WSMs;
        "pkg-1.18.2-forge-2.1" = _vuPgkVhA;
        "pkg-1.19.2-forge-2.1" = _7jVeglzP;
        "pkg-1.19.4-forge-2.1" = _3jjVLMsn;
        "pkg-1.20.1-forge-2.1" = _52K2wMgu;
        "pkg-1.20.2-forge-2.1" = _6X63b0qe;
        "pkg-1.20.4-forge-2.1" = _Kd4UFtfb;
        "pkg-1.20.6-forge-2.1" = _rVYidcXa;
        "pkg-1.20.6-neoforge-2.1" = _MrDtdUyE;
        "pkg-1.21.1-forge-2.1" = _bk8ZM4kI;
        "pkg-1.21.1-neoforge-2.1" = _hFodNN6s;
        "pkg-1.21.3-forge-2.1" = _mwUc6HmB;
        "pkg-1.21.3-neoforge-2.1" = _DhSQBqp2;
        "pkg-1.21.4-forge-2.1" = _gwXyDPxy;
        "pkg-1.21.4-neoforge-2.1" = _xccNlYaF;
        "pkg-1.21.5-fabric-2.1" = _RfoEMf1H;
        "pkg-1.21.5-forge-2.1" = _JpmcWf8L;
        "pkg-1.21.5-neoforge-2.1" = _3Qcb0Wzy;
        "pkg-1.21.6-fabric-2.1" = _polR92EF;
        "pkg-1.21.6-forge-2.1" = _KpnmmMX4;
        "pkg-1.21.6-neoforge-2.1" = _nnOVeizy;
        "pkg-1.21.7-fabric-2.1" = _1GsQYRFu;
        "pkg-1.21.7-forge-2.1" = _k0pJBjCy;
        "pkg-1.21.7-neoforge-2.1" = _K6vYUtCG;
        "pkg-1.21.8-fabric-2.1" = _XMjf2qJ1;
        "pkg-1.21.8-forge-2.1" = _7xu5iAD2;
        "pkg-1.21.8-neoforge-2.1" = _bsgm64ZJ;
        "pkg-1.21.9-fabric-2.1" = _hmlnA34O;
        "pkg-1.21.9-forge-2.1" = _SKCpp932;
        "pkg-1.21.9-neoforge-2.1" = _WHc0HZfl;
        "pkg-1.21.10-fabric-2.1" = _SZseO3Du;
        "pkg-1.21.10-forge-2.1" = _kNy5gjfk;
        "pkg-1.21.10-neoforge-2.1" = _HZbidZzn;
        "pkg-1.21.11-fabric-2.1" = _7QAhIUKs;
        "pkg-1.21.11-forge-2.1" = _b6cE8Lqh;
        "pkg-1.21.11-neoforge-2.1" = _Y6CVp1oE;
        "pkg-1.18.2-fabric-2.1" = _iDQL0GqJ;
        "pkg-1.19.4-fabric-2.2" = _bcv2guIH;
        "pkg-1.19.4-forge-2.2" = _EaOW9slj;
        "pkg-1.20.1-fabric-2.2" = _yQIeEeQw;
        "pkg-1.20.1-forge-2.2" = _EHopKgn1;
        "pkg-1.20.2-fabric-2.2" = _RrzlZU46;
        "pkg-1.20.2-forge-2.2" = _vBhAH0Eu;
        "pkg-1.20.4-fabric-2.2" = _hO4lXEng;
        "pkg-1.20.4-forge-2.2" = _DJYnXyn4;
        "pkg-1.20.6-fabric-2.2" = _uHDi833K;
        "pkg-1.20.6-forge-2.2" = _YUlcjMTT;
        "pkg-1.20.6-neoforge-2.2" = _BMW246Q1;
        "pkg-1.21.1-fabric-2.2" = _egXJE6fw;
        "pkg-1.21.1-forge-2.2" = _14uZRroq;
        "pkg-1.21.1-neoforge-2.2" = _OW1cg4XB;
        "pkg-1.21.10-fabric-2.2" = _ExziFmCT;
        "pkg-1.21.10-forge-2.2" = _Qt03Jw9Y;
        "pkg-1.21.10-neoforge-2.2" = _qZf8OnGb;
        "pkg-1.21.11-fabric-2.2" = _DKw3RBMI;
        "pkg-1.21.11-forge-2.2" = _6FY1xxju;
        "pkg-1.21.11-neoforge-2.2" = _gEl3VuZt;
        "pkg-1.21.3-fabric-2.2" = _mbgi5VzY;
        "pkg-1.21.3-forge-2.2" = _3nJX8doL;
        "pkg-1.21.3-neoforge-2.2" = _Fx01JaJc;
        "pkg-1.21.5-fabric-2.2" = _MOEGFh5q;
        "pkg-1.21.5-forge-2.2" = _Wa330WHB;
        "pkg-1.21.5-neoforge-2.2" = _YzSFSsZf;
        "pkg-1.21.8-fabric-2.2" = _kobahfRo;
        "pkg-1.21.8-forge-2.2" = _kWnM4872;
        "pkg-1.21.8-neoforge-2.2" = _6AaC66oc;
        "pkg-26.1.1-fabric-2.2" = _s0gTVqcQ;
        "pkg-26.1.1-forge-2.2" = _MXtG6K85;
        "pkg-26.1.1-neoforge-2.2" = _XEtxfi6V;
        "pkg-26.1.2-fabric-2.2" = _4C5Ggj2H;
        "pkg-26.1.2-forge-2.2" = _OIRXb21J;
        "pkg-26.1.2-neoforge-2.2" = _ZOs2g48R;
