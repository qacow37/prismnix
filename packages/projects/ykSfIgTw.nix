...
let
    ...
    in {
        ...
        "pkg-v1.1.0" = _Rr8RztrZ;
        "pkg-v1.2.0" = _w5XkMhjx;
        "pkg-1.2.1" = _DJM9Bq9Y;
        "pkg-1.17.1-1.2.2" = _PMdclX6T;
        "pkg-1.16.5-1.2.2" = _tdRVytPZ;
        "pkg-1.17.1-1.2.3" = _5veQpRBB;
        "pkg-v2.0.0+1.18.1" = _fkUg69XE;
        "pkg-v2.0.1+1.18.1" = _lOtiWG89;
        "pkg-v2.1.0+1.18.1" = _5p4W8dWq;
        "pkg-v2.1.1+1.18.2" = _45biHkt5;
        "pkg-v2.1.2+1.18.2" = _Km3xrQ1U;
        "pkg-v2.1.2+1.19.2" = _vqN8KeiB;
        "pkg-v2.1.3+1.19.2" = _S1eIthIl;
        "pkg-v2.1.4+1.18.2" = _GUXv2En7;
        "pkg-v2.1.4+1.19.2" = _t9MYW9lw;
        "pkg-v2.2.0+1.19.4" = _DBJGNfNA;
        "pkg-v2.2.1+1.19.4" = _nuA6kIaF;
        "pkg-v2.2.1+1.20.1" = _qSAa0vuB;
        "pkg-2.3.0+1.20.4" = _lhn1Dwup;
        "pkg-2.4.0+1.20.6" = _CTqdpZTL;
        "pkg-2.4.1+1.20.6" = _l2A19mac;
        "pkg-2.4.1+1.21" = _cb9rzzkK;
        "pkg-2.4.2+1.21.1" = _wBniNKdB;
        "pkg-2.5.0+1.21.4" = _OvJDn5fm;
        "pkg-2.5.1+1.21.4" = _WEadmh4N;
        "pkg-2.5.2+1.21.1" = _AoBlh6vD;
        "pkg-2.5.2+1.21.4" = _MFLGgWoo;
        "pkg-2.5.3+1.21.1" = _SUS3kKGn;
        "pkg-2.5.3+1.21.4" = _uB1qV2tO;
        "pkg-2.5.3+1.21.5" = _nVh9jGuJ;
        "pkg-2.5.4+1.21.1" = _icALBnp4;
        "pkg-2.5.4+1.21.3" = _IxkuMOh7;
        "pkg-2.5.4+1.21.4" = _DoBDsirx;
        "pkg-2.5.4+1.21.5" = _5MbTuLXe;
        "pkg-2.5.4-hotfix.1+1.20.1" = _SkCzMKT5;
        "pkg-2.5.4+1.21.8" = _HskVQM3H;
        "pkg-2.5.5+1.20.1" = _5D6dwqJc;
        "pkg-2.5.5+1.21.1" = _W5rT9OiH;
        "pkg-2.5.5+1.21.10" = _pELpJOoT;
        "pkg-2.5.6+1.21.1" = _vb7jb2UJ;
        "pkg-2.5.6+1.21.8" = _M50WvzET;
        "pkg-2.5.6+1.21.10" = _BVqRW15Q;
        "pkg-2.5.6+1.21.11" = _5sNAnV8X;
        "pkg-2.5.6+1.20.1" = _Jq06AjRo;
        "pkg-2.5.7+1.20.1" = _NHbp3EAm;
        "pkg-2.5.7+1.21.1" = _bix8ndct;
        "pkg-2.5.7+1.21.8" = _DO0pujQG;
        "pkg-2.5.7+1.21.10" = _siWVCyLQ;
        "pkg-2.5.7+1.21.11" = _h8RIIOQq;
        "default" = _h8RIIOQq;
    });
