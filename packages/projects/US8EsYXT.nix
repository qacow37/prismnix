...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.2.0.0" = _70nflJmM;
        "pkg-1.19.4-0.2.0.0" = _vgT6g7Yp;
        "pkg-1.20.1-0.2.0.0" = _7C1ZZMww;
        "pkg-1.16.5-0.1.1.0a" = _YF6shy00;
        "pkg-1.20.1-0.2.0.1" = _7OZhaX4J;
        "pkg-1.18.2-0.2.0.1" = _FM1xX7pF;
        "pkg-1.19.4-0.2.0.1" = _99l6Byt4;
        "pkg-1.20.1-0.2.0.2" = _eKeXJMjW;
        "pkg-1.19.4-0.2.0.2" = _RVwHKQUQ;
        "pkg-1.18.2-0.2.0.2" = _D4jk9vQX;
        "pkg-1.19.2-0.2.0.2" = _fsYFf4lv;
        "pkg-1.20.1-0.2.1.0" = _IK8Vr6E3;
        "pkg-1.20.1-0.2.1.1" = _Q4ft0Nmz;
        "pkg-1.19.2-0.2.1.1" = _sZOoMrmI;
        "pkg-1.19.2-0.2.1.2" = _bxfZvdJf;
        "pkg-1.20.1-0.2.1.2" = _96JFZqRp;
        "pkg-1.19.2-0.2.1.3" = _MZT2GLMJ;
        "pkg-1.20.1-0.2.1.3" = _CY9QFS7D;
        "pkg-1.19.2-0.2.1.3a" = _1CovReLb;
        "pkg-1.19.2-0.2.1.3b" = _XfM23OMn;
        "pkg-1.20.1-0.2.1.3b" = _1lHZcVrE;
        "pkg-1.20.1-0.2.1.3c" = _E4UypMeu;
        "pkg-1.20.1-0.2.1.4" = _lwCwsAsT;
        "pkg-1.20.1-0.2.1.4a" = _nflGZocW;
        "pkg-1.20.1-0.2.1.4b" = _SJd8OwZp;
        "pkg-1.20.1-0.2.1.5" = _1AHdNzyX;
        "pkg-1.20.1-0.2.1.6" = _YG6DcAgA;
        "pkg-1.20.1-0.2.1.7" = _4T7VzIf5;
        "pkg-1.20.1-0.2.1.8" = _TLIItGwO;
        "pkg-1.21-0.2.1.8" = _Vkuy7T7s;
        "pkg-1.21-0.2.1.9" = _AJ3bnL4G;
        "pkg-1.20.1-0.2.1.9" = _ewV2xf9t;
        "pkg-1.21-0.2.1.10" = _AZzo2qHn;
        "pkg-1.20.1-0.2.1.10" = _2baBgBUI;
        "pkg-1.21-0.2.1.11" = _zunlPGop;
        "pkg-1.20.1-0.2.1.11" = _CmUjmwXb;
        "pkg-1.20.1-0.2.1.11a" = _3cbkf8Ur;
        "pkg-1.21-0.2.1.12" = _nq2OE2LZ;
        "pkg-1.21-0.2.1.12a" = _hrkq8moM;
        "pkg-1.20.1-0.2.1.12" = _r12tg3yf;
        "pkg-1.20.1-0.2.1.12a" = _PykqV8Hb;
        "pkg-1.21-0.2.1.12b" = _ym87TRuk;
        "pkg-1.20.1-0.2.1.13" = _OMJI6cWl;
        "pkg-1.21-0.2.1.13" = _tPRJFXs1;
        "pkg-1.21-0.2.1.14" = _NmbXrkYR;
        "pkg-1.20.1-0.2.1.14" = _cLZGRlr1;
        "pkg-1.20.1-0.2.1.15" = _f3qR4mk4;
        "pkg-1.21-0.2.1.15" = _1hFCnfiG;
        "pkg-1.20.1-0.2.1.15a" = _6vVLdclX;
        "pkg-1.21-0.2.1.15a" = _9SxT3VpQ;
        "pkg-1.20.1-0.2.1.16" = _ZLWO5X37;
        "pkg-1.21-0.2.1.16" = _AHGyccSi;
        "pkg-1.20.1-0.2.1.16a" = _U5fklQCW;
        "pkg-1.21-0.2.1.16a" = _tqvQOs3M;
        "pkg-1.20.1-0.2.2.0" = _Umf58ouW;
        "pkg-1.21-0.2.2.0" = _IQuhS5wa;
        "pkg-1.21-0.2.2.1" = _cQwrxh9n;
        "pkg-1.20.1-0.2.2.1" = _4hu1Bqzr;
        "pkg-1.20.1-0.2.2.2" = _s98rdSnf;
        "pkg-1.21-0.2.2.2" = _6yiOpH5m;
        "pkg-1.20.1-0.2.2.3" = _1eGJGB8E;
        "pkg-1.21-0.2.2.3" = _aQNJbW3J;
        "pkg-1.20.1-0.2.2.4" = _CKl81Pu8;
        "pkg-1.21-0.2.2.4" = _1HMcQXLA;
        "pkg-1.20.1-0.2.2.4a" = _fUGVvIpL;
        "pkg-1.21-0.2.2.4a" = _evIfm2MX;
        "pkg-1.20.1-0.2.2.4b" = _iUFDj5Bz;
        "pkg-1.21-0.2.2.4b" = _xCwaqJ96;
        "pkg-1.20.1-0.2.2.5" = _jfgsT3pU;
        "pkg-1.21-0.2.2.5" = _TIS3yn5o;
        "pkg-1.20.1-0.2.2.5a" = _bmccs8ua;
        "pkg-1.21-0.2.2.5a" = _4IPE4D3R;
        "pkg-1.20.1-0.2.2.6" = _BKFKaw9q;
        "pkg-1.21-0.2.2.6" = _f2vbrGIq;
        "pkg-1.20.1-0.2.2.7" = _C7DB0Wli;
        "pkg-1.21-0.2.2.7" = _touwuiOG;
        "default" = _touwuiOG;
    });
