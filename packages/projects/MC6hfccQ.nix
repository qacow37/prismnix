...
let
    ...
    in {
        ...
        "pkg-2.0.1" = _kM7W5E4U;
        "pkg-2.1.0" = _UrJjLHn2;
        "pkg-2.1.1+1.21.5" = _d9rKblcW;
        "pkg-2.1.1+1.21.1" = _TFmBUo7d;
        "pkg-2.1.1+25w20a" = _tfgDsGma;
        "pkg-2.1.2+1.21.1" = _jfkqZmGd;
        "pkg-2.1.2+1.21.5" = _UCXjmz6T;
        "pkg-2.1.2+1.20.1" = _D0uPvyey;
        "pkg-2.1.2+1.20.2" = _hN9wE9eh;
        "pkg-2.1.3+1.20.1" = _gtSk8Jdd;
        "pkg-2.1.3+1.20.2" = _UsAKdjhb;
        "pkg-2.1.3+1.21.1" = _fAtUk4MS;
        "pkg-2.1.3+1.21.5" = _or4FTEYY;
        "pkg-2.1.4+1.20.1" = _Jz3KlujH;
        "pkg-2.1.4+1.21.1" = _EJDiGrxp;
        "pkg-2.1.4+1.21.5" = _DL51Af9M;
        "pkg-2.2.0+1.21.5" = _SrnJ3aP5;
        "pkg-2.2.0+1.21.6" = _URErhGyA;
        "pkg-2.2.1+1.21.5" = _2HUifwhx;
        "pkg-2.2.1+1.21.6" = _wsnn7PU7;
        "pkg-2.2.2+1.21.6" = _UxQcXAlD;
        "pkg-2.2.3-mc1.21.9" = _iRQ0Vbqb;
        "pkg-2.2.4-mc1.21.9" = _9MUI0Nsx;
        "pkg-2.2.5-mc1.21.9" = _q0e13PvH;
        "pkg-2.2.6-mc1.21.11" = _u48fYwWW;
        "pkg-2.2.7-fabric-mc1.21.11" = _1N3iFzCn;
        "pkg-2.2.7-neo-mc1.21.11" = _8GL6UUNB;
        "pkg-2.2.7-fabric-mc26.1" = _uYhp2JYE;
        "pkg-2.2.7-neo-mc26.1" = _sfqz3MyC;
        "pkg-2.2.7-fabric-mc26.1.2" = _K6CbumEA;
        "pkg-2.2.7-neo-mc26.1.2" = _Bqfo5woO;
        "default" = _Bqfo5woO;
    });
