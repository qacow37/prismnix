...
let
    ...
    in {
        ...
        "pkg-1.12.3" = _PeQyEfZ7;
        "pkg-1.20_1.12.3" = _v7DcDZPW;
        "pkg-1.13.0" = _Je8hONC6;
        "pkg-1.14.0" = _i1yDKdln;
        "pkg-1.15.0" = _tzH5xqtm;
        "pkg-1.20.1_1.15.0" = _EaOvz9ST;
        "pkg-1.16.0" = _lkbIfFuR;
        "pkg-1.20.1_1.16.0" = _PIlKNC3r;
        "pkg-1.20.1_1.16.1" = _Nt3ArXno;
        "pkg-1.16.2" = _MzceNYn0;
        "pkg-1.16.4" = _YuSv3XfG;
        "pkg-1.16.5" = _buNoinlj;
        "pkg-1.16.6" = _yZTpRTSS;
        "pkg-1.20.4_1.16.6" = _PySousyp;
        "pkg-1.20.1_1.16.6" = _ZG6LgkWB;
        "pkg-1.20.4_1.16.7" = _enoHhKXb;
        "pkg-1.20.1_1.16.7" = _TZFCWDOX;
        "pkg-1.20.6_1.16.7" = _hnaCvPnf;
        "pkg-1.21_1.16.7" = _QSEYncBd;
        "pkg-1.21_1.16.8" = _Z7qvb1Cc;
        "pkg-1.21.1_1.16.8" = _F4kwM8kS;
        "pkg-1.21.2_1.16.8" = _3sVr3TfF;
        "pkg-1.21.3_1.16.8" = _DZGgqwuA;
        "pkg-1.21.4_1.16.8" = _ohzKVeCc;
        "pkg-1.21.5_1.16.8" = _jtnXdoK4;
        "pkg-1.21.6_1.16.8" = _V1vQegz9;
        "pkg-1.21.7_1.16.8" = _TUn0WGho;
        "pkg-1.21.8_1.16.8" = _EeYuuDF4;
        "pkg-1.21.9_1.16.8" = _iPJElGCM;
        "pkg-1.21.10_1.16.9" = _taTUJkEh;
        "pkg-1.21.11_1.16.9" = _G8FeOmE5;
        "pkg-1.21.8_1.16.9" = _7sEYJEVf;
        "default" = _7sEYJEVf;
    });
