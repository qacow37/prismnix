...
let
    ...
    in {
        ...
        "pkg-1.2.3+MC1.18-1.18.1" = _vRhRToi1;
        "pkg-1.2.4+MC1.18-1.18.1" = _Qeks9sT7;
        "pkg-1.2.5+MC1.18-1.18.2" = _HsJoIf0G;
        "pkg-1.2.6+MC1.18-1.18.2" = _mbE3aCDl;
        "pkg-1.2.6-1+MC1.18-1.18.2" = _55JGP4u4;
        "pkg-1.2.7+MC1.19" = _EtTLbnrv;
        "pkg-1.2.8+MC1.19.1" = _4qLsbHPv;
        "pkg-1.2.9+MC1.19.1" = _aGZ3DjPK;
        "pkg-1.2.10+MC1.19.1-1.19.2" = _rjym79fx;
        "pkg-1.3.0-b1+MC1.19.1-1.19.2" = _7uXZ14c0;
        "pkg-1.3.1+MC1.19.3-1.19.4" = _NgFYK2KR;
        "pkg-1.3.2+MC1.20-1.20.1" = _M5LOhlR4;
        "pkg-1.3.3+MC1.20.2" = _h5cyRqLy;
        "pkg-1.3.4+MC1.20.3-1.20.4" = _Kj7co51O;
        "pkg-1.3.5+MC1.20.5" = _JvwHyJLL;
        "pkg-1.3.6+MC1.20.5-1.20.6" = _SDZjPKL8;
        "pkg-1.4.0+MC1.21" = _s7dKBvJy;
        "pkg-1.4.1+MC1.21-1.21.1" = _VokviPBx;
        "pkg-1.5.0+MC1.21.2-1.21.3" = _MWuzd2Xv;
        "pkg-1.5.1+MC1.21.2-1.21.4" = _zsg3JNMY;
        "pkg-1.6.0+MC1.21.5" = _V2jWBoPw;
        "pkg-1.6.1+MC1.21.5-1.21.6" = _uA8YC60F;
        "pkg-1.6.2+MC1.21.5-1.21.7" = _ZT15MWkx;
        "pkg-1.6.3+MC1.21.5-1.21.8" = _wZywmQj4;
        "pkg-1.7.0+MC1.21.9" = _fZT0iy91;
        "pkg-1.7.1+MC1.21.9-1.21.10" = _eMe1t6Ro;
        "pkg-1.8.0+MC1.21.11" = _BrD9V7zC;
