...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.2-forge" = _yns77NPk;
        "pkg-1.18.2-1.4-forge" = _8WjDzory;
        "pkg-1.16.5-2.3-fabric" = _4ZuSyMVq;
        "pkg-1.18.2-2.3-fabric" = _NyuQ2X3t;
        "pkg-1.19.2-2.3-fabric" = _pOpZGF4P;
        "pkg-1.19.2-1.4-forge" = _cQ0ukUWs;
        "pkg-1.16.5-2.4-fabric" = _iwaBPUYJ;
        "pkg-1.18.2-2.4-fabric" = _sfseCYRy;
        "pkg-1.19.2-2.4-fabric" = _nwNMkwgI;
        "pkg-1.19.3-2.5-fabric" = _lRkVqBKy;
        "pkg-1.19.3-1.4-forge" = _Hr8gARG6;
        "pkg-1.18.2-3.0-forge+fabric" = _ONAqTyw3;
        "pkg-1.19.2-3.0-forge+fabric" = _8oXkVnup;
        "pkg-1.19.3-3.0-forge+fabric" = _6sYR0xKi;
        "pkg-1.19.4-3.0-forge+fabric" = _Crnxyu9J;
        "pkg-1.20-3.0-forge+fabric" = _RSxXML7n;
        "pkg-1.20.1-3.0-forge+fabric" = _QhT7CFkE;
        "pkg-1.18.2-3.1-forge+fabric" = _xMqrhHLR;
        "pkg-1.19.2-3.1-forge+fabric" = _z8Kfs0UK;
        "pkg-1.19.4-3.1-forge+fabric" = _muvFkNcC;
        "pkg-1.20.1-3.1-forge+fabric" = _AjPRvHUm;
        "pkg-1.20.2-3.1-forge+fabric" = _yyL91NFL;
        "pkg-1.18.2-3.2-forge+fabric" = _FliOLGAT;
        "pkg-1.19.2-3.2-forge+fabric" = _ctqFqnSP;
        "pkg-1.20.1-3.2-forge+fabric" = _Y58uzASP;
        "pkg-1.20.2-3.2-forge+fabric" = _m4gih3YS;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _mNZYvRpm;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _PcCYLiw7;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _ZqJcbhjf;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _LSTeqI5R;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _GGDZgxmT;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _l9U2HNrG;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _VEedetZn;
        "pkg-1.20.5-3.4-fabric+neo" = _H2g9SdbZ;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _yuklRaIX;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _xC82sxdf;
        "pkg-1.19.2-3.5-fabric+forge" = _xYte9z3n;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _9RGCZJIl;
        "pkg-1.20.4-3.5-fabric+forge+neo" = _i7ZHXpmD;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _4IYjEc84;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _iVikRBGg;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _Kh74AxCm;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _gu4sN0Ys;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _2DUOmLqM;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _YocBBfMX;
        "pkg-1.21.2-3.6-fabric+neo" = _3Wpzlyqc;
        "pkg-1.21.2-3.7-fabric+neo" = _JGZcz265;
        "pkg-1.21.3-3.7-fabric+forge+neo" = _eU5hfXf8;
        "pkg-1.21.4-3.7-fabric+forge+neo" = _H0tE1naV;
        "pkg-1.21.4-3.8-fabric+forge+neo" = _A9GNaNUP;
        "pkg-1.20.1-3.9-fabric+forge+neo" = _WoJ9zDWZ;
        "pkg-1.21.1-3.9-fabric+forge+neo" = _sO7PrJYX;
        "pkg-1.21.4-3.9-fabric+forge+neo" = _PJMWxHFJ;
        "pkg-1.21.5-3.9-fabric+forge+neo" = _EgdqzLlM;
        "pkg-1.21.6-3.9-fabric+forge+neo" = _izvyTKV8;
        "pkg-1.21.6-4.0-fabric+forge+neo" = _z4pBrMWf;
        "pkg-1.21.7-4.0-fabric+forge+neo" = _heuEkwsL;
        "pkg-1.21.8-4.0-fabric+forge+neo" = _l3J6aQlQ;
        "pkg-1.21.9-4.0-fabric+forge+neo" = _g5FXym6z;
        "pkg-1.21.10-4.0-fabric+forge+neo" = _YKNiEcQx;
        "pkg-1.21.11-4.0-fabric+forge+neo" = _arQw2WOq;
        "pkg-26.1.0-4.0-fabric+forge+neo" = _d93qa87x;
        "pkg-26.1.1-4.0-fabric+forge+neo" = _SxMEiNWW;
        "pkg-26.1.2-4.0-fabric+forge+neo" = _uKhnQpN1;
        "pkg-26.2.0-4.0-fabric+forge+neo" = _YflddsmH;
