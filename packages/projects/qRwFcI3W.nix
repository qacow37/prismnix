...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.0-Forge" = _fDuAuyG4;
        "pkg-1.19.2-1.0.0-Forge" = _XIetaN8j;
        "pkg-1.19.4-1.0.0-Forge" = _9Z76lhSt;
        "pkg-1.20-1.0.0-Forge" = _wm6MTOir;
        "pkg-1.20.1-1.0.1-Forge" = _z8D6EuWz;
        "pkg-1.20.1-1.0.2-Forge" = _IUHJGJnH;
        "pkg-1.20.1-1.0.3-Forge" = _pfz5rlm5;
        "pkg-1.20.1-1.0.0-Fabric" = _rR4JWY30;
        "pkg-1.19.4-1.0.0-Fabric" = _VqH3iOLy;
        "pkg-1.19.2-1.0.0-Fabric" = _2mqDn4rn;
        "pkg-1.18.2-1.0.0-Fabric" = _wOO8hq9O;
        "pkg-1.0.4" = _SMXX9r6j;
        "pkg-1.20.1-1.0.1-Fabric" = _1yXjsnaY;
        "pkg-1.1.0" = _Xwfwo8ay;
        "pkg-1.20.1-1.1.0-Fabric" = _svktoDkr;
        "pkg-1.18.2-1.1.0" = _IUJdGgAr;
        "pkg-1.19.2-1.1.0" = _Vg2VV2Sh;
        "pkg-1.19.4-1.1.0" = _PxiDhSe0;
        "pkg-1.1.1-Fabric" = _IYh6AF81;
        "pkg-2.0.0" = _k9buPNZW;
        "pkg-2.0.1" = _vWWJE94z;
        "pkg-2.1.0" = _hLzIcAPi;
        "pkg-2.1.1" = _IhtZKW6v;
