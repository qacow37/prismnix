...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.20.1-47.4.9" = _WmXxVnvB;
        "pkg-1.0.0-forge-1.21.1-52.1.5" = _LZLpeBpA;
        "pkg-1.0.0-forge-1.21.4-54.1.8" = _hpGomug7;
        "pkg-1.1.0-neoforge-1.21.9-21.9.2-b" = _PlsfOIQl;
        "pkg-1.1.0-fabric-1.21.9-0.134.0" = _ag1h7nGi;
        "pkg-1.1.0-forge-1.21.9-59.0.1" = _XwpjIJUL;
        "pkg-1.1.1-forge-1.21.9-59.0.5" = _d0eoFwmE;
        "pkg-1.1.1-fabric-1.21.4-0.119.4" = _YOQNtOFH;
        "pkg-1.1.1-fabric-1.21.1-0.116.7" = _6spMo7MX;
        "pkg-1.1.1-neoforge-1.21.4-21.4.155" = _pwwE0oNF;
        "pkg-1.1.1-neoforge-1.21.1-21.1.213" = _FH1K51kM;
        "pkg-1.1.2-forge-1.21.8-58.1.7" = _H8o9xIgF;
        "pkg-1.1.2-forge-1.21.11-61.0.2" = _dKXAq5jc;
        "pkg-1.1.2-fabric-1.21.11-0.140.0" = _hq55e5FE;
        "pkg-1.1.2-neoforge-1.21.11-21.11.10-" = _qN78NzL8;
        "pkg-1.1.2-fabric-1.21.5-0.128.2" = _diZw7cAM;
