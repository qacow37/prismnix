...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _3dulVwCT;
        "pkg-2.0.0" = _tkuyatJj;
        "pkg-2.1.0+1.18.2-fabric" = _sucYCxlm;
        "pkg-2.1.0+1.18.2-forge" = _NJjMopLr;
        "pkg-2.1.0+1.19.4-fabric" = _1oc4GX1G;
        "pkg-2.1.0+1.19.4-forge" = _VMbdgPnd;
        "pkg-3.0.0+1.18.2-fabric" = _pLz45fbK;
        "pkg-3.0.0+1.18.2-forge" = _tjBdb3r4;
        "pkg-3.0.0+1.19.4-fabric" = _RYu0blcO;
        "pkg-3.0.0+1.19.4-forge" = _LoW2grqh;
        "pkg-3.1.0+1.18.2-fabric" = _hGugEJRy;
        "pkg-3.1.0+1.18.2-forge" = _1qQ1DWsk;
        "pkg-3.1.0+1.19.4-fabric" = _OswvfQpX;
        "pkg-3.1.0+1.19.4-forge" = _G5KD73tD;
        "pkg-3.2.0+1.18.2-fabric" = _1iSISpdw;
        "pkg-3.2.0+1.18.2-forge" = _3XvSJkCz;
        "pkg-3.2.0+1.19.4-fabric" = _jWzkvN1j;
        "pkg-3.2.0+1.19.4-forge" = _2kjDRIY6;
        "pkg-4.0.0+1.18.2-fabric" = _FgvOC1Lq;
        "pkg-4.0.0+1.19.4-fabric" = _EaPCW4md;
        "pkg-4.0.1+1.18.2-fabric" = _2WVvoLhs;
        "pkg-4.0.1+1.18.2-forge" = _wWfd7Nmq;
        "pkg-4.0.1+1.19.4-fabric" = _vVFlVRt7;
        "pkg-4.0.1+1.19.4-forge" = _bFG2YxbQ;
        "pkg-5.0.0" = _bvr50NJe;
        "pkg-5.1.0" = _JwZn7YZ0;
        "pkg-5.2.0-forge" = _eneGx47b;
        "pkg-5.2.0-fabric" = _InBwo24m;
        "pkg-5.2.0-neoforge" = _CtgIkkOP;
        "pkg-5.2.1-neoforge" = _A4q0mIh4;
        "pkg-5.2.1-forge" = _pI8oz23J;
        "pkg-5.2.1-fabric" = _ul9OslWB;
        "pkg-5.3.0-forge" = _W7N6Gx7j;
        "pkg-5.3.0-neoforge" = _TgCDc1rC;
        "pkg-5.3.0-fabric" = _3TGzFQfN;
        "pkg-5.3.1-neoforge" = _Dwiz4GeV;
        "pkg-5.3.1-forge" = _LH3YCVlF;
        "pkg-5.3.1-fabric" = _71uPp5Hx;
        "pkg-5.4.0-fabric" = _5QrLKdlJ;
        "pkg-5.4.0-neoforge" = _8RZGdlTQ;
        "pkg-5.4.0-forge" = _6KAngQb1;
        "pkg-5.4.1-forge" = _pRz52ujZ;
        "pkg-5.4.1-neoforge" = _CYvdypE2;
        "pkg-5.4.1-fabric" = _baNcxaPZ;
        "pkg-5.4.2-fabric" = _UWBY9Hnh;
        "pkg-5.4.2-forge" = _9SP96wWZ;
        "pkg-5.4.2-neoforge" = _eWeGubOq;
        "pkg-5.5.0-forge" = _ps2C8uwr;
        "pkg-5.5.0-neoforge" = _BGXelkg1;
        "pkg-5.5.0-fabric" = _N66xgAjA;
        "pkg-5.5.1-forge" = _5ePh8ej2;
        "pkg-5.5.1-neoforge" = _Z09hbUAK;
        "pkg-5.5.1-fabric" = _ksbz8jfO;
        "pkg-5.5.2-neoforge" = _S4lZy45Y;
        "pkg-5.5.2-forge" = _UVAEJB5b;
        "pkg-5.5.2-fabric" = _JPYJkSky;
        "pkg-5.5.3-forge" = _Y0nOOLNy;
        "pkg-5.5.3-neoforge" = _WzTj136e;
        "pkg-5.5.3-fabric" = _RemI2Gef;
        "pkg-5.5.4-neoforge" = _Z8fOr0IE;
        "pkg-5.5.4-forge" = _hhjrLvn9;
        "pkg-5.5.4-fabric" = _jpS88LKC;
        "pkg-6.0.0-neoforge" = _AFj4CGYH;
        "pkg-6.0.0-forge" = _wLyen3Df;
        "pkg-6.0.0-fabric" = _g44QXYXa;
        "pkg-6.0.1-neoforge" = _IZOSZuj3;
        "pkg-6.0.1-fabric" = _BgYSpVzo;
        "pkg-6.0.1-forge" = _Rw5U8fKY;
        "pkg-6.0.2-forge" = _ACBK5CH8;
        "pkg-6.0.2-fabric" = _XF4PnEJR;
        "pkg-6.0.2-neoforge" = _87w0PDQp;
        "pkg-6.0.3-fabric" = _xG7FX9Fj;
        "pkg-6.0.3-forge" = _8OvFnlWW;
        "pkg-6.0.3-neoforge" = _9NcziZNG;
        "pkg-6.0.4-forge" = _E3Vtkc62;
        "pkg-6.0.4-neoforge" = _w9nWt7NL;
        "pkg-6.0.4-fabric" = _gZfUxccw;
        "pkg-6.0.5-fabric" = _BAesrdmo;
        "pkg-6.0.5-forge" = _dbujFt30;
        "pkg-6.0.5-neoforge" = _qJOHCcm8;
        "pkg-6.0.6-neoforge" = _Ne2Q3vB5;
        "pkg-6.0.6-fabric" = _JSmcqwxn;
        "pkg-6.0.6-forge" = _3VfYZhnR;
        "pkg-6.0.6-modern-test-fabric" = _kEaqY7ml;
        "pkg-6.1.0-fabric-modern" = _Ufea4oy6;
        "pkg-6.1.0-forge" = _jjcQdp8y;
        "pkg-6.1.0-neoforge" = _rXxApWSO;
        "pkg-6.1.0-fabric" = _9QMfnrh4;
        "pkg-6.1.1-fabric-modern" = _dieF1zeJ;
        "pkg-6.1.1-fabric" = _wpGvTXU0;
        "pkg-6.1.1-forge" = _MAvDmOPR;
        "pkg-6.1.1-neoforge" = _sAwQM3H5;
        "pkg-6.1.2-neoforge" = _uQddXQQr;
        "pkg-6.1.2-fabric-modern" = _9O0NWQAh;
        "pkg-6.1.2-fabric" = _W2zCn5TY;
        "pkg-6.1.2-forge" = _767jju1b;
        "pkg-6.2.0-fabric-modern" = _7xT2gfm2;
        "pkg-6.2.0-fabric" = _pS69vPZg;
        "pkg-6.2.0-neoforge" = _8CGbAwhn;
        "pkg-6.2.0-forge" = _a9KhgTiJ;
        "pkg-6.2.1-neoforge" = _B3hKbv2R;
        "pkg-6.2.1-forge" = _CUKdAmgx;
        "pkg-6.2.1-fabric-modern" = _6jk4EtFt;
        "pkg-6.2.1-fabric" = _k8wW4lF5;
        "default" = _k8wW4lF5;
    });
