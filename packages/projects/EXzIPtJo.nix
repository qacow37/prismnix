...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.9-fabric" = _WBPZadAh;
        "pkg-1.18.2-2.9-fabric" = _cdwNV3QA;
        "pkg-1.19.2-3.1-fabric" = _il04qa3y;
        "pkg-1.16.5-2.5-forge" = _d4UgXQJ0;
        "pkg-1.18.2-2.6-forge" = _eUalcVUl;
        "pkg-1.19.2-2.8-forge" = _QgGfiewI;
        "pkg-1.16.5-4.0-fabric" = _D7J75eYe;
        "pkg-1.18.2-4.0-fabric" = _brCzLqy9;
        "pkg-1.19.2-4.0-fabric" = _yNkkLFop;
        "pkg-1.16.5-4.0-forge" = _CTaVykIg;
        "pkg-1.18.2-4.0-forge" = _r8dYaqX4;
        "pkg-1.19.2-4.0-forge" = _821CSO6Q;
        "pkg-1.16.5-4.1-fabric" = _HsyvuhqT;
        "pkg-1.18.2-4.1-fabric" = _2nFrFJdi;
        "pkg-1.19.2-4.1-fabric" = _MCat7l7t;
        "pkg-1.16.5-4.1-forge" = _4MVXzLho;
        "pkg-1.18.2-4.1-forge" = _ZNOVsM8k;
        "pkg-1.19.2-4.1-forge" = _9uciuhTR;
        "pkg-1.16.5-4.2-fabric" = _U3vcTUbs;
        "pkg-1.18.2-4.2-fabric" = _1c5BDggO;
        "pkg-1.19.2-4.2-fabric" = _Khj18iJe;
        "pkg-1.19.3-4.3-fabric" = _YciIDz79;
        "pkg-1.19.3-4.1-forge" = _92keZ9zo;
        "pkg-1.18.2-5.0-forge+fabric" = _AwOBYWFy;
        "pkg-1.19.2-5.0-forge+fabric" = _Qw44Kyt8;
        "pkg-1.19.3-5.0-forge+fabric" = _GkM0kapg;
        "pkg-1.18.2-5.1-forge+fabric" = _FC9tkWof;
        "pkg-1.19.2-5.1-forge+fabric" = _cyuynbIu;
        "pkg-1.19.3-5.1-forge+fabric" = _xsuDTBd6;
        "pkg-1.19.4-5.1-forge+fabric" = _4VMnVHyO;
        "pkg-1.20-5.1-forge+fabric" = _P5RHGw4D;
        "pkg-1.20.1-5.1-forge+fabric" = _ki5wouxc;
        "pkg-1.20.2-5.1-forge+fabric" = _2CAW5ani;
        "pkg-1.18.2-5.2-forge+fabric" = _kagOKGGw;
        "pkg-1.19.2-5.2-forge+fabric" = _c4FluJHo;
        "pkg-1.20.1-5.2-forge+fabric" = _MBmDFBAN;
        "pkg-1.20.2-5.2-forge+fabric" = _l4u3f1hH;
        "pkg-1.20.3-5.2-fabric+forge+neo" = _N7hcvnrd;
        "pkg-1.20.4-5.2-fabric+forge+neo" = _MQEGmgg0;
        "pkg-1.19.2-5.3-fabric+forge+neo" = _EYBDB7U3;
        "pkg-1.20.1-5.3-fabric+forge+neo" = _uSCEar36;
        "pkg-1.20.2-5.3-fabric+forge+neo" = _VCyff53J;
        "pkg-1.20.4-5.3-fabric+forge+neo" = _IOV66ofe;
        "pkg-1.20.5-5.3-fabric+neo" = _n5kHeYEq;
        "pkg-1.20.6-5.3-fabric+forge+neo" = _39ujsMnU;
        "pkg-1.21.0-5.3-fabric+forge+neo" = _q4sTRaxH;
        "pkg-1.20.1-5.4-fabric+forge+neo" = _YjQdTUEq;
        "pkg-1.20.6-5.4-fabric+forge+neo" = _FLqLIryP;
        "pkg-1.21.0-5.4-fabric+forge+neo" = _mHYx2oq7;
        "pkg-1.21.1-5.4-fabric+forge+neo" = _ch137OCG;
        "pkg-1.21.2-5.4-fabric+neo" = _lzBQTUgO;
        "pkg-1.21.3-5.4-fabric+forge+neo" = _waGdIl0y;
        "pkg-1.21.4-5.4-fabric+forge+neo" = _CupiKea5;
        "pkg-1.20.1-5.5-fabric+forge+neo" = _JrbAOCLs;
        "pkg-1.21.1-5.5-fabric+forge+neo" = _dJ9RP7Em;
        "pkg-1.21.4-5.5-fabric+forge+neo" = _WTJ5MghM;
        "pkg-1.21.5-5.5-fabric+forge+neo" = _dMiuyv1Q;
        "pkg-1.21.6-5.5-fabric+forge+neo" = _1ZuIkXPA;
        "pkg-1.21.7-5.5-fabric+forge+neo" = _6eBKDsPK;
        "pkg-1.21.8-5.5-fabric+forge+neo" = _GsZKN4VV;
        "pkg-1.21.9-5.5-fabric+forge+neo" = _cRvmEVcd;
        "pkg-1.21.10-5.5-fabric+forge+neo" = _oikxx5uf;
        "pkg-1.21.11-5.5-fabric+forge+neo" = _sxFyLqxa;
        "pkg-26.1.0-5.5-fabric+forge+neo" = _81CNtyzK;
        "pkg-26.1.1-5.5-fabric+forge+neo" = _x6vg2Ktx;
        "pkg-26.1.2-5.5-fabric+forge+neo" = _3MAW6F4w;
        "pkg-26.1.2-5.6-fabric+forge+neo" = _4kKyV4kN;
        "pkg-26.2.0-5.6-fabric+forge+neo" = _4SLDlryk;
        "default" = _4SLDlryk;
    });
