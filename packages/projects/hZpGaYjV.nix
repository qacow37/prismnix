...
let
    ...
    in {
        ...
        "pkg-1.0.0+26.1.2" = _VGxejuHV;
        "pkg-1.1.1+1.20.4" = _V8OI5eYs;
        "pkg-1.1.1+1.21.11" = _PxdTYoNW;
        "pkg-1.1.1+26.1.2" = _ZdGBE95V;
        "pkg-1.1.2+1.20.4" = _33eJfx2V;
        "pkg-1.1.2+1.21.11" = _CdSEpFKZ;
        "pkg-1.1.2+26.1.2" = _L5r6Zu8A;
        "pkg-1.1.2+26.2" = _kNOinxjc;
        "pkg-1.1.3+26.2" = _rmmvGoB4;
        "pkg-1.1.4+26.2" = _yYGGlQ9c;
        "pkg-1.1.4+26.2-neoforge" = _zz42p26H;
        "pkg-1.2.0+1.20.4" = _ynDhJpcw;
        "pkg-1.2.0+1.20.6" = _H8x01L8l;
        "pkg-1.2.0+1.21.1" = _hbOkvcm3;
        "pkg-1.2.0+1.21.5" = _f8H590Jg;
        "pkg-1.2.0+1.21.8" = _yordtiiq;
        "pkg-1.2.0+1.21.11" = _4lwYHDNY;
        "pkg-1.2.0+26.1.2" = _l1ZNqUPN;
        "pkg-1.2.0+1.20.1-forge" = _qbRjaVTy;
        "pkg-1.2.0+1.20.6-forge" = _kVCDF3a6;
        "pkg-1.2.0+1.21.1-forge" = _7nDXzNTH;
        "pkg-1.2.0+1.21.5-forge" = _G82PgWMW;
        "pkg-1.2.0+1.21.8-forge" = _qigHvUi6;
        "pkg-1.2.0+1.20.1-neoforge" = _VwozFyVl;
        "pkg-1.2.0+1.20.4-neoforge" = _46e0rrz7;
        "pkg-1.2.0+1.20.6-neoforge" = _HgmjBa4G;
        "pkg-1.2.0+1.21.1-neoforge" = _WQ3uNpZf;
        "pkg-1.2.0+1.21.5-neoforge" = _9OvMmeNh;
        "pkg-1.2.0+1.21.8-neoforge" = _I4pP5a9G;
        "pkg-1.2.0+1.21.11-neoforge" = _Lca7MtW0;
        "pkg-1.2.0+26.1.2-neoforge" = _KSgxrKwC;
        "pkg-1.2.0+26.2" = _cN0P8p4R;
        "pkg-1.2.0+26.2-neoforge" = _iTlrS0k5;
        "pkg-1.2.2+1.20.4" = _rEGcNFKq;
        "pkg-1.2.2+1.20.6" = _dHP5FYnr;
        "pkg-1.2.2+1.21.1" = _ocuqChin;
        "pkg-1.2.2+1.21.5" = _ZyqpbInq;
        "pkg-1.2.2+1.21.8" = _nhW0cExu;
        "pkg-1.2.2+1.21.11" = _aza9ODIS;
        "pkg-1.2.2+26.1.2" = _wK4dZcYD;
        "pkg-1.2.2+1.20.1-forge" = _wQxf1mSr;
        "pkg-1.2.2+1.20.6-forge" = _VJYnADZc;
        "pkg-1.2.2+1.21.1-forge" = _2B2PWSgt;
        "pkg-1.2.2+1.21.5-forge" = _V95Z44B9;
        "pkg-1.2.2+1.21.8-forge" = _ZWKUOMI1;
        "pkg-1.2.2+1.20.1-neoforge" = _i3p7jgQ9;
        "pkg-1.2.2+1.20.4-neoforge" = _HW3FOEDt;
        "pkg-1.2.2+1.20.6-neoforge" = _tbaKhTMR;
        "pkg-1.2.2+1.21.1-neoforge" = _98YCLy2E;
        "pkg-1.2.2+1.21.5-neoforge" = _vHEaAIzw;
        "pkg-1.2.2+1.21.8-neoforge" = _pUKc4Np3;
        "pkg-1.2.2+1.21.11-neoforge" = _Fpk7zNzw;
        "pkg-1.2.2+26.1.2-neoforge" = _julqlEDo;
        "pkg-1.2.2+26.2" = _bCrTmmy7;
        "pkg-1.2.2+26.2-neoforge" = _EVsuKMPg;
        "pkg-1.2.3+26.2" = _psUvNeCe;
        "pkg-1.2.3+26.2-neoforge" = _P8yQDtoI;
        "pkg-1.3.0+1.20.4" = _yE02qjyU;
        "pkg-1.3.0+1.20.6" = _fKimOYFU;
        "pkg-1.3.0+1.20.1-forge" = _vaFSorxM;
        "pkg-1.3.0+1.20.2-forge" = _ail9wY8P;
        "pkg-1.3.0+1.20.3-forge" = _gNwcv1Du;
        "pkg-1.3.0+1.20.4-forge" = _F9lMCLjV;
        "pkg-1.3.0+1.20.6-forge" = _hJd1CmkI;
        "pkg-1.3.0+1.20.1-neoforge" = _OchC1Fgp;
        "pkg-1.3.0+1.20.2-neoforge" = _Zj8azrId;
        "pkg-1.3.0+1.20.3-neoforge" = _r8r2zpE8;
        "pkg-1.3.0+1.20.4-neoforge" = _hbLviBVZ;
        "pkg-1.3.0+1.20.6-neoforge" = _gmIRVPbq;
        "pkg-1.2.3+26.3-snapshot-1" = _ntW6fgoB;
        "pkg-1.2.4+26.1" = _hfgNbnme;
        "pkg-1.2.4+26.2" = _dqR4E9rV;
        "pkg-1.2.4+26.3-snapshot-1" = _m74qsANK;
        "pkg-1.2.4+26.1-neoforge" = _uFFnW5Bv;
        "pkg-1.2.4+26.2-neoforge" = _tteTpJvi;
        "pkg-1.4.1+1.20.1-forge" = _5WbAOwaI;
        "pkg-1.4.1+1.20.1-neoforge" = _Z7WSPqfR;
        "pkg-1.4.1+1.20.1" = _q5cg3kHz;
        "pkg-1.4.1+1.20.2-forge" = _CDbGGTGR;
        "pkg-1.4.1+1.20.2-neoforge" = _nZ6zo1EY;
        "pkg-1.4.1+1.20.3-forge" = _VCvh5p8Y;
        "pkg-1.4.1+1.20.3-neoforge" = _YJIkKrF5;
        "pkg-1.4.1+1.20.4-forge" = _yXoNV8nT;
        "pkg-1.4.1+1.20.4-neoforge" = _fOhTYQdY;
        "pkg-1.4.1+1.20.6-forge" = _bmH1Wzor;
        "pkg-1.4.1+1.20.6-neoforge" = _fdVtjSzf;
        "pkg-1.4.1+1.20.6" = _8QYA9okc;
        "pkg-1.4.1+1.21-forge" = _h5QIRuSg;
        "pkg-1.4.1+1.21-neoforge" = _osdzFzaX;
        "pkg-1.4.1+1.21.1-forge" = _Hcx6Pwu7;
        "pkg-1.4.1+1.21.1-neoforge" = _A6FWQnvF;
        "pkg-1.4.1+1.21.1" = _O4xnc0XX;
        "pkg-1.4.1+1.21.10-neoforge" = _IyJQgsgs;
        "pkg-1.4.1+1.21.11-neoforge" = _IBzw8Uzd;
        "pkg-1.4.1+1.21.11" = _eRS6E1Zd;
        "pkg-1.4.1+1.21.2-neoforge" = _qK6syTsu;
        "pkg-1.4.1+1.21.3-forge" = _R4LbwYa2;
        "pkg-1.4.1+1.21.3-neoforge" = _HRI3tw5t;
        "pkg-1.4.1+1.21.4-forge" = _bwhMru5P;
        "pkg-1.4.1+1.21.4-neoforge" = _oYl69Dyo;
        "pkg-1.4.1+1.21.5-forge" = _BUv6oUO2;
        "pkg-1.4.1+1.21.5-neoforge" = _J8g5pHlT;
        "pkg-1.4.1+1.21.5" = _xYY4v7oq;
        "pkg-1.4.1+1.21.6-forge" = _OvTjRG0l;
        "pkg-1.4.1+1.21.6-neoforge" = _87oyr5I0;
        "pkg-1.4.1+1.21.7-forge" = _cyhDLL8B;
        "pkg-1.4.1+1.21.7-neoforge" = _MA8HOLYY;
        "pkg-1.4.1+1.21.8-forge" = _7cmRPGk6;
        "pkg-1.4.1+1.21.8-neoforge" = _emxzzLcL;
        "pkg-1.4.1+1.21.8" = _EqgvuDub;
        "pkg-1.4.1+1.21.9-neoforge" = _PewvpLv6;
        "pkg-1.4.1+1.21.9" = _Lme1zvLF;
        "pkg-1.4.1+26.1" = _4l8VdZsS;
        "pkg-1.4.1+26.1-neoforge" = _owlFWrYC;
        "pkg-1.4.1+26.2" = _qFGXFTsH;
        "pkg-1.4.1+26.2-neoforge" = _vM50Ghwa;
        "pkg-1.4.1+26.3-snapshot-2" = _mRwhkACm;
        "pkg-1.4.2+26.3-snapshot-3" = _OpPwxx9s;
        "pkg-1.4.3+1.20.1-forge" = _sdsP62bb;
        "pkg-1.4.3+1.20.1-neoforge" = _KGatk1Nf;
        "pkg-1.4.3+1.20.1" = _7gPY1BFC;
        "pkg-1.4.3+1.20.2-forge" = _ORiT7OFM;
        "pkg-1.4.3+1.20.2-neoforge" = _HXNYezDH;
        "pkg-1.4.3+1.20.3-forge" = _eDmTOlYa;
        "pkg-1.4.3+1.20.3-neoforge" = _Q49PP4fF;
        "pkg-1.4.3+1.20.4-forge" = _DJ0XALcp;
        "pkg-1.4.3+1.20.4-neoforge" = _XPliHTHH;
        "pkg-1.4.3+1.20.6-forge" = _d7ykvXRu;
        "pkg-1.4.3+1.20.6-neoforge" = _6ytKtIMS;
        "pkg-1.4.3+1.20.6" = _nBJWhmEe;
        "pkg-1.4.3+1.21-forge" = _LgnXADna;
        "pkg-1.4.3+1.21-neoforge" = _K1FZB7wc;
        "pkg-1.4.3+1.21.1-forge" = _OKVgYljJ;
        "pkg-1.4.3+1.21.1-neoforge" = _PxUgMv9n;
        "pkg-1.4.3+1.21.1" = _USk4U0dp;
        "pkg-1.4.3+1.21.10-forge" = _XFwWoqXz;
        "pkg-1.4.3+1.21.10-neoforge" = _hl61hOv7;
        "pkg-1.4.3+1.21.11-forge" = _fTvPE4DX;
        "pkg-1.4.3+1.21.11-neoforge" = _E3g9iUsD;
        "pkg-1.4.3+1.21.11" = _rPtWK53a;
        "pkg-1.4.3+1.21.2-neoforge" = _m1Vkn5Pm;
        "pkg-1.4.3+1.21.3-forge" = _TxrXHclI;
        "pkg-1.4.3+1.21.3-neoforge" = _cIPQT2De;
        "pkg-1.4.3+1.21.4-forge" = _bJOeJZss;
        "pkg-1.4.3+1.21.4-neoforge" = _vgNBURSO;
        "pkg-1.4.3+1.21.5-forge" = _Kk0mU8L5;
        "pkg-1.4.3+1.21.5-neoforge" = _gP10kkjt;
        "pkg-1.4.3+1.21.5" = _iH2YkHWT;
        "pkg-1.4.3+1.21.6-forge" = _Q6ds5jvG;
        "pkg-1.4.3+1.21.6-neoforge" = _r3gxHWGm;
        "pkg-1.4.3+1.21.7-forge" = _ahQqiUlC;
        "pkg-1.4.3+1.21.7-neoforge" = _d5784C6s;
        "pkg-1.4.3+1.21.8-forge" = _RFT2t8u2;
        "pkg-1.4.3+1.21.8-neoforge" = _yj052B5e;
        "pkg-1.4.3+1.21.8" = _EHHusRrU;
        "pkg-1.4.3+1.21.9-neoforge" = _lElFv4GD;
        "pkg-1.4.3+1.21.9" = _WQRIImUX;
        "pkg-1.4.3+26.1" = _nnN7is4P;
        "pkg-1.4.3+26.1-neoforge" = _cyYQoklZ;
        "pkg-1.4.3+26.2" = _uCk7Uab3;
        "pkg-1.4.3+26.2-neoforge" = _skH0M7wa;
        "pkg-1.4.3+26.3-snapshot-3" = _nTgPJqrE;
        "pkg-1.4.4+1.20.1-forge" = _3exZTHH3;
        "pkg-1.4.4+1.20.1-neoforge" = _XDPBpAF1;
        "pkg-1.4.4+1.20.1" = _7cZ1Xcso;
        "pkg-1.4.4+1.20.2-forge" = _p7VuLqVg;
        "pkg-1.4.4+1.20.2-neoforge" = _PE0kZFPf;
        "pkg-1.4.4+1.20.3-forge" = _VlJzxojA;
        "pkg-1.4.4+1.20.3-neoforge" = _DCSyKYJj;
        "pkg-1.4.4+1.20.4-forge" = _QY7z9eDi;
        "pkg-1.4.4+1.20.4-neoforge" = _a2QV3riH;
        "pkg-1.4.4+1.20.6-forge" = _qJ2jrtow;
        "pkg-1.4.4+1.20.6-neoforge" = _gkP4qsSQ;
        "pkg-1.4.4+1.20.6" = _ly0vXUD7;
        "pkg-1.4.4+1.21-forge" = _BGoXT3qt;
        "pkg-1.4.4+1.21-neoforge" = _vAvhzEgS;
        "pkg-1.4.4+1.21.1-forge" = _zKf0kK4H;
        "pkg-1.4.4+1.21.1-neoforge" = _BR0F1rTo;
        "pkg-1.4.4+1.21.1" = _YWjvhlhR;
        "pkg-1.4.4+1.21.2-neoforge" = _jCDD8jpR;
        "pkg-1.4.4+1.21.3-forge" = _WLTPcbFV;
        "pkg-1.4.4+1.21.3-neoforge" = _3NQhFmH6;
        "pkg-1.4.4+1.21.4-forge" = _EoeUDimH;
        "pkg-1.4.4+1.21.4-neoforge" = _KOXTntNI;
        "pkg-1.4.4+1.21.5-forge" = _2ByjIjX4;
        "pkg-1.4.4+1.21.5-neoforge" = _gayLro8m;
        "pkg-1.4.4+1.21.5" = _U5N2WZFY;
        "pkg-1.4.4+1.21.6-forge" = _FoSKSdI4;
        "pkg-1.4.4+1.21.6-neoforge" = _xIlFFvHf;
        "pkg-1.4.4+1.21.7-forge" = _Ca0heXxr;
        "pkg-1.4.4+1.21.7-neoforge" = _JRH7mhFU;
        "pkg-1.4.4+1.21.8-forge" = _phdjIsUR;
        "pkg-1.4.4+1.21.8-neoforge" = _Ty0NxaMW;
        "pkg-1.4.4+1.21.8" = _1C5NpjRw;
        "pkg-1.4.4+26.1" = _Mc5wt28F;
        "pkg-1.4.4+26.1-neoforge" = _kbqqQvx6;
        "pkg-1.4.4+26.2" = _AL95EnS9;
        "pkg-1.4.4+26.2-neoforge" = _z5Lfw5oX;
        "pkg-1.4.5+1.21.10-forge" = _TtegM5Dx;
        "pkg-1.4.5+1.21.10-neoforge" = _I6FIPyT5;
        "pkg-1.4.5+1.21.11-forge" = _qlnZ722k;
        "pkg-1.4.5+1.21.11-neoforge" = _9MAzxBfD;
        "pkg-1.4.5+1.21.11" = _rG5tnEbL;
        "pkg-1.4.5+1.21.9-neoforge" = _8IGLByEl;
        "pkg-1.4.5+1.21.9" = _jjSXZPBg;
        "pkg-1.4.5+26.3" = _2G2lRwjD;
        "pkg-1.4.6+26.3" = _Hg8pGWZB;
        "pkg-1.4.7+26.1-neoforge" = _5cyKUXqt;
        "pkg-1.4.7+26.2-neoforge" = _RqOAvIai;
