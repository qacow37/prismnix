...
let
    ...
    in {
        ...
        "pkg-2.3.11-GTNH" = _1awZH5vk;
        "pkg-2.3.12-GTNH" = _o7UsBuUT;
        "pkg-2.3.13-GTNH" = _Eyk1TWgM;
        "pkg-2.3.14-GTNH" = _nvrKlLQQ;
        "pkg-2.3.15-GTNH" = _FZRdIJe8;
        "pkg-2.3.16-GTNH" = _wBWBMB4O;
        "pkg-2.3.17-GTNH" = _GAE0hgBv;
        "pkg-2.3.18-GTNH" = _IQrtXkyD;
        "pkg-2.3.19-GTNH" = _54ltRvdu;
        "pkg-2.3.20-GTNH" = _TaCJcjSN;
        "pkg-2.3.21-GTNH" = _hagnIT3r;
        "pkg-2.3.22-GTNH" = _sQ7kXU9i;
        "pkg-2.3.23-GTNH" = _thm1uw0M;
        "pkg-2.3.24-GTNH" = _adJQSzqr;
        "pkg-2.3.25-GTNH" = _uXB9lK9O;
        "pkg-2.3.26-GTNH" = _8d1M0KMh;
        "pkg-2.3.27-GTNH" = _YERK3uys;
        "pkg-2.3.28-GTNH" = _zqUbv7Kk;
        "pkg-2.3.29-GTNH" = _wvZFyQDO;
        "pkg-2.3.30-GTNH" = _kVPQMu6X;
        "pkg-2.3.31-GTNH" = _SqHInN7K;
        "pkg-2.3.32-GTNH" = _UhyvRAZk;
        "pkg-2.3.33-GTNH-pre" = _lFst4Cjs;
        "pkg-2.3.34-GTNH" = _DlCPXYNb;
        "pkg-2.3.35-GTNH" = _X048I7w0;
        "pkg-2.3.36-GTNH" = _IBK5jLd4;
        "pkg-2.3.37-GTNH" = _TZDKpWpL;
        "pkg-2.3.38-GTNH" = _K8BisOaA;
        "pkg-2.3.39-GTNH" = _j5rDFenj;
        "pkg-2.3.40-GTNH" = _BMsDkHct;
        "pkg-2.3.41-GTNH-pre" = _QpxTH55e;
        "pkg-2.3.42-GTNH-pre" = _vwenATWR;
        "pkg-2.3.43-GTNH" = _9q89Chn7;
        "pkg-2.3.44-GTNH-pre" = _ekTg16pA;
        "pkg-2.3.45-GTNH" = _NPzSQAV7;
        "pkg-2.3.46-GTNH" = _rltHAzVQ;
        "pkg-2.3.47-GTNH" = _VP9I5OY5;
        "pkg-2.3.48-GTNH" = _smkQqMEn;
        "pkg-2.3.49-GTNH-pre" = _4l9iwkbD;
        "pkg-2.3.50-GTNH" = _q1OsD38x;
        "pkg-2.3.51-GTNH" = _kpd9FeJu;
        "pkg-2.3.52-GTNH" = _qgC1Gz7L;
        "pkg-2.3.53-GTNH" = _fqJyXaj8;
        "pkg-2.3.54-GTNH" = _OTLs1KJm;
        "pkg-2.3.55-GTNH" = _LWmsyDOW;
        "pkg-2.3.56-GTNH-pre" = _LBjDU6uF;
        "pkg-2.3.57-GTNH" = _NDQQvprz;
        "pkg-2.3.58-GTNH-pre" = _ZMakRYy2;
        "pkg-2.3.59-GTNH-pre" = _6fA3Q3iw;
        "pkg-2.3.60-GTNH-pre" = _v7fpJBND;
        "pkg-2.3.61-GTNH-pre" = _zyK1pCwl;
        "pkg-2.3.62-GTNH-pre" = _bg667mZ8;
        "pkg-2.3.63-GTNH" = _BlIyVG9H;
        "pkg-2.3.64-GTNH-pre" = _Vj9rAv0Z;
        "pkg-2.3.65-GTNH-pre" = _4XMoOaKm;
        "pkg-2.3.66-GTNH-pre" = _Gg2pPq6j;
        "pkg-2.3.67-GTNH-pre" = _eaBu24Zc;
        "pkg-2.3.68-GTNH-pre" = _coQOA1KH;
        "pkg-2.3.69-GTNH-pre" = _WgHCh8Dj;
        "pkg-2.3.70-GTNH" = _yNqyBSaU;
        "pkg-2.3.71-GTNH-pre" = _XaAGEyeG;
        "pkg-2.3.72-GTNH-pre" = _ra5m19kg;
        "pkg-2.3.73-GTNH" = _26kvAZT1;
        "pkg-2.3.74-GTNH-pre" = _lQ4Rao4n;
        "pkg-2.3.75-GTNH" = _FVm1dpEl;
        "pkg-2.3.76-GTNH" = _nuwLsKEb;
        "pkg-2.3.77-GTNH-pre" = _aUjOJrW7;
        "pkg-2.3.78-GTNH-pre" = _2AdOWdZQ;
        "pkg-2.3.79-GTNH" = _SBocDEao;
        "pkg-2.3.80-GTNH" = _VOKoc242;
        "pkg-2.3.81-GTNH" = _jcFnWphh;
        "pkg-2.3.82-GTNH" = _hVFJBWL2;
        "pkg-2.3.83-GTNH" = _YooawwWQ;
        "pkg-2.4.0-GTNH" = _BzTNAX57;
        "pkg-2.4.1" = _CAsIhhSA;
        "pkg-2.4.2" = _8QOiCEjc;
        "pkg-2.4.1-GTNH" = _8aFZatV2;
        "pkg-2.4.2-GTNH" = _CocJWvZK;
        "pkg-2.4.3-GTNH" = _fwBf6RO9;
        "pkg-2.4.4-GTNH" = _7rCoHy65;
        "pkg-2.4.5-GTNH" = _F9oLGdZO;
        "pkg-2.4.6-GTNH" = _JowEIpxJ;
        "pkg-2.4.7-GTNH-pre" = _KGQE8sLY;
        "pkg-2.4.8-GTNH-pre" = _UEfcLpbv;
        "pkg-2.4.9-GTNH" = _d5LXM4ly;
        "pkg-2.4.10-GTNH" = _ML9Zi8Cw;
        "pkg-2.4.11-GTNH" = _huijpbxA;
        "pkg-2.4.12-GTNH" = _RO8bAOEb;
        "pkg-2.4.13-GTNH" = _LkVGNKhd;
        "pkg-2.5.10-GTNH-pre" = _awdsra1f;
        "pkg-2.5.11-GTNH-pre" = _qsAZuyv5;
        "pkg-2.5.12-GTNH-pre" = _sGySpiF8;
        "pkg-2.5.14-GTNH-pre" = _b0Fus25w;
        "pkg-2.5.15-GTNH-pre" = _DsIIdTyz;
        "pkg-2.5.16-GTNH-pre" = _ffyhPHyY;
        "pkg-2.5.17-GTNH" = _fjeSQDMx;
        "pkg-2.5.18-GTNH" = _b696867Z;
        "pkg-2.5.19-GTNH" = _433GtczZ;
        "pkg-2.5.20-GTNH-pre" = _VXoxEEBF;
        "pkg-2.5.21-GTNH" = _3mEC6NiP;
        "pkg-2.5.22-GTNH-pre" = _mReOG21B;
        "pkg-2.5.23-GTNH" = _lcO0MvVl;
        "pkg-2.5.24-GTNH" = _ofDGbgQH;
        "pkg-2.5.25-GTNH" = _KMnmeRcc;
        "pkg-2.5.26-GTNH" = _t48XVW94;
        "pkg-2.5.27-GTNH" = _qJgUYW0a;
        "pkg-2.6.0-GTNH" = _kh1HcpBs;
        "pkg-2.5.28-GTNH" = _BHosNeh5;
        "pkg-2.5.29-GTNH-pre" = _HZeHzKb7;
        "pkg-2.6.1-GTNH" = _P9CjVDn0;
        "pkg-v2.6.1-beta" = _J96NGCMW;
        "pkg-2.6.2-GTNH-pre" = _htUE7SWK;
        "pkg-2.6.3-GTNH-pre" = _aVVlG9xY;
        "pkg-2.6.4-GTNH-pre" = _cU7fUDvz;
        "pkg-2.6.5-GTNH" = _WQup0pfQ;
        "pkg-2.6.6-GTNH-pre" = _kg4HDCfS;
        "pkg-2.6.7-GTNH-pre" = _iitb9Fav;
        "pkg-2.6.8-GTNH" = _nQIyyfrt;
        "pkg-2.6.9-GTNH-pre" = _QYIrYuWb;
        "pkg-2.6.10-GTNH-pre" = _jXV5f7Cw;
        "pkg-2.6.11" = _u5RMwmf7;
        "pkg-2.6.11-GTNH" = _COI4RwFj;
        "pkg-2.6.12-GTNH-pre" = _7ywOuClG;
        "pkg-2.6.13-GTNH-pre" = _Zs18ytUz;
        "pkg-2.6.14-GTNH" = _rTIa7N7Q;
        "pkg-2.6.15-GTNH-pre" = _q2Tj7vwn;
        "pkg-2.6.16-GTNH-pre" = _mDV2LwZQ;
        "pkg-2.6.17-GTNH-pre" = _x0Mw2vQ4;
        "pkg-2.6.18-GTNH-pre" = _vRnA5TRc;
        "pkg-2.6.19-GTNH" = _wW0a344U;
        "pkg-2.6.20-GTNH-pre" = _yVCOjCsA;
        "pkg-2.6.21-GTNH-pre" = _SAoqkpd3;
        "pkg-2.6.22-GTNH" = _6ejgvTAj;
        "pkg-2.6.23-GTNH-pre" = _69UwdBjP;
        "pkg-2.6.24-GTNH-pre" = _i6MNX3H1;
        "pkg-2.6.25-GTNH" = _aBgQ2U0e;
        "pkg-2.6.26-GTNH" = _WwSDxKe2;
        "pkg-2.6.27-GTNH-pre" = _N9sm1VdF;
        "pkg-2.6.28-GTNH-pre" = _iPiUHYur;
        "pkg-2.6.29-GTNH-pre" = _5mk5s8ZC;
        "pkg-2.6.30-GTNH" = _B4CEzf6d;
        "pkg-2.6.31-GTNH" = _LBuraOyL;
        "pkg-2.6.32-GTNH-pre" = _nvSmBD6o;
        "pkg-2.6.33-GTNH" = _L6szcp2r;
        "pkg-2.6.34-GTNH" = _I9uPQk6l;
        "pkg-2.6.35-GTNH" = _caID7Nfx;
        "pkg-2.6.36-GTNH" = _jcX0jewk;
        "pkg-2.6.37-GTNH-pre" = _BpZ4UgKi;
        "pkg-2.6.38-GTNH" = _82hZzcGr;
        "pkg-2.6.39-GTNH" = _UhoBEyGF;
        "pkg-2.6.40-GTNH" = _rZXOhMTo;
        "pkg-2.6.41-GTNH" = _YIyQDiDj;
        "pkg-2.6.42-GTNH" = _sRcbChvY;
        "pkg-2.6.44-GTNH" = _X1sZ0R2R;
        "pkg-2.6.45-GTNH" = _got8i1My;
        "pkg-2.6.46-GTNH" = _teI7Hhje;
        "pkg-2.6.47-GTNH" = _kBlo7TQ2;
        "pkg-2.6.48-GTNH" = _rzrXFHD1;
        "pkg-2.6.49-GTNH" = _2wWypmsE;
        "pkg-2.6.50-GTNH" = _vbsD8Eje;
        "pkg-2.6.51-GTNH" = _X7bayJNn;
        "pkg-2.7.0-GTNH" = _7ZTAljc0;
        "pkg-2.6.52-GTNH" = _BKoYYtQj;
        "pkg-2.7.1-GTNH-pre" = _1ziTwerX;
        "pkg-2.7.2-GTNH" = _5mQUsBrN;
        "pkg-2.7.3-GTNH-pre" = _wdumus97;
        "pkg-2.6.53-GTNH" = _gGaB1kRm;
        "pkg-2.7.4-GTNH" = _gs7tvYWd;
        "pkg-2.7.5-GTNH-pre" = _jaCJaIId;
        "pkg-2.7.7-GTNH-pre" = _z9sRPxvG;
        "pkg-2.7.8-GTNH" = _onFDKmN0;
        "pkg-2.7.9-GTNH-pre" = _9r3FMXLJ;
        "pkg-2.7.10-GTNH-pre" = _oC6tJyWN;
        "pkg-2.7.11-GTNH" = _hCP8EKRI;
        "pkg-2.7.12-GTNH-pre" = _nw9x01F0;
        "pkg-2.7.13-GTNH" = _LCVnhhdK;
        "pkg-2.7.14-GTNH-pre" = _KXjBKzRS;
        "pkg-2.7.15-GTNH" = _NgjssLCI;
        "pkg-2.7.16-GTNH-pre" = _DPtcILKg;
        "pkg-2.7.17-GTNH-pre" = _sYRGoPXT;
        "pkg-2.7.18-GTNH" = _tUdrwr2i;
        "pkg-2.7.19-GTNH-pre" = _hVgogu46;
        "pkg-2.7.20-GTNH" = _CleNC2Ep;
        "pkg-2.7.21-GTNH-pre" = _Fqtn7Jd2;
        "pkg-2.7.22-GTNH" = _CRb20oyH;
        "pkg-2.7.23-GTNH" = _oyWuZkeU;
        "pkg-2.7.24-GTNH-pre" = _BJIM5u1j;
        "pkg-2.7.25-GTNH" = _cH9vdUzI;
        "pkg-2.7.26-GTNH-pre" = _xvRlw8Qn;
        "pkg-2.7.27-GTNH" = _q235w5vt;
        "pkg-2.7.28-GTNH" = _ynOoSgU9;
        "pkg-2.7.29-GTNH" = _CIrAsFyj;
        "pkg-2.6.54-GTNH" = _tcXJIZfI;
        "pkg-2.7.27" = _vyTLmnhG;
        "pkg-2.6.55-GTNH" = _tLAiMuCu;
        "pkg-2.7.30-GTNH" = _XyUtguhI;
        "pkg-2.7.31-GTNH" = _zjBGSahQ;
        "pkg-2.7.32-GTNH-pre" = _lsnLTPjL;
        "pkg-2.7.33-GTNH" = _deqR1fNM;
        "pkg-2.7.34-GTNH" = _8wujXV0t;
        "pkg-2.7.35-GTNH-pre" = _itE1n3LS;
        "pkg-2.7.36-GTNH-pre" = _54sOfANS;
        "pkg-2.7.37-GTNH-pre" = _eDhWkYVm;
        "pkg-2.7.38-GTNH" = _MzFtvkPh;
        "pkg-2.7.39-GTNH-pre" = _loOe162B;
        "pkg-2.7.40-GTNH" = _WwVkJUaP;
        "pkg-2.7.41-GTNH-pre" = _tek9BsMi;
        "pkg-2.7.42-GTNH-pre" = _ja39J5lz;
        "pkg-2.7.43-GTNH" = _8WjaEkVW;
        "pkg-2.7.44-GTNH" = _mYmWqpz9;
        "pkg-2.7.45-GTNH" = _LXffJZEC;
        "pkg-2.7.46-GTNH" = _tkaTmiYS;
        "pkg-2.7.47-GTNH-pre" = _aXajujY3;
        "pkg-2.7.48-GTNH" = _6JA1rZEM;
        "pkg-2.7.49-GTNH" = _IrjLAVYa;
        "pkg-2.7.50-GTNH" = _WbIxwh4K;
        "pkg-2.7.51-GTNH" = _OkL9i1og;
        "pkg-2.7.52-GTNH" = _XfvpGcuO;
        "pkg-2.7.53-GTNH-pre" = _yYRpJYL4;
        "pkg-2.7.54-GTNH" = _WDbANEh6;
        "pkg-2.7.55-GTNH-pre" = _yrLLLcpw;
        "pkg-2.7.56-GTNH" = _aFDkenE2;
        "pkg-2.7.57-GTNH" = _UbzgPWBs;
        "pkg-2.7.58-GTNH" = _XSpnPlP8;
        "pkg-2.7.59-GTNH" = _Ya1aJT0j;
        "pkg-2.7.60-GTNH" = _zirjQJ8O;
        "pkg-2.7.62-GTNH" = _KavIjPTO;
        "pkg-2.7.64-GTNH" = _Akv7VFTa;
        "pkg-2.7.66-GTNH" = _6efqpIjh;
        "pkg-2.7.69-GTNH" = _Q3pChaCE;
        "pkg-2.7.72-GTNH" = _8C5iQ5Nb;
        "pkg-2.7.74-GTNH" = _QIR7sO4H;
        "pkg-2.7.75-GTNH" = _inKGWkkK;
        "pkg-2.7.76-GTNH" = _W6BGhfgR;
        "pkg-2.7.77-GTNH" = _rsBGgSvI;
        "pkg-2.7.78-GTNH" = _rFlvYcNt;
        "pkg-2.7.80-GTNH" = _cPd49zUG;
        "pkg-2.7.81-GTNH" = _2CWvL21Q;
        "pkg-2.7.82-GTNH" = _8zKOkjN8;
        "pkg-2.7.83-GTNH" = _tZRevSr7;
        "pkg-2.7.84-GTNH" = _kHjSFUAO;
        "pkg-2.7.85-GTNH" = _yLRfO11V;
        "pkg-2.7.86-GTNH" = _dJgfHDvW;
        "pkg-2.7.87-GTNH" = _pbqpvNwP;
        "pkg-2.7.88-GTNH" = _m3RJRNdQ;
        "pkg-2.7.89-GTNH" = _1RhXNHNE;
        "pkg-2.7.90-GTNH" = _NWvAh2Yt;
        "pkg-2.7.91-GTNH" = _hOnia99R;
        "pkg-2.8.0-GTNH" = _BsFC0W2j;
        "pkg-2.8.2-GTNH" = _6bxSG3SH;
        "pkg-2.8.4-GTNH" = _aN4whzNP;
        "pkg-2.8.6-GTNH" = _zNCmxhSm;
        "pkg-2.8.8-GTNH" = _SIs9bLC8;
        "pkg-2.8.9-GTNH" = _qjuduK8F;
        "pkg-2.8.11-GTNH" = _AErhP6Qr;
        "pkg-2.8.14-GTNH" = _87dHIbgX;
        "pkg-2.8.15-GTNH" = _OIR3dfHb;
        "pkg-2.8.16-GTNH" = _6iT3qP7Y;
        "pkg-2.8.18-GTNH" = _ehkxCska;
        "pkg-2.8.19-GTNH" = _LCkMcwXi;
        "pkg-2.8.20-GTNH" = _AfxqSOzk;
        "pkg-2.8.21-GTNH" = _3XCXmEN5;
        "pkg-2.8.23-GTNH" = _3TDEW7WP;
        "pkg-2.8.25-GTNH" = _2tjkRF86;
        "pkg-2.8.26-GTNH" = _YACoGUIK;
        "pkg-2.8.31-GTNH" = _OY6dBxwR;
        "pkg-2.8.33-GTNH" = _6jFjydu7;
        "pkg-2.8.35-GTNH" = _kwRPGraO;
        "pkg-2.8.37-GTNH" = _gTxWs99Z;
        "pkg-2.8.39-GTNH" = _Y1F5QsCi;
        "pkg-2.8.40-GTNH" = _zvX2IHmG;
        "pkg-2.8.42-GTNH" = _KKrnw4BI;
        "pkg-2.8.43-GTNH" = _jYT4xnUt;
        "pkg-2.8.44-GTNH" = _83d3jGze;
        "pkg-2.8.47-GTNH" = _SMHgKDhg;
        "pkg-2.8.48-GTNH" = _9PAQYDgl;
        "pkg-2.8.50-GTNH" = _D31wnAjl;
        "pkg-2.8.52-GTNH" = _OFQZYT9y;
        "pkg-2.8.54-GTNH" = _uo9hlcuP;
        "pkg-2.8.55-GTNH" = _FXZHaHwc;
        "pkg-2.8.58-GTNH" = _VV7cYyYm;
        "pkg-2.8.60-GTNH" = _jMa51DWf;
        "pkg-2.8.63-GTNH" = _whtKLGBM;
        "pkg-2.8.65-GTNH" = _ZtVxiJRw;
        "pkg-2.8.67-GTNH" = _SbTfQtVt;
        "pkg-2.8.68-GTNH" = _oWc1cPBq;
        "pkg-2.8.69-GTNH" = _cIse25yj;
        "pkg-2.8.70-GTNH" = _T5hkuY2r;
        "pkg-2.8.71-GTNH" = _WhZRqoU3;
        "pkg-2.8.72-GTNH" = _EBopc8aR;
        "pkg-2.8.74-GTNH" = _fd2KHeLn;
        "pkg-2.8.75-GTNH" = _qWkcFvQO;
        "pkg-2.8.76-GTNH" = _b1aG8zRx;
        "pkg-2.8.77-GTNH" = _ohjiU3RC;
        "pkg-2.8.78-GTNH" = _Om9W1g8W;
        "pkg-2.8.79-GTNH" = _8OObWRsi;
        "pkg-2.8.80-GTNH" = _Ig9CynCy;
        "pkg-2.8.81-GTNH" = _sIHTkJWd;
        "pkg-2.8.82-GTNH" = _VkIkYdR2;
        "pkg-2.8.83-GTNH" = _35NGxnGv;
        "pkg-2.8.84-GTNH" = _gwXEVoGp;
        "pkg-2.8.85-GTNH" = _jD37l0SD;
        "pkg-2.8.86-GTNH" = _GTooK5P1;
        "pkg-2.8.87-GTNH" = _Elr0uuAA;
        "pkg-2.8.88-GTNH" = _QjMF7bYU;
        "pkg-2.8.89-GTNH" = _6LASuO3J;
        "pkg-2.8.90-GTNH" = _vHVVXhzA;
        "pkg-2.8.91-GTNH" = _zcorfTnf;
        "pkg-2.8.92-GTNH" = _Jtpc3sWd;
        "pkg-2.8.93-GTNH" = _U9PhLDCe;
        "pkg-2.8.94-GTNH" = _GpGkAyJf;
        "pkg-2.8.95-GTNH" = _yL0nRgvp;
        "pkg-2.8.96-GTNH" = _48TMM7Ot;
        "pkg-2.8.97-GTNH" = _5Vw0Uq05;
        "pkg-2.8.98-GTNH" = _CR7NzFCN;
        "pkg-2.8.99-GTNH" = _w2eYse2K;
        "pkg-2.8.100-GTNH" = _Tou3z245;
        "pkg-2.8.101-GTNH" = _wztPUYHX;
