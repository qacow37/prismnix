...
let
    ...
    in {
        ...
        "pkg-0.4.1+1.18.2" = _mRXoRTy0;
        "pkg-0.4.1-576+1.18.2" = _ce9nGr3a;
        "pkg-0.4.1-586+1.18.2" = _eq17R2hD;
        "pkg-0.4.1-594+1.18.2" = _bGga7Elj;
        "pkg-0.4.1-595+1.18.2" = _yFEFFnx0;
        "pkg-0.4.1-596+1.18.2" = _LQns5RQ4;
        "pkg-0.4.1-599+1.18.2" = _OYqqVNgO;
        "pkg-0.4.1-600+1.18.2" = _5nlKopWj;
        "pkg-0.4.1-601+1.18.2" = _eNCMQaKl;
        "pkg-0.4.1-628+1.18.2" = _CDGw3zSe;
        "pkg-0.4.1-629+1.18.2" = _claJcl5F;
        "pkg-0.4.1-631+1.18.2" = _bJKtTI8y;
        "pkg-0.4.1-635+1.18.2" = _TMePrzvw;
        "pkg-0.4.1-637+1.18.2" = _kTNqWWMa;
        "pkg-0.5.0.c-708+1.18.2" = _j7rLltXv;
        "pkg-0.5.0.d-728+1.18.2" = _uAheUy8q;
        "pkg-0.5.0.d-730+1.18.2" = _mEHNMQS7;
        "pkg-0.5.0.d-731+1.18.2" = _l66YzGBK;
        "pkg-0.5.0.e-733+1.18.2" = _AUnWONBr;
        "pkg-0.5.0.f-776+1.19.2" = _5QkKPfWg;
        "pkg-0.5.0.g-791+1.19.2" = _CMXqOgvp;
        "pkg-0.5.0.g-788+1.18.2" = _KVlT278H;
        "pkg-0.5.0.g-792+1.18.2" = _aCFWhh4m;
        "pkg-0.5.0.g-796+1.19.2" = _ZOucvJwc;
        "pkg-0.5.0.i-921+1.18.2" = _8wJieFuI;
        "pkg-0.5.0.i-925+1.19.2" = _WIznfof3;
        "pkg-0.5.0.i-944+1.18.2" = _eMmAlNIo;
        "pkg-0.5.0.i-946+1.19.2" = _9Kizjtn4;
        "pkg-0.5.0.i-960+1.18.2" = _XfN2Gwkh;
        "pkg-0.5.0.i-961+1.19.2" = _eiOEbe83;
        "pkg-0.5.0.i-963+1.18.2" = _wSUajPZ2;
        "pkg-0.5.0.i-979+1.18.2" = _6WodDaRw;
        "pkg-0.5.0.i-988+1.18.2" = _SDRtfq3B;
        "pkg-0.5.0.i-989+1.19.2" = _OzM1R01X;
        "pkg-0.5.0.i-991+1.19.2" = _MpeKaF3n;
        "pkg-0.5.0.i-1003+1.19.2" = _js1edbtD;
        "pkg-0.5.0.i-1002+1.18.2" = _kOmlEnRT;
        "pkg-0.5.0.i-1016+1.18.2" = _URHyiw9Z;
        "pkg-0.5.0.i-1017+1.19.2" = _EkeMb3jA;
        "pkg-0.5.1-b-build.1075+mc1.19.2" = _ojGZcMyX;
        "pkg-0.5.1-b-build.1070+mc1.18.2" = _i0067Dja;
        "pkg-0.5.1-b-build.1078+mc1.18.2" = _8hPKnWl8;
        "pkg-0.5.1-b-build.1079+mc1.19.2" = _q6x0xvc1;
        "pkg-0.5.1-b-build.1089+mc1.19.2" = _wKEEi1qX;
        "pkg-0.5.1-b-build.1088+mc1.18.2" = _uxdmLu14;
        "pkg-0.5.1-c-build.1160+mc1.19.2" = _okpdciJG;
        "pkg-0.5.1-c-build.1159+mc1.18.2" = _3eQP1uZu;
        "pkg-0.5.1-d-build.1161+mc1.20.1" = _qlA1WuOK;
        "pkg-0.5.1-f-build.1333+mc1.18.2" = _mFmmdAVA;
        "pkg-0.5.1-f-build.1335+mc1.20.1" = _A8R3Be5A;
        "pkg-0.5.1-f-build.1334+mc1.19.2" = _42mznDva;
        "pkg-0.5.1-f-build.1415+mc1.18.2" = _ACfVIQMB;
        "pkg-0.5.1-f-build.1416+mc1.19.2" = _ylv5ppFs;
        "pkg-0.5.1-f-build.1417+mc1.20.1" = _h2HgGyvA;
        "pkg-0.5.1-i-build.1598+mc1.18.2" = _KW1sKlUC;
        "pkg-0.5.1-i-build.1599+mc1.19.2" = _iMqYwC9I;
        "pkg-0.5.1-j-build.1600+mc1.20.1" = _S5OtZS6Y;
        "pkg-0.5.1-j-build.1604+mc1.20.1" = _4Flkixdq;
        "pkg-0.5.1-i-build.1603+mc1.19.2" = _GOkLKgci;
        "pkg-0.5.1-i-build.1608+mc1.19.2" = _cVnXjt7x;
        "pkg-0.5.1-j-build.1609+mc1.20.1" = _lNcgFlF8;
        "pkg-0.5.1-i-build.1629+mc1.18.2" = _L283tIV7;
        "pkg-0.5.1-j-build.1631+mc1.20.1" = _7Ub71nPb;
        "pkg-0.5.1-i-build.1630+mc1.19.2" = _XMiAOQvM;
        "pkg-6.0.7.0+build.1728-mc1.20.1" = _Ahg9WKTJ;
        "pkg-6.0.8.0+build.1734-mc1.20.1" = _XwEwQH3o;
        "pkg-6.0.8.1+build.1744-mc1.20.1" = _HAqwA6X1;
        "default" = _HAqwA6X1;
    });
