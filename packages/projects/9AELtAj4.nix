...
let
    ...
    in {
        ...
        "pkg-Forge-1.16.4-v2.0.0" = _s8z04QBr;
        "pkg-Fabric-1.16.4-v2.0.0" = _MAO810pO;
        "pkg-Forge-1.17.1-v2.0.0" = _R99553xH;
        "pkg-Fabric-1.17-v2.0.0" = _7E2uVEH8;
        "pkg-Forge-1.18.1-v2.0.0" = _3747wPU9;
        "pkg-Fabric-1.18.1-v2.0.0" = _KmBWYWDD;
        "pkg-Forge-1.18.2-v2.0.0" = _Oqv9nY8F;
        "pkg-Fabric-1.18.2-v2.0.0" = _rYyezggC;
        "pkg-Forge-1.16.4-v2.1.0" = _oWoGtYz3;
        "pkg-Fabric-1.16.4-v2.1.0" = _v7UBgAwm;
        "pkg-Forge-1.17.1-v2.1.0" = _2u1SFbUo;
        "pkg-Fabric-1.17.1-v2.1.0" = _Kg4792du;
        "pkg-Forge-1.18.1-v2.1.0" = _hQFUyzug;
        "pkg-Fabric-1.18.1-v2.1.0" = _G32FrfZ9;
        "pkg-Forge-1.18.2-v2.1.0" = _RlqlKoLy;
        "pkg-Fabric-1.18.2-v2.1.0" = _tLncXNqV;
        "pkg-Forge-1.19-v2.1.0" = _5jKh1Nmh;
        "pkg-Fabric-1.19-v2.1.0" = _SjP4krpl;
        "pkg-Forge-1.19.2-v2.1.0" = _NvXFdLis;
        "pkg-Fabric-1.19.2-v2.1.0" = _qIQ5XFxa;
        "pkg-Forge-1.16.4-v2.2.0" = _BZJipT4s;
        "pkg-Fabric-1.16.4-v2.2.0" = _pNb18p6t;
        "pkg-Forge-1.17.1.v2.2.0" = _7cjsTFCJ;
        "pkg-Fabric-1.17.1-v2.2.0" = _5V5Xn9se;
        "pkg-Forge-1.18.1-v2.2.0" = _ncjVS2Tz;
        "pkg-Fabric-1.18.1-v2.2.0" = _80eiDgf3;
        "pkg-Forge-1.18.2-v2.2.0" = _2N7SEkhp;
        "pkg-Fabric-1.18.2-v2.2.0" = _6EkhHQlz;
        "pkg-Forge-1.19-v2.2.0" = _9KM7nelC;
        "pkg-Fabric-1.19-v2.2.0" = _qTE1rLVf;
        "pkg-Forge-1.19.2-v2.2.0" = _NvxSIq5I;
        "pkg-Fabric-1.19.2-v2.2.0" = _TjADpOZM;
        "pkg-Forge-1.19.3-v2.2.0" = _rdlhZAZh;
        "pkg-Fabric-1.19.3-v2.2.0" = _MkbjQVNC;
        "pkg-Forge-1.19.4-v2.2.0" = _VRRX4Fkj;
        "pkg-Fabric-1.19.4-v2.2.0" = _pEtfbMkl;
        "pkg-Forge-1.8.9-v2.2.0" = _bPdJVv4E;
        "pkg-Forge-1.20.1-v2.2.0" = _e1b66H3l;
        "pkg-Fabric-1.20.1-v2.2.0" = _za0cuXo2;
        "pkg-NeoForge-1.20.1-v2.2.0" = _EFaTRYzy;
        "pkg-Forge-1.16.4-v2.3.0" = _2oKldKI9;
        "pkg-Fabric-1.16.5-v2.3.0" = _AgmWcPyy;
        "pkg-Forge-1.17.1-v2.3.0" = _HupYroPD;
        "pkg-Fabric-1.17.1-v2.3.0" = _54fMAupF;
        "pkg-Forge-1.18.1-v2.3.0" = _R7HeDMTP;
        "pkg-Fabric-1.18.1-v2.3.0" = _JsJYGoU1;
        "pkg-Forge-1.18.2-v2.3.0" = _T5wUfxjc;
        "pkg-Fabric-1.18.2-v2.3.0" = _anJ51i5Q;
        "pkg-Forge-1.19-v2.3.0" = _uK0Qz3eC;
        "pkg-Fabric-1.19-v2.3.0" = _ZWfWygqr;
        "pkg-Forge-1.19.2-v2.3.0" = _kaM5IpVO;
        "pkg-Fabric-1.19.2-v2.3.0" = _5XnMXFLJ;
        "pkg-Forge-1.19.3-v2.3.0" = _o20BFT5N;
        "pkg-Fabric-1.19.3-v2.3.0" = _6Rjy9Ghs;
        "pkg-Forge-1.19.4-v2.3.0" = _ZuTzyhdn;
        "pkg-Fabric-1.19.4-v2.3.0" = _TrqqrZ4B;
        "pkg-NeoForge-1.20.1-v2.3.0" = _ajiMvBwK;
        "pkg-Fabric-1.20.1-v2.3.0" = _t7MMcPbx;
        "pkg-NeoForge-1.20.2-v2.3.0" = _vHfNmRNm;
        "pkg-Fabric-1.20.2-v2.3.0" = _pGYIfZvZ;
        "pkg-Forge-1.8.9-v2.3.0" = _SM32eaMI;
        "pkg-NeoForge-1.20.4-v2.3.0" = _IDRZn0Q0;
        "pkg-Fabric-1.20.4-v2.3.0" = _GTCuFfpW;
        "pkg-NeoForge-1.20.6-v2.3.0" = _OfZ9jroT;
        "pkg-Fabric-1.20.6-v2.3.0" = _r2ZYyD9E;
        "pkg-NeoForge-1.21-v2.3.0" = _BusZM5t1;
        "pkg-Fabric-1.21-v2.3.0" = _BiFRmlaz;
        "pkg-Forge-1.16.5-v3.0.0" = _2FUsxg42;
        "pkg-Fabric-1.16.5-v3.0.0" = _HKU3WM6k;
        "pkg-Forge-1.17.1-v3.0.0" = _u9IdIkyR;
        "pkg-Fabric-1.17.1-v3.0.0" = _gv87VlGu;
        "pkg-Forge-1.18.2-v3.0.0" = _FNf3cVKV;
        "pkg-Fabric-1.18.2-v3.0.0" = _LXAmsjVR;
        "pkg-Forge-1.19.4-v3.0.0" = _KvBEpquK;
        "pkg-Fabric-1.19.4-v3.0.0" = _YVeCaaeX;
        "pkg-NeoForge-1.20.6-v3.0.0" = _CdCCSl4I;
        "pkg-Fabric-1.20.6-v3.0.0" = _tx2ZwpO0;
        "pkg-NeoForge-1.21.1-v3.0.0" = _cdeM1bPN;
        "pkg-Fabric-1.21.1-v3.0.0" = _WmhF7AqV;
        "pkg-Fabric-1.20.1-v3.0.0" = _6LiR8Eln;
        "pkg-NeoForge-1.21.3-v3.0.0" = _g9wQVcyr;
        "pkg-Fabric-1.21.3-v3.0.0" = _oPHWRugj;
        "pkg-Forge-1.16.5-v3.1.0" = _UBFBuGR9;
        "pkg-Fabric-1.16.4-v3.1.0" = _EO3BTqPt;
        "pkg-Forge-1.17.1-v3.1.0" = _YvMeQGnz;
        "pkg-Fabric-1.17.1-v3.1.0" = _UEdgKR8i;
        "pkg-Forge-1.18.2-v3.1.0" = _asB87410;
        "pkg-Fabric-1.18.2-v3.1.0" = _dUgmRM02;
        "pkg-Forge-1.19.4-v3.1.0" = _4lBqJGmL;
        "pkg-Fabric-1.19.4-v3.1.0" = _sIbWfNqC;
        "pkg-Fabric-1.20.1-v3.1.0" = _R33fahsQ;
        "pkg-NeoForge-1.20.6-v3.1.0" = _dGh3MONd;
        "pkg-NeoForge-1.21.1-v3.1.0" = _LYEfiyuU;
        "pkg-Fabric-1.21.1-v3.1.0" = _AiIxXXJI;
        "pkg-NeoForge-1.21.3-v3.1.0" = _sWJCSqcY;
        "pkg-Fabric-1.21.3-v3.1.0" = _wObDmANO;
        "pkg-NeoForge-1.21.4-v3.1.0" = _oDYZeegv;
        "pkg-Fabric-1.21.4-v3.1.0" = _VArHtABi;
        "pkg-NeoForge-1.20.4-v3.1.0" = _pts7sZc8;
        "pkg-Forge-1.20.1-v3.1.0" = _lQvUviaz;
        "pkg-Fabric-1.20.4-v3.1.0" = _mfdTZEgy;
        "pkg-NeoForge-1.21.5-v3.1.0" = _Qwu1EMvM;
        "pkg-Fabric-1.21.5-v3.1.0" = _gBYC8UQf;
        "pkg-NeoForge-1.21.6-v3.1.0" = _weNUI2gz;
        "pkg-Fabric-1.21.6-v3.1.0" = _49Jy8Hmc;
        "pkg-NeoForge-1.21.7-v3.1.0" = _aO6zUaYh;
        "pkg-Fabric-1.21.7-v3.1.0" = _6SFZcm3u;
        "pkg-NeoForge-1.21.9-v3.1.0" = _ZBjJvPHP;
        "pkg-Fabric-1.21.9-v3.1.0" = _W1MwFrMg;
        "pkg-Forge-1.8.9-v3.1.0" = _lyZQf4Ie;
        "pkg-NeoForge-1.21.11-v3.1.0" = _qK3933BU;
        "pkg-Fabric-1.21.11-v3.1.0" = _DFUe2I8K;
        "pkg-NeoForge-26.1-v3.1.0" = _hguw0MK3;
        "pkg-Fabric-26.1-v3.1.0" = _4Pmn0U94;
        "pkg-NeoForge-26.2-v3.1.0" = _Clti6qr5;
        "pkg-Fabric-26.2-v3.1.0" = _AFYLbHQC;
        "default" = _AFYLbHQC;
    });
