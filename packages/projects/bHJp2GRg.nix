...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _VHlfDJ0J;
        "pkg-v4.0.2-1.19.2-Fabric" = _Gclx8b1R;
        "pkg-v4.0.2-1.19.2-Forge" = _9wHxVSdS;
        "pkg-v4.0.3-1.19.2-Fabric" = _ZQLxxbzK;
        "pkg-v4.0.3-1.19.2-Forge" = _G8otZ4d8;
        "pkg-v4.0.4-1.19.2-Fabric" = _PeaC5rW1;
        "pkg-v4.0.4-1.19.2-Forge" = _rgqVk5H1;
        "pkg-v5.0.0-1.19.3-Forge" = _3BEgs0vi;
        "pkg-v5.0.0-1.19.3-Fabric" = _J1AxZoYF;
        "pkg-v6.0.0-1.19.4-Fabric" = _AsxGyzOl;
        "pkg-v6.0.0-1.19.4-Forge" = _G64kJHgK;
        "pkg-v7.0.0-1.20-Fabric" = _bzoQJ2FU;
        "pkg-v7.0.0-1.20-Forge" = _OadpDHZ8;
        "pkg-v7.0.1-1.20-Fabric" = _Rzm5Ewur;
        "pkg-v7.0.1-1.20-Forge" = _wlgrty0w;
        "pkg-v8.0.0-1.20.1-Fabric" = _Cqpmor52;
        "pkg-v8.0.0-1.20.1-Forge" = _UOgfoBsZ;
        "pkg-v8.0.1-1.20.1-Forge" = _aY4C0ZWK;
        "pkg-v8.0.1-1.20.1-Fabric" = _F7jxmi6E;
        "pkg-v8.0.2-1.20.1-Forge" = _lmegK1S5;
        "pkg-v8.0.2-1.20.1-Fabric" = _oBrN9aom;
        "pkg-v8.0.3-1.20.1-Forge" = _tVFcuxZG;
        "pkg-v8.0.3-1.20.1-Fabric" = _ov250Qvk;
        "pkg-v20.4.0-1.20.4-Fabric" = _6AsthdnH;
        "pkg-v20.4.0-1.20.4-Forge" = _HEyPfHS3;
        "pkg-v20.4.0-1.20.4-NeoForge" = _E3FxcZT2;
        "pkg-v20.4.1-1.20.4-Fabric" = _5QfA1sxM;
        "pkg-v20.4.1-1.20.4-Forge" = _sntYnlE6;
        "pkg-v20.4.1-1.20.4-NeoForge" = _kJZNMPJT;
        "pkg-v21.0.0-1.21-Fabric" = _S5cjv083;
        "pkg-v21.0.0-1.21-NeoForge" = _UT8nYyt5;
        "pkg-v4.0.5-1.19.2-Forge" = _Z4h917Ex;
        "pkg-v4.0.5-1.19.2-Fabric" = _BMbqwvVU;
        "pkg-v4.0.6-1.19.2-Fabric" = _MkFSQ4tx;
        "pkg-v4.0.6-1.19.2-Forge" = _vpkeaYKc;
        "pkg-v8.0.4-1.20.1-Forge" = _pg7wiIfo;
        "pkg-v8.0.4-1.20.1-Fabric" = _ctUjPcK0;
        "pkg-v21.0.1-1.21-Fabric" = _pCyCHZoo;
        "pkg-v21.0.1-1.21-NeoForge" = _kc7wDJgF;
        "pkg-v21.1.0-1.21.1-Fabric" = _jPJRPoXB;
        "pkg-v21.1.0-1.21.1-NeoForge" = _93cFQQBq;
        "pkg-v21.3.0-1.21.3-Fabric" = _9kIoJ9QL;
        "pkg-v21.3.0-1.21.3-NeoForge" = _keyHx8jp;
        "pkg-v21.4.0-1.21.4-Fabric" = _k0Rerrst;
        "pkg-v21.4.0-1.21.4-NeoForge" = _gAGrleOr;
        "pkg-v21.5.0-1.21.5-Fabric" = _46Z2ANfU;
        "pkg-v21.5.0-1.21.5-NeoForge" = _fv5GVRSa;
        "pkg-v21.6.0-1.21.6-Fabric" = _xMFid8vq;
        "pkg-v21.6.0-1.21.6-NeoForge" = _Pl5j8QQZ;
        "pkg-v21.7.0-1.21.7-Fabric" = _xWlnNf6b;
        "pkg-v21.7.0-1.21.7-NeoForge" = _826w2IC6;
        "pkg-v21.8.0-1.21.8-Fabric" = _he9oY0dZ;
        "pkg-v21.8.0-1.21.8-NeoForge" = _ipgsGMzs;
        "pkg-21.9.0" = _mLKTJF3g;
        "pkg-21.10.0" = _O5RuGvLA;
        "pkg-v21.1.1-1.21.1-Fabric" = _fNixrBTj;
        "pkg-v21.1.1-1.21.1-NeoForge" = _fII2Ezk6;
        "pkg-21.10.1" = _ccYM2AlK;
        "pkg-21.11.0" = _TNoxD5CV;
