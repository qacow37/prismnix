...
let
    ...
    in {
        ...
        "pkg-0.6" = _1plvlTrI;
        "pkg-0.6.1" = _6gW0qIwR;
        "pkg-1.0-forge-1.20.1" = _528SnOE1;
        "pkg-1.0-fabric-1.20.1" = _vvG3O4Oc;
        "pkg-1.0-forge-1.21" = _t0aI0bSJ;
        "pkg-1.0-neoforge-1.21" = _ZdzeTitC;
        "pkg-1.0-fabric-1.21" = _q8NvyEUy;
        "pkg-1.0-forge-1.21.3" = _Ro9MdJUo;
        "pkg-1.0-neoforge-1.21.3" = _pVuAFWvE;
        "pkg-1.0-fabric-1.21.3" = _4qsRQIiE;
        "pkg-1.0-forge-1.21.4" = _DfMkzStO;
        "pkg-1.0-neoforge-1.21.4" = _Q0bNQdvj;
        "pkg-1.0-fabric-1.21.4" = _SVuK4qmV;
        "pkg-1.0-forge-1.21.5" = _YsV9jy68;
        "pkg-1.0-neoforge-1.21.5" = _fRuKjfPb;
        "pkg-1.0-fabric-1.21.5" = _OrYGqwGm;
        "pkg-1.0-forge-1.21.6" = _QtR4T4vW;
        "pkg-1.0-neoforge-1.21.6" = _pj8Vtg73;
        "pkg-1.0-fabric-1.21.6" = _avKux8rk;
        "pkg-1.0-forge-1.21.9" = _2pQlB5cA;
        "pkg-1.0-neoforge-1.21.9" = _B0VzGf7n;
        "pkg-1.0-fabric-1.21.9" = _gHDuwzIW;
        "pkg-1.0-forge-1.21.11" = _s7AL1wWd;
        "pkg-1.0-neoforge-1.21.11" = _tVwk2BnN;
        "pkg-1.0-fabric-1.21.11" = _lZ6TTIMU;
        "pkg-1.0.1-forge-1.20.1" = _yVl09o4v;
        "pkg-1.0.1-fabric-1.20.1" = _A1Bm1x9p;
        "pkg-1.0.1-forge-1.21" = _5UArkL5T;
        "pkg-1.0.1-neoforge-1.21" = _1swtyIe6;
        "pkg-1.0.1-fabric-1.21" = _9mHzvYCf;
        "pkg-1.0.1-forge-1.21.3" = _MLM0oOEI;
        "pkg-1.0.1-neoforge-1.21.3" = _CKrFwqum;
        "pkg-1.0.1-fabric-1.21.3" = _3cJSJUNX;
        "pkg-1.0.1-forge-1.21.4" = _ZRUZOucR;
        "pkg-1.0.1-neoforge-1.21.4" = _hLFM7Ic4;
        "pkg-1.0.1-fabric-1.21.4" = _3HifDoP6;
        "pkg-1.0.1-forge-1.21.5" = _2qHeARBD;
        "pkg-1.0.1-neoforge-1.21.5" = _MWjIhB1B;
        "pkg-1.0.1-fabric-1.21.5" = _46BftHtH;
        "pkg-1.0.1-forge-1.21.6" = _qvU8JV05;
        "pkg-1.0.1-neoforge-1.21.6" = _hZWeG1XR;
        "pkg-1.0.1-fabric-1.21.6" = _bryU6bt9;
        "pkg-1.0.1-forge-1.21.9" = _c1BO2vUp;
        "pkg-1.0.1-neoforge-1.21.9" = _Ag67LAZG;
        "pkg-1.0.1-fabric-1.21.9" = _o54Zl9Ke;
        "pkg-1.0.1-forge-1.21.11" = _MMrBIbCD;
        "pkg-1.0.1-neoforge-1.21.11" = _btnN7AmK;
        "pkg-1.0.1-fabric-1.21.11" = _dEN91jfQ;
        "pkg-1.0.2-forge-1.20.1" = _vtV3Btiz;
        "pkg-1.0.2-fabric-1.20.1" = _DU92HQWc;
        "pkg-1.0.2-forge-1.21" = _Yj4sHnmr;
        "pkg-1.0.2-neoforge-1.21" = _WJxQ4oG5;
        "pkg-1.0.2-fabric-1.21" = _SkSYgFS8;
        "pkg-1.0.2-forge-1.21.3" = _ZgtUzGxd;
        "pkg-1.0.2-neoforge-1.21.3" = _mbeN5bpa;
        "pkg-1.0.2-fabric-1.21.3" = _v4CB4rzF;
        "pkg-1.0.2-forge-1.21.4" = _FoqTihs7;
        "pkg-1.0.2-neoforge-1.21.4" = _VpuGeyya;
        "pkg-1.0.2-fabric-1.21.4" = _TTPxDWbY;
        "pkg-1.0.2-forge-1.21.5" = _bcdpyuYC;
        "pkg-1.0.2-neoforge-1.21.5" = _rNCJXfPl;
        "pkg-1.0.2-fabric-1.21.5" = _7U777wzb;
        "pkg-1.0.2-forge-1.21.6" = _QAdA9uiC;
        "pkg-1.0.2-neoforge-1.21.6" = _iICSqbqr;
        "pkg-1.0.2-fabric-1.21.6" = _tnKPaAiF;
        "pkg-1.0.2-forge-1.21.9" = _l9gDsyM9;
        "pkg-1.0.2-neoforge-1.21.9" = _31ESvbf6;
        "pkg-1.0.2-fabric-1.21.9" = _TG97ssVC;
        "pkg-1.0.2-forge-1.21.11" = _gvMj7kPC;
        "pkg-1.0.2-neoforge-1.21.11" = _iL8UWiaq;
        "pkg-1.0.2-fabric-1.21.11" = _N7grlZix;
        "pkg-1.0.3-forge-1.20.1" = _Lpq8YKyW;
        "pkg-1.0.3-fabric-1.20.1" = _tf50AJQh;
        "pkg-1.0.3-forge-1.21" = _TxGdeoY7;
        "pkg-1.0.3-neoforge-1.21" = _wLM2dHhQ;
        "pkg-1.0.3-fabric-1.21" = _pWmX0wnR;
        "pkg-1.0.3-forge-1.21.3" = _OMp1IQTO;
        "pkg-1.0.3-neoforge-1.21.3" = _tAqtfzWS;
        "pkg-1.0.3-fabric-1.21.3" = _3fh1qM85;
        "pkg-1.0.3-forge-1.21.4" = _QbeZpj2N;
        "pkg-1.0.3-neoforge-1.21.4" = _7ivg8vif;
        "pkg-1.0.3-fabric-1.21.4" = _UfjMv7sm;
        "pkg-1.0.3-forge-1.21.5" = _vAspfMV2;
        "pkg-1.0.3-neoforge-1.21.5" = _BXAYISea;
        "pkg-1.0.3-fabric-1.21.5" = _5J4NysWN;
        "pkg-1.0.3-forge-1.21.6" = _pN9pz3JL;
        "pkg-1.0.3-neoforge-1.21.6" = _nSIJZNX8;
        "pkg-1.0.3-fabric-1.21.6" = _8Lr5V4z2;
        "pkg-1.0.3-forge-1.21.9" = _SzQgL7oE;
        "pkg-1.0.3-neoforge-1.21.9" = _BQkLXm8u;
        "pkg-1.0.3-fabric-1.21.9" = _dq1FXHGc;
        "pkg-1.0.3-forge-1.21.11" = _1tp4hIwy;
        "pkg-1.0.3-neoforge-1.21.11" = _KE5IoWeS;
        "pkg-1.0.3-fabric-1.21.11" = _hQwx4fDd;
        "pkg-1.0.4-forge-1.20.1" = _zESe40Su;
        "pkg-1.0.4-fabric-1.20.1" = _DJMcFV1j;
        "pkg-1.0.4-forge-1.21" = _CsNA6yp4;
        "pkg-1.0.4-neoforge-1.21" = _4CuhEC7q;
        "pkg-1.0.4-fabric-1.21" = _X28wT0dD;
        "pkg-1.0.4-forge-1.21.3" = _7bigJt8i;
        "pkg-1.0.4-neoforge-1.21.3" = _9g0N6FWy;
        "pkg-1.0.4-fabric-1.21.3" = _TCszTkO8;
        "pkg-1.0.4-forge-1.21.4" = _whKYItOB;
        "pkg-1.0.4-neoforge-1.21.4" = _w5JyIciQ;
        "pkg-1.0.4-fabric-1.21.4" = _Uvuc1dIf;
        "pkg-1.0.4-forge-1.21.5" = _AejkVKZn;
        "pkg-1.0.4-neoforge-1.21.5" = _zlAJFP2B;
        "pkg-1.0.4-fabric-1.21.5" = _3pzgVZEZ;
        "pkg-1.0.4-forge-1.21.6" = _wej5SNZ6;
        "pkg-1.0.4-neoforge-1.21.6" = _I7NfGa6z;
        "pkg-1.0.4-fabric-1.21.6" = _iyixmbsX;
        "pkg-1.0.4-forge-1.21.9" = _70TtzerK;
        "pkg-1.0.4-neoforge-1.21.9" = _tX3Bgjwl;
        "pkg-1.0.4-fabric-1.21.9" = _TthcRp75;
        "pkg-1.0.4-forge-1.21.11" = _Poe0p8kv;
        "pkg-1.0.4-neoforge-1.21.11" = _qettK4WH;
        "pkg-1.0.4-fabric-1.21.11" = _8P2fZbvY;
        "pkg-1.0.5-forge-1.20.1" = _8lL6gzh8;
        "pkg-1.0.5-fabric-1.20.1" = _F96FbCZk;
        "pkg-1.0.5-forge-1.21" = _6EFZU035;
        "pkg-1.0.5-neoforge-1.21" = _2310YWLO;
        "pkg-1.0.5-fabric-1.21" = _PJEFODev;
        "pkg-1.0.5-forge-1.21.3" = _IBX60pcD;
        "pkg-1.0.5-neoforge-1.21.3" = _x1dhkDH2;
        "pkg-1.0.5-fabric-1.21.3" = _PhiSYfIH;
        "pkg-1.0.5-forge-1.21.4" = _mAq3Jiuv;
        "pkg-1.0.5-neoforge-1.21.4" = _JKBzbuhk;
        "pkg-1.0.5-fabric-1.21.4" = _QtOlKppN;
        "pkg-1.0.5-forge-1.21.5" = _1DjN7Jdp;
        "pkg-1.0.5-neoforge-1.21.5" = _l1Fh5Ske;
        "pkg-1.0.5-fabric-1.21.5" = _4Q68fvxB;
        "pkg-1.0.5-forge-1.21.6" = _bhqLN1yb;
        "pkg-1.0.5-neoforge-1.21.6" = _TlTQWUgr;
        "pkg-1.0.5-fabric-1.21.6" = _69N1UuFK;
        "pkg-1.0.5-forge-1.21.9" = _QSGBeFc7;
        "pkg-1.0.5-neoforge-1.21.9" = _NfnwkjRB;
        "pkg-1.0.5-fabric-1.21.9" = _Q7LKJDns;
        "pkg-1.0.5-forge-1.21.11" = _mHYzFxYG;
        "pkg-1.0.5-neoforge-1.21.11" = _RdMZVujS;
        "pkg-1.0.5-fabric-1.21.11" = _1dlthAqR;
        "pkg-1.0.5-neoforge-26.1" = _qoXBC8lE;
        "pkg-1.0.5-fabric-26.1" = _XOLdxvAC;
        "pkg-1.0.6-fabric-1.20.1" = _PtasBuko;
        "pkg-1.0.6-forge-1.20.1" = _SrlJXZBd;
        "pkg-1.0.6-fabric-1.21" = _J5C5ZDSr;
        "pkg-1.0.6-neoforge-1.21" = _k37oVEnG;
        "pkg-1.0.6-forge-1.21" = _Di1JSt4Y;
        "pkg-1.0.6-fabric-1.21.11" = _nUFwkiLK;
        "pkg-1.0.6-forge-1.21.11" = _PBYJbuhU;
        "pkg-1.0.6-fabric-1.21.3" = _gr9p2EE4;
        "pkg-1.0.6-neoforge-1.21.11" = _V5WtwJqg;
        "pkg-1.0.6-forge-1.21.3" = _paZGQWTc;
        "pkg-1.0.6-neoforge-1.21.3" = _7j60zT0f;
        "pkg-1.0.6-fabric-1.21.4" = _vFuj3Xq1;
        "pkg-1.0.6-forge-1.21.4" = _TxIKnOiV;
        "pkg-1.0.6-neoforge-1.21.4" = _YXmb53vz;
        "pkg-1.0.6-fabric-1.21.5" = _rxPe4vEV;
        "pkg-1.0.6-forge-1.21.5" = _2p7NV2Nv;
        "pkg-1.0.6-neoforge-1.21.5" = _MD70UPjQ;
        "pkg-1.0.6-fabric-1.21.6" = _lLZKt3r6;
        "pkg-1.0.6-forge-1.21.6" = _WgxkdvNj;
        "pkg-1.0.6-neoforge-1.21.6" = _p1Xhd2nD;
        "pkg-1.0.6-fabric-1.21.9" = _fSFp8HP9;
        "pkg-1.0.6-forge-1.21.9" = _In0N0gkU;
        "pkg-1.0.6-neoforge-1.21.9" = _e3tScrLt;
        "pkg-1.0.6-fabric-26.1" = _4iVEt9Lk;
        "pkg-1.0.6-neoforge-26.1" = _pn2b8XW2;
        "pkg-1.0.7-neoforge-26.2" = _ynkJWrlk;
        "pkg-1.0.7-fabric-26.2" = _DFIWIkDF;
        "default" = _DFIWIkDF;
    });
