...
let
    ...
    in {
        ...
        "pkg-2.0-alpha-11" = _tk6MLeac;
        "pkg-2.0-alpha-12" = _6lLA4SbV;
        "pkg-V2.0-alpha-13" = _6kLTXk5h;
        "pkg-2.0-alpha-13" = _pRZGHJrT;
        "pkg-2.0-alpha-14" = _iiAx7MxQ;
        "pkg-2.0-alpha-15" = _COmmtqyc;
        "pkg-2.0-beta-1" = _dFgLlSVv;
        "pkg-2.0-beta-2" = _j9fkj518;
        "pkg-2.0-beta-3" = _25YP18tc;
        "pkg-2.0-beta-4" = _T9OoE6ua;
        "pkg-2.0-beta-5" = _sGfLkTP7;
        "pkg-2.0-beta-6" = _P0U5s1xr;
        "pkg-2.0-beta-7" = _ZwjfqHcU;
        "pkg-2.0-beta-8" = _i6gspcTm;
        "pkg-2.0-beta-9" = _rxdSVXSH;
        "pkg-2.0-beta-10" = _Rw692v0r;
        "pkg-2.0-beta-11" = _WZbbRorx;
        "pkg-2.0" = _s1KD7ENn;
        "pkg-2.0.1" = _CJRlsATr;
        "pkg-2.1-beta-1" = _Czr6iDrT;
        "pkg-2.1-beta-2" = _9gA2dltQ;
        "pkg-2.1-beta-3" = _oD9S8Sc9;
        "pkg-2.1" = _BiZASvkA;
        "pkg-2.2-pre-1" = _CgrcETzn;
        "pkg-2.1-pre-2" = _jr4vzKyD;
        "pkg-2.2-pre-2" = _dj70zo0N;
        "pkg-2.2-pre-3" = _WMkzPWjE;
        "pkg-2.2" = _3fWBJIXG;
        "default" = _3fWBJIXG;
    });
