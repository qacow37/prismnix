...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _A1OAYCTN;
        "pkg-1.0.4" = _6eO5TibS;
        "pkg-1.0.55" = _YgoNDybE;
        "pkg-1.0.7" = _a0F09HQq;
        "pkg-1.0.9" = _kiB8wcE3;
        "pkg-1.0.96" = _6EtJyKd5;
        "pkg-1.1.0" = _9DkvZhbg;
        "pkg-1.1.05" = _vUm2HKag;
        "pkg-1.1.1" = _F4eUr4JG;
        "pkg-1.1.15" = _tKCu3LTf;
        "pkg-1.1.16" = _zl4mTvkO;
        "pkg-1.1.2" = _zKb7lm71;
        "pkg-1.1.26" = _gHHGJTLD;
        "pkg-1.1.27" = _LnxQFOdo;
        "pkg-1.1.29" = _jv4uEVPi;
        "pkg-1.1.3" = _NeWpv7ov;
        "pkg-1.1.31" = _EKmSuS9E;
        "pkg-1.1.4" = _WreIPc73;
        "pkg-1.1.41" = _Te9yxT01;
        "pkg-1.1.5" = _T25aoaHy;
        "default" = _T25aoaHy;
    });
