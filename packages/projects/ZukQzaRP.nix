...
let
    ...
    in {
        ...
        "pkg-1.1.4" = _eXhzjrJL;
        "pkg-1.1.5" = _1dNAl9cn;
        "pkg-FC1.1.9" = _2JdL5jLQ;
        "pkg-FC1.2.0" = _fZwXkZuQ;
        "pkg-FG1.2.0" = _EJu0VuJg;
        "pkg-FC1.2.0-1.16" = _iJltMonl;
        "pkg-FC1.2.1" = _AiGJEyRZ;
        "pkg-FG1.2.1-1.12.2" = _O0yjj2pa;
        "pkg-FG1.2.1+1.17.x" = _hnRgiJxg;
        "pkg-FG1.2.2+1.17.x" = _ViRfd7dX;
        "pkg-FC1.2.2+1.17.x" = _L2lMyX5i;
        "pkg-FG1.2.3-1.12.2" = _TaD9iJ3x;
        "pkg-FG1.2.3-1.16.5" = _eU9iYyKL;
        "pkg-FC1.2.3-1.16.5" = _bVxgFBtx;
        "pkg-FG-1.2.3-1.17.x" = _wtOKTD6j;
        "pkg-FC1.2.3-1.17.x" = _ZDL6TJc5;
        "pkg-FC-1.2.4-1.16.5" = _3FOCCdVZ;
        "pkg-FG-1.2.4-1.17.1" = _u06ccZW8;
        "pkg-FC-1.2.4-1.17.1" = _dIckl99i;
        "pkg-FG-1.2.4-1.16.5" = _MQxQ5c5S;
        "pkg-FC-1.2.5-1.16.5" = _QUcOQS6W;
        "pkg-FG-1.2.5-1.16.5" = _2uc72P9O;
        "pkg-FC-1.2.5-1.17.1" = _cM1foJAY;
        "pkg-FG-1.2.5-1.17" = _ifogVI3g;
        "pkg-FC-1.2.6-1.18" = _tA6ArTX7;
        "pkg-1.2.8+1.18.1" = _ZeD2mHnc;
        "pkg-1.2.9+1.18.1" = _7fTEvjFG;
        "pkg-1.2.9+112" = _NgFLTGtX;
        "pkg-1.3.0+118-fabric" = _otnNULko;
        "pkg-1.3.0+118-forge" = _ZXYjkUXo;
        "pkg-1.3.0+116-fabric" = _yYhAigH9;
        "pkg-1.3.0+116-forge" = _wgEN8jli;
        "pkg-1.3.0+112" = _UMc7oY6w;
        "pkg-1.3.1+116-fabric" = _VKDu1avR;
        "pkg-1.3.1+116-forge" = _rgZSeQYp;
        "pkg-1.3.2+116-fabric" = _TCJuDbPG;
        "pkg-1.3.2+116-forge" = _9eKsFP8C;
        "pkg-1.3.1+118-fabric" = _Ku3YFU7G;
        "pkg-1.3.1+118-forge" = _UJGp4ytv;
        "pkg-1.4.0+119-fabric" = _wPkVhCZx;
        "pkg-1.4.0+119-forge" = _RLHG3ytY;
        "pkg-1.4.1+119-fabric" = _4NVtmkC7;
        "pkg-1.4.1+119-forge" = _myBRuQBP;
        "pkg-1.4.2+119-fabric" = _BKBxSlUB;
        "pkg-1.4.2+119-forge" = _hBVSIoun;
        "pkg-1.4.3+119-fabric" = _2HcE3K6L;
        "pkg-1.4.3+119-forge" = _9OZXdtFu;
        "pkg-1.4.4+119-fabric" = _CJvX55tl;
        "pkg-1.4.4+119-forge" = _xsZF3X6p;
        "pkg-1.5.0+119-fabric" = _J5bWY9eX;
        "pkg-1.5.0+119-forge" = _9pZDzav1;
        "pkg-1.5.1+119-fabric" = _lJ13G1rX;
        "pkg-1.5.1+119-forge" = _vIvzysSG;
        "pkg-1.5.2+119-fabric" = _bRLBPJVL;
        "pkg-1.5.2+119-forge" = _Mp8gV2JV;
        "pkg-1.5.2+118-fabric" = _PXDUCFY5;
        "pkg-1.5.2+118-forge" = _aXx6MTft;
        "pkg-1.5.3+1.19.2-fabric" = _cQHdtWZ3;
        "pkg-1.5.3+1.19.2-quilt" = _13tDoMea;
        "pkg-1.5.3+1.19.2-forge" = _34u8xS56;
        "pkg-1.5.3+1.19-fabric" = _qRrU0rP1;
        "pkg-1.5.3+1.19-quilt" = _KPsr2Whx;
        "pkg-1.5.3+1.19-forge" = _XdaK3NkD;
        "pkg-1.5.3+1.18.2-fabric" = _Q50cwsPN;
        "pkg-1.5.3+1.18.2-quilt" = _an1RRagm;
        "pkg-1.5.3+1.18.2-forge" = _kU8KO1Qq;
        "pkg-1.5.3+1.18.1-fabric" = _EdpGtItA;
        "pkg-1.5.3+1.18.1-forge" = _vU7e375W;
        "pkg-1.5.3+1.17.1-fabric" = _X90I7jHY;
        "pkg-1.5.3+1.17.1-forge" = _wKukNV0r;
        "pkg-1.5.3+1+1.17.1-fabric" = _DklZxkIz;
        "pkg-1.5.3+1+1.17.1-forge" = _kziYi8e3;
        "pkg-1.5.3+1.16.5-fabric" = _lyMaboz1;
        "pkg-1.5.3+1.16.5-forge" = _lMOxHgiR;
        "pkg-1.5.3+2+1.17.1-fabric" = _w0do9SH9;
        "pkg-1.5.3+2+1.17.1-forge" = _MonwH8es;
        "pkg-1.5.3+1+1.19-fabric" = _cjCYPJr4;
        "pkg-1.5.3+1+1.19-quilt" = _Ek5jkeUM;
        "pkg-1.5.3+1+1.19-forge" = _ISZoD6W7;
        "pkg-1.5.3+1+1.19.2-fabric" = _xGQGC3tK;
        "pkg-1.5.3+1+1.19.2-quilt" = _cVXReUha;
        "pkg-1.5.3+1+1.19.2-forge" = _SJPTf1Vq;
        "pkg-1.5.3+1+1.18.2-fabric" = _zOVRlmMe;
        "pkg-1.5.3+1+1.18.2-quilt" = _Tw4ojDmX;
        "pkg-1.5.3+1+1.18.2-forge" = _sKysSQY9;
        "pkg-1.5.3+2+1.18.2-fabric" = _jZhy49mv;
        "pkg-1.5.3+2+1.18.2-quilt" = _njhTIoE4;
        "pkg-1.5.3+2+1.18.2-forge" = _q6CkOUE3;
        "pkg-1.5.3+1+1.19.3-fabric" = _FuBfX17i;
        "pkg-1.5.3+1+1.19.3-quilt" = _gVeXl4Cs;
        "pkg-1.5.3+1+1.19.3-forge" = _BGcUMoQE;
        "pkg-1.5.3+2+1.19-fabric" = _i0FJhI8s;
        "pkg-1.5.3+2+1.19-quilt" = _YgZXfqRb;
        "pkg-1.5.3+2+1.19-forge" = _v32kPFzN;
        "pkg-1.5.4+1.19.3-fabric" = _2QlxINpr;
        "pkg-1.5.4+1.19.3-quilt" = _wKJAG9Qs;
        "pkg-1.5.4+1.19.3-forge" = _KJ9zByDW;
        "pkg-1.5.4+1.19.2-fabric" = _KsIh68In;
        "pkg-1.5.4+1.19.2-quilt" = _lX4PYNMz;
        "pkg-1.5.4+1.19.2-forge" = _hqGrjVsj;
        "pkg-1.5.4+1.19-fabric" = _nl4ROHKc;
        "pkg-1.5.4+1.19-quilt" = _YYsJ359t;
        "pkg-1.5.4+1.19-forge" = _aXhIFsnu;
        "pkg-1.5.4+1.18.2-fabric" = _gJF4QsVN;
        "pkg-1.5.4+1.18.2-quilt" = _HeGR23vd;
        "pkg-1.5.4+1.18.2-forge" = _gRNO6BoR;
        "pkg-1.5.4+1.18.1-fabric" = _Wg8XHQtJ;
        "pkg-1.5.4+1.18.1-forge" = _KDl7Ym2A;
        "pkg-1.5.4+1.17.1-fabric" = _OjuII4Kp;
        "pkg-1.5.4+1.17.1-forge" = _5Jnf4Cv6;
        "pkg-1.5.4+1.16.5-fabric" = _Z6sc2HMV;
        "pkg-1.5.4+1.16.5-forge" = _wOqX2GvZ;
        "pkg-1.5.4+1+1.16.5-fabric" = _L4Sf180n;
        "pkg-1.5.4+1+1.16.5-forge" = _es46zN9m;
        "pkg-1.5.5+1.19.3-fabric" = _DUGXCwDs;
        "pkg-1.5.5+1.19.3-quilt" = _RvCMkHCR;
        "pkg-1.5.5+1.19.3-forge" = _zKgYayDY;
        "pkg-1.5.6+1.19.4-fabric" = _6ckNO0wS;
        "pkg-1.5.6+1.19.4-quilt" = _7Qrh7kBl;
        "pkg-1.5.6+1.19.4-forge" = _LRA2xuL0;
        "pkg-1.5.6+1.20-fabric" = _Ko02VKMU;
        "pkg-1.5.6+1.20-quilt" = _JFIEeywl;
        "pkg-1.5.6+1.20-forge" = _HlHkmlnf;
        "pkg-1.5.7+1.20-fabric" = _XCpWI4wm;
        "pkg-1.5.7+1.20-quilt" = _H3MYRikF;
        "pkg-1.5.7+1.20-forge" = _OPcqrPWA;
        "pkg-1.5.7+1.19.4-fabric" = _pRj09zWP;
        "pkg-1.5.7+1.19.4-quilt" = _xM9ka5hX;
        "pkg-1.5.7+1.19.4-forge" = _Pwcmq2Zb;
        "pkg-1.5.8+1.20-fabric" = _sdJqKnFE;
        "pkg-1.5.8+1.20-quilt" = _6pEyD8Ri;
        "pkg-1.5.8+1.20-forge" = _9NFQeYoG;
        "pkg-1.5.8+1.19.4-fabric" = _XMt81tvf;
        "pkg-1.5.8+1.19.4-quilt" = _o412LkCv;
        "pkg-1.5.8+1.19.4-forge" = _AMs98Dfl;
        "pkg-1.5.8+1.19.3-fabric" = _Mb84Evjh;
        "pkg-1.5.8+1.19.3-quilt" = _DC2CQ2Hs;
        "pkg-1.5.8+1.19.3-forge" = _J8azN5Vj;
        "pkg-1.5.8+1.19.2-fabric" = _yTqPhklh;
        "pkg-1.5.8+1.19.2-quilt" = _FtaFO0QF;
        "pkg-1.5.8+1.19.2-forge" = _3FrFmwNZ;
        "pkg-1.5.8+1.18.1-fabric" = _XeRZdioU;
        "pkg-1.5.8+1.18.1-forge" = _RZpSZOPK;
        "pkg-1.5.8+1.18.2-fabric" = _W8TUqXbM;
        "pkg-1.5.8+1.18.2-quilt" = _CJGzc7m6;
        "pkg-1.5.8+1.18.2-forge" = _7muyZ2k9;
        "default" = _7muyZ2k9;
    });
