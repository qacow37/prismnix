...
let
    ...
    in {
        ...
        "pkg-1.0.0-fabric-1.21.5-0.128.2" = _Ydd6Zw8c;
        "pkg-1.0.0-fabric-1.21.8-0.136.1" = _j8HHuo8e;
        "pkg-1.0.0-fabric-1.21.10-0.138.4" = _dqGowl9G;
        "pkg-1.0.0-fabric-1.21.11-0.141.3" = _7yzxLk1p;
        "pkg-1.0.0-neoforge-1.21.1-21.1.219" = _WPVd2uIj;
        "pkg-1.0.0-neoforge-1.21.4-21.4.156" = _WQZ3WV2g;
        "pkg-1.0.0-neoforge-1.21.5-21.5.96" = _z1GdmvOo;
        "pkg-1.0.0-neoforge-1.21.8-21.8.52" = _eVMvwMkV;
        "pkg-1.0.0-neoforge-1.21.10-21.10.64" = _vmdHclSX;
        "pkg-1.0.0-neoforge-1.21.11-21.11.38" = _bXy1IaWI;
        "pkg-1.0.0-forge-1.20.1-47.4.10" = _IYaa8QmZ;
        "pkg-1.0.0-forge-1.21.1-52.1.8" = _sGXuJX5A;
        "pkg-1.0.0-forge-1.21.4-54.1.11" = _2kOjtq85;
        "pkg-1.0.0-forge-1.21.5-55.1.4" = _DetE9Zil;
        "pkg-1.0.0-forge-1.21.8-58.1.11" = _qPPMM28g;
        "pkg-1.0.0-forge-1.21.10-60.1.0" = _jUaslFwH;
        "pkg-1.0.0-forge-1.21.11-61.1.1" = _iH4lANV2;
        "pkg-1.0.0-forge-1.18.2-40.3.12" = _ZvWSpbVE;
        "pkg-1.0.1-fabric-26.1.1-0.145.3" = _dLeZNJTp;
        "pkg-1.0.1-forge-26.1.1-63.0.0" = _8E1NEAQg;
        "pkg-1.0.1-neoforge-26.1.1.1" = _LqgV8Wt3;
