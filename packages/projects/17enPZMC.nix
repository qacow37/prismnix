...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _5TkuKRc7;
        "pkg-1.18.2-2.0-fabric" = _Lemq8ZHl;
        "pkg-1.19.2-2.2-fabric" = _CinMoWjc;
        "pkg-1.16.5-1.4-forge" = _ulcRzAeu;
        "pkg-1.18.2-1.6-forge" = _hE6t59cX;
        "pkg-1.19.2-1.9-forge" = _8UDYNRvx;
        "pkg-1.16.5-3.0-fabric" = _nOBm0QPo;
        "pkg-1.18.2-3.0-fabric" = _lNjslykb;
        "pkg-1.19.2-3.0-fabric" = _8bVT2UUd;
        "pkg-1.16.5-3.0-forge" = _AEVA6FZz;
        "pkg-1.18.2-3.0-forge" = _gw74CKpC;
        "pkg-1.19.2-3.0-forge" = _Ynpzd8cy;
        "pkg-1.16.5-3.1-fabric" = _7hXt5Xxk;
        "pkg-1.18.2-3.1-fabric" = _ezFDDibS;
        "pkg-1.19.2-3.1-fabric" = _DZlyKOIj;
        "pkg-1.16.5-3.2-fabric" = _lpFPrKRR;
        "pkg-1.18.2-3.2-fabric" = _QYWCf2Zw;
        "pkg-1.19.2-3.2-fabric" = _21dvCivH;
        "pkg-1.16.5-3.2-forge" = _yCC75ai9;
        "pkg-1.18.2-3.2-forge" = _o11WJFaQ;
        "pkg-1.19.2-3.2-forge" = _TRkOlpC7;
        "pkg-1.16.5-3.3-fabric" = _SyQ8H0Kd;
        "pkg-1.18.2-3.3-fabric" = _d39F2p0e;
        "pkg-1.19.2-3.3-fabric" = _keogdhHc;
        "pkg-1.16.5-3.3-forge" = _mHa2AQ3i;
        "pkg-1.18.2-3.3-forge" = _143H8per;
        "pkg-1.19.2-3.3-forge" = _ImgMJ4uh;
        "pkg-1.19.3-3.4-fabric" = _dZx988RJ;
        "pkg-1.19.3-3.3-forge" = _YaigZlT4;
        "pkg-1.18.2-4.0-forge+fabric" = _RULpUT2c;
        "pkg-1.19.2-4.0-forge+fabric" = _tuKR1XQd;
        "pkg-1.19.3-4.0-forge+fabric" = _ROY3JGqM;
        "pkg-1.18.2-4.1-forge+fabric" = _jkmb2bWu;
        "pkg-1.19.2-4.1-forge+fabric" = _iGwZsnoU;
        "pkg-1.19.3-4.1-forge+fabric" = _mvy0Dj7e;
        "pkg-1.19.4-4.1-forge+fabric" = _zxqzGtCP;
        "pkg-1.20-4.1-forge+fabric" = _O4jeCwJU;
        "pkg-1.20.1-4.1-forge+fabric" = _WqfPFQ6y;
        "pkg-1.20.2-4.1-forge+fabric" = _rHqhRQko;
        "pkg-1.18.2-4.3-forge+fabric" = _9iBYvz7d;
        "pkg-1.19.2-4.3-forge+fabric" = _Y0ekYUTb;
        "pkg-1.20.1-4.3-forge+fabric" = _QdCsYK9I;
        "pkg-1.20.2-4.3-forge+fabric" = _cMlKPjHu;
        "pkg-1.18.2-4.4-forge+fabric" = _RjlbHmHt;
        "pkg-1.19.2-4.4-forge+fabric" = _vfDyWNZR;
        "pkg-1.20.1-4.4-forge+fabric" = _EQFJ88l4;
        "pkg-1.20.2-4.4-forge+fabric" = _ZkIJKmEm;
        "pkg-1.20.3-4.4-fabric+forge+neo" = _HYdNOmn3;
        "pkg-1.20.4-4.4-fabric+forge+neo" = _FAYrvJBn;
        "pkg-1.19.2-4.5-fabric+forge+neo" = _5Vr4aC6c;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _1pBsAsHD;
        "pkg-1.20.2-4.5-fabric+forge+neo" = _is4rc000;
        "pkg-1.20.4-4.5-fabric+forge+neo" = _ZwU0WePW;
        "pkg-1.20.5-4.5-fabric+neo" = _PwnVvdD1;
        "pkg-1.20.6-4.5-fabric+forge+neo" = _4jcLQYvO;
        "pkg-1.21.0-4.5-fabric+forge+neo" = _XHy1p5yf;
        "pkg-1.20.1-4.6-fabric+forge+neo" = _OLGhPSDQ;
        "pkg-1.20.6-4.6-fabric+forge+neo" = _DNgl7Z17;
        "pkg-1.21.0-4.6-fabric+forge+neo" = _IojTiJc8;
        "pkg-1.21.1-4.6-fabric+forge+neo" = _Ld1hAn0a;
        "pkg-1.21.2-4.6-fabric+neo" = _RNfFlQFy;
        "pkg-1.21.3-4.6-fabric+forge+neo" = _eUfPiN0i;
        "pkg-1.21.4-4.6-fabric+forge+neo" = _aMRLgaaY;
        "pkg-1.20.1-4.7-fabric+forge+neo" = _ZdKX4Iko;
        "pkg-1.21.1-4.7-fabric+forge+neo" = _XnVod4i3;
        "pkg-1.21.4-4.7-fabric+forge+neo" = _cCFg8dqt;
        "pkg-1.21.5-4.7-fabric+forge+neo" = _xeDUELIS;
        "pkg-1.21.6-4.7-fabric+forge+neo" = _d5wWH0cE;
        "pkg-1.21.7-4.7-fabric+forge+neo" = _lZoPVRfl;
        "pkg-1.21.8-4.7-fabric+forge+neo" = _V8p1ZJM2;
        "pkg-1.21.9-4.7-fabric+forge+neo" = _z3MDnqKJ;
        "pkg-1.21.10-4.7-fabric+forge+neo" = _MyEUsR5C;
        "pkg-1.21.11-4.7-fabric+forge+neo" = _xncSYvvy;
        "pkg-26.1.0-4.7-fabric+forge+neo" = _8UeYqUFi;
        "pkg-26.1.1-4.7-fabric+forge+neo" = _uXVuMQdK;
        "pkg-26.1.2-4.7-fabric+forge+neo" = _GahMS1La;
        "pkg-26.2.0-4.7-fabric+forge+neo" = _UwlUPD3C;
        "default" = _UwlUPD3C;
    });
