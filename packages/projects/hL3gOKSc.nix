...
let
    ...
    in {
        ...
        "pkg-2.2.2" = _yPnaXmC6;
        "pkg-3.0.0" = _MOuOXiix;
        "pkg-4.0.0+1.21.6-7" = _ze4JiTd9;
        "pkg-4.1.0+1.21.8" = _YntJveOV;
        "pkg-4.2.0+1.21.10" = _FsujzRmt;
        "pkg-5.0.0+1.21.5" = _NKmIUXK1;
        "pkg-5.0.0+1.21.6" = _nhDO5IlG;
        "pkg-5.0.0+1.21.11" = _S7wOLlfw;
        "pkg-5.0.0+1.21.9" = _TQzNCujU;
        "pkg-5.0.1+1.21.5" = _ADTLShby;
        "pkg-5.0.1+1.21.6" = _VcT8S1w1;
        "pkg-5.0.1+1.21.9" = _F1ykqnwY;
        "pkg-5.0.1+1.21.11" = _FnAhIMv7;
        "pkg-5.0.2+1.21.5" = _hf8LcZ2L;
        "pkg-5.0.2+1.21.6" = _IocKgDpm;
        "pkg-5.0.2+1.21.9" = _3kzk6F8w;
        "pkg-5.0.2+1.21.11" = _wVmanArm;
        "default" = _wVmanArm;
    });
