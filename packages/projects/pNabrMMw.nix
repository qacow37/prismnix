...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha.671298347" = _vyJyPHDK;
        "pkg-1.0.0-alpha.671304988" = _sj7qjneT;
        "pkg-1.0.0-alpha.671322708" = _m6wijQmC;
        "pkg-1.0.0-alpha.702763198" = _mISL32Pc;
        "pkg-1.0.0-alpha.704569004" = _p8zv59ZX;
        "pkg-1.0.0-alpha.705096240" = _Tg0RT8RA;
        "pkg-1.0.0-alpha.707557927" = _DnzuJVDN;
        "pkg-1.0.0-alpha.707903004" = _Ot2HYfaI;
        "pkg-1.0.0-alpha.708851489" = _tMkw0pu3;
        "pkg-1.0.0-alpha.718488862" = _TMspHv99;
        "pkg-1.0.0-alpha.719185266" = _H9Hka2nC;
        "pkg-1.0.0-beta" = _9sF1Ajrd;
        "pkg-1.0.1-beta.5" = _cqNmwmst;
        "pkg-1.0.2-beta" = _Avj9K3Bt;
        "pkg-1.0.3-beta" = _8unmUuX2;
        "pkg-1.0.3-beta.1" = _VwEcUZvD;
        "pkg-1.0.4-beta" = _2sjx3wuL;
        "pkg-1.0.4-beta.1" = _KenyaL4j;
        "pkg-1.0.5-beta" = _2K24uoqc;
        "pkg-1.0.6-beta" = _BVRaTnXB;
        "pkg-1.0.7-beta" = _bzTGsgWt;
        "pkg-1.0.7-beta.1" = _qRyZ0ZOc;
        "pkg-1.0.8-beta" = _OIC0zZEm;
        "pkg-1.0.8-release" = _QNXtzsj8;
        "pkg-1.1.0-beta" = _w4EzwEPk;
        "pkg-1.1.0-beta.1" = _jZg7Y7y7;
        "pkg-1.0.9-release" = _lWWTGoWM;
        "pkg-1.1.1-beta" = _xQauZVfu;
        "pkg-1.1.1-beta.1" = _bknXEYvi;
        "pkg-1.1.2-release.2" = _O3COYvcO;
        "pkg-1.1.3-release" = _N9uLkyrJ;
        "pkg-1.1.4-release" = _fBW3f9ux;
        "pkg-1.1.5-release" = _KXpwVCrT;
        "pkg-1.2.1-beta" = _ylcd30PA;
        "pkg-1.2.2-beta" = _EtyXQGT4;
        "pkg-1.2.3-beta" = _XXSZgMzN;
        "pkg-1.2.3-beta.1" = _40bAsH3r;
        "pkg-1.2.3-beta.2" = _hEfXCSwc;
        "pkg-1.2.3-beta.3" = _QpJFKmDr;
        "pkg-1.2.3-beta.4" = _pazwzh5a;
        "pkg-1.2.3-beta.5" = _5nLI9qJX;
        "pkg-1.2.3-beta.6" = _7tysZBvW;
        "pkg-1.2.4-alpha" = _n25At5yy;
        "pkg-1.2.4-alpha.1" = _OpSZBt6z;
        "pkg-1.2.4-beta" = _sR8vDIPF;
        "pkg-1.2.4-beta.1" = _tBaq4l9g;
        "pkg-9.0.0-alpha.1" = _mwpALUYx;
        "pkg-1.2.4-release" = _4iy8QhEp;
        "pkg-9.0.0-alpha.2" = _YygF33pg;
        "pkg-9.0.0-alpha.3" = _UZut0YSe;
        "pkg-9.0.0-alpha.4" = _zMhm59oh;
        "pkg-9.0.0-beta.1" = _LC4JXbFT;
        "pkg-9.0.0-beta.2" = _BP58796S;
        "pkg-9.0.0-beta.3" = _7rmq3AKS;
        "pkg-9.0.0-beta.4" = _OXKqs0sl;
        "pkg-9.0.0-beta.5" = _gIl76SAk;
        "pkg-9.0.0-beta.6" = _CbiGdUTF;
        "pkg-9.0.0-beta.7" = _tyo9ICzd;
        "pkg-1.2.5-release" = _ocpk1olH;
        "pkg-9.0.0-beta.8" = _kZN9IHum;
        "pkg-10.0.0-alpha.1" = _j1VAQ9Br;
        "pkg-10.0.0-alpha.2" = _waPR5x3H;
        "pkg-10.0.0-alpha.3" = _YrwbDw4A;
        "pkg-10.0.0-alpha.4" = _8s6EwAaK;
        "pkg-10.0.0-alpha.5" = _8F7TMsfb;
        "pkg-10.0.0-alpha.6" = _h3KEwFsM;
        "pkg-10.0.0-alpha.7" = _Dk0Q4ihL;
        "pkg-10.0.0-alpha.8" = _uzAjswEM;
        "pkg-10.0.0-alpha.9" = _hB1LqgM9;
        "pkg-10.0.0-alpha.10" = _dU3GNbuo;
        "pkg-9.0.0-beta.9" = _uUVK3ITc;
        "pkg-1.2.6-release" = _sf1mHLqO;
        "pkg-10.0.0-beta.3" = _31o5U4Ht;
        "pkg-10.0.0-beta.4" = _Kmqv8rof;
        "pkg-10.0.0-beta.5" = _tL9JjD5j;
        "pkg-10.0.0-release" = _teLn4nlK;
        "pkg-10.0.1-release" = _rl4lr7nL;
        "pkg-10.1.0-beta.1" = _T0NpNq0x;
        "pkg-10.1.1-beta.1-forge" = _5wfOuIHt;
        "pkg-10.1.1-beta.2-fabric" = _o5tBJHYM;
        "pkg-10.1.1-beta.2-forge" = _kdSeNOuX;
        "pkg-10.1.1-beta.3-fabric" = _HDgfhJXK;
        "pkg-10.1.1-beta.3-forge" = _CQIHOtAE;
        "pkg-10.1.1-beta.4-fabric" = _BLMnMKlj;
        "pkg-10.1.1-beta.4-forge" = _krEBgelR;
        "pkg-10.1.1-beta.5-fabric" = _b1aFm6Lj;
        "pkg-10.1.1-beta.5-forge" = _5w1drTMc;
        "pkg-10.1.1-beta.6-fabric" = _wrI2tpzF;
        "pkg-10.1.1-beta.6-forge" = _wyXCsHc6;
        "pkg-11.0.0-alpha.1-fabric" = _wCWVWUyw;
        "pkg-11.0.0-alpha.1-forge" = _ckFyrQPP;
        "pkg-11.0.0-alpha.2-forge" = _9gnsdalj;
        "pkg-11.0.0-alpha.2-fabric" = _9d82624y;
        "pkg-11.0.0-beta.1-fabric" = _Q2LoPpKh;
        "pkg-11.0.0-beta.1-forge" = _l0MFQAsb;
        "pkg-11.0.0-forge" = _LGZn3kd8;
        "pkg-11.0.0-fabric" = _iZLzFd8j;
        "pkg-11.0.1-forge" = _HCUKUb5W;
        "pkg-11.0.1-fabric" = _uMnxfT7w;
        "pkg-11.1.0-forge" = _UZ0HVbBd;
        "pkg-11.1.0-fabric" = _kHIV8fRz;
        "pkg-11.1.1-fabric" = _JAkNTbad;
        "pkg-11.1.1-forge" = _Hmpl05o8;
        "pkg-11.1.2-fabric" = _jajB2nmy;
        "pkg-11.1.2-forge" = _bhEb7csP;
        "pkg-11.1.3-forge" = _4OzPD5Ek;
        "pkg-11.1.3-fabric" = _pLueSR68;
        "pkg-12.0.0-alpha-fabric" = _pwv7FA5t;
        "pkg-12.0.1-alpha-fabric" = _nbSCbRFS;
        "pkg-11.1.4-forge" = _BasoSPTq;
        "pkg-11.1.4-fabric" = _6qVA8kLw;
        "pkg-12.0.2-alpha-fabric" = _zG3Xrh8H;
        "pkg-12.1.0-beta-fabric" = _embDUtpG;
        "pkg-12.1.0-beta-forge" = _90Rg6guI;
        "pkg-11.1.5-forge" = _2RTcxvsm;
        "pkg-11.1.5-fabric" = _1tMU3DD3;
        "pkg-12.2.0-beta-fabric" = _RbhH11u6;
        "pkg-12.2.0-beta-forge" = _HatZK3qc;
        "pkg-12.5.1-beta-fabric" = _vVBFWDVa;
        "pkg-12.5.1-beta-forge" = _Nx6twYAD;
        "pkg-12.7.0-fabric" = _mGtj8AME;
        "pkg-12.7.0-forge" = _Ni6Gq5YU;
        "pkg-11.5.0-forge" = _YbrETenQ;
        "pkg-11.5.0-fabric" = _9mlDbLqG;
        "pkg-12.8.0-beta-forge" = _BBDCISrw;
        "pkg-12.8.3-beta-fabric" = _FDsNdQmF;
        "pkg-12.8.3-beta-forge" = _C7AGReqG;
        "pkg-12.8.4-beta-fabric" = _SsCru80f;
        "pkg-12.8.4-beta-forge" = _FpAIpNhx;
        "pkg-12.8.4-fabric" = _uSTNPmOl;
        "pkg-12.8.4-forge" = _VOVugdFz;
        "pkg-11.6.3-forge" = _Dd1XwvRa;
        "pkg-11.6.3-fabric" = _49dSdqdP;
        "pkg-12.8.5-fabric" = _UtqbMyTo;
        "pkg-12.8.5-forge" = _BiKPJ2ts;
        "pkg-13.0.6-beta-fabric" = _h1Yon34K;
        "pkg-13.0.9-beta-forge" = _xIFoRj8O;
        "pkg-12.8.6-forge" = _SZxOOMuM;
        "pkg-12.8.7-forge" = _MbCvODnJ;
        "pkg-12.9.5-forge" = _1SxbwPwD;
        "pkg-12.9.5-fabric" = _Tj7dqeEY;
        "pkg-15.0.1-beta-fabric" = _WTEwHwE4;
        "pkg-15.0.1-betag-forge" = _bInEuaKb;
        "pkg-12.9.6-forge" = _E2Amespn;
        "pkg-15.0.5-beta-forge" = _enYmjkkQ;
        "pkg-12.9.7-forge" = _Sk6tHeLM;
        "pkg-15.0.6-beta-forge" = _WVILPm6N;
        "pkg-15.0.11-forge" = _nMHhVPtn;
        "pkg-15.0.12-forge" = _JZrkQwCl;
        "pkg-15.1.0-fabric" = _TW3EIXLT;
        "pkg-15.1.0-forge" = _7mbd8Nwp;
        "pkg-15.1.1-forge" = _ND7Doo53;
        "pkg-15.1.2-forge" = _w1GB1xmb;
        "pkg-15.1.2-fabric" = _h6WBCQhW;
        "pkg-12.9.8-fabric" = _1LeD12ov;
        "pkg-15.1.3-forge" = _jUxvSF8N;
        "pkg-15.1.3-fabric" = _rMyyj2Oc;
        "pkg-15.1.4-forge" = _iTkIRxmP;
        "pkg-15.1.5-forge" = _Nlioq7vh;
        "pkg-15.1.5-fabric" = _fjGKTjps;
        "pkg-15.2.1-fabric" = _QewbGM3G;
        "pkg-15.2.1-forge" = _IVO9rSRJ;
        "pkg-17.2.0-beta" = _6VxDDjI8;
        "pkg-17.4.0-beta" = _ukUfNVnP;
        "pkg-17.6.1-beta" = _eWaoM56R;
        "pkg-17.6.2-beta" = _y36OhUeu;
        "pkg-17.6.3-beta" = _TTYdWAzq;
        "pkg-15.2.2-forge" = _7xD9lbep;
        "pkg-17.10.4-beta" = _bU2ZuiTb;
        "pkg-17.10.5-beta" = _i1TMFCx7;
        "pkg-17.12.0-beta" = _bGX9IPwl;
        "pkg-15.2.3-forge" = _O1Gg7y6z;
        "pkg-18.1.1-beta" = _dFrAglWg;
        "pkg-18.1.3-beta" = _dnyBkAUG;
        "pkg-18.1.4-beta" = _bePqAqEm;
        "pkg-19.0.2-beta" = _rcOysgXy;
        "pkg-19.0.3-beta" = _Nlta104R;
        "pkg-19.0.4-beta" = _qnd7jQwn;
        "pkg-19.0.7-alpha" = _jqaoHVCd;
        "pkg-19.0.8-alpha" = _5aGxD5ej;
        "pkg-19.0.10-beta" = _WyPbb8sE;
        "pkg-19.1.1-beta" = _UZGdx48C;
        "pkg-19.1.2-beta" = _We2xv9CM;
        "pkg-19.1.3-beta" = _7TWWccrb;
        "pkg-19.1.4-beta" = _tL5vZeFg;
        "pkg-19.1.5-beta" = _5c5Tws4t;
        "pkg-19.1.6-beta" = _sByIMks5;
        "pkg-19.1.7" = _X1bhyEw4;
        "pkg-19.1.8" = _9flqVkeD;
        "pkg-19.2.0" = _6feJ9h09;
        "pkg-19.2.1" = _l8n1d6bQ;
        "pkg-19.2.2" = _LhLD7BZk;
        "pkg-19.2.3" = _QkqFSZTz;
        "pkg-19.2.4" = _ypYwh16p;
        "pkg-19.2.5" = _UOlbVk0Q;
        "pkg-19.2.6" = _IQFaf9vp;
        "pkg-15.3.0-forge" = _Gy5UgOq4;
        "pkg-15.3.1-forge" = _BLQZoB0F;
        "pkg-19.3.0" = _jJ2svSk6;
        "pkg-15.3.3-forge" = _z8QXeyI0;
        "pkg-19.4.0" = _wutnk0In;
        "pkg-19.4.1" = _JZs5lgpV;
        "pkg-19.5.0" = _y9YgjcrO;
