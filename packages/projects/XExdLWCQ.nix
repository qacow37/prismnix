...
let
    ...
    in {
        ...
        "pkg-1.13.6" = _fWrVbGRN;
        "pkg-1.9.8" = _k34E6ifa;
        "pkg-1.12.8" = _xu8G2q6R;
        "pkg-1.14.0" = _4vbponXS;
        "pkg-1.15.0" = _LqsTdtjN;
        "pkg-1.16.0" = _pPNA03OJ;
        "pkg-1.16.1" = _S4NV6v0S;
        "pkg-1.16.2" = _QOGa3XRf;
        "pkg-1.16.3" = _JSbh9eTX;
        "pkg-1.17.0" = _qAoVgWPk;
        "pkg-1.17.1" = _Yx31lcKh;
        "pkg-1.17.2" = _yhKuOfB3;
        "pkg-1.18.0" = _vD5Tg5Jb;
        "pkg-1.18.1" = _ik9YyHbz;
        "pkg-1.19.0" = _YRSr7lb9;
        "pkg-1.20.0" = _WoaE6GzV;
        "pkg-1.20.1" = _dpWSk2aj;
        "pkg-1.20.2" = _C9QL3mln;
        "pkg-1.21.0" = _kBaNLp37;
        "pkg-1.21.1" = _wboQrdtH;
        "pkg-1.21.2" = _L3hOC6xW;
        "pkg-1.22.0" = _lrhbGGSe;
        "default" = _lrhbGGSe;
    });
