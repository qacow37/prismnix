...
let
    ...
    in {
        ...
        "pkg-119.5.4" = _iJ5c9wa9;
        "pkg-120.1.1" = _n6kAFrdC;
        "pkg-120.2.1" = _3vY54ykN;
        "pkg-120.3.1" = _X0ZrHvGZ;
        "pkg-120.4.2" = _QEvMsWl8;
        "pkg-120.5.2" = _Ib2RFaxl;
        "pkg-120.6.3" = _ydx3iUmR;
        "pkg-120.7.4" = _XomOc0FY;
        "pkg-120.8.4" = _sr09cDJG;
        "pkg-120.9.5" = _UoTN4ITM;
        "pkg-121.0.1" = _snKkHZK0;
        "pkg-121.1.2" = _XgvEmnWN;
        "pkg-121.2.3" = _AESCb1Z1;
        "pkg-121.3.3" = _aQgtEqic;
        "pkg-121.4.3" = _VVj9kyZt;
        "pkg-121.4.4" = _ClzG3eg2;
        "pkg-121.5.5" = _JB734rtC;
        "pkg-v121.6.6" = _DWgBRXhZ;
        "pkg-v121.7.6" = _oCFI6FpZ;
        "pkg-v121.7.7" = _GHMmS4Gs;
        "pkg-v121.7.8" = _WB4lEPqV;
        "pkg-v121.7.9" = _T7CwwQkV;
        "pkg-v121.7.10" = _BZGogsXF;
        "pkg-v121.7.11" = _7FpeuyyP;
        "pkg-v121.8.12" = _klduRZWr;
        "pkg-v121.9.13" = _ib9vZ1Um;
        "pkg-v121.10.14" = _HNXEYMkT;
        "pkg-v121.11.14" = _sc5KasFS;
        "pkg-v121.12.14" = _PuGa3dda;
        "pkg-v121.13.15" = _pX4vLLL0;
        "pkg-v121.14.15" = _GEEIm1XG;
        "pkg-v121.15.16" = _VuF8SY3w;
        "pkg-v121.16.16" = _mAIj1Wsx;
        "pkg-v121.17.17" = _stBF6M5b;
        "pkg-v121.18.17" = _otdUr9w0;
        "pkg-v121.19.18" = _4s2gASeb;
        "pkg-v121.20.19" = _ke79xpmh;
        "pkg-v121.21.19" = _KVA5xqV3;
        "pkg-v121.22.20" = _LA3Mvsnb;
        "pkg-v121.23.21" = _FIYKNgFF;
        "pkg-v121.24.22" = _KmOoTkWU;
        "pkg-v121.25.22" = _7Ua4ifb1;
        "pkg-v261.1" = _ejYuh29Z;
        "pkg-v261.2" = _D4SuMrC2;
        "pkg-v261.3" = _Fk8MX8j8;
        "default" = _Fk8MX8j8;
    });
