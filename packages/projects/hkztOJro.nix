...
let
    ...
    in {
        ...
        "pkg-1.19.2-2.2.0" = _sD6czVqk;
        "pkg-1.16.5-2.0.1" = _Yq4WcCEj;
        "pkg-1.17.1-2.0.1" = _imn82PCi;
        "pkg-1.18.2-2.0.1" = _EEUbb5n0;
        "pkg-1.16.5-2.1.3" = _A9MyGw7o;
        "pkg-1.16.5-2.0.2" = _J3dvxxf1;
        "pkg-1.17.1-2.0.4" = _z7WkzHq8;
        "pkg-1.17.1-2.0.2" = _fewXTyAO;
        "pkg-1.18.2-2.1.3" = _wVqw7pR8;
        "pkg-1.18.2-2.0.2" = _QowTOsvR;
        "pkg-1.19.2-2.2.1" = _GxXQCO1R;
        "pkg-1.19.3-2.3.0" = _FU2GPgbX;
        "pkg-1.19.4-2.4.0" = _2MijguAv;
        "pkg-1.16.5-3.0.0" = _64JJhXjP;
        "pkg-1.17.1-3.0.0" = _UbFZHjAm;
        "pkg-1.18.2-3.0.0" = _kcJslfmh;
        "pkg-1.19.2-3.0.0" = _QBEzK4qH;
        "pkg-1.19.4-3.0.0" = _sQvYN895;
        "pkg-1.20.1-3.0.0" = _BxT50Qdi;
        "pkg-1.20.2-3.0.0" = _EICEG0aF;
        "pkg-1.21.1-3.0.0" = _kiGW1zIa;
        "pkg-1.21.1-3.0.1" = _Z2l6AP3F;
        "pkg-1.20.1-3.0.2" = _I19WnMQH;
        "pkg-1.21.1-3.0.2" = _Om0KPQcq;
