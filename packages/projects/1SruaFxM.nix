...
let
    ...
    in {
        ...
        "pkg-2.0.0" = _uFeDo72Y;
        "pkg-2.0.1" = _zH5IGHjE;
        "pkg-2.0.1+1.20.4" = _SI4yaOoc;
        "pkg-2.1.0+1.20.4" = _HJQzMP0C;
        "pkg-2.2.0+1.20.6" = _Ny5kAVLh;
        "pkg-2.2.1+1.20.4" = _z3GAClB3;
        "pkg-2.2.1+1.20.6" = _I0fTxOPF;
        "pkg-2.2.1+1.21" = _5U7yVAq9;
        "default" = _5U7yVAq9;
    });
