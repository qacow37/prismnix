...
let
    ...
    in {
        ...
        "pkg-1.0-pre-release-1.20.1" = _PQl95cGZ;
        "pkg-1.0-pre-release.2-1.20.1" = _uwrM4Amf;
        "pkg-1.0-pre-release-3-1.20.1-forge" = _znb4G4FZ;
        "pkg-1.0-pre-release-3-1.20.1-fabric" = _WS7q66JW;
        "pkg-Archery-1.0-1.20.1-fabric" = _vzB7Dhfk;
        "pkg-Archery-1.0-1.20.1-forge" = _uNZLMNYQ;
        "pkg-Archery-1.1-1.20.1-fabric" = _78SDIa8d;
        "pkg-Archery-1.1-1.20.1-forge" = _EtxzyRaZ;
        "pkg-1.2-1.20.1-fabric" = _EpgbZIql;
        "pkg-1.2-1.20.1-forge" = _InARYEau;
        "pkg-1.3-1.20.1-neoforge" = _AnwakGPG;
        "pkg-1.3-1.20.1-fabric" = _3sBwfDs3;
        "pkg-1.4-1.20.1-fabric" = _sJgRl60c;
        "pkg-1.4-1.20.1-neoforge" = _AWO5blaP;
        "pkg-1.5-1.20.1-neoforge" = _qMBiNClw;
        "pkg-1.5-1.20.1-fabric" = _9PH1jkc1;
        "pkg-1.6-1.20.1-fabric" = _JN8N1qIR;
        "pkg-1.6-1.20.1-neoforge" = _2dd7iKfx;
        "pkg-2.0-1.21-neoforge" = _sFzOrE8p;
        "pkg-2.0-1.21-fabric" = _zZyEOORX;
        "pkg-2.1-1.21-fabric" = _ZfkzzkVV;
        "pkg-2.1-1.21-neoforge" = _Qwgacods;
        "pkg-2.2-1.21-neoforge" = _SUC6tCiv;
        "pkg-2.2-1.21-fabric" = _5BIsC8Wj;
        "default" = _5BIsC8Wj;
    });
