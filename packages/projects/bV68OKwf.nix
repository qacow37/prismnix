...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.8-58.1.7" = _ib49PEqJ;
        "pkg-1.0.0-forge-1.21.10-60.0.15" = _KCmVD1Ul;
        "pkg-1.0.0-fabric-1.21.1-0.116.7" = _vNJ5OIrm;
        "pkg-1.0.0-neoforge-1.21.1-21.1.215" = _DNhkL2PL;
        "pkg-1.0.0-neoforge-1.21.4-21.4.155" = _yDywj2IB;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _OaGbPsrZ;
        "pkg-1.0.0-fabric-1.21.8-0.136.0" = _CLhBy0vZ;
        "pkg-1.0.0-neoforge-1.21.8-21.8.51" = _WsGLdoW8;
        "pkg-1.0.0-fabric-1.21.10-0.138.3" = _1eFWyjSs;
        "pkg-1.0.0-neoforge-1.21.10-21.10.52-" = _1xfH9ztP;
        "pkg-1.0.0-neoforge-1.21.11-21.10.52b" = _unmYfvYd;
        "pkg-1.0.0-fabric-1.21.11-0.140.0" = _ydKunokg;
        "pkg-1.0.0-forge-1.21.11-61.0.2" = _pWLH9w8s;
        "pkg-1.0.0-fabric-1.21.5-0.128.2" = _9glAu5lp;
        "pkg-1.0.0-fabric-1.20.1-0.92.7" = _ACCM3FnX;
        "pkg-1.0.0-fabric-26.1.1-0.145.4" = _HNhJ2x7p;
