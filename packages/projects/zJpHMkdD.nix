...
let
    ...
    in {
        ...
        "pkg-0.89-mc1.16.5-fabric" = _WUQOeLYw;
        "pkg-0.90-mc1.16.5-fabric" = _BpAGb0Rm;
        "pkg-v0.04-mc1.17-fabric" = _y14zmA6T;
        "pkg-v0.10-1.17" = _2nwwq6bV;
        "pkg-v0.17-1.17" = _OnKtyQhs;
        "pkg-v0.28-1.17" = _QBZhCYdN;
        "pkg-1.0.3-1.18" = _VrIcStfk;
        "pkg-1.0.4-1.18" = _U9Cb1VzA;
        "pkg-1.0.5-1.18" = _FT9QapHv;
        "pkg-1.0.6-1.18" = _LpvAVFot;
        "pkg-1.1.2-1.18.1" = _94hTMC62;
        "pkg-1.1.3-1.18.1" = _XiqQSPBV;
        "pkg-1.1.4-1.18.1" = _FQ9E3W6G;
        "pkg-1.1.5-1.18.1" = _lZWYTcAh;
        "pkg-1.1.6-1.18.1" = _g4zcgBLe;
        "pkg-1.1.7-1.18.1" = _1e2JzzZs;
        "pkg-1.1.8-1.18.1" = _PaIKWPKb;
        "pkg-1.1.9-1.18.1" = _dbKyYmzU;
        "pkg-1.2.0-1.18.1" = _dPN4o4rf;
        "pkg-1.2.1-1.18.1" = _4KjhiIl4;
        "pkg-1.2.2-1.18.1" = _nRayunWG;
        "pkg-1.2.3-1.18.1" = _EUB0NtcT;
        "pkg-1.2.4-1.18.1" = _gnb0gWQK;
        "pkg-1.2.5-1.18.1" = _AfIR1xZw;
        "pkg-1.2.6-1.18.1" = _oUGOJ8zR;
        "pkg-1.3.0-1.18.2" = _u8Oh4Gi5;
        "pkg-1.3.1-1.18.2" = _k0pZrwy9;
        "pkg-1.3.2-1.18.2" = _rOO3XUGu;
        "pkg-1.3.3-1.18.2" = _BTzO80c0;
        "pkg-1.3.4-1.18.2" = _fA81ztw1;
        "pkg-1.3.5-1.18.2" = _f0Z57K3u;
        "pkg-1.3.6-1.18.2" = _HFPqvNFV;
        "pkg-1.3.7-1.18.2" = _8GK5ODcq;
        "pkg-1.3.8-1.18.2" = _bVTPORti;
        "pkg-1.3.9-1.18.2" = _jv8F9Bes;
        "pkg-1.4.0-1.18.2" = _XkdMFerL;
        "pkg-1.4.2-1.18.2" = _jEtT2Tqg;
        "pkg-1.4.3-1.18.2" = _NmfRZzIH;
        "pkg-1.4.4-1.18.2" = _LCmgEAlT;
        "pkg-2.0.0-1.19" = _ivCHbLiF;
        "pkg-2.0.1-1.19" = _EaVmhS1s;
        "pkg-1.4.5-1.18.2" = _IQzEjW70;
        "pkg-2.0.2-1.19" = _JnGTIV4h;
        "pkg-1.4.6-1.18.2" = _7WEwgIGx;
        "pkg-1.4.7-1.18.2" = _FLEU4ibZ;
        "pkg-1.4.8-1.18.2" = _HdCsOqD8;
        "pkg-2.0.4-1.19" = _YcOhpy8N;
        "pkg-1.4.9-1.18.2" = _SGBsclkL;
        "pkg-2.0.5-1.19" = _I1Izima7;
        "pkg-2.1.0-1.19.1" = _u28xPCp9;
        "pkg-2.1.1-1.19.1" = _7BHxITYR;
        "pkg-2.2.0-1.19.2" = _xS49Sdr6;
        "pkg-2.2.1-1.19.2" = _DlHFPz3L;
        "pkg-2.2.2-1.19.2" = _v3a6wdsH;
        "pkg-2.2.3-1.19.2" = _BvD8tMCd;
        "pkg-2.2.4-1.19.2" = _Yc9mFuad;
        "pkg-2.2.5-1.19.2" = _kaIi8yDa;
        "pkg-1.4.10-1.18.2" = _ItT2CqIh;
        "pkg-2.3.0-1.19.2" = _Aj5m6jzM;
        "pkg-2.3.1-1.19.2" = _FSeZJtpR;
        "pkg-1.4.11-1.18.2" = _Vy2AI68l;
        "pkg-2.4.0-1.19.3" = _5XCTvtiA;
        "pkg-2.4.1-1.19.3" = _pj2WYnJl;
        "pkg-2.4.2-1.19.3" = _Inazd5fA;
        "pkg-2.4.3-1.19.3" = _PQuU0vvu;
        "pkg-2.4.4-1.19.3" = _OfRRgCQd;
        "pkg-2.4.5-1.19.3" = _jkDH7q9h;
        "pkg-2.4.8-1.19.3" = _VVameDri;
        "pkg-2.4.9-1.19.3" = _u29G3u0i;
        "pkg-2.5.0-1.19.3" = _GTgQpfR5;
        "pkg-2.5.1-1.19.3" = _osoxVElg;
        "pkg-2.5.2-1.19.3" = _aptCHLgO;
        "pkg-2.5.3-1.19.3" = _SEsCih8A;
        "pkg-2.6.0-1.19.4" = _KGWgSAHN;
        "pkg-v2.6.2-mc1.19.4" = _1w5q1KuA;
        "pkg-v2.6.3-mc1.19.4" = _icRINKmD;
        "pkg-v2.6.4-mc1.19.4" = _bAxPk3CT;
        "pkg-v2.6.5-mc1.19.4" = _ydSjVTeU;
        "pkg-v2.6.6-mc1.19.4" = _vxEOHJsY;
        "pkg-v2.6.7-mc1.19.4" = _llRfh4D7;
        "pkg-v2.6.9-mc1.19.4" = _7ebkqlkO;
        "pkg-2.3.2" = _k8vFN2vg;
        "pkg-2.5.5-1.19.3" = _sBRNFOUA;
        "pkg-v2.7.2-mc1.19.4" = _9sPWylti;
        "pkg-v2.7.3-mc1.19.4" = _8d0lDKSh;
        "pkg-v3.1.0-mc1.20.1" = _odDbeHRi;
        "pkg-v3.1.1-mc1.20.1" = _x6yPUqux;
        "pkg-v3.1.2-mc1.20.1" = _Yga1ThxD;
        "pkg-v3.2.0-mc1.20.1" = _VVwo1mws;
        "pkg-v3.2.1-mc1.20.1" = _ikYUNV3Y;
        "pkg-v3.2.3-mc1.20.1" = _Zfw1ZoVj;
        "pkg-v3.2.5-mc1.20.1" = _gHkU8koW;
        "pkg-v3.2.6-mc1.20.1" = _4STZdzGR;
        "pkg-v3.2.7-mc1.20.1" = _Jijlf8Td;
        "pkg-v3.2.8-mc1.20.1" = _HToVn2hm;
        "pkg-v3.3.0-mc1.20.1" = _tZPrclu9;
        "pkg-v3.3.1-mc1.20.1" = _l0THX1Cn;
        "pkg-v3.3.2-mc1.20.1" = _EvbM0Fu0;
        "pkg-v3.3.3-mc1.20.1" = _7WoGbOtY;
        "pkg-v4.0.0-mc1.20.2" = _xG2b9Gn0;
        "pkg-v4.0.1-mc1.20.2" = _iXhCreUg;
        "pkg-v4.0.2-mc1.20.2" = _dt5VtQmR;
        "pkg-v4.0.3-mc1.20.2" = _D7Sw2eRA;
        "pkg-v3.3.4-mc1.20.1" = _73uNAbs5;
        "pkg-v3.3.5-mc1.20.1" = _CPbmKRp5;
        "pkg-v4.1.0-mc1.20.2" = _Q9P0YYfU;
        "pkg-v4.1.1-mc1.20.2" = _OTxddWxn;
        "pkg-v3.3.6-mc1.20.1" = _od4ToX34;
        "pkg-v2.7.5-mc1.19.4" = _tZaaFhkf;
        "pkg-2.5.6-1.19.3" = _IZQIExZZ;
        "pkg-v2.3.2-mc1.19.2" = _WC8jIRwS;
        "pkg-v3.3.7-mc1.20.1" = _e8f7xBSa;
        "pkg-v4.1.2-mc1.20.2" = _4sc1hUOv;
        "pkg-v4.1.3-mc1.20.2" = _bWN0NxgM;
        "pkg-v4.1.4-mc1.20.2" = _D8CjaYv1;
        "pkg-v5.0.0-mc1.20.4" = _lvfPsdtX;
        "pkg-v5.0.1-mc1.20.4" = _CdH9HOYH;
        "pkg-v5.0.2-mc1.20.4" = _zlkLeOOn;
        "pkg-v5.0.3-mc1.20.4" = _PrrZqBsG;
        "pkg-v5.1.0-mc1.20.4" = _LXFBLN4W;
        "pkg-v5.1.1-mc1.20.4" = _ZLJ3J2xJ;
        "pkg-v3.3.8-mc1.20.1" = _qqq3Gaft;
        "pkg-v5.1.2-mc1.20.4" = _YX84GQQM;
        "pkg-v3.3.9-mc1.20.1" = _155jtqJi;
        "pkg-v5.1.3-mc1.20.4" = _o9vZrcth;
        "pkg-v5.1.4-mc1.20.4" = _cBTPCE6o;
        "pkg-v5.1.5-mc1.20.4" = _t1ejN1OI;
        "pkg-v5.1.6-mc1.20.4" = _RGlKXdjB;
        "pkg-v5.1.7-mc1.20.4" = _9qYPBTUp;
        "pkg-v5.1.8-mc1.20.4" = _Z6bAJIwz;
        "pkg-v6.0.0-mc1.21.1" = _KmONYzHT;
        "pkg-v6.0.1-mc1.21.1" = _8LAGSdvj;
        "pkg-v6.0.2-mc1.21.1" = _Um095DJT;
        "pkg-v6.0.3-mc1.21.1" = _NGk8VAMH;
        "pkg-v5.1.9-mc1.20.4" = _iekyf0fi;
        "pkg-v5.1.10-mc1.20.4" = _IW0nxIBB;
        "pkg-v6.0.4-mc1.21.1" = _dRnapizT;
        "pkg-v6.0.5-mc1.21.1" = _mdmh2vNn;
        "pkg-v6.0.6-mc1.21.1" = _vOmUATGw;
        "pkg-5.2.0" = _fSBijwCM;
        "default" = _fSBijwCM;
    });
