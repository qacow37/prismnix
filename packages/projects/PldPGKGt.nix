...
let
    ...
    in {
        ...
        "pkg-1.0.0-SNAPSHOT+30a7c34" = _OTP3ebkl;
        "pkg-1.1.0-SNAPSHOT+370e33e" = _fADFZLdk;
        "pkg-1.1.0-SNAPSHOT+d77e927" = _yCDLydIp;
        "pkg-1.1.0-SNAPSHOT+75fb0a6" = _lvHw1CPw;
        "pkg-1.1.0-SNAPSHOT+1579b4a" = _2D6LXSZ7;
        "pkg-1.1.0-SNAPSHOT+66df71b" = _rEjft7xG;
        "pkg-1.1.0+bd55ee4" = _9VTd8CrO;
        "pkg-1.1.0-SNAPSHOT+44d5a18" = _BkRCY1c6;
        "pkg-1.1.0-SNAPSHOT+aca1617" = _AkUg3C3Z;
        "pkg-1.1.0-SNAPSHOT+2006780" = _yleqN2t5;
        "pkg-1.1.0-SNAPSHOT+3c81991" = _leoBErRO;
        "pkg-1.1.0-SNAPSHOT+dcf05cb" = _N0QDRWaU;
        "pkg-1.1.0-SNAPSHOT+2add003" = _wk27qH9m;
        "pkg-1.1.0-SNAPSHOT+46fae1b" = _aXgK6kxd;
        "pkg-1.1.0+f408c00" = _JnFV7eGu;
        "pkg-1.2.0-SNAPSHOT+c1b3a5a" = _oIQFi37M;
        "pkg-1.2.0-SNAPSHOT+3a16d0d" = _3vE5etMh;
        "pkg-1.2.0-SNAPSHOT+73ef330" = _7wDa8e0D;
        "pkg-1.2.0-SNAPSHOT+217b235" = _omNXDsrJ;
        "pkg-1.2.0-SNAPSHOT+3b1d94a" = _SIOhdTvh;
        "pkg-1.2.0-SNAPSHOT+248e7c4" = _hOnsH9nT;
        "pkg-1.2.0-SNAPSHOT+6ca64b5" = _34yu0BGJ;
        "pkg-1.2.0-SNAPSHOT+29a869f" = _IaYTBuBb;
        "pkg-1.2.0-SNAPSHOT+2a68809" = _DYrpDe4q;
        "pkg-1.2.0-SNAPSHOT+b5ff17a" = _CPOfrWR5;
        "pkg-1.2.0-SNAPSHOT+d8e5c38" = _QByfq9HK;
        "pkg-1.2.0-SNAPSHOT+c6e82ff" = _NfAMtTQn;
        "pkg-1.2.0-SNAPSHOT+cffe97a" = _M0yogOKi;
        "pkg-1.2.0-SNAPSHOT+d35a718" = _MrEhknnH;
        "pkg-1.2.0-SNAPSHOT+c7c3fcf" = _UFK0Z1kg;
        "pkg-1.2.0-SNAPSHOT+cb1cb82" = _KrvkOZcx;
        "pkg-1.2.0-SNAPSHOT+92ad21a" = _hQ8CFvJG;
        "pkg-1.2.0-SNAPSHOT+d241c92" = _JumJ9Mrt;
        "pkg-1.2.0-SNAPSHOT+a0fc964" = _mRDlC4OI;
        "pkg-1.2.0-SNAPSHOT+747c302" = _s7MOiaEv;
        "pkg-1.2.0-SNAPSHOT+8bc7f91" = _3GjW6Bd8;
        "pkg-1.2.0-SNAPSHOT+5af7c9e" = _GT63HfwF;
        "pkg-1.2.0-SNAPSHOT+a7a0c74" = _QAltgEtP;
        "pkg-1.2.0-SNAPSHOT+acc81de" = _zoOT9AKS;
        "pkg-1.2.0-SNAPSHOT+3036f09" = _X26WJd6b;
        "pkg-1.2.0-SNAPSHOT+b4c5ea8" = _qlfK8OJV;
        "pkg-1.2.0-SNAPSHOT+efa0d3c" = _79epXQub;
        "pkg-1.2.0-SNAPSHOT+1315ff3" = _pLp70OvL;
        "pkg-1.2.0-SNAPSHOT+377fd98" = _NYkC9j0P;
        "pkg-1.2.0-SNAPSHOT+66835a1" = _COE0B4kF;
        "pkg-1.2.0-SNAPSHOT+3d3ef0b" = _newyCqIw;
        "pkg-1.2.0-SNAPSHOT+3351f52" = _JmZhkkKF;
        "pkg-1.2.0-SNAPSHOT+3d7904b" = _SW560iNB;
        "pkg-1.2.0-SNAPSHOT+770ae39" = _OlojARYJ;
        "pkg-1.2.0-SNAPSHOT+07b39a2" = _inmuQDrZ;
        "pkg-1.2.0-SNAPSHOT+ded4710" = _3EyV4WDp;
        "pkg-1.2.0-SNAPSHOT+777b563" = _Yw3z7j2h;
        "pkg-1.2.0-SNAPSHOT+4f08470" = _s2gGXvFg;
        "pkg-1.2.0-SNAPSHOT+78976b8" = _Q3W0MKjY;
        "pkg-1.2.0-SNAPSHOT+08025a2" = _vWowlhOo;
        "pkg-1.2.0-SNAPSHOT+8d0e4c1" = _HUfjMhd8;
        "pkg-1.2.0-SNAPSHOT+a6c43b1" = _TG4iJyoU;
        "pkg-1.2.0-SNAPSHOT+1151088" = _C1kzlaac;
        "default" = _C1kzlaac;
    });
