...
let
    ...
    in {
        ...
        "pkg-1.21.5-1.0.0" = _nKpxeFvp;
        "pkg-1.21.4-1.0.0" = _S8a43Ffu;
        "pkg-1.20.6-1.1.0" = _gysH93n3;
        "pkg-1.21.1-1.1.0" = _2Qh20BT3;
        "pkg-1.21-1.1.0" = _OhXTx84W;
        "pkg-1.20.5-1.1.0" = _nNimJHcb;
        "pkg-1.21.3-1.1.0" = _EiWGTNux;
        "pkg-1.21.2-1.1.0" = _P7b7xzOr;
        "pkg-1.21.4-1.1.0" = _q0tl8pyY;
        "pkg-1.21.5-1.1.0" = _6hF1t4Pf;
        "pkg-1.20.1-1.1.0" = _ng186F4q;
        "pkg-1.20.2-1.1.0" = _iJHtv52s;
        "pkg-1.20.4-1.1.0" = _g9BUoXOq;
        "pkg-1.20-1.1.0" = _N4kU3blR;
        "pkg-1.20.3-1.1.0" = _KvTeJJ6D;
        "pkg-1.21.10-1.1.1" = _lYKFiah0;
        "pkg-1.20-1.2.0" = _QbahIykA;
        "pkg-1.20.1-1.2.0" = _kWYpeZSM;
        "pkg-1.20.2-1.2.0" = _nu5yEVq2;
        "pkg-1.20.3-1.2.0" = _KKdu0cTK;
        "pkg-1.20.4-1.2.0" = _MqxG0TDB;
        "pkg-1.20.5-1.2.0" = _Y7AD28q9;
        "pkg-1.20.6-1.2.0" = _195yERoE;
        "pkg-1.21-1.2.0" = _MJXvaQWJ;
        "pkg-1.21.1-1.2.0" = _fiOHUMIL;
        "pkg-1.21.2-1.2.0" = _tNbV96Ji;
        "pkg-1.21.3-1.2.0" = _uaxMRakd;
        "pkg-1.21.4-1.2.0" = _FmP9VQzE;
        "pkg-1.21.5-1.2.0" = _zDeCwYid;
        "pkg-1.21.6-1.2.0" = _xd15jSIY;
        "pkg-1.21.7-1.2.0" = _5Mkgp1QG;
        "pkg-1.21.8-1.2.0" = _rFCEzVA9;
        "pkg-1.21.9-1.2.0" = _eaqlCUmX;
        "pkg-1.21.10-1.2.0" = _CcTF1OIY;
        "pkg-1.21.11-1.2.0" = _Nl5njz64;
        "default" = _Nl5njz64;
    });
