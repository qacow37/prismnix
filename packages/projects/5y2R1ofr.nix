...
let
    ...
    in {
        ...
        "pkg-1.0.3+mod" = _pUZOWd9f;
        "pkg-1.1" = _TebgsZL5;
        "pkg-1.1+mod" = _YrNEXkz6;
        "pkg-1.1.1" = _diRnCn4W;
        "pkg-1.1.1+mod" = _jCt1z6Gn;
        "pkg-1.1.2" = _abbDdu7X;
        "pkg-1.1.2+mod" = _3ehixZfe;
        "pkg-1.1.2-1.19-1.19.2" = _26VzBPwW;
        "pkg-1.1.2-1.19-1.19.2+mod" = _ibnexQve;
        "pkg-1.1.3" = _ite2yg7n;
        "pkg-1.1.3+mod" = _9eYz1rB7;
        "pkg-1.1.4" = _FvKsx2Xt;
        "pkg-1.1.4+mod" = _Lbo3S4Pc;
        "pkg-1.1.5" = _oW0X5pEv;
        "pkg-1.1.5+mod" = _U5zxn2YR;
        "pkg-1.1.6" = _TV8DTBYU;
        "pkg-1.1.6+mod" = _BUkD36AH;
        "pkg-1.2" = _tlKupLWc;
        "pkg-1.2+mod" = _G36ZJThp;
        "pkg-1.2.1" = _rvwYnhlQ;
        "pkg-1.2.1+mod" = _q4jY32GV;
        "pkg-1.2.2" = _639vWiu0;
        "pkg-1.2.2+mod" = _QcwNSjdR;
        "pkg-1.2.3" = _TR2aNngr;
        "pkg-1.2.3+mod" = _9Udravtp;
        "pkg-1.2.4" = _RvJ2Ynrb;
        "pkg-1.2.4+mod" = _AK6oxbXp;
        "pkg-1.2.5" = _RSpACTQl;
        "pkg-1.2.5+mod" = _m0qNdjtN;
        "pkg-1.2.6" = _gYiTvVrY;
        "pkg-1.2.6+mod" = _7VHVkk45;
        "pkg-1.2.7" = _EkkZko39;
        "pkg-1.2.7+mod" = _Zhx8qUmG;
        "pkg-1.2.8" = _lOmKcAB0;
        "pkg-1.2.8+mod" = _wEMgXFvV;
        "pkg-1.2.8-1.19.2" = _WPUgOpru;
        "pkg-1.2.8-1.19.2+mod" = _Pxhzw1iN;
        "pkg-1.2.8-1.18.2" = _CJokfaNb;
        "pkg-1.2.8-1.18.2+mod" = _cgRHUG3O;
        "pkg-1.2.9" = _29jTzJ29;
        "pkg-1.2.9+mod" = _QEcfWaHz;
        "pkg-1.3.0" = _fcs3PYxd;
        "pkg-1.3.0+mod" = _8Q657FWi;
        "pkg-1.3.1" = _JWUALcdC;
        "pkg-1.3.1-1.20.2" = _RApg9CFQ;
        "pkg-1.3.1+mod" = _vbyR29jq;
        "pkg-1.3.1-1.20.2+mod" = _KbUTjCCs;
        "pkg-1.3.2" = _I7Wm0BMK;
        "pkg-1.3.2-1.20.2" = _WWNlzaF2;
        "pkg-1.3.2+mod" = _qy98k1Ja;
        "pkg-1.3.2-1.20.2+mod" = _fz4qAgn7;
        "pkg-1.3.3" = _wrJ6cRm3;
        "pkg-1.3.3+mod" = _tmm08KfL;
        "pkg-1.4" = _nJtQKGE7;
        "pkg-1.4+mod" = _9ZOapqLi;
        "pkg-1.4.1" = _JCO9KOHa;
        "pkg-1.4.1+mod" = _mQpvKoC6;
        "pkg-1.4.2" = _PCD4R43I;
        "pkg-1.4.2+mod" = _v0K34Bwo;
        "pkg-1.4.3" = _OcYrPK4W;
        "pkg-1.4.3+mod" = _Rv3dPsLc;
        "pkg-1.4.4" = _l2yFZMUY;
        "pkg-1.4.4+mod" = _Zzdedn6R;
        "pkg-1.4.5" = _OegKQ0Rb;
        "pkg-1.4.5+mod" = _z70McCt9;
        "pkg-1.4.6" = _NvinKGgm;
        "pkg-1.4.6+mod" = _Slcj3YlH;
        "pkg-1.4.7" = _PvC3bEo5;
        "pkg-1.4.7+mod" = _ELgY1zsZ;
        "pkg-1.4.8" = _9WFkJ45l;
        "pkg-1.4.8+mod" = _KMUQcVgb;
        "pkg-1.5" = _E7XMzRT7;
        "pkg-1.5+mod" = _hWcvvmlY;
        "pkg-1.5.1" = _ZogikzDa;
        "pkg-1.5.1+mod" = _pL9Sxh5R;
        "pkg-1.5.2" = _o6mJQIz2;
        "pkg-1.5.2+mod" = _lVGQwFo2;
        "pkg-1.5.3" = _kJONeCRL;
        "pkg-1.5.3+mod" = _iHzwB3WZ;
        "pkg-1.5.4" = _VPYRcA3D;
        "pkg-1.5.4+mod" = _hsggglZP;
        "pkg-1.5.5" = _IZxazEI5;
        "pkg-1.5.5+mod" = _Tko5WKAU;
        "pkg-1.5.6" = _dn7EYAZR;
        "pkg-1.5.6+mod" = _akmGg5RT;
        "pkg-1.6" = _sLWYLW9I;
        "pkg-1.6+mod" = _U7a6UWdY;
        "pkg-1.6.1" = _c2oWNbRO;
        "pkg-1.6.1+mod" = _slnWqOkt;
        "pkg-1.6.2" = _ip2sFoax;
        "pkg-1.6.2+mod" = _4XdSoSFP;
        "pkg-1.6.3" = _MWHewG07;
