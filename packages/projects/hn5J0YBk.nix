...
let
    ...
    in {
        ...
        "pkg-1.21.1_1" = _D9YRy4ya;
        "pkg-1.21.1_2" = _VVZ7HKjO;
        "pkg-1.21.1_3" = _y5uvVx4F;
        "pkg-1.21.1_4" = _FTcQ1GDA;
        "pkg-1.21.1_5" = _yb55fFCh;
        "pkg-1.21.1_6" = _z4OuteQQ;
        "pkg-1.21.1_7" = _W4Baut94;
        "pkg-1.21.1_8" = _FfR51kVs;
        "pkg-1.21.3_1" = _7hX1V9Ua;
        "pkg-1.21.3_2" = _SOVJebtN;
        "pkg-1.21.4_1" = _CbKLDnN0;
        "pkg-1.21.4_2" = _ugEm1EWB;
        "pkg-1.21.4_3" = _NoeAASu9;
        "pkg-1.21.5_1" = _eZva36ip;
        "pkg-1.21.1_9" = _RjmReCi0;
        "pkg-1.21.5_2" = _kn1KVhIj;
        "pkg-1.21.81" = _uGmcEQqy;
        "pkg-1.21.82" = _GrvhXecp;
        "pkg-1.0.0" = _EaBt9ffZ;
        "pkg-2.0.0" = _PvYwj1KW;
        "pkg-3.0.0" = _YMbBFO2Y;
        "pkg-4.0.0" = _S6RT627s;
