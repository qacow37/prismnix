...
let
    ...
    in {
        ...
        "pkg-1.20.7" = _S41hIeci;
        "pkg-1.20.8" = _FLDKsous;
        "pkg-1.20.9" = _qVBeIDAx;
        "pkg-1.20.10" = _mfbuNvPm;
        "pkg-1.21.0" = _LPZeHWzd;
        "pkg-1.22.0" = _zb5TZDPJ;
        "pkg-1.22.1" = _M3VlUwRW;
        "pkg-1.22.2" = _OMpioHC2;
        "pkg-1.22.3" = _TGevcjry;
        "pkg-1.22.4" = _8sCf4HGL;
        "pkg-1.22.5" = _KsVhPvG1;
        "pkg-1.22.6" = _W1nZNmqi;
        "pkg-1.23.0" = _fr9lYAo7;
        "pkg-1.23.1" = _1hG7pvCi;
        "pkg-1.23.2" = _E1HemmcH;
        "pkg-1.23.3" = _9wg9mt2m;
        "pkg-1.23.4" = _B7k2NU6T;
        "pkg-1.23.5" = _IpdJVEHi;
        "pkg-1.23.6" = _6BA226lh;
        "pkg-1.23.7" = _B7ahUW5g;
        "pkg-1.23.8" = _XvFsDJuM;
        "pkg-1.23.9" = _3HKol1hq;
        "pkg-1.23.10" = _IlO1cpce;
        "pkg-1.23.11" = _fGX2zXoX;
        "pkg-1.23.12" = _9OZEoy4f;
        "pkg-1.23.13" = _KiyuJMRD;
        "pkg-1.24.0" = _9tGdIQ0B;
        "pkg-1.24.1" = _dgfRp1pD;
        "pkg-1.24.2" = _FWKFLbcD;
        "pkg-1.24.3" = _PX4gr25m;
        "pkg-1.24.4" = _s0ccgQxy;
        "pkg-1.24.5" = _DR3fLoQy;
        "pkg-1.25.0" = _oH0HyEIl;
        "pkg-1.25.1" = _1umlD0JV;
        "pkg-1.26.2" = _dOVVNOm0;
        "pkg-1.26.3" = _b3ALrAT4;
        "pkg-1.26.4" = _fRNKsau4;
        "pkg-1.26.5" = _WCNh2fv6;
        "pkg-1.26.6" = _qxW4xL8O;
        "pkg-1.26.7" = _yGTUjQHM;
        "pkg-1.26.8" = _cjB0Vn5U;
        "pkg-1.26.9" = _NrERVu5J;
        "pkg-1.27.0" = _Sd6TupgX;
        "pkg-1.27.1" = _qNuNQArq;
        "pkg-1.27.2" = _5Eb48WgF;
        "pkg-1.28.0" = _QVdTVBe7;
        "pkg-1.29.0" = _DT6vUvYO;
        "pkg-1.30.0" = _7au1sR9f;
        "pkg-1.30.1" = _lnQyuleb;
        "pkg-1.30.2" = _OlRkraTM;
        "pkg-1.30.3" = _Qpjfoju7;
        "pkg-1.30.4" = _oLEPCZED;
        "pkg-1.31.0" = _Rs97kmH4;
        "pkg-1.32.0" = _CYcJt0EO;
        "pkg-1.32.1" = _GrW7g2bl;
        "pkg-1.32.2" = _fUj84EN3;
        "pkg-1.32.3" = _yk1GuVfK;
        "default" = _yk1GuVfK;
    });
