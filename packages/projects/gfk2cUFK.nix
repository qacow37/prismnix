...
let
    ...
    in {
        ...
        "pkg-1.4.0" = _bOFkd9Dz;
        "pkg-1.5.0" = _zv1rqUnY;
        "pkg-1.5.1-1.20.1" = _pczTwndl;
        "pkg-1.5.1-1.20.2" = _SLoznEvL;
        "pkg-1.5.1-1.20.4" = _UzW6eXgr;
        "pkg-1.5.2-1.20.1" = _8MK4rtbg;
        "pkg-1.5.2-1.20.2" = _SNfa9Czc;
        "pkg-1.5.2-1.20.4" = _oeHCMS2B;
        "pkg-1.6.0-1.20.1" = _7Awnfsby;
        "pkg-1.6.0-1.20.2" = _DtQiBbj7;
        "pkg-1.6.0-1.20.4" = _Q1ATzYha;
        "pkg-1.6.1-1.20.1" = _oNWT24CV;
        "pkg-1.6.1-1.20.2" = _7ip2am2B;
        "pkg-1.6.1-1.20.4" = _NtZx3r1y;
        "pkg-1.6.2-1.20.1" = _yr7dRn07;
        "pkg-1.6.2-1.20.2" = _C1fRmS1O;
        "pkg-1.6.2-1.20.4" = _Q1yc5mDg;
        "pkg-1.6.2-1.20.6" = _JqtZ0aiu;
        "pkg-1.6.3-1.20.6" = _YckhZzma;
        "pkg-1.6.3-1.21" = _q1G5yBrB;
        "pkg-SNAPSHOT-24w28a-1.21" = _oxBKqLwM;
        "pkg-SNAPSHOT-24w29a-1.21" = _DSAukjVv;
        "pkg-1.6.3-1.21.1" = _HF68dnmN;
        "pkg-SNAPSHOT-24w32a-1.21.1" = _HbGVmFlC;
        "pkg-1.6.4-1.20.1" = _7xF8HDEr;
        "pkg-1.6.4-1.20.4" = _k8jbWH22;
        "pkg-1.6.4-1.20.6" = _Acb4sENy;
        "pkg-1.6.4-1.21" = _ujiifvQs;
        "pkg-1.6.4-1.21.1" = _ukXTaxaO;
        "pkg-SNAPSHOT-24w33a-1.21" = _cuFTRrZx;
        "pkg-1.7-1.20.1" = _ZdbSzKvb;
        "pkg-1.7-1.20.4" = _7m9T4CrV;
        "pkg-1.7-1.20.6" = _dCvIdffg;
        "pkg-1.7-1.21.1" = _83T6hEzk;
        "pkg-1.7-1.21.2" = _SjRh324T;
        "pkg-1.7-1.21.3" = _uQbhJrqW;
        "pkg-1.8-1.20.1" = _bnMvMsnO;
        "pkg-1.8-1.21.1" = _nT6IH18v;
        "pkg-1.8-1.21.3" = _Sjhnft66;
        "pkg-1.21.4-1.8" = _htWDhYff;
        "pkg-1.21.5-1.8.1" = _iPdsuMPY;
        "pkg-1.21.5-1.9" = _BmrAksV5;
        "pkg-1.21.8-1.9" = _BDJOvmNL;
        "pkg-1.21.8-1.10" = _Rgg79K3C;
        "pkg-1.21.8-1.10.1" = _xpEhi4Ad;
        "pkg-1.21.10-1.10.2" = _YyunKFod;
