...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _10B2RN27;
        "pkg-1.9.2" = _HixZ3FEE;
        "pkg-1.10.0" = _xOggNcoi;
        "pkg-1.10.1" = _BbJCJAOJ;
        "pkg-1.10.2" = _EInJcNuA;
        "pkg-1.11.0" = _QqhVGY3B;
        "pkg-1.11.1" = _a7iUgjcO;
        "pkg-1.11.2" = _3Ql9OvHK;
        "pkg-2.0.0" = _hAPKuewh;
        "pkg-2.0.1" = _8cNxhJft;
        "pkg-2.0.2" = _Rdwo1hpm;
        "pkg-2.1.0" = _vIcBiRxl;
