...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.20.1" = _boFqMohl;
        "pkg-0.1.0+1.21.1" = _2jb4Rr1m;
        "pkg-0.1.0+1.20.6" = _kaL9ZnK6;
        "pkg-0.1.1+1.20.6" = _vtYg6mwB;
        "pkg-0.1.1+1.21.1" = _d0sJwSjT;
        "pkg-0.1.1+1.20.1" = _nYP0YQR9;
        "pkg-0.1.2+1.20.6" = _vXzIl5FE;
        "pkg-0.1.2+1.21.1" = _9QXSYs9y;
        "pkg-0.1.2+1.20.1" = _u0olNYx7;
        "pkg-0.1.3+1.21.1" = _YVUVcbr4;
        "pkg-0.1.3+1.20.6" = _mmsULm5b;
        "pkg-0.1.3+1.19" = _7vAy85bj;
        "pkg-0.1.3+1.18" = _DCQHZXzC;
        "pkg-0.1.3+1.17.1" = _4bXSqwpq;
        "pkg-0.1.3+1.20.1" = _L6tVkiN1;
        "pkg-0.1.4+1.21.1" = _FSbstmxc;
        "pkg-0.1.4+1.20.6" = _LM8x1UZy;
        "pkg-0.1.4+1.21.3" = _co8Mpsij;
        "pkg-0.1.4+1.18" = _RhjMuuc2;
        "pkg-0.1.4+1.20.1" = _eocn8RB5;
        "pkg-0.1.4+1.19" = _lN51IAuK;
        "pkg-0.1.4+1.17.1" = _r7bP66PZ;
        "pkg-0.1.5+1.21.3" = _L5krqlds;
        "pkg-0.1.5+1.19" = _5IkVovz1;
        "pkg-0.1.5+1.21.1" = _Q1vYoMuN;
        "pkg-0.1.5+1.20.6" = _FRWLLD8N;
        "pkg-0.1.5+1.15" = _6OR4xJss;
        "pkg-0.1.5+1.17.1" = _XJ2HqxcR;
        "pkg-0.1.5+1.20.1" = _AEMXYaXw;
        "pkg-0.1.5+1.18" = _Le9ANmfI;
        "pkg-0.1.6+1.21.3" = _6aA651tl;
        "pkg-0.1.6+1.20.1" = _p8D6Jm5I;
        "pkg-0.1.6+1.20.6" = _MvMNNRPz;
        "pkg-0.1.6+1.18" = _zppItftC;
        "pkg-0.1.6+1.15" = _OpjwsxaW;
        "pkg-0.1.6+1.19" = _gccOk1co;
        "pkg-0.1.6+1.21.1" = _uJRwnd5Z;
        "pkg-0.1.6+1.17.1" = _2XcAA1Oq;
        "pkg-0.1.7+1.21.3" = _SvkkZcyK;
        "pkg-0.1.7+1.20.6" = _pAt7sRmE;
        "pkg-0.1.7+1.15" = _RGActPi8;
        "pkg-0.1.7+1.21.1" = _lLcIDG5M;
        "pkg-0.1.7+1.20.1" = _M0pOQvAa;
        "pkg-0.1.7+1.18" = _ubIX0d3n;
        "pkg-0.1.7+1.19" = _NmcXVEqa;
        "pkg-0.1.7+1.17.1" = _tPFrmxAU;
        "pkg-0.1.8+1.19" = _PfvfBUd0;
        "pkg-0.1.8+1.20.6" = _pJNfgpG7;
        "pkg-0.1.8+1.21.5" = _iQjzKm8v;
        "pkg-0.1.8+1.15" = _TuOox7bJ;
        "pkg-0.1.8+1.21.3" = _5UTUDTDf;
        "pkg-0.1.8+1.21.1" = _GezC8rqU;
        "pkg-0.1.8+1.20.1" = _OgcMM2uh;
        "pkg-0.1.8+1.17.1" = _PDV3jalr;
        "pkg-0.1.8+1.18" = _B77hlhHG;
        "pkg-0.1.8+1.14.4" = _RrBk2LR9;
        "pkg-0.1.9+1.17.1" = _lBtWpH6w;
        "pkg-0.1.9+1.18" = _Hs2EAD6h;
        "pkg-0.1.9+1.19" = _3RBSmae4;
        "pkg-0.1.9+1.20.1" = _ePga1TsL;
        "pkg-0.1.9+1.20.6" = _IG5G411n;
        "pkg-0.1.9+1.21.3" = _OJYTQp04;
        "pkg-0.1.9+1.21.1" = _WLzKy9Q6;
        "pkg-0.1.9+1.21.5" = _5QJ6aCsU;
        "pkg-0.2.0+1.17.1" = _hcpHhjwZ;
        "pkg-0.2.0+1.18" = _hGgSY9KK;
        "pkg-0.2.0+1.19" = _YdZf7lZz;
        "pkg-0.2.0+1.20.1" = _6Sfgfzi7;
        "pkg-0.2.0+1.20.6" = _yEeveWev;
        "pkg-0.2.0+1.21.1" = _HeYWF7xh;
        "pkg-0.2.0+1.21.3" = _yckD3f2X;
        "pkg-0.2.0+1.21.5" = _KdGIpKPR;
        "pkg-0.2.0+1.21.6" = _PbY6ibrG;
        "pkg-0.2.0+1.21.9" = _LB8rCcR5;
        "pkg-0.2.1+1.17.1" = _N1AtIxQN;
        "pkg-0.2.1+1.18" = _TVRNPH5s;
        "pkg-0.2.1+1.19" = _ewZeAC9T;
        "pkg-0.2.1+1.20.1" = _98teau0m;
        "pkg-0.2.1+1.20.6" = _KLozcs8V;
        "pkg-0.2.1+1.21.1" = _dMWrE3Fj;
        "pkg-0.2.1+1.21.3" = _7eQwvxfs;
        "pkg-0.2.1+1.21.5" = _N6qFoNRg;
        "pkg-0.2.1+1.21.6" = _NI4dAttn;
        "pkg-0.2.1+1.21.9" = _S4fpXdla;
        "pkg-0.2.2+1.17.1" = _DsfNsrzJ;
        "pkg-0.2.2+1.18" = _JCHU1t5i;
        "pkg-0.2.2+1.19" = _TXJlcd9G;
        "pkg-0.2.2+1.20.1" = _i9uG7AIO;
        "pkg-0.2.2+1.20.6" = _cgNfpW93;
        "pkg-0.2.2+1.21.3" = _1UbRRLVT;
        "pkg-0.2.2+1.21.1" = _p6riPPnO;
        "pkg-0.2.2+1.21.5" = _qCWgpYDU;
        "pkg-0.2.2+1.21.6" = _K7jkgrRs;
        "pkg-0.2.2+1.21.9" = _EywpdU6Y;
        "default" = _EywpdU6Y;
    });
