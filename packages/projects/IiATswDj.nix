...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _TbjiRSjd;
        "pkg-1.4.2" = _d9GM663Q;
        "pkg-1.5.0-beta" = _Wbz5eyMw;
        "pkg-1.5.1-beta" = _wGlxD9Bs;
        "pkg-1.5.2-beta" = _BG93ZC9u;
        "pkg-1.5.3-beta" = _i4WJI0gp;
        "pkg-1.6.0-alpha.1" = _yh6fz02r;
        "pkg-1.6.0-alpha.2" = _IgoTaaJV;
        "pkg-1.6.0" = _GCScYwwI;
        "pkg-1.6.1" = _7Qy4Ta6b;
        "pkg-1.6.2" = _Huen69N5;
        "pkg-1.6.3" = _TpUCzFaW;
