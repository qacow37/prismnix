...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.1-fabric+forge+neo" = _mQu6HPBz;
        "pkg-1.20.6-1.1-fabric+forge+neo" = _yJhDKkHA;
        "pkg-1.21.0-1.1-fabric+forge+neo" = _usBenVL0;
        "pkg-1.21.1-1.1-fabric+forge+neo" = _vYGy1sQV;
        "pkg-1.21.2-1.1-fabric+neo" = _yQZmNsBG;
        "pkg-1.21.3-1.1-fabric+forge+neo" = _FbAvGnOW;
        "pkg-1.21.4-1.1-fabric+forge+neo" = _Hv71UWaO;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _AW1Id5tB;
        "pkg-1.21.1-1.2-fabric+forge+neo" = _84YMYHoG;
        "pkg-1.21.4-1.2-fabric+forge+neo" = _8MVtGHK8;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _H6wd5Jo8;
        "pkg-1.21.1-1.3-fabric+forge+neo" = _7KMoV9Oz;
        "pkg-1.21.4-1.3-fabric+forge+neo" = _G2Eb2wb2;
        "pkg-1.21.5-1.3-fabric+forge+neo" = _vuQ3HZaY;
        "pkg-1.21.6-1.3-fabric+forge+neo" = _MJr5qQqw;
        "pkg-1.21.7-1.3-fabric+forge+neo" = _W0vtPYdt;
        "pkg-1.21.8-1.3-fabric+forge+neo" = _rovc3uxc;
        "pkg-1.21.9-1.3-fabric+forge+neo" = _SzY18Luf;
        "pkg-1.21.10-1.3-fabric+forge+neo" = _r1roZVIQ;
        "pkg-1.21.11-1.3-fabric+forge+neo" = _I55P61qh;
        "pkg-26.1.0-1.3-fabric+forge+neo" = _uXmgzN7o;
        "pkg-26.1.1-1.3-fabric+forge+neo" = _hxicBotK;
        "pkg-26.1.2-1.3-fabric+forge+neo" = _F1OyF5hi;
        "pkg-1.20.1-1.4-fabric+forge+neo" = _DvRdxh3A;
        "pkg-1.21.1-1.4-fabric+forge+neo" = _xxE87Rf4;
