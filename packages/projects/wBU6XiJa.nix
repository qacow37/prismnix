...
let
    ...
    in {
        ...
        "pkg-1.18.2-2.7.0" = _JmrzCbhJ;
        "pkg-1.19.2-3.0.0" = _zc1csxiI;
        "pkg-1.19.2-3.1.0" = _RefvQfhY;
        "pkg-1.18.2-2.7.1" = _fa0nBLp9;
        "pkg-1.19.2-3.1.1" = _GDvQPSco;
        "pkg-1.19.2-3.2.0" = _I9W67nKP;
        "pkg-4.0.0" = _ROu2iUE6;
        "pkg-5.0.0" = _32LN8rtu;
        "pkg-5.0.1" = _v9Rwy9A6;
        "pkg-3.3.0" = _NM7hD98E;
