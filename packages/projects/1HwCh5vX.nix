...
let
    ...
    in {
        ...
        "pkg-1.19.3-0.1" = _nsnN1wBl;
        "pkg-1.19.4-0.1" = _9KXwgER1;
        "pkg-1.20-0.1" = _PnxMaxHB;
        "pkg-1.20.1-0.1" = _bfo1eh6e;
        "pkg-1.20.2-0.1" = _balk1Xan;
        "pkg-1.19-0.2" = _yRfPcGr7;
        "pkg-1.19.1-0.2" = _KN10d8hc;
        "pkg-1.19.2-0.2" = _9ya6mjIP;
        "pkg-1.19.3-0.2" = _iqOTBx6E;
        "pkg-1.19.4-0.2" = _9WE2I6r6;
        "pkg-1.20-0.2" = _zbnRYd9I;
        "pkg-1.20.2-0.2" = _UHLQr8sr;
        "pkg-1.20.1-0.2" = _AjGqxhm2;
        "pkg-1.19-0.3" = _uo57LOdH;
        "pkg-1.19.1-0.3" = _X1P5qbi1;
        "pkg-1.19.2-0.3" = _7VFQQALX;
        "pkg-1.19.3-0.3" = _5wQinMBD;
        "pkg-1.19.4-0.3" = _RpuQKeCG;
        "pkg-1.20-0.3" = _gK2zfu67;
        "pkg-1.20.1-0.3" = _CT9x0UGb;
        "pkg-1.20.2-0.3" = _PxHNg1dn;
        "pkg-1.20.4-0.1" = _LZFJZVkK;
        "pkg-1.20.6-0.1" = _C6KWeD2Y;
        "pkg-1.20.3-0.1" = _ZfPvVhMN;
        "pkg-1.20.5-0.1" = _NqoTfcnE;
        "pkg-1.21-0.1" = _K8hbCeKb;
        "pkg-1.21-0.2" = _LYZoDFgj;
        "pkg-1.21.1-0.1" = _y8U2VuSg;
        "pkg-1.21.1-0.2" = _H2pwDVfQ;
        "pkg-1.21-0.3" = _X89fE95W;
        "pkg-1.21.3-0.1" = _W9J5g2v6;
        "pkg-1.21.4-0.1" = _vs3ASxs3;
        "pkg-1.21.4-0.2" = _GovDA9KL;
        "pkg-1.21.4-0.3" = _CHBstGJg;
        "pkg-1.21.5-0.1" = _BfgzNZkn;
        "pkg-1.21.5-0.2" = _PnpEzs1O;
        "pkg-1.21.4-0.4" = _6Tjpw3P2;
        "pkg-1.21.3-0.2" = _FYLTLWVF;
        "pkg-1.21.1-0.3" = _WxoZLVbs;
        "pkg-1.21-0.4" = _DhpDRfZc;
        "pkg-1.21-0.5" = _GQ8tsRug;
        "pkg-1.21.1-0.4" = _REXdhwCd;
        "pkg-1.21.3-0.3" = _5CGHUp03;
        "pkg-1.21.5-0.3" = _E3SKG3fZ;
        "pkg-1.21.6-0.1" = _OCBAYpCU;
        "pkg-1.21.7-0.1" = _9i1dS8Xm;
        "pkg-1.21.8-0.1" = _8bIFjO7X;
        "pkg-1.21.9-0.1" = _ofCyKHWs;
        "pkg-1.21.10-0.1" = _faiMr4zC;
        "pkg-1.20.1-0.4" = _8ZmF7RhS;
        "pkg-1.21.11-0.1" = _8MwQWlsH;
        "pkg-26.1.2-0.1" = _4EAbDlWR;
