...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _Ns7HKHLO;
        "pkg-1.4.2" = _AwL3egqh;
        "pkg-1.21.8-1.4.2" = _KwwEIjCB;
        "pkg-1.5" = _HIAlBM1A;
        "pkg-1.21.4-1.5" = _eLUisQaJ;
        "pkg-1.21.8-1.5.0" = _iNBCVMvD;
        "pkg-1.21.10-1.5.0" = _zabVzbYz;
        "pkg-1.21.10-1.5.1" = _ooRbb9Y0;
        "pkg-1.5.1" = _bdoQ9HxH;
        "pkg-1.5.2" = _G6UZkqJZ;
        "pkg-1.21.4-1.5.2" = _GFologFx;
        "pkg-1.21.8-1.5.2" = _5I3c7dNH;
        "pkg-1.21.10-1.5.2" = _SMwEQvpN;
        "default" = _SMwEQvpN;
    });
