...
let
    ...
    in {
        ...
        "pkg-1.0-alpha.3" = _i3HFfM7f;
        "pkg-1.0-alpha.5" = _LYiKj2fU;
        "pkg-1.0-alpha.6" = _7a5VVoT5;
        "pkg-1.0-alpha.7" = _oj3YjSO2;
        "pkg-1.0-RC1" = _BH4PwcfG;
        "pkg-1.0-RC2" = _9oomofIf;
        "pkg-1.0-RC3" = _JVz5nooN;
        "pkg-1.0-RC3.1" = _KgY4IQMB;
        "pkg-1.0-RC3.2" = _duiSbJp9;
        "pkg-1.0-RC4" = _gXpdkRk6;
        "pkg-1.0-38" = _X9PrIuFM;
        "pkg-1.0-40" = _mwjanKnq;
        "pkg-1.0-43" = _lE1FY74G;
        "pkg-1.0-48" = _Jk8ITwHT;
        "pkg-1.0-51" = _uSw5hAf1;
        "pkg-1.0-54" = _V342guvm;
        "pkg-1.0-55" = _qBrs8owH;
        "pkg-1.0-60" = _q7e3kvIE;
        "pkg-1.0-78" = _oPrHcpIR;
        "pkg-1.0-105" = _ovGCnQb5;
        "pkg-1.0-130" = _ElItqOpZ;
        "pkg-1.0-131" = _6Epuq0RK;
        "pkg-1.0-179" = _7Qm5bPMw;
        "pkg-1.0-213" = _e4b8IyYu;
        "pkg-1.0-230" = _zyH8upgx;
        "pkg-2.0-259" = _NMPrP5bs;
        "pkg-2.1-319" = _iVPUyQER;
        "pkg-2.1-334" = _6IlcJO4R;
        "pkg-2.1-352" = _e5hZMw56;
        "pkg-2.1-354" = _Lj6sJ770;
        "pkg-2.1-383" = _gjPvsB7k;
        "pkg-2.1-384" = _PR24ZH8t;
        "pkg-2.1-385" = _XFYhgjxj;
        "pkg-2.1-387" = _XVz8ZASn;
        "pkg-2.1-388" = _pE3QixbT;
        "pkg-2.1-389" = _z0nfkPXY;
        "pkg-2.1-390" = _YwOvn216;
        "pkg-2.1-391" = _Fb4mdKjv;
        "pkg-2.1-393" = _bV3J0YRU;
        "pkg-3.0-BETA-5" = _U09Oy7Ur;
        "pkg-3.0-BETA-6" = _7jazteWK;
        "pkg-3.0-BETA-7" = _9JPchRE7;
        "pkg-3.0-BETA-8" = _YJaOFAa8;
        "pkg-3.0-BETA-11" = _AKDThHZt;
        "pkg-3.0-BETA-12" = _KGOX92Sg;
        "pkg-3.0-BETA-14" = _cgrm2pdL;
        "pkg-2.1-396" = _O0TSBb4i;
        "pkg-3.0-BETA-15" = _wgf8b2Cw;
        "pkg-3.0-BETA-16" = _LYvPxnkb;
        "pkg-3.0-BETA-17" = _72nm1OPw;
        "pkg-3.0-BETA-19" = _UCPVG8Sl;
        "pkg-3.0-BETA-22" = _Ve6Xsgoj;
        "pkg-2.1-397" = _9Y1w4NrE;
        "pkg-3.0-BETA-24" = _p2FHaFkV;
        "pkg-3.0-BETA-26" = _nrK3Cs0X;
        "pkg-3.0-BETA-27" = _zCEV88ZA;
        "pkg-2.1-398" = _ybJU2p7U;
        "pkg-3.0-BETA-28" = _nnBjKjPR;
        "pkg-3.0-BETA-29" = _jbcXjXKo;
        "pkg-3.0-BETA-30" = _6Y6XdnTJ;
        "pkg-3.0-BETA-31" = _WZr4U3i2;
        "pkg-3.0-BETA-32" = _IaNTuqoC;
        "pkg-3.0-1" = _Ub9f1uHH;
        "pkg-3.0-2" = _pws0iZ9C;
        "pkg-3.0-4" = _DFSSuuXE;
        "pkg-3.0-5" = _EAVhQ0gT;
        "pkg-3.0-6" = _WWIn3Xur;
        "pkg-3.0-9" = _d2u5yPE7;
        "pkg-3.0-10" = _5hfEyEuh;
        "pkg-3.0-11" = _PfmFtyOe;
        "pkg-3.0-14" = _5NgmiLoG;
        "pkg-3.0-16" = _BgSUHWUS;
        "pkg-3.0-17" = _ZzJnxlyD;
        "pkg-3.0-18" = _2YP5wyc5;
        "pkg-3.0-19" = _ZUnXgAn4;
        "pkg-3.0-20" = _MOyxN0tw;
        "pkg-3.0-21" = _P3odyXkO;
        "pkg-3.0-22" = _pdqdZEOz;
        "pkg-3.0-23" = _4wC70HIe;
        "pkg-3.0-24" = _PD2gtxPb;
        "pkg-3.0-25" = _3hTZGhcw;
        "pkg-3.0-26" = _D4EoaRYp;
        "pkg-3.0-30" = _XY5L0Q4D;
        "pkg-3.0-31" = _NS2FZGp8;
        "pkg-3.0-32" = _BGzIoD0f;
        "pkg-3.0-34" = _Q1PNeXnk;
        "pkg-3.0-35" = _zUKEQA2z;
        "pkg-3.0-36" = _KFDrn8d2;
        "pkg-3.0-37" = _L98RNJzZ;
        "pkg-3.0-38" = _D9ECb0gJ;
        "pkg-3.0-39" = _4g35zoDk;
        "pkg-3.0-40" = _lpbU9xqv;
        "pkg-3.0-41" = _H18jPbmR;
        "pkg-3.0-42" = _F9tsr35z;
        "pkg-3.0-44" = _ufIx02rX;
        "pkg-3.0-46" = _7Ln7fSJX;
        "pkg-3.0-47" = _VqAVMmt4;
        "pkg-3.0-48" = _kn56JcxT;
        "pkg-3.0-50" = _PlAA0Uri;
        "pkg-3.0-51" = _KtxhMArf;
        "pkg-3.0-52" = _fnd3eEF8;
        "pkg-3.0-53" = _Rgbms0iY;
        "pkg-3.0-54" = _bgFoSogN;
        "pkg-3.0-55" = _nNHFRAyt;
        "pkg-3.0-56" = _Yn31jS6B;
        "pkg-3.0-57" = _9vy60W0E;
        "pkg-3.0-58" = _wBGALBd9;
        "pkg-3.0-60" = _fH09jbgV;
        "pkg-3.0-61" = _xv9TfOA0;
        "pkg-3.0-62" = _xxkWWDXv;
        "pkg-3.0-65" = _ntwuaS0i;
        "pkg-3.0-69" = _MC7WPJME;
        "pkg-3.0-71" = _iZWPjLCW;
        "pkg-3.0-76" = _C7uzC6zU;
        "pkg-3.0-77" = _1NywUJIY;
        "pkg-3.0-78" = _LEWKU3HB;
        "pkg-3.0-79" = _976nzlvZ;
        "pkg-3.0-80" = _zPQj5gP0;
        "pkg-3.0-81" = _eoOq2BdV;
        "pkg-3.0-82" = _KKDB0EBk;
        "pkg-3.0-83" = _F5BY2JWc;
        "pkg-3.0-84" = _mzJu0fgf;
        "pkg-3.0-86" = _NAl3fl7K;
        "pkg-3.0-87" = _dQzp22OZ;
        "pkg-3.0-88" = _WVdVWitH;
        "pkg-3.0-89" = _ATv0c3vF;
        "pkg-3.0-90" = _RHYRC00I;
        "pkg-3.0-91" = _uqStUYoM;
        "pkg-3.0-92" = _JSXl92pR;
        "pkg-3.0-93" = _sspQq9TC;
        "pkg-3.0-94" = _KxLbIduV;
        "pkg-3.0-95" = _Z2ZcrjRv;
        "pkg-3.0-96" = _PxitEELr;
        "pkg-3.0-97" = _Ketk86uB;
        "pkg-3.0-99" = _eJB8SgbF;
        "pkg-3.0-100" = _PSeZcsw6;
        "pkg-3.0-101" = _tqXWKUPi;
        "pkg-3.0-102" = _4VUSsDr1;
        "pkg-3.0-103" = _rBh7yA6d;
        "pkg-3.0-104" = _1J2DE9O5;
        "pkg-3.0-105" = _nQSylFzw;
        "pkg-3.0-106" = _bL5yvSBK;
        "pkg-3.0-107" = _xIN47wK9;
        "pkg-3.0-108" = _NP5ev5yG;
        "pkg-3.0-109" = _Mjhmufw1;
        "pkg-3.0-111" = _9S3Zv7ZG;
        "pkg-3.0-112" = _VHSpODoS;
        "pkg-3.0-113" = _Xu279Lv5;
        "pkg-3.0-115" = _cLtALWOZ;
        "pkg-3.0-116" = _SMbVJ8Wc;
        "pkg-3.0-117" = _ym14UIlm;
        "pkg-3.0-118" = _YCkjfKKj;
        "pkg-3.0-119" = _FBs99Z0t;
        "pkg-3.0-120" = _Jowa0l7b;
        "pkg-3.0-121" = _c2uLad5u;
        "pkg-3.0-122" = _FdmxHL6w;
        "pkg-3.0-123" = _CeAoVhtb;
        "pkg-3.0-125" = _FhsguUR4;
        "pkg-3.0-126" = _FuDoyrIl;
        "pkg-3.0-127" = _w5AtCv9g;
        "pkg-3.0-128" = _blcCJ4qr;
        "pkg-3.0-131" = _5ZVLhqLd;
        "pkg-3.0-132" = _lroYjcML;
        "pkg-3.0-133" = _MKf4Ke8y;
        "pkg-3.0-134" = _xyhcfDPo;
        "pkg-3.0-136" = _NzPvW97V;
        "pkg-3.0-137" = _Lt2D881m;
        "pkg-3.0-138" = _X4sOrxKS;
        "pkg-3.0-139" = _2HrhJ431;
        "pkg-3.0-140" = _jyqE0oJP;
        "pkg-3.0-141" = _Jrlqb6oN;
        "pkg-3.0-142" = _2ZUcA0F5;
        "pkg-3.0-143" = _Ox2cWbww;
        "pkg-3.0-144" = _7FySBQeu;
        "pkg-3.0-145" = _XGqnM2MK;
        "pkg-3.0-146" = _NpqEAjLg;
        "pkg-3.0-147" = _xg178DGN;
        "pkg-3.0-148" = _6V3eTxBx;
        "pkg-3.0-149" = _TALilraG;
        "pkg-3.0-150" = _yyCqWcjV;
        "pkg-3.0-151" = _OkUt8JV3;
        "pkg-3.0-152" = _KA2qrb7D;
        "pkg-3.0-153" = _X3xMPuby;
        "pkg-3.0-154" = _QnMGhmFL;
        "pkg-3.0-155" = _ZFZoe2j8;
        "pkg-3.0-156" = _bhLc7xsC;
        "pkg-3.0-157" = _CZBtcddN;
        "pkg-3.0-158" = _FchXZBgf;
        "pkg-3.0-159" = _G9Y2HAkn;
        "pkg-3.0-160" = _bo9pTq3C;
        "pkg-3.0-161" = _dBO3iyuI;
        "pkg-3.0-162" = _HsODxUK3;
        "pkg-3.0-163" = _OhNR1wZt;
        "default" = _OhNR1wZt;
    });
