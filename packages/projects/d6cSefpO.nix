...
let
    ...
    in {
        ...
        "pkg-1.3.1" = _Iy0nnP4D;
        "pkg-2.0.1" = _zA20LtRe;
        "pkg-2.0.11" = _aIcJkUxQ;
        "pkg-3.0.0+3" = _NJpR3Z91;
        "pkg-3.0.0+4" = _hjWS2qik;
        "pkg-3.0.0+5" = _24zM40Gt;
        "pkg-3.0.0+6" = _mnCpvNNJ;
        "pkg-2.0.13" = _IeOQ4NqA;
        "pkg-3.0.1" = _dlyb8zWk;
        "pkg-3.0.2" = _o6VJVb0y;
        "pkg-3.0.3" = _rBuGCiQd;
        "pkg-2.0.14" = _xacOeCKZ;
        "pkg-3.0.4" = _50fdcUua;
        "pkg-2.0.15" = _M1q9VmFx;
        "pkg-3.0.5" = _BclnmgrR;
        "pkg-2.0.16" = _VGoAae8o;
        "pkg-2.0.17" = _PDoYDmdt;
        "pkg-3.0.6" = _tqFe3Nbm;
        "pkg-3.0.7" = _fp2DgqCZ;
        "pkg-3.0.8" = _H50b5s4f;
        "pkg-2.0.19" = _2yvHlQE1;
        "pkg-2.1.0" = _IS45Xmns;
        "pkg-3.1.0" = _4R7llRmJ;
        "pkg-3.1.1" = _6liLIVca;
        "pkg-2.1.1" = _up1seAQi;
