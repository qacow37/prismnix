...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _EelCZHiQ;
        "pkg-1.20.1-v1.0.1" = _kCRZL5mm;
        "pkg-1.21.1-v1.0.1(BUGGED)" = _zWzbQmpw;
        "pkg-1.21.1-v1.1.2" = _Czfw8psQ;
        "pkg-1.20.1-v1.1.3" = _xovwHOJN;
        "pkg-1.1.5" = _RXzCii7z;
        "pkg-1.1.6" = _TxM0Ubwc;
        "pkg-1.1.7-BETATEST" = _EGNpZjzI;
        "pkg-1.1.7-BETATEST-v4" = _UMqeTGCF;
        "pkg-1.7.1" = _roe6AapF;
        "pkg-1.8.1" = _f1OVSgDR;
        "pkg-1.8.1-st" = _gEnfeBfH;
        "pkg-1.8.1-sinytra_fix" = _NuBmK0wi;
        "pkg-1.9.0" = _f91KA8pP;
        "pkg-1.9.1-forge-1.20.1" = _d45211NZ;
        "pkg-1.9.2-forge-1.20.1" = _zdKQL6qr;
        "pkg-1.9.3-forge-1.20.1" = _1WbpViSQ;
        "pkg-1.9.4-forge-1.20.1" = _nXEgnFGh;
        "pkg-1.10.1-forge-1.20.1" = _Tfx8p8Qs;
        "pkg-1.10.2-neoforge-1.21.1" = _KQg1WdXq;
        "pkg-1.10.2-forge-1.20.1" = _nqVGl7BE;
        "pkg-1.10.3-neoforge-1.21.1" = _e6t9dR2G;
        "default" = _e6t9dR2G;
    });
