...
let
    ...
    in {
        ...
        "pkg-1.5.7" = _F2zmW5te;
        "pkg-1.5.8s" = _EFdHKd5U;
        "pkg-1.5.8_1s" = _6oDIKWgs;
        "pkg-1.5.9stable" = _Gk3ePQ46;
        "pkg-1.5.10stable" = _Bdr04Jpi;
        "pkg-1.6" = _PU7q3Ijs;
        "pkg-1.6.2" = _d1jtUyV6;
        "pkg-1.6.2.1" = _15YHQYhp;
        "pkg-1.6.3" = _N4MNUwRz;
        "pkg-1.6.4" = _1IX4lM6g;
        "pkg-1.6.4_1" = _42eoTIkC;
        "pkg-1.6.5" = _wK4y1zW8;
        "pkg-1.6.6" = _eOIGOd5Z;
        "pkg-1.6.7stb" = _d8ZmL0dl;
        "pkg-1.6.8s" = _YxbkWDxe;
        "pkg-1.6.9stb" = _7FZP46Se;
        "pkg-1.6.10stb" = _wugCkYkF;
        "pkg-1.6.11stb" = _Juc6ardv;
        "pkg-1.6.12stb" = _8pJwQXIS;
        "pkg-1.6.13stb" = _MiRYPI0u;
        "pkg-1.6.14stb" = _VVEDvopw;
        "pkg-1.6.15stb" = _fg7pUYbM;
        "pkg-1.6.16stb" = _KG4F7nw2;
        "pkg-1.6.17stb" = _9lEjHevB;
        "pkg-1.6.18stb" = _htFmEY1P;
        "pkg-1.6.19stb" = _TRh74A4X;
        "pkg-1.6.20stb" = _U092FbeX;
        "pkg-1.6.21stb" = _MIqToi2X;
        "pkg-1.6.22stb" = _HYbcxMTY;
        "pkg-1.6.23exp" = _TWpVkZHG;
        "pkg-1.6.21_1" = _4bPmcJgw;
        "pkg-1.6.24" = _MZHg8lH2;
        "pkg-1.6.25exp" = _V5fxEaXv;
        "pkg-1.6.26exp" = _7jq6GH6W;
        "pkg-1.6.27exp" = _ptE4IFzQ;
        "pkg-1.6.28exp" = _dHrRfAuj;
        "pkg-1.6.29exp" = _JVJezVaf;
        "pkg-1.6.30exp" = _KY8ketxD;
        "pkg-1.6.31exp" = _boMxAidR;
        "pkg-1.6.32uns" = _qU1wCa5C;
        "pkg-1.6.33uns" = _53HSP5WX;
        "pkg-1.6.34uns" = _XCOt73HF;
        "pkg-1.6.35uns" = _e1AGZeoF;
        "pkg-1.6.35_1uns" = _bxVVSC7x;
        "default" = _bxVVSC7x;
    });
