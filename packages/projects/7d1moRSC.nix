...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _ci6h4Asu;
        "pkg-1.18.2-2.0-fabric" = _zTrCHgpc;
        "pkg-1.19.2-2.2-fabric" = _eKmk8t1B;
        "pkg-1.16.5-1.5-forge" = _CPqVjWLL;
        "pkg-1.18.2-1.7-forge" = _wmaIvNPV;
        "pkg-1.19.2-1.9-forge" = _VbkFGyoQ;
        "pkg-1.16.5-2.3-fabric" = _T8kkW8KV;
        "pkg-1.18.2-2.3-fabric" = _vMi3AR7X;
        "pkg-1.19.2-2.3-fabric" = _ZqSu4UUa;
        "pkg-1.19.3-2.4-fabric" = _oJV487kV;
        "pkg-1.19.3-1.9-forge" = _DkRoSMPB;
        "pkg-1.18.2-3.0-forge+fabric" = _VcCXPIkR;
        "pkg-1.19.2-3.0-forge+fabric" = _YbXqGMGk;
        "pkg-1.19.3-3.0-forge+fabric" = _3znprN3E;
        "pkg-1.19.4-3.0-forge+fabric" = _sata8uPc;
        "pkg-1.20-3.0-forge+fabric" = _EZFjqWA5;
        "pkg-1.20.1-3.0-forge+fabric" = _vzzIa5JC;
        "pkg-1.20.2-3.0-forge+fabric" = _uPaUC13g;
        "pkg-1.18.2-3.1-forge+fabric" = _lBZxDlvq;
        "pkg-1.19.2-3.1-forge+fabric" = _Rq39zmAN;
        "pkg-1.20.1-3.1-forge+fabric" = _PXF38ZT6;
        "pkg-1.20.2-3.1-forge+fabric" = _GyG91ApE;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _boAZXNFB;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _BUoJ51Si;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _C94XeEVQ;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _DooRrUvf;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _DbnSX9kS;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _VzWbMZQX;
        "pkg-1.19.2-3.3-fabric+forge" = _CQ6kG2dI;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _SJbHEWIB;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _Rtgpd2CF;
        "pkg-1.20.5-3.3-fabric+neo" = _qRzY7ree;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _OPKO8yNK;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _Wh4qaeae;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _egihRelC;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _m8jwZCrd;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _aG23hfGH;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _yv9VMD9O;
        "pkg-1.21.2-3.4-fabric+neo" = _N1tD5AfA;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _16fI2iVa;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _VBFj6d6Y;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _HbDGkBw9;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _RtgmR19R;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _5RSnUo2Q;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _4hOXK02B;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _rY0aDldx;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _qIyi15Qo;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _wHW2sITl;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _YzMfz746;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _Cg03fFkV;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _k0pg0evk;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _cInh9IEZ;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _qlxMhhHK;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _8ctORbcs;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _NrAFMbzA;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _XOhwSol5;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _P9b7YgPG;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _VHyGQ0Ig;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _hLffy2Cl;
        "default" = _hLffy2Cl;
    });
