...
let
    ...
    in {
        ...
        "pkg-mc1.18.2-v0.0.1" = _Jjkl6d1e;
        "pkg-mc1.20.2-v0.0.1" = _LTMO2QJm;
        "pkg-mc1.20.1-v0.0.1" = _7uFWJrky;
        "pkg-mc1.21-v0.0.1" = _93mxuRWi;
        "pkg-mc1.20-v0.0.1" = _dD13aUNG;
        "pkg-mc1.20.5-v0.0.1" = _BO7CKSA0;
        "pkg-mc1.16.5-v0.0.1" = _20Gy4pu6;
        "pkg-mc1.17.1-v0.0.1" = _3SQEdZv8;
        "pkg-mc1.20.6-v0.0.1" = _WC8CngYB;
        "pkg-mc1.20.3-v0.0.1" = _DC9tewPC;
        "pkg-mc1.19.4-v0.0.1" = _kGqcMoGf;
        "pkg-mc1.20.4-v0.0.1" = _mFGnq7Nz;
        "pkg-mc1.18.2-v1.0.0" = _HohLAwIc;
        "pkg-mc1.16.5-v1.0.0" = _9LD3H9nJ;
        "pkg-mc1.20.2-v1.0.0" = _gEyNTWoq;
        "pkg-mc1.19.4-v1.0.0" = _CVpVFr4E;
        "pkg-mc1.20-v1.0.0" = _hgMLN8H9;
        "pkg-mc1.20.5-v1.0.0" = _6VsGPFgV;
        "pkg-mc1.21-v1.0.0" = _B8bKSBbN;
        "pkg-mc1.20.3-v1.0.0" = _3PRL0x6g;
        "pkg-mc1.17.1-v1.0.0" = _qoaannKz;
        "pkg-mc1.20.6-v1.0.0" = _pit2BYGg;
        "pkg-mc1.20.1-v1.0.0" = _RqpOqstN;
        "pkg-mc1.20.4-v1.0.0" = _6wBJ2sV5;
        "pkg-mc1.20.3-v1.0.1" = _E0mGPrvD;
        "pkg-mc1.20.2-v1.0.1" = _mQPwwgUx;
        "pkg-mc1.16.5-v1.0.1" = _YWAZ8o1T;
        "pkg-mc1.19.4-v1.0.1" = _B9sXbHxw;
        "pkg-mc1.20.1-v1.0.1" = _gbEQCrkh;
        "pkg-mc1.17.1-v1.0.1" = _nXwcnrix;
        "pkg-mc1.18.2-v1.0.1" = _Qq70JmLC;
        "pkg-mc1.21.1-v1.0.1" = _wiQ2uxlG;
        "pkg-mc1.21-v1.0.1" = _Mb4N4rKY;
        "pkg-mc1.20.4-v1.0.1" = _MxMljkzY;
        "pkg-mc1.20.6-v1.0.1" = _L6KpZkdA;
        "pkg-mc1.20.5-v1.0.1" = _ZX9Ytrqk;
        "pkg-mc1.20-v1.0.1" = _ZQC1GrgZ;
        "pkg-mc1.16.5-v1.0.2" = _Q2YaHnmx;
        "pkg-mc1.20-v1.0.2" = _1G0FJZGC;
        "pkg-mc1.20.1-v1.0.2" = _8kqFGDa0;
        "pkg-mc1.18.2-v1.0.2" = _2NBFiNYW;
        "pkg-mc1.20.5-v1.0.2" = _6RMoT9ct;
        "pkg-mc1.20.2-v1.0.2" = _lZeyZM4K;
        "pkg-mc1.19.4-v1.0.2" = _s44E8V7A;
        "pkg-mc1.20.4-v1.0.2" = _f79s6yXL;
        "pkg-mc1.21.1-v1.0.2" = _W01V66PA;
        "pkg-mc1.20.3-v1.0.2" = _BEKpXfRJ;
        "pkg-mc1.21-v1.0.2" = _TUHysbbR;
        "pkg-mc1.17.1-v1.0.2" = _P3H4gcLP;
        "pkg-mc1.20.6-v1.0.2" = _LPGbsRdw;
        "pkg-mc1.19.4-v1.0.3" = _yDMDEiQ5;
        "pkg-mc1.17.1-v1.0.3" = _vFJvS0jh;
        "pkg-mc1.21.4-v1.0.3" = _oirkDvOv;
        "pkg-mc1.18.2-v1.0.3" = _sbSyPYKL;
        "pkg-mc1.16.5-v1.0.3" = _1T1MpT9n;
        "pkg-mc1.20.6-v1.0.3" = _gXSNVLHV;
        "pkg-mc1.20.6-v1.1.0" = _IASCKEeO;
        "pkg-mc1.16.5-v1.1.0" = _n6wWtVLx;
        "pkg-mc1.19.4-v1.1.0" = _78N1lEtT;
        "pkg-mc1.18.2-v1.1.0" = _nc63NWGN;
        "pkg-mc1.17.1-v1.1.0" = _qGwd1ftH;
        "pkg-mc1.21.4-v1.1.0" = _linKHCHI;
        "pkg-mc1.17.1-v1.1.1" = _6An99kih;
        "pkg-mc1.19.4-v1.1.1" = _wNkNu5jc;
        "pkg-mc1.20.6-v1.1.1" = _jiDxCogd;
        "pkg-mc1.21.4-v1.1.1" = _4vWjwyIo;
        "pkg-mc1.21.5-v1.1.1" = _zyBdkzsB;
        "pkg-mc1.18.2-v1.1.1" = _kA3cROUN;
        "pkg-mc1.16.5-v1.1.1" = _iXYAfakB;
        "pkg-mc1.18.2-v1.1.2" = _j224MNm3;
        "pkg-mc1.21.5-v1.1.2" = _huEgwbAQ;
        "pkg-mc1.19.4-v1.1.2" = _xJ90Gx6r;
        "pkg-mc1.17.1-v1.1.2" = _MUNEL7cj;
        "pkg-mc1.21.6-v1.1.2" = _fk2bHnDo;
        "pkg-mc1.16.5-v1.1.2" = _ahZaN8l0;
        "pkg-mc1.20.6-v1.1.2" = _UaIJW6wB;
        "pkg-mc1.21.4-v1.1.2" = _arzFVz0Y;
        "pkg-mc1.20.6-v1.1.3" = _H6D9Fxyu;
        "pkg-mc1.17.1-v1.1.3" = _miWM7RzH;
        "pkg-mc1.21.6-v1.1.3" = _GGQ0QXYO;
        "pkg-mc1.16.5-v1.1.3" = _yIMEr6W3;
        "pkg-mc1.19.4-v1.1.3" = _EFAYk1h6;
        "pkg-mc1.18.2-v1.1.3" = _gIddFj3u;
        "pkg-mc1.21.5-v1.1.3" = _TFM3bnb3;
        "pkg-mc1.21.4-v1.1.3" = _9fOJBNA0;
        "default" = _9fOJBNA0;
    });
