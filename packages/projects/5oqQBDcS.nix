...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha.3" = _ayb65YWh;
        "pkg-1.0.0-beta" = _qlhmKLEJ;
        "pkg-1.0.0-beta.1" = _VpHSsHmu;
        "pkg-1.0.0-beta.2" = _bOJw7NH9;
        "pkg-1.0.0-beta.3" = _WZKYUJZt;
        "pkg-1.21.1-1.0.0" = _vMc3KueH;
