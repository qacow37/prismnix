...
let
    ...
    in {
        ...
        "pkg-1.6.1" = _rK3JYiIr;
        "pkg-1.7.0" = _EFEQx62B;
        "pkg-1.8.1+1.20.2" = _spUi8TNo;
        "pkg-1.8.1+1.20.4" = _seRANa4r;
        "pkg-1.8.1+1.20.1" = _m2uDJixB;
        "pkg-1.8.2+1.20.6" = _QyJ0iDZA;
        "pkg-1.8.2+1.20.4" = _LRLnBgNK;
        "pkg-1.8.2+1.20.2" = _k0fKDV1M;
        "pkg-1.8.2+1.20.1" = _mcgPuTSm;
        "pkg-1.8.3+1.21" = _xKjg2DGw;
        "pkg-1.8.3+1.20.6" = _HymIJz5H;
        "pkg-1.8.3+1.20.4" = _KogGp6kv;
        "pkg-1.8.3+1.20.2" = _RHicOk4d;
        "pkg-1.8.3+1.20.1" = _1gqYXlq6;
        "pkg-1.8.4+1.21" = _BXE09dWX;
        "pkg-1.8.4+1.20.6" = _fRxiW8Yd;
        "pkg-1.8.4+1.20.2" = _bgIuAmf4;
        "pkg-1.8.4+1.20.4" = _TCbcVtBX;
        "pkg-1.8.4+1.20.1" = _clMBLvv7;
        "pkg-1.9.0+1.21" = _jahrQkA0;
        "pkg-1.9.0+1.20.2" = _dFBaX3ph;
        "pkg-1.9.0+1.20.4" = _odTEbjqm;
        "pkg-1.9.0+1.20.6" = _qgw7EVHu;
        "pkg-1.9.0+1.20.1" = _DJniceCl;
        "pkg-1.9.1+1.20.6" = _Ho2FNZlD;
        "pkg-1.9.1+1.21" = _dCw8DnhC;
        "pkg-1.9.1+1.20.4" = _EQnLGPXn;
        "pkg-1.9.1+1.20.2" = _mBZIFEiu;
        "pkg-1.9.1+1.20.1" = _DDlcXohM;
        "pkg-1.9.2+1.21.4" = _qhkLHk3c;
        "pkg-1.9.2+1.21.3" = _K8l0Ftlr;
        "default" = _K8l0Ftlr;
    });
