...
let
    ...
    in {
        ...
        "pkg-0.0.1" = _6r5RFU7Z;
        "pkg-0.0.2+1.19.2" = _poO30PuC;
        "pkg-0.1.0+1.19.3" = _DUeu0vb9;
        "pkg-0.1.1+1.19.3" = _hy9q99Iv;
        "pkg-0.2.0+1.19.4" = _XotuDelt;
        "pkg-0.0.3+1.19.2" = _nTEpg4cq;
        "pkg-0.3.0+1.20.0" = _NQ9wedmU;
        "pkg-0.4.0+1.20.1" = _sZpVjhCs;
        "pkg-0.5.0+1.20.2" = _IjeFXCo3;
        "pkg-0.6.0+1.20.4" = _GtGTP523;
        "pkg-0.6.1+1.20.4" = _FSBrJbuQ;
        "pkg-0.7.0+1.20.5" = _G00hX4il;
        "pkg-0.8.0+1.21" = _sVMm79CA;
        "pkg-0.8.1+1.21" = _cdwTkL8k;
        "pkg-0.9.0+1.21.1" = _Yrqbb2TS;
        "pkg-0.11.0+1.21.3" = _dF6jRbMR;
        "pkg-0.12.0+1.21.3" = _sUALKasN;
        "pkg-0.12.1+1.21.3" = _o3bK7xhw;
        "pkg-0.13.0+1.21.4" = _BPZvgc1b;
        "pkg-0.14.0+1.21.5" = _wFLZ1uHM;
        "pkg-0.15.0+1.21.6" = _AEjhQsdA;
        "pkg-0.16.0+1.21.7" = _95wzmeG8;
        "pkg-0.17.0+1.21.8" = _zbH7XYnE;
        "pkg-0.18.0+1.21.9" = _QJ9a2F3d;
        "pkg-0.18.1+1.21.9" = _GXHLGsSf;
        "pkg-0.19.0+1.21.10" = _dy4wzFRW;
        "pkg-0.19.1+1.21.10" = _FSkoWYfS;
        "pkg-0.20.0+1.21.11" = _Flo26xGy;
        "pkg-0.21.0+1.21.11" = _JS90qCGt;
        "pkg-0.22.0+26.1.1" = _FJKY6MlJ;
        "pkg-0.23.0+26.1.2" = _Z971Ozk5;
        "pkg-0.24.0+26.2" = _UnL9JxtC;
        "default" = _UnL9JxtC;
    });
