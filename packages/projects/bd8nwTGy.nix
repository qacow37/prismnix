...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.5-fabric" = _KcuiLueX;
        "pkg-1.18.2-1.5-fabric" = _KpXbL8FX;
        "pkg-1.19.2-1.6-fabric" = _JOPuPhQ1;
        "pkg-1.16.5-1.0-forge" = _xf0SDdgd;
        "pkg-1.18.2-1.2-forge" = _FgMIy5O8;
        "pkg-1.19.2-1.4-forge" = _eMJnWLnl;
        "pkg-1.16.5-1.7-fabric" = _Kg7qy60M;
        "pkg-1.18.2-1.7-fabric" = _Gys8QCgF;
        "pkg-1.19.2-1.7-fabric" = _tbJkMF8O;
        "pkg-1.19.3-1.8-fabric" = _vwJGY5ab;
        "pkg-1.19.3-1.4-forge" = _Wo1lHFkd;
        "pkg-1.18.2-2.0-forge+fabric" = _Tl88VzpK;
        "pkg-1.19.2-2.0-forge+fabric" = _OTg9rb7l;
        "pkg-1.19.3-2.0-forge+fabric" = _uNj0EuYG;
        "pkg-1.19.4-2.0-forge+fabric" = _e2577K6C;
        "pkg-1.20-2.0-forge+fabric" = _36eBz1IT;
        "pkg-1.20.1-2.0-forge+fabric" = _nlg1Eco9;
        "pkg-1.20.2-2.0-forge+fabric" = _DsO2WwLu;
        "pkg-1.18.2-2.1-forge+fabric" = _rak5Mt27;
        "pkg-1.19.2-2.1-forge+fabric" = _qMTMHySn;
        "pkg-1.20.1-2.1-forge+fabric" = _YE08ghDV;
        "pkg-1.20.2-2.1-forge+fabric" = _jJNVg5FE;
        "pkg-1.20.3-2.1-fabric+forge+neo" = _wGYSSq2i;
        "pkg-1.20.4-2.1-fabric+forge+neo" = _yhKLtdaQ;
        "pkg-1.19.2-2.2-fabric+forge+neo" = _EON9WgRS;
        "pkg-1.20.1-2.2-fabric+forge+neo" = _oGl19qoA;
        "pkg-1.20.2-2.2-fabric+forge+neo" = _ORpQSzSH;
        "pkg-1.20.4-2.2-fabric+forge+neo" = _tCu017P7;
        "pkg-1.20.5-2.2-fabric+neo" = _lrPsxynK;
        "pkg-1.20.6-2.2-fabric+forge+neo" = _tTGIVd3p;
        "pkg-1.21.0-2.2-fabric+forge+neo" = _TbY75QiR;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _uo0M05mk;
        "pkg-1.20.6-2.3-fabric+forge+neo" = _vq0aCi2W;
        "pkg-1.21.0-2.3-fabric+forge+neo" = _5tfM6FzG;
        "pkg-1.21.1-2.3-fabric+forge+neo" = _huTN8X9Y;
        "pkg-1.21.2-2.3-fabric+neo" = _dBZfxwcj;
        "pkg-1.21.3-2.3-fabric+forge+neo" = _1iOohfR5;
        "pkg-1.21.4-2.3-fabric+forge+neo" = _SUEOYtOv;
        "pkg-1.20.1-2.4-fabric+forge+neo" = _G6Hp26aj;
        "pkg-1.21.1-2.4-fabric+forge+neo" = _s2Ff8GFL;
        "pkg-1.21.4-2.4-fabric+forge+neo" = _AgMWWTzG;
        "pkg-1.21.5-2.4-fabric+forge+neo" = _CMlNj4Ju;
        "pkg-1.21.6-2.4-fabric+forge+neo" = _uQRz2uKY;
        "pkg-1.21.7-2.4-fabric+forge+neo" = _Szz7Xk5m;
        "pkg-1.21.8-2.4-fabric+forge+neo" = _sbursSZZ;
        "pkg-1.21.9-2.4-fabric+forge+neo" = _PFhPeLNq;
        "pkg-1.21.9-2.5-fabric+forge+neo" = _WPnpt3be;
        "pkg-1.21.10-2.5-fabric+forge+neo" = _EZpxOAFv;
        "pkg-1.21.11-2.5-fabric+forge+neo" = _xGzeyADa;
        "pkg-26.1.0-2.5-fabric+forge+neo" = _o6q5AeNo;
        "pkg-26.1.1-2.5-fabric+forge+neo" = _HR6OCCcf;
        "pkg-26.1.2-2.5-fabric+forge+neo" = _wanlh2Ln;
        "pkg-26.2.0-2.5-fabric+forge+neo" = _7R7j6qiw;
        "default" = _7R7j6qiw;
    });
