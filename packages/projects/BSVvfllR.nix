...
let
    ...
    in {
        ...
        "pkg-1.6.1+1.19.4" = _xVwExGR9;
        "pkg-1.6.2+1.20.1" = _FLBGICpk;
        "pkg-1.6.3+1.20.1" = _gBRthCjF;
        "pkg-1.6.4+1.20.2" = _MOM1Y1AS;
        "pkg-1.5.3+1.18" = _OkAPnU7c;
        "pkg-1.7+1.20.2" = _x4YnSSHb;
        "pkg-1.7.1+1.20.4" = _9sxYf1N4;
        "pkg-1.7.1+1.20.1" = _bpY7aXUm;
        "pkg-1.8+1.20.1" = _Wo8mhgDQ;
        "pkg-1.8+1.20.4" = _p2LOZ5EO;
        "pkg-1.8+1.20.6" = _Qs4vuNAk;
        "pkg-1.8.1+1.20.1" = _vDEKmcqj;
        "pkg-1.8.1+1.20.6" = _bIPdy96D;
        "pkg-1.8.2+1.20.1" = _5c6HpJfx;
        "pkg-1.8.2+1.20.6" = _FwMHRI8V;
        "pkg-1.8.2+1.21" = _4qgFrIbf;
        "pkg-1.8.3+1.21" = _Yupm62q4;
        "pkg-1.8.3+1.21.3" = _U4QRA6vk;
        "pkg-1.8.4+1.21.4" = _gJRES2tC;
        "pkg-1.9+1.21.4" = _W9KJp5iz;
        "pkg-1.9.1+1.21.5" = _xuyu5hll;
        "pkg-1.9.2+1.21.6" = _N7VlGfeq;
        "pkg-1.9.2+1.21.9" = _nNqsPjdz;
        "default" = _nNqsPjdz;
    });
