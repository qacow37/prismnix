...
let
    ...
    in {
        ...
        "pkg-mc1.17.1-v0.1.0.1" = _1bg31cVL;
        "pkg-mc1.17.1-v0.1.4.0" = _aGoMse66;
        "pkg-mc1.17.1-v0.1.4.3" = _OXvtY7jb;
        "pkg-mc1.17.1-v0.1.4.5" = _Rp1HcNfR;
        "pkg-mc1.18-v0.5" = _VQoP3PTU;
        "pkg-mc1.17.1-v0.5" = _Ngvxyzy1;
        "pkg-mc1.17-v0.5" = _BjaGbhtW;
        "pkg-mc1.18.1-v0.5" = _mb1tm2Sk;
        "pkg-mc1.18.2-v0.5" = _nojJV38U;
        "pkg-mc1.19-v0.5" = _iVRKAk6M;
        "pkg-mc1.17-v1.0.2.0" = _6KwLFA1q;
        "pkg-mc1.17.1-v1.0.2.0" = _NWwMIwtM;
        "pkg-mc1.18-v1.0.2.0" = _JnqlgTqf;
        "pkg-mc1.18.1-v1.0.2.0" = _OWiX7y2q;
        "pkg-mc1.18.2-v1.0.2.0" = _y04dBJYE;
        "pkg-mc1.19-v1.0.2.0" = _NH4EAPZ0;
        "pkg-mc1.19.1-v1.0.2.0" = _Jx6ZDsDW;
        "pkg-mc1.19.2-v1.0.2.0" = _6ySR2oLV;
        "pkg-mc1.17-v1.4.0.2" = _88K2eyMF;
        "pkg-mc1.17.1-v1.4.0.2" = _PkJj1CAv;
        "pkg-mc1.18-v1.4.0.2" = _UHJeWfnH;
        "pkg-mc1.18.1-v1.4.0.2" = _pofwQCPB;
        "pkg-mc1.18.2-v1.4.0.2" = _gMkzDLkn;
        "pkg-mc1.19-v1.4.0.2" = _9OamICok;
        "pkg-mc1.19.1-v1.4.0.2" = _oFbZNaDe;
        "pkg-mc1.19.3-v1.4.0.2" = _UUQvVph1;
        "pkg-mc1.19.4-v1.4.0.2" = _g5RgKkTW;
        "pkg-mc1.20-v1.4.0.2" = _QKsTrcoB;
        "pkg-mc1.20.1-v1.4.0.2" = _Q2MkVucd;
        "pkg-mc1.20.2-v1.4.0.2" = _JbsIPcYq;
        "pkg-mc1.19.2-v1.4.0.2" = _vUxVXv17;
        "pkg-mc1.17.1-v1.6.3.0" = _b5lI9boW;
        "pkg-mc1.18-v1.6.3.0" = _rMzg1keS;
        "pkg-mc1.18.1-v1.6.3.0" = _UHAdjnzQ;
        "pkg-mc1.18.2-v1.6.3.0" = _brMw9yki;
        "pkg-mc1.19-v1.6.3.0" = _PhdKVogY;
        "pkg-mc1.19.1-v1.6.3.0" = _Q4JNYDpr;
        "pkg-mc1.19.2-v1.6.3.0" = _q16qRwM1;
        "pkg-mc1.19.3-v1.6.3.0" = _wzAPTCVE;
        "pkg-mc1.19.4-v1.6.3.0" = _CsaYQYeZ;
        "pkg-mc1.20-v1.6.3.0" = _OW4EP5oB;
        "pkg-mc1.20.1-v1.6.3.0" = _oo2j3lOY;
        "pkg-mc1.20.2-v1.6.3.0" = _HIwVdxio;
        "pkg-mc1.20.3-v1.6.3.0" = _eqo64iGj;
        "pkg-mc1.20.4-v1.6.3.0" = _j1k5ZZFu;
        "default" = _j1k5ZZFu;
    });
