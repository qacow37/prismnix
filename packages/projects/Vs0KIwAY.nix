...
let
    ...
    in {
        ...
        "pkg-1.3.2.2" = _XTseYBDN;
        "pkg-1.3.2.1" = _XeaNx0CE;
        "pkg-1.0.0" = _NzPqwEui;
        "pkg-1.3.3.0" = _PgLjnxcV;
        "pkg-1.3.3.1" = _rhLm6Qzx;
        "pkg-1.4.2.0" = _wjTD7jDk;
        "pkg-1.4.2.1" = _CW7G9psj;
        "pkg-1.5.0.1" = _gwESFrxK;
        "pkg-1.5.0.0" = _ZBf33klH;
        "pkg-1.5.1" = _DVBKkFr4;
        "pkg-1.6.0" = _EPa3ujzB;
        "pkg-1.7.0" = _tduJMaHy;
        "pkg-1.7.1" = _3cN5FCFf;
