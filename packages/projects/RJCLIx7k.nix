...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.20-fabric" = _m5Wqcsu6;
        "pkg-1.0.1-1.20-forge" = _nZ92MJWm;
        "pkg-1.0.2-1.20-fabric" = _yalorM2L;
        "pkg-1.0.2-1.20-forge" = _p7CiR8FH;
        "pkg-1.0.2-1.20.6-fabric" = _BpJX3w7j;
        "pkg-1.0.2" = _4pjahkVL;
        "pkg-1.0.2-1.21-fabric" = _nhJ6uMen;
        "pkg-1.0.2-1.21-neoforge" = _sQL2OF9h;
        "pkg-1.1.2-1.20-fabric" = _99AxpUyz;
        "pkg-1.1.2-1.20.4-fabric" = _BsXBQoNZ;
        "pkg-1.1.2-1.20.6-fabric" = _FIajKdo1;
        "pkg-1.1.2-1.21-fabric" = _QpHNGiti;
        "pkg-1.1.2-1.20-forge" = _1sEtaMzu;
        "pkg-1.1.2-1.20.4" = _H3ECQSQf;
        "pkg-1.1.2-1.20.6-neoforge" = _Pudukr13;
        "pkg-1.1.2-1.21-neoforge" = _DXnH655C;
        "pkg-1.1.3-1.21-fabric" = _qCFfCIn1;
        "pkg-1.1.3-1.21-neoforge" = _RQ02l3qe;
        "pkg-1.1.4-1.21-fabric" = _C6p0KHv2;
        "pkg-1.1.4-1.21-neoforge" = _6yowsbbz;
        "pkg-1.2.4-1.21-fabric" = _JxfKbn59;
        "pkg-1.2.4-1.21-neoforge" = _lZSIxFAA;
        "pkg-1.2.5-1.21-fabric" = _2gsiuhUY;
        "pkg-1.2.5-1.21-neoforge" = _qdX9XnnM;
        "pkg-1.2.6-1.20-fabric" = _UZtmjsBR;
        "pkg-1.2.6-1.20.6-fabric" = _jHM62O4b;
        "pkg-1.2.6-1.20-forge" = _D0XPz6XY;
        "pkg-1.2.6-1.20.4" = _QAoF3ACs;
        "pkg-1.2.6" = _9uynDJXm;
        "pkg-1.2.6-1.21-fabric" = _6m2Qi2ND;
        "pkg-1.2.7-1.21-fabric" = _ho26hINu;
        "pkg-1.2.7-1.21-neoforge" = _taSxUk0k;
        "pkg-1.2.7-1.20-fabric" = _orJQCr9i;
        "pkg-1.2.7-1.20-forge" = _Jnoe6jQy;
        "pkg-1.2.7-1.20.4" = _SxD9VU0K;
        "pkg-1.2.7-1.20.6-fabric" = _1clAWab6;
        "pkg-1.2.7-1.20.6-neoforge" = _fcS243m6;
        "pkg-1.3.0-1.21" = _tKsKnBac;
        "pkg-1.3.1-1.21.4" = _ynLTj6ca;
        "pkg-1.2.8-1.21" = _rQ6bUOhA;
        "pkg-1.3.2-1.21.4" = _XYKLBNWO;
        "pkg-1.3.3-1.21.5" = _8a0FvCHN;
        "pkg-1.3.4-1.21.5" = _xoOPvVYF;
        "pkg-1.3.3-1.21.4" = _X6EjoMBM;
        "pkg-1.3.5-1.21.4" = _5HeOJO45;
        "pkg-1.3.5-1.21.5" = _CltPEaM3;
        "pkg-1.3.5-1.21-fabric" = _V3AIsiJE;
        "pkg-1.3.5-1.21-neoforge" = _SKQK5lSw;
        "pkg-1.3.6-1.21.5-6" = _OvXYq2Jd;
        "pkg-1.3.6-1.21.7" = _koHDDSaP;
        "pkg-1.3.6-1.21.8" = _DIIzwa6g;
        "pkg-1.3.7-1.21.9" = _hdc7duZX;
        "pkg-1.3.8-1.21.9-1.21.10" = _WDQrnFSY;
        "pkg-2.0.0" = _RRBfX8c4;
        "pkg-2.0.2" = _WNRZbckE;
        "pkg-2.1.0" = _BoUtV92U;
        "pkg-2.1.2" = _i1RQPVjQ;
