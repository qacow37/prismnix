...
let
    ...
    in {
        ...
        "pkg-v.1.2.1c" = _C5WFaicP;
        "pkg-v.1.2.7" = _CHPur8iH;
        "pkg-v.1.2.8" = _isSM96wv;
        "pkg-1.2.9" = _bBjilyMA;
        "pkg-v.1.3.0" = _j7nHovYj;
        "pkg-1.4.0" = _2mZRuCxv;
        "pkg-v.1.4.1" = _ayqYWJhM;
        "pkg-v.1.4.2" = _I0wHBaZk;
        "pkg-v.1.5.0" = _AWq6mPU1;
        "pkg-v.1.5.1" = _EfMEWbTY;
        "pkg-v.1.6.0" = _EhBT8Arl;
        "pkg-v.1.6.1" = _YYuODsmZ;
        "pkg-v.1.6.2" = _499whisn;
        "pkg-v.1.6.3" = _JZR3f0QB;
        "pkg-v.1.7.0" = _XawfUdWx;
        "pkg-v.1.7.1" = _EbpSZBxV;
        "pkg-v.1.7.2" = _9HMsPB0Q;
        "pkg-v.1.8.0" = _lUnXuBgN;
        "pkg-v.1.8.1" = _B1twaZ4l;
        "pkg-v.1.8.2" = _mAn8HLxB;
        "pkg-v.1.8.3" = _iiS46Gi0;
        "pkg-v.1.7.3" = _gTrZp44b;
        "pkg-v.2.0.0" = _pPETQhxU;
        "pkg-v.1.7.4" = _OCZIyHpu;
        "pkg-v.3.0.0" = _DIs1Ygc1;
        "pkg-v.3.0.1" = _dmu0uNZG;
        "pkg-v.3.1.0" = _iZNZxhrL;
        "pkg-v.4.0.0" = _lnya94yM;
        "pkg-v.4.1.0" = _LQsJCt88;
        "pkg-v.4.2.0" = _FRNpJhuD;
        "default" = _FRNpJhuD;
    });
