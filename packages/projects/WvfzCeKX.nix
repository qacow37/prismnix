...
let
    ...
    in {
        ...
        "pkg-1.2.3" = _fAJQcpTQ;
        "pkg-1.2.4" = _Kd1Giy2v;
        "pkg-1.2.5+Forge-1.16.2" = _hQpkEJSV;
        "pkg-1.2.5+Forge-1.17.1" = _jwGi5qde;
        "pkg-1.2.5+Forge-1.18" = _ehDuiBzq;
        "pkg-1.2.5+Forge-1.18.2" = _mauYfIQr;
        "pkg-1.2.5+Fabric-1.18.2" = _iTuPUf7k;
        "pkg-1.2.5+Forge-1.19" = _KU2IiY4e;
        "pkg-1.2.5+Fabric-1.19" = _Ap6PUsiQ;
        "pkg-1.2.5+Forge-1.19.4" = _i4bha3R9;
        "pkg-1.2.5+Fabric-1.19.3" = _NDxAMQ4o;
        "pkg-1.2.5+Forge-1.20.2" = _uT8h8MBJ;
        "pkg-1.2.5+Fabric-1.20.2" = _tr0V0dJK;
        "pkg-1.2.5+Forge-1.20.6" = _UPlwjbDg;
        "pkg-1.2.5+Fabric-1.20.5" = _nmnrSQ5v;
        "pkg-1.2.5+Forge-1.21" = _ZfQrlolO;
        "pkg-1.2.5+NeoForge-1.21" = _bDEAm5dU;
        "pkg-1.2.5+Fabric-1.21" = _R4aPZrPA;
        "pkg-1.2.5+NeoForge-1.21.2" = _BXlRAcDC;
        "pkg-1.2.5+NeoForge-1.21.4" = _t2cPrm5y;
        "pkg-1.2.5+NeoForge-1.21.5" = _5uHRWEI1;
        "pkg-1.2.5+Fabric-1.21.5" = _O0pnWn7l;
        "pkg-1.2.5+NeoForge-1.21.6" = _hvKKvQVP;
        "pkg-1.2.5+Fabric-1.21.6" = _zkZjwXNZ;
        "pkg-1.2.5+NeoForge-1.21.9" = _E06H2muO;
        "pkg-1.2.5+Fabric-1.21.9" = _jp4TxNvW;
        "default" = _jp4TxNvW;
    });
