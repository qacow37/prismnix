...
let
    ...
    in {
        ...
        "pkg-1.1.1-1.16.5" = _7d0WDLqU;
        "pkg-1.1.1-1.17.1" = _4xkX5HO6;
        "pkg-1.1.1-1.18.2" = _h9sq8FxW;
        "pkg-1.1.1-1.19" = _yxnC7NLy;
        "pkg-1.1.1-1.19.3" = _wpblU743;
        "pkg-1.1.2-1.16.5" = _DsNYFrmt;
        "pkg-1.1.2-1.17.1" = _9azUnBxu;
        "pkg-1.1.2-1.18.2" = _Tostz5ol;
        "pkg-1.1.2-1.19" = _gLEjXgjX;
        "pkg-1.1.2-1.19.4" = _lY758mcy;
        "pkg-1.1.2" = _N3wU2WGx;
        "pkg-1.1.3-1.20.1" = _njnx1uS2;
        "pkg-1.1.4-1.20.1" = _WmTDKsQY;
        "pkg-1.1.5-1.19" = _pdC1IIWG;
        "pkg-1.1.5-1.19.4" = _WnSVM88i;
        "pkg-1.1.5-1.20.1" = _bHAZHyWM;
        "pkg-1.1.6-1.19" = _xoofxzHA;
        "pkg-1.1.6-1.19.4" = _xAkkpdrN;
        "pkg-1.1.6-1.20.1" = _HLWJ5nQN;
        "pkg-1.1.7-1.18.2" = _hNjgZcj6;
        "pkg-1.1.7-1.19" = _otbtCdA8;
        "pkg-1.1.7-1.19.4" = _onofBi8z;
        "pkg-1.1.7-1.20.1" = _vMsgDeRf;
        "pkg-1.1.8-1.18.2" = _IPrePvrb;
        "pkg-1.1.8-1.19" = _vGrDxyio;
        "pkg-1.1.8-1.19.4" = _cAnKlK3X;
        "pkg-1.1.8-1.20.1" = _VlAay2XV;
        "default" = _VlAay2XV;
    });
