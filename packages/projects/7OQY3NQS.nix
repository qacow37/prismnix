...
let
    ...
    in {
        ...
        "pkg-1.4" = _CBoN1Zfb;
        "pkg-1.4.1" = _Wxx5Q4xc;
        "pkg-1.4.1+1.21.2-SNAPSHOT.1" = _psT4wA5i;
        "pkg-1.5+1.21" = _zmen4RCC;
        "pkg-1.5+1.20.4" = _ojbAD09h;
        "pkg-1.5+1.21.2-SNAPSHOT.1" = _LGwowSZq;
        "pkg-1.5+1.21.2-SNAPSHOT.2" = _H5MByIIp;
        "pkg-1.6+1.21" = _k9Sl9FOQ;
        "pkg-1.7+1.21" = _Du4or6ar;
        "pkg-1.7+1.21.2-SNAPSHOT.1" = _gGbROgAc;
        "pkg-1.7+1.21.2" = _BMHXFM9h;
        "pkg-1.7+1.21.4" = _X6HnvaFi;
        "pkg-1.7+1.21.5" = _Z7Vuccpj;
        "pkg-1.7+1.21.6" = _Y4Yhk5Yo;
        "pkg-1.7+1.21.9-beta.1" = _RlLOnXOD;
        "pkg-1.7+1.21.9" = _EmcCP18i;
        "pkg-1.7+1.21.11" = _hU3ZXZVz;
        "pkg-1.8+1.21.11" = _YDU2KGYm;
        "default" = _YDU2KGYm;
    });
