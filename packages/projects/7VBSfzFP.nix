...
let
    ...
    in {
        ...
        "pkg-1.0.18-1.18.2" = _RXWq1p4z;
        "pkg-0.2.15-1.20" = _X93iwVwy;
        "pkg-1.1.20-1.18.2" = _YrJUstUx;
        "pkg-1.1.20-1.20.1" = _hiLnW3GB;
        "pkg-1.1.20-1.20.2" = _jvQ9JU6h;
        "pkg-1.1.21-1.20.1" = _Dz5J9uNz;
        "pkg-1.1.21-1.20.2" = _jGpQW1O9;
        "pkg-1.3.21-1.18.2" = _8ayNSjFi;
        "pkg-1.3.21-1.20.1" = _Ef6MJxBN;
        "pkg-1.4.22-1.18.2" = _OnWCaSqw;
        "pkg-1.4.23-1.18.2" = _ZXaxtUyJ;
        "pkg-1.4.24-1.18.2" = _KEYhTsaT;
        "pkg-1.4.25-1.18.2" = _s4JfRXIs;
        "pkg-1.4.22-1.20.1" = _oYYrfSyF;
        "pkg-1.4.23-1.20.1" = _5EwUC2Ge;
        "pkg-1.4.26-1.18.2" = _kyz5Vwg7;
        "pkg-1.4.25-1.20.1" = _TJdK7JTf;
        "pkg-1.4.27-1.18.2" = _QUQmY7Ab;
        "pkg-1.4.26-1.20.1" = _6jEnddmk;
        "pkg-1.4.27-1.20.1" = _qVqWDIx4;
        "pkg-1.5.28-1.20.1" = _CZs7k8hi;
        "pkg-1.5.28-1.18.2" = _MhlVm9NR;
        "pkg-1.5.29-1.18.2" = _P8plEOSC;
        "pkg-1.5.29-1.20.1" = _oH32EclC;
        "pkg-1.5.30-1.20.1" = _jQcCSqkq;
        "pkg-1.5.31-1.20.1" = _Rqa4My0d;
        "pkg-1.0.0-1.21" = _tpFnth8A;
        "pkg-1.0.1-1.21" = _K7WdHHCh;
        "pkg-1.0.2-1.21" = _arYKJQcy;
        "pkg-1.5.32-1.20.1" = _LjZSmUnA;
        "pkg-1.0.3-1.21" = _XBOBlHrO;
        "pkg-1.5.34-1.20.1" = _7c7riD6a;
        "pkg-1.5.35-1.20.1" = _oNfegApj;
        "pkg-1.6.36-1.20.1" = _MLDgb0Ff;
        "pkg-1.6.37-1.20.1" = _Qe5dZy8c;
        "pkg-1.7.38-1.20.1" = _BrK5Kch9;
        "pkg-1.7.39-1.20.1" = _VCoyWCU5;
        "pkg-1.1.5-1.21.1" = _ULhQY0iS;
        "pkg-1.8.41-1.20.1" = _k9c8K0pB;
        "pkg-1.8.42-1.20.1" = _wK6zgaGj;
        "pkg-1.8.43-1.20.1" = _5usn9o8L;
        "pkg-1.8.44-1.20.1" = _fL6Cv9dV;
        "pkg-1.8.45-1.20.1" = _7JFpYqSn;
        "pkg-1.8.46-1.20.1" = _UpS0O3ZR;
        "pkg-1.8.47-1.20.1" = _WgEdLKnA;
        "pkg-1.8.48-1.20.1" = _hyfDnbvO;
        "pkg-1.9.49-1.20.1" = _Z5N0uKmA;
        "pkg-1.9.50-1.20.1" = _PG6M0IM5;
        "pkg-1.2.6-1.21.1" = _RFsPEnC1;
        "pkg-1.9.51-1.20.1" = _iPToBDTI;
        "pkg-1.9.52-1.20.1" = _lVABt7gT;
        "pkg-1.9.53-1.20.1" = _AQktxtwK;
        "pkg-1.9.55-1.20.1" = _IlrUL4ac;
        "pkg-1.9.56-1.20.1" = _2lZ4kweq;
        "pkg-1.9.57-1.20.1" = _xotF2XXx;
        "pkg-1.9.58-1.20.1" = _BN3biHCR;
        "pkg-1.9.59-1.20.1" = _oS3Qdj7D;
        "pkg-1.10.60-1.20.1" = _qQYOQJfd;
        "pkg-1.10.61-1.20.1" = _EX58FBae;
        "pkg-1.10.62-1.20.1" = _2P1kZt9M;
        "pkg-1.3.7-1.21.1" = _7qvWmhoF;
        "pkg-1.10.63-1.20.1" = _SuSuKIQL;
        "pkg-1.11.64-1.20.1" = _xST1Uwsr;
        "pkg-1.11.65-1.20.1" = _9yoxX0UT;
        "pkg-1.11.66-1.20.1" = _db09bYFC;
        "pkg-1.11.67-1.20.1" = _cScqu81x;
        "pkg-1.3.8-1.21.1" = _bvdkcOWZ;
        "pkg-1.12.69-1.20.1" = _JsHSW5mP;
        "pkg-1.12.70-1.20.1" = _5y0NNgbd;
        "pkg-1.12.71-1.20.1" = _30CAnZrW;
        "pkg-1.12.72-1.20.1" = _BOqF30v2;
        "pkg-1.4.9-1.21.1" = _uApWI9mF;
        "pkg-1.4.10-1.21.1" = _3qA3HBfU;
        "pkg-1.12.73-1.20.1" = _tPupNkdu;
        "pkg-1.4.11-1.21.1" = _9vNmKSM6;
        "pkg-1.4.12-1.21.1" = _SNnrutfb;
        "default" = _SNnrutfb;
    });
