...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.18.2" = _FjMwbsHS;
        "pkg-0.1.0+1.19" = _3C9vBGk9;
        "pkg-0.1.1+1.18.2" = _5DFmIITp;
        "pkg-0.1.1+1.19" = _pvo6Xo2r;
        "pkg-0.2.0+1.18.2" = _FPgkzHD6;
        "pkg-0.2.0+1.19" = _aLExolfh;
        "pkg-0.2.1+1.18.2" = _XwsS3Ofm;
        "pkg-0.2.1+1.19" = _3Dq4xDvZ;
        "pkg-0.2.2+1.18.2" = _d75c3WjJ;
        "pkg-0.2.2+1.19" = _Tzp1fOCT;
        "pkg-0.2.3+1.18.2" = _NL6ZIaUo;
        "pkg-0.2.3+1.19" = _5LNeeIQx;
        "pkg-0.3.0+1.18.2" = _AhttwmD6;
        "pkg-0.3.0+1.19" = _YYiXIev8;
        "pkg-0.3.1+1.18.2" = _dSRLDg9K;
        "pkg-0.3.1+1.19" = _YxgppL8v;
        "pkg-0.3.3+1.18.2" = _FLqXjE5V;
        "pkg-0.3.3+1.19" = _NzNu6fBE;
        "pkg-0.4.0+1.18.2" = _XjI6Fv2S;
        "pkg-0.4.0+1.19" = _O725Kopd;
        "pkg-0.4.1+1.18.2" = _a85TXfbU;
        "pkg-0.4.1+1.19" = _gnUwjEjE;
        "pkg-0.4.2+1.18.2" = _ijClAwFi;
        "pkg-0.4.2+1.19" = _Bt3K3p8R;
        "pkg-0.4.2a+1.18.2" = _5CNeiXs4;
        "pkg-0.4.3+1.18.2" = _M4fQbGln;
        "pkg-0.4.3+1.19" = _X4AkNOor;
        "pkg-0.4.3+1.19.3" = _AxFx5Kp2;
        "pkg-1.0.0+1.18.2" = _u80Mo3UX;
        "pkg-1.0.0+1.19" = _3MOMdP5T;
        "pkg-1.0.0+1.19.3" = _KMD7sKYP;
        "pkg-1.0.1+1.19.3" = _fX0pUENW;
        "pkg-1.0.1+1.19" = _MIUQqJfD;
        "pkg-1.0.1+1.18.2" = _nuIP2J55;
        "pkg-1.0.2+1.18.2" = _yy7A8tMy;
        "pkg-1.0.2+1.19" = _RfWqQw7J;
        "pkg-1.0.2+1.19.3" = _Zxk0aM4c;
        "pkg-1.0.3+1.18.2" = _cbhOhDEN;
        "pkg-1.0.3+1.19" = _2zxR8CsT;
        "pkg-1.0.3+1.19.3" = _yQdDZuoO;
        "pkg-1.0.4+1.18.2" = _NPRNbGh4;
        "pkg-1.0.4+1.19" = _RBLQv1WT;
        "pkg-1.0.4+1.19.3" = _jnPQxOOy;
        "pkg-1.1.0+1.19" = _TP4AUleU;
        "pkg-1.1.0+1.19.3" = _5MXxGGTr;
        "pkg-1.2.0+1.19" = _xQbvrcqd;
        "pkg-1.2.0+1.19.3" = _KxkJzNyp;
        "pkg-1.2.1+1.19" = _8FDxnm1z;
        "pkg-1.2.1+1.19.3" = _jSuSsyUp;
        "pkg-1.2.1+1.19.4" = _vtlc7Jss;
        "pkg-1.2.1+1.20.1" = _NjxYldIz;
        "pkg-1.2.2+1.19" = _9cevX8EL;
        "pkg-1.2.2+1.19.3" = _tJy3tENx;
        "pkg-1.2.2+1.19.4" = _Jg3fDiNM;
        "pkg-1.2.2+1.20.1" = _dIS3w9bA;
        "pkg-1.3.0+1.20.1" = _119UIa6T;
        "pkg-1.4.0+1.20.1" = _L0fUUZZf;
        "pkg-1.4.1+1.20.1" = _uOfYAfvv;
        "pkg-1.4.2+1.20.1" = _rYhm8Fz6;
        "pkg-1.4.3+1.20.1" = _vsVzkKGk;
        "pkg-1.4.4+1.20.1" = _RipyFwPZ;
        "pkg-1.4.5+1.20.1" = _dVyJOTFl;
        "pkg-1.4.6+1.20.1" = _MHAf9gTF;
        "pkg-1.4.7+1.20.1" = _WFCau6eG;
        "pkg-1.4.8+1.20.1" = _bnGF6W3L;
        "pkg-1.4.9+1.20.1" = _gYjup7So;
        "pkg-1.4.10+1.20.1" = _NogHbKzH;
        "pkg-1.5.0+1.20.1" = _t3Tks6iD;
        "default" = _t3Tks6iD;
    });
