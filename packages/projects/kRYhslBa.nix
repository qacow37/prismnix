...
let
    ...
    in {
        ...
        "pkg-1.1.3+1.19.3" = _Z6HYVDOf;
        "pkg-1.1.3+1.19.2" = _fwCUVylB;
        "pkg-1.1.3+1.18.2" = _OAYFEDnz;
        "pkg-1.1.3-1.19.3-Forge" = _rO5f2Tli;
        "pkg-1.1.3-1.19.2-Forge" = _5jy8kNCM;
        "pkg-1.1.2-1.18.2-Forge" = _bWUhNIWw;
        "pkg-1.1.4+1.19.3" = _9FU8triH;
        "pkg-1.1.4+1.19.2" = _voLtZyrb;
        "pkg-1.1.4+1.18.2" = _wEmW5mBR;
        "pkg-1.1.4-1.19.3-Forge" = _cE3g1vEX;
        "pkg-1.1.4-1.19.2-Forge" = _A8hUbaM0;
        "pkg-1.1.4-1.18.2-Forge" = _lA8RV0OZ;
        "pkg-1.1.5+1.19.3" = _KZseAsus;
        "pkg-1.1.5+1.19.2" = _a6aDVjmd;
        "pkg-1.1.5+1.18.2" = _iD9CtbHl;
        "pkg-1.1.5-1.19.3-Forge" = _VG0Shrgo;
        "pkg-1.1.5-1.19.2-Forge" = _aGRLxv7r;
        "pkg-1.1.5-1.18.2-Forge" = _ofqjuUik;
        "pkg-1.1.6+1.19.3" = _SDrWuqTM;
        "pkg-1.1.6+1.19.2" = _bUmd5OGw;
        "pkg-1.1.6+1.18.2" = _wNF0xWNC;
        "pkg-1.1.6-1.19.3-Forge" = _mChk0Q3P;
        "pkg-1.1.6-1.19.2-Forge" = _jt3V5Q6G;
        "pkg-1.1.6-1.18.2-Forge" = _La8HHa48;
        "pkg-1.1.7+1.18.2" = _OiWMnvSL;
        "pkg-1.1.7+1.19.2" = _lHXYhz1O;
        "pkg-1.1.7+1.19.3" = _rHfBFzuk;
        "pkg-1.1.7+1.20" = _XWal4wua;
        "pkg-1.1.8+1.20-BETA-2" = _8pLVY8Lg;
        "pkg-1.1.7-1.18.2-Forge" = _CG94b58b;
        "pkg-1.1.7-1.19.2-Forge" = _vKMKindu;
        "pkg-1.1.7-1.19.3-Forge" = _GeEIBJQP;
        "pkg-1.1.7-1.20-Forge" = _4OxDdGOu;
        "pkg-1.1.8+1.20-BETA-3" = _sDp9scqA;
        "pkg-1.1.8+1.20-BETA-4" = _B1vvTekZ;
        "pkg-1.1.8+1.20-BETA-5" = _qub7jS40;
        "pkg-1.1.8+1.20-BETA-6" = _GSCpb9dg;
        "pkg-1.1.8+1.20-BETA-7" = _NcRmhAI4;
        "pkg-1.1.8+1.20-BETA-8" = _2IeVFDAT;
        "pkg-1.1.8+1.20-BETA-9" = _ErdgHwrx;
        "pkg-1.20-1.1.8-BETA-11" = _rMZ5eLbM;
        "pkg-1.20-1.1.8-BETA-12" = _vWRzREQ5;
        "pkg-1.20-1.1.8-BETA-13" = _etjd2CjT;
        "pkg-1.20-1.1.8-BETA-14" = _HsqsNQXV;
        "pkg-1.20-1.1.8-BETA-15" = _M2jNXrsb;
        "pkg-1.20-1.1.8-BETA-16" = _iXJ8VQqS;
        "pkg-1.20-1.1.8-BETA-17" = _gqoWjLDe;
        "pkg-1.20-1.1.8-BETA-18" = _kZ4ic2qd;
        "pkg-1.20-1.1.8-BETA-19" = _XzHiXO0X;
        "pkg-1.20-1.1.8-BETA-20" = _I6u034GO;
        "pkg-1.20-1.1.8-BETA-21" = _zkaInVyV;
        "pkg-1.20-1.1.8-BETA-22" = _C5Inxeo3;
        "pkg-1.20-1.1.8-BETA-23" = _pv8BqnNy;
        "pkg-1.20-1.1.8-BETA-24" = _1oLOg6U1;
        "pkg-1.20-1.1.8-BETA-25" = _pa7FwTgb;
        "pkg-1.20-1.1.8-BETA-26" = _aZ2y5e8R;
        "pkg-1.20-1.1.8-BETA-27" = _KMzcoHiu;
        "pkg-1.20-1.1.8-BETA-28" = _utWVRnuz;
        "pkg-1.20-1.1.8-BETA-29" = _nxXVR2qO;
        "pkg-1.20-1.1.8-BETA-30" = _8gubEhj0;
        "pkg-1.20-1.1.8-BETA-31" = _M9oHFwDd;
        "pkg-1.20-1.1.8-BETA-32" = _t0dm7pHU;
        "pkg-1.20-1.1.8-BETA-33" = _AfBBycAP;
        "pkg-1.20-1.1.8-RC-1" = _HaJ3H4Km;
        "pkg-1.20-1.1.8-RC-2" = _PHALH3Gz;
        "pkg-1.20-1.1.8-RC-3" = _tnU3RV5P;
        "pkg-1.20-1.1.8-Forge-RC-3" = _hvkIOzup;
        "pkg-1.20-1.1.8-RC-4" = _nfs8aV1w;
        "pkg-1.20-1.1.8-Forge-RC-4" = _t8DBR3Z0;
        "pkg-1.20-1.1.8-RC-5" = _K491knL3;
        "pkg-1.20-1.1.8-Forge-RC-5" = _SVXkt9eT;
        "pkg-1.20-1.1.8-RC-6" = _iVApfaWX;
        "pkg-1.20-1.1.8-Forge-RC-6" = _gkFmbwbt;
        "pkg-1.20-1.1.8-RC-8" = _2yd4XsHb;
        "pkg-1.20-1.1.8" = _4XSJI2Sq;
        "pkg-1.20-1.1.8-Forge" = _bOrwKzVq;
        "pkg-1.20-1.1.8.1" = _2FSBbK40;
        "pkg-1.20-1.1.8.1-Forge" = _11cr3FWW;
        "pkg-1.20-1.1.8.2" = _Zu3EsdtG;
        "pkg-1.20-1.1.8.2-Forge" = _litq6T1q;
        "pkg-1.20-1.1.8.3-Forge" = _rvnrWvAX;
        "pkg-1.20-1.1.8.3" = _mcCCgtad;
        "pkg-1.20.5-1.1.8" = _VA65uuEx;
        "pkg-1.20.5-1.1.8.1" = _In14onu3;
        "pkg-1.20.5-1.1.8.2" = _mFYnIxuO;
        "pkg-1.20.5-1.2.0-BETA-1" = _gXQtyLpD;
        "pkg-1.20.5-1.2.0-BETA-2" = _4TF7Aa0v;
        "pkg-1.20.5-1.2.0-BETA-3" = _NLpWVeBH;
        "pkg-1.20.5-1.2.0-BETA-4" = _Ucp7mg2l;
        "pkg-1.20.5-1.2.0-BETA-5" = _rmHuSjq4;
        "pkg-1.20.5-1.2.0-BETA-6" = _bm1c4Mwd;
        "pkg-1.20.6-1.2.0-RC-1-Fabric" = _7VHJdRF5;
        "pkg-1.20.6-1.2.0-RC-2-Fabric" = _dFhwDInx;
        "pkg-1.20.6-1.2.0-Fabric" = _5CkMY0Tt;
        "pkg-1.21-1.2.0-Fabric" = _q8nlyRsb;
        "pkg-1.21-1.2.1-Fabric" = _zEm8SrYm;
        "pkg-1.21-1.2.2-Fabric" = _PKyOMZfY;
        "pkg-1.21-1.2.3-Fabric" = _3tGHT4tP;
        "pkg-1.21-1.2.4-Fabric" = _wNz3RgkI;
        "pkg-1.21-1.2.5-BETA-1-Fabric" = _fD482dQr;
        "pkg-1.21.4-1.2.5-BETA-2-Fabric" = _i77C9Xnz;
        "pkg-1.21.4-1.2.5-BETA-3-Fabric" = _nNvTfh5f;
        "pkg-1.21.4-1.2.5-Fabric" = _r1FCYhro;
        "pkg-1.21.4-1.2.6-Fabric" = _2byA4Goo;
        "pkg-1.21.1-1.2.6-Fabric" = _XKXSs5R7;
        "pkg-1.21.4-1.2.7-Fabric" = _K0QEuoiZ;
        "pkg-1.21.5-1.2.7-Fabric" = _geCrxcaV;
        "pkg-1.2.8-1.21.5" = _IzcAi0Dj;
        "pkg-1.2.8-1.21.4" = _BPiiIRZ5;
        "pkg-1.2.8-1.21.1" = _ZoZSOmkS;
        "pkg-1.2.9-1.21.5" = _PYdLuxXd;
        "pkg-1.2.9-1.21.4" = _DpZWHFSS;
        "pkg-1.2.9-1.21.1" = _6mfJZucU;
        "pkg-1.2.9-1.21.8" = _4xtYUA8p;
        "pkg-1.2.9-1.21.9-pre1" = _AzwHvBKT;
        "pkg-1.21.9-1.2.10-Fabric" = _PKCarqCx;
        "pkg-1.21.8-1.2.10-Fabric" = _lR632vBA;
        "pkg-1.21.5-1.2.10-Fabric" = _wKAlJtRR;
        "pkg-1.21.4-1.2.10-Fabric" = _HE2yrtbz;
        "pkg-1.21-1.2.10-Fabric" = _Xn2zrFLo;
        "pkg-1.21.9-1.2.11-Fabric" = _xNZZhqpQ;
        "pkg-1.21.8-1.2.11-Fabric" = _6lVts9fj;
        "pkg-1.21.5-1.2.11-Fabric" = _RGXgvyh6;
        "pkg-1.21.4-1.2.11-Fabric" = _a3LVtHrl;
        "pkg-1.21.1-1.2.11-Fabric" = _dxH5IgkO;
        "pkg-25w41a-1.2.12-Fabric" = _Zna7JKmc;
        "pkg-1.21.9-1.2.12-Fabric" = _HI9yWs8v;
        "pkg-1.21.8-1.2.12-Fabric" = _8PIuc9cD;
        "pkg-1.21.5-1.2.12-Fabric" = _O5iL3K0e;
        "pkg-1.21.4-1.2.12-Fabric" = _GFUYbUZy;
        "pkg-1.21.1-1.2.12-Fabric" = _wTaDVw51;
        "pkg-25w41a-1.2.13-Fabric" = _9v4Sj69d;
        "pkg-1.21.9-1.2.13-Fabric" = _qd9vvqo4;
        "pkg-1.21.8-1.2.13-Fabric" = _dIsq9FJ6;
        "pkg-1.21.5-1.2.13-Fabric" = _iTH3Vm45;
        "pkg-1.21.4-1.2.13-Fabric" = _uwI0LJxR;
        "pkg-1.21.1-1.2.13-Fabric" = _YM5N2bn8;
        "pkg-1.21.1-1.2.13-NeoForge" = _RtcUSnWN;
        "pkg-1.2.13.1-1.21.1-NeoForge" = _xMxPskMh;
        "pkg-1.1.8.4-1.20.1-Fabric" = _UNNpiJx5;
        "pkg-1.1.8.6-1.20.1-Forge" = _nf8fz83i;
        "pkg-1.1.8.6-1.20.1-Fabric" = _9u8bfeK7;
        "pkg-1.1.8.7-1.20.1-Forge" = _6hhDtfxz;
        "pkg-1.1.8.7-1.20.1-Fabric" = _qF7Dmdxi;
        "pkg-1.3.0-25w44a-Fabric" = _yDGczGzP;
        "pkg-1.3.0-1.21.9-Fabric" = _OpBQjeZ2;
        "pkg-1.3.0-1.21.8-Fabric" = _RAaicndX;
        "pkg-1.3.0-1.21.5-Fabric" = _JJRss6Sk;
        "pkg-1.3.0-1.21.4-Fabric" = _HJOsYfRk;
        "pkg-1.3.0-1.21.1-Fabric" = _TwFqXlse;
        "pkg-1.3.0-1.21.1-NeoForge" = _LzYIXH5Z;
        "pkg-1.3.1-1.21.11-pre-1-Fabric" = _cNkZ9bvb;
        "pkg-1.3.1-1.21.11-rc1-Fabric" = _zaYtBpAm;
        "pkg-1.3.2-1.21.11-Fabric" = _G3hPrcbB;
        "pkg-1.3.3-1.21.11-Fabric" = _Rluky4oi;
        "pkg-1.3.4-1.21.11-Fabric" = _QHpbrPaL;
        "pkg-1.3.4-1.21.9-Fabric" = _f8Fxe2Pb;
        "pkg-1.3.4-1.21.8-Fabric" = _RogRuthe;
        "pkg-1.3.4-1.21.1-Fabric" = _aPPFap0c;
        "pkg-1.3.4-1.21.1-NeoForge" = _YC47qWh5;
        "pkg-1.3.4-1.21.1-Fabric-HF1" = _J4YCsI4O;
        "pkg-1.3.4-1.21.1-NeoForge-HF1" = _RpWSA3ld;
        "pkg-1.3.4-26.1-Fabric" = _PtV9vVK1;
        "pkg-1.4.0-26.1.2-Fabric" = _cr3TjVZS;
        "pkg-1.4.0-26.2-Fabric" = _ZURwKDMr;
        "pkg-1.4.0-26.1.2-Fabric-HF1" = _5FOyb118;
        "pkg-1.4.0-26.2-Fabric-HF1" = _QAUil3WR;
        "default" = _QAUil3WR;
    });
