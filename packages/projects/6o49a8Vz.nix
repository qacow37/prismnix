...
let
    ...
    in {
        ...
        "pkg-0.0.42-alpha" = _s00YVqhf;
        "pkg-0.0.43-alpha" = _5zJp0kCG;
        "pkg-0.0.50-alpha" = _CKD4AXR4;
        "pkg-0.0.51-alpha" = _FjCQb33f;
        "pkg-0.0.44-alpha" = _UmdyDU3d;
        "pkg-0.1.0-alpha" = _4UOl6YZd;
        "pkg-0.1.1-alpha" = _KoGOtnMI;
        "pkg-0.1.2-alpha" = _KG0qfXS0;
        "pkg-0.1.3-alpha" = _G3h4qn2f;
        "pkg-0.1.4-alpha" = _kzwsbIiY;
        "pkg-0.1.5-alpha" = _p3Tb5Buf;
        "pkg-0.1.6-alpha" = _fkQuS7oP;
        "pkg-0.1.8-alpha" = _RPVHOF23;
        "pkg-0.1.9-alpha" = _41koXpoR;
        "pkg-0.1.10-alpha" = _JRzQiKsP;
        "pkg-0.2.0-alpha" = _YRh8Y4cj;
        "pkg-0.2.1-alpha" = _6UgWzhwp;
        "pkg-0.2.2-alpha" = _lRrrQ1Lz;
        "pkg-0.2.3-alpha" = _DTSHQww9;
        "pkg-0.2.4-alpha-1.20.1" = _JWrggj8t;
        "pkg-0.2.5-alpha-1.20.1" = _fptCkN1n;
        "pkg-0.2.6-alpha-1.20.1" = _p1KRXWik;
        "pkg-0.2.7-alpha-1.20.1" = _A2ryzTFF;
        "pkg-0.2.8-alpha-1.20.1" = _3aYBeJis;
        "pkg-0.2.9-alpha-1.20.1" = _LexjhwAN;
        "pkg-0.2.10-alpha-1.20.1" = _unOUNl4H;
        "pkg-1.0.0" = _Nf0gdUtw;
        "pkg-1.0.1" = _Y6SlfNph;
        "pkg-1.0.2" = _jUJbPGl4;
        "pkg-1.0.4" = _RLjCrwJW;
