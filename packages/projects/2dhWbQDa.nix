...
let
    ...
    in {
        ...
        "pkg-0.1+1.20.4" = _oQV9O0th;
        "pkg-0.1+1.20.1" = _j8mNfW2L;
        "pkg-0.2+1.20.1" = _J8vIl8ti;
        "pkg-0.2+1.20.4" = _npjkFDLs;
        "pkg-0.4+1.20.1" = _NvWEbdst;
        "pkg-0.4+1.20.4" = _ZRaqQfba;
        "pkg-0.4+1.20.6" = _aW1ErOjX;
        "pkg-0.4+1.21" = _TDBoGdbH;
        "pkg-0.4.1+1.20.6" = _cLs7XnWx;
        "pkg-0.4.1+1.21" = _gQ3reWvr;
        "pkg-0.5+1.20.1" = _3eBPZXvr;
        "pkg-0.5+1.20.4" = _PRTRs9cg;
        "pkg-0.5+1.20.6" = _kZ1vIOJH;
        "pkg-0.5+1.21" = _J6aktsdl;
        "pkg-0.6+1.21" = _1KDSWLu0;
        "pkg-0.6+1.20.1" = _xOimAJni;
        "pkg-0.6.1+1.20.1" = _r39q9d5l;
        "pkg-0.6.1+1.21" = _MFUWn9m6;
        "pkg-0.7.0+1.21" = _Iq6lv2qt;
        "pkg-0.7.0+1.20.1" = _AmgeGtm9;
        "pkg-0.8.0+1.21" = _q8nyE6i4;
        "pkg-0.8.0+1.20.1" = _PuDdCsOt;
        "pkg-0.8.1+1.21" = _mh8JrVmB;
        "pkg-0.8.1+1.20.1" = _KaqQ2CY9;
        "pkg-0.8.1+1.21.2-rc1" = _o0hcO4eD;
        "pkg-0.9.0+1.21" = _DPXHLUiO;
        "pkg-0.9.0+1.21.4" = _TF3SGQVK;
        "pkg-0.9.0+1.21.5" = _ownbvVNR;
        "default" = _ownbvVNR;
    });
