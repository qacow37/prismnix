...
let
    ...
    in {
        ...
        "pkg-8.0.1" = _jGp9r2Uu;
        "pkg-9.0.1" = _6ElGRaaO;
        "pkg-10.0.1" = _vek5ZLyQ;
        "pkg-11.0.1" = _v2XoX02g;
        "pkg-12.0.2" = _Y2QfXSSn;
        "pkg-13.0.1" = _Lrtq3RJL;
        "pkg-14.0.1" = _xxOgKd5H;
        "pkg-15.0.1" = _lJoNuSFb;
        "pkg-16.0.1" = _OQs2ofgn;
        "pkg-17.0.1" = _LMl5MOh9;
        "pkg-18.0.1" = _SnDIFPt9;
        "default" = _SnDIFPt9;
    });
