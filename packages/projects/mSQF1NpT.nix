...
let
    ...
    in {
        ...
        "pkg-1.13.2-0.4" = _SxBdxzm2;
        "pkg-FORGE-1.14.4-1.0" = _LlayoSaI;
        "pkg-FORGE-1.15.2-2.0" = _G9HHvBKX;
        "pkg-1.16.5-4.0.2.4" = _CFT2ihe8;
        "pkg-1.1.1-1.16.5" = _X5xhe47U;
        "pkg-1.17.1-5.0.0.1" = _EUZM5QvM;
        "pkg-3.0.0-1.17.1" = _vTTunEBv;
        "pkg-1.18.1-5.0.1.0" = _GoaZeJCf;
        "pkg-3.0.0-1.18.1" = _sMgiWQoW;
        "pkg-6.1.0+1.19.2" = _KKnExUD9;
        "pkg-6.2.0+1.19.3" = _aBl6pUtF;
        "pkg-6.1.1+1.19.2" = _Ekq3CEFr;
        "pkg-6.2.1+1.19.4" = _Q23kffFn;
        "pkg-6.3.0+1.20.1" = _AmEdJTeq;
        "pkg-1.16.5-4.0.2.5" = _VGNLr4U0;
        "pkg-1.18.2-5.0.2.0" = _ARTfU0cs;
        "pkg-6.1.2+1.19.2" = _vH9hd5hp;
        "pkg-6.1.3+1.19.2" = _QTCddx1Z;
        "pkg-6.4.0+1.20.1" = _HGpQDN32;
        "pkg-7.0.0+1.20.4" = _sBvScwrv;
        "pkg-8.0.0+1.20.6" = _4oC7n1Wz;
        "pkg-6.4.1+1.20.1" = _8MFnfKqj;
        "pkg-7.0.1+1.20.4" = _ZKUzyYCU;
        "pkg-8.0.1+1.20.6" = _vXUzY0eg;
        "pkg-9.0.0+1.21" = _yHMeMyPD;
        "pkg-6.4.2+1.20.1" = _yxgTJu0N;
        "pkg-6.4.3+1.20.1" = _AlHVXgYe;
        "pkg-9.0.1+1.21.1" = _oxX7WNWo;
        "pkg-9.0.2+1.21.1" = _RX6A02W1;
        "pkg-6.4.4+1.20.1" = _k6lA080t;
        "pkg-10.0.0+1.21.4" = _KbUvbIlc;
        "pkg-10.0.1+1.21.4" = _iHITcI92;
        "default" = _iHITcI92;
    });
