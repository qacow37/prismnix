...
let
    ...
    in {
        ...
        "pkg-forge-mc1.19-1.0.0" = _TjnxJVMh;
        "pkg-fabric-mc1.19-1.0.0" = _S0WpHuHU;
        "pkg-forge-mc1.18.2-1.0.0" = _wVNBQfz7;
        "pkg-fabric-mc1.18.2-1.0.0" = _e05JLTSX;
        "pkg-fabric-mc1.19-1.0.1" = _zUHewcWD;
        "pkg-fabric-mc1.18.2-1.0.1" = _FfwHhMdK;
        "pkg-fabric-mc1.18.2-1.0.2" = _YzmBxwg1;
        "pkg-fabric-mc1.19-1.0.2" = _sJOkXvN6;
        "pkg-fabric-mc1.19-1.0.2-patch1" = _HcG19prc;
        "pkg-fabric-mc1.18.2-1.0.2-patch1" = _rO6LXCX1;
        "pkg-forge-mc1.19-1.1.0" = _qVYJKIOB;
        "pkg-forge-mc1.18.2-1.1.0" = _9XSyue1H;
        "pkg-fabric-mc1.19-1.1.0" = _stC6LvNY;
        "pkg-fabric-mc1.18.2-1.1.0" = _b6AFBkDQ;
        "pkg-forge-mc1.19-1.1.0-patch1" = _j2LL4Xim;
        "pkg-forge-mc1.18.2-1.1.0-patch1" = _o5JgnOwP;
        "pkg-fabric-mc1.19-1.1.0-patch1" = _8RmBX1qp;
        "pkg-fabric-mc1.18.2-1.1.0-patch1" = _QCbe9vHW;
        "pkg-fabric-mc1.19-1.1.0-patch2" = _W9L3JGyW;
        "pkg-fabric-mc1.18.2" = _da1Llbbq;
        "pkg-forge-mc1.19-1.1.0-patch2" = _KkX2oaHZ;
        "pkg-forge-mc1.18.2-1.1.0-patch2" = _3UE4RdQy;
        "pkg-fabric-mc1.19-1.1.0-patch3" = _p0XtlCev;
        "pkg-fabric-mc1.18.2-1.1.0-patch3" = _fZ14rs0G;
        "pkg-fabric-1.1.1" = _G4YxcSle;
        "pkg-forge-1.1.1" = _aMn6UMlv;
        "pkg-fabric-1.1.1-patch1" = _ydq4Pzr2;
        "pkg-forge-1.1.2" = _Ur0CigsV;
        "pkg-fabric-1.1.2" = _rAiwTBXZ;
        "pkg-forge-1.18.2" = _obvcQSJT;
        "pkg-forge-mc1.18.2-1.1.3" = _cFJRQZqk;
        "pkg-forge-mc1.19-1.1.3" = _xRQmrSRB;
        "pkg-forge-mc1.19.2-1.1.3" = _QQ0edOaA;
        "pkg-fabric-mc1.18.2-1.1.3" = _dEdf3qQd;
        "pkg-fabric-mc1.19-1.1.3" = _MwOltEC7;
        "pkg-fabric-mc1.19.2-1.1.3" = _tXFqtGJz;
        "default" = _tXFqtGJz;
    });
