...
let
    ...
    in {
        ...
        "pkg-0.2.0+1.21-fabric" = _V1XGijUr;
        "pkg-0.2.0+1.21.1-fabric" = _xYXE4bNy;
        "pkg-0.3.0+1.21-fabric" = _WVkHvpJC;
        "pkg-0.3.0+1.21.1-fabric" = _Z6XLdLub;
        "pkg-0.3.1+1.21-fabric" = _7Asee5jC;
        "pkg-0.3.1+1.21.1-fabric" = _MV074d0h;
        "pkg-0.3.2+1.21.1-fabric" = _PZPOxheH;
        "pkg-0.3.2+1.21-fabric" = _AgK10vrs;
        "pkg-0.4.0+1.21-fabric" = _HyBkHhR3;
        "pkg-0.4.0+1.21.1-fabric" = _EdRqkj4H;
        "pkg-0.4.1+1.21.1-fabric" = _Mtg9jc3w;
        "pkg-0.4.1+1.21-fabric" = _ogssxMDo;
        "pkg-0.5.0+1.21-fabric" = _7q1POJsm;
        "pkg-0.5.0+1.21.1-fabric" = _od6SezjB;
        "pkg-0.5.1+1.21-fabric" = _yIXLjpvM;
        "pkg-0.5.1+1.21.1-fabric" = _FOf4wwX3;
        "pkg-0.5.2+1.21-fabric" = _vsS7P9Q5;
        "pkg-0.5.2+1.21.2-fabric" = _CFzyQiby;
        "pkg-0.5.2+1.21.1-fabric" = _jG03xXkJ;
        "pkg-0.5.2+1.21.3-fabric" = _zZWG0T1X;
        "pkg-0.5.3+1.21.4-fabric" = _xOSKmvlZ;
        "pkg-0.5.3+1.21.3-fabric" = _g5z46OZu;
        "pkg-0.5.3+1.21.1-fabric" = _md19jeR2;
        "pkg-0.5.3+1.21-fabric" = _GlQ3JlsJ;
        "pkg-0.5.3+1.21.2-fabric" = _JkdqSDp8;
        "default" = _JkdqSDp8;
    });
