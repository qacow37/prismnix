...
let
    ...
    in {
        ...
        "pkg-mc1.19.2-0.0.2-fabric" = _Q9tAh4ot;
        "pkg-mc1.19.2-0.0.2-forge" = _xqDX9D7c;
        "pkg-mc1.20.1-0.0.2-fabric" = _lnyh5SEy;
        "pkg-mc1.20.1-0.0.2-forge" = _ggL4CurB;
        "pkg-mc1.19.2-0.0.2.a-fabric" = _WjewfMwu;
        "pkg-mc1.19.2-0.0.2.a-forge" = _Rye4TCpx;
        "pkg-mc1.20.1-0.0.2.a-fabric" = _UtY4dl8F;
        "pkg-mc1.20.1-0.0.2.a-forge" = _RSFmJd69;
        "pkg-mc1.19.2-0.0.2.b-fabric" = _ZgVClv4r;
        "pkg-mc1.19.2-0.0.2.b-forge" = _fNv82hNR;
        "pkg-mc1.20.1-0.0.2.b-fabric" = _oRo8hfu5;
        "pkg-mc1.20.1-0.0.2.b-forge" = _6ZNBFrck;
        "pkg-mc1.19.2-0.1.0-fabric" = _P5IBcQbu;
        "pkg-mc1.19.2-0.1.0-forge" = _cLWGJaM7;
        "pkg-mc1.20.1-0.1.0-fabric" = _By7C0Mg8;
        "pkg-mc1.20.1-0.1.0-forge" = _gM64zPv0;
        "pkg-mc1.20.1-0.1.0.a-fabric" = _yng4sk5Z;
        "pkg-mc1.20.1-0.1.0.a-forge" = _XEtNnQ7G;
        "pkg-mc1.19.2-0.1.0.a-fabric" = _9FCD4j5N;
        "pkg-mc1.19.2-0.1.0.a-forge" = _shxC4sJ0;
        "pkg-mc1.20.1-0.1.1-fabric" = _atoTxnku;
        "pkg-mc1.20.1-0.1.1-forge" = _veMboZIN;
        "pkg-mc1.19.2-0.1.1-fabric" = _jUl3ljQc;
        "pkg-mc1.19.2-0.1.1-forge" = _rbUfiBh9;
        "pkg-mc1.20.1-0.1.1.a-fabric" = _BZZ6xJWA;
        "pkg-mc1.20.1-0.1.1.a-forge" = _zutk3EiI;
        "pkg-mc1.19.2-0.1.1.a-fabric" = _Z9231ZkE;
        "pkg-mc1.19.2-0.1.1.a-forge" = _5BPFXtOu;
        "pkg-mc1.20.1-0.1.1.b-fabric" = _gwtTtv8v;
        "pkg-mc1.20.1-0.1.1.b-forge" = _bKjbEWVp;
        "pkg-mc1.19.2-0.1.1.b-fabric" = _vO3Kxx98;
        "pkg-mc1.19.2-0.1.1.b-forge" = _ppzCrdZR;
        "pkg-mc1.20.1-0.1.2a-fabric" = _lxbUvfMl;
        "pkg-mc1.20.1-0.1.2a-forge" = _MsqpFDWp;
        "pkg-mc1.20.1-0.1.2.b-fabric" = _EJhOWXNr;
        "pkg-mc1.20.1-0.1.2.b-forge" = _iZzvVY8n;
        "pkg-mc1.20.1-0.1.2.c-fabric" = _bgTd3zSq;
        "pkg-mc1.20.1-0.1.2.c-forge" = _OE189VJI;
        "pkg-mc1.20.1-0.1.3-aa-fabric" = _xdZskl4p;
        "pkg-mc1.20.1-0.1.3-aa-forge" = _vRzzW1T8;
        "pkg-mc1.20.1-0.1.3" = _SdDAVMnO;
        "pkg-mc1.20.1-0.1.4" = _wYUEB7Ge;
        "pkg-mc1.20.1-0.1.5" = _QrIUPdZs;
        "pkg-mc1.20.1-0.1.6" = _Lu7bMrob;
        "pkg-mc1.20.1-0.1.7" = _DaqOG61q;
        "pkg-mc1.20.1-0.1.7-a" = _C1gGCYqk;
        "pkg-mc1.20.1-0.1.7.b" = _LiXyGYFQ;
        "pkg-mc1.20.1-0.1.8" = _1qFIKxNA;
        "pkg-mc1.20.1-0.1.9" = _JsYlgYfh;
        "pkg-mc1.20.1-0.2.0" = _42sr3HeO;
        "pkg-mc1.20.1-0.2.1" = _a5KHAWYL;
        "pkg-mc1.21.1-0.2.1" = _OXPnxdV6;
        "pkg-mc1.21.1-0.2.1+1" = _pr5pYLYi;
        "pkg-mc1.20.1-0.2.2" = _TuDTHqkN;
        "pkg-mc1.21.1-0.2.2" = _6PwlB9Rx;
        "pkg-mc1.20.1-0.2.3" = _zQYIk7Q8;
        "pkg-mc1.21.1-0.2.3" = _NbKbk5DA;
        "pkg-mc1.20.1-0.2.4" = _xcJS3C1D;
        "pkg-mc1.21.1-0.2.4" = _2xXrBDrs;
        "pkg-mc1.20.1-0.2.5" = _ztNm4q1y;
        "pkg-mc1.20.1-0.2.6" = _jmHUnVwR;
        "pkg-mc1.20.1-0.2.7" = _XBd8V0ga;
        "pkg-mc1.20.1-0.2.8" = _d2R8cmpT;
        "pkg-mc1.20.1-0.2.9" = _Ne2N0mLN;
        "default" = _Ne2N0mLN;
    });
