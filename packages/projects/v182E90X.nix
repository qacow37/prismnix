...
let
    ...
    in {
        ...
        "pkg-1.3.6" = _J2jWaSpe;
        "pkg-1.3.7" = _iyINwJDp;
        "pkg-1.3.71" = _NE7KIIq8;
        "pkg-1.3.72" = _5hlV53gd;
        "pkg-1.3.73-SNAPSHOT+2" = _UJVdxZpc;
        "pkg-1.3.73-SNAPSHOT+5" = _Z84YwD2V;
        "pkg-1.3.73-SNAPSHOT+12" = _q61N7r16;
        "pkg-1.3.73" = _rJSzP2wg;
        "pkg-1.3.74-SNAPSHOT+27" = _JAerN21H;
        "pkg-1.3.74-SNAPSHOT+38" = _r6xOcEhC;
        "pkg-1.3.74-SNAPSHOT+41" = _nyRU58eK;
        "pkg-1.3.74-SNAPSHOT+44" = _9hizkAAk;
        "pkg-1.3.74-SNAPSHOT+71" = _QJ4A5GkQ;
        "pkg-1.3.74-SNAPSHOT+78" = _MZm6nIP6;
        "pkg-1.3.74-SNAPSHOT+94" = _opJjd9iH;
        "pkg-1.3.74-SNAPSHOT+113" = _KnP7uSGr;
        "pkg-1.3.74-SNAPSHOT+115" = _9TiTD5bH;
        "pkg-1.3.74-SNAPSHOT+118" = _95Ss7Bot;
        "pkg-1.3.74-SNAPSHOT+124" = _DYCt36ay;
        "pkg-1.3.74-SNAPSHOT+134" = _Jtlib7Mo;
        "pkg-1.3.74-SNAPSHOT+141" = _8AjgZw3G;
        "pkg-1.3.74-SNAPSHOT+157" = _lGMpqsFA;
        "pkg-1.3.74-SNAPSHOT+169" = _JPWHrZe0;
        "pkg-1.3.74-SNAPSHOT+175" = _SQUocnbl;
        "pkg-1.3.74-SNAPSHOT+178" = _JYdUfcIm;
        "pkg-1.3.74-SNAPSHOT+194" = _rA7x6B3W;
        "pkg-1.3.74-SNAPSHOT+195" = _l7mD79YK;
        "pkg-1.3.74" = _RlVMrVth;
        "pkg-1.3.75-SNAPSHOT+206" = _DkzlSDWJ;
        "pkg-1.3.75-SNAPSHOT+214" = _nZ71S7NZ;
        "pkg-1.3.75-SNAPSHOT+292" = _TMWgXrYk;
        "pkg-1.3.75-SNAPSHOT+311" = _5DjRnJ7k;
        "pkg-1.3.75-SNAPSHOT+312" = _3eCfoh7E;
        "pkg-1.3.75-SNAPSHOT+313" = _1tE8gljR;
        "pkg-1.3.75-SNAPSHOT+314" = _HoIQO3qC;
        "pkg-1.3.75-SNAPSHOT+315" = _5ZFyTLAt;
        "pkg-1.3.75-SNAPSHOT+316" = _TU6WU9HR;
        "pkg-1.3.75-SNAPSHOT+317" = _ZMFUutA3;
        "pkg-1.3.75-SNAPSHOT+318" = _5jvpwUvj;
        "pkg-1.3.75-SNAPSHOT+319" = _2ikVsto7;
        "pkg-1.3.75-SNAPSHOT+320" = _85P1gC0Q;
        "pkg-1.3.75-SNAPSHOT+321" = _JTF1ib5z;
        "default" = _JTF1ib5z;
    });
