...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.7-fabric" = _ZBkpixOC;
        "pkg-1.18.2-1.7-fabric" = _HeZn797j;
        "pkg-1.19.2-1.9-fabric" = _LeoZpg0I;
        "pkg-1.16.5-1.2-forge" = _lDBdcorU;
        "pkg-1.18.2-1.4-forge" = _34OQsRKx;
        "pkg-1.19.2-1.6-forge" = _yvjUzSin;
        "pkg-1.16.5-2.0-fabric" = _7RUCWTL4;
        "pkg-1.18.2-2.0-fabric" = _zbEE1PF3;
        "pkg-1.19.2-2.0-fabric" = _R729xTeM;
        "pkg-1.19.3-2.1-fabric" = _QNnp8TWK;
        "pkg-1.19.3-1.6-forge" = _yaq5Xq1y;
        "pkg-1.18.2-3.0-forge+fabric" = _MEEXJF9C;
        "pkg-1.19.2-3.0-forge+fabric" = _5V1X0Zn0;
        "pkg-1.19.3-3.0-forge+fabric" = _4jtykad5;
        "pkg-1.19.4-3.0-forge+fabric" = _hzHNXCKZ;
        "pkg-1.20-3.0-forge+fabric" = _DYrDaKJU;
        "pkg-1.20.1-3.0-forge+fabric" = _GXighW5S;
        "pkg-1.20.2-3.0-forge+fabric" = _us2bsy52;
        "pkg-1.18.2-3.1-forge+fabric" = _a7AJzWaB;
        "pkg-1.19.2-3.1-forge+fabric" = _PdADmNcn;
        "pkg-1.20.1-3.1-forge+fabric" = _TzzTjO9O;
        "pkg-1.20.2-3.1-forge+fabric" = _C0X8M5u4;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _3mDRqHSN;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _SfaDlxV6;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _ginoQfnO;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _vtlEY4bI;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _mn37cw4B;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _N9UT8bBj;
        "pkg-1.20.5-3.2-fabric+neo" = _hKLLKZE7;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _cNFoygTW;
        "pkg-1.21.0-3.2-fabric+forge+neo" = _ywMcU3J9;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _6Kx5tdkG;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _9I0cBFxd;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _KEHwUDx5;
        "pkg-1.21.1-3.3-fabric+forge+neo" = _kxNSRA4q;
        "pkg-1.21.2-3.3-fabric+neo" = _aMiNOwRZ;
        "pkg-1.21.3-3.3-fabric+forge+neo" = _aiKVDmyq;
        "pkg-1.21.4-3.3-fabric+forge+neo" = _aLQ3LCCf;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _4mfUFQmp;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _aTCcNYVc;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _H74yIIDF;
        "pkg-1.21.5-3.4-fabric+forge+neo" = _YOpXaSpk;
        "pkg-1.21.6-3.4-fabric+forge+neo" = _Hl1M5oKF;
        "pkg-1.21.7-3.4-fabric+forge+neo" = _gS7SRPIn;
        "pkg-1.21.8-3.4-fabric+forge+neo" = _HieYwU17;
        "pkg-1.21.9-3.4-fabric+forge+neo" = _3YdQRybz;
        "pkg-1.21.10-3.4-fabric+forge+neo" = _wxqf3dfP;
        "pkg-1.21.11-3.4-fabric+forge+neo" = _xrR4321Q;
        "pkg-26.1.0-3.4-fabric+forge+neo" = _XlBh5jEw;
        "pkg-26.1.1-3.4-fabric+forge+neo" = _2xowS5Ln;
        "pkg-26.1.2-3.4-fabric+forge+neo" = _KEINON9t;
        "pkg-26.2.0-3.4-fabric+forge+neo" = _9IVWrqUT;
        "default" = _9IVWrqUT;
    });
