...
let
    ...
    in {
        ...
        "pkg-1.3.4" = _s6iyZ11j;
        "pkg-1.3.5" = _B40ZoBd3;
        "pkg-1.3.5-1" = _aXV0hfvS;
        "pkg-1.3.6" = _uC0K8G0t;
        "pkg-1.3.7" = _XL2U0NKa;
        "pkg-1.3.8" = _Y9yHNxAC;
        "pkg-1.3.9" = _Gy9GZdeb;
        "pkg-1.3.10" = _RLVanW9D;
        "pkg-1.3.11" = _miNXaly0;
        "pkg-1.3.12" = _23ZVhkqv;
        "pkg-1.3.13" = _utdA1qC8;
        "pkg-1.3.13.1" = _jLvkPR0R;
        "pkg-1.3.14" = _ZRcG1Qlu;
        "pkg-1.3.15" = _GtlTsR51;
        "pkg-1.3.16" = _pGx09Lpw;
        "pkg-1.3.17" = _bbDfR1Os;
        "pkg-1.3.18" = _B80G8xT0;
        "pkg-1.3.19" = _UZTOvIXW;
        "pkg-1.3.20" = _4ilQD6Ex;
        "pkg-1.3.21" = _7LGX04Dq;
        "pkg-1.3.22" = _1GyHsaUm;
        "pkg-1.3.23" = _KfU8KPBE;
        "pkg-1.3.24" = _Zg8XweNS;
        "pkg-1.3.25" = _phaFB3JP;
        "pkg-1.4.0" = _eLFxjGxm;
        "pkg-1.4.1" = _ee44YhBI;
        "pkg-1.4.2" = _RxjEYouf;
        "pkg-1.4.3" = _CAOw1C6k;
