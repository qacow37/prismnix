...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha.1" = _KZpJjPUE;
        "pkg-1.0.0-alpha.2" = _WWrWGUAa;
        "pkg-1.0.0-alpha.3-build.16+mc1.19.2" = _7sNrcYax;
        "pkg-1.0.0-alpha.3-build.18+mc1.20.2" = _ojeR9f4C;
        "pkg-1.0.0-alpha.4-build.22+mc1.20.2" = _ck7Yj60M;
        "pkg-1.0.0-alpha.5-build.26+mc1.20.2" = _FeaR7OFC;
        "pkg-1.0.0-alpha.6-build.27+mc1.20.2" = _pMFjQ9eD;
        "pkg-1.0.0-alpha.7-build.28+mc1.20.2" = _AQGN06KY;
        "pkg-1.0.0-alpha.8-build.30+mc1.20.2" = _uaZtVnCF;
        "pkg-1.0.0-alpha.9-build.31+mc1.20.2" = _QMB5hZw0;
        "pkg-1.0.0-alpha.9-build.32+mc1.20.1" = _4Di6vnyn;
        "pkg-1.0.0-alpha.10-build.35+mc1.20.2" = _1MzMvFJp;
        "pkg-1.0.0-alpha.10-build.34+mc1.20.1" = _fdSmYAb9;
        "pkg-1.0.0-alpha.11-build.41+mc1.20.1" = _8ZyIOgR5;
        "pkg-1.0.0-alpha.11-build.40+mc1.20.2" = _YXiX70ak;
        "pkg-1.0.0-alpha.12-build.49+mc1.20.2" = _OM4iKNXZ;
        "pkg-1.0.0-alpha.12-build.53+mc1.20.1" = _vA5BNwrS;
        "pkg-1.0.0-alpha.13-build.55+mc1.20.1" = _BwhXiET2;
        "pkg-1.0.0-alpha.13-build.54+mc1.20.2" = _JQYuMSoM;
        "pkg-1.0.0-alpha.14-build.56+mc1.20.1" = _Hr95B2d5;
        "pkg-1.0.0-alpha.14-build.57+mc1.20.2" = _dSPjEZns;
        "pkg-1.0.0-alpha.15-build.58+mc1.20.1" = _IKo3rpDr;
        "pkg-1.0.0-alpha.15-build.62+mc1.20.2" = _3kiO2hbG;
        "pkg-1.0.0-alpha.16-build.63+mc1.20.1" = _yjBtcK5P;
        "pkg-1.0.0-alpha.16-build.64+mc1.20.2" = _vTUxuM0C;
        "pkg-1.0.0-alpha.17-build.68+mc1.20.1" = _VDopw8Hu;
        "pkg-1.0.0-alpha.17-build.71+mc1.20.2" = _5ecLolbK;
        "pkg-1.0.0-alpha.18-build.72+mc1.20.1" = _Xmkvlryf;
        "pkg-1.0.0-alpha.18-build.73+mc1.20.2" = _cg9Lgjc2;
        "pkg-1.0.0-alpha.19-build.75+mc1.20.1" = _3R9LMdm2;
        "pkg-1.0.0-alpha.19-build.74+mc1.20.2" = _In3HZB8Z;
        "pkg-1.0.0-alpha.20-build.76+mc1.20.1" = _jnWD5yTx;
        "pkg-1.0.0-alpha.20-build.77+mc1.20.2" = _DNlfIYKc;
        "pkg-1.0.0-alpha.21-build.79+mc1.20.2" = _HdPrVRRJ;
        "pkg-1.0.0-alpha.21-build.80+mc1.20.1" = _xPULAX9s;
        "pkg-1.0.0-alpha.22-build.81+mc1.20.1" = _pbj0iXgs;
        "pkg-1.0.0-alpha.22-build.82+mc1.20.2" = _wxQflWJM;
        "pkg-1.0.0-alpha.23-build.95+mc1.20.1" = _HvZCHahj;
        "pkg-1.0.0-alpha.23-build.96+mc1.20.2" = _xW66TY82;
        "pkg-1.0.0-alpha.24-build.98+mc1.20.1" = _5A6HPkth;
        "pkg-1.0.0-alpha.24-build.97+mc1.20.2" = _pcAUBrPv;
        "pkg-1.0.0-alpha.25-build.99+mc1.20.2" = _43T0MQhO;
        "pkg-1.0.0-alpha.25.103+mc1.20.1" = _RsDG1o1n;
        "pkg-1.0.0-alpha.26.104+mc1.20.1" = _pl9bjV0Q;
        "pkg-1.0.0-alpha.26.105+mc1.20.2" = _x5hTSN2M;
        "pkg-1.0.0-alpha.27.116+mc1.20.2" = _hEfr2x47;
        "pkg-1.0.0-alpha.27.115+mc1.20.1" = _8eOzp8sQ;
        "pkg-1.0.0-alpha.28.120+mc1.20.1" = _toON9OfE;
        "pkg-1.0.0-alpha.28.119+mc1.20.2" = _ECUYc5RH;
        "default" = _ECUYc5RH;
    });
