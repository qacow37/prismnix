...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.11-61.0.5" = _zmXSRSO6;
        "pkg-1.0.0-forge-1.21.10-60.1.0" = _yh0nuyrm;
        "pkg-1.0.0-forge-1.21.8-58.1.11" = _3u8P14L0;
        "pkg-1.0.0-forge-1.21.5-55.1.4" = _M2IsyP3b;
        "pkg-1.0.0-forge-1.21.4-54.1.11" = _lRnUyFeS;
        "pkg-1.0.0-forge-1.21.1-52.1.8" = _6ubJAf8k;
        "pkg-1.0.0-forge-1.20.1-47.4.10" = _e4h5bSfC;
        "pkg-1.0.0-neoforge-1.21.11-21.11.27b" = _l2xkaGFQ;
        "pkg-1.0.0-neoforge-1.21.10-21.10.64" = _l0w4dK7p;
        "pkg-1.0.0-neoforge-1.21.8-21.8.52" = _L9XGe93d;
        "pkg-1.0.0-neoforge-1.21.5-21.5.96" = _bAUxXzYT;
        "pkg-1.0.0-neoforge-1.21.4-21.4.156" = _yXs55ELB;
        "pkg-1.0.0-neoforge-1.21.1-21.1.218" = _o2XHgalF;
        "pkg-1.0.0-fabric-1.20.1-0.92.6" = _cuCC7iKW;
        "pkg-1.0.0-fabric-1.21.1-0.116.7-1.0." = _n9gTSkj6;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _eLcsG0w0;
        "pkg-1.0.0-fabric-1.21.5-0.128.2" = _XzogyXDF;
        "pkg-1.0.0-fabric-1.21.8-0.136.1" = _XTPf7muq;
        "pkg-1.0.0-fabric-1.21.10-0.138.4" = _sjhAYDaa;
        "pkg-1.0.0-fabric-1.21.11-0.141.1" = _j6o4buYs;
        "pkg-1.0.1-fabric-1.20.1-0.92.6" = _eiiOxlQV;
        "pkg-1.0.1-fabric-1.21.11-0.141.1" = _F8CDIFPU;
        "pkg-1.0.1-fabric-1.21.10-0.138.4" = _51cbH6fb;
        "pkg-1.0.1-fabric-1.21.8-0.136.1" = _GgJeNc3F;
        "pkg-1.0.1-fabric-1.21.5-0.128.2" = _xaW5MPPz;
        "pkg-1.0.1-fabric-1.21.4-0.119.4" = _gS1oAxAB;
        "pkg-1.0.1-fabric-1.21.1-0.116.7" = _qUkIiMa6;
        "pkg-1.0.0-neoforge-26.1.1.1" = _1KdR3uIK;
        "pkg-1.0.1-fabric-26.1.1-0.145.3" = _iTMQ7BEh;
        "pkg-1.0.0-forge-26.1.1-63.0.0" = _SMdoANli;
        "default" = _SMdoANli;
    });
