...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _YtNpa3LU;
        "pkg-1.1" = _jwPKESvh;
        "pkg-1.1.1+1.20.1" = _Ph6mqGcj;
        "pkg-1.1.1+1.21.8" = _rmBnJDhy;
        "pkg-1.1.1+1.21.9" = _uLbihKPX;
        "pkg-1.1.1+1.21.10" = _FugkT7TN;
        "pkg-1.1.1+1.21.11" = _LNGSJAud;
        "pkg-1.1.1+26.1" = _YTOxQOmb;
