...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.9-fabric" = _kA802ua6;
        "pkg-1.18.2-1.9-fabric" = _NGgHFCL9;
        "pkg-1.19.2-2.0-fabric" = _8sR6bmIP;
        "pkg-1.16.5-1.6-forge" = _nKTNLs8V;
        "pkg-1.18.2-1.6-forge" = _WebtGtP0;
        "pkg-1.19.2-1.8-forge" = _zZQNTaMK;
        "pkg-1.16.5-2.1-fabric" = _lncD13fD;
        "pkg-1.18.2-2.1-fabric" = _nLzrzp5D;
        "pkg-1.19.2-2.1-fabric" = _40dwNNwr;
        "pkg-1.19.3-2.2-fabric" = _ADlyf3vV;
        "pkg-1.19.3-1.8-forge" = _R37iJlmc;
        "pkg-1.18.2-3.0-forge+fabric" = _lnMVc2IX;
        "pkg-1.19.2-3.0-forge+fabric" = _Oyq7etlG;
        "pkg-1.19.3-3.0-forge+fabric" = _7np4wyZP;
        "pkg-1.19.4-3.0-forge+fabric" = _lOMgohRY;
        "pkg-1.20-3.0-forge+fabric" = _Vil7pk2b;
        "pkg-1.20.1-3.0-forge+fabric" = _RSJ1ZVY8;
        "pkg-1.20.2-3.0-forge+fabric" = _ke2Oy5Oi;
        "pkg-1.18.2-3.1-forge+fabric" = _XHKRb7Fm;
        "pkg-1.19.2-3.1-forge+fabric" = _betuLuD2;
        "pkg-1.20.1-3.1-forge+fabric" = _eWZYjnua;
        "pkg-1.20.2-3.1-forge+fabric" = _asdVvql1;
        "pkg-1.18.2-3.2-forge+fabric" = _vPBmANl8;
        "pkg-1.19.2-3.2-forge+fabric" = _QpLNoeVY;
        "pkg-1.20.1-3.2-forge+fabric" = _xAj20M12;
        "pkg-1.20.2-3.2-forge+fabric" = _deHYG7KH;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _CWdQZAnM;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _1b9IjQ9O;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _jtdTlBnB;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _WVeJyiyo;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _J7zvHPoS;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _9ACuUqj6;
        "pkg-1.19.2-3.4-fabric+forge" = _z4bZjSsw;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _OLooJIGW;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _iqbH3ZQd;
        "pkg-1.20.5-3.4-fabric+neo" = _hpjxn7jb;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _gDJze0rT;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _3WNoAIkI;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _2oh6hLbh;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _PXrqSulI;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _ktPGKnnt;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _qhyyIDYt;
        "pkg-1.21.2-3.5-fabric+neo" = _Bm2QAyFw;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _iQ7JIj6r;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _wg9hgosU;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _WqSEWCzI;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _ZVKlC4b9;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _WEfz9MQc;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _ELDVVnJf;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _Wzt1ATZf;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _Tm8a3gl8;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _VWTadHJp;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _OUFNf7KO;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _JCnCJ0Zf;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _Z4hgjtLH;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _PHajWhtI;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _L8qVv8VV;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _hPOGgJyi;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _B7GcjVmx;
        "default" = _B7GcjVmx;
    });
