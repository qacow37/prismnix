...
let
    ...
    in {
        ...
        "pkg-1.0+1.18.2" = _8iwFTJHA;
        "pkg-1.0+1.19.2" = _trbDutac;
        "pkg-1.0+1.20.1" = _fW5dYuX8;
        "pkg-1.1+1.18.2" = _whJEtIoA;
        "pkg-1.1+1.19.2" = _4TZnq0R1;
        "pkg-1.1+1.20.1" = _LV6nZled;
        "pkg-1.2+1.18.2" = _dWKWuwFS;
        "pkg-1.2+1.19.2" = _Z12Auc5w;
        "pkg-1.2+1.20.1" = _f0d0DQtv;
        "pkg-1.3+1.18.2" = _vSoWEkuP;
        "pkg-1.3+1.20.1" = _Cww7FROG;
        "pkg-1.3+1.19.2" = _zSCdvu8i;
        "pkg-1.4+1.18.2" = _e0xLHvOI;
        "pkg-1.4+1.19.2" = _C8gbG8qx;
        "pkg-1.4+1.20.1" = _9eDdduwh;
        "pkg-1.4.1+1.18.2" = _lNdIFVK7;
        "pkg-1.4.1+1.19.2" = _p8ymnqdz;
        "pkg-1.4.1+1.20.1" = _WUZ8cyaX;
        "pkg-1.4.2+1.18.2" = _epbzqJuS;
        "pkg-1.4.2+1.19.2" = _2zRa2Piy;
        "pkg-1.4.2+1.20.1" = _FSiIuUW2;
        "pkg-1.4.3+1.18.2" = _l90y6L1t;
        "pkg-1.4.3+1.19.2" = _bqJBD5HW;
        "pkg-1.4.3+1.20.1" = _sIazvlGr;
        "pkg-1.4.4+1.18.2-forge" = _vYW0Wzh7;
        "pkg-1.4.4+1.19.2-forge" = _wwObUIy9;
        "pkg-1.4.4+1.20.1-forge" = _8HNGEaNZ;
        "pkg-1.4.4+1.18.2-fabric" = _dHwzmjHd;
        "pkg-1.4.4+1.19.2-fabric" = _rFQSS4Us;
        "pkg-1.4.4+1.20.1-fabric" = _AhbRzFhG;
        "pkg-1.4.5+1.18.2-forge" = _BOhohs4n;
        "pkg-1.4.5+1.19.2-forge" = _uhWjEbQu;
        "pkg-1.4.5+1.20.1-forge" = _rYfrNPDY;
        "pkg-1.4.5+1.18.2-fabric" = _2c5vJWwv;
        "pkg-1.4.5+1.19.2-fabric" = _w0mars34;
        "pkg-1.4.5+1.20.1-fabric" = _JBmDENFL;
        "pkg-1.4.5.1+1.18.2-forge" = _gdmBbwbJ;
        "pkg-1.4.5.1+1.19.2-forge" = _h9ixfoTK;
        "pkg-1.4.5.1+1.20.1-forge" = _D9jj1Z18;
        "pkg-1.4.6+1.20.1-fabric" = _xt9bPLmd;
        "pkg-1.5+1.20.1-forge" = _tPxrgWK6;
        "pkg-1.5+1.20.1-fabric" = _dV1ZHNoX;
        "pkg-1.5.1+1.20.1-forge" = _NIk0j5IY;
        "pkg-1.5.1+1.20.1-fabric" = _KfJypgOp;
        "pkg-1.5.2+1.20.1-forge" = _JuMQFIIY;
        "pkg-1.5.2+1.20.1-fabric" = _b6lkbjmu;
        "pkg-1.5.3+1.20.1-forge" = _eTrTfYuH;
        "pkg-1.5.4+1.20.1-forge" = _CIoOWxTy;
        "pkg-1.5.4+1.20.1-fabric" = _3BTYdc9A;
        "pkg-1.5.5+1.20.1-forge" = _xVYUYCbn;
        "pkg-1.5.6+1.20.1-forge" = _XCdY9ew8;
        "pkg-1.5.6+1.20.1-fabric" = _ocqYUkye;
        "pkg-1.5.7+1.20.1-fabric" = _zP3swNtv;
        "pkg-1.5.8+1.20.1-fabric" = _yPJ73ZP3;
        "pkg-1.6+1.20.1-forge" = _ujZU2IuJ;
        "pkg-1.6+1.21-neoforged" = _BTqqA6o7;
        "pkg-1.6.1+1.20.1-forge" = _iqCPvJnS;
        "pkg-1.6.1+1.21-neoforged" = _4pWDgWuJ;
        "pkg-1.6.2+1.20.1-forge" = _Jfc3cZ42;
        "pkg-1.6.2+1.21-neoforged" = _DjAY3P3K;
        "pkg-1.6.3+1.20.1-forge" = _oKASgF8z;
        "pkg-1.6.3+1.21-neoforged" = _tojuF8FU;
        "pkg-1.6.4+1.21.1-neoforged" = _B0NAlI5v;
        "pkg-1.6.5+1.20.1-forge" = _Xz8wY6gC;
        "pkg-1.6.5+1.21.1-neoforged" = _rLL3jGU6;
        "pkg-1.6.6+1.21.1-neoforged" = _eaxRv7tM;
        "pkg-1.6.7+1.21.1" = _2v3rhNnG;
        "pkg-1.6.8+1.21.1" = _3AyPFjJG;
        "pkg-1.7+1.21.1" = _UF0hMH9L;
        "pkg-1.7+1.20.1" = _OsKHAeBa;
        "pkg-1.7+1.20.1-fabric" = _xzMTuM3W;
        "pkg-1.7.1+1.21.1" = _WU05agPt;
        "pkg-1.7.1+1.20.1" = _k1du8nDj;
        "pkg-1.7.1+1.20.1-fabric" = _8HndwQde;
        "pkg-1.7.2+1.20.1-fabric" = _XBLKJgQt;
        "pkg-1.7.2+1.21.1" = _RHHbrHGm;
        "pkg-1.7.3+1.20.1-fabric" = _IPl2ZzII;
        "pkg-1.7.3+1.21.1" = _1BtGyIVR;
        "pkg-1.8+1.21.1" = _5Bv7PJJf;
        "pkg-1.8.1+1.21.1" = _Xp9vyJe0;
        "pkg-1.8.2+1.21.1" = _yioQUGiO;
        "default" = _yioQUGiO;
    });
