...
let
    ...
    in {
        ...
        "pkg-1.4.4" = _Ou3efpX9;
        "pkg-1.4.5" = _UBXiAibL;
        "pkg-1.5.0-beta" = _MJgzkAVO;
        "pkg-1.5.1-beta" = _MviXNGnp;
        "pkg-1.5.2-beta" = _GjAZCYLD;
        "pkg-1.5.3-beta" = _7TFaQi0T;
        "pkg-1.5.4-beta" = _U24YQpfA;
        "pkg-1.5.5-beta" = _DLmymwPK;
        "pkg-1.5.6-beta" = _cDjvO9g7;
        "pkg-2.0.0" = _WCxVdweL;
        "pkg-2.0.1" = _ndYtBu1C;
        "pkg-3.0.0" = _IES9laHj;
        "pkg-3.1.0" = _HSGkS2VT;
