...
let
    ...
    in {
        ...
        "pkg-0.4.0" = _jvda17yk;
        "pkg-0.4.1" = _Z0T9SIb5;
        "pkg-0.5.0b" = _aT1HJHtU;
        "pkg-0.5.1b" = _V938INQL;
        "pkg-0.5.2B" = _n7N2iJ7K;
        "pkg-0.5.3" = _h1p2fbl0;
        "pkg-0.5.5" = _f49W8mWB;
        "pkg-0.6.0" = _lV5jdKoV;
        "pkg-0.6.1" = _GmxeynKl;
        ...
        "pkg-0.6.6" = _4cDvdhPU;
        "pkg-0.6.7" = _ccFNTxJp;
        "pkg-1.0.0-SNAPSHOT" = _9ykaoX0f;
        "pkg-1.0.1-SNAPSHOT" = _KJZnCihK;
        "pkg-1.0.2-SNAPSHOT" = _bjuPqxwD;
        "pkg-1.0.3-SNAPSHOT" = _urJ09ZMm;
        "pkg-1.0.4-SNAPSHOT" = _e46FaqDE;
        "pkg-1.0.5" = _9lPruuyI;
        "pkg-1.0.6" = _xA4tu96U;
        "pkg-1.0.7" = _OYquncrz;
        "pkg-1.0.7-1" = _vJaOEamd;
        "pkg-1.0.8" = _rL7I6YEP;
        "pkg-1.0.9" = _mY9PI4PS;
        "default" = _mY9PI4PS;
    });
