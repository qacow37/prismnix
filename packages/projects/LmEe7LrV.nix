...
let
    ...
    in {
        ...
        "pkg-1.0.0+fabric.mc1.20.1" = _VChWuQtw;
        "pkg-1.0.0+fabric.mc1.21" = _C62t3iuR;
        "pkg-1.0.0+fabric.mc1.21.1" = _33TW2cUE;
        "pkg-1.0.0+forge.mc1.20.1" = _dCIY6bAR;
        "pkg-1.0.0+forge.mc1.21" = _ngEy7U56;
        "pkg-1.0.0+forge.mc1.21.1" = _vA2DIrR0;
        "pkg-1.0.0+neoforge.mc1.20.1" = _ff7vqbdC;
        "pkg-1.0.0+neoforge.mc1.21" = _nY1WIpt9;
        "pkg-1.0.0+neoforge.mc1.21.1" = _oBPZo3wn;
        "pkg-1.1.0+fabric.mc1.20.1" = _LI28RQrC;
        "pkg-1.1.0+fabric.mc1.21" = _H1hMsovi;
        "pkg-1.1.0+fabric.mc1.21.1" = _4I77QZTn;
        "pkg-1.1.0+forge.mc1.20.1" = _pWzTaWyX;
        "pkg-1.1.0+forge.mc1.21" = _QTB5vnmF;
        "pkg-1.1.0+forge.mc1.21.1" = _F3YQ3apR;
        "pkg-1.1.0+neoforge.mc1.20.1" = _8EQ6BVXv;
        "pkg-1.1.0+neoforge.mc1.21" = _ikBBw2d5;
        "pkg-1.1.0+neoforge.mc1.21.1" = _dgUquE2c;
        "pkg-1.2.0+fabric.mc1.20.1" = _WJkxlZkV;
        "pkg-1.2.0+fabric.mc1.21" = _lejLKsk4;
        "pkg-1.2.0+fabric.mc1.21.1" = _uTuQSNhE;
        "pkg-1.2.0+forge.mc1.20.1" = _zPDptD5u;
        "pkg-1.2.0+forge.mc1.21" = _DUohw2jw;
        "pkg-1.2.0+forge.mc1.21.1" = _Pm46ZrRs;
        "pkg-1.2.0+neoforge.mc1.20.1" = _uqoJyuzw;
        "pkg-1.2.0+neoforge.mc1.21" = _hfJfyczv;
        "pkg-1.2.0+neoforge.mc1.21.1" = _Gyjt65TV;
        "default" = _Gyjt65TV;
    });
