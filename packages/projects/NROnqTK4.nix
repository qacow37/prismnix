...
let
    ...
    in {
        ...
        "pkg-3.0.8" = _rYoTwTC6;
        "pkg-3.0.9" = _1uz3StD1;
        "pkg-3.0.10" = _7rXnfqGo;
        "pkg-3.1" = _kCiwENX0;
        "pkg-2.1.4" = _9lCP1rDF;
        "pkg-3.0.6.1" = _DPg9sJrA;
        "pkg-3.0.10.1" = _rYk8pTxQ;
        "pkg-3.0.3.1" = _73elbAmw;
        "pkg-3.0.4.1" = _DnkB4qoW;
        "pkg-3.0.12" = _gcrmxEKr;
        "pkg-3.0.8.1" = _gyYQmTf6;
        "pkg-3.1.1" = _XLbdV5pV;
        "pkg-3.2" = _Zzkv1u63;
        "pkg-3.3" = _9YYqDVJ7;
        "pkg-3.3.1" = _OU1WcmFW;
