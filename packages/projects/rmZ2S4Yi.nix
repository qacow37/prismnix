...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _3emLdo3i;
        "pkg-1.5.0" = _btRgMXSH;
        "pkg-1.5.0hf" = _o2oJ7fcr;
        "pkg-1.5.0hf2" = _K7hTNLCc;
        "pkg-1.5.0hf3" = _Oyuvx9MF;
        "pkg-1.5" = _hRZiRts3;
        "pkg-1.5.0hf5" = _rwn5w2BG;
        "pkg-1.5.5" = _ybbj22Ib;
        "pkg-1.6.0" = _qUTKZB3S;
        "pkg-1.5.5-hotfix" = _urGwlHo6;
        "pkg-1.5.0hotfix" = _G4XFgMNT;
        "pkg-1.6.0hotfix" = _yhStECeU;
        "pkg-0.1.0" = _p8CNwYX9;
        "pkg-0.2.0" = _l6CqTsAu;
        "pkg-1.7.0" = _5wGe3fHC;
        "pkg-1.7.1" = _igIx5uIh;
        ...
        "pkg-1.7.3" = _hMxaHScd;
        "pkg-1.7.4" = _oglMZe6Q;
        "pkg-1.5.5-fix-sodtext" = _recRjW02;
        "pkg-1.5.5-fsod" = _I87EWqZp;
        "pkg-1.7.5" = _bdwKwEcN;
        "pkg-1.7.6" = _PjIUAjc2;
        "pkg-2.0.0" = _ubLS43SQ;
        "pkg-2.0.1" = _cCcArNUp;
