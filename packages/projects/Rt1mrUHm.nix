...
let
    ...
    in {
        ...
        "pkg-1.6.1" = _7Em0LkGO;
        "pkg-1.6.2" = _njLTx7e8;
        "pkg-v1.6.3+1.19.3" = _BRahLXkh;
        "pkg-v1.6.4+1.19.4" = _W9OSM1WK;
        "pkg-v1.6.5+1.20" = _kv9HVGqj;
        "pkg-v1.6.6+1.20" = _ulkivKzy;
        "pkg-v1.6.7+1.20.2" = _Wvq5AKkm;
        "pkg-v1.6.8+1.20.4" = _GAHsEejj;
        "pkg-1.6.9+1.20.4" = _FKBhsHiX;
        "pkg-1.6.10+1.20.6" = _NpTnkgrn;
        "pkg-1.6.11+1.21" = _WSx6SItb;
        "pkg-1.6.12+1.21.1" = _8VvLvwMn;
        "pkg-1.6.13+1.21.1" = _Y5EAJzwR;
        "pkg-1.6.13+1.21.5" = _PaIo4ZGM;
        "pkg-1.6.14+1.21.5" = _51pvu7W9;
        "pkg-1.6.14+1.21.6" = _iPCHaTPt;
        "pkg-1.6.15+1.21.6" = _aX5ZEmN4;
        "pkg-1.7.0+1.21.10" = _Qi5eDlej;
        "pkg-1.8.0+1.21.11" = _yyg5IZNd;
        "pkg-1.8.1+1.21.11" = _2PHCrWcd;
