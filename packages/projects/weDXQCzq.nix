...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _bg4rB8n8;
        "pkg-1.0.1+1.18.2+forge" = _bX8Jt7v6;
        "pkg-1.0.1+1.18.2+fabric" = _dN7mftRR;
        "pkg-1.0.1+1.19.2+fabric" = _AXryrCCQ;
        "pkg-1.0.1+1.19.2+forge" = _KKyIMSiA;
        "pkg-1.0.2+1.18.2+forge" = _TLXoX7MB;
        "pkg-1.0.2+1.18.2+fabric" = _3IkH4h4C;
        "pkg-1.0.2+1.19.2+forge" = _5xtf7Ie5;
        "pkg-1.0.2+1.19.2+fabric" = _HIEgFPpr;
        "pkg-1.0.3+1.18.2+fabric" = _fw3nUz1p;
        "pkg-1.0.3+1.18.2+forge" = _iXn76dGf;
        "pkg-1.0.3+1.19.2+fabric" = _EXErPk7a;
        "pkg-1.0.3+1.19.2+forge" = _pidYqS8s;
        "pkg-1.0.4+1.18.2+fabric" = _icMLmwer;
        "pkg-1.0.4+1.18.2+forge" = _GgjTQeO4;
        "pkg-1.0.4+1.19.2+fabric" = _wsnFiUnd;
        "pkg-1.0.4+1.19.2+forge" = _oVFpTaen;
        "pkg-1.0.5+1.19.2+fabric" = _dnQewFpw;
        "pkg-1.0.5+1.19.2+forge" = _9FePlBSw;
        "pkg-2.0.0" = _VwRFyuRh;
        "pkg-2.0.1" = _zzgWd67r;
        "pkg-2.1.0" = _BaQkAtTP;
        "pkg-2.2.0" = _pMGiPKZK;
