...
let
    ...
    in {
        ...
        "pkg-1.9.0" = _IrtJOFk4;
        "pkg-1.9.1" = _OO0H9Bmn;
        "pkg-1.10.0" = _UgoYokGP;
        "pkg-1.10.1" = _6mV7YSXe;
        "pkg-1.10.2" = _f4vXIl39;
        "pkg-1.10.3" = _JJUl7Tiw;
        "pkg-1.11.0" = _igFZiPRt;
        "pkg-1.12.0" = _Ilz254iQ;
        "pkg-1.12.1" = _nhL7pwg3;
        "pkg-1.12.2" = _45Oi1iHe;
        "pkg-1.12.3" = _wIusrDta;
        "pkg-1.12.4" = _qv6OPTT9;
        "pkg-1.12.5" = _bWobbVeb;
        "pkg-1.13.0" = _FzOhT0AY;
        "pkg-1.14.0" = _WZK1QNXE;
        "pkg-1.15.0" = _MlrVJcWY;
        "pkg-1.16.0" = _GY6LlAYN;
        "default" = _GY6LlAYN;
    });
