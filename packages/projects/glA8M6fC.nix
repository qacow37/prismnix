...
let
    ...
    in {
        ...
        "pkg-1.19.3-1.0.7" = _RKfUfSXy;
        "pkg-1.19.3-1.0.8" = _Jrke32Se;
        "pkg-1.19.3-1.0.9" = _VLwyYh7n;
        "pkg-1.19.3-1.0.10" = _RKSxxdj6;
        "pkg-1.19.3-1.1.0" = _jCUkZZAx;
        "pkg-1.19.3-1.1.1" = _yOmnGiwe;
        "pkg-1.19.3-1.1.2" = _gucaIZcQ;
        "pkg-1.19.3-1.1.3" = _n3vPpxqv;
        "pkg-1.19.3-1.1.4" = _qpTDz46T;
        "pkg-1.19.3-1.1.5" = _X1fv29wQ;
        "pkg-1.19.3-1.1.6" = _KDcHJ8CY;
        "pkg-1.19.3-1.1.7" = _slyOSpNi;
        "pkg-1.19.3-1.2.0" = _zjqPbaBW;
        "pkg-1.19.3-1.2.1" = _oneirOc0;
        "pkg-1.19.3-1.2.2" = _rTixC3Sa;
        "pkg-1.19.3-1.2.3" = _eWhaaucx;
        "pkg-1.19.3-1.2.4" = _ISUVWeWE;
        "pkg-1.19.3-1.2.5" = _i8gwmYpS;
        "pkg-1.19.3-1.2.6" = _CrVwPXa2;
        "pkg-1.19.4-1.3.0" = _YenwC9DN;
        "pkg-1.19.4-1.3.1" = _XD0osQpb;
        "pkg-1.19.4-1.3.2" = _WgaHejE2;
        "pkg-1.19.4-1.3.3" = _nbY0iyuz;
        "pkg-1.19.4-1.3.4" = _t7yqD5m8;
        "pkg-1.19.4-1.4.0" = _4BboxItB;
        "pkg-1.19.4-1.4.1" = _EdZwdOut;
        "pkg-1.19.4-1.4.2" = _yKG9nljz;
        "pkg-1.19.4-1.5.0" = _LwsUvqD6;
        "pkg-1.20.1-1.6.0" = _xPPfUaKc;
        "pkg-1.20.1-1.6.1" = _Motg0BHR;
        "pkg-1.20.1-1.6.2" = _dwlQDmgt;
        "pkg-1.20.1-1.6.3" = _m7FnjBmg;
        "pkg-1.20.1-1.6.4" = _5NGe3qbR;
        "pkg-1.20.1-1.6.5" = _GqE653LL;
        "pkg-1.20.1-1.6.6" = _MAf5i3au;
        "pkg-1.20.1-1.7.0" = _iHiXo9Vj;
        "pkg-1.20.1-1.8.0" = _MIYvLhS3;
        "pkg-1.20.1-1.8.1" = _sRD4LQ8k;
        "pkg-1.20.1-1.9.0" = _HEbkxWZs;
        "pkg-1.20.1-1.9.1" = _Awxp25Gp;
        "pkg-1.20.1-1.10.0" = _m8WsmK5c;
        "pkg-1.20.1-1.10.1" = _ImtkEYtI;
        "pkg-1.20.1-1.11.0" = _Hc4VbMHQ;
        "pkg-1.20.1-1.12.0" = _QeDKik1G;
        "pkg-1.20.1-1.12.1" = _CCijXoPy;
        "pkg-1.20.1-1.12.2" = _GX2SQS9a;
        "pkg-1.20.1-1.12.3" = _DrqWUThE;
        "pkg-1.20.1-1.12.4" = _lGK5nkh4;
        "pkg-1.20.1-1.12.5" = _DYIkWe6F;
        "pkg-1.20.1-1.12.6" = _HfqUPRG7;
        "pkg-1.20.1-1.12.7" = _FeRx7jb3;
        "pkg-1.20.1-1.13.0" = _yMUQojpE;
        "pkg-1.20.1-1.13.1" = _5Weh9SHf;
        "default" = _5Weh9SHf;
    });
