...
let
    ...
    in {
        ...
        "pkg-1.6.3" = _gJTEb1Jw;
        "pkg-1.6.4" = _wk8xyAbk;
        "pkg-FORGE-1.6.5" = _Czk3eSG2;
        "pkg-NEOFORGE-1.6.5" = _bvSaHIFr;
        "pkg-FORGE-1.7" = _qBllNsMb;
        "pkg-NEOFORGE-1.7" = _66koauQ4;
        "pkg-HOTFIX-NEOFORGE-1.7.1" = _HIKJDGQu;
        "pkg-FORGE-1.7.1" = _5Tztem9x;
        "pkg-NEOFORGE-1.7.1" = _RwltEinP;
        "pkg-NEOFORGE-1.7.2" = _SK32Fp6J;
        "pkg-FORGE-1.8" = _S3kdijLV;
        "pkg-NEOFORGE-1.8" = _lnEoLCMG;
        "pkg-FORGE-1.8.1" = _YQE6t16c;
        "pkg-NEOFORGE-1.8.1" = _UT71syvL;
        "pkg-FORGE-1.8.2" = _EoscSAGo;
        "pkg-NEOFORGE-1.8.2" = _yh2DHmmk;
        "pkg-FORGE-1.9" = _BmPBiRhF;
        "pkg-NEOFORGE-1.9" = _PZrnGIOx;
        "pkg-v1.9.1" = _eLFWPh3H;
        "pkg-v1.10" = _cAP7Wn2B;
        "pkg-v1.10.2" = _FQvYZHed;
        "pkg-v1.10.3" = _oBhX6MAz;
        "pkg-v1.10.4" = _fXvjfe3h;
        "pkg-v1.10.5" = _V3pbdltb;
        "pkg-v1.11" = _EQJguzcR;
        "pkg-v1.11.1" = _RDqBKWdU;
