...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.21.1" = _Jw8uYDZM;
        "pkg-1.1.0-1.21.4" = _Bn4grD3a;
        "pkg-1.1.1-1.21.1" = _KdTson5F;
        "pkg-1.1.0-1.20.1" = _ZVt0So1i;
        "pkg-1.2.0-1.20.1" = _F0ccVp1G;
        "pkg-1.2.0-1.21.1" = _KjFyHzPd;
        "pkg-1.2.0-1.21.4" = _XMIHluI1;
        "pkg-1.2.0-1.21.5" = _1IhJQlxy;
        "pkg-1.2.0-1.21.6" = _92GQO7r6;
        "pkg-1.3.2-1.20.1" = _qcxlvAQn;
        "pkg-1.3.2-1.21.1" = _tzVmVqPV;
        "pkg-1.3.2-1.21.5" = _T7ZlPSzF;
        "pkg-1.3.2-1.21.6" = _dtrJTgEG;
        "pkg-1.3.3-1.20.1" = _Tp3EKChK;
        "pkg-1.3.3-1.21.1" = _jKNoaoKJ;
        "pkg-1.3.3-1.21.5" = _F2lPTTod;
        "pkg-1.3.3-1.21.6" = _r4v8SR6e;
        "pkg-1.3.4-1.20.1" = _aMuesiuj;
        "pkg-1.3.4-1.21.1" = _aA67X5XT;
        "pkg-1.3.4-1.21.5" = _UJVrxqvq;
        "pkg-1.3.4-1.21.6" = _C4qFafeL;
        "pkg-2.0.0b-1.21.6" = _kNWunPfV;
        "pkg-2.0.0-1.20.1" = _S8kK1oN9;
        "pkg-2.0.0-1.21.1" = _JOlSBRqa;
        "pkg-2.0.0-1.21.5" = _chYbctXF;
        "pkg-2.0.0-1.21.6" = _Url8LkQp;
        "pkg-2.1.0b-1.21.6" = _lSfAP1uD;
        "pkg-2.2.0-1.20.1" = _vJgxO1Pt;
        "pkg-2.2.0-1.21.1" = _OiGIK62N;
        "pkg-2.2.0-1.21.4" = _mivwb5R3;
        "pkg-2.2.0-1.21.5" = _qTYH2z3N;
        "pkg-2.2.0-1.21.6" = _DDZaqSrT;
        "pkg-2.3.0-1.20.1" = _4kQYaVSl;
        "pkg-2.3.0-1.21" = _Lgs5bLD1;
        "pkg-2.3.0-1.21.4" = _IEBB7fdO;
        "pkg-2.3.0-1.21.5" = _aY6AAUK6;
        "pkg-2.3.0-1.21.6" = _Ky5Nmmw5;
        "pkg-2.3.0o-1.21.6" = _PI0Rsz46;
        "pkg-2.3.1-1.20.1" = _zo5K6RGP;
        "pkg-2.3.1-1.21" = _GYVfps1j;
        "pkg-2.3.1-1.21.4" = _4g7FP0RX;
        "pkg-2.3.1-1.21.5" = _IjMjFRP4;
        "pkg-2.3.1o" = _j7n63R2n;
        "pkg-2.3.1-1.21.6" = _m81I5cE4;
        "pkg-2.3.2-1.20.1" = _4mqz5EQ6;
        "pkg-2.3.2-1.21" = _NAQEm2yN;
        "pkg-2.3.2-1.21.4" = _n9OeJLXP;
        "pkg-2.3.2-1.21.5" = _uoEVrdm7;
        "pkg-2.3.2-1.21.6" = _JBgOUbhf;
        "pkg-2.3.3-1.21.10" = _rnydA0Rn;
        "pkg-2.3.4-1.21.11" = _FdaBYCxc;
        "pkg-2.4.0-1.21.1" = _tfSUsCeA;
        "pkg-2.4.0-1.21.8" = _RzPo41sw;
        "pkg-2.4.0-1.21.11" = _WYKkOz52;
        "pkg-2.4.0-1.20.1h" = _4Kz4ZxB5;
        "pkg-2.4.0-1.21.4" = _5Ra72d3s;
        "pkg-2.4.0-1.21.5" = _Vv8dEsU9;
        "pkg-2.4.0-1.21.10h" = _MGlGOS8L;
        "pkg-2.5.0-1.21.11b" = _xpZljvvi;
        "pkg-2.5.0-1.20.1" = _EzChh0CU;
        "pkg-2.5.0-1.21.1" = _cY5xndEd;
        "pkg-2.5.0-1.21.4" = _OxPtWqwb;
        "pkg-2.5.0-1.21.5" = _fMOZyZSm;
        "pkg-2.5.0-1.21.8" = _WYdFEUwM;
        "pkg-2.5.0-1.21.10" = _7XE9n60s;
        "pkg-2.5.0-1.21.11" = _1fDopX3t;
        "pkg-2.5.1-1.20.1" = _azkcuwn5;
        "pkg-2.5.1-1.21.1" = _qVyUzwgO;
        "pkg-2.5.1-1.21.4" = _T5IiAwrJ;
        "pkg-2.5.1-1.21.5" = _QTc19KbA;
        "pkg-2.5.1-1.21.8" = _9fUsPmPQ;
        "pkg-2.5.1-1.21.10" = _GqVVxIoQ;
        "pkg-2.5.1-1.21.11" = _T9IMXw8g;
        "pkg-2.5.1-26.1bh" = _aCiKriuG;
        "pkg-2.5.2-1.20.1" = _57vlP9bY;
        "pkg-2.5.2-1.21.1" = _Y1iiIPs0;
        "pkg-2.5.2-1.21.4" = _CPnecT7d;
        "pkg-2.5.2-1.21.5" = _x5IoB1bM;
        "pkg-2.5.2-1.21.6" = _At7GzqhS;
        "pkg-2.5.2-1.21.10" = _jRofOj4F;
        "pkg-2.5.2-1.21.11" = _qmyq7C5j;
        "pkg-2.5.2-26.1" = _Zq1llYKV;
        "pkg-2.5.2-26.2" = _P9qSgvLC;
        "pkg-2.5.2-26.2b-neoforge" = _l8uGAyPE;
        "pkg-2.5.2-1.20.1-forge" = _Mhnup0pQ;
        "pkg-2.5.2-1.21.1-neoforge" = _2hhAAkXI;
