...
let
    ...
    in {
        ...
        "pkg-1.18.2-1" = _ugtXbSeF;
        "pkg-1.18.2-2" = _ebXROafP;
        "pkg-1.18.2-3" = _VnS1zdd3;
        "pkg-1.19-4" = _mJ3Q4M0p;
        "pkg-1.19-5" = _vD0LPGDe;
        "pkg-1.19-6" = _YisOu3Dc;
        "pkg-1.19.1-8" = _JxPtjYuu;
        "pkg-1.19.1-9" = _VotWLgYN;
        "pkg-1.19.2-10" = _nYEKtP8u;
        "pkg-1.19.2-11" = _iFrUze7x;
        "pkg-1.19.2-12" = _BKknQjKl;
        "pkg-1.19.2-13" = _akLbBocw;
        "pkg-1.19.2-14" = _rXsUAUb7;
        "pkg-1.19.2-15" = _sRXRqc5l;
        "pkg-1.19.2-16" = _oT2EAd5Y;
        "pkg-1.19.3-18" = _YtPPZlfk;
        "pkg-1.19.3-19" = _1ZO3uhGK;
        "pkg-1.19.3-20" = _HYwJSBkg;
        "pkg-1.19.3-21" = _yWwriCNp;
        "pkg-1.19.3-22" = _6wevfg0P;
        "pkg-1.20.1-23" = _igdun7Zr;
        "pkg-1.20.1-24" = _keQi9vwN;
        "pkg-1.20.2-rc2-25" = _RGN0bUck;
        "pkg-1.20.2-27" = _eyKQ0552;
        "pkg-1.20.2-28" = _gAFIPgCn;
        "pkg-1.20.4-29" = _4dI9G0zX;
        "pkg-1.20.4-31" = _PsMnmva5;
        "pkg-1.20.6-33" = _YBoac4Km;
        "pkg-1.20.6-34" = _YBxOvlej;
        "pkg-1.20.6-35" = _Rrjfm63i;
        "pkg-1.21-36" = _f2ha5oDc;
        "pkg-1.21-37" = _Jo6cRJiU;
        "pkg-1.21.3-39" = _rmHsxllf;
        "pkg-1.21.4-40" = _ldjSpT4Z;
        "pkg-1.21.4-41" = _Uw2BP61x;
        "pkg-1.21.5-42" = _exvWatvc;
        "pkg-1.21.5-43" = _psX2Xx1W;
        "default" = _psX2Xx1W;
    });
