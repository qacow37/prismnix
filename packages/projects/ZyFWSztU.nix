...
let
    ...
    in {
        ...
        "pkg-1.12.2-0.2.2" = _xZNp0qcX;
        "pkg-1.16.5-0.2.2" = _6PuA6rjs;
        "pkg-1.18.2-0.2.2" = _2CgS8fNU;
        "pkg-1.19.2-0.2.2" = _WHddrf2j;
        "pkg-1.18.2-fabric-0.2.2" = _irLJIZ95;
        "pkg-1.19.2-fabric-0.2.2" = _IQVKnM5d;
        "pkg-1.12.2-0.2.3" = _dlbExijc;
        "pkg-1.16.5-0.2.3" = _WxXByKqg;
        "pkg-1.18.2-0.2.3" = _vhoQ9zOv;
        "pkg-1.19.2-0.2.3" = _JdU6BRq1;
        "pkg-1.18.2-fabric-0.2.3" = _TBi6rh72;
        "pkg-1.19.2-fabric-0.2.3" = _uEDLh3Na;
        "pkg-1.12.2-0.2.4" = _Gh2j7zQb;
        "pkg-1.16.5-0.2.4" = _nslxIlEo;
        "pkg-1.18.2-0.2.4" = _eUVyY72S;
        "pkg-1.19.2-0.2.4" = _vHRrkDW5;
        "pkg-1.18.2-fabric-0.2.4" = _Z5hV5vmD;
        "pkg-1.19.2-fabric-0.2.4" = _kZJqAB8a;
        "pkg-1.20.1-fabric-0.2.4" = _CDgrYXYV;
        "pkg-1.12.2-0.3.0" = _IfFpK9iA;
        "pkg-1.16.5-0.3.0" = _eJ2k7RHx;
        "pkg-1.18.2-0.3.0" = _ffQocyaq;
        "pkg-1.19.2-0.3.0" = _zseWwzgc;
        "pkg-1.18.2-fabric-0.3.0" = _QKev6ZCw;
        "pkg-1.19.2-fabric-0.3.0" = _kOeWCtYg;
        "pkg-1.20.1-fabric-0.3.0" = _l4gmJNc1;
        "pkg-1.16.5-0.3.1" = _lBoW0OT6;
        "pkg-1.18.2-0.3.1" = _75AtcMDM;
        "pkg-1.19.2-0.3.1" = _8Ge01RgS;
        "pkg-1.18.2-fabric-0.3.1" = _PCMbGr40;
        "pkg-1.19.2-fabric-0.3.1" = _uRuobNu8;
        "pkg-1.20.1-fabric-0.3.1" = _lN3Z5yKr;
        "pkg-0.4.0" = _T8UFxOKd;
        "pkg-0.4.1" = _eeX27HbS;
        "pkg-0.4.2" = _RcJlFR99;
        "pkg-0.4.3" = _DYUFyqHR;
