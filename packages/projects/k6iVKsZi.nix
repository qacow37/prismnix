...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _Qdwcdh8z;
        "pkg-1.0.0+1.21.4" = _EMaBD9Sm;
        "pkg-1.0.0+1.21.1" = _X9mMnhQP;
        "pkg-1.0.0+1.20.4" = _tDbIZxVG;
        "pkg-1.0.0+1.20.1" = _7RQaHFXT;
        "pkg-1.0.0+1.19.4" = _hArSOsgc;
        "pkg-1.0.0+1.19.2" = _QBLttxHv;
        "pkg-1.0.0+1.18.2" = _6P3VmRpT;
        "pkg-1.0.0+1.18.1" = _FV7JX8zW;
        "pkg-1.0.0+1.17.1" = _iOlmU8R8;
        "pkg-1.0.0+1.16.5" = _JOybnJqQ;
        "pkg-1.0.0+1.20.6" = _zdOWOhQV;
        "pkg-1.0.0+forge-1.21.11" = _D0V3JIuW;
        "pkg-1.0.0+forge-1.21.4" = _JMIwIGMS;
        "pkg-1.0.0+forge-1.21.1" = _OUXmuLV2;
        "pkg-1.0.0+forge-1.20.6" = _qGwV25UB;
        "pkg-1.0.0+forge-1.20.4" = _kbp1IjEa;
        "pkg-1.0.0+forge-1.20.1" = _ps1XBXWD;
        "pkg-1.0.0+forge-1.19.4" = _49ye6bor;
        "pkg-1.0.0+forge-1.19.2" = _Sl2SpmeU;
        "pkg-1.0.0+forge-1.18.2" = _RvAMFXCq;
        "pkg-1.0.0+forge-1.18.1" = _mEs5dDsr;
        "pkg-1.0.0+forge-1.17.1" = _izKo2aXz;
        "pkg-1.0.0+forge-1.16.5" = _rC8QQhrT;
        "pkg-1.0.0+neoforge-1.21.1" = _pW7iywFp;
        "pkg-1.0.0+neoforge-1.21.4" = _kz6c2Lp9;
        "pkg-1.0.0+neoforge-1.21.11" = _Mhv4wiXc;
        "pkg-1.0.0+quilt-1.20.1" = _lOIKUbXj;
        "pkg-1.0.0+quilt-1.21.1" = _jJ8Oswx5;
        "pkg-1.0.0+quilt-1.21.4" = _NA2S9gsY;
        "pkg-1.0.0+quilt-1.21.11" = _6UnU1qAe;
        "pkg-1.0.0+quilt-1.20.6" = _DnGezTxU;
        "pkg-1.0.0+neoforge-1.20.6" = _ioZsgknJ;
        "pkg-1.0.0+1.14.4" = _pJV1Pl3C;
        "pkg-1.0.0+1.15.1" = _8ONuFCKH;
        "pkg-1.0.0+1.15.2" = _r2U6XepI;
        "pkg-1.0.0+1.15" = _nxcAFyTJ;
        "pkg-1.0.0+1.16.1" = _NHyKSeZT;
        "pkg-1.0.0+1.16.2" = _EbhWR1Be;
        "pkg-1.0.0+1.16.3" = _qI0MKGI0;
        "pkg-1.0.0+1.16.4" = _8RkCzmdk;
        "pkg-1.0.0+1.16" = _ELMU6FjR;
        "pkg-1.0.0+1.17" = _c1Q4hDOL;
        "pkg-1.0.0+1.18" = _VI23MSg9;
        "pkg-1.0.0+1.19" = _WXvnmXwS;
        "pkg-1.0.0+1.19.1" = _HRNlGpcY;
        "pkg-1.0.0+1.19.3" = _4tv7g5CR;
        "pkg-1.0.0+1.20" = _lFcJdpr8;
        "pkg-1.0.0+1.20.2" = _OZ93Do5R;
        "pkg-1.0.0+1.20.3" = _yJqnYzyO;
        "pkg-1.0.0+1.20.5" = _MohPJ4vQ;
        "pkg-1.0.0+1.21.2" = _tUDVaUOQ;
        "pkg-1.0.0+1.21.3" = _YVdwzUNo;
        "pkg-1.0.0+1.21.5" = _ge8sIqHz;
        "pkg-1.0.0+1.21.6" = _ZXbAR0xq;
        "pkg-1.0.0+1.21.7" = _29ekrTJX;
        "pkg-1.0.0+1.21.8" = _w0UlWyRB;
        "pkg-1.0.0+1.21.9" = _fDpUmhHu;
        "pkg-1.0.0+1.21.10" = _3nLqBUbY;
        "pkg-1.0.0+1.21" = _KxKOKDgY;
        "pkg-1.0.0+forge-1.20" = _ZJdpRAUH;
        "pkg-1.0.0+forge-1.20.2" = _5oxUrxcc;
        "pkg-1.0.0+forge-1.20.3" = _TEYXigml;
        "pkg-1.0.0+forge-1.21" = _2cVkmy3b;
        "pkg-1.0.0+forge-1.21.3" = _4ZQlQNKR;
        "pkg-1.0.0+forge-1.21.5" = _FNgdEgox;
        "pkg-1.0.0+forge-1.21.6" = _or9s4JF5;
        "pkg-1.0.0+forge-1.21.7" = _vlYuJSMN;
        "pkg-1.0.0+forge-1.21.8" = _coNQ3BNO;
        "pkg-1.0.0+forge-1.21.9" = _n8Gdb3JF;
        "pkg-1.0.0+forge-1.21.10" = _WzZIJw3g;
        "pkg-1.0.0+neoforge-1.20.2" = _3w6hK5TG;
        "pkg-1.0.0+neoforge-1.20.3" = _WUPTpZRO;
        "pkg-1.0.0+neoforge-1.20.5" = _93rQnJln;
        "pkg-1.0.0+neoforge-1.21" = _IYu5aQla;
        "pkg-1.0.0+neoforge-1.21.3" = _JxisKfTw;
        "pkg-1.0.0+neoforge-1.21.5" = _Ijni63CF;
        "pkg-1.0.0+neoforge-1.21.6" = _uS4YyUKU;
        "pkg-1.0.0+neoforge-1.21.7" = _5HNRtBoY;
        "pkg-1.0.0+neoforge-1.21.8" = _a3nsRiLS;
        "pkg-1.0.0+neoforge-1.21.9" = _ucNSjRi9;
        "pkg-1.0.0+neoforge-1.21.10" = _RUSLaNw2;
        "pkg-1.0.0+quilt-1.20" = _BDVUvEMb;
        "pkg-1.0.0+quilt-1.20.2" = _i54QT1Pq;
        "pkg-1.0.0+quilt-1.20.3" = _FpPyGJmR;
        "pkg-1.0.0+quilt-1.20.5" = _bgokJmqf;
        "pkg-1.0.0+quilt-1.21" = _OeWHyzP7;
        "pkg-1.0.0+quilt-1.21.2" = _uQZLDpu4;
        "pkg-1.0.0+quilt-1.21.3" = _DBN3H7qa;
        "pkg-1.0.0+quilt-1.21.5" = _BlExZc62;
        "pkg-1.0.0+quilt-1.21.6" = _LVAUNV8J;
        "pkg-1.0.0+quilt-1.21.7" = _wMD8lBtk;
        "pkg-1.0.0+quilt-1.21.8" = _ICiQWTjh;
        "pkg-1.0.0+quilt-1.21.9" = _oJMyvrAW;
        "pkg-1.0.0+quilt-1.21.10" = _WaWoQs3U;
        "default" = _WaWoQs3U;
    });
