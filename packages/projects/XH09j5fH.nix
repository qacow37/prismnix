...
let
    ...
    in {
        ...
        "pkg-4.0.0" = _7yWSXy51;
        "pkg-4.0.1-Forge" = _V4syoE2M;
        "pkg-4.0.1-Fabric" = _79UOVYE0;
        "pkg-v4.0.2-1.19-Forge" = _vZqUU4jT;
        "pkg-v4.0.2-1.19-Fabric" = _zixaK7nQ;
        "pkg-v4.0.2-1.18.2-1.18.2-Forge" = _HxZvJP0u;
        "pkg-v4.0.2-1.18.2-1.18.2-Fabric" = _gJ6mVkxx;
        "pkg-v4.0.21-1.18.2-1.18.2-Forge" = _qhH0Luc0;
        "pkg-v4.0.21-1.18.2-1.18.2-Fabric" = _fIcFdPfI;
        "pkg-v4.0.0-1.19-Fabric" = _sea89ptK;
        "pkg-v4.0.0-1.19-Forge" = _klcy3gdq;
        "pkg-v4.0.4-1.19.3-Forge" = _HvauKRmv;
        "pkg-v4.0.4-1.19.3-Fabric" = _l0aLdpQ1;
        "pkg-v4.0.5-1.19.2-Forge" = _myxTRIoK;
        "pkg-v4.0.5-1.19.2-Fabric" = _b0vVVSmK;
        "pkg-v4.0.6-1.20.1-Forge" = _D5zh4XcE;
        "pkg-v4.0.6-1.20.1-Fabric" = _xYGKT64I;
        "pkg-v4.1.0-1.20.1-Forge" = _SQygau5I;
        "pkg-v4.1.0-1.20.1-Fabric" = _g03JmHiO;
        "pkg-5.0.0" = _JBr9MbC5;
        "pkg-5.0.1" = _OGmbvan5;
        "pkg-5.0.2" = _AuZ93QAj;
        "pkg-5.1.0" = _CaLM1z2E;
