...
let
    ...
    in {
        ...
        "pkg-1.6.0" = _5PhfdFT8;
        "pkg-1.6.1" = _UGJCQzEe;
        "pkg-1.7.0-1.21.6" = _7OSefGi5;
        "pkg-1.7.0-1.21.5" = _qXHVZcbQ;
        "pkg-1.7.0-1.21.4" = _Mf2H3NiR;
        "pkg-1.7.0-1.21" = _jyNzIv5x;
        "pkg-1.7.0-1.21.2" = _GCbQ84C9;
        "pkg-1.7.0-1.21.9" = _f6IaDOOo;
        "pkg-2.0.0-1.21.9" = _zOI2FWz9;
        "pkg-2.0.0-1.21.6" = _qPGzB5Km;
        "pkg-2.0.0-1.21.5" = _pnfZbepY;
        "pkg-2.0.0-1.21.4" = _RNp6nn7b;
        "pkg-2.0.0-1.21.2" = _bbsgzFdw;
        "pkg-2.0.0-1.21" = _7ifRcoJa;
        "pkg-2.1.0-1.21.9" = _rPyJcXEw;
        "pkg-2.1.0-1.21.6" = _GZ8MvUEB;
        "pkg-2.1.1-1.21.9" = _YfrdWXLK;
        "pkg-2.2.0-1.21.9" = _t3RLbDv3;
        "pkg-2.2.0-1.21.4" = _8M81jkbC;
        "pkg-2.3.0-1.21.9" = _EPWVKf2m;
        "pkg-2.3.0-1.21.11" = _rw0sOqcG;
        "pkg-2.3.0-1.21.4" = _aqGmae4M;
        "pkg-2.3.1-1.21.11" = _udqAIYHF;
        "pkg-2.3.1-1.21.6" = _iHHVRRtQ;
        "pkg-2.4.0-1.21.11" = _ythpXb5P;
        "pkg-2.4.0-26.1" = _JXgWX24K;
        "pkg-2.4.0-26.2" = _VXKIQFRu;
        "pkg-2.5.0-26.2" = _zXq1uNQk;
        "pkg-2.5.0-26.1" = _NBrpK1PN;
        "pkg-2.5.0-1.21.11" = _5IcrmYbw;
        "pkg-2.6.0-26.2-fabric" = _vwGsFNCK;
        "pkg-2.6.0-26.2-neoforge" = _Xz5RF0QT;
        "pkg-2.6.0-26.1-fabric" = _A9hFPdnD;
