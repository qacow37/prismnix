...
let
    ...
    in {
        ...
        "pkg-0.1" = _BT2kxKBw;
        "pkg-0.1.1" = _8LWXGm2u;
        "pkg-0.1.1.a" = _Q9gcKyCr;
        "pkg-0.1.1.b" = _zIRCnHSC;
        "pkg-0.1.1.c" = _l2RUtn5p;
        "pkg-0.1.1.d" = _TUhMI74Y;
        "pkg-0.1.1.e" = _ZANNsgf1;
        "pkg-0.1.2" = _Q1g1ub1T;
        "pkg-0.1.2a" = _FCooJ9T5;
        "pkg-0.1.2b+forge-mc1.20.1" = _zyzUpNVS;
        "pkg-0.1.2b+fabric-mc1.20.1" = _SnJlguQv;
        "pkg-0.1.3+forge-mc1.20.1" = _MnM74hgh;
        "pkg-0.1.3+fabric-mc1.20.1" = _Ib2iSolv;
        "pkg-forge-0.1.3a" = _YU3raPpj;
        "pkg-fabric-0.1.3a" = _YgBxAFTi;
        "pkg-0.1.4" = _BgreUV0v;
        "pkg-0.1.5" = _r6V58ymo;
        "pkg-0.1.6" = _y79vg16K;
        "pkg-0.1.7" = _vGRO5TSr;
        ...
        "pkg-0.2.8" = _2d65R1QV;
        "pkg-0.2.9" = _kPOkmYw9;
        "pkg-0.2.10" = _5GrIiX67;
        "pkg-0.2.11" = _nKAay8G8;
        "pkg-0.2.12" = _H3qyLPNX;
        "pkg-0.2.13" = _1eIE5bd1;
        "pkg-0.3" = _ZIQsj5v8;
        "pkg-0.3.1" = _B0TqqmAJ;
        "pkg-0.3.2" = _hs24j1yE;
        "pkg-0.3.3" = _Stc6Vo9Y;
