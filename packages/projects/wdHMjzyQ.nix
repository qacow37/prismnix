...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _I773OQeq;
        "pkg-1.0.2" = _4z6pFFFF;
        "pkg-2.0.0.0" = _itHjQfbP;
        "pkg-2.0.0.1" = _kApET880;
        "pkg-2.0.0.2" = _XlGJnnar;
        "pkg-2.0.2.0" = _5sCoWMPG;
        "pkg-2.0.3.0" = _yuctmPlM;
        "pkg-2.0.4.0" = _6bdvvt9f;
        "pkg-2.0.5.0" = _PmbX1wo2;
        "pkg-2.0.6.0" = _cet5bTq6;
        "pkg-2.0.7.0" = _oVAeLBW7;
        "pkg-2.0.8.0" = _4qliJM2g;
        "pkg-2.0.9.0" = _TA9HpbVV;
        "pkg-2.1.0" = _8zXKxFxb;
        "pkg-2.1.1" = _jtfL9GQa;
        "pkg-3.0.0" = _H7eZ5dMn;
        "pkg-3.1.0" = _QCPc3s8I;
