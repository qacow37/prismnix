...
let
    ...
    in {
        ...
        "pkg-0.1.0+neoforge" = _gzSalUhG;
        "pkg-0.2.3+neoforge" = _vOna3S00;
        "pkg-0.3.0+neoforge" = _wNQ7uP6H;
        "pkg-0.3.0+fabric" = _g9oPIP30;
        "pkg-0.3.1+neoforge" = _Ma4vAV8l;
        "pkg-0.3.1+fabric" = _gGix9Y2k;
        "pkg-0.4.0+neoforge" = _qelqeNqA;
        "pkg-0.4.0+fabric" = _GC3SVQKA;
        "pkg-0.4.1+neoforge" = _AmP56VQe;
        "pkg-0.4.1+fabric" = _UTsi5tDP;
        "pkg-0.4.2+neoforge" = _SuTFXDvE;
        "pkg-0.4.2+fabric" = _2Gqhx7jx;
        "pkg-0.5.0+neoforge" = _zpsTPzzV;
        "pkg-0.5.0+fabric" = _Zt6RgdfK;
        "pkg-0.5.1+neoforge" = _aELhB0iy;
        "pkg-0.5.1+fabric" = _gUGJsYD3;
        "pkg-0.5.2+neoforge" = _ne12LudO;
        "pkg-0.5.2+fabric" = _LoHU3xSG;
        "pkg-0.5.3+neoforge" = _hqMnFLsr;
        "pkg-0.5.3+fabric" = _ohNxNLDL;
        "pkg-0.6.0+neoforge" = _Yhd01IYw;
        "pkg-0.6.0+fabric" = _BvyVC1Hi;
        "pkg-0.7.0+neoforge" = _CugJhb2X;
        "pkg-0.7.0+fabric" = _7wcYggPK;
        "pkg-0.8.0+neoforge" = _83d8c5a7;
        "pkg-0.8.0+fabric" = _oRYLya6a;
        "pkg-0.9.0+neoforge" = _HPcxb2EL;
        "pkg-0.9.0+fabric" = _FPTdLJaf;
        "pkg-0.10.0+neoforge" = _3OHpdkWO;
        "pkg-0.10.0+fabric" = _yOCgpWSi;
        "pkg-0.10.1+neoforge" = _XXohQmed;
        "pkg-0.10.1+fabric" = _h811vN7V;
        "pkg-0.11.0+neoforge" = _H1BoyZlF;
        "pkg-0.11.0+fabric" = _cwml7Fk4;
        "pkg-1.0.0+neoforge" = _noVIEyp3;
        "pkg-1.0.0+fabric" = _drkR4Yez;
        "pkg-1.1.0+neoforge" = _t4TZw9PL;
        "pkg-1.1.0+fabric" = _oIyFwPvt;
        "pkg-2.0.0+neoforge" = _o2dhTJjF;
        "pkg-2.0.0+fabric" = _zCrwAiZI;
        "pkg-2.0.1+neoforge" = _zwxCHSnK;
        "pkg-2.0.1+fabric" = _EBkMqIfa;
        "pkg-1.1.1+neoforge" = _3jTnClfx;
        "pkg-1.1.1+fabric" = _wakDUcX3;
        "pkg-1.1.2+neoforge" = _IuqiN3hw;
        "pkg-1.1.2+fabric" = _DrJwbJPJ;
        "pkg-2.0.2+neoforge" = _AGljgBPC;
        "pkg-2.0.2+fabric" = _TDXOhbOe;
        "pkg-2.1.0+neoforge" = _O4sVrNmD;
        "pkg-2.1.0+fabric" = _84bucfGE;
        "pkg-1.2.0+fabric" = _99jm5y0d;
        "pkg-1.2.0+neoforge" = _3boV0cPM;
        "pkg-1.2.1+neoforge" = _jCro3k3J;
        "pkg-1.2.1+fabric" = _9cZdk8UB;
        "pkg-2.1.1+neoforge" = _gOey2mhK;
        "pkg-2.1.1+fabric" = _miCLIAww;
        "pkg-3.0.0+neoforge" = _4O9Mdni8;
        "pkg-3.0.0+fabric" = _pLplXsUP;
        "pkg-3.1.0+neoforge" = _uIv3nO9C;
        "pkg-3.1.0+fabric" = _umbgQVeu;
        "pkg-3.2.0+neoforge" = _qjJKV6Yh;
        "pkg-3.2.0+fabric" = _8eqdlxdO;
        "pkg-3.3.0+neoforge" = _hmZlMKgb;
        "pkg-3.3.0+fabric" = _hikoIHyS;
        "pkg-1.3.0+neoforge" = _WKzi4XD8;
        "pkg-1.3.0+fabric" = _36kmNMWY;
        "pkg-2.2.0+neoforge" = _GOyrWdSq;
        "pkg-2.2.0+fabric" = _mSVlmV7V;
        "pkg-3.4.0+neoforge" = _nonYt4mt;
        "pkg-3.4.0+fabric" = _bN7Lt5f9;
        "pkg-1.3.1+neoforge" = _iNoFosNY;
        "pkg-1.3.1+fabric" = _3Mqxvqeg;
        "pkg-3.5.0+neoforge" = _u9mXh4pz;
        "pkg-3.5.0+fabric" = _8pRosSsK;
        "pkg-3.5.1+neoforge" = _fEnk8Cmw;
        "pkg-3.5.1+fabric" = _w7MwscWr;
        "pkg-4.0.0+neoforge" = _LVXItx2J;
        "pkg-4.0.0+fabric" = _hOc7cPpc;
        "pkg-1.3.2+neoforge" = _Z9bPIqNA;
        "pkg-1.3.2+fabric" = _UJ84cijz;
        "pkg-4.0.1+neoforge" = _rBYUVuYI;
        "pkg-4.0.1+fabric" = _gX2XQ6Ue;
        "pkg-5.0.0+neoforge" = _iHhJD0q1;
        "pkg-5.0.0+fabric" = _XlR6lnhB;
        "pkg-5.0.1+neoforge" = _z21arsBh;
        "pkg-5.0.1+fabric" = _wFxl6SjY;
        "pkg-1.3.3+neoforge" = _9nqtSXey;
        "pkg-1.3.3+fabric" = _yEE734CA;
        "pkg-5.1.0+neoforge" = _JwUuRJKr;
        "pkg-5.1.0+fabric" = _2mSBYmrX;
        "pkg-5.2.0+neoforge" = _Sv9rRnoB;
        "pkg-5.2.0+fabric" = _fTk0JAFc;
        "pkg-6.0.0+neoforge" = _bpCsVKVg;
        "pkg-6.0.0+fabric" = _MmINZJ5Z;
        "pkg-6.0.1+neoforge" = _FI00vZku;
        "pkg-6.0.1+fabric" = _J1cEC0Pj;
        "pkg-6.0.2+neoforge" = _mCs3Svhn;
        "pkg-6.0.2+fabric" = _eGCcMOAj;
        "pkg-1.3.4+neoforge" = _ccviRqtd;
        "pkg-1.3.4+fabric" = _aHjJqnkL;
        "pkg-6.0.3+neoforge" = _Q33oJMpE;
        "pkg-6.0.3+fabric" = _ZLibDfNx;
        "pkg-6.0.4+neoforge" = _e4sE4hVt;
        "pkg-6.0.4+fabric" = _PNoOMPor;
        "default" = _PNoOMPor;
    });
