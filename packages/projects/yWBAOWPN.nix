...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _sZj48W9V;
        "pkg-1.0.1+mod" = _FN1VnbZJ;
        "pkg-1.1.0" = _an2ZPK2F;
        "pkg-1.1.0+mod" = _CWMakOrM;
        "pkg-1.1.1" = _TCQYJpRh;
        "pkg-1.1.1+mod" = _tkPjsKmw;
        "pkg-1.2.0" = _U0qEEhpR;
        "pkg-1.2.0+mod" = _MEtHqHgH;
        "pkg-1.2.1" = _d4SVceFI;
        "pkg-1.2.1+mod" = _54IMZOvt;
        "pkg-1.2.2" = _KaCJBBgA;
        "pkg-1.2.2+mod" = _7cdQ4xjg;
        "pkg-1.2.3" = _Q7zJthiT;
        "pkg-1.2.3+mod" = _H9zN8KjM;
        "pkg-1.2.4" = _2nqRs30x;
        "pkg-1.2.4+mod" = _llaeeQaP;
        "pkg-1.2.5" = _go90w9VG;
        "pkg-1.2.5+mod" = _iOoLHjV4;
        "pkg-1.2.6" = _3n6LCCBX;
        "pkg-1.2.6+mod" = _yCwAUIcp;
        "pkg-1.2.7" = _FqX6KQ0e;
        "pkg-1.2.7+mod" = _nQDe04b9;
        "pkg-v1.2.8" = _dFVGqr6A;
        "pkg-v1.2.8+mod" = _D0vo7TJf;
        "pkg-v1.3" = _uRXGDPiq;
