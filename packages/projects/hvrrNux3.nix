...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.4-fabric" = _4Pxf24fF;
        "pkg-1.18.2-1.4-fabric" = _KEBHGJqg;
        "pkg-1.19.2-1.5-fabric" = _JsJWHDG7;
        "pkg-1.16.5-1.0-forge" = _qWrYzIk1;
        "pkg-1.18.2-1.1-forge" = _a8oyIVqZ;
        "pkg-1.19.2-1.3-forge" = _dgvbpmJm;
        "pkg-1.16.5-1.6-fabric" = _X6sCwEwy;
        "pkg-1.18.2-1.6-fabric" = _sCVFN7eT;
        "pkg-1.19.2-1.6-fabric" = _xbmHz66A;
        "pkg-1.16.5-1.6-forge" = _AIC9yb53;
        "pkg-1.18.2-1.6-forge" = _jqtgtYdr;
        "pkg-1.19.2-1.6-forge" = _Yy6nbQc7;
        "pkg-1.16.5-1.7-fabric" = _7arNQCdn;
        "pkg-1.18.2-1.7-fabric" = _BqLtQzDA;
        "pkg-1.19.2-1.7-fabric" = _qkG7L5nf;
        "pkg-1.19.3-1.8-fabric" = _2lX7eJG4;
        "pkg-1.19.3-1.6-forge" = _xhSQgX4B;
        "pkg-1.18.2-2.0-forge+fabric" = _5x12CW7B;
        "pkg-1.19.2-2.0-forge+fabric" = _VG2ChH3l;
        "pkg-1.19.3-2.0-forge+fabric" = _PhgCs6fa;
        "pkg-1.18.2-2.1-forge+fabric" = _I9GXQypR;
        "pkg-1.19.2-2.1-forge+fabric" = _T5slAmSe;
        "pkg-1.19.3-2.1-forge+fabric" = _BxBUJKc5;
        "pkg-1.19.4-2.1-forge+fabric" = _IjgoXTo0;
        "pkg-1.20-2.1-forge+fabric" = _VSd68KsF;
        "pkg-1.20.1-2.1-forge+fabric" = _ORDWhduL;
        "pkg-1.20.2-2.1-forge+fabric" = _TiTRLa6s;
        "pkg-1.18.2-2.2-forge+fabric" = _YR4lJaZs;
        "pkg-1.19.2-2.2-forge+fabric" = _9yoV3yCY;
        "pkg-1.20.1-2.2-forge+fabric" = _QSaGauHL;
        "pkg-1.20.2-2.2-forge+fabric" = _8LDcp5WF;
        "pkg-1.20.3-2.2-fabric+forge+neo" = _m30hADuu;
        "pkg-1.20.4-2.2-fabric+forge+neo" = _uW2KuERj;
        "pkg-1.19.2-2.3-fabric+forge+neo" = _iU00AmRJ;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _TzVdS64T;
        "pkg-1.20.2-2.3-fabric+forge+neo" = _SonJAg2c;
        "pkg-1.20.4-2.3-fabric+forge+neo" = _Nkunay9q;
        "pkg-1.20.5-2.3-fabric+neo" = _5j4yV7JR;
        "pkg-1.20.6-2.3-fabric+forge+neo" = _XMwPPU9N;
        "pkg-1.21.0-2.3-fabric+forge+neo" = _qaSofrf9;
        "pkg-1.20.1-2.4-fabric+forge+neo" = _ugOK1Sx2;
        "pkg-1.20.6-2.4-fabric+forge+neo" = _AvIwCiIh;
        "pkg-1.21.0-2.4-fabric+forge+neo" = _8vzuLxqv;
        "pkg-1.21.1-2.4-fabric+forge+neo" = _6Y2EmQW4;
        "pkg-1.21.2-2.4-fabric+neo" = _sg77s1lJ;
        "pkg-1.21.3-2.4-fabric+forge+neo" = _XXVnFIrx;
        "pkg-1.21.4-2.4-fabric+forge+neo" = _ACRlrSQW;
        "pkg-1.20.1-2.5-fabric+forge+neo" = _ZkZHaSE1;
        "pkg-1.21.1-2.5-fabric+forge+neo" = _rsW5Tg4Q;
        "pkg-1.21.4-2.5-fabric+forge+neo" = _QS06hxVq;
        "pkg-1.21.5-2.5-fabric+forge+neo" = _tIG8XVVB;
        "pkg-1.21.6-2.5-fabric+forge+neo" = _WldFeAx5;
        "pkg-1.21.7-2.5-fabric+forge+neo" = _WmWZHvOv;
        "pkg-1.21.8-2.5-fabric+forge+neo" = _E24u2Ozj;
        "pkg-1.21.9-2.5-fabric+forge+neo" = _E9LHJ3B2;
        "pkg-1.21.10-2.5-fabric+forge+neo" = _FSCM17dO;
        "pkg-1.21.11-2.5-fabric+forge+neo" = _sfVLeE12;
        "pkg-26.1.0-2.5-fabric+forge+neo" = _rt3l3STR;
        "pkg-26.1.1-2.5-fabric+forge+neo" = _GOK56elo;
        "pkg-26.1.2-2.5-fabric+forge+neo" = _zyOngmpA;
        "pkg-26.2.0-2.5-fabric+forge+neo" = _EeFkZhWE;
        "default" = _EeFkZhWE;
    });
