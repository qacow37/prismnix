...
let
    ...
    in {
        ...
        "pkg-1.3.7" = _PlfAUAli;
        "pkg-1.3.8" = _cYqUjC9V;
        "pkg-1.3.3b" = _kUn7JCSf;
        "pkg-1.3.9" = _qZT5Izyd;
        "pkg-1.4.0" = _4Ui7MIgI;
        "pkg-1.4.1" = _69JwitSn;
        "pkg-1.4.2" = _bYe5GBnf;
        "pkg-1.4.3-datapack" = _5f8SYcjJ;
        "pkg-1.4.3" = _NRM5UZpn;
        "pkg-1.4.4-datapack" = _zjmM898r;
        "pkg-1.4.4" = _vH0BWeDm;
        "pkg-1.4.5-datapack" = _RJzZTV8i;
        "pkg-1.4.5" = _31DRiEea;
        "pkg-1.3.7b" = _Qn6mihfc;
        "pkg-1.4.6-datapack" = _5JkMBi9N;
        "pkg-1.4.6" = _evvyMtKE;
        "pkg-1.4.4b-datapack" = _LPzbrvx2;
        "pkg-1.4.4b" = _JosVVZQn;
        "pkg-1.4.7-datapack" = _uAlVm8a1;
        "pkg-1.4.7" = _8HdtnSTx;
        "pkg-1.4.8" = _LUG9G8uH;
        "pkg-1.4.8-datapack" = _DLYnIfCA;
        "pkg-1.4.9" = _JPQQ0jPr;
        "pkg-1.4.9-datapack" = _Ztd2wfuF;
        "pkg-1.3.7c" = _qblrYEEZ;
        "pkg-1.5.0" = _cGc1KFZs;
        "pkg-1.5.0-datapack" = _VD9QVgIl;
        "pkg-1.5.1" = _MkX9384L;
        "pkg-1.5.1-datapack" = _UijivZID;
        "pkg-1.1-datapack" = _OKKIYwrz;
        "pkg-1.1" = _Fy688u5M;
