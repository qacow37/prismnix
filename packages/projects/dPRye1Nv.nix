...
let
    ...
    in {
        ...
        "pkg-v2.2.0-1.20.1-fabric" = _KwZUOO0P;
        "pkg-2.2.0-1.20.1-forge" = _ycUGquLQ;
        "pkg-v2.2.0-1.20.2-fabric" = _4WJ9FPVE;
        "pkg-2.2.0-1.20.2-forge" = _KRZTYXlM;
        "pkg-v2.2.0-1.20.4-fabric" = _URR78VCg;
        "pkg-2.2.0-1.20.4-forge" = _YeDBhGPJ;
        "pkg-v2.2.0-1.20.6-fabric" = _d9wgr0eA;
        "pkg-2.2.0-1.20.6-forge" = _KV3aKwRS;
        "pkg-v2.2.0-1.21-fabric" = _vOvrG4eU;
        "pkg-2.2.0-1.21-forge" = _DQtL5bfo;
        "pkg-v2.2.0-1.21.1-fabric" = _12IouypR;
        "pkg-2.2.0-1.21.1-forge" = _28kyvGwV;
        "pkg-v2.2.0-1.21.2-fabric" = _grqeOSeT;
        "pkg-2.2.0-1.21.3-forge" = _LNDO5CSh;
        "pkg-v2.2.0-1.21.4-fabric" = _PQebZTu3;
        "pkg-2.2.0-1.21.4-forge" = _610wXsju;
        "pkg-v2.2.0-1.21.5-fabric" = _TAqp2GBm;
        "pkg-2.2.0-1.21.5-forge" = _OT1ah1O8;
        "pkg-v2.2.0-1.21.7-fabric" = _zyfzH99p;
        "pkg-2.2.0-1.21.7-forge" = _knAGBfGF;
        "pkg-v2.2.0-1.21.8-fabric" = _ypD0NXw5;
        "pkg-2.2.0-1.21.8-forge" = _mXaytCYk;
        "pkg-v2.2.0-1.21.9-fabric" = _INSETzMj;
        "pkg-2.2.0-1.21.9-forge" = _vVXfehYB;
        "pkg-v2.2.0-1.21.10-fabric" = _QOxWqWUu;
        "pkg-2.2.0-1.21.10-forge" = _KSmLVQzR;
        "pkg-v2.2.0-1.21.11-fabric" = _rEBkmJlV;
        "pkg-2.2.0-1.21.11-forge" = _jCqBTD2O;
        "pkg-v2.2.1-26.1.2-fabric" = _43Xet4PX;
        "pkg-2.2.1-26.1.2-forge" = _6QCs0HfU;
        "default" = _6QCs0HfU;
    });
