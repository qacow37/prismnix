...
let
    ...
    in {
        ...
        "pkg-0.8.2" = _6n69IGEb;
        "pkg-0.9.0" = _f5ZZZZfB;
        "pkg-0.10.0" = _thPCRexE;
        "pkg-0.10.1" = _Ue4Cm2o7;
        "pkg-0.11.0" = _GsXx4txM;
        "pkg-0.12.0" = _Cfeiqt72;
        "pkg-0.12.1" = _ReSxJ49a;
        "pkg-0.12.2" = _4Q4euKMC;
        "pkg-0.12.3" = _IFI2KDE0;
        "pkg-0.12.4" = _PJ4r1zbL;
        "pkg-0.13.0" = _OzBst6o6;
        "pkg-0.13.1" = _ubM9NfE1;
        "pkg-0.14.0" = _OXUSFmnD;
        "pkg-0.14.1" = _yySIN68j;
        "pkg-0.14.2" = _QGEeMZQq;
        "pkg-0.14.3" = _qBjUFoTL;
        "pkg-0.14.4" = _wwKNYzq8;
        "default" = _wwKNYzq8;
    });
