...
let
    ...
    in {
        ...
        "pkg-1.7.0+20w51a" = _8iVwQyoe;
        "pkg-1.7.1+21w03a" = _uGZwG5nQ;
        "pkg-1.8.0+21w08b" = _C4bVKiVX;
        "pkg-1.9.0+21w10a" = _JOFpwk0p;
        "pkg-1.10.0+21w14a" = _sDXHk7EW;
        "pkg-2.0.0+1.16.5-forge" = _20hbi2WP;
        "pkg-2.0.0+21w14a" = _LGSarUA2;
        "pkg-2.1.0+1.16.5-forge" = _EFunm8S6;
        "pkg-2.1.0+21w18a" = _iMdrs7GR;
        "pkg-2.2.0+1.16.5-forge" = _P3OyDMUF;
        "pkg-2.2.0+21w20a" = _qewhz2kB;
        "pkg-2.2.1+1.16.5-forge" = _kAplpXbg;
        "pkg-2.2.1+1.14.4-1.17" = _fL3GTx3o;
        "pkg-2.3.0+1.16.5-forge" = _uixX7uTm;
        "pkg-2.3.0+1.14.4-1.17.1" = _6bneSych;
        "pkg-2.4.0+1.16.5-forge" = _UBywUz0S;
        "pkg-2.4.0+1.14.4-1.17.1" = _oEhNh3HJ;
        "pkg-2.5.0+1.16.5-forge" = _LW2F1INY;
        "pkg-2.5.0+1.17.1-forge" = _8LJ3VID8;
        "pkg-2.5.0+1.14.4-1.18" = _l6pY2bfj;
        "pkg-2.5.1+1.16.5-forge" = _gRlLC81G;
        "pkg-2.5.1+1.17.1-forge" = _5wJwXIMI;
        "pkg-2.5.1+1.14.4-1.18" = _bP3qVJwJ;
        "pkg-2.5.2+1.16.5-forge" = _b1keEVDt;
        "pkg-2.5.2+1.17.1-forge" = _DxngfJuJ;
        "pkg-2.5.2+1.14.4-1.18" = _Ekr2ZDxt;
        "pkg-2.5.3+1.16.5-forge" = _xLdJpnVb;
        "pkg-2.5.3+1.17.1-forge" = _dglzVhIX;
        "pkg-2.5.3+1.14.4-1.18" = _SVt0OGM2;
        "pkg-2.6.0+1.14.4-1.18" = _LnoMm6he;
        "pkg-3.0.0+1.14.4-1.18" = _sI52fskA;
        "pkg-3.0.0+1.16.5-forge" = _3XjGSpws;
        "pkg-3.0.0+1.17.1-forge" = _3cWBK9qw;
        "pkg-3.0.1+1.16.5-forge" = _m0GIYqFo;
        "pkg-3.0.1+1.17.1-forge" = _7ZBhcegV;
        "pkg-3.0.1+1.18-forge" = _zPzdrmfl;
        "pkg-3.1.0+1.14.4-1.18.1" = _8wNiKOgR;
        "pkg-3.1.0+1.16.5-forge" = _FSFtpl3b;
        "pkg-3.1.0+1.17.1-forge" = _KsbWX2iu;
        "pkg-3.1.0+1.18.1-forge" = _SAPndlN1;
        "pkg-3.2.0+1.16.5-forge" = _mXkdO3uD;
        "pkg-3.2.0+1.17.1-forge" = _ESrmPgam;
        "pkg-3.2.0+1.18.1-forge" = _WB2iijy2;
        "pkg-3.2.0+1.18.2-forge" = _NSmkDR7p;
        "pkg-3.2.0+1.14.4-1.19" = _e3FnyyOz;
        "pkg-3.2.1+1.14.4-1.19" = _HhGvqcIp;
        "pkg-3.2.2+1.14.4-1.19" = _HUaaBNb3;
        "pkg-3.3.0+1.16.5-forge" = _VHPFed8p;
        "pkg-3.3.0+1.17.1-forge" = _TIsZQadK;
        "pkg-3.3.0+1.18.1-forge" = _VePYQ4q4;
        "pkg-3.3.0+1.18.2-forge" = _AybsfjaP;
        "pkg-3.3.0+1.14.4-1.19" = _wBi86WOn;
        "pkg-3.3.1+1.16.5-forge" = _97Gt1I1O;
        "pkg-3.3.1+1.17.1-forge" = _hqx2zVGa;
        "pkg-3.3.1+1.18.1-forge" = _VR4OPni5;
        "pkg-3.3.1+1.18.2-forge" = _z9luQsnx;
        "pkg-3.3.1+1.14.4-1.19" = _2VMSSb9P;
        "pkg-3.3.2+1.16.5-forge" = _5mN0z3rt;
        "pkg-3.3.2+1.17.1-forge" = _zYsAv0Rp;
        "pkg-3.3.2+1.18.1-forge" = _krBDWieK;
        "pkg-3.3.2+1.18.2-forge" = _s6llh4eB;
        "pkg-3.3.2+1.14.4-1.19" = _vUoAK8ZT;
        "pkg-3.3.3+1.16.5-forge" = _HhI6rrzI;
        "pkg-3.3.3+1.17.1-forge" = _dE0m9Mpm;
        "pkg-3.3.3+1.18.2-forge" = _LsjNUY9E;
        "pkg-3.3.3+1.19-forge" = _4i8d0BQ7;
        "pkg-3.3.3+1.14.4-1.19.1" = _rCJ3oStN;
        "pkg-3.4.0+1.16.5-forge" = _GyH4xOVe;
        "pkg-3.4.0+1.17.1-forge" = _4EiUhzgy;
        "pkg-3.4.0+1.18.2-forge" = _fIo2oXqt;
        "pkg-3.4.0+1.19-forge" = _WMNaY5zV;
        "pkg-3.4.0+1.19.2-forge" = _ZTkICia9;
        "pkg-3.4.0+1.14.4-1.19.2" = _6J3h8sJb;
        "pkg-3.4.1+1.16.5-forge" = _G7TO2pT2;
        "pkg-3.4.1+1.17.1-forge" = _d8YwH8cV;
        "pkg-3.4.1+1.18.2-forge" = _jhQ2drFe;
        "pkg-3.4.1+1.19-forge" = _GnsvAYez;
        "pkg-3.4.1+1.19.2-forge" = _NPtp5hxN;
        "pkg-3.4.1+1.14.4-1.19.2" = _fsgVBwgV;
        "pkg-3.4.2+1.16.5-forge" = _An8Sq8ta;
        "pkg-3.4.2+1.17.1-forge" = _V9PuotIF;
        "pkg-3.4.2+1.18.2-forge" = _t5Dwtntv;
        "pkg-3.4.2+1.19-forge" = _OBXo0zvd;
        "pkg-3.4.2+1.19.2-forge" = _4w4GKmvP;
        "pkg-3.4.2+1.14.4-1.19.2" = _mQUvJcQi;
        "pkg-3.5.0+1.16.5-forge" = _3lLe9YIl;
        "pkg-3.5.0+1.17.1-forge" = _c18f3v4b;
        "pkg-3.5.0+1.18.2-forge" = _85ppXUz9;
        "pkg-3.5.0+1.19-forge" = _HrGwuVOl;
        "pkg-3.5.0+1.19.2-forge" = _xASmJbpW;
        "pkg-3.5.0+1.14.4-1.19.2" = _bqlYHqmT;
        "pkg-3.6.0+1.16.5-forge" = _jFaljqTH;
        "pkg-3.6.0+1.17.1-forge" = _oodYungl;
        "pkg-3.6.0+1.18.2-forge" = _tfTNNCrg;
        "pkg-3.6.0+1.19-forge" = _fyUUmUnh;
        "pkg-3.6.0+1.19.2-forge" = _MarwFR48;
        "pkg-3.6.0+1.14.4-1.19.3" = _KdbiK6RJ;
        "pkg-3.6.1+1.16.5-forge" = _5F101RsO;
        "pkg-3.6.1+1.17.1-forge" = _awhnjWbk;
        "pkg-3.6.1+1.18.2-forge" = _BFPCTtXw;
        "pkg-3.6.1+1.19.2-forge" = _N960OfvE;
        "pkg-3.6.1+1.19.3-forge" = _O9lYBISl;
        "pkg-3.6.1+1.14.4-1.19.3" = _J8DnNDOS;
        "pkg-3.6.2+1.16.5-forge" = _gqjZp19U;
        "pkg-3.6.2+1.17.1-forge" = _g2bjqfZX;
        "pkg-3.6.2+1.18.2-forge" = _auOoqqjD;
        "pkg-3.6.2+1.19.2-forge" = _XYhYLzTm;
        "pkg-3.6.2+1.19.3-forge" = _NHdDfXOe;
        "pkg-3.6.2+1.14.4-1.19.3" = _IFmJuF78;
        "pkg-3.6.3+1.16.5-forge" = _AA2E43UR;
        "pkg-3.6.3+1.17.1-forge" = _wseZzZ0O;
        "pkg-3.6.3+1.18.2-forge" = _ixUullxL;
        "pkg-3.6.3+1.19.2-forge" = _bpEK2Y8B;
        "pkg-3.6.3+1.19.3-forge" = _NFQLWwbU;
        "pkg-3.6.3+1.14.4-1.19.3" = _rOb9x5fM;
        "pkg-3.7.0+1.16.5-forge" = _1o5iGGCh;
        "pkg-3.7.0+1.17.1-forge" = _Z1elHZ48;
        "pkg-3.7.0+1.18.2-forge" = _sku0rAXL;
        "pkg-3.7.0+1.19.2-forge" = _N2dG5Den;
        "pkg-3.7.0+1.19.3-forge" = _WtaJKPLc;
        "pkg-3.7.0+1.14.4-1.19.3" = _ZlyksjwT;
        "pkg-3.7.1+1.16.5-forge" = _slhQqGHb;
        "pkg-3.7.1+1.17.1-forge" = _ps21grCg;
        "pkg-3.7.1+1.18.2-forge" = _ap29c7Hq;
        "pkg-3.7.1+1.19.2-forge" = _nRO31hZ7;
        "pkg-3.7.1+1.19.3-forge" = _14FEjUKX;
        "pkg-3.7.1+1.19.4-forge" = _qlGEV818;
        "pkg-3.7.1+1.14.4-1.19.4" = _HuSbUkKH;
        "pkg-3.7.2+1.16.5-forge" = _ycZywLc2;
        "pkg-3.7.2+1.17.1-forge" = _O07xXPJP;
        "pkg-3.7.2+1.18.2-forge" = _TIrb7iC5;
        "pkg-3.7.2+1.19.2-forge" = _1DUs2AMQ;
        "pkg-3.7.2+1.19.3-forge" = _jWUVWsfC;
        "pkg-3.7.2+1.19.4-forge" = _BmVR1rnu;
        "pkg-3.7.2+1.14.4-1.19.4" = _79X6I2xj;
        "pkg-3.7.3+1.16.5-forge" = _3v6rQPKd;
        "pkg-3.7.3+1.17.1-forge" = _RPdCM56t;
        "pkg-3.7.3+1.18.2-forge" = _Ok01w4EA;
        "pkg-3.7.3+1.19.2-forge" = _LlYFRp4h;
        "pkg-3.7.3+1.19.3-forge" = _cA16CC37;
        "pkg-3.7.3+1.19.4-forge" = _sl7EtQRn;
        "pkg-3.7.3+1.14.4-1.20" = _T6zz9cnV;
        "pkg-3.7.4+1.16.5-forge" = _RmqK4lbE;
        "pkg-3.7.4+1.17.1-forge" = _KqcPDIoK;
        "pkg-3.7.4+1.18.2-forge" = _T8bcCdtD;
        "pkg-3.7.4+1.19.2-forge" = _VZ99wiTL;
        "pkg-3.7.4+1.19.3-forge" = _pHSvP7Bw;
        "pkg-3.7.4+1.19.4-forge" = _cCMp4GkO;
        "pkg-3.7.4+1.14.4-1.20" = _JFBKABoe;
        "pkg-3.7.5+1.16.5-forge" = _k0zCzZWr;
        "pkg-3.7.5+1.17.1-forge" = _HLKM2roB;
        "pkg-3.7.5+1.18.2-forge" = _Jq7b4lL3;
        "pkg-3.7.5+1.19.2-forge" = _sMaMk1fr;
        "pkg-3.7.5+1.19.3-forge" = _h4YmqkcU;
        "pkg-3.7.5+1.19.4-forge" = _xy2vSEFv;
        "pkg-3.7.5+1.14.4-1.20" = _riJf9xr3;
        "pkg-3.7.6+1.16.5-forge" = _ZiXsm8mU;
        "pkg-3.7.6+1.17.1-forge" = _K6karNxN;
        "pkg-3.7.6+1.18.2-forge" = _8MORTlbd;
        "pkg-3.7.6+1.19.2-forge" = _BtfnTk61;
        "pkg-3.7.6+1.19.3-forge" = _YcTOR0C4;
        "pkg-3.7.6+1.19.4-forge" = _TrrnL0P5;
        "pkg-3.7.6+1.20.1-forge" = _rUlbXz1h;
        "pkg-3.7.6+1.14.4-1.20.1" = _hYzQBiXB;
        "pkg-3.7.7+1.16.5-forge" = _nsh98J9M;
        "pkg-3.7.7+1.17.1-forge" = _XGAc4fdG;
        "pkg-3.7.7+1.18.2-forge" = _S6n8jGiO;
        "pkg-3.7.7+1.19.2-forge" = _YsC6605j;
        "pkg-3.7.7+1.19.3-forge" = _TYANFfos;
        "pkg-3.7.7+1.19.4-forge" = _MHxDX3nd;
        "pkg-3.7.7+1.20.1-forge" = _uTXXBeVj;
        "pkg-3.7.7+1.14.4-1.20.1" = _upq7HCkV;
        "pkg-3.7.8+1.16.5-forge" = _5yyDnQzj;
        "pkg-3.7.8+1.17.1-forge" = _aiAmAWjE;
        "pkg-3.7.8+1.18.2-forge" = _34Zka5Wk;
        "pkg-3.7.8+1.19.2-forge" = _ElQ6t56c;
        "pkg-3.7.8+1.19.3-forge" = _rwo6Gdl6;
        "pkg-3.7.8+1.19.4-forge" = _Pxg0KblB;
        "pkg-3.7.8+1.20.1-forge" = _jERMr4ha;
        "pkg-3.7.8+1.14.4-1.20.1" = _ooQsxSVg;
        "pkg-3.7.9+1.16.5-forge" = _ww97SXdc;
        "pkg-3.7.9+1.17.1-forge" = _jHJKizEb;
        "pkg-3.7.9+1.18.2-forge" = _h8RIYvDU;
        "pkg-3.7.9+1.19.2-forge" = _Gow8CV2Y;
        "pkg-3.7.9+1.19.4-forge" = _YIvErKZO;
        "pkg-3.7.9+1.20.1-forge" = _iFa0Xbhn;
        "pkg-3.7.9+1.14.4-1.20.2" = _NXT21hP9;
        "pkg-3.7.10+1.17.1-forge" = _WpdMROMn;
        "pkg-3.7.10+1.18.2-forge" = _BQ3axApK;
        "pkg-3.7.10+1.19.2-forge" = _grAxoHg3;
        "pkg-3.7.10+1.19.4-forge" = _ibnHzhdA;
        "pkg-3.7.10+1.20.1-forge" = _nevkDPPl;
        "pkg-3.7.11+1.17.1-forge" = _SU8qVXsl;
        "pkg-3.7.11+1.18.2-forge" = _OJw7ES2q;
        "pkg-3.7.11+1.19.2-forge" = _ANbTpOlT;
        "pkg-3.7.11+1.19.4-forge" = _6W8BENkb;
        "pkg-3.7.11+1.20.1-forge" = _ysBfIbZ4;
        "pkg-3.7.11+1.14.4-1.20.2" = _EKhpC3mG;
        "pkg-3.7.12+1.20.1-forge" = _trgbZnd0;
        "pkg-3.7.12+1.20.2-neoforge" = _Ho0klGEY;
        "pkg-3.7.12+1.20.4-neoforge" = _gW0NRaWB;
        "pkg-3.7.12+1.14.4-1.20.4" = _CEwGflAU;
        "pkg-3.8.0+1.16.5-forge" = _OSy4tTWV;
        "pkg-3.8.0+1.17.1-forge" = _hfv8Ahlb;
        "pkg-3.8.0+1.18.2-forge" = _que73KU8;
        "pkg-3.8.0+1.19.2-forge" = _yV53lABS;
        "pkg-3.8.0+1.19.4-forge" = _CyiYSQre;
        "pkg-3.8.0+1.20.1-forge" = _vtnrxIhq;
        "pkg-3.8.0+1.20.2-neoforge" = _cvOaFr8t;
        "pkg-3.8.0+1.20.4-neoforge" = _TYdeDZh6;
        "pkg-3.8.0+1.14.4-1.20.4" = _czRgm3k6;
        "pkg-3.8.1+1.14.4-1.20.6" = _zrzf8aXg;
        "pkg-3.8.2+1.16.5-forge" = _aIxWya4e;
        "pkg-3.8.2+1.17.1-forge" = _DVRRZjN0;
        "pkg-3.8.2+1.18.2-forge" = _Xy2SOsNg;
        "pkg-3.8.2+1.19.2-forge" = _pJSHElpS;
        "pkg-3.8.2+1.19.4-forge" = _eYCa9MGH;
        "pkg-3.8.2+1.20.1-forge" = _SQpqSgAE;
        "pkg-3.8.2+1.20.2-neoforge" = _2ZWVY0Zn;
        "pkg-3.8.2+1.20.4-neoforge" = _efhy7FQg;
        "pkg-3.8.2+1.20.6-neoforge" = _Aq9lznCX;
        "pkg-3.8.2+1.14.4-1.20.6" = _smQAtVRG;
        "pkg-3.8.3+1.20.6-neoforge" = _vKeyKfkC;
        "pkg-3.8.3+1.14.4-1.21" = _6fzxx6SC;
        "pkg-3.8.3+1.21-neoforge" = _nKHizsl6;
        "default" = _nKHizsl6;
    });
