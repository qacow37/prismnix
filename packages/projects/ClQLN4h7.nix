...
let
    ...
    in {
        ...
        "pkg-1.16.4-0.1.0-fabric" = _EN8ApwY4;
        "pkg-1.16.5-0.1.0-fabric" = _1SJvqDIV;
        "pkg-1.16.5-0.2.0-fabric" = _5wzgqurh;
        "pkg-1.16.5-0.3.0-fabric" = _L8pWiAAf;
        "pkg-1.16.5-0.4.0-fabric" = _F5c5kJng;
        "pkg-1.16.5-0.4.1-fabric" = _242e7aNv;
        "pkg-1.16.5-0.5.0-fabric" = _f1ulfpol;
        "pkg-1.16.5-0.6.0-fabric" = _7XUU3FJr;
        "pkg-1.16.5-0.7.0-fabric" = _70Zk15Sp;
        "pkg-1.16.5-0.7.1-fabric" = _PTIad6Zc;
        "pkg-1.17-0.1.0-fabric" = _KJ7Qwzt4;
        "pkg-1.17-0.2.0-fabric" = _1ASy8OB3;
        "pkg-1.16.5-0.8.0-fabric" = _LDAzJijs;
        "pkg-1.16.5-0.9.0-fabric" = _P8pPsPp4;
        "pkg-1.17-0.2.1-fabric" = _GEx1jjYE;
        "pkg-1.17-0.2.2-fabric" = _zSsSW6gJ;
        "pkg-1.16.5-0.9.1-fabric" = _lbO0SloI;
        "pkg-1.16.5-0.10.0-fabric" = _KALUVcGb;
        "pkg-1.17-0.3.0-fabric" = _E6aKm537;
        "pkg-1.16.5-0.11.0-fabric" = _Ts99GAU4;
        "pkg-1.17.1-0.4.0-fabric" = _UxEou3Bq;
        "pkg-1.16.5-1.11.1-fabric" = _rIAqpDPl;
        "pkg-21w44a-0.1.0" = _jd8Jss5Y;
        "pkg-1.18-0.1.0-fabric" = _oZCseWLk;
        "pkg-1.16.5-0.12.0-fabric" = _vTebyBIb;
        "pkg-1.17.1-0.5.0-fabric" = _3o4P9IeQ;
        "pkg-1.18.1-0.2.0-fabric" = _iD1pE5kk;
        "pkg-1.16.5-0.12.1-fabric" = _LJQT6TQy;
        "pkg-1.17.1-0.5.1-fabric" = _x0uBn1Hu;
        "pkg-1.18.1-0.2.1-fabric" = _6MSqnzaH;
        "pkg-1.16.5-0.13.0-fabric" = _aVeD4doP;
        "pkg-1.17.1-0.6.0-fabric" = _GXHfM6vd;
        "pkg-1.18.1-0.3.0-fabric" = _pgnFg6W8;
        "pkg-1.18.2-0.4.0-fabric" = _ut9lTlaG;
        "pkg-1.16.5-0.14.0-fabric" = _nCuQUArz;
        "pkg-1.17.1-0.7.0-fabric" = _aAI5JpZr;
        "pkg-1.18.2-0.5.0-fabric" = _77B0wwBY;
        "pkg-1.19-0.1.0-fabric" = _vdOeM3uZ;
        "pkg-1.19.3-0.1.1-fabric" = _hmgfZURB;
        "pkg-1.19.4-0.1.2-fabric" = _UbrObw8I;
        "pkg-1.20-0.1.0-fabric" = _ZKU01iX8;
        "pkg-1.16.5-0.15.0-fabric" = _Y0a3DxZj;
        "pkg-1.17.1-0.8.0-fabric" = _xjO1XZWm;
        "pkg-1.18.2-0.6.0-fabric" = _viFmEYnK;
        "pkg-1.19.4-0.2.0-fabric" = _zvsa5NhN;
        "pkg-1.20.1-0.2.0-fabric" = _DUmIeSlo;
        "pkg-1.12.2-0.0.1-forge" = _OC2jMKJd;
        "pkg-1.12.2-0.1.0-forge" = _g4Yie3y0;
        "pkg-1.12.2-0.2.0-forge" = _dFiCDWKv;
        "pkg-1.12.2-0.3.0-forge" = _xE4ebruP;
        "pkg-1.12.2-0.4.0-forge" = _xplU0z2Z;
        "pkg-1.15.2-0.1.0-forge" = _AKLZvhKu;
        "pkg-1.15.2-0.2.0-forge" = _IZFIgOwR;
        "pkg-1.15.2-0.3.0-forge" = _zWexgC7Z;
        "pkg-1.15.2-0.4.0-forge" = _D2SWOMBR;
        "pkg-1.16.5-0.1.0-forge" = _NHQyc3AS;
        "pkg-1.16.5-0.2.0-forge" = _4CC1DMKQ;
        "pkg-1.16.5-0.3.0-forge" = _FaJsWjkV;
        "pkg-1.16.5-0.4.0-forge" = _hnfcubAh;
        "pkg-1.16.5-0.5.0-forge" = _A7GdKXit;
        "pkg-1.16.5-0.6.0-forge" = _alFEoCHj;
        "pkg-1.16.5-0.6.1-forge" = _WdTApDrC;
        "pkg-1.16.5-0.7.0-forge" = _rWV1varO;
        "pkg-1.16.5-0.8.0-forge" = _H51mVHvD;
        "pkg-1.16.5-0.9.0-forge" = _SDpHUaWo;
        "pkg-1.17.1-0.1.0-forge" = _C5uvypZE;
        "pkg-1.18.2-0.1.0-forge" = _qsAVWoh5;
        "pkg-1.19.4-0.1.0-forge" = _xVhbZ4oK;
        "pkg-1.20.1-0.1.0-forge" = _gni0MZTY;
        "pkg-1.16.5-0.9.1" = _GGfl5EB6;
        "pkg-1.17.1-0.1.1" = _6GsrqUdJ;
        "pkg-1.18.2-0.1.1" = _Raoqo3dg;
        "pkg-1.19.4-0.1.1" = _vu40IvUt;
        "pkg-1.20.1-0.1.1" = _9xoik08l;
        "pkg-1.16.5-0.15.1" = _xC2UNhjq;
        "pkg-1.17.1-0.8.1" = _2iKkeBdi;
        "pkg-1.18.2-0.6.1" = _FW3wEjH0;
        "pkg-1.19.4-0.2.1" = _uZ73TBs4;
        "pkg-1.20.1-0.2.1" = _Mz0y30zQ;
        "pkg-1.16.5-0.9.2" = _jlCBuUrP;
        "pkg-1.17.1-0.1.2" = _zElZMAoM;
        "pkg-1.18.2-0.1.2" = _XmiCbSe5;
        "pkg-1.19.4-0.1.2" = _j72hFgMt;
        "pkg-1.20.1-0.1.2" = _rNU7kjvi;
        "pkg-1.12.2-0.5.0" = _BSTMOM7c;
        "pkg-1.15.2-0.5.0" = _DIiGy28a;
        "pkg-1.16.5-0.10.0" = _KJNRVPXH;
        "pkg-1.17.1-0.2.0" = _9inKRydz;
        "pkg-1.18.2-0.2.0" = _3j9QsvOr;
        "pkg-1.19.4-0.2.0" = _j0znhThR;
        "pkg-1.20.1-0.2.0" = _YDwuYikp;
        "pkg-1.16.5-0.16.0" = _urz6MyfN;
        "pkg-1.17.1-0.9.0" = _6ypJXVI5;
        "pkg-1.18.2-0.7.0" = _bQcVC7bq;
        "pkg-1.19.4-0.3.0" = _PxGgidFi;
        "pkg-1.20.1-0.3.0" = _g8J0t5Kd;
        "pkg-1.12.2-0.5.1" = _bKOIDyf7;
        "pkg-1.15.2-0.5.1" = _93BdNPFJ;
        "pkg-1.16.5-0.10.1" = _fjEiTWg9;
        "pkg-1.17.1-0.2.1" = _UfGDfWNG;
        "pkg-1.18.2-0.2.1" = _ibkjq1om;
        "pkg-1.16.5-0.16.1" = _1OOXpd4W;
        "pkg-1.17.1-0.9.1" = _99dKKhin;
        "pkg-1.18.2-0.7.1" = _qqjp20xH;
        "pkg-1.19.4-0.3.1" = _WrRcOLyH;
        "pkg-1.20.1-0.3.1" = _pMxcrZlt;
        "pkg-1.20.6-0.3.2" = _LIuMRflp;
        "pkg-1.20.6-0.3.3" = _MEbP7mEW;
        "pkg-1.12.2-0.5.2" = _yOkaGKGQ;
        "default" = _yOkaGKGQ;
    });
