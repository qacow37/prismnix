...
let
    ...
    in {
        ...
        "pkg-1.6.4" = _ObE3haFE;
        "pkg-1.7.3" = _t4YZ6dhe;
        "pkg-2.11.12" = _MqtVLa6V;
        "pkg-2.12.1" = _ngaws0kQ;
        "pkg-2.22.0" = _cgTZBYTg;
        "pkg-2.22.1" = _uDm3bBlG;
        "pkg-2.22.2" = _gZj46nIN;
        "pkg-2.23.0" = _FUK6vKfK;
        "pkg-2.23.1" = _VSdCACa5;
        "pkg-2.24.0" = _SdnabmBl;
        "pkg-2.24.1" = _rFz2LSbo;
        "pkg-2.25.0" = _WxrW0zJe;
        "pkg-2.26.0" = _T3TjYf89;
        "pkg-2.26.1" = _soA9iwZp;
        "pkg-2.26.2" = _b8iBgELK;
        "pkg-2.26.3" = _CymGzaeJ;
        "pkg-2.26.4" = _XIjpjgvn;
        "pkg-2.26.5" = _9pdtGQb7;
        "pkg-2.27.0" = _Iiq8ih8M;
        "pkg-2.28.0" = _Q1QCLnpI;
        "pkg-2.29.0" = _mkqkIwez;
        "pkg-2.30.0" = _zLW2an19;
        "pkg-2.30.1" = _yUuDfmnk;
        "default" = _yUuDfmnk;
    });
