...
let
    ...
    in {
        ...
        "pkg-29" = _BG4BNBVM;
        "pkg-30" = _egCyElYs;
        "pkg-215.2.a" = _kVoHYZqG;
        "pkg-215.2.b" = _TDOkGI8F;
        "pkg-215.3.a" = _I5pJEWQ6;
        "pkg-215.3.b" = _ZEge2AFr;
        "pkg-215.4.a" = _VCtTQryq;
        "pkg-215.4.b" = _VTK6gyrd;
        "pkg-215.5.a" = _JnA6Sebs;
        "pkg-215.5.b" = _8FRbcTOu;
        "pkg-1216.1.A" = _OrqM48VV;
        "pkg-1216.1.B" = _l5bBuCZg;
        "pkg-1218.1.A" = _rdKO73mF;
        "pkg-1218.1.B" = _aY6m3TZx;
        "pkg-1218.4.A" = _DYxBxp3w;
        "pkg-1218.4.B" = _60wut6Ji;
        "pkg-12110_1192_v1" = _9Uxj2014;
        "pkg-12110_1194_v1" = _JkEgs5ub;
        "pkg-12110_1201_v1" = _dO1EYIwE;
        "pkg-12110_1202_v1" = _itNWZ8op;
        "pkg-12110_1201_v3" = _ee7f56hx;
        "pkg-12110_1202+_v3" = _YSuQQv4R;
        "default" = _YSuQQv4R;
    });
