...
let
    ...
    in {
        ...
        "pkg-v1.0.2-Forge-1.16.5" = _V9SQOmr0;
        "pkg-v1.0.2-Forge-1.18.2" = _mXHfSp77;
        "pkg-v1.0.2-Forge-1.19.2" = _Lyt3DoBR;
        "pkg-v1.0.2-Forge-1.20.1" = _yL6SQgxX;
        "pkg-v1.0.2-Fabric-1.20.1" = _KCTfivqI;
        "pkg-v1.0.2-NeoForge-1.20.4" = _7INoi4nX;
        "pkg-v1.0.2-Fabric-1.21.1" = _KqVQVXMA;
        "pkg-v1.0.2-NeoForge-1.21.1" = _uXctel4M;
        "pkg-v1.0.2-Fabric-1.21.4" = _pooKYLEq;
        "pkg-v1.0.2-NeoForge-1.21.4" = _oAjpPOCs;
        "pkg-v1.0.2-NeoForge-1.21.6" = _3uBnPeRN;
        "pkg-v1.0.3-NeoForge-1.21.11" = _khL0UPaY;
        "pkg-v1.0.3-Fabric-26.1.x" = _bbCpKT1M;
        "pkg-v1.0.3-NeoForge-26.1.x" = _22QtBpXN;
        "pkg-v1.1.0-Forge-1.20.1" = _JxPVXi7d;
        "pkg-v1.1.0-NeoForge-1.21.1" = _cTL4BNWE;
        "pkg-v1.1.0-Fabric-26.1.x" = _K4K1F00b;
        "pkg-v1.1.0-NeoForge-26.1.x" = _xW8I8892;
        "pkg-v1.1.0-Fabric-1.20.1" = _aeNcHZ0x;
        "pkg-v1.1.0-Fabric-1.21.1" = _xH7xXFWZ;
        "pkg-v1.1.0-NeoForge-1.21.11" = _lGTJ1aSb;
        "pkg-v1.1.2-Fabric-1.20.1" = _1i3noE4m;
        "pkg-v1.1.2-Forge-1.20.1" = _AvISChOF;
        "pkg-v1.1.2-Fabric-1.21.1" = _RIkPB7u5;
        "pkg-v1.1.2-NeoForge-1.21.1" = _6TRwWVqd;
        "pkg-v1.1.2-Fabric-26.1.x" = _W0VvGcFQ;
        "pkg-v1.1.2-NeoForge-26.1.x" = _BEPwoP9H;
        "default" = _BEPwoP9H;
    });
