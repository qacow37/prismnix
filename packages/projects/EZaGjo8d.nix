...
let
    ...
    in {
        ...
        "pkg-0.1.1.250205+mc1.21.1" = _7PtHWTAT;
        "pkg-0.1.1.250207+mc1.21.4" = _7OtvFphB;
        "pkg-0.1.1.250209+mc1.21.1" = _SKJ4AdkJ;
        "pkg-0.1.1.250209+mc1.21.4" = _fVPYbkcc;
        "pkg-0.1.2+mc1.21.4" = _geV590rr;
        "pkg-0.1.3+mc1.21.1" = _R0zKoyft;
        "pkg-0.1.3+mc1.21.4" = _7n4rdKGa;
        "pkg-0.1.4+mc1.21.4" = _9er2iGvD;
        "pkg-0.1.4+mc1.21.1" = _J8LOXWvw;
        "pkg-0.1.5+mc1.21.3" = _DhmUmdH3;
        "pkg-0.1.5+mc1.21.1" = _GrbUo9f1;
        "pkg-0.1.5+mc1.21.4" = _Zr6YTKQ4;
        "pkg-0.1.5-hotfix1+mc1.21.1" = _5FmJ3LpG;
        "pkg-0.1.6+mc1.21.1" = _pB2OQW1d;
        "pkg-0.1.0+mc1.21.5" = _zQCMohwi;
        "pkg-0.2.0+mc1.21.4" = _pNcP3Pab;
        "pkg-0.2.0+mc1.21.5" = _uy7HaFPw;
        "pkg-0.2.0+mc1.21.3" = _lcEn9Cyb;
        "pkg-0.2.0+mc1.21.1" = _AaFkDNm0;
        "pkg-0.2.1+mc1.21.4" = _cT5W4Ico;
        "pkg-0.2.1+mc1.21.3" = _zIi2KaVg;
        "pkg-0.2.1+mc1.21.1" = _HbBAModY;
        "pkg-0.2.1+mc1.21.5" = _ZKza84dP;
        "pkg-0.2.2+mc1.21.4" = _k3mznuZw;
        "pkg-0.2.4+mc1.21.7" = _3fg8k7CH;
        "pkg-0.2.5+mc1.21.7" = _iqV2El8n;
        "default" = _iqV2El8n;
    });
