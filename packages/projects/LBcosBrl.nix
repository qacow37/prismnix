...
let
    ...
    in {
        ...
        "pkg-2.77.1" = _ERwTSaLQ;
        "pkg-V2.77.2" = _wGg5Sgne;
        "pkg-2.78" = _JYZFKqTg;
        "pkg-V2.79" = _ZcjmNgfJ;
        "pkg-2.80" = _kLeFHu9r;
        "pkg-2.81" = _rwtR7rL7;
        "pkg-2.83" = _6YlBzEjx;
        "pkg-2.82.1" = _7MhkQ1Hw;
        "pkg-V2.83" = _zxUQb3VI;
        "pkg-V2.83.1" = _ta77wSvx;
        "pkg-2.84" = _7O8d3ztr;
        "pkg-2.85" = _j4efMkN1;
        "pkg-2.86" = _sB8XpO4p;
        "pkg-2.86.1" = _Ij4A0ekb;
        "pkg-2.87" = _YCHvUA9j;
        "pkg-2,88" = _ynFpcE7B;
        "pkg-2.88.1" = _g19NPTGc;
        "pkg-2.89" = _LjVmjsnP;
        "pkg-2.90" = _hdIsqS0A;
        "pkg-2.91.2" = _eUy15igI;
        "pkg-2.93" = _7F4Iz9ic;
        "pkg-V2.94" = _iXiwBJWe;
        "pkg-V2.94.1" = _OoZ3v2Lc;
        "pkg-2.96" = _bUTi8hUE;
        "pkg-2.98" = _2Yk85eRT;
        "pkg-2.99" = _ZeWSCy9a;
        "pkg-3.0" = _CPLrzTQx;
