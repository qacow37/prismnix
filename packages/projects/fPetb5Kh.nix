...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.9.1-forge" = _o0SCfsMe;
        "pkg-1.17.1-2.0.1-fabric" = _EiqUWpG9;
        "pkg-1.17.1-1.9.2-forge" = _IevyW0iW;
        "pkg-1.18.2-2.0.3-fabric" = _fUU599ai;
        "pkg-1.18.2-1.9.7-forge" = _h9RH2quJ;
        "pkg-1.19.2-2.1.0-fabric" = _mtJLgFgQ;
        "pkg-1.19.2-1.10.0-forge" = _N4ONofeB;
        "pkg-1.19.4-2.2.0-fabric" = _4uJ33W15;
        "pkg-1.19.4-1.11.0-forge" = _lVeHfUiZ;
        "pkg-1.20.1-2.2.3-fabric" = _NovIXDxY;
        "pkg-1.20.1-1.11.2-forge" = _Og40jCNX;
        "pkg-1.20.2-2.2.3-fabric" = _IQefNHid;
        "pkg-1.20.2-1.11.2-forge" = _T9QM7yrP;
        "pkg-1.20.2-1.11.3-forge" = _BtFlcETU;
        "pkg-1.20.3-2.2.3-fabric" = _rEEmi8E5;
        "pkg-1.20.3-1.11.3-forge" = _xyis9gOg;
        "pkg-1.20.4-2.2.3-fabric" = _1auwKKIf;
        "pkg-1.20.4-1.11.3-forge" = _iaAgAAIT;
        "pkg-1.20.2-1.11.5-forge" = _AXaVQKzH;
        "pkg-1.20.4-1.11.5-forge" = _BkllKDjG;
        "pkg-1.20.2-3.0.0-neoforge" = _IznZXHBu;
        "pkg-1.20.4-3.0.0-neoforge" = _GfYWHTxk;
        "pkg-1.20.5-3.0.1-neoforge" = _i96v7o3k;
        "pkg-1.20.6-3.0.1-neoforge" = _1OwCLPtS;
        "pkg-1.20.5-2.2.4-fabric" = _UtIbyrWH;
        "pkg-1.20.6-2.2.4-fabric" = _TtWM9SPX;
        "pkg-1.20.6-1.11.5-forge" = _H29kZ8Rq;
        "pkg-1.20.6-3.0.2-neoforge" = _jte5ZZmb;
        "pkg-1.20.6-2.2.5-fabric" = _QVKr4BEc;
        "pkg-1.20.6-1.11.6-forge" = _YLBedBAk;
        "pkg-1.21-3.0.2-neoforge" = _GYmZGD7e;
        "pkg-1.21-2.2.5-fabric" = _g7OAoksp;
        "pkg-1.21-1.11.6-forge" = _hwcVd7cN;
        "pkg-1.21-3.0.3-neoforge" = _B8cOeTJ3;
        "pkg-1.21-2.2.6-fabric" = _tBmAcdOX;
        "pkg-1.21-1.11.7-forge" = _OJXBDVY2;
        "pkg-1.21.3-1.11.8-forge" = _pjB92Owi;
        "pkg-1.21.3-2.2.8-fabric" = _K3BhUrB4;
        "pkg-1.21.3-3.0.4-neoforge" = _oJbgGdZe;
        "pkg-1.21.1-1.11.7-forge" = _dAktoHul;
        "pkg-1.21.1-2.2.7-fabric" = _9W2MUsnU;
        "pkg-1.21.1-3.0.3-neoforge" = _AqEmYPpi;
        "pkg-1.21.4-1.11.8-forge" = _jyCnsmp5;
        "pkg-1.21.4-2.2.8-fabric" = _fF380mCq;
        "pkg-1.21.4-3.0.4-neoforge" = _J03HgGZ8;
        "pkg-1.21.5-1.11.8-forge" = _gM9Ds7fk;
        "pkg-1.21.5-2.2.8-fabric" = _FtXoG4cB;
        "pkg-1.21.5-3.0.4-neoforge" = _GdntNEt3;
        "pkg-1.21.6-2.2.9-fabric" = _gd78727T;
        "pkg-1.21.7-2.2.9-fabric" = _ZiFxUhCU;
        "pkg-1.21.6-3.0.5-neoforge" = _hNggNVxA;
        "pkg-1.21.7-3.0.5-neoforge" = _vq4qXHML;
        "pkg-1.21.8-2.2.9-fabric" = _8YXpOUsV;
        "pkg-1.21.8-3.0.5-neoforge" = _H6rdfYL3;
        "pkg-1.21.10-2.2.9-fabric" = _xGCEylgP;
        "pkg-1.21.10-3.0.5-neoforge" = _bvGXT2Ns;
        "pkg-1.21.11-2.2.9-fabric" = _qbScvfRR;
        "pkg-1.21.11-3.0.5-neoforge" = _wxggb362;
        "pkg-1.21.11-2.4.0-fabric" = _CjsPEp1i;
        "pkg-1.21.11-3.2.0-neoforge" = _NJnJeC3j;
        "pkg-1.21.11-2.5.0-fabric" = _7w8oJxSS;
        "pkg-1.21.11-3.3.0-neoforge" = _IXnn4ORf;
        "pkg-26.1-2.5.0-fabric" = _8HDRpWxW;
        "pkg-26.1-3.3.0-neoforge" = _FKGBa8Rq;
        "pkg-1.20.1-1.12.0-forge" = _eRSDvCjN;
        "pkg-1.20.1-2.6.0-fabric" = _3dox9JXF;
        "pkg-1.21.1-2.6.0-fabric" = _dtrDpgsF;
        "pkg-1.21.1-3.4.0-neoforge" = _nFniEtJV;
