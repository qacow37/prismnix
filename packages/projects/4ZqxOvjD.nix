...
let
    ...
    in {
        ...
        "pkg-0.6.0a" = _52gcrxOy;
        "pkg-0.5.2a" = _suKMGRbi;
        "pkg-0.2.7" = _V7JZgyIU;
        "pkg-0.5.3" = _TnN4CV2Q;
        "pkg-0.2.8" = _c4RHSmo9;
        "pkg-0.2.9" = _WTmxKPaw;
        "pkg-0.5.3a" = _ibGbqBbP;
        "pkg-0.6.1" = _w6asrex4;
        "pkg-0.2.10" = _JEoSJNGo;
        "pkg-0.5.4" = _v1Byy3O4;
        "pkg-0.6.2" = _qSw3a67v;
        "pkg-0.6.3" = _ySmWhbfP;
        "pkg-0.2.11" = _QrS8ZpUH;
        "pkg-0.6.4" = _lCbMhmSa;
        "pkg-0.6.2a" = _Hlexif59;
        "pkg-0.5.5" = _uqcWRM8W;
        "pkg-0.5.6" = _9DCa1IzX;
        "pkg-0.6.2b" = _6YKudvQ5;
        "pkg-0.2.12" = _vkRZleVy;
        "pkg-0.6.5" = _iLEHOlRR;
        "pkg-0.7.0" = _17IcFh9q;
        "pkg-0.7.0a" = _KoZMxzwB;
        "pkg-0.2.13" = _YDAuLUY8;
        "pkg-0.6.2c" = _bmmEZ4mh;
        "pkg-0.7.1" = _VKligEsm;
        "default" = _VKligEsm;
    });
