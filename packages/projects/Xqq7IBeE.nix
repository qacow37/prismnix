...
let
    ...
    in {
        ...
        "pkg-1.0" = _OyP4jUUG;
        "pkg-1.0_mod" = _W9qn5Dpa;
        "pkg-1.1" = _12bJ8I5H;
        "pkg-1.2" = _Nju5oOFv;
        "pkg-1.2+mod" = _qxMOZN9m;
        "pkg-1.3" = _93WI6AE2;
        "pkg-1.3+mod" = _E7r75rN0;
        "pkg-1.4" = _npFTrofY;
        "pkg-1.4+mod" = _FiIHlXHY;
        "pkg-2.0" = _kCOfrYTU;
        "pkg-2.0+mod" = _p9bTRyrn;
        "pkg-2.1" = _Br8y1hzu;
        "pkg-3.0" = _X4mjkDRU;
        "pkg-3.0+mod" = _naflFFG3;
        "pkg-3.1" = _EJgYjxvq;
        "pkg-3.1+mod" = _kzZFylMW;
        "pkg-3.2" = _mE03Vti3;
        "pkg-3.2+mod" = _OR525xj2;
        "pkg-3.3" = _3sKciIMw;
        "pkg-3.3+mod" = _VdaU7JaT;
        "pkg-3.4" = _XleowT9U;
        "pkg-3.4+mod" = _sYRhYN2Z;
        "pkg-3.5" = _Pdd0AEO2;
        "pkg-3.5+mod" = _iIuv1dGX;
        "pkg-3.6" = _Hzugp7aU;
        "pkg-3.6+mod" = _iCzeLGI3;
        "pkg-3.7" = _Jr7Ig3wr;
        "pkg-3.7-fabric" = _avbzzz25;
        "pkg-3.7-forge" = _avA8Y2pn;
        "pkg-3.11" = _593jryhd;
        "pkg-3.11-fabric" = _gKPKdbrB;
        "pkg-3.11-quilt" = _yOJlISHt;
        "pkg-3.11-forge" = _CRayu2Uk;
        "pkg-3.11-neoforge" = _KWO8Qy1p;
        "pkg-3.12" = _mbv2YMaH;
        "pkg-3.12-fabric" = _iyYlzwl5;
        "pkg-3.12-quilt" = _iuU1OUK0;
        "pkg-3.12-forge" = _C3CIwhE8;
        "pkg-3.12-neoforge" = _4r9lPEbR;
        "default" = _4r9lPEbR;
    });
