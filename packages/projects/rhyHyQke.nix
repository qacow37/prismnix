...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _xoZIJa50;
        "pkg-1.4.0" = _oXC16tQc;
        "pkg-1.4.1-forge" = _ndkyevf8;
        "pkg-1.4.1-fabric" = _zYQ4oPKD;
        "pkg-1.3.1" = _cCyrCcNp;
        "pkg-2.0.0-forge-1.20.1" = _Q4TFsdxO;
        "pkg-2.0.0-fabric-1.20.1" = _CuZ7a51K;
        "pkg-2.1.0-forge-1.18.2" = _O04TJfWl;
        "pkg-2.1.0-fabric-1.18.2" = _JzwgLXai;
        "pkg-2.1.0-forge-1.19.2" = _zcti5sHR;
        "pkg-2.1.0-fabric-1.19.2" = _USbiWVje;
        "pkg-2.1.0-forge-1.19.4" = _QIdjZZzQ;
        "pkg-2.1.0-fabric-1.19.4" = _V4HqlszC;
        "pkg-2.1.0-forge-1.20.1" = _1ijh7gB6;
        "pkg-2.1.0-fabric-1.20.1" = _rRB0PCfk;
        "pkg-2.1.0-forge-1.20.2" = _MWGaz5FA;
        "pkg-2.1.0-fabric-1.20.2" = _9q9n9fyG;
        "pkg-2.1.1-forge-1.18.2" = _4twhTGGl;
        "pkg-2.1.1-fabric-1.18.2" = _jSl53Yfa;
        "pkg-2.1.1-forge-1.19.2" = _R6jGTZZ2;
        "pkg-2.1.1-fabric-1.19.2" = _sEkL5jA7;
        "pkg-2.1.1-forge-1.19.4" = _vRWaZqCT;
        "pkg-2.1.1-fabric-1.19.4" = _cmoSzjgT;
        "pkg-2.1.1-forge-1.20.1" = _9VpE2l5L;
        "pkg-2.1.1-fabric-1.20.1" = _WkzIt9ET;
        "pkg-2.1.1-forge-1.20.2" = _VnyxQbk6;
        "pkg-2.1.1-fabric-1.20.2" = _a4vWApsb;
        "pkg-2.2.0-forge-1.18.2" = _l52lngTH;
        "pkg-2.2.0-fabric-1.18.2" = _oExBP7J1;
        "pkg-2.2.0-forge-1.19.2" = _fvDavl0p;
        "pkg-2.2.0-fabric-1.19.2" = _uXNJPryg;
        "pkg-2.2.0-forge-1.19.4" = _Plxh4rsK;
        "pkg-2.2.0-fabric-1.19.4" = _G8VMROGV;
        "pkg-2.2.0-forge-1.20.1" = _ZktJ9WJb;
        "pkg-2.2.0-fabric-1.20.1" = _iu1OMJDW;
        "pkg-2.2.0-fabric-1.20.2" = _j1luRvIk;
        "pkg-2.2.0-forge-1.20.2" = _OIRVqAny;
        "pkg-2.2.1-forge-1.18.2" = _5G5aliTi;
        "pkg-2.2.1-fabric-1.18.2" = _gwRpXhX2;
        "pkg-2.2.1-forge-1.19.2" = _1zAPNsJ6;
        "pkg-2.2.1-fabric-1.19.2" = _LQ70uQC7;
        "pkg-2.2.1-forge-1.19.4" = _TuSQDa7S;
        "pkg-2.2.1-fabric-1.19.4" = _kf0jjKse;
        "pkg-2.2.1-forge-1.20.1" = _NX4bnFL9;
        "pkg-2.2.1-fabric-1.20.1" = _vUpGp30w;
        "pkg-2.2.1-forge-1.20.2" = _qeiubSfe;
        "pkg-2.2.1-fabric-1.20.2" = _eATgdSa6;
        "pkg-2.2.1-forge-1.20.4" = _mIuGrLsY;
        "pkg-2.2.1-fabric-1.20.4" = _34eqiZlT;
        "pkg-2.2.2-forge-1.18.2" = _KhrhePIZ;
        "pkg-2.2.2-fabric-1.18.2" = _B8yD2UyS;
        "pkg-2.2.2-fabric-1.19.2" = _hFIlzy26;
        "pkg-2.2.2-forge-1.19.2" = _i8bemnRd;
        "pkg-2.2.2-forge-1.19.4" = _cHiG15nd;
        "pkg-2.2.2-fabric-1.19.4" = _cpVuvqSf;
        "pkg-2.2.2-forge-1.20.1" = _BcWF7G0E;
        "pkg-2.2.2-fabric-1.20.1" = _V1KRMYjo;
        "pkg-2.2.2-forge-1.20.4" = _LZxZkHgE;
        "pkg-2.2.2-fabric-1.20.4" = _s553RPXp;
        "pkg-2.3.0-forge-1.20.4" = _mmgnMZkJ;
        "pkg-2.3.0-fabric-1.20.4" = _1mXWMTKK;
        "pkg-2.3.0-neoforge-1.21.1" = _D6Qa77YH;
        "pkg-2.3.0-fabric-1.21.1" = _d4miRYgF;
        "pkg-2.3.1-neoforge-1.21.1" = _r1mpn9bC;
        "pkg-2.3.1-fabric-1.21.1" = _QKIxECxO;
        "pkg-2.3.2-neoforge-1.21.1" = _vtqXlAWL;
        "pkg-2.3.2-fabric-1.21.1" = _DJ1VocaO;
        "pkg-2.3.2-neoforge-1.21.5" = _6vZkP5Hp;
        "pkg-2.3.2-fabric-1.21.5" = _qN028owP;
        "pkg-2.3.3-neoforge-1.21.1" = _rftlnKSN;
        "pkg-2.3.3-fabric-1.21.1" = _JG6Mvdez;
        "pkg-2.3.3-neoforge-1.21.4" = _TfTCyWzy;
        "pkg-2.3.3-fabric-1.21.4" = _W9QSKtil;
        "default" = _W9QSKtil;
    });
