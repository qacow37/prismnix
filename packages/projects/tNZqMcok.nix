...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _rQFyWPsH;
        "pkg-0.1.1" = _C52WwSCB;
        "pkg-0.1.2+1.8.9-forge" = _vsl1B7ne;
        "pkg-0.1.2+1.12.2-forge" = _X6XzJZTC;
        "pkg-0.1.3+1.8.9-forge" = _hNUwFqCS;
        "pkg-0.1.3+1.12.2-forge" = _FwiTwa7o;
        "pkg-0.1.4-BETA+1.8.9-forge" = _LL8bZULJ;
        "pkg-0.1.4-BETA+1.12.2-forge" = _c87JrguA;
        "pkg-0.1.4+1.8.9-forge" = _LjpJUYMo;
        "pkg-0.1.4+1.12.2-forge" = _xJFPvJD7;
        "pkg-0.1.5+1.8.9-forge" = _e4Fg7EfY;
        "pkg-0.1.5+1.12.2-forge" = _XOrYVfhj;
        "pkg-0.1.6+1.8.9-forge" = _FysvEo1o;
        "pkg-0.1.6+1.12.2-forge" = _vphN35lJ;
        "pkg-0.1.7+1.8.9-forge" = _aa5qpOqe;
        "pkg-0.1.7+1.12.2-forge" = _B3uo590t;
        "pkg-0.1.8+1.8.9-forge" = _JRPGyssd;
        "pkg-0.1.8+1.12.2-forge" = _ywQUvkDp;
        "default" = _ywQUvkDp;
    });
