...
let
    ...
    in {
        ...
        "pkg-0.9.6" = _dx2jqLba;
        "pkg-0.9.7" = _4McWmi6k;
        "pkg-0.9.8-1.21.1" = _K2AEKaG3;
        "pkg-0.9.9-1.21.1" = _xa3mDjVH;
        "pkg-0.9.9.1" = _SA0gKSLn;
        "pkg-0.9.9.2" = _6xrkLjc2;
        "pkg-0.9.9.3" = _sNSRkmtc;
        "pkg-0.9.9.4" = _UpQRT3Sr;
        "pkg-1.0" = _PDYrhPDr;
        "pkg-1.0.1" = _BiaZycvk;
        "pkg-1.0.2" = _6ePriXe1;
        "pkg-1.0.2-curios_compat" = _QwQordSh;
        "pkg-1.0.3" = _df3SuCaG;
        "pkg-1.0.4" = _idDehEIk;
        "pkg-1.0.5" = _O3cD74R3;
        "pkg-1.0.6" = _TXTdcVJC;
        "pkg-1.0.7" = _b2d6pxhM;
        "pkg-1.0.7-1.21.11" = _z7u33fgr;
        "pkg-1.0.8" = _zuyQrPzn;
        "pkg-1.0.8-1.21.11" = _BPMorv2j;
        "pkg-1.0.9" = _e8upk6j5;
        "pkg-1.0.9-1.21.11" = _cUXI6yBM;
        "pkg-1.1.0" = _1kEsFMIZ;
        "pkg-1.1.0-1.21.11" = _bAAOItKN;
        "pkg-1.2.0" = _mIxqhMkX;
        "pkg-1.2.0-1.21.11" = _tmUOK0Fj;
        "pkg-1.2.1" = _IduCfJ9o;
        "pkg-1.2.1-1.21.11" = _w8BlSM35;
        "pkg-1.2.2" = _lQdExIIX;
        "pkg-1.2.2-1.21.11" = _QRd5FWwk;
        "pkg-1.2.3" = _etfFl6iO;
        "pkg-1.2.3-1.21.11" = _RlXQYzED;
        "pkg-1.2.4" = _feHWLa6K;
        "pkg-1.2.4-1.21.11" = _KFpZmvHZ;
        "pkg-1.2.4-26.1.2" = _HK9hfdph;
        "pkg-1.2.5" = _wYd86LBz;
        "pkg-1.2.5-1.21.11" = _plJvKpdK;
        "pkg-1.2.5-26.1.2" = _zWm52daM;
        "pkg-1.2.6" = _M1zb1sWy;
        "pkg-1.2.6-1.21.11" = _bP43n8MG;
        "pkg-1.2.6-26.1.2" = _dZplC0Gt;
        "pkg-1.2.7" = _tYVpzh1J;
