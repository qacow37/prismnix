...
let
    ...
    in {
        ...
        "pkg-v1.0.0" = _HRqDrjGm;
        "pkg-v1.0.1" = _ltUCichg;
        "pkg-v1.0.2" = _Ke50VC6G;
        "pkg-v1.0.2.1-beta" = _i4fFunbH;
        "pkg-v1.0.4" = _WIckw30F;
        "pkg-v1.0.4.1" = _5mXKRczL;
        "pkg-v1.0.4.3" = _vR8n1Bqk;
        "pkg-v1.1.0" = _HI4QfhMK;
        "pkg-v1.1.1" = _Ku9JgHrQ;
        "pkg-v1.1.2" = _KFlHEA9o;
        "pkg-v1.1.3" = _68mj3Ay5;
        "pkg-v1.1.4" = _4tdZzKcT;
        "pkg-v1.1.5" = _FF4aMlXb;
        "pkg-v1.2.0" = _TclOoy70;
        "pkg-1.3.0" = _rW5RXUV5;
        "pkg-1.4.0" = _ItP6rCwn;
        "pkg-1.3.1" = _ezoLmi7r;
        "pkg-1.4.1" = _aUHMxTHd;
        ...
        "pkg-1.4.2" = _U8LEqW8q;
        "pkg-1.5.0" = _q820tkKS;
        "pkg-1.6.0-beta.1" = _j9xKgnpe;
        "pkg-1.7.0-beta.1" = _FrXtYp5B;
        "pkg-1.7.0" = _5yL0TXxE;
        "pkg-1.8.0" = _imEAKw4n;
        "pkg-1.9.0" = _jtGMklLN;
        "pkg-1.10.0" = _aRqzkGCK;
        "default" = _aRqzkGCK;
    });
