...
let
    ...
    in {
        ...
        "pkg-v1.0.1" = _QflFRX0W;
        "pkg-v1.0.2" = _1LBMrElr;
        "pkg-1.19.4-v1.2.0" = _N6rO876a;
        "pkg-1.19.3-v1.2.0" = _jfPFBizn;
        "pkg-1.19-v1.2.0" = _cxx9vcoG;
        "pkg-1.18-v1.2.0" = _IRE0LLL0;
        "pkg-1.20-v1.2.0" = _BNOdjXLg;
        "pkg-1.18-v1.3.0" = _PQm1d4eF;
        "pkg-1.19-v1.3.0" = _biTn6Q1n;
        "pkg-1.19.3-v1.3.0" = _PAI6rfDx;
        "pkg-1.19.4-v1.3.0" = _wVz5PTOI;
        "pkg-1.20-v1.3.0" = _8cXKKbjn;
        "pkg-1.18-v1.4.0" = _bukmprCU;
        "pkg-1.19-v1.4.0" = _ooDDxdLU;
        "pkg-1.19.3-v1.4.0" = _d1RP052A;
        "pkg-1.19.4-v1.4.0" = _wFskjhGu;
        "pkg-1.20-v1.4.0" = _fJk4Ozi8;
        "pkg-1.18-v1.4.1" = _VLQcD4xn;
        "pkg-1.19-v1.4.1" = _Vz3kxiRE;
        "pkg-1.19.3-v1.4.1" = _McoKoKiT;
        "pkg-1.19.4-v1.4.1" = _C30xtrsH;
        "pkg-1.20-v1.4.1" = _DJJa3VB1;
        "pkg-2.0.0-mc1.20" = _VWfKaaAY;
        "pkg-2.0.1-mc1.20" = _Nl4W2r8m;
        "pkg-2.0.1-mc1.20.2" = _l22TksgD;
        "pkg-2.0.2-mc1.20.2" = _jRoIqVWB;
        "pkg-2.1.0-mc1.20.2" = _8knZGn5f;
        "pkg-2.1.0-mc1.20" = _SpFSLjhe;
        "pkg-3.0.0-mc1.20.2" = _y18Ce6wZ;
        "pkg-3.1.0-mc1.20.2" = _3CGMXcja;
        "pkg-3.1.1-mc1.20.2" = _c8xjJ69M;
        "pkg-4.0.0-mc1.20.2" = _JwjtZjke;
        "pkg-4.0.1-mc1.20.2" = _duY03Moh;
        "pkg-4.0.2-mc1.20.2" = _50yu2xYI;
        "pkg-4.0.3-mc1.20.2" = _zafjkgiQ;
        "pkg-4.1.0-fabric1.20.2" = _mpfSapKD;
        "pkg-4.1.1-fabric1.20.2" = _1p2uEUXZ;
        "pkg-4.1.2-fabric1.20.2" = _hYxhB9Bi;
        "pkg-4.1.3-fabric1.20.2" = _7ea3a1De;
        "pkg-4.1.3-fabric1.20" = _dsBZi6gT;
        "default" = _dsBZi6gT;
    });
