...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.1.11" = _OOZfnWLW;
        "pkg-1.19.2-1.1.0.8" = _y4YLOAsW;
        "pkg-1.20.1-1.2.0.3" = _Dl9MK4on;
        "pkg-1.18.2-1.0.2.12" = _SXgHNfLT;
        "pkg-1.19.2-1.1.1.9" = _B7Ht1sXL;
        "pkg-1.20.1-1.2.1.4" = _vPX0UIuK;
        "pkg-1.20.4-2.a.0.0" = _JDS7kKVR;
        "pkg-1.18.2-1.0.2.13" = _ph5w1IBE;
        "pkg-1.19.2-1.1.2.10" = _WOPabswu;
        "pkg-1.20.1-1.2.2.5" = _jQZGnN3f;
        "pkg-1.20.4-2.a.0.1" = _Eyjz7kuQ;
        "pkg-1.18.2-1.0.2.14" = _Xb0L0ghM;
        "pkg-1.19.2-1.1.2.11" = _uidoHzQa;
        "pkg-1.20.1-1.2.2.6" = _JjuQy965;
        "pkg-1.20.4-2.a.0.2" = _F6VuRXyC;
        "pkg-1.18.2-1.0.2.15" = _Sm1iOawB;
        "pkg-1.19.2-1.1.2.12" = _eJ0OP1iW;
        "pkg-1.20.1-1.2.2.7" = _JZwfz7Mf;
        "pkg-1.20.4-2.0.a.3" = _J0ADNQok;
        "pkg-1.21-2.0.b.0" = _wG5KedvO;
        "pkg-1.21.1-2.0.0.0" = _fCjG3BU8;
        "pkg-1.18.2-1.0.2.17" = _VBjVTLGy;
        "pkg-1.19.2-1.1.2.14" = _fkl7hHQf;
        "pkg-1.20.1-1.2.2.9" = _eSVk4hR8;
        "pkg-1.21.1-2.0.0.3" = _vnhTiB9M;
        "pkg-1.18.2-1.0.2.18" = _iUdDO0yl;
        "pkg-1.19.2-1.1.2.15" = _yvIa4U0X;
        "pkg-1.20.1-1.2.2.10" = _NnNPJ9L0;
        "pkg-1.21.1-2.0.0.4" = _SuCRkW4O;
        "pkg-1.18.2-1.0.2.19" = _mO4xrRd8;
        "pkg-1.19.2-1.1.2.16" = _m4uWgIfB;
        "pkg-1.20.1-1.2.2.11" = _prpstPhx;
        "pkg-1.21.1-2.0.0.5" = _UIz97L67;
        "pkg-1.18.2-1.0.2.20" = _bkjeqVIV;
        "pkg-1.19.2-1.1.2.17" = _KqCnXIve;
        "pkg-1.20.1-1.2.2.12" = _rSTxjUPt;
        "pkg-1.21.1-2.0.0.6" = _vkRw4LgF;
        "pkg-1.18.2-1.0.2.21" = _ilBgbUSC;
        "pkg-1.19.2-1.1.2.18" = _isQToiqx;
        "pkg-1.20.1-1.2.2.13" = _k8Im0xSh;
        "pkg-1.21.1-2.0.0.7" = _wZml2Fep;
        "default" = _wZml2Fep;
    });
