...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _fkbzhabC;
        "pkg-1.0.2" = _25kOslIx;
        "pkg-df3137f" = _DTlHMIql;
        "pkg-1.0.3" = _YXrEAeR8;
        "pkg-9381bd9" = _y7NwbsbW;
        "pkg-d9213e1" = _inDoU2OT;
        "pkg-1.0.4" = _Pjkdve8o;
        "pkg-06517b1" = _tQVR98ft;
        "pkg-1.0.5" = _QAoECYYo;
        "pkg-c9f08bf" = _xn16TVmo;
        "pkg-1.0.6" = _WbCyip15;
        "pkg-a8243a0" = _16Rh6MIk;
        "pkg-5e7a811" = _qO0lMIVm;
        "pkg-096c544" = _zonyIOMo;
        "pkg-643fed4" = _leBX080w;
        "pkg-84d1fc2" = _ItIAxVVQ;
        "pkg-27e7729" = _IokxZHri;
        "pkg-1c338e6" = _wQsKuozx;
        "pkg-1.0.7" = _PQkaV7hq;
        "pkg-8ad8543" = _BTh4sdwI;
        "pkg-5dc2bba" = _6tUk3Op4;
        "pkg-53c8442" = _EkqyZ9Uw;
        "pkg-0c7f4f9" = _EjDgHkN7;
        "pkg-1.0.8" = _j3GMv0wI;
        "pkg-6b2fe8a" = _6RKenNZu;
        "pkg-41118f4" = _6MKtPqiZ;
        "pkg-7277905" = _3nmxXeWV;
        "pkg-1.0.9" = _KMF7h16S;
        "pkg-f72ebce" = _mIZt10la;
        "pkg-6ca91cd" = _eFtVPMqj;
        "pkg-8b40faa" = _UIIdkjsm;
        "pkg-1.0.10" = _4YoLFQ0G;
        "pkg-6880197" = _3i0JP4qh;
        "default" = _3i0JP4qh;
    });
