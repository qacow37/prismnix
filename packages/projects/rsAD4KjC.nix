...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _hcZ1dbhl;
        "pkg-fabric1.20-1.0.1" = _bGtSG9Ws;
        "pkg-fabric1.20.2-1.0.1" = _WHsx0ZH7;
        "pkg-fabric1.20.3-1.0.1" = _YZMSPwWT;
        "pkg-fabric1.20-1.0.2" = _CWKtdZq0;
        "pkg-fabric1.20.2-1.0.2" = _3ZXK7dWm;
        "pkg-fabric1.20.3-1.0.2" = _adde81TT;
        "pkg-fabric1.20.3-1.0.3" = _6lqoIdwi;
        "pkg-fabric1.20-1.0.4" = _Wes83L8K;
        "pkg-fabric1.20.2-1.0.4" = _27P1Pza5;
        "pkg-fabric1.20.3-1.0.4" = _Wd435dO9;
        "pkg-fabric1.20-1.0.5" = _bIZA4N7d;
        "pkg-fabric1.20.2-1.0.5" = _YsureAjI;
        "pkg-fabric1.20.3-1.0.5" = _c15Um0iM;
        "pkg-fabric1.20.3-1.0.6" = _YnXEr6Pi;
        "pkg-fabric1.20-1.0.7" = _JjQ2Rkee;
        "pkg-fabric1.20.2-1.0.7" = _Y4t41U48;
        "pkg-fabric1.20.3-1.0.7" = _cSs4lUCc;
        "pkg-fabric1.20.3-1.0.8" = _IlqY1ywR;
        "pkg-fabric1.20-1.0.9" = _h1RXL3Nu;
        "pkg-fabric1.20.2-1.0.9" = _YNeA1ZYl;
        "pkg-fabric1.20.3-1.0.9" = _5plauyuz;
        "pkg-fabric1.20-1.1.0" = _GC8hSu7Z;
        "pkg-fabric1.20.2-1.1.0" = _uZeoNvCJ;
        "pkg-fabric1.20.3-1.1.0" = _NQ07fjnT;
        "pkg-fabric1.21.2-1.1.0" = _EoipuNpx;
        "default" = _EoipuNpx;
    });
