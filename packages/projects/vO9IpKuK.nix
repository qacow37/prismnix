...
let
    ...
    in {
        ...
        "pkg-1.3-1.21.1" = _E2eYQN6r;
        "pkg-1.4-1.20.1" = _QAVkXSKU;
        "pkg-1.4-1.21.1" = _jgXtlJFp;
        "pkg-1.4-1.21.2" = _6f4fjJfI;
        "pkg-1.4-1.21.5" = _3638y3Y1;
        "pkg-1.4-1.21.6" = _vkDKw2p4;
        "pkg-1.4-1.21.8" = _FmEF9RWj;
        "pkg-1.4-1.21.9" = _ISuyUnXo;
        "pkg-1.4-1.21.10" = _xbv4AST3;
        "pkg-1.4-1.21.11" = _ONXqtZtX;
        "pkg-2.0-1.20.1" = _DEi0aslK;
        "pkg-2.0-1.21.1" = _rl8inu3N;
        "pkg-2.0-1.21.2" = _ZeTnQq04;
        "pkg-2.0-1.21.3" = _H6CF0UD6;
        "pkg-2.0-1.21.4" = _BQkKdoKB;
        "pkg-2.0-1.21.5" = _xeigohoD;
        "pkg-2.0-1.21.6" = _T1RPsYx8;
        "pkg-2.0-1.21.7" = _bFyx8qAo;
        "pkg-2.0-1.21.8" = _IoQYjuiy;
        "pkg-2.0-1.21.9" = _9uMiK3BW;
        "pkg-2.0-1.21.10" = _Ce9s0YOu;
        "pkg-2.0-1.21.11" = _D5bDYrlB;
        "pkg-2.0-26.1" = _FoDcKi17;
        "pkg-2.0-26.1.1" = _MVCemRPv;
        "pkg-2.0-26.1.2" = _xibPByBM;
        "pkg-2.0-26.2" = _U2ZvrZeg;
        "pkg-2.1-1.20.1" = _FxmDWCdx;
        "pkg-2.1-1.21.1" = _YVEfMqOB;
