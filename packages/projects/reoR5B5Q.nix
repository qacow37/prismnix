...
let
    ...
    in {
        ...
        "pkg-V1.2" = _LJbzexL8;
        "pkg-V1.2.1-data" = _1y1iv2EB;
        "pkg-V1.2.1-mod" = _ttK1dcTm;
        "pkg-V1.2.2-data" = _PFEitKKf;
        "pkg-V1.2.2-mod" = _bbWfshi9;
        "pkg-V1.2.3-data" = _g1O9T1Wa;
        "pkg-V1.2.3-mod" = _2CZQcuY5;
        "pkg-V1.3-data" = _H1TBRtRF;
        "pkg-V1.3-mod" = _u6hHUSQS;
        "pkg-V1.3.1-data" = _HhnlCg0x;
        "pkg-V1.3.1-mod" = _k3CLfN2e;
        "pkg-V1.3.2-data" = _D1kHt1UJ;
        "pkg-V1.3.2-mod" = _EqlVwY9O;
        "pkg-V1.3a-data" = _1NOENokP;
        "pkg-V1.3a-mod" = _v5rVwSwb;
        "pkg-V1.3.1a-data" = _UP6NSiia;
        "pkg-V1.3.1a-mod" = _epL4MwgT;
        "pkg-V1.3.2a-data" = _uLKvBmHi;
        "pkg-V1.3.2a-mod" = _lqquxBl9;
        "pkg-V1.3.3-data" = _uwo6AXm0;
        "pkg-V1.3.3-mod" = _vCfhXpHV;
        "pkg-V1.3.4-data" = _dmOtC8DQ;
        "pkg-V1.3.4-mod" = _vSUB8K2J;
        "default" = _vSUB8K2J;
    });
