...
let
    ...
    in {
        ...
        "pkg-1.20.1-0.0.1-forge" = _K1UgdCUK;
        "pkg-1.20.1-0.0.1-fabric" = _b3bX2WMB;
        "pkg-1.20.1-1.0.0-forge" = _Iaqyr5gb;
        "pkg-1.20.1-1.0.0-fabric" = _AoupwXcg;
        "pkg-1.20.1-1.0.1-forge" = _huiPd6Lc;
        "pkg-1.20.1-1.0.1-fabric" = _fBoxabC2;
        "pkg-1.20.1-1.0.2-fabric" = _Bskomaui;
        "pkg-1.20.1-1.0.2-forge" = _ImjY8MG3;
        "pkg-1.20.1-1.1.0-forge" = _2RMHYPD5;
        "pkg-1.20.1-1.1.0-fabric" = _k0AwWumU;
        "pkg-1.21.1-1.1.0-neoforge" = _GPnJR0Cp;
        "pkg-1.21.1-1.1.0-fabric" = _XlluQUr6;
        "pkg-1.21.1-1.1.1-fabric" = _8jBT4C2k;
        "pkg-1.21.1-1.1.1-neoforge" = _sU5MXKHH;
        "pkg-1.20.1-1.1.1-forge" = _U3ktiRdL;
        "pkg-1.20.1-1.1.1-fabric" = _oUAVXW1N;
        "pkg-1.20.1-1.2.0-fabric" = _Mj1ZICrq;
        "pkg-1.20.1-1.2.0-forge" = _bFFuH1bk;
        "pkg-1.21.1-1.2.0-neoforge" = _HZxaUSFO;
        "pkg-1.21.1-1.2.0-fabric" = _cQDZrjq9;
        "pkg-1.20.1-1.2.1-forge" = _wfcpVoyC;
        "pkg-1.20.1-1.2.1-fabric" = _dFVGiTeX;
        "pkg-1.21.1-1.2.1-neoforge" = _gxMygMIy;
        "pkg-1.21.1-1.2.1-fabric" = _eil5mAWV;
        "pkg-1.20.1-1.2.2-forge" = _H1jsvy53;
        "pkg-1.20.1-1.2.2-fabric" = _n7VmkBLu;
        "pkg-1.21.1-1.2.2-neoforge" = _FhE1RJsR;
        "pkg-1.21.1-1.2.2-fabric" = _SBDJBD0a;
        "default" = _SBDJBD0a;
    });
