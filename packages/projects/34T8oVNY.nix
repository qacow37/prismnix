...
let
    ...
    in {
        ...
        "pkg-1.20.2-SNAPSHOT" = _1K0E989z;
        "pkg-1.20.2-473" = _OMmFogXM;
        "pkg-1.20.2-474" = _J1d1vdBv;
        "pkg-1.20.2-475" = _QPbgctmT;
        "pkg-1.20.4-476" = _UGwTiM8X;
        "pkg-1.20.4-477" = _lkMkrKg5;
        "pkg-1.20.4-478" = _PL95NpAU;
        "pkg-1.20.4-479" = _vA62fwV3;
        "pkg-1.20.4-480" = _qNAHRk9P;
        "pkg-1.20.4-481" = _OmRF69iO;
        "pkg-1.20.4-482" = _SY1rMQ56;
        "pkg-1.20.4-483" = _CmHyRjLH;
        "pkg-1.20.4-484" = _SfUdiae8;
        "pkg-1.20.4-485" = _i0HWDPda;
        "pkg-1.20.4-486" = _QHcdXGBb;
        "pkg-1.20.4-487" = _znZSTdSY;
        "pkg-1.20.4-488" = _lnRPUImn;
        "pkg-1.20.4-489" = _2FL9pxkl;
        "pkg-1.20.4-490" = _QOtDl6Yx;
        "pkg-1.20.4-491" = _aOSyYaiv;
        "pkg-1.20.4-492" = _rAKqW9Cm;
        "pkg-1.20.6-493" = _3VcHepIO;
        "pkg-1.20.6-494" = _rto8s52l;
        "pkg-1.20.6-495" = _tDgA6bF3;
        "pkg-1.20.6-496" = _eIAzO2tx;
        "pkg-1.20.6-497" = _OLbCxRk7;
        "pkg-1.20.6-498" = _POnJfjrP;
        "pkg-1.20.6-499" = _KqfToZQ4;
        "pkg-1.21-500" = _beUjZRa2;
        "pkg-1.21-501" = _FQ8WD6mI;
        "pkg-1.21-502" = _5BB1PHsL;
        "pkg-1.21-503" = _Mrusq1GH;
        "pkg-1.21-504" = _gGUIA9XL;
        "pkg-1.21-505" = _lEWsadkA;
        "pkg-1.21-506" = _F4lqJPYd;
        "pkg-1.21-507" = _3nFZqu2w;
        "pkg-1.21.1-508" = _Z2GbpQcE;
        "pkg-1.21.3-509" = _LWkJr0rA;
        "pkg-1.21.3-510" = _KVb8wj42;
        "pkg-1.21.3-511" = _HuZK4TDu;
        "pkg-1.21.4-512" = _g00QoYVL;
        "pkg-1.21.4-513" = _jCVebWm5;
        "pkg-1.21.4-514" = _8YXY3h0N;
        "pkg-1.21.4-515" = _8JsiZZI0;
        "pkg-1.21.4-516" = _9maXmlF2;
        "pkg-1.21.4-517" = _BM2TKQWm;
        "pkg-1.21.4-518" = _jEH1graG;
        "pkg-1.21.4-519" = _ndThA1lr;
        "pkg-1.21.4-520" = _SdgU0i4e;
        "pkg-1.21.4-521" = _OvwBThgN;
        "pkg-1.21.4-522" = _7Foisq1m;
        "pkg-1.21.4-523" = _cBMLf0uw;
        "pkg-1.21.4-524" = _RYsfpwGg;
        "pkg-1.21.4-525" = _aPoIL2mI;
        "pkg-1.21.4-526" = _Mml961m8;
        "pkg-1.21.5-527" = _GDUVMkJE;
        "pkg-1.21.5-528" = _QODjzDYG;
        "pkg-1.21.5-529" = _7Dfbq9gO;
        "pkg-1.21.6-530" = _QdZS9giC;
        "pkg-1.21.6-531" = _lhrcub7H;
        "pkg-1.21.7-531" = _wWZQtILE;
        "pkg-1.21.7-532" = _IOdc2YPn;
        "pkg-1.21.7-533" = _UGoDnDRl;
        "pkg-1.21.8-534" = _sCKfp2wx;
        "pkg-1.21.10-535" = _vymv6Zde;
        "pkg-1.21.10-536" = _2XAkf3uB;
        "pkg-1.21.10-537" = _Ur0eA4jT;
        "pkg-1.21.10-538" = _3sHNaN8q;
        "pkg-1.21.11-539" = _anv0WAKr;
        "pkg-1.21.11-540" = _e7ry5uKb;
        "pkg-1.21.11-541" = _kh6fCyFq;
        "pkg-1.21.11-542" = _Qz9jIHQN;
        "pkg-1.21.11-543" = _DgHRWrss;
        "pkg-1.21.11-544" = _1O4z4iPC;
        "pkg-26.1.2-545" = _ybOhOUei;
        "pkg-26.1.2-546" = _lIfBwoTp;
        "pkg-26.1.2-547" = _21UsCFPc;
        "pkg-26.1.2-548" = _nFc5QgTP;
        "pkg-26.1.2-549" = _DITrCkXi;
        "pkg-26.1.2-550" = _FjJqTbas;
        "pkg-26.2-551" = _1NoPT72m;
