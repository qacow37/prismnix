...
let
    ...
    in {
        ...
        "pkg-2.0.1" = _c5NJu1Rs;
        "pkg-2.3.0" = _eBFrS8uZ;
        "pkg-1.19.4-2.3.0" = _79nOoNCe;
        "pkg-1.16.5-2.3.0" = _hbBdiMTG;
        "pkg-1.20.1-2.3.1" = _NxUr10If;
        "pkg-1.19.4-2.3.1" = _L6M9UkTo;
        "pkg-1.16.5-2.3.1" = _ctYIwYom;
        "pkg-1.19.2-2.3.1" = _nf8zGJnv;
        "pkg-1.20.2-2.3.2" = _mCjt1FQx;
        "pkg-1.20.6-2.4.0" = _6MoPVj4X;
        "pkg-1.21-2.4.1" = _K6K33e5O;
        "pkg-1.20.6-2.4.1" = _JsbQbVnz;
        "pkg-1.21-3.0.0-alpha" = _2lfxqT76;
        "pkg-1.21-3.0.0-alpha.1" = _Eb7hxtXs;
        "pkg-1.21-3.0.0-alpha.2" = _lqMJFhmd;
        "pkg-1.21-3.0.0-alpha.3" = _CtuvsocD;
        "pkg-1.21-3.0.0-alpha.4" = _l2AKjPnt;
        "pkg-1.21-3.0.0-alpha.5" = _oKG12Q7K;
        "pkg-1.21-3.0.0-alpha.6" = _osAZb62u;
        "pkg-1.21-3.0.0-beta" = _AReNuXJz;
        "pkg-1.21-3.0.0" = _zLGMpWoP;
        "default" = _zLGMpWoP;
    });
