...
let
    ...
    in {
        ...
        "pkg-v20.4.0-1.20.4-Fabric" = _QVvjk2GT;
        "pkg-v20.4.0-1.20.4-Forge" = _6kk1Xwbm;
        "pkg-v20.4.0-1.20.4-NeoForge" = _8aSIdj8G;
        "pkg-v21.1.0-1.21.1-Fabric" = _UNvqdGif;
        "pkg-v21.1.0-1.21.1-NeoForge" = _VWXppTuG;
        "pkg-v21.3.0-1.21.3-Fabric" = _dOneEus4;
        "pkg-v21.3.0-1.21.3-NeoForge" = _BIgDbDit;
        "pkg-v21.4.0-1.21.4-Fabric" = _MyEUUErd;
        "pkg-v21.4.0-1.21.4-NeoForge" = _S6D61xFc;
        "pkg-v21.5.0-1.21.5-Fabric" = _tNR9nsqN;
        "pkg-v21.5.0-1.21.5-NeoForge" = _NJwJWgED;
        "pkg-v21.8.0-1.21.8-Fabric" = _9eIkRPXm;
        "pkg-v21.8.0-1.21.8-NeoForge" = _MgjEuYyL;
        "pkg-v21.1.1-1.21.1-Fabric" = _JOJ2mX2z;
        "pkg-v21.1.1-1.21.1-NeoForge" = _27FVftjr;
        "pkg-21.10.1" = _YmKkOln9;
        "pkg-21.11.0" = _aHP9Ju2T;
        "pkg-26.1.0" = _IYhPZl5v;
