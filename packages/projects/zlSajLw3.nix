...
let
    ...
    in {
        ...
        "pkg-v.1.2.8" = _Hwi8eIpH;
        "pkg-v.2.0.3" = _wkUnPA2F;
        "pkg-v.2.0.5" = _tWehwVd2;
        "pkg-v.2.0.10" = _KhsCPeX7;
        "pkg-v.2.1.2" = _ufS2kf8C;
        "pkg-v.2.1.3" = _Cj7ZB8kW;
        "pkg-v.2.1.4" = _253u9reu;
        "pkg-v.2.1.5" = _9DWdPodb;
        "pkg-v.2.2.0" = _Ac920VJN;
        "pkg-v.2.2.1" = _DX5lvvU2;
        "pkg-v.2.2.2" = _4jM3bgxs;
        "pkg-v.2.2.3" = _HlChAJtM;
        "pkg-v.2.3.0" = _9PXnepML;
        "pkg-v.2.3.1" = _bbDa96Bm;
        "pkg-v.2.4.0" = _B2QV58jK;
        "pkg-v.2.3.2" = _wdtbFAfj;
        "pkg-v.2.4.1" = _5jf6vI8S;
        "pkg-v.2.3.3" = _SVNgazo9;
        "pkg-v.2.4.2" = _kbhoDTCl;
        "pkg-v.3.0.0" = _5IoMouqO;
        "pkg-v.3.0.1" = _GX8abTlQ;
        "pkg-v.3.0.2" = _hD3dstfW;
        "pkg-v.3.0.3" = _DuleHrw3;
        "pkg-v.3.0.4" = _KvqV3Zh2;
        "pkg-v.3.0.5" = _VYEt2jwD;
        "pkg-4.0.0" = _fNQiaqXz;
        "pkg-v.4.0.1" = _sByp6lZi;
        "pkg-v.4.1.0" = _sf8o8y8m;
        "pkg-v.5.0.0" = _ksAY2NBj;
        "default" = _ksAY2NBj;
    });
