...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _iQLlmxUd;
        "pkg-1.0.1-1.10.2" = _qXP9wCx7;
        "pkg-1.0.1-1.11" = _oNji0ZVk;
        "pkg-1.0.2" = _wij5pEII;
        "pkg-1.1.0" = _w7muEbhz;
        "pkg-1.1.1" = _dFVc4azA;
        "pkg-1.1.2" = _jj4i6GvS;
        ...
        "pkg-1.2.2" = _vULgSvpw;
        "pkg-1.2.3" = _EXXb3BtE;
        "pkg-1.2.4-1.16.5" = _2w6cDymy;
        "pkg-1.2.4-1.18.2" = _24qA23yO;
        "pkg-1.2.5-1.18.2" = _GrMG9R9n;
        "pkg-1.2.5-1.19.2" = _ySRK0ETi;
        "pkg-1.2.6-1.16.5" = _BT7jhxAs;
        "pkg-1.2.6-1.18.2" = _nvRtW2UN;
        "pkg-1.2.6-1.19.2" = _wbl17r0T;
        "pkg-1.2.7-1.16.5" = _zO2CSqB3;
        "pkg-1.2.7-1.18.2" = _NjcrAVWj;
        "pkg-1.2.7-1.19.2" = _hEhQhXXE;
        "pkg-1.2.8-1.16.5" = _z6Tc6JgC;
        "pkg-1.2.8-1.18.2" = _AUqsHZZ6;
        "pkg-1.2.8-1.19.2" = _ufkF1Dp7;
        "pkg-1.2.9-1.16.5" = _RhNwHTHr;
        "pkg-1.2.9-1.18.2" = _NyFVlUed;
        "pkg-1.2.9-1.19.2" = _LRRyQNKE;
        "pkg-1.2.10-1.16.5" = _OHXsH50y;
        "pkg-1.2.10-1.18.2" = _kS2oURTc;
        "pkg-1.2.10-1.19.2" = _xC4KpcaJ;
        "pkg-1.2.10-1.19.3" = _gP3Td7mM;
        "pkg-1.2.10-1.19.4" = _zccgBNgo;
        "pkg-1.2.11-1.16.5" = _3CFDZZAS;
        "pkg-1.2.11-1.18.2" = _b994HSkA;
        "pkg-1.2.11-1.19.2" = _1RTwgVYp;
        "pkg-1.2.11-1.19.4" = _tm3oaqzF;
        "pkg-1.2.12-1.16.5" = _zNuQfbhd;
        "pkg-1.2.12-1.18.2" = _fgqJjSWj;
        "pkg-1.2.12-1.19.2" = _MhWfqW9m;
        "pkg-1.2.12-1.19.4" = _DQActy0B;
        "pkg-1.2.12-1.20" = _Ig3l9y9M;
        "pkg-1.2.13" = _o1zjFoVz;
        "pkg-1.2.14-1.18.2" = _DHzjQxEI;
        "pkg-1.2.14-1.19.2" = _yXvRywoX;
        "pkg-1.2.14-1.19.4" = _Hwj9PyMD;
        "pkg-1.2.14-1.20.1" = _1t1rRSP7;
        "pkg-1.2.14-1.20.2" = _VRmg4Q7G;
        "pkg-1.2.15-1.18.2" = _V5YF4zfV;
        "pkg-1.2.15-1.19.2" = _U291tdpK;
        "pkg-1.2.15-1.19.4" = _dWAAsdBX;
        "pkg-1.2.15-1.20.1" = _WlvDRe1W;
        "pkg-1.2.15-1.20.2" = _pKByVZZ7;
        "pkg-1.2.16-1.19.4" = _oatIMP4n;
        "pkg-1.2.16-1.20.1" = _c4vnZgBp;
        "pkg-1.2.16-1.20.4" = _i12gXhU5;
        "pkg-1.2.16-neoforge-1.20.4" = _BwMeb2eB;
        "pkg-1.2.16-fabric-1.20.1" = _9R38oliQ;
        "pkg-1.2.16-fabric-1.20.4" = _YBgtpp5f;
        "pkg-1.2.17-1.18.2" = _5PHkrTMN;
        "pkg-1.2.17-1.19.2" = _IKE642La;
        "pkg-1.2.17-1.19.4" = _Z8HPTdLX;
        "pkg-1.2.17-1.20.1" = _F0BgKEBv;
        "pkg-1.2.17-1.20.4" = _j2zFHouv;
        "pkg-1.2.17-neoforge-1.20.4" = _7FMycyXq;
        "pkg-1.2.17-neoforge-1.20.6" = _b8p8svtK;
        "pkg-1.2.17" = _aPL2KLye;
        "pkg-1.2.18-1.18.2" = _vp7dqKiR;
        "pkg-1.2.18-1.19.2" = _ALSHY0zB;
        "pkg-1.2.18-1.19.4" = _WjwPm7Ba;
        "pkg-1.2.18-1.20.1" = _hZPgfMGr;
        "pkg-1.2.18-fabric-1.20.1" = _wiwcn0y3;
        "pkg-1.2.18-neoforge-1.20.4" = _2bubAfz1;
        "pkg-1.2.18-fabric-1.20.4" = _tsrUPEbU;
        "pkg-1.2.18-neoforge-1.20.6" = _Q6z4X0jL;
        "pkg-1.2.18-fabric-1.20.6" = _1a6stxzw;
        "pkg-1.2.18-1.20.6-fabric" = _EbRXGWd4;
        "pkg-1.2.19-1.20.1" = _ZPQ9StUH;
        "pkg-1.2.19-1.20.1-fabric" = _bs3Gmr4n;
        "pkg-1.2.19-1.20.6-neoforge" = _vEaeujTD;
        "pkg-1.2.19-1.20.6-fabric" = _3y7kc4fy;
        "pkg-1.2.19-1.21.1-neoforge" = _7JEAoE7Z;
        "pkg-1.2.19-1.21.1-fabric" = _BA3haTu4;
        "pkg-1.2.19-1.21.4-neoforge" = _hqOvNyZO;
        "pkg-1.2.19-1.21.4-fabric" = _EqWL4V42;
        "pkg-1.2.19b-1.20.1-fabric" = _pwW4dxqR;
        "pkg-1.2.19b-1.20.6-fabric" = _upce0bFB;
        "pkg-1.2.19b-1.21.1-fabric" = _yhjBJX91;
        "pkg-1.2.19b-1.21.4-neoforge" = _KE73d5Vu;
        "pkg-1.2.19b-1.21.4-fabric" = _sRRz3KvN;
        "pkg-1.2.19c-1.21.1-fabric" = _nXhKgqlB;
        "pkg-1.2.19d-1.21.1-fabric" = _weV9ubhk;
        "pkg-1.2.19b-1.21.1-neoforge" = _IXHt4Afn;
        "pkg-1.2.19c-1.21.4-neoforge" = _xoP2m7or;
        "pkg-1.2.20b-1.20.1" = _lQ7L0Mpg;
        "pkg-1.2.20-1.20.1-fabric" = _U2Rcaxss;
        "pkg-1.2.20-1.21.1-neoforge" = _zM3SsIhh;
        "pkg-1.2.20-1.21.1-fabric" = _y3lBPE7M;
        "pkg-1.2.20b-1.20.1-fabric" = _g3QLAfWN;
        "pkg-1.2.20b-1.21.1-fabric" = _lXP6AeMa;
        "pkg-1.2.20c-1.20.1" = _s4RfuNom;
        "pkg-1.2.20c-1.20.1-fabric" = _DPZmJRnn;
        "pkg-1.2.20d-1.20.1" = _boLB5KV5;
        "pkg-1.2.20c-1.21.1-fabric" = _3FOxtTwR;
        "pkg-1.2.20b-1.21.1-neoforge" = _oxlYGdMR;
        "default" = _oxlYGdMR;
    });
