...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.21" = _P7kGDZwn;
        "pkg-1.1.1-1.21" = _lUcFZmxB;
        "pkg-1.1.1-1.21.1" = _ZQema1Ya;
        "pkg-1.1.2-BETA-1-1.21.4" = _ITXgGWoP;
        "pkg-1.1.2-BETA-2-1.21.4" = _grtkC0wu;
        "pkg-1.1.2-BETA-3-1.21.4" = _YCnwDZwZ;
        "pkg-1.1.2-BETA-1-1.21.1" = _SDXazey4;
        "pkg-1.1.2-BETA-2-1.21.1" = _87IP0jfT;
        "pkg-1.1.2-BETA-2-1.21.5" = _DShxE7Lr;
        "pkg-1.1.2.beta.3-1.21.1" = _kWKPcD18;
        "pkg-1.1.2.beta.4-1.21.4" = _QXgHFUGV;
        "pkg-1.1.2.beta.3-1.21.5" = _u9Xxqcve;
        "pkg-1.1.2.beta.3-1.20.5" = _xdlk0usz;
        "pkg-1.1.2.beta.3-25w41a" = _KjFtEAhm;
        "pkg-1.1.2.beta.4-1.21.x-Fabric" = _8alQyw88;
        "pkg-1.1.2.beta.4-1.21.5-Fabric" = _3tOo57xc;
        "pkg-1.1.2.beta.4-25w41a-Fabric" = _YhVFaJBW;
        "pkg-1.1.2.beta.5-1.21.x-Fabric" = _SxU5j2lv;
        "pkg-1.1.2.beta.5-1.21.5-Fabric" = _pDexIJoO;
        "pkg-1.1.2.beta.5-25w41a-Fabric" = _jN1dWm8S;
        "pkg-1.1.2.beta.5-1.21.x-NeoForge" = _PkVXSWsf;
        "pkg-1.1.2.beta.5.1-1.21.x-NeoForge" = _HdD49GW6;
        "pkg-1.1.2.beta.5-1.20.5-Fabric" = _LA2ZXxRu;
        "pkg-1.1.2.beta.5-1.20.1-Fabric" = _rNoHVJ7R;
        "pkg-1.1.2.beta.5-1.20.1-Forge" = _4xr36xil;
        "pkg-1.1.2.beta.5.1-1.20.1-Forge" = _pVOH5ITI;
        "pkg-1.1.2.beta.6-1.20.1-Fabric" = _DC5C9VLN;
        "pkg-1.1.2.beta.6-1.20.1-Forge" = _OONPTsfd;
        "pkg-1.1.2.beta.6-1.20.5-Fabric" = _nsAu2s2C;
        "pkg-1.1.2.beta.6-1.21.1-Fabric" = _cZ8IK41r;
        "pkg-1.1.2.beta.6-1.21.1-Neo" = _bp3jeGSC;
        "pkg-1.1.2.beta.6-1.21.5-Fabric" = _zkLTPbHn;
        "pkg-1.1.2.beta.6-1.21.11-Fabric" = _V8sLByW0;
        "pkg-1.1.2-1.21.11-Fabric" = _9dC48ZEj;
        "pkg-1.1.3-og-1.21.11-Fabric" = _2eRfDl7e;
        "pkg-1.1.3-1.21.11-Fabric" = _1PY8iFlT;
        "pkg-1.1.3-1.21.5-Fabric" = _Mwk9l7aW;
        "pkg-1.1.3-1.21.1-Fabric" = _wZC5H1xS;
        "pkg-1.1.3-1.21.1-NeoForge" = _uuxPBp8T;
        "pkg-1.1.3-1.20.5-Fabric" = _YChoP8xg;
        "pkg-1.1.3-1.20.1-Fabric" = _vsloSGjC;
        "pkg-1.1.3-1.20.1-Forge" = _yUEIhoSB;
        "pkg-1.1.3-26.1-Fabric" = _mBQQv7TR;
        "pkg-1.1.3-26.1-NeoForge" = _oXUs87O2;
        "pkg-1.1.3-26.2-Fabric" = _conCjKRL;
        "default" = _conCjKRL;
    });
