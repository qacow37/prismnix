...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.21.7" = _coy1UM79;
        "pkg-1.1.0+1.21.6" = _9urr74xY;
        "pkg-1.1.0+1.21.5" = _M2jf3TED;
        "pkg-1.1.0+1.21.4" = _82SY0UcL;
        "pkg-1.1.0+1.21.1" = _g532XRhv;
        "pkg-1.2.0+1.21.11" = _ULHFOjIT;
        "pkg-1.2.0+1.21.10" = _2UPqZejL;
        "pkg-1.2.0+1.21.8" = _j2DcNlML;
        "pkg-1.2.0+1.21.6" = _aYVxvRn5;
        "pkg-1.2.0+1.21.5" = _FhtKdI8g;
        "pkg-1.2.0+1.21.4" = _9W5h9ObO;
        "pkg-1.2.0+1.21.1" = _udsn6H63;
        "pkg-1.2.1+1.21.11" = _6E2AaND2;
        "pkg-1.2.1+1.21.10" = _tQwLVIZH;
        "pkg-1.2.1+1.21.8" = _ObaUieos;
        "pkg-1.2.1+1.21.6" = _D2iGQ177;
        "pkg-1.2.1+1.21.5" = _k0PHQlP7;
        "pkg-1.2.1+1.21.4" = _YI44e5nJ;
        "pkg-1.2.1+1.21.1" = _TKq4cPg5;
        "pkg-1.3.0+1.21.1" = _SOqCLYlG;
        "pkg-1.3.0+1.21.4" = _rqiW9yEH;
        "pkg-1.3.0+1.21.5" = _iko7UPb1;
        "pkg-1.3.0+1.21.6" = _bfWRt3Fi;
        "pkg-1.3.0+1.21.8" = _JybM3lYa;
        "pkg-1.3.0+1.21.10" = _HPdq9oV8;
        "pkg-1.3.0+1.21.11" = _XSCa5Lei;
        "pkg-1.3.1+26.1.1" = _PtEZm3Er;
        "pkg-1.3.1+26.1.2" = _jrlc6Ppx;
        "pkg-1.3.1+26.1" = _VfftpbCZ;
        "pkg-1.3.2+26.1.1" = _QkqgVirM;
