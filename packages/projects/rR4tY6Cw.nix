...
let
    ...
    in {
        ...
        "pkg-0.8.0" = _8YTsAVeo;
        "pkg-0.9.0" = _srFPinTA;
        "pkg-0.10.0" = _brTB8jgU;
        "pkg-0.10.1" = _AusN0lU3;
        "pkg-0.10.3" = _JRtZFCFF;
        "pkg-0.10.4" = _pbed9FWV;
        "pkg-0.10.5" = _vjzQekjl;
        "pkg-0.10.6" = _OcnQRszU;
        "pkg-0.10.7" = _rlDA45FS;
        "pkg-0.10.8" = _rLT106mu;
        "pkg-0.11.0" = _U38a1xPj;
        "pkg-0.11.1" = _K34KhMpV;
        "pkg-0.11.2" = _Oqg8VeXM;
        "pkg-0.11.3" = _yXCKPBjN;
        "pkg-0.12.0" = _Dq2GrDFF;
        "pkg-0.12.1" = _w0ijutJV;
        "pkg-0.12.2" = _hZWCGwjo;
        "pkg-0.12.3" = _5qxYpAsr;
        "pkg-0.13.0" = _ONxL7yTw;
        "pkg-0.13.1" = _4wbI7qs3;
        "pkg-0.14.0" = _s9ieVKvL;
        "pkg-0.15.0" = _vUxcjcq4;
        "pkg-0.15.1" = _H59QBIKp;
        "pkg-0.15.2" = _DEWAczGP;
        "pkg-0.15.3" = _PWMr2sUq;
        "pkg-0.15.4" = _YgTFZZDG;
        "pkg-0.15.5" = _Xoocpywp;
        "pkg-0.15.6" = _q8zhjo2P;
        "default" = _q8zhjo2P;
    });
