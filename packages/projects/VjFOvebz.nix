...
let
    ...
    in {
        ...
        "pkg-0.3.1" = _Y95nrBhB;
        "pkg-1.0" = _VzxBKPSX;
        "pkg-1.1-1.19.4-fabric" = _rpgwkVnG;
        "pkg-1.1-1.19.4-forge" = _Gn4lEXqI;
        "pkg-1.1-1.20.1-fabric" = _dXpE9Xti;
        "pkg-1.1-1.20.1-forge" = _6WcP0SyI;
        "pkg-1.1-1.20.4-fabric" = _2IP0jErY;
        "pkg-1.1-1.20.6-fabric" = _c91oDhwj;
        "pkg-1.1-1.20.6-neoforge" = _hNCdHUvH;
        "pkg-1.1-1.21.1-fabric" = _GjoE3XsG;
        "pkg-1.1-1.21.1-neoforge" = _NE5Ktuik;
        "pkg-1.1-1.21.3-fabric" = _q4yueRqR;
        "pkg-1.1-1.21.3-neoforge" = _GYFD6rM8;
        "pkg-1.1-1.21.5-fabric" = _bdam2wKe;
        "pkg-1.1-1.21.5-neoforge" = _McYPaLTA;
        "pkg-1.1.1-1.19.4-fabric" = _ONOnn1PN;
        "pkg-1.1.1-1.19.4-forge" = _yOVDIAg7;
        "pkg-1.1.1-1.20.1-fabric" = _TLmOOYDn;
        "pkg-1.1.1-1.20.1-forge" = _nwoDu4IZ;
        "pkg-1.1.1-1.20.4-fabric" = _vdTVEz5g;
        "pkg-1.1.1-1.20.6-fabric" = _dx6MWTNP;
        "pkg-1.1.1-1.20.6-neoforge" = _GXxI7DBc;
        "pkg-1.1.1-1.21.1-fabric" = _wm2kSyEz;
        "pkg-1.1.1-1.21.1-neoforge" = _2XIOit0Z;
        "pkg-1.1.1-1.21.3-fabric" = _dEU7yqWJ;
        "pkg-1.1.1-1.21.3-neoforge" = _je81Ceqc;
        "pkg-1.1.1-1.21.5-fabric" = _giVJUsVJ;
        "pkg-1.1.1-1.21.5-neoforge" = _8vBQnc0K;
        "pkg-1.1.1-1.21.8-fabric" = _EMNp6udv;
        "pkg-1.1.1-1.21.8-neoforge" = _K1Z3krrW;
        "pkg-1.1.1-1.21.10-fabric" = _qfNNA2Qj;
        "pkg-1.1.1-1.21.10-neoforge" = _BqprYTVX;
        "default" = _BqprYTVX;
    });
