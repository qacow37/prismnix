...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.1.0" = _C5SqLDYd;
        "pkg-1.20.1-0.2.0" = _cA3ZRcko;
        "pkg-1.20.1-0.2.1" = _E0QSnjx6;
        "pkg-1.20.1-0.2.2" = _VMWLdrAh;
        "pkg-1.20.1-0.2.3" = _TcT3PJpj;
        "pkg-1.20.1-0.2.4" = _HHhG3PJb;
        "pkg-1.20.1-0.2.4.1" = _bWevZSEt;
        "default" = _bWevZSEt;
    });
