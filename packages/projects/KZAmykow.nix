...
let
    ...
    in {
        ...
        "pkg-0.1.4" = _AeSC6NkL;
        "pkg-0.1.5" = _CdKN2uoH;
        "pkg-1.19.3-0.2.0" = _pi0J978P;
        "pkg-1.19.2-0.2.0" = _qQOgIpxQ;
        "pkg-1.19.4-0.2.0" = _Wiu55RHK;
        "pkg-1.19.2-0.2.1" = _LsSXw1tA;
        "pkg-1.19.3-0.2.1" = _Io2ob30l;
        "pkg-1.19.4-0.2.1" = _7Rkt6y8O;
        "pkg-1.19.4-0.3.0" = _pw6T7BKi;
        "pkg-1.19.4-0.3.1" = _OohhMNo5;
        "pkg-1.20-0.3.1" = _fhnUgNFL;
        "pkg-1.20-0.3.2" = _DcT5B3gW;
        "pkg-1.20-0.3.3" = _pB9ksLKB;
        "pkg-1.20-0.3.4" = _m2Vkmizo;
        "pkg-1.20-0.3.5" = _3kEIqBw3;
        "pkg-1.20-0.3.6" = _7bQWr6fT;
        "pkg-1.20.1-0.3.6" = _6e5wNlhL;
        "pkg-1.20-0.3.7" = _A0pPyMLX;
        "pkg-1.20.1-0.3.7" = _WztXsUKW;
        "pkg-1.20.1-0.3.8" = _dooZIIEZ;
        "pkg-1.20.1-0.3.9" = _qWfBdxSB;
        "pkg-1.20.X-0.4.0" = _g2pL624r;
        "pkg-1.20.X-0.4.1" = _UWzQ8ZqX;
        "pkg-1.20.X-0.4.2" = _yWh2UlfR;
        "pkg-1.20.(0-1)-0.4.3" = _O3dkbuDi;
        "pkg-1.20-0.5.0" = _frZ2unEH;
        "pkg-1.20.2-0.5.0" = _j5TvMCvW;
        "pkg-1.20.(0-1)-0.5.1" = _nctB2Qun;
        "pkg-1.20.2-0.5.1" = _Ql23mxVP;
        "pkg-1.20.2-0.5.2" = _NOqJzUQ9;
        "pkg-1.20.(0-1)-0.5.2" = _UzC1ByIP;
        "pkg-1.20.(0-1)-0.5.3" = _Bok28Afa;
        "pkg-1.20.(0-1)-0.5.4" = _a19QTJ49;
        "pkg-1.20.(0-1)-0.5.5" = _O8g7WgQD;
        "pkg-1.20.(0-1)-0.5.6" = _c11dpnmh;
        "pkg-1.20.(0-1)-0.5.7" = _MruMiwFW;
        "pkg-1.20.(0-1)-0.5.8" = _sPLi6J2x;
        "pkg-1.20.(0-1)-0.5.9" = _zuD1P17E;
        "pkg-1.20.(0-1)-0.5.10" = _yOUMwHO3;
        "pkg-1.20-0.5.11" = _uAxHhsr2;
        "pkg-1.20-0.6.0" = _IM549pNB;
        "pkg-1.20.2-0.6.0" = _6EpByNOK;
        "pkg-1.20.4-0.6.0" = _XQWg2cct;
        "pkg-1.21.1-0.6.1" = _GLEHGiMF;
        "pkg-1.21.1-0.6.2" = _ZGlXSo3J;
        "pkg-1.21.1-0.6.3" = _yBf0GBIv;
        "pkg-1.21.1-0.6.4" = _JPYjtlxG;
        "pkg-1.21.1-0.6.5" = _OirSZS4H;
