...
let
    ...
    in {
        ...
        "pkg-0.0.17" = _fuHwFiAG;
        "pkg-0.0.18" = _LqiSaocJ;
        "pkg-0.0.19" = _i2lqyeCD;
        "pkg-0.0.20" = _boSI7tyG;
        "pkg-0.0.21" = _KWvj6jSR;
        "pkg-0.0.22" = _zcvTgDha;
        "pkg-0.0.23" = _Dx8Uvt0T;
        "pkg-0.0.24" = _ulQsfKiN;
        "pkg-0.0.25" = _pfmJF32p;
        "pkg-0.0.26" = _8T4BLoiy;
        "pkg-0.0.27" = _cUKyaedi;
        "pkg-0.0.28" = _WBFUCF2C;
        "pkg-0.0.29" = _NlO3R97e;
        "pkg-0.0.30" = _jproYMx9;
        "pkg-0.0.31" = _dEQSc8qq;
        "pkg-0.0.32" = _uiolAlpY;
        "pkg-0.0.33" = _mFRJLmgt;
