...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0" = _m5MwzTo0;
        "pkg-1.18.2-1.1" = _V5SB5ZQL;
        "pkg-1.19.2-1.1" = _8UMW84lW;
        "pkg-1.20.1-1.1" = _rUijSNmq;
        "pkg-1.20.1-1.2" = _tmqj66WM;
        "pkg-1.19.2-1.2" = _kG2wy0fk;
        "pkg-1.18.2-1.2" = _1vk7xWNH;
        "pkg-1.18.2-1.3" = _ehPbAu67;
        "pkg-1.19.2-1.3" = _oFVyEITc;
        "pkg-1.20.1-1.3" = _rOL2JhHs;
        "pkg-1.18.2-1.4" = _P1vVHiDF;
        "pkg-1.19.2-1.4" = _RZBsIOY7;
        "pkg-1.20.1-1.4" = _GHY8nBJl;
        "pkg-1.21.0-1.4" = _hZsUYw3y;
        "pkg-1.18.2-1.5" = _836TmiQw;
        "pkg-1.19.2-1.5" = _QBiV7TLv;
        "pkg-1.20.1-1.5" = _3Eh2Dw6A;
        "pkg-1.18.2-1.6" = _3H26Dnfu;
        "pkg-1.19.2-1.6" = _NMkyDV0q;
        "pkg-1.20.1-1.6" = _T2OC1jIx;
        "pkg-1.20.1-2.0" = _89hFq8bw;
        "pkg-1.21.1-1.4.1" = _9Xrh8TAm;
        "pkg-1.20.1-3.0" = _mpJsCJBX;
        "pkg-1.20.1-3.1" = _g2Dlkw7C;
        "pkg-1.21.1-3.1" = _IQJ3YR4H;
        "pkg-1.21.1-3.2" = _yDe6PUj5;
        "pkg-1.21.1-3.3" = _LRF4ivIZ;
        "pkg-1.21.1-3.4" = _smZtCkBo;
        "pkg-1.20.1-3.4" = _qPBbz58Z;
        "pkg-1.21.1-3.5" = _8L6mVLAs;
        "pkg-1.20.1-3.5" = _r05Bi877;
        "pkg-1.19.2-2.0" = _pkNLZ04L;
        "pkg-1.20.1-3.6" = _O5X1vYX7;
        "pkg-1.21.1-3.7" = _mrQTULRW;
        "default" = _mrQTULRW;
    });
