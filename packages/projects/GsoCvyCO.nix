...
let
    ...
    in {
        ...
        "pkg-1+MC+1.17.x" = _WNkp4G9B;
        "pkg-1+MC+1.16.x" = _kQI8atdK;
        "pkg-1+MC+1.18.x" = _X0gT1jtM;
        "pkg-1+MC+1.19.x" = _ZA3HoPKB;
        "pkg-2+MC+1.16.x" = _FliDlUJB;
        "pkg-1+MC+1.20.x" = _P6qMtPTc;
        "pkg-2+MC+1.20.x" = _6w1GEXco;
        "pkg-2.1+MC+1.20.x" = _zGQfEFMM;
        "pkg-3+MC+1.20.x" = _ApuYwMfx;
        "pkg-4+MC+1.20.x" = _mDF6Da06;
        "pkg-5+MC+1.20.x" = _yynpitL4;
        "pkg-1.21-1.0" = _5zwK6gXl;
        "pkg-1.7-B1" = _LGOSmOnb;
        "pkg-1.12-B1" = _ThU8eHVN;
        "pkg-1.16-B1" = _Pw2Kv7UF;
        "pkg-1.17-B1" = _F6F3eG5i;
        "pkg-1.18-1.1-B1" = _nibdXf3A;
        "pkg-1.19-1.1-B1" = _ko0YDXmI;
        "pkg-1.20-1.5-B1" = _Pgr7n10v;
        "pkg-1.21-1.1-B1" = _T6CbNaja;
        "pkg-1.7-B2" = _BAQUMUUK;
        "pkg-1.12-B2" = _mYVOzuZZ;
        "pkg-1.16-B2" = _2uK2rJYU;
        "pkg-1.17-B2" = _Y5XPXElr;
        "pkg-1.18-1.1-B2" = _p7ciiQE1;
        "pkg-1.19-1.1-B2" = _bKozbvRA;
        "pkg-1.20-1.5-B2" = _kNMd17ws;
        "pkg-1.21-1.1-B2" = _WxyqUChU;
        "pkg-1.7-B3" = _QNNYpzu1;
        "pkg-1.12-B3" = _6t90U5gT;
        "pkg-1.16-B3" = _Mtrcy1Zk;
        "pkg-1.17-B3" = _TJt79g3N;
        "pkg-1.18-B3" = _AzCzCVDA;
        "pkg-1.19-1.1-B3" = _OV6fSMSZ;
        "pkg-1.20-1.5-B3" = _RaqorolV;
        "pkg-1.21-1.1-B3" = _9cxoTyDj;
        "pkg-1.7-B4" = _7Q4yxR9I;
        "pkg-1.12-B4" = _aupEKMlR;
        "pkg-1.16-B4" = _BZ0eP73X;
        "pkg-1.17-B4" = _zEsaZyRr;
        "pkg-1.18-1.1-B4" = _2lD7bSYr;
        "pkg-1.19-1.1-B4" = _EXO76YrB;
        "pkg-1.20-1.5-B4" = _YmzQRqCF;
        "pkg-1.21-1.1-B4" = _roRJU1wE;
        "pkg-1.7-1.0-B5" = _qespLZlh;
        "pkg-1.12-1.0-B5" = _juHX0FFP;
        "pkg-1.16-1.2-B5" = _4n7fpLyd;
        "pkg-1.17-1.1-B5" = _p9u7akqx;
        "pkg-1.18-1.1-B5" = _kUCaXFAP;
        "pkg-1.19-1.1-B5" = _MyZ40YtH;
        "pkg-1.20-1.5-B5" = _qJd3m1z6;
        "pkg-1.21-1.1-B5" = _tF6yz5c2;
        "pkg-1.7-1.0-B6" = _wl5kHCcE;
        "pkg-1.12-1.0-B6" = _r7Dpv9yC;
        "pkg-1.16-1.2-B6" = _R42ee6aQ;
        "pkg-1.17-1.1-B6" = _P3Ek0jWO;
        "pkg-1.18-1.1-B6" = _cKSV9Dzs;
        "pkg-1.19-1.1-B6" = _Fuj2QceC;
        "pkg-1.20-1.5-B6" = _vCr4Macu;
        "pkg-1.21-1.1-B6" = _Rdkh1TVv;
        "pkg-1.21-1.1" = _hQjgTGgA;
        "default" = _hQjgTGgA;
    });
