...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _YTlnTgRQ;
        "pkg-v5.0.0-1.19.3-Fabric" = _8JO9tOBu;
        "pkg-v5.0.0-1.19.3-Forge" = _OpSW99yr;
        "pkg-v6.0.0-1.19.4-Fabric" = _xLbsJUf8;
        "pkg-v6.0.0-1.19.4-Forge" = _uMCIJlJz;
        "pkg-v6.0.1-1.19.4-Fabric" = _QJR9OB5e;
        "pkg-v6.0.1-1.19.4-Forge" = _vqKSnmQy;
        "pkg-v7.0.0-1.20-Forge" = _oPfDlCfo;
        "pkg-v7.0.0-1.20-Fabric" = _jQo0c2bM;
        "pkg-v8.0.0-1.20.1-Forge" = _w5A5TE95;
        "pkg-v8.0.0-1.20.1-Fabric" = _RkLle0Jq;
        "pkg-v8.0.1-1.20.1-Forge" = _x2H4dooa;
        "pkg-v8.0.1-1.20.1-Fabric" = _awKwu0uE;
        "pkg-v8.0.2-1.20.1-Forge" = _gVDdbffP;
        "pkg-v8.0.2-1.20.1-Fabric" = _R3lJW4Qh;
        "pkg-v20.4.0-1.20.4-Fabric" = _H2vguj8v;
        "pkg-v20.4.0-1.20.4-Forge" = _VUI40ZBL;
        "pkg-v20.4.0-1.20.4-NeoForge" = _RZPArszi;
        "pkg-v20.4.1-1.20.4-Fabric" = _7HnGihMH;
        "pkg-v20.4.1-1.20.4-Forge" = _8ndg8pme;
        "pkg-v20.4.1-1.20.4-NeoForge" = _iKM7gUxY;
        "pkg-v21.1.0-1.21.1-Fabric" = _ZzOoi6dQ;
        "pkg-v21.1.0-1.21.1-NeoForge" = _q37Rv4tf;
        "pkg-v21.1.1-1.21.1-Fabric" = _rE5TwLOe;
        "pkg-v21.1.1-1.21.1-NeoForge" = _Jya0J2fp;
        "pkg-v21.3.0-1.21.3-Fabric" = _I8HNL3xw;
        "pkg-v21.3.0-1.21.3-NeoForge" = _saWrB9IS;
        "pkg-v21.4.0-1.21.4-Fabric" = _lYU1OnGi;
        "pkg-v21.4.0-1.21.4-NeoForge" = _tVEeKMAX;
        "pkg-v21.5.0-1.21.5-Fabric" = _Pxwt1BOK;
        "pkg-v21.5.0-1.21.5-NeoForge" = _Ou2qHzhL;
