...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _dsYdyH1i;
        "pkg-0.2.0+1.21" = _ZqEfHqNj;
        "pkg-0.2.0+1.21.2" = _JPSMco8V;
        "pkg-0.3.0+1.21" = _N2rU6JM9;
        "pkg-0.3.0+1.21.2" = _FRSqzHpD;
        "pkg-0.4.0+1.21.2" = _VXzpeLxF;
        "pkg-0.4.0+1.21" = _11L04g8T;
        "pkg-0.5.0+1.21" = _mj6ZpjKp;
        "pkg-0.5.0+1.21.2" = _4ji7eSPQ;
        "pkg-0.6.0+1.21.2" = _IDazHhsd;
        "pkg-0.6.0+1.21.4" = _lrU0L61f;
        "pkg-0.6.0+1.21" = _jemPk2pz;
        "pkg-0.7.0+1.21" = _zM2cBECD;
        "pkg-0.7.0+1.21.4" = _p19fviQM;
        "pkg-0.7.0+1.21.2" = _n0mONVGQ;
        "pkg-0.7.1+1.21.4" = _qWWSicX8;
        "pkg-0.7.1+1.21.2" = _DyS33bIo;
        "pkg-0.7.1+1.21" = _v1gchzmq;
        "pkg-fabric-1.21.3-0.8.0" = _TPi6ra7s;
        "pkg-fabric-1.21.1-0.8.0" = _j5h5ZbsL;
        "pkg-fabric-1.21.4-0.8.0" = _vF86yH9l;
        "pkg-neoforge-1.21.1-0.8.0" = _1tKA5JSU;
        "pkg-fabric-1.21.1-0.8.1" = _iI7iVA6Z;
        "pkg-fabric-1.21.4-0.8.1" = _vzD27bzJ;
        "pkg-neoforge-1.21.1-0.8.1" = _XoAmZAES;
        "pkg-fabric-1.21.3-0.8.1" = _fQZWBVhX;
        "pkg-neoforge-1.21.1-0.9.1" = _zeysSMkO;
        "pkg-fabric-1.21.3-0.9.1" = _yoOeTtnM;
        "pkg-fabric-1.21.4-0.9.1" = _GtRBqQn1;
        "pkg-fabric-1.21.1-0.9.1" = _9K1CulVF;
        "default" = _9K1CulVF;
    });
