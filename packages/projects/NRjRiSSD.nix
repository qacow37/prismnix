...
let
    ...
    in {
        ...
        "pkg-v0.3.0" = _XPnqFCe0;
        "pkg-v0.1.1" = _db1Qa6iF;
        "pkg-v0.3.1" = _NK8mmASH;
        "pkg-v0.3.2" = _uxqIlBiR;
        "pkg-v0.3.3" = _op83jsPA;
        "pkg-v0.3.4" = _bEzJ3d9Y;
        "pkg-v0.3.5" = _y1Kvwhgo;
        "pkg-v0.4.0" = _gPH2ZLuR;
        "pkg-v0.4.1" = _6WxBG7Wn;
        "pkg-v0.5.0" = _tXDxRppV;
        "pkg-v0.5.1" = _RZJVmohY;
        "pkg-v0.5.1-1.18" = _zmzNcLjP;
        "pkg-v0.5.2-1.18" = _Yw3hrc43;
        "pkg-v0.5.2" = _8vFow3y0;
        "pkg-v0.5.3-1.18" = _ju6d51G0;
        "pkg-v0.5.3" = _oZ1QFlkk;
        "pkg-v0.5.4-1.18" = _uvitUbpR;
        "pkg-v0.5.4" = _R4CYPhDX;
        "pkg-v0.6.0" = _S6zlvHPT;
        "pkg-v0.7.0" = _tlLtHh1w;
        "pkg-v0.7.0-1.18" = _fDYPSGrC;
        "pkg-v0.7.0-1.19" = _f12YQRLF;
        "pkg-v0.7.0-1.19.3" = _YtNQP5gX;
        "pkg-v0.8.0-1.19" = _UWqVNxls;
        "pkg-v0.8.0-1.19.x" = _xn2d7ltf;
        "pkg-v0.8.0-1.18.2" = _fn7KiVkh;
        "pkg-v1.0.0" = _lTJY9iYT;
        "pkg-v1.1.0" = _FeW7TYVZ;
        "pkg-v1.1.1" = _kLyFtyv2;
        "pkg-v1.1.2" = _IRQCDoh9;
        "pkg-v1.1.3" = _PPpK82xV;
        "pkg-v1.1.4" = _5eYju5dK;
        "pkg-v1.1.5" = _3w0IxNtk;
        "default" = _3w0IxNtk;
    });
