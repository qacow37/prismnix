...
let
    ...
    in {
        ...
        "pkg-1.19.4-fabric-1.0" = _1wDYQj8O;
        "pkg-1.19.4-forge-1.0" = _ZAdpbr2V;
        "pkg-1.20.1-fabric-1.0" = _7EgUiNBn;
        "pkg-1.20.1-forge-1.0" = _QDYtR5gN;
        "pkg-1.20.2-fabric-1.0" = _oz2RWSrf;
        "pkg-1.20.2-forge-1.0" = _pjUI9Sd2;
        "pkg-1.18.2-fabric-1.0.1" = _KRbFsbiU;
        "pkg-1.18.2-forge-1.0.1" = _1DxxQzlf;
        "pkg-1.19.4-fabric-1.0.1" = _Soh0x33O;
        "pkg-1.19.4-forge-1.0.1" = _QC217Fqm;
        "pkg-1.20.1-fabric-1.0.1" = _CAB2IXvX;
        "pkg-1.20.1-forge-1.0.1" = _vFMTwD7f;
        "pkg-1.20.2-fabric-1.0.1" = _snnouJ4m;
        "pkg-1.20.2-forge-1.0.1" = _QHw9qeBl;
        "pkg-1.16.5-fabric-1.0.1" = _hwf7tBbN;
        "pkg-1.16.5-forge-1.0.1" = _x0D1i06X;
        "pkg-1.16.5-fabric-1.0.2" = _dT5TZzRF;
        "pkg-1.16.5-forge-1.0.2" = _2s7xUWz7;
        "pkg-1.18.2-fabric-1.0.2" = _mhKmijsx;
        "pkg-1.18.2-forge-1.0.2" = _aj6Hr0Kh;
        "pkg-1.19.4-forge-1.0.2" = _OC5nQYcv;
        "pkg-1.20.1-fabric-1.0.2" = _JNWeBNsM;
        "pkg-1.20.1-forge-1.0.2" = _40WebXsp;
        "pkg-1.20.2-fabric-1.0.2" = _32jQjVCj;
        "pkg-1.20.2-forge-1.0.2" = _WkrzEst5;
        "pkg-1.16.5-fabric-1.0.3" = _fA5W0lGp;
        "pkg-1.16.5-forge-1.0.3" = _pziUICQY;
        "pkg-1.18.2-fabric-1.0.3" = _NVRJBH6q;
        "pkg-1.18.2-forge-1.0.3" = _cJlYnAlc;
        "pkg-1.19.4-fabric-1.0.3" = _Gz3Xghda;
        "pkg-1.19.4-forge-1.0.3" = _KixjZpTK;
        "pkg-1.20.1-fabric-1.0.3" = _3RnszYF3;
        "pkg-1.20.1-forge-1.0.3" = _oy3xJU40;
        "pkg-1.20.2-fabric-1.0.3" = _T1ry3a1K;
        "pkg-1.20.2-forge-1.0.3" = _opUzoBDE;
        "pkg-1.16.5-fabric-1.1" = _Hzz7FwvN;
        "pkg-1.16.5-forge-1.1" = _IiXhePTU;
        "pkg-1.18.2-fabric-1.1" = _oqH5naQ9;
        "pkg-1.18.2-forge-1.1" = _YW6v4fSJ;
        "pkg-1.19.4-fabric-1.1" = _UrWsO3SD;
        "pkg-1.19.4-forge-1.1" = _3V5BjwYf;
        "pkg-1.20.1-fabric-1.1" = _TBgGPPMu;
        "pkg-1.20.1-forge-1.1" = _FKjXcAOS;
        "pkg-1.20.2-fabric-1.1" = _yTDqxvzi;
        "pkg-1.20.2-forge-1.1" = _H7zv6dog;
        "pkg-1.20.2-neoforge-1.1" = _kLkxE65d;
        "pkg-2.0+fabric" = _auw4j54t;
        "pkg-2.0+forge" = _cUKVIIBt;
        "pkg-2.0+neoforge" = _7NaXKFSP;
        "pkg-2.1+fabric" = _CYi47LnC;
        "pkg-2.1+forge" = _BPAC4del;
        "pkg-2.1+neoforge" = _8ws2azT2;
        "pkg-1.20.2-fabric-2.1.1" = _QMATSrx2;
        "pkg-1.20.2-forge-2.1.1" = _7oKMgh6d;
        "pkg-1.20.2-neoforge-2.1.1" = _PKrm6mgR;
        "pkg-1.18.2-fabric-2.1.1" = _GFLSUbQX;
        "pkg-1.18.2-forge-2.1.1" = _lLLTMHlR;
        "pkg-1.20.1-fabric-2.1.1" = _KUdHG4JJ;
        "pkg-1.20.1-forge-2.1.1" = _pP5XikBl;
        "pkg-1.19.4-fabric-2.1.1" = _IOvCMdjN;
        "pkg-1.19.4-forge-2.1.1" = _tauhTFmv;
        "default" = _tauhTFmv;
    });
