...
let
    ...
    in {
        ...
        "pkg-0.14.12+1.19.2" = _kHcKnnhr;
        "pkg-0.14.12+1.20.1" = _bfK7P3Ja;
        "pkg-1.0.0+1.20.1" = _wuncu1oK;
        "pkg-1.0.3+1.20.1" = _qYovuT97;
        "pkg-1.0.4+1.20.1" = _O2pi5cE0;
        "pkg-1.0.5+1.20.1" = _VmsNBbCQ;
        "default" = _VmsNBbCQ;
    });
