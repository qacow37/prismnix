...
let
    ...
    in {
        ...
        "pkg-2.1.2-forge-1.18" = _TD6nLqRF;
        "pkg-2.2.0-forge-1.19" = _WMnZYDpI;
        "pkg-2.2.0-fabric-1.19" = _Leq9L11S;
        "pkg-2.2.1-1.18" = _DgnR251n;
        "pkg-2.2.0-1.19.3-fabric" = _bpEtdlup;
        "pkg-2.2.0-1.19.3-forge" = _sbjZTEW2;
        "pkg-2.2.2-1.18" = _OyYEArCd;
        "pkg-2.2.2-1.19.3" = _CCXpyT4U;
        "pkg-2.2.2-1.19.2" = _13BJdNBy;
        "pkg-2.2.3-1.19.3" = _rTyvi7fK;
        "pkg-2.2.3-1.19.4" = _VIJi4c8W;
        "pkg-2.2.3-1.19.2" = _INcc4wk6;
        "pkg-2.2.3-1.18.2" = _HKSZvtE5;
        "pkg-2.2.3-1.20" = _evkvoubL;
        "pkg-2.2.3-1.20.2" = _szmxJfsR;
        "pkg-2.2.4-1.20.1" = _gah8AMuD;
        "pkg-2.2.4-1.20.2" = _sAIjL2oE;
        "pkg-2.3.0" = _1MxqGuyg;
        "pkg-2.3.1" = _GjAM3k6B;
        "pkg-2.3.2" = _qLcRgFeC;
        "pkg-2.3.3" = _eOvU1Dch;
