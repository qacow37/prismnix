...
let
    ...
    in {
        ...
        "pkg-2.3.3-1.12.2" = _Xv5vVaM3;
        "pkg-2.3.3-1.11.2" = _35dLaOXQ;
        "pkg-2.3.3-1.10.2" = _jBQZKCyZ;
        "pkg-2.3.3-1.9.4" = _TJrfwbJx;
        "pkg-2.3.3-1.8.9" = _8hwbLRWC;
        "pkg-2.3.3-1.7.10" = _VtcBnCZB;
        "pkg-2.3.0-1.6.4" = _oSeOifaC;
        "pkg-2.3.4-1.6.4" = _WepcHwuS;
        "pkg-2.3.4-1.7.10" = _9agWWTdt;
        "pkg-2.3.4-1.8.9" = _VzyVZbRU;
        "pkg-2.3.4-1.9.4" = _MlNm35Me;
        "pkg-2.3.4-1.10.2" = _CXKrCNso;
        "pkg-2.3.4-1.11.2" = _UZS5wQCo;
        "pkg-2.3.4-1.12.2" = _RbFQ7u2R;
        "pkg-2.3.5-1.6" = _GMp7SW5c;
        "pkg-2.3.5-1.7" = _HUsfm3UE;
        "pkg-2.3.5-1.8" = _p7hdQ294;
        "pkg-2.3.5-1.9" = _Sqb1HvBO;
        "pkg-2.3.5-1.10" = _TZOfH2dn;
        "pkg-2.3.5-1.11" = _pjL3GDyI;
        "pkg-2.3.5-1.12" = _pe2TALzd;
        "pkg-2.3.6-1.6" = _6lykSSNR;
        "pkg-2.3.6-1.7" = _Wukw2SWV;
        "pkg-2.3.6-1.8" = _yp4aTRTt;
        "pkg-2.3.6-1.9" = _KD3AHi3X;
        "pkg-2.3.6-1.10" = _MXq0DLRM;
        "pkg-2.3.6-1.11" = _H12bgy7a;
        "pkg-2.3.6-1.12" = _W8kS7FQg;
        "pkg-2.4.0-1.6" = _OuRKbR9w;
        "pkg-2.4.0-1.7" = _7pwEENEO;
        "pkg-2.4.0-1.8" = _RwpYS2p4;
        "pkg-2.4.0-1.9" = _86yqUofa;
        "pkg-2.4.0-1.10" = _wWv9CRQb;
        "pkg-2.4.0-1.11" = _Mnebtf33;
        "pkg-2.4.1-1.6" = _L5jzBZDA;
        "pkg-2.4.1-1.7" = _fPvFAVAb;
        "pkg-2.4.1-1.8" = _t761IWye;
        "pkg-2.4.1-1.9" = _SkLZXody;
        "pkg-2.4.1-1.10" = _JqrKXa9z;
        "pkg-2.4.1-1.11" = _gcSRaIpU;
        "pkg-2.4.1-1.12" = _tGK4Yz6y;
        "default" = _tGK4Yz6y;
    });
