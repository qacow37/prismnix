...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.2.0" = _4rH8qFQT;
        "pkg-1.16.5-2.2.1" = _CH0rAVN3;
        "pkg-1.17-2.2.1" = _RGcBylcs;
        "pkg-1.17.1-2.2.2" = _cJEyHFph;
        "pkg-1.17.1-2.2.3" = _1M1GY5Pu;
        "pkg-2.2.4" = _f4xDwftX;
        "pkg-1.18-2.2.5" = _fe8RsOy5;
        "pkg-1.18-2.2.6" = _eBMQRNnq;
        "pkg-1.18.1-2.2.7" = _zhUgm25N;
        "pkg-1.18.2-2.3.0" = _9PFOu6ww;
        "pkg-1.18.2-2.3.1" = _Ic4UuyVU;
        "pkg-1.19-2.4.0" = _kj9CWbvE;
        "pkg-1.19-2.4.1" = _XJAv7ElP;
        "pkg-1.19-2.4.2" = _SJhicF4F;
        "pkg-1.19.1-2.5.0" = _jSCuT4H4;
        "pkg-1.19.1-2.5.1" = _PibWLjqk;
        "pkg-1.19.1-2.5.2" = _IMn468Jg;
        "pkg-1.19.2-2.6.0" = _cS4enerj;
        "pkg-22w43a-2.7.0a1" = _SkCsrrtn;
        "pkg-1.19.3-2.7.0" = _atMpHkci;
        "pkg-1.19.4-2.7.1" = _1QDI6RkU;
        "pkg-1.19.4-2.8.0" = _hXin7WqP;
        "default" = _hXin7WqP;
    });
