...
let
    ...
    in {
        ...
        "pkg-1.16.2+build.0" = _Hiz6JFEt;
        "pkg-1.16.3+build.0" = _Gvcfo9ZT;
        "pkg-1.16.4+build.0" = _LGCOCqel;
        "pkg-1.16.5+build.0" = _4YoPh6aO;
        "pkg-1.17.1+build.0" = _G34vJkRR;
        "pkg-1.18+build.0" = _NjndBLDv;
        "pkg-1.18.1+build.0" = _gOUJBlRt;
        "pkg-1.18.2+build.0" = _1xxIAaHs;
        "pkg-1.19+build.1" = _yV443kTd;
        "pkg-1.19.1+build.0" = _34oSt1Kp;
        "pkg-1.19.2+build.0" = _oSNd1Dww;
        "pkg-1.19.3+build.0" = _FIMinHWq;
        "pkg-1.19.4+build.0" = _CiXSPOjj;
        "pkg-1.16.2+build.2" = _nXf5C312;
        "pkg-1.16.3+build.2" = _7L09pRX7;
        "pkg-1.16.4+build.2" = _RfL1kFYE;
        "pkg-1.16.5+build.2" = _PNcJhCah;
        "pkg-1.17+build.2" = _rXqyjB7a;
        "pkg-1.17.1+build.2" = _eorGYc77;
        "pkg-1.18+build.2" = _OSrEJwAF;
        "pkg-1.18.1+build.2" = _gx1NKuKx;
        "pkg-1.18.2+build.2" = _9o29OwbT;
        "pkg-1.19+build.2" = _bPrZWfMx;
        "pkg-1.19.1+build.1" = _6lZj7f2l;
        "pkg-1.19.2+build.1" = _C2K9UhFi;
        "pkg-1.20+build.0-fabric" = _IaPLbM8r;
        "pkg-1.20+build.0-forge" = _cUpMp0qT;
        "pkg-1.20.1+build.0-forge" = _xqZRz2oA;
        "pkg-1.20.1+build.0-fabric" = _K8pYZu4s;
        "pkg-1.20.2+build.0-fabric" = _1795cO6E;
        "pkg-1.20.3+build.0-fabric" = _O19kHoED;
        "pkg-1.20.4+build.0-fabric" = _W3PqK4ne;
        "pkg-1.20.2+build.0-forge" = _6CChLRDZ;
        "pkg-1.20.3+build.0-forge" = _vKAyeRlt;
        "pkg-1.20.4+build.0-forge" = _v10jan3G;
        "pkg-1.20.5+build.0-fabric" = _vGBcprys;
        "pkg-1.20.6+build.0-fabric" = _rJpR5gxQ;
        "pkg-1.21+build.0-fabric" = _Q52lmnPS;
        "pkg-1.21.4+build.0-fabric" = _P9u0oZgb;
        "pkg-1.21.1+build.0-fabric" = _At4gVNBr;
        "pkg-1.21.2+build.0-fabric" = _pQd5fMvt;
        "pkg-1.21.3+build.0-fabric" = _1pLZ0YXC;
        "pkg-1.20.6+build.0-forge" = _8jt8zfZF;
        "pkg-1.21+build.0-forge" = _6tYwfXIT;
        "pkg-1.21.1+build.0-forge" = _bTgTYCwd;
        "pkg-1.21.3+build.0-forge" = _QuiZYSpG;
        "pkg-1.21.4+build.0-forge" = _qfMGBolM;
        "pkg-1.21.5+build.0-fabric" = _VH397hOp;
        "pkg-1.21.5+build.0-forge" = _L9XQniDW;
        "pkg-1.21.6+build.0-fabric" = _Cajj8BQl;
        "pkg-1.21.7+build.0-fabric" = _DrZTzBjp;
        "pkg-1.21.6+build.0-forge" = _AMkGy8W0;
        "pkg-1.21.7+build.0-forge" = _icLV9uZX;
        "default" = _icLV9uZX;
    });
