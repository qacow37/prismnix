...
let
    ...
    in {
        ...
        "pkg-0.1" = _ZA78MsGi;
        "pkg-0.1+mod" = _xDAjxZZC;
        "pkg-0.1.2" = _1wjeQQCk;
        "pkg-0.1.2+mod" = _JlbtWiJo;
        "pkg-0.1.3" = _F0XLiPLY;
        "pkg-0.1.3+mod" = _GsXhk9El;
        "pkg-0.2" = _JmuD4gsj;
        "pkg-0.2+mod" = _6POK9nZr;
        "pkg-1.0" = _drOsdsTt;
        "pkg-1.0.1" = _szvSUzsb;
        "pkg-1.0.1+mod" = _KiPgWrS1;
        "pkg-1.0.2" = _zdhISasu;
        "pkg-1.0.2+mod" = _kEggsyQm;
        "pkg-1.0.3" = _kBhWJjk9;
        "pkg-1.0.3+mod" = _zS6aISz9;
        "pkg-1.0.3a" = _ofFaXlt3;
        "pkg-1.0.3a+mod" = _62kCUlHN;
        "pkg-1.0.3b" = _Sv7wsksN;
        "pkg-1.0.3b-1.20.1" = _GdzT9hej;
        "pkg-1.0.3b-1.20.4" = _2LsD151s;
        "pkg-1.0.3b-1.21.1" = _8jsINCnz;
        "pkg-1.0.3b-1.21.9" = _GVoYBLu4;
        "default" = _GVoYBLu4;
    });
