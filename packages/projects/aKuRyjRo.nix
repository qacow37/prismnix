...
let
    ...
    in {
        ...
        "pkg-0.11.0" = _CIR6qr1h;
        "pkg-0.11.1" = _1MSAD3qf;
        "pkg-0.11.2" = _FYG7ximj;
        "pkg-0.12.0" = _6QnKTjW9;
        "pkg-0.13.0" = _QmcQusZ1;
        "pkg-0.13.1" = _l48dc2Bu;
        "pkg-0.13.2" = _PxEkwBAv;
        "pkg-0.13.3" = _DHiUXs7r;
        "pkg-0.14.0" = _BDt5quB0;
        "pkg-0.14.1" = _RNr45bF3;
        "pkg-0.14.2" = _uNDZeayu;
        "pkg-0.14.3" = _lwgJnLaT;
        "pkg-0.14.4" = _szLCIVwn;
        "pkg-0.15.0" = _pfxpn0qZ;
        "pkg-0.15.1" = _tYolpOYs;
        "pkg-0.15.2" = _Mlit2lsM;
        "pkg-0.15.3" = _DzIG7a1k;
        "pkg-0.15.4" = _q3k07Z1W;
        "pkg-0.15.5" = _GMqYGYim;
        "pkg-0.15.6" = _8ksmvWWG;
        "pkg-0.15.7" = _A1EbuZNl;
        "pkg-0.16.0" = _BRL6iXcL;
        "pkg-0.16.1" = _SxvfxoAN;
        "pkg-0.16.2" = _WLCqZzIH;
        "default" = _WLCqZzIH;
    });
