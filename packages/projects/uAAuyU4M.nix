...
let
    ...
    in {
        ...
        "pkg-2.0.37.0" = _RtedCL17;
        "pkg-2.0.39.0" = _pzs6Js9T;
        "pkg-2.0.43.0" = _8OGrF79O;
        "pkg-2.0.47.0" = _hktg3Loj;
        "pkg-2.0.48.0" = _kw3AUyPG;
        "pkg-2.0.53.1" = _DWNeAeZX;
        "pkg-2.0.53.2" = _9ZfE2sd2;
        "pkg-2.0.53.0" = _xQxgPHdm;
        "pkg-1.1.4.0-no-attack-reach" = _s8ctr38a;
        "pkg-1.1.4.0" = _cetcvioU;
        "pkg-2.1.11.1" = _1JbmXkDw;
        "pkg-2.1.11.3" = _nHzMQCZu;
        "pkg-2.1.12.0" = _dM4m9KFS;
        "pkg-2.2.0.0" = _TZA78Aw7;
        "pkg-2.3.0.1" = _nvsKN38r;
        "pkg-2.3.0.0" = _sRFiWd3Z;
        "pkg-2.3.1.0" = _IG7OWVjH;
        "pkg-2.4.2.0" = _j4K6gGmD;
        "pkg-2.3.2.0" = _fAYXgFCf;
        "pkg-2.4.4.0" = _u9EEqRye;
        "pkg-2.8.1.0" = _OeYVfLkK;
        "pkg-2.8.2.0" = _z3OGOrEW;
        "pkg-2.8.9.0" = _aCySB8BF;
        "pkg-2.8.13.0" = _vyQr8FTW;
        "pkg-2.8.13.1" = _Brr8TJnP;
        "pkg-2.8.19.0" = _R9G57ESj;
        "pkg-2.9.0.0-alpha.0" = _TWbb4eGZ;
        "pkg-2.9.0.1-alpha.0" = _AkCSiK30;
        "default" = _AkCSiK30;
    });
