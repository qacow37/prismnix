...
let
    ...
    in {
        ...
        "pkg-1.3.1" = _CJn4dn3R;
        "pkg-1.3.2" = _zr3pJkB2;
        "pkg-1.4.0+1.19.3" = _qTgQcB9d;
        "pkg-1.4.0+1.19.4" = _LGUFUlMz;
        "pkg-1.4.1+1.19.4" = _H03Mg6Ww;
        "pkg-1.4.1+1.20-rc1" = _nvNFFQf7;
        "pkg-1.4.2+1.20" = _GfnwrbQ6;
        "pkg-1.4.2+1.20.2" = _hqxpO8Cn;
        "pkg-1.4.3+1.20.2" = _Sq4moNie;
        "pkg-1.5.0+1.20.2" = _zCaugDkd;
        "pkg-1.5.0+1.20.3-rc1" = _JkKyIAwQ;
        "pkg-1.5.1+1.20.4" = _j16IX4Ej;
        "pkg-1.5.2+1.20.1" = _yvTI22nE;
        "pkg-1.5.2+1.20.4" = _DkEyt0Wk;
        "pkg-1.5.3+1.20.1" = _kaQJ7HcN;
        "pkg-1.5.3+1.20.4" = _5WT6TvY5;
        "pkg-1.5.3+1.20.5" = _SOa6RH3N;
        "pkg-1.5.4+1.20.5" = _h5SV8LlU;
        "pkg-1.5.4+1.20.4" = _H4yFnOYs;
        "pkg-1.5.4+1.20.1" = _jtBda3vL;
        "pkg-1.5.5+1.20.6" = _7LNsR9YY;
        "pkg-1.5.5+1.20.1" = _2D19CPkZ;
        "pkg-1.5.5+1.21" = _y1BqkSLJ;
        "pkg-1.5.6+1.21" = _QOHotZWh;
        "pkg-1.5.7+1.21.1" = _ylDKsA7L;
        "pkg-1.5.7+1.21.2-rc2" = _2ecYWOit;
        "pkg-1.5.8+1.21.3" = _PQuYzbZ6;
        "pkg-1.5.9+1.21.3" = _zKnrPVDF;
        "pkg-1.5.9+1.21.1" = _Ss4SvkMR;
        "pkg-1.5.9+1.21.4" = _v24ijRym;
        "pkg-1.5.10+1.21.4" = _7BlRpjCw;
        "pkg-1.5.11+1.21.4" = _NEX7cusQ;
        "pkg-1.5.12+1.21.4" = _sOVWUHwB;
        "pkg-1.5.12+1.21.5-rc1" = _jTTZ3odB;
        "pkg-1.5.12+1.21.5" = _8HYMKPbd;
        "pkg-1.5.13+1.21.5" = _Q8SP5SLv;
        "pkg-1.5.14+1.21.5" = _KFyD9VUi;
        "pkg-1.5.15+1.21.5" = _QuAWeWKt;
        "pkg-1.5.16+1.21.5" = _bc9qLBaj;
        "pkg-1.5.16+1.21.4" = _C2g1H3UU;
        "pkg-1.5.16+1.21.1" = _Gs82Qyea;
        "pkg-1.5.17+1.21.5" = _8KfvHljj;
        "pkg-1.5.17+1.21.4" = _gn7yKBKb;
        "pkg-1.5.17+1.21.1" = _HOFnF6UO;
        "pkg-1.5.18+1.21.4" = _WEw6GTad;
        "pkg-1.5.18+1.21.6-rc1" = _BZxqxDMR;
        "pkg-1.5.19+1.21.7" = _BobOxSL4;
        "pkg-1.5.20+1.21.7" = _FOYmfdQc;
        "pkg-1.5.20+1.21.5" = _zT3zlD2L;
        "pkg-1.5.20+1.21.4" = _DfqajOpC;
        "pkg-1.5.20+1.21.1" = _WJZIEsJn;
        "pkg-1.6.0+1.21.1" = _vE16Wdz7;
        "pkg-1.6.0+1.21.4" = _AnEyqpfw;
        "pkg-1.6.0+1.21.5" = _fBCi6dYR;
        "pkg-1.6.0+1.21.8" = _gigHDcN5;
        "pkg-1.6.1+1.21.1" = _GdHHwWhm;
        "pkg-1.6.1+1.21.4" = _QcjUZtqV;
        "pkg-1.6.1+1.21.5" = _ASpRvzzJ;
        "pkg-1.6.1+1.21.8" = _4DB1ZCab;
        "pkg-1.6.1+1.21.9-rc1" = _TP3a7Lp9;
        "pkg-1.6.1+1.21.10" = _lyeuEsAD;
        "pkg-1.6.2+1.21.1" = _XIdLka8o;
        "pkg-1.6.2+1.21.10" = _cc67BUWK;
        "pkg-1.6.2+1.21.4" = _AeQ7C9tw;
        "pkg-1.6.2+1.21.5" = _5lX9qjEf;
        "pkg-1.6.2+1.21.8" = _K0JcPJO0;
        "pkg-1.6.2+1.21.9" = _isj3kho8;
        "pkg-1.6.2+1.21.11-rc2" = _PWMyd8wn;
        "pkg-1.6.3+1.21.1" = _EgwN3Fqz;
        "pkg-1.6.3+1.21.10" = _x8g6mQPM;
        "pkg-1.6.3+1.21.11" = _mf0a63EP;
        "pkg-1.6.3+1.21.4" = _Vz4JRhaJ;
        "pkg-1.6.3+1.21.5" = _hpeF0ruj;
        "pkg-1.6.3+1.21.8" = _KQpp8HEY;
        "pkg-1.6.3+1.21.9" = _5l0kiYN4;
        "pkg-1.6.4+1.21.1" = _gDsBuWJO;
        "pkg-1.6.4+1.21.10" = _AoUIiePa;
        "pkg-1.6.4+1.21.11" = _3b0nNziz;
        "pkg-1.6.4+1.21.4" = _yfzNGc6b;
        "pkg-1.6.4+1.21.5" = _bBbt7kUR;
        "pkg-1.6.4+1.21.8" = _ClOBd51b;
        "pkg-1.6.4+1.21.9" = _bIvetTr1;
        "pkg-1.6.5+1.21.1" = _swMoSUkl;
        "pkg-1.6.5+1.21.10" = _SCA4IlOy;
        "pkg-1.6.5+1.21.11" = _gBzbLMXr;
        "pkg-1.6.5+1.21.4" = _hwHkNtuo;
        "pkg-1.6.5+1.21.5" = _nIlaPe0k;
        "pkg-1.6.5+1.21.8" = _t0zJCkvQ;
        "pkg-1.6.5+1.21.9" = _i7b6kB1N;
        "pkg-1.6.6+1.21.1" = _DVUQhdeW;
        "pkg-1.6.6+1.21.4" = _zy83W5XS;
        "pkg-1.6.6+1.21.5" = _TAPh6zJT;
        "pkg-1.6.6+1.21.8" = _Z9aamfJN;
        "pkg-1.6.6+1.21.9" = _XCOyRRSP;
        "pkg-1.6.6+1.21.10" = _3yWg9XmU;
        "pkg-1.6.6+1.21.11" = _NpTm6CT2;
        "pkg-1.6.6+26.1" = _iOaEmkPC;
        "pkg-1.6.7+26.1" = _hJditxCw;
        "pkg-1.6.8+1.21.1" = _OZ15lnFQ;
        "pkg-1.6.8+1.21.4" = _DT1liEpq;
        "pkg-1.6.8+1.21.5" = _NrieWy7e;
        "pkg-1.6.8+1.21.8" = _2gNWdEuW;
        "pkg-1.6.8+1.21.9" = _zCAtQMZy;
        "pkg-1.6.8+1.21.10" = _Kvbk6GPu;
        "pkg-1.6.8+1.21.11" = _qjFC7E92;
        "pkg-1.6.8+26.1" = _RjGXZKS5;
        "pkg-1.6.9+1.21.1" = _UsLbfYiJ;
        "pkg-1.6.9+1.21.4" = _1DI62V0s;
        "pkg-1.6.9+1.21.5" = _RTzGpGwH;
        "pkg-1.6.9+1.21.8" = _ORDRp80R;
        "pkg-1.6.9+1.21.9" = _oMY2KOuz;
        "pkg-1.6.9+1.21.10" = _fmP26s6X;
        "pkg-1.6.9+1.21.11" = _Gwr5GCOc;
        "pkg-1.6.9+26.1.2" = _MAfndrvo;
        "pkg-1.6.10+1.21.1" = _4fB7NU1G;
        "pkg-1.6.10+1.21.4" = _W4VSjZX5;
        "pkg-1.6.10+1.21.8" = _BrBWiAla;
        "pkg-1.6.10+1.21.5" = _LopLxcum;
        "pkg-1.6.10+1.21.9" = _57zYQwpU;
        "pkg-1.6.10+26.1.2" = _XQrraERB;
        "pkg-1.6.10+1.21.10" = _3fP5vqTT;
        "pkg-1.6.10+1.21.11" = _rgSQTmDd;
        "pkg-1.6.10+26.2-rc-2" = _4ptiwdSM;
        "pkg-1.6.11+1.21.1" = _5lbRX6JK;
        "pkg-1.6.11+1.21.4" = _kw0Oto0K;
        "pkg-1.6.11+1.21.5" = _aNmYKWtH;
        "pkg-1.6.11+1.21.8" = _JAOltZyL;
        "pkg-1.6.11+1.21.9" = _dPJu9c2L;
        "pkg-1.6.11+1.21.10" = _k0CTnlvO;
        "pkg-1.6.11+1.21.11" = _ZDkD03iD;
        "pkg-1.6.11+26.1.2" = _teCt9iBV;
        "pkg-1.6.11+26.2-rc-2" = _ZUr9FGjL;
        "pkg-1.6.12+1.21.1" = _KIotfbr7;
        "pkg-1.6.12+1.21.4" = _O1Gn0BB2;
        "pkg-1.6.12+1.21.5" = _c8HvSkwC;
        "pkg-1.6.12+1.21.8" = _COoY6Mqy;
        "pkg-1.6.12+1.21.9" = _2TKHGKGR;
        "pkg-1.6.12+1.21.10" = _d6thgZ2W;
        "pkg-1.6.12+1.21.11" = _a5rPrF1e;
        "pkg-1.6.12+26.1.2" = _nQlXDDdG;
        "pkg-1.6.12+26.2" = _MIGXSFm1;
        "pkg-1.6.13+1.21.11" = _I1481Vv8;
        "pkg-1.6.14+1.21.1" = _2uXeDD05;
        "pkg-1.6.14+1.21.4" = _oHys1ZBK;
        "pkg-1.6.14+1.21.5" = _RgAMM6vt;
        "pkg-1.6.14+1.21.8" = _Jb5VhTMg;
        "pkg-1.6.14+1.21.9" = _ZzJDS6WC;
        "pkg-1.6.14+1.21.10" = _fSybkWbE;
        "pkg-1.6.14+1.21.11" = _rO2VTcLQ;
        "pkg-1.6.14+26.1.2" = _unJ5VjgV;
        "pkg-1.6.14+26.2" = _ZtzIuskA;
        "pkg-1.6.15+1.21.1" = _XYTiU7Xy;
        "pkg-1.6.15+1.21.4" = _f7rT9MHy;
        "pkg-1.6.15+1.21.5" = _PFp1iTjs;
        "pkg-1.6.15+1.21.8" = _RBab6k6q;
        "pkg-1.6.15+1.21.9" = _4SlNLx2Y;
        "pkg-1.6.15+1.21.10" = _KX9Djk4B;
