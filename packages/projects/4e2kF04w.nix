...
let
    ...
    in {
        ...
        "pkg-1.0+mc1.18.2" = _cIQyw945;
        "pkg-1.0+mc1.19.2" = _RlQO1V5C;
        "pkg-1.0+mc1.19.4" = _nRutIo01;
        "pkg-1.0+mc1.20.1" = _mb5y7N8Q;
        "pkg-1.0+mc1.20.2" = _5JFUyIXU;
        "pkg-1.1+mc1.18.2" = _k6ZiYpb9;
        "pkg-1.1+mc1.19.2" = _Ho7U6x48;
        "pkg-1.1+mc1.19.4" = _ejvfr86g;
        "pkg-1.1+mc1.20.1" = _pstUmbF0;
        "pkg-1.1+mc1.20.2" = _LXlidxuF;
        "pkg-1.1.1+mc1.18.2" = _yi9qVvck;
        "pkg-1.1.1+mc1.19.2" = _i5JEMZ1d;
        "pkg-1.1.1+mc1.19.4" = _c1j7XoqP;
        "pkg-1.1.1+mc1.20.1" = _Spbn2mch;
        "pkg-1.1.1+mc1.20.2" = _gMy7ZK3f;
        "pkg-1.1.2+mc1.18.2" = _ZOknVgFM;
        "pkg-1.1.2+mc1.19.2" = _WbpSW6B9;
        "pkg-1.1.2+mc1.19.4" = _3bFWqy65;
        "pkg-1.1.2+mc1.20.1" = _nVeqQWgD;
        "pkg-1.1.2+mc1.20.2" = _X3fQw8Y4;
        "pkg-1.1.2+mc1.20.4" = _MimSsWTA;
        "pkg-1.1.3+mc1.19.4" = _CHj34Sjb;
        "pkg-1.1.3+mc1.20.1" = _Ntd97sXm;
        "pkg-1.1.3+mc1.20.2" = _VsFdnHv5;
        "pkg-1.1.3+mc1.20.4" = _9bHrbmnn;
        "pkg-1.1.3+mc1.20.6" = _RDZX4qL6;
        "pkg-1.1.3+mc1.21.1" = _jPvl6wSm;
        "default" = _jPvl6wSm;
    });
