...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.3" = _o9OS6PFH;
        "pkg-1.18.2-1.3" = _bvIbXnUS;
        "pkg-1.16.5-1.4" = _R91naare;
        "pkg-1.18.2-1.4" = _Estw097X;
        "pkg-1.19.2-1.0" = _YBhfqUSr;
        "pkg-1.18.2-1.6" = _1iWgks3a;
        "pkg-1.16.5-1.6" = _rkwGGtLZ;
        "pkg-1.19.2-1.2" = _IdvjuQLv;
        "pkg-1.20.1-1.0" = _9W1diyY6;
        "pkg-1.20.1-1.1" = _bDdZjHWa;
        "pkg-1.16.5-1.0" = _CmpUFfu5;
        "pkg-1.18.2-1.0" = _NCAE6IxE;
        "pkg-1.16.5-1.1" = _uvcdHtMh;
        "pkg-1.18.2-1.1" = _ij82OSE0;
        "pkg-1.19.2-1.1" = _t4o7Xmim;
        "pkg-1.16.5-1.2" = _TmxtjZRF;
        "pkg-1.16.5-1.2.1" = _tVIHBj2H;
        "pkg-1.18.2-1.2" = _uWcksw7u;
        "pkg-1.20.1-1.2" = _e42SPN5h;
        "pkg-1.21.1-1.2" = _8WziXPA4;
        "pkg-1.19.2-1.3" = _LsWANd8Q;
        "pkg-1.21.1-1.2.1" = _oz99BrV0;
        "pkg-1.21.1-1.4" = _v0TXPgT6;
        "pkg-1.21.1-1.4.1" = _zC8rJHh1;
        "pkg-1.20.1-1.4" = _BWNcP94k;
        "pkg-1.19.2-1.4" = _knic5Ynn;
        "pkg-1.16.5-1.5" = _azQjxN0d;
        "pkg-1.16.5-1.5.1" = _HPb4pkEW;
        "pkg-1.18.2-1.5" = _TnJBdO2A;
        "pkg-1.19.2-1.5" = _AEGXmlW5;
        "pkg-1.20.1-1.5" = _2OPsXUqn;
        "pkg-1.21.1-1.5" = _4HtPir2S;
        "pkg-1.16.5-1.5.2" = _EMsnAh1Z;
        "pkg-1.18.2-1.5.1" = _uClNphPC;
        "pkg-1.19.2-1.5.1" = _K38fwKA8;
        "pkg-1.21.1-1.6" = _qWPunfMh;
        "pkg-1.20.1-1.6" = _Hr94akPS;
        "pkg-1.19.2-1.6" = _c8YLVJnr;
        "default" = _rkwGGtLZ;
    });
