...
let
    ...
    in {
        ...
        "pkg-1.1.8" = _cBvXKAUE;
        "pkg-1.2.1" = _lyQVzQlq;
        "pkg-1.1.10" = _P78wsWOK;
        "pkg-1.1.11" = _o9c8BfUr;
        "pkg-fabric-2.0.0" = _KJQ0uLWH;
        "pkg-forge-2.0.0" = _yxzyC1VT;
        "pkg-neoforge-2.0.0" = _ADe9o8wZ;
        "pkg-fabric-1.20.1-2.0.1" = _eBwMs2Z0;
        "pkg-forge-1.20.1-2.0.1" = _xyGmZ08i;
        "pkg-fabric-1.21.1-2.0.1" = _skObcpeb;
        "pkg-neoforge-1.21.1-2.0.1" = _1mCoVeVP;
        "pkg-fabric-1.21.4-2.0.1" = _Ny7aln7p;
        "pkg-neoforge-1.21.4-2.0.1" = _xP9OSet8;
        "pkg-fabric-1.20.1-2.0.2" = _VqRfLaJU;
        "pkg-fabric-1.21.1-2.0.2" = _3aeGKHAN;
        "pkg-forge-1.20.1-2.0.2" = _4pKpMr7O;
        "pkg-neoforge-1.21.1-2.0.2" = _glis8Dmo;
        "pkg-fabric-1.21.4-2.0.2" = _gh1F1ofF;
        "pkg-neoforge-1.21.4-2.0.2" = _nYB3FYZw;
        "pkg-fabric-1.20.1-2.0.3" = _6nGxAp9G;
        "pkg-fabric-1.21.1-2.0.3" = _KGaRX5wN;
        "pkg-forge-1.20.1-2.0.3" = _AzDLzvD9;
        "pkg-fabric-1.21.4-2.0.3" = _SFljBxol;
        "pkg-neoforge-1.21.1-2.0.3" = _9ovNy5Py;
        "pkg-neoforge-1.21.4-2.0.3" = _rJzL6Vgv;
        "pkg-forge-1.20.1-2.0.4" = _IJIItvCp;
        "pkg-fabric-1.21.1-2.0.4" = _H3VqHweG;
        "pkg-fabric-1.20.1-2.0.4" = _HbW6fXMJ;
        "pkg-neoforge-1.21.1-2.0.4" = _A3pYq3bS;
        "pkg-fabric-1.21.4-2.0.4" = _Z1OdghOR;
        "pkg-neoforge-1.21.4-2.0.4" = _5tI2F2YV;
        "pkg-fabric-1.20.1-2.0.5" = _POA5WX2B;
        "pkg-forge-1.20.1-2.0.5" = _b6cf1hOI;
        "pkg-fabric-1.21.1-2.0.5" = _ttBzGhcE;
        "pkg-fabric-1.21.4-2.0.5" = _MIS3wncz;
        "pkg-neoforge-1.21.1-2.0.5" = _dCCjHyWH;
        "pkg-neoforge-1.21.4-2.0.5" = _zVwZJVgD;
        "pkg-forge-1.20.1-2.0.8" = _JG4UweiV;
        "pkg-neoforge-1.21.1-2.0.8" = _P0q1DnjI;
        "pkg-fabric-1.20.1-2.0.8" = _VD8ESTOp;
        "pkg-fabric-1.21.1-2.0.8" = _6J9whYRN;
        "pkg-fabric-1.21.4-2.0.8" = _X3cewb7W;
        "pkg-neoforge-1.21.4-2.0.8" = _bXA7kL52;
        "pkg-forge-1.20.1-2.0.9" = _FAWIPQ6X;
        "pkg-neoforge-1.21.1-2.0.9" = _5A6HAblL;
        "pkg-fabric-1.21.1-2.0.9" = _JwIu18G0;
        "pkg-fabric-1.20.1-2.0.9" = _D4ityaCu;
        "pkg-fabric-1.21.4-2.0.9" = _EECkNWGI;
        "pkg-neoforge-1.21.4-2.0.9" = _LeLDiuwS;
        "pkg-fabric-1.20.1-2.0.10" = _hIaQB0rp;
        "pkg-forge-1.20.1-2.0.10" = _qPD9biSZ;
        "pkg-neoforge-1.21.1-2.0.10" = _fojmObe4;
        "pkg-fabric-1.21.1-2.0.10" = _ckKARzNr;
        "pkg-fabric-1.21.4-2.0.10" = _TR9AyOJr;
        "pkg-neoforge-1.21.4-2.0.10" = _EXFXvNL2;
        "pkg-fabric-1.20.1-2.0.11" = _39vEVJvD;
        "pkg-forge-1.20.1-2.0.11" = _2PmHn5We;
        "pkg-fabric-1.21.4-2.0.11" = _nFBTHflj;
        "pkg-neoforge-1.21.1-2.0.11" = _RcomQRyX;
        "pkg-fabric-1.21.1-2.0.11" = _LTDvcYpS;
        "pkg-neoforge-1.21.4-2.0.11" = _QCF68Z7p;
        "pkg-fabric-1.20.1-2.0.13" = _aFHOzHgi;
        "pkg-forge-1.20.1-2.0.13" = _q9A511XL;
        "pkg-fabric-1.21.1-2.0.13" = _PRXEXoMk;
        "pkg-neoforge-1.21.1-2.0.13" = _EZ8mqdyO;
        "pkg-fabric-1.21.4-2.0.13" = _cuTT5cEo;
        "pkg-neoforge-1.21.4-2.0.13" = _GjK4gipS;
        "pkg-fabric-1.21.1-2.0.14" = _XErkUu1G;
        "pkg-fabric-1.20.1-2.0.14" = _xiXaUN87;
        "pkg-forge-1.20.1-2.0.14" = _AE85XxgI;
        "pkg-fabric-1.21.4-2.0.14" = _EPNtPty8;
        "pkg-neoforge-1.21.1-2.0.14" = _2Xjm9ZKL;
        "pkg-neoforge-1.21.4-2.0.14" = _W7h9ypCq;
        "pkg-forge-1.20.1-2.0.15" = _rwhPNdtf;
        "pkg-fabric-1.21.1-2.0.15" = _Jj4pcn17;
        "pkg-fabric-1.20.1-2.0.15" = _r6LZJhDx;
        "pkg-neoforge-1.21.1-2.0.15" = _D6to000r;
        "pkg-fabric-1.21.4-2.0.15" = _1LimIol3;
        "pkg-neoforge-1.21.4-2.0.15" = _zhZmmH0h;
        "pkg-fabric-1.20.1-2.0.16" = _PcpK1I3U;
        "pkg-forge-1.20.1-2.0.16" = _7p6vL0W7;
        "pkg-neoforge-1.21.1-2.0.16" = _b3dmdv2e;
        "pkg-fabric-1.21.1-2.0.16" = _H8aKhDPa;
        "pkg-fabric-1.21.4-2.0.16" = _UUUaEylg;
        "pkg-neoforge-1.21.4-2.0.16" = _eU43vVyI;
        "pkg-fabric-1.20.1-2.0.17" = _KhzdLidX;
        "pkg-forge-1.20.1-2.0.17" = _nb0qghjO;
        "pkg-fabric-1.21.1-2.0.17" = _ZOkRjHGT;
        "pkg-fabric-1.21.4-2.0.17" = _kLrIoI9Q;
        "pkg-neoforge-1.21.1-2.0.17" = _nUPW7ei6;
        "pkg-neoforge-1.21.4-2.0.17" = _cpBCipEy;
        "pkg-fabric-1.20.1-2.1.0" = _4Lykd0oh;
        "pkg-forge-1.20.1-2.1.0" = _1gITSzpT;
        "pkg-neoforge-1.21.1-2.1.0" = _Fe2cCF2P;
        "pkg-fabric-1.21.10-2.1.0" = _WB9klqh9;
        "pkg-fabric-1.21.1-2.1.0" = _Ntl5Jha6;
        "pkg-neoforge-1.21.10-2.1.0" = _6K7zQtpK;
        "pkg-fabric-1.21.4-2.1.0" = _oBMSVSLR;
        "pkg-neoforge-1.21.4-2.1.0" = _QOsDvnSo;
        "pkg-fabric-1.21.8-2.1.0" = _oPJdzRum;
        "pkg-neoforge-1.21.8-2.1.0" = _CdPJZLb7;
        "pkg-fabric-1.20.1-2.1.2" = _7ID070gQ;
        "pkg-fabric-1.21.1-2.1.2" = _GJfAiGSm;
        "pkg-neoforge-1.21.1-2.1.2" = _p33aqAKW;
        "pkg-forge-1.20.1-2.1.2" = _OIFDZVTT;
        "pkg-neoforge-1.21.4-2.1.2" = _f7pPB2ek;
        "pkg-neoforge-1.21.10-2.1.2" = _1wmfJlWu;
        "pkg-fabric-1.21.4-2.1.2" = _4ctK1X2K;
        "pkg-fabric-1.21.8-2.1.2" = _johV6zZD;
        "pkg-fabric-1.21.10-2.1.2" = _2i7k54d0;
        "pkg-neoforge-1.21.8-2.1.2" = _10ueOD6k;
        "pkg-neoforge-1.21.1-2.1.3" = _kYma4CqO;
        "pkg-fabric-1.20.1-2.1.3" = _9i2OW2Dg;
        "pkg-fabric-1.21.1-2.1.3" = _6wp7Xsdp;
        "pkg-forge-1.20.1-2.1.3" = _u4b4JMQ2;
        "pkg-fabric-1.21.10-2.1.3" = _N3DfdrH1;
        "pkg-neoforge-1.21.10-2.1.3" = _tTzVbgQQ;
        "pkg-neoforge-1.21.8-2.1.3" = _NyyTr5Wl;
        "pkg-neoforge-1.21.4-2.1.3" = _KIkEotTT;
        "pkg-fabric-1.21.8-2.1.3" = _l5sFNfJj;
        "pkg-fabric-1.21.4-2.1.3" = _B2TN1h1w;
        "pkg-neoforge-1.21.8-2.1.4" = _zLHwsBeJ;
        "pkg-fabric-1.21.1-2.1.5" = _4NKWsfN3;
        "pkg-fabric-1.20.1-2.1.5" = _8H3NRm4Z;
        "pkg-neoforge-1.21.1-2.1.5" = _IuP2RD4x;
        "pkg-fabric-1.21.10-2.1.5" = _YKduazRC;
        "pkg-forge-1.20.1-2.1.5" = _404miqEQ;
        "pkg-neoforge-1.21.10-2.1.5" = _SQi7yIqo;
        "pkg-fabric-1.21.11-2.1.5" = _906jiSSC;
        "pkg-neoforge-1.21.11-2.1.5" = _tIJjgtin;
        "pkg-fabric-1.21.4-2.1.5" = _zr9ErBI3;
        "pkg-fabric-1.21.8-2.1.5" = _SlUlDxsl;
        "pkg-neoforge-1.21.4-2.1.5" = _Fy93MR7e;
        "pkg-neoforge-1.21.8-2.1.5" = _cDjplDos;
        "pkg-fabric-1.21.1-2.1.6" = _aDqZ7vy2;
        "pkg-fabric-1.20.1-2.1.6" = _AzyLl0Eo;
        "pkg-neoforge-1.21.1-2.1.6" = _F4HifhPU;
        "pkg-fabric-1.21.10-2.1.6" = _MoBjviFg;
        "pkg-forge-1.20.1-2.1.6" = _nAjq31SK;
        "pkg-neoforge-1.21.10-2.1.6" = _okgsc2xE;
        "pkg-fabric-1.21.11-2.1.6" = _J19EC39o;
        "pkg-fabric-1.21.4-2.1.6" = _eTVKUgpr;
        "pkg-neoforge-1.21.11-2.1.6" = _sbu0SSFg;
        "pkg-neoforge-1.21.4-2.1.6" = _ogwux2aj;
        "pkg-fabric-1.21.8-2.1.6" = _p0mMsda0;
        "pkg-neoforge-1.21.8-2.1.6" = _7Nndc0DK;
        "pkg-fabric-1.20.1-2.1.7" = _kJj2QwTY;
        "pkg-forge-1.20.1-2.1.7" = _aKoSukCp;
        "pkg-fabric-1.20.1-2.2.0" = _XHvG1FpA;
        "pkg-fabric-1.21.1-2.2.0" = _WzVU77xK;
        "pkg-neoforge-1.21.1-2.2.0" = _T4VXxkNe;
        "pkg-fabric-1.21.10-2.2.0" = _w1fc9oVq;
        "pkg-forge-1.20.1-2.2.0" = _wzv9dD6L;
        "pkg-neoforge-1.21.10-2.2.0" = _wrftu5GU;
        "pkg-fabric-1.21.11-2.2.0" = _egpfQNqB;
        "pkg-neoforge-1.21.11-2.2.0" = _6w480u92;
        "pkg-fabric-1.21.4-2.2.0" = _lUDsTWMi;
        "pkg-neoforge-1.21.4-2.2.0" = _1VLs4C4W;
        "pkg-fabric-1.21.8-2.2.0" = _zC0WLbYt;
        "pkg-neoforge-1.21.8-2.2.0" = _ExpKOl1P;
        "pkg-neoforge-26.1.2-2.2.0" = _vC36zvGi;
        "default" = _vC36zvGi;
    });
