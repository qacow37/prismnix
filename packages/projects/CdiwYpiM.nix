...
let
    ...
    in {
        ...
        "pkg-Forge1.20.1-1.0.0" = _oPPag7Ci;
        "pkg-Forge1.16.5-1.0.0" = _7IR5vXCd;
        "pkg-Forge1.18.2-1.0.0" = _tJ4YJfxl;
        "pkg-Forge1.19.2-1.0.0" = _425bd4lx;
        "pkg-Forge1.19.4-1.0.0" = _O96nJvGP;
        "pkg-Forge1.20.2-1.0.0" = _G8CBxkaP;
        "pkg-Forge1.20.4-1.0.0" = _JUHxYrTZ;
        "pkg-Forge1.20.6-1.0.0" = _aQUkwf4p;
        "pkg-Forge1.21.0-1.0.0" = _TyYaE5lG;
        "pkg-Forge1.21.1-1.0.0" = _Qy9zmXMW;
        "pkg-Forge1.21.3-1.0.0" = _27yqHNtI;
        "pkg-Forge1.12.2-1.0.0" = _YJHcrXuI;
        "pkg-Fabric1.16.5-1.0.0" = _XWnp3BYX;
        "pkg-Fabric1.18.2-1.0.0" = _jm4rLcCv;
        "pkg-Fabric1.19.2-1.0.0" = _wp0H0kGY;
        "pkg-Fabric1.19.4-1.0.0" = _TQMswN4t;
        "pkg-Fabric1.20.1-1.0.0" = _iMFu2hLU;
        "pkg-Fabric1.20.2-1.0.0" = _2I2RpN4I;
        "pkg-Fabric1.20.4-1.0.0" = _uESBVLsX;
        "pkg-Fabric1.20.6-1.0.0" = _Cnw3oR1B;
        "pkg-Fabric1.21.0-1.0.0" = _5GKArvBM;
        "pkg-Fabric1.21.1-1.0.0" = _CNBsy0y8;
        "pkg-Fabric1.21.3_1.0.0" = _lNiaBisc;
        "pkg-Forge1.21.11-1.0.0" = _bnmEjdSH;
        "pkg-Fabric1.21.11-1.0.0" = _btUhe8uw;
        "default" = _btUhe8uw;
    });
