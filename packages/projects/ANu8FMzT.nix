...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _IJTt4zQP;
        "pkg-1.1.0" = _GSwBKZXi;
        "pkg-1.1.0.17" = _BZYeJ9HU;
        "pkg-1.1.0.17.1" = _WXsi6isy;
        "pkg-1.1.0.18" = _78KZ8Njx;
        "pkg-1.2.0-fabric-1.18.2" = _fpGGPyXa;
        "pkg-1.2.1-fabric-1.19.2" = _BmkQvxAR;
        "pkg-1.2.0-forge-1.18.2" = _O2HoPAbg;
        "pkg-1.2.1-forge-1.19.2" = _zBXgN335;
        "pkg-1.2.1-forge-1.4.7" = _tsyuXzgd;
        "pkg-1.2.1-forge-1.7.10" = _lHVuV2gz;
        "pkg-2-fabric-1.16.5" = _3JsrWfEJ;
        "pkg-2-fabric-1.17.1" = _P4X6gK8q;
        "pkg-2-fabric-1.18.2" = _Z7o4GTEi;
        "pkg-2-fabric-1.19.2" = _hBY8w3YG;
        "pkg-2-fabric-1.19.4" = _RgijDnnD;
        "pkg-2-forge-1.4.7" = _VFSqfR5G;
        "pkg-2-forge-1.7.10" = _AQXWbLzp;
        "pkg-2-forge-1.12.2" = _JRTa691x;
        "pkg-2-forge-1.16.5" = _AxtkyMHC;
        "pkg-2-forge-1.17.1" = _Hpu7PXzI;
        "pkg-2-forge-1.18.2" = _CmZbglOG;
        "pkg-2-forge-1.19.2" = _yiwPxAnf;
        "pkg-2-forge-1.19.4" = _EioTS1Ee;
        "pkg-2.0.2-fabric-1.20.0" = _URkujonb;
        "pkg-2.0.2-forge-1.20" = _uMND9RVO;
        "pkg-2.0.3-forge-1.4.7" = _HjCQxJk6;
        "pkg-2.0.3-forge-1.7.10" = _dtdHfhnx;
        "pkg-2.0.4" = _kUS3Shex;
        "pkg-2.0.4-forge-1.20.1" = _3EcZwgdH;
        "pkg-2.0.5-fabric-1.16.5" = _JTVgDBXQ;
        "pkg-2.0.5-fabric-1.17.1" = _3gtQEhvX;
        "pkg-2.0.5-fabric-1.18.2" = _aNsmkHWz;
        "pkg-2.0.5-fabric-1.19.2" = _ZWTDL7Qp;
        "pkg-2.0.5-fabric-1.19.4" = _usi11VXY;
        "pkg-2.0.5-fabric-1.20.1" = _FxNms32N;
        "pkg-2.0.5-forge-1.12.2" = _XUWEcpA8;
        "pkg-2.0.5-forge-1.16.5" = _j1oqtzV7;
        "pkg-2.0.5-forge-1.17.1" = _J1rzyacW;
        "pkg-2.0.5-forge-1.18.2" = _ahKcFJZy;
        "pkg-2.0.5-forge-1.19.2" = _7maJtuGd;
        "pkg-2.0.5-forge-1.19.4" = _ncJjXbFD;
        "pkg-2.0.5-forge-1.20.1" = _gh8nQFjW;
        "pkg-2.1-fabric-1.16.5" = _9vj6NIsC;
        "pkg-2.1-fabric-1.17.1" = _HdIYxYFy;
        "pkg-2.1-fabric-1.18.2" = _Vb0x37U9;
        "pkg-2.1-fabric-1.19.2" = _S5GRifqT;
        "pkg-2.1-fabric-1.19.4" = _G0XH0ads;
        "pkg-2.1-fabric-1.20.1" = _s2FOydlN;
        "pkg-2.1-forge-1.12.2" = _TVSYu2oQ;
        "pkg-2.1-forge-1.16.5" = _OUN5madY;
        "pkg-2.1-forge-1.17.1" = _UTHnEu1q;
        "pkg-2.1-forge-1.18.2" = _rK5KFGk4;
        "pkg-2.1-forge-1.19.2" = _doKcqkNi;
        "pkg-2.1-forge-1.19.4" = _abMkukKB;
        "pkg-2.1-forge-1.20.1" = _m8X9EICJ;
        "pkg-2.2-forge-1.12.2" = _1c6QDx08;
        "pkg-2.2-neo-1.21.1" = _o2kINZoC;
        "pkg-2.2-fabric-1.21.1" = _4I4nAyGY;
        "pkg-2.2-fabric-1.21.5" = _SSKWyH1B;
        "pkg-2.2-neo-1.21.5" = _2470Lm5o;
        "pkg-2.3-forge-1.12.2" = _JclddCSX;
        "default" = _JclddCSX;
    });
