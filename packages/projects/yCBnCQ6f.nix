...
let
    ...
    in {
        ...
        "pkg-1.21.0-1.3-fabric+forge+neo" = _7fz7MpVy;
        "pkg-1.21.0-1.4-fabric+forge+neo" = _NkLaaqN0;
        "pkg-1.21.0-1.5-fabric+forge+neo" = _iWVGjXSF;
        "pkg-1.21.0-1.6-fabric+forge+neo" = _oQW0gAuJ;
        "pkg-1.21.0-1.7-fabric+forge+neo" = _ukuOCsMZ;
        "pkg-1.21.0-1.8-fabric+forge+neo" = _gtF17wYl;
        "pkg-1.21.1-1.8-fabric+forge+neo" = _EyK0mwQ1;
        "pkg-1.21.2-1.8-fabric+neo" = _VWqutDWQ;
        "pkg-1.21.2-1.9-fabric+neo" = _kAW7w49F;
        "pkg-1.21.2-2.0-fabric+neo" = _suaaz7aC;
        "pkg-1.21.3-2.0-fabric+forge+neo" = _D8mMeNUG;
        "pkg-1.21.4-2.0-fabric+forge+neo" = _lGhQxJJP;
        "pkg-1.21.4-2.1-fabric+forge+neo" = _zSbIWWkw;
        "pkg-1.21.5-2.1-fabric+forge+neo" = _5VBZCQGs;
        "pkg-1.21.6-2.1-fabric+forge+neo" = _L0Q4SFeA;
        "pkg-1.21.7-2.1-fabric+forge+neo" = _Qc5uKXm6;
        "pkg-1.21.8-2.1-fabric+forge+neo" = _ai3WVHUb;
        "pkg-1.21.9-2.1-fabric+forge+neo" = _skeSlDB6;
        "pkg-1.21.9-2.2-fabric+forge+neo" = _1m0DAPEp;
        "pkg-1.21.10-2.2-fabric+forge+neo" = _MojN9eE9;
        "pkg-1.21.11-2.2-fabric+forge+neo" = _FKpwdE5X;
        "pkg-26.1.0-2.2-fabric+forge+neo" = _sHFxySZ7;
