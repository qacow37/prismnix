...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _6nmYGIEl;
        "pkg-1.9.2" = _m7kTTUzJ;
        "pkg-1.9.3.1" = _T4gSwufw;
        "pkg-1.9.4" = _nmuRQqrU;
        "pkg-1.9.4.1" = _ApjYghIV;
        "pkg-1.10.0" = _r67NOV1R;
        "pkg-1.10.1" = _S36MimWL;
        "pkg-1.10.2" = _th8NSM7J;
        "pkg-1.10.3" = _OdhuXQg9;
        "pkg-1.11.0" = _B6WaT4Pj;
        "pkg-1.11.0.1" = _aF8kQIEn;
        "pkg-1.11.1" = _OnKgsVNf;
        "pkg-1.11.2" = _5eMEFa4n;
        "pkg-1.11.2.1" = _WB3UbNOC;
        "pkg-1.11.3" = _3zZqL7RP;
        "pkg-1.12.0" = _qCQptsZK;
        "pkg-1.12.1" = _EPXwtDKD;
        "pkg-1.12.2" = _HvXGE3IZ;
        "pkg-1.12.3" = _geLd1Ddn;
        "pkg-1.12.7" = _yxhUKiXD;
        "pkg-1.12.8" = _b625baJp;
        "default" = _b625baJp;
    });
