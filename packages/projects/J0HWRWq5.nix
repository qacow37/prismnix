...
let
    ...
    in {
        ...
        "pkg-1.4.22" = _aFhnM4JC;
        "pkg-1.4.23" = _j1Ms9lMK;
        "pkg-1.4.24" = _GeUCAKH9;
        "pkg-1.4.25" = _QNLOBmL6;
        "pkg-1.4.26" = _H02lMtci;
        "pkg-1.5.0" = _BdWdAfae;
        "pkg-1.5.1" = _VsTfeHtU;
        "pkg-1.5.2" = _oPQUu2Od;
        "pkg-1.5.3" = _Fs0yedkn;
        ...
        "pkg-1.5.8" = _I5C3WFxA;
        "pkg-1.5.9" = _NVLyUkbm;
        "pkg-1.5.10" = _5vIS9qSi;
        "pkg-1.5.11" = _yGkYnDuy;
        "pkg-1.5.12" = _Dcp2wjNO;
        "pkg-1.5.13" = _8iTMiHy8;
        "pkg-1.5.14" = _wVBtcNa0;
        "pkg-1.5.15" = _OHoWnYP4;
        "pkg-1.5.16" = _ee8nR7zq;
        "pkg-1.5.17" = _W2CPDf6s;
        "pkg-1.5.18-beta.1" = _mkudWAHj;
        "pkg-1.5.18-beta.2" = _KtjyCofJ;
        "pkg-1.5.18-beta.3" = _fUXpg1HS;
        "pkg-1.5.18-beta.4" = _kGIy3HZ2;
        "pkg-1.5.18" = _l904v8hB;
        "pkg-1.5.19" = _kfmhDj35;
        "pkg-1.5.20" = _wskq5cR3;
        "pkg-1.5.21" = _3v81Re1B;
        "pkg-1.5.22" = _IwOMcx61;
        "pkg-1.5.23-beta.1" = _AbMe7DTu;
        "pkg-1.5.23" = _bzD98i8j;
        "pkg-1.5.24" = _XxvrhFFD;
        "pkg-1.5.25" = _hvLkDkPE;
        "pkg-1.5.26" = _MqWyGh84;
        "pkg-1.5.43" = _tSJSjtjE;
        "default" = _tSJSjtjE;
    });
