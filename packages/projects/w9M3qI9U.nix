...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.19.4" = _UNKbISR3;
        "pkg-0.2.0+1.19.4" = _mmL9730Z;
        "pkg-0.3.0+1.20" = _czEZKykE;
        "pkg-0.3.0+1.20.3" = _JD29PYKO;
        "pkg-0.3.0+1.20.5" = _jL6gfQyC;
        "pkg-0.3.1+1.20" = _o3k9E8pR;
        "pkg-0.3.1+1.20.3" = _9TS1ADw2;
        "pkg-0.3.1+1.20.5" = _7eupfwFS;
        "pkg-0.3.2+1.20" = _CIasNTg1;
        "pkg-0.3.2+1.20.3" = _vfIKAu4b;
        "pkg-0.3.2+1.20.5" = _SUxEEPs5;
        "pkg-0.3.3+1.20" = _qmgMN6Ka;
        "pkg-0.3.3+1.20.3" = _pwc6NO1c;
        "pkg-0.3.3+1.20.5" = _J7ieNi3w;
        "pkg-0.3.3+1.21" = _9zAsFI73;
        "pkg-0.3.4+1.20" = _hxXbQyXF;
        "pkg-0.3.4+1.20.3" = _hqYWiOnw;
        "pkg-0.3.4+1.20.5" = _1zaRlDQ3;
        "pkg-0.3.4+1.21" = _GaQHDqHn;
        "pkg-0.4.0+1.21" = _8xGqR04P;
        "pkg-0.4.1+1.21" = _ADTb0JkS;
        "pkg-0.4.2+1.21" = _bJkBBdWA;
        "pkg-0.5.0+1.20.5" = _b3tKOemP;
        "pkg-0.5.0+1.20.3" = _Ck924367;
        "pkg-0.5.0+1.20" = _tb4yWdn0;
        "pkg-0.5.0+1.21" = _MGOeyMhM;
        "default" = _MGOeyMhM;
    });
