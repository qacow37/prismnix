...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.18.x-forge" = _POIJXTaD;
        "pkg-1.0.0-1.19.x-forge" = _h1pPOyzb;
        "pkg-1.0.0-1.19.x-fabric" = _cD9kzlqq;
        "pkg-1.0.0-1.18.x-fabric" = _Gbo3vjbR;
        "pkg-1.0.0-1.16.5-forge" = _ct6t8Jhn;
        "pkg-1.0.0-1.16.5-fabric" = _6Q0S6Vgu;
        "pkg-1.0.1-1.16.5-forge" = _XBrK3Z1R;
        "pkg-1.0.1-1.16.5-fabric" = _CRbpqcTq;
        "pkg-1.0.1-1.18.x-fabric" = _wfq8oEU2;
        "pkg-1.0.1-1.19.x-fabric" = _L7xJn1yn;
        "pkg-1.0.1-1.18.x-forge" = _XSvgMQlw;
        "pkg-1.0.1-1.19.x-forge" = _tv7UEaRY;
        "pkg-mc1.16.5-v1.0.0-forge" = _fH0W8XkZ;
        "pkg-mc1.16.5-v1.0.0-fabric" = _INQyGucq;
        "pkg-mc1.18.x-v1.0.0-fabric" = _MvtlRKAn;
        "pkg-mc1.18.x-v1.0.0-forge" = _YlgdD2Sx;
        "pkg-mc1.18.x-v1.0.0-quilt" = _UInxTJj4;
        "pkg-mc1.19.x-v1.0.0-fabric" = _eZAgIYHM;
        "pkg-mc1.19.x-v1.0.0-forge" = _l5XMbQno;
        "pkg-mc1.19.x-1.0.0-quilt" = _XlwITMBg;
        "pkg-mc1.16.5-1.0.0hotfix1-forge" = _wsBGhd7v;
        "pkg-mc1.18.x-1.0.1-forge" = _BbyqP73r;
        "pkg-mc1.18.x-1.0.1-fabric" = _Zl4zxB06;
        "pkg-1.1.0+1.18.2-fabric" = _vBTeOiWa;
        "pkg-1.1.0+1.18.2-forge" = _KMSeFbOv;
        "pkg-1.1.0+1.19.2-fabric" = _XuWujELP;
        "pkg-1.1.0+1.19.2-forge" = _mB3k2VSo;
        "pkg-1.1.0+1.16.5-fabric" = _o5Z6rDJ2;
        "pkg-1.1.0+1.16.5-forge" = _ZCzpJ4zU;
        "pkg-1.0.0+1.20.1-forge" = _HAnUuieU;
        "pkg-1.0.0+1.20.1-fabric" = _qb3sCBNn;
        "default" = _qb3sCBNn;
    });
