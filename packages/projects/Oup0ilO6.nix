...
let
    ...
    in {
        ...
        "pkg-2.0.4-MC1.19.4" = _kQuenA8E;
        "pkg-2.0.4-MC1.20.1" = _tdcOXGp6;
        "pkg-2.0.5-MC1.19.4" = _PLdHRDq7;
        "pkg-2.0.5-MC1.20.1" = _sAFaBS5O;
        "pkg-2.0.6-MC1.19.4" = _6ohjLflZ;
        "pkg-2.0.6-MC1.20.1" = _m2KEQ6XR;
        "pkg-2.0.7-MC1.19.4" = _xXKMqb0A;
        "pkg-2.0.7-MC1.20.1" = _txRN4F0Y;
        "pkg-2.0.9-MC1.19.4" = _lta9nlpx;
        "pkg-2.0.9-MC1.20.1" = _UGerqrfz;
        "pkg-2.0.10-MC1.19.4" = _7uzNWVdt;
        "pkg-2.0.10-MC1.20.1" = _oEWaPvKV;
        "pkg-2.0.11-MC1.19.4" = _K1wh90vF;
        "pkg-2.0.11-MC1.20.1" = _PE1GHL5h;
        "pkg-1.14.14-MC1.12.2" = _ZUAE3Rcd;
        "pkg-2.0.12-MC1.19.4" = _b2PJPIRJ;
        "pkg-2.0.12-MC1.20.1" = _ummQg3xw;
        "pkg-2.0.13-MC1.19.4" = _jPDrsnTE;
        "pkg-2.0.13-MC1.20.1" = _fQfDgnPu;
        "pkg-2.0.13-MC1.19.2" = _vbLstGaS;
        "pkg-2.1.0-MC1.20.1" = _F89L7vaE;
        "pkg-2.1.1-MC1.19.2" = _euSIiRfj;
        "pkg-2.1.1-MC1.19.4" = _A2aP9gM3;
        "pkg-2.1.1-MC1.20.1" = _haZklaVK;
        "pkg-2.1.2-MC1.19.2" = _5zFTAq7t;
        "pkg-2.1.2-MC1.19.4" = _CvSlLjCf;
        "pkg-2.1.2-MC1.20.1" = _UkSfDOd2;
        "pkg-1.14.16-MC1.12.2" = _du2FkHPW;
        "pkg-2.1.5-MC1.20.1" = _xTLM4DX0;
        "pkg-1.14.17" = _LomD300W;
        "default" = _LomD300W;
    });
