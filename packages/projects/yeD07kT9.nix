...
let
    ...
    in {
        ...
        "pkg-0.2.0" = _AIFN1jeO;
        "pkg-1.0.0" = _JI4oa5ft;
        "pkg-1.0.0+mod" = _LYOubi58;
        "pkg-1.0.1" = _nKlsqEhl;
        "pkg-1.0.1+mod" = _GNH8bZDJ;
        "pkg-1.0.2" = _BeOzt4Xi;
        "pkg-1.0.2+mod" = _pERUIYiN;
        "pkg-1.0.3" = _lmL5pRzb;
        "pkg-1.0.3+mod" = _7zREobkH;
        "pkg-1.0.5" = _qiXcgL74;
        "pkg-1.0.5+mod" = _OkbH7hwV;
        "pkg-1.0.2.2" = _AMsbLL4R;
        "pkg-1.0.6" = _e6G5eCxn;
        "pkg-1.0.6+mod" = _TCFfHjok;
        "pkg-1.0.7" = _rOiIn3tX;
        "pkg-1.0.7+mod" = _YnHZYWPB;
        "pkg-1.0.8.1" = _DBRnqk0p;
        "pkg-1.0.8.2" = _rV3FfIXb;
        "pkg-1.0.9" = _Jkk0JfwU;
        "pkg-1.0.9+mod" = _K2tMp2uT;
        "pkg-1.0.10" = _Az7hv61y;
        "pkg-1.0.10+mod" = _uJCCPOXy;
        "pkg-1.0.11" = _4y7eLiAI;
        "pkg-1.0.11+mod" = _NfxZkDvl;
        "pkg-2.0.0" = _XkaQvHWr;
        "pkg-2.0.1" = _BxIqklie;
        "pkg-2.0.1+mod" = _dg7dTwe5;
        "pkg-2.0.2" = _JpU4QcAO;
        "pkg-2.0.2+mod" = _2Jo8LQlk;
        "default" = _2Jo8LQlk;
    });
