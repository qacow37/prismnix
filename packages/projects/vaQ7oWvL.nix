...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.21.1" = _5qRW09DL;
        "pkg-0.2.0+1.21.1" = _YraD6ktA;
        "pkg-0.3.0+1.21.1" = _YHdtxFzE;
        "pkg-0.3.0+1.21.4-fabric" = _nc5WUg1n;
        "pkg-0.3.0+1.21.4-neoforge" = _24pLqRN6;
        "pkg-0.4.0+1.21.1-neoforge" = _zRJ0fO2I;
        "pkg-0.4.0+1.21.1-fabric" = _sOc5jWst;
        "pkg-0.4.0+1.21.4-neoforge" = _rKzmvnfh;
        "pkg-0.4.0+1.21.4-fabric" = _xxa9FDuo;
        "pkg-0.5.0+1.21.1-neoforge" = _EgIFwf18;
        "pkg-0.5.0+1.21.1-fabric" = _V7Cm35FX;
        "pkg-0.5.0+1.21.4-neoforge" = _3CwTn6Wm;
        "pkg-0.5.0+1.21.4-fabric" = _ahre1he4;
        "pkg-0.5.1+1.21.1-neoforge" = _isawgl71;
        "pkg-0.5.1+1.21.1-fabric" = _EEnJcD52;
        "pkg-0.5.1+1.21.4-neoforge" = _zn8TGr7J;
        "pkg-0.5.1+1.21.4-fabric" = _AuRgtTyt;
        "pkg-0.6.0+1.21.1-fabric" = _VSBrrbyN;
        "pkg-0.6.0+1.21.1-neoforge" = _mu4jMyvZ;
        "pkg-0.6.0+1.21.4-fabric" = _ZdEneiyS;
        "pkg-0.6.0+1.21.4-neoforge" = _MC66LBPk;
        "pkg-0.7.0+1.21.1-fabric" = _BBsv6ItZ;
        "pkg-0.7.0+1.21.1-neoforge" = _QVtXCXBy;
        "pkg-0.7.1+1.21.1-fabric" = _5UiMhb88;
        "pkg-0.7.1+1.21.1-neoforge" = _o1Rfy7S9;
        "pkg-0.8.0+1.21.1-neoforge" = _aUJEnCX6;
        "pkg-0.8.0+1.21.1-fabric" = _8RCtK6k7;
        "pkg-0.8.0+1.21.4-neoforge" = _geZmjAPi;
        "pkg-0.8.0+1.21.4-fabric" = _ATd89wXH;
        "pkg-0.9.0+1.21.5-fabric" = _itXBn3a3;
        "pkg-0.9.0+1.21.5-neoforge" = _LT59Cwsu;
        "pkg-0.9.0+1.21.8-neoforge" = _LtPTNd8O;
        "pkg-0.9.0+1.21.8-fabric" = _ttbCvkhv;
        "pkg-1.0.0-beta.1+1.21.10-fabric" = _z9aIoheV;
        "default" = _z9aIoheV;
    });
