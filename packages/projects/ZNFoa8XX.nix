...
let
    ...
    in {
        ...
        "pkg-1.19.2-0.0.1" = _vd2WrW97;
        "pkg-1.20.1-0.0.1" = _e5aVEThh;
        "pkg-1.19.2-0.0.2" = _Dd3uDT8p;
        "pkg-1.20.1-0.0.2" = _54LC43Q0;
        "pkg-1.19.2-0.0.3" = _22Eu2kFQ;
        "pkg-1.20.1-0.0.3" = _KUJRQvYu;
        "pkg-1.19.2-0.0.4" = _69WHuJH5;
        "pkg-1.20.1-0.0.4" = _vZTpnDeS;
        "pkg-1.19.2-0.0.5" = _Cqr7oKhh;
        "pkg-1.20.1-0.0.5" = _dvQowrfN;
        "pkg-1.19.2-0.0.6" = _FygdlAlj;
        "pkg-1.20.1-0.0.6" = _pZ2VUMYP;
        "pkg-1.19.2-0.0.7" = _dyFiJsrV;
        "pkg-1.20.1-0.0.7" = _dwMKj7tr;
        "pkg-1.19.2-0.0.8" = _WZuJH3YM;
        "pkg-1.20.1-0.0.8" = _zR9sQxCi;
        "pkg-1.19.2-0.0.9" = _BiUW4Y6z;
        "pkg-1.20.1-0.0.9" = _YN5qw9XY;
        "pkg-1.19.2-0.1.0" = _2nJg0XMc;
        "pkg-1.20.1-0.1.0" = _MV60Rqw6;
        "pkg-1.20.1-0.1.1" = _dqbl5ME7;
        "pkg-1.20.1-0.1.2" = _hDbohO7g;
        "pkg-1.20.1-0.1.3" = _8xuwG0hi;
        "default" = _8xuwG0hi;
    });
