...
let
    ...
    in {
        ...
        "pkg-1.0" = _yybdMTQ1;
        "pkg-1.0_mod" = _j47s3By1;
        "pkg-1.1" = _6PCpRVLA;
        "pkg-1.2" = _Jiy0YfCe;
        "pkg-1.2+mod" = _gQfLC53r;
        "pkg-2.0" = _w1co361q;
        "pkg-2.0+mod" = _bwkYWjuz;
        "pkg-2.1" = _NEGPdGC0;
        "pkg-2.1+mod" = _U4ybKsSg;
        "pkg-3.0" = _Jq5YjGwc;
        "pkg-3.0+mod" = _BrWU19Fv;
        "pkg-3.1" = _S2VIa0kw;
        "pkg-4.0" = _QyHIa2V6;
        "pkg-4.0+mod" = _rcxqe4oT;
        "pkg-4.1" = _YAj7CRGn;
        "pkg-4.1+mod" = _rwCHH7sh;
        "pkg-4.2" = _W4APnlJG;
        "pkg-4.2+mod" = _Oq8YWD56;
        "pkg-4.3" = _rnWv1Fwq;
        "pkg-4.3+mod" = _JWEAR06B;
        "pkg-4.4" = _g8cPaPIu;
        "pkg-4.4+mod" = _6wKvYm06;
        "pkg-4.5" = _NAZyutDY;
        "pkg-4.5+mod" = _OCx3GfkZ;
        "pkg-4.6" = _zqQIJty9;
        "pkg-4.6+mod" = _yVpWYmQp;
        "pkg-4.7" = _esoxvVzo;
        "pkg-4.7-fabric" = _fORK2dxg;
        "pkg-4.7-forge" = _whSIPHf5;
        "pkg-4.11" = _dnsOQ3D0;
        "pkg-4.11-fabric" = _dUvEGbqw;
        "pkg-4.11-quilt" = _uoCAGTNA;
        "pkg-4.11-forge" = _VImDW0oj;
        "pkg-4.11-neoforge" = _K7s83zzz;
        "pkg-4.12" = _V8BKqqGE;
        "pkg-4.12-fabric" = _MvnG2e7r;
        "pkg-4.12-quilt" = _BZDnvKpj;
        "pkg-4.12-forge" = _p4VD0mwP;
        "pkg-4.12-neoforge" = _SGdzuV4R;
        "default" = _SGdzuV4R;
    });
