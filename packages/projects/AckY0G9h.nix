...
let
    ...
    in {
        ...
        "pkg-2.15.1-SNAPSHOT" = _GFbuHo23;
        "pkg-2.15.1-SNAPSHOT+e4fb1e0" = _5YjSNSby;
        "pkg-2.15.1-SNAPSHOT+ec2fab9" = _B04S6lUG;
        "pkg-2.15.1-SNAPSHOT+30ccc9d" = _hVaEbte9;
        "pkg-2.15.1-SNAPSHOT+bf0a930" = _wvwyct3J;
        "default" = _wvwyct3J;
    });
