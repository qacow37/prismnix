...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19-forge" = _ruVouh8N;
        "pkg-1.0.1+1.18.2-forge" = _fwWMS64D;
        "pkg-1.0.1+1.18.2-fabric" = _Ef4UURAJ;
        "pkg-1.0.1+1.19-forge" = _cNuQKeYa;
        "pkg-1.0.1+1.19-fabric" = _bEkfuXFS;
        "pkg-1.0.2+1.18.2-forge" = _azj5HSxy;
        "pkg-1.0.2+1.18.2-fabric" = _pGWBRn1i;
        "pkg-1.0.2+1.19-forge" = _g54fQTVc;
        "pkg-1.0.2+1.19-fabric" = _oDqrlOkT;
        "pkg-1.0.3+1.18.2-forge" = _NjDgCyxY;
        "pkg-1.0.3+1.18.2-fabric" = _VXixoSQM;
        "pkg-1.0.3+1.19-forge" = _UF8erTuU;
        "pkg-1.0.3+1.19-fabric" = _Ucep0Cu5;
        "pkg-1.0.4+1.18.2-fabric" = _VFPcEpGA;
        "pkg-1.0.4+1.18.2-forge" = _KYboqMGf;
        "pkg-1.0.4+1.19-forge" = _X1F0kcns;
        "pkg-1.0.4+1.19-fabric" = _QCPx2IS2;
        "pkg-1.0.5+1.18.2-forge" = _LvVX8D1q;
        "pkg-1.0.5+1.18.2-fabric" = _7xq1zpn0;
        "pkg-1.0.5+1.19-forge" = _DkP5RdK3;
        "pkg-1.0.5+1.19-fabric" = _2YI9I4TO;
        "pkg-1.0.6+1.18.2-forge" = _EDsEsJtK;
        "pkg-1.0.6+1.18.2-fabric" = _aJk5QhXt;
        "pkg-1.0.6+1.19-forge" = _u2ibYGVH;
        "pkg-1.0.6+1.19-fabric" = _2Ae8EJZw;
        "pkg-1.0.7+1.18.2-forge" = _WOCP3kLf;
        "pkg-1.0.7+1.18.2-fabric" = _oSQPSvZH;
        "pkg-1.0.7+1.19-forge" = _pzCkMdkj;
        "pkg-1.0.7+1.19-fabric" = _h13cp5Hk;
        "pkg-1.0.8+1.18.2-forge" = _SzaC8Y3W;
        "pkg-1.0.8+1.18.2-fabric" = _JrSJCgLX;
        "pkg-1.0.8+1.19-forge" = _qiJtKPOI;
        "pkg-1.0.8+1.19-fabric" = _kJTOmZiq;
        "pkg-1.1.0+1.18.2-forge" = _4Kt64z82;
        "pkg-1.1.0+1.19-forge" = _RkJWufMO;
        "pkg-1.1.0+1.18.2-fabric" = _Osxa4mmc;
        "pkg-1.1.0+1.19-fabric" = _URzpc7Lq;
        "pkg-1.1.1+1.18.2-forge" = _ouVfwhi4;
        "pkg-1.1.1+1.18.2-fabric" = _JkgJLz6x;
        "pkg-1.1.1+1.19-forge" = _b64nmuue;
        "pkg-1.1.1+1.19-fabric" = _jsIwSe6h;
        "pkg-1.1.1+1.19.3-forge" = _B7ZtSwe2;
        "pkg-1.1.1+1.19.3-fabric" = _iG0xPWUm;
        "pkg-1.1.2+1.18.2-forge" = _vOu5WIvs;
        "pkg-1.1.2+1.18.2-fabric" = _bOQ2Cikd;
        "pkg-1.1.2+1.19-forge" = _mSQJJvNy;
        "pkg-1.1.2+1.19-fabric" = _91FfnPM8;
        "pkg-1.1.2+1.19.3-forge" = _UQb9qD3J;
        "pkg-1.1.2+1.19.3-fabric" = _XTopJ0Id;
        "pkg-1.1.3+1.19-fabric" = _deyBZlUs;
        "pkg-1.1.3+1.19-forge" = _vaBqHK19;
        "pkg-1.1.3+1.18.2-fabric" = _ljjcUkWs;
        "pkg-1.1.3+1.18.2-forge" = _81E06FMa;
        "pkg-1.1.3+1.19.3-fabric" = _1QeyH5IG;
        "pkg-1.1.3+1.19.3-forge" = _8Q03X6HA;
        "pkg-1.1.4+1.18.2-forge" = _Aj08MYtw;
        "pkg-1.1.4+1.18.2-fabric" = _PSEQMV1l;
        "pkg-1.1.4+1.19-fabric" = _DYKVvo9P;
        "pkg-1.1.4+1.19.3-forge" = _js1pLjSF;
        "pkg-1.1.4+1.19-forge" = _slz81V0J;
        "pkg-1.1.4+1.19.3-fabric" = _MzRHyyTC;
        "pkg-1.1.5+1.19-fabric" = _gLzlXMlf;
        "pkg-1.1.5+1.18.2-fabric" = _NP7Nwrwq;
        "pkg-1.1.5+1.19-forge" = _vdae5kTA;
        "pkg-1.1.5+1.18.2-forge" = _QiWlD1U9;
        "pkg-1.1.5+1.19.3-forge" = _hJQhKVxj;
        "pkg-1.1.5+1.19.3-fabric" = _RBDMFemm;
        "pkg-1.1.5+1.19.4-forge" = _EXGDg1mc;
        "pkg-1.1.5+1.19.4-fabric" = _ZFOUucav;
        "pkg-1.2.0+1.20.1-fabric" = _tOGQOc87;
        "pkg-1.2.0+1.20.1-forge" = _GKj5mumX;
        "pkg-1.2.1+1.20.1-fabric" = _KnHNGyLj;
        "pkg-1.2.1+1.20.1-forge" = _buCwQh9G;
        "pkg-1.2.2+1.20.1-fabric" = _LNxSmECr;
        "pkg-1.2.2+1.20.1-forge" = _GmitzqXs;
        "pkg-1.2.2+1.20.2-fabric" = _NhqiKzjd;
        "pkg-1.2.3+1.20.1-forge" = _Iu7dNK5J;
        "pkg-1.2.3+1.20.1-fabric" = _S9W5W5gZ;
        "pkg-1.2.3+1.20.2-fabric" = _n5c0ilso;
        "pkg-1.3.0+1.20.1-forge" = _yr87igvi;
        "pkg-1.3.0+1.20.1-fabric" = _soyzSn1W;
        "pkg-1.3.0+1.20.2-fabric" = _eVyBNuwl;
        "pkg-1.3.0+1.20.2-forge" = _cIHoyOhg;
        "pkg-1.3.1+1.20.2-fabric" = _Btqy2YLV;
        "pkg-1.3.1+1.20.1-forge" = _FwTldg5l;
        "pkg-1.3.1+1.20.1-fabric" = _8Zv39qno;
        "pkg-1.3.2+1.20.1-forge" = _jHvKJkv8;
        "pkg-1.3.2+1.20.1-fabric" = _rwRYD8bX;
        "pkg-1.3.3+1.20.4-fabric" = _ofN9RHSY;
        "pkg-1.3.3+1.20.1-forge" = _532t65Zz;
        "pkg-1.3.3+1.20.1-fabric" = _FyOp03FS;
        "pkg-1.3.4+1.20.4-fabric" = _sMyWCvwn;
        "pkg-1.4.0+1.20.4-neoforge" = _j2OvzNhM;
        "pkg-1.4.0+1.20.4-fabric" = _9kp2Pvcp;
        "pkg-2.0.0+1.21.1-neoforge" = _ZLQTnvZK;
        "pkg-2.0.0+1.21.1-fabric" = _wHUV3Aci;
        "pkg-2.0.1+1.21.1-neoforge" = _264e2l8J;
        "pkg-2.0.1+1.21.1-fabric" = _4c12AaMS;
        "pkg-2.0.2+1.21.1-neoforge" = _IGf35iiG;
        "pkg-2.0.2+1.21.1-fabric" = _NNRViwFU;
        "pkg-2.0.3+1.21.1-fabric" = _SV2jaBXq;
        "pkg-2.0.3+1.21.1-neoforge" = _EBH9UlQk;
        "pkg-2.0.4+1.21.1-neoforge" = _R7D0sles;
        "pkg-2.0.4+1.21.1-fabric" = _rtkzGVC5;
        "pkg-2.0.5+1.21.1-fabric" = _XEM0T44p;
        "pkg-2.0.5+1.21.1-neoforge" = _dO3XGXuP;
        "pkg-2.0.5+1.21.4-fabric" = _6PelITey;
        "pkg-2.0.5+1.21.4-neoforge" = _WABpH0nv;
        "pkg-2.0.6+1.21.1-fabric" = _UkTSsgGt;
        "pkg-2.0.6+1.21.1-neoforge" = _FT7t1n1a;
        "pkg-3.0.0+1.21.8-neoforge" = _aIYU6I6t;
        "pkg-3.0.0+1.21.8-fabric" = _ke3chKqw;
        "pkg-3.0.0+1.21.10-neoforge" = _Vo8V99Xs;
        "pkg-3.0.0+1.21.10-fabric" = _TboS98D6;
        "pkg-3.0.0+1.21.11-fabric" = _T7sepZSq;
        "pkg-3.0.0+1.21.11-neoforge" = _kR6alo7V;
        "pkg-3.0.1+1.21.11-neoforge" = _znWrqNKk;
        "pkg-3.0.1+26.1.2-neoforge" = _st64SArf;
        "pkg-3.0.1+26.1.2-fabric" = _FLQRcSui;
