...
let
    ...
    in {
        ...
        "pkg-1.0" = _9ojvDdQu;
        "pkg-1.0+mod" = _Mo9szqjW;
        "pkg-1.1" = _nmu1ZzXm;
        "pkg-1.1+mod" = _tvoUNjPA;
        "pkg-1.2" = _BTws6h6Q;
        "pkg-1.2+mod" = _Ep3icpVg;
        "pkg-1.3" = _h5Lko3HU;
        "pkg-1.3+mod" = _ebkQ9oS7;
        "pkg-1.4" = _gmvq36y9;
        "pkg-1.4+mod" = _ToxVpjWO;
        "pkg-2.0" = _h4aqG051;
        "pkg-2.0+mod" = _P6HzUpIP;
        "pkg-2.1" = _hB7B3CSU;
        "pkg-2.1+mod" = _VNYSTBCd;
        "pkg-2.1.1" = _XEtlkJ33;
        "pkg-2.1.1+mod" = _fg5kz90C;
        "pkg-2.1.0.1" = _D79KoHAn;
        "pkg-2.1.0.1+mod" = _ITzhI3WZ;
        "pkg-2.2" = _yvXWrzMa;
        "pkg-2.2+mod" = _76hbd6bI;
        "pkg-2.2.1" = _UTbc0ZBb;
        "pkg-2.2.1+mod" = _eAWUZXr0;
        "pkg-2.2.2" = _fJtXt5rT;
        "pkg-2.2.2+mod" = _Pa9Fhqdf;
        "pkg-2.2.3" = _No4Ob31u;
        "pkg-2.2.3+mod" = _GAgZx2Rc;
        "pkg-2.2.4" = _Dqmi4DN3;
        "pkg-2.2.4+mod" = _60GIz8rl;
        "pkg-3.0" = _NN7Kl5dY;
        "pkg-3.0+mod" = _mIDZxKVg;
        "pkg-v3.0.1" = _Bh7MXihY;
        "pkg-v3.0.1+mod" = _oMkkJk47;
        "pkg-v3.0.2" = _finOUoq7;
        "pkg-v3.0.2+mod" = _pgfk79vD;
        "pkg-v3.0.3" = _qy2E0I8m;
        "pkg-v3.0.3+mod" = _a1vz0akk;
        "default" = _a1vz0akk;
    });
