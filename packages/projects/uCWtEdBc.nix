...
let
    ...
    in {
        ...
        "pkg-1.0-MC1.21.8" = _i1Qli7p5;
        "pkg-1.0-MC1.21.10" = _fKPc6VOL;
        "pkg-1.0-MC1.21.11" = _ZUoiaQFP;
        "pkg-1.0-MC26.1-snapshot-6" = _1oYlzuPi;
        "pkg-1.0-MC26.1-snapshot-7" = _4xbJp090;
        "pkg-1.0-MC26.1-snapshot-8" = _ywkMTVZ5;
        "pkg-1.0-MC26.1-snapshot-9" = _LiY67nzx;
        "pkg-1.0-MC26.1-snapshot-10" = _GsJ8cpEN;
        "pkg-1.0-MC26.1-snapshot-11" = _5qtpAcWY;
        "pkg-1.0-MC26.1-pre-1" = _b3xF0gBy;
        "pkg-1.0-MC26.1-pre-2" = _8gdXUAw4;
        "pkg-1.0-MC26.1-pre-3" = _MNjdar4T;
        "pkg-1.0-MC26.1-rc-1" = _L6RXATFY;
        "pkg-1.0-MC26.1-rc-2" = _hxPcoN1A;
        "pkg-1.1-MC1.21.11" = _cfDDqodw;
        "pkg-1.1-MC26.1-rc-2" = _aCIARhIF;
        "pkg-1.1-MC26.1-rc-3" = _f3Gy5JcF;
        "pkg-1.1-MC26.1" = _Yle225z1;
        "pkg-1.1-MC26.1.1-rc-1" = _EghEztDY;
        "pkg-1.1-MC26.1.1" = _IfEfO9Yq;
        "pkg-1.1-MC26w14a" = _AfeME4sj;
        "pkg-1.1-MC26.2-snapshot-1" = _RaDt3nPP;
        "pkg-1.1-MC26.1.2-rc-1" = _2BEIeI8p;
        "pkg-1.1-MC26.1.2" = _j2sVDdE1;
        "pkg-1.1-MC26.2-snapshot-2" = _jfXtNii7;
        "pkg-1.1-MC26.2-snapshot-3" = _N0uqlYbs;
        "pkg-1.1-MC26.2-snapshot-4" = _ZaCCqinh;
        "pkg-1.1-MC26.2-snapshot-5" = _EITYKW92;
        "pkg-1.1-MC26.2-snapshot-6" = _KvFYW8yS;
        "pkg-1.1-MC26.2-snapshot-7" = _uTcNLrCv;
        "pkg-1.1-MC26.2-snapshot-8" = _Rq9vbY5z;
        "pkg-1.1-MC26.2-pre-1" = _SyQ1Gweg;
        "pkg-1.1-MC26.2-pre-2" = _N4Do9b3R;
        "pkg-1.1-MC26.2-pre-3" = _oSfEN66n;
        "pkg-1.1-MC26.2-pre-4" = _KhVNThW7;
        "pkg-1.1-MC26.2-pre-5" = _W6AwnuVi;
        "pkg-1.1-MC26.2-pre-6" = _EErUWFeC;
        "pkg-1.1-MC26.2-rc-1" = _rrITcS7d;
        "pkg-1.1-MC26.2-rc-2" = _I19n63BA;
        "pkg-1.1-MC26.2" = _n2ttGNHl;
        "pkg-1.1.1-MC26.2" = _t45ZowbZ;
        "pkg-1.1.1-MC1.21.11" = _Q6Th27xI;
        "pkg-1.1.1-MC26.1.2" = _k9gi9UTe;
        "pkg-1.1.1-MC26.3-snapshot-1" = _qJJ6Gn9P;
        "pkg-1.1.1-MC26.3-snapshot-2" = _FZaBAMo4;
        "pkg-1.1.2-MC26.2" = _f3V5dCNA;
        "pkg-1.1.2-MC26.3-snapshot-3" = _d7vwR4iV;
        "pkg-1.1.2-MC26.3-snapshot-4" = _LCgFlVGk;
        "pkg-1.1.2-MC26.3-snapshot-5" = _KJXwuumA;
        "pkg-1.1.3-MC26.2" = _fVR1MnUu;
        "pkg-1.1.3-MC26.1.2" = _mFjUzPkU;
        "pkg-1.1.3-MC1.21.11" = _2gaIGPlZ;
        "pkg-1.1.3-MC26.3-snapshot-5" = _bouIxp8N;
        "pkg-1.1.3-MC26.3-snapshot-6" = _m0tyraiX;
        "default" = _m0tyraiX;
    });
