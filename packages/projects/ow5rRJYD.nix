...
let
    ...
    in {
        ...
        "pkg-0.2.0" = _hJ3smsMp;
        "pkg-0.2.1" = _cLHWhz1F;
        "pkg-0.2.2+1.21.10" = _r282zOjV;
        "pkg-0.2.2+1.21.11" = _pNB17AGt;
        "pkg-0.2.2+1.21.4" = _RTZAI7FB;
        "pkg-0.2.2+1.21.1" = _WplwCQYE;
        "pkg-0.2.3+1.21.11" = _Yja8UMQE;
        "pkg-0.2.3+1.21.4" = _IcNS5rDd;
        "pkg-0.2.3+1.21.1" = _XvopbKBV;
        "pkg-1.0.0+1.21.11" = _KfcQJUzB;
        "pkg-1.0.1+1.21.11" = _5fck0vEr;
        "pkg-1.0.1+1.21.1" = _90ttEEbr;
        "pkg-1.0.2+26.1" = _69z5Vb5V;
        "pkg-1.0.3+26.1.2" = _2cT5TSfZ;
        "pkg-1.0.3+1.21.1" = _MVGW3H6s;
        "pkg-1.1.0+neoforge-1.21.1" = _fT12K93i;
        "pkg-1.1.0+fabric-26.1.2" = _n8i3mK0f;
        "pkg-1.1.0+neoforge-26.1.2" = _Majg9nvF;
        "pkg-1.1.0+fabric-1.21.1" = _pB7PaEFQ;
        "pkg-1.1.1+neoforge-1.21.1" = _chXrJrFD;
        "pkg-1.1.1+neoforge-26.1.2" = _O30zjuf4;
        "pkg-1.1.1+fabric-26.1.2" = _mSF21gdg;
        "pkg-1.1.1+fabric-1.21.1" = _5Zh2zq3v;
        "pkg-1.1.1+fabric-26.2" = _rrTob2am;
        "pkg-1.1.1+neoforge-26.2" = _CNnpJPqA;
        "default" = _CNnpJPqA;
    });
