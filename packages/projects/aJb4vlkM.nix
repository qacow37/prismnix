...
let
    ...
    in {
        ...
        "pkg-1.4.0" = _Q7U1M3S2;
        "pkg-1.4.1" = _bbdv1SzW;
        "pkg-1.4.2+1.21" = _ruYl7Sd4;
        "pkg-1.5.0+1.21" = _GL0FXIvU;
        "pkg-1.5.1+1.21" = _71l8axmm;
        "pkg-1.6.0+1.21" = _DTKJKpAM;
        "pkg-1.7.0+1.21" = _dFY3C4oI;
        "pkg-1.7.1+1.21" = _qFvfPICY;
        "pkg-1.7.1+1.21.3" = _EE3ENXUO;
        "pkg-1.7.1+1.21.4" = _OfenUuIf;
        "pkg-1.7.2+1.21.4" = _YVN3QjsU;
        "pkg-1.7.3+1.21.4" = _4rtRGM6f;
        "pkg-1.7.3+1.21.5" = _MqNk4MU0;
        "pkg-1.7.3+1.21.7" = _hnP8krsm;
        "pkg-1.7.3+1.21.10" = _UtzKHQON;
        "pkg-1.7.4+1.21.11" = _J9n2nBFV;
        "pkg-1.7.4+26.1.2" = _k08vuJT9;
        "pkg-1.7.4+26.2" = _2eptaWxs;
        "default" = _2eptaWxs;
    });
