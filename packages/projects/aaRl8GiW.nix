...
let
    ...
    in {
        ...
        "pkg-21.0.6" = _jcK0ewZ6;
        "pkg-21.0.7" = _RPheioa7;
        "pkg-21.0.8" = _Zaf9YuDC;
        "pkg-21.0.9" = _4zOa12VX;
        "pkg-21.1.1" = _nyfft2Bq;
        "pkg-21.1.2" = _2INqAJlG;
        "pkg-21.1.3" = _3aKRiOiA;
        "pkg-21.1.4" = _m8OGTxU9;
        "pkg-21.1.5" = _RIOedxsd;
        "pkg-21.1.6" = _R9ZWDTuu;
        "pkg-21.1.7" = _WnFkNHWx;
        "pkg-21.1.8" = _u5HZtlyZ;
        "pkg-21.1.9" = _6PUPR9D7;
        "pkg-21.1.10" = _jGBdTRi5;
        "pkg-21.2.1" = _zb9UvElw;
        "pkg-21.3.1" = _HDg1adCQ;
        "pkg-21.4.1" = _XlRqflOf;
        "pkg-21.5.1" = _BrlyNG29;
        "pkg-21.6.1" = _tSNaoz8z;
        "pkg-21.7.1" = _BaRssxq4;
        "pkg-21.8.1" = _5i6PPwki;
        "pkg-21.1.11" = _EE1FHDyD;
        "pkg-21.8.2" = _lIB6H7Jl;
        "pkg-21.9.1" = _3360ej7s;
        "pkg-21.10.2" = _l2jKhJoj;
        "pkg-21.11.1" = _fgUon9A6;
        "pkg-26.1.1.1" = _fJPQ7VIb;
        "pkg-26.1.1.2" = _rQrYQgKp;
        "pkg-26.1.1.3" = _BdrLpV0y;
        "pkg-26.1.1.5" = _hornQG68;
        "pkg-26.1.1.7" = _d8j676uS;
        "pkg-26.1.1.8" = _FqwktugT;
        "pkg-26.1.2.1" = _g8zJ08TD;
        "pkg-26.1.2.2" = _oquULkHC;
        "pkg-26.1.2.3" = _3Mvkapwz;
        "pkg-26.1.2.4" = _FpFx6WKh;
        "pkg-26.2.0.1" = _9MOo716V;
        "pkg-26.1.2.5" = _ZsWxxJNe;
