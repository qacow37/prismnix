...
let
    ...
    in {
        ...
        "pkg-v4.1.0-1.19.1-Forge" = _GXhuhVUd;
        "pkg-v4.0.1-1.19-Forge" = _Btj1I5Yn;
        "pkg-v4.0.1-1.19-Fabric" = _TGWMKqZJ;
        "pkg-v4.2.0-1.19.2-Forge" = _VHjccmc4;
        "pkg-v4.2.0-1.19.2-Fabric" = _vxQCqkT0;
        "pkg-v5.0.0-1.19.3-Fabric" = _4TlB3c7M;
        "pkg-v5.0.0-1.19.3-Forge" = _HohA2S5H;
        "pkg-v6.0.0-1.19.4-Fabric" = _XuJZkVsA;
        "pkg-v6.0.0-1.19.4-Forge" = _QjfsymZG;
        "pkg-v7.0.0-1.20-Forge" = _CNdo5HIf;
        "pkg-v7.0.0-1.20-Fabric" = _TfXokI6E;
        "pkg-v8.0.0-1.20.1-Forge" = _l2sO0ExT;
        "pkg-v8.0.0-1.20.1-Fabric" = _xdqj9cKL;
        "pkg-v8.0.1-1.20.1-Forge" = _skIfd1VU;
        "pkg-v8.0.1-1.20.1-Fabric" = _XE1yCFep;
        "pkg-v8.0.2-1.20.1-Forge" = _LvveFy3w;
        "pkg-v8.0.2-1.20.1-Fabric" = _Xc6BwCFB;
        "pkg-v20.4.0-1.20.4-Fabric" = _zVjx03Ba;
        "pkg-v20.4.0-1.20.4-NeoForge" = _rdFj7xQa;
        "pkg-v20.4.0-1.20.4-Forge" = _qiNf0tiv;
        "pkg-v20.4.1-1.20.4-Fabric" = _eTzedmqO;
        "pkg-v20.4.1-1.20.4-Forge" = _msR2jeJX;
        "pkg-v20.4.1-1.20.4-NeoForge" = _dgrhO5dj;
        "pkg-v20.4.2-1.20.4-Fabric" = _4wKjEx1s;
        "pkg-v20.4.2-1.20.4-Forge" = _8C9FASmz;
        "pkg-v20.4.2-1.20.4-NeoForge" = _fWxqPqd7;
        "pkg-v21.0.0-1.21-Fabric" = _VvwEWp6L;
        "pkg-v21.0.0-1.21-NeoForge" = _KCg8JAkM;
        "pkg-v21.0.1-1.21-Fabric" = _J9NGHI46;
        "pkg-v21.0.1-1.21-NeoForge" = _gfIe8bdc;
        "pkg-v21.0.2-1.21-Fabric" = _eyDP24V9;
        "pkg-v21.0.2-1.21-NeoForge" = _CBsh1EZv;
        "pkg-v21.1.0-1.21.1-Fabric" = _7CEOfmbg;
        "pkg-v21.1.0-1.21.1-NeoForge" = _ldVC1ElB;
        "pkg-v21.3.0-1.21.3-Fabric" = _hUlLSd3L;
        "pkg-v21.3.0-1.21.3-NeoForge" = _A1PcYajA;
        "pkg-v21.4.0-1.21.4-Fabric" = _kKPGLsUd;
        "pkg-v21.4.0-1.21.4-NeoForge" = _8smaKZsn;
        "pkg-v21.4.1-1.21.4-Fabric" = _jUUt63mW;
        "pkg-v21.4.1-1.21.4-NeoForge" = _O8vsBEYp;
        "pkg-v21.5.0-1.21.5-Fabric" = _iw4awAY6;
        "pkg-v21.5.0-1.21.5-NeoForge" = _T09tYKVD;
        "pkg-v21.6.0-1.21.6-Fabric" = _88f6FwRE;
        "pkg-v21.6.0-1.21.6-NeoForge" = _sHfDzgfP;
        "pkg-v21.7.0-1.21.7-Fabric" = _BL2S3CMb;
        "pkg-v21.7.0-1.21.7-NeoForge" = _34H9gdqs;
        "pkg-v21.8.0-1.21.8-Fabric" = _TnbfMPgx;
        "pkg-v21.8.0-1.21.8-NeoForge" = _nEQBljGf;
        "pkg-21.9.0" = _cMlCDmrO;
        "pkg-21.10.0" = _SacBz22y;
        "pkg-v21.1.1-1.21.1-Fabric" = _JxSbQLVf;
        "pkg-v21.1.1-1.21.1-NeoForge" = _iAzPpBdI;
        "pkg-21.10.1" = _nseRB5wI;
