...
let
    ...
    in {
        ...
        "pkg-1.0" = _I2K1vRss;
        "pkg-1.1" = _ZVbcl871;
        "pkg-Beta_Accuracy-1.2" = _GUt37Z2W;
        "pkg-Beta_Accuracy-1.2a" = _36004xkG;
        "pkg-Beta_Accuracy-1.2b" = _7YoHypiZ;
        "pkg-Beta_Accuracy-1.3" = _8vou9ZcF;
        "pkg-Beta_Accuracy-1.3a" = _v9cU0d5z;
        "pkg-Beta_Accuracy-1.3b" = _1K7EG1ja;
        "pkg-Beta_Colormap_Addon-1.0" = _EfhgSz3k;
        "pkg-Mod_Support_Addon-1.0" = _rNAizlTH;
        "pkg-Beta_Accuracy-1.3c" = _4cTJ31PU;
        "pkg-Beta_Accuracy-1.4" = _trMy7ZbN;
        "pkg-Beta_Accuracy-1.4a" = _GcC856Bi;
        "pkg-Beta_Accuracy-1.5" = _LI51e5qe;
        "pkg-Beta_Accuracy-1.6" = _E6bOV79b;
        "pkg-Beta_Accuracy-1.7" = _7JJHbrVy;
        "pkg-Beta_Accuracy-1.8" = _IGASPcTz;
        "pkg-Beta_Accuracy-1.8a" = _iEe8aHlI;
        "pkg-Beta_Accuracy-1.9" = _E4DaA5cZ;
        "pkg-Beta_Accuracy-1.9a" = _Ure0EHEO;
        "pkg-Beta_Accuracy-1.10" = _U90AHrgx;
        "pkg-Alpha_Accuracy_Addon-1.0" = _Z7VdFN20;
        "default" = _Z7VdFN20;
    });
