...
let
    ...
    in {
        ...
        "pkg-0.2.6" = _zNxkbypO;
        "pkg-0.2.7" = _NehU58tH;
        "pkg-0.2.7+1.18" = _274i8nNb;
        "pkg-0.2.8+1.18" = _I8vCqyHv;
        "pkg-0.2.9+1.18" = _UVtm0Mxh;
        "pkg-0.2.10+1.18" = _mm11P6PF;
        "pkg-0.2.11+1.18" = _FVZaNtjN;
        "pkg-0.2.12+1.18" = _ylZli2mA;
        "pkg-0.2.13+1.18" = _vL9nY4fj;
        "pkg-0.2.14+1.18" = _uJF4YTXl;
        "pkg-0.2.15+1.18" = _e2ysxVmj;
        "pkg-0.2.16+1.18" = _jXfKOjlw;
        "pkg-0.2.17+1.18" = _ubtF4UL9;
        "pkg-0.2.18+1.18" = _20KpxXrW;
        "pkg-0.2.19+1.19" = _YvuNpDEz;
        "pkg-0.2.20+1.19" = _Dwis6LWU;
        "pkg-0.3.0+1.19" = _K59hNxSI;
        "pkg-0.3.0+1.19.3" = _3uTXDKXz;
        "pkg-0.3.0+1.19.4" = _XoKlERtL;
        "pkg-0.3.1+1.20" = _4osKFK3P;
        "pkg-0.3.2+1.20.2" = _ahg5pbDR;
        "pkg-0.3.3+1.20" = _FLzUUyOd;
        "pkg-0.3.3+1.20.2" = _V4qx9x2b;
        "pkg-0.3.3+1.20.3" = _HVxIuUjc;
        "pkg-0.3.4+1.20.3" = _FjkRTLT9;
        "pkg-0.4.0+1.21" = _Rq5WQPY3;
        "pkg-0.4.1+1.21" = _oGd6imp4;
        "pkg-0.4.2+1.21" = _C9vVXLgu;
        "default" = _C9vVXLgu;
    });
