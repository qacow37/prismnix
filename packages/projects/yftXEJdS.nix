...
let
    ...
    in {
        ...
        "pkg-Fabric-1.0.0-mc1.21.1" = _p90x8yud;
        "pkg-Forge-1.0.0-mc1.21.1" = _LasU4F1w;
        "pkg-Forge-1.0.0-mc1.20.1" = _hA3R7RCL;
        "pkg-Fabric-1.0.0-mc1.20.1" = _pD4Rt9FM;
        "pkg-Fabric-1.0.0-mc1.21.7" = _LlFcjUQa;
        "pkg-Fabric-1.0.0-mc1.21.8" = _ZGAiAOy3;
        "pkg-Fabric-1.0.0-mc1.21.6" = _FR1PXQ4C;
        "pkg-Fabric-1.0.0-mc1.21.5" = _MxI31Udj;
        "pkg-Fabric-1.0.0-mc1.21.4" = _zmmKhg8q;
        "pkg-Fabric-1.0.0-mc1.21.3" = _xR4u8x1b;
        "pkg-Fabric-1.0.0-mc1.21.2" = _PqV75Nn5;
        "pkg-Fabric-1.0.1-mc1.21.8" = _BqW7OQAd;
        "pkg-Forge-1.0.1-mc1.21.8" = _3rfwCBdP;
        "pkg-NeoForge-1.0.1-mc1.21.8" = _R0kYKEJV;
        "pkg-Fabric-1.0.1-mc1.21.7" = _6Nktg3MD;
        "pkg-Forge-1.0.1-mc1.21.7" = _6wAdUf61;
        "pkg-NeoForge-1.0.1-mc1.21.7" = _az1R0jRP;
        "pkg-Fabric-1.0.1-mc1.21.6" = _5xOVSV97;
        "pkg-Fabric-1.0.1-mc1.21.5" = _ZOhdZ2nT;
        "pkg-Fabric-1.0.1-mc1.21.4" = _ML18FK1V;
        "pkg-Fabric-1.0.1-mc1.21.3" = _gvRfnT29;
        "pkg-Fabric-1.0.1-mc1.21.2" = _b7SCEb0r;
        "pkg-Fabric-1.0.1-mc1.21.1" = _40KFTefx;
        "pkg-Fabric-1.0.1-mc1.21" = _eCfAsWuh;
        "pkg-Fabric-1.0.1-mc1.20.6" = _XMyU4Gnk;
        "pkg-Fabric-1.0.1-mc1.20.5" = _483ppb4k;
        "pkg-Fabric-1.0.1-mc1.20.4" = _nJwpa6e9;
        "pkg-Fabric-1.0.1-mc1.20.3" = _xSlE7TLN;
        "pkg-Fabric-1.0.1-mc1.20.2" = _ffggYOfX;
        "pkg-Fabric-1.0.1-mc1.20.1" = _27PE1c61;
        "pkg-Fabric-1.0.1-mc1.20" = _1kXX8Jep;
        "pkg-Forge-1.0.1-mc1.20.1" = _fv3EkK4n;
        "pkg-Fabric-1.0.1-mc1.21.9" = _akXVtYAH;
        "pkg-Fabric-1.0.1-mc1.21.10" = _SsUx8png;
        "pkg-Fabric-1.0.2-mc1.21.10" = _AaxvT8Mk;
        "pkg-Fabric-1.0.3-mc1.21.10" = _XlGhpYzE;
        "pkg-Fabric-2.0.0-mc1.21.11" = _pNOODFaO;
        "pkg-Fabric-2.0.0-mc1.21.10" = _A9iC7dat;
        "pkg-Fabric-2.0.0-mc1.21.1" = _rYg6Zy4u;
        "pkg-Fabric-2.0.0-mc1.20.1" = _yobEypJs;
        "pkg-Fabric-2.0.0-mc1.20.4" = _FKbd4rdA;
        "pkg-Fabric-2.0.0-mc1.21.8" = _cMhOqhwz;
        "pkg-Fabric-2.0.1-mc26.1" = _EXGg9PGB;
        "pkg-Fabric-2.0.1-mc26.1.1" = _Umztcm8D;
        "pkg-Fabric-2.0.1-mc26.1.2" = _KgjWRrW4;
        "pkg-3.0.0" = _gsNfqDUA;
        "pkg-5.0.0" = _DONg9o3t;
        "default" = _DONg9o3t;
    });
