...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _KkrERWC3;
        "pkg-1.20.1-1.0.1" = _Wpxu9M23;
        "pkg-fabric-1.20.1-1.0.2" = _dvgo05O0;
        "pkg-fabric-1.20.1-1.0.3" = _i7s2WlgX;
        "pkg-fabric-1.20.1-1.0.4" = _YHsWlZGX;
        "pkg-fabric-1.20.1-1.1.0-beta-1" = _Rvg8sFgf;
        "pkg-forge-1.20.1-1.1.0-beta-1" = _jzEMljpb;
        "pkg-fabric-1.20.1-1.2.0" = _K9djs3vC;
        "pkg-forge-1.20.1-1.2.0" = _QQnXcK5g;
        "pkg-fabric-1.20.1-1.2.1" = _vXX2BgMe;
        "pkg-forge-1.20.1-1.2.1" = _mKDoJpqY;
        "pkg-1.2.2" = _X6jr9vxA;
        "pkg-1.3.0" = _Ucgta6hn;
        "pkg-1.3.1" = _2viUjRzn;
        "pkg-1.3.2" = _BHEWVjxa;
        ...
        "pkg-1.4.2" = _bYMxADTd;
        "pkg-1.4.3" = _5dNIdojN;
        "pkg-fabric-1.21.1-1.4.4" = _emTv0sZD;
        "pkg-neoforge-1.21.1-1.4.4" = _BK6aKJbp;
        "pkg-fabric-1.21.5-1.4.4" = _YyEg0S7J;
        "pkg-fabric-1.21.8-1.4.4" = _lvBoMShO;
        "pkg-fabric-1.21.10-1.4.4" = _eia7X8cK;
        "pkg-fabric-1.21.11-1.4.5" = _HQXJQqzj;
        "pkg-forge-1.20.1-1.4.6" = _RbbcEsFS;
        "pkg-fabric-1.20.1-1.4.6" = _XSUKdGlw;
        "pkg-fabric-1.21.1-1.4.6" = _i3AvO5IP;
        "pkg-neoforge-1.21.1-1.4.6" = _O8wLBXIP;
        "pkg-fabric-1.21.11-1.4.6" = _ZFeUfGCn;
        "pkg-fabric-1.21.11-1.4.7" = _oq72QEUD;
        "pkg-forge-1.20.1-1.4.8" = _r31i2Fd1;
        "pkg-neoforge-1.21.1-1.4.8" = _4BABsmeb;
        "pkg-fabric-1.21.1-1.4.8" = _A9XUynei;
        "default" = _A9XUynei;
    });
