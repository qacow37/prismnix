...
let
    ...
    in {
        ...
        "pkg-0.5-1.21.4" = _hywaTonh;
        "pkg-0.5-1.21" = _e6Lqcvwq;
        "pkg-0.6-1.21" = _VAaVJRmM;
        "pkg-0.6-1.21.4" = _IX7PgoT5;
        "pkg-0.7-1.21" = _Bo46xFOC;
        "pkg-0.7-1.21.4" = _qAvCeTGc;
        "pkg-0.8-1.21" = _WsBCroJS;
        "pkg-0.8-1.21.4" = _OLegbrnB;
        "pkg-0.8-1.21.5" = _WNOZRmku;
        "pkg-0.8-1.21.8" = _Ip3x5KIK;
        "pkg-0.8-1.21.9" = _D9Ohp9Mo;
        "pkg-0.8-1.21.10" = _bDccyzL3;
        "pkg-0.9-1.21.11" = _VqiCeFti;
        "pkg-0.9.1-1.21.11" = _7uJj2trs;
        "pkg-0.8.1-1.21.1" = _WNIO5DM4;
        "pkg-0.9.1-26.1" = _bxCrQtPv;
        "pkg-0.9.1-26.1.2" = _hgO3YJf7;
        "pkg-0.9.2-26.1.2" = _hRBYfERv;
