...
let
    ...
    in {
        ...
        "pkg-1.1" = _rK6DmUaV;
        "pkg-1.1+mod" = _kZXXdKtY;
        "pkg-1.0.1" = _nYglZjRZ;
        "pkg-1.0.1+mod" = _B7rvYnrT;
        "pkg-1.1.1" = _LuvRoKBD;
        "pkg-1.1.1+mod" = _Ms1KRJIl;
        "pkg-1.2" = _a0aVoODy;
        "pkg-1.2+mod" = _g0PwnqOW;
        "pkg-1.2.1" = _xTncdFJa;
        "pkg-1.2.1+mod" = _aYRxpyZv;
        "pkg-1.2.2" = _xqMujGSS;
        "pkg-1.2.2+mod" = _L3MXeGSv;
        "pkg-1.3" = _S8xOWApI;
        "pkg-1.3+mod" = _tTKkbBpD;
        "pkg-1.3.1" = _eQKQ8Xps;
        "pkg-1.3.1+mod" = _e94qT1yE;
        "pkg-1.3.2" = _wqVmkyLQ;
        "pkg-1.3.2+mod" = _cK6Htd84;
        "pkg-1.3.3" = _LhojwKJR;
