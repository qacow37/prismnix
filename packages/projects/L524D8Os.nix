...
let
    ...
    in {
        ...
        "pkg-1.4.7" = _ODU9DF3X;
        "pkg-1.4.8" = _pqZ6uZpN;
        "pkg-1.4.9-1.20.1" = _LwXwBfH1;
        "pkg-1.4.9-1.21.1" = _hsoMU5sa;
        "pkg-1.5.0-1.20.1" = _DcwNO28o;
        "pkg-1.5.0-1.21.1" = _LBXFgd2B;
        "pkg-1.5.1+1.20.1" = _oxUsRxlL;
        "pkg-1.5.1+1.21.1" = _eiRKKSdJ;
        "default" = _eiRKKSdJ;
    });
