...
let
    ...
    in {
        ...
        "pkg-0.0.1+1.20.1" = _ZDft9RA9;
        "pkg-0.0.2+1.20.1" = _4rM18fnL;
        "pkg-0.0.3+1.20.1" = _1X12L6Y4;
        "pkg-0.0.3+1.21" = _Pu11gn8v;
        "pkg-0.0.4+1.21" = _PkeraQLM;
        "pkg-0.0.4+1.20.1" = _VkNy6izU;
        "pkg-0.0.5+1.21" = _S2RfHwBG;
        "pkg-0.1.0+1.20.1" = _IbAHAwYb;
        "pkg-0.1.0+1.21" = _1xYKtazd;
        "pkg-0.1.1+1.21" = _KFazbdWI;
        "pkg-0.1.1+1.21.11" = _9uqhLUYe;
        "pkg-0.1.2+1.21.11" = _WDhHeVx9;
        "pkg-0.1.3+1.21.11" = _dOKObJwU;
        "pkg-0.1.4+1.20.1" = _x7rjIeqE;
        "pkg-0.1.4+1.21" = _6L9QZsxY;
        "pkg-0.1.4+1.21.11" = _O1RoolzO;
        "pkg-0.1.5+1.20.1" = _BPO2tF0b;
        "pkg-0.1.5+1.21" = _MIODRRbM;
        "pkg-0.1.5+1.21.11" = _VBx0ToEQ;
        "pkg-0.1.5+26.1.2" = _7hjfMyy6;
        "pkg-0.1.6+1.20.1" = _o7r3PTMP;
        "pkg-0.1.6+1.21.11" = _IdLZfHEs;
        "pkg-0.1.6+26.1.2" = _bTnsL7ro;
        "pkg-0.1.6+1.21" = _NYh6EQRG;
        "pkg-0.2.0+1.20.1" = _fWotFHdM;
        "pkg-0.2.0+1.21.1" = _h2tTmurt;
        "pkg-0.2.0+1.21.11" = _wj6XuuAc;
        "pkg-0.2.0+26.1.2" = _Jx7y1KvM;
        "pkg-0.2.0+26.2" = _FINcrLHK;
        "default" = _FINcrLHK;
    });
