...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _sCUYngCO;
        "pkg-0.3.0" = _iYLpprhy;
        "pkg-0.6.0-dev.20171010.003436" = _SPD9T6t3;
        "pkg-0.6.0-dev.20171102.195305" = _IFJEl0FW;
        "pkg-0.6.0-dev.20171117.213848" = _O4vsiZsk;
        "pkg-0.6.0-dev.20171201.034137" = _zOFRza4c;
        "pkg-0.6.0-dev.20180429.194246" = _rKu2bANs;
        "pkg-0.6.0-dev.20180430.173749" = _lY6Im3Wv;
        "pkg-0.6.0-dev.20180502.210326" = _znyqTrZE;
        "pkg-0.6.0-dev.20180503.005000" = _PLoGFOuQ;
        "pkg-0.6.0-dev.20180609.231640" = _6qLTILf0;
        "pkg-0.6.0-dev.20181206.234027" = _v0apegrG;
        "pkg-0.6.0-dev.20190108.182306" = _UyYb4HSY;
        "pkg-0.6.0-dev.20190112.001021" = _BMG2uXJE;
        "pkg-0.6.0-dev.20190309.202458" = _WQD0ZSkc;
        "pkg-0.6.0-dev.20190525.121747" = _GqrNTfkt;
        "pkg-0.6.0-dev.20190814.220944" = _xGjcQcM1;
        "pkg-0.6.0-dev.20200122.211517" = _ALdapr4x;
        "default" = _ALdapr4x;
    });
