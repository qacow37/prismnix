...
let
    ...
    in {
        ...
        "pkg-1.18.1-0-fabric" = _jfTF6uK4;
        "pkg-1.18.1-0-forge" = _pEawvzyy;
        "pkg-1.18.2-0-forge" = _RX2N5644;
        "pkg-1.19-0-fabric" = _fp94XIPA;
        "pkg-1.19-0-forge" = _EjmgXWhb;
        "pkg-1.19.1-0-fabric" = _itf1MAFE;
        "pkg-1.19.1-0-forge" = _gbkgLR9I;
        "pkg-1.19.2-0-fabric" = _jkoGt8Ta;
        "pkg-1.19.2-0-forge" = _aqeIcvWh;
        "pkg-1.19.3-0-fabric" = _a8KdrJIZ;
        "pkg-1.19.3-0-forge" = _O9rhU9xz;
        "pkg-1.19.4-0-fabric" = _ZVOdfgKB;
        "pkg-1.19.4-0-forge" = _xmFGEnrH;
        "pkg-1.20-0-fabric" = _DqO0hoHa;
        "pkg-1.20-0-forge" = _sBWxBDJq;
        "pkg-1.20.1-0-fabric" = _5dnrcLQH;
        "pkg-1.20.1-0-forge" = _cSi8Q5I0;
        "pkg-1.20.2-0-fabric" = _yzbitSt5;
        "pkg-1.20.2-0-forge" = _4L84s9xo;
        "pkg-1.20.3-0" = _MagXGCiR;
        "pkg-1.20.4-0" = _SxQl55nY;
        "pkg-1.20.6-11-forge" = _4JbyhKZh;
        "pkg-1.21-11-forge" = _CjtJfJ4A;
        "default" = _CjtJfJ4A;
    });
