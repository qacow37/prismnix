...
let
    ...
    in {
        ...
        "pkg-3.1.5" = _1G2Ncb01;
        "pkg-2.6.2" = _WhXwZ39b;
        "pkg-fabric-1.20.1-2.7.0" = _zS3KSjJx;
        "pkg-forge-1.20.1-2.7.0" = _YL6OAOx9;
        "pkg-fabric-1.21.1-2.7.0" = _WRWvd0bC;
        "pkg-neoforge-1.21.1-2.7.0" = _UXyBHcun;
        "pkg-fabric-1.21.4-2.7.0" = _51NdQp7g;
        "pkg-neoforge-1.21.4-2.7.0" = _ovICkvRb;
        "pkg-fabric-1.20.1-3.2.0" = _793lfjOj;
        "pkg-forge-1.20.1-3.2.0" = _TwhIKwDy;
        "pkg-neoforge-1.21.1-3.2.0" = _Yhv0VF0b;
        "pkg-fabric-1.21.4-3.2.0" = _SmOnZ5SP;
        "pkg-fabric-1.21.1-3.2.0" = _Cundnlwo;
        "pkg-neoforge-1.21.4-3.2.0" = _TlsdY6e0;
        "pkg-fabric-1.20.1-3.2.1" = _N5FuhHQa;
        "pkg-forge-1.20.1-3.2.1" = _Zu7dNk3s;
        "pkg-fabric-1.21.1-3.2.1" = _g5ClYb0i;
        "pkg-fabric-1.21.4-3.2.1" = _egHsGMbY;
        "pkg-neoforge-1.21.1-3.2.1" = _bIWENRmF;
        "pkg-neoforge-1.21.4-3.2.1" = _6EWZmZkz;
        "pkg-fabric-1.20.1-3.2.2" = _Dew9O4UW;
        "pkg-forge-1.20.1-3.2.2" = _UIwP7SOk;
        "pkg-fabric-1.21.1-3.2.2" = _ndRgIowy;
        "pkg-fabric-1.21.4-3.2.2" = _1wpQB6t5;
        "pkg-neoforge-1.21.1-3.2.2" = _1OP4Tqox;
        "pkg-neoforge-1.21.4-3.2.2" = _HNuWmGZJ;
        "pkg-fabric-1.20.1-3.2.3" = _WOFdSRrW;
        "pkg-fabric-1.21.1-3.2.3" = _TbQeE2ZH;
        "pkg-neoforge-1.21.1-3.2.3" = _fSnS0mdE;
        "pkg-forge-1.20.1-3.2.3" = _7ZADuvYK;
        "pkg-fabric-1.21.4-3.2.3" = _pHe0cynJ;
        "pkg-neoforge-1.21.4-3.2.3" = _xqaNnRH9;
        "pkg-fabric-1.20.1-3.2.4" = _XMBnUEVm;
        "pkg-forge-1.20.1-3.2.4" = _qxJCcyt7;
        "pkg-fabric-1.21.1-3.2.4" = _reZpWthW;
        "pkg-neoforge-1.21.1-3.2.4" = _mSr72OSu;
        "pkg-fabric-1.21.4-3.2.4" = _b6olw7ta;
        "pkg-neoforge-1.21.4-3.2.4" = _bR9wJu0g;
        "pkg-fabric-1.21.1-3.2.5" = _Gbs1uX1S;
        "pkg-neoforge-1.21.1-3.2.5" = _smZacpGB;
        "pkg-forge-1.20.1-3.2.5" = _70Lw85rH;
        "pkg-fabric-1.20.1-3.2.5" = _CcA6NQAU;
        "pkg-fabric-1.21.4-3.2.5" = _eHw2qRRY;
        "pkg-neoforge-1.21.4-3.2.5" = _CvVP2dsb;
        "pkg-fabric-1.20.1-3.2.6" = _cuB90jEv;
        "pkg-forge-1.20.1-3.2.6" = _hT4BvY7X;
        "pkg-fabric-1.21.1-3.2.6" = _WjNK58Ca;
        "pkg-fabric-1.21.4-3.2.6" = _IV8ugoxv;
        "pkg-neoforge-1.21.1-3.2.6" = _s3RCNrPO;
        "pkg-neoforge-1.21.4-3.2.6" = _MuBXGgZm;
        "pkg-fabric-1.20.1-3.2.7" = _5TefwIQh;
        "pkg-neoforge-1.21.1-3.2.7" = _ags5uf57;
        "pkg-fabric-1.21.4-3.2.7" = _kBTYlJPn;
        "pkg-fabric-1.21.1-3.2.7" = _56hl82VD;
        "pkg-forge-1.20.1-3.2.7" = _RqISYrRK;
        "pkg-neoforge-1.21.4-3.2.7" = _GSpFFo4R;
        "pkg-fabric-1.20.1-3.2.8" = _BG14wWUx;
        "pkg-forge-1.20.1-3.2.8" = _p8EN0BZy;
        "pkg-neoforge-1.21.1-3.2.8" = _nM8oBmWN;
        "pkg-fabric-1.21.1-3.2.8" = _nn72niJY;
        "pkg-fabric-1.21.4-3.2.8" = _j328fIUR;
        "pkg-neoforge-1.21.4-3.2.8" = _MmLuTPa4;
        "pkg-fabric-1.20.1-3.2.9" = _THYs4mxe;
        "pkg-forge-1.20.1-3.2.9" = _o5XxSRjq;
        "pkg-fabric-1.21.1-3.2.9" = _kVsBTyoI;
        "pkg-fabric-1.21.4-3.2.9" = _k5fI5pvi;
        "pkg-neoforge-1.21.1-3.2.9" = _WfGEv8R3;
        "pkg-neoforge-1.21.4-3.2.9" = _jtbxq4nR;
        "pkg-fabric-1.20.1-3.2.10" = _WG6Qruw9;
        "pkg-forge-1.20.1-3.2.10" = _X6SxYqR0;
        "pkg-fabric-1.21.1-3.2.10" = _jJXAWoII;
        "pkg-neoforge-1.21.1-3.2.10" = _RSpTe5RF;
        "pkg-fabric-1.21.4-3.2.10" = _uo37CGMh;
        "pkg-neoforge-1.21.4-3.2.10" = _ARncH3Ij;
        "pkg-neoforge-1.21.1-3.3.1" = _pMyQvf1t;
        "pkg-fabric-1.21.1-3.3.1" = _yfsWM3ZH;
        "pkg-fabric-1.20.1-3.3.1" = _KiepFXCa;
        "pkg-forge-1.20.1-3.3.1" = _cYNPKbAp;
        "pkg-fabric-1.21.10-3.3.1" = _TQKgk865;
        "pkg-neoforge-1.21.10-3.3.1" = _mSEL2jCl;
        "pkg-neoforge-1.21.4-3.3.1" = _6qmidhcM;
        "pkg-neoforge-1.21.8-3.3.1" = _kLMnT6vz;
        "pkg-fabric-1.21.4-3.3.1" = _OnBxcFNM;
        "pkg-fabric-1.21.8-3.3.1" = _3FmjeTEw;
        "pkg-neoforge-1.21.1-3.3.2" = _ejSJKKT2;
        "pkg-fabric-1.21.1-3.3.2" = _6UrsnhtW;
        "pkg-fabric-1.21.10-3.3.2" = _Y1kSM41I;
        "pkg-fabric-1.20.1-3.3.2" = _sjOeK9Ja;
        "pkg-neoforge-1.21.10-3.3.2" = _pxXWCUCM;
        "pkg-forge-1.20.1-3.3.2" = _znE8pHMR;
        "pkg-neoforge-1.21.4-3.3.2" = _kznnHrJ4;
        "pkg-fabric-1.21.4-3.3.2" = _UP7JEZbo;
        "pkg-fabric-1.21.8-3.3.2" = _5qddkkH0;
        "pkg-neoforge-1.21.8-3.3.2" = _7X9wjV6U;
        "pkg-fabric-1.21.1-3.4.0" = _Uu8btuAY;
        "pkg-neoforge-1.21.1-3.4.0" = _fiUIVwFl;
        "pkg-fabric-1.21.10-3.4.0" = _Hk1Mceey;
        "pkg-fabric-1.20.1-3.4.0" = _eoGIVG44;
        "pkg-forge-1.20.1-3.4.0" = _riC7s7kS;
        "pkg-neoforge-1.21.10-3.4.0" = _4LNFxXgA;
        "pkg-fabric-1.21.4-3.4.0" = _Ak13ZUbV;
        "pkg-neoforge-1.21.4-3.4.0" = _Ie8fvUYp;
        "pkg-neoforge-1.21.8-3.4.0" = _Dz2LIvYR;
        "pkg-fabric-1.21.8-3.4.0" = _ptKl4Mud;
        "pkg-neoforge-1.21.1-3.4.1" = _bfcauO8f;
        "pkg-neoforge-1.21.1-3.4.2" = _OPvGUun0;
        "pkg-fabric-1.21.1-3.4.2" = _5GVT1Bel;
        "pkg-fabric-1.20.1-3.4.2" = _M6qHQUpl;
        "pkg-fabric-1.21.10-3.4.2" = _9hCH8YMu;
        "pkg-neoforge-1.21.10-3.4.2" = _IZQU5qyg;
        "pkg-fabric-1.21.4-3.4.2" = _vE4dCdaX;
        "pkg-neoforge-1.21.4-3.4.2" = _90XnVYye;
        "pkg-fabric-1.21.8-3.4.2" = _Rmk11Ox4;
        "pkg-neoforge-1.21.8-3.4.2" = _kQmjWBjO;
        "pkg-forge-1.20.1-3.4.2" = _tMxvARqV;
        "pkg-neoforge-1.21.1-3.4.3" = _nDPH2dwf;
        "pkg-fabric-1.21.10-3.4.3" = _Zs6crk7w;
        "pkg-fabric-1.20.1-3.4.3" = _rJH6GtQc;
        "pkg-fabric-1.21.1-3.4.3" = _Onrto8gc;
        "pkg-neoforge-1.21.10-3.4.3" = _bPVfE4gR;
        "pkg-neoforge-1.21.11-3.4.3" = _hopV1i3V;
        "pkg-fabric-1.21.4-3.4.3" = _egpI7H8L;
        "pkg-forge-1.20.1-3.4.3" = _yQKdlIfG;
        "pkg-fabric-1.21.11-3.4.3" = _UDOBshQg;
        "pkg-neoforge-1.21.4-3.4.3" = _mHMCgIb3;
        "pkg-fabric-1.21.8-3.4.3" = _FlUFxSF3;
        "pkg-neoforge-1.21.8-3.4.3" = _miBa13ny;
        "pkg-neoforge-1.21.1-3.4.4" = _PGVVOOIf;
        "pkg-fabric-1.20.1-3.4.4" = _IYSvirVs;
        "pkg-fabric-1.21.1-3.4.4" = _k2eJ5ykG;
        "pkg-forge-1.20.1-3.4.4" = _GOcg3F8h;
        "pkg-fabric-1.20.1-3.4.5" = _lIAkaKXX;
        "pkg-fabric-1.21.1-3.4.5" = _Mfk5QaRZ;
        "pkg-neoforge-1.21.1-3.4.5" = _kErng9Gq;
        "pkg-forge-1.20.1-3.4.5" = _Jga9VPT6;
        "pkg-fabric-1.21.4-3.4.5" = _JDtEP7By;
        "pkg-neoforge-1.21.4-3.4.5" = _g8Fy0bdN;
        "pkg-fabric-1.21.8-3.4.5" = _pwMR8N0j;
        "pkg-neoforge-1.21.8-3.4.5" = _pbJzUj7f;
        "pkg-fabric-1.20.1-3.4.6" = _qHf7rOIa;
        "pkg-forge-1.20.1-3.4.6" = _QvhDdnKe;
        "pkg-neoforge-1.21.1-3.4.7" = _lsOrQAr5;
        "pkg-fabric-1.20.1-3.4.7" = _J98NuwDd;
        "pkg-fabric-1.21.1-3.4.7" = _v9vImeBE;
        "pkg-fabric-1.21.10-3.4.7" = _evvYuxar;
        "pkg-neoforge-1.21.10-3.4.7" = _TBu5xgy1;
        "pkg-forge-1.20.1-3.4.7" = _lJW4wb7b;
        "pkg-fabric-1.21.11-3.4.7" = _HbN5x0R1;
        "pkg-neoforge-1.21.11-3.4.7" = _kvalvUhQ;
        "pkg-neoforge-1.21.4-3.4.7" = _dgqWQsII;
        "pkg-fabric-1.21.4-3.4.7" = _7efkFb3u;
        "pkg-neoforge-1.21.8-3.4.7" = _F2kR6gNa;
        "pkg-fabric-1.21.8-3.4.7" = _UY9bSg1K;
        "default" = _UY9bSg1K;
    });
