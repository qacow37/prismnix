...
let
    ...
    in {
        ...
        "pkg-1.0-SNAPSHOT" = _FyJJAdwb;
        "pkg-0.1" = _pvEW36Vw;
        "pkg-0.1.2" = _qRa5t8JK;
        "pkg-0.1.3(1.20.6-)" = _20WEKpIV;
        "pkg-0.1.3(1.21)" = _Tb4KsABl;
        "pkg-0.1.5" = _Y1gBbagD;
        "pkg-0.1.6" = _aJZgyzAu;
        "pkg-0.1.7" = _mSSAYoUM;
        "pkg-0.1.8" = _P4XN5DqB;
        ...
        "pkg-0.3.7" = _D8vEhJX1;
        "pkg-0.3.8" = _KO2uL2uT;
        "pkg-0.3.8-1.20.4" = _YViFtQu8;
        "pkg-0.3.9" = _kUl3lUIl;
        "pkg-0.3.9-1.20.4" = _qWz8mlxh;
        "pkg-0.4.1" = _Sh6NkLQ7;
        "pkg-0.4.1-1.20.4" = _KKPXK3WO;
        "pkg-0.4.2" = _IoQWZCUM;
        "pkg-0.4.2-1.20.4" = _M3upuFw1;
        "pkg-0.4.3" = _1v0i9MuF;
        "pkg-0.4.4" = _HXmK8EIh;
        "pkg-0.4.3-1.20.4" = _LChcFS1a;
        "pkg-0.4.5" = _AIjraoQL;
        "pkg-0.4.6" = _WFRd7mZK;
        "pkg-0.4.4-1.20.4" = _FBERGrQy;
        "pkg-0.4.9(alpha)-1.20.4" = _XWDMqSXG;
        "pkg-0.4.7" = _uiQzCFsI;
        "pkg-0.4.8" = _Vh4U5bpJ;
        "pkg-0.4.9" = _y99dHm5e;
        "pkg-0.5" = _b7KY2eox;
