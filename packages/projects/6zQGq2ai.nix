...
let
    ...
    in {
        ...
        "pkg-1.19.4-1.0.0" = _EPuV9ohx;
        "pkg-1.20.1-1.0.0" = _fkmhjBR6;
        "pkg-1.20-1.0.0" = _YSZlnqDw;
        "pkg-1.20.1-1.1.0" = _JjSXyNOE;
        "pkg-1.20.2-1.1.0" = _KbKPhmyJ;
        "pkg-1.20-1.1.0" = _QoPkEvR7;
        "pkg-1.20.1-1.2.0" = _RyOByA7D;
        "pkg-1.20-1.2.0" = _QswhhhKA;
        "pkg-1.20.2-1.2.0" = _3WVjbMGb;
        "pkg-1.20.3-1.2.0" = _EfN6IlE3;
        "pkg-1.20.4-1.2.0" = _c36ub4RG;
        "pkg-1.20-1.2.1" = _8CjF70CD;
        "pkg-1.20.1-1.2.1" = _4O8rCMvx;
        "pkg-1.20.2-1.2.1" = _rMQgsNbj;
        "pkg-1.20.3-1.2.1" = _N3bXyHSG;
        "pkg-1.20.4-1.2.1" = _E5jXJFvr;
        "pkg-1.20-1.3" = _QoO3W8V2;
        "pkg-1.20.1-1.3" = _nLUnDEAX;
        "pkg-1.20.2-1.3" = _g8zNWrjT;
        "pkg-1.20.3-1.3" = _hOLxqCf8;
        "pkg-1.20.4-1.3" = _TUfL9pAW;
        "pkg-1.20.1-1.4.0" = _XS9e6jC4;
        "pkg-1.20.4-1.4.0" = _iGAStqqG;
        "pkg-1.20.1-1.4.1" = _HBlRDrS6;
        "pkg-1.20.4-1.4.1" = _TzuYfEgE;
        "default" = _TzuYfEgE;
    });
