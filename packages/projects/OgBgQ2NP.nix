...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.21.1" = _8pZAF8jh;
        "pkg-1.0.1-1.21.1" = _48VRfDgn;
        "pkg-1.0.2-1.21.1" = _usCLlxEK;
        "pkg-1.1.0-1.21.1" = _L4LCHU6S;
        "pkg-1.1.0-1.21.4" = _REuVtjs7;
        "pkg-1.1.0-1.21.5" = _lGspwY6Y;
        "pkg-2.0.0-1.20.1" = _D9RsRuyr;
        "pkg-2.0.0-1.21.1" = _EuADsFj5;
        "pkg-2.0.0-1.21.5" = _kvL76P9J;
        "pkg-2.0.0-1.21.8" = _w29l47P0;
        "pkg-2.0.0-1.21.10" = _WfhdH8fl;
        "pkg-2.0.1-1.20.1" = _2tI9CLPP;
        "pkg-2.0.1-1.21.1" = _d8XGq36F;
        "pkg-2.0.1-1.21.5" = _3HvkzJGU;
        "pkg-2.0.1-1.21.8" = _b6bj33OD;
        "pkg-2.0.1-1.21.10" = _CWypeiHa;
        "pkg-2.0.1-1.21.11" = _Yyq4JWVN;
        "pkg-2.1.0-1.20.1" = _KNbnDBJl;
        "pkg-2.1.0-1.21.1" = _8FptKu18;
        "pkg-2.1.0-1.21.11" = _tLwzoohA;
        "pkg-2.2.0-1.20.1" = _WvS6LzuK;
        "pkg-2.2.0-1.21.1" = _7szwK1Gd;
        "pkg-2.2.0-1.21.11" = _v59W9OWZ;
        "pkg-2.2.1-1.20.1" = _TYqOELET;
        "pkg-2.2.1-1.21.1" = _CHNT8997;
        "pkg-2.2.1-1.21.11" = _kVt37vpv;
        "pkg-2.2.1-26.1.2" = _2BVeCJ0q;
        "pkg-2.2.1-26.2" = _MWtfwPhA;
        "pkg-2.2.2-1.20.1" = _cSqhy1jY;
        "pkg-2.2.2-1.21.1" = _pLSIbSfl;
        "pkg-2.2.2-1.21.11" = _up7oryn1;
        "pkg-2.2.2-26.1.2" = _ls1xUZYO;
        "pkg-2.2.2-26.2" = _z8TfeNFY;
        "default" = _z8TfeNFY;
    });
