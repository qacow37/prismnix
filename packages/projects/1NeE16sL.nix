...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.21.8" = _57sbRuE5;
        "pkg-1.0.2+1.21.8" = _oXJfiTYy;
        "pkg-1.0.2+1.21.1" = _MLnyTMq6;
        "pkg-1.0.3+1.21.8" = _YkeuiSHD;
        "pkg-1.0.3+1.21.1" = _yHkl9BAv;
        "pkg-1.0.4+1.21.1" = _lDSLUpLE;
        "pkg-1.0.4+1.21.8" = _qinSvqX1;
        "pkg-1.0.5+1.21.1" = _tCwruHHn;
        "pkg-1.0.5+1.21.8" = _Zcpt7LWv;
        "pkg-1.0.5+1.21.10" = _8LX5D2Yg;
        "pkg-1.0.6+1.21.10-neoforge" = _fiCwA8Ic;
        "pkg-1.0.6+1.21.1-neoforge" = _hltWXzpH;
        "pkg-1.0.6+1.21.1-fabric" = _CMXOnuNw;
        "pkg-1.0.6+1.21.10-fabric" = _UzIsJNV8;
        "pkg-1.1.0+1.21.11-neoforge" = _XkGKDMVd;
        "pkg-1.1.0+1.21.1-neoforge" = _QfAe7qRO;
        "pkg-1.1.0+1.21.10-neoforge" = _QQSega9e;
        "pkg-1.1.0+1.21.11-fabric" = _4HKIYreL;
        "pkg-1.1.0+1.21.10-fabric" = _n5EJxb0m;
        "pkg-1.1.0+1.21.1-fabric" = _m8CwFsS5;
        "pkg-1.2.0+1.21.11-neoforge" = _qhFWfoPr;
        "pkg-1.2.0+1.21.1-neoforge" = _3ywYz3xA;
        "pkg-1.2.0+1.21.1-fabric" = _iVtvx2kF;
        "pkg-1.2.0+1.21.11-fabric" = _YrUOwfIu;
        "pkg-1.2.1+26.1-neoforge" = _lnoJ9m3m;
