...
let
    ...
    in {
        ...
        "pkg-1802.1.13-build.175" = _mkLXaVP4;
        "pkg-1802.1.14-build.206+fabric" = _9nOxKhZD;
        "pkg-1802.1.14-build.206+forge" = _L93DX9JE;
        "pkg-1802.1.14-build.209+fabric" = _IGgMuhcx;
        "pkg-1802.1.14-build.209+forge" = _TxJqYAQy;
        "pkg-1802.1.14-build.225+fabric" = _ayMmZeEm;
        "pkg-1802.1.14-build.225+forge" = _GAnMlPyj;
        "pkg-1802.2.0-build.232+fabric" = _XHnNV9Q5;
        "pkg-1802.2.0-build.232+forge" = _3gaqIhQ4;
        "pkg-1802.2.1-build.240+fabric" = _torEfDK1;
        "pkg-1802.2.1-build.240+forge" = _TzuDY0hA;
        "pkg-1902.2.1-build.242+fabric" = _x03x5BR7;
        "pkg-1902.2.1-build.242+forge" = _8Zo9Lc7Q;
        "pkg-1802.2.1-build.248+fabric" = _A6ZdBR7h;
        "pkg-1802.2.1-build.248+forge" = _OcCUPm56;
        "pkg-1902.2.1-build.247+fabric" = _GsdT2QWq;
        "pkg-1902.2.1-build.247+forge" = _MxTuO7W6;
        "pkg-1802.2.1-build.252+fabric" = _VBYN93Fl;
        "pkg-1802.2.1-build.252+forge" = _DzVyaTra;
        "pkg-1902.2.1-build.250+fabric" = _IBVvZWb5;
        "pkg-1902.2.1-build.250+forge" = _WhLMAlAG;
        "pkg-1802.2.1-build.255+fabric" = _bsrlks7Z;
        "pkg-1802.2.1-build.255+forge" = _N59eFKIq;
        "pkg-1902.2.1-build.257+fabric" = _Q32ivykp;
        "pkg-1902.2.1-build.257+forge" = _8dU2hkcu;
        "pkg-1902.2.2-build.261+fabric" = _lqNrgBQh;
        "pkg-1902.2.2-build.261+forge" = _LeJNG881;
        "pkg-1902.2.2-build.264+fabric" = _7nlytiXr;
        "pkg-1902.2.2-build.264+forge" = _5RVy11TO;
        "pkg-1902.2.2-build.268+fabric" = _BF7Q43Mc;
        "pkg-1902.2.2-build.268+forge" = _jvqq7lUX;
        "pkg-1902.2.2-build.272+fabric" = _FWhq0g2w;
        "pkg-1902.2.2-build.272+forge" = _NX25xYm2;
        "pkg-2001.2.2-build.6+fabric" = _PN90O3BT;
        "pkg-2001.2.2-build.6+forge" = _Cr8aUCZp;
        "pkg-2001.2.2-build.11+fabric" = _335Xyflr;
        "pkg-2001.2.2-build.11+forge" = _1gjp5zCo;
        "pkg-1902.2.2-build.280+fabric" = _WxH1u1SQ;
        "pkg-1902.2.2-build.280+forge" = _hvyivMiC;
        "pkg-2001.2.2-build.13+fabric" = _yu10djrf;
        "pkg-2001.2.2-build.13+forge" = _GUjMpbXQ;
        "pkg-2001.2.2-build.18+fabric" = _d6aWp117;
        "pkg-2001.2.2-build.18+forge" = _w5HiejeN;
        "pkg-1902.2.2-build.282+fabric" = _N2JuTimR;
        "pkg-1902.2.2-build.282+forge" = _VlIGn2gd;
        "pkg-1902.2.3-build.284+fabric" = _Q5RjCKEJ;
        "pkg-1902.2.3-build.284+forge" = _6m33q64a;
        "pkg-2005.2.3-build.1+Rhino-1.20.5" = _Zwt8lXe1;
        "pkg-2005.2.3-build.3+Rhino-1.20.5" = _EvsmKGvD;
        "pkg-2100.2.5-build.32+Rhino-1.21" = _D6NSAjTk;
        "pkg-2100.2.5-build.34+Rhino-1.21" = _ZXP4vo5I;
        "pkg-2100.2.5-build.41+Rhino-1.21" = _XKFFDgCU;
        "pkg-2100.2.5-build.44+Rhino-1.21" = _x09siBAL;
        "pkg-2100.2.5-build.46+Rhino-1.21" = _1a0qGwYf;
        "pkg-2100.2.5-build.48+Rhino-1.21" = _m3qP2AdB;
        "pkg-2001.2.2-build.2+fabric" = _ANnmwRcY;
        "pkg-2001.2.2-build.2+forge" = _HwNk41j5;
        "pkg-2001.2.3-build.4+fabric" = _ywLbkc4T;
        "pkg-2001.2.3-build.4+forge" = _5F4uy0yx;
        "pkg-2001.2.3-build.6+fabric" = _WradV9Zu;
        "pkg-2001.2.3-build.6+forge" = _maCpsT70;
        "pkg-2101.2.5-build.52+Rhino-1.21" = _9lnFoT3R;
        "pkg-2101.2.5-build.54+Rhino-1.21" = _kox3FBVc;
        "pkg-2101.2.6-build.56+Rhino-1.21" = _QHSbxlEq;
        "pkg-2101.2.6-build.58+Rhino-1.21" = _HeujSN8O;
        "pkg-2101.2.6-build.60+Rhino-1.21" = _Uf20A4mQ;
        "pkg-2101.2.6-build.66+Rhino-1.21" = _hSZnqZO1;
        "pkg-2101.2.7-build.74+Rhino-1.21" = _6ClRsUNJ;
        "pkg-2001.2.3-build.10+fabric" = _MLIu0Tct;
        "pkg-2001.2.3-build.10+forge" = _uNALdylI;
        "pkg-2101.2.7-build.77+Rhino-1.21" = _KobrWfUm;
        "pkg-2101.2.7-build.81+Rhino-1.21" = _ZdLtebKH;
        "pkg-2101.2.7-build.85+Rhino-1.21" = _cQ4POTah;
        "pkg-2101.2.8-build.91+Rhino-1.21" = _SqkDvOLG;
        "default" = _SqkDvOLG;
    });
