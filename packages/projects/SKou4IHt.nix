...
let
    ...
    in {
        ...
        "pkg-1+mod" = _lNBvrE09;
        "pkg-1.1" = _2MFPt70T;
        "pkg-1.1+mod" = _XtL8jRqH;
        "pkg-1.2" = _E9Q5UIKY;
        "pkg-1.2+mod" = _SHN1rzB4;
        "pkg-1.3" = _9ptfntCp;
        "pkg-1.3+mod" = _xcAyteft;
        "pkg-1.3.2" = _VUh0f6cQ;
        "pkg-1.3.2+mod" = _i8cTJdHr;
        "pkg-1.4" = _2cMFDcwJ;
        "pkg-1.4+mod" = _FUYkens9;
        "pkg-1.5" = _h7vGChFI;
        "pkg-1.5+mod" = _V3JYsCil;
        "pkg-1.6" = _GuE5IuKS;
        "pkg-1.6+mod" = _1BQ7CUxb;
        "pkg-1.7" = _PSbCGq08;
        "pkg-1.7+mod" = _sazjB1ns;
        "pkg-1.8-beta" = _34Az5qJT;
