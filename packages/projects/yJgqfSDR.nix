...
let
    ...
    in {
        ...
        "pkg-0.0.1" = _jCwG6ubU;
        "pkg-0.0.2+" = _q4dvTcpJ;
        "pkg-0.0.4+1.20.2" = _OdxRGAqg;
        "pkg-0.1.0+1.20.4" = _hLuw4E3c;
        "pkg-0.1.1+1.20.4" = _5yFA1eyP;
        "pkg-0.2.0+1.20.5" = _oPpertnv;
        "pkg-0.3.0+1.20.6" = _prqJKCjg;
        "pkg-0.4.0+1.21" = _lLtAB3CZ;
        "pkg-0.4.1+1.21" = _MfWnbbBf;
        "pkg-0.5.0+1.21.1" = _IBlpEt2E;
        "pkg-0.7.0+1.21.3" = _ykZ4wgIC;
        "pkg-0.8.0+1.21.4" = _c68UhsCH;
        "pkg-0.9.0+1.21.5" = _9U4TVf3r;
        "pkg-0.10.0+1.21.6" = _BDu1dxZB;
        "pkg-0.11.0+1.21.7" = _jZqNveyG;
        "pkg-0.12.0+1.21.8" = _qiuI1Fye;
        "pkg-0.13.0+1.21.9" = _9TRh54pY;
        "pkg-1.14.0+1.21.10" = _neG3Wy57;
        "pkg-1.15.0+1.21.11" = _7iTREKj4;
        "pkg-1.16.0+1.21.11" = _b0ARn81v;
        "pkg-1.16.1+1.21.11" = _nFIfEnF1;
        "pkg-0.3.1+1.20.6" = _63JOQltl;
        "pkg-1.17.0+26.1" = _kf4cBdoP;
        "pkg-1.18.0+26.1.1" = _Fl4BY3QS;
        "pkg-1.19.0+26.1.2" = _jOUi8kaC;
        "pkg-1.20.0+26.2" = _FEYRkH2m;
        "default" = _FEYRkH2m;
    });
