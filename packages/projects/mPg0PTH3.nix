...
let
    ...
    in {
        ...
        "pkg-0.1-1.20-fabric" = _MktJkEKk;
        "pkg-0.1-1.20-forge" = _veZ0iB2X;
        "pkg-0.2-1.20-fabric" = _8KiRt6M8;
        "pkg-0.2-1.20-forge" = _TpSuPDbQ;
        "pkg-0.3-1.20-fabric" = _MkvbI6ax;
        "pkg-0.3-1.20-forge" = _9X7rICJx;
        "pkg-0.3-1.20.1-fabric" = _y4OWQbyx;
        "pkg-0.3-1.20.1-forge" = _nMOGAW8r;
        "pkg-0.3-1.20.2-fabric" = _eOLizsNb;
        "pkg-0.3-1.20.2-forge" = _4hOAM3Ir;
        "pkg-0.4-1.20-fabric" = _1GIE4VJ0;
        "pkg-0.4-1.20-forge" = _CPxbk8nB;
        "pkg-0.4-1.20.1-fabric" = _MBn5Aeeb;
        "pkg-0.4-1.20.1-forge" = _ejgQXFyD;
        "pkg-0.4-1.20.2-fabric" = _THcmjvAd;
        "pkg-0.4-1.20.2-forge" = _9BTYSYaK;
        "pkg-0.4.1-1.19.3-fabric" = _4yskTKlx;
        "pkg-0.4.1-1.19.3-forge" = _9QipVTj2;
        "pkg-0.4.1-1.19.4-fabric" = _x1v7w48h;
        "pkg-0.4.1-1.19.4-forge" = _A13OuJHQ;
        "pkg-0.4.1-1.20-fabric" = _c4Yung2l;
        "pkg-0.4.1-1.20-forge" = _T1pwNLJy;
        "pkg-0.4.1-1.20.1-fabric" = _orkqZqzE;
        "pkg-0.4.1-1.20.1-forge" = _cTWrrh9r;
        "pkg-0.4.1-1.20.2-fabric" = _mRZS4Gla;
        "pkg-0.4.1-1.20.2-forge" = _8RkIGYyh;
        "pkg-0.5-1.20-fabric" = _YT0VI2GS;
        "pkg-0.5-1.20-forge" = _LGUrkp6R;
        "pkg-0.6-1.20-fabric" = _rgaO2tq9;
        "pkg-0.6-1.20-forge" = _VLyeDJxW;
        "pkg-0.7-1.20-fabric" = _RbBd9db2;
        "pkg-0.7-1.20-forge" = _6iGTTGJ5;
        "pkg-0.7-1.20.1-fabric" = _9IF1Iqw4;
        "pkg-0.7-1.20.1-forge" = _bwOoz27O;
        "pkg-0.7-1.20.2-fabric" = _T4ikYKqX;
        "pkg-0.7-1.20.2-forge" = _Tucial4V;
        "pkg-0.7-1.19.4-fabric" = _xfz13CoS;
        "pkg-0.7-1.19.4-forge" = _CsYOvmA2;
        "pkg-0.7-1.19.3-fabric" = _walYXwux;
        "pkg-0.7-1.19.3-forge" = _IHiI9Vc7;
        "pkg-0.7-1.19-fabric" = _2sBlBnzE;
        "pkg-0.7-1.19-forge" = _423GBgnl;
        "pkg-0.7-1.19.1-fabric" = _507eE48O;
        "pkg-0.7-1.19.1-forge" = _Ve5UKUb1;
        "pkg-0.7-1.19.2-fabric" = _FMzRKDuf;
        "pkg-0.7-1.19.2-forge" = _4KZWSucy;
        "pkg-0.8-1.19.3-fabric" = _JCGwDRht;
        "pkg-0.8-1.19.3-forge" = _3b0nqVrb;
        "pkg-0.8-1.19.4-fabric" = _aY2tmwYv;
        "pkg-0.8-1.19.4-forge" = _13koSKay;
        "pkg-0.8-1.20-fabric" = _boAr8NiY;
        "pkg-0.8-1.20-forge" = _CNnWsBGH;
        "pkg-0.8-1.20.1-fabric" = _qHVYuVPL;
        "pkg-0.8-1.20.1-forge" = _fgqxQRR9;
        "pkg-0.8-1.20.2-fabric" = _Ej9IOxov;
        "pkg-0.8-1.20.2-forge" = _mQ4dVkvl;
        "pkg-0.9-1.19.3-fabric" = _pSSIVik7;
        "pkg-0.9-1.19.3-forge" = _MlYRgEP6;
        "pkg-0.9-1.19.3-quilt" = _tgxXZIO8;
        "pkg-0.9-1.19.4-fabric" = _dZNIZG3q;
        "pkg-0.9-1.19.4-forge" = _1aOYLhEv;
        "pkg-0.9-1.19.4-quilt" = _ygkKKiDP;
        "pkg-0.9-1.20.1-fabric" = _siA3RtE5;
        "pkg-0.9-1.20.1-forge" = _se6geBFR;
        "pkg-0.9-1.20.1-quilt" = _YnbYMYbw;
        "pkg-0.9-1.20.2-fabric" = _yJ3BeTjV;
        "pkg-0.9-1.20.2-forge" = _Is49Fdqh;
        "pkg-0.9-1.20-fabric" = _rnmAPeW1;
        "pkg-0.9-1.20-forge" = _FrTlXhVD;
        "pkg-0.9-1.20-quilt" = _2dVHPbDr;
        "pkg-0.10-1.19.3-fabric" = _pzarxrde;
        "pkg-0.10-1.19.3-forge" = _vXq2aC7Y;
        "pkg-0.10-1.19.3-quilt" = _4I4YdkM8;
        "pkg-0.10-1.19.4-fabric" = _dGK9MWFD;
        "pkg-0.10-1.19.4-forge" = _pTTVy4YG;
        "pkg-0.10-1.19.4-quilt" = _6oNHLAn0;
        "pkg-0.10-1.20-fabric" = _b1OzzpAh;
        "pkg-0.10-1.20-forge" = _Orzw6Hbk;
        "pkg-0.10-1.20-quilt" = _CmhY4HwF;
        "pkg-0.10-1.20.1-fabric" = _xoOiW6rx;
        "pkg-0.10-1.20.1-forge" = _VDhMTJMU;
        "pkg-0.10-1.20.1-quilt" = _LJ6i0ZNG;
        "pkg-0.10-1.20.2-fabric" = _qgQBBzY8;
        "pkg-0.10-1.20.2-forge" = _uvrSumWX;
        "pkg-0.10-1.20.2-neoforge" = _S6pSDhlZ;
        "pkg-0.10-1.20.4-fabric" = _StBfGdbF;
        "pkg-0.10-1.20.4-forge" = _CwzQsWee;
        "pkg-0.10-1.20.4-neoforge" = _cLGTBCdO;
        "pkg-0.10.1-test-1.19.3-forge" = _kiieVwzW;
        "pkg-0.10.1-test-1.19.3-fabric" = _IGCd1vn2;
        "pkg-0.10.1-1.19.3-fabric" = _qPImGapN;
        "pkg-0.10.1-1.19.3-forge" = _wDCd4KZQ;
        "pkg-0.10.1-1.19.3-quilt" = _bVIxJtaU;
        "pkg-0.10.1-1.19.4-fabric" = _2fRqvvYA;
        "pkg-0.10.1-1.19.4-forge" = _fL1bzemM;
        "pkg-0.10.1-1.19.4-quilt" = _gRuQQyf0;
        "pkg-0.10.1-1.20.1-fabric" = _oTZkEDGo;
        "pkg-0.10.1-1.20.1-forge" = _PeXvgrvz;
        "pkg-0.10.1-1.20.1-quilt" = _nfvd8fGV;
        "pkg-0.10.1-1.20.2-fabric" = _RPxfFHMc;
        "pkg-0.10.1-1.20.2-forge" = _4zZvObOK;
        "pkg-0.10.1-1.20.4-fabric" = _4ahWexjA;
        "pkg-0.10.1-1.20.4-forge" = _tkktkvo1;
        "pkg-0.10.1-1.20.4-neoforge" = _uDW4u426;
        "pkg-0.10.1-1.20-fabric" = _C1wzIPoF;
        "pkg-0.10.1-1.20-forge" = _D8KkVolC;
        "pkg-0.10.1-1.20-quilt" = _Cvtlx969;
        "pkg-0.10.1-1.20.2-neoforge" = _toyGDcDp;
        "default" = _toyGDcDp;
    });
