...
let
    ...
    in {
        ...
        "pkg-5.5" = _9Rzv10vC;
        "pkg-6.0" = _SVwV6Wid;
        "pkg-6.0-1-_1.0" = _lYgl2sWa;
        "pkg-6.0-_1.21.10-.1.0" = _zuIeA4yK;
        "pkg-6.5" = _nw2IGWcK;
        "pkg-6.0-26.1.2-_1.5" = _4WcZGgYP;
        "pkg-6.5-_1.21.10-.1.5" = _TGgS9CNB;
        "pkg-26.1.2_7.0" = _incIeJ9B;
        "pkg-1.21.11_7.0" = _Z94TM3dF;
        "pkg-1.21.10_7.0" = _VuipG884;
        "pkg-26.1.2_7.5" = _T3HP0uSr;
        "pkg-1.21.11_7.5" = _JVuLtMgw;
        "pkg-1.21.10_7.5" = _W1v7NwN3;
        "pkg-26.1.2_8.0" = _hcmYQaAX;
        "pkg-1.21.11_8.0" = _8bWixNBz;
        "pkg-1.21.10_8.0" = _ncsQYI6P;
        "pkg-26.1.2_8.5" = _tg8Ry1Gw;
        "pkg-1.21.11_8.5" = _AemH0OSs;
        "pkg-1.21.10_8.5" = _dKIYMI8X;
        "pkg-26.1.2_9.0" = _2XDsOY95;
        "pkg-1.21.11_9.0" = _uml1Y4ux;
        "pkg-1.21.10_9.0" = _Hy7hJWUp;
        "pkg-1.0.17" = _r6fQrqro;
        "pkg-1.0.17_1" = _i20tZQfn;
        "default" = _i20tZQfn;
    });
