...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _ylSHgPKV;
        "pkg-1.0.1+mc1.21-1.21.5" = _p7j7uIer;
        "pkg-1.0.2+mc1.21-1.21.6" = _cGuQxgBa;
        "pkg-1.0.3+mc1.21-1.21.7" = _pEXbrYCh;
        "pkg-1.0.4+mc1.21-1.21.8" = _gTkQ2QqW;
        "pkg-1.0.5+mc1.21-1.21.8" = _O0XT62ck;
        "pkg-1.0.6+mc1.20.5-1.21.8" = _Hy4FAAAb;
        "pkg-1.0.6+hotfix+mc1.20.5-1.21.8" = _KTMtyuD7;
        "pkg-1.0.7+mc1.20.5-1.21.8" = _kmqB1kPB;
        "pkg-1.0.8+mc1.17-1.19.1" = _4MV9IEvt;
        "pkg-1.0.8+mc1.19.2-1.20.1" = _pJPuhToG;
        "pkg-1.0.8+mc1.20.2-1.20.4" = _VFK8Mm3B;
        "pkg-1.0.8+mc1.20.5-1.21.8" = _LqZ9j84b;
        "pkg-1.0.9+mc1.19.3-1.20.1" = _TKd52w2I;
        "pkg-1.0.9+mc1.20.5-1.21.8" = _EAJT4uFq;
        "pkg-1.0.10+mc1.20.5-1.21.9" = _VrD4rHJe;
        "pkg-1.0.11+mc1.20.5-1.21.10" = _kDVwK1uh;
        "pkg-1.0.11+mc1.18.2-1.20.1+forge" = _QYXIwu4N;
        "pkg-1.0.12+mc1.19.3-1.20.1" = _KfVkWq9D;
        "pkg-1.0.12+mc1.20.5-1.21.10" = _oGPg7ROO;
        "pkg-1.0.13+mc1.20.5-1.21.11" = _LR3UlE18;
        "pkg-1.0.13+hotfix+mc1.21-1.21.11" = _RB2yNcp5;
        "pkg-1.0.13+mc1.19.3-1.20.1" = _zRAqS06J;
        "pkg-1.0.14+mc1.19.3-1.20.1" = _rpLSDhs7;
        "pkg-1.0.14+mc1.21-1.21.11" = _tpkUNnlX;
        "pkg-1.1.0+mc1.20.1" = _DCiJd7rG;
        "pkg-1.1.0+mc1.21-1.21.11" = _MQNF8eAq;
        "pkg-1.1.1+mc1.20.1" = _GdZGZ0l3;
        "pkg-1.1.1+mc1.21-1.21.11" = _JgekedTR;
        "pkg-1.1.0+mc26.1" = _O9EcPVyp;
        "pkg-1.1.2+mc1.20.1" = _CwXIfrB0;
        "pkg-1.1.1+mc26" = _dVonFzVe;
        "pkg-1.1.2+mc1.21-1.21.11" = _endXjhx0;
        "pkg-1.1.2+mc26" = _VK1LkFnn;
        "default" = _VK1LkFnn;
    });
