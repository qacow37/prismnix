...
let
    ...
    in {
        ...
        "pkg-1.2.0" = _fKY5zkWz;
        "pkg-1.2.1" = _HExgjOqr;
        "pkg-1.3.0+1.18.2" = _CS1O3hSY;
        "pkg-2.0.0" = _z9yPuJ33;
        "pkg-2.1.0" = _2kBPnANn;
        "pkg-2.1.1" = _n13hCKyu;
        "pkg-2.1.2" = _cgEqOhr8;
        "pkg-2.2.0+1.19" = _nsVYyiwH;
        "pkg-2.2.0" = _jWMVQdZu;
        "pkg-2.2.3" = _IIKlspc0;
        "pkg-2.2.4" = _zubQVJDq;
        "pkg-2.2.4+1.21" = _Lsc3Pk9I;
        "pkg-2.2.5+1.21.1" = _Pxtm7pgf;
        "pkg-3.0.0+1.21.4" = _zIEsBS0e;
        "pkg-3.1.0+1.21.5" = _DHZ3XRxJ;
        "pkg-3.1.0+1.21.7" = _zYEb6qj1;
        "pkg-3.1.0+1.21.10" = _c3JOqf9m;
        "pkg-3.1.0+26.1" = _G9Oljtjl;
        "pkg-3.1.1+26.1" = _t82eeyB1;
        "pkg-3.2.0+26.2" = _Im9gI64u;
        "default" = _Im9gI64u;
    });
