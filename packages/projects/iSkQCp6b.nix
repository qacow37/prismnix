...
let
    ...
    in {
        ...
        "pkg-Forge-1.19.4-0.1.7" = _TM9KlpBK;
        "pkg-Forge-1.18.2-0.1.6" = _RPxLlCim;
        "pkg-Fabric-1.19.4-0.1.7" = _fyFKrpb4;
        "pkg-Fabric-1.18.2-0.1.6" = _BOXLKqcY;
        "pkg-1.18.2-0.2.0" = _TLUMbNJV;
        "pkg-1.19.4-0.2.0" = _j8tST994;
        "pkg-1.19.2-0.1.6" = _ZQNEdHUC;
        "pkg-1.20-0.2.0" = _7Q2Ahj2f;
        "pkg-1.20.1-0.2.0" = _sAdk4uhI;
        "pkg-1.20.1-0.2.1" = _oGYt9hjb;
        "pkg-1.20.1-0.2.2" = _DuWbl10x;
        "pkg-1.20.4-0.2.2" = _ipISwOY5;
        "pkg-1.20.4-0.2.3" = _Tx89lqTO;
        "pkg-1.19.4-0.2.3" = _cWGXCHZG;
        "pkg-1.18.2-0.2.3" = _mIEVqeDV;
        "pkg-1.19.2-0.2.4" = _UystJoI0;
        "pkg-1.20.1-0.2.4" = _iDZm0VL2;
        "pkg-1.20.4-0.2.4" = _pkg3i61G;
        "pkg-1.20.4-0.3.0" = _XNo5lNzP;
        "pkg-1.20.1-0.3.0" = _eXONHgcJ;
        "pkg-1.19.4-0.3.0" = _GBslZwpo;
        "pkg-1.19.2-0.3.0" = _tSscWtx3;
        "pkg-1.18.2-0.3.0" = _8evuKmet;
        "pkg-1.20.4-0.3.1" = _aMqFZCVW;
        "pkg-1.20.1-0.3.1" = _DCQKjXqf;
        "pkg-1.19.2-0.3.1" = _2q50AHaO;
        "pkg-1.18.2-0.3.1" = _szSHfB2g;
        "pkg-1.20.4-0.3.2" = _QmTGBChV;
        "pkg-1.20.1-0.3.2" = _PH3QFp5w;
        "pkg-1.19.2-0.3.2" = _nxHfpSMn;
        "pkg-1.18.2-0.3.2" = _MmYR1izy;
        "pkg-1.21.1-0.3.2" = _zwVO9sl3;
        "pkg-1.21.1-0.4.0" = _nV0q5j3l;
        "pkg-1.21.1-Neo-0.4.0" = _eJfr27xY;
        "pkg-1.20.1-0.4.0" = _E5auW75J;
        "pkg-1.20.1-Neo-0.4.0" = _jgJvtZiI;
        "pkg-1.20.1-0.4.0a" = _vcsAZ7Ma;
        "pkg-1.20.1-Neo-0.4.0a" = _LcbDTCwp;
        "default" = _LcbDTCwp;
    });
