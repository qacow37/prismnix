...
let
    ...
    in {
        ...
        "pkg-22" = _j3DpOHuK;
        "pkg-23" = _iHnA2BsG;
        "pkg-1.20.0-2.2.0" = _vm6q8bpt;
        "pkg-1.20.0-2.2.1" = _mrDgOrfx;
        "pkg-1.20.1-2.3.1" = _O4JYLIv6;
        "pkg-1.20.1-2.3.4" = _ijrOeHx2;
        "pkg-1.21.0-2.3.5" = _O7kn4Bzq;
        "pkg-1.21.1-2.3.8" = _EsIP6hb3;
        "pkg-1.21.1-2.4.2" = _dnoUh0Rf;
        "default" = _dnoUh0Rf;
    });
