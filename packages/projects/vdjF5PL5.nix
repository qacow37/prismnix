...
let
    ...
    in {
        ...
        "pkg-1.16.5-0.10.5" = _xfRW8BpS;
        "pkg-1.18.2-1.0.3" = _FBKBu64t;
        "pkg-1.19.2-1.1.0-BETA1" = _sCyEOH8T;
        "pkg-1.19.2-1.1.0-BETA2" = _YbGEmSKe;
        "pkg-1.19.2-1.1.0-BETA3" = _x9Cf6AuG;
        "pkg-1.19.2-1.1.0-BETA4" = _dbyjTTbg;
        "pkg-1.19.2-1.1.0-BETA5" = _uo0GeAkB;
        "pkg-1.18.2-1.0.4" = _8gAgdf1j;
        "pkg-1.19.2-1.1.0-BETA6" = _f9sQv8fx;
        "pkg-1.19.2-1.1.0-BETA7" = _lcv21qgC;
        "pkg-1.19.2-1.1.0-BETA8" = _yvkigxIq;
        "pkg-1.19.2-1.1.0-BETA9" = _pQ0f1IuY;
        "pkg-1.19.2-1.1.0-BETA10" = _6GQg0a8S;
        "pkg-1.19.2-1.2.0-BETA1" = _pTPEE0Dv;
        "pkg-1.20.1-1.3.0-BETA1" = _Sx2miOIR;
        "pkg-1.20.1-1.3.0-BETA2" = _CA4C6hBA;
        "pkg-1.19.2-1.2.0-BETA2" = _Qv5ECClE;
        "pkg-1.20.1-1.3.0-BETA3" = _AyvRO3P4;
        "pkg-1.19.2-1.2.0" = _Ynk06EXN;
        "pkg-1.20.1-1.3.0-BETA4" = _OYjluuHy;
        "pkg-1.20.1-1.3.0-BETA5" = _VNcwGHHG;
        "pkg-1.20.1-1.3.0-BETA6" = _gqfv3pqq;
        "pkg-1.19.2-1.2.1" = _XAcic5dk;
        "pkg-1.20.1-1.3.0-BETA7" = _xAmeN30y;
        "pkg-1.20.1-1.3.0-BETA8" = _SOi1k0nG;
        "pkg-1.20.1-1.3.0-BETA9" = _LOWCbCvY;
        "pkg-1.20.1-1.3.0-BETA10" = _GnJJOp7I;
        "pkg-1.20.1-1.3.0-BETA11" = _LipKJRFX;
        "pkg-1.20.1-1.3.0-BETA12" = _po6VTN46;
        "pkg-1.19.2-1.2.2" = _byXgtF59;
        "pkg-1.20.1-1.3.0-BETA13" = _xmk3WJO4;
        "pkg-1.20.1-1.3.0-BETA14" = _Wv2d1pla;
        "pkg-1.20.1-1.3.0" = _aztWYUe5;
        "pkg-1.20.1-1.3.1" = _UtJ3yahr;
        "pkg-1.20.1-1.3.2" = _g9ovHTPi;
        "pkg-1.20.1-1.3.3" = _AUOAU5de;
        "pkg-1.20.1-1.4.0-ALPHA02" = _H0l2y55T;
        "pkg-1.20.1-1.3.4" = _SlLG3IHV;
        "pkg-1.20.1-1.3.5" = _63Etyh65;
        "pkg-1.20.1-1.4.0-ALPHA03" = _lXlO4Ppx;
        "pkg-1.20.1-1.3.6" = _KYXeQ4Vx;
        "pkg-1.20.1-1.4.0-BETA01" = _K4IARPGS;
        "pkg-1.5.0-BETA01" = _DB2pRv6P;
        "pkg-1.20.1-1.4.0" = _oAmuTwVC;
        "pkg-1.5.0-BETA02" = _EDJ43S4b;
        "pkg-1.20.1-1.4.1" = _lapE8mRF;
        "pkg-1.5.0-BETA03" = _GN0T8Y4b;
        "pkg-1.5.0-BETA04" = _NybNPGNk;
        "pkg-1.20.1-1.4.2" = _6kAMcZrh;
        "pkg-1.20.1-1.4.3" = _cCwRZe17;
        "pkg-1.20.1-1.4.4" = _Klw2RmBT;
        "pkg-1.5.0-BETA05" = _vyasqDgt;
        "pkg-1.5.0-BETA06" = _UV7PSbaB;
        "pkg-1.5.0-BETA07" = _wsGaCWOx;
        "pkg-1.20.1-1.4.5" = _JmNKkurv;
        "pkg-1.5.0-BETA08" = _bxdpa2k2;
        "pkg-1.20.1-1.4.6" = _JdIdjMke;
        "pkg-1.20.1-1.4.7" = _XFTnlYsq;
        "pkg-1.5.0-BETA09" = _RosznvHG;
        "pkg-1.5.0-BETA10" = _qeJj0RAo;
        "pkg-1.5.0-BETA11" = _iOv1sz04;
        "pkg-1.5.0-BETA12" = _5wuJiRt7;
        "pkg-1.5.0-BETA13" = _r8ANn8Ml;
        "pkg-1.5.0" = _kBauWahu;
        "pkg-1.5.1" = _L4IzopyY;
        "pkg-1.20.1-1.4.8" = _9aYck5po;
        "pkg-1.6.0-BETA01" = _7eCBDJuI;
        "pkg-1.6.0-BETA03" = _2NXaE6II;
        "pkg-1.20.1-1.4.9" = _G7ma4wV5;
        "pkg-1.20.1-1.4.10" = _JAF7MM1b;
        "pkg-1.6.0-BETA04" = _Q1H59JJ7;
        "pkg-1.6.0" = _PvZqAQyF;
        "pkg-1.7.0" = _1sD1u4G2;
        "pkg-1.7.0-BETA1" = _QEQdbeww;
        "pkg-1.8.0-BETA01" = _lKKhabrI;
        "pkg-1.7.1" = _I4J1Vv2K;
        "pkg-1.7.1-BETA" = _w3Iejyxg;
        "pkg-1.20.1-1.4.11" = _iGSXZxgo;
        "pkg-1.7.2" = _G4uJ0UA0;
        "pkg-1.7.2-BETA" = _AejMebCy;
        "pkg-1.8.0-BETA03" = _49BjyewB;
        "pkg-1.8.0-BETA04" = _djcEepCM;
        "default" = _djcEepCM;
    });
