...
let
    ...
    in {
        ...
        "pkg-1.16.5-4.5-fabric" = _gI84Mxw3;
        "pkg-1.18.2-4.5-fabric" = _9HOxJxjU;
        "pkg-1.19.2-4.5-fabric" = _PjAuDbww;
        "pkg-1.16.5-4.5-forge" = _reNw3tsw;
        "pkg-1.18.2-4.5-forge" = _WCHfqfRg;
        "pkg-1.19.2-4.5-forge" = _POKgJr0D;
        "pkg-1.16.5-4.6-fabric" = _7rfkTzEK;
        "pkg-1.18.2-4.6-fabric" = _GDmDMXPL;
        "pkg-1.19.2-4.6-fabric" = _vqdmrDth;
        "pkg-1.19.3-4.7-fabric" = _eKQXLYj8;
        "pkg-1.19.3-4.5-forge" = _fU7To4M0;
        "pkg-1.18.2-5.0-forge+fabric" = _r342meqW;
        "pkg-1.19.2-5.0-forge+fabric" = _vVDdgTFo;
        "pkg-1.19.3-5.0-forge+fabric" = _lPrSr06w;
        "pkg-1.18.2-5.1-forge+fabric" = _Tr6rl40q;
        "pkg-1.19.2-5.1-forge+fabric" = _p9DRcusH;
        "pkg-1.19.3-5.1-forge+fabric" = _OriYTBAU;
        "pkg-1.18.2-5.2-forge+fabric" = _2CJcZtSX;
        "pkg-1.19.2-5.2-forge+fabric" = _1CSgCjx3;
        "pkg-1.19.3-5.2-forge+fabric" = _bEyeV2KW;
        "pkg-1.18.2-5.3-forge+fabric" = _gjC0UaWv;
        "pkg-1.19.2-5.3-forge+fabric" = _ve8BsX3I;
        "pkg-1.19.3-5.3-forge+fabric" = _rPxRtt0R;
        "pkg-1.18.2-5.4-forge+fabric" = _AAhrf1Vt;
        "pkg-1.19.2-5.4-forge+fabric" = _U1AMIim3;
        "pkg-1.19.3-5.4-forge+fabric" = _1EI96gUp;
        "pkg-1.19.4-5.4-forge+fabric" = _ZbjjnaAw;
        "pkg-1.19.4-5.5-forge+fabric" = _fJCKQKkA;
        "pkg-1.19.4-5.6-forge+fabric" = _p4XSBeFS;
        "pkg-1.20-5.6-forge+fabric" = _faZrwNK3;
        "pkg-1.20.1-5.6-forge+fabric" = _PUrIyMeI;
        "pkg-1.20.2-5.6-forge+fabric" = _zSEThAy1;
        "pkg-1.18.2-5.7-forge+fabric" = _KkqD6jwY;
        "pkg-1.19.2-5.7-forge+fabric" = _ngytEFK2;
        "pkg-1.20.1-5.7-forge+fabric" = _Dcw1OcXz;
        "pkg-1.20.2-5.7-forge+fabric" = _5beLbBBg;
        "pkg-1.20.3-5.7-fabric+forge+neo" = _8XbW9oxu;
        "pkg-1.20.4-5.7-fabric+forge+neo" = _AUqjntwo;
        "pkg-1.19.2-5.8-fabric+forge+neo" = _ASjdw0h6;
        "pkg-1.20.1-5.8-fabric+forge+neo" = _4ak47aDr;
        "pkg-1.20.2-5.8-fabric+forge+neo" = _oBbfEq4S;
        "pkg-1.20.4-5.8-fabric+forge+neo" = _dhGE5zyG;
        "pkg-1.19.2-5.9-fabric+forge" = _1Mzo1WWs;
        "pkg-1.20.1-5.9-fabric+forge+neo" = _YW5245VL;
        "pkg-1.20.2-5.9-fabric+forge+neo" = _Uzs5XrgI;
        "pkg-1.20.4-5.9-fabric+forge+neo" = _23BxEkGT;
        "pkg-1.20.5-5.9-fabric+neo" = _Mj4FYwWD;
        "pkg-1.20.5-6.0-fabric+neo" = _yRFZmrdK;
        "pkg-1.20.6-6.0-fabric+forge+neo" = _Joq5Hg9y;
        "pkg-1.20.6-6.1-fabric+forge+neo" = _YiiIkWUv;
        "pkg-1.21.0-6.1-fabric+forge+neo" = _ZQE4yDKI;
        "pkg-1.20.1-7.0-fabric+forge+neo" = _a9Mh7LdT;
        "pkg-1.20.6-7.0-fabric+forge+neo" = _CPjLDDv8;
        "pkg-1.21.0-7.0-fabric+forge+neo" = _czJQJ7qH;
        "pkg-1.20.1-7.1-fabric+forge+neo" = _tEq0j3Mh;
        "pkg-1.20.6-7.1-fabric+forge+neo" = _FOfj0hV5;
        "pkg-1.21.0-7.1-fabric+forge+neo" = _8y4Kl2As;
        "pkg-1.21.1-7.1-fabric+forge+neo" = _VhJPLdxH;
        "pkg-1.21.2-7.1-fabric+neo" = _dtWsh6xa;
        "pkg-1.21.3-7.1-fabric+forge+neo" = _CZ5LQTaV;
        "pkg-1.21.4-7.1-fabric+forge+neo" = _9wKNZbVL;
        "pkg-1.20.1-7.2-fabric+forge+neo" = _iNnx7a2g;
        "pkg-1.21.1-7.2-fabric+forge+neo" = _FH8UmhVY;
        "pkg-1.21.4-7.2-fabric+forge+neo" = _TwT48Pqw;
        "pkg-1.21.5-7.2-fabric+forge+neo" = _gH4BfZ8u;
        "pkg-1.21.6-7.2-fabric+forge+neo" = _MADwPGmL;
        "pkg-1.21.7-7.2-fabric+forge+neo" = _YsDCAULT;
        "pkg-1.21.8-7.2-fabric+forge+neo" = _pmsuQ7No;
        "pkg-1.21.9-7.2-fabric+forge+neo" = _IskJCnsS;
        "pkg-1.21.10-7.2-fabric+forge+neo" = _FIXlKnKL;
        "pkg-1.21.11-7.2-fabric+forge+neo" = _9YDHYveh;
        "pkg-26.1.0-7.2-fabric+forge+neo" = _YYZPUX27;
        "pkg-26.1.0-7.3-fabric+forge+neo" = _6QowBHzA;
        "pkg-26.1.1-7.3-fabric+forge+neo" = _d37mUYvT;
        "pkg-26.1.2-7.3-fabric+forge+neo" = _MmGMBptk;
        "pkg-26.2.0-7.3-fabric+forge+neo" = _wvY9ao7Z;
        "pkg-1.20.1-7.4-fabric+forge+neo" = _7EIrM3wy;
        "pkg-1.21.1-7.4-fabric+forge+neo" = _VfUqnJyq;
        "pkg-26.2.0-7.4-fabric+forge+neo" = _B3GiJLUw;
        "pkg-1.20.1-7.5-fabric+forge+neo" = _fVZfM68o;
        "pkg-1.21.1-7.5-fabric+forge+neo" = _Ar77cJcr;
        "pkg-26.2.0-7.5-fabric+forge+neo" = _HmDSvVIj;
        "default" = _HmDSvVIj;
    });
