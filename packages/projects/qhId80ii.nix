...
let
    ...
    in {
        ...
        "pkg-1.5_01.4" = _xlCNIU60;
        "pkg-1.6.5.1" = _WpDlszHH;
        "pkg-1.6.6.1" = _iW7uLdJO;
        "pkg-1.6.6.2" = _sDNigZmk;
        "pkg-1.6.6.3" = _4TtEJ2qx;
        "pkg-1.6.6.4" = _ZCTqHPpl;
        "pkg-1.7.2.1" = _WEhFIU9C;
        "pkg-1.7.3.1" = _gQwEzAWS;
        "pkg-1.7.3.2" = _n0rkc74b;
        "pkg-1.7.3.3" = _2rm2VlTk;
        "pkg-1.7.3.4" = _UqCgb54G;
        "pkg-1.8.1.1" = _CfrRV4xZ;
        "pkg-2.0.1" = _bRNcnJRm;
        "pkg-2.1.0" = _9GAHmWDq;
        "pkg-2.1.1" = _JCnIG1m1;
        "pkg-2.2.0" = _dTaG7CMW;
        ...
        "pkg-2.2.8" = _WWFPnG6d;
        "pkg-2.2.9" = _y7k3FzQV;
        "pkg-2.2.10" = _T3P4wOoP;
        "pkg-2.2.11" = _bjO17prI;
        "pkg-2.2.12" = _dQaoaLPv;
        "pkg-2.2.13" = _62MiYrsO;
        "pkg-2.2.14" = _GeIHUe56;
        "pkg-3.0.0" = _XfWXIGyS;
        "pkg-3.0.1" = _lKBv8kBo;
        "pkg-3.0.2" = _LWjeRnVK;
        "pkg-3.0.3" = _Y2Ddo6Nu;
        ...
        "pkg-7.0.8" = _ceCTf15p;
        "pkg-7.0.9" = _2V3C42bl;
        "pkg-7.0.10" = _PmUQyuzl;
        "pkg-7.0.11" = _qatCGLvb;
        "pkg-7.0.12" = _iTUngiKe;
        "pkg-7.0.13" = _t6sdl5YI;
        "pkg-7.0.14" = _9top3xxy;
        "pkg-7.0.15" = _KquDpFaJ;
        "pkg-7.0.16" = _JOuInzxX;
        "pkg-7.0.17" = _Eh6XQWzR;
        "pkg-7.0.18" = _qAQQQT3m;
        "pkg-7.0.19" = _ziHqtk6U;
        "pkg-7.0.20" = _AFEhFCX2;
        "pkg-7.0.21" = _8ZEEeRz2;
        "pkg-7.0.22" = _NLrafy7m;
        "pkg-7.0.23" = _943eBIXK;
        "pkg-7.0.25" = _kHUqG0gQ;
        "pkg-7.0.26" = _wD1VhwCW;
        "pkg-7.1.0" = _tGS2siLY;
        "pkg-7.1.1" = _OmooEfme;
        "pkg-7.1.2" = _Md0wIUSv;
        "pkg-7.1.3" = _cPr6v6VL;
        ...
        "pkg-7.1.8" = _kyMGHeBI;
        "pkg-7.1.9" = _EWZBLTij;
        "pkg-7.1.10" = _NWZ4OjpU;
        "pkg-7.1.11" = _9zAIQPBR;
        "pkg-7.1.12" = _XjqwO9Ye;
        "pkg-7.1.13" = _ITuU5KLm;
        "pkg-7.1.14" = _B8gfywJc;
        "pkg-7.1.15" = _lz5X2xap;
        "pkg-7.1.16" = _ByflQM3l;
        "pkg-7.1.17" = _ZNRgILCe;
        "pkg-7.1.18" = _8KN3cPcR;
        "pkg-7.1.19" = _12TAXmb4;
        "pkg-7.1.20" = _hQ7DpPyA;
        "pkg-7.2.0" = _wCnhpduK;
        "pkg-7.2.1" = _YbSiFFgh;
        "pkg-7.2.2" = _w9YvVhgG;
        "pkg-7.2.3" = _MFpfb3OB;
        ...
        "pkg-7.2.7" = _QJKHvWq4;
        "pkg-7.2.8" = _jOeSrnyr;
        "pkg-7.1.21" = _zQKy5gq6;
        "pkg-7.1.22" = _MLlPTcrH;
        "pkg-7.1.23" = _zHKz1cKQ;
        "pkg-7.1.24" = _h6Hx1am8;
        "pkg-7.1.25" = _7AADimNC;
        "pkg-7.1.26" = _x94JBh9N;
        "pkg-7.99.5" = _apnUaeY3;
        "pkg-7.99.6" = _4kJy6BON;
        "pkg-7.99.7" = _oMIuofBa;
        "pkg-7.99.8" = _pKfuOrrq;
        "pkg-7.99.8.1" = _rTHOxgir;
        "pkg-7.99.8.2" = _svVhMYiW;
        "pkg-7.99.12" = _nPJ4no7N;
        "pkg-7.99.13" = _WoEy8F8e;
        "pkg-7.99.14" = _lq2Ujvrv;
        "pkg-7.99.15" = _Hnf7vYXS;
        "pkg-7.99.16" = _2XLMRvqi;
        "pkg-7.99.17" = _1BT9vb7O;
        "pkg-7.99.18" = _laNDDMxU;
        "pkg-7.99.19" = _WYcn04g6;
        "pkg-7.99.20" = _TZy5MAq8;
        "pkg-7.99.21" = _IrINHPxH;
        "pkg-7.99.22" = _eBvLPrCZ;
        "pkg-7.99.23" = _dPril2Ox;
        "pkg-7.99.24" = _T9HXIvXT;
        "pkg-7.99.24.1" = _7HRkNBi1;
        "pkg-7.99.24.2" = _rXskQPeB;
        "pkg-7.99.24.3" = _TIQw9nDO;
        "pkg-7.99.24.4" = _h4dwyCyo;
        "pkg-7.99.24.5" = _afso8Kj0;
        "pkg-7.99.24.6" = _Hy8vDDW7;
        "pkg-7.99.24.7" = _zVq2vZxa;
        "pkg-7.99.24.8" = _u2GLuUj5;
        "pkg-7.1.27" = _hkfZwMGY;
        "pkg-8.0.0" = _m504ptVz;
        "default" = _m504ptVz;
    });
