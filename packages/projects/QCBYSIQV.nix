...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _o6ybrpos;
        "pkg-1.1.2" = _oabAVkWS;
        "pkg-1.9.4-1.1.2" = _5ix10n7c;
        "pkg-1.9.4-1.1.3" = _FP9Hheeq;
        "pkg-1.9.4-1.1.4" = _2YMU0qOe;
        "pkg-1.9.4-1.1.5" = _sKPNlRPL;
        "pkg-1.9.4-1.1.6" = _pvp8emUV;
        "pkg-1.9.4-1.1.7" = _Adi3hXKw;
        "pkg-1.10-1.1.8" = _jdlvBHY2;
        "pkg-1.1x-1.2.0" = _nStwkl5I;
        "pkg-1.1x-1.2.1" = _bbGaIVn2;
        "pkg-1.1x-1.2.2" = _jWdqjpOR;
        "pkg-1.1x-1.2.3" = _3WZAb0Mg;
        "pkg-1.1x-1.2.4" = _dGwLj6RK;
        "pkg-1.1x-1.2.5" = _HV3Lzmq5;
        "pkg-1.1x-1.2.6" = _w5shv58J;
        "pkg-1.1x-1.3.0" = _CqhGcP4J;
        "pkg-1.1x-1.3.1" = _1mUy8aZx;
        "pkg-1.1x-1.3.2" = _EFFhV71o;
        "pkg-1.1x-1.3.3" = _HVGpF2ge;
        "pkg-1.12-1.3.3" = _j4Dw83Q1;
        "pkg-1.12-1.3.4" = _zrHseGRq;
        "pkg-1.12-1.3.5" = _o8lBJs1H;
        "pkg-1.1x-1.3.6" = _zAOXbOYs;
        "pkg-1.12-1.3.6" = _4UBhPs5q;
        "pkg-1.12-1.4.0" = _DiRzFixI;
        "pkg-1.12-1.4.1" = _25yJw5fo;
        "pkg-1.12-1.5.0-alpha" = _84J0p7ar;
        "pkg-1.12-1.5.0" = _bqewXXtY;
        "pkg-1.12-1.5.1" = _uzfq3n6h;
        "pkg-1.12-1.6.0" = _6WoEPVoF;
        "default" = _6WoEPVoF;
    });
