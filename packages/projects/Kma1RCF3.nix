...
let
    ...
    in {
        ...
        "pkg-1.18.2-2.3.1" = _67YRc3M0;
        "pkg-1.19.2-2.3.1" = _l0I7aRK8;
        "pkg-1.19.4-2.3.1-forge" = _UwMjmyIY;
        "pkg-1.20-2.3.1-forge" = _uavK1xJ5;
        "pkg-1.12.2-2.1.3-forge" = _JIy19H1D;
        "pkg-1.16.5-2.3.1-forge" = _3NmXYtom;
        "pkg-1.17.1-2.3.1-forge" = _EfsBx8cK;
        "pkg-1.18.2-2.3.1-forge" = _IZJAUUio;
        "pkg-1.19.2-2.3.1-forge" = _dk5bzp1a;
        "pkg-1.20.1-2.3.1-forge" = _Vql9eLTY;
        "pkg-1.19.2-2.3.1-fabric" = _WswYmO6N;
        "pkg-1.19.4-2.3.1-fabric" = _wDPppyBP;
        "pkg-1.20.1-2.3.1-fabric" = _aFzhBdLk;
        "pkg-1.18.2-2.3.2-forge" = _SLCUAzw0;
        "pkg-1.19.2-2.3.2-forge" = _jlG4Su1T;
        "pkg-1.19.4-2.3.2-forge" = _BYyZv3Sc;
        "pkg-1.20.1-2.3.2-forge" = _J2NRLbXl;
        "pkg-1.20.2-2.3.2-forge" = _SAOfF50h;
        "pkg-1.19.2-2.3.2-fabric" = _qlPY6bTP;
        "pkg-1.19.4-2.3.2-fabric" = _bCJD6D7F;
        "pkg-1.20.1-2.3.2-fabric" = _eeIJ7vuG;
        "pkg-1.20.2-2.3.2-fabric" = _y2ZWHX1n;
        "pkg-1.20.2-2.3.2-neoforge" = _3nXLrgKY;
        "pkg-1.18.2-2.3.3-forge" = _oABrnW3k;
        "pkg-1.19.2-2.3.3-fabric" = _nkfoPA9V;
        "pkg-1.19.2-2.3.3-forge" = _PhMROylR;
        "pkg-1.19.4-2.3.3-fabric" = _zUrIZgfv;
        "pkg-1.19.4-2.3.3-forge" = _5WeR9yHw;
        "pkg-1.20.1-2.3.3-fabric" = _ra7HO6YB;
        "pkg-1.20.1-2.3.3-forge" = _lGxgO4Ty;
        "pkg-1.20.3-2.3.3-fabric" = _GP6r9cuQ;
        "pkg-1.20.3-2.3.3-forge" = _h9rxybon;
        "pkg-1.20.3-2.3.3-neoforge" = _aoobK5Tg;
        "pkg-1.19.2-2.3.4-fabric" = _uAef49DN;
        "pkg-1.19.4-2.3.4-fabric" = _7PzobJGU;
        "pkg-1.20.1-2.3.4-fabric" = _SIPvreOA;
        "pkg-1.20.4-2.3.4-fabric" = _xr1OJhFA;
        "pkg-1.18.2-2.3.4-forge" = _D5axtoPL;
        "pkg-1.19.2-2.3.4-forge" = _1HAo8GwG;
        "pkg-1.20.1-2.3.4-forge" = _banulU1E;
        "pkg-1.20.4-2.3.4-forge" = _A7eBA9ab;
        "pkg-1.20.4-2.3.4-neoforge" = _5yALTpTF;
        "pkg-1.18.2-2.4.0-fabric" = _UFN2xe5P;
        "pkg-1.19.2-2.4.0-fabric" = _JD5QYt38;
        "pkg-1.19.4-2.4.0-fabric" = _3rLkEAmR;
        "pkg-1.20.1-2.4.0-fabric" = _R8Xn7a1L;
        "pkg-1.20.4-2.4.0-fabric" = _u5zRhFmI;
        "pkg-1.18.2-2.4.0-forge" = _5ipgr6R5;
        "pkg-1.19.2-2.4.0-forge" = _DGAUJktR;
        "pkg-1.19.4-2.4.0-forge" = _UEdnqWnA;
        "pkg-1.20.1-2.4.0-forge" = _co81h9Bu;
        "pkg-1.20.4-2.4.0-forge" = _ErKcLRpg;
        "pkg-1.20.4-2.4.0-neoforge" = _l7lhGo4Y;
        "pkg-1.18.2-2.4.1-fabric" = _QKY9bBHh;
        "pkg-1.19.2-2.4.1-fabric" = _VS7G9KGo;
        "pkg-1.19.4-2.4.1-fabric" = _3u6y3Dsc;
        "pkg-1.20.1-2.4.1-fabric" = _Uto5eFmD;
        "pkg-1.20.5-2.4.1-fabric" = _PjMJop96;
        "pkg-1.18.2-2.4.1-forge" = _UwhbU3TM;
        "pkg-1.19.2-2.4.1-forge" = _fvHMHreh;
        "pkg-1.19.4-2.4.1-forge" = _MXZgkCGb;
        "pkg-1.20.1-2.4.1-forge" = _hPRPD1jl;
        "pkg-1.20.5-2.4.1-neoforge" = _NpzMvMYE;
        "pkg-1.20.6-2.4.1-fabric" = _QRn3K5kK;
        "pkg-1.20.6-2.4.1-neoforge" = _qgc2nMz9;
        "pkg-1.20.6-2.4.1-forge" = _tsFcHhbd;
        "pkg-1.21-2.4.1-fabric" = _XIBSzfiP;
        "pkg-1.21-2.4.1-forge" = _RrgY9xUy;
        "pkg-1.21-2.4.1-neoforge" = _771tizpP;
        "pkg-1.20.6-2.4.2-fabric" = _CwcZRR7g;
        "pkg-1.21-2.4.2-fabric" = _HYhdXBsI;
        "pkg-1.20.6-2.4.2-forge" = _9gRTcsFv;
        "pkg-1.20.6-2.4.2-neoforge" = _7lu0Cwvb;
        "pkg-1.21-2.4.2-forge" = _6mUzXZsP;
        "pkg-1.21-2.4.2-neoforge" = _gH1KGCXt;
        "pkg-1.20.4-2.4.1-fabric" = _zjnULayI;
        "pkg-1.20.4-2.4.1-forge" = _HUCBg69I;
        "pkg-1.20.4-2.4.1-neoforge" = _MiUCWIFT;
        "pkg-1.18.2-2.4.3-fabric" = _9Y86tttW;
        "pkg-1.19.2-2.4.3-fabric" = _OC1K8OxB;
        "pkg-1.19.4-2.4.3-fabric" = _xMmhSHEc;
        "pkg-1.20.1-2.4.3-fabric" = _3Yvu7m7Q;
        "pkg-1.20.4-2.4.3-fabric" = _jReEBAre;
        "pkg-1.20.6-2.4.3-fabric" = _sj6Gq0F0;
        "pkg-1.21-2.4.3-fabric" = _QKkOs5gb;
        "pkg-1.18.2-2.4.3-forge" = _SbppxKBz;
        "pkg-1.19.2-2.4.3-forge" = _a8uQ51by;
        "pkg-1.19.4-2.4.3-forge" = _TIhFaduU;
        "pkg-1.20.1-2.4.3-forge" = _cI4tiznh;
        "pkg-1.20.4-2.4.3-forge" = _SfWov6GR;
        "pkg-1.20.4-2.4.3-neoforge" = _6HZtRNLl;
        "pkg-1.20.6-2.4.3-forge" = _I9uqwWd6;
        "pkg-1.20.6-2.4.3-neoforge" = _KUvYALCX;
        "pkg-1.21-2.4.3-forge" = _nyi4L7q1;
        "pkg-1.21-2.4.3-neoforge" = _fO38f7mP;
        "pkg-1.19.4-2.4.4-fabric" = _HiiyaAzb;
        "pkg-1.19.4-2.4.4-forge" = _YfvBlP1O;
        "pkg-1.20.1-2.4.4-fabric" = _YzfPNzTw;
        "pkg-1.20.1-2.4.4-forge" = _8ImlTzme;
        "pkg-1.20.4-2.4.4-fabric" = _IBU9mKlj;
        "pkg-1.20.4-2.4.4-forge" = _tChqgp1E;
        "pkg-1.20.4-2.4.4-neoforge" = _aMQtIH9k;
        "pkg-1.20.6-2.4.4-fabric" = _feewZbPA;
        "pkg-1.20.6-2.4.4-neoforge" = _uZerPQMS;
        "pkg-1.21-2.4.4-fabric" = _RhCf4k9z;
        "pkg-1.21-2.4.4-neoforge" = _ZW8CC0M5;
        "pkg-1.20.6-2.4.4-forge" = _MrK5aiG4;
        "pkg-1.21-2.4.4-forge" = _81ZPR994;
        "pkg-1.21.1-2.4.4-fabric" = _mf3LnFhj;
        "pkg-1.21.1-2.4.4-forge" = _khIseTSs;
        "pkg-1.21.1-2.4.4-neoforge" = _UhJKSAOJ;
        "pkg-1.18.2-2.4.5-fabric" = _PCmQH9ld;
        "pkg-1.18.2-2.4.5-forge" = _KUlZ2zHi;
        "pkg-1.19.2-2.4.5-fabric" = _4RQEOKYN;
        "pkg-1.19.2-2.4.5-forge" = _ekCZIXql;
        "pkg-1.19.4-2.4.5-fabric" = _wMtSzhqq;
        "pkg-1.19.4-2.4.5-forge" = _VN1RxBtY;
        "pkg-1.20.1-2.4.5-fabric" = _rszC1ECM;
        "pkg-1.20.1-2.4.5-forge" = _5LD7N3Bf;
        "pkg-1.20.4-2.4.5-fabric" = _vpZ9We2l;
        "pkg-1.20.4-2.4.5-forge" = _5YqAdBgN;
        "pkg-1.20.4-2.4.5-neoforge" = _CBY2REOz;
        "pkg-1.20.6-2.4.5-fabric" = _XkJO3sHc;
        "pkg-1.20.6-2.4.5-forge" = _O4DIwBSX;
        "pkg-1.20.6-2.4.5-neoforge" = _LZ7FZE6V;
        "pkg-1.21.1-2.4.5-fabric" = _G4EFJsKp;
        "pkg-1.21.1-2.4.5-forge" = _9Q1b0kx3;
        "pkg-1.21.1-2.4.5-neoforge" = _TBrjeDSK;
        "pkg-1.18.2-2.4.6-fabric" = _ehG6c5Nh;
        "pkg-1.18.2-2.4.6-forge" = _9PzuxBMr;
        "pkg-1.19.2-2.4.6-fabric" = _IJPWnURn;
        "pkg-1.19.2-2.4.6-forge" = _SRlqFkvK;
        "pkg-1.19.4-2.4.6-fabric" = _FowSYVCy;
        "pkg-1.19.4-2.4.6-forge" = _ABF8J6eV;
        "pkg-1.20.1-2.4.6-fabric" = _hvUvKQaA;
        "pkg-1.20.1-2.4.6-forge" = _a0egmUu8;
        "pkg-1.20.4-2.4.6-fabric" = _PRWIZsog;
        "pkg-1.20.4-2.4.6-forge" = _JMD9kzLo;
        "pkg-1.20.4-2.4.6-neoforge" = _BHso0zIK;
        "pkg-1.20.6-2.4.6-fabric" = _wxCius7o;
        "pkg-1.20.6-2.4.6-forge" = _qTiq4Gnx;
        "pkg-1.20.6-2.4.6-neoforge" = _WU54ni24;
        "pkg-1.21.1-2.4.6-fabric" = _u7yBW4th;
        "pkg-1.21.1-2.4.6-forge" = _Z7obnttf;
        "pkg-1.21.1-2.4.6-neoforge" = _6nH2JAwT;
        "pkg-1.21.1-2.4.7-fabric" = _p3JMMS8b;
        "pkg-1.21.1-2.4.7-forge" = _DPGpCZCX;
        "pkg-1.21.1-2.4.7-neoforge" = _7UqiZj7l;
        "pkg-1.18.2-2.4.8-fabric" = _wvgLOmDn;
        "pkg-1.18.2-2.4.8-forge" = _M9u1w7pD;
        "pkg-1.19.2-2.4.8-fabric" = _jaQ2ZWv5;
        "pkg-1.19.2-2.4.8-forge" = _Au2XmT10;
        "pkg-1.19.4-2.4.8-fabric" = _4Wm372SE;
        "pkg-1.19.4-2.4.8-forge" = _cPiK8P9A;
        "pkg-1.20.1-2.4.8-fabric" = _LuzbbXph;
        "pkg-1.20.1-2.4.8-forge" = _CkVRb0Kg;
        "pkg-1.20.4-2.4.8-fabric" = _O28ylv2A;
        "pkg-1.20.4-2.4.8-forge" = _mZR78hLS;
        "pkg-1.20.4-2.4.8-neoforge" = _2gZOAS6F;
        "pkg-1.20.6-2.4.8-fabric" = _au78Nl7G;
        "pkg-1.20.6-2.4.8-forge" = _2NJliSYn;
        "pkg-1.20.6-2.4.8-neoforge" = _ZrOEPov1;
        "pkg-1.21.1-2.4.8-fabric" = _5SVO6GER;
        "pkg-1.21.1-2.4.8-forge" = _tvEUs2pj;
        "pkg-1.21.1-2.4.8-neoforge" = _frzztnYV;
        "pkg-1.21.3-2.4.8-fabric" = _dJ8e7aZB;
        "pkg-1.21.3-2.4.8-neoforge" = _ckbUFxrk;
        "pkg-1.21.3-2.4.8-forge" = _wYqouHYv;
        "pkg-1.21.4-2.4.8-fabric" = _32SvwpmO;
        "pkg-1.21.4-2.4.8-neoforge" = _Ss2ufera;
        "pkg-1.21.4-2.4.8-forge" = _9KrhNtON;
        "pkg-1.21.4-2.4.9-neoforge" = _i7E6NnqU;
        "pkg-1.18.2-2.4.10-fabric" = _oC4FViCC;
        "pkg-1.18.2-2.4.10-forge" = _U13BJXKx;
        "pkg-1.19.2-2.4.10-fabric" = _CK1DiOMK;
        "pkg-1.19.2-2.4.10-forge" = _hbt9BxmV;
        "pkg-1.19.4-2.4.10-fabric" = _lOluF0xx;
        "pkg-1.19.4-2.4.10-forge" = _fr5ddBiQ;
        "pkg-1.20.1-2.4.10-fabric" = _N8hhtV26;
        "pkg-1.20.1-2.4.10-forge" = _t7wIxRNl;
        "pkg-1.20.4-2.4.10-fabric" = _llDu3sgq;
        "pkg-1.20.4-2.4.10-forge" = _S90gszrP;
        "pkg-1.20.4-2.4.10-neoforge" = _Hiz7OR8X;
        "pkg-1.20.6-2.4.10-fabric" = _WggUxOyP;
        "pkg-1.20.6-2.4.10-forge" = _bHjeEiyb;
        "pkg-1.20.6-2.4.10-neoforge" = _6MH5AtY6;
        "pkg-1.21.1-2.4.10-fabric" = _xl7caqzf;
        "pkg-1.21.1-2.4.10-forge" = _emkZKndN;
        "pkg-1.21.1-2.4.10-neoforge" = _nCCQljEG;
        "pkg-1.21.3-2.4.10-fabric" = _dDQ4mH8M;
        "pkg-1.21.3-2.4.10-forge" = _rM5TrmDo;
        "pkg-1.21.3-2.4.10-neoforge" = _jknBK8ZY;
        "pkg-1.21.4-2.4.10-fabric" = _80JCYJZ5;
        "pkg-1.21.4-2.4.10-forge" = _ko8WVYya;
        "pkg-1.21.4-2.4.10-neoforge" = _N2Pbb3rn;
        "pkg-1.21.5-2.4.10-fabric" = _l34M35WW;
        "pkg-1.21.5-2.4.10-neoforge" = _VwSihGKB;
        "pkg-1.21.5-2.4.10-forge" = _rJ8X7Usz;
        "pkg-1.18.2-2.4.11-fabric" = _IJXPM9K6;
        "pkg-1.18.2-2.4.11-forge" = _50AwHVQR;
        "pkg-1.19.2-2.4.11-fabric" = _3LHaz7FC;
        "pkg-1.19.2-2.4.11-forge" = _oFuS7l7k;
        "pkg-1.19.4-2.4.11-fabric" = _GO7CN1dC;
        "pkg-1.19.4-2.4.11-forge" = _hynWDcsf;
        "pkg-1.20.1-2.4.11-fabric" = _7HvTITKm;
        "pkg-1.20.1-2.4.11-forge" = _qUQmpZbT;
        "pkg-1.20.4-2.4.11-fabric" = _n4f6V249;
        "pkg-1.20.4-2.4.11-forge" = _TYTpPfrR;
        "pkg-1.20.4-2.4.11-neoforge" = _AevtSfd1;
        "pkg-1.20.6-2.4.11-fabric" = _u9z5Frkb;
        "pkg-1.20.6-2.4.11-forge" = _k6BNuw9A;
        "pkg-1.20.6-2.4.11-neoforge" = _xEPZKaRr;
        "pkg-1.21.1-2.4.11-fabric" = _NOLK697F;
        "pkg-1.21.1-2.4.11-forge" = _IMbVlYRC;
        "pkg-1.21.1-2.4.11-neoforge" = _tLOzWaU4;
        "pkg-1.21.3-2.4.11-fabric" = _NSWCJ7b7;
        "pkg-1.21.3-2.4.11-forge" = _pf6BwtNd;
        "pkg-1.21.3-2.4.11-neoforge" = _2eSbkP7n;
        "pkg-1.21.4-2.4.11-fabric" = _Ho2QYEJP;
        "pkg-1.21.4-2.4.11-forge" = _YJm9lt1Q;
        "pkg-1.21.4-2.4.11-neoforge" = _tnlzZ1oa;
        "pkg-1.21.5-2.4.11-fabric" = _N9x4X6Sb;
        "pkg-1.21.5-2.4.11-forge" = _Dyb2MQkD;
        "pkg-1.21.5-2.4.11-neoforge" = _SpZgIliW;
        "pkg-1.21.6-2.4.11-fabric" = _olabIpp2;
        "pkg-1.21.6-2.4.11-neoforge" = _bZqZDR06;
        "pkg-1.21.6-2.4.11-forge" = _UD14GwwW;
        "pkg-1.21.7-2.4.11-fabric" = _eRt8iYzu;
        "pkg-1.21.7-2.4.11-forge" = _tnFgR74K;
        "pkg-1.21.7-2.4.11-neoforge" = _ZAIUcAlF;
        "pkg-1.21.8-2.4.11-fabric" = _dEZA6KaS;
        "pkg-1.21.8-2.4.11-forge" = _78mPMc92;
        "pkg-1.21.8-2.4.11-neoforge" = _JUrUdd9P;
        "pkg-1.21.9-2.4.11-fabric" = _uMaMFl2L;
        "pkg-1.21.9-2.4.11-neoforge" = _tpyIn9VU;
        "pkg-1.21.9-2.4.11-forge" = _HKkGvZYC;
        "pkg-1.21.10-2.4.11-fabric" = _F5tGQQT5;
        "pkg-1.21.10-2.4.11-forge" = _SrSJ1H90;
        "pkg-1.21.10-2.4.11-neoforge" = _SLSgyPwf;
        "pkg-1.21.11-2.4.11-fabric" = _Z4NjESVX;
        "pkg-1.21.11-2.4.11-forge" = _4qL0cJlS;
        "pkg-1.21.11-2.4.11-neoforge" = _TKOzips5;
        "pkg-26.1.2-2.4.11-fabric" = _Dc1vl6r4;
        "pkg-26.1.2-2.4.11-forge" = _Wtbdc3xF;
        "pkg-26.1.2-2.4.11-neoforge" = _dp0EVjRg;
