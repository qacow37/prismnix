...
let
    ...
    in {
        ...
        "pkg-0.3.1" = _oiMCXKDH;
        "pkg-0.4" = _HHqDCd5p;
        "pkg-0.4+1.17" = _bndJ1Eq5;
        "pkg-0.4.1+1.17" = _Zl4ETunR;
        "pkg-0.5+1.17" = _ILuyoK6c;
        "pkg-0.5+1.18" = _qbUAJjs9;
        "pkg-0.6+1.18.2" = _VOB3iJkd;
        "pkg-0.7+1.18.2" = _5FTTHyNq;
        "pkg-0.7+1.19" = _88qNYjJz;
        "pkg-0.7.1+1.18.2" = _Id00LoSl;
        "pkg-0.7.1+1.19" = _s76PBY7D;
        "pkg-0.7.2+1.19.2" = _fZx04xgT;
        "pkg-0.8+1.19.3" = _6NvQpIBY;
        "pkg-0.8.1+1.19.3" = _fJLBqbZ5;
        "pkg-0.9+1.19.4" = _Xdo5ZiRc;
        "pkg-0.9+1.20" = _i3v1Skck;
        "pkg-0.9.1+1.20.2" = _eIFo7wvq;
        "pkg-0.10+1.20.4" = _xeHyTMq8;
        "pkg-0.10+1.20.6" = _Ihazqamt;
        "pkg-0.10.1+1.20.4" = _xUOoKrs2;
        "pkg-0.10.1+1.20.6" = _BKpMtYZB;
        "pkg-0.10.1+1.21" = _8OuTJDGd;
        "pkg-0.10.2+1.21" = _HBZAPs3u;
        "pkg-0.11+1.21.2" = _fOVHsM6M;
        "pkg-0.11+1.21.4" = _qtIP0d7M;
        "pkg-0.11.1+1.21.4" = _fHWMRwif;
        "pkg-0.11.2+1.21.4" = _jGcne3w1;
        "pkg-0.11.3+1.21.4" = _YokFoILZ;
        "default" = _YokFoILZ;
    });
