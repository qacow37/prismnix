...
let
    ...
    in {
        ...
        "pkg-v.1.0.1+mod" = _PE8qWzhb;
        "pkg-v.2.0.0" = _ajTqLWSy;
        "pkg-v.2.0.0+mod" = _aVTKSPfc;
        "pkg-v.1.0.2" = _PlN1KTRZ;
        "pkg-v.1.0.2+mod" = _p6SH25fO;
        "pkg-v.2.1.0" = _P9jGJ9EO;
        "pkg-v.2.1.0+mod" = _ecDhWYyB;
        "pkg-v.2.1.1" = _A3JGDuTh;
        "pkg-v.2.1.1+mod" = _j1psvT6M;
        "pkg-v.2.1.2" = _wxyIi8B8;
        "pkg-v.2.1.2+mod" = _E0RJOlqb;
        "pkg-v.1.1.1" = _TuBxsr6M;
        "pkg-v.1.1.1+mod" = _R4ffxQii;
        "pkg-v.1.1.2" = _2Q9W5lXE;
        "pkg-v.1.1.2+mod" = _FBBFKyv1;
        "pkg-v.2.2.2" = _zrWjaFHT;
        "pkg-v.2.2.2+mod" = _Q2YjYaux;
        "pkg-v.2.3.2" = _LVIm57wb;
        "pkg-v.2.3.2+mod" = _u0jaG2fS;
        "pkg-v.2.4.2" = _VHmpTVeX;
        "pkg-v.2.4.2+mod" = _1NL048ad;
        "pkg-v.3.0.0" = _pdP0U59J;
        "pkg-v.3.0.0+mod" = _ruLTPVnx;
        "pkg-v.3.1.0" = _11KdnECy;
        "pkg-v.3.1.0+mod" = _SsQercBh;
        "pkg-v.3.2.0" = _udwRlUKB;
        "pkg-v.3.2.0+mod" = _w4xisPCF;
        "pkg-v.3.3.0" = _C0T73KtD;
        "pkg-v.3.3.0+mod" = _LZtOUHIH;
        "pkg-v3.4.0" = _JAq5WOUt;
        "pkg-v3.4.0+mod" = _yLpEvHta;
        "pkg-v3.4.1" = _9ypXDNYb;
        "pkg-v3.4.1+mod" = _BAN3UGOM;
        "pkg-v3.5.0" = _JPVttqEo;
        "pkg-v3.5.0+mod" = _L9asOXeP;
        "pkg-v3.5.1" = _V5Ll9vCZ;
        "pkg-v3.5.1+mod" = _W3CqEF9S;
        "pkg-v3.5.2" = _fnm7VYNT;
        "pkg-v3.5.2+mod" = _n1ukoY3z;
        "pkg-v3.5.3" = _mqZ96gF1;
        "pkg-v3.5.3+mod" = _Ejn0DvU8;
        "pkg-v4.0.0" = _jidkFMgP;
        "pkg-v4.0.0+mod" = _1Ar89DYk;
        "pkg-v4.0.1" = _pKk315pu;
        "pkg-v4.0.1+mod" = _7wcAeryX;
        "pkg-v4.0.2" = _w54EpoQh;
        "pkg-v4.0.2+mod" = _CEw0KvwZ;
        "pkg-v4.0.2.0" = _VmlQMLEo;
        "pkg-v4.0.2.0+mod" = _PH1EPU3a;
        "pkg-v4.0.2.1" = _7asnzYBB;
