...
let
    ...
    in {
        ...
        "pkg-v.2.0.0+mod" = _CPmUC0dg;
        "pkg-v.1.0.1" = _6lj4wjFS;
        "pkg-v.1.0.1+mod" = _AQGytiiZ;
        "pkg-v.2.1.0" = _6Ap1Hr1V;
        "pkg-v.2.1.0+mod" = _lCcGeKkr;
        "pkg-v.2.2.0" = _IkF7rwPn;
        "pkg-v.2.2.0+mod" = _3pYLM3nv;
        "pkg-v.1.1.1" = _HhHToBsw;
        "pkg-v.1.1.1+mod" = _4uehyGLZ;
        "pkg-v.2.3.0" = _MwL9ro6Z;
        "pkg-v.2.3.0+mod" = _6yQWxt1V;
        "pkg-v.2.4.0" = _bER7Y4gB;
        "pkg-v.2.4.0+mod" = _bqcicr1i;
        "pkg-v2.5.0" = _DMX9o8PR;
        "pkg-v2.5.0+mod" = _AdJ5drqZ;
        "pkg-v2.5.1" = _7LtKOd0J;
        "pkg-v2.5.1+mod" = _qQ6rwbpc;
        "pkg-v2.5.2" = _I4j8jjk7;
        "pkg-v2.5.2+mod" = _ousIiVKa;
        "pkg-v2.5.3" = _2LpkVwZK;
        "pkg-v2.5.3+mod" = _EvBJ0MBC;
        "pkg-v2.5.4" = _15dhhsJd;
        "pkg-v2.5.4+mod" = _u8T9T0HG;
        "pkg-v2.5.4.1" = _MMyyDn2u;
