...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _JGrSma46;
        "pkg-1.0.0+mod" = _nfAU6CM1;
        "pkg-1.0.1" = _7uiuJ3jd;
        "pkg-1.1.0" = _ZnzpR853;
        "pkg-1.1.0-mod" = _cx5FX23y;
        "pkg-1.2.0" = _3Lic0his;
        "pkg-1.2.0+mod" = _YCPDHSZV;
        "pkg-1.3.0" = _U9Brxuvt;
        "pkg-1.3.0+mod" = _LtGxziCG;
        "pkg-1.3.1+mod" = _XUrXPJQg;
        "pkg-1.3.2" = _UNn58D33;
        "pkg-1.3.2+mod" = _JTSifLsF;
        "pkg-1.3.3" = _ONDVk8FH;
        "pkg-1.3.3+mod" = _aTlS2YJ3;
        "pkg-1.3.4" = _UZMQJjNj;
        "pkg-1.3.4+mod" = _DjT3OErs;
        "pkg-1.3.5" = _MoLqPr08;
        "pkg-1.3.5+mod" = _cMaa4IcY;
        "pkg-1.3.6" = _WnvZXsnE;
        "pkg-1.3.6+mod" = _3yXRVJjx;
        "pkg-1.3.7" = _nwMBmqv7;
        "pkg-1.3.7+mod" = _mJiNYpZM;
        "default" = _mJiNYpZM;
    });
