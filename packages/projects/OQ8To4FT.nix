...
let
    ...
    in {
        ...
        "pkg-0.1.1" = _iMTBQPQg;
        "pkg-0.1.2" = _A2h0zht7;
        "pkg-0.1.2+1.18" = _3GvIsps0;
        "pkg-0.1.3+1.18" = _mgCmGmGc;
        "pkg-0.1.4+1.18" = _9N7pO5Mz;
        "pkg-0.1.5+1.18" = _BsyhO78u;
        "pkg-0.1.6+1.18" = _TtTjbFXV;
        "pkg-0.1.6+1.19" = _IFVZDqGa;
        "pkg-0.1.7+1.19" = _FkAR7cBl;
        "pkg-0.1.7+1.19.3" = _wxRPfdzE;
        "pkg-0.1.7+1.19.4" = _L9dMNzhb;
        "pkg-0.1.7+1.20" = _WoySbSLF;
        "pkg-0.1.8+1.20" = _b2NIHM63;
        "pkg-0.1.8+1.20.2" = _knc732DG;
        "pkg-0.1.9+1.20.2" = _y2LhVoom;
        "pkg-0.1.9+1.20.3" = _Sqa3AAij;
        "pkg-0.1.9+1.21" = _i4vZ2NO6;
        "pkg-0.1.10+1.21" = _OVcatXhy;
        "pkg-0.1.10+1.21.2" = _hMJpNk92;
        "pkg-0.1.11+1.21.2" = _ZcZwAedh;
        "pkg-0.1.11+1.21.9" = _VnvPlHdX;
        "default" = _VnvPlHdX;
    });
