...
let
    ...
    in {
        ...
        "pkg-1.8.1" = _QIgzjSz3;
        "pkg-1.12.1" = _Afk4n8wP;
        "pkg-1.11.1" = _tp5Fsw7a;
        "pkg-2.1.0" = _q3sbvDgz;
        "pkg-3.0.0" = _zjxWmM2J;
        "pkg-3.1.0" = _S88K7l0p;
        "pkg-3.2.0" = _8Gkj4eXp;
        "pkg-3.3.0" = _MH7uS39A;
        "pkg-4.0.0-beta.1" = _VBh9kNyj;
        "pkg-4.1.0" = _hn7UhJdM;
        "pkg-4.2.0-beta.1" = _y89Sk8ph;
        "pkg-5.0.0-beta.1" = _lvmH08sY;
        "pkg-5.2.0-beta.1" = _7GmsoIM5;
        "pkg-5.4.0-beta.1" = _EoShJhB2;
        "pkg-8.0.0-beta.1+neoforge" = _sGKuzUNV;
        "pkg-5.5.0+fabric" = _zCWCAdkK;
        "pkg-6.0.0+fabric" = _6Xbb9GFg;
        "pkg-7.0.0+fabric" = _8cfCkUM9;
        "pkg-7.0.1+fabric" = _SGBV44iM;
        "pkg-8.0.1+neoforge" = _4BuGaKqK;
        "pkg-7.0.2+fabric" = _SRLDxHiZ;
        "pkg-7.0.3+fabric" = _83zTSKOa;
        "pkg-7.1.0-beta.1+fabric" = _sgEiThGY;
        "pkg-5.6.0-beta.1+fabric" = _kaDsUT45;
        "pkg-7.1.1-beta.1+fabric" = _COglOEQV;
        "pkg-7.1.1-beta.2+fabric" = _Vj2u832d;
        "pkg-6.1.0-beta.1+fabric" = _OMNJGjZo;
        "default" = _OMNJGjZo;
    });
