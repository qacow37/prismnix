...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha.1.jar" = _USD4H3rI;
        "pkg-1.0.0-1.21.8" = _Jy2DTOmu;
        "pkg-1.0.1-1.21.8" = _TUlsD2oL;
        "pkg-1.0.2-1.21.10" = _U1q2D6o2;
        "pkg-1.0.3-1.21.10" = _p0wHaZbK;
        "pkg-1.0.4-1.21.10" = _9PTx4amk;
        "pkg-1.0.5-1.21.10" = _x6jg55NK;
        "pkg-1.1.0-beta-1.21.10" = _GDWb1h6e;
        "pkg-1.1.0-beta.2+1.21.10" = _VMPxGeQh;
        "pkg-1.21.10-1.1.0" = _M8NV8qCm;
        "pkg-1.21.10-1.1.1" = _QO15TWOA;
        "pkg-1.21.10-1.1.2" = _nWfWTun3;
        "pkg-1.21.10-1.1.3" = _G1QZ1iJw;
        "pkg-1.21.10-1.1.4" = _5SASAZCy;
        "pkg-1.21.10-1.1.5" = _CxG3tU7p;
        "pkg-1.21.10-1.1.6" = _tlbqqsp1;
        "pkg-1.21.10-1.1.7" = _lIVCZFWT;
        "pkg-1.21.10-1.1.8" = _a9Z5pbRi;
        "pkg-1.21.10-1.1.9" = _qkUeKyBU;
        "pkg-1.21.11-1.1.10" = _oAG3Hwu3;
        "pkg-1.21.11-1.1.11" = _UjzMeKul;
        "pkg-1.21.11-1.1.12" = _eOx5l6ue;
        "pkg-1.21.11-1.2.0" = _za7F4ESW;
        "pkg-1.21.11-1.2.1" = _DZHDNbEN;
        "pkg-1.21.11-1.2.2" = _tyD7tpGQ;
        "pkg-1.21.11-1.2.3" = _dFfF38D0;
        "pkg-1.21.11-1.2.4" = _oQMNdJgV;
        "pkg-1.21.11-1.2.5" = _mEameaIj;
        "pkg-1.21.11-1.2.6" = _Vu4gAHXK;
        "pkg-1.21.11-1.3.0" = _aLkCx57J;
        "default" = _aLkCx57J;
    });
