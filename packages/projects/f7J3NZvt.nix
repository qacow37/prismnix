...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.19.2-forge" = _NWPslMDe;
        "pkg-1.0.0-1.18.2-forge" = _kbPtvf7v;
        "pkg-1.1.0-1.19.4-forge" = _s073ftRx;
        "pkg-1.2.0-1.19.4-forge" = _hKRt0dVh;
        "pkg-1.3.0-1.20-forge" = _gl9SIQzl;
        "pkg-1.4.0-1.20-forge" = _LbiyxRZC;
        "pkg-1.4.0-1.20-fabric" = _B9QROmfk;
        "pkg-1.4.1-1.20-forge" = _F9t5H9Wn;
        "pkg-1.4.2-1.20-forge" = _nOSobi12;
        "pkg-1.5.2-1.20.4-neoforge" = _DjuiHwMn;
        "pkg-1.5.2-1.20.4-fabric" = _LVlhKaXr;
        "pkg-1.5.2-1.20-fabric" = _9gNuTDlw;
        "pkg-1.5.3-1.21-neoforge" = _f76Faoci;
        "pkg-1.5.3-1.21-fabric" = _YHQMDkQS;
        "pkg-1.5.4-1.20.1-fabric" = _4r3AUvMB;
        "pkg-1.6.0-1.20.1-forge" = _IIWxrrzi;
        "pkg-1.7.0-1.20.1-forge" = _wAyJkEAZ;
        "pkg-1.7.0-1.21.1-neoforge" = _oi7LH70R;
        "pkg-1.7.0-1.20.1-fabric" = _uLCFfDQI;
        "pkg-1.7.0-1.21.1-fabric" = _Ua83qWMS;
        "pkg-1.7.1-1.20.1-forge" = _4Tnnpdn2;
        "pkg-1.7.1-1.20.1-fabric" = _RcKnrxHd;
        "pkg-1.7.1-1.12.2-forge" = _FGucjNfk;
        "default" = _FGucjNfk;
    });
