...
let
    ...
    in {
        ...
        "pkg-2.2.1" = _S2q1wN8h;
        "pkg-2.3.1" = _DVG684Rj;
        "pkg-2.3.2-1.19.3" = _4LUMbOkW;
        "pkg-2.3.2-1.19.4" = _AuRaeDyk;
        "pkg-2.3.3-1.19.3" = _npG6jy06;
        "pkg-2.3.3-1.19.4" = _ZbSwmmgL;
        "pkg-2.3.3-1.20-1.20.1" = _OnCiqI7r;
        "pkg-2.4.3-1.19.3" = _x5hX3pKm;
        "pkg-2.4.3-1.19.4" = _MEP0fGkS;
        "pkg-2.4.3-1.20-1.20.1" = _fbTme3To;
        "pkg-2.4.3-1.20.2" = _woR5mNmZ;
        "pkg-3.0.0-1.19.3" = _mLLGVOww;
        "pkg-3.0.0-1.19.4" = _yZBC9ZFe;
        "pkg-3.0.0-1.20-1.20.1" = _pLTfPL6G;
        "pkg-3.0.0-1.20.2-1.20.4" = _5pocwo7l;
        "pkg-3.1.0-1.20-1.20.1" = _3i1mXpxb;
        "pkg-3.1.0-1.20.2-1.20.4" = _krIY9uWK;
        "pkg-3.1.0-1.20.6" = _MnD1prTx;
        "pkg-3.1.0-1.21" = _BGGdQJm6;
        "pkg-3.1.0-1.21.2-1.21.4" = _ysJuNshJ;
        "pkg-3.1.0-1.21.5" = _IrAUxqw9;
        "default" = _IrAUxqw9;
    });
