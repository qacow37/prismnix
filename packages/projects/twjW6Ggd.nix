...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.4-Forge" = _cuYiWQ1f;
        "pkg-1.0.0+1.20.4-Neo" = _q95Mkcvu;
        "pkg-1.0.0+1.20.4-Fabric" = _HvpIDznd;
        "pkg-1.0.1+1.20.4-Forge" = _t5ForzI4;
        "pkg-1.0.1+1.20.4-Neo" = _VrtiEGoi;
        "pkg-1.0.1+1.20.4-Fabric" = _ZXnwWiaH;
        "pkg-1.0.2+1.20.4-Forge" = _OwG9BqHE;
        "pkg-1.0.2+1.20.4-Neo" = _Q9HN3uVu;
        "pkg-1.0.2+1.20.4-Fabric" = _CTHPlY2L;
        "pkg-1.0.3+1.20.4-Forge" = _aZ8LERl1;
        "pkg-1.0.3+1.20.4-Neo" = _4PjEeRGC;
        "pkg-1.0.3+1.20.4-Fabric" = _ihmEbQCX;
        "pkg-1.0.3+1.20.6-Neo" = _T4BWmPii;
        "pkg-1.0.3+1.20.6-Fabric" = _VDzhSp65;
        "pkg-1.0.4+1.20.4-Forge" = _pCL5Lkk4;
        "pkg-1.0.4+1.20.4-Neo" = _rzPfsx77;
        "pkg-1.0.4+1.20.4-Fabric" = _auCccWh0;
        "pkg-1.0.4+1.20.6-Neo" = _yuSfSGQ6;
        "pkg-1.0.4+1.20.6-Fabric" = _p1ygMtIq;
        "pkg-1.0.4+1.21-Neo" = _gBV5u46C;
        "pkg-1.0.4+1.21-Fabric" = _hgLqbkLp;
        "pkg-1.0.5+1.21-Neo" = _wO3mBAz6;
        "pkg-1.0.6+1.21.4-Fabric" = _lxlBBhP3;
        "pkg-1.0.7+1.21.5-Fabric" = _V57g2S8g;
        "default" = _V57g2S8g;
    });
