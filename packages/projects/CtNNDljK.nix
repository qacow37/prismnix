...
let
    ...
    in {
        ...
        "pkg-1.17.1-2.0.2" = _QDDV3YoM;
        "pkg-1.17.1-2.0.3" = _NqsXE09U;
        "pkg-1.17.1-2.0.4" = _vJMCQU3f;
        "pkg-1.17.1-2.0.5" = _gFr7pwu4;
        "pkg-1.17.1-2.0.6" = _BegciGBd;
        "pkg-1.17.1-2.0.7" = _uFzfcicz;
        "pkg-1.17.1-2.0.8" = _sPuO70T3;
        "pkg-1.18.1-3.0.0" = _b6OVHvdY;
        "pkg-1.18.1-3.0.1" = _X7QBP8fR;
        "pkg-1.18.1-3.0.2" = _wB9NOiOK;
        "pkg-1.18.1-3.0.3" = _byFMk9zA;
        "pkg-1.18.2-3.1.0" = _VsrFeZxl;
        "pkg-1.18.2-3.1.1" = _qUj4sutX;
        "pkg-1.19-4.0.0" = _1rYP0t9f;
        "pkg-1.19-4.0.1" = _PnvKSGKb;
        "pkg-1.19.1-4.1.0" = _jWr7J06b;
        "pkg-1.19.1-4.1.1" = _ketvEt6G;
        "pkg-1.19.4-4.2.0" = _Wswq6YSl;
        "pkg-1.20.1-5.0.1" = _S5qO1mTQ;
        "pkg-1.15.2-1.2.4" = _jRy9SBZF;
        "pkg-1.16.4-1.4.1" = _aUIKAmsY;
        "pkg-21.1.0" = _IPA2cWx1;
        "pkg-21.1.1" = _hpjHVX9l;
        "pkg-21.1.2" = _zfp98FUp;
        "pkg-21.1.3" = _EUuPKAZ7;
        "pkg-21.1.4" = _omY8QNbP;
        "default" = _omY8QNbP;
    });
