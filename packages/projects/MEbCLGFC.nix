...
let
    ...
    in {
        ...
        "pkg-2.6.1" = _uFZdv7Fl;
        "pkg-3.3.0" = _FJTgiNLA;
        "pkg-1.18.2-3.4.0" = _aGHTFJKd;
        "pkg-1.18.2-3.3.0" = _qFP1A5cN;
        "pkg-1.18.1-3.3.0" = _zgIBrqhV;
        "pkg-1.17.1-2.6.1" = _4QF0eQgb;
        "pkg-1.16.5-2.7.1" = _fQ0H6dr8;
        "pkg-1.18.2-3.2.0" = _VFaMe07k;
        "pkg-1.18.1-3.0.2" = _EK6jNA8Z;
        "pkg-1.16.5-2.7.0" = _SHXddDm8;
        "pkg-1.18.2-3.1.0" = _Ox0hPare;
        "pkg-1.18.1-3.0.1" = _CF1ic27L;
        "pkg-1.17.1-2.6.0" = _PZWb84Dp;
        "pkg-1.16.5-2.6.0" = _MyLLwtFW;
        "pkg-1.17.1-2.5.1" = _dERjiY7a;
        "pkg-1.16.5-2.5.1" = _tQJvdkd4;
        "pkg-1.17.1-2.5.0" = _BeP6qywo;
        "pkg-1.16.5-2.5.0" = _HmJeVfml;
        "pkg-1.17.1-2.4.1" = _GOEhOX2r;
        "pkg-1.16.5-2.4.1" = _qRNN9Jqf;
        "pkg-1.17.1-2.4.0" = _dorYTCK6;
        "pkg-1.16.5-2.4.0" = _cUsDv6EY;
        "pkg-1.17.1-2.3.1" = _vCmr0cz8;
        "pkg-1.16.5-2.3.1" = _6CvWOKd7;
        "pkg-1.17.1-2.3.0" = _7W5bPWN2;
        "pkg-1.16.5-2.2.1" = _ROFbRdks;
        "pkg-1.16.5-2.2.0" = _ZokXUlew;
        "pkg-1.16.5-2.1.0" = _OAeGYmID;
        "pkg-1.16.5-2.0.2" = _oCeRzSOd;
        "pkg-1.16.5-2.0.1" = _kHDUaAyn;
        "pkg-1.16.5-2.0.0" = _aNSnfGzN;
        "pkg-1.0.2-1.12.0" = _IhC9PFNJ;
        "pkg-1.0.2-1.11.2" = _OngoeP4N;
        "pkg-1.0.2-1.10.2" = _8LkPO8LO;
        "pkg-1.0.2-1.9.4" = _c4II3Vwe;
        "pkg-1.0.2-1.8.9" = _DGYFMG63;
        "pkg-1.0.2-1.7.10" = _ZHXItXWh;
        "pkg-1.0.1-1.7.10" = _NP2I25gD;
        "pkg-1.0.1-1.8.9" = _TGw4FmbN;
        "pkg-1.0.1-1.9.4" = _lQpko7ze;
        "pkg-1.0.0-1.9.4" = _AwJQ3iAD;
        "pkg-1.0.0-1.7.10" = _Eqvdg2rp;
        "pkg-1.0.0-1.8.9" = _s6GIaxWP;
        "pkg-v1.18.2-3.4.1" = _dQjKFZYn;
        "default" = _dQjKFZYn;
    });
