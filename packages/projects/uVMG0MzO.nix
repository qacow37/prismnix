...
let
    ...
    in {
        ...
        "pkg-4.0.8" = _1uUCNz5z;
        "pkg-4.0.9" = _rrmQvGlF;
        "pkg-4.0.9.1" = _9XHOqGQs;
        "pkg-4.1.0B" = _VbznjHaL;
        "pkg-4.1.0B-3" = _3GJcJ7Ti;
        "pkg-4.1.0-B5" = _UxxauB5l;
        "pkg-4.1.0" = _ALE1ZYQ4;
        "pkg-4.1.1" = _u8gSMtLf;
        "pkg-4.1.2-b1" = _GbzwSKQC;
        "pkg-4.1.2-b2" = _Asei9gLJ;
        "pkg-4.1.2-b3" = _h8lYiHU9;
        "pkg-4.1.2-b4" = _FbvT1NRw;
        "pkg-4.1.2" = _83izqKy6;
        "pkg-4.1.3-b1" = _RBnRC8Uj;
        "pkg-4.1.3-b2" = _bKwkglYE;
        "pkg-4.1.3-b3" = _9ETvUojW;
        "pkg-4.1.3-b4" = _h6vG9olq;
        "pkg-4.1.3-b5" = _xZ7J4RXw;
        "pkg-4.1.4" = _BxI4HhTB;
        "pkg-4.1.5-b1" = _PxSAvjj9;
        "pkg-4.1.5-b2" = _uW7U72pZ;
        "pkg-4.1.5" = _3L0LVid4;
        "default" = _3L0LVid4;
    });
