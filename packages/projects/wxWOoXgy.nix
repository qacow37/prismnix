...
let
    ...
    in {
        ...
        "pkg-1.0.0_1.7.10" = _sjsP0s82;
        "pkg-1.0.1_1.7.10" = _P7wlFQFg;
        "pkg-1.0.2_1.7.10" = _OGRQcEJD;
        "pkg-1.0.3_1.7.10" = _u2uGTgjq;
        "pkg-1.0.4_1.7.10" = _vYTkuepW;
        "pkg-1.0.5_1.7.10" = _Xwa5chrg;
        "pkg-1.0.6_1.7.10" = _a8CVNqe5;
        "pkg-1.0.7_1.7.10" = _OMwZikHZ;
        "pkg-1.0.8_1.7.10" = _z4SM4i1V;
        "pkg-1.0.9_1.7.10" = _aAu097um;
        "pkg-1.1.0_1.7.10" = _m8AcffJE;
        "pkg-1.1.1_1.7.10" = _JGIyNRMX;
        "pkg-1.2.0_1.7.10" = _7uWFwcqG;
        "pkg-1.2.1_1.7.10" = _wqZKHsaF;
        "pkg-1.7.10" = _D6Wi7gL8;
        "pkg-1.8.8" = _U8H4Upcq;
        "pkg-1.8+" = _ov3AgjuE;
        "pkg-1.1.4.170" = _gfOvq8pq;
        "pkg-1.1.4.171" = _4LX1nupv;
        "pkg-2.2.0.174" = _m8kkkXzd;
        "pkg-2.2.0.175" = _bcSjSRiB;
        "pkg-2.2.0.176" = _eIaen0Zu;
        "pkg-2.2.0.177" = _Pob6Aqt6;
        "pkg-2.2.0.178" = _2T1eeIzt;
        "pkg-2.2.0.179" = _2CXxmftN;
        "pkg-2.2.0.180" = _q3EPVCHR;
        "pkg-2.2.0.181" = _32cbnhYM;
        "pkg-2.2.0.184" = _1lUmFqcr;
        "pkg-2.2.0.186" = _qGd5SWcw;
        "pkg-1.0.5.120" = _eeGiL6NE;
        "pkg-2.2.1.190" = _75EwI86Q;
        "pkg-2.2.1.191" = _CvFjl1AO;
        "pkg-2.2.1.192" = _oxPdHZfE;
        "pkg-2.3.0.193" = _8OY320j1;
        "pkg-2.3.0.194" = _o5tPLeFl;
        "pkg-2.3.0.195" = _CKZIQYxN;
        "pkg-2.3.0.197" = _7ljtyDLU;
        "pkg-2.3.0.198" = _8ClPR0jZ;
        "pkg-2.3.0.199" = _Ntc1XVjd;
        "pkg-2.3.0.200" = _4634ohU3;
        "pkg-2.3.0.201" = _GesRQTjl;
        "pkg-2.3.0.202" = _KEvqWoRc;
        "pkg-2.3.0.203" = _IYRFtViT;
        "pkg-2.3.0.204" = _UK5n60pe;
        "pkg-2.3.0.205" = _1vGIFbSB;
        "pkg-2.3.0.206" = _li8ukSKm;
        "pkg-2.3.0.207" = _oNuJmlKT;
        "pkg-2.3.1.208" = _Y7RHqodm;
        "pkg-2.3.1.209" = _fsvnHR5Y;
        "pkg-2.3.1.210" = _xZEmzQxx;
        "pkg-2.3.1.211" = _f6ORI9KC;
        "pkg-2.3.1.212" = _fG7ZWc0Y;
        "pkg-2.3.1.213" = _NnddMs8V;
        "pkg-2.3.1.214" = _mTsyvELL;
        "pkg-2.3.2.215" = _oKjO7pux;
        "pkg-2.4.0.217" = _d6WOdvm5;
        "pkg-2.4.0.218" = _56j1dqWe;
        "pkg-2.4.0.219" = _Y0OjxMWA;
        "pkg-2.4.0.220" = _z54vyfwE;
        "pkg-2.4.0.221" = _VH4R022T;
        "pkg-2.4.0.230" = _KFY7AY6p;
        "pkg-2.4.0.231" = _AvNdtrDV;
        "pkg-2.4.0.232" = _carAakYT;
        "pkg-2.4.0.233" = _yfFGrW7s;
        "pkg-2.5.235" = _Ej1H9Gmv;
        "pkg-2.5.236" = _L1h8iMKo;
        "pkg-2.5.237" = _Nwm39x5V;
        "pkg-2.5.238" = _NfTrNZG9;
        "pkg-2.5.239" = _asBST5iY;
        "pkg-2.5.240" = _Y1QSh1kC;
        "pkg-2.5.241" = _HC0VoqNF;
        "pkg-2.5.243" = _F3ZcniLV;
        "pkg-2.5.244" = _8uAhBuE4;
        "pkg-2.5.245" = _83qrvl5Z;
        "pkg-2.5.246" = _h5Y3s0D6;
        "pkg-2.5.247" = _CQtw1ak3;
        "pkg-2.5.248" = _R7xYpJe7;
        "pkg-2.5.249" = _FV9vzcoP;
        "pkg-2.5.250" = _MP0GTbrI;
        "pkg-2.5.251" = _KCVkH2dQ;
        "pkg-2.5.253" = _bqPAtbE4;
        "pkg-2.5.254" = _fZtTH3Of;
        "pkg-2.5.255" = _J8IZ89Fs;
        "pkg-2.5.256" = _pfvRprZ4;
        "pkg-2.5.257" = _kaH0U3sg;
        "pkg-2.5.259" = _hxNJTSnH;
        "pkg-2.5.260" = _3YPwK0vH;
        "pkg-2.5.261" = _tjJEZaZy;
        "pkg-2.5.262" = _P3hB7k3X;
        "pkg-2.5.263" = _otYJEahS;
        "pkg-2.5.264" = _Y2LS6GN7;
        "pkg-2.5.265" = _LZ0xcUAC;
        "pkg-2.5.269" = _T2Q80k1g;
        "pkg-2.5.270" = _iGkZhqCy;
        "pkg-2.5.271" = _xaPLiprr;
        "pkg-2.5.272" = _OhgSvXjV;
        "pkg-2.5.273" = _LAH8b2J8;
        "pkg-2.6.274" = _y5DOUdS8;
        "pkg-2.6.275" = _eJ3Yfksn;
        "pkg-3.0.1" = _BUvxMMji;
        "pkg-3.0.2" = _sLPA1y8M;
        "pkg-3.0.3" = _GO1oNYyH;
        "pkg-3.0.4" = _KQ77XBZJ;
