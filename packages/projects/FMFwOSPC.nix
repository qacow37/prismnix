...
let
    ...
    in {
        ...
        "pkg-1.13-1.14.4" = _U7KnAnnH;
        "pkg-1.15-1.16.1" = _MUsTZcUj;
        "pkg-1.16.2-1.16.5" = _skNb9FIa;
        "pkg-1.17-1.17.1" = _O5WH6mp5;
        "pkg-1.18-1.18.2" = _VYhgrIrS;
        "pkg-1.19-1.19.2" = _BrjhUque;
        "pkg-1.19.3" = _SLzCX2bf;
        "pkg-1.19.4" = _C0wjbj9U;
        "pkg-1.20-1.20.1" = _BLVjmjS3;
        "pkg-1.20.2" = _C5abUUYg;
        "pkg-1.20.3-1.20.4" = _gs6LHoVS;
        "pkg-1.20.5-1.20.6" = _qEouVZh9;
        "pkg-1.21-1.21.1" = _C5jbIA8V;
        "pkg-1.21.2-1.21.3" = _Ka2vQG39;
        "pkg-1.21.4" = _qZ9rJkY9;
        "pkg-1.21.5" = _wjnUPzMn;
        "pkg-1.21.6" = _xdrrSk7z;
        "pkg-1.21.7-1.21.8" = _qfTl04Pz;
        "pkg-1.21.9-1.21.10" = _KQuki3tn;
        "pkg-1.21.11" = _TDoiy9SN;
