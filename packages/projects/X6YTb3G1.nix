...
let
    ...
    in {
        ...
        "pkg-mc1.16-1.0.0" = _uNI5R4I2;
        "pkg-mc1.15-1.0.0" = _CsoHZo7N;
        "pkg-mc1.14-1.0.0" = _iJB9STLZ;
        "pkg-mc1.16-1.1.0" = _VsKay7J7;
        "pkg-mc1.15-1.1.0" = _vmt5XIZf;
        "pkg-mc1.14-1.1.0" = _4kjckWPu;
        "pkg-mc1.14-1.2.0" = _CcBoJ4nt;
        "pkg-mc1.15-1.2.0" = _VoBSsv40;
        "pkg-mc1.16-1.2.0" = _epdyyhca;
        "pkg-mc1.16-1.2.1" = _s1NtO0b0;
        "pkg-mc1.14-1.3.0" = _9NdqLj4a;
        "pkg-mc1.15-1.3.0" = _1DF9OjK1;
        "pkg-mc1.16-1.3.0" = _cx1arZxK;
        "pkg-mc1.17-1.3.0" = _wpvt7iR3;
        "pkg-mc1.14-1.4.0" = _Y42wF3sZ;
        "pkg-mc1.15-1.4.0" = _aJhad32F;
        "pkg-mc1.16-1.4.0" = _cQi9pPK1;
        "pkg-mc1.17-1.4.0" = _dO5Hqxig;
        "pkg-mc1.18-1.4.0" = _2yHsInUS;
        "pkg-mc1.14-1.5.0" = _gt4IXzMi;
        "pkg-mc1.15-1.5.0" = _YsQDkbxp;
        "pkg-mc1.16-1.5.0" = _NWWegPLk;
        "pkg-mc1.16.2-1.5.0" = _K9RNeXQs;
        "pkg-mc1.17-1.5.0" = _ted69jaa;
        "pkg-mc1.18-1.5.0" = _yvxwr6HJ;
        "pkg-mc1.14-1.6.0" = _zGcYnEIv;
        "pkg-mc1.15-1.6.0" = _kkmmRUvA;
        "pkg-mc1.16-1.6.0" = _OZQCEbGJ;
        "pkg-mc1.16.2-1.6.0" = _L4D5ovdn;
        "pkg-mc1.17-1.6.0" = _cnZBcLo9;
        "pkg-mc1.18-1.6.0" = _yyGw4P8D;
        "pkg-mc1.14-1.6.1" = _CmGNaosj;
        "pkg-mc1.15-1.6.1" = _wCJ3frWx;
        "pkg-mc1.16-1.6.1" = _hs0UltFV;
        "pkg-mc1.16.2-1.6.1" = _Ia2zpByP;
        "pkg-mc1.17-1.6.1" = _v73ugYXh;
        "pkg-mc1.18-1.6.1" = _wDRX44na;
        "pkg-mc1.18.2-1.6.1" = _Fc863N1b;
        "pkg-mc1.19-1.6.0" = _jct4BbeP;
        "pkg-mc1.14-1.7.0" = _GrYRA7Rr;
        "pkg-mc1.15-1.7.0" = _wL40uVnZ;
        "pkg-mc1.16-1.7.0" = _2twERG2I;
        "pkg-mc1.16.2-1.7.0" = _Jp4dPArL;
        "pkg-mc1.17-1.7.0" = _E2wCjyLT;
        "pkg-mc1.18-1.7.0" = _ZxjBSJ5I;
        "pkg-mc1.19-1.7.0" = _r0S1RQt3;
        "pkg-mc1.18.2-1.7.0" = _eJJlrwqG;
        "pkg-mc1.14-1.8.0" = _v9NFIc8n;
        "pkg-mc1.15-1.8.0" = _vamYdb9l;
        "pkg-mc1.16-1.8.0" = _edQpS0Mb;
        "pkg-mc1.16.2-1.8.0" = _v37vb3ng;
        "pkg-mc1.17-1.8.0" = _RpsOphme;
        "pkg-mc1.18-1.8.0" = _UnhdfNT8;
        "pkg-mc1.18.2-1.8.0" = _5egZdGru;
        "pkg-mc1.19-1.8.0" = _BYrxqdaD;
        "pkg-mc1.14-1.9.0" = _Gy3e4Gew;
        "pkg-mc1.15-1.9.0" = _Ki6PTsbY;
        "pkg-mc1.16-1.9.0" = _MC5RuZbT;
        "pkg-mc1.16.2-1.9.0" = _BvdUoXU7;
        "pkg-mc1.17-1.9.0" = _oxrdTZ4h;
        "pkg-mc1.18-1.9.0" = _iDvl9avd;
        "pkg-mc1.18.2-1.9.0" = _yil5JOoV;
        "pkg-mc1.19-1.9.0" = _4C1zMn3A;
        "pkg-mc1.14-1.9.1" = _CpLwvKvf;
        "pkg-mc1.15-1.9.1" = _ajz9X0LI;
        "pkg-mc1.16-1.9.1" = _wlgf59Cb;
        "pkg-mc1.16.2-1.9.1" = _j6ZjUS6G;
        "pkg-mc1.17-1.9.1" = _emfPdPiE;
        "pkg-mc1.18-1.9.1" = _LikbNOZS;
        "pkg-mc1.18.2-1.9.1" = _X9bzDLiH;
        "pkg-mc1.19-1.9.1" = _f2NZI4kq;
        "pkg-mc1.14-1.10.0" = _n9DsgvKI;
        "pkg-mc1.15-1.10.0" = _G4Myh3f1;
        "pkg-mc1.16-1.10.0" = _Fwow3wny;
        "pkg-mc1.16.2-1.10.0" = _ijCKC6zj;
        "pkg-mc1.17-1.10.0" = _j8jtrcVS;
        "pkg-mc1.18-1.10.0" = _xSip17L4;
        "pkg-mc1.18.2-1.10.0" = _94IgrqXt;
        "pkg-mc1.19-1.10.0" = _mptJhZ0Y;
        "pkg-mc1.14-1.11.0" = _HMqOEhfP;
        "pkg-mc1.15-1.11.0" = _tLtTFU6K;
        "pkg-mc1.16-1.11.0" = _3wFFzTHt;
        "pkg-mc1.16.2-1.11.0" = _Yiuq26Um;
        "pkg-mc1.17-1.11.0" = _eVsgExlF;
        "pkg-mc1.18-1.11.0" = _d8q1gwK0;
        "pkg-mc1.18.2-1.11.0" = _CLG5Z2DS;
        "pkg-mc1.19-1.11.0" = _uJiVTtxr;
        "pkg-mc1.19.3-1.11.0" = _dtSiVtzx;
        "pkg-mc1.19.3-1.11.1" = _E13hQnQs;
        "pkg-mc1.14-1.11.1" = _nzTKwNH8;
        "pkg-mc1.15-1.11.1" = _DtFZDW4L;
        "pkg-mc1.16-1.11.1" = _rW3y5WwJ;
        "pkg-mc1.16.2-1.11.1" = _2Bt5Ugso;
        "pkg-mc1.17-1.11.1" = _Y8EFiM0X;
        "pkg-mc1.18-1.11.1" = _8WfDerC1;
        "pkg-mc1.18.2-1.11.1" = _NkCAyJwF;
        "pkg-mc1.19-1.11.1" = _dB8TsDYd;
        "pkg-mc1.19.3-1.11.2" = _ymkn2Vgb;
        "pkg-mc1.19.4-1.11.0" = _h7BqfsYl;
        "pkg-mc1.18.2-1.11.2" = _VqeX8rp2;
        "pkg-mc1.14-1.12.0" = _j64civ0P;
        "pkg-mc1.15-1.12.0" = _t6M2Jey8;
        "pkg-mc1.16-1.12.0" = _OT4eLdSW;
        "pkg-mc1.16.2-1.12.0" = _cMpatksL;
        "pkg-mc1.17-1.12.0" = _ITuCDnJ4;
        "pkg-mc1.18-1.12.0" = _hxtw3JFD;
        "pkg-mc1.18.2-1.12.0" = _IG7C9w26;
        "pkg-mc1.19-1.12.0" = _RcNfBt2M;
        "pkg-mc1.19.3-1.12.0" = _unU09rhi;
        "pkg-mc1.19.4-1.12.0" = _BvSo7viQ;
        "pkg-mc1.19.4-1.12.1" = _tDCqrz96;
        "pkg-mc1.20-1.12.0" = _7Rh9B3Zq;
        "pkg-mc1.14-1.13.0" = _6dczICSC;
        "pkg-mc1.15-1.13.0" = _TOqhBIbB;
        "pkg-mc1.16-1.13.0" = _uNOKwYQ2;
        "pkg-mc1.16.2-1.13.0" = _W79vMLLg;
        "pkg-mc1.17-1.13.0" = _6ShsMQzz;
        "pkg-mc1.18-1.13.0" = _Lr3vyJKe;
        "pkg-mc1.18.2-1.13.0" = _J39yPMYb;
        "pkg-mc1.19-1.13.0" = _N9VwjkXD;
        "pkg-mc1.19.3-1.13.0" = _16yujALE;
        "pkg-mc1.19.4-1.13.0" = _92zGjDKP;
        "pkg-mc1.20-1.13.0" = _aPHLcLWH;
        "pkg-mc1.20.2-1.13.0" = _w51jlxEp;
        "pkg-mc1.16.2-1.13.1" = _G6ehvBD2;
        "pkg-mc1.20-1.13.1" = _PCigxs2N;
        "pkg-mc1.20.2-1.13.1" = _JTva324U;
        "pkg-mc1.14-1.14.0" = _7fzus7oz;
        "pkg-mc1.15-1.14.0" = _m3HaES2v;
        "pkg-mc1.16-1.14.0" = _YiD7mkZf;
        "pkg-mc1.16.2-1.14.0" = _3KuvNOJC;
        "pkg-mc1.17-1.14.0" = _Qq4gVGCV;
        "pkg-mc1.18-1.14.0" = _Bhh9rcUs;
        "pkg-mc1.18.2-1.14.0" = _3ULgJwO6;
        "pkg-mc1.19-1.14.0" = _m5r6b4JO;
        "pkg-mc1.19.3-1.14.0" = _UEf1zRwO;
        "pkg-mc1.19.4-1.14.0" = _InaiupI1;
        "pkg-mc1.20-1.14.0" = _ULk8oNnm;
        "pkg-mc1.20.2-1.14.0" = _zEMgeC8L;
        "pkg-mc1.17-1.14.1" = _YhRfmle4;
        "pkg-mc1.18.2-1.14.1" = _uqf9ffZz;
        "pkg-mc1.19.3-1.14.1" = _CCp6HoKn;
        "pkg-mc1.19.4-1.14.1" = _IQc0rI6p;
        "pkg-mc1.20-1.14.1" = _8nQfWIuy;
        "pkg-1.20.2-1.14.1" = _YXswnmvv;
        "pkg-mc1.20.2-1.14.2" = _HY8RmcRV;
        "pkg-mc1.20.3-1.14.3" = _KlsvQP3u;
        "pkg-mc1.8-1.14.0" = _XjKNRT8o;
        "pkg-mc1.9-1.14.0" = _jkSPUFh0;
        "pkg-mc1.10-1.14.0" = _OwWlgtFq;
        "pkg-mc1.11-1.14.0" = _PnToafOH;
        "pkg-mc1.12-1.14.0" = _jTPIjmkU;
        "pkg-mc1.13-1.14.0" = _R8Gfwz9s;
        "pkg-mc1.20.5-1.14.0" = _GLDUuN6C;
        "pkg-mc1.20.5-1.14.1" = _F56XHAHs;
        "pkg-mc1.21-1.14.0" = _vNFjYMgM;
        "pkg-mc1.21-1.15.0-beta.1" = _rsdxFwC7;
        "pkg-mc1.21-1.15.0-beta.2" = _51IEz6sX;
        "pkg-mc1.21-1.15.0-beta.3" = _vNzHgPOC;
        "pkg-mc1.21-1.15.0-beta.4" = _hFmXlJVy;
        "pkg-mc1.21-1.15.0-beta.5" = _3MiKbFTW;
        "pkg-mc1.7-1.15.0" = _XloMudQK;
        "pkg-mc1.7.3-1.15.0" = _tAVxZb3z;
        "pkg-mc1.8-1.15.0" = _H5kZf6TH;
        "pkg-mc1.9-1.15.0" = _hbCfntry;
        "pkg-mc1.10-1.15.0" = _15y0nEWJ;
        "pkg-mc1.11-1.15.0" = _z1tB0jae;
        "pkg-mc1.12-1.15.0" = _GwkLoJmb;
        "pkg-mc1.13-1.15.0" = _3YN7dNwU;
        "pkg-mc1.14-1.15.0" = _150Y4813;
        "pkg-mc1.15-1.15.0" = _tffQ9EpJ;
        "pkg-mc1.16-1.15.0" = _WW6MMRG2;
        "pkg-mc1.16.2-1.15.0" = _7qeHj0Zx;
        "pkg-mc1.17-1.15.0" = _9mahRoVW;
        "pkg-mc1.18-1.15.0" = _60XYOJBe;
        "pkg-mc1.18.2-1.15.0" = _e1eWPSXT;
        "pkg-mc1.19-1.15.0" = _CiQm8cVs;
        "pkg-mc1.19.3-1.15.0" = _9uGUiLi5;
        "pkg-mc1.19.4-1.15.0" = _mVGz2TkL;
        "pkg-mc1.20-1.15.0" = _Es57w65C;
        "pkg-mc1.20.2-1.15.0" = _wqNlQrWf;
        "pkg-mc1.20.4-1.15.0" = _mL3dYOBL;
        "pkg-mc1.20.5-1.15.0" = _YyoTz7r3;
        "pkg-mc1.21-1.15.0" = _23Cxfz7Q;
        "pkg-mc1.21.2-1.15.0" = _n3uN9T1E;
        "pkg-mc1.21.4-1.15.0" = _KScMsbbI;
        "pkg-mc1.20.5-1.15.1" = _nU4PaWpB;
        "pkg-mc1.21-1.15.1" = _3xPG68W2;
        "pkg-mc1.21.2-1.15.1" = _kTiP34Lj;
        "pkg-mc1.21.4-1.15.1" = _gWWxWyl1;
        "pkg-mc1.21.5-1.15.0" = _ZK4u88jr;
        "pkg-mc1.17-1.15.1" = _GF20lgHt;
        "pkg-mc1.18.2-1.15.1" = _h3KdTVv2;
        "pkg-mc1.19.3-1.15.1" = _643v7hoy;
        "pkg-mc1.19.4-1.15.1" = _AjkZnk9k;
        "pkg-mc1.20-1.15.1" = _gnMRDUu1;
        "pkg-mc1.3-1.16.0" = _xmEcIKdt;
        "pkg-mc1.4-1.16.0" = _P1qebfyz;
        "pkg-mc1.5-1.16.0" = _cj2R2hz8;
        "pkg-mc1.6-1.16.0" = _Nt2nrMlA;
        "pkg-mc1.7-1.16.0" = _5NoStURN;
        "pkg-mc1.7.6-1.16.0" = _xICwRygc;
        "pkg-mc1.8-1.16.0" = _2Q2BsUqc;
        "pkg-mc1.9-1.16.0" = _HdUTNkfm;
        "pkg-mc1.10-1.16.0" = _NJ4mYWte;
        "pkg-mc1.11-1.16.0" = _7dZgSpHK;
        "pkg-mc1.12-1.16.0" = _JddOS2Do;
        "pkg-mc1.13-1.16.0" = _LQ2pMm05;
        "pkg-mc1.14-1.16.0" = _OSgQJeFn;
        "pkg-mc1.15-1.16.0" = _ibo0t6OR;
        "pkg-mc1.16-1.16.0" = _WlVDaAwb;
        "pkg-mc1.16.2-1.16.0" = _6gNWbsqv;
        "pkg-mc1.17-1.16.0" = _4mLxDGhr;
        "pkg-mc1.18-1.16.0" = _OqPaMIT7;
        "pkg-mc1.18.2-1.16.0" = _CiVQGmmy;
        "pkg-mc1.19-1.16.0" = _9cgjKmrH;
        "pkg-mc1.19.3-1.16.0" = _gGzSknRR;
        "pkg-mc1.19.4-1.16.0" = _hygV5ENr;
        "pkg-mc1.20-1.16.0" = _O8wbQA9o;
        "pkg-mc1.20.2-1.16.0" = _6dTNHKh5;
        "pkg-mc1.20.3-1.16.0" = _bMpkMumK;
        "pkg-mc1.20.5-1.16.0" = _f7RKiLlH;
        "pkg-mc1.21-1.16.0" = _hQ2fPuzY;
        "pkg-mc1.21.2-1.16.0" = _2z4BcDx1;
        "pkg-mc1.21.4-1.16.0" = _H4JRyU2R;
        "pkg-mc1.21.5-1.16.0" = _b3ggMGQA;
        "pkg-mc1.21.6-1.16.0" = _tYohdy2b;
        "pkg-mc1.21.7-1.16.0" = _z6gMz4UR;
        "pkg-mc1.15-1.16.1" = _acFvbnKC;
        "pkg-mc1.16-1.16.1" = _QcB6XX9X;
        "pkg-mc1.16.2-1.16.1" = _wMVr0BGZ;
        "pkg-mc1.17-1.16.1" = _ImmmtZKx;
        "pkg-mc1.21.9-1.17.0" = _myrGKPjK;
        "pkg-mc1.21.11-1.17.0" = _Hjs8kaY4;
        "pkg-mc1.21.11-1.17.1" = _9s5DeFH4;
        "pkg-mc26.1-1.17.0" = _lZ4iQ6LE;
        "pkg-mc26.2-1.17.0" = _PVHFYkK3;
        "default" = _PVHFYkK3;
    });
