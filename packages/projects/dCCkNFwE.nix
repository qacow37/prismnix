...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _c9O4G6KS;
        "pkg-1.20-1.1.6" = _RzDwDNWI;
        "pkg-1.20-1.1.7" = _P9yWdz2S;
        "pkg-1.20-1.1.8" = _XBWAshDT;
        "pkg-1.20-1.1.9" = _h6uf5Ohn;
        "pkg-1.20-1.1.10" = _9EkzflrT;
        "pkg-1.20-1.1.11" = _fUnsJfp4;
        "pkg-1.20-1.1.12" = _6RvCMFn1;
        "pkg-1.20-1.1.13" = _Rk04TjQ3;
        "pkg-1.20-1.1.14" = _8PXoizc7;
        "pkg-1.20-1.1.15" = _FBkL5CxZ;
        "pkg-1.20-1.1.16" = _epDSxpGy;
        "pkg-1.20-1.1.18" = _YnMoU1Cj;
        "pkg-fabric_1.21-1.2.3" = _RsgCDYAi;
        "pkg-neoforge_1.21-1.2.3" = _YlSpxRKO;
        "pkg-1.20-1.1.21" = _QqMQ0LSA;
        "pkg-fabric_1.21-1.2.4" = _pTPmMR6c;
        "pkg-neoforge_1.21-1.2.4" = _TMXw4VjL;
        "pkg-neoforge_1.21-1.2.5" = _tZkHAxeC;
        "pkg-fabric_1.21-1.2.5" = _VNQqs8gA;
        "pkg-neoforge_1.21-1.2.7" = _KM0DSBV8;
        "pkg-fabric_1.21-1.2.7" = _J97Ahz2A;
        "pkg-fabric_1.21-1.2.8" = _PaHXd3UT;
        "pkg-neoforge_1.21-1.2.8" = _EaRtlzLh;
        "pkg-neoforge_1.21-1.2.9" = _taCUiJVT;
        "pkg-fabric_1.21-1.2.9" = _b4ivvkBK;
        "pkg-fabric_1.21-1.2.10" = _BuOF2yco;
        "pkg-neoforge_1.21-1.2.10" = _c0Olyzlr;
        "pkg-1.20-1.1.22" = _Stzf8x7J;
        "pkg-neoforge_1.21-1.2.11" = _cH3ZwWfQ;
        "pkg-fabric_1.21-1.2.11" = _NdIT5y0C;
        "pkg-neoforge_1.21-1.2.12" = _4kxASiJs;
        "pkg-fabric_1.21-1.2.12" = _beBPiOCN;
        "pkg-1.20-1.1.23" = _avILgxzS;
        "pkg-neoforge_1.21-1.2.13" = _5TlyrOPH;
        "pkg-fabric_1.21-1.2.13" = _1Wby1KUa;
        "pkg-fabric_1.21-1.2.14" = _M2ixWndm;
        "pkg-neoforge_1.21-1.2.14" = _m9CoftwQ;
        "pkg-1.20-1.1.24" = _vQ2LoflR;
        "pkg-1.20-1.1.25" = _rUDFruiT;
        "pkg-1.20-1.1.26" = _IMFQf21R;
        "pkg-fabric_1.21-1.2.15" = _umwXpWVh;
        "pkg-1.20-1.1.27" = _m2SEy83c;
        "pkg-1.20-1.1.28" = _azr5Pcp6;
        "pkg-neoforge_1.21-1.2.17" = _6LgMCeqW;
        "pkg-fabric_1.21-1.2.17" = _4AreWltB;
        "pkg-1.20-1.1.29" = _hGBKgPSc;
        "pkg-1.21-1.2.18" = _wNDokve9;
        "default" = _wNDokve9;
    });
