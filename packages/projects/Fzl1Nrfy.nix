...
let
    ...
    in {
        ...
        "pkg-0.2.8" = _aWCZtWOU;
        "pkg-0.2.9" = _ihMKQsJD;
        "pkg-0.2.10" = _dOq0bdH2;
        "pkg-0.2.11.94" = _Ns6SRVzN;
        "pkg-0.2.12.95" = _ozWPcuX1;
        "pkg-0.2.13.96" = _EwdWayza;
        "pkg-0.2.14.100" = _zW3kYfka;
        "pkg-0.2.15.106" = _SmhdI64V;
        "pkg-2.0-beta2" = _JCCZBeoK;
        "pkg-2.0-beta3" = _OEziZtqx;
        "pkg-2.0.1" = _Wq0o6ARv;
        "pkg-2.0.2" = _Nbq5HiHv;
        "pkg-2.1.0" = _qtZ0YWIc;
        "pkg-2.1.1" = _z2f9tRy5;
