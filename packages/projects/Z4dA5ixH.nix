...
let
    ...
    in {
        ...
        "pkg-1.20.1_0.0.5" = _jnnTgMvN;
        "pkg-1.20.1_0.0.6" = _bWjAhfKm;
        "pkg-1.21.1_0.0.7" = _BM7RWU0D;
        "pkg-1.20.1_0.0.7" = _7F8Beltw;
        "pkg-1.21.1_0.0.8_pre1" = _RbS6HOcY;
        "pkg-0.0.82" = _XsEPFLEs;
        "pkg-0.0.83" = _l4fsEDxn;
        "pkg-0.0.84" = _tJORhqtG;
        "pkg-0.0.85" = _pF6vN4o1;
        "pkg-0.0.8" = _ovcrF1ue;
        "pkg-0.0.91" = _P4MR4ohT;
        "pkg-0.0.9b2" = _Wcmt8AuD;
        "pkg-0.0.9b3" = _U3IN9Bxg;
        "pkg-0.0.9b4" = _CchkfFu5;
        "pkg-0.0.b95" = _WQKSH8GK;
        "pkg-0.0.9b5" = _xeTj4uWr;
        "pkg-0.0.9b6" = _xRypuoEA;
        "pkg-0.0.9b6fix1" = _HaTaZPLF;
        "pkg-0.0.9b6b1" = _Vb5zgK0V;
        "pkg-0.1.0" = _HFtJuoDm;
        "pkg-0.1.1" = _vd4lOBs0;
        "pkg-0.1.2" = _k4xPNay8;
        "pkg-0.1.3" = _Ndlo9uPW;
        "pkg-0.1.3fix1" = _nEn1XIz4;
        "pkg-0.1.32" = _9EKn9Ba0;
        "pkg-0.1.4" = _BvoRcRHx;
        "pkg-0.1.5" = _36kOId1Z;
        "pkg-0.1.51" = _xJzPGoPT;
        "pkg-0.1.62" = _VNEGMvib;
        "pkg-0.1.63" = _hxtaU7qp;
        "pkg-0.1.64" = _MPE54E7e;
        "pkg-0.1.65" = _xWmQ26BR;
        "pkg-0.1.6b6" = _Z6qgdCba;
        "pkg-0.1.6" = _kR8DoAjh;
        "pkg-0.1.71" = _QCaAbHOP;
        "pkg-0.1.7a1" = _j8c2MFwL;
        "pkg-0.1.7b2" = _VlLsVz13;
        "pkg-0.1.7a3" = _Cahjw5IS;
        "pkg-0.1.7b3" = _ACxk6VDY;
        "pkg-0.1.73" = _5r0xCzpk;
        "pkg-0.1.7" = _9zP1YOLv;
        "pkg-0.1.8b1" = _EyCLqgbn;
        "pkg-0.1.8b2" = _rVrd1xIe;
        "pkg-0.1.8" = _UNDYNqLo;
        "pkg-0.1.9" = _kKvm87Wo;
        "pkg-0.2.0" = _6xulnTND;
        "pkg-0.2.1" = _FefofI1o;
        "pkg-0.2.1hotfix1" = _4H9zceIB;
        "pkg-0.2.2" = _DGU5asgT;
        "pkg-0.2.3" = _phQYN1Ve;
        "pkg-0.2.4" = _xBvsOmpa;
        "pkg-0.2.5pre1" = _hP2uwtJh;
        "pkg-0.2.5pre2" = _A32V1mWt;
        "pkg-0.2.5pre3" = _x3kiuxSF;
        "pkg-0.2.5" = _JVuLbxFp;
        "pkg-0.2.6" = _MhbcNeBp;
        "pkg-0.2.7" = _JJ4je7gs;
        "pkg-0.2.7-H1" = _qX1ASpY2;
        "pkg-0.2.7-H2" = _8IRJKjL0;
        "pkg-0.2.7-3" = _s3BBFvU3;
        "pkg-0.2.8a" = _tSIeZ2jy;
        "pkg-0.2.8b" = _9Zz1jyWv;
        "pkg-0.2.9a" = _U78f9YGv;
        "pkg-0.2.9b" = _lUopgl6y;
        "pkg-0.2.9c" = _hxUYk9XZ;
        "pkg-0.2.9e" = _zw5Nxiup;
        "pkg-0.2.9f" = _VMoXdR5v;
        "pkg-0.2.9h" = _5QrR3Cph;
        "pkg-0.2.9i" = _WgiixSh3;
        "pkg-0.2.9g" = _gWcZsUDc;
        "pkg-0.2.9j" = _aNNF93Bl;
        "pkg-0.3.0" = _BzKFao8q;
        "default" = _BzKFao8q;
    });
