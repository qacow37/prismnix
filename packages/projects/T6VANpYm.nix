...
let
    ...
    in {
        ...
        "pkg-1.0.0-Alpha+1.18.2" = _NSQGVfCP;
        "pkg-1.0.0-Alpha+1.19.2" = _1qfi6vA1;
        "pkg-1.0.0-Alpha+1.19.4" = _Beyjkadi;
        "pkg-1.0.0-Alpha+1.20.1" = _OC7hOw3V;
        "pkg-1.0.0-Alpha+1.20.4" = _Gkn5xeUy;
        "pkg-1.0.0-Alpha+1.21.1" = _YOGRzuxN;
        "pkg-1.0.0-Alpha+1.21.4" = _2aHw7hCu;
        "pkg-1.0.1-Alpha+1.21.4" = _f2qtfNEZ;
        "pkg-1.0.1-Alpha+1.21.1" = _eej3Dk89;
        "pkg-1.0.1-Alpha+1.20.4" = _CPnaiXKn;
        "pkg-1.0.1-Alpha+1.20.1" = _pgfVUxIT;
        "pkg-1.0.1-Alpha+1.19.4" = _QW9Os7Ic;
        "pkg-1.0.1-Alpha+1.19.2" = _ugk3DOmp;
        "pkg-1.0.1-Alpha+1.18.2" = _lK7VJmL5;
        "pkg-1.0.2-Alpha+1.21.4" = _ssjybS8K;
        "pkg-1.0.2-Alpha+1.21.1" = _axh4oq6d;
        "pkg-1.0.2-Alpha+1.20.4" = _E8VdMyMY;
        "pkg-1.0.2-Alpha+1.20.1" = _AyBxHpzS;
        "pkg-1.0.2-Alpha+1.19.4" = _tdNhLr1m;
        "pkg-1.0.2-Alpha+1.19.2" = _uDcTG5bF;
        "pkg-1.0.2-Alpha+1.18.2" = _MUImILGJ;
        "pkg-1.0.3-Alpha+1.20.1" = _TjyKlr8B;
        "pkg-1.0.3-Alpha+1.20.4" = _ukYjgYdB;
        "pkg-1.0.3-Alpha+1.21.1" = _9K9ACcCR;
        "pkg-1.0.3-Alpha+1.21.4" = _L58m0y15;
        "pkg-1.1.0-Alpha+1.21.1" = _bkBvcNie;
        "pkg-1.1.0-Alpha+1.21.4" = _5YfH85Ef;
        "pkg-1.1.0-Alpha+1.21.8" = _l7RlqdrM;
        "pkg-1.1.0-Alpha+1.21.10" = _TRbvs0Eq;
        "default" = _TRbvs0Eq;
    });
