...
let
    ...
    in {
        ...
        "pkg-mc1.21.3-v1.3.0" = _XT3oXKD3;
        "pkg-mc1.20.6-v1.3.0" = _8jv8dc0J;
        "pkg-mc1.16.5-v1.3.0" = _eX8Qlv10;
        "pkg-mc1.21-v1.3.0" = _oS15t6y6;
        "pkg-mc1.21.1-v1.3.0" = _2xzGke26;
        "pkg-mc1.17.1-v1.3.0" = _mJGBDmgy;
        "pkg-mc1.21.5-v1.3.0" = _XPSO8tmk;
        "pkg-mc1.21.4-v1.3.0" = _NZvOk3CO;
        "pkg-mc1.18.2-v1.3.0" = _HHrrxC4n;
        "pkg-mc1.18.2-v1.3.1" = _ZR8zaTQa;
        "pkg-mc1.20.6-v1.3.1" = _sEJyB5DB;
        "pkg-mc1.21.5-v1.3.1" = _agdc0BEx;
        "pkg-mc25w20a-v1.3.1" = _TxGX46b8;
        "pkg-mc1.16.5-v1.3.1" = _b8ISCnQd;
        "pkg-mc1.21.1-v1.3.1" = _mDsqN03X;
        "pkg-mc1.21-v1.3.1" = _FWcH2jjd;
        "pkg-mc1.19.4-v1.3.1" = _UZsajIMf;
        "pkg-mc1.17.1-v1.3.1" = _t49SnJMN;
        "pkg-mc1.21.4-v1.3.1" = _PPtqnHaq;
        "pkg-mc1.21.2-v1.3.1" = _ElS6TQ1V;
        "pkg-mc1.21.3-v1.3.1" = _zQovUuJE;
        "pkg-mc1.19.4-v1.4.0" = _qEUmGMtU;
        "pkg-mc1.21.4-v1.4.0" = _Hx84mjxU;
        "pkg-mc1.20.6-v1.4.0" = _kMVrfzYH;
        "pkg-mc1.16.5-v1.4.0" = _vDKiHros;
        "pkg-mc1.21.6-pre3-v1.4.0" = _NhwD2oda;
        "pkg-mc1.17.1-v1.4.0" = _b9xlKnTT;
        "pkg-mc1.18.2-v1.4.0" = _woghp3xu;
        "pkg-mc1.21-v1.4.0" = _Kg8Zv16U;
        "pkg-mc1.21.3-v1.4.0" = _xV0z53cU;
        "pkg-mc1.21.5-v1.4.0" = _5wDBLFXz;
        "pkg-mc1.21.1-v1.4.0" = _tbz6AH05;
        "pkg-mc1.21.2-v1.4.0" = _EeXA82uA;
        "pkg-mc1.21.2-v1.4.1" = _I3LUPUvc;
        "pkg-mc1.17.1-v1.4.1" = _OXx5Bvpg;
        "pkg-mc1.19.4-v1.4.1" = _7Oy5IQ9F;
        "pkg-mc1.21.3-v1.4.1" = _3iEWrjSi;
        "pkg-mc1.21-v1.4.1" = _PL7sB8RI;
        "pkg-mc1.21.6-v1.4.1" = _ztqpoECI;
        "pkg-mc1.21.5-v1.4.1" = _fkTiAbfG;
        "pkg-mc1.18.2-v1.4.1" = _x3AGX3E9;
        "pkg-mc1.16.5-v1.4.1" = _2QGWRFLs;
        "pkg-mc1.21.4-v1.4.1" = _BhzcldRB;
        "pkg-mc1.21.1-v1.4.1" = _wC6JPf2d;
        "pkg-mc1.20.6-v1.4.1" = _G9ipYH8s;
        "pkg-mc1.21-v1.4.2" = _MjrteTPO;
        "pkg-mc1.21.4-v1.4.2" = _67z8oUR9;
        "pkg-mc1.21.7-v1.4.2" = _sanzoBiA;
        "pkg-mc1.21.3-v1.4.2" = _pEaWGHNN;
        "pkg-mc1.21.6-v1.4.2" = _hgTO6mKw;
        "pkg-mc1.21.2-v1.4.2" = _ebHIewXd;
        "pkg-mc1.16.5-v1.4.2" = _8rBJZkyl;
        "pkg-mc1.21.1-v1.4.2" = _4YyogvnP;
        "pkg-mc1.21.5-v1.4.2" = _Lr6RWdVM;
        "pkg-mc1.20.6-v1.4.2" = _CfEMCS0J;
        "pkg-mc1.18.2-v1.4.2" = _nvFJ6Dh6;
        "pkg-mc1.17.1-v1.4.2" = _YWUTf3jx;
        "pkg-mc1.19.4-v1.4.2" = _TGdUvKvU;
        "pkg-mc1.21-v1.4.3" = _mAMShzdK;
        "pkg-mc1.21.2-v1.4.3" = _TsoDisMe;
        "pkg-mc1.21.7-v1.4.3" = _Wruob2I6;
        "pkg-mc1.21.1-v1.4.3" = _9Rp6t8Gs;
        "pkg-mc1.21.8-v1.4.3" = _KNkLFnJf;
        "pkg-mc1.20.6-v1.4.3" = _4v6Hifzf;
        "pkg-mc1.18.2-v1.4.3" = _hNJHVlCz;
        "pkg-mc1.21.6-v1.4.3" = _j1F4V6Pt;
        "pkg-mc1.16.5-v1.4.3" = _xIlb3aQE;
        "pkg-mc1.21.3-v1.4.3" = _grJEq7ZC;
        "pkg-mc1.21.5-v1.4.3" = _cX7rF7pw;
        "pkg-mc1.21.4-v1.4.3" = _4bXnno4b;
        "pkg-mc1.17.1-v1.4.3" = _Aw5xES4W;
        "pkg-mc1.19.4-v1.4.3" = _aRHJD580;
        "pkg-mc1.21.5-v1.5.0" = _lVDnakSg;
        "pkg-mc1.21.2-v1.5.0" = _aQfgPNZ8;
        "pkg-mc1.21.4-v1.5.0" = _IvZRPGYo;
        "pkg-mc1.21.8-v1.5.0" = _HR2G47xn;
        "pkg-mc1.19.4-v1.5.0" = _dtmtuCSZ;
        "pkg-mc1.20.6-v1.5.0" = _sxIbvS1s;
        "pkg-mc1.21.3-v1.5.0" = _EH8XfDzY;
        "pkg-mc1.21-v1.5.0" = _hVfrnrU0;
        "pkg-mc1.18.2-v1.5.0" = _evaz2unk;
        "pkg-mc1.21.1-v1.5.0" = _gOpWe9xV;
        "pkg-mc1.17.1-v1.5.0" = _czeIsVwD;
        "pkg-mc1.21.6-v1.5.0" = _3lirtl9V;
        "pkg-mc1.21.7-v1.5.0" = _ejaSHVWk;
        "pkg-mc1.16.5-v1.5.0" = _gmw0StF9;
        "pkg-mc1.21.1-v1.6.0" = _lrMBOzar;
        "pkg-mc1.21.3-v1.6.0" = _dR7vXeiE;
        "pkg-mc1.19.4-v1.6.0" = _9ZXmPWJj;
        "pkg-mc1.21.7-v1.6.0" = _976ufgTy;
        "pkg-mc1.18.2-v1.6.0" = _WD8K5g0W;
        "pkg-mc1.17.1-v1.6.0" = _p2DEHr2S;
        "pkg-mc1.21.6-v1.6.0" = _gsvU3lf8;
        "pkg-mc1.21.4-v1.6.0" = _CjmYzy05;
        "pkg-mc1.21.5-v1.6.0" = _qxLzjrol;
        "pkg-mc1.21.2-v1.6.0" = _dTfTWeno;
        "pkg-mc1.20.6-v1.6.0" = _N4ZKVfJm;
        "pkg-mc1.21-v1.6.0" = _4OQEAmm1;
        "pkg-mc1.21.8-v1.6.0" = _OTx1vKFU;
        "pkg-mc1.16.5-v1.6.0" = _uqaQltlV;
        "pkg-mc1.21.3-v1.6.1" = _yqpjfm1G;
        "pkg-mc1.17.1-v1.6.1" = _8zBdd1tY;
        "pkg-mc1.21.1-v1.6.1" = _Uqjr3yUo;
        "pkg-mc1.21.4-v1.6.1" = _6VaMfdfI;
        "pkg-mc1.21.7-v1.6.1" = _3Nzn7HZU;
        "pkg-mc1.21.8-v1.6.1" = _5OlsPtv5;
        "pkg-mc1.16.5-v1.6.1" = _SKtxhpjE;
        "pkg-mc1.18.2-v1.6.1" = _BWSIw5WT;
        "pkg-mc1.20.6-v1.6.1" = _Eq7alSuZ;
        "pkg-mc1.21.5-v1.6.1" = _pLSYEaLA;
        "pkg-mc1.19.4-v1.6.1" = _wkir6FHk;
        "pkg-mc1.21.6-v1.6.1" = _U9AZFboE;
        "pkg-mc1.21-v1.6.1" = _3yfHMEmO;
        "pkg-mc1.21.2-v1.6.1" = _zPveKMqV;
        "pkg-mc1.21.7-v1.6.2" = _ezwvssYV;
        "pkg-mc1.21.4-v1.6.2" = _pGSolZU4;
        "pkg-mc1.20.6-v1.6.2" = _XHxW2pHK;
        "pkg-mc1.19.4-v1.6.2" = _kOlH9HIy;
        "pkg-mc1.21.1-v1.6.2" = _oRC1ZhLx;
        "pkg-mc1.21.5-v1.6.2" = _TTQyltS6;
        "pkg-mc1.16.5-v1.6.2" = _If0tjEh8;
        "pkg-mc1.21.8-v1.6.2" = _TtF5PDuF;
        "pkg-mc1.17.1-v1.6.2" = _fHwDxN3f;
        "pkg-mc1.21.6-v1.6.2" = _3MphxPYf;
        "pkg-mc1.18.2-v1.6.2" = _wYqBwYVA;
        "pkg-mc1.21-v1.6.2" = _HmALfyOJ;
        "pkg-mc1.21.2-v1.6.2" = _Ns0M9FjQ;
        "pkg-mc1.21.3-v1.6.2" = _d5AZSu8v;
        "pkg-mc1.21.6-v1.6.3" = _xDqLXNZs;
        "pkg-mc1.17.1-v1.6.3" = _6a5NMTsf;
        "pkg-mc1.16.5-v1.6.3" = _zCKHFrGu;
        "pkg-mc1.21.1-v1.6.3" = _zsHC006l;
        "pkg-mc1.20.6-v1.6.3" = _8CCdXn9C;
        "pkg-mc1.21-v1.6.3" = _Ar0BOjMQ;
        "pkg-mc1.18.2-v1.6.3" = _QW2OAlI5;
        "pkg-mc1.21.5-v1.6.3" = _aoIqBrWv;
        "pkg-mc1.19.4-v1.6.3" = _NVwXnCzB;
        "pkg-mc1.21.3-v1.6.3" = _rdzdFwpj;
        "pkg-mc1.21.2-v1.6.3" = _8ZKDBQo0;
        "pkg-mc1.21.7-v1.6.3" = _9wnMrZmw;
        "pkg-mc1.21.4-v1.6.3" = _IEKyoJ5L;
        "pkg-mc1.21.8-v1.6.3" = _8FZb513p;
        "pkg-mc1.19.4-v1.6.4" = _vHqngJtj;
        "pkg-mc1.18.2-v1.6.4" = _VvZingwc;
        "pkg-mc1.21.5-v1.6.4" = _yPvqV8L8;
        "pkg-mc1.21.1-v1.6.4" = _gXaBdajW;
        "pkg-mc1.21.7-v1.6.4" = _2QOm2FDq;
        "pkg-mc1.20.6-v1.6.4" = _MLKmbZ30;
        "pkg-mc1.21.3-v1.6.4" = _7RG0ix6S;
        "pkg-mc1.21-v1.6.4" = _n4yeOWg1;
        "pkg-mc1.17.1-v1.6.4" = _KVazzhuO;
        "pkg-mc1.21.4-v1.6.4" = _dVxVnYoE;
        "pkg-mc1.21.9-v1.6.4" = _bdi2tN15;
        "pkg-mc1.16.5-v1.6.4" = _D7RD70U0;
        "pkg-mc1.21.8-v1.6.4" = _ahXqaNJv;
        "pkg-mc1.21.6-v1.6.4" = _ToBiijlL;
        "pkg-mc1.21.2-v1.6.4" = _XbjtDKD5;
        "pkg-mc1.21.8-v1.6.5" = _Kbp2AKW2;
        "pkg-mc1.21.1-v1.6.5" = _Qe0kjAh1;
        "pkg-mc1.21.6-v1.6.5" = _59jfEd9M;
        "pkg-mc1.16.5-v1.6.5" = _TyhhtBPM;
        "pkg-mc1.17.1-v1.6.5" = _Rj85v0i5;
        "pkg-mc1.19.4-v1.6.5" = _IqsxL8DM;
        "pkg-mc1.21.9-v1.6.5" = _zX30TU1o;
        "pkg-mc1.21.4-v1.6.5" = _1UmnDuIR;
        "pkg-mc1.20.6-v1.6.5" = _bnGY2Ptb;
        "pkg-mc1.21.7-v1.6.5" = _nEFzD5vf;
        "pkg-mc1.18.2-v1.6.5" = _pQE6iZpN;
        "pkg-mc1.21.5-v1.6.5" = _P9BWvncG;
        "pkg-mc1.21.3-v1.6.5" = _1UtPskjd;
        "pkg-mc1.21.2-v1.6.5" = _N5Skv19y;
        "pkg-mc1.21.10-v1.6.5" = _llMcazbL;
        "pkg-mc1.21-v1.6.5" = _oikxLHwJ;
        "pkg-mc1.21.4-v1.6.6" = _l4GkmhoI;
        "pkg-mc1.21.2-v1.6.6" = _VOB5yLjj;
        "pkg-mc1.21.6-v1.6.6" = _H5YDnMyH;
        "pkg-mc1.21.5-v1.6.6" = _b4xuMNdG;
        "pkg-mc1.21.8-v1.6.6" = _G0gAFTNX;
        "pkg-mc1.21.3-v1.6.6" = _bkTjN2nF;
        "pkg-mc1.17.1-v1.6.6" = _mZOOzKeZ;
        "pkg-mc1.21.7-v1.6.6" = _cn63fiUC;
        "pkg-mc1.21.11-v1.6.6" = _PC2uERy4;
        "pkg-mc1.21.10-v1.6.6" = _XukeluOh;
        "pkg-mc1.21.1-v1.6.6" = _WjEKSXRF;
        "pkg-mc1.20.6-v1.6.6" = _oe1nyg7W;
        "pkg-mc1.19.4-v1.6.6" = _BVQG1ffP;
        "pkg-mc1.21.9-v1.6.6" = _n4o0sXDR;
        "pkg-mc1.16.5-v1.6.6" = _BNn6PWZe;
        "pkg-mc1.18.2-v1.6.6" = _ZJCsQZ5p;
        "pkg-mc1.21-v1.6.6" = _W79SSY95;
        "pkg-mc1.21.2-v1.6.7" = _m44wvQcb;
        "pkg-mc1.18.2-v1.6.7" = _WsRMTDZC;
        "pkg-mc1.21.5-v1.6.7" = _caBRw5HQ;
        "pkg-mc1.17.1-v1.6.7" = _BqQgCl6U;
        "pkg-mc1.21.9-v1.6.7" = _tAay2bTI;
        "pkg-mc1.20.6-v1.6.7" = _sENwi70P;
        "pkg-mc1.21.11-v1.6.7" = _QcbFKs4c;
        "pkg-mc1.21.1-v1.6.7" = _qL0ApYJ0;
        "pkg-mc1.21.8-v1.6.7" = _LK8loxFz;
        "pkg-mc1.21.4-v1.6.7" = _e0ZFc9fW;
        "pkg-mc1.16.5-v1.6.7" = _wctBKhBr;
        "pkg-mc1.21.7-v1.6.7" = _A5uHpbzS;
        "pkg-mc1.21-v1.6.7" = _yTVM9OUN;
        "pkg-mc1.21.3-v1.6.7" = _2lu5egVN;
        "pkg-mc1.21.10-v1.6.7" = _4Oe8wPUJ;
        "pkg-mc1.21.6-v1.6.7" = _33IQR2sn;
        "pkg-mc1.19.4-v1.6.7" = _oNkeR46y;
        "pkg-mc1.21.2-v1.6.8-beta.1" = _46NH5B7z;
        "pkg-mc1.21.6-v1.6.8-beta.1" = _8bYnxToE;
        "pkg-mc1.18.2-v1.6.8-beta.1" = _gkZIJ8q6;
        "pkg-mc1.21.7-v1.6.8-beta.1" = _cZeNGt5n;
        "pkg-mc1.21.9-v1.6.8-beta.1" = _oCD7PpWR;
        "pkg-mc1.21-v1.6.8-beta.1" = _ULXlVRtf;
        "pkg-mc1.21.1-v1.6.8-beta.1" = _DqHgDJLa;
        "pkg-mc1.21.4-v1.6.8-beta.1" = _V7Ii9SbK;
        "pkg-mc1.21.3-v1.6.8-beta.1" = _SboGGnXC;
        "pkg-mc1.19.4-v1.6.8-beta.1" = _TWHCW0xd;
        "pkg-mc1.20.6-v1.6.8-beta.1" = _bFu81Y9K;
        "pkg-mc1.21.11-v1.6.8-beta.1" = _WyICroSi;
        "pkg-mc1.21.8-v1.6.8-beta.1" = _68ReEhxx;
        "pkg-mc1.17.1-v1.6.8-beta.1" = _XVVas9lU;
        "pkg-mc1.21.10-v1.6.8-beta.1" = _PJkHp2CD;
        "pkg-mc1.21.5-v1.6.8-beta.1" = _iJrlCvyx;
        "pkg-mc1.16.5-v1.6.8-beta.1" = _D2tgMtN0;
        "pkg-mc1.21.6-v1.6.9" = _89Z13iM9;
        "pkg-mc1.20.6-v1.6.9" = _V3g09svP;
        "pkg-mc1.21.7-v1.6.9" = _kNsJIq6x;
        "pkg-mc1.19.4-v1.6.9" = _rW7oofOv;
        "pkg-mc1.21.3-v1.6.9" = _HyUdpZtG;
        "pkg-mc1.21-v1.6.9" = _Q6UZ2UbR;
        "pkg-mc1.21.5-v1.6.9" = _rTRzHw21;
        "pkg-mc1.21.1-v1.6.9" = _xhyIg5UY;
        "pkg-mc1.21.2-v1.6.9" = _C5XfqICZ;
        "pkg-mc1.21.8-v1.6.9" = _rlr74IbW;
        "pkg-mc1.21.4-v1.6.9" = _3wZKKGia;
        "pkg-mc1.16.5-v1.6.9" = _m7LsodGN;
        "pkg-mc1.21.9-v1.6.9" = _YwucdSzV;
        "pkg-mc1.21.11-v1.6.9" = _tjQsFGPi;
        "pkg-mc1.17.1-v1.6.9" = _zoy78kp4;
        "pkg-mc1.21.10-v1.6.9" = _UWRudZ3A;
        "pkg-mc1.18.2-v1.6.9" = _JOsOJw4H;
        "pkg-mc26.1-v1.6.9" = _OGeTfaCl;
        "pkg-mc26.1-v1.6.10" = _rRClV2xZ;
        "pkg-mc26.1.1-v1.6.10" = _mmxOWQTJ;
        "pkg-mc26.1.2-v1.6.11" = _GUfl95P1;
        "pkg-mc26.1-v1.6.11" = _Meey6C8v;
        "pkg-mc26.1.1-v1.6.11" = _oJsZ5nFl;
        "pkg-mc26.1.2-v1.6.12" = _JrrD8gj0;
        "pkg-mc26.2-v1.6.12" = _5XXbbGl6;
        "pkg-mc1.21-v1.6.10" = _eiE96grn;
        "pkg-mc1.21.4-v1.6.10" = _eu6Wqhvj;
        "pkg-mc1.17.1-v1.6.10" = _vJC791L8;
        "pkg-mc1.21.6-v1.6.10" = _3CySn348;
        "pkg-mc1.21.8-v1.6.10" = _6U2rLxm9;
        "pkg-mc1.21.3-v1.6.10" = _s4bVP6Tk;
        "pkg-mc1.21.2-v1.6.10" = _V12E0jIB;
        "pkg-mc1.16.5-v1.6.10" = _BxbvIwpP;
        "pkg-mc1.21.7-v1.6.10" = _5kIM0jN6;
        "pkg-mc1.21.9-v1.6.10" = _aaMWmX27;
        "pkg-mc1.19.4-v1.6.10" = _W2CPWLRd;
        "pkg-mc1.21.10-v1.6.10" = _7YrelUJv;
        "pkg-mc1.18.2-v1.6.10" = _4lINgT8F;
        "pkg-mc1.21.5-v1.6.10" = _YOMcujON;
        "pkg-mc1.20.6-v1.6.10" = _oC6PP9DO;
        "pkg-mc1.21.11-v1.6.10" = _U3CzGF3y;
