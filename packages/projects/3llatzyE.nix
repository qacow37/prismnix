...
let
    ...
    in {
        ...
        "pkg-2.4+1.19" = _xIdIGGpW;
        "pkg-3.0+1.19" = _5jRx2Ths;
        "pkg-3.0+1.18" = _HYmz6e95;
        "pkg-3.0+1.17" = _9BDz8I5B;
        "pkg-3.1+1.17" = _LFrtakTH;
        "pkg-3.1+1.18" = _rufhra7K;
        "pkg-3.1+1.19" = _OsxxyMeb;
        "pkg-3.1+1.19.3" = _ZsFXkXdp;
        "pkg-3.2+1.17" = _xO9LjPNo;
        "pkg-3.2+1.18" = _3VEiOUIS;
        "pkg-3.2+1.19.3" = _8AtaUYLA;
        "pkg-3.2+1.19.4" = _kmoieWOA;
        "pkg-3.2+1.19" = _fvEboyZN;
        "pkg-3.2.1+1.20.1" = _5ybtVRWR;
        "pkg-3.2.1+1.20.2" = _WhDsYPme;
        "pkg-3.2.1+1.20.4" = _xeDghx1o;
        "pkg-3.2.1+1.21" = _ouKKEivc;
        "pkg-3.5.0-sakura.7+1.21" = _oAE9Jtok;
        "pkg-3.5.0-sakura.5+1.21.2" = _rm0IVgfi;
        "pkg-3.5.0-sakura.6+1.21.3" = _4iHKDmLW;
        "pkg-3.2.1-sakura.1+1.21.4" = _nTnkbjAv;
        "pkg-3.2.1-sakura.2+1.21.4" = _LEkczcJV;
        "pkg-3.2.1-sakura.5+1.21.5" = _f9I6PpBA;
        "pkg-3.2.1-sakura.6+1.21.6" = _TPVl7PJb;
        "pkg-3.2.1-sakura.7+1.21.7" = _CsIjzol2;
        "pkg-3.2.1-sakura.8+1.21.8" = _GioyXd7X;
        "pkg-3.2.1+1.21.10-rc1" = _6gGYwSaw;
