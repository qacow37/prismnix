...
let
    ...
    in {
        ...
        "pkg-1.1.2" = _othKAsCK;
        "pkg-3.0.3" = _zQ4A2BRR;
        "pkg-16.6.4" = _tONKXKCl;
        "pkg-17.1.12" = _euZdWfop;
        "pkg-18.5.12" = _MAJnlxLD;
        "pkg-19.5.10" = _gSeRenBp;
        "pkg-18.5.13" = _dwgH0xp2;
        "pkg-20.5.13" = _3u8NjL6k;
        "pkg-19.5.13" = _ej5UIwc0;
        "pkg-18.5.14" = _1Z0gh5qt;
        "pkg-19.5.14" = _kFlGP3NI;
        "pkg-20.5.14" = _uQU626EK;
        "pkg-20.5.15" = _I1MiACm0;
        "pkg-18.5.15" = _a10qgf9g;
        "pkg-18.5.16" = _PBWzMvFF;
        "pkg-19.5.16" = _9ohlNMKG;
        "pkg-20.5.16" = _7P1rMtma;
        "pkg-18.5.17" = _4M5dziNe;
        "pkg-19.5.17" = _dNokQKWA;
        "pkg-20.5.17" = _nO0Zk6bf;
        "pkg-16.6.5" = _qbWaFntW;
        "pkg-18.5.18" = _jZonAzh3;
        "pkg-19.5.18" = _oqLLWnTD;
        "pkg-20.6.1" = _i2G9kC3R;
        "pkg-19.5.18.3" = _9QPKqTTF;
        "pkg-18.5.19" = _x0wAlAIu;
        "pkg-19.5.19" = _a8tlusMb;
        "pkg-20.6.2" = _yiL3JWb0;
        "pkg-20.6.3" = _kNjLHhUY;
        "pkg-18.5.20" = _adn8WU3k;
        "pkg-19.5.20" = _nxKXUw7R;
        "pkg-20.6.4" = _DW5Ecpfa;
        "pkg-18.5.21" = _uTpDPDEQ;
        "pkg-19.5.21" = _JiDYnN2l;
        "pkg-20.6.5" = _JjdJjLFY;
        "pkg-18.5.22" = _Q66jzdFe;
        "pkg-19.5.22" = _TVhZorSa;
        "pkg-20.7.1" = _4pG47JSa;
        "pkg-18.5.23" = _1KiweUHG;
        "pkg-19.5.23" = _hCil0sZy;
        "pkg-20.7.2" = _NK4aPoA6;
        "pkg-18.5.24" = _Bz8QPRL9;
        "pkg-19.5.24" = _EN2eUjrF;
        "pkg-20.7.3" = _zNBOOjiI;
        "pkg-20.7.4" = _SrlzdvpH;
        "pkg-19.5.25" = _lO1h844u;
        "pkg-18.5.26" = _6SuH0tnY;
        "pkg-19.5.26" = _UICaPHaU;
        "pkg-20.8.2" = _Iazjlq5B;
        "pkg-20.8.3" = _1MxObV6F;
        "pkg-20.8.4" = _E0kwSDG2;
        "pkg-20.8.5" = _fQQ6QDdO;
        "pkg-20.8.6" = _wQLidOqf;
        "pkg-20.8.7" = _Kr6Ugovl;
        "pkg-20.8.8" = _V47oGyUo;
        "pkg-20.8.9" = _23qnIFNm;
        "pkg-20.8.10" = _16VSPlim;
        "pkg-20.9.1" = _ds9l4xnI;
        "pkg-20.9.2" = _s1YVcS5i;
        "pkg-20.9.3" = _tiShHpKh;
        "pkg-20.9.4" = _19EQ5ShQ;
        "pkg-20.9.5" = _BpxwA4GD;
        "pkg-20.9.6" = _5RBRsoVd;
        "pkg-20.9.7" = _s6BQ9MWw;
        "pkg-20.10.2.101" = _hgSze1ml;
        "pkg-20.10.3" = _BY9Vvfmm;
        "pkg-20.10.5" = _MqywKwnT;
        "pkg-20.10.6" = _ycy4mPXt;
        "pkg-20.10.7" = _7cpK4rBV;
        "pkg-20.11.2" = _5pInHYN2;
        "pkg-20.11.3" = _XdHxr4OA;
        "pkg-20.11.4" = _WcBlQRiv;
        "pkg-20.11.5" = _ED8VLAun;
        "pkg-20.11.6" = _aI3PRrsq;
        "pkg-20.11.7" = _mmI2ae4L;
        "pkg-21.11.0.5" = _fN7u5Kq4;
        "pkg-20.11.8" = _lcgx2zSg;
        "pkg-20.11.9" = _8IY2NC07;
        "pkg-20.11.10" = _eDaSfUGH;
        "pkg-21.11.1" = _MD7Ss78Q;
        "pkg-20.11.11" = _CC0cMgOM;
        "pkg-21.11.2" = _oYANqFkk;
        "pkg-20.12.1" = _QbKDGNUU;
        "pkg-20.12.2" = _FqiQTf1A;
        "pkg-20.12.3" = _HsN5iPub;
        "pkg-20.12.4" = _yrYM8EhR;
        "pkg-21.12.1" = _AMdbNVsB;
        "pkg-20.12.5" = _8fBU4NVv;
        "pkg-20.12.6" = _cEWUyWlW;
        "pkg-21.12.2" = _vtmYCyrO;
        "pkg-20.12.7" = _q5PbB8Cn;
        "pkg-20.12.8" = _XKycRvwR;
        "pkg-21.12.3" = _sB4L34lb;
        "pkg-20.12.9" = _oIlhG6te;
        "pkg-21.12.4" = _HmF7BvsP;
        "pkg-20.12.10" = _n62sPWmt;
        "pkg-20.12.11" = _tj5WB0Ov;
        "pkg-20.12.12" = _5N6NqI0x;
        "pkg-21.12.5" = _1fgBiRTS;
        "pkg-20.13.1" = _cUzQY8vF;
        "pkg-21.13.1" = _qQYukUae;
        "pkg-20.13.2" = _vExCmUee;
        "pkg-21.13.3.2" = _Tg9DqrR6;
        "pkg-20.13.3-1.20.1" = _RYB4KjyU;
        "pkg-21.13.3-1.21.1" = _xamRT7Le;
        "pkg-20.13.4-1.20.1" = _JQvaqhP6;
        "pkg-21.13.4-1.21.1" = _66t0v2wT;
        "pkg-20.13.5-1.20.1" = _u7xQUdgE;
        "pkg-20.13.6-1.20.1" = _GaRQuxc8;
        "pkg-21.13.5-1.21.1" = _gqKqN6Io;
        "pkg-20.14.1-1.20.1" = _24EPZaNl;
        "pkg-21.14.1-mc1.21.1-neoforge" = _x070gTVk;
        "pkg-20.14.2-1.20.1" = _2MuRFLxd;
        "pkg-21.14.2-mc1.21.1-neoforge" = _lOuUkzLd;
        "pkg-21.14.3-mc1.21.1-neoforge" = _dpTnEIa6;
        "pkg-20.14.3-1.20.1" = _XwO3FQRf;
        "pkg-20.14.4-1.20.1" = _21HBbRFH;
        "pkg-21.14.4-mc1.21.1-neoforge" = _b0CMn91B;
        "pkg-20.14.5-mc1.20.1-forge" = _OaigzNK5;
        "pkg-20.14.6-mc1.20.1-forge" = _FTWMBNEt;
        "pkg-21.15.1-mc1.21.1-neoforge" = _L6lE458l;
        "pkg-21.15.2-mc1.21.1-neoforge" = _hE8G9skG;
        "pkg-20.14.7-mc1.20.1-forge" = _NVzuueXh;
        "pkg-21.15.3-mc1.21.1-neoforge" = _hUyqBnin;
        "pkg-20.14.8-mc1.20.1-forge" = _SwzWokMe;
        "pkg-21.15.4-mc1.21.1-neoforge" = _YgV0s8VX;
        "pkg-20.14.9-mc1.20.1-forge" = _KUXXidQ5;
        "pkg-21.15.5-mc1.21.1-neoforge" = _YKMNQW93;
        "pkg-20.14.10-mc1.20.1-forge" = _bggM5Lmk;
        "pkg-21.15.6-mc1.21.1-neoforge" = _71Ed7Y1v;
        "pkg-20.14.11-mc1.20.1-forge" = _S9OrTsOq;
        "pkg-21.15.7-mc1.21.1-neoforge" = _lLbngDD1;
        "pkg-20.14.12-mc1.20.1-forge" = _HzcIv8gr;
        "pkg-21.15.8-mc1.21.1-neoforge" = _w4FWTyEV;
        "pkg-20.14.13-mc1.20.1-forge" = _EF378K6m;
        "pkg-21.16.1-mc1.21.1-neoforge" = _VTCxCmbq;
        "pkg-20.14.14-mc1.20.1-forge" = _hGQ1VAGE;
        "pkg-21.16.2-mc1.21.1-neoforge" = _VeYx7VVf;
        "pkg-20.14.15-mc1.20.1-forge" = _7QrAOXDC;
        "pkg-20.14.15.1-mc1.20.1-forge" = _YhrZ5MMD;
        "pkg-20.14.16-mc1.20.1-forge" = _GuQTTfMa;
        "pkg-21.16.3-mc1.21.1-neoforge" = _qbin25em;
        "pkg-21.16.4-mc1.21.1-neoforge" = _dSV7xWi5;
        "pkg-20.14.17-mc1.20.1-forge" = _KEBfkBat;
        "pkg-21.17.1-mc1.21.1-neoforge" = _BWo6bwu3;
        "pkg-21.17.2-mc1.21.1-neoforge" = _NQynI1o8;
        "pkg-21.17.3-mc1.21.1-neoforge" = _VK0u97Q8;
        "pkg-21.17.3.1-mc1.21.1-neoforge" = _8HHhJt6i;
        "default" = _8HHhJt6i;
    });
