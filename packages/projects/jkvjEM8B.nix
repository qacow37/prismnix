...
let
    ...
    in {
        ...
        "pkg-1.3.2" = _RfVQUMF5;
        "pkg-1.4.1" = _ObUOxO7W;
        "pkg-1.5.0.1" = _mQN6ZCUE;
        "pkg-1.5.0" = _fzUDZlHc;
        "pkg-1.6.0.2" = _VDPZEg96;
        "pkg-1.6.0.2.1" = _gOwrxtrA;
        "pkg-1.5.1" = _13u6YaEr;
        "pkg-1.6.0.2.2" = _4q8ri1BE;
        "pkg-1.5.2" = _za4X4pmP;
        "pkg-1.5.3" = _ssLNZJyQ;
        "pkg-1.5.4" = _9QkNO1AP;
        "pkg-1.5.5" = _4DvAINyv;
        ...
        "pkg-1.9.8" = _nuztKdk3;
        "pkg-1.9.9" = _gBY8ZLnI;
        "pkg-1.10.0" = _7qOAqMpD;
        "pkg-1.10.1" = _HUfz3TZX;
        "pkg-1.10.2" = _4AoNolGX;
        "default" = _4AoNolGX;
    });
