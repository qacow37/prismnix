...
let
    ...
    in {
        ...
        "pkg-1.18-0-forge" = _AOVxyah6;
        "pkg-1.18.1-0-forge" = _L1aXtHvW;
        "pkg-1.18.2-0-forge" = _uhvLnmps;
        "pkg-1.19-0-forge" = _OX4Yi8YM;
        "pkg-1.19.1-0-forge" = _rNb4i6QU;
        "pkg-1.19.2-0-forge" = _5z9YeNrq;
        "pkg-1.19.3-0-forge" = _r8vKmFoT;
        "pkg-1.19.4-0-forge" = _yzXDLZ8c;
        "pkg-1.20-0-forge" = _IhyU3f9W;
        "pkg-1.20.1-0-forge" = _7FncoDUq;
        "pkg-1.20.2-0-forge" = _s4cvKD3m;
        "pkg-1.18.1-0-fabric" = _rwLLYJ3S;
        "pkg-1.18.2-0-fabric" = _v8Fkr6Py;
        "pkg-1.19-0-fabric" = _8KCpJKMt;
        "pkg-1.19.1-0-fabric" = _hzsJAawq;
        "pkg-1.19.2-0-fabric" = _L8LC06yh;
        "pkg-1.19.4-0-fabric" = _dDr9VYFz;
        "pkg-1.20-0-fabric" = _MvKNrova;
        "pkg-1.20.1-0-fabric" = _OPPhcEmJ;
        "pkg-1.20.2-0-fabric" = _jLVvI4P2;
        "pkg-1.20.3-0-fabric" = _8MDfidIC;
        "pkg-1.20.4-0-fabric" = _bSvYC1T8;
        "pkg-1.18-1-forge" = _EWKicf1u;
        "pkg-1.18.1-1-forge" = _BMZ74zno;
        "pkg-1.18.2-1-forge" = _x9C7mo1U;
        "pkg-1.19-1-forge" = _20HFFAm6;
        "pkg-1.19.1-1-forge" = _JDdfgMs8;
        "pkg-1.20.1-1-forge" = _G7u7fZPU;
        "default" = _s4cvKD3m;
    });
