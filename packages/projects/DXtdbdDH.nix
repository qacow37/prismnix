...
let
    ...
    in {
        ...
        "pkg-20.12" = _u9XrHa51;
        "pkg-20.13" = _QGvkVeb5;
        "pkg-21.0.0" = _fHJtoels;
        "pkg-21.1.0" = _7Q1BvBm5;
        "pkg-21.1.1" = _B63lj3sI;
        "pkg-21.3.0" = _FFXTHmv6;
        "pkg-21.4.0" = _BkwEpwmd;
        "pkg-21.5.0" = _F757fRjN;
        "pkg-21.6.0" = _RTCnmjT1;
        "pkg-21.7.0" = _KLphAmS0;
        "pkg-21.10.0" = _gM6Me3cN;
        "pkg-21.10.1" = _b1pIHdhb;
        "pkg-21.11.1" = _JEDswogv;
