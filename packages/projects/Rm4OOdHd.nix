...
let
    ...
    in {
        ...
        "pkg-1.20.5-1.0-fabric+neo" = _pMooka4Z;
        "pkg-1.20.6-1.0-fabric+forge+neo" = _p8AtgTpj;
        "pkg-1.19.2-1.1-fabric+forge" = _LhvBWCBa;
        "pkg-1.20.1-1.1-fabric+forge+neo" = _fn6OOYfu;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _qS9o9Hlx;
        "pkg-1.20.6-1.1-fabric+forge+neo" = _HyGIGqFG;
        "pkg-1.21.0-1.1-fabric+forge+neo" = _bBDMZS25;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _hJuIowdr;
        "pkg-1.20.6-1.2-fabric+forge+neo" = _UoDOyflW;
        "pkg-1.21.0-1.2-fabric+forge+neo" = _xVid0Ilh;
        "pkg-1.21.1-1.2-fabric+forge+neo" = _TlSbvWkK;
        "pkg-1.21.2-1.2-fabric+neo" = _p9hxFk4L;
        "pkg-1.21.3-1.2-fabric+forge+neo" = _txBW5JeU;
        "pkg-1.21.4-1.2-fabric+forge+neo" = _TEscz3rE;
        "pkg-1.21.5-1.2-fabric+forge+neo" = _1JjwikaD;
        "pkg-1.21.6-1.2-fabric+forge+neo" = _RAkMP1l6;
        "pkg-1.21.7-1.2-fabric+forge+neo" = _7HVv3Qc9;
        "pkg-1.21.8-1.2-fabric+forge+neo" = _XC9eRmjC;
        "pkg-1.21.9-1.2-fabric+forge+neo" = _f4FQf3aK;
        "pkg-1.21.10-1.2-fabric+forge+neo" = _bz79uRN5;
        "pkg-1.21.11-1.2-fabric+forge+neo" = _4M7B1SyU;
        "pkg-26.1.0-1.2-fabric+forge+neo" = _S3jtBdhw;
