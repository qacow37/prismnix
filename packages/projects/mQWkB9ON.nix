...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.4-fabric" = _j2ygmTZn;
        "pkg-1.18.2-2.4-fabric" = _goiT00Ue;
        "pkg-1.19.2-2.6-fabric" = _JqLnWiOK;
        "pkg-1.16.5-2.0-forge" = _5QfMV881;
        "pkg-1.18.2-2.1-forge" = _4RC9QtHJ;
        "pkg-1.19.2-2.3-forge" = _G7fQCTEu;
        "pkg-1.16.5-2.5-fabric" = _hb2k0BGv;
        "pkg-1.18.2-2.5-fabric" = _CCSs1qWh;
        "pkg-1.19.2-2.5-fabric" = _ITDY15SX;
        "pkg-1.16.5-2.7-fabric" = _7gEicQu1;
        "pkg-1.18.2-2.7-fabric" = _kdnc1lQb;
        "pkg-1.19.2-2.7-fabric" = _NxFVCM9n;
        "pkg-1.16.5-2.7-forge" = _fFcw1G4p;
        "pkg-1.18.2-2.7-forge" = _zAjmtcYe;
        "pkg-1.19.2-2.7-forge" = _k9neuIIy;
        "pkg-1.16.5-3.0-fabric" = _82vmLvzl;
        "pkg-1.18.2-3.0-fabric" = _JI4jVJuA;
        "pkg-1.19.2-3.0-fabric" = _RgK8JsBf;
        "pkg-1.16.5-3.0-forge" = _eHbhJ9Fj;
        "pkg-1.18.2-3.0-forge" = _Hl2isIJu;
        "pkg-1.19.2-3.0-forge" = _bDH9FVLQ;
        "pkg-1.16.5-3.1-fabric" = _PmHWtCW7;
        "pkg-1.18.2-3.1-fabric" = _im6SnzaL;
        "pkg-1.19.2-3.1-fabric" = _aVWRlojC;
        "pkg-1.16.5-3.2-fabric" = _YVRFiuhz;
        "pkg-1.18.2-3.2-fabric" = _2aDKgnbO;
        "pkg-1.19.2-3.2-fabric" = _LvYWrbrG;
        "pkg-1.16.5-3.2-forge" = _dwjOn0So;
        "pkg-1.18.2-3.2-forge" = _my3GmCgZ;
        "pkg-1.19.2-3.2-forge" = _e2xKytHE;
        "pkg-1.19.3-3.3-fabric" = _2S28pp4b;
        "pkg-1.19.3-3.2-forge" = _qZnZndOb;
        "pkg-1.18.2-4.0-forge+fabric" = _VGRc447U;
        "pkg-1.19.2-4.0-forge+fabric" = _VNRWv819;
        "pkg-1.19.3-4.0-forge+fabric" = _GYmS7YaK;
        "pkg-1.19.4-4.0-forge+fabric" = _2VQobd4Z;
        "pkg-1.20-4.0-forge+fabric" = _wgXalt3s;
        "pkg-1.20.1-4.0-forge+fabric" = _37gXvRIW;
        "pkg-1.20.2-4.0-forge+fabric" = _MjZfVW1I;
        "pkg-1.18.2-4.1-forge+fabric" = _zMCHDEgL;
        "pkg-1.19.2-4.1-forge+fabric" = _btIdI4tH;
        "pkg-1.20.1-4.1-forge+fabric" = _uANk4nhZ;
        "pkg-1.20.2-4.1-forge+fabric" = _1ATTZrXW;
        "pkg-1.20.3-4.1-fabric+forge+neo" = _l9srzQAp;
        "pkg-1.20.4-4.1-fabric+forge+neo" = _FekCG20e;
        "pkg-1.19.2-4.2-fabric+forge+neo" = _sgkW3jaH;
        "pkg-1.20.1-4.2-fabric+forge+neo" = _PsJVmVzf;
        "pkg-1.20.2-4.2-fabric+forge+neo" = _IHdwcPL2;
        "pkg-1.20.4-4.2-fabric+forge+neo" = _HGSYHrgz;
        "pkg-1.20.5-4.2-fabric+neo" = _2V5hg9Gl;
        "pkg-1.20.5-4.3-fabric+neo" = _NB17oMUW;
        "pkg-1.20.6-4.3-fabric+forge+neo" = _Ytd2dr0x;
        "pkg-1.19.2-4.4-fabric+forge" = _MDA9IAE3;
        "pkg-1.20.1-4.4-fabric+forge+neo" = _u73gygFL;
        "pkg-1.20.4-4.4-fabric+forge+neo" = _UmnHIRwT;
        "pkg-1.20.6-4.4-fabric+forge+neo" = _3ZR7tMmn;
        "pkg-1.21.0-4.4-fabric+forge+neo" = _xn9KY6LE;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _O5D7DMz0;
        "pkg-1.20.6-4.5-fabric+forge+neo" = _PRyHAdFu;
        "pkg-1.21.0-4.5-fabric+forge+neo" = _JF4BsgNL;
        "pkg-1.21.1-4.5-fabric+forge+neo" = _XkihrYZR;
        "pkg-1.21.2-4.5-fabric+neo" = _DHV2tpa8;
        "pkg-1.21.3-4.5-fabric+forge+neo" = _3LTwZlPE;
        "pkg-1.21.4-4.5-fabric+forge+neo" = _xmyGODRG;
        "pkg-1.20.1-4.6-fabric+forge+neo" = _f6ofQRO7;
        "pkg-1.21.1-4.6-fabric+forge+neo" = _pZvybeGD;
        "pkg-1.21.4-4.6-fabric+forge+neo" = _7db6oUmE;
        "pkg-1.21.5-4.6-fabric+forge+neo" = _QElaScar;
        "pkg-1.20.1-4.7-fabric+forge+neo" = _48t8duHT;
        "pkg-1.21.1-4.7-fabric+forge+neo" = _7u0qP3e1;
        "pkg-1.21.4-4.7-fabric+forge+neo" = _zHv63BmF;
        "pkg-1.21.5-4.7-fabric+forge+neo" = _XCHC1MXs;
        "pkg-1.21.6-4.7-fabric+forge+neo" = _7ePmv1dB;
        "pkg-1.21.6-4.8-fabric+forge+neo" = _VikZFBSS;
        "pkg-1.20.1-4.9-fabric+forge+neo" = _3w2JG23r;
        "pkg-1.21.1-4.9-fabric+forge+neo" = _5RkgQCwL;
        "pkg-1.21.5-4.9-fabric+forge+neo" = _mIEmwsLA;
        "pkg-1.21.6-4.9-fabric+forge+neo" = _VyZlxnda;
        "pkg-1.21.7-4.9-fabric+forge+neo" = _fCMuLr1o;
        "pkg-1.21.8-4.9-fabric+forge+neo" = _rOD8gQJ5;
        "pkg-1.21.9-4.9-fabric+forge+neo" = _FoHegFTp;
        "pkg-1.21.9-5.0-fabric+forge+neo" = _lc9ctF0h;
        "pkg-1.21.10-5.0-fabric+forge+neo" = _AkyyQNbG;
        "pkg-1.21.11-5.0-fabric+forge+neo" = _56HQnvhL;
        "pkg-26.1.0-5.0-fabric+forge+neo" = _6XLVmdak;
        "pkg-26.1.1-5.0-fabric+forge+neo" = _9ww92lQS;
        "pkg-26.1.2-5.0-fabric+forge+neo" = _6q9Ge9SN;
        "pkg-26.2.0-5.0-fabric+forge+neo" = _QW8JdaV8;
        "default" = _QW8JdaV8;
    });
