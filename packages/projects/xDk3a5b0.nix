...
let
    ...
    in {
        ...
        "pkg-1.0.0-fabric-1.20.1-0.92.6" = _3vftpY9z;
        "pkg-1.0.0-forge-1.20.1-47.4.10" = _ofdm7C0F;
        "pkg-1.0.0-fabric-1.21.1-0.116.7" = _ulaWEPgM;
        "pkg-1.0.0-forge-1.21.1-52.1.8" = _u6VBy0nZ;
        "pkg-1.0.0-neoforge-1.21.1-21.1.216" = _Se23O0hL;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _jorsMLja;
        "pkg-1.0.0-forge-1.21.4-54.1.11" = _lTZms6Rz;
        "pkg-1.0.0-neoforge-1.21.4-21.4.156" = _j7poE21m;
        "pkg-1.0.0-neoforge-1.21.8-21.8.52" = _IMfMaQl8;
        "pkg-1.0.0-forge-1.21.8-58.1.11" = _98VHpRPq;
        "pkg-1.0.0-fabric-1.21.8-0.136.1" = _IrCeGSAP;
        "pkg-1.0.0-fabric-1.21.10-0.138.3" = _kra1GNOO;
        "pkg-1.0.0-forge-1.21.10-60.1.0" = _Fp3NP1n2;
        "pkg-1.0.0-neoforge-1.21.10-21.10.64" = _pPL1myOM;
        "pkg-1.0.0-neoforge-1.21.11-21.11.6-b" = _oPrNgoho;
        "pkg-1.0.0-forge-1.21.11-61.0.2" = _bqLb2CRk;
        "pkg-1.0.0-fabric-1.21.11-0.139.5" = _k3RNyk6H;
        "pkg-1.0.0-forge-26.1.1-63.0.0" = _eUCKa538;
        "pkg-1.0.0-neoforge-26.1.1.1" = _DloHJjxj;
        "pkg-1.0.0-fabric-26.1.1-0.145.3" = _5VMiDxBx;
        "pkg-1.0.0-forge-26.2-65.0.0" = _EBLMyuHG;
        "pkg-1.0.0-neoforge-26.2.0.3" = _VvrWLJ6Z;
        "pkg-1.0.0-fabric-26.2-0.152.2" = _TXBe1qaQ;
        "default" = _TXBe1qaQ;
    });
