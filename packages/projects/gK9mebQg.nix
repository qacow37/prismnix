...
let
    ...
    in {
        ...
        "pkg-v5.0.0-1.19.3-Forge" = _Y2bJJseT;
        "pkg-v6.0.0-1.19.4-Forge" = _ky9czhBW;
        "pkg-v6.0.0-1.19.4-Fabric" = _AdG0C8N3;
        "pkg-v7.0.0-1.20-Forge" = _ARY271Q8;
        "pkg-v7.0.0-1.20-Fabric" = _kvPU6GQr;
        "pkg-v8.0.0-1.20.1-Forge" = _tuok8y4p;
        "pkg-v8.0.0-1.20.1-Fabric" = _m1OeQHdG;
        "pkg-v3.2.0-1.18.2-Forge" = _67E6jRHd;
        "pkg-v3.2.0-1.18.2-Fabric" = _R89YtSeV;
        "pkg-v20.4.0-1.20.4-Fabric" = _talaiYTX;
        "pkg-v20.4.0-1.20.4-Forge" = _W8b1AwSt;
        "pkg-v20.4.0-1.20.4-NeoForge" = _lMfQxWKq;
        "pkg-v20.4.1-1.20.4-Fabric" = _RCmSFlU7;
        "pkg-v20.4.1-1.20.4-Forge" = _VPS6byeH;
        "pkg-v20.4.1-1.20.4-NeoForge" = _U6QaV0Gd;
        "pkg-v21.1.0-1.21.1-Fabric" = _eb2WbLFo;
        "pkg-v21.1.0-1.21.1-NeoForge" = _PgUG9sm3;
        "pkg-v21.1.1-1.21.1-Fabric" = _Xmqwhg0s;
        "pkg-v21.1.1-1.21.1-NeoForge" = _ANIn22X0;
        "pkg-v21.1.2-1.21.1-Fabric" = _ZYixTvyE;
        "pkg-v21.1.2-1.21.1-NeoForge" = _27kYf7JI;
        "pkg-v21.3.0-1.21.3-Fabric" = _xVKhrSW6;
        "pkg-v21.3.0-1.21.3-NeoForge" = _LgLbLLui;
        "pkg-v21.4.0-1.21.4-Fabric" = _snqPlHVU;
        "pkg-v21.4.0-1.21.4-NeoForge" = _TcnaGaNI;
        "pkg-v21.5.0-1.21.5-Fabric" = _6JB1aR4L;
        "pkg-v21.5.0-1.21.5-NeoForge" = _Liu705FV;
        "pkg-v21.7.0-1.21.7-Fabric" = _6s91UDil;
        "pkg-v21.7.0-1.21.7-NeoForge" = _BHld8sEN;
        "pkg-v21.8.0-1.21.8-Fabric" = _O3E0ZG8W;
        "pkg-v21.8.0-1.21.8-NeoForge" = _CunDGaON;
        "pkg-21.9.0" = _cNcjSdkV;
        "pkg-21.10.0" = _ECs7Qrfq;
