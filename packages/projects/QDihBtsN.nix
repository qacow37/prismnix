...
let
    ...
    in {
        ...
        "pkg-1.2.1" = _JcXcjo9G;
        "pkg-1.2.2" = _inOIbH0q;
        "pkg-retro-1.3.0" = _BuQ0W147;
        "pkg-1.3.0" = _OrFuDV4U;
        "pkg-retro-1.4.0" = _lYlliukL;
        "pkg-1.4.0" = _qIYxM07p;
        "pkg-retro-1.4.1" = _se7GzizW;
        "pkg-1.4.1" = _s9mzeQtQ;
        "pkg-1.7.10-1.4.2" = _HRIwpi0i;
        "pkg-1.14.4-1.4.2" = _tRMm5yk1;
        "pkg-1.5.0" = _33z7IW3i;
        "pkg-1.7.10-1.4.3" = _nuHNNjQQ;
        "pkg-1.14.4-1.5.1" = _z8zaDCHj;
        "pkg-1.14.4-1.5.2" = _ZqnVHPyr;
        "pkg-1.7.10-1.6.0" = _ABvV4Oh7;
        "pkg-1.14.4-1.6.0" = _BjkDyh6V;
        "pkg-1.14.4-1.6.1" = _1MMioGBP;
        "pkg-1.7.10-1.6.1" = _gRNBRBR1;
        "pkg-1.14.4-1.6.2" = _RB1oc6zq;
        "pkg-1.7.0" = _emZOWk1i;
        "pkg-1.14.4-1.7.1" = _luXF7ddL;
        "pkg-1.14.4-1.7.2" = _N9yFPuek;
        "default" = _N9yFPuek;
    });
