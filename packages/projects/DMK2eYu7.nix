...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.4-fabric" = _YlLaqOgC;
        "pkg-1.18.2-1.4-fabric" = _qDAUtHdE;
        "pkg-1.19.2-1.6-fabric" = _TQMv3ZGd;
        "pkg-1.16.5-1.0-forge" = _8U0jsRhu;
        "pkg-1.18.2-1.1-forge" = _XaPMWavr;
        "pkg-1.19.2-1.3-forge" = _bzEN58XA;
        "pkg-1.16.5-1.7-fabric" = _cB8x7RNC;
        "pkg-1.18.2-1.7-fabric" = _pNL1orcH;
        "pkg-1.19.2-1.7-fabric" = _6bIHdm66;
        "pkg-1.16.5-1.7-forge" = _1kmDh6Ai;
        "pkg-1.18.2-1.7-forge" = _sd8RY5DY;
        "pkg-1.19.2-1.7-forge" = _3Zt6HApj;
        "pkg-1.16.5-1.8-fabric" = _RJsfSFoP;
        "pkg-1.18.2-1.8-fabric" = _HFCpuidk;
        "pkg-1.19.2-1.8-fabric" = _Ke7ov80E;
        "pkg-1.19.3-1.9-fabric" = _F9Yqodkr;
        "pkg-1.19.3-1.7-forge" = _P4dPrRDJ;
        "pkg-1.18.2-2.0-forge+fabric" = _lPGlP2db;
        "pkg-1.19.2-2.0-forge+fabric" = _In1DbLKi;
        "pkg-1.19.3-2.0-forge+fabric" = _U7oUgoOb;
        "pkg-1.18.2-2.1-forge+fabric" = _MBtMqqe0;
        "pkg-1.19.2-2.1-forge+fabric" = _lS9ymf3C;
        "pkg-1.19.3-2.1-forge+fabric" = _OsyTZRYw;
        "pkg-1.19.4-2.1-forge+fabric" = _a9UzXG23;
        "pkg-1.20-2.1-forge+fabric" = _qT4GR5Sp;
        "pkg-1.20.1-2.1-forge+fabric" = _gB0EZ0Rc;
        "pkg-1.20.2-2.1-forge+fabric" = _sToND03A;
        "pkg-1.18.2-2.2-forge+fabric" = _3gsrlEKC;
        "pkg-1.19.2-2.2-forge+fabric" = _G4YaJxYT;
        "pkg-1.20.1-2.2-forge+fabric" = _RF7FNVeU;
        "pkg-1.20.2-2.2-forge+fabric" = _tiVs52Ea;
        "pkg-1.20.3-2.2-fabric+forge+neo" = _WZKLy7nR;
        "pkg-1.20.4-2.2-fabric+forge+neo" = _R8tQ3TN7;
        "pkg-1.19.2-2.3-fabric+forge+neo" = _6p0oPyWz;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _PxVipgLG;
        "pkg-1.20.2-2.3-fabric+forge+neo" = _hqFthmVU;
        "pkg-1.20.4-2.3-fabric+forge+neo" = _FohqwtWG;
        "pkg-1.19.2-2.4-fabric+forge" = _rfhSzuMI;
        "pkg-1.20.1-2.4-fabric+forge+neo" = _NxBbluah;
        "pkg-1.20.4-2.4-fabric+forge+neo" = _yCVSI16R;
        "pkg-1.20.5-2.4-fabric+neo" = _yCP7K86d;
        "pkg-1.20.5-2.5-fabric+neo" = _1ZIKPLIi;
        "pkg-1.20.6-2.5-fabric+forge+neo" = _5fyLVNoq;
        "pkg-1.21.0-2.5-fabric+forge+neo" = _ln1IItMx;
        "pkg-1.20.1-2.6-fabric+forge+neo" = _Lv0mK9E0;
        "pkg-1.20.6-2.6-fabric+forge+neo" = _OTkBmhLy;
        "pkg-1.21.0-2.6-fabric+forge+neo" = _BFt7s9Nm;
        "pkg-1.21.1-2.6-fabric+forge+neo" = _7a57QQtY;
        "pkg-1.21.2-2.6-fabric+neo" = _Vmh4w1E5;
        "pkg-1.21.3-2.6-fabric+forge+neo" = _2Qa19aXb;
        "pkg-1.21.4-2.6-fabric+forge+neo" = _8hTBJ8XG;
        "pkg-1.20.1-2.7-fabric+forge+neo" = _Mq4Xj1Sl;
        "pkg-1.21.1-2.7-fabric+forge+neo" = _n1QkuC4i;
        "pkg-1.21.4-2.7-fabric+forge+neo" = _1HYmlOYh;
        "pkg-1.21.5-2.7-fabric+forge+neo" = _JhmB847d;
        "pkg-1.21.6-2.7-fabric+forge+neo" = _jtL2MXYf;
        "pkg-1.21.6-2.8-fabric+forge+neo" = _HFNAuIdq;
        "pkg-1.21.7-2.8-fabric+forge+neo" = _lk3WlylO;
        "pkg-1.21.8-2.8-fabric+forge+neo" = _5OX2cOcI;
        "pkg-1.21.9-2.8-fabric+forge+neo" = _4MO5s8lq;
        "pkg-1.21.10-2.8-fabric+forge+neo" = _UIe7l3O9;
        "pkg-1.21.11-2.8-fabric+forge+neo" = _5rSy2RLB;
        "pkg-26.1.0-2.8-fabric+forge+neo" = _evwl7vBr;
        "pkg-26.1.1-2.8-fabric+forge+neo" = _uVfMxUQM;
        "pkg-26.1.2-2.8-fabric+forge+neo" = _OfDtxLJM;
        "pkg-26.2.0-2.8-fabric+forge+neo" = _HaUYHekm;
        "default" = _HaUYHekm;
    });
