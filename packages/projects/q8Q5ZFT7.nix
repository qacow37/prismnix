...
let
    ...
    in {
        ...
        "pkg-1.0.0-SNAPSHOT" = _cfEaeTGG;
        "pkg-1.0.0-alpha.1" = _fRiS6pGO;
        "pkg-1.0.0-alpha.2" = _QMh1S6tR;
        "pkg-1.0.0-alpha.3" = _O9cLLvPq;
        "pkg-1.0.0-alpha.4" = _xmMJ3QS9;
        "pkg-1.0.0-alpha.5" = _KVfOEN9X;
        "pkg-1.0.0-alpha.6" = _1GkBYlnY;
        "pkg-1.0.0-alpha.7" = _PgUYt07x;
        "pkg-1.0.0-alpha.8" = _FR0S8Gf9;
        "pkg-1.0.0-alpha.9" = _woLxE396;
        "pkg-1.0.0-alpha.10" = _5g6nMqnk;
        "pkg-1.0.0-alpha.11" = _SFo9WlVl;
        "pkg-1.0.0-alpha.12" = _pS4srBPS;
        "pkg-1.0.0-alpha.13" = _KDMabDDY;
        "pkg-1.0.0-alpha.14" = _5N7C7aP0;
        "pkg-1.0.0-alpha.15" = _uOfWDBoF;
        "pkg-1.0.0-alpha.16" = _4rPVb0Tg;
        "pkg-1.0.0-alpha.17" = _aOHHZVc0;
        "pkg-1.0.0-alpha.18" = _mWwm1VUg;
        "pkg-1.0.0-alpha.19" = _klfJBZCr;
        "pkg-1.0.0-alpha.20" = _Gr5n76T7;
        "pkg-1.0.0-alpha.21" = _z3PRQlUM;
        "pkg-1.0.0-alpha.22" = _jmv0aAMw;
        "pkg-1.0.0-alpha.23" = _QLZYqPkP;
        "pkg-1.0.0-alpha.24" = _5HF6pO3r;
        "pkg-1.0.0-alpha.25" = _bgQukuiT;
        "pkg-1.0.0-alpha.26" = _WzkuRtpI;
        "pkg-1.0.0-alpha.27" = _eS3yp2qJ;
        "pkg-1.0.0-alpha.28" = _h3BjrKM4;
        "pkg-1.0.0-alpha.29" = _vhPozdSL;
        "pkg-1.0.0-alpha.30" = _Sv6su0hK;
        "pkg-1.0.0-alpha.32" = _5mbjROvY;
        "default" = _5mbjROvY;
    });
