...
let
    ...
    in {
        ...
        "pkg-1.0.6" = _dToAdDS8;
        "pkg-1.0.7" = _BTZacATQ;
        "pkg-1.0.8+1.19" = _RmsKiWBG;
        "pkg-1.0.9+1.19" = _YzoO9Rp5;
        "pkg-2.0.0+1.19-fabric" = _Lxo73pkB;
        "pkg-2.0.1+1.19-fabric" = _isrcBlxN;
        "pkg-2.0.2+1.19-fabric" = _V4cBjSNf;
        "pkg-2.1.0+1.19-fabric" = _Kmx4fYwJ;
        "pkg-2.2.0+1.18.2-fabric" = _X4aCxNak;
        "pkg-2.2.0+1.18.2-forge" = _JCxZlhYZ;
        "pkg-2.2.0+1.19-forge" = _OqfciHlH;
        "pkg-2.2.0+1.19-fabric" = _1oUQWCR2;
        "pkg-3.0.0+1.18.2-forge" = _ZkDIrPKU;
        "pkg-3.0.0+1.18.2-fabric" = _9AwQEbEW;
        "pkg-3.0.0+1.19-forge" = _vfrSBMkK;
        "pkg-3.0.0+1.19-fabric" = _SFBgp0Np;
        "pkg-3.0.0+1.19.3-forge" = _l8S0vwMu;
        "pkg-3.0.0+1.19.3-fabric" = _895AGGqE;
        "pkg-3.0.0+1.19.4-forge" = _XZUTTWrM;
        "pkg-3.0.0+1.19.4-fabric" = _3Qa5LtB7;
        "pkg-3.1.0+1.18.2-forge" = _verg9LZP;
        "pkg-3.1.0+1.18.2-fabric" = _lk9hRF5m;
        "pkg-3.1.0+1.19-forge" = _YgghDwPO;
        "pkg-3.1.0+1.19-fabric" = _ioWRFrpH;
        "pkg-3.1.0+1.19.3-forge" = _APOsJrk6;
        "pkg-3.1.0+1.19.3-fabric" = _Use2Wc8w;
        "pkg-3.1.0+1.19.4-fabric" = _wkCDeHuV;
        "pkg-3.1.0+1.19.4-forge" = _ty5sfnFd;
        "pkg-3.2.0+1.19.4-fabric" = _wgt5TX38;
        "pkg-3.2.0+1.19.4-forge" = _KmOINMgZ;
        "pkg-3.2.0+1.19.3-fabric" = _90WiDH7U;
        "pkg-3.2.0+1.19.3-forge" = _li8jFAS6;
        "pkg-3.2.0+1.19-forge" = _ixuj3BQo;
        "pkg-3.2.0+1.19-fabric" = _9tbiPKHo;
        "pkg-3.2.1+1.19.4-fabric" = _KLdFqP9j;
        "pkg-3.2.1+1.19-fabric" = _qdfM9zqu;
        "pkg-3.2.1+1.19-forge" = _l6ZX9VlU;
        "pkg-3.2.1+1.19.3-fabric" = _nUSz2Ow2;
        "pkg-3.2.1+1.19.3-forge" = _mXIgIV5d;
        "pkg-3.2.1+1.19.4-forge" = _BbLEDLVx;
        "pkg-3.2.1+1.20-fabric" = _kJonytow;
        "pkg-3.2.1+1.20-forge" = _K9g8WAlv;
        "pkg-3.2.2+1.20.1-fabric" = _IJYozS89;
        "pkg-3.2.2+1.20.1-forge" = _KgTLAkfq;
        "pkg-3.2.2+1.20.2-forge" = _FitdvaJ7;
        "pkg-3.2.2+1.20.2-fabric" = _V4AfQVrE;
        "pkg-3.2.3+1.20.1-forge" = _Xk19d9L4;
        "pkg-3.2.3+1.20.1-fabric" = _TPkj1ZDs;
        "default" = _TPkj1ZDs;
    });
