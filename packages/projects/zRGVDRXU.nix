...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _BFiTxoqm;
        "pkg-0.2.0" = _XjoGnQMz;
        "pkg-0.2.1-1.20.4" = _5PLc0NUg;
        "pkg-0.2.1-1.20.5" = _ghaPVgEl;
        "pkg-0.2.2-1.20.5+6" = _L3jBR4dv;
        "pkg-0.2.3-1.21" = _KDxisrHh;
        "pkg-0.2.4-1.21" = _w3VUX2TF;
        "pkg-0.2.5-1.21.3" = _ec6p6fe0;
        "pkg-0.2.6-1.21.1" = _UfbGeEYH;
        "pkg-0.2.6-1.21.3" = _4a76rZMe;
        "pkg-0.2.6-1.21.4" = _FJs4GZ9y;
        "pkg-0.2.7-1.21.5" = _9PorJven;
        "pkg-0.2.8-1.21.5" = _YlQZklTI;
        "pkg-0.2.8-1.21.6" = _YJG77Sbi;
        "pkg-0.2.8-1.21.7" = _mshS9nkh;
        "pkg-0.2.8-1.21.8" = _OMIzuGM5;
        "pkg-0.2.8-1.21.9" = _Q9UGqBTF;
        "pkg-0.2.8-1.21.10" = _xgfahyaX;
        "pkg-0.2.8-1.21.11" = _3J8yNLmB;
        "pkg-0.2.9-1.21.11" = _QqFttNdi;
        "pkg-0.3.0-26.1" = _13RzUQsE;
        "pkg-0.3.0-26.1.1" = _B5elRQZu;
        "pkg-0.3.1-26.2" = _wmnrPr5P;
        "default" = _wmnrPr5P;
    });
