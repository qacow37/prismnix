...
let
    ...
    in {
        ...
        "pkg-V1.2" = _MKvMhwyU;
        "pkg-1.3.0" = _d1bQdLmT;
        "pkg-V1.3.1" = _xmBqeq0w;
        "pkg-1.3.2" = _VJDTnqZy;
        "pkg-V2.0.0" = _4LUwgtZN;
        "pkg-1.18-V2.0.0" = _cG0HouP7;
        "pkg-V3.0.1" = _be6WQSmQ;
        "pkg-3.0.1" = _HCl9vN5d;
        "pkg-1.19.2-4.0.2" = _5J8xRK6N;
        "pkg-1.0.0" = _Y9QOmPTy;
        "pkg-1.0.1" = _M96ycKgM;
        "pkg-1.1.0" = _LNSMks9Q;
        "pkg-1.1.1" = _N5C7BDBz;
        ...
        "pkg-2.0.0" = _D6GQJ6Mc;
        "pkg-3.0.0" = _ypUTXgrq;
        "pkg-1.21.1-3.1.0" = _4uDuexD8;
        "pkg-1.21.1-3.2.1" = _X8NOTMQi;
        "pkg-1.21.1-3.2.2" = _IwjpCxlt;
        "default" = _IwjpCxlt;
    });
