...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.4" = _5qLhJr1U;
        "pkg-1.18.2-1.0.5" = _fmoJf7GX;
        "pkg-1.20.1-1.0.7" = _dygFtAFH;
        "pkg-1.20.1-1.0.8" = _mIOu49Wn;
        "pkg-1.18.2-1.0.8" = _OxIAMv0U;
        "pkg-1.20.1-1.2.0-fabric" = _sxNfqC3E;
        "pkg-1.20.1-1.2.0-forge" = _Zbmk0wfs;
        "pkg-1.20.1-1.2.1-fabric" = _GuoxDrKP;
        "pkg-1.20.1-1.2.1-forge" = _t6K1q2Pu;
        "pkg-1.20.1-1.2.2-fabric" = _OlGoA8cD;
        "pkg-1.20.1-1.2.2-forge" = _9zuatfHM;
        "pkg-1.20.1-1.3.0b1-fabric" = _UwR2FxyJ;
        "pkg-1.20.1-1.3.0b1-forge" = _yWC4Z4Vo;
        "pkg-1.20.1-1.4.0-fabric" = _jkjmuzO6;
        "pkg-1.20.1-1.4.0-forge" = _q2g2ritU;
        "pkg-1.20.1-1.3.1-fabric" = _vXT5KTzC;
        "pkg-1.20.1-1.3.1-forge" = _WYuSl7Vo;
        "pkg-1.20.1-1.4.3-fabric" = _WwHzX5M9;
        "pkg-1.20.1-1.4.3-forge" = _7t7qGqtC;
        "pkg-1.20.1-1.4.4-fabric" = _S0D4noic;
        "pkg-1.20.1-1.4.4-forge" = _H996mVdt;
        "pkg-1.20.1-1.4.5-fabric" = _hB7x3K6T;
        "pkg-1.20.1-1.4.5-forge" = _vANIBXYO;
        "pkg-1.20.1-1.4.6-fabric" = _Rmys9EFU;
        "pkg-1.20.1-1.4.6-forge" = _xlb8sBJa;
        "pkg-1.21-1.4.6-fabric" = _6u2Rc6nV;
        "pkg-1.21-1.4.6-neoforge" = _f6TWFI9x;
        "pkg-1.20.1-1.4.7-fabric" = _8QXSm2Kh;
        "pkg-1.20.1-1.4.7-forge" = _zekw2rWD;
        "pkg-1.21-1.4.7-fabric" = _pvvRGT6U;
        "pkg-1.21-1.4.7-neoforge" = _jeuOZqpO;
        "pkg-1.20.1-1.4.8-fabric" = _fHMOBjvB;
        "pkg-1.20.1-1.4.8-forge" = _FqFiDhRL;
        "pkg-1.20.1-1.4.9-fabric" = _2Qu78BOU;
        "pkg-1.20.1-1.4.9-forge" = _qbol9kQh;
        "pkg-1.21-1.4.9-fabric" = _VcPLjR4h;
        "pkg-1.21-1.4.9-neoforge" = _13ggBnrg;
        "pkg-1.20.1-1.4.10-fabric" = _6MnAGzll;
        "pkg-1.20.1-1.4.10-forge" = _y71X65Qm;
        "pkg-1.20.1-1.4.11-fabric" = _8LsA5nMY;
        "pkg-1.20.1-1.4.11-forge" = _heNkI8gU;
        "pkg-1.21-1.4.11-fabric" = _Gv6IhEFy;
        "pkg-1.21-1.4.11-neoforge" = _apkXxn3m;
        "pkg-fabric-1.21-1.4.12" = _bmrcdjP2;
        "pkg-fabric-1.20.1-2.0.0" = _fPb8bZ3k;
        "pkg-forge-1.20.1-2.0.0" = _JBAotatv;
        "pkg-fabric-1.21.1-2.0.0" = _2K8Sfap1;
        "pkg-neoforge-1.21.1-2.0.0" = _Xk0tXE88;
        "pkg-fabric-26.1-2.0.0" = _qb4jbEMV;
        "pkg-neoforge-26.1-2.0.0" = _VQLv5T8J;
        "pkg-fabric-1.20.1-2.0.1" = _isFdEj3w;
        "pkg-forge-1.20.1-2.0.1" = _tCNCKJle;
        "pkg-fabric-1.21.1-2.0.1" = _xUtLwIWE;
        "pkg-neoforge-1.21.1-2.0.1" = _sF0oB5ow;
        "pkg-fabric-26.1-2.0.1" = _ZEzMzB9t;
        "pkg-neoforge-26.1-2.0.1" = _AhM5tCQm;
        "pkg-fabric-1.20.1-2.1.0" = _JB2NqLkW;
        "pkg-forge-1.20.1-2.1.0" = _svild8SE;
        "pkg-fabric-1.21.1-2.1.0" = _I5rOWuiA;
        "pkg-neoforge-1.21.1-2.1.0" = _f71ub7ed;
        "pkg-fabric-26.1-2.1.0" = _526Q25M4;
        "pkg-neoforge-26.1-2.1.0" = _H231Jj12;
        "pkg-fabric-1.20.1-2.2.0" = _Kr0rF5xu;
        "pkg-forge-1.20.1-2.2.0" = _aTc9PgXJ;
        "pkg-fabric-1.21.1-2.2.0" = _HiO9rzKA;
        "pkg-neoforge-1.21.1-2.2.0" = _vkma84Pu;
        "pkg-fabric-26.1.2-2.2.0" = _U0HrK556;
        "pkg-neoforge-26.1.2-2.2.0" = _BXGe5HnC;
        "pkg-neoforge-26.1.2-2.2.2" = _SJzWIGHB;
        "pkg-fabric-1.20.1-2.2.3" = _KPUjU5NL;
        "pkg-forge-1.20.1-2.2.3" = _9cBh3Vh8;
        "pkg-fabric-1.21.1-2.2.3" = _v93Kx3ly;
        "pkg-neoforge-1.21.1-2.2.3" = _ePi58Pcx;
        "pkg-fabric-26.1.2-2.2.3" = _gY1Ig5nY;
        "pkg-neoforge-26.1.2-2.2.3" = _vSY72JSQ;
        "default" = _vSY72JSQ;
    });
