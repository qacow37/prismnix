...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.20.4-forge" = _9Qm2HqHr;
        "pkg-0.1.0+1.20.2-neoforge" = _LFoW7Ovj;
        "pkg-0.1.0+1.20.1-forge" = _WE273z9x;
        "pkg-0.1.0+1.21-neoforge" = _PdgSzyDi;
        "pkg-0.1.0+1.19.2-forge" = _EEk2Z3Eo;
        "pkg-0.1.0+1.19.4-fabric" = _7YmqLNrD;
        "pkg-0.1.0+1.20.2-forge" = _PP0ZUxR7;
        "pkg-0.1.0+1.20.1-fabric" = _zNfBAPXE;
        "pkg-0.1.0+1.19.4-forge" = _4L7DNiyo;
        "pkg-0.1.0+1.18.2-fabric" = _PDCF6vXj;
        "pkg-0.1.0+1.20.4-neoforge" = _2Z2GKu8o;
        "pkg-0.1.0+1.17.1-forge" = _KIjZ9hmW;
        "pkg-0.1.0+1.18.2-forge" = _GHuRfja7;
        "pkg-0.1.0+1.21-fabric" = _D3MkPl1V;
        "pkg-0.1.0+1.20.6-neoforge" = _XWC1KUKs;
        "pkg-0.1.0+1.20.4-fabric" = _cimdHkR0;
        "pkg-0.1.0+1.20.6-fabric" = _f22CZ5b2;
        "pkg-0.1.0+1.19.2-fabric" = _Gmf0CXxX;
        "pkg-0.1.0+1.20.2-fabric" = _DRfs5pPG;
        "pkg-0.1.0+1.16.5-forge" = _cGhg1Kgn;
        "pkg-0.1.0+1.16.5-fabric" = _3ZByGDFo;
        "pkg-0.1.0+1.17.1-fabric" = _QQstJcjX;
        "pkg-0.1.0+1.12.2-forge" = _mKX75Rry;
        "pkg-0.1.0+1.8.9-forge" = _SVvKiPsQ;
        "pkg-0.1.1+1.21-neoforge" = _AgaeL0iV;
        "pkg-0.1.1+1.20.6-neoforge" = _5jzbAWns;
        "pkg-0.1.1+1.20.2-neoforge" = _NB3tt12t;
        "pkg-0.1.1+1.21-fabric" = _daH5f0wZ;
        "pkg-0.1.1+1.20.4-neoforge" = _MCakBzqE;
        "pkg-0.1.1+1.20.6-fabric" = _C1Wrqdfx;
        "pkg-0.1.1+1.20.4-fabric" = _DF1PewME;
        "pkg-0.1.1+1.20.4-forge" = _r0CAkWZL;
        "pkg-0.1.1+1.19.2-fabric" = _lAf4uwyV;
        "pkg-0.1.1+1.20.2-forge" = _8C2RwKXP;
        "pkg-0.1.1+1.19.4-forge" = _em9Rx27t;
        "pkg-0.1.1+1.20.1-fabric" = _cxvqp6c1;
        "pkg-0.1.1+1.16.5-forge" = _m8l3TQwD;
        "pkg-0.1.1+1.19.4-fabric" = _IqTm86ZD;
        "pkg-0.1.1+1.18.2-fabric" = _q12qA3KE;
        "pkg-0.1.1+1.20.1-forge" = _6KeHiDh2;
        "pkg-0.1.1+1.16.5-fabric" = _pa9U9yRs;
        "pkg-0.1.1+1.19.2-forge" = _ab4YnMNp;
        "pkg-0.1.1+1.18.2-forge" = _U1cqPWLc;
        "pkg-0.1.1+1.17.1-fabric" = _9Muaxv3m;
        "pkg-0.1.1+1.20.2-fabric" = _C3LwcqBS;
        "pkg-0.1.1+1.17.1-forge" = _ciyrXWqr;
        "pkg-0.1.1+1.12.2-forge" = _UKPWgt6s;
        "pkg-0.1.1+1.8.9-forge" = _zvH4X2vU;
        "pkg-0.2.0+1.21-fabric" = _qvHDBjhT;
        "pkg-0.2.0+1.21-neoforge" = _ph4ZJECm;
        "pkg-0.2.0+1.20.6-neoforge" = _cauiOLc4;
        "pkg-0.2.0+1.20.4-neoforge" = _wJtLy0Su;
        "pkg-0.2.0+1.20.2-neoforge" = _DKrKFATM;
        "pkg-0.2.0+1.20.6-fabric" = _HDoZ0YTx;
        "pkg-0.2.0+1.20.4-fabric" = _czzJWmcR;
        "pkg-0.2.0+1.20.2-forge" = _1YT3QHfv;
        "pkg-0.2.0+1.17.1-fabric" = _zZg2NmhO;
        "pkg-0.2.0+1.17.1-forge" = _5kzZrsbb;
        "pkg-0.2.0+1.19.4-forge" = _dySzvb16;
        "pkg-0.2.0+1.18.2-fabric" = _C54LLGM2;
        "pkg-0.2.0+1.20.1-forge" = _seCSFuBt;
        "pkg-0.2.0+1.16.5-forge" = _D0npwUBR;
        "pkg-0.2.0+1.16.5-fabric" = _3PosOcL5;
        "pkg-0.2.0+1.19.4-fabric" = _leOcplAU;
        "pkg-0.2.0+1.20.2-fabric" = _aOXqhVg8;
        "pkg-0.2.0+1.19.2-fabric" = _JjLuJNiz;
        "pkg-0.2.0+1.18.2-forge" = _BoEJbtjm;
        "pkg-0.2.0+1.20.1-fabric" = _xirK5LJN;
        "pkg-0.2.0+1.19.2-forge" = _ZKOGm79Q;
        "pkg-0.2.0+1.20.4-forge" = _hfroSYzm;
        "pkg-0.2.0+1.12.2-forge" = _InvHsTxS;
        "pkg-0.2.0+1.8.9-forge" = _ROzHKFcs;
        "pkg-0.2.1+1.20.4-neoforge" = _5iRh00U1;
        "pkg-0.2.1+1.21-neoforge" = _yUFqko9W;
        "pkg-0.2.1+1.20.4-forge" = _wfKgbEvZ;
        "pkg-0.2.1+1.20.6-neoforge" = _dsu3dUJ9;
        "pkg-0.2.1+1.20.2-forge" = _rDji5MpV;
        "pkg-0.2.1+1.20.2-neoforge" = _xylysicw;
        "pkg-0.2.1+1.21-fabric" = _Cn3CeXTZ;
        "pkg-0.2.1+1.20.2-fabric" = _zZahFFKQ;
        "pkg-0.2.1+1.20.4-fabric" = _COAqoieT;
        "pkg-0.2.1+1.20.6-fabric" = _uhGsqEsM;
        "pkg-0.2.1+1.19.4-forge" = _1QlnUKgp;
        "pkg-0.2.1+1.20.1-forge" = _eQ6mfck7;
        "pkg-0.2.1+1.20.1-fabric" = _hAGTREhl;
        "pkg-0.2.1+1.19.2-fabric" = _hYJGTT2X;
        "pkg-0.2.1+1.18.2-forge" = _aB9AdD5Z;
        "pkg-0.2.1+1.18.2-fabric" = _JCsSDsqt;
        "pkg-0.2.1+1.19.2-forge" = _1U3bKL4f;
        "pkg-0.2.1+1.19.4-fabric" = _ZFIREnQy;
        "pkg-0.2.1+1.17.1-forge" = _VVpEKNbE;
        "pkg-0.2.1+1.16.5-forge" = _fGxVnkdk;
        "pkg-0.2.1+1.17.1-fabric" = _gY6sJ3CU;
        "pkg-0.2.1+1.16.5-fabric" = _WD8Oic55;
        "pkg-0.2.1+1.8.9-forge" = _IIYtOSIz;
        "pkg-0.2.1+1.12.2-forge" = _fBhnXYQc;
        "pkg-0.3.0+1.20.2-neoforge" = _bGqrG26F;
        "pkg-0.3.0+1.20.4-neoforge" = _4srn0tNM;
        "pkg-0.3.0+1.21-neoforge" = _dHR3N460;
        "pkg-0.3.0+1.20.6-neoforge" = _xCMDUaC6;
        "pkg-0.3.0+1.20.6-fabric" = _RyNiTd39;
        "pkg-0.3.0+1.18.2-fabric" = _4gk3Aws1;
        "pkg-0.3.0+1.17.1-forge" = _ANNDtq6L;
        "pkg-0.3.0+1.19.2-forge" = _5TgsQdCs;
        "pkg-0.3.0+1.19.4-fabric" = _Y8KK0P2D;
        "pkg-0.3.0+1.16.5-fabric" = _T8GA0FMP;
        "pkg-0.3.0+1.19.2-fabric" = _VbMfWvqF;
        "pkg-0.3.0+1.16.5-forge" = _sIIEg9vc;
        "pkg-0.3.0+1.21-fabric" = _ZJWIem0C;
        "pkg-0.3.0+1.20.1-forge" = _f2nxfZHy;
        "pkg-0.3.0+1.20.2-forge" = _YxnCoGSj;
        "pkg-0.3.0+1.20.2-fabric" = _5o9qPXRi;
        "pkg-0.3.0+1.17.1-fabric" = _uTLne2Nw;
        "pkg-0.3.0+1.20.1-fabric" = _8Ouz25dC;
        "pkg-0.3.0+1.18.2-forge" = _bYm1Qicd;
        "pkg-0.3.0+1.20.4-fabric" = _OD25QVUx;
        "pkg-0.3.0+1.19.4-forge" = _M2rWDdHn;
        "pkg-0.3.0+1.20.4-forge" = _JFETjFA7;
        "pkg-0.3.0+1.8.9-forge" = _biEkBWpB;
        "pkg-0.3.0+1.12.2-forge" = _Uqi1z8io;
        "pkg-0.4.0+1.20.2-neoforge" = _6I0iVO8i;
        "pkg-0.4.0+1.20.4-neoforge" = _5WViwnTN;
        "pkg-0.4.0+1.20.6-neoforge" = _xxLrHIsW;
        "pkg-0.4.0+1.21-neoforge" = _jhlgY4rg;
        "pkg-0.4.0+1.18.2-forge" = _k51vITTs;
        "pkg-0.4.0+1.19.4-fabric" = _Z4oxu9P2;
        "pkg-0.4.0+1.19.2-forge" = _LD9iRRv6;
        "pkg-0.4.0+1.16.5-fabric" = _bJ2N5qyC;
        "pkg-0.4.0+1.20.1-forge" = _WpR5Xvt7;
        "pkg-0.4.0+1.20.4-forge" = _oLPYkcZG;
        "pkg-0.4.0+1.18.2-fabric" = _YASpn0C2;
        "pkg-0.4.0+1.16.5-forge" = _pkREPX6l;
        "pkg-0.4.0+1.17.1-forge" = _UYDoHtO6;
        "pkg-0.4.0+1.21-fabric" = _NevdAyqV;
        "pkg-0.4.0+1.20.4-fabric" = _LqITgWkx;
        "pkg-0.4.0+1.20.6-fabric" = _xLWPWl7U;
        "pkg-0.4.0+1.20.2-fabric" = _bBePiF5j;
        "pkg-0.4.0+1.20.2-forge" = _ubWTZxtK;
        "pkg-0.4.0+1.19.2-fabric" = _lyY4jiA9;
        "pkg-0.4.0+1.19.4-forge" = _njTKrACf;
        "pkg-0.4.0+1.17.1-fabric" = _ZDe0zU0r;
        "pkg-0.4.0+1.20.1-fabric" = _qWK1ghK9;
        "pkg-0.4.0+1.12.2-forge" = _9FGYoZ6y;
        "pkg-0.4.0+1.8.9-forge" = _9U28R8FN;
        "pkg-0.5.0+1.12.2-forge" = _CDeXH0IT;
        "pkg-0.5.0+1.16.5-fabric" = _Oo551o3f;
        "pkg-0.5.0+1.16.5-forge" = _iTNV90yv;
        "pkg-0.5.0+1.17.1-fabric" = _6ZR9BBW3;
        "pkg-0.5.0+1.17.1-forge" = _Kp4rJYS4;
        "pkg-0.5.0+1.18.2-fabric" = _eRkElGSw;
        "pkg-0.5.0+1.18.2-forge" = _WQJRpmwM;
        "pkg-0.5.0+1.19.2-fabric" = _uquVtd5f;
        "pkg-0.5.0+1.19.2-forge" = _ZwH0S4eD;
        "pkg-0.5.0+1.19.4-fabric" = _2S9aHSyP;
        "pkg-0.5.0+1.19.4-forge" = _OEdohuCN;
        "pkg-0.5.0+1.20.1-fabric" = _yazBhbSu;
        "pkg-0.5.0+1.20.1-forge" = _y6B4V0ps;
        "pkg-0.5.0+1.20.2-fabric" = _VKTh2im3;
        "pkg-0.5.0+1.20.2-forge" = _wpEfqwpo;
        "pkg-0.5.0+1.20.2-neoforge" = _KgA8lGQz;
        "pkg-0.5.0+1.20.4-fabric" = _kfKdnIL0;
        "pkg-0.5.0+1.20.4-forge" = _IrI562OW;
        "pkg-0.5.0+1.20.4-neoforge" = _LAlUfuRu;
        "pkg-0.5.0+1.20.6-fabric" = _va8AQqj2;
        "pkg-0.5.0+1.20.6-neoforge" = _BnEqhdgl;
        "pkg-0.5.0+1.21-fabric" = _ZIVU1eVy;
        "pkg-0.5.0+1.21-neoforge" = _enLzgqd0;
        "pkg-0.5.0+1.8.9-forge" = _Nx2Ki7XD;
        "pkg-0.5.1+1.16.5-fabric" = _4AgJObBH;
        "pkg-0.5.1+1.17.1-fabric" = _ehR1klKH;
        "pkg-0.5.1+1.16.5-forge" = _kugBoP3h;
        "pkg-0.5.1+1.17.1-forge" = _WrdR4PIn;
        "pkg-0.5.1+1.18.2-fabric" = _VOre6U3q;
        "pkg-0.5.1+1.18.2-forge" = _E8DiwR8X;
        "pkg-0.5.1+1.19.2-fabric" = _B8oxQHZl;
        "pkg-0.5.1+1.19.2-forge" = _x8XO5FJp;
        "pkg-0.5.1+1.19.4-fabric" = _zg6SIEpX;
        "pkg-0.5.1+1.19.4-forge" = _NlRKlfOp;
        "pkg-0.5.1+1.20.1-fabric" = _CmX8dOTD;
        "pkg-0.5.1+1.20.2-fabric" = _JoAio6ey;
        "pkg-0.5.1+1.20.1-forge" = _mcSJP81G;
        "pkg-0.5.1+1.20.2-forge" = _VHxFgqln;
        "pkg-0.5.1+1.20.2-neoforge" = _W9PXwTw3;
        "pkg-0.5.1+1.20.4-fabric" = _3jeOapo0;
        "pkg-0.5.1+1.20.4-forge" = _DJRR8bm4;
        "pkg-0.5.1+1.20.4-neoforge" = _UsY0pmNm;
        "pkg-0.5.1+1.20.6-fabric" = _k6yhCrIk;
        "pkg-0.5.1+1.20.6-neoforge" = _av1DUOTK;
        "pkg-0.5.1+1.21-fabric" = _aZAaSfVl;
        "pkg-0.5.1+1.21-neoforge" = _InrchUJT;
        "pkg-0.5.1+1.8.9-forge" = _Rr27aCov;
        "pkg-0.5.1+1.12.2-forge" = _S0zSvIrV;
        "default" = _S0zSvIrV;
    });
