...
let
    ...
    in {
        ...
        "pkg-1.21.9" = _fPiCwghX;
        "pkg-1.8" = _lVPAo9Kk;
        "pkg-1.21" = _b6c6Get8;
        "pkg-1.21.7" = _m6mWt6Br;
        "pkg-1.21.6" = _iCEdoIzg;
        "pkg-1.21.5" = _dPmIadbJ;
        "pkg-1.9-1.10" = _M7j6FqpU;
        "pkg-1.11-1.12" = _akYBcDxQ;
        "pkg-1.13" = _xtzd3qDe;
        "pkg-1.20" = _TMSsLssB;
        "pkg-1.20.2" = _4yIAb8dg;
        "pkg-1.21.4" = _9H0H0MUP;
        "pkg-1.21.2" = _DmYgP7eO;
        "pkg-1.21.1" = _e2Ucckv3;
        "pkg-1.19" = _OXfX4jmB;
        "pkg-1.19.4" = _bzziLqxq;
        "pkg-1.19.3" = _2Yy1cMn5;
        "pkg-1.18" = _o19Xoqqa;
        "pkg-1.17" = _R3enS9iQ;
        "pkg-1.16" = _ZVUka6iT;
        "pkg-1.15" = _Mu8JEp32;
