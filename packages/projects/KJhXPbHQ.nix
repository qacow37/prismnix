...
let
    ...
    in {
        ...
        "pkg-4.0.7" = _MjyEVlHS;
        "pkg-4.0.8" = _BtXREwmT;
        "pkg-4.0.6+mc1.20.1" = _MCB1ocA9;
        "pkg-4.0.2+mc1.20.1" = _o33GAToU;
        "pkg-4.0.1+mc1.20.1" = _gatP97QZ;
        "pkg-4.0.0+mc1.20.1" = _zMYE6wqq;
        "pkg-build.65+mc1.20.1" = _90T01ZgN;
        "pkg-build.64+mc1.20" = _MbkP4za6;
        "pkg-build.63+mc1.19.4" = _nzhgAsDK;
        "pkg-build.62+mc1.20.1" = _2J5tZbDx;
        "pkg-build.61+mc1.20" = _oCX5VAl6;
        "pkg-build.60+mc1.19.4" = _zHyIREU6;
        "pkg-build.59+mc1.20.1" = _pQLKmYFX;
        "pkg-build.58+mc1.20" = _auZ4x8at;
        "pkg-build.55+mc1.20" = _6M34kBHk;
        "pkg-build.54+mc1.19.4" = _YnODIsDe;
        "pkg-build.50+mc1.19.2" = _SIqdR1UJ;
        "pkg-build.18+mc1.19.3" = _ZAwnTcVu;
        "pkg-build.48+mc1.18.2" = _OJnNLLxf;
        "pkg-build.44+mc1.18.2" = _J9E7uDlD;
        "pkg-build.17+mc1.19.3" = _Iwv4XDBS;
        "pkg-build.42+mc1.18.2" = _O52mZUEt;
        "pkg-build.41+mc1.19.3" = _R3wYjYaE;
        "pkg-build.40+mc1.18.2" = _K7mpgOdv;
        "pkg-build.39+mc1.18.2" = _uvbeqJT2;
        "pkg-build.38+mc1.19.2" = _2s7hGIwd;
        "pkg-build.36+mc1.19.2" = _jMa3sL0a;
        "pkg-build.35+mc1.19.2" = _DeG4Kszf;
        "pkg-build.34+mc1.19.1" = _AUq6v3du;
        "pkg-build.16+mc1.19.1" = _kACizCIT;
        "pkg-build.33+mc1.19.1" = _tYWPEWYl;
        "pkg-build.32+mc1.19" = _R8CXTGBb;
        "pkg-build.31+mc1.19" = _dwKEn61Z;
        "pkg-build.30+mc1.19" = _AkhKr9OC;
        "pkg-build.29+mc1.18.2" = _P95ZjfS5;
        "pkg-build.15" = _88UEmBlC;
        "pkg-build.14" = _W5Ngga9T;
        "pkg-build.28+mc1.19" = _SGws5nN0;
        "pkg-build.27+mc1.19" = _dYXQANI3;
        "pkg-build.26+mc1.18.2" = _HVAGP7hy;
        "pkg-1.0.5" = _GCQonNMv;
        "pkg-build.25+mc1.18.2" = _dFFRSv3g;
        "pkg-build.24+mc1.18.1" = _FTHzB5Q5;
        "pkg-build.23+mc1.18.1" = _ZKXucxpS;
        "pkg-build.22+mc1.16.5" = _x5lHqcrL;
        "pkg-build.21+mc1.18.1" = _qVwM2Ntc;
        "pkg-build.20+mc1.18.1" = _9EeaI6R6;
        "pkg-build.19+mc1.16.5" = _4gpRYnT7;
        "pkg-build.18+mc1.18.1" = _smSxPaLG;
        "pkg-1.0.4" = _p6n6hgnC;
        "pkg-build.16+mc1.18.1" = _2QYmLOhf;
        "pkg-build.17+mc1.16.5" = _YqlrKgVZ;
        "pkg-build.15+mc1.16.5" = _ehtYwl7v;
        "pkg-build.14+mc1.18.1" = _bE6C5JFw;
        "pkg-1.0.3" = _jHUCABCJ;
        "pkg-build.13+mc1.18.1" = _3OzuL6mr;
        "pkg-build.12+mc1.18" = _LnQ7nMln;
        "pkg-1.0.2" = _U33KDCYB;
        "pkg-build.11+mc1.18" = _uSspB8nC;
        "pkg-build.10+mc1.16.5" = _5tZLsba8;
        "pkg-build.8+mc1.18" = _XBKyjVP8;
        "pkg-build.4+mc1.18" = _eAOPgG9n;
        "pkg-build.2+mc1.18" = _UUgSAs1L;
        "pkg-5.0.0" = _ffb7pRMv;
        "pkg-5.1.0" = _NQwHDGYp;
        "pkg-5.1.1" = _BR8psj07;
        "pkg-5.1.2" = _2zGaH9kF;
        "pkg-21.0.1" = _Y5hWW5ab;
        "pkg-21.1.0" = _cfm6GZlI;
        "pkg-21.1.1" = _YXQPrFY3;
        "pkg-21.1.2" = _NqlDaGdd;
        "pkg-21.1.3" = _JmD5TALt;
        "pkg-21.1.4" = _fBzWv2Bi;
        "pkg-21.1.5" = _ErUSwqj3;
        "pkg-21.1.6" = _G1p59dBv;
        "pkg-21.1.7" = _CpGFL9bS;
        "pkg-21.1.8" = _NYkU1ldY;
        "pkg-21.3.1" = _pMw3RYCU;
        "pkg-21.6.0" = _Go08TfK8;
        "pkg-21.10.0" = _XSCZKZiq;
        "pkg-21.11.0" = _v2Qc0zY2;
        "pkg-26.1.0-0" = _XdhqK6mn;
