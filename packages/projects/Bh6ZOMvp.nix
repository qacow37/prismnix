...
let
    ...
    in {
        ...
        "pkg-13" = _LcvwAmSH;
        "pkg-14" = _WO7QFUFi;
        "pkg-1.20-1.7.3" = _GcGsn7L3;
        "pkg-1.20-1.7.4" = _1ozAAeUD;
        "pkg-1.20-1.8.0" = _G1EMeer8;
        "pkg-1.20-1.8.1" = _mKXftH7M;
        "pkg-1.20-1.8.2" = _6FQ9UODd;
        "pkg-1.20-1.8.3" = _pYx0klMs;
        "pkg-1.20-2.0.0" = _gvYeSXYF;
        "pkg-1.21-2.0.0" = _1WvXNlxH;
        "pkg-1.20-2.0.1" = _9jPmYL4L;
        "pkg-1.21-2.0.1" = _54ylJ2aN;
        "pkg-1.21-2.0.2" = _GKRJx1Pa;
        "pkg-1.20-2.1.0" = _q4GptzFS;
        "pkg-1.21-2.1.0" = _7Mt0A8sv;
        "pkg-1.21-2.1.1" = _CWrrSJKk;
        "pkg-1.21-2.1.2" = _n5Pt9kJS;
        "pkg-1.21-2.1.4" = _DpwpDFay;
        "pkg-1.21-2.1.5" = _hIBqif1b;
        "pkg-1.21-2.2.0" = _YcUtKPTa;
        "pkg-1.21-2.2.1" = _9HPHReKX;
        "pkg-1.21-2.2.2" = _bPeHDepY;
        "pkg-1.20-2.1.2" = _Pg7m0oCv;
        "pkg-1.21-2.2.3" = _BEMEyQl5;
        "pkg-1.21-2.2.4" = _bsYbob1i;
        "default" = _bsYbob1i;
    });
