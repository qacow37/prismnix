...
let
    ...
    in {
        ...
        "pkg-build.30+mc1.19.4" = _eKBWk7qY;
        "pkg-build.28+mc1.18.2" = _mWTsMVZ5;
        "pkg-build.26+mc1.18.2" = _H5EtmH22;
        "pkg-build.27+mc1.19.2" = _yDMFaftP;
        "pkg-build.24+mc1.19.2" = _DdUCwMlk;
        "pkg-build.25+mc1.18.2" = _i2sAtAT4;
        "pkg-build.23+mc1.19.2" = _HcspTctq;
        "pkg-build.22+mc1.19.2" = _X5qiNnje;
        "pkg-build.21+mc1.18.2" = _YNRsJTRv;
        "pkg-build.18+mc1.18.2" = _Bl9SjziF;
        "pkg-build.17+mc1.19.1" = _IW2U36O6;
        "pkg-build.16+mc1.19" = _ieKNC8jt;
        "pkg-build.15+mc1.18.2" = _qFuisDnv;
        "pkg-build.14+mc1.18.2" = _uoIttpWM;
        "pkg-build.13+mc1.19" = _AFMmFV4C;
        "pkg-build.9+mc1.19" = _xDeGtJoS;
        "pkg-build.8+mc1.18.1" = _48LCoVxk;
        "pkg-build.7+mc1.18" = _yiU6O3iJ;
        "pkg-build.3+mc1.16.5" = _tnYxN9tw;
        "pkg-1.3.5" = _siQDZMhc;
        "pkg-1.3.4" = _uftxdeJz;
        "pkg-1.3.3" = _4tfUUQ4q;
        "pkg-1.3.2" = _oavtPLP5;
        ...
        "pkg-1.0.0" = _Ew3QjzV2;
        "pkg-4.0.2" = _ggbdrn6W;
        "pkg-3.0.5-build.37+mc1.19.2" = _DlRngyOd;
        "pkg-3.0.6" = _8dzaSxiR;
        "pkg-4.0.3" = _jnmqJmSh;
        "pkg-5.0.0" = _hHVeyNtr;
        "pkg-6.0.0" = _tct97qlC;
        "pkg-7.0.0" = _aTDwaUR3;
        "pkg-86.0.0" = _dHA4sB3n;
        "pkg-6.0.1" = _mgELklnt;
        "pkg-6.0.2" = _CTHx0qlL;
        "pkg-86.0.1" = _Z8Q3XMxn;
        "pkg-87.0.0" = _5W67RaVm;
        "pkg-87.0.1" = _LYkR3nRP;
        "pkg-91.0.0" = _QBNa9sFu;
        "pkg-88.0.0" = _mTp551fI;
        "pkg-97.0.0" = _Q4WV5HZ3;
        "pkg-98.0.0" = _yN9ptwOc;
        "pkg-88.0.1" = _zGdNLf6B;
        "pkg-98.0.1" = _jqvUv2O8;
