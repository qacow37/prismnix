...
let
    ...
    in {
        ...
        "pkg-v5.0.0-1.19.3-Fabric" = _8ubFmhkT;
        "pkg-v6.0.0-1.19.4-Forge" = _qWmRaIrT;
        "pkg-v6.0.0-1.19.4-Fabric" = _n8mDLw77;
        "pkg-v7.0.0-1.20-Forge" = _3qArVSyS;
        "pkg-v7.0.0-1.20-Fabric" = _QNc5DUOR;
        "pkg-v8.0.0-1.20.1-Forge" = _p4DC4iCa;
        "pkg-v8.0.0-1.20.1-Fabric" = _oabyPC1j;
        "pkg-v3.0.0-1.18.2-Forge" = _Pa4njSW9;
        "pkg-v3.0.0-1.18.2-Fabric" = _6lsxoPtk;
        "pkg-v20.4.0-1.20.4-Fabric" = _VhkXDnrC;
        "pkg-v20.4.0-1.20.4-Forge" = _xUvEEK81;
        "pkg-v20.4.0-1.20.4-NeoForge" = _l1i4ZX8Y;
        "pkg-v8.0.1-1.20.1-Forge" = _9ocXWaBc;
        "pkg-v8.0.1-1.20.1-Fabric" = _AUOA9HVP;
        "pkg-v20.4.1-1.20.4-Fabric" = _sjvo5IIo;
        "pkg-v20.4.1-1.20.4-Forge" = _L6vbcs0z;
        "pkg-v20.4.1-1.20.4-NeoForge" = _lTOvxBBA;
        "pkg-v21.1.0-1.21.1-Fabric" = _e9DxnF1t;
        "pkg-v21.1.0-1.21.1-NeoForge" = _ZR3Q2JQQ;
        "pkg-v21.3.0-1.21.3-Fabric" = _LcwZOHZf;
        "pkg-v21.3.0-1.21.3-NeoForge" = _aIqUS2B5;
        "pkg-v21.4.0-1.21.4-Fabric" = _V1Trz8q9;
        "pkg-v21.4.0-1.21.4-NeoForge" = _OFwTBntO;
        "pkg-v21.5.0-1.21.5-Fabric" = _tgfZxaYh;
        "pkg-v21.5.0-1.21.5-NeoForge" = _hObsHTZa;
        "pkg-v21.6.0-1.21.6-Fabric" = _l1eCydb1;
        "pkg-v21.6.0-1.21.6-NeoForge" = _9hVGZCWf;
        "pkg-v21.7.0-1.21.7-Fabric" = _5FvQvA8v;
        "pkg-v21.7.0-1.21.7-NeoForge" = _2MCxG8Tj;
        "pkg-v21.8.0-1.21.8-Fabric" = _LX2C0NZK;
        "pkg-v21.8.0-1.21.8-NeoForge" = _5ql18YiC;
        "pkg-v21.1.1-1.21.1-Fabric" = _qrvtthZC;
        "pkg-v21.1.1-1.21.1-NeoForge" = _Qsj3YEUS;
        "pkg-v21.8.1-1.21.8-Fabric" = _hYRUlEli;
        "pkg-v21.8.1-1.21.8-NeoForge" = _nrA6iOIP;
        "pkg-21.9.0" = _ZYAzZsZo;
        "pkg-21.10.0" = _nquZXt4H;
        "pkg-21.11.0" = _IqnigbYl;
        "pkg-26.1.0" = _KSnJfHAX;
