...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.0.0-forge" = _k6MVZNXL;
        "pkg-1.19.4-1.0.0-fabric" = _Ux5L8SPB;
        "pkg-1.19.4-1.0.0-forge" = _O0W7UZZL;
        "pkg-1.20.1-1.0.0-fabric" = _KOALRIRO;
        "pkg-1.20.1-1.0.0-forge" = _yeRafBLD;
        "pkg-1.20.4-1.0.0-fabric" = _1N5rkxE0;
        "pkg-1.20.4-1.0.0-forge" = _yPWBolBs;
        "pkg-1.20.4-1.0.0-neoforge" = _2ZEpiQKD;
        "pkg-1.20.6-1.0.0-fabric" = _txpvDCay;
        "pkg-1.20.6-1.0.0-forge" = _RRjMksZh;
        "pkg-1.20.6-1.0.0-neoforge" = _KmsFzRBg;
        "pkg-1.21.1-1.0.0-fabric" = _7yFAbPy8;
        "pkg-1.21.1-1.0.0-forge" = _CEuxuERi;
        "pkg-1.21.1-1.0.0-neoforge" = _UHvDXSTJ;
        "pkg-1.21.3-1.0.0-fabric" = _tukf1DML;
        "pkg-1.21.3-1.0.0-forge" = _bxvvFblK;
        "pkg-1.21.3-1.0.0-neoforge" = _yw8R6wD4;
        "pkg-1.21.4-1.0.0-fabric" = _hBB9cj7P;
        "pkg-1.21.4-1.0.0-forge" = _EGT8d1Hs;
        "pkg-1.21.4-1.0.0-neoforge" = _fBOZIPmG;
        "pkg-1.20.1-1.0.1-fabric" = _ZOROaDUE;
        "pkg-1.20.1-1.0.1-forge" = _9Wpu4aw7;
        "pkg-1.18.2-1.0.2-fabric" = _2xzQjUz2;
        "pkg-1.18.2-1.0.2-forge" = _VlXP6byI;
        "pkg-1.19.2-1.0.2-fabric" = _bZVJhITe;
        "pkg-1.19.2-1.0.2-forge" = _7XZqJU09;
        "pkg-1.20.1-1.0.2-fabric" = _9i0GsOnq;
        "pkg-1.20.1-1.0.2-forge" = _uZ5PCT0V;
        "pkg-1.20.4-1.0.2-fabric" = _wgMd1Ozd;
        "pkg-1.20.4-1.0.2-forge" = _QtlNuFoA;
        "pkg-1.20.4-1.0.2-neoforge" = _nnTkEXCr;
        "pkg-1.20.6-1.0.2-fabric" = _pUnnZh8i;
        "pkg-1.20.6-1.0.2-forge" = _zEnmE6Mn;
        "pkg-1.20.6-1.0.2-neoforge" = _Jd0ZVADr;
        "pkg-1.21.1-1.0.2-fabric" = _Yad6aq0l;
        "pkg-1.21.1-1.0.2-forge" = _Ls78PMxh;
        "pkg-1.21.1-1.0.2-neoforge" = _TRdd32p1;
        "pkg-1.21.3-1.0.2-fabric" = _T2swFLz0;
        "pkg-1.21.3-1.0.2-forge" = _B6J8ZfaP;
        "pkg-1.21.3-1.0.2-neoforge" = _oSAidhYt;
        "pkg-1.21.4-1.0.2-fabric" = _ACK6lZGB;
        "pkg-1.21.4-1.0.2-forge" = _T1LhDysY;
        "pkg-1.21.4-1.0.2-neoforge" = _c5CpAlcA;
        "pkg-1.21.5-1.0.2-fabric" = _yXrUkJb9;
        "pkg-1.21.5-1.0.2-neoforge" = _qvVXPzYS;
        "pkg-1.21.5-1.0.2-forge" = _yKYUZcQW;
        "pkg-1.19.4-1.0.2-fabric" = _4B4pBsqd;
        "pkg-1.19.4-1.0.2-forge" = _pU5UogRA;
        "pkg-1.18.2-1.0.3-fabric" = _1u6HoCnv;
        "pkg-1.18.2-1.0.3-forge" = _1dxPQ0yH;
        "pkg-1.19.2-1.0.3-fabric" = _JJPc8ztg;
        "pkg-1.19.2-1.0.3-forge" = _ClgZgwNZ;
        "pkg-1.19.4-1.0.3-fabric" = _EVAOGKx8;
        "pkg-1.19.4-1.0.3-forge" = _BH9mmVHe;
        "pkg-1.20.1-1.0.3-fabric" = _Xzzw6Umg;
        "pkg-1.20.1-1.0.3-forge" = _S8g3OyMQ;
        "pkg-1.20.4-1.0.3-fabric" = _uLW4DIW0;
        "pkg-1.20.4-1.0.3-forge" = _uRhh9dMe;
        "pkg-1.20.4-1.0.3-neoforge" = _K43NFin9;
        "pkg-1.20.6-1.0.3-fabric" = _5fc7A7Zz;
        "pkg-1.20.6-1.0.3-forge" = _EWmtCnhu;
        "pkg-1.20.6-1.0.3-neoforge" = _uaMP7Y2L;
        "pkg-1.21.1-1.0.3-fabric" = _66lNS9Jt;
        "pkg-1.21.1-1.0.3-forge" = _KNJWpo6C;
        "pkg-1.21.1-1.0.3-neoforge" = _lXo1J6fi;
        "pkg-1.21.3-1.0.3-fabric" = _tscHhYpE;
        "pkg-1.21.3-1.0.3-forge" = _X4PPTjfd;
        "pkg-1.21.3-1.0.3-neoforge" = _c7yyAcgW;
        "pkg-1.21.4-1.0.3-fabric" = _ZDp4ly5n;
        "pkg-1.21.4-1.0.3-forge" = _YJDsWPt9;
        "pkg-1.21.4-1.0.3-neoforge" = _EWqmuR2A;
        "pkg-1.21.5-1.0.3-fabric" = _cyfrOhpu;
        "pkg-1.21.5-1.0.3-forge" = _u3dY3ZOf;
        "pkg-1.21.5-1.0.3-neoforge" = _6gXoZeGl;
        "pkg-1.18.2-1.0.4-fabric" = _ehU8xp6k;
        "pkg-1.18.2-1.0.4-forge" = _TYxgiKg4;
        "pkg-1.19.2-1.0.4-fabric" = _oQ9nxzkj;
        "pkg-1.19.2-1.0.4-forge" = _WpWDuZ8c;
        "pkg-1.19.4-1.0.4-fabric" = _pYdGO29z;
        "pkg-1.19.4-1.0.4-forge" = _bHjjWGmg;
        "pkg-1.20.1-1.0.4-fabric" = _M5bAPHwT;
        "pkg-1.20.1-1.0.4-forge" = _PD2PKHeM;
        "pkg-1.20.4-1.0.4-fabric" = _D49uJSvg;
        "pkg-1.20.4-1.0.4-forge" = _uoGRinNS;
        "pkg-1.20.4-1.0.4-neoforge" = _di7yoaen;
        "pkg-1.21.6-1.0.4-fabric" = _wsDEwMH9;
        "pkg-1.21.6-1.0.4-neoforge" = _gHPcdA3e;
        "pkg-1.21.6-1.0.4-forge" = _8tVT7j0r;
        "pkg-1.21.7-1.0.4-fabric" = _neJyRm5A;
        "pkg-1.21.7-1.0.4-forge" = _rVx0QqM5;
        "pkg-1.21.7-1.0.4-neoforge" = _1rd8Arom;
        "pkg-1.21.8-1.0.4-fabric" = _ngbld7cZ;
        "pkg-1.21.8-1.0.4-forge" = _olAkxnoX;
        "pkg-1.21.8-1.0.4-neoforge" = _jkXQFpaS;
        "pkg-1.18.2-1.0.5-fabric" = _iw3vVMTQ;
        "pkg-1.18.2-1.0.5-forge" = _oHqGFAnT;
        "pkg-1.19.2-1.0.5-fabric" = _GbOUxkaj;
        "pkg-1.19.2-1.0.5-forge" = _seMJhbKp;
        "pkg-1.19.4-1.0.5-fabric" = _98j6P2Yp;
        "pkg-1.19.4-1.0.5-forge" = _Aq46bpQV;
        "pkg-1.20.1-1.0.5-fabric" = _TEKSaINK;
        "pkg-1.20.1-1.0.5-forge" = _yJkPYNNy;
        "pkg-1.20.4-1.0.5-fabric" = _OowBRo7c;
        "pkg-1.20.4-1.0.5-forge" = _lRdO6sCw;
        "pkg-1.20.4-1.0.5-neoforge" = _8z1yVqNn;
        "pkg-1.20.6-1.0.5-fabric" = _fZ7pSDq7;
        "pkg-1.20.6-1.0.5-forge" = _qauQrIUj;
        "pkg-1.20.6-1.0.5-neoforge" = _BGjCEf3Q;
        "pkg-1.21.1-1.0.5-fabric" = _a5haDiXZ;
        "pkg-1.21.1-1.0.5-forge" = _a6Zg1wKf;
        "pkg-1.21.1-1.0.5-neoforge" = _6QXwF9HK;
        "pkg-1.21.3-1.0.5-fabric" = _mivuvGxv;
        "pkg-1.21.3-1.0.5-forge" = _hLPJb7jh;
        "pkg-1.21.3-1.0.5-neoforge" = _22kfQ50G;
        "pkg-1.21.4-1.0.5-fabric" = _8qJyof72;
        "pkg-1.21.4-1.0.5-forge" = _wlA0NMkg;
        "pkg-1.21.4-1.0.5-neoforge" = _uaH7mIdX;
        "pkg-1.21.5-1.0.5-fabric" = _5ngVWmtF;
        "pkg-1.21.5-1.0.5-forge" = _3TfG5UJQ;
        "pkg-1.21.5-1.0.5-neoforge" = _FbG58qtt;
        "pkg-1.21.8-1.0.5-fabric" = _RMiqhBKn;
        "pkg-1.21.8-1.0.5-forge" = _yLZY4Z26;
        "pkg-1.21.8-1.0.5-neoforge" = _aZutYRM7;
        "pkg-1.18.2-1.0.6-fabric" = _1bcPFFcz;
        "pkg-1.18.2-1.0.6-forge" = _FGGhLVIb;
        "pkg-1.19.2-1.0.6-fabric" = _mPmeAcgw;
        "pkg-1.19.2-1.0.6-forge" = _UtRtk1WD;
        "pkg-1.19.4-1.0.6-fabric" = _7LO2MmNN;
        "pkg-1.19.4-1.0.6-forge" = _4Z78yP0y;
        "pkg-1.20.1-1.0.6-fabric" = _Y46aL2Be;
        "pkg-1.20.1-1.0.6-forge" = _UEI45oUH;
        "pkg-1.20.4-1.0.6-fabric" = _yTKQOiSy;
        "pkg-1.20.4-1.0.6-forge" = _pjKmaxSt;
        "pkg-1.20.4-1.0.6-neoforge" = _QZ5ySE1Q;
        "pkg-1.20.6-1.0.6-fabric" = _eedeDv4a;
        "pkg-1.20.6-1.0.6-forge" = _BsTTv3EF;
        "pkg-1.20.6-1.0.6-neoforge" = _yh9UwiYx;
        "pkg-1.21.1-1.0.6-fabric" = _UzHH7ESS;
        "pkg-1.21.1-1.0.6-forge" = _R4E72hs6;
        "pkg-1.21.1-1.0.6-neoforge" = _ETdPQi8j;
        "pkg-1.21.3-1.0.6-fabric" = _cxi9edzg;
        "pkg-1.21.3-1.0.6-forge" = _WtEYLixZ;
        "pkg-1.21.3-1.0.6-neoforge" = _gOz9pZJB;
        "pkg-1.21.4-1.0.6-fabric" = _U5RfwaAZ;
        "pkg-1.21.4-1.0.6-forge" = _hmc4eE9k;
        "pkg-1.21.4-1.0.6-neoforge" = _UwXqLCB1;
        "pkg-1.21.5-1.0.6-fabric" = _SxtSogMN;
        "pkg-1.21.5-1.0.6-forge" = _TnfM8xcG;
        "pkg-1.21.5-1.0.6-neoforge" = _yjVMM4X4;
        "pkg-1.21.8-1.0.6-fabric" = _G1CQNPrC;
        "pkg-1.21.8-1.0.6-forge" = _QFhZ5sCa;
        "pkg-1.21.8-1.0.6-neoforge" = _xUx72apF;
        "pkg-1.21.9-1.0.6-fabric" = _uev1dghP;
        "pkg-1.21.9-1.0.6-neoforge" = _3576GMhn;
        "pkg-1.21.9-1.0.6-forge" = _HH8hTtOQ;
        "pkg-1.21.10-1.0.6-fabric" = _bm4IAZS9;
        "pkg-1.21.10-1.0.6-forge" = _loTXqgiw;
        "pkg-1.21.10-1.0.6-neoforge" = _GVJYGmiw;
        "pkg-1.21.11-1.0.6-fabric" = _vNdNCEO0;
        "pkg-1.21.11-1.0.6-forge" = _FUIc9bLM;
        "pkg-1.21.11-1.0.6-neoforge" = _9aMRZABU;
        "pkg-26.1.2-1.0.6-fabric" = _4mYGT5dx;
        "pkg-26.1.2-1.0.6-neoforge" = _1PbTsINN;
        "pkg-26.1.2-1.0.6-forge" = _VcPWXhQ3;
        "pkg-26.1.2-1.0.7-fabric" = _s7x1N7mk;
        "pkg-26.1.2-1.0.7-forge" = _zrCP5Mvi;
        "pkg-26.1.2-1.0.7-neoforge" = _rUbISYdI;
        "pkg-1.20.1-1.0.8-fabric" = _HyxwWUqr;
        "pkg-1.20.1-1.0.8-forge" = _nCXMBKPG;
        "pkg-1.21.1-1.0.8-fabric" = _5mVtA9Jc;
        "pkg-1.21.1-1.0.8-forge" = _BVNBXCaL;
        "pkg-1.21.1-1.0.8-neoforge" = _jqXGhTek;
        "pkg-1.21.11-1.0.8-fabric" = _L1xhTYi0;
        "pkg-1.21.11-1.0.8-forge" = _5U75Uz43;
        "pkg-1.21.11-1.0.8-neoforge" = _CeeW6HSx;
        "pkg-26.1.2-1.0.8-fabric" = _rvT04wYS;
        "pkg-26.1.2-1.0.8-forge" = _SMvrD1aU;
        "pkg-26.1.2-1.0.8-neoforge" = _7Z1dNugz;
