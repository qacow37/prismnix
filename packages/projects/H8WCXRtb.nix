...
let
    ...
    in {
        ...
        "pkg-1.19.4-v1.0.0" = _O4WmlVNu;
        "pkg-1.19.4-v1.0.1" = _ecU7Oc9X;
        "pkg-1.19.4-v1.1.0" = _PJJedGWI;
        "pkg-1.19.4-v1.1.1" = _88410SXV;
        "pkg-1.19.4-v1.2.0" = _5LoFdNbY;
        "pkg-1.19.4-v1.2.1" = _xI36Durp;
        "pkg-1.19.4-v1.2.2" = _JRDUvgby;
        "pkg-1.19.4-v1.3.0" = _hEgfLh47;
        "pkg-1.19.4-v1.3.1" = _ruCoPmnZ;
        "pkg-v1.3.1+1.19-1.19.2" = _IK4X768B;
        "pkg-v1.3.2+1.19.3-1.19.4" = _IxcnoGO7;
        "pkg-v1.3.3+1.19.3-1.19.4" = _9nQJtona;
        "pkg-v1.3.3+1.20" = _kiep4Hbx;
        "pkg-v1.3.4+1.20" = _9qQVwety;
        "pkg-v1.3.4+1.20-1.20.1" = _h5svnMRK;
        "pkg-v1.3.5+1.20-1.20.1" = _EjLsm64S;
        "pkg-1.3.6+1.20-1.20.1" = _WEehl9q9;
        "pkg-1.3.6+1.19.4" = _Dg8X6RUD;
        "pkg-1.3.7+1.20-1.20.1" = _5jyDYeTD;
        "pkg-1.3.7+1.19.4" = _P7HlNdVD;
        "pkg-1.3.8+1.20-1.20.1" = _wkBiZKF2;
        "pkg-1.3.8+1.19.4" = _TlSEy1u6;
        "pkg-1.3.8+1.19.2" = _ECT8z3s5;
        "pkg-1.3.9+1.20-1.20.1" = _h3vDqfbN;
        "pkg-1.3.9+1.19.4" = _Ao2f5HTR;
        "pkg-1.3.9+1.19.2" = _Na5Cw0XG;
        "pkg-1.3.10+1.20-1.20.1" = _7cFLqTUV;
        "pkg-1.3.10+1.19.4" = _LJsaqXC6;
        "pkg-1.3.11+1.20-1.20.1" = _Rmfca8cD;
        "pkg-1.3.11+1.19.4" = _N0vHY3jt;
        "pkg-1.3.12+1.20-1.20.1" = _W6JBlMjr;
        "pkg-1.3.12+1.19.4" = _KURZ9UbV;
        "pkg-1.3.13+1.20-1.20.1" = _Ory02Iuw;
        "pkg-1.3.14+1.20-1.20.1" = _dthUez7W;
        "pkg-1.3.14+1.19.4" = _fPUBhSQC;
        "pkg-1.3.15+1.20-1.20.1" = _JJaO0mgR;
        "pkg-1.3.15+1.19.4" = _g8Xfu8kF;
        "pkg-1.4.0+1.20-1.20.1" = _ZH8my6ML;
        "pkg-1.4.0+1.20-1.20.2" = _5JPXfYhB;
        "pkg-1.4.1+1.20-1.20.2" = _GzWdl5Sn;
        "pkg-1.4.2+1.20-1.20.2" = _CujOW56t;
        "pkg-1.4.2+23w41a" = _1A4YF7nX;
        "pkg-1.4.3+1.20-1.20.2" = _B0SeAsF8;
        "pkg-1.4.4+23w42a" = _tD7FrMXW;
        "pkg-1.4.4+1.20-1.20.2" = _KU3sRUCo;
        "pkg-1.4.4+23w43a" = _9nZCCOWO;
        "pkg-s1.4.4+23w43b" = _bd29H5NP;
        "pkg-s1.4.4+23w44a" = _krceG2yr;
        "pkg-s1.4.4+23w45a" = _s51bMCtF;
        "pkg-s1.4.4+23w46a" = _5SAlcgSB;
        "pkg-1.5.0+1.20-1.20.2" = _WLlQEhNi;
        "pkg-1.5.1+1.20-1.20.2" = _eDq2Nl9h;
        "pkg-s1.5.1+1.20.3-pre1" = _IRt5PiWh;
        "pkg-v1.5.2+1.20-1.20.2" = _wyDnwnQs;
        "pkg-1.5.3+1.20-1.20.2" = _EcJXIECx;
        "pkg-a1.6.0.0+1.20.2" = _m5h9boXJ;
        "pkg-v1.5.4+1.20.1" = _qkcnI6pD;
        "pkg-1.5.4+1.20.2" = _Xt8Kzmn4;
        "pkg-1.5.4+1.20.3" = _Pasg6UCz;
        "pkg-1.5.4+1.20.3-1.20.4" = _U6D4GzJu;
        "pkg-1.5.5+1.20.1" = _48PVFAVq;
        "pkg-1.5.5+1.20.2" = _TeHG4RfB;
        "pkg-1.5.5+1.20.3-1.20.4" = _M7QTT3ym;
        "pkg-1.6.0+1.20.1" = _6hCIvuzV;
        "pkg-1.6.0+1.20.2" = _zSpg1kP6;
        "pkg-1.6.0+1.20.3-1.20.4" = _SJSzvQ3v;
        "pkg-1.6.1+1.20.1" = _DvPrnxqv;
        "pkg-1.6.1+1.20.2" = _5afwXmrA;
        "pkg-1.6.1+1.20.3-1.20.4" = _dZpTOv0l;
        "pkg-1.6.2+1.20.1" = _U9lY8sRU;
        "pkg-1.6.2+1.20.2" = _YJLmfSa3;
        "pkg-1.6.2+1.20.3-1.20.4" = _oqK1SaRR;
        "pkg-1.6.3+1.20.1" = _qSd5VKay;
        "pkg-1.6.3+1.20.2" = _lhmy18a4;
        "pkg-1.6.3+1.20.3-1.20.4" = _eQftwetw;
        "pkg-1.6.5+1.20.1" = _3F9MLTBP;
        "pkg-1.6.5+1.20.2" = _oLBdduBs;
        "pkg-1.6.5+1.20.3-1.20.4" = _gpBXMzVa;
        "pkg-1.6.6+1.20.1" = _7ACkm90G;
        "pkg-1.6.6+1.20.2" = _b2861yeL;
        "pkg-1.6.6+1.20.3-1.20.4" = _m9GnKsxT;
        "pkg-1.6.7+1.20.1" = _jhVeWV7r;
        "pkg-1.6.7+1.20.2" = _ydqmZbb9;
        "pkg-1.6.7+1.20.3-1.20.4" = _E4Hgzqai;
        "pkg-s1.6.7+23w09a" = _5JoQvvdi;
        "pkg-1.6.8+1.20.1" = _aiOyqhpE;
        "pkg-1.6.8+1.20.2" = _7NRGtp2P;
        "pkg-1.6.8+1.20.3-1.20.4" = _Kyt5QGiQ;
        "pkg-1.6.9+1.20.1" = _PVdo11uC;
        "pkg-1.6.9+1.20.2" = _UpZHP78U;
        "pkg-1.6.9+1.20.3-1.20.4" = _TN56c6ax;
        "pkg-1.6.9+1.20.5" = _YL77Q0qQ;
        "pkg-1.6.10+1.20.6" = _87YLDUzB;
        "pkg-1.6.10+1.20.4" = _eiNjva14;
        "pkg-1.6.10+1.20.1" = _YiKf82cX;
        "pkg-1.7.0+1.20.1" = _bvQoqWOd;
        "pkg-1.7.0+1.20.4" = _MmummF1a;
        "pkg-1.7.0+1.20.6" = _cNWJDR44;
        "pkg-1.7.1+1.20.1" = _uZbLxOZx;
        "pkg-1.7.1+1.20.4" = _T2fNEVos;
        "pkg-1.7.1+1.20.6" = _FLOJEiNa;
        "pkg-1.7.1+1.21" = _rAFMtu8G;
        "pkg-1.7.2+1.21" = _Ya35NEei;
        "pkg-1.7.2+1.20.6" = _cTlSVb6S;
        "pkg-1.7.3+1.21-1.21.1" = _SEOS3AOy;
        "pkg-1.7.2+1.20.4" = _mAFeKoXC;
        "pkg-1.7.2+1.20.1" = _2yD4NOHT;
        "pkg-1.7.4+1.21-1.21.1" = _GSyrywLo;
        "pkg-1.7.4+1.20.6" = _fXyN5zpM;
        "pkg-1.7.4+1.20.4" = _x6TAM3Ou;
        "pkg-1.7.4+1.20.1" = _IxkCauHU;
        "pkg-1.7.4+1.21.2" = _ku1lqdvE;
        "pkg-1.7.4+1.21.3" = _eqjtd6uO;
        "pkg-1.7.5+1.21.3" = _C5hOlinR;
        "pkg-1.7.5+1.21-1.21.1" = _wxgml1eB;
        "pkg-1.7.5+1.20.6" = _uE5hsVHd;
        "pkg-1.7.5+1.21.4" = _bas2qfg5;
        "pkg-1.8.0+1.21.4" = _ww7MjPyB;
        "pkg-1.8.0+1.21.5-pre2-1.21.5" = _UVVwJHtJ;
        "pkg-1.8.0.1+1.21.4" = _AWBDllt4;
        "pkg-1.8.0.1+1.21.3" = _iQm2knYt;
        "pkg-1.8.0.1+1.21-1.21.1" = _s4FZRaQP;
        "pkg-1.8.0.2+1.21.4" = _58FH3BE9;
        "pkg-1.8.0.2+1.21.3" = _wLehXPnP;
        "pkg-1.8.0.2+1.21-1.21.1" = _H8oL8XmY;
        "pkg-1.8.0.2+1.20.6" = _n7Tcv5Ka;
        "pkg-1.8.0.2+1.20.4" = _ww9brCA2;
        "pkg-1.8.0.2+1.20.1" = _xPRkAfNZ;
        "pkg-1.8.0.3+1.21.4" = _IWjRgJJu;
        "pkg-1.8.0.3+1.20-1.21.4" = _HLZpgWlK;
        "pkg-1.8.0.3+1.21.5" = _UtuNo7an;
        "pkg-1.8.0.4+1.21.5" = _kQKoWZK5;
        "pkg-1.8.0.5+1.21.5" = _4cvULl3u;
        "pkg-1.8.0.5+1.20-1.21.5" = _iIDEHBvs;
        "pkg-1.8.0.5+1.21.4" = _s3a8f3Tc;
        "pkg-1.8.0.5+1.21.3" = _Mrgyb9kM;
        "pkg-1.8.0.5+1.21-1.21.1" = _E02ymdlI;
        "pkg-1.8.0.5+1.20.6" = _7FQbWDwg;
        "pkg-1.8.0.5+1.20.4" = _4gwzofcL;
        "pkg-1.8.0.5+1.20.1" = _xHhSifPw;
        "pkg-1.8.0.6+1.20-1.21.5" = _CPDApIG4;
        "pkg-1.8.0.6+1.21.5" = _qs5ltaq4;
        "pkg-1.8.0.7+1.20-1.21.5" = _KOaLvReC;
        "pkg-1.8.0.7+1.21.5" = _WoKlh0dB;
        "pkg-1.8.0.7+1.21.4" = _9k8tmY01;
        "pkg-1.8.0.7+1.21-1.21.1" = _TSTLf1ml;
        "pkg-1.8.1.0.0+1.21.5" = _Mfmp6oDI;
        "pkg-1.8.1.0+1.21.6" = _7BGy5e9w;
        "pkg-1.8.1.0+1.21.5" = _ycDzcSov;
        "pkg-1.8.1.1+1.21.6" = _oYzYqEED;
        "pkg-1.8.1.1+1.21.5" = _TLyrRSWl;
        "pkg-1.8.1.1+1.21.4" = _5NUIMoCA;
        "pkg-1.8.1.1+1.21-1.21.1" = _9T3WMoTv;
        "pkg-1.8.1.2+1.21.6" = _WbrrwMSP;
        "pkg-1.8.1.2+1.20-1.21.6" = _ogO0Jr6a;
        "pkg-1.8.1.2+1.21.5" = _MGy283qe;
        "pkg-1.8.1.2+1.21.4" = _IWDF5QZY;
        "pkg-1.8.1.2+1.21-1.21.1" = _N45bOf9i;
        "pkg-1.8.1.2+1.20.6" = _nh2eoQ4U;
        "pkg-1.8.1.2+1.20.4" = _mljSz3Bc;
        "pkg-1.8.1.2+1.20.1" = _bOuNpHQd;
        "pkg-1.8.1.2+1.21.7" = _4CSu35X0;
        "pkg-1.8.1.2+1.20-1.21.7" = _wiBA6BGb;
        "pkg-1.8.1.2+1.21.8" = _wGgU200S;
        "pkg-1.8.1.3+1.21.8" = _ZYPGh05f;
        "pkg-1.8.1.3+1.20-1.21.8" = _WcW39GIr;
        "pkg-1.8.2.0+1.21.8" = _3xVPZfNX;
        "pkg-1.8.2.0+1.20-1.21.8" = _WxPfakYM;
        "pkg-1.8.2.0+1.21.5" = _LGf0Oz9h;
        "pkg-1.8.2.0+1.21.4" = _Bnjxa2JA;
        "pkg-1.8.2.0+1.21.1" = _skQsQRkz;
        "pkg-1.8.2.0+1.21.9-1.21.10" = _blKInQao;
        "pkg-1.8.2.1+1.21.10" = _y0iuwWJb;
        "pkg-1.8.2.1+1.20-1.21.10" = _rE0bURmF;
        "pkg-1.8.2.1+1.21.8" = _8QrNtZHI;
        "pkg-1.8.2.1+1.21.4" = _Hgdpin5H;
        "pkg-1.8.2.1+1.21.1" = _WMIQYj6m;
        "pkg-1.8.2.1+1.21.11" = _dcQtQQvg;
        "pkg-1.8.2.2+1.20-1.21.11" = _HYe37xyh;
        "pkg-1.8.2.2+1.21.11" = _bAgSSBYH;
        "pkg-1.8.2.3+1.21.11" = _cIZocyKE;
        "pkg-1.8.2.4+1.21.11" = _hCKypENp;
        "pkg-1.8.3.0+26.1" = _YqObASqc;
        "pkg-1.8.3.1+26.1" = _yQIfbyqa;
        "pkg-1.8.3.1+26.1.1" = _t44Y18BN;
        "pkg-1.8.3.2+26.1" = _z5vSR57l;
