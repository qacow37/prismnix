...
let
    ...
    in {
        ...
        "pkg-1.5_01.4" = _dhvF5J3B;
        "pkg-1.6.5.1" = _JJEf47nA;
        "pkg-1.6.6.1" = _bIBL5X2m;
        "pkg-1.6.6.2" = _4WUK1fEq;
        "pkg-1.6.6.3" = _crbnlwiC;
        "pkg-1.6.6.4" = _TRgNP6eY;
        "pkg-1.7.2.1" = _OJssDuIu;
        "pkg-1.7.3.1" = _4JsE7uTU;
        "pkg-1.7.3.2" = _BqPCDDKe;
        "pkg-1.7.3.3" = _h9iZPy1C;
        "pkg-1.7.3.4" = _isCwxb9j;
        "pkg-1.8.1.1" = _V6lQ37hb;
        "pkg-2.0.1" = _bTfiN7GH;
        "pkg-2.1.0" = _psfgvuM1;
        "pkg-2.1.1" = _KVZwO5vV;
        "pkg-2.2.0" = _gc9APXjh;
        ...
        "pkg-2.2.8" = _NJ4Y9dxl;
        "pkg-2.2.9" = _S8Vy6MP2;
        "pkg-2.2.10" = _v7lYfJZs;
        "pkg-2.2.11" = _MmQZZeRG;
        "pkg-2.2.12" = _VGfO5iQj;
        "pkg-2.2.13" = _8sQ9ujWn;
        "pkg-2.2.14" = _e2KIFsll;
        "pkg-3.0.0" = _5k39EjAw;
        "pkg-3.0.1" = _c3bAJomJ;
        "pkg-3.0.2" = _gWMyAIxt;
        "pkg-3.0.3" = _4FAwiX8c;
        ...
        "pkg-7.0.8" = _5Eyyizbg;
        "pkg-7.0.9" = _SdRTayVP;
        "pkg-7.0.10" = _mUxxsgFJ;
        "pkg-7.0.11" = _DBQNxHJw;
        "pkg-7.0.12" = _yYqNWzxZ;
        "pkg-7.0.13" = _k1sY5oJW;
        "pkg-7.0.14" = _83SrXsVU;
        "pkg-7.0.15" = _D0fAtlz0;
        "pkg-7.0.16" = _hkYHjLai;
        "pkg-7.0.17" = _aQwEMqXp;
        "pkg-7.0.18" = _xOBP3NcD;
        "pkg-7.0.19" = _K7JxEpHN;
        "pkg-7.0.20" = _jY8FLcgf;
        "pkg-7.0.21" = _fCQjiP7y;
        "pkg-7.0.22" = _VLJMjWCU;
        "pkg-7.0.23" = _EMMvGop3;
        "pkg-7.0.25" = _M7ix16hx;
        "pkg-7.0.26" = _zffoTasu;
        "pkg-7.1.0" = _wS9jfgsw;
        "pkg-7.1.1" = _FVaRKZDR;
        "pkg-7.1.2" = _gPy1l0s5;
        "pkg-7.1.3" = _f8my4u3q;
        ...
        "pkg-7.1.8" = _WmqXzcQ7;
        "pkg-7.1.9" = _6ouaGtVO;
        "pkg-7.1.10" = _7Kp9Ss0H;
        "pkg-7.1.11" = _l9V7QyqT;
        "pkg-7.1.12" = _1NkFTVTg;
        "pkg-7.1.13" = _V3f318D8;
        "pkg-7.1.14" = _xMfYNmpd;
        "pkg-7.1.15" = _QYGKZfuU;
        "pkg-7.1.16" = _MrOFK3uX;
        "pkg-7.1.17" = _a4G550Gb;
        "pkg-7.1.18" = _wZe1Oe03;
        "pkg-7.1.19" = _jkQC2GwI;
        "pkg-7.1.20" = _aLeVkrwM;
        "pkg-7.2.0" = _HFGRY3pr;
        "pkg-7.2.1" = _XEw79VDC;
        "pkg-7.2.2" = _EzUUmXUs;
        "pkg-7.2.3" = _cZ9pGk3w;
        ...
        "pkg-7.2.7" = _ROJv8blV;
        "pkg-7.2.8" = _ggGUHfjq;
        "pkg-7.1.21" = _8xk2JJS2;
        "pkg-7.1.22" = _OWUzmTmo;
        "pkg-7.1.23" = _69NL4bFp;
        "pkg-7.1.24" = _HpmyJGuf;
        "pkg-7.1.25" = _S2d1nFLM;
        "pkg-7.1.26" = _uhNp32pz;
        "pkg-7.99.5" = _UGR6fySW;
        "pkg-7.99.6" = _YyGVS3wb;
        "pkg-7.99.7" = _GcQBaosx;
        "pkg-7.99.8" = _xuqOoEsR;
        "pkg-7.99.8.1" = _uhLPCqQp;
        "pkg-7.99.8.2" = _mG3e6Axd;
        "pkg-7.99.12" = _t1yX8NLW;
        "pkg-7.99.13" = _hV8mPxNv;
        "pkg-7.99.14" = _WEr6K3bK;
        "pkg-7.99.15" = _MiMRYscd;
        "pkg-7.99.16" = _FJRCNrjb;
        "pkg-7.99.17" = _E610a7ul;
        "pkg-7.99.18" = _6HCKBE11;
        "pkg-7.99.19" = _VLUvCj1R;
        "pkg-7.99.20" = _bJGLucdf;
        "pkg-7.99.21" = _l12V0RO7;
        "pkg-7.99.22" = _KNBfUGuW;
        "pkg-7.99.23" = _fcBT154v;
        "pkg-7.99.24" = _Ktpwp5Wr;
        "pkg-7.99.24.1" = _H47nlF2i;
        "pkg-7.99.24.2" = _kiFdzhup;
        "pkg-7.99.24.3" = _O9LKn3P8;
        "pkg-7.99.24.4" = _3hwd4YLc;
        "pkg-7.99.24.5" = _37Cy0BY6;
        "pkg-7.99.24.6" = _n71bjNmx;
        "pkg-7.99.24.7" = _f20Ywll9;
        "pkg-7.99.24.8" = _9z6jfCsz;
        "pkg-7.1.27" = _sV9cH15x;
        "pkg-8.0.0" = _JogqttJb;
        "default" = _JogqttJb;
    });
