...
let
    ...
    in {
        ...
        "pkg-3.27.1-build.35" = _GFV9QHNO;
        "pkg-3.27.1-build.36" = _uDjoL6Xb;
        "pkg-3.27.2-build.41" = _gaCZZATc;
        "pkg-3.27.2-build.8" = _daPjOqSg;
        "pkg-3.27.2-build.42" = _AThqK6yZ;
        "pkg-3.27.2-build.43" = _4Bt6JB7D;
        "pkg-3.27.2-build.44" = _F7kFKJNE;
        "pkg-3.27.3-build.48" = _z1OqfC9X;
        "pkg-3.27.3-build.49" = _GcHZmBJs;
        "pkg-3.27.3-build.50" = _Dm5bzqQk;
        "pkg-3.27.3-build.51" = _3oxLYdWj;
        "pkg-3.27.3-build.52" = _fdPuT0wM;
        "pkg-3.27.3-build.53" = _eSmPNy7h;
        "pkg-3.27.3-build.54" = _2e00T5L8;
        "pkg-3.27.3-build.55" = _Kfi5s6f3;
        "pkg-3.27.3-build.56" = _vHa177cn;
        "pkg-3.27.3-build.57" = _55SoPHdK;
        "pkg-3.27.3-build.58" = _tWsCFKuf;
        "pkg-3.27.3-build.59" = _F3ek7EFV;
        "pkg-3.27.3-build.60" = _paE397tq;
        "pkg-3.27.3-build.63" = _o2WrkQcd;
        "pkg-3.27.3-build.64" = _PtxYtTvJ;
        "pkg-3.27.3-build.65" = _BxnVJ4OY;
        "pkg-3.27.3-build.66" = _wDU4sQ0E;
        "pkg-3.27.3-build.67" = _3LRHAcgj;
        "pkg-3.27.3-build.68" = _QFGq4Mkw;
        "pkg-1.0.0-rc.6-build.81" = _HH6VkZWh;
        "pkg-1.0.0-rc.6-SNAPSHOT" = _DORvSnTu;
        "pkg-1.0.0-rc.8-SNAPSHOT-build.92" = _qLo8sAok;
        "pkg-1.0.0-rc.8-SNAPSHOT-build.95" = _cgqcKprB;
        "pkg-1.1.1-b132" = _D229hIZ3;
        "pkg-1.1.1-b133" = _8mGhplEO;
        "pkg-1.1.1-b6" = _2wgyjdlz;
        "pkg-1.1.2-b135" = _Il7cwRtz;
        "pkg-1.1.2-b137" = _sDmQkPZv;
        "pkg-1.1.2-b139" = _IHFiUd8d;
        "pkg-1.1.2-b140" = _czFULxYs;
        "pkg-1.2.0-b141" = _C8jJMjBd;
        "pkg-1.2.0-b142" = _J0wwg0TF;
        "pkg-1.2.0-b143" = _XDZbfm1k;
        "pkg-1.2.0-b144" = _PXWHjBQ3;
        "pkg-1.2.0-b145" = _uTTsRDGG;
        "pkg-1.2.0-b146" = _ILgkGcI3;
        "pkg-1.2.0-b13" = _HO2IOcFM;
        "pkg-1.2.1-b148" = _ktv4X2Dj;
        "pkg-1.2.1-b149" = _8M1ENqMf;
        "pkg-1.2.1-b150" = _oJlzUnxz;
        "pkg-1.2.1-b151" = _aIhZtzmW;
        "pkg-1.2.1-b152" = _mkWtm4fk;
        "pkg-1.2.1-b153" = _uWb68WWP;
        "pkg-1.2.1-b14" = _5MAGJIjG;
        "pkg-1.2.2-b154" = _KRcavUAD;
        "pkg-1.3.0-b155" = _j626fA0u;
        "pkg-1.3.0-b15" = _giImwDho;
        "pkg-1.3.1-b156" = _cr3tmzy6;
        "pkg-1.3.1-b159" = _qAe9QDtS;
        "pkg-1.3.1-b160" = _kSqugY83;
        "pkg-1.3.1-b161" = _8niZ7O5h;
        "pkg-1.3.1-b163" = _3zyg3DmI;
        "pkg-1.4.0-b17" = _2bjZ5MFl;
        "pkg-1.4.1-b164" = _ysbrh4u4;
        "pkg-1.4.1-b165" = _cIy2BU6K;
        "pkg-1.4.1-b166" = _mGx8k79r;
        "pkg-1.4.1-b167" = _7IVzfK4j;
        "pkg-1.4.1-b168" = _baNUghRv;
        "pkg-1.4.1-b169" = _tR7I6XxM;
        "pkg-1.4.1-b170" = _yu2wi7KJ;
        "pkg-1.4.1-b171" = _7FibwccL;
        "pkg-1.4.1-b172" = _m6GlkNUr;
        "pkg-1.4.1-b173" = _iaPyEx7f;
        "pkg-1.4.1-b174" = _9A281n1O;
        "pkg-1.4.1-b175" = _q6cS4w0I;
        "pkg-1.5.0-b181" = _6l1iguCG;
        "pkg-1.5.0-b182" = _CkAZxuyM;
        "pkg-1.5.0-b183" = _MyEtzsRy;
        "pkg-1.5.0-b184" = _c9ACVvHF;
        "pkg-1.5.0-b185" = _FTxX8Fqy;
        "pkg-1.5.0-b186" = _s8cMNbAg;
        "pkg-1.5.0-b187" = _5uyhjQZ6;
        "pkg-1.5.0-b188" = _WcJLRh1j;
        "pkg-1.5.0-b189" = _8HFcOiYI;
        "pkg-1.5.0-b190" = _SQb93FFm;
        "pkg-1.5.0-b191" = _2fdT6Kb0;
        "pkg-1.5.0-b192" = _xVvTOfoN;
        "pkg-1.5.0-b193" = _Q3blKXjc;
        "pkg-1.5.0-b194" = _lmsTEnxK;
        "pkg-1.5.0-b195" = _aXmamxxv;
        "pkg-1.5.0-b196" = _IftbV6UK;
        "pkg-1.5.0-b197" = _ftdz1jZ2;
        "pkg-1.5.0-b18" = _JYoaqzYg;
        "pkg-1.5.0-b198" = _bKobURp4;
        "pkg-1.5.0-b199" = _szWo5erg;
        "pkg-1.5.0-b200" = _yb07p9KJ;
        "pkg-1.5.1-b201" = _SuJXoJLb;
        "pkg-1.5.1-b202" = _pdiJUGPv;
        "pkg-1.5.1-b203" = _O0b1hiNE;
        "pkg-1.5.1-b19" = _xaZMUYkQ;
        "pkg-1.5.2-b20" = _UMgFFMAc;
        "pkg-1.5.3-b205" = _bWElPmKp;
        "pkg-1.5.3-b21" = _O9144gOc;
        "pkg-1.5.4-b206" = _EQPgvvnE;
        "pkg-1.5.4-b207" = _aEcY9tAC;
        "pkg-1.5.4-b208" = _3gIX48NT;
        "pkg-1.5.4-b209" = _tXaQr6ne;
        "pkg-1.5.4-b22" = _Afys8Bi8;
        "pkg-1.5.4-b210" = _fSI0sJrs;
        "pkg-1.5.5-b212" = _sUnc1Yp6;
        "pkg-1.5.5-b213" = _FWVHttF3;
        "pkg-1.5.5-b214" = _caVh4Ozf;
        "pkg-1.5.5-b215" = _RMZoRiJA;
        "pkg-1.5.5-b216" = _uAy05ShQ;
        "pkg-1.6.0-b23" = _p1gHGvx6;
        "pkg-1.6.1-b217" = _O1rsuAH2;
        "pkg-1.6.1-b218" = _ErXwDVQr;
        "pkg-1.6.1-b24" = _iEJR59kf;
        "pkg-1.6.2-b219" = _W2eH1Yt7;
        "pkg-1.6.2-b220" = _as60p6Z8;
        "pkg-1.6.2-b221" = _E2gfTtWM;
        "pkg-1.6.2-b222" = _irCczBU8;
        "pkg-1.6.2-b223" = _qmBGUfkS;
        "pkg-1.6.2-b224" = _iGnHdh0p;
        "pkg-1.6.2-b225" = _Cj497gp3;
        "pkg-1.6.2-b226" = _aU3tc9MT;
        "pkg-1.6.2-b227" = _nhGmUnlB;
        "pkg-1.6.2-b25" = _FWg3z2qQ;
        "pkg-1.6.3-b229" = _ZPSVyBQX;
        "pkg-1.6.3-b26" = _pih0El9R;
        "pkg-1.6.4-b29" = _NGotd91d;
        "pkg-1.6.4-b230" = _8TSbGrOp;
        "pkg-1.6.4-b232" = _PX5crnpd;
        "pkg-1.6.5-b233" = _b3nztwnK;
        "pkg-1.6.5-b234" = _AErV4Dv2;
        "pkg-1.6.5-b235" = _PauWPTWd;
        "pkg-1.6.5-b236" = _JbRhxsOz;
        "pkg-1.6.5-b237" = _VamXhyFZ;
        "pkg-1.6.5-b238" = _pXuzHBOf;
        "pkg-1.6.5-b239" = _MJUKtzZ9;
        "pkg-1.6.5-b241" = _RjolxNJJ;
        "pkg-1.6.5-b242" = _26CCsqb4;
        "pkg-1.6.5-b30" = _7TVgXrvE;
        "pkg-1.6.6-b243" = _nP8Xv4qL;
        "pkg-1.6.6-b244" = _OL0MYTVa;
        "pkg-1.6.6-b245" = _kzXhiAJM;
        "pkg-1.6.6-b246" = _rG8hJbPh;
        "pkg-1.6.6-b247" = _IQ1kKBpZ;
        "pkg-1.6.6-b248" = _b1fSxmYh;
        "pkg-1.6.6-b250" = _a1vnEPDC;
        "pkg-1.6.6-b254" = _Xrt2hk6L;
        "pkg-1.6.6-b255" = _l367epV7;
        "pkg-1.6.6-b256" = _Opa82E8I;
        "pkg-1.6.6-b257" = _umyafbvl;
        "pkg-1.7.0-b258" = _Gi0Ch7B6;
        "pkg-1.7.0-b259" = _JziLwC7k;
        "pkg-1.7.0-b262" = _2HsS3lc9;
        "pkg-1.7.0-b263" = _uEQDl5as;
        "pkg-1.7.0-b265" = _4eQMLpTm;
        "pkg-1.7.0-b266" = _xxR7pLHW;
        "pkg-1.7.0-b267" = _KA9FBCSz;
        "pkg-1.7.0-b269" = _WeA5Leyf;
        "pkg-1.7.0-b270" = _5RVZE1H1;
        "pkg-1.7.0-b271" = _Si8n2Ab6;
        "pkg-1.7.0-b276" = _zTRJ5lbG;
        "pkg-1.7.0-b280" = _rqbHtWhA;
        "pkg-1.7.0-b281" = _ZyFcSASo;
        "pkg-1.7.0-b282" = _YCj4BhHT;
        "pkg-1.7.0-b283" = _erz0XCB4;
        "pkg-1.7.0-b284" = _MOUBEYwy;
        "pkg-1.7.0-b285" = _hM3FeNnM;
        "pkg-1.7.0-b286" = _K2TQJfEr;
        "pkg-1.7.0-b287" = _MPCH2ftv;
        "pkg-1.7.1-b289" = _np10Pkc4;
        "pkg-1.7.1-b290" = _lAv1ohF1;
        "pkg-1.7.1-b31" = _KAm4Ez32;
        "pkg-1.7.2-b291" = _doy3tiNM;
        "pkg-1.7.2-b32" = _vksiS6em;
        "default" = _vksiS6em;
    });
