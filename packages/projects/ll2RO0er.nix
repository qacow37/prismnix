...
let
    ...
    in {
        ...
        "pkg-v8.0.0-1.20.1-Forge" = _4UYnpr7q;
        "pkg-v8.0.0-1.20.1-Fabric" = _9dm5uSJb;
        "pkg-v8.1.0-1.20.1-Forge" = _BIS851xn;
        "pkg-v4.0.1-1.19.2-Forge" = _Jw1Isjzl;
        "pkg-v8.1.1-1.20.1-Fabric" = _4mmZ06Sp;
        "pkg-v8.1.1-1.20.1-Forge" = _635sirHK;
        "pkg-v8.1.2-1.20.1-Forge" = _PNYRRf95;
        "pkg-v8.1.2-1.20.1-Fabric" = _ypQH5sQj;
        "pkg-v8.1.3-1.20.1-Forge" = _T9GZPSCQ;
        "pkg-v8.1.3-1.20.1-Fabric" = _ZUeMLk8t;
        "pkg-v8.1.5-1.20.1-Forge" = _Phzyg7km;
        "pkg-v8.1.5-1.20.1-Fabric" = _FEiYWKBt;
        "pkg-v20.4.0-1.20.4-Fabric" = _dHcmYEn1;
        "pkg-v20.4.0-1.20.4-NeoForge" = _zFjaiYAo;
        "pkg-v20.4.0-1.20.4-Forge" = _M7PwZ3qK;
        "pkg-v20.4.1-1.20.4-Fabric" = _K4BjbHSZ;
        "pkg-v20.4.1-1.20.4-Forge" = _pdkXdGJr;
        "pkg-v20.4.1-1.20.4-NeoForge" = _OQadEugo;
        "pkg-v20.4.2-1.20.4-Fabric" = _yt2NZQCk;
        "pkg-v20.4.2-1.20.4-Forge" = _nieoKXLC;
        "pkg-v20.4.2-1.20.4-NeoForge" = _LbkbeXoP;
        "pkg-v8.1.6-1.20.1-Forge" = _lVZIkuVD;
        "pkg-v8.1.6-1.20.1-Fabric" = _SfBk9wd0;
        "pkg-v8.1.7-1.20.1-Forge" = _XOOZYqAf;
        "pkg-v8.1.7-1.20.1-Fabric" = _bsXQ422o;
        "default" = _bsXQ422o;
    });
