...
let
    ...
    in {
        ...
        "pkg-9.2.1" = _zTpJR7I2;
        "pkg-9.3.0" = _ZFt7g1FK;
        "pkg-10.0.0" = _IJ1m6ZmY;
        "pkg-10.1.0" = _lfSWjXAB;
        "pkg-10.1.1" = _6V5EVObG;
        "pkg-11.0.0" = _Zd6zrbWd;
        "pkg-11.1.0" = _O3P9d9Nj;
        "pkg-11.2.0" = _zms0XJM3;
        "pkg-11.3.0" = _eGf6paLl;
        "pkg-11.4.0" = _ylS98f0n;
        "pkg-11.5.0" = _yvDBboPJ;
        "pkg-11.5.1" = _TFXE7amO;
        "pkg-11.5.2" = _tT1q9uYs;
        "pkg-11.5.3" = _yfVmIlyI;
        "pkg-11.5.4" = _wbTi7IIi;
        "pkg-11.5.5" = _wxhXeJVw;
        "pkg-11.6.0" = _M4UHVBWO;
        "pkg-11.6.1" = _Lcsn21cX;
        "pkg-11.6.2" = _OBXOE3b7;
        "pkg-11.7.0" = _I7jxlPdH;
        "pkg-11.8.0" = _jsUHFc9q;
        "pkg-11.8.1" = _kPIb8P3M;
        "pkg-11.8.2" = _6hxLEJig;
        "pkg-11.8.4" = _vavzx642;
        "pkg-11.8.6" = _zs8lWwAm;
        "pkg-12.0.0" = _jMNOOra6;
        "pkg-12.1.0" = _hTov8xbh;
        "pkg-12.1.1" = _8XC6YR1h;
        "pkg-12.2.0" = _EV5Dlnry;
        "pkg-12.3.0" = _TJztpyJl;
