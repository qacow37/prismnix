...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.8-fabric" = _ZJhMynQ6;
        "pkg-1.18.2-1.8-fabric" = _Xj05PGIS;
        "pkg-1.19.2-1.9-fabric" = _vhC8sdTF;
        "pkg-1.16.5-1.4-forge" = _zs49r2BS;
        "pkg-1.18.2-1.5-forge" = _dE1F4pnI;
        "pkg-1.19.2-1.7-forge" = _MYOiSZgi;
        "pkg-1.16.5-2.0-fabric" = _Zvy4Ztk5;
        "pkg-1.18.2-2.0-fabric" = _Ls6hLB7R;
        "pkg-1.19.2-2.0-fabric" = _AxYRtdj2;
        "pkg-1.19.3-2.1-fabric" = _gjm5DuaY;
        "pkg-1.19.3-1.7-forge" = _cef33jo9;
        "pkg-1.18.2-3.0-forge+fabric" = _7UiEmNJc;
        "pkg-1.19.2-3.0-forge+fabric" = _ZnYdjEMN;
        "pkg-1.19.3-3.0-forge+fabric" = _GeQC3hP3;
        "pkg-1.18.2-3.1-forge+fabric" = _1jtsWoPo;
        "pkg-1.19.2-3.1-forge+fabric" = _rJH2MW2v;
        "pkg-1.19.3-3.1-forge+fabric" = _ui2NboHq;
        "pkg-1.18.2-3.2-forge+fabric" = _cRemfae5;
        "pkg-1.19.2-3.2-forge+fabric" = _gzEd9lQk;
        "pkg-1.19.3-3.2-forge+fabric" = _lNVdiVvs;
        "pkg-1.19.4-3.2-forge+fabric" = _DPHShVlo;
        "pkg-1.19.4-3.3-forge+fabric" = _6cMGQ0Du;
        "pkg-1.19.4-3.4-forge+fabric" = _2CU9sRmX;
        "pkg-1.20-3.4-forge+fabric" = _dIqCSjmU;
        "pkg-1.20.1-3.4-forge+fabric" = _keJWn3ix;
        "pkg-1.20.2-3.4-forge+fabric" = _NdCA1M3y;
        "pkg-1.18.2-3.5-forge+fabric" = _vDfk1jJq;
        "pkg-1.19.2-3.5-forge+fabric" = _ZGyJ7hlY;
        "pkg-1.20.1-3.5-forge+fabric" = _A4ZCpmhF;
        "pkg-1.20.2-3.5-forge+fabric" = _1XyB1iVm;
        "pkg-1.20.3-3.5-fabric+forge+neo" = _R8yMN3Tn;
        "pkg-1.20.4-3.5-fabric+forge+neo" = _DruTvQQB;
        "pkg-1.19.2-3.6-fabric+forge+neo" = _k0gcwQ1G;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _r8ERZPfi;
        "pkg-1.20.2-3.6-fabric+forge+neo" = _J3deG1b6;
        "pkg-1.20.4-3.6-fabric+forge+neo" = _aHbDa4Gz;
        "pkg-1.20.5-3.6-fabric+neo" = _AXo0QOAs;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _ioogG2TS;
        "pkg-1.20.6-3.7-fabric+forge+neo" = _U3DeOghi;
        "pkg-1.21.0-3.7-fabric+forge+neo" = _Fgmz1dLj;
        "pkg-1.20.1-3.8-fabric+forge+neo" = _J1XnM0bd;
        "pkg-1.20.6-3.8-fabric+forge+neo" = _PybR3TgB;
        "pkg-1.21.0-3.8-fabric+forge+neo" = _qGGuhqHC;
        "pkg-1.21.1-3.8-fabric+forge+neo" = _uaTBGdjp;
        "pkg-1.21.2-3.8-fabric+neo" = _PCTOr24H;
        "pkg-1.21.3-3.8-fabric+forge+neo" = _lWHZsyBv;
        "pkg-1.21.4-3.8-fabric+forge+neo" = _2n8rWJBQ;
        "pkg-1.20.1-3.9-fabric+forge+neo" = _bDA25Xcg;
        "pkg-1.21.1-3.9-fabric+forge+neo" = _oHxzVjRs;
        "pkg-1.21.4-3.9-fabric+forge+neo" = _LcH6w3rS;
        "pkg-1.21.5-3.9-fabric+forge+neo" = _xHQkYJIl;
        "pkg-1.21.6-3.9-fabric+forge+neo" = _nWNUjtDl;
        "pkg-1.21.7-3.9-fabric+forge+neo" = _qdnac2Go;
        "pkg-1.21.8-3.9-fabric+forge+neo" = _L1RTkDsr;
        "pkg-1.21.9-3.9-fabric+forge+neo" = _8hw8Bjse;
        "pkg-1.21.10-3.9-fabric+forge+neo" = _VQvQrbZ2;
        "pkg-1.21.11-3.9-fabric+forge+neo" = _svuaNO0X;
        "pkg-26.1.0-3.9-fabric+forge+neo" = _UtO8R3qD;
        "pkg-26.1.0-4.0-fabric+forge+neo" = _dgmPHsgJ;
        "pkg-26.1.1-4.0-fabric+forge+neo" = _LadobNM1;
        "pkg-26.1.2-4.0-fabric+forge+neo" = _YPfD21mM;
        "pkg-26.2.0-4.0-fabric+forge+neo" = _iyrz0NRg;
        "default" = _iyrz0NRg;
    });
