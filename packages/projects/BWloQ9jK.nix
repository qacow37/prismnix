...
let
    ...
    in {
        ...
        "pkg-1.2.0-1.18" = _ZBI5qTep;
        "pkg-1.3.0" = _tzYc9HNM;
        "pkg-1.3.1" = _mctIoo5p;
        "pkg-1.3.2" = _GegFEZ3h;
        "pkg-1.3.3" = _cSzSbcvJ;
        "pkg-1.3.3-1.19" = _FPGndHr3;
        "pkg-1.3.4" = _MAruo7Ba;
        "pkg-1.3.4-1.19.3" = _DRpka5gO;
        "pkg-1.3.5" = _YYMS9LcJ;
        "pkg-1.3.5-1.19.4" = _WEzwowSz;
        "pkg-1.3.6-1.19.4" = _fAaHFHVp;
        "pkg-1.3.7-1.19.4" = _NriKkvat;
        "pkg-1.3.8-1.20" = _LUHS9aJ0;
        "pkg-1.3.9-1.20" = _apwqGSaK;
        "pkg-1.4.0-1.20" = _Vf7GPVNV;
        "pkg-1.4.0-1.20.2" = _XBrcSt3S;
        "pkg-1.4.1-1.20" = _Uj1peBrG;
        "pkg-1.4.1-1.20.2" = _GPeTJmd2;
        "pkg-1.4.1-1.20.6" = _RP6Tr3Bo;
        "pkg-1.4.1-1.21" = _I3a5043B;
        "pkg-1.4.1-1.21.2" = _esRBDwvg;
        "pkg-1.4.2-1.21.5" = _KDNue5SN;
        "pkg-1.4.2-1.21.6" = _1eRKC4VO;
        "pkg-1.4.3-1.21.10" = _HO6A4YAV;
        "pkg-1.4.4-1.21.11" = _xNvTLri9;
        "pkg-1.4.5-1.21.11" = _6d1Ndpk3;
