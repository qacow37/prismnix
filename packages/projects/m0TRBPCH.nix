...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.4-54.0.9" = _S9wV6CyR;
        "pkg-1.0.0-forge-1.21.3" = _QF3P57Uw;
        "pkg-1.0.1-forge-1.21.1-52.0.40" = _86B7qU18;
        "pkg-1.0.1-forge-1.20.1-47.3.22" = _9HEAwXmY;
        "pkg-v1.0.0-fabric-1.21.5-0.119.9" = _XgY4DWfL;
        "pkg-v1.0.0-forge-1.21.5-55.0.4" = _rSABpNlW;
        "pkg-v1.0.1-forge-1.21.5-55.0.4" = _an9Xc9K3;
        "pkg-1.0.2-fabric-1.21.6-0.127.0" = _9w2SUMtY;
        "pkg-1.0.2-forge-1.21.6-56.0.7" = _AuMaO3qP;
        "pkg-1.0.2-neoforge-1.21.8-21.8.39" = _deFfw4QI;
        "pkg-1.0.2-neoforge-1.21.9-21.9.2-b" = _l7YU6cpp;
        "pkg-1.0.2-fabric-1.21.9-0.134.0" = _KQBLm8DN;
        "pkg-1.0.2-forge-1.21.9-59.0.1" = _Ki8ZOK8A;
        "pkg-1.0.3-forge-1.21.9-59.0.5" = _f3EUrcd5;
        "pkg-1.0.2-neoforge-1.21.4-21.4.155" = _nq8jqvcu;
        "pkg-1.0.2-neoforge-1.21.1-21.1.213" = _b2xPel7m;
        "pkg-1.0.3-forge-1.21.8-58.1.7" = _PBEAh6Hn;
        "pkg-1.0.3-forge-1.21.11-61.0.2" = _biqSp5KI;
        "pkg-1.0.3-neoforge-1.21.11-21.11.10-" = _gnES6pDq;
        "pkg-1.0.3-fabric-1.21.11-0.140.0" = _6vevqh5u;
        "pkg-1.0.4-fabric-26.1-0.142.2" = _uV3hueWq;
        "pkg-1.0.4-fabric-26.1.1-0.145.4" = _R4i3TU1z;
        "pkg-1.0.4-neoforge-26.1.1.15" = _gEnfIrR2;
        "pkg-1.0.4-forge-26.1.1-63.0.0" = _9evyMXKq;
        "pkg-1.0.5-forge-26.1.1-63.0.0" = _9W2gTteO;
