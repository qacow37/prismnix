...
let
    ...
    in {
        ...
        "pkg-2.0.9+1.18-forge" = _3pmm4o4q;
        "pkg-2.0.9+1.18-fabric" = _6bKwXJyA;
        "pkg-2.0.10+1.18-fabric" = _xe3ds5yC;
        "pkg-2.0.10+1.18-forge" = _RucUnVgC;
        "pkg-2.0.10+1.17-fabric" = _JNNmAHv3;
        "pkg-2.0.10+1.17-forge" = _L2cwnuTf;
        "pkg-2.0.10+1.16-fabric" = _VEqZ0Gub;
        "pkg-2.0.10+1.16-forge" = _8q8nFN9U;
        "pkg-2.1.0+1.18-fabric" = _b0zwgjJE;
        "pkg-2.1.0+1.18-forge" = _x3qD9DW2;
        "pkg-2.1.0+1.19-fabric" = _7oyqUtGm;
        "pkg-2.1.0+1.19-forge" = _v4fhhKeP;
        "pkg-2.1.1+1.18-fabric" = _hs2khZ9Z;
        "pkg-2.1.1+1.18-forge" = _y2aP6jce;
        "pkg-2.1.1+1.19-fabric" = _oADpDiPw;
        "pkg-2.1.1+1.19-forge" = _4uj7IO7s;
        "pkg-2.1.2+1.19-fabric" = _q4KoD26G;
        "pkg-2.1.2+1.19-forge" = _UtwfyGhd;
        "pkg-2.2.0+1.18-fabric" = _Yb5sT5jR;
        "pkg-2.2.0+1.18-forge" = _yBxaakyF;
        "pkg-2.2.0+1.19-fabric" = _jQ4wI8T9;
        "pkg-2.2.0+1.19-forge" = _3WYxQLxV;
        "pkg-2.2.1+1.19-fabric" = _M29cmrMU;
        "pkg-2.2.1+1.19-forge" = _t4C1m0VI;
        "pkg-2.2.1+1.19.3-fabric" = _wAMbRNn6;
        "pkg-2.2.1+1.19.3-forge" = _Bv7Ak2Fk;
        "pkg-2.2.2+1.19-fabric" = _JEltPXI7;
        "pkg-2.2.2+1.19-forge" = _BFZN2xZv;
        "pkg-2.2.2+1.19.3-fabric" = _EyxIvtLu;
        "pkg-2.2.2+1.19.3-forge" = _xBU8lYZH;
        "pkg-2.2.2+1.19.4-fabric" = _aAcdR2Mn;
        "pkg-2.2.2+1.19.4-forge" = _qWnZxedu;
        "pkg-2.2.3+1.20-fabric" = _FlcRmy4g;
        "pkg-2.2.3+1.20-forge" = _53TNwafV;
        "pkg-2.2.4+1.20.2-fabric" = _s9DD2OQX;
        "pkg-2.2.4+1.20.2-forge" = _2fcdRh1p;
        "pkg-2.2.5+1.20.2-fabric" = _fKUqLfhi;
        "pkg-2.2.5+1.20.2-forge" = _GO3cA8fx;
        "pkg-2.2.5+1.20.2-neoforge" = _4Lf2uOy6;
        "pkg-2.2.6+1.20.2-fabric" = _YBAw7WnA;
        "pkg-2.2.6+1.20.2-forge" = _OoRoMwF5;
        "pkg-2.2.6+1.20.2-neoforge" = _LOwE9wAF;
        "pkg-2.2.7+1.20.4-fabric" = _MpdUFP59;
        "pkg-2.2.7+1.20.4-forge" = _lxa5pFqD;
        "pkg-2.2.7+1.20.4-neoforge" = _GjVQ56I3;
        "pkg-2.2.8+1.20.4-fabric" = _NGCD88ln;
        "pkg-2.2.8+1.20.4-forge" = _7awHe6qR;
        "pkg-2.2.8+1.20.4-neoforge" = _g0NHZsOE;
        "pkg-2.2.8+1.20.2-fabric" = _bTITl68h;
        "pkg-2.2.8+1.20.2-forge" = _nwJo0OYt;
        "pkg-2.2.8+1.20.2-neoforge" = _1qy15t4b;
        "pkg-2.2.8+1.20-fabric" = _loGmZ8r0;
        "pkg-2.2.8+1.20-forge" = _Xt1HBBDl;
        "default" = _Xt1HBBDl;
    });
