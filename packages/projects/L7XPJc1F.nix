...
let
    ...
    in {
        ...
        "pkg-v0.0.1-mc1.14.4" = _tvRtkLum;
        "pkg-v0.0.1-mc1.15.2" = _pVWAQGHK;
        "pkg-v0.0.1-mc1.16.5" = _FAHmQp1e;
        "pkg-v0.0.1-mc1.17.1" = _cIeAmBVw;
        "pkg-v0.0.1-mc1.18.2" = _EnxkFDwD;
        "pkg-v0.0.1-mc1.19.4" = _NyCLASDq;
        "pkg-v0.0.1-mc1.20.1" = _eCNKtTV0;
        "pkg-v0.0.1-mc1.20.6" = _e1BQPjch;
        "pkg-v0.0.1-mc1.21.1" = _xlSnxpsy;
        "pkg-v0.0.1-mc1.21.4" = _ZX9DJacb;
        "pkg-v0.0.1-mc1.21.5" = _wBrDBspW;
        "pkg-v0.0.2-mc1.14.4" = _28Qi9Zie;
        "pkg-v0.0.2-mc1.15.2" = _8xIXWyM1;
        "pkg-v0.0.2-mc1.16.5" = _eXEIHGBR;
        "pkg-v0.0.2-mc1.17.1" = _qHy9iQTg;
        "pkg-v0.0.2-mc1.18.2" = _RGsnTHiG;
        "pkg-v0.0.2-mc1.19.4" = _bk0KBfGO;
        "pkg-v0.0.2-mc1.20.1" = _E9lgLHFc;
        "pkg-v0.0.2-mc1.20.6" = _jcbrST4w;
        "pkg-v0.0.2-mc1.21.1" = _c1HhD6AW;
        "pkg-v0.0.2-mc1.21.4" = _xMTGzOp0;
        "pkg-v0.0.2-mc1.21.5" = _ekWrjgp3;
        "pkg-v0.1.0-mc1.14.4" = _gg20DHss;
        "pkg-v0.1.0-mc1.15.2" = _U7CVKarO;
        "pkg-v0.1.0-mc1.16.5" = _j32vTpry;
        "pkg-v0.1.0-mc1.17.1" = _bPnNxiuC;
        "pkg-v0.1.0-mc1.18.2" = _Ve19Fie6;
        "pkg-v0.1.0-mc1.19.4" = _EaKnwKjC;
        "pkg-v0.1.0-mc1.20.1" = _u98p30NI;
        "pkg-v0.1.0-mc1.20.6" = _kCRo3bNH;
        "pkg-v0.1.0-mc1.21.1" = _hWf0EMZD;
        "pkg-v0.1.0-mc1.21.4" = _xqnePzVA;
        "pkg-v0.1.0-mc1.21.5" = _2KAcKJsb;
        "pkg-v0.1.0-mc1.21.6" = _IU6wyJEr;
        "pkg-v0.2.0-mc1.14.4" = _UaDMnJsV;
        "pkg-v0.2.0-mc1.15.2" = _vPlFGwoV;
        "pkg-v0.2.0-mc1.16.5" = _y5uFJ0OJ;
        "pkg-v0.2.0-mc1.17.1" = _KpVDRCe3;
        "pkg-v0.2.0-mc1.18.2" = _HB01NOOt;
        "pkg-v0.2.0-mc1.19.4" = _m3nPZCJa;
        "pkg-v0.2.0-mc1.20.1" = _wNOU65OC;
        "pkg-v0.2.0-mc1.20.6" = _QeISCttG;
        "pkg-v0.2.0-mc1.21.1" = _QyhghTSa;
        "pkg-v0.2.0-mc1.21.4" = _CoW43GtC;
        "pkg-v0.2.0-mc1.21.5" = _iHFWvmtG;
        "pkg-v0.2.0-mc1.21.6" = _xRXhyJoG;
        "pkg-v0.2.0-mc1.21.7" = _jUVnIP9v;
        "pkg-v0.2.1-mc1.14.4" = _GCc2j77R;
        "pkg-v0.2.1-mc1.15.2" = _2RPXjkLx;
        "pkg-v0.2.1-mc1.16.5" = _AJUcYwb3;
        "pkg-v0.2.1-mc1.17.1" = _q0BR5tMG;
        "pkg-v0.2.1-mc1.18.2" = _Dsmo7wc0;
        "pkg-v0.2.1-mc1.19.4" = _L8OxDK6Y;
        "pkg-v0.2.1-mc1.20.1" = _4QbhQ6Zj;
        "pkg-v0.2.1-mc1.20.6" = _GE9mw366;
        "pkg-v0.2.1-mc1.21.1" = _Q18kYbfY;
        "pkg-v0.2.1-mc1.21.4" = _doyOh9RD;
        "pkg-v0.2.1-mc1.21.5" = _K1C1Q85c;
        "pkg-v0.2.1-mc1.21.6" = _3abPv6h0;
        "pkg-v0.2.1-mc1.21.7" = _egJKIM0p;
        "pkg-v0.2.1-mc1.21.8" = _ZHPjgQQU;
        "pkg-v0.2.2-mc1.14.4" = _LHoH5tkx;
        "pkg-v0.2.2-mc1.15.2" = _hIT4Why9;
        "pkg-v0.2.2-mc1.16.5" = _tt0MFSVN;
        "pkg-v0.2.2-mc1.17.1" = _RHtfqAq1;
        "pkg-v0.2.2-mc1.18.2" = _WWxCiWRf;
        "pkg-v0.2.2-mc1.19.4" = _N0cuwXKG;
        "pkg-v0.2.2-mc1.20.1" = _tuKf036P;
        "pkg-v0.2.2-mc1.20.6" = _KLin5MRx;
        "pkg-v0.2.2-mc1.21.1" = _JKlQrVLw;
        "pkg-v0.2.2-mc1.21.10" = _dYhftFdK;
        "pkg-v0.2.2-mc1.21.3" = _GdXSN4gJ;
        "pkg-v0.2.2-mc1.21.4" = _1nThBwve;
        "pkg-v0.2.2-mc1.21.5" = _UAbRGQCg;
        "pkg-v0.2.2-mc1.21.8" = _6Pb5Theg;
        "pkg-v0.3.0-mc1.14.4" = _nU2MuIcO;
        "pkg-v0.3.0-mc1.15.2" = _h9nRyp2k;
        "pkg-v0.3.0-mc1.16.5" = _fu2bkpA6;
        "pkg-v0.3.0-mc1.17.1" = _9vuWgXeJ;
        "pkg-v0.3.0-mc1.18.2" = _Al4j2AYo;
        "pkg-v0.3.0-mc1.19.4" = _ON8fN3uQ;
        "pkg-v0.3.0-mc1.20.1" = _fU78wCm5;
        "pkg-v0.3.0-mc1.20.6" = _b8b2T6ZP;
        "pkg-v0.3.0-mc1.21.1" = _sb1aV6nk;
        "pkg-v0.3.0-mc1.21.10" = _icXnL6g4;
        "pkg-v0.3.0-mc1.21.3" = _AMUfp49D;
        "pkg-v0.3.0-mc1.21.4" = _uYOzN2ce;
        "pkg-v0.3.0-mc1.21.5" = _yaVuMfeN;
        "pkg-v0.3.0-mc1.21.8" = _OxwSSlYL;
        "pkg-v0.3.1-mc1.14.4" = _aXIr7ba7;
        "pkg-v0.3.1-mc1.15.2" = _wKbMTgrc;
        "pkg-v0.3.1-mc1.16.5" = _OnfM2uqP;
        "pkg-v0.3.1-mc1.17.1" = _9i4TLMvy;
        "pkg-v0.3.1-mc1.18.2" = _WocYPyP5;
        "pkg-v0.3.1-mc1.19.4" = _YIzwrt9Q;
        "pkg-v0.3.1-mc1.20.1" = _moUWh3Et;
        "pkg-v0.3.1-mc1.20.6" = _EycuEFrr;
        "pkg-v0.3.1-mc1.21.1" = _HYAg74SA;
        "pkg-v0.3.1-mc1.21.10" = _yIm0VcUQ;
        "pkg-v0.3.1-mc1.21.11" = _ZzrI5bZk;
        "pkg-v0.3.1-mc1.21.3" = _gRG6IrBE;
        "pkg-v0.3.1-mc1.21.4" = _xTdpFofA;
        "pkg-v0.3.1-mc1.21.5" = _OyZNnqH8;
        "pkg-v0.3.1-mc1.21.8" = _H3YLXGq2;
        "pkg-v0.3.2-mc1.14.4" = _r8qyRwlZ;
        "pkg-v0.3.2-mc1.15.2" = _EfyhZrLL;
        "pkg-v0.3.2-mc1.16.5" = _lmqjOjlu;
        "pkg-v0.3.2-mc1.17.1" = _nJAcfXg7;
        "pkg-v0.3.2-mc1.18.2" = _30yxAh6G;
        "pkg-v0.3.2-mc1.19.4" = _fIW6jOM1;
        "pkg-v0.3.2-mc1.20.1" = _fbyZ3Hj2;
        "pkg-v0.3.2-mc1.20.6" = _8lAOeEgm;
        "pkg-v0.3.2-mc1.21.1" = _zfUmcUbd;
        "pkg-v0.3.2-mc1.21.10" = _lhmuf0Cj;
        "pkg-v0.3.2-mc1.21.11" = _olmuGrbo;
        "pkg-v0.3.2-mc1.21.3" = _qEQjp5v4;
        "pkg-v0.3.2-mc1.21.4" = _TYt4jZf7;
        "pkg-v0.3.2-mc1.21.5" = _TkNyhNCn;
        "pkg-v0.3.2-mc1.21.8" = _HP00F0Qk;
        "pkg-v0.4.0-mc1.14.4" = _N5YYsBka;
        "pkg-v0.4.0-mc1.15.2" = _2WUpMxll;
        "pkg-v0.4.0-mc1.16.5" = _hAPj1YCX;
        "pkg-v0.4.0-mc1.17.1" = _vaxcxNz9;
        "pkg-v0.4.0-mc1.18.2" = _TnxJtAGC;
        "pkg-v0.4.0-mc1.19.4" = _vIgguobK;
        "pkg-v0.4.0-mc1.20.1" = _tZQyrixQ;
        "pkg-v0.4.0-mc1.20.6" = _xz2C4QZw;
        "pkg-v0.4.0-mc1.21.1" = _r4IA2nWQ;
        "pkg-v0.4.0-mc1.21.10" = _fHccVST9;
        "pkg-v0.4.0-mc1.21.11" = _G8Tm0osE;
        "pkg-v0.4.0-mc1.21.3" = _V54ElevW;
        "pkg-v0.4.0-mc1.21.4" = _eF9OldMp;
        "pkg-v0.4.0-mc1.21.5" = _xlZZ3w6D;
        "pkg-v0.4.0-mc1.21.8" = _CRiMvLvQ;
        "pkg-v0.4.0-mc26.1-snapshot-9" = _vu1qgVL0;
        "pkg-v0.4.1-mc1.14.4" = _8YC0Et6u;
        "pkg-v0.4.1-mc1.15.2" = _51h9gs5M;
        "pkg-v0.4.1-mc1.16.5" = _JuErME4z;
        "pkg-v0.4.1-mc1.17.1" = _YRZ25gHQ;
        "pkg-v0.4.1-mc1.18.2" = _7uG8eQxm;
        "pkg-v0.4.1-mc1.19.4" = _8yhR43sC;
        "pkg-v0.4.1-mc1.20.1" = _LPCdNaoW;
        "pkg-v0.4.1-mc1.20.6" = _AROjh7js;
        "pkg-v0.4.1-mc1.21.1" = _ayoVv4zy;
        "pkg-v0.4.1-mc1.21.10" = _uwiDirMM;
        "pkg-v0.4.1-mc1.21.11" = _I9eiir2s;
        "pkg-v0.4.1-mc1.21.3" = _e1vLPkvd;
        "pkg-v0.4.1-mc1.21.4" = _YVrNUZaP;
        "pkg-v0.4.1-mc1.21.5" = _bVOoOgtG;
        "pkg-v0.4.1-mc1.21.8" = _qCO1oRFb;
        "pkg-v0.4.1-mc26.1" = _U0JlNW3K;
        "default" = _U0JlNW3K;
    });
