...
let
    ...
    in {
        ...
        "pkg-4.1.2" = _FMdIAsIi;
        "pkg-4.2.0" = _OhuTVpQH;
        "pkg-4.2.1-fabric" = _776Z5oW9;
        "pkg-4.2.1-forge" = _AvWRJcqx;
        "pkg-5.0.0-forge" = _zkszypjI;
        "pkg-5.0.0-fabric" = _7epbwkFg;
        "pkg-5.0.1" = _xyl3NViI;
        "pkg-5.0.2" = _fwozdl4o;
        "pkg-4.2.2" = _fs07zE6w;
        "pkg-2.1.1-forge" = _6gwDuh90;
        "pkg-2.1.1-fabric" = _3UkWIj4a;
        "pkg-5.0.3-fabric" = _kwjHqfz7;
        "pkg-5.0.3-forge" = _CtXsUUz6;
        "pkg-5.1.0-fabric" = _GHcKib6J;
        "pkg-5.1.0-forge" = _YrvjR5sX;
        "pkg-5.2.0-fabric" = _RbR7EG8T;
        "pkg-5.2.0-forge" = _zI3uKvrU;
        "pkg-6.0.0-fabric" = _FCnCG6PS;
        "pkg-6.0.0-forge" = _ULSumfl4;
        "pkg-6.0.1" = _DG5Fn9Sz;
        "pkg-6.0.2" = _tfQSdUpc;
        "pkg-6.0.3-forge" = _85kC2OMr;
        "pkg-6.0.3-fabric" = _pguEMpy9;
        "pkg-6.1.0-neoforge" = _agJm6Vrw;
        "pkg-6.1.0" = _PPnbi6JY;
        "pkg-6.1.1-neoforge" = _HWBrlwWv;
        "pkg-6.1.1-fabric" = _i9RcCdZv;
        "pkg-7.0.0-neoforge" = _BkJB5PPB;
        "pkg-7.0.0-fabric" = _wmIZ4wP4;
        "pkg-7.0.1-neoforge" = _6BhrwMOV;
        "pkg-7.0.1-fabric" = _zQSo4nxk;
        "pkg-7.0.2-fabric" = _W4lg2p7U;
        "pkg-7.0.2-neoforge" = _CnpoQxCx;
        "pkg-7.1.0-fabric" = _zLd6ikLj;
        "pkg-7.1.0-neoforge" = _HViHO2Oi;
        "pkg-7.0.2-hotfix-fabric" = _bwKMSBhn;
        "pkg-7.1.0-hotfix-fabric" = _a3QXXGz2;
        "pkg-7.1.1-fabric" = _IPM0JlHd;
        "pkg-7.1.2-neoforge" = _gTYCIFFQ;
        "pkg-8.0.0-neoforge" = _WmGPid1l;
        "pkg-8.0.0-fabric" = _CtMpt7Jr;
        "pkg-8.0.1-neoforge" = _aCcv0w0q;
        "pkg-8.0.2-fabric" = _MGoveONm;
        "pkg-8.0.2-neoforge" = _dR6exAyF;
        "pkg-8.0.3-neoforge" = _kI9raxPl;
        "pkg-8.0.3-fabric" = _eRLwt73x;
        "pkg-7.0.3-neoforge" = _x7kQWVju;
        "pkg-7.0.3-fabric" = _sOzRw3CG;
        "pkg-7.1.3-neoforge" = _joOID027;
        "pkg-7.1.3-fabric" = _7KqeXPRS;
        "pkg-8.0.4-neoforge" = _vqv9Um4Q;
        "pkg-8.0.4-fabric" = _LdlksamY;
        "pkg-8.1.0-neoforge" = _G34Jddxu;
        "pkg-8.1.0-fabric" = _bPLllEgi;
        "pkg-8.2.0-neoforge" = _mLI5k2Gi;
        "pkg-8.2.0-fabric" = _Ii0gP3D8;
        "pkg-9.0.0-neoforge" = _LtVvw4uS;
        "pkg-9.0.0-fabric" = _d5ddUdiB;
        "default" = _d5ddUdiB;
    });
