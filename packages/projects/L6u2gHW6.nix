...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.4-54.1.11" = _RXxgr1Jb;
        "pkg-1.0.0-forge-1.21.5-55.1.4" = _niqggjZZ;
        "pkg-1.0.0-forge-1.21.8-58.1.11" = _3WWyBgum;
        "pkg-1.0.0-forge-1.21.10-60.1.0" = _7e26T8HG;
        "pkg-1.0.0-forge-1.21.11-61.1.1" = _3DD4t80h;
        "pkg-1.0.0-neoforge-1.21.1-21.1.219" = _DwyLYZD4;
        "pkg-1.0.0-neoforge-1.21.4-21.4.156" = _FAJwdIin;
        "pkg-1.0.0-neoforge-1.21.5-21.5.96" = _lXKAZkZe;
        "pkg-1.0.0-neoforge-1.21.8-21.8.52" = _K2ycDICF;
        "pkg-1.0.0-neoforge-1.21.10-21.10.64" = _nDXhdP6e;
        "pkg-1.0.0-neoforge-1.21.11-21.11.38" = _W2L8I27U;
        "pkg-1.0.0-fabric-1.20.1-0.92.7" = _KOI0COcw;
        "pkg-1.0.0-fabric-1.21.1-0.116.9" = _nL0hTO1M;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _hXAs1b23;
        "pkg-1.0.0-fabric-1.21.5-0.128.2" = _EX1Br0YN;
        "pkg-1.0.0-fabric-1.21.8-0.136.1" = _1LmQpF9x;
        "pkg-1.0.0-fabric-1.21.10-0.138.4" = _lfVO76Zp;
        "pkg-1.0.0-fabric-1.21.11-0.141.3" = _ErNkSyef;
        "pkg-1.0.1-fabric-26.1.1-0.145.3" = _KYqLWsHK;
        "pkg-1.0.1-forge-26.1.1-63.0.0" = _3jh3qS9P;
        "pkg-1.0.1-neoforge-26.1.1.1" = _bIvSxMky;
