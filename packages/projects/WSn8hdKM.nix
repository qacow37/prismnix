...
let
    ...
    in {
        ...
        "pkg-0.2.6" = _NyY1kP0J;
        "pkg-0.2.7" = _iHE0n19Y;
        "pkg-0.2.7.1" = _Wy5PNEtk;
        "pkg-0.2.8" = _eOEyV6c2;
        "pkg-0.2.9" = _AmLLaOzC;
        "pkg-0.3.0" = _jNv9MvsI;
        "pkg-0.3.1" = _zayCkOhW;
        "pkg-0.3.1.2" = _3s0Qnryn;
        "pkg-1.21.1_v.0.3.2" = _KDkRElxc;
        "pkg-1.20.1_v.0.3.2" = _hVWMxkR2;
        "pkg-1.19.4_v.0.3.2" = _sONDb8kZ;
        "pkg-1.21.1_v.0.3.2.1" = _DVZMWTBG;
        "pkg-1.20.1_v.0.3.2.1" = _oXDSdbGq;
        "pkg-1.19.4_v.0.3.2.1" = _C0UHqWkU;
        "pkg-1.21.1_v.0.3.4" = _BOjUujYO;
        "pkg-1.20.1_v.0.3.4" = _TuByvZRs;
        "pkg-1.19.4_v.0.3.4" = _rVratzBk;
        "pkg-1.21.1_v.0.3.4.3" = _5Mkje2sD;
        "pkg-1.20.1_v.0.3.4.3" = _fhMQBypX;
        "pkg-1.19.4_v.0.3.4.3" = _yk6z4X5k;
        "pkg-1.21.1_v.0.3.9" = _q7nxLV8s;
        "pkg-1.20.1_v.0.3.9" = _xHi5HdCh;
        "pkg-1.19.4_v.0.3.9" = _rJUNcCGj;
        "pkg-1.21.1_v.0.3.9.1" = _u4SmFknf;
        "pkg-1.20.1_v.0.3.9.1" = _gR3TLLy5;
        "pkg-1.19.4_v.0.3.9.1" = _gVXPdyBq;
        "default" = _gVXPdyBq;
    });
