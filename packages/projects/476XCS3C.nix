...
let
    ...
    in {
        ...
        "pkg-1.20.6-0.9.0" = _afyKKYN2;
        "pkg-1.20.6-0.10.0" = _g3cl459y;
        "pkg-1.21-0.10.0" = _4l0puvhJ;
        "pkg-1.20.6-0.10.1" = _fnPE6ew0;
        "pkg-1.21-0.10.1" = _MKTYpEl4;
        "pkg-1.20.6-0.11.0" = _xHFXMR6t;
        "pkg-1.21-0.11.0" = _zDkxZh0x;
        "pkg-1.20.6-0.11.1" = _UfkcA6Fh;
        "pkg-1.21-0.11.1" = _i0MNa0ek;
        "pkg-1.20.6-0.11.2" = _xQyb7TXR;
        "pkg-1.21-0.11.2" = _B4F1sTzj;
        "pkg-1.21-0.11.3" = _320hI7ri;
        "pkg-1.20.6-0.11.3" = _kGdT1mli;
        "pkg-1.21-0.11.4" = _sft0bXdd;
        "pkg-1.20.6-0.11.4" = _QSx0QX2Y;
        "pkg-1.20.6-0.11.5" = _CEN8fqIy;
        "pkg-1.21-0.11.5" = _e1f2vjw0;
        "pkg-1.21-0.11.6" = _HhEoWyfh;
        "pkg-1.20.6-0.11.7" = _hY41gv9h;
        "pkg-1.21-0.11.7" = _SU7OZIUr;
        "pkg-1.21.1-0.12-alpha-fabric" = _MxRkdNCs;
        "pkg-1.21.1-0.12-alpha-neoforge" = _UdWs2LQT;
        "pkg-0.12.1-1.21.1-alpha-fabric" = _XHwtc0vh;
        "pkg-0.12.1-1.21.1-alpha-neoforge" = _7imvm4bB;
        "pkg-0.13.0-1.21.1-beta-neoforge" = _WAcnD2Lu;
        "pkg-0.13.0-1.21.1-beta-fabric" = _2kODXO0R;
        "pkg-0.13.1-1.21.1-beta-fabric" = _HczvO13t;
        "pkg-0.13.1-1.21.1-beta-neoforge" = _G6jWYCfQ;
        "pkg-0.13.2-1.21.1-beta-fabric" = _7GGgK4OC;
        "pkg-0.13.2-1.21.1-beta-neoforge" = _HXuS3Ld1;
        "pkg-0.13.3-1.21.1-beta-neoforge" = _Pqa010pN;
        "pkg-0.13.3-1.21.1-beta-fabric" = _ZipvJVGW;
        "pkg-0.14.0-1.21.1-beta-neoforge" = _LTy6BqBX;
        "pkg-0.14.0-1.21.1-beta-fabric" = _808jXL8K;
        "pkg-0.14.1-1.21.1-beta-neoforge" = _Eea6BuxW;
        "pkg-0.14.1-1.21.1-beta-fabric" = _iTzTyzRt;
        "default" = _iTzTyzRt;
    });
