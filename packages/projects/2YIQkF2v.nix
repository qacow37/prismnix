...
let
    ...
    in {
        ...
        "pkg-1.0.1-mc1.20.1" = _qH73rLlU;
        "pkg-1.0.1-mc1.20.2" = _crHEP7DU;
        "pkg-1.0.1-mc1.20.4" = _D043skbU;
        "pkg-1.0.2-mc1.20.1" = _ujZYI5uj;
        "pkg-1.0.2-mc1.20.2" = _QrT0mLIL;
        "pkg-1.0.2-mc1.20.4" = _9xtubAxU;
        "pkg-1.0.3-mc1.20.1" = _mJMDr4Xc;
        "pkg-1.0.3-mc1.20.2" = _kKyQ2WaL;
        "pkg-1.0.3-mc1.20.4" = _ROGONOLU;
        "pkg-1.1.0-mc1.20.1" = _vLRdZvcN;
        "pkg-1.1.0-mc1.20.2" = _VmgI5Kek;
        "pkg-1.1.0-mc1.20.4" = _GKOW9qBd;
        "pkg-1.1.1-mc1.20.1" = _6aHHPLe7;
        "pkg-1.1.1-mc1.20.2" = _uKHzAGFR;
        "pkg-1.1.1-mc1.20.4" = _DIiz3RCL;
        "pkg-1.1.1-mc1.20.5" = _ZpBEeDuO;
        "pkg-1.1.2-mc1.20.1" = _PPbPmS6z;
        "pkg-1.1.2-mc1.20.2" = _Eo461r72;
        "pkg-1.1.2-mc1.20.4" = _VW48biHX;
        "pkg-1.1.2-mc1.20.5" = _2d9EaFnk;
        "pkg-1.1.3-mc1.20.1" = _manhA6my;
        "pkg-1.1.3-mc1.20.2" = _U2XmQAFK;
        "pkg-1.1.3-mc1.20.4" = _jWYXsX6w;
        "pkg-1.1.3-mc1.20.6" = _aTqNJFmn;
        "pkg-1.1.3-mc1.21.0" = _Mv2p0pBe;
        "pkg-1.2.0-mc1.20.1" = _IFontJtY;
        "pkg-1.2.0-mc1.20.2" = _asR3edvZ;
        "pkg-1.2.0-mc1.20.4" = _WV3bRkf0;
        "pkg-1.2.0-mc1.20.6" = _Cs2a62aK;
        "pkg-1.2.0-mc1.21.0" = _PmVicqHJ;
        "pkg-1.2.1-mc1.20.1" = _F63g74HH;
        "pkg-1.2.1-mc1.20.2" = _hTeBvwOE;
        "pkg-1.2.1-mc1.20.4" = _6TaXJaf7;
        "pkg-1.2.1-mc1.20.6" = _p14PJ9Qk;
        "pkg-1.2.1-mc1.21.0" = _xTjajODs;
        "pkg-1.2.1-mc1.21.2" = _FTlRdNxe;
        "pkg-1.2.2-mc1.20.1" = _s9IZ5pT5;
        "pkg-1.2.2-mc1.20.2" = _fxQ2SQhz;
        "pkg-1.2.2-mc1.20.4" = _2oO2qgvN;
        "pkg-1.2.2-mc1.20.6" = _X6L27fpj;
        "pkg-1.2.2-mc1.21.0" = _cV6LbCd1;
        "pkg-1.2.2-mc1.21.2" = _8bGHpJoK;
        "pkg-1.3.0-mc1.20.1" = _6PXpn8IU;
        "pkg-1.3.0-mc1.20.2" = _ybfBrZFu;
        "pkg-1.3.0-mc1.20.4" = _XkTzHz8Z;
        "pkg-1.3.0-mc1.20.6" = _vbchHlok;
        "pkg-1.3.0-mc1.21.0" = _uZjW4IFF;
        "pkg-1.3.0-mc1.21.2" = _EaahHPGz;
        "pkg-1.3.0-mc1.21.5" = _CwRXOSQy;
        "pkg-1.4.0-mc1.20.1" = _QDtgbrbZ;
        "pkg-1.4.0-mc1.20.2" = _uJ0mBpv2;
        "pkg-1.4.0-mc1.20.4" = _SoW6Steo;
        "pkg-1.4.0-mc1.20.6" = _d6MqG5ih;
        "pkg-1.4.0-mc1.21.0" = _NBYscVF7;
        "pkg-1.4.0-mc1.21.2" = _zLuRBBWf;
        "pkg-1.4.0-mc1.21.5" = _rbxwnJJm;
        "pkg-1.4.0-mc1.21.6" = _eXGkKEF5;
        "pkg-1.4.1-mc1.20.1" = _nPNB4elY;
        "pkg-1.4.1-mc1.20.2" = _D3jzRaBv;
        "pkg-1.4.1-mc1.20.4" = _fcqotxpo;
        "pkg-1.4.1-mc1.20.6" = _Sllt4ohd;
        "pkg-1.4.1-mc1.21.0" = _E0ZwSE0a;
        "pkg-1.4.1-mc1.21.2" = _uue6yVpD;
        "pkg-1.4.1-mc1.21.5" = _KF8Q7M3r;
        "pkg-1.4.1-mc1.21.6" = _W7WQRavI;
        "pkg-1.4.1-mc1.21.9" = _zO42Y07j;
