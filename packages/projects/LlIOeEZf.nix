...
let
    ...
    in {
        ...
        "pkg-3.11" = _XUd6mTzs;
        "pkg-3.12" = _VMLbzWTw;
        "pkg-2026.1" = _5Ctb5Ha5;
        "pkg-2026.2" = _SWMesoYE;
        "pkg-2026.3" = _etCUrB02;
        "pkg-2026.4" = _ERv8njzi;
        "pkg-2026.5" = _riwsGLf5;
        "pkg-2026.6-Beta" = _8ZDK9Z5V;
        "pkg-2026.7-Beta" = _SwG4LEMz;
        "default" = _SwG4LEMz;
    });
