...
let
    ...
    in {
        ...
        "pkg-0.2.1" = _MLJ0TtdM;
        "pkg-0.2.2" = _1KrEG1KB;
        "pkg-0.2.3-1.20.1" = _qlQ7KVHb;
        "pkg-0.2.3-1.21.1" = _iphPJVCu;
        "pkg-0.2.3-1.21.4" = _7FhdD5iG;
        "pkg-0.3.0-1.20.1" = _10EO5xUz;
        "pkg-0.3.0-1.21.1" = _oUGH9AqJ;
        "pkg-0.3.0-1.21.4" = _E0Gtkzlm;
        "pkg-0.4.0-1.20.1" = _kPMmnitE;
        "pkg-0.4.0-1.21.1" = _p6oKEUWs;
        "pkg-0.4.0-1.21.4" = _rxRJPK9k;
        "pkg-0.4.1-1.20.1" = _GjvqzYOQ;
        "pkg-0.4.1-1.21.1" = _yHfg8uRM;
        "pkg-0.4.1-1.21.4" = _q6thtHrc;
        "pkg-0.4.2-1.20.1" = _ZVqQxb6y;
        "pkg-0.4.2-1.21.1" = _AKLFUQ60;
        "pkg-0.4.2-1.21.4" = _YxCEXBsi;
        "pkg-0.4.3-1.20.1" = _Ryb2vOeq;
        "pkg-0.4.3-1.21.1" = _CbqGlwPy;
        "pkg-0.4.3-1.21.4" = _NsB1VLPz;
        "pkg-0.5.0-1.20.1" = _dfMWh2L6;
        "pkg-0.5.0-1.21.1" = _Kn6VhbKY;
        "pkg-0.5.0-1.21.4" = _Z97anEWO;
        "pkg-0.5.1-1.20.1" = _twZDJbAQ;
        "pkg-0.5.1-1.21.1" = _wioy0nnC;
        "pkg-0.5.1-1.21.4" = _tmO9E35v;
        "pkg-0.5.2-1.20.1" = _2OIuPFP0;
        "pkg-0.5.2-1.21.1" = _PXabGBc7;
        "pkg-0.5.2-1.21.4" = _Rxk08VMq;
        "pkg-0.6.0-1.20.1" = _Yia7oitu;
        "pkg-0.6.0-1.21.1" = _nNVcKFDp;
        "pkg-0.6.0-1.21.4" = _UyK8kD2j;
        "pkg-0.6.1-1.21.1" = _OLoxvmKN;
        "pkg-0.6.1-1.21.4" = _7pAyCd6M;
        "pkg-0.6.1-1.21.5-alpha" = _1T1uMiOJ;
        "pkg-0.6.1-1.21.5" = _kpoIYgs0;
        "pkg-0.6.2-1.21.5" = _jRxD9Mqw;
        "pkg-0.7.0-1.21.1" = _MgVjCaug;
        "pkg-0.7.0-1.21.4" = _JtiPVoFP;
        "pkg-0.7.0-1.21.5" = _aW3pgzMS;
        "pkg-1.0.0-1.21.1" = _xmtaHcvI;
        "pkg-1.0.0-1.21.4" = _btDgQvMa;
        "pkg-1.0.0-1.21.5" = _FVQS7RGn;
        "pkg-1.0.1-1.21.1" = _SCLaW4si;
        "pkg-1.0.1-1.21.4" = _AnmY49D0;
        "pkg-1.0.1-1.21.5" = _3IOYIOQI;
        "pkg-1.0.2-1.21.1" = _f7b0JzXB;
        "pkg-1.0.2-1.21.4" = _7yYdCpxC;
        "pkg-1.0.2-1.21.5" = _VDgI0spI;
        "pkg-1.1.0-1.21.1" = _DOb9nFdM;
        "pkg-1.1.0-1.21.4" = _iR7N7G83;
        "pkg-1.1.0-1.21.5" = _2IOA1Zv7;
        "pkg-1.1.0-1.21.7" = _IXAZN8No;
        "pkg-1.1.0-1.21.8" = _UNWmHGfV;
        "pkg-1.2.0-1.21.1" = _mBfcyObv;
        "pkg-1.2.0-1.21.4" = _1lc3LAxJ;
        "pkg-1.2.0-1.21.5" = _OBsZRTEZ;
        "pkg-1.2.0-1.21.6" = _Ut8kVFgg;
        "pkg-1.2.1-1.21.6" = _U1uYMI7K;
        "pkg-1.3.0-1.20.1" = _IxJ0NOBp;
        "pkg-1.3.0-1.21.1" = _4GWcE2Um;
        "pkg-1.3.0-1.21.5" = _xaiep7xr;
        "pkg-1.3.0-1.21.8" = _BYjWTowA;
        "pkg-1.3.0-1.21.10" = _uu1tkAYz;
        "pkg-1.3.1-1.20.1" = _4b1KxPjc;
        "pkg-1.3.1-1.21.1" = _ffWlLctx;
        "pkg-1.3.1-1.21.5" = _KyFiA7Az;
        "pkg-1.3.1-1.21.8" = _NXFkQ5TZ;
        "pkg-1.3.1-1.21.10" = _JcEpK9sk;
        "pkg-1.3.1-1.21.11" = _mlyCfCT0;
        "pkg-1.4.0-1.20.1" = _vNIg194o;
        "pkg-1.4.0-1.21.1" = _eknqlnsS;
        "pkg-1.4.0-1.21.11" = _w9FFy4XF;
        "pkg-1.4.0-26.1.2" = _iTjRW4qP;
        "pkg-1.4.0-26.2" = _5bpUcOHS;
        "pkg-1.4.1-1.20.1" = _4EuXjiZd;
        "pkg-1.4.1-1.21.1" = _P9ZLB72Q;
