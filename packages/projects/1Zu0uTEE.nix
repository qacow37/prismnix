...
let
    ...
    in {
        ...
        "pkg-1.7.1" = _mNIjPMUg;
        "pkg-1.8.0" = _9x7VKSy3;
        "pkg-1.8.0beta1" = _EKFMTX5J;
        "pkg-1.8.1" = _EIS07pmm;
        "pkg-1.8.9-1.8.1beta2" = _2qOhczhJ;
        "pkg-1.8.9-1.8.1beta4" = _l2oAKqA4;
        "pkg-1.8.9-1.8.1beta5" = _vbV4r1On;
        "pkg-1.8.9-1.8.1beta6" = _NRwH0oIO;
        "pkg-1.8.9-1.8.1beta7" = _nQG32L7G;
        "pkg-1.8.9-1.8.1beta8" = _dTdrvOZ7;
        "pkg-1.9.0-1.8.1beta8" = _aJo6w1zw;
        "pkg-1.9.0-1.8.1beta9" = _8cTzkpUh;
        "pkg-1.8.9-1.8.1beta10" = _wk2tNvFw;
        "pkg-1.9.0-1.8.1beta10" = _EWbG1IbS;
        "pkg-1.9.0-1.8.1beta11" = _JwpNrKR8;
        "pkg-1.9.0-1.8.1beta12" = _zPCndAGX;
        "pkg-1.9.0-1.8.1beta13" = _91T5qvMy;
        "pkg-1.9.0-1.8.1beta14" = _6PNEuSLN;
        "pkg-1.9.0-1.8.1beta15" = _wu8T7HQ1;
        "pkg-1.9.0-1.8.2" = _exDIAcIz;
        "pkg-1.9.0-1.8.3" = _ZMHhWkV7;
        "pkg-1.9.0-1.8.4" = _vU3Lj1EE;
        "pkg-1.9.0-1.8.6" = _ezdfNh5W;
        "pkg-1.9.4-1.8.6" = _Ys2aoYFM;
        "pkg-1.9.4-1.8.7" = _b4myhMoh;
        "pkg-1.9.4-1.9.0" = _TmzwcfJs;
        "pkg-1.9.4-1.9.1" = _1cLf3lvt;
        "pkg-1.10-1.9.2" = _T0iIYTzX;
        "pkg-1.10-1.9.3" = _YxDLCEw4;
        "pkg-1.10-1.9.4" = _bwwm0PKg;
        "pkg-1.10-1.9.5" = _EiE1mwm4;
        "pkg-1.10-1.9.6" = _ibF1X42t;
        "pkg-1.10-1.9.7" = _Rx6tUo3P;
        "pkg-1.10-1.9.8" = _g2rIuvgF;
        "pkg-1.10-1.9.9" = _8xPJ51NM;
        "pkg-1.10-2.0.0" = _kWyxA6b6;
        "pkg-1.10-2.0.1" = _AMb4iXU4;
        "pkg-1.10-2.0.2" = _uyFItk4n;
        "pkg-1.10-2.1.0" = _jXkFAXKQ;
        "pkg-1.10-2.1.1" = _MiEpvT0k;
        "pkg-1.10-2.1.2" = _OiSkmb3g;
        "pkg-1.10-2.1.3" = _C5sV8EXO;
        "pkg-1.10-2.1.4" = _5zIZGWit;
        "pkg-1.10-2.2.0" = _IijdPugD;
        "pkg-1.11-2.2.0alpha1" = _Yj1S9a0R;
        "pkg-1.11-2.2.0alpha2" = _aYjc6auO;
        "pkg-1.11-2.2.0alpha10" = _LuGjfLka;
        "pkg-1.11-2.2.0alpha11" = _4OEk11SW;
        "pkg-1.11-2.2.0beta1" = _CV1zckvO;
        "pkg-1.1x-2.3.0" = _zCM5iJSP;
        "pkg-1.1x-2.3.1" = _qJo2JAHA;
        "pkg-1.1x-2.3.2" = _a9GHKtnt;
        "pkg-1.1x-2.3.3" = _8T8xvTS3;
        "pkg-1.1x-2.3.4" = _pBe6jjdG;
        "pkg-1.1x-2.3.5" = _bB3rzOqh;
        "pkg-1.1x-2.3.6" = _jx9gBf6i;
        "pkg-1.1x-2.3.7" = _8tUQcs9o;
        "pkg-1.1x-2.3.8" = _t1Mdhuv7;
        "pkg-1.1x-2.3.9" = _9LtgeG0V;
        "pkg-1.1x-2.3.10" = _iOoUhafp;
        "pkg-1.1x-2.3.11" = _jcra0Ghf;
        "pkg-1.12-2.3.11beta" = _Bx3cBv9V;
        "pkg-1.12-2.3.13" = _riIioNP4;
        "pkg-1.12-2.4.0" = _VMlLmDzq;
        "pkg-1.12-2.4.1" = _sCoYZTQQ;
        "pkg-1.12-2.4.2" = _Qh9tj5jt;
        "pkg-1.12-2.4.3" = _LBjMHjfv;
        "pkg-1.1x-2.4.3" = _hPr1O39y;
        "pkg-1.12-2.4.4" = _gmrJ0tJw;
        "pkg-1.1x-2.4.5" = _poAGTKBw;
        "pkg-1.12-2.4.5" = _zhMy6uDx;
        "pkg-1.1x-2.5.0" = _c8m1nOU7;
        "pkg-1.12-2.5.0" = _hHxlcZ19;
        "pkg-1.1x-2.5.1" = _IaPgIn3x;
        "pkg-1.12-2.6.0" = _bKeBKklk;
        "pkg-1.12-2.6.1" = _tCqs4sms;
        "pkg-1.12-2.6.2" = _GMeRvQVk;
        "pkg-1.12-2.6.3" = _mcyqMbRp;
        "pkg-1.1x-2.5.2" = _giWnhElu;
        "pkg-1.12-2.6.4" = _qYIpUrGL;
        "pkg-1.1x-2.5.3" = _ettdcuoh;
        "pkg-1.12-2.6.5" = _eitgF98N;
        "pkg-1.12-2.6.6" = _vH6X73BW;
        "pkg-1.12-2.6.7" = _Av6JN5tD;
        "pkg-1.12-3.0.0-alpha" = _YOOBDXI9;
        "pkg-1.12-3.0.0" = _t9eRx38D;
        "pkg-1.12-3.0.1" = _wBUyhytw;
        "pkg-1.12-3.0.2" = _KVxef3Ro;
        "pkg-1.12-3.0.3" = _GpeqryBE;
        "pkg-1.12-3.0.4" = _12lgusaw;
        "pkg-1.12-3.0.5" = _FUYsuNVn;
        "pkg-1.12-3.0.6" = _G3HmgFAc;
        "pkg-1.12-3.0.7" = _Xu4X2BR8;
        "pkg-1.12-3.1.0" = _vpUwBYSv;
        "pkg-1.12-3.1.1" = _B0klPSnd;
        "pkg-1.12-3.5.0" = _PSPrejBJ;
        "pkg-1.12-3.5.1" = _a2fSArbA;
        "pkg-1.12-3.5.2" = _3b1Fu1xv;
        "pkg-1.12-3.5.3" = _2fT8dNQ7;
        "pkg-1.14-3.5.3-alpha" = _l1RfYFS9;
        "pkg-1.14-3.5.4-alpha" = _GslNeCc0;
        "pkg-1.12-3.5.4" = _KOV8fkZb;
        "pkg-1.14-3.5.5-alpha" = _YpX2CWcO;
        "pkg-1.14-3.5.6-alpha" = _1ObsOJL4;
        "pkg-1.14-3.5.7-alpha" = _Dhw8JLsT;
        "pkg-1.14-3.5.8-alpha" = _CkXC0wwH;
        "pkg-1.14-3.5.9-alpha" = _Or08B8t8;
        "pkg-1.14-3.5.10-alpha" = _GKdLX8CQ;
        "pkg-1.14-3.5.11-alpha" = _9i2dZDkH;
        "pkg-1.14-3.5.12-alpha" = _39fKa1wm;
        "pkg-1.14-3.5.13-alpha" = _oriE9JPx;
        "pkg-1.14-3.5.14-alpha" = _NGg4RbM2;
        "pkg-1.14-3.5.15-alpha" = _G9V3vl4Y;
        "pkg-1.14-3.5.16-alpha" = _OWazh9AG;
        "pkg-1.14-3.5.17-alpha" = _2iK42q23;
        "pkg-1.15-4.0.0-alpha" = _XJ86ymof;
        "pkg-1.15-4.0.1-alpha" = _wpWvgyLK;
        "pkg-1.15-4.0.2-alpha" = _GGzvLck9;
        "pkg-1.15-4.0.3-alpha" = _OZ7sPSqa;
        "pkg-1.15-4.1.0-beta" = _VL6UmQ7J;
        "pkg-1.15-4.1.1-beta" = _K50tTlCW;
        "pkg-1.15-4.1.2-beta" = _6dI9ePVv;
        "pkg-1.15-4.1.3-beta" = _YPjnjl5D;
        "pkg-1.15-4.1.4" = _6hLF0nqT;
        "pkg-1.16-5.0.0" = _hRWFfDMY;
        "pkg-1.16-5.0.1" = _Dw0QAl3r;
        "pkg-1.15-4.1.5" = _JkEDFWrz;
        "pkg-1.16-5.0.2" = _RsGOf1Xm;
        "pkg-1.15-4.1.6" = _53wd7p6z;
        "pkg-1.16-5.0.3" = _uRm3lwHr;
        "pkg-1.16-5.0.4" = _KZRGMkh8;
        "pkg-1.15-4.1.7" = _YkJSNE6Y;
        "pkg-1.16-5.0.5" = _AHw1I8gz;
        "pkg-1.16-5.0.6" = _GcoJ4rrm;
        "pkg-1.15-4.1.8" = _blXGeRnI;
        "pkg-1.16-5.0.7" = _BxeqInIB;
        "pkg-1.15-4.1.9" = _SaE8wzTa;
        "pkg-1.16-5.0.8" = _EmlSpIJy;
        "pkg-1.16-5.0.9" = _LyoASYaN;
        "pkg-1.15-4.1.10" = _CDDiPydU;
        "pkg-1.16-5.0.10" = _i0vHdnz0;
        "pkg-1.16-5.0.11" = _RoyhpnIq;
        "pkg-1.15-4.1.11" = _HYA6Jzf3;
        "pkg-1.16-5.0.12" = _1e7Crxke;
        "pkg-1.16-5.0.13" = _k9p770kw;
        "pkg-1.16-5.0.14" = _7Hs7Y8nJ;
        "pkg-1.15-4.1.12" = _5rN8Dwzm;
        "pkg-1.15-4.1.13" = _cWMCMaSk;
        "pkg-1.16-5.0.15" = _IsTjAu7t;
        "pkg-1.16-5.0.16" = _c6MyRiAL;
        "pkg-1.16-5.0.17" = _ZYdzhKn1;
        "pkg-1.16-5.0.18" = _YNMwXtAq;
        "pkg-1.16-5.0.19" = _2wkv1zwV;
        "pkg-1.16-5.0.20" = _sANGrEn5;
        "pkg-1.16-5.0.21" = _lHxePIOz;
        "pkg-1.16-5.0.22" = _xtudc9SK;
        "pkg-1.16-5.0.23" = _r9KIuJFj;
        "pkg-1.16-5.1.0" = _uZ8W53vt;
        "pkg-1.16-5.1.1" = _m0lDEG88;
        "pkg-1.16-5.1.2" = _uWAISKT1;
        "pkg-1.18-6.0.0" = _brYRY31h;
        "pkg-1.18-6.0.1" = _R2U6JjuE;
        "pkg-1.18-6.0.2" = _QXIaSGVm;
        "pkg-1.18-6.0.3" = _po2bpA5c;
        "pkg-1.18-6.0.4" = _VMP85Kxq;
        "pkg-1.18-6.0.5" = _LJkGxigR;
        "pkg-1.16-5.1.3" = _T0LB8HoH;
        "pkg-1.18-6.0.6" = _GDFVZwNV;
        "pkg-1.18-6.0.7" = _kKcfDC6I;
        "pkg-1.18-6.0.8" = _E9hOb58h;
        "pkg-1.16-5.1.4" = _wJgh9gs4;
        "pkg-1.18-6.0.9" = _HpayUWn9;
        "pkg-1.18-6.0.10" = _rOgm0k8X;
        "pkg-1.18-6.0.11" = _s2TGRv2i;
        "pkg-1.16-5.1.5" = _QrNEIHjS;
        "pkg-1.18-6.0.12" = _xGI3AiO3;
        "pkg-1.16-5.1.6" = _1PM3Aep0;
        "pkg-1.18-6.0.13" = _oMOvSOIT;
        "pkg-1.18-6.0.14" = _bBBMs7PX;
        "pkg-1.16-5.1.7" = _cVjrfKkx;
        "pkg-1.18-6.0.15" = _6dy2MBOj;
        "pkg-1.16-5.1.8" = _YZKmio6M;
        "pkg-1.19-7.0.0" = _CXleZnEv;
        "pkg-1.18-6.0.16" = _IpyErEFp;
        "pkg-1.19-7.0.1" = _6oCHSWrZ;
        "pkg-1.19-7.0.2" = _j89owbq8;
        "pkg-1.18-6.0.17" = _zEmiQlvF;
        "pkg-1.19-7.0.3" = _GnCndDvz;
        "pkg-1.18-6.0.18" = _ercQxbe5;
        "pkg-1.19-7.0.4" = _pe8By6jN;
        "pkg-1.19-7.0.5" = _37rCO3tc;
        "pkg-1.18-6.0.19" = _1XuyeeVL;
        "pkg-1.19-7.0.6" = _HVpUBEct;
        "pkg-1.18-6.0.20" = _SqbqcXXW;
        "pkg-1.19-7.0.7" = _mUPL5yXR;
        "pkg-1.19-7.1.1" = _SotTc0nM;
        "pkg-1.19.3-7.1.1" = _CvFdHKdC;
        "pkg-1.19-7.1.2" = _FR4NoBzw;
        "pkg-1.19.3-7.1.2" = _uIyenHSs;
        "pkg-1.19.3-7.1.3" = _bvXnSOcl;
        "pkg-1.19-7.1.4" = _MF0ki2yE;
        "pkg-1.19.3-7.1.4" = _yuWHLSi3;
        "pkg-1.19.3-7.1.5" = _GONIPdhx;
        "pkg-1.19-7.1.5" = _8c40rUPj;
        "pkg-1.19-7.2.1" = _7wsIneZt;
        "pkg-1.19.3-7.2.1" = _HmBlFdZV;
        "pkg-1.19.4-7.2.1" = _JxWcRXDz;
        "pkg-1.19-7.2.2" = _LYYf1UuZ;
        "pkg-1.19.3-7.2.2" = _FJifbkCd;
        "pkg-1.19.4-7.2.2" = _p9lFBuI6;
        "pkg-1.19.4-7.2.3" = _ShgZ1Zfe;
        "pkg-1.19-7.2.3" = _gvi0TIoY;
        "pkg-1.19-7.2.4" = _8Y2JVvXq;
        "pkg-1.19.3-7.2.4" = _BOrOrPz4;
        "pkg-1.19.4-7.2.4" = _oknxatZy;
        "pkg-1.19-7.2.5" = _7J3PfrH4;
        "pkg-1.19.3-7.2.5" = _oTJh7JHz;
        "pkg-1.19.4-7.2.5" = _l4POuphU;
        "pkg-1.19.4-7.2.6" = _3o4SBL30;
        "pkg-1.20-8.0.0" = _3LlgyvSh;
        "pkg-1.19.4-7.2.7" = _nSoxMtIk;
        "pkg-1.20-8.0.1" = _3atWkG7t;
        "pkg-1.20-8.0.2" = _FFTpP0Bw;
        "pkg-1.20-8.0.3" = _vA8GsEKt;
        "pkg-1.19-7.2.6" = _Li9LnuAb;
        "pkg-1.20-8.0.4" = _eH4rTH4E;
        "pkg-1.19-7.2.7" = _qYG3Hbs7;
        "pkg-1.20-8.0.5" = _xIiulPos;
        "pkg-1.19-7.2.8" = _47PU761N;
        "pkg-1.20-8.0.6" = _IjGaFb6t;
        "pkg-1.21-9.0.0" = _7SDk7DI4;
        "pkg-1.21-9.0.1" = _ISTn6xxD;
        "pkg-1.21-9.0.2" = _6l80Hw6o;
        "pkg-1.21-9.0.3" = _HPH0Dii2;
        "pkg-1.21-9.0.4" = _YThcyCfz;
        "pkg-1.21-9.0.5" = _MQ0sGLBg;
        "pkg-1.21-9.0.6" = _LD5Jmnmo;
        "pkg-1.21-9.0.7" = _9WfzUcxr;
        "pkg-1.21-9.0.8" = _ZIoN7RAg;
        "pkg-1.21-9.0.9" = _GqMpQ3ys;
        "pkg-1.20-8.0.7" = _pt0NR4gg;
        "pkg-1.21-9.0.10" = _EQ9usQLe;
        "pkg-1.21-9.0.11" = _E1Y4a6JZ;
        "pkg-1.21-9.0.12" = _IGqDkquo;
        "pkg-1.21-9.0.13" = _IsAKnjGV;
        "pkg-1.21-9.0.14" = _AWLkAjp8;
        "pkg-1.21-9.0.15" = _Ve7r7UG6;
        "pkg-1.21-9.0.16" = _4LTPCi9W;
        "pkg-1.21-9.0.17" = _5xakeXr2;
        "pkg-1.21-9.0.18" = _LhteonKO;
        "pkg-1.21-9.0.19" = _V2tf4JRK;
        "pkg-1.21-9.0.20" = _UUyC6hPr;
        "pkg-1.20-8.0.8" = _GIASnLXz;
        "pkg-1.21-9.0.21" = _9B2CiAN5;
        "default" = _9B2CiAN5;
    });
