...
let
    ...
    in {
        ...
        "pkg-B.02.O" = _tC0HeqNJ;
        "pkg-B.02.P" = _NQVCfQug;
        "pkg-B.02.Q" = _pbROLS56;
        "pkg-B.02.R" = _vftKMXZl;
        "pkg-B.02.S" = _2fWvdYN7;
        "pkg-B.02.T" = _POEiA7qV;
        "pkg-B.02.U" = _w5ujpTsG;
        "pkg-B.02.V" = _DfAeaLBR;
        "pkg-B.02.W" = _QHiBag9w;
        "pkg-B.02.X" = _m5zmYmxi;
        "pkg-B.02.Y" = _ocFRMOAG;
        "pkg-B.02.Z" = _lOxF4CfC;
        "pkg-B.03.A" = _DAtbNltW;
        "pkg-B.03.B" = _HLzsQLif;
        "pkg-B.03.C" = _8zqHdiNv;
        "pkg-B.03.D" = _F3icosD0;
        "pkg-B.03.E" = _gtZop5xc;
        "pkg-B.03.F" = _pR8NHTNW;
        "pkg-B.03.G" = _cgjGmARb;
        "pkg-B.03.H" = _sXV6zlCL;
        "pkg-B.03.I" = _olGj9N8S;
        "pkg-B.03.J" = _jQTynQCz;
        "pkg-B.03.K" = _Ntt4pXda;
        "pkg-B.03.L" = _sS2R2tsY;
        "default" = _sS2R2tsY;
    });
