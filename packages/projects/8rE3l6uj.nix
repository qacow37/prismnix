...
let
    ...
    in {
        ...
        "pkg-1.21" = _XdA7d21e;
        "pkg-1.21+mod" = _YbXzoLKN;
        "pkg-1.21.1" = _x48VPBRe;
        "pkg-1.21.1+mod" = _A3YDyaO0;
        "pkg-1.21.2" = _ui4CZrvO;
        "pkg-1.21.2+mod" = _7apP285B;
        "pkg-1.21.3" = _EEJmlfeW;
        "pkg-1.21.3+mod" = _FBRFdgxj;
        "pkg-1.21.4" = _5snEL48n;
        "pkg-1.21.4+mod" = _MJ0yz9u1;
        "pkg-1.21.5" = _zSPJLANE;
        "pkg-1.21.5+mod" = _VUpWlHry;
        "pkg-1.21.6" = _S4sI79iD;
        "pkg-1.21.6+mod" = _nG3api8c;
        "pkg-1.21.7" = _x9OCvutG;
        "pkg-1.21.7+mod" = _DiSBoBRh;
        "pkg-1.21.8" = _uFwkdQaU;
        "pkg-1.21.8+mod" = _iZzL4Ah0;
        "pkg-1.21.9" = _gBaL46wH;
        "pkg-1.21.9+mod" = _RRLJhYZI;
        "pkg-1.21.10" = _WAZcCDlG;
        "pkg-1.21-Plus+mod" = _ICtiolIO;
        "pkg-26.1" = _B224zkEt;
        "pkg-26.1+mod" = _KWAk4PvJ;
        "default" = _KWAk4PvJ;
    });
