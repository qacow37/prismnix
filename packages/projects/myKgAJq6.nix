...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _bw79bNtV;
        "pkg-1.5.0" = _7Ry9C1Of;
        "pkg-1.5.0+1.20.4" = _WuiUYZJH;
        "pkg-1.6.0+1.20.4" = _5pg0WqAA;
        "pkg-1.6.1+1.20.4" = _bxJIsb8c;
        "pkg-1.6.1+1.20.5" = _zvB8toeF;
        "pkg-1.6.1+1.20.6" = _o61Ijp5X;
        "pkg-1.6.1+1.21" = _dDaeRqTu;
        "pkg-1.6.2+1.21" = _DGrNnihT;
        "pkg-1.7.0" = _2P5vw4V5;
        "pkg-1.8.0" = _HsuyRRoL;
        "pkg-1.8.1" = _CtFT7bxE;
        "pkg-fabric-2.0.0+mc1.20.2" = _LLT1oFff;
        "pkg-fabric-2.0.0+mc1.20.4" = _8122JiEg;
        "pkg-fabric-2.0.0+mc1.19.4" = _4Sj5vDyT;
        "pkg-fabric-2.0.0+mc1.21.1" = _7S8E0FG3;
        "pkg-fabric-2.0.0+mc1.20.6" = _C7JIY7qK;
        "pkg-fabric-2.0.0+mc1.21" = _2Aa9L137;
        "pkg-fabric-2.0.0+mc1.21.3" = _9NLCWlyK;
        "pkg-fabric-2.0.0+mc1.21.4" = _GGjSGsTW;
        "pkg-fabric-2.0.0+mc1.21.5" = _fy6OqMuK;
        "pkg-fabric-2.0.0+mc1.21.8" = _iWVfrKUF;
        "pkg-neoforge-2.0.0+mc1.20.6" = _FN4QtfHT;
        "pkg-neoforge-2.0.0+mc1.20.4" = _4JjV6P41;
        "pkg-neoforge-2.0.0+mc1.21" = _dHVHEI31;
        "pkg-neoforge-2.0.0+mc1.21.3" = _jNsgSKJj;
        "pkg-neoforge-2.0.0+mc1.21.1" = _lwgqfaNI;
        "pkg-neoforge-2.0.0+mc1.21.4" = _3JtFhGF6;
        "pkg-neoforge-2.0.0+mc1.21.5" = _xTKEJAbM;
        "pkg-neoforge-2.0.0+mc1.21.8" = _ae5wC5wH;
        "pkg-neoforge-2.0.0+mc1.21.9" = _a78Hr3xt;
        "pkg-fabric-2.0.0+mc1.21.9" = _ozhIQuxP;
        "pkg-neoforge-2.0.0+mc1.21.10" = _FQSRHNT6;
        "pkg-fabric-2.0.0+mc1.21.10" = _FTnVgcNm;
        "pkg-fabric-2.0.0+mc1.21.11" = _2iJQ456i;
        "pkg-neoforge-2.0.0+mc1.21.11" = _6ktJEbbj;
        "pkg-mc26.1-2.1.0-neoforge" = _VFwWUvFy;
        "pkg-mc26.1-2.1.0-fabric" = _2JmzmTsp;
