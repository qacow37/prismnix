...
let
    ...
    in {
        ...
        "pkg-1.0-1.21" = _Ihu1opM7;
        "pkg-1.0-1.21.1" = _4iAHfFSX;
        "pkg-1.1-1.20.1" = _ACRi2MNb;
        "pkg-1.1-1.21" = _rbtnqPI2;
        "pkg-1.1-1.21.1" = _FHVFDGa7;
        "pkg-1.1.1-1.20.1" = _RpPq3ATl;
        "pkg-1.1.1-1.21.1" = _80MyY8YQ;
        "pkg-1.1.1-1.21.2" = _kSI0bq6q;
        "pkg-1.1.1-1.21.3" = _qfHKYEfj;
        "pkg-1.1.2-1.21.3" = _3qPWLGS0;
        "pkg-1.21.4-1.2" = _UHXEAk11;
        "pkg-1.20.1-1.1.3" = _dWecpxiX;
        "pkg-1.21.1-1.1.3" = _SuXN0QqL;
        "pkg-1.21.3-1.1.3" = _ICX3Md0Y;
        "pkg-1.21.4-1.2.1" = _MJKImkjE;
        "pkg-1.20.1-1.2.2" = _mcQAWc8b;
        "pkg-1.21.1-1.2.2" = _rGyemUIk;
        "pkg-1.21.3-1.2.2" = _5S4Twaeb;
        "pkg-1.21.4-1.2.2" = _C6aRsBTr;
        "pkg-1.21.5-1.2.2" = _UkEVQ1ir;
        "pkg-1.21.8-2.0" = _DL3Ufpha;
        "pkg-1.21.8-2.0.1" = _xccrSkbM;
        "pkg-1.21.8-2.1" = _66qClme0;
        "pkg-1.21.8-2.1.1" = _W96HOJIU;
        "pkg-1.21.8-2.2" = _NKQCY6kz;
        "pkg-1.21.10-2.2" = _uXLckcO7;
        "pkg-1.21.11-2.3" = _nGOlOZ5Q;
        "pkg-26.1.2-2.3" = _fRnldB9k;
