...
let
    ...
    in {
        ...
        "pkg-1.0.2+23w31a" = _aeEFhnwM;
        "pkg-1.0.2+23w32a" = _UsFGSyiE;
        "pkg-1.0.2+23w33a" = _29bCGtyS;
        "pkg-1.0.2+23w35a" = _DADMqa0K;
        "pkg-1.0.2+1.20.2-pre1" = _TkKnal66;
        "pkg-1.0.2+1.20.2-pre2" = _vseAb8Ge;
        "pkg-1.0.2+1.20.2-pre3" = _jNYuk1KW;
        "pkg-1.0.2+1.20.2-pre4" = _2ibUlM2y;
        "pkg-1.0.2+1.20.2-rc1" = _SlBwawnd;
        "pkg-1.0.2+1.20.2-rc1-1.20.2-rc2" = _WaDvcp9O;
        "pkg-1.0.2+1.20.2" = _GA5fQWwP;
        "pkg-1.0.3+23w41a" = _qneOkQv1;
        "pkg-1.0.3+23w42a" = _EeixE7lH;
        "pkg-1.0.3+23w43a" = _bZVvYYkY;
        "pkg-1.0.3+1.20-1.20.1" = _afnAoQTi;
        "pkg-s1.0.3+23w43b" = _97C4JbH9;
        "pkg-1.0.3+1.20.2" = _Kwtxiwsy;
        "pkg-s1.0.3+23w44a" = _K5au5Cnu;
        "pkg-s1.0.3+23w45a" = _Rk4gub9u;
        "pkg-s1.0.3+23w46a" = _S5Dlozk2;
        "pkg-s1.0.3+1.20.3-pre1" = _rfknnJKL;
        "pkg-1.1.0+1.20.2" = _i9CXUeL3;
        "pkg-1.1.0+1.20-1.20.1" = _pkvJ8vFE;
        "pkg-s1.1.0+1.20.3-pre1-1.20.3-rc1" = _S5duYX2r;
        "pkg-1.1.1+1.20.2-1.20.3" = _Cms7HZ20;
        "pkg-1.1.1+1.20-1.20.1" = _AzFHTyLV;
        "pkg-1.1.1+1.20.2-1.20.4" = _sBzguQR0;
        "pkg-1.1.2+1.20.2-1.20.4" = _zNNsNobp;
        "pkg-1.1.3+1.20-1.20.1" = _9RC1jgLa;
        "pkg-1.1.3+1.20.2-1.20.4" = _64Ph2wUH;
        "pkg-s1.1.3+24w03b" = _YvSQ4NU2;
        "pkg-1.1.4+1.20-1.20.1" = _yRayXLeH;
        "pkg-1.1.4+1.20.2-1.20.4" = _wuMBQ49N;
        "pkg-s1.1.4+1.20.5-pre1" = _ADIV5m9P;
        "pkg-1.1.4+1.20.5" = _5ibldTWu;
        "pkg-1.1.5+1.20.6" = _A0kfk7px;
        "pkg-1.1.5+1.20.2-1.20.4" = _PQVEDsrw;
        "pkg-1.1.5+1.20.1" = _LBPlizvM;
        "pkg-1.1.6+1.20.6" = _RCahS6Oh;
        "pkg-1.1.6+1.21" = _4cTV9eag;
        "pkg-1.1.6+1.20.4" = _13fieKGt;
        "pkg-1.1.6+1.20.1" = _vQUR6cgQ;
        "pkg-1.1.7+1.21" = _sHchUbpF;
        "pkg-1.2.0.0+1.21" = _P0exJKxv;
        "pkg-1.1.8+1.21" = _Nl20Sfvy;
        "pkg-1.1.8+1.20.6" = _phDooUKF;
        "pkg-1.1.8+1.20.4" = _MUS2YN3V;
        "pkg-1.1.8+1.20.1" = _ZZdDnczl;
        "pkg-1.2.0.1+1.21" = _Nft3QqQp;
        "pkg-1.1.9+1.21-1.21.1" = _WdpALvvv;
        "pkg-1.2.0.2+1.21-1.21.1" = _ruex5xdI;
        "pkg-1.2.0.3+1.21-1.21.1" = _2OJvFqNA;
        "pkg-1.1.10+1.20.1" = _iLrlRGHY;
        "pkg-1.1.10+1.20.4" = _DG3BZxwx;
        "pkg-1.1.10+1.20.6" = _FGAPJXqe;
        "pkg-1.1.10+1.21-1.21.1" = _XzGle247;
        "pkg-1.2.0.4+1.21-1.21.1" = _tqW1m05X;
        "pkg-1.2.0.5+1.21-1.21.1" = _eSdZKIw9;
        "pkg-1.2.0.6+1.21-1.21.1" = _ZBMV5K6l;
        "pkg-1.2.0.7+1.21-1.21.1" = _BXv7sN4Y;
        "pkg-1.2.0.8+1.21-1.21.1" = _QFrEHSRS;
        "pkg-1.1.10+1.21.2" = _EjnVIozp;
        "pkg-1.1.10+1.21.3" = _7k45fPnV;
        "pkg-1.2.0.8+1.21.3" = _Q50T5fDD;
        "pkg-1.2.0.9+1.21.3" = _gPR7xw2r;
        "pkg-1.2.0.10+1.21.3" = _GajAvBaq;
        "pkg-1.2.0+1.21.3" = _YDvOz4q0;
        "pkg-1.2.0+1.21-1.21.1" = _GNkZt2pd;
        "pkg-1.2.0+1.20.6" = _pU916s5i;
        "pkg-1.2.1+1.21.4" = _LmDd9wsK;
        "pkg-1.2.1+1.21.3" = _PmME7uTD;
        "pkg-1.2.1+1.20.6" = _ExAxyvr0;
        "pkg-1.2.1+1.21-1.21.1" = _UvuuwmsA;
        "pkg-1.2.1+1.20.4" = _sdcDwcmX;
        "pkg-1.2.1+1.20.1" = _VD4mDKYW;
        "pkg-1.2.2+1.21.4" = _2ytuxMt1;
        "pkg-1.2.2+1.21.3" = _HQgnpxPT;
        "pkg-1.2.2+1.21-1.21.1" = _Op6bkIE0;
        "pkg-1.2.2+1.20.6" = _SpFRxqDb;
        "pkg-1.2.2+1.20.4" = _Pb1rmrhz;
        "pkg-1.2.2+1.20.1" = _i92F5Bs5;
        "pkg-1.2.3+1.21.4" = _31bLjUY2;
        "pkg-1.2.3+1.21.5-pre2-1.21.5" = _cTgvJ5fT;
        "pkg-1.2.3+1.21.3" = _7RPpBaTk;
        "pkg-1.2.3+1.21-1.21.1" = _kuv8ny7G;
        "pkg-1.2.3+1.20.6" = _E5QWybP4;
        "pkg-1.2.3+1.20.4" = _ofRnlUVI;
        "pkg-1.2.3+1.20.1" = _sUV22q0D;
        "pkg-1.2.3+1.21.5" = _sRgfJ3uU;
        "pkg-1.2.3.1+1.21.5" = _QTTlGVkz;
        "pkg-1.2.3.1+1.21.4" = _KrowdcsU;
        "pkg-1.2.3.2+1.21.5" = _LQzcYAOs;
        "pkg-1.2.3.2+1.21.4" = _p95f9ot4;
        "pkg-1.2.3.2+1.21-1.21.1" = _4EkoZm7Q;
        "pkg-1.2.3.2+1.20.6" = _eZEdA8qc;
        "pkg-1.2.3.2+1.20.4" = _SrMqAMs6;
        "pkg-1.2.3.2+1.20.1" = _XjXmxWBs;
        "pkg-1.2.4.0+1.21.5" = _ANCsofgi;
        "pkg-1.2.4.1+1.21.5" = _hpPbXeff;
        "pkg-1.2.4.1+1.21.4" = _TdxMsbXY;
        "pkg-1.2.4.1+1.21-1.21.1" = _kQaL75j1;
        "pkg-1.2.4.1+1.20.6" = _MF6UDe0w;
        "pkg-1.2.4.1+1.20.4" = _j4eAAyhE;
        "pkg-1.2.4.1+1.20.1" = _zeBAjx3e;
        "pkg-1.2.4.2+1.21.5" = _4U9AyhqD;
        "pkg-1.2.4.3+1.21.5" = _6djKdeDX;
        "pkg-1.2.4.3+1.21.4" = _2kiWp8u8;
        "pkg-1.2.4.3+1.21-1.21.1" = _S4GySOuP;
        "pkg-1.2.4.3+1.20.6" = _H2BI2ivO;
        "pkg-1.2.4.3+1.20.4" = _xp5Bv7LB;
        "pkg-1.2.4.3+1.20.1" = _lD8cT1eu;
        "pkg-1.2.4.3+1.21.6" = _bbvv2A7Z;
        "pkg-1.2.4.5+1.21.6" = _FcCK9avL;
        "pkg-1.2.4.5+1.21.5" = _gKYxphmy;
        "pkg-1.2.4.5+1.21.7" = _ImC46K5m;
        "pkg-1.2.4.5+1.21.4" = _EQf3G23k;
        "pkg-1.2.4.5+1.21-1.21.1" = _qcOAEgdz;
        "pkg-1.2.4.5+1.20.6" = _OrGqRyTe;
        "pkg-1.2.4.5+1.20.4" = _uKBTMmFJ;
        "pkg-1.2.4.5+1.20.1" = _Qta76dAv;
        "pkg-1.2.4.5+1.21.8" = _m7lBLCr4;
        "pkg-1.2.4.6+1.21.8" = _qfWetil7;
        "pkg-1.2.4.7+1.21.8" = _yKe3ReZZ;
        "pkg-1.2.4.7+1.21.5" = _EbFBtGda;
        "pkg-1.2.4.7+1.21.4" = _yHBRKgO7;
        "pkg-1.2.4.7+1.21-1.21.1" = _Ow5Iv0Np;
        "pkg-1.2.4.7+1.20.6" = _YQwmLw2c;
        "pkg-1.2.4.7+1.20.4" = _dsZwCgjF;
        "pkg-1.2.4.7+1.20.1" = _el7DJLJF;
        "pkg-1.2.5.0+1.21.8" = _yGaQnuwV;
        "pkg-1.2.5.0+1.21.9-1.21.10" = _cJvlmbfO;
        "pkg-1.2.5.1+1.21.9-1.21.10" = _wOMpgPKm;
        "pkg-1.2.5.1+1.21.8" = _1LyZIoNv;
        "pkg-1.2.5.1+1.21.4" = _LdRWY1js;
        "pkg-1.2.5.1+1.21-1.21.1" = _wstK3UaY;
        "pkg-1.2.5.1+1.21.11" = _6skzufDg;
        "pkg-1.2.5.2+1.21.11" = _xy4C23w4;
        "pkg-1.2.6.0+26.1" = _9i13JWal;
        "pkg-1.2.6.0+26.1.1" = _HztkP6GQ;
