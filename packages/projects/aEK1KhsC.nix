...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.4-forge" = _11svO6iJ;
        "pkg-1.16.5-2.1-fabric" = _UfHRfXsA;
        "pkg-1.18.2-2.1-fabric" = _IokG6GBi;
        "pkg-1.19.2-2.1-fabric" = _s0AgvRBJ;
        "pkg-1.16.5-2.1-forge" = _EH9ELsIL;
        "pkg-1.18.2-2.1-forge" = _ayvJs9HV;
        "pkg-1.19.2-2.1-forge" = _AaNoWOQI;
        "pkg-1.16.5-2.2-fabric" = _21dXaQqv;
        "pkg-1.18.2-2.2-fabric" = _ZdFNxk6R;
        "pkg-1.19.2-2.2-fabric" = _aICv2F37;
        "pkg-1.19.3-2.3-fabric" = _QcJadeQ7;
        "pkg-1.19.3-2.1-forge" = _yWneDQK9;
        "pkg-1.18.2-3.0-forge+fabric" = _phxxvNKu;
        "pkg-1.19.2-3.0-forge+fabric" = _N1NLIe7R;
        "pkg-1.19.3-3.0-forge+fabric" = _zJVqkOTt;
        "pkg-1.19.4-3.0-forge+fabric" = _RzBZ0I77;
        "pkg-1.20-3.0-forge+fabric" = _1pNrgc4v;
        "pkg-1.20.1-3.0-forge+fabric" = _9MUSHIIy;
        "pkg-1.20.2-3.0-forge+fabric" = _ENCBv3iG;
        "pkg-1.18.2-3.1-forge+fabric" = _eicFvWGM;
        "pkg-1.19.2-3.1-forge+fabric" = _WerxCN00;
        "pkg-1.20.1-3.1-forge+fabric" = _Aeygx0QS;
        "pkg-1.20.2-3.1-forge+fabric" = _mrBhRHId;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _RTyWF9p5;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _2olrbDtb;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _3VT52MN8;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _gB3J2gKV;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _GSeMqtT7;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _8ksbv0lN;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _NOiJectP;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _tclx2z6H;
        "pkg-1.19.2-4.0-fabric+forge" = _lAzcc0Dt;
        "pkg-1.20.1-4.0-fabric+forge+neo" = _tmxFfz1u;
        "pkg-1.20.2-4.0-fabric+forge+neo" = _WOCDMOnD;
        "pkg-1.20.4-4.0-fabric+forge+neo" = _eoCzDGY0;
        "pkg-1.20.5-4.0-fabric+neo" = _b16Dy85M;
        "pkg-1.20.6-4.0-fabric+forge+neo" = _VJCbe9V7;
        "pkg-1.21.0-4.0-fabric+forge+neo" = _g859qvdL;
        "pkg-1.20.1-4.1-fabric+forge+neo" = _EenpGt3Q;
        "pkg-1.20.6-4.1-fabric+forge+neo" = _ht79LQ2X;
        "pkg-1.21.0-4.1-fabric+forge+neo" = _hCvvvlWc;
        "pkg-1.20.1-4.2-fabric+forge+neo" = _W0JWNiPZ;
        "pkg-1.20.6-4.2-fabric+forge+neo" = _wVqawRwV;
        "pkg-1.21.0-4.2-fabric+forge+neo" = _6gP18gBh;
        "pkg-1.21.1-4.2-fabric+forge+neo" = _FL8dt9f8;
        "pkg-1.21.2-4.2-fabric+neo" = _s9ujBTYa;
        "pkg-1.21.3-4.2-fabric+forge+neo" = _7k2o8Q6z;
        "pkg-1.21.4-4.2-fabric+forge+neo" = _VL41uDr8;
        "pkg-1.20.1-4.3-fabric+forge+neo" = _9UsRPWLi;
        "pkg-1.21.1-4.3-fabric+forge+neo" = _2BjVBEDx;
        "pkg-1.21.4-4.3-fabric+forge+neo" = _IzSPjMSj;
        "pkg-1.21.5-4.3-fabric+forge+neo" = _PeVUcOGT;
        "pkg-1.21.6-4.3-fabric+forge+neo" = _iD9mTduW;
        "pkg-1.21.7-4.3-fabric+forge+neo" = _QYFQD8IT;
        "pkg-1.21.8-4.3-fabric+forge+neo" = _qJz8K4AS;
        "pkg-1.20.1-4.4-fabric+forge+neo" = _Yu8lFWWG;
        "pkg-1.21.1-4.4-fabric+forge+neo" = _8S5iOkIh;
        "pkg-1.21.8-4.4-fabric+forge+neo" = _oY9ucpWf;
        "pkg-1.21.9-4.4-fabric+forge+neo" = _WNxN72PB;
        "pkg-1.21.9-4.5-fabric+forge+neo" = _ftAuRNlb;
        "pkg-1.21.10-4.5-fabric+forge+neo" = _AVUCk9xJ;
        "pkg-1.21.11-4.5-fabric+forge+neo" = _4PhWRSH8;
        "pkg-26.1.0-4.5-fabric+forge+neo" = _sBZN7ILY;
