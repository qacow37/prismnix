...
let
    ...
    in {
        ...
        "pkg-0.9.2-26.1" = _6UJphL0C;
        "pkg-0.9.2-1.21" = _wo3lw0Jd;
        "pkg-0.9.2-1.21.8.7" = _X6v6cwan;
        "pkg-0.9.2-1.21.6.5" = _CrOBVea4;
        "pkg-0.9.2-1.21.11" = _ksaQqinR;
        "pkg-0.9.2-1.21.1" = _UOWqf4mZ;
        "pkg-0.9.2-1.21.4.3" = _k0BVDS4h;
        "pkg-0.9.2-1.21.10" = _2ZJRqitZ;
        "pkg-0.9.3-1.21.4" = _TuLnhVA5;
        "pkg-0.9.3-1.21.6" = _DiKdjVfw;
        "pkg-0.9.3-26.1" = _iORsrFEA;
        "pkg-0.9.3-1.21.11" = _nArIhv4K;
        "pkg-0.9.3-1.21.8" = _QqgJ7sat;
        "pkg-0.9.3-1.21" = _MXrJedwM;
        "pkg-0.9.3-1.21.1" = _dTR0Yxvv;
        "pkg-0.9.3-1.21.10" = _t4g8eGqR;
        "pkg-0.9.4-1.21.10" = _k9hKgbri;
        "pkg-0.9.4-1.21.11" = _BKHfDMS2;
        "pkg-0.9.4-26.1" = _vxgcO6i4;
        "pkg-0.9.4-1.21.8" = _6OGJDwlB;
        "pkg-0.9.4-1.21.1" = _9fAu3xz2;
        "pkg-0.9.4-1.21" = _YeIuIIa1;
        "pkg-0.9.4-1.21.4" = _OQOhYx4F;
        "pkg-0.9.4-1.21.6" = _HYwIsbQq;
        "pkg-0.10.0-26.1" = _S7iGfMXn;
        "pkg-0.10.0-1.21.10" = _WYQyQCSb;
        "pkg-0.10.0-1.21.11" = _lfJi7KS6;
        "pkg-0.10.0-1.21.6" = _Op24qNUz;
        "pkg-0.10.0-1.21.8" = _BnPaDDJa;
        "pkg-0.10.0-1.21.4" = _p7K4mqjt;
        "pkg-0.10.0-1.21" = _GDuxs8wP;
        "pkg-0.10.0-1.21.1" = _QA3pjrpj;
        "pkg-0.10.2-1.21.1" = _NT6h88NR;
        "pkg-0.10.2-1.21.11" = _ktv4DGZO;
        "pkg-0.10.2-1.21.10" = _QIr6AFzl;
        "pkg-0.10.2-26.1" = _iAzhBGHU;
        "pkg-0.10.2-1.21.6" = _G4QfV8Nv;
        "pkg-0.10.2-1.21" = _UsYnK9bm;
        "pkg-0.10.2-1.21.4" = _8KlzdkZt;
        "pkg-0.10.2-1.21.8" = _uXtJHfhS;
        "pkg-0.10.3-1.21.11" = _vChdMEQr;
        "pkg-0.10.3-26.2" = _k2ldsiob;
        "pkg-0.10.3-1.21.1" = _LcUu0Neo;
        "pkg-0.10.3-1.21.8" = _QsrtiLv3;
        "pkg-0.10.3-26.1" = _QulTodYY;
        "pkg-0.10.3-1.21" = _X45RmAlz;
        "pkg-0.10.3-1.21.10" = _Bh2BgaIA;
        "pkg-0.10.3-1.21.6" = _PfhXm5y0;
        "pkg-0.10.3-1.21.4" = _ewrVsmzl;
        "default" = _ewrVsmzl;
    });
