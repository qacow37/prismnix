...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.10" = _bWvF9hFW;
        "pkg-1.0.1+1.21.11" = _iZIMUn17;
        "pkg-1.0.1+1.21.10" = _DzxEEgzA;
        "pkg-1.0.2+1.21.10" = _ej03B9Mm;
        "pkg-1.0.2+1.21.11" = _kPv6G0O7;
        "pkg-1.0.3+1.21.10" = _tx2Qkb68;
        "pkg-1.0.3+1.21.11" = _rikAhQcm;
        "pkg-1.0.3+26.1-snapshot-6" = _LBVC9sDH;
        "pkg-1.0.4+1.21.10" = _iaSAT8zb;
        "pkg-1.0.4+1.21.11" = _6uPO4UP1;
        "pkg-1.0.5+1.21.10" = _QQpaOIYt;
        "pkg-1.0.5+1.21.11" = _1J30JGCt;
        "pkg-1.1.0+1.21.10" = _AwP0gftb;
        "pkg-1.1.0+1.21.11" = _ujE6cOrw;
        "pkg-1.2.0+1.21.10" = _bawagi1C;
        "pkg-1.2.0+1.21.11" = _s8rR0Dnz;
        "pkg-1.2.1+1.21.10" = _F7ftIdEQ;
        "pkg-1.2.1+1.21.11" = _lhgucqPB;
        "pkg-1.2.1+26.1" = _Qw7tpeay;
        "pkg-1.2.1+26.1.1" = _yBABWGVQ;
        "pkg-1.2.1+26.1.2" = _KxiYLNys;
        "pkg-1.2.2+26.1" = _ymPnjERf;
        "pkg-1.2.2+26.2" = _qhpupqD6;
        "default" = _qhpupqD6;
    });
