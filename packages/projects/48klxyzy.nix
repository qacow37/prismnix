...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _fmDjC91m;
        "pkg-1.1.1" = _7TSDe9Zb;
        "pkg-1.0.0+mod" = _Xs7F1dNH;
        "pkg-1.0.1+mod" = _Hbmx8L6H;
        "pkg-1.0.2+mod" = _yfSrRl1I;
        "pkg-1.0.3+mod" = _RLh44JEJ;
        "pkg-1.1.0+mod" = _CBBlz8Yi;
        "pkg-1.1.1+mod" = _O9V7rY2Y;
        "pkg-1.1.2" = _rzZvEDkt;
        "pkg-1.1.2+mod" = _shuo3iyL;
        "default" = _shuo3iyL;
    });
