...
let
    ...
    in {
        ...
        "pkg-1.5-MC1.20.1-Forge" = _lrZgFzcQ;
        "pkg-1.5-MC23w40a" = _DMKt78JG;
        "pkg-1.0-MC1.12.2-Forge" = _b3WjMTNr;
        "pkg-1.0-MC1.14.4" = _v8GjTVcp;
        "pkg-1.0-MC1.15" = _wKYnkuDT;
        "pkg-1.0.1-MC1.12.2-Forge" = _8eJnY87G;
        "pkg-1.0.1-MC1.14.4" = _3FYBcdWX;
        "pkg-1.0.1-MC1.15" = _gx1fvDGP;
        "pkg-1.1-MC1.12.2-Forge" = _QosaEAsi;
        "pkg-1.1-MC1.14.4" = _GgKreaAc;
        "pkg-1.1-MC1.15.1" = _aIleODtn;
        "pkg-1.1-MC1.15.2" = _4UMiS1L3;
        "pkg-1.1-MC1.15" = _4o3WGeQG;
        "pkg-1.1-MC20w10a" = _pQPCRuY0;
        "pkg-1.1-MC20w11a" = _VRFR6y4J;
        "pkg-1.1-MC20w12a" = _39madX7S;
        "pkg-1.1-MC20w13a" = _txUzmEC3;
        "pkg-1.1-MC20w14a" = _5KcKkUhA;
        "pkg-1.1-MC20w14infinite" = _r3WsMnMm;
        "pkg-1.2-MC1.14.4" = _X0scFjLv;
        "pkg-1.2-MC1.15.1" = _pT8SFbVe;
        "pkg-1.2-MC1.15.2" = _zWbDG6wq;
        "pkg-1.2-MC1.15" = _A699PmC1;
        "pkg-1.2-MC1.16-pre1" = _VaPTDg9l;
        "pkg-1.2-MC1.16-pre2" = _G6IPIiMp;
        "pkg-1.2-MC1.16-pre3" = _a4CtfgbD;
        "pkg-1.2-MC1.16-pre4" = _RXMKwCKN;
        "pkg-1.2-MC1.16-pre5" = _dATvCzc6;
        "pkg-1.2-MC1.16-pre6" = _YeYSWNGt;
        "pkg-1.2-MC1.16-pre7" = _4ZBLDKc6;
        "pkg-1.2-MC1.16-pre8" = _jdnLMF0M;
        "pkg-1.2-MC1.16-rc1" = _gUvoqmxm;
        "pkg-1.2-MC1.16.1" = _7ciYCeUC;
        "pkg-1.2-MC1.16.2-pre1" = _76O6HT6J;
        "pkg-1.2-MC1.16.2-pre2" = _gkf0VLZO;
        "pkg-1.2-MC1.16.2-pre3" = _rLM9MxvS;
        "pkg-1.2-MC1.16.2-rc1" = _Vakt1fnU;
        "pkg-1.2-MC1.16.2-rc2" = _HNsrVd2m;
        "pkg-1.2-MC1.16.2" = _352fgBpH;
        "pkg-1.2-MC1.16.3-rc1" = _g5x746ru;
        "pkg-1.2-MC1.16.3" = _ynX5196h;
        "pkg-1.2-MC1.16.4-pre1" = _vZGnh0Z6;
        "pkg-1.2-MC1.16.4-pre2" = _EeGbpoxK;
        "pkg-1.2-MC1.16.4-rc1" = _WJ3V35Xy;
        "pkg-1.2-MC1.16.4" = _759PsRoc;
        "pkg-1.2-MC1.16" = _Qi6ZIwQg;
        "pkg-1.2-MC20w14a" = _SdHrbzp0;
        "pkg-1.2-MC20w15a" = _5jhk77e0;
        "pkg-1.2-MC20w16a" = _etjuTSqX;
        "pkg-1.2-MC20w17a" = _RKPtXSKm;
        "pkg-1.2-MC20w18a" = _BQjtHSJ4;
        "pkg-1.2-MC20w19a" = _tFLrcwHd;
        "pkg-1.2-MC20w20a" = _5iTqLV2D;
        "pkg-1.2-MC20w21a" = _50SnXAnP;
        "pkg-1.2-MC20w22a" = _7NdQfTzH;
        "pkg-1.2-MC20w27a" = _e4curUU3;
        "pkg-1.2-MC20w28a" = _Po7X2yWW;
        "pkg-1.2-MC20w29a" = _zzT7bfHR;
        "pkg-1.2-MC20w30a" = _3zEkkm9J;
        "pkg-1.3-MC1.16.3" = _A9ZudXEF;
        "pkg-1.3-MC1.16.4" = _hFgTW38x;
        "pkg-1.3-MC1.16.5" = _LYeHzIR8;
        "pkg-1.3-MC1.17-pre1" = _f2aq76ZR;
        "pkg-1.3-MC1.17-pre2" = _nLoBNZCN;
        "pkg-1.3-MC1.17-pre3" = _Ad0UqtvK;
        "pkg-1.3-MC1.17-pre4" = _E2FBG71z;
        "pkg-1.3-MC1.17-pre5" = _LhSzHQS5;
        "pkg-1.3-MC1.17-rc1" = _Jc6mMifG;
        "pkg-1.3-MC1.17-rc2" = _BWpPwhql;
        "pkg-1.3-MC1.17.1-pre1" = _IfjWyf2Z;
        "pkg-1.3-MC1.17.1-pre2" = _47Q8mIB8;
        "pkg-1.3-MC1.17.1-pre3" = _kjFxFSyu;
        "pkg-1.3-MC1.17.1-rc1" = _rac13wHm;
        "pkg-1.3-MC1.17.1-rc2" = _xYhr31q9;
        "pkg-1.3-MC1.17.1" = _OYzl0qI6;
        "pkg-1.3-MC1.17" = _IGc3sqJT;
        "pkg-1.3-MC1.18-pre1" = _JNKKhtB8;
        "pkg-1.3-MC1.18-pre2" = _T0vJfeEl;
        "pkg-1.3-MC1.18-pre4" = _82y17cNZ;
        "pkg-1.3-MC1.18-pre5" = _5vbnszHC;
        "pkg-1.3-MC1.18-pre6" = _3pvi7Qab;
        "pkg-1.3-MC1.18-pre7" = _fgV2Ajxh;
        "pkg-1.3-MC1.18-pre8" = _z1N7SpAI;
        "pkg-1.3-MC1.18-rc1" = _PXRNoJgr;
        "pkg-1.3-MC1.18-rc3" = _UAlqR5D8;
        "pkg-1.3-MC1.18-rc4" = _1rvQo1hv;
        "pkg-1.3-MC1.18.1-rc1" = _galLqbsy;
        "pkg-1.3-MC1.18.1-rc2" = _znh53cQU;
        "pkg-1.3-MC1.18.1" = _1w8BLhsU;
        "pkg-1.3-MC1.18.2-pre1" = _RtT4StGp;
        "pkg-1.3-MC1.18.2-pre2" = _riDRhzsJ;
        "pkg-1.3-MC1.18.2-pre3" = _Gj7Cisjc;
        "pkg-1.3-MC1.18.2-rc1" = _q7N3mfuC;
        "pkg-1.3-MC1.18.2" = _iezDWJbR;
        "pkg-1.3-MC1.18" = _zaDHpsmk;
        "pkg-1.3-MC1.19-pre1" = _OuyjUbYN;
        "pkg-1.3-MC1.19-pre2" = _uExW0fdL;
        "pkg-1.3-MC1.19-pre3" = _HfjrHwyr;
        "pkg-1.3-MC1.19-pre4" = _kCHoA2Tn;
        "pkg-1.3-MC1.19-pre5" = _ZIy8tj0G;
        "pkg-1.3-MC1.19-rc1" = _I3VHByeV;
        "pkg-1.3-MC1.19-rc2" = _i4CCkBLt;
        "pkg-1.3-MC1.19" = _WRKXlVzu;
        "pkg-1.3-MC20w45a" = _doZgKMOn;
        "pkg-1.3-MC20w46a" = _6RWuZj6K;
        "pkg-1.3-MC20w48a" = _UArGwfHf;
        "pkg-1.3-MC20w49a" = _OgknsOkn;
        "pkg-1.3-MC20w51a" = _b9N9ldVG;
        "pkg-1.3-MC21w03a" = _UnFoyWyE;
        "pkg-1.3-MC21w05a" = _IAWMVz74;
        "pkg-1.3-MC21w06a" = _DL8NPkCy;
        "pkg-1.3-MC21w07a" = _fHV5vq8A;
        "pkg-1.3-MC21w08a" = _5drvguma;
        "pkg-1.3-MC21w10a" = _6fzLAHTR;
        "pkg-1.3-MC21w11a" = _STeTmmyY;
        "pkg-1.3-MC21w13a" = _wR8zFC4q;
        "pkg-1.3-MC21w14a" = _lpy5Cwww;
        "pkg-1.3-MC21w15a" = _TNQ3zRgo;
        "pkg-1.3-MC21w16a" = _c5fW8ZJo;
        "pkg-1.3-MC21w17a" = _k0ZfHrfo;
        "pkg-1.3-MC21w18a" = _FTyfuzgE;
        "pkg-1.3-MC21w19a" = _KTK5lgL1;
        "pkg-1.3-MC21w20a" = _9yqFNrfD;
        "pkg-1.3-MC21w37a" = _tEUg8uza;
        "pkg-1.3-MC21w38a" = _FloTe8ee;
        "pkg-1.3-MC21w39a" = _ALN37EM8;
        "pkg-1.3-MC21w40a" = _bG4MeXS2;
        "pkg-1.3-MC21w41a" = _j9qezMR7;
        "pkg-1.3-MC21w42a" = _67OvBUCU;
        "pkg-1.3-MC21w43a" = _AgX1OR6K;
        "pkg-1.3-MC21w44a" = _Ev9A2TMm;
        "pkg-1.3-MC22w03a" = _unAio2Ci;
        "pkg-1.3-MC22w06a" = _sEObQDZW;
        "pkg-1.3-MC22w07a" = _JTy7rMrz;
        "pkg-1.3-MC22w11a" = _eF5pIh7r;
        "pkg-1.3-MC22w12a" = _MWJW793V;
        "pkg-1.3-MC22w13a" = _qmUpOnc7;
        "pkg-1.3-MC22w13oneblockatatime" = _NqS5XoK9;
        "pkg-1.3-MC22w14a" = _ggbSiSiP;
        "pkg-1.3-MC22w15a" = _pQ1ytFFe;
        "pkg-1.3-MC22w16b" = _5OjmKU4P;
        "pkg-1.3-MC22w17a" = _DdkMnh9Y;
        "pkg-1.3-MC22w18a" = _uzF9oLNd;
        "pkg-1.3-MC22w19a" = _AgvDoU43;
        "pkg-1.3-MC22w05a" = _o7wwVlZJ;
        "pkg-1.4-MC1.18.2" = _B52SYAiT;
        "pkg-1.4-MC1.19.1-pre1" = _zZxtVFx5;
        "pkg-1.4-MC1.19.1-pre2" = _YLc3MdSJ;
        "pkg-1.4-MC1.19.1-pre3" = _cAIx1JcZ;
        "pkg-1.4-MC1.19.1-pre4" = _s2MYxa5x;
        "pkg-1.4-MC1.19.1-pre5" = _u8mVhynU;
        "pkg-1.4-MC1.19.1-pre6" = _W7RbsNnF;
        "pkg-1.4-MC1.19.1-rc1" = _60q0oPYk;
        "pkg-1.4-MC1.19.1-rc2" = _lMB7EBjh;
        "pkg-1.4-MC1.19.1-rc3" = _CiES4SjL;
        "pkg-1.4-MC1.19.1" = _wG3dUYz4;
        "pkg-1.4-MC1.19.2" = _G95e71N3;
        "pkg-1.4-MC1.19.3-pre1" = _VhJHJZZz;
        "pkg-1.4-MC1.19.3-pre2" = _bddyDl97;
        "pkg-1.4-MC1.19.3-pre3" = _QERTzKha;
        "pkg-1.4-MC1.19.3-rc1" = _l7bwDV8X;
        "pkg-1.4-MC1.19.3-rc2" = _WaHFoJvr;
        "pkg-1.4-MC1.19.3-rc3" = _UiLFdCUX;
        "pkg-1.4-MC1.19.3" = _Vcsl3FzK;
        "pkg-1.4-MC1.19.4-pre1" = _F3KU4gZD;
        "pkg-1.4-MC1.19.4-pre2" = _lOg14vmS;
        "pkg-1.4-MC1.19.4-pre3" = _JSobW91w;
        "pkg-1.4-MC1.19.4-pre4" = _uE5yMfHX;
        "pkg-1.4-MC1.19.4-rc1" = _r6CUYTE1;
        "pkg-1.4-MC1.19.4-rc2" = _i9MD215x;
        "pkg-1.4-MC1.19.4-rc3" = _mkFqVaU8;
        "pkg-1.4-MC1.19.4" = _qRqDVxie;
        "pkg-1.4-MC1.19" = _GzmKyD8p;
        "pkg-1.4-MC1.20-pre1" = _llzFtgiT;
        "pkg-1.4-MC1.20-pre2" = _uDpCYEMU;
        "pkg-1.4-MC1.20-pre3" = _itkhAMLH;
        "pkg-1.4-MC1.20-pre4" = _ybX7Mohi;
        "pkg-1.4-MC1.20-pre5" = _EnlwP01J;
        "pkg-1.4-MC1.20-pre6" = _RJUmTmoD;
        "pkg-1.4-MC1.20-pre7" = _vJvXPIDY;
        "pkg-1.4-MC1.20-rc1" = _zCRzC9tx;
        "pkg-1.4-MC1.20.1-rc1" = _JRlDfcVW;
        "pkg-1.4-MC1.20.1" = _ODMZmlaW;
        "pkg-1.4-MC1.20.2-pre1" = _HqT8V720;
        "pkg-1.4-MC1.20.2-pre2" = _joxAl3ZQ;
        "pkg-1.4-MC1.20.2-pre3" = _IssqlIa9;
        "pkg-1.4-MC1.20.2-pre4" = _8jBMMK42;
        "pkg-1.4-MC1.20.2-rc1" = _yzdjNPE1;
        "pkg-1.4-MC1.20.2-rc2" = _I0LEgsU7;
        "pkg-1.4-MC1.20.2" = _UFJC4eOt;
        "pkg-1.4-MC1.20" = _y51AVwkD;
        "pkg-1.4-MC22w42a" = _5OUzhBYB;
        "pkg-1.4-MC22w43a" = _LaQRsiev;
        "pkg-1.4-MC22w44a" = _GPooLTXV;
        "pkg-1.4-MC22w45a" = _JVrq5lSB;
        "pkg-1.4-MC22w46a" = _XZIuS6aW;
        "pkg-1.4-MC23w03a" = _SZXqpfRN;
        "pkg-1.4-MC23w04a" = _dGUlb0Gt;
        "pkg-1.4-MC23w05a" = _sxeEU8ah;
        "pkg-1.4-MC23w06a" = _MOhdvtJ0;
        "pkg-1.4-MC23w07a" = _YeOASNON;
        "pkg-1.4-MC23w12a" = _6qkJQJE0;
        "pkg-1.4-MC23w13a" = _km64nbEY;
        "pkg-1.4-MC23w13a_or_b" = _EVMbfAKM;
        "pkg-1.4-MC23w14a" = _soCzhFeb;
        "pkg-1.4-MC23w16a" = _JnOSH0Ri;
        "pkg-1.4-MC23w17a" = _dboirnep;
        "pkg-1.4-MC23w18a" = _nDG32R4Z;
        "pkg-1.4-MC23w31a" = _9ozqicuS;
        "pkg-1.4-MC23w32a" = _GHImrbCh;
        "pkg-1.4-MC23w33a" = _ciVZm4UG;
        "pkg-1.4-MC23w35a" = _Aha7LqWB;
        "pkg-1.5-MC1.20.1" = _AYN9L9xU;
        "pkg-1.5-MC1.20.2" = _uK3fldtL;
        "pkg-1.5-MC23w41a" = _b7evAx2w;
        "pkg-1.5-MC23w42a" = _ZLfv1C29;
        "pkg-1.5-MC23w43a" = _f0laRBxN;
        "pkg-1.5-MC23w44a" = _H5geexH5;
        "pkg-1.5-MC23w45a" = _fhSQPNhG;
        "pkg-1.5-MC23w46a" = _oacdPnau;
        "pkg-1.5-MC1.20.3-pre1" = _515EkPe0;
        "pkg-1.5-MC1.20.3-pre2" = _1cuhKuKT;
        "pkg-1.5-MC1.20.3-pre3" = _EE8fCsIq;
        "pkg-1.5-MC1.20.3-pre4" = _WKkxqGlj;
        "pkg-1.5-MC1.20.3-rc1" = _ocwNSKVC;
        "pkg-1.5-MC1.20.3" = _76Eh7mtl;
        "pkg-1.5-MC1.20.4-rc1" = _LBDreDRM;
        "pkg-1.5-MC1.20.4" = _qm9wM46U;
        "pkg-1.5-MC23w51b" = _vxovBBV4;
        "pkg-1.5-MC24w03b" = _NVvC33PU;
        "pkg-1.5-MC24w04a" = _k1YYcuIh;
        "pkg-1.5-MC24w05a" = _GEn5ZPuR;
        "pkg-1.5-MC24w06a" = _ZOcKEVaM;
        "pkg-1.5-MC24w07a" = _KVgOXBsd;
        "pkg-1.5-MC24w09a" = _10y0L1O2;
        "pkg-1.5-MC24w10a" = _75HaeSuc;
        "pkg-1.5-MC24w11a" = _9z0CmeIy;
        "pkg-1.5-MC24w12a" = _2WRimdje;
        "pkg-1.5-MC24w13a" = _tud9esIC;
        "pkg-1.5-MC24w14potato" = _JmPsxFzV;
        "pkg-1.5-MC24w14a" = _gXVDdKCQ;
        "pkg-1.5-MC1.20.5-pre1" = _caOh1iam;
        "pkg-1.5-MC1.20.5-pre2" = _jPXkN9G5;
        "pkg-1.5-MC1.20.5-pre3" = _2O7Xx8FB;
        "pkg-1.5-MC1.20.5-pre4" = _dt2STAXw;
        "pkg-1.5-MC1.20.5-rc1" = _NmqxS9Oe;
        "pkg-1.5-MC1.20.5-rc2" = _Mn4zmYf4;
        "pkg-1.5-MC1.20.5-rc3" = _QFYH3vhv;
        "pkg-1.5-MC1.20.5" = _9brAZOSI;
        "pkg-1.5-MC1.20.6-rc1" = _nlQ6rLtn;
        "pkg-1.5-MC1.20.6" = _ycgAvYkZ;
        "pkg-1.5-MC24w18a" = _DE31Xdow;
        "pkg-1.5-MC24w19b" = _ep7zSxvf;
        "pkg-1.5-MC24w20a" = _mTHkDDfi;
        "pkg-1.5-MC24w21b" = _An5xIk93;
        "pkg-1.5-MC1.21-pre1" = _XohdbKZq;
        "pkg-1.5-MC1.21-pre2" = _ZrUk9m8k;
        "pkg-1.5-MC1.21-pre3" = _xPxt99D2;
        "pkg-1.5-MC1.21-pre4" = _It7zJjsR;
        "pkg-1.5-MC1.21-rc1" = _FLcoOH5w;
        "pkg-1.5-MC1.21" = _MPjGDe4j;
        "pkg-1.5-MC1.21.1-rc1" = _xN8zoKmC;
        "pkg-1.5-MC1.21.1" = _BMvLe1xP;
        "pkg-1.5-MC24w33a" = _22f9johy;
        "pkg-1.5-MC24w34a" = _lqoKgQVU;
        "pkg-1.5-MC24w35a" = _XG588pxs;
        "pkg-1.5-MC24w36a" = _5F8XjnGm;
        "pkg-1.5-MC24w37a" = _wJoVGhrv;
        "pkg-1.5-MC24w38a" = _1y51MVWk;
        "pkg-1.5-MC24w39a" = _oktm5U0h;
        "pkg-1.5-MC24w40a" = _bu2PmVTt;
        "pkg-1.5-MC1.21.2-pre1" = _OBKDf5oB;
        "pkg-1.5-MC1.21.2-pre2" = _l9VC6IDf;
        "pkg-1.5-MC1.21.2-pre3" = _6vdcS74L;
        "pkg-1.5-MC1.21.2-pre4" = _obQYW388;
        "pkg-1.5-MC1.21.2-pre5" = _gOlrf2yr;
        "pkg-1.5-MC1.21.2-rc1" = _ny9XnTgX;
        "pkg-1.5-MC1.21.2-rc2" = _3viDXDKs;
        "pkg-1.5-MC1.21.2" = _QPj8YySm;
        "pkg-1.5-MC1.21.3" = _rKlBvhji;
        "pkg-1.5-MC24w44a" = _cOB7ti9A;
        "pkg-1.5-MC24w45a" = _Ewam86M7;
        "pkg-1.5-MC24w46a" = _5I5DvGFs;
        "pkg-1.5-MC1.21-NeoForge" = _6DvhzVLj;
        "pkg-1.5-MC1.21.3-NeoForge" = _9dnSdu2l;
        "pkg-1.5-MC1.21.4-pre1" = _JTGQNCme;
        "pkg-1.5-MC1.21.4-pre2" = _TGINx22H;
        "pkg-1.5-MC1.21.4-pre3" = _JyH5wilL;
        "pkg-1.5-MC1.21.4-rc1" = _jEpUR3x0;
        "pkg-1.5-MC1.21.4-rc2" = _tELGi0Ya;
        "pkg-1.5-MC1.21.4-rc3" = _vOM4O6Gs;
        "pkg-1.5-MC1.21.4" = _OhrlMpy2;
        "pkg-1.6-MC1.21.4" = _tOlzaBh2;
        "pkg-1.6-MC25w02a" = _fqfpZVvG;
        "pkg-1.6-MC25w03a" = _INLCKTMd;
        "pkg-1.6-MC1.21.3" = _CjiZoTBh;
        "pkg-1.6-MC1.21.3-NeoForge" = _Ep9VcovD;
        "pkg-1.6-MC1.21.4-NeoForge" = _3dDnCt7n;
        "pkg-1.6-MC25w04a" = _JdY6Io6Q;
        "pkg-1.6-MC25w05a" = _DImNTKah;
        "pkg-1.6-MC25w06a" = _7r6gkeTq;
        "pkg-1.6-MC25w07a" = _7ovYBBSp;
        "pkg-1.6-MC25w08a" = _JRCHAj82;
        "pkg-1.6-MC25w09a" = _OY4cCH7k;
        "pkg-1.6-MC25w09b" = _NPhwkpHV;
        "pkg-1.6-MC25w10a" = _dT5LAphv;
        "pkg-1.6-MC1.21.1" = _phLIy7fX;
        "pkg-1.6-MC1.21.1-NeoForge" = _NBm3hI80;
        "pkg-1.6-MC1.21-NeoForge" = _XZQFIAAx;
        "pkg-1.6-MC1.20.1" = _bp1VnPr8;
        "pkg-1.6-MC1.20.6-NeoForge" = _bzf7slc5;
        "pkg-1.6-MC1.20.5-NeoForge" = _9B6k79UM;
        "pkg-1.6-MC1.20.4-NeoForge" = _gn0lJEcJ;
        "pkg-1.6-MC1.20.2-NeoForge" = _IKANQpaZ;
        "pkg-1.6-MC1.21.5-pre1" = _IoKQwGYy;
        "pkg-1.6-MC1.21.5-pre2" = _H7f4k3L7;
        "pkg-1.6-MC1.21.5-pre3" = _9ZCJ3sPC;
        "pkg-1.6-MC1.21.5-rc1" = _2Z0ybU3N;
        "pkg-1.6-MC1.21.5-rc2" = _Mvjxm4GM;
        "pkg-1.6-MC1.21.5" = _TQkylBBi;
        "pkg-1.6-MC25w14craftmine" = _Z8lk2I7I;
        "pkg-1.6-MC25w15a" = _u564SzqD;
        "pkg-1.6-MC25w16a" = _Ku2jFvR5;
        "pkg-1.6-MC25w17a" = _t5QZX8r5;
        "pkg-1.6-MC25w18a" = _xG8CtNXm;
        "pkg-1.6-MC25w19a" = _tuItivhW;
        "pkg-1.6-MC25w20a" = _ydYFjg6Q;
        "pkg-1.6-MC25w21a" = _7mq67byr;
        "pkg-1.6-MC1.21.6-pre1" = _cBgzjvv6;
        "pkg-1.6-MC1.21.6-pre2" = _IpSA1SAu;
        "pkg-1.6-MC1.21.6-pre3" = _CxrQrAlY;
        "pkg-1.6-MC1.21.6-pre4" = _OdwAuGKJ;
        "pkg-1.6-MC1.21.6-rc1" = _3hW3oRwr;
        "pkg-1.6-MC1.21.6" = _c4jHWR3K;
        "pkg-1.6-MC1.21.7-rc1" = _H8lOAFtW;
        "pkg-1.6-MC1.21.7-rc2" = _MLJZbURu;
        "pkg-1.6-MC1.21.7" = _80ZMCkDa;
        "pkg-1.6-MC1.21.8-rc1" = _4y1FzdzY;
        "pkg-1.6-MC1.21.8" = _fKhB2TtP;
        "pkg-1.6-MC25w31a" = _SQoj8Dok;
        "pkg-1.6-MC25w32a" = _ZutQfIc4;
        "pkg-1.6-MC25w33a" = _eCcQ3dOM;
        "pkg-1.6-MC25w34b" = _LRyiHiUh;
        "pkg-1.6-MC25w35a" = _GyzoubLw;
        "pkg-1.6-MC25w36b" = _7NFgSkEv;
        "pkg-1.6-MC25w37a" = _ROKVHIUk;
        "pkg-1.6-MC1.21.9-pre1" = _QdxiNAok;
        "pkg-1.6-MC1.21.9-pre2" = _VvEUg1Ep;
        "pkg-1.6-MC1.21.9-pre3" = _nDUMoZD1;
        "pkg-1.6-MC1.21.9-pre4" = _BwvwbADx;
        "pkg-1.6-MC1.21.9-rc1" = _taMgK3Bs;
        "pkg-1.6-MC1.21.9" = _l0ePqxZD;
        "pkg-1.6-MC1.21.10-rc1" = _qiQuIAqu;
        "pkg-1.6-MC1.21.10" = _KVbFtIKX;
        "pkg-1.6-MC25w41a" = _dxJ6ecLn;
        "pkg-1.6-MC25w42a" = _6eEWagHY;
        "pkg-1.6-MC25w43a" = _1FFAohnI;
        "pkg-1.6-MC25w44a" = _xpRxlGiH;
        "pkg-1.6-MC25w45a" = _3EfBgOKU;
        "pkg-1.6-MC25w46a" = _amm5D5s0;
        "pkg-1.6-MC1.21.11-pre1" = _P9ZkXsNP;
        "pkg-1.6-MC1.21.11-pre2" = _lW3MQZma;
        "pkg-1.7-MC1.21.1" = _6GKBs4pI;
        "pkg-1.7-MC1.21.4" = _RHZZsTVv;
        "pkg-1.7-MC1.21.8" = _ly02uKHA;
        "pkg-1.7-MC1.21.10" = _bGzfUfMu;
        "pkg-1.7-MC1.21.11-pre2" = _anbcUz6r;
        "pkg-1.7-MC1.21.11-pre3" = _JESBe0aY;
        "pkg-1.7-MC1.21.11-pre4" = _R5j5JX6n;
        "pkg-1.7-MC1.21.11-pre5" = _1myZvRj4;
        "pkg-1.7-MC1.21.11-rc1" = _17No140j;
        "pkg-1.7-MC1.21.11-rc2" = _OT41TA5K;
        "pkg-1.7-MC1.21.11-rc3" = _Kjh4CTZ4;
        "pkg-1.7-MC1.21.11" = _8TffgKNp;
        "pkg-1.7-MC26.1-snapshot-1" = _knAZqrIZ;
        "pkg-1.7-MC26.1-snapshot-2" = _tWnkb2qn;
        "pkg-1.7-MC26.1-snapshot-3" = _TBMlS62q;
        "pkg-1.7-MC26.1-snapshot-4" = _tqxFKUoX;
        "pkg-1.7-MC26.1-snapshot-5" = _3uHp99ZY;
        "pkg-1.7-MC26.1-snapshot-6" = _oOa0iHvv;
        "pkg-1.7-MC26.1-snapshot-7" = _HjCSDC3a;
        "pkg-1.7-MC26.1-snapshot-8" = _H8BAnP7u;
        "pkg-1.7-MC26.1-snapshot-9" = _QQFPoHZb;
        "pkg-1.7-MC26.1-snapshot-10" = _w09eAEj8;
        "pkg-1.7-MC26.1-snapshot-11" = _jD09FY6B;
        "pkg-1.7-MC26.1-pre-1" = _fOFYCvb8;
        "pkg-1.7-MC26.1-pre-2" = _hoF1jL17;
        "pkg-1.7-MC26.1-pre-3" = _RTjuJRkY;
        "pkg-1.7-MC26.1-rc-1" = _4AQzLiYF;
        "pkg-1.7-MC26.1-rc-2" = _o6G0fnYm;
        "pkg-1.7-MC26.1-rc-3" = _XzS4dHee;
        "pkg-1.7-MC26.1" = _pjgnJOcl;
        "pkg-1.7-MC26.1.1-rc-1" = _1UaB1lRc;
        "pkg-1.7-MC26.1.1" = _a27UWgMq;
        "pkg-1.7-MC26w14a" = _R2kZxIiQ;
        "pkg-1.7-MC26.2-snapshot-1" = _rZpnXQtd;
        "pkg-1.7-MC26.1.2-rc-1" = _MRpYHam8;
        "pkg-1.7-MC26.1.2" = _ePFy2DEx;
        "pkg-1.7-MC26.2-snapshot-2" = _49zZG1Zb;
        "pkg-1.7-MC26.2-snapshot-3" = _pBzeeTY4;
        "pkg-1.7-MC26.2-snapshot-4" = _eHWP1pYb;
        "pkg-1.7-MC26.2-snapshot-5" = _dGlOhpbS;
        "pkg-1.7-MC26.2-snapshot-6" = _hwBvHYPU;
        "pkg-1.7-MC26.2-snapshot-7" = _3DTWhPTP;
        "pkg-1.7-MC26.2-snapshot-8" = _11O60v7L;
        "pkg-1.7-MC26.2-pre-1" = _SHIaGbg2;
        "pkg-1.7-MC26.2-pre-2" = _RFkyIA0s;
        "pkg-1.7-MC26.2-pre-3" = _z6VLEbxt;
        "pkg-1.7-MC26.2-pre-4" = _nFRYmShs;
        "pkg-1.7-MC26.2-pre-5" = _AVLBTj8g;
        "pkg-1.7-MC26.2-pre-6" = _VyCwm8ES;
        "pkg-1.7-MC26.2-rc-1" = _qyRNSsJu;
        "pkg-1.7-MC26.2-rc-2" = _QLlAmcFu;
        "pkg-1.7-MC26.2" = _765pKqRg;
        "pkg-1.7-MC26.3-snapshot-1" = _vebXFA1X;
        "pkg-1.7-MC26.3-snapshot-2" = _j9zmOioK;
        "pkg-1.7-MC26.3-snapshot-3" = _m0PnNGOx;
        "pkg-1.7-MC26.3-snapshot-4" = _QrgzxCfs;
        "pkg-1.7-MC26.3-snapshot-5" = _wTlndyTV;
        "pkg-1.7-MC26.3-snapshot-6" = _Bg6G24EN;
        "default" = _Bg6G24EN;
    });
