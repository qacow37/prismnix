...
let
    ...
    in {
        ...
        "pkg-1.0.0-mc1.20.6" = _RacKZyun;
        "pkg-1.0.1-mc1.20.6" = _gHbOK6Kj;
        "pkg-1.0.2-mc1.20.6" = _Wap8ZLV4;
        "pkg-1.0.3-mc1.20.6" = _sK2jtB1M;
        "pkg-1.0.4-mc1.20.6" = _zU9g1Ub0;
        "pkg-1.0.5-mc1.20.6" = _38QBoOxc;
        "pkg-1.0.6-mc1.21.1" = _5fvlTkMa;
        "pkg-1.0.6-mc1.20.1" = _Bs8Biq6q;
        "pkg-1.1.0-mc1.20.1" = _5y8Zosmj;
        "pkg-1.1.0-mc1.21.1" = _jTDA3kNq;
        "pkg-1.1.1-mc1.21.1" = _PWHf2Qyi;
        "pkg-1.1.1-mc1.21.4" = _8YbeRTk7;
        "pkg-1.1.2-mc1.21.1" = _wXVRvelG;
        "pkg-1.1.2-mc1.21.4" = _jw53hibD;
        "pkg-1.2.0-mc1.21.4" = _SQD4wXRY;
        "pkg-1.2.1-mc1.21.4" = _Gx46OTEO;
        "pkg-1.2.2-mc1.21.4" = _9mnTF3hW;
        "pkg-1.2.2-mc1.20.1" = _A5cWMvkX;
        "pkg-1.3.0-mc1.21.4" = _grAiZ3xg;
        "pkg-1.3.1-mc1.20.1" = _AB0bc3o2;
        "pkg-1.3.1-mc1.20.6" = _K4L1UD0Z;
        "pkg-1.3.1-mc1.21.1" = _L5UGmu2W;
        "pkg-1.3.1-mc1.21.4" = _BJ5hcFSo;
        "pkg-1.3.1-mc1.19.4" = _qJxUURxj;
        "pkg-1.3.2-mc1.17.1" = _7IabwSSN;
        "pkg-1.3.2-mc1.18.2" = _MuGAlMIz;
        "pkg-1.3.2-mc1.19.4" = _6HMu5lqG;
        "pkg-1.3.2-mc1.20.1" = _cfysOEso;
        "pkg-1.3.2-mc1.20.6" = _RPr86eAh;
        "pkg-1.3.2-mc1.21.1" = _gftjhDeo;
        "pkg-1.3.2-mc1.21.4" = _A8aXkAaY;
        "pkg-1.3.3-mc1.17.1" = _S5vZtYd5;
        "pkg-1.3.3-mc1.18.2" = _coP44Pn2;
        "pkg-1.3.3-mc1.19.4" = _ebddpJWE;
        "pkg-1.3.3-mc1.20.1" = _mF9X3Y7T;
        "pkg-1.3.3-mc1.20.6" = _uQnzNVOK;
        "pkg-1.3.3-mc1.21.1" = _D2UCmSJG;
        "pkg-1.3.3-mc1.21.4" = _LfJPGLvL;
        "pkg-1.3.4-mc1.16.5" = _zkBlln6u;
        "pkg-1.3.4-mc1.17.1" = _Pb16gqs0;
        "pkg-1.3.4-mc1.18.2" = _JFXJunGC;
        "pkg-1.3.4-mc1.19.4" = _JAP6vauV;
        "pkg-1.3.4-mc1.20.6" = _DQG4mcNt;
        "pkg-1.3.4-mc1.21.1" = _XjBLtFry;
        "pkg-1.3.4-mc1.21.4" = _UmbJSqvN;
        "pkg-1.3.4-mc1.20.1" = _UJQQZWbd;
        "pkg-1.3.5-mc1.16.5" = _LUEIM9V9;
        "pkg-1.3.5-mc1.17.1" = _6MT58QYP;
        "pkg-1.3.5-mc1.18.2" = _eZD5Cbrf;
        "pkg-1.3.5-mc1.19.4" = _8mmoCmk4;
        "pkg-1.3.5-mc1.20.1" = _ibiKSETq;
        "pkg-1.3.5-mc1.20.6" = _u0qYTDiX;
        "pkg-1.3.5-mc1.21.1" = _OKvoGnH8;
        "pkg-1.3.5-mc1.21.4" = _6k0bUkIR;
        "pkg-1.3.5-mc1.21.5" = _fLEq4Aac;
        "pkg-1.3.6-mc1.16.5" = _pwvh8Jfy;
        "pkg-1.3.6-mc1.17.1" = _sGctqiZo;
        "pkg-1.3.6-mc1.18.2" = _9FhmZAqQ;
        "pkg-1.3.6-mc1.19.4" = _BON30q1G;
        "pkg-1.3.6-mc1.20.1" = _UJQQBjwE;
        "pkg-1.3.6-mc1.20.6" = _BAsDigUT;
        "pkg-1.3.6-mc1.21.1" = _av98j7qp;
        "pkg-1.3.6-mc1.21.4" = _KfqwoyMD;
        "pkg-1.3.6-mc1.21.5" = _62xXzE6c;
        "pkg-1.3.7-mc1.16.5" = _K9UTesDC;
        "pkg-1.3.7-mc1.17.1" = _9wzKgqTk;
        "pkg-1.3.7-mc1.18.2" = _bTwIJtFy;
        "pkg-1.3.7-mc1.19.4" = _1k8nbXVI;
        "pkg-1.3.7-mc1.20.1" = _OhIsCG54;
        "pkg-1.3.7-mc1.20.6" = _eyeb9Cs6;
        "pkg-1.3.7-mc1.21.1" = _FPuxEnid;
        "pkg-1.3.7-mc1.21.4" = _U550rW7i;
        "pkg-1.3.7-mc1.21.5" = _UuWxfSCg;
        "pkg-1.4.0-mc1.16.5" = _NQgXYfrL;
        "pkg-1.4.0-mc1.17.1" = _1bH6spWU;
        "pkg-1.4.0-mc1.18.2" = _52oH3PrT;
        "pkg-1.4.0-mc1.19.4" = _foWqFy4r;
        "pkg-1.4.0-mc1.20.1" = _NmF9jE5D;
        "pkg-1.4.0-mc1.20.6" = _zRcIoLZB;
        "pkg-1.4.0-mc1.21.1" = _4iTAtV0A;
        "pkg-1.4.0-mc1.21.4" = _JEakC6RA;
        "pkg-1.4.0-mc1.21.5" = _7tPlnbnT;
        "pkg-1.4.0-mc1.21.6" = _hu7KcnPs;
        "pkg-1.4.1-mc1.16.5" = _S7WZj2uD;
        "pkg-1.4.1-mc1.17.1" = _MhhZOBqQ;
        "pkg-1.4.1-mc1.18.2" = _uBoSMUV3;
        "pkg-1.4.1-mc1.19.4" = _DAl95405;
        "pkg-1.4.1-mc1.20.1" = _nBFiL214;
        "pkg-1.4.1-mc1.20.6" = _8k0CDvep;
        "pkg-1.4.1-mc1.21.1" = _7Fi6UW55;
        "pkg-1.4.1-mc1.21.4" = _7kZ5CKvG;
        "pkg-1.4.1-mc1.21.5" = _VGJfwJ5b;
        "pkg-1.4.1-mc1.21.6" = _dxderKC5;
        "pkg-1.4.2-mc1.16.5" = _gZS8vReg;
        "pkg-1.4.2-mc1.17.1" = _ZKMoXsb4;
        "pkg-1.4.2-mc1.18.2" = _OYNDrnrh;
        "pkg-1.4.2-mc1.19.4" = _IgJn5yCA;
        "pkg-1.4.2-mc1.20.1" = _edRyzksF;
        "pkg-1.4.2-mc1.20.6" = _OLgBIVAL;
        "pkg-1.4.2-mc1.21.1" = _BD498W1R;
        "pkg-1.4.2-mc1.21.4" = _KnQJSjyp;
        "pkg-1.4.2-mc1.21.5" = _ZczdxILq;
        "pkg-1.4.2-mc1.21.6" = _OuRqTUGT;
        "pkg-1.5.0-mc1.16.5" = _FcSeNpHb;
        "pkg-1.5.0-mc1.18.2" = _bVuLcBog;
        "pkg-1.5.0-mc1.21.4" = _8ps3jOrk;
        "pkg-1.5.0-mc1.21.6" = _VNtvwaTK;
        "pkg-1.5.0-mc1.19.4" = _ybIJpcKx;
        "pkg-1.5.0-mc1.20.6" = _ACPh89fi;
        "pkg-1.5.0-mc1.21.10" = _64fGX86D;
        "pkg-1.5.0-mc1.20.1" = _7MmIAUOR;
        "pkg-1.5.0-mc1.21.1" = _ofDonvaH;
        "pkg-1.5.0-mc1.17.1" = _rgEXFtAv;
        "pkg-1.5.0-mc1.21.5" = _D36gm4uc;
        "pkg-1.5.0-mc1.21.11" = _WpDaeb2c;
        "pkg-1.5.0-mc1.20.4" = _W6MCAxBk;
        "pkg-forge-1.5.0-mc1.16.5" = _hzq9iiHy;
        "pkg-forge-1.5.0-mc1.17.1" = _fWewbVKD;
        "pkg-forge-1.5.0-mc1.18.2" = _cF7G8lPe;
        "pkg-forge-1.5.0-mc1.19.4" = _7p3EZ9OU;
        "pkg-forge-1.5.0-mc1.20.1" = _u41xv11v;
        "pkg-forge-1.5.0-mc1.20.4" = _kUgKOZS0;
        "pkg-forge-1.5.0-mc1.20.6" = _HWNIEATn;
        "pkg-neoforge-1.5.0-mc1.21.1" = _tqzfcil2;
        "pkg-neoforge-1.5.0-mc1.21.10" = _bSav1mrK;
        "pkg-neoforge-1.5.0-mc1.21.11" = _prEtFn07;
        "pkg-neoforge-1.5.0-mc1.21.2" = _bnqyd8Mz;
        "pkg-neoforge-1.5.0-mc1.21.4" = _bEgeIpEh;
        "pkg-neoforge-1.5.0-mc1.21.6" = _fBvDnDsK;
        "pkg-neoforge-1.5.0-mc1.21.7" = _xaN8nWlx;
        "pkg-neoforge-1.5.0-mc1.21.5" = _NCtxLD5p;
        "pkg-2.0.0-fabric" = _jYUQrEkF;
        "pkg-2.0.0-neoforge" = _F9spo4L6;
        "pkg-2.0.0-paper" = _Ve0tLmit;
        "pkg-fabric-2.0.1-mc1.21.11" = _NFmmrRlw;
        "pkg-neoforge-2.0.1-mc1.21.11" = _wFyn5623;
        "pkg-fabric-2.0.2-mc1.20.6" = _hzlyrMfW;
        "pkg-neoforge-2.0.2-mc1.20.6" = _8mVSDbkw;
        "pkg-paper-2.0.2-mc1.20.6" = _QouKml16;
        "pkg-fabric-2.0.2-mc26.1.2" = _uxjPtU0z;
        "pkg-fabric-2.0.2-mc1.21.6" = _AkjwLM3T;
        "pkg-fabric-2.0.2-mc1.21.1" = _HccW62wy;
        "pkg-neoforge-2.0.2-mc26.1.2" = _cBGNKUt0;
        "pkg-neoforge-2.0.2-mc1.21.6" = _Ab1HUI7r;
        "pkg-neoforge-2.0.2-mc1.21.1" = _rtKWdQdY;
        "pkg-paper-2.0.2-mc26.1.2" = _CKqwyiW5;
        "pkg-paper-2.0.2-mc1.21.6" = _GPvOlN0B;
        "pkg-paper-2.0.2-mc1.21.1" = _jAmgasI4;
        "pkg-fabric-2.0.2-mc1.21.11" = _dL3oN59E;
        "pkg-neoforge-2.0.2-mc1.21.11" = _cv4OxAVA;
        "pkg-paper-2.0.2-mc1.21.11" = _DDsJa4Aa;
        "pkg-fabric-2.0.3-mc26.1.2" = _VecoVV7k;
        "pkg-neoforge-2.0.3-mc26.1.2" = _R20BwUqc;
        "pkg-paper-2.0.3-mc26.1.2" = _Bxjcww7y;
        "pkg-fabric-2.0.3-mc1.20.6" = _6t9XdW3V;
        "pkg-neoforge-2.0.3-mc1.20.6" = _vXVOyD7M;
        "pkg-fabric-2.0.3-mc1.21.11" = _bl9soNjE;
        "pkg-fabric-2.0.3-mc1.21.1" = _4amltIH6;
        "pkg-paper-2.0.3-mc1.20.6" = _Uuq3mwld;
        "pkg-neoforge-2.0.3-mc1.21.11" = _YowZVGu3;
        "pkg-neoforge-2.0.3-mc1.21.1" = _q5AAS8OR;
        "pkg-paper-2.0.3-mc1.21.11" = _API63CAL;
        "pkg-paper-2.0.3-mc1.21.1" = _fplF1sh4;
        "pkg-fabric-2.0.3-mc1.21.6" = _KgBDAJwW;
        "pkg-neoforge-2.0.3-mc1.21.6" = _7lIQhSdk;
        "pkg-paper-2.0.3-mc1.21.6" = _noTONyjY;
        "pkg-fabric-2.0.4-mc26.1.2" = _j5KHum1h;
        "pkg-neoforge-2.0.4-mc26.1.2" = _lIO1fkbK;
        "pkg-paper-2.0.4-mc26.1.2" = _zYqViQRa;
        "pkg-fabric-2.0.4-mc1.20.6" = _owaDFz1Y;
        "pkg-neoforge-2.0.4-mc1.20.6" = _XeKJ0mCo;
        "pkg-paper-2.0.4-mc1.20.6" = _3PT0qgpB;
        "pkg-fabric-2.0.4-mc1.21.6" = _ZpAimwYn;
        "pkg-fabric-2.0.4-mc1.21.11" = _WZGlvFNs;
        "pkg-neoforge-2.0.4-mc1.21.6" = _F9EvznNF;
        "pkg-neoforge-2.0.4-mc1.21.11" = _aqn3GPkn;
        "pkg-paper-2.0.4-mc1.21.6" = _KS57h49z;
        "pkg-paper-2.0.4-mc1.21.11" = _D3h43zmX;
        "pkg-fabric-2.0.4-mc1.21.1" = _YvpeTtsZ;
        "pkg-neoforge-2.0.4-mc1.21.1" = _pZVazJod;
        "pkg-paper-2.0.4-mc1.21.1" = _BDTT3XRS;
        "pkg-fabric-2.0.4-mc26.2" = _cbeqLZOv;
        "pkg-neoforge-2.0.4-mc26.2" = _ytVSU6vU;
        "pkg-paper-2.0.4-mc26.2" = _BHCCTCid;
        "pkg-fabric-2.1.0-mc26.2" = _Q8P2OGrC;
        "pkg-neoforge-2.1.0-mc26.2" = _nVCTqSUW;
        "pkg-paper-2.1.0-mc26.2" = _XcmfQXOu;
        "pkg-fabric-2.1.0-mc1.20.1" = _APWxLeaj;
        "pkg-paper-2.1.0-mc1.20.1" = _40zGXGrw;
        "pkg-fabric-2.1.0-mc26.1.2" = _w3PPfpCY;
        "pkg-neoforge-2.1.0-mc26.1.2" = _aLVnn9Op;
        "pkg-paper-2.1.0-mc26.1.2" = _VOSHqVkj;
        "pkg-fabric-2.1.0-mc1.21.1" = _HSSzRqhf;
        "pkg-neoforge-2.1.0-mc1.21.1" = _4a69Ou7Q;
        "pkg-paper-2.1.0-mc1.21.1" = _qkLhPDYN;
        "pkg-fabric-2.1.0-mc1.20.6" = _PVpBGJfg;
        "pkg-neoforge-2.1.0-mc1.20.6" = _lnkwQrjh;
        "pkg-paper-2.1.0-mc1.20.6" = _8JPlgxSG;
        "pkg-fabric-2.1.0-mc1.21.6" = _EV8NrmWF;
        "pkg-neoforge-2.1.0-mc1.21.6" = _fbCqedx5;
        "pkg-paper-2.1.0-mc1.21.6" = _IBzPKyKk;
        "pkg-fabric-2.1.0-mc1.21.11" = _RqU5MmXy;
        "pkg-neoforge-2.1.0-mc1.21.11" = _vZ8WLyqP;
        "pkg-paper-2.1.0-mc1.21.11" = _KgwzjFC0;
        "default" = _KgwzjFC0;
    });
