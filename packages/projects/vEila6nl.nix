...
let
    ...
    in {
        ...
        "pkg-1.0.0.2" = _JinyWE7G;
        "pkg-1.0.0.3" = _Fj43QiQ4;
        "pkg-1.0.0.4" = _QT9ChUOE;
        "pkg-1.0.0.5" = _9nurWrdi;
        "pkg-1.0.0.6" = _lFFFc39P;
        "pkg-1.0.0.7" = _MW1Z3gtB;
        "pkg-1.0.0.8" = _s8yyQsEj;
        "pkg-1.0.0.9" = _g61Vomzw;
        "pkg-1.0.0.10" = _blVGMOvC;
        "pkg-1.0.0.11" = _CKyhq2GR;
        "pkg-1.0.0.12" = _Q88giDw5;
        "pkg-1.0.0.13" = _6j4URcbw;
        "pkg-1.0.0.14" = _qZmzSC1r;
        "pkg-1.0.0.17" = _ubJ6eNXb;
        "pkg-1.0.0.18" = _A01OfElf;
        "pkg-1.0.0.19" = _KTUSocY0;
        "pkg-1.0.0.20" = _shb0BBl1;
        "pkg-1.0.0.21" = _kKEVay2f;
        "pkg-1.0.0.23" = _HLQXZFra;
        "pkg-1.0.0.24" = _ypEdi8cT;
        "pkg-1.0.0.25" = _CVERLpeE;
        "pkg-1.0.0.26" = _qKgNF4R1;
        "pkg-2.0.0" = _21P517Lo;
        "pkg-2.0.0.5" = _ZAFKKxqF;
        "pkg-2.0.0.6" = _OCgS4UbF;
        "pkg-2.0.0.7" = _4SBIMU92;
        "pkg-2.0.0.8" = _WFIo11QF;
        "pkg-2.0.0.9" = _Uo1i5hor;
        "pkg-2.0.0.10" = _x7wXaZbe;
        "pkg-2.0.0.11" = _mDvKE0el;
        "pkg-2.0.0.12" = _ePoltGnE;
        "pkg-2.0.0.13" = _R94P1DMP;
        "pkg-2.0.0.14" = _ndWWEi9W;
        "pkg-2.0.0.15" = _F2kiUKpU;
        "pkg-2.0.0.16" = _JYOuN8tu;
        "pkg-2.0.0.17" = _VsOaF2L7;
        "pkg-3.0.0.2" = _xp0PZRgP;
        "pkg-1.0.0.28" = _isoDdfVP;
        "pkg-3.0.0.3" = _iDgQARe3;
        "pkg-2.0.0.18" = _jO1IfGMU;
        "pkg-3.0.0.4" = _jqK91wDa;
        "pkg-3.0.0.5" = _1Ons0pUn;
        "pkg-2.0.0.19" = _JP5kYaCL;
        "pkg-3.0.0.6" = _1I2j1hm7;
        "pkg-4.0.5" = _6jQYYQfv;
        "pkg-4.0.6" = _HfErXcPX;
        "pkg-4.0.7" = _9dpKg67e;
        "pkg-4.0.8" = _7Ci9zjJj;
        "pkg-4.0.9" = _VL21gppz;
        "pkg-4.0.10" = _KofpAc2W;
        "pkg-4.0.11" = _pVrHkw74;
        "pkg-4.0.12" = _kFzX6Oos;
        "pkg-4.0.13" = _aqgQBtnH;
        "pkg-4.0.15" = _C5FpflFw;
        "default" = _C5FpflFw;
    });
