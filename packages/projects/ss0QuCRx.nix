...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18" = _y3ADI8cG;
        "pkg-1.0.0+1.19.2" = _TZ2T8Id5;
        "pkg-1.0.1+1.19.2" = _Y4727ZxQ;
        "pkg-1.0.1+1.18.2" = _4Bh5RrnX;
        "pkg-1.2.0+1.18" = _zVpb1SLh;
        "pkg-1.2.1+1.18" = _GQtWJagN;
        "pkg-1.2.1+1.19" = _8O4Ue0i1;
        "pkg-1.2.2+1.19" = _gKDb6QtA;
        "pkg-1.2.2+1.18" = _mG6nBPWx;
        "pkg-1.2.3+1.18" = _joofh8FS;
        "pkg-1.2.3+1.19" = _9WcxdAN6;
        "pkg-1.3.0+1.18" = _saYNCVQr;
        "pkg-1.3.0+1.19" = _Ir7YITuk;
        "pkg-1.3.1+1.19" = _3uG6UEME;
        "pkg-1.3.2+1.18" = _cu89XdoL;
        "pkg-1.3.2+1.19" = _TJMUnyTs;
        "pkg-1.3.3+1.18" = _iUlNmRKG;
        "pkg-1.3.3+1.19" = _bFvTDnfs;
        "pkg-1.3.4+1.18" = _aFk531f5;
        "pkg-1.3.4+1.19" = _KZEvxP1W;
        "pkg-1.3.5+1.18" = _stmweBgf;
        "pkg-1.3.5+1.19" = _TQZ2COwj;
        "pkg-1.3.6+1.18" = _jKfFof1g;
        "pkg-1.3.6+1.19" = _PE6i1Qqd;
        "pkg-1.4.0+1.18" = _uURqwLy2;
        "pkg-1.4.0+1.19" = _i0TLwFb5;
        "pkg-1.4.1+1.18" = _17e5LZbH;
        "pkg-1.4.1+1.19" = _YvfxBH6O;
        "pkg-1.4.2+1.18" = _H924WPdr;
        "pkg-1.4.2+1.19" = _ZkSUxPkH;
        "pkg-1.4.3+1.19" = _oQjb4gDl;
        "pkg-1.4.3+1.18" = _DKWtqRle;
        "pkg-1.5.0+1.18" = _sSPyx4EN;
        "pkg-1.5.0+1.19" = _BbUPomYi;
        "pkg-1.5.2+1.19" = _VExiGNoj;
        "pkg-1.6.0+1.18" = _EUjgcJ0M;
        "pkg-1.6.0+1.19" = _Zvj2Sbhj;
        "pkg-1.6.1+1.18" = _2ytxb09a;
        "pkg-1.6.1+1.19" = _QBgpNuq5;
        "pkg-1.7.0+1.18" = _i2wfbBP8;
        "pkg-1.7.0+1.19" = _jMgjUpg8;
        "pkg-1.7.1+1.19" = _h6PmVyUO;
        "pkg-1.7.1+1.18" = _lRN3E2yF;
        "pkg-1.7.2+1.19" = _ck4L9BQH;
        "pkg-1.7.2+1.18" = _79ktLAlB;
        "pkg-1.7.3+1.19" = _1vYA5tBI;
        "pkg-1.7.3+1.18" = _BAyBGcUJ;
        "pkg-1.8.0+1.18" = _O6Q6ecac;
        "pkg-1.8.0+1.19" = _hwPuPjs4;
        "pkg-1.8.1+1.18" = _oX5blZlF;
        "pkg-1.8.1+1.19" = _L2Y0CWbp;
        "pkg-1.8.2+1.18" = _RHHUbiIu;
        "pkg-1.8.2+1.19" = _2Ot3nou2;
        "pkg-1.8.3+1.18" = _bSARsNCZ;
        "pkg-1.8.3+1.19" = _qZGrKEHK;
        "pkg-1.8.4+1.18" = _jGnUBzXi;
        "pkg-1.8.4+1.19" = _u8lZHkYz;
        "pkg-1.8.5+1.18" = _gzQhvIjW;
        "pkg-1.8.5+1.19" = _JCnmIVKS;
        "pkg-1.8.6+1.18" = _hVJEJCkj;
        "pkg-1.8.6+1.19" = _e5TtFXqQ;
        "pkg-1.8.7+1.18" = _irOuCuQA;
        "pkg-1.8.7+1.19" = _ihAEXFWH;
        "pkg-1.8.8+1.19" = _uLxBEtR8;
        "pkg-1.8.9+1.18" = _UauHFPL0;
        "pkg-1.8.9+1.19" = _E6mzXrMF;
        "pkg-1.8.13+1.18" = _T0wd5cNv;
        "pkg-1.8.13+1.19" = _klAvtriW;
        "pkg-1.8.14+1.18" = _QHSmFarh;
        "pkg-1.8.14+1.19" = _AxLdtnPw;
        "pkg-1.8.15+1.18" = _fQofeLbi;
        "pkg-1.8.15+1.19" = _YXubBocR;
        "pkg-1.9.0+1.19" = _jF2tqEhU;
        "pkg-1.9.1+1.19" = _eRnvF0v9;
        "pkg-2.0.0+1.19" = _bkZGifuj;
        "pkg-2.0.1+1.19" = _X54stArX;
        "pkg-2.0.2+1.19" = _21XeynUo;
        "pkg-2.0.3+1.19" = _BbamfGtN;
        "pkg-2.0.4+1.19" = _LYENMXjs;
        "pkg-2.0.5+1.19" = _CHqGBYAB;
        "pkg-2.0.6+1.19" = _NrNlTdYF;
        "pkg-2.0.7+1.19" = _ouF2MzXb;
        "pkg-2.1.0+1.19" = _Zao87Jgf;
        "pkg-2.1.1+1.19" = _EYReoM5o;
        "pkg-2.1.2+1.19" = _XyMAEtok;
        "pkg-2.1.3+1.19" = _k9Q5quv4;
        "pkg-2.1.4+1.19" = _f2wqkXFI;
        "pkg-2.1.5+1.19" = _mSR3gJOP;
        "pkg-2.1.6+1.19" = _P4EJHyEg;
        "pkg-2.1.7+1.19" = _pXU1bPXN;
        "pkg-2.1.7+1.19.3" = _ceRcXTh9;
        "pkg-2.1.7+1.19.4" = _cDHIiH8D;
        "pkg-2.1.8+1.19.3" = _3NYIRbsG;
        "pkg-2.1.8+1.19.4" = _YTKsLtsA;
        "pkg-2.1.8+1.20" = _KGy2UwfN;
        "pkg-2.2.0+1.19" = _auuBDoVA;
        "pkg-2.2.0+1.19.3" = _U9xVY7lV;
        "pkg-2.2.0+1.19.4" = _PMTeg3ZW;
        "pkg-2.2.0+1.20" = _HpglsVaj;
        "pkg-2.3.0+1.19" = _BxysJ2fg;
        "pkg-2.3.0+1.19.3" = _u8dodnSJ;
        "pkg-2.3.0+1.19.4" = _LoX5U2l9;
        "pkg-2.3.0+1.20" = _PIs1GUun;
        "pkg-2.4.0+1.19" = _dmTYwh5z;
        "pkg-2.4.0+1.19.3" = _VhsGbonD;
        "pkg-2.4.0+1.19.4" = _PGvHT2tJ;
        "pkg-2.4.0+1.20" = _pPZjdUBR;
        "pkg-2.4.1+1.19" = _fSWrBqWe;
        "pkg-2.4.1+1.19.3" = _om3f37MQ;
        "pkg-2.4.1+1.19.4" = _Ja9bGH5R;
        "pkg-2.4.1+1.20" = _vMYO9jtt;
        "pkg-2.5.0+1.19" = _ABB7mqSu;
        "pkg-2.5.0+1.19.3" = _x2TnP8kt;
        "pkg-2.5.0+1.19.4" = _7unjZh4K;
        "pkg-2.5.0+1.20" = _VAFAmlvb;
        "pkg-2.6.0+1.19" = _HMf3W4ua;
        "pkg-2.6.0+1.19.3" = _j1aSedt2;
        "pkg-2.6.0+1.19.4" = _cgJ0Ytov;
        "pkg-2.6.0+1.20" = _Zp8UnVNy;
        "pkg-2.6.1+1.19" = _qdj2aHxy;
        "pkg-2.6.1+1.19.3" = _AqpKwAFM;
        "pkg-2.6.1+1.19.4" = _Q3OTuJqf;
        "pkg-2.6.1+1.20" = _gHmQ1464;
        "pkg-2.6.2+1.19" = _hlQ1y2EI;
        "pkg-2.6.2+1.19.3" = _b7AcCrGx;
        "pkg-2.6.2+1.19.4" = _gZzm1xyz;
        "pkg-2.6.2+1.20" = _HkAFhInH;
        "pkg-2.6.3+1.19" = _Zw5hIWKz;
        "pkg-2.6.3+1.19.3" = _fFuVvwEs;
        "pkg-2.6.3+1.19.4" = _7Xikq6vw;
        "pkg-2.6.3+1.20" = _UDucPgnB;
        "pkg-2.6.4+1.19" = _HA1oTeoa;
        "pkg-2.6.4+1.19.3" = _4HcCqyj8;
        "pkg-2.6.4+1.19.4" = _GlghBxw9;
        "pkg-2.6.4+1.20" = _NgpcBdhS;
        "pkg-2.7.0+1.19" = _2fRPY0bb;
        "pkg-2.7.0+1.19.3" = _Dexm8We8;
        "pkg-2.7.0+1.19.4" = _n6MNXqLX;
        "pkg-2.7.0+1.20" = _y35ze71i;
        "pkg-2.7.1+1.19" = _h0x2s1EU;
        "pkg-2.7.1+1.19.3" = _NHsdN5PG;
        "pkg-2.7.1+1.19.4" = _DVUhABpR;
        "pkg-2.7.1+1.20" = _rCGlRa0O;
        "pkg-2.7.2+1.19.4" = _pU7t9Jz4;
        "pkg-2.7.3+1.19" = _dhhephXO;
        "pkg-2.7.3+1.19.3" = _oLoirsy6;
        "pkg-2.7.3+1.19.4" = _UcnqEcDs;
        "pkg-2.7.3+1.20" = _GcfSryZh;
        "pkg-2.8.0+1.19" = _BXE8q7GL;
        "pkg-2.8.0+1.19.3" = _Hj2FJ6Uz;
        "pkg-2.8.0+1.19.4" = _Opj77YYB;
        "pkg-2.8.0+1.20" = _vkwiQaqu;
        "pkg-2.8.1+1.19" = _1l4n6xmZ;
        "pkg-2.8.1+1.19.3" = _G0uxcXRI;
        "pkg-2.8.1+1.19.4" = _v9sn47bM;
        "pkg-2.8.1+1.20" = _M7J7tDUm;
        "pkg-2.8.2+1.19" = _9VrHmj7h;
        "pkg-2.8.2+1.19.3" = _AMFto9uZ;
        "pkg-2.8.2+1.19.4" = _iId0w3rx;
        "pkg-2.8.2+1.20" = _tQTMt7RG;
        "pkg-2.8.3+1.19" = _gZTjyQiN;
        "pkg-2.8.3+1.19.3" = _viGg0XGj;
        "pkg-2.8.3+1.19.4" = _RXux54xM;
        "pkg-2.8.3+1.20" = _Bt1gWToj;
        "pkg-2.8.3+1.18" = _5nnbDPGB;
        "pkg-2.8.4+1.20" = _WulnlZSA;
        "pkg-2.9.0+1.18" = _1eFnh3is;
        "pkg-2.9.0+1.19" = _MJR3jzuC;
        "pkg-2.9.0+1.20" = _8SCdZVFo;
        "pkg-2.9.0+1.20.4" = _dYQqCTki;
        "pkg-2.9.1+1.20" = _fUy8osoF;
        "pkg-2.9.2+1.20" = _y0OZVWXu;
        "pkg-2.9.3+1.19" = _zTpu9ym0;
        "pkg-2.9.3+1.18" = _nVvSCQsI;
        "pkg-2.9.3+1.20" = _6kqIoNFG;
        "pkg-2.9.3+1.20.4" = _VUFlaTxT;
        "pkg-2.9.4+1.18" = _XbQ0zfYc;
        "pkg-2.9.4+1.19" = _xkgh1kii;
        "pkg-2.9.4+1.20" = _kbR6TC3S;
        "pkg-2.9.4+1.21" = _vnlcdiDx;
        "pkg-2.9.5+1.18" = _cNZRGY78;
        "pkg-2.9.5+1.19" = _wsknMLyN;
        "pkg-2.9.5+1.20" = _A4PulTVq;
        "pkg-2.9.5+1.21" = _putUcCHO;
        "pkg-2.9.6+1.21" = _1nHKCSnS;
        "pkg-2.9.7+1.19" = _g05pw2K3;
        "pkg-2.9.7+1.20" = _nL36mf6Z;
        "pkg-2.9.7+1.21" = _jTmUcPg1;
        "pkg-2.9.8+1.21" = _uhMZoxkX;
        "pkg-2.9.9+1.21" = _QdLreJ52;
        "pkg-2.9.10+1.19" = _mltNu5Ek;
        "pkg-2.9.10+1.20" = _YpQ33qmR;
        "pkg-2.9.10+1.21" = _EdQoLlkB;
        "pkg-2.9.11+1.19" = _P4JG0rBx;
        "pkg-2.9.11+1.20" = _UIeIZ9K2;
        "pkg-2.9.11+1.21" = _xsQYaGvs;
        "pkg-3.0.0-beta.1+1.20" = _Dp540b35;
        "pkg-3.0.0-beta.1+1.21" = _Y9Fj4tF7;
        "pkg-3.1.0+1.20" = _Zfvxuud3;
        "pkg-3.1.0+1.21" = _PcdwHGYe;
        "pkg-3.1.1+1.20" = _SOB65bN0;
        "pkg-3.1.1+1.21" = _plRPd2B2;
        "pkg-3.2.0+1.20" = _HIbLHCFL;
        "pkg-3.2.0+1.21" = _dP6i0pcJ;
        "pkg-3.2.1+1.20" = _LNomdhbt;
        "pkg-3.2.1+1.21" = _6sEaZPHr;
        "pkg-3.2.2+1.20" = _n1iu2AGi;
        "pkg-3.2.2+1.21" = _hMwPJCf2;
        "pkg-3.2.3+1.20" = _VWJnLcQ4;
        "pkg-3.2.4+1.20" = _lad77Aae;
        "pkg-3.2.4+1.21" = _elhuyQ9y;
        "pkg-3.2.5+1.21" = _mORZPppx;
        "pkg-3.2.6+1.20" = _MNPNDT3i;
        "pkg-3.2.6+1.21" = _vbGWy9Af;
        "pkg-3.2.7+1.20" = _oMQr5LRS;
        "pkg-3.2.7+1.21" = _Lln46F3u;
        "pkg-3.3.0+1.20" = _64DX9GMx;
        "pkg-3.3.0+1.21" = _pAWItSRt;
        "pkg-3.3.1+1.20" = _Sls5uoMG;
        "pkg-3.3.1+1.21" = _1wgBgphq;
        "pkg-3.4.0+1.20" = _ViVHhsvP;
        "pkg-3.4.0+1.21" = _asf5Gulv;
        "pkg-3.5.0+1.20" = _AsHtlEDf;
        "pkg-3.5.0+1.21" = _FLNUS1ZC;
        "pkg-3.5.1+1.20" = _8jCSB6Fv;
        "pkg-3.5.2+1.20" = _K5kaEIJG;
        "pkg-3.5.2+1.21" = _qYsfOyAq;
        "pkg-3.5.3+1.20" = _4euOAwEo;
        "pkg-3.5.3+1.21" = _eWdsOeAs;
        "pkg-3.5.4+1.20" = _qsbqaMSY;
        "pkg-3.5.4+1.21" = _A4NbUvZm;
        "pkg-3.5.5+1.20" = _qVju6mV3;
        "pkg-3.5.5+1.21" = _N7kPEhPm;
        "pkg-3.5.5+26.1" = _dYvKSKzV;
        "pkg-3.5.6+26.1" = _jELLWQCt;
        "pkg-3.6.0+1.20" = _C5zvtelN;
        "pkg-3.6.0+1.21" = _2TatMJYq;
        "pkg-3.6.0+26.1" = _zuYtHooR;
        "pkg-3.7.0+1.20" = _9P8XH8Ye;
        "pkg-3.7.0+1.21" = _afhDJVda;
        "pkg-3.7.0+26.1" = _r8nzQvF1;
        "pkg-3.7.1+1.20" = _LtiOTgYV;
        "pkg-3.7.1+1.21" = _Jtm28EKg;
        "pkg-3.7.1+26.1" = _xTy3VO5L;
        "pkg-3.7.2+26.1" = _OAmLnCmN;
        "pkg-3.7.3+26.1" = _mYjQBoio;
        "default" = _mYjQBoio;
    });
