...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19" = _4npwmbgi;
        "pkg-1.1.0+1.19" = _b8e3OvxM;
        "pkg-1.2.0+1.19" = _ZZQiDBdp;
        "pkg-1.3.0+1.19" = _UvQn8n0k;
        "pkg-1.4.0+1.19" = _B9YtYPyV;
        "pkg-1.4.0+1.20" = _1Ia07tOR;
        "pkg-1.5.0+1.19" = _4mIFMz8I;
        "pkg-1.5.0+1.20" = _7A6knJ4I;
        "pkg-1.5.1+1.19" = _G7hmcw8F;
        "pkg-1.5.1+1.20" = _FcqZGopq;
        "pkg-1.5.2+1.19" = _JO5wZR1X;
        "pkg-1.5.2+1.20" = _P4ocMsKU;
        "pkg-1.5.2+1.18" = _iNuOW4ok;
        "pkg-1.5.3+1.18" = _Nx3Im3oi;
        "pkg-1.5.3+1.19" = _mtltWUj9;
        "pkg-1.5.3+1.20" = _52tAMkGv;
        "pkg-1.6.0+1.18" = _HMoZ8ZpC;
        "pkg-1.6.0+1.19" = _qIMcnVRV;
        "pkg-1.6.0+1.20" = _pWmuPA0F;
        "pkg-1.6.1+1.18" = _tWYwXMLd;
        "pkg-1.6.1+1.19" = _ODwvXAWi;
        "pkg-1.6.1+1.20" = _LUw0tcnN;
        "pkg-1.6.2+1.20" = _qqVvRmx9;
        "pkg-1.6.2+1.21" = _ufGJ11iC;
        "pkg-1.6.3+1.20" = _DPmoJ2vt;
        "pkg-1.6.3+1.21" = _JO6VHDDs;
        "pkg-1.6.3+1.19" = _KrSCRpP9;
        "pkg-1.6.3+1.18" = _yDwqDBxX;
        "pkg-1.6.4+1.20" = _IXtKVc5V;
        "pkg-1.6.4+1.21" = _qEU4KpZ2;
        "pkg-1.6.4+1.19" = _7MLV6540;
        "pkg-1.6.4+1.18" = _QRWNXBLH;
        "pkg-1.6.5+1.21" = _JAReezpC;
        "pkg-1.6.6+1.21" = _8ogO0SGw;
        "pkg-1.6.7+1.18" = _wLGq4GvB;
        "pkg-1.6.7+1.19" = _88xilfTO;
        "pkg-1.6.7+1.20" = _mDyttyc5;
        "pkg-1.6.7+1.21" = _t713FN20;
        "pkg-1.6.8+1.20" = _7taDRDKA;
        "pkg-1.6.8+1.19" = _LhbpjfIA;
        "pkg-1.6.8+1.18" = _hMa8XeW8;
        "pkg-1.6.8+1.21" = _Fm59sO5V;
        "default" = _Fm59sO5V;
    });
