...
let
    ...
    in {
        ...
        "pkg-0.1.0+mc1.16.5" = _OY3WMRon;
        "pkg-0.1.1+mc1.16.5" = _hAX6sZDw;
        "pkg-0.1.0+mc1.18.2" = _CaCf4EvP;
        "pkg-0.1.0+mc1.19.2" = _DJkrzyL1;
        "pkg-0.1.0+mc1.20.1" = _UIKYhj3g;
        "pkg-0.1.2+mc1.16.5" = _D2QgOs8k;
        "pkg-0.1.2+mc1.18.2" = _wgTSyLdT;
        "pkg-0.1.2+mc1.19.2" = _n92q1xDm;
        "pkg-0.1.2+mc1.20.1" = _x2iQDsSn;
        "pkg-0.1.3+mc1.20.1" = _w5i6C5rA;
        "pkg-0.1.4+mc1.16.5" = _VYx7wJuh;
        "pkg-0.1.4+mc1.18.2" = _BPwa1a0f;
        "pkg-0.1.4+mc1.19.2" = _Z0owWEPo;
        "pkg-0.1.4+mc1.20.1" = _LRqPQ9p6;
        "pkg-0.1.5+mc1.16.5" = _Z6YgHfkc;
        "pkg-0.1.5+mc1.18.2" = _LNnaE3Iz;
        "pkg-0.1.5+mc1.19.2" = _tWq5LNiQ;
        "pkg-0.1.5+mc1.20.1" = _wnaKtTWg;
        "pkg-0.1.6+mc1.16.5" = _Y6g88oF9;
        "pkg-0.1.6+mc1.18.2" = _uTvFPy3X;
        "pkg-0.1.6+mc1.19.2" = _FigmoyrV;
        "pkg-0.1.6+mc1.20.1" = _i9i2KqZe;
        "pkg-0.1.7+mc1.16.5" = _S3AHUNRv;
        "pkg-0.1.7+mc1.18.2" = _HnjKDI0x;
        "pkg-0.1.7+mc1.19.2" = _TSg0S1pd;
        "pkg-0.1.7+mc1.20.1" = _GtJAZj8u;
        "pkg-0.1.8+mc1.16.5" = _7bMjt6FE;
        "pkg-0.1.8+mc1.19.2" = _WCVvIUCp;
        "pkg-0.1.8+mc1.20.1" = _AlJbBh2q;
        "pkg-0.1.9+mc1.16.5" = _PMhLaLp3;
        "pkg-0.1.9+mc1.20.1" = _VbQKy5NM;
        "pkg-0.1.10+mc1.19.2" = _YOtFUnuF;
        "pkg-0.1.10+mc1.20.1" = _t4lyYHms;
        "pkg-0.1.11+mc1.18.2" = _sYVignsY;
        "pkg-0.1.11+mc1.19.2" = _ZvHYVZ7N;
        "pkg-0.1.11+mc1.20.1" = _TUv35Xx2;
        "pkg-0.1.12+mc1.16.5" = _dmm3qp7E;
        "pkg-0.1.12+mc1.18.2" = _DjnG6mVQ;
        "pkg-0.1.12+mc1.19.2" = _pGzt36pt;
        "pkg-0.1.12+mc1.20.1" = _Qfu5Kd9O;
        "pkg-0.1.13+mc1.20.1" = _1stNn0rY;
        "pkg-0.1.13+mc1.20.2" = _T6fDsgmB;
        "pkg-0.1.14+mc1.16.5" = _d1lm62ry;
        "pkg-0.1.14+mc1.18.2" = _K3BLhFI2;
        "pkg-0.1.14+mc1.19.2" = _XCpspd2X;
        "pkg-0.1.14+mc1.20.1" = _BjKVjzzv;
        "pkg-0.1.15+mc1.19.2" = _wyFtjfdq;
        "pkg-0.1.15+mc1.20.1" = _xBcRMUbs;
        "pkg-0.1.16+mc1.20.1" = _HANE6P3c;
        "pkg-0.2.0+mc1.16.5" = _N3lbJd7s;
        "pkg-0.2.0+mc1.18.2" = _7EwYBwRf;
        "pkg-0.2.0+mc1.19.2" = _9KEzIDi8;
        "pkg-0.2.0+mc1.20.1" = _CxHW3eKX;
        "pkg-0.2.1+mc1.20.1" = _yLY5HJuZ;
        "pkg-0.2.2+mc1.16.5" = _TrAxlM98;
        "pkg-0.2.2+mc1.18.2" = _nS5TmjEq;
        "pkg-0.2.2+mc1.19.2" = _9Wsd8bKr;
        "pkg-0.2.2+mc1.20.1" = _fuMYnZwc;
        "pkg-0.2.3+mc1.18.2" = _tKTwEh86;
        "pkg-0.2.3+mc1.19.2" = _VjMExAXb;
        "pkg-0.2.2+mc1.20.2" = _CTJ1cpIc;
        "pkg-0.2.4+mc1.16.5" = _HS5An5NP;
        "pkg-0.2.4+mc1.18.2" = _uDb6RGmi;
        "pkg-0.2.5+mc1.16.5" = _fJd9zAd5;
        "pkg-0.2.5+mc1.18.2" = _n4bb1wQI;
        "pkg-0.2.5+mc1.19.2" = _spYd2Trx;
        "pkg-0.2.5+mc1.20.1" = _FdJwjm0X;
        "pkg-0.2.6+mc1.16.5" = _BzoeMuKp;
        "pkg-0.2.7+mc1.16.5" = _GDJzfqu2;
        "pkg-0.2.7+mc1.18.2" = _X2vyBV9U;
        "pkg-0.2.7+mc1.19.2" = _xu0nloU9;
        "pkg-0.2.7+mc1.20.1" = _B6Bp1bvC;
        "pkg-0.2.8+mc1.20.1" = _bU0mTIXZ;
        "pkg-0.2.9+mc1.16.5" = _6MC29glI;
        "pkg-0.2.9+mc1.18.2" = _sagDi1UO;
        "pkg-0.2.9+mc1.19.2" = _fUvrPCLk;
        "pkg-0.2.9+mc1.20.1" = _HTjadeuQ;
        "pkg-0.2.9-git.a883fdf+mc1.20.2" = _4yvkuGJs;
        "pkg-0.2.10+mc1.16.5" = _StgdrbYM;
        "pkg-0.2.10+mc1.18.2" = _DlmUznIq;
        "pkg-0.2.10+mc1.19.2" = _k11ORQp6;
        "pkg-0.2.10+mc1.20.1" = _3Ib0aVnm;
        "pkg-0.2.10+mc1.20.2" = _J5gD4WO0;
        "pkg-0.2.11+mc1.18.2" = _k0PQcQFa;
        "pkg-0.2.11+mc1.19.2" = _KqJf74Ah;
        "pkg-0.2.12+mc1.16.5" = _GuYwrocT;
        "pkg-0.2.12+mc1.18.2" = _NLrbB3o9;
        "pkg-0.2.12+mc1.19.2" = _vlIcINb8;
        "pkg-0.2.12+mc1.20.1" = _OFI05fnF;
        "pkg-0.2.12+mc1.20.2" = _8QyTfW8d;
        "pkg-0.2.12+mc1.20.3" = _N21UWLtA;
        "pkg-0.2.12+mc1.20.4" = _EgJgmm6j;
        "pkg-0.2.13+mc1.16.5" = _JhR2FXy9;
        "pkg-0.2.13+mc1.18.2" = _nbnS4lv3;
        "pkg-0.2.13+mc1.19.2" = _g9Z4ICTo;
        "pkg-0.2.13+mc1.20.1" = _tDExzaO7;
        "pkg-0.2.13+mc1.20.4" = _NhxNCVb8;
        "pkg-0.2.14+mc1.16.5" = _dHjtqLmL;
        "pkg-0.2.14+mc1.18.2" = _BWJ5iluO;
        "pkg-0.2.14+mc1.19.2" = _KLZso8Yf;
        "pkg-0.2.14+mc1.20.1" = _dFziZfee;
        "pkg-0.2.14+mc1.20.4" = _ULUyPB6X;
        "pkg-0.2.15+mc1.16.5" = _oys8w84k;
        "pkg-0.2.15+mc1.18.2" = _RVhDRI3S;
        "pkg-0.2.15+mc1.19.2" = _lvv1Ek0I;
        "pkg-0.2.15+mc1.20.1" = _YjxYbhdu;
        "pkg-0.2.15+mc1.20.4" = _PYQ8JPHe;
        "pkg-0.2.16+mc1.16.5" = _CWLgixEM;
        "pkg-0.2.16+mc1.18.2" = _i6olgd4m;
        "pkg-0.2.16+mc1.19.2" = _J35HEDEt;
        "pkg-0.2.16+mc1.20.1" = _WqH4m6Io;
        "pkg-0.2.17+mc1.16.5" = _5MKgIFka;
        "pkg-0.2.17+mc1.18.2" = _bTpBE5Cl;
        "pkg-0.2.18+mc1.16.5" = _PPzhTSxX;
        "pkg-0.2.18+mc1.18.2" = _yEgbIIqo;
        "pkg-0.2.18+mc1.19.2" = _ykAk59SJ;
        "pkg-0.2.18+mc1.20.1" = _5UhQey9d;
        "pkg-0.2.18+mc1.20.4" = _DKQHHrNn;
        "pkg-0.2.19+mc1.20.4" = _TYuvuG0g;
        "pkg-0.3.0+mc1.16.5" = _YzLsDwpZ;
        "pkg-0.3.0+mc1.18.2" = _SSsqOqyJ;
        "pkg-0.3.0+mc1.19.2" = _aUHtVcge;
        "pkg-0.3.0+mc1.20.1" = _pXXcLrZz;
        "pkg-0.3.0+mc1.20.4" = _bL8XwccJ;
        "pkg-0.3.1+mc1.20.1" = _ZDL24WiX;
        "pkg-0.3.1+mc1.20.4" = _UdUl1T5g;
        "pkg-0.3.2+mc1.16.5" = _9AANXPV0;
        "pkg-0.3.2+mc1.18.2" = _eQxbAMuQ;
        "pkg-0.3.2+mc1.19.2" = _VzpBlb1u;
        "pkg-0.3.2+mc1.20.1" = _b4O5B6UM;
        "pkg-0.3.2+mc1.20.4" = _Enbq4EFR;
        "pkg-0.3.3+mc1.20.1" = _JVm1F3Ne;
        "pkg-0.3.3+mc1.19.2" = _dUXuPlDN;
        "pkg-0.3.3+mc1.18.2" = _u4P38VUP;
        "pkg-0.3.3+mc1.16.5" = _is18HkMy;
        "pkg-0.3.3+mc1.20.4" = _jnBArugs;
        "pkg-0.3.4+mc1.20.1" = _YC4uPX2q;
        "pkg-0.3.4+mc1.20.4" = _xElzw6qM;
        "pkg-0.3.4-git.ccebde7+mc24w07a" = _jbudV9go;
        "pkg-0.3.5+mc1.20.1" = _POiAxWIn;
        "pkg-0.3.5+mc1.19.2" = _z5mT3cUf;
        "pkg-0.3.5+mc1.18.2" = _sREW7Z37;
        "pkg-0.3.5+mc1.16.5" = _xHx8ofV5;
        "pkg-0.3.5+mc1.20.4" = _WOcbGReJ;
        "pkg-0.3.6+mc1.20.1" = _Q3sjpN6Y;
        "pkg-0.3.6+mc1.20.4" = _TIJHm5CK;
        "pkg-0.3.7+mc1.20.1" = _KYxevBhX;
        "pkg-0.3.7+mc1.20.4" = _g7dGXilm;
        "pkg-0.3.7+mc24w09a" = _Jms8wfZJ;
        "pkg-0.3.8+mc1.20.4" = _M27NTeQi;
        "pkg-0.3.7+mc24w10a" = _DKQOiIXx;
        "pkg-0.3.9+mc1.20.1" = _F8B5jLCp;
        "pkg-0.3.9+mc1.20.4" = _NMfFonVs;
        "pkg-0.3.9+mc1.19.2" = _yYQuhhsI;
        "pkg-0.3.9+mc1.18.2" = _AfhRPHGN;
        "pkg-0.3.9+mc1.16.5" = _PA3yNJsA;
        "pkg-0.3.10+mc1.18.2" = _vbLeUdZC;
        "pkg-0.3.10+mc1.16.5" = _g8rp1a3W;
        "pkg-0.3.9+mc24w11a" = _YmMRbgDO;
        "pkg-0.3.9+mc24w12a" = _SLGQvelN;
        "pkg-0.3.11+mc1.20.1" = _rjlh9Vcr;
        "pkg-0.3.11+mc1.20.4" = _On5whdbn;
        "pkg-0.3.9+mc24w13a" = _oIvr6Yvk;
        "pkg-0.3.11+mc24w14potato" = _L9TkFdpn;
        "pkg-0.3.12+mc1.20.1" = _aVRvM7I7;
        "pkg-0.3.12+mc1.19.2" = _B33sb7Zs;
        "pkg-0.3.12+mc1.18.2" = _9tXCBDZj;
        "pkg-0.3.12+mc1.16.5" = _3KdD83Qu;
        "pkg-0.3.13+mc1.20.1" = _n1Nt5hK2;
        "pkg-0.3.13+mc1.20.4" = _kbkd7mOQ;
        "pkg-0.3.13+mc24w14a" = _B86stv25;
        "pkg-0.3.13+mc1.20.5-pre1" = _ofc6iWhZ;
        "pkg-0.3.14+mc1.20.1" = _2D6ipaiY;
        "pkg-0.3.14+mc1.20.4" = _RHVugIok;
        "pkg-0.3.14+mc1.19.2" = _syxwmWEk;
        "pkg-0.3.14+mc1.18.2" = _rNFOdDcR;
        "pkg-0.3.14+mc1.16.5" = _KLQezI6V;
        "pkg-0.3.14+mc1.20.5-pre2" = _8ZSgkYpx;
        "pkg-0.3.14+mc1.20.5" = _fITh7c6G;
        "pkg-0.3.15+mc1.20.5" = _E2hEqxns;
        "pkg-0.3.16+mc1.20.1" = _9C2gFT6k;
        "pkg-0.3.16+mc1.20.6" = _UKPPe3rg;
        "pkg-0.3.17+mc1.20.1" = _VAyZt0rt;
        "pkg-0.3.17+mc1.20.6" = _JMdj7A5D;
        "pkg-0.3.18+mc1.20.1" = _pGO3hiY8;
        "pkg-0.3.18+mc1.20.6" = _VbtsS5XM;
        "pkg-0.3.18+mc1.19.2" = _jfqlwYJ5;
        "pkg-0.3.18+mc1.18.2" = _xuVAgh89;
        "pkg-0.3.18+mc1.16.5" = _9PbX7IEh;
        "pkg-0.3.19+mc1.20.1" = _Xg1M092Q;
        "pkg-0.3.19+mc1.20.6" = _X4vKGX9r;
        "pkg-0.3.20+mc1.20.1" = _QmRSmFyB;
        "pkg-0.3.20+mc1.20.6" = _b7VDEGTG;
        "pkg-1.0.0-beta.1+mc1.21" = _bTZZCnz6;
        "pkg-0.3.21+mc1.20.1" = _lxoKz7FZ;
        "pkg-1.0.1+mc1.21" = _6dpj5w0V;
        "pkg-0.3.21+mc1.20.4" = _gpJ5vymI;
        "pkg-0.3.22+mc1.20.1" = _yHr1TDpG;
        "pkg-0.3.22+mc1.20.4" = _xUckFTXy;
        "pkg-1.0.2+mc1.21" = _cGU91GG0;
        "pkg-0.3.23+mc1.20.1" = _PpOoTFqN;
        "pkg-1.0.3+mc1.21" = _GOT3kcV5;
        "pkg-0.3.24+mc1.20.1" = _P7uCsjQD;
        "pkg-1.0.4+mc1.21" = _RnqhELTh;
        "pkg-0.3.24+mc1.20.4" = _vW8Dn9x4;
        "pkg-0.3.25+mc1.20.1" = _kJkE9dfS;
        "pkg-1.0.5+mc1.21" = _V9FYzgvh;
        "pkg-0.3.25+mc1.20.4" = _YcDuSsmz;
        "pkg-0.3.18.1+mc1.19.2" = _AYqEbec0;
        "pkg-1.0.6+mc1.21" = _B3uyzMOQ;
        "pkg-0.3.27+mc1.20.1" = _ylN2s7IP;
        "pkg-1.0.7+mc1.21" = _Na1PoLYF;
        "pkg-0.3.28+mc1.20.1" = _lopZqfMw;
        "pkg-0.3.29+mc1.20.1" = _vCML9MtQ;
        "pkg-1.0.9+mc1.21.1" = _5fIHGnBg;
        "pkg-0.3.30+mc1.20.1" = _EKA4u4Uy;
        "pkg-1.0.10+mc1.21.1" = _O0l2GK0l;
        "pkg-0.3.31+mc1.20.1" = _UTbfe5d1;
        "pkg-1.0.11+mc1.21.1" = _MphSqDWg;
        "pkg-1.0.12+mc1.21.1" = _dft58ljy;
        "pkg-1.0.13+mc1.21.1" = _YrnIydv3;
        "pkg-1.0.12-beta.1+mc1.21.4" = _vsgK3r0g;
        "pkg-1.0.14+mc1.21.1" = _w5TMTMe8;
        "pkg-1.0.15+mc1.21.1" = _J7b96IEd;
        "default" = _J7b96IEd;
    });
