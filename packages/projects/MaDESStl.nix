...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.20.2-fabric" = _g2BPSBoY;
        "pkg-0.1.0+1.20.1-forge" = _k43BbiFC;
        "pkg-0.1.0+1.19.3-fabric" = _kyeufUzv;
        "pkg-0.1.0+1.19.3-forge" = _WBGrPXGD;
        "pkg-0.1.0+1.19.4-fabric" = _mCwAGgId;
        "pkg-0.1.0+1.19.4-forge" = _cP1ZAhke;
        "pkg-0.1.0+1.18.2-forge" = _hMv7bYkE;
        "pkg-0.1.0+1.18.2-fabric" = _32QmxWHV;
        "pkg-0.1.0+1.16.5-fabric" = _GFcP61mm;
        "pkg-0.1.0+1.19.2-fabric" = _n6X6fSDS;
        "pkg-0.1.0+1.19.2-forge" = _yQHwGRcb;
        "pkg-0.1.0+1.17.1-fabric" = _DwAqd04i;
        "pkg-0.1.0+1.20.2-forge" = _SBoWDDfv;
        "pkg-0.1.0+1.20.1-fabric" = _FXS99zxu;
        "pkg-0.1.0+1.8.9-forge" = _t7i40joT;
        "pkg-0.1.0+1.12.2-forge" = _J75Rwwyo;
        "pkg-0.1.0+1.17.1-forge" = _jhVrk731;
        "pkg-0.1.0+1.16.5-forge" = _Lrmi0hmM;
        "pkg-0.2.0+1.20.2-fabric" = _K6GE2gj1;
        "pkg-0.2.0+1.20.2-forge" = _ct1TMtdx;
        "pkg-0.2.0+1.19.4-fabric" = _hc3M5Hih;
        "pkg-0.2.0+1.20.1-forge" = _LFyMw4y3;
        "pkg-0.2.0+1.19.4-forge" = _RbFeO8zm;
        "pkg-0.2.0+1.19.2-fabric" = _sWiS7zKz;
        "pkg-0.2.0+1.19.3-forge" = _XehTNFYc;
        "pkg-0.2.0+1.18.2-fabric" = _q4L9R5HI;
        "pkg-0.2.0+1.19.3-fabric" = _HtZOYkdn;
        "pkg-0.2.0+1.20.1-fabric" = _xxDH59km;
        "pkg-0.2.0+1.16.5-fabric" = _BV5zND5l;
        "pkg-0.2.0+1.17.1-fabric" = _lqO7U7X4;
        "pkg-0.2.0+1.16.5-forge" = _Ml0r1mSi;
        "pkg-0.2.0+1.19.2-forge" = _lpf4AdTg;
        "pkg-0.2.0+1.18.2-forge" = _bX0u5kQY;
        "pkg-0.2.0+1.17.1-forge" = _YfXUGE5b;
        "pkg-0.2.0+1.12.2-forge" = _PpN0RAy9;
        "pkg-0.2.0+1.8.9-forge" = _qtxLMcl7;
        "pkg-0.2.1+1.20.2-fabric" = _wVUtI3Zy;
        "pkg-0.2.1+1.20.2-forge" = _FjfirnZT;
        "pkg-0.2.1+1.20.1-forge" = _l17GIRaH;
        "pkg-0.2.1+1.20.1-fabric" = _7o9EBAHO;
        "pkg-0.2.1+1.19.4-fabric" = _kHnXdnKQ;
        "pkg-0.2.1+1.12.2-forge" = _1wmIbvpp;
        "pkg-0.2.1+1.19.3-forge" = _jF5px1Jd;
        "pkg-0.2.1+1.16.5-fabric" = _pZqnlRVW;
        "pkg-0.2.1+1.19.4-forge" = _A5FN9N0U;
        "pkg-0.2.1+1.16.5-forge" = _kycozBt2;
        "pkg-0.2.1+1.19.2-fabric" = _qQukkeOx;
        "pkg-0.2.1+1.19.3-fabric" = _lQ3JUpCf;
        "pkg-0.2.1+1.19.2-forge" = _ujTWKyfl;
        "pkg-0.2.1+1.18.2-fabric" = _GtFxdGwA;
        "pkg-0.2.1+1.17.1-forge" = _CnPugKMk;
        "pkg-0.2.1+1.17.1-fabric" = _NBTOAETn;
        "pkg-0.2.1+1.18.2-forge" = _KyWQw7z6;
        "pkg-0.2.1+1.8.9-forge" = _w0mBKPYw;
        "pkg-0.3.0+1.20.2-fabric" = _BRy2dptc;
        "pkg-0.3.0+1.20.2-forge" = _uvnkgcxp;
        "pkg-0.3.0+1.19.4-fabric" = _sq2UgwD8;
        "pkg-0.3.0+1.19.3-fabric" = _LiiRPNem;
        "pkg-0.3.0+1.20.1-fabric" = _gjyBq6oM;
        "pkg-0.3.0+1.19.4-forge" = _VJEjZdQj;
        "pkg-0.3.0+1.20.1-forge" = _Dc8mlYnz;
        "pkg-0.3.0+1.19.2-forge" = _hOMlAZGx;
        "pkg-0.3.0+1.19.3-forge" = _eH8ZMuWJ;
        "pkg-0.3.0+1.19.2-fabric" = _IVoeOwC6;
        "pkg-0.3.0+1.16.5-fabric" = _kDEb8PHo;
        "pkg-0.3.0+1.18.2-fabric" = _ttGLWx6N;
        "pkg-0.3.0+1.17.1-fabric" = _bhdXNwon;
        "pkg-0.3.0+1.8.9-forge" = _6jX3nSLK;
        "pkg-0.3.0+1.12.2-forge" = _VgBoA3qm;
        "pkg-0.3.0+1.16.5-forge" = _xtbj0tpU;
        "pkg-0.3.0+1.17.1-forge" = _8y0NooJf;
        "pkg-0.3.0+1.18.2-forge" = _8yW7zVOW;
        "pkg-0.4.0+1.16.5-forge" = _hdEoqP8j;
        "pkg-0.4.0+1.19.4-fabric" = _C0K4n1rz;
        "pkg-0.4.0+1.16.5-fabric" = _o0GkEaMx;
        "pkg-0.4.0+1.17.1-forge" = _oyzFyIoO;
        "pkg-0.4.0+1.20.2-forge" = _yfrLDi4c;
        "pkg-0.4.0+1.17.1-fabric" = _B1X72tpL;
        "pkg-0.4.0+1.19.3-fabric" = _veDDpFRX;
        "pkg-0.4.0+1.19.2-fabric" = _VCocsEYi;
        "pkg-0.4.0+1.12.2-forge" = _oaBqz0SB;
        "pkg-0.4.0+1.20.2-fabric" = _k4fjiATo;
        "pkg-0.4.0+1.19.3-forge" = _RAuynMkv;
        "pkg-0.4.0+1.8.9-forge" = _YgDvMZe1;
        "pkg-0.4.0+1.18.2-fabric" = _oJXDvMZc;
        "pkg-0.4.0+1.18.2-forge" = _lXxV2HUz;
        "pkg-0.4.0+1.19.2-forge" = _JnqvHjOK;
        "pkg-0.4.0+1.20.1-fabric" = _oCZYIYD7;
        "pkg-0.4.0+1.19.4-forge" = _7pBRrOQs;
        "pkg-0.4.0+1.20.1-forge" = _3YJ7tXhr;
        "pkg-0.5.0+1.12.2-forge" = _Ml32C63e;
        "pkg-0.5.0+1.20.2-fabric" = _69ZGYhHc;
        "pkg-0.5.0+1.20.2-neoforge" = _hILl4RlZ;
        "pkg-0.5.0+1.19.2-fabric" = _uJNqBCqT;
        "pkg-0.5.0+1.20.6-neoforge" = _gaOG56aY;
        "pkg-0.5.0+1.20.4-neoforge" = _K5S0FzmG;
        "pkg-0.5.0+1.21-neoforge" = _173LLuQN;
        "pkg-0.5.0+1.8.9-forge" = _G2BOLFhA;
        "pkg-0.5.0+1.19.4-forge" = _np2fMnkz;
        "pkg-0.5.0+1.18.2-fabric" = _LSms7c9K;
        "pkg-0.5.0+1.16.5-forge" = _PHQAg9mh;
        "pkg-0.5.0+1.17.1-fabric" = _UJTQMzqb;
        "pkg-0.5.0+1.19.2-forge" = _Ptndlh6x;
        "pkg-0.5.0+1.21-fabric" = _tLsp0M5z;
        "pkg-0.5.0+1.18.2-forge" = _LSi9Xpi3;
        "pkg-0.5.0+1.17.1-forge" = _JheTRGTx;
        "pkg-0.5.0+1.20.4-fabric" = _mRGWRGeT;
        "pkg-0.5.0+1.20.2-forge" = _Z253gS0y;
        "pkg-0.5.0+1.16.5-fabric" = _oDF4vbNV;
        "pkg-0.5.0+1.19.4-fabric" = _cYR1pc0Q;
        "pkg-0.5.0+1.20.4-forge" = _r5Fh2Tw5;
        "pkg-0.5.0+1.20.1-fabric" = _COWSBqfD;
        "pkg-0.5.0+1.20.1-forge" = _JXv8moex;
        "pkg-0.5.0+1.20.6-fabric" = _C2ARJSve;
        "pkg-0.6.0+1.20.2-fabric" = _fNIuttOb;
        "pkg-0.6.0+1.20.4-fabric" = _AOJbGVoZ;
        "pkg-0.6.0+1.20.4-forge" = _sf7XQus5;
        "pkg-0.6.0+1.20.2-forge" = _9bTws8Uh;
        "pkg-0.6.0+1.20.4-neoforge" = _C0uryI6Y;
        "pkg-0.6.0+1.20.6-fabric" = _Qg01jezc;
        "pkg-0.6.0+1.20.6-neoforge" = _vukwDjbw;
        "pkg-0.6.0+1.21-fabric" = _WwKbqBpG;
        "pkg-0.6.0+1.21-neoforge" = _b8DT3Yo1;
        "pkg-0.6.0+1.20.2-neoforge" = _WuvsvNEO;
        "pkg-0.6.0+1.18.2-forge" = _oI3vdWUZ;
        "pkg-0.6.0+1.19.2-forge" = _gq70ElPt;
        "pkg-0.6.0+1.18.2-fabric" = _fq1BJSQF;
        "pkg-0.6.0+1.17.1-fabric" = _RSmQ7eAl;
        "pkg-0.6.0+1.17.1-forge" = _wfNuHUO2;
        "pkg-0.6.0+1.16.5-forge" = _u0qq1o5f;
        "pkg-0.6.0+1.19.2-fabric" = _bkQVxFgE;
        "pkg-0.6.0+1.12.2-forge" = _f4mkzWq0;
        "pkg-0.6.0+1.19.4-forge" = _79iS2MEJ;
        "pkg-0.6.0+1.20.1-forge" = _r8WNN2rH;
        "pkg-0.6.0+1.16.5-fabric" = _Z0XG9Ilw;
        "pkg-0.6.0+1.8.9-forge" = _tuhaMnqz;
        "pkg-0.6.0+1.19.4-fabric" = _Hiw2eOpy;
        "pkg-0.6.0+1.20.1-fabric" = _5kO2IBcX;
        "pkg-0.7.0+1.20.4-fabric" = _CsLWrhHo;
        "pkg-0.7.0+1.20.2-fabric" = _U5vSv8YK;
        "pkg-0.7.0+1.21-neoforge" = _f4h621vx;
        "pkg-0.7.0+1.20.4-neoforge" = _l0LRXyjs;
        "pkg-0.7.0+1.20.6-fabric" = _ylRMvYvO;
        "pkg-0.7.0+1.20.6-neoforge" = _eGrtX67b;
        "pkg-0.7.0+1.20.4-forge" = _XBPM7loT;
        "pkg-0.7.0+1.21-fabric" = _D7BtTMgM;
        "pkg-0.7.0+1.17.1-fabric" = _zYZTgMwL;
        "pkg-0.7.0+1.17.1-forge" = _vgtdjzux;
        "pkg-0.7.0+1.20.2-forge" = _RBNAAumJ;
        "pkg-0.7.0+1.19.4-fabric" = _lyYbUjbC;
        "pkg-0.7.0+1.19.4-forge" = _mUChZ6Xf;
        "pkg-0.7.0+1.20.1-forge" = _4z2oujRI;
        "pkg-0.7.0+1.12.2-forge" = _xp0zdBB5;
        "pkg-0.7.0+1.19.2-forge" = _I23vuefV;
        "pkg-0.7.0+1.18.2-forge" = _m9t0vaN1;
        "pkg-0.7.0+1.19.2-fabric" = _TFSizxF3;
        "pkg-0.7.0+1.18.2-fabric" = _kpnb7V5Q;
        "pkg-0.7.0+1.16.5-forge" = _1CeiO673;
        "pkg-0.7.0+1.20.2-neoforge" = _cnR7Avgk;
        "pkg-0.7.0+1.8.9-forge" = _gIjmsaID;
        "pkg-0.7.0+1.16.5-fabric" = _6gIfbI7F;
        "pkg-0.7.0+1.20.1-fabric" = _attfN3EJ;
        "pkg-0.8.0+1.20.2-fabric" = _dNTTzLhb;
        "pkg-0.8.0+1.20.2-forge" = _156qQ2rD;
        "pkg-0.8.0+1.20.1-forge" = _uw5rwhmf;
        "pkg-0.8.0+1.19.2-fabric" = _mSMrlNol;
        "pkg-0.8.0+1.20.2-neoforge" = _rB5XohmY;
        "pkg-0.8.0+1.21-fabric" = _W3mO8rIL;
        "pkg-0.8.0+1.21-neoforge" = _FqaD1Uh3;
        "pkg-0.8.0+1.20.4-forge" = _n50IKFO4;
        "pkg-0.8.0+1.16.5-fabric" = _ufycwMpq;
        "pkg-0.8.0+1.18.2-fabric" = _ubVfgIy5;
        "pkg-0.8.0+1.20.6-neoforge" = _1gbB5mE7;
        "pkg-0.8.0+1.18.2-forge" = _Va4E4SPJ;
        "pkg-0.8.0+1.8.9-forge" = _vlodRgwm;
        "pkg-0.8.0+1.16.5-forge" = _3xcfwMeS;
        "pkg-0.8.0+1.17.1-forge" = _3Rqnpvc5;
        "pkg-0.8.0+1.20.6-fabric" = _g51ZhNxA;
        "pkg-0.8.0+1.12.2-forge" = _GmbS9hHk;
        "pkg-0.8.0+1.19.4-forge" = _4SPr5P5a;
        "pkg-0.8.0+1.17.1-fabric" = _VmXvOlK2;
        "pkg-0.8.0+1.20.4-neoforge" = _Vvg2VqtG;
        "pkg-0.8.0+1.20.4-fabric" = _21YOZwHJ;
        "pkg-0.8.0+1.19.2-forge" = _4UnhfFUQ;
        "pkg-0.8.0+1.19.4-fabric" = _7NmvaPH0;
        "pkg-0.8.0+1.20.1-fabric" = _H6XsYA2i;
        "pkg-0.9.0+1.12.2-forge" = _BIROniJB;
        "pkg-0.9.0+1.16.5-fabric" = _8yWOqOJq;
        "pkg-0.9.0+1.16.5-forge" = _zVvpEe1Z;
        "pkg-0.9.0+1.17.1-fabric" = _hRjLgF82;
        "pkg-0.9.0+1.18.2-forge" = _HnF6TyOi;
        "pkg-0.9.0+1.19.4-fabric" = _M6nV8Cp3;
        "pkg-0.9.0+1.19.4-forge" = _hzGfEKRY;
        "pkg-0.9.0+1.20.1-forge" = _YgOsWDRc;
        "pkg-0.9.0+1.20.2-forge" = _5FFDkjFZ;
        "pkg-0.9.0+1.20.4-fabric" = _QR5ovKzI;
        "pkg-0.9.0+1.20.4-forge" = _ZKUYm8fV;
        "pkg-0.9.0+1.8.9-forge" = _zXbWMs0U;
        "pkg-0.9.0+1.18.2-fabric" = _StRs0iFW;
        "pkg-0.9.0+1.19.2-fabric" = _oi908ZHC;
        "pkg-0.9.0+1.20.1-fabric" = _xBVzAYfd;
        "pkg-0.9.0+1.20.2-neoforge" = _1x7ZOt66;
        "pkg-0.9.0+1.20.4-neoforge" = _a6ftpwfZ;
        "pkg-0.9.0+1.19.2-forge" = _ynv0Es9g;
        "pkg-0.9.0+1.20.6-fabric" = _tbRu9hWZ;
        "pkg-0.9.0+1.20.6-neoforge" = _Ueg0PXBm;
        "pkg-0.9.0+1.21-neoforge" = _4xlxh4g1;
        "pkg-0.9.0+1.21-fabric" = _jYODlGxW;
        "pkg-0.9.0+1.17.1-forge" = _jtflDdXF;
        "pkg-0.9.0+1.20.2-fabric" = _NsmfnAmX;
        "pkg-0.10.0+1.17.1-fabric" = _PWZ0ZUck;
        "pkg-0.10.0+1.16.5-fabric" = _NcJq0nVe;
        "pkg-0.10.0+1.12.2-forge" = _C1XRoqKP;
        "pkg-0.10.0+1.16.5-forge" = _D9tzaCEz;
        "pkg-0.10.0+1.20.2-neoforge" = _4tH2wtUH;
        "pkg-0.10.0+1.18.2-forge" = _JNlpz7Jm;
        "pkg-0.10.0+1.17.1-forge" = _j1mArYjA;
        "pkg-0.10.0+1.18.2-fabric" = _Jp9vjKB2;
        "pkg-0.10.0+1.19.2-forge" = _MCyQRqN3;
        "pkg-0.10.0+1.19.4-fabric" = _wA7XL1Ou;
        "pkg-0.10.0+1.19.2-fabric" = _PqjRtaoH;
        "pkg-0.10.0+1.20.1-fabric" = _sofpYBKH;
        "pkg-0.10.0+1.20.2-fabric" = _fmjCxfL5;
        "pkg-0.10.0+1.19.4-forge" = _iGS0iDEX;
        "pkg-0.10.0+1.20.1-forge" = _2gje9deE;
        "pkg-0.10.0+1.20.2-forge" = _wds2ldrK;
        "pkg-0.10.0+1.20.4-neoforge" = _fFSm3PNI;
        "pkg-0.10.0+1.20.6-neoforge" = _uWFaTXdB;
        "pkg-0.10.0+1.21-neoforge" = _mMGEUAkN;
        "pkg-0.10.0+1.20.4-forge" = _XLVDPPGC;
        "pkg-0.10.0+1.20.4-fabric" = _iJLWdlqz;
        "pkg-0.10.0+1.20.6-fabric" = _HVvFpUp0;
        "pkg-0.10.0+1.8.9-forge" = _wBtGipVI;
        "pkg-0.10.0+1.21-fabric" = _CwEfYJue;
        "pkg-0.21.0+1.12.2-fabric" = _MCHIYRUC;
        "pkg-0.21.0+1.12.2-forge" = _QKeWd1X5;
        "pkg-0.21.0+1.16.5-fabric" = _jhKybdm7;
        "pkg-0.21.0+1.16.5-forge" = _FlLWLv7E;
        "pkg-0.21.0+1.17.1-fabric" = _BhWGux87;
        "pkg-0.21.0+1.17.1-forge" = _kbTuJ2gK;
        "pkg-0.21.0+1.18.2-fabric" = _kZLJ0SAX;
        "pkg-0.21.0+1.18.2-forge" = _U0Hfc5m7;
        "pkg-0.21.0+1.19.2-fabric" = _MiR81aCn;
        "pkg-0.21.0+1.19.2-forge" = _tQ22YySb;
        "pkg-0.21.0+1.19.4-fabric" = _TQeSAGMc;
        "pkg-0.21.0+1.19.4-forge" = _TEPtH8Fd;
        "pkg-0.21.0+1.20.1-fabric" = _gDhEyj3C;
        "pkg-0.21.0+1.20.1-forge" = _V8hKXjPv;
        "pkg-0.21.0+1.20.4-neoforge" = _IGPzesOa;
        "pkg-0.21.0+1.20.4-fabric" = _KP8DVYkG;
        "pkg-0.21.0+1.20.4-forge" = _3SLEoQjH;
        "pkg-0.21.0+1.20.6-neoforge" = _B2CUlNCo;
        "pkg-0.21.0+1.20.6-fabric" = _Pm8KgotX;
        "pkg-0.21.0+1.21.1-neoforge" = _G2GHwnTh;
        "pkg-0.21.0+1.21.1-fabric" = _SkhOLF8E;
        "pkg-0.21.0+1.21.4-neoforge" = _uekIZpgx;
        "pkg-0.21.0+1.21.4-fabric" = _8XfVkK7p;
        "pkg-0.21.0+1.8.9-fabric" = _zO69uEU9;
        "pkg-0.21.0+1.8.9-forge" = _oJbafuEi;
        "pkg-0.22.0+1.12.2-fabric" = _xHnHWHh1;
        "pkg-0.22.0+1.12.2-forge" = _gigEhHvW;
        "pkg-0.22.0+1.16.5-fabric" = _EjWwrJKv;
        "pkg-0.22.0+1.16.5-forge" = _UEnQEFpA;
        "pkg-0.22.0+1.17.1-fabric" = _hpudlHld;
        "pkg-0.22.0+1.17.1-forge" = _kIvfWif1;
        "pkg-0.22.0+1.18.2-fabric" = _cAuDU83F;
        "pkg-0.22.0+1.18.2-forge" = _LGUbATCx;
        "pkg-0.22.0+1.19.2-fabric" = _UWrh6GET;
        "pkg-0.22.0+1.19.2-forge" = _Pct0412y;
        "pkg-0.22.0+1.19.4-fabric" = _jpxUtuGw;
        "pkg-0.22.0+1.19.4-forge" = _JHpb2Qd4;
        "pkg-0.22.0+1.20.1-fabric" = _kNKS6gXb;
        "pkg-0.22.0+1.20.1-forge" = _Ixb2DqV7;
        "pkg-0.22.0+1.20.4-fabric" = _HmY6yznC;
        "pkg-0.22.0+1.20.4-forge" = _w8j1I6Tv;
        "pkg-0.22.0+1.20.4-neoforge" = _qdcFiuRn;
        "pkg-0.22.0+1.20.6-fabric" = _lotCFOf8;
        "pkg-0.22.0+1.20.6-neoforge" = _REfDES2P;
        "pkg-0.22.0+1.21.1-fabric" = _97RGgGlT;
        "pkg-0.22.0+1.21.1-neoforge" = _6chMUpor;
        "pkg-0.22.0+1.21.4-fabric" = _CE1jso51;
        "pkg-0.22.0+1.21.4-neoforge" = _D8vrS1ds;
        "pkg-0.22.0+1.8.9-fabric" = _yMmNt1bn;
        "pkg-0.22.0+1.8.9-forge" = _c8p5mSpV;
        "pkg-0.22.1+1.12.2-forge" = _o36fnJ8y;
        "pkg-0.22.1+1.16.5-fabric" = _s34u3VNK;
        "pkg-0.22.1+1.16.5-forge" = _MUxyHXTc;
        "pkg-0.22.1+1.17.1-fabric" = _3YPCiJKl;
        "pkg-0.22.1+1.17.1-forge" = _j2N0kSXL;
        "pkg-0.22.1+1.18.2-fabric" = _JN8Dv5ZG;
        "pkg-0.22.1+1.18.2-forge" = _Fq5tmkZs;
        "pkg-0.22.1+1.19.2-fabric" = _G95SabLT;
        "pkg-0.22.1+1.19.2-forge" = _cxgeFnTf;
        "pkg-0.22.1+1.19.4-fabric" = _61hJdFbZ;
        "pkg-0.22.1+1.19.4-forge" = _blrzGFIX;
        "pkg-0.22.1+1.20.1-fabric" = _FQepI541;
        "pkg-0.22.1+1.20.1-forge" = _AOXgPwVO;
        "pkg-0.22.1+1.20.4-fabric" = _8XYEKhTk;
        "pkg-0.22.1+1.20.4-forge" = _BESbHU1a;
        "pkg-0.22.1+1.20.4-neoforge" = _m96s1bUx;
        "pkg-0.22.1+1.20.6-fabric" = _JtMs5w5P;
        "pkg-0.22.1+1.20.6-neoforge" = _wz6dOgEY;
        "pkg-0.22.1+1.21.1-fabric" = _Viig4NTy;
        "pkg-0.22.1+1.21.1-neoforge" = _Uqu5y79n;
        "pkg-0.22.1+1.21.4-fabric" = _oyNdnqgp;
        "pkg-0.22.1+1.21.4-neoforge" = _Il2NCSmv;
        "pkg-0.22.1+1.8.9-forge" = _YVu7heFf;
        "pkg-0.22.1+1.12.2-fabric" = _h1deP4p0;
        "pkg-0.22.1+1.8.9-fabric" = _R3MH0NAs;
        "pkg-0.23.0+1.12.2-fabric" = _xtJoOung;
        "pkg-0.23.0+1.12.2-forge" = _pM1kSQOY;
        "pkg-0.23.0+1.16.5-fabric" = _OTnFW0PM;
        "pkg-0.23.0+1.16.5-forge" = _yEadJGew;
        "pkg-0.23.0+1.17.1-fabric" = _mSGmEfW1;
        "pkg-0.23.0+1.17.1-forge" = _4mZOUawq;
        "pkg-0.23.0+1.18.2-fabric" = _bXGaSfVe;
        "pkg-0.23.0+1.18.2-forge" = _I6KmP8xZ;
        "pkg-0.23.0+1.19.2-fabric" = _qNJYOuSw;
        "pkg-0.23.0+1.19.2-forge" = _Yluo4f8Y;
        "pkg-0.23.0+1.19.4-fabric" = _X4WuuiPZ;
        "pkg-0.23.0+1.19.4-forge" = _Z1Nrrb3E;
        "pkg-0.23.0+1.20.1-fabric" = _YTc82ohr;
        "pkg-0.23.0+1.20.1-forge" = _q2nEMNaT;
        "pkg-0.23.0+1.20.4-fabric" = _cQCHDvYb;
        "pkg-0.23.0+1.20.4-forge" = _fhr8GLIA;
        "pkg-0.23.0+1.20.4-neoforge" = _rUopZGCw;
        "pkg-0.23.0+1.20.6-fabric" = _rPm0OHNd;
        "pkg-0.23.0+1.20.6-neoforge" = _ZNa9sk3J;
        "pkg-0.23.0+1.21.1-fabric" = _eWukehkB;
        "pkg-0.23.0+1.21.1-neoforge" = _kyIgah4k;
        "pkg-0.23.0+1.21.2-fabric" = _HcMsrqw2;
        "pkg-0.23.0+1.21.2-neoforge" = _BUay8Gnf;
        "pkg-0.23.0+1.21.3-fabric" = _xhCYCqSo;
        "pkg-0.23.0+1.21.3-neoforge" = _BiCfoukN;
        "pkg-0.23.0+1.21.4-fabric" = _V2r0tWB1;
        "pkg-0.23.0+1.21.4-neoforge" = _8G8w9dmh;
        "pkg-0.23.0+1.8.9-fabric" = _tkrdBjBX;
        "pkg-0.23.0+1.8.9-forge" = _Olmj4NKh;
        "pkg-0.24.0+1.12.2-fabric" = _MmO917PM;
        "pkg-0.24.0+1.12.2-forge" = _ETggwzoU;
        "pkg-0.24.0+1.16.5-fabric" = _Dx7ERFEN;
        "pkg-0.24.0+1.16.5-forge" = _61BmF18P;
        "pkg-0.24.0+1.17.1-fabric" = _K2GTj3vN;
        "pkg-0.24.0+1.17.1-forge" = _dHpNmr4b;
        "pkg-0.24.0+1.18.2-fabric" = _qvovzA8m;
        "pkg-0.24.0+1.18.2-forge" = _OD3AmK5f;
        "pkg-0.24.0+1.19.2-fabric" = _KuLYKvXs;
        "pkg-0.24.0+1.19.2-forge" = _rQeyvmfG;
        "pkg-0.24.0+1.19.4-fabric" = _bsTbP1lX;
        "pkg-0.24.0+1.19.4-forge" = _NVwNEy2f;
        "pkg-0.24.0+1.20.1-fabric" = _f3xwz9WS;
        "pkg-0.24.0+1.20.1-forge" = _8tcUQtI9;
        "pkg-0.24.0+1.20.4-fabric" = _tQEg1hqs;
        "pkg-0.24.0+1.20.4-forge" = _qC4hqXrX;
        "pkg-0.24.0+1.20.4-neoforge" = _pjyWnXCT;
        "pkg-0.24.0+1.20.6-fabric" = _S15he2SA;
        "pkg-0.24.0+1.20.6-neoforge" = _Ho5ZpnGI;
        "pkg-0.24.0+1.21.1-fabric" = _v5Lf0OXs;
        "pkg-0.24.0+1.21.1-neoforge" = _Yuaabf5q;
        "pkg-0.24.0+1.21.2-fabric" = _RYRXOra0;
        "pkg-0.24.0+1.21.2-neoforge" = _XyKEtgkA;
        "pkg-0.24.0+1.21.3-fabric" = _vkw9tU7z;
        "pkg-0.24.0+1.21.3-neoforge" = _E0vr10mk;
        "pkg-0.24.0+1.21.4-fabric" = _Zgy0Zu3b;
        "pkg-0.24.0+1.21.4-neoforge" = _izjWGaCX;
        "pkg-0.24.0+1.8.9-fabric" = _sEL35YuF;
        "pkg-0.24.0+1.8.9-forge" = _pnajqon2;
        "pkg-0.24.1+1.12.2-fabric" = _LPJetRuE;
        "pkg-0.24.1+1.12.2-forge" = _RDmu1PxG;
        "pkg-0.24.1+1.16.5-fabric" = _CidOSTzy;
        "pkg-0.24.1+1.16.5-forge" = _Hy1SaT9Q;
        "pkg-0.24.1+1.17.1-fabric" = _hMUkpuHW;
        "pkg-0.24.1+1.17.1-forge" = _37leXdwF;
        "pkg-0.24.1+1.18.2-fabric" = _VzO5Xsp5;
        "pkg-0.24.1+1.18.2-forge" = _Fxn5UkRl;
        "pkg-0.24.1+1.19.2-fabric" = _aSO8ET1F;
        "pkg-0.24.1+1.19.2-forge" = _Q1fXYiAJ;
        "pkg-0.24.1+1.19.4-fabric" = _HFU8OpOu;
        "pkg-0.24.1+1.19.4-forge" = _lqXf0JAb;
        "pkg-0.24.1+1.20.1-fabric" = _fNJNUMdA;
        "pkg-0.24.1+1.20.1-forge" = _2U5JwmHF;
        "pkg-0.24.1+1.20.4-fabric" = _eZW4CVkm;
        "pkg-0.24.1+1.20.4-forge" = _qbkvkGI5;
        "pkg-0.24.1+1.20.4-neoforge" = _j1W5QHDQ;
        "pkg-0.24.1+1.20.6-fabric" = _o9LBlgWm;
        "pkg-0.24.1+1.20.6-neoforge" = _UHPkyluZ;
        "pkg-0.24.1+1.21.1-fabric" = _pAWyCoQz;
        "pkg-0.24.1+1.21.1-neoforge" = _ISt1m9wQ;
        "pkg-0.24.1+1.21.2-fabric" = _J6Z7k1bH;
        "pkg-0.24.1+1.21.2-neoforge" = _14yhZCNU;
        "pkg-0.24.1+1.21.3-fabric" = _uUTZsPzm;
        "pkg-0.24.1+1.21.3-neoforge" = _xIQtOlJG;
        "pkg-0.24.1+1.21.4-fabric" = _Z9kd8RWl;
        "pkg-0.24.1+1.21.4-neoforge" = _i0SY1pWD;
        "pkg-0.24.1+1.8.9-fabric" = _DGRmluvS;
        "pkg-0.24.1+1.8.9-forge" = _p6MEnnCl;
        "pkg-0.24.2+1.12.2-fabric" = _7zCVVq7f;
        "pkg-0.24.2+1.12.2-forge" = _ofqzNDns;
        "pkg-0.24.2+1.16.5-fabric" = _onSOu7Sl;
        "pkg-0.24.2+1.16.5-forge" = _XL4CLChW;
        "pkg-0.24.2+1.17.1-fabric" = _SthHpfZ5;
        "pkg-0.24.2+1.17.1-forge" = _igUef4qW;
        "pkg-0.24.2+1.18.2-fabric" = _pmAmT1o3;
        "pkg-0.24.2+1.18.2-forge" = _g0QAVZkC;
        "pkg-0.24.2+1.19.2-fabric" = _BVXvWckz;
        "pkg-0.24.2+1.19.2-forge" = _tk31UT1Y;
        "pkg-0.24.2+1.19.4-fabric" = _XgSLK5xV;
        "pkg-0.24.2+1.19.4-forge" = _m9IpIjba;
        "pkg-0.24.2+1.20.1-fabric" = _PRbwCac2;
        "pkg-0.24.2+1.20.1-forge" = _U4xRraZO;
        "pkg-0.24.2+1.20.4-fabric" = _izIUcgc4;
        "pkg-0.24.2+1.20.4-forge" = _yc74D0I9;
        "pkg-0.24.2+1.20.4-neoforge" = _uY1Mf2Re;
        "pkg-0.24.2+1.20.6-fabric" = _EygGjGEd;
        "pkg-0.24.2+1.20.6-neoforge" = _8t1LGuvd;
        "pkg-0.24.2+1.21.1-fabric" = _WB44W2yu;
        "pkg-0.24.2+1.21.1-neoforge" = _3qZIKMUi;
        "pkg-0.24.2+1.21.2-fabric" = _hd9bM25u;
        "pkg-0.24.2+1.21.2-neoforge" = _t5JHSwhu;
        "pkg-0.24.2+1.21.3-fabric" = _wlSAmXRC;
        "pkg-0.24.2+1.21.3-neoforge" = _DN8MGDRz;
        "pkg-0.24.2+1.21.4-fabric" = _S2KVCVvN;
        "pkg-0.24.2+1.21.4-neoforge" = _4vwmvPtZ;
        "pkg-0.24.2+1.8.9-fabric" = _54R3sK7y;
        "pkg-0.24.2+1.8.9-forge" = _gIXh2Rv7;
        "pkg-0.24.3+1.12.2-fabric" = _qxdclTO2;
        "pkg-0.24.3+1.12.2-forge" = _JV1gjgT7;
        "pkg-0.24.3+1.16.5-fabric" = _ipf6DrBi;
        "pkg-0.24.3+1.16.5-forge" = _HKkoIjur;
        "pkg-0.24.3+1.17.1-fabric" = _AUYu5Ng2;
        "pkg-0.24.3+1.17.1-forge" = _omdj7Orb;
        "pkg-0.24.3+1.18.2-fabric" = _3Gigiqjy;
        "pkg-0.24.3+1.18.2-forge" = _ow0eVEP8;
        "pkg-0.24.3+1.19.2-fabric" = _gjksXjYZ;
        "pkg-0.24.3+1.19.2-forge" = _WbV4Wo9c;
        "pkg-0.24.3+1.19.4-fabric" = _y3AQQ1z4;
        "pkg-0.24.3+1.19.4-forge" = _flJEeDTf;
        "pkg-0.24.3+1.20.1-fabric" = _bHf7XtTR;
        "pkg-0.24.3+1.20.1-forge" = _E7sG2Q6w;
        "pkg-0.24.3+1.20.4-fabric" = _EPksl1HW;
        "pkg-0.24.3+1.20.4-forge" = _nXIwfb1U;
        "pkg-0.24.3+1.20.4-neoforge" = _6ZIy5j7F;
        "pkg-0.24.3+1.20.6-fabric" = _tupYREnB;
        "pkg-0.24.3+1.20.6-neoforge" = _jZF4o5Zg;
        "pkg-0.24.3+1.21.1-fabric" = _k4GRYLTz;
        "pkg-0.24.3+1.21.1-neoforge" = _1XBYD6az;
        "pkg-0.24.3+1.21.2-fabric" = _4IjOvcHi;
        "pkg-0.24.3+1.21.2-neoforge" = _sHEOH3Ps;
        "pkg-0.24.3+1.21.3-fabric" = _TxkcEgN7;
        "pkg-0.24.3+1.21.3-neoforge" = _mGHcqFsN;
        "pkg-0.24.3+1.21.4-fabric" = _moTnMCY9;
        "pkg-0.24.3+1.21.4-neoforge" = _4CemCxct;
        "pkg-0.24.3+1.8.9-fabric" = _Nuit4X13;
        "pkg-0.24.3+1.8.9-forge" = _jaFKcPKF;
        "pkg-0.25.0+1.12.2-fabric" = _3CX517MK;
        "pkg-0.25.0+1.12.2-forge" = _1EPIXRom;
        "pkg-0.25.0+1.16.5-fabric" = _FYi33B6V;
        "pkg-0.25.0+1.16.5-forge" = _xbf8x3HI;
        "pkg-0.25.0+1.17.1-fabric" = _OIof5LrF;
        "pkg-0.25.0+1.17.1-forge" = _y1Uc0JNg;
        "pkg-0.25.0+1.18.2-fabric" = _r8mR9kl3;
        "pkg-0.25.0+1.18.2-forge" = _o7OgRKnF;
        "pkg-0.25.0+1.19.2-fabric" = _e8F0oqgH;
        "pkg-0.25.0+1.19.2-forge" = _4h0lbTpy;
        "pkg-0.25.0+1.19.4-fabric" = _mUxwtWlU;
        "pkg-0.25.0+1.19.4-forge" = _KAru9IJB;
        "pkg-0.25.0+1.20.1-fabric" = _iC3Fjhy3;
        "pkg-0.25.0+1.20.1-forge" = _GDFD2lY5;
        "pkg-0.25.0+1.20.4-fabric" = _tcrWpsCu;
        "pkg-0.25.0+1.20.4-forge" = _WFk4VyZ2;
        "pkg-0.25.0+1.20.4-neoforge" = _lcJ6vPDc;
        "pkg-0.25.0+1.20.6-fabric" = _npEqy7ka;
        "pkg-0.25.0+1.20.6-neoforge" = _ve64Yuyd;
        "pkg-0.25.0+1.21.1-fabric" = _OAxc7H0Z;
        "pkg-0.25.0+1.21.1-neoforge" = _vXI4yDBI;
        "pkg-0.25.0+1.21.2-fabric" = _PZWkKpzX;
        "pkg-0.25.0+1.21.2-neoforge" = _9YgWsnwq;
        "pkg-0.25.0+1.21.3-fabric" = _uE6OobYW;
        "pkg-0.25.0+1.21.3-neoforge" = _eKkkspXG;
        "pkg-0.25.0+1.21.4-fabric" = _1IOsQcod;
        "pkg-0.25.0+1.21.4-neoforge" = _5hZ6GzvW;
        "pkg-0.25.0+1.8.9-fabric" = _TOLEd0pc;
        "pkg-0.25.0+1.8.9-forge" = _AaWwCmLM;
        "pkg-0.26.2+1.12.2-fabric" = _6qD3KTtK;
        "pkg-0.26.2+1.12.2-forge" = _VlKKE1Nw;
        "pkg-0.26.2+1.16.5-fabric" = _CdejYOlh;
        "pkg-0.26.2+1.16.5-forge" = _xAImOGJk;
        "pkg-0.26.2+1.17.1-fabric" = _NlGfWxJr;
        "pkg-0.26.2+1.17.1-forge" = _xmQRiSG5;
        "pkg-0.26.2+1.18.2-fabric" = _Pc5gGPP2;
        "pkg-0.26.2+1.18.2-forge" = _KJ2uvAEc;
        "pkg-0.26.2+1.19.2-fabric" = _j0qprhOa;
        "pkg-0.26.2+1.19.2-forge" = _2n67AZVS;
        "pkg-0.26.2+1.19.4-fabric" = _LLMiEpQo;
        "pkg-0.26.2+1.19.4-forge" = _cuqmvzEP;
        "pkg-0.26.2+1.20.1-fabric" = _Ujok0nRh;
        "pkg-0.26.2+1.20.1-forge" = _7vH6FZEF;
        "pkg-0.26.2+1.20.4-fabric" = _XQzHTD9Y;
        "pkg-0.26.2+1.20.4-forge" = _fMSRwivN;
        "pkg-0.26.2+1.20.4-neoforge" = _4jv01M83;
        "pkg-0.26.2+1.20.6-fabric" = _Wbo79Wto;
        "pkg-0.26.2+1.20.6-neoforge" = _GyuWcn3B;
        "pkg-0.26.2+1.21.1-fabric" = _R5tJu36k;
        "pkg-0.26.2+1.21.1-neoforge" = _CEARIIvt;
        "pkg-0.26.2+1.21.2-fabric" = _XauD7lCQ;
        "pkg-0.26.2+1.21.2-neoforge" = _KfcbkRlv;
        "pkg-0.26.2+1.21.3-fabric" = _gajn67MD;
        "pkg-0.26.2+1.21.3-neoforge" = _oUUz2gyv;
        "pkg-0.26.2+1.21.4-fabric" = _I6BHHJMh;
        "pkg-0.26.2+1.21.4-neoforge" = _8Y1I6qX6;
        "pkg-0.26.2+1.21.5-fabric" = _JzwYBZ43;
        "pkg-0.26.2+1.21.5-neoforge" = _T2lLAP9F;
        "pkg-0.26.2+1.8.9-fabric" = _xO4QNHWA;
        "pkg-0.26.2+1.8.9-forge" = _uSgNd6AW;
        "pkg-0.27.0+1.12.2-fabric" = _bp8IZvRW;
        "pkg-0.27.0+1.12.2-forge" = _cr7LSuvp;
        "pkg-0.27.0+1.16.5-fabric" = _Gh8a3rFL;
        "pkg-0.27.0+1.16.5-forge" = _yHHhPryE;
        "pkg-0.27.0+1.17.1-fabric" = _n6kn6Wcb;
        "pkg-0.27.0+1.17.1-forge" = _VHzMDBJh;
        "pkg-0.27.0+1.18.2-fabric" = _z9Fubzuq;
        "pkg-0.27.0+1.18.2-forge" = _FD9b64mG;
        "pkg-0.27.0+1.19.2-fabric" = _apQxUsQf;
        "pkg-0.27.0+1.19.2-forge" = _Bg7Vnrww;
        "pkg-0.27.0+1.19.4-fabric" = _L6Nw2bEF;
        "pkg-0.27.0+1.19.4-forge" = _H9cjaU0S;
        "pkg-0.27.0+1.20.1-fabric" = _oH9CwO2p;
        "pkg-0.27.0+1.20.1-forge" = _xxOwOZRN;
        "pkg-0.27.0+1.20.4-fabric" = _4ZFmNQhw;
        "pkg-0.27.0+1.20.4-forge" = _noNSHgDk;
        "pkg-0.27.0+1.20.4-neoforge" = _X8nP1cTr;
        "pkg-0.27.0+1.20.6-fabric" = _6Ca5lpjc;
        "pkg-0.27.0+1.20.6-neoforge" = _bspGDrui;
        "pkg-0.27.0+1.21.1-fabric" = _XNUBlkWi;
        "pkg-0.27.0+1.21.1-neoforge" = _mJt5RKsz;
        "pkg-0.27.0+1.21.2-fabric" = _u9MRn8HZ;
        "pkg-0.27.0+1.21.2-neoforge" = _qDVk79OM;
        "pkg-0.27.0+1.21.3-fabric" = _XVG0meU4;
        "pkg-0.27.0+1.21.3-neoforge" = _cOw95d0n;
        "pkg-0.27.0+1.21.4-fabric" = _uWSukA9s;
        "pkg-0.27.0+1.21.4-neoforge" = _wzYwxmC8;
        "pkg-0.27.0+1.21.5-fabric" = _TdE7R1XA;
        "pkg-0.27.0+1.21.5-neoforge" = _dgHsqPrl;
        "pkg-0.27.0+1.8.9-fabric" = _KSqwME2k;
        "pkg-0.27.0+1.8.9-forge" = _AUYyUltV;
        "pkg-0.28.0+1.12.2-fabric" = _mxXB5nrc;
        "pkg-0.28.0+1.12.2-forge" = _R2qCerFr;
        "pkg-0.28.0+1.16.5-fabric" = _4JtY7jLo;
        "pkg-0.28.0+1.17.1-fabric" = _86OyuCAD;
        "pkg-0.28.0+1.17.1-forge" = _LJpXl7ZL;
        "pkg-0.28.0+1.18.2-fabric" = _ZAlk778L;
        "pkg-0.28.0+1.18.2-forge" = _q7PeIvkR;
        "pkg-0.28.0+1.19.2-fabric" = _3nq0anYR;
        "pkg-0.28.0+1.19.2-forge" = _xHPO86fp;
        "pkg-0.28.0+1.19.4-fabric" = _vFNp3gTr;
        "pkg-0.28.0+1.19.4-forge" = _n5VyYNzd;
        "pkg-0.28.0+1.20.1-fabric" = _RNN6Qcgv;
        "pkg-0.28.0+1.20.1-forge" = _fhBbq8DR;
        "pkg-0.28.0+1.20.4-fabric" = _cE4SZXMQ;
        "pkg-0.28.0+1.20.4-forge" = _qLD6ffM8;
        "pkg-0.28.0+1.20.4-neoforge" = _AyNjktRm;
        "pkg-0.28.0+1.20.6-fabric" = _Aa4bAS3Q;
        "pkg-0.28.0+1.20.6-neoforge" = _VE467sY1;
        "pkg-0.28.0+1.21.1-fabric" = _rsnKRW25;
        "pkg-0.28.0+1.21.1-neoforge" = _xNNCSNXb;
        "pkg-0.28.0+1.21.2-fabric" = _PAXmwUCf;
        "pkg-0.28.0+1.21.2-neoforge" = _LWXolOmV;
        "pkg-0.28.0+1.21.3-fabric" = _n4CFxeri;
        "pkg-0.28.0+1.21.3-neoforge" = _IVCjsQ3L;
        "pkg-0.28.0+1.21.4-fabric" = _UPuufxwa;
        "pkg-0.28.0+1.21.4-neoforge" = _6pcajImE;
        "pkg-0.28.0+1.21.5-fabric" = _GimvKfzd;
        "pkg-0.28.0+1.21.5-neoforge" = _18aTIznB;
        "pkg-0.28.0+1.8.9-fabric" = _VPQZ90CL;
        "pkg-0.28.0+1.8.9-forge" = _7ASwoOce;
        "pkg-0.29.0+1.12.2-fabric" = _jsj9rkz4;
        "pkg-0.29.0+1.12.2-forge" = _LKuuqlYt;
        "pkg-0.29.0+1.16.5-fabric" = _uTnVKC99;
        "pkg-0.29.0+1.16.5-forge" = _5W2aE6PO;
        "pkg-0.29.0+1.17.1-fabric" = _3cuNKZ8y;
        "pkg-0.29.0+1.17.1-forge" = _k60ZoPyO;
        "pkg-0.29.0+1.18.2-fabric" = _Lu5G55h8;
        "pkg-0.29.0+1.18.2-forge" = _3pQlsK37;
        "pkg-0.29.0+1.19.2-fabric" = _pwwotkq2;
        "pkg-0.29.0+1.19.2-forge" = _j6cibtZd;
        "pkg-0.29.0+1.19.4-fabric" = _95XELzZm;
        "pkg-0.29.0+1.19.4-forge" = _S2caE377;
        "pkg-0.29.0+1.20.1-fabric" = _ps0Nc5cl;
        "pkg-0.29.0+1.20.1-forge" = _5Towki0W;
        "pkg-0.29.0+1.20.4-fabric" = _JCfcsIHk;
        "pkg-0.29.0+1.20.4-forge" = _XGnTUJt6;
        "pkg-0.29.0+1.20.4-neoforge" = _jiZ1z6hi;
        "pkg-0.29.0+1.20.6-fabric" = _5dXMEZVf;
        "pkg-0.29.0+1.20.6-neoforge" = _FwyhNFJx;
        "pkg-0.29.0+1.21.1-fabric" = _pzK0Z3Yl;
        "pkg-0.29.0+1.21.1-neoforge" = _ZHc7Gs23;
        "pkg-0.29.0+1.21.2-fabric" = _QdGntsam;
        "pkg-0.29.0+1.21.2-neoforge" = _Vquwhlg5;
        "pkg-0.29.0+1.21.3-fabric" = _T2xQuX7k;
        "pkg-0.29.0+1.21.3-neoforge" = _EBecgRfl;
        "pkg-0.29.0+1.21.4-fabric" = _irXK4rB2;
        "pkg-0.29.0+1.21.4-neoforge" = _RA3MZsXc;
        "pkg-0.29.0+1.21.5-fabric" = _PUYTzr43;
        "pkg-0.29.0+1.21.5-neoforge" = _zr0Z2Ace;
        "pkg-0.29.0+1.8.9-fabric" = _RZalR9gf;
        "pkg-0.29.0+1.8.9-forge" = _wuG72KeD;
        "pkg-0.30.0+1.12.2-fabric" = _zwWCE7lo;
        "pkg-0.30.0+1.12.2-forge" = _X4jTPSDf;
        "pkg-0.30.0+1.16.5-fabric" = _hZCFdvxq;
        "pkg-0.30.0+1.16.5-forge" = _73KuM0n3;
        "pkg-0.30.0+1.17.1-fabric" = _8vX2PUKq;
        "pkg-0.30.0+1.17.1-forge" = _At1MgHIl;
        "pkg-0.30.0+1.18.2-fabric" = _k9gQSgCT;
        "pkg-0.30.0+1.18.2-forge" = _S0W3m9YP;
        "pkg-0.30.0+1.19.2-fabric" = _lF1IJaPE;
        "pkg-0.30.0+1.19.2-forge" = _XxZPaDQF;
        "pkg-0.30.0+1.19.4-fabric" = _IvlW2maG;
        "pkg-0.30.0+1.19.4-forge" = _40LTtOf3;
        "pkg-0.30.0+1.20.1-fabric" = _eIK7SpNK;
        "pkg-0.30.0+1.20.1-forge" = _uoqmdUUY;
        "pkg-0.30.0+1.20.4-fabric" = _VGQRDLYz;
        "pkg-0.30.0+1.20.4-forge" = _h4twaPNQ;
        "pkg-0.30.0+1.20.4-neoforge" = _CGjTACuh;
        "pkg-0.30.0+1.20.6-fabric" = _YtdOMEbe;
        "pkg-0.30.0+1.20.6-neoforge" = _IDu9Oej7;
        "pkg-0.30.0+1.21.1-fabric" = _X4HZ9x6d;
        "pkg-0.30.0+1.21.1-neoforge" = _qOdfyzBb;
        "pkg-0.30.0+1.21.2-fabric" = _PAhfoUYA;
        "pkg-0.30.0+1.21.2-neoforge" = _OYcc22zE;
        "pkg-0.30.0+1.21.3-fabric" = _EsSJnPdO;
        "pkg-0.30.0+1.21.3-neoforge" = _ndRhzxWa;
        "pkg-0.30.0+1.21.4-fabric" = _mIgokqyS;
        "pkg-0.30.0+1.21.4-neoforge" = _cQELN6Nr;
        "pkg-0.30.0+1.21.5-fabric" = _ODw6kbWt;
        "pkg-0.30.0+1.21.5-neoforge" = _B8vfrinL;
        "pkg-0.30.0+1.8.9-fabric" = _kiZa4cPs;
        "pkg-0.30.0+1.8.9-forge" = _D1pw91BO;
        "pkg-0.31.0+1.12.2-fabric" = _r8AvCFQV;
        "pkg-0.31.0+1.12.2-forge" = _NMRz3AY0;
        "pkg-0.31.0+1.16.5-fabric" = _ggDKAKKz;
        "pkg-0.31.0+1.16.5-forge" = _KOkb5rGs;
        "pkg-0.31.0+1.17.1-fabric" = _l2Aecb8Z;
        "pkg-0.31.0+1.17.1-forge" = _WpzoyK3G;
        "pkg-0.31.0+1.18.2-fabric" = _fmNjz7eD;
        "pkg-0.31.0+1.18.2-forge" = _zyISh1ez;
        "pkg-0.31.0+1.19.2-fabric" = _zfEbdTm6;
        "pkg-0.31.0+1.19.2-forge" = _N3vozy9x;
        "pkg-0.31.0+1.19.4-fabric" = _4L1E2lTl;
        "pkg-0.31.0+1.19.4-forge" = _UQRrdXFe;
        "pkg-0.31.0+1.20.1-fabric" = _VuQ4aKVE;
        "pkg-0.31.0+1.20.1-forge" = _ur7VIueb;
        "pkg-0.31.0+1.20.4-fabric" = _tXS7ZnvP;
        "pkg-0.31.0+1.20.4-forge" = _UcMZgF4c;
        "pkg-0.31.0+1.20.4-neoforge" = _cb8U978x;
        "pkg-0.31.0+1.20.6-fabric" = _PIUMyj9s;
        "pkg-0.31.0+1.20.6-neoforge" = _t7ajcGu1;
        "pkg-0.31.0+1.21.1-fabric" = _lFyF7xZh;
        "pkg-0.31.0+1.21.1-neoforge" = _e2S0sTlc;
        "pkg-0.31.0+1.21.2-fabric" = _LH6xtNXb;
        "pkg-0.31.0+1.21.2-neoforge" = _4B5yUtRG;
        "pkg-0.31.0+1.21.3-fabric" = _kmowifJw;
        "pkg-0.31.0+1.21.3-neoforge" = _LibORhEr;
        "pkg-0.31.0+1.21.4-fabric" = _SwiJshUA;
        "pkg-0.31.0+1.21.5-fabric" = _tGFeC96E;
        "pkg-0.31.0+1.21.5-neoforge" = _WNAqplWj;
        "pkg-0.31.0+1.8.9-fabric" = _Ft7W7K2M;
        "pkg-0.31.0+1.8.9-forge" = _syOQEgcf;
        "pkg-0.31.0+1.21.4-neoforge" = _cUu3QBQG;
        "pkg-0.32.0+1.12.2-fabric" = _aOKPw10k;
        "pkg-0.32.0+1.12.2-forge" = _KZmjhHJs;
        "pkg-0.32.0+1.16.5-fabric" = _NjQt4Vwe;
        "pkg-0.32.0+1.16.5-forge" = _ICEl7tuA;
        "pkg-0.32.0+1.17.1-fabric" = _QQL3OtK1;
        "pkg-0.32.0+1.17.1-forge" = _5KMtK4LL;
        "pkg-0.32.0+1.18.2-fabric" = _ComwntNL;
        "pkg-0.32.0+1.18.2-forge" = _qGkeKIaC;
        "pkg-0.32.0+1.19.2-fabric" = _KuJ0Ct6g;
        "pkg-0.32.0+1.19.2-forge" = _N4EnSovo;
        "pkg-0.32.0+1.19.4-fabric" = _P4YircTZ;
        "pkg-0.32.0+1.19.4-forge" = _nL5JzRuL;
        "pkg-0.32.0+1.20.1-fabric" = _42eX3rE6;
        "pkg-0.32.0+1.20.1-forge" = _f9ftOrnv;
        "pkg-0.32.0+1.20.4-fabric" = _uGLqBtEJ;
        "pkg-0.32.0+1.20.4-forge" = _8EVOyHkQ;
        "pkg-0.32.0+1.20.4-neoforge" = _tWF5y8ea;
        "pkg-0.32.0+1.20.6-fabric" = _uuND0eQu;
        "pkg-0.32.0+1.20.6-neoforge" = _I49uxiY5;
        "pkg-0.32.0+1.21.1-fabric" = _GfIT26jw;
        "pkg-0.32.0+1.21.1-neoforge" = _CC5j9zGO;
        "pkg-0.32.0+1.21.2-fabric" = _IoCql8tN;
        "pkg-0.32.0+1.21.2-neoforge" = _DaJyqA7a;
        "pkg-0.32.0+1.21.3-fabric" = _9nnQKCml;
        "pkg-0.32.0+1.21.3-neoforge" = _MemXW2lF;
        "pkg-0.32.0+1.21.4-fabric" = _ZE12wEtT;
        "pkg-0.32.0+1.21.4-neoforge" = _2D5O3mHM;
        "pkg-0.32.0+1.21.5-fabric" = _eLejZ9ir;
        "pkg-0.32.0+1.21.5-neoforge" = _7KYtZlcM;
        "pkg-0.32.0+1.8.9-fabric" = _6az9tEjP;
        "pkg-0.32.0+1.8.9-forge" = _WPIArT4x;
        "pkg-0.33.0+1.12.2-fabric" = _GB7fvo7y;
        "pkg-0.33.0+1.12.2-forge" = _QTqk8EwA;
        "pkg-0.33.0+1.16.5-fabric" = _sFRVNqCB;
        "pkg-0.33.0+1.16.5-forge" = _A79Ktkll;
        "pkg-0.33.0+1.17.1-fabric" = _B1LZhkWD;
        "pkg-0.33.0+1.17.1-forge" = _2R2N7P21;
        "pkg-0.33.0+1.18.2-fabric" = _pt2NqQ5E;
        "pkg-0.33.0+1.18.2-forge" = _zckke95O;
        "pkg-0.33.0+1.19.2-fabric" = _Y14AulY0;
        "pkg-0.33.0+1.19.2-forge" = _FY1OLJoX;
        "pkg-0.33.0+1.19.4-fabric" = _7TowqZNe;
        "pkg-0.33.0+1.19.4-forge" = _RLQSODID;
        "pkg-0.33.0+1.20.1-fabric" = _9Yl7G6gT;
        "pkg-0.33.0+1.20.1-forge" = _ccLcqC5m;
        "pkg-0.33.0+1.20.4-fabric" = _3ge5upJI;
        "pkg-0.33.0+1.20.4-forge" = _WCGI99EM;
        "pkg-0.33.0+1.20.4-neoforge" = _JCX9dswY;
        "pkg-0.33.0+1.20.6-fabric" = _YlVnV4tj;
        "pkg-0.33.0+1.20.6-neoforge" = _gVb27JY6;
        "pkg-0.33.0+1.21.1-fabric" = _PLUFzstU;
        "pkg-0.33.0+1.21.1-neoforge" = _AMPonzaT;
        "pkg-0.33.0+1.21.2-fabric" = _jhTRrQQr;
        "pkg-0.33.0+1.21.2-neoforge" = _miiq1i03;
        "pkg-0.33.1+1.12.2-fabric" = _3Vrg3mI4;
        "pkg-0.33.1+1.12.2-forge" = _qQQBkwjT;
        "pkg-0.33.1+1.16.5-fabric" = _bMOMQxIR;
        "pkg-0.33.1+1.16.5-forge" = _JuIAhOxR;
        "pkg-0.33.1+1.17.1-fabric" = _byRDwoqH;
        "pkg-0.33.1+1.17.1-forge" = _EM3oXfKT;
        "pkg-0.33.1+1.18.2-fabric" = _rBKndfiB;
        "pkg-0.33.1+1.18.2-forge" = _q0QYFG9x;
        "pkg-0.33.1+1.19.2-fabric" = _w9ajIUP4;
        "pkg-0.33.1+1.19.2-forge" = _MMnLnxU3;
        "pkg-0.33.1+1.19.4-fabric" = _3qfsPjMF;
        "pkg-0.33.1+1.19.4-forge" = _Mg1HDftd;
        "pkg-0.33.1+1.20.1-fabric" = _fLoOIfd7;
        "pkg-0.33.1+1.20.1-forge" = _9cXnXFoA;
        "pkg-0.33.1+1.20.4-fabric" = _QnRg68yt;
        "pkg-0.33.1+1.20.4-forge" = _F4MERGtz;
        "pkg-0.33.1+1.20.4-neoforge" = _7EtOeI2U;
        "pkg-0.33.1+1.20.6-fabric" = _PDeojgoT;
        "pkg-0.33.1+1.20.6-neoforge" = _6tinghvo;
        "pkg-0.33.1+1.21.1-fabric" = _e6J1KdPT;
        "pkg-0.33.1+1.21.1-neoforge" = _GHFPfW2u;
        "pkg-0.33.1+1.21.2-fabric" = _hMqbEL3X;
        "pkg-0.33.1+1.21.2-neoforge" = _nTRCJR9G;
        "pkg-0.33.1+1.21.3-fabric" = _vb8f6PGK;
        "pkg-0.33.1+1.21.3-neoforge" = _KJqitT3F;
        "pkg-0.33.1+1.21.4-fabric" = _3XXh4lm2;
        "pkg-0.33.1+1.21.4-neoforge" = _VvVO5bEx;
        "pkg-0.33.1+1.21.5-fabric" = _39s1lcYY;
        "pkg-0.33.1+1.21.5-neoforge" = _V7grQ679;
        "pkg-0.33.1+1.8.9-fabric" = _sEY742EJ;
        "pkg-0.33.1+1.8.9-forge" = _4HXPZYBo;
        "pkg-0.34.0+1.12.2-fabric" = _e4C5G0b5;
        "pkg-0.34.0+1.12.2-forge" = _54UECgWI;
        "pkg-0.34.0+1.16.5-fabric" = _ayw11l0K;
        "pkg-0.34.0+1.16.5-forge" = _gO9dnFGF;
        "pkg-0.34.0+1.17.1-fabric" = _JPy3tlxS;
        "pkg-0.34.0+1.17.1-forge" = _7kpG21Ww;
        "pkg-0.34.0+1.18.2-fabric" = _UiwyQGl3;
        "pkg-0.34.0+1.18.2-forge" = _D2EpXjfY;
        "pkg-0.34.0+1.19.2-fabric" = _v8vfwBti;
        "pkg-0.34.0+1.19.2-forge" = _Bzq2atRr;
        "pkg-0.34.0+1.19.4-fabric" = _lTSbnVLR;
        "pkg-0.34.0+1.19.4-forge" = _rqBCF1iA;
        "pkg-0.34.0+1.20.1-fabric" = _rSYKIXSB;
        "pkg-0.34.0+1.20.1-forge" = _FDkzJ5qy;
        "pkg-0.34.0+1.20.4-fabric" = _bqfuK0JO;
        "pkg-0.34.0+1.20.4-forge" = _s5i80dEB;
        "pkg-0.34.0+1.20.4-neoforge" = _bRW5H0m0;
        "pkg-0.34.0+1.20.6-fabric" = _wV7DDqbv;
        "pkg-0.34.0+1.20.6-neoforge" = _4umtcZGf;
        "pkg-0.34.0+1.21.1-fabric" = _Wf0W7AoZ;
        "pkg-0.34.0+1.21.1-neoforge" = _LPcd30Av;
        "pkg-0.34.0+1.21.2-fabric" = _cLFmbKHV;
        "pkg-0.34.0+1.21.2-neoforge" = _1xWu2Bdp;
        "pkg-0.34.0+1.21.3-fabric" = _ocxW6OwL;
        "pkg-0.34.0+1.21.3-neoforge" = _Kt7f7E5w;
        "pkg-0.34.0+1.21.4-fabric" = _G39o3jSr;
        "pkg-0.34.0+1.21.4-neoforge" = _4MF8TYNy;
        "pkg-0.34.0+1.21.5-fabric" = _ArDzejUc;
        "pkg-0.34.0+1.21.5-neoforge" = _oFOFtL3p;
        "pkg-0.34.0+1.8.9-fabric" = _g6BPfyFG;
        "pkg-0.34.0+1.8.9-forge" = _W4pkE0YK;
        "pkg-0.35.0+1.12.2-fabric" = _l6FU2jHH;
        "pkg-0.35.0+1.12.2-forge" = _KxwlzqU6;
        "pkg-0.35.0+1.16.5-fabric" = _TsIjPBTn;
        "pkg-0.35.0+1.16.5-forge" = _uDJSQQLv;
        "pkg-0.35.0+1.17.1-fabric" = _kee9cZ7z;
        "pkg-0.35.0+1.17.1-forge" = _fJrdp5TU;
        "pkg-0.35.0+1.18.2-fabric" = _buGtPS1m;
        "pkg-0.35.0+1.18.2-forge" = _PAFPp8TD;
        "pkg-0.35.0+1.19.2-fabric" = _2RsKf80V;
        "pkg-0.35.0+1.19.2-forge" = _YN4SCKpM;
        "pkg-0.35.0+1.19.4-fabric" = _Z3tfrBfF;
        "pkg-0.35.0+1.19.4-forge" = _mtgLFBj1;
        "pkg-0.35.0+1.20.1-fabric" = _EeSvk14L;
        "pkg-0.35.0+1.20.1-forge" = _UxOE1nqn;
        "pkg-0.35.0+1.20.4-fabric" = _Aqi77gv8;
        "pkg-0.35.0+1.20.4-forge" = _vkuy8TZM;
        "pkg-0.35.0+1.20.4-neoforge" = _FoURsLve;
        "pkg-0.35.0+1.20.6-fabric" = _Y2u0oX72;
        "pkg-0.35.0+1.20.6-neoforge" = _OGFonhKO;
        "pkg-0.35.0+1.21.1-fabric" = _jFlsC58d;
        "pkg-0.35.0+1.21.1-neoforge" = _qmvuoKMb;
        "pkg-0.35.0+1.21.2-fabric" = _XwcdBd8Z;
        "pkg-0.35.0+1.21.2-neoforge" = _Qj3adq6F;
        "pkg-0.35.0+1.21.3-fabric" = _lQbML7Jc;
        "pkg-0.35.0+1.21.3-neoforge" = _JrkWQ3Xu;
        "pkg-0.35.0+1.21.4-fabric" = _UFvZxZlj;
        "pkg-0.35.0+1.21.4-neoforge" = _ZLZL205i;
        "pkg-0.35.0+1.21.5-fabric" = _V0ROvKPG;
        "pkg-0.35.0+1.21.5-neoforge" = _Y2xF5Mgb;
        "pkg-0.35.0+1.21.6-fabric" = _nD1mtMOR;
        "pkg-0.35.0+1.21.6-neoforge" = _yUReDUfW;
        "pkg-0.35.0+1.21.7-fabric" = _kBcyaLPn;
        "pkg-0.35.0+1.21.7-neoforge" = _zUL4lxor;
        "pkg-0.35.0+1.8.9-fabric" = _OkrpVocO;
        "pkg-0.35.0+1.8.9-forge" = _H6VUHi6s;
        "pkg-0.36.0+1.12.2-fabric" = _hibgH7qT;
        "pkg-0.36.0+1.12.2-forge" = _RFCL40vl;
        "pkg-0.36.0+1.16.5-fabric" = _6I8sr48D;
        "pkg-0.36.0+1.16.5-forge" = _lu55K2uE;
        "pkg-0.36.0+1.17.1-fabric" = _GXWEQRmj;
        "pkg-0.36.0+1.17.1-forge" = _Q8I8OEt1;
        "pkg-0.36.0+1.18.2-fabric" = _yf1pyi31;
        "pkg-0.36.0+1.18.2-forge" = _6qf6v1zk;
        "pkg-0.36.0+1.19.2-fabric" = _XRUmqVG5;
        "pkg-0.36.0+1.19.2-forge" = _eU73pivq;
        "pkg-0.36.0+1.19.4-fabric" = _2BKM6Dxh;
        "pkg-0.36.0+1.19.4-forge" = _YWGXtEDd;
        "pkg-0.36.0+1.20.1-fabric" = _O2a1pefN;
        "pkg-0.36.0+1.20.1-forge" = _I3hAK22m;
        "pkg-0.36.0+1.20.4-fabric" = _BHcII2MC;
        "pkg-0.36.0+1.20.4-forge" = _oL8nbTwz;
        "pkg-0.36.0+1.20.4-neoforge" = _ZwUAVvkT;
        "pkg-0.36.0+1.20.6-fabric" = _ajSjXHle;
        "pkg-0.36.0+1.20.6-neoforge" = _zZfVFETb;
        "pkg-0.36.0+1.21.1-fabric" = _flDDd0Ix;
        "pkg-0.36.0+1.21.1-neoforge" = _c8mFD6U1;
        "pkg-0.36.0+1.21.2-fabric" = _uuS93VJ6;
        "pkg-0.36.0+1.21.2-neoforge" = _DXGfmo3t;
        "pkg-0.36.0+1.21.3-fabric" = _V29vvnMp;
        "pkg-0.36.0+1.21.3-neoforge" = _Xo9CnH8y;
        "pkg-0.36.0+1.21.4-fabric" = _AZNwvXwY;
        "pkg-0.36.0+1.21.4-neoforge" = _1zTp3Ovl;
        "pkg-0.36.0+1.21.5-fabric" = _6pLu4vjU;
        "pkg-0.36.0+1.21.5-neoforge" = _Pj2VsEw2;
        "pkg-0.36.0+1.21.6-fabric" = _mV6DjDyE;
        "pkg-0.36.0+1.21.6-neoforge" = _EIStWZA5;
        "pkg-0.36.0+1.21.7-fabric" = _HBNXjd3y;
        "pkg-0.36.0+1.21.7-neoforge" = _2JLPWWNF;
        "pkg-0.36.0+1.8.9-fabric" = _y1yTL7cl;
        "pkg-0.36.0+1.8.9-forge" = _dtDkvdhA;
        "pkg-0.37.0+1.12.2-fabric" = _3rdMYzEr;
        "pkg-0.37.0+1.12.2-forge" = _ahtyPZrG;
        "pkg-0.37.0+1.16.5-fabric" = _yqetKeMI;
        "pkg-0.37.0+1.16.5-forge" = _j44WPZJW;
        "pkg-0.37.0+1.17.1-fabric" = _9x9awJaj;
        "pkg-0.37.0+1.17.1-forge" = _lq1NXewl;
        "pkg-0.37.0+1.18.2-fabric" = _3gtRcIn7;
        "pkg-0.37.0+1.18.2-forge" = _jFOPUdlP;
        "pkg-0.37.0+1.19.2-fabric" = _F7MTy37s;
        "pkg-0.37.0+1.19.2-forge" = _LR3YJxRs;
        "pkg-0.37.0+1.19.4-fabric" = _bpIm8ysV;
        "pkg-0.37.0+1.19.4-forge" = _u9wtUwEa;
        "pkg-0.37.0+1.20.1-fabric" = _o596IrI5;
        "pkg-0.37.0+1.20.1-forge" = _66OvQWHn;
        "pkg-0.37.0+1.20.4-fabric" = _D4tRpNio;
        "pkg-0.37.0+1.20.4-forge" = _1QOgeFIp;
        "pkg-0.37.0+1.20.4-neoforge" = _gM5Jsb4X;
        "pkg-0.37.0+1.20.6-fabric" = _ljf71UI2;
        "pkg-0.37.0+1.20.6-neoforge" = _jpPUdvDP;
        "pkg-0.37.0+1.21.1-fabric" = _sQKM1FvK;
        "pkg-0.37.0+1.21.1-neoforge" = _uM99WYt7;
        "pkg-0.37.0+1.21.2-fabric" = _x2ZT6WDq;
        "pkg-0.37.0+1.21.2-neoforge" = _6vW4Oqco;
        "pkg-0.37.0+1.21.3-fabric" = _s9iJUiVc;
        "pkg-0.37.0+1.21.3-neoforge" = _l0tUJ1up;
        "pkg-0.37.0+1.21.4-fabric" = _RepZm2Pm;
        "pkg-0.37.0+1.21.4-neoforge" = _ty154ath;
        "pkg-0.37.0+1.21.5-fabric" = _u672p4s4;
        "pkg-0.37.0+1.21.5-neoforge" = _gTE1b1GC;
        "pkg-0.37.0+1.21.6-fabric" = _QnU37DvL;
        "pkg-0.37.0+1.21.6-neoforge" = _OEy2mW5l;
        "pkg-0.37.0+1.21.7-fabric" = _5JHKIwqf;
        "pkg-0.37.0+1.21.7-neoforge" = _LvwDU0iJ;
        "pkg-0.37.0+1.8.9-fabric" = _uaOXqQvB;
        "pkg-0.37.0+1.8.9-forge" = _k5KfDQoq;
        "pkg-0.38.0+1.12.2-fabric" = _wmMAylCz;
        "pkg-0.38.0+1.12.2-forge" = _Y0AHiaCt;
        "pkg-0.38.0+1.16.5-fabric" = _VCrCv4s3;
        "pkg-0.38.0+1.16.5-forge" = _wecLuEpt;
        "pkg-0.38.0+1.17.1-fabric" = _vE2q770v;
        "pkg-0.38.0+1.17.1-forge" = _yUeodhjI;
        "pkg-0.38.0+1.18.2-fabric" = _Zzdh6bnN;
        "pkg-0.38.0+1.18.2-forge" = _vQdOSGZl;
        "pkg-0.38.0+1.19.2-fabric" = _lPDwzkkK;
        "pkg-0.38.0+1.19.2-forge" = _Mm6OPqk8;
        "pkg-0.38.0+1.19.4-fabric" = _RI5x0jOM;
        "pkg-0.38.0+1.19.4-forge" = _hGEzstpb;
        "pkg-0.38.0+1.20.1-fabric" = _jatQXHHi;
        "pkg-0.38.0+1.20.1-forge" = _hVExUXL2;
        "pkg-0.38.0+1.20.4-fabric" = _onVToiSa;
        "pkg-0.38.0+1.20.4-forge" = _8Dt4PgW2;
        "pkg-0.38.0+1.20.4-neoforge" = _dfTpg2zl;
        "pkg-0.38.0+1.20.6-fabric" = _TqitWJ4O;
        "pkg-0.38.0+1.20.6-neoforge" = _hnTCO3D8;
        "pkg-0.38.0+1.21.1-fabric" = _GXW8coU7;
        "pkg-0.38.0+1.21.1-neoforge" = _O7SF2g1N;
        "pkg-0.38.0+1.21.2-fabric" = _RLKeUjKG;
        "pkg-0.38.0+1.21.2-neoforge" = _uBCT84vn;
        "pkg-0.38.0+1.21.3-fabric" = _yEa4t8yZ;
        "pkg-0.38.0+1.21.3-neoforge" = _cDzAczZZ;
        "pkg-0.38.0+1.21.4-fabric" = _xvUT2DCD;
        "pkg-0.38.0+1.21.4-neoforge" = _pqrTAbuh;
        "pkg-0.38.0+1.21.5-fabric" = _AFcJ0qcE;
        "pkg-0.38.0+1.21.5-neoforge" = _2acs1p5z;
        "pkg-0.38.0+1.21.6-fabric" = _5pbHe4qE;
        "pkg-0.38.0+1.21.6-neoforge" = _gW9WCdsG;
        "pkg-0.38.0+1.21.7-fabric" = _8qKhk8pn;
        "pkg-0.38.0+1.21.7-neoforge" = _2amesDAK;
        "pkg-0.38.0+1.21.8-fabric" = _ienyQ19a;
        "pkg-0.38.0+1.21.8-neoforge" = _tjLSxlJL;
        "pkg-0.38.0+1.8.9-fabric" = _h5zJQgNw;
        "pkg-0.38.0+1.8.9-forge" = _IuPFxOAY;
        "pkg-0.39.0+1.12.2-fabric" = _tcGNVs9g;
        "pkg-0.39.0+1.12.2-forge" = _RzYrQ1SG;
        "pkg-0.39.0+1.16.5-fabric" = _HTQf8PzQ;
        "pkg-0.39.0+1.16.5-forge" = _IAhQxn4x;
        "pkg-0.39.0+1.17.1-fabric" = _9kTwQz2J;
        "pkg-0.39.0+1.17.1-forge" = _JRocKmTg;
        "pkg-0.39.0+1.18.2-fabric" = _3uIEcih4;
        "pkg-0.39.0+1.18.2-forge" = _MTLhpA1m;
        "pkg-0.39.0+1.19.2-fabric" = _gdk3cl6s;
        "pkg-0.39.0+1.19.2-forge" = _uWCMn5LD;
        "pkg-0.39.0+1.19.4-fabric" = _m7GgxYVk;
        "pkg-0.39.0+1.19.4-forge" = _xqiQm5zP;
        "pkg-0.39.0+1.20.1-fabric" = _wyv8QgPP;
        "pkg-0.39.0+1.20.1-forge" = _3adKs0o3;
        "pkg-0.39.0+1.20.4-fabric" = _2KkXaViw;
        "pkg-0.39.0+1.20.4-forge" = _fHfZoJJD;
        "pkg-0.39.0+1.20.4-neoforge" = _pZzFZPXo;
        "pkg-0.39.0+1.20.6-fabric" = _oaRkxjcP;
        "pkg-0.39.0+1.20.6-neoforge" = _w0wUTPWj;
        "pkg-0.39.0+1.21.1-fabric" = _IPZViyVc;
        "pkg-0.39.0+1.21.2-fabric" = _A9olEYtT;
        "pkg-0.39.0+1.21.2-neoforge" = _YFRLQXfO;
        "pkg-0.39.0+1.21.3-fabric" = _774t4W9h;
        "pkg-0.39.0+1.21.3-neoforge" = _40IHKJOz;
        "pkg-0.39.0+1.21.4-fabric" = _2E4Mz5yt;
        "pkg-0.39.0+1.21.4-neoforge" = _s2Jejbmi;
        "pkg-0.39.0+1.21.5-fabric" = _E9wsni9P;
        "pkg-0.39.0+1.21.5-neoforge" = _Sh3RatV0;
        "pkg-0.39.0+1.21.6-fabric" = _GqwfRe3t;
        "pkg-0.39.0+1.21.6-neoforge" = _mhPJh421;
        "pkg-0.39.0+1.21.7-fabric" = _MMmfS7WO;
        "pkg-0.39.0+1.21.7-neoforge" = _Mes1JJTE;
        "pkg-0.39.0+1.21.8-fabric" = _6NP9btQ3;
        "pkg-0.39.0+1.21.8-neoforge" = _wwrXlgZA;
        "pkg-0.39.0+1.8.9-fabric" = _coAOqO7o;
        "pkg-0.39.0+1.8.9-forge" = _bcJx28cb;
        "pkg-0.40.0+1.12.2-fabric" = _ZypMdFNQ;
        "pkg-0.40.0+1.12.2-forge" = _z8QAVh0O;
        "pkg-0.40.0+1.16.5-fabric" = _BjqhQA0W;
        "pkg-0.40.0+1.16.5-forge" = _6MgBE9KM;
        "pkg-0.40.0+1.17.1-fabric" = _zOmwgxiR;
        "pkg-0.40.0+1.17.1-forge" = _1GQDenxb;
        "pkg-0.40.0+1.18.2-fabric" = _5panMrda;
        "pkg-0.40.0+1.18.2-forge" = _IO4FaVlY;
        "pkg-0.40.0+1.19.2-fabric" = _rYfSb6jF;
        "pkg-0.40.0+1.19.2-forge" = _Q44LYHcx;
        "pkg-0.40.0+1.19.4-fabric" = _CMHVHgcG;
        "pkg-0.40.0+1.19.4-forge" = _CzzHSyBF;
        "pkg-0.40.0+1.20.1-fabric" = _Rg5yiq78;
        "pkg-0.40.0+1.20.1-forge" = _bqvAH0y4;
        "pkg-0.40.0+1.20.4-fabric" = _D34pNlnx;
        "pkg-0.40.0+1.20.4-forge" = _tEmtySy4;
        "pkg-0.40.0+1.20.4-neoforge" = _2elEnanN;
        "pkg-0.40.0+1.20.6-fabric" = _A6sZWznL;
        "pkg-0.40.0+1.20.6-neoforge" = _jB3tDF7J;
        "pkg-0.40.0+1.21.1-fabric" = _QDJO0nmk;
        "pkg-0.40.0+1.21.1-neoforge" = _inek812F;
        "pkg-0.40.0+1.21.2-fabric" = _B1JsKN5Z;
        "pkg-0.40.0+1.21.2-neoforge" = _6z774C0Q;
        "pkg-0.40.0+1.21.3-fabric" = _VyfgXQ90;
        "pkg-0.40.0+1.21.3-neoforge" = _62p7ndNi;
        "pkg-0.40.0+1.21.4-fabric" = _VLwm6iCf;
        "pkg-0.40.0+1.21.4-neoforge" = _Fh5MSczL;
        "pkg-0.40.0+1.21.5-fabric" = _i3LsGduy;
        "pkg-0.40.0+1.21.5-neoforge" = _FeiuX3jv;
        "pkg-0.40.0+1.21.6-fabric" = _lIKw8WKt;
        "pkg-0.40.0+1.21.6-neoforge" = _WwU374RA;
        "pkg-0.40.0+1.21.7-fabric" = _3A39n8eM;
        "pkg-0.40.0+1.21.7-neoforge" = _cvq1V8m0;
        "pkg-0.40.0+1.21.8-fabric" = _CdRnTqEh;
        "pkg-0.40.0+1.21.8-neoforge" = _C4CpJn4g;
        "pkg-0.40.0+1.8.9-fabric" = _gsiurOfC;
        "pkg-0.40.0+1.8.9-forge" = _Nc3Juv3a;
        "pkg-0.41.0+1.12.2-fabric" = _SfOmzJQk;
        "pkg-0.41.0+1.12.2-forge" = _krAowz5r;
        "pkg-0.41.0+1.16.5-fabric" = _8E7XFjtz;
        "pkg-0.41.0+1.16.5-forge" = _HFBmgvWe;
        "pkg-0.41.0+1.17.1-fabric" = _hPe5BQAB;
        "pkg-0.41.0+1.17.1-forge" = _rINLTLJS;
        "pkg-0.41.0+1.18.2-fabric" = _kIftcbPx;
        "pkg-0.41.0+1.18.2-forge" = _MuoFDJBt;
        "pkg-0.41.0+1.19.2-fabric" = _3azTElZc;
        "pkg-0.41.0+1.19.2-forge" = _2RPT7CkR;
        "pkg-0.41.0+1.19.4-fabric" = _v0jCgs63;
        "pkg-0.41.0+1.19.4-forge" = _krS4D4eQ;
        "pkg-0.41.0+1.20.1-fabric" = _aYhaVXZV;
        "pkg-0.41.0+1.20.1-forge" = _kZRSfGQZ;
        "pkg-0.41.0+1.20.4-fabric" = _LvGgu53S;
        "pkg-0.41.0+1.20.4-forge" = _Hz2ORHiq;
        "pkg-0.41.0+1.20.4-neoforge" = _bs1Mje7V;
        "pkg-0.41.0+1.20.6-fabric" = _ulFwTHDU;
        "pkg-0.41.0+1.20.6-neoforge" = _kFGH4NSl;
        "pkg-0.41.0+1.21.1-fabric" = _bpSxiLWa;
        "pkg-0.41.0+1.21.1-neoforge" = _qJJqtIPf;
        "pkg-0.41.0+1.21.2-fabric" = _TZi9Q6mH;
        "pkg-0.41.0+1.21.2-neoforge" = _hWQwnUq0;
        "pkg-0.41.0+1.21.3-fabric" = _FDyoHZBP;
        "pkg-0.41.0+1.21.3-neoforge" = _wBI2Fe4G;
        "pkg-0.41.0+1.21.4-fabric" = _2sjl4mK0;
        "pkg-0.41.0+1.21.4-neoforge" = _5iCTIhoa;
        "pkg-0.41.0+1.21.5-fabric" = _pTFLlCzj;
        "pkg-0.41.0+1.21.5-neoforge" = _ZzWPCqXU;
        "pkg-0.41.0+1.21.6-fabric" = _ZzveKe64;
        "pkg-0.41.0+1.21.6-neoforge" = _LYQhCqb5;
        "pkg-0.41.0+1.21.7-fabric" = _rkpngMkF;
        "pkg-0.41.0+1.21.7-neoforge" = _mzJ7p4dc;
        "pkg-0.41.0+1.21.8-fabric" = _lvlfOhgN;
        "pkg-0.41.0+1.21.8-neoforge" = _b8ybxHlv;
        "pkg-0.41.0+1.8.9-fabric" = _zIC7L5Dn;
        "pkg-0.41.0+1.8.9-forge" = _ocrJMRkY;
        "pkg-0.41.1+1.12.2-fabric" = _Yfc2poaf;
        "pkg-0.41.1+1.12.2-forge" = _PY7Ih72j;
        "pkg-0.41.1+1.16.5-fabric" = _UqN7xZtO;
        "pkg-0.41.1+1.16.5-forge" = _cuVsLzmI;
        "pkg-0.41.1+1.17.1-fabric" = _DEbaqtdP;
        "pkg-0.41.1+1.17.1-forge" = _9bpbX2xF;
        "pkg-0.41.1+1.18.2-fabric" = _xTeHiUDS;
        "pkg-0.41.1+1.18.2-forge" = _pp2GoN3v;
        "pkg-0.41.1+1.19.2-fabric" = _YoFJKkqR;
        "pkg-0.41.1+1.19.2-forge" = _NifNGnnh;
        "pkg-0.41.1+1.19.4-fabric" = _kL5fCdTI;
        "pkg-0.41.1+1.19.4-forge" = _GCn3MkSP;
        "pkg-0.41.1+1.20.1-fabric" = _LdhJ35TF;
        "pkg-0.41.1+1.20.1-forge" = _1E7iNARM;
        "pkg-0.41.1+1.20.4-fabric" = _u6ltaeok;
        "pkg-0.41.1+1.20.4-forge" = _fv6x8nKm;
        "pkg-0.41.1+1.20.4-neoforge" = _ggFUEV2t;
        "pkg-0.41.1+1.20.6-fabric" = _QlYkyIDA;
        "pkg-0.41.1+1.20.6-neoforge" = _coygSdu5;
        "pkg-0.41.1+1.21.1-fabric" = _XwoIAYaM;
        "pkg-0.41.1+1.21.1-neoforge" = _BrFkL9Wh;
        "pkg-0.41.1+1.21.2-fabric" = _R6PH9Zpw;
        "pkg-0.41.1+1.21.2-neoforge" = _396wFjdv;
        "pkg-0.41.1+1.21.3-fabric" = _AJYhWvW6;
        "pkg-0.41.1+1.21.3-neoforge" = _cCsD8Scn;
        "pkg-0.41.1+1.21.4-fabric" = _q9t6oWBN;
        "pkg-0.41.1+1.21.4-neoforge" = _oh6NyHqs;
        "pkg-0.41.1+1.21.5-fabric" = _uvN3Yzpf;
        "pkg-0.41.1+1.21.5-neoforge" = _BKBvOtX8;
        "pkg-0.41.1+1.21.6-fabric" = _gZnbvXOq;
        "pkg-0.41.1+1.21.6-neoforge" = _lPQCPJEw;
        "pkg-0.41.1+1.21.7-fabric" = _2HkjOMaF;
        "pkg-0.41.1+1.21.7-neoforge" = _esvblwrm;
        "pkg-0.41.1+1.21.8-fabric" = _noITHgPJ;
        "pkg-0.41.1+1.21.8-neoforge" = _M0LEPFUx;
        "pkg-0.41.1+1.8.9-fabric" = _fXdonZU7;
        "pkg-0.41.1+1.8.9-forge" = _LBZn1XH6;
        "pkg-0.42.0+1.12.2-fabric" = _uvY2uAML;
        "pkg-0.42.0+1.12.2-forge" = _WzmDiJCm;
        "pkg-0.42.0+1.16.5-fabric" = _QMeSWQIW;
        "pkg-0.42.0+1.16.5-forge" = _b7g9mkHA;
        "pkg-0.42.0+1.17.1-fabric" = _Q7MLRxnd;
        "pkg-0.42.0+1.17.1-forge" = _eb0hbGQt;
        "pkg-0.42.0+1.18.2-fabric" = _Muox8OuV;
        "pkg-0.42.0+1.18.2-forge" = _Evx8jPod;
        "pkg-0.42.0+1.19.2-fabric" = _niG2525E;
        "pkg-0.42.0+1.19.2-forge" = _T5l5IRyq;
        "pkg-0.42.0+1.19.4-fabric" = _yA3y1fqE;
        "pkg-0.42.0+1.19.4-forge" = _8pZkRbaG;
        "pkg-0.42.0+1.20.1-fabric" = _tihHluhs;
        "pkg-0.42.0+1.20.1-forge" = _vaQLaWRQ;
        "pkg-0.42.0+1.20.4-fabric" = _gx19htJJ;
        "pkg-0.42.0+1.20.4-forge" = _jeEuilIO;
        "pkg-0.42.0+1.20.4-neoforge" = _bfLHSBvW;
        "pkg-0.42.0+1.20.6-fabric" = _CoYjCVq7;
        "pkg-0.42.0+1.20.6-neoforge" = _R9ZHy0a7;
        "pkg-0.42.0+1.21.1-fabric" = _c0Za4AVv;
        "pkg-0.42.0+1.21.1-neoforge" = _ZuLRf3hT;
        "pkg-0.42.0+1.21.2-fabric" = _QYuq8oQb;
        "pkg-0.42.0+1.21.2-neoforge" = _TTY66cFh;
        "pkg-0.42.0+1.21.3-fabric" = _9dpTcugy;
        "pkg-0.42.0+1.21.3-neoforge" = _gQrnDtE8;
        "pkg-0.42.0+1.21.4-fabric" = _rZTXwpwp;
        "pkg-0.42.0+1.21.4-neoforge" = _QOSwGZ4m;
        "pkg-0.42.0+1.21.5-fabric" = _j847Dn1d;
        "pkg-0.42.0+1.21.5-neoforge" = _cfaWnhLj;
        "pkg-0.42.0+1.21.6-fabric" = _xIimSzFM;
        "pkg-0.42.0+1.21.6-neoforge" = _mEFd6wpL;
        "pkg-0.42.0+1.21.7-fabric" = _ZLxjPmap;
        "pkg-0.42.0+1.21.7-neoforge" = _2eJEkGnS;
        "pkg-0.42.0+1.21.8-fabric" = _h99w5hLr;
        "pkg-0.42.0+1.21.8-neoforge" = _ApbYvXe9;
        "pkg-0.42.0+1.8.9-fabric" = _jZTJ5XB6;
        "pkg-0.42.0+1.8.9-forge" = _UY01eYmX;
        "pkg-0.43.0+1.12.2-fabric" = _2tVr2ulv;
        "pkg-0.43.0+1.12.2-forge" = _S4kglxKJ;
        "pkg-0.43.0+1.16.5-fabric" = _oiCTFL8R;
        "pkg-0.43.0+1.16.5-forge" = _Bxwaf77u;
        "pkg-0.43.0+1.17.1-fabric" = _tokb0xFv;
        "pkg-0.43.0+1.17.1-forge" = _p3mi5DU1;
        "pkg-0.43.0+1.18.2-fabric" = _sGJOIJLb;
        "pkg-0.43.0+1.18.2-forge" = _VIaHSap9;
        "pkg-0.43.0+1.19.2-fabric" = _8ngbeCWu;
        "pkg-0.43.0+1.19.2-forge" = _prEIu3uC;
        "pkg-0.43.0+1.19.4-fabric" = _XpXF6xHL;
        "pkg-0.43.0+1.19.4-forge" = _dlxKzYUU;
        "pkg-0.43.0+1.20.1-fabric" = _pFz7UGWl;
        "pkg-0.43.0+1.20.1-forge" = _upjqDKFt;
        "pkg-0.43.0+1.20.4-fabric" = _V7lXooH2;
        "pkg-0.43.0+1.20.4-forge" = _3dfAhYLw;
        "pkg-0.43.0+1.20.4-neoforge" = _tbNNEAPZ;
        "pkg-0.43.0+1.20.6-fabric" = _B2kPcANQ;
        "pkg-0.43.0+1.20.6-neoforge" = _wthnIZ6r;
        "pkg-0.43.0+1.21.1-fabric" = _4azHwSqh;
        "pkg-0.43.0+1.21.1-neoforge" = _xSrwgxm0;
        "pkg-0.43.0+1.21.2-fabric" = _TN6kP05s;
        "pkg-0.43.0+1.21.2-neoforge" = _WlV55BZD;
        "pkg-0.43.0+1.21.3-fabric" = _hrAKGMtY;
        "pkg-0.43.0+1.21.3-neoforge" = _OsdvXJ8O;
        "pkg-0.43.0+1.21.4-fabric" = _DRrKFCD9;
        "pkg-0.43.0+1.21.4-neoforge" = _rs3IUq3X;
        "pkg-0.43.0+1.21.5-fabric" = _9yWYx7Eu;
        "pkg-0.43.0+1.21.5-neoforge" = _lzSbuLYk;
        "pkg-0.43.0+1.21.6-neoforge" = _4ulnNOUf;
        "pkg-0.43.0+1.21.7-fabric" = _LtEfD0bJ;
        "pkg-0.43.0+1.21.7-neoforge" = _ZSVqSPPs;
        "pkg-0.43.0+1.21.8-fabric" = _K5KeuZIH;
        "pkg-0.43.0+1.21.8-neoforge" = _Jqo6PZl2;
        "pkg-0.43.0+1.8.9-fabric" = _NMIZyguu;
        "pkg-0.43.0+1.8.9-forge" = _OiH4MndR;
        "pkg-0.44.0+1.12.2-fabric" = _DszedT4h;
        "pkg-0.44.0+1.12.2-forge" = _l7wCSfVj;
        "pkg-0.44.0+1.16.5-fabric" = _2lS101HM;
        "pkg-0.44.0+1.16.5-forge" = _hijBDVUA;
        "pkg-0.44.0+1.17.1-fabric" = _PVDZb174;
        "pkg-0.44.0+1.17.1-forge" = _zOsfjNS1;
        "pkg-0.44.0+1.18.2-fabric" = _DeMgiygJ;
        "pkg-0.44.0+1.18.2-forge" = _F0ZGrqE6;
        "pkg-0.44.0+1.19.2-fabric" = _NP0B6A1z;
        "pkg-0.44.0+1.19.2-forge" = _4OFypbY3;
        "pkg-0.44.0+1.19.4-fabric" = _VmMEKXro;
        "pkg-0.44.0+1.19.4-forge" = _3JkDRgUN;
        "pkg-0.44.0+1.20.1-fabric" = _leEIXq3e;
        "pkg-0.44.0+1.20.1-forge" = _ne0Wd7MA;
        "pkg-0.44.0+1.20.4-fabric" = _jlTMw8xf;
        "pkg-0.44.0+1.20.4-forge" = _I595e8MF;
        "pkg-0.44.0+1.20.4-neoforge" = _50q6NQge;
        "pkg-0.44.0+1.20.6-fabric" = _lyFOwbDG;
        "pkg-0.44.0+1.20.6-neoforge" = _PEkl7gJP;
        "pkg-0.44.0+1.21.1-fabric" = _lxHnPnOQ;
        "pkg-0.44.0+1.21.1-neoforge" = _e9XXe1Av;
        "pkg-0.44.0+1.21.2-fabric" = _NkEyVs8r;
        "pkg-0.44.0+1.21.2-neoforge" = _C93fIXpo;
        "pkg-0.44.0+1.21.3-fabric" = _KHJKYOGs;
        "pkg-0.44.0+1.21.3-neoforge" = _SNBK3rpA;
        "pkg-0.44.0+1.21.4-fabric" = _99cmKu9b;
        "pkg-0.44.0+1.21.4-neoforge" = _6anY9nuL;
        "pkg-0.44.0+1.21.5-fabric" = _KgseprfK;
        "pkg-0.44.0+1.21.5-neoforge" = _N7OCAgBg;
        "pkg-0.44.0+1.21.6-fabric" = _cAOfTbgw;
        "pkg-0.44.0+1.21.6-neoforge" = _CEAXC1MW;
        "pkg-0.44.0+1.21.7-fabric" = _wUn9EpKr;
        "pkg-0.44.0+1.21.7-neoforge" = _tw65PHQL;
        "pkg-0.44.0+1.21.8-fabric" = _brErq7dn;
        "pkg-0.44.0+1.21.8-neoforge" = _7lc4LuLO;
        "pkg-0.44.0+1.8.9-fabric" = _Wa6xo8kA;
        "pkg-0.44.0+1.8.9-forge" = _KZsJ1xtd;
        "pkg-0.45.0+1.12.2-fabric" = _IK8X19tO;
        "pkg-0.45.0+1.12.2-forge" = _IJap1ATr;
        "pkg-0.45.0+1.16.5-fabric" = _8QKFPkw0;
        "pkg-0.45.0+1.16.5-forge" = _qR1loH9x;
        "pkg-0.45.0+1.17.1-fabric" = _CZX6VYRA;
        "pkg-0.45.0+1.17.1-forge" = _L4gkk63i;
        "pkg-0.45.0+1.18.2-fabric" = _a4mCjhl7;
        "pkg-0.45.0+1.18.2-forge" = _BeipK1op;
        "pkg-0.45.0+1.19.2-fabric" = _m8jKTI5i;
        "pkg-0.45.0+1.19.2-forge" = _ril4LW5c;
        "pkg-0.45.0+1.19.4-fabric" = _4h924IwM;
        "pkg-0.45.0+1.19.4-forge" = _Xg6QcJlw;
        "pkg-0.45.0+1.20.1-fabric" = _k6SaUEMc;
        "pkg-0.45.0+1.20.1-forge" = _tsiHjMhd;
        "pkg-0.45.0+1.20.4-fabric" = _AhCYZVXF;
        "pkg-0.45.0+1.20.4-forge" = _5rBJ1dl0;
        "pkg-0.45.0+1.20.4-neoforge" = _ziv81KDh;
        "pkg-0.45.0+1.20.6-fabric" = _wnmFLnrS;
        "pkg-0.45.0+1.20.6-neoforge" = _J9vcV7iy;
        "pkg-0.45.0+1.21.1-fabric" = _gxoiX2mT;
        "pkg-0.45.0+1.21.1-neoforge" = _2ZbexJRC;
        "pkg-0.45.0+1.21.2-fabric" = _vPGFKfqZ;
        "pkg-0.45.0+1.21.2-neoforge" = _bmgjTUsR;
        "pkg-0.45.0+1.21.3-fabric" = _WtH1KxRZ;
        "pkg-0.45.0+1.21.3-neoforge" = _xL0NyUC5;
        "pkg-0.45.0+1.21.4-fabric" = _dXZz6yfl;
        "pkg-0.45.0+1.21.4-neoforge" = _6Pf1kOcu;
        "pkg-0.45.0+1.21.5-fabric" = _uk01OBG0;
        "pkg-0.45.0+1.21.5-neoforge" = _iMtM9Osh;
        "pkg-0.45.0+1.21.6-fabric" = _ZEymgoFX;
        "pkg-0.45.0+1.21.6-neoforge" = _CDCvG9IE;
        "pkg-0.45.0+1.21.7-fabric" = _cRyBY88P;
        "pkg-0.45.0+1.21.7-neoforge" = _xcF6JMyi;
        "pkg-0.45.0+1.21.8-fabric" = _TgVS8Nzs;
        "pkg-0.45.0+1.21.8-neoforge" = _3zxhAYR1;
        "pkg-0.45.0+1.8.9-fabric" = _GwNlgqDR;
        "pkg-0.45.0+1.8.9-forge" = _rrsgiyCG;
        "pkg-0.46.0+1.12.2-fabric" = _E5CCUuLU;
        "pkg-0.46.0+1.12.2-forge" = _GcMN5XEu;
        "pkg-0.46.0+1.16.5-fabric" = _5h16sYwy;
        "pkg-0.46.0+1.16.5-forge" = _f0UkKDkZ;
        "pkg-0.46.0+1.17.1-fabric" = _xLyuWPkA;
        "pkg-0.46.0+1.17.1-forge" = _Tm0VY5fl;
        "pkg-0.46.0+1.18.2-fabric" = _uPq33arF;
        "pkg-0.46.0+1.18.2-forge" = _5vOH2MDC;
        "pkg-0.46.0+1.19.2-fabric" = _tTzhZ9be;
        "pkg-0.46.0+1.19.2-forge" = _Upgn47Ns;
        "pkg-0.46.0+1.19.4-fabric" = _D9fqNc0m;
        "pkg-0.46.0+1.19.4-forge" = _tp85Vbwf;
        "pkg-0.46.0+1.20.1-fabric" = _wFznx9j6;
        "pkg-0.46.0+1.20.1-forge" = _i0EMeE3l;
        "pkg-0.46.0+1.20.4-fabric" = _jqIDkNhb;
        "pkg-0.46.0+1.20.4-forge" = _NPHgFYQP;
        "pkg-0.46.0+1.20.4-neoforge" = _RxYMCsXU;
        "pkg-0.46.0+1.20.6-fabric" = _n8C44HUy;
        "pkg-0.46.0+1.20.6-neoforge" = _N5nPsNm3;
        "pkg-0.46.0+1.21.1-fabric" = _znP1g7p7;
        "pkg-0.46.0+1.21.1-neoforge" = _QbdP7LID;
        "pkg-0.46.0+1.21.2-fabric" = _6q8HDMhL;
        "pkg-0.46.0+1.21.2-neoforge" = _aGlQ80Mw;
        "pkg-0.46.0+1.21.3-fabric" = _9kPHIi2b;
        "pkg-0.46.0+1.21.3-neoforge" = _QTBipzLE;
        "pkg-0.46.0+1.21.4-fabric" = _Am1FYcBk;
        "pkg-0.46.0+1.21.4-neoforge" = _7EzkE5xx;
        "pkg-0.46.0+1.21.5-fabric" = _lU6ucaCR;
        "pkg-0.46.0+1.21.5-neoforge" = _CDegJqqd;
        "pkg-0.46.0+1.21.6-fabric" = _KEuZc15w;
        "pkg-0.46.0+1.21.6-neoforge" = _z3lzqFBK;
        "pkg-0.46.0+1.21.7-fabric" = _R5uLO6tg;
        "pkg-0.46.0+1.21.7-neoforge" = _c9JjIE6P;
        "pkg-0.46.0+1.21.8-fabric" = _5VMOE9qP;
        "pkg-0.46.0+1.21.8-neoforge" = _7YBVCt1H;
        "pkg-0.46.0+1.8.9-fabric" = _ie8Lyosq;
        "pkg-0.46.0+1.8.9-forge" = _FXboJxQz;
        "pkg-0.47.0+1.12.2-fabric" = _i4l7YVKk;
        "pkg-0.47.0+1.12.2-forge" = _cTSOhADL;
        "pkg-0.47.0+1.16.5-fabric" = _e6pULHWz;
        "pkg-0.47.0+1.16.5-forge" = _ilFbpgiP;
        "pkg-0.47.0+1.17.1-fabric" = _7qz8RC5F;
        "pkg-0.47.0+1.17.1-forge" = _2nyOo9vQ;
        "pkg-0.47.0+1.18.2-fabric" = _P6427i8c;
        "pkg-0.47.0+1.18.2-forge" = _XrPW7TO4;
        "pkg-0.47.0+1.19.2-fabric" = _6Z4W4ce2;
        "pkg-0.47.0+1.19.2-forge" = _vjCH6tbo;
        "pkg-0.47.0+1.19.4-fabric" = _eW0EUClO;
        "pkg-0.47.0+1.19.4-forge" = _B1zpoTrR;
        "pkg-0.47.0+1.20.1-fabric" = _rv7Nx60b;
        "pkg-0.47.0+1.20.1-forge" = _2DzOIC4P;
        "pkg-0.47.0+1.20.4-fabric" = _wvsIc59k;
        "pkg-0.47.0+1.20.4-forge" = _dsiMkVjE;
        "pkg-0.47.0+1.20.4-neoforge" = _ZCuw09HF;
        "pkg-0.47.0+1.20.6-fabric" = _vZWLDINR;
        "pkg-0.47.0+1.20.6-neoforge" = _LfQ8xPlh;
        "pkg-0.47.0+1.21.1-fabric" = _9mMKvm5s;
        "pkg-0.47.0+1.21.1-neoforge" = _Vid9O0WT;
        "pkg-0.47.0+1.21.2-fabric" = _nHCuOp7l;
        "pkg-0.47.0+1.21.2-neoforge" = _w3bv46cc;
        "pkg-0.47.0+1.21.3-fabric" = _rzTXoa95;
        "pkg-0.47.0+1.21.3-neoforge" = _LqWCaLBU;
        "pkg-0.47.0+1.21.4-fabric" = _z4e6gf2a;
        "pkg-0.47.0+1.21.4-neoforge" = _TDbuzoXX;
        "pkg-0.47.0+1.21.5-fabric" = _ihPI9WRO;
        "pkg-0.47.0+1.21.5-neoforge" = _KsdwD6o3;
        "pkg-0.47.0+1.21.6-fabric" = _lpfzXZwC;
        "pkg-0.47.0+1.21.6-neoforge" = _UdmPfHwJ;
        "pkg-0.47.0+1.21.7-fabric" = _cF84rENj;
        "pkg-0.47.0+1.21.7-neoforge" = _xSJfolXg;
        "pkg-0.47.0+1.21.8-fabric" = _mDuRoqjz;
        "pkg-0.47.0+1.21.8-neoforge" = _A2ZRKlvh;
        "pkg-0.47.0+1.8.9-fabric" = _OnWKWAgn;
        "pkg-0.47.0+1.8.9-forge" = _nr8gucSi;
        "pkg-0.48.0+1.12.2-fabric" = _5YSK4W6E;
        "pkg-0.48.0+1.12.2-forge" = _anJAg89b;
        "pkg-0.48.0+1.16.5-fabric" = _5uoKOsfv;
        "pkg-0.48.0+1.16.5-forge" = _R87jVUCR;
        "pkg-0.48.0+1.17.1-fabric" = _V0h9UYoJ;
        "pkg-0.48.0+1.17.1-forge" = _SqordAPw;
        "pkg-0.48.0+1.18.2-fabric" = _CWVW3eda;
        "pkg-0.48.0+1.18.2-forge" = _vm9tVDMv;
        "pkg-0.48.0+1.19.2-fabric" = _dwQINtwb;
        "pkg-0.48.0+1.19.2-forge" = _wbKk1Zie;
        "pkg-0.48.0+1.19.4-fabric" = _b3UDtwBv;
        "pkg-0.48.0+1.19.4-forge" = _avSUC8UY;
        "pkg-0.48.0+1.20.1-fabric" = _66nmDTc0;
        "pkg-0.48.0+1.20.1-forge" = _hLOqwqVb;
        "pkg-0.48.0+1.20.4-fabric" = _zemYjQn9;
        "pkg-0.48.0+1.20.4-forge" = _yBI6HHBN;
        "pkg-0.48.0+1.20.4-neoforge" = _aOBhP4Ae;
        "pkg-0.48.0+1.20.6-fabric" = _hvZrKJUZ;
        "pkg-0.48.0+1.20.6-neoforge" = _oxwgNlyD;
        "pkg-0.48.0+1.21.1-fabric" = _673q1joU;
        "pkg-0.48.0+1.21.1-neoforge" = _qyqGmXuc;
        "pkg-0.48.0+1.21.2-fabric" = _Q7I1Ym8N;
        "pkg-0.48.0+1.21.2-neoforge" = _HlykrKIh;
        "pkg-0.48.0+1.21.3-fabric" = _hlTNKoRo;
        "pkg-0.48.0+1.21.3-neoforge" = _eLPZzpRF;
        "pkg-0.48.0+1.21.4-fabric" = _l9vcJ9M5;
        "pkg-0.48.0+1.21.4-neoforge" = _WeSJeFzn;
        "pkg-0.48.0+1.21.5-fabric" = _SncFW3bb;
        "pkg-0.48.0+1.21.5-neoforge" = _ClVnixDY;
        "pkg-0.48.0+1.21.6-fabric" = _jjrCi4l1;
        "pkg-0.48.0+1.21.6-neoforge" = _HzjrA4sV;
        "pkg-0.48.0+1.21.7-fabric" = _y7ABYxYx;
        "pkg-0.48.0+1.21.7-neoforge" = _4MUiM4cz;
        "pkg-0.48.0+1.21.8-fabric" = _JEvDMP0i;
        "pkg-0.48.0+1.21.8-neoforge" = _J1mbzYaB;
        "pkg-0.48.0+1.8.9-fabric" = _5VEoNf5d;
        "pkg-0.48.0+1.8.9-forge" = _3NQsf3Sz;
        "pkg-0.49.0+1.12.2-fabric" = _6ocVxEFv;
        "pkg-0.49.0+1.12.2-forge" = _RecRnQcT;
        "pkg-0.49.0+1.16.5-fabric" = _oNArh6Aw;
        "pkg-0.49.0+1.16.5-forge" = _hdPYbMwK;
        "pkg-0.49.0+1.17.1-fabric" = _sHbkyaOk;
        "pkg-0.49.0+1.17.1-forge" = _Uf2F16KZ;
        "pkg-0.49.0+1.18.2-fabric" = _CBo0GR4o;
        "pkg-0.49.0+1.18.2-forge" = _MvGNpeHt;
        "pkg-0.49.0+1.19.2-fabric" = _6G31KeqZ;
        "pkg-0.49.0+1.19.2-forge" = _nN9L4joa;
        "pkg-0.49.0+1.19.4-fabric" = _MALYzwmx;
        "pkg-0.49.0+1.19.4-forge" = _NGx2psOi;
        "pkg-0.49.0+1.20.1-fabric" = _ropv09rb;
        "pkg-0.49.0+1.20.1-forge" = _mrYSitMY;
        "pkg-0.49.0+1.20.4-fabric" = _6RmQK3rk;
        "pkg-0.49.0+1.20.4-forge" = _7Go7BYjP;
        "pkg-0.49.0+1.20.4-neoforge" = _UIdVZE4K;
        "pkg-0.49.0+1.20.6-fabric" = _p8CzNdWD;
        "pkg-0.49.0+1.20.6-neoforge" = _GxkH0RxZ;
        "pkg-0.49.0+1.21.1-fabric" = _77wWIrce;
        "pkg-0.49.0+1.21.1-neoforge" = _LgIkQRmr;
        "pkg-0.49.0+1.21.2-fabric" = _u07joDi6;
        "pkg-0.49.0+1.21.2-neoforge" = _mefaPkg6;
        "pkg-0.49.0+1.21.3-fabric" = _wViYuhgt;
        "pkg-0.49.0+1.21.3-neoforge" = _LZ2edkwu;
        "pkg-0.49.0+1.21.4-fabric" = _wp0qxIyX;
        "pkg-0.49.0+1.21.4-neoforge" = _KbGxSMsJ;
        "pkg-0.49.0+1.21.5-fabric" = _JpzKeZiy;
        "pkg-0.49.0+1.21.5-neoforge" = _yWIUJmRl;
        "pkg-0.49.0+1.21.6-fabric" = _LC2STmjs;
        "pkg-0.49.0+1.21.6-neoforge" = _7J3WfCAn;
        "pkg-0.49.0+1.21.7-fabric" = _y8Nsdxz3;
        "pkg-0.49.0+1.21.7-neoforge" = _sZbnljGu;
        "pkg-0.49.0+1.21.8-fabric" = _WpWaJCE6;
        "pkg-0.49.0+1.21.8-neoforge" = _qOAA4In3;
        "pkg-0.49.0+1.8.9-fabric" = _IK2MfQKa;
        "pkg-0.49.0+1.8.9-forge" = _tXUFzbXh;
        "pkg-0.50.0+1.12.2-fabric" = _k9QmqvOX;
        "pkg-0.50.1+1.12.2-fabric" = _zgfC1WBp;
        "pkg-0.50.1+1.12.2-forge" = _PDyqIlG3;
        "pkg-0.50.1+1.16.5-fabric" = _s90qbWLB;
        "pkg-0.50.1+1.16.5-forge" = _Ko8uY271;
        "pkg-0.50.1+1.17.1-fabric" = _mSSksOYg;
        "pkg-0.50.1+1.17.1-forge" = _wr6d1fm1;
        "pkg-0.50.1+1.18.2-fabric" = _xGzTADcB;
        "pkg-0.50.1+1.18.2-forge" = _P0UR1Q4n;
        "pkg-0.50.1+1.19.2-fabric" = _T4k47OTH;
        "pkg-0.50.1+1.19.2-forge" = _PwtDSKLd;
        "pkg-0.50.1+1.19.4-fabric" = _NwDBoTcc;
        "pkg-0.50.1+1.19.4-forge" = _OTpSHXGG;
        "pkg-0.50.1+1.20.1-fabric" = _P8RJnaRn;
        "pkg-0.50.1+1.20.1-forge" = _olMZ4yvM;
        "pkg-0.50.1+1.20.4-fabric" = _X0M4GIOu;
        "pkg-0.50.1+1.20.4-forge" = _O21Ts12z;
        "pkg-0.50.1+1.20.4-neoforge" = _z2nlkjPD;
        "pkg-0.50.1+1.20.6-fabric" = _7pIL94hW;
        "pkg-0.50.1+1.20.6-neoforge" = _MEeRPEBv;
        "pkg-0.50.1+1.21.1-fabric" = _JS01z17m;
        "pkg-0.50.1+1.21.1-neoforge" = _KpRfN2dM;
        "pkg-0.50.1+1.21.2-fabric" = _DDWQraWT;
        "pkg-0.50.1+1.21.2-neoforge" = _elra3P9E;
        "pkg-0.50.1+1.21.3-fabric" = _ehnscIr3;
        "pkg-0.50.1+1.21.3-neoforge" = _tBvB4kOU;
        "pkg-0.50.1+1.21.4-fabric" = _IZb7AjPf;
        "pkg-0.50.1+1.21.4-neoforge" = _RpNWu87n;
        "pkg-0.50.1+1.21.5-fabric" = _EoFOm0c3;
        "pkg-0.50.1+1.21.5-neoforge" = _jdbqsZPX;
        "pkg-0.50.1+1.21.6-fabric" = _2y7OC8I1;
        "pkg-0.50.1+1.21.6-neoforge" = _ZehX3skC;
        "pkg-0.50.1+1.21.7-fabric" = _xBmS7MCP;
        "pkg-0.50.1+1.21.7-neoforge" = _rMVfCehu;
        "pkg-0.50.1+1.21.8-fabric" = _1mcKHvDx;
        "pkg-0.50.1+1.21.8-neoforge" = _8fxZb49Z;
        "pkg-0.50.1+1.8.9-fabric" = _KEjl6BDD;
        "pkg-0.50.1+1.8.9-forge" = _vxe3s7En;
        "pkg-0.51.0+1.12.2-fabric" = _h9Alc5mc;
        "pkg-0.51.0+1.12.2-forge" = _OycE9djD;
        "pkg-0.51.0+1.16.5-fabric" = _3c8TXUas;
        "pkg-0.51.0+1.16.5-forge" = _209AmCMX;
        "pkg-0.51.0+1.17.1-fabric" = _fdJBjfcx;
        "pkg-0.51.0+1.17.1-forge" = _AG2Eawgf;
        "pkg-0.51.0+1.18.2-fabric" = _rVqgttVP;
        "pkg-0.51.0+1.18.2-forge" = _OCuT2g1m;
        "pkg-0.51.0+1.19.2-fabric" = _oMczWL93;
        "pkg-0.51.0+1.19.2-forge" = _kayIBNQo;
        "pkg-0.51.0+1.19.4-fabric" = _cIbblF5E;
        "pkg-0.51.0+1.19.4-forge" = _N2NT423y;
        "pkg-0.51.0+1.20.1-fabric" = _WnzVGj3Y;
        "pkg-0.51.0+1.20.1-forge" = _IlfBU00E;
        "pkg-0.51.0+1.20.4-fabric" = _vsZmxggk;
        "pkg-0.51.0+1.20.4-forge" = _ZTuuAND0;
        "pkg-0.51.0+1.20.4-neoforge" = _rOe7mAiB;
        "pkg-0.51.0+1.20.6-fabric" = _BbfFDm5k;
        "pkg-0.51.0+1.20.6-neoforge" = _kQ6irOmi;
        "pkg-0.51.0+1.21.1-fabric" = _zRhNGRLs;
        "pkg-0.51.0+1.21.1-neoforge" = _eoWhBsl7;
        "pkg-0.51.0+1.21.2-fabric" = _uszyYmAp;
        "pkg-0.51.0+1.21.2-neoforge" = _6fn6D8TQ;
        "pkg-0.51.0+1.21.3-fabric" = _MwSaLveI;
        "pkg-0.51.0+1.21.3-neoforge" = _YTgNqWyY;
        "pkg-0.51.0+1.21.4-fabric" = _UxAoFTie;
        "pkg-0.51.0+1.21.4-neoforge" = _DohMStrV;
        "pkg-0.51.0+1.21.5-fabric" = _f737bdUw;
        "pkg-0.51.0+1.21.5-neoforge" = _e8qLRYJK;
        "pkg-0.51.0+1.21.6-fabric" = _qRFE6bx1;
        "pkg-0.51.0+1.21.6-neoforge" = _Yzlp2AXz;
        "pkg-0.51.0+1.21.7-fabric" = _ssupgsNE;
        "pkg-0.51.0+1.21.7-neoforge" = _aPfw3VnI;
        "pkg-0.51.0+1.21.8-fabric" = _inlL4nl7;
        "pkg-0.51.0+1.21.8-neoforge" = _OudvUjN0;
        "pkg-0.51.0+1.8.9-fabric" = _AhVtN9fZ;
        "pkg-0.51.0+1.8.9-forge" = _QUuVknzG;
        "default" = _QUuVknzG;
    });
