...
let
    ...
    in {
        ...
        "pkg-fabric-mc118-6.0.236" = _Bwd6Bx51;
        "pkg-fabric-mc118-6.0.242" = _RJpGLYjq;
        "pkg-fabric-mc119-6.0.264" = _twIELZtk;
        "pkg-fabric-mc119-6.0.268" = _8bes7q9N;
        "pkg-fabric-mc119-6.0.277" = _LqPD8K4e;
        "pkg-fabric-mc119-6.0.278" = _k50ijze0;
        "pkg-fabric-mc118-6.0.263" = _RlQuWwkr;
        "pkg-fabric-mc119-6.1.297" = _hp9ebd7l;
        "pkg-fabric-mc119-6.1.300" = _XciA4pc0;
        "pkg-fabric-mc119-6.1.301" = _bZ98a6s9;
        "pkg-fabric-mc119-6.1.302" = _5wiNjYAM;
        "pkg-fabric-mc119-6.1.305" = _iL7OmbbS;
        "pkg-fabric-mc119-7.0.319" = _qzyAd8Vb;
        "pkg-fabric-mc119-8.0.327" = _eHCrS26f;
        "pkg-fabric-18.2.311" = _4ChPVgw7;
        "pkg-fabric-19.3.324" = _Z5ImkbfT;
        "pkg-fabric-19.4.331" = _3BLjcSTn;
        "pkg-fabric-20.0.332" = _kfLo64Th;
        "pkg-fabric-19.2.307" = _lxkVaokX;
        "pkg-fabric-20.0.338" = _4gUP3JU7;
        "pkg-fabric-20.0.341" = _Vhn632B5;
        "pkg-fabric-19.3.328" = _G4NwSNBf;
        "pkg-fabric-20.2.353" = _5dAncttG;
        "default" = _5dAncttG;
    });
