...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _NKuN3pnx;
        "pkg-1.1.0" = _VGW7Er2j;
        "pkg-1.1.0.12" = _gJ2lIugV;
        "pkg-1.1.0.13" = _vO5ymCxW;
        "pkg-1.2.0" = _Gn5dndyM;
        "pkg-1.2.1" = _hc0LQIYV;
        "pkg-1.3.0" = _w5Ak0ZNa;
        "pkg-2.0.0.0" = _rG092fqo;
        "pkg-2.1.0.0" = _JSr4UigR;
        "pkg-2.2.0" = _nRfCskuE;
        "pkg-2.2.1" = _lEAgLEtt;
        "pkg-3.0.0" = _YkytKWCV;
        "pkg-3.0.1" = _oOx81Bii;
        ...
        "pkg-3.0.6" = _mi5RVPkd;
        "pkg-3.1.0" = _MXP58t70;
        "pkg-1.20.1-3.2.1d" = _GWd8Gpye;
        "pkg-1.21-3.3.0" = _SfvBIcek;
        "pkg-1.21-3.3.1" = _nbVWtC3b;
        "pkg-1.21-3.3.2" = _70mSZOXl;
        "pkg-1.21-3.3.3" = _9k9ve2su;
        "pkg-1.20.1-3.2.2" = _vfMrLiQk;
        "pkg-1.20.1-3.2.3" = _3yVHZGuH;
        "pkg-1.21-3.3.4" = _EJKksclk;
        "pkg-4.0.0" = _ulWItSbO;
        "default" = _ulWItSbO;
    });
