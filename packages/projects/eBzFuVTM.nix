...
let
    ...
    in {
        ...
        "pkg-1.18.2-2.0.0-beta1" = _HG7dJiVF;
        "pkg-1.20.1-2.0.0-beta1" = _g4Fn2mpW;
        "pkg-1.18.2-2.0.0-beta2" = _EeOsm3XS;
        "pkg-1.20.1-2.0.0-beta2" = _7YTipAVl;
        "pkg-1.18.2-2.0.0-beta3" = _krW9RO4I;
        "pkg-2.0.0-beta5" = _JrRwq1ZW;
        "pkg-1.20.1-2.0.0-beta2.1" = _PpalAqOr;
        "pkg-1.19.2_2.0.0-beta5" = _s0ZL49CJ;
        "pkg-1.20.1_2.0.0-beta5" = _8uQbUSoQ;
        "pkg-1.20.1_2.0.0-beta5.1" = _SYP2Y3Wu;
        "pkg-1.18.2-2.0.0" = _y6xPwNRr;
        "pkg-1.19.2-2.0.0" = _EC3euAFp;
        "pkg-1.20.1-2.0.0" = _xfHOgoaQ;
        "pkg-1.18.2-2.0.1" = _OkYDy4w7;
        "pkg-1.19.2-2.0.1" = _S1miPlQv;
        "pkg-1.20.1-2.0.1" = _28kQZRsR;
        "pkg-1.18.2-2.0.2" = _qiFUO19G;
        "pkg-1.19.2-2.0.2" = _ukjl5Hd3;
        "pkg-1.20.1-2.0.2" = _deW6q2Ny;
        "pkg-1.18.2-2.0.3" = _o38wpOJy;
        "pkg-1.19.2-2.0.3" = _aCPUXxqx;
        "pkg-1.20.1-2.0.3" = _yCxQHBMB;
        "pkg-1.18.2-2.0.4" = _aT3xFpYu;
        "pkg-1.19.2-2.0.4" = _E5BfdKAQ;
        "pkg-1.20.1-2.0.4" = _yr02kkKp;
        "pkg-1.20.1-2.0.5" = _B9DC4Jbt;
        "pkg-1.19.2-2.0.5" = _4qX7G7M9;
        "pkg-1.18.2-2.0.5" = _CY1Hl07p;
        "pkg-1.18.2-2.0.6" = _y05OzRg4;
        "pkg-1.19.2-2.0.6" = _XMSJu0wu;
        "pkg-1.20.1-2.0.6" = _zGUAGHLi;
        "pkg-1.18.2-2.0.7" = _Jr3LkLm6;
        "pkg-1.19.2-2.0.7" = _SBPz1asq;
        "pkg-1.20.1-2.0.7" = _hseLEhJS;
        "pkg-1.18.2-2.0.8" = _kyhHpBRA;
        "pkg-1.19.2-2.0.8" = _bjl2ZwZw;
        "pkg-1.20.1-2.0.8" = _geuHeZPL;
        "pkg-1.20.1-fabric-2.0.8-alpha.5" = _Ni0TIQrr;
        "pkg-1.20.1-fabric-2.0.8-alpha.6" = _oZdkdQpb;
        "pkg-1.18.2-2.0.9" = _ddKqwtwu;
        "pkg-1.19.2-2.0.9" = _OqmofDff;
        "pkg-1.20.1-2.0.9" = _QJeyHGf0;
        "pkg-1.20.1-fabric-2.0.9-alpha.1" = _M5ptHvNp;
        "pkg-1.20.1-fabric-2.0.9-alpha.2" = _BQ2sBwsa;
        "pkg-1.18.2-2.0.10" = _alafph9h;
        "pkg-1.19.2-2.0.10" = _yoQ0azDy;
        "pkg-1.20.1-2.0.10" = _nwxwL9cU;
        "pkg-1.20.1-fabric-2.0.10-beta.1" = _OMrBYSYZ;
        "pkg-FORGE-mc1.18.2-v2.0.11a" = _a0jJyodI;
        "pkg-FORGE-mc1.19.2-v2.0.11a" = _MOraeztg;
        "pkg-FORGE-mc1.20.1-v2.0.11a" = _E8Hsgd89;
        "pkg-FABRIC-mc1.20.1-v2.0.11a" = _GEwsLXOk;
        "pkg-FABRIC-mc1.20.1-v2.0.11b" = _nRPCFAnJ;
        "pkg-FABRIC-mc1.20.1-v2.0.11c" = _KO0Rxj8d;
        "pkg-FORGE-mc1.18.2-v2.0.12" = _mRo8iKJF;
        "pkg-FORGE-mc1.19.2-v2.0.12" = _bF2jzOc5;
        "pkg-FORGE-mc1.20.1-v2.0.12" = _H8pRB4hR;
        "pkg-FABRIC-mc1.20.1-v2.0.12" = _JrlV1uiW;
        "pkg-FORGE-mc1.18.2-v2.0.14" = _HC7kqhYh;
        "pkg-FORGE-mc1.19.2-v2.0.14" = _TixhnBTy;
        "pkg-FORGE-mc1.20.1-v2.0.14" = _YGm5PMF0;
        "pkg-FABRIC-mc1.20.1-v2.0.14" = _bJsfYTbr;
        "pkg-FORGE-mc1.18.2-v2.1.0" = _FLk8WoM5;
        "pkg-FORGE-mc1.19.2-v2.1.0" = _z1FQJchQ;
        "pkg-FORGE-mc1.20.1-v2.1.0" = _HIOwfpwo;
        "pkg-NEOFORGE-mc1.21.1-v2.1.0" = _Fq8Svvff;
        "pkg-FORGE-mc1.18.2-v2.1.1" = _6ufTXhiT;
        "pkg-FORGE-mc1.19.2-v2.1.1" = _7Q118tZe;
        "pkg-FORGE-mc1.20.1-v2.1.1" = _NIzazMxJ;
        "pkg-NEOFORGE-mc1.21.1-v2.1.1" = _caMcWS0A;
        "pkg-FORGE-mc1.18.2-v2.1.2" = _e05cqAkr;
        "pkg-FORGE-mc1.19.2-v2.1.2" = _EAkQ3UvN;
        "pkg-FORGE-mc1.20.1-v2.1.2" = _2A2HUo6d;
        "pkg-NEOFORGE-mc1.21.1-v2.1.2" = _4spIJghd;
        "pkg-FORGE-mc1.18.2-v2.1.3" = _h1uPodWv;
        "pkg-FORGE-mc1.19.2-v2.1.3" = _5ursWgpS;
        "pkg-FORGE-mc1.20.1-v2.1.3" = _7dq3p9A0;
        "pkg-NEOFORGE-mc1.21.1-v2.1.3" = _K0KAA77z;
        "pkg-FABRIC-mc1.20.1-v2.1.3" = _VwcpVmz7;
        "pkg-FORGE-mc1.18.2-v2.1.4" = _lQl2j6tw;
        "pkg-FORGE-mc1.19.2-v2.1.4" = _NkWMgD05;
        "pkg-FORGE-mc1.20.1-v2.1.4" = _NqD5gIlF;
        "pkg-FABRIC-mc1.20.1-v2.1.4" = _AcSfM1hg;
        "pkg-NEOFORGE-mc1.21.1-v2.1.4" = _vdCP433N;
        "pkg-FABRIC-mc1.21.1-v2.1.4" = _RuXhSxfh;
        "pkg-FORGE-mc1.18.2-v2.1.5" = _PLl1L0u9;
        "pkg-FORGE-mc1.19.2-v2.1.5" = _TPcMQe8J;
        "pkg-FORGE-mc1.20.1-v2.1.5" = _xqCImHJV;
        "pkg-NEOFORGE-mc1.21.1-v2.1.5" = _UtpJ7kVt;
        "pkg-FABRIC-mc1.21.1-v2.1.5a" = _HmVsRjcx;
        "pkg-NEOFORGE-mc1.21.1-v2.1.5a" = _K42chzjV;
        "pkg-FORGE-mc1.20.1-v2.1.6" = _JOwi3ra2;
        "pkg-FABRIC-mc1.20.1-v2.1.6" = _qSiuO6E1;
        "pkg-NEOFORGE-mc1.21.1-v2.1.6" = _LpjCnyUc;
        "pkg-FABRIC-mc1.21.1-v2.1.6" = _Z8uFwTVn;
        "pkg-NEOFORGE-mc1.21.1-v2.1.6a" = _MUnfmyGL;
        "pkg-FABRIC-mc1.21.1-v2.1.6a" = _cO0v6QwX;
        "pkg-NEOFORGE-mc1.21.1-v2.1.6b" = _QpVzqCvJ;
        "pkg-FORGE-mc1.20.1-v2.1.7" = _3hhrCPoT;
        "pkg-FABRIC-mc1.20.1-v2.1.7" = _tmMIEE6l;
        "pkg-FORGE-mc1.20.1-v2.1.7a" = _MGzbWa4B;
        "pkg-NEOFORGE-mc1.21.1-v2.1.7" = _xZWyO7K9;
        "pkg-FABRIC-mc1.21.1-v2.1.7" = _ssWXysep;
        "pkg-FABRIC-mc1.20.1-v2.1.7b" = _l7OWLhzR;
        "pkg-NEOFORGE-mc1.21.1-v2.1.8" = _PdtAWav8;
        "pkg-FORGE-mc1.19.2-v2.1.8" = _jxdadtzB;
        "pkg-FORGE-mc1.20.1-v2.1.9" = _JK7CgKYe;
        "pkg-FORGE-mc1.19.2-v2.1.9" = _RZveSlIK;
        "pkg-NEOFORGE-mc1.21.1-v2.1.9" = _zMlixyPA;
        "pkg-FORGE-mc1.20.1-v2.1.10" = _8k5HPTA1;
        "pkg-NEOFORGE-mc1.21.1-v2.1.10" = _NHIEonKy;
        "pkg-NEOFORGE-mc1.21.4-v2.1.10" = _hhzL4N6u;
        "pkg-FORGE-mc1.19.2-v2.1.10" = _IK023tSw;
        "pkg-FORGE-mc1.20.1-v2.1.11" = _xOk9ExQQ;
        "pkg-FORGE-mc1.19.2-v2.1.11" = _FFHPVfcS;
        "pkg-NEOFORGE-mc1.21.1-v2.1.11" = _3VBWAUNF;
        "pkg-NEOFORGE-mc1.21.4-v2.1.11" = _9y1BE8Ux;
        "pkg-NEOFORGE-mc1.21.4-v2.1.11a" = _mB8U8m4w;
        "pkg-FABRIC-mc1.20.1-v2.1.11" = _eCAcufgV;
        "pkg-FABRIC-mc1.21.1-v2.1.11" = _OD6EGIgf;
        "pkg-FABRIC-mc1.21.1-v2.1.11a" = _wChhmL3h;
        "pkg-FABRIC-mc1.20.1-v2.1.11a" = _mS3u1fNQ;
        "pkg-FABRIC-mc1.20.1-v2.1.11b" = _swKIAez7;
        "pkg-FABRIC-mc1.20.1-v2.1.11c" = _nWgL4ZMc;
        "pkg-FABRIC-mc1.21.1-v2.1.11c" = _Bk1oLm9s;
        "pkg-FORGE-mc1.20.1-v2.1.12" = _UyKSecEj;
        "pkg-NEOFORGE-mc1.21.1-v2.1.12" = _3TQ60Lg7;
        "pkg-NEOFORGE-mc1.21.4-v2.1.12" = _2FWvdJeH;
        "pkg-FABRIC-mc1.21.1-v2.1.12a" = _QyQmnT6g;
        "pkg-FABRIC-mc1.20.1-v2.1.12a" = _MhW210e2;
        "pkg-FORGE-mc1.19.2-v2.1.12" = _xUNWOHUA;
        "pkg-FORGE-mc1.18.2-v2.1.12" = _NJOd2ZT1;
        "pkg-FORGE-mc1.20.1-v2.1.13" = _Suva8n46;
        "pkg-NEOFORGE-mc1.21.1-v2.1.13" = _aauh9rJX;
        "pkg-FORGE-mc1.20.1-v2.1.14" = _F6KTRQET;
        "pkg-NEOFORGE-mc1.21.1-v2.1.14" = _kSsOJvBW;
        "pkg-FABRIC-mc1.21.1-v2.1.12b" = _APOfkg2U;
        "pkg-FABRIC-mc1.20.1-v2.1.12c" = _OIroJuKI;
        "pkg-FABRIC-mc1.21.1-v2.1.12c" = _PIXgOEz5;
        "pkg-FORGE-mc1.20.1-v2.1.15" = _Add8joyQ;
        "pkg-NEOFORGE-mc1.21.1-v2.1.15" = _CwJN1Ruj;
        "pkg-FORGE-mc1.20.1-v2.1.20" = _6FeLKEmt;
        "pkg-NEOFORGE-mc1.21.1-v2.1.20" = _ZswaOq9u;
        "pkg-FABRIC-mc1.20.1-v2.1.20" = _rzSmSe33;
        "pkg-FABRIC-mc1.21.1-v2.1.20" = _WCIVNpnX;
        "pkg-NEOFORGE-mc1.21.5-v2.1.20-a.1" = _7upuNNpp;
        "pkg-NEOFORGE-mc1.21.5-v2.1.21-a.1" = _CcyvB4HC;
        "pkg-NEOFORGE-mc1.21.1-v2.1.21" = _NYGiq0Rg;
        "pkg-FABRIC-mc1.20.1-v2.1.21" = _OJftcMUe;
        "pkg-FABRIC-mc1.21.1-v2.1.21" = _AzjBs33G;
        "pkg-NEOFORGE-mc1.21.5-v2.1.21" = _qCtu1NNd;
        "pkg-FABRIC-mc1.20.1-v2.1.22" = _arCNnrup;
        "pkg-NEOFORGE-mc1.21.1-v2.1.22" = _p6zqgIqr;
        "pkg-NEOFORGE-mc1.21.5-v2.1.22" = _MdLXtzXS;
        "pkg-FABRIC-mc1.21.1-v2.1.22" = _TM8LO9zb;
        "pkg-FABRIC-mc1.21.5-v2.1.22" = _TEeONfYV;
        "pkg-FORGE-mc1.20.1-v2.1.22" = _v8wcp1KM;
        "pkg-FORGE-mc1.20.1-v2.2.0-beta.1" = _eeAYHtOS;
        "pkg-FABRIC-mc1.21.8-v2.1.22" = _NZ7DzgQG;
        "pkg-FORGE-mc1.20.1-v2.2.0-beta.2" = _1eHXEHQs;
        "pkg-FORGE-mc1.20.1-v2.2.0-beta.3" = _AqpXMvIU;
        "pkg-FORGE-mc1.20.1-v2.2.0-beta.4" = _4DKFju94;
        "pkg-NEOFORGE-mc1.21.1-v2.1.23" = _ygogZrIE;
        "pkg-FORGE-mc1.20.1-v2.2.0-beta.5" = _41bOq1F5;
        "pkg-FORGE-mc1.20.1-v2.2.0-beta.6" = _e2ivSMRA;
        "default" = _e2ivSMRA;
    });
