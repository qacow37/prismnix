...
let
    ...
    in {
        ...
        "pkg-1.13-1.14.4" = _uBiljP8T;
        "pkg-1.15-1.16.1" = _midPAhUv;
        "pkg-1.16.2-1.16.5" = _WcG4LqKK;
        "pkg-1.17-1.17.1" = _x4FXMQzN;
        "pkg-1.18-1.18.2" = _mUvkmvz9;
        "pkg-1.19-1.19.2" = _TWIPJzul;
        "pkg-1.19.3" = _47ZdMX5E;
        "pkg-1.19.4" = _zGEzJFJM;
        "pkg-1.20-1.20.1" = _5JRB3ee6;
        "pkg-1.20.2" = _AgX14wtw;
        "pkg-1.20.3-1.20.4" = _9BwWBVpH;
        "pkg-1.20.5-1.20.6" = _yifQ2fPC;
        "pkg-1.21-1.21.1" = _62RVZhtt;
        "pkg-1.21.2-1.21.3" = _JSuBEibw;
        "pkg-1.21.4" = _pElxYef0;
        "pkg-1.21.5" = _VZTsYFr1;
        "pkg-1.21.6" = _T3DjJpcc;
        "pkg-1.21.7-1.21.8" = _SfvAxb0j;
        "pkg-1.21.9-1.21.10" = _2PDbQJ0z;
        "pkg-1.21.11" = _RtEO0Dlv;
