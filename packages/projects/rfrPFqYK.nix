...
let
    ...
    in {
        ...
        "pkg-MC1.12.2-1.3.5" = _19ifPAsU;
        "pkg-3.2.1+1.15-fabric" = _Uenjsdck;
        "pkg-3.2.1+1.15-forge" = _nqKTpUdz;
        "pkg-4.2.1+1.16-fabric" = _S03kITlw;
        "pkg-4.2.1+1.16-forge" = _fVLPirSi;
        "pkg-5.0.1+1.17-fabric" = _RGzQjPNt;
        "pkg-5.0.1+1.17-forge" = _FZZVCbmr;
        "pkg-6.0.0+1.18-fabric" = _b6z35u4H;
        "pkg-6.0.0+1.18-forge" = _zd79VqKe;
        "pkg-6.0.1+1.18-fabric" = _4axJLKWz;
        "pkg-6.0.1+1.18-forge" = _RWEcpG6W;
        "pkg-6.0.2+1.18-forge" = _Qen4d4qt;
        "pkg-6.0.2+1.18-fabric" = _h4d68RlW;
        "pkg-3.3.0+1.15-fabric" = _45y2pFJ8;
        "pkg-3.3.0+1.15-forge" = _JO6stl1l;
        "pkg-4.3.0+1.16-fabric" = _qQzwa4Pa;
        "pkg-4.3.0+1.16-forge" = _w9K6zFPy;
        "pkg-5.1.0+1.17-fabric" = _QXHZKNdu;
        "pkg-5.1.0+1.17-forge" = _TtAtGMHO;
        "pkg-6.1.0+1.18" = _vKU6JLwz;
        "pkg-6.1.0+1.18-forge" = _A4Ii9756;
        "pkg-7.0.0+1.19-fabric" = _N151nqKT;
        "pkg-7.0.0+1.19-forge" = _LJLePhIZ;
        "pkg-7.1.0+1.19-fabric" = _bPWqp5R1;
        "pkg-7.1.0+1.19-forge" = _FD8uuDws;
        "pkg-4.4.0+1.16-fabric" = _9UZecZUX;
        "pkg-4.4.0+1.16-forge" = _syXNCID6;
        "pkg-6.2.0+1.18-fabric" = _F4ySPMaV;
        "pkg-6.2.0+1.18-forge" = _W8eQ9s3c;
        "pkg-7.2.0+1.19-fabric" = _5pfU4mji;
        "pkg-7.2.0+1.19-forge" = _Rwe7Pc0L;
        "pkg-6.3.0+1.18-fabric" = _RQxpNKVT;
        "pkg-6.3.0+1.18-forge" = _uMLjaPZD;
        "pkg-7.3.0+1.19-fabric" = _eg8ePG6P;
        "pkg-7.3.0+1.19-forge" = _e9C0LMAu;
        "pkg-8.0.0+1.20-fabric" = _7fcHXEQP;
        "pkg-8.0.0+1.20-forge" = _t73Yyw5p;
        "pkg-8.0.1+1.20-fabric" = _LrtDO1Fs;
        "pkg-8.0.1+1.20-forge" = _PxsvwK4B;
        "pkg-8.0.1+1.20-neoforge" = _aW0jjXGR;
        "pkg-6.4.0+1.18.2-fabric" = _W43rvqF1;
        "pkg-6.4.0+1.18.2-minecraftforge" = _2NN6K2AC;
        "pkg-7.4.0+1.19.4-fabric" = _Hok44cXP;
        "pkg-7.4.0+1.19.4-minecraftforge" = _HZfjZQqY;
        "pkg-8.1.0+1.20.6-fabric" = _3VxhE4ru;
        "pkg-8.1.0+1.20.6-neoforge" = _Pvpa6Tln;
        "pkg-9.0.0+1.21-fabric" = _x18fGB4E;
        "pkg-9.0.0+1.21-neoforge" = _kXNmZGTK;
        "pkg-9.0.2+1.21.11" = _C8G4zzxO;
        "default" = _C8G4zzxO;
    });
