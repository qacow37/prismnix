...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _OLBx0Cgn;
        "pkg-1.0.1218" = _71p7A02w;
        "pkg-1.1.1215" = _ldqOKArK;
        "pkg-1.1.1214" = _yx6Gqefc;
        "pkg-1.1.1211" = _3XZJw9MB;
        "pkg-1.1.1201" = _FkDyDl5k;
        "pkg-1.1.1204" = _SDHmJMrw;
        "pkg-1.2.1215" = _cvmJTdoc;
        "pkg-1.2.1206" = _36ygDB5l;
        "pkg-1.2.1211" = _TLvq8ALk;
        "pkg-1.2.1194" = _v4wvgZgw;
        "pkg-1.2.1192" = _VlC4Gvh1;
        "pkg-1.2.1182" = _6hJRTSis;
        "pkg-1.2.1171" = _KrlQ7h09;
        "pkg-1.2.1165" = _kKFJg1x3;
        "pkg-1.2.1144" = _aFcCX3y9;
        "pkg-1.2.1152" = _nQAYkIfr;
        "pkg-1.2.2165" = _ipJygzmK;
        "pkg-1.2.2171" = _7nzSqjR9;
        "pkg-1.2.2182" = _F9O7Y7qX;
        "pkg-1.2.2192" = _CdgMU6ig;
        "pkg-1.2.2194" = _TcIb7z8Y;
        "pkg-1.2.3204" = _5HYbvmBO;
        "pkg-1.2.3206" = _b7eGHzGu;
        "pkg-1.2.3211" = _8pC07JUl;
        "pkg-1.2.3214" = _euB9BZio;
        "pkg-1.2.3215" = _e3XfZE6x;
        "pkg-1.2.1218" = _Cnp0YxvK;
        "pkg-1.3.1218" = _ybahjnd7;
        "pkg-1.3.1200" = _kmCnXw8r;
        "pkg-1.4.0" = _pCtNL5bz;
        "pkg-1.4.1" = _4Y6tgUeR;
        "pkg-1.4.2" = _hlXdY4Sd;
        "pkg-1.4.3" = _CprLwtIc;
