...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.16.5" = _Zk2jPxcx;
        "pkg-1.0.0+mc1.17.1" = _uTvfCUBM;
        "pkg-1.0.1+mc1.17.1" = _mfNlBb6U;
        "pkg-1.0.2-alpha1+mc1.18" = _1ApUEVoW;
        "pkg-1.0.2-alpha2+mc1.18.1" = _CVUGSVU0;
        "pkg-1.0.2-alpha3+mc1.18.1" = _Rxzic9a0;
        "pkg-1.0.2+mc1.18.2" = _D0fLM4o1;
        "pkg-1.0.3+mc1.18.2" = _ZxoJeTLg;
        "pkg-1.0.4+mc1.19" = _TpvP0qDc;
        "pkg-1.0.5+mc1.19" = _lK43uDfu;
        "pkg-1.0.6+mc1.18.2" = _Rli2nU8i;
        "pkg-1.0.6+mc1.19" = _H4bOnadw;
        "pkg-1.0.7+mc1.18.2" = _H45YVREb;
        "pkg-1.0.7+mc1.19" = _mJ7WqoOY;
        "pkg-1.0.8+mc1.19.2" = _WG5jreCt;
        "pkg-1.0.9+mc1.19.2" = _yTfou6df;
        "pkg-1.0.10+mc1.19.3" = _BoAba4K3;
        "pkg-1.0.11+mc1.19.3" = _KqmHL1pI;
        "pkg-1.0.12+mc1.19.3" = _85NvAOjQ;
        "pkg-1.0.13+mc1.19.3" = _tMamyl08;
        "pkg-1.0.14+mc1.19.3" = _U94NcDpV;
        "pkg-1.0.15+mc1.19.4" = _qqiFL8NF;
        "pkg-1.0.18+mc1.19.4" = _M7szjcI4;
        "pkg-1.0.18+mc1.20" = _WTH3T2cR;
        "pkg-1.0.19+mc1.19.4" = _oYQsfz9e;
        "pkg-1.0.20+mc1.20.1" = _9dgIzesu;
        "pkg-1.0.21+mc1.20.1" = _yTh7W27h;
        "pkg-1.0.22+mc1.20.1" = _OPwFzZCT;
        "pkg-1.0.23+mc1.20.1" = _HIQfyNd3;
        "pkg-1.0.24+mc1.20.1" = _hfBawPLH;
        "pkg-1.0.25+mc1.20.1" = _6UQwWURe;
        "pkg-1.0.27+mc1.20.1" = _Lue6O9z9;
        "pkg-1.0.28+mc1.20.4" = _tD2IqHXC;
        "pkg-1.0.29+mc1.20.4" = _nTorcOMQ;
        "pkg-1.0.30+mc1.20.4" = _Aouse6P7;
        "pkg-1.0.31+mc1.20.4" = _VlLxDisa;
        "pkg-1.0.32+mc1.20.1" = _XPsoVC5n;
        "pkg-1.0.33+mc1.21" = _w4F7PG0f;
        "pkg-1.0.34+mc1.20.1" = _gofbpynL;
        "pkg-1.0.34+mc1.21" = _K4hsdO9H;
        "pkg-1.0.35+mc1.21" = _Z8VpxxGh;
        "pkg-1.0.36+mc1.20.1" = _nQHYSjxO;
        "default" = _nQHYSjxO;
    });
