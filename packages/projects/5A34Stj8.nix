...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.1.10+fabric" = _nzFjhXtk;
        "pkg-1.19.2-1.1.11+fabric" = _x3ZJ7bKp;
        "pkg-1.19.2-1.1.11+forge" = _6ej9Yx2p;
        "pkg-1.18.2-1.1.9+fabric" = _r0apmYyP;
        "pkg-1.18.2-1.1.9+forge" = _86JOuUoT;
        "pkg-1.19.2-1.1.12+fabric" = _Np152Ylk;
        "pkg-1.19.2-1.1.12+forge" = _MbFI8Cl6;
        "pkg-1.19.2-1.2.0+fabric" = _qRm6EVNY;
        "pkg-1.19.2-1.2.0+forge" = _4MnNfUbP;
        "pkg-1.18.2-1.1.10+forge" = _lTzNCQBm;
        "pkg-1.20.1-1.3.0+forge" = _2CdEkEEj;
        "pkg-1.20.1-1.3.0+fabric" = _lVAfehsi;
        "pkg-1.20.1-1.3.1+forge" = _UAwhmZbI;
        "pkg-1.20.1-1.3.1+fabric" = _PAfk8PCf;
        "pkg-1.20.1-1.4.0+forge" = _9iZDJ3Sl;
        "pkg-1.20.1-2.0.0+forge" = _vgVUSAfc;
        "pkg-1.20.1-2.0.1+forge" = _eHFFTyTi;
        "pkg-1.20.1-2.0.2+forge" = _d3fGP4I1;
        "pkg-1.20.1-2.0.3+forge" = _wDW9QSlH;
        "pkg-1.20.1-2.0.4+forge" = _FbNu3pns;
        "pkg-1.20.1-2.0.5+forge" = _662B3KY3;
        "pkg-1.21.1-2.1.0+neoforge" = _d1yFFaUS;
        "pkg-1.21.1-2.1.1+neoforge" = _xj6ZvVWc;
        "pkg-1.21.1-2.1.2+neoforge" = _KNqrQhG3;
        "pkg-1.20.1-2.0.6+forge" = _rdDCSAh8;
        "pkg-1.21.1-2.1.3+neoforge" = _Xb2bsfiV;
        "pkg-1.21.1-2.2.0+neoforge" = _u0m5tHyB;
        "pkg-1.20.1-2.1.0+forge" = _5J8TMODW;
        "pkg-1.21.1-2.3.0+neoforge" = _tS3P0wyD;
        "pkg-1.21.1-2.4.0+neoforge" = _BqhDf7W8;
        "default" = _BqhDf7W8;
    });
