...
let
    ...
    in {
        ...
        "pkg-0.0.8" = _vVri1moE;
        "pkg-0.0.9" = _JmZbxKAW;
        "pkg-0.0.10-1.20.1" = _iT6S0C3X;
        "pkg-0.0.10-1.20.4" = _6hd7NgTE;
        "pkg-0.0.11-1.20.4" = _vkcx4QqB;
        "pkg-0.0.10-1.21" = _ifl4DB2S;
        "pkg-0.0.12-1.20.1" = _PI3sL3Mu;
        "pkg-0.0.12-1.20.4" = _Z0XXhv3Z;
        "pkg-0.0.12-1.21" = _3ez4IXN1;
        "pkg-0.0.13-1.20.1" = _b99Er59V;
        "pkg-0.0.13-1.20.4" = _kfNHZ9jg;
        "pkg-0.0.13-1.21" = _HvQ5IiI3;
        "pkg-0.0.14-1.21" = _5BBtCLnC;
        "pkg-0.0.14-1.21.3" = _GJRkPPg7;
        "pkg-0.0.15-1.20.1" = _A6CwiAdk;
        "pkg-0.0.15-1.20.4" = _oucQe01X;
        "pkg-0.0.15-1.21" = _CDHzxtqG;
        "pkg-0.0.15-1.21.3" = _qThvNHWb;
        "pkg-0.0.16-1.20.1" = _hBj3LHCX;
        "pkg-0.0.16-1.20.4" = _kresuNvS;
        "pkg-0.0.16-1.21" = _FBq5WMJ1;
        "pkg-0.0.16-1.21.3" = _V3wvQEkS;
        "pkg-0.0.17-1.20.1" = _4KWCsMKh;
        "pkg-0.0.17-1.20.4" = _CmN6mUHk;
        "pkg-0.0.17-1.21" = _zesr1bM6;
        "pkg-0.0.17-1.21.4" = _inEUmoji;
        "pkg-0.0.18-1.20.1" = _F9aCtBxf;
        "pkg-0.0.18-1.21" = _VWkGiFOj;
        "pkg-0.0.18-1.21.4" = _78f4f8nv;
        "pkg-0.0.19+1.21" = _WgoQ7COk;
        "pkg-0.0.20+1.21" = _uurhxmwf;
        "pkg-0.0.20+1.21.4" = _lEwI3neP;
        "pkg-0.0.21+1.21" = _SsqybicZ;
        "pkg-0.0.22+1.21.1" = _bC6YJJmN;
        "pkg-0.0.23+1.21.1" = _Ach6oR3I;
        "pkg-0.0.24+1.21.1" = _BocQWZWg;
        "pkg-0.0.25+1.21.1" = _9jHpHzen;
        "default" = _9jHpHzen;
    });
