...
let
    ...
    in {
        ...
        "pkg-1.6.0-fabric-1.18" = _KTGfH3KC;
        "pkg-1.6.0-forge-1.19" = _CioYPb6W;
        "pkg-1.6.0-fabric-1.19" = _K6cf9eax;
        "pkg-1.6.1-forge-1.19" = _LUGyS5vg;
        "pkg-1.6.1-fabric-1.19" = _TGtlRlUI;
        "pkg-1.6.2-1.19" = _KZmMUPjz;
        "pkg-1.6.2-1.19.3" = _C4uW6hHV;
        "pkg-1.6.2-1.19.3-forge" = _kE3Ii6Ew;
        "pkg-1.6.3-1.19.3" = _LxB5Tojq;
        "pkg-1.6.3-1.19.4" = _V5HfYVtW;
        "pkg-1.6.4-1.19.4" = _XFJeh7MA;
        "pkg-1.6.4-1.20" = _6auoqhMp;
        "pkg-1.6.4-1.20.2" = _4QkMRJ1H;
        "pkg-1.6.4-1.19.2" = _4Q3YTJ4K;
        "pkg-1.7.0" = _4e9kpBqk;
        "pkg-1.7.1" = _ZLjUeuU8;
        "pkg-1.7.2" = _9wrknT51;
        "pkg-1.7.3" = _roq966Ei;
        ...
        "pkg-1.9.2" = _CGUU69su;
        "pkg-1.9.3" = _8FfTQxID;
        "pkg-1.10.0" = _fGChInmc;
        "pkg-1.10.1" = _eGRESEt1;
        "pkg-1.10.2" = _zaJTSlH4;
        "pkg-1.10.3" = _MTCntRDh;
        "pkg-1.10.3.1" = _TBAXiloV;
        "pkg-1.10.4" = _gTbZZ3NA;
        "pkg-1.10.4.1" = _8YaHOshz;
        "pkg-1.10.5" = _McDjCKa2;
        "pkg-1.10.6" = _mpXwLASF;
        "pkg-1.11.0" = _ipdtSqTS;
        "pkg-1.11.1" = _TAFd0fuV;
        "pkg-1.11.2" = _oApy0qPj;
        "pkg-1.11.3" = _lTliK8fZ;
        "pkg-1.12.0" = _Go8OGTe5;
        "pkg-1.12.1" = _6K40Lrs5;
