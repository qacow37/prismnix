...
let
    ...
    in {
        ...
        "pkg-0.9.3" = _jTasLw1N;
        "pkg-0.10" = _8sXEhnPY;
        "pkg-0.10.1" = _UvDjdWYI;
        "pkg-0.10.1-bugfix" = _Th3KkXF7;
        "pkg-0.10.2" = _SU3Xsrmv;
        "pkg-0.10.3" = _78oJQUe7;
        "pkg-0.10.4" = _zIZCkS9L;
        "pkg-0.10.5" = _vyfmfQMw;
        "pkg-0.10.6" = _tHUHAybO;
        "pkg-0.11" = _t41GCsNP;
        "pkg-1.0-beta.1" = _hxxCfURo;
        "pkg-1.0-beta.2" = _lWy6haRD;
        "pkg-1.0-beta.3" = _4hsdVbBy;
        "pkg-1.0-beta.4" = _lDwGzIKP;
        "default" = _lDwGzIKP;
    });
