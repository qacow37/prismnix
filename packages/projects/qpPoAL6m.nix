...
let
    ...
    in {
        ...
        "pkg-fabric-1.19-1.0.3" = _6ftDXKG1;
        "pkg-forge-1.19.1-1.0.4" = _I0DlM7OQ;
        "pkg-fabric-1.19.1-1.0.3" = _iSHag0lU;
        "pkg-forge-1.19.2-1.0.4" = _bHUzGIMv;
        "pkg-fabric-1.19.2-1.0.3" = _o1MGTaWb;
        "pkg-forge-1.19-1.0.5" = _Jz5v0hv9;
        "pkg-fabric-1.19-1.0.5" = _sZxERsgm;
        "pkg-forge-1.19.1-1.0.5" = _iPWZ2dnK;
        "pkg-fabric-1.19.1-1.0.5" = _Aj39Eyxz;
        "pkg-forge-1.19.2-1.0.5" = _kSSO6K6f;
        "pkg-fabric-1.19.2-1.0.5" = _qLOXh29y;
        "pkg-forge-1.19.3-1.0.5" = _gu1FMLMz;
        "pkg-fabric-1.19.3-1.0.5" = _1Vt7kBpC;
        "pkg-forge-1.19.4-1.0.5" = _eepRoMrF;
        "pkg-fabric-1.19.4-1.0.5" = _p9LMGCuc;
        "pkg-forge-1.20-1.0.5" = _dIv0shmh;
        "pkg-forge-1.20.1-1.0.5" = _VP91XA5l;
        "pkg-fabric-1.20.1-1.0.5" = _whrPDkv2;
        "pkg-forge-1.20.1-1.0.6" = _2VDNGM9s;
        "pkg-fabric-1.20.1-1.0.6" = _aYjA2Tds;
        "pkg-forge-1.20.1-1.0.7" = _xLra6bEB;
        "pkg-fabric-1.20.1-1.0.7" = _9Vwmj6aI;
        "pkg-forge-1.20.2-1.0.7" = _u19hJM1Z;
        "pkg-fabric-1.20.2-1.0.7" = _zwealt1L;
        "pkg-neoforge-1.20.2-1.0.7" = _OcyiJK0Q;
        "pkg-forge-1.20.4-1.0.7" = _ChopZHVi;
        "pkg-neoforge-1.20.4-1.0.7" = _jWmiDVgZ;
        "pkg-fabric-1.20.4-1.0.7" = _fmvZUa2M;
        "pkg-forge-1.19.2-1.0.8" = _NQ9e0KwK;
        "pkg-fabric-1.19.2-1.0.8" = _4IkPbOop;
        "pkg-forge-1.20.1-1.0.8" = _xzG9q0Rn;
        "pkg-fabric-1.20.1-1.0.8" = _II9JagBu;
        "pkg-forge-1.20.2-1.0.8" = _gTe56BWr;
        "pkg-neoforge-1.20.2-1.0.8" = _VwrTNqqM;
        "pkg-fabric-1.20.2-1.0.8" = _KQjLNqMe;
        "pkg-forge-1.20.4-1.0.8" = _k3BPTmL6;
        "pkg-neoforge-1.20.4-1.0.8" = _aPyqAuOK;
        "pkg-fabric-1.20.4-1.0.8" = _sXuY8QJv;
        "pkg-forge-1.19.2-1.0.9" = _z4Y1tpyd;
        "pkg-fabric-1.19.2-1.0.9" = _IlaYwHCa;
        "pkg-forge-1.20.1-1.0.9" = _3m3s5dnQ;
        "pkg-fabric-1.20.1-1.0.9" = _H9LAUpZ7;
        "pkg-forge-1.20.4-1.0.9" = _pa01WKST;
        "pkg-neoforge-1.20.4-1.0.9" = _m0ABDidl;
        "pkg-fabric-1.20.4-1.0.9" = _gRUUTH4p;
        "pkg-forge-1.19.2-1.0.10" = _KF9TPz5j;
        "pkg-fabric-1.19.2-1.0.10" = _9sZjOgul;
        "pkg-forge-1.20.1-1.0.10" = _Q7qDgzDv;
        "pkg-fabric-1.20.1-1.0.10" = _OeUPUWl0;
        "pkg-forge-1.20.4-1.0.10" = _MDQTnodY;
        "pkg-neoforge-1.20.4-1.0.10" = _lmn6NjIi;
        "pkg-fabric-1.20.4-1.0.10" = _x13Iw5eJ;
        "pkg-forge-1.20.4-1.0.11" = _eOBFr33d;
        "pkg-neoforge-1.20.4-1.0.11" = _UKkPqIR6;
        "pkg-fabric-1.20.4-1.0.11" = _LIpX6qiq;
        "pkg-fabric-1.20.5-1.0.11" = _TEg4Zwjn;
        "pkg-neoforge-1.20.5-1.0.11" = _RQUb9rky;
        "pkg-forge-1.20.6-1.0.11" = _LDJJV1Vr;
        "pkg-neoforge-1.20.6-1.0.11" = _iFKrxH1P;
        "pkg-fabric-1.20.6-1.0.11" = _pCRH0GhH;
        "pkg-forge-1.21-1.0.11" = _Kvcz9a7q;
        "pkg-neoforge-1.21-1.0.11" = _7nkFLqQK;
        "pkg-fabric-1.21-1.0.11" = _G0E68axR;
        "pkg-forge-1.21-1.0.12" = _h6Ckdrc9;
        "pkg-neoforge-1.21-1.0.12" = _lXlEh8p8;
        "pkg-fabric-1.21-1.0.12" = _AQi6tDVy;
        "pkg-forge-1.19.2-1.0.13" = _Hnp6FsXa;
        "pkg-fabric-1.19.2-1.0.13" = _qLLWAXHA;
        "pkg-forge-1.20.1-1.0.13" = _6ipqmJ3I;
        "pkg-fabric-1.20.1-1.0.13" = _vKEz10cI;
        "pkg-forge-1.21-1.0.13" = _NgnqlzUi;
        "pkg-neoforge-1.21-1.0.13" = _5Z61ytaB;
        "pkg-fabric-1.21-1.0.13" = _1Xv7UU3q;
        "pkg-forge-1.21.1-1.0.13" = _9Z9Gq1Y4;
        "pkg-neoforge-1.21.1-1.0.13" = _6oHfzARc;
        "pkg-fabric-1.21.1-1.0.13" = _d3t2qbXw;
        "pkg-forge-1.19.2-1.0.14" = _QvppD8We;
        "pkg-fabric-1.19.2-1.0.14" = _3kQY8i6q;
        "pkg-forge-1.20.1-1.0.14" = _WgDCAlNH;
        "pkg-fabric-1.20.1-1.0.14" = _1jpO2JE3;
        "pkg-forge-1.21.1-1.0.14" = _LNcXtWlA;
        "pkg-neoforge-1.21.1-1.0.14" = _mejndbLj;
        "pkg-fabric-1.21.1-1.0.14" = _deVz1doZ;
        "pkg-forge-1.19.2-1.0.15" = _ZH5GrE5Q;
        "pkg-fabric-1.19.2-1.0.15" = _Hcju6Vth;
        "pkg-forge-1.20.1-1.0.15" = _6JjTwphz;
        "pkg-fabric-1.20.1-1.0.15" = _Jd71Afpm;
        "pkg-forge-1.21.1-1.0.15" = _8viJKkpc;
        "pkg-neoforge-1.21.1-1.0.15" = _FoKzuay2;
        "pkg-fabric-1.21.1-1.0.15" = _U6KxKGKC;
        "pkg-forge-1.21.3-1.0.15" = _HdptOVb9;
        "pkg-neoforge-1.21.3-1.0.15" = _lUKtuuFD;
        "pkg-fabric-1.21.3-1.0.15" = _aYrM4NZY;
        "pkg-forge-1.21.4-1.0.15" = _UojqCNoS;
        "pkg-neoforge-1.21.4-1.0.15" = _OzyBDKRG;
        "pkg-fabric-1.21.4-1.0.15" = _V5A1iSMQ;
        "pkg-forge-1.21.1-1.0.16" = _c5NSFKdR;
        "pkg-neoforge-1.21.1-1.0.16" = _yikAUzxG;
        "pkg-fabric-1.21.1-1.0.16" = _zEDKoUbT;
        "pkg-forge-1.21.4-1.0.16" = _E2yGyBBa;
        "pkg-neoforge-1.21.4-1.0.16" = _LT3fwDc9;
        "pkg-fabric-1.21.4-1.0.16" = _hJMpd4ey;
        "pkg-forge-1.20.1-1.0.17" = _v44h7Iv2;
        "pkg-fabric-1.20.1-1.0.17" = _kkpp7peL;
        "pkg-forge-1.21.1-1.0.17" = _CxNEuy09;
        "pkg-neoforge-1.21.1-1.0.17" = _E6vbUqiY;
        "pkg-fabric-1.21.1-1.0.17" = _7kNr2Tvp;
        "pkg-forge-1.21.4-1.0.17" = _dGtmHDqL;
        "pkg-neoforge-1.21.4-1.0.17" = _X6XKxvAl;
        "pkg-fabric-1.21.4-1.0.17" = _3hn20qg7;
        "pkg-forge-1.21.5-1.0.17" = _Uszt2kFg;
        "pkg-neoforge-1.21.5-1.0.17" = _UpFQiGip;
        "pkg-fabric-1.21.5-1.0.17" = _v96TJZns;
        "pkg-forge-1.20.1-1.0.18" = _W1h55dwF;
        "pkg-fabric-1.20.1-1.0.18" = _oKfFaQGY;
        "pkg-forge-1.21.1-1.0.18" = _8T6UTQSg;
        "pkg-neoforge-1.21.1-1.0.18" = _Dy7xxXr3;
        "pkg-fabric-1.21.1-1.0.18" = _NptlNExS;
        "pkg-forge-1.21.4-1.0.18" = _yG4lDysX;
        "pkg-neoforge-1.21.4-1.0.18" = _lpYl2pUx;
        "pkg-fabric-1.21.4-1.0.18" = _I88lE9nL;
        "pkg-forge-1.21.5-1.0.18" = _zWR0ZF6q;
        "pkg-neoforge-1.21.5-1.0.18" = _42CR8HM8;
        "pkg-fabric-1.21.5-1.0.18" = _dirqc2Im;
        "pkg-forge-1.21.6-1.0.18" = _YKTQkNG7;
        "pkg-neoforge-1.21.6-1.0.18" = _3SpfUi1P;
        "pkg-fabric-1.21.6-1.0.18" = _p0TEwl6y;
        "pkg-forge-1.21.6-1.0.19" = _Gs2BPQ0L;
        "pkg-neoforge-1.21.6-1.0.19" = _zklxb5Ky;
        "pkg-fabric-1.21.6-1.0.19" = _vRzvpr9S;
        "pkg-forge-1.21.7-1.0.19" = _noQwQXnP;
        "pkg-neoforge-1.21.7-1.0.19" = _777RlKRd;
        "pkg-fabric-1.21.7-1.0.19" = _dRyLEQiG;
        "pkg-forge-1.21.8-1.0.19" = _8HkA8hxb;
        "pkg-neoforge-1.21.8-1.0.19" = _2IIFJo94;
        "pkg-fabric-1.21.8-1.0.19" = _xpf5V7wi;
        "pkg-forge-1.21.9-1.0.19" = _m2FXtudL;
        "pkg-neoforge-1.21.9-1.0.19" = _pNQwCy33;
        "pkg-fabric-1.21.9-1.0.19" = _8gUJobPK;
        "pkg-forge-1.21.10-1.0.19" = _TxIu28iW;
        "pkg-neoforge-1.21.10-1.0.19" = _6zSB3zQa;
        "pkg-fabric-1.21.10-1.0.19" = _bWRFCmCA;
        "pkg-forge-1.21.11-1.0.19" = _43k1v12M;
        "pkg-neoforge-1.21.11-1.0.19" = _otjqu8u2;
        "pkg-fabric-1.21.11-1.0.19" = _ljZHlvtc;
        "pkg-fabric-1.21.1-1.0.20" = _g1AEWhmh;
        "pkg-fabric-1.21.4-1.0.20" = _Qi9Krhbc;
        "pkg-fabric-1.21.5-1.0.20" = _tZFQXmUX;
        "pkg-fabric-1.21.8-1.0.20" = _OEQWLuja;
        "pkg-fabric-1.21.10-1.0.20" = _U95L1wcI;
        "pkg-fabric-1.21.11-1.0.20" = _gjL3kDvK;
        "pkg-neoforge-1.0.20+26.1" = _LZ1lYE59;
        "pkg-fabric-1.0.20+26.1" = _gsior5Tf;
        "pkg-forge-1.0.20+26.1" = _Ybea5HWV;
        "pkg-forge-1.0.20+26.1.1" = _MVVvmRs0;
        "pkg-neoforge-1.0.20+26.1.1" = _ih0YoEWQ;
        "pkg-fabric-1.0.20+26.1.1" = _CAJy84yy;
        "pkg-forge-1.0.20+26.1.2" = _47KwgMJN;
        "pkg-neoforge-1.0.20+26.1.2" = _L6kgiCZg;
        "pkg-fabric-1.0.20+26.1.2" = _fYOanFML;
        "pkg-forge-1.0.21+26.1.2" = _kYp0CDKN;
        "pkg-neoforge-1.0.21+26.1.2" = _CjVuaIOO;
        "pkg-fabric-1.0.21+26.1.2" = _lOYCVRCp;
