...
let
    ...
    in {
        ...
        "pkg-0.3.8" = _3fm9AQ8T;
        "pkg-0.3.9" = _eGcJFUSQ;
        "pkg-0.3.10" = _HKmOKLKB;
        "pkg-0.3.11" = _EAnUCsYC;
        "pkg-0.3.12" = _CvKA8KBS;
        "pkg-0.3.13" = _rA3T0HpI;
        "pkg-0.3.14" = _MCYeeFI2;
        "pkg-0.3.15" = _7T2zEIZe;
        "pkg-0.3.16" = _TCo2PNkB;
        "pkg-0.3.17" = _zwDbCcfB;
        "pkg-0.3.18" = _XA8wT9Mf;
        "pkg-0.3.19" = _fOIvAw7q;
        "pkg-0.3.20" = _i0R9xPA5;
        "pkg-0.3.21" = _RpnZbZy8;
        "pkg-0.3.22" = _l2pdvrT5;
        "pkg-0.3.23" = _Cpdi83eV;
        "pkg-0.3.24" = _BBzVqYIm;
        "pkg-0.3.25" = _XNRERH9X;
        "default" = _XNRERH9X;
    });
