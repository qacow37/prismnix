...
let
    ...
    in {
        ...
        "pkg-1.0.1-alpha" = _BV1ALjca;
        "pkg-1.0.2-alpha" = _qCSFZJDC;
        "pkg-1.1-alpha" = _9eCZGA4u;
        "pkg-1.2-alpha" = _zlSHmaBO;
        "pkg-1.3-alpha" = _r4TfbmIo;
        "pkg-1.3.1-stable" = _uoZ9GRQf;
        "pkg-1.4-experemental" = _6XZ8uzBM;
        "pkg- 1.4.1-experemental" = _8Fdayh7u;
        "pkg-1.4.3-stable" = _OnYC2zew;
        "pkg-1.4.4" = _zCsGOJZc;
        "pkg-1.4.5-stable" = _se6qU2fa;
        "pkg-1.5" = _yEJ77Dbe;
        "pkg-2.0-pre1" = _KBORImrP;
        "pkg-2.0-pre2" = _vAQbBj1w;
        "pkg-2.0-pre3" = _HV2NHpfY;
        "pkg-2.0" = _k9vsytTC;
        "pkg-2.0.1" = _IbL8S9Tt;
        "pkg-3.0-beta1" = _CsYSbmtE;
        "pkg-3.0-beta3" = _Gct6yfbT;
        "pkg-3.0-beta4" = _h1VgG4ob;
        "pkg-3.0-rc6" = _Oub3E7JL;
        "pkg-3.0-rc6-1.18" = _8vYUAyOO;
        "pkg-3.0-rc10-1.18" = _fZNzww9k;
        "pkg-3.0-rc10-1.17" = _EqfM9CWW;
        "pkg-3.0-rc11-1.17" = _Y9ZKQAAS;
        "pkg-3.0-rc11-1.18" = _QaDgUeVV;
        "pkg-3.0-rc14-1.18" = _PcGOE5fz;
        "pkg-3.0-rc14-1.17" = _WdNFKue4;
        "pkg-3.0.0+1.17" = _3mMWMjAJ;
        "pkg-3.0.0+1.18" = _FQY8wtX3;
        "pkg-3.0.1+1.18" = _xps3tiEt;
        "pkg-3.0.1+1.17" = _nJuq0bM2;
        "pkg-3.1.1+1.18" = _OTK7ITDv;
        "pkg-3.1.1+1.17" = _JQ7pEK4s;
        "pkg-4.0.0+1.18" = _Av1aoyKG;
        "pkg-4.0.0+1.19" = _EUniyxEp;
        "pkg-4.1.1+1.19" = _uSvjz4bE;
        "pkg-4.1.1+1.18" = _HX3WYeGO;
        "pkg-4.1.2+1.18" = _bw6BzoC6;
        "pkg-4.1.2+1.19" = _fum8FjYI;
        "pkg-4.1.3+1.19" = _DsPMHgmj;
        "pkg-4.1.3+1.18" = _oDlgxjWQ;
        "pkg-5.0.0-alpha.3+1.19.3" = _bNoZcrPi;
        "pkg-5.0.0-alpha.4+1.19.3" = _XB4YnZ4X;
        "pkg-5.0.0-alpha.5+1.19.3" = _q9pA7KnN;
        "pkg-5.0.0-alpha.6+1.19.3" = _zOVGzQ13;
        "pkg-5.0.0-alpha.8+1.19.3" = _Zt4Hzppp;
        "pkg-5.0.0-alpha.9+1.19.3" = _ctsVVcoF;
        "pkg-5.0.0-alpha.10+1.19.3" = _mswaNhKQ;
        "pkg-5.0.0-alpha.11+1.19.3" = _wDoBtdGY;
        "pkg-5.0.0-alpha.12+1.19.3" = _D6bYfsNQ;
        "pkg-5.0.0-alpha.13+1.19.4" = _VkD2LvlX;
        "pkg-5.0.0-alpha.13+1.19.3" = _BUJc3mxs;
        "pkg-5.0.0-alpha.14+1.19.4" = _xwPC6okA;
        "pkg-5.0.0-beta.1+1.20.0" = _mcU33FBx;
        "pkg-5.0.0-beta.1+1.19.4" = _7hqKf7qu;
        "pkg-5.0.0-beta.2+1.20.0" = _wgtrj8HS;
        "pkg-5.0.0-beta.4+1.20.4" = _nbtQCDWh;
        "pkg-5.0.0-beta.4+1.20.6" = _tuSfD1VX;
        "pkg-5.0.0-beta.4+1.21.1" = _VmSkr8XZ;
        "pkg-5.0.0-beta.5+1.21.1" = _gk1Yt2XJ;
        "pkg-5.1.0-beta.5+1.21.3" = _wcLX6pSC;
        "pkg-5.1.0-beta.8+1.21.1" = _s8iJLvsS;
        "pkg-5.1.0-beta.8+1.21.3" = _eJQmV8LB;
        "pkg-5.1.0-beta.8+1.21.4" = _cgFogJZB;
        "default" = _cgFogJZB;
    });
