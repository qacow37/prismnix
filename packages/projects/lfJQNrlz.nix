...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _qfYfgI8I;
        "pkg-1.0.9" = _zoz2WuvU;
        "pkg-1.1.0+1.21.1" = _FgeNGUIt;
        "pkg-1.1.1+1.21.1" = _qnYW3D74;
        "pkg-1.1.2+1.21.1" = _mg0xqYIT;
        "pkg-1.1.3+1.21.1" = _NbJERsNj;
        "pkg-1.1.4+1.21.1" = _jzxVJxwM;
        "pkg-2.0.0+1.21.1" = _4ExUaGUr;
        "pkg-2.0.1+1.21.1" = _1nGPWgfP;
        "pkg-2.0.2+1.21.1" = _AEmb2P2H;
        "pkg-2.0.3+1.21.1" = _1kSFmHuh;
        "pkg-2.0.4+1.21.1" = _CfkXxHb8;
        "pkg-2.0.6+1.21.1" = _hzdBiZ8A;
        "pkg-2.0.7+1.21.1" = _2dA7j2Gq;
        "pkg-2.0.8+1.21.1" = _FtEd7yZ7;
        "pkg-2.0.9+1.21.1" = _zHkPfNiI;
        "pkg-2.0.10+1.21.1" = _5skTYPUh;
        "pkg-2.0.11+1.21.1" = _Ncm43f5k;
        "pkg-2.0.12+1.21.1" = _9Y34EOG5;
        "pkg-2.0.13+1.21.1" = _vOAaCXZf;
        "pkg-2.0.14+1.21.1" = _ePC5qaaa;
        "pkg-2.0.15+1.21.1" = _kuZl2vc2;
        "pkg-2.0.16+1.21.1" = _YrHyl7sC;
        "default" = _YrHyl7sC;
    });
