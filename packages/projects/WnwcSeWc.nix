...
let
    ...
    in {
        ...
        "pkg-v6.0.0-1.19.4-Forge" = _I70BGD6W;
        "pkg-v7.0.0-1.20-Forge" = _swSQRnaV;
        "pkg-v7.0.0-1.20-Fabric" = _UCWI8RxQ;
        "pkg-v8.0.0-1.20.1-Forge" = _BSNLebvS;
        "pkg-v8.0.0-1.20.1-Fabric" = _v7ycbZ7O;
        "pkg-v8.1.0-1.20.1-Forge" = _OXBRf5bv;
        "pkg-v8.1.0-1.20.1-Fabric" = _RvpMjRub;
        "pkg-v3.0.0-1.18.2-Forge" = _NU6xkngP;
        "pkg-v3.0.0-1.18.2-Fabric" = _Rtle0vOI;
        "pkg-v3.0.1-1.18.2-Forge" = _rfTx5X1Z;
        "pkg-v3.0.1-1.18.2-Fabric" = _c4kGVgt5;
        "pkg-v8.1.1-1.20.1-Forge" = _R65fOJX8;
        "pkg-v8.1.1-1.20.1-Fabric" = _irtVKuXe;
        "pkg-v8.2.0-1.20.1-Forge" = _OIQpiuR2;
        "pkg-v8.2.0-1.20.1-Fabric" = _uwE2f5y5;
        "pkg-v3.1.0-1.18.2-Forge" = _POJgiKHv;
        "pkg-v3.1.0-1.18.2-Fabric" = _Q5NfOXD4;
        "pkg-v20.4.0-1.20.4-Fabric" = _856RuZNc;
        "pkg-v20.4.0-1.20.4-Forge" = _taLUFAOe;
        "pkg-v20.4.0-1.20.4-NeoForge" = _gMmNt3L5;
        "pkg-v21.1.0-1.21.1-Fabric" = _IYnBKE6t;
        "pkg-v21.1.0-1.21.1-NeoForge" = _MabEzeun;
        "pkg-v8.2.1-1.20.1-Forge" = _KQaLEkgg;
        "pkg-v8.2.1-1.20.1-Fabric" = _HY4ut1Q0;
        "pkg-v21.1.1-1.21.1-Fabric" = _ih7DIVry;
        "pkg-v21.1.1-1.21.1-NeoForge" = _9AQKRTYv;
        "pkg-v21.4.0-1.21.4-Fabric" = _8O8Dgfwn;
        "pkg-v21.4.0-1.21.4-NeoForge" = _tzrAmuVR;
        "pkg-v21.5.0-1.21.5-Fabric" = _zR6SHMrP;
        "pkg-v21.5.0-1.21.5-NeoForge" = _h0QbD9Ld;
        "pkg-v21.7.0-1.21.7-Fabric" = _zsNlf98D;
        "pkg-v21.7.0-1.21.7-NeoForge" = _PjTVaSZa;
        "pkg-v21.8.0-1.21.8-Fabric" = _GsCR8vWs;
        "pkg-v21.8.0-1.21.8-NeoForge" = _EIfGbvr9;
        "pkg-v21.1.2-1.21.1-Fabric" = _p6ShFU9y;
        "pkg-v21.1.2-1.21.1-NeoForge" = _a7lvPWaQ;
        "pkg-v21.8.1-1.21.8-Fabric" = _p5aecK9k;
        "pkg-v21.8.1-1.21.8-NeoForge" = _jQcSV1b6;
        "pkg-21.9.0" = _YFLFkjff;
        "pkg-21.10.0" = _kCrwtVBG;
