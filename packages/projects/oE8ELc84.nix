...
let
    ...
    in {
        ...
        "pkg-V1.6" = _6aEEsdoO;
        "pkg-V1.7" = _c4tOwxxL;
        "pkg-V1.2(Beta)" = _ChG70O7y;
        "pkg-V1.1(Beta-1)" = _cPQT6Jfg;
        "pkg-V1.1(Beta-2)" = _dkay7JLY;
        "pkg-V1.7.1" = _zMfFlexW;
        "pkg-V1.7.2" = _8eTA02Ts;
        "pkg-V1.8" = _JhuTQMnr;
        "pkg-V1.8.1" = _D6Oy6ei4;
        "pkg-V1.9" = _2RRGkxUk;
        "pkg-V1.3.1" = _qyVviYAd;
        "pkg-V1.3.2" = _Wwq2kXMU;
        "pkg-V1.8.2" = _4HXLBKqs;
        "pkg-V1.8.3" = _29nWA0kG;
        "pkg-V1.9.1" = _vBzdB5w0;
        "pkg-V1.5.1" = _RySOr2rf;
        "pkg-V1.8.4" = _oHbfMRtd;
        "pkg-V1.9.2" = _S7uV4HK4;
        "pkg-V1.9.3" = _tm1sT1pg;
        "pkg-V1.8.5" = _QYzWprra;
        "pkg-V1.3.3" = _6ENxbqKK;
        "pkg-V1.9.4" = _m8THDO3n;
        "pkg-V1.8.6" = _3fuo5o4p;
        "pkg-V1.8.7" = _sm6yKWAP;
        "pkg-V1.8.4.1" = _K4rkhf5d;
        "pkg-V1.1.1" = _OqDeEMO9;
        "pkg-V1.2.1" = _5MJGzBlA;
        "default" = _5MJGzBlA;
    });
