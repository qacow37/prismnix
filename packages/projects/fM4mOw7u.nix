...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.0" = _A9yOWJ8e;
        "pkg-1.21.1-1.0.3" = _xPg2e3q3;
        "pkg-1.21.4-1.1.0" = _bZBETDrr;
        "pkg-1.21.11-1.2.0" = _1L4sKEYs;
        "pkg-1.21.11-1.2.1" = _AczUdVva;
        "pkg-1.21.11-1.2.2" = _Qt9N1LKa;
        "pkg-26.1.1-1.3.0" = _J4IRH817;
        "pkg-26.1.1-1.3.1" = _gSl01Tqj;
        "pkg-1.21.11-1.2.3" = _5ply0PXJ;
        "pkg-1.20.1-1.0.3" = _WH2WKVfn;
        "pkg-1.21.1-1.0.4" = _UgVYUzCa;
        "pkg-1.21.4-1.1.1" = _jLDDLPO8;
        "pkg-26.1.1-1.4.0" = _zIhnRrxF;
        "pkg-1.21.11-1.3.0" = _ERwzA8lK;
        "pkg-1.20.1-1.1.0" = _dOGcdPz8;
        "pkg-1.21.4-1.2.0" = _6RuMP9Sa;
        "pkg-1.21.1-1.1.0" = _veFcaehW;
        "pkg-26.1.2-1.4.1" = _L0ikHiDY;
        "pkg-26.1.2-1.4.2" = _3Kk8AnCP;
        "pkg-1.21.11-1.3.1" = _7r3P7ba1;
        "pkg-26.1.2-1.4.3" = _ydfOX1ym;
        "pkg-1.21.11-1.3.2" = _591xqgR5;
        "pkg-1.20.1-1.1.1" = _btW2sZup;
        "pkg-1.21.1-1.1.1" = _4qe3qeLg;
        "pkg-1.21.4-1.2.1" = _aRb3ECrt;
        "pkg-26.2-1.5.0" = _tHFJdu4p;
        "pkg-26.2-1.5.1" = _Ga9uO4PN;
        "pkg-26.1.2-1.4.4" = _eC5AuuJf;
        "pkg-1.21.11-1.3.3" = _kuFi3jc2;
