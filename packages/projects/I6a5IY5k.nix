...
let
    ...
    in {
        ...
        "pkg-0.3.0.722" = _daZhhlZO;
        "pkg-0.1.0.725" = _jNiPH3XQ;
        "pkg-0.1.1.756" = _lih4tbD7;
        "pkg-1.1.1.759" = _piKnCWBk;
        "pkg-1.1.1.765" = _SaIpHCz6;
        "pkg-1.14.4-0.4.0.847" = _EaWuPH9Y;
        "pkg-1.15.2-0.4.0.851" = _VewO2duh;
        "pkg-1.16.5-0.2.0.855" = _bFTXqiMm;
        "pkg-1.17.1-0.2.0.859" = _XKQlp43Y;
        "pkg-1.18.2-1.2.0.863" = _7C5TZeMG;
        "pkg-1.19.4-1.2.0.867" = _WsSojB25;
        "pkg-1.20.1-1.2.0.871" = _sUBHLOu0;
        "pkg-1.14.4-0.4.1.1020" = _7pN6XxBv;
        "pkg-1.15.2-0.4.1.1024" = _HkIQvMMC;
        "pkg-1.16.5-0.2.1.1028" = _vaQlONt6;
        "pkg-1.17.1-0.2.1.1032" = _NFb0tpX3;
        "pkg-1.18.2-1.2.1.1036" = _eZw1hUQZ;
        "pkg-1.19.4-1.2.1.1040" = _e2Zi5Hvc;
        "pkg-1.20.1-1.2.1.1045" = _8ABqw3os;
        "pkg-1.20.2-1.0.0.1054" = _ViWpjHQo;
        "pkg-1.14.4-0.4.2.1151" = _YtfKVt3B;
        "pkg-1.15.2-0.4.2.1155" = _9U3MPA1j;
        "pkg-1.16.5-0.2.2.1159" = _cTtseflo;
        "pkg-1.17.1-0.2.2.1163" = _mRJ6rBUw;
        "pkg-1.18.2-1.2.2.1167" = _Sy6LenlV;
        "pkg-1.19.4-1.2.2.1171" = _H72YIDLX;
        "pkg-1.20.2-1.0.1.1175" = _YCHlSl7g;
        "pkg-1.19.2-1.1.2.1205" = _NtQeAC00;
        "pkg-1.20.1-1.2.2.1214" = _592wp1am;
        "pkg-1.17.1-0.2.3.1264" = _hJ7pPBhW;
        "pkg-1.18.2-1.2.3.1268" = _GWdMvWLD;
        "pkg-1.19.2-1.1.3.1272" = _iHAv07V4;
        "pkg-1.19.4-1.2.3.1278" = _oaMtfuDz;
        "pkg-1.20.1-1.2.3.1282" = _hL97yOFw;
        "pkg-1.20.2-1.0.2.1286" = _YNLRjgcd;
        "pkg-1.14.4-0.4.3.1394" = _8De6fw0p;
        "pkg-1.15.2-0.4.3.1398" = _ILsWHRCc;
        "pkg-1.16.5-0.2.3.1402" = _zkieiOcq;
        "pkg-1.17.1-0.2.4.1406" = _n8brNec5;
        "pkg-1.20.2-1.0.3.1426" = _BjRKQJpV;
        "pkg-1.14.4-0.4.4.1450" = _utQbWQAr;
        "pkg-1.15.2-0.4.4.1454" = _lGRNS0WI;
        "pkg-1.16.5-0.2.4.1458" = _5H3Fbgy2;
        "pkg-1.17.1-0.2.5.1462" = _RMajbuCK;
        "pkg-1.18.2-1.2.5.1466" = _66oLkCuJ;
        "pkg-1.19.2-1.1.5.1470" = _leXqsGoB;
        "pkg-1.19.4-1.2.5.1474" = _yY0LMQOA;
        "pkg-1.20.1-1.2.5.1478" = _JxWLjIVi;
        "pkg-1.20.2-1.0.4.1482" = _HtQoGbxI;
        "pkg-1.14.4-0.4.5.1543" = _TsZU7whh;
        "pkg-1.15.2-0.4.5.1547" = _1AtH2fJN;
        "pkg-1.16.5-0.2.5.1551" = _8Nuf85d3;
        "pkg-1.17.1-0.2.6.1555" = _HublMuqs;
        "pkg-1.18.2-1.2.6.1559" = _uhzomc8c;
        "pkg-1.19.2-1.1.6.1563" = _lwRm0Uuv;
        "pkg-1.19.4-1.2.6.1567" = _Oc4XUgaM;
        "pkg-1.20.1-1.2.6.1571" = _kv4i0z7m;
        "pkg-1.20.2-1.0.5.1575" = _qQQF5Mbd;
        "pkg-1.20.4-1.0.0.1591" = _EZC2TOOp;
        "pkg-1.14.4-0.4.6.1621" = _vO7XL1A2;
        "pkg-1.15.2-0.4.6.1625" = _thvcQNs1;
        "pkg-1.16.5-0.2.6.1629" = _E5TKH4nA;
        "pkg-1.17.1-0.2.7.1633" = _Eoju8DMg;
        "pkg-1.18.2-1.2.7.1637" = _HsJPKh4U;
        "pkg-1.19.2-1.1.7.1641" = _y6R0LBFc;
        "pkg-1.19.4-1.2.7.1645" = _nzEwdRCC;
        "pkg-1.20.1-1.2.7.1649" = _iC50LcaD;
        "pkg-1.20.2-1.0.6.1653" = _MQPu7MoY;
        "pkg-1.20.4-1.0.1.1657" = _5FzbqOIx;
        "pkg-1.14.4-0.5.0.1684" = _srIhRCBQ;
        "pkg-1.15.2-0.5.0.1688" = _kNX0922r;
        "pkg-1.16.5-0.3.0.1692" = _nKjskjVe;
        "pkg-1.17.1-0.3.0.1696" = _8KVmAbwH;
        "pkg-1.18.2-1.3.0.1700" = _1oKg7Axq;
        "pkg-1.19.2-1.2.0.1704" = _TDlTP4Il;
        "pkg-1.19.4-1.3.0.1708" = _88WmaG0P;
        "pkg-1.20.1-1.3.0.1712" = _rRhd7iBC;
        "pkg-1.20.4-1.1.0.1716" = _SfbOOqtJ;
        "pkg-1.20.6-1.0.0.1849" = _XGTUm7rz;
        "pkg-1.21.0-1.0.1.1877" = _MaKi13dv;
        "pkg-1.21.1-1.0.0.1887" = _Wv8hbpyj;
        "pkg-1.21.3-1.0.0.1960" = _vKGs79Y1;
        "pkg-1.21.4-1.0.0.2146" = _p3R3xXSh;
        "pkg-1.21.5-1.0.0.2157" = _CYv8BcCT;
