...
let
    ...
    in {
        ...
        "pkg-0.0.1+25w14craftmine" = _IIaJtiXA;
        "pkg-0.0.1+1.21.3" = _jpZwJodu;
        "pkg-0.0.1+1.21.2" = _6KziapTo;
        "pkg-0.0.1+1.21.5" = _F6C1V1nw;
        "pkg-0.0.1+1.21.1" = _XrB9bBEF;
        "pkg-0.0.1+1.21.4" = _ZuByaMzI;
        "pkg-0.0.1+1.21" = _B4ZhpsmQ;
        "pkg-0.0.2+1.21.2" = _I9Qfl2JL;
        "pkg-0.0.2+1.21.3" = _2t0CztfE;
        "pkg-0.0.2+1.21.1" = _Dezb4TqE;
        "pkg-0.0.2+1.21.4" = _vMzm5SlD;
        "pkg-0.0.2+1.21" = _MeF5cz5t;
        "pkg-0.0.2+25w14craftmine" = _4QjkLzLu;
        "pkg-0.0.2+1.21.5" = _7TGGTCRu;
        "pkg-0.0.3+25w14craftmine" = _5RJ4oJqU;
        "pkg-0.0.3+1.21.5" = _kfjFsDXs;
        "pkg-0.0.3+1.21.4" = _wQRuz5Xh;
        "pkg-0.0.3+1.21.3" = _RKglnomL;
        "pkg-0.0.3+1.21.1" = _gTcTIVML;
        "pkg-0.0.3+1.21" = _WGni3itl;
        "pkg-0.0.3+1.21.2" = _SLavKmuu;
        "pkg-0.0.4+25w14craftmine" = _VUIHqMqR;
        "pkg-0.0.4+1.21.5" = _YBonEavc;
        "pkg-0.0.4+1.21.3" = _Ltg1xVZJ;
        "pkg-0.0.4+1.21.2" = _etTmkPNv;
        "pkg-0.0.4+1.21.4" = _A2FCmzjc;
        "pkg-0.0.4+1.21.1" = _nfXOp4go;
        "pkg-0.0.4+1.21" = _mhPwn1qq;
        "pkg-0.0.5+25w14craftmine" = _mKvypg4r;
        "pkg-0.0.5+1.21.1" = _WnTvkZNZ;
        "pkg-0.0.5+1.21.4" = _aR3uTMXs;
        "pkg-0.0.5+1.21.5" = _uu4y7EUb;
        "pkg-0.0.5+1.21.3" = _nNVKJeb1;
        "pkg-0.0.5+1.21.2" = _pfSQwaXs;
        "pkg-0.0.5+1.20.6" = _G6LxiIUC;
        "pkg-0.0.5+1.21" = _nJTxCVWT;
        "pkg-0.0.5+1.20" = _irhbsk3h;
        "pkg-0.0.5+1.20.5" = _9RhsHrZm;
        "pkg-0.0.5+1.20.3" = _I2V3X29M;
        "pkg-0.0.5+1.20.4" = _lSHkB88r;
        "pkg-0.0.5+1.20.2" = _XydJSpG6;
        "pkg-0.0.5+1.20.1" = _LMYKNsnN;
        "pkg-0.1.0+1.20" = _lJXfVQ0x;
        "pkg-0.1.0+1.20.4" = _2B6EfJXA;
        "pkg-0.1.0+1.20.1" = _Qdz6DvbG;
        "pkg-0.1.0+1.20.2" = _Q5HlFVjd;
        "pkg-0.1.0+1.21.5" = _vNuwaGxT;
        "pkg-0.1.0+1.21.4" = _6NNO0FAH;
        "pkg-0.1.0+1.21.1" = _sa3dd4gV;
        "pkg-0.1.0+25w14craftmine" = _cSKHNyo5;
        "pkg-0.1.0+1.21.3" = _wmQhfHHZ;
        "pkg-0.1.0+1.21.2" = _PxJ2vtAJ;
        "pkg-0.1.0+1.20.5" = _IHFXcxZl;
        "pkg-0.1.0+1.21" = _ASBFWRDh;
        "pkg-0.1.0+1.20.6" = _XBsEK9Le;
        "pkg-0.1.0+1.20.3" = _5bWk47HS;
        "pkg-0.1.1+1.21.1" = _OATuRUL5;
        "pkg-0.1.1+1.21.5" = _BkltM1M5;
        "pkg-0.1.1+25w14craftmine" = _2Tx5ulR0;
        "pkg-0.1.1+1.21.3" = _VyFfrgZ5;
        "pkg-0.1.1+1.21.4" = _AwYLoBPh;
        "pkg-0.1.1+1.21.2" = _mIIV1rTt;
        "pkg-0.1.1+1.20.5" = _8sNjpURw;
        "pkg-0.1.1+1.21" = _qEjOT6tb;
        "pkg-0.1.1+1.20.6" = _zQvihg6P;
        "pkg-0.1.2+25w14craftmine" = _V2wEECtZ;
        "pkg-0.1.2+1.21.5" = _ctxBBTcD;
        "pkg-0.1.2+1.21.4" = _cNFQYd9k;
        "pkg-0.1.2+1.21.3" = _dcpIObz5;
        "pkg-0.1.2+1.21.2" = _iC24MTqd;
        "pkg-0.1.2+1.21.1" = _RT7qezeo;
        "pkg-0.1.2+1.21" = _EbrkEra9;
        "pkg-0.1.2+1.20.6" = _7zWawdep;
        "pkg-0.1.2+1.20.5" = _NmuNa58K;
        "pkg-0.1.2+1.20.4" = _rzDc2wTb;
        "pkg-0.1.2+1.20.3" = _1sYQpbLj;
        "pkg-0.1.2+1.20.2" = _An086btL;
        "pkg-0.1.2+1.20.1" = _74shl9hb;
        "pkg-0.1.2+1.20" = _NoG0t6dj;
        "pkg-0.1.3+25w14craftmine" = _ZX84OodX;
        "pkg-0.1.3+1.21.5" = _Ayet8ZnO;
        "pkg-0.1.3+1.21.4" = _9Ue06CZG;
        "pkg-0.1.3+1.21.3" = _evQBPieu;
        "pkg-0.1.3+1.21.2" = _FWPMYQiQ;
        "pkg-0.1.3+1.21.1" = _TH9fZg5T;
        "pkg-0.1.3+1.21" = _m7WdCWrw;
        "pkg-0.1.3+1.20.6" = _3Kh6aVdB;
        "pkg-0.1.3+1.20.5" = _agvdJm7B;
        "pkg-0.1.3+1.20.4" = _t5QoSIvw;
        "pkg-0.1.3+1.20.3" = _y8urrB5E;
        "pkg-0.1.3+1.20.2" = _lK8EdBhp;
        "pkg-0.1.3+1.20.1" = _qMEgeRDk;
        "pkg-0.1.3+1.20" = _49HRhGN9;
        "pkg-0.1.4+25w14craftmine" = _wlKkuS7o;
        "pkg-0.1.4+1.21.5" = _1X3LcZeE;
        "pkg-0.1.4+1.21.4" = _DOrJ59jV;
        "pkg-0.1.4+1.21.3" = _s4JqDBCW;
        "pkg-0.1.4+1.21.2" = _V22sOST2;
        "pkg-0.1.4+1.21.1" = _jTYDpBqL;
        "pkg-0.1.4+1.21" = _OsxGWPOg;
        "pkg-0.1.4+1.20.6" = _67Wf4AAE;
        "pkg-0.1.4+1.20.5" = _f7hVRHyp;
        "pkg-0.1.4+1.20.4" = _AyW31eFF;
        "pkg-0.1.4+1.20.3" = _KRAIurlm;
        "pkg-0.1.4+1.20.2" = _Hzye1ZII;
        "pkg-0.1.4+1.20.1" = _aKryEscK;
        "pkg-0.1.4+1.20" = _eSKAoRAu;
        "pkg-0.1.4+1.21.7" = _KWjPte62;
        "pkg-0.1.5+1.21.4" = _y94XD8O3;
        "pkg-0.1.5+1.21" = _7LboLhpy;
        "pkg-0.1.5+1.21.2" = _o1p7SJkm;
        "pkg-0.1.5+1.21.3" = _VkFWTfAF;
        "pkg-0.1.5+1.21.5" = _H2T3wgvX;
        "pkg-0.1.5+1.21.7" = _MrFxCKBE;
        "pkg-0.1.5+1.21.1" = _llntSyMT;
        "pkg-0.1.5+1.20.6" = _lJcBuEGD;
        "pkg-0.1.5+1.20.1" = _kT05i2OP;
        "pkg-0.1.5+1.20.5" = _76CZSEW8;
        "pkg-0.1.5+1.20.4" = _YLnqFHeW;
        "pkg-0.1.5+1.20" = _Pw8AzFSl;
        "pkg-0.1.5+1.20.3" = _1mTBZGIM;
        "pkg-0.1.5+1.20.2" = _kQwXz3mL;
        "pkg-2.0.0" = _SJ2ZBf07;
        "pkg-2.0.0+1.21.6" = _z7KQZY0b;
        "pkg-2.0.0+26.1.x" = _6TJwm5G4;
        "pkg-2.0.0+26.2.x" = _qSu8vg1U;
        "default" = _qSu8vg1U;
    });
