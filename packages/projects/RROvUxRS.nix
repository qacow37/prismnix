...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _3gvr9qtl;
        "pkg-1.4.1+1.18.2" = _uInZSXQ9;
        "pkg-1.4.2" = _KrITt1zc;
        "pkg-1.4.2+1.18.2" = _WJlareWw;
        "pkg-1.5" = _bCgRQ3CW;
        "pkg-1.5.1" = _P2VCzoc7;
        "pkg-1.5.2" = _y14bBf3E;
        "pkg-1.6" = _462WwPJy;
        "pkg-1.6+1.18.2" = _vVVgvrJq;
        "pkg-1.6.1" = _Ykd0Yy7I;
        "pkg-1.6.1+1.18.2" = _XhVuKb8w;
        "pkg-1.6.2+1.18.2" = _bSzQ9GAA;
        "pkg-1.6.2+1.19.2" = _IU4rCp52;
        "pkg-1.6.2+1.19.3" = _57Df33Cn;
        "pkg-1.6.3+1.18.2" = _p4urs0yX;
        "pkg-1.6.3+1.19.2" = _XSlBjUFl;
        "pkg-1.6.3+1.19.3" = _74HsSIaj;
        "pkg-1.6.3+1.19.4" = _10oxyyNR;
        "pkg-2.0+1.18.2" = _1qkQN8iu;
        "pkg-2.0+1.19.2" = _nVyClJRA;
        "pkg-2.0+1.19.3" = _Kzoee4kS;
        "pkg-2.0+1.19.4" = _bEqsANhg;
        "pkg-2.1+1.18.2" = _ksuelIPy;
        "pkg-2.1+1.19.2" = _Wu5i4dHi;
        "pkg-2.1+1.19.3" = _G0OHFv0H;
        "pkg-2.1+1.19.4" = _G2l8Ds0F;
        "pkg-2.2+1.18.2" = _DixwCyy6;
        "pkg-2.2+1.19.2" = _rpQ2EYjC;
        "pkg-2.2+1.19.3" = _l9iyTnKp;
        "pkg-2.2+1.19.4" = _zRCVl2f6;
        "pkg-2.2+1.20.1" = _TZFVeJ4S;
        "pkg-2.2.1+1.18.2" = _Fl0HGoI4;
        "pkg-2.2.1+1.19.2" = _tZTnmSsT;
        "pkg-2.2.1+1.19.3" = _LS4OfZH0;
        "pkg-2.2.1+1.19.4" = _lRGXRgIL;
        "pkg-2.2.1+1.20.1" = _Kc80gQ05;
        "pkg-2.3+forge" = _PvhH3XKG;
        "pkg-2.3+1.18.2" = _rpGyYw9T;
        "pkg-2.3+1.19.2" = _5hOvonQN;
        "pkg-2.3+1.19.3" = _3o2ndVqY;
        "pkg-2.3+1.19.4" = _xeKqNGFK;
        "pkg-2.3+1.20.1" = _Dx3SaNE9;
        "pkg-2.3.1+1.19.2-forge" = _BXpLfA57;
        "pkg-2.3.1+1.20.1-forge" = _lVF1HXFO;
        "pkg-2.3.1+1.18.2" = _j48aP2qd;
        "pkg-2.3.1+1.19.2" = _vqXZxdV5;
        "pkg-2.3.1+1.19.3" = _QG3xJPwq;
        "pkg-2.3.1+1.19.4" = _WaRaqP15;
        "pkg-2.3.1+1.20.1" = _soKPVtdu;
        "pkg-2.3.1+1.20.2" = _6pXfrMAi;
        "pkg-2.4+1.18.2" = _2R7BimAZ;
        "pkg-2.4+1.19.2" = _n6v1Tyem;
        "pkg-2.4+1.19.2-forge" = _NWqoGXml;
        "pkg-2.4+1.19.3" = _ZfI0xKOP;
        "pkg-2.4+1.19.4" = _HkfJhjwF;
        "pkg-2.4+1.20.1" = _NpbDpi6s;
        "pkg-2.4+1.20.1-forge" = _xu2sAOOm;
        "pkg-2.4+1.20.2" = _o5nRKvaD;
        "pkg-3.0+1.18.2" = _XIOuhOAh;
        "pkg-3.0+1.19.3" = _3nWlZFtu;
        "pkg-3.0+1.19.4" = _Cm6jYGRk;
        "pkg-3.0+1.20.1" = _7d1VcrtJ;
        "pkg-3.0+1.20.2" = _98ZEJ3un;
        "pkg-3.0+1.19.2-forge" = _3yGnMqgy;
        "pkg-3.0+1.20.1-forge" = _6HkZidDf;
        "pkg-3.0+1.20.4" = _UPtVpTab;
        "pkg-3.0+1.21.1" = _VjNltnRO;
        "pkg-3.1+1.18.2" = _ZeBp1Qnb;
        "pkg-3.1+1.19.3" = _1tKdlXWc;
        "pkg-3.1+1.19.4" = _GGxlhtVe;
        "pkg-3.1+1.20.1" = _D8SNVyI7;
        "pkg-3.1+1.20.2" = _6VvnK8Yn;
        "pkg-3.1+1.19.2-forge" = _Sy0KQF7o;
        "pkg-3.1+1.20.1-forge" = _Yv5Jc0IQ;
        "pkg-3.1+1.20.4" = _d0YHOSzh;
        "pkg-3.1+1.21.1" = _O9JJ1JCl;
        "default" = _O9JJ1JCl;
    });
