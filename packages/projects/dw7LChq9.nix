...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _uubMfc6s;
        "pkg-1.0.0+1.21" = _2o81yS48;
        "pkg-1.0.0+1.20.5" = _EEyqSfDD;
        "pkg-1.0.0+1.20.4" = _OlU40B84;
        "pkg-1.0.0+1.20.6" = _ts8SCONh;
        "pkg-1.0.0+1.20.3" = _1ImOCa2p;
        "pkg-1.0.0+1.20.2" = _M4iqy7Lx;
        "pkg-1.0.0+1.20.1" = _ffPdhakD;
        "pkg-1.0.0+1.20" = _dwYp9oB1;
        "pkg-1.0.0+1.19.4" = _N6RF05Yd;
        "pkg-1.0.0+1.19.3" = _XWEn9JBo;
        "pkg-1.0.0+1.19.2" = _ITAIXaAz;
        "pkg-1.0.0+1.19.1" = _JQrKGpDp;
        "pkg-1.0.0+1.19" = _jWXMzv75;
        "pkg-1.0.0+1.18.2" = _LA8zZUpp;
        "pkg-1.0.0+1.18" = _tnBCO93K;
        "pkg-1.0.0+1.17.1" = _StN3a3Vc;
        "pkg-1.0.0+1.17" = _xzs67Vwx;
        "pkg-1.0.0+1.16.5" = _C8IMG3kW;
        "pkg-1.0.1+1.21.4" = _CIp0gWr8;
        "pkg-1.0.1+1.21.3" = _1gGJnkKQ;
        "pkg-1.0.1+1.21.2" = _HofHOu3n;
        "pkg-1.0.1+1.21.1" = _BFLbNeJe;
        "pkg-1.0.1+1.21" = _DwcnNEpF;
        "pkg-1.0.1+1.20.6" = _HUfJoy5S;
        "pkg-1.0.1+1.20.5" = _qDObBtEa;
        "pkg-1.0.1+1.20.4" = _4JHSBTj5;
        "pkg-1.0.1+1.20.3" = _mfs3hV1k;
        "pkg-1.0.1+1.20.2" = _ys7uH2GB;
        "pkg-1.0.1+1.20.1" = _t5po1cqt;
        "pkg-1.0.1+1.20" = _kQtamtfi;
        "pkg-1.0.1+1.19.4" = _PSXpPbzl;
        "pkg-1.0.1+1.19.3" = _FsqNkSQ6;
        "pkg-1.0.1+1.19.2" = _NmnisvCv;
        "pkg-1.0.1+1.19.1" = _yqrXcFmn;
        "pkg-1.0.1+1.19" = _RFXp61PH;
        "pkg-1.0.1+1.18.2" = _PlvTcrxL;
        "pkg-1.0.1+1.18.1" = _w2HofVVP;
        "pkg-1.0.1+1.18" = _3GsKVk0y;
        "pkg-1.0.1+1.17.1" = _JcFirNkK;
        "pkg-1.0.1+1.17" = _uo4iE869;
        "pkg-1.0.1+1.16.5" = _rPBbZXI1;
        "pkg-1.1.0+1.21.4" = _WFrbJ5uF;
        "pkg-1.1.0+1.21.3" = _BGxzmjkC;
        "pkg-1.1.0+1.21.2" = _8vM6eSI6;
        "pkg-1.1.0+1.21.1" = _ulYRIbo8;
        "pkg-1.1.0+1.21" = _GoexYKCV;
        "pkg-1.1.0+1.20.6" = _x9KY9lDP;
        "pkg-1.1.0+1.20.5" = _wP3bPmi7;
        "pkg-1.1.0+1.20.4" = _etGqByVX;
        "pkg-1.1.0+1.20.3" = _C6LfyIHX;
        "pkg-1.1.0+1.20.2" = _KCFqOaaj;
        "pkg-1.1.0+1.20.1" = _wgEuZo0T;
        "pkg-1.1.0+1.20" = _wLeZz0II;
        "pkg-1.1.0+1.19.4" = _7rxYVxip;
        "pkg-1.1.0+1.19.3" = _DHkRmRiP;
        "pkg-1.1.0+1.19.2" = _cIGuIP57;
        "pkg-1.1.0+1.19.1" = _NBDOeuus;
        "pkg-1.1.0+1.19" = _hixUH8KI;
        "pkg-1.1.0+1.18.2" = _jnhf0R7h;
        "pkg-1.1.0+1.18.1" = _LWXahkQk;
        "pkg-1.1.0+1.18" = _jBHng6ca;
        "pkg-1.1.0+1.17.1" = _T802mjhq;
        "pkg-1.1.0+1.16.5" = _AUaLdwGj;
        "pkg-1.1.0+1.17" = _Va6ilsel;
        "pkg-1.1.1+1.21.4" = _g0f7Gc0N;
        "pkg-1.1.1+1.21.3" = _V787WOwo;
        "pkg-1.1.1+1.21.2" = _pbX9nkLH;
        "pkg-1.1.1+1.21.1" = _2OYa1buS;
        "pkg-1.1.1+1.21" = _birXjalX;
        "pkg-1.1.1+1.20.6" = _TQwuzAhY;
        "pkg-1.1.1+1.20.5" = _ANN0rlfW;
        "pkg-1.1.1+1.20.4" = _vrhMkMgg;
        "pkg-1.1.1+1.20.3" = _xYuZ1J47;
        "pkg-1.1.1+1.20.2" = _mJX6AQHU;
        "pkg-1.1.1+1.20.1" = _1TczNoVf;
        "pkg-1.1.1+1.20" = _W177bZ41;
        "pkg-1.1.1+1.19.4" = _hKNwEyD2;
        "pkg-1.1.1+1.19.3" = _A9ZSkcqf;
        "pkg-1.1.1+1.19.2" = _ScW0mZrV;
        "pkg-1.1.1+1.19.1" = _vIMl5NQN;
        "pkg-1.1.1+1.19" = _6FQHQgDZ;
        "pkg-1.1.1+1.18.2" = _bt6wTrp3;
        "pkg-1.1.1+1.18.1" = _DTqECiHf;
        "pkg-1.1.1+1.18" = _aZLACTdt;
        "pkg-1.1.1+1.17.1" = _cc7P0r2w;
        "pkg-1.1.1+1.17" = _9VE8gMWj;
        "pkg-1.1.1+1.16.5" = _nHrN8d7D;
        "pkg-1.1.1+1.21.5" = _s750CfPo;
        "pkg-1.2.0" = _7pFXE9Cn;
        "pkg-1.2.0+1.19.3" = _mdwR6f0L;
        "pkg-1.2.0+1.18.2" = _rMaOx6w7;
        "pkg-1.2.0+1.16.5" = _SAkEw0ux;
        "pkg-1.2.0+1.17.1" = _sgWsDUmC;
        "pkg-1.2.0+1.18.1" = _sGAvFpwO;
        "pkg-1.2.0+1.19" = _AydiuDw1;
        "pkg-1.2.0+1.17" = _xs0Y3Q8z;
        "pkg-1.2.0+1.18" = _7qxiHwko;
        "pkg-1.2.0+1.19.2" = _ouKtzWrW;
        "pkg-1.2.0+1.19.4" = _bTtKi5eQ;
        "pkg-1.2.0+1.19.1" = _iTfUM7OS;
        "pkg-1.2.0+1.20" = _D2tG4Daa;
        "pkg-1.2.0+1.20.1" = _w7RTJIiF;
        "pkg-1.2.0+1.20.2" = _Zad7zVSW;
        "pkg-1.2.0+1.20.4" = _RlaxzWli;
        "pkg-1.2.0+1.20.3" = _qJzXI4G0;
        "pkg-1.2.0+1.21.5" = _I6lTbVT3;
        "pkg-1.2.0+1.21.1" = _BOBX0mI2;
        "pkg-1.2.0+1.20.6" = _jt8aUywx;
        "pkg-1.2.0+1.20.5" = _Zxs3WNXO;
        "pkg-1.2.0+1.21" = _SqJ9AXJN;
        "pkg-1.2.0+1.21.3" = _6zgGNgdK;
        "pkg-1.2.0+1.21.2" = _QJSwil5p;
        "pkg-1.2.0+1.21.6" = _seNLpXP5;
        "pkg-1.2.0+1.21.7" = _nsMPp4PH;
        "pkg-1.2.0+1.21.4" = _OgM0iodu;
        "pkg-1.2.0+1.21.8" = _VVyuxVi6;
        "pkg-1.2.1+1.16.5" = _L4vtqJQb;
        "pkg-1.2.1+1.17" = _CukGOagf;
        "pkg-1.2.1+1.17.1" = _Al8cEPVX;
        "pkg-1.2.1+1.18" = _s7wkYjpw;
        "pkg-1.2.1+1.18.1" = _vPXdLVXp;
        "pkg-1.2.1+1.18.2" = _JX3zppK1;
        "pkg-1.2.1+1.19" = _F6OKlfRp;
        "pkg-1.2.1+1.19.1" = _S8IRFnoc;
        "pkg-1.2.1+1.19.2" = _N1XVAkuM;
        "pkg-1.2.1+1.19.3" = _KJ47yZTB;
        "pkg-1.2.1+1.19.4" = _tjtsimGr;
        "pkg-1.2.1+1.20" = _zJMAkAlY;
        "pkg-1.2.1+1.20.1" = _BxngziNz;
        "pkg-1.2.1+1.20.3" = _LcXRwb3f;
        "pkg-1.2.1+1.20.4" = _x8pfk4wX;
        "pkg-1.2.1+1.20.2" = _VidMl5J6;
        "pkg-1.2.1+1.20.5" = _tI6wJ8t7;
        "pkg-1.2.1+1.20.6" = _QFmarO3b;
        "pkg-1.2.1+1.21" = _gck1t3on;
        "pkg-1.2.1+1.21.1" = _3gAbxQ4U;
        "pkg-1.2.1+1.21.2" = _sH2eleEX;
        "pkg-1.2.1+1.21.3" = _U63dmRhB;
        "pkg-1.2.1+1.21.4" = _o9ijuijq;
        "pkg-1.2.1+1.21.5" = _joNjg7nZ;
        "pkg-1.2.1+1.21.7" = _3KgqXuxZ;
        "pkg-1.2.1+1.21.6" = _Qcuy4PLq;
        "pkg-1.2.1+1.21.8" = _7K074CIw;
        "pkg-1.2.2+1.16.5" = _20ZMiCSH;
        "pkg-1.2.2+1.17.1" = _1s48acID;
        "pkg-1.2.2+1.18" = _U2g8M8ra;
        "pkg-1.2.2+1.19.1" = _bA9YEyqD;
        "pkg-1.2.2+1.17" = _Jeidrgn6;
        "pkg-1.2.2+1.18.1" = _OdtFcQVQ;
        "pkg-1.2.2+1.18.2" = _Ckxp5TYw;
        "pkg-1.2.2+1.19" = _rXxaqYkA;
        "pkg-1.2.2+1.19.2" = _jfBwvZVL;
        "pkg-1.2.2+1.19.3" = _J7aLYxLM;
        "pkg-1.2.2+1.20" = _UYT2ynVk;
        "pkg-1.2.2+1.20.4" = _eilei1ZW;
        "pkg-1.2.2+1.20.1" = _bsRNmvn9;
        "pkg-1.2.2+1.20.2" = _prVfG2Cg;
        "pkg-1.2.2+1.19.4" = _NxQsa9an;
        "pkg-1.2.2+1.21" = _iYIHyTPr;
        "pkg-1.2.2+1.21.1" = _3urUdIzG;
        "pkg-1.2.2+1.20.5" = _oFi6uubU;
        "pkg-1.2.2+1.21.2" = _uWpmpzZS;
        "pkg-1.2.2+1.20.6" = _sB90YIzT;
        "pkg-1.2.2+1.21.5" = _8udvvmtG;
        "pkg-1.2.2+1.21.3" = _UXbxr6Dp;
        "pkg-1.2.2+1.21.6" = _sDkvl1YW;
        "pkg-1.2.2+1.20.3" = _txN0erzN;
        "pkg-1.2.2+1.21.4" = _6KTq8LJ8;
        "pkg-1.2.2+1.21.7" = _UrSJOMOt;
        "pkg-1.2.2+1.21.8" = _28EU5Ak7;
        "pkg-1.2.3+1.16.5" = _Xm5s6xub;
        "pkg-1.2.3+1.17" = _ifn9Va4o;
        "pkg-1.2.3+1.17.1" = _mE0YEJPZ;
        "pkg-1.2.3+1.18" = _dWrwHxJt;
        "pkg-1.2.3+1.18.1" = _sx8uT4Ph;
        "pkg-1.2.3+1.18.2" = _zniNr5Lo;
        "pkg-1.2.3+1.19" = _4UHh6d3T;
        "pkg-1.2.3+1.19.1" = _4GTuRB2t;
        "pkg-1.2.3+1.19.2" = _zXavfyFL;
        "pkg-1.2.3+1.19.3" = _BWHvTia5;
        "pkg-1.2.3+1.19.4" = _lyilSf7P;
        "pkg-1.2.3+1.20" = _vE3pu6WC;
        "pkg-1.2.3+1.20.1" = _gz6hr7RH;
        "pkg-1.2.3+1.20.2" = _ISjnR9QR;
        "pkg-1.2.3+1.20.3" = _aWBsOY9W;
        "pkg-1.2.3+1.20.4" = _2em5JuWC;
        "pkg-1.2.3+1.20.5" = _JIrKpjqh;
        "pkg-1.2.3+1.20.6" = _nPvow1eW;
        "pkg-1.2.3+1.21" = _u0QzP5ph;
        "pkg-1.2.3+1.21.1" = _rhN1HJcz;
        "pkg-1.2.3+1.21.2" = _bNZRCa4t;
        "pkg-1.2.3+1.21.3" = _1Yep4Pr2;
        "pkg-1.2.3+1.21.4" = _AWLnkviK;
        "pkg-1.2.3+1.21.5" = _3XICRWYM;
        "pkg-1.2.3+1.21.6" = _LpYhcSdP;
        "pkg-1.2.3+1.21.7" = _NsELVDsF;
        "pkg-1.2.3+1.21.8" = _uXguFKGZ;
        "pkg-1.2.3+1.21.9" = _hxh5Zz1R;
        "pkg-1.2.3+1.21.10" = _zVJW8vkG;
        "pkg-1.2.1" = _OXqO8Pl7;
        "pkg-1.2.4+1.21.11" = _xFScpfft;
        "pkg-1.2.5" = _5GCMlK4e;
        "pkg-1.2.4+1.21.1+neoforge" = _4AbDTwoo;
        "pkg-1.2.4+1.21.11+neoforge" = _r5z0lLC7;
        "pkg-1.2.4+1.20.1+forge" = _EOhXkjmC;
        "pkg-1.2.5+26.1+fabric" = _ZKUNJaVF;
        "pkg-1.2.6+26.1+fabric" = _iPuMSKbb;
        "pkg-1.3.0+26.2+neoforge" = _5PVZQIBh;
        "pkg-1.3.0+26.2+fabric" = _NDjYrNet;
        "pkg-1.3.0+1.16.5+fabric" = _iqVxKg5G;
        "pkg-1.3.0+1.17+fabric" = _Lo03CsBa;
        "pkg-1.3.0+1.17.1+fabric" = _fQ13iW01;
        "pkg-1.3.0+1.18+fabric" = _Msi38m9W;
        "pkg-1.3.0+1.18.1+fabric" = _T0ZkF4LQ;
        "pkg-1.3.0+1.18.2+fabric" = _WgPd7OCP;
        "pkg-1.3.0+1.19+fabric" = _2k7e39tV;
        "pkg-1.3.0+1.19.1+fabric" = _lEaz8qI3;
        "pkg-1.3.0+1.19.2+fabric" = _Kz5FDhzq;
        "pkg-1.3.0+1.19.3+fabric" = _aGLG7yOG;
        "pkg-1.3.0+1.19.4+fabric" = _pHzNbi7P;
        "pkg-1.3.0+1.20+fabric" = _ujMf4Ye6;
        "pkg-1.3.0+1.20.1+fabric" = _4Kv58Cid;
        "pkg-1.3.0+1.20.2+fabric" = _bjVpHXL1;
        "pkg-1.3.0+1.20.3+fabric" = _90ldDWtg;
        "pkg-1.3.0+1.20.4+fabric" = _onhYBSdO;
        "pkg-1.3.0+1.20.5+fabric" = _2PBCKq7M;
        "pkg-1.3.0+1.20.6+fabric" = _IrW4pMzy;
        "pkg-1.3.0+1.21+fabric" = _fQtfImVy;
        "pkg-1.3.0+1.21.1+fabric" = _g2XRvKfK;
        "pkg-1.3.0+1.21.4+fabric" = _aCl87Q1N;
        "pkg-1.3.0+1.21.5+fabric" = _aprUyQli;
        "pkg-1.3.0+1.21.6+fabric" = _Bv5boMTd;
        "pkg-1.3.0+1.21.7+fabric" = _mzJzRWFa;
        "pkg-1.3.0+1.21.8+fabric" = _xZ7xId2e;
        "pkg-1.3.0+1.21.9+fabric" = _AmkZztw1;
        "pkg-1.3.0+1.21.10+fabric" = _2uihirgg;
        "pkg-1.3.0+1.21.11+fabric" = _aH0XOWA6;
        "pkg-1.3.0+26.1+fabric" = _J3hzvlZ8;
        "pkg-1.3.0+1.20.3+neoforge" = _BOM8rrvB;
        "pkg-1.3.0+1.20.4+neoforge" = _VabN8VUH;
        "pkg-1.3.0+1.20.6+neoforge" = _bYUl1nMQ;
        "pkg-1.3.0+1.21.1+neoforge" = _ElMkM996;
        "pkg-1.3.0+1.21.4+neoforge" = _3hBh114u;
        "pkg-1.3.0+1.21.5+neoforge" = _hSxOFMy9;
        "pkg-1.3.0+1.21.6+neoforge" = _7vNcE1i5;
        "pkg-1.3.0+1.21.7+neoforge" = _7pHHuKuw;
        "pkg-1.3.0+1.21.8+neoforge" = _asZGFZdZ;
        "pkg-1.3.0+1.21.9+neoforge" = _c6esQQKl;
        "pkg-1.3.0+1.21.10+neoforge" = _L4GwxWSK;
        "pkg-1.3.0+1.21.11+neoforge" = _OnMLkGsK;
        "pkg-1.3.0+26.1+neoforge" = _8J7lfeEl;
        "pkg-1.3.0+1.18.2+forge" = _BaPX2Ezo;
        "pkg-1.3.0+1.19.2+forge" = _S8HV3IZC;
        "pkg-1.3.0+1.19.3+forge" = _w9DO15AR;
        "pkg-1.3.0+1.19.4+forge" = _61vBx3wj;
        "pkg-1.3.0+1.20.1+forge" = _xroxBcsK;
        "pkg-1.3.1+1.16.5+fabric" = _Ai4nrZpY;
        "pkg-1.3.1+1.17+fabric" = _BdonN87q;
        "pkg-1.3.1+1.17.1+fabric" = _8YmC3zyZ;
        "pkg-1.3.1+1.18+fabric" = _GIJap78A;
        "pkg-1.3.1+1.18.1+fabric" = _CaIh267N;
        "pkg-1.3.1+1.18.2+fabric" = _COJTNk2j;
        "pkg-1.3.1+1.19+fabric" = _E6Isnp0u;
        "pkg-1.3.1+1.19.1+fabric" = _cwrfEKJm;
        "pkg-1.3.1+1.19.2+fabric" = _bfmkYYbn;
        "pkg-1.3.1+1.19.3+fabric" = _gBaaYJIV;
        "pkg-1.3.1+1.19.4+fabric" = _V9rmGsVO;
        "pkg-1.3.1+1.20+fabric" = _lWPSOJoo;
        "pkg-1.3.1+1.20.1+fabric" = _kyQpRZZb;
        "pkg-1.3.1+1.20.2+fabric" = _Yx457jeY;
        "pkg-1.3.1+1.20.3+fabric" = _LkBLlUEv;
        "pkg-1.3.1+1.20.4+fabric" = _u0lBOysb;
        "pkg-1.3.1+1.20.5+fabric" = _IDastTds;
        "pkg-1.3.1+1.20.6+fabric" = _MsBb92zu;
        "pkg-1.3.1+1.21+fabric" = _37vPcOOT;
        "pkg-1.3.1+1.21.1+fabric" = _TPDmfm0v;
        "pkg-1.3.1+1.21.4+fabric" = _RgxSZon8;
        "pkg-1.3.1+1.21.5+fabric" = _amEYyy0m;
        "pkg-1.3.1+1.21.6+fabric" = _l42tsjip;
        "pkg-1.3.1+1.21.7+fabric" = _KNgGHAV5;
        "pkg-1.3.1+1.21.8+fabric" = _kgZWoANK;
        "pkg-1.3.1+1.21.9+fabric" = _TXiWwyDP;
        "pkg-1.3.1+1.21.10+fabric" = _IY2wv7fA;
        "pkg-1.3.1+1.21.11+fabric" = _z8VBk6yE;
        "pkg-1.3.1+26.1+fabric" = _6x7D8Zul;
        "pkg-1.3.1+1.20.3+neoforge" = _Rr0bfsKj;
        "pkg-1.3.1+1.20.4+neoforge" = _JB4apjAF;
        "pkg-1.3.1+1.20.6+neoforge" = _mSiEQyc5;
        "pkg-1.3.1+1.21.1+neoforge" = _VKC3j9lS;
        "pkg-1.3.1+1.21.4+neoforge" = _5cJC4yCn;
        "pkg-1.3.1+1.21.5+neoforge" = _tsS6pz2S;
        "pkg-1.3.1+1.21.6+neoforge" = _qOvWuNiy;
        "pkg-1.3.1+1.21.7+neoforge" = _rnd1NlxD;
        "pkg-1.3.1+1.21.8+neoforge" = _76A2FwCb;
        "pkg-1.3.1+1.21.9+neoforge" = _64jZYcCM;
        "pkg-1.3.1+1.21.10+neoforge" = _Y1LndouP;
        "pkg-1.3.1+1.21.11+neoforge" = _Mai7aCwM;
        "pkg-1.3.1+26.1+neoforge" = _IIqMBj5o;
        "pkg-1.3.1+1.18.2+forge" = _yH77qYx9;
        "pkg-1.3.1+1.19.2+forge" = _ireCQbW0;
        "pkg-1.3.1+1.19.3+forge" = _KWTCJ2lx;
        "pkg-1.3.1+1.19.4+forge" = _nl9mHvs1;
