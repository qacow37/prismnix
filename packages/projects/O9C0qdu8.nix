...
let
    ...
    in {
        ...
        "pkg-2.1.5+1.19" = _NchXZfKL;
        "pkg-2.2.0+1.19" = _KhpZymXb;
        "pkg-2.2.1+1.19" = _Pmd4jBWP;
        "pkg-2.2.2+1.19" = _fvBL6xYV;
        "pkg-2.2.3+1.19" = _zDcjh5pL;
        "pkg-2.2.4+1.20" = _ZGc6UtWN;
        "pkg-2.2.5+1.20" = _LMM8v3v2;
        "pkg-2.2.6+1.20" = _j00Bd0o2;
        "pkg-2.2.7+1.20.4" = _szdkhw2r;
        "pkg-2.2.7+1.20" = _N9EbpflO;
        "pkg-2.2.8+1.20" = _goNFWmwg;
        "pkg-2.2.9+1.20" = _lv4Wg0QP;
        "pkg-2.2.10+1.20" = _QZreFbIp;
        "pkg-2.3.0+1.21" = _X13rWty9;
        "pkg-2.3.1+1.21.1" = _FEfS2vKD;
        "pkg-2.3.2+1.21.3" = _gTJwOfsa;
        "pkg-2.3.2+1.21.4" = _N4JuyYTs;
        "pkg-2.3.3+1.21.5" = _3QxvHfI7;
        "pkg-2.3.4+1.21.5" = _TGpluzb7;
        "pkg-2.3.5+1.21.8" = _lyRX7P18;
        "pkg-2.3.6+1.21.10" = _og65y1em;
        "pkg-2.3.7+1.21.11" = _pXGmDuIW;
        "default" = _pXGmDuIW;
    });
