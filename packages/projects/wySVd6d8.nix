...
let
    ...
    in {
        ...
        "pkg-1.2.1" = _7H36BjkI;
        "pkg-1.2.2" = _SQPWpcrc;
        "pkg-v1.2.3-1.18.2" = _TeMDldRr;
        "pkg-v1.2.3-1.19" = _13mV1C8C;
        "pkg-v1.2.3-1.19.3" = _5ojiSSWq;
        "pkg-v1.2.4-1.19.4" = _M28PFI7a;
        "pkg-v1.2.5-1.20" = _uzJqs3bv;
        "pkg-1.2.6" = _dXCTlhFR;
        "pkg-1.3.0" = _kfDo2ktt;
        "pkg-1.3.0+1.21" = _MT9Y7ffm;
        "pkg-1.4.0+1.21" = _OxjWqbuz;
        "pkg-1.4.0+1.21.3" = _frE4xeEM;
        "pkg-1.4.0+1.21.6" = _mz5TYwct;
        "pkg-1.4.1+1.21.6" = _c5oNZQPv;
        "pkg-1.4.1+1.21.10" = _QR031v2k;
        "pkg-1.5.0+1.21.6" = _3JQ3ZpO1;
        "pkg-1.5.0+1.21.10" = _vmUmd0NY;
        "pkg-1.5.1+1.21.10" = _gBczTI9h;
        "pkg-1.5.1+1.21.6" = _wuLruteM;
        "pkg-1.5.1+1.21.3" = _CXkFtSPK;
