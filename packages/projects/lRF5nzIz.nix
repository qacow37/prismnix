...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.7-fabric" = _4Ubqpdlh;
        "pkg-1.18.2-1.7-fabric" = _Ryt97bUQ;
        "pkg-1.19.2-1.8-fabric" = _IFXC7r9r;
        "pkg-1.16.5-1.3-forge" = _qT1Dh0CZ;
        "pkg-1.18.2-1.4-forge" = _F92xvu5J;
        "pkg-1.19.2-1.6-forge" = _rw9Qh88q;
        "pkg-1.16.5-1.9-fabric" = _vmAeodox;
        "pkg-1.18.2-1.9-fabric" = _psqjDwOE;
        "pkg-1.19.2-1.9-fabric" = _c75VlrzU;
        "pkg-1.16.5-2.0-fabric" = _BgT8Fl5f;
        "pkg-1.18.2-2.0-fabric" = _qIHjvYcN;
        "pkg-1.19.2-2.0-fabric" = _uaqZBuBc;
        "pkg-1.16.5-2.0-forge" = _HJEY6Uw1;
        "pkg-1.18.2-2.0-forge" = _7RQsYWJ9;
        "pkg-1.19.2-2.0-forge" = _k5GMoPJp;
        "pkg-1.19.3-2.1-fabric" = _eC8oybTp;
        "pkg-1.19.3-2.0-forge" = _SXqXbfLD;
        "pkg-1.18.2-3.0-forge+fabric" = _WoyIGQad;
        "pkg-1.19.2-3.0-forge+fabric" = _W7FMC90E;
        "pkg-1.19.3-3.0-forge+fabric" = _YToyESmB;
        "pkg-1.19.4-3.0-forge+fabric" = _zvuwwnau;
        "pkg-1.20-3.0-forge+fabric" = _ABD2SJXc;
        "pkg-1.20.1-3.0-forge+fabric" = _BkblnnmG;
        "pkg-1.20.2-3.0-forge+fabric" = _10QQU1sD;
        "pkg-1.18.2-3.1-forge+fabric" = _ffJLejsv;
        "pkg-1.19.2-3.1-forge+fabric" = _Cf6BbXaD;
        "pkg-1.20.1-3.1-forge+fabric" = _x8hHmRP4;
        "pkg-1.20.2-3.1-forge+fabric" = _2lMMXKbU;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _7WW3kLhW;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _6sRTd32p;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _MINTULDO;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _x7ylX9FR;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _Zh3QGWHn;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _uNluodIt;
        "pkg-1.20.5-3.2-fabric+neo" = _nCOws4qE;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _P0HtLDEc;
        "pkg-1.21.0-3.2-fabric+forge+neo" = _NgGavHTu;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _GiIh0OMI;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _Cdj3fO2B;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _47XQEhqa;
        "pkg-1.21.1-3.3-fabric+forge+neo" = _CcRUUgxK;
        "pkg-1.21.2-3.3-fabric+neo" = _vnAls2nG;
        "pkg-1.21.3-3.3-fabric+forge+neo" = _T6PWwFlX;
        "pkg-1.21.4-3.3-fabric+forge+neo" = _no3cSKac;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _aBwWifA1;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _WtP0IHZB;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _gT8CFZ6B;
        "pkg-1.21.5-3.4-fabric+forge+neo" = _yo9yb2wo;
        "pkg-1.21.6-3.4-fabric+forge+neo" = _IKdPBacj;
        "pkg-1.21.7-3.4-fabric+forge+neo" = _Ue9Vs3eJ;
        "pkg-1.21.8-3.4-fabric+forge+neo" = _fVkU3CHI;
        "pkg-1.21.9-3.4-fabric+forge+neo" = _qSmabRNW;
        "pkg-1.21.10-3.4-fabric+forge+neo" = _dz4UVjkn;
        "pkg-1.21.11-3.4-fabric+forge+neo" = _Miulx2MV;
        "pkg-26.1.0-3.4-fabric+forge+neo" = _na8Q66YI;
        "pkg-26.1.1-3.4-fabric+forge+neo" = _MLx6hy0l;
        "pkg-26.1.2-3.4-fabric+forge+neo" = _t92xA8E0;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _hALKMPSW;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _goT6VVnY;
        "default" = _goT6VVnY;
    });
