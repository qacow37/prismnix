...
let
    ...
    in {
        ...
        "pkg-0.1-forge+1.18" = _WSBpjmQY;
        "pkg-0.1-forge+1.19" = _iIKPATKh;
        "pkg-0.1-forge+1.20" = _4zo5z16B;
        "pkg-0.1-fabric+1.18" = _Yse7wYOt;
        "pkg-0.1-fabric+1.19" = _P3F8DB9U;
        "pkg-0.1-fabric+1.20" = _llMGVlTP;
        "pkg-0.2-forge+1.18" = _jeGcUl2a;
        "pkg-0.2-forge+1.19" = _GN3hX08y;
        "pkg-0.2-forge+1.20" = _GOmxQAer;
        "pkg-0.2-fabric+1.18" = _krClRJ2Q;
        "pkg-0.2-fabric+1.19" = _Cn6eo3IZ;
        "pkg-0.2-fabric+1.20" = _n0g1doiq;
        "pkg-0.3-forge+1.18" = _Q6TZoyfm;
        "pkg-0.3-forge+1.19" = _GJfaQebh;
        "pkg-0.3-forge+1.20" = _1Qoimwcz;
        "pkg-0.4-forge+1.19" = _XfqLvtE1;
        "pkg-0.4-forge+1.20" = _OZq2plqJ;
        "pkg-0.4-fabric+1.19" = _lRlvvhCQ;
        "pkg-0.4-fabric+1.20" = _SUVgOgU9;
        "pkg-0.5-forge+1.20" = _Bz8dSAtU;
        "pkg-0.5-fabric+1.20" = _vd6j7EDD;
        "pkg-0.5.1-forge+1.20" = _KnSUlmyv;
        "pkg-0.5.1-fabric+1.20" = _7CcFCBLb;
        "pkg-0.6-fabric+1.20" = _i8svv1qC;
        "pkg-0.6-neoforge+1.20" = _FCZrZSqR;
        "pkg-0.6-neoforge+1.21" = _wPuCcwWP;
        "pkg-0.6-fabric+1.21" = _JNUSB5fw;
        "pkg-0.6-fabric+1.21.4" = _HxioJpD5;
        "pkg-0.6-neoforge+1.21.4" = _B2PXTzNc;
        "pkg-1.0-neoforge+1.20" = _9xH49Ze1;
        "pkg-1.0-neoforge+1.21" = _RpLmfIeG;
        "pkg-1.0-neoforge+1.21.4" = _PBkBkvzW;
        "pkg-1.0-fabric+1.20" = _IEGimRsZ;
        "pkg-1.0-fabric+1.21" = _xmnvO2fm;
        "pkg-1.0-fabric+1.21.4" = _f2PZzZxF;
        "pkg-1.0-neoforge+1.21.5" = _QS2WVAn6;
        "pkg-1.0-fabric+1.21.5" = _SxxdsZIg;
        "pkg-1.1-1.20" = _DItBjWQv;
        "pkg-1.1-1.20.2" = _A5nlvwxf;
        "pkg-1.1-1.21" = _yiCdMq4R;
        "pkg-1.1-1.21.3" = _PkgAYrCV;
        "pkg-1.1-1.21.5" = _ZRIf6aqm;
        "pkg-1.1.1-1.20" = _KOskkH6u;
        "pkg-1.1.1-1.20.2" = _pRExcUPj;
        "pkg-1.1.1-1.21" = _saLEUrkr;
        "pkg-1.1.1-1.21.3" = _rYlvwnuA;
        "pkg-1.1.1-1.21.5" = _ynqgBbVP;
        "pkg-1.1.2-1.20" = _keSeTWzS;
        "pkg-1.1.2-1.20.2" = _ELPwo49e;
        "pkg-1.1.2-1.21" = _JucQe4YL;
        "pkg-1.1.2-1.21.3" = _5J2Czl1t;
        "pkg-1.1.2-1.21.5" = _HUx29BYY;
        "pkg-1.1.3-1.20" = _jozq2SuI;
        "pkg-1.1.3-1.20.2" = _ilwPdO6j;
        "pkg-1.1.3-1.21" = _yS4Ekb8I;
        "pkg-1.1.3-1.21.3" = _S2yWgP36;
        "pkg-1.1.3-1.21.5" = _ZnvsV33A;
        "pkg-1.2-1.20" = _ZlIFzak1;
        "pkg-1.2-1.20.2" = _V06mi5VP;
        "pkg-1.2-1.21" = _x6ZNJg5i;
        "pkg-1.2-1.21.3" = _Sxuih9K9;
        "pkg-1.2-1.21.5" = _n88ZECBC;
        "pkg-1.2.1-1.21" = _P6Sor6KX;
        "pkg-1.2.1-1.21.3" = _ZfzEBNHD;
        "pkg-1.2.1-1.21.5" = _Mn9cnRFX;
        "pkg-1.3-1.20" = _D4bskNmn;
        "pkg-1.3-1.20.2" = _gonvxJQF;
        "pkg-1.3-1.21" = _fmzw5taO;
        "pkg-1.3-1.21.3" = _q36uKMAG;
        "pkg-1.3-1.21.5" = _8cgaBJZ2;
        "pkg-1.4-1.21+fabric" = _hLEPG8jt;
        "pkg-1.4-1.21+neoforge" = _6TbnUFbd;
        "pkg-1.4-1.21.3+fabric" = _NLisXoiA;
        "pkg-1.4-1.21.3+neoforge" = _PZ4PPtgK;
        "pkg-1.4-1.21.5+fabric" = _adEkKKd9;
        "pkg-1.4-1.21.5+neoforge" = _TQSZ7bzr;
        "pkg-1.4-1.21.9+fabric" = _Ns7ZCktY;
        "pkg-1.4-1.21.9+neoforge" = _KcGbS2XG;
        "pkg-1.4.1-1.21.3+fabric" = _QLDyKSyA;
        "pkg-1.4.1-1.21.3+neoforge" = _DzVVb0JC;
        "pkg-1.4.1-fabric+1.21.5" = _t0bBWaNR;
        "pkg-1.4.1-1.21.5+neoforge" = _83I2NVLq;
        "pkg-1.4.1-1.21.9+fabric" = _8RHn2jrW;
        "pkg-1.4.1-1.21.9+neoforge" = _XmwkAkN5;
        "pkg-2.0-1.21.11+fabric" = _fj0wb1gI;
        "pkg-2.0-1.21.11+neoforge" = _gOLODvXh;
        "pkg-2.0.1-1.21.11+fabric" = _JJUYX5NJ;
        "pkg-2.0.1-1.21.11+neoforge" = _CvnxoSoJ;
        "pkg-2.0.2-1.21.11+fabric" = _yP6k7har;
        "pkg-2.0.2-1.21.11+neoforge" = _QCKvVpuU;
        "pkg-2.0.3-1.21.11+fabric" = _phjoxxQF;
        "pkg-2.0.3-1.21.11+neoforge" = _Sc2GmLQd;
        "pkg-2.1-fabric+1.21.11" = _Ri6GrxLw;
        "pkg-2.1-1.21.11+neoforge" = _VWdt51lg;
        "pkg-2.2+26.1" = _Q82NRXmO;
        "pkg-2.3+26.1" = _mNqkgL8r;
        "pkg-2.3.1+26.1" = _dlZrZJAh;
        "pkg-2.3.2+26.1" = _UmGlq6E1;
        "pkg-2.3.3+26.1" = _qXiGMlFi;
        "pkg-2.3.3+26.2" = _XRwrYSiD;
        "default" = _XRwrYSiD;
    });
