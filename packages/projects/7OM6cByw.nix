...
let
    ...
    in {
        ...
        "pkg-10" = _aaJpe8yI;
        "pkg-10+mod" = _Jyp4v0Bg;
        "pkg-12" = _IKMSobmP;
        "pkg-12+mod" = _rp8q3Mlb;
        "pkg-15" = _rCuPyG3d;
        "pkg-15+mod" = _5Azai1PE;
        "pkg-18" = _2kbec82D;
        "pkg-18+mod" = _GqdxqpuI;
        "pkg-26" = _Tvgc3JP5;
        "pkg-26+mod" = _qw4SWAHD;
        "pkg-41" = _XbcWJIat;
        "pkg-41+mod" = _L6CGJuAK;
        "pkg-48" = _X9rw1hyj;
        "pkg-48+mod" = _TIzLA5tO;
        "pkg-57" = _v65M6HKo;
        "pkg-57+mod" = _nDbhn7vm;
        "pkg-61" = _7582Sg9j;
        "pkg-61+mod" = _pUwZV1dT;
        "pkg-71" = _w6Iic4lc;
        "pkg-71+mod" = _FFqTRWCw;
        "pkg-80" = _Vjxss6wH;
        "pkg-80+mod" = _rE8Y1hoP;
        "pkg-81" = _Rmef8laC;
        "pkg-81+mod" = _PriJvRNy;
        "pkg-88" = _e4bfoJ3O;
        "pkg-88+mod" = _zK0G1bjK;
        "default" = _zK0G1bjK;
    });
