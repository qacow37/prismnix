...
let
    ...
    in {
        ...
        "pkg-2.5.4" = _LVAADojk;
        "pkg-2.5.5" = _g9TiNNaq;
        "pkg-2.5.5-B" = _t6WXNg12;
        "pkg-2.5.6" = _YAO0vKUT;
        "pkg-2.5.7" = _oe9WPpnW;
        "pkg-2.5.8" = _UO2cYgxW;
        "pkg-2.5.9" = _PbsRVwnr;
        "pkg-2.5.10" = _S4ZaiyWB;
        "pkg-2.5.10.1" = _Ahtzpr83;
        "pkg-2.5.10.2" = _oGbl9QQK;
        "pkg-2.5.10.3" = _hhTCZ5PG;
        "pkg-2.5.10.4" = _ETzaPCIR;
        "pkg-2.5.10.6" = _TawERMSj;
        "pkg-2.6.0" = _2iqKv9ho;
        "pkg-2.6.1" = _jQdKPPTp;
        "pkg-2.6.1b" = _X4ZKqghy;
        "pkg-2.6.2" = _f7Gzhmbu;
        "pkg-2.6.3" = _x2jR5tla;
        "pkg-2.6.4" = _wWAO76Vp;
        "pkg-2.6.5" = _yZ6AHvpV;
        "pkg-2.6.5c" = _j23fpxSQ;
        "pkg-2.6.5.1" = _SPUOiTdB;
        "pkg-2.6.5.3" = _UycmCC96;
        "pkg-2.6.5.4" = _YuV9fD88;
        "pkg-2.6.5.5" = _mDLAH5M4;
        "pkg-2.6.5.5b" = _icKgy3EQ;
        "pkg-2.6.5.5c" = _dX6twEBL;
        "pkg-2.6.5.5e" = _Ysi87KcN;
        "pkg-2.6.5.6" = _rUP9uYrP;
        "pkg-2.6.5.7" = _BgpZ9AEI;
        "pkg-2.6.6" = _ihsArlfH;
        "pkg-2.6.7" = _kqcu8ZYC;
        "pkg-2.7.0" = _Ig21aSVx;
        "pkg-2.7.1" = _aUhYHMXj;
        "pkg-2.7.2" = _GZv9tOw3;
        "pkg-2.7.2-hot-fix" = _ZgbDzMkn;
        "pkg-2.7.3" = _od2aeqL2;
        "pkg-2.7.4" = _GDz9Ng8z;
        "pkg-2.7.5" = _ZEWb3tgo;
        "pkg-2.8.0" = _sBpwbesP;
        "pkg-2.8.1" = _oo9viRIe;
        "pkg-2.8.2" = _NSrC1Wn3;
        "pkg-2.8.2b" = _zXjaklWW;
        "pkg-2.9.0" = _9IgaC80i;
        "pkg-2.9.2" = _3sScd1up;
        "pkg-2.9.2b" = _IqVBIRHJ;
        "default" = _IqVBIRHJ;
    });
