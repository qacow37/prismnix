...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _4NJr36sc;
        "pkg-1.3.1" = _v50bgGHc;
        "pkg-1.3.1-alpha.1+mc.1.20.4" = _wc1qBI12;
        "pkg-1.4.0-alpha" = _A8rMXb0p;
        "pkg-1.4.0-alpha.1+mc.1.20.4" = _fT6Bv4xz;
        "pkg-1.4.1-alpha" = _NSN60kor;
        "pkg-1.4.1-alpha.1+mc.1.20.4" = _4LBgGrLN;
        "pkg-1.4.2-alpha" = _BdgTUWz8;
        "pkg-1.4.2-alpha.1+mc.1.20.4" = _GXNSjfnm;
        "pkg-1.5.0" = _CQl0Bpo3;
        "pkg-1.5.0-alpha" = _7RpM7eXN;
        "pkg-1.5.1" = _QSLitT3N;
        "pkg-1.5.1-alpha+mc.1.20.4" = _eY8YB1We;
        "pkg-1.6.0" = _2g2r4x6L;
        "pkg-1.6.0-alpha+mc.1.20.4" = _tcZWAZ47;
        "pkg-1.6.1" = _5Qovq7Vu;
        "pkg-1.6.1-alpha+mc.1.20.4" = _Xw8Iv3Gt;
        "pkg-1.6.2" = _u5aZu0yp;
        "pkg-1.6.2-alpha+mc.1.20.4" = _359Zvt8j;
        "pkg-1.7.0" = _8LkwqsbX;
        "pkg-1.7.0-alpha+mc.1.20.4" = _qSgp6jwy;
        "pkg-1.7.1" = _nLset90B;
        "pkg-1.7.1-alpha+mc.1.20.4" = _uCfd5YmR;
        "pkg-1.7.1+patch.1" = _EJEVy8IZ;
        "default" = _EJEVy8IZ;
    });
