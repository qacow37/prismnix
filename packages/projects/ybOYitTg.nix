...
let
    ...
    in {
        ...
        "pkg-1.0.2+1.17.1" = _Oq0Q1gRh;
        "pkg-1.0.2+1.18.2" = _V8uHdzKy;
        "pkg-1.0.2+1.19.2" = _UXBIlz9q;
        "pkg-1.0.2+1.19.3" = _EDAUAX3o;
        "pkg-1.0.2+1.19.4" = _TotWJFmB;
        "pkg-1.0.2+1.20.1" = _pcmWjQUA;
        "pkg-1.0.4+1.19.2" = _cFxOAh0E;
        "pkg-1.0.4+1.18.2" = _SclekXdc;
        "pkg-1.0.4+1.19.3" = _ipFRmEkt;
        "pkg-1.0.4+1.17.1" = _GMNFVi4v;
        "pkg-1.0.4+1.19.4" = _1NpJlHH9;
        "pkg-1.0.4+1.20.1" = _R5zgquIi;
        "pkg-1.0.4-hotfix-1+1.17.1" = _IVM20Tjx;
        "pkg-1.0.4-hotfix-1+1.20.1" = _BA9fsd7j;
        "pkg-1.0.4-hotfix-1+1.19.3" = _xsCmYrQn;
        "pkg-1.0.4-hotfix-1+1.19.4" = _jCpx9czv;
        "pkg-1.0.4-hotfix-1+1.18.2" = _6kysm9so;
        "pkg-1.0.4-hotfix-1+1.19.2" = _ATQvwioJ;
        "pkg-1.1.0+1.19.2" = _8oq8qwW8;
        "pkg-1.1.0+1.18.2" = _lLdr1Ejw;
        "pkg-1.1.0+1.17.1" = _79DfHJhS;
        "pkg-1.1.0+1.19.3" = _Pgal6uSN;
        "pkg-1.1.0+1.19.4" = _bjj5HvuA;
        "pkg-1.1.0+1.20.1" = _7Hi3cN4I;
        "default" = _7Hi3cN4I;
    });
