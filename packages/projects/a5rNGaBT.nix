...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.1" = _MzngtiyE;
        "pkg-1.0.0+1.21.4" = _66sgJNch;
        "pkg-1.0.1+1.21.1" = _cz15GC26;
        "pkg-1.0.1+1.21.4" = _EQ8JITrZ;
        "pkg-1.0.2+1.21.4" = _63wlenOk;
        "pkg-1.0.2+1.21.1" = _sUGtvLG7;
        "default" = _sUGtvLG7;
    });
