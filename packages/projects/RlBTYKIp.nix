...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.20.1" = _XoiRnVmF;
        "pkg-1.0.1+1.20.4" = _Q6JSFE6c;
        "pkg-1.0.1+1.20.6" = _IqXUGLg2;
        "pkg-1.0.2+1.20.1" = _C3HGGtBF;
        "pkg-1.0.2+1.20.4" = _Mh1mSiur;
        "pkg-1.0.2+1.20.6" = _G9NAQDwI;
        "pkg-1.0.2+1.21" = _bLXjO37e;
        "pkg-1.1.0+1.20.1" = _Vw2vrDc0;
        "pkg-1.1.0+1.20.4" = _nw7VNz9L;
        "pkg-1.1.0+1.20.6" = _fL2rjueH;
        "pkg-1.1.0+1.21" = _nsNsRWlb;
        "pkg-1.2.0+1.21" = _iDgvs5yC;
        "pkg-1.2.0+1.21.2-rc1" = _TKs7N7na;
        "pkg-1.2.0+1.21.4" = _OrgDkI8K;
        "pkg-1.2.0+1.21.5" = _dRC7YhIl;
        "pkg-1.2.0+1.21.6" = _JzOCdPYW;
        "pkg-1.2.1+1.21.7" = _3kSbh5Uw;
        "pkg-1.2.2+1.21.9-rc1" = _c4g6RUk9;
        "pkg-1.2.2+1.21.11" = _dOH6U9gx;
        "pkg-1.2.2+26.1" = _y8qcCFVu;
