...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _IcBK1dvd;
        "pkg-v1.0.2-mc1.21.5" = _T5jBMtZB;
        "pkg-mc1.21.1-1.1.0" = _x5QJ23fO;
        "pkg-v1.1.1-mc1.21.1" = _1uRy2PXw;
        "pkg-v1.1.0-mc1.20.1" = _ZlR6OoBp;
        "pkg-v1.1.2-mc1.21.1" = _ABaXdoIN;
        "pkg-v1.1.1-mc1.20.1" = _HrAoVs6V;
        "pkg-v1.1.2-mc1.21.5" = _Sp9qsUyZ;
        "pkg-v1.1.3-mc1.21.5" = _YAoRsPoN;
        "pkg-v1.1.4-mc1.21.5" = _DYReCyLA;
        "pkg-v1.1.3-mc1.21.1" = _fE9qrwVD;
        "pkg-v1.1.2-mc1.20.1" = _jMpqtd54;
        "pkg-v1.1.4-mc1.21.1" = _VOuqYOBe;
        "pkg-v1.1.3-mc1.20.1" = _J9fvrkSo;
        "pkg-v1.2.0-mc1.21.1" = _OK9kaluC;
        "pkg-v1.2.0-mc1.20.1" = _6lmrsik0;
        "pkg-v1.2.1-mc1.20.1" = _NVhkGKoF;
        "pkg-v1.2.2-mc1.20.1" = _SApBWJ0e;
        "pkg-v1.2.2-mc1.21.1" = _b3o4sdbI;
        "pkg-v1.2.4-mc1.20.1" = _rUx4cmVD;
        "pkg-v1.3.0-mc1.21.1" = _dTEw59hT;
        "pkg-v1.2.5-mc1.20.1" = _HHYSLxUq;
        "pkg-v1.4.0-mc1.21.1" = _IZh1S7XY;
        "pkg-v1.4.1-mc1.21.1" = _dxRbL6Bs;
        "pkg-v1.4.2-mc1.21.1" = _xo4DDC8t;
        "default" = _xo4DDC8t;
    });
