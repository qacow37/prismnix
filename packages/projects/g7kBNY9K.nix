...
let
    ...
    in {
        ...
        "pkg-1.5.1" = _x5zrjRnS;
        "pkg-2.0_release_fabric_1.17.1" = _vAQw0aTc;
        "pkg-2.0_release_forge_1.17.1" = _wapUe52R;
        "pkg-2.0_release_fabric_1.18.1" = _Y3HKyV0b;
        "pkg-2.0_release_forge_1.18.1" = _V4J7GHwu;
        "pkg-2.0_release_fabric_1.18.2" = _ToubjF3R;
        "pkg-2.0_release_forge_1.18.2" = _y42NKcr8;
        "pkg-2.0_release_fabric_1.19" = _S8Ciw5lC;
        "pkg-2.0_release_forge_1.19" = _yRfoC7zC;
        "pkg-2.0_release_fabric_1.19.1" = _oKX2IDXe;
        "pkg-2.0_release_forge_1.19.1" = _euecfwHr;
        "pkg-2.1_release_fabric_1.17.1" = _KbKcobik;
        "pkg-2.1_release_forge_1.17.1" = _IwC0qXUd;
        "pkg-2.1_release_fabric_1.18.1" = _enxkJ6Lo;
        "pkg-2.1_release_forge_1.18.1" = _dlNPgcxq;
        "pkg-2.1_release_fabric_1.18.2" = _WlFM46Hk;
        "pkg-2.1_release_forge_1.18.2" = _3BqC3wDF;
        "pkg-2.1_release_fabric_1.19" = _IichTrhl;
        "pkg-2.1_release_forge_1.19" = _PuMfW6Qc;
        "pkg-2.1_release_fabric_1.19.1" = _785LKHi2;
        "pkg-2.1_release_forge_1.19.1" = _KJSQmLmQ;
        "pkg-2.1_release_fabric_1.19.2" = _p4zTmE7v;
        "pkg-2.1_release_forge_1.19.2" = _3tVt62Wy;
        "pkg-2.2_release_fabric_1.17.1" = _WpDRa0FL;
        "pkg-2.2_release_forge_1.17.1" = _MysoRHoj;
        "pkg-2.2_release_fabric_1.18.1" = _34a8Qo2e;
        "pkg-2.2_release_forge_1.18.1" = _KdyI5PIi;
        "pkg-2.2_release_fabric_1.18.2" = _8FcyRmAs;
        "pkg-2.2_release_forge_1.18.2" = _XIM9W3IE;
        "pkg-2.2_release_fabric_1.19" = _tXj4zpoH;
        "pkg-2.2_release_forge_1.19" = _IUWQYn0c;
        "pkg-2.2_release_fabric_1.19.1" = _hOaT3XWf;
        "pkg-2.2_release_forge_1.19.1" = _boCoYpGx;
        "pkg-2.2_release_fabric_1.19.2" = _t2Qq4v3b;
        "pkg-2.2_release_forge_1.19.2" = _FbgBo0PL;
        "pkg-2.3_release_fabric_1.19.3" = _g1SlI5SH;
        "pkg-2.3_release_forge_1.19.3" = _uZB4SB5n;
        "pkg-2.4_release_fabric_1.17.1" = _zb1WwKvm;
        "pkg-2.4_release_forge_1.17.1" = _DBQPQqaS;
        "pkg-2.4_release_fabric_1.18.1" = _xTsU8nAJ;
        "pkg-2.4_release_forge_1.18.1" = _TDcrlwKW;
        "pkg-2.4_release_fabric_1.18.2" = _xpBjpIlX;
        "pkg-2.4_release_forge_1.18.2" = _hmyBU9D5;
        "pkg-2.4_release_fabric_1.19" = _ZHCsHHl9;
        "pkg-2.4_release_forge_1.19" = _j1VMfiKs;
        "pkg-2.4_release_fabric_1.19.1" = _qWoDp2uL;
        "pkg-2.4_release_forge_1.19.1" = _gcbf0HdU;
        "pkg-2.4_release_fabric_1.19.2" = _xpcEYStj;
        "pkg-2.4_release_forge_1.19.2" = _8T80xaEr;
        "pkg-2.4_release_fabric_1.19.3" = _26urnSic;
        "pkg-2.4_release_forge_1.19.3" = _lIajMsq8;
        "pkg-2.5_release_fabric_1.17.1" = _rjF5IAX7;
        "pkg-2.5_release_forge_1.17.1" = _CZr9iv9n;
        "pkg-2.5_release_fabric_1.18.1" = _HkNpEzqb;
        "pkg-2.5_release_forge_1.18.1" = _abOyjnS9;
        "pkg-2.5_release_fabric_1.18.2" = _f0rv0jOf;
        "pkg-2.5_release_forge_1.18.2" = _IA4ARqqa;
        "pkg-2.5_release_fabric_1.19" = _5n6qkbro;
        "pkg-2.5_release_forge_1.19" = _SDLMvDPY;
        "pkg-2.5_release_fabric_1.19.1" = _c2YwwAN8;
        "pkg-2.5_release_forge_1.19.1" = _68Mo5SWt;
        "pkg-2.5_release_fabric_1.19.2" = _nufK0cLt;
        "pkg-2.5_release_forge_1.19.2" = _Qb0fjgZC;
        "pkg-2.5_release_fabric_1.19.3" = _TQvN77pW;
        "pkg-2.5_release_forge_1.19.3" = _ldCrupXm;
        "pkg-2.5_release_fabric_1.19.4" = _nGxAVxjh;
        "pkg-2.5_release_forge_1.19.4" = _Y4Q1ozXm;
        "pkg-2.5_release_fabric_1.20" = _A9lpudbi;
        "pkg-2.5_release_forge_1.20" = _SYL7Ctd0;
        "pkg-2.5_release_fabric_1.20.1" = _jXBxp5PA;
        "pkg-2.5_release_forge_1.20.1" = _ljMHFEHe;
        "pkg-2.5_release_fabric_1.20.2" = _UprffG39;
        "pkg-2.5_release_forge_1.20.2" = _OouD6Ylc;
        "pkg-2.5_release_forge_1.20.4" = _ZmNDlCDG;
        "pkg-2.5_release_fabric_1.20.4" = _XvkUZDyB;
        "pkg-2.5_release_mc1.20.6" = _ou5Qfs8K;
        "pkg-2.5" = _y1h3Jc1y;
        "pkg-2.5_release_mc1.21" = _K219aOir;
        "pkg-2.5_release_forge_1.21.3" = _eVsNoSh6;
        "pkg-2.5_release_fabric_1.21.3" = _aXFFx5cb;
        "pkg-2.5_release_forge_1.21.1" = _1H7jcMFx;
        "pkg-2.5_release_fabric_1.21.1" = _S6iuEqHc;
        "pkg-2.5.1_release_forge_1.21.1" = _vcEt3ZVN;
        "pkg-2.5.1_release_fabric_1.21.1" = _5YS6CmWG;
        "pkg-2.5.1_release_forge_1.21.4" = _dZV9OkHN;
        "pkg-2.5.1_release_fabric_1.21.4" = _WnJSGcaX;
        "pkg-2.5.2_release_forge_1.21.5" = _eewlbzAA;
        "pkg-2.5.2_release_fabric_1.21.5" = _W3fEsz9o;
        "pkg-2.5.3_release_forge_1.21.8" = _xEIqVCup;
        "pkg-2.5.3_release_fabric_1.21.8" = _OZ4cHN27;
        "pkg-2.5.3_release_forge_1.21.9" = _mFmwCyDn;
        "pkg-2.5.3_release_fabric_1.21.9" = _JvUaCIjy;
        "pkg-2.6.0" = _cxonJOZK;
        "pkg-2.6.1" = _JNy5iIEv;
        "pkg-2.6.2" = _pKzF8jbq;
        "default" = _pKzF8jbq;
