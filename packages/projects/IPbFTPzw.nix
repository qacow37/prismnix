...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.3-fabric" = _guesPBKi;
        "pkg-1.18.2-2.3-fabric" = _f32rvJ0R;
        "pkg-1.19.2-2.5-fabric" = _96ekvYbi;
        "pkg-1.16.5-1.9-forge" = _Eeo81kRR;
        "pkg-1.18.2-2.0-forge" = _MUkcEdaY;
        "pkg-1.19.2-2.2-forge" = _naAPXUOa;
        "pkg-1.16.5-2.6-fabric" = _LoC1fmTE;
        "pkg-1.18.2-2.6-fabric" = _TDijvECE;
        "pkg-1.19.2-2.6-fabric" = _9T3UhXkt;
        "pkg-1.19.3-2.7-fabric" = _vbrZwr9V;
        "pkg-1.19.3-2.2-forge" = _9UicqsnX;
        "pkg-1.18.2-3.0-forge+fabric" = _cvMCe9AK;
        "pkg-1.19.2-3.0-forge+fabric" = _XP4YmfI6;
        "pkg-1.19.3-3.0-forge+fabric" = _9Dtn5SHI;
        "pkg-1.19.4-3.0-forge+fabric" = _5nVVQBWp;
        "pkg-1.20-3.0-forge+fabric" = _yvQOMlY3;
        "pkg-1.20.1-3.0-forge+fabric" = _xWrfVEkO;
        "pkg-1.20.2-3.0-forge+fabric" = _NNJFSDMF;
        "pkg-1.18.2-3.1-forge+fabric" = _mynqZ1qw;
        "pkg-1.19.2-3.1-forge+fabric" = _tZqfMxnw;
        "pkg-1.20.1-3.1-forge+fabric" = _EyiSnJmW;
        "pkg-1.20.2-3.1-forge+fabric" = _HBKCsQlj;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _3P23p1rL;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _TeKbViPm;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _IhoFaLVE;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _EdsLeo2W;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _fM8EzEIg;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _Tr5hiicO;
        "pkg-1.19.2-3.3-fabric+forge" = _6fwHDwtN;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _UfRmfSV8;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _QJbAsOO9;
        "pkg-1.20.5-3.3-fabric+neo" = _HzqtUrNI;
        "pkg-1.20.5-3.4-fabric+neo" = _DJp6ZgiE;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _z2lLTkeI;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _qzL5rc1b;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _m0LQhD12;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _XSKBoL10;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _7NrmbMMa;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _MliIQRdw;
        "pkg-1.21.2-3.5-fabric+neo" = _QQAzT4G0;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _wZTiP26r;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _zQGhOo8g;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _2kbPf7os;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _Trgvi7lJ;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _XbCk9Xss;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _aA9sXxot;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _Iz8ZHYX4;
        "pkg-1.21.6-3.7-fabric+forge+neo" = _tY1WxGsW;
        "pkg-1.21.7-3.7-fabric+forge+neo" = _vj0KgcT6;
        "pkg-1.21.8-3.7-fabric+forge+neo" = _oCB4bww4;
        "pkg-1.21.9-3.7-fabric+forge+neo" = _FsTR4Xaf;
        "pkg-1.21.9-3.8-fabric+forge+neo" = _p0XvRsfV;
        "pkg-1.21.10-3.8-fabric+forge+neo" = _a9MOhThF;
        "pkg-1.21.11-3.8-fabric+forge+neo" = _xR3g1ZMg;
        "pkg-26.1.0-3.8-fabric+forge+neo" = _Pavh8U5Q;
        "pkg-26.1.1-3.8-fabric+forge+neo" = _frbmBSgZ;
        "pkg-26.1.2-3.8-fabric+forge+neo" = _8NtmgtVC;
        "pkg-1.20.1-3.9-fabric+forge+neo" = _559EJAYw;
        "pkg-1.21.1-3.9-fabric+forge+neo" = _1J7J02Hj;
        "pkg-1.21.11-3.9-fabric+forge+neo" = _kFwkuO98;
        "pkg-26.1.2-3.9-fabric+forge+neo" = _hH9rAN9v;
        "pkg-26.2.0-3.9-fabric+forge+neo" = _kPTvPfnL;
        "default" = _kPTvPfnL;
    });
