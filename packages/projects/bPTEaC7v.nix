...
let
    ...
    in {
        ...
        "pkg-0.7.6" = _yhmlgWgw;
        "pkg-0.8.7" = _yjGgcDMS;
        "pkg-0.6.12" = _mRqjB7mW;
        "pkg-0.6.13" = _PBsZAKI0;
        "pkg-0.7.7" = _53ccpgYl;
        "pkg-0.8.8" = _mdvOtwJ8;
        "pkg-0.9.6" = _Y7eSkwYt;
        "pkg-0.9.7" = _kedp5znJ;
        ...
        "pkg-0.9.8" = _5yCkpoik;
        "pkg-0.9.9" = _DLxEqHaq;
        "pkg-0.9.10" = _wkpSlbui;
        "pkg-0.6.14" = _3JiYyaQP;
        "pkg-0.7.9" = _cKvjP7JK;
        "pkg-0.8.10" = _GAmkHUbH;
        "pkg-0.10.0" = _bKB7Q2zQ;
        "pkg-0.10.1" = _JgKv6AzP;
        "pkg-0.9.11" = _dOjbYP0P;
        "pkg-0.10.2" = _IwyQFQea;
        "pkg-0.11.0" = _beXwKb5m;
        "pkg-0.11.1" = _NIfzEzea;
        "pkg-0.11.2" = _IJEpXTZF;
        "pkg-0.11.3" = _80siyCUA;
        "pkg-0.11.4" = _fwLnLb60;
        "pkg-0.11.5" = _tsc54Htx;
        "pkg-0.11.6" = _Lv1nlaOi;
        "pkg-0.11.7" = _Xr3mfEwb;
        "pkg-0.9.12" = _unBrj1OZ;
        "pkg-0.11.8" = _RxJZDzVq;
        "pkg-0.11.9" = _SUhaPDqU;
        "pkg-0.11.10" = _IG3quFpo;
        "pkg-0.11.11" = _ESzJuIKq;
        "pkg-0.12.0" = _AiaXvWtJ;
        "pkg-0.12.1" = _sUKomHIv;
        "pkg-0.13.0" = _fQimmjXb;
        "pkg-0.14.0" = _b7zhVrZ0;
        "pkg-0.14.1" = _dN2ScRAo;
        "pkg-0.14.2" = _Nf39sNa5;
        "pkg-0.13.1" = _aBcVpZNc;
        "pkg-0.14.3" = _UMv8dRfG;
        "pkg-0.12.2" = _QxFPG2cB;
        "pkg-0.15.0" = _Qraz9Eud;
        "pkg-0.16.0" = _19ZuyxQB;
        "pkg-0.11.12" = _1Bcz0w79;
        "pkg-0.16.1" = _4Svqwbjx;
        "pkg-0.17.0" = _yR73Nyxf;
        "pkg-0.17.1" = _IAW9NH6M;
        "default" = _IAW9NH6M;
    });
