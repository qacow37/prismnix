...
let
    ...
    in {
        ...
        "pkg-3.0.0+1.14.4" = _Y2m0phqJ;
        "pkg-3.0.0+1.15.2" = _djNq1T0j;
        "pkg-3.0.0+1.16.5" = _3Tsi3Roh;
        "pkg-4.0.0+1.14.4" = _TpVDpHfA;
        "pkg-4.0.0+1.15.2" = _7T5w1xiY;
        "pkg-4.0.0+1.16.5" = _eCvc9FBn;
        "pkg-4.1.0+1.14.4" = _tMwUS1rM;
        "pkg-4.1.0+1.15.2" = _KoRX0CM2;
        "pkg-4.1.0+1.16.5" = _Vse0N2Ff;
        "pkg-5.0.0+1.14.4" = _CrVRS9ym;
        "pkg-5.0.0+1.15.2" = _xorRk9b7;
        "pkg-5.0.0+1.16.5" = _GlH1O9iR;
        "pkg-5.0.0+1.17.1" = _lFjLjPSQ;
        "pkg-5.0.1+1.14.4" = _mk0ZrLwD;
        "pkg-5.0.1+1.15.2" = _NPBNQQdA;
        "pkg-5.0.1+1.16.5" = _D503nSRj;
        "pkg-5.0.1+1.17.1" = _ZSry9BS5;
        "pkg-5.1.0+1.14.4" = _S4L44P2k;
        "pkg-5.1.0+1.15.2" = _fw9O1hdi;
        "pkg-5.1.0+1.16.5" = _c25OwN8t;
        "pkg-5.1.0+1.17.1" = _84X27Jhn;
        "pkg-5.1.1+1.18" = _5wOWM3aS;
        "pkg-6.0.0+1.15.2-fabric" = _xLntGKBe;
        "pkg-6.0.0+1.16.5-fabric" = _XIJlAevI;
        "pkg-6.0.0+1.17.1-fabric" = _p9H0wK2I;
        "pkg-6.0.0+1.17.1" = _KcqPBYvj;
        "pkg-6.0.0+1.18.2-fabric" = _IQY1C8F3;
        "pkg-6.0.0+1.18.2" = _7SlmFhlv;
        "pkg-6.0.0+1.19-fabric" = _7X4Ar4CB;
        "pkg-6.0.0+1.19" = _ONIOLQnV;
        "pkg-6.0.1+1.19-fabric" = _WAhOYEkK;
        "pkg-6.0.1+1.19" = _tEpeg8xy;
        "default" = _tEpeg8xy;
    });
