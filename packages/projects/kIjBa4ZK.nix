...
let
    ...
    in {
        ...
        "pkg-1.0.0-mc1.20.1-fabric" = _EIF9lqKt;
        "pkg-1.0.0-mc1.20.2-fabric" = _m9qz9Dtt;
        "pkg-1.0.1-mc1.20.2-fabric" = _lA0B95Gs;
        "pkg-1.0.1-mc1.20.1-fabric" = _3L1DIfRO;
        "pkg-1.0.2-mc1.20.4-fabric" = _KsXesV8y;
        "pkg-1.0.3-mc1.20.5-fabric" = _EAbX3OnS;
        "pkg-1.0.3-mc1.20.6-fabric" = _ly33zj0X;
        "pkg-1.1.0-mc1.21-fabric-pre1" = _kfbq5ql1;
        "pkg-2.0.0-pre1+mc1.21+neoforge" = _6Zjkn6rH;
        "pkg-2.0.0-pre2+mc1.21+fabric" = _QdhhxNYe;
        "pkg-2.0.0-pre3+mc1.21+neoforge" = _H8F8Rw0s;
        "pkg-2.0.0-pre3+mc1.21+fabric" = _eHUbnOOp;
        "pkg-2.0.0-pre5+mc1.21+fabric" = _FV4EJ4gv;
        "pkg-2.0.0-pre5+mc1.21+neoforge" = _LYtgEEN3;
        "pkg-2.0.0+mc1.21+neoforge" = _g50tUCg9;
        "pkg-2.0.0+mc1.21+fabric" = _Rm2P4aZd;
        "pkg-2.0.1+mc1.21+neoforge" = _fj02Josv;
        "pkg-2.0.1+mc1.21+fabric" = _X1ER2HJi;
        "pkg-2.0.2+mc1.21+neoforge" = _SXH1xH0N;
        "pkg-2.0.2+mc1.21+fabric" = _4yK9HTGT;
        "pkg-2.0.3+mc1.21+neoforge" = _HACsMJHs;
        "pkg-2.0.3+mc1.21+fabric" = _4MjUUPD2;
        "pkg-2.1.0+mc1.21+neoforge" = _cCVrWV3f;
        "pkg-2.1.0+mc1.21+fabric" = _PBDWmC6w;
        "pkg-2.1.1+mc1.21.1+neoforge" = _rVrBsquR;
        "pkg-2.1.1+mc1.21.1+fabric" = _qegYfaY8;
        "default" = _qegYfaY8;
    });
