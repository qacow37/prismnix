...
let
    ...
    in {
        ...
        "pkg-0.2.0+fabric-1.21" = _c8VUQtYs;
        "pkg-0.3.0+fabric-1.21" = _d5tPOVnM;
        "pkg-0.3.1+fabric-1.20" = _LFIq7ccQ;
        "pkg-0.3.1+forge-1.20" = _nXA182ZT;
        "pkg-0.3.1+neo-1.21" = _R20b40le;
        "pkg-0.3.2+fabric-1.20" = _OWf31i6A;
        "pkg-0.3.2+forge-1.20" = _x0nL4Thi;
        "pkg-0.3.2-cloth+fabric-1.16" = _adCKjC4q;
        "pkg-0.3.3-cloth+fabric-1.16" = _fjAChf8J;
        "pkg-0.3.3+fabric-1.20" = _17CKhwqV;
        "pkg-0.3.3-cloth+forge-1.16" = _IuM4TlXw;
        "pkg-0.3.3-cloth+forge-1.18" = _U4c4kKgD;
        "pkg-0.3.3-cloth+forge-1.19" = _zbAKMeDu;
        "pkg-0.3.3+forge-1.20" = _4t7EOv0h;
        "pkg-0.3.3+neo-1.21" = _yHGo6VsD;
        "pkg-0.4.0+fabric-1.20" = _krATUE3O;
        "pkg-0.4.0+forge-1.20" = _waVFr5fX;
        "pkg-0.4.0+neo-1.21" = _hvwcX4UF;
        "pkg-0.4.0-cloth+fabric-1.16" = _k8u6AZVM;
        "pkg-0.4.0-cloth+forge-1.16" = _T7CTmlbq;
        "pkg-0.4.0-cloth+forge-1.18" = _qwFP1cKS;
        "pkg-0.4.0-cloth+forge-1.19" = _C6vwx829;
        "pkg-0.4.1+fabric-1.20" = _HhfnomCg;
        "pkg-0.4.1+forge-1.20" = _ovT7XMOW;
        "pkg-0.4.1+neo-1.21" = _nfqfeKsL;
        "pkg-0.4.1+fabric-26.1" = _Jvu612ei;
        "default" = _Jvu612ei;
    });
