...
let
    ...
    in {
        ...
        "pkg-1.0" = _jN633UNm;
        "pkg-1.0+mod" = _nPqdvUuO;
        "pkg-1.1" = _5CUKdcOd;
        "pkg-1.1+mod" = _CxxuILIB;
        "pkg-1.1.1" = _zxb1aoJD;
        "pkg-1.1.1+mod" = _6tbTdqMl;
        "pkg-1.1.2" = _78ErWhCA;
        "pkg-1.1.2+mod" = _fhfDjaWu;
        "pkg-1.1.3" = _CJfWBmUQ;
        "pkg-1.1.3+mod" = _LHzy10yq;
        "pkg-1.2" = _980OK7MM;
        "pkg-1.2+mod" = _NogcW19q;
        "pkg-1.2.1" = _mLQTHzas;
        "pkg-1.2.1+mod" = _qCNc0oDx;
        "pkg-1.2.1.1" = _4EUY2j5V;
        "pkg-1.2.1.1+mod" = _JALoW2WA;
        "pkg-1.2.2" = _LdWMi2CS;
        "pkg-1.2.2+mod" = _XBVYcxfn;
        "pkg-1.2.2.1" = _KXfsElwu;
        "pkg-1.2.2.1+mod" = _LN2BbAhu;
        "pkg-1.2.3" = _vN01vaAE;
        "pkg-1.2.3+mod" = _6LJNMGvg;
        "pkg-1.3" = _Hg74A3ci;
        "pkg-1.3+mod" = _Vg0B2M1p;
        "pkg-1.3.1" = _pJtAWag7;
        "pkg-1.3.1+mod" = _PyfET0rJ;
        "pkg-1.3.1.1" = _rUUSUcgb;
        "pkg-1.3.1.1+mod" = _yOOSygKJ;
        "pkg-1.3.2" = _INZl4sWn;
        "pkg-1.3.2+mod" = _WXKS9c3V;
        "pkg-1.4" = _IHtFwn30;
        "pkg-1.4+mod" = _BAx4sHnA;
        "pkg-1.4.1" = _z699oQwj;
        "pkg-1.4.1+mod" = _aTADS24D;
        "pkg-1.4.2" = _dnk5ULgH;
        "pkg-1.4.2+mod" = _AZbFlMU3;
        "pkg-1.4.2.1" = _ezAOYiIG;
        "pkg-1.4.2.1+mod" = _ncIyIyLP;
        "pkg-1.4.3" = _bcCDQuJJ;
        "pkg-1.4.3+mod" = _D4zwSHjc;
        "pkg-1.4.3.1" = _hzp9UVeH;
        "pkg-1.4.3.1+mod" = _RZ4LrIs5;
        "default" = _RZ4LrIs5;
    });
