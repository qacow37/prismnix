...
let
    ...
    in {
        ...
        "pkg-1.0+1.20.3" = _HySZMrup;
        "pkg-1.0+1.20.4" = _VaqjWdKL;
        "pkg-1.1+1.20" = _AYOHdRII;
        "pkg-1.1+1.20.1" = _egE6h0sR;
        "pkg-1.1+1.20.2" = _rN7xR5bU;
        "pkg-1.1+1.20.3" = _TwsPE49k;
        "pkg-1.1+1.20.4" = _gVObxO1n;
        "pkg-1.1+1.20.5" = _ZOM2Lxou;
        "pkg-1.1+1.20.6" = _ZLZmt2Fp;
        "pkg-1.1+1.21" = _Bw4Yd2Ze;
        "pkg-1.1+1.21.1" = _akWFhhqA;
        "pkg-1.2+1.20" = _sDmGL71X;
        "pkg-1.2+1.20.2" = _pSJpJKTi;
        "pkg-1.2+1.20.3" = _lG99E5mF;
        "pkg-1.2+1.20.5" = _uakEkcah;
        "pkg-1.2+1.21" = _kujicsVy;
        "pkg-1.2+1.21.2" = _P1K0KsD7;
        "pkg-1.2+1.21.4" = _NvGCnt7Z;
        "pkg-1.3" = _dWKin3cA;
        "pkg-1.4" = _R784b6ei;
        "pkg-1.5" = _GhzZ6xJ9;
        "pkg-1.6" = _kBmQzpqG;
