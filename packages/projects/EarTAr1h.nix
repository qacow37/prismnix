...
let
    ...
    in {
        ...
        "pkg-flying_castles_1.14.4_empty_1" = _wohmgbFG;
        "pkg-flying_castles_1.15.2_empty_1" = _bQWaVVXG;
        "pkg-flying_castles_1.16.4_empty_1" = _nYrT12Gz;
        "pkg-flying_castles_1.16.5_empty_1" = _LhX4AkaX;
        "pkg-flying_castles_1.14.4_village_1" = _zj1JYW6a;
        "pkg-flying_castles_1.15.2_village_1" = _7IIMLh3e;
        "pkg-flying_castles_1.16.4_village_1" = _hedMmuPF;
        "pkg-flying_castles_1.16.5_village_1" = _FaemR47R;
        "pkg-flying_castles_1.14.4_knight_1" = _MpFg0Wmm;
        "pkg-flying_castles_1.15.2_knight_1" = _f7w7a0Pu;
        "pkg-flying_castles_1.16.4_knight_1" = _4Cday8bu;
        "pkg-flying_castles_1.16.5_knight_1" = _hNyo1yJH;
        "pkg-flying_castles_knight_1.16.5_knight_2" = _TzGAIgwX;
        "pkg-flying_castles_1.16.5_knight_3" = _yFuWXDQL;
        "pkg-flying_castles_1.16.5_empty_2" = _I5Opdaem;
        "pkg-flying_castles_1.16.5_village_2" = _UujMZkhG;
        "pkg-flying_castles_1.16.5_knight_4" = _JFa4cXks;
        "pkg-flying_castles_1.16.5_knights_5." = _R8uw9jyD;
        "pkg-flying_castles_1.16.5_knights_5.1" = _pt5KZuvP;
        "pkg-flying_castles_1.16.5_knights_6.0" = _1Oa2t5Ga;
        "pkg-flying_castles_1.17.1_knight_6.0" = _eRsJHwwD;
        "pkg-flying_castles_1.17.1_knight_7.0" = _PiTtmDfp;
        "pkg-flying_castles_1.18.2_knight_7.0" = _sVANerKS;
        "pkg-flying_castles_1.19.2_knight_7.0" = _OGFKSPiy;
        "pkg-7.1" = _UcilpM46;
        "pkg-7.2.0" = _bM91DvX4;
        "pkg-8.0.0" = _RUlSEANC;
        "pkg-8.1.0" = _PIyMCWxY;
