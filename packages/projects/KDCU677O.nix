...
let
    ...
    in {
        ...
        "pkg-2.1.25" = _ty4FMxjw;
        "pkg-2.1.28" = _p0p8IHrK;
        "pkg-2.1.32" = _opfU2oiz;
        "pkg-2.1.34" = _YPHbCDjj;
        "pkg-2.1.37" = _jq6DPBmF;
        "pkg-1.19.2-3.0.4" = _4TAgveSQ;
        "pkg-2.1.38" = _8Mj9Pl6I;
        "pkg-1.19.2-3.0.9" = _kSgXEaHW;
        "pkg-1.20.1-3.1.3" = _MRNl4f3E;
        "pkg-3.1.3" = _QpujeFj1;
        "pkg-3.1.5" = _SFA8F2kO;
        "pkg-3.1.6" = _vQ9Okb0B;
        "pkg-3.1.7" = _57SYZ29a;
        ...
        "pkg-3.2.5" = _pqlQBEvI;
        "pkg-3.2.6" = _TsZi2iy3;
        "pkg-3.2.11" = _gy8RxJw2;
        "pkg-3.2.14" = _syQ0Ldyb;
        "default" = _syQ0Ldyb;
    });
