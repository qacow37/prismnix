...
let
    ...
    in {
        ...
        "pkg-0.2.7" = _RCMkApoB;
        "pkg-0.2.8" = _9R116eJm;
        "pkg-0.2.8.1" = _u3MIhW9j;
        "pkg-0.2.9" = _7nKOfPCz;
        "pkg-0.3.0" = _ZgMYlcqW;
        "pkg-0.3.0.1" = _KhoTjlFQ;
        "pkg-0.3.0.2" = _fa9mLTAt;
        "pkg-0.3.1" = _D6Euqi1A;
        "pkg-0.3.1.1" = _dnfNGGg9;
        "pkg-0.3.2" = _TC7l6vyk;
        "pkg-0.3.2.1" = _q2O1lYA4;
        "pkg-0.3.3" = _hGbtuw8R;
        "pkg-0.3.3.1" = _4ZBBOh7T;
        "pkg-0.3.3.2" = _mqODqECr;
        "pkg-0.3.3.3" = _AejzhVDP;
        "pkg-0.3.4" = _d98IGeBm;
        "pkg-0.3.4.1" = _VtY38cwQ;
        "pkg-0.3.4.2" = _fMuVfYlk;
        "pkg-0.3.5" = _PXgL8QQX;
        "pkg-0.3.5.1" = _p57ZyZ41;
        "pkg-0.3.5.2" = _YBY4OniE;
        "pkg-0.3.5.3" = _Ok23uW0S;
        "default" = _Ok23uW0S;
    });
