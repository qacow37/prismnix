...
let
    ...
    in {
        ...
        "pkg-0.1.0+mc1.21.0" = _1dnldrMB;
        "pkg-0.1.1+mc1.21.0" = _wQE7HhUR;
        "pkg-0.2.0+mc1.21.0" = _hRCtU1NM;
        "pkg-0.2.0+mc1.20.1" = _QWPBcPJE;
        "pkg-0.2.0+mc1.21.2" = _pZBLbZJ5;
        "pkg-0.2.0+mc1.20.2" = _YjznDhJM;
        "pkg-0.3.0+mc1.21.0" = _UMBxRU06;
        "pkg-0.3.0+mc1.21.2" = _hAkqNsBy;
        "pkg-0.2.1+mc1.20.2" = _IIfkMysj;
        "pkg-0.3.0+mc1.21.5" = _kXxQrxIV;
        "pkg-0.2.2+mc1.20.1" = _rY3TgUsG;
        "pkg-0.3.1+mc1.21.0" = _NjAu5sv2;
        "pkg-0.3.1+mc1.21.5" = _VxC8ZLhD;
        "pkg-0.3.2+mc1.21.0" = _ek4daUs3;
        "pkg-0.3.2+mc1.21.5" = _2GeMraV0;
        "pkg-0.2.3+mc1.20.1" = _9Rt1WVxq;
        "pkg-0.3.3+mc1.21.5" = _Q3w7Bunz;
        "pkg-0.4.0+mc1.21.11" = _E1NvyDcD;
        "pkg-0.4.1+mc1.21.11" = _UvE5zVv5;
        "pkg-0.4.2+mc1.21.11" = _KMPriwMR;
        "pkg-0.4.2+mc26.1" = _zqQ6NNem;
        "pkg-0.4.2+mc26.2" = _jUUjr5rX;
        "default" = _jUUjr5rX;
    });
