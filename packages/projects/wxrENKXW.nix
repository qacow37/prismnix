...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _lTnDZmxr;
        "pkg-1.0.9" = _9jFq4wv3;
        "pkg-1.0.10" = _n6jqvfdx;
        "pkg-1.0.11" = _2SSjTc6K;
        "pkg-1.0.12" = _NsafQDp9;
        "pkg-1.0.13" = _bAyvZpC1;
        "pkg-1.0.14" = _g7z0MR6V;
        "pkg-1.0.15" = _P6fBjYh7;
        "pkg-1.0.16" = _QXjABS61;
        "pkg-1.0.17" = _Gc5eFzuj;
        "pkg-1.0.18" = _DEcBlqYN;
        "pkg-1.0.19" = _jVN8ExSN;
        "pkg-1.0.20" = _mknRO6By;
        "pkg-1.0.21" = _GEQ89oIU;
        "pkg-1.0.22" = _HyQMgHaR;
        "pkg-1.0.23" = _mjP7HSx9;
        "pkg-1.0.25" = _UdzzdNPo;
        "pkg-1.0.26" = _W95r5byH;
        "pkg-1.0.27" = _5My0XvGD;
        "pkg-1.0.28" = _SH6g2YO3;
        "pkg-1.0.29" = _dHayR8Pz;
        "pkg-1.0.30" = _sPiVB9LS;
        "pkg-1.0.31" = _L7muzWEr;
        "pkg-1.0.32" = _heBl3hSv;
        "pkg-1.0.33" = _mskkj5oj;
        "pkg-1.0.34" = _Q5adl5ft;
        "pkg-1.0.35" = _WHyjDi2t;
        "pkg-1.0.36" = _ov7TfEbz;
        "pkg-1.0.37" = _mvcPPVkj;
        "pkg-1.0.38" = _NWn5BeGL;
        "pkg-1.0.39" = _XKUU9wWR;
        "pkg-1.0.40" = _GeVKWVKN;
        "pkg-1.0.41" = _8JhgDS2b;
        "default" = _8JhgDS2b;
    });
