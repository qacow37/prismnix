...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.1" = _qwEXrGnw;
        "pkg-1.0.1+1.20.1" = _sYoIMksK;
        "pkg-1.1+1.20.1" = _8beT1wzX;
        "pkg-1.1+1.21.1" = _4gsIlhiM;
        "pkg-1.2.0+1.21.1" = _GxzEXtxS;
        "pkg-1.2.0+1.20.1" = _EIfuv6vH;
        "pkg-1.3.0+1.20.1" = _iAjaK69M;
        "pkg-1.3.0+1.21.1" = _A8aYqXQw;
        "pkg-1.4.0+1.21.1" = _xGULy1zW;
        "pkg-1.4.0+1.20.1" = _t2sj8dLv;
        "pkg-1.4.1+1.20.1" = _iawoAI8d;
        "pkg-1.4.1+1.21.1" = _Dw9Z24P8;
        "pkg-1.5.0+1.20.1" = _JV20wBB2;
        "pkg-1.5.1+1.21.1" = _66ZrKTIm;
        "pkg-1.5.1+1.20.1" = _363tdgy3;
        "pkg-1.5.2+1.20.1" = _n2tDzs0Q;
        "pkg-1.5.2+1.21.1" = _9klHIr7R;
        "pkg-1.6.0+1.20.1" = _pAiUmrn0;
        "pkg-1.6.0+1.21.1" = _aCCRJhge;
        "pkg-1.6.1+1.20.1" = _BeQkE4E2;
        "pkg-1.6.1+1.21.1" = _50zGALmq;
        "pkg-1.6.2+1.20.1" = _ps5us3nj;
        "pkg-1.6.2+1.21.1" = _EWtsnxjI;
        "pkg-1.6.3+1.20.1" = _sH7O0giM;
        "pkg-1.6.3+1.21.1" = _6tHF0yCl;
        "default" = _6tHF0yCl;
    });
