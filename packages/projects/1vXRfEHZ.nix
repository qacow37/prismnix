...
let
    ...
    in {
        ...
        "pkg-0.3.0" = _4GWGvUQd;
        "pkg-0.4.0" = _TNJtd0dN;
        "pkg-1.21.1-0.4.0" = _QzGUwXdv;
        "pkg-1.21.1-0.4.1" = _mNK8lcQW;
        "pkg-1.21.1-0.4.2" = _JWWeDb16;
        "pkg-1.21.1-0.4.3" = _6awp7AS8;
        "pkg-1.20.1-0.4.1" = _25DetJQT;
        "pkg-1.21.1-0.4.4" = _bvag7OZ6;
        "pkg-1.20.1-0.5.0" = _YQO7dCSQ;
        "pkg-1.20.1-0.5.1" = _oLZzxwC2;
        "pkg-1.20.1-0.5.2" = _etTPTgaq;
        "pkg-1.21.1-0.5.0" = _IXooWk94;
        "pkg-1.21.1-0.5.1" = _oEvll7A7;
        "pkg-1.20.1-0.5.3" = _sPUE6s5X;
        "pkg-1.21.1-0.5.2" = _QgKuORKu;
        "pkg-1.20.1-0.5.4-4" = _TbRbq1Q8;
        "pkg-1.21.1-0.5.3" = _cMrltBDO;
        "pkg-1.20.1-0.5.5" = _iVETuh9w;
        "pkg-1.21.1-0.5.4" = _uGBybZDd;
        "pkg-1.21.1-0.5.5" = _sq6Cb1lc;
        "pkg-1.20.1-0.6.0-Beta-01" = _K7dO8dHY;
        "pkg-1.21.1-0.6.0-Beta-01" = _ytp3xVTx;
        "pkg-1.20.1-0.6.0-Beta-02" = _ay9v5nCo;
        "pkg-1.21.1-0.6.0-Beta-02" = _qWQqMG6l;
        "pkg-1.20.1-0.6.0-Beta-03" = _gEbAZ6ga;
        "pkg-1.21.1-0.6.0-Beta-03" = _asvFQAYD;
        "pkg-1.20.1-0.6.0" = _b6GphAQ9;
        "pkg-1.21.1-0.6.0" = _aXkvlA4D;
        "pkg-1.21.1-0.6.1" = _6P3PpA6f;
        "pkg-1.20.1-0.6.1" = _5KlbqQtT;
        "pkg-1.21.1-0.7.0" = _AXLWkdx1;
        "pkg-1.21.1-0.7.1" = _DlHvAXY8;
        "pkg-1.21.1-0.7.2" = _Qgx95FcJ;
        "pkg-1.21.1-0.7.3" = _p6cqlruu;
        "pkg-1.21.1-0.7.4" = _vrSxdmxm;
