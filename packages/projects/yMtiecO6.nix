...
let
    ...
    in {
        ...
        "pkg-0.0.2.5" = _yDL2uw3P;
        "pkg-0.0.2.6" = _rQLzaW8O;
        "pkg-0.0.2.7" = _UFbF5Ue6;
        "pkg-0.0.2.8" = _38sUgLiF;
        "pkg-0.0.2.8.5" = _UR43dRmL;
        "pkg-0.0.2.9" = _kMVx6vQD;
        "pkg-0.0.5.0" = _x3UfbgwX;
        "pkg-0.0.5.1" = _sAlPvM7i;
        "pkg-0.0.5.2.1" = _1vVDC1ft;
        "pkg-0.0.5.3" = _bFwUYVzG;
        "pkg-0.1.0.0" = _r0tqNAlQ;
        "pkg-0.1.0.1" = _SE7OTwhY;
        "pkg-0.1.1.0" = _1UJ8Y9LV;
        "pkg-0.1.2.0" = _dEAzmRyD;
        "pkg-0.1.3.0" = _OcH8dMDJ;
        "pkg-0.1.3.1" = _6680R1Pe;
        "pkg-0.1.3.2" = _jgbLb2dH;
        "pkg-0.1.3.3" = _Xfj4rDmO;
        "pkg-0.1.3.3.2" = _jQtIGXZg;
        "pkg-0.1.3.4" = _E9bTIo3P;
        "pkg-0.1.3.5.1" = _HjEOmfUu;
        "pkg-0.1.5.0" = _pdhiBzcG;
        "pkg-0.1.5.5" = _EfYNo10y;
        "pkg-0.1.6.0" = _NYVaoExH;
        "pkg-0.1.6.1" = _gk4WJuBV;
        "pkg-0.1.6.3" = _stw5xi3V;
        "pkg-0.1.6.4" = _RoUVxmcA;
        "pkg-0.1.6.4.2" = _bwVmVu78;
        "pkg-0.1.6.5-hothix" = _LidAUorb;
