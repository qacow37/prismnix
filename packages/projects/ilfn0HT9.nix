...
let
    ...
    in {
        ...
        "pkg-1.5.1" = _MMg4UMVV;
        "pkg-1.5.2" = _S7vGoW82;
        "pkg-2.0.0+fabric" = _ztdoEyb0;
        "pkg-2.0.0+forge" = _nozD8TZC;
        "pkg-2.0.1+fabric" = _g4qHijy7;
        "pkg-2.0.1+forge" = _V5zi6eZY;
        "pkg-2.0.0b" = _oQjSp4xc;
        "pkg-2.0.1b" = _egOFDeSM;
        "pkg-2.0.1c" = _a13eN36t;
        "pkg-2.0.0c" = _fVuhfGuV;
        "pkg-2.1.0+1.19.2" = _u3VNgz9V;
        "pkg-2.1.0+1.19.3" = _GCxmT7ly;
        "pkg-2.2.0+1.19.2" = _GLEeX6Ij;
        "pkg-2.2.0+1.19.3" = _yOppsMBr;
        "pkg-2.2.1+1.19.2" = _kox7o8Gm;
        "pkg-2.2.1+1.19.3" = _FWLiFOD1;
        "pkg-2.2.2+1.19.2" = _cIKqnzTO;
        "pkg-2.2.2+1.19.3" = _v1lms7PP;
        "pkg-2.2.2+1.17.1" = _Lv7mDcmS;
        "pkg-2.2.2+1.18.2" = _3ewE3IfP;
        "pkg-2.2.2b+1.17.1" = _WH5kIc7D;
        "pkg-v2.3.0+1.19.3" = _LpXgQzKX;
        "pkg-v2.3.0+1.19.2" = _NqfFlp5X;
        "pkg-v2.3.0+1.18.2" = _8c4MgosT;
        "pkg-v2.3.0+1.17.1" = _KZ09WAnQ;
        "pkg-v2.3.1+1.18.2" = _vlkNYhgC;
        "pkg-v2.3.1+1.17.1" = _eIVnXZFP;
        "pkg-v2.3.1+1.19.2" = _FbA3ha97;
        "pkg-v2.3.1+1.19.3" = _8sW9A3eU;
        "pkg-v2.3.1+1.20" = _QbaWta05;
        "pkg-v2.3.2+1.20" = _kci0a7lY;
        "default" = _kci0a7lY;
    });
