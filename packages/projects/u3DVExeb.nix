...
let
    ...
    in {
        ...
        "pkg-1.21" = _WlYEdRCv;
        "pkg-1.21+mod" = _zP6nOw0b;
        "pkg-1.21.1" = _hD16cEWC;
        "pkg-1.21.1+mod" = _VSO37MO6;
        "pkg-1.21.2" = _wajMFP78;
        "pkg-1.21.2+mod" = _yGUbI1Cl;
        "pkg-1.21.3" = _nEvyoKiQ;
        "pkg-1.21.3+mod" = _Pr7X4glM;
        "pkg-1.21.4" = _ydEuQQhm;
        "pkg-1.21.4+mod" = _WZFHttVe;
        "pkg-1.21.5" = _Zh9Vn1q5;
        "pkg-1.21.5+mod" = _ACiKk04P;
        "pkg-1.21.6" = _gTP6xMdG;
        "pkg-1.21.6+mod" = _AMdS3bqv;
        "pkg-1.21.7" = _SnKBnaZX;
        "pkg-1.21.7+mod" = _Dv6KV5vS;
        "pkg-1.21.8" = _2oJgy3u7;
        "pkg-1.21.8+mod" = _FxPjLR6z;
        "pkg-1.21.9" = _acxZcHHs;
        "pkg-1.21.9+mod" = _jmt9ntwG;
        "pkg-1.21-Plus" = _bsKvIZFi;
        "pkg-1.21-Plus+mod" = _CXUmhAs3;
        "default" = _CXUmhAs3;
    });
