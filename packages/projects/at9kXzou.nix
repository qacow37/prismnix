...
let
    ...
    in {
        ...
        "pkg-v.1.1.0" = _GgMHBA86;
        "pkg-v.1.9.0" = _9qOTkSRz;
        "pkg-v.1.9.2" = _xkHfIpe3;
        "pkg-v.1.9.3" = _NQIAaRbW;
        "pkg-v.1.9.4" = _lyYURwrO;
        "pkg-v.1.10.0" = _ulTg79ql;
        "pkg-v.1.9.5" = _pF9Vdlka;
        "pkg-v.1.10.1" = _McAdPp2C;
        "pkg-v.2.0.0" = _Zr8R1ULq;
        "pkg-v.1.9.0a" = _E6M7eDQf;
        "pkg-v.2.0.1" = _EQVD0e55;
        "pkg-v.2.1.0" = _MiEmvelj;
        "pkg-v.2.1.1" = _bLVmNNmW;
        "pkg-v.2.1.2" = _EvqIXl3w;
        "pkg-v.3.0.0" = _WpRFnzCW;
        "pkg-v.3.1.0" = _4xDgEdSK;
        "pkg-v.2.1.3" = _Dfrg2noI;
        "pkg-v.3.2.0" = _IqUrYWf2;
        "pkg-v.3.3.0" = _z3zoNT5C;
        "pkg-v.3.4.0" = _tEwNHVSf;
        "pkg-v.2.1.1b" = _rkp91Mnv;
        "pkg-v.2.2.0" = _VmuIOf4i;
        "pkg-v.3.5.0" = _cP0m1ZBo;
        "pkg-v.3.6.0" = _svWn5GAw;
        "pkg-v.3.7.0" = _tIvhDchs;
        "pkg-v.3.8.0" = _M1OHzCrh;
        "pkg-v.3.8.1" = _QfdP1BpL;
        "pkg-v.3.8.2" = _hTfPNdFe;
        "pkg-v.3.8.3" = _lECthwCo;
        "pkg-v.3.8.4" = _f98OKHYL;
        "pkg-v.2.3.0" = _T9QST8KN;
        "pkg-v.2.3.1" = _GQG2clMp;
        "pkg-v.3.8.5" = _18PWfcvJ;
        "pkg-v.3.8.6" = _5fi5iAX8;
        "pkg-v.3.8.7" = _543AG9S4;
        "pkg-v.3.9.0" = _dSDg5s2x;
        "pkg-v.3.9.1" = _1IfRn5Yp;
        "pkg-v.2.3.2" = _XGjw2gVg;
        "pkg-v.2.3.3" = _9tVJOeah;
        "default" = _9tVJOeah;
    });
