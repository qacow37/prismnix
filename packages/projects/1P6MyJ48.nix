...
let
    ...
    in {
        ...
        "pkg-1.20.x-1.0.0" = _f0TkbCqn;
        "pkg-1.20.6-1.1.1" = _jGEmGLYC;
        "pkg-1.20.6-1.1.2" = _9GX9opic;
        "pkg-1.21-1.1.2" = _V623WENx;
        "pkg-1.21-1.1.3" = _J5JGqRIh;
        "pkg-1.21-1.1.4" = _oN0AfQhD;
        "pkg-1.21-1.2.0" = _kV9tYFac;
        "pkg-1.21-1.2.1" = _GyqFvYBr;
        "pkg-1.21.3-1.2.2" = _1pgfP8JD;
        "pkg-1.21.4-1.2.3" = _1uPcTAQU;
        "pkg-1.21.4-1.2.4" = _MJlSwIWs;
        "pkg-1.21.5-1.3" = _NdvXNxvq;
        "pkg-1.21.6-1.3" = _m8UU8xOS;
        "pkg-1.21.7-1.3" = _HUeIRlwF;
        "pkg-1.21.7-1.4.0" = _ISzBs6lZ;
        "pkg-1.21.6-1.4.0" = _MxmqlknR;
        "pkg-1.21.6-1.4.1" = _2YrF3BMQ;
        "pkg-1.21.7-1.4.1" = _7rqAdie1;
        "pkg-1.21.7-1.4.2" = _gzYAouof;
        "pkg-1.21.6-1.4.2" = _yWVWbj6l;
        "pkg-1.21.8-1.4.2" = _1M1u37DQ;
        "pkg-1.21.8-1.4.3" = _hhBaVgnB;
        "pkg-1.21.8-1.4.4" = _Juwrw99u;
        "pkg-1.21.10-1.4.5" = _GgWmvE88;
        "pkg-1.21.11-1.4.5" = _Zjm2yyH3;
        "default" = _Zjm2yyH3;
    });
