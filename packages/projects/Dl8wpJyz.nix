...
let
    ...
    in {
        ...
        "pkg-3.2.0-fabric" = _oGxL02AF;
        "pkg-3.2.0-forge" = _wXexbbUm;
        "pkg-3.2.20-fabric" = _SE0OcO7S;
        "pkg-3.2.20-forge" = _S8iLLk0J;
        "pkg-3.2.31-forge" = _WIWejBfn;
        "pkg-3.2.31-fabric" = _yEgwoBd2;
        "default" = _yEgwoBd2;
    });
