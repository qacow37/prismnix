...
let
    ...
    in {
        ...
        "pkg-9.1.1" = _Iv2EPUA8;
        "pkg-9.1.2" = _N5Sr78gy;
        "pkg-10.0.0" = _l9Plxtjg;
        "pkg-11.0.0" = _R1R54L7p;
        "pkg-11.0.1" = _RLejXevw;
        "pkg-11.0.2" = _6NWhTZDe;
        "pkg-12.0.0" = _ficU3Xl5;
        "pkg-13.0.0" = _DHRAGHGE;
        "pkg-14.0.0" = _Ja57GTJf;
        "pkg-14.0.1" = _t7D24ocU;
        "pkg-15.0.0" = _EZQxanoD;
        "pkg-16.0.0" = _rwXPBUuD;
        "pkg-17.0.0" = _AkcL2j1i;
        "pkg-17.0.1" = _gtroFDbm;
        "pkg-17.1.0" = _HppFTA6u;
        "pkg-17.1.1" = _PwlXN8MH;
        "pkg-16.0.1" = _C4B24B4A;
        "pkg-17.2.0" = _Pll3XsRh;
        "pkg-18.0.0" = _rx2QSGzj;
        "default" = _rx2QSGzj;
    });
