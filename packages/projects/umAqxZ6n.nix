...
let
    ...
    in {
        ...
        "pkg-0.1.3" = _BYo68pDF;
        "pkg-0.1.4" = _XOhcoPOe;
        "pkg-0.1.5-1.19.4" = _oVe451NK;
        "pkg-0.1.5-1.20.1+" = _3Uc6G0aq;
        "pkg-0.1.5-1.19.2" = _pufuVUoD;
        "pkg-0.1.6-1.19.2" = _SlbX1mlc;
        "pkg-0.1.6-1.19.4" = _W4MSFdf3;
        "pkg-0.1.6-1.20.1+" = _hEwtB5Kx;
        "pkg-0.1.7-1.19.2" = _cJf7IHjC;
        "pkg-0.1.7-1.19.4" = _15L7r5RL;
        "pkg-0.1.7-1.20.1+" = _yVuuKmPY;
        "pkg-0.1.8-1.19.2" = _9WANemXj;
        "pkg-0.1.8-1.19.4" = _e2E469SQ;
        "pkg-0.1.8-1.20.1+" = _E2MyHNfg;
        "pkg-0.1.8-1.20.3+" = _enT1AqET;
        "pkg-0.1.8.1-1.20.3+" = _duljVEFv;
        "pkg-0.1.9-1.19.2" = _HULWYpRn;
        "pkg-0.1.9-1.20" = _XOIlvpJx;
        "pkg-0.1.9-1.20.4" = _5zmbvFac;
        "pkg-1.0.0-1.20" = _sFtPjCsN;
        "pkg-1.0.0-1.20.5+" = _FBW7n06q;
        "pkg-1.0.0-1.20.4" = _OFOMjSbd;
        "pkg-1.1.0-1.21+" = _x7Gm8yoX;
        "pkg-1.2.0-1.21+" = _G0sNpCXr;
        "pkg-1.2.1-1.21+" = _l2wINGa2;
        "pkg-1.2.2-1.21+" = _h6SAfLBi;
        "pkg-2.0.0-1.21+" = _hRkQNuhs;
        "pkg-2.0.1-1.21+" = _4tOJKkdI;
        "pkg-2.0.2-1.21.4+" = _YVNy5d7u;
        "pkg-2.0.3-1.21.4+" = _PuQ616gW;
        "pkg-2.1.0" = _nOBMeJp4;
        "pkg-2.1.1" = _22gyCPT9;
        "pkg-2.1.2" = _EngtVPc1;
        "pkg-2.1.3" = _5VdJgxjt;
