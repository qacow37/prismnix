...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _FxzAYT5u;
        "pkg-1.0.9" = _gVnE0RFO;
        "pkg-1.0.10" = _UEpX1VEY;
        "pkg-1.0.11" = _aHpZkt9R;
        "pkg-1.0.12" = _BOQLnVXW;
        "pkg-1.0.13" = _cqEVe1Uu;
        "pkg-1.0.14" = _sRK2PiVz;
        "pkg-1.0.15" = _HOaSuCge;
        "pkg-1.0.16" = _XCVNiTEc;
        "pkg-1.0.17" = _pAEjN8c4;
        "pkg-1.0.18" = _SgH3fDLr;
        "pkg-1.0.19" = _vYGqsAU4;
        "pkg-1.0.20" = _oR14vI1u;
