...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.7-fabric" = _b6b20uEe;
        "pkg-1.18.2-2.7-fabric" = _lQY3hbcc;
        "pkg-1.19.2-2.8-fabric" = _sBEENGlb;
        "pkg-1.16.5-2.4-forge" = _9D06KEyT;
        "pkg-1.18.2-2.4-forge" = _ujBsiRJr;
        "pkg-1.19.2-2.6-forge" = _wsGyf6Vu;
        "pkg-1.16.5-2.9-fabric" = _vKlyto2l;
        "pkg-1.18.2-2.9-fabric" = _Yq3b3mcT;
        "pkg-1.19.2-2.9-fabric" = _6Q9Gjpt3;
        "pkg-1.19.3-3.0-fabric" = _YVBw3rOM;
        "pkg-1.19.3-2.6-forge" = _wBSmXUPx;
        "pkg-1.18.2-4.0-forge+fabric" = _gJZG4inB;
        "pkg-1.19.2-4.0-forge+fabric" = _q5SOsumC;
        "pkg-1.19.3-4.0-forge+fabric" = _3c3Nnemd;
        "pkg-1.18.2-4.1-forge+fabric" = _APCmAYU3;
        "pkg-1.19.2-4.1-forge+fabric" = _JTcPQC2g;
        "pkg-1.19.3-4.1-forge+fabric" = _klkJRYFf;
        "pkg-1.18.2-4.2-forge+fabric" = _a5ZMtgu4;
        "pkg-1.19.2-4.2-forge+fabric" = _IVxMhxnG;
        "pkg-1.19.3-4.2-forge+fabric" = _LS1z4ZjN;
        "pkg-1.18.2-4.3-forge+fabric" = _5lCsJi1i;
        "pkg-1.19.2-4.3-forge+fabric" = _cUH24yml;
        "pkg-1.19.3-4.3-forge+fabric" = _kcWtsI8e;
        "pkg-1.18.2-4.4-forge+fabric" = _dosauThS;
        "pkg-1.19.2-4.4-forge+fabric" = _8EeKz1va;
        "pkg-1.19.3-4.4-forge+fabric" = _asFsxb2M;
        "pkg-1.19.4-4.4-forge+fabric" = _hFWknt8T;
        "pkg-1.20-4.4-forge+fabric" = _stISxeTR;
        "pkg-1.20.1-4.4-forge+fabric" = _O3o2JfsL;
        "pkg-1.20.2-4.4-forge+fabric" = _ZXfhKZI9;
        "pkg-1.18.2-4.5-forge+fabric" = _YsmUruO6;
        "pkg-1.19.2-4.5-forge+fabric" = _MG1t6925;
        "pkg-1.20.1-4.5-forge+fabric" = _z8P8rI5Z;
        "pkg-1.20.2-4.5-forge+fabric" = _IFOuhI9G;
        "pkg-1.20.3-4.5-fabric+forge+neo" = _sHeCkKcs;
        "pkg-1.20.4-4.5-fabric+forge+neo" = _F5IE5WLI;
        "pkg-1.19.2-4.6-fabric+forge+neo" = _WSJAmfTG;
        "pkg-1.20.1-4.6-fabric+forge+neo" = _jp6z4kMu;
        "pkg-1.20.2-4.6-fabric+forge+neo" = _cc5WwowA;
        "pkg-1.20.4-4.6-fabric+forge+neo" = _HtnvOwJU;
        "pkg-1.20.5-4.6-fabric+neo" = _KhXybzVC;
        "pkg-1.20.5-4.7-fabric+neo" = _ZxSqKyEs;
        "pkg-1.20.6-4.7-fabric+forge+neo" = _JGlVvORS;
        "pkg-1.21.0-4.7-fabric+forge+neo" = _2xUbDi57;
        "pkg-1.20.1-4.8-fabric+forge+neo" = _r67ml53I;
        "pkg-1.20.6-4.8-fabric+forge+neo" = _FLcmF5Wq;
        "pkg-1.21.0-4.8-fabric+forge+neo" = _AWatH91s;
        "pkg-1.21.1-4.8-fabric+forge+neo" = _8OJga66z;
        "pkg-1.21.2-4.8-fabric+neo" = _stifSrND;
        "pkg-1.21.3-4.8-fabric+forge+neo" = _eLss4uFn;
        "pkg-1.21.4-4.8-fabric+forge+neo" = _eouk5r85;
        "pkg-1.20.1-4.9-fabric+forge+neo" = _ZbVN9hr6;
        "pkg-1.21.1-4.9-fabric+forge+neo" = _3W4ZrhhC;
        "pkg-1.21.4-4.9-fabric+forge+neo" = _YPsm91cV;
        "pkg-1.21.5-4.9-fabric+forge+neo" = _NFkFj1Io;
        "pkg-1.21.6-4.9-fabric+forge+neo" = _9tsksza5;
        "pkg-1.21.7-4.9-fabric+forge+neo" = _pTv31Bt3;
        "pkg-1.21.8-4.9-fabric+forge+neo" = _7RWaZ0o5;
        "pkg-1.21.9-4.9-fabric+forge+neo" = _pXbt1KBM;
        "pkg-1.21.9-5.0-fabric+forge+neo" = _b9KwZIOF;
        "pkg-1.21.10-5.0-fabric+forge+neo" = _ueIkMs0b;
        "pkg-1.21.11-5.0-fabric+forge+neo" = _TTAqz5tF;
        "pkg-26.1.0-5.0-fabric+forge+neo" = _ld0bStrQ;
        "pkg-26.1.1-5.0-fabric+forge+neo" = _KiDsAYvG;
        "pkg-26.1.2-5.0-fabric+forge+neo" = _Gx2Ozu0W;
        "pkg-26.2.0-5.0-fabric+forge+neo" = _Mhg4ajMP;
        "default" = _Mhg4ajMP;
    });
