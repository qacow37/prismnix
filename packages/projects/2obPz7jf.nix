...
let
    ...
    in {
        ...
        "pkg-0.2.0" = _yxP8WYY2;
        "pkg-0.2.1" = _NjRy3cN8;
        "pkg-0.2.2+1.19.2" = _Nepld7su;
        "pkg-0.3.0+1.19.2" = _A4J6CjOa;
        "pkg-0.3.1+1.19.2" = _LZeAkeNn;
        "pkg-0.4.0+1.19.2" = _BZVd7WPz;
        "pkg-0.4.1+1.19.2" = _a94ayyQG;
        "pkg-0.4.2+1.19.2" = _ECp6vktD;
        "pkg-0.4.3+1.19.2" = _a0LB7ORV;
        "pkg-0.4.4+1.19.2" = _z8G2NkKF;
        "pkg-0.4.5+1.20.1" = _SX2ecxZL;
        "pkg-0.5.0" = _nmeuW8es;
        "pkg-0.5.1" = _QwbukhS9;
        "pkg-0.5.2" = _dYSp3ZsV;
        "pkg-0.5.3" = _ZQqfol0h;
        ...
        "pkg-0.6.7" = _7RTXGY8r;
        "pkg-0.6.8" = _W4wJY7w5;
        "pkg-0.7.0-SNAPSHOT" = _nNOP0iII;
        "pkg-0.7.0" = _YLyhzygh;
        "pkg-0.7.1-neoforge" = _dEMwrap5;
        "pkg-0.7.1-fabric" = _4wBW6vUa;
        "default" = _4wBW6vUa;
    });
