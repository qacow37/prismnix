...
let
    ...
    in {
        ...
        "pkg-1.21" = _BJIu6qtC;
        "pkg-1.21+mod" = _7yPS7bfc;
        "pkg-1.21.1" = _qpFDupVl;
        "pkg-1.21.1+mod" = _4XFJRzIV;
        "pkg-1.21.2" = _QLu4NWqf;
        "pkg-1.21.2+mod" = _E6nQzaam;
        "pkg-1.21.3" = _Nq8IKqCS;
        "pkg-1.21.3+mod" = _t0cqXfhc;
        "pkg-1.21.4" = _uXwN7xRF;
        "pkg-1.21.4+mod" = _sPEHFIjh;
        "pkg-1.21.5" = _1wa5KmPl;
        "pkg-1.21.5+mod" = _XWViJMoq;
        "pkg-1.21.6" = _WUXjCE6p;
        "pkg-1.21.6+mod" = _3ZzkZW64;
        "pkg-1.21.7" = _xyn834Zy;
        "pkg-1.21.7+mod" = _Vf9La81j;
        "pkg-1.21.8" = _UYGE58OR;
        "pkg-1.21.8+mod" = _eEAHDfkI;
        "pkg-1.21.9" = _Qwhcdo3n;
        "pkg-1.21.9+mod" = _wbPwEFAj;
        "pkg-1.21-Plus" = _IEhec80U;
        "pkg-1.21-Plus+mod" = _GYILXOdT;
        "pkg-26.1" = _XqKU5Y1b;
        "pkg-26.1+mod" = _ewR14ZMH;
        "default" = _ewR14ZMH;
    });
