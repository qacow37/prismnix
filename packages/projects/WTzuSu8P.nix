...
let
    ...
    in {
        ...
        "pkg-v.0.3.0" = _qn1GnDU3;
        "pkg-v.0.3.0+mod" = _2ax06COa;
        "pkg-v.2.0.0" = _KP6ZAOiO;
        "pkg-v.2.0.0+mod" = _M2yj8RO1;
        "pkg-v.1.0.1" = _4qyXVK9k;
        "pkg-v.1.0.1+mod" = _eKBebVIo;
        "pkg-v.1.1.1" = _P0r0gBkw;
        "pkg-v.1.1.1+mod" = _xTfNPx1w;
        "pkg-2.1.0" = _3AivzlCB;
        "pkg-2.1.0+mod" = _eeNqKbnh;
        "pkg-v.1.1.0" = _tHoGY1SU;
        "pkg-v.1.1.0+mod" = _eJQQchWv;
        "pkg-v.1.2.0" = _aKg9qifC;
        "pkg-v.1.2.0+mod" = _mSvbxEtP;
        "pkg-v.2.1.0" = _LipczdFt;
        "pkg-v.2.1.0+mod" = _JGZWZhXc;
        "pkg-v.2.2.0" = _DgjROCAq;
        "pkg-v.2.2.0+mod" = _XaQQnx35;
        "pkg-v.2.2.1" = _wyLN6OJM;
        "pkg-v.2.2.1+mod" = _diWiASYC;
        "pkg-v.2.3.1" = _vSIIAq02;
        "pkg-v.2.3.1+mod" = _z4QHdg3a;
        "pkg-v.2.4.1" = _74FWvPFK;
        "pkg-v.2.4.1+mod" = _jHZOkywH;
        "pkg-v.2.3.0" = _iSbgiUoV;
        "pkg-v.2.3.0+mod" = _v42LiLI2;
        "pkg-v.2.4.2" = _nQFX3T4R;
        "pkg-v.2.4.2+mod" = _beKFejUG;
        "pkg-v.2.0.1" = _mn9bBEGb;
        "pkg-v.2.0.1+mod" = _YUDnvMVq;
        "pkg-v.2.5.2" = _fZmag2We;
        "pkg-v.2.5.2+mod" = _x9nBxNxP;
        "pkg-v.2.1.1" = _KLhwK6Dr;
        "pkg-v.2.1.1+mod" = _p9bxMxjv;
        "pkg-v.1.0.0" = _U15rmJZD;
        "pkg-v.1.0.0+mod" = _Dc43TS9k;
        "pkg-v.2.6.2" = _rWcr88HB;
        "pkg-v.2.6.2+mod" = _OZlXgUbo;
        "pkg-v.2.7.2" = _qTx3DtPy;
        "pkg-v.2.7.2+mod" = _Jl8AJwz9;
        "pkg-v.2.7.3" = _2YzWdUaD;
        "pkg-v.2.7.3+mod" = _HiXwyccg;
        "pkg-v.2.1.2" = _pw8ctTLy;
        "pkg-v.2.1.2+mod" = _R5tblQON;
        "pkg-v.2.8.3" = _2gleCaMI;
        "pkg-v.2.8.3+mod" = _avqjSwO7;
        "pkg-2.8.4" = _LpUVJCZx;
        "pkg-2.8.4+mod" = _F4qHU3WU;
        "pkg-v.2.8.5" = _sbLcXS2a;
        "pkg-v.2.8.5+mod" = _xDY0Tnt3;
        "pkg-v.3.0.0" = _L1yf6rpb;
        "pkg-v.3.0.0+mod" = _cHSpKl4R;
        "pkg-v.3.0.1" = _5Y4CqKaW;
        "pkg-v.3.0.1+mod" = _RgcnIhzx;
        "pkg-v.3.1.1" = _a0IDefbZ;
        "pkg-v.3.1.1+mod" = _3rFkoWwZ;
        "pkg-v.3.2.1" = _y0iY7eE6;
        "pkg-v.3.2.1+mod" = _owbuYSQw;
        "pkg-v.4.0.0" = _F9fMKFKP;
        "pkg-v.4.0.0+mod" = _uOhNXlg3;
        "pkg-v.3.2.2" = _YhaQQVoR;
        "pkg-v.3.2.2+mod" = _oHcg0EF4;
        "pkg-v.4.0.1" = _OoElfOzq;
        "pkg-v.4.0.1+mod" = _4PunqltR;
        "pkg-v.4.0.2" = _pyubmJ41;
        "pkg-v.4.0.2+mod" = _qlOH7jKR;
        "pkg-v.4.0.3" = _erwlyRHK;
        "pkg-v.4.0.3+mod" = _Zc3onY3d;
        "pkg-v.4.0.4" = _msL6c1G5;
        "pkg-v.4.0.4+mod" = _CMARO0eX;
        "pkg-v4.1.4" = _yVF9jwLr;
        "pkg-v4.1.4+mod" = _w4ONshdx;
        "pkg-v2.1.3" = _KI7urkNh;
        "pkg-v2.1.3+mod" = _2RXpwktK;
        "pkg-v4.1.5" = _80LQbHL8;
        "pkg-v4.1.5+mod" = _zIrLsHqN;
        "pkg-v4.2.5" = _p3Ab8XtY;
        "pkg-v4.2.5+mod" = _4FSQGYD9;
        "pkg-v4.2.6" = _O9qZMK88;
        "pkg-v4.2.6+mod" = _msWvQlVW;
        "pkg-v3.3.2" = _Jt16eBgB;
        "pkg-v3.3.2+mod" = _UWSYEZWj;
        "pkg-v4.2.8" = _b3TctcLO;
        "pkg-v4.2.8+mod" = _oaGql6BQ;
        "pkg-v4.2.9" = _GJab9Lx2;
        "pkg-v4.2.9+mod" = _fSRWm98I;
        "pkg-v4.2.10" = _VwscO9FD;
        "pkg-v4.2.10+mod" = _fdb9tehZ;
        "pkg-v4.2.11" = _OmqU3fOr;
        "pkg-v4.2.11+mod" = _rFPavsjw;
        "pkg-v4.2.12" = _PBxMcb54;
        "pkg-v4.2.12+mod" = _JPM1CHMD;
        "pkg-v4.3.12" = _NZ3D06X3;
        "pkg-v4.3.12+mod" = _KwxLcYNd;
        "pkg-v4.3.13-mc1.21.6+" = _s6RLXbtW;
        "pkg-v4.3.13-mc1.21.6++mod" = _fUtpj4ud;
        "pkg-v4.3.13" = _RuflkuJZ;
        "pkg-v4.3.13+mod" = _ELwtUzes;
        "pkg-v4.3.14" = _QVpeVn0a;
        "pkg-v4.3.14+mod" = _ThfAnoCl;
        "pkg-v4.3.15" = _DkJmDXrE;
        "pkg-v4.3.15+mod" = _tv9mWaHg;
        "pkg-v4.3.16" = _wn7wtCDk;
        "pkg-v4.3.16+mod" = _jFxS0C1v;
        "pkg-v4.3.17" = _zfq0ZGYs;
