...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _cPukbhnG;
        "pkg-1.0.1" = _srnyGoVX;
        "pkg-1.1.0+1.21.9" = _oQZ7rvDu;
        "pkg-2.0.0+1.20.1+fabric" = _ecvYIfBS;
        "pkg-2.0.0+1.21.1+fabric" = _sWenp2Na;
        "pkg-2.0.0+1.21.4+fabric" = _YjnJdLcG;
        "pkg-2.0.0+1.21.5+fabric" = _kqMkfsM6;
        "pkg-2.0.0+1.21.8+fabric" = _bBTz5NFd;
        "pkg-2.0.0+1.21.10+fabric" = _oQDkZJcJ;
        "pkg-2.0.0+1.21.11+fabric" = _GiosZTvx;
        "pkg-2.0.0+26.1+fabric" = _tIz2QbNK;
        "pkg-2.0.0+1.21.1+neoforge" = _2HtRCTNb;
        "pkg-2.0.0+1.21.11+neoforge" = _SN4tUdAW;
        "pkg-2.0.0+26.1+neoforge" = _qeLlkRrM;
        "pkg-2.0.0+1.20.1+forge" = _TEaPjUGX;
        "pkg-2.0.1+1.20.1+fabric" = _OrXHcun3;
        "pkg-2.0.1+1.21.1+fabric" = _xZGAO2OL;
        "pkg-2.0.1+1.21.11+fabric" = _DE8vY9qy;
        "pkg-2.0.1+26.1+fabric" = _dTcLmIUo;
        "pkg-2.0.1+26.2+fabric" = _DtKzK3iq;
        "pkg-2.0.1+1.21.1+neoforge" = _PmTj38sx;
        "pkg-2.0.1+1.21.11+neoforge" = _4QPtLV5X;
        "pkg-2.0.1+26.1+neoforge" = _jN0R0B7c;
        "pkg-2.0.1+26.2+neoforge" = _SA0XBfen;
        "pkg-2.0.1+1.20.1+forge" = _pVPMfhLV;
        "default" = _pVPMfhLV;
    });
