...
let
    ...
    in {
        ...
        "pkg-1.1.2" = _StIiDQS9;
        "pkg-1.2" = _osDA8XES;
        "pkg-1.2.1-1.21" = _riLAO9ZF;
        "pkg-1.2.2-1.21" = _Anq91EFP;
        "pkg-1.2.2-1.21.1" = _EErY6Lf0;
        "pkg-1.2.3-1.21.1" = _R9dYR4WV;
        "pkg-1.3-1.21.1" = _HP6BfNmG;
        "pkg-1.3.1-1.21.1" = _FRMkq3fd;
        "pkg-1.3.1-1.21.5" = _QgTXyFgc;
        "pkg-1.3.2-1.21.5" = _6LlesrPl;
        "pkg-1.3.2-1.21.1" = _6Supzzhv;
        "pkg-1.2.1" = _bKb3JgIY;
        "pkg-1.3.3-1.21.5" = _CSdvGFeW;
        "pkg-1.3.3-1.21.6" = _thh6GoFF;
        "pkg-1.3.3-1.21.9" = _egsv4fKu;
        "pkg-1.3.4-1.21.9" = _Mrv5AjOG;
        "pkg-1.3.4-1.21.6" = _uecSDXkU;
        "pkg-1.3.5-1.21.6" = _VTqqB6Vc;
        "pkg-19.0.0" = _BYnJkPBg;
        "pkg-19.0.1" = _CoYXipMu;
        "pkg-19.1.0" = _4EnE8CHL;
        "pkg-20.1.0" = _uB1dLyN4;
        "pkg-20.1.1" = _rvdpV0M4;
        "pkg-9.0.0" = _8928VcTu;
        "pkg-20.1.2" = _zqNy7nje;
        "pkg-21.1.0" = _xz7DtfIp;
        "default" = _xz7DtfIp;
    });
