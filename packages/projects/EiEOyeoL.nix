...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _V5Lx5xjD;
        "pkg-1.0.1" = _sbaK1ENn;
        "pkg-1.0.1.2" = _OudfmmnY;
        "pkg-1.0.1.3" = _NS4burTL;
        "pkg-1.0.1.4" = _IVnlFdP4;
        "pkg-1.0.1.5" = _Xi1WmWxu;
        "pkg-1.0.1.6" = _qIwjnbYU;
        "pkg-1.0.1.7" = _RtOis3qz;
        "pkg-1.0.1.8" = _JDX48Uls;
        "pkg-1.0.1.9" = _Ewc7trBI;
        "pkg-1.0.1.10" = _XcSd0ekb;
        "pkg-1.0.1.11" = _rpArFovp;
        "pkg-1.0.1.12" = _IeJ244H3;
        "pkg-1.0.1.13" = _3DOGteeh;
        "pkg-1.0.1.14" = _niHlWBZZ;
        "pkg-1.0.1.15" = _3gJMpREi;
        "pkg-1.0.1.16" = _7yAVE54i;
        "pkg-1.0.1.17" = _MvTdhSvJ;
        "pkg-1.0.1.18" = _QX7dOIX3;
        "pkg-1.0.1.19" = _DFogHstW;
        "pkg-1.0.1.20" = _no4S6PdW;
        "pkg-1.0.1.21" = _65Kyt71k;
        "pkg-1.0.1.22" = _Jh23zVH1;
        "pkg-1.0.1.23" = _RzkyIoou;
        "pkg-1.0.1.24" = _2tLqOHPB;
        "pkg-1.0.1.25" = _SqaXzLw8;
        "pkg-1.0.1.26" = _qEJcdsM3;
        "pkg-1.0.1.27" = _LL1Aj4J1;
        "pkg-1.0.1.28" = _GsXv5Ios;
        "pkg-1.0.1.29" = _zQbxqa0z;
        "pkg-1.0.1.30" = _rGIzS680;
        "pkg-1.0.1.31" = _OS75Aeqs;
        "pkg-1.0.1.33" = _Iiw8eKHy;
        "pkg-1.0.1.34" = _eusSWGwm;
        "pkg-1.0.1.35" = _N8AgM47N;
        "pkg-1.1.0.40" = _ch0ChjRg;
        "pkg-1.1.0.41" = _ln61jLBI;
        "pkg-1.1.0.42" = _gR4YDnx8;
        "pkg-1.1.0.43" = _CZTv3duw;
        "pkg-1.1.0.44" = _4HVqN2k3;
        "pkg-1.1.0.45" = _EXOaoKae;
        "pkg-1.1.0.46" = _20KbL9vy;
        "pkg-1.1.0.47" = _cLA3EH6T;
        "pkg-1.1.0.48" = _4GVH5zw2;
        "pkg-1.1.0.49" = _n02I216t;
        "pkg-2.0.0.2" = _rXh9CUMu;
        "pkg-2.0.0.1" = _tVJ6HxUs;
        "pkg-3.0.0.3" = _s2SIOs7a;
        "pkg-3.0.0.4" = _5usyZZNh;
        "pkg-3.0.0.5" = _gprOFpTE;
        "pkg-3.0.0.7" = _vpl37joJ;
        "pkg-3.0.0.8" = _6rZmrxU8;
        "pkg-3.0.0.9" = _d953fyfK;
        "pkg-4.0+7" = _LotGbkQF;
        "pkg-4.0+8" = _pjE3wfnl;
        "pkg-4.0.9" = _3iK3LNQk;
        "pkg-4.0.10" = _hTQpwIjw;
        "pkg-4.0.11" = _vYD5dvb2;
        "pkg-4.0.12" = _TQgBt4Ky;
        "pkg-8.0.4" = _wanQpMzR;
        "pkg-8.0.5" = _6HaqtxxH;
        "pkg-8.0.6" = _BTMxPqmn;
        "default" = _BTMxPqmn;
