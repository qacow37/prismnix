...
let
    ...
    in {
        ...
        "pkg-v1.0.1+mod" = _NbQrjKzh;
        "pkg-v1.0.2" = _VUPgdDR9;
        "pkg-v1.0.2+mod" = _DAU36LhF;
        "pkg-v1.1.0" = _B16MgSDE;
        "pkg-v1.1.0+mod" = _j03hxbpR;
        "pkg-v1.2.0" = _2KfoD2mL;
        "pkg-v1.2.0+mod" = _e9DabiXO;
        "pkg-v1.2.1" = _qUyyt6Gv;
        "pkg-v1.2.1+mod" = _Xg8lQgUL;
        "pkg-v1.2.2" = _9Q4hamfU;
        "pkg-v1.2.2+mod" = _uhewE3Q2;
        "pkg-v1.2.3" = _UcMgICf6;
        "pkg-v1.2.3+mod" = _KozKcJVU;
        "pkg-v2.0.0" = _TLpvWgY3;
        "pkg-v2.0.0+mod" = _leh25Hus;
        "pkg-v2.0.1" = _cAHLF9Jn;
