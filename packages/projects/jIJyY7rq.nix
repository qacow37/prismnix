...
let
    ...
    in {
        ...
        "pkg-1.2-1.18" = _8oQjVKs6;
        "pkg-1.2-1.19" = _PmUCtYCk;
        "pkg-1.3-1.19" = _WpPUw5cd;
        "pkg-1.3-1.18" = _fQWCI2nE;
        "pkg-1.4-1.19" = _OcInoL3C;
        "pkg-1.4-1.18" = _gFBQE6kV;
        "pkg-1.5-1.19" = _7nPUykAU;
        "pkg-1.5-1.18" = _zMy9lAbB;
        "pkg-1.6-1.19" = _xWwgtMIh;
        "pkg-1.7-1.18.x" = _FHz9QHWG;
        "pkg-1.7-1.19.x" = _wScIWTOP;
        "pkg-1.8-1.19.x" = _CFbqoPf7;
        "pkg-1.9-1.19.x" = _hMTaBd5H;
        "pkg-1.9-1.18.x" = _Wtz6NYcp;
        "pkg-1.10-1.19.2" = _riETWAqE;
        "pkg-1.10-1.19.3" = _4Y7RRjww;
        "pkg-1.11-1.18.x" = _qWC7d5q1;
        "pkg-1.11-1.19.2" = _5BaJJtgH;
        "pkg-1.11-1.19.3" = _TWxUoHou;
        "pkg-1.12-1.18.x" = _665PnbuZ;
        "pkg-1.12-1.19.2" = _3CqcMD0v;
        "pkg-1.12-1.19.3" = _j6rw1k3G;
        "pkg-1.12-1.19.4" = _6JkUfXQ5;
        "pkg-1.13-1.20" = _Qv8YoS72;
        "pkg-1.15-1.20" = _bAe3i5ed;
        "pkg-2.0-1.21.1" = _VVjvXQ3O;
        "pkg-3.0-BETA-1.21.1" = _V628u0Dz;
        "pkg-3.0-BETA-1.20.1" = _FuSncu8O;
        "pkg-3.1-BETA-1.20.1" = _KTfSBIjL;
        "pkg-3.2-1.20.1" = _gDmXlsKk;
        "pkg-3.3-1.20.1" = _68ESOP6A;
        "pkg-3.4-1.20.1" = _iieVSOpQ;
        "pkg-3.1-1.21.1" = _30fAD9af;
        "pkg-3.2-1.21.1" = _gsl4Iga3;
        "pkg-3.5-1.20.1" = _wX5ETsO0;
        "pkg-3.3-1.21.1" = _v0p2Yk6l;
        "pkg-3.3-26.1.2" = _j3iPwmnp;
        "default" = _j3iPwmnp;
    });
