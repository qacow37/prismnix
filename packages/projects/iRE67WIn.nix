...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _Rd6B3j61;
        "pkg-1.0.2" = _OsJmtZg0;
        "pkg-1.19.3-1.0.3" = _c6c3ujnf;
        "pkg-1.19.4-1.0.3" = _UgoD6J3E;
        "pkg-1.19.2-1.0.3" = _4dfnMaGj;
        "pkg-1.19.4-1.0.4" = _ElYEScYW;
        "pkg-1.20-1.1.0" = _Mt9SnTru;
        "pkg-1.20-1.1.1" = _7Qm6RdwB;
        "pkg-1.20-1.1.2" = _zzBe9aIP;
        "pkg-1.20.2-1.1.2" = _fgg24ooi;
        "pkg-1.20.6-1.2.0" = _yo7H7gnJ;
        "pkg-1.20.1-1.2.0" = _7xo239cu;
        "pkg-1.20.1-1.2.1" = _w8uizUXa;
        "pkg-1.20.6-1.2.1" = _eWqV3M78;
        "pkg-1.20.1-1.2.2" = _cJ6Kn4Di;
        "pkg-1.20.6-1.2.2" = _X9IXIcPy;
        "pkg-2.0.0" = _sZV1srLE;
        "pkg-1.20.1-1.2.3" = _3V4Q2v0t;
        "pkg-2.0.1" = _msqf8rGs;
        "pkg-2.0.2" = _WS0H1Qa8;
        "pkg-1.20.1-1.2.4" = _wokdN1mi;
        "pkg-2.0.3" = _umo35HTL;
        "pkg-2.0.4" = _LAeZs0en;
        "pkg-2.0.5" = _8FOh8e5f;
        "pkg-2.0.6" = _5EZEynCG;
        "pkg-1.20.1-1.2.5" = _Cd1MIW5D;
        "pkg-2.0.7" = _Di6kw5mn;
        "pkg-2.0.8" = _drJwfRpB;
        "pkg-2.0.9" = _KtT7BF6G;
        "pkg-2.0.10" = _458rh8WV;
        "pkg-2.0.11" = _INufuf0B;
        "pkg-1.20.1-1.2.6" = _35nRLWhN;
        "pkg-2.0.12" = _rQCcxbgR;
