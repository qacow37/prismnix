...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _6IraqXK6;
        "pkg-v5.0.0-1.19.3-Fabric" = _4YeCl7Gw;
        "pkg-v5.0.0-1.19.3-Forge" = _3twQFwYi;
        "pkg-v6.0.0-1.19.4-Fabric" = _9cFxMhOA;
        "pkg-v6.0.0-1.19.4-Forge" = _uwOE3NS5;
        "pkg-v7.0.0-1.20-Forge" = _gVHVvycp;
        "pkg-v7.0.0-1.20-Fabric" = _CntBh33x;
        "pkg-v8.0.0-1.20.1-Forge" = _QiVVaBcr;
        "pkg-v8.0.0-1.20.1-Fabric" = _ZmIBxN6h;
        "pkg-v8.0.1-1.20.1-Forge" = _WcCHKpLR;
        "pkg-v8.0.1-1.20.1-Fabric" = _3oDB3sIt;
        "pkg-v20.4.0-1.20.4-Fabric" = _fcTkJwod;
        "pkg-v20.4.0-1.20.4-Forge" = _398ym6Zv;
        "pkg-v20.4.0-1.20.4-NeoForge" = _22SF8Vey;
        "pkg-v20.4.1-1.20.4-Fabric" = _4iAReEBa;
        "pkg-v20.4.1-1.20.4-Forge" = _uWV2kGKA;
        "pkg-v20.4.1-1.20.4-NeoForge" = _2qEhJmCp;
        "pkg-v20.4.2-1.20.4-Fabric" = _w9XMObeO;
        "pkg-v20.4.2-1.20.4-Forge" = _YW5nvdFn;
        "pkg-v20.4.2-1.20.4-NeoForge" = _pxbLwmoJ;
        "pkg-v8.0.2-1.20.1-Forge" = _uA0OpHqs;
        "pkg-v8.0.2-1.20.1-Fabric" = _RKQMmnQs;
        "pkg-v20.4.3-1.20.4-Fabric" = _oZOUKVU1;
        "pkg-v20.4.3-1.20.4-Forge" = _zwvRNn0h;
        "pkg-v20.4.3-1.20.4-NeoForge" = _eSEFYkgD;
        "pkg-v21.1.0-1.21.1-Fabric" = _GrOL98Wf;
        "pkg-v21.1.0-1.21.1-NeoForge" = _tROD5GWO;
        "pkg-v21.1.1-1.21.1-Fabric" = _toKhapmx;
        "pkg-v21.1.1-1.21.1-NeoForge" = _BPu76DKE;
        "pkg-v21.1.2-1.21.1-Fabric" = _hstBf1NP;
        "pkg-v21.1.2-1.21.1-NeoForge" = _KaQdIIs8;
        "pkg-v8.0.3-1.20.1-Forge" = _587S3cKr;
        "pkg-v8.0.3-1.20.1-Fabric" = _cGuAidm3;
        "pkg-v21.3.0-1.21.3-Fabric" = _19Bl3MGQ;
        "pkg-v21.3.0-1.21.3-NeoForge" = _k0ulanXD;
        "pkg-v21.1.3-1.21.1-Fabric" = _FJIqczCy;
        "pkg-v21.1.3-1.21.1-NeoForge" = _2M9g2E8m;
        "pkg-v21.3.1-1.21.3-Fabric" = _EMU1v4FK;
        "pkg-v21.3.1-1.21.3-NeoForge" = _oJIvsVGk;
        "pkg-v21.4.0-1.21.4-Fabric" = _fmWwd4MA;
        "pkg-v21.4.0-1.21.4-NeoForge" = _NHaUZiqk;
        "pkg-v21.5.0-1.21.5-Fabric" = _HSvyMlUp;
        "pkg-v21.5.0-1.21.5-NeoForge" = _qfgpfF3k;
        "pkg-v21.7.0-1.21.7-Fabric" = _3ZkQr8fr;
        "pkg-v21.7.0-1.21.7-NeoForge" = _rojiN7IN;
        "pkg-v21.8.0-1.21.8-Fabric" = _qC2SiR7p;
        "pkg-v21.8.0-1.21.8-NeoForge" = _GfqikjpE;
        "pkg-v21.8.1-1.21.8-Fabric" = _gQpfKARR;
        "pkg-v21.8.1-1.21.8-NeoForge" = _ZTYyi3A7;
        "pkg-v21.8.2-1.21.8-Fabric" = _vURQj4TD;
        "pkg-v21.8.2-1.21.8-NeoForge" = _b27pQOPZ;
        "pkg-v21.1.4-1.21.1-Fabric" = _1l0T9jm4;
        "pkg-v21.1.4-1.21.1-NeoForge" = _OR1IjCku;
        "pkg-v21.8.3-1.21.8-Fabric" = _nBgw27Z4;
        "pkg-v21.8.3-1.21.8-NeoForge" = _ylPhFMdN;
        "pkg-21.10.0" = _60X4iRrk;
        "pkg-21.9.0" = _BEoCrPJb;
