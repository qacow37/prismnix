...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.21.6+neoforge" = _pl70oK3N;
        "pkg-1.0.0+mc1.21.6+fabric" = _JJxHRqN4;
        "pkg-1.0.1+mc1.21.6+fabric" = _59yYtvOK;
        "pkg-1.0.1+mc1.21.6+neoforge" = _nzXQ0Kg6;
        "pkg-1.1.0+mc1.21.6+fabric" = _KgvOBHXM;
        "pkg-1.1.0+mc1.21.6+neoforge" = _zw7nGWie;
        "pkg-1.1.1+mc1.21.6" = _XVYi6UWf;
        "pkg-1.2.0+mc1.21.9" = _jOkvCQmL;
        "pkg-1.3.0+mc1.21.9" = _AzTY3PdA;
        "pkg-1.4.0+mc1.21.8" = _661e2RGC;
        "pkg-1.4.1+mc1.21.4" = _byckklST;
        "pkg-1.4.1+mc1.21.8" = _6VN5sOzV;
        "pkg-1.4.2+mc1.21.5" = _wDyr2H0m;
        "pkg-1.4.2+mc1.21.8" = _fT1tMU9W;
        "pkg-2.0.0+mc1.21.10" = _WnfMX7Tx;
        "pkg-2.0.1+mc1.21.10" = _i889JKId;
        "pkg-1.4.3+mc1.21.5" = _gvYOTCYo;
        "pkg-2.0.2+mc1.21.10" = _wBOAjKi0;
        "pkg-1.4.4+mc1.21.5" = _GAcOmgCX;
        "pkg-2.0.3+mc1.21.10" = _WQvmKBM2;
        "pkg-2.0.4+mc1.21.10" = _3c9BxMFC;
        "pkg-1.4.5+mc1.21.5" = _KydIbG1k;
        "pkg-2.0.5+mc1.21.10" = _lpCwGoyQ;
        "pkg-3.0.0+mc1.21.11" = _FSUSw8ce;
        "pkg-3.0.1+mc1.21.11" = _rzMWGh12;
        "pkg-3.0.2+mc1.21.11" = _QuYiL6UX;
        "pkg-3.1.0+mc1.21.11" = _3GAv2MoN;
        "pkg-3.1.1+mc1.21.11" = _20V9y6uD;
        "pkg-3.2.0+mc1.21.11" = _pgBT7F2L;
        "pkg-1.5.0+mc1.21.5" = _RVCmecUC;
        "pkg-2.1.0+mc1.21.10" = _uxk6iyIT;
        "pkg-3.3.0+mc1.21.11" = _PI4xZTvP;
        "pkg-3.4.0+mc1.21.11" = _MEuYglet;
        "pkg-3.4.1+mc1.21.11" = _OkiEDXOq;
        "pkg-1.5.0+mc1.21.1" = _PdAhvEEF;
        "pkg-1.5.1+mc1.21.1" = _cSpAlexz;
        "pkg-4.0.0" = _V0DdMwHJ;
        "pkg-4.0.1" = _6dOECDJz;
        "pkg-4.0.2" = _3NisEGjU;
        "pkg-4.0.3" = _UfukrDyX;
