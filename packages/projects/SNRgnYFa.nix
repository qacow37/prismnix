...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.21.1" = _Bfvxo2aD;
        "pkg-1.0.1-1.21.1" = _oEU4loUX;
        "pkg-1.0.2-1.21.1" = _1LUdokrW;
        "pkg-1.0.0-1.20.1" = _2ij6VMV2;
        "pkg-1.0.1-1.20.1" = _yH1YPVYn;
        "pkg-1.0.3-1.21.1" = _FrTrqfqu;
        "pkg-1.0.3-1.20.1" = _tcgUqLZ0;
        "pkg-1.0.4-1.21.1" = _iYBNB8St;
        "pkg-Sout-1.20.1-0.1" = _7AefW2E9;
        "pkg-0.2Scout" = _Emvk90F2;
        "pkg-Scout-Recrafted-Forge-1.20.1-0.3" = _a05MxNo4;
        "pkg-1.0.0-1.21.11" = _95Md9DyU;
        "pkg-Scout-Recrafted-Forge-1.20.1-0.4" = _6lXIu5qD;
        "pkg-1.0.4-1.20.1" = _bzPYJ8TE;
        "pkg-1.0.1-1.21.11" = _utydnXn4;
        "pkg-1.0.5-1.20.1" = _RFs2aMuL;
        "pkg-1.0.5-1.21.1" = _46aAHX5j;
        "pkg-1.0.2-1.21.11" = _gG0snWRb;
        "pkg-1.0.6-1.20.1" = _eLuvHOQ4;
        "pkg-1.0.6-1.21.1" = _TJQAwC3w;
        "pkg-Scout-Recrafted-Forge-1.20.1-0.5" = _M4vkBMHA;
        "pkg-1.0.7-1.20.1" = _8GFKKouo;
        "pkg-1.0.3-1.21.11" = _JCvH0xa4;
        "pkg-1.0.7-1.21.1" = _AkBAOKvZ;
        "pkg-1.0.8-1.21.1" = _u56DKnYg;
        "pkg-1.0.8-1.20.1" = _JSxnS2DG;
        "pkg-1.0.4-1.21.11" = _OVxZ0EnP;
        "pkg-Scout-Recrafted-Forge-1.20.1-0.6" = _MZmjO1j5;
        "pkg-Scout-Recrafted-Forge-1.20.1-0.7" = _md4Lms6a;
        "default" = _md4Lms6a;
    });
