...
let
    ...
    in {
        ...
        "pkg-V1.19" = _1tCPD8bD;
        "pkg-V1.19.1" = _nJ2urvmI;
        "pkg-V1.19.2" = _xGbnH6ZQ;
        "pkg-V1.19.3" = _iUgTorhA;
        "pkg-V1.20" = _X2eZAryy;
        "pkg-V1.20.1" = _TThLSwXt;
        "pkg-V1.21" = _csiev2bB;
        "pkg-V1.21.1" = _Wb2CWgLb;
        "pkg-V1.21.2" = _iPhhGtQt;
        "pkg-V1.21.3" = _Pt22KvI3;
        "pkg-V1.22" = _mirdsb90;
        "pkg-V1.22.1" = _SGBSrGaL;
        "pkg-V1.22.2" = _DtvWhABs;
        "pkg-V1.22.3" = _z0kucP4l;
        "pkg-V1.22.4" = _ew09YueM;
        "pkg-V1.22.5" = _TbNqufPf;
        "pkg-V1.22.6" = _8tjXQvpl;
        "pkg-V1.22.7-resource" = _ybunkBr2;
        "pkg-V1.22.7-data" = _ZPpEYwlp;
        "pkg-V1.22.7-mod" = _XFVChXN7;
        "pkg-V1.22.8-resource" = _SlMWXRaN;
        "pkg-V1.22.8-data" = _Eap69lY3;
        "pkg-V1.22.8-mod" = _BoaGTpJT;
        "pkg-V1.23-resource" = _Rza9bmnP;
        "pkg-V1.23-data" = _46ul0Xpa;
        "pkg-V1.23-mod" = _bTnH3hih;
        "pkg-V1.23.1-resource" = _kBte6lEQ;
        "pkg-V1.23.1-data" = _5X1Htiel;
        "pkg-V1.23.1-mod" = _zDoyIMgv;
        "pkg-V1.24-resources" = _3BnyAk7b;
        "pkg-V1.24-data" = _57fBg1q9;
        "pkg-V1.24-mod" = _jfKr0DJt;
        "pkg-V1.24.1-resource" = _zBOYVqUo;
        "pkg-V1.24.1-data" = _sFsQ2Rgl;
        "pkg-V1.24.1-mod" = _Ld78FKGT;
        "pkg-V1.24.2-resource" = _YYvDbQnk;
        "pkg-V1.24.2-data" = _Sb6azRZ5;
        "pkg-V1.24.2-mod" = _UyISZqKM;
        "pkg-V1.24.3-resource" = _ZkBBNmRj;
        "pkg-V1.24.3-data" = _Ezz1SzB4;
        "pkg-V1.24.3-mod" = _TlBfCPaL;
        "pkg-V1.24.4-resource" = _U0KPLyJU;
        "pkg-V1.24.4-data" = _jEQZYYsz;
        "pkg-V1.24.4-mod" = _lRoBeUgX;
        "pkg-V1.24.5-resource" = _DzRe2L78;
        "pkg-V1.24.5-data" = _9CtpxSL7;
        "pkg-V1.24.5-mod" = _iQnFNgxz;
        "pkg-V1.24.6-resource" = _880P3z0G;
        "pkg-V1.24.6-data" = _fyag3TXB;
        "pkg-V1.24.6-mod" = _w5SLtk28;
        "pkg-V1.24.7-resource" = _lTQAD1Rx;
        "pkg-V1.24.7-data" = _jhzIW5RU;
        "pkg-V1.24.7-mod" = _B18aEmaJ;
        "pkg-V1.24.8-resource" = _deI03IL5;
        "pkg-V1.24.8-data" = _HfAWZhQm;
        "pkg-V1.24.8-mod" = _BIccHjcr;
        "pkg-V1.24.9-resource" = _n4xvzR1V;
        "pkg-V1.24.9-data" = _k8wDL9ic;
        "pkg-V1.24.9-mod" = _TXnJQLfh;
        "pkg-V1.24.10-resource" = _ygs3bq3c;
        "pkg-V1.24.10-data" = _pbt8tfx7;
        "pkg-V1.24.10-mod" = _x7khLtsh;
        "pkg-V1.25-resource" = _ArnUi3xp;
        "pkg-V1.25-data" = _Ov70JCOV;
        "pkg-V1.25-mod" = _Be4ct177;
        "pkg-V1.25.1-resource" = _cEp87EiN;
        "pkg-V1.25.1-data" = _1aDBGjwx;
        "pkg-V1.25.1-mod" = _W0Njed7L;
        "pkg-V1.26-resource" = _3TTX5jSl;
        "pkg-V1.26-data" = _2lSefDMN;
        "pkg-V1.26-mod" = _JNJH5Hie;
        "pkg-V1.26.1-resource" = _eddeXKkr;
        "pkg-V1.26.1-data" = _NSXPNMrL;
        "pkg-V1.26.1-mod" = _RgM2je2T;
        "pkg-V1.26.2-resource" = _NfMEdFfm;
        "pkg-V1.26.2-data" = _JhMLBcsM;
        "pkg-V1.26.2-mod" = _KkSpI3Pd;
        "pkg-V1.26.3-resource" = _OODU5kLu;
        "pkg-V1.26.3-data" = _mZqhdiP8;
        "pkg-V1.26.3-mod" = _Tv9J2rsW;
        "pkg-V1.26.4-resource" = _UveZ4QCP;
        "pkg-V1.26.4-data" = _tB3jxZ1m;
        "pkg-V1.26.4-mod" = _GDomnogT;
        "pkg-V1.26.5-resource" = _saT2djVP;
        "pkg-V1.26.5-data" = _3svXjL9y;
        "pkg-V1.26.5-mod" = _p3LGKOLN;
        "pkg-V1.26.6-resource" = _eYQS7v3H;
        "pkg-V1.26.6-data" = _8TijaFlc;
        "pkg-V1.26.6-mod" = _5xMNcOdV;
        "pkg-V1.26.7-resource" = _XETyvr7E;
        "pkg-V1.26.7-data" = _xVLvepmR;
        "pkg-V1.26.7-mod" = _6CgGmZg7;
        "pkg-V1.27-resource" = _kSwu9bQl;
        "pkg-V1.27-data" = _QLg9rzlo;
        "pkg-V1.27-mod" = _6mzchnCl;
        "pkg-V1.28-resource" = _InN52WUO;
        "pkg-V1.28-data" = _FuzEE28B;
        "pkg-V1.28-mod" = _lRzaxR9I;
        "pkg-V1.28.1-resource" = _phZoDYiw;
        "pkg-V1.28.1-data" = _vwTtA4CA;
        "pkg-V1.28.1-mod" = _vpRWzE22;
        "pkg-V1.28.2-resource" = _vDy3sa4h;
        "pkg-V1.28.2-data" = _kTBCDWeC;
        "pkg-V1.28.2-mod" = _A4xF40Mw;
        "default" = _A4xF40Mw;
    });
