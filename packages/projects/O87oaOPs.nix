...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.15.2-fabric" = _1bTzeQLp;
        "pkg-1.1.0-1.15.2-forge" = _22fwjgRU;
        "pkg-1.1.0-1.16.1-fabric" = _sDvFZ7Or;
        "pkg-1.1.0-1.16.1-forge" = _ang5TZp5;
        "pkg-1.1.0-1.16.2-fabric" = _tp2gix13;
        "pkg-1.1.0-1.16.2-forge" = _Er76hHIV;
        "pkg-1.1.0-1.16.3-forge" = _hq0mq87Q;
        "pkg-1.1.1-1.16.2-fabric" = _o2Kyj2SJ;
        "pkg-1.1.1-1.15.2-fabric" = _JNXbjcH5;
        "pkg-1.2.0-1.17-fabric" = _jkXs10ge;
        "pkg-1.3.0-1.17-fabric" = _lQ2PBPPA;
        "pkg-1.3.0-1.17.1-forge" = _v06gCpXG;
        "pkg-1.3.0-1.16.2-fabric" = _MXm621yX;
        "pkg-1.3.0-1.16.3-forge" = _wKI6Hx7F;
        "pkg-1.3.0-1.15.2-fabric" = _dFHr9LCU;
        "pkg-1.3.0-1.15.2-forge" = _IJRb31So;
        "pkg-1.4.0-1.15.2-fabric" = _NTK378fp;
        "pkg-1.4.0-1.15.2-forge" = _Y5p7WvXx;
        "pkg-1.4.0-1.16.2-fabric" = _yIRlyArO;
        "pkg-1.4.0-1.16.3-forge" = _ib2IpkqN;
        "pkg-1.4.0-1.17-fabric" = _hn7KogBO;
        "pkg-1.4.0-1.17.1-forge" = _5pD3koS6;
        "pkg-1.4.0-1.18-fabric" = _AfFikJ2E;
        "pkg-1.4.0-1.18-forge" = _wGX7J5ey;
        "pkg-1.4.0-1.18.2-fabric" = _IHE1Prwv;
        "pkg-1.4.0-1.18.2-forge" = _G6PCwwK8;
        "pkg-1.4.0-1.19-fabric" = _17GC7TPn;
        "pkg-1.4.0-1.19-forge" = _gl8KVw7n;
        "pkg-1.4.1-1.19-forge" = _7XShS13e;
        "pkg-1.4.0-1.19.3-fabric" = _Nl5kbMmC;
        "pkg-1.4.1-1.19.3-forge" = _Si7JVJPs;
        "pkg-1.4.1-1.19.4-forge" = _mVJeMvhI;
        "pkg-1.4.0-1.19.4-fabric" = _mWwtqu7y;
        "pkg-1.4.1-1.20.1-forge" = _87MJRl1P;
        "pkg-1.4.0-1.20.1-fabric" = _2K1wJqqc;
        "pkg-1.4.0-1.20.2-fabric" = _Ssm0hBu1;
        "default" = _Ssm0hBu1;
    });
