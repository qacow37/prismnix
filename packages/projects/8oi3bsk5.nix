...
let
    ...
    in {
        ...
        "pkg-2.3.5" = _Wd3Co0mZ;
        "pkg-2.3.7" = _Xf5mFGCS;
        "pkg-2.3.7a" = _jUK1mCz3;
        "pkg-2.3.7b" = _pNFzTzQd;
        "pkg-2.3.8" = _K3S6BASh;
        "pkg-2.2.4" = _aYOzrVFZ;
        "pkg-2.4.1" = _Y4i2gvLB;
        "pkg-2.4.2" = _D0hKeWDQ;
        "pkg-2.3.9" = _8N8lLvTW;
        "pkg-2.4.3" = _34PhE3zd;
        "pkg-2.3.10" = _PNByHzei;
        "pkg-2.4.4" = _WZvndtxX;
        "pkg-2.3.11" = _Rq2BBA8A;
        "pkg-2.4.5" = _hYoo0DKV;
        "pkg-2.4.6" = _CDrDiFNK;
        "pkg-2.4.7" = _qFd4s3fV;
        "pkg-2.3.12" = _YmXuNSUM;
        "pkg-2.4.8" = _1hOeraaL;
        "pkg-2.4.10" = _4KrRTVvQ;
        "pkg-2.4.10a" = _WgDuoe1K;
        "pkg-2.2.5" = _xm11wemG;
        "pkg-2.4.11" = _FgvUosFH;
        "pkg-2.4.11a" = _zA1qYB0L;
        "pkg-2.2.6" = _6DoFR4md;
        "pkg-2.5.0" = _owDSctxm;
        "pkg-2.5.1" = _rWmFwtGy;
        "pkg-2.5.2" = _IA4tbVrS;
        ...
        "pkg-2.5.8" = _urbokcOc;
        "pkg-2.5.9" = _uG75eHfz;
        "pkg-2.5.10" = _plRDn5uz;
        "pkg-2.5.11" = _o7SunBER;
        "pkg-2.5.12" = _J4ZyGgTf;
        "pkg-2.5.13" = _RFNry3l0;
        "pkg-2.5.14" = _5HiwkSjM;
        "pkg-2.6.0" = _ke6KOsC5;
        "pkg-2.6.1" = _qcBNpb1U;
        "pkg-2.6.2" = _IY93YaEe;
        "pkg-2.6.3" = _eihdCshF;
