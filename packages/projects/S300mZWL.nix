...
let
    ...
    in {
        ...
        "pkg-1.0" = _Ko9BN5bv;
        "pkg-1.1-1.19.3-fabric" = _CdrJq0sJ;
        "pkg-1.1-1.19.3-forge" = _23F6fEid;
        "pkg-1.1-1.19.3-quilt" = _SVIPAiyA;
        "pkg-1.1-1.19.4-fabric" = _zerxNAZl;
        "pkg-1.1-1.19.4-forge" = _Ixl7P6Wh;
        "pkg-1.1-1.19.4-quilt" = _4Rq88HQ3;
        "pkg-1.1-1.20.1-fabric" = _gRsZooCI;
        "pkg-1.1-1.20.1-forge" = _lPxjeYm6;
        "pkg-1.1-1.20.1-quilt" = _PJbOeBN1;
        "pkg-1.1-1.20.2-fabric" = _fumivtiQ;
        "pkg-1.1-1.20.2-forge" = _9IkJRSpU;
        "pkg-1.1-1.20-fabric" = _ftBnem60;
        "pkg-1.1-1.20-forge" = _xQYOq89O;
        "pkg-1.1-1.20-quilt" = _9wSegquL;
        "pkg-1.2-1.19.3-fabric" = _nJmcqmXx;
        "pkg-1.2-1.19.3-forge" = _Sqg9zIEj;
        "pkg-1.2-1.19.3-quilt" = _C4yLek9i;
        "pkg-1.2-1.19.4-fabric" = _K5qb3sBT;
        "pkg-1.2-1.19.4-forge" = _59GCib7x;
        "pkg-1.2-1.19.4-quilt" = _5mQax7z7;
        "pkg-1.2-1.20-fabric" = _8oTIk1u0;
        "pkg-1.2-1.20-forge" = _DDR1A64u;
        "pkg-1.2-1.20-quilt" = _oMhYzbH5;
        "pkg-1.2-1.20.1-fabric" = _Cbz7LJpW;
        "pkg-1.2-1.20.1-forge" = _DD5SiFKH;
        "pkg-1.2-1.20.1-quilt" = _CYf510J8;
        "pkg-1.2-1.20.2-fabric" = _3ft1DPSm;
        "pkg-1.2-1.20.2-forge" = _qL02dOcq;
        "pkg-1.2-1.20.2-neoforge" = _7R3fE6wl;
        "pkg-1.2-1.20.4-fabric" = _9vCX5Dka;
        "pkg-1.2-1.20.4-forge" = _jItHX3nx;
        "pkg-1.2-1.20.4-neoforge" = _OcgrjSjG;
        "default" = _OcgrjSjG;
    });
