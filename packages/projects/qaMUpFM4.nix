...
let
    ...
    in {
        ...
        "pkg-1.17.1-1.5.0.1" = _L6cYmvr6;
        "pkg-1.18.2-1.6.1.1" = _kY34gaso;
        "pkg-1.19-1.7.0.0" = _u8c6Vz6b;
        "pkg-1.19.3-1.7.1.0" = _advul82X;
        "pkg-1.19.3-1.7.1.1" = _nnq5Wz1r;
        "pkg-1.19.3-1.7.1.2" = _qAg2drzz;
        "pkg-1.20-1.8.0.0" = _1qHoNi5n;
        "pkg-1.20.1-1.9.0.0" = _Oo6LiryJ;
        "pkg-1.20.2-2.0.0.0" = _HmO67ct3;
        "pkg-1.20.2-2.1.0.0" = _cD7FhEG9;
        "pkg-1.20.4-2.1.0.1" = _dlCf8iZz;
        "pkg-1.20.4-2.1.0.2" = _SGv5Agnk;
        "pkg-1.20.4-2.2.0.0" = _JHFkn2z9;
        "pkg-1.20.6-2.3.0.0" = _tS0nnF79;
        "pkg-1.20.6-2.3.0.1" = _dKfaK3XA;
        "pkg-1.21-3.0.0.0" = _rsuPIMiY;
        "pkg-1.21-3.1.0.0" = _Ec3PmLEc;
        "pkg-1.20.6-2.4.0.0" = _dfHtjdao;
        "pkg-1.21-3.1.1.0" = _IXP9Kr8G;
        "pkg-1.21-3.1.2.0" = _La2AgVHT;
        "pkg-1.20.6-2.4.1.0" = _CdPajkyc;
        "pkg-1.20.4-2.2.1.0" = _hc1nruge;
        "pkg-1.21-3.2.0.0" = _ry27ktba;
        "pkg-1.21-3.2.0.1" = _oWvhNQTA;
        "pkg-1.21-3.2.0.2" = _bBG72mEB;
        "pkg-1.21-3.2.1.0" = _us77oqV6;
        "pkg-1.21.3-3.3.0.0" = _pp6cTDjt;
        "pkg-1.21.4-3.4.0.0" = _xVr0lYWc;
        "pkg-1.20.1-1.9.0.1" = _gzghNUtI;
        "pkg-1.20.4-2.2.1.1" = _L249VJif;
        "pkg-1.21.4-3.4.0.1" = _UZh47fIv;
        "pkg-1.21.3-3.3.0.1" = _YgQZpbg4;
        "pkg-1.21-3.2.1.1" = _K129H4ix;
        "pkg-1.20.6-2.4.1.1" = _Hjp7Xa8K;
        "pkg-1.21.6-3.5.0.0" = _ig3EfcZv;
        "pkg-1.21.9-3.6.0.0" = _DlmbxbTH;
        "pkg-1.21.6-3.5.0.1" = _PlWfyuXn;
        "pkg-1.21.9-3.6.0.1" = _hYn2BGL4;
        "pkg-1.21.11-3.7.0.0" = _8WrSDoDD;
        "pkg-26.1-4.0.0.0" = _vpOIxkAh;
        "pkg-1.21.11-3.7.1.0" = _GR00OaUO;
