...
let
    ...
    in {
        ...
        "pkg-1.16.4-0.2.0" = _jwiXOJRY;
        "pkg-1.16.4-0.2.1" = _wT5iScHE;
        "pkg-1.16.4-0.2.2" = _kqM7UUXk;
        "pkg-1.16.4-0.2.3" = _wyhQdfVU;
        "pkg-1.16.4-fabric-0.2.3" = _gH0vttT4;
        "pkg-1.17.1-fabric-0.2.3" = _pytV6rNB;
        "pkg-1.17.1-0.2.3" = _3tkgzTRz;
        "pkg-1.16.4-fabric-0.3.0" = _xFZukrZe;
        "pkg-1.16.5-0.3.0" = _pImZCIy4;
        "pkg-1.17.1-fabric-0.3.0" = _7WIQuuev;
        "pkg-1.17.1-0.3.0" = _mgizhwhC;
        "pkg-1.18.1-fabric-0.3.0" = _7mHEmbk4;
        "pkg-1.18.1-0.3.0" = _2JBPZXDM;
        "pkg-1.16.4-fabric-0.3.1" = _lj3udG8h;
        "pkg-1.16.5-0.3.1" = _naWKjxbJ;
        "pkg-1.17.1-fabric-0.3.1" = _591oIhoI;
        "pkg-1.17.1-0.3.1" = _UyQCc4Wb;
        "pkg-1.18.1-fabric-0.3.1" = _ESuKPpx8;
        "pkg-1.18.1-0.3.1" = _WEaKHBHU;
        "pkg-1.16.4-fabric-0.3.2" = _QiWDEHkX;
        "pkg-1.16.5-0.3.2" = _V2W2fAuQ;
        "pkg-1.17.1-fabric-0.3.2" = _vTWJ85ns;
        "pkg-1.17.1-0.3.2" = _VuvWUkga;
        "pkg-1.18.1-fabric-0.3.2" = _zV5obMYt;
        "pkg-1.18.1-0.3.2" = _WYx8m90z;
        "pkg-1.18.2-0.3.3-preview" = _Etgd7vfY;
        "pkg-1.18.2-fabric-0.3.3-preview" = _QEG3BkdH;
        "pkg-1.16.5-0.3.3" = _N5Y0KGh0;
        "pkg-1.17.1-0.3.3" = _s8TJSB0I;
        "pkg-1.18.2-0.3.3" = _PhaexPLL;
        "pkg-1.19.2-0.3.3" = _vSciizAJ;
        "pkg-1.19-0.3.3" = _hbminbfj;
        "pkg-1.19.3-0.3.3" = _QLYttbcD;
        "pkg-1.19.4-0.3.3" = _P2UpGBuw;
        "pkg-1.20-0.3.3" = _9jfF5nMh;
        "pkg-1.16.4-0.4.0" = _ML6zmbWA;
        "pkg-1.17.1-0.4.0" = _YIhRokUw;
        "pkg-1.18-0.4.0" = _QMXiMdlk;
        "pkg-1.19-0.4.0" = _6wCbbSCH;
        "pkg-1.19.3-0.4.0" = _mL80TMvI;
        "pkg-1.19.4-0.4.0" = _X11C72xZ;
        "pkg-1.20-0.4.0" = _10NmWxeV;
        "pkg-1.20.2-0.4.0" = _9korWr01;
        "pkg-1.20.4-0.4.0" = _N1jgGDYi;
        "pkg-1.16.4-0.4.1" = _UerJuogC;
        "pkg-1.17.1-0.4.1" = _Txzp16JC;
        "pkg-1.18-0.4.1" = _fV6cRQNE;
        "pkg-1.19-0.4.1" = _ksXxPZ6b;
        "pkg-1.19.3-0.4.1" = _5rgjZRse;
        "pkg-1.19.4-0.4.1" = _wu5jyv8A;
        "pkg-1.20-0.4.1" = _t1IvYtuQ;
        "pkg-1.20.2-0.4.1" = _hCWPZ2QK;
        "pkg-1.20.4-0.4.1" = _BIsdNXi9;
        "pkg-1.20.6-0.4.1" = _GnYV2oKR;
        "pkg-1.21-0.4.1" = _KfEZQHpq;
        "pkg-1.17.1-0.4.2" = _Gn5cjD4b;
        "pkg-1.18-0.4.2" = _TP4472Ye;
        "pkg-1.19-0.4.2" = _EuxjvPcW;
        "pkg-1.19.3-0.4.2" = _7a0Ac2bv;
        "pkg-1.19.4-0.4.2" = _Hm8X9BAP;
        "pkg-1.20-0.4.2" = _lX8Ac45x;
        "pkg-1.20.2-0.4.2" = _yNj4mTdt;
        "pkg-1.20.4-0.4.2" = _kFWuSjcB;
        "pkg-1.20.6-0.4.2" = _ItSlOgfF;
        "pkg-1.21-0.4.2" = _GUeBj8XD;
        "pkg-1.17.1-0.4.3" = _fONNJlTW;
        "pkg-1.18-0.4.3" = _ADGBJpg0;
        "pkg-1.19-0.4.3" = _sIl3GcSr;
        "pkg-1.19.3-0.4.3" = _9ufzPbdK;
        "pkg-1.19.4-0.4.3" = _ftpSSV6q;
        "pkg-1.20-0.4.3" = _NcSuWCai;
        "pkg-1.20.2-0.4.3" = _s9gu13TT;
        "pkg-1.20.4-0.4.3" = _kydTofWZ;
        "pkg-1.20.6-0.4.3" = _RMyhmk1t;
        "pkg-1.21-0.4.3" = _LNm1O6ca;
        "pkg-0.4.4-1.17.1" = _jzxdp4DC;
        "pkg-0.4.4-1.18" = _T7kkIPNx;
        "pkg-0.4.4-1.19" = _wLhyOEfg;
        "pkg-0.4.4-1.19.3" = _UNmZH14s;
        "pkg-0.4.4-1.19.4" = _5PUjgdjY;
        "pkg-0.4.4-1.20" = _UlLeMuqu;
        "pkg-0.4.4-1.20.2" = _4IqqxhhJ;
        "pkg-0.4.4-1.20.4" = _71o69L2b;
        "pkg-0.4.4-1.20.6" = _IOSq1O17;
        "pkg-0.4.4-1.21" = _GRzoByng;
        "pkg-0.4.4-1.21.3" = _tNEXeBfz;
        "pkg-0.4.5-1.17.1" = _Ln0IErIW;
        "pkg-0.4.5-1.18" = _Swubftca;
        "pkg-0.4.5-1.19" = _iC8JydYe;
        "pkg-0.4.5-1.19.3" = _fhXFrjpE;
        "pkg-0.4.5-1.19.4" = _kT8SbBTb;
        "pkg-0.4.5-1.20" = _LUtKbaBz;
        "pkg-0.4.5-1.20.2" = _foP9C2FV;
        "pkg-0.4.5-1.20.4" = _P14uU4vV;
        "pkg-0.4.5-1.20.6" = _zOsBfKtx;
        "pkg-0.4.5-1.21" = _nsIixhrC;
        "pkg-0.4.5-1.21.3" = _ycg1l66r;
        "pkg-0.4.5-1.21.5" = _cG2rQaAb;
        "pkg-0.4.6-1.17.1" = _q8jT7bQO;
        "pkg-0.4.6-1.18" = _f0xWv8cC;
        "pkg-0.4.6-1.19" = _WdQhV75T;
        "pkg-0.4.6-1.19.3" = _m21GcnXn;
        "pkg-0.4.6-1.19.4" = _k9w0KbAe;
        "pkg-0.4.6-1.20" = _bsFiRyZS;
        "pkg-0.4.6" = _YFvfOw5i;
        "pkg-0.4.6-1.20.6" = _kJKhQKpK;
        "pkg-0.4.6-1.21" = _PdCao5sd;
        "pkg-0.4.6-1.21.3" = _DP1Y3kjt;
        "pkg-0.4.6-1.21.4" = _M8COfura;
        "pkg-0.4.6-1.21.5" = _2mlsEGLN;
        "pkg-0.4.6-1.21.8" = _YZeALta0;
        "pkg-0.4.7-1.20" = _i4qsoaOP;
        "pkg-0.4.7-1.20.2" = _2jGDQ8p1;
        "pkg-0.4.7-1.20.4" = _w8vUdFoZ;
        "pkg-0.4.7-1.20.6" = _csfYcAug;
        "pkg-0.4.7-1.21" = _vCytMICO;
        "pkg-0.4.7-1.21.3" = _7KGcd7qr;
        "pkg-0.4.7-1.21.4" = _QjG3Bc5H;
        "pkg-0.4.7-1.21.5" = _Xn3dm3TM;
        "pkg-0.4.7-1.21.8" = _FgF2yItb;
        "pkg-0.4.7-1.21.10-rev1" = _THLELRGE;
        "pkg-0.4.7-1.21.11" = _nNEtTIBh;
        "pkg-0.4.8-1.20" = _2twOaUqc;
        "pkg-0.4.8-1.20.2" = _TJvjTPyq;
        "pkg-0.4.8-1.20.4" = _WmjzheYj;
        "pkg-0.4.8-1.20.6" = _7GvX6T4k;
        "pkg-0.4.8-1.21" = _FAqppP3u;
        "pkg-0.4.8-1.21.3" = _f4rx6lDP;
        "pkg-0.4.8-1.21.4" = _5YWBa4mI;
        "pkg-0.4.8-1.21.5" = _V0XCx5ev;
        "pkg-0.4.8-1.21.8" = _ioYxioJl;
        "pkg-0.4.8-1.21.10" = _lt9l6vkw;
        "pkg-0.4.8-1.21.11" = _Lmp8lli5;
        "pkg-0.4.8-26.1.2" = _ZnyrUe3T;
        "pkg-0.4.8-26.2" = _rKXwD5G9;
        "pkg-0.4.9-1.20" = _5Brt5UEX;
        "pkg-0.4.9-1.20.2" = _2Jq2JHtM;
        "pkg-0.4.9-1.20.4" = _MfyOPfQE;
        "pkg-0.4.9-1.20.6" = _CdoOeRDx;
        "pkg-0.4.9-1.21" = _wxmM0C4H;
        "pkg-0.4.9-1.21.3" = _GiYSKxtO;
        "pkg-0.4.9-1.21.4" = _EL86zY3E;
        "pkg-0.4.9-1.21.5" = _1VskD6pK;
        "pkg-0.4.9-1.21.8" = _5gJQILQ4;
        "pkg-0.4.9-1.21.10" = _iT4Vw5vp;
