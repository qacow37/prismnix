...
let
    ...
    in {
        ...
        "pkg-2.0.0" = _lzhLAc8R;
        "pkg-2.0.1" = _owA4vrOI;
        "pkg-2.0.1.1" = _1LkaOBFy;
        "pkg-2.1.0-forge" = _ayir8DYF;
        "pkg-2.1.0-fabric" = _zLndoZLG;
        "pkg-2.2.0-forge" = _clbVgzAY;
        "pkg-2.2.0-fabric" = _95UkKccg;
        "pkg-2.3.0-fabric" = _S8tYZWD0;
        "pkg-2.4.0-forge" = _6XRNdJBU;
        "pkg-2.4.0-fabric" = _WiP1bPwu;
        "pkg-2.4.1-forge" = _LJ2VXJr3;
        "pkg-2.4.1-fabric" = _NCOoalqo;
        "pkg-2.4.2-forge" = _tmlMHd9D;
        "pkg-2.4.2-fabric" = _7wwNfUlt;
        "pkg-2.5.0-forge" = _IltyB8tC;
        "pkg-2.5.0-fabric" = _bMHfsLnM;
        "pkg-1.0.2+mc.1.18.1-forge" = _KTqSBQzP;
        "pkg-1.0.2+mc.1.18.1-fabric" = _dZHG2ybx;
        "pkg-1.0.2+mc.1.17.1-forge" = _uzDSJY3E;
        "pkg-1.0.2+mc.1.17.1-fabric" = _DfZsSATj;
        "pkg-1.0.2+mc.1.16.5-forge" = _nqR2Ixbv;
        "pkg-1.0.2+mc.1.16.5-fabric" = _pjVFsMZ4;
        "pkg-1.0.2+mc.1.8.9-legacyfabric" = _FycsJ5jw;
        "pkg-1.0.2+mc.1.8.9-forge" = _CX2EC58Y;
        "pkg-2.6.0-mc.1.20.2-forge" = _ChDcsIAl;
        "pkg-2.6.0-mc.1.20.2-neoforge" = _Zz4KGKrp;
        "pkg-2.6.0-mc.1.20.2-fabric" = _5s5jCU3l;
        "pkg-2.7.0-mc.1.20.4-forge" = _MrXWfWPq;
        "pkg-2.7.0-mc.1.20.4-neoforge" = _TMGklCPI;
        "pkg-2.7.0-mc.1.20.4-fabric" = _kUEWiiQG;
        "pkg-2.7.0-DOS-mc.1.20.4-forge" = _mmxw97VE;
        "pkg-2.7.0-DOS-mc.1.20.4-neoforge" = _Rp7iprT8;
        "pkg-2.7.0-DOS-mc.1.20.4-fabric" = _adUxLDdM;
        "pkg-2.8.0+mc.1.20.5-fabric" = _wAhELMi6;
        "pkg-2.8.0+mc.1.20.5-neoforge" = _L9DBrhpn;
        "pkg-3.0.0-fabric" = _XT6ga09K;
        "pkg-3.0.0-neoforge" = _qmbTWUIx;
        "pkg-0.1+1.12.2-legacyfabric" = _7384uk4Q;
        "pkg-0.1+1.11.2-legacyfabric" = _QzEjgpcG;
        "pkg-0.1+1.10.2-legacyfabric" = _n59jsuQQ;
        "pkg-0.1+1.9.4-legacyfabric" = _MbRZHTrP;
        "pkg-0.1+1.8-legacyfabric" = _EYP38Z0O;
        "pkg-0.1+1.7.10-legacyfabric" = _m4CqFVN2;
        "pkg-0.1+1.6.4-legacyfabric" = _iaTHwYUa;
        "pkg-0.1+1.5.2-legacyfabric" = _GLpEBSyM;
        "pkg-0.1+1.4.7-legacyfabric" = _2jw3Hbx4;
        "pkg-0.1+1.3.2-legacyfabric" = _ZRaNOgqT;
        "pkg-3.0.1" = _VPxz2zIR;
        "pkg-3.1.0" = _k4D902pa;
        "pkg-3.1.0-hotfix.1" = _mIbhpaX2;
        "pkg-3.2.0" = _Vf1YukfS;
        "pkg-3.3.0" = _amQebF69;
        "pkg-3.4.0" = _h8K4ZvjM;
        "pkg-4.0.0-fabric+1.18.2" = _R7pZdNRj;
        "pkg-4.0.0-fabric+1.19.2" = _OSf2XpIS;
        "pkg-4.0.0-fabric+1.19.4" = _SOuZ5dDN;
        "pkg-4.0.0-fabric+1.20.1" = _Ji3BSFIz;
        "pkg-4.0.0-fabric+1.20.4" = _eDV5pmO3;
        "pkg-4.0.0-fabric+1.21.1" = _bLBArGhD;
        "pkg-4.0.0-fabric+1.21.7" = _nbSaMjZT;
        "pkg-4.0.0-fabric+26.1.2" = _x9xh7tCv;
        "pkg-4.0.0-fabric+26.2" = _a3oD75eA;
        "pkg-4.0.0-neoforge+1.21.1" = _envoap2x;
        "pkg-4.0.0-neoforge+1.21.7" = _pdEFwXKp;
        "pkg-4.0.0-neoforge+26.1.2" = _t7Z2eAf9;
        "pkg-4.0.0-neoforge+26.2" = _rLfFstur;
        "default" = _rLfFstur;
    });
