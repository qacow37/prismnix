...
let
    ...
    in {
        ...
        "pkg-0.1.2-mc1.18.2-forge" = _dH85itXF;
        "pkg-0.1.2-mc1.18.2-fabric" = _nDvzslEd;
        "pkg-0.1.0-mc1.20.1-forge" = _XnqOHs5W;
        "pkg-0.1.0-mc1.20.1-fabric" = _k5HQyebI;
        "pkg-0.1.4-mc1.18.2-forge" = _5XWDh3UT;
        "pkg-0.1.4-mc1.18.2-fabric" = _YXH1bz93;
        "pkg-0.1.1-mc1.20.1-forge" = _dHWSN4uq;
        "pkg-0.1.1-mc1.20.4-fabric" = _46VA9CHR;
        "pkg-0.1.1-mc1.20.4-neoforge" = _mzwzgJjv;
        "pkg-0.1.6-mc1.18.2-forge" = _Nb7DQjHJ;
        "pkg-0.1.6-mc1.18.2-fabric" = _4mQQmW89;
        "pkg-0.1.2-mc1.20.1-forge" = _zjAKaOah;
        "pkg-0.1.2-mc1.20.4-fabric" = _VjSCPLdc;
        "pkg-0.1.2-mc1.20.4-neoforge" = _btQIxmWW;
        "pkg-0.2.0-mc1.18.2-forge" = _OkPNX7j9;
        "pkg-0.2.0-mc1.18.2-fabric" = _Ffl4DwE9;
        "pkg-0.2.0-mc1.20.1-forge" = _UUuMgIMr;
        "pkg-0.2.0-mc1.20.4-fabric" = _g1n1oB2D;
        "pkg-0.2.0-mc1.20.4-neoforge" = _2Jv8jU06;
        "pkg-0.2.1-mc1.18.2-forge" = _swbWaKRB;
        "pkg-0.2.1-mc1.18.2-fabric" = _baA5vyaa;
        "pkg-0.2.1-mc1.20.1-forge" = _o9jVI9V1;
        "pkg-0.2.1-mc1.20.4-fabric" = _BuMNQJqR;
        "pkg-0.2.1-mc1.20.4-neoforge" = _Cy4zCTz4;
        "pkg-0.1.0-mc1.20.6-fabric" = _QrxpuanU;
        "pkg-0.1.0-mc1.20.6-neoforge" = _YUVvIH8B;
        "default" = _YUVvIH8B;
    });
