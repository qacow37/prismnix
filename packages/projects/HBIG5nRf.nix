...
let
    ...
    in {
        ...
        "pkg-2.3.3" = _T78JPXUb;
        "pkg-2.4.0" = _YE2a2dE4;
        "pkg-3.0.0+fabric" = _tC6qI6y5;
        "pkg-2.5.0" = _aw7SZSue;
        "pkg-2.5.1" = _MScHZyce;
        "pkg-3.1.0+fabric" = _8YBQJubA;
        "pkg-3.1.0+neoforge" = _69LjvGme;
        "pkg-3.2.0+fabric" = _d5J9w2NZ;
        "pkg-3.1.1+neoforge" = _LKgwcxze;
        "pkg-3.2.1+neoforge" = _YmMAan2W;
        "pkg-3.2.1+fabric" = _bBcmTgIr;
        "pkg-2.5.2+forge" = _NCK1yWRS;
        "pkg-2.5.3+fabric" = _JSi3tfCy;
        "pkg-2.5.4+fabric" = _K7xaTxzc;
        "pkg-3.2.2+fabric" = _BYu6qpeY;
        "pkg-2.5.4+forge" = _B0lm1Mcy;
        "pkg-3.2.2+neoforge" = _hF0Zpoh9;
        "pkg-3.2.3+fabric" = _x5aApexA;
        "pkg-3.2.3+neoforge" = _KF9W8Z1P;
        "default" = _KF9W8Z1P;
    });
