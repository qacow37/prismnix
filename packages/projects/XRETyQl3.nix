...
let
    ...
    in {
        ...
        "pkg-forge-1.18.2-1.0.0" = _SXQZvH5g;
        "pkg-forge-1.19.1-1.0.0" = _ZdXCT8T6;
        "pkg-forge-1.19.2-1.0.0" = _N8xJGYfB;
        "pkg-forge-1.19.3-1.0.0" = _GyBnmueH;
        "pkg-forge-1.19.3-1.0.1" = _8V3N2Qgn;
        "pkg-forge-1.19.3-1.0.2" = _FSQElUhJ;
        "pkg-forge-1.19.4-1.0.2" = _XymabmJC;
        "pkg-forge-1.20-1.0.2" = _WbnMDPNa;
        "pkg-forge-1.20.1-1.0.2" = _Z0JJEOMS;
        "pkg-forge-1.20.1-1.0.3" = _4dWA2Tgt;
        "pkg-forge-1.19.2-1.0.40" = _uY5JLHwq;
        "pkg-forge-1.19.4-1.0.4" = _uOr5pDnY;
        "pkg-forge-1.20.1-1.0.4" = _opIBLugU;
        "pkg-forge-1.20.2-1.0.4" = _X765IKCG;
        "pkg-neoforge-1.20.2-1.0.4" = _z6N8PxdC;
        "pkg-neoforge-1.20.2-1.0.5" = _Hq44iG2L;
        "pkg-neoforge-1.20.3-1.0.5" = _nVblnKfO;
        "pkg-neoforge-1.20.4-1.0.5" = _M4TiiWNa;
        "pkg-forge-1.19.2-1.1.0" = _yBpEWUls;
        "pkg-forge-1.20.1-1.1.0" = _SfCtwxcf;
        "pkg-neoforge-1.20.4-1.1.0" = _XxZbK6Fd;
        "pkg-neoforge-1.20.4-1.1.1" = _SGd1Hn8c;
        "default" = _SGd1Hn8c;
    });
