...
let
    ...
    in {
        ...
        "pkg-v1.0.0+1.7.10" = _5w5k9ckA;
        "pkg-v1.0.1+1.7.10" = _ySPyJaEB;
        "pkg-v1.0.2+1.7.10" = _aHs4dNxE;
        "pkg-v1.0.2+1.12.2" = _G6v1SDfi;
        "pkg-v1.0.4+1.12.2" = _J4tqQReO;
        "pkg-v1.0.5+1.12.2" = _7Q1EINvK;
        "pkg-v1.0.6+1.12.2" = _pRBZG7T5;
        "pkg-v1.0.6+1.19.x.fabric" = _ottDqgFS;
        "pkg-v1.0.6+1.18.x.fabric" = _IRZaOPch;
        "pkg-v1.0.6+1.17.x.fabric" = _8bBWQf8u;
        "pkg-v1.0.7+1.19.x.fabric" = _SoBDDlNV;
        "pkg-v1.0.8+1.19.x.fabric" = _uROVvrYT;
        "pkg-v1.0.9+1.19.x.fabric" = _Z7OpVgby;
        "pkg-v1.0.10+1.7.10" = _U1jFbh6l;
        "pkg-v1.0.10+1.12.2" = _AnIc1h0O;
        "pkg-v1.0.10+1.17.x.fabric" = _tmRbfCTy;
        "pkg-v1.0.10+1.18.x.fabric" = _b9NkY6Zg;
        "pkg-v1.0.10+1.19.2.fabric" = _mc6XUwYK;
        "pkg-v1.0.10+1.19.x.fabric" = _idqHiCsG;
        "pkg-v1.0.11+1.19.x.fabric" = _2H2LP6Ag;
        "pkg-1.0.10+1.16.x.forge" = _DVovJWoi;
        "pkg-1.0.11+1.16.x.forge" = _SBco8xEX;
        "pkg-1.0.11+1.17.x.forge" = _Wpj461Eo;
        "pkg-1.0.11+1.18.x.forge" = _dlNEjJ70;
        "pkg-1.0.11+1.19.2.forge" = _DrzKMLVS;
        "pkg-1.0.11+1.19.3.forge" = _sivD9eDj;
        "pkg-1.0.11+1.19.x.forge" = _C5H8GpyH;
        "pkg-1.0.11+1.20.x" = _AaB1oW9s;
        "pkg-1.0.11+1.20.x.forge" = _d9cgnHpk;
        "pkg-1.0.12+1.16.x.forge" = _RClfaX0a;
        "pkg-1.0.12+1.17.x.forge" = _wGx3QkFy;
        "pkg-1.0.12+1.18.x.forge" = _ucdmvdzx;
        "pkg-1.0.12+1.19.2.forge" = _oS7NYsov;
        "pkg-1.0.12+1.19.3.forge" = _8xgpDfeQ;
        "pkg-1.0.12+1.19.x.forge" = _FtrjY68b;
        "pkg-1.0.12+1.20.x.forge" = _zga9j85i;
        "pkg-1.0.13+1.20.x.forge" = _2xmHvaN5;
        "default" = _2xmHvaN5;
    });
