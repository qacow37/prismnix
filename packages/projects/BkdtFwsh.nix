...
let
    ...
    in {
        ...
        "pkg-2.5.8" = _3J5Qd294;
        "pkg-2.5.9" = _INRkYhAC;
        "pkg-2.5.10" = _9fl9cIrY;
        "pkg-2.5.11" = _mqJkmpud;
        "pkg-2.6.0" = _5V3B7Pwy;
        "pkg-2.7.0" = _RkrAc1co;
        "pkg-2.7.1" = _boU3OHfT;
        "pkg-2.7.3" = _2CphufxV;
        ...
        "pkg-2.9.1" = _84tqoFxc;
        "pkg-2.9.2" = _KrsljEfo;
        "pkg-2.10.0" = _o7gu3ce5;
        "pkg-2.10.4" = _AxEHwRvA;
        "pkg-2.10.5" = _EaYy2q2l;
        "pkg-2.10.6" = _sOb25Q7H;
        "pkg-2.10.7" = _mQiBwsoU;
        "pkg-2.10.11" = _dz7yfPgA;
        "pkg-2.11.1" = _ZoOrqdhi;
        "pkg-2.11.2" = _Y35nVYey;
        "pkg-2.11.3" = _ITy3aSVt;
        "pkg-2.11.4" = _n8GvRuMe;
        "pkg-2.11.6" = _8WHKVjaP;
        "pkg-2.11.7" = _UDzpt5Wu;
        "pkg-2.11.8" = _V46fWcQx;
        "pkg-2.11.9" = _RVZoVZQC;
        "pkg-2.11.10" = _Q9WcGeNg;
        "pkg-2.11.11" = _8blRoN5a;
        "pkg-2.11.12" = _ALtuqpYb;
        "pkg-2.11.13" = _xBvZB4Ql;
        "pkg-2.11.14" = _iqX9o9Be;
        "pkg-2.11.15" = _BZ6JXSX2;
        "pkg-2.11.16" = _bQv7Ufx1;
        "pkg-2.11.17" = _hPZLoc4o;
        "pkg-2.11.18" = _IuKWYfok;
        "pkg-2.11.19" = _MzofkYRU;
        "pkg-2.11.20" = _Q8lIMI6a;
        "pkg-2.11.21" = _FWoMBDR3;
        "pkg-2.11.22" = _MwAtKzKk;
        "pkg-2.11.23" = _brtS6ur9;
        "pkg-2.11.23.1" = _X35huMJN;
        "pkg-2.11.23.2" = _kYHvrPbC;
        "pkg-2.11.23.3" = _CKBMkoIi;
        "pkg-2.11.23.4" = _BEIyWZe5;
        "pkg-2.11.23.5" = _zOzVwJJY;
        "pkg-2.11.24" = _Gdr4YtCc;
        "pkg-2.11.25" = _sC4peW2A;
        "pkg-2.11.26" = _oOGCNs3F;
        "pkg-2.11.27" = _Mh1auqmZ;
        "pkg-2.11.28" = _orqEzppM;
        "default" = _orqEzppM;
    });
