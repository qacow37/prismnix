...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _TCLrVM70;
        "pkg-2.0" = _AMhYlnHy;
        "pkg-1.5.0-1.21" = _u7KXY4iN;
        "pkg-fabric-1.1.0" = _6AdSqi2L;
        "pkg-1.5.1-1.21" = _CeN4YvBI;
        "pkg-2.0.1" = _ijL1zyaf;
        "pkg-fabric-1.1.2" = _oRmsz98j;
        "pkg-2.0.2" = _W8gytv4S;
        "pkg-fabric-1.1.3" = _EQtl1QoH;
        "pkg-1.5.2-1.21" = _VjgmSGcG;
        "pkg-1.5.3-1.21" = _MNg8LDzF;
        "pkg-2.0.3" = _Kxlebul1;
        "pkg-fabric-1.1.4" = _DrXfR2cX;
        "pkg-1.5.4-1.21" = _CNLq43L0;
        "pkg-fabric-1.1.5" = _hwHIsiRB;
        "pkg-2.0.4" = _HWSDK8wm;
        "pkg-2.0.5" = _9o1k1eh8;
        "pkg-fabric-1.1.6" = _mpPNsSdH;
        "pkg-1.5.5-1.21" = _J73vO6fb;
        "pkg-2.0.6" = _FO4Tkdg7;
        "pkg-fabric-2.0.6" = _FM6rp5uk;
        "pkg-2.0.6-1.21" = _bONLjo8s;
        "pkg-2.0.7" = _3cUAUNmI;
        "pkg-2.0.7-1.21" = _IkttXpBE;
        "pkg-fabric-2.0.7" = _CgGQYDgh;
        "pkg-2.0.8" = _hjBCjHby;
        "pkg-fabric-2.0.8" = _TOdgBnpq;
        "pkg-2.0.8-1.21" = _M4k6Q4Pf;
        "pkg-fabric-2.0.9" = _TnIKAUXC;
        "pkg-2.0.9-1.21" = _EtlcTmga;
        "pkg-2.0.9" = _LKbqt2YM;
        "pkg-2.1" = _An41rAeT;
        "pkg-fabric-2.1" = _5L2SwT0Q;
        "pkg-2.1-1.21" = _wxYXtamf;
        "pkg-2.1.1" = _Tn1mphw7;
        "pkg-2.1.1-1.21" = _3yM5dGxV;
        "pkg-fabric-2.1.1" = _HOozXEGD;
        "pkg-2.1.2" = _GwEDZM9q;
        "pkg-fabric-2.1.2" = _7cl4WgEG;
        "pkg-2.1.2-1.21" = _lqQQmq3l;
        "pkg-2.1.3" = _bu3mxTjj;
        "pkg-fabric-2.1.3" = _BS9BU2Na;
        "pkg-2.1.3-1.21" = _DYi26sH1;
        "pkg-fabric-2.1.4" = _e3K2Q1iD;
        "pkg-2.1.4" = _Vi35ZZ8p;
        "pkg-2.1.4-1.21" = _9lIeemdi;
        "pkg-2.1.5" = _CUBc511r;
        "pkg-2.1.5-1.21" = _Gpy5RSUa;
        "pkg-fabric-2.1.5" = _4hw02k9D;
        "pkg-2.1.7" = _lQStCMMW;
        "pkg-2.1.8-1.20.1" = _lKTnXnAJ;
        "pkg-2.1.8" = _EY5vWmht;
        "pkg-fabric-2.1.8" = _Y1CE2T3n;
        "pkg-2.1.8-1.21" = _lhHwOKE5;
        "pkg-2.1.9" = _OsqQwfjm;
        "pkg-2.1.9-1.20.1" = _BeLxl5Ml;
        "pkg-2.1.9-1.21" = _6VdHV6Zw;
        "pkg-fabric-2.1.9" = _a60a0NA2;
        "pkg-fabric-2.2" = _Q47ZH9Vp;
        "pkg-2.2-1.21" = _fdd6ueSG;
        "pkg-2.2" = _ye84zUOJ;
        "pkg-2.2-1.20.1" = _kVqx9Lev;
        "pkg-2.2.1" = _1N2B48Zs;
        "pkg-fabric-2.2.1" = _G7m1N208;
        "pkg-2.2.1-neoforge" = _hctgcJ1y;
        "pkg-2.2.1-1.21" = _veo8APnb;
        "pkg-2.3.0-1.20.1" = _63EBugn0;
        "pkg-2.3.0" = _FAftPiU3;
