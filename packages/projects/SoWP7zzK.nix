...
let
    ...
    in {
        ...
        "pkg-1.16.5-0.3.0-0" = _aZNlUbdj;
        "pkg-1.17.1-0.3.1-0" = _ZmvRn6I7;
        "pkg-1.18.2-0.4.2-5" = _9Ds1iTS7;
        "pkg-1.19.2-0.5.2-3" = _neZl6EI8;
        "pkg-1.20.1-0.6.0-0" = _62iIJDJV;
        "pkg-1.20.1-0.6.0-1" = _RJhRDLME;
        "pkg-1.20.1-0.6.0-2" = _1VTuVvSx;
        "pkg-1.16.5-0.3.1-0" = _Fx3WG9Z6;
        "pkg-1.18.2-0.4.3-0" = _IpghgTjC;
        "pkg-1.19.2-0.5.3-0" = _FIvwuyRr;
        "pkg-1.20.1-0.6.0-3" = _R2FQoGsO;
        "pkg-1.21.1-0.7.0-0" = _ZA1xu9vy;
        "pkg-1.21.1-0.7.0-1" = _PwFDVqAa;
        "pkg-1.16.5-0.3.2-0" = _QZQf9QPi;
        "pkg-1.18.2-0.4.4-0" = _f2KKacpb;
        "pkg-1.19.2-0.5.4-0" = _gmayzhQj;
        "pkg-1.20.1-0.6.1-0" = _49nLBW4H;
        "pkg-1.21.1-0.7.1-0" = _uidzDImt;
        "pkg-1.16.5-0.3.2-1" = _1IJZ3psx;
        "pkg-1.18.2-0.4.4-1" = _YAzxn8wi;
        "pkg-1.19.2-0.5.4-1" = _ezmPY5eo;
        "pkg-1.20.1-0.6.1-1" = _VhSNy5sZ;
        "pkg-1.21.1-0.8.0-0" = _DFiL921X;
        "pkg-1.21.1-0.8.0-1" = _NEt7ktq8;
        "pkg-1.20.1-0.8.0-1" = _TfofBshc;
        "pkg-1.20.1-0.8.1" = _so9CQIGl;
        "pkg-1.21.1-0.8.1" = _4rROhot9;
        "pkg-1.21.1-0.8.2" = _ItViY3Xu;
        "pkg-1.20.1-0.8.2" = _3hp810cK;
        "pkg-1.19.2-0.8.2" = _HnAsoorz;
        "default" = _HnAsoorz;
    });
