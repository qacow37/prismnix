...
let
    ...
    in {
        ...
        "pkg-(Forge-Fabric-1.20-1.20.6)-1.0" = _7q6h32z1;
        "pkg-(Forge-Fabric-1.20-1.20.6)-1.1" = _THmVXmPy;
        "pkg-(Forge-Fabric-1.20-1.20.6)-1.2" = _XtfkCL5H;
        "pkg-(Forge-Fabric-1.20-1.20.6)-1.3" = _8DEl23ED;
        "pkg-(Forge-Fabric-1.20.x)-1.3" = _WfxSZ2Ay;
        "pkg-(Forge-Fabric-1.21.x)-1.3" = _P45lDf5J;
        "pkg-(NeoForge-1.21.x)-1.3" = _M2zxTWRI;
        "pkg-(Forge-Fabric-1.20.x)-1.4" = _QfdPQlao;
        "pkg-(Forge-Fabric-1.21.x)-1.4" = _ZwDuZfEO;
        "pkg-(NeoForge-1.21.x)-1.4" = _HPXGmyDI;
        "pkg-(Forge-Fabric-1.20.x)-1.5" = _ZVxwER2u;
        "pkg-(Forge-Fabric-1.21.x)-1.5" = _wukzR6El;
        "pkg-(NeoForge-1.21.x)-1.5" = _nQ8aQ5ss;
        "pkg-(Forge-Fabric-1.20.x)-1.6" = _SH6syPKI;
        "pkg-(Forge-Fabric-1.21.x)-1.6" = _YyTR9koV;
        "pkg-(NeoForge-1.21.x)-1.6" = _39FwmL70;
        "pkg-(Forge-Fabric-1.20.x)-2.0" = _qoVlFegR;
        "pkg-(Forge-Fabric-1.21.x-26.1.x)-2.0" = _SOCe3AsI;
        "pkg-(NeoForge-1.21.x-26.1.x)-2.0" = _xi3rmFrb;
        "pkg-(Forge-Fabric-1.20.x)-2.0.1" = _cl5ysJqH;
        "pkg-(Forge-Fabric-1.21.x-26.2)-2.0.1" = _dUlscN05;
        "pkg-(NeoForge-1.21.x-26.2)-2.0.1" = _M1QffBRm;
        "pkg-(Forge-Fabric-1.20.x)-2.0.2" = _D6gOsZWH;
        "pkg-(Forge-Fabric-1.21.x-26.2)-2.0.2" = _lJu7Rp30;
        "default" = _lJu7Rp30;
    });
