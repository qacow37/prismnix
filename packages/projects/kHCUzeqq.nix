...
let
    ...
    in {
        ...
        "pkg-1+mod" = _EZNNflju;
        "pkg-1.1" = _dPIJrDNz;
        "pkg-1.1+mod" = _yEBGejxf;
        "pkg-1.2" = _MK3RW9OC;
        "pkg-1.2+mod" = _3BZIQTB0;
        "pkg-1.3" = _npcnkO3a;
        "pkg-1.3+mod" = _Kx0kxaTr;
        "pkg-1.4" = _A8Fihxfs;
        "pkg-1.4+mod" = _CAUGhZQm;
        "pkg-1.5-1.20.x" = _6R0OkAl5;
        "pkg-1.5-1.20.x+mod" = _xl4Vrorz;
        "pkg-1.5" = _vC04BkIG;
        "pkg-1.5+mod" = _UCCI0FfV;
        "pkg-1.5.1" = _r5F6FFzM;
        "pkg-1.5.1+mod" = _dm1o7FcR;
        "pkg-1.6" = _G1rJUNMZ;
        "pkg-1.6+mod" = _JGYvm3zn;
        "pkg-1.7" = _oLgCmPLZ;
