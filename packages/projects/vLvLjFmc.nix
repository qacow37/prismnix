...
let
    ...
    in {
        ...
        "pkg-1.12.3+1.19.4-pre1" = _hxH24s1L;
        "pkg-1.12.3+1.19.4-pre3" = _wKVLJYT9;
        "pkg-1.12.0+1.19.2" = _JxKMSi2y;
        "pkg-1.12.2+1.19.3" = _4g5Ut45G;
        "pkg-1.12.0+1.18.2" = _ESb2rfpz;
        "pkg-1.13.0+1.19.2" = _HOyyuJvu;
        "pkg-1.13.1+1.18.2" = _7wiiuAg7;
        "pkg-1.13.1+1.19.3" = _2sUZtDjB;
        "pkg-1.13.0+1.19.4" = _ZYC10kv8;
        "pkg-1.13.2+1.20" = _ZRxnXVCD;
        "pkg-1.13.3+1.19.4" = _AZpnKew2;
        "pkg-1.13.3+1.20.1" = _tXUsclZB;
        "pkg-1.13.3+1.20.2" = _rR1SAewG;
        "pkg-1.14.0+1.20.4" = _mDWIdDY7;
        "pkg-1.14.0+1.19.2" = _U4pCmWJC;
        "pkg-1.14.0+1.20.1" = _osmB10RS;
        "pkg-1.14.1+1.20.4" = _IsWig7dn;
        "pkg-1.14.1+1.20.1" = _1bo5VpLI;
        "pkg-1.14.1+1.20.5" = _Qwpogrdb;
        "pkg-1.14.1+1.20.2" = _pvmOzHat;
        "pkg-1.14.1+1.20.6" = _5SkYyVai;
        "pkg-1.14.3+1.21" = _w7wob3w8;
        "pkg-1.14.4+1.21.2" = _1P8plK05;
        "pkg-1.14.4+1.21.3" = _f4jW84ri;
        "pkg-1.14.4+1.21.4" = _5R7qjAQn;
        "pkg-1.14.5+1.21.4" = _D0TQPqXq;
        "pkg-1.13.4+1.20.2" = _5ePQ7pA8;
        "pkg-1.14.6+1.21.4" = _LuVUMbgU;
        "pkg-1.14.1-c+1.20.1" = _fKqIfSib;
        "pkg-1.14.3-c+1.21" = _mvPPLnbB;
        "pkg-1.14.6+1.21.5" = _H1991DgU;
        "pkg-1.14.6+1.21.6" = _iGOWsU6h;
        "pkg-1.14.7+1.21.7" = _qKdrvgh8;
        "pkg-1.14.7+1.21.8" = _FfTfDydL;
        "default" = _FfTfDydL;
    });
