...
let
    ...
    in {
        ...
        "pkg-1.2.0+1.21.1" = _mwB3gQeK;
        "pkg-1.2.0+1.21.4" = _gaQi8j7n;
        "pkg-2.0.0+1.21.5" = _mvTJ8L9U;
        "pkg-2.1.0+1.21.6" = _3V6Gj734;
        "pkg-2.1.1+1.21.6" = _rkU4x5r3;
        "pkg-2.2.0+1.21.7" = _oCxxJY5I;
        "pkg-3.0.0+1.21.10" = _pqB2Py7y;
        "pkg-3.1.0+1.21.10" = _IU3dNfb7;
        "pkg-4.0.0+1.21.11" = _JS9kCKnU;
        "pkg-5.0.0+26.1" = _YBKi9ZCi;
        "pkg-5.0.0+26.1.1" = _Zcbbi7ip;
        "pkg-5.0.0+26.1.2" = _a2Qt12J1;
        "pkg-5.1.0+26.2" = _QZ9gCOww;
        "pkg-5.1.0+1.21.11" = _wVyndgNo;
        "pkg-5.1.0+26.1" = _a6Za6IZ4;
        "pkg-5.1.0+26.1.1" = _zGJQFlP6;
        "pkg-5.1.0+26.1.2" = _MHckFCg6;
        "pkg-5.2.0+1.21.11" = _wFCnnyNA;
        "pkg-5.2.0+26.1" = _Ys87DGU5;
