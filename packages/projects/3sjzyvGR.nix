...
let
    ...
    in {
        ...
        "pkg-3.8.0.1" = _Jc9qsz2j;
        "pkg-3.8.0.2" = _u6EDJ7l2;
        "pkg-3.8.0.3" = _JP60uHaM;
        "pkg-3.8.0.4" = _Cev7EP0b;
        "pkg-3.8.1.1" = _YOw3sqUw;
        "pkg-3.8.1.2" = _KGsPVS4p;
        "pkg-3.8.1.3" = _a5p7q5pp;
        "pkg-3.8.1.4" = _wPcoVcDX;
        "pkg-3.8.1.5" = _fiYL31XK;
        "pkg-3.8.2.1" = _hgnEggW0;
        "pkg-3.8.2.2" = _IRhXWSci;
        "pkg-3.8.2.3" = _N1x7QLjw;
        "pkg-3.8.2.4" = _CQbVDRy6;
        "pkg-3.9.0.1" = _qDql2S2D;
        "pkg-3.9.0.2" = _sbLXftcL;
        "pkg-3.9.0.3" = _lCT4hGJY;
        "pkg-3.9.0.4" = _I8RJ9cJm;
        "pkg-3.9.0.5" = _RQEe9cqb;
        "pkg-3.10.0.1" = _dYjKP8ns;
        "pkg-3.10.0.2" = _IWvr0azn;
        "pkg-3.10.0.3" = _ST0uAuZt;
        "pkg-3.10.0.4" = _uUgsJY6x;
        "pkg-3.10.0.5" = _1v8T9T1i;
        "pkg-3.10.0.6" = _qhpv34gT;
        "pkg-3.10.1.1" = _CwJsJxWc;
        "pkg-3.10.1.2" = _ppM8v5tR;
        "pkg-3.10.1.3" = _rUm7qDwH;
        "pkg-3.10.1.4" = _Od6wiHsH;
        "pkg-3.10.1.5" = _EmQx4ZGk;
        "pkg-3.11.0.1" = _lzpOpVRz;
        "pkg-3.11.0.2" = _NSEeqlgu;
        "pkg-3.11.0.3" = _MHLy0x2e;
        "pkg-3.11.0.4" = _8fbdmoLe;
        "pkg-3.11.1.1" = _pljjL2SK;
        "pkg-3.11.1.2" = _SKoP2E2k;
        "pkg-3.11.1.3" = _U99mU1At;
        "pkg-3.11.1.4" = _9nao3cSK;
        "pkg-3.11.1.5" = _DCwtd4Rh;
        "pkg-3.11.1.6" = _Y0NqaFQx;
        "pkg-3.11.1.7" = _VmXTWblB;
        "pkg-3.11.1.8" = _qAE3kuAE;
        "pkg-3.11.1.9" = _wZq1RW34;
        "pkg-3.11.1.10" = _A6Dgf1rz;
        "pkg-3.11.1.11" = _J2bSvjmc;
        "pkg-3.12.0.1" = _X2Gc2jpP;
        "pkg-3.12.0.2" = _V0GW2YDN;
        "pkg-3.12.0.3" = _8ttmPfHK;
        "pkg-3.12.0.4" = _WKMJCR00;
        "pkg-3.13.0.1" = _ZNr1nosu;
        "pkg-3.13.0.3" = _WMWjwHj1;
        "pkg-3.13.0.4" = _LQ39AcMw;
        "pkg-3.13.0.5" = _uf6cAgLr;
        "default" = _uf6cAgLr;
    });
