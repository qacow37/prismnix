...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta.1" = _brAjPsmI;
        "pkg-1.0.0-beta.2" = _MXPtx9Ji;
        "pkg-1.0.0-beta.3" = _xRdkT4uQ;
        "pkg-1.0.0" = _J3dHn3LD;
        "pkg-1.1.0" = _9En9Loni;
        "pkg-1.1.1" = _poCruJmI;
        "pkg-1.1.2" = _yv7KxNw9;
        ...
        "pkg-1.1.7" = _3nnmJpPI;
        "pkg-1.2.0" = _xpgyRm6m;
        "pkg-2.0.0-beta" = _smOxCSOc;
        "pkg-2.0.1-beta" = _aIFIb6vE;
        "pkg-2.0.2-beta" = _nRiflGUp;
        "pkg-2.0.3-beta" = _AoZccJTw;
        "pkg-1.0.2" = _QzSL3Wdt;
        "pkg-2.0.4-beta" = _7szpQSwX;
        "pkg-2.0.5-beta" = _yvl7m2af;
        "pkg-2.1.0-beta" = _460A02Xs;
        "pkg-2.1.1-beta" = _Bdb8HLZ0;
        "default" = _Bdb8HLZ0;
    });
