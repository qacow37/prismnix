...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _ycPFNf1d;
        "pkg-1.10" = _ZVNhRX6r;
        "pkg-1.10.1" = _uJFFD3oh;
        "pkg-1.10.2" = _2OR6kvIr;
        "pkg-1.11" = _Ouk67tn6;
        "pkg-1.11.1" = _uhHe5kiM;
        "pkg-1.11.2" = _7ayeTI8y;
        "pkg-1.12" = _HtC4OYUr;
        "pkg-1.12.1" = _ufUfAIl1;
        "pkg-1.12.2" = _pyFApMWt;
        "pkg-1.13" = _YgobZ5Id;
        "pkg-1.14" = _AMhoVOXe;
        "pkg-1.14.1" = _jI6DIUU5;
        "pkg-1.15" = _fbebOlS8;
        "pkg-1.16" = _Uq2hhIaU;
        "pkg-1.16-pbj" = _lQkcmzii;
        "pkg-1.17" = _29vnLSM8;
        "pkg-1.17-pbj" = _FyTZ0C3k;
        "pkg-1.17.1" = _99Lun39s;
        "pkg-1.17.1-pbj" = _WLakN9lO;
        "pkg-1.17.2" = _FerGk1u4;
        "pkg-1.17.3" = _CbxC7nkf;
        "pkg-1.18" = _hXr2nTzW;
        "pkg-2b.0" = _oOjdQKy1;
