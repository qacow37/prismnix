...
let
    ...
    in {
        ...
        "pkg-2.2.0+1.16.5+forge" = _tsIbjijo;
        "pkg-2.2.0+1.18.x+forge" = _dDDSyNN7;
        "pkg-2.2.0+1.19.3+forge" = _AvDCdXgW;
        "pkg-2.2.0+1.19.4+forge" = _q5A0GaBM;
        "pkg-2.2.0+1.20.1+forge" = _RccPwfw7;
        "pkg-2.2.0+1.20.1+fabric" = _35nrO9rq;
        "pkg-2.1.0+1.19+fabric" = _7mKgyyfC;
        "pkg-2.1.1+1.19+forge" = _H7PbTMnC;
        "pkg-2.1.0+1.16.5+fabric" = _M2KyzNrr;
        "pkg-2.1.0+1.18.2+fabric" = _TBvQgOPU;
        "pkg-2.3.0+1.19.2+forge" = _sab5z8Ca;
        "pkg-2.2.1+1.20.1+fabric" = _Zpk9nHMB;
        "pkg-2.3.0+1.20.x+fabric" = _x38ZMwb1;
        "pkg-2.3.0+1.20.x+forge" = _M4NQZuns;
        "pkg-1.21+forge+2.3.0" = _ID1RsEoB;
        "pkg-1.21+fabric+2.3.0" = _i0FaxhAf;
        "pkg-1.21.3+forge+2.3.0" = _JrNYXOmo;
        "pkg-1.21.4+fabric+2.3.0" = _L1dAqDtW;
        "pkg-1.21.5+forge+2.3.0" = _rlQjPeEl;
        "pkg-1.21.5+fabric+2.3.0" = _Enw0o1J7;
        "pkg-1.21.6+forge+2.3.1" = _dnfVsvop;
        "pkg-1.21.6+fabric+2.3.1" = _OdnXv6Ju;
        "pkg-neoforge-1.21.7-2.3.1" = _vUGKbadg;
        "pkg-fabric-1.21.6-2.3.2" = _qbWctErM;
        "pkg-neoforge-1.21.10-2.3.2" = _3H5WOnl9;
        "pkg-forge-1.21.10-2.3.2" = _EOBhKy1Z;
        "pkg-fabric-1.21.10-2.3.2" = _8Nqs3wVT;
        "pkg-neoforge-1.21.11-2.3.2" = _wMV6VuUM;
        "pkg-forge-1.21.11-2.3.2" = _yNnDt7d0;
        "pkg-fabric-1.21.11-2.3.2" = _WCS6KKVZ;
        "pkg-neoforge-26.1.2-2.3.3" = _Zn49rm0v;
        "pkg-forge-26.1.2-2.3.3" = _n7qqr8Zx;
        "pkg-fabric-26.1.2-2.3.3" = _J8jxbgRH;
        "pkg-forge-26.2-2.3.3" = _cTZDmIsc;
        "pkg-neoforge-26.2-2.3.3" = _gjHiJz0O;
        "pkg-fabric-26.2-2.3.3" = _MDDMVQGh;
        "default" = _MDDMVQGh;
    });
