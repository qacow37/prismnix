...
let
    ...
    in {
        ...
        "pkg-2.1.2" = _iIGfhWqM;
        "pkg-2.1.3" = _4Yqc6Tk9;
        "pkg-2.1.3-PRE" = _1cLcsIK9;
        "pkg-2.1.3.1" = _C4NXC0vJ;
        "pkg-2.1.3.2" = _UAlnDqVT;
        "pkg-2.1.4" = _hRCcsYnD;
        "pkg-2.1.5" = _duZR19EW;
        "pkg-2.1.6" = _eJ5d9MMM;
        "pkg-2.1.7" = _QeFZIna2;
        "pkg-2.1.7.1" = _yh0VSgg3;
        "pkg-2.1.8" = _FxgYlQH2;
        "pkg-2.2" = _E7VLPcDw;
        "pkg-2.2.1" = _Li9zWICb;
        "pkg-2.2.2" = _mcFTUd8x;
        ...
        "pkg-2.2.4" = _aGYAe8Kf;
        "pkg-2.2.5" = _Kfcrn8ny;
        "pkg-2.2.5.1" = _aTouOSIV;
        "pkg-2.2.6" = _bGZkFV3H;
        "pkg-2.2.6.1" = _G80BJZgT;
        "pkg-2.2.7" = _vQXMjaMu;
        "pkg-2.2.7.1" = _l43keQ10;
        "pkg-2.2.7.2" = _E00SsVmN;
        "pkg-2.2.8-PRE-1" = _Lmbpv8E6;
        "pkg-2.2.8-PRE-2" = _6dSGMifK;
        "pkg-2.2.8-PRE-3" = _tGkZw2AS;
        "pkg-2.2.8-PRE-4" = _Bnqh7Ebd;
        "pkg-2.2.8-PRE-5" = _iZfFZj6i;
        "pkg-2.2.8-PRE-6" = _jGryiR1n;
        "pkg-2.2.8-PRE-7" = _9LZTfEsM;
        "pkg-2.2.8" = _t5R4zlt3;
        "pkg-2.2.9" = _T11e46wd;
        "pkg-2.2.10" = _ijkQD8US;
        "pkg-2.2.10.1" = _e6PmnJiS;
        "pkg-2.2.10.2" = _bXcEtAls;
        "pkg-2.2.10.3" = _vzEnthPw;
        "pkg-2.2.10.4" = _Vohds7W5;
        "pkg-2.2.11" = _3dDuN7Jz;
        "pkg-2.2.12" = _MiaKqsZP;
        "pkg-2.2.13" = _LSemF1Dg;
        "pkg-2.2.14" = _H3atSyJ1;
        "pkg-2.2.14.1" = _vBt5FY88;
        "pkg-2.2.14.2" = _5RZDTBHU;
        "pkg-2.2.14.3" = _GFYHjiJW;
        "pkg-2.2.14.4" = _o7BbAMfb;
        "pkg-2.3" = _7EoXKhEn;
        "pkg-2.3.1" = _YtMMRwri;
        "pkg-2.3.2" = _6dTRoJwU;
        "pkg-2.3.2.1" = _vbtJHbeZ;
        "pkg-2.3.3" = _8IzEWXUT;
        "pkg-2.3.4" = _lY2UKU2j;
        "pkg-2.3.5" = _kRR0C5OI;
        "pkg-2.3.6" = _veaXL3SB;
