...
let
    ...
    in {
        ...
        "pkg-1.18.2-2.0.17.4" = _ckDYI4ST;
        "pkg-1.18.2-2.0.18.0" = _Qas0MPYz;
        "pkg-1.18.2-2.0.18.1" = _8F7RRuW7;
        "pkg-1.19.2-2.0.18.2" = _gMOjx81N;
        "pkg-1.18.2-2.0.18.2" = _Xt2eN5Hh;
        "pkg-1.19.2-2.0.18.3" = _tFSF7Gnd;
        "pkg-1.19.2-2.0.18.4" = _wK26VfNh;
        "pkg-1.19.2-2.0.18.5" = _g0kXIyTH;
        "pkg-1.19.2-2.0.19.1" = _j1QSU97V;
        "pkg-1.19.2-2.0.20.0" = _c5cBo7PC;
        "pkg-1.19.2-2.0.21.1" = _opdOTjCd;
        "pkg-1.19.2-2.0.21.3" = _ZTVnSuEx;
        "pkg-1.19.2-2.0.21.4" = _VgJ58lcv;
        "pkg-1.19.2-2.0.21.5" = _eAO7U15f;
        "pkg-1.19.2-2.0.21.6" = _PkqIybt7;
        "pkg-1.19.2-2.0.21.7" = _egKgpsvZ;
        "pkg-1.19.2-2.0.22.2" = _w6sXm0PL;
        "pkg-1.19.2-2.0.22.3" = _QUpvt2gy;
        "pkg-1.19.2-2.0.22.4" = _N25C1h60;
        "pkg-1.19.2-2.0.25.2" = _CSYZDfDk;
        "pkg-1.20.1-2.0.25.3" = _rJc9j4hr;
        "pkg-1.20.1-2.0.25.4" = _7wuyx658;
        "pkg-1.20.1-2.0.25.5" = _R7UBeVbc;
        "pkg-1.20.1-2.0.25.8" = _ZGda56rS;
        "pkg-1.20.1-2.0.25.9" = _4hsJrBUo;
        "pkg-1.20.1-2.0.25.10" = _4g4FIR4Y;
        "pkg-1.18.2-2.0.18.4" = _CP5fnfY6;
        "pkg-1.19.2-2.0.25.3" = _bR5GzFcM;
        "pkg-1.18.2-2.0.18.5" = _NVEZMF0J;
        "pkg-1.19.2-2.0.25.4" = _tGmtqh1C;
        "pkg-1.20.1-2.0.25.11" = _tRwncaPT;
        "pkg-1.20.1-2.0.25.12" = _7I0rQr2S;
        "pkg-1.20.1-2.0.25.13" = _K9exyy2T;
        "pkg-1.20.1-2.0.25.14" = _KwlheOox;
        "pkg-1.20.1-2.0.25.15" = _Ogq5kJVf;
        "pkg-1.20.1-2.0.25.16" = _YcJTr4eY;
        "pkg-1.20.1-2.0.25.17" = _d4BQrHKR;
        "pkg-1.20.1-2.0.25.18" = _Wa4ozs78;
        "pkg-1.20.1-2.0.25.19" = _X3bGRXCj;
        "pkg-1.18.2-2.0.18.6" = _aGKeo3DF;
        "default" = _aGKeo3DF;
    });
