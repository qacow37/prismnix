...
let
    ...
    in {
        ...
        "pkg-v1.0.0" = _YVrw0jvx;
        "pkg-1.1.0" = _vHeYW3aw;
        "pkg-1.3.8-1.16.5 - Fabric" = _8asMSQY5;
        "pkg-1.3.8-1.16.5 - Forge" = _15WSNfri;
        "pkg-1.3.9-1.16.5 - Fabric" = _Ym66syya;
        "pkg-1.3.9-1.16.5 - Forge" = _iksgtYc1;
        "pkg-1.3.10-1.16.5 - Fabric" = _ZMqowcSz;
        "pkg-1.3.10-1.16.5 - Forge" = _mJkzRjSa;
        "pkg-1.3.12-1.16.5 - Fabric" = _CjyQhvPf;
        "pkg-1.3.12-1.16.5 - Forge" = _ANURj99W;
        "pkg-1.3.13-1.16.5 - Fabric" = _P1ADYpua;
        "pkg-1.3.13-1.16.5 - Forge" = _E8tbZSZ5;
        "pkg-1.3.14-1.16.5 - Fabric" = _kyNACoAf;
        "pkg-1.3.14-1.16.5 - Forge" = _gCAIMLzJ;
        "pkg-1.3.15-1.16.5 - Fabric" = _v9Uhs5xS;
        "pkg-1.3.15-1.16.5 - Forge" = _CiMIf5Tw;
        "pkg-1.3.16-1.16.5 - Fabric" = _nobLV1ru;
        "pkg-1.3.16-1.16.5 - Forge" = _9Tb8QSu2;
        "pkg-1.3.17-1.16.5 - Fabric" = _d7RcTHlt;
        "pkg-1.3.17-1.16.5 - Forge" = _jsamcv0m;
        "pkg-1.4.0-1.16.5 - Fabric" = _GUgaNPr3;
        "pkg-1.4.0-1.16.5 - Forge" = _8yiZvBOb;
        "pkg-1.4.1-1.16.5 - Fabric" = _6cn8INqq;
        "pkg-1.4.1-1.16.5 - Forge" = _lR2ITFZs;
        "pkg-1.4.2-1.16.5 - Fabric" = _pcjwPYnr;
        "pkg-1.4.2-1.16.5 - Forge" = _Oo7wQHas;
        "pkg-1.4.3-1.16.5 - Fabric" = _zgyXieqO;
        "pkg-1.4.3-1.16.5 - Forge" = _xQxRfMlr;
        "pkg-1.4.4-1.16.5 - Fabric" = _sXD02MmV;
        "pkg-1.4.4-1.16.5 - Forge" = _Lfc7Zwbe;
        "pkg-1.4.5-1.16.5 - Fabric" = _yMiCdBX2;
        "pkg-1.4.5-1.16.5 - Forge" = _sc16TqKx;
