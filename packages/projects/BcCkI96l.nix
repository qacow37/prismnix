...
let
    ...
    in {
        ...
        "pkg-1.0.4" = _rbAaFRPd;
        "pkg-1.1.0" = _iHOfbXM0;
        "pkg-2.0.0-fabric" = _YQAVIZU0;
        "pkg-2.0.0-forge" = _BNV8E9h5;
        "pkg-2.0.1-forge" = _MTi9UQ94;
        "pkg-2.0.0-fabric-1.16" = _Sq8yavAA;
        "pkg-2.0.0-forge-1.16" = _BON0vx73;
        "pkg-3.0.0-fabric" = _IakyCWtL;
        "pkg-3.0.1" = _SP4EV3Iq;
        "pkg-3.0.1-forge" = _omG6euq9;
        "pkg-4.0.0-fabric" = _oVtHOaDZ;
        "pkg-4.0.0-forge" = _Jwul4AKv;
        "pkg-4.1.1-forge" = _6qgiDZVa;
        "pkg-4.1.1-fabric" = _nYyfeMSx;
        "pkg-5.0.0-forge" = _2fSrZHab;
        "pkg-5.0.0-fabric" = _G54H71KU;
        "pkg-4.2.0-fabric" = _YUmTTSTR;
        "pkg-5.1.0-fabric" = _qpih3K2N;
        "pkg-4.2.0-forge" = _PZ1SDwNi;
        "pkg-5.1.0-forge" = _75khpDdA;
        "pkg-4.2.1-fabric" = _4qsCnnL0;
        "pkg-4.2.1-forge" = _Mf4qzkox;
        "pkg-5.1.1-fabric" = _GFfYu4tk;
        "pkg-5.1.1-forge" = _EWnonbfq;
        "default" = _EWnonbfq;
    });
