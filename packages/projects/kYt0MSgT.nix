...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.20.2" = _ubWGvirL;
        "pkg-1.1.0-1.20.2" = _7WG5QqPG;
        "pkg-1.1.1-1.20.2" = _xsWtgh1Q;
        "pkg-1.2.0-1.20.2" = _6eWdNl8H;
        "pkg-1.2.1-1.20.2" = _NQz0Uc2I;
        "pkg-0.1.0-1.20.1" = _GdUgJmcV;
        "pkg-0.1.1-1.20.1" = _U0DNHKw2;
        "pkg-0.0.1-1.20.2-V2" = _TGpbYn0s;
        "pkg-0.0.1-V2" = _AQlkba8P;
        "pkg-0.0.2-V2" = _vqjfGOjh;
        "pkg-1.0-1.20.1" = _bNVEzWGc;
        "pkg-0.3-v2" = _D5TlsOrM;
        "pkg-1.1-1.20.1" = _nQPnj7du;
        "pkg-0.4-v2" = _dNeAFN9v;
        "pkg-1.2-1.20.1" = _76WkOro3;
        "pkg-0.5-v2" = _95qDfksy;
        "pkg-0.0-v2_20.1" = _qByXLNvo;
        "pkg-0.6-v2_20.2" = _6ak50Ig8;
        "pkg-0.7-v2_20.2" = _4WcNmO8Z;
        "pkg-20.1-0.1-v2" = _iaEsLtC4;
        "pkg-20.2-0.9-v2" = _qDZy1sYV;
        "pkg-20.1-0.3-v2" = _HaTQB9sV;
        "pkg-20.2-0.10-v2" = _KP87DZpl;
        "pkg-20.1-0.4-v2" = _znZGUAnV;
        "pkg-20.1-0.5-v2" = _Gxmvq0Mz;
        "pkg-20.2-0.11-v2" = _DDSnKUp7;
        "pkg-20.1-0.6-v2" = _xqeOHsDZ;
        "pkg-20.2-0.12-v2" = _XRXp592B;
        "pkg-20.1-0.7-v2" = _o9h1tY0e;
        "pkg-20.2-0.13-v2" = _qMyCQwxe;
        "pkg-20.1-0.8-v2" = _ADB838T4;
        "pkg-20.1-0.9-v2" = _nMTODhdS;
        "pkg-20.2-0.14-v2" = _3ZCHnoD4;
        "pkg-20.1-0.10-v2" = _gbTc9AzG;
        "pkg-20.1-0.11-v2" = _syc69Rbn;
        "pkg-20.1-0.11-v2b" = _8frYS55o;
        "pkg-20.2-0.15-v2" = _4uxacre2;
        "pkg-20.1-0.12-v2" = _3onBqn4E;
        "pkg-20.2-0.16-v2" = _OIFK5AFm;
        "pkg-20.1-0.13-v2" = _Z8o9VqGa;
        "pkg-20.1-0.14-v2" = _c11dxUxm;
        "pkg-20.1-0.15-v2" = _GnlN10kS;
        "pkg-20.1-0.16-v2" = _hT2LiZSl;
        "pkg-20.1-0.17-v2" = _H4JcgrtM;
        "pkg-20.1-0.18-v2" = _DAAneEZB;
        "pkg-20.1-0.19-v2" = _Zbyf2QXs;
        "pkg-20.1-0.20-v2" = _54kJIUk7;
        "pkg-20.1-0.21-v2" = _Kfzz8Qb8;
        "pkg-20.1-0.22-v2" = _PD1gkSj0;
        "pkg-20.1-0.23-v2" = _s3Td8o7Y;
        "pkg-20.1-0.24-v2" = _i6pR1zwp;
        "pkg-20.1-0.25-v2" = _bsSV8DuI;
        "pkg-20.1-0.26-v2" = _pIxZG2rT;
        "pkg-20.1-0.27-v2" = _sFeDOcoz;
        "pkg-20.1-0.28-v2" = _XkIm14hL;
        "pkg-20.1-0.29-v2" = _xwwp8rVe;
        "pkg-20.1-0.30b-v2" = _eDHSpDK0;
        "pkg-20.1-0.30-v2" = _8NOEf895;
        "pkg-20.1-2.0" = _GXk1q6ec;
        "pkg-20.1-2.0.1" = _rfNsj3VF;
        "pkg-2.0.2" = _r9Lq0Zp7;
        "pkg-20.1-2.0.2" = _tRrZGZ5U;
        "default" = _tRrZGZ5U;
    });
