...
let
    ...
    in {
        ...
        "pkg-1.0" = _RV0jW0oB;
        "pkg-1.1" = _nkfu5okV;
        "pkg-fabric-5.4.0" = _KxYwrUIv;
        "pkg-forge-5.4.0" = _B1cVRr6a;
        "pkg-neoforge-6.0.0" = _3QW0Jv7d;
        "pkg-neoforge-7.0.0" = _cwZysVtY;
        "pkg-forge-5.5.0" = _KnZzeTcv;
        "pkg-neoforge-7.1.0" = _1dPQt4Rh;
        "pkg-neoforge-8.0.0" = _JWyZaUp0;
        "pkg-neoforge-8.1.0" = _bF2tLpej;
        "pkg-neoforge-8.1.1" = _WAvm56Pr;
        "pkg-neoforge-8.2.0" = _z3r8QA0K;
        "default" = _z3r8QA0K;
    });
