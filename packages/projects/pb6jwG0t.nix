...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _VAfUeRSW;
        "pkg-1.9.2" = _v7YjRkWj;
        "pkg-1.10.0" = _Cxh9pXET;
        "pkg-1.10.1" = _dfDDB0TI;
        "pkg-1.11.0" = _KScQfgjK;
        "pkg-1.11.1" = _T6aqufeo;
        "pkg-1.11.2" = _lcgk4ypS;
        "pkg-1.11.3-beta1" = _EQyUTjRt;
        "pkg-1.11.3-beta2" = _gjljiwNt;
        "pkg-1.11.4" = _fiMl1AeI;
        "pkg-1.11.5-beta" = _vbrZ95fh;
        "pkg-1.12.0" = _QiDCpWZa;
        "pkg-1.12.1" = _DEmVhA76;
        "pkg-1.12.2" = _XqsczOHg;
        "pkg-1.12.3" = _P3YZNTWw;
        "pkg-1.13.0" = _4EPrcjcJ;
        "pkg-1.13.1" = _uTOz5PIq;
        "pkg-1.13.2" = _Ke2fN79T;
        "default" = _Ke2fN79T;
    });
