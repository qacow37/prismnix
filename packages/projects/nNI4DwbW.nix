...
let
    ...
    in {
        ...
        "pkg-1.0.0-quilt" = _U43nwUZD;
        "pkg-1.0.0-forge" = _zByRC71g;
        "pkg-1.0.0-fabric" = _kEOkNRnk;
        "pkg-2.0.0-quilt" = _g7k8RqMY;
        "pkg-2.0.0-forge" = _KW9DxfJY;
        "pkg-2.0.0-fabric" = _5XRaTCTq;
        "pkg-2.1.0+1.20-quilt" = _Icavu0No;
        "pkg-2.1.0+1.20-forge" = _uE19d52h;
        "pkg-2.1.0+1.20-fabric" = _aELOrOFb;
        "pkg-2.2.0+1.20-quilt" = _1jnD5vF0;
        "pkg-2.2.0+1.20-forge" = _qkufQjbs;
        "pkg-2.2.0+1.20-fabric" = _kfiTB0AH;
        "pkg-3.0.0+1.20.1-quilt" = _F0plEkIb;
        "pkg-3.0.0+1.20.1-forge" = _TiOuKZv8;
        "pkg-3.0.0+1.20.1-fabric" = _WJDn6yqr;
        "pkg-20.2.0-neoforge" = _NFWakQPh;
        "pkg-20.2.0-forge" = _kGbDh0VD;
        "pkg-20.2.0-fabric" = _ql8DSx6y;
        "pkg-20.2.1-neoforge" = _sjwxGYga;
        "pkg-20.2.1-forge" = _RHi4KBMF;
        "pkg-20.2.1-fabric" = _R8F5dPKo;
        "pkg-20.4.0-neoforge" = _cbXgqHtj;
        "pkg-20.4.0-forge" = _uvSa9SUo;
        "pkg-20.4.0-fabric" = _OSyhDJvn;
        "pkg-20.4.1-neoforge" = _XkH7hh3s;
        "pkg-20.4.1-forge" = _EIikHbJs;
        "pkg-20.4.1-fabric" = _K0sLvikL;
        "pkg-20.6.0-neoforge" = _qYj4THmG;
        "pkg-20.6.0-forge" = _q5EY5caq;
        "pkg-20.6.0-fabric" = _cHixPrhd;
        "pkg-21.0.0-neoforge" = _aFsmI31U;
        "pkg-21.0.0-fabric" = _7dm8uE8e;
        "pkg-21.0.1-neoforge" = _4zcNaQHD;
        "pkg-21.0.1-fabric" = _CvKzuBEz;
        "pkg-21.1.0-neoforge" = _NYIrwcSD;
        "pkg-21.1.0-fabric" = _ly9ddZo8;
        "pkg-21.2.0-neoforge" = _Ajahn3yk;
        "pkg-21.2.0-fabric" = _GnsCfnsH;
        "pkg-21.3.0-neoforge" = _cWUSXN8u;
        "pkg-21.3.0-fabric" = _LLlzAChM;
        "pkg-21.4.0-neoforge" = _xXfp6BZv;
        "pkg-21.4.0-fabric" = _Rld59qul;
        "pkg-21.5.0-neoforge" = _SvL2sqL2;
        "pkg-21.5.0-fabric" = _CWuivXDE;
        "default" = _CWuivXDE;
    });
