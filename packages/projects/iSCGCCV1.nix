...
let
    ...
    in {
        ...
        "pkg-v5.0.0-1.19.3-Fabric" = _pOt0SdV0;
        "pkg-v6.0.0-1.19.4-Forge" = _LBCXLxEE;
        "pkg-v6.0.0-1.19.4-Fabric" = _US66cVmv;
        "pkg-v7.0.0-1.20-Forge" = _pnfcFk2Z;
        "pkg-v7.0.0-1.20-Fabric" = _I5CmNAzs;
        "pkg-v8.0.0-1.20.1-Forge" = _VSxl1I7f;
        "pkg-v8.0.0-1.20.1-Fabric" = _2F2vLNnl;
        "pkg-v3.0.0-1.18.2-Forge" = _xI0X8VeA;
        "pkg-v3.0.0-1.18.2-Fabric" = _i2Zs3GZx;
        "pkg-v20.4.0-1.20.4-Fabric" = _jY4uBrjT;
        "pkg-v20.4.0-1.20.4-Forge" = _UHBuoNJg;
        "pkg-v20.4.0-1.20.4-NeoForge" = _jRwnKA88;
        "pkg-v20.4.1-1.20.4-Fabric" = _yNkTugCD;
        "pkg-v20.4.1-1.20.4-Forge" = _nHqTiPUa;
        "pkg-v20.4.1-1.20.4-NeoForge" = _wZVswVoD;
        "pkg-v21.1.0-1.21.1-Fabric" = _AYxO4ga4;
        "pkg-v21.1.0-1.21.1-NeoForge" = _nx3WY9Ju;
        "pkg-v21.3.0-1.21.3-Fabric" = _1blLreYM;
        "pkg-v21.3.0-1.21.3-NeoForge" = _UI5DdnaB;
        "pkg-v21.4.0-1.21.4-Fabric" = _ugwE6iTV;
        "pkg-v21.4.0-1.21.4-NeoForge" = _peVcZe7z;
        "pkg-v21.5.0-1.21.5-Fabric" = _uJSuwS1j;
        "pkg-v21.5.0-1.21.5-NeoForge" = _f3ed9oZv;
        "pkg-v21.6.0-1.21.6-Fabric" = _mq21Gfgb;
        "pkg-v21.6.0-1.21.6-NeoForge" = _6oTkSjpR;
        "pkg-v21.7.0-1.21.7-Fabric" = _RSsdce9C;
        "pkg-v21.7.0-1.21.7-NeoForge" = _Gap0Bp9b;
        "pkg-v21.7.1-1.21.7-Fabric" = _xntLh1uA;
        "pkg-v21.7.1-1.21.7-NeoForge" = _3F5tmRNF;
        "pkg-v21.8.0-1.21.8-Fabric" = _TRDGztkw;
        "pkg-v21.8.0-1.21.8-NeoForge" = _k5rGbZAc;
        "pkg-21.9.0" = _CjXOh8oD;
        "pkg-21.10.0" = _weCOa84m;
