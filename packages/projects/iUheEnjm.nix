...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.0.1" = _qihVOAIy;
        "pkg-1.20.1-1.0.2" = _OXrv1IZ1;
        "pkg-1.18.2-1.0.2-hotfix" = _iCPDAKte;
        "pkg-1.20.1-1.0.3" = _IEyHWL3h;
        "pkg-1.18.2-1.0.3" = _daLN1rrl;
        "pkg-1.18.2-1.0.4" = _irtL8mz0;
        "pkg-1.20.1-1.0.4" = _ZABM9kS5;
        "pkg-1.19.2-1.3.0" = _IUy68TP5;
        "pkg-1.20.1-1.3.0" = _QLvXpHAH;
        "pkg-1.19.2-1.3.1" = _dcz1lea1;
        "pkg-1.20.1-1.3.1" = _jITaK9ID;
        "pkg-1.18.2-1.3.1" = _yVEAbKCr;
        "pkg-1.20.1-1.3.2" = _dXYSLTEU;
        "pkg-1.19.2-1.3.2" = _LyO5DRBr;
        "pkg-1.18.2-1.3.2" = _JSMnQ2Bc;
        "pkg-1.20.1-1.3.3" = _Y9Ddh8cY;
        "pkg-1.19.2-1.3.3" = _cVySpNbw;
        "pkg-1.18.2-1.3.3" = _D2OF3Q2t;
        "pkg-1.18.2-1.3.4" = _7aCuCakO;
        "pkg-1.19.2-1.3.4" = _YGrUkuqk;
        "pkg-1.20.1-1.3.4" = _c6EFcfsJ;
        "pkg-1.18.2-1.3.5" = _pgqD9Nfr;
        "pkg-1.19.2-1.3.5" = _HozZv4JY;
        "pkg-1.20.1-1.3.5" = _kghwkpyG;
        "pkg-1.18.2-1.3.6" = _n97pBvZg;
        "pkg-1.19.2-1.3.6" = _hyYTibLV;
        "pkg-1.20.1-1.3.6" = _SBL7j9WD;
        "pkg-1.18.2-1.3.7" = _ZzjJhEO6;
        "pkg-1.19.2-1.3.7" = _PdCC22tX;
        "pkg-1.20.1-1.3.7" = _hxwE6dfU;
        "pkg-1.18.2-1.3.8" = _6afeQYOE;
        "pkg-1.19.2-1.3.8" = _cg6RGkoN;
        "pkg-1.20.1-1.3.8" = _WAqHrDql;
        "pkg-1.21.0-2.0.0" = _hLfZmNk2;
        "pkg-1.18.2-1.3.9" = _5SDwdQW2;
        "pkg-1.19.2-1.3.9" = _F9DLuYzA;
        "pkg-1.20.1-1.3.9" = _Mv9BSGvk;
        "pkg-1.21.0-2.0.1" = _hovpYLkB;
        "pkg-1.18.2-1.3.10" = _aNSem2Gz;
        "pkg-1.19.2-1.3.10" = _XWIiPy5f;
        "pkg-1.21.1-2.0.2" = _zSOsF3Tu;
        "pkg-1.20.1-1.3.10" = _atdXk65Z;
        "pkg-1.21.1-2.0.3" = _uMSoYtbz;
        "pkg-1.18.2-1.3.11" = _ys4nvqH6;
        "pkg-1.19.2-1.3.11" = _z9PJMoQg;
        "pkg-1.20.1-1.3.11" = _kPKDcpnP;
        "pkg-1.20.1-1.3.12" = _aJjmAMuq;
        "pkg-1.20.1-1.3.13" = _23NhlO5T;
        "pkg-1.20.1-1.3.14" = _1xdogcPg;
        "pkg-1.20.1-1.3.15" = _rUgbClmY;
        "pkg-1.20.1-1.3.16" = _O3DA4Mml;
        "pkg-1.21.1-2.1.0" = _W7WCQgdb;
        "pkg-1.21.1-2.1.1" = _n9MKyOx8;
        "pkg-1.21.1-2.1.2" = _TowvpBLA;
        "pkg-1.21.1-2.1.3" = _Tdb3cy02;
        "pkg-1.20.1-1.4.0" = _v0d2UK5F;
        "pkg-1.21.1-2.1.4" = _JXZnUWkA;
        "pkg-1.21.1-2.1.5" = _YqPoqXIx;
        "default" = _YqPoqXIx;
    });
