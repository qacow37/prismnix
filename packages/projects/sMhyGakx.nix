...
let
    ...
    in {
        ...
        "pkg-1.21.1_v1.0.0" = _XpuT4hV1;
        "pkg-1.20.1_v1.0.0" = _y1jULqCD;
        "pkg-1.19.4_v1.0.0" = _eUrHwVBl;
        "pkg-1.21.1_fabric_v2.0.0" = _rvfOpaMH;
        "pkg-1.20.1_fabric_v2.0.0" = _LqcZCHxT;
        "pkg-1.19.4_fabric_v2.0.0" = _olubM1Lu;
        "pkg-1.19.2_fabric_v.2.0.0" = _r0LB4Hw7;
        "pkg-1.18.2_fabric_v.2.0.0" = _yTkaoQr9;
        "pkg-1.21.1_forge_v2.0.0" = _oZCZ7DOW;
        "pkg-1.20.1_forge_v2.0.0" = _IukDFwtx;
        "pkg-1.19.4_forge_v2.0.0" = _troWdIJc;
        "pkg-1.19.2_forge_v2.0.0" = _tV7kjbWb;
        "pkg-1.18.2_forge_v2.0.0" = _wxc94jx5;
        "pkg-1.21.1_neoforge_v2.0.0" = _KJlvtCto;
        "pkg-1.21.1_fabric_v2.0.1" = _RCEpeC36;
        "pkg-1.20.1_fabric_v2.0.1" = _Ekr5Jdip;
        "pkg-1.19.4_fabric_v2.0.1" = _c2T3jcl6;
        "pkg-1.19.2_fabric_v.2.0.1" = _YaZEtmoT;
        "pkg-1.18.2_fabric_v.2.0.1" = _qojbNgia;
        "pkg-1.21.1_forge_v2.0.1" = _MfeWYa8P;
        "pkg-1.20.1_forge_v2.0.1" = _abrxgDbV;
        "pkg-1.19.4_forge_v2.0.1" = _gW9s1d78;
        "pkg-1.19.2_forge_v2.0.1" = _YyfDeCwJ;
        "pkg-1.18.2_forge_v2.0.1" = _mUvOJFvI;
        "pkg-1.21.1_neoforge_v2.0.1" = _JoEZFDJo;
        "pkg-1.21.1_neoforge_v2.0.2" = _97n7cyh9;
        "default" = _97n7cyh9;
    });
