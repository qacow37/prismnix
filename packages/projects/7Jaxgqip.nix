...
let
    ...
    in {
        ...
        "pkg-v1.7.3" = _OMlSNJnU;
        "pkg-v1.8.3" = _BHfRGrCr;
        "pkg-v1.3.0" = _xeWK4Ojs;
        "pkg-v1.8.4" = _edz9KQch;
        "pkg-v1.7.4" = _hnJ0xW6K;
        "pkg-v1.8.5" = _w7YxsifX;
        "pkg-v1.8.6" = _F3Abxkk0;
        "pkg-v1.7.5" = _SWJIrXTf;
        "pkg-v1.8.7" = _OPTjovJy;
        "pkg-v1.7.6" = _t0eRbMid;
        "pkg-v1.8.8" = _ytrceD8m;
        "pkg-1.7.7" = _8iJHH4Ky;
        "pkg-v1.8.9" = _J657mUm5;
        "pkg-v1.7.8" = _NdzBrq9d;
        "pkg-v1.7.9" = _itiW7Fb2;
        "pkg-v1.8.10" = _QcccbcT4;
        "pkg-v1.9.1" = _X7TqUN1p;
        "pkg-v1.9.2" = _es1lLtdN;
        "pkg-v1.10.0" = _sFH5n4IC;
        "pkg-v1.11.0" = _dLi8KAgI;
        "pkg-v1.7.10" = _RpmwyJ2R;
        "pkg-v1.11.1" = _8ZZRZ4Jc;
        "pkg-v1.11.2" = _7fBKBrSi;
        "pkg-v1.7.11" = _i7zSnUxE;
        "pkg-v1.12.0" = _PMjB9KC3;
        "pkg-v1.12.2" = _IhpVAiXl;
        "pkg-v1.13.0" = _keNxajDd;
        "pkg-v1.14.0" = _reT8CFwD;
        "pkg-v1.15.1" = _tAQ4e6sH;
        "pkg-v1.15.2" = _oQD5ay0s;
        "pkg-v1.14.1" = _S9H1Z5Xk;
        "pkg-v1.16.0" = _i0gy9iDp;
        "pkg-v1.16.1" = _NBCnBGZj;
        "pkg-1.17.0" = _rJzXa8HU;
        "default" = _rJzXa8HU;
    });
