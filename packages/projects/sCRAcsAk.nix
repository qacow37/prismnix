...
let
    ...
    in {
        ...
        "pkg-2.0.1" = _KRolPdrb;
        "pkg-2.0.2" = _m0uRXcWY;
        "pkg-2.0.3+1.19.3" = _a6SESzpr;
        "pkg-2.0.4+1.19.4" = _U2GzAXqP;
        "pkg-2.0.5+1.19.4" = _WxDQB1cg;
        "pkg-2.0.5+1.20" = _NomJP9wt;
        "pkg-2.0.5+1.20.1" = _4aHDYLUK;
        "pkg-2.0.6+1.20.1" = _9MsYZeTf;
        "pkg-2.1.0+1.20.1" = _3bzbIQZH;
        "pkg-2.0.5-fix+1.20" = _nsu730Z6;
        "pkg-3.0.0-alpha+1.20.1" = _bMEAwAm2;
        "pkg-3.0.1+1.20.1" = _d0Vh9eRT;
        "pkg-3.0.2+1.20.1" = _dfHw0KSV;
        "pkg-3.0.3+1.20.1" = _8g905dxe;
        "pkg-4.0.0-alpha+1.20.1" = _55IignFp;
        "pkg-4.0.1-alpha+1.20.1" = _tybPDfME;
        "default" = _tybPDfME;
    });
