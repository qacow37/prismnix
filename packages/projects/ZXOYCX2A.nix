...
let
    ...
    in {
        ...
        "pkg-1.3.2" = _Vyk7n8zK;
        "pkg-2.0" = _9mMBL1Mb;
        "pkg-1.19.3-0.2.1" = _zTBiAX2L;
        "pkg-1.19.2-0.2.0" = _hqehSq1Y;
        "pkg-1.12.2-1.5.5" = _YI1hklI2;
        "pkg-1.19.2-0.2.1-forge" = _5Aog6Kvy;
        "pkg-1.19.2-0.2.1" = _7PvN6PLB;
        "pkg-1.19.3-0.2.2-forge" = _pERJ50H1;
        "pkg-1.19.3-0.2.2-fabric" = _zILUsDHF;
        "pkg-1.19.4-0.1.0" = _os56CJJe;
        "pkg-1.19.4-0.1.1+fabric" = _JX1vTpcQ;
        "pkg-1.19.4-0.1.1+forge" = _MIMxD8Gl;
        "pkg-1.20.1-0.1.0+fabric" = _jOAs2iCn;
        "pkg-1.20.1-0.1.0+forge" = _K0qPbUqq;
        "pkg-1.20.1-0.1.1+fabric" = _llugbDJ2;
        "pkg-1.20.1-0.1.1+forge" = _ZGVpo4Uq;
        "pkg-1.19.4-0.1.2+forge" = _gIu7gbT2;
        "pkg-1.19.4-0.1.2+fabric" = _7cPctDuM;
        "pkg-1.20.1-0.1.2+fabric" = _ukc35fci;
        "pkg-1.20.1-0.1.2+forge" = _gEdlxxfc;
        "pkg-1.19.4-0.1.3+fabric" = _dAcmRzdr;
        "pkg-1.19.4-0.1.3+forge" = _1cYIvcTI;
        "pkg-1.16.5-0.1.0+forge" = _Ceku93z5;
        "pkg-1.16.5-0.1.0+fabric" = _l8xkSXrz;
        "pkg-1.20.1-0.1.3+fabric" = _6HSCJiKP;
        "pkg-1.20.1-0.1.3+forge" = _o6GPgySS;
        "pkg-1.19.4-0.1.4+fabric" = _aFYOLFX7;
        "pkg-1.19.4-0.1.4+forge" = _mzlMB6Lc;
        "pkg-1.16.5-0.1.1+fabric" = _84wQvwiv;
        "pkg-1.16.5-0.1.1+forge" = _BZouysps;
        "pkg-1.19.2-0.2.2+forge" = _AxWWJKFy;
        "pkg-1.19.4-0.1.5+fabric" = _mUwsbngT;
        "pkg-1.19.2-0.2.2+fabric" = _ZWSnNiWL;
        "pkg-1.20.1-0.1.4+forge" = _wDmH52GM;
        "pkg-1.19.4-0.1.5+forge" = _NIHvodLa;
        "pkg-1.20.1-0.1.4+fabric" = _DYwXMM8c;
        "pkg-1.20.1-0.1.5+fabric" = _t8oQbCmH;
        "pkg-1.20.1-0.1.5+forge" = _j331j98r;
        "pkg-1.19.2-0.2.3+forge" = _o8bwmquD;
        "pkg-1.19.2-0.2.3+fabric" = _epBdMmJ0;
        "pkg-1.16.5-0.1.2+forge" = _V8US5WqY;
        "pkg-1.16.5-0.1.2+fabric" = _tZl0kDZ3;
        "pkg-1.19.4-0.1.6+forge" = _EITMjyhy;
        "pkg-1.19.4-0.1.6+fabric" = _ueangax8;
        "pkg-1.20.1-0.1.6+fabric" = _CYePht9y;
        "pkg-1.20.1-0.1.6+forge" = _eNc8AhwA;
        "pkg-1.16.5-0.1.3+fabric" = _Y4XNkYya;
        "pkg-1.16.5-0.1.3+forge" = _42dHulIh;
        "pkg-1.19.2-0.2.4+fabric" = _MrC0zPTl;
        "pkg-1.19.2-0.2.4+forge" = _DVg3SgA0;
        "pkg-1.19.4-0.1.7+fabric" = _GA7vBxuD;
        "pkg-1.19.4-0.1.7+forge" = _dl8JoR0o;
        "pkg-1.16.5-0.1.4+forge" = _iupGmktO;
        "pkg-1.20.1-0.1.7+forge" = _iQ93FTmD;
        "pkg-1.20.1-0.1.7+fabric" = _VOwuR7iJ;
        "pkg-1.19.2-0.2.5+forge" = _o91IGchy;
        "pkg-1.16.5-0.1.4+fabric" = _tBcTz5ge;
        "pkg-1.19.4-0.1.8+forge" = _C2GF2GCX;
        "pkg-1.19.2-0.2.5+fabric" = _PJUngvs9;
        "pkg-1.19.4-0.1.8+fabric" = _AElnM1jF;
        "pkg-1.20.1-1.0.0+fabric" = _LWq1JeDf;
        "pkg-1.19.4-1.0.0+fabric" = _brWQa0wX;
        "pkg-1.20.1-1.0.0+forge" = _wr2L4nO4;
        "pkg-1.19.2-1.0.0+fabric" = _AfbtU2Dg;
        "pkg-1.19.4-1.0.0+forge" = _U4DuM1Qb;
        "pkg-1.16.5-1.0.0+fabric" = _nI9zrbpH;
        "pkg-1.16.5-1.0.0+forge" = _zGgcQP7E;
        "pkg-1.19.2-1.0.0+forge" = _qaJQyNfi;
        "pkg-1.20.1-1.0.1+fabric" = _HGgePuRo;
        "pkg-1.20.1-1.0.1+forge" = _gDaO7yv3;
        "pkg-1.19.2-1.0.1+fabric" = _cqQhPJf6;
        "pkg-1.19.2-1.0.1+forge" = _bpLHpEsp;
        "pkg-1.19.4-1.0.1+fabric" = _7jN2qUTl;
        "pkg-1.19.4-1.0.1+forge" = _lEB5KQJE;
        "pkg-1.16.5-1.0.1+forge" = _Pkf7WfnJ;
        "pkg-1.16.5-1.0.1+fabric" = _eEkMYNjo;
        "pkg-1.16.5-1.0.2+forge" = _pvHGwne4;
        "pkg-1.16.5-1.0.2+fabric" = _gkw9hkzW;
        "pkg-1.16.5-1.0.3+fabric" = _bHAmu53i;
        "pkg-1.16.5-1.0.3+forge" = _5KoKWJKH;
        "pkg-1.19.2-1.0.2+fabric" = _Co5eLyy4;
        "pkg-1.19.2-1.0.2+forge" = _qNKjNS1a;
        "pkg-1.16.5-1.0.4+fabric" = _mwPtMrCj;
        "pkg-1.20.1-1.0.2+fabric" = _ivCgNFKE;
        "pkg-1.16.5-1.0.4+forge" = _4jgGLXgz;
        "pkg-1.20.1-1.0.2+forge" = _zZxkoiYa;
        "pkg-1.20.1-1.0.3+fabric" = _2WCNHvom;
        "pkg-1.20.1-1.0.3+forge" = _Z1rEiaOQ;
        "pkg-1.20.1-1.1+fabric" = _PwivimqS;
        "pkg-1.20.1-1.1+forge" = _9ppNbocr;
        "pkg-1.20.1-1.1.1+forge" = _RvoOmYrf;
        "pkg-1.20.1-1.1.1+fabric" = _DJir1RUH;
        "pkg-1.16.5-1.1.0+forge" = _nNKivOgD;
        "pkg-1.16.5-1.1.0+fabric" = _85jNZV58;
        "pkg-1.19.2-1.1.0+fabric" = _aKPKP6WP;
        "pkg-1.19.2-1.1.0+forge" = _v5vGvmiu;
        "pkg-1.19.4-1.1.0+forge" = _O77o69Xv;
        "pkg-1.19.4-1.1.0+fabric" = _ZE0tGmZz;
        "pkg-1.20.2-1.0+fabric" = _nnLPK0pF;
        "pkg-1.20.2-1.0+forge" = _mufpP9hG;
        "pkg-1.20.2-1.0.1+forge" = _Tz5LhrJg;
        "pkg-1.20.2-1.0.1+fabric" = _VBkvjzjA;
        "pkg-1.19.4-1.1.1+fabric" = _3xJpMScr;
        "pkg-1.19.4-1.1.1+forge" = _qv41T7xE;
        "pkg-1.19.2-1.1.1+forge" = _6DTXXQvV;
        "pkg-1.19.2-1.1.1+fabric" = _T7Uq2HLH;
        "pkg-1.16.5-1.1.1+fabric" = _3eJa2Rfz;
        "pkg-1.16.5-1.1.1+forge" = _Lgy8Wipv;
        "pkg-1.16.5-1.1.2+fabric" = _yHOM27ET;
        "pkg-1.16.5-1.1.2+forge" = _ZFA1h0rA;
        "pkg-1.19.4-1.1.2+forge" = _JQeDcCcZ;
        "pkg-1.19.4-1.1.2+fabric" = _6cShYOuA;
        "pkg-1.19.2-1.1.2+fabric" = _7B4bOAjm;
        "pkg-1.19.2-1.1.2+forge" = _83ekczOT;
        "pkg-1.20.2-1.0.2+fabric" = _AKEaWlH8;
        "pkg-1.20.2-1.0.2+forge" = _HWnRJ140;
        "pkg-1.16.5-1.1.3+fabric" = _bDxs0n2I;
        "pkg-1.16.5-1.1.3+forge" = _IzT3Ajx4;
        "pkg-1.18.2-1.0+forge" = _ZYGdY2vh;
        "pkg-1.18.2-1.0+fabric" = _xw6VAsxN;
        "pkg-1.20.2-1.0.3+fabric" = _L53I1GDH;
        "pkg-1.20.2-1.0.3+forge" = _QHlAG8RC;
        "pkg-1.20.2-1.0.4+fabric" = _zwP4DIG6;
        "pkg-1.20.2-1.0.4+forge" = _HuL0584b;
        "pkg-1.20.4-1.0+fabric" = _FiJis7Cb;
        "pkg-1.20.4-1.0+forge" = _uTjbk3Zn;
        "pkg-1.20.4-1.0.1+fabric" = _uFGPx8TF;
        "pkg-1.20.1-1.1.2+forge" = _scycQqR4;
        "pkg-1.20.1-1.1.2+fabric" = _VshlOjX9;
        "pkg-1.20.4-1.0.1+forge" = _OFZfV167;
        "pkg-1.20.4-1.0.2+fabric" = _2vXfMQ5s;
        "pkg-1.20.4-1.0.2+forge" = _VQ7uqdOS;
        "pkg-1.20.1-1.1.3+fabric" = _1qW3x7W8;
        "pkg-1.20.1-1.1.3+forge" = _UmIlARSR;
        "pkg-1.21.5-1.1.2515.0+forge" = _iw7rtIlR;
        "pkg-1.21.5-1.1.2515.0+neoforge" = _IzB4Pgf9;
        "pkg-1.21.4-1.1.2515.0+neoforge" = _rZZsi7w2;
        "pkg-1.21.5-1.1.2515.0+fabric" = _mLCDMT22;
        "pkg-1.21.4-1.1.2515.0+forge" = _lG7MGFCi;
        "pkg-1.21.3-1.1.2515.0+neoforge" = _sNhvgn2p;
        "pkg-1.21.4-1.1.2515.0+fabric" = _EqDskRQ3;
        "pkg-1.21.3-1.1.2515.0+forge" = _lRWzCO7O;
        "pkg-1.21.1-1.1.2515.0+neoforge" = _MBaKg8PU;
        "pkg-1.21.3-1.1.2515.0+fabric" = _vgY0obuY;
        "pkg-1.21.1-1.1.2515.0+forge" = _i7Mkcl1v;
        "pkg-1.21.1-1.1.2515.0+fabric" = _5BugqLOG;
        "pkg-1.20.4-1.1.2515.0+neoforge" = _Iv37n7fL;
        "pkg-1.20.4-1.1.2515.0+forge" = _hdC45eLL;
        "pkg-1.20.4-1.1.2515.0+fabric" = _VYefoiXw;
        "pkg-1.20.1-1.1.2515.0+forge" = _42rSILFN;
        "pkg-1.20.1-1.1.2515.0+fabric" = _dFlbEbyG;
        "pkg-1.21.4-1.1.2516.0+neoforge" = _sH8zNOCw;
        "pkg-1.21.5-1.1.2516.0+neoforge" = _WQaKBvcJ;
        "pkg-1.21.5-1.1.2516.0+forge" = _94jemdhZ;
        "pkg-1.21.4-1.1.2516.0+forge" = _P15KVKzN;
        "pkg-1.21.5-1.1.2516.0+fabric" = _HehabftP;
        "pkg-1.21.3-1.1.2516.0+neoforge" = _LeQ7B8gM;
        "pkg-1.21.4-1.1.2516.0+fabric" = _IOofIyu7;
        "pkg-1.21.3-1.1.2516.0+forge" = _z4LWI9Ly;
        "pkg-1.21.1-1.1.2516.0+neoforge" = _dJBdBl4J;
        "pkg-1.21.1-1.1.2516.0+fabric" = _GXJiGF5x;
        "pkg-1.21.3-1.1.2516.0+fabric" = _lFc84gCB;
        "pkg-1.21.1-1.1.2516.0+forge" = _jSjn2YjX;
        "pkg-1.20.4-1.1.2516.0+neoforge" = _SpfiC0rI;
        "pkg-1.20.1-1.1.2516.0+forge" = _hBNIhXGE;
        "pkg-1.20.4-1.1.2516.0+fabric" = _IOR9xt85;
        "pkg-1.20.4-1.1.2516.0+forge" = _W0n9nl1t;
        "pkg-1.20.1-1.1.2516.0+fabric" = _skiUxd56;
        "pkg-1.21.5-1.1.2516.1+forge" = _28BbdHtl;
        "pkg-1.21.5-1.1.2516.1+neoforge" = _iOnAOQl2;
        "pkg-1.21.4-1.1.2516.1+neoforge" = _Fg3o6rc3;
        "pkg-1.21.5-1.1.2516.1+fabric" = _vAM49X39;
        "pkg-1.21.4-1.1.2516.1+fabric" = _B3tSbdz2;
        "pkg-1.21.3-1.1.2516.1+neoforge" = _1LDAtSeh;
        "pkg-1.21.3-1.1.2516.1+forge" = _O8DGhKlP;
        "pkg-1.21.1-1.1.2516.1+neoforge" = _wFOmRxA7;
        "pkg-1.21.3-1.1.2516.1+fabric" = _aFVCVS3D;
        "pkg-1.21.1-1.1.2516.1+fabric" = _aFG3MPCP;
        "pkg-1.21.1-1.1.2516.1+forge" = _KeZ91APz;
        "pkg-1.20.4-1.1.2516.1+forge" = _rMFEJJbQ;
        "pkg-1.20.4-1.1.2516.1+neoforge" = _q6iOapR6;
        "pkg-1.20.1-1.1.2516.1+forge" = _Kri13JaT;
        "pkg-1.20.4-1.1.2516.1+fabric" = _9EbgRchE;
        "pkg-1.20.1-1.1.2516.1+fabric" = _tzIdOrwe;
        "pkg-1.21.4-1.1.2516.1+forge" = _GeJejHeT;
        "pkg-1.21.5-1.1.2516.2+neoforge" = _8SCYcdny;
        "pkg-1.21.4-1.1.2516.2+neoforge" = _oXj8Y794;
        "pkg-1.21.5-1.1.2516.2+forge" = _6SipdGr5;
        "pkg-1.21.5-1.1.2516.2+fabric" = _VX114Gl7;
        "pkg-1.21.4-1.1.2516.2+forge" = _QmyNXDaV;
        "pkg-1.21.4-1.1.2516.2+fabric" = _8YvxMxB1;
        "pkg-1.21.3-1.1.2516.2+neoforge" = _AXvVEi34;
        "pkg-1.21.3-1.1.2516.2+forge" = _TZkKI0on;
        "pkg-1.21.3-1.1.2516.2+fabric" = _a3wY7dcq;
        "pkg-1.21.1-1.1.2516.2+neoforge" = _hoKr5ADo;
        "pkg-1.21.1-1.1.2516.2+forge" = _XLs9BA6U;
        "pkg-1.21.1-1.1.2516.2+fabric" = _QXKAQ5Jn;
        "pkg-1.20.4-1.1.2516.2+neoforge" = _uU0q9MZ4;
        "pkg-1.20.4-1.1.2516.2+forge" = _Q464sxS5;
        "pkg-1.20.4-1.1.2516.2+fabric" = _stCYZ58E;
        "pkg-1.20.1-1.1.2516.2+forge" = _s1qMQv5C;
        "pkg-1.20.1-1.1.2516.2+fabric" = _qTc6atJc;
        "pkg-1.21.5-1.1.2516.3+neoforge" = _kzvuda3d;
        "pkg-1.21.4-1.1.2516.3+neoforge" = _xRM9heOs;
        "pkg-1.21.5-1.1.2516.3+forge" = _Z3V1cCFz;
        "pkg-1.21.4-1.1.2516.3+forge" = _gQUcxdnG;
        "pkg-1.21.5-1.1.2516.3+fabric" = _VxJVrGdY;
        "pkg-1.21.3-1.1.2516.3+neoforge" = _SFeJNPtn;
        "pkg-1.21.3-1.1.2516.3+forge" = _iuKUXV6P;
        "pkg-1.21.4-1.1.2516.3+fabric" = _gAjsFyLi;
        "pkg-1.21.1-1.1.2516.3+neoforge" = _xqlHfQ7A;
        "pkg-1.21.3-1.1.2516.3+fabric" = _iAfJyZky;
        "pkg-1.21.1-1.1.2516.3+forge" = _K1dyQFyq;
        "pkg-1.20.4-1.1.2516.3+neoforge" = _4fD4oT2n;
        "pkg-1.21.1-1.1.2516.3+fabric" = _9Vt3DejZ;
        "pkg-1.20.4-1.1.2516.3+forge" = _uqjpEPjv;
        "pkg-1.20.1-1.1.2516.3+fabric" = _AxyVQBbs;
        "pkg-1.20.4-1.1.2516.3+fabric" = _EAGCQnVX;
        "pkg-1.20.1-1.1.2516.3+forge" = _3e14aB4M;
        "pkg-1.21.4-1.1.2517.0+forge" = _3gqSfQlM;
        "pkg-1.21.5-1.1.2517.0+forge" = _An22kHvc;
        "pkg-1.21.5-1.1.2517.0+neoforge" = _svaxuwvZ;
        "pkg-1.21.4-1.1.2517.0+neoforge" = _J9tH7HCC;
        "pkg-1.21.5-1.1.2517.0+fabric" = _xPDiDzgK;
        "pkg-1.21.4-1.1.2517.0+fabric" = _b3qF8Fae;
        "pkg-1.21.3-1.1.2517.0+neoforge" = _PC6MNjh2;
        "pkg-1.21.3-1.1.2517.0+fabric" = _oG6DiBCi;
        "pkg-1.20.4-1.1.2517.0+neoforge" = _EczkaS2E;
        "pkg-1.21.1-1.1.2517.0+forge" = _VoCOItNA;
        "pkg-1.21.1-1.1.2517.0+neoforge" = _oyrrg0u8;
        "pkg-1.21.3-1.1.2517.0+forge" = _fwbGcG1e;
        "pkg-1.20.1-1.1.2517.0+forge" = _RMzwSS1N;
        "pkg-1.21.1-1.1.2517.0+fabric" = _vRbbEPPV;
        "pkg-1.20.1-1.1.2517.0+fabric" = _UTRIQmLl;
        "pkg-1.20.4-1.1.2517.0+fabric" = _AWsabOJz;
        "pkg-1.20.4-1.1.2517.0+forge" = _LibNZwBi;
        "pkg-1.21.3-1.1.2518.0+neoforge" = _GFfj0Ll2;
        "pkg-1.21.5-1.1.2518.0+neoforge" = _6SnDtbQ9;
        "pkg-1.21.4-1.1.2518.0+forge" = _yIHrDL5d;
        "pkg-1.21.4-1.1.2518.0+neoforge" = _hSD9pddd;
        "pkg-1.21.5-1.1.2518.0+forge" = _vBAYxxWx;
        "pkg-1.21.5-1.1.2518.0+fabric" = _BvxXSJlv;
        "pkg-1.21.4-1.1.2518.0+fabric" = _MsT3JIu1;
        "pkg-1.21.1-1.1.2518.0+neoforge" = _6v5d5UuH;
        "pkg-1.21.3-1.1.2518.0+fabric" = _yd5M0Dv2;
        "pkg-1.21.3-1.1.2518.0+forge" = _VjdWHi7I;
        "pkg-1.21.1-1.1.2518.0+forge" = _nIFpxCbg;
        "pkg-1.21.1-1.1.2518.0+fabric" = _PphpHuNB;
        "pkg-1.20.4-1.1.2518.0+forge" = _ombSsW31;
        "pkg-1.20.4-1.1.2518.0+neoforge" = _g3tH9TQ7;
        "pkg-1.20.1-1.1.2518.0+forge" = _7pTuBRLe;
        "pkg-1.20.4-1.1.2518.0+fabric" = _z9Bl7vW3;
        "pkg-1.20.1-1.1.2518.0+fabric" = _z1fra8Hl;
        "pkg-1.21.4-1.1.2518.1+forge" = _DMWjZfsY;
        "pkg-1.21.4-1.1.2518.1+neoforge" = _AJWQaKLP;
        "pkg-1.21.3-1.1.2518.1+neoforge" = _s18WtUy2;
        "pkg-1.21.5-1.1.2518.1+neoforge" = _MuGBNZ7D;
        "pkg-1.21.5-1.1.2518.1+forge" = _akAdpUw0;
        "pkg-1.21.5-1.1.2518.1+fabric" = _p9lEUqX9;
        "pkg-1.21.3-1.1.2518.1+fabric" = _X4gwSciO;
        "pkg-1.21.4-1.1.2518.1+fabric" = _JcpgT6b5;
        "pkg-1.21.3-1.1.2518.1+forge" = _KJopTcDR;
        "pkg-1.20.4-1.1.2518.1+forge" = _yAbwYvGq;
        "pkg-1.21.1-1.1.2518.1+neoforge" = _YUwxtJ8j;
        "pkg-1.21.1-1.1.2518.1+forge" = _AHAQ5wDi;
        "pkg-1.21.1-1.1.2518.1+fabric" = _bJ5ueqVe;
        "pkg-1.20.4-1.1.2518.1+neoforge" = _fPZ37MT4;
        "pkg-1.20.4-1.1.2518.1+fabric" = _C9aBXrxU;
        "pkg-1.20.1-1.1.2518.1+forge" = _NA47NSnJ;
        "pkg-1.20.1-1.1.2518.1+fabric" = _erLAvSS1;
        "default" = _erLAvSS1;
    });
