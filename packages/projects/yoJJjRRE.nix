...
let
    ...
    in {
        ...
        "pkg-1.16.4-fabric0.25.1-1.1.1" = _eGVMpSg0;
        "pkg-20w49a-fabric0.27.2-1.1.1" = _FT5H4qM6;
        "pkg-20w51a-fabric0.28.3-1.1.1" = _zqSJ0pXV;
        "pkg-21w03a-fabric0.29.5-1.1.1" = _8THfUG9X;
        "pkg-21w05a-fabric0.30.1-1.1.1" = _x9m9nKN7;
        "pkg-1.16.5-fabric0.30.0-1.1.1" = _FOOOtHid;
        "pkg-21w07a-fabric0.30.5-1.1.1" = _lmiMNRZw;
        "pkg-21w08b-fabric0.31.1-1.1.1" = _I7sJems5;
        "pkg-21w10a-fabric0.32.1-1.1.1" = _1NzboPGj;
        "pkg-21w11a-fabric0.32.4-1.1.1" = _vYxRLWQ6;
        "pkg-21w13a-fabric0.32.6-1.1.1" = _Elndy0uX;
        "pkg-21w14a-fabric0.32.7-1.1.1" = _gRX2zGA0;
        "pkg-1.17-pre5-fabric0.34.8-1.1.1" = _QiT3CrFQ;
        "pkg-1.17-fabric0.34.9-1.1.1" = _q7dtjvae;
        "pkg-1.17.1-fabric0.36.1-1.1.1" = _WhsNgBbg;
        "pkg-1.17.1-1.1.2" = _HxBfnXkF;
        "pkg-21w40a-1.1.3" = _9Xke6c1g;
        "pkg-1.1.8" = _rpuYs1Va;
        "pkg-1.1.10" = _tol35oV4;
        "pkg-1.1.11" = _RynPxbsG;
        "pkg-1.1.12" = _s9m05wT4;
        "pkg-1.1.13" = _yvnQNe2a;
        "pkg-1.1.7" = _TwEFlZkY;
        "pkg-1.1.14" = _w0uZbaTt;
        "pkg-1.1.15" = _BVhaU9kb;
        "default" = _BVhaU9kb;
    });
