...
let
    ...
    in {
        ...
        "pkg-1.0-MC1.14.4" = _DEJDV9x1;
        "pkg-1.1-MC1.14.4" = _ggMP9P29;
        "pkg-1.1-MC1.15" = _lUsVvYfq;
        "pkg-1.1.1-MC1.14.4" = _Xrc5LVEG;
        "pkg-1.1.1-MC1.15.1" = _jh16qTTB;
        "pkg-1.1.1-MC1.15.2" = _BKd8rPfH;
        "pkg-1.1.1-MC1.15" = _ycLBRJD7;
        "pkg-1.1.1-MC20w10a" = _fGpng2T1;
        "pkg-1.1.1-MC20w11a" = _b5joKM0X;
        "pkg-1.2-MC1.14.4" = _jNJDq5YX;
        "pkg-1.2-MC1.15.1" = _H5Di1SQE;
        "pkg-1.2-MC1.15.2" = _BZ4YdATl;
        "pkg-1.2-MC1.15" = _vJlmVxVm;
        "pkg-1.2-MC1.16-pre1" = _jZv9aAvM;
        "pkg-1.2-MC1.16-pre2" = _dQvSFtaf;
        "pkg-1.2-MC1.16-pre3" = _j1NnzJQo;
        "pkg-1.2-MC1.16-pre4" = _uFzCZzuY;
        "pkg-1.2-MC1.16-pre5" = _b0Qat89n;
        "pkg-1.2-MC1.16-pre6" = _srX6Ztt9;
        "pkg-1.2-MC1.16-pre7" = _9AaEYh95;
        "pkg-1.2-MC1.16-pre8" = _MxGpvdGF;
        "pkg-1.2-MC1.16-rc1" = _feh8p3BP;
        "pkg-1.2-MC1.16.1" = _hjc7CGGh;
        "pkg-1.2-MC1.16" = _e6Wqzeg5;
        "pkg-1.2-MC20w11a" = _KGJy0Y1G;
        "pkg-1.2-MC20w12a" = _AmVdOWeg;
        "pkg-1.2-MC20w13a" = _Ow0l1K4k;
        "pkg-1.2-MC20w14a" = _r4yMcaQE;
        "pkg-1.2-MC20w14infinite" = _6UkEGsES;
        "pkg-1.2-MC20w15a" = _VO2NWg6K;
        "pkg-1.2-MC20w16a" = _6o13yCY8;
        "pkg-1.2-MC20w17a" = _Av5aFFny;
        "pkg-1.2-MC20w18a" = _EOPBMczz;
        "pkg-1.2-MC20w19a" = _T0zx1qna;
        "pkg-1.2-MC20w20a" = _yiY0IEnG;
        "pkg-1.2-MC20w21a" = _dd65THAl;
        "pkg-1.2-MC20w22a" = _GSrgfMQO;
        "pkg-1.2-MC20w27a" = _QJU2jEpC;
        "pkg-1.2-MC20w28a" = _FNKuaDgB;
        "pkg-1.3-MC1.14.4" = _JAavf5Is;
        "pkg-1.3-MC1.15.2" = _yxNgnW13;
        "pkg-1.3-MC1.16.1" = _BdjA3jBV;
        "pkg-1.3-MC1.16.2-pre1" = _StWKmnML;
        "pkg-1.3-MC1.16.2-pre2" = _YPTEfivq;
        "pkg-1.3-MC1.16.2-pre3" = _EM5IjyPr;
        "pkg-1.3-MC1.16.2-rc1" = _rxQETbHc;
        "pkg-1.3-MC20w28a" = _3VJUR5JS;
        "pkg-1.3-MC20w29a" = _OmULmO0C;
        "pkg-1.3-MC20w30a" = _IIergS3P;
        "pkg-1.4-MC1.14.4" = _QBxHYcYp;
        "pkg-1.4-MC1.15.2" = _tLJuw9gA;
        "pkg-1.4-MC1.16.1" = _KT06Tlvg;
        "pkg-1.4-MC1.16.2-rc1" = _fHsSQRf6;
        "pkg-1.4-MC1.16.2-rc2" = _uDPiAIKa;
        "pkg-1.4-MC1.16.2" = _jfv1dezn;
        "pkg-1.4-MC1.16.3-rc1" = _MKbb39uf;
        "pkg-1.4-MC1.16.4-pre1" = _qzMN0njS;
        "pkg-1.4-MC1.16.4-pre2" = _2RPVmVcO;
        "pkg-1.4-MC1.16.4-rc1" = _xCKRTN9w;
        "pkg-1.4-MC1.16.4" = _5auBlMcW;
        "pkg-1.4-MC1.16.3" = _EgHzFcsn;
        "pkg-1.5-MC1.16.3" = _fHcb8U97;
        "pkg-1.5-MC1.16.4" = _sB5GnPdt;
        "pkg-1.5-MC1.16.5" = _4WweTAyv;
        "pkg-1.5-MC1.17-pre1" = _xXkAOmmA;
        "pkg-1.5-MC1.17-pre2" = _NX8H20tL;
        "pkg-1.5-MC1.17-pre3" = _YUr99rQa;
        "pkg-1.5-MC1.17-pre4" = _t2GPUrC7;
        "pkg-1.5-MC1.17-pre5" = _lHc9GSFd;
        "pkg-1.5-MC1.17-rc1" = _KN3PRlKv;
        "pkg-1.5-MC1.17-rc2" = _ctBg3BAr;
        "pkg-1.5-MC1.17.1-pre1" = _cIQ0fm5k;
        "pkg-1.5-MC1.17.1-pre2" = _BEbfQH5C;
        "pkg-1.5-MC1.17.1-pre3" = _tNFL5CgM;
        "pkg-1.5-MC1.17.1-rc1" = _WszuTzcI;
        "pkg-1.5-MC1.17.1-rc2" = _iTV7uELd;
        "pkg-1.5-MC1.17.1" = _GggNiQAS;
        "pkg-1.5-MC1.17" = _McZgH1H5;
        "pkg-1.5-MC1.18-pre1" = _Vk43ujK2;
        "pkg-1.5-MC1.18-pre2" = _z1969qg6;
        "pkg-1.5-MC1.18-pre4" = _qNmCaaTc;
        "pkg-1.5-MC1.18-pre5" = _pFGJ1iqL;
        "pkg-1.5-MC1.18-pre6" = _NOUakZmB;
        "pkg-1.5-MC1.18-pre7" = _vTBwllp4;
        "pkg-1.5-MC1.18-pre8" = _SwMsWmkp;
        "pkg-1.5-MC1.18-rc1" = _29x8hBT2;
        "pkg-1.5-MC1.18-rc3" = _hiRPs9h7;
        "pkg-1.5-MC1.18-rc4" = _d9pfdKQJ;
        "pkg-1.5-MC1.18.1-rc1" = _EUOriu6n;
        "pkg-1.5-MC1.18.1-rc2" = _iwXTZrWA;
        "pkg-1.5-MC1.18.1" = _Gu8hNlQF;
        "pkg-1.5-MC1.18" = _KDR9VOLF;
        "pkg-1.5-MC20w45a" = _8cTiBcCg;
        "pkg-1.5-MC20w46a" = _aye44ppW;
        "pkg-1.5-MC20w48a" = _9c4PznW2;
        "pkg-1.5-MC20w49a" = _jua15ffc;
        "pkg-1.5-MC20w51a" = _hSq6Hyuu;
        "pkg-1.5-MC21w03a" = _eJJ7Ii95;
        "pkg-1.5-MC21w05a" = _eOUxrlR7;
        "pkg-1.5-MC21w06a" = _uJpbZIFm;
        "pkg-1.5-MC21w07a" = _PuiNRNib;
        "pkg-1.5-MC21w08a" = _WxZFs9J2;
        "pkg-1.5-MC21w10a" = _dhs5V7EW;
        "pkg-1.5-MC21w11a" = _VDYFqmdi;
        "pkg-1.5-MC21w13a" = _5EgXO8Av;
        "pkg-1.5-MC21w14a" = _bWFROMbL;
        "pkg-1.5-MC21w15a" = _zuiQlGrN;
        "pkg-1.5-MC21w16a" = _WbS1hv1y;
        "pkg-1.5-MC21w17a" = _HWLqTxBb;
        "pkg-1.5-MC21w18a" = _R8ShsA38;
        "pkg-1.5-MC21w19a" = _fqRyyTkA;
        "pkg-1.5-MC21w20a" = _fZQcTSiX;
        "pkg-1.5-MC21w37a" = _UmQTakcW;
        "pkg-1.5-MC21w38a" = _ep2gkip3;
        "pkg-1.5-MC21w39a" = _or8pUr6V;
        "pkg-1.5-MC21w40a" = _m2vxZBeJ;
        "pkg-1.5-MC21w41a" = _mNfa0kep;
        "pkg-1.5-MC21w42a" = _wGeovBbY;
        "pkg-1.5-MC21w43a" = _4yuH6ZlB;
        "pkg-1.5-MC21w44a" = _F238d2aE;
        "pkg-1.6-MC1.17.1" = _kkO81Kog;
        "pkg-1.6-MC1.18.1" = _o9Eez8YB;
        "pkg-1.6-MC1.18" = _s2n0BBwc;
        "pkg-1.6.1-MC1.17.1" = _zf6722BU;
        "pkg-1.6.1-MC1.18" = _UUNnTnLz;
        "pkg-1.6.1-MC1.18.1" = _shU6Nge6;
        "pkg-1.6.1-MC22w03a" = _DnZzifa8;
        "pkg-1.6.1-MC22w06a" = _lRPe7duT;
        "pkg-1.6.1-MC22w07a" = _W0MZTr80;
        "pkg-1.6.1-MC1.18.2-pre1" = _xHtqxZ1y;
        "pkg-1.6.1-MC1.18.2-pre2" = _aTy8rh5s;
        "pkg-1.6.1-MC1.18.2-pre3" = _bAmV4eAa;
        "pkg-1.6.1-MC1.18.2-rc1" = _hz1yoL69;
        "pkg-1.6.1-MC1.18.2" = _Pn0f2VbJ;
        "pkg-1.6.1-MC22w11a" = _TA9jNcR3;
        "pkg-1.6.1-MC22w12a" = _LgUTD2bJ;
        "pkg-1.6.1-MC22w13a" = _Nehue036;
        "pkg-1.6.1-MC22w13oneblockatatime" = _Uwc0ADSX;
        "pkg-1.6.1-MC22w14a" = _4Q0gwDOE;
        "pkg-1.6.1-MC22w15a" = _vD1vM3JA;
        "pkg-1.6.1-MC22w16b" = _vdIIiaoZ;
        "pkg-1.6.1-MC22w17a" = _qd8sWFhi;
        "pkg-1.6.1-MC22w18a" = _A1UKsFb4;
        "pkg-1.6.1-MC22w19a" = _UHY301cP;
        "pkg-1.6.1-MC1.19-pre1" = _rdB7hUwa;
        "pkg-1.6.1-MC22w05a" = _knZTUmzB;
        "pkg-1.6.1-MC1.19-pre2" = _lt9NKbW2;
        "pkg-1.6.1-MC1.19-pre3" = _8Bxy9p2H;
        "pkg-1.6.1-MC1.19-pre4" = _vDFDx4Gg;
        "pkg-1.6.1-MC1.19-pre5" = _mZtgOqa9;
        "pkg-1.6.1-MC1.19-rc1" = _B9THQjId;
        "pkg-1.6.1-MC1.19-rc2" = _x5CaBmbj;
        "pkg-1.6.1-MC1.19" = _lwkeK4RU;
        "pkg-1.6.1-MC1.19.1-pre1" = _UOeNFYdN;
        "pkg-1.6.1-MC1.19.1-rc1" = _5zUiRCPu;
        "pkg-1.6.1-MC1.19.1-pre2" = _QT6ibKUA;
        "pkg-1.6.1-MC1.19.1-pre3" = _IINvYV6B;
        "pkg-1.6.1-MC1.19.1-pre4" = _Cde45aw5;
        "pkg-1.6.1-MC1.19.1-pre6" = _IRvo1u65;
        "pkg-1.6.1-MC1.19.1-rc2" = _OovlVxtg;
        "pkg-1.6.1-MC1.19.1-rc3" = _3Q1ewtg7;
        "pkg-1.6.1-MC1.19.1" = _KuP4rkVD;
        "pkg-1.6.1-MC1.19.2" = _wkN2wtWZ;
        "pkg-1.6.1-MC22w42a" = _KSheHSYv;
        "pkg-1.6.1-MC22w43a" = _cP2dPFRk;
        "pkg-1.6.1-MC22w44a" = _gmAi3fWN;
        "pkg-1.6.1-MC22w45a" = _M2sduPfL;
        "pkg-1.6.1-MC22w46a" = _oGEkdaeu;
        "pkg-1.6.1-MC1.19.3-pre1" = _2JlPUm00;
        "pkg-1.6.1-MC1.19.3-pre2" = _Cdt2AX9t;
        "pkg-1.6.1-MC1.19.3-pre3" = _aUvTX2DO;
        "pkg-1.6.1-MC1.19.3-rc1" = _Cn4GgZYx;
        "pkg-1.6.1-MC1.19.3-rc2" = _nFo47iXO;
        "pkg-1.6.1-MC1.19.3-rc3" = _5beAdP1Z;
        "pkg-1.6.1-MC1.19.3" = _cS0e9kIZ;
        "pkg-1.6.1-MC23w03a" = _HmSlNtUX;
        "pkg-1.6.1-MC23w04a" = _SpTBqhpm;
        "pkg-1.6.1-MC22w24a" = _P4eHj9RA;
        "pkg-1.6.1-MC23w05a" = _BaAPoLhk;
        "pkg-1.6.1-MC23w06a" = _q0oGiBPW;
        "pkg-1.6.1-MC23w07a" = _cBxoFSgv;
        "pkg-1.6.1-MC1.19.4-pre1" = _YrJ7gyq9;
        "pkg-1.6.1-MC1.19.4-pre2" = _lkZENnUa;
        "pkg-1.6.1-MC1.19.4-pre3" = _KW5TPbRo;
        "pkg-1.6.1-MC1.19.4-pre4" = _5h8QoP7c;
        "pkg-1.6.1-MC1.19.4-rc1" = _SVQqHpru;
        "pkg-1.6.1-MC1.19.4-rc2" = _QNr5JWbZ;
        "pkg-1.6.1-MC1.19.4-rc3" = _8aLs35mN;
        "pkg-1.6.1-MC1.19.4" = _JIJ0VeBJ;
        "pkg-1.6.1-MC23w12a" = _w7CT5359;
        "pkg-1.6.1-MC23w13a" = _ki2GUVrs;
        "pkg-1.6.1-MC23w13a_or_b" = _cP5CgnQH;
        "pkg-1.6.1-MC23w14a" = _yx947gE4;
        "pkg-1.6.1-MC23w16a" = _8qD30BIf;
        "pkg-1.6.1-MC23w17a" = _E1gAzRIa;
        "pkg-1.6.1-MC23w18a" = _sOFEleXL;
        "pkg-1.6.1-MC1.20-pre1" = _97grs8Nj;
        "pkg-1.6.1-MC1.20-pre2" = _avuneXqG;
        "pkg-1.6.1-MC1.20-pre3" = _MGSvss5l;
        "pkg-1.6.1-MC1.20-pre4" = _eNi4Etxw;
        "pkg-1.6.1-MC1.20-pre5" = _UCzaKImr;
        "pkg-1.6.1-MC1.20-pre6" = _1ECgAt6t;
        "pkg-1.6.1-MC1.20-pre7" = _mf2Vqrcj;
        "pkg-1.6.1-MC1.20-rc1" = _WOveBiKC;
        "pkg-1.6.1-MC1.20" = _hC67P3qE;
        "pkg-1.6.1-MC1.20.1-rc1" = _lmjehrdF;
        "pkg-1.6.1-MC1.20.1" = _arEdRkQJ;
        "pkg-1.6.1-MC23w31a" = _MNssK2hd;
        "pkg-1.6.1-MC23w32a" = _nEgCaOLZ;
        "pkg-1.6.1-MC23w33a" = _8EzP4Vw3;
        "pkg-1.6.1-MC23w35a" = _ORWIn4AP;
        "pkg-1.6.1-MC1.20.2-pre1" = _X7I0zjPR;
        "pkg-1.6.1-MC1.20.2-pre2" = _FyIUamsp;
        "pkg-1.6.1-MC1.20.2-pre3" = _lQfzc8nF;
        "pkg-1.6.1-MC1.20.2-pre4" = _yO49BYdr;
        "pkg-1.6.1-MC1.20.2-rc1" = _y0DWxMYG;
        "pkg-1.6.1-MC1.20.2-rc2" = _XFxadqlE;
        "pkg-1.6.1-MC1.20.2" = _2JX39T0c;
        "pkg-1.6.1-MC23w40a" = _JnlFdP9q;
        "pkg-1.6.1-MC23w41a" = _H9M60JU1;
        "pkg-1.6.1-MC23w42a" = _zzwQL4ab;
        "pkg-1.6.1-MC23w43a" = _JAgZmQ9h;
        "pkg-1.6.1-MC23w44a" = _kLcbWMO3;
        "pkg-1.6.1-MC23w45a" = _thiIk12B;
        "pkg-1.6.1-MC23w46a" = _mREICSMh;
        "pkg-1.6.1-MC1.20.3-pre1" = _ogAnyzkz;
        "pkg-1.6.1-MC1.20.3-pre3" = _pz627aOH;
        "pkg-1.6.1-MC1.20.3-pre4" = _lrp727TG;
        "pkg-1.6.1-MC1.20.3-rc1" = _YO3sGxHD;
        "pkg-1.6.1-MC1.19.1-pre5" = _pFgdcTuy;
        "pkg-1.6.1-MC1.20.3-pre2" = _ZwtkHJfk;
        "pkg-1.6.1-MC1.20.3" = _g5W7FdxM;
        "pkg-1.6.1-MC1.20.4-rc1" = _BhtySbcg;
        "pkg-1.6.1-MC1.20.4" = _nPCmcZB7;
        "pkg-1.7-MC1.20.1-Forge" = _l4XKxWpr;
        "pkg-1.7-MC1.20.1" = _IxENJp0J;
        "pkg-1.7-MC1.20.2" = _ZV9B1dfa;
        "pkg-1.7-MC1.20.3" = _YhLO4c6C;
        "pkg-1.7-MC1.20.4" = _bI8F4iSc;
        "pkg-1.7-MC23w51b" = _xW68JYDJ;
        "pkg-1.7-MC1.20.2-NeoForge" = _SFeRtYOs;
        "pkg-1.7-MC24w03b" = _4BB5RFym;
        "pkg-1.7-MC24w04a" = _sAplDxga;
        "pkg-1.7-MC24w05a" = _lytutje6;
        "pkg-1.7-MC24w06a" = _ONKQ3jy6;
        "pkg-1.7-MC24w07a" = _TXh5sVHM;
        "pkg-1.7-MC24w09a" = _ov11nLjH;
        "pkg-1.7-MC24w10a" = _V0mskygu;
        "pkg-1.7-MC24w11a" = _bEQmAf1Y;
        "pkg-1.7-MC24w12a" = _69oBfZrj;
        "pkg-1.7-MC24w13a" = _gtPfbS5g;
        "pkg-1.7-MC24w14potato" = _QTggQwta;
        "pkg-1.7-MC24w14a" = _IAi7jruL;
        "pkg-1.7-MC1.20.5-pre1" = _oQfQn1WY;
        "pkg-1.7-MC1.20.5-pre2" = _8p75s73i;
        "pkg-1.7.1-MC1.20.1-Forge" = _K7llFADq;
        "pkg-1.8-MC1.20.5-pre3" = _YK6wLrP5;
        "pkg-1.8-MC1.20.5-pre4" = _Ere5JCnX;
        "pkg-1.8-MC1.20.5-rc1" = _JVAEIxiq;
        "pkg-1.8-MC1.20.5-rc2" = _lvhzdezw;
        "pkg-1.8-MC1.20.5-rc3" = _STGMfZNj;
        "pkg-1.8-MC1.20.5" = _yAnj031e;
        "pkg-1.8-MC1.20.6-rc1" = _5IQdzvP3;
        "pkg-1.8-MC1.20.6" = _lskwkyWl;
        "pkg-1.8.1-MC1.20.6" = _njXF9YJ1;
        "pkg-1.8.1-MC1.20.5" = _SqVMlFWt;
        "pkg-1.8.1-MC24w18a" = _VZtpnqeJ;
        "pkg-1.8.1-MC24w19b" = _54H8cJ0u;
        "pkg-1.8.1-MC24w20a" = _oEZ8fnv9;
        "pkg-1.8.1-MC24w21b" = _mbvKLlro;
        "pkg-1.8.1-MC1.21-pre1" = _DwdnbPZP;
        "pkg-1.8.1-MC1.21-pre2" = _SacFtDZ1;
        "pkg-1.8.1-MC1.21-pre3" = _lmoVeWQp;
        "pkg-1.8.1-MC1.21-pre4" = _u6zeyr2p;
        "pkg-1.8.1-MC1.21-rc1" = _RNl0favw;
        "pkg-1.8.1-MC1.21" = _n3PGEpcL;
        "pkg-1.8.1-MC1.21.1-rc1" = _XydZ1cCR;
        "pkg-1.8.1-MC1.21.1" = _OQdEgrH9;
        "pkg-1.9-MC1.21.1" = _bMEGaiXq;
        "pkg-1.9-MC1.21" = _53hZXZmF;
        "pkg-1.10-MC1.21.1" = _gGt5TI69;
        "pkg-1.10-MC24w33a" = _iQ1k9hNK;
        "pkg-1.10-MC24w34a" = _d9apgs02;
        "pkg-1.10-MC24w35a" = _N2Gtqt6J;
        "pkg-1.10-MC24w36a" = _d1OCm4na;
        "pkg-1.10-MC24w37a" = _a3lo1xll;
        "pkg-1.10-MC24w38a" = _lJ7arNDB;
        "pkg-1.10-MC24w39a" = _85K2oVCN;
        "pkg-1.10-MC24w40a" = _zkLeiwON;
        "pkg-1.10-MC1.21.2-pre1" = _FaS40lF8;
        "pkg-1.10-MC1.21.2-pre2" = _tVn7kYSY;
        "pkg-1.10-MC1.21.2-pre3" = _vpkglEOX;
        "pkg-1.10-MC1.21.2-pre4" = _UdT5V7tM;
        "pkg-1.10-MC1.21.2-pre5" = _rwMV2NRv;
        "pkg-1.10-MC1.21.2-rc1" = _4sDe260W;
        "pkg-1.10-MC1.21.2-rc2" = _1XiK48Jb;
        "pkg-1.10-MC1.21.2" = _v7ecFGOp;
        "pkg-1.10-MC1.21.3" = _bVulFlVO;
        "pkg-1.10-MC24w44a" = _C3Uq2bYG;
        "pkg-1.10-MC24w45a" = _CQRBT2s7;
        "pkg-1.10-MC24w46a" = _CYssZZPe;
        "pkg-1.10-MC1.21-NeoForge" = _WGnI83Mg;
        "pkg-1.10-MC1.21.3-NeoForge" = _YnA0AKi2;
        "pkg-1.10-MC1.21.4-pre1" = _1Ijl4ZJ4;
        "pkg-1.10-MC1.21.4-pre2" = _esxGbPW3;
        "pkg-1.10-MC1.21.4-pre3" = _RMFLKkje;
        "pkg-1.10-MC1.21.4-rc1" = _2mxUQddT;
        "pkg-1.10-MC1.21.4-rc2" = _nUotPWuX;
        "pkg-1.10-MC1.21.4-rc3" = _1uHgXy2L;
        "pkg-1.10-MC1.21.4" = _yUTKtjJR;
        "pkg-1.10.1-MC1.21.4" = _SEReVptw;
        "pkg-1.10.1-MC1.21.3" = _3yQIOiBo;
        "pkg-1.10.1-MC1.21.2" = _9ipwHpMi;
        "pkg-1.10.1-MC1.21.1" = _ANvaZgzQ;
        "pkg-1.10.1-MC1.21" = _kSP905Qw;
        "pkg-1.10.1-MC1.21.3-NeoForge" = _RqqIeuOW;
        "pkg-1.10.1-MC1.21-NeoForge" = _gTM9onBt;
        "pkg-1.10.1-MC25w02a" = _mYxrIR7A;
        "pkg-1.10.1-MC25w03a" = _J1s5pxaz;
        "pkg-1.10.1-MC1.21.4-NeoForge" = _bnTa4KtJ;
        "pkg-1.10.1-MC25w04a" = _VamJcJPY;
        "pkg-1.10.1-MC25w05a" = _QWGwM2SC;
        "pkg-1.10.1-MC25w06a" = _UJ7XRTLc;
        "pkg-1.10.1-MC25w07a" = _SGQy8qif;
        "pkg-1.10.1-MC25w08a" = _5TeF8c0M;
        "pkg-1.10.1-MC25w09a" = _8WCsZPxO;
        "pkg-1.10.1-MC25w09b" = _dkf1oKQA;
        "pkg-1.10.1-MC25w10a" = _5I54VF58;
        "pkg-1.11-MC1.21.4" = _T2vVgkfW;
        "pkg-1.11-MC25w10a" = _bRqcI0NT;
        "pkg-1.11-MC1.21.5-pre1" = _AkB7AGTo;
        "pkg-1.11-MC1.21.5-pre2" = _tgIwHINk;
        "pkg-1.11-MC1.21.5-pre3" = _WM79xiUK;
        "pkg-1.11-MC1.21.5-rc1" = _XYhcAP6B;
        "pkg-1.11-MC1.21.5-rc2" = _KZLBzeMR;
        "pkg-1.11-MC1.21.5" = _FRxmGW1q;
        "pkg-1.11-MC25w14craftmine" = _lublFqf7;
        "pkg-1.11-MC25w15a" = _fA3IrYWo;
        "pkg-1.11-MC25w16a" = _cZjq3Ub1;
        "pkg-1.11-MC25w17a" = _1zeSx3hA;
        "pkg-1.11-MC25w18a" = _NkUWoqlX;
        "pkg-1.11-MC25w19a" = _KnGkErVJ;
        "pkg-1.11-MC25w20a" = _1P4LgtXo;
        "pkg-1.11-MC25w21a" = _O0rGCu1G;
        "pkg-1.11-MC1.21.6-pre1" = _ohRnWZnn;
        "pkg-1.11-MC1.21.6-pre2" = _4CqOrGwT;
        "pkg-1.11-MC1.21.6-pre3" = _RYGZc6hl;
        "pkg-1.11-MC1.21.6-pre4" = _GMtjlZUp;
        "pkg-1.11-MC1.21.6-rc1" = _1IuNMkIW;
        "pkg-1.11-MC1.21.6" = _rhuRZWvi;
        "pkg-1.11-MC1.21.7-rc1" = _U6bK3Nd3;
        "pkg-1.11-MC1.21.7-rc2" = _7qFuecn6;
        "pkg-1.11-MC1.21.7" = _5eeZnaUP;
        "pkg-1.11-MC1.21.8-rc1" = _tJiLcytY;
        "pkg-1.11-MC1.21.8" = _3fWG5hZn;
        "pkg-1.11-MC25w31a" = _Rh0b8Yof;
        "pkg-1.11-MC25w32a" = _EKt6FzBq;
        "pkg-1.11-MC25w33a" = _pti8DLId;
        "pkg-1.11-MC25w34b" = _SkvBvBMA;
        "pkg-1.11-MC25w35a" = _yYDSINW3;
        "pkg-1.11-MC25w36b" = _qBGkeEFz;
        "pkg-1.11-MC25w37a" = _HfqSEySy;
        "pkg-1.11-MC1.21.9-pre1" = _VvqiCpGc;
        "pkg-1.11-MC1.21.9-pre2" = _w4bewt7o;
        "pkg-1.11-MC1.21.9-pre3" = _zJXLM1LR;
        "pkg-1.11-MC1.21.9-pre4" = _8MRuGJ4d;
        "pkg-1.11-MC1.21.9-rc1" = _e1sOeKfM;
        "pkg-1.11-MC1.21.9" = _z6mMGts6;
        "pkg-1.11-MC1.21.10-rc1" = _rtCzcq3e;
        "pkg-1.11-MC1.21.10" = _OvOCtQIg;
        "pkg-1.11-MC25w41a" = _CqYqxcWw;
        "pkg-1.11-MC25w42a" = _hVuIjX3h;
        "pkg-1.11-MC25w43a" = _NppPF42l;
        "pkg-1.11-MC25w44a" = _qoCK2tGZ;
        "pkg-1.11-MC25w45a" = _7ZOzwaCF;
        "pkg-1.11-MC25w46a" = _9VMo9UH6;
        "pkg-1.11-MC1.21.11-pre1" = _ood7we9g;
        "pkg-1.11-MC1.21.11-pre2" = _1uP1L4v4;
        "pkg-1.11-MC1.21.11-pre3" = _lDsL3vvZ;
        "pkg-1.12-MC1.21.1" = _YOE8Gkm9;
        "pkg-1.12-MC1.21.4" = _z24HzBjT;
        "pkg-1.12-MC1.21.8" = _J8iTqF0l;
        "pkg-1.12-MC1.21.10" = _M2rJT2Ur;
        "pkg-1.12-MC1.21.11-pre3" = _lYdXzus5;
        "pkg-1.12-MC1.21.11-pre4" = _VnayLKnv;
        "pkg-1.12-MC1.21.11-pre5" = _kuHqPZJY;
        "pkg-1.12-MC1.21.11-rc1" = _IBUxK8iN;
        "pkg-1.12-MC1.21.11-rc2" = _wJ14amXl;
        "pkg-1.12-MC1.21.11-rc3" = _kN9zhotz;
        "pkg-1.12-MC1.21.11" = _NY5RP81o;
        "pkg-1.12-MC26.1-snapshot-1" = _J4Jc5ieM;
        "pkg-1.12-MC26.1-snapshot-2" = _EpNboNKu;
        "pkg-1.12-MC26.1-snapshot-3" = _g12FAfLM;
        "pkg-1.12-MC26.1-snapshot-4" = _CxCCKnhn;
        "pkg-1.12-MC26.1-snapshot-5" = _6QsdZTC2;
        "pkg-1.12-MC26.1-snapshot-6" = _TWZVu7m0;
        "pkg-1.12-MC26.1-snapshot-7" = _XcQvld7a;
        "pkg-1.12-MC26.1-snapshot-8" = _BcLnWWj2;
        "pkg-1.12-MC26.1-snapshot-9" = _8YSw068w;
        "pkg-1.12-MC26.1-snapshot-10" = _4xPJJNF8;
        "pkg-1.12-MC26.1-snapshot-11" = _zyXIsZDo;
        "pkg-1.12-MC26.1-pre-1" = _59ksC2ZX;
        "pkg-1.12-MC26.1-pre-2" = _SxnLwSZ3;
        "pkg-1.12-MC26.1-pre-3" = _MxQX4qMq;
        "pkg-1.12-MC26.1-rc-1" = _PXFCLZbo;
        "pkg-1.12-MC26.1-rc-2" = _NO59PQU8;
        "pkg-1.12-MC26.1-rc-3" = _rQzbarL0;
        "pkg-1.12-MC26.1" = _2m74OrKZ;
        "pkg-1.12-MC26.1.1-rc-1" = _Hi6LwWvS;
        "pkg-1.12-MC26.1.1" = _7ZB5t3vy;
        "pkg-1.12-MC26w14a" = _ByCdbwDU;
        "pkg-1.12-MC26.2-snapshot-1" = _mwaeOZIX;
        "pkg-1.12-MC26.1.2-rc-1" = _MAQEuV8I;
        "pkg-1.12-MC26.1.2" = _yvRllLdP;
        "pkg-1.12-MC26.2-snapshot-2" = _31dXmtFc;
        "pkg-1.12-MC26.2-snapshot-3" = _Fd8tQxVO;
        "pkg-1.12-MC26.2-snapshot-4" = _mVhL7Dco;
        "pkg-1.12-MC26.2-snapshot-5" = _qFgDTTKP;
        "pkg-1.12-MC26.2-snapshot-6" = _MOS9CDcX;
        "pkg-1.12-MC26.2-snapshot-7" = _qeSZa2Kx;
        "pkg-1.12-MC26.2-snapshot-8" = _qJ9Yy2q9;
        "pkg-1.12-MC26.2-pre-1" = _8Mhd2Pyb;
        "pkg-1.12-MC26.2-pre-2" = _TcpWtNGS;
        "pkg-1.12-MC26.2-pre-3" = _dg15LO6Q;
        "pkg-1.12-MC26.2-pre-4" = _phyfY1Hg;
        "pkg-1.12-MC26.2-pre-5" = _JpgO5C3w;
        "pkg-1.12-MC26.2-pre-6" = _FryumNIz;
        "pkg-1.12-MC26.2-rc-1" = _Whg8MO2O;
        "pkg-1.12-MC26.2-rc-2" = _NW4BqHoH;
        "pkg-1.12-MC26.2" = _YHOi4aE2;
        "pkg-1.12-MC26.3-snapshot-1" = _QIR83d5N;
        "pkg-1.12-MC26.3-snapshot-2" = _nxau2cME;
        "pkg-1.12-MC26.3-snapshot-3" = _xeuqey90;
        "pkg-1.12-MC26.3-snapshot-4" = _BPZlsBYf;
        "pkg-1.12-MC26.3-snapshot-5" = _9RI1CXZI;
        "pkg-1.12-MC26.3-snapshot-6" = _b6JPe0uE;
        "default" = _b6JPe0uE;
    });
