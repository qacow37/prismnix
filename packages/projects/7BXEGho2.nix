...
let
    ...
    in {
        ...
        "pkg-1.16.5-3.0.9" = _3nqfLiZy;
        "pkg-1.17.1-4.0.3" = _rKgIfesg;
        "pkg-1.18.2-5.1.3" = _xE4RsCO4;
        "pkg-1.19.2-6.2.2" = _7Bjnn0yS;
        "pkg-1.19.3-6.3.0" = _RUG4shjL;
        "pkg-1.20.1-7.0.0" = _F65YDRcA;
        "pkg-1.20.1-7.0.1" = _tsJj2NqY;
        "pkg-1.19.2-6.2.3" = _11wfhIqi;
        "pkg-1.19.4-6.4.0" = _7WropOov;
        "pkg-1.20.1-7.0.2" = _KVrznwq7;
        "pkg-1.19.2-6.2.4" = _EOWfQlBH;
        "pkg-1.19.4-6.4.1" = _zm4DNQ7o;
        "pkg-1.20.1-7.0.3" = _O4JnTEXA;
        "pkg-1.18.2-5.1.4" = _9slUr37l;
        "pkg-1.18.2-5.1.5" = _G3KlQLX3;
        "pkg-1.19.2-6.2.5" = _ZYhtNb4b;
        "pkg-1.19.4-6.4.2" = _awbXxTpD;
        "pkg-1.20.1-7.0.4" = _KfOwAk4u;
        "pkg-1.20.1-7.0.5" = _fk0vlpjL;
        "pkg-1.19.4-6.4.3" = _KBYpFR40;
        "pkg-1.18.2-5.1.6" = _Vl9ERVKj;
        "pkg-1.19.2-6.2.6" = _8HBYebR8;
        "pkg-1.19.4-6.4.4" = _r9bWz031;
        "pkg-1.20.1-7.0.6" = _wruaGPDF;
        "pkg-1.18.2-5.1.7" = _uPCBUUEA;
        "pkg-1.19.2-6.2.7" = _SezrGx52;
        "pkg-1.19.4-6.4.5" = _TAxZUfEt;
        "pkg-1.20.1-7.0.7" = _d7ATUw2G;
        "pkg-1.20.1-7.0.8" = _CcpvadC6;
        "pkg-1.20.4-7.4.0" = _i5j011qq;
        "default" = _i5j011qq;
    });
