...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _bJHFZ9d7;
        "pkg-1.1.0" = _b6KJsHQ9;
        "pkg-1.2.0+1.20" = _XhnbEwwE;
        "pkg-1.2.0+1.19.4" = _OJurihQs;
        "pkg-1.3.0+1.19.4" = _vnxdpfB0;
        "pkg-1.3.0+1.20" = _8qyh8eOu;
        "pkg-1.3.1+1.19.4" = _IgqgiO8s;
        "pkg-1.3.1+1.20" = _T56l9ylh;
        "pkg-1.4.0+1.19.4" = _ObmoqJ7q;
        "pkg-1.4.0+1.20" = _UsFlxZgw;
        "pkg-1.5.0+1.19.4" = _iwfi99OY;
        "pkg-1.5.0+1.20.2" = _W5kqWStu;
        "pkg-1.5.1+1.19.4" = _a1xD7Gt9;
        "pkg-1.5.1+1.20.2" = _zkDyGoX6;
        "pkg-1.5.2+1.19.4" = _JNiAdvhD;
        "pkg-1.5.2+1.20.2" = _XgAQz4oM;
        "pkg-1.5.3+1.19.4" = _mop2M640;
        "pkg-1.5.3+1.20.2" = _28xvzwz8;
        "pkg-1.5.4+1.20.2" = _mbroekZW;
        "pkg-1.5.4+1.20.3" = _Kb6deuHG;
        "pkg-1.5.5+1.19.4" = _L5CPx5Zi;
        "pkg-1.5.5+1.20.2" = _EAC3f0WK;
        "pkg-1.5.5+1.20.3" = _5ScnS5qG;
        "pkg-1.5.6+1.19.4" = _STHHduPW;
        "pkg-1.5.6+1.20.2" = _cYVAWgRb;
        "pkg-1.5.6+1.20.3" = _KPyL3nCa;
        "pkg-1.5.7+1.20.2" = _ln3z0GDh;
        "pkg-1.5.7+1.20.5" = _tdDfMLad;
        "pkg-1.5.8+1.20.5" = _KFYdFl9j;
        "pkg-1.5.9+1.20.5" = _ks8kpZ6z;
        "pkg-1.6.0+1.20.5" = _8mj71NoT;
        "pkg-1.6.1+1.20.5" = _7HHvsdUr;
        "pkg-1.6.1+1.21.5" = _aC5CnNXT;
        "pkg-1.6.2+1.21.5" = _f2RdiQgT;
        "pkg-1.6.2+1.21.10" = _W9vxk9Fb;
        "pkg-1.6.3+1.21.10" = _KnXYZnS8;
        "pkg-1.7.0+1.21.11" = _x7u72lge;
        "pkg-1.7.0+26.1.2" = _sdtl9UMe;
        "pkg-1.6.4+1.20.5" = _FJdRdrnW;
        "pkg-1.6.4+1.21.5" = _atk0Alvn;
        "pkg-1.6.4+1.21.10" = _EptqK5op;
        "pkg-1.7.1+1.21.11" = _UBYjFSoV;
        "pkg-1.7.1+26.1.2" = _fxmbiJZE;
        "default" = _fxmbiJZE;
    });
