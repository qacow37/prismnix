...
let
    ...
    in {
        ...
        "pkg-1.0-b3" = _9vIP9kDd;
        "pkg-1.0-b9_Forge_1.16.5" = _E6U8fNBr;
        "pkg-1.1-b32-R" = _ysbf5AtG;
        "pkg-1.1-b13-R-Forge_1.16.5" = _L9oSP5cX;
        "pkg-1.1-b33-R-Fabric_1.16.5" = _Ubbm3Aq3;
        "pkg-1.1-b44-R-Fabric_1.19.2" = _bAOQlVWU;
        "pkg-1.1-b15-R-Forge_1.19.2" = _deph3nUI;
        "pkg-1.1-b48-R-Fabric_1.19.4" = _BEsimtKq;
        "pkg-1.1.14-Forge_1.16.5" = _Kc9kP0se;
        "pkg-1.1.19" = _9xaIg6vv;
        "pkg-1.1.50" = _pEwEEgPU;
        "pkg-1.1.20" = _A70sE0pY;
        "pkg-1.1.53" = _R9XpPTcp;
        "pkg-1.1.24-Forge" = _OTnQCkQo;
        "pkg-1.1.55" = _WBUenm0r;
        "pkg-1.1.57" = _HiwyIQj1;
        "pkg-1.1.59" = _LbcsHQno;
        "pkg-1.2.61-fabric" = _4a7Nn2Ez;
        "pkg-1.2.61-forge" = _JxCUaNUQ;
        "pkg-1.2.62+1.21.4-forge" = _f5vaAbNm;
        "pkg-1.2.62+1.21.4-fabric" = _mHJa1PEO;
        "pkg-1.2.63+1.19.2-forge" = _3OyKY73v;
        "pkg-1.2.63+1.19.2-fabric" = _ptOAy0Wh;
        "pkg-1.2.66+1.19.2-forge" = _ptC58ZiB;
        "pkg-1.2.66+1.19.2-fabric" = _jHi5O26W;
        "pkg-1.2.68+1.21.4-forge" = _Pryx1nZI;
        "pkg-1.2.68+1.21.4-fabric" = _5e5mQg7J;
        "pkg-1.2.70+1.21.6-fabric" = _Ist8iorb;
        "pkg-1.2.70+1.21.6-forge" = _H6T3gxMU;
        "pkg-1.2.71+1.21.8-fabric" = _lPaT13UY;
        "pkg-1.2.71+1.21.8-forge" = _QYq8GVR1;
        "default" = _QYq8GVR1;
    });
