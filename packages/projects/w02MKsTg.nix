...
let
    ...
    in {
        ...
        "pkg-2.8.8" = _fObkReic;
        "pkg-2.8.9" = _uWtIDnMK;
        "pkg-2.8.10" = _9AvwJs3y;
        "pkg-2.8.11" = _Md7xgFfm;
        "pkg-2.8.12" = _daamc5QO;
        "pkg-2.8.13" = _ZFmmRrR2;
        "pkg-2.8.14" = _gKc4JMZw;
        "pkg-2.8.15" = _2TrhaUzj;
        "pkg-2.8.16" = _KHUZ0SgG;
        "pkg-2.8.17" = _kWbr5gLd;
        "pkg-2.9.0" = _OPICIcNG;
        "pkg-2.9.1" = _SGsPyq0W;
        "pkg-2.9.2" = _dzwW7zbR;
        "pkg-2.9.3" = _8zhGWueM;
        ...
        "pkg-2.9.8" = _TFOMGLk3;
        "pkg-2.9.9" = _1UArPPeT;
        "pkg-2.9.10" = _t9gURTWO;
        "pkg-2.10.0" = _nGwsH27P;
        "pkg-2.10.1" = _Fva1FgWm;
        "default" = _Fva1FgWm;
    });
