...
let
    ...
    in {
        ...
        "pkg-1.16.5-0.2.0-0" = _Eb37SyB9;
        "pkg-1.17.1-0.2.1-0" = _sSE1ZwxS;
        "pkg-1.18.2-0.2.7-2" = _HNFucJYn;
        "pkg-1.19.2-0.3.2-2" = _FrZ4gLAM;
        "pkg-1.20.1-0.4.0-0" = _z7yjWCRz;
        "pkg-1.20.1-0.4.0-1" = _TT6z4mJk;
        "pkg-1.16.5-0.2.1-0" = _kEXX9txK;
        "pkg-1.18.2-0.2.8-0" = _kd2JyOjH;
        "pkg-1.19.2-0.3.3-0" = _vzsN3dkx;
        "pkg-1.20.1-0.4.0-2" = _tfzpMwSv;
        "pkg-1.20.1-0.4.0-3" = _IAG1gYPt;
        "pkg-1.21.1-0.5.0-0" = _dbS5lVeL;
        "pkg-1.21.1-0.5.0-1" = _pfX3Bp0Z;
        "pkg-1.16.5-0.2.2-0" = _9k9uSmNC;
        "pkg-1.18.2-0.2.9-0" = _8ZGPrA0L;
        "pkg-1.19.2-0.3.4-0" = _9q3UeGGQ;
        "pkg-1.20.1-0.4.1-0" = _NlnZa6XB;
        "pkg-1.21.1-0.5.1-0" = _qvcrN0c7;
        "pkg-1.21.1-0.6.0-0" = _pDEHBXIV;
        "pkg-1.21.1-0.6.0-1" = _xkrv51d9;
        "pkg-1.20.1-0.6.0-1" = _3Q7epUwo;
        "pkg-1.21.1-0.6.2" = _DjndBuNm;
        "pkg-1.20.1-0.6.2" = _GPx1sTl5;
        "pkg-1.19.2-0.6.2" = _HGM2nv4M;
        "default" = _HGM2nv4M;
    });
