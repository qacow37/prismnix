...
let
    ...
    in {
        ...
        "pkg-1.16.3-1.0.2" = _w3UNOqfO;
        "pkg-1.2.11" = _GkSmAlQs;
        "pkg-Fabric-1.4.23" = _F0xiuLLl;
        "pkg-Forge-1.4.23" = _OmxdaI0p;
        "pkg-Fabric-1.3.8" = _ff8Qq7si;
        "pkg-forge-1.18.2-1.4.24" = _XQekqbV4;
        "pkg-fabric-1.18.2-1.4.24" = _2inwayGp;
        "pkg-fabric-1.19-beta-1.5.0" = _yBvsobZj;
        "pkg-fabric-1.19-beta-1.5.1" = _7g8zFVSs;
        "pkg-fabric-beta-1.19-1.5.2" = _cFHr2gX4;
        "pkg-fabric-beta-1.19-1.5.3" = _wfAtMRdJ;
        "pkg-fabric-beta-1.19.1.5.4" = _BCcymklZ;
        "pkg-fabric-beta-1.19-1.5.5" = _njgfVBzx;
        "pkg-forge-beta-1.19-1.5.5" = _RCpYk3qS;
        "pkg-forge-1.19-1.5.6" = _SvDAntbc;
        "pkg-fabric-1.19-1.5.6" = _Y1gxb5V4;
        "pkg-fabric-1.19-1.5.7" = _n4Qz2cNt;
        "pkg-forge-1.19-1.5.7" = _auC4Eb1d;
        "pkg-fabric-1.18.2-1.4.26" = _KK6shmf3;
        "pkg-forge-1.18.2-1.4.26" = _DWMi34Yb;
        "pkg-fabric-1.18.2-1.4.28" = _zt4fyjLh;
        "pkg-forge-1.18.2-1.4.28" = _lDJIzfLJ;
        "pkg-fabric-1.19-1.5.8" = _vkcbSNTs;
        "pkg-forge-1.19-1.5.8" = _yFNJII4u;
        "pkg-fabric-1.19-1.5.9" = _gLapWtBn;
        "pkg-forge-1.19-1.5.9" = _XqhVQUJF;
        "pkg-fabric-1.18.2-1.4.29" = _zxtbJTWa;
        "pkg-forge-1.18.2-1.4.29" = _BqICihg1;
        "pkg-forge-1.19-1.5.10" = _JFQXsjqe;
        "pkg-forge-1.18.2-1.4.30" = _8NByS1le;
        "pkg-fabric-1.19.1-1.5.11" = _2mSORAxJ;
        "pkg-forge-1.19.1-1.5.11" = _5DRUtzvx;
        "pkg-fabric-1.18.2-1.4.31" = _cW94KePs;
        "pkg-forge-1.18.2-1.4.31" = _U4gTpMXd;
        "pkg-fabric-1.19.2-1.5.12" = _srV20lh3;
        "pkg-forge-1.19.2-1.5.12" = _wDSTQ0Y0;
        "pkg-fabric-1.19.2-1.6.0" = _nn7CDoeK;
        "pkg-forge-1.19.2-1.6.0" = _8jXGZvC0;
        "pkg-fabric-1.19.2-1.6.1" = _aAxprfxF;
        "pkg-forge-1.19.2-1.6.1" = _V54UOnEG;
        "pkg-forge-1.19.2-1.6.2" = _fhI0jEsJ;
        "pkg-fabric-1.19.2-1.6.2" = _xRlqxEOM;
        "pkg-fabric-1.19.3-1.7.0" = _3znR8mvE;
        "pkg-fabric-1.19.3-1.7.1" = _fhXiLJzH;
        "pkg-forge-1.19.4-1.8.0" = _TwXipZrx;
        "pkg-fabric-1.19.4-1.8.0" = _8LeIO6Kq;
        "pkg-forge-1.19.4-1.8.1" = _nQRTBmHD;
        "pkg-fabric-1.19.4-1.8.1" = _WahWWd0y;
        "pkg-fabric-1.19.4-1.8.2" = _gRPkl2cZ;
        "pkg-forge-1.19.4-1.8.2" = _kJS4txdV;
        "pkg-forge-1.19.2-1.6.3" = _Yb2mpEr8;
        "pkg-fabric-1.19.2-1.6.3" = _7a1jEbdK;
        "pkg-forge-1.19.2-1.6.4" = _vazL5gfV;
        "pkg-fabric-1.19.2-1.6.4" = _9RkVvM3O;
        "pkg-forge-1.19.4-1.8.3" = _F3qmgIa6;
        "pkg-fabric-1.19.4-1.8.3" = _LNgU34dm;
        "pkg-forge-1.19.4-1.9.0" = _cqzmJrXl;
        "pkg-fabric-1.19.4-1.9.0" = _hrF49TKn;
        "pkg-forge-1.19.4-1.9.1" = _VxvPCtE0;
        "pkg-fabric-1.19.4-1.9.1" = _S2l0dl9C;
        "pkg-forge-1.19.4-1.9.2" = _wD1te0on;
        "pkg-fabric-1.19.4-1.9.2" = _zkn1WbLU;
        "pkg-fabric-1.19.4-1.9.3" = _1dIjmZJ8;
        "pkg-forge-1.19.4-1.9.3" = _PzM2xkYb;
        "pkg-forge-1.19.4-1.9.4" = _8lYnlpgZ;
        "pkg-fabric-1.19.4-1.9.4" = _BE2zwysw;
        "pkg-fabric-1.20.0-1.10.0" = _wNgUVvoE;
        "pkg-forge-1.20.0-1.10.0" = _4sCY1wet;
        "pkg-forge-1.19.4-1.9.5" = _iKsY6JG4;
        "pkg-fabirc-1.19.4-1.9.5" = _AAVa3zfM;
        "pkg-forge-1.20.0-1.10.1" = _l53kxKvP;
        "pkg-fabric-1.20.0-1.10.1" = _AmTMeWTC;
        "pkg-forge-1.20.1-1.10.2" = _tZxB9xYc;
        "pkg-fabric-1.20.1-1.10.2" = _ADBEPkA3;
        "pkg-forge-1.20.1-1.10.3" = _qr8qSbBf;
        "pkg-forge-1.20.1-1.10.4" = _PO49nQ9r;
        "pkg-fabric-1.20.1-1.10.4" = _IOpc44DM;
        "pkg-forge-1.20.1-1.10.5" = _zMzbCk1H;
        "pkg-fabric-1.20.1-1.10.5" = _4OAZzyUB;
        "pkg-forge-1.20.1-1.11.0" = _3qAjs2Zu;
        "pkg-fabric-1.20.1-1.11.0" = _JU6grQG9;
        "pkg-Forge-1.20.1-1.11.1" = _5h5ylxZX;
        "pkg-fabric-1.20.1-1.11.1" = _VLElb9Da;
        "pkg-forge-1.20.1-1.11.2" = _1E35TIsr;
        "pkg-fabric-1.20.1-1.11.2" = _7PlNoPGw;
        "pkg-forge-1.20.1-1.11.3" = _OCazhn6C;
        "pkg-fabric-1.20.1-1.11.3" = _1qjQNRgo;
        "pkg-fabric-1.20.1-1.11.4" = _rsoZ2Iqo;
        "pkg-forge-1.20.1-1.11.4" = _ou8TDqX2;
        "default" = _ou8TDqX2;
    });
