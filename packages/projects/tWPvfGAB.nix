...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _YArrW0Nd;
        "pkg-1.20.4-1.0.0-neoForge" = _e4oyOSpk;
        "pkg-1.20.4-1.0.0-fabric" = _m08SGLIf;
        "pkg-1.20.1-1.0.0-fabric" = _bDIgeDB9;
        "pkg-1.19.2-1.0.1-fabric" = _pVcK1T1R;
        "pkg-1.18.2-1.0.0-fabric" = _7GnAawWX;
        "pkg-1.17.1-1.0.0-fabric" = _LtgiGQu7;
        "pkg-1.0.1" = _paBmiEZ9;
        "pkg-2.0.0" = _nbawe6Or;
        "pkg-2.1.1" = _EgXWU3Xh;
        "pkg-2.1.12" = _k3YgDfm6;
        "pkg-2.1.25" = _6qjsVQl5;
        "pkg-2.1.50" = _SFZOp2DQ;
        "pkg-2.1.52" = _YbPb50gA;
        "pkg-2.2.3" = _5fknPjEA;
        "pkg-2.5.01" = _5FmrHi5S;
        "pkg-2.5.02" = _Q08uh8zv;
        "pkg-2.5.10" = _64fiUlxy;
        "pkg-2.5.12" = _WMYNv51D;
        "pkg-2.7.03" = _Czk03lDA;
        "pkg-3.0.0" = _8R93V3H7;
        "pkg-3.0.01" = _riQQaaTy;
        "pkg-3.0.02" = _NMHWoGO5;
        "default" = _NMHWoGO5;
    });
