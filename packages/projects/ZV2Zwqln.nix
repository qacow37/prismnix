...
let
    ...
    in {
        ...
        "pkg-7.0.8" = _DZcCcFgD;
        "pkg-7.0.9" = _rgADaF3n;
        "pkg-7.0.10" = _BMeMBFft;
        "pkg-7.0.11" = _7Kl97G1X;
        "pkg-7.0.12" = _kXcK29Ju;
        "pkg-7.0.13" = _3vPMbQTf;
        "pkg-7.0.14" = _Ui0EKXWm;
        "pkg-7.0.15" = _emZCDQpQ;
        "pkg-7.0.16" = _KxK28zPB;
        "pkg-7.0.17" = _iC6ZKB2Y;
        "pkg-7.0.18" = _TQXTLpwF;
        "pkg-7.0.19" = _yWu72I1y;
        "pkg-7.0.20" = _lCFZv74D;
        "pkg-7.0.21" = _6BQLuUlU;
        "pkg-7.0.22" = _eS3fKg6y;
        "pkg-7.0.23" = _f1EyQYMI;
        "pkg-7.0.25" = _RUfjFNj4;
        "pkg-7.0.26" = _fVbgPi6o;
        "pkg-7.1.0" = _IGSfAQG3;
        "pkg-7.1.1" = _EDHUwbzg;
        "pkg-7.1.2" = _ujG6mgcI;
        "pkg-7.1.3" = _uRT3pmk5;
        ...
        "pkg-7.1.8" = _MYzoyUwH;
        "pkg-7.1.9" = _UQgkR8LU;
        "pkg-7.1.10" = _8QAa5meR;
        "pkg-7.1.11" = _9BZTt9BZ;
        "pkg-7.1.12" = _vDfgzkDo;
        "pkg-7.1.13" = _542O4Ds0;
        "pkg-7.1.14" = _gka411vK;
        "pkg-7.1.15" = _1CPrmcpP;
        "pkg-7.1.16" = _sMbgWfSF;
        "pkg-7.1.17" = _zJhN7uhr;
        "pkg-7.1.18" = _ephLjHM2;
        "pkg-7.1.19" = _iFxDZu2W;
        "pkg-7.1.20" = _u5h8KSnr;
        "pkg-7.2.0" = _2XBvGHyH;
        "pkg-7.2.1" = _Owc3xxBk;
        "pkg-7.2.2" = _DYoJ13Mc;
        "pkg-7.2.3" = _Jq63tzoe;
        ...
        "pkg-7.2.7" = _jlfPa5Td;
        "pkg-7.2.8" = _FeG6oyYH;
        "pkg-7.1.21" = _QddNJuhK;
        "pkg-7.1.22" = _CjRme4xb;
        "pkg-7.1.23" = _6GcULgAS;
        "pkg-7.1.24" = _7mF5DlaZ;
        "pkg-7.1.25" = _sqh1qNq7;
        "pkg-7.1.26" = _gqMbRMG3;
        "pkg-7.99.5" = _HlgvAQNS;
        "pkg-7.99.6" = _nB8MpmYd;
        "pkg-7.99.7" = _4eJ64Phq;
        "pkg-7.99.8" = _9Bq8Y1h8;
        "pkg-7.99.8.1" = _ORkRYmk2;
        "pkg-7.99.8.2" = _HessY5X5;
        "pkg-7.99.12" = _PwI7fkcw;
        "pkg-7.99.13" = _j727ik34;
        "pkg-7.99.14" = _VTDAj6rW;
        "pkg-7.99.15" = _nPQ9lyLF;
        "pkg-7.99.16" = _mQ1hvLrM;
        "pkg-7.99.17" = _ZrtmGSOC;
        "pkg-7.99.18" = _es5cZcGw;
        "pkg-7.99.19" = _7NaMIpkg;
        "pkg-7.99.20" = _iKIrFuFc;
        "pkg-7.99.21" = _bx2fHkMy;
        "pkg-7.99.22" = _c6cepn8w;
        "pkg-7.99.23" = _oDOEfDCg;
        "pkg-7.99.24" = _Ti0KZOXO;
        "pkg-7.99.24.1" = _YfDhJnYu;
        "pkg-7.99.24.2" = _nMY665Cq;
        "pkg-7.99.24.3" = _DCB95ukD;
        "pkg-7.99.24.4" = _W0t7Yy8n;
        "pkg-7.99.24.5" = _L2tAQwka;
        "pkg-7.99.24.6" = _qdWbRKIS;
        "pkg-7.99.24.7" = _Dj98MRsh;
        "pkg-7.99.24.8" = _rGIyrjMM;
        "pkg-7.1.27" = _YHWftuEU;
        "pkg-8.0.0" = _iaQaTxUU;
        "default" = _iaQaTxUU;
    });
