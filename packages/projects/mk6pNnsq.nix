...
let
    ...
    in {
        ...
        "pkg-mc1.17.1-1.0.0" = _fXI09VzJ;
        "pkg-mc1.17.1-1.0.1" = _aI1ZuvHz;
        "pkg-mc1.18-pre2-2.0.0" = _OY3RWeOk;
        "pkg-mc1.17.1-1.1.0" = _L7Oz4t4R;
        "pkg-mc1.18-pre4-2.1.0" = _BIi47sCp;
        "pkg-mc1.17.1-1.1.1" = _okIOnB5u;
        "pkg-mc1.18-pre4-2.1.1" = _5thjofy0;
        "pkg-mc1.16.5-0.1.0" = _9tCQvmn2;
        "pkg-mc1.17.1-1.1.2" = _HFvxfizD;
        "pkg-mc1.18-pre5-2.1.2" = _57uEDPZs;
        "pkg-mc1.16.5-0.1.1" = _1EV6UNNY;
        "pkg-mc1.17.1-1.1.3" = _OxeNh4Nc;
        "pkg-mc1.18-pre5-2.1.3" = _8tOPWe4N;
        "pkg-mc1.16.5-0.1.2" = _gNRiJ6v6;
        "pkg-mc1.17.1-1.1.4" = _2BxcjWrH;
        "pkg-mc1.18-2.1.4" = _dgsXGr1Q;
        "pkg-mc1.18.1-2.1.5" = _u9FLLOnE;
        "pkg-mc1.17.1-1.1.5" = _qakQnuqU;
        "pkg-mc1.16.5-0.2.0" = _H90zuOPO;
        "pkg-mc1.17.1-1.2.0" = _5l6AuX7w;
        "pkg-mc1.18.1-2.2.0" = _rNxf6Kut;
        "pkg-mc1.18.1-2.3.0-forge" = _BefrOvKe;
        "pkg-mc1.18.1-2.3.0-fabric" = _kEJhoM6e;
        "pkg-mc1.19-3.0.0-fabric" = _MqRy7F8m;
        "pkg-mc1.19-3.0.0-forge" = _aaCBQuva;
        "pkg-mc1.18.2-2.4.0-fabric" = _5N93mSlN;
        "pkg-mc1.18.2-2.4.0-forge" = _6gc93iX4;
        "pkg-mc1.19-3.1.0-fabric" = _MoG0uvJN;
        "pkg-mc1.19-3.1.0-forge" = _nN2qxLqq;
        "pkg-mc1.19-3.1.1-fabric" = _cgSuov1n;
        "pkg-mc1.19-3.1.1-forge" = _KIwvVQic;
        "pkg-mc1.19.3-3.2.0-fabric" = _nt3oWgc9;
        "pkg-mc1.19.3-3.2.0-forge" = _LKyOVwIY;
        "default" = _LKyOVwIY;
    });
