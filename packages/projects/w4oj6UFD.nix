...
let
    ...
    in {
        ...
        "pkg-0.3" = _lejUgX7y;
        "pkg-0.3+mod" = _Fg4wgRRt;
        "pkg-0.3.1" = _BxUFVHik;
        "pkg-0.3.1+mod" = _18W9Al93;
        "pkg-1.0.0" = _HI61YAw9;
        "pkg-1.0.0+mod" = _hRO4B0hL;
        "pkg-1.1.0" = _OM8ZY8hV;
        "pkg-1.1.0+mod" = _VmEoMVEH;
        "pkg-1.2.0" = _UYHGp1y5;
        "pkg-1.2.0+mod" = _lRJvzk3R;
        "pkg-1.3.0" = _KUcVoIVC;
        "pkg-1.3.0+mod" = _FG5CjxMY;
        "pkg-1.4.0" = _Xqk5EBCt;
        "pkg-1.4.0+mod" = _KKeWQEz0;
        "pkg-1.4.1" = _OYBbjnRx;
        "pkg-1.4.1+mod" = _C4036uEv;
        "pkg-1.4.2" = _f6HUWH8H;
        "pkg-1.4.2+mod" = _9NoDAwqv;
        "pkg-1.5.0" = _mogAXBAU;
        "pkg-1.5.0+mod" = _9zHsnXSm;
        "pkg-1.5.1" = _IdYHNv9M;
        "pkg-1.5.1+mod" = _akgXSO0T;
        "pkg-1.5.2" = _sMCYpfY8;
        "pkg-1.5.2+mod" = _hNnhpto4;
        "pkg-1.5.3" = _QgqVAPoI;
        "pkg-1.5.3+mod" = _fGDyJRpI;
        "pkg-1.6.0" = _hr50J1OJ;
        "pkg-1.6.0+mod" = _zrwhyodH;
        "pkg-1.6.1" = _y4IOabwe;
        "pkg-1.6.1+mod" = _csJ9b9Jp;
        "pkg-1.6.2" = _dHp4ZCeg;
        "pkg-1.6.2+mod" = _OjjWqAHZ;
        "pkg-1.6.3" = _bd9siyHU;
        "pkg-1.6.3+mod" = _LddoMeoU;
        "pkg-1.6.4" = _ckLvSkoW;
        "pkg-1.6.4+mod" = _sWkfkSiP;
        "pkg-1.6.5" = _kRmGfQo5;
        "pkg-1.6.5+mod" = _YwnAecjS;
        "pkg-1.7.0" = _6NgVwOpn;
        "pkg-1.7.0+mod" = _F8osMncA;
        "pkg-1.7.1" = _e4vcgd4z;
        "pkg-1.7.1+mod" = _C9npq3Cj;
        "pkg-1.7.2" = _DhWESnvj;
        "pkg-1.7.2+mod" = _UfOppyev;
        "pkg-1.7.3" = _7FtlKfaw;
        "pkg-1.7.3+mod" = _AQoJhYwV;
        "pkg-1.7.4" = _9D6OsCoJ;
        "pkg-1.7.4+mod" = _aJa7BPHg;
        "pkg-1.8.0" = _HFx9LyRE;
        "pkg-1.8.0+mod" = _DfkgKi9G;
        "pkg-1.8.1" = _HYIeH9Fk;
        "pkg-1.8.1+mod" = _wSpYohiv;
        "default" = _wSpYohiv;
    });
