...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.8-fabric" = _QAwErNSR;
        "pkg-1.18.2-1.8-fabric" = _a4rID9G0;
        "pkg-1.19.2-1.9-fabric" = _ZDMiRueu;
        "pkg-1.16.5-1.4-forge" = _2Em9SOE2;
        "pkg-1.18.2-1.5-forge" = _czYH42Zq;
        "pkg-1.19.2-1.7-forge" = _iR2cERp4;
        "pkg-1.16.5-2.0-fabric" = _Wp4Z1Yo7;
        "pkg-1.18.2-2.0-fabric" = _W4e30qo3;
        "pkg-1.19.2-2.0-fabric" = _DUjwXI4X;
        "pkg-1.19.3-2.1-fabric" = _rGYsuzjH;
        "pkg-1.19.3-1.7-forge" = _1yIbXZ54;
        "pkg-1.18.2-3.0-forge+fabric" = _lRuCMVg6;
        "pkg-1.19.2-3.0-forge+fabric" = _p8Ts76p2;
        "pkg-1.19.3-3.0-forge+fabric" = _rblmPR4N;
        "pkg-1.19.4-3.0-forge+fabric" = _GRt0LbT5;
        "pkg-1.20-3.0-forge+fabric" = _NJAivLnT;
        "pkg-1.20.1-3.0-forge+fabric" = _cRLEbXwf;
        "pkg-1.20.2-3.0-forge+fabric" = _lISqeq19;
        "pkg-1.18.2-3.1-forge+fabric" = _XSYau9jZ;
        "pkg-1.19.2-3.1-forge+fabric" = _hda2e6Sk;
        "pkg-1.20.1-3.1-forge+fabric" = _LLyOT4Pn;
        "pkg-1.20.2-3.1-forge+fabric" = _lybydPYY;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _80N5oW0w;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _PPWQwdVv;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _TSJW15RI;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _tl3nA81w;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _RMit1Ay1;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _AOq0FLaS;
        "pkg-1.19.2-3.3-fabric+forge" = _iqH582EL;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _j0xRzzDj;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _K4nTfvLF;
        "pkg-1.20.5-3.3-fabric+neo" = _U9vJSW4L;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _youTtSBE;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _rXMtzSkx;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _een6nMQG;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _TdM5BvGr;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _f4eAoIpH;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _Dn6elI2b;
        "pkg-1.21.2-3.4-fabric+neo" = _37l7nKcR;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _7TIgArk0;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _eMeSmzmL;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _VjJgkK28;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _PULGUIYZ;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _JkcUgyZs;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _OLI1eONf;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _gGh6HaLR;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _roUOvoQl;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _PkaIW7cV;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _X96n9n1G;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _28dZL5Ua;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _NwRksTCY;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _czjLUyfi;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _obAGDGgE;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _v7sWiu4V;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _iOH6vg60;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _BFgRHLFu;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _FD8gmqSm;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _QbLd0tvF;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _34mcIh6k;
        "default" = _34mcIh6k;
    });
