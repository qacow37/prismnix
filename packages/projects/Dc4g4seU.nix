...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.19.4-build.1" = _uPWbZCun;
        "pkg-1.19.4-1.0.1-forge" = _kUTRUo0U;
        "pkg-1.19.4-1.0.1-fabric" = _MIXN2vQJ;
        "pkg-1.19.4-1.0.2-forge" = _CxxY5xsY;
        "pkg-1.19.4-1.0.2-fabric" = _ttSfMAlU;
        "pkg-1.20.1-2.0.0-forge" = _9YsOqP3a;
        "pkg-1.20.1-2.0.0-fabric" = _afQ5UT9e;
        "pkg-1.20.1-2.0.1-forge" = _GgEcnTJf;
        "pkg-1.20.1-2.0.1-fabric" = _8S5GWqua;
        "pkg-2.1.0-forge" = _VfvliTdR;
        "pkg-2.1.0-fabric" = _zF39lJCF;
        "pkg-2.1.1-forge" = _kVL3vR9m;
        "pkg-2.1.1-fabric" = _rWacmm7l;
        "pkg-2.1.2-forge" = _2Riip6rV;
        "pkg-2.1.2-fabric" = _KfEcVOeO;
        "pkg-3.0.0+mc1.20.4-forge" = _lGuDSIBK;
        "pkg-3.0.0+mc1.20.4-fabric" = _xXZg2N5z;
        "pkg-3.1.0+mc1.20.4-forge" = _RrXf7Jz9;
        "pkg-3.1.0+mc1.20.4-fabric" = _ZZOgliA8;
        "pkg-3.1.1+mc1.20.4-forge" = _m8EFISmW;
        "pkg-3.1.1+mc1.20.4-fabric" = _X5xZejCK;
        "pkg-3.2.0+mc1.21-forge" = _P6xu5xm9;
        "pkg-3.2.0+mc1.21-fabric" = _ihfFESFp;
        "pkg-3.2.1+mc1.21-forge" = _svpdLLrq;
        "pkg-3.2.1+mc1.21-fabric" = _HLBwcaIT;
        "pkg-3.2.2+mc1.21.1-forge" = _kxPcxaoi;
        "pkg-3.2.2+mc1.21.1-fabric" = _zKKtThvm;
        "pkg-3.2.3+mc1.21.1-forge" = _mhrm5tGu;
        "pkg-3.2.3+mc1.21.1-fabric" = _TxKQBvID;
        "pkg-3.3.0+mc1.21.1-forge" = _chJfG2YS;
        "pkg-3.3.0+mc1.21.1-fabric" = _U1b8PQFR;
        "pkg-3.3.1+mc1.21.4-forge" = _yvIpja0H;
        "pkg-3.3.1+mc1.21.4-fabric" = _9Ooys4Ix;
        "pkg-3.3.1+mc1.21.1-forge" = _bMa9R0SG;
        "pkg-3.3.1+mc1.21.1-fabric" = _SIMh0Umd;
        "pkg-3.3.2+mc1.21.4-forge" = _5XNyXiDu;
        "pkg-3.3.2+mc1.21.4-fabric" = _cRp5FBRW;
        "pkg-3.3.3.1+mc1.21.4-forge" = _mDv9WrZo;
        "pkg-3.3.3.1+mc1.21.4-fabric" = _fsh4Pshj;
        "pkg-3.3.4+mc1.21.4-forge" = _z9NFXWOv;
        "pkg-3.3.4+mc1.21.4-fabric" = _vUqqhlxP;
        "pkg-3.3.5+mc1.21.4-forge" = _q4FHDqXx;
        "pkg-3.3.5+mc1.21.4-fabric" = _JxyryNb5;
        "pkg-3.4.0+mc1.21.5-forge" = _aD9JIjUw;
        "pkg-3.4.0+mc1.21.5-fabric" = _K0SQrQE4;
        "pkg-3.4.0+mc1.21.8-forge" = _V91xmUwX;
        "pkg-3.4.0+mc1.21.8-fabric" = _UziJjzSw;
        "pkg-3.4.1+mc1.21.8-forge" = _CauznQ7W;
        "pkg-3.4.1+mc1.21.8-fabric" = _ed0MvWmw;
        "pkg-3.4.2+mc1.21.9-forge" = _FE13fm1N;
        "pkg-3.4.2+mc1.21.9-fabric" = _njxc5LNY;
        "pkg-3.4.4+mc1.21.9-forge" = _mrE3W86U;
        "pkg-3.4.4+mc1.21.9-fabric" = _ZfDr2zc2;
        "pkg-3.4.5+mc1.21.9-forge" = _Oimi23py;
        "pkg-3.4.5+mc1.21.9-fabric" = _vVuBW5jp;
        "pkg-3.4.6+mc1.21.11-forge" = _jFP4RiOk;
        "pkg-3.4.6+mc1.21.11-fabric" = _ExuEpfee;
        "pkg-3.4.7+mc1.21.11-forge" = _aGPyX9Ib;
        "pkg-3.4.7+mc1.21.11-fabric" = _LD554NcN;
        "pkg-3.4.8+mc26.1" = _QpTbjRzS;
        "pkg-3.4.8+mc1.21.11-forge" = _hXmH2OF0;
        "pkg-3.4.8+mc1.21.11-fabric" = _s7bWrbeV;
        "pkg-3.4.9+mc1.21.11-forge" = _5TDomEG1;
        "pkg-3.4.9+mc1.21.11-fabric" = _NO6WQiYJ;
        "pkg-3.4.9+mc26.1.2" = _g6nwW3hR;
        "pkg-3.4.9+mc26.2" = _yEdesEWA;
        "pkg-3.4.10+mc26.2" = _jtItiTtj;
        "default" = _jtItiTtj;
    });
