...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _NtWDa45E;
        "pkg-2.0.0_forge-neoforge-1.20.1" = _DLQfhmmv;
        "pkg-2.0.1-forge_neoforge-1.20.1" = _B55GkgUd;
        "pkg-2.1.0-forge_neoforge-1.20.1" = _wkXyzb3c;
        "pkg-2.1.1-forge_neoforge-1.20.1" = _jGoJRM6P;
