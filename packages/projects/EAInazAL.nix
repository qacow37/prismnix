...
let
    ...
    in {
        ...
        "pkg-1.3-1.21.6" = _XDSfVjSl;
        "pkg-1.3-1.21.5" = _aCEqgQDN;
        "pkg-1.2-1.21.6" = _QbKQzM1s;
        "pkg-1.2-1.21.5" = _UXJyv1RA;
        "pkg-1.2-1.21.4" = _vFFqHXZB;
        "pkg-1.1-1.21.3" = _m8vjF7hk;
        "pkg-1.2-1.21" = _yvnyrt5i;
        "pkg-1.2-1.21.1" = _Q87EPljB;
        "pkg-1.3-1.21.4" = _BeO615NZ;
        "pkg-1.3-1.21.2" = _R1pJno7t;
        "pkg-1.3-1.21" = _XQxBGQWn;
        "pkg-1.2-1.20.1" = _Qa6ysd2S;
        "pkg-1.1-1.20.5" = _ru3xnEEW;
        "pkg-1.2-1.20" = _ocwxBQzy;
        "pkg-1.1-1.19.4" = _SiyiImYh;
        "pkg-1.1-1.19.3" = _78exaV5x;
        "pkg-1.1-1.19" = _REJPehUU;
        "pkg-1.1-1.18.2" = _nCEE4hh6;
        "pkg-1.1-1.18" = _sQXogKJm;
        "pkg-1.1-1.17.1" = _3rgUoRaK;
        "pkg-1.1-1.16.2" = _TsFxiLd5;
        "pkg-1.3-1.21.3" = _CU7q6BIW;
        "pkg-1.1-1.20.6" = _VxV535HH;
        "pkg-1.1-1.20.1" = _V6u0G2Ed;
        "pkg-1.1" = _9mkn72Qh;
        "pkg-1.0-1.21.6" = _5dtbRGro;
        "pkg-1.4-1.21.5" = _wnqKHyOi;
        "pkg-2.1-1.21.6" = _GIvBE4nS;
        "pkg-2.1-1.21.5" = _v1jovtnq;
        "pkg-2.0-1.21.4" = _JT7wdGhO;
        "pkg-2.0-1.21" = _eOKn7N5O;
        "pkg-2.0-1.20.6" = _yC8hc6CJ;
        "pkg-2.0-1.20.1" = _hpGWp7Hb;
        "pkg-2.0-1.21.7" = _B0Joqr3K;
        "pkg-2.0-1.21.6" = _6ny5pXqw;
        "pkg-2.0-1.21.5" = _gkK7GHcA;
        "pkg-2.0-1.21.1" = _Qpo3NJVM;
        "pkg-2.2-1.16.2" = _pIaSIv0k;
        "pkg-2.2-1.17.1" = _aeNEcXAN;
        "pkg-2.2-1.18" = _Y0HPpcR1;
        "pkg-2.2-1.19" = _C7brvYOT;
        "pkg-2.2-1.19.3" = _SEbjMdAV;
        "pkg-2.2-1.19.4" = _T5axg1Pd;
        "pkg-2.2-1.20.1" = _5Zqh5KKd;
        "pkg-2.3-1.20.1" = _NU8OjRrv;
        "default" = _NU8OjRrv;
    });
