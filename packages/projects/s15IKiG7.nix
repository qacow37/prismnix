...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.1-fabric+forge+neo" = _Gvf7Gvpo;
        "pkg-1.20.6-1.1-fabric+forge+neo" = _K1Nj8l5a;
        "pkg-1.21.0-1.1-fabric+forge+neo" = _Jsplkhk8;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _MrWUQVbf;
        "pkg-1.20.6-1.2-fabric+forge+neo" = _hcDrWB4d;
        "pkg-1.21.0-1.2-fabric+forge+neo" = _tMtytj2F;
        "pkg-1.21.1-1.2-fabric+forge+neo" = _vKXuvnPm;
        "pkg-1.21.2-1.2-fabric+neo" = _jjWzHjON;
        "pkg-1.21.3-1.2-fabric+forge+neo" = _XaJGFo0v;
        "pkg-1.21.4-1.2-fabric+forge+neo" = _rjtTrv3h;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _e8dDwtHA;
        "pkg-1.21.1-1.3-fabric+forge+neo" = _SbVZ6LuE;
        "pkg-1.21.4-1.3-fabric+forge+neo" = _uBdik4I3;
        "pkg-1.20.1-1.4-fabric+forge+neo" = _vNmQh4Z6;
        "pkg-1.21.1-1.4-fabric+forge+neo" = _2wMwORRj;
        "pkg-1.21.4-1.4-fabric+forge+neo" = _34xWyIHj;
        "pkg-1.20.1-1.5-fabric+forge+neo" = _yB31OI3Z;
        "pkg-1.21.1-1.5-fabric+forge+neo" = _SUMHhaJq;
        "pkg-1.21.4-1.5-fabric+forge+neo" = _kTZF05Ro;
        "pkg-1.21.5-1.5-fabric+forge+neo" = _JvkFLPoS;
        "pkg-1.21.6-1.5-fabric+forge+neo" = _ARaD8TKA;
        "pkg-1.21.7-1.5-fabric+forge+neo" = _yn5iBRR3;
        "pkg-1.21.8-1.5-fabric+forge+neo" = _QMAP05Ls;
        "pkg-1.20.1-1.6-fabric+forge+neo" = _4AtX1FjJ;
        "pkg-1.21.1-1.6-fabric+forge+neo" = _3zjGKotV;
        "pkg-1.21.8-1.6-fabric+forge+neo" = _d1RPLchG;
        "pkg-1.21.9-1.6-fabric+forge+neo" = _d8YB2CTa;
        "pkg-1.21.9-1.7-fabric+forge+neo" = _sHw319JJ;
        "pkg-1.21.10-1.7-fabric+forge+neo" = _sdGV72uP;
        "pkg-1.21.11-1.7-fabric+forge+neo" = _bQfWOz5t;
        "pkg-26.1.0-1.7-fabric+forge+neo" = _vUBxGgRG;
        "pkg-26.1.1-1.7-fabric+forge+neo" = _6rhBB8ap;
        "pkg-26.1.2-1.7-fabric+forge+neo" = _707WoIsi;
        "pkg-1.20.1-1.8-fabric+forge+neo" = _uk4ZxwHM;
        "pkg-1.21.1-1.8-fabric+forge+neo" = _OTfIDvqx;
