...
let
    ...
    in {
        ...
        "pkg-1.20.1-0.0.5.1" = _ZucLJB1a;
        "pkg-1.19.2-0.0.5.1" = _xPrqK6J2;
        "pkg-1.20.1-0.0.6.0" = _bFsZsmuL;
        "pkg-1.19.2-0.0.6.0" = _zyYEw7Ww;
        "pkg-1.20.1-0.0.6.1" = _Be3TCuVj;
        "pkg-1.19.2-0.0.6.1" = _IyHVzFPl;
        "pkg-1.20.1-0.0.7.0" = _YTRyfKFW;
        "pkg-1.19.2-0.0.7.0" = _38xbFq0a;
        "pkg-1.20.1-0.1.0.0" = _3qr3rJtZ;
        "pkg-1.19.2-0.1.0.0" = _PkjdfBNp;
        "pkg-1.20.1-0.1.1.0" = _3GLnZzdc;
        "pkg-1.19.2-0.1.1.0" = _dH0dSqka;
        "pkg-1.20.1-0.1.1.1" = _ZhT8TzDs;
        "pkg-1.19.2-0.1.1.1" = _3jSyIZbD;
        "pkg-1.20.1-0.1.1.2" = _UkJUnEAU;
        "pkg-1.19.2-0.1.1.2" = _IGWoevzn;
        "pkg-1.20.1-0.1.2.0" = _FAjHN6d3;
        "pkg-1.19.2-0.1.2.0" = _MkLe4O2W;
        "pkg-1.18.2-0.1.2.0" = _IHdRgzJx;
        "pkg-1.20.1-0.1.3.0" = _dFpzNmc6;
        "pkg-1.19.2-0.1.3.0" = _NWAmCMPX;
        "pkg-1.20.1-0.1.3.1" = _GiIObMFG;
        "pkg-1.19.2-0.1.3.1" = _QW7aqLMo;
        "pkg-1.18.2-0.1.3.1" = _c68CeL4j;
        "pkg-1.20.1-0.1.3.2" = _cJizWJ0n;
        "pkg-1.19.2-0.1.3.2" = _KSQ6tBAx;
        "pkg-1.18.2-0.1.3.2" = _FkO2EFmh;
        "pkg-1.20.1-0.1.3.3" = _ET55biK2;
        "pkg-1.19.2-0.1.3.3" = _XuvHnrOC;
        "pkg-1.18.2-0.1.3.3" = _wX5geUto;
        "pkg-1.20.1-0.1.3.4" = _Xvsg0LLg;
        "pkg-1.19.2-0.1.3.4" = _BrnbBtkV;
        "pkg-1.18.2-0.1.3.4" = _YqEElgYv;
        "pkg-1.20.1-0.1.4.0" = _Eqgf9fGN;
        "pkg-1.20.1-0.1.4.1" = _HDt55fIe;
        "pkg-1.19.2-0.1.4.0" = _uOpOrtMc;
        "pkg-1.18.2-0.1.4.0" = _SJbAcYTO;
        "pkg-1.20.1-0.1.4.2" = _G8kN4IG9;
        "pkg-1.19.2-0.1.4.1" = _8pTGdLX8;
        "pkg-1.18.2-0.1.4.1" = _rlkdyUvT;
        "pkg-1.20.1-0.1.4.3" = _hDcuIXjS;
        "pkg-1.19.2-0.1.4.2" = _hjexZekh;
        "pkg-1.18.2-0.1.4.2" = _vYW6tC75;
        "pkg-1.20.1-0.1.5.0" = _yK61xX35;
        "pkg-1.19.2-0.1.5.0" = _2IiJzf5Q;
        "pkg-1.18.2-0.1.5.0" = _rgkgHMw3;
        "pkg-1.20.1-0.1.5.1" = _Iv2XMeTT;
        "pkg-1.19.2-0.1.5.1" = _s0dswQ0B;
        "pkg-1.18.2-0.1.5.1" = _l2y6YbSt;
        "pkg-1.18.2-0.1.5.1a" = _sJAb5377;
        "pkg-1.20.1-0.1.6.0" = _lPOrIWJq;
        "pkg-1.19.2-0.1.6.0" = _7nllkrsp;
        "pkg-1.18.2-0.1.6.0" = _Dpqea8UR;
        "pkg-1.20.1-0.2.0.0" = _Q63DwgtV;
        "pkg-1.19.2-0.2.0.0" = _pwPgvscX;
        "pkg-1.18.2-0.2.0.0" = _Itn1I4OG;
        "pkg-1.20.1-0.2.0.1" = _EiiQt417;
        "pkg-1.19.2-0.2.0.1" = _f5ItheFT;
        "pkg-1.18.2-0.2.0.1" = _OKEFnVxy;
        "pkg-1.20.1-0.2.0.2" = _Z8VfPb3D;
        "pkg-1.19.2-0.2.0.2" = _8hv018YK;
        "pkg-1.18.2-0.2.0.2" = _w6cxNV7Q;
        "pkg-1.20.1-0.2.0.3" = _a7TBDYtd;
        "pkg-1.19.2-0.2.0.3" = _nXivVakq;
        "pkg-1.18.2-0.2.0.3" = _5SDJMqIm;
        "default" = _5SDJMqIm;
    });
