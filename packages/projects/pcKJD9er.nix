...
let
    ...
    in {
        ...
        "pkg-1.4.0-1.20+" = _7mdPn6w8;
        "pkg-1.4.1-1.20+" = _K1p1hNpk;
        "pkg-1.5.0-1.20.2" = _GKOfr1kS;
        "pkg-1.5.0-1.20.3" = _mR6KIuXF;
        "pkg-1.5.0-1.20.5" = _Y3wIg8Wq;
        "pkg-1.5.1-1.20.3" = _DkIRT0DH;
        "pkg-1.5.1-1.20.5" = _bq29nEVX;
        "pkg-1.5.0-1.20+" = _ccY1pEax;
        "pkg-1.6.0-1.21.0" = _QIhazRpp;
        "pkg-1.7.0-1.21.2" = _jCONrafE;
        "pkg-1.7.0-1.21.4" = _JmBKkjLk;
        "pkg-1.7.1-1.21.5" = _vbNqpcWe;
        "pkg-1.6.1-1.21.0" = _eo9IZItj;
        "pkg-1.7.1-1.21.2" = _rNxZKwe6;
        "pkg-1.7.1-1.21.4" = _XSDtGqzm;
        "pkg-1.8.0-1.21.6" = _ItF2MZeO;
        "pkg-1.8.1-1.21.6" = _5JPZ3FPx;
        "pkg-1.8.2-1.21.9" = _nsbi30Mj;
        "pkg-1.8.3-1.21.11" = _Iec1rY79;
