...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _tWtlPztN;
        "pkg-1.11.0" = _1NHrCjsV;
        "pkg-1.11.1" = _ACWHPnTF;
        "pkg-1.11.2" = _xF2zbaNJ;
        "pkg-1.11.3" = _olW5zmzo;
        "pkg-1.12.0" = _Yw5ee6ku;
        "pkg-1.12.1" = _xwioxCcd;
        "pkg-1.12.2" = _vdp1h7im;
        "pkg-1.12.3" = _8nhnpkvD;
        "pkg-1.12.4" = _3RpAvJ56;
        "pkg-1.13.0" = _U0VfpTDU;
        "pkg-1.14.0" = _jaUh3y5Z;
        "pkg-1.14.1" = _kR47e3XV;
        "pkg-1.15.0" = _QAazQ1Mo;
        "pkg-1.15.1" = _smgOiB4v;
        "pkg-1.15.2" = _O9VPrenD;
        "pkg-1.15.3" = _gnwcgOxh;
        "pkg-1.15.4" = _4uyCff71;
        "pkg-1.16.0" = _r9dRfF5c;
        "pkg-1.16.1" = _YvXMrlzU;
        "pkg-1.17.0" = _CRVGlOVV;
        "pkg-1.17.1" = _n5aQFGOH;
        "pkg-1.17.2" = _jN3OaOAC;
        "pkg-1.18.0" = _az4LA2LG;
        "pkg-1.18.1" = _faq2Z2FR;
        "pkg-1.18.2" = _mh5bInOQ;
        "pkg-1.19.0" = _2hsk1i0g;
        "pkg-1.19.1" = _w8EPmN6Y;
        "pkg-1.19.2" = _xIufJx83;
        "default" = _xIufJx83;
    });
