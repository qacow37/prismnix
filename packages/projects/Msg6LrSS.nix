...
let
    ...
    in {
        ...
        "pkg-1.1.4" = _cEUVYS49;
        "pkg-1.2" = _VVTJjHvR;
        "pkg-1.2.1-fabric" = _ftRulZ6i;
        "pkg-1.2.1-neoforge" = _Qc3pNNlo;
        "pkg-1.2.2-fabric" = _hFINSwD8;
        "pkg-1.2.2-neoforge" = _oYjd38Kq;
        "pkg-1.2.2-fabric-1.21.2" = _wI5yMrq0;
        "pkg-1.2.2-neoforge-1.21.2" = _xJsQQd9B;
        "pkg-1.2.2-fabric-1.21" = _CmnXxPv8;
        "pkg-1.2.2-neoforge-1.21" = _sf0tC9Fd;
        "pkg-1.2.3-fabric-1.21" = _k0WKaLWX;
        "pkg-1.2.3-neoforge-1.21" = _QW9D51FB;
        "pkg-1.2.3-fabric-1.21.2" = _QVZs73bK;
        "pkg-1.2.3-neoforge-1.21.2" = _1sm35hHa;
        "pkg-1.2.3-fabric" = _cSz9U5li;
        "pkg-1.2.3-neoforge" = _YvPShNnF;
        "pkg-1.2.4-fabric-1.21" = _nHzzu1lT;
        "pkg-1.2.4-fabric-1.21.2" = _D4muxWr9;
        "pkg-1.2.4-fabric-1.21.5" = _rVJFtfCj;
        "pkg-1.2.4-neofore-1.21" = _8gjiPtPM;
        "pkg-1.2.4-neoforge-1.21.2" = _lsL69eUi;
        "pkg-1.2.4-neoforge-1.21.5" = _Y1o9PuPr;
        "pkg-1.2.5+1.21-fabric" = _eJUgOHgQ;
        "pkg-1.2.5+1.21.2-fabric" = _hyBgLXEZ;
        "pkg-1.2.5+1.21.5-fabric" = _mM3IRnMA;
        "pkg-1.2.5+1.21-neoforge" = _jkFzoHEV;
        "pkg-1.2.5+1.21.2-neoforge" = _ckLNCMD3;
        "pkg-1.2.5+1.21.5-neforge" = _UBvjaQuN;
        "pkg-1.2.5-hotfix+1.21.5-fabric" = _523pEYBb;
        "pkg-1.2.5-hotfix+1.21.5-neoforge" = _pwV3LN2d;
        "pkg-1.2.6+1.21.11-fabric" = _yeHrW0Ix;
        "pkg-1.3.0+1.21.11-fabric" = _ckxOt3gD;
        "pkg-1.3.0+1.21.11-neoforge" = _3pAHb9CT;
        "default" = _3pAHb9CT;
    });
