...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _9ZaKnyFk;
        "pkg-1.0.2" = _qeXNDwK1;
        "pkg-1.0.3-1.21.4" = _3vJdhOTL;
        "pkg-1.0.3-1.21.1" = _ly4D7XLo;
        "pkg-1.0.3-1.20.1" = _STVzoWwh;
        "pkg-1.0.4-1.21.4" = _Q7kQE4CT;
        "pkg-1.0.4-1.21.1" = _qH1dISo2;
        "pkg-1.0.4-1.20.1" = _TapvY3IA;
        "pkg-1.0.4-1.19.2" = _OfBSLaRy;
        "pkg-1.0.4.1-1.20.1" = _l8ZO7zFj;
        "pkg-1.0.4.1-1.19.2" = _SGZS81sz;
        "pkg-1.0.5-1.21.4" = _D9KRlOxf;
        "pkg-1.0.5-1.21.3" = _1jVUDUJr;
        "pkg-1.0.5-1.21.1" = _7513Kasm;
        "pkg-1.0.5-1.20.1" = _z2ReG6qK;
        "pkg-1.0.5-1.19.2" = _q4TCHZBg;
        "pkg-1.0.6-1.21.4" = _6aCtwzNx;
        "pkg-1.0.6-1.21.3" = _AEM3AlCU;
        "pkg-1.0.6-1.21.1" = _i4qhc4xg;
        "pkg-1.0.6-1.20.1" = _ZVOCan5o;
        "pkg-1.0.6-1.19.2" = _kebKLmiF;
        "pkg-1.0.7-1.21.4" = _aDLV7pnz;
        "pkg-1.0.7-1.21.11" = _XicguzPJ;
        "pkg-1.0.7-1.20.1" = _14FQZ4mM;
        "pkg-1.0.7-1.19.2" = _hyFT59cp;
        "pkg-1.0.7-1.21.1" = _WpA59vts;
        "pkg-1.0.8-1.19.2" = _jmLdyIMR;
        "pkg-1.0.8-1.20.1" = _SpbiXm4t;
        "pkg-1.0.8-1.21.1" = _rUfJxIPH;
        "pkg-1.0.8-1.21.4" = _eRdDwu9A;
        "pkg-1.0.8-1.21.11" = _onmtg6w9;
        "pkg-1.0.9-1.19.2" = _QdZhj1or;
        "pkg-1.0.9-1.20.1" = _WVYGxitH;
        "pkg-1.0.9-1.21.1" = _6mCe1UkK;
        "pkg-1.0.9-1.21.4" = _Gr0Ee3uP;
        "pkg-1.0.9-1.21.11" = _4zwyWZU6;
        "pkg-1.0.9-1.20.1-forge" = _GuX7tgFR;
        "pkg-1.0.10-1.21.4-fabric" = _VQB7J8UE;
        "pkg-1.0.10-1.21.11-fabric" = _RI7E1J5N;
        "pkg-1.0.10-1.21.1-fabric" = _k5BUkG4V;
        "pkg-1.0.10-1.19.2-fabric" = _W5axXXix;
        "pkg-1.0.10-1.21.11-neoforge" = _iZzeomQq;
        "pkg-1.0.10-1.20.1-fabric" = _LrYOFmXt;
        "pkg-1.0.10-1.21.1-neoforge" = _brzu3zm6;
        "pkg-1.0.10-1.21.4-neoforge" = _9yUOXcIj;
        "pkg-1.0.10-1.21.11-forge" = _WSkw22Dw;
        "pkg-1.0.10-1.21.4-forge" = _ZA3Xf72e;
        "pkg-1.0.10-1.21.1-forge" = _GeQl8FaE;
        "pkg-1.0.10-1.20.1-forge" = _TWFeoxGx;
        "pkg-1.0.10-1.19.2-forge" = _27vMf7da;
        "default" = _27vMf7da;
    });
