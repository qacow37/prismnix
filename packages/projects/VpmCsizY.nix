...
let
    ...
    in {
        ...
        "pkg-0.5" = _kRHV6B8S;
        "pkg-0.5.1" = _mz6UeowF;
        "pkg-0.6-alpha5" = _fcOoOX42;
        "pkg-0.6-alpha6" = _60tQ3k4t;
        "pkg-0.6-alpha7" = _yVkiF2xq;
        "pkg-0.6" = _4Wl5oa0G;
        "pkg-0.6.1" = _tN0RT68k;
        "pkg-0.6.2" = _I5LgyoLT;
        "pkg-0.6.3" = _A2ICqUUQ;
        "pkg-0.6.4" = _Iq490oxr;
        "pkg-0.6.5" = _zY6y7Qvz;
        "pkg-0.7-alpha1" = _6w1tiIs9;
        "pkg-0.7-alpha2" = _ufJABWni;
        "pkg-0.7" = _epxgXmsr;
        "pkg-0.7.1" = _Hq64Nd6I;
        "pkg-0.8" = _4Fr9msyO;
        "pkg-0.8-bugfix" = _uGUb34Dj;
        "pkg-0.8.1" = _iiPMOgCL;
        "pkg-0.8.2" = _cymDgYiI;
        "pkg-0.8.3" = _o8lqWLSn;
        "pkg-0.8.4" = _3aq1OdU4;
        "pkg-0.8.5" = _4HLOxFAw;
        "pkg-1.0-beta.1" = _KojZQsrJ;
        "pkg-1.0-beta.2" = _kw9ycp98;
        "pkg-1.0" = _vS8ELZ5k;
        "pkg-1.0-alpha2" = _AAGY7hJY;
        "pkg-1.0-alpha3" = _vPVDW6zh;
        "pkg-1.0-beta.3" = _T5myE2fj;
        "pkg-1.0-beta.4" = _LM051sKZ;
        "pkg-1.0-beta.5" = _cFfJekwt;
        "pkg-1.0.1" = _rOmoyrIi;
        "pkg-1.0-beta.6" = _pV8InJMj;
        "pkg-1.0-beta.7" = _HOFhMRpv;
        "pkg-1.0.2" = _69qoQYCo;
        "pkg-1.0-beta.8" = _wQgL3YjY;
        "pkg-1.0-beta.9" = _T1QiMrAW;
        "pkg-1.1" = _i7bEabpP;
        "pkg-1.1.1" = _Dq63oSXb;
        "pkg-1.2" = _i756cxMb;
        "pkg-2.0-beta.1" = _MaSuayBy;
        "pkg-2.0-beta.2" = _zTu5UlIg;
        "pkg-2.0-beta.2-bugfix" = _psXuvdBL;
        "pkg-2.0-beta.3" = _RLlFcgBs;
        "pkg-2.0-beta.4" = _Nty9LreE;
        "pkg-2.0-beta.5" = _MbwiYbx6;
        "pkg-2.0-beta.6" = _zB7fFKNr;
        "pkg-2.0-beta.7" = _SoRz04Bu;
        "pkg-1.2-bugfix" = _o6b2kAdp;
        "pkg-2.0-beta.8" = _B9XosZp4;
        "pkg-1.2.1" = _2QCAEFP6;
        "pkg-2.0-beta.9" = _LBYLwUHp;
        "pkg-2.0-beta.10" = _Y78b5aeC;
        "pkg-1.2.2" = _3s5umdG5;
        "pkg-2.0-beta.11" = _ZuLPcnaz;
        "pkg-2.0-beta.12" = _vLueEXwq;
        "pkg-1.2.3" = _ZLnHIEF7;
        "pkg-2.0-beta.13" = _SgO9RBV9;
        "pkg-1.2.4" = _HuyfavU1;
        "pkg-1.2.5" = _Rq1ofgUQ;
        "pkg-2.0-beta.14" = _yLDKjAIj;
        "pkg-2.0-beta.15" = _I4Sg9ofE;
        "pkg-2.0-beta.17" = _kdvvFM7V;
        "pkg-1.2.6" = _3zeAzYQ0;
        "pkg-1.2.7" = _er2PNtdp;
        "pkg-2.0" = _soR168tk;
        "pkg-2.1-beta.1" = _o6K8vx54;
        "default" = _o6K8vx54;
    });
