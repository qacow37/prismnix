...
let
    ...
    in {
        ...
        "pkg-3.1" = _nKwD1wd7;
        "pkg-3.2" = _dH5N4o0F;
        "pkg-1.21.1-4.0.0" = _bJVsYABi;
        "pkg-1.21.5-4.0.0" = _PL59ce4y;
        "pkg-1.21.5-4.0.1" = _iI26C28N;
        "pkg-1.21.5-4.0.2" = _ASFCQqNd;
        "pkg-1.21.1-4.0.1" = _UucrgpRc;
        "pkg-1.21.5-4.0.3" = _hoGBGLWm;
        "pkg-1.21.1-4.0.2" = _8M9nRvGW;
        "pkg-1.21.1-4.0.3" = _ZmBFRR96;
        "pkg-1.21.1-4.0.4" = _sgDaqbL0;
        "pkg-1.21.1-4.1.0" = _wsk4wO8o;
        "pkg-1.21.5-4.0.4" = _5L5vLKR1;
        "pkg-1.21.11-4.0.5" = _c2QLbdcI;
        "pkg-1.21.1-4.2.0" = _JwAgXOvz;
        "default" = _JwAgXOvz;
    });
