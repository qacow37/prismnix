...
let
    ...
    in {
        ...
        "pkg-8.3.0" = _q1R9qZ7M;
        "pkg-9.0.1" = _AFIuYFLS;
        "pkg-10.0.0" = _daQFqhuU;
        "pkg-11.0.0" = _yTPpRL24;
        "pkg-11.1.2" = _5tdSDr2f;
        "pkg-11.2.3" = _mFxn02Ky;
        "pkg-11.3.0" = _UGDzHOaT;
        "pkg-11.4.0" = _bzWTCjPG;
        "pkg-11.5.0" = _PHGCFWYb;
        "pkg-12.0.2" = _8TmLf52i;
        "default" = _8TmLf52i;
    });
