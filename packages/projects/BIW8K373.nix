...
let
    ...
    in {
        ...
        "pkg-1.21.4-1.0.0-fabric" = _30NV5fM8;
        "pkg-1.21.4-1.0.0-forge" = _c5tO0M5R;
        "pkg-1.21.4-1.0.0-neoforge" = _hGCDKEbl;
        "pkg-1.21.5-1.0.0-fabric" = _8fq2UuSW;
        "pkg-1.21.5-1.0.0-forge" = _4ps4Evul;
        "pkg-1.21.5-1.0.0-neoforge" = _Ci6NdbWF;
        "pkg-1.21.1-1.0.0-fabric" = _pS4L0Ayu;
        "pkg-1.21.1-1.0.0-forge" = _Tsj9H21v;
        "pkg-1.21.1-1.0.0-neoforge" = _YBr1EnKj;
        "pkg-1.20.1-1.0.0-fabric" = _UDerZMW2;
        "pkg-1.20.1-1.0.0-forge" = _t6wSyysz;
        "pkg-1.20.1-1.1.0-fabric" = _zFcpDIVl;
        "pkg-1.20.1-1.1.0-forge" = _gI5zSfH4;
        "pkg-1.21.1-1.1.0-fabric" = _EwVMLhjM;
        "pkg-1.21.1-1.1.0-forge" = _mcy6Ycv9;
        "pkg-1.21.1-1.1.0-neoforge" = _JkNTODzP;
        "pkg-1.21.4-1.1.0-fabric" = _OndfLKzL;
        "pkg-1.21.4-1.1.0-forge" = _vNjiS7wZ;
        "pkg-1.21.4-1.1.0-neoforge" = _jfJDjVEX;
        "pkg-1.21.5-1.1.0-fabric" = _Z88E4cI2;
        "pkg-1.21.5-1.1.0-forge" = _H5TetRSw;
        "pkg-1.21.5-1.1.0-neoforge" = _v7STsbYB;
        "pkg-1.21.6-1.1.0-fabric" = _Sn4H72M3;
        "pkg-1.21.6-1.1.0-forge" = _Qy9q437I;
        "pkg-1.21.6-1.1.0-neoforge" = _1YGLMNn3;
        "pkg-1.21.7-1.1.0-fabric" = _PuFMdZWf;
        "pkg-1.21.7-1.1.0-forge" = _gpqGo2fO;
        "pkg-1.21.7-1.1.0-neoforge" = _4geWouwP;
        "pkg-1.20.1-1.1.0p2-forge" = _aeIzhh8f;
        "pkg-1.21.10-1.1.0-fabric" = _cIbM9Kji;
        "pkg-1.21.10-1.1.0-forge" = _O2xbjAkH;
        "pkg-1.21.10-1.1.0-neoforge" = _sqDvOweR;
        "pkg-1.21.10-1.1.0p1-forge" = _T6JXUle2;
        "pkg-1.21.11-1.1.0p1-fabric" = _vgKh51jg;
        "pkg-1.21.11-1.1.0p1-forge" = _MvaCJ0Rc;
        "pkg-1.21.11-1.1.0p1-neoforge" = _Piq8rXqz;
        "pkg-1.20.1-1.2.0-fabric" = _FhTJU7Xj;
        "pkg-1.20.1-1.2.0-forge" = _qutKcz23;
        "pkg-1.21.11-1.2.0-fabric" = _wamYcNyt;
        "pkg-1.21.11-1.2.0-forge" = _fauZIN0M;
        "pkg-1.21.11-1.2.0-neoforge" = _s6IiJfsP;
        "pkg-1.21.1-1.2.0-fabric" = _tgJl4DyA;
        "pkg-1.21.1-1.2.0-forge" = _CtKP32kb;
        "pkg-1.21.1-1.2.0-neoforge" = _kOjmxYoo;
        "default" = _kOjmxYoo;
    });
