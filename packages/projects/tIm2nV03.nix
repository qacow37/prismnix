...
let
    ...
    in {
        ...
        "pkg-5.1.0-148" = _4e5ym3hC;
        "pkg-8.0.1-147" = _UMcCfBIP;
        "pkg-8.0.2-149" = _HXdkBiEI;
        "pkg-1.18.2-8.1.0-150" = _nRta3Aea;
        "pkg-1.18.2-8.2.0-151" = _AdqQLENe;
        "pkg-1.18.2-8.2.1-152" = _O9qGVo0Z;
        "pkg-1.19.2-9.0.0-153" = _fVjq6Z3V;
        "pkg-1.18.2-8.2.2-154" = _HJrtm24e;
        "pkg-1.18.2-8.3.0-155" = _d82TaNEn;
        "pkg-1.19.2-9.1.0-156" = _8cSY80xI;
        "pkg-1.18.2-8.3.1-157" = _uekfFt7Z;
        "pkg-1.19.2-9.1.1-158" = _DBzRhQMO;
        "pkg-1.19.2-9.1.2-159" = _2lg4ADhS;
        "pkg-1.19.3-9.2.0-160" = _3Ublqy96;
        "pkg-1.18.2-8.4.0-161" = _g7u3ovfs;
        "pkg-1.19.2-9.2.0-162" = _fB3ySsyT;
        "pkg-1.19.3-9.3.0-163" = _OEzUN0pz;
        "pkg-1.19.2-9.2.1-164" = _jKiL95JQ;
        "pkg-1.19.2-9.2.2-165" = _7NaNJWwh;
        "pkg-1.19.4-9.4.0-166" = _ser2bkL3;
        "pkg-1.19.2-9.2.3-167" = _7Mm7llLR;
        "pkg-1.19.4-9.4.1-168" = _bHtBdyn4;
        "pkg-1.20.1-10.0.0-169" = _uqGFpLXw;
        "pkg-1.19.2-9.2.4-170" = _VzTXQKEm;
        "pkg-1.20.1-10.1.0-171" = _MAqXk6P8;
        "pkg-11.1.0-172" = _11mMmtHT;
        "pkg-11.2.0-173" = _M7MlRnaN;
        "pkg-11.3.0-174" = _X772GplD;
        "pkg-11.4.0-175" = _w3BEYHmQ;
        "pkg-11.4.1-176" = _vdgCyQsf;
        "pkg-11.4.2-177" = _tn0vdyar;
        "pkg-11.4.3-178" = _CyVP7zyQ;
        "pkg-0.12-98" = _qklpKVVz;
        "pkg-11.5.0-179" = _SbwjBOP1;
        "pkg-11.6.0-180" = _YVAzfEtc;
        "pkg-11.6.1-181" = _IL0vvpaZ;
        "pkg-12.0.0-182" = _UoruPMQV;
        "pkg-10.2.0-183" = _WUzj4tgJ;
        "pkg-11.7.0-184" = _lww1U3n6;
        "pkg-12.1.0-185" = _En8VM1jV;
        "pkg-12.1.1-186" = _f2NqYnnB;
        "pkg-12.2.0-187" = _7uBp7xUp;
        "pkg-12.3.0-188" = _AqijsV5Y;
        "pkg-12.3.1-189" = _j51zY43a;
        "pkg-12.3.2-190" = _hd09r1gE;
        "pkg-12.3.3-191" = _J9M5YW0v;
        "pkg-12.4.0-192" = _xDZWulIs;
        "pkg-12.4.1-193" = _6G3o1s7e;
        "pkg-12.4.2-194" = _uNRARSH2;
        "default" = _uNRARSH2;
    });
