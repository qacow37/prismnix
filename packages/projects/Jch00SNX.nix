...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.7-fabric" = _I8mpMZZ5;
        "pkg-1.18.2-1.7-fabric" = _3ZAvortp;
        "pkg-1.19.2-1.9-fabric" = _7TDedSJL;
        "pkg-1.16.5-1.4-forge" = _8l6S3I3G;
        "pkg-1.18.2-1.4-forge" = _ueyQzvo8;
        "pkg-1.19.2-1.6-forge" = _ahySoUlj;
        "pkg-1.16.5-2.0-fabric" = _jcWBOcRy;
        "pkg-1.18.2-2.0-fabric" = _ZOhtgF2U;
        "pkg-1.19.2-2.0-fabric" = _62IbNfcX;
        "pkg-1.19.3-2.1-fabric" = _DuWSk10N;
        "pkg-1.19.3-1.6-forge" = _tGFHlbwQ;
        "pkg-1.18.2-3.0-forge+fabric" = _xYVFJrru;
        "pkg-1.19.2-3.0-forge+fabric" = _czZYCPdD;
        "pkg-1.19.3-3.0-forge+fabric" = _uqN7bXJT;
        "pkg-1.18.2-3.1-forge+fabric" = _9lAhv3o0;
        "pkg-1.19.2-3.1-forge+fabric" = _Cbw744Lg;
        "pkg-1.19.3-3.1-forge+fabric" = _219pDHra;
        "pkg-1.19.4-3.1-forge+fabric" = _74hGqp61;
        "pkg-1.20-3.1-forge+fabric" = _yP9enDFG;
        "pkg-1.20.1-3.1-forge+fabric" = _PTizR9Kn;
        "pkg-1.20.2-3.1-forge+fabric" = _WlfqJnyZ;
        "pkg-1.18.2-3.2-forge+fabric" = _naIWWATL;
        "pkg-1.19.2-3.2-forge+fabric" = _VVcaYD0j;
        "pkg-1.20.1-3.2-forge+fabric" = _Bcv7zfJf;
        "pkg-1.20.2-3.2-forge+fabric" = _38ICgZ6I;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _hCX9QBYw;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _jc0FrU2q;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _xXoFyZ3c;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _asMgSk1J;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _Orz6gZ5j;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _FQ6twB1n;
        "pkg-1.20.5-3.3-fabric+neo" = _t2uejlGy;
        "pkg-1.20.5-3.4-fabric+neo" = _bFgfTu39;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _sYchH51z;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _dotzwAwI;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _8GPxW8Ti;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _cVyiVUMR;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _MlvELvMG;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _KGxd82Ct;
        "pkg-1.21.2-3.5-fabric+neo" = _TtxJSM83;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _olISQ4op;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _YdR87gkm;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _QVWiu6IZ;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _NlK5MLM5;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _sBYdLeUO;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _rlOTMu9Y;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _NQ5wMDfV;
        "pkg-1.21.6-3.7-fabric+forge+neo" = _L8SdI57P;
        "pkg-1.21.7-3.7-fabric+forge+neo" = _ivy0Y1wp;
        "pkg-1.21.8-3.7-fabric+forge+neo" = _W5fSDGFA;
        "pkg-1.21.9-3.7-fabric+forge+neo" = _roqt1YYS;
        "pkg-1.21.10-3.7-fabric+forge+neo" = _rCVu0x0u;
        "pkg-1.21.11-3.7-fabric+forge+neo" = _QLenhyYT;
        "pkg-26.1.0-3.7-fabric+forge+neo" = _uxCEZGga;
        "pkg-26.1.1-3.7-fabric+forge+neo" = _nIA8qHXZ;
        "pkg-26.1.2-3.7-fabric+forge+neo" = _5Qzt2ZN1;
        "pkg-26.2.0-3.7-fabric+forge+neo" = _GcSodIZk;
        "default" = _GcSodIZk;
    });
