...
let
    ...
    in {
        ...
        "pkg-1.2.1" = _973K2WS6;
        "pkg-1.2.2" = _cJEW6ewZ;
        "pkg-1.2.2+26.1-neoforge" = _DMYvWrjT;
        "pkg-1.2.2+26.1-fabric" = _yTnWzw7Z;
        "pkg-1.2.2+1.21.6-neoforge" = _boMSscBw;
        "pkg-1.2.2+1.21.9-neoforge" = _wtLKFOuV;
        "pkg-1.2.2+1.21.6-fabric" = _JqzvguD9;
        "pkg-1.2.2+1.21.9-fabric" = _4UkXE6IS;
        "pkg-1.2.3+26.1-neoforge" = _3dJe713H;
        "pkg-1.2.3+1.21.6-fabric" = _uMU4Z2vR;
        "pkg-1.2.3+1.21.9-fabric" = _FcdqSGdT;
        "pkg-1.2.3+1.21.11-fabric" = _oG5XvPLM;
        "pkg-1.2.3+26.1-fabric" = _gDn79OPS;
        "pkg-1.2.4+1.21.6-neoforge" = _HnOZGTqt;
        "pkg-1.2.4+1.21.6-fabric" = _6eJlRJUw;
        "pkg-1.2.4+1.21.9-neoforge" = _w9M9MwwV;
        "pkg-1.2.4+1.21.9-fabric" = _OhbQ8TeV;
        "pkg-1.2.4+1.21.11-neoforge" = _JooAMt1b;
        "pkg-1.2.4+1.21.11-fabric" = _ELsQBKdq;
        "pkg-1.2.4+26.1-neoforge" = _XOpG3oOV;
        "pkg-1.2.4+26.1-fabric" = _33b6nb7d;
        "pkg-1.2.5+1.21.6-neoforge" = _UZNeMx2M;
        "pkg-1.2.5+1.21.6-fabric" = _ukdt3Dr8;
        "pkg-1.2.5+1.21.9-neoforge" = _HgPDjCkL;
        "pkg-1.2.5+1.21.9-fabric" = _1PCilQ11;
        "pkg-1.2.5+1.21.11-neoforge" = _e1uWbNPc;
        "pkg-1.2.5+1.21.11-fabric" = _zv52QLOH;
        "pkg-1.2.5+26.1-neoforge" = _Bc5BGBbr;
        "pkg-1.2.5+26.1-fabric" = _GPTx63nz;
        "pkg-1.2.6+1.21.6-neoforge" = _LfM5ERdh;
        "pkg-1.2.6+1.21.6-fabric" = _bVNR7jgg;
        "pkg-1.2.6+1.21.9-neoforge" = _EoVN6nkG;
        "pkg-1.2.6+1.21.9-fabric" = _TZJX550R;
        "pkg-1.2.6+1.21.11-neoforge" = _xSmmnJFr;
        "pkg-1.2.6+1.21.11-fabric" = _77xz4T5P;
        "pkg-1.2.6+26.1-neoforge" = _IYbPcNR3;
        "pkg-1.2.6+26.1-fabric" = _xWyt29CN;
        "pkg-1.2.6-fix+1.21.6-neoforge" = _KQVXguzU;
        "pkg-1.2.6-fix+1.21.9-neoforge" = _YhfJd5nM;
        "pkg-1.2.6-fix+1.21.11-neoforge" = _hFIl4VNl;
        "pkg-1.2.6-fix+26.1-neoforge" = _2KurHQkC;
        "pkg-1.2.7+1.21.6-neoforge" = _Vqc0J3JT;
        "pkg-1.2.7+1.21.6-fabric" = _obS7d6mW;
        "pkg-1.2.7+1.21.9-neoforge" = _A2gloNaj;
        "pkg-1.2.7+1.21.9-fabric" = _powLMpLf;
        "pkg-1.2.7+1.21.11-neoforge" = _y8uaQaMV;
        "pkg-1.2.7+1.21.11-fabric" = _VfCVYpuR;
        "pkg-1.2.7+26.1-fabric" = _Iwzi6hty;
        "pkg-1.2.8+1.21.6-neoforge" = _YvWSvOQA;
        "pkg-1.2.8+26.1-fabric" = _qZR6SRbQ;
        "pkg-1.2.8+1.21.6-fabric" = _i40FoWdD;
        "pkg-1.2.8+1.21.9-neoforge" = _SWnBZz5J;
        "pkg-1.2.8+1.21.9-fabric" = _rSRxXNKh;
        "pkg-1.2.8+1.21.11-neoforge" = _lVGnhNEJ;
        "pkg-1.2.8+1.21.11-fabric" = _KfBKPI6f;
        "pkg-1.2.8+26.1-neoforge" = _qYEEIJ2y;
        "pkg-1.2.9+1.21.6-neoforge" = _ah0d4WmX;
        "pkg-1.2.9+1.21.9-fabric" = _BjQy1bGX;
        "pkg-1.2.9+1.21.6-fabric" = _Bea0qocX;
        "pkg-1.2.9+1.21.9-neoforge" = _8dWN5z0V;
        "pkg-1.2.9+1.21.11-neoforge" = _qnhyVRlx;
        "pkg-1.2.9+1.21.11-fabric" = _q993xExg;
        "pkg-1.2.9+26.1-neoforge" = _ZklHagpA;
        "pkg-1.2.9+26.1-fabric" = _qRbQlEek;
        "default" = _qRbQlEek;
    });
