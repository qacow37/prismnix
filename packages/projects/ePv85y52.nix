...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19-Fabric" = _Od1aoZdH;
        "pkg-v4.0.2-1.19-Fabric" = _sSI5l4To;
        "pkg-v4.0.2-1.19-Forge" = _9ItBEnm2;
        "pkg-v4.0.3-1.19-Fabric" = _7JJF6bmG;
        "pkg-v4.0.3-1.19-Forge" = _MIZEVu00;
        "pkg-v4.1.0-1.19.1-Fabric" = _p4pYorgr;
        "pkg-v4.1.0-1.19.1-Forge" = _VhTU4VYv;
        "pkg-v4.1.1-1.19.1-Fabric" = _9r76uxKl;
        "pkg-v4.1.1-1.19.1-Forge" = _XCZQxY6f;
        "pkg-v4.2.0-1.19.2-Forge" = _JMr7hPQW;
        "pkg-v4.2.0-1.19.2-Fabric" = _3k6EJgYU;
        "pkg-v4.2.1-1.19.2-Fabric" = _iHkEvBqw;
        "pkg-v4.2.1-1.19.2-Forge" = _tc0YGian;
        "pkg-v4.2.2-1.19.2-Fabric" = _UaIVbML9;
        "pkg-v4.2.2-1.19.2-Forge" = _9UD54Pev;
        "pkg-v5.0.0-1.19.3-Fabric" = _CCLx4Mu5;
        "pkg-v5.0.0-1.19.3-Forge" = _4dG2YrCp;
        "pkg-v6.0.0-1.19.4-Fabric" = _wB5MzXXE;
        "pkg-v6.0.0-1.19.4-Forge" = _vwxMrkmk;
        "pkg-v7.0.0-1.20-Forge" = _n3XAYY0o;
        "pkg-v7.0.0-1.20-Fabric" = _N7WAndEY;
        "pkg-v8.0.0-1.20.1-Forge" = _kk0YThxK;
        "pkg-v8.0.0-1.20.1-Fabric" = _c1vmVmGb;
        "pkg-v8.0.1-1.20.1-Forge" = _LyQxVmrT;
        "pkg-v8.0.1-1.20.1-Fabric" = _2NxkjBtw;
        "pkg-v8.0.2-1.20.1-Forge" = _1NgJmHTq;
        "pkg-v8.0.2-1.20.1-Fabric" = _D1uroW8m;
        "pkg-v20.4.0-1.20.4-Fabric" = _SISwkeEH;
        "pkg-v20.4.0-1.20.4-Forge" = _yOMsRdTo;
        "pkg-v20.4.0-1.20.4-NeoForge" = _QYvpMUlO;
        "pkg-v20.4.1-1.20.4-Fabric" = _BWdnXRwi;
        "pkg-v20.4.1-1.20.4-Forge" = _nHfa0uAQ;
        "pkg-v20.4.1-1.20.4-NeoForge" = _7MCzbbq4;
        "pkg-v8.0.3-1.20.1-Fabric" = _8ZYi5jjW;
        "pkg-v8.0.3-1.20.1-Forge" = _UIJtaBTP;
        "pkg-v21.1.0-1.21.1-Fabric" = _77TOfopW;
        "pkg-v21.1.0-1.21.1-NeoForge" = _67Sh09hh;
        "pkg-v21.3.0-1.21.3-Fabric" = _wa41One0;
        "pkg-v21.3.0-1.21.3-NeoForge" = _9J01xmwS;
        "pkg-v21.4.0-1.21.4-Fabric" = _OSFpDKSd;
        "pkg-v21.4.0-1.21.4-NeoForge" = _rWKxOq4C;
        "pkg-v21.5.0-1.21.5-Fabric" = _10gld3Cv;
        "pkg-v21.5.0-1.21.5-NeoForge" = _5rTqpFQa;
        "pkg-v21.6.0-1.21.6-Fabric" = _dkAUPWIJ;
        "pkg-v21.6.0-1.21.6-NeoForge" = _uQPFky3n;
        "pkg-v21.7.0-1.21.7-Fabric" = _gp49PYO7;
        "pkg-v21.7.0-1.21.7-NeoForge" = _Gj2vjWPN;
        "pkg-v21.8.0-1.21.8-Fabric" = _EJlDeEQs;
        "pkg-v21.8.0-1.21.8-NeoForge" = _Thx1RN8N;
        "pkg-v21.8.1-1.21.8-Fabric" = _FgX9Bpwu;
        "pkg-v21.8.1-1.21.8-NeoForge" = _aLg0cbHB;
        "pkg-v21.1.1-1.21.1-Fabric" = _ltB1N9OI;
        "pkg-v21.1.1-1.21.1-NeoForge" = _9rPpDiqt;
        "pkg-v21.8.2-1.21.8-Fabric" = _P9TJcSoA;
        "pkg-v21.8.2-1.21.8-NeoForge" = _yoglZrml;
        "pkg-v21.1.2-1.21.1-Fabric" = _8Myn7TRZ;
        "pkg-v21.1.2-1.21.1-NeoForge" = _beXGbkoY;
        "pkg-21.9.0" = _8YXRWfRu;
        "pkg-21.10.0" = _odHsOwEQ;
        "pkg-21.11.0" = _aqrb0the;
        "pkg-v21.1.3-1.21.1-Fabric" = _v0SRTqsp;
        "pkg-v21.1.3-1.21.1-NeoForge" = _yDca44W2;
        "pkg-21.11.1" = _5HLVp4Ew;
        "pkg-21.11.2" = _cGhMuhYq;
        "pkg-v21.1.4-1.21.1-Fabric" = _lBRm6Aii;
        "pkg-v21.1.4-1.21.1-NeoForge" = _AoOYPAOZ;
