...
let
    ...
    in {
        ...
        "pkg-1.0" = _ppllYI1S;
        "pkg-1.0_mod" = _AiNnFVgW;
        "pkg-1.1" = _YdOdaojd;
        "pkg-1.2" = _X2uJ8B5z;
        "pkg-1.2+mod" = _NmX6aXid;
        "pkg-1.3" = _S0okeP5q;
        "pkg-1.3+mod" = _FJG4Taen;
        "pkg-2.0" = _m9tC82S3;
        "pkg-2.0+mod" = _WMe2XCbl;
        "pkg-3.0" = _vM7V4F2c;
        "pkg-3.0+mod" = _8StpWRgb;
        "pkg-3.1" = _jDgwY8Iv;
        "pkg-3.1+mod" = _6Uh0bdMS;
        "pkg-3.2" = _qHr3MzEZ;
        "pkg-4.0" = _5JYzSi3a;
        "pkg-4.0+mod" = _5zWmNu0J;
        "pkg-4.1" = _prmengAG;
        "pkg-4.1+mod" = _CEJD8KGl;
        "pkg-4.2" = _rFepTtK5;
        "pkg-4.2+mod" = _tuSI0bAN;
        "pkg-4.3" = _9JQtGWDn;
        "pkg-4.3+mod" = _gpDPh5Nv;
        "pkg-4.4" = _Y9nSTOnu;
        "pkg-4.4+mod" = _EypK2XFp;
        "pkg-4.5" = _acCTfMCS;
        "pkg-4.5+mod" = _nuk5WK7N;
        "pkg-4.6" = _956J0zaQ;
        "pkg-4.6+mod" = _P7WRMVz3;
        "pkg-4.7" = _nw19SN6s;
        "pkg-4.7-fabric" = _9Xaa4rmC;
        "pkg-4.7-forge" = _LKhFSWfm;
        "pkg-4.11" = _pRxeu4lP;
        "pkg-4.11-fabric" = _WpFToIDF;
        "pkg-4.11-quilt" = _6ERkjDtc;
        "pkg-4.11-forge" = _fhJ6ueV2;
        "pkg-4.11-neoforge" = _2ZfTx496;
        "pkg-4.12" = _Ep7X04QT;
        "pkg-4.12-fabric" = _whZQPM3x;
        "pkg-4.12-quilt" = _kSDqrvvs;
        "pkg-4.12-forge" = _1eb3v4pM;
        "pkg-4.12-neoforge" = _3a9J9L8p;
        "pkg-4.13" = _oqHucUkZ;
        "pkg-4.13-fabric" = _ZxhhdfFG;
        "pkg-4.13-quilt" = _sN5Owhpd;
        "pkg-4.13-forge" = _o9OUBTkp;
        "pkg-4.13-neoforge" = _FY7kydVs;
        "pkg-4.14" = _Z2dWUZn3;
        "pkg-4.14-fabric" = _1PRRz7tF;
        "pkg-4.14-quilt" = _l3JtC4GP;
        "pkg-4.14-forge" = _p8SvsNu6;
        "pkg-4.14-neoforge" = _qQZv1wu8;
        "default" = _qQZv1wu8;
    });
