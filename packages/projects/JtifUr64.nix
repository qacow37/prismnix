...
let
    ...
    in {
        ...
        "pkg-1.19.2-Forge-3.1.2" = _nIfqKsvT;
        "pkg-1.19.2-Fabric-3.1.0" = _yLYslqqw;
        "pkg-1.19.3-Forge-3.2.0" = _8j6rQRir;
        "pkg-1.19.3-Fabric-3.2.0" = _U7s0a0fP;
        "pkg-1.19.4-Fabric-3.3.0" = _olf32JwT;
        "pkg-1.19.4-Forge-3.3.0" = _yOjVCeqk;
        "pkg-1.20-Forge-4.0.1" = _ZA3ahpCR;
        "pkg-1.20-Fabric-4.0.1" = _xcHI86YI;
        "pkg-1.20-Forge-4.0.2" = _oUSK4sOQ;
        "pkg-1.20-Fabric-4.0.2" = _MbifZGB0;
        "pkg-1.20.4-Forge-4.4.0" = _TTAtymNe;
        "pkg-1.20.4-Fabric-4.4.0" = _zbwk2CBy;
        "pkg-1.20.4-Forge-4.4.1" = _vsCE3dyt;
        "pkg-1.20.4-Fabric-4.4.1" = _yMVTlUDY;
        "pkg-1.20.4-NeoForge-4.4.1" = _Hyc60sDr;
        "pkg-1.21.1-Fabric-5.1.0" = _qslgngRE;
        "pkg-1.21.1-Forge-5.1.0" = _Lg8WJPHv;
        "pkg-1.21.1-NeoForge-5.1.0" = _1GrJmc2G;
        "pkg-1.21.1-Forge-5.1.1" = _t0B1JBpA;
        "pkg-1.21.1-NeoForge-5.1.1" = _29MQbkrU;
        "pkg-1.21.1-Fabric-5.1.1" = _CyPFY6w5;
        "pkg-1.21.1-Forge-5.1.2" = _qYZF6BN7;
        "pkg-1.21.1-NeoForge-5.1.2" = _OLbxQrMO;
        "pkg-1.21.1-Fabric-5.1.2" = _mhVgP7cl;
        "pkg-1.21.1-Forge-5.1.3" = _gVFjyHcx;
        "pkg-1.21.1-NeoForge-5.1.3" = _2y01mBUy;
        "pkg-1.21.1-Fabric-5.1.3" = _S27dNesu;
        "pkg-1.21.4-NeoForge-5.4.0" = _GLlOjgBX;
        "pkg-1.21.4-Fabric-5.4.0" = _VJXT53KG;
        "pkg-26.1.2-Fabric-6.1.0" = _lRpJBRMb;
        "pkg-26.1.2-NeoForge-6.1.0" = _B2suTpMt;
        "default" = _B2suTpMt;
    });
