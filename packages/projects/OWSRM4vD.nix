...
let
    ...
    in {
        ...
        "pkg-9.1.0" = _lxYBn2s2;
        "pkg-9.1.1" = _5HWMioLU;
        "pkg-10.0.0" = _l63KvIts;
        "pkg-9.1.2" = _9jKJM7su;
        "pkg-10.0.2" = _nHqWaBq9;
        "pkg-9.2.0.36" = _ClAAatrz;
        "pkg-10.2.0.38" = _tvth3cqM;
        "pkg-9.2.1" = _7zcEQXx8;
        "pkg-10.2.1" = _URZFNWr9;
        "pkg-9.2.2" = _C13KSHjB;
        "pkg-10.3.0" = _LLFWn75q;
        "pkg-9.2.3" = _FLmfCu2S;
        "pkg-10.3.1" = _ssRHxD6e;
        "pkg-11.0.0" = _C1iOYlLu;
        "pkg-11.0.2" = _kglS53Hd;
        "default" = _kglS53Hd;
    });
