...
let
    ...
    in {
        ...
        "pkg-2.0" = _fymqsOlJ;
        "pkg-2.0+mod" = _FgvbnlyS;
        "pkg-2.0.1" = _lWSqElve;
        "pkg-2.0.1+mod" = _oJXMpDw7;
        "pkg-2.0.2" = _CQPK6U5Q;
        "pkg-2.0.2+mod" = _wag2NFtH;
        "pkg-2.1" = _hIMzPUjX;
        "pkg-2.1+mod" = _UXxQIob9;
        "pkg-2.1.1" = _HhIPah9m;
        "pkg-2.1.1+mod" = _Xh7FYJ4K;
        "pkg-2.1.2" = _XwAdoooA;
        "pkg-2.1.2+mod" = _M3ogdoKU;
        "pkg-2.2" = _uCpIjjTU;
        "pkg-2.2+mod" = _XB9CNvcC;
        "pkg-2.2.1" = _MQCXevFP;
        "pkg-2.2.1+mod" = _fRIuuraq;
        "pkg-2.2.2" = _mOC57Eg8;
        "pkg-2.2.2+mod" = _AbtkLCI2;
        "pkg-2.2.3" = _QSlMOY7g;
        "pkg-2.2.3+mod" = _T44slzdj;
        "pkg-2.2.4" = _8vCGkm5K;
        "pkg-2.2.4+mod" = _gt6i1ZIL;
        "pkg-2.2.5" = _aqlGUb7r;
        "pkg-2.2.5+mod" = _sNh3eveD;
        "default" = _sNh3eveD;
    });
