...
let
    ...
    in {
        ...
        "pkg-1.2.5" = _SH9226nn;
        "pkg-1.2.6" = _T8RCgBqa;
        "pkg-1.2.6.1" = _TkSfzmhn;
        "pkg-1.2.7" = _nYb6j7NA;
        "pkg-1.2.7.1" = _ueBxLtw6;
        "pkg-1.2.7.2" = _1LcuocEy;
        "pkg-1.2.8" = _duzlL8mh;
        "pkg-1.2.8.1" = _ZL47ZcFI;
        "pkg-1.2.9" = _ixEOIbQ7;
        "pkg-1.2.9.1" = _1PAPTRH4;
        "pkg-1.2.9.2" = _mhp2aSbo;
        "pkg-1.2.9.3" = _2f5c0fSQ;
        "pkg-1.2.9.4" = _oJepDgCz;
        "pkg-1.2.9.5" = _97Ej8Akv;
        "pkg-1.2.9.6" = _QngwxgcK;
        "pkg-1.2.9.7" = _EyjUJYRz;
        "pkg-1.2.9.8" = _u46YPLPy;
        "pkg-1.2.10" = _GKy2z5C4;
        "pkg-1.2.11" = _FYyLTeKY;
        "pkg-1.2.12" = _j69LcFDH;
        "pkg-1.2.13" = _lTidm0eu;
        "pkg-1.2.14" = _ebZZum4Z;
        "default" = _ebZZum4Z;
    });
