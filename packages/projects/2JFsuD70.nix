...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.21.1" = _mHOdtqor;
        "pkg-1.1.0+1.21.3" = _ZuHwHsgU;
        "pkg-1.1.1+1.21.1" = _P6cWrig5;
        "pkg-1.1.1+1.21.4" = _STs10rx3;
        "pkg-1.2.0+1.21.1" = _Hbh952WH;
        "pkg-1.2.0+1.21.4" = _iVPc4hQa;
        "pkg-1.2.1+1.21.1" = _LSHhFuRO;
        "pkg-1.2.1+1.21.4" = _8l6q5YYC;
        "pkg-1.3.0+1.21.7" = _YjLIN806;
        "pkg-1.3.0+1.21.4" = _Yy8Ftff3;
        "pkg-1.3.0+1.21.1" = _thbd0Hbg;
        "pkg-1.3.1+1.21.7" = _yvwd9C1p;
        "pkg-1.3.1+1.21.4" = _AuI6EvAy;
        "pkg-1.3.1+1.21.1" = _gpksvUN8;
        "pkg-1.3.2+1.21.1" = _OvMC7spN;
        "pkg-1.3.2+1.21.7" = _q5a1STc5;
        "pkg-1.3.2+1.21.4" = _RhLsELFq;
        "pkg-1.4.0+1.21.1" = _xgo6IuoL;
        "pkg-1.4.0+1.21.8" = _h86C3U5o;
        "pkg-1.4.0+1.21.10" = _MRmdyXa0;
        "pkg-1.4.1+1.21.1" = _9ISxRxml;
        "pkg-1.4.1+1.21.10" = _aFSSto0T;
        "pkg-1.4.2+1.21.1-neoforge" = _oWBSpaEF;
        "pkg-1.4.2+1.21.1-fabric" = _j18Tk1rD;
        "pkg-1.4.2+1.21.10-neoforge" = _jGRBiurc;
        "pkg-1.4.2+1.21.10-fabric" = _yPUvclF7;
        "pkg-1.4.3+1.21.11-neoforge" = _fIVef13L;
        "pkg-1.4.3+1.21.11-fabric" = _2f85dBsr;
        "pkg-1.5.0+1.21.1-neoforge" = _CwbjwCyS;
        "pkg-1.5.0+1.21.11-neoforge" = _geLkYAkK;
        "pkg-1.5.0+1.21.11-fabric" = _vu2hrZDG;
        "pkg-1.5.0+1.21.1-fabric" = _8s8VCW97;
        "pkg-1.5.1+26.1-fabric" = _8p9J7ZMw;
        "pkg-1.5.1+26.1-neoforge" = _YLwEeNUN;
        "pkg-1.5.2+26.1-neoforge" = _JR0DHbuw;
