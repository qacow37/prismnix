...
let
    ...
    in {
        ...
        "pkg-0.0.1a.ALPHA" = _EK51lYTC;
        "pkg-0.0.2a.ALPHA" = _aZqEtOh6;
        "pkg-0.0.2b.ALPHA" = _QrdWpMEk;
        "pkg-0.0.2c.ALPHA" = _Eq7aZEUs;
        "pkg-0.0.3a.ALPHA" = _nERX7dHG;
        "pkg-0.0.4a.ALPHA" = _UEkOoDbi;
        "pkg-0.0.5a.ALPHA" = _ocohqnVU;
        "pkg-1.19.2-0.1a.PREBETA" = _UOuN7K92;
        "pkg-0.2a.PREBETA" = _lLhDmF1Y;
        "pkg-0.2b.PREBETA" = _qgrM6bNk;
        "pkg-1.20.1-0.2c.PREBETA" = _4zjj5Jhw;
        "pkg-1.18.2-0.2c.PREBETA" = _PJIUgstx;
        "pkg-1.19.2-0.2c.PREBETA" = _9OmEJ9a3;
        "pkg-0.2.5a.PREBETA" = _ZUoK5QvL;
        "pkg-1.19.2-0.2.5b.PREBETA" = _7acX2sGJ;
        "pkg-0.1a" = _zQa6dkM9;
        "pkg-Fabric-0.1b" = _rWSSoT7D;
        "pkg-0.1c-Fabric" = _ecuNWZrN;
        "pkg-0.1d-fabric" = _Knv9sBsR;
        "pkg-Early-Dev.0.1a.BETA" = _nMBlUJT8;
        "pkg-0.1b.BETA.Early-Dev" = _cjYVaqUb;
        "pkg-0.1a.Release-Early-Dev" = _23rf7Qhl;
        "pkg-0.1b.Release-Early-Dev" = _qTHnZQwl;
        "pkg-1.20.1-0.1a.Release-Early-Dev" = _EIfTFqT2;
        "pkg-1.19.2-0.1c.Release-Early-Dev" = _PiqvawlN;
        "pkg-1.20.1-0.1b.Release-Early-Dev" = _GZxkqfDv;
        "pkg-1.2cBetaMidDev" = _n3bakyiQ;
        "pkg-2.0.0" = _zUkXiIr8;
        "pkg-2.1a-BETA" = _OW55xHru;
        "pkg-2.1b-BETA" = _G8OR8q1G;
        "pkg-2.2a-BETA" = _UPMsqE3U;
        "pkg-2.2b-BETA" = _njIQ2raO;
        "pkg-2.2c-BETA" = _IQmSy8nn;
        "pkg-2.2d-BETA" = _P4yXqsnw;
        "pkg-2.3a-BETA" = _bqMxf6Ua;
        "default" = _bqMxf6Ua;
    });
