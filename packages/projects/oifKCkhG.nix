...
let
    ...
    in {
        ...
        "pkg-5.9.35" = _hjTO48Ci;
        "pkg-5.9.36" = _mjseAtu3;
        "pkg-5.9.37" = _LuNb7QxQ;
        "pkg-5.9.38" = _pGTmetTJ;
        "pkg-5.9.39" = _t9kJvJmg;
        "pkg-6.0.0" = _exEtgD5N;
        "pkg-6.0.1" = _lRM7T7pB;
        "pkg-6.0.2" = _7i972SCe;
        "pkg-6.0.3" = _km0aqSgg;
        ...
        "pkg-6.1.8" = _ojkd08TR;
        "pkg-6.1.9" = _xdxZJNM4;
        "pkg-6.1.10" = _eGlPH01A;
        "pkg-6.1.11" = _G9JANywH;
        "pkg-6.1.12" = _bs1TGM1W;
        "pkg-6.1.13" = _omUbPpM3;
        "pkg-6.1.14" = _avAM3QdJ;
        "pkg-6.1.15" = _5qjgZPxM;
        "pkg-6.2.0" = _cOjAabMs;
        "pkg-6.2.1" = _FFVC0b9H;
        "pkg-6.2.2" = _A5fVQY9M;
        "pkg-6.2.3" = _WlakIbU3;
