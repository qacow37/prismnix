...
let
    ...
    in {
        ...
        "pkg-3.4.2" = _cZMDVd07;
        "pkg-3.5.0" = _XdCJYv2W;
        "pkg-fabric-3.6.0" = _ofImv63I;
        "pkg-forge-3.6.0" = _7kU76z6j;
        "pkg-neoforge-4.0.0" = _Z9Gmk9yo;
        "pkg-neoforge-4.1.0" = _UXTMzRte;
        "pkg-forge-3.7.0" = _wLIplBJu;
        "pkg-neoforge-5.0.0" = _eZdrBw5n;
        "pkg-forge-3.8.0" = _BMmcfapL;
        "pkg-neoforge-5.1.0" = _6lTKDode;
        "pkg-forge-3.9.0" = _YL2ZsDea;
        "pkg-neoforge-5.2.0" = _8YZAhtoO;
        "pkg-forge-3.10.0" = _8oKT0Ajq;
        "pkg-neoforge-6.0.0" = _tOJbiWLL;
        "pkg-forge-3.11.0" = _GXwnehiG;
        "pkg-neoforge-6.1.0" = _uS6l0f2i;
        "default" = _uS6l0f2i;
    });
