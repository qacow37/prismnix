...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _SShz2eVo;
        "pkg-1.18.2-2.0-fabric" = _OdPIM8JJ;
        "pkg-1.19.2-2.1-fabric" = _oX7W4FYE;
        "pkg-1.16.5-1.6-forge" = _U1LEaVig;
        "pkg-1.18.2-1.7-forge" = _xLmdGypE;
        "pkg-1.19.2-1.9-forge" = _8KNe2pgH;
        "pkg-1.16.5-2.2-fabric" = _v6idF0rQ;
        "pkg-1.18.2-2.2-fabric" = _SldNz81A;
        "pkg-1.19.2-2.2-fabric" = _Z4M82sPu;
        "pkg-1.19.3-2.3-fabric" = _1qlhE7rZ;
        "pkg-1.19.3-1.9-forge" = _paz4ClCP;
        "pkg-1.18.2-3.0-forge+fabric" = _PQBHnK3p;
        "pkg-1.19.2-3.0-forge+fabric" = _QyAHCpdu;
        "pkg-1.19.3-3.0-forge+fabric" = _aMyhsDKH;
        "pkg-1.18.2-3.1-forge+fabric" = _T16fWb2B;
        "pkg-1.19.3-3.1-forge+fabric" = _JVLLPXHu;
        "pkg-1.18.2-3.2-forge+fabric" = _GbchJ093;
        "pkg-1.19.2-3.2-forge+fabric" = _OUGhNeKO;
        "pkg-1.19.3-3.2-forge+fabric" = _r1M9yRM4;
        "pkg-1.19.4-3.2-forge+fabric" = _AGsfesDc;
        "pkg-1.20-3.2-forge+fabric" = _D0twhf09;
        "pkg-1.20.1-3.2-forge+fabric" = _EYFmo1b7;
        "pkg-1.20.2-3.2-forge+fabric" = _R3IK8YgW;
        "pkg-1.18.2-3.3-forge+fabric" = _LbEMCG83;
        "pkg-1.19.2-3.3-forge+fabric" = _2QM4Z8fz;
        "pkg-1.20.1-3.3-forge+fabric" = _vJhkbqkz;
        "pkg-1.20.2-3.3-forge+fabric" = _tfsqqASz;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _AAcaxQED;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _OEZBfLuC;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _k4pokyHv;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _E6RnOwj0;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _BseMK7yZ;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _nc9A8WCM;
        "pkg-1.20.5-3.4-fabric+neo" = _dZNhcJFA;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _KiQuwyYt;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _4UBSmUMn;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _X5eILg1M;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _1mO85nUt;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _KiPy7N6C;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _L5ES0PjX;
        "pkg-1.21.2-3.5-fabric+neo" = _EIxqE8wt;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _rSzUCmcV;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _NRUe0tNS;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _BuU3a2Fo;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _KoovVmla;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _D3Kf7Vp6;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _jSaJBgGF;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _QLQLDD73;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _WFU0ETeE;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _5rPSGVkI;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _4TPEdCd6;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _7sJzxDCx;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _PpkN3ySA;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _58UUNg4b;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _JNLIPZL1;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _aWZhlIZF;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _lnhszNWB;
        "default" = _lnhszNWB;
    });
