...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.1" = _UMx3GY4x;
        "pkg-1.0.1+1.20.1" = _9l7mYPei;
        "pkg-1.1.0+1.21.1" = _8vN9cjVY;
        "pkg-1.1.1+1.21.1" = _Pn6p0piP;
        "pkg-1.1.2+1.21.1" = _oeOfrNTU;
        "pkg-1.2.0+1.21.1" = _5zcYc5mz;
        "pkg-1.2.1+1.21.1" = _rImhxRkz;
        "pkg-1.3.0+1.21.1" = _9GRNpxvd;
        "pkg-1.3.1+1.21.1" = _cDWRXSNk;
        "pkg-1.4.0+1.21.1" = _YbGanYPY;
        "pkg-1.5.0+1.21.1" = _jUcYJrjM;
        "pkg-1.5.1+1.21.1" = _ZesY6YfT;
        "pkg-2.0.0+1.21.1" = _iSTkL6OR;
        "pkg-2.0.1+1.21.1" = _oEFB2LXx;
        "pkg-2.0.2+1.21.1" = _fqFqqpve;
        "pkg-2.1.0+1.21.1" = _8P7R3kwR;
        "pkg-2.1.1+1.21.1" = _E9f5WLkV;
        "pkg-2.2.0+1.21.1" = _fu638o1f;
        "pkg-2.2.1+1.21.1" = _iUZHEvoJ;
        "pkg-2.2.2+1.21.1" = _nH0m65WQ;
        "pkg-2.2.3+1.21.1" = _QhDroSLh;
        "pkg-2.2.4+1.21.1" = _JPS9wXsu;
        "pkg-2.3.0+1.21.1" = _Ly4wcLLI;
        "pkg-2.3.1+1.21.1" = _tZeFMEbA;
        "pkg-2.3.2+1.21.1" = _HZKWFIbL;
        "pkg-2.3.3+1.21.1" = _hhWxPHnc;
        "pkg-2.4.0-bc25.1+1.21.1" = _BtRutRYW;
        "pkg-2.4.0+1.21.1" = _1bHSkVHB;
        "pkg-2.4.1-bc25.1+1.21.1" = _Rlr5SkHk;
        "pkg-2.4.1+1.21.1" = _7w5Vq1Lk;
        "default" = _7w5Vq1Lk;
    });
