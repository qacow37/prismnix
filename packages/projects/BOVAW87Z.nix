...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.6.3-forge" = _xUSqIEGM;
        "pkg-1.18.2-1.6.3-fabric" = _hw7nIwik;
        "pkg-1.18.2-1.7.3-forge" = _KQewB9k2;
        "pkg-1.18.2-1.7.3-fabric" = _DuL8d1CN;
        "pkg-1.18.2-1.8.0-forge" = _GlGOVpnN;
        "pkg-1.18.2-1.8.0-fabric" = _oDR6bTLL;
        "pkg-1.18.2-1.9.0-forge" = _ObBQzsin;
        "pkg-1.18.2-1.9.0-fabric" = _glcuCsuw;
        "pkg-1.20.1-1.9.0-fabric" = _OhbyJ7lR;
        "pkg-1.20.1-1.9.0-forge" = _3Hc5NJi6;
        "pkg-1.19.4-1.9.0-forge" = _MdSux04c;
        "pkg-1.19.4-1.9.0-fabric" = _fXvh5Tjv;
        "pkg-1.19.3-1.9.0-forge" = _v19vprQa;
        "pkg-1.19.3-1.9.0-fabric" = _8RM1Bzjh;
        "pkg-1.19.2-1.9.0-forge" = _atYmgHjW;
        "pkg-1.19.2-1.9.0-fabric" = _iSzeN8bR;
        "pkg-1.18.2-1.9.1-fabric" = _twlAdfOS;
        "pkg-1.19.2-1.9.1-fabric" = _J6Xu7hZh;
        "pkg-1.19.3-1.9.1-fabric" = _pyInKfpr;
        "pkg-1.19.4-1.9.1-fabric" = _vmoOsmUH;
        "pkg-1.19.4-1.9.1-forge" = _EoYVK7UI;
        "pkg-1.19.3-1.9.1-forge" = _P5ROvK5O;
        "pkg-1.20.1-1.9.1-forge" = _hGTPPcqt;
        "pkg-1.20.1-1.9.1-fabric" = _3bjXrSbu;
        "pkg-1.18.2-1.9.2-forge" = _hDdhjljJ;
        "pkg-1.18.2-1.9.2-fabric" = _DeodnN1W;
        "pkg-1.19.2-1.9.2-forge" = _fHZF0Fr0;
        "pkg-1.19.2-1.9.2-fabric" = _AxWv329A;
        "pkg-1.19.3-1.9.2-forge" = _6bichR42;
        "pkg-1.19.3-1.9.2-fabric" = _PcnvG26J;
        "pkg-1.19.4-1.9.2-forge" = _ZOwo6PNg;
        "pkg-1.19.4-1.9.2-fabric" = _olCt6AvH;
        "pkg-1.20.1-1.9.2-forge" = _dPJQUPu9;
        "pkg-1.20.1-1.9.2-fabric" = _NS2o3zkj;
        "pkg-1.18.2-1.9.3-fabric" = _ZCXDK1QI;
        "pkg-1.19.2-1.9.3-fabric" = _aCbrduZr;
        "pkg-1.19.3-1.9.3-fabric" = _g8qSMwWk;
        "pkg-1.19.4-1.9.3-fabric" = _UTTS1cSV;
        "pkg-1.20.1-1.9.3-fabric" = _M4VvMcZQ;
        "pkg-1.20.6-1.9.3-fabric" = _vB2ROsHC;
        "pkg-1.21.1-1.9.3-alpha-fabric" = _rpY5jlK0;
        "pkg-1.21.1-1.9.3-alpha-neoforge" = _HSrVxI9g;
        "pkg-1.21.1-1.9.4-alpha-neoforge" = _1Cu922wS;
        "pkg-1.21.1-1.9.4-alpha-fabric" = _ajQumuDK;
        "default" = _ajQumuDK;
    });
