...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _1QEeISEj;
        "pkg-1.1.2" = _LK1vAbi5;
        "pkg-1.2.0_1.21-1.21.1" = _sQN7mdW6;
        "pkg-1.2.0_1.21.2-2.21.4" = _EMCuTPqq;
        "pkg-1.2.0_1.21.5" = _t1D1lNXd;
        "pkg-1.2.0_1.21.6-1.21.8" = _8qIXAz3k;
        "pkg-1.2.0_1.21.9-1.21.10" = _Kmg5JKtN;
        "pkg-1.2.0_1.21.11" = _4ezmGGBK;
        "pkg-1.2.1_1.21-1.21.1" = _FTD7JmSK;
        "pkg-1.2.1_1.21.2-2.21.4" = _iCHkHWWg;
        "pkg-1.2.1_1.21.5" = _CzuGUTzH;
        "pkg-1.2.1_1.21.6-1.21.8" = _1pYHqPuW;
        "pkg-1.2.1_1.21.9-1.21.10" = _7v9yYlZo;
        "pkg-1.2.1_1.21.11" = _IZooR4Jk;
        "pkg-1.3.0_1.21-1.21.1" = _QGaC6ejr;
        "pkg-1.3.0_1.21.2-2.21.4" = _q33yIvdh;
        "pkg-1.3.0_1.21.5" = _xqno73wZ;
        "pkg-1.3.0_1.21.6-1.21.8" = _5zaHOxcm;
        "pkg-1.3.0_1.21.9-1.21.10" = _fg1b2CoP;
        "pkg-1.3.0_1.21.11" = _skY8B6XK;
        "pkg-1.4.0_26.1-26.1.2" = _uNLRpFpt;
        "default" = _uNLRpFpt;
    });
