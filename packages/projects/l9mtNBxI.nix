...
let
    ...
    in {
        ...
        "pkg-0.0.0+1.21-indeterminate" = _NOM6zBwQ;
        "pkg-0.0.1+1.21.(9+)" = _ryIzONtM;
        "pkg-0.0.1+1.21.(2-8)" = _OSbY35UT;
        "pkg-0.1.0+1.21.1" = _JUx28698;
        "pkg-0.1.0+1.21.(2-8)" = _u5BPUSrc;
        "pkg-0.1.0+1.21.(9+)" = _bjEbJmMf;
        "pkg-0.1.1+1.21.1" = _cncPWH3J;
        "pkg-0.1.1+1.21.(9+)" = _ggpmnIyJ;
        "pkg-0.1.1+1.21.(2-8)" = _PHlDoO3N;
        "pkg-0.1.2+1.21.1" = _eeRh3KOg;
        "pkg-0.1.2+1.21.(2-8)" = _qr6M4wur;
        "pkg-0.1.2+1.21.(9+)" = _WyeKEZaH;
        "pkg-0.1.3+1.21.1" = _F9uokTd2;
        "pkg-0.1.3+1.21.(9+)" = _CEvf19PD;
        "pkg-0.1.3+1.21.(2-8)" = _kjkWiIq1;
        "pkg-0.2.0+1.20.1" = _NNN8UKnx;
        "pkg-0.2.0+1.21.(2-8)" = _4geaSD8z;
        "pkg-0.2.0+1.21.1" = _zkOyRdIV;
        "pkg-0.2.0+1.21.(9+)" = _5TU6RCIc;
        "pkg-0.2.0+1.20.(2-6)" = _YiLgjW67;
        "pkg-0.2.0+26.1" = _wdcYfktf;
        "pkg-0.2.1+26.1" = _ErZnN31N;
        "pkg-0.2.1+1.21.1" = _ijnfwNqE;
        "pkg-0.2.1+1.21.2" = _ngEEzhVd;
        "pkg-0.2.1+1.21.9" = _gFTAOmso;
        "pkg-0.2.1+1.20.2" = _yNcvBSZx;
        "pkg-0.2.1+1.20.1" = _SPzPQQJc;
        "pkg-0.2.2+1.21.9" = _aOLj8hrn;
        "pkg-0.2.2+1.21.2" = _yLpvFbCW;
        "pkg-0.2.2+1.20.2" = _8B7K425I;
        "pkg-0.2.2+26.1" = _r7y4TjCa;
        "pkg-0.2.2+1.20.1" = _iNfq56qh;
        "pkg-0.2.2+1.21.1" = _kjOQX6ay;
        "default" = _kjOQX6ay;
    });
