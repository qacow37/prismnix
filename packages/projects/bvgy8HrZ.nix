...
let
    ...
    in {
        ...
        "pkg-0.0.1-alpha" = _7vK6jNUv;
        "pkg-0.0.2-alpha+87eff1fd0a" = _JrmUBJUj;
        "pkg-0.0.3-alpha+4d084309dd" = _gXdmjggR;
        "pkg-0.0.4-alpha+59ce051ee2" = _qzITaI8v;
        "pkg-0.0.5-alpha+0ac18826bd" = _86JBYeUp;
        "pkg-0.0.6-alpha+4e2140bff0" = _jXo6Rve5;
        "pkg-0.0.6-alpha+9619fb1b2d" = _OVrWJuGF;
        "pkg-0.0.7-alpha+2e07646d05" = _NFEiJ2wT;
        "pkg-0.0.7-alpha+f68460ebe2" = _IOoBUcPD;
        "pkg-0.0.8" = _vZpoCOqT;
        "pkg-1.18.2-forge-0.0.9" = _R1OhsxL7;
        "pkg-1.18.2-fabric-0.0.9" = _T1vfexED;
        "pkg-1.19.2-fabric-0.0.9" = _C89JAbGG;
        "pkg-1.19.2-forge-0.0.9" = _LMX26hO2;
        "pkg-1.20.1-forge-0.0.9" = _gZTKboxc;
        "pkg-1.20.1-fabric-0.0.9" = _c7b3Rnp5;
        "pkg-0.1.0" = _8Xl4d2Lj;
        "pkg-0.1.1" = _stNnHsTg;
        "pkg-0.1.2" = _zIpXhGpZ;
        "pkg-0.2.2" = _Fqg5A0hv;
