...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _Ht3kZnr8;
        "pkg-1.9.2" = _s6TxwIFf;
        "pkg-1.10.0" = _dSxFkOo9;
        "pkg-1.10.1" = _4qYEOLH8;
        "pkg-1.10.2" = _6tGWeDqW;
        "pkg-1.10.3" = _XQhQ2gtk;
        "pkg-1.10.4" = _8Bw1zEW3;
        "pkg-1.11.0" = _990ueBcd;
        "pkg-1.11.1" = _uCQmGkUF;
        "pkg-1.11.2" = _GMv8G59k;
        "pkg-1.11.3" = _hC2iidDG;
        "pkg-1.12.0" = _3Rkjb43x;
        "default" = _3Rkjb43x;
    });
