...
let
    ...
    in {
        ...
        "pkg-10.0.0+1.14.4" = _OlyrwSyn;
        "pkg-10.0.0+1.15.2" = _2PVmpvXl;
        "pkg-10.0.0+1.16.5" = _ePZKxwHs;
        "pkg-10.0.0+1.17.1" = _7yRlIjv0;
        "pkg-10.1.0+1.14.4" = _wcMiNuzI;
        "pkg-10.1.0+1.15.2" = _I2n4mxXo;
        "pkg-10.1.0+1.16.5" = _uOUrB9Jv;
        "pkg-10.1.0+1.17.1" = _3m1LBwrn;
        "pkg-10.1.1+1.16.5" = _M0oLrZna;
        "pkg-10.1.1+1.17.1" = _MABJnhja;
        "pkg-10.2.0+1.14.4" = _RxlCkHTi;
        "pkg-10.2.0+1.15.2" = _xlYuUmeT;
        "pkg-10.2.0+1.16.5" = _KGNQAlOj;
        "pkg-10.2.0+1.17.1" = _zq7y52Z2;
        "pkg-10.2.1+1.18" = _iB6xQsOw;
        "pkg-10.2.2+1.18.2" = _C5ZlNUKF;
        "pkg-10.2.3+1.15.2+fabric" = _ao4G3RmV;
        "pkg-10.2.3+1.16.5+fabric" = _91ChcnBa;
        "pkg-10.2.3+1.17.1" = _gvTMbWMT;
        "pkg-10.2.3+1.17.1+fabric" = _QQle2P5s;
        "pkg-10.2.3+1.18.2" = _WG7HozE1;
        "pkg-10.2.3+1.18.2+fabric" = _869OVyt5;
        "default" = _869OVyt5;
    });
