...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19.2" = _5I9FaK9J;
        "pkg-1.1.0+1.19.2" = _1V0H1q7y;
        "pkg-1.2.0+1.19.2" = _OgSDxJjD;
        "pkg-1.2.0+1.19.3" = _MEBUwS1F;
        "pkg-1.3.0+1.19.3" = _pjuiaov9;
        "pkg-1.3.0+1.19.2" = _BXoEUiHH;
        "pkg-1.4.0+1.19.2" = _vpA0YbrT;
        "pkg-1.4.0+1.19.3" = _PQaDUIud;
        "pkg-1.4.1+1.19.2" = _uoISMvFm;
        "pkg-1.4.2+1.19.2" = _32HhxodN;
        "pkg-1.4.1+1.19.3" = _tOlHYOTj;
        "pkg-1.5.0+1.20.1" = _KYYu4t1P;
        "pkg-1.6.0+1.20.1" = _sVDXGSds;
        "pkg-1.6.1+1.20.1" = _S9lmnxPO;
        "pkg-1.6.2+1.20.4" = _lElo59ga;
        "pkg-1.6.3+1.20.4" = _rPtXgNhg;
        "pkg-1.7.0+1.20.1" = _A40kPQqv;
        "pkg-1.7.0+1.21.0" = _hMeQSbZe;
        "pkg-1.7.0+1.20.4" = _ZnkvjGzU;
        "pkg-1.7.1+1.21.2" = _7H1si7K9;
        "pkg-1.7.1+1.21.0" = _53oBcbGA;
        "pkg-1.7.1+1.20.4" = _Lh0aVAIs;
        "pkg-1.7.1+1.20.1" = _LtAFKigt;
        "pkg-1.7.2+1.20.4" = _U8tSoCrS;
        "pkg-1.7.2+1.21.0" = _1YuA3EGD;
        "pkg-1.7.2+1.21.2" = _E0cJDbvF;
        "pkg-1.7.2+1.20.1" = _BGVlxplj;
        "default" = _BGVlxplj;
    });
