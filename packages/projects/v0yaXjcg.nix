...
let
    ...
    in {
        ...
        "pkg-1.0-1.21.3" = _xf5MLWO7;
        "pkg-2.0.0-1.20" = _d4edBCaP;
        "pkg-2.0.0-1.20.1" = _X1OGeBo7;
        "pkg-2.0.0-1.20.2" = _kJaXwfGm;
        "pkg-2.0.0-1.20.3" = _WriKSMrc;
        "pkg-2.0.0-1.20.4" = _QhFyFzx7;
        "pkg-2.0.0-1.20.5" = _y6aY1yrs;
        "pkg-2.0.0-1.20.6" = _BCKL2To0;
        "pkg-2.0.0-1.21" = _rDvUXqBP;
        "pkg-2.0.0-1.21.1" = _8o1hov6d;
        "pkg-2.0.0-1.21.2" = _GtghrCTq;
        "pkg-2.0.0-1.21.3" = _f0bjr10a;
        "pkg-2.0.0-1.21.4" = _1yDJnvfK;
        "pkg-2.0.0-1.21.5" = _pJMH12Hj;
        "pkg-2.0.0-1.21.6" = _XbBev3KX;
        "pkg-2.0.0-1.21.7" = _kcFcKxRk;
        "pkg-2.1.1-1.20" = _IpemwroK;
        "pkg-2.1.1-1.20.1" = _PYFaeBnf;
        "pkg-2.1.1-1.20.2" = _jQztxcyG;
        "pkg-2.1.1-1.20.3" = _A8lbocEF;
        "pkg-2.1.1-1.20.4" = _vVnLPVJc;
        "pkg-2.1.1-1.20.5" = _yJxCgiAt;
        "pkg-2.1.1-1.20.6" = _bwnuxjd2;
        "pkg-2.1.1-1.21" = _yLrCn927;
        "pkg-2.1.1-1.21.1" = _v0JpmjY5;
        "pkg-2.1.1-1.21.2" = _zRtSD9Hg;
        "pkg-2.1.1-1.21.3" = _653iWvHH;
        "pkg-2.1.1-1.21.4" = _Xq0UUOzs;
        "pkg-2.1.1-1.21.5" = _ReFcUS5I;
        "pkg-2.1.1-1.21.6" = _klLE5wwN;
        "pkg-2.1.1-1.21.7" = _lEpaLoAY;
        "pkg-2.1.1-1.21.8" = _aO5ujRwg;
        "pkg-3.0.0-1.16.5" = _H939lbAn;
        "pkg-3.0.0-1.17" = _GqTAlMS6;
        "pkg-3.0.0-1.17.1" = _xyhOJQvk;
        "pkg-3.0.0-1.18" = _xfuAweX6;
        "pkg-3.0.0-1.18.1" = _4SYw0NHb;
        "pkg-3.0.0-1.18.2" = _OpDZ1DHo;
        "pkg-3.0.0-1.19" = _QtgaeYZQ;
        "pkg-3.0.0-1.19.1" = _7xr1mbhC;
        "pkg-3.0.0-1.19.2" = _H8D715oI;
        "pkg-3.0.0-1.19.3" = _Rj8UlCPE;
        "pkg-3.0.0-1.19.4" = _MD5W3vC2;
        "pkg-3.0.0-1.20" = _gNCf2lXA;
        "pkg-3.0.0-1.20.1" = _wGb7PqCE;
        "pkg-3.0.0-1.20.2" = _RsnnDQEs;
        "pkg-3.0.0-1.20.3" = _NRRjnFsD;
        "pkg-3.0.0-1.20.4" = _Fi5Y6BzA;
        "pkg-3.0.0-1.20.5" = _kpci7DJn;
        "pkg-3.0.0-1.20.6" = _AwWOLLEs;
        "pkg-3.0.0-1.21" = _9oB42Ww3;
        "pkg-3.0.0-1.21.1" = _hcgeep9r;
        "pkg-3.0.0-1.21.2" = _q3MUHpZE;
        "pkg-3.0.0-1.21.3" = _ar04oO4K;
        "pkg-3.0.0-1.21.4" = _w3YxZtKF;
        "pkg-3.0.0-1.21.5" = _emaPUEYc;
        "pkg-3.0.0-1.21.6" = _ot5QGCjd;
        "pkg-3.0.0-1.21.7" = _xqsbL2jU;
        "pkg-3.0.0-1.21.8" = _EqxS8Omf;
        "pkg-3.1.0-1.16.5-fabric" = _45qx2dRd;
        "pkg-3.1.0-1.17.1-fabric" = _sFHe1boX;
        "pkg-3.1.0-1.17.1-forge" = _EkjH5k8z;
        "pkg-3.1.0-1.18.2-fabric" = _Z8FwcJNy;
        "pkg-3.1.0-1.18.2-forge" = _Ol1Oxja7;
        "pkg-3.1.0-1.19-fabric" = _jL1fPG5A;
        "pkg-3.1.0-1.19-forge" = _sinvGrEA;
        "pkg-3.1.0-1.19.2-fabric" = _ksy41NSq;
        "pkg-3.1.0-1.19.2-forge" = _5HNHoQTt;
        "pkg-3.1.0-1.19.3-fabric" = _Q2jJWwIF;
        "pkg-3.1.0-1.19.3-forge" = _x96xUdG9;
        "pkg-3.1.0-1.19.4-fabric" = _P6hbRLCr;
        "pkg-3.1.0-1.19.4-forge" = _b54rjyhL;
        "pkg-3.1.0-1.20.1-fabric" = _w8NJwFVf;
        "pkg-3.1.0-1.20.1-forge" = _olwfcCtR;
        "pkg-3.1.0-1.20.2-fabric" = _R9h5KDLH;
        "pkg-3.1.0-1.20.4-fabric" = _3OghemvG;
        "pkg-3.1.0-1.20.4-neoforge" = _jcaFapzo;
        "pkg-3.1.0-1.20.6-fabric" = _V52KSPGa;
        "pkg-3.1.0-1.20.6-neoforge" = _NwpM5Jab;
        "pkg-3.1.0-1.21.1-fabric" = _fvB876Fi;
        "pkg-3.1.0-1.21.1-neoforge" = _E6G5xn1v;
        "pkg-3.1.0-1.21.3-fabric" = _9RSxNaxs;
        "pkg-3.1.0-1.21.3-neoforge" = _XCTDAji7;
        "pkg-3.1.0-1.21.4-fabric" = _AHQXrktI;
        "pkg-3.1.0-1.21.4-neoforge" = _fN4lY5Hg;
        "pkg-3.1.0-1.21.5-fabric" = _AdCBjPHv;
        "pkg-3.1.0-1.21.5-neoforge" = _tGyVGhLx;
        "pkg-3.1.0-1.21.8-fabric" = _bTpKMcNg;
        "pkg-3.1.0-1.21.8-neoforge" = _5mVviW0X;
        "pkg-3.1.0-1.21.10-fabric" = _G0kqkuPd;
        "pkg-3.1.0-1.21.10-neoforge" = _Bnlr5hVw;
        "pkg-3.1.0-1.21.11-fabric" = _kdhizLGg;
        "pkg-3.1.0-1.21.11-neoforge" = _WdGyyACC;
        "pkg-4.0.0-1.16.5-fabric" = _nIvsaVVL;
        "pkg-4.0.0-1.17.1-fabric" = _pJiRnuVH;
        "pkg-4.0.0-1.17.1-forge" = _4fR4b7Hu;
        "pkg-4.0.0-1.18.2-fabric" = _tu7mOIGm;
        "pkg-4.0.0-1.18.2-forge" = _Xpf5Mhdq;
        "pkg-4.0.0-1.19-fabric" = _92kDFUF7;
        "pkg-4.0.0-1.19-forge" = _TTWhaNXL;
        "pkg-4.0.0-1.19.2-fabric" = _yLL52cDD;
        "pkg-4.0.0-1.19.2-forge" = _wqtgWC2v;
        "pkg-4.0.0-1.19.3-fabric" = _NrCjpwrF;
        "pkg-4.0.0-1.19.3-forge" = _zzFcAtdQ;
        "pkg-4.0.0-1.19.4-fabric" = _JUXF54ED;
        "pkg-4.0.0-1.19.4-forge" = _QGAlBvbj;
        "pkg-4.0.0-1.20.1-fabric" = _vIbnKJUZ;
        "pkg-4.0.0-1.20.1-forge" = _EY44b2KA;
        "pkg-4.0.0-1.20.2-fabric" = _XJM971aP;
        "pkg-4.0.0-1.20.4-fabric" = _PugkXKeV;
        "pkg-4.0.0-1.20.4-neoforge" = _SmX83Ftz;
        "pkg-4.0.0-1.20.6-fabric" = _wV7NhYci;
        "pkg-4.0.0-1.20.6-neoforge" = _mdqZvulB;
        "pkg-4.0.0-1.21.1-fabric" = _AgbXr0yD;
        "pkg-4.0.0-1.21.1-neoforge" = _Qw0dYRY2;
        "pkg-4.0.0-1.21.3-fabric" = _mqWDgqtu;
        "pkg-4.0.0-1.21.3-neoforge" = _KbwG2aZQ;
        "pkg-4.0.0-1.21.4-fabric" = _sTzQEyes;
        "pkg-4.0.0-1.21.4-neoforge" = _4qeZW2UD;
        "pkg-4.0.0-1.21.5-fabric" = _nr6A4y2U;
        "pkg-4.0.0-1.21.5-neoforge" = _Zpm5HnJ4;
        "pkg-4.0.0-1.21.8-fabric" = _WAikDZAv;
        "pkg-4.0.0-1.21.8-neoforge" = _mWvslqrz;
        "pkg-4.0.0-1.21.10-fabric" = _TeKhpwfC;
        "pkg-4.0.0-1.21.10-neoforge" = _SU7vYQTX;
        "pkg-4.0.0-1.21.11-fabric" = _p5nwiKK0;
        "pkg-4.0.0-1.21.11-neoforge" = _EswDCFP2;
        "pkg-4.0.1-1.16.5-fabric" = _T8eaAdU9;
        "pkg-4.0.1-1.17.1-fabric" = _ggLwOJeo;
        "pkg-4.0.1-1.17.1-forge" = _Lu893Ide;
        "pkg-4.0.1-1.18.2-fabric" = _zt4Mw0aq;
        "pkg-4.0.1-1.18.2-forge" = _5w8q6C2m;
        "pkg-4.0.1-1.19-fabric" = _OJANYIo9;
        "pkg-4.0.1-1.19-forge" = _M2ws3SDi;
        "pkg-4.0.1-1.19.2-fabric" = _5vXYWiA8;
        "pkg-4.0.1-1.19.2-forge" = _R2frePKG;
        "pkg-4.0.1-1.19.3-fabric" = _QKnDyXFf;
        "pkg-4.0.1-1.19.3-forge" = _jHZjYw8b;
        "pkg-4.0.1-1.19.4-fabric" = _aWyA5lZx;
        "pkg-4.0.1-1.19.4-forge" = _vOQJqRSM;
        "pkg-4.0.1-1.20.1-fabric" = _OAX7KtQP;
        "pkg-4.0.1-1.20.1-forge" = _XPB9VZsq;
        "pkg-4.0.1-1.20.2-fabric" = _DYigBoT2;
        "pkg-4.0.1-1.20.4-fabric" = _j2N9FT35;
        "pkg-4.0.1-1.20.4-neoforge" = _Hf1QoQGO;
        "pkg-4.0.1-1.20.6-fabric" = _9LSGsfeG;
        "pkg-4.0.1-1.20.6-neoforge" = _J5H88DAI;
        "pkg-4.0.1-1.21.1-fabric" = _m4FHMSzx;
        "pkg-4.0.1-1.21.1-neoforge" = _gLYSGNgC;
        "pkg-4.0.1-1.21.3-fabric" = _HxbD3BXu;
        "pkg-4.0.1-1.21.3-neoforge" = _UHHvuO5D;
        "pkg-4.0.1-1.21.4-fabric" = _69Iqj0iJ;
        "pkg-4.0.1-1.21.4-neoforge" = _qhf4N0jx;
        "pkg-4.0.1-1.21.5-fabric" = _lBSk1Lxq;
        "pkg-4.0.1-1.21.5-neoforge" = _bfzDOHbA;
        "pkg-4.0.1-1.21.8-fabric" = _QUFxImmb;
        "pkg-4.0.1-1.21.8-neoforge" = _WTZdTVTF;
        "pkg-4.0.1-1.21.10-fabric" = _LkdRvMz9;
        "pkg-4.0.1-1.21.10-neoforge" = _5JaISW2b;
        "pkg-4.0.1-1.21.11-fabric" = _RlK2I7jv;
        "pkg-4.0.1-1.21.11-neoforge" = _yoo60184;
        "pkg-4.0.2-1.16.5-fabric" = _PRxO4HHg;
        "pkg-4.0.2-1.17.1-fabric" = _HOMvtrrW;
        "pkg-4.0.2-1.17.1-forge" = _TXu1pvph;
        "pkg-4.0.2-1.18.2-fabric" = _mkWI8r4v;
        "pkg-4.0.2-1.18.2-forge" = _Tb5WnjWp;
        "pkg-4.0.2-1.19-fabric" = _KirL4KHt;
        "pkg-4.0.2-1.19-forge" = _n9ShC4Ub;
        "pkg-4.0.2-1.19.2-fabric" = _1VXmcO8F;
        "pkg-4.0.2-1.19.2-forge" = _jXZ1nawh;
        "pkg-4.0.2-1.19.3-fabric" = _nU6TcJwz;
        "pkg-4.0.2-1.19.3-forge" = _PD14TIgX;
        "pkg-4.0.2-1.19.4-fabric" = _oBkVrFtd;
        "pkg-4.0.2-1.19.4-forge" = _Hn4OE1vy;
        "pkg-4.0.2-1.20.1-fabric" = _BLh2TUwQ;
        "pkg-4.0.2-1.20.1-forge" = _KzK3HCIm;
        "pkg-4.0.2-1.20.2-fabric" = _iDuwqjo7;
        "pkg-4.0.2-1.20.4-fabric" = _iokXWvZD;
        "pkg-4.0.2-1.20.4-neoforge" = _UyeHEEte;
        "pkg-4.0.2-1.20.6-fabric" = _fkkZ0n76;
        "pkg-4.0.2-1.20.6-neoforge" = _qb43JvrA;
        "pkg-4.0.2-1.21.1-fabric" = _yu7DOjIS;
        "pkg-4.0.2-1.21.1-neoforge" = _96Rprpy6;
        "pkg-4.0.2-1.21.3-fabric" = _ZXkjfcXQ;
        "pkg-4.0.2-1.21.3-neoforge" = _EzdmeFrk;
        "pkg-4.0.2-1.21.4-fabric" = _NfB3M1Vv;
        "pkg-4.0.2-1.21.4-neoforge" = _46ISjbdQ;
        "pkg-4.0.2-1.21.5-fabric" = _lWaBna6O;
        "pkg-4.0.2-1.21.5-neoforge" = _gpjqfUkC;
        "pkg-4.0.2-1.21.8-fabric" = _pHP854hC;
        "pkg-4.0.2-1.21.8-neoforge" = _BhgVCIr6;
        "pkg-4.0.2-1.21.10-fabric" = _yKWRaVl7;
        "pkg-4.0.2-1.21.10-neoforge" = _q1vXmXM7;
        "pkg-4.0.2-1.21.11-fabric" = _PJF4VSmw;
        "pkg-4.0.2-1.21.11-neoforge" = _XKJrjUfS;
        "pkg-4.0.2-26.1-fabric" = _ofwRPQ0i;
        "pkg-4.0.2-26.1-neoforge" = _9Jc2Rr9w;
        "default" = _9Jc2Rr9w;
    });
