...
let
    ...
    in {
        ...
        "pkg-1.21-1.0.1" = _zBWFPP1J;
        "pkg-1.20.6-1.0.1" = _sudv4xYa;
        "pkg-1.20.4-1.0.1" = _Nt1jt7Z9;
        "pkg-1.20.1-1.0.1" = _96MBXwRs;
        "pkg-1.20.6-1.0.2" = _KuSzt29s;
        "pkg-1.20.4-1.0.2" = _qxmCv074;
        "pkg-1.20.1-1.0.2" = _cpyoEfXU;
        "pkg-1.21-1.0.2" = _9NtScxLh;
        "pkg-1.21.1-1.0.2" = _e8BCMk7g;
        "pkg-1.21.3-1.0.2" = _mQ10Ndd1;
        "pkg-1.19.2-1.0.2" = _XuDtPA7W;
        "pkg-1.18.2-1.0.2" = _Xn55ElIc;
        "pkg-1.16.5-1.0.2" = _djGokEJB;
        "pkg-1.21.3-1.1.0" = _LcGDlXgb;
        "pkg-1.21.1-1.1.0" = _YibKsOCy;
        "pkg-1.20.6-1.1.0" = _gtvpkmul;
        "pkg-1.20.4-1.1.0" = _XbwDgCF6;
        "pkg-1.20.1-1.1.0" = _HzQSPL8p;
        "pkg-1.21.4-1.1.0" = _jOJLuZDP;
        "pkg-1.21.5-1.2.0" = _hBfd5ZDV;
        "pkg-1.16.5-1.0.3" = _VNn3MfGx;
        "pkg-1.18.2-1.0.3" = _8MUiM8FS;
        "pkg-1.19.2-1.0.3" = _6ZB0FJIA;
        "pkg-1.20.1-1.1.1" = _mNrm89gJ;
        "pkg-1.20.4-1.1.1" = _95NXvmwU;
        "pkg-1.21.6-1.2.1" = _PTnb90Ly;
        "pkg-1.21.7-1.2.1" = _TSf5Mvm5;
        "default" = _TSf5Mvm5;
    });
