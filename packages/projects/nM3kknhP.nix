...
let
    ...
    in {
        ...
        "pkg-1.3.7" = _f4fN6wPN;
        "pkg-1.3.7+1.20.1" = _zIoH4xh0;
        "pkg-1.3.7+1.21.1" = _x8WjcVkk;
        "pkg-1.3.8" = _Q2fat0RM;
        "pkg-1.3.8+1.21.1" = _C9gkB0tB;
        "pkg-2.5.0+1.20.1" = _t4wYRCmm;
        "pkg-2.5.0+1.21.1" = _uZvkkiF7;
        "pkg-2.5.0+1.21.8" = _U0bLFmQW;
        "pkg-2.5.0" = _q9rZXEBU;
        "pkg-1.3.11+1.20.1" = _GNluMIuC;
        "pkg-1.3.11+1.21.1" = _fozthge7;
        "pkg-1.3.11+1.21.8" = _2R3JuKsJ;
        "pkg-1.3.11" = _sIVZs9LC;
        "pkg-1.3.12" = _mtWp33yk;
        "pkg-1.3.12+1.20.1" = _MZghz31X;
        "pkg-1.3.12+1.21.1" = _S4uHNWLO;
        "pkg-1.3.12+1.21.8" = _toQTfN82;
        "pkg-1.3.14+1.20.4" = _XyxyrbY5;
        "pkg-1.3.14+1.20.1" = _LljqKqky;
        "pkg-1.3.14+1.20.1-forge" = _6EBZQjEk;
        "pkg-1.3.14+1.20" = _kboFrOBY;
        "pkg-1.3.14+1.20.3" = _NLUDc4mE;
        "pkg-1.3.14+1.20.2" = _FCCMHrhm;
        "pkg-1.3.14+1.21.1-forge" = _uH83paJG;
        "pkg-1.3.14+1.20.5" = _OVXt2yXc;
        "pkg-1.3.14+1.20.6" = _4Qwr9UJk;
        "pkg-1.3.14+1.21.1" = _84KvNVli;
        "pkg-1.3.14+1.21.3" = _xexRLuwb;
        "pkg-1.3.14+1.21.2" = _d4oZ0bsP;
        "pkg-1.3.14+1.21.4" = _Jq6FfpS0;
        "pkg-1.3.14+1.21.5" = _XXBAdFg8;
        "pkg-1.3.14+1.21.6" = _5mhyjnCB;
        "pkg-1.3.14+1.21.7" = _Xkb4QNZB;
        "pkg-1.3.14+1.21.8" = _5OWLmxyo;
        "pkg-1.3.14+1.21.10" = _i7QewQFh;
        "pkg-1.3.14+1.21.9" = _XomGQ90O;
        "pkg-1.3.15+1.20.4" = _F5boVy7i;
        "pkg-1.3.15+1.20" = _IQlvyAlA;
        "pkg-1.3.15+1.20.2" = _GwLdz5Sn;
        "pkg-1.3.15+1.20.1" = _k7YkKPVZ;
        "pkg-1.3.15+1.20.3" = _eddEidwx;
        "pkg-1.3.15+1.20.1-forge" = _D4vgZmmi;
        "pkg-1.3.15+1.21.1-forge" = _PKx9rt8i;
        "pkg-1.3.15+1.21.3" = _AHRUIT7B;
        "pkg-1.3.15+1.21.2" = _GcGcdNBF;
        "pkg-1.3.15+1.20.6" = _QOa74M4a;
        "pkg-1.3.15+1.20.5" = _eFGiUXxG;
        "pkg-1.3.15+1.21.1" = _aPWoFjDl;
        "pkg-1.3.15+1.21.4" = _WTeFQidc;
        "pkg-1.3.15+1.21.6" = _8PkZkkHQ;
        "pkg-1.3.15+1.21.7" = _fW9yOU9t;
        "pkg-1.3.15+1.21.5" = _kuMfn0Gf;
        "pkg-1.3.15+1.21.9" = _pErTsuHl;
        "pkg-1.3.15+1.21.8" = _zUguDaJG;
        "pkg-1.3.15+1.21.10" = _T3lApuGV;
        "default" = _T3lApuGV;
    });
