...
let
    ...
    in {
        ...
        "pkg-1.0.0-fabric" = _WYrlhVod;
        "pkg-1.0.1-fabric" = _nicMVj0J;
        "pkg-1.0.0-forge" = _cdGlC270;
        "pkg-1.0.2-fabric" = _ldJ6vsnR;
        "pkg-1.0.3-fabric" = _SqvSzYPB;
        "pkg-1.2.0-forge" = _xfWxjLJo;
        "pkg-2.0.0-neoforge" = _x5NMBEBD;
        "pkg-2.0.0-fabric" = _hgdPICIA;
        "pkg-1.2.0-fabric" = _3uTc9H4o;
        "pkg-1.2.1-forge" = _tfhuj4qO;
        "pkg-1.2.1-fabric" = _qnvRN3FJ;
        "pkg-2.0.1-fabric" = _EDRSQoW3;
        "pkg-2.0.1-neoforge" = _H5W3t2ud;
        "pkg-1.2.2-forge" = _Anw1IIAV;
        "pkg-2.0.2-fabric" = _I8xcPjcY;
        "pkg-2.0.2-neoforge" = _LcGfPPua;
        "pkg-1.2.3-forge" = _TxJLqc2c;
        "pkg-1.2.2-fabric" = _uPnN8t1X;
        "pkg-2.1.0" = _eMHcwYHB;
        "pkg-1.3.0" = _fyxrF0Kp;
        "pkg-1.3.1" = _npqQVTAV;
        "pkg-2.1.1" = _HrjD3oYu;
