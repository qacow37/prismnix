...
let
    ...
    in {
        ...
        "pkg-v.1.1.0+mod" = _U1xabMYa;
        "pkg-1.1.1" = _7mEDxNqj;
        "pkg-1.1.1+mod" = _qedr6AB7;
        "pkg-v1.2.1" = _tiWCit4g;
        "pkg-v1.2.1+mod" = _PbCgJznd;
        "pkg-v1.2.2" = _UODGQwC6;
        "pkg-v1.2.2+mod" = _9xq21s28;
        "pkg-v1.2.3" = _TkFkqBRX;
        "pkg-v1.2.3+mod" = _5GBPmaGe;
        "pkg-v1.2.4" = _iTdlxyx6;
        "pkg-v1.2.4+mod" = _CNFAPr58;
        "pkg-v1.2.5" = _qmVFvw3l;
        "pkg-v1.2.5+mod" = _bCSYiaW1;
        "pkg-v1.2.6" = _cowWDVAl;
        "pkg-v1.2.6+mod" = _ij7sUEO5;
        "pkg-v1.2.6.1" = _7SdfMCWC;
