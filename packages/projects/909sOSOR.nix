...
let
    ...
    in {
        ...
        "pkg-1.0.1-Beta-Fabric" = _PmgClboh;
        "pkg-1.0.1-Beta-Forge" = _VdFaj9vS;
        "pkg-1.0.1-Beta-NeoForge" = _8DZyWdHZ;
        "pkg-1.0.2-Beta-Fabric" = _h246Pdss;
        "pkg-1.0.2-Beta-Forge" = _rKz1TPmj;
        "pkg-1.0.2-Beta-NeoForge" = _Yff49mrV;
        "pkg-1.0.0-1.21.1-Fabric" = _g2UOc84o;
        "pkg-1.0.0-1.21.1-Forge" = _RbDrZpDe;
        "pkg-1.0.0-1.21.1-NeoForge" = _utu8JJSM;
        "pkg-1.0.1-1.21.1-Fabric" = _dn6vxW2F;
        "pkg-1.0.1-1.21.1-Forge" = _3mMDUO3Z;
        "pkg-1.0.1-1.21.1-NeoForge" = _BJoxN6jL;
        "pkg-1.0.1-1.21.11-Fabric" = _2oVNOu9e;
        "pkg-1.0.1-1.21.11-Forge" = _rQ37JDJA;
        "pkg-1.0.1-1.21.11-NeoForge" = _MfPkRwqh;
        "pkg-1.1.0-1.21.1-Fabric" = _VOXg0baU;
        "pkg-1.1.0-1.21.1-Forge" = _raQUDUOm;
        "pkg-1.1.0-1.21.1-NeoForge" = _Sd9eTjQB;
        "pkg-1.1.0-1.21.11-Fabric" = _18OR5ThS;
        "pkg-1.1.0-1.21.11-Forge" = _iEpHhwXW;
        "pkg-1.1.0-1.21.11-NeoForge" = _lrELFaQ2;
        "pkg-1.1.0-2-26.1.2-Fabric" = _FAAIYdBO;
        "pkg-1.1.0-2-26.1.2-NeoForge" = _fQx2OsdQ;
        "pkg-1.2.0-Fabric-mc1.21.1" = _eMZX0g1t;
        "pkg-1.2.0-Forge-mc1.21.1" = _5gjZYVK4;
        "pkg-1.2.0-NeoForge-mc1.21.1" = _fCIYaJhQ;
        "pkg-1.2.0-Fabric-mc1.21.11" = _Fzr6jNDD;
        "pkg-1.2.0-Forge-mc1.21.11" = _B4uEC1iy;
        "pkg-1.2.0-NeoForge-mc1.21.11" = _enM5B4c9;
        "pkg-1.2.0-Fabric-mc26.1.2" = _qAJkYMVb;
        "pkg-1.2.0-NeoForge-mc26.1.2" = _2dYsptuR;
        "pkg-1.2.0-NeoForge-mc26.2" = _erS2tdpc;
        "pkg-1.2.1-NeoForge-mc26.2" = _rSzJF7K0;
        "pkg-1.2.1-Forge-mc26.2" = _PjCFm0tv;
        "pkg-1.2.2-Fabric-mc26.2" = _9XpPvWp2;
        "pkg-1.2.2-NeoForge" = _He9nheT4;
        "pkg-1.2.2-Forge" = _TOxRpuTS;
        "pkg-1.2.2-Fabric-mc26.1.2" = _kHAWtAXx;
        "pkg-1.2.2-NeoForge-mc26.1.2" = _jSkpb1Ai;
        "pkg-1.2.2-Forge-mc26.1.2" = _JZ5VEwEU;
        "pkg-1.2.1-Fabric" = _azzFA713;
        "pkg-1.2.1-Forge" = _Ul2R2QEL;
        "pkg-1.2.1-NeoForge" = _UQhwY5pQ;
