...
let
    ...
    in {
        ...
        "pkg-1.5.6" = _dnHaIcty;
        "pkg-1.5.7" = _M4meVpcO;
        "pkg-1.6.6-beta" = _vMHRyFRb;
        "pkg-1.6.7-beta" = _lOmCOBGy;
        "pkg-1.1.8" = _BzMRzw7Q;
        "pkg-1.2.8" = _jPoQcJB1;
        "pkg-1.3.8" = _pgEZivmf;
        "pkg-1.4.8" = _XX6bMl5B;
        "pkg-1.5.8" = _ktAsA1aX;
        "pkg-1.6.9-beta" = _arlyB4Sy;
        "pkg-1.1.10" = _zNecujx9;
        "pkg-1.2.10" = _XS4eM2ms;
        "pkg-1.3.10" = _zGv2bWk9;
        "pkg-1.4.10" = _DhjzJSNP;
        "pkg-1.5.10" = _vAauoJQB;
        "pkg-1.6.10-beta" = _yD6hJxaP;
        "pkg-1.5.11" = _MgRJGwvB;
        "pkg-1.6.11" = _npOvWzfG;
        "pkg-1.6.12" = _rfhh3fex;
        "pkg-1.6.13-beta" = _OxuaE0nd;
        "pkg-1.6.14" = _J4CvOiKz;
        "pkg-1.6.15" = _gg3hKuDX;
        "pkg-1.6.17" = _mckgixLB;
        "pkg-1.6.18" = _dNtbI4FJ;
        "pkg-1.7.18-beta" = _Yzlbwtdu;
        "pkg-1.6.19" = _kYTHKOj4;
        "pkg-1.7.19" = _m86gmBlV;
        "pkg-1.7.20" = _iKyyx1jP;
        "pkg-1.7.21" = _YBtcxmHK;
        "pkg-1.7.23" = _d7203Hw9;
        "pkg-1.7.24" = _uLMyhCec;
        "pkg-1.7.25" = _X1g8Aaw2;
        "pkg-1.7.26" = _Qy1XlGop;
        "pkg-1.7.27" = _Fr0xMIls;
        "pkg-1.8.27" = _a7940DDK;
        "pkg-1.9.27-beta" = _tYbqaFxu;
        "pkg-1.7.28" = _7Byq5pOO;
        "pkg-1.8.28" = _wQ9CPOJX;
        "pkg-1.9.28-beta" = _ZHQyetMt;
        "pkg-1.9.29" = _pxO0KdPL;
        "pkg-1.10.30-beta" = _24gkCSGi;
        "pkg-1.10.30" = _eddYlLHx;
        "pkg-1.9.31" = _aVxxRab1;
        "pkg-1.10.31" = _67pPFVbv;
        "pkg-1.11.31" = _zzUWopo1;
        "pkg-1.10.32" = _mjynPANt;
        "pkg-1.11.32" = _9RZtj4WH;
        "default" = _9RZtj4WH;
    });
