...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.2-fabric" = _1VZ6df1N;
        "pkg-1.18.2-2.2-fabric" = _evAzaJHw;
        "pkg-1.19.2-2.2-fabric" = _9qPjGdB9;
        "pkg-1.16.5-2.2-forge" = _MZcVkDNo;
        "pkg-1.18.2-2.2-forge" = _7WXhArk4;
        "pkg-1.19.2-2.2-forge" = _XabRKbaC;
        "pkg-1.16.5-2.3-fabric" = _rhlehYbS;
        "pkg-1.18.2-2.3-fabric" = _M5HY81Zq;
        "pkg-1.19.2-2.3-fabric" = _Ojxwho7t;
        "pkg-1.19.3-2.4-fabric" = _KfzlPkci;
        "pkg-1.19.3-2.2-forge" = _AmU9f57Q;
        "pkg-1.18.2-3.0-forge+fabric" = _cvTcOho9;
        "pkg-1.19.2-3.0-forge+fabric" = _h5fGbq6A;
        "pkg-1.19.3-3.0-forge+fabric" = _1CDZZUtn;
        "pkg-1.18.2-3.1-forge+fabric" = _7zGwajYa;
        "pkg-1.19.2-3.1-forge+fabric" = _RJijWQkh;
        "pkg-1.19.3-3.1-forge+fabric" = _SlWvQmJm;
        "pkg-1.19.4-3.1-forge+fabric" = _qrrXVx5y;
        "pkg-1.20-3.1-forge+fabric" = _BzJUsM2n;
        "pkg-1.20.1-3.1-forge+fabric" = _KioeItYp;
        "pkg-1.20.2-3.1-forge+fabric" = _2eSJygr4;
        "pkg-1.18.2-3.2-forge+fabric" = _edOVXzaw;
        "pkg-1.19.2-3.2-forge+fabric" = _wVfbk1Qh;
        "pkg-1.20.1-3.2-forge+fabric" = _Mp7FoJbu;
        "pkg-1.20.2-3.2-forge+fabric" = _FDrI0UOV;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _o62bz7GQ;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _G7mXMirM;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _5nwdd4h8;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _76TiymBX;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _dp5qIGuj;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _yPL0oz17;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _23Pg5GjJ;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _ull6syu7;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _h6YjjhJ4;
        "pkg-1.19.2-3.5-fabric+forge" = _z8KfF07r;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _4ZxbgYWu;
        "pkg-1.20.4-3.5-fabric+forge+neo" = _b2eircY2;
        "pkg-1.20.5-3.5-fabric+neo" = _ecH0KV9q;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _NAJfOjA3;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _24yjWEzg;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _SB8tBT69;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _ogQGENyJ;
        "pkg-1.20.6-3.7-fabric+forge+neo" = _IfUqblRL;
        "pkg-1.21.0-3.7-fabric+forge+neo" = _OXA9YWZS;
        "pkg-1.21.1-3.7-fabric+forge+neo" = _LRdWll37;
        "pkg-1.21.2-3.7-fabric+neo" = _bysGu8S8;
        "pkg-1.21.3-3.7-fabric+forge+neo" = _tbJuY8jd;
        "pkg-1.21.4-3.7-fabric+forge+neo" = _BiOZB4fT;
        "pkg-1.20.1-3.8-fabric+forge+neo" = _6H1kc3Kl;
        "pkg-1.21.1-3.8-fabric+forge+neo" = _wF6aQIQi;
        "pkg-1.21.4-3.8-fabric+forge+neo" = _t7LtQjQA;
        "pkg-1.21.5-3.8-fabric+forge+neo" = _pnIOLVId;
        "pkg-1.21.6-3.8-fabric+forge+neo" = _2vjGbxS0;
        "pkg-1.21.7-3.8-fabric+forge+neo" = _Xlcxo0KA;
        "pkg-1.20.1-3.9-fabric+forge+neo" = _YS5wLOmO;
        "pkg-1.21.1-3.9-fabric+forge+neo" = _yYP472C2;
        "pkg-1.21.7-3.9-fabric+forge+neo" = _XO3M1MvK;
        "pkg-1.21.8-3.9-fabric+forge+neo" = _2qEwc5Zd;
        "pkg-1.21.9-3.9-fabric+forge+neo" = _FEJHwlwF;
        "pkg-1.21.9-4.0-fabric+forge+neo" = _bERKPNQT;
        "pkg-1.21.10-4.0-fabric+forge+neo" = _TcOsLlSy;
        "pkg-1.21.11-4.0-fabric+forge+neo" = _RschCm5i;
        "pkg-26.1.0-4.0-fabric+forge+neo" = _ufkz6kI6;
        "pkg-26.1.0-4.1-fabric+forge+neo" = _bs6FkqJT;
        "pkg-26.1.1-4.1-fabric+forge+neo" = _9PHCjx5F;
        "pkg-26.1.2-4.1-fabric+forge+neo" = _d6nY7U05;
        "pkg-1.20.1-4.2-fabric+forge+neo" = _Yb0ZSmA0;
        "pkg-1.21.1-4.2-fabric+forge+neo" = _1ss7iQwh;
        "pkg-1.21.11-4.2-fabric+forge+neo" = _ZjxNT8ZU;
        "pkg-26.1.2-4.2-fabric+forge+neo" = _96rZDCNu;
        "pkg-26.2.0-4.2-fabric+forge+neo" = _jhhxWopL;
        "default" = _jhhxWopL;
    });
