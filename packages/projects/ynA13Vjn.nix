...
let
    ...
    in {
        ...
        "pkg-1.1.8" = _lKS04mMJ;
        "pkg-1.1.9" = _9Gxpi9HI;
        "pkg-1.1.10" = _GwaQZkl4;
        "pkg-1.1.11" = _FCpQ8ZcI;
        "pkg-1.1.12" = _GOoqjndt;
        "pkg-1.1.14" = _6GVndfzN;
        "pkg-1.1.15" = _tFE7HFaL;
        "pkg-1.2.0" = _B4h6fr0X;
        "pkg-2.0-SNAPSHOT" = _WrKiX4No;
        "pkg-2.0.0-rc.1" = _VhZkQlPE;
        "pkg-2.0.0-rc.2" = _ktQqh4VB;
        "pkg-2.0.0" = _IkG9ptp8;
        "pkg-2.0.1-rc.1" = _Gb9kHxWd;
        "pkg-2.0.1" = _8jm4gFej;
        "pkg-2.1.0-rc.1" = _wboicLXn;
        "pkg-2.1.0" = _bcU0cSlB;
        "pkg-2.1.1-rc.1" = _kDBQcjIY;
        "pkg-2.1.1" = _hIOs5i42;
        "pkg-2.1.2-rc.1" = _F5HPh753;
        "pkg-2.1.2-rc.2" = _lU0PWAtb;
        "pkg-2.1.2" = _mQErNNCD;
        "pkg-2.1.3-rc.2" = _8RgWKkl7;
        "pkg-2.1.3" = _K0fKHVSv;
        "pkg-2.1.4" = _OgigbGKH;
        "pkg-2.1.5" = _AajRnLPj;
        "pkg-2.1.6" = _GpxYakvL;
        ...
        "pkg-2.1.8" = _8uz8qSDe;
        "pkg-2.1.9" = _thIIGXX9;
        "pkg-2.2.0-rc.1-fabric" = _jTBV1rzn;
        "pkg-2.2.0-rc.1-neoforge" = _l5Wx8xZd;
        "pkg-2.2.0-rc.2-fabric" = _gr5IT6cp;
        "pkg-2.2.0-rc.2-neoforge" = _AxVEUdDg;
        "pkg-2.2.0-rc.3-fabric" = _rzPrXVfx;
        "pkg-2.2.0-rc.3-neoforge" = _11E98qNY;
        "pkg-2.2.0-fabric" = _YSa2ToGh;
        "pkg-2.2.0-neoforge" = _xh5Dm4Ql;
        "pkg-2.2.0+patch.1-fabric" = _3YG7KRc3;
        "pkg-2.2.0+patch.1-neoforge" = _PiacCIwB;
        "pkg-2.2.1-fabric" = _hLaMMXFU;
        "pkg-2.2.1-forge" = _rnvcpnOp;
        "pkg-2.2.1-neoforge" = _bkdGdvvA;
        "pkg-3.0.0+26.1.1-fabric" = _bhcGLhYB;
        "pkg-3.0.0+26.1.1-neoforge" = _pw97KdpS;
        "pkg-3.0.1+26.1.2-fabric" = _pcYVyf3O;
        "pkg-3.0.1+26.1.2-neoforge" = _4kvTn8oB;
        "default" = _4kvTn8oB;
    });
