...
let
    ...
    in {
        ...
        "pkg-v0.1.5.2-1.19_OF" = _Z1BuWruQ;
        "pkg-v0.1.5.1-1.19_CTM" = _QzD5QFdp;
        "pkg-v0.1.5.1-1.18_OF" = _PJLuTuI9;
        "pkg-v0.1.5.1-1.18_CTM" = _v4FAUAoX;
        "pkg-v0.1.5.1-1.17_OF" = _oFUT93OY;
        "pkg-v0.1.5.1-1.17_CTM" = _v6DafYxM;
        "pkg-v0.1.5.1-1.16_OF" = _TKNW30nL;
        "pkg-v0.1.5.1-1.16_CTM" = _P5jUvK3C;
        "pkg-v0.1.5.2-1.16_CTM" = _PVEwA4Bb;
        "pkg-v0.1.5.2-1.17_CTM" = _uHy6ai6d;
        "pkg-v0.1.5.2-1.18_CTM" = _XYmxPqlN;
        "pkg-v0.1.5.2-1.19_CTM" = _gs7Ibzjm;
        "pkg-v0.1.6-1.16_OF" = _mTS6a0yH;
        "pkg-v0.1.6-1.17_OF" = _ZTMLcdpx;
        "pkg-v0.1.6-1.18_OF" = _dR8yHtaU;
        "pkg-v0.1.6-1.19_OF" = _T4WTpWSD;
        "pkg-v0.1.6.1-1.16_OF" = _XyDVkPh2;
        "pkg-v0.1.6.1-1.17_OF" = _wGex0m0E;
        "pkg-v0.1.6.1-1.18_OF" = _oyVv5aSq;
        "pkg-v0.1.6.1-1.19_OF" = _tmjijb6g;
        "pkg-v0.1.6.1-1.15_OF" = _B68EVqkq;
        "pkg-v0.1.6.1-1.14_OF" = _o39b4zeQ;
        "pkg-v0.1.6.1-1.13_OF" = _sCYiFwkF;
        "pkg-v0.1.6.1-1.12_OF" = _2bySWrk5;
        "pkg-v0.1.6.1-1.9_OF" = _N58mmI7r;
        "pkg-v0.2.0-1.9_OF" = _KU5Wj0no;
        "pkg-v0.2.0-1.12_OF" = _tHTHNty9;
        "pkg-v0.2.0-1.13_OF" = _O528Nl53;
        "pkg-v0.2.0-1.14_OF" = _w9xwG16y;
        "pkg-v0.2.0-1.15_OF" = _N9ILIzDX;
        "pkg-v0.2.0-1.16_OF" = _zx4rB1ZT;
        "pkg-v0.2.0-1.17_OF" = _mLNgiMwn;
        "pkg-v0.2.0-1.18_OF" = _24DWTsc0;
        "pkg-v0.2.0-1.19_OF" = _zXc6Br92;
        "pkg-v0.2.0-1.20_OF" = _Mxb9QZCP;
        "pkg-v0.3.0-1.20_OF" = _8R2hi3Kq;
        "pkg-v0.3.1-1.20_OF" = _N44wQGxk;
        "pkg-v0.4.0-1.9_OF" = _OmYRXGzv;
        "pkg-v0.4.0-1.12_OF" = _GYlPqu9t;
        "pkg-v0.4.0-1.13_OF" = _RGCegJ9x;
        "pkg-v0.4.0-1.14_OF" = _X2TrsJjk;
        "pkg-v0.4.0-1.15_OF" = _YN0RwV90;
        "pkg-v0.4.0-1.16_OF" = _IB8ODJAA;
        "pkg-v0.4.0-1.17_OF" = _fhEgDUBK;
        "pkg-v0.4.0-1.18_OF" = _96ySH2Lw;
        "pkg-v0.4.0-1.19_OF" = _MTTuKEtr;
        "pkg-v0.4.0-1.20_OF" = _6OAaIJso;
        "pkg-v0.4.0-24w14potato_OF" = _tKihjSa7;
        "pkg-v0.4.0-1.21_OF" = _lFtGTsuy;
        "pkg-v0.4.1-1.21_OF" = _TpdfRGQJ;
        "pkg-v0.4.1-1.21_Vanllia" = _xd5XJm9d;
        "pkg-v0.4.0-1.21.2_OF" = _uAF9OJNJ;
        "pkg-v0.4.1-1.21.2_OF" = _mgAhVZLI;
        "pkg-v0.4.2-1.21.2_OF" = _jl1uWGYg;
        "pkg-v0.5.0-1.9_OF" = _GP13I8Un;
        "pkg-v0.5.0-1.13_OF" = _1S5zVIrg;
        "pkg-v0.5.0-1.12_OF" = _NGKAay8b;
        "pkg-v0.5.0-1.14_OF" = _dz6MWzaA;
        "pkg-v0.5.0-1.16_OF" = _wkgRnnkv;
        "pkg-v0.5.0-1.19_OF" = _WIt7W1tB;
        "pkg-v0.5.0-1.20_OF" = _oUNVaM14;
        "pkg-v0.5.0-1.21.2_OF" = _vgkAqxZJ;
        "default" = _vgkAqxZJ;
    });
