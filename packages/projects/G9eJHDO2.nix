...
let
    ...
    in {
        ...
        "pkg-0.0.1+mc.1.18.2" = _GEWPq2Hr;
        "pkg-0.1.0+mc.1.19.3" = _4nFiXKZC;
        "pkg-0.0.2+mc.1.18.2" = _xLrJliQj;
        "pkg-0.1.1+mc.1.19.3" = _SnirGvzZ;
        "pkg-0.2.0+mc.1.19.4" = _rCV6dmGO;
        "pkg-0.4.1+mc.1.20.1" = _CaJFz0WP;
        "pkg-0.5.1+mc.1.20.1" = _vE7A9Cip;
        "pkg-0.5.2+mc.1.20.1" = _rLNU3yas;
        "pkg-0.5.3+mc.1.20.1" = _eUzn1fyJ;
        "pkg-0.6.1+mc.1.20.1" = _M6TAufYU;
        "pkg-0.6.2+mc.1.21" = _8le2Kzh8;
        "pkg-0.7.1+mc.1.20.1" = _5q45oxWW;
        "pkg-0.8.1+mc.1.20.1" = _AxjAmLJq;
        "pkg-0.8.4+mc.1.21.2" = _QBsLvkch;
        "pkg-0.8.2+mc.1.20.4" = _UXPKpRyT;
        "pkg-0.8.3+mc.1.21" = _baubhIHP;
        "pkg-0.8.5+mc.1.21.5" = _5kcHCVce;
        "pkg-0.9.1+mc.1.20.1" = _Vwhj1iP1;
        "pkg-0.9.3+mc.1.21.1" = _Jc8D0myc;
        "pkg-0.9.4+mc.1.21.2" = _Zpt5oCMR;
        "pkg-0.9.2+mc.1.20.4" = _Vxf1GRqn;
        "pkg-0.9.5+mc.1.21.5" = _RxruJi0u;
        "pkg-0.9.3-blanketcon.1+mc.1.21.1" = _mspC2wDR;
        "pkg-0.9.6+mc.1.21.6" = _98mvCMP5;
        "pkg-0.9.8+mc.1.21.9" = _NhnPCAVv;
        "pkg-0.9.5.1+mc.1.21.5" = _Dss3LvH0;
        "pkg-0.9.6.1+mc.1.21.6" = _mdc9cUeW;
        "pkg-0.9.8.1+mc.1.21.9" = _5aRfzWvw;
        "pkg-0.9.9+mc.1.21.11-rc1" = _aCPbwIpT;
        "pkg-0.9.10+mc.26.1.2" = _huUaK6XD;
        "pkg-0.9.10.1+mc.26.1.2" = _5L0V6zal;
        "pkg-0.9.11+mc.26.2" = _a9FvL6b6;
        "default" = _a9FvL6b6;
    });
