...
let
    ...
    in {
        ...
        "pkg-1.0.4+MC1.16.5" = _9rUHuSH0;
        "pkg-1.0.4+MC1.17-1.17.1" = _ilS6HYBp;
        "pkg-1.0.5+MC1.17-1.17.1" = _77Zd2SeA;
        "pkg-1.0.6+MC1.18" = _6Ed8rM26;
        "pkg-1.0.7+MC1.18-1.18.1" = _h3nZGFK2;
        "pkg-1.0.8+MC1.18-1.18.1" = _xuGMUIph;
        "pkg-1.0.9+MC1.18-1.18.2" = _pLyHGoyR;
        "pkg-1.0.9-1+MC1.18-1.18.2" = _1HBQ92ok;
        "pkg-1.0.10+MC1.19" = _1RCAhCj9;
        "pkg-1.0.11+MC1.19" = _ZDOm32om;
        "pkg-1.0.12+MC1.19-1.19.1" = _5B2yrxSb;
        "pkg-1.0.13+MC1.19-1.19.2" = _7y4OhMYn;
        "pkg-1.0.14+MC1.19.3-1.19.4" = _C6Cbq2r9;
        "pkg-1.0.15+MC1.20-1.20.1" = _71uQleqz;
        "pkg-1.0.16+MC1.20-1.20.1" = _CXlYJN1K;
        "pkg-1.0.17+MC1.20.2" = _FgUnvPYF;
        "pkg-1.0.18+MC1.20.2-1.20.4" = _KBqIrJ0n;
        "pkg-1.0.19+MC1.20.2-1.20.5" = _3TNsr85M;
        "pkg-1.0.20+MC1.20.2-1.20.6" = _oXRzsres;
        "pkg-1.1.0+MC1.21" = _OeVLyVi7;
        "pkg-1.1.1+MC1.21-1.21.1" = _wcum7YYY;
        "pkg-1.2.0+MC1.21.2-1.21.3" = _FVL16iaZ;
        "pkg-1.2.1+MC1.21.2-1.21.4" = _egYfBvTz;
        "pkg-1.2.2+MC1.21.2-1.21.5" = _Bw93Wlu3;
        "pkg-1.2.3+MC1.21.2-1.21.6" = _sFySWdPo;
        "pkg-1.2.4+MC1.21.2-1.21.7" = _4gAlmu9Y;
        "pkg-1.2.5+MC1.21.2-1.21.8" = _Vphknl4l;
        "pkg-1.2.6+MC1.21.2-1.21.10" = _ULPiyfBu;
        "pkg-1.3.0+MC1.21.11" = _OxQkBt3E;
        "pkg-1.2.7+MC1.21.2-1.21.10" = _8eeuc2jb;
