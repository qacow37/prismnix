...
let
    ...
    in {
        ...
        "pkg-v1.41" = _JDNrtLyf;
        "pkg-v1.42" = _9rcrwWi7;
        "pkg-v1.42.1" = _vm2gbhk8;
        "pkg-v1.42.2" = _pDfA9uUT;
        "pkg-1.42.3" = _zPz2rutO;
        "pkg-v1.43" = _5Xao1cJI;
        "pkg-v1.44" = _J6g9eYcP;
        "pkg-v1.45" = _g0YaBuw1;
        "pkg-v1.46-beta.1" = _uTxPhZnq;
        "pkg-v1.46-beta-2" = _88VRlIs8;
        "pkg-v1.46-beta-3" = _o5Ix2yOo;
        "pkg-v1.46-release" = _ELe1G8CB;
        "pkg-v1.47" = _3CaMiSO2;
        "pkg-v1.47.1" = _OBbVfqzP;
        "pkg-v1.48" = _MOrqLbYb;
        "pkg-v1.48.1" = _hptgnCWs;
        "pkg-v1.48.2" = _4fywG97U;
        "pkg-v1.49" = _r6kTkxQi;
        "pkg-v1.49.1" = _xbu7DHfy;
        "pkg-v1.49.2" = _KlvNsbQZ;
        "pkg-v1.50" = _7Qw561Dh;
        "pkg-v1.50.1" = _Y7FuGI6v;
        "pkg-v1.50.2" = _rafG5XnO;
        "pkg-v1.51" = _dvXWwX9n;
        "pkg-v1.52" = _ZikJdLCZ;
        "pkg-v1.53" = _J0XF5txZ;
        "pkg-v1.53.1" = _HNZGqSUF;
        "pkg-v1.53.2" = _rrbQOZDJ;
        "pkg-v1.53.3" = _AvfE6Fks;
        "pkg-v1.53.4" = _OHbTJzTy;
        "pkg-v1.53.5" = _fiqTlecC;
        "pkg-v1.53.6" = _WueKhzRD;
        "pkg-v1.54" = _xEkJ5U0B;
        "pkg-v1.54.1" = _ZV3TzlpY;
        "pkg-v1.55" = _FyZUACY7;
        "pkg-v1.55.1" = _yspIKpxS;
        "pkg-v1.55.2" = _na8Nc5Np;
        "pkg-v1.56" = _9PLTx8dg;
        "pkg-v1.57" = _55WNtCC3;
        "pkg-v1.58" = _1W0UcdUz;
        "pkg-v1.58.1" = _YGWLlxLQ;
        "pkg-v1.59" = _VjycBmFP;
        "pkg-v1.60" = _s2b20wJF;
        "pkg-v1.60.1" = _8ou2sreA;
        "pkg-v1.60.2" = _mBLxAxQ8;
        "pkg-v1.61" = _KOKO8Whg;
        "pkg-v1.62" = _c03gGZue;
        "pkg-v1.62.1" = _pRmZpJp0;
        "pkg-v1.62.2" = _Sk3yRNly;
        "pkg-v1.63" = _QKlqKxzl;
        "pkg-v1.63.1" = _7EdrujU3;
        "pkg-v1.63.2" = _R87EEkhY;
        "pkg-v1.63.3" = _fnbYMFvE;
        "pkg-v1.63.4" = _NX1ptnbH;
        "pkg-v1.63.5" = _GivqH6oW;
        "default" = _GivqH6oW;
    });
