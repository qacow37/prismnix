...
let
    ...
    in {
        ...
        "pkg-2.14.5" = _cIbMTXAb;
        "pkg-3.11.2" = _gM0fS0xJ;
        "pkg-4.0" = _vdAU6gxY;
        "pkg-5.0.1" = _SDGmCOpP;
        "pkg-5.0" = _bgzyIFA4;
        "pkg-2.15" = _BfFmaE4z;
        ...
        "pkg-4.1" = _G0PT2Pw8;
        "pkg-5.1" = _Pb4eqz4u;
        "pkg-2.15.1" = _wJg5wWOy;
        "pkg-2.15.2" = _ElZflczX;
        "pkg-3.12.1" = _lZB4CHcw;
        "pkg-4.1.1" = _QbME3QLF;
        "pkg-5.1.1" = _xpk7uIUi;
        "pkg-2.15.3" = _DSrP3y6C;
        "pkg-3.12.2" = _RPZm68qL;
        "pkg-4.1.2" = _zOs30YNR;
        "pkg-5.1.2" = _cXjwTlal;
        "pkg-2.15.4" = _gpCrRFWW;
        "pkg-3.12.3" = _JLNf2blh;
        "pkg-4.1.3" = _CmkvXoQ5;
        "pkg-5.1.3" = _7EyfAAuA;
        "pkg-2.15.5" = _EakU80aZ;
        "pkg-3.12.4" = _l0pk5SyC;
        "pkg-4.1.4" = _EpItbJK0;
        "pkg-5.1.4" = _6TNRODk8;
        "default" = _6TNRODk8;
    });
