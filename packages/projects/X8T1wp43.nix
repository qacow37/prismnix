...
let
    ...
    in {
        ...
        "pkg-1.0.2+mc1.18.2" = _qtU1ipAP;
        "pkg-1.0.2+mc1.19.2" = _yPCLpkWr;
        "pkg-1.0.2+mc1.19.4" = _hfqJ9kER;
        "pkg-1.0.2+mc1.20.1" = _4FHuGrm6;
        "pkg-1.1.0+mc1.18.2" = _eeWRVoFK;
        "pkg-1.1.0+mc1.19.2" = _jPpgECFb;
        "pkg-1.1.0+mc1.19.4" = _rr8Fd5IW;
        "pkg-1.1.0+mc1.20.1" = _KZE3e2K6;
        "pkg-1.1.0+mc1.20.2" = _ywTJU7jj;
        "pkg-1.1.1+mc1.18.2" = _PqtMq5re;
        "pkg-1.1.1+mc1.19.2" = _c2qkCINy;
        "pkg-1.1.1+mc1.19.4" = _W4dXmiyD;
        "pkg-1.1.1+mc1.20.1" = _tjiEBQsp;
        "pkg-1.1.1+mc1.20.2" = _NxD3IlEA;
        "pkg-1.1.2+mc1.18.2" = _vAuq75gL;
        "pkg-1.1.2+mc1.19.2" = _unAr5GgO;
        "pkg-1.1.2+mc1.19.4" = _X5rNGCvF;
        "pkg-1.1.2+mc1.20.1" = _NR61g08K;
        "pkg-1.1.2+mc1.20.2" = _lRF2IyX1;
        "pkg-1.1.2+mc1.20.4" = _YQZL3U5S;
        "pkg-1.1.2+mc1.20.6" = _D6ioUGVP;
        "pkg-1.1.2+mc1.21.1" = _U8lppwkw;
        "pkg-1.2+mc1.20.6" = _W8UNynYW;
        "pkg-1.2+mc1.21.1" = _ji5m2TQn;
        "pkg-1.2.1+mc1.20.6" = _zfo3viMQ;
        "pkg-1.2.1+mc1.21.1" = _Mnu34qmx;
        "pkg-1.2.2+mc1.20.6" = _nrPaVuOg;
        "pkg-1.2.2+mc1.21.1" = _XG7dLiYY;
        "default" = _XG7dLiYY;
    });
