...
let
    ...
    in {
        ...
        "pkg-v8.0.0-1.20.1-Forge" = _hIcEjfq3;
        "pkg-v8.0.0-1.20.1-Fabric" = _4s9ynGSu;
        "pkg-v20.4.0-1.20.4-Fabric" = _89dS0ON7;
        "pkg-v20.4.0-1.20.4-Forge" = _qB7One0j;
        "pkg-v20.4.0-1.20.4-NeoForge" = _CkS92Hnc;
        "pkg-v21.1.0-1.21.1-Fabric" = _amplmLeW;
        "pkg-v21.1.0-1.21.1-NeoForge" = _qFqyEtOF;
        "pkg-v21.3.0-1.21.3-Fabric" = _ApDXLxpe;
        "pkg-v21.3.0-1.21.3-NeoForge" = _ECvPP5qJ;
        "pkg-v21.4.0-1.21.4-Fabric" = _Vv94e9jw;
        "pkg-v21.4.0-1.21.4-NeoForge" = _PjcBl9sL;
        "pkg-v21.5.0-1.21.5-Fabric" = _kFpRU7WI;
        "pkg-v21.5.0-1.21.5-NeoForge" = _GDhES2wM;
        "pkg-v8.0.1-1.20.1-Forge" = _jOZwjIXd;
        "pkg-v8.0.1-1.20.1-Fabric" = _3fkO3smk;
        "pkg-v21.1.1-1.21.1-Fabric" = _BrDNZPNi;
        "pkg-v21.1.1-1.21.1-NeoForge" = _GRcaWOfO;
        "pkg-v21.5.1-1.21.5-Fabric" = _Rzc2u1G6;
        "pkg-v21.5.1-1.21.5-NeoForge" = _eNXs9Hch;
        "pkg-v21.6.0-1.21.6-Fabric" = _tkya7sAS;
        "pkg-v21.6.0-1.21.6-NeoForge" = _JUxg2TgC;
        "pkg-v21.7.0-1.21.7-Fabric" = _3TnZVkSh;
        "pkg-v21.7.0-1.21.7-NeoForge" = _BgqCIncQ;
        "pkg-v21.8.0-1.21.8-Fabric" = _KGBWQE3E;
        "pkg-v21.8.0-1.21.8-NeoForge" = _IlfNPDEr;
        "pkg-21.9.0" = _qlOSaMt5;
        "pkg-21.10.0" = _XJg05q5H;
        "default" = _XJg05q5H;
    });
