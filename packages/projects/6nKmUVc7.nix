...
let
    ...
    in {
        ...
        "pkg-1.3.8" = _AX5iA5To;
        "pkg-1.3.9" = _SabFQMZ2;
        "pkg-1.3.10" = _bIpdUyVp;
        "pkg-1.3.11" = _MrjGRSU4;
        "pkg-1.3.12" = _ztDMRyur;
        "pkg-1.3.13" = _ZU4KOwjQ;
        "pkg-1.3.14" = _Ub07tgsc;
        "pkg-1.3.15" = _klPnOfL9;
        "pkg-1.3.16" = _DTL3Qd0K;
        "pkg-1.3.17" = _NiuqKIT8;
        "pkg-1.4" = _gbt6gPQq;
        "pkg-1.4.1" = _Z9RACRYw;
        "pkg-1.4.2" = _UKQoPvY0;
        "pkg-1.4.3" = _KxuaLz9t;
