...
let
    ...
    in {
        ...
        "pkg-3.0.0+1.14.4" = _R65c2unl;
        "pkg-3.0.0+1.15.2" = _ZqL6ckki;
        "pkg-3.0.0+1.16.5" = _zjbhnAZd;
        "pkg-3.0.0+1.17.1" = _T71vIIzN;
        "pkg-3.1.0+1.14.4" = _EwBQAtBp;
        "pkg-3.1.0+1.15.2" = _LfaTqNsx;
        "pkg-3.1.0+1.16.5" = _MLS7T1Xu;
        "pkg-3.1.0+1.17.1" = _xTVuxOpD;
        "pkg-3.1.1+1.14.4" = _dBBxGGCD;
        "pkg-3.1.1+1.15.2" = _rvU4GD5B;
        "pkg-3.1.1+1.16.5" = _CqcNjv5i;
        "pkg-3.1.1+1.17.1" = _kOcu33ZL;
        "pkg-3.1.1+1.18" = _yUXbei7H;
        "pkg-3.1.2+1.18.2" = _LxIr5MGK;
        "pkg-3.1.3+1.14.4" = _8RPFL5Mj;
        "pkg-3.1.3+1.15.2" = _kFoXygE6;
        "pkg-3.1.3+1.16.5" = _FeE81KUc;
        "pkg-3.1.3+1.17.1" = _rEM4FZgi;
        "pkg-3.1.3+1.18.1" = _Wjcz7cQl;
        "pkg-3.1.3+1.18.2" = _3WUcOYsN;
        "pkg-3.1.4+1.14.4" = _QYr9cDWz;
        "pkg-3.1.4+1.15.2" = _h2kRo3y7;
        "pkg-3.1.4+1.16.5" = _OzEfUxbi;
        "pkg-3.1.4+1.17.1" = _ouSyab97;
        "pkg-3.1.4+1.18.1" = _T0zdSVvC;
        "pkg-3.1.4+1.18.2" = _cp6CH2rg;
        "pkg-3.1.5+1.15.2" = _KHt1FBmm;
        "pkg-3.1.5+1.16.5" = _mQvANIXu;
        "pkg-3.1.5+1.17.1+fabric" = _TgQSnaI1;
        "pkg-3.1.5+1.17.1" = _BiMIPB28;
        "pkg-3.1.5+1.18.2" = _ze6TnX0J;
        "pkg-3.1.5+1.18.2+fabric" = _Lwq7SbWS;
        "pkg-3.1.5+1.19" = _tN6VQRtj;
        "pkg-3.1.5+1.19+fabric" = _NIp539QV;
        "pkg-3.1.6+1.17.1" = _PWOYw4Zw;
        "pkg-3.1.6+1.17.1+fabric" = _S6pj7aGA;
        "pkg-3.1.6+1.18.2" = _YMm80FwA;
        "pkg-3.1.6+1.18.2+fabric" = _DJ8n4qd1;
        "pkg-3.1.6+1.19.2" = _sqjB6UpH;
        "pkg-3.1.6+1.19.2+fabric" = _eskUjpll;
        "pkg-3.1.6+1.19.4" = _2pHDVmC6;
        "pkg-3.1.6+1.19.4+fabric" = _6hrvbRhj;
        "pkg-3.1.6+1.20.1" = _4W6BNHXt;
        "pkg-3.1.6+1.20.1+fabric" = _ZafZUA9o;
        "pkg-3.1.6+1.20.4" = _fvEupKlk;
        "pkg-3.1.6+1.20.4+fabric" = _VbqQULfS;
        "pkg-3.1.6+1.20.6+fabric" = _6c4tXeNn;
        "pkg-3.1.6+1.21.1+fabric" = _9CUXRu3Y;
        "pkg-3.1.6+1.21.5+fabric" = _gUtAlLkJ;
        "pkg-3.1.7+1.17.1+fabric" = _5BSg69OQ;
        "pkg-3.1.7+1.18.2" = _YjXLRNGC;
        "pkg-3.1.7+1.18.2+fabric" = _QKTrYhjL;
        "pkg-3.1.7+1.19.2" = _EAsudMQ8;
        "pkg-3.1.7+1.19.2+fabric" = _czi4bAwI;
        "pkg-3.1.7+1.19.4" = _YA2jUINq;
        "pkg-3.1.7+1.19.4+fabric" = _8x6NuUAC;
        "pkg-3.1.7+1.20.1" = _WG1cHEbm;
        "pkg-3.1.7+1.20.1+fabric" = _lzorfLP4;
        "pkg-3.1.7+1.20.4" = _x0hImrj2;
        "pkg-3.1.7+1.20.4+fabric" = _aA7OX7Es;
        "pkg-3.1.7+1.20.6+fabric" = _xYnFQXiV;
        "pkg-3.1.7+1.21.1+fabric" = _XsJvDzrm;
        "pkg-3.1.7+1.21.5+fabric" = _Md4pfJ8r;
        "pkg-3.1.7+1.21.7+fabric" = _4lYRfzCX;
        "default" = _4lYRfzCX;
    });
