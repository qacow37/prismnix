...
let
    ...
    in {
        ...
        "pkg-0.0.1" = _Sp9DcGuE;
        "pkg-0.0.2.0" = _NE2gAgIg;
        "pkg-0.0.1.0" = _sRCTpQMl;
        "pkg-0.0.3.0" = _tEVULVe5;
        "pkg-0.0.4.0" = _GXF0eooQ;
        "pkg-0.1.0.0" = _iIILxpvB;
        "pkg-0.1.1.0" = _FbCv81tc;
        "pkg-0.2.0.0" = _3LZYLMpA;
        "pkg-Fabric-0.0.1.0-1.20.4" = _jS1JnF7v;
        "pkg-0.2.1.0" = _L900a2dh;
        "pkg-Fabric-0.1.0.0-1.20.4" = _5NcAfJmD;
        "pkg-Quilt-0.1.0.0-1.20.4" = _dSS6h9Xq;
        "pkg-Fabric-0.2.0.0-1.20.4" = _EbgFuy0B;
        "pkg-0.3.0.0" = _tJ85Xorr;
        "pkg-0.3.1.0" = _s96DRmGA;
        "pkg-Fabric-0.3.0.0-1.20.4" = _JhoRoYdw;
        "pkg-0.3.2.0" = _ZrSGU2Wp;
        "pkg-Fabric-0.3.2.0-1.20.1" = _7TUYuyfS;
        "pkg-Fabric-0.3.3.0-1.20.1" = _oXOUykxu;
        "pkg-Fabric-0.4.0-1.20.1" = _m0elD70p;
        "pkg-Fabric-0.4.1-1.20.1" = _ZNMQKxWt;
        "pkg-Fabric-0.4.1-1.20.2" = _xunFZY2J;
        "pkg-Fabric-0.4.1-1.20.4" = _zraW3Jrr;
        "default" = _zraW3Jrr;
    });
