...
let
    ...
    in {
        ...
        "pkg-forge-1.19-1.0.1" = _F68y6qzY;
        "pkg-forge-1.19-1.0.2" = _YZ4RJ0ui;
        "pkg-forge-1.19.1-1.0.0" = _rhMnlpEv;
        "pkg-forge-1.19.2-1.0.0" = _Pv0d4FpX;
        "pkg-forge-1.19.3-1.0.0" = _4yUQZVKh;
        "pkg-forge-1.19.3-1.0.1" = _u2Mu8lcy;
        "pkg-forge-1.19.3-1.0.2" = _7Mmp64h2;
        "pkg-forge-1.19.4-1.0.2" = _4LxZVS6T;
        "pkg-forge-1.20-1.0.2" = _S42zSDl2;
        "pkg-forge-1.20.1-1.0.2" = _DklhmqJB;
        "pkg-forge-1.20.1-1.0.3" = _pYeOjAxg;
        "pkg-forge-1.20.2-1.0.3" = _dxcPzGrO;
        "pkg-neoforge-1.20.2-1.0.3" = _61PqGZRS;
        "pkg-neoforge-1.20.2-1.0.4" = _pAncJpm6;
        "pkg-neoforge-1.20.3-1.0.4" = _dWN2y0jQ;
        "pkg-neoforge-1.20.4-1.0.4" = _FhwTPOl2;
        "pkg-forge-1.19.2-1.0.5" = _HdszKhYp;
        "pkg-forge-1.20.1-1.0.5" = _8NOiKSE2;
        "pkg-neoforge-1.20.4-1.0.5" = _X4xgPcpT;
        "pkg-neoforge-1.20.4-1.0.6" = _6TbEWQkm;
        "pkg-neoforge-1.20.5-1.0.6" = _UtdoI3PI;
        "pkg-neoforge-1.20.6-1.0.6" = _uWP5HDg8;
        "pkg-neoforge-1.21-1.0.6" = _BtqLNwnP;
        "pkg-neoforge-1.21.1-1.0.6" = _Dz7vCaHv;
        "pkg-neoforge-1.21.2-1.0.6" = _CqCVT0o7;
        "pkg-neoforge-1.21.3-1.0.6" = _19A6dmdq;
        "pkg-neoforge-1.21.4-1.0.6" = _mu8SrWzF;
        "pkg-neoforge-1.21.5-1.0.6" = _oFzRUOgK;
        "pkg-neoforge-1.21.6-1.0.6" = _Y08eaUHy;
        "pkg-neoforge-1.21.7-1.0.6" = _WblZIUWx;
        "pkg-neoforge-1.21.7-1.0.7" = _z7h1xrlW;
        "pkg-neoforge-1.21.8-1.0.7" = _rSWaYNXd;
        "default" = _rSWaYNXd;
    });
