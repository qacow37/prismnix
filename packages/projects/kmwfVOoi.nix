...
let
    ...
    in {
        ...
        "pkg-18c" = _kVgJJYab;
        "pkg-18d" = _KgJHr8Dp;
        "pkg-r0.1-alpha1" = _XoCWYDjr;
        "pkg-r0.1-alpha1a" = _14mGpe0b;
        "pkg-r0.1-alpha1b" = _b0FIbZO5;
        "pkg-r0.1-alpha2" = _l5ivuwMY;
        "pkg-r01-alpha3" = _sj3rknwd;
        "pkg-r0.1-alpha4" = _1LqpOU4L;
        "pkg-r0.1-alpha5" = _YZmnZG0z;
        "pkg-r0.1-alpha6" = _HQ07gLxO;
        "pkg-r0.1-alpha7" = _nHx51bUG;
        "pkg-r0.1-alpha8" = _3e7utNwI;
        "pkg-r0.1-alpha9" = _1vaiswPE;
        "pkg-r0.1-alpha9a" = _H05Uhtt3;
        "pkg-r0.1-alpha9b" = _AWtumMpy;
        "pkg-r0.1-alpha9c" = _kT5rXgon;
        "pkg-r0.1-alpha10" = _4QxN9Se8;
        "pkg-r0.1-beta1" = _9sZPgPWg;
        "pkg-r0.1-beta2" = _kxINFUyA;
        "pkg-r0.1-beta3" = _i5OG3ddh;
        "pkg-r0.1-beta4" = _3xT7x1Bp;
        "pkg-r0.1-beta4-fix1" = _b25mX5xa;
        "pkg-r0.1-beta4-fix2" = _is3rS8JL;
        "pkg-r0.1-beta5" = _nZpwS5Nf;
        "pkg-r0.1-beta6" = _tmYqcund;
        "pkg-r0.1-beta6a" = _LCXewuJs;
        "pkg-r0.1-beta7" = _7v1Tx7G4;
        "pkg-r0.1-beta7a" = _GQRxltfT;
        "pkg-aprilfools_2025" = _JrSlEfvn;
        "pkg-r0.1-beta7b" = _V7VAEdfL;
        "pkg-r0.1-beta8" = _ZYsfUe9S;
        "pkg-r0.1-beta9" = _cpD4esk9;
        "default" = _cpD4esk9;
    });
