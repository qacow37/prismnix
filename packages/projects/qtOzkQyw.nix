...
let
    ...
    in {
        ...
        "pkg-v1.1" = _45ZCDAcW;
        "pkg-v1.2" = _36RWNYIi;
        "pkg-v1.2+mod" = _dSEI50gY;
        "pkg-v2.0" = _kmpSokHn;
        "pkg-v2.0+mod" = _zPushDp0;
        "pkg-v2.1" = _3DtYgV06;
        "pkg-v2.1+mod" = _GWa8pl0X;
        "pkg-v2.2" = _gVfRubF1;
        "pkg-v2.2+mod" = _mpYpsxpe;
        "pkg-v2.3" = _LoQ7acY8;
        "pkg-v2.3+mod" = _zJE2QN8x;
        "pkg-v2.4" = _BbYw4y3C;
        "pkg-v2.4+mod" = _wDDbY1ww;
        "pkg-v2.5" = _xUJ9PHAD;
        "pkg-v2.5+mod" = _Vpllpwni;
        "pkg-v2.6" = _UnW4Lc64;
        "pkg-v2.6+mod" = _53TB5x5h;
        "pkg-v2.7" = _qeZVPy3R;
        "pkg-v2.7+mod" = _8IpygqXk;
        "pkg-v2.8" = _WkT1Lf67;
