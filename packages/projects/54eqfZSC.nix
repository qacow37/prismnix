...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.20.1" = _kbGLD9dR;
        "pkg-0.1-1.19.4" = _6LwJsyCC;
        "pkg-1.0.2-1.20.1" = _Dl8MiCwf;
        "pkg-1.0.3-1.20.1" = _bQq0XpMN;
        "pkg-fabric-1.0.3-1.20.1" = _wYv6dctH;
        "pkg-fabric-1.0.3-1.19.4" = _7O8PbECC;
        "pkg-fabric-1.0.3-1.19.2" = _UPObxQld;
        "pkg-fabric-1.19.2-1.0.4" = _2hKttwV0;
        "pkg-fabric-1.19.4-1.0.4" = _Tk9TJ8jy;
        "pkg-fabric-1.20.1-1.0.4" = _4xBQRSrI;
        "pkg-forge-1.19.2-1.0.4" = _Uv4r5q7N;
        "pkg-forge-1.19.4-1.0.4" = _SsBjJzlY;
        "pkg-forge-1.20.1-1.0.4" = _19eiXkY0;
        "pkg-fabric-1.19.2-1.0.5" = _y1zaR8hl;
        "pkg-fabric-1.19.4-1.0.5" = _l9gBTZ63;
        "pkg-1.0.5" = _bidT6426;
        "pkg-1.19.2-1.0.5" = _HJLh5Hib;
        "pkg-fabric-1.21-1.0.5" = _bjIYTdLT;
        "pkg-1.0.7" = _mG1B8BcI;
        "pkg-fabric-1.21-1.0.7" = _yPGv8N19;
        "pkg-1.0.8" = _Iw5Ybuj7;
        "pkg-fabric-1.21-1.0.8" = _MsYnwYAU;
        "pkg-1.0.9" = _AxSm5PB9;
        "pkg-fabric-1.21-1.0.9" = _5A24T8JD;
        "default" = _5A24T8JD;
    });
