...
let
    ...
    in {
        ...
        "pkg-0.5.2" = _AicZDv3Y;
        "pkg-0.5.2.a" = _1xPOUM1K;
        "pkg-0.5.3" = _1k4SYd1e;
        "pkg-0.5.3.a" = _XQpPHFFQ;
        "pkg-0.5.3.b" = _DXFEzwRY;
        "pkg-0.5.4" = _HdgdrH1E;
        "pkg-5.5.0" = _7mkkUJtb;
        "pkg-5.5.1" = _pOCvB359;
        "pkg-5.6.0" = _OjFFlxmu;
        ...
        "pkg-5.9.0" = _ZOkFGRwq;
        "pkg-5.9.1" = _hdPNh3oa;
        "pkg-5.10.0" = _LTezmxKD;
        "pkg-5.10.1" = _xTBs4YIB;
        "pkg-5.10.2" = _nUn5DSGP;
        "pkg-5.11.0" = _zlTofxh2;
        "pkg-5.11.1" = _u5arUfYz;
        "pkg-5.11.2" = _mFWvbnn8;
        "pkg-5.11.3" = _bsGaXKEd;
        "pkg-5.11.4" = _Ijsq5Kj6;
        "pkg-5.11.5" = _GtEAfuhu;
        "pkg-5.11.6" = _Xd4DDnph;
        "pkg-5.11.7" = _bOiDu0LS;
        "default" = _bOiDu0LS;
    });
