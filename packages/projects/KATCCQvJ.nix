...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.1" = _xFJyr2x9;
        "pkg-1.0.1+1.20.1" = _q3pECHjy;
        "pkg-1.0.1+1.20.2-1.20.4" = _lPD0nAjd;
        "pkg-1.0.2+1.20" = _rEGLWqLt;
        "pkg-1.0.2+1.20.1" = _WLjqlYhP;
        "pkg-1.0.2+1.20.2" = _tr0sHJ7V;
        "pkg-1.0.2+1.20.3" = _Y2Fo9cLQ;
        "pkg-1.0.2+1.20.4" = _yoJJWySQ;
        "pkg-1.0.3+1.20.1" = _12RnBhsw;
        "pkg-1.0.3+1.20.2" = _zLH1bQu2;
        "pkg-1.0.3+1.20" = _V5bspdyk;
        "pkg-1.0.3+1.20.3" = _ZDETWPer;
        "pkg-1.0.3+1.20.4" = _7Ou2JcAo;
        "pkg-1.0.3+1.20.5" = _FChcf7CY;
        "pkg-1.0.3+1.20.6" = _A9MlZEK1;
        "pkg-1.0.3+1.21" = _uVDoA91Y;
        "pkg-1.0.4+1.20.1" = _Lny0xJsM;
        "pkg-1.0.4+1.20.2" = _PlxdKRpC;
        "pkg-1.0.4+1.20.3" = _GALwiKsT;
        "pkg-1.0.4+1.20.4" = _jzxvecke;
        "pkg-1.0.4+1.20.5" = _vxIL6DgL;
        "pkg-1.0.4+1.20.6" = _7MtuBWUp;
        "pkg-1.0.4+1.21" = _65GELcYO;
        "pkg-1.0.4+1.21.1" = _jelUpXkK;
        "default" = _jelUpXkK;
    });
