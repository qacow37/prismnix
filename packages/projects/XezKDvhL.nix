...
let
    ...
    in {
        ...
        "pkg-1.4.0-neoforge" = _yKKXbbi1;
        "pkg-1.4.0-fabric" = _mpR2dAS2;
        "pkg-1.5.0-fabric" = _iI2zCpUo;
        "pkg-1.5.0-neoforge" = _dl1FanM5;
        "pkg-1.7.0-fabric" = _5LSaBtct;
        "pkg-1.7.0-neoforge" = _PPsDB2tS;
        "pkg-1.8.0-neoforge" = _aB4AMpzw;
        "pkg-1.8.0-fabric" = _JQhCvtpT;
        "pkg-1.9.0-neoforge" = _QG1SgcDS;
        "pkg-1.9.0-fabric" = _EEbR2ILh;
        "pkg-1.11.0-neoforge" = _BgThpJP1;
        "pkg-1.11.0-fabric" = _sh27DJHK;
        "pkg-1.14.0-neoforge" = _aGFMS2nE;
        "pkg-1.14.0-fabric" = _Tw2moQY5;
        "pkg-1.17.0-neoforge" = _Oj6o4SFD;
        "pkg-1.17.0-fabric" = _oLZgalRX;
        "pkg-1.21.0-neoforge" = _CujpUBLN;
        "pkg-1.21.0-fabric" = _oNO7nfT4;
        "pkg-1.21.1-neoforge" = _7dTJc7d2;
        "pkg-1.21.1-fabric" = _feNys87f;
        "pkg-1.30.0-neoforge" = _ydSSAMRm;
        "pkg-1.30.0-fabric" = _rScTeucE;
        "pkg-1.30.1-fabric" = _6ju3CWDx;
        "pkg-1.30.1-neoforge" = _AUe54as1;
        "default" = _AUe54as1;
    });
