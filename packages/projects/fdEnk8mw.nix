...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.21" = _eoNiNc1g;
        "pkg-1.0.0+mc1.21.1" = _V4NT9HVl;
        "pkg-1.0.0+mc1.21.2" = _g1twTDNz;
        "pkg-1.0.0+mc1.21.3" = _roGtSv3K;
        "pkg-1.0.0+mc1.21.4" = _qjoKXzBc;
        "pkg-1.0.0+mc1.21.5" = _ytrhS8GH;
        "pkg-1.0.0+mc1.21.6" = _YwxBOrcz;
        "pkg-1.0.0+mc1.21.7" = _amf1s2xW;
        "pkg-1.0.0+mc1.21.8" = _7D9nbO8t;
        "pkg-1.0.0+mc1.21.9" = _3vdIQziN;
        "pkg-1.0.0+mc1.21.10" = _9VJnI3tW;
        "pkg-1.0.0+mc1.21.11" = _768lDNBV;
        "pkg-1.0.1+mc1.21" = _c1pexTOR;
        "pkg-1.0.1+mc1.21.1" = _SYgxGdbC;
        "pkg-1.0.1+mc1.21.2" = _mDZQoRoG;
        "pkg-1.0.1+mc1.21.3" = _N1BZQTnQ;
        "pkg-1.0.1+mc1.21.4" = _2Oa65ZCk;
        "pkg-1.0.1+mc1.21.5" = _P7ACP4pA;
        "pkg-1.0.1+mc1.21.6" = _2PDtbQ96;
        "pkg-1.0.1+mc1.21.7" = _At0BhaKF;
        "pkg-1.0.1+mc1.21.8" = _O7yCkfnV;
        "pkg-1.0.1+mc1.21.9" = _tgpGfcj4;
        "pkg-1.0.1+mc1.21.10" = _ZLlQUc86;
        "pkg-1.0.1+mc1.21.11" = _59a1dirE;
        "pkg-1.0.2+mc1.21" = _ZuubnqfZ;
        "pkg-1.0.2+mc1.21.1" = _hWZXgGhT;
        "pkg-1.0.2+mc1.21.2" = _Fpf7F3lC;
        "pkg-1.0.2+mc1.21.3" = _5iBwgZd1;
        "pkg-1.0.2+mc1.21.4" = _BRDtZHHm;
        "pkg-1.0.2+mc1.21.5" = _CltkLyL0;
        "pkg-1.0.2+mc1.21.6" = _FVOrZFiC;
        "pkg-1.0.2+mc1.21.7" = _NFa8tOJd;
        "pkg-1.0.2+mc1.21.8" = _nCDIzEca;
        "pkg-1.0.2+mc1.21.9" = _NWhoPDtV;
        "pkg-1.0.2+mc1.21.10" = _nervtnSZ;
        "pkg-1.0.2+mc1.21.11" = _xozZi882;
        "default" = _xozZi882;
    });
