...
let
    ...
    in {
        ...
        "pkg-50.0.0PR1" = _adl4gHd7;
        "pkg-50.0.0pr2" = _JGWQjBPQ;
        "pkg-50.0.1" = _s776iYC5;
        "pkg-50.1.0" = _qroCLw9w;
        "pkg-50.1.1" = _EhZOrg4f;
        "pkg-50.1.2" = _pQPmNEgS;
        "pkg-50.2.0" = _QnzNmtcK;
        "pkg-50.2.1" = _O5EhraL0;
        "pkg-PR1" = _fINUfO7m;
        "pkg-PR2" = _nQyxMXt2;
        "pkg-PR3" = _ikchz0jd;
        "pkg-rev1" = _oDKLwOYE;
        "pkg-rev2.1" = _BnbYxKxD;
        "pkg-rev2" = _6jVdgvfY;
        "pkg-rev3.1" = _BOhipLod;
        "pkg-rev3.2" = _RPRr4lA4;
        "pkg-rev3" = _CbypDP4j;
        "pkg-rev4" = _QnITS8WK;
        "pkg-51.0.0" = _ot4ickeG;
        "pkg-51.0.1" = _XOUwwqOd;
        "pkg-51.0.2" = _PNpakf9i;
        "pkg-51.0.3" = _JFBfeXDa;
        "pkg-51.0.4" = _KH2TS0bI;
        "pkg-51.0.5" = _op2yCSps;
        "pkg-52.0.0" = _rLG5Q4lK;
        "pkg-52.0.1" = _NkpTgL8A;
        "pkg-52.0.2" = _nOckR51Q;
        "pkg-52.0.3" = _m5PLAdii;
        "pkg-52.0.4" = _mxQpJjK7;
        "pkg-52.0.5" = _8MelZQfD;
        "pkg-52.0.6" = _D3ZMYfLT;
        "pkg-52.0.7" = _O6P1DX37;
        "pkg-52.0.8" = _O7n5pOMN;
        "pkg-52.1.0" = _LlWsXVsX;
        "pkg-52.1.1" = _9til7U5x;
        "pkg-52.1.2" = _FVU0oBig;
        "pkg-52.1.3" = _zRkmZIHn;
        "pkg-52.1.4" = _ghCS8F9y;
        "pkg-52.1.5" = _5jqSiuhI;
        "pkg-52.1.6" = _KK81vYi7;
        "pkg-52.1.7" = _iFoV6EkD;
        "pkg-52.1.8" = _R8GhCMNl;
        "pkg-52.1.9" = _18WJYEEh;
        "pkg-52.2.0" = _Djp0Hp6Z;
        "pkg-53.0.0" = _uHS3GrQK;
        "pkg-54.0.0" = _SCoczI5o;
        "pkg-55.0.0" = _1hCic2xP;
        "pkg-55.0.1" = _YcMqnJgw;
        "pkg-55.0.2" = _T7B5rIQ2;
        "pkg-55.0.3" = _Pd9hYUQ4;
        "pkg-56.0.0" = _Qttb8DAg;
        "pkg-56.0.1" = _qjqgbRJv;
        "pkg-57.0.0" = _VsTMzbdW;
        "pkg-57.1.0" = _J9XHL8p8;
        "pkg-57.1.1" = _e7VNG0nH;
        "pkg-57.1.2" = _FpZfDtRP;
        "pkg-57.1.3" = _OcbQbmF8;
        "pkg-57.1.4" = _VmCSE3bb;
        "pkg-57.1.5" = _Hcri9iV6;
        "pkg-57.1.6" = _GEWK4CpN;
        "pkg-57.1.7" = _YpveLPHH;
        "pkg-57.1.8" = _hhbGn7On;
        "pkg-57.1.9" = _zgfko9CY;
        "pkg-57.1.91" = _R2T7kDWl;
        "pkg-57.1.92" = _WE0kP0Z2;
        "pkg-57.1.93" = _DHes2cZ8;
        "pkg-57.1.94" = _XdTfQ84N;
        "pkg-57.1.95" = _cf6Tmzyx;
        "pkg-57.1.96" = _yeuq7VaK;
        "pkg-59.0.0" = _kI6djoEc;
        "pkg-59.0.1" = _f6Cym118;
        "pkg-59.0.2" = _gUsIffzL;
        "pkg-59.0.3" = _PsyeK4gt;
        "pkg-58.0.0" = _5fpjLB7f;
        "pkg-58.1.0" = _OIdVshve;
        "pkg-58.1.1" = _y6SRi0Sh;
        "pkg-58.1.2" = _wujcv1wk;
        "pkg-58.1.3" = _LEOYdgFu;
        "default" = _LEOYdgFu;
    });
