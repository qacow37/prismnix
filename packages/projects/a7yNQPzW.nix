...
let
    ...
    in {
        ...
        "pkg-1.0.4" = _sILWnhIF;
        "pkg-1.0.5" = _ESpjhqpv;
        "pkg-1.16.5-1.0.6" = _mIy2NX5N;
        "pkg-1.15.2-1.0.6" = _80IBhWVX;
        "pkg-1.16.5-1.0.7" = _7Auaz1PK;
        "pkg-1.15.2-1.0.7" = _yegoF0Hg;
        "pkg-1.15.2-1.08" = _HucIE9W4;
        "pkg-1.16.5-1.0.8" = _PvCNhyL7;
        "pkg-1.15.2-1.0.9" = _mhnGdhlV;
        "pkg-1.15.2-1.0.10" = _xGEcA4wZ;
        "pkg-1.16.5-1.0.9" = _leR18i7z;
        "pkg-1.16.5-1.0.10" = _O8Q8Cq70;
        "pkg-1.16.5-1.0.11" = _XBd7ERaB;
        "pkg-1.16.5-1.0.12" = _jfKCpAm5;
        "pkg-1.15.2-1.0.11" = _PRr3YIOu;
        "pkg-1.16.5-1.0.13" = _ZDR7UsNG;
        "pkg-1.15.2-1.0.12" = _NBlVovDF;
        "pkg-1.16.5-1.0.14" = _sPWBB50i;
        "pkg-1.15.2-1.0.13" = _cp3JYMwX;
        "pkg-1.15.2-1.0.14" = _8J9ogRes;
        "pkg-1.16.5-1.0.15" = _r2pjWIwo;
        "pkg-1.15.2-1.0.15" = _mw9LxhyT;
        "pkg-1.16.5-1.0.16" = _xQkilWNE;
        "pkg-1.16.5-1.0.17" = _JVeq23PQ;
        "pkg-1.15.2-1.0.16" = _2avB295g;
        "pkg-1.16.5-1.0.18" = _e7Zsk1Nl;
        "pkg-1.15.2-1.0.17" = _aGJcJXC5;
        "pkg-1.16.5-1.0.19" = _C20O7fFe;
        "pkg-1.15.2-1.0.18" = _QOj8IrfQ;
        "pkg-1.16.5-1.0.20" = _j09tg638;
        "pkg-1.14.4-1.0.0" = _xachL7bw;
        "pkg-1.15.2-1.0.19" = _W9BaCkWy;
        "pkg-1.14.4-1.0.1" = _GIlrWKBa;
        "pkg-1.15.2-1.0.20" = _Cj4dcIA2;
        "pkg-1.16.5-1.0.21" = _zWN0N9CV;
        "pkg-1.18.2-1.0.0" = _81rgYdsv;
        "pkg-1.14.4-1.0.2" = _uVFnWV9W;
        "pkg-1.15.2-1.0.21" = _jociSFJ6;
        "pkg-1.16.5-1.0.22" = _16RN3dCw;
        "pkg-1.18.2-1.0.1" = _1s5OEWFh;
        "pkg-1.14.4-1.0.3" = _rfgu0rqf;
        "pkg-1.15.2-1.0.22" = _f0yINaXV;
        "pkg-1.16.5-1.0.23" = _wVQKx9Op;
        "pkg-1.18.2-1.0.2" = _O7HMaaLu;
        "pkg-1.14.4-1.0.4" = _wkeQs3TZ;
        "pkg-1.15.2-1.0.23" = _ubbpvWAs;
        "pkg-1.18.2-1.0.3" = _QlvRH3ft;
        "pkg-1.16.5-1.0.24" = _jhFEDtEq;
        "pkg-1.14.4-1.0.5" = _8JrY3Dax;
        "pkg-1.15.2-1.0.24" = _uPkuVInt;
        "pkg-1.16.5-1.0.25" = _XfiuvLP0;
        "pkg-1.18.2-1.0.4" = _KvaOF0Fr;
        "pkg-1.18.2-1.0.5" = _ZbmkLxS1;
        "pkg-1.16.5-1.0.26" = _JfcvkFpD;
        "pkg-1.15.2-1.0.25" = _gw5kPPtw;
        "pkg-1.14.4-1.0.6" = _7jazqHmf;
        "pkg-1.14.4-1.0.7" = _o12EaH3T;
        "pkg-1.15.2-1.0.26" = _oGsGT9JL;
        "pkg-1.16.5-1.0.27" = _vCddIvK4;
        "pkg-1.18.2-1.0.6" = _ns6S80e5;
        "pkg-1.18.2-1.0.7" = _FzLxMLcv;
        "pkg-1.14.4-1.0.8" = _xSu3J11o;
        "pkg-1.15.2-1.0.27" = _JTiR0v16;
        "pkg-1.16.5-1.0.28" = _44kw9W5m;
        "pkg-1.18.2-1.0.8" = _m6KHvmGA;
        "pkg-1.14.4-1.0.9" = _6A73tyap;
        "pkg-1.18.2-1.0.9" = _HCotjTuR;
        "pkg-1.16.5-1.0.29" = _OnAPHMZp;
        "pkg-1.15.2-1.0.28" = _IxCjTA88;
        "pkg-1.14.4-1.0.10" = _c6eI9Ebc;
        "pkg-1.15.2-1.0.29" = _VSdyrEkT;
        "pkg-1.16.5-1.0.30" = _fIre4Lx4;
        "pkg-1.18.2-1.0.10" = _Gw3C3a6v;
        "pkg-1.15.2-1.0.30" = _UcN35EvE;
        "pkg-1.16.5-1.0.31" = _jIGP5UDY;
        "pkg-1.18.2-1.0.11" = _k0198BoA;
        "pkg-1.15.2-1.0.31" = _qVWX7azS;
        "pkg-1.16.5-1.0.32" = _72kKWamB;
        "pkg-1.18.2-1.0.12" = _lmmVoDvU;
        "pkg-1.19.2-1.0.0" = _uGuJCQmU;
        "pkg-1.15.2-1.0.32" = _jo1QZaw4;
        "pkg-1.16.5-1.0.33" = _FjGytVrX;
        "pkg-1.18.2-1.0.13" = _zNetmdMk;
        "pkg-1.19.2-1.0.1" = _zSt103hP;
        "pkg-1.15.2-1.0.33" = _zzuo8L3N;
        "pkg-1.16.5-1.0.34" = _yYBmz6q8;
        "pkg-1.18.2-1.0.14" = _Y4xiv71L;
        "pkg-1.19.2-1.0.2" = _UCpVPhuQ;
        "pkg-1.16.5-1.0.35" = _DL3pdp36;
        "pkg-1.18.2-1.0.15" = _mqVS34uQ;
        "pkg-1.19.2-1.0.3" = _BOv7LEtH;
        "pkg-1.16.5-1.0.36" = _B1xDbmCz;
        "pkg-1.18.2-1.0.16" = _j1WXrIxh;
        "pkg-1.19.2-1.0.4" = _GQ9qpy47;
        "pkg-1.16.5-1.0.37" = _eaAFgMjb;
        "pkg-1.18.2-1.0.17" = _RxwnHbzw;
        "pkg-1.19.2-1.0.5" = _DlLw4flV;
        "pkg-1.19.2-1.0.6" = _TpkyYbS6;
        "pkg-1.18.2-1.0.18" = _bPDqNY2e;
        "pkg-1.16.5-1.0.38" = _VucKMDnN;
        "pkg-1.16.5-1.0.39" = _kRH9fxsx;
        "pkg-1.18.2-1.0.19" = _BEzeqgos;
        "pkg-1.19.2-1.0.7" = _M1Aq8sqQ;
        "pkg-1.16.5-1.0.40" = _1Tz0fRKk;
        "pkg-1.18.2-1.0.20" = _wzJ6yMY3;
        "pkg-1.19.2-1.0.8" = _JQYnGCnS;
        "pkg-1.19.2-1.0.10" = _JX09dKo8;
        "pkg-1.16.5-1.0.41" = _EMnd1mNs;
        "pkg-1.18.2-1.0.21" = _EDnPklAt;
        "pkg-1.20.1-1.0.0" = _BJ7IBntb;
        "pkg-1.18.2-1.1.0" = _QOQRFu78;
        "pkg-1.19.2-1.1.0" = _BRZYSNhI;
        "pkg-1.20.1-1.1.0" = _KDgDJCJO;
        "pkg-1.20.1-1.1.1" = _XbVzQQfZ;
        "pkg-1.18.2-1.1.1" = _zTquBXG6;
        "pkg-1.19.2-1.1.1" = _QUoEX6d6;
        "pkg-1.20.1-1.1.2" = _LldrKhOj;
        "pkg-1.21.1-1.0.0" = _VRUuUHGQ;
        "pkg-1.21.1-1.0.1" = _VJTdX7P6;
        "pkg-1.21.1-1.0.2" = _LVMCOsPP;
        "pkg-1.21.1-1.0.3" = _J9NQvILF;
        "pkg-1.21.1-1.0.4" = _YZYxgSE5;
        "pkg-1.20.1-1.1.3" = _ldFKkUfe;
        "pkg-1.21.1-1.0.5" = _Gx7LSNJh;
        "pkg-1.21.1-1.0.6" = _F5C1OobM;
        "default" = _F5C1OobM;
    });
