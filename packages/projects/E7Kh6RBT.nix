...
let
    ...
    in {
        ...
        "pkg-3.0.0" = _EH9zMDk8;
        "pkg-4.0.0" = _5BoKNKkL;
        "pkg-4.0.0+1.20" = _QX8f4aYJ;
        "pkg-4.1.0+1.20.1" = _26I84pBb;
        "pkg-4.2.0+1.20.1" = _fcO2JfKp;
        "pkg-4.2.1+1.20.1" = _pvgZmE2V;
        "pkg-4.2.1+1.21" = _HSNJb28O;
        "pkg-4.2.1+26.1" = _l1jQX6ht;
        "default" = _l1jQX6ht;
    });
