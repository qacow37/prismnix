...
let
    ...
    in {
        ...
        "pkg-Fabric-1.0.0-mc1.21.10" = _9ovMhL7f;
        "pkg-Fabric-2.0.0-mc1.21.11" = _Sd3Ilx6V;
        "pkg-Fabric-3.0.0-mc1.21.11" = _x9RD3auY;
        "pkg-Forge-3.0.0-mc1.21.11" = _kiMak6nN;
        "pkg-Forge-3.0.0-mc1.21.10" = _WXZZvfOs;
        "pkg-Forge-3.0.0-mc1.21.8" = _ugUNYkWl;
        "pkg-Forge-3.0.0-mc1.21.1" = _8jYIJPS0;
        "pkg-Fabric-5.0.0-mc1.21.11" = _KdUv5y7M;
        "pkg-Fabric-5.0.0-mc1.21.10" = _xIi9E2es;
        "pkg-Fabric-5.0.0-mc1.21.9" = _5jqYh55y;
        "pkg-Fabric-5.0.0-mc1.21.8" = _Hm9zZ1td;
        "pkg-Fabric-5.0.0-mc1.21.7" = _XuNiIrYG;
        "pkg-Fabric-5.0.0-mc1.21.6" = _ssJSqMX7;
        "pkg-Fabric-5.0.0-mc1.21.5" = _ejvt6Rsw;
        "pkg-Fabric-5.0.0-mc1.21.4" = _RUDC2S0S;
        "pkg-Fabric-5.0.0-mc1.21.3" = _tWaLTQmR;
        "pkg-Fabric-5.0.0-mc1.21.2" = _kQGKs8ec;
        "pkg-Fabric-5.0.0-mc1.21.1" = _FZwVXkha;
        "pkg-Fabric-5.0.0-mc1.21" = _goAuuflP;
        "pkg-Fabric-5.0.0-mc1.20.6" = _I2NQRUxr;
        "pkg-Fabric-5.0.0-mc1.20.5" = _XEieNI0T;
        "pkg-Fabric-5.0.0-mc1.20.4" = _Ax2hXoAO;
        "pkg-Fabric-5.0.0-mc1.20.3" = _AFtg6BRX;
        "pkg-Fabric-5.0.0-mc1.20.2" = _W7gbQYxB;
        "pkg-Fabric-5.0.0-mc1.20.1" = _LhfhqAdG;
        "pkg-Fabric-5.0.0-mc1.20" = _oa6op8WE;
        "pkg-Fabric-5.0.0-mc1.19.4" = _5a5ZQkZ9;
        "pkg-Fabric-5.0.0-mc1.19.3" = _EMbG2m6t;
        "pkg-Fabric-5.0.0-mc1.19.2" = _3cvPiBla;
        "pkg-Fabric-5.0.0-mc1.19.1" = _as3vm6DS;
        "pkg-Fabric-5.0.0-mc1.19" = _dPsncMIf;
        "pkg-NeoForge-5.0.0-mc1.21.11" = _9fWsjjZg;
        "pkg-Fabric-5.0.0-mc26.1" = _bmWf3vDi;
        "pkg-Fabric-5.0.0-mc26.1.1" = _dMAgmWFa;
        "pkg-Fabric-5.0.0-mc26.1.2" = _AjGRUt4w;
        "pkg-6.0.0" = _clmK6DP2;
        "pkg-7.0.0" = _JWhysrIG;
        "pkg-7.3.0" = _RSmLdpBA;
        "pkg-7.5.0" = _Adrms9au;
