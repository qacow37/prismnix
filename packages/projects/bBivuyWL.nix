...
let
    ...
    in {
        ...
        "pkg-v1.0.0-1.20.1" = _3IEcXtlE;
        "pkg-v1.1.0-1.20.1" = _nyhk2mpr;
        "pkg-v1.2-1.20.1" = _lBAA3Hf0;
        "pkg-v1.2.1-1.19.4" = _OqwMQmH4;
        "pkg-v1.2.1-1.20.1" = _GLDc8CbO;
        "pkg-v1.3-1.20.1" = _XnYD6HK8;
        "pkg-v2-1.20.1" = _QAr4vNN6;
        "pkg-v2-1.21-1.21.1" = _XEzyyFdP;
        "pkg-v2.1-Bug-Fix-1.20.1" = _w62RcPkx;
        "pkg-v2.1_1.21-1.21.1" = _EUMSfugQ;
        "pkg-v2.1.1_1.21-1.21.1" = _scnx5o79;
        "pkg-v2.1.2_1.21-1.21.1" = _vmWyq8C0;
        "pkg-v2.1.2_1.21.2" = _PovLAmee;
        "pkg-v2.1.2_1.21.3" = _eUxQCsDZ;
        "pkg-v2.1.2_1.21.3-fogfix" = _9ajvbyXw;
        "pkg-v2.1.2_1.21.2-md_fix" = _YjLc3Iid;
        "pkg-v2.1.2_1.21.4" = _F6wdiaXz;
        "pkg-v2.1.2_1.21.5" = _tnsnxKCk;
        "pkg-v2.1.2_1.21.6" = _IlyFu7Xe;
        "pkg-v2.1.2_1.21.6_gw-fix" = _IPNgyXHQ;
        "pkg-v2.1.2_1.21_gw-fix" = _yLZ1wjqg;
        "pkg-v2.1.2_1.21.3_gw-fix" = _9nIwUpmL;
        "pkg-v2.1.2_1.21.4_gw-fix" = _Hiw9T3zw;
        "pkg-v2.1.2_1.21.5_gw-fix" = _3E7Kf9kr;
        "pkg-v2.1.2_1.21.7_gw-fix" = _6PMHqR0a;
        "pkg-v2.1.2_1.21.7" = _U3RGHwEG;
        "pkg-v2.1.2_1.21.8" = _EfoZtZP5;
        "pkg-v2.2_1.21.8" = _9on4ChSs;
        "pkg-v2.2_1.21.9" = _ivhMo9g3;
        "pkg-v2.2.1_1.21.9" = _4rp9L9cU;
        "pkg-v2.2.1_1.21.10" = _jneLjxkC;
        "pkg-v2.2.1_1.21.11" = _ccqUAQd7;
        "pkg-v2.2.1_26.1" = _G8KAp2CO;
        "pkg-v2.2.1-26.1.1" = _ql0AO7mt;
        "pkg-v2.2.1_26.1.2" = _GFz7qhm5;
        "pkg-v2.2.1_26.2" = _uJcfY2Bx;
        "default" = _uJcfY2Bx;
    });
