...
let
    ...
    in {
        ...
        "pkg-1.0-SNAPSHOT" = _qycE9k8U;
        "pkg-1.1-SNAPSHOT" = _t10HjiW5;
        "pkg-1.2-SNAPSHOT" = _uJpihq0Y;
        "pkg-1.3-SNAPSHOT" = _TbACF7rT;
        "pkg-1.4-SNAPSHOT" = _5Nc2pGo2;
        "pkg-1.4.1-SNAPSHOT" = _rbiWuBm9;
        "pkg-1.5-SNAPSHOT" = _ZJK1TC6y;
        "pkg-1.6-SNAPSHOT" = _GTUV3PQQ;
        "pkg-1.7-SNAPSHOT" = _z5qsHAtD;
        "pkg-1.8-SNAPSHOT" = _WWb0PfZ7;
        "pkg-1.8.1-SNAPSHOT" = _roc8QAdn;
        "pkg-1.8.2-SNAPSHOT" = _8kbhmMRb;
        "pkg-1.8.3-SNAPSHOT" = _k7lIw4UX;
        "pkg-1.8.4-SNAPSHOT" = _GYXDbBOY;
        "pkg-1.8.5-SNAPSHOT" = _sr4KM9LQ;
        "pkg-1.8.6-ALPHA" = _Nm1wmvea;
        "pkg-1.8.7-ALPHA" = _3uAVi2NF;
        "pkg-1.8.8-ALPHA" = _5vE7uXSV;
        "pkg-1.8.9-SNAPSHOT" = _8SdTdxdr;
        "pkg-1.8.10-SNAPSHOT" = _5BQL4OT4;
        "pkg-1.8.11-SNAPSHOT" = _oNg9OAtd;
        "pkg-1.9-SNAPSHOT" = _tf6qlcfw;
        "pkg-1.9.1-SNAPSHOT" = _68Dc1IsP;
        "pkg-1.10-SNAPSHOT" = _iMAyunHR;
        "pkg-1.10.1-SNAPSHOT" = _9LVCeAFv;
        "default" = _9LVCeAFv;
    });
