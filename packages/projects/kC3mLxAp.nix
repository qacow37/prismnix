...
let
    ...
    in {
        ...
        "pkg-0.0.8" = _pGzYoEiq;
        "pkg-0.0.9" = _X98XHsO2;
        "pkg-0.0.10" = _o2dJKj3G;
        "pkg-0.0.11" = _MfXv7kp7;
        "pkg-0.0.12" = _3ofQ4OX4;
        "pkg-0.0.13" = _hiC82eyi;
        "pkg-0.0.14" = _yaQx6ysF;
        "pkg-0.0.15" = _HwKsYPx5;
        "pkg-0.0.16" = _q8lMdSVO;
        "pkg-0.0.17" = _aJCHJSEr;
        "pkg-0.0.18" = _5QUuGQhM;
        "pkg-0.0.19" = _K2aQz3hQ;
        "pkg-0.0.20" = _Adr23qLJ;
        "pkg-0.0.21" = _2WXbU73p;
        "pkg-0.0.22" = _jHEtPSmO;
        "pkg-0.0.23" = _1YKNpa4m;
        "pkg-0.0.24" = _mUx0odqQ;
        "pkg-0.0.25" = _kGi2iJnR;
        "pkg-0.0.26" = _XrAowmzP;
        "pkg-0.0.27" = _3YjETXad;
        "pkg-0.0.28" = _MVa1r0SE;
        "pkg-0.0.29" = _pQS7RlGk;
        "pkg-0.0.30" = _Aq2yPcjG;
        "pkg-0.0.31" = _bN9s852X;
        "pkg-0.0.32" = _VZAzNPj8;
        "pkg-0.0.33" = _2qUVscjB;
        "pkg-0.0.34" = _A2VlMEJ0;
        "pkg-0.0.35" = _Lv7fVVCI;
        "pkg-0.0.36" = _tqrdaKB2;
        "pkg-0.0.37" = _gRmtmPM1;
        "pkg-0.0.38" = _Vjh6O2WH;
        "pkg-0.0.39" = _SqS4rVw2;
        "pkg-0.0.40" = _QpFoOODC;
        "pkg-0.0.41" = _6Q24QM39;
        "pkg-0.0.42" = _SejVORHE;
        "pkg-0.0.43" = _odg5gd3H;
        "pkg-0.0.44" = _vuNORer8;
        "pkg-0.0.44+1.21.10" = _1Mm2go9t;
        "pkg-1.0.0+1.21.10" = _P4nPNjG1;
        "pkg-1.1.0+1.21.10" = _Ut7A9max;
        "pkg-1.1.1+26.1.2" = _WpUL6CN8;
        "pkg-1.2.0+26.1.2" = _5338mG1k;
        "pkg-1.3.0+26.1.2" = _szVCXxIv;
        "pkg-1.4.0+26.1.2" = _ytcBTVYg;
        "pkg-1.4.1+26.1.2" = _btePDDhe;
        "pkg-1.4.2+26.2" = _EKya35zM;
        "pkg-1.4.2+26.1.2" = _NAcCIEQf;
        "default" = _NAcCIEQf;
    });
