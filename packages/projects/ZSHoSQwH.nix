...
let
    ...
    in {
        ...
        "pkg-1.21-2.5.0" = _NB0mgd27;
        "pkg-1.21-2.5.1" = _Knrb9MYD;
        "pkg-1.21.1-2.5.2" = _LDxJ0mVU;
        "pkg-1.21.1-2.6.0" = _1MdsjTMO;
        "pkg-1.21.x-2.7.0" = _6tuZrGBN;
        "pkg-1.21.x-2.7.1" = _U0NBN1D1;
        "pkg-1.21.x-2.7.2" = _qwIxcyht;
        "pkg-1.21.x-2.7.3" = _pyMYhJHN;
        "pkg-1.21.x-2.7.4" = _vKjPX6ec;
        "pkg-1.21.x-2.7.5" = _CF5VQBCc;
        "pkg-1.21.x-2.8.0" = _FaUNEgBo;
        "pkg-1.21.x-2.8.1" = _74FaRLTz;
        "pkg-1.21.1-2.8.2" = _UQpx11pM;
        "pkg-1.21.1-2.8.3" = _vcbPYqxv;
        "pkg-1.21.1-2.8.4" = _XlqVFYcb;
        "pkg-1.21.1-2.8.5" = _KbYhs1Mq;
        "pkg-1.21.1-2.8.6" = _tvhNnCWa;
        "pkg-1.21.1-2.8.7" = _aGBUMn7E;
