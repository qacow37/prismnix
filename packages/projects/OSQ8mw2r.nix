...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.19.3" = _bGhxVVas;
        "pkg-1.0.1-1.19.2" = _fiUJwmkX;
        "pkg-1.1.0-1.19.2" = _s3UXlttX;
        "pkg-1.1.0-1.19.3" = _Ho1KRE53;
        "pkg-1.1.0-1.19.4" = _6yRyiiLL;
        "pkg-1.1.0-1.20.x" = _P5LwjQZ1;
        "pkg-1.2.0-1.19.2" = _6l6aea2l;
        "pkg-1.2.0-1.19.3" = _rYijflDk;
        "pkg-1.2.0-1.19.4" = _Z6SvlCPf;
        "pkg-1.2.0-1.20.x" = _GgXnvMPU;
        "pkg-1.2.1-1.19.2" = _GRT5GfJI;
        "pkg-1.2.1-1.19.3" = _k11oWMV0;
        "pkg-1.2.1-1.19.4" = _Yd6Pzwa0;
        "pkg-1.2.1-1.20.x" = _FJnk7qhP;
        "pkg-1.2.2-1.19.2" = _u69b5o1A;
        "pkg-1.2.2-1.19.3" = _zVIq1yhE;
        "pkg-1.2.2-1.19.4" = _xExvGyF0;
        "pkg-1.2.2-1.20.x" = _LLkiKipc;
        "pkg-1.2.3-1.21.0" = _JLYnnbUi;
        "pkg-1.3.0-1.19.2" = _nzvRsqb8;
        "pkg-1.3.0-1.19.3" = _pME1Flib;
        "pkg-1.3.0-1.19.4" = _H9oVbgwM;
        "pkg-1.3.0-1.20.x" = _jaSmwfP2;
        "pkg-1.3.0-1.21-1.21.1" = _EPpyMj2E;
        "pkg-1.3.0-1.21.2-3" = _s42by1MP;
        "pkg-1.3.0-1.21.4" = _uENUGvIY;
        "pkg-1.3.1-1.19.2" = _zVQVXOpW;
        "pkg-1.3.1-1.19.3" = _oLY4Bup3;
        "pkg-1.3.1-1.19.4" = _qNTGekUj;
        "pkg-1.3.1-1.20.x" = _BtbW0JbW;
        "pkg-1.3.2-1.20-1.20.4" = _t5vUyiRo;
        "pkg-1.3.2-1.20.6" = _BW2Nn6qQ;
        "pkg-1.3.2-1.21-1.21.1" = _LEeJnb8j;
        "pkg-1.4.0-1.21.10" = _nik1YtFv;
        "pkg-1.4.1-1.21.11" = _B9iEY7nb;
        "pkg-1.4.2-26.1.1" = _IFzOg4ts;
        "pkg-1.4.2-26.2" = _q9vZmPqg;
        "default" = _q9vZmPqg;
    });
