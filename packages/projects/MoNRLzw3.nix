...
let
    ...
    in {
        ...
        "pkg-1.0.0+fabric-quilt" = _bQiDJdJz;
        "pkg-1.0.0+forge" = _fJ4Xr2Ff;
        "pkg-1.0.1+fabric-quilt" = _CgbDSteL;
        "pkg-1.0.1+forge" = _7l1lXLp9;
        "pkg-1.0.2+fabric-quilt" = _bccIHlHo;
        "pkg-1.0.2+forge" = _aLHtbK0h;
        "pkg-1.0.3+1.18.x+fabric-quilt" = _REjg75kf;
        "pkg-1.0.3+1.18.x+forge" = _fxocdG2T;
        "pkg-1.0.3+1.19.x+fabric-quilt" = _zklxRPJL;
        "pkg-1.0.3+1.19.x+forge" = _OTenqDO3;
        "pkg-1.1.0+1.19.4+fabric-quilt" = _f3sbbSOm;
        "pkg-1.1.0+1.19.4+forge" = _hvEWuuub;
        "pkg-1.2.0+1.19.4+fabric-quilt" = _c2xp7VJq;
        "pkg-1.2.0+1.19.4+forge" = _MoBnLDnS;
        "pkg-2.0.0+1.21.4-fabric" = _K1gmt34L;
        "pkg-2.0.0+1.21.4-neoforge" = _1U6INEVU;
        "pkg-2.0.1+1.21.4-neoforge" = _mBXMFFCr;
        "pkg-2.0.1+1.21.4-fabric" = _cZ0ScBKc;
        "pkg-2.1.0+1.21.4-neoforge" = _aHQIbfNk;
        "pkg-2.1.0+1.21.4-fabric" = _WnfjSQo5;
        "pkg-2.2.0+1.21.9-fabric" = _4W0BtR6k;
