...
let
    ...
    in {
        ...
        "pkg-1.3.8" = _9sDknDi4;
        "pkg-1.3.9" = _gEtYcDuJ;
        "pkg-2.0.0a8" = _YFN2CJwP;
        "pkg-2.0.0a9" = _u1Fc2yIT;
        "pkg-2.0.0a10" = _54T4An4l;
        "pkg-2.0.0a11" = _w815sW0X;
        "pkg-2.0.0a12-1.16.5" = _R02lZmOa;
        "pkg-2.0.0a12-1.18.2" = _zW42CFyq;
        "pkg-2.0.0a12-1.19.4" = _ObUjVfCb;
        "pkg-2.0.0a12-1.20.2" = _IPVK51pp;
        "pkg-2.0.0a13-1.20.2" = _3FGJfgfL;
        "pkg-2.0.0a13-1.16.5" = _y9FKoA7r;
        "pkg-2.0.0a13-1.18.2" = _fBx62IJH;
        "pkg-2.0.0a13-1.19.4" = _VdnI9811;
        "pkg-2.0.0a14-1.20.2" = _NALAZtYA;
        "pkg-2.0.0a14-1.19.4" = _tCpSjwFI;
        "pkg-2.0.0a14-1.18.2" = _ldCiDPWi;
        "pkg-2.0.0a14-1.16.5" = _8U5fZKO0;
        "pkg-2.0.0b1-1.20.2" = _rPJ4YJ28;
        "pkg-2.0.0b1-1.16.5" = _x8uo3Ai7;
        "pkg-2.0.0b1-1.18.2" = _IXaOk0Qx;
        "pkg-2.0.0b1-1.19.4" = _fp6OtUPo;
        "pkg-2.0.0b2-1.20.4" = _UUtAqKB9;
        "pkg-2.0.0b2-1.19.4" = _hWgToA5H;
        "pkg-2.0.0b2-1.18.2" = _yFxCjgPl;
        "pkg-2.0.0b2-1.16.5" = _b9mq7Gct;
        "pkg-2.0.0b3-1.20.4" = _isZOiAgm;
        "pkg-2.0.0b3-1.19.4" = _QnUkWs7t;
        "pkg-2.0.0b3-1.18.2" = _kMPoxNzd;
        "pkg-2.0.0b3-1.16.5" = _Pytjg6PE;
        "pkg-2.0.0b4-1.16.5" = _slENeORh;
        "pkg-2.0.0b4-1.18.2" = _8gYAlMYt;
        "pkg-2.0.0b4-1.19.4" = _CsPwh4SC;
        "pkg-2.0.0b4-1.20.4" = _WaO2Q6aL;
        "pkg-2.0.0b5-1.21" = _6JextPJz;
        "default" = _6JextPJz;
    });
