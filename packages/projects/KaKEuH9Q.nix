...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18" = _G9kkSHUd;
        "pkg-1.0.0+1.19" = _oaGwEqmF;
        "pkg-v1.1.0" = _r5wdSQvI;
        "pkg-1.1.1" = _xC5zwyx9;
        "pkg-v1.1.2" = _LlFt7Z1L;
        "pkg-1.2.0" = _5pPf7J7a;
        "pkg-1.2.1" = _RvO5c0xE;
        "pkg-1.3.0" = _LhPwmLKH;
        "pkg-2.0.0" = _WriM1iS0;
        ...
        "pkg-5.0.0" = _bJL4LePd;
        "pkg-5.0.1" = _5fn53O7J;
        "pkg-v5.0.1" = _lSw9We0h;
        "pkg-v5.1.0-multiloader-fabric" = _ZzZwZFFU;
        "pkg-5.1.0-multiloader-neoforge" = _E52ALlLw;
        "default" = _E52ALlLw;
    });
