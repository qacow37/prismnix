...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.3.2" = _tb2EvNC8;
        "pkg-1.19.4-1.3.2" = _qs7YMHwq;
        "pkg-1.20.1-1.3.2" = _x10JQ1QH;
        "pkg-1.18.2-1.4.0" = _plIrUD9F;
        "pkg-1.19.4-1.4.0" = _EE02HvBZ;
        "pkg-1.20.1-1.4.0" = _19aP7fy4;
        "pkg-1.18.2-1.5.0" = _w1gF0u4j;
        "pkg-1.19.4-1.5.0" = _M0aEvD9C;
        "pkg-1.20.1-1.5.0" = _r5dp8ewb;
        "pkg-1.18.2-1.5.1" = _4OZnrhrD;
        "pkg-1.19.4-1.5.1" = _mshU83JC;
        "pkg-1.20.1-1.5.1" = _YelMFcYr;
        "pkg-1.18.2-1.5.2" = _G30zrgd9;
        "pkg-1.19.4-1.5.2" = _2WMy9E42;
        "pkg-1.20.2-1.5.2" = _9I8lmtWD;
        "pkg-1.20.1-1.5.2" = _7ZMeDXGK;
        "pkg-1.18.2-1.5.3" = _i0SE5MJE;
        "pkg-1.20.2-1.5.3" = _qEMTC8Zc;
        "pkg-1.18.2-1.5.4" = _QLuCPJ5K;
        "pkg-1.20.1-1.5.4" = _JHFRlKpD;
        "pkg-1.18.2-1.5.5" = _61579Zzm;
        "pkg-1.20.1-1.5.5" = _1MUCwx47;
        "pkg-1.20.6-1.5.6" = _31ijTmPl;
        "pkg-1.20.6-1.5.6.b" = _tPgC1w50;
        "pkg-1.21-1.5.6.b" = _tjKiwDQM;
        "pkg-1.21-1.5.7" = _M163MjcA;
        "pkg-1.18.2-2.0.0-fabric" = _hXweka2e;
        "pkg-1.18.2-2.0.0-forge" = _9ZGZE55y;
        "pkg-1.20.1-1.5.8-fabric" = _4INMgdKL;
        "pkg-1.20.1-1.5.8-forge" = _KMNvCerw;
        "pkg-1.21.1-1.5.8-fabric" = _SbSlBBTm;
        "pkg-1.21.1-1.5.8-neoforge" = _g1OVha7G;
        "pkg-1.18.2-2.1.0-fabric" = _vIsXoRmR;
        "pkg-1.18.2-2.1.0-forge" = _AQk0NLbk;
        "pkg-1.20.1-2.1.0-fabric" = _RittN5jB;
        "pkg-1.20.1-2.1.0-forge" = _tk8mvaR7;
        "pkg-1.21.1-2.1.0-fabric" = _ua2nD97o;
        "pkg-1.21.1-2.1.0-neoforge" = _R6Rp4yx5;
        "pkg-1.18.2-2.1.1-fabric" = _Gnp19Rye;
        "pkg-1.18.2-2.1.1-forge" = _WEdyfxmg;
        "pkg-1.20.1-2.1.1-fabric" = _M1pbKNGP;
        "pkg-1.20.1-2.1.1-forge" = _HK8HZiKx;
        "pkg-1.21.1-2.1.1-fabric" = _MjFOEDQl;
        "pkg-1.21.1-2.1.1-neoforge" = _mhAItRTJ;
        "pkg-1.18.2-2.1.2-fabric" = _aR5GAgcr;
        "pkg-1.18.2-2.1.2-forge" = _mDeuWIyd;
        "pkg-1.20.1-2.1.2-fabric" = _zyk3Eqlm;
        "pkg-1.20.1-2.1.2-forge" = _7DR1Z9nZ;
        "pkg-1.21.1-2.1.2-fabric" = _RzZ8FmdL;
        "pkg-1.21.1-2.1.2-neoforge" = _g7fo237z;
        "pkg-1.21.1-2.2.0-fabric" = _51xlgzcM;
        "pkg-1.21.1-2.2.0-neoforge" = _kxJMT5fC;
        "default" = _kxJMT5fC;
    });
