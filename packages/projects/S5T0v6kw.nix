...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _3u0kaNJt;
        "pkg-1.0.0+mod" = _qPJDLo06;
        "pkg-2.0.0" = _WtsL0gNS;
        "pkg-2.0.0+mod" = _7pdjwhql;
        "pkg-2.0.1" = _boyOuug5;
        "pkg-2.0.1+mod" = _jbiay6VQ;
        "pkg-2.0.2" = _h8t5IhX0;
        "pkg-2.1.0" = _hP1XH8tD;
        "pkg-2.1.0+mod" = _hVrReVrP;
        "pkg-3.0.0" = _ne9w2ZR2;
        "pkg-3.0.0+mod" = _LXAi4egw;
        "pkg-4.0.0" = _xoXzpfer;
        "pkg-4.0.0+mod" = _vMFyVml3;
        "pkg-4.0.1" = _zonVGIo0;
        "pkg-4.0.1+mod" = _ec1dtDGx;
        "pkg-4.1.0" = _6kQ9pAt9;
        "pkg-4.1.0+mod" = _VEKl8rXd;
        "pkg-5.0.0" = _1PqjWEJM;
        "pkg-5.0.0+mod" = _EdZFMU2v;
        "pkg-6.0.0" = _icfGrc9L;
        "pkg-6.0.0+mod" = _pi9jF3xq;
        "pkg-6.0.1" = _878r9qtx;
        "pkg-6.0.1+mod" = _Rb2TRDcl;
        "pkg-6.1.0" = _OaeaB6Zz;
        "pkg-6.1.0+mod" = _I8j83YYL;
        "pkg-6.2.0" = _3beZ6PdA;
        "pkg-6.2.0+mod" = _iPSafY4K;
        "pkg-6.2.1" = _MFMcWxWU;
        "pkg-6.2.1+mod" = _Q5LJ8p0R;
        "pkg-6.3.0" = _lpXokYO3;
        "pkg-6.3.0+mod" = _FLpr1Pxg;
        "pkg-6.4.0" = _HGnlhn2H;
        "pkg-6.4.0+mod" = _4MAuVcHf;
        "pkg-6.5.0" = _aEQZBMW4;
        "pkg-6.5.0+mod" = _uPg34HEr;
        "pkg-6.6.0" = _dlZ3HZ35;
        "pkg-6.6.0+mod" = _1xkJzwEY;
        "default" = _1xkJzwEY;
    });
