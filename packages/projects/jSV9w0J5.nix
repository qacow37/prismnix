...
let
    ...
    in {
        ...
        "pkg-v8.0.0-1.20.1-Forge" = _4kpNDQN4;
        "pkg-v8.0.0-1.20.1-Fabric" = _XBem2rhv;
        "pkg-v3.0.0-1.18.2-Forge" = _B6N9QOpJ;
        "pkg-v3.0.0-1.18.2-Fabric" = _LrUDQzbF;
        "pkg-v8.0.1-1.20.1-Forge" = _brRyGqiz;
        "pkg-v8.0.1-1.20.1-Fabric" = _jc1d6k4U;
        "pkg-v3.0.1-1.18.2-Fabric" = _8JqTjhkr;
        "pkg-v3.0.1-1.18.2-Forge" = _YnbR0LO8;
        "pkg-v3.0.2-1.18.2-Fabric" = _cF6hf7v2;
        "pkg-v3.0.2-1.18.2-Forge" = _2T9YyUzW;
        "pkg-v8.0.2-1.20.1-Forge" = _3ScFu52k;
        "pkg-v8.0.2-1.20.1-Fabric" = _ds9ZHz06;
        "pkg-v3.0.3-1.18.2-Fabric" = _3fvnIlgS;
        "pkg-v3.0.3-1.18.2-Forge" = _ijcJEO7Q;
        "pkg-v3.0.4-1.18.2-Fabric" = _COqaRrtQ;
        "pkg-v3.0.4-1.18.2-Forge" = _w74Voujn;
        "pkg-v8.0.3-1.20.1-Forge" = _uvQh39dn;
        "pkg-v8.0.3-1.20.1-Fabric" = _9qIYgSXZ;
        "pkg-v3.0.5-1.18.2-Fabric" = _xOlNsNkv;
        "pkg-v3.0.5-1.18.2-Forge" = _5Po3kzsu;
        "pkg-v8.0.4-1.20.1-Forge" = _igsUQy9R;
        "pkg-v8.0.4-1.20.1-Fabric" = _LlLRdJcg;
        "pkg-v20.4.0-1.20.4-Fabric" = _YI1HAeGS;
        "pkg-v20.4.0-1.20.4-Forge" = _pmBpV7Fv;
        "pkg-v20.4.0-1.20.4-NeoForge" = _K2ygIKp4;
        "pkg-v20.4.1-1.20.4-Fabric" = _SOENKl4O;
        "pkg-v20.4.1-1.20.4-Forge" = _ehuiTy3y;
        "pkg-v20.4.1-1.20.4-NeoForge" = _3UAH96lE;
        "pkg-v20.4.2-1.20.4-Fabric" = _W0RORyxT;
        "pkg-v20.4.2-1.20.4-Forge" = _1K79B2UZ;
        "pkg-v20.4.2-1.20.4-NeoForge" = _OjwfM0Ij;
        "pkg-v8.0.5-1.20.1-Forge" = _wPqH0RfQ;
        "pkg-v8.0.5-1.20.1-Fabric" = _GNRbymwI;
        "pkg-v20.4.3-1.20.4-Fabric" = _cQvvBiQA;
        "pkg-v20.4.3-1.20.4-Forge" = _4UcBtBFx;
        "pkg-v20.4.3-1.20.4-NeoForge" = _luZgcQCj;
        "pkg-v21.1.0-1.21.1-Fabric" = _o6Tot1fI;
        "pkg-v21.1.0-1.21.1-NeoForge" = _ATitYW3Y;
        "pkg-v8.0.6-1.20.1-Fabric" = _jDTECOMb;
        "pkg-v8.0.6-1.20.1-Forge" = _DMn6ktl4;
        "pkg-v3.0.6-1.18.2-Fabric" = _eOKN1fF4;
        "pkg-v3.0.6-1.18.2-Forge" = _TjGDKYex;
        "pkg-v21.1.1-1.21.1-Fabric" = _xRlHucSY;
        "pkg-v21.1.1-1.21.1-NeoForge" = _kvAX1cc4;
        "pkg-v21.1.2-1.21.1-Fabric" = _U4vRnaGx;
        "pkg-v21.1.2-1.21.1-NeoForge" = _XxHRkoo9;
        "pkg-v21.3.0-1.21.3-Fabric" = _8GiQl5Z9;
        "pkg-v21.3.0-1.21.3-NeoForge" = _nfRmYw16;
        "pkg-v21.4.0-1.21.4-Fabric" = _oO1hcdtf;
        "pkg-v21.4.0-1.21.4-NeoForge" = _TJKkhL8m;
        "pkg-v21.4.1-1.21.4-Fabric" = _4IH1cPuk;
        "pkg-v21.4.1-1.21.4-NeoForge" = _VqFz4Slz;
        "pkg-v21.1.3-1.21.1-Fabric" = _aF0KTZ5i;
        "pkg-v21.1.3-1.21.1-NeoForge" = _IoAVAWRO;
        "pkg-v8.0.7-1.20.1-Forge" = _h3xEIiW8;
        "pkg-v8.0.7-1.20.1-Fabric" = _tdl5EQxi;
        "pkg-v21.1.4-1.21.1-Fabric" = _jS1WxBhj;
        "pkg-v21.1.4-1.21.1-NeoForge" = _zVhqThI8;
        "pkg-v21.5.0-1.21.5-Fabric" = _MuzsWKJp;
        "pkg-v21.5.0-1.21.5-NeoForge" = _RjNXiQHD;
        "pkg-v21.5.1-1.21.5-Fabric" = _8Y5DpEzp;
        "pkg-v21.5.1-1.21.5-NeoForge" = _iOPtcICB;
        "pkg-v21.5.2-1.21.5-Fabric" = _bHn5F8vm;
        "pkg-v21.5.2-1.21.5-NeoForge" = _WjHv76WF;
        "pkg-v21.5.3-1.21.5-Fabric" = _mjeYWYzy;
        "pkg-v21.5.3-1.21.5-NeoForge" = _aooSI67X;
        "pkg-v21.1.5-1.21.1-Fabric" = _NkpAEJYk;
        "pkg-v21.1.5-1.21.1-NeoForge" = _6u2ZDGH4;
        "pkg-v21.1.6-1.21.1-Fabric" = _rfLsSsrL;
        "pkg-v21.1.6-1.21.1-NeoForge" = _9bEpNrvK;
        "pkg-v21.7.0-1.21.7-Fabric" = _eaM2TZtZ;
        "pkg-v21.7.0-1.21.7-NeoForge" = _XN25iUnx;
        "pkg-v21.8.0-1.21.8-Fabric" = _dNxbhpHR;
        "pkg-v21.8.0-1.21.8-NeoForge" = _P1NeZd7s;
        "pkg-v21.8.1-1.21.8-Fabric" = _UPyeWymw;
        "pkg-v21.8.1-1.21.8-NeoForge" = _zXbjo5Vy;
        "pkg-v21.8.2-1.21.8-Fabric" = _gIUJAqBK;
        "pkg-v21.8.2-1.21.8-NeoForge" = _3HMQVpUl;
        "pkg-21.10.0" = _pfZe2MTB;
        "pkg-21.9.0" = _tc3065Ay;
        "pkg-21.11.0" = _6Hk4HBnY;
        "pkg-21.11.1" = _yvVMFPsK;
        "pkg-26.1.0" = _Rl9dfKjx;
        "pkg-26.2.0" = _1EML9Osa;
        "default" = _1EML9Osa;
    });
