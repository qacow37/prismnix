...
let
    ...
    in {
        ...
        "pkg-1.2.6" = _HLS46ZGh;
        "pkg-1.2.7" = _f6J1Lr1v;
        "pkg-1.2.7.5" = _x94437h2;
        "pkg-1.2.8" = _qA2Q7KXq;
        "pkg-1.2.8.1" = _5aSBwKW6;
        "pkg-b1.2.8.2" = _jeEfIAeO;
        "pkg-b1.2.8.3" = _NwYkoULE;
        "pkg-1.2.9" = _BFa5Ee6m;
        "pkg-a1.2.9.1" = _o3KsUnms;
        "pkg-b1.2.9.2" = _yJzjgSGN;
        "pkg-1.2.9.2" = _sYAVpfp5;
