...
let
    ...
    in {
        ...
        "pkg-1.0.0-neoforge-yarn+1.21.1" = _WTOcpSGu;
        "pkg-1.0.0-neoforge-mojmap+1.21.1" = _ZuHNwjBs;
        "pkg-1.0.0-fabric-yarn+1.21.1" = _rrAotWe9;
        "pkg-1.0.0-fabric-mojmap+1.21.1" = _O3GTSmdW;
        "pkg-1.0.1-neoforge-yarn+1.21.1" = _zd48FOS0;
        "pkg-1.0.1-fabric-yarn+1.21.1" = _7OA7RBqI;
        "pkg-1.0.1-neoforge-mojmap+1.21.1" = _WOuF3mec;
        "pkg-1.0.1-fabric-mojmap+1.21.1" = _PmS4QUv6;
        "pkg-1.0.2-fabric-yarn+1.21.1" = _XSiGTkb7;
        "pkg-1.0.2-neoforge-yarn+1.21.1" = _MGIiciMo;
        "pkg-1.0.2-neoforge-mojmap+1.21.1" = _4TCgXbC4;
        "pkg-1.0.2-fabric-mojmap+1.21.1" = _vcdInHTN;
        "pkg-1.0.3-fabric-yarn+1.21.1" = _ed1oXzIa;
        "pkg-1.0.3-neoforge-mojmap+1.21.1" = _hYcwFb2r;
        "pkg-1.0.3-neoforge-yarn+1.21.1" = _WTxhrAJs;
        "pkg-1.0.3-fabric-mojmap+1.21.1" = _Eimr8O2E;
        "pkg-1.1.0-fabric-yarn+1.21.1" = _JItmD4yJ;
        "pkg-1.1.0-neoforge-yarn+1.21.1" = _vH6bQZrJ;
        "pkg-1.1.0-neoforge-mojmap+1.21.1" = _mKA9XOZO;
        "pkg-1.1.0-fabric-mojmap+1.21.1" = _3KvNTP8H;
        "pkg-1.1.1-fabric-yarn+1.21.1" = _MLoPrWZz;
        "pkg-1.1.1-neoforge-mojmap+1.21.1" = _b9YaXCU1;
        "pkg-1.1.1-neoforge-yarn+1.21.1" = _g860aMc1;
        "pkg-1.1.1-fabric-mojmap+1.21.1" = _1k0bbRZF;
        "pkg-1.1.2-fabric-yarn+1.21.1" = _s5Xg1UpI;
        "pkg-1.1.2-neoforge-yarn+1.21.1" = _uzeObHVq;
        "pkg-1.1.2-neoforge-mojmap+1.21.1" = _1Z0Uv6j6;
        "pkg-1.1.2-fabric-mojmap+1.21.1" = _n2Xxe0xQ;
        "pkg-1.2.0-fabric-yarn+1.21.1" = _u55Ji24d;
        "pkg-1.2.0-neoforge-yarn+1.21.1" = _1zOwTChA;
        "pkg-1.2.0-neoforge-mojmap+1.21.1" = _X2ENJnB7;
        "pkg-1.2.0-fabric-mojmap+1.21.1" = _7BaTCWIs;
        "pkg-1.2.0-fabric-yarn+1.20.1" = _WcchdBCR;
        "pkg-1.2.0-fabric-mojmap+1.20.1" = _VAPMqIxJ;
        "pkg-1.3.0-neoforge-yarn+1.21.1" = _k2l4ZooG;
        "pkg-1.3.0-fabric-yarn+1.21.1" = _XqOhGrQA;
        "pkg-1.3.0-fabric-yarn+1.20.1" = _H6Wpj3Qe;
        "pkg-2.0.0-fabric-yarn+1.21.1" = _Y3DumrMC;
        "pkg-2.0.0-neoforge-yarn+1.21.1" = _QBhPTHHq;
        "pkg-2.0.0-fabric-yarn+1.20.1" = _B6ZniERJ;
        "pkg-2.0.1-fabric-yarn+1.20.1" = _ivbyWaXF;
        "pkg-2.0.1-fabric-yarn+1.21.1" = _i34cmD18;
        "pkg-2.0.1-neoforge-yarn+1.21.1" = _u5KsFdsP;
        "pkg-2.0.3-fabric-yarn+1.21.1" = _tpJuELiN;
        "pkg-2.0.3-fabric-yarn+1.20.1" = _azti55cr;
        "pkg-2.0.3-neoforge-yarn+1.21.1" = _i7XQRfHE;
        "pkg-2.1.1-fabric-yarn+1.20.1" = _MFl3s4J2;
        "pkg-2.1.1-fabric-yarn+1.21.1" = _G2OiH5Zc;
        "pkg-2.1.1-neoforge-yarn+1.21.1" = _gy8qiH4M;
        "pkg-2.1.2-neoforge-yarn+1.21.1" = _Lhybxu2T;
        "pkg-2.1.2-fabric-yarn+1.20.1" = _rI4RJpsP;
        "pkg-2.1.2-fabric-yarn+1.21.1" = _pT4BPJms;
        "pkg-2.1.3-fabric-yarn+1.20.1" = _gT9xMQMr;
        "pkg-2.1.3-fabric-yarn+1.21.1" = _udL2iffm;
        "pkg-2.1.3-neoforge-yarn+1.21.1" = _JmtEMLrX;
        "pkg-2.2.0-fabric-yarn+1.21.1" = _dsXPAYeT;
        "pkg-2.2.0-fabric-yarn+1.20.1" = _hJV8yUJ4;
        "pkg-2.2.0-neoforge-yarn+1.21.1" = _zNl7RSkU;
        "pkg-2.2.1-fabric-yarn+1.21.1" = _Wp8al9LX;
        "pkg-2.2.1-fabric-yarn+1.20.1" = _gZNLFVKd;
        "pkg-2.2.1-neoforge-yarn+1.21.1" = _tvosOlUn;
        "pkg-2.2.2-neoforge-yarn+1.21.1" = _Wq1MDsvR;
        "pkg-2.2.2-neoforge-yarn+1.21.3" = _XgvPArH3;
        "pkg-2.2.2-fabric-yarn+1.21.1" = _qAube1i6;
        "pkg-2.2.2-fabric-yarn+1.21.3" = _XaFKiUkL;
        "pkg-2.2.2-fabric-yarn+1.20.1" = _Bk5u5Fuf;
        "pkg-2.2.3-neoforge-yarn+1.21.1" = _xGCKxdz0;
        "pkg-2.2.3-fabric-yarn+1.21.3" = _zWgk0cOy;
        "pkg-2.2.3-neoforge-yarn+1.21.3" = _nUx7chD1;
        "pkg-2.2.3-fabric-yarn+1.21.1" = _BWHYM48e;
        "pkg-2.2.3-fabric-yarn+1.20.1" = _Hqxe5vgj;
        "pkg-3.0.0" = _xpMkLQS6;
        "pkg-3.0.1" = _6HNIiGiM;
        "pkg-3.0.2" = _WSIeS6wr;
        "pkg-3.1.0" = _VJxTKFmN;
        ...
        "pkg-3.2.8" = _uoXusdPI;
        "pkg-3.2.9" = _b4QImeus;
        "pkg-3.2.10" = _PiSkmHuz;
        "pkg-3.2.11" = _tD94HVpF;
        "pkg-3.2.12" = _1K0bZ70c;
        "pkg-3.3.0" = _LjvY1SWw;
        "pkg-3.3.1" = _6Hd4TzEF;
        "pkg-3.3.2" = _jIjsSVfP;
        "pkg-3.4.0" = _ZkjxwYFg;
