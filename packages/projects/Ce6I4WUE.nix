...
let
    ...
    in {
        ...
        "pkg-9.1.1.1031" = _gqJMEABX;
        "pkg-9.2.4.103" = _wukmoSeF;
        "pkg-9.3.5.206" = _4QWCUteA;
        "pkg-9.6.9.367" = _ruRBKgwc;
        "pkg-9.8.3.390" = _KIzASRO5;
        "pkg-9.9.3.394" = _dZZ4j18G;
        "pkg-9.10.9.422" = _4IEoyWzh;
        "pkg-10.0.9.432" = _IDjtJsDR;
        "pkg-10.0.17.444" = _ZrS7qENE;
        "pkg-10.0.19.446" = _nDxFueG2;
        "pkg-10.1.2.457" = _DlhxRTKL;
        "pkg-10.2.0.459" = _atcAq1UT;
        "pkg-10.2.1.461" = _Pz4thLN2;
        "pkg-10.2.2.462" = _ppz3xziS;
        "pkg-10.2.3.463" = _g74zfl0m;
        "pkg-10.2.4.464" = _RGlXXgcD;
        "pkg-10.2.5.465" = _zWt8Aemn;
        "pkg-10.3.0.467" = _zLHaraw3;
        "pkg-10.3.1.468" = _yDOSRo2r;
        "pkg-10.3.2.469" = _6zqf3EGe;
        "pkg-10.3.3.470" = _OFopgIFW;
        "pkg-10.3.4.471" = _xKRR7R7a;
        "pkg-10.3.5.473" = _RBifwW3R;
        "pkg-10.3.6.475" = _TAyUJAKw;
        "pkg-10.3.7.476" = _X58zIngK;
        "pkg-10.3.8.477" = _CgFgCgTf;
        "pkg-10.3.9.13" = _yj7d33HE;
        "pkg-10.4.0.14" = _MLG4wWo6;
        "pkg-10.4.1.15" = _W5PUUWt9;
        "pkg-10.4.2.16" = _GxZSvUQi;
        "pkg-10.4.4.18" = _5fXP0XBe;
        "pkg-10.4.5.19" = _52nOMLHi;
        "pkg-10.4.6.20" = _gNIc57RO;
        "pkg-10.5.1.23" = _eVOeDNA3;
        "pkg-10.5.2.24" = _aYZg5gr4;
        "pkg-10.5.3.25" = _ITHqRXF6;
        "pkg-10.5.4.26" = _H8bgSedJ;
        "pkg-10.5.5.27" = _JzPscbhA;
        "pkg-10.5.6.28" = _nKXR4Epk;
        "pkg-10.5.7.29" = _JorNeGyn;
        "pkg-10.5.8.30" = _SsMYCLyo;
        "pkg-10.5.10.32" = _ymNS7Xu4;
        "pkg-10.5.11.33" = _b6FomViI;
        "pkg-10.5.12.34" = _294wJ15t;
        "pkg-10.5.13.35" = _TRHlTRLN;
        "pkg-10.5.15.36" = _yIGbm770;
        "pkg-10.5.16.37" = _qb6SolDK;
        "pkg-10.5.17.38" = _POJlYRhY;
        "pkg-10.5.18.39" = _L8Ew5o4z;
        "pkg-10.5.19.40" = _Tk6qda6I;
        "pkg-10.5.20.41" = _CzRJjYwn;
        "pkg-10.4.7.42" = _pMSK4H9M;
        "pkg-10.4.8.43" = _VT5mybN7;
        "pkg-10.6.0.44" = _3uqZ9TUK;
        "pkg-10.6.1.45" = _bmewZnUP;
        "pkg-10.6.2.46" = _Lu1y7Y2N;
        "pkg-10.6.3.49" = _2Xnt7wI1;
        "pkg-10.6.4.50" = _jxR9mmIK;
        "pkg-10.6.4.51" = _qoCxT7er;
        "pkg-10.6.5.52" = _PxEwvOp3;
        "pkg-10.6.6.53" = _2hyn7vRw;
        "pkg-10.6.7.54" = _eRWrmuPG;
        "pkg-10.7.0.55" = _bugM0vYQ;
        "pkg-10.7.1.56" = _iPywG4n7;
        "pkg-10.7.1.57" = _ggHjI6Hl;
        "pkg-10.7.2.58" = _qXWWyqUl;
        "pkg-10.7.3.59" = _CGTqtBV4;
        "pkg-10.7.4.60" = _Aq2W4yx3;
        "pkg-10.4.9.61" = _CteEUDph;
        "pkg-10.7.5.62" = _UMprSHX6;
        "pkg-10.7.6.63" = _ywmOhWph;
        "pkg-10.7.7.64" = _bAChHEOV;
        "pkg-10.4.10.66" = _rNRR6VR1;
        "pkg-10.4.11.67" = _iqbGHzp7;
        "pkg-10.4.12.68" = _8gSCgGlf;
        "pkg-10.4.13.69" = _oqvPeKdC;
        "pkg-10.7.8.70" = _U5ODDMgp;
        "pkg-10.4.14.71" = _qQBJK65g;
        "pkg-10.7.9.72" = _OtmG8aAS;
        "pkg-10.7.10.73" = _7JzgOwrY;
        "pkg-10.4.15.75" = _9iboPfea;
        "pkg-10.7.11.76" = _BZM7yAZV;
        "pkg-10.7.12.77" = _XdoAtefU;
        "pkg-10.7.13.78" = _EvKSX4uE;
        "pkg-10.7.14.79" = _nWsUKZBo;
        "pkg-10.4.16.80" = _uxe1WQp4;
        "pkg-10.7.15.81" = _zcaMNWl7;
        "pkg-10.7.16.82" = _JpDlMCsB;
        "pkg-10.7.17.83" = _D32JUF51;
        "pkg-10.7.18.84" = _yY7vZB47;
        "pkg-10.7.19.85" = _5KzzycBT;
        "default" = _5KzzycBT;
    });
