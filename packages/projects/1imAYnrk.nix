...
let
    ...
    in {
        ...
        "pkg-1.3.4" = _MekpRb3J;
        "pkg-1.3.5" = _aI22NA1F;
        "pkg-1.3.5-bugfix" = _szBtxaGG;
        "pkg-1.4" = _eCcnyGxJ;
        "pkg-1.4.1" = _gC9SvvIC;
        "pkg-1.4.2" = _mFXgjAcu;
        "pkg-1.4.2-bugfix" = _xEHACHjh;
        "pkg-1.4.3" = _zuhWZxdg;
        "pkg-1.5" = _aomHeC0C;
        "pkg-1.5.1" = _yMH41Byz;
        "pkg-1.5.2" = _506ZpuVP;
        ...
        "pkg-1.7.1" = _Ompk282D;
        "pkg-1.7.2" = _SmVvHcBI;
        "pkg-2.0-beta.1" = _5Y37oqRK;
        "pkg-2.0-beta.2" = _jSayUUR5;
        "pkg-2.0-beta.3" = _Rlo0EL26;
        "pkg-2.0" = _QAfAoOBC;
        "pkg-2.0.1" = _AshIOIAO;
        "pkg-2.0.2" = _Sdxd2c4A;
        "pkg-2.1" = _3yg6DQv2;
        ...
        "pkg-3.3.3" = _skRCfxMV;
        "pkg-3.4" = _NFedFEhp;
        "pkg-3.4-bugfix" = _wlNF5dl7;
        "pkg-3.4.1" = _mUGBgUM7;
        "pkg-3.4.1-bugfix" = _N06YHVPe;
        "pkg-4.0.0-beta.1" = _stdZ8kxs;
        "pkg-4.0.0-beta.2" = _2wplY01H;
        "pkg-4.0.0-beta.3" = _ATi5X0Hy;
        "pkg-4.0.0-beta.3-bugfix" = _95zArzbE;
        "pkg-4.0.0-beta.4" = _eO76LDzo;
        "pkg-4.0.0-beta.5" = _V7ne4qsq;
        "pkg-4.0.0-beta.5-bugfix" = _A0sNMjgK;
        "pkg-4.0.0-beta.5-bugfix.2" = _3XVTWtOb;
        "pkg-4.0.0-beta.5-bugfix.3" = _tJY9nHLT;
        "pkg-4.0.0-beta.6" = _WZ0Cj96V;
        "default" = _WZ0Cj96V;
    });
