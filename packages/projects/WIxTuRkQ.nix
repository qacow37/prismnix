...
let
    ...
    in {
        ...
        "pkg-1.1.0.2" = _z2itZTmB;
        "pkg-1.1.0.3" = _tYiRLSu7;
        "pkg-1.1.0.4" = _JTNU6a02;
        "pkg-1.1.0.5" = _lrA9JSy5;
        "pkg-1.1.0.15" = _pkOdOQrp;
        "pkg-1.1.1.14" = _pvB0Yc9z;
        "pkg-1.1.2.15" = _tiegSRm0;
        "pkg-1.1.2.16" = _5dSmQf4b;
        "pkg-2.0.1.24" = _GUlbfxBR;
        "pkg-2.1.3.32" = _zOzKVg9a;
        "pkg-2.1.3.34" = _YrAiGjJ2;
        "pkg-2.1.3.47" = _GfcplH6y;
        "pkg-2.1.3.49" = _lOgeloaZ;
        "pkg-2.1.3.51" = _noEf1JZh;
        "pkg-2.1.3.52" = _r4kzSdN0;
        "pkg-2.1.4.54" = _k1qIS0dB;
        "pkg-2.1.4.55" = _L0GOy2fG;
        "pkg-2.2.0.59" = _in8APUmh;
        "pkg-2.3.0.61" = _QKdSz8SV;
        "pkg-2.3.0.63" = _nLfWimNW;
        "pkg-2.5.0.70" = _jR3FVkBO;
        "pkg-2.5.0.73" = _ZZjSSA4F;
        "pkg-2.5.1.77" = _YCT40chu;
        "pkg-2.5.2.81" = _h2MpqhBj;
        "pkg-2.6.0.82" = _Vhwd7QUg;
        "pkg-2.6.0.86" = _6UBwF7LA;
        "pkg-2.7.0.87" = _6OKf4vaD;
        "pkg-2.8.0.88" = _RK1vpN1P;
        "pkg-2.8.0.89" = _PiqAKVGU;
        "pkg-2.7.0.90" = _Dny2JbNR;
        "default" = _Dny2JbNR;
    });
