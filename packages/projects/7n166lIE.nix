...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.16.5" = _NpIUsBtV;
        "pkg-1.0.0-1.18.2" = _6993s2DD;
        "pkg-1.0.0-1.20" = _yaCo0Gcg;
        "pkg-1.0.0-1.20.1" = _kGD3OuJ6;
        "pkg-1.0.0-1.20.2" = _8ODAGWPe;
        "pkg-1.0.0-1.20.3" = _a7UP9ELk;
        "pkg-1.0.0-1.20.4" = _wrs5jGox;
        "pkg-1.1.1-1.16.5" = _My4TOH70;
        "pkg-1.1.1-1.18.2" = _37xTozF5;
        "pkg-1.1.1-1.20" = _zLxoI9AA;
        "pkg-1.1.1-1.20.1" = _HEB1bVz3;
        "pkg-1.1.1-1.20.2" = _AMPAHegt;
        "pkg-1.1.1-1.20.3" = _KZQBGc6a;
        "pkg-1.1.1-1.20.4" = _KScSCraR;
        "pkg-1.1.2-1.16.5" = _HNWi2RcR;
        "pkg-1.1.2-1.18.2" = _FFoxBHxD;
        "pkg-1.1.2-1.19.2" = _c7rBdlqG;
        "pkg-1.1.2-1.20" = _FMSarzB0;
        "pkg-1.1.2-1.20.1" = _lhtCc89c;
        "pkg-1.1.2-1.20.2" = _Sf5Xen9x;
        "pkg-1.1.2-1.20.3" = _bFhi2zjS;
        "pkg-1.1.2-1.20.4" = _gYow4hcm;
        "pkg-1.1.2-1.21" = _EskNADZD;
        "default" = _EskNADZD;
    });
