...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _S6BOmmVN;
        "pkg-1.0.1" = _vUyFcsMj;
        "pkg-1.0.2+1.20" = _3hDV2rga;
        "pkg-1.0.2+1.20.2" = _YhoRf86l;
        "pkg-1.0.3+1.20" = _nhppImui;
        "pkg-1.0.3+1.20.2" = _1iM14CFN;
        "pkg-1.1.0+1.20.1" = _9FtdyZ8d;
        "pkg-1.2.0+1.20.1" = _ttf4n9oy;
        "pkg-1.2.1+1.20.1" = _RWYdO2Tg;
        "pkg-1.2.2+1.20.1" = _QP0PTm08;
        "pkg-1.3.0" = _nacVnTG4;
        "pkg-1.3.1" = _W564xwbj;
        "pkg-1.4.0+1.20+A" = _VnbGSTKN;
        "pkg-1.4.0+1.21+A" = _n2BQqy0B;
        "pkg-1.4.0+1.21.6+A" = _jYpctzm7;
        "pkg-1.4.0+1.21.9+A" = _6t0WHetd;
        "pkg-1.4.0+1.21.11+A" = _t5c6iyhN;
        "pkg-1.4.1+1.20+A" = _y2RZZ51g;
        "pkg-1.4.1+1.21+A" = _ob3tE9E1;
        "pkg-1.4.1+1.21.6+A" = _BIvbrZoI;
        "pkg-1.4.1+1.21.9+A" = _SGbKSEkp;
        "pkg-1.4.1+1.21.11+A" = _CbVq05Sc;
        "pkg-1.4.2+1.20+A" = _BdOlf96X;
        "pkg-1.4.2+1.21+A" = _9lvGZg1W;
        "pkg-1.4.2+1.21.6+A" = _4oEcr4tI;
        "pkg-1.4.2+1.21.9+A" = _a1Jr4Qbl;
        "pkg-1.4.2+1.21.11+A" = _rzyGJOQw;
        "pkg-1.4.2+26.1+A" = _egYkTIvR;
        "pkg-1.4.3+1.20+A" = _QovgW5kU;
        "pkg-1.4.3+1.21+A" = _PLTV0lkA;
        "pkg-1.4.3+1.21.6+A" = _bEFB25ea;
        "pkg-1.4.3+1.21.9+A" = _Zl6Ru0Ts;
        "pkg-1.4.3+1.21.11+A" = _hcLj5pbL;
        "pkg-1.4.3+26.1+A" = _6f4biaEK;
        "pkg-1.4.3+26.2+A" = _HJrxKOOb;
        "pkg-1.4.4+1.20+A" = _9HHIYIxr;
        "pkg-1.4.4+1.21+A" = _rClUmw37;
        "pkg-1.4.4+1.21.6+A" = _CKCFuThJ;
        "pkg-1.4.4+1.21.9+A" = _dPPTet1p;
        "pkg-1.4.4+1.21.11+A" = _2pyq82B3;
        "pkg-1.4.4+26.1+A" = _X2MxDcEB;
        "pkg-1.4.4+26.2+A" = _Z8GYHxx5;
        "default" = _Z8GYHxx5;
    });
