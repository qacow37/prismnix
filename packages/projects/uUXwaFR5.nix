...
let
    ...
    in {
        ...
        "pkg-1.19.4-0.1" = _X8PgOJfV;
        "pkg-1.20-0.1" = _z12rkRXb;
        "pkg-1.20.1-0.1" = _pzb1gIjp;
        "pkg-1.20.2-0.1" = _H7ytubB0;
        "pkg-1.20.3-0.1" = _E9lF97bk;
        "pkg-1.20.4-0.1" = _THvGqkHX;
        "pkg-1.20.6-0.1" = _d8Ik7tta;
        "pkg-1.20.5-0.1" = _FpISeMs1;
        "pkg-1.21-0.1" = _fHSLSLJw;
        "pkg-1.21-0.2" = _1MHv4zK9;
        "pkg-1.20.6-0.2" = _mzjSuFva;
        "pkg-1.20.5-0.2" = _2NQZlcAM;
        "pkg-1.21.1-0.1" = _xjlCjTdF;
        "pkg-1.21-0.3" = _tBfOBKvH;
        "pkg-1.21.1-0.2" = _6fqnPL6Z;
        "pkg-1.21.3-0.1" = _4ifKu0EX;
        "pkg-1.21.4-0.1" = _g02Vze95;
        "pkg-1.21.4-0.2" = _AwF19g05;
        "pkg-1.21-0.4" = _ybXrdYHF;
        "pkg-1.21.1-0.3" = _BloCyCgF;
        "pkg-1.21.3-0.2" = _MGa0vlBc;
        "pkg-1.21.4-0.3" = _SEGdlcz2;
        "pkg-1.21.4-0.4" = _sIRwK86T;
        "pkg-1.21.3-0.3" = _oh6GPYi3;
        "pkg-1.21.1-0.4" = _mdkuAsGL;
        "pkg-1.21-0.5" = _kDfwW2lw;
        "pkg-1.21.5-0.1" = _j1TL7sHe;
        "pkg-1.21.5-0.2" = _4V4sizdr;
        "pkg-1.21.6-0.1" = _tkEf5mJU;
        "pkg-1.21.7-0.1" = _kGlaj3FW;
        "pkg-1.21.8-0.1" = _dly5yqXg;
        "pkg-1.21.9-0.1" = _qFiDzW9M;
        "pkg-1.21.10-0.1" = _RvddfF9X;
        "pkg-1.21.11-0.1" = _zSuSx6lh;
        "pkg-26.1.2-0.1" = _4XV1foCB;
