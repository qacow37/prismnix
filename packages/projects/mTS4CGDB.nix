...
let
    ...
    in {
        ...
        "pkg-4.6.5" = _j4eaEJfx;
        "pkg-4.6.6" = _87MqAkGy;
        "pkg-5.0.0a1" = _Z5QtLizV;
        "pkg-5.0.0a2" = _4DQEEtHU;
        "pkg-5.0.0a3" = _679TmXNf;
        "pkg-5.0.0" = _b4ru90xz;
        "pkg-5.1.0b1" = _shwufYwn;
        "pkg-5.1.0" = _v8mZ4doQ;
        "pkg-5.2.0b1" = _kkyQ40OT;
        "pkg-5.2.0b2" = _OdfTyvla;
        "pkg-5.2.0" = _2FpOxbwZ;
        "pkg-6.0.0b1" = _QiM85W1J;
        "pkg-6.0.0b2" = _DXV5W6fo;
        "pkg-6.0.0" = _djWxz68Z;
        "pkg-6.1.0b1" = _KEhoqPxh;
        "pkg-6.1.0b2" = _9dwLuJ2f;
        "pkg-6.1.0b4" = _pRo0ZDIV;
        "pkg-6.1.0" = _2ieDbI0I;
        "pkg-6.1.1" = _sGfd8vCd;
        "pkg-6.1.0-backport1" = _v1pMFg0X;
        "pkg-6.1.0-backport2" = _EHDjTjzS;
        "pkg-6.2.1" = _Un4WNfmd;
        "pkg-6.2.2" = _GYIlJcuD;
        "pkg-6.3.0" = _oUDVauFp;
        "pkg-6.3.1" = _EK1rowU3;
