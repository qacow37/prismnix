...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.19.2" = _QIVFM96J;
        "pkg-1.0.0-1.19.3" = _TAiRWSKG;
        "pkg-1.0.1-1.19.2" = _zh1R2GFd;
        "pkg-1.0.1-1.19.3" = _kw1zGqv7;
        "pkg-1.0.2-1.19.2" = _pxY8Q0Us;
        "pkg-1.0.2-1.19.3" = _sWb0bSAK;
        "pkg-1.0.2-1.19.4" = _2ILumWtR;
        "pkg-1.0.2-1.20" = _3k001iX1;
        "pkg-1.0.21-1.20" = _gAKBXMvr;
        "pkg-1.0.3-1.19.2" = _Qu8MLdVY;
        "pkg-1.0.3-1.19.3" = _KMoSdyxp;
        "pkg-1.0.3-1.19.4" = _VPVN2sow;
        "pkg-1.0.3-1.20" = _1rMgt1qH;
        "pkg-1.0.31-1.19.2" = _Wp0LGg5K;
        "pkg-1.0.31-1.19.3" = _RKJXDGqC;
        "pkg-1.0.31-1.19.4" = _v5xEYjaM;
        "pkg-1.0.31-1.20" = _APuXQV9e;
        "pkg-1.0.31" = _e1YdNCZK;
        "pkg-1.0.31-1.20.4" = _xUM8WipC;
        "pkg-1.0.31-1.21.1" = _D69xE9wP;
        "pkg-1.0.35-1.21.1" = _c2CFZznV;
        "pkg-1.0.36-1.21.1" = _kl1mYkiA;
        "pkg-1.0.37-1.21.1" = _VlUDE58i;
        "pkg-1.0.37-1.21.5" = _awcZtN2N;
        "pkg-1.0.37-1.21.6" = _Z0Rh35RC;
        "pkg-1.0.37-1.21.10" = _Uu5zg27r;
        "pkg-1.0.37-1.21.11" = _5QjGLOBE;
        "pkg-1.0.37-26.1.X" = _WHb5koNC;
        "default" = _WHb5koNC;
    });
