...
let
    ...
    in {
        ...
        "pkg-1.4.57" = _M2G5yWMw;
        "pkg-1.4.69" = _Gt4ohwGH;
        "pkg-1.4.84" = _SaOHo2Ac;
        "pkg-1.4.92" = _Tf6oYaBi;
        "pkg-1.3.7" = _NLwOaUCY;
        "pkg-1.4.0" = _cI14KY8A;
        "pkg-1.4.79" = _TlRTHOcb;
        "pkg-1.4.93" = _b0lLyrj4;
        "pkg-1.4.94" = _ETN6NJeX;
        "pkg-1.4.95" = _bbLp1MTl;
        "pkg-1.4.96-1.19.3" = _PEqJJf7p;
        "pkg-1.4.96" = _TztzKSn1;
        "pkg-1.4.97" = _851myNB3;
        "pkg-1.4.99" = _thiwdAPM;
        "pkg-1.4.100" = _PPDW5VS3;
        "pkg-1.4.101" = _p5SN7luf;
        "pkg-1.4.102" = _w5MuY9RY;
        "pkg-1.4.103" = _epPEOe1L;
        "pkg-1.4.104" = _jaoOesfu;
        "pkg-1.4.105" = _JFhFYCx9;
        "pkg-1.4.106" = _6Cw5YqjL;
        "pkg-1.4.107" = _vF0L9Oob;
        "pkg-1.4.108" = _R8IFoYpy;
        "pkg-1.4.109" = _STWBUPMa;
        "pkg-1.4.110" = _KSLc7SV6;
        "pkg-1.4.111" = _Yp901hy2;
        "pkg-1.4.112" = _K0Wj117C;
        "pkg-1.4.113" = _xPMYyPpv;
        "pkg-1.4.114" = _h7fUaFkO;
        "pkg-1.4.115" = _k22XCRmM;
        "pkg-1.4.116" = _e3g0dZaQ;
        "pkg-1.4.117" = _ClLhGp2e;
        "pkg-1.4.118" = _EaEZ1k5B;
        "pkg-1.4.119" = _iGHB3B1y;
        "pkg-1.4.120" = _DgeakR6i;
        "pkg-1.4.121" = _xksYKkvF;
        "pkg-1.4.122+v231018" = _OFDrMIaP;
        "pkg-1.4.123" = _jXLHzvDW;
        "pkg-1.4.124" = _nyNboWdx;
        "pkg-1.4.125" = _gPjvEyVH;
        "pkg-1.4.126" = _d2Zjs48v;
        "pkg-1.4.127" = _OOJoc9kE;
        "pkg-1.4.128" = _yYzR60Xd;
        "pkg-1.4.129" = _JfuWaP6v;
        "pkg-1.4.130" = _44Y21h86;
        "pkg-1.4.131" = _1o9MBJh6;
        "pkg-1.4.132" = _BkPMA8Z5;
        "pkg-1.4.133" = _LsfkSsBk;
        "pkg-1.4.134" = _FjeNPBbC;
        "pkg-1.4.135" = _SheltrYH;
        "pkg-1.4.136" = _VtZ6ndC0;
        "pkg-1.4.137" = _OCLXh3kx;
        "pkg-1.4.138" = _8Uh1TOZF;
        "pkg-1.4.139" = _Oep3HDfE;
        "pkg-1.4.140" = _xjxZEiKl;
        "pkg-1.4.141" = _iImwtlTX;
        "pkg-1.4.142" = _xrQg4ml6;
        "pkg-1.4.143" = _fdlwhWT6;
        "pkg-1.4.144" = _IhEAlTmp;
        "pkg-1.4.145" = _MupImyPh;
        "pkg-1.4.146" = _6ivtLxOA;
        "pkg-1.4.147" = _f2mvlGrg;
        "pkg-1.4.148" = _96i4d2eG;
        "pkg-1.4.149" = _GOqlpSwl;
        "pkg-1.4.150" = _qC4PqL5F;
        "pkg-1.4.151" = _3U5joqXl;
        "pkg-1.4.152" = _ycs2nrOF;
        "pkg-1.4.153" = _3VfZIjXn;
        "pkg-1.4.155" = _qh9RAhUL;
        "pkg-1.4.156" = _4GjHbqwI;
        "pkg-1.4.157" = _2og1ueRg;
        "pkg-1.4.158" = _ZF8ufR9V;
        "pkg-1.4.159" = _AxmOgWQe;
        "pkg-1.4.160" = _qOSLmnqf;
        "pkg-1.4.161" = _aVB2lYQQ;
        "pkg-1.4.162" = _PdC55gKk;
        "pkg-1.4.163" = _L40GDAYI;
        "pkg-1.4.164" = _vmcWN6HD;
        "pkg-1.4.165" = _IRAR0lWa;
        "pkg-1.4.166" = _8tQ3T6ku;
        "pkg-1.4.167" = _VN6LpS9W;
        "pkg-1.4.168" = _CJn60Mes;
        "pkg-1.4.169" = _oXn7up6k;
        "pkg-1.4.170" = _Y6BHWQyF;
        "pkg-1.4.171" = _U7ttqayj;
        "pkg-1.4.172" = _U2Oef4Vn;
        "pkg-1.4.173" = _2egxp8jm;
        "pkg-1.4.174" = _CMbdSBjO;
        "pkg-1.4.175" = _yEV5JtZn;
        "pkg-1.4.176" = _NXZ9k9lc;
        "pkg-1.4.177" = _RXcxPvgC;
        "pkg-1.4.178" = _9sDNEkuZ;
        "pkg-1.4.179" = _3JF9NgNJ;
        "pkg-1.4.180" = _E2IpoPAm;
        "pkg-1.4.181" = _ogGjc1NN;
        "pkg-1.4.182" = _FKpNCvBT;
        "pkg-1.4.183" = _oFvv1eq5;
        "pkg-1.4.184" = _1Pg2Vq2r;
        "pkg-1.4.185" = _jcWK0Ziq;
        "pkg-1.4.186" = _Ak2iyAlP;
        "pkg-1.4.187" = _mV7ZU1wg;
        "pkg-1.4.188" = _oiUqSOMA;
        "pkg-1.4.188+25w42a" = _y7wNE3Jz;
        "pkg-1.4.189" = _OpFtDpHA;
        "pkg-1.4.190" = _xoSJjxcV;
        "pkg-1.4.191" = _RVpdlsEJ;
        "pkg-1.4.192" = _fKU4HJjc;
        "pkg-1.4.193" = _JV4Dlp7j;
        "pkg-26.1-beta-1" = _6FpFtZPE;
        "pkg-1.4.194" = _HzPcczDK;
        "pkg-26.1-beta-2" = _Ie7XSsI8;
        "pkg-26.1-beta-3" = _pIC5aaVm;
        "pkg-26.1-beta-4" = _TGtm63Bk;
        "pkg-26.1-beta-5" = _nu6L917m;
        "pkg-26.1-beta-6" = _voHUxVAY;
        "pkg-26.1-beta-7" = _LFamyIeO;
        "pkg-26.1-beta-8" = _ZlB5drEY;
        "pkg-26.1-beta-9" = _rQfDNQBG;
        "pkg-26.1" = _ygtmLbO3;
        "pkg-26.2-beta-1" = _3Pltf6nM;
        "pkg-26.2-beta-2" = _cVLxHDWC;
        "pkg-26.2-beta-3" = _lUx6Xy8L;
