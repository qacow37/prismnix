...
let
    ...
    in {
        ...
        "pkg-1.16.5-3.2.0-2.0.7" = _HaVJnGFt;
        "pkg-1.17.1-3.2.0-2.0.7" = _jQfDsrmu;
        "pkg-1.18.2-3.2.0-2.0.7" = _GeWxgwKm;
        "pkg-1.19.2-3.2.0-2.0.7" = _6Lxd1btS;
        "pkg-1.19.3-3.2.0-2.0.7" = _9Hrkl2We;
        "pkg-1.19.4-3.2.0-2.0.7" = _wtycK6RF;
        "pkg-1.16.5-3.2.0-2.0.8" = _5qAg7TkN;
        "pkg-1.17.1-3.2.0-2.0.8" = _8JxrlJLJ;
        "pkg-1.18.2-3.2.0-2.0.8" = _DyLpzY8d;
        "pkg-1.19.2-3.2.0-2.0.8" = _2J4pTSBu;
        "pkg-1.19.3-3.2.0-2.0.8" = _6jgDQK1U;
        "pkg-1.19.4-3.2.0-2.0.8" = _PPUwFo5E;
        "pkg-1.16.5-2.1.0" = _I5biiSAG;
        "pkg-1.19.2-2.1.0" = _XmIcPk44;
        "pkg-1.19.4-2.1.0" = _oasADsT1;
        "pkg-1.18.2-2.1.0" = _ROL6Ic6e;
        "pkg-1.17.1-2.1.0" = _sQS8Il5X;
        "pkg-1.19.3-2.1.0" = _uU1jozrr;
        "pkg-1.19.2-2.1.2" = _s2ePUAt9;
        "pkg-1.16.5-2.1.2" = _3079k7BQ;
        "pkg-1.18.2-2.1.2" = _WpfxqH3I;
        "pkg-1.19.3-2.1.2" = _ditfufZZ;
        "pkg-1.19.4-2.1.2" = _WNcbZn40;
        "pkg-1.17.1-2.1.2" = _CSuzbAMz;
        "pkg-2.2.0" = _qLz5dVKp;
        "pkg-FABRIC-2.2.1+1.16.5" = _VsoTBFtH;
        "pkg-FORGE-2.2.1+1.16.5" = _baPDAVi5;
        "pkg-FABRIC-2.2.1+1.17.1" = _EnWubGAK;
        "pkg-FORGE-2.2.1+1.17.1" = _YSCu6Jac;
        "pkg-FABRIC-2.2.1+1.18.2" = _imgk903c;
        "pkg-FORGE-2.2.1+1.18.2" = _O9ZHUaFQ;
        "pkg-FABRIC-2.2.1+1.19.2" = _3RM7Y2hc;
        "pkg-FORGE-2.2.1+1.19.2" = _aSVrFf9l;
        "pkg-FABRIC-2.2.1+1.19.4" = _apIi1qFn;
        "pkg-FORGE-2.2.1+1.19.4" = _5lHmdCgF;
        "pkg-FABRIC-2.2.1+1.20.1" = _RT87vx08;
        "pkg-FORGE-2.2.1+1.20.1" = _hlfcPn0G;
        "pkg-FABRIC-2.2.1+1.20.4" = _xpWYVO2F;
        "pkg-FORGE-2.2.1+1.20.4" = _cTOoCqN1;
        "pkg-FABRIC-2.2.2+1.16.5" = _KtizfaAE;
        "pkg-FORGE-2.2.2+1.16.5" = _XBVJj0RV;
        "pkg-FABRIC-2.2.2+1.17.1" = _oGnh6ygm;
        "pkg-FORGE-2.2.2+1.17.1" = _yA7xutjQ;
        "pkg-FABRIC-2.2.2+1.18.2" = _nHxmah1M;
        "pkg-FORGE-2.2.2+1.18.2" = _HxKDB89p;
        "pkg-FABRIC-2.2.2+1.19.2" = _IrcqJ70M;
        "pkg-FORGE-2.2.2+1.19.2" = _IBrZaGdn;
        "pkg-FABRIC-2.2.2+1.19.4" = _VqVRQhvq;
        "pkg-FORGE-2.2.2+1.19.4" = _7LUkUj8L;
        "pkg-FABRIC-2.2.2+1.20.1" = _1f7yDMAo;
        "pkg-FORGE-2.2.2+1.20.1" = _xOLXFdSl;
        "pkg-FABRIC-2.2.2+1.20.4" = _Qe0yakbC;
        "pkg-FORGE-2.2.2+1.20.4" = _ONZwoOBX;
        "pkg-FABRIC-2.2.3+1.16.5" = _3RMahJUs;
        "pkg-FORGE-2.2.3+1.16.5" = _pSKQy8Jf;
        "pkg-FABRIC-2.2.3+1.17.1" = _pGPkcgzE;
        "pkg-FORGE-2.2.3+1.17.1" = _nRd8IpLQ;
        "pkg-FABRIC-2.2.3+1.18.2" = _HkxgTp4c;
        "pkg-FORGE-2.2.3+1.18.2" = _iB4K0Tmk;
        "pkg-FABRIC-2.2.3+1.19.2" = _9piaaYo8;
        "pkg-FORGE-2.2.3+1.19.2" = _optd54t3;
        "pkg-FABRIC-2.2.3+1.19.4" = _dAxLXZEI;
        "pkg-FORGE-2.2.3+1.19.4" = _gZqGXVlt;
        "pkg-FABRIC-2.2.3+1.20.1" = _xdD0r5ZM;
        "pkg-FORGE-2.2.3+1.20.1" = _EpzGzGYf;
        "pkg-FABRIC-2.2.3+1.20.4" = _ewX3LnSj;
        "pkg-FORGE-2.2.3+1.20.4" = _W627QhG8;
        "pkg-FABRIC-2.2.4+1.16.5" = _F4q9x7Em;
        "pkg-FORGE-2.2.4+1.16.5" = _98LA8MTm;
        "pkg-FABRIC-2.2.4+1.17.1" = _UGfkX3s9;
        "pkg-FORGE-2.2.4+1.17.1" = _TYjYZtRP;
        "pkg-FABRIC-2.2.4+1.18.2" = _O31rQxAz;
        "pkg-FORGE-2.2.4+1.18.2" = _W2T2urlX;
        "pkg-FABRIC-2.2.4+1.19.2" = _TSKmdnPa;
        "pkg-FORGE-2.2.4+1.19.2" = _MAHCx5Rq;
        "pkg-FABRIC-2.2.4+1.19.4" = _KUHhqK6C;
        "pkg-FORGE-2.2.4+1.19.4" = _IXUPUPS4;
        "pkg-FABRIC-2.2.4+1.20.1" = _udWNOhrU;
        "pkg-FORGE-2.2.4+1.20.1" = _5mA7Y5hH;
        "pkg-FABRIC-2.2.4+1.20.4" = _FvqDweiB;
        "pkg-FORGE-2.2.4+1.20.4" = _2gGXOfNt;
        "default" = _2gGXOfNt;
    });
