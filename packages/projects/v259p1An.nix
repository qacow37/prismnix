...
let
    ...
    in {
        ...
        "pkg-1.20-2.8.0-fabric" = _FkmAO0KL;
        "pkg-1.20-2.8.0-forge" = _OVIAVjv0;
        "pkg-1.20-2.8.1-fabric" = _wJl96Pm3;
        "pkg-1.20-2.8.1-forge" = _gbYiN3fP;
        "pkg-1.20-2.8.2-fabric" = _xG7e7MIy;
        "pkg-1.20-2.8.2-forge" = _gJyOV2EJ;
        "pkg-1.20-2.8.3-fabric" = _SyBR9mHO;
        "pkg-1.20-2.8.3-forge" = _iX7cbyc8;
        "pkg-1.20-2.9.0-fabric" = _UmbZYo07;
        "pkg-1.20-2.9.0-forge" = _csB296sH;
        "pkg-1.20-2.9.1-fabric" = _GPsj2qxO;
        "pkg-1.20-2.9.1-forge" = _teyu8owK;
        "pkg-1.20-2.9.2-fabric" = _6Z6m6oaD;
        "pkg-1.20-2.9.2-forge" = _JMmJcasE;
        "pkg-1.20-2.9.3-fabric" = _tyJtQ9jC;
        "pkg-1.20-2.9.3-forge" = _XXiVpGNp;
        "pkg-1.20-2.9.4-fabric" = _qLJQc3Fg;
        "pkg-1.20-2.9.4-forge" = _UVGYIuru;
        "pkg-1.20-2.9.5-fabric" = _9BkQqoVC;
        "pkg-1.20-2.9.5-forge" = _Mtl91jTe;
        "pkg-1.20-2.9.6-fabric" = _hjMKnU2P;
        "pkg-1.20-2.9.6-forge" = _VqC0vvrI;
        "pkg-1.20-2.9.7-fabric" = _G8fl9mNP;
        "pkg-1.20-2.9.7-forge" = _vZVdd2vq;
        "pkg-1.21-2.11.0-fabric" = _VD6DDu65;
        "pkg-1.21-2.11.0-neoforge" = _5Ffp9yYx;
        "pkg-1.21-2.11.1-fabric" = _O2AGP8uJ;
        "pkg-1.21-2.11.1-neoforge" = _NIZkc7Xu;
        "pkg-1.21-2.11.2-fabric" = _Dgd279H0;
        "pkg-1.21-2.11.2-neoforge" = _U9jBYib3;
        "pkg-1.20-2.9.8-fabric" = _lmUv5VSD;
        "pkg-1.20-2.9.8-forge" = _x3QhLZnp;
        "pkg-1.21-2.11.3-fabric" = _dURHN7PY;
        "pkg-1.21-2.11.3-neoforge" = _XIE0asyq;
        "pkg-1.20-2.9.9-fabric" = _obrctoRO;
        "pkg-1.20-2.9.9-forge" = _NXs2oCVM;
        "default" = _NXs2oCVM;
    });
