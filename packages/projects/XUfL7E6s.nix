...
let
    ...
    in {
        ...
        "pkg-1.0.0.0-1.20.1" = _STbARCnv;
        "pkg-1.1.0.0-1.20.1" = _n4EI08qC;
        "pkg-1.1.0.0-1.21.1" = _FUXY52RD;
        "pkg-1.1.0.0-1.19.2" = _BH6kDeT0;
        "pkg-1.1.0.0-1.18.2" = _2q0tXF8t;
        "pkg-1.1.0.0-1.17.1" = _P2JsRGre;
        "pkg-1.1.0.0-1.16.5" = _f4llPuWQ;
        "pkg-1.2.1.0-1.20" = _fTH2561r;
        "pkg-1.2.1.0-1.20.5" = _ymZSTiXA;
        "pkg-1.2.1.0-1.19" = _ivsPqoen;
        "pkg-1.2.1.0-1.19.3" = _jdGIIwtP;
        "pkg-1.2.1.0-1.19.4" = _Q54b86Cx;
        "pkg-1.2.1.0-1.21" = _bnJIqgUi;
        "pkg-1.2.1.0-1.21.2" = _tlpRmyDn;
        "pkg-1.2.1.0-1.21.4" = _YYFWmmmC;
        "pkg-1.2.1.0-1.21.5" = _N8dLPrUR;
        "pkg-1.2.1.0-1.21.6" = _4QuEgDFw;
        "pkg-1.2.1.0-1.21.8" = _o8mmOLIX;
        "pkg-1.2.1.0-1.21.9" = _NwuHY6JU;
        "pkg-1.3.0.0-1.21" = _loxTmu8T;
        "pkg-1.3.0.0-1.21.2" = _8oCaBGpq;
        "pkg-1.3.0.0-1.21.4" = _uHrVmvph;
        "pkg-1.3.0.0-1.21.5" = _VdEcjfC1;
        "pkg-1.3.0.0-1.21.6" = _ObB6WJpx;
        "pkg-1.3.0.0-1.21.8" = _oUHUUkZ9;
        "pkg-1.3.0.0-1.21.9" = _sq0yaIhz;
        "pkg-1.3.0.0-1.20" = _WmelrQy1;
        "pkg-1.3.0.0-1.20.3" = _tImSzkuD;
        "pkg-1.3.0.0-1.20.5" = _5Qkepq97;
        "pkg-1.3.0.0-1.19.4" = _IWYavvLd;
        "pkg-1.3.0.0-1.19.3" = _Nm7PJpPa;
        "pkg-1.3.0.0-1.19" = _8tz6FVHY;
        "default" = _8tz6FVHY;
    });
