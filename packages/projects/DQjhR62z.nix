...
let
    ...
    in {
        ...
        "pkg-1.10-0.0.1beta1" = _P1hfPwA7;
        "pkg-1.10-0.0.1beta2" = _tCjspBjF;
        "pkg-1.10-0.1.0beta3" = _keMSedxA;
        "pkg-1.10-0.1.0beta5" = _nu8i7Jll;
        "pkg-1.10-0.1.0beta6" = _pWvvB8sl;
        "pkg-1.10-0.1.0beta7" = _XWWmJOaJ;
        "pkg-1.10-1.0.0beta9" = _n7XSjb2n;
        "pkg-1.10-1.0.0beta10" = _dyRK3Cjf;
        "pkg-1.10-1.0.0" = _QHfGKtyL;
        "pkg-1.10-1.1.0" = _cIVjhqgb;
        "pkg-1.10-1.1.1" = _jgcQvvIP;
        "pkg-1.10-1.2.0" = _ir1eRZMh;
        "pkg-1.10-1.3.0" = _TuNiCrzW;
        "pkg-1.10-1.3.1" = _l5wvKjbz;
        "pkg-1.10-1.3.2" = _w0MFctJo;
        "pkg-1.10-1.3.3" = _LvArx1Uy;
        "pkg-1.10-1.3.4" = _dtnQJO7l;
        "pkg-1.10-1.4.0" = _bTCVl0Pv;
        "pkg-1.10-1.5.0" = _tAf59Qym;
        "pkg-1.10-1.5.1" = _i6SLw3BI;
        "pkg-1.10-1.5.2" = _kZEDCoJz;
        "pkg-1.11-1.5.2alpha1" = _CPvhrFuB;
        "pkg-1.11-1.5.2alpha2" = _oU0ngK4S;
        "pkg-1.11-1.5.2beta1" = _cWLL6Rem;
        "pkg-1.1x-1.6.0" = _g4yXdVtS;
        "pkg-1.1x-1.6.1" = _7f44C5xj;
        "pkg-1.1x-1.6.2" = _gyykhogK;
        "pkg-1.1x-1.6.3" = _Pr6n1wO4;
        "pkg-1.1x-1.6.4" = _RFZJ3u0l;
        "pkg-1.1x-1.6.5" = _iAmYz0I7;
        "pkg-1.1x-1.6.6" = _XqsQTjmM;
        "pkg-1.1x-1.6.8" = _jsdBtnh4;
        "pkg-1.12-1.6.8beta1" = _NMmlPf7A;
        "pkg-1.12-1.6.8" = _JL3hucJ1;
        "pkg-1.1x-1.6.9" = _Eiyd30aI;
        "pkg-1.12-1.6.9" = _6IiJ2aTR;
        "pkg-1.1x-1.7.0" = _cT2zOcua;
        "pkg-1.12-1.7.0" = _D8zN40xT;
        "pkg-1.12-1.8.0" = _3I1qghsI;
        "pkg-1.12-1.8.1" = _bCU3Pevr;
        "pkg-1.12-1.9.0-alpha" = _d3qbUN1u;
        "pkg-1.12-1.9.0" = _FoO6hM48;
        "pkg-1.12-1.9.1" = _dROxvV3C;
        "pkg-1.12-1.9.2" = _t9wiwLqC;
        "pkg-1.12-1.9.3" = _HpptEzT6;
        "pkg-1.12-2.0.0" = _rOJBxI7A;
        "pkg-1.12-2.0.1" = _K2nGXAUj;
        "pkg-1.12-2.0.2" = _vZYVWNJB;
        "pkg-1.15-3.0.0-beta" = _XSTKzOg6;
        "pkg-1.15-3.0.1-beta" = _zjpHG3CR;
        "pkg-1.15-3.0.2-beta" = _ayhEbg3q;
        "pkg-1.15-3.0.3-beta" = _UhyW9o29;
        "pkg-1.15-3.0.4-beta" = _HppdQ1sC;
        "pkg-1.16-4.0.0-beta" = _pDU7B9vY;
        "pkg-1.16-4.0.1-beta" = _dqD24leU;
        "pkg-1.15-3.0.6" = _PyQFIX3c;
        "pkg-1.16-4.0.2-beta" = _ewd3Eon3;
        "pkg-1.16-4.0.3-beta" = _UkU6m1il;
        "pkg-1.15-3.0.7" = _Pmfd1zx2;
        "pkg-1.16-4.0.4-beta" = _6xOQwWkz;
        "pkg-1.15-3.0.8" = _9fY0Jp67;
        "pkg-1.16-4.0.5" = _nC4xY70f;
        "pkg-1.16-4.0.6" = _onmlijSi;
        "pkg-1.15-3.0.9" = _ttojGkuq;
        "pkg-1.16-4.0.7" = _rB188hv6;
        "pkg-1.16-4.0.8" = _rtcrL5jQ;
        "pkg-1.16-4.0.9" = _a236cDDB;
        "pkg-1.16-4.0.10" = _CBKFoZEl;
        "pkg-1.16-4.0.11" = _74mAGb8n;
        "pkg-1.16-4.0.12" = _abAYziIn;
        "pkg-1.16-4.0.13" = _vOSy6qdM;
        "pkg-1.16-4.0.14" = _2DoKudfB;
        "pkg-1.18-5.0.0" = _fTmrZNLo;
        "pkg-1.18-5.0.1" = _uRHbLoRF;
        "pkg-1.18-5.0.2" = _UsqfUEZl;
        "pkg-1.18-5.0.3" = _PU23kySd;
        "pkg-1.16-4.0.15" = _C6xjWzBQ;
        "pkg-1.16-4.0.16" = _GUx3YKvX;
        "pkg-1.18-5.0.4" = _dSzO1uUo;
        "pkg-1.16-4.0.17" = _52iNobDd;
        "pkg-1.18-5.0.5" = _RnujlV66;
        "pkg-1.18-5.0.6" = _uvnImxuR;
        "pkg-1.16-4.0.18" = _jKHrXVKa;
        "pkg-1.19-6.0.0" = _LR5Ee3pm;
        "pkg-1.18-5.0.7" = _ED6jmtXg;
        "pkg-1.19-6.0.1" = _ZCySwDHj;
        "pkg-1.18-5.0.8" = _M59BDDoH;
        "pkg-1.18-5.0.9" = _eeDps4Zf;
        "pkg-1.19-6.1.0" = _XbSDwHNK;
        "pkg-1.18-5.0.10" = _quVKUHcx;
        "pkg-1.19-6.1.1" = _hyhZntQc;
        "pkg-1.19-6.1.2" = _SiG80o02;
        "pkg-1.19-6.1.3" = _UrGr2oNn;
        "pkg-1.19-6.1.4" = _Cjinisl7;
        "pkg-1.20-7.0.0" = _9UgzQ0vG;
        "pkg-1.20-7.0.1" = _VitrlUgN;
        "pkg-1.20-7.0.2" = _86sZOj88;
        "pkg-1.19-6.1.5" = _RP3ZhZCz;
        "pkg-1.20-7.0.3" = _ck81C5tg;
        "pkg-1.21-8.0.0" = _YuL4oiGc;
        "pkg-1.21-8.0.1" = _iy9A1UXp;
        "pkg-1.20-7.0.4" = _vx6jEwhH;
        "pkg-1.21-8.0.2" = _Q6pchzIj;
        "default" = _Q6pchzIj;
    });
