...
let
    ...
    in {
        ...
        "pkg-7.2.0" = _TUJiKsci;
        "pkg-7.2.1" = _rVJ0f543;
        "pkg-7.99.0" = _Bp3S4ZiZ;
        "pkg-7.99.13" = _8K4wLPKt;
        "pkg-7.99.14" = _82pryHA5;
        "pkg-7.99.15" = _D7fNNtWj;
        "pkg-7.99.20" = _f6icizWx;
        "pkg-7.99.21" = _qJMOybuz;
        "pkg-7.99.22" = _i4d0OOwa;
        "pkg-7.99.23" = _E6KX3rdo;
        "pkg-7.99.24" = _EdXv56zZ;
        "pkg-7.99.24.1" = _MkanHTaW;
        "pkg-7.99.24.2" = _wh9MTGMC;
        "pkg-7.99.24.3" = _RlNzHDwo;
        "pkg-7.99.24.4" = _ExOb1Kc8;
        "pkg-7.99.24.5" = _W6OyAuy3;
        "pkg-7.99.24.6" = _nQipG63m;
        "pkg-7.99.24.7" = _f0XpvdIt;
        "pkg-7.99.24.8" = _5kahh29u;
        "pkg-7.1.9" = _7gHdRW4A;
        "pkg-8.0.0" = _s0txPaZD;
        "default" = _s0txPaZD;
    });
