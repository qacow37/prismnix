...
let
    ...
    in {
        ...
        "pkg-1.4.6" = _73CmmJsu;
        "pkg-1.4.7" = _xnq7wOtZ;
        "pkg-1.4.8-dev1" = _HgfLutwW;
        "pkg-1.4.8" = _weLPjkYd;
        "pkg-1.4.8-hotfix" = _gjt4Dtx2;
        "pkg-1.4.9" = _GNCCyOAU;
        "pkg-1.5.0" = _gRajS7ds;
        "pkg-1.5.1" = _GN8K8Ly0;
        "pkg-1.6.0" = _VakM80Km;
        ...
        "pkg-1.8.0" = _W6hDcPOk;
        "pkg-1.8.1" = _UKlF1UlS;
        "pkg-1.9.0-mc.1.21.11" = _JS7kAeuq;
        "pkg-1.9.0-mc.26.1.2" = _VJ5bYwXw;
        "pkg-1.9.1-mc.1.21.11" = _6Wj6MQOv;
        "pkg-1.9.1-mc.26.1.2" = _qRG0oQJF;
        "pkg-1.9.2-mc.1.21.11" = _4JS0EKEO;
        "pkg-1.9.2-mc.26.1.2" = _AxkqIqGY;
        "pkg-1.9.3-mc.1.21.11" = _pneGCRhT;
        "pkg-1.9.3-mc.26.1.2" = _skObdWzL;
        "pkg-1.9.4-mc.1.21.11" = _js4f9jP1;
        "pkg-1.9.4-mc.26.1.2" = _rkzyaCXS;
        "pkg-1.9.5-mc.1.21.11" = _CWSl11QK;
        "pkg-1.9.5-mc.26.1.2" = _nhz12jiM;
        "default" = _nhz12jiM;
    });
