...
let
    ...
    in {
        ...
        "pkg-1.1.0+forge" = _UCCoANHF;
        "pkg-2.0.0+forge" = _6Irxh3Yf;
        "pkg-2.0.0+fabric" = _z337cufp;
        "pkg-3.0.0+fabric" = _slw3cfk1;
        "pkg-3.0.0+forge" = _aortmgxE;
        "pkg-3.0.1+fabric" = _DmY5c72A;
        "pkg-3.0.1+forge" = _ceUloz21;
        "pkg-3.0.2+fabric" = _BAaPH9t5;
        "pkg-3.0.2+forge" = _ZPSs2RAq;
        "pkg-3.1.0+fabric" = _zt3EyBI9;
        "pkg-3.1.0+forge" = _TBaPSW78;
        "pkg-4.0.0+fabric" = _SmKQcjOS;
        "pkg-4.0.0+neoforge" = _m8ZOFB44;
        "pkg-4.0.1+fabric" = _8plsYECy;
        "pkg-4.0.1+neoforge" = _1hYnHGka;
        "pkg-4.0.2+Fabric" = _itUdve5o;
        "pkg-4.0.2+Forge" = _4gE5Cxic;
        "pkg-4.0.3+Fabric" = _PlOEuFMz;
        "pkg-4.0.3+Forge" = _ZTIpORdw;
        "pkg-4.0.4+Fabric" = _iTTXScie;
        "pkg-4.0.4+Forge" = _h6aWutwh;
        "pkg-4.0.4" = _7bjHviJn;
        "pkg-4.0.5" = _l18xV0Dm;
        "pkg-4.0.6" = _yAakn7Dn;
        "pkg-4.1.0" = _SuIwhIqm;
