...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _AUfeJpct;
        "pkg-1.0.0+mod" = _W0pTpy5M;
        "pkg-1.1.0" = _7aPSLGXE;
        "pkg-1.1.0+mod" = _Xh9ZaYaV;
        "pkg-1.1.1" = _Uz7A9jap;
        "pkg-1.1.1+mod" = _Fz7dEPYE;
        "pkg-1.1.2" = _rDPo1Ej0;
        "pkg-1.1.2+mod" = _veSvk5yq;
        "pkg-1.1.3" = _8sQ1Q6QH;
        "pkg-1.1.3+mod" = _E6Hy5mfg;
        "pkg-1.1.4" = _cRzuBuaX;
        "pkg-1.1.4+mod" = _lCnWdUkg;
        "pkg-2.0.0" = _cInubbnr;
        "pkg-2.0.0+mod" = _fcTSi9kO;
        "pkg-2.1.0" = _Mo2lMloa;
        "pkg-2.1.0+mod" = _wS9Dhtn7;
        "pkg-2.2.0" = _qPHIAmYb;
        "pkg-2.2.0+mod" = _eE6mvf2M;
        "pkg-2.2.1" = _y50sYJUf;
        "pkg-2.2.1+mod" = _5m9jn1AA;
        "pkg-3.0.0" = _MTfLQgNh;
        "pkg-3.0.0+mod" = _BK7vs5ue;
        "default" = _BK7vs5ue;
    });
