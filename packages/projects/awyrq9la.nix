...
let
    ...
    in {
        ...
        "pkg-1.1.2" = _hAIhXc4U;
        "pkg-1.1.3" = _iKvNyybP;
        "pkg-1.1.4-beta.1" = _li2RnAkI;
        "pkg-1.2.0" = _BcwDqLJS;
        "pkg-1.2.1" = _3CdcwjVW;
        "pkg-1.2.2" = _fBl60gDc;
        "pkg-1.3+1.21.11-fabric" = _bSSJBPJS;
        "pkg-1.3+1.21.11-neoforge" = _yaWrSC5x;
        "pkg-1.3+26.1-snapshot-1-fabric" = _KexSpwjT;
        "pkg-1.3.1+26.1-snapshot-10-fabric" = _XWnJoZpZ;
        "pkg-1.3.2+26.1-snapshot-11-fabric" = _90qELK0r;
        "pkg-1.4.0+26.1-pre-2-fabric" = _mLh2k2UR;
        "pkg-1.4.1+26.1.1-fabric" = _jxAeTIeA;
        "pkg-1.4.1+26.1.1-neoforge" = _ldENQLtJ;
