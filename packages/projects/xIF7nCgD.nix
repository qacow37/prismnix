...
let
    ...
    in {
        ...
        "pkg-1.10.3" = _1fh0b4at;
        "pkg-1.3.3" = _bkYzSnpV;
        "pkg-1.10.5" = _pq3Nu2ue;
        "pkg-1.3.4" = _1ua2TB4g;
        "pkg-1.10.6" = _LPNxMuUM;
        "pkg-1.3.5" = _uHzeXiAF;
        "pkg-1.20.1-1.0" = _Z7DtJ1rx;
        "pkg-1.20.2-1.0" = _5BSn4dZ8;
        "pkg-1.10.2.02" = _6alkjy6M;
        "pkg-1.2.8" = _19Swuken;
        "pkg-1.3.6" = _OrKVfwRU;
        "pkg-1.20.1-1.1" = _QKXIpujo;
        "pkg-1.20.2-1.1" = _hWlr8EoW;
        "pkg-1.9.10" = _jCqiD2gO;
        "pkg-1.10.7" = _ZiIjJaVH;
        "pkg-1.20.4-1.2" = _lhNjVXju;
        "pkg-1.20.4-1.1" = _DM18rC5s;
        "pkg-1.21.1-0.1" = _CEti6nXO;
        "pkg-1.7.19" = _epLQC7En;
        "pkg-1.9.11" = _Z6qVoCOD;
        "pkg-1.10.8" = _pXpwrarj;
        "pkg-1.3.7" = _ISLzUY7k;
        "pkg-1.20.1-1.2" = _NlGoENKz;
        "pkg-1.20.4-1.3" = _CruCYSxT;
        "pkg-1.21.1-1.0" = _UKUYTR6M;
        "default" = _UKUYTR6M;
    });
