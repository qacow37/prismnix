...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.0.0-forge" = _WyCxCYHl;
        "pkg-1.19.4-1.0.0-fabric" = _7FTwaKMQ;
        "pkg-1.19.4-1.0.0-forge" = _ENzw3blK;
        "pkg-1.20.1-1.0.0-fabric" = _YgJn4k0P;
        "pkg-1.20.1-1.0.0-forge" = _CbPeVCKF;
        "pkg-1.20.4-1.0.0-fabric" = _8iBXkqYr;
        "pkg-1.20.4-1.0.0-forge" = _NojEIXSt;
        "pkg-1.20.4-1.0.0-neoforge" = _Cz8wF5YH;
        "pkg-1.20.6-1.0.0-fabric" = _nF9Z6SBh;
        "pkg-1.20.6-1.0.0-forge" = _tfDizNx3;
        "pkg-1.20.6-1.0.0-neoforge" = _3ps7DqIF;
        "pkg-1.21.1-1.0.0-fabric" = _aiDZyyyO;
        "pkg-1.21.1-1.0.0-forge" = _vyIp1fbT;
        "pkg-1.21.1-1.0.0-neoforge" = _AuvK9Bos;
        "pkg-1.21.3-1.0.0-fabric" = _VwTIlYyD;
        "pkg-1.21.3-1.0.0-forge" = _CuX8yZ01;
        "pkg-1.21.3-1.0.0-neoforge" = _6LvOIZ60;
        "pkg-1.21.4-1.0.0-fabric" = _RO6Iczm4;
        "pkg-1.21.4-1.0.0-forge" = _w6WdM8XM;
        "pkg-1.21.4-1.0.0-neoforge" = _LNOmZ8c0;
        "pkg-1.18.2-1.0.1-fabric" = _GTR1nf4I;
        "pkg-1.18.2-1.0.1-forge" = _9rJXoxyK;
        "pkg-1.19.2-1.0.1-fabric" = _t6b261wQ;
        "pkg-1.19.2-1.0.1-forge" = _XGaFSFqy;
        "pkg-1.19.4-1.0.1-fabric" = _ml7Dhgm7;
        "pkg-1.19.4-1.0.1-forge" = _hIiVRjUs;
        "pkg-1.20.1-1.0.1-fabric" = _V1RAM9ER;
        "pkg-1.20.1-1.0.1-forge" = _Bxiaa4NA;
        "pkg-1.20.4-1.0.1-fabric" = _LeXADpYW;
        "pkg-1.20.4-1.0.1-forge" = _DchAuEKV;
        "pkg-1.20.4-1.0.1-neoforge" = _TKes2IVz;
        "pkg-1.20.6-1.0.1-fabric" = _l2qrDs1U;
        "pkg-1.20.6-1.0.1-forge" = _2MmfQcJL;
        "pkg-1.20.6-1.0.1-neoforge" = _mOhBrgUI;
        "pkg-1.21.1-1.0.1-fabric" = _4r1gu1Ey;
        "pkg-1.21.1-1.0.1-forge" = _iHL0w3LC;
        "pkg-1.21.1-1.0.1-neoforge" = _BXORjI2Y;
        "pkg-1.21.3-1.0.1-fabric" = _D6lZsJWI;
        "pkg-1.21.3-1.0.1-forge" = _OEDbXumb;
        "pkg-1.21.3-1.0.1-neoforge" = _ttA7nQRH;
        "pkg-1.21.4-1.0.1-fabric" = _Uk88vqbZ;
        "pkg-1.21.4-1.0.1-forge" = _1e4mvIt6;
        "pkg-1.21.4-1.0.1-neoforge" = _6akxvhwA;
        "pkg-1.21.5-1.0.1-fabric" = _h9Kiv8VI;
        "pkg-1.21.5-1.0.1-neoforge" = _Rj8OcYD5;
        "pkg-1.18.2-1.0.2-fabric" = _VS4mB8nS;
        "pkg-1.18.2-1.0.2-forge" = _r2JjwKYN;
        "pkg-1.19.2-1.0.2-fabric" = _qCvuMrx0;
        "pkg-1.19.2-1.0.2-forge" = _3TwO2D0x;
        "pkg-1.19.4-1.0.2-fabric" = _NjIr12ux;
        "pkg-1.19.4-1.0.2-forge" = _b6EnPXoF;
        "pkg-1.20.1-1.0.2-fabric" = _KZWY3HFl;
        "pkg-1.20.1-1.0.2-forge" = _6SZUbGTM;
        "pkg-1.20.4-1.0.2-fabric" = _ULqvv2jK;
        "pkg-1.20.4-1.0.2-forge" = _iXmi4E0o;
        "pkg-1.20.4-1.0.2-neoforge" = _Gf9Exw2e;
        "pkg-1.20.6-1.0.2-fabric" = _MMiA0hBO;
        "pkg-1.20.6-1.0.2-forge" = _zc4pGgCl;
        "pkg-1.20.6-1.0.2-neoforge" = _tAFa7aPI;
        "pkg-1.21.1-1.0.2-fabric" = _iy3iEuUD;
        "pkg-1.21.1-1.0.2-forge" = _vLtZ7WIa;
        "pkg-1.21.1-1.0.2-neoforge" = _wU1I3eAm;
        "pkg-1.21.3-1.0.2-fabric" = _YK5BfhSZ;
        "pkg-1.21.3-1.0.2-forge" = _9GN5yTFH;
        "pkg-1.21.3-1.0.2-neoforge" = _HrCld7lf;
        "pkg-1.21.4-1.0.2-fabric" = _NmV4920g;
        "pkg-1.21.4-1.0.2-forge" = _rH2ofEDr;
        "pkg-1.21.4-1.0.2-neoforge" = _phzeNS1U;
        "pkg-1.21.5-1.0.2-fabric" = _YBzTxYXl;
        "pkg-1.21.5-1.0.2-neoforge" = _ewSfzSmI;
        "pkg-1.21.5-1.0.2-forge" = _6GYr1gvC;
        "pkg-1.21.6-1.0.2-fabric" = _EWb4U6ew;
        "pkg-1.21.6-1.0.2-neoforge" = _CYqn2beK;
        "pkg-1.21.6-1.0.2-forge" = _AqJ7GjsK;
        "pkg-1.21.7-1.0.2-fabric" = _Kk8JOMyk;
        "pkg-1.21.7-1.0.2-forge" = _5Cd7TzfN;
        "pkg-1.21.7-1.0.2-neoforge" = _2xsYEDtq;
        "pkg-1.18.2-1.0.3-fabric" = _thu4s1NO;
        "pkg-1.18.2-1.0.3-forge" = _C7yKJI2a;
        "pkg-1.19.2-1.0.3-fabric" = _maZQj7CY;
        "pkg-1.19.2-1.0.3-forge" = _Vyyhly2b;
        "pkg-1.19.4-1.0.3-fabric" = _IrrnUhZC;
        "pkg-1.19.4-1.0.3-forge" = _sv3hzHJz;
        "pkg-1.20.1-1.0.3-fabric" = _BD8mgVRu;
        "pkg-1.20.1-1.0.3-forge" = _kmXHELpw;
        "pkg-1.20.4-1.0.3-fabric" = _ZcBWI9q8;
        "pkg-1.20.4-1.0.3-forge" = _8kCI6AhT;
        "pkg-1.20.4-1.0.3-neoforge" = _HTTGRUb9;
        "pkg-1.20.6-1.0.3-fabric" = _zIeq4gvJ;
        "pkg-1.20.6-1.0.3-forge" = _HMDr1nqy;
        "pkg-1.20.6-1.0.3-neoforge" = _CWiAgIRz;
        "pkg-1.21.1-1.0.3-fabric" = _fuxPRbjm;
        "pkg-1.21.1-1.0.3-forge" = _T4McG6Je;
        "pkg-1.21.1-1.0.3-neoforge" = _vZzyfwWe;
        "pkg-1.21.3-1.0.3-fabric" = _t12WAnQE;
        "pkg-1.21.3-1.0.3-forge" = _mNSGDlO9;
        "pkg-1.21.3-1.0.3-neoforge" = _v2Q695Uu;
        "pkg-1.21.4-1.0.3-fabric" = _9I4RtZ1t;
        "pkg-1.21.4-1.0.3-forge" = _6bobQnCM;
        "pkg-1.21.4-1.0.3-neoforge" = _KOGKCqai;
        "pkg-1.21.5-1.0.3-fabric" = _XjtBHahQ;
        "pkg-1.21.5-1.0.3-forge" = _bXC4mz41;
        "pkg-1.21.5-1.0.3-neoforge" = _jMZsWfFr;
        "pkg-1.21.7-1.0.3-fabric" = _yeUCEL9R;
        "pkg-1.21.7-1.0.3-forge" = _yIPQxa3U;
        "pkg-1.21.7-1.0.3-neoforge" = _OVfoxGcV;
        "pkg-1.21.8-1.0.3-fabric" = _hwyIyxKN;
        "pkg-1.21.8-1.0.3-forge" = _iSuWzGHh;
        "pkg-1.21.8-1.0.3-neoforge" = _yd4uU7rO;
        "pkg-1.21.9-1.0.3-fabric" = _D3QDfsE5;
        "pkg-1.21.9-1.0.3-neoforge" = _f2lAexnX;
        "pkg-1.21.9-1.0.3-forge" = _semRVEKi;
        "pkg-1.21.10-1.0.3-fabric" = _sGk7S9Zm;
        "pkg-1.21.10-1.0.3-forge" = _ZNURI4N6;
        "pkg-1.21.10-1.0.3-neoforge" = _3nWSGigg;
        "pkg-1.21.11-1.0.3-fabric" = _bwoK8j5L;
        "pkg-1.21.11-1.0.3-forge" = _3NCBCnIN;
        "pkg-1.21.11-1.0.3-neoforge" = _luJofGMA;
        "pkg-26.1.2-1.0.3-fabric" = _sfGsgLqU;
        "pkg-26.1.2-1.0.3-forge" = _ZFVsFh9T;
        "pkg-26.1.2-1.0.3-neoforge" = _k6HUyFPJ;
        "pkg-26.1.2-1.0.4-fabric" = _1Ob1iWIU;
        "pkg-26.1.2-1.0.4-forge" = _S6Xm9Egr;
        "pkg-26.1.2-1.0.4-neoforge" = _IcuHGVmg;
        "pkg-1.20.1-1.0.5-fabric" = _QmE7tjFP;
        "pkg-1.20.1-1.0.5-forge" = _RuDRP3if;
        "pkg-1.21.1-1.0.5-fabric" = _t9TYhYPL;
        "pkg-1.21.1-1.0.5-forge" = _i0VugkKy;
        "pkg-1.21.1-1.0.5-neoforge" = _3blfRQUY;
        "pkg-1.21.11-1.0.5-fabric" = _sDfjgCIF;
        "pkg-1.21.11-1.0.5-forge" = _BcebLH8v;
        "pkg-1.21.11-1.0.5-neoforge" = _K00q73VI;
        "pkg-26.1.2-1.0.5-fabric" = _r6gPtLxf;
        "pkg-26.1.2-1.0.5-forge" = _6RXcjvcS;
        "pkg-26.1.2-1.0.5-neoforge" = _ZotZFELu;
