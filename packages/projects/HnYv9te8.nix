...
let
    ...
    in {
        ...
        "pkg-1.0.0+24w40a-fabric" = _yI9UzTYn;
        "pkg-1.1.0+24w40a-fabric" = _Xkh9MZEs;
        "pkg-1.2.0+24w40a-fabric" = _CaUf1DaP;
        "pkg-1.2.1+24w40a-fabric" = _5ojwBrau;
        "pkg-2.0.0+24w40a-fabric" = _W7z2U4BW;
        "pkg-2.1.0+24w40a-fabric" = _r4CQKA5f;
        "pkg-2.2.0+24w40a-fabric" = _HwnWveYw;
        "pkg-2.3.0+24w40a-fabric" = _lklTEJia;
        "pkg-2.4.0+24w40a-fabric" = _EANON6ES;
        "pkg-2.4.1+24w40a-fabric" = _PQD2XQfJ;
        "pkg-2.5.0+24w40a-fabric" = _Smj0szNS;
        "pkg-2.6.0+24w40a-fabric" = _nPkyn3lK;
        "pkg-2.7.0+24w40a-fabric" = _SgYxC9Ja;
        "pkg-2.8.0+24w40a-fabric" = _7ihtCXEv;
        "pkg-2.7.0+1.21.2-neoforge" = _sQ5aDdXK;
        "pkg-2.7.0+1.21.3-forge" = _hD2ivVaJ;
        "pkg-2.8.0+1.21.3-forge" = _260dCyai;
        "pkg-2.8.0+1.21.2-neoforge" = _AbW0EHZL;
        "pkg-2.8.1+24w40a-fabric" = _6UqoHsgD;
        "pkg-2.8.1+1.21.2-neoforge" = _Z7GOpQoM;
        "pkg-2.8.1+1.21.3-forge" = _QTmNToRB;
        "pkg-2.8.2+24w40a-fabric" = _lUPirGph;
        "pkg-2.8.2+1.21.2-neoforge" = _nlZBYYLK;
        "pkg-2.8.2+1.21.3-forge" = _JK6DQt6e;
        "pkg-2.8.3+24w40a-fabric" = _weLxW0nO;
        "pkg-2.8.3+1.21.2-neoforge" = _eoGeAWCx;
        "pkg-2.8.3+1.21.3-forge" = _c7ZlhOG2;
        "pkg-2.9.0+1.20-fabric" = _95jDqJ9M;
        "pkg-2.9.0+1.20-forge" = _plNInObp;
        "pkg-2.9.0+1.20.1-fabric" = _9YXeAD6r;
        "pkg-2.9.0+1.20.1-forge" = _ycn1VIsS;
        "pkg-2.9.0+1.20.2-fabric" = _jA3WUD7r;
        "pkg-2.9.0+1.20.2-forge" = _3FAfSCXC;
        "pkg-2.9.0+1.20.3-fabric" = _t3sJNBvR;
        "pkg-2.9.0+1.20.4-fabric" = _dYreWmBi;
        "pkg-2.9.0+1.20.4-forge" = _2uMaMnSk;
        "pkg-2.9.0+1.20.5-fabric" = _1sgUu3V9;
        "pkg-2.9.0+1.20.6-fabric" = _mhpXD4ff;
        "pkg-2.9.0+1.21-fabric" = _xsjkjiVV;
        "pkg-2.9.0+1.21-forge" = _pRgvkBsA;
        "pkg-2.9.0+1.21-neoforge" = _HjqofpBT;
        "pkg-2.9.0+1.21.1-fabric" = _3a3nFTDM;
        "pkg-2.9.0+1.21.1-forge" = _fLdJcUc8;
        "pkg-2.9.0+1.21.1-neoforge" = _jy4DZrI6;
        "pkg-2.9.0+24w40a-fabric" = _uZqqHKjy;
        "pkg-2.9.0+1.21.2-fabric" = _jhb2sLSu;
        "pkg-2.9.0+1.21.2-neoforge" = _QCp1kZKK;
        "pkg-2.9.0+1.21.3-fabric" = _Hz8p60Oi;
        "pkg-2.9.0+1.21.3-forge" = _QdMAB1vV;
        "pkg-2.9.0+1.21.3-neoforge" = _W9zJTVaJ;
        "pkg-2.9.0+1.21.4-fabric" = _kQr3E2qI;
        "pkg-2.9.0+1.21.4-forge" = _8SmkcNaS;
        "pkg-2.9.0+1.21.4-neoforge" = _cssiP3QB;
        "pkg-2.9.0+1.21.5-fabric" = _B7d2BdqN;
        "pkg-2.9.0+1.21.5-neoforge" = _EtXE8r4G;
        "pkg-2.9.0+25w14craftmine-fabric" = _R3JeX9B7;
        "pkg-2.9.0+25w14craftmine-neoforge" = _KJxX6kO9;
        "pkg-2.9.0+1.21.5-forge" = _KSW5Vncq;
        "pkg-2.9.0+1.19.4-forge" = _fTVxdtol;
        "pkg-2.9.0+1.19.4-fabric" = _tA9Tt6zj;
        "pkg-2.9.0+1.19.3-forge" = _TVrhyRwz;
        "pkg-2.9.0+1.19.3-fabric" = _biEoYSIs;
        "pkg-2.9.1+1.19.3-fabric" = _QKf3cJN7;
        "pkg-2.9.1+1.19.3-forge" = _e6Mt7RYM;
        "pkg-2.9.1+1.19.4-fabric" = _opVwi6eo;
        "pkg-2.9.1+1.19.4-forge" = _1naMUW8C;
        "pkg-2.9.1+1.20-fabric" = _NZFRAn23;
        "pkg-2.9.1+1.20-forge" = _h57eU2DX;
        "pkg-2.9.1+1.20.1-fabric" = _4bpyY5ME;
        "pkg-2.9.1+1.20.1-forge" = _aXsyrhMl;
        "pkg-2.9.1+1.20.2-fabric" = _svHxa6VT;
        "pkg-2.9.1+1.20.2-forge" = _EMIfcmlN;
        "pkg-2.9.1+1.20.3-fabric" = _bd1PJ5Vu;
        "pkg-2.9.1+1.20.4-fabric" = _He8NWkZw;
        "pkg-2.9.1+1.20.4-forge" = _KID3g8w4;
        "pkg-2.9.1+1.20.5-fabric" = _3oOjwley;
        "pkg-2.9.1+1.20.6-fabric" = _5mIEvPmH;
        "pkg-2.9.1+1.21-fabric" = _pryBnYuF;
        "pkg-2.9.1+1.21-forge" = _TACS3qY2;
        "pkg-2.9.1+1.21-neoforge" = _TWnJZQu3;
        "pkg-2.9.1+1.21.1-fabric" = _t2J8KDfw;
        "pkg-2.9.1+1.21.1-forge" = _6HR2lPre;
        "pkg-2.9.1+1.21.1-neoforge" = _kicZlBCe;
        "pkg-2.9.1+1.21.2-fabric" = _Jmgou39n;
        "pkg-2.9.1+1.21.2-neoforge" = _DkyjqpW0;
        "pkg-2.9.1+1.21.3-fabric" = _Y10hutlU;
        "pkg-2.9.1+1.21.3-forge" = _9YkRE569;
        "pkg-2.9.1+1.21.3-neoforge" = _3I6hdUsX;
        "pkg-2.9.1+1.21.4-fabric" = _8qLH5A5C;
        "pkg-2.9.1+1.21.4-forge" = _EptsqqCU;
        "pkg-2.9.1+1.21.4-neoforge" = _ruAQf8W9;
        "pkg-2.9.1+1.21.5-fabric" = _4PNeNweP;
        "pkg-2.9.1+1.21.5-forge" = _nZOA3lVM;
        "pkg-2.9.1+1.21.5-neoforge" = _QgUbWaXg;
        "pkg-2.9.1+25w14craftmine-fabric" = _jgWZzb8S;
        "pkg-2.9.1+25w14craftmine-neoforge" = _4qxwI1rJ;
        "pkg-2.9.1+1.21.6-pre1-fabric" = _IH2Jzrsp;
        "pkg-2.9.1+1.21.6-fabric" = _PUPeQXja;
        "pkg-2.9.1+1.21.6-neoforge" = _4aCLfujA;
        "default" = _4aCLfujA;
    });
