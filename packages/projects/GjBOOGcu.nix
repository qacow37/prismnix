...
let
    ...
    in {
        ...
        "pkg-1.9.8" = _rFTVZJrg;
        "pkg-1.9.9" = _7NTzlQT9;
        "pkg-1.9.10" = _XbcplunD;
        "pkg-1.9.12" = _r6GNpjNQ;
        "pkg-2.0.0" = _3v9lxa9I;
        "pkg-2.1.0" = _h1EHVGNQ;
        "pkg-2.0.1" = _GMfHzmOv;
        "pkg-2.1.1" = _pGNpFPnp;
        ...
        "pkg-2.0.8" = _BanJG4ha;
        "pkg-2.0.9" = _wHStOSou;
        "pkg-2.0.10" = _c8jUEPIn;
        "pkg-2.1.10" = _rjCi8ldb;
        "pkg-2.0.12" = _vjieUAmu;
        "pkg-2.1.12" = _N1kjCtAn;
        "pkg-2.0.13" = _ILgRnARc;
        "pkg-2.1.13" = _jae8g41G;
        "pkg-2.0.14" = _LgloIO1o;
        "pkg-2.1.14" = _BlLbWvlD;
        "pkg-2.0.15" = _WJj4CvuQ;
        "pkg-2.1.15" = _jz3ALGge;
        "pkg-2.0.16" = _vPBxxis0;
        "pkg-2.1.16" = _ZlP83IVa;
        "pkg-2.0.17" = _Y9gWWAjV;
        "pkg-2.1.17" = _VQKV7rV0;
        "pkg-2.0.18" = _adzLFs8p;
        "pkg-2.1.18" = _FWsZ73MD;
        "pkg-2.0.19" = _BCFlCk7v;
        "pkg-2.1.19" = _Moxyn6R6;
        "pkg-2.2.0" = _h3R2w9qa;
        "pkg-2.2.1" = _6S3HLdhu;
        "pkg-2.0.20" = _6b6BQxZ7;
        "pkg-2.2.2" = _tHrkJfIn;
        "pkg-2.0.21" = _lNEj9BhY;
        "pkg-2.2.3" = _ecvlc2En;
        "pkg-2.0.22" = _vKC0E4lN;
        "pkg-2.2.4" = _dhoIF8u3;
        "pkg-2.0.23" = _d4eoSE5M;
        "pkg-2.2.5" = _mOjOpNBE;
        "pkg-2.0.24" = _wNzY8Va3;
        "pkg-2.0.25" = _X0MCBQxf;
        "pkg-2.2.6" = _hgGXCpTz;
        "pkg-2.0.26" = _VPJpyV8N;
        "pkg-2.0.27" = _Od5UneC0;
        "pkg-2.2.7" = _cq8kf8vM;
        "pkg-2.2.8" = _ngMRyWAw;
        "pkg-2.2.9" = _3TJoUz0m;
        "pkg-2.0.28" = _A6t8fQlW;
        "pkg-2.0.29" = _7y8mh8Bi;
        "pkg-2.0.30" = _LshFt3pi;
        "pkg-2.2.10" = _qH9qtyow;
        "pkg-2.2.11" = _I1T6ciJ4;
        "pkg-2.0.32" = _FlOt4iDu;
        "pkg-2.0.33" = _avP8TlxY;
        "pkg-2.0.34" = _kKFBWIN0;
        "pkg-2.0.35" = _4KBsj3ma;
        "pkg-2.2.12" = _NQDKLnsf;
        "pkg-2.0.36" = _DDfkZ7ha;
        "pkg-2.2.13" = _AweqsGiS;
        "pkg-2.0.37" = _MuXsyjWC;
        "pkg-2.2.14" = _S5I4r5jh;
        "pkg-2.0.38" = _qFd4N5Wr;
        "pkg-2.2.15" = _fyTZITwR;
        "pkg-2.0.39" = _UVKwJ0DS;
        "pkg-2.2.16" = _JA9uV6Mw;
        "pkg-2.0.40" = _NbDzRY3a;
        "pkg-2.0.42" = _BZZva8WS;
        "pkg-2.2.17" = _iFeu9T4F;
        "pkg-2.0.43" = _Hi4VNBHt;
        "pkg-2.0.45" = _fAsGnDjt;
        "pkg-2.2.18" = _gYCMFsep;
        "pkg-2.0.46" = _yMonBFMq;
        "pkg-2.2.19" = _qVZMx5ty;
        "pkg-2.0.47" = _63d6R05y;
        "pkg-2.0.48" = _8tkR5ARK;
        "pkg-2.0.49" = _kS3WxEB9;
        "pkg-2.2.20" = _Q35GZlhr;
        "pkg-2.0.52" = _cqCG87T3;
        "pkg-2.0.53" = _dASCejss;
        "pkg-2.0.54" = _28k0c2x1;
        "pkg-2.0.55" = _AUwvcanI;
        "default" = _AUwvcanI;
    });
