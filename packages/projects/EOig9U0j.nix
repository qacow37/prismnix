...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _714DtfNW;
        "pkg-v4.0.2-1.19.2-Forge" = _JH6PHjLS;
        "pkg-v4.0.2-1.19.2-Fabric" = _ga8MhiAO;
        "pkg-v4.0.3-1.19.2-Fabric" = _ScYPmGl2;
        "pkg-v4.0.3-1.19.2-Forge" = _xiH2XGVy;
        "pkg-v5.0.0-1.19.3-Fabric" = _Cj3Zhcay;
        "pkg-v5.0.0-1.19.3-Forge" = _dyunQyeX;
        "pkg-v6.0.0-1.19.4-Fabric" = _gqYXib4X;
        "pkg-v6.0.0-1.19.4-Forge" = _WGFUTnsb;
        "pkg-v7.0.0-1.20-Forge" = _xTKh8vrZ;
        "pkg-v7.0.0-1.20-Fabric" = _VLDACnTa;
        "pkg-v8.0.0-1.20.1-Forge" = _4op6LZEK;
        "pkg-v8.0.0-1.20.1-Fabric" = _tCw8RpfZ;
        "pkg-v20.4.0-1.20.4-Fabric" = _mqe3MdvN;
        "pkg-v20.4.0-1.20.4-Forge" = _Bk7NBiov;
        "pkg-v20.4.0-1.20.4-NeoForge" = _vIAyti9l;
        "pkg-v20.4.1-1.20.4-Fabric" = _aczqWm9D;
        "pkg-v20.4.1-1.20.4-Forge" = _GtIyxWMO;
        "pkg-v20.4.1-1.20.4-NeoForge" = _togVOSPM;
        "pkg-v21.0.0-1.21-Fabric" = _VOtYCYxV;
        "pkg-v21.0.0-1.21-NeoForge" = _MFsrniyK;
        "pkg-v21.1.0-1.21.1-Fabric" = _pxuwney2;
        "pkg-v21.1.0-1.21.1-NeoForge" = _GOAgiH0l;
        "pkg-v21.3.0-1.21.3-Fabric" = _2i0qpaC5;
        "pkg-v21.3.0-1.21.3-NeoForge" = _LGuAEyye;
        "pkg-v21.4.0-1.21.4-Fabric" = _I8P6qFjB;
        "pkg-v21.4.0-1.21.4-NeoForge" = _oPjXiswS;
        "pkg-v21.5.0-1.21.5-Fabric" = _YVyLEq8K;
        "pkg-v21.5.0-1.21.5-NeoForge" = _r96kT3xE;
        "pkg-v21.6.0-1.21.6-Fabric" = _d0tN6rQZ;
        "pkg-v21.6.0-1.21.6-NeoForge" = _AgGu53hS;
        "pkg-v21.7.0-1.21.7-Fabric" = _jxLPMVOv;
        "pkg-v21.7.0-1.21.7-NeoForge" = _66PsFD3a;
        "pkg-v21.8.0-1.21.8-Fabric" = _alDzMEIw;
        "pkg-v21.8.0-1.21.8-NeoForge" = _yuqw1Jut;
        "pkg-21.9.0" = _BA6yCkAE;
        "pkg-21.10.0" = _69cgK7Lo;
