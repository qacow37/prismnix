...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.6.2.0b-fabric" = _TltpeMiy;
        "pkg-1.20.1-1.6.2" = _OvRVC914;
        "pkg-1.20.1-1.6.2.0c-fabric" = _ks2JyNvN;
        "pkg-1.20.1-1.6.2.0d-fabric" = _X345cRey;
        "pkg-1.20.1-1.6.2.0f-fabric" = _7KGzYX0w;
        "pkg-1.20.1-1.6.2.0g-fabric" = _I01VpnzR;
        "pkg-1.20.1-1.6.2.0i-fabric" = _uUS17IK6;
        "pkg-1.20.1-1.6.2.1-fabric" = _yPPTybYc;
        "pkg-1.20.1-1.6.2.1b-fabric" = _eNnrHwKO;
        "pkg-1.20.1-1.6.3" = _59Xhi91C;
        "pkg-1.20.1-1.6.3-fabric" = _J9NeSfqm;
        "pkg-1.20.1-1.6.3.0b-fabric" = _sL7telRE;
        "pkg-1.20.1-1.6.4" = _h7tcKjRE;
        "pkg-1.20.1-1.6.5" = _zFSV53nE;
        "pkg-1.20.1-1.6.5.1" = _hmpAzpC1;
        "pkg-1.20.1-1.6.6" = _Qf7QgrTh;
        "pkg-1.7.0" = _FSc5yaSt;
        "pkg-1.7.1" = _nHHS815w;
        "pkg-1.7.2" = _jXmJQMxy;
        "pkg-1.20.1-1.6.7" = _U88VbrNU;
        "pkg-1.7.3" = _mLfHXyLG;
        "pkg-1.7.3.1" = _DPwO66EL;
        "pkg-1.8.2" = _BIbVs1fo;
        "default" = _BIbVs1fo;
    });
