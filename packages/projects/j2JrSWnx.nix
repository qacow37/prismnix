...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _h61TE3Cm;
        "pkg-1.9.2" = _LXOV9Qms;
        "pkg-1.10.0" = _v43KFpVx;
        "pkg-1.10.1" = _XCxdEHn1;
        "pkg-1.10.2" = _uUV1FBtc;
        "pkg-1.10.3" = _KtOhscTl;
        "pkg-1.10.4" = _1BuSWZdr;
        "pkg-1.11.0" = _mIU5vyW5;
        "pkg-1.11.1" = _J5ITvzDy;
        "pkg-1.11.2" = _kIbKFmil;
        "pkg-1.11.3" = _kUaNoEm5;
        "pkg-1.12.0" = _hLZORmxc;
        "default" = _hLZORmxc;
    });
