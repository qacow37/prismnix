...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19" = _FBF1osil;
        "pkg-1.1.0+1.19" = _NlqhjyCI;
        "pkg-1.2.0+1.18" = _Tne4pAY5;
        "pkg-1.2.0+1.19" = _RdGeOLDB;
        "pkg-1.2.1+1.19" = _XcYpP7ig;
        "pkg-1.2.2+1.18" = _LactAtLB;
        "pkg-1.2.2+1.19" = _afCcLQ1c;
        "pkg-1.2.3+1.18.2" = _DtlcR4vt;
        "pkg-1.2.3+1.19" = _5O3dPR9X;
        "pkg-1.3.0+1.19" = _KzcdQ9FU;
        "pkg-1.3.0+1.18.2" = _oIbVdzDn;
        "pkg-1.3.1+1.18.2" = _q0stzwqc;
        "pkg-1.3.1+1.19" = _htOChW49;
        "pkg-1.3.2+1.18.2" = _sRNui8uR;
        "pkg-1.3.2+1.19" = _65fVXLz3;
        "pkg-1.3.3+1.17.1" = _5te3CHsv;
        "pkg-1.3.3+1.18.2" = _2NVQ8FN1;
        "pkg-1.3.3+1.19" = _O7xueryC;
        "pkg-2.0.0+1.18.2-forge" = _wK9XqoTM;
        "pkg-2.0.0+1.18.2-fabric" = _5GlNCgf2;
        "pkg-2.0.0+1.19-forge" = _KigHzrzN;
        "pkg-2.0.0+1.19-fabric" = _1sryaevE;
        "pkg-2.0.1+1.18.2-forge" = _sx58gc3e;
        "pkg-2.0.1+1.18.2-fabric" = _By23e8Rx;
        "pkg-2.0.1+1.19-forge" = _efjOZLaq;
        "pkg-2.0.1+1.19-fabric" = _ydgYYE9t;
        "pkg-2.0.2+1.18.2-forge" = _2LAYV4Yy;
        "pkg-2.0.2+1.18.2-fabric" = _l1OtiztH;
        "pkg-2.0.2+1.19-forge" = _pSUyYuUs;
        "pkg-2.0.2+1.19-fabric" = _yEP0r6Ew;
        "pkg-2.0.3+1.18.2-forge" = _A6VLpD97;
        "pkg-2.0.3+1.18.2-fabric" = _D1sCy5H6;
        "pkg-2.0.3+1.19-forge" = _bR8uktFD;
        "pkg-2.0.3+1.19-fabric" = _veIjf9eb;
        "pkg-2.1.0+1.18.2-forge" = _vzw5YS5Z;
        "pkg-2.1.0+1.18.2-fabric" = _DwcmCwIe;
        "pkg-2.1.0+1.19-forge" = _nrEBLBMS;
        "pkg-2.1.0+1.19-fabric" = _AWbu44WI;
        "pkg-2.2.0+1.18.2-forge" = _ltHynVRp;
        "pkg-2.2.0+1.18.2-fabric" = _2bKiSrV1;
        "pkg-2.2.0+1.19-forge" = _qziJgmV7;
        "pkg-2.2.0+1.19-fabric" = _Ws8I3F28;
        "pkg-2.2.1+1.18.2-forge" = _NrmDUOJh;
        "pkg-2.2.1+1.18.2-fabric" = _u01IgEvL;
        "pkg-2.2.1+1.19-forge" = _KnimXV6c;
        "pkg-2.2.1+1.19-fabric" = _Hfw3cWFy;
        "pkg-2.3.0+1.18.2-forge" = _2nnTjpM4;
        "pkg-2.3.0+1.18.2-fabric" = _vLiy6emu;
        "pkg-2.3.0+1.19-forge" = _SMTZR2CA;
        "pkg-2.3.0+1.19-fabric" = _m0uwZ4Md;
        "pkg-2.3.1+1.18.2-forge" = _udQpOG4e;
        "pkg-2.3.1+1.18.2-fabric" = _psj0IIJ5;
        "pkg-2.3.1+1.19-forge" = _8jV0jGc4;
        "pkg-2.3.1+1.19-fabric" = _15oiPLsb;
        "pkg-2.3.1+1.19.3-fabric" = _UyB2v0D5;
        "pkg-2.3.2+1.18.2-forge" = _xhkQ6rwl;
        "pkg-2.3.2+1.18.2-fabric" = _Va6KeLzG;
        "pkg-2.3.2+1.19-forge" = _sGSmyzfS;
        "pkg-2.3.2+1.19-fabric" = _Eunepnp9;
        "pkg-2.3.2+1.19.3-fabric" = _ehY7RHs7;
        "pkg-2.3.3+1.18.2-forge" = _rNLVNbXo;
        "pkg-2.3.3+1.18.2-fabric" = _v0Hg3qaE;
        "pkg-2.3.3+1.19-forge" = _kLZwBJcX;
        "pkg-2.3.3+1.19-fabric" = _cQpF8MVo;
        "pkg-2.3.3+1.19.3-fabric" = _XqkJ2I6G;
        "pkg-2.3.4+1.18.2-forge" = _Pbsj8g4U;
        "pkg-2.3.4+1.18.2-fabric" = _WJIph4ys;
        "pkg-2.3.4+1.19-forge" = _jS3Nv7i1;
        "pkg-2.3.4+1.19-fabric" = _wTBxfiYI;
        "pkg-2.3.4+1.19.3-fabric" = _9mMDXR35;
        "pkg-2.4.0+1.18.2-forge" = _sOAes0g5;
        "pkg-2.4.0+1.18.2-fabric" = _ZIVSKDMl;
        "pkg-2.4.0+1.19-forge" = _pPjoi45i;
        "pkg-2.4.0+1.19-fabric" = _UA9IRVr3;
        "pkg-2.4.0+1.19.3-forge" = _XjYxU38d;
        "pkg-2.4.0+1.19.3-fabric" = _pcOcGh6r;
        "pkg-2.5.0+1.18.2-forge" = _au3ce2ic;
        "pkg-2.5.0+1.18.2-fabric" = _i3cCcNIa;
        "pkg-2.5.0+1.19-forge" = _jhwKfxBc;
        "pkg-2.5.0+1.19-fabric" = _thu8z32t;
        "pkg-2.5.0+1.19.3-forge" = _oPsCVHAx;
        "pkg-2.5.0+1.19.3-fabric" = _oszZ7uZz;
        "pkg-2.5.1+1.18.2-forge" = _6N2mSGPm;
        "pkg-2.5.1+1.18.2-fabric" = _EWRGHy3g;
        "pkg-2.5.1+1.19-forge" = _QKDc4J7Z;
        "pkg-2.5.1+1.19-fabric" = _XjHa44dr;
        "pkg-2.5.1+1.19.3-forge" = _piNWn5F8;
        "pkg-2.5.1+1.19.3-fabric" = _9nFs4ToQ;
        "pkg-2.5.2+1.18.2-forge" = _nw0hSXru;
        "pkg-2.5.2+1.18.2-fabric" = _a2ikZBtM;
        "pkg-2.5.2+1.19-forge" = _D6DdoR3w;
        "pkg-2.5.2+1.19-fabric" = _DNIT5vUX;
        "pkg-2.5.2+1.19.3-forge" = _E6Rqbi6I;
        "pkg-2.5.2+1.19.3-fabric" = _lmCjE3pH;
        "pkg-2.5.3+1.18.2-forge" = _HzO2s9YI;
        "pkg-2.5.3+1.18.2-fabric" = _JdhmWEXC;
        "pkg-2.5.3+1.19-forge" = _8Z6qjSak;
        "pkg-2.5.3+1.19-fabric" = _9mAq86OS;
        "pkg-2.5.3+1.19.3-forge" = _QXFEoWz0;
        "pkg-2.5.3+1.19.3-fabric" = _B7cLLqEG;
        "pkg-2.6.0+1.18.2-fabric" = _p2kiit3r;
        "pkg-2.6.0+1.19-forge" = _Tw7IzpBC;
        "pkg-2.6.0+1.19-fabric" = _49BAMaJx;
        "pkg-2.6.0+1.19.3-forge" = _qYn0YE9S;
        "pkg-2.6.0+1.19.3-fabric" = _FGguxlbf;
        "pkg-2.6.1+1.18.2-fabric" = _hxUi39OJ;
        "pkg-2.6.1+1.19-forge" = _9oeV1gFl;
        "pkg-2.6.1+1.19-fabric" = _e1JDHe9b;
        "pkg-2.6.1+1.19.3-forge" = _50i0VClG;
        "pkg-2.6.1+1.19.3-fabric" = _Vm945UCb;
        "pkg-2.6.2+1.18.2-fabric" = _eE2kjsho;
        "pkg-2.6.2+1.19-forge" = _nybnGUJv;
        "pkg-2.6.2+1.19-fabric" = _2GZpcF7N;
        "pkg-2.6.2+1.19.3-forge" = _BbZhZNIX;
        "pkg-2.6.2+1.19.3-fabric" = _NeQj3Fz9;
        "pkg-2.6.3+1.19.4-fabric" = _gtLI94FF;
        "pkg-2.7.0+1.19.4-forge" = _fkl7bxl7;
        "pkg-2.7.0+1.19.4-fabric" = _jD6tD3Ck;
        "pkg-2.7.1+1.19.4-forge" = _HsKAadOS;
        "pkg-2.7.1+1.19.4-fabric" = _jveY9zir;
        "pkg-2.7.2+1.19.4-forge" = _CNM3smnf;
        "pkg-2.7.2+1.19.4-fabric" = _7a5Vl6bt;
        "pkg-2.7.3+1.19.4-forge" = _rIfOMh9m;
        "pkg-2.7.3+1.19.4-fabric" = _c8TlDgSJ;
        "pkg-2.7.4+1.19.4-forge" = _uNVp4YAh;
        "pkg-2.7.4+1.19.4-fabric" = _2f37LU7J;
        "pkg-2.7.5+1.19.4-fabric" = _1CTfnpHI;
        "pkg-2.8.0+1.19.4-fabric" = _lPiCk49y;
        "pkg-2.8.1+1.19.4-fabric" = _QcCmwDIK;
        "pkg-2.8.2+1.19.4-fabric" = _IfRYowB0;
        "pkg-2.8.3+1.19.4-fabric" = _cXepeLYw;
        "pkg-3.0.0-beta.1+1.20-fabric" = _iclteRK7;
        "pkg-3.0.0-beta.2+1.20-fabric" = _AK6qVse9;
        "pkg-3.0.0+1.19.4-fabric" = _ln8C5QJj;
        "pkg-3.0.0+1.20-fabric" = _Ws6fWaHi;
        "pkg-3.0.1+1.19.4-fabric" = _B47f6kqW;
        "pkg-3.0.1+1.20-fabric" = _gbxieggJ;
        "pkg-3.0.2+1.19.4-fabric" = _5wwdjkF4;
        "pkg-3.0.2+1.20-fabric" = _6sLkwKoK;
        "pkg-3.1.1+1.19.4-fabric" = _BdBAMCep;
        "pkg-3.1.1+1.20-fabric" = _3trypJmH;
        "pkg-3.1.2+1.19.4-fabric" = _zFfB9gke;
        "pkg-3.1.2+1.20-fabric" = _xXQOdU31;
        "pkg-3.1.3+1.19.4-fabric" = _YcHNDCOO;
        "pkg-3.1.3+1.20-fabric" = _hZ2m2dCd;
        "pkg-3.2.0+1.19.4-fabric" = _aMOITkqD;
        "pkg-3.2.0+1.20-fabric" = _TN8tlPYz;
        "pkg-3.3.0+1.20-fabric" = _JCUASO47;
        "pkg-3.3.1+1.20-fabric" = _BEgYscT7;
        "pkg-3.3.2+1.20-fabric" = _IQXyiTai;
        "pkg-3.3.3+1.20-fabric" = _xrNZLxUL;
        "pkg-3.3.4+1.19.4-fabric" = _uzOm8tez;
        "pkg-3.3.4+1.20-fabric" = _kRrQPKRd;
        "pkg-3.3.5+1.19.4-fabric" = _PJCutXpv;
        "pkg-3.3.5+1.20-fabric" = _cjOnrxD6;
        "pkg-3.3.6+1.20-fabric" = _o2ffIR7z;
        "pkg-3.3.7+1.19.4-fabric" = _vLGZctV5;
        "pkg-3.3.7+1.20-fabric" = _UI3NfPIy;
        "pkg-3.3.7+1.20.2-fabric" = _hsg4BN2T;
        "pkg-3.3.8+1.20-fabric" = _S0QngIQM;
        "pkg-3.3.8+1.20.2-fabric" = _Tc6hshn5;
        "pkg-3.3.8+1.19.4-fabric" = _s4zNwCf2;
        "pkg-3.3.8+1.20.4" = _34jQR2SU;
        "pkg-3.4.0+1.20.1-forge" = _Rboy7btV;
        "pkg-3.5.0+1.20.1-forge" = _jB6dU7ir;
        "pkg-3.5.1+1.20.1-fabric" = _zzTTYEGP;
        "pkg-3.5.1+1.20.1-forge" = _yqGJz0MG;
        "pkg-3.5.2+1.20.1-fabric" = _oExHpF2v;
        "pkg-3.5.2+1.20.1-forge" = _5mn6dm6c;
        "pkg-3.5.3+1.20.1-forge" = _VFrYSyNB;
        "pkg-3.5.3+1.20.1-fabric" = _GSWLE8Yp;
        "pkg-3.5.4+1.20.1-forge" = _jxec8n0p;
        "pkg-3.5.4+1.20.1-fabric" = _rzK5er8a;
        "pkg-3.5.4+1.20.4-neoforge" = _QTZWPLMO;
        "pkg-3.5.4+1.20.4-fabric" = _eyGO4rWH;
        "pkg-3.5.5+1.20.1-forge" = _oLVOsTht;
        "pkg-3.5.5+1.20.1-fabric" = _RlVXmJeD;
        "pkg-3.5.6+1.20.4-fabric" = _9xcYWEMM;
        "pkg-3.5.6+1.20.4-neoforge" = _5OZhAiaw;
        "pkg-3.5.6+1.20.1-fabric" = _pJSq0gmP;
        "pkg-3.5.6+1.20.1-forge" = _VH8QpKA5;
        "pkg-3.5.6+1.20.6-fabric" = _swE82BGE;
        "pkg-3.5.7+1.20.6-fabric" = _vhbUNxBk;
        "pkg-3.5.8+1.20.6-fabric" = _1alzQQhn;
        "pkg-3.5.9+1.20.6-fabric" = _l4f77JZk;
        "pkg-3.5.10+1.20.6-fabric" = _RkvZ8dFD;
        "pkg-3.6.0+1.20.6-fabric" = _VhftET6c;
        "pkg-3.6.0+1.20.1-fabric" = _iKLtnuLB;
        "pkg-3.6.0+1.20.4-fabric" = _vnywyrWt;
        "pkg-3.6.0+1.20.4-neoforge" = _eVfj9RoR;
        "pkg-3.6.1+1.21-fabric" = _CJFnOoi0;
        "pkg-3.6.1+1.20.1-fabric" = _CuLlUIYD;
        "pkg-3.6.2+1.21-fabric" = _OjBr3egj;
        "pkg-3.7.0+1.21-neoforge" = _DDcKiuOR;
        "pkg-3.7.0+1.21-fabric" = _5jCmYvxp;
        "pkg-3.7.1+1.21-neoforge" = _2huzzRzW;
        "pkg-3.7.1+1.21-fabric" = _hwWjHEKD;
        "pkg-3.7.2+1.21-fabric" = _cjzbJxI2;
        "pkg-3.7.2+1.21-neoforge" = _y8jv7s49;
        "pkg-3.8.0+1.21.2-fabric" = _xMjXb8O3;
        "pkg-3.8.1+1.21.2-fabric" = _oadY9xkk;
        "pkg-3.8.1+1.21.4-fabric" = _UitUD6VJ;
        "pkg-3.7.3+1.21-fabric" = _vBXl66wc;
        "pkg-3.7.3+1.21-neoforge" = _Zj604q5O;
        "pkg-3.8.1+1.21.5-fabric" = _V0e6gDT5;
        "pkg-3.8.1+1.21.6-fabric" = _IM6knaKg;
        "pkg-3.8.2+1.21.6-fabric" = _7nUPwWUG;
        "pkg-3.8.3+1.21.6-fabric" = _REB9EGpL;
        "pkg-3.8.3+1.21.9-fabric" = _SSvdU922;
        "pkg-3.8.3+1.21.11-fabric" = _QyuEXDMC;
