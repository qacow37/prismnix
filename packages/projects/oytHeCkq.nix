...
let
    ...
    in {
        ...
        "pkg-neoforge-1.21.1-1.0.0" = _DusvW4Bw;
        "pkg-forge-1.20.1-1.0.0" = _8cH3J0bX;
        "pkg-fabric-1.20.1-1.0.0" = _tbPH1uVk;
        "pkg-fabric-1.21.5-1.0.0" = _KPOo3M9z;
        "pkg-fabric-1.21.4-1.0.0" = _n18Z7Wqz;
        "pkg-fabric-1.21.1-1.0.0" = _TPpECjwz;
        "default" = _TPpECjwz;
    });
