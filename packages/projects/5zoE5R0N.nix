...
let
    ...
    in {
        ...
        "pkg-1.0.0-unofficial-7-SNAPSHOT-2" = _995QopNV;
        "pkg-1.16.5-1.0.0-unofficial-7-S2F1" = _UP7s6pan;
        "pkg-1.0.0-unofficial-7-S2F1" = _4QVxsgRi;
        "pkg-1.0.2-pre-1" = _6eAcBbyV;
        "pkg-1.0.2-pre-2" = _xQzQ7uj0;
        "pkg-1.0.2-pre-3" = _LWZT8ygd;
        "pkg-1.0.2-pre-3+26.2s1" = _366fKHvH;
        "pkg-1.0.2-pre-4+1.20.1" = _fixYy7Ci;
        "pkg-1.0.2-pre-4+1.21.1" = _CeWhzN5z;
        "pkg-1.0.2-pre-4+1.21.8" = _PDtWJDj5;
        "pkg-1.0.2-pre-4+1.21.10" = _A262dlpY;
        "pkg-1.0.2-pre-4+1.21.11" = _1iR5a15W;
        "pkg-1.0.2-pre-4+26.1" = _Ka92ufAl;
        "pkg-1.0.2-pre-4+26.2s1" = _9oqRpm7f;
        "pkg-1.0.2-rc-1+1.20.1" = _J2OefyPA;
        "pkg-1.0.2-rc-1+1.21.1" = _vAtudM0W;
        "pkg-1.0.2-rc-1+1.21.8" = _Fw9p4uxD;
        "pkg-1.0.2-rc-1+1.21.10" = _UUbfUrve;
        "pkg-1.0.2-rc-1+1.21.11" = _XTBzGNzM;
        "pkg-1.0.2-rc-1+26.1" = _HD0SFo3N;
        "pkg-1.0.2-rc-1+26.2s1" = _gXxm5wKp;
        "pkg-1.0.2+1.20.1" = _PkOPng9B;
        "pkg-1.0.2+1.21.1" = _zn7bwY52;
        "pkg-1.0.2+1.21.8" = _guTdGw9v;
        "pkg-1.0.2+1.21.10" = _dXd9UB4k;
        "pkg-1.0.2+1.21.11" = _nx0r8YRS;
        "pkg-1.0.2+26.1" = _XzMyzj39;
        "pkg-1.0.2+26.2s1-2" = _J8LwH3fS;
        "pkg-1.0.2+26.2s3" = _k58tbqoE;
        "pkg-1.0.2+26.2s7" = _PfTMGcFO;
        "pkg-1.0.3+1.20.1" = _dgf1hc4m;
        "pkg-1.0.3+1.21.1" = _eKMhrNP6;
        "pkg-1.0.3+1.21.8" = _9b3VCL5L;
        "pkg-1.0.3+1.21.10" = _kJgvB63A;
        "pkg-1.0.3+1.21.11" = _59pkHqJS;
        "pkg-1.0.3+26.1.x" = _V2K4UMPU;
        "pkg-1.0.3+26.2pre" = _QLyb8qrj;
        "default" = _QLyb8qrj;
    });
