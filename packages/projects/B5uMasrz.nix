...
let
    ...
    in {
        ...
        "pkg-0.9.0-beta.1+1.20.1-fabric" = _USuDYCEC;
        "pkg-0.9.0-beta.1+1.20.2-fabric" = _vu1oDmCJ;
        "pkg-0.9.0-beta.1+1.20.2-forge" = _ISqtokpK;
        "pkg-0.9.0-beta.1+1.20.1-forge" = _uQyJAqKe;
        "pkg-0.10.0-beta.1+1.20.6" = _PXK3FYWO;
        "default" = _PXK3FYWO;
    });
