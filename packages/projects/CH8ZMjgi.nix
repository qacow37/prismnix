...
let
    ...
    in {
        ...
        "pkg-Forge-1.15.0" = _XW2IHpaQ;
        "pkg-Forge-2.8.0" = _W9tbTnf9;
        "pkg-Forge-3.8.0" = _H7g8qoSd;
        "pkg-Forge-6.1.0" = _oxsHMG9T;
        "pkg-Forge-2.8.1" = _7SmsjL58;
        "pkg-Forge-7.1.0" = _FaLVR76c;
        "pkg-Forge-7.2.0" = _wTO1vKa4;
        "pkg-Forge-2.10.0" = _uWE3QdZU;
        "pkg-Fabric-2.3.0" = _FkvOyinF;
        "pkg-Fabric-3.3.0" = _H6MNLwWZ;
        "pkg-Fabric-2.3.1" = _Z3RZmQjX;
        "pkg-Fabric-3.3.1" = _Bwxv7Y9t;
        "pkg-Fabric-6.2.0" = _lMNUoniG;
        "pkg-Fabric-7.3.0" = _J96lHYvL;
        "pkg-Fabric-2.4.0" = _u9BVjtaj;
        "pkg-Fabric-3.4.0" = _y4mnwIch;
        "pkg-Fabric-6.3.0" = _NoLZmdIl;
        "pkg-Fabric-7.4.0" = _TnjkYI4C;
        "pkg-Forge-1.16.0" = _m0Vsiz5l;
        "pkg-2.12.0" = _MzO7zIT2;
        "pkg-3.9.0" = _scqIv981;
        "pkg-Forge-6.2.0" = _SyEsD5OI;
        "pkg-Forge-7.3.0" = _FR3TVomW;
        "pkg-Forge-1.17.0" = _1mYezH37;
        "pkg-Forge-2.13.0" = _VzRoCyBg;
        "pkg-Forge-3.10.0" = _PR8GEToK;
        "pkg-Forge-7.4.0" = _c1CLWpLY;
        "pkg-Forge-1.18.0" = _4ZBJQgPa;
        "pkg-Forge-2.14.0" = _za1LTqEH;
        "pkg-Forge-3.11.0" = _gPUGXNH6;
        "pkg-Fabric-2.5.0" = _y9mJMC0l;
        "pkg-Fabric-3.5.0" = _uepH2CEr;
        "pkg-Fabric-7.5.0" = _mJOYH7C2;
        "pkg-Forge-1.21.0" = _DprLdGst;
        "pkg-Forge-2.17.0" = _jzYRtcXU;
        "pkg-Forge-3.13.0" = _eC2hHHWR;
        "pkg-Forge-7.9.0" = _1QIkRSbw;
        "pkg-Fabric-2.8.0" = _mB5Z4QVV;
        "pkg-Fabric-3.7.0" = _E1YCIP11;
        "pkg-Fabric-7.8.0" = _18mBcZNH;
        "pkg-Forge-1.21.1" = _NoJox2oP;
        "pkg-Forge-2.24.0" = _s3JGr4J3;
        "pkg-Forge-3.25.0" = _hvyG0xwV;
        "pkg-Forge-7.22.0" = _5AWhYLDO;
        "pkg-Fabric-2.11.0" = _svhBMFOx;
        "pkg-Fabric-3.11.0" = _m0m3oLNE;
        "pkg-Fabric-7.12.0" = _T3P3Dlnb;
        "pkg-Forge-1.21.2" = _FPqrXVbE;
        "pkg-Forge-2.25.0" = _xlVt60ZS;
        "pkg-Forge-3.28.0" = _AoSATZov;
        "pkg-Forge-7.28.0" = _jvNOTFBu;
        "pkg-Fabric-2.12.0" = _MnXnYqif;
        "pkg-Fabric-3.12.0" = _GQChkbkD;
        "pkg-Fabric-7.13.0" = _kg1bNxht;
        "pkg-Forge-1.21.3" = _rw9iNThn;
        "pkg-Forge-2.25.1" = _TgoessHh;
        "pkg-Forge-3.28.1" = _1JyVJLUG;
        "pkg-Forge-7.28.1" = _Ch00SWdU;
        "pkg-Fabric-2.12.1" = _6adbF1w3;
        "pkg-Fabric-3.12.1" = _UHnRmOL1;
        "pkg-Fabric-7.13.1" = _TB2aN2Nx;
        "pkg-Forge-2.25.2" = _ueJ0jo3r;
        "pkg-Fabric-2.12.2" = _kgu201Nx;
        "pkg-NeoForge-14.28.0" = _4QDdUHD2;
        "pkg-Fabric-14.12.0" = _b8SPxlpJ;
        "pkg-Forge-2.29.0" = _bgAV6l34;
        "pkg-Forge-3.33.0" = _3wulKw4y;
        "pkg-Forge-7.36.1" = _IHgMGfMq;
        "pkg-Fabric-2.14.0" = _nc0UbjB0;
        "pkg-Fabric-3.14.0" = _kCOI68Wo;
        "pkg-Fabric-7.15.1" = _K3R62QM0;
        "pkg-Fabric-14.14.0" = _RGaW5Rnt;
        "pkg-NeoForge-14.35.0" = _niMOci6G;
        "pkg-Forge-7.36.2" = _obBtMzLh;
        "pkg-NeoForge-14.35.1" = _6FUwidrT;
        "pkg-Forge-15.40.0" = _TFSLIPLW;
        "pkg-Fabric-15.16.0" = _DBdSfHEC;
        "default" = _DBdSfHEC;
    });
