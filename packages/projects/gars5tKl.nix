...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0.0-Fabric" = _KVd6OUm5;
        "pkg-1.20.4-1.0.0-NeoForge" = _JRfPofHD;
        "pkg-1.20.4-1.0.0-Forge" = _EWg8gNEF;
        "pkg-1.20.4-1.1.0-Fabric" = _qBhVOKNM;
        "pkg-1.20.4-1.1.0-NeoForge" = _n21VpADH;
        "pkg-1.20.4-1.1.0-Forge" = _Fd8eifXb;
        "pkg-1.18.2-1.1.1-Fabric" = _CGh1JyAc;
        "pkg-1.18.2-1.1.1-Forge" = _pkHUtzro;
        "pkg-1.19.3-1.1.1-Fabric" = _dvLl56HO;
        "pkg-1.19.3-1.1.1-Forge" = _UwPmoHqx;
        "pkg-1.20.4-1.1.1-Fabric" = _KgsIRAvR;
        "pkg-1.20.4-1.1.1-NeoForge" = _QtKzhkS0;
        "pkg-1.20.4-1.1.1-Forge" = _QGZYuQ6d;
        "pkg-1.19.3-1.1.2-Fabric" = _Q2PlH2ZL;
        "pkg-1.19.3-1.1.2-Forge" = _QuiJqceX;
        "pkg-1.18.2-1.1.2-Fabric" = _uc2V4aWo;
        "pkg-1.18.2-1.1.2-Forge" = _EjzidC3g;
        "pkg-1.20.6-1.1.2-NeoForge" = _fj0fPdfJ;
        "pkg-1.20.6-1.1.2-Fabric" = _cO8gvNFA;
        "pkg-1.20.6-1.1.2-Forge" = _Cbh03RW3;
        "pkg-1.20.4-1.1.2-NeoForge" = _t1SpWmSn;
        "pkg-1.20.4-1.1.2-Fabric" = _Y3VIA4ii;
        "pkg-1.20.4-1.1.2-Forge" = _ew2Kc0TX;
        "pkg-1.21-1.1.2-NeoForge" = _TNxphVCa;
        "pkg-1.21-1.1.2-Fabric" = _ItbXkVgy;
        "pkg-1.21-1.1.2-Forge" = _Km3X0XpN;
        "pkg-1.21.1-1.1.2-NeoForge" = _d1o00HZ6;
        "pkg-1.21.1-1.1.2-Fabric" = _18QwPo65;
        "pkg-1.21.1-1.1.2-Forge" = _BwKnnNHe;
        "pkg-1.21.1-1.1.3-NeoForge" = _b2flAY30;
        "pkg-1.21.1-1.1.3-Fabric" = _lkjSSxVf;
        "pkg-1.21.1-1.1.3-Forge" = _Ak5XbfuP;
        "pkg-1.21.3-1.1.3-NeoForge" = _1awJRRZP;
        "pkg-1.21.3-1.1.3-Fabric" = _3XZKE4uD;
        "pkg-1.21.3-1.1.3-Forge" = _JSx4ECT5;
        "pkg-1.21.4-1.1.3-NeoForge" = _n63en94T;
        "pkg-1.21.4-1.1.3-Fabric" = _8H1XJpBR;
        "pkg-1.21.4-1.1.3-Forge" = _J9fzuSxg;
        "pkg-1.18.2-1.1.4-Fabric" = _MhtJxfu3;
        "pkg-1.18.2-1.1.4-Forge" = _VZwUXdaf;
        "pkg-1.19.3-1.1.4-Fabric" = _AeyeEHI9;
        "pkg-1.19.3-1.1.4-Forge" = _1mrJfbDA;
        "pkg-1.20.1-1.1.4-Fabric" = _LNkY8Xys;
        "pkg-1.20.1-1.1.4-Forge" = _RzrXsEvP;
        "pkg-1.20.4-1.1.4-NeoForge" = _wmLeaFWi;
        "pkg-1.20.4-1.1.4-Fabric" = _WnmSiiRX;
        "pkg-1.20.4-1.1.4-Forge" = _ETapuejE;
        "pkg-1.20.6-1.1.4-NeoForge" = _G2saYFyS;
        "pkg-1.20.6-1.1.4-Fabric" = _wZoxHYGr;
        "pkg-1.20.6-1.1.4-Forge" = _nF7TShhA;
        "pkg-1.21.4-1.1.4-NeoForge" = _73JtnyXR;
        "pkg-1.21.4-1.1.4-Fabric" = _MUWUxXSv;
        "pkg-1.21.4-1.1.4-Forge" = _C9n1NatV;
        "pkg-1.21.6-1.1.5-NeoForge" = _Pzap8hA4;
        "pkg-1.21.6-1.1.5-Fabric" = _VfSsiaEj;
        "pkg-1.21.6-1.1.5-Forge" = _d3Lc1cQu;
        "pkg-1.21.7-1.1.5-NeoForge" = _QYyv7sGE;
        "pkg-1.21.7-1.1.5-Fabric" = _x2tcM6gr;
        "pkg-1.21.7-1.1.5-Forge" = _VP4S2IJE;
        "pkg-1.21.5-1.1.5-NeoForge" = _6d9rcz5f;
        "pkg-1.21.5-1.1.5-Fabric" = _XAL6rUKt;
        "pkg-1.21.5-1.1.5-Forge" = _52HPCn78;
        "pkg-1.21.8-1.1.5-NeoForge" = _gJLTRDxs;
        "pkg-1.21.8-1.1.5-Fabric" = _EdyUfonj;
        "pkg-1.21.8-1.1.5-Forge" = _8GtfyZHS;
        "pkg-1.21.10-1.1.6-NeoForge" = _p9o7YTWx;
        "pkg-1.21.10-1.1.6-Fabric" = _KvVcNi4W;
        "pkg-1.21.10-1.1.6-Forge" = _K5JeJJ9V;
        "pkg-1.21.11-1.1.7-NeoForge" = _5XVp31Vr;
        "pkg-1.21.11-1.1.7-Fabric" = _iKjOL6RT;
        "pkg-1.21.11-1.1.7-Forge" = _geIxaqq6;
        "default" = _geIxaqq6;
    });
