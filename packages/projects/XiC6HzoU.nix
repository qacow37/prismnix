...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _9XToMMUs;
        "pkg-1.0.1" = _zHj4eYPM;
        "pkg-1.0.1b" = _o6ZKZUy4;
        "pkg-1.0.2" = _ZpxnuiTS;
        "pkg-1.1.0+fabric" = _wukCCm6S;
        "pkg-1.1.0+forge" = _3wSBmBHu;
        "pkg-1.1.1+fabric" = _IQaWYxks;
        "pkg-1.1.1+forge" = _khjB5qLh;
        "pkg-1.1.2+fabric" = _tlHT9WKt;
        "pkg-1.1.2+forge" = _ScaPoovu;
        "pkg-1.1.3+fabric" = _klPNnsOe;
        "pkg-1.1.3+forge" = _WLcGHp5D;
        "pkg-1.1.4+fabric" = _UKYjvjnD;
        "pkg-1.1.4+forge" = _Y2kfKvXr;
        "pkg-1.1.5+fabric" = _9Qu0MGnH;
        "pkg-1.1.5+forge" = _nVCZVT0i;
        "pkg-1.1.6+fabric" = _FTfjUzVu;
        "pkg-1.1.6+forge" = _5V8JfBma;
        "pkg-1.1.7+fabric" = _WuU4rheE;
        "pkg-1.1.7+forge" = _XtIYEB1p;
        "pkg-1.1.7+neoforge" = _6FBW2eYx;
        "pkg-1.1.8+fabric" = _JMVh3Vb6;
        "pkg-1.1.8+neoforge" = _XMduptKZ;
        "pkg-1.2.0+fabric" = _ELhbZNsE;
        "pkg-1.2.0+forge" = _gLPEZ1Xm;
        "default" = _gLPEZ1Xm;
    });
