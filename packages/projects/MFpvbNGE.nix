...
let
    ...
    in {
        ...
        "pkg-2.0.4beta-1.20.1-fabric" = _KG7xlwoL;
        "pkg-2.0.4beta-1.20.6-fabric" = _FBRldeYd;
        "pkg-2.0.5beta-1.20.6-fabric" = _FiSyTRyw;
        "pkg-2.0.4a-beta-1.20.1-fabric" = _UOjv8wbm;
        "pkg-2.0.6-1.21-fabric" = _Z4YBP67Y;
        "pkg-2.0.7-1.21-fabric" = _dZESeTGM;
        "pkg-2.0.4-b-1.20.1-fabric" = _ZSaUkY0B;
        "pkg-2.0.4-build4-1.20.1-fabric" = _6ol44ejs;
        "pkg-2.0.8-1.21-fabric" = _v0qI49QE;
        "pkg-2.0.9-1.21.3-fabric" = _XoFUfloc;
        "pkg-2.0.10-1.21.4-fabric" = _h3dqu66j;
        "pkg-2.0.11-1.21.4-fabric" = _K3HcCF7w;
        "pkg-2.0.12-1.21.5-fabric" = _bg4qkIRA;
        "pkg-2.0.8-1.21.1-fabric" = _Zyv4rJix;
        "pkg-2.1.0-1.21.5-fabric" = _MWbkUMRG;
        "pkg-2.1.0-1.20.1-fabric" = _3cXBjCfG;
        "pkg-2.1.0-1.21.1-fabric" = _UkTMpSY2;
        "pkg-2.1.1-1.21.6-fabric" = _ZazOWJOh;
        "pkg-2.1.1-1.21.7-fabric" = _ov4Kz6sX;
        "pkg-2.1.1-1.21.8-fabric" = _RdTbo7fa;
        "pkg-fabric-2.1.2+mc1.21.9" = _WlQ92KVH;
        "pkg-fabric-2.1.2+mc1.21.10" = _ht1paDdC;
