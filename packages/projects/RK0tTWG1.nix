...
let
    ...
    in {
        ...
        "pkg-0.4.2" = _ONjHwFAO;
        "pkg-0.4.3" = _bMct2CAT;
        "pkg-1.18.2-v0.4.2" = _YM79yaXI;
        "pkg-1.19-v0.5.0" = _daCeJBND;
        "pkg-1.18.2-v0.5.0" = _ap7ym8Fb;
        "pkg-1.19-v0.6.0" = _DE2ribCA;
        "pkg-1.18.2-v0.6.0" = _6aZAIfLz;
        "pkg-1.19-v0.6.3" = _FBSc3DLj;
        "pkg-1.19-v0.7.0" = _8cUsz5tf;
        "pkg-1.18.2-v0.7.0" = _GczTOiyx;
        "pkg-1.19.x-v0.7.2" = _7wu9nNjR;
        "pkg-1.19.x-v0.8.0" = _J33KAWlc;
        "pkg-1.18.x-v0.8.0" = _f9nsF8mQ;
        "pkg-1.18.x-0.8.5" = _VX02Mydu;
        "pkg-1.19.x-0.8.5" = _ADEAHsBG;
        "pkg-0.8.6" = _WKtvlPxI;
        "pkg-0.8.7" = _AqHmfMbM;
        "pkg-0.9.0" = _59RO9fko;
        "pkg-0.9.1" = _dFaemElB;
        ...
        "pkg-1.1.0" = _z69iEwmB;
        "pkg-1.2.0" = _UfDm3tha;
        "pkg-1.2.3-beta" = _ZMDRTrpq;
        "pkg-1.2.3-beta2" = _8nUlcTx2;
        "pkg-2.0.0" = _G0Wi54lp;
