...
let
    ...
    in {
        ...
        "pkg-1.0" = _TzjguXED;
        "pkg-1.0+mod" = _pC39bcvH;
        "pkg-1.1" = _K30uxakF;
        "pkg-1.1+mod" = _ZSDMvW1A;
        "pkg-1.2" = _9gkQB4Kn;
        "pkg-1.2+mod" = _mocBRxcj;
        "pkg-2.0" = _sZNud1UJ;
        "pkg-2.0+mod" = _2O97vWNo;
        "pkg-3.0" = _QKwGI3oE;
        "pkg-3.0+mod" = _izsu5l5X;
        "pkg-3.1" = _BZCz5RGn;
        "pkg-4.0" = _dpobD8iY;
        "pkg-4.0+mod" = _ulpQJd30;
        "pkg-4.1" = _9OwLE3Xn;
        "pkg-4.1+mod" = _pR91rWDq;
        "pkg-4.2" = _HvZRl3lg;
        "pkg-4.2+mod" = _YCPoWaye;
        "pkg-4.3" = _IsptdKqN;
        "pkg-4.3+mod" = _Dt2bwIK0;
        "pkg-4.4" = _Fq7qOOAQ;
        "pkg-4.4+mod" = _xQlSjJO8;
        "pkg-4.5" = _3uTtDd4u;
        "pkg-4.5+mod" = _Snkbq9j0;
        "pkg-4.6" = _dy0Q9jNS;
        "pkg-4.6+mod" = _JglyBK09;
        "pkg-4.7" = _HKIA9nah;
        "pkg-4.7-fabric" = _BEJztlcT;
        "pkg-4.7-forge" = _146EF2Tc;
        "pkg-4.11" = _pH8hAIHL;
        "pkg-4.11-fabric" = _IGaSviVR;
        "pkg-4.11-quilt" = _N7SsNX9b;
        "pkg-4.11-forge" = _3N8nb8mP;
        "pkg-4.11-neoforge" = _uoeWdAWG;
        "pkg-4.12" = _BC3OHwM1;
        "pkg-4.12-fabric" = _8lXU2cdm;
        "pkg-4.12-quilt" = _FT1Fwq9l;
        "pkg-4.12-forge" = _452MWKZR;
        "pkg-4.12-neoforge" = _qkLHpWeU;
        "default" = _qkLHpWeU;
    });
