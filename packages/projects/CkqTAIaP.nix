...
let
    ...
    in {
        ...
        "pkg-1.0.0.15" = _gFyGx9su;
        "pkg-1.0.0.17" = _DWrQbRS6;
        "pkg-1.0.0.18" = _LwoXRoYG;
        "pkg-1.0.0.19" = _Wgznu9MR;
        "pkg-1.0.0.20" = _ApaC8R2e;
        "pkg-1.0.0.26" = _qsIzCv0H;
        "pkg-1.0.0.27" = _SPDoglOx;
        "pkg-1.1.0.32" = _r8cmmlnP;
        "pkg-1.1.0.33" = _NPA0kCrM;
        "pkg-1.1.0.34" = _FToOUaFb;
        "pkg-1.1.0.35" = _nQWTpPgF;
        "pkg-1.1.0.38" = _XxSViJfO;
        "pkg-1.1.0.40" = _jK3JiTvZ;
        "pkg-1.1.0.41" = _x8VDgMsl;
        "pkg-1.1.1.42" = _rHwDz195;
        "pkg-1.1.1.43" = _bstIhAlT;
        "pkg-1.1.1.44" = _Pvo426y7;
        "pkg-1.1.1.47" = _aCxbq1Cm;
        "pkg-1.1.2.55" = _b9xNqfVl;
        "pkg-1.1.3.70" = _OAr3K0Ay;
        "pkg-1.1.3.71" = _pRE8eJ4r;
        "pkg-1.1.4.85" = _QxQGymSg;
        "pkg-1.1.4.86" = _nRCtP5py;
        "pkg-1.1.4.87" = _XbqQjBd7;
        "pkg-1.1.4.88" = _rsKFqNA3;
        "pkg-1.1.5.91" = _GKydNRO0;
        "pkg-1.1.5.92" = _P06qIvNA;
        "pkg-1.1.5.93" = _zMk6nUpf;
        "pkg-1.1.5.95" = _qY0upzgU;
        "pkg-1.1.5.96" = _MezVoUAF;
        "pkg-1.1.5.97" = _BtKidSUq;
        "pkg-1.1.5.98" = _oAViXfz0;
        "pkg-1.1.6.99" = _ODM8jP8P;
        "pkg-1.1.6.100" = _PhNsi46P;
        "pkg-1.1.6.103" = _QtVoLc91;
        "pkg-1.1.6.105" = _6BojNkP7;
        "pkg-1.1.6.106" = _6NkrO236;
        "pkg-1.1.6.107" = _CQAMgYoY;
        "pkg-1.1.6.108" = _puAHzeUx;
        "pkg-1.1.6.109" = _elelMojU;
        "pkg-1.1.7.111" = _M86Dmpdw;
        "pkg-1.1.7.112" = _Zdopjn37;
        "pkg-1.1.7.116" = _xqhlU0OC;
        "pkg-1.1.7.118" = _zZWvdzMj;
        "pkg-1.1.7.120" = _pOGIY3w9;
        "pkg-1.2.0.122" = _oGRqekpE;
        "pkg-1.2.0.124" = _ue1tEKLY;
        "pkg-1.2.0.126" = _LSFwC3HP;
        "pkg-1.2.0.128" = _W2a21pXl;
        "pkg-1.2.0.129" = _CKutrgnH;
        "pkg-1.2.0.133" = _WwR0CmoU;
        "pkg-1.2.0.134" = _KYV6BRfQ;
        "pkg-1.1.8.finalrc1" = _TE59LECg;
        "pkg-1.2.0.135" = _c3727SgD;
        "pkg-1.2.0.137" = _kz9Y0TqI;
        "pkg-1.1.8.finalrc2" = _LnhlQzLU;
        "pkg-1.2.0.139" = _tq7Znezm;
        "pkg-1.2.0.141" = _zv4ZuCzU;
        "pkg-1.2.0.142" = _fgFl0sf2;
        "pkg-1.2.0.143" = _W19EGzQr;
        "pkg-1.2.0.144" = _WSfqbFB7;
        "pkg-1.2.0.145" = _AxUxnyOd;
        "pkg-1.2.0.147" = _NK7iMFHm;
        "pkg-1.5.151" = _6AuIexcE;
        "pkg-1.5.153" = _xsYlVsqR;
        "pkg-1.6.155" = _gpiGkGho;
        "pkg-1.6.156" = _mPP9ovZF;
        "pkg-1.6.158" = _Z6aQP5YA;
        "pkg-1.6.159" = _1r6ZyCLu;
        "pkg-1.6.160" = _UZFj5W6N;
        "pkg-1.6.161" = _cAqKUqXF;
        "pkg-1.6.162" = _4x3LmQmM;
        "pkg-1.6.163" = _g6zdqENu;
        "pkg-1.6.164" = _oj1DRSik;
        "pkg-1.6.166" = _GiIwl9pT;
        "pkg-1.6.167" = _sugzB8Oe;
        "pkg-1.7.169" = _rP1AM1Tr;
        "pkg-1.7.170" = _PpeAVedP;
        "pkg-1.7.171" = _fg95vvAQ;
        "pkg-1.7.173" = _7hfkL1k1;
        "pkg-1.7.174" = _enKMrrH6;
        "pkg-1.7.176" = _5nUwSMWL;
        "pkg-1.7.177" = _jku29s0S;
        "pkg-1.7.178" = _3H3ipDzI;
        "pkg-1.7.180" = _OkPEJFY2;
        "pkg-1.7.181" = _fzT9i8kG;
        "pkg-1.7.182" = _jrEiB5ij;
        "pkg-1.8.185" = _mgXEC3gl;
        "pkg-1.8.186" = _1lZW7M6C;
        "pkg-1.8.187" = _oId5rEcO;
        "pkg-1.8.188" = _V46OPd3V;
        "pkg-1.8.190" = _K29YHn71;
        "pkg-1.8.191" = _AOMdAt99;
        "pkg-1.8.192" = _NRU1AGoO;
        "pkg-1.8.193" = _jWg8QELw;
        "pkg-1.8.194" = _YL5I838d;
        "pkg-1.8.195" = _to05yTMl;
        "pkg-1.8.196" = _PZRtLcfv;
        "pkg-1.8.198" = _w7HCLoJl;
        "pkg-1.8.199" = _iEDvrqtl;
        "pkg-1.8.200" = _o6d1SKDR;
        "pkg-1.8.201" = _5LU1Conx;
        "pkg-1.8.202" = _YbBwRo3v;
        "pkg-1.8.203" = _b8LslKXd;
        "pkg-1.8.204" = _xwfoJ1xq;
        "pkg-1.8.205" = _gPP71AjV;
        "pkg-1.8.207" = _HSMJjTAZ;
        "pkg-1.8.208" = _aJvDlPT8;
        "pkg-1.8.209" = _SoE8S72B;
        "pkg-1.8.210" = _VJlUzwpB;
        "pkg-1.8.211" = _VuiXqtCt;
        "pkg-1.8.212" = _scVMAKWw;
        "pkg-1.8.213" = _N1W6n0Hc;
        "pkg-1.8.214" = _apRZ8gOi;
        "pkg-1.8.215" = _PXCkn70I;
        "pkg-1.8.216" = _vamR7jaH;
        "pkg-1.8.217" = _UTq80JHR;
        "pkg-1.8.218" = _aU46YvgO;
        "pkg-1.8.219" = _p1fn5KJf;
        "pkg-1.8.220" = _wrMgzLFn;
        "pkg-1.8.221" = _FWj6gcxc;
        "pkg-1.8.222" = _jcYEPGnb;
        "pkg-1.8.223" = _xmuug8Ds;
        "pkg-1.8.224" = _8EnnTrlV;
        "pkg-1.8.225" = _MjWRReOs;
        "pkg-1.8.226" = _ZcUZaFSp;
        "pkg-1.8.227" = _WdElPite;
        "pkg-1.8.228" = _v5d7JOFv;
        "pkg-1.8.230" = _NYqAjxPp;
        "pkg-2.0." = _tmVTbnC0;
        "pkg-2.0.2" = _W7lKabbq;
        "pkg-2.0.3" = _oQdVighw;
        "pkg-2.0.4" = _1P6ZISln;
        ...
        "pkg-2.0.8" = _dyPx3oGp;
        "pkg-2.0.9" = _vJudLd3Q;
        "pkg-2.0.10" = _85J2KZPn;
        "pkg-2.0.11" = _Er3hGgFf;
        "pkg-2.0.12" = _5aSXtF3M;
        "pkg-2.0.13" = _5j5U7Vnt;
        "pkg-3.0.1" = _QoQ5ZJnl;
        "pkg-3.0.2" = _YYw4EaPa;
        "pkg-3.0.3" = _8sjJI1ez;
        "pkg-3.0.5" = _SCPdknL6;
        "pkg-3.0.6" = _9irDFh6E;
        "pkg-2.0.14" = _1NGHbFoz;
        "pkg-3.0.7" = _eLWFZAJl;
        "pkg-3.1.8" = _qOSUDN3j;
        "pkg-4.0.1" = _3piYYJtz;
        "pkg-4.0.2" = _hxW4LBU6;
        ...
        "pkg-8.0.6" = _C0KVRkq5;
        "pkg-8.0.9" = _6cWn1jn6;
        "pkg-8.0.10" = _jPUNlbLq;
        "pkg-8.0.11" = _LEJDFIJv;
        "pkg-9.0.1" = _MseIPrvQ;
        "pkg-10.0.1" = _kErbf6It;
        "pkg-9.0.2" = _Vxqt7UuP;
        "pkg-10.0.2" = _1w4NbKVO;
        "pkg-8.0.12" = _mDM736wJ;
        "pkg-10.0.3" = _GagBKHPe;
        "pkg-8.0.13" = _FxSnF2ZU;
        "pkg-10.0.4" = _yHckUyxt;
        "pkg-8.0.14" = _TyCE8BIy;
        "pkg-11.0.1" = _3FBtweoL;
        "pkg-11.0.2" = _IOkcG3MC;
        "pkg-10.0.5" = _d0p1x54Q;
        "pkg-11.1.3" = _KWUGjEov;
        "pkg-12.0.1" = _dBpO5hyZ;
        "pkg-12.0.2" = _vA4FFUGa;
        "pkg-13.0.1" = _E0p9OAVE;
        "pkg-13.1.2" = _EhtA3AbP;
        "pkg-13.1.3" = _A0PTR9w9;
        "pkg-13.1.4" = _64rDVw9q;
        "pkg-13.1.5" = _G7IyAwre;
        "pkg-13.1.6" = _y95YAU0I;
        "pkg-10.1.6" = _Xfh6EFCk;
        "pkg-13.1.7" = _nh79sjSp;
        "pkg-14.0.1" = _WDJq3dZH;
        "pkg-15.0.1" = _CfKg1oaA;
        "pkg-9.0.4" = _kC9xUxYK;
        "pkg-10.1.7" = _nLt2QmsZ;
        "pkg-11.1.4" = _y7OuhleZ;
        "pkg-12.0.3" = _Oy7Ssbif;
        "pkg-13.1.8" = _ci6YzWrU;
        "pkg-13.1.9" = _uqIswic9;
        "pkg-14.0.2" = _y2brfScg;
        "pkg-15.0.2" = _O0CGUXVw;
        "pkg-16.0.1" = _qqP8XgM6;
        "pkg-16.0.2" = _3SoEFd85;
        "pkg-16.0.3" = _OITi32qD;
        "pkg-17.0.1" = _kSd0qVEk;
        "pkg-17.0.2" = _k1N10U3z;
        "pkg-17.0.3" = _82toaoSD;
        "pkg-18.0.1" = _M5D7aYkt;
        "pkg-19.0.2" = _svoMzTSF;
        "pkg-19.0.3" = _2uM9KIyE;
        "pkg-19.0.4" = _sxXKN3YQ;
        "pkg-19.0.5" = _69kxHy5l;
        "pkg-19.0.6" = _ns7XrzOE;
        "pkg-17.0.5" = _G6ROOs1R;
        "pkg-21.1.1" = _17SqiDCk;
        "pkg-17.0.6" = _5zG97cHT;
