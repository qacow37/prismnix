...
let
    ...
    in {
        ...
        "pkg-forge-1.20.1-1.0" = _b5xvg8yf;
        "pkg-forge-1.20-1.0" = _q6wkwLPb;
        "pkg-forge-1.19.4-1.0" = _FFBiEoWs;
        "pkg-forge-1.19.3-1.0" = _NZlO21eW;
        "pkg-forge-1.19.2-1.0" = _9wqpWKHO;
        "pkg-forge-1.19.2-1.0.1" = _362zBR0b;
        "pkg-forge-1.20.1-1.1" = _BKZbofgO;
        "pkg-forge-1.20-1.1" = _YWCgX4a7;
        "pkg-forge-1.19.4-1.1" = _TWQQZoRw;
        "pkg-forge-1.19.3-1.1" = _mmoRbDVs;
        "pkg-forge-1.19.2-1.1" = _dbDvdeF7;
        "pkg-forge-1.20.1-1.1.1" = _XEbD0TCv;
        "pkg-forge-1.20-1.1.1" = _fyDNPdtY;
        "pkg-forge-1.19.4-1.1.1" = _8WSUHLIT;
        "pkg-forge-1.19.3-1.1.1" = _s529QZvs;
        "pkg-forge-1.19.2-1.1.1" = _ZNbQKmDp;
        "pkg-forge-1.19.2-2.0" = _FSdrDmnv;
        "pkg-forge-1.19.3-2.0" = _xGmoKM0Y;
        "pkg-forge-1.19.4-2.0" = _1yZ9ReBB;
        "pkg-forge-1.20+1.20.1-2.0" = _e8kw2Rdd;
        "pkg-forge-1.19.3-2.1" = _WRvekIy4;
        "pkg-forge-1.19.2-2.1" = _mD77bqoH;
        "pkg-forge-1.19.4-2.1" = _rPz4KRxZ;
        "pkg-forge-1.20+1.20.1" = _iBdhmZNw;
        "pkg-forge-1.20.2-2.1" = _IfKQuqsb;
        "pkg-fabric-1.20.1-b2.1" = _NXymPgJZ;
        "pkg-forge-1.18.2-3.0" = _KFE2yz36;
        "pkg-fabric-1.18.2-3.0" = _EdNpSsfj;
        "pkg-forge-1.19.2-3.0" = _EMkm4yCp;
        "pkg-fabric-1.19.2-3.0" = _pophxK2K;
        "pkg-forge-1.19.3-3.0" = _aBB0TRX8;
        "pkg-fabric-1.19.3-3.0" = _Hvher57S;
        "pkg-forge-1.19.4-3.0" = _rKYJFIwJ;
        "pkg-fabric-1.19.4-3.0" = _ZhFpx9k0;
        "pkg-forge-1.20-1.20.1-3.0" = _SxVI5h5f;
        "pkg-fabric-1.20-1.20.2-3.0" = _uKvCpN9H;
        "pkg-forge-1.18.2-6.0" = _BWRTVTsv;
        "pkg-fabric-1.19.2-6.0" = _x8QuDCGF;
        "pkg-forge-1.19.2-6.0" = _UPihH9SV;
        "pkg-fabric-1.20+1.20.1-6.0" = _HvwPZQMI;
        "pkg-forge-1.20+1.20.1-6.0" = _axlDjEEk;
        "pkg-fabric-1.20.2-6.0" = _qIH1xo8i;
        "pkg-forge-1.20.2-6.0" = _C8heYkOp;
        "pkg-fabric-1.20.4-6.0" = _MVUZx0F1;
        "pkg-forge-1.18.2-6.1" = _uiWKwxiU;
        "pkg-forge-1.19.2-6.1" = _zizz4GxC;
        "pkg-forge-1.20+1.20.1-6.1" = _hAiL4o6o;
        "pkg-fabric-1.20+1.20.1-6.1" = _4fwbfOKS;
        "pkg-forge-1.20.4-6.1" = _ktR9L9Si;
        "pkg-fabric-1.20.4-6.1" = _NzOw9pkH;
        "pkg-forge-1.18.2-6.1.1" = _72XSm64W;
        "pkg-forge-1.19.2-6.1.1" = _FJo0Vji5;
        "pkg-fabric-1.20+1.20.1-6.1.1" = _pjZGueqB;
        "pkg-forge-1.20+1.20.1-6.1.1" = _P86wr6zR;
        "pkg-forge-1.20.4-6.1.1" = _3K6xCDaM;
        "pkg-fabric-1.20.4-6.1.1" = _yP7FPrZ0;
        "pkg-forge-1.18.2-6.1.2" = _9xtCO2GK;
        "pkg-forge-1.19.2-6.1.2" = _ZnuJggYg;
        "pkg-forge-1.20+1.20.1-6.1.2" = _G5B9oXkS;
        "pkg-fabric-1.20-1.20.1-6.1.2" = _5lctAyB9;
        "pkg-forge-1.20.4-6.1.2" = _VN2SUW3U;
        "pkg-fabric-1.20.4-6.1.2" = _OHf5NlNW;
        "pkg-forge-1.20.6-6.1.2" = _xTxtXPUH;
        "pkg-fabric-1.20.6-6.1.2" = _t7z7Zm5O;
        "pkg-forge-1.21+1.21.1-6.1.2" = _6rsB4Nk7;
        "pkg-fabric-1.21-1.21.1-6.1.2" = _apvpYj6f;
        "pkg-forge-1.18.2-6.1.3" = _tFKGys3W;
        "pkg-forge-1.19.2-6.1.3" = _5A3i4pt7;
        "pkg-forge-1.20+1.20.1-6.1.3" = _O8I7rQvO;
        "pkg-fabric-1.20+1.20.1-6.1.3" = _whDgsYIj;
        "pkg-forge-1.21+1.21.1-6.1.3" = _2XeLF0h2;
        "pkg-fabric-1.21+1.21.1-6.1.3" = _G0CojXhW;
        "pkg-fabric-1.20+1.20.1-6.1.3.1" = _biN6tRK9;
        "pkg-fabric-1.21+1.21.1-6.1.3.1" = _LyOyFHWw;
        "pkg-forge-1.18.2-6.1.4" = _eWCGiuCK;
        "pkg-forge-1.19.2-6.1.4" = _l3vA9Zr0;
        "pkg-forge-1.20+1.20.1-6.1.4" = _Y3VmW2Cj;
        "pkg-fabric-1.20+1.20.1-6.1.4" = _X2qbymcw;
        "pkg-fabric-1.21+1.21.1-6.1.4" = _3S7eiogA;
        "pkg-neoforge-1.21+1.21.1-6.1.4" = _Wt97BeYw;
        "default" = _Wt97BeYw;
    });
