...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.20.1" = _tzVDgRAI;
        "pkg-1.0.1-1.20.1" = _chp6baNt;
        "pkg-1.0.2-1.20.1" = _gzDMA2G1;
        "pkg-1.0.3-1.20.1" = _UOAamgdX;
        "pkg-1.0.5-1.20.1" = _xTgaKqUv;
        "pkg-1.0.6-1.20.1" = _KC2PKORZ;
        "pkg-1.0.7-1.20.1" = _7uRlQFlT;
        "pkg-1.0.8-1.20.1" = _xZj6X15m;
        "pkg-1.0.9-1.20.1" = _ItOHFGeC;
        "pkg-1.0.10-1.21.7" = _w7AhLbqW;
        "pkg-1.1.0-1.21.1" = _FdSAmewV;
        "pkg-1.1.1-1.21.1" = _bsDsL2Ke;
        "pkg-1.1.2-1.21.1" = _dabGx75f;
        "pkg-1.1.3-1.21.1" = _17ldZ5O5;
        "pkg-1.2.0-1.21.1" = _axyhR0RT;
        "pkg-1.2.1-1.21.1" = _YoDBGy58;
        "pkg-1.2.2-1.21.1" = _5OLLjdh4;
        "pkg-1.2.3-1.21.1" = _tD9jBx7m;
        "pkg-1.2.4-1.21.1" = _cPeUqLWf;
        "pkg-1.2.5-1.21.1" = _f3esJ9Xm;
        "pkg-1.3-1.21.1" = _aiBvhJeY;
        "pkg-1.4-1.21.1" = _KLlAatpO;
        "pkg-1.4.1-1.21.1" = _ZSIRT4iK;
        "pkg-1.4.2-1.21.1" = _W4CsuHEa;
        "pkg-1.4.3-1.21.1" = _XUhQHGmt;
        "default" = _XUhQHGmt;
    });
