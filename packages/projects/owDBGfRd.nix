...
let
    ...
    in {
        ...
        "pkg-1.16.5-3.3-fabric" = _cDy6LDji;
        "pkg-1.18.2-3.3-fabric" = _1hhF3rxj;
        "pkg-1.19.2-3.5-fabric" = _VmGIfqJa;
        "pkg-1.16.5-3.0-forge" = _YFH0aukP;
        "pkg-1.18.2-3.1-forge" = _8NwChbsC;
        "pkg-1.19.2-3.2-forge" = _29FdZ5Xe;
        "pkg-1.16.5-3.6-fabric" = _LK1I2Lkt;
        "pkg-1.18.2-3.6-fabric" = _vfjS5lKU;
        "pkg-1.19.2-3.6-fabric" = _D06gaIYh;
        "pkg-1.19.3-3.7-fabric" = _np9pN72p;
        "pkg-1.19.3-3.2-forge" = _vUPacsdr;
        "pkg-1.18.2-4.0-forge+fabric" = _DgU8YZ5H;
        "pkg-1.19.2-4.0-forge+fabric" = _QtB3ZV6s;
        "pkg-1.19.3-4.0-forge+fabric" = _OmH6FpVD;
        "pkg-1.18.2-4.1-forge+fabric" = _IchOjD9j;
        "pkg-1.19.2-4.1-forge+fabric" = _MM5HoeVN;
        "pkg-1.19.3-4.1-forge+fabric" = _zqlfFNzO;
        "pkg-1.18.2-4.2-forge+fabric" = _lzrQze59;
        "pkg-1.19.2-4.2-forge+fabric" = _Kc2XeqZq;
        "pkg-1.19.3-4.2-forge+fabric" = _NxJpomr6;
        "pkg-1.18.2-4.3-forge+fabric" = _sUamzkew;
        "pkg-1.19.2-4.3-forge+fabric" = _lz6ZCyF5;
        "pkg-1.19.3-4.3-forge+fabric" = _2jcqqudE;
        "pkg-1.18.2-4.4-forge+fabric" = _O8n10xGh;
        "pkg-1.19.2-4.4-forge+fabric" = _hzcP3r7n;
        "pkg-1.19.3-4.4-forge+fabric" = _5jBd2XMr;
        "pkg-1.18.2-4.5-forge+fabric" = _hs9Rm6kD;
        "pkg-1.19.2-4.5-forge+fabric" = _2fkf09V2;
        "pkg-1.19.3-4.5-forge+fabric" = _LRigESkr;
        "pkg-1.18.2-4.6-forge+fabric" = _6WlaDxQa;
        "pkg-1.19.2-4.6-forge+fabric" = _xBigJRWb;
        "pkg-1.19.3-4.6-forge+fabric" = _njQl0utl;
        "pkg-1.19.4-4.6-forge+fabric" = _BrLwW0QT;
        "pkg-1.20-4.6-forge+fabric" = _hC1MLyNm;
        "pkg-1.20.1-4.6-forge+fabric" = _yjCyCCkN;
        "pkg-1.20.2-4.6-forge+fabric" = _slBBwaaq;
        "pkg-1.18.2-4.7-forge+fabric" = _lIwWfbjt;
        "pkg-1.19.2-4.7-forge+fabric" = _1hHrUH0S;
        "pkg-1.20.1-4.7-forge+fabric" = _USzkajk5;
        "pkg-1.20.2-4.7-forge+fabric" = _bYY2jhcB;
        "pkg-1.20.3-4.7-fabric+forge+neo" = _3WPAMAL0;
        "pkg-1.20.4-4.7-fabric+forge+neo" = _lg1ZUY74;
        "pkg-1.19.2-4.8-fabric+forge+neo" = _co8PqVgX;
        "pkg-1.20.1-4.8-fabric+forge+neo" = _lMQNGyig;
        "pkg-1.20.2-4.8-fabric+forge+neo" = _ezyGygf8;
        "pkg-1.20.4-4.8-fabric+forge+neo" = _7NVnsQp0;
        "pkg-1.20.5-4.8-fabric+neo" = _5cCKRamn;
        "pkg-1.20.5-4.9-fabric+neo" = _EB08F1hf;
        "pkg-1.20.5-5.0-fabric+neo" = _KrwYxKw6;
        "pkg-1.20.6-5.0-fabric+forge+neo" = _a1xee9XA;
        "pkg-1.21.0-5.0-fabric+forge+neo" = _6oKl8uRh;
        "pkg-1.20.1-5.1-fabric+forge+neo" = _cSk3xHfo;
        "pkg-1.20.6-5.1-fabric+forge+neo" = _nCoAqZsp;
        "pkg-1.21.0-5.1-fabric+forge+neo" = _ssleEmoh;
        "pkg-1.21.1-5.1-fabric+forge+neo" = _FDcuqV5F;
        "pkg-1.21.2-5.1-fabric+neo" = _cHD7NO7V;
        "pkg-1.21.3-5.1-fabric+forge+neo" = _gkANi3UQ;
        "pkg-1.21.4-5.1-fabric+forge+neo" = _zeNdN9vD;
        "pkg-1.20.1-5.2-fabric+forge+neo" = _dKV5HYJi;
        "pkg-1.21.1-5.2-fabric+forge+neo" = _yJKT8zzG;
        "pkg-1.21.4-5.2-fabric+forge+neo" = _2r8dBU9O;
        "pkg-1.21.5-5.2-fabric+forge+neo" = _aiG7f06a;
        "pkg-1.21.6-5.2-fabric+forge+neo" = _DpCmQ6lY;
        "pkg-1.21.7-5.2-fabric+forge+neo" = _YoS31BGO;
        "pkg-1.21.8-5.2-fabric+forge+neo" = _J6cmt4YM;
        "pkg-1.21.9-5.2-fabric+forge+neo" = _j7bZJkND;
        "pkg-1.21.10-5.2-fabric+forge+neo" = _HumK2PYW;
        "pkg-1.21.11-5.2-fabric+forge+neo" = _NG34wHGs;
        "pkg-26.1.0-5.2-fabric+forge+neo" = _zcd6w553;
        "pkg-26.1.1-5.2-fabric+forge+neo" = _CZjIRd5x;
        "pkg-26.1.2-5.2-fabric+forge+neo" = _3xagilpY;
        "pkg-26.2.0-5.2-fabric+forge+neo" = _MlwF6TTU;
        "default" = _MlwF6TTU;
    });
