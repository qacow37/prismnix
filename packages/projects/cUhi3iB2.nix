...
let
    ...
    in {
        ...
        "pkg-1.3.8" = _kUqyL2X9;
        "pkg-1.3.9" = _S8AEf3X1;
        "pkg-1.3.11" = _L48r3Mn5;
        "pkg-1.3.12" = _VmrIjfRU;
        "pkg-1.3.13" = _HlyaFEvp;
        "pkg-1.3.14" = _lskRXBaC;
        "pkg-1.3.15" = _WWxVTUNm;
        "pkg-1.3.16" = _XRXBIyQG;
        "pkg-1.3.17" = _6z3Q6ae1;
        "pkg-1.3.18" = _MN5xYErD;
        "pkg-1.3.19" = _qOIMGJzy;
        "pkg-1.3.20" = _cXm8yvoG;
        "pkg-1.3.21" = _e13JK2qV;
        "pkg-1.3.22" = _1KTJJ2gz;
        "pkg-1.3.23" = _Ua2p3xKG;
        "pkg-1.3.24" = _sOk0epGX;
        "pkg-1.3.25" = _JkFbz8lE;
        "pkg-1.3.26" = _qOIQNUgt;
        "pkg-1.3.27" = _DlhrDe98;
        "pkg-1.3.28" = _w0oIAEFo;
        "pkg-1.3.29" = _OW7YKtaI;
        "pkg-1.3.30" = _hTiqRp4H;
