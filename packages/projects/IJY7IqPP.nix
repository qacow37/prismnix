...
let
    ...
    in {
        ...
        "pkg-8.0.6" = _2Wi50MGh;
        "pkg-7.3.2" = _xrKK0Ej7;
        "pkg-1.18.2-9.0.0.3-fabric" = _UnpLvlq6;
        "pkg-1.18.2-9.0.0.3-forge" = _cTPMTRNl;
        "pkg-1.18.2-9.0.0.4-forge" = _INAoCzSd;
        "pkg-1.18.2-9.0.0.4-fabric" = _bdArwKxe;
        "pkg-1.18.2-9.1.1.0-fabric" = _ZRlvZ81l;
        "pkg-1.18.2-9.1.1.0-forge" = _tTjO1EKH;
        "pkg-1.18.2-9.1.3.0-fabric" = _wDCPxvRf;
        "pkg-1.18.2-9.1.3.0-forge" = _NoEaqSg4;
        "pkg-1.18.2-9.1.4.0-forge" = _yf7mIIgf;
        "pkg-1.18.2-9.1.4.0-fabric" = _pmhtWxc4;
        "pkg-1.18.2-9.1.4.1-fabric" = _bkwEj8gQ;
        "pkg-1.18.2-9.1.4.1-forge" = _8vTreX4c;
        "pkg-1.18.2-9.1.5.0-fabric" = _FuUt2Omd;
        "pkg-1.18.2-9.1.5.0-forge" = _Rwdvzwht;
        "pkg-1.18.2-9.1.5.1-fabric" = _r6BDr4R0;
        "pkg-1.18.2-9.1.5.1-forge" = _s3aC5rCz;
        "pkg-1.18.2-9.1.6.0-forge" = _Pil3kAdG;
        "pkg-1.18.2-9.1.6.0-fabric" = _y5PsIGB8;
        "pkg-1.18.2-9.1.7.0-forge" = _kF6PWMA8;
        "pkg-1.18.2-9.1.7.0-fabric" = _uiI0z2Lv;
        "pkg-1.19.2-9.1.7.0-alpha-forge" = _KA73qQzH;
        "pkg-1.19.2-9.1.7.0-alpha-fabric" = _818pBBTk;
        "pkg-1.19.3-9.1.7.0-alpha-forge" = _8Z75ELaZ;
        "pkg-1.19.3-9.1.7.0-alpha-fabric" = _NIac0xBt;
        "pkg-1.19.4-9.1.7.0-alpha-forge" = _3uONzGiy;
        "pkg-1.19.4-9.1.7.0-alpha-fabric" = _5Myoi4DC;
        "pkg-1.20.1-9.1.7.0-alpha-fabric" = _wR0nwojD;
        "pkg-1.20.1-9.1.7.0-alpha-forge" = _CJ5hV6J1;
        "pkg-1.19.2-9.1.7.1-alpha-fabric" = _LZDbUedP;
        "pkg-1.19.3-9.1.7.1-alpha-fabric" = _VlhvLyHh;
        "pkg-1.19.2-9.1.7.1-alpha-forge" = _u23xjuFd;
        "pkg-1.19.3-9.1.7.1-alpha-forge" = _l36kGqdl;
        "pkg-1.19.4-9.1.7.1-alpha-fabric" = _KymK7Cs6;
        "pkg-1.19.4-9.1.7.1-alpha-forge" = _BMEq4Urc;
        "pkg-1.20.1-9.1.7.1-alpha-fabric" = _szc5Mf4d;
        "pkg-1.20.1-9.1.7.1-alpha-forge" = _ZCeV5VK0;
        "pkg-1.18.2-9.2.0.0-forge" = _Nhw1u1EV;
        "pkg-1.18.2-9.2.0.0-fabric" = _ns91LVr7;
        "pkg-1.19.2-9.2.0.0-alpha-forge" = _XFX27oaV;
        "pkg-1.19.2-9.2.0.0-alpha-fabric" = _6ADLgIqw;
        "pkg-1.19.3-9.2.0.0-alpha-fabric" = _z9lE986b;
        "pkg-1.19.4-9.2.0.0-alpha-forge" = _gswcrlhY;
        "pkg-1.19.3-9.2.0.0-alpha-forge" = _fIYUqxOR;
        "pkg-1.19.4-9.2.0.0-alpha-fabric" = _dAOGgu6j;
        "pkg-1.20.1-9.2.0.0-alpha-forge" = _LrfvvFWU;
        "pkg-1.20.1-9.2.0.0-alpha-fabric" = _fMGym3JT;
        "pkg-1.18.2-9.2.0.1-forge" = _p3o71Obq;
        "pkg-1.18.2-9.2.0.1-fabric" = _6Kmh9tLV;
        "pkg-1.19.2-9.2.0.1-alpha-forge" = _VkD7dIgY;
        "pkg-1.19.2-9.2.0.1-alpha-fabric" = _6EUnbLnq;
        "pkg-1.19.3-9.2.0.1-alpha-forge" = _mgGDI0Tj;
        "pkg-1.19.4-9.2.0.1-alpha-fabric" = _6OOuR1lH;
        "pkg-1.19.3-9.2.0.1-alpha-fabric" = _cVp3jrth;
        "pkg-1.19.4-9.2.0.1-alpha-forge" = _9ip7IGYq;
        "pkg-1.20.1-9.2.0.1-alpha-forge" = _SieLrGuZ;
        "pkg-1.20.1-9.2.0.1-alpha-fabric" = _2j4Sv790;
        "pkg-1.18.2-9.2.0.2-fabric" = _YML9nmR8;
        "pkg-1.18.2-9.2.0.2-forge" = _LOiQDGev;
        "pkg-1.19.2-9.2.0.2-alpha-forge" = _Da7IuHeI;
        "pkg-1.19.2-9.2.0.2-alpha-fabric" = _WBK4mjdo;
        "pkg-1.19.3-9.2.0.2-alpha-forge" = _kYFXskJV;
        "pkg-1.19.3-9.2.0.2-alpha-fabric" = _1ntB5zRx;
        "pkg-1.19.4-9.2.0.2-alpha-forge" = _RxJh3ugI;
        "pkg-1.19.4-9.2.0.2-alpha-fabric" = _QipDjz5U;
        "pkg-1.20.1-9.2.0.2-alpha-forge" = _MugWBC19;
        "pkg-1.20.1-9.2.0.2-alpha-fabric" = _SL92iJEj;
        "pkg-1.18.2-9.2.1.0-fabric" = _Z1jZy8p6;
        "pkg-1.18.2-9.2.1.0-forge" = _Kvtb8Z5Y;
        "pkg-1.19.2-9.2.1.0-forge" = _UU7FqesX;
        "pkg-1.19.2-9.2.1.0-fabric" = _d3WDrkDE;
        "pkg-1.19.3-9.2.1.0-forge" = _FIrzNCNk;
        "pkg-1.19.3-9.2.1.0-fabric" = _Zf3PHgvI;
        "pkg-1.19.4-9.2.1.0-forge" = _IqmdDNbU;
        "pkg-1.19.4-9.2.1.0-fabric" = _j8YTv3xp;
        "pkg-1.20.1-9.2.1.0-forge" = _2e30V16I;
        "pkg-1.20.1-9.2.1.0-fabric" = _JnJ2H2LD;
        "pkg-1.18.2-9.2.1.1-fabric" = _umkglQDy;
        "pkg-1.18.2-9.2.1.1-forge" = _RDjZpJiC;
        "pkg-1.18.2-9.2.1.2-fabric" = _5yPhy8TI;
        "pkg-1.18.2-9.2.1.2-forge" = _cQia1VwD;
        "pkg-1.19.2-9.2.1.2-forge" = _bFFNe0wq;
        "pkg-1.19.2-9.2.1.2-fabric" = _W4G8huEZ;
        "pkg-1.19.3-9.2.1.2-forge" = _6AhADc9h;
        "pkg-1.19.3-9.2.1.2-fabric" = _kih7lj0H;
        "pkg-1.19.4-9.2.1.2-forge" = _VgAjhGgJ;
        "pkg-1.19.4-9.2.1.2-fabric" = _x29oTIlU;
        "pkg-1.20.1-9.2.1.2-forge" = _ZzGwMblT;
        "pkg-1.20.1-9.2.1.2-fabric" = _hM81qYuf;
        "pkg-1.18.2-9.2.1.3-fabric" = _iwGbCsXk;
        "pkg-1.18.2-9.2.1.3-forge" = _D9PsmY7n;
        "pkg-1.19.2-9.2.1.3-fabric" = _Vhp1XtC0;
        "pkg-1.19.2-9.2.1.3-forge" = _7pvim58F;
        "pkg-1.19.3-9.2.1.3-forge" = _8IW11MIP;
        "pkg-1.19.3-9.2.1.3-fabric" = _T5b8RBZ8;
        "pkg-1.19.4-9.2.1.3-fabric" = _iMfX7k3t;
        "pkg-1.19.4-9.2.1.3-forge" = _3kG8sIkN;
        "pkg-1.20.1-9.2.1.3-forge" = _3N7BJ596;
        "pkg-1.20.1-9.2.1.3-fabric" = _gjC2cSgD;
        "pkg-1.18.2-9.3.0.2-fabric" = _Jtfij4Hv;
        "pkg-1.18.2-9.3.0.2-forge" = _GFTtHJNZ;
        "pkg-1.19.2-9.3.0.2-forge" = _ckEpqv89;
        "pkg-1.19.2-9.3.0.2-fabric" = _LrGGHpkA;
        "pkg-1.19.3-9.3.0.2-forge" = _ZkyqqFif;
        "pkg-1.19.3-9.3.0.2-fabric" = _zymvVUv8;
        "pkg-1.19.4-9.3.0.2-forge" = _oPWA82Xc;
        "pkg-1.19.4-9.3.0.2-fabric" = _hftfVp98;
        "pkg-1.20.1-9.3.0.2-forge" = _8LiSOj1f;
        "pkg-1.20.1-9.3.0.2-fabric" = _AjBKjO8R;
        "pkg-1.18.2-9.3.0.3-fabric" = _Gcaw3XFp;
        "pkg-1.18.2-9.3.0.3-forge" = _ycnNj4jz;
        "pkg-1.19.2-9.3.0.3-forge" = _x0u7Lrjd;
        "pkg-1.19.2-9.3.0.3-fabric" = _rUsrqUcd;
        "pkg-1.19.3-9.3.0.3-fabric" = _2oltmVDM;
        "pkg-1.19.3-9.3.0.3-forge" = _9ma66JxZ;
        "pkg-1.19.4-9.3.0.3-fabric" = _j8R9k63L;
        "pkg-1.19.4-9.3.0.3-forge" = _oh3EMPiG;
        "pkg-1.20.1-9.3.0.3-forge" = _yCOVwbwv;
        "pkg-1.20.1-9.3.0.3-fabric" = _H6AD9rwm;
        "pkg-1.18.2-9.3.2.0-forge" = _XWCViXcM;
        "pkg-1.18.2-9.3.2.0-fabric" = _vffgUOob;
        "pkg-1.19.2-9.3.2.0-fabric" = _L7kClfUV;
        "pkg-1.19.2-9.3.2.0-forge" = _Ykmc2XD1;
        "pkg-1.19.3-9.3.2.0-fabric" = _J3c83uSx;
        "pkg-1.19.3-9.3.2.0-forge" = _UpLOwE5O;
        "pkg-1.19.4-9.3.2.0-forge" = _UBjzNlnh;
        "pkg-1.19.4-9.3.2.0-fabric" = _dr9LRPU9;
        "pkg-1.20.1-9.3.2.0-forge" = _6tcm0Xko;
        "pkg-1.20.1-9.3.2.0-fabric" = _oRtD3sMR;
        "pkg-1.18.2-9.3.3.0-forge" = _7ZvRppIb;
        "pkg-1.18.2-9.3.3.0-fabric" = _X2OCwq9U;
        "pkg-1.19.2-9.3.3.0-fabric" = _gfbbGzhY;
        "pkg-1.19.2-9.3.3.0-forge" = _OEvrrQHt;
        "pkg-1.19.3-9.3.3.0-fabric" = _tiTxbZI7;
        "pkg-1.19.3-9.3.3.0-forge" = _nSM04PLT;
        "pkg-1.19.4-9.3.3.0-fabric" = _N6RX9XSt;
        "pkg-1.19.4-9.3.3.0-forge" = _61JS56NP;
        "pkg-1.20.1-9.3.3.0-forge" = _157RaZvX;
        "pkg-1.20.1-9.3.3.0-fabric" = _k5IAjiMM;
        "pkg-1.18.2-9.3.3.1-fabric" = _etf28EjH;
        "pkg-1.18.2-9.3.3.1-forge" = _g1pTrsmy;
        "pkg-1.19.2-9.3.3.1-forge" = _K6cTY79X;
        "pkg-1.19.2-9.3.3.1-fabric" = _rlGRGLf8;
        "pkg-1.19.3-9.3.3.1-fabric" = _uWQe1Sl2;
        "pkg-1.19.3-9.3.3.1-forge" = _JX4ZEwEK;
        "pkg-1.19.4-9.3.3.1-fabric" = _kj7pT7w6;
        "pkg-1.19.4-9.3.3.1-forge" = _Euw9Ybxp;
        "pkg-1.20.1-9.3.3.1-forge" = _xWHLErNp;
        "pkg-1.20.1-9.3.3.1-fabric" = _IWSYiqKU;
        "pkg-1.18.2-9.3.4.0-fabric" = _DH0U50mZ;
        "pkg-1.18.2-9.3.4.0-forge" = _deR3Cypo;
        "pkg-1.19.2-9.3.4.0-fabric" = _iZ8QkGzi;
        "pkg-1.19.2-9.3.4.0-forge" = _L5OjYsf3;
        "pkg-1.19.3-9.3.4.0-fabric" = _V1fp1jft;
        "pkg-1.19.3-9.3.4.0-forge" = _6SWe6YCX;
        "pkg-1.19.4-9.3.4.0-fabric" = _Ipe5OqA2;
        "pkg-1.19.4-9.3.4.0-forge" = _uGuU7AMV;
        "pkg-1.20.1-9.3.4.0-fabric" = _fouLO3jc;
        "pkg-1.20.1-9.3.4.0-forge" = _ChiOT0xS;
        "default" = _ChiOT0xS;
    });
