...
let
    ...
    in {
        ...
        "pkg-fabric-4.1.0" = _hSImj693;
        "pkg-forge-4.1.0" = _dfpHKcat;
        "pkg-fabric-4.1.1" = _ogQ2CWzE;
        "pkg-forge-4.1.1" = _dLf0LCSA;
        "pkg-fabric-5.0.0" = _k1fVxo2G;
        "pkg-forge-5.0.0" = _8cWmtQkL;
        "pkg-5.0.1" = _CBSPXp2r;
        "pkg-6.0.0" = _2ur5EpyA;
        "pkg-6.0.1" = _vRPyA6kJ;
        "pkg-5.0.2" = _ue4CZPML;
