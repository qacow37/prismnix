...
let
    ...
    in {
        ...
        "pkg-1.19.2-4.0.1" = _W7oHZJkj;
        "pkg-1.19.2-4.0.3" = _PQ3yGaoy;
        "pkg-1.19.2-4.0.4" = _zCdxtKid;
        "pkg-1.19.3-4.1.0" = _HmdCJ0Gr;
        "pkg-1.19.4-4.2.0" = _OxA6AcyI;
        "pkg-1.19.4-4.2.1" = _IvpxKmj9;
        "pkg-1.19.4-4.2.2" = _1KBrULMp;
        "pkg-1.19.4-4.2.3" = _kVP0EVXf;
        "pkg-1.19.4-4.2.4" = _5pYULoon;
        "pkg-1.20-4.3.0" = _3zAPGSGo;
        "pkg-1.20.1-4.4.1" = _efAPPLBj;
        "pkg-1.20.1-4.4.1-release" = _xe5r6faB;
        "pkg-1.20.1-4.4.2" = _IOF2qMbW;
        "pkg-1.20-4.3.1" = _QWwK6Leu;
        "pkg-1.19.4-4.2.5" = _pnaVN0xV;
        "pkg-1.19.3-4.1.1" = _Uwqdpw5B;
        "pkg-1.19.2-4.0.5" = _bLNdFeaL;
        "pkg-1.18.2-3.0.0" = _RxjjOqzT;
        "pkg-1.20.1-5.0.0" = _5p7cGvRH;
        "pkg-5.0.1+mc1.20.1-SNAPSHOT" = _LTCOwyO9;
        "pkg-5.1.0+mc1.20.2-SNAPSHOT" = _AZCqQ2yQ;
        "pkg-5.1.0+mc1.20.3-SNAPSHOT" = _y86W18ec;
        "pkg-5.1.0+mc1.20.4-SNAPSHOT" = _6EG9gxPJ;
        "pkg-5.1.0+mc1.19.4-SNAPSHOT" = _UEu6hTXy;
        "pkg-5.1.0+mc1.19.2-SNAPSHOT" = _bhkqAIpo;
        "pkg-5.1.0+mc1.18.2-SNAPSHOT" = _AKcRYf8H;
        "pkg-5.1.0+mc1.17.1-SNAPSHOT" = _M2Wi7QLr;
        "pkg-5.1.0+mc1.16.5-SNAPSHOT" = _2mAsFotS;
        "pkg-5.0.2+mc1.20.1-SNAPSHOT" = _pgQx3Z5r;
        "pkg-5.0.3+mc1.20.1" = _x45wpz18;
        "pkg-5.1.1+mc1.18.2-SNAPSHOT" = _J3gnClW0;
        "pkg-5.1.1+mc1.16.5" = _UcDXMmnB;
        "pkg-5.2.0+mc1.20.4" = _50hLjJaV;
        "pkg-5.2.1+mc1.20.4" = _blsjFD5E;
        "pkg-5.2.1+mc1.20.5" = _TRfWjYJU;
        "pkg-5.2.2+mc1.20.6" = _Q3ZUOI7d;
        "pkg-5.2.3+mc1.20.6" = _T7Xh9q8L;
        "pkg-5.2.4+mc1.20.6" = _54rJ3lUr;
        "pkg-5.2.2+mc1.20.4" = _29mhvANc;
        "pkg-5.2.5+mc1.21" = _wIBedyus;
        "pkg-5.2.6+mc1.21" = _UE4qwyuq;
        "pkg-5.2.7+mc1.21" = _iqL3ixFi;
        "pkg-5.2.7+mc1.20.1" = _9f1gtmbb;
        "pkg-5.2.8+mc1.21" = _8omN6c8i;
        "pkg-5.1.1+mc1.19.2" = _5Ic8WAuh;
        "pkg-5.2.9+mc1.21.3" = _UpSSGkEx;
        "pkg-5.2.8+mc1.20.1" = _tR4Z5Ijy;
        "pkg-5.2.9+mc1.21.4" = _XXLJjyxb;
        "pkg-5.2.10+mc1.21.4" = _l4JOeG2I;
        "pkg-5.2.10+mc1.21.3" = _dYuDIJYW;
        "pkg-5.2.10+mc1.21.1" = _3Bd21g0j;
        "pkg-5.2.11+mc1.21.4" = _2ILhz2g1;
        "pkg-5.2.11+mc1.21.3" = _3A6DJ8SR;
        "pkg-5.2.11+mc1.21.1" = _XYsOhIsN;
        "pkg-5.2.12+mc1.21.5" = _QMQizWB5;
        "pkg-5.2.12+mc1.21.6" = _mjzlWMJs;
        "pkg-5.2.13+mc1.21.6" = _5fvdUqoW;
        "pkg-5.2.13+mc1.21.8" = _LRbuc858;
        "pkg-5.2.13+mc1.21.10" = _EWiXANbr;
        "pkg-5.2.14+mc1.21.10" = _xZRgNr8w;
        "pkg-5.2.14+mc1.21.8" = _y8Y6MtFP;
        "pkg-5.2.14+mc1.21.6" = _98B5vMAd;
        "pkg-6.0.0-fabric" = _E9r554AL;
        "pkg-6.0.0-forge" = _jAhLeEAt;
        "pkg-6.0.0-neoforge" = _x79G0VSP;
        "pkg-5.2.15+mc1.21.10" = _5C9n4Vrx;
        "default" = _5C9n4Vrx;
    });
