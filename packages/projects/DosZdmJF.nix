...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _kePKviTY;
        "pkg-1.5" = _gaBP8y34;
        "pkg-1.5+mod" = _iqkvUA1t;
        "pkg-1.5.1" = _W5ruXlYa;
        "pkg-1.5.1+mod" = _tFM8YCLl;
        "pkg-1.5.2" = _7AyvvIL1;
        "pkg-1.5.2+mod" = _Es8UE8Ml;
        "pkg-1.5.3" = _mYLM7Mof;
        "pkg-1.5.3+mod" = _k2eMpcH3;
        "pkg-1.6" = _tgiDCKY9;
        "pkg-1.6+mod" = _Yw2pJoQo;
        "pkg-1.6.1" = _7Eiv674A;
        "pkg-1.6.1+mod" = _17YyJgqj;
        "pkg-1.7" = _VHlyedRU;
        "pkg-1.7+mod" = _nkXc7XV1;
        "pkg-1.7.1" = _qSnDDmsf;
        "pkg-1.7.1+mod" = _y9RH3kbO;
        "pkg-1.8" = _NsnYG1vk;
        "pkg-1.8+mod" = _qhF0c7aL;
        "pkg-1.8.1" = _7Z2eK02z;
        "pkg-1.8.1+mod" = _AgsrEHxD;
        "pkg-1.8.2" = _KYSNZsPb;
        "pkg-1.8.3" = _5DfDh4PV;
        "pkg-1.9" = _2M4VLEJO;
        "pkg-1.9+mod" = _AoUxlIEZ;
        "pkg-1.9.1" = _jTSNPvCY;
        "pkg-1.9.1+mod" = _IjGIrrw3;
        "pkg-1.9.2" = _GLNKxtaC;
        "pkg-1.9.2+mod" = _SjqoDKvM;
        "pkg-2.0-(1.21.1)" = _R47TqDTk;
        "pkg-2.0-(1.21.1)+mod" = _4hIexzhV;
        "pkg-2.0-(1.21.4)" = _EMjtEnoj;
        "pkg-2.0-(1.21.4)+mod" = _vnD7DXQ1;
        "pkg-2.1" = _3cKdsZ0C;
        "pkg-2.1+mod" = _Fci1NeEU;
        "pkg-2.0.1-(1.21.1)" = _Fn70wbui;
        "pkg-2.0.1-(1.21.1)+mod" = _mANWrFfD;
        "pkg-2.0.1-(1.21.4)" = _7lf9JRL6;
        "pkg-2.0.1-(1.21.4)+mod" = _M4FAHAmn;
        "pkg-2.1.1" = _Sd6f2iOR;
        "pkg-2.1.1+mod" = _30hCYFxz;
        "pkg-2.0.1.1-(1.21.1)" = _yTHOHu9w;
        "pkg-2.0.1.1-(1.21.1)+mod" = _ZiXXG961;
        "pkg-2.0.1.2-(1.21.1)" = _3t4RwtRv;
        "pkg-2.0.1.2-(1.21.1)+mod" = _kaLPG2nk;
        "pkg-2.1.2" = _Ica7zxKb;
        "pkg-2.1.2+mod" = _1VtnpTkK;
        "pkg-2.1.3" = _2HCNqQyk;
        "pkg-2.1.3+mod" = _hfeKnhKW;
        "pkg-3.0" = _G7xBcu7o;
        "pkg-3.0+mod" = _UYiFV07M;
        "pkg-3.1" = _OuAqeEy0;
        "pkg-3.1+mod" = _GdYeMS4I;
        "pkg-2.0.1.3-(1.21.1)" = _m7pcmdgv;
        "pkg-2.0.1.3-(1.21.1)+mod" = _ToKlX1yk;
        "pkg-3.0.1" = _XeMrhlX0;
        "pkg-3.0.1+mod" = _MyqlO0Cj;
        "pkg-3.1.1" = _hbXVdic7;
        "pkg-3.1.1+mod" = _okMjTExy;
        "pkg-3.0.2" = _FakEK9RQ;
        "pkg-3.0.2+mod" = _WOxfKlFJ;
        "pkg-3.1.2" = _suCkn30c;
        "pkg-3.1.2+mod" = _z259dDQE;
        "pkg-2.0.1.4-(1.21.1)" = _KmUNwUlU;
        "pkg-2.0.1.4-(1.21.1)+mod" = _5sNJmsho;
        "pkg-3.0.3" = _qyNuvkLD;
        "pkg-3.0.3+mod" = _j8FUBz1A;
        "pkg-3.1.3" = _fL0gRQ7P;
        "pkg-3.1.3+mod" = _PQrvP7sL;
        "pkg-3.2" = _xaapxKRj;
        "pkg-3.2+mod" = _SvVoimmI;
        "pkg-3.2.1" = _U2j4CeWN;
        "pkg-3.2.1+mod" = _z77RgwQM;
        "pkg-3.3" = _1uFYd72w;
        "pkg-3.3+mod" = _Xkcnf0R4;
        "pkg-4.0" = _9SNkmCuS;
        "pkg-4.0+mod" = _BX5vxJYc;
        "pkg-4.0.1" = _mwoFm7Wu;
        "pkg-4.0.1+mod" = _IzdGbud7;
        "pkg-4.0.2" = _H8Ny8JSo;
        "pkg-4.0.2+mod" = _65vZRxTh;
        "pkg-4.0.3" = _esstCRqa;
        "pkg-4.0.3+mod" = _6mHxjmo1;
        "pkg-4.0.4" = _52qmdFtg;
        "pkg-4.0.4+mod" = _XJ5F3yWJ;
        "pkg-4.0.5" = _G6MoMm30;
        "pkg-4.0.5+mod" = _wCqq8eRY;
        "pkg-4.0.4a" = _Ytg9tGIn;
        "pkg-4.0.4a+mod" = _sfeEcUIV;
        "pkg-4.0.5a" = _MEq6GMxc;
        "pkg-4.0.5a+mod" = _ohXqZfit;
        "pkg-2.0.1.5" = _1JrITLjq;
        "pkg-2.0.1.5+mod" = _nbAk9UTH;
        "pkg-v5.0" = _NHzOXjVa;
        "pkg-v5.0+mod" = _xyzcY53z;
        "pkg-v5.0.1" = _nhc6aiB3;
        "pkg-v5.0.1+mod" = _BpMmoR4V;
        "pkg-v5.0.2" = _78atMNYB;
        "pkg-v5.0.2+mod" = _enqwkh0o;
        "pkg-v4.0.6" = _YStbTAgT;
        "pkg-v4.0.6+mod" = _bKkFyrTE;
        "pkg-v5.0.3" = _dy6oiK8b;
        "pkg-v5.0.3+mod" = _ZYVTl0Io;
        "pkg-v4.0.7" = _RgtD95U5;
        "pkg-v4.0.7+mod" = _7p9mFaWB;
        "pkg-v5.0.4" = _5vRy310H;
        "pkg-v5.0.4+mod" = _WTIO3dQ0;
        "pkg-v5.0.5" = _s87LxqEM;
