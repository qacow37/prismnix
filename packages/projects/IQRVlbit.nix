...
let
    ...
    in {
        ...
        "pkg-1.5.1" = _ev7ui2oW;
        "pkg-1.5.2" = _GxxGSIwO;
        "pkg-1.6.0-1.17.1" = _MSzso14X;
        "pkg-1.6.0-1.18.2" = _aeNZLW0h;
        "pkg-1.6.0-1.19.4" = _80IPiRjc;
        "pkg-1.6.0-1.19.2" = _sZRLTZD7;
        "pkg-1.6.0-1.20.2" = _aAVHxjwN;
        "pkg-1.6.0-1.20.4" = _Yt9gFzFW;
        "pkg-1.6.1-1.17.1" = _UMRVPtch;
        "pkg-1.6.1-1.18.2" = _W1sQkERA;
        "pkg-1.6.1-1.19.2" = _ZMnQGYds;
        "pkg-1.6.1-1.19.4" = _s23BwNDj;
        "pkg-1.6.1-1.20.2" = _duX2dfmK;
        "pkg-1.6.1-1.20.4" = _ee2dKilS;
        "pkg-1.6.1-1.20.6" = _OzebiD5C;
        "pkg-1.7.0-1.21.0" = _pKBq6tYW;
        "pkg-1.8.0-1.21.4" = _Bl0Qm6jO;
        "pkg-1.7.1-1.21" = _hH0OGH9T;
        "pkg-1.8.1-1.21.4" = _WWqNW76l;
        "pkg-1.7.2-1.21.1" = _Ga2Oc4TI;
