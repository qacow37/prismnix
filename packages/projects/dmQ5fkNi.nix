...
let
    ...
    in {
        ...
        "pkg-1.0.0.0" = _lInO9azf;
        "pkg-1.0.0.5" = _RR1RQjEV;
        "pkg-1.0.0.9" = _tzUG6lZn;
        "pkg-1.0.1.1" = _PSR1OdjG;
        "pkg-1.0.1.5" = _b51ONmHp;
        "pkg-1.0.1.9" = _t8XATXJg;
        "pkg-1.0.2.0" = _757Wd8jJ;
        "pkg-1.0.2.2" = _CWFB4Q0D;
        "pkg-1.0.2.5" = _AGWaDjBK;
        "pkg-1.0.3.0" = _dM6MJSWZ;
        "pkg-1.0.3.2" = _D5nDI5qz;
        "pkg-1.0.0.0-forge" = _6I0U3fi5;
        "pkg-1.0.3.3" = _LNRWH2kh;
        "pkg-1.0.0.0-1.21.5" = _PyLVGmTq;
        "pkg-1.0.0.1-1.21.5" = _QludJsMO;
        "pkg-1.0.0.5-1.21.5" = _eOtYiG75;
        "pkg-1.0.0.6-1.21.5" = _LJw0ztIa;
        "pkg-1.0.3.5" = _BL7TQ3lE;
        "pkg-1.0.1.0-1.21.5" = _G5T4ro9i;
        "pkg-1.0.1.2-1.21.5" = _4z3Y7seA;
        "pkg-1.0.1.3-1.21.5" = _YXUIYRvp;
        "pkg-1.0.1.5-1.21.5" = _JuDUB9QQ;
        "pkg-1.0.0.7-forge" = _2tbfdnrm;
        "pkg-1.0.3.7" = _MMGIoQL7;
        "pkg-1.0.0.9-forge" = _tHBMmUT8;
        "pkg-1.0.1.8-1.21.5" = _52Y2eomn;
        "pkg-1.0.3.9" = _wf29oiF6;
        "pkg-1.0.2.0-1.21.5" = _mduwWo1W;
        "pkg-1.0.2.3-1.21.5" = _Bu3Zwz1X;
        "pkg-1.0.4.5" = _uUUNwvBj;
        "pkg-1.0.5.0" = _8fGBFO6p;
        "pkg-1.0.5.3" = _6URaRhC0;
        "pkg-1.0.1.0-forge" = _CEkKPc54;
        "pkg-1.0.1.2-forge" = _yGCPumbM;
        "pkg-1.0.5.5" = _osKkmy4A;
        "pkg-1.0.6.1" = _o9nRg0NS;
        "pkg-1.0.1.5-forge" = _DzsrckXm;
        "pkg-1.0.6.5" = _L49mejDo;
        "pkg-1.0.6.7" = _qyFNQ2X1;
        "pkg-1.0.7.0" = _gBywQfNV;
        "pkg-1.0.1.9-forge" = _jjwAG3Ay;
        "pkg-1.0.2.0-forge" = _JaRJLChh;
        "pkg-1.0.8.2" = _NDegunhz;
        "pkg-1.0.8.5" = _K2MqjpAv;
        "pkg-1.0.8.6" = _f9DqTyVG;
        "pkg-1.0.2.4-forge" = _5LlYQYPe;
        "pkg-1.0.9.5" = _KadV1XOe;
        "pkg-1.0.9.6" = _XeQMyeo9;
        "pkg-1.0.9.7" = _30fk0nIO;
        "pkg-1.0.2.8-forge" = _IO3m7p7p;
        "pkg-1.0.3.5-forge" = _ZtxldbHh;
        "pkg-1.1.0.0" = _E2rThwxc;
        "pkg-1.0.3.7-forge" = _GmMwwbfn;
        "pkg-1.0.3.8-forge" = _N5EfPCxP;
        "pkg-1.1.0.1" = _7c8M5L6A;
        "pkg-1.1.1.0" = _hSOiZv4y;
        "pkg-1.1.1.2" = _YsfxBOBF;
        "pkg-1.1.1.5" = _MCgCf3fS;
        "pkg-1.1.1.7" = _O0Lx0MGC;
        "pkg-1.1.2.7" = _mND06EBv;
        "pkg-1.0.4.0-forge" = _nUlTtA4m;
        "pkg-1.0.4.1-forge" = _SRhJhNQX;
        "pkg-1.1.2.8" = _8TKEbHH4;
        "pkg-1.1.3.5" = _iMUaYgpP;
        "pkg-1.1.4.4" = _8OkiDcMj;
        "default" = _8OkiDcMj;
    });
