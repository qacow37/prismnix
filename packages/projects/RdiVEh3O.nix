...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0.0.0-NEOFORGE" = _Fz262fBi;
        "pkg-1.20.6-1.0.0.0-FABRIC" = _l1u7E8EK;
        "pkg-1.20.6-1.0.0.0-NEOFORGE" = _sTXQ4YfV;
        "pkg-1.21-1.0.0.0-FABRIC" = _HHUaQIAw;
        "pkg-1.21-1.0.0.0-NEOFORGE" = _AaXijWj8;
        "pkg-1.21-1.0.0.1-FABRIC" = _EmfAFNMJ;
        "pkg-1.21-1.0.0.1-NEOFORGE" = _fdZJT1lq;
        "pkg-1.21.1-1.0.0.1-FABRIC" = _c33e8k2J;
        "pkg-1.21.1-1.0.0.1-NEOFORGE" = _rkyraoI9;
        "pkg-1.21.1-1.0.0.2-FABRIC" = _DcDAWDX6;
        "pkg-1.21.1-1.0.0.2-NEOFORGE" = _wMV84Bkf;
        "pkg-1.20.1-1.0.0.5-FABRIC" = _lONuktsw;
        "pkg-1.20.1-1.0.0.5-FORGE" = _iOMUTu7p;
        "pkg-1.20.1-1.0.0.6-FABRIC" = _gS3kNKMz;
        "pkg-1.20.1-1.0.0.6-FORGE" = _pqVAKhG6;
        "pkg-1.20.4-1.0.0.6-FABRIC" = _vb9A8R2T;
        "pkg-1.20.4-1.0.0.6-NEOFORGE" = _LVagpaPC;
        "pkg-1.20.6-1.0.0.6-FABRIC" = _f8SNmC2z;
        "pkg-1.20.6-1.0.0.6-NEOFORGE" = _rTrxbazp;
        "pkg-1.21.1-1.0.0.6-FABRIC" = _yEpi8qBw;
        "pkg-1.21.1-1.0.0.6-NEOFORGE" = _va0P21OQ;
        "pkg-1.21.3-1.0.0.6-FABRIC" = _YCOL88uq;
        "pkg-1.21.3-1.0.0.6-NEOFORGE" = _nZHbxZr5;
        "pkg-1.21.4-1.0.0.6-FABRIC" = _822V1DdG;
        "pkg-1.21.4-1.0.0.6-NEOFORGE" = _zpfrD8n1;
        "pkg-1.21.8-1.0.0.6-FABRIC" = _KfLpCmhb;
        "pkg-1.21.8-1.0.0.6-NEOFORGE" = _w45UBKHK;
        "pkg-1.20.1-1.0.1.0-FABRIC" = _ABZY0dNg;
        "pkg-1.20.1-1.0.1.0-FORGE" = _9F3WVyXb;
        "pkg-1.21.1-1.0.1.0-FABRIC" = _Np4cLMyT;
        "pkg-1.21.1-1.0.1.0-NEOFORGE" = _u520dMmr;
        "pkg-1.21.8-1.0.1.0-FABRIC" = _dvxpyEe9;
        "pkg-1.21.8-1.0.1.0-NEOFORGE" = _Ut9xlD5W;
        "pkg-1.21.8-1.0.1.1-FABRIC" = _JCBKVfKI;
        "pkg-1.21.8-1.0.1.1-NEOFORGE" = _M3xeSAaB;
        "pkg-1.20.1-1.0.1.1-FABRIC" = _jteDzjT7;
        "pkg-1.20.1-1.0.1.1-FORGE" = _Pky6dJCC;
        "pkg-1.20.1-1.0.1.2-FABRIC" = _QV3EwM2O;
        "pkg-1.20.1-1.0.1.2-FORGE" = _24L8STg6;
        "pkg-1.21.1-1.0.1.1-FABRIC" = _sEToCfU8;
        "pkg-1.21.1-1.0.1.1-NEOFORGE" = _gHKN5T9r;
        "pkg-1.21.8-1.0.1.2-FABRIC" = _xYlR9yvU;
        "pkg-1.21.8-1.0.1.2-NEOFORGE" = _JHb6Zbjx;
        "pkg-1.20.1-1.0.1.3-FORGE" = _kB55PEKf;
        "pkg-1.21.1-1.0.1.2-FABRIC" = _iRDOhhBZ;
        "pkg-1.21.1-1.0.1.2-NEOFORGE" = _YRjFbrGg;
        "pkg-1.21.8-1.0.1.3-FABRIC" = _T1bpqD8U;
        "pkg-1.21.8-1.0.1.3-NEOFORGE" = _oECXznF6;
        "pkg-1.21.9-1.0.2.0-FABRIC" = _i4KOMKQD;
        "pkg-1.21.9-1.0.2.0-NEOFORGE" = _2rLHQM4g;
        "pkg-1.21.10-1.0.2.0-FABRIC" = _lraqlnXI;
        "pkg-1.21.10-1.0.2.0-NEOFORGE" = _iomzLsst;
        "pkg-1.21.1-1.0.2.1-FABRIC" = _esGGyD68;
        "pkg-1.21.1-1.0.2.1-NEOFORGE" = _ZLqaEKQp;
        "pkg-1.21.10-1.0.2.1-FABRIC" = _PKBuHGJE;
        "pkg-1.21.10-1.0.2.1-NEOFORGE" = _Khnrdtv5;
        "pkg-1.21.11-1.0.2.1-FABRIC" = _tEk3zf9F;
        "pkg-1.21.11-1.0.2.1-NEOFORGE" = _Do1pmPpx;
        "pkg-26.1.1-1.0.2.1-FABRIC" = _VR7efGq6;
        "pkg-26.1.1-1.0.2.1-NEOFORGE" = _Xf9tSG2T;
        "pkg-26.1.2-1.0.2.1-FABRIC" = _ujVYxW3J;
        "pkg-26.1.2-1.0.2.1-NEOFORGE" = _LrP4yvn8;
        "pkg-1.21.1-1.0.2.2-FABRIC" = _r63X82j2;
        "pkg-1.21.1-1.0.2.2-NEOFORGE" = _SMTEBWw2;
        "pkg-26.1.2-1.0.2.2-FABRIC" = _3E8Watqi;
