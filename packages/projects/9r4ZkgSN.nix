...
let
    ...
    in {
        ...
        "pkg-r1.8" = _oY1ZBxOw;
        "pkg-r1.9" = _kHxswnXH;
        "pkg-r1.9.1" = _gtuWYWeg;
        "pkg-1.9" = _Xa9zwGHR;
        "pkg-1.11a3" = _fHEx49EB;
        "pkg-1.11a4" = _7oWoFnBM;
        "pkg-1.11a4b" = _IvsYaD7N;
        "pkg-1.11a4c" = _5IIpPDM4;
        "pkg-1.11a5" = _oNYFCFUh;
        "pkg-1.11a5b" = _ApzBa6Up;
        "pkg-1.11a1.18.2" = _xUGzErST;
        "pkg-1.11a6" = _u5nPBEmk;
        "pkg-1.11b1" = _wE0BlO3B;
        "pkg-1.11b2" = _iGIHemfG;
        "pkg-1.11b3" = _xm6k9R9p;
        "pkg-1.11b2-1.18.2" = _rHZDMu5E;
        "pkg-1.11b4" = _EZNePEz5;
        "pkg-1.11b5" = _YlUnDpwJ;
        "pkg-1.11" = _UvQBx25Q;
        "pkg-1.11-1.18.2" = _NFv8fir1;
        "pkg-1.11-22w42a" = _BwnW8P6f;
        "pkg-1.11.1" = _11GEdRk8;
        "pkg-1.11.2-1.18.2" = _IFK4aVkQ;
        "pkg-1.11.2" = _ExafmHT8;
        "pkg-1.11.2-22w42a" = _O4KfZL8f;
        "pkg-1.11.3" = _mZjDvoCa;
        "pkg-1.11.3-22w42a" = _BoibvsBu;
        "pkg-1.11.3-1.18.2" = _R3iwOJGr;
        "pkg-1.11.3-22w43a" = _fToOAJrL;
        "pkg-1.11.3-22w45a" = _4IZ3pnIQ;
        "pkg-1.11.3-22w46a" = _HqiLiKMi;
        "pkg-1.11.4-1.18.2" = _3dtgrapp;
        "pkg-1.11.4" = _Ze717MYv;
        "pkg-1.11.4-22w46a" = _mqmb5sfw;
        "pkg-1.11.4-1.19.3" = _fo6V4hr5;
        "pkg-1.12" = _VrYxGcg0;
        "pkg-1.12-1.19.3" = _LtEo7Fqi;
        "pkg-1.12-1.18.2" = _fQzVGfa5;
        "pkg-1.12-23w04a" = _95Hqzg01;
        "pkg-1.12-1.19.4" = _e7FaUuF7;
        "pkg-1.13" = _jv9W8HOA;
        "pkg-1.13-1.19.3" = _t4mTUYnO;
        "pkg-1.13-1.19.4" = _lh10V3r2;
        "pkg-1.13.1" = _yEo98Vbe;
        "pkg-1.13.1-1.19.3" = _Bbv9W1V2;
        "pkg-1.13.1-1.19.4" = _DW7nb3EV;
        "pkg-1.13.1-1.20" = _Ev2KSSWR;
        "pkg-1.13.3-1.20" = _q8DOigeD;
        "pkg-1.13.3-1.19" = _Dv34ewqS;
        "pkg-1.13.3-1.19.3" = _6z9SSIsk;
        "pkg-1.13.3-1.19.4" = _3kZPzEZF;
        "pkg-1.12.1-1.18.2" = _f8hsWFFR;
        "pkg-1.13.4" = _REsjlj43;
        "pkg-1.13.5" = _QII3TzT1;
        "pkg-1.13.6" = _FKt8JNOd;
        "pkg-1.14-1.20.1" = _2wG0N40d;
        "pkg-1.14" = _dd9U7ewC;
        "pkg-1.15" = _dSBv3axo;
        "pkg-1.15.1" = _oAWst0hS;
        "pkg-1.15.2" = _Ec42ndUG;
        "pkg-1.15.3" = _iuhPovqT;
        "pkg-1.15.4" = _tINoAkAa;
        "pkg-1.15.4-1.20.1" = _IJ5tVtsR;
        "pkg-1.15.5" = _wPuMjxmV;
        "pkg-1.16-1.20.2" = _G9vP8wc0;
        "pkg-1.16-1.20.1" = _DonIUBAf;
        "pkg-1.16-1.20.4" = _TCmoc5Sl;
        "pkg-1.16.1-1.20.2" = _4qLWHaik;
        "pkg-1.16.1-1.20.4" = _aNc9MS3Y;
        "pkg-1.16.1-1.20.1" = _RMObPif0;
        "pkg-1.16.1-1.20.6" = _cKpjhpJs;
        "pkg-1.17" = _Ogzd0CTk;
        "pkg-2.0" = _4X6dOYLU;
        "pkg-2.0-1.21" = _8WV3U3dD;
        "pkg-2.0.1-mc1.21.2" = _DvLSLBqQ;
        "pkg-2.0.1-mc1.20.1" = _66O1gNQr;
        "pkg-2.0.1" = _uKSC4ZdK;
        "pkg-2.0.2-mc1.21.2" = _wnVUwBv6;
        "pkg-2.0.2-mc1.21.1" = _knOqHFPW;
        "pkg-2.0.2-mc1.20.1" = _beKju3ZQ;
        "pkg-2.0.3-mc1.21.2" = _b2EUC6GL;
        "pkg-2.0.3-mc1.21.1" = _4P7GtiZx;
        "pkg-2.0.3-mc1.20.1" = _kUCsby3t;
        "pkg-2.0.4-mc1.21.1" = _5d27deAL;
        "pkg-2.0.4-mc1.21.2" = _1NFhhOfM;
        "pkg-2.0.4-mc1.21.4" = _xe4E3Uh1;
        "pkg-2.0.5-mc1.21.1" = _Zrb0ZqS8;
        "pkg-2.0.5-mc1.21.2" = _bvKVtD1r;
        "pkg-2.0.5-mc1.21.4" = _gIyCUpzQ;
        "pkg-2.0.6-mc1.21.1" = _OiCkwg79;
        "pkg-2.0.6-mc1.21.2" = _9hdQnCMc;
        "pkg-2.0.6-mc1.21.4" = _eSc3BziT;
        "pkg-2.0.6-mc1.21.5" = _loJugPYH;
        "pkg-2.0.7-mc1.21.6" = _1hK4RC2l;
        "pkg-2.1-mc1.21.9" = _Ps3kBP4S;
        "pkg-2.1.1-mc1.21.9" = _kmQBsCut;
        "pkg-2.1.1-mc1.21.10" = _dsycOT4n;
        "pkg-2.1.2-mc1.21.9" = _npyW8LXj;
        "pkg-2.1.2-mc1.21.10" = _bcM1dvVT;
        "pkg-2.1.3-mc1.21.9" = _KdQWLAAi;
        "pkg-2.1.3-mc1.21.10" = _DpcnP84G;
        "pkg-2.1.3" = _1mO9LrK4;
        "pkg-2.1.3-mc26.1-snapshot-1" = _Z5FhPWj6;
        "pkg-2.1.4-mc1.21.11" = _uFf00jF4;
