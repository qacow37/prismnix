...
let
    ...
    in {
        ...
        "pkg-v1.0.0" = _1BAH1Fmm;
        "pkg-v1.0.1" = _9da5SUUE;
        "pkg-v1.1.0-BETA" = _vy19p9S2;
        "pkg-v1.1.0-FABRIC" = _UoZjeXyw;
        "pkg-v1.1.0-FORGE" = _szQITYw5;
        "pkg-v1.1.1-FABRIC" = _x6jMLOOm;
        "pkg-v1.1.1-FORGE" = _E6XEbizt;
        "pkg-v1.1.2-FABRIC" = _9A6JOWnF;
        "pkg-v1.1.3-FORGE" = _zsWgYniU;
        "pkg-1.1.3-FABRIC" = _gekGJBUM;
        "pkg-1.1.4-FABRIC" = _if4FKoj6;
        "pkg-1.1.4-FORGE" = _AqrTbFlu;
        "pkg-v1.2.0-beta.1+1.19.2-fabric" = _Qp4mzcwz;
        "pkg-v1.2.0-beta.1+1.19.2-forge" = _pKVAdkWH;
        "pkg-v1.2.0-beta.1+1.19.2-quilt" = _tEJFvR4T;
        "pkg-v1.2.0-beta.1+1.19.4-fabric" = _WwLNA9vO;
        "pkg-v1.2.0-beta.1+1.19.4-forge" = _K44UJtlI;
        "pkg-v1.2.0-beta.1+1.19.4-quilt" = _YtPVa5V0;
        "pkg-v1.2.0-beta.2+1.19.2-fabric" = _4cTlUzWV;
        "pkg-v1.2.0-beta.2+1.19.2-forge" = _YKlkpfeY;
        "pkg-v1.2.0-beta.2+1.19.2-quilt" = _q1Z1ov2J;
        "pkg-v1.2.0-beta.2+1.19.4-fabric" = _ol6qGuRB;
        "pkg-v1.2.0-beta.2+1.19.4-forge" = _nAQ2r6zt;
        "pkg-v1.2.0-beta.2+1.19.4-quilt" = _zWtapWEe;
        "pkg-v1.2.0-beta.2+1.20.1-fabric" = _KE1DqY72;
        "pkg-v1.2.0-beta.2+1.20.1-quilt" = _McZRLQ6v;
        "pkg-v1.2.0-beta.3+1.20.1-quilt" = _1rV0TzcL;
        "pkg-v1.2.0-beta.3+1.20.1-fabric" = _mTNXLZSF;
        "pkg-v1.2.0-beta.4+1.20.1-quilt" = _PuSQKUFe;
        "pkg-v1.2.0-beta.5+1.20.1-quilt" = _2WyDYFXS;
        "pkg-v1.2.0-beta.5+1.20.1-fabric" = _mTWkowcZ;
        "pkg-v1.2.0-beta.6+1.20.1-quilt" = _TYbWppp0;
        "pkg-v1.2.0-beta.6+1.20.1-fabric" = _6yYHbif8;
        "pkg-v1.2.0-beta.7+1.20.1-quilt" = _kWHcf5XI;
        "pkg-v1.2.0-beta.7+1.20.1-fabric" = _vMRESHaS;
        "pkg-v1.2.0+1.20.1-fabric" = _ppVcErow;
        "pkg-v1.2.0+1.20.1-quilt" = _w0XKjr7B;
        "pkg-v1.2.0+1.20.1-forge" = _7Ur35xRv;
        "pkg-v1.2.1+1.20.1-fabric" = _FU3pQpFT;
        "pkg-v1.2.1+1.20.1-forge" = _CUyy6u4Y;
        "pkg-v1.2.1+1.20.1-quilt" = _6QhjdE9r;
        "pkg-1.3.0+1.21-fabric" = _zkWQXCYk;
        "pkg-1.3.0+1.21-neoforge" = _5m6Kddkv;
        "pkg-1.3.1+1.21-neoforge" = _syuC5oFD;
        "pkg-1.3.1+1.21-fabric" = _FWKVimaL;
        "pkg-1.3.2+1.21-neoforge" = _2yS2DpIE;
        "pkg-1.3.3+1.21-fabric" = _ZPLnIVe9;
        "pkg-1.4.0+beta+1.21.1-neoforge" = _ArlxkfJ3;
        "pkg-1.4.0+beta+1.21.1-fabric" = _gokV67bZ;
        "default" = _gokV67bZ;
    });
