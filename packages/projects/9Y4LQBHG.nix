...
let
    ...
    in {
        ...
        "pkg-1.12-0.0.1" = _RzrDXnO0;
        "pkg-1.12-0.0.2" = _EKxljldv;
        "pkg-1.12-0.1.0" = _ruQTU9PS;
        "pkg-1.12-0.1.1" = _CACqkSKh;
        "pkg-1.12-0.1.2" = _N6i7Zzmu;
        "pkg-1.12-0.1.3" = _ZnzZmFu8;
        "pkg-1.12-0.1.4" = _9SqozDUt;
        "pkg-1.12-0.1.5" = _OrXiOZb5;
        "pkg-1.12-0.1.6" = _GJ2D1iD1;
        "pkg-1.12-0.1.7" = _QzwNoydY;
        "pkg-1.12-0.1.8" = _OEbWCtpc;
        "pkg-1.12-0.1.9" = _Uy7uvzwm;
        "pkg-1.12-0.1.10" = _hGRw3cEs;
        "pkg-1.12-0.1.11" = _hlh64uzg;
        "pkg-1.12-0.1.12" = _Z9eWuaDm;
        "pkg-1.12-0.1.13" = _aOgslOvg;
        "pkg-1.12-0.1.14" = _ymK4W2pS;
        "pkg-1.15-1.0.0" = _PQWfrxGU;
        "pkg-1.15-1.0.1" = _I4eOUZgn;
        "pkg-1.15-1.0.2" = _75QOPpvu;
        "pkg-1.12-0.1.15" = _bpci0Uk2;
        "pkg-1.15-1.0.3" = _vE9wkSUu;
        "pkg-1.15-1.0.4" = _M1ZZCCKc;
        "pkg-1.16-2.0.0" = _zgQzPVpk;
        "pkg-1.16-2.0.1" = _2BvzwMio;
        "pkg-1.15-1.0.5" = _2ffDq37s;
        "pkg-1.16-2.0.2" = _bpYQlUaz;
        "pkg-1.15-1.0.6" = _rKa35Hu1;
        "pkg-1.16-2.0.3" = _OiaByv4K;
        "pkg-1.16-2.0.4" = _XsKQ0grP;
        "pkg-1.16-2.0.5" = _48uL12eO;
        "pkg-1.16-2.0.6" = _qSBFBsvk;
        "pkg-1.16-2.0.7" = _WlgtuTZv;
        "pkg-1.16-2.0.8" = _33s2TMdT;
        "pkg-1.16-2.0.9" = _Kfm35sVo;
        "pkg-1.16-2.0.10" = _7nTXydol;
        "pkg-1.16-2.0.11" = _YXOHAfwE;
        "pkg-1.16-2.0.12" = _7iqLRBn8;
        "pkg-1.16-2.0.13" = _Ksa4SxLO;
        "pkg-1.18-3.0.0" = _m1d0DPHg;
        "pkg-1.18-3.0.1" = _WkBumC5J;
        "pkg-1.19-4.0.0" = _23T8huyO;
        "pkg-1.19-4.0.1" = _H2A6CY1L;
        "pkg-1.16-2.0.14" = _ulhj453B;
        "pkg-1.18-3.0.2" = _KSXsSIZU;
        "pkg-1.19-4.0.2" = _vBwdXSMY;
        "pkg-1.19-4.0.3" = _eIlbRhBX;
        "pkg-1.19-4.0.4" = _bOFUXFLA;
        "pkg-1.18-3.0.3" = _k6A7pulD;
        "pkg-1.16-2.0.15" = _H5aPZzJ5;
        "pkg-1.18-3.0.4" = _1H787OhV;
        "pkg-1.19-4.0.5" = _Dkk8kqsM;
        "pkg-1.18-3.0.5" = _ihUVF8lZ;
        "pkg-1.19-4.0.6" = _4hAv1xOm;
        "pkg-1.19-4.0.7" = _dq3PGpTB;
        "pkg-1.18-3.0.6" = _pO6FlxC8;
        "pkg-1.18-3.0.7" = _U9Gbt54X;
        "pkg-1.19-4.0.8" = _Cvwa1Osm;
        "pkg-1.19-4.0.9" = _VqIJPW5A;
        "pkg-1.18-3.0.8" = _JLzViVU7;
        "pkg-1.19.3-5.0.0" = _8d2AtB2A;
        "pkg-1.19.3-5.0.1" = _PIAqp7TB;
        "pkg-1.19-4.0.10" = _BxJzU8pT;
        "pkg-1.18-3.0.9" = _ymGp85XY;
        "pkg-1.18-3.0.10" = _1W20w0JT;
        "pkg-1.19-4.0.11" = _Kkn812pF;
        "pkg-1.19.3-5.0.2" = _SDd6P4dF;
        "pkg-1.19-4.0.12" = _aYhWA5PZ;
        "pkg-1.19-4.0.13" = _db8y8gKe;
        "pkg-1.19-4.0.14" = _kYwbVojU;
        "pkg-1.19-4.0.15" = _WylMTOFE;
        "pkg-1.19-4.0.16" = _KF3EHJIC;
        "default" = _KF3EHJIC;
    });
