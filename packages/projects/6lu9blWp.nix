...
let
    ...
    in {
        ...
        "pkg-1.13" = _KgB8qUf8;
        "pkg-1.14" = _chUe8FSu;
        "pkg-1.14.1" = _k6JgfwTJ;
        "pkg-1.14.4" = _R8ZAe1xl;
        "pkg-1.14.5" = _YE8Haf27;
        "pkg-1.14.6" = _yzVFluIR;
        "pkg-1.14.7" = _M953RPXA;
        "pkg-1.13.1" = _qWsjwRet;
        "pkg-1.15.0" = _1Ab8aRF4;
        "pkg-1.15.1" = _LcIS55iN;
        "pkg-1.15.2" = _Oo6Pocan;
        "pkg-1.31.1" = _KWghAXa4;
        "pkg-1.15.3" = _gU9TVpHN;
        "pkg-1.32.0" = _JwX4Tx0g;
        "pkg-1.32.1" = _SoZ7Wj0q;
        "pkg-1.32.2" = _UbvJG9Mc;
        "pkg-1.32.3" = _aRUXYI5Q;
        "pkg-1.32.4" = _Q3R2wSD5;
        "pkg-1.32.5" = _MkOGRd9a;
        "pkg-1.32.6" = _sKPm7992;
        "pkg-1.33.0" = _zI0y4iLt;
        "pkg-1.33.1" = _v20EQXhk;
        "pkg-1.34.0" = _5qLxSlRL;
        "pkg-1.34.1" = _qCbbtlg0;
        "pkg-1.34.2" = _JJLsGV90;
        "pkg-1.34.3" = _dE9oummq;
        "pkg-1.34.4" = _kn1y9zwQ;
        "pkg-1.35.0" = _Sai2YuSj;
        "pkg-1.34.5" = _Uuri7m8x;
        "pkg-1.34.6" = _qaaw2jSz;
