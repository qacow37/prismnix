...
let
    ...
    in {
        ...
        "pkg-mc1.18.x-1.0.2" = _MYYTHseB;
        "pkg-mc1.19.x-1.0.2" = _3qOpWPeX;
        "pkg-mc1.17.x-1.0.0" = _h0B6LiBB;
        "pkg-mc1.18.x-1.0.3" = _RRqDlnmM;
        "pkg-mc1.19.2-1.0.3" = _FYqHzL9T;
        "pkg-mc1.17.x-1.0.1" = _RXPZBUN5;
        "pkg-1.0.4-1.20.1-forge" = _T0VMSw3q;
        "pkg-1.0.4-1.20.1-fabric" = _IePUqvUd;
        "pkg-1.0.5-1.20.1-fabric" = _eMfkSCKT;
        "pkg-1.0.5-1.20.1-forge" = _T2UG6bMx;
        "pkg-1.0.5-1.19.2-forge" = _mz6NzvFe;
        "pkg-1.0.5-1.19.2-fabric" = _BelrUE6J;
        "pkg-1.0.5-1.19.4-fabric" = _4I46OpEx;
        "pkg-1.0.5-1.19.4-forge" = _4S6HVHgn;
        "pkg-1.0.5-1.18.2-fabric" = _A6SPxUev;
        "pkg-1.0.5-1.18.2-forge" = _2TRINCfo;
        "pkg-1.0.5-1.16.5-fabric" = _s9hTy9Hu;
        "pkg-1.0.5-1.16.5-forge" = _jvPI4DJA;
        "pkg-1.0.5-1.17.1-fabric" = _Bc0mklLc;
        "pkg-1.0.5-1.17.1-forge" = _NiOmIEK3;
        "pkg-1.0.6-1.20.1-fabric" = _XQVoeSGd;
        "pkg-1.0.6-1.19.4-fabric" = _DNc3wzKk;
        "pkg-1.0.6-1.20.1-forge" = _V8hbzvI0;
        "pkg-1.0.6-1.19.4-forge" = _TpHZlrez;
        "pkg-1.0.6-1.19.2-fabric" = _bMXRwT4Z;
        "pkg-1.0.6-1.18.2-fabric" = _pUDhvtdX;
        "pkg-1.0.6-1.19.2-forge" = _EES8EhEd;
        "pkg-1.0.6-1.18.2-forge" = _W8BDBx1s;
        "pkg-1.0.6hotfix-1.18.2-fabric" = _l11IiG5r;
        "pkg-1.0.6-1.16.5-fabric" = _bRLnoWMI;
        "pkg-1.0.6-1.16.5-forge" = _VHa6oowQ;
        "pkg-1.0.6-1.17.1-fabric" = _yLnehxOn;
        "pkg-1.0.6-1.17.1-forge" = _MEAfRuT5;
        "pkg-1.0.7-1.20.1-forge" = _V0QAGw3U;
        "pkg-1.0.7-1.20.1-fabric" = _ZKNh0y2c;
        "default" = _ZKNh0y2c;
    });
