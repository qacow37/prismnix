...
let
    ...
    in {
        ...
        "pkg-v20.4.0-1.20.4-Forge" = _JIPpYa5w;
        "pkg-v20.4.0-1.20.4-NeoForge" = _sArzmwCk;
        "pkg-v8.0.1-1.20.1-Forge" = _aQT24Bn6;
        "pkg-v8.0.1-1.20.1-Fabric" = _jzNJUCTD;
        "pkg-v8.0.2-1.20.1-Forge" = _GjdmA0S5;
        "pkg-v8.0.2-1.20.1-Fabric" = _pWDZoQQ0;
        "pkg-v20.4.1-1.20.4-Fabric" = _JAyBKne3;
        "pkg-v20.4.1-1.20.4-Forge" = _nrwCEppr;
        "pkg-v20.4.1-1.20.4-NeoForge" = _Dd9wOQlD;
        "pkg-v21.0.0-1.21-Fabric" = _m71DpGUc;
        "pkg-v21.0.0-1.21-NeoForge" = _lxqws0Kj;
        "pkg-v21.1.0-1.21.1-Fabric" = _RkLWpk7W;
        "pkg-v21.1.0-1.21.1-NeoForge" = _4CtETbgv;
        "pkg-v21.3.0-1.21.3-Fabric" = _ORGTlT8O;
        "pkg-v21.3.0-1.21.3-NeoForge" = _PG7K3TIX;
        "pkg-v21.4.0-1.21.4-Fabric" = _D1ZhdlHg;
        "pkg-v21.4.0-1.21.4-NeoForge" = _8wvP4f9f;
        "pkg-v21.5.0-1.21.5-Fabric" = _zhFNyqmH;
        "pkg-v21.5.0-1.21.5-NeoForge" = _vwNqn854;
        "pkg-v21.7.0-1.21.7-Fabric" = _TpW4mkr9;
        "pkg-v21.7.0-1.21.7-NeoForge" = _qgdROJny;
        "pkg-v21.8.0-1.21.8-Fabric" = _K26gsDy3;
        "pkg-v21.8.0-1.21.8-NeoForge" = _nUVhfprN;
        "pkg-v8.0.3-1.20.1-Forge" = _nAAkM9HI;
        "pkg-v8.0.3-1.20.1-Fabric" = _GBBwWl2l;
        "pkg-v21.1.1-1.21.1-Fabric" = _EEHLAX6H;
        "pkg-v21.1.1-1.21.1-NeoForge" = _gxFLjZrq;
        "pkg-v21.8.1-1.21.8-Fabric" = _jW3d6abV;
        "pkg-v21.8.1-1.21.8-NeoForge" = _vJJgL7Jr;
        "pkg-21.9.0" = _Lh7Sfv7h;
        "pkg-21.10.0" = _gb1E3RvC;
