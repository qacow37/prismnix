...
let
    ...
    in {
        ...
        "pkg-2.2.0+1.19" = _WIvEx3e9;
        "pkg-2.3.0+1.19" = _xJbLkuvd;
        "pkg-2.3.1+1.19" = _j6bVg0YJ;
        "pkg-2.3.2+1.19" = _YpCRiC2u;
        "pkg-2.3.3+1.19" = _4tu84oMh;
        "pkg-2.4.0+1.20" = _xnRT88bP;
        "pkg-2.4.1+1.20" = _pn1lWqQq;
        "pkg-2.5.0+1.20" = _VPA2WJX5;
        "pkg-2.5.1+1.20" = _f238xKrO;
        "pkg-2.5.2+1.20" = _zDj1Rcv9;
        "pkg-2.5.3+1.20.4" = _aR70w2i8;
        "pkg-2.6.0+1.20" = _7evCJjG3;
        "pkg-3.0.0+1.20" = _4iwr29tA;
        "pkg-3.0.1+1.21" = _VSu8wbHu;
        "pkg-3.1.0+1.21" = _Rz45fpga;
        "pkg-3.2.0+1.21.1" = _4sh8GN2Q;
        "pkg-3.0.1+1.20" = _nWIInqy7;
        "pkg-3.2.1+1.21.1" = _PZOyr6QP;
        "pkg-3.3.0+1.21.3" = _5wBaXTRx;
        "pkg-3.4.0+1.21.4" = _34ZXeSYM;
        "pkg-3.4.1+1.21.5" = _fNVmQ3WP;
        "pkg-3.4.2+1.21.5" = _VMJPAKWT;
        "pkg-3.4.3+1.21.8" = _ddxIVwS7;
        "pkg-3.4.4-alpha+1.21.10" = _OZyQnNQt;
        "pkg-3.5.0-beta+1.21.11" = _vaO0SeEZ;
        "default" = _vaO0SeEZ;
    });
