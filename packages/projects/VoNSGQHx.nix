...
let
    ...
    in {
        ...
        "pkg-0.0.1-1.20.5" = _AOwIEBiE;
        "pkg-0.0.1-1.20.4" = _rLWv39JU;
        "pkg-0.0.1-1.20.1" = _mPCS9znQ;
        "pkg-0.0.1-1.19.4" = _ei5OTYFE;
        "pkg-0.0.1-1.18.2" = _1qplSuE2;
        "pkg-0.1.0-1.20.5" = _7jZq7icr;
        "pkg-0.1.0-1.20.4" = _TP6vjHf6;
        "pkg-0.1.0-1.20.1" = _kcaLQo41;
        "pkg-0.1.0-1.19.4" = _78430RxV;
        "pkg-0.1.0-1.18.2" = _378dBnSx;
        "pkg-0.1.1-1.20.5" = _HMMQgf2A;
        "pkg-0.1.1-1.20.4" = _cZGLSE1k;
        "pkg-0.1.1-1.19.4" = _Z3XOH9MB;
        "pkg-0.1.1-1.18.2" = _5kptELVB;
        "pkg-0.1.2-1.20.1" = _z1OeD149;
        "pkg-0.1.2-1.20.4" = _PFwu6NDJ;
        "pkg-0.1.3-1.18.2" = _qES9lvX4;
        "pkg-0.1.3-1.19.4" = _tnVHBuM5;
        "pkg-0.1.3-1.20.1" = _cZu9D08P;
        "pkg-0.1.3-1.20.4" = _36mptIgY;
        "pkg-0.1.3-1.20.5" = _5Rv3QRD4;
        "pkg-0.1.4-1.20.5" = _cxh6HLNj;
        "default" = _cxh6HLNj;
    });
