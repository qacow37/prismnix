...
let
    ...
    in {
        ...
        "pkg-0.1-1.20.1" = _OUS5ySfn;
        "pkg-0.2-1.20.1" = _hvxvMVs1;
        "pkg-0.3-1.20.1" = _ISsDW11u;
        "pkg-0.3-1.12.2" = _1iaBNvkk;
        "pkg-0.3-1.7.10" = _Z2ZnOumd;
        "pkg-0.3.0-1.7.10" = _MzasWoLv;
        "pkg-0.3.1-1.7.10" = _kYv2DTYT;
        "pkg-0.3.2-1.7.10" = _fPrXXHmw;
        "pkg-0.3.3-1.7.10" = _2pjMcMFl;
        "pkg-0.3.4-1.7.10" = _fMQhCNlk;
        "pkg-0.4-1.20.1" = _PnjbOjNK;
        "pkg-0.4-1.12.2" = _LC0KxsBS;
        "pkg-0.4.1-1.12.2" = _L5V22fjP;
        "pkg-0.4.1-1.20.1" = _Z3PlTAsq;
        "pkg-0.4.2-1.20.1" = _vaSNWJFP;
        "pkg-0.3.5-1.7.10" = _u0HLWXPx;
        "pkg-0.3.7-1.7.10" = _joaRN9eK;
        "pkg-0.3.10-1.7.10" = _OaQzgPn9;
        "pkg-0.3.12-1.7.10" = _nsLJIzqQ;
        "pkg-0.4.3-1.20.1" = _9litZedm;
        "pkg-0.4.4-1.20.1" = _XA2b4xp4;
        "pkg-0.3.13-1.7.10" = _ZtLBefGf;
        "default" = _ZtLBefGf;
    });
