...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _2r6x5wIZ;
        "pkg-v4.0.2-1.19.2-Fabric" = _vka9k10s;
        "pkg-v4.0.2-1.19.2-Forge" = _k0p2W8fJ;
        "pkg-v4.0.3-1.19.2-Forge" = _vAbDFPOV;
        "pkg-v4.0.3-1.19.2-Fabric" = _q0xXFnz3;
        "pkg-v4.0.4-1.19.2-Fabric" = _2RM8LNzg;
        "pkg-v4.0.4-1.19.2-Forge" = _ogSmEU5z;
        "pkg-v4.0.5-1.19.2-Fabric" = _wkkPu4dB;
        "pkg-v4.0.5-1.19.2-Forge" = _n5bazwHY;
        "pkg-v4.0.6-1.19.2-Fabric" = _bZ3FozLJ;
        "pkg-v4.0.6-1.19.2-Forge" = _W1Nr2YeX;
        "pkg-v4.0.7-1.19.2-Fabric" = _6wD4trlH;
        "pkg-v4.0.7-1.19.2-Forge" = _JopLDI6F;
        "pkg-v5.0.0-1.19.3-Fabric" = _YDHJQ1Jb;
        "pkg-v5.0.0-1.19.3-Forge" = _94X7V8hX;
        "pkg-v6.0.0-1.19.4-Forge" = _r9dFWl5x;
        "pkg-v6.0.0-1.19.4-Fabric" = _7wuHzgKO;
        "pkg-v4.0.8-1.19.2-Fabric" = _JmtXadye;
        "pkg-v4.0.8-1.19.2-Forge" = _RIy723LJ;
        "pkg-v5.0.1-1.19.3-Fabric" = _nRXTPMgV;
        "pkg-v5.0.1-1.19.3-Forge" = _ON4wYFWP;
        "pkg-v6.0.1-1.19.4-Fabric" = _rlyYqyF9;
        "pkg-v6.0.1-1.19.4-Forge" = _vJ6w3pZl;
        "pkg-v4.0.9-1.19.2-Fabric" = _FXjG2oJj;
        "pkg-v4.0.9-1.19.2-Forge" = _e9dCKW7d;
        "pkg-v5.0.2-1.19.3-Fabric" = _4ZbiiiMH;
        "pkg-v5.0.2-1.19.3-Forge" = _f18LnDAQ;
        "pkg-v6.0.2-1.19.4-Fabric" = _VveCEcsb;
        "pkg-v6.0.2-1.19.4-Forge" = _SkN0nr9r;
        "pkg-v7.0.0-1.20-Fabric" = _CfHWBD9n;
        "pkg-v7.0.0-1.20-Forge" = _seEOlqR6;
        "pkg-v8.0.0-1.20.1-Forge" = _MOcWWHUe;
        "pkg-v8.0.0-1.20.1-Fabric" = _WbTzbIE2;
        "pkg-v8.0.1-1.20.1-Forge" = _hFLpBncv;
        "pkg-v8.0.1-1.20.1-Fabric" = _FjjW1qYC;
        "pkg-v3.0.0-1.18.2-Forge" = _WUeq85MM;
        "pkg-v3.0.0-1.18.2-Fabric" = _HyEDNsdn;
        "pkg-v8.0.2-1.20.1-Forge" = _vtTIhFrc;
        "pkg-v8.0.2-1.20.1-Fabric" = _OZRIDods;
        "pkg-v8.0.3-1.20.1-Forge" = _rJocjNjf;
        "pkg-v8.0.3-1.20.1-Fabric" = _hynR8fnB;
        "pkg-v21.7.0-1.21.7-Fabric" = _zBiJlgtM;
        "pkg-v21.7.0-1.21.7-NeoForge" = _muOiDlm9;
        "pkg-v21.1.0-1.21.1-Fabric" = _tgM9WSUn;
        "pkg-v21.1.0-1.21.1-NeoForge" = _sGVDl8zH;
        "pkg-v21.8.0-1.21.8-Fabric" = _CS73N2SK;
        "pkg-v21.8.0-1.21.8-NeoForge" = _YEt1yCtb;
        "pkg-21.9.0" = _cRaFrtZE;
        "pkg-21.10.0" = _Ny7Jx1HR;
