...
let
    ...
    in {
        ...
        "pkg-1.6.1" = _FfAQf6xg;
        "pkg-2.0" = _Zr7jPYOa;
        "pkg-2.0-without-rp" = _5zsr4fxc;
        "pkg-2.0.1" = _w7WI9B60;
        "pkg-2.0.1-without-rp" = _VWOmV2He;
        "pkg-2.1" = _ORDKXiLC;
        "pkg-2.1-without-rp" = _u2CeS1bO;
        "pkg-2.2" = _5KWhy9Ph;
        "pkg-2.2-without-rp" = _XqqEwLf6;
        "pkg-2.3" = _5zo9awsw;
        "pkg-2.3-cropped" = _q6FDKfBj;
        "pkg-2.3.0-cropped" = _qnVTrCcR;
        "pkg-2.3.0" = _G015RtMF;
        "pkg-2.4.0-cropped" = _SEKqFalT;
        "pkg-2.4.0" = _I7NVtOQU;
        "pkg-2.4.0-cropped+mod" = _ovBXeEIe;
        "pkg-2.4.0+mod" = _OmGkFkFW;
        "pkg-2.4.1-cropped" = _w588wyub;
        "pkg-2.4.1" = _X1V8czRx;
        "pkg-2.4.1-cropped+mod" = _nLnE5GCP;
        "pkg-2.4.1+mod" = _lFpqL47O;
        "pkg-2.4.2-cropped" = _bedYstQm;
        "pkg-2.4.2" = _LdYYbuil;
        "pkg-2.4.2-cropped+mod" = _3Ip5aqrR;
        "pkg-2.4.2+mod" = _SxpxdUC5;
        "default" = _SxpxdUC5;
    });
