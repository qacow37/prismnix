...
let
    ...
    in {
        ...
        "pkg-1.0.9" = _Ie0bNAgb;
        "pkg-0.5.9" = _tPNC0UTT;
        "pkg-1.0.10" = _k6SnqxMm;
        "pkg-1.2.0" = _yol3k1ZX;
        "pkg-1.0.11" = _tnCZbTy0;
        "pkg-1.2.1" = _U8pbIBPI;
        "pkg-1.2.1+1" = _TiVM1RjY;
        "pkg-1.2.1+2" = _5YqeciIl;
        "pkg-1.0.12" = _HFL3Od48;
        "pkg-1.2.1+4" = _uAAfFFYE;
        "pkg-1.2.1+5" = _zAOCOYNk;
        "pkg-1.0.13" = _Z4f0SdAw;
        "pkg-1.2.2" = _XW8fHwt6;
        "pkg-1.0.14" = _7DGER4wW;
        "pkg-1.0.15" = _znOgvXZQ;
        "pkg-1.0.16" = _AdvXVw6l;
        "pkg-1.2.3" = _UQYW1Cua;
        "pkg-1.0.17" = _Bg8J2K84;
        "pkg-1.2.4" = _yQECZNhu;
        "pkg-1.0.18" = _xQuwBeXa;
        "pkg-1.2.5" = _19LLzrwv;
        "pkg-1.0.19" = _x48mxwHB;
        "pkg-1.2.6" = _4G3XuzWm;
        "pkg-1.0.20" = _qLvhzASv;
        "pkg-1.0.21" = _kErKgKkm;
        "pkg-1.2.7" = _PYfElzPJ;
        "pkg-1.0.22" = _gSG5A9TX;
        "pkg-1.2.8" = _ucAv4AKT;
        "pkg-1.2.9" = _O5Jcrl5j;
        "pkg-1.1.0" = _puf0UKgr;
        "pkg-1.1.1" = _qPyefm6m;
        "pkg-1.2.10" = _mi4g1Son;
        "pkg-1.2.11" = _x5jrBT3B;
        "pkg-1.2.12" = _34hdoNH8;
        "pkg-1.1.2" = _CrzBnzfA;
        "pkg-1.2.13" = _kLzQjFUo;
        "pkg-1.2.14" = _TWbuEFZt;
        "pkg-1.1.3" = _E7H5IrKI;
        "default" = _E7H5IrKI;
    });
