...
let
    ...
    in {
        ...
        "pkg-v0.8.3+mod" = _ss8iljgn;
        "pkg-1.0" = _bqIMKHVT;
        "pkg-1.0+mod" = _grM6quRL;
        "pkg-1.0.1" = _9IJG1nSZ;
        "pkg-1.0.1+mod" = _bTo9EDIz;
        "pkg-1.0.2" = _fG465eSV;
        "pkg-1.0.2+mod" = _KX22BKPN;
        "pkg-1.0.3" = _XjadQCC1;
        "pkg-1.0.3+mod" = _6x3Zw5UA;
        "pkg-1.0.4" = _JEKSMJTt;
        "pkg-1.0.4+mod" = _bINug9Hs;
        "pkg-1.0.4.1" = _GgqDFCRx;
        "pkg-1.0.4.1+mod" = _lkuCEuyN;
        "pkg-1.0.5" = _2Ax9VzoM;
        "pkg-1.0.5+mod" = _AbEhXU7i;
        "pkg-1.0.5.1" = _KXgZS9dr;
