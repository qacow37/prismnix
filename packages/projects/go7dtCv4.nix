...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.7-fabric" = _2O7bCswg;
        "pkg-1.18.2-1.7-fabric" = _OMESQWNm;
        "pkg-1.19.2-1.9-fabric" = _XCAwsM1F;
        "pkg-1.16.5-1.2-forge" = _jWFB9pm7;
        "pkg-1.18.2-1.4-forge" = _kgYsggUL;
        "pkg-1.19.2-1.6-forge" = _nqKpeYsI;
        "pkg-1.16.5-2.0-fabric" = _SLnsPzV5;
        "pkg-1.18.2-2.0-fabric" = _hoj0ISQl;
        "pkg-1.19.2-2.0-fabric" = _fewaEfkK;
        "pkg-1.19.3-2.1-fabric" = _6Vdg5ezp;
        "pkg-1.19.3-1.6-forge" = _zR1oZ1rP;
        "pkg-1.18.2-3.0-forge+fabric" = _4SyqYdU1;
        "pkg-1.19.2-3.0-forge+fabric" = _IwNCpItH;
        "pkg-1.19.3-3.0-forge+fabric" = _kSEsIIky;
        "pkg-1.19.4-3.0-forge+fabric" = _YkuiV9an;
        "pkg-1.20-3.0-forge+fabric" = _RicvoxXC;
        "pkg-1.20.1-3.0-forge+fabric" = _nKGSv6PZ;
        "pkg-1.20.2-3.0-forge+fabric" = _rkH0tIPl;
        "pkg-1.18.2-3.1-forge+fabric" = _33vOBG3s;
        "pkg-1.19.2-3.1-forge+fabric" = _1BnySm3R;
        "pkg-1.20.1-3.1-forge+fabric" = _3KW1CoO6;
        "pkg-1.20.2-3.1-forge+fabric" = _x3TND5o9;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _XF9N6DT1;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _O0DXV5yO;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _b7xA3gRi;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _mSOCVbYa;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _44ZKVF7N;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _NSKAMTkJ;
        "pkg-1.20.5-3.2-fabric+neo" = _sqjl5GaD;
        "pkg-1.20.5-3.3-fabric+neo" = _6J9v5Eif;
        "pkg-1.20.5-3.4-fabric+neo" = _sJWx0LyQ;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _4HbVu0CR;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _iI6dRiv8;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _bfJGGrOT;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _aV1qEeZg;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _YySaMZbh;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _rOJFqVvV;
        "pkg-1.21.2-3.5-fabric+neo" = _2dKJaG5d;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _s2zmWGmZ;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _793mJTAv;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _8M0smyBz;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _S898GJ1O;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _b5NorQkS;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _YNXlRn4v;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _jTrsL4dt;
        "pkg-1.21.6-3.7-fabric+forge+neo" = _QucbJpp8;
        "pkg-1.21.7-3.7-fabric+forge+neo" = _Ad1D8y0u;
        "pkg-1.21.8-3.7-fabric+forge+neo" = _3sSxwheA;
        "pkg-1.21.9-3.7-fabric+forge+neo" = _MNGpwh6Y;
        "pkg-1.21.10-3.7-fabric+forge+neo" = _JIpBt5rg;
        "pkg-1.21.11-3.7-fabric+forge+neo" = _RKiGYqtM;
        "pkg-26.1.0-3.7-fabric+forge+neo" = _et4jI0N2;
        "pkg-26.1.1-3.7-fabric+forge+neo" = _K43S2wrU;
        "pkg-26.1.2-3.7-fabric+forge+neo" = _o45mHjTG;
        "pkg-26.2.0-3.7-fabric+forge+neo" = _i4qy9oxd;
        "default" = _i4qy9oxd;
    });
