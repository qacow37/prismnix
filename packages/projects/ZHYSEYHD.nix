...
let
    ...
    in {
        ...
        "pkg-1.0.0+fabric" = _nmWIBSRg;
        "pkg-1.0.0+neoforge" = _JpM12sqI;
        "pkg-1.0.1+fabric" = _RB5S8fZb;
        "pkg-1.0.1+neoforge" = _L0jUVm9u;
        "pkg-1.0.1.1+fabric" = _NCfwwPd5;
        "pkg-1.0.1.1+neoforge" = _Jq6rNHBF;
        "pkg-1.0.1.2+fabric" = _3kjEQF1F;
        "pkg-1.0.1.2+neoforge" = _LpPO958H;
        "pkg-1.0.1.3+fabric" = _cffEED37;
        "pkg-1.0.1.3+neoforge" = _aRLEXvtZ;
        "pkg-1.0.1.4+fabric" = _vnP3i4LI;
        "pkg-1.0.1.4+neoforge" = _hBViaLxb;
        "pkg-1.0.1.5+fabric" = _r4Bbwxhv;
        "pkg-1.0.1.5+neoforge" = _Nof4CMz5;
        "pkg-1.0.1.6+fabric" = _1IS13NE4;
        "pkg-1.0.1.6+neoforge" = _GRzlLWov;
        "pkg-1.0.1.7+fabric" = _2JF8UEaY;
        "pkg-1.0.1.7+neoforge" = _jNRZF0u3;
        "pkg-1.0.1.8+fabric" = _9E6MPw1L;
        "pkg-1.0.1.8+neoforge" = _bxOYJGyk;
        "pkg-1.0.1.9+fabric" = _dOJfMBK2;
        "pkg-1.0.1.9+neoforge" = _xWTA6A1h;
        "pkg-1.0.1.10+fabric" = _SWh5CQV9;
        "pkg-1.0.1.10+neoforge" = _I3TF8yEc;
        "pkg-1.0.1.11+fabric" = _AhkwS3P7;
        "pkg-1.0.1.11+neoforge" = _xobPs9TL;
        "pkg-1.1.0-mc.26.1.x+fabric" = _gm7t7poq;
        "pkg-1.1.0-mc.26.1.x+neoforge" = _udZYbV7v;
        "pkg-1.1.0-mc.1.21-1.21.1+fabric" = _IHKqPX3B;
        "pkg-1.1.0-mc.1.21-1.21.1+neoforge" = _Ew99xuEp;
        "pkg-1.1.0-mc.1.21.2+fabric" = _YhblhyBN;
        "pkg-1.1.0-mc.1.21.2+neoforge" = _8I5zOddo;
        "pkg-1.1.0-mc.1.21.3+fabric" = _OO11kFc0;
        "pkg-1.1.0-mc.1.21.3+neoforge" = _4ZZQzxru;
        "pkg-1.1.0-mc.1.21.4+fabric" = _fSHvFaia;
        "pkg-1.1.0-mc.1.21.4+neoforge" = _8roTLpwv;
        "pkg-1.1.0-mc.1.21.5+fabric" = _DSrQ8JRj;
        "pkg-1.1.0-mc.1.21.5+neoforge" = _6Oc4fFvQ;
        "pkg-1.1.0-mc.1.21.6+fabric" = _awRodWzw;
        "pkg-1.1.0-mc.1.21.6+neoforge" = _MbqyFcqn;
        "pkg-1.1.0-mc.1.21.7+fabric" = _UHoIvdOu;
        "pkg-1.1.0-mc.1.21.7+neoforge" = _G670YolB;
        "pkg-1.1.0-mc.1.21.8+fabric" = _CORVerpt;
        "pkg-1.1.0-mc.1.21.8+neoforge" = _eqk0cNlj;
        "pkg-1.1.0-mc.1.21.9+fabric" = _ah2NZ2Fc;
        "pkg-1.1.0-mc.1.21.9+neoforge" = _v5Qsj9hB;
        "pkg-1.1.0-mc.1.21.10+fabric" = _Bj1jDRlV;
        "pkg-1.1.0-mc.1.21.10+neoforge" = _PIg8UpO1;
        "pkg-1.1.0-mc.1.21.11+fabric" = _nKPxG3x0;
        "pkg-1.1.0-mc.1.21.11+neoforge" = _2uULHeqt;
        "pkg-1.2.0-mc26.1.x-release+fabric" = _Mu8xFfjB;
        "pkg-1.2.0-mc26.1.x-release+neoforge" = _avngbSPy;
        "pkg-1.3.0-mc26.1.x-release+fabric" = _R52JJ9j6;
        "pkg-1.3.0-mc26.1.x-release+neoforge" = _UJuxIFmv;
        "pkg-1.3.0-mc26.2-release+fabric" = _xgJlliZu;
        "pkg-1.3.0-mc26.2-release+neoforge" = _uwcJanDs;
        "default" = _uwcJanDs;
    });
