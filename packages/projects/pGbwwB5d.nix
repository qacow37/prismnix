...
let
    ...
    in {
        ...
        "pkg-mc1.19.2-v1.0.0" = _QfhYD1m7;
        "pkg-mc1.19.2-v1.0.1" = _JQ25uI3K;
        "pkg-mc1.19.3-v1.0.1" = _RYiahe2T;
        "pkg-mc1.19.3-v1.0.2" = _9gMgHecu;
        "pkg-mc1.19.2-v1.0.2" = _OQfgobuq;
        "pkg-mc1.19.2-v1.1.0" = _SV4zdLtF;
        "pkg-mc1.20.1-v1.1.0" = _PSVzg2Ia;
        "pkg-mc1.19.4-v1.1.0" = _8n8GO9No;
        "pkg-v1.1.1-mc1.19.4-forge" = _NjaqKbdL;
        "pkg-v1.1.1-mc1.19.2-fabric" = _FbuuEiGo;
        "pkg-v1.1.1-mc1.20.1-forge" = _8rLWmp0Q;
        "pkg-v1.1.1-mc1.19.2-forge" = _dzzqbHct;
        "pkg-v1.1.1-mc1.20.6-neoforge" = _uglcz5SL;
        "pkg-v1.1.1-mc1.20.1-fabric" = _slOSbreN;
        "pkg-v1.1.1-mc1.20.6-forge" = _ppwrhnLj;
        "pkg-v1.1.1-mc1.20.6-fabric" = _abVuYksa;
        "pkg-v1.1.1-mc1.19.4-fabric" = _ERVR1JVS;
        "pkg-v1.2.0-mc1.20.6-fabric" = _QAYs68MG;
        "pkg-v1.2.0-mc1.21.6-fabric" = _MCv2mBfs;
        "pkg-v1.2.0-mc1.20.4-forge" = _XwWuUyqL;
        "pkg-v1.2.0-mc1.20.6-forge" = _RXmUim8P;
        "pkg-v1.2.0-mc1.21.5-neoforge" = _OpjJiAUn;
        "pkg-v1.2.0-mc1.20.6-neoforge" = _MIeVo00N;
        "pkg-v1.2.0-mc1.19.4-forge" = _ur4GbAlU;
        "pkg-v1.2.0-mc1.19.2-fabric" = _faXOaTBy;
        "pkg-v1.2.0-mc1.21.5-forge" = _EsYAZD3P;
        "pkg-v1.2.0-mc1.21.6-neoforge" = _Fs06OGYA;
        "pkg-v1.2.0-mc1.19.2-forge" = _WWWppRdh;
        "pkg-v1.2.0-mc1.21.5-fabric" = _aNc7uXKj;
        "pkg-v1.2.0-mc1.21.6-forge" = _afoIbFeF;
        "pkg-v1.2.0-mc1.19.4-fabric" = _OR2iUQr7;
        "pkg-v1.2.0-mc1.20.4-fabric" = _uXuIOIMm;
        "pkg-v1.2.1-mc1.19.4-forge" = _xMQUNnMI;
        "pkg-v1.2.1-mc1.21.11-fabric" = _2QmoBRi9;
        "pkg-v1.2.1-mc1.19.4-fabric" = _TyHjNRPS;
        "pkg-v1.2.1-mc1.21.5-fabric" = _cs95A2YM;
        "pkg-v1.2.1-mc1.20.4-fabric" = _iDNOiayw;
        "pkg-v1.2.1-mc1.19.2-forge" = _2qcQ8Y9A;
        "pkg-v1.2.1-mc1.20.6-forge" = _MJO355rI;
        "pkg-v1.2.1-mc1.20.6-fabric" = _5XdcHChc;
        "pkg-v1.2.1-mc1.19.2-fabric" = _cZBjFoFE;
        "pkg-v1.2.1-mc1.21.5-neoforge" = _hgHd5aAE;
        "pkg-v1.2.1-mc1.21.5-forge" = _4LpFmBMA;
        "pkg-v1.2.1-mc1.21.11-neoforge" = _w6M0EDb9;
        "pkg-v1.2.1-mc1.20.4-forge" = _szphQBg7;
        "pkg-v1.2.1-mc1.20.6-neoforge" = _upgPGptR;
        "pkg-v1.2.1-mc1.21.11-forge" = _8dOAs9Rn;
        "pkg-v1.2.2-mc1.20.6-fabric" = _ERlwS5Nc;
        "pkg-v1.2.2-mc1.20.4-fabric" = _AmYuyLz4;
        "pkg-v1.2.2-mc1.19.4-fabric" = _QwmMqvuq;
        "pkg-v1.2.2-mc1.19.2-fabric" = _u0cmn9ae;
        "pkg-v1.2.2-mc1.21.11-fabric" = _JpxzqIyC;
        "pkg-v1.2.2-mc1.21.5-fabric" = _6HpVqQT0;
        "pkg-v1.2.2-mc26.1.2" = _gigN5moM;
        "pkg-v1.2.2-mc1.19.2-forge" = _9WL7XIPT;
        "pkg-v1.2.2-mc1.19.4-forge" = _fSufkLch;
        "pkg-v1.2.2-mc1.20.4-forge" = _Zy5ERs16;
        "pkg-v1.2.2-mc1.20.6-neoforge" = _oQQcg4VG;
        "pkg-v1.2.2-mc1.21.5-neoforge" = _aUkCW2fl;
        "pkg-v1.2.2-mc1.21.11-neoforge" = _heTK1oeZ;
        "default" = _heTK1oeZ;
    });
