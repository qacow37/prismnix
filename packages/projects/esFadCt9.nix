...
let
    ...
    in {
        ...
        "pkg-0.1.3" = _gcAp305C;
        "pkg-0.1.4" = _BTuRx5nz;
        "pkg-1.20.1-0.1.5-fabric" = _2pQDnsO9;
        "pkg-1.20.1-0.1.5-forge" = _kUe9svhR;
        "pkg-1.20.1-0.1.6-fabric" = _TgCmQ7RW;
        "pkg-1.20.1-0.1.6-forge" = _LXeZ6X6a;
        "pkg-1.20.1-0.1.7-fabric" = _L6LyDwc3;
        "pkg-1.20.1-0.1.7-forge" = _FIoGN14g;
        "pkg-1.20.1-0.2.0-fabric" = _xvFTFDYg;
        "pkg-1.20.1-0.2.0-forge" = _auF7JoWR;
        "pkg-1.20.1-0.2.1-fabric" = _rAItJE9w;
        "pkg-1.20.1-0.2.1-forge" = _jIGGdOgK;
        "pkg-1.20.1-0.2.2-forge" = _mzDi7kuP;
        "pkg-1.20.1-0.2.3-fabric" = _5kDUga8P;
        "pkg-1.20.1-0.2.3-forge" = _jU6LVfW0;
        "pkg-1.20.1-0.2.4-fabric" = _MAmyn6p4;
        "pkg-1.20.1-0.2.4-forge" = _aTwohbAM;
        "pkg-1.20.1-0.2.5-fabric" = _ZGOwnDCd;
        "pkg-1.20.1-0.2.5-forge" = _aO3uPoug;
        "pkg-1.20.1-0.2.6-fabric" = _fQpG8DIJ;
        "pkg-1.20.1-0.2.6-forge" = _eshw5OqB;
        "pkg-1.20.1-0.3.0-fabric" = _PZkLHsX8;
        "pkg-1.20.1-0.3.0-forge" = _2onK5yEk;
        "pkg-1.20.1-0.3.1-fabric" = _JkI8Na4k;
        "pkg-1.20.1-0.3.1-forge" = _7tndtihF;
        "pkg-1.20.1-0.3.2-fabric" = _chpz1IRQ;
        "pkg-1.20.1-0.3.2-forge" = _DQpqslQI;
        "default" = _DQpqslQI;
    });
