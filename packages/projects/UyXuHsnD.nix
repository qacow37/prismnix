...
let
    ...
    in {
        ...
        "pkg-0.1.1+1.21.9" = _idStgzh2;
        "pkg-0.2.0+1.20.4" = _f7goUq0I;
        "pkg-0.2.1+1.20.5" = _aCqNPtou;
        "pkg-0.2.1+1.21" = _jNPk16Ci;
        "pkg-0.2.1+1.21.2" = _7njDeDYt;
        "pkg-0.2.1+1.21.4" = _B4YAIbQE;
        "pkg-0.2.1+1.21.5" = _qfapdnV3;
        "pkg-0.2.1+1.21.6" = _VH7kUqyy;
        "pkg-0.2.1+1.21.7" = _4pC7vSKe;
        "pkg-0.2.1+1.21.9" = _62Xteidt;
