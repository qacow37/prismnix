...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.19.4" = _1eTSqszG;
        "pkg-1.0.0+mc1.18.2" = _B0Ev8NiA;
        "pkg-1.0.0+mc1.20.4" = _DFC3LDkN;
        "pkg-1.0.0+mc1.20.6" = _jld6jnkd;
        "pkg-1.1.0+mc1.18.2" = _IjOLcgzf;
        "pkg-1.1.0+mc1.19.4" = _mpzTgKr1;
        "pkg-1.1.0+mc1.20.6" = _IauJVhaW;
        "pkg-1.1.0+mc1.20.4" = _zyh4ff6B;
        "pkg-1.2.0+mc1.18.2" = _HSoIr8r5;
        "pkg-1.2.0+mc1.19.4" = _P5BajtVq;
        "pkg-1.2.0+mc1.20.6" = _qEnC9q1x;
        "pkg-1.2.0+mc1.20.4" = _n7PZtlvL;
        "pkg-1.2.0+mc1.17.1" = _gTNFcrlP;
        "pkg-1.3.0+mc1.17.1" = _d5ztha07;
        "pkg-1.3.0+mc1.18.2" = _Uo3Uc9zU;
        "pkg-1.3.0+mc1.19.4" = _efOVgGj2;
        "pkg-1.3.0+mc1.20.4" = _sceloJeF;
        "pkg-1.3.0+mc1.20.6" = _cJEdSKXa;
        "pkg-1.3.0+mc1.16.5" = _22JRuQmb;
        "pkg-1.3.1+mc1.19.4" = _YwxHzcjm;
        "pkg-1.3.1+mc1.20.4" = _7IQv7vqc;
        "pkg-1.3.1+mc1.20.6" = _wEKd4NnS;
        "pkg-1.3.1+mc1.18.2" = _DhP3UN9z;
        "pkg-1.3.1+mc1.16.5" = _dn7UOSrS;
        "pkg-1.3.1+mc1.17.1" = _gzL3i7Rz;
        "pkg-1.3.2+mc1.17.1" = _H548U4Nf;
        "pkg-1.3.2+mc1.18.2" = _fzmtFbMk;
        "pkg-1.3.2+mc1.19.4" = _NlJ4HwHL;
        "pkg-1.3.2+mc1.20.6" = _9SmOV1BF;
        "pkg-1.3.2+mc1.20.4" = _UhFEouDC;
        "pkg-1.3.2+mc1.16.5" = _gunhZzxw;
        "default" = _gunhZzxw;
    });
