...
let
    ...
    in {
        ...
        "pkg-1.0.0-neoforge-1.21.1-21.1.213" = _jeBNz7gn;
        "pkg-1.0.0-forge-1.21.4-54.1.8" = _N80CnHz1;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _U7TRo7t5;
        "pkg-1.0.0-neoforge-1.21.4-21.4.155" = _vMVjqSe4;
        "pkg-1.0.0-fabric-1.21.8-0.136.0" = _oxPvDK5V;
        "pkg-1.0.0-neoforge-1.21.8-21.8.49" = _m0KmwcBF;
        "pkg-1.0.0-forge-1.21.8-58.1.7" = _MF2khTlG;
        "pkg-1.0.0-neoforge-1.21.10-21.10.38-" = _UAHaWtDo;
        "pkg-1.0.0-fabric-1.21.10-0.136.0" = _vhqsZlTR;
        "pkg-1.0.0-forge-1.21.10-60.0.9" = _XF1DKC8P;
        "pkg-1.0.0-fabric-1.21.11-0.140.0" = _DKRB2odc;
        "pkg-1.0.0-neoforge-1.21.11-21.11.10b" = _qUFwVsMQ;
        "pkg-1.0.0-forge-1.21.11-61.0.2" = _QNSgFtt2;
        "pkg-1.0.0-fabric-1.21.5-0.128.2" = _vOIvrL5c;
        "pkg-1.0.0-fabric-1.20.1-0.92.7" = _KyEtDMlV;
        "pkg-1.0.1-forge-26.1.1-63.0.0" = _D4QftWST;
