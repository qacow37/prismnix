...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _H6Tl6jEf;
        "pkg-v4.0.2-1.19.2-Fabric" = _vQtohe4S;
        "pkg-v4.0.2-1.19.2-Forge" = _Vw3QjsNE;
        "pkg-v4.0.3-1.19.2-Fabric" = _KOcfuZhf;
        "pkg-v4.0.3-1.19.2-Forge" = _ZSxdJrA1;
        "pkg-v4.0.4-1.19.2-Forge" = _gZhDSdgg;
        "pkg-v4.0.4-1.19.2-Fabric" = _XtGOl7FU;
        "pkg-v4.0.5-1.19.2-Fabric" = _8MnkdFyA;
        "pkg-v4.0.5-1.19.2-Forge" = _Wb0fZsut;
        "pkg-v4.0.6-1.19.2-Fabric" = _xxrotpj7;
        "pkg-v4.0.6-1.19.2-Forge" = _IX8dI06v;
        "pkg-v8.0.0-1.20.1-Forge" = _2TwWAlg6;
        "pkg-v8.0.0-1.20.1-Fabric" = _5ACDetAX;
        "pkg-v4.0.7-1.19.2-Fabric" = _8WsNFef1;
        "pkg-v4.0.7-1.19.2-Forge" = _gLWeypme;
        "pkg-v8.0.1-1.20.1-Forge" = _1CHoV8x3;
        "pkg-v8.0.1-1.20.1-Fabric" = _z3ZGkh8i;
        "pkg-v4.0.8-1.19.2-Fabric" = _G4qauOPg;
        "pkg-v4.0.8-1.19.2-Forge" = _ASuYpCVK;
        "pkg-v8.0.2-1.20.1-Forge" = _B1DAeww1;
        "pkg-v8.0.2-1.20.1-Fabric" = _pO9lM7eJ;
        "pkg-v8.0.3-1.20.1-Forge" = _9uw1ynYf;
        "pkg-v8.0.3-1.20.1-Fabric" = _kexyNnBb;
        "pkg-v8.0.4-1.20.1-Forge" = _8rOVT0ZV;
        "pkg-v8.0.4-1.20.1-Fabric" = _DE4hl0ui;
        "pkg-v8.0.5-1.20.1-Forge" = _hUE3GBUr;
        "pkg-v8.0.5-1.20.1-Fabric" = _p6VRqg7D;
        "pkg-v20.4.0-1.20.4-Fabric" = _5qfb9MG5;
        "pkg-v20.4.0-1.20.4-NeoForge" = _LIsJegfC;
        "pkg-v20.4.0-1.20.4-Forge" = _5kdz0lxM;
        "pkg-v20.4.1-1.20.4-Fabric" = _XDmMW23c;
        "pkg-v20.4.1-1.20.4-Forge" = _yDico3r5;
        "pkg-v20.4.1-1.20.4-NeoForge" = _HYCLYRnG;
        "pkg-v8.0.6-1.20.1-Forge" = _Oa75lUzE;
        "pkg-v8.0.6-1.20.1-Fabric" = _D9e0CJWj;
        "pkg-v20.4.2-1.20.4-Fabric" = _F2tyfAcg;
        "pkg-v20.4.2-1.20.4-Forge" = _xXaJqRLu;
        "pkg-v20.4.2-1.20.4-NeoForge" = _nR13iWhg;
        "pkg-v21.0.0-1.21-Fabric" = _ay3FWh9s;
        "pkg-v21.0.0-1.21-NeoForge" = _lwoiDlbp;
        "pkg-v21.0.1-1.21-Fabric" = _sjuCsolj;
        "pkg-v21.0.1-1.21-NeoForge" = _hTrGF0fo;
        "pkg-v21.1.0-1.21.1-Fabric" = _X9wdRi3p;
        "pkg-v21.1.0-1.21.1-NeoForge" = _SGpwIu7v;
        "pkg-v21.3.0-1.21.3-Fabric" = _mysfc1uU;
        "pkg-v21.3.0-1.21.3-NeoForge" = _BoeIgwAQ;
        "pkg-v21.3.1-1.21.3-Fabric" = _3U0sLmnN;
        "pkg-v21.3.1-1.21.3-NeoForge" = _udGt5kOs;
        "pkg-v21.3.2-1.21.3-Fabric" = _DSWAQznO;
        "pkg-v21.3.2-1.21.3-NeoForge" = _X5bpbWLK;
        "pkg-v21.4.0-1.21.4-Fabric" = _DBV5WhLf;
        "pkg-v21.4.0-1.21.4-NeoForge" = _rMRixVkI;
        "pkg-v21.5.0-1.21.5-Fabric" = _YrJ7jOk2;
        "pkg-v21.5.0-1.21.5-NeoForge" = _D4vm6suD;
        "pkg-v21.6.0-1.21.6-Fabric" = _6TBYrM3g;
        "pkg-v21.6.0-1.21.6-NeoForge" = _IeKdU47l;
        "pkg-v21.7.0-1.21.7-Fabric" = _EMkSvyiP;
        "pkg-v21.7.0-1.21.7-NeoForge" = _CBZJxO0A;
        "pkg-v21.8.0-1.21.8-Fabric" = _9bsVAied;
        "pkg-v21.8.0-1.21.8-NeoForge" = _2ZbSy1Jy;
        "pkg-21.10.0" = _U82wZLEa;
        "pkg-21.11.0" = _ErGicdH5;
