...
let
    ...
    in {
        ...
        "pkg-1.2-1.20" = _MlPi01tY;
        "pkg-1.2-1.20.1" = _CaMMMNtD;
        "pkg-1.2-1.20.2" = _ziyp2aza;
        "pkg-1.2.1-1.20.2" = _7bsMSdHR;
        "pkg-1.2.1-1.20" = _5qVSjAPf;
        "pkg-1.2.1-1.20.1" = _GZgnV86m;
        "pkg-1.2.2-1.20" = _ie6f6gyd;
        "pkg-1.2.2-1.20.1" = _LjC5QKkH;
        "pkg-1.2.2-1.20.2" = _U01p6ThZ;
        "pkg-1.2.2-1.20.3" = _8dNrqKoE;
        "pkg-1.2.2-1.20.4" = _bvfj63xf;
        "pkg-1.2.2-1.20.5" = _NcxrbpJG;
        "pkg-1.2.2-1.20.6" = _2cBktUWR;
        "pkg-1.2.2-1.21" = _tjbSaxbm;
        "pkg-1.3-1.20" = _EuYT7Ita;
        "pkg-1.3-1.20.1" = _Dy1u8PQC;
        "pkg-1.3-1.20.2" = _pAPox7X0;
        "pkg-1.3-1.20.3" = _vZTUymrl;
        "pkg-1.3-1.20.4" = _mAROmp35;
        "pkg-1.3-1.20.5" = _duQVNEou;
        "pkg-1.3-1.20.6" = _DU6ZWrx4;
        "pkg-1.3-1.21" = _PSzKjdem;
        "pkg-1.3-1.21.1" = _BTxdJfoV;
        "pkg-1.3-1.21.2" = _f2Bag0Ir;
        "pkg-1.3-1.21.4" = _1qLTKaQm;
        "pkg-1.3-1.21.5" = _E71Ycfkc;
        "pkg-1.3-1.21.6" = _8GkCHQsf;
        "pkg-1.3-1.21.9" = _KyHKCdr8;
