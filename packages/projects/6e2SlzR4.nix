...
let
    ...
    in {
        ...
        "pkg-0.2-0.5.1" = _v43K27Dp;
        "pkg-0.2.1-0.5.1" = _xk435Pk9;
        "pkg-0.2.2-0.5.1" = _KYSifFbC;
        "pkg-0.2.3-0.5.1" = _fL0vhRqO;
        "pkg-0.3-0.5.1" = _TpVrVJMR;
        "pkg-0.4-0.5.1" = _pFY5rCrf;
        "pkg-0.4.1+1.19.2" = _ORbfIPtK;
        "pkg-0.4.2+1.19.2" = _NMZvi32B;
        "pkg-0.5+1.19.2" = _6jwvUbw0;
        "pkg-0.6+1.19.2" = _I1U1DFRc;
        "pkg-0.6.1+1.19.2" = _Nd4IQds1;
        "pkg-0.7+1.19.2" = _L1WiF4m8;
        "pkg-0.7+1.20.1" = _RrGCNDCS;
        "pkg-0.7.1+1.19.2" = _larxRsPo;
        "pkg-0.7.1+1.20.1" = _u1QVVer1;
        "pkg-0.7.2+1.19.2" = _C9LB3HQG;
        "pkg-0.7.2+1.20.1" = _L8yr7mcj;
        "pkg-0.8+1.19.2" = _2HWcME3t;
        "pkg-0.8+1.20.1" = _TFBHf7rl;
        "pkg-0.9+1.19.2" = _5WTPO3sD;
        "pkg-0.9+1.20.1" = _ayVBRu81;
        "pkg-1.0+1.19.2" = _XI0kcAX2;
        "pkg-1.0+1.20.1" = _sKCtPf0Z;
        "pkg-1.1+1.18.2" = _juuATg92;
        "pkg-1.1+1.19.2" = _Ph9RmfuF;
        "pkg-1.1+1.20.1" = _TSUhxzJR;
        "pkg-1.1-hotfix+1.18.2" = _SFHzZoZA;
        "pkg-1.2+1.18.2" = _RyBuTEtV;
        "pkg-1.2+1.19.2" = _O8aGpvfl;
        "pkg-1.2+1.20.1" = _C9lrisDk;
        "pkg-1.2-hotfix-1+1.18.2" = _9XRsWrkc;
        "pkg-1.2-hotfix-1+1.19.2" = _RdLlh3fy;
        "pkg-1.2-hotfix-1+1.20.1" = _dQiLQfep;
        "pkg-1.2-hotfix-2+1.18.2" = _KmYEp3oM;
        "pkg-1.2-hotfix-2+1.19.2" = _fE5L668G;
        "pkg-1.2-hotfix-2+1.20.1" = _YBhMrsmd;
        "pkg-1.3+1.18.2" = _KBGCIQgm;
        "pkg-1.3+1.19.2" = _Nz9kvhRC;
        "pkg-1.3+1.20.1" = _iGkJwzEC;
        "pkg-1.3-hotfix-1+1.18.2" = _M1XUEgrd;
        "pkg-1.3-hotfix-1+1.19.2" = _YwbtLbtM;
        "pkg-1.3-hotfix-1+1.20.1" = _A1HCmuyB;
        "pkg-1.3-hotfix-2+1.18.2" = _44AW0EYH;
        "pkg-1.3-hotfix-2+1.19.2" = _Pt8dQzSi;
        "pkg-1.3-hotfix-2+1.20.1" = _xrfuWpcB;
        "pkg-1.4+1.18.2" = _t2XRqED7;
        "pkg-1.4+1.19.2" = _raqoEhV3;
        "pkg-1.4+1.20.1" = _5xMDinSh;
        "pkg-1.5+1.18.2-beta" = _eHjHhtGP;
        "pkg-1.5+1.19.2-beta" = _48iCm2Vw;
        "pkg-1.5+1.20.1-beta" = _VSJQ0C2z;
        "pkg-1.5.1+1.18.2-beta" = _5fcKBpSC;
        "pkg-1.5.1+1.19.2-beta" = _sOl3wGfp;
        "pkg-1.5.1+1.20.1-beta" = _CEpYeusT;
        "pkg-1.5.1-hotfix-1+1.18.2" = _Z7zY438F;
        "pkg-1.5.1-hotfix-1+1.19.2" = _r9qEOZ8o;
        "pkg-1.5.1-hotfix-1+1.20.1" = _cxndnp4b;
        "pkg-1.5.1-hotfix-2+1.19.2" = _t75a5Yu1;
        "pkg-1.5.2+1.18.2" = _VHIRehtY;
        "pkg-1.5.2+1.19.2" = _z3lMHPlL;
        "pkg-1.5.2+1.20.1" = _8pgjJQIs;
        "pkg-1.5.2-hotfix-1+1.18.2" = _1plvTwhb;
        "pkg-1.5.2-hotfix-1+1.19.2" = _fGva5enZ;
        "pkg-1.5.2-hotfix-1+1.20.1" = _4tD88qc4;
        "pkg-1.6+1.18.2" = _FjgQaLJh;
        "pkg-1.6+1.19.2" = _KGY523Dc;
        "pkg-1.6+1.20.1" = _LmGZYgGA;
        "pkg-1.6.1+1.18.2" = _YaUdkO8c;
        "pkg-1.6.1+1.19.2" = _4hOj7QBm;
        "pkg-1.6.1+1.20.1" = _nbvgHhsw;
        "pkg-1.6.2+1.18.2" = _hcyjQD95;
        "pkg-1.6.2+1.19.2" = _yx4OEyzy;
        "pkg-1.6.3+1.18.2" = _UMaShFUN;
        "pkg-1.6.3+1.19.2" = _xKvndtpg;
        "pkg-1.6.3+1.20.1" = _KbCwX87k;
        "pkg-1.7+1.18.2" = _btGEtP8Q;
        "pkg-1.7+1.19.2" = _YQNDhN3o;
        "pkg-1.7+1.20.1" = _R6VRNdjA;
        "pkg-1.7.1+1.18.2" = _RnQ9LiOy;
        "pkg-1.7.1+1.19.2" = _mT7Nojjz;
        "pkg-1.7.1+1.20.1" = _ofHYP6AS;
        "pkg-1.7.2+1.18.2" = _EQqTVCNb;
        "pkg-1.7.2+1.19.2" = _DGK34yHj;
        "pkg-1.7.2+1.20.1" = _179qieyI;
        "pkg-1.7.3+1.18.2" = _ulHMUkuK;
        "pkg-1.7.3+1.19.2" = _dHMvEtEE;
        "pkg-1.7.3+1.20.1" = _1p4rWjKX;
        "pkg-1.7.4+1.18.2" = _anY8SDb7;
        "pkg-1.7.4+1.19.2" = _GyMJ0yRi;
        "pkg-1.7.4+1.20.1" = _L0Cmqxdq;
        "pkg-1.7.5+1.19.2" = _UpkKzqod;
        "pkg-1.7.5+1.20.1" = _hpGG98o4;
        "pkg-1.8+1.19.2-forge" = _TMyqpwGa;
        "pkg-1.8+1.20.1-neoforged" = _IV4vazAc;
        "pkg-1.8+1.19.2-fabric" = _OKoQNRm8;
        "pkg-1.8+1.20.1-fabric" = _RoxzEBjm;
        "pkg-1.8.1+1.19.2-forge" = _uxEMaXRC;
        "pkg-1.8.1+1.20.1-neoforged" = _Ji1vc3Bf;
        "pkg-1.8.1+1.19.2-fabric" = _QNR2uBbe;
        "pkg-1.8.1+1.20.1-fabric" = _c5Vr3FB1;
        "pkg-1.8.2+1.19.2-forge" = _j8RhYMlY;
        "pkg-1.8.2+1.20.1-neoforged" = _N6pXaHFv;
        "pkg-1.8.2+1.19.2-fabric" = _acq55Way;
        "pkg-1.8.2+1.20.1-fabric" = _iMoXrlXK;
        "pkg-1.8.3+1.19.2-forge" = _Ajplh8ea;
        "pkg-1.8.3+1.20.1-neoforged" = _CT4mbysj;
        "pkg-1.8.3+1.19.2-fabric" = _x7NpxCr3;
        "pkg-1.8.3+1.20.1-fabric" = _xM9frhZm;
        "pkg-1.8.4+1.19.2-forge" = _BiHdAbdn;
        "pkg-1.8.4+1.20.1-neoforged" = _8XaHYiCD;
        "pkg-1.8.4+1.19.2-fabric" = _1BWYPmC5;
        "pkg-1.8.4+1.20.1-fabric" = _iXOkKT1x;
        "pkg-1.8.5+1.19.2-forge" = _1Hggt2Et;
        "pkg-1.8.5+1.20.1-neoforged" = _6XPrZ7o0;
        "pkg-1.8.5+1.19.2-fabric" = _YWsfIWXR;
        "pkg-1.8.5+1.20.1-fabric" = _8Vi7VjtB;
        "pkg-1.8.6+1.19.2-forge" = _DbLhW2ht;
        "pkg-1.8.6+1.20.1-neoforged" = _czRzfvxX;
        "pkg-1.8.6+1.19.2-fabric" = _azWmbKP4;
        "pkg-1.8.6+1.20.1-fabric" = _fU9V4dQ4;
        "pkg-1.8.7+1.19.2-forge" = _KWC2iGUC;
        "pkg-1.8.7+1.20.1-neoforged" = _vezEVx34;
        "pkg-1.8.7+1.19.2-fabric" = _YbBXpC20;
        "pkg-1.8.7+1.20.1-fabric" = _UdZe9vOL;
        "pkg-1.8.8+1.20.1-neoforged" = _kqXYhb4t;
        "pkg-1.8.8+1.19.2-fabric" = _c3C5yHoP;
        "pkg-1.9+1.19.2-forge" = _LLnzsQYx;
        "pkg-1.9+1.20.1-neoforged" = _1iMGGl3R;
        "pkg-1.9+1.19.2-fabric" = _H3juX65q;
        "pkg-1.9+1.20.1-fabric" = _VzOHN3UC;
        "pkg-1.9.1+1.20.1-neoforged" = _M0sjsBwi;
        "pkg-1.9.1+1.20.1-fabric" = _kLHAjTVk;
        "pkg-1.9.2+1.19.2-forge" = _XfqhMVmI;
        "pkg-1.9.2+1.20.1-neoforged" = _DgFooefw;
        "pkg-1.9.2+1.19.2-fabric" = _afTecMvE;
        "pkg-1.9.2+1.20.1-fabric" = _Z9MIh6QO;
        "pkg-1.9.3+1.19.2-forge" = _LAQT6rlO;
        "pkg-1.9.3+1.20.1-neoforged" = _B2kJPeKL;
        "pkg-1.9.3+1.19.2-fabric" = _7PS7K32C;
        "pkg-1.9.3+1.20.1-fabric" = _NA9cES0e;
        "pkg-1.9.4+1.19.2-forge" = _nvVGKqdE;
        "pkg-1.9.4+1.20.1-neoforged" = _AhQnIdXs;
        "pkg-1.9.4+1.19.2-fabric" = _6tlNDfEu;
        "pkg-1.9.4+1.20.1-fabric" = _GE4gS82a;
        "pkg-1.9.5+1.19.2-fabric" = _GYDhfbhe;
        "pkg-1.9.5+1.20.1-fabric" = _CqaYP9pe;
        "pkg-1.9.5+1.19.2-forge" = _SNFddOZy;
        "pkg-1.9.6+1.19.2-forge" = _6TAuKVgC;
        "pkg-1.9.6+1.19.2-fabric" = _eQp8THek;
        "pkg-1.9.7+1.19.2-forge" = _nl44UY50;
        "pkg-1.9.7+1.20.1-neoforged" = _DmrHBatb;
        "pkg-1.9.7+1.19.2-fabric" = _SJsHeFaf;
        "pkg-1.9.7+1.20.1-fabric" = _M1iJaU56;
        "pkg-1.9.8+1.19.2-forge" = _MsLULKlk;
        "pkg-1.9.8+1.20.1-neoforged" = _lGUvI3rP;
        "pkg-1.9.8+1.19.2-fabric" = _7hOkZHF6;
        "pkg-1.9.8+1.20.1-fabric" = _EoFtF84y;
        "pkg-2.0+1.19.2-forge" = _TXDESUnX;
        "pkg-2.0+1.20.1-neoforged" = _JcgWBHrz;
        "pkg-2.0+1.19.2-fabric" = _fKLm4Kxm;
        "pkg-2.0+1.20.1-fabric" = _nmvJDjdo;
        "pkg-2.0.1+1.19.2-forge" = _jmLPE28t;
        "pkg-2.0.1+1.20.1-neoforged" = _6e5bIGsw;
        "pkg-2.0.1+1.19.2-fabric" = _lMfPptub;
        "pkg-2.0.1+1.20.1-fabric" = _IpsO8SOJ;
        "pkg-2.0.2+1.19.2-forge" = _AfLzCPFq;
        "pkg-2.0.2+1.20.1-neoforged" = _2bVKxcsc;
        "pkg-2.0.2+1.19.2-fabric" = _7BsFZXKX;
        "pkg-2.0.2+1.20.1-fabric" = _w7E36ytN;
        "pkg-2.0.3+1.20.1-fabric" = _1KXDAOpO;
        "pkg-2.0.3+1.20.1-neoforged" = _eGT2lfgM;
        "pkg-2.0.4+1.20.1-fabric" = _eFip1j57;
        "pkg-2.0.5+1.20.1-fabric" = _eTQpNp76;
        "pkg-2.0.6+1.20.1-fabric" = _OxEAPinj;
        "pkg-2.0.7+1.20.1-fabric" = _YMXchJo7;
        "pkg-2.0.7+1.20.1-neoforged" = _89g0UvwF;
        "pkg-2.0.8+1.20.1-neoforged" = _iQZLLLMd;
        "pkg-2.1+1.20.1-neoforged" = _1gdE7Lkp;
        "pkg-2.1.0.1+1.20.1-neoforged" = _tEUE1os1;
        "pkg-2.1.0.2+1.20.1-neoforged" = _i5ngsYxB;
        "pkg-2.1.1+1.20.1-neoforged" = _OVSwMYNf;
        "pkg-2.1.1+1.21.1-neoforged" = _PyWz7dxv;
        "pkg-2.1.2+1.20.1-neoforged" = _E2zVZR4l;
        "pkg-2.1.2+1.21.1-neoforged" = _elQsMfy5;
        "pkg-2.1.3+1.21.1-neoforged" = _vFw5G8px;
        "pkg-2.1.3.1+1.21.1-neoforged" = _AJQ4D4uE;
        "pkg-2.1.3.2+1.21.1-neoforged" = _3nRhGyUp;
        "pkg-2.1.3.3+1.21.1-neoforged" = _kRTMwvoE;
        "pkg-2.1.3.4+1.21.1-neoforged" = _N4F4H6G0;
        "pkg-2.1.3.5+1.21.1-neoforged" = _lenfE9so;
        "pkg-2.1.3.6+1.21.1-neoforged" = _ExTohSYT;
        "pkg-2.1.4+1.21.1-neoforged" = _7hnATs05;
        "pkg-2.1.5+1.21.1-neoforged" = _ZFW5x77P;
        "pkg-2.1.6+1.21.1-neoforged" = _5VUZCA6a;
        "pkg-2.1.6.1+1.21.1-neoforged" = _KaBRZAzM;
        "pkg-2.1.6.2+1.21.1-neoforged" = _N0WCbAuG;
        "pkg-2.1.6.3+1.21.1-neoforged" = _SO4x2JKw;
        "pkg-2.1.6.4+1.21.1-neoforged" = _vELhRvN9;
        "pkg-2.1.6.5+1.21.1-neoforged" = _5Xn13yzh;
        "pkg-2.1.6.6+1.21.1" = _HOmOCaPz;
        "pkg-2.1.6.7+1.21.1" = _eYWrZPCj;
        "pkg-2.1.6.8+1.21.1-neoforged" = _LljvYUxj;
        "pkg-2.1.6.9+1.20.1-forge" = _SjzUnbc9;
        "pkg-2.1.6.9+1.21.1-neoforged" = _LUYt8BEb;
        "pkg-2.1.7+1.21.1-neoforged" = _I8veAkKJ;
        "pkg-2.1.7.b+1.20.1-forge" = _tO2irH8t;
        "pkg-2.1.8+1.21.1-neoforged" = _9a3KRdYx;
        "pkg-2.1.9+1.21.1-neoforged" = _E6dza7zL;
