...
let
    ...
    in {
        ...
        "pkg-14.13-SNAPSHOT-303" = _Q0A32vCm;
        "pkg-14.13-SNAPSHOT-306-Forge.Legacy" = _BhZQMByg;
        "pkg-14.13-SNAPSHOT-306-Forge.Active" = _ahEXjiaP;
        "pkg-14.13-SNAPSHOT-306-Fabric" = _P2zZgGxB;
        "pkg-14.13-SNAPSHOT-309-Forge.Legacy" = _I5NR5NfA;
        "pkg-14.13-SNAPSHOT-309-Forge.Active" = _wq0lpRWw;
        "pkg-14.13-SNAPSHOT-309-Fabric" = _ZE9ZB03n;
        "pkg-14.13-SNAPSHOT-311-Forge.Legacy" = _kejCn3mw;
        "pkg-14.13-SNAPSHOT-311-Forge.Active" = _UKwDtpbp;
        "pkg-14.13-SNAPSHOT-311-Fabric" = _xHbeGkbD;
        "pkg-14.13-SNAPSHOT-313-Forge.Legacy" = _C3mILCTe;
        "pkg-14.13-SNAPSHOT-313-Forge.Active" = _ZLmemgOY;
        "pkg-14.13-SNAPSHOT-313-Fabric" = _8tekC2m9;
        "pkg-14.13-SNAPSHOT-314-Forge.Legacy" = _w5NanVsb;
        "pkg-14.13-SNAPSHOT-314-Forge.Active" = _85EJUGOE;
        "pkg-14.13-SNAPSHOT-314-Fabric" = _gUHDPazO;
        "pkg-14.13-SNAPSHOT-317-Forge.Legacy" = _tTuwIlxG;
        "pkg-14.13-SNAPSHOT-317-Forge.Active" = _tYtmwDEk;
        "pkg-14.13-SNAPSHOT-317-Fabric" = _Qv7iBSht;
        "pkg-14.13-Forge.Legacy" = _6BC0AkIW;
        "pkg-14.13-Forge.Active" = _oDi74cnW;
        "pkg-14.13-Fabric" = _dvrUJneR;
        "pkg-14.14-SNAPSHOT-321-Forge.Legacy" = _RuRF3zFA;
        "pkg-14.14-SNAPSHOT-321-Forge.Active" = _gCiOek8d;
        "pkg-14.14-SNAPSHOT-321-Fabric" = _3YyqF3YS;
        "pkg-14.14-SNAPSHOT-323-Forge.Legacy" = _ZoxXILpz;
        "pkg-14.14-SNAPSHOT-323-Forge.Active" = _zSvOpv93;
        "pkg-14.14-SNAPSHOT-323-Fabric" = _MW30vdoP;
        "pkg-14.14-SNAPSHOT-325-Forge.Legacy" = _tF1bHIBi;
        "pkg-14.14-SNAPSHOT-325-Forge.Active" = _8bM0ZkrR;
        "pkg-14.14-SNAPSHOT-325-Fabric" = _TPRGzk1a;
        "pkg-14.14-SNAPSHOT-329-ForgeLegacy" = _NVtqXuZM;
        "pkg-14.14-SNAPSHOT-329-ForgeActive" = _whaqa9qZ;
        "pkg-14.14-SNAPSHOT-329-Fabric" = _4KN083wy;
        "pkg-14.14-SNAPSHOT-330-ForgeLegacy" = _cTMS62D8;
        "pkg-14.14-SNAPSHOT-330-ForgeActive" = _QxrsU5gH;
        "pkg-14.14-SNAPSHOT-330-Fabric" = _rbl9H63l;
        "pkg-14.14-SNAPSHOT-331-ForgeLegacy" = _Wlq85YyE;
        "pkg-14.14-SNAPSHOT-331-ForgeActive" = _52qYVr3T;
        "pkg-14.14-SNAPSHOT-331-Fabric" = _zploEctN;
        "pkg-14.14-SNAPSHOT-332-ForgeLegacy" = _QxlusKaz;
        "pkg-14.14-SNAPSHOT-332-ForgeActive" = _VmSVWTTp;
        "pkg-14.14-SNAPSHOT-332-Fabric" = _bdJGoHgV;
        "pkg-14.14-SNAPSHOT-333-ForgeLegacy" = _rsTeeJA7;
        "pkg-14.14-SNAPSHOT-333-ForgeActive" = _cc77pOQE;
        "pkg-14.14-SNAPSHOT-333-Fabric" = _f6VQpHLn;
        "pkg-14.14-SNAPSHOT-335-ForgeLegacy" = _lLiz0tSE;
        "pkg-14.14-SNAPSHOT-335-ForgeActive" = _3J91iRDv;
        "pkg-14.14-SNAPSHOT-335-Fabric" = _zLfD2UrG;
        "pkg-14.14-SNAPSHOT-336-ForgeLegacy" = _FbdXH8at;
        "pkg-14.14-SNAPSHOT-336-ForgeActive" = _lzXqyUKN;
        "pkg-14.14-SNAPSHOT-336-Fabric" = _GfOHbhsZ;
        "pkg-14.14-SNAPSHOT-337-ForgeLegacy" = _xSxfjtXc;
        "pkg-14.14-SNAPSHOT-337-ForgeActive" = _M2avkQzQ;
        "pkg-14.14-SNAPSHOT-337-Fabric" = _GP3fVbEU;
        "pkg-14.14-SNAPSHOT-338-ForgeLegacy" = _l10xsx6S;
        "pkg-14.14-SNAPSHOT-338-ForgeActive" = _pkjK8Q7f;
        "pkg-14.14-SNAPSHOT-338-Fabric" = _7SDeajVN;
        "pkg-14.14-SNAPSHOT-339-ForgeLegacy" = _WrVsQld8;
        "pkg-14.14-SNAPSHOT-339-ForgeActive" = _6mZPLyK2;
        "pkg-14.14-SNAPSHOT-339-Fabric" = _939pZe2K;
        "pkg-14.14-SNAPSHOT-340-ForgeLegacy" = _aV0CXpQJ;
        "pkg-14.14-SNAPSHOT-340-ForgeActive" = _6zPSOHt1;
        "pkg-14.14-SNAPSHOT-340-Fabric" = _4Pw6r7Oh;
        "pkg-14.14-SNAPSHOT-341-ForgeLegacy" = _vPtBJcg0;
        "pkg-14.14-SNAPSHOT-341-ForgeActive" = _i2ufj0UI;
        "pkg-14.14-SNAPSHOT-341-Fabric" = _8WH60fG6;
        "pkg-14.14-SNAPSHOT-342-ForgeLegacy" = _Gb3aeaF3;
        "pkg-14.14-SNAPSHOT-342-ForgeActive" = _HCeozr4g;
        "pkg-14.14-SNAPSHOT-342-Fabric" = _aAE3Wuhr;
        "pkg-14.14-SNAPSHOT-343-ForgeLegacy" = _P4WrC5LZ;
        "pkg-14.14-SNAPSHOT-343-ForgeActive" = _I1V9wA3h;
        "pkg-14.14-SNAPSHOT-343-Fabric" = _R1h2UY36;
        "pkg-14.14-SNAPSHOT-345-ForgeLegacy" = _HbcaEGY3;
        "pkg-14.14-SNAPSHOT-345-ForgeActive" = _OTLTXH3v;
        "pkg-14.14-SNAPSHOT-345-Fabric" = _SQN18BzP;
        "pkg-14.14-SNAPSHOT-346-ForgeLegacy" = _zz8zhS5g;
        "pkg-14.14-SNAPSHOT-346-ForgeActive" = _Zy6NFBXx;
        "pkg-14.14-SNAPSHOT-346-Fabric" = _d3ztFWlj;
        "pkg-14.14-ForgeLegacy" = _rOxnAjGj;
        "pkg-14.14-ForgeActive" = _w2Lo5CVd;
        "pkg-14.14-Fabric" = _w2hD4JEO;
        "pkg-14.15-SNAPSHOT-348-ForgeLegacy" = _YeTtWDKn;
        "pkg-14.15-SNAPSHOT-348-ForgeActive" = _UZNVKq0o;
        "pkg-14.15-SNAPSHOT-350-ForgeLegacy" = _1lFCN5Df;
        "pkg-14.15-SNAPSHOT-350-ForgeActive" = _vy8yI515;
        "pkg-14.15-SNAPSHOT-351-ForgeLegacy" = _cutfO4Kg;
        "pkg-14.15-SNAPSHOT-351-ForgeActive" = _a25vOxqC;
        "pkg-14.15-SNAPSHOT-352-ForgeLegacy" = _9mIbvUYz;
        "pkg-14.15-SNAPSHOT-352-ForgeActive" = _mlKuwdCu;
        "pkg-14.15-SNAPSHOT-353-ForgeLegacy" = _Vvoz2YJG;
        "pkg-14.15-SNAPSHOT-353-ForgeActive" = _DCIGBf7l;
        "pkg-14.15-SNAPSHOT-353-Fabric" = _U8Z6W5OT;
        "pkg-14.15-SNAPSHOT-355-ForgeLegacy" = _Q8PQXwQU;
        "pkg-14.15-SNAPSHOT-355-ForgeActive" = _MbLotQFM;
        "pkg-14.15-SNAPSHOT-355-Fabric" = _Kgi3jd4o;
        "pkg-14.15-SNAPSHOT-357-ForgeLegacy" = _MktjxYTC;
        "pkg-14.15-SNAPSHOT-357-ForgeActive" = _nAnRJ0i5;
        "pkg-14.15-SNAPSHOT-357-Fabric" = _BLMNx40m;
        "pkg-14.15-SNAPSHOT-358-ForgeLegacy" = _Yv2qXJOZ;
        "pkg-14.15-SNAPSHOT-358-ForgeActive" = _1q0QGumE;
        "pkg-14.15-SNAPSHOT-358-Fabric" = _aDSmnCal;
        "pkg-14.15-ForgeLegacy" = _GgLboVbY;
        "pkg-14.15-ForgeActive" = _UzMTa67d;
        "pkg-14.15-Fabric" = _cHrfRCou;
        "pkg-14.15.1-ForgeLegacy" = _PLJRWNs3;
        "pkg-14.15.1-ForgeActive" = _XunzbCmi;
        "pkg-14.15.1-Fabric" = _5645MZUD;
        "pkg-14.15.2-ForgeLegacy" = _skh1soYP;
        "pkg-14.15.2-ForgeActive" = _CaiYKZ1H;
        "pkg-14.15.2-Fabric" = _IG8dHR18;
        "pkg-14.17" = _z1JNexvy;
        "pkg-14.18-Fabric" = _MMHIoSW7;
        "pkg-14.18-ForgeActive" = _2cRx5ixj;
        "pkg-14.18-ForgeLegacy" = _wjX9aaPk;
        "pkg-14.18.1-ForgeLegacy" = _46nVcR6b;
        "pkg-14.18.1-Fabric" = _y8ghFL5k;
        "pkg-14.18.1-ForgeActive" = _kUvPciTv;
        "pkg-14.18.2-ForgeActive" = _F8V0YQk0;
        "pkg-14.18.2-Fabric" = _I4Ug2nw9;
        "pkg-14.18.2-ForgeLegacy" = _ZlZgRjDs;
        "pkg-14.18.3-ForgeActive" = _yxNzO8b9;
        "pkg-14.18.3-Fabric" = _fMWYHlzf;
        "pkg-14.18.3-ForgeLegacy" = _R72bf3a0;
        "pkg-14.19-ForgeLegacy" = _CB2XVqvj;
        "pkg-14.19-Fabric" = _JZhcMPzD;
        "pkg-14.19-ForgeActive" = _DXlbhIJd;
        "pkg-14.19.1-Fabric" = _DJ03lU4i;
        "pkg-14.19.1-ForgeLegacy" = _xGh2s0eE;
        "pkg-14.19.1-ForgeActive" = _dvl8hhBz;
        "pkg-14.20-Fabric" = _80Fnnn1d;
        "pkg-14.20-ForgeV1" = _BfOifZWE;
        "pkg-14.20-ForgeV2" = _CBwU6CS2;
        "pkg-14.20-ForgeV3" = _F2gKGFjo;
        "pkg-14.21-ForgeV3" = _q11IMFG0;
        "pkg-14.21-ForgeV2" = _oparyd9b;
        "pkg-14.21-Fabric" = _EJ8G1uZj;
        "pkg-14.21-ForgeV1" = _RBVMAOmP;
        "pkg-14.21.1-ForgeV2" = _WeBNF1AJ;
        "pkg-14.21.1-ForgeV1" = _ULMMZzCD;
        "pkg-14.21.1-ForgeV3" = _9B1Mb9IZ;
        "pkg-14.21.2-ForgeV3" = _1MVVnCZw;
        "pkg-14.21.2-ForgeV2" = _V5xRl6CU;
        "pkg-14.21.2-Fabric" = _4iIhDKay;
        "pkg-14.21.2-ForgeV1" = _gVv49fTY;
        "pkg-14.22-ForgeV2" = _6wilmXEK;
        "pkg-14.22-ForgeV3" = _1rFt9AXa;
        "pkg-14.22-Fabric" = _x0w81QQX;
        "pkg-14.22-ForgeV1" = _r3kymU7L;
        "pkg-14.23-ForgeV2" = _A4UBTSeF;
        "pkg-14.23-ForgeV1" = _HTMldfH3;
        "pkg-14.23-Fabric" = _asGzIRRZ;
        "pkg-14.23-ForgeV3" = _cM9n27gS;
        "pkg-14.24-ForgeV1" = _Lj1O7vqV;
        "pkg-14.24-ForgeV3" = _7IAUBuzk;
        "pkg-14.24-Fabric" = _rHrSuH9N;
        "pkg-14.24-ForgeV2" = _Pc1V24Kr;
        "pkg-14.25-ForgeV3" = _eustHs7o;
        "pkg-14.25-Fabric" = _wTLY2rwx;
        "pkg-14.25-ForgeV1" = _bp6F0TTr;
        "pkg-14.25-ForgeV2" = _CdHgYmem;
        "pkg-14.26-ForgeV2" = _4jkpqBGD;
        "pkg-14.26-ForgeV3" = _3QOKG8kh;
        "pkg-14.26-Fabric" = _qeNSc97K;
        "pkg-14.26-ForgeV1" = _4wUQtyOW;
        "pkg-14.26.1-ForgeV1" = _wLkp5dpJ;
        "pkg-14.26.1-ForgeV2" = _CcAsu9W3;
        "pkg-14.26.1-Fabric" = _bLZg6wUJ;
        "pkg-14.26.1-ForgeV3" = _8ZHfEWIC;
        "pkg-14.27-ForgeV2" = _dcitd3cL;
        "pkg-14.27-ForgeV3" = _w01oabna;
        "pkg-14.27-Fabric" = _Fsrt5ueW;
        "pkg-14.27-ForgeV1" = _9IEAIelx;
        "pkg-14.28-ForgeV2" = _Rcbx2QhV;
        "pkg-14.28-ForgeV1" = _5rz5EZ6x;
        "pkg-14.28-Fabric" = _2C8mIbK2;
        "pkg-14.28-Universal" = _11FjKEY1;
        "pkg-15.0-Universal" = _l7Rzv5QF;
        "pkg-15.0.1-Universal" = _OLaesh5y;
        "default" = _OLaesh5y;
    });
