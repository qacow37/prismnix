...
let
    ...
    in {
        ...
        "pkg-0.5.0-1.20+fabric" = _HlyFFNYA;
        "pkg-0.5.0-1.20+forge" = _D5PuFZzm;
        "pkg-0.6.0-1.20+fabric" = _DnMsIeOx;
        "pkg-0.6.0-1.20+forge" = _rgO0bdwf;
        "pkg-0.7.0-1.20+forge" = _4fZZgNGb;
        "pkg-0.7.0-1.20+fabric" = _ISRECcSw;
        "pkg-0.7.0-1.20.6+fabric" = _Ra2DuQbT;
        "pkg-0.7.0-1.20.6+forge" = _99mJlrvN;
        "pkg-0.7.0-1.20.6+neoforge" = _iqdKvccG;
        "pkg-0.7.0-1.21.1+fabric" = _ytmUmfQP;
        "pkg-0.7.0-1.21.1+forge" = _BYTib86T;
        "pkg-0.7.1-1.21.4+fabric" = _qPYXhZwC;
        "pkg-0.7.1-1.21.4+forge" = _jXAgScOP;
        "pkg-0.7.1-1.21.5+fabric" = _j24je8yb;
        "pkg-0.7.1-1.21.5+forge" = _pUDgTJUa;
        "pkg-0.7.1-1.21.6+fabric" = _whDPrTlS;
        "pkg-0.7.1-1.21.6+forge" = _yxQDY3Rx;
        "pkg-0.7.1-1.21.7+fabric" = _yT2AuKjg;
        "pkg-0.7.1-1.21.7+forge" = _fGhfbw62;
        "pkg-0.7.1-1.21.8+fabric" = _peA3gmnM;
        "pkg-0.7.1-1.21.8+forge" = _27A3EqVc;
        "pkg-0.7.1-1.21.9+fabric" = _1IEfBzH1;
        "pkg-0.7.1-1.21.9+forge" = _N4IvUAtG;
        "pkg-0.7.1-1.21.10+fabric" = _aTjrKpkB;
        "pkg-0.7.1-1.21.10+forge" = _LnPDpMdb;
        "pkg-0.7.1-1.21.11+fabric" = _ZVs2VfUv;
        "pkg-0.7.1-26.1.2+fabric" = _HT8NL95r;
        "pkg-0.7.1-26.1.2+forge" = _1o3sKjwY;
        "pkg-0.7.1-26.2+fabric" = _Y0zs6l6h;
        "pkg-0.7.1-26.2+forge" = _xJXEmfoc;
        "pkg-0.7.0-1.21.1+neoforge" = _dAWR6iLe;
        "pkg-0.7.1-1.21.4+neoforge" = _12gIAv7L;
        "pkg-0.7.1-1.21.5+neoforge" = _ebHi87DW;
        "pkg-0.7.1-1.21.6+neoforge" = _UHtDiG6T;
        "pkg-0.7.1-1.21.7+neoforge" = _5aWgjPvR;
        "pkg-0.7.1-1.21.8+neoforge" = _izy8916V;
        "pkg-0.7.1-1.21.9+neoforge" = _grsl26S9;
        "pkg-0.7.1-1.21.10+neoforge" = _uIUGJRJA;
        "pkg-0.7.1-1.21.11+neoforge" = _zJJ3Uv1l;
        "pkg-0.7.1-26.1.2+neoforge" = _zaKr0AM3;
        "pkg-0.7.1-26.2+neoforge" = _J2KeVS9O;
        "default" = _J2KeVS9O;
    });
