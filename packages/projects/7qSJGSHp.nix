...
let
    ...
    in {
        ...
        "pkg-0.0.8" = _ZlwtcIfo;
        "pkg-0.0.9" = _PonD752C;
        "pkg-0.0.9+mod" = _FGLBQrOc;
        "pkg-0.1.0" = _Svn1hfqK;
        "pkg-0.1.0+mod" = _BbJAk9fR;
        "pkg-0.1.1" = _NGKO8TmU;
        "pkg-0.1.1+mod" = _FJaAHHSg;
        "pkg-0.1.2" = _lFhvJq5q;
        "pkg-0.1.2+mod" = _VkqUXj5O;
        "pkg-0.1.3" = _hX8qwgS3;
        "pkg-0.1.3+mod" = _LlCmSSaf;
        "pkg-0.1.4" = _tMxYGSGx;
        "pkg-0.1.4+mod" = _fR0foOLP;
        "pkg-0.1.4a" = _j5rQzrgF;
        "pkg-0.1.4a+mod" = _GlvIUFVw;
        "pkg-0.1.4b" = _j3IyLc4O;
        "pkg-0.1.4b+mod" = _BhuKlIHl;
        "pkg-0.2.5" = _1tlcmPIe;
        "pkg-0.2.5+mod" = _yaxILtJo;
        "pkg-0.3.0" = _z6HJaQz5;
        "pkg-0.3.0+mod" = _sz43G2TJ;
        "default" = _sz43G2TJ;
    });
