...
let
    ...
    in {
        ...
        "pkg-18.2.0" = _HKRlqUb3;
        "pkg-19.2.0" = _Tft7G7IS;
        "pkg-19.3.0" = _c8QieiQk;
        "pkg-19.4.0" = _n5ZqNuPv;
        "pkg-20.1.0" = _Qf8fjO8Z;
        "pkg-20.2.0" = _FEVriM17;
        "pkg-20.4.0" = _UDrzJvMd;
        "pkg-21.1.0" = _SZ8cgVoB;
        "pkg-18.2.1" = _Owlh2Itg;
        "pkg-19.2.1" = _xArzhaAt;
        "pkg-19.3.1" = _h9557IW6;
        "pkg-19.4.1" = _h9Hh1RT5;
        "pkg-20.1.1" = _SbPMhOQz;
        "pkg-20.2.1" = _4ezvvyQb;
        "pkg-20.4.1" = _Eostiy1x;
        "pkg-21.1.1" = _hYrOwTjM;
        "pkg-18.2.2" = _jrDJprij;
        "pkg-19.2.2" = _G2Jzi7bK;
        "pkg-19.3.2" = _LrcWZRp8;
        "pkg-19.4.2" = _QfVBG0hB;
        "pkg-20.1.2" = _Wmksk3Kk;
        "pkg-20.2.2" = _nP725u90;
        "pkg-20.4.2" = _UOfJgJv3;
        "pkg-18.2.3" = _p8Yn3slx;
        "pkg-19.2.3" = _TSaoB3EA;
        "pkg-19.3.3" = _nrfywbxf;
        "pkg-19.4.3" = _pEhZoDfO;
        "pkg-20.1.3" = _XSjX2qPK;
        "pkg-20.2.3" = _PMRSLuFt;
        "pkg-20.4.3" = _99Q5ed4O;
        "pkg-21.1.2" = _E2R5M7J0;
        "pkg-18.2.4" = _xAY6XR3C;
        "pkg-19.2.4" = _HfXtdS7W;
        "pkg-19.3.4" = _iXr8wkBI;
        "pkg-19.4.4" = _834yYlWw;
        "pkg-20.1.4" = _S13iOAWb;
        "pkg-20.2.4" = _MqrWX47j;
        "pkg-20.4.4" = _QKxbboOp;
        "pkg-21.1.3" = _UWyhQgTl;
        "pkg-18.2.5" = _VjuM95K6;
        "pkg-19.2.5" = _LdaKOMZb;
        "pkg-19.3.5" = _9Nea3Ca5;
        "pkg-19.4.5" = _vD4059Sf;
        "pkg-20.1.5" = _FJ092vYD;
        "pkg-20.2.5" = _5trCXij3;
        "pkg-20.4.5" = _yvfAIR8R;
        "pkg-21.1.4" = _VJlhdo2n;
        "pkg-18.2.6" = _oROgTo9t;
        "pkg-19.2.6" = _SMaYwUkG;
        "pkg-19.3.6" = _Cd958bxS;
        "pkg-19.4.6" = _ZbPcssuV;
        "pkg-20.1.6" = _cGIiQsXB;
        "pkg-20.2.6" = _6zM9lpWE;
        "pkg-20.4.6" = _MzTXbVjG;
        "pkg-21.1.5" = _v0cVhqDi;
        "pkg-18.2.7" = _x9a5kXCb;
        "pkg-19.2.7" = _G6k6k91l;
        "pkg-19.3.7" = _NndtFMA2;
        "pkg-19.4.7" = _reM6HNj6;
        "pkg-20.1.7" = _9o3fUEFv;
        "pkg-20.2.7" = _3zSJJWHv;
        "pkg-20.4.7" = _rgQRE2aE;
        "pkg-21.1.6" = _2DXcz7L9;
        "pkg-18.2.8" = _ekgselRj;
        "pkg-19.2.8" = _aNXtpWtU;
        "pkg-19.3.8" = _r5riN7tt;
        "pkg-19.4.8" = _qTFX0OG9;
        "pkg-20.1.8" = _Kp3qSIZH;
        "pkg-20.2.8" = _zq1TO8lj;
        "pkg-20.4.8" = _tkHJVrOb;
        "pkg-21.1.7" = _Q7vDXbgr;
        "pkg-21.10.0" = _NVHpy6EQ;
        "pkg-18.2.9" = _E6tnaBC6;
        "pkg-19.2.9" = _1JcKSlvp;
        "pkg-19.3.9" = _PQmSXnNJ;
        "pkg-19.4.9" = _D33u0rfa;
        "pkg-20.1.9" = _PwoTChTT;
        "pkg-20.2.9" = _ptbGGr4u;
        "default" = _ptbGGr4u;
    });
