...
let
    ...
    in {
        ...
        "pkg-1.0.6" = _g8s77vjY;
        "pkg-1.0.7" = _pjBwawsQ;
        "pkg-1.0.10" = _hc5cVDRT;
        "pkg-1.0.11" = _tacgXNFo;
        "pkg-1.0.12" = _J6gVaAnW;
        "pkg-1.0.13" = _YXttfNjv;
        "pkg-1.0.17" = _dW8TllZj;
        "pkg-1.0.18" = _M9UoYa0o;
        "pkg-1.0.20" = _WmN4l0O4;
        "pkg-1.0.21" = _HMzSq6Bo;
        "pkg-1.0.22" = _75OapOsP;
        "pkg-1.0.23" = _5DKLqhut;
        "pkg-1.0.24" = _1Sy8nbrh;
        "pkg-1.0.25" = _sDSbnOHy;
        "pkg-1.0.26" = _lmziaXrT;
        "pkg-1.0.27" = _6b7AGFN7;
        "pkg-1.0.28" = _whX3X3EC;
        "pkg-1.0.30" = _TiazDCkS;
        "pkg-1.0.31" = _Etnp1APL;
        "pkg-1.0.32" = _m74LCu69;
        "pkg-1.0.33" = _NHkxsJPu;
        "pkg-1.0.34" = _l3t1n92g;
        "pkg-1.0.35" = _L9tGEPm6;
        "pkg-1.0.36" = _gtjbPemP;
        "pkg-1.0.37" = _y3ANEbH8;
        "pkg-1.0.38" = _2wmiMXrA;
        "pkg-1.0.39" = _DqQFjfV6;
        "pkg-1.0.40" = _nWGfH8Q7;
        "pkg-1.0.41" = _F9ruiu6R;
        "pkg-1.0.42" = _KxToHSRH;
        "pkg-1.0.43" = _D1b0990Z;
        "default" = _D1b0990Z;
    });
