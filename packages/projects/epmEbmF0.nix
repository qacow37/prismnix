...
let
    ...
    in {
        ...
        "pkg-1.1.3" = _XhGd0f1m;
        "pkg-1.1.4" = _zdCjtO8m;
        "pkg-1.1.6-forge" = _hlCbXYpa;
        "pkg-1.1.6-fabric" = _IRv42kHQ;
        "pkg-1.1.7-fabric" = _CXclh27k;
        "pkg-1.1.7-forge" = _JfSxwSoL;
        "pkg-1.1.8-fabric" = _cjMLU0tT;
        "pkg-1.1.8-forge" = _bV4803HY;
        "pkg-1.2.2-fabric" = _J90wjoGE;
        "pkg-1.2.2-forge" = _muzpmnLi;
        "pkg-1.3.0-fabric" = _AnUUQl5T;
        "pkg-1.3.0-forge" = _1FLpCS38;
        "pkg-1.3.1-fabric" = _K2OXkknl;
        "pkg-1.3.1-forge" = _GzYmGAZ2;
        "pkg-1.3.2-forge" = _jOay7XLx;
        "pkg-1.3.2-fabric" = _TtnFCBf3;
        "pkg-1.3.3-forge" = _9BOqvFgV;
        "pkg-1.3.3-fabric" = _d0qESwXU;
        "pkg-1.4.0-forge" = _j4UGyDG1;
        "pkg-1.4.0-fabric" = _tloDCabG;
        "pkg-1.4.1-fabric" = _l1hzsqJz;
        "pkg-1.4.1-forge" = _9BXOXMxL;
        "pkg-1.5.5" = _d8GXpNkM;
        "pkg-1.6.0" = _lTeVj61l;
        "pkg-1.6.1" = _rp320gdN;
        "pkg-1.6.7" = _TmnT4ykN;
        ...
        "pkg-1.8.4" = _SFuQ2g0G;
        "pkg-1.9.0" = _l77e8W2Q;
        "pkg-1.10.0" = _Fw4f26YL;
        "pkg-1.11.0" = _uDUilYhT;
        "pkg-1.12.0" = _D8O6ZApG;
        "pkg-1.13.0" = _w3uRZPde;
        "pkg-1.14.1" = _gWsCJWp5;
        "pkg-1.14.1-lexforge" = _SCEhQY6D;
        "pkg-1.14.2" = _2fU4s6dZ;
        "pkg-1.14.2-lexforge" = _dF7QrfQm;
        "pkg-1.14.3" = _tsbghW6p;
        "pkg-1.14.3-lexforge" = _4PX0D09X;
        "pkg-1.15.0" = _K1hONr8N;
        "pkg-1.15.0-lexforge" = _fkcEKnNH;
        "pkg-1.16.0" = _XmDPVZir;
        "pkg-1.16.0-lexforge" = _Z5gjlS6m;
        "pkg-0.16.1" = _BXrr7PPG;
        "pkg-1.16.1" = _y5larKlJ;
        "pkg-1.16.1-lexforge" = _jupdk5XX;
        "pkg-1.16.2" = _ppUfV7UC;
        "pkg-1.16.2-lexforge" = _R4evQ7uO;
        "pkg-2.0.0" = _NMH2CbZQ;
        "pkg-2.1.0" = _gR2MsTy2;
        "pkg-2.1.1" = _4J1acYZC;
        "pkg-2.1.2" = _NVJmWrRp;
