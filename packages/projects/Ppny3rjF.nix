...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.7-fabric" = _Rni4JFOk;
        "pkg-1.18.2-1.7-fabric" = _X8CiSwJz;
        "pkg-1.19.2-1.8-fabric" = _kxJfCvWS;
        "pkg-1.16.5-1.3-forge" = _j9qRwnDW;
        "pkg-1.18.2-1.4-forge" = _8roQabye;
        "pkg-1.19.2-1.6-forge" = _ahm9AsBd;
        "pkg-1.16.5-1.9-fabric" = _K06XRDhJ;
        "pkg-1.18.2-1.9-fabric" = _akmEtqPN;
        "pkg-1.19.2-1.9-fabric" = _zQjzo2H7;
        "pkg-1.19.3-2.0-fabric" = _jCi15tFX;
        "pkg-1.19.3-1.6-forge" = _Prfq0ReQ;
        "pkg-1.18.2-3.0-forge+fabric" = _vcZBTwnu;
        "pkg-1.19.2-3.0-forge+fabric" = _lZLbDXj1;
        "pkg-1.19.3-3.0-forge+fabric" = _dKqPc5br;
        "pkg-1.18.2-3.1-forge+fabric" = _F9Tr3mRX;
        "pkg-1.19.2-3.1-forge+fabric" = _auf6AQGz;
        "pkg-1.19.3-3.1-forge+fabric" = _6iYHblNv;
        "pkg-1.19.4-3.1-forge+fabric" = _yq8zMjyz;
        "pkg-1.20-3.1-forge+fabric" = _4HweJ33A;
        "pkg-1.20.1-3.1-forge+fabric" = _lc1AFtmC;
        "pkg-1.20.2-3.1-forge+fabric" = _FQTCbsg9;
        "pkg-1.18.2-3.2-forge+fabric" = _QRMC8Ipr;
        "pkg-1.19.2-3.2-forge+fabric" = _usQb722W;
        "pkg-1.20.1-3.2-forge+fabric" = _uq9k1dGn;
        "pkg-1.20.2-3.2-forge+fabric" = _4ifYxkFe;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _NvrxJ5JB;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _R5t0drlW;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _uTG0l6u0;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _DYrvdYmu;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _W1CTq2bk;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _rQeuNpmj;
        "pkg-1.19.2-3.4-fabric+forge" = _6s2may7g;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _pDT3kW5c;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _iLEoYJAQ;
        "pkg-1.19.2-3.5-fabric+forge" = _xdoh8yLr;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _JcJfLh2H;
        "pkg-1.20.4-3.5-fabric+forge+neo" = _Jsf1Lu8K;
        "pkg-1.20.5-3.5-fabric+neo" = _njjTN6XP;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _Q73XYwvo;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _eOgST5Z0;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _LGdg6M3e;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _RGo1FsuC;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _yQp6AjlK;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _fdwu1ioW;
        "pkg-1.21.2-3.6-fabric+neo" = _KUvmuvOa;
        "pkg-1.21.3-3.6-fabric+forge+neo" = _4dHicJDR;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _ZytBUpxU;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _wwrz26Pi;
        "pkg-1.21.1-3.7-fabric+forge+neo" = _TNvagCwa;
        "pkg-1.21.4-3.7-fabric+forge+neo" = _qtNqp2Z1;
        "pkg-1.21.5-3.7-fabric+forge+neo" = _noNH8Brw;
        "pkg-1.20.1-3.8-fabric+forge+neo" = _JqWwdP9a;
        "pkg-1.21.1-3.8-fabric+forge+neo" = _71apu41K;
        "pkg-1.21.4-3.8-fabric+forge+neo" = _Je83WsCp;
        "pkg-1.21.5-3.8-fabric+forge+neo" = _YKveWctJ;
        "pkg-1.21.6-3.8-fabric+forge+neo" = _48j3loZ9;
        "pkg-1.21.7-3.8-fabric+forge+neo" = _ltPcc2jA;
        "pkg-1.21.8-3.8-fabric+forge+neo" = _MkmnXR4s;
        "pkg-1.21.9-3.8-fabric+forge+neo" = _z0B8puw4;
        "pkg-1.21.10-3.8-fabric+forge+neo" = _xeInJWiH;
        "pkg-1.21.11-3.8-fabric+forge+neo" = _Uhu35jqw;
        "pkg-26.1.0-3.8-fabric+forge+neo" = _95pU8ezK;
        "pkg-26.1.1-3.8-fabric+forge+neo" = _H4u32008;
        "pkg-26.1.2-3.8-fabric+forge+neo" = _mg7luTeb;
        "pkg-26.2.0-3.8-fabric+forge+neo" = _Hci5qr3o;
        "default" = _Hci5qr3o;
    });
