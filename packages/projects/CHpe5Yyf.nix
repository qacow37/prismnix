...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _TEXKqQYs;
        "pkg-1.0.1-1.20.1" = _GfhGag7d;
        "pkg-1.0.1-1.20.2" = _RMdiXmc5;
        "pkg-1.0.2-1.20.1" = _QhnGiDhb;
        "pkg-1.0.2-1.20.2" = _qNZkTSpl;
        "pkg-1.0.2-1.20" = _WuiQa5eP;
        "pkg-1.0.2-1.20.3" = _Evph3jAR;
        "pkg-1.0.2-1.20.4" = _zGYpamkw;
        "pkg-1.0.2-1.20.5" = _rpYug1hS;
        "pkg-1.0.2-1.20.6" = _J0zHkY35;
        "pkg-1.0.2-1.21.x" = _U7PR2pVt;
        "pkg-2.0-1.20.1" = _UHQPZdIa;
        "pkg-2.0-1.20.2" = _w9C05lhU;
        "pkg-2.0-1.20.3" = _Ui2lrklf;
        "pkg-2.0-1.20.6" = _Xb8KkGfB;
        "pkg-2.0-1.21" = _S9Rjn7Tw;
        "pkg-2.0.1-1.21" = _Xk6qoR6K;
        "pkg-2.0.2-1.20.1" = _i1iWtaVf;
        "pkg-2.0.2-1.20.2" = _d7BM8GXj;
        "pkg-2.0.2-1.20.3" = _dpsja1Oy;
        "pkg-2.0.2-1.20.6" = _y2Lfsi5Q;
        "pkg-2.0.2-1.21" = _AU0PBMBX;
        "pkg-2.1.0-1.20.1" = _sONlywJa;
        "pkg-2.1.0-1.20.6" = _LQQ7P41i;
        "pkg-2.1.0-1.21" = _iz6zg7kc;
        "default" = _iz6zg7kc;
    });
