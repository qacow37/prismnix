...
let
    ...
    in {
        ...
        "pkg-1.0" = _fVOiNcQI;
        "pkg-1.0+mod" = _vWHaPqJ3;
        "pkg-1.1" = _o3QHRLWE;
        "pkg-2.0" = _QuouyQRs;
        "pkg-2.0+mod" = _JiChVMAL;
        "pkg-2.1" = _SSqbVZXz;
        "pkg-2.1+mod" = _MFrApZic;
        "pkg-2.2" = _y4mfYSuL;
        "pkg-2.2+mod" = _6TUFvcXO;
        "pkg-2.3" = _fJrhz3yN;
        "pkg-2.3+mod" = _VlIxTNAW;
        "pkg-2.4" = _FjHH7cG6;
        "pkg-2.4+mod" = _XEl2hYBg;
        "pkg-2.5" = _2SJ4QkgQ;
        "pkg-2.5+mod" = _D5KKIaGm;
        "pkg-2.6" = _FXDE1ZHA;
        "pkg-2.6+mod" = _BHzngLg0;
        "pkg-2.7" = _xFtbPTIk;
        "pkg-2.7-fabric" = _V0dRyqtK;
        "pkg-2.7-forge" = _NZNaVojT;
        "pkg-2.11" = _vYVSBR5T;
        "pkg-2.11-fabric" = _ryauOraR;
        "pkg-2.11-quilt" = _I7AOW8uY;
        "pkg-2.11-forge" = _wXpGEK5Q;
        "pkg-2.11-neoforge" = _SbWVV1FQ;
        "pkg-2.12" = _BGXWmcFs;
        "pkg-2.12-fabric" = _YTniKUe4;
        "pkg-2.12-quilt" = _HH28vJ1C;
        "pkg-2.12-forge" = _NVKsYPMo;
        "pkg-2.12-neoforge" = _Iqo5jEld;
        "default" = _Iqo5jEld;
    });
