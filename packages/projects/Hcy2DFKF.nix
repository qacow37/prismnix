...
let
    ...
    in {
        ...
        "pkg-1.20.1-Forge-1.0" = _w1mW1SCE;
        "pkg-1.20.1-Fabric-1.0" = _F84m4wR5;
        "pkg-1.20.1-Forge-1.0.1" = _5otRCiqG;
        "pkg-1.20.1-Fabric-1.0.1" = _JYUAcBh3;
        "pkg-1.20.1-Forge-1.0.2" = _3FmFt8jI;
        "pkg-1.20.1-Fabric-1.0.2" = _QRV0K267;
        "pkg-1.20.4-Forge-1.4.0" = _tvYcRU7g;
        "pkg-1.20.4-Fabric-1.4.0" = _H3lJxdVm;
        "pkg-1.20.4-Forge-1.4.1" = _HWTQXfhm;
        "pkg-1.20.4-NeoForge-1.4.1" = _rueMdpfd;
        "pkg-1.20.4-Fabric-1.4.1" = _slXHrjhI;
        "pkg-1.21-Fabric-2.0.0" = _yfBrdNmy;
        "pkg-1.21-Forge-2.0.0" = _Y79h0GoV;
        "pkg-1.21-NeoForge-2.0.0" = _P4Fc4m2Z;
        "pkg-1.21.1-Fabric-2.1.0" = _16RBn5EB;
        "pkg-1.21.1-Forge-2.1.0" = _YOt3Orou;
        "pkg-1.21.1-NeoForge-2.1.0" = _wsrytp4p;
        "pkg-1.21.1-Forge-2.1.1" = _VMtUTDrd;
        "pkg-1.21.1-NeoForge-2.1.1" = _2mzf7b2Y;
        "pkg-1.21.1-Fabric-2.1.1" = _246YDJ7a;
        "pkg-1.21.1-Forge-2.1.2" = _ttgo696F;
        "pkg-1.21.1-NeoForge-2.1.2" = _OB9hQTpQ;
        "pkg-1.21.1-Fabric-2.1.2" = _ROfVrQnL;
        "pkg-1.21.4-NeoForge-2.4.0" = _UCIRAnA8;
        "pkg-1.21.4-Fabric-2.4.0" = _LJ3ujWWA;
        "pkg-26.1.2-Fabric-3.1.0" = _tFTq3QG2;
        "pkg-26.1.2-NeoForge-3.1.0" = _T9GFQbib;
        "default" = _T9GFQbib;
    });
