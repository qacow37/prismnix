...
let
    ...
    in {
        ...
        "pkg-6.1.0" = _cBCLEtwJ;
        "pkg-6.1.1" = _MalTuCK4;
        "pkg-21.0.0" = _HkXG4bVl;
        "pkg-21.0.1" = _vOzSjxQ7;
        "pkg-21.0.2" = _LQFgR20m;
        "pkg-21.0.3" = _QXWqBZ17;
        "pkg-21.1.0" = _BOGi47c6;
        "pkg-21.1.1" = _1E3c98dZ;
        "pkg-21.1.2" = _OFCYuLn8;
        "pkg-21.2.0" = _UiaVZkC1;
        "pkg-21.4.0" = _8WjCPKKU;
        "pkg-21.5.0" = _CXrFpIW8;
        "pkg-21.6.0" = _OC2VkGDU;
        "pkg-21.10.0" = _aKBym85c;
        "pkg-21.11.0" = _BUs2hrKR;
        "pkg-26.1.1.1" = _oI80SLTj;
        "pkg-21.1.3" = _fpdXVGO0;
