...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _28U6zNlf;
        "pkg-1.0.9" = _WZtIeXeS;
        "pkg-1.0.10" = _IazcTNWV;
        "pkg-1.0.11" = _Fl3wLOgL;
        "pkg-1.0.12" = _eVat6tfs;
        "pkg-1.0.13" = _XyzArlHP;
        "pkg-1.0.14" = _IZM4KZFf;
        "pkg-1.0.15" = _MDF00P9o;
        "pkg-1.0.16" = _sP15n5OE;
        "pkg-1.0.17" = _V1E8EwHX;
        "pkg-1.0.18" = _ohbVtdkH;
        "pkg-1.0.19" = _S3Ob16uz;
        "pkg-1.0.20" = _GwpBWLdx;
        "pkg-1.0.21" = _qIVx7vCd;
        "pkg-1.0.22" = _TheA3nvk;
        "default" = _TheA3nvk;
    });
