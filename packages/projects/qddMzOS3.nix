...
let
    ...
    in {
        ...
        "pkg-2.0.1" = _pa4O7wc3;
        "pkg-2.2" = _rl2mmBj5;
        "pkg-2.2+mod" = _YJLhF0kE;
        "pkg-2.3" = _aabotKkP;
        "pkg-2.3+mod" = _ax5nEpCJ;
        "pkg-2.4" = _jtnLSjbD;
        "pkg-2.4+mod" = _ZtGk1xxc;
        "pkg-2.5" = _ihZIHpVb;
        "pkg-2.5+mod" = _4mk3uLqZ;
        "pkg-2.5.1" = _khiNHVtb;
        "pkg-2.5.1+mod" = _kCv3YrAc;
        "pkg-2.6" = _Uz7dr6oJ;
        "pkg-2.6+mod" = _uQeBwkgA;
        "pkg-2.6.1" = _oQb7lrYE;
        "pkg-2.6.1+mod" = _D8Dt1Akm;
        "pkg-2.6.2" = _LGKZMDl7;
