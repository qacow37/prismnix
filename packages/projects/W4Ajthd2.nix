...
let
    ...
    in {
        ...
        "pkg-6.0.0.0" = _o3s4MBkn;
        "pkg-6.0.0.0-final" = _JIL3dgci;
        "pkg-6.0.1.0" = _HF6sIFOg;
        "pkg-6.0.1.0-final" = _SgE5JLE4;
        "pkg-6.0.1.1" = _1Qd1HbgH;
        "pkg-6.0.1.1-final" = _HKBKjRCQ;
        "pkg-6.0.1.2" = _XVLMDksZ;
        "pkg-6.0.1.2-final" = _lJpmA82g;
        "pkg-7.0.0.0" = _Oi8zlHA9;
        "pkg-6.0.1.3" = _jppNJ5i2;
        "pkg-6.0.1.3-final" = _3U34xKK5;
        "pkg-7.0.0.1" = _imFNF4r0;
        "pkg-6.0.1.4-final" = _un7QsjpJ;
        "pkg-6.0.1.4" = _EMtRkcpS;
        "pkg-7.0.0.2" = _nGfcfWHe;
        "pkg-6.1.0.0" = _AfvKgd26;
        "pkg-7.1.0.0" = _MHa8bPQU;
        "pkg-8.0.0.0" = _l2ENihuM;
        "pkg-8.0.0.1" = _A95oN7hs;
        "pkg-8.0.0.2" = _zhIjfCU7;
        "pkg-8.0.1.0" = _9CTdNk3W;
        "pkg-8.0.1.1" = _YT7ezMrq;
        "pkg-9.0.0.0-beta" = _djQfUmQA;
        "pkg-1.20.4-9.0.0.1-beta" = _p9gbSL5L;
        "pkg-1.20.2-9.0.0.1-beta" = _6YcmGH7i;
        "pkg-1.20.2-9.0.0.2-beta" = _bSbA10pV;
        "pkg-1.18.2-9.0.0.3-beta" = _BSnEwumt;
        "pkg-1.19.2-9.0.0.3-beta" = _SNY44WTJ;
        "pkg-1.19.4-9.0.0.3-beta" = _wDLaRz1n;
        "pkg-1.20.2-9.0.0.3-beta" = _L1SKV3iw;
        "pkg-1.20.4-9.0.0.3-beta" = _1qNGSsUQ;
        "pkg-9.0.0" = _bUhXD9K8;
        "pkg-9.0.1" = _kdQDbzgN;
        "pkg-9.0.2" = _e0qBlvXu;
        "pkg-9.1.0" = _8GiNXH0Y;
