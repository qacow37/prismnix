...
let
    ...
    in {
        ...
        "pkg-1.0-pre40" = _lf5CGcNR;
        "pkg-1.0" = _BHjyP65q;
        "pkg-1.0.1-pre1" = _J0jhCaQl;
        "pkg-1.0.1-pre2" = _7W3U9EWX;
        "pkg-1.0.1-pre3" = _6w8xAbdd;
        "pkg-1.0.1-pre4" = _ZcsiMNSo;
        "pkg-1.0.1-pre5" = _XvHtxTU9;
        "pkg-1.0.1-pre6" = _7LeB9NKN;
        "pkg-1.0.1-pre7" = _cisjsfDx;
        "pkg-1.0.1-pre8" = _BtYAwvSV;
        "pkg-1.0.1-pre9" = _K4tyJ3Rl;
        "pkg-1.0.1-pre10" = _tJzDTTCo;
        "pkg-1.0.1-pre11" = _vvxBmUeg;
        "pkg-1.0.1-pre12" = _29WubMa5;
        "pkg-1.0.1-pre13" = _9u5gvLMW;
        "pkg-1.0.1-pre14" = _1jBzCXVG;
        "pkg-1.0.1-pre15" = _XAtyrYio;
        "pkg-1.0.1-pre16" = _AU1SKLU7;
        "pkg-1.0.2-pre1" = _nUCdtWAX;
        "pkg-1.0.2-pre2" = _5IyrXzBs;
        "pkg-1.0.3" = _skGXnJTA;
        "pkg-1.1.0" = _SjUnF9Rb;
        "pkg-1.1.1" = _ZAvAshkJ;
        "pkg-1.1.2" = _Z3vLzM8i;
