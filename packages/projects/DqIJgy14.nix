...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.4-fabric" = _fEEjXzvD;
        "pkg-1.18.2-1.4-fabric" = _ORanJWGb;
        "pkg-1.19.2-1.5-fabric" = _N82rZ902;
        "pkg-1.16.5-1.0-forge" = _FXCKSWY3;
        "pkg-1.18.2-1.1-forge" = _7qxfLCv2;
        "pkg-1.19.2-1.3-forge" = _PHF7MLLU;
        "pkg-1.16.5-1.6-fabric" = _slyQnjvB;
        "pkg-1.18.2-1.6-fabric" = _P4GPf5di;
        "pkg-1.19.2-1.6-fabric" = _nr6aE7lP;
        "pkg-1.19.3-1.7-fabric" = _zWUsIhpr;
        "pkg-1.19.3-1.3-forge" = _VH04uWGs;
        "pkg-1.18.2-2.0-forge+fabric" = _wtd5x1oj;
        "pkg-1.19.2-2.0-forge+fabric" = _UlDrlz24;
        "pkg-1.19.3-2.0-forge+fabric" = _kcqu3SUC;
        "pkg-1.18.2-2.1-forge+fabric" = _rtHFhCkN;
        "pkg-1.19.2-2.1-forge+fabric" = _lW0rTS0W;
        "pkg-1.19.3-2.1-forge+fabric" = _d5c8zhOZ;
        "pkg-1.19.4-2.1-forge+fabric" = _w3R5bvea;
        "pkg-1.20-2.1-forge+fabric" = _N6uJ5hPI;
        "pkg-1.20.1-2.1-forge+fabric" = _mavC2Z3l;
        "pkg-1.20.2-2.1-forge+fabric" = _W2IAuGWC;
        "pkg-1.18.2-2.2-forge+fabric" = _wjOY3wFW;
        "pkg-1.19.2-2.2-forge+fabric" = _bUIg88Df;
        "pkg-1.20.1-2.2-forge+fabric" = _6i7fbyKs;
        "pkg-1.20.2-2.2-forge+fabric" = _83icanK1;
        "pkg-1.20.3-2.2-fabric+forge+neo" = _qt204cxV;
        "pkg-1.20.4-2.2-fabric+forge+neo" = _edaPY3kb;
        "pkg-1.19.2-2.3-fabric+forge+neo" = _agkRydNp;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _ZOp7Y3oX;
        "pkg-1.20.2-2.3-fabric+forge+neo" = _L4cgSpqV;
        "pkg-1.20.4-2.3-fabric+forge+neo" = _vANPZZfs;
        "pkg-1.20.5-2.3-fabric+neo" = _Q8ONCFwo;
        "pkg-1.20.6-2.3-fabric+forge+neo" = _M654jCUY;
        "pkg-1.21.0-2.3-fabric+forge+neo" = _xoFmqr6x;
        "pkg-1.20.1-2.4-fabric+forge+neo" = _efbrJR38;
        "pkg-1.20.6-2.4-fabric+forge+neo" = _lALqybGY;
        "pkg-1.21.0-2.4-fabric+forge+neo" = _xeX91hIv;
        "pkg-1.21.1-2.4-fabric+forge+neo" = _5ea5n1PO;
        "pkg-1.21.2-2.4-fabric+neo" = _sr7TBCoo;
        "pkg-1.21.3-2.4-fabric+forge+neo" = _UaGMmF4O;
        "pkg-1.21.4-2.4-fabric+forge+neo" = _TTABXX2K;
        "pkg-1.20.1-2.5-fabric+forge+neo" = _7c5nMR4O;
        "pkg-1.21.1-2.5-fabric+forge+neo" = _2u5kjJ75;
        "pkg-1.21.4-2.5-fabric+forge+neo" = _hCpUybf2;
        "pkg-1.21.5-2.5-fabric+forge+neo" = _hmf6qets;
        "pkg-1.21.6-2.5-fabric+forge+neo" = _nyGUvgv5;
        "pkg-1.21.7-2.5-fabric+forge+neo" = _nGZ8k6p0;
        "pkg-1.21.8-2.5-fabric+forge+neo" = _QRzdCI12;
        "pkg-1.21.9-2.5-fabric+forge+neo" = _oap91szg;
        "pkg-1.21.10-2.5-fabric+forge+neo" = _cEXB9P5O;
        "pkg-1.21.11-2.5-fabric+forge+neo" = _DrRKPb6N;
        "pkg-26.1.0-2.5-fabric+forge+neo" = _31Hu5WHP;
        "pkg-26.1.1-2.5-fabric+forge+neo" = _LDzEbhy8;
        "pkg-26.1.2-2.5-fabric+forge+neo" = _FQepxW7f;
        "pkg-26.2.0-2.5-fabric+forge+neo" = _9wsCHwQS;
        "default" = _9wsCHwQS;
    });
