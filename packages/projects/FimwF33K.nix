...
let
    ...
    in {
        ...
        "pkg-0.1.2" = _zgGtBuGd;
        "pkg-0.1.3" = _cLp5iRrT;
        "pkg-mc1.19.4-0.1.4" = _hxGSuUke;
        "pkg-mc1.20.0-0.1.4" = _JD2veGMW;
        "pkg-mc1.20.1-0.1.4" = _GYSmfiPM;
        "pkg-mc1.20.2-0.1.4" = _e0OEg7wG;
        "pkg-mc1.20.3-0.1.4" = _tMkRCw5u;
        "pkg-mc1.20.1-0.1.5" = _mhD4lahI;
        "pkg-mc1.20.2-0.1.5" = _uIeEaGZ6;
        "pkg-mc1.20.4-0.1.5" = _6LOQm8s0;
        "pkg-mc1.20.1-0.1.6" = _bdXfnUUl;
        "pkg-mc1.20.2-0.1.6" = _fFjDcvVD;
        "pkg-mc1.20.4-0.1.6" = _UwT5Yn8f;
        "pkg-mc1.19.2-0.1.7" = _UxHH96FR;
        "pkg-mc1.20.1-0.1.7" = _52lnr3A3;
        "pkg-mc1.20.2-0.1.7" = _dY770EZv;
        "pkg-mc1.20.4-0.1.7" = _bRf0gXFJ;
        "pkg-mc1.20.1-0.1.8" = _nXoQGQed;
        "pkg-mc1.20.2-0.1.8" = _eNAAsBWT;
        "pkg-mc1.20.4-0.1.8" = _l0V4QSPA;
        "pkg-mc1.20.1-0.1.9" = _te06ZQpD;
        "pkg-mc1.20.3-0.1.9" = _beT1zdXy;
        "pkg-mc1.20.1-0.2.0" = _JFNunyDW;
        "pkg-mc1.20.3-0.2.0" = _OzHup14j;
        "pkg-mc1.20.5-0.2.0" = _jZlCWoxJ;
        "pkg-mc1.21-0.2.0" = _JKmWiHVO;
        "pkg-mc1.21-0.2.1" = _WfFL1ZEG;
        "pkg-mc1.20.5-0.2.2" = _M020PwDN;
        "pkg-mc1.21-0.2.2" = _8shnjIoG;
        "pkg-mc1.20.5-0.2.3" = _ufqzhpG1;
        "pkg-mc1.21-0.2.3" = _rZZBac5a;
        "default" = _rZZBac5a;
    });
