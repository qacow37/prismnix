...
let
    ...
    in {
        ...
        "pkg-1.0.5+1.16.5" = _FQMrJOdS;
        "pkg-1.1.4+1.17.1" = _cKSCGEPv;
        "pkg-1.2.4+1.18.2" = _4WiB5Rs4;
        "pkg-1.3.4+1.19.2" = _cL5MPTHI;
        "pkg-1.3.6+1.19.3" = _H5PIA4ij;
        "pkg-1.3.7+1.19.4" = _kRwNsIhH;
        "pkg-1.4.0+1.20" = _bT3LgQlB;
        "pkg-1.4.0+1.20.1" = _cos7bgsW;
        "pkg-1.4.1+1.20" = _wWcx129o;
        "pkg-1.4.1+1.20.1" = _xsjde7Ym;
        "pkg-1.4.2+1.20" = _oXwze9kl;
        "pkg-1.4.2+1.20.1" = _Q9SZp916;
        "pkg-1.0.6+1.16.5" = _LezkVKl3;
        "pkg-1.1.5+1.17.1" = _ViApRt5x;
        "pkg-1.2.5+1.18.2" = _rL9uWvee;
        "pkg-1.3.8+1.19.2" = _XD116Fcq;
        "pkg-1.3.8+1.19.3" = _LHC2hWVu;
        "pkg-1.3.8+1.19.4" = _o0woTZmE;
        "pkg-1.4.3+1.20" = _8zpO9Ben;
        "pkg-1.4.3+1.20.1" = _IKBqftJM;
        "pkg-1.0.7+1.16.5" = _Oy3bUap3;
        "pkg-1.1.6+1.17.1" = _C5MmUNDM;
        "pkg-1.2.6+1.18.2" = _beT2zpuc;
        "pkg-1.3.9+1.19.2" = _QPRQRb6c;
        "pkg-1.3.9+1.19.3" = _fbhJun5f;
        "pkg-1.3.9+1.19.4" = _d8PurZaq;
        "pkg-1.4.4+1.20" = _tjasdRGZ;
        "pkg-1.4.4+1.20.1" = _b0w6HygY;
        "pkg-1.4.4+1.20.2" = _QOnsmBo5;
        "pkg-1.2.7+1.18.2" = _E6vt2xtl;
        "pkg-1.3.10+1.19.2" = _KkW48e9y;
        "pkg-1.3.10+1.19.4" = _91WzFReP;
        "pkg-1.4.5+1.20.1" = _ju995cSJ;
        "pkg-1.4.5+1.20.4" = _dgxM4GcI;
        "pkg-2.0.0" = _Mt1U4Y4H;
        "pkg-2.0.1" = _rnaPSkCj;
        "pkg-2.0.2" = _HwlMUpfO;
        "pkg-2.1.0" = _NMRPv9r2;
