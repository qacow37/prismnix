...
let
    ...
    in {
        ...
        "pkg-1.0" = _JhijNFeU;
        "pkg-1.0_mod" = _99TPDGvi;
        "pkg-1.1" = _XmCyxvUA;
        "pkg-1.2" = _xk2lQlt2;
        "pkg-1.2+mod" = _5cEYS0Ch;
        "pkg-1.3" = _CXQTSWZZ;
        "pkg-1.3+mod" = _FUukXOJi;
        "pkg-1.4" = _pA0IhBGD;
        "pkg-1.4+mod" = _jkobwBLi;
        "pkg-2.0" = _xMdVoO6F;
        "pkg-2.0+mod" = _aoYjUgGE;
        "pkg-2.1" = _7BRWCqew;
        "pkg-3.0" = _8CKiTiop;
        "pkg-3.0+mod" = _tbF9Zy9Y;
        "pkg-3.1" = _FYKsf8hq;
        "pkg-3.1+mod" = _G3K4Xd1k;
        "pkg-3.2" = _EV410H2J;
        "pkg-3.2+mod" = _vRkYlFRo;
        "pkg-3.3" = _c0QxcGTs;
        "pkg-3.3+mod" = _P2MhoTXl;
        "pkg-3.4" = _LCSfO0Q0;
        "pkg-3.4+mod" = _2EALwB3W;
        "pkg-3.5" = _aW6qQ2vD;
        "pkg-3.5+mod" = _mcsl3iJd;
        "pkg-3.6" = _mhupffux;
        "pkg-3.6+mod" = _veCHtTh9;
        "pkg-3.7" = _iufeZOhl;
        "pkg-3.7-fabric" = _HERrmmgP;
        "pkg-3.7-forge" = _cwjN1GE8;
        "pkg-3.11" = _kV8nxbob;
        "pkg-3.11-fabric" = _VtErDZYw;
        "pkg-3.11-quilt" = _zcUrKeQ2;
        "pkg-3.11-forge" = _Jk8cb3aV;
        "pkg-3.11-neoforge" = _ztznSxZn;
        "pkg-3.12" = _KWoUxh9c;
        "pkg-3.12-fabric" = _71IE3iB5;
        "pkg-3.12-quilt" = _4IXiAx5i;
        "pkg-3.12-forge" = _GwEWEA4F;
        "pkg-3.12-neoforge" = _EWNdYaeL;
        "default" = _EWNdYaeL;
    });
