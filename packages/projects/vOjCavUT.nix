...
let
    ...
    in {
        ...
        "pkg-1.8.0" = _ulhLxPbI;
        "pkg-1.9.0" = _13IU87fo;
        "pkg-1.10.0" = _7MximalI;
        "pkg-1.16.0" = _86wp2ALZ;
        "pkg-1.19.0" = _bOvq9jS9;
        "pkg-1.20.0" = _U5pczYpd;
        "pkg-1.22.0" = _ZiJwkgTz;
        "pkg-1.25.0" = _snp7x6ZW;
        "pkg-1.26.0" = _dPB34MqP;
        "pkg-1.26.1" = _YZMSJHTC;
        "pkg-1.29.0" = _HLCRnYEc;
        "pkg-1.29.1" = _aDSdwCv6;
        "pkg-1.31.0" = _hWkaWlG4;
        "pkg-1.32.1" = _lScpLhxr;
        "pkg-1.33.0" = _IxhYv0Wz;
        "pkg-1.34.0" = _qpWgANHc;
        "pkg-1.34.1" = _m9wZIn9O;
        "pkg-1.34.2" = _cjs92n9j;
        "pkg-1.34.3" = _PoE9g43T;
