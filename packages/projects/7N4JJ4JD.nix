...
let
    ...
    in {
        ...
        "pkg-1.17.1-2.0.0" = _7caj2Jzx;
        "pkg-1.18.1-3.0.0" = _qaSokCZY;
        "pkg-1.18.2-3.1.0" = _tvZQ34Vk;
        "pkg-1.0" = _MNse1WDU;
        "pkg-1.14.4-1.0" = _2LA7B1s5;
        "pkg-1.15.2-1.2" = _a9eu73eh;
        "pkg-1.16.4-1.2.6" = _XjSjabY8;
        "pkg-1.19-4.0.0" = _g0FUXkuN;
        "pkg-1.18.2-3.1.1" = _6hbD4TcC;
        "pkg-1.19-4.0.1" = _CVS8nKgE;
        "pkg-1.19-4.0.2" = _3sqlgtWi;
        "pkg-1.19-4.0.3" = _koI2N5zx;
        "pkg-1.19-4.0.4" = _C6KY8fBl;
        "pkg-1.18.2-3.1.2" = _g2zP0Df5;
        "pkg-1.19.1-4.1.0" = _7LME5JJO;
        "pkg-1.19.1-4.1.1" = _y5oVLBuX;
        "pkg-1.19.4-4.2.0" = _1MiGcU8Z;
        "pkg-1.20.1-5.1.0" = _Ft1BHa53;
        "pkg-1.20.1-5.1.2" = _lfA4tAo8;
        "pkg-1.18.2-3.1.3" = _TSheNjlE;
        "pkg-1.19.4-4.2.2" = _p0Aeh8jm;
        "pkg-1.17.1-2.0.2" = _MmwkeLEA;
        "default" = _MmwkeLEA;
    });
