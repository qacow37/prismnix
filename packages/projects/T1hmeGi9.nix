...
let
    ...
    in {
        ...
        "pkg-1.19.2-0.0.1.i" = _AIZ6fJBy;
        "pkg-1.19.2-0.0.2.i" = _H2rVEiUJ;
        "pkg-1.19.2-0.0.5.i" = _fX85LxpY;
        "pkg-1.19.2-0.0.6.i" = _IRFQMyZE;
        "pkg-1.19.2-0.0.9.c-36" = _vqQlwKKq;
        "pkg-1.19.2-0.0.10.c-36" = _aVC8zWn5;
        "pkg-1.20.1-0.0.10.d-9" = _dBCMdNgy;
        "pkg-1.20.1-0.0.11.d-9" = _WS7lW0ab;
        "pkg-1.20.1-0.0.12.d-9" = _jVm08kxP;
        "pkg-1.19.2-0.0.11.c-36" = _qHdGfcTa;
        "pkg-1.19.2-0.0.12.c-36" = _STimUyWh;
        "pkg-1.20.1-0.0.13.d-9" = _uvQytfbY;
        "pkg-1.19.2-0.0.14.e-44" = _T3tNd5nl;
        "pkg-1.20.1-0.0.14.e-22" = _2fW06BMu;
        "pkg-1.20.1-0.0.15.h-48" = _L84KvXBV;
        "pkg-1.20.1-0.0.16.h-48" = _SDEzbEyI;
        "pkg-1.20.1-0.0.17.h-48" = _6yaAPSEc;
        "pkg-1.20.1-0.1.0.h-48" = _UiRV8V1H;
        "pkg-1.20.1-0.1.0.j-55" = _n16CYvcF;
        "pkg-1.20.1-0.1.1.j-55" = _EwtEH60Y;
        "pkg-1.20.1-0.1.2-6.0.1" = _qE3otRKL;
        "pkg-1.20.1-0.1.3-6.0.1" = _gqTeUNAT;
        "pkg-1.20.1-0.1.4-6.0.2" = _iBgBVwd9;
        "pkg-1.20.1-0.1.5-6.0.4" = _e8mOfErW;
        "pkg-1.21.1-1.0.0-6.0.4" = _sA4R9UTh;
        "pkg-1.21.1-1.0.1-6.0.4" = _HpOr67zD;
        "pkg-1.21.1-1.0.2-6.0.4" = _BI6MdkTH;
        "pkg-1.21.1-1.1.0-6.0.4" = _H0dlUh4p;
        "pkg-1.21.1-1.1.1-6.0.4" = _tgOAKKRb;
        "pkg-1.21.1-1.1.2-6.0.4" = _Nbzs3Uvo;
        "pkg-1.21.1-1.2.0-6.0.4" = _RPnCQN1k;
        "pkg-1.21.1-1.2.1-6.0.4" = _oWyZGa0u;
        "pkg-1.20.1-0.1.6-6.0.4" = _wXrjWpGm;
        "pkg-1.21.1-1.2.2-6.0.4" = _LiNc1lFc;
        "pkg-1.21.1-1.2.4-6.0.6" = _SfByo5AD;
        "pkg-1.20.1-0.1.7-6.0.6" = _rmpoahFk;
        "pkg-1.21.1-1.3.0-6.0.8" = _WlsTiEVK;
        "pkg-1.21.1-1.3.1-6.0.10" = _iw0iZPNt;
        "pkg-1.21.1-1.3.2-6.0.10" = _k7Fepzl4;
        "default" = _k7Fepzl4;
    });
