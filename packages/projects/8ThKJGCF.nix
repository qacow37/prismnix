...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _LpnEHVYI;
        "pkg-1.0.1-1.20.1" = _UgpQjilD;
        "pkg-1.0.2-1.20.1" = _TMAPfif2;
        "pkg-1.0.3-1.20.1" = _lRIqiTMF;
        "pkg-1.0.4-1.20.1" = _y6gjer1z;
        "pkg-1.0.4-1.20.2" = _g8hLHRJs;
        "pkg-1.0.5-1.20.1" = _mkFBSUrX;
        "pkg-1.0.5-1.20.2" = _x1VOBHoW;
        "pkg-1.0.5-1.20.4" = _qGPih9OE;
        "pkg-1.0.5-1.20.6" = _8bASzkPm;
        "pkg-1.0.5-1.21" = _jQiGGK1O;
        "pkg-1.0.6-1.20.1" = _QSVamttl;
        "pkg-1.0.7-1.20.1" = _wRjxW69j;
        "pkg-1.1.0-1.20.1" = _zqhyz0ak;
        "pkg-1.1.1-1.20.1" = _mqF8r65S;
        "pkg-1.1.2-1.20.1" = _UUhWp6iO;
        "pkg-1.1.2-1.20.2" = _DOOhgd0K;
        "pkg-1.1.2-1.20.4" = _9Mm66qMp;
        "pkg-1.1.3-1.20.1" = _6U2kYKdr;
        "pkg-1.1.3-1.20.2" = _Y1F7H3SI;
        "pkg-1.1.3-1.20.4" = _XlsaIfsP;
        "pkg-1.1.3-1.20.6" = _AAgZ0xZn;
        "pkg-1.1.3-1.21.1" = _TSttMxzl;
        "pkg-1.1.3-1.19.2" = _US1tp8zK;
        "pkg-1.1.3-1.18.2" = _TVsZqQXY;
        "pkg-1.1.3-1.21.3" = _2hZhHypV;
        "pkg-1.1.3b-1.21.1" = _ZcNUkIY5;
        "pkg-1.1.3b-1.21.3" = _UrPSriKU;
        "pkg-1.1.3b-1.21.4" = _rlqOol1h;
        "pkg-1.1.3b-1.21.5" = _VerMGZh2;
        "default" = _VerMGZh2;
    });
