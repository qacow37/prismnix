...
let
    ...
    in {
        ...
        "pkg-v.1.1.5" = _vlaXJJEQ;
        "pkg-v.1.1.4" = _yvawHAA1;
        "pkg-v.1.2.3" = _ZyQArODs;
        "pkg-v.1.2.4" = _aVNLEq4n;
        "pkg-v.1.1.5a" = _3NUI2ReQ;
        "pkg-v.1.2.3a" = _M4SCJgya;
        "pkg-v.1.2.5" = _u4zzx6a5;
        "pkg-v.1.2.6" = _2ec1Brwi;
        "pkg-v.1.3.0" = _QWKXFl6m;
        "pkg-v.1.3.1" = _pbE8hmZS;
        "pkg-v.1.4.0" = _ZlBoZcQG;
        "pkg-v.1.4.1" = _6Dk80eOy;
        "pkg-v.1.4.2" = _qXaaF1xT;
        "pkg-v.1.4.3" = _MlPX6fPD;
        "pkg-v.1.4.4" = _Uh5tYXtC;
        "pkg-v.1.4.5" = _QuKm0ZUu;
        "pkg-v.1.4.6" = _9xkpB2mA;
        "pkg-v.1.5.0" = _1EvYhB0Q;
        "pkg-v.1.4.7" = _31O7Ps5A;
        "pkg-v.1.1.5b" = _qHcPO1zS;
        "pkg-v.1.2.3b" = _yaUIqDGm;
        "pkg-v.1.3.0a" = _1U5C4zuh;
        "pkg-v.1.3.2" = _GiebJTXW;
        "pkg-v.1.5.1" = _6v3Dv2kX;
        "pkg-1.1.5c" = _kLvmEv8Z;
        "pkg-v.1.2.3c" = _KdNpCRcQ;
        "pkg-v.1.3.0b" = _RKzsJC1b;
        "pkg-v.1.3.3" = _xiWgf05J;
        "pkg-v.1.4.8" = _5kBS9vGg;
        "pkg-v.1.5.2" = _XXORnGeo;
        "pkg-v.2.0.0" = _RdVRo6Tn;
        "pkg-v.2.1.0" = _vQcT3IoL;
        "pkg-v.1.4.9" = _oZEBxolm;
        "pkg-v.3.0.0" = _TMAg2SoI;
        "pkg-v.3.1.0" = _VuTlPJV7;
        "pkg-v.1.4.10" = _18h2at75;
        "pkg-v.2.1.1" = _xOO3SIRm;
        "pkg-v.3.0.1" = _A5Chjrqt;
        "pkg-v.4.0.0" = _TDmsbud7;
        "pkg-v.4.1.0" = _1k80udcC;
        "pkg-v.2.2.0" = _C0IeqYX7;
        "pkg-v.4.1.1" = _hlbtsxs4;
        "pkg-v.4.2.0" = _5PZK3RGk;
        "pkg-v.4.3.0" = _gqjt4Q2C;
        "default" = _gqjt4Q2C;
    });
