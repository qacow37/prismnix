...
let
    ...
    in {
        ...
        "pkg-1.0010" = _OedBjrJk;
        "pkg-1.0110" = _g3C2WaV6;
        "pkg-1.0210" = _lqJ5rcPd;
        "pkg-1.0310" = _PDtxW26h;
        "pkg-1.0410" = _ZllxAAbg;
        "pkg-1.0510" = _GK2wmP38;
        "pkg-1.0610" = _O6RtwJjq;
        "pkg-1.0711" = _d2Oja41V;
        "pkg-1.0811" = _IlMg5tOF;
        "pkg-1.0911" = _acYeN0XE;
        "pkg-1.1112" = _HHomggz8;
        "pkg-1.1212" = _7rdHT6Ly;
        "pkg-2.0201" = _mG5L8QGN;
        "pkg-2.0301" = _8cEVcd1s;
        "pkg-2.0403" = _ODDA8ZSL;
        "pkg-2.0504" = _XZzH3zuQ;
        "pkg-2.0605" = _4aeDt9Cd;
        "pkg-2.0706" = _SAl0CIbl;
        "pkg-2.0806" = _Q8VqxbhE;
        "pkg-2.0907" = _pvIRCn7K;
        "pkg-2.1007" = _3C7uC2br;
        "pkg-2.1108" = _mH2u1icB;
        "pkg-2.1209" = _LlakeS8o;
        "pkg-3.0001" = _ug4hqeYC;
        "pkg-3.0103" = _cHW7Uv9A;
        "pkg-3.0204" = _ugFKH0F5;
        "pkg-3.0306" = _fEaFeOWr;
        "pkg-3.0406" = _JrKLLYd8;
        "pkg-3.0507" = _CEMjH2Hs;
        "default" = _CEMjH2Hs;
    });
