...
let
    ...
    in {
        ...
        "pkg-0.4.0+1.19.2" = _usBLzTOZ;
        "pkg-0.5.0+1.19.2" = _s7VB1m5g;
        "pkg-0.5.1+1.19.2" = _ESukN1hU;
        "pkg-0.6.0+1.19.2" = _7iWNqyCW;
        "pkg-0.7.0+1.19.2" = _G4Bqf8bv;
        "pkg-0.7.1+1.19.2" = _pY0OuVwP;
        "pkg-0.7.2+1.19.2" = _VyG8y42K;
        "pkg-0.7.3+1.19.2" = _gX9oxrLu;
        "pkg-0.7.4+1.19.2" = _emanm5VA;
        "pkg-0.8.0+1.19.3" = _qQT61cA4;
        "pkg-0.9.0+1.19.3" = _9aPRVMaD;
        "pkg-0.10.0+1.19.4" = _wdAtWfS2;
        "pkg-0.11.0+1.20.0" = _S0UsfZfj;
        "pkg-0.11.1+1.20.0" = _GJaLSZ52;
        "pkg-0.11.2+1.20.0" = _1QF0g1Vv;
        "pkg-0.12.0+1.20.1" = _9NyvBu2u;
        "pkg-0.12.1+1.20.1" = _pCPtRC8w;
        "pkg-0.12.2+1.20.1" = _dqeXNnDy;
        "pkg-0.13.0+1.20.1" = _Pcwq0Yn0;
        "pkg-0.14.0+1.20.1" = _MDce3jc9;
        "pkg-0.14.1+1.20.1" = _KgDyIfPd;
        "pkg-0.15.0+1.20.1" = _evIzOtXg;
        "pkg-0.15.1+1.20.1" = _GlUWIpf5;
        "pkg-0.15.2+1.20.1" = _CN3rfBNu;
        "pkg-0.15.2-alpha+1.20.1-forge" = _yGbpkMo5;
        "pkg-0.15.3+1.20.1" = _5vTBtmR0;
        "pkg-0.15.e-alpha+1.20.1-forge" = _CxgVH3k0;
        "pkg-0.15.4+1.20.1" = _HA7WOg6L;
        "pkg-0.15.4-alpha+1.20.1-forge" = _zh1aK3qP;
        "pkg-0.15.5+1.20.1-forge" = _KtRbOOXY;
        "pkg-0.15.5+1.20.1" = _OYbIrodR;
        "pkg-0.15.6+1.20.1-forge" = _sCxHMib4;
        "pkg-0.15.6+1.20.1-fabric" = _Q8JSGhdj;
        "pkg-0.16.0+1.20.2-forge" = _CoN7yxuB;
        "pkg-0.16.0+1.20.2-fabric" = _rpUVkvi8;
        "pkg-0.16.1+1.20.2-forge" = _S2mxYQLP;
        "pkg-0.16.1+1.20.2-fabric" = _yuRPpkVE;
        "pkg-0.16.2+1.20.2-forge" = _tIktIAbL;
        "pkg-0.16.2+1.20.2-fabric" = _QOTwGLKw;
        "pkg-0.17.0+1.20.4-fabric" = _nU79gyPO;
        "pkg-0.17.0+1.20.4-forge" = _k7Lc1AsU;
        "pkg-0.17.3+1.20.4-fabric" = _Xvb7diPW;
        "pkg-0.17.3+1.20.4-forge" = _2PMJ6JTB;
        "pkg-0.17.4+1.20.4-fabric" = _p4G8vs3T;
        "pkg-0.17.4+1.20.4-forge" = _3kqiNXSf;
        "pkg-0.18.0+1.20.6-fabric" = _D3C3AGKP;
        "pkg-0.18.1+1.20.6-fabric" = _194JWasK;
        "pkg-0.19.0+1.21-fabric" = _YtkZmwLO;
        "pkg-0.20.0+1.21.1-fabric" = _Rhplybe8;
        "pkg-0.22.0+1.21.3-fabric" = _T7nH3NCk;
        "pkg-0.23.0+1.21.4-fabric" = _1KuX59cj;
        "pkg-0.24.0+1.21.5-fabric" = _X3MhZeJC;
        "pkg-0.24.1+1.21.5-fabric" = _7mTnBi2q;
        "pkg-0.25.0+1.21.6-fabric" = _ql6o5F4S;
        "pkg-0.26.0+1.21.7-fabric" = _ivLyPe2P;
        "pkg-0.26.1+1.21.7-fabric" = _wyqCSRwG;
        "pkg-0.27.0+1.21.8-fabric" = _y0qKuwQV;
        "pkg-0.28.0+1.21.9-fabric" = _yw6bD7A8;
        "pkg-0.29.0+1.21.10-fabric" = _DtjrGc8t;
        "pkg-0.30.0+1.21.11-fabric" = _yqaOm9Fj;
        "pkg-0.31.0+1.21.11" = _2a72komm;
        "pkg-0.31.1+1.21.11" = _aEKhnCTg;
        "pkg-0.32.0+26.1.1" = _nQ8blDnN;
