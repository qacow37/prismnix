...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _gOB8tRNo;
        "pkg-1.1.0" = _yTCKdidQ;
        "pkg-1.2.0+pre1" = _gchDMAwg;
        "pkg-1.2.0+pre3" = _PXVLWeix;
        "pkg-1.2.0+pre4" = _m9kBws5g;
        "pkg-1.2.0+pre5" = _CnNsidIQ;
        "pkg-1.2.0+pre6" = _cflDuMYG;
        "pkg-1.3.0-pre1+1.20-pre1" = _kqztphqa;
        "default" = _kqztphqa;
    });
