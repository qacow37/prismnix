...
let
    ...
    in {
        ...
        "pkg-0.6.2+1.21.3" = _RRn2TI9a;
        "pkg-0.6.3+1.21.3" = _A3UGDx3z;
        "pkg-0.6.3+1.21" = _YILMzBd2;
        "pkg-0.6.4+1.21" = _6RgpjD17;
        "pkg-0.6.5+1.21" = _XQlCyLnt;
        "pkg-0.6.6+1.21" = _T2EIn8Ew;
        "pkg-0.6.6+1.21.3" = _9HH6UOrC;
        "pkg-0.6.6+1.21.6" = _nrCJoILc;
        "pkg-1.0.0+1.21.1" = _V5wdugDQ;
        "pkg-1.0.0+1.21.8" = _AZL3BJZc;
        "pkg-1.0.0+1.21.9" = _HSYoGCCe;
        "pkg-1.0.1+1.21.8" = _4JvDf9f9;
        "pkg-1.0.1+1.21.9" = _7yYU0K4C;
        "pkg-1.0.1+1.21.1" = _vKCn89n1;
        "pkg-1.1.0+1.21.11-neoforge" = _RCyCH8Nl;
        "pkg-1.1.0+1.21.11-fabric" = _2e6FCPsy;
        "pkg-1.1.1+26.1-neoforge" = _cjlYochi;
        "pkg-1.1.1+26.1-fabric" = _oUZ901A5;
        "pkg-1.1.2+26.1-neoforge" = _kFoYBLvP;
        "pkg-1.1.2+26.1-fabric" = _rly7FiHw;
        "pkg-1.1.3+26.1-neoforge" = _NTq71vq2;
        "pkg-1.1.3+26.1-fabric" = _9AEYzMpD;
        "pkg-1.1.4+26.1-neoforge" = _8APfaDQO;
