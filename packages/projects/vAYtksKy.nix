...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.18.2-forge" = _ZTbiA6Ql;
        "pkg-1.0.0-1.18.2-fabric" = _4xW1S29p;
        "pkg-1.0.0-1.18.2-quilt" = _ylzEmYfD;
        "pkg-1.1.0-1.19-forge" = _6nv8dtqV;
        "pkg-1.1.0-1.19-fabric" = _pOVLZl9U;
        "pkg-1.1.0-1.19-quilt" = _LkYXKHYt;
        "pkg-1.1.1-1.19.1-forge" = _AeDfoqHp;
        "pkg-1.1.1-1.19.1-fabric" = _S2vFPmf0;
        "pkg-1.1.1-1.19.1-quilt" = _QNhdL7U0;
        "pkg-v1.2.0-1.19.2" = _gZOi0CNC;
        "pkg-v1.2.0-1.19.3" = _hr9dgvP6;
        "pkg-v1.2.2-1.19.4" = _B5T9Kbpz;
        "pkg-1.3.0+forge-1.19.4" = _qb7sWxX7;
        "pkg-1.3.0+fabric-1.19.4" = _BP2xV2VL;
        "pkg-1.4.0+fabric-1.20" = _nG3xqA71;
        "pkg-1.4.0+forge-1.20" = _BSK3P0lR;
        "pkg-1.4.1+fabric-1.20.1" = _nRj7j4uK;
        "pkg-1.4.1+forge-1.20.1" = _j2CEj8JG;
        "pkg-1.4.2+neoforge-1.20.1" = _SBxttmTZ;
        "pkg-1.4.2+fabric-1.20.1" = _phMtkE0E;
        "pkg-1.4.2+forge-1.20.1" = _sNIS4ziJ;
        "pkg-1.4.5+fabric-1.20.4" = _rvdURvZo;
        "pkg-1.4.5+neoforge-1.20.4" = _PV7GyIxP;
        "pkg-1.4.5+forge-1.20.4" = _D3lZQsgZ;
        "pkg-1.4.6+forge-1.20.6" = _fNoSdd1D;
        "pkg-1.4.6+neoforge-1.20.6" = _zFsYVHSE;
        "pkg-1.4.6+fabric-1.20.6" = _WYT791Fl;
        "pkg-1.4.7+forge-1.21.1" = _rFSIXcXX;
        "pkg-1.4.7+neoforge-1.21.1" = _U8r9sfJy;
        "pkg-1.4.7+fabric-1.21.1" = _FIh9kj6U;
        "pkg-1.4.9+forge-1.21.4" = _c3Z9F1yw;
        "pkg-1.4.9+fabric-1.21.4" = _fLDdfSId;
        "pkg-1.4.9+neoforge-1.21.4" = _a14c3FEx;
        "pkg-1.4.8+fabric-1.21.3" = _NZ3ZXjTn;
        "pkg-1.4.8+forge-1.21.3" = _UfQ5JWUN;
        "pkg-1.4.8+neoforge-1.21.3" = _lxGCfJHW;
        "pkg-1.4.2+fix-cloth+neoforge-1.20.1" = _RUkDCWDD;
        "pkg-1.4.2+fix-cloth+forge-1.20.1" = _gFLIrUj0;
        "pkg-1.4.2+fix-cloth+fabric-1.20.1" = _GkX409oG;
        "pkg-1.3.1+for1.19+forge-1.19" = _fvE0srhI;
        "pkg-1.3.1+for1.19+fabric-1.19" = _4mFDjf6Q;
        "pkg-1.3.1+for1.19.1+forge-1.19.1" = _FJgRhQ2O;
        "pkg-1.3.1+for1.19.1+fabric-1.19.1" = _AZEYUogo;
        "pkg-1.3.1+for1.19.3+forge-1.19.3" = _yySMmmrp;
        "pkg-1.3.1+for1.19.3+fabric-1.19.3" = _I8LJEEPl;
        "pkg-1.3.1+for1.19.2+forge-1.19.2" = _jokK0w91;
        "pkg-1.3.1+for1.19.2+fabric-1.19.2" = _tWCg0VkM;
        "pkg-1.4.10-beta+neoforge-1.21.5" = _2ZxpeSO4;
        "pkg-1.4.10-beta+fabric-1.21.5" = _7hhYTdhS;
        "pkg-1.5.0+neoforge-1.21.6" = _qo4fghFF;
        "pkg-1.5.0+fabric-1.21.6" = _82n68V9i;
        "pkg-1.5.1+neoforge-1.21.7" = _Z6y3vsFL;
        "pkg-1.5.1+fabric-1.21.7" = _oFdivt2n;
        "pkg-1.5.2+fabric-1.21.8" = _y5AjkGH8;
        "pkg-1.5.2+neoforge-1.21.8" = _3slWFUrK;
        "pkg-1.5.3+fabric-1.21.9" = _fCWCWZGW;
        "pkg-1.5.3+neoforge-1.21.9" = _BfGiercR;
        "pkg-1.5.4+fabric-1.21.10" = _oX0dtBde;
        "pkg-1.5.4+neoforge-1.21.10" = _bdHtipkT;
        "pkg-1.5.5+neoforge-1.21.11" = _mkXPhhQz;
        "pkg-1.5.5+fabric-1.21.11" = _LjlxjWIg;
        "pkg-1.5.6+fabric-26.1" = _s5Vyby6V;
        "pkg-1.5.6+neoforge-26.1" = _ES9cRZ1E;
        "pkg-1.5.7+neoforge-26.1.1" = _kDpbd74y;
        "pkg-1.5.7+fabric-26.1.1" = _RDtFXjgD;
        "pkg-1.5.8+neoforge-26.1.2" = _lQvHoLvS;
        "pkg-1.5.8+fabric-26.1.2" = _pOwBgh8K;
        "pkg-1.6.0+fabric-26.2" = _DGk6zAdg;
        "pkg-1.6.0+neoforge-26.2" = _QskurR3v;
        "pkg-1.6.0+forge-26.2" = _XCIQCPjS;
        "default" = _XCIQCPjS;
    });
