...
let
    ...
    in {
        ...
        "pkg-1.0" = _C2kUJ4ib;
        "pkg-1.0_mod" = _cmA5lBT4;
        "pkg-1.1" = _t4V0UQmW;
        "pkg-1.2" = _7Gu4mUUV;
        "pkg-1.3" = _43JkCWbr;
        "pkg-1.3+mod" = _IzIbXX2Z;
        "pkg-1.4" = _NquVhHNH;
        "pkg-1.4+mod" = _PuMxEiZ2;
        "pkg-1.5" = _qsp3WMCG;
        "pkg-1.5+mod" = _MNoiUvW5;
        "pkg-2.0" = _Y2cj4XPU;
        "pkg-2.0+mod" = _fUftNG4D;
        "pkg-2.1" = _hUjTaqCF;
        "pkg-3.0" = _npXcDX4k;
        "pkg-3.0+mod" = _zLLEYSyc;
        "pkg-3.1" = _MfBu5Wgu;
        "pkg-3.1+mod" = _IR4QeUKh;
        "pkg-3.4" = _G3HBs1Od;
        "pkg-3.4+mod" = _sz02MnMi;
        "pkg-3.5" = _44sj2lDi;
        "pkg-3.5+mod" = _OkpVISA5;
        "pkg-3.6" = _4dDvhqzh;
        "pkg-3.6+mod" = _Jjdcm4lT;
        "pkg-3.7" = _VYWpo4MR;
        "pkg-3.7+mod" = _s42Rs9X3;
        "pkg-3.8" = _tEtIB5gV;
        "pkg-3.8+mod" = _P0PcB9j1;
        "pkg-3.9" = _dislpRta;
        "pkg-3.9-fabric" = _2OCJXMp7;
        "pkg-3.9-forge" = _ID5DNpDj;
        "pkg-3.13" = _Y9UBcvNp;
        "pkg-3.13-fabric" = _xodH5lrs;
        "pkg-3.13-quilt" = _OBlp9ZrV;
        "pkg-3.13-forge" = _umsZRzIF;
        "pkg-3.13-neoforge" = _2PPyuv4E;
        "pkg-3.14" = _D69L3Ypd;
        "pkg-3.14-fabric" = _lvkgaGq9;
        "pkg-3.14-quilt" = _cGL7FH1S;
        "pkg-3.14-forge" = _t1JLUb98;
        "pkg-3.14-neoforge" = _8QTHSnPH;
        "default" = _8QTHSnPH;
    });
