...
let
    ...
    in {
        ...
        "pkg-0.2.8" = _SilvRmKj;
        "pkg-0.2.9" = _XgBVYGsd;
        "pkg-0.2.10" = _pJCki8s4;
        "pkg-0.3.0" = _OfC9gNet;
        "pkg-0.3.1" = _ZQD9e6iv;
        "pkg-0.3.2" = _PgufqdPD;
        "pkg-0.3.3+1.18.2" = _KZfHS3De;
        "pkg-0.4.0+1.19" = _b9Smrnb8;
        "pkg-0.4.1+1.19" = _RwzQ5HgE;
        "pkg-0.4.2+1.19" = _BszOSmx5;
        "pkg-0.4.3+1.19" = _Y8p0nWLS;
        "pkg-0.4.4+1.19" = _nAvD6YT6;
        "pkg-0.3.4+1.18.2" = _JQa53BrV;
        "pkg-0.3.5+1.18.2" = _CwCoEqE4;
        "pkg-0.4.5+1.19" = _ffyhJFLK;
        "pkg-0.4.6+1.19" = _lXWkAkn8;
        "pkg-0.3.6+1.18.2" = _qS9WRLIt;
        "pkg-0.4.7+1.19" = _XKzUrIlB;
        "pkg-0.3.7+1.18.2" = _kCyMtA0s;
        "pkg-0.4.8+1.19" = _ufMrFNSE;
        "pkg-0.3.8+1.18.2" = _PxYKFwn4;
        "pkg-0.4.9+1.19" = _eZkN00dD;
        "pkg-0.4.10+1.19" = _11Br3Cnz;
        "pkg-0.3.9+1.18.2" = _MRAM4IyI;
        "pkg-0.4.11+1.19.2" = _DJINiTGp;
        "pkg-0.4.12+1.19.2" = _YpfFKDg4;
        "pkg-0.3.10+1.18.2" = _9GUa3X5p;
        "pkg-0.4.13+1.19.2" = _5hSEl0lj;
        "pkg-0.4.14+1.19.2" = _yo3m7aYA;
        "pkg-0.4.15+1.19.2" = _mfhz7v7C;
        "pkg-0.3.11+1.18.2" = _SntJUKiW;
        "pkg-0.4.16+1.19.2" = _OgUIto19;
        "pkg-0.4.17+1.19.2" = _Nf77Skms;
        "pkg-0.5.0+1.19.3" = _fpCS7OLA;
        "pkg-0.6.0+1.19.4" = _kVVQsl72;
        "pkg-0.4.18+1.19.2" = _N65DMun2;
        "pkg-0.6.1+1.19.4" = _uNQVa9FD;
        "pkg-0.5.1+1.19.3" = _aBUSaJy3;
        "pkg-0.7.0+1.20.1" = _u5SK9OpK;
        "pkg-0.4.19+1.19.2" = _thwqrcKD;
        "pkg-0.3.12+1.18.2" = _O5kSrhF4;
        "pkg-0.7.1+1.20.1" = _GTUfvHVP;
        "pkg-0.7.2+1.20.1" = _OaWOJ8tA;
        "pkg-0.7.3+1.20.1" = _G0e73P8c;
        "pkg-0.7.4+1.20.1" = _jnFopquB;
        "pkg-0.7.5+1.20.1" = _rA7GY5xJ;
        "pkg-0.7.6+1.20.1" = _jewXbKzX;
        "pkg-0.7.7+1.20.1" = _gLnBXAbC;
        "pkg-0.7.8+1.20.1" = _3Nms4vt8;
        "default" = _3Nms4vt8;
    });
