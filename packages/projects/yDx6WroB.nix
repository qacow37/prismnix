...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18-fabric" = _LEpItvqX;
        "pkg-1.0.0+1.19-fabric" = _OJwDhAbC;
        "pkg-1.1.0+1.18-fabric" = _IGQ5z4Js;
        "pkg-1.1.0+1.19-fabric" = _YQdCYf4l;
        "pkg-1.1.1+1.18-fabric" = _gQpNuKby;
        "pkg-1.1.1+1.19-fabric" = _CTjxPhrB;
        "pkg-1.1.2+1.19.3-fabric" = _KNmgMhrY;
        "pkg-1.1.3+1.19.3-fabric" = _hPRxqlDa;
        "pkg-1.1.4+1.19.3-fabric" = _Stjgoqlq;
        "pkg-1.1.5+1.19.4-fabric" = _l5M35HJl;
        "pkg-1.1.5+1.19.2-fabric" = _28Zh7QS0;
        "pkg-1.1.5+1.20-fabric" = _ZFpp6mPh;
        "pkg-1.2.0+1.20.6-fabric" = _hIhYZUhj;
        "pkg-1.3.0+1.21-fabric" = _Nq1EMrUF;
        "pkg-1.2.1+1.20.6-fabric" = _KyPslq3D;
        "pkg-1.3.1+1.21-fabric" = _KqvQei35;
        "pkg-1.3.2+1.21-fabric" = _oXVEudzm;
        "pkg-1.2.2+1.20.6-fabric" = _iXUgbPM4;
        "pkg-1.4.0+1.21.8" = _czQlkhDh;
        "pkg-1.4.0+1.21.11" = _dnbqdVAb;
