...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _mbvv27BK;
        "pkg-1.0.9" = _L6fnP3xg;
        "pkg-1.0.10" = _rL8PIx1w;
        "pkg-1.0.11" = _5miKBQVl;
        "pkg-1.0.12" = _ouWVuJYL;
        "pkg-1.0.13" = _z6XRlQDr;
        "pkg-1.0.14" = _SbHxRGlt;
        "pkg-1.0.15" = _UyyZ7EO7;
        "pkg-1.0.16" = _FKfXq5hI;
        "pkg-1.0.17" = _NkF9qBOP;
        "pkg-1.0.18" = _8S6jtvLq;
        "pkg-1.0.19" = _kwsCv5ih;
        "pkg-1.0.20" = _ZW2YDeII;
        "pkg-1.0.21" = _sFROQbvz;
        "pkg-1.0.22" = _uOPMsnqO;
        "pkg-1.0.23" = _YVztuEK9;
        "default" = _YVztuEK9;
    });
