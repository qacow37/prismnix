...
let
    ...
    in {
        ...
        "pkg-1.3.43" = _blUbkOTT;
        "pkg-2.0.72" = _eXEHM4NK;
        "pkg-2.0.73" = _VWMlDSm4;
        "pkg-2.0.74" = _Z5q9KzJh;
        "pkg-2.0.75" = _YeFu9g4R;
        "pkg-2.1.0-alpha.1" = _ES1Ja5Y2;
        "pkg-2.1.0-alpha.2" = _I5OYRdMg;
        "pkg-2.1.0-alpha.3" = _M0gwPmz5;
        "pkg-2.1.0-alpha.4" = _z8iWHYtT;
        "pkg-2.1.0-alpha.5" = _XrxQJGHT;
        "pkg-2.1.0-beta.1" = _wV1yzPDj;
        "pkg-2.1.0-beta.2" = _TNmEGeVj;
        "pkg-2.1.0-beta.3" = _t6RFJnMg;
        "pkg-2.1.0-beta.4" = _CZFdEpa3;
        "pkg-2.1.0" = _9C7LRK04;
        "pkg-2.1.1" = _xp27BzFX;
        "pkg-2.1.2" = _HUHd6tfG;
        "pkg-2.1.3" = _Ws55Nqt1;
        ...
        "pkg-2.1.8" = _dnNuIOcw;
        "pkg-2.1.9" = _SBMguWgE;
        "pkg-2.1.10" = _9QuGLJMO;
        "pkg-2.1.11" = _9jn121rT;
        "pkg-2.1.12" = _TPDJF8aQ;
        "pkg-2.1.13" = _8UjzSuck;
        "pkg-2.1.14" = _hcsVrfST;
        "pkg-2.1.15" = _nhiMbutY;
        "pkg-2.1.16" = _YtrrjfWY;
        "pkg-2.1.17" = _HyorbFxH;
        "pkg-2.1.18" = _2s3KP3MM;
        "pkg-2.1.19" = _Eje4cRwS;
        "pkg-2.1.20" = _WwUnqbgk;
        "pkg-2.1.21" = _DEyIYIrP;
        "pkg-2.1.22" = _b0jJasuV;
        "pkg-2.1.23" = _tdrzHjoW;
        "pkg-2.1.24" = _HlUiSWvC;
        "pkg-2.1.25" = _8MrS6vpH;
        "pkg-2.1.26" = _k8PxEwJC;
        "pkg-2.1.27" = _d3tEKdH2;
        "pkg-2.1.28" = _871fUzz7;
        "pkg-2.1.29" = _hjOBO3Hp;
        "pkg-2.1.30" = _o2Z6JjwX;
        "pkg-2.1.32" = _b3UyB3Yq;
        "pkg-2.1.33" = _uJgGeNEY;
        "pkg-2.1.34" = _qGhHJv6H;
        "pkg-2.1.35" = _b2vz7YpZ;
        "pkg-2.1.36" = _yezkkXsZ;
        "pkg-2.1.37" = _fB0LmHnR;
        "pkg-3.0.0-beta.5" = _AypjeTIS;
        "pkg-3.0.0-beta.6" = _MhsrXGlz;
        "pkg-3.0.0-beta.7" = _JzqZsPKT;
        "pkg-3.0.0-beta.8" = _zEtbtd9N;
        "pkg-3.0.0-beta.9" = _VNX54G8H;
        "pkg-3.0.0-beta.10" = _N029A94N;
        "pkg-3.0.0-beta.11" = _6IQCIiui;
        "pkg-3.0.0-beta.12" = _j8pHMIY2;
        "pkg-3.0.0-beta.13" = _esR9gGEe;
        "pkg-3.0.0.14" = _FNz7E2CT;
        "pkg-3.0.0.15" = _htgQBITz;
        "pkg-3.0.0.16" = _IdnrbQUL;
        "pkg-3.0.0.17" = _PliJVHhd;
        "pkg-3.0.0.18" = _UdvBWLsI;
        "pkg-3.0.0.19" = _aerNChHz;
        "pkg-3.0.0.20" = _YyVsXArD;
        "pkg-3.0.0.21" = _OUchGva4;
        "pkg-3.0.0.22" = _SytIeSKM;
        "pkg-3.0.0.23" = _FdCZ5Rxq;
        "default" = _FdCZ5Rxq;
    });
