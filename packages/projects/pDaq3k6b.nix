...
let
    ...
    in {
        ...
        "pkg-1.9.3" = _fGPzbZx1;
        "pkg-1.9.5" = _3iIjtwm5;
        "pkg-1.10.0" = _J6TYde7i;
        "pkg-1.10.1" = _gQVoLcar;
        "pkg-1.10.1-snapshot-25b9071" = _zmSAaMD0;
        "pkg-1.10.2-snapshot-32ffb2b" = _r3RlQoSg;
        "pkg-1.10.2" = _Tt94D1r3;
        "pkg-1.10.3-snapshot-2d1665b" = _sYeAm5pm;
        "pkg-1.10.3" = _ajpP0YT8;
        "pkg-1.10.4" = _c16fUz0r;
        "pkg-1.10.4-snapshot-400bec5" = _5I5WT6rN;
        "pkg-1.10.4-snapshot-b964b42" = _TqKfFDjC;
        "pkg-1.10.5-snapshot-55b336a" = _I43oj71q;
        "pkg-1.10.5" = _pZBUfBRH;
        "pkg-1.10.6" = _IrN0dFZp;
        "pkg-1.11.0-snapshot-020afff" = _g7XRGpPK;
        "pkg-1.11.0" = _4ZllXTbU;
        "pkg-1.11.1-snapshot-70d08c6" = _DXj934hB;
        "pkg-1.11.1" = _GXjZL9P5;
        "pkg-1.11.1-snapshot-e31592f" = _7hqI49N1;
        "pkg-1.11.1-snapshot-6ce9e8f" = _EvluvKtF;
        "pkg-1.11.2-snapshot-8cef18c" = _4D5D66if;
        "pkg-1.11.2" = _FiOIhR63;
        "pkg-1.11.2-snapshot-f443de5" = _EUbciogC;
        "pkg-1.11.2-snapshot-e4ef7ad" = _PjJCe85f;
        "pkg-1.11.3" = _1iyn2wR2;
        "pkg-1.11.3-snapshot-f2de46b" = _xiKMQXVd;
        "pkg-1.12.0-snapshot-849ab75" = _PUBQ2bXp;
        "pkg-1.12.0" = _LHSxqnqZ;
        "pkg-1.12.1-snapshot-72667df" = _9SXnguh9;
        "pkg-1.12.1" = _6Bmv34lZ;
        "pkg-1.12.1-snapshot-b0cc7d4" = _fhLyQvyP;
        "pkg-1.12.1-snapshot-2fb56cf" = _MnED5T0F;
        "pkg-1.13.0-snapshot-062da55" = _Xa9WGSdJ;
        "pkg-1.13.0" = _d8xkIRlt;
        "pkg-1.13.2-snapshot-fb1f499" = _CzmD9UTF;
        "pkg-1.13.2" = _HFzYIWL4;
        "pkg-1.13.3-snapshot-20f148e" = _EQyBSWSp;
        "pkg-1.13.3" = _L4gTyGkl;
        "pkg-1.13.3-snapshot-f13a5bf" = _bWK2owni;
        "pkg-1.14.0" = _rNv5XjYT;
        "pkg-1.14.0-snapshot-f1f4285" = _lxKp8fuL;
        "pkg-1.14.1-snapshot-d24a80a" = _5el6UxjJ;
        "pkg-1.14.1-snapshot-9c47c48" = _pL0h3pcZ;
        "pkg-1.14.1" = _nd3cMmiB;
        "pkg-1.14.2-snapshot-a1b8f9c" = _Opcp99U1;
        "pkg-1.14.2-snapshot-d475730" = _ccqt4das;
        "pkg-1.14.2-snapshot-cacd6bc" = _o3cbjVsO;
        "pkg-1.14.2-snapshot-a9dd0d1" = _ha6rRSzV;
        "pkg-1.14.2" = _hIf4dfhB;
        "pkg-1.14.2-snapshot-4333e2a" = _BQYkC1FB;
        "pkg-1.15.0-snapshot-7da589b" = _pprUbyjw;
        "pkg-1.15.0" = _XcFZ42DL;
        "pkg-1.15.1-snapshot-92a06b8" = _nOOwGdL7;
