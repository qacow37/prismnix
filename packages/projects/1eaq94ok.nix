...
let
    ...
    in {
        ...
        "pkg-1.19.4-1.0" = _A1TXFL2p;
        "pkg-1.19.4-1.0.1" = _jGN06KQl;
        "pkg-1.20.1-1.0.1-neoforge" = _Q9Ek6EKB;
        "pkg-r1.20.1-1.0-neoforge" = _K76lxVQU;
        "pkg-r1.19.2-1.0" = _ENjPVs9V;
        "pkg-r1.19.4-1.0" = _C9Tr7eBZ;
        "pkg-1.19.2-1.0.1" = _4XwFCFML;
        "pkg-1.0.1" = _3p5XMJvt;
        "pkg-1.0.0" = _wSvpPEr3;
        "default" = _wSvpPEr3;
    });
