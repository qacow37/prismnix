...
let
    ...
    in {
        ...
        "pkg-1.18.1-2.0.0" = _3Rouvlj1;
        "pkg-1.18.1-2.0.1" = _imLtfA4H;
        "pkg-1.18.1-2.0.2" = _40Vr3jGs;
        "pkg-1.18.2-2.1.0" = _AOy9pMXs;
        "pkg-1.18.2-2.1.1" = _rHgVrYIo;
        "pkg-0.7.1" = _EESuCcez;
        "pkg-1.14.4-1.2-final" = _M6zFPlfc;
        "pkg-1.15.2-1.2.3" = _v32AcnLI;
        "pkg-1.16.5-1.8.4" = _72FfK2hy;
        "pkg-1.18.2-2.1.2" = _lnnIuAXU;
        "pkg-1.19.2-3.0.0" = _9x25TpzF;
        "pkg-1.19.2-3.0.1" = _vXDYFovJ;
        "pkg-1.20.1-4.0.0" = _z3vLj70R;
        "pkg-1.20.1-4.0.1" = _5dSS3paW;
        "pkg-1.19.2-3.0.2" = _Eaf1l30L;
        "pkg-1.20.1-4.0.2" = _aBZ10ONK;
        "pkg-1.20.1-4.0.3" = _o5hoPPK5;
        "pkg-1.20.1-4.0.4" = _Hd4YjKkM;
        "pkg-1.20.1-4.0.5" = _sCJhPEzm;
        "pkg-1.18.2-2.1.3" = _D72qLiks;
        "pkg-1.19.2-3.0.3" = _LgjjTzUe;
        "pkg-0.1" = _QJuzw9TR;
        "pkg-0.2" = _b6Jso2lm;
        "pkg-0.3" = _2BZKcB0R;
        "pkg-0.4" = _ycuMOUkm;
        ...
        "pkg-0.6.1" = _H9mmvOYv;
        "pkg-0.7" = _tSqLHens;
        "pkg-1.14.4-1.0.1" = _piyHgGR3;
        "pkg-1.14.4-1.0.2" = _EYNDPKqV;
        "pkg-1.14.4-1.0.3" = _OuxZQ2A6;
        "pkg-1.14.4-1.1.0" = _U2aPCJw5;
        "pkg-1.14.4-1.1.1" = _QaVohTeI;
        "pkg-1.2" = _SkOA1WN8;
        "pkg-1.2.1" = _pNkdVP20;
        "pkg-1.2.2" = _BIS9id2T;
        "pkg-1.3" = _dHfVMaWi;
        ...
        "pkg-1.4.2" = _BegDP0xy;
        "pkg-1.4.3" = _Yogy1Xic;
        "pkg-1.16.4-1.5.0" = _Sdyk4TNk;
        "pkg-1.16.4-1.6.0" = _hS7N5UbK;
        "pkg-1.16.4-1.7.0" = _OWykGVLb;
        "pkg-1.16.4-1.7.1" = _RpLPaaju;
        "pkg-1.16.4-1.7.2" = _PQDniHKm;
        "pkg-1.16.4-1.7.3" = _z8tiqGxf;
        "pkg-1.16.4-1.7.4" = _F2wwYXWa;
        "pkg-1.16.4-1.7.5" = _Sz7P9tmP;
        "pkg-1.16.4-1.7.6" = _1tfL4ZrX;
        "pkg-1.16.5-1.8.0" = _SyMgI5V8;
        "pkg-1.16.5-1.8.1" = _sw9wXm4b;
        "pkg-1.16.5-1.8.2" = _R36R11NO;
        "pkg-1.16.5-1.8.3" = _eTya7on4;
        "pkg-1.20.1-4.0.6" = _cjprVBKN;
        "pkg-1.20.1-4.0.7" = _6uTpjHc9;
        "pkg-1.20.1-4.0.8" = _NIprzMla;
        "default" = _NIprzMla;
    });
