...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _iqQSBhAO;
        "pkg-1.0.9" = _7MTxGHmr;
        "pkg-1.0.10" = _3WmH18x0;
        "pkg-1.0.11" = _F14feS2m;
        "pkg-1.0.12" = _W52hPmZI;
        "pkg-1.0.13" = _dAv2C7AU;
        "pkg-1.0.14" = _Ip7elPTX;
        "pkg-1.0.15" = _s7C40uu1;
        "pkg-1.0.16" = _qhZQSkCT;
        "pkg-1.0.17" = _O8ORdH34;
        "pkg-1.0.18" = _kEezbMMD;
        "pkg-1.0.19" = _82usAmPC;
        "pkg-1.0.20" = _XXfgi31t;
        "pkg-1.0.21" = _e6cqGL5B;
        "pkg-1.0.22" = _3mCHjUud;
        "pkg-1.0.23" = _otwfER6s;
        "pkg-1.1.0" = _6foTUBMF;
        "default" = _6foTUBMF;
    });
