...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.1" = _tnEThpXc;
        "pkg-1.0.0+1.21.1" = _TTWztCSK;
        "pkg-1.0.1+1.21.1" = _PFoVIIik;
        "pkg-1.0.1+1.20.1" = _RBGncB99;
        "pkg-1.0.2+1.21.1-POLYMER" = _Nj7RzAwT;
        "pkg-1.1.0+1.20.1" = _MX8DtqTb;
        "pkg-1.1.1+1.21.1-POLYMER" = _1pAfe6Fg;
        "pkg-1.1.1+1.20.1" = _1OCvzRtD;
        "pkg-1.1.2+1.21.4-POLYMER" = _jGF6XDhD;
        "pkg-1.1.2+1.20.1" = _GTwkS1wQ;
        "pkg-1.1.2.1+1.21.4-POLYMER" = _Pjdq3Zj6;
        "pkg-1.1.3+1.20.1" = _7XHFnu2Z;
        "pkg-1.1.3+1.21.4-POLYMER" = _3Rngfsst;
        "pkg-1.1.4+1.20.1" = _R2JnyLz7;
        "pkg-1.2.0+1.20.1" = _PQe24cXm;
        "pkg-1.2.0.1+1.20.1" = _MptVd5Wb;
        "pkg-1.2.1.1+1.20.1" = _sXt2ou74;
        "pkg-1.2.1+1.21.4-POLYMER" = _IdlbvB3E;
        "pkg-1.3+1.20.1" = _7eTGvtMD;
        "pkg-1.3.1+1.20.1" = _JDDF6Uw2;
        "pkg-1.3.1+1.21.4-POLYMER" = _lPiosiex;
        "pkg-1.3.2+1.21.4-POLYMER" = _Qe4HUJFI;
        "pkg-1.3.3+1.21.6-POLYMER" = _lRMONmzY;
        "pkg-1.3.3+1.21.4-POLYMER" = _XXE90iEY;
        "pkg-1.3.4+1.21.4-POLYMER" = _60OLem15;
        "pkg-1.3.5+1.21.1-POLYMER" = _EaMFrfSu;
        "pkg-1.3.5+1.21.4-POLYMER" = _pCr3FxHY;
        "pkg-1.3.5+1.21.6-POLYMER" = _vkW0ZGkK;
        "pkg-1.3.6+1.21.1" = _mtw2GmGU;
        "pkg-1.3.7+1.21.1" = _Iky4Ph2U;
        "pkg-1.3.8+1.21.1" = _deshfqnx;
        "pkg-1.3.9+1.21.1" = _2kOssn77;
        "pkg-1.3.10+1.21.1" = _A3fsz5A9;
        "pkg-1.4+1.21.1" = _kB6fFAmv;
        "pkg-1.4.1+1.21.1" = _Ho9Zd2Hy;
        "pkg-1.4.2+1.21.1" = _CZVnM7xO;
        "default" = _CZVnM7xO;
    });
