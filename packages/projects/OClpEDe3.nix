...
let
    ...
    in {
        ...
        "pkg-mc1.19-3.0.3-fabric" = _Zx1LYcmu;
        "pkg-mc1.18.2-3.0.4-fabric" = _8m919M1N;
        "pkg-mc1.19-3.0.4-fabric" = _GSyoAAod;
        "pkg-3.0.5-mc-1.18.2" = _2K9vXLK5;
        "pkg-3.0.5-mc-1.19" = _T9ZSfoGw;
        "pkg-4.0.0+1.18.2" = _ccJKFIDi;
        "pkg-4.0.0+1.19.2" = _zIj3HnBI;
        "pkg-4.0.0+1.19.3" = _FKxKSN3S;
        "pkg-4.0.1+1.19.2" = _XjM0hjz9;
        "pkg-4.0.1+1.18.2" = _OcZAklfh;
        "pkg-4.0.1+1.19.3" = _cKn2SRkT;
        "pkg-4.0.1+1.20-rc1" = _R6C8dehq;
        "pkg-4.0.2+1.20.1" = _EEYON8Ln;
        "pkg-4.0.3+1.20.1" = _63iVAck0;
        "pkg-4.1.0+1.20.2" = _VANgEKd3;
        "pkg-4.1.1+1.20.2" = _mSu8IKGZ;
        "pkg-4.1.2+1.20.2" = _VvbAYSM6;
        "pkg-4.1.2+1.20.1" = _BeVW8b1q;
        "pkg-4.1.2+1.20.5" = _ivSF6cFA;
        "pkg-4.1.2+1.21" = _aRI6Him0;
        "pkg-4.2.0+1.21" = _jEs87LQS;
        "pkg-4.3.0+1.21.1" = _pYtvSDgO;
        "pkg-4.3.0+1.21.2-rc2" = _777HwLSa;
        "pkg-4.3.1+1.21.3" = _7svfiGCY;
        "pkg-4.3.1+1.21.4" = _RduCvcfn;
        "pkg-4.3.2+1.21.4" = _pG6lgHNQ;
        "pkg-4.3.2+1.21.5-rc1" = _UewePsgD;
        "pkg-4.3.3+1.21.5" = _CR1rRBBL;
        "pkg-4.3.4+1.21.5" = _sMKjokaU;
        "pkg-4.3.4+1.21.4" = _DseL7bWS;
        "pkg-4.3.4+1.21.1" = _rsxOGr7L;
        "pkg-4.3.5+1.21.6-rc1" = _Cg01Zbuu;
        "pkg-4.3.5+1.21.4" = _2aReBXRx;
        "pkg-4.3.5+1.21.1" = _svHWCYBe;
        "pkg-neoforge-4.4.0+1.21.6" = _VWvcStVd;
        "pkg-neoforge-4.4.0+1.21.4" = _aEkH755m;
        "pkg-neoforge-4.4.0+1.21.1" = _XBE1chAg;
        "pkg-fabric-4.4.0+1.21.6" = _ZQ73fOeo;
        "pkg-fabric-4.4.0+1.21.4" = _tqWj4foj;
        "pkg-fabric-4.4.0+1.21.1" = _UneNMsX5;
        "pkg-neoforge-4.4.1+1.21.6" = _iYs94HsX;
        "pkg-neoforge-4.4.1+1.21.4" = _mIjtH2kO;
        "pkg-neoforge-4.4.1+1.21.1" = _gArxweZD;
        "pkg-fabric-4.4.1+1.21.6" = _UzXYtrGx;
        "pkg-fabric-4.4.1+1.21.4" = _Qy2KjaLc;
        "pkg-fabric-4.4.1+1.21.1" = _7Wlnff65;
        "pkg-neoforge-4.4.2+1.21.6" = _jirPpDYC;
        "pkg-neoforge-4.4.2+1.21.4" = _O4QDzeKf;
        "pkg-neoforge-4.4.2+1.21.1" = _FQTq5nE1;
        "pkg-neoforge-4.4.3+1.21.1" = _FPTFY4WR;
        "pkg-neoforge-4.4.3+1.21.4" = _3X9gSfFN;
        "pkg-neoforge-4.4.3+1.21.6" = _PpPWXn4Y;
        "pkg-neoforge-4.4.4+1.21.6" = _uv0kYc7T;
        "pkg-neoforge-4.4.4+1.21.4" = _9STASlCQ;
        "pkg-neoforge-4.4.4+1.21.1" = _kYLFT4TJ;
        "pkg-fabric-4.4.4+1.21.6" = _YgE1ejh9;
        "pkg-fabric-4.4.4+1.21.4" = _1c8OdT23;
        "pkg-fabric-4.4.4+1.21.1" = _mIQMys5d;
        "pkg-neoforge-4.4.5+1.21.1" = _xZoLiW0G;
        "pkg-fabric-4.4.6+1.21.1" = _vfEmrxIP;
        "pkg-fabric-4.4.6+1.21.4" = _6ho0VYj8;
        "pkg-fabric-4.4.6+1.21.8" = _EBzOMtvT;
        "pkg-neoforge-4.4.6+1.21.1" = _qFUlPpvY;
        "pkg-neoforge-4.4.6+1.21.4" = _Ni4MYNOY;
        "pkg-neoforge-4.4.6+1.21.8" = _AgjPcDwG;
        "pkg-fabric-4.4.7+1.21.1" = _mApdNENX;
        "pkg-fabric-4.4.7+1.21.4" = _ACF9nUMa;
        "pkg-fabric-4.4.7+1.21.8" = _kejT1GAL;
        "pkg-neoforge-4.4.7+1.21.1" = _qvtzJk0M;
        "pkg-neoforge-4.4.7+1.21.4" = _ZQq10deM;
        "pkg-neoforge-4.4.7+1.21.8" = _rEPExAJY;
        "pkg-fabric-4.4.7+1.21.9-rc1" = _Z4idGCRX;
        "pkg-fabric-4.4.8+1.21.1" = _eHUSvycX;
        "pkg-fabric-4.4.8+1.21.8" = _TY3PMylP;
        "pkg-fabric-4.4.8+1.21.4" = _RFhMPzA9;
        "pkg-fabric-4.4.8+1.21.9" = _LMQh4dbp;
        "pkg-neoforge-4.4.8+1.21.1" = _ffAz6LYn;
        "pkg-neoforge-4.4.8+1.21.4" = _BwUDvbhL;
        "pkg-neoforge-4.4.8+1.21.8" = _lP8W862y;
        "pkg-fabric-4.4.9+1.21.1" = _5U3H12rA;
        "pkg-fabric-4.4.9+1.21.4" = _m6Fe3F4n;
        "pkg-fabric-4.4.9+1.21.8" = _RFjXqqKZ;
        "pkg-fabric-4.4.9+1.21.9" = _UxHTTzEe;
        "pkg-neoforge-4.4.9+1.21.1" = _v9xxRrPa;
        "pkg-neoforge-4.4.9+1.21.4" = _4hMvoghx;
        "pkg-neoforge-4.4.9+1.21.8" = _tG2cGN3j;
        "pkg-neoforge-4.4.9+1.21.9" = _3fP37qLv;
        "pkg-fabric-4.4.10+1.21.1" = _xpN52a70;
        "pkg-fabric-4.4.10+1.21.4" = _ILrTbD2l;
        "pkg-fabric-4.4.10+1.21.8" = _p9pAsnQb;
        "pkg-fabric-4.4.10+1.21.9" = _hWsuh3x9;
        "pkg-neoforge-4.4.10+1.21.1" = _mf4R0qzD;
        "pkg-neoforge-4.4.10+1.21.4" = _Ddg24Rme;
        "pkg-neoforge-4.4.10+1.21.8" = _bOEYff0h;
        "pkg-neoforge-4.4.10+1.21.9" = _DdejhLNl;
        "pkg-fabric-4.4.11+1.21.1" = _NrdtFS0f;
        "pkg-fabric-4.4.11+1.21.4" = _ewEuw4UY;
        "pkg-neoforge-4.4.11+1.21.1" = _XUyPjJPm;
        "pkg-neoforge-4.4.11+1.21.4" = _IDxpPnna;
        "pkg-fabric-4.5.0+1.21.1" = _k6hfcusa;
        "pkg-fabric-4.5.0+1.21.10" = _6arQpdPr;
        "pkg-fabric-4.5.0+1.21.11-pre5" = _L0hWA43x;
        "pkg-fabric-4.5.0+1.21.4" = _LrM75MiY;
        "pkg-fabric-4.5.0+1.21.8" = _nkNeGbqL;
        "pkg-neoforge-4.5.0+1.21.1" = _rgCiSvds;
        "pkg-neoforge-4.5.0+1.21.10" = _FUpPOiqS;
        "pkg-neoforge-4.5.0+1.21.4" = _9eu2BM1j;
        "pkg-neoforge-4.5.0+1.21.8" = _tHGUNx5R;
        "pkg-fabric-4.5.1+1.21.1" = _XjQr9x5a;
        "pkg-fabric-4.5.1+1.21.10" = _E9QUc9cQ;
        "pkg-fabric-4.5.1+1.21.11-pre5" = _bpSUQMSI;
        "pkg-fabric-4.5.1+1.21.4" = _3d4KKOf0;
        "pkg-fabric-4.5.1+1.21.8" = _ZbbBf9O7;
        "pkg-neoforge-4.5.1+1.21.1" = _A5jrA5T5;
        "pkg-neoforge-4.5.1+1.21.10" = _oWPNzpBG;
        "pkg-neoforge-4.5.1+1.21.4" = _uoQTR2AC;
        "pkg-neoforge-4.5.1+1.21.8" = _A5YKrpAJ;
        "pkg-fabric-4.5.2+1.21.1" = _sUeX84bR;
        "pkg-fabric-4.5.2+1.21.10" = _c6dCznSC;
        "pkg-fabric-4.5.2+1.21.11" = _UqkyKJPh;
        "pkg-fabric-4.5.2+1.21.4" = _UKpaS65I;
        "pkg-fabric-4.5.2+1.21.8" = _ghwoyr1k;
        "pkg-neoforge-4.5.2+1.21.1" = _6AZJSBpC;
        "pkg-neoforge-4.5.2+1.21.10" = _IVEjIDoS;
        "pkg-neoforge-4.5.2+1.21.11" = _AkPJyKoc;
        "pkg-neoforge-4.5.2+1.21.4" = _mYjpFd49;
        "pkg-neoforge-4.5.2+1.21.8" = _m7G6oz65;
        "pkg-fabric-4.5.2+26.1" = _jdMo63Hr;
        "pkg-neoforge-4.5.2+26.1" = _jBRYn8Fj;
        "pkg-neoforge-4.5.3+26.1" = _69mYPA6h;
        "pkg-fabric-4.5.3+26.1" = _XInw8KQi;
        "pkg-neoforge-4.5.4+26.1.2" = _KMLVshD2;
        "pkg-neoforge-4.5.5+26.1.2" = _9ArwKVV3;
        "pkg-fabric-4.5.5+26.1.2" = _p7tZbzKC;
        "pkg-fabric-4.5.6+26.1.2" = _N9ht9LUm;
        "pkg-neoforge-4.5.6+26.1.2" = _4vu8a1Kp;
        "pkg-fabric-4.5.3+1.21.1" = _q81dxdjT;
        "pkg-fabric-4.5.3+1.21.10" = _70ENwxEc;
        "pkg-fabric-4.5.3+1.21.11" = _VI90Hyf2;
        "pkg-fabric-4.5.3+1.21.4" = _3WiWuhcN;
        "pkg-fabric-4.5.3+1.21.8" = _T77ZTq9H;
        "pkg-neoforge-4.5.3+1.21.1" = _bMBLHCvH;
        "pkg-neoforge-4.5.3+1.21.10" = _gR8Q8ZnD;
        "pkg-neoforge-4.5.3+1.21.11" = _dls7a7f0;
        "pkg-neoforge-4.5.3+1.21.4" = _8FCOUGQc;
        "pkg-neoforge-4.5.3+1.21.8" = _jqT0N2Gt;
        "pkg-fabric-4.5.7+26.1.2" = _4vPNLj4a;
        "pkg-fabric-4.5.7+26.2-rc-2" = _SU1yfqu5;
        "pkg-neoforge-4.5.7+26.1.2" = _HhIZK6su;
        "pkg-fabric-4.5.4+1.21.1" = _sb4XIWwK;
        "pkg-fabric-4.5.4+1.21.10" = _odwn993y;
        "pkg-fabric-4.5.4+1.21.11" = _cVsVnS2u;
        "pkg-fabric-4.5.4+1.21.4" = _qpU3nyj3;
        "pkg-fabric-4.5.4+1.21.8" = _dNoKazRs;
        "pkg-neoforge-4.5.4+1.21.1" = _GqDtZulf;
        "pkg-neoforge-4.5.4+1.21.10" = _YjQPwSWf;
        "pkg-neoforge-4.5.4+1.21.11" = _sSNVgCBO;
        "pkg-neoforge-4.5.4+1.21.4" = _buwyggLn;
        "pkg-neoforge-4.5.4+1.21.8" = _wELPk3e9;
