...
let
    ...
    in {
        ...
        "pkg-0.0.1" = _FGRAgI8x;
        "pkg-0.0.2-neoforge" = _ruSjPTFW;
        "pkg-0.0.2-paper" = _hK4CQKWm;
        "pkg-0.0.2-spigot" = _QycYuMmz;
        "pkg-0.0.2-velocity" = _7oZQXjqh;
        "pkg-0.0.2-fabric" = _2QG8NDvD;
        "pkg-0.3.0-neoforge" = _ZBrR9a8A;
        "pkg-0.3.0-paper" = _6lbS41EA;
        "pkg-0.3.0-spigot" = _pygzhwyS;
        "pkg-0.3.0-velocity" = _BdtCgxdG;
        "pkg-0.3.0-fabric" = _11ZTLeAY;
        "pkg-0.4.0-fabric" = _4K3pvvKD;
        "pkg-0.4.0-neoforge" = _sn8WOPxv;
        "pkg-0.4.0-paper" = _GVqWB2Az;
        "pkg-0.4.0-spigot" = _9pqevfcI;
        "pkg-0.4.0-velocity" = _vF5FWJge;
        "pkg-0.4.1-neoforge" = _2IzP8bPV;
        "pkg-0.4.1-fabric" = _Xxu0GmyM;
        "pkg-0.4.2-neoforge" = _1KHTviIU;
        "pkg-0.4.2-paper" = _eACRpBxN;
        "pkg-0.4.2-spigot" = _zz89Tv6m;
        "pkg-0.4.2-velocity" = _tJ7QTwZu;
        "pkg-0.4.2-fabric" = _tviJrby0;
        "pkg-0.4.3-velocity" = _CIHk87GF;
        "pkg-0.4.4-velocity" = _OAFVMpor;
        "pkg-0.4.5-fabric" = _JJ32qx60;
        "pkg-0.4.5-paper" = _w54RxprF;
        "pkg-0.4.5-spigot" = _wqzHqf8P;
        "pkg-0.4.5-velocity" = _Gxj441Iw;
        "pkg-0.4.5-neoforge" = _toe4Mig5;
        "pkg-0.5.0-fabric-1.21.11" = _HwP4fKBf;
        "pkg-0.5.0-fabric-1.20-1.21.10" = _KG5clXPE;
        "pkg-0.5.0-neoforge-1.21.11" = _JVL8voMq;
        "pkg-0.5.0-neoforge-26.1" = _hyivKMIn;
        "pkg-0.5.0-neoforge-1.20.4-1.21.10" = _9pi8I8EW;
        "pkg-0.5.0-paper" = _GBv8EmkO;
        "pkg-0.5.0-spigot" = _cCqQOsUT;
        "pkg-0.5.0-velocity" = _K4KTh6l5;
        "pkg-0.5.0-fabric-26.1" = _E7YC8CP9;
        "pkg-0.5.1-paper-paper" = _ryMC476c;
        "pkg-0.5.1-spigot-spigot" = _ZaqyKD70;
        "pkg-0.5.1-velocity-velocity" = _9HuZMyYd;
        "pkg-0.5.1-1.14.4-fabric" = _RfC0l499;
        "pkg-0.5.1-1.15-fabric" = _EvcoU2TF;
        "pkg-0.5.1-1.16-fabric" = _oZIn1Tbc;
        "pkg-0.5.1-1.17-fabric" = _g50S5cVN;
        "pkg-0.5.1-1.18-fabric" = _Ads7xCLk;
        "pkg-0.5.1-1.19-fabric" = _oDIk3ssa;
        "pkg-0.5.1-1.20-fabric" = _BJTB5Wto;
        "pkg-0.5.1-1.21.11-fabric" = _FECLqhrv;
        "pkg-0.5.1-1.20.4-neoforge" = _jDWrCUSh;
        "pkg-0.5.1-26.1.2-fabric261" = _p4PAdKku;
        "pkg-0.5.1-1.21.11-neoforge" = _NMICQUyg;
        "pkg-0.5.1-26.1-neoforge" = _H2mIvhmj;
        "pkg-0.5.1-26.1.1-neoforge" = _FUWq3K9s;
        "pkg-0.5.1-26.1.2-neoforge" = _M5ImIG4k;
        "pkg-0.5.1-26.1-fabric261" = _wUg4x6Vu;
        "pkg-0.5.1-26.1.1-fabric261" = _PGJQcmLS;
        "pkg-0.5.1-26.2-fabric261" = _PdacOZFK;
        "pkg-0.5.1-26.2-neoforge" = _bscz4sZS;
        "default" = _bscz4sZS;
    });
