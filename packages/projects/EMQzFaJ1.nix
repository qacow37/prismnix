...
let
    ...
    in {
        ...
        "pkg-1.3.8" = _KH9gf1RD;
        "pkg-1.3.9" = _Cv6CsjrW;
        "pkg-1.3.10" = _WeqrjeAN;
        "pkg-1.3.11" = _yb3oQiLl;
        "pkg-1.3.12" = _aYzomiZY;
        "pkg-2.0.0+MC-1.21" = _MYj85CNp;
        "pkg-2.0.1+MC-1.21" = _cdL4wXhZ;
        "pkg-2.0.2+MC-1.21" = _L1kTnjzG;
        "pkg-2.0.3+MC-1.21" = _P9pzXxWM;
        "pkg-2.0.4+MC-1.21" = _uu2QM76k;
        "pkg-2.0.5+MC-1.21" = _Kyc1QWvC;
        "pkg-2.0.6+MC-1.21.1" = _m08mw7Sg;
        "default" = _m08mw7Sg;
    });
