...
let
    ...
    in {
        ...
        "pkg-v20.4.0-1.20.4-Forge" = _l5mgC3AL;
        "pkg-v20.4.0-1.20.4-NeoForge" = _NdJ4SNWJ;
        "pkg-v21.1.0-1.21.1-Fabric" = _KaNh4B31;
        "pkg-v21.1.0-1.21.1-NeoForge" = _853zNSci;
        "pkg-v21.3.0-1.21.3-Fabric" = _Jx3mvgF7;
        "pkg-v21.3.0-1.21.3-NeoForge" = _nDq0gliG;
        "pkg-v21.4.0-1.21.4-Fabric" = _Uvl4NwpJ;
        "pkg-v21.4.0-1.21.4-NeoForge" = _gl1KbKrb;
        "pkg-v21.5.0-1.21.5-Fabric" = _RDYgZG7E;
        "pkg-v21.5.0-1.21.5-NeoForge" = _p03WzBcl;
        "pkg-v21.1.1-1.21.1-Fabric" = _fsBR2F6G;
        "pkg-v21.1.1-1.21.1-NeoForge" = _5XCrLkTK;
        "pkg-v21.5.1-1.21.5-Fabric" = _gF3qdD7o;
        "pkg-v21.5.1-1.21.5-NeoForge" = _uqsYsuRp;
        "pkg-v21.4.1-1.21.4-Fabric" = _3BAQMa2w;
        "pkg-v21.4.1-1.21.4-NeoForge" = _u7WVQetk;
        "pkg-v21.6.0-1.21.6-Fabric" = _XHAWqSCA;
        "pkg-v21.6.0-1.21.6-NeoForge" = _lGYdFv2G;
        "pkg-v20.1.1-1.20.1-Fabric" = _JFJ5zF5B;
        "pkg-v20.1.1-1.20.1-Forge" = _IEfCPaw9;
        "pkg-v21.6.1-1.21.6-Fabric" = _eXzTj8t6;
        "pkg-v21.6.1-1.21.6-NeoForge" = _qmTtBSJk;
        "pkg-v21.7.0-1.21.7-Fabric" = _owtrwwJi;
        "pkg-v21.7.0-1.21.7-NeoForge" = _BFz66IbY;
        "pkg-v21.5.2-1.21.5-Fabric" = _K7HINLla;
        "pkg-v21.5.2-1.21.5-NeoForge" = _YpzqLqrM;
        "pkg-v21.7.1-1.21.7-Fabric" = _tVskvWhM;
        "pkg-v21.7.1-1.21.7-NeoForge" = _pO5jP6RF;
        "pkg-v21.8.0-1.21.8-Fabric" = _D6vH889Q;
        "pkg-v21.8.0-1.21.8-NeoForge" = _4xCj4SRb;
        "pkg-v20.1.2-1.20.1-Fabric" = _vjOvXgKV;
        "pkg-v20.1.2-1.20.1-Forge" = _U3XIssnD;
        "pkg-v21.1.2-1.21.1-Fabric" = _oFDXEdZD;
        "pkg-v21.1.2-1.21.1-NeoForge" = _oNpW2PtS;
        "pkg-v21.8.1-1.21.8-Fabric" = _aFkzfUEP;
        "pkg-v21.8.1-1.21.8-NeoForge" = _4YpuR3tX;
        "pkg-v21.4.2-1.21.4-Fabric" = _Z7miaDW2;
        "pkg-v21.4.2-1.21.4-NeoForge" = _U0RW2f3M;
        "pkg-21.9.0" = _TNNsgrpi;
        "pkg-21.10.0" = _TgDSazyC;
        "pkg-v20.1.3-1.20.1-Fabric" = _xBGglNV9;
        "pkg-v20.1.3-1.20.1-Forge" = _oxYWsAHC;
        "pkg-21.11.0" = _5b6NJxlx;
