...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _sgnXSWwo;
        "pkg-0.1.1-1.20.1" = _oZHwCRf6;
        "pkg-1.20.1-0.1.2" = _BsbPeFaW;
        "pkg-1.20.6-0.1.3" = _uga7nk16;
        "pkg-1.18.2-0.1.2" = _JFwPvRrC;
        "pkg-1.16.5-0.1.4" = _Nw2QPHoC;
        "pkg-1.20.6-0.1.4" = _vpz052gq;
        "pkg-1.20.1-0.1.4" = _J1Epb5BR;
        "pkg-1.20.1-0.1.5" = _BHxazH6B;
        "pkg-1.21-0.1.5" = _cxJVfotF;
        "pkg-1.21-0.1.5-fix" = _nY9EXZoF;
        "pkg-1.20.6-0.1.5" = _c1Bs0pZz;
        "pkg-1.20.1-0.1.6" = _9Wx5Ud3F;
        "pkg-1.20.4-0.1.6" = _ycibsFCC;
        "pkg-1.20.6-0.1.6" = _CB4VBe9P;
        "pkg-1.21-0.1.6" = _kwDUO9kh;
        "pkg-0.1.7-1.20.1-pre1" = _ARtMfjTE;
        "pkg-0.1.7-1.20.6-pre1" = _ZsJ5Tmix;
        "pkg-1.18.2-0.1.7" = _8BRxRTWp;
        "pkg-1.19.2-0.1.7" = _5SwhxHR5;
        "pkg-1.20.1-0.1.7" = _gYtpMEOo;
        "pkg-1.20.6-0.1.7" = _GvSE1rEq;
        "pkg-1.21-0.1.7" = _VtBRudGK;
        "pkg-1.18.2-0.1.7-1" = _4OLqQGyg;
        "pkg-1.19.2-0.1.7-1" = _286iPz4U;
        "pkg-1.20.1-0.1.7-1" = _nNUEKSgV;
        "pkg-1.20.6-0.1.7-1" = _B5tzXrEd;
        "pkg-1.21-0.1.7-1" = _wtw0lLk2;
        "pkg-1.19.2-0.1.8" = _asoThkCK;
        "pkg-1.20.1-0.1.8" = _R3DGdOpu;
        "pkg-1.20.6-0.1.8" = _9qKBlVfs;
        "pkg-1.21-0.1.8" = _RKLepOcz;
        "pkg-1.19.2-0.1.9" = _T2UdnFam;
        "pkg-1.20.1-0.1.9" = _U18DCsZo;
        "pkg-1.20.6-0.1.9" = _wz94GCb7;
        "pkg-1.21-0.1.9" = _bYb5eiME;
        "pkg-0.2.0-1.20.1" = _zVWIiAEv;
        "pkg-0.2.0-1.20.4" = _kqYkj5wm;
        "pkg-1.20.6-0.2.0" = _dwkgsAyf;
        "pkg-0.2.0-1.21" = _qXER7NMi;
        "pkg-1.7.10-0.2.1" = _uXi8touE;
        "pkg-1.12.2-0.2.1" = _HF8a5jBL;
        "pkg-0.2.1-fix-mc1.7.10" = _JeaoxKY0;
        "pkg-0.2.2-1.20.1" = _FgCuV1U9;
        "pkg-1.20.4-0.2.2" = _KBImMWBZ;
        "pkg-1.20.6-0.2.2" = _dftQRRQS;
        "pkg-1.21-0.2.2" = _E0yJbvM6;
        "pkg-0.2.3-1.16.5" = _G2Gq1EuO;
        "pkg-0.2.3-1.20.1" = _eAyIpK7I;
        "pkg-0.2.3-1.21" = _1UOg4Jzu;
        "pkg-1.20.1-0.2.4" = _NT0dFDEC;
        "pkg-1.20.4-0.2.4" = _6Q38VWkM;
        "pkg-1.21-0.2.4" = _7FJSr7Mz;
        "pkg-1.20.1-0.2.5" = _ibdl46LA;
        "pkg-1.20.6-0.2.5" = _1z1qb77a;
        "pkg-1.21-0.2.5" = _FJGakbEp;
        "pkg-0.2.6" = _y0uhk9Cv;
        "pkg-0.2.7" = _S6NY8Vxv;
        "pkg-0.2.8" = _QJFp0uco;
        "pkg-1.18.2-0.2.9" = _9drr9Uxz;
        "pkg-0.2.9-1.19.2" = _qZ0zYLuN;
        "pkg-1.19.4-0.2.9" = _MU8Cn2yd;
        "pkg-0.2.10" = _6BB7AN5C;
        "default" = _6BB7AN5C;
    });
