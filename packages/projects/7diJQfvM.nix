...
let
    ...
    in {
        ...
        "pkg-v20.4.0-1.20.4-Fabric" = _riZJAMwY;
        "pkg-v20.4.0-1.20.4-NeoForge" = _ALE0dmqL;
        "pkg-v21.1.0-1.21.1-Fabric" = _7RnxZRew;
        "pkg-v21.1.0-1.21.1-NeoForge" = _vJUUjK3C;
        "pkg-v21.3.0-1.21.3-Fabric" = _HHwn4k6P;
        "pkg-v21.3.0-1.21.3-NeoForge" = _Lz6efU7f;
        "pkg-v21.4.0-1.21.4-Fabric" = _8WnXrzeI;
        "pkg-v21.4.0-1.21.4-NeoForge" = _Ex0EFflM;
        "pkg-v21.5.0-1.21.5-Fabric" = _OTR7xx9s;
        "pkg-v21.5.0-1.21.5-NeoForge" = _LxokmEpq;
        "pkg-v21.7.0-1.21.7-Fabric" = _rTpidFEp;
        "pkg-v21.7.0-1.21.7-NeoForge" = _4dErRBw9;
        "pkg-v21.8.0-1.21.8-Fabric" = _GOL1oqsf;
        "pkg-v21.8.0-1.21.8-NeoForge" = _C7ih9dwy;
        "pkg-21.9.0" = _PZdQbLq0;
        "pkg-21.10.0" = _q2l3NRua;
        "pkg-21.11.0" = _YSVzSskA;
        "pkg-26.1.0.0" = _Zg6evfnA;
