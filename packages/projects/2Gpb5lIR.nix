...
let
    ...
    in {
        ...
        "pkg-1.0.4" = _zbiMsGGk;
        "pkg-1.1.0" = _zsCssHXT;
        "pkg-mc1.20.1-1.1.1" = _gzsowAyt;
        "pkg-mc1.18.2-1.1.1" = _LzS38OzD;
        "pkg-mc1.19-1.1.1" = _FN3HfNdw;
        "pkg-mc1.19.4-1.1.1" = _NQ8iUuKz;
        "pkg-mc1.21-2.0.0" = _9zq35GfE;
        "pkg-mc1.21-2.0.1" = _VzMcpZwF;
        "pkg-mc1.20.1-1.1.2" = _dSVqGnsT;
        "pkg-mc1.18.2-1.1.2" = _ouMPXOiQ;
        "pkg-mc1.19.4-1.1.2" = _w3WICyAi;
        "pkg-mc1.20.4-2.0.0" = _Oab2WG8J;
        "pkg-mc1.21-2.0.2" = _BxOU7PU9;
        "pkg-mc1.20.4-2.0.2" = _tKj9OVLP;
        "pkg-mc1.20.4-2.0.2a" = _yDjf1Hos;
        "pkg-mc1.20.1-1.1.3" = _LBXdd9u4;
        "pkg-mc1.19.4-1.1.3" = _2IamJlPw;
        "pkg-mc1.19-1.1.3" = _3OEkunek;
        "pkg-mc1.18.2-1.1.3" = _OnePOr36;
        "pkg-mc1.18.2-1.1.4" = _L9dZUueq;
        "pkg-mc1.19-1.1.4" = _Jpnt33SN;
        "pkg-mc1.19.4-1.1.4" = _xr4EzivS;
        "pkg-mc1.20.1-1.1.4" = _dWwP26ed;
        "pkg-mc1.20.4-2.0.3" = _LOyQXynv;
        "pkg-mc1.21-2.0.3" = _yuAHHPmv;
        "pkg-mc1.18.2-1.1.5" = _KMLerTAj;
        "pkg-mc1.19-1.1.5" = _VVWpNwVt;
        "pkg-mc1.19.4-1.1.5" = _ILPCY09R;
        "pkg-mc1.20.1-1.1.5" = _BqTCsJRk;
        "pkg-mc1.20.4-2.0.4" = _Wdlghv5x;
        "pkg-mc1.21-2.0.4" = _zyLiQ0Mz;
        "default" = _zyLiQ0Mz;
    });
