...
let
    ...
    in {
        ...
        "pkg-v21.3.0-1.21.3-NeoForge" = _jwB4aUUG;
        "pkg-v21.4.0-1.21.4-Fabric" = _D5fjjkmF;
        "pkg-v21.4.0-1.21.4-NeoForge" = _CALR2NPH;
        "pkg-v21.5.0-1.21.5-Fabric" = _jV7Wrh0x;
        "pkg-v21.5.0-1.21.5-NeoForge" = _9VgbdHx5;
        "pkg-v21.5.1-1.21.5-Fabric" = _31dn73nr;
        "pkg-v21.5.1-1.21.5-NeoForge" = _CpJdIhP4;
        "pkg-v21.6.0-1.21.6-Fabric" = _RNWJtXVW;
        "pkg-v21.6.0-1.21.6-NeoForge" = _Kni6JqOA;
        "pkg-v21.7.0-1.21.7-Fabric" = _OCIwLHwA;
        "pkg-v21.7.0-1.21.7-NeoForge" = _b0eZCqr1;
        "pkg-v21.8.0-1.21.8-Fabric" = _OH5owq1g;
        "pkg-v21.8.0-1.21.8-NeoForge" = _tw8cEMAG;
        "pkg-v21.8.1-1.21.8-Fabric" = _mzBNqLBY;
        "pkg-v21.8.1-1.21.8-NeoForge" = _Zi48LQa3;
        "pkg-21.9.0" = _OZOKk0q5;
        "pkg-21.10.0" = _U8gyeSCj;
        "pkg-21.11.0" = _As7cIC1U;
        "pkg-26.1.0" = _ZmNCWzTl;
