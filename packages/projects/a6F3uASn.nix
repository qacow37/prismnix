...
let
    ...
    in {
        ...
        "pkg-9.9.3.394" = _V7KEjPrm;
        "pkg-9.10.9.422" = _YDQGc1uM;
        "pkg-10.0.9.432" = _3rrSJOqZ;
        "pkg-10.0.17.444" = _O0HRG6yF;
        "pkg-10.0.19.446" = _b0rQG8Ud;
        "pkg-10.1.2.457" = _h7ekYqcG;
        "pkg-10.2.0.459" = _zspveSrl;
        "pkg-10.2.1.461" = _5sqRM7lI;
        "pkg-10.2.2.462" = _6lZWCb61;
        "pkg-10.2.3.463" = _7whYwnP2;
        "pkg-10.2.4.464" = _5XRYBFG9;
        "pkg-10.2.5.465" = _pphKL6iA;
        "pkg-10.3.0.467" = _HN4Om5ql;
        "pkg-10.3.1.468" = _lDbCJOJO;
        "pkg-10.3.2.469" = _QHOdPWFB;
        "pkg-10.3.3.470" = _PRYiDSNu;
        "pkg-10.3.4.471" = _gwpmyqFB;
        "pkg-10.3.5.473" = _7LrzFGph;
        "pkg-10.3.6.475" = _JwMMWmrc;
        "pkg-10.3.7.476" = _vJasessP;
        "pkg-10.3.8.477" = _KEOppd3L;
        "pkg-10.3.9.13" = _PqFyojyH;
        "pkg-10.4.0.14" = _bAwfOct0;
        "pkg-10.4.1.15" = _Qf92bpx7;
        "pkg-10.4.2.16" = _MvQMcJxl;
        "pkg-10.4.3.17" = _AWepzZIo;
        "pkg-10.4.4.18" = _5hsz5saC;
        "pkg-10.4.5.19" = _MMmNDrKd;
        "pkg-10.4.6.20" = _pXrqwQNY;
        "pkg-10.5.1.23" = _DwsycnWV;
        "pkg-10.5.2.24" = _nFgbuw3L;
        "pkg-10.5.3.25" = _N3pXIos2;
        "pkg-10.5.4.26" = _iRXISWLa;
        "pkg-10.5.5.27" = _XlPEUdYX;
        "pkg-10.5.6.28" = _hyTUCoEM;
        "pkg-10.5.7.29" = _PLkoRLhB;
        "pkg-10.5.8.30" = _rDxnOA2V;
        "pkg-10.5.10.32" = _hO0KB3vH;
        "pkg-10.5.11.33" = _cFFCDWiG;
        "pkg-10.5.12.34" = _3tf1dBVS;
        "pkg-10.5.13.35" = _taKiIhrg;
        "pkg-10.5.15.36" = _qFNWZfXK;
        "pkg-10.5.16.37" = _MjfxQwzp;
        "pkg-10.5.17.38" = _fzAVyxL4;
        "pkg-10.5.18.39" = _uD7anrFT;
        "pkg-10.5.19.40" = _wFrsHZS6;
        "pkg-10.5.20.41" = _ZAaxdWJp;
        "pkg-10.4.7.42" = _fQcJxM8K;
        "pkg-10.4.8.43" = _b7sWNx4V;
        "pkg-10.6.0.44" = _gGgTJNon;
        "pkg-10.6.1.45" = _IMpXpfZo;
        "pkg-10.6.2.46" = _VULKnH2A;
        "pkg-10.6.3.49" = _LxQzwvnm;
        "pkg-10.6.4.50" = _etWhX7SB;
        "pkg-10.6.4.51" = _X4uJEw1Y;
        "pkg-10.6.5.52" = _e8CdL4gw;
        "pkg-10.6.6.53" = _wuLAWcuN;
        "pkg-10.6.7.54" = _BiVkaymT;
        "pkg-10.7.0.55" = _MSMjQ39L;
        "pkg-10.7.1.56" = _5NWEuGJv;
        "pkg-10.7.1.57" = _SvWK8PNb;
        "pkg-10.7.2.58" = _boUwB1k6;
        "pkg-10.7.3.59" = _A9AyBz4z;
        "pkg-10.7.4.60" = _sMw15G8f;
        "pkg-10.4.9.61" = _tUg8V9Gq;
        "pkg-10.7.5.62" = _pbSwaXYL;
        "pkg-10.7.6.63" = _FgQdFj6M;
        "pkg-10.7.7.64" = _2NMAj4kJ;
        "pkg-10.4.10.66" = _gB0PPQdi;
        "pkg-10.4.11.67" = _bDIquFvW;
        "pkg-10.4.12.68" = _zAZo9Iys;
        "pkg-10.4.13.69" = _GXirICXS;
        "pkg-10.7.8.70" = _agnAJKYl;
        "pkg-10.4.14.71" = _tAKEnBMo;
        "pkg-10.7.9.72" = _SF1pqxGq;
        "pkg-10.7.10.73" = _Ek96cWij;
        "pkg-10.4.15.75" = _ey1dc556;
        "pkg-10.7.11.76" = _yB8J6CGF;
        "pkg-10.7.12.77" = _4Eyu9t3h;
        "pkg-10.7.13.78" = _u6xx9IhC;
        "pkg-10.7.14.79" = _fOFZiDjW;
        "pkg-10.4.16.80" = _RFiZ24he;
        "pkg-10.7.15.81" = _Tg4ZeLNP;
        "pkg-10.7.16.82" = _6Opt3C0j;
        "pkg-10.7.17.83" = _wfPjzfo0;
        "pkg-10.7.18.84" = _y4y04JfC;
        "pkg-10.7.19.85" = _6mkdykZa;
        "default" = _6mkdykZa;
    });
