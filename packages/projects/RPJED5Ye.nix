...
let
    ...
    in {
        ...
        "pkg-1.1" = _6X131WX0;
        "pkg-1.2" = _9sGnFhu1;
        "pkg-1.3-MC-1.21.4" = _mQBO8Zwd;
        "pkg-1.3-MC-1.21.1" = _8y6TDHHy;
        "pkg-1.3-MC-1.20.6" = _KCw7YrNf;
        "pkg-1.3-MC-1.20.4" = _oHs9uxQK;
        "pkg-1.3-MC-1.20.2" = _ZaFQCEWJ;
        "pkg-1.3-MC-1.20.1" = _Wrcfk9qn;
        "pkg-1.4-MC-1.21.4" = _yHPKBCQd;
        "pkg-1.4-MC-1.21.1" = _kLnHUFca;
        "pkg-1.4-MC-1.20.6" = _1xrRRIe1;
        "pkg-1.4-MC-1.20.4" = _tSidbVQZ;
        "pkg-1.4-MC-1.20.1" = _p7lsApFe;
        "pkg-1.4-MC-1.21.5" = _hOTaJ9lQ;
        "pkg-1.5-MC-1.20.1" = _ljikpVZg;
        "pkg-1.5-MC-1.20.4" = _TcW5ev4A;
        "pkg-1.5-MC-1.20.6" = _XFrC7ERM;
        "pkg-1.5-MC-1.21.1" = _TSx30U6U;
        "pkg-1.5-MC-1.21.4" = _megjiy8y;
        "pkg-1.5-MC-1.21.5" = _a0LBBKmk;
        "pkg-1.6-MC-1.20.1" = _eIibTi1E;
        "pkg-1.6-MC-1.20.4" = _fYsZ0DCW;
        "pkg-1.6-MC-1.20.6" = _n2MSs6Q1;
        "pkg-1.6-MC-1.21.1" = _L4wz7H3a;
        "pkg-1.6-MC-1.21.4" = _XE66FPFT;
        "pkg-1.6-MC-1.21.5" = _vr1KPNZc;
        "pkg-1.7-MC-1.20.1" = _YmXtwPiW;
        "pkg-1.7-MC-1.20.4" = _SfnznQcp;
        "pkg-1.7-MC-1.20.6" = _MNkekJyz;
        "pkg-1.7-MC-1.21.1" = _UakTmNTZ;
        "pkg-1.7-MC-1.21.4" = _gOag5CFD;
        "pkg-1.7-MC-1.21.5" = _L0BjHqm5;
        "pkg-1.7-MC-1.21.2" = _RQRRpiED;
        "pkg-1.8-MC-1.20.1" = _y5Idi5Br;
        "pkg-1.8-MC-1.20.4" = _1onhHuAl;
        "pkg-1.8-MC-1.20.6" = _iGGgk60G;
        "pkg-1.8-MC-1.21.1" = _Yd92njR8;
        "pkg-1.8-MC-1.21.2" = _pgHwyYg3;
        "pkg-1.8-MC-1.21.4" = _IJrnCof0;
        "pkg-1.8-MC-1.21.5" = _JLkqwUep;
        "pkg-1.9-MC-1.20.1" = _Dsi9Mc1j;
        "pkg-1.9-MC-1.20.4" = _42q9Hsnl;
        "pkg-1.9-MC-1.20.6" = _xANKFASq;
        "pkg-1.9-MC-1.21.1" = _24M685jx;
        "pkg-1.9-MC-1.21.2" = _bBTCcJLy;
        "pkg-1.9-MC-1.21.4" = _aHIcv0Np;
        "pkg-1.9-MC-1.21.5" = _Q9Vfw5Y2;
        "pkg-1.10-MC-1.20.1" = _5JWTCsbK;
        "pkg-1.10-MC-1.20.4" = _H7aTSAm8;
        "pkg-1.10-MC-1.20.6" = _TdoReQCf;
        "pkg-1.10-MC-1.21.1" = _VA2R16rp;
        "pkg-1.10-MC-1.21.2" = _rt5r3CIX;
        "pkg-1.10-MC-1.21.4" = _anIZ8b8x;
        "pkg-1.10-MC-1.21.5" = _lKrUmAWQ;
        "pkg-1.10-hf1-MC-1.20.1" = _YWVZ5Xib;
        "pkg-1.10-hf1-MC-1.20.4" = _SZrvffgu;
        "pkg-1.10-hf2-MC-1.20.1" = _oBpcPGQH;
        "pkg-1.10-hf2-MC-1.20.4" = _5oTBJJA3;
        "pkg-1.10-hf2-MC-1.20.6" = _kQrOov3Z;
        "pkg-1.10-hf2-MC-1.21.1" = _4wXjoMX0;
        "pkg-1.10-hf2-MC-1.21.2" = _j51E5kqh;
        "pkg-1.10-hf2-MC-1.21.4" = _dDYEwmMf;
        "pkg-1.10-hf2-MC-1.21.5" = _uwMbzRQi;
        "pkg-1.11-MC-1.20.1" = _STguKWlE;
        "pkg-1.11-MC-1.20.4" = _yNMaXuYY;
        "pkg-1.11-MC-1.20.6" = _gG5Zbwgh;
        "pkg-1.11-MC-1.21.1" = _FIqFlyrC;
        "pkg-1.11-MC-1.21.2" = _DdHhCq4B;
        "pkg-1.11-MC-1.21.4" = _Uto8Z3Wz;
        "pkg-1.11-MC-1.21.5" = _3pRdZXn9;
        "pkg-1.11-MC-1.21.6" = _76USHzgC;
        "pkg-1.11-hf1-MC-1.21.6" = _Q6Jhe3Nq;
        "pkg-1.11-hf1-MC-1.21.5" = _5kq6ahgR;
        "pkg-1.11-hf1-MC-1.21.4" = _ZDUg5CoX;
        "pkg-1.11-hf1-MC-1.21.2" = _kdxv0GJK;
        "pkg-1.11-hf1-MC-1.21.1" = _48iRPvL6;
        "pkg-1.11-hf1-MC-1.20.6" = _CKafR4S8;
        "pkg-1.11-hf1-MC-1.20.4" = _Adg9D8dU;
        "pkg-1.11-hf1-MC-1.20.1" = _SArj5qmP;
        "pkg-1.12-MC-1.21.6" = _xI8yDk2A;
        "pkg-1.12-MC-1.21.5" = _VOTFsL6A;
        "pkg-1.12-MC-1.21.4" = _vrp8uTrZ;
        "pkg-1.12-MC-1.21.2" = _fYAWxPuA;
        "pkg-1.12-MC-1.21.1" = _67vbKHBD;
        "pkg-1.12-MC-1.20.6" = _g6RFMo0d;
        "pkg-1.12-MC-1.20.4" = _oxTJzSi5;
        "pkg-1.12-MC-1.20.1" = _22Nw0sAq;
        "pkg-1.12-hf1-MC-1.21.6" = _T80zpQfI;
        "pkg-1.12-hf2-MC-1.21.6" = _feJW2QoQ;
        "pkg-1.13-1.21.8" = _IW58QLpl;
        "pkg-1.13-26.1" = _fFWn8Xad;
        "default" = _fFWn8Xad;
    });
