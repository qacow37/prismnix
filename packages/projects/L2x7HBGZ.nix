...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.21.4-fabric" = _fMNW454n;
        "pkg-1.0.0-1.21.5-fabric" = _h4aOp9nm;
        "pkg-1.0.1-1.21.1-fabric" = _8wZH2KgB;
        "pkg-1.0.1-1.21.5-fabric" = _b3AxBLX0;
        "pkg-1.0.1-1.21.4-fabric" = _1HeZcrgm;
        "pkg-1.1.0-1.21.5-fabric" = _Fq3OZfHr;
        "pkg-1.1.1-1.21.5-fabric" = _snvMLmHC;
        "pkg-1.1.0-1.21.4-fabric" = _H4sUuhM8;
        "pkg-1.1.0-1.21.1-fabric" = _cv8Zidhc;
        "pkg-1.2.0-1.21.5-fabric" = _AF5weay5;
        "pkg-1.2.0-1.21.4-fabric" = _2gRw0YtE;
        "pkg-1.2.0-1.21.1-fabric" = _5NhDGnZD;
        "pkg-1.2.1-1.21.5-fabric" = _uKR6bKJ3;
        "pkg-1.2.1-1.21.4-fabric" = _9licCYhu;
        "pkg-1.2.1-1.21.1-fabric" = _HjMCsRn0;
        "pkg-1.2.2-1.21.5-fabric" = _4p8hUc9e;
        "pkg-1.2.2-1.21.5-forge" = _Fk0ynXUc;
        "pkg-1.2.2-1.21.5-neoforge" = _s5EIJlAV;
        "pkg-1.2.2-1.21.4-fabric" = _HU7MPYEs;
        "pkg-1.2.2-1.21.4-forge" = _xbrrc3Ha;
        "pkg-1.2.2-1.21.4-neoforge" = _2wc31TGY;
        "pkg-1.2.2-1.21.1-neoforge" = _GgrmB4Q6;
        "pkg-1.2.2-1.21.1-forge" = _IMKYa5OG;
        "pkg-1.2.2-1.21.1-fabric" = _FWodIrZd;
        "pkg-1.3.1-1.21.5-neoforge" = _BCJGADIv;
        "pkg-1.3.1-1.21.5-forge" = _b1j0VqKx;
        "pkg-1.3.1-1.21.5-fabrirc" = _iSA11oFu;
        "pkg-1.3.1-1.21.4-neoforge" = _vKOQ8dWC;
        "pkg-1.3.1-1.21.4-forge" = _32xNhxKq;
        "pkg-1.3.1-1.21.4-fabric" = _d1tiKCuR;
        "pkg-1.3.1-1.21.1-neoforge" = _tmsQY2g1;
        "pkg-1.3.1-1.21.1-forge" = _N6zxe32t;
        "pkg-1.3.1-1.21.1-fabric" = _YrZ7txac;
        "pkg-1.3.2-1.21.5-fabric" = _mjT58Chf;
        "pkg-1.3.2-1.21.5-neoforge" = _cigBuSzO;
        "pkg-1.3.2-1.21.5-forge" = _X1xaGadb;
        "pkg-1.3.2-1.21.4-fabric" = _oig4QWi7;
        "pkg-1.3.2-1.21.4-forge" = _n3lueHwS;
        "pkg-1.3.2-1.21.4-neoforge" = _8acJm0zw;
        "pkg-1.3.2-1.21.1-fabric" = _Zfn7RXpB;
        "pkg-1.3.2-1.21.1-forge" = _wV46Fl6M;
        "pkg-1.3.2-1.21.1-neoforge" = _i70z8cgh;
        "pkg-1.3.2-1.21.6+-fabric" = _MMdRW1h5;
        "pkg-1.3.2-1.21.6+-forge" = _hzA0wo3c;
        "pkg-1.3.2-1.21.6+-neoforge" = _2nj9xFKX;
        "default" = _2nj9xFKX;
    });
