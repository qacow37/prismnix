...
let
    ...
    in {
        ...
        "pkg-1.0.7" = _itfgkYL4;
        "pkg-1.19.3-1.0.7" = _Ho5GZy60;
        "pkg-1.18.2-1.0.7.1" = _1pK9MxoS;
        "pkg-1.19.2-1.0.7.1" = _ti9zCXZq;
        "pkg-1.19.3-1.0.7.1" = _h526wuR3;
        "pkg-1.19.4-1.0.7.1" = _i2gFzEss;
        "pkg-1.0.7.2" = _llGvI3Hi;
        "pkg-1.0.8.2" = _sISvYIbE;
        "default" = _sISvYIbE;
    });
