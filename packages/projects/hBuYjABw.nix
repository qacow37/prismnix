...
let
    ...
    in {
        ...
        "pkg-1.2.8" = _Cy1ilpA3;
        "pkg-1.2.9" = _8mugecGM;
        "pkg-1.2.11" = _ERTFaHaX;
        "pkg-1.2.12" = _GTFEHWqX;
        "pkg-1.2.13" = _6eUkmHkw;
        "pkg-1.2.14" = _X0YF2FL8;
        "pkg-1.2.15" = _rno2UFEW;
        "pkg-1.2.16" = _tL6t4gYa;
        "pkg-1.2.17" = _dpVEyz7c;
        "pkg-1.2.18" = _YJOLpzvc;
        "pkg-1.2.19" = _r2H8Ht0y;
        "pkg-1.2.20" = _C7nU0mp6;
        "pkg-1.2.21" = _ow9qfHmt;
        "pkg-1.2.22" = _qwAf5eaT;
        "pkg-1.2.23" = _5BsSGDby;
        "pkg-1.2.24" = _xh0hAB5p;
        "default" = _xh0hAB5p;
    });
