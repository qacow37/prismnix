...
let
    ...
    in {
        ...
        "pkg-1.1.4" = _IQgu9W4S;
        "pkg-1.1.5" = _WFOxfwhc;
        "pkg-1.1.5+1.19.2" = _DFEUfi0S;
        "pkg-1.1.6" = _9mEeoxGz;
        "pkg-1.1.6+1.20.1" = _ztISRVId;
        "pkg-1.1.6+1.19.2" = _FZBZjIQb;
        "pkg-2.0.0+1.21.1" = _8cHKdVrT;
        "pkg-2.0.0+1.21.1+mjmps" = _7Zmd4HUK;
        "pkg-2.0.0+1.20.1" = _MVOki3aP;
        "pkg-2.0.0+1.19.2" = _RcCFz9TJ;
        "pkg-2.0.0+1.21.6" = _RPu5mTyl;
        "pkg-2.0.0+1.21.1+neo" = _NwZ3nvBp;
        "pkg-2.0.0+1.20.1+forge" = _bYxqJXmI;
        "pkg-2.1.0+1.21.1" = _AMmWBUlE;
        "pkg-2.1.0+1.20.1" = _IiiPf8SJ;
        "pkg-2.1.0+1.21.1+neo" = _lbLQyHZu;
        "pkg-2.1.0+1.20.1+forge" = _fm41Q6PL;
        "pkg-2.1.0+1.19.2" = _3gGNunkM;
        "pkg-2.1.0+1.21.11" = _dBluEUaE;
        "pkg-2.1.1+1.21.1" = _Tl86aiIE;
        "pkg-2.1.1+1.21.11" = _dtRLt5Pk;
        "pkg-2.1.1+1.21.1+neo" = _j18R83Er;
        "pkg-2.1.1+1.20.1+forge" = _5yzHf2C1;
        "pkg-2.1.1+1.19.2" = _hHPo3fCb;
        "pkg-2.1.1+1.20.1" = _mtQlrUz7;
        "pkg-2.1.1+26.1" = _kWoix016;
        "default" = _kWoix016;
    });
