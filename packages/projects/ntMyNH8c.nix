...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.18.1" = _GyPssEtz;
        "pkg-1.2.2-1.18.2" = _QkDvf41g;
        "pkg-1.2.3-1.19.2" = _Oe3zPknB;
        "pkg-1.2.5-1.19.4" = _ogsJmO1N;
        "pkg-1.2.7-1.20" = _8yyqqkaF;
        "pkg-1.3.1-1.20.2" = _lDViBNyN;
        "pkg-1.4.2-1.18.2" = _WyEdmWOH;
        "pkg-1.4.2-1.20.1" = _4S6TSXbX;
        "pkg-1.4.5-1.18.2" = _ibtfirbD;
        "pkg-1.4.4-1.20.1" = _nB8NuTIO;
        "pkg-1.4.5-1.20.1" = _joOHM6Kp;
        "pkg-1.4.7-1.18.2" = _GaGnrERz;
        "pkg-1.4.7-1.20.1" = _c79gyX4v;
        "pkg-1.0.1-1.21" = _nMutXpoK;
        "pkg-1.0.2-1.21.1" = _Nd3k3Crc;
        "pkg-1.1.6-1.21.1" = _o0t08Xbi;
        "pkg-1.5.15-1.20.1" = _bQW4YePh;
        "pkg-1.5.17-1.20.1" = _vZvT79Fe;
        "pkg-1.1.7-1.21.1" = _fr7qHc2V;
        "pkg-1.1.8-1.21.1" = _QCo1JpCt;
        "pkg-1.5.18-1.20.1" = _d9pE28IQ;
        "pkg-1.5.19-1.20.1" = _CnYTpb19;
        "pkg-1.5.21-1.20.1" = _GrP6n4l9;
        "pkg-1.5.22-1.20.1" = _GCX4PZJn;
        "pkg-2.3.0-1.12.2" = _ZStoHRGc;
        "pkg-1.5.23-1.20.1" = _7FI8buGO;
        "pkg-1.2.14-1.21.1" = _7Rhgswdk;
        "pkg-1.5.24-1.20.1" = _mSVq2uKf;
        "pkg-1.5.25-1.20.1" = _Nxqgswxl;
        "pkg-1.5.26-1.20.1" = _6Qs3olf4;
        "pkg-1.6.28-1.20.1" = _Hs7JYxMh;
        "pkg-1.6.29-1.20.1" = _aNFnuXpW;
        "pkg-1.6.30-1.20.1" = _DPuIWHyp;
        "pkg-1.6.34-1.20.1" = _m0IYPVS4;
        "pkg-1.2.15-1.21.1" = _o49zOLis;
        "default" = _o49zOLis;
    });
