...
let
    ...
    in {
        ...
        "pkg-v1.0.1+1.18.2" = _jvJfecx9;
        "pkg-v1.0.2+1.18.2" = _2zE7dj3R;
        "pkg-v1.0.3+1.18.2" = _bds6PhCr;
        "pkg-v1.0.4+1.18.2" = _LjxrGjwN;
        "pkg-v1.1.0+1.18.2" = _KWUgM1Pm;
        "pkg-v1.1.0+1.19" = _EmeZ0Gqt;
        "pkg-v1.1.1+1.19" = _SBi7COdt;
        "pkg-v1.1.2+1.19" = _enCs35o3;
        "pkg-v1.1.2+1.18.2" = _QNaBS24G;
        "pkg-v1.1.3+1.18.2" = _o5KsFiVJ;
        "pkg-v1.1.3+1.19" = _WwSxteqI;
        "pkg-v1.1.4+1.18.2" = _w1ctchwV;
        "pkg-v1.1.4+1.19" = _DvWsedjb;
        "pkg-v1.1.5+1.18.2" = _IDfdFriT;
        "pkg-v1.1.5+1.19" = _KaUaJJ1i;
        "pkg-v1.1.6+1.18.2" = _jdW6CBhM;
        "pkg-v1.1.6+1.19" = _RMa6KMf9;
        "pkg-v1.1.6+1.19.3" = _HpDkLZjj;
        "pkg-2.0.0-alpha.1" = _bqQWHwWx;
        "pkg-2.0.0-alpha.2" = _ehlFpVEb;
        "pkg-2.0.0-alpha.3" = _3uGk4ChO;
        "pkg-2.0.0-alpha.4" = _eM7FKWWG;
        "pkg-2.0.0-alpha.5" = _L99Bxt2Y;
        "pkg-2.0.0-alpha.6" = _2oUHeIhM;
        "pkg-2.0.0-beta.1" = _v4BLjO6F;
        "pkg-2.0.0-beta.2" = _vJb4cpaY;
        "pkg-2.0.0-beta.3" = _TM9YqUwX;
        "pkg-2.1.0-beta.1" = _EOU9oC3S;
        "pkg-2.1.0-beta.2" = _LVdJJtmU;
        "pkg-2.1.0-beta.3" = _XflepaVP;
        "pkg-2.1.0" = _P6myMR8K;
        "pkg-2.1.1" = _xQrH4kWR;
        "pkg-2.1.2" = _YU9Yi2mO;
        "pkg-2.1.3" = _41AoOR3G;
        "pkg-2.1.4" = _3CSEKfcd;
        "pkg-2.1.5" = _x0k8u61W;
        "pkg-2.2.0-alpha.1" = _noPVqZnY;
        "pkg-2.1.6" = _rBFq3aQs;
        "pkg-2.1.7" = _xpfegZsE;
        "pkg-2.3.0-alpha.2" = _cGrREnKA;
        "pkg-2.3.0-beta.2" = _pUVuXS69;
        "pkg-2.3.0-beta.2+1.20.5" = _2FbON5jl;
        "pkg-2.3.0-beta.2+1.21" = _dPuD2Nuk;
        "pkg-2.3.0-beta.3+1.20.2" = _2F04ehzr;
        "pkg-2.3.0-beta.4+1.20.2" = _a8j0Obwt;
        "pkg-2.3.0-beta.4+1.20.5" = _VJsnsla4;
        "pkg-2.3.0-beta.4+1.21" = _8yMAzCTU;
        "pkg-2.3.0-beta.5+1.20.2" = _keWLEigf;
        "pkg-2.3.0-beta.5+1.20.5" = _ifjPvcMH;
        "pkg-2.3.0-beta.5+1.21" = _BUvJCGus;
        "pkg-2.3.0-beta.5+1.20" = _Fdam47G9;
        "pkg-2.3.0-beta.5+1.19.3" = _oM2u3QmP;
        "pkg-2.3.0-beta.6+1.19.3" = _cPfdz9hB;
        "pkg-2.3.0-beta.6+1.20" = _PQYmfBLg;
        "pkg-2.3.0-beta.6+1.20.2" = _5X90cSj7;
        "pkg-2.3.0-beta.6+1.20.5" = _ePtlPQRN;
        "pkg-2.3.0-beta.6+1.21" = _rPLGSp71;
        "pkg-2.3.0-beta.6+1.21.2" = _EsA0cp6K;
        "pkg-2.3.0-beta.7+1.21.2" = _hTnXX4UQ;
        "pkg-3.0.0-alpha.1+fabric.1.21" = _Ne7zPaev;
        "pkg-3.0.0-alpha.2+fabric.1.21" = _agSgouUY;
        "pkg-3.0.0-alpha.3+fabric.1.21" = _7bPm8uDR;
        "pkg-3.0.0-alpha.3+fabric.1.20" = _5k2l6FnR;
        "pkg-2.3.0-beta.6.1-modrinth+1.20" = _VOkFcxqC;
        "pkg-2.3.0-beta.6.1-modrinth+1.21" = _Zu9vDPeQ;
        "pkg-2.3.0-beta.7+1.21.5" = _c2A7xc4Z;
        "pkg-2.3.0-beta.7+1.21.6" = _QXe3WY3V;
        "pkg-2.3.0-beta.8+1.21.6" = _ft3Pi0Dc;
        "pkg-2.3.0-beta.8+1.21.9" = _novKhTZ1;
        "pkg-2.3.0-beta.8+1.21.5" = _KZchfcno;
        "pkg-2.3.0-beta.8+1.21.2" = _hiHL1M7J;
        "pkg-2.3.0-beta.8+1.21" = _18LgkicJ;
        "pkg-2.3.0-beta.8+1.20.5" = _oYtt6NBq;
        "pkg-2.3.0-beta.8+1.20.2" = _omngMZlB;
        "pkg-2.3.0-beta.8+1.20" = _vOOoRc7H;
        "pkg-2.3.0-beta.8+1.19.3" = _rloe7wl2;
        "pkg-2.3.0-beta.9+1.21.9" = _7aP1cWaK;
        "pkg-2.3.0-beta.9+1.21.6" = _oPOarurF;
        "pkg-2.3.0-beta.9+1.21.5" = _zMVAxv6K;
        "pkg-2.3.0-beta.9+1.21.2" = _JVVQD89i;
        "pkg-2.3.0-beta.9+1.21" = _npnKNaoI;
        "pkg-2.3.0-beta.9+1.20.5" = _YPsJjocl;
        "pkg-2.3.0-beta.9+1.20.2" = _CXtw4Sdu;
        "pkg-2.3.0-beta.9+1.20" = _BhkVUqUt;
