...
let
    ...
    in {
        ...
        "pkg-6.3.0" = _NCbt7eLe;
        "pkg-6.4.0" = _KqtqUbjl;
        "pkg-7.0.4-1.20.1" = _6QaFC0xR;
        "pkg-7.0.5-1.20.1" = _njQ96R0v;
        "pkg-7.0.5-1.20.X" = _irLESBAK;
        "pkg-7.0.5-1.21.X" = _IJUjt4Yw;
        "pkg-7.1.0-1.20.X" = _NqskSbVl;
        "pkg-7.2.1-1.20.X" = _AnAJPqlh;
        "default" = _AnAJPqlh;
    });
