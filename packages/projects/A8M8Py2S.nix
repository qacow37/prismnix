...
let
    ...
    in {
        ...
        "pkg-0.3.0" = _3QWZQvIr;
        "pkg-1.0-SNAPSHOT" = _trfyX5Kn;
        "pkg-1.0-SNAPSHOT5" = _pfgHXTnf;
        "pkg-1.0-fabric" = _33hrChda;
        "pkg-1.0-neoforge" = _oanAzoOo;
        "pkg-1.1-fabric" = _VrmDmZiA;
        "pkg-1.1-neoforge" = _ZKyMH7ol;
        "pkg-1.2-fabric" = _TUL3RoYs;
        "pkg-1.2-neoforge" = _vPKjsAIn;
        "pkg-2.0-fabric" = _kjxAla5j;
        "pkg-2.0-neoforge" = _V9UUfrPY;
        "pkg-2.1-fabric" = _xaiNT5Im;
        "pkg-2.1-neoforge" = _b7L19se9;
        "pkg-3.0-fabric" = _80V2Czlj;
        "pkg-3.0-neoforge" = _3ZC4asF1;
        "pkg-3.1-fabric" = _Fr6rQTi3;
        "pkg-3.1-neoforge" = _sQIvDeIA;
        "pkg-4.0-BETA-fabric" = _pBMxIwPB;
        "pkg-4.0-BETA-neoforge" = _LbHiEyXX;
        "pkg-4.0-fabric" = _Zy0BT6By;
        "pkg-4.0-neoforge" = _PrNtq1QW;
        "pkg-4.1-fabric" = _urhbo7ET;
        "pkg-4.1-neoforge" = _U1UDoHYQ;
        "pkg-4.2-fabric" = _uJMGrekJ;
        "pkg-4.2-neoforge" = _41wjEY8e;
        "pkg-4.3-fabric" = _Bn3dITV0;
        "pkg-4.3-neoforge" = _GULuznax;
        "pkg-5.0-fabric" = _gmnlsQfx;
        "pkg-5.0-neoforge" = _fy6OQl2f;
        "pkg-6.0-fabric" = _1gm7wGrv;
        "pkg-6.0-neoforge" = _kWBXVmzi;
        "pkg-6.1-fabric" = _rA95HsQk;
        "pkg-6.1-neoforge" = _jYXjeYAV;
        "pkg-7.0-fabric" = _P7RK6Vvp;
        "pkg-7.0-neoforge" = _kESLaj6G;
        "pkg-8.0-BETA" = _J01FvDd8;
        "pkg-8.0-BETA2" = _UBlItfcL;
        "pkg-8.0-BETA3" = _L3PDTRBC;
        "pkg-8.0-fabric" = _AoNb02BM;
        "pkg-8.0-neoforge" = _rptbrgBE;
        "pkg-8.1-fabric" = _rR73Itwn;
        "pkg-8.1-neoforge" = _LimmS3eM;
        "pkg-8.2-fabric" = _f9AdbNXu;
        "pkg-8.2-neoforge" = _SRlg94O2;
        "pkg-9.0-fabric" = _hgyqXimO;
        "pkg-9.0-neoforge" = _wtILIuxx;
        "pkg-9.1-fabric" = _ZVIM0b17;
        "pkg-9.1-neoforge" = _LV7lsoM3;
        "pkg-10.1-fabric" = _hjZWpggP;
        "pkg-10.1-neoforge" = _EMEJ3hcJ;
        "pkg-10.2-fabric" = _ElBwidcG;
        "pkg-10.2-neoforge" = _oXLuXsyy;
        "pkg-10.3-fabric" = _wyQbVwEm;
        "pkg-10.3-neoforge" = _ZBTxu5Hr;
        "pkg-11.0-fabric" = _14YocvTg;
        "pkg-11.0-neoforge" = _pJIiXR04;
        "pkg-11.1-fabric" = _1lVeRYJN;
        "pkg-11.1-neoforge" = _4IvGNsP3;
        "pkg-12.0-fabric" = _K09Sh6hk;
        "pkg-12.0-neoforge" = _e41D5l0M;
        "pkg-12.1-fabric" = _JILnBi5c;
        "pkg-12.1-neoforge" = _VNTB9zEi;
        "default" = _VNTB9zEi;
    });
