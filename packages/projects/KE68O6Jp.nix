...
let
    ...
    in {
        ...
        "pkg-1.21.9-release.1" = _18rmlbQp;
        "pkg-1.21.9-release.2" = _SNHvOrmR;
        "pkg-1.20.5-release.1" = _jAv5ekPg;
        "pkg-1.21-release.1" = _gT2n34W5;
        "pkg-1.21.2-release.1" = _lgVHptQc;
        "pkg-1.21.9-release.3" = _Z32kIGK7;
        "pkg-1.21.2-release.2" = _jM7gRPfk;
        "pkg-1.21-release.2" = _6BzLkrWu;
        "pkg-1.20.5-release.2" = _VR163YLR;
        "pkg-1.20-release.1" = _Mtiybo5t;
        "pkg-1.19.4-release.1" = _9NRIIaA9;
        "pkg-1.19-release.1" = _3PJsW0LY;
        "pkg-1.18-release.1" = _VTWRuxco;
        "pkg-1.17-release.1" = _KEmAhAyk;
        "pkg-1.16-release.1" = _qtsfQI7n;
        "pkg-1.16-release.2" = _FMT4YoJK;
        "pkg-1.15-release.1" = _JEsXN8AT;
        "pkg-y25m12b1" = _USJTbk65;
        "pkg-2.0.0-rc.1+1.21.9" = _ob1VVUQ1;
        "pkg-y25m12b2" = _pVmL3cm4;
        "pkg-2.0.0-rc.2+1.21.9" = _uAylMhQn;
        "pkg-2.0.0+1.21.9" = _sB0B2O5S;
        "pkg-2.0.0+1.21.11" = _KYw4ZFLe;
        "pkg-2.0.0+1.21.5" = _IfqbJBj0;
        "pkg-2.0.0+1.21" = _zbCDIAnp;
        "pkg-2.1.0-alpha.1+1.21.11" = _EJ5PSKSc;
        "pkg-2.1.0-beta.1+1.21.11" = _3SYIzRUW;
        "pkg-2.1.0-beta.2+1.21.11" = _wRjJ8VNg;
        "pkg-2.1.0+1.21.11" = _usVnqOnw;
        "pkg-2.1.1+1.21.11" = _lrDhzEMY;
        "pkg-2.1.1+1.21.11.neoforge" = _PVe23TD8;
        "pkg-2.1.1+1.21.neoforge" = _XrIyD6ii;
        "pkg-2.1.1+1.21" = _aoHIWfqn;
        "pkg-2.1.1+1.21.1.neoforge" = _UhbiZNgu;
        "pkg-2.1.1+1.21.9" = _neJJjBik;
        "pkg-2.1.1+1.21.6" = _XXhQbu0F;
        "pkg-2.1.1+1.21.5" = _cGRjT0ih;
        "pkg-2.1.1+1.21.4" = _REKeegCz;
        "pkg-2.1.1+1.21.2" = _BEo8kMoY;
        "pkg-2.1.1+1.21.neoforge.patch.1" = _KP6RIKwa;
        "pkg-2.2.0+1.21.11" = _QO6NVZpE;
        "pkg-2.1.1+1.20.forge" = _QUsTOdIU;
        "pkg-2.1.1+1.20.5" = _ZipppL3d;
        "pkg-2.1.1+1.20.3" = _K2Z8bL0I;
        "pkg-2.1.1+1.20.2" = _lkfu3jYe;
        "pkg-2.1.1+1.20" = _ta1pVwl8;
        "pkg-2.1.1+1.19.4" = _pFP82Hh3;
        "pkg-2.3.0-alpha.1+1.21.11" = _z7PWQPTm;
        "pkg-2.3.0-alpha.2+1.21.11" = _J67pHUKu;
        "pkg-2.3.0+1.21.11.fabric" = _P7fdY4hQ;
        "pkg-2.3.0+26.1.fabric" = _HdvqeDiS;
        "pkg-2.4.0+26.1" = _hHSTMYyc;
