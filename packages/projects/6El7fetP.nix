...
let
    ...
    in {
        ...
        "pkg-1.4.6" = _VqHs3lBy;
        "pkg-1.4.7" = _5xHxnSJm;
        "pkg-1.5.0-beta-8" = _4WbwU7Yt;
        "pkg-1.5.0-beta-10" = _Df7C5RjY;
        "pkg-1.5.0" = _mXU1qVr6;
        "pkg-1.5.1" = _QgVpeDBG;
        "pkg-1.5.2" = _4eOHh7x2;
        "pkg-1.5.3" = _Ej8XNaeb;
        ...
        "pkg-1.6.6" = _M1A9Uzlh;
        "pkg-1.6.7" = _dg4GgRTa;
        "pkg-1.5.3-1.20.1" = _wXQeJdCF;
        "pkg-1.6.8" = _nhUVCz9j;
        "pkg-1.5.4-1.20.1" = _ioe6z2FW;
        "pkg-1.6.9" = _r00QgwSZ;
        "pkg-1.6.10" = _ysxLBcF8;
        "pkg-1.6.11" = _sxrbqNzu;
        "pkg-1.6.12" = _sjqauABi;
        "pkg-1.6.0-1.20.1" = _XJd0DEFe;
        "pkg-1.7.0" = _cWxKi95p;
        "pkg-1.7.0-1.20.1" = _5laqQcLk;
        "pkg-1.7.1" = _8PJCB1O5;
        "pkg-1.7.1-1.20.1" = _X5zMcHlm;
        "pkg-1.7.2" = _eyuUgoWT;
        "pkg-1.7.2-1.20.1" = _vPPEwQHw;
        "pkg-1.7.3-1.20.1" = _97Z1s9e4;
        "pkg-1.8.0-1.20.1" = _Ng7F97jV;
        "pkg-1.8.1-1.20.1" = _9vfHHqvk;
        "pkg-1.21-1.8.0" = _Simb6QPb;
        "pkg-1.21-1.8.1" = _9nf7Ynjf;
        "pkg-1.21-1.8.2" = _m66cQogE;
        "default" = _m66cQogE;
    });
