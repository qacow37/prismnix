...
let
    ...
    in {
        ...
        "pkg-1+mod" = _kDfpdrxn;
        "pkg-1.1" = _lTzeHniU;
        "pkg-1.1+mod" = _CwkD1cGj;
        "pkg-1.2" = _7ZylozaJ;
        "pkg-1.3" = _MlIMVX0P;
        "pkg-1.3+mod" = _jtnRqhTD;
        "pkg-2" = _N7SHvEUr;
        "pkg-2+mod" = _gFtcuV68;
        "pkg-2.0.1" = _aJiyqCjK;
        "pkg-2.0.1+mod" = _XeQyXACJ;
        "pkg-2.1" = _IoiGnoZJ;
        "pkg-2.1+mod" = _MTXQRPJW;
        "pkg-2.2" = _seNTThLY;
        "pkg-2.2+mod" = _yKg269d6;
        "pkg-2.3.1" = _Y0p7xcV8;
        "pkg-2.3.1+mod" = _bxvKN21w;
        "pkg-2.4" = _4FrIMmPX;
        "pkg-2.4+mod" = _27uYxnQy;
        "pkg-2.4.1" = _aSKKwgZL;
        "pkg-2.4.1+mod" = _dzfXVMOP;
        "pkg-2.4.2" = _Qo53azFE;
        "pkg-2.4.2+mod" = _SFJbQJak;
        "pkg-2.4.3" = _kWc0G54j;
        "pkg-2.4.3+mod" = _B4f7qq07;
        "pkg-2.5-1.20.x" = _xZitzJKh;
        "pkg-2.5-1.20.x+mod" = _9anPXKBK;
        "pkg-2.5" = _pr3WRTah;
        "pkg-2.5+mod" = _KAygrvEx;
        "pkg-2.6" = _XuyjpZWI;
        "pkg-2.6+mod" = _kFuXgfLP;
        "pkg-2.7" = _AKJEfpOk;
        "pkg-2.7+mod" = _y0y9X0hQ;
        "pkg-2.7.1" = _wPBp02NP;
