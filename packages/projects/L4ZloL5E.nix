...
let
    ...
    in {
        ...
        "pkg-4.0.1" = _Osiqz5Xf;
        "pkg-5.0.1" = _OjOXKUUi;
        "pkg-5.0.1.4" = _Q1MvYR2M;
        "pkg-5.0.1.1" = _Vt9NuCs2;
        "pkg-5.0.1.5" = _zFKj4JCM;
        "pkg-5.0.1.3" = _waVH0a5G;
        "pkg-5.0.1.11" = _YKDejR73;
        "pkg-5.0.2.21" = _PSoSUNTw;
        "pkg-5.0.2.22" = _DumLgjKD;
        "pkg-5.0.3.23" = _KTHAnf7M;
        "pkg-6.0.5" = _IktqUIIA;
        "pkg-6.0.6" = _e5YKIr6x;
        "pkg-6.0.7" = _NCLqQsBx;
        "pkg-6.0.8" = _xxBdtgZl;
        ...
        "pkg-9.0.2" = _8OFS34mb;
        "pkg-8.0.4" = _rM7aa03Z;
        "pkg-10.0.1" = _PWX99n1L;
        "pkg-11.0.1" = _X4kseScZ;
        "pkg-11.0.2" = _3QMjeqPC;
        "pkg-12.0.1" = _m8Y76335;
        "pkg-12.0.2" = _yIj3oAFF;
        "pkg-12.0.3" = _IYCFo2Ly;
        "pkg-13.0.1" = _TIGSbjQC;
        "default" = _TIGSbjQC;
    });
