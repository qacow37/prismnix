...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.9-fabric" = _jLD5WFGh;
        "pkg-1.18.2-2.9-fabric" = _zqCRtP4f;
        "pkg-1.19.2-3.1-fabric" = _z6jPSwUA;
        "pkg-1.16.5-2.4-forge" = _pY1d7ySe;
        "pkg-1.18.2-2.6-forge" = _RepG6p1P;
        "pkg-1.19.2-2.8-forge" = _bb38y1CF;
        "pkg-1.16.5-3.2-fabric" = _8lOmAEsB;
        "pkg-1.18.2-3.2-fabric" = _hnUrcliu;
        "pkg-1.19.2-3.2-fabric" = _8zYH57Y8;
        "pkg-1.19.3-3.3-fabric" = _rDiphNbj;
        "pkg-1.19.3-2.8-forge" = _B9XxMD8D;
        "pkg-1.18.2-4.0-forge+fabric" = _ISJPyvEM;
        "pkg-1.19.2-4.0-forge+fabric" = _EyB2A3ZM;
        "pkg-1.19.3-4.0-forge+fabric" = _1jnM6yNY;
        "pkg-1.18.2-4.1-forge+fabric" = _MklKz8Vf;
        "pkg-1.19.2-4.1-forge+fabric" = _2fFD9ZvC;
        "pkg-1.19.3-4.1-forge+fabric" = _prDowe8I;
        "pkg-1.19.4-4.1-forge+fabric" = _ywcVe3YE;
        "pkg-1.20-4.1-forge+fabric" = _e8D2KfDs;
        "pkg-1.20.1-4.1-forge+fabric" = _dmhfjcRZ;
        "pkg-1.18.2-4.2-forge+fabric" = _v8nog9j2;
        "pkg-1.19.2-4.2-forge+fabric" = _iuxT5RkB;
        "pkg-1.19.4-4.2-forge+fabric" = _JGfmOSw2;
        "pkg-1.20.1-4.2-forge+fabric" = _s4XXEqwE;
        "pkg-1.20.2-4.2-forge+fabric" = _Ai6KLsB0;
        "pkg-1.18.2-4.3-forge+fabric" = _uhE1wtqw;
        "pkg-1.19.2-4.3-forge+fabric" = _FhbN2aKP;
        "pkg-1.20.1-4.3-forge+fabric" = _uJA08DT1;
        "pkg-1.20.2-4.3-forge+fabric" = _7OAKd2Vk;
        "pkg-1.20.3-4.3-fabric+forge+neo" = _UH56zn27;
        "pkg-1.20.4-4.3-fabric+forge+neo" = _DyomSb0u;
        "pkg-1.19.2-4.4-fabric+forge+neo" = _WWFNyRDH;
        "pkg-1.20.1-4.4-fabric+forge+neo" = _4Pggdz0U;
        "pkg-1.20.2-4.4-fabric+forge+neo" = _nyMrkDmu;
        "pkg-1.20.4-4.4-fabric+forge+neo" = _pGwXtn1F;
        "pkg-1.19.2-4.5-fabric+forge" = _4Hjj4Tpp;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _XGpqHG3G;
        "pkg-1.20.4-4.5-fabric+forge+neo" = _Zh4CbDMt;
        "pkg-1.20.5-4.5-fabric+neo" = _f7xsEqNR;
        "pkg-1.20.5-4.6-fabric+neo" = _PofIOFIi;
        "pkg-1.20.6-4.6-fabric+forge+neo" = _InwK6Gqk;
        "pkg-1.21.0-4.6-fabric+forge+neo" = _j3SUJUk1;
        "pkg-1.20.1-4.7-fabric+forge+neo" = _bIGMLIMW;
        "pkg-1.20.6-4.7-fabric+forge+neo" = _KxQzLKPZ;
        "pkg-1.21.0-4.7-fabric+forge+neo" = _r6IrmqWy;
        "pkg-1.21.1-4.7-fabric+forge+neo" = _xTAbRPmG;
        "pkg-1.21.2-4.7-fabric+neo" = _dvDk3mCd;
        "pkg-1.21.3-4.7-fabric+forge+neo" = _6UCGOvuG;
        "pkg-1.21.4-4.7-fabric+forge+neo" = _wv829P7S;
        "pkg-1.20.1-4.8-fabric+forge+neo" = _Kj1bqvbV;
        "pkg-1.21.1-4.8-fabric+forge+neo" = _Q7oGfKUE;
        "pkg-1.21.4-4.8-fabric+forge+neo" = _nGp3uScm;
        "pkg-1.21.5-4.8-fabric+forge+neo" = _tUlqOfLY;
        "pkg-1.21.6-4.8-fabric+forge+neo" = _p3jDQ2og;
        "pkg-1.21.6-4.9-fabric+forge+neo" = _8QdMjNlf;
        "pkg-1.21.7-4.9-fabric+forge+neo" = _DrZ1O6DZ;
        "pkg-1.21.8-4.9-fabric+forge+neo" = _iRNn0Rbd;
        "pkg-1.21.9-4.9-fabric+forge+neo" = _S2HTF9xd;
        "pkg-1.21.10-4.9-fabric+forge+neo" = _3a9K15vG;
        "pkg-1.21.11-4.9-fabric+forge+neo" = _KNr4NKDb;
        "pkg-26.1.0-4.9-fabric+forge+neo" = _LozKTZOr;
        "pkg-26.1.1-4.9-fabric+forge+neo" = _owK9SqnM;
        "pkg-26.1.2-4.9-fabric+forge+neo" = _guxtWGso;
        "pkg-1.20.1-5.0-fabric+forge+neo" = _FggDciLp;
        "pkg-1.21.1-5.0-fabric+forge+neo" = _gptaZMhp;
        "pkg-1.21.11-5.0-fabric+forge+neo" = _PjhhP5dA;
        "pkg-26.1.2-5.0-fabric+forge+neo" = _wSbrX5rR;
        "pkg-26.2.0-5.0-fabric+forge+neo" = _N16o09gF;
        "default" = _N16o09gF;
    });
