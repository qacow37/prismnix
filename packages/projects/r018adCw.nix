...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _Oa86RnMm;
        "pkg-1.2.0" = _ttIfdI1D;
        "pkg-1.18.2-1.2.2.e" = _FjssCa89;
        "pkg-1.19.2-1.2.2.f" = _SDRL57su;
        "pkg-1.2.3.f" = _5iYojXLJ;
        "pkg-1.18.2-1.2.3.e" = _9oMGUZUz;
        "pkg-1.3.0.e" = _hMHaK294;
        "pkg-1.3.0.f" = _QfuylVeN;
        "pkg-1.19.2-1.4.0.i" = _XfkSxcsb;
        "pkg-1.18.2-1.4.0.i" = _qjRYPvet;
        "pkg-1.18.2-1.5.1.b-285" = _KpC46PHD;
        "pkg-1.19.2-1.5.1.b-30" = _V8hrspzO;
        "pkg-1.20.1-1.5.4.d-9" = _VJAIx9Ob;
        "pkg-1.19.2-1.5.5.c-36" = _TZjCwjWD;
        "pkg-1.19.2-1.6.1.c-36" = _tgO8DfXa;
        "pkg-1.20.1-1.6.1.d-9" = _pKIuWGzy;
        "pkg-1.18.2-1.5.3.b-285" = _yGNeVacV;
        "pkg-1.19.2-1.7.1.c-36" = _2rQVTUqA;
        "pkg-1.20.1-1.7.3.d-9" = _NVU0zHMW;
        "pkg-1.19.2-1.7.3.c-36" = _MlGLRvvB;
        "pkg-1.19.2-1.7.4.c-36" = _GJrFfZGF;
        "pkg-1.20.1-1.7.4.d-9" = _m4CA3JY8;
        "pkg-1.18.2-1.5.5.b-285" = _1v1jJNVR;
        "pkg-1.19.2-1.7.5.c-36" = _onqcUIjj;
        "pkg-1.20.1-1.8.0.e-22" = _Ljcrec5t;
        "pkg-1.19.2-1.8.0.e-44" = _EV33HMwO;
        "pkg-1.19.2-1.8.1.e-44" = _bYgWxuGU;
        "pkg-1.20.1-1.8.1.e-22" = _mzpzbAnR;
        "pkg-1.20.1-1.8.2.e-22" = _DRsgyEZ3;
        "pkg-1.20.1-1.8.2.h-48" = _32ozQaAU;
        "pkg-1.20.1-1.8.2.i-51" = _z63kUG39;
        "pkg-1.20.1-1.8.2.j-55" = _HRAknR6X;
        "pkg-1.20.1-1.8.3-6.0.2" = _185gGryh;
        "pkg-1.20.1-1.8.4-6.0.3" = _Dddl57MQ;
        "pkg-1.21.1-2.0.0-6.0.4" = _TLzU983v;
        "pkg-1.21.1-2.0.1-6.0.4" = _D2JB1ACX;
        "pkg-1.21.1-2.0.3-6.0.4" = _z4r0Eixa;
        "pkg-1.21.1-2.0.4-6.0.4" = _SaGRhXRy;
        "pkg-1.21.1-2.0.5-6.0.4" = _unMrNpHK;
        "pkg-1.21.1-2.0.6-6.0.4" = _YIaWRiFB;
        "pkg-1.21.1-2.0.7-6.0.4" = _Pqxcjdth;
        "pkg-1.21.1-2.1.0" = _V6U88NC7;
        "pkg-1.21.1-2.1.1" = _mNJ88QhA;
        "pkg-1.21.1-2.1.2" = _AiXSx418;
        "pkg-1.21.1-2.1.3" = _bSe64UvI;
        "pkg-1.21.1-2.1.4" = _HYNyH3xh;
        "pkg-1.20.1-1.8.6-6.0.6" = _GlQRvUIe;
        "pkg-1.21.1-2.1.6" = _4Vqak5jp;
        "pkg-1.21.1-2.2.0" = _wltLQmj3;
        "pkg-1.21.1-2.2.1" = _hk3kHwCT;
        "pkg-1.21.1-2.2.2" = _Api0vjcP;
        "pkg-1.21.1-2.3.0" = _Z5bTlA6P;
        "default" = _Z5bTlA6P;
    });
