...
let
    ...
    in {
        ...
        "pkg-1.13-1.14.4" = _fwwBFAM6;
        "pkg-1.15-1.16.1" = _l2B5voGc;
        "pkg-1.16.2-1.16.5" = _DaUQXHxI;
        "pkg-1.17-1.17.1" = _1Fdb5qJ6;
        "pkg-1.18-1.18.2" = _DC1GwsTR;
        "pkg-1.19-1.19.2" = _iOoumztX;
        "pkg-1.19.3" = _9Hsi6Wii;
        "pkg-1.19.4" = _bidSrhCX;
        "pkg-1.20-1.20.1" = _GW1wP0if;
        "pkg-1.20.2" = _pRfYyawQ;
        "pkg-1.20.3-1.20.4" = _CMPUkZtG;
        "pkg-1.20.5-1.20.6" = _BYu9Iu6l;
        "pkg-1.21-1.21.1" = _4MammT3i;
        "pkg-1.21.2-1.21.3" = _Euj5C9uI;
        "pkg-1.21.4" = _jhjtxjn9;
        "pkg-1.21.5" = _cNkJqdsI;
        "pkg-1.21.6" = _ZH2EEdzV;
        "pkg-1.21.7-1.21.8" = _EesdAyTs;
        "pkg-1.21.9-1.21.10" = _OD2TE7Yu;
        "pkg-1.21.11" = _iHT4ao8g;
