...
let
    ...
    in {
        ...
        "pkg-1.0-SNAPSHOT" = _frMyengY;
        "pkg-1.2_Beta" = _ktgGW4kK;
        "pkg-1.3" = _h4fxPSlu;
        "pkg-1.3_1.21.5_Beta" = _aipRtlcd;
        "pkg-1.4.0+1.20" = _K6AWJOYw;
        "pkg-1.4.0+1.20.1" = _uwsuVKpy;
        "pkg-1.4.0+1.20.2" = _FCalgCQL;
        "pkg-1.4.0+1.20.3" = _7pEtPT09;
        "pkg-1.4.0+1.20.4" = _NGbWtqH2;
        "pkg-1.4.0+1.20.5" = _bAFZzQan;
        "pkg-1.4.0+1.20.6" = _e3hQyhIE;
        "pkg-1.4.0+1.21" = _2KLWUhkq;
        "pkg-1.4.0+1.21.1" = _MONlgGK3;
        "pkg-1.4.0+1.21.2" = _T4LtJv5G;
        "pkg-1.4.0+1.21.3" = _Hr7KAJxD;
        "pkg-1.4.0+1.21.4" = _u02ryj9u;
        "pkg-1.4.0+1.21.5" = _bHOLAO6R;
        "pkg-1.4.0+1.21.6" = _4AQZZQ12;
        "pkg-1.4.0+1.21.7" = _P5KWDzXx;
        "pkg-1.4.0+1.21.8" = _A3T4CQWR;
        "pkg-1.4.0+1.21.9" = _HVI98ryF;
        "pkg-1.4.0+1.21.10" = _n4O8eODl;
        "pkg-1.4.2+1.21.6" = _aHQ7SkXH;
        "pkg-1.4.2+1.21.7" = _mUdrKw8I;
        "pkg-1.4.2+1.21.8" = _yE7029sV;
        "pkg-1.4.2+1.21.1" = _OelKfkDV;
        "pkg-1.4.2+1.20.1" = _4Tr6osEk;
        "default" = _4Tr6osEk;
    });
