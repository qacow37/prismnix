...
let
    ...
    in {
        ...
        "pkg-1.1.8+1.19.x+forge" = _tg6IHhEL;
        "pkg-1.1.8+1.16.5+fabric" = _3bUhBB1l;
        "pkg-1.1.8+1.17.1+fabric" = _9MvXqlEY;
        "pkg-1.1.8+1.18.2+fabric" = _fKjA17WA;
        "pkg-1.1.8+1.19.1+fabric" = _SvLf6Yf9;
        "pkg-1.1.8+1.18.x+forge" = _ZxEadNww;
        "pkg-1.1.8+1.19.2+fabric" = _VyySSQn8;
        "pkg-1.1.8+1.19.3+fabric" = _wxWfpG1M;
        "pkg-1.1.8+1.19.4+fabric" = _pZdI2nCb;
        "pkg-1.1.8+1.20.1+fabric" = _bZUjQkdO;
        "pkg-1.1.8+1.20+fabric" = _oNfANNSY;
        "pkg-1.1.8+1.16.5+forge" = _5qY4OBbd;
        "pkg-1.1.9+1.16.5+fabric" = _Tlb4h1CC;
        "pkg-1.1.9+1.16.5+forge" = _UjCpiUXG;
        "pkg-1.1.9+1.17.1+fabric" = _OUx59LFS;
        "pkg-1.1.9+1.18.2+fabric" = _sJNWoaPE;
        "pkg-1.1.9+1.18.x+forge" = _FDYJaCyl;
        "pkg-1.1.9+1.19.1+fabric" = _AW2mNMdk;
        "pkg-1.1.9+1.19.2+fabric" = _UiSvuv3G;
        "pkg-1.1.9+1.19.3+fabric" = _TVCy7E9o;
        "pkg-1.1.9+1.19.4+fabric" = _osyF1i31;
        "pkg-1.1.9+1.20.1+fabric" = _z5a0laug;
        "pkg-1.1.9+1.20+fabric" = _Dz4jp8QZ;
        "pkg-1.1.10+1.19.x+forge" = _fulGoMjX;
        "pkg-1.1.10+1.18.x+forge" = _DhEHzYt3;
        "pkg-1.1.10+1.16.5+forge" = _qLJpyuw7;
        "pkg-1.1.11+1.18.x+forge" = _PiTWGLg9;
        "pkg-1.1.11+1.19.x+forge" = _NctoeQs3;
        "pkg-1.1.11+1.20.2+fabric" = _hNKjZodS;
        "pkg-1.1.11+1.20.1+forge" = _OQ7kHhnU;
        "pkg-1.1.11+1.20.2+forge" = _WBLPm8NV;
        "pkg-1.1.12+1.20.2+fabric" = _Hzl9lb13;
        "pkg-1.1.12+1.17.1+fabric" = _FT0F3cQs;
        "pkg-1.1.12+1.16.5+fabric" = _K9onX5Nl;
        "pkg-1.1.12+1.18.2+fabric" = _6GMpKkhj;
        "pkg-1.1.12+1.19.1+fabric" = _4EWfJvMi;
        "pkg-1.1.12+1.19.2+fabric" = _Em3jm9zE;
        "pkg-1.1.12+1.19.3+fabric" = _LKcZFcI0;
        "pkg-1.1.12+1.19.4+fabric" = _G4MNxfCm;
        "pkg-1.1.12+1.20+fabric" = _TJwKfpwv;
        "pkg-1.1.12+1.20.1+fabric" = _60itFWjv;
        "pkg-1.1.12+1.18.x+forge" = _O9Xlifxh;
        "pkg-1.1.12+1.20.1+forge" = _fez3jR9F;
        "pkg-1.1.12+1.19.x+forge" = _khFpDyiw;
        "pkg-1.1.12+1.20.2+forge" = _KiUryvw1;
        "pkg-1.1.13" = _6Ymrrso3;
        "pkg-1.1.14+1.16.5+forge" = _C0y8JhNt;
        "pkg-1.1.14+1.18.x+forge" = _ofj0VQyj;
        "pkg-1.1.14+1.19.x+forge" = _mgWD1px1;
        "pkg-1.1.14+1.20.1+forge" = _ktxArBeg;
        "pkg-1.1.14+1.20.2+forge" = _nrE9olUK;
        "pkg-1.2.0+1.16.5+fabric" = _C2EjHtTE;
        "pkg-1.2.0+1.17.1+fabric" = _nJtorMiv;
        "pkg-1.2.0+1.18.2+fabric" = _vAfrTFAi;
        "pkg-1.2.0+1.19.1+fabric" = _RGiTGrD2;
        "pkg-1.2.0+1.19.2+fabric" = _Bz0IuDmI;
        "pkg-1.2.0+1.19.3+fabric" = _XxbhSbvL;
        "pkg-1.2.0+1.19.4+fabric" = _k33aoS98;
        "pkg-1.2.0+1.20+fabric" = _prV2IXyT;
        "pkg-1.2.0+1.20.1+fabric" = _UJIFq70T;
        "pkg-1.2.0+1.20.2+fabric" = _qQzsOBRj;
        "pkg-1.2.0+1.20.3+fabric" = _L71uLejD;
        "pkg-1.2.0+1.20.4+fabric" = _IGoT9Kws;
        "pkg-1.2.0+1.16.5+forge" = _U9ZEqY8o;
        "pkg-1.2.0+1.18.x+forge" = _W03Cj0NW;
        "pkg-1.2.0+1.19.x+forge" = _V9VPvxh2;
        "pkg-1.2.0+1.20.1+forge" = _YWGmR7t7;
        "pkg-1.2.0+1.20.2+forge" = _pnfcLZXg;
        "pkg-1.2.0+1.20.3+forge" = _nyTeWFcu;
        "pkg-1.2.1+1.16.5+fabric" = _8jaIDzvA;
        "pkg-1.2.1+1.16.5+forge" = _uoUT4ZL3;
        "pkg-1.2.2+1.16.5+forge" = _4XbFZ3tY;
        "pkg-1.2.2+1.20.2+neoforge" = _2KT1aJri;
        "pkg-1.2.2+1.20.3+neoforge" = _hY7xUnrm;
        "pkg-1.2.2+1.20.4+neoforge" = _srDp906T;
        "pkg-1.2.2+1.20.3+fabric" = _5LsE5e5p;
        "pkg-1.2.2+1.20.4+fabric" = _1M7hfeuO;
        "pkg-1.2.2+1.20.4+forge" = _cfIHAkWH;
        "pkg-1.2.3+1.16.5+fabric" = _7roiDqBZ;
        "pkg-1.2.3+1.16.5+forge" = _CwC675G1;
        "pkg-1.2.3+1.17.1+fabric" = _bmcpFIvH;
        "pkg-1.2.3+1.18.2+fabric" = _9jE7k0Xk;
        "pkg-1.2.3+1.18.x+forge" = _6UCvMofR;
        "pkg-1.2.3+1.19.1+fabric" = _9NtB0HNR;
        "pkg-1.2.3+1.19.2+fabric" = _61Tsyt5R;
        "pkg-1.2.3+1.19.3+fabric" = _Pm1aPlWM;
        "pkg-1.2.3+1.19.4+fabric" = _E3PYFpYp;
        "pkg-1.2.3+1.19.x+forge" = _Q5fRvV5M;
        "pkg-1.2.3+1.20+fabric" = _vXtFEwO8;
        "pkg-1.2.3+1.20.1+fabric" = _e0rF5dq6;
        "pkg-1.2.3+1.20.1+forge" = _fzgdYxq0;
        "pkg-1.2.3+1.20.2+fabric" = _R6IFCxJo;
        "pkg-1.2.3+1.20.2+forge" = _JeIJllRm;
        "pkg-1.2.3+1.20.2+neoforge" = _ZbCpUmlO;
        "pkg-1.2.3+1.20.3+fabric" = _c1N4Fm5C;
        "pkg-1.2.3+1.20.3+neoforge" = _ku22y3TV;
        "pkg-1.2.3+1.20.4+fabric" = _SbY9YOsn;
        "pkg-1.2.3+1.20.4+forge" = _h7bAuNF6;
        "pkg-1.2.3+1.20.4+neoforge" = _ebzOfreq;
        "pkg-1.2.4+1.20.3+fabric" = _uZyHWIoZ;
        "pkg-1.2.4+1.20.4+fabric" = _GF8UkYu5;
        "pkg-1.2.4+1.19.2+fabric" = _7CAy92T1;
        "pkg-1.2.4+1.16.5+fabric" = _G1heeNA8;
        "pkg-1.2.4+1.17.1+fabric" = _5Xanurv0;
        "pkg-1.2.4+1.18.2+fabric" = _gPzENBec;
        "pkg-1.2.4+1.18.x+forge" = _1EYYXcB5;
        "pkg-1.2.4+1.19.1+fabric" = _t7xUkqIX;
        "pkg-1.2.4+1.19.3+fabric" = _vMynNwJb;
        "pkg-1.2.4+1.19.4+fabric" = _UmZX04rZ;
        "pkg-1.2.4+1.19.x+forge" = _xrzTMEaQ;
        "pkg-1.2.4+1.20+fabric" = _g5FpeIAW;
        "pkg-1.2.4+1.20.1+fabric" = _deSJjIPv;
        "pkg-1.2.4+1.20.1+forge" = _p1fWsY0e;
        "pkg-1.2.4+1.20.2+fabric" = _Z8entQ9L;
        "pkg-1.2.4+1.20.2+forge" = _LqeGEcnB;
        "pkg-1.2.4+1.20.2+neoforge" = _IqaBMl84;
        "pkg-1.2.4+1.20.3+neoforge" = _5ufVA6OO;
        "pkg-1.2.4+1.20.4+forge" = _5llbHL4z;
        "pkg-1.2.4+1.20.4+neoforge" = _yYgDRsyi;
        "pkg-1.2.4+1.20.5+fabric" = _xc2haTgH;
        "pkg-1.2.4+1.21+fabric" = _Ll5Uk3Ju;
        "pkg-1.2.5+1.20.1+fabric" = _lx4nCSIQ;
        "pkg-1.2.5+1.20.5+fabric" = _lb0gV1sP;
        "pkg-1.2.5+1.21+fabric" = _KHtrOCoU;
        "pkg-1.3.0+1.16.5+fabric" = _aTxdCYJI;
        "pkg-1.3.0+1.18.2+fabric" = _w5tTnm4i;
        "pkg-1.3.0+1.19.3+fabric" = _QfgoBics;
        "pkg-1.3.0+1.20.5+fabric" = _RmSvfYzd;
        "pkg-1.3.0+1.20+fabric" = _PeUu1TL4;
        "pkg-1.3.0+1.19.4+fabric" = _uPKGW6iC;
        "pkg-1.3.0+1.20.3+fabric" = _WoVP0kyn;
        "pkg-1.3.0+1.19.1+fabric" = _1OzSuPXz;
        "pkg-1.3.0+1.19.2+fabric" = _BsvWKMAG;
        "pkg-1.3.0+1.21+fabric" = _c2IyB2XX;
        "pkg-1.3.0+1.21.2+fabric" = _hTuo9ZFN;
        "pkg-1.3.0+1.16.5+forge" = _rIaSzNQ5;
        "pkg-1.3.0+1.21.0+neoforge" = _rlJHDsAZ;
        "pkg-1.3.0+1.20.3+neoforge" = _r9qtKlB2;
        "pkg-1.3.0+1.20.5+neoforge" = _G2dUi4rZ;
        "pkg-1.3.0+1.20.2+neoforge" = _j9uii7oa;
        "pkg-1.3.0+1.20.4+neoforge" = _1m8pEUiF;
        "pkg-1.3.0+1.18.2+forge" = _nvA6vtPw;
        "pkg-1.3.0+1.19+forge" = _yiBXlQCZ;
        "pkg-1.3.0+1.20.3+forge" = _w5qkSTvj;
        "pkg-1.3.0+1.20.2+forge" = _3phyQvrG;
        "pkg-1.3.0+1.20+forge" = _AeUZtPKq;
        "pkg-1.3.0+1.21.2+neoforge" = _RV7sf6t0;
        "pkg-1.3.0+1.21.4+fabric" = _WT4gtL8z;
        "pkg-1.3.2+1.18.2+fabric" = _qjWfQnkc;
        "pkg-1.3.2+1.16.5+fabric" = _aVqxM8Lp;
        "pkg-1.3.2+1.19.4+fabric" = _mrxbFmgA;
        "pkg-1.3.2+1.20+fabric" = _rq2o31XG;
        "pkg-1.3.2+1.19.1+fabric" = _IRCzsJlu;
        "pkg-1.3.2+1.20.3+fabric" = _WAp7bDk1;
        "pkg-1.3.2+1.19.3+fabric" = _3xPczaq7;
        "pkg-1.3.2+1.20.5+fabric" = _TB3PBc5c;
        "pkg-1.3.2+1.19.2+fabric" = _3Zrcw45M;
        "pkg-1.3.2+1.16.5+forge" = _CQwaZGEJ;
        "pkg-1.3.2+1.21+fabric" = _RG9HJftE;
        "pkg-1.3.2+1.21.4+fabric" = _FqlbklUI;
        "pkg-1.3.2+1.21.2+fabric" = _PmGBpUaC;
        "pkg-1.3.2+1.20.5+neoforge" = _gsEueaeh;
        "pkg-1.3.2+1.20.2+neoforge" = _3mDE3S6b;
        "pkg-1.3.2+1.20.3+neoforge" = _Bpi5qGty;
        "pkg-1.3.2+1.21.0+neoforge" = _LPI0nHsq;
        "pkg-1.3.2+1.20.4+neoforge" = _8HoJ8r8J;
        "pkg-1.3.2+1.19+forge" = _BULXHQkj;
        "pkg-1.3.2+1.20+forge" = _LVDZ2bQ6;
        "pkg-1.3.2+1.20.3+forge" = _TeHjTRfI;
        "pkg-1.3.2+1.21.2+neoforge" = _z45QUJzb;
        "pkg-1.3.2+1.18.2+forge" = _sUJA2XBm;
        "pkg-1.3.2+1.20.2+forge" = _ojtzKVvj;
        "pkg-1.3.2+1.21.4+neoforge" = _8cCEd6J7;
        "pkg-1.3.3+1.19.2+fabric" = _K4Qn1bKm;
        "pkg-1.3.3+1.20.5+fabric" = _X1QH2uqH;
        "pkg-1.3.3+1.19.3+fabric" = _6izqdzjq;
        "pkg-1.3.3+1.20.3+fabric" = _lFOHPLAR;
        "pkg-1.3.3+1.16.5+fabric" = _qrnW9RoY;
        "pkg-1.3.3+1.18.2+fabric" = _hoTiZZMr;
        "pkg-1.3.3+1.19.1+fabric" = _qsRXxpW0;
        "pkg-1.3.3+1.20+fabric" = _NSHSxW3L;
        "pkg-1.3.3+1.19.4+fabric" = _bOudET3G;
        "pkg-1.3.3+1.16.5+forge" = _ivMET4xs;
        "pkg-1.3.3+1.21.2+fabric" = _yP4y7Dz1;
        "pkg-1.3.3+1.21+fabric" = _ATj5GuOb;
        "pkg-1.3.3+1.21.4+fabric" = _77W9ZXmW;
        "pkg-1.3.3+1.21.0+neoforge" = _IovhRH50;
        "pkg-1.3.3+1.20.3+neoforge" = _lyMPqwCe;
        "pkg-1.3.3+1.20.2+neoforge" = _kjrbymB3;
        "pkg-1.3.3+1.20.4+neoforge" = _saDusYYc;
        "pkg-1.3.3+1.20.5+neoforge" = _sQWDsIIP;
        "pkg-1.3.3+1.21.4+neoforge" = _lFkG5Xsu;
        "pkg-1.3.3+1.21.2+neoforge" = _m2xmXEdC;
        "pkg-1.3.3+1.20.3+forge" = _5TdxzivN;
        "pkg-1.3.3+1.20.2+forge" = _RUM5i2Ct;
        "pkg-1.3.3+1.20+forge" = _kFkSfR9k;
        "pkg-1.3.3+1.18.2+forge" = _91LYWAUH;
        "pkg-1.3.3+1.19+forge" = _VcB9goYD;
        "pkg-1.4.0+1.21.0+neoforge" = _KnbGC4Di;
        "pkg-1.4.0+1.16.5+fabric" = _feyCmyX2;
        "pkg-1.4.0+1.21+fabric" = _SbjaLtTu;
        "pkg-1.4.0+1.21.4+neoforge" = _BJ1zJ78u;
        "pkg-1.4.0+1.20+fabric" = _vimJP6TH;
        "pkg-1.4.0+1.19.4+fabric" = _lBV22pDo;
        "pkg-1.4.0+1.19.1+fabric" = _8EMlYnwT;
        "pkg-1.4.0+1.19+forge" = _kMUS6dr9;
        "pkg-1.4.0+1.21.4+fabric" = _5n5GRy2E;
        "pkg-1.4.0+1.21.2+neoforge" = _1r3nZMdQ;
        "pkg-1.4.0+1.19.2+fabric" = _Ew3D3nAf;
        "pkg-1.4.0+1.20.3+fabric" = _bBBKoxoV;
        "pkg-1.4.0+1.21.2+fabric" = _pyZuFAo0;
        "pkg-1.4.0+1.19.3+fabric" = _RobipnYG;
        "pkg-1.4.0+1.16.5+forge" = _MvXZY2wL;
        "pkg-1.4.0+1.20.5+fabric" = _ngIjJCxA;
        "pkg-1.4.0+1.20.3+neoforge" = _rNisurE3;
        "pkg-1.4.0+1.18.2+forge" = _UsC207ZL;
        "pkg-1.4.0+1.20.4+neoforge" = _hGySMsln;
        "pkg-1.4.0+1.20.5+neoforge" = _DQkUs2MX;
        "pkg-1.4.0+1.18.2+fabric" = _H0dheOYV;
        "pkg-1.4.0+1.20.2+forge" = _x2fDwZKT;
        "pkg-1.4.0+1.20+forge" = _uuFL9U52;
        "pkg-1.4.0+1.20.2+neoforge" = _h2si7k1R;
        "pkg-1.4.0+1.20.3+forge" = _kSpAYW68;
        "pkg-1.4.1+1.19.1+fabric" = _lPUbp3V6;
        "pkg-1.4.1+1.21.2+fabric" = _iSWzfltP;
        "pkg-1.4.1+1.21+fabric" = _iiZPnJk7;
        "pkg-1.4.1+1.21.0+neoforge" = _D1l9O2Qu;
        "pkg-1.4.1+1.20.3+forge" = _hvIv93v8;
        "pkg-1.4.1+1.19.2+fabric" = _HNhN4zFJ;
        "pkg-1.4.1+1.18.2+forge" = _ch4pzsm0;
        "pkg-1.4.1+1.21.4+fabric" = _hsFqrQZC;
        "pkg-1.4.1+1.18.2+fabric" = _QBwHLkLy;
        "pkg-1.4.1+1.19+forge" = _YxBJUHTD;
        "pkg-1.4.1+1.20.2+forge" = _NDoXz8Me;
        "pkg-1.4.1+1.16.5+forge" = _9RjB4T1W;
        "pkg-1.4.1+1.20+forge" = _JUaYckTw;
        "pkg-1.4.1+1.20.3+fabric" = _wH7Wi8GJ;
        "pkg-1.4.1+1.21.4+neoforge" = _2RTyED0e;
        "pkg-1.4.1+1.21.2+neoforge" = _658nYGBN;
        "pkg-1.4.1+1.20+fabric" = _n2R8FzSu;
        "pkg-1.4.1+1.20.2+neoforge" = _pfQa7Ijo;
        "pkg-1.4.1+1.20.4+neoforge" = _4LitjfFY;
        "pkg-1.4.1+1.20.3+neoforge" = _KCUaAMb0;
        "pkg-1.4.1+1.16.5+fabric" = _N0Wa6Q0L;
        "pkg-1.4.1+1.19.3+fabric" = _YMadEbay;
        "pkg-1.4.1+1.20.5+fabric" = _jj4kbVpH;
        "pkg-1.4.1+1.20.5+neoforge" = _6JVt8sCz;
        "pkg-1.4.1+1.19.4+fabric" = _d0fnKL3U;
        "pkg-1.4.2+1.19.1+fabric" = _HRK5PSf9;
        "pkg-1.4.2+1.19.2+fabric" = _ngimKGac;
        "pkg-1.4.2+1.21.2+fabric" = _cPbZGTx0;
        "pkg-1.4.2+1.21.4+fabric" = _XUcD2lUZ;
        "pkg-1.4.2+1.16.5+forge" = _X8j0n6kb;
        "pkg-1.4.2+1.18.2+fabric" = _IeJf4X7y;
        "pkg-1.4.2+1.19.3+fabric" = _CJJWXgWm;
        "pkg-1.4.2+1.18.2+forge" = _Xfj8P2rz;
        "pkg-1.4.2+1.20.3+neoforge" = _E2HN8D9Z;
        "pkg-1.4.2+1.20.4+neoforge" = _Gcyx2q8o;
        "pkg-1.4.2+1.20.3+fabric" = _XvE4icfa;
        "pkg-1.4.2+1.20.5+neoforge" = _Hbz16I3g;
        "pkg-1.4.2+1.16.5+fabric" = _iR8X6y12;
        "pkg-1.4.2+1.20+fabric" = _uJ4Idgcs;
        "pkg-1.4.2+1.21+fabric" = _9Aa9vSOp;
        "pkg-1.4.2+1.21.0+neoforge" = _E54SBp5f;
        "pkg-1.4.2+1.19+forge" = _5vvdkacr;
        "pkg-1.4.2+1.20+forge" = _uRBOExCm;
        "pkg-1.4.2+1.21.4+neoforge" = _9f7PdEO1;
        "pkg-1.4.2+1.20.3+forge" = _lkBAIswq;
        "pkg-1.4.2+1.19.4+fabric" = _DnpJdCNY;
        "pkg-1.4.2+1.20.5+fabric" = _DY3YiQdn;
        "pkg-1.4.2+1.20.2+neoforge" = _VftpBJqi;
        "pkg-1.4.2+1.21.2+neoforge" = _byUXVI7J;
        "pkg-1.4.2+1.20.2+forge" = _SBpvOWAB;
        "pkg-1.4.4+1.16.5+fabric" = _wN16HB3U;
        "pkg-1.4.4+1.20.5+fabric" = _XEmu7JZh;
        "pkg-1.4.4+1.21+fabric" = _qSDaR7gU;
        "pkg-1.4.4+1.19.2+fabric" = _ayzoQ1vn;
        "pkg-1.4.4+1.21.4+neoforge" = _3hvoHbGk;
        "pkg-1.4.4+1.19+forge" = _ANBrFHTn;
        "pkg-1.4.4+1.20.2+forge" = _q6sGaRSj;
        "pkg-1.4.4+1.21.2+fabric" = _e5OSqYuy;
        "pkg-1.4.4+1.20+forge" = _FkLLfif5;
        "pkg-1.4.4+1.18.2+forge" = _EwolAuiU;
        "pkg-1.4.4+1.21.0+neoforge" = _WLbJsdi2;
        "pkg-1.4.4+1.19.1+fabric" = _QA7sUiVJ;
        "pkg-1.4.4+1.20.3+forge" = _WBVOXI6K;
        "pkg-1.4.4+1.20.3+neoforge" = _3zJ5d7gD;
        "pkg-1.4.4+1.20.5+neoforge" = _HG2uwpYl;
        "pkg-1.4.4+1.20.2+neoforge" = _pHwj3I0W;
        "pkg-1.4.4+1.19.4+fabric" = _44LofrcV;
        "pkg-1.4.4+1.20.4+neoforge" = _2LaqVAnd;
        "pkg-1.4.4+1.21.4+fabric" = _1JOt5Cpc;
        "pkg-1.4.4+1.16.5+forge" = _9U7i19lI;
        "pkg-1.4.4+1.19.3+fabric" = _f9Xfju3y;
        "pkg-1.4.4+1.20+fabric" = _YYwJh7jE;
        "pkg-1.4.4+1.20.3+fabric" = _cMBR0p7J;
        "pkg-1.4.4+1.21.2+neoforge" = _LCxdv4Sd;
        "pkg-1.4.4+1.18.2+fabric" = _vDVBWSUd;
        "pkg-1.4.5+1.20.2+forge" = _lrvxBWxS;
        "pkg-1.4.5+1.21.2+fabric" = _CExdGBsZ;
        "pkg-1.4.5+1.19.4+fabric" = _uueBsFTM;
        "pkg-1.4.5+1.20.5+fabric" = _qD4YodVH;
        "pkg-1.4.5+1.20+forge" = _1HfV2kyN;
        "pkg-1.4.5+1.18.2+forge" = _KN3IFUfc;
        "pkg-1.4.5+1.21.0+neoforge" = _BxC24Ldj;
        "pkg-1.4.5+1.19.3+fabric" = _BeAGqIvT;
        "pkg-1.4.5+1.20.3+forge" = _Tv70pwdU;
        "pkg-1.4.5+1.19.1+fabric" = _vR6a64mC;
        "pkg-1.4.5+1.21.4+neoforge" = _sPQAEgjH;
        "pkg-1.4.5+1.16.5+forge" = _RVSdvmGt;
        "pkg-1.4.5+1.19+forge" = _nqiqhaT7;
        "pkg-1.4.5+1.19.2+fabric" = _kYSZN4Vd;
        "pkg-1.4.5+1.18.2+fabric" = _GV67J7S7;
        "pkg-1.4.5+1.20.3+fabric" = _nBOQWWIM;
        "pkg-1.4.5+1.21.2+neoforge" = _DSSoLhbC;
        "pkg-1.4.5+1.20.4+neoforge" = _V8neQ0y9;
        "pkg-1.4.5+1.21.4+fabric" = _UOpyzLyt;
        "pkg-1.4.5+1.20.2+neoforge" = _ruUT4btk;
        "pkg-1.4.5+1.21+fabric" = _DboKFlGf;
        "pkg-1.4.5+1.20+fabric" = _hsOK7IA9;
        "pkg-1.4.5+1.16.5+fabric" = _bQCYO9MW;
        "pkg-1.4.5+1.20.3+neoforge" = _KgodSGyL;
        "pkg-1.4.5+1.20.5+neoforge" = _mRMEwLlT;
        "pkg-1.4.6+1.21.2+fabric" = _fY9qRplP;
        "pkg-1.4.6+1.18.2+fabric" = _6SKcWdqy;
        "pkg-1.4.6+1.19.4+fabric" = _61hv44BH;
        "pkg-1.4.6+1.20.2+forge" = _8gjfwPsC;
        "pkg-1.4.6+1.16.5+fabric" = _dlr12xon;
        "pkg-1.4.6+1.20.3+fabric" = _nTYtbbIh;
        "pkg-1.4.6+1.19.3+fabric" = _AITPVn2s;
        "pkg-1.4.6+1.19.2+fabric" = _jeHsITMt;
        "pkg-1.4.6+1.20+fabric" = _hZNruLvN;
        "pkg-1.4.6+1.20.3+forge" = _8mVl6Q0z;
        "pkg-1.4.6+1.18.2+forge" = _zUkKPuXE;
        "pkg-1.4.6+1.21.2+neoforge" = _LIngqdJP;
        "pkg-1.4.6+1.21+fabric" = _zgaAHWZW;
        "pkg-1.4.6+1.21.0+neoforge" = _HGM9qRpp;
        "pkg-1.4.6+1.20.2+neoforge" = _k8RvERu8;
        "pkg-1.4.6+1.21.4+neoforge" = _etjnMayZ;
        "pkg-1.4.6+1.20.5+neoforge" = _kH3jWSDO;
        "pkg-1.4.6+1.20.5+fabric" = _gxKqCtRk;
        "pkg-1.4.6+1.20+forge" = _bP2zZL3V;
        "pkg-1.4.6+1.19.1+fabric" = _od27BWdb;
        "pkg-1.4.6+1.19+forge" = _cQh7SPfa;
        "pkg-1.4.6+1.20.3+neoforge" = _WIenGGUy;
        "pkg-1.4.6+1.21.4+fabric" = _iihmOiVk;
        "pkg-1.4.6+1.16.5+forge" = _UchAj7Vr;
        "pkg-1.4.6+1.20.4+neoforge" = _lJHyh40c;
        "pkg-1.4.6+1.21.5+fabric" = _46i4Nhnt;
        "pkg-1.4.6+1.21.5+neoforge" = _8lLY3D9C;
        "pkg-1.4.7+1.19.4+fabric" = _ZNMQ0zuW;
        "pkg-1.4.7+1.19.2+fabric" = _yncuAZBD;
        "pkg-1.4.7+1.16.5+fabric" = _dWGlJoMJ;
        "pkg-1.4.7+1.19.1+fabric" = _RiSVwgzE;
        "pkg-1.4.7+1.21.5+neoforge" = _SudaeBdR;
        "pkg-1.4.7+1.21.4+neoforge" = _I71FquRt;
        "pkg-1.4.7+1.21.5+fabric" = _UIjQZLGg;
        "pkg-1.4.7+1.16.5+forge" = _O0jsZcSJ;
        "pkg-1.4.7+1.20+fabric" = _O9ItkRDK;
        "pkg-1.4.7+1.18.2+forge" = _atHB3DlM;
        "pkg-1.4.7+1.19.3+fabric" = _jjKshPTn;
        "pkg-1.4.7+1.20+forge" = _C4U6NF0q;
        "pkg-1.4.7+1.21.2+neoforge" = _Wcu4X4t8;
        "pkg-1.4.7+1.21.2+fabric" = _WLMbBDev;
        "pkg-1.4.7+1.21+fabric" = _UXeFgRSY;
        "pkg-1.4.7+1.20.3+forge" = _RgzO6zKj;
        "pkg-1.4.7+1.20.5+fabric" = _VMMTNQK8;
        "pkg-1.4.7+1.20.3+neoforge" = _wuBCWYed;
        "pkg-1.4.7+1.20.5+neoforge" = _XvSOH68F;
        "pkg-1.4.7+1.20.3+fabric" = _D4vY1HZi;
        "pkg-1.4.7+1.19+forge" = _ZKezY3aA;
        "pkg-1.4.7+1.20.2+neoforge" = _WuYTPzdL;
        "pkg-1.4.7+1.18.2+fabric" = _Kl9qvGlO;
        "pkg-1.4.7+1.20.2+forge" = _e9C8XEwJ;
        "pkg-1.4.7+1.21.0+neoforge" = _hqAoNNVF;
        "pkg-1.4.7+1.21.4+fabric" = _v2hJhFkv;
        "pkg-1.4.7+1.20.4+neoforge" = _s8O07AJj;
        "pkg-1.4.7+1.21.6+fabric" = _sfOkar5t;
        "pkg-1.4.7+1.21.9+fabric" = _fQy4Xziw;
        "pkg-1.4.7+1.21.6+neoforge" = _KviMVXyS;
        "default" = _KviMVXyS;
    });
