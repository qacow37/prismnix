...
let
    ...
    in {
        ...
        "pkg-1.0.6" = _mnz95yqa;
        "pkg-1.0.9" = _vQWOtQ9z;
        "pkg-1.0.10" = _PYmnCm2u;
        "pkg-1.0.11" = _eemV8NhR;
        "pkg-1.0.3" = _yLb1Evrf;
        "pkg-1.0.7" = _C3XCfqcS;
        "pkg-1.0.14" = _TxSwhISy;
        "pkg-1.0.18" = _osfDwuGY;
        "pkg-1.0.19" = _pU59BUAi;
        "pkg-1.0.20" = _UmneEpqW;
        "pkg-1.0.21" = _CXuUawJA;
        "pkg-1.0.22" = _OJbfS83n;
        "pkg-1.0.23" = _kOWLVHK5;
        "pkg-1.0.24" = _W3SbhkFs;
        "pkg-1.0.25" = _EVu351A1;
        "pkg-1.0.26" = _v844wB4f;
        "pkg-1.0.27" = _mAq27NHC;
        "pkg-1.0.28" = _ZVfuxuFm;
        "pkg-1.0.29" = _AfepiIm8;
        "pkg-1.0.32" = _3V6Krnjt;
        "pkg-1.0.33" = _fGndJkxP;
        "pkg-1.0.34" = _REzoyUiu;
        "pkg-1.0.35" = _KewNbDtD;
        "pkg-1.0.36" = _35LYCX8a;
        "pkg-1.0.37" = _nsVhgGnd;
        "pkg-1.0.38" = _gM8xgj1n;
        "pkg-1.0.39" = _inwhvlLh;
        "default" = _inwhvlLh;
    });
