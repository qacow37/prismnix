...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.9-fabric" = _ImEFFzs3;
        "pkg-1.18.2-1.9-fabric" = _v0AQN6yX;
        "pkg-1.19.2-2.1-fabric" = _1tdLqnWT;
        "pkg-1.16.5-1.4-forge" = _pMqPfeFq;
        "pkg-1.18.2-1.6-forge" = _5h6G2ha4;
        "pkg-1.19.2-1.8-forge" = _tDJT5kBG;
        "pkg-1.16.5-2.2-fabric" = _HqZRct9Z;
        "pkg-1.18.2-2.2-fabric" = _Bzuh78Av;
        "pkg-1.19.2-2.2-fabric" = _A6yQvniI;
        "pkg-1.19.3-2.3-fabric" = _21AAU5S1;
        "pkg-1.19.3-1.8-forge" = _dFa9CEvb;
        "pkg-1.18.2-3.0-forge+fabric" = _x0EZYINd;
        "pkg-1.19.2-3.0-forge+fabric" = _AeCAweIw;
        "pkg-1.19.3-3.0-forge+fabric" = _ljxri3sC;
        "pkg-1.19.4-3.0-forge+fabric" = _yr2S01eH;
        "pkg-1.20-3.0-forge+fabric" = _nUYPq1s0;
        "pkg-1.20.1-3.0-forge+fabric" = _tmzr33wg;
        "pkg-1.20.2-3.0-forge+fabric" = _ai8U2jAP;
        "pkg-1.18.2-3.1-forge+fabric" = _TNaAGChO;
        "pkg-1.19.2-3.1-forge+fabric" = _otHx2Z8Z;
        "pkg-1.20.1-3.1-forge+fabric" = _C5iktigw;
        "pkg-1.20.2-3.1-forge+fabric" = _gZfB1xMp;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _VoBiGV5R;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _A1KzMOWo;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _7MFcBayp;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _XpjSUCI8;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _CjuZWt6O;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _oTgLquyP;
        "pkg-1.20.5-3.2-fabric+neo" = _OSGdaz1C;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _PdOzNzIx;
        "pkg-1.21.0-3.2-fabric+forge+neo" = _4PbTOoze;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _BKLFbQWT;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _w2FpcHU9;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _PlF44iQM;
        "pkg-1.21.1-3.3-fabric+forge+neo" = _yqyqw03X;
        "pkg-1.21.2-3.3-fabric+neo" = _fPJHjoG9;
        "pkg-1.21.3-3.3-fabric+forge+neo" = _Si6acbZs;
        "pkg-1.21.4-3.3-fabric+forge+neo" = _XoJzGRQj;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _pC5QThBP;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _RnWSv8yZ;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _qqSy16ac;
        "pkg-1.21.5-3.4-fabric+forge+neo" = _Dmg5QFOJ;
        "pkg-1.21.6-3.4-fabric+forge+neo" = _zd5B30t2;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _N4b1Uuxl;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _fPzpSEQM;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _SoXBKZzF;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _Qrqg6rzm;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _dAH0WoBN;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _EhtNAwLM;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _1azIuu15;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _cdajDsg6;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _iSUmkzPo;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _6NBNY0ex;
        "default" = _6NBNY0ex;
    });
