...
let
    ...
    in {
        ...
        "pkg-v1.0.2" = _lE5IYfth;
        "pkg-v1.0.2+mod" = _hbyjxIAy;
        "pkg-v1.1.0" = _gPj1bLO7;
        "pkg-v1.1.0+mod" = _9hwtfbg7;
        "pkg-v1.1.1" = _OlBUWf5D;
        "pkg-v1.1.1+mod" = _HYFw1SeE;
        "pkg-v2.0.2" = _GjX99ODf;
        "pkg-v2.0.2+mod" = _bZpd7Ns8;
        "pkg-v2.1.3" = _8ZzMBW2N;
        "pkg-v2.1.3+mod" = _yS9d9ipl;
        "pkg-v2.1.4" = _2pRVBzBZ;
        "pkg-v2.1.4+mod" = _8l6YfN71;
        "pkg-v2.2.0" = _D6NTemUi;
        "pkg-v2.2.0+mod" = _hXTBHhDZ;
        "pkg-v2.2.1" = _SQZoWwhG;
        "pkg-v2.2.1+mod" = _oWcadRP6;
        "pkg-v2.2.2" = _GorJHMVl;
        "pkg-v2.2.2+mod" = _SlEHKh5D;
        "pkg-v2.3.0" = _jJ9Qi4g4;
        "pkg-v2.3.0+mod" = _aVhQCO5u;
        "pkg-v2.3.1" = _cP1OqCdT;
        "pkg-v2.3.1+mod" = _duemcvuz;
        "pkg-v2.3.2" = _sjROOXzk;
        "pkg-v2.3.2+mod" = _i6OhwkWf;
        "pkg-v2.4.0" = _WIrNHSkk;
        "pkg-v2.4.0+mod" = _FtGK2FtQ;
        "pkg-v2.4.1" = _dth1CT0t;
        "pkg-v2.4.1+mod" = _uzC1g2j0;
        "pkg-v2.4.2" = _OMvZN9D9;
        "pkg-v2.4.2+mod" = _3FbRCWS7;
        "pkg-v2.4.3" = _679ONqbJ;
        "pkg-v2.4.3+mod" = _VeIip6fD;
        "pkg-v2.4.5" = _oGHMAcse;
        "pkg-v2.4.5+mod" = _3lvYZPXm;
        "pkg-v2.4.8" = _S4fu4TDd;
        "pkg-v2.4.8+mod" = _1gC2S9ft;
        "pkg-v3.0.0" = _U6EwqLCR;
