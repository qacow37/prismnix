...
let
    ...
    in {
        ...
        "pkg-0.1.5+1" = _oeT3WJvm;
        "pkg-0.1.5+2" = _VzhG1ee2;
        "pkg-0.1.8" = _mH5wME47;
        "pkg-0.2.0" = _Hno2kg6V;
        "pkg-0.2.0+1" = _DhmnwVC9;
        "pkg-0.2.0+2" = _6UcjLFiZ;
        "pkg-0.2.1" = _HzDlRUBa;
        "pkg-0.2.2" = _T4ooVL38;
        "pkg-0.2.3" = _mslg9G1S;
        "pkg-0.2.4" = _CKKP7DCZ;
        ...
        "pkg-0.4.4" = _VZ0T78LG;
        "pkg-0.4.5" = _X91YAGvU;
        "pkg-0.4.5.1" = _LpPW3nRn;
        "pkg-0.4.6" = _KRiPy18X;
        "pkg-0.4.7" = _US6s2g38;
        "pkg-0.4.8" = _AWPRguCU;
        "pkg-0.4.9" = _p79xhkux;
        "pkg-0.5.0" = _AhY6YeMK;
        "pkg-0.5.0-build.1" = _9Ovwxlme;
        "pkg-0.5.1" = _P5FKc3uc;
        "pkg-0.5.2" = _I3uJz86I;
        "pkg-0.5.3" = _RLiwSOr0;
        "pkg-0.5.4" = _9BnBJI0w;
        ...
        "pkg-0.6.5" = _zLXOtN34;
        "pkg-0.6.6" = _PNODQNIn;
        "pkg-0.6.7+1.21.1" = _2eqroDKD;
        "pkg-0.6.7+1.21.11" = _aB0HQGHf;
        "pkg-0.6.7+26.1.2" = _ARHxtCLs;
        "pkg-0.6.8+1.21.11" = _hWKRTXbQ;
        "pkg-0.6.8+26.1.2" = _CEmnv55N;
        "default" = _CEmnv55N;
    });
