...
let
    ...
    in {
        ...
        "pkg-1.3.0mc1.17.1" = _5nAwTHFj;
        "pkg-1.3.1mc1.18.1" = _vJlajQHJ;
        "pkg-1.3.2mc1.18.2" = _j6z5b4J2;
        "pkg-1.3.3mc1.19" = _iP43HL7v;
        "pkg-1.3.4mc1.19.1" = _gWD4t59M;
        "pkg-1.4.0mc1.19.2" = _hjgap0pO;
        "pkg-2.0.0_fabric" = _gdyPCUQq;
        "pkg-2.0.0_forge" = _TtlHKqH7;
        "pkg-2.1.0_fabric" = _pGiE3uFj;
        "pkg-2.1.0_forge" = _e8Kd890r;
        "pkg-2.1.1_fabric" = _1gKohCHF;
        "pkg-2.1.2" = _X9Uc7Mbq;
        "pkg-2.1.2_fabric" = _AEjeJ3TR;
        "pkg-2.1.3_forge" = _pBMDUKoi;
        "pkg-2.1.3_fabric" = _GArbuI1C;
        "pkg-2.1.4-forge" = _VxGhFPOn;
        "pkg-2.1.4-fabric" = _jIbleHVf;
        "pkg-2.2.0" = _7448t3FB;
        "pkg-2.2.0mc1.19.4" = _LsiVwpcw;
        "pkg-fabric_2.3.0" = _WTyojyxx;
        "pkg-forge_2.3.0" = _Z8QatISK;
        "pkg-fabric_2.3.1" = _hyKqPuAs;
        "pkg-forge_2.3.1" = _WHrlmd9O;
        "pkg-fabric_2.3.2" = _qo9ZNhbG;
        "pkg-forge_2.3.2" = _TflCUOlw;
        "pkg-2.3.3-forge" = _zTLgslPx;
        "pkg-2.3.3-fabric" = _kzNRq5yr;
        "pkg-2.3.4-forge" = _sBzMesa4;
        "pkg-2.3.4-fabric" = _jBjuzkak;
        "pkg-3.0.0" = _A4k060w0;
        "pkg-3.0.0+1.20.1" = _HEXEbcVt;
        "pkg-3.1.0" = _QRtecODK;
        "pkg-3.1.0-fabric" = _Bay5KqOk;
        "pkg-3.2.0-forge" = _nivDLXro;
        "pkg-3.2.0-fabric" = _vCJf2IFi;
        "pkg-3.2.1-forge" = _PtVlAfsU;
        "pkg-3.2.1-fabric" = _aTdhk8GD;
        "pkg-3.2.2-forge" = _5XUkATcW;
        "pkg-3.2.2-fabric" = _9pCIe104;
        "pkg-4.0.0" = _kfXGP9zw;
        "pkg-4.0.0-fabric" = _RYobNfO2;
        "pkg-5.0.0-fabric" = _V9p2Md7g;
        "pkg-5.0.0-forge" = _K1EJHKtq;
        "pkg-6.0.0-fabric" = _7B2Qo6v9;
        "pkg-6.0.0-forge" = _cHGzUNZO;
        "pkg-7.0.0-fabric" = _ZiNbyYUC;
        "pkg-7.0.0-forge" = _L4z44KfX;
        "pkg-8.0.0-fabric" = _bvV1YM2r;
        "pkg-8.0.0-forge" = _el0yviAP;
        "pkg-9.0.0-fabric" = _u5QyNRBs;
        "pkg-9.0.0-forge" = _BxVyX9Jx;
        "pkg-10.0.0-neoforge" = _72e61DoN;
        "pkg-10.0.0-fabric" = _UFfYdk9t;
        "pkg-11.0.0-CoordinatesDisplay" = _ItPbyyOP;
        "pkg-11.1.0-CoordinatesDisplay" = _zklvGSKL;
        "pkg-11.1.1-CoordinatesDisplay" = _W3uzS3pk;
        "pkg-1.5.0-CoordinatesDisplay" = _u9G8sJWd;
        "pkg-2.4.0-CoordinatesDisplay" = _BCXa3yeK;
        "pkg-3.3.0-CoordinatesDisplay" = _NnhEO9ak;
        "pkg-4.1.0-forge" = _E4DgJBmz;
        "pkg-4.1.0-fabric" = _1QRzvdyA;
        "pkg-5.1.0-forge" = _1ljm65ID;
        "pkg-5.1.0-fabric" = _zdSmHJa8;
        "pkg-6.1.0-forge" = _bGjrs7MG;
        "pkg-6.1.0-fabric" = _GPAHNvYl;
        "pkg-7.1.0-forge" = _x6CGrNqt;
        "pkg-7.1.0-fabric" = _3eBMKTYk;
        "pkg-8.1.0-fabric" = _r3lhYMNg;
        "pkg-8.1.0-forge" = _PVgBXwvf;
        "pkg-9.1.0-fabric" = _pJmgcX2t;
        "pkg-9.1.0-forge" = _RxBOjrkU;
        "pkg-10.1.0-forge" = _euJPn2S5;
        "pkg-10.1.0-fabric" = _FXT90u5v;
        "pkg-11.2.0-forge" = _xSlkTAbA;
        "pkg-11.2.0-fabric" = _6OF0WV8E;
        "pkg-12.0.0-neoforge" = _LOwD2ils;
        "pkg-12.0.0-fabric" = _nNyvhYrQ;
        "pkg-13.0.0-neoforge" = _oWbUYQrV;
        "pkg-13.0.0-fabric" = _CoXx7Kea;
        "pkg-1.5.1-CoordinatesDisplay" = _oqkHyXsO;
        "pkg-2.4.1-CoordinatesDisplay" = _v7qlME1f;
        "pkg-3.3.1-CoordinatesDisplay" = _Nd8afyaK;
        "pkg-4.1.1-forge" = _OgVLjhd0;
        "pkg-4.1.1-fabric" = _zzOUZjSI;
        "pkg-5.1.1-forge" = _rMekXTvs;
        "pkg-5.1.1-fabric" = _YYBUTrm6;
        "pkg-6.1.1-forge" = _d2L1FcRT;
        "pkg-7.1.1-forge" = _Dglp6bwE;
        "pkg-7.1.1-fabric" = _wnxZr0GH;
        "pkg-8.1.1-fabric" = _BGixIvzT;
        "pkg-8.1.1-forge" = _wY8rtsv4;
        "pkg-9.1.1-forge" = _6t74Jiws;
        "pkg-9.1.1-fabric" = _oktGTfHQ;
        "pkg-10.1.1-forge" = _iRfEEK3M;
        "pkg-10.1.1-fabric" = _HpcuBLAF;
        "pkg-11.2.1-forge" = _hqEaFP6Z;
        "pkg-11.2.1-fabric" = _SQnMsALS;
        "pkg-12.1.0-fabric" = _a4X2XmRs;
        "pkg-12.1.0-forge" = _sOsUZPY5;
        "pkg-12.1.0-neoforge" = _qdPADtzF;
        "pkg-13.1.0-neoforge" = _mxWDuWbU;
        "pkg-13.1.0-fabric" = _YyfWudgG;
        "pkg-13.1.0-forge" = _vuJY8FZB;
        "pkg-9.2.0-forge" = _F4EraboL;
        "pkg-9.2.0-fabric" = _SYOHbI0F;
        "pkg-13.2.0-forge" = _8mRUehti;
        "pkg-13.2.0-neoforge" = _mjgftxvp;
        "pkg-13.2.0-fabric" = _fav229SS;
        "pkg-14.0.0-forge" = _rzuBo1sd;
        "pkg-14.0.0-neoforge" = _M1ajSsRI;
        "pkg-14.0.0-fabric" = _4ffDLqfz;
        "pkg-9.2.1-forge" = _WuKjQakN;
        "pkg-9.2.1-fabric" = _nerxibbk;
        "pkg-15.0.0-neoforge" = _fvHqQJUw;
        "pkg-15.0.0-fabric" = _3DMWiStp;
        "pkg-15.0.0-forge" = _bIRzVtAF;
        "pkg-16.0.0-forge" = _mAIJRC62;
        "pkg-16.0.0-neoforge" = _IpMi2gO3;
        "pkg-16.0.0-fabric" = _CUIo3UDk;
        "pkg-17.0.0-neoforge" = _V7i2prSU;
        "pkg-17.0.0-forge" = _gOF7ZU39;
        "pkg-17.0.0-fabric" = _v58KgzQF;
        "pkg-17.0.1-neoforge" = _mPI8oZH0;
        "pkg-17.0.1-forge" = _8DJeaO1n;
        "pkg-17.0.1-fabric" = _21WTa5Hc;
        "pkg-17.0.2" = _fNkLKcoB;
        "pkg-18.0.0" = _pxJEOc5W;
        "pkg-18.0.1" = _6p7wobJH;
        "pkg-18.0.2" = _yN1mmE7j;
        "pkg-19.0.0" = _mRg4wLhD;
        "pkg-19.0.1" = _eDuBWY6s;
        "pkg-20.0.0" = _dY88XBoO;
        "pkg-20.0.1" = _hO0jejYs;
        "pkg-21.0.0" = _25Z1saeZ;
        "default" = _25Z1saeZ;
    });
