...
let
    ...
    in {
        ...
        "pkg-3.19.5+mc1.19.2-build.40" = _p6aQYYmC;
        "pkg-3.19.5+mc1.19.4-build.38" = _lZdzDGC2;
        "pkg-3.19.4+mc1.20.1-build.39" = _QglCOMrE;
        "pkg-3.19.5+mc1.19.2-build.79" = _F6nGY33e;
        "pkg-3.19.5+mc1.19.4-build.80" = _XggMj0gj;
        "pkg-3.19.5+mc1.20.1-build.76" = _uN07Qzsk;
        "pkg-3.19.5+mc1.19.2-build.103" = _KDTmbW5b;
        "pkg-3.19.5+mc1.19.4-build.105" = _Jn9oOBNQ;
        "pkg-3.19.5+mc1.20.1-build.104" = _lbSRE8Te;
        "pkg-1.19.2-3.20.2.22" = _xDzV8ICU;
        "pkg-1.20.1-3.20.11.26" = _ZgK5kbFw;
        "pkg-1.20.4-3.20.6.30" = _2BjUaqW5;
        "pkg-1.20.4-3.20.6.41" = _TUaiiqt5;
        "pkg-1.21.1-3.20.19.44" = _eudsQxsA;
        "pkg-1.21.1-3.20.19.51" = _FqCcxTXd;
        "pkg-1.20.1-3.20.17.1.60" = _QohWxuZ4;
        "pkg-1.21.1-3.20.26.1.61" = _x3HvtfXu;
        "pkg-1.21.1-3.20.26.2.69" = _nq3Z2GI9;
        "pkg-1.21.1-3.21.1.1.82" = _gpSJccbD;
        "pkg-1.20.1-3.21.2.1.81" = _g7vm5J1t;
        "pkg-1.20.1-3.23.4.1.95" = _2dpSRXlj;
        "pkg-1.21.1-3.23.4.1.96" = _I83OMUa2;
        "pkg-1.20.4-3.20.7.101" = _ZAq3sS8e;
        "pkg-1.21.1-3.23.4.2.103" = _zBk8Jjya;
        "pkg-1.20.1-3.23.4.4.105" = _53tSpjtW;
        "pkg-1.21.1-3.23.4.3.106" = _nHhuPdda;
        "pkg-1.20.1-3.23.4.5.110" = _Jk6o7s4h;
        "default" = _Jk6o7s4h;
    });
