...
let
    ...
    in {
        ...
        "pkg-1.9.7" = _inPM83W4;
        "pkg-2.0.4" = _fECjojgn;
        "pkg-1.18-2.0.5" = _jyZcKvrR;
        "pkg-1.17.1-2.0.5" = _EhLyBsPs;
        "pkg-1.18-2.1.0" = _Sfubmz7S;
        "pkg-1.18.2-2.2.2" = _KUfTISvX;
        "pkg-1.18.2-3.0.0-6" = _DLZghxwy;
        "pkg-1.19-3.0.0-6" = _lwsP4KzS;
        "pkg-1.19-3.0.0-7" = _lyHgH9uy;
        "pkg-1.19.1-3.0.0-8" = _QKrykc9t;
        "pkg-1.19.1-3.0.0-11" = _ygBzpouw;
        "pkg-3.0.0-14" = _t5i9IRdQ;
        "pkg-3.0.0-15" = _GWjihQlW;
        "pkg-3.0.0-16" = _hbLNdvJO;
        "pkg-3.0.0-17" = _E8ysyhQS;
        "pkg-3.0.19" = _ILLJbynj;
        "pkg-3.0.20" = _hmsvtQgu;
        "pkg-3.0.23" = _ALq1VIRt;
        "pkg-3.0.24" = _wBsXZmch;
        "pkg-3.0.25" = _8ZQEgc1i;
        "pkg-3.0.27" = _cNfqAFbs;
        "pkg-3.0.19-replaced" = _lRzVGc9w;
        "pkg-3.1.8" = _hCzqLw0j;
        "pkg-3.1.9" = _dyZXtBBD;
        "pkg-3.1.10" = _c0GR6kWD;
        "pkg-3.1.11" = _MdRRckj6;
        "pkg-3.2.1" = _G3sQjbIO;
        "pkg-3.3.2" = _eT3mrga6;
        "pkg-3.3.3" = _FAZuvjpE;
        "pkg-3.3.5" = _qt7otgVH;
