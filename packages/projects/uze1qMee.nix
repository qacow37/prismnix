...
let
    ...
    in {
        ...
        "pkg-1.6.0" = _UN6iXlIF;
        "pkg-1.6.1" = _kQFe91hq;
        "pkg-1.6.2+1.20.1" = _aC3DbLXS;
        "pkg-1.6.2+1.20.2" = _g043tEVi;
        "pkg-1.6.3+1.20.4" = _5dI7YH8k;
        "pkg-1.6.4+1.20.2" = _GZYaGFMM;
        "pkg-1.6.4+1.20.4" = _I8sMknKj;
        "pkg-1.6.4+1.20.1" = _ZbmayDVe;
        "default" = _ZbmayDVe;
    });
