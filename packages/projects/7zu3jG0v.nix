...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.3.1" = _JYMmhmk7;
        "pkg-1.18.2-3.3.2c" = _sqKAbl9K;
        "pkg-1.18.2-3.4.0c" = _HTyxBV2t;
        "pkg-1.18.2-3.4.1" = _3zzoYJwy;
        "pkg-1.19-4.0.0" = _EaCBD6P6;
        "pkg-1.19-4.1.0" = _TrSweX98;
        "pkg-1.19.1-4.2.0" = _YlyaJcSo;
        "pkg-1.19.2-4.3.1" = _nLVSj3om;
        "pkg-1.19.2-4.3.2" = _lC1GEYFy;
        "pkg-1.18.2-3.4.2" = _H71SPdSs;
        "pkg-1.19.2-4.4.0" = _dqWAHRoG;
        "pkg-1.20.1-5.0.0b" = _vnX7WIFk;
        "pkg-1.20.1-5.0.0c" = _CFrj2g6h;
        "pkg-1.20.1-5.0.1" = _cpV4qNpA;
        "pkg-1.20.4-5.1.0" = _IWn68AIH;
        "pkg-1.20.4-5.1.1" = _aUHDTVVJ;
        "pkg-5.1.2" = _VDjUJXXu;
        "pkg-6.0.0e" = _srll3Fz1;
        "pkg-6.0.0f" = _a4aFRyyr;
        "pkg-6.0.0g" = _53ZDJP8c;
        "pkg-6.0.0h" = _y5LWIPGp;
        "pkg-6.0.1" = _66R7hYi3;
        "pkg-6.1.0" = _j0kf9i1J;
        "pkg-6.1.1" = _tp9wX5BP;
        "pkg-6.1.2b" = _tbmc0HMP;
        "pkg-6.1.3" = _ZXqILf7I;
        "default" = _ZXqILf7I;
    });
