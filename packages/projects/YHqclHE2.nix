...
let
    ...
    in {
        ...
        "pkg-Minecraft_Overworld-1" = _4C9kGikH;
        "pkg-Minecraft_Overworld-2" = _yXHneFJq;
        "pkg-Minecraft_Overworld-3" = _Muuo1ca9;
        "pkg-Minecraft_Overworld-4" = _NKEJN0Sf;
        "pkg-Minecraft_Overworld-5" = _bbfSLTU5;
        "pkg-Minecraft_Overworld-6" = _unPK1XrP;
        "pkg-Minecraft_Overworld-7" = _67Vz5PFr;
        "pkg-Minecraft_Overworld-8" = _10b9Si1P;
        "pkg-Minecraft_TheNether" = _krtEDXvs;
        "pkg-Minecraft_TheEnd" = _vWkhhkt9;
        "pkg-Saturated_Saturated" = _Aa9pXJYo;
        "pkg-Saturated_Void" = _sFUUpkBS;
        "pkg-TheBrackenPack_Dormis" = _DqWeqEds;
        "pkg-TheBrackenPack_Glacium" = _YBSwXYlD;
        "pkg-TheBrackenPack_Omnidrome" = _S5POxFJ1;
        "pkg-TheBrackenPack_Pax" = _ltJynNNh;
        "pkg-TheBrackenPack_Panacea" = _UtmI0m3n;
        "pkg-TheBrackenPack_Sanctum" = _pscK3vk7;
        "pkg-TheBrackenPack_TheBrine" = _jzBcrHzY;
        "pkg-TheBrackenPack_TheUnderdark" = _YdUaIFoL;
        "pkg-TheBrackenPack_TheFaewild" = _NvItHDw1;
        "pkg-TheBrackenPack_Varskspace" = _IOHgYZZW;
        "pkg-TheBrackenPack_Void" = _wcTbfpjp;
        "pkg-DeeperDarker_Otherside" = _5Uts9bTp;
        "pkg-Trial_Chambers" = _1qsdnqhG;
        "pkg-Lukis_Crazy_Chambers" = _VqC3ZQeZ;
        "pkg-Minecraft_PaleGarden-1" = _zvFxK9J3;
        "pkg-Minecraft_PaleGarden-3" = _Q7jZGGe2;
        "pkg-TheCorners_CommunalCorridors" = _WS8SXVda;
        "pkg-TheCorners_HoaryCrossroads" = _xZPHrG7p;
        "pkg-TheCorners_YearningCanal" = _FOCTE7iG;
        "default" = _FOCTE7iG;
    });
