...
let
    ...
    in {
        ...
        "pkg-1.8pre1" = _Mh2taILv;
        "pkg-1.8pre2" = _1NiQZbWW;
        "pkg-1.8pre3" = _qjTlBj4g;
        "pkg-1.8" = _YCrN4K2n;
        "pkg-1.9" = _UF3mQRfz;
        "pkg-1.9.1" = _V6gZViNb;
        "pkg-1.9.2" = _ujTu2LdP;
        "pkg-1.9.3" = _w5xR4M90;
        "pkg-1.10.1" = _ikFhRaQS;
        "pkg-1.11" = _ramCnv08;
        "pkg-1.11.1" = _rX3O53jh;
        "pkg-1.11.2" = _PYy0UZo7;
        "pkg-1.11.3" = _iM6mxyAW;
        "pkg-1.11.4" = _CgPpWLWy;
        "pkg-1.11.5" = _ReyIbnLb;
        "pkg-1.11.5-NLM" = _K7p2fJDL;
        "pkg-1.9.1-NLM" = _TbwsY14s;
        "pkg-1.12" = _tuH5eRgZ;
        "pkg-1.12.1" = _Sdq0CGTj;
        "pkg-1.13" = _HI2Qcr0G;
        "pkg-1.13.1" = _y2k4dpy4;
        "pkg-1.13.2" = _mhzWX68N;
        "pkg-1.13.3" = _yTuG7y8g;
        "pkg-1.13.4" = _RNni6iXH;
        "default" = _RNni6iXH;
    });
