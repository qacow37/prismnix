...
let
    ...
    in {
        ...
        "pkg-1.0.2.15" = _uJXrELZH;
        "pkg-1.0.2.14" = _EygrkONV;
        "pkg-1.6.1.9" = _S5OfhxLq;
        "pkg-1.6.1.4" = _6TEJuCXs;
        "pkg-1.0.3.67" = _beItnoNc;
        "pkg-1.0.3.74" = _7ZWaQV3K;
        "pkg-1.0.4.83" = _HxquN7v6;
        "pkg-1.0.4.90" = _cSM2v2ZY;
        "pkg-1.3.0.1" = _a27uw6dt;
        "pkg-1.4.0.5" = _lSEEnpNo;
        "pkg-1.4.2.1" = _bp3jU41b;
        "pkg-1.4.3.6" = _UlK1dt9T;
        "pkg-1.4.7.1" = _zQS4ipP5;
        "pkg-1.4.7.4" = _vqhwlzMQ;
        "pkg-1.5.2.6" = _xijmi6wi;
        "pkg-1.5.2.10" = _PzS4mnnF;
        "pkg-1.5.2.28" = _MnXBfImW;
        "pkg-1.0.4.95" = _AqUDW36h;
        "pkg-1.0.5.82" = _Nex1pioc;
        "pkg-1.0.5.96" = _WtOc2RJy;
        "pkg-1.0.4.100" = _JuvIucg8;
        "pkg-1.0.4.107" = _5dLfxoEg;
        "pkg-1.0.5.104" = _2hEKvg8x;
        "pkg-1.0.5.118" = _rNe1vVt3;
        "pkg-1.0.5.120" = _4ZISyGrt;
        "pkg-2.0.1.132" = _SNR2UOuz;
        "pkg-2.0.1.133" = _qEbwhNsA;
        "pkg-2.1.2.150" = _qMy1OjpX;
        "pkg-2.1.2.157" = _W9CFosbL;
        "pkg-2.1.2.160" = _DbWpMr0A;
        "pkg-2.1.2.163" = _6yRg37P5;
        "pkg-2.1.3.178" = _TvUa2ipH;
        "pkg-2.1.3.181" = _fKmlOh44;
        "pkg-2.1.3.182" = _lWgIyc0f;
        "pkg-2.1.3.199" = _qxYsQmvk;
        "pkg-2.1.3.201" = _OZIyGU4I;
        "pkg-2.1.3.205" = _9iKuuuQS;
        "pkg-2.1.3.206" = _17nD4pPJ;
        "pkg-2.1.3.207" = _5NQkMVku;
        "pkg-2.2.0.216" = _bZ1DSqoX;
        "pkg-2.1.3.219" = _DebAnz50;
        "pkg-2.1.3.220" = _7MMOiFY8;
        "pkg-2.3.0.223" = _DEX8AG01;
        "pkg-2.3.0.227" = _hxelWmhf;
        "pkg-2.4.0.231" = _aHT882Hl;
        "pkg-2.4.1.233" = _Jt4KAUid;
        "pkg-2.4.1.238" = _a9hBdSW9;
        "pkg-2.4.1.239" = _VVfwM1yA;
        "pkg-2.4.2.240" = _Eu6DYe54;
        "pkg-2.4.3.245" = _cgeujovY;
        "default" = _cgeujovY;
    });
