...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.8-fabric" = _3h3GwMiU;
        "pkg-1.18.2-1.8-fabric" = _AaGZMU5u;
        "pkg-1.19.2-1.9-fabric" = _wTEqrJES;
        "pkg-1.16.5-1.3-forge" = _3t4BrBbu;
        "pkg-1.18.2-1.5-forge" = _keWnCV0d;
        "pkg-1.19.2-1.7-forge" = _O8H15C2G;
        "pkg-1.16.5-2.0-fabric" = _V9Nnp4OQ;
        "pkg-1.18.2-2.0-fabric" = _JQTgmQFE;
        "pkg-1.19.2-2.0-fabric" = _AdgLHYuh;
        "pkg-1.19.3-2.1-fabric" = _OTBeEsnn;
        "pkg-1.19.3-1.7-forge" = _wO2LlF94;
        "pkg-1.18.2-3.0-forge+fabric" = _znhfaRoI;
        "pkg-1.19.2-3.0-forge+fabric" = _dzlwCgSz;
        "pkg-1.19.3-3.0-forge+fabric" = _u6DXR1RU;
        "pkg-1.19.4-3.0-forge+fabric" = _glN0yo1S;
        "pkg-1.20-3.0-forge+fabric" = _5VGVezgx;
        "pkg-1.20.1-3.0-forge+fabric" = _U9GYvZdb;
        "pkg-1.20.2-3.0-forge+fabric" = _LnbECzxX;
        "pkg-1.18.2-3.1-forge+fabric" = _3uRkdTrA;
        "pkg-1.19.2-3.1-forge+fabric" = _iQFBOBtt;
        "pkg-1.20.1-3.1-forge+fabric" = _ciAucZsX;
        "pkg-1.20.2-3.1-forge+fabric" = _K1IahI2M;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _eqY36eQI;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _zftmi9UX;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _4DjoH1Kn;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _Qm4QfV0y;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _ve5n5KlY;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _a4w529t0;
        "pkg-1.20.5-3.2-fabric+neo" = _kBldV7xE;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _VcXzhKqj;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _D8URj1PC;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _KPmmZvE1;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _V64m0nEP;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _EQAXy2Rk;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _D8bYNXIG;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _WAqy9mih;
        "pkg-1.21.2-3.4-fabric+neo" = _t2d2jSzx;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _isG1tAU9;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _OxzMtE9u;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _83fKQ1sY;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _ry7c9vsd;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _Zit8ZPLv;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _C0ibakYX;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _NyHbY7w9;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _zixHMoZc;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _3XSRn8m8;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _YD3vvjdw;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _ShWw84Js;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _vyybszmE;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _3HdGiSA2;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _WOrihfVo;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _fRQ9h7qf;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _vkqUWcCM;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _5wKaPxob;
        "default" = _5wKaPxob;
    });
