...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.1-forge" = _EPkGoYhr;
        "pkg-1.18.2-2.1-forge" = _jZHUiSp3;
        "pkg-1.19.2-2.2-forge" = _LUI8wzDd;
        "pkg-1.16.5-2.5-fabric" = _rcOgIF99;
        "pkg-1.18.2-2.5-fabric" = _l8hvkn8Z;
        "pkg-1.19.2-2.5-fabric" = _Ztvw6WPS;
        "pkg-1.16.5-2.5-forge" = _j8O7ycLq;
        "pkg-1.18.2-2.5-forge" = _Eq7bpsXh;
        "pkg-1.19.2-2.5-forge" = _bTokW25a;
        "pkg-1.16.5-2.6-fabric" = _3tVkwZ6z;
        "pkg-1.18.2-2.6-fabric" = _hQz4sO9U;
        "pkg-1.19.2-2.6-fabric" = _GBZ47PCB;
        "pkg-1.19.3-2.7-fabric" = _uOXx6eyS;
        "pkg-1.19.3-2.5-forge" = _V4rmh0RR;
        "pkg-1.18.2-3.0-forge+fabric" = _tSiiXWCw;
        "pkg-1.19.2-3.0-forge+fabric" = _FNkQhBC9;
        "pkg-1.19.3-3.0-forge+fabric" = _oJkWu9Om;
        "pkg-1.19.4-3.0-forge+fabric" = _40WuLDkH;
        "pkg-1.20-3.0-forge+fabric" = _muIc3oAR;
        "pkg-1.20.1-3.0-forge+fabric" = _L5cuYyRZ;
        "pkg-1.20.2-3.0-forge+fabric" = _weyrgfAO;
        "pkg-1.18.2-3.1-forge+fabric" = _3Fo7Iy1o;
        "pkg-1.19.2-3.1-forge+fabric" = _soYHdnZq;
        "pkg-1.20.1-3.1-forge+fabric" = _LeJzyfuq;
        "pkg-1.20.2-3.1-forge+fabric" = _tBLojyKk;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _suu47La4;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _W8xabqvC;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _O3Q8wPZT;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _BHvCbbQo;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _6i9Q6T3v;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _SlO9cY7w;
        "pkg-1.19.2-3.3-fabric+forge" = _ZWXDHA4R;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _e8QrreXN;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _OpD34mLd;
        "pkg-1.20.5-3.3-fabric+neo" = _uUBuX9Kz;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _iYFgjoTr;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _DWiFmIle;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _lVU23KdS;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _X5vRLTCe;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _o6nwyCPW;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _jpA8tRA2;
        "pkg-1.21.2-3.4-fabric+neo" = _deKg0oeb;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _tHg0kQBP;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _rkblusZh;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _amBVja9x;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _a6266GPY;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _7YPnZbAN;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _Ljf3KnFg;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _ctjxVs1X;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _Azmzluym;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _JNdHdtSN;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _t88P2Ecx;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _qZtLH4h2;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _COXug57I;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _qNvdE2Zp;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _KjU9UZoU;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _mAuOwBKU;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _7v73srU7;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _1LHfij4k;
