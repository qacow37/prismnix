...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _eDCzWMIK;
        "pkg-1.0.19" = _suM3HlWj;
        "pkg-fabric-1.21.1-1.0.21" = _37uNiZ5w;
        "pkg-forge-1.20.1-1.0.21" = _DL4CfvOF;
        "pkg-fabric-1.21.4-1.0.21" = _xTaNQ3jc;
        "pkg-fabric-1.20.1-1.0.21" = _dG5z8lod;
        "pkg-neoforge-1.21.1-1.0.21" = _DsVc1ltn;
        "pkg-fabric-1.21.4-1.0.22" = _YacqGFEs;
        "pkg-fabric-1.21.1-1.0.22" = _JOKpd5pX;
        "pkg-forge-1.20.1-1.0.22" = _p7eMb4Jf;
        "pkg-neoforge-1.21.1-1.0.22" = _571wNYKK;
        "pkg-fabric-1.20.1-1.0.22" = _FhgY1WIg;
        "pkg-fabric-1.20.1-1.0.23" = _tdv2AbVQ;
        "pkg-fabric-1.21.1-1.0.23" = _B5sZWnOA;
        "pkg-forge-1.20.1-1.0.23" = _9uKyXp6F;
        "pkg-neoforge-1.21.1-1.0.23" = _nMQ7DOOO;
        "pkg-fabric-1.21.5-1.0.23" = _3ImQ83h6;
        "pkg-fabric-1.21.1-1.0.24" = _98FHAlrc;
        "pkg-forge-1.20.1-1.0.24" = _kQ8qnDHA;
        "pkg-fabric-1.21.4-1.0.24" = _L9fYx72q;
        "pkg-fabric-1.20.1-1.0.24" = _7toCynAY;
        "pkg-neoforge-1.21.1-1.0.24" = _M1CyD3Uu;
        "pkg-fabric-1.21.5-1.0.24" = _fnEiEwOl;
        "default" = _fnEiEwOl;
    });
