...
let
    ...
    in {
        ...
        "pkg-1.0.0-neoforge-1.21.5-21.5.96" = _79IT8zF6;
        "pkg-1.0.0-neoforge-1.21.8-21.8.52" = _GUV6puot;
        "pkg-1.0.0-neoforge-1.21.11-21.11.17b" = _9TjCyUGh;
        "pkg-1.0.0-forge-1.18.2-40.3.12" = _OqD3M2Pe;
        "pkg-1.0.0-forge-1.19.2-43.5.2" = _LfgnF7f8;
        "pkg-1.0.0-forge-1.19.4-45.4.3" = _GYhmzCuX;
        "pkg-1.0.0-forge-1.20.4-49.2.4" = _UbB6hmrp;
        "pkg-1.0.0-forge-1.20.6-50.2.4" = _6gx9uR1e;
        "pkg-1.0.0-forge-1.21.1-52.1.8" = _jLBIaHDw;
        "pkg-1.0.0-forge-1.21.5-55.1.4" = _rk1SfyEw;
        "pkg-1.0.0-forge-1.21.8-58.1.11" = _d1L8EWHs;
        "pkg-1.0.0-forge-1.21.11-61.0.2" = _T2OjIQ7D;
        "pkg-1.0.0-fabric-1.20.4-0.97.3" = _PlBed8qj;
        "pkg-1.0.0-fabric-1.21.11-0.140.2" = _25C0I0LQ;
        "pkg-1.0.1-forge-1.20.1-47.4.10" = _lBii9Wkn;
        "pkg-1.0.1-forge-1.20.6-50.2.4" = _soIvgIWj;
        "pkg-1.0.1-forge-1.21.1-52.1.8" = _BNhP8w1V;
        "pkg-1.0.1-forge-1.21.5-55.1.4" = _MxSOLDCE;
        "pkg-1.0.1-forge-1.21.8-58.1.11" = _CFNlCLOc;
        "pkg-1.0.1-forge-1.21.11-61.0.2" = _XUPOt1hk;
        "pkg-1.0.1-fabric-1.20.4-0.97.3" = _FlomD4RV;
        "pkg-1.0.1-fabric-1.21.11-0.140.2" = _KaE3FXDG;
        "pkg-1.0.1-neoforge-1.21.1-21.1.217" = _ZvqNk5GI;
        "pkg-1.0.1-neoforge-1.21.5-21.5.96" = _s2jX9nGD;
        "pkg-1.0.1-neoforge-1.21.8-21.8.52" = _9CxjuYwd;
        "pkg-1.0.1-neoforge-1.21.11-21.11.17b" = _TLAA1T9V;
        "pkg-1.0.1-fabric-26.1-0.142.2" = _FYDGInFU;
        "pkg-1.0.2-fabric-26.1-0.142.2" = _2gd1vabp;
