...
let
    ...
    in {
        ...
        "pkg-1.17.1-4" = _tBxQCxAB;
        "pkg-1.18+build.1" = _tcDqwV7Q;
        "pkg-1.18.1+build.1" = _WmIjizWr;
        "pkg-1.18.2+build.1" = _bN9KBU7h;
        "pkg-1.19+build.1" = _H3lz1V8Y;
        "pkg-1.19+build.2" = _ESr9djU1;
        "pkg-1.19.3+build.1" = _mmEVBszp;
        "pkg-1.19.4+build.1" = _VIs7nhof;
        "pkg-1.20+build.1" = _4bsWTlbF;
        "pkg-1.20.1+build.1" = _29RtOh9D;
        "pkg-1.20.1+build.2" = _bmszBAwA;
        "pkg-1.20.6+build.1" = _zMWIPiHC;
        "pkg-1.20.6+build.2" = _t5A2eShd;
        "pkg-1.21+build.1" = _aZXNzdAt;
        "pkg-1.21+build.2" = _tUXJqWLa;
        "pkg-1.21.10+build.1" = _hG0YHyH2;
