...
let
    ...
    in {
        ...
        "pkg-1.0.3-1.17.1" = _umj6V0ZJ;
        "pkg-1.0.4-1.18.2" = _cuhV5L3x;
        "pkg-1.0.5-1.19" = _BzjrQPlo;
        "pkg-1.0.6-1.19.3" = _lRzRbOeU;
        "pkg-1.0.5-1.17.1" = _Fp9Lk8xA;
        "pkg-1.0.5-1.18.2" = _kM9gZXGc;
        "pkg-1.0.7-1.19" = _rPPxpnIg;
        "pkg-1.0.8-1.19.3" = _7TdvsQgO;
        "pkg-1.0.8-1.19.4" = _SZs31E0a;
        "pkg-1.0.6-1.17.1" = _kZCGNUCT;
        "pkg-1.0.6-1.18.2" = _u2uj0ipK;
        "pkg-1.0.8-1.19" = _lmp8HMwr;
        "pkg-1.0.9-1.19.4" = _nhvOpqFc;
        "pkg-1.0.9" = _X4k5B9VH;
        "pkg-1.1.1-1.17.1" = _QVpzyZe6;
        "pkg-1.1.1-1.18.2" = _W7lz1A4E;
        "pkg-1.1.1-1.19" = _kQ1M9t2p;
        "pkg-1.1.1-1.20.1" = _Rz9fqwh6;
        "pkg-1.1.2-1.17.1" = _tZRtn8xN;
        "pkg-1.1.2-1.18.2" = _W92iw70K;
        "pkg-1.1.2-1.19" = _77Xlx0dy;
        "pkg-1.1.2-1.20.1" = _hSLEl8Qo;
        "pkg-1.1.3-1.19" = _f4H7T9gU;
        "pkg-1.1.3-1.19.4" = _aEspG8vI;
        "pkg-1.1.3-1.20.1" = _8jrXg8ul;
        "pkg-1.1.4-1.19" = _odtr81L5;
        "pkg-1.1.4-1.19.4" = _cKpXkNaZ;
        "pkg-1.1.4-1.20.1" = _Jpp7YMcZ;
        "pkg-1.1.5-1.19" = _ZhKcOojX;
        "pkg-1.1.5-1.19.4" = _uGCt151l;
        "pkg-1.1.5-1.20.1" = _t8bTwA2B;
        "pkg-2.0.0-1.21.1" = _IgDf5kLl;
        "default" = _IgDf5kLl;
    });
