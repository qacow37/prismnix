...
let
    ...
    in {
        ...
        "pkg-4.2.3" = _Dkyax1rl;
        "pkg-4.3.0-pre.1" = _gBjoWOOR;
        "pkg-4.3.0-pre.2" = _Y5nLyeAy;
        "pkg-4.3.0-pre.3" = _OhG5hNQs;
        "pkg-5.0.0-pre.1" = _rtUCA9mp;
        "pkg-5.0.0-pre.2" = _59DQXrxy;
        "pkg-5.0.0-pre.3" = _1iUKGdOh;
        "pkg-5.0.0-pre.4" = _IytynAmg;
        "pkg-5.0.0-pre.5" = _k4EZsV9A;
        "pkg-5.0.0" = _6IYi9F4x;
        "pkg-5.0.1-pre" = _c3gZS6G2;
        "pkg-5.0.1" = _4FRFaoi6;
        "pkg-5.0.2-pre" = _eeL7gr3f;
        "pkg-5.0.2" = _8A7Nimis;
        "pkg-5.0.3-pre" = _avz043H7;
        "pkg-5.0.3-pre.1" = _qhRw04dC;
        "pkg-5.0.3" = _xTnZkHQL;
        "pkg-5.0.4-pre" = _u1tohThu;
        "pkg-5.0.4" = _JVd0QB5k;
        "pkg-5.0.5-pre" = _MV2ZBz3t;
        "pkg-5.0.5" = _H5s2uQM2;
        "pkg-5.1.0-pre" = _zHUNGRW7;
        "pkg-5.1.0-pre.1" = _LrDEezxF;
        "pkg-5.1.0" = _RRa80eDI;
        "default" = _RRa80eDI;
    });
