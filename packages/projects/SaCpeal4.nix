...
let
    ...
    in {
        ...
        "pkg-1.12.2-1.4.1.3" = _dHrSKL4J;
        "pkg-1.13.2-2.0-beta2" = _c1r3IQ5i;
        "pkg-FORGE-1.14.4-2.0-beta6" = _aGuoSKwG;
        "pkg-FORGE-1.15.2-2.0.0.4" = _ArfJfNNQ;
        "pkg-1.16.5-4.0.1.5" = _hQP0wrCY;
        "pkg-0.0.7-1.16.5" = _ZyTxtFj8;
        "pkg-1.17.1-5.0.0.1" = _IOKMgz2A;
        "pkg-0.0.7-1.17.1" = _s5LKEIOP;
        "pkg-1.18.2-5.0.0.5" = _67l2afHb;
        "pkg-1.1.3-1.18.2" = _Ct4mFCUB;
        "pkg-6.0.3+1.19.2" = _de4Ew1fk;
        "pkg-6.1.1+1.19.3" = _2TuGHiZI;
        "pkg-1.18.2-5.0.0.6" = _DFNEJtPk;
        "pkg-6.0.4+1.19.2" = _CeY7jdWr;
        "pkg-6.1.2+1.19.3" = _UdZSGyFh;
        "pkg-6.2.0+1.19.4" = _1XmpwUAS;
        "pkg-6.0.5+1.19.2" = _eny6SErU;
        "pkg-6.2.1+1.19.4" = _ErWeNcks;
        "pkg-6.3.0+1.20.1" = _tSzzMaGY;
        "pkg-6.3.1+1.20.1" = _j7LyiMPf;
        "pkg-6.3.2+1.20.1" = _931lwegu;
        "pkg-6.3.3+1.20.1" = _FRk7TuF3;
        "pkg-6.0.6+1.19.2" = _ePAcflcJ;
        "pkg-6.2.2+1.19.4" = _TJTAQTxQ;
        "pkg-6.3.4+1.20.1" = _3nNu4JfG;
        "pkg-7.0.0+1.20.2" = _4gN165vy;
        "pkg-7.0.1+1.20.2" = _Fsk1gLtM;
        "pkg-6.0.7+1.19.2" = _4xI610Ck;
        "pkg-6.2.3+1.19.4" = _EitEWOXA;
        "pkg-6.3.5+1.20.1" = _KgzjTw3n;
        "pkg-7.1.0+1.20.4" = _N8auIkK2;
        "pkg-6.3.6+1.20.1" = _eERpuRc2;
        "pkg-7.2.0+1.20.4" = _9sRsDjzm;
        "pkg-7.2.1+1.20.4" = _OzDgRdin;
        "pkg-7.2.2+1.20.4" = _eXcBRSHm;
        "pkg-8.0.0+1.20.6" = _3krX2BL3;
        "pkg-8.0.1+1.20.6" = _CZFrqdSy;
        "pkg-6.4.0+1.20.1" = _gBDsc134;
        "pkg-9.0.0+1.21" = _6ORJU0Um;
        "pkg-9.0.1+1.21" = _tIbZJEUK;
        "pkg-9.0.2+1.21.1" = _Amo1EWsq;
        "pkg-9.0.3+1.21.1" = _duBFOcde;
        "pkg-9.0.4+1.21.1" = _f0FgfKAZ;
        "pkg-10.0.0+1.21.4" = _MQWPsBgO;
        "pkg-11.0.0+1.21.5" = _PYgnu4sR;
        "pkg-10.0.1+1.21.4" = _WWIZYfxv;
        "pkg-12.0.0+1.21.8" = _bXweZFrw;
        "pkg-13.0.0+1.21.10" = _M3zpcBxY;
        "pkg-13.0.1+1.21.10" = _Uv0pjJpB;
        "pkg-9.0.5+1.21.1" = _3kpPjcTc;
        "pkg-14.0.0+1.21.11" = _SsmepYZf;
        "pkg-14.0.1+1.21.11" = _tAltK2Bs;
        "pkg-14.0.2+1.21.11" = _wpo0PYGR;
        "pkg-15.0.0+26.1.2" = _AOqxsXuM;
        "pkg-16.0.0+26.2" = _fbz515w1;
        "default" = _fbz515w1;
    });
