...
let
    ...
    in {
        ...
        "pkg-1.5.8" = _hxyN0h8S;
        "pkg-1.5.9" = _jb8XyLTW;
        "pkg-1.5.10" = _4Z00bt3j;
        "pkg-1.5.11" = _C2mr1YDU;
        "pkg-1.5.12" = _HW2YvcWU;
        "pkg-1.5.13" = _7z8QYso8;
        "pkg-1.5.14" = _FLpLE80c;
        "pkg-1.5.15" = _8E4WeZkw;
        "pkg-2.0.0" = _FjjWOxwl;
        "pkg-1.5.16" = _DnKKeHi6;
        "pkg-1.5.17" = _ePrkDMoQ;
        "pkg-2.0.1" = _YEmvoXQz;
        "pkg-2.0.2" = _UofTMSXS;
        "pkg-2.0.3" = _kCPdZuYv;
        "pkg-2.0.4" = _rFbyzXEg;
        ...
        "pkg-2.2.8" = _pKj75PYl;
        "pkg-2.2.9" = _PWWdsufB;
        "pkg-2.2.10" = _eNoctJSc;
        "pkg-2.2.11" = _dHXChsn4;
        "pkg-2.2.12" = _oQYuRL5f;
        "pkg-2.2.13" = _bFHjGyie;
        "pkg-2.2.14" = _tj9mPtEn;
        "pkg-2.3.0" = _GaMlzJWj;
        "pkg-2.3.1" = _RWMN1hWg;
        "pkg-2.3.2" = _Rlu1lCmr;
        "pkg-2.4.0" = _197WHiwU;
        ...
        "pkg-2.4.8" = _VSq1hmCw;
        "pkg-2.4.9" = _M05bgRen;
        "pkg-2.4.10" = _4gr6gzwF;
        "pkg-2.4.11" = _NmEagTpn;
        "pkg-2.5.0" = _JKbpU6se;
        "pkg-2.5.1" = _j26wEaIE;
        "pkg-2.5.2" = _UhGzoVWg;
        "pkg-2.5.3" = _KIe94HEM;
