...
let
    ...
    in {
        ...
        "pkg-1.19.2-v1" = _81imr9xt;
        "pkg-1.19.3-v1" = _gRWmdvYi;
        "pkg-1.18.2-v1.1" = _vlTSfOb7;
        "pkg-1.19.2-v1.1" = _jU8HX4xs;
        "pkg-1.19.3-v1.1" = _b0f3DjH9;
        "pkg-1.18.2-v1.2" = _W6qOowji;
        "pkg-1.19.2-v1.2" = _hCM8GFKF;
        "pkg-1.19.3-v1.2" = _vx3oANWA;
        "pkg-1.18.2-v1.3" = _9pNyxgqP;
        "pkg-1.19.2-v1.3" = _bQeyzMZD;
        "pkg-1.19.3-v1.3" = _IO00h8S8;
        "pkg-1.18.2-v1.3b" = _CaGRczWJ;
        "pkg-1.18.2-v1.4" = _otJf5CZE;
        "pkg-1.19.2-v1.4" = _4jhOSRMT;
        "pkg-1.19.3-v1.4" = _AiLB2UHa;
        "pkg-1.18.2-v1.5" = _EdKFI1Ou;
        "pkg-1.19.2-v1.5" = _GeAu8lj6;
        "pkg-1.19.3-v1.5" = _zLppgv1R;
        "pkg-1.19.4-v1.5" = _VHGNAncT;
        "pkg-1.18.2-v1.6" = _75UiTn6Y;
        "pkg-1.19.2-v1.6" = _Zd2U69mW;
        "pkg-1.19.3-v1.6" = _oLKGXLm3;
        "pkg-1.19.4-v1.6" = _Xbsq80cZ;
        "pkg-1.20-pre2-v1.6" = _A9mDZad2;
        "pkg-1.20-pre4-v1.6" = _Fc0QaDU9;
        "pkg-1.20.1-v1.6" = _yMEfJZyV;
        "pkg-1.19.2-v1.7" = _qyUBAWIF;
        "pkg-1.19.4-v1.7" = _fxknkOZr;
        "pkg-1.20-v1.7" = _OfeixF2X;
        "pkg-1.20.2-v1.7" = _cVw6majO;
        "pkg-1.20.4-v1.7" = _V3Z75EG8;
        "pkg-1.19.4-v1.8" = _S1qg9J1s;
        "pkg-1.20(.1)-v1.8" = _A6VKCyyT;
        "pkg-1.20.2-v1.8" = _hoQ8bPO5;
        "pkg-1.20.4-v1.8" = _r9nj2grN;
        "pkg-1.8+1.19.2" = _V2lmPZP9;
        "pkg-1.99.0+1.20.1.beta.fabric" = _jVjsFtrx;
        "default" = _jVjsFtrx;
    });
