...
let
    ...
    in {
        ...
        "pkg-1.1.11-r4" = _bDsDBNNA;
        "pkg-1.1.11-r6" = _nBflG1kV;
        "pkg-1.11.1-r7" = _oxlRBxeb;
        "pkg-1.11.1-r8" = _XyhSE1yb;
        "pkg-1.11.1-r9" = _TQVLYr9y;
        "pkg-1.11.1-r10" = _G1sWFFYf;
        "pkg-1.11.1-r11" = _FWFXIbrB;
        "pkg-1.11.1-r12" = _RQ5xMIDY;
        "pkg-1.11.1-r13" = _4dyMlnqJ;
        "pkg-1.11.1-r14" = _VZjR59xp;
        "pkg-1.11.1-r15" = _Iu4EZK0N;
        "pkg-1.11.1-r16" = _RM4hppIs;
        "pkg-1.11.1-r17" = _wMhEHAfB;
        "pkg-1.11.1-r18" = _3J7FwLre;
        "pkg-1.11.1-r19" = _OzkUPlDs;
        "pkg-1.11.1-r20" = _sHoqyoca;
        "pkg-1.11.1-r22" = _2QPKd1lj;
        "pkg-1.11.1-r23" = _Mejz4VFz;
        "pkg-1.11.1-r24" = _L5neFYYH;
        "pkg-1.11.1-r25" = _AhZdcOgt;
        "pkg-1.11.1-r26" = _aaHVMF2p;
        "pkg-1.11.1-r27" = _b8PIw8N5;
        "pkg-1.11.1-r28" = _9X6CHoVc;
        "pkg-1.11.1-r29" = _A759wDMM;
        "pkg-1.11.1-r30" = _lVYL1GF7;
        "pkg-1.11.1-r31" = _UD95Gh0s;
        "pkg-1.11.1-r32" = _Zg6Hb204;
        "pkg-1.11.1-r33" = _ElnazBsO;
        "pkg-1.11.1-r34" = _OUbCmrNn;
        "pkg-1.11.1-r35-hotfix" = _aLA7aZiN;
        "pkg-1.11.1-r36-hotfix" = _a1AjQNvu;
        "pkg-1.11.1-r37" = _JDa543yR;
        "pkg-1.11.1-r38" = _Is8rtK0W;
        "pkg-1.11.1-r39" = _XYflZbJx;
        "pkg-1.11.1-r40" = _a4tk4FLr;
        "pkg-1.11.1-r41" = _wFJMMMqQ;
        "pkg-1.11.1-r42" = _mxnk9Fjs;
        "pkg-1.11.1-r43" = _wWM1R0eo;
        "pkg-1.11.1-r44" = _bOOJvA87;
        "pkg-1.11.1-r46" = _OI4tudNR;
        "pkg-1.11.1-r47" = _8AruuhDK;
        "pkg-1.11.1-r48" = _7RlnBjAN;
        "pkg-1.11.1-r49" = _S7r8H46E;
        "pkg-1.11.1-r50" = _PyJOAMMW;
        "pkg-1.11.1-r51" = _aVOCgwNO;
        "pkg-1.11.1-r52" = _EC97wIDz;
        "pkg-1.11.1-r53" = _e4e92q9D;
        "pkg-1.11.1-r54" = _Uau2p0iI;
        "pkg-1.11.1-r55" = _vN3zHOkP;
        "pkg-2.0.0-pre1" = _fPRoDTxK;
        "pkg-2.0.0-pre2" = _JoPIBdur;
        "pkg-2.0.0-pre3" = _ifK6h1EO;
        "pkg-2.0.0-pre4" = _vn4nR0Kb;
        "pkg-2.0.0-pre5" = _uAECtmkq;
        "pkg-2.0.0-pre6" = _R1KbNwaY;
        "pkg-2.0.0-pre7" = _5siFLc8E;
        "pkg-2.0.3" = _rV6A85Lk;
        "default" = _rV6A85Lk;
    });
