...
let
    ...
    in {
        ...
        "pkg-mc1.20.1-v1.0.0" = _ZIm9o7xO;
        "pkg-mc1.20.1-v1.20.1-1.0.1" = _bUe0taTZ;
        "pkg-mc1.20.1-v1.20.1-1.0.2" = _QmzN2yL7;
        "pkg-mc1.20.1-v1.20.1-1.0.3" = _1VAn8XVJ;
        "pkg-mc1.20.1-v1.20.1-1.0.4" = _3oNQfQcS;
        "default" = _3oNQfQcS;
    });
