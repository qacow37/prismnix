...
let
    ...
    in {
        ...
        "pkg-1.18.2.fabric.1.0.0" = _OAv8CrM0;
        "pkg-1.19.fabric.1.0.1" = _hR5aj90D;
        "pkg-1.19.fabric.1.0.2" = _Lbph3YVy;
        "pkg-1.19.fabric.1.0.3" = _nkXCDjTX;
        "pkg-1.19.fabric.1.0.4" = _CVP8s8T3;
        "pkg-1.19.fabric.1.0.5" = _tFMofdbs;
        "pkg-1.18.2.forge.1.0.6" = _3j5R1tqr;
        "pkg-1.19.forge.1.0.6" = _opd0zx0e;
        "pkg-1.18.2.fabric.1.0.6" = _iiKA1DWl;
        "pkg-1.19.fabric.1.0.6" = _DVbkQeRT;
        "pkg-1.18.2.fabric.1.1.0" = _bAEd4DsW;
        "pkg-1.19.fabric.1.1.0" = _PjaIK1Vp;
        "pkg-1.18.2.forge.1.1.0" = _tAJHf9G7;
        "pkg-1.19.forge.1.1.0" = _wIStpaL0;
        "pkg-1.18.2.forge.1.1.1" = _8J8D4v6o;
        "pkg-1.19.forge.1.1.1" = _1wIMDix7;
        "pkg-1.18.2.fabric.1.1.1" = _BnPn5A62;
        "pkg-1.19.fabric.1.1.1" = _f4sYhmcE;
        "pkg-1.18.2.fabric.1.1.3" = _meWCSzii;
        "pkg-1.19.fabric.1.1.3" = _DJkYeZd5;
        "pkg-1.18.2.fabric.1.1.4" = _1f1DA0KB;
        "pkg-1.19.fabric.1.1.4" = _QNff3l3l;
        "pkg-1.1.5.fabric.1.18.2" = _QlIwIIh9;
        "pkg-1.1.5.fabric.1.19" = _C2LwOzJk;
        "pkg-1.18.2.fabric.1.2.0" = _1uyZI4Sv;
        "pkg-1.18.2.fabric.1.2.1" = _FKmzXNtY;
        "pkg-1.18.2.forge.1.2.1" = _K88McHch;
        "pkg-1.19.2.forge.1.2.1" = _DQlQxhhM;
        "pkg-1.19.2.forge.1.3.2" = _qIDVvUbg;
        "pkg-1.18.2.forge.1.3.2" = _nAfxWveV;
        "pkg-1.19.2.forge.1.3.3" = _MmygcB2M;
        "pkg-1.18.2.forge.1.3.3" = _zNe7bwry;
        "pkg-1.18.2.fabric.1.3.3" = _Tv3wOvtj;
        "pkg-1.19.2.fabric.1.3.3" = _ksl46t40;
        "pkg-1.18.2.fabric.1.3.4" = _qkR1zzal;
        "pkg-1.19.2.fabric.2.3.4" = _dKaZj3NX;
        "pkg-1.18.2.fabric.1.3.5" = _bxgfNPxE;
        "pkg-1.19.2.fabric.2.3.5" = _LtO049ip;
        "pkg-1.19.2.fabric.2.4.0" = _RWontocM;
        "pkg-1.19.2-2.4.1" = _tMBTPH4j;
        "pkg-1.19.2.fabric.2.4.2" = _rGmamzE5;
        "pkg-1.19.2.forge.2.4.1" = _gdXi90uO;
        "pkg-1.18.2.fabric.1.4.0" = _Dsgo7CSj;
        "pkg-1.19.2.fabric.2.4.3" = _2Yda0wxa;
        "pkg-1.18.2.fabric.1.4.1" = _pPHZxvSq;
        "pkg-1.19.2.fabric.2.4.4" = _mBNst1pT;
        "pkg-1.19.3.fabric.2.5.0" = _NHYFVTEV;
        "pkg-1.19.3.fabric.2.6.0" = _WyunD6Js;
        "pkg-1.18.2.fabric.1.5.0" = _N1SrNeBH;
        "pkg-1.19.3.fabric.2.6.1" = _IpZXHH55;
        "pkg-1.18.2.fabric.1.5.1" = _rxKwFSer;
        "pkg-1.19.3.fabric.2.6.2" = _ZlGXwJvh;
        "pkg-1.18.2.fabric.1.5.2" = _TQqs51tn;
        "pkg-1.19.3.fabric.2.6.3" = _DadZpSjE;
        "pkg-1.18.2.fabric.1.5.3" = _tMPV3Kkg;
        "pkg-1.19.3.fabric.2.6.4" = _ZF0uERgW;
        "pkg-1.18.2.fabric.1.5.4" = _FpDn2R2L;
        "pkg-1.19.3.fabric.2.6.5" = _gIRDVsr1;
        "pkg-1.19.3.fabric.2.6.6" = _a5IjqNvz;
        "pkg-1.18.2.fabric.1.5.5" = _DlCLRU3a;
        "pkg-1.18.2.fabric.1.5.6" = _WU1it2AO;
        "pkg-1.19.3.fabric.2.6.7" = _FU50wLzH;
        "pkg-1.18.2.fabric.1.5.7" = _DhZ4Ja4S;
        "pkg-1.19.3.fabric.2.6.8" = _Y0vyVBp6;
        "pkg-1.18.2.fabric.1.5.8" = _suyTpHDo;
        "pkg-1.19.3.fabric.2.6.9" = _gO58JOqR;
        "pkg-1.18.2.fabric.1.5.9" = _K9vr5fdy;
        "pkg-1.19.3.fabric.2.6.10" = _OQyAqgWH;
        "pkg-1.18.2.forge.2.6.9" = _AWGFfzNY;
        "pkg-1.19.2.forge.2.6.9" = _Jy0nBwT7;
        "pkg-1.19.3.forge.2.6.9" = _n2GBDiY8;
        "pkg-1.19.2.fabric.2.6.10" = _YvKzIdFE;
        "pkg-1.5.10" = _lbg7lLOP;
        "pkg-2.6.11" = _GCH0zDV1;
        "pkg-2.7" = _cOIVKLwU;
        "pkg-3.0" = _FswsA1ru;
        "pkg-3.0.1" = _pDTCLzgm;
        "pkg-3.1.0" = _s3zsS0HW;
        ...
        "pkg-3.3.8" = _u4FVRRGd;
        "pkg-3.4.0" = _ys9T20o4;
        "pkg-mc1.18.2-8.2.1" = _47qpvpOP;
        "pkg-mc1.19.2-8.2.1" = _P17HkM27;
        "pkg-mc1.19.3-8.2.1" = _9Kgnmrza;
        "pkg-mc1.19.4-8.2.1" = _3cboK7gk;
        "pkg-mc1.20(.1)-8.2.1" = _HDvAnQIw;
        "pkg-mc1.18.2-3.4.0" = _Z8CqLDDO;
        "pkg-mc1.19.2-3.4.0" = _nHeyxX0A;
        "pkg-mc1.19.3-3.4.0" = _fbLmfqa5;
        "pkg-mc1.19.4-3.4.0" = _ka9OYmub;
        "pkg-mc1.20.1-3.4.0" = _5caSj7kt;
        "default" = _5caSj7kt;
    });
