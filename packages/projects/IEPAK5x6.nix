...
let
    ...
    in {
        ...
        "pkg-1.1.6" = _WQNbky5c;
        "pkg-1.1.7" = _WM2WD52i;
        "pkg-v1.1.8" = _VNL9qxuN;
        "pkg-1.1.9" = _RU6DuGfk;
        "pkg-1.1.10" = _kTJydmL9;
        "pkg-1.1.11" = _9IGodraD;
        "pkg-1.1.12" = _dv5Ekeks;
        "pkg-1.1.13" = _2tO12wyr;
        "pkg-1.1.14" = _33UBuPWR;
        "pkg-1.1.15" = _2FP7zVLp;
        "pkg-1.1.16" = _fuKfDM4I;
        "pkg-1.1.17" = _s0rVbfCp;
        "pkg-1.2.0" = _eQ9Cwbhn;
        "pkg-1.2.1" = _eJhLx0nu;
        "pkg-1.2.2" = _LSFSoAeR;
        "pkg-1.2.3" = _a4L62JoR;
