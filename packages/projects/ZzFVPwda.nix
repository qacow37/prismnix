...
let
    ...
    in {
        ...
        "pkg-3+mod" = _IYm8Z1qV;
        "pkg-3.1" = _vzeo9yrg;
        "pkg-3.1+mod" = _UtNiTNBv;
        "pkg-3.2" = _q6H9XYoC;
        "pkg-3.2+mod" = _97ZS52Mu;
        "pkg-3.3" = _rDIHgVA6;
        "pkg-3.3+mod" = _txt8jUri;
        "pkg-3.4" = _eabRWAU8;
        "pkg-3.4+mod" = _wXC5z77s;
        "pkg-3.5-1.20.x" = _YILmyKbR;
        "pkg-3.5-1.20.x+mod" = _8wp5MrB9;
        "pkg-3.5" = _BGC5g0LR;
        "pkg-3.5+mod" = _vPOmg3gu;
        "pkg-3.5.2" = _Rm06OsJt;
        "pkg-3.5.2+mod" = _Zp4rGvm3;
        "pkg-3.6" = _Tnf3WmRu;
        "pkg-3.6+mod" = _vCfV4pHK;
        "pkg-3.7" = _l5cIik83;
        "pkg-3.7+mod" = _752rfdrC;
        "default" = _752rfdrC;
    });
