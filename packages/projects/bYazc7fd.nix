...
let
    ...
    in {
        ...
        "pkg-0.23.4" = _zvQPsYEI;
        "pkg-0.27.0" = _GoiUaKNC;
        "pkg-0.28.0" = _obsjSDhQ;
        "pkg-0.29.0" = _RHI371Uu;
        "pkg-0.29.4" = _7hBq2uM7;
        "pkg-0.29.6" = _Az6xMkc7;
        "pkg-0.29.11" = _5iErH7nw;
        "pkg-0.29.18" = _PrwFfHYa;
        "pkg-0.29.20" = _nBhVLNB3;
        "pkg-0.30.0" = _Runcbxxn;
        "pkg-0.30.1" = _WhYQfKPO;
        "pkg-0.30.3" = _z7GWNn4b;
        "pkg-0.30.4" = _MDLthlTZ;
        "pkg-0.30.7" = _ASkUyKCl;
        "pkg-0.30.10" = _7cyx2hY5;
        "pkg-0.30.11" = _TBZvA0QG;
        "pkg-0.30.12" = _krhT9z6o;
        "pkg-0.31.0" = _kYdP5Wwl;
        "pkg-0.30.15" = _c0iAbWyA;
        "pkg-0.31.3" = _FuglNZrp;
        "pkg-0.31.4" = _LdgDLDqU;
        "pkg-0.31.6" = _ZjeRzbRs;
        "pkg-0.31.9" = _sOGwtz2f;
        "pkg-0.31.10-SNAPSHOT" = _3Zd3kT3M;
        "pkg-0.31.10" = _703gMGve;
        "pkg-0.31.12" = _lSyxYu9g;
        "pkg-0.31.13-SNAPSHOT" = _44wGUGGD;
        "pkg-0.31.13" = _yqi00u70;
        "pkg-0.31.15" = _cAOIkpWF;
        "default" = _cAOIkpWF;
    });
