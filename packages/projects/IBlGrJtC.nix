...
let
    ...
    in {
        ...
        "pkg-forge-1.18.2-1.0.0" = _V4VIRCIv;
        "pkg-fabric-1.18.2-1.0.0" = _OVmyaspg;
        "pkg-forge-1.19.2-1.0.0" = _qRgtNm1r;
        "pkg-fabric-1.19.2-1.0.0" = _yxSD0y9A;
        "pkg-forge-1.19.2-1.1.0" = _6R7c24oE;
        "pkg-fabric-1.19.2-1.1.0" = _DyeRYxuc;
        "pkg-forge-1.19.2-1.1.1" = _WdQ0mrLm;
        "pkg-forge-1.19.3-1.0.0" = _D5qfWpum;
        "pkg-fabric-1.19.3-1.0.0" = _ToUX3iQg;
        "pkg-forge-1.19.3-1.0.1" = _wTCqw0UX;
        "pkg-fabric-1.19.3-1.0.1" = _3OZVo6u1;
        "pkg-fabric-1.19.3-1.0.2" = _2ddjccEL;
        "pkg-fabric-1.20-1.0.0" = _Y8apkNRF;
        "pkg-forge-1.20-1.0.0" = _Z9cCaAMk;
        "pkg-fabric-1.20-1.1.0" = _xwCR2C1I;
        "pkg-forge-1.20-1.1.0" = _U1BubPIq;
        "pkg-quilt-1.20-1.1.0" = _BkRjPUfu;
        "pkg-fabric-1.19.2-1.2.0" = _D8cvUlPE;
        "pkg-forge-1.19.2-1.2.0" = _HxzWpkRb;
        "pkg-quilt-1.19.2-1.2.0" = _bM6hedCb;
        "pkg-3.2.0+1.20.1" = _gJMHOBep;
        "pkg-2.3.0+1.19.2" = _YtygM4i7;
        "pkg-1.1.0+1.18.2" = _U1hQ2yH1;
        "pkg-3.2.1+1.20.1" = _NfYYrzMk;
        "pkg-3.2.2+1.20.1" = _4qWgB4SV;
        "pkg-3.2.3+1.20.1" = _kYqdyb6B;
        "pkg-4.0.0+1.20.2" = _9cvpIYTF;
        "pkg-4.0.1+1.20.2" = _3a33c3nh;
        "pkg-5.0.0+1.20.4" = _o8zsTrZf;
        "pkg-5.1.0+1.20.4" = _2Z7m1odV;
        "pkg-6.0.0+1.20.5" = _ooUcLcNO;
        "pkg-7.0.0+1.21" = _zPzmPwSn;
        "pkg-7.1.0+1.21.1" = _WVEdmoZO;
        "pkg-7.1.1+1.21.1" = _LKuPtvUQ;
        "pkg-3.3.0+1.20.1" = _JALeYrv3;
        "pkg-3.3.1+1.20.1" = _DoVwzvli;
        "pkg-7.2.0+1.21.1" = _PMmXFOqp;
        "pkg-3.4.0+1.20.1" = _SGQ8phJY;
        "pkg-7.3.0+1.21.1" = _EddDSwpM;
        "pkg-3.4.1+1.20.1-fabric" = _4EhWMsyv;
        "pkg-3.4.1+1.20.1-forge" = _VEVX8qmw;
        "pkg-3.4.1+1.20.1-quilt" = _h7armvZ3;
        "pkg-7.3.1+1.21.1-fabric" = _57WGUEZk;
        "pkg-7.3.1+1.21.1-neoforge" = _7DLfmBLO;
        "pkg-7.3.2+1.21.1-fabric" = _dUnSYhMq;
        "pkg-7.3.2+1.21.1-neoforge" = _j1jHWr3M;
        "pkg-7.3.3+1.21.1-fabric" = _K2CrgnQh;
        "pkg-7.3.3+1.21.1-neoforge" = _jiXGEfgF;
        "pkg-7.4.0+1.21.1-fabric" = _2lXhvr8W;
        "pkg-7.4.0+1.21.1-neoforge" = _yLGFb5V1;
        "pkg-7.4.1+1.21.1-fabric" = _KoLiT6a6;
        "pkg-7.4.1+1.21.1-neoforge" = _8vXZuYQ1;
        "pkg-8.0.0+1.21.11-fabric" = _xGBdwxVG;
        "pkg-8.0.0+1.21.11-neoforge" = _ZREhUtNE;
        "pkg-8.0.1+1.21.11-fabric" = _Db6uB6ge;
        "pkg-8.0.1+1.21.11-neoforge" = _l0wE4g3n;
        "pkg-9.0.0+1.18.2-fabric" = _2y1Kcn6n;
        "pkg-9.0.0+1.18.2-forge" = _CCFTcm60;
        "pkg-9.0.0+1.19.2-fabric" = _DZOgOwOo;
        "pkg-9.0.0+1.19.2-forge" = _n1ZgsoGN;
        "pkg-9.0.0+1.20.1-fabric" = _esCiNXxZ;
        "pkg-9.0.0+1.20.1-forge" = _6ODYBpl7;
        "pkg-9.0.0+1.21.1-fabric" = _F8cetQFN;
        "pkg-9.0.0+1.21.1-neoforge" = _lsbqVn4T;
        "pkg-9.0.0+1.21.11-fabric" = _Wt6ThmL8;
        "pkg-9.0.0+1.21.11-neoforge" = _IaFMgK2y;
        "pkg-9.0.0+26.1-fabric" = _pWo0k5zQ;
        "pkg-9.0.0+26.1-neoforge" = _hNhJfea4;
        "default" = _hNhJfea4;
    });
