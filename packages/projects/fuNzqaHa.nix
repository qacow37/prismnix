...
let
    ...
    in {
        ...
        "pkg-1.16" = _SIkWMjm6;
        "pkg-1.16.1" = _hNlUU5fh;
        "pkg-1.16.2" = _3zRoDB3G;
        "pkg-1.16.3" = _3hG6RlWR;
        "pkg-1.16.4" = _z9YB2TOa;
        "pkg-1.16.5" = _MUaVXdqT;
        "pkg-1.17" = _gFEmMuX4;
        "pkg-1.17.1" = _ktPN9eQi;
        "pkg-1.18" = _S2l1mmu5;
        "pkg-1.18.1" = _llbO2EXv;
        "pkg-1.18.2" = _ChoibkUJ;
        "pkg-1.19" = _mUwfhoul;
        "pkg-1.19.1" = _mk0fA9rH;
        "pkg-1.19.2" = _LARrHf8P;
        "pkg-1.19.3" = _qBSPC7Ix;
        "pkg-1.19.4" = _lCV1hvbE;
        "pkg-1.20" = _fL0o82gH;
        "pkg-1.20.1" = _bdt7GlRF;
        "pkg-1.20.2" = _Jr6uNnLB;
        "pkg-1.20.3" = _gRZCharC;
        "pkg-1.20.4" = _TrqHFDii;
        "pkg-1.20.5" = _z8co8Fea;
        "pkg-1.20.6" = _qKP14I17;
        "pkg-1.21" = _4bsS5RSV;
        "pkg-1.21.1" = _8Wj37rpa;
        "pkg-1.21.2" = _PigiZza7;
        "pkg-1.21.3" = _rTiNdkXU;
        "pkg-1.21.4" = _f82lakF0;
        "pkg-1.21.5" = _nPPlkatE;
        "pkg-1.21.6" = _zStp87sV;
        "pkg-1.21.7" = _MoM4IKI5;
        "pkg-1.21.8" = _3MflEQdJ;
        "pkg-1.21.9" = _jYXF2Di8;
        "pkg-1.21.10" = _vcgkysnB;
        "pkg-1.21.11" = _VKY5u6rM;
        "default" = _VKY5u6rM;
    });
