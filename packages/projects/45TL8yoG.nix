...
let
    ...
    in {
        ...
        "pkg-1.12.2-3.0.0-rc1" = _Cq2bVDla;
        "pkg-1.16.5-2.0.0-rc1" = _boMasnw4;
        "pkg-1.18.2-1.0.0-rc1" = _qt8pcVZD;
        "pkg-1.19.2-1.0.0-rc1" = _zbrIR6Ux;
        "pkg-1.20.1-1.0.0-rc1" = _SDTaTTgW;
        "pkg-1.12.2-1.0.0-rc2" = _r2J48FxG;
        "pkg-1.16.5-2.0.0-rc2" = _ygZo6PpG;
        "pkg-1.18.2-1.0.0-rc2" = _vJBkhQtC;
        "pkg-1.19.2-1.0.0-rc2" = _KqcWLbEo;
        "pkg-1.20.1-1.0.0-rc2" = _SlkPtMpJ;
        "pkg-1.12.2-3.0.0-rc3" = _Y63ueBz8;
        "pkg-1.16.5-2.0.0-rc3" = _xfnFTds2;
        "pkg-1.18.2-1.0.0-rc3" = _g9elqQ4g;
        "pkg-1.19.2-1.0.0-rc3" = _FelGFH4A;
        "pkg-1.20.1-1.0.0-rc3" = _F20HCBS1;
        "pkg-1.12.2-3.0.0-rc4" = _VuZ4Teo2;
        "pkg-1.16.5-2.0.0-rc4" = _CNUKkvPL;
        "pkg-1.18.2-1.0.0-rc4" = _LW0NErOe;
        "pkg-1.19.2-1.0.0-rc4" = _nJI1gW1h;
        "pkg-1.20.1-1.0.0-rc4" = _AbjoV6RK;
        "pkg-1.12.2-3.0.0" = _hue3vbR9;
        "pkg-1.16.5-2.0.0" = _Ab84cA1L;
        "pkg-1.18.2-1.0.0" = _RzfUkQBS;
        "pkg-1.19.2-1.0.0" = _HhXBva5t;
        "pkg-1.20.1-1.0.0" = _WyW2Cvvp;
        "default" = _WyW2Cvvp;
    });
