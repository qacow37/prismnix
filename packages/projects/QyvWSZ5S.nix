...
let
    ...
    in {
        ...
        "pkg-1.1.5" = _IBcqAk7N;
        "pkg-1.1.6" = _IW4l13Hu;
        "pkg-1.1.6-fabric-1.20.1" = _F0t17G5X;
        "pkg-1.1.6-fabric-1.20.6" = _634z05bZ;
        "pkg-1.1.6-forge-1.20.1" = _PPenS053;
        "pkg-1.1.6-neoforge-1.20.6" = _rya6uic0;
        "pkg-1.1.7" = _DuFfJ3jc;
        "pkg-1.1.8-fabric-1.21.1" = _tcXqCpPq;
        "pkg-1.1.8-neoforge-1.21.1" = _4jWlQkHy;
        "pkg-0.10.0-snapshot.1" = _tebCr0rn;
        "pkg-2.0.0-fabric,1.21" = _nrCSifwo;
        "pkg-2.0.0-neoforge,1.21" = _VOg87xHV;
        "pkg-2.0.0-forge,1.21" = _9eYtQUQy;
        "pkg-2.0.1-fabric,1.21.1" = _MXVGS9Kc;
        "pkg-2.1.0-fabric,1.21.1" = _jzFrWf8h;
        "pkg-2.1.0-neoforge,1.21.1" = _Ox5f3Uly;
        "pkg-2.1.0-forge,1.21.1" = _KpB2asg8;
        "pkg-2.1.1-fabric,1.21.1" = _4Zxlcb5t;
        "pkg-2.1.1-neoforge,1.21.1" = _NKV07m90;
        "pkg-2.1.1-forge,1.21.1" = _wtxAL3YH;
        "pkg-2.2.0-fabric,1.21.1" = _km4DcS5s;
        "pkg-2.2.0-neoforge,1.21.1" = _BMGxvUeP;
        "pkg-2.2.0-forge,1.21.1" = _lhzug4tq;
        "pkg-2.2.1-fabric,1.21.1" = _vYeMiCbz;
        "pkg-2.2.1-neoforge,1.21.1" = _zLUFH2X2;
        "pkg-2.2.2-fabric,1.21.1" = _3yMLdi0a;
        "pkg-2.2.2-neoforge,1.21.1" = _UdaCWSGR;
        "pkg-2.2.2-forge,1.21.1" = _WgftKX3g;
        "pkg-2.2.3-fabric,1.21.1" = _bZ0V7DG4;
        "pkg-2.2.3-neoforge,1.21.1" = _YeyiYgTy;
        "pkg-2.2.3-forge,1.21.1" = _efe2KFUk;
        "pkg-2.2.4-fabric,1.21.1" = _Me5V7UJd;
        "pkg-2.2.5-fabric,1.21.3" = _62EHqqv6;
        "pkg-2.2.5-neoforge,1.21.3" = _v2MnOpbB;
        "pkg-2.2.5-forge,1.21.3" = _gynyZsDp;
        "pkg-2.3.0-fabric,1.21.3" = _NQzCUwOd;
        "pkg-2.3.0-neoforge,1.21.3" = _E7K9ZMD2;
        "pkg-2.3.0-forge,1.21.3" = _NnZfEWzk;
        "default" = _NnZfEWzk;
    });
