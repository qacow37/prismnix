...
let
    ...
    in {
        ...
        "pkg-1.19.4-0-fabric" = _ltk4GWOJ;
        "pkg-1.20-0-fabric" = _x9LyxQup;
        "pkg-1.20.1-0-fabric" = _6QclfLjO;
        "pkg-1.20.2-0-fabric" = _IB2fdW76;
        "pkg-1.20.3-0-fabric" = _BPOA7ewo;
        "pkg-1.20.4-0-fabric" = _gvsOpsKv;
        "pkg-1.18.2-0-forge" = _s1tTRiMc;
        "pkg-1.19-6-forge" = _DqcCnsGX;
        "pkg-1.19.1-6-forge" = _3bLbrimG;
        "pkg-1.19.2-6-forge" = _CiOvohtI;
        "pkg-1.19.3-6-forge" = _VhswJLH1;
        "pkg-1.19.4-6-forge" = _sJ402Sno;
        "pkg-1.20-0-forge" = _iWAif3mw;
        "pkg-1.20.1-0-forge" = _bpc9rtQL;
        "pkg-1.20.2-0-forge" = _xq0gsSpV;
        "pkg-1.20.3-0-forge" = _EpTBZpLR;
        "pkg-1.20.4-0-forge" = _bJK5ojmp;
        "pkg-1.20.4-0-neoforge" = _lUY7djdj;
        "pkg-1.20.6-11-forge" = _NIDMDoMP;
        "pkg-1.20.6-0-neoforge" = _7IzZOOdM;
        "pkg-1.20.5-0-fabric" = _HBNpeVSK;
        "pkg-1.20.6-0-fabric" = _krhXCKLq;
        "pkg-1.21-11-forge" = _BvlfGK7O;
        "pkg-1.21-0-neoforge" = _YJ6t3QcT;
        "pkg-1.21-0-fabric" = _8Gml3Rcj;
        "pkg-1.20.4-1-neoforge" = _l2T13kXw;
        "pkg-1.20.6-1-neoforge" = _EanVeSB6;
        "pkg-1.21-1-neoforge" = _I8eVa5Mg;
        "pkg-1.19.1-1-fabric" = _x77WtMay;
        "pkg-1.19.2-1-fabric" = _l2gqSCnT;
        "pkg-1.19.3-1-fabric" = _fcr0ykqv;
        "pkg-1.19.4-1-fabric" = _f81SUvbt;
        "pkg-1.20-1-fabric" = _wyUiYVSW;
        "pkg-1.20.1-1-fabric" = _bYWrHSKR;
        "pkg-1.20.2-1-fabric" = _lqHy6pp6;
        "pkg-1.20.3-1-fabric" = _5Obwvv6Q;
        "pkg-1.20.4-1-fabric" = _wbhc2wOi;
        "pkg-1.20.5-1-fabric" = _kt8evwkM;
        "pkg-1.20.6-1-fabric" = _5H52Rjz1;
        "pkg-1.21-1-fabric" = _E0XVXnqw;
        "pkg-1.18.2-1-forge" = _jU7e9WM0;
        "pkg-1.19-1-forge" = _dQAMz0Fl;
        "pkg-1.19.1-1-forge" = _rXcnxDI2;
        "pkg-1.19.2-1-forge" = _45LhxCF8;
        "pkg-1.19.3-1-forge" = _22N3HJVf;
        "pkg-1.19.4-1-forge" = _mYuMmyMv;
        "pkg-1.20-1-forge" = _xp6BQa25;
        "pkg-1.20.1-1-forge" = _KtWpKUIA;
        "pkg-1.20.2-1-forge" = _BXe98jWR;
        "pkg-1.20.3-1-forge" = _Zx1mYkfD;
        "pkg-1.20.4-1-forge" = _bkPyPdVD;
        "pkg-1.20.6-1-forge" = _eQQQqGXu;
        "pkg-1.21-1-forge" = _NPc3ObrC;
        "pkg-1.21.1-1-neoforge" = _bEQOSlg4;
        "pkg-1.21.1-1-forge" = _MGxrAdf9;
        "pkg-1.21.1-1-fabric" = _BHWhwiLa;
        "pkg-1.18.2-2-forge" = _L30x564y;
        "pkg-1.19-2-forge" = _YvU6YBxb;
        "pkg-1.19.1-2-forge" = _42kU5Bjr;
        "pkg-1.19.2-2-forge" = _66OQaHo1;
        "pkg-1.19.3-2-forge" = _gabLNFMS;
        "pkg-1.19.4-2-forge" = _ethmQmQg;
        "pkg-1.20-2-forge" = _SceAcAjg;
        "pkg-1.20.1-2-forge" = _VaF0DULG;
        "pkg-1.20.2-2-forge" = _3AHYkKHb;
        "pkg-1.20.3-2-forge" = _rzlwKvCB;
        "pkg-1.20.4-2-forge" = _sPpFUuMa;
        "pkg-1.20.6-2-forge" = _42deSG9q;
        "pkg-1.21.1-2-forge" = _E4Fg6LJg;
        "pkg-1.20.4-2-neoforge" = _7i5jEtgq;
        "pkg-1.20.6-2-neoforge" = _25L5z3fC;
        "pkg-1.21.1-2-neoforge" = _RVOyxI2O;
        "pkg-1.19.1-2-fabric" = _ZxRJ5Qmi;
        "pkg-1.19.2-2-fabric" = _RBDOjQye;
        "pkg-1.19.3-2-fabric" = _b5fnxbWQ;
        "pkg-1.19.4-2-fabric" = _XZKVSbVQ;
        "pkg-1.20-2-fabric" = _8OxMpq3O;
        "pkg-1.20.1-2-fabric" = _3RhsO40Z;
        "pkg-1.20.2-2-fabric" = _q08FcTMl;
        "pkg-1.20.3-2-fabric" = _gsAaS62W;
        "pkg-1.20.4-2-fabric" = _mH4f9A2z;
        "pkg-1.20.5-2-fabric" = _WbutvfaS;
        "pkg-1.20.6-2-fabric" = _cTx0D3n9;
        "pkg-1.21.1-2-fabric" = _aXDXmNGu;
        "pkg-1.21.3-2-fabric" = _l5Ei9eCW;
        "pkg-1.21.3-2-forge" = _fuf7ojZt;
        "pkg-1.21.3-2-neoforge" = _Th9jEmqc;
        "pkg-1.21.4-2-neoforge" = _ZS1183UK;
        "pkg-1.21.4-2-forge" = _pijISHEs;
        "pkg-1.21.4-2-fabric" = _1uc0XYZ4;
        "pkg-1.18.2-fabric-2" = _bmLmDs8n;
        "pkg-1.18.2-forge-2" = _93ZZWLYd;
        "pkg-1.19.2-fabric-2" = _dOaLnaY6;
        "pkg-1.19.2-forge-2" = _Yh7LDGCl;
        "pkg-1.19.4-fabric-2" = _w9olWzS0;
        "pkg-1.19.4-forge-2" = _Jb6i0ZuM;
        "pkg-1.20.1-fabric-2" = _iXQjSAUa;
        "pkg-1.20.1-forge-2" = _P69SIvmN;
        "pkg-1.20.2-fabric-2" = _VWqCYtSS;
        "pkg-1.20.2-forge-2" = _RMjs0LGy;
        "pkg-1.20.4-fabric-2" = _QL8aJmPr;
        "pkg-1.20.4-forge-2" = _LhXv2r8K;
        "pkg-1.20.6-fabric-2" = _qspbzAxN;
        "pkg-1.20.6-forge-2" = _EYrO54kz;
        "pkg-1.20.6-neoforge-2" = _UTbznWmk;
        "pkg-1.21.1-fabric-2" = _VkIumM4n;
        "pkg-1.21.1-forge-2" = _Wd9UgOR0;
        "pkg-1.21.1-neoforge-2" = _QVjvRlvo;
        "pkg-1.21.3-fabric-2" = _RRG3BqmM;
        "pkg-1.21.3-forge-2" = _EZXvskZo;
        "pkg-1.21.3-neoforge-2" = _CK0uSAh3;
        "pkg-1.21.4-fabric-2" = _CH9YFpE0;
        "pkg-1.21.4-forge-2" = _cpUExyha;
        "pkg-1.21.4-neoforge-2" = _Ax8AqHnx;
        "pkg-1.18.2-forge-2.1" = _kRQRUkfD;
        "pkg-1.19.2-forge-2.1" = _3Z7oukKz;
        "pkg-1.19.4-forge-2.1" = _JfJC4QOQ;
        "pkg-1.20.1-forge-2.1" = _aJszMnZw;
        "pkg-1.20.2-forge-2.1" = _CHmoPgqS;
        "pkg-1.20.4-forge-2.1" = _3GNTRXWG;
        "pkg-1.20.6-forge-2.1" = _ewtVD8zN;
        "pkg-1.20.6-neoforge-2.1" = _RYEdSTmX;
        "pkg-1.21.1-forge-2.1" = _EUBKENvh;
        "pkg-1.21.1-neoforge-2.1" = _lp5UNcEI;
        "pkg-1.21.3-forge-2.1-javadoc" = _j3KaB9oT;
        "pkg-1.21.3-neoforge-2.1" = _sh5CHjNO;
        "pkg-1.21.4-forge-2.1" = _OBh9pM95;
        "pkg-1.21.4-neoforge-2.1" = _eCmc3T4I;
        "pkg-1.21.5-fabric-2.1" = _fHaasGok;
        "pkg-1.21.5-forge-2.1" = _1hxSb1UJ;
        "pkg-1.21.5-neoforge-2.1" = _2UNIjETO;
        "pkg-1.18.2-fabric-2.1" = _vwnXxj5f;
        "pkg-1.19.2-fabric-2.1" = _XV9VqVgC;
        "pkg-1.19.4-fabric-2.1" = _HlsWtm5t;
        "pkg-1.20.1-fabric-2.1" = _jfZb6Mjk;
        "pkg-1.20.2-fabric-2.1" = _IGEZP0O3;
        "pkg-1.20.4-fabric-2.1" = _SJDOxZwL;
        "pkg-1.20.6-fabric-2.1" = _njbmiWz1;
        "pkg-1.21.1-fabric-2.1" = _xWb70tl7;
        "pkg-1.21.3-fabric-2.1" = _SNZDeqym;
        "pkg-1.21.3-forge-2.1" = _6yfUjGpx;
        "pkg-1.21.4-fabric-2.1" = _aAon2xrq;
        "pkg-1.21.6-fabric-2.1" = _uCAlVxBx;
        "pkg-1.21.6-forge-2.1" = _MDYVfWGr;
        "pkg-1.21.6-neoforge-2.1" = _Qcmz58sX;
        "pkg-1.21.6-fabric-2.2" = _iCrRHb52;
        "pkg-1.21.6-forge-2.2" = _REaHocPa;
        "pkg-1.21.6-neoforge-2.2" = _Qh6QkOnV;
        "pkg-1.21.7-fabric-2.2" = _3nalAivh;
        "pkg-1.21.7-forge-2.2" = _hGiEkSzu;
        "pkg-1.21.7-neoforge-2.2" = _vCATCp43;
        "pkg-1.21.7-fabric-2.3" = _rIlWyyPV;
        "pkg-1.21.7-forge-2.3" = _XaQDcB99;
        "pkg-1.21.7-neoforge-2.3" = _xX2nxIz2;
        "pkg-1.21.8-fabric-2.3" = _BzSb8Tg5;
        "pkg-1.21.8-forge-2.3" = _HFlZm9Ii;
        "pkg-1.21.8-neoforge-2.3" = _Mmz2Jh36;
        "pkg-1.18.2-fabric-2.2" = _y4nvzfir;
        "pkg-1.18.2-forge-2.2" = _FRM286M4;
        "pkg-1.19.2-fabric-2.2" = _ZUjnqmZM;
        "pkg-1.19.2-forge-2.2" = _TVmztQO2;
        "pkg-1.19.4-fabric-2.2" = _DtAhH5Vx;
        "pkg-1.19.4-forge-2.2" = _fQ7TdxJy;
        "pkg-1.20.1-fabric-2.2" = _LU3QssZU;
        "pkg-1.20.1-forge-2.2" = _wfMr5rnM;
        "pkg-1.20.2-fabric-2.2" = _bT7u7pw0;
        "pkg-1.20.2-forge-2.2" = _DQkcqTW2;
        "pkg-1.20.4-fabric-2.2" = _wMamuCuD;
        "pkg-1.20.4-forge-2.2" = _HlJRc7Sy;
        "pkg-1.20.6-fabric-2.2" = _xX5fmzNS;
        "pkg-1.20.6-forge-2.2" = _cLQWkAEW;
        "pkg-1.20.6-neoforge-2.2" = _9e7LpvEV;
        "pkg-1.21.1-fabric-2.2" = _WdGCtron;
        "pkg-1.21.1-forge-2.2" = _9rrRg03O;
        "pkg-1.21.1-neoforge-2.2" = _TuBJQBPn;
        "pkg-1.21.3-fabric-2.2" = _lLhn1Prk;
        "pkg-1.21.3-forge-2.2" = _RbUK2TG8;
        "pkg-1.21.3-neoforge-2.2" = _Tatc3vQD;
        "pkg-1.21.4-fabric-2.2" = _VAMovS4s;
        "pkg-1.21.4-forge-2.2" = _DqPVd144;
        "pkg-1.21.4-neoforge-2.2" = _aPtVhJ1H;
        "pkg-1.21.5-fabric-2.2" = _XVet6h5t;
        "pkg-1.21.5-forge-2.2" = _knsGtUKc;
        "pkg-1.21.5-neoforge-2.2" = _WqU11mV0;
        "pkg-1.21.8-fabric-2.4" = _ZsorFKKT;
        "pkg-1.21.8-forge-2.4" = _85z2Jpkh;
        "pkg-1.21.8-neoforge-2.4" = _MdruQWJc;
        "pkg-1.21.9-fabric-2.4" = _nem4INXf;
        "pkg-1.21.9-forge-2.4" = _HgzoSXrm;
        "pkg-1.21.9-neoforge-2.4" = _WdZhfosw;
        "pkg-1.21.10-fabric-2.4" = _IX7oFo5L;
        "pkg-1.21.10-forge-2.4" = _P5RvFI6n;
        "pkg-1.21.10-neoforge-2.4" = _Aw3cV0lM;
        "pkg-1.21.11-fabric-2.4" = _mo3Y2Bcs;
        "pkg-1.21.11-forge-2.4" = _oQp6fzLU;
        "pkg-1.21.11-neoforge-2.4" = _vrtQ5Vtw;
        "pkg-1.18.2-fabric-2.5" = _8jFVEJ0c;
        "pkg-1.18.2-forge-2.5" = _yO969z1z;
        "pkg-1.19.2-fabric-2.5" = _FwDdGOtl;
        "pkg-1.19.2-forge-2.5" = _cXi3vQvx;
        "pkg-1.19.4-fabric-2.5" = _RWpFBiUq;
        "pkg-1.19.4-forge-2.5" = _ezoPlMoe;
        "pkg-1.20.1-fabric-2.5" = _rFLQlN7k;
        "pkg-1.20.1-forge-2.5" = _15qdKfNA;
        "pkg-1.20.2-fabric-2.5" = _RcHuWIKT;
        "pkg-1.20.2-forge-2.5" = _mYpYsEbU;
        "pkg-1.20.4-fabric-2.5" = _PXU3Mu1m;
        "pkg-1.20.4-forge-2.5" = _gPrw7LKf;
        "pkg-1.20.6-fabric-2.5" = _dmdgCxWY;
        "pkg-1.20.6-forge-2.5" = _MX9kbum5;
        "pkg-1.20.6-neoforge-2.5" = _46Xsxbi0;
        "pkg-1.21.1-fabric-2.5" = _KJZkM3b6;
        "pkg-1.21.1-forge-2.5" = _kaYE7F5O;
        "pkg-1.21.1-neoforge-2.5" = _bFgDzWfM;
        "pkg-1.21.10-fabric-2.5" = _LaoHBxFq;
        "pkg-1.21.10-forge-2.5" = _bpvhNFDo;
        "pkg-1.21.10-neoforge-2.5" = _VXDdeUCJ;
        "pkg-1.21.11-fabric-2.5" = _PxGJEfWp;
        "pkg-1.21.11-forge-2.5" = _9f3jcX07;
        "pkg-1.21.11-neoforge-2.5" = _poFY05zp;
        "pkg-1.21.3-fabric-2.5" = _DxeEUDru;
        "pkg-1.21.3-forge-2.5" = _xqcZw07H;
        "pkg-1.21.3-neoforge-2.5" = _wraI3TWO;
        "pkg-1.21.4-fabric-2.5" = _1Q0R3Kj6;
        "pkg-1.21.4-forge-2.5" = _6U1Nx4Su;
        "pkg-1.21.4-neoforge-2.5" = _cR3In7OQ;
        "pkg-1.21.5-fabric-2.5" = _KluQVUwC;
        "pkg-1.21.5-forge-2.5" = _EOoThIYa;
        "pkg-1.21.5-neoforge-2.5" = _Ev0SMDak;
        "pkg-1.21.8-fabric-2.5" = _veMdGVNo;
        "pkg-1.21.8-forge-2.5" = _MVlwR04z;
        "pkg-1.21.8-neoforge-2.5" = _ryEFii9f;
        "pkg-26.1.1-fabric-2.5" = _3a5GbQvF;
        "pkg-26.1.1-forge-2.5" = _Sup9lL14;
        "pkg-26.1.1-neoforge-2.5" = _cPXvMmPI;
        "pkg-26.1.2-fabric-2.5" = _T2oC3g4v;
        "pkg-26.1.2-forge-2.5" = _cf6YS32G;
        "pkg-26.1.2-neoforge-2.5" = _qqKS5hKV;
