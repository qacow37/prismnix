...
let
    ...
    in {
        ...
        "pkg-0.0.8" = _qpKOeupR;
        "pkg-0.0.9" = _4zPuUglX;
        "pkg-0.0.10" = _JNah3Le7;
        "pkg-0.1.1" = _Oh0fl63g;
        "pkg-0.1.2" = _62UJ8X8m;
        "pkg-0.0.11" = _UIYT1CDD;
        "pkg-0.0.12" = _jQGr4tDD;
        "pkg-0.1.3" = _77rkwXZi;
        "pkg-0.0.13" = _Qy4emOQd;
        "pkg-0.1.4" = _vrPXGDn6;
        "pkg-0.1.5" = _DtHCQo0T;
        "pkg-0.1.6" = _8QYTQr4N;
        "pkg-0.0.14" = _ZagJoBKb;
        "pkg-0.1.7" = _pPDhcQYI;
        "pkg-0.1.8" = _4eym8i2j;
        "pkg-0.0.15" = _3ZA7qFo4;
        "pkg-0.0.16" = _E0I3y534;
        "pkg-0.1.9" = _eZg9TkKF;
        "pkg-0.1.10" = _DA7qZugU;
        "pkg-0.0.17" = _JdQcLMHe;
        "pkg-0.1.11" = _JNa9DOCI;
        "pkg-0.0.18" = _2r3lSbin;
        "pkg-0.0.19" = _D3jdYtvu;
        "pkg-0.0.20" = _r4oOieGC;
        "pkg-0.1.12" = _Nt6zJvUN;
        "default" = _Nt6zJvUN;
    });
