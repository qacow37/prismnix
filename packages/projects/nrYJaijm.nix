...
let
    ...
    in {
        ...
        "pkg-19.0.0" = _Ms8PQ1WR;
        "pkg-20.0.0" = _OOQpUDUj;
        "pkg-20.0.1" = _59SUUpnY;
        "pkg-19.0.1" = _5mkqVczZ;
        "pkg-27.0.0" = _6bfwPJto;
        "pkg-20.0.3" = _RRlJD0dk;
        "pkg-21.0.0" = _Dh5o1zgY;
        "pkg-22.0.3" = _IQGdNNpG;
        "pkg-22.0.0" = _ridDVbwr;
        "pkg-20.0.2" = _OFrGlDW6;
        "pkg-23.0.1" = _HKwq4sad;
        "pkg-25.0.3" = _LM838kqW;
        "pkg-25.0.2" = _4RyGYMbd;
        "pkg-24.0.3" = _ijKzSwFu;
        "pkg-24.0.4" = _99CyXUzG;
        "pkg-26.0.0" = _175zHR55;
        "pkg-28.0.0" = _FWGyxDft;
        "pkg-28.0.1" = _FXNa8GlP;
        "pkg-28.1.0" = _epZRSG75;
        "pkg-27.0.1" = _vnQW992V;
        "pkg-26.0.1" = _zpoHT6Cc;
        "pkg-24.0.5" = _FuB3ur8F;
        "pkg-23.0.2" = _H9VEOqnT;
        "pkg-24.0.6" = _e19toaIH;
        "pkg-26.0.2" = _Bi0rMFKJ;
        "pkg-27.0.2" = _1uGuvryH;
        "pkg-28.0.2" = _1kG4wqeu;
        "pkg-28.1.1" = _MGwJVnD9;
        "pkg-23.0.3" = _UmN8vX9v;
        "pkg-29.0.0-pre1" = _OcNm7q48;
        "pkg-29.0.0-pre2" = _cYbpGUMS;
        "pkg-29.0.0-pre3" = _pOKJqOlG;
        "pkg-29.0.0-pre4" = _8aJLulbt;
        "pkg-29.0.0-pre5" = _mltwZSOb;
        "pkg-29.0.0-pre6" = _ml82QLBn;
        "pkg-29.0.0-pre7" = _hrUkBH18;
        "pkg-29.0.0-pre8" = _NHtvGmG8;
        "pkg-29.0.0-pre9" = _Vead2U4O;
        "pkg-29.0.0-rc1" = _Ww6DVLOB;
        "pkg-29.0.0" = _CXVuBUIU;
        "pkg-29.0.1" = _Xspc1Vmd;
        "pkg-30.0.0" = _njVkW4lR;
        "pkg-31.0.0" = _a7Y6m0GC;
        "pkg-31.0.1" = _hASDKb8M;
        "pkg-30.0.1" = _pzKvfJkK;
        "pkg-32.0.0" = _tAFzyvF2;
        "pkg-32.0.1" = _BHo5RA4I;
        "pkg-32.0.2" = _ekTYvWKb;
        "pkg-32.0.3" = _l1kIDzc4;
        "pkg-32.0.4" = _iD7DteCh;
        "pkg-33.0.0" = _wWU0FE9J;
        "pkg-31.0.2" = _s3qcsCPF;
        "pkg-30.0.2" = _F89qNYVf;
        "pkg-28.1.2" = _c7XKc8Z1;
        "default" = _c7XKc8Z1;
    });
