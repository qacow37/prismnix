...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _H2znAbYq;
        "pkg-v5.0.0-1.19.3-Forge" = _HZvcjugr;
        "pkg-v5.0.0-1.19.3-Fabric" = _XFw3dTD1;
        "pkg-v6.0.0-1.19.4-Fabric" = _Bd82N1Gy;
        "pkg-v6.0.0-1.19.4-Forge" = _ltgfTINx;
        "pkg-v7.0.0-1.20-Forge" = _k27i84Ef;
        "pkg-v7.0.0-1.20-Fabric" = _bK5ZTDlv;
        "pkg-v8.0.0-1.20.1-Fabric" = _uDp2TXlN;
        "pkg-v8.0.0-1.20.1-Forge" = _juXraD7j;
        "pkg-v3.0.0-1.18.2-Forge" = _KaC0GODt;
        "pkg-v3.0.0-1.18.2-Fabric" = _VfsWZ7u6;
        "pkg-v8.0.1-1.20.1-Forge" = _w90XIUWB;
        "pkg-v8.0.1-1.20.1-Fabric" = _oswQSU19;
        "pkg-v20.4.0-1.20.4-Fabric" = _cvWP8a7w;
        "pkg-v20.4.0-1.20.4-Forge" = _UbHmYRot;
        "pkg-v20.4.0-1.20.4-NeoForge" = _yUsCkozZ;
        "pkg-v21.1.0-1.21.1-Fabric" = _E6S1e9DZ;
        "pkg-v21.1.0-1.21.1-NeoForge" = _KmXCtHi0;
        "pkg-v21.1.1-1.21.1-Fabric" = _c6NQdp13;
        "pkg-v21.1.1-1.21.1-NeoForge" = _PYRrjTaY;
        "pkg-v21.3.0-1.21.3-Fabric" = _kOqQ3umk;
        "pkg-v21.3.0-1.21.3-NeoForge" = _Diiv4t6s;
        "pkg-v21.4.0-1.21.4-Fabric" = _uJRzcUlN;
        "pkg-v21.4.0-1.21.4-NeoForge" = _eilz8wMG;
        "pkg-v21.5.0-1.21.5-Fabric" = _Jai3AJ2X;
        "pkg-v21.5.0-1.21.5-NeoForge" = _mGPaTx9D;
        "pkg-v21.6.0-1.21.6-Fabric" = _3hOzRVMU;
        "pkg-v21.6.0-1.21.6-NeoForge" = _9Pnh0LHE;
        "pkg-v21.7.0-1.21.7-Fabric" = _X441tOCy;
        "pkg-v21.7.0-1.21.7-NeoForge" = _KsXxG198;
        "pkg-v21.8.0-1.21.8-Fabric" = _qHtIufSo;
        "pkg-v21.8.0-1.21.8-NeoForge" = _srjHsl7b;
        "pkg-21.9.0" = _OZvZSwbr;
        "pkg-21.10.0" = _xn5YwKCf;
        "pkg-21.10.1" = _PpqXBdSK;
