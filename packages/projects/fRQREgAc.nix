...
let
    ...
    in {
        ...
        "pkg-3.5-beta-3" = _zI8J2fqk;
        "pkg-3.5-beta-3-866" = _sjHW2fTC;
        "pkg-3.5-forge-1.12.2" = _76EfaYa6;
        "pkg-3.5-forge-1.14.4" = _wmAdoTWS;
        "pkg-3.5-forge-1.15.2" = _eZE0QnoA;
        "pkg-3.5-forge-1.16.5" = _UkFspHnj;
        "pkg-3.5-forge-1.17.1" = _Vb86mln3;
        "pkg-3.5-forge-1.18.2" = _QWXNDNRM;
        "pkg-3.5-forge-1.19" = _QYmtMo1x;
        "pkg-3.5-forge-1.19.2" = _XzgHyUAN;
        "pkg-3.5-forge-1.19.3" = _dvITxiOM;
        "pkg-v3.5-fabric-1.14.4" = _hx37Wra1;
        "pkg-v3.5-fabric-1.15.2" = _9LStbksc;
        "pkg-v3.5-fabric-1.16.4" = _K3cyKLTY;
        "pkg-v3.5-fabric-1.17.1" = _V8iRFlxP;
        "pkg-v3.5-fabric-1.18.2" = _mhQojrZw;
        "pkg-v3.5-fabric-1.19" = _nt2kcNwo;
        "pkg-v3.5-fabric-1.19.1" = _anURObBG;
        "pkg-v3.5-fabric-1.19.3" = _CXwjIeS2;
        "pkg-v3.5-fabric-1.19.4" = _WUAsGsVK;
        "pkg-3.5-spigot" = _YsFoYsPV;
        "pkg-3.6-beta-1" = _vjPULkv3;
        "pkg-3.6-beta-2" = _Tq6vKidz;
        "pkg-3.6" = _vqx7tUUt;
        "pkg-3.7-beta-2" = _UXqPUg7D;
        "pkg-3.7-beta-3-932" = _SunlT39I;
        "pkg-3.7-beta-3" = _zPiaQlaJ;
        "pkg-v3.7-beta-3" = _rO4GzRCo;
        "pkg-3.7-beta-4-935" = _E0uc64ti;
        "pkg-3.7-beta-4" = _fOe507oy;
        "pkg-3.7-beta-5" = _CeFY2xAD;
        "pkg-3.7-beta-6" = _IIQSYMHC;
        "pkg-3.7-beta-7" = _AdtrWcU2;
        "pkg-3.7-beta-8" = _ewsTwo6L;
        "pkg-3.7-beta-9" = _sXDq1ybz;
        "pkg-3.7-beta-10" = _n9wM3HwU;
        "pkg-3.7-beta-11" = _su7EwNNG;
        "pkg-v3.8" = _qoqV5Ysj;
        "default" = _qoqV5Ysj;
    });
