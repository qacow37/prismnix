...
let
    ...
    in {
        ...
        "pkg-1.17.0.8" = _ibq5WYnJ;
        "pkg-1.18.2.5" = _IA7TXsjL;
        "pkg-2.0.0.5" = _CGK8S9Jc;
        "pkg-2.0.0.6" = _FS0TPQOn;
        "pkg-2.0.1.9" = _Tpvzh1n7;
        "pkg-2.0.2.3" = _HSrAkWqH;
        "pkg-2.0.2.11" = _zFYERXVc;
        "pkg-2.0.3.4" = _QAiSN3Q8;
        "pkg-2.0.3.13" = _cE4GdBxS;
        "pkg-2.0.4.6" = _SXmDVLN0;
        "pkg-2.0.4.15" = _o4LGtvUQ;
        "pkg-2.0.5.10" = _2jx3bUuL;
        "pkg-2.0.5.17" = _i8cp4wxM;
        "pkg-1.12.7.23" = _uGbxgawj;
        "pkg-1.15.6.24" = _LwNYnVxa;
        "pkg-1.17.1.11" = _NyGIRVfz;
        "pkg-2.0.5.11" = _1soFLh2H;
        "pkg-2.0.5.20" = _gq4gg8ZY;
        "pkg-2.0.5.16" = _fgecxyFN;
        "pkg-2.0.5.22" = _TNZ4Ah0o;
        "pkg-1.17.1.12" = _epf47Jaz;
        "pkg-2.0.5.24" = _TxQzQgUm;
        "pkg-2.1.0.1" = _aKYuUZpd;
        "pkg-2.1.1.2" = _5QeqM4nf;
        "pkg-2.1.0.19" = _fg9VeABy;
        "pkg-2.1.0.20" = _nc5Z9l3C;
        "pkg-2.0.5.25" = _x5FGVS4q;
        "pkg-2.1.1.3" = _LTOqV1Cw;
        "pkg-2.1.1.21" = _9iomDg8D;
        "pkg-2.0.6.27" = _uh2S7w5K;
        "pkg-2.1.2.5" = _e6FYVr4k;
        "pkg-2.1.1.22" = _SgeYUS6n;
        "pkg-2.1.2.7" = _Mkla4B3q;
        "pkg-1.17.2.15" = _AlPBrFTW;
        "pkg-2.1.2.23" = _J7qT9hJD;
        "pkg-2.1.3" = _8a6KfB5j;
        "pkg-2.1.4" = _85jjKm7u;
        "pkg-2.2.0" = _lSa8MVef;
        "pkg-2.2.1" = _2LfOJ5LW;
        "pkg-2.1.4.1" = _ZViMsjtX;
        "pkg-2.2.2" = _TuSZSQeB;
        "pkg-2.2.3" = _jUBhoHdc;
        "pkg-2.3.0" = _XqSVU1Kv;
        "pkg-2.4.0" = _CAqmamRe;
