...
let
    ...
    in {
        ...
        "pkg-0.2.0+1.17" = _tec042JR;
        "pkg-0.2.0+1.18" = _RaD0CVeI;
        "pkg-0.3.0+1.18" = _J2RbRKQu;
        "pkg-0.4.0+1.18" = _L4UrNwgC;
        "pkg-0.5.0+1.18" = _bjmbRKd3;
        "pkg-0.6.0+1.18" = _goQB7kmr;
        "pkg-0.7.1+1.18" = _6T9ywn3W;
        "pkg-0.7.1+1.18.2" = _oYC1PH1A;
        "pkg-0.8.0+1.18.2" = _DRNqRFHZ;
        "pkg-0.9.0+1.18.2" = _YciOo8le;
        "pkg-0.9.1+1.18.2" = _hBYFL2aY;
        "pkg-0.9.2+1.18.2" = _6klaT8O2;
        "pkg-0.9.3+1.18.2" = _QjQ2S0sb;
        "pkg-0.10.0+1.18.2" = _bCKslBjG;
        "pkg-0.10.0+1.19" = _EHnJl946;
        "pkg-0.11.0+1.19" = _xUpR5YTJ;
        "pkg-0.11.1+1.19" = _3C5IZKVy;
        "pkg-0.11.2+1.19" = _6ADiNiIO;
        "pkg-0.11.2+1.19.3" = _5rjZ1zxM;
        "pkg-0.12.0+1.19.3" = _ypz4AYDO;
        "pkg-0.13.0+1.19.3" = _kfqSTXzZ;
        "pkg-0.13.1+1.19.3" = _hpKqlNjn;
        "pkg-0.13.1+1.19.4" = _juNcKfun;
        "pkg-0.13.2+1.19.4" = _zI9DkVIm;
        "pkg-0.13.2+1.20.2" = _7FiiAAT2;
        "pkg-0.13.3+1.20.2" = _nm50HTA4;
        "pkg-0.13.3+1.20.4" = _v6CXnIZf;
        "pkg-0.13.4+1.20.4" = _WvyUwl74;
        "pkg-0.13.5+1.20.4" = _y3VWRO9f;
        "pkg-0.13.6+1.20.4" = _vsP008bk;
        "pkg-0.13.6+1.20.1" = _GlbB27uR;
        "pkg-0.13.7+1.20.1" = _i3i4fQzE;
        "pkg-0.14.0+1.20.5" = _icOOrai3;
        "pkg-0.15.0+1.20.6" = _vB0EZQSv;
        "pkg-0.15.0+1.21.1" = _x7ojT4IE;
        "pkg-0.15.1+1.21.1" = _HlgwZ27l;
        "pkg-0.15.1+1.21.3" = _bwc0I1Iq;
        "pkg-0.15.2+1.21.3" = _UdYoV7yJ;
        "pkg-0.15.3+1.21.3" = _h6SCohHC;
        "pkg-0.15.4+1.21.3" = _hvBlWScp;
        "pkg-0.15.5+1.21.3" = _VkccADMh;
        "pkg-1.0.0+1.21.3" = _VC6U2Htg;
        "pkg-1.0.0+1.21.4" = _4TVBaQDT;
        "pkg-1.0.1+1.21.4" = _cW0fE19Z;
        "pkg-1.1.0+1.21.4" = _NGRupFPw;
        "pkg-1.1.0+1.20.1" = _HfZi4nT7;
        "pkg-1.1.0+1.19.2" = _TftzM0Io;
        "pkg-1.1.1+1.19.2" = _Y3QRWPgb;
        "pkg-1.1.0+1.21.1" = _IW1q3ogW;
        "pkg-1.1.1+1.21.1" = _PWd9pLoF;
        "pkg-1.1.2+1.21.1" = _hRpuZkyY;
        "pkg-1.1.3+1.21.1" = _xgJF6oMv;
        "pkg-1.1.4+1.21.1" = _LfTWPOWV;
        "pkg-1.2.0+1.21.11" = _ndkTlHJF;
