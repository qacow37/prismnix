...
let
    ...
    in {
        ...
        "pkg-2.0" = _jZDeeSiO;
        "pkg-2.1" = _OifQbDEY;
        "pkg-2.1-neoforge-26.1.2" = _eACrqyh0;
        "pkg-2.1-fabric-26.1.2" = _javd9uuh;
        "pkg-2.1-forge-1.21.1" = _WfXG9iXy;
        "pkg-2.1-fabric-1.21.1" = _YQ8t2Q3F;
        "pkg-2.2-neoforge-1.21.1" = _EwguMp68;
        "pkg-2.2-neoforge-26.1" = _eylW2c0k;
