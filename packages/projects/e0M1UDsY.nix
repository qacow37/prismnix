...
let
    ...
    in {
        ...
        "pkg-1.16.5-4.50-forge" = _JlGCFdxJ;
        "pkg-1.18.2-4.50-forge" = _fgCbrjNG;
        "pkg-1.19.2-4.50-forge" = _VXFyIrnD;
        "pkg-1.16.5-4.51-fabric" = _H2i6GWli;
        "pkg-1.18.2-4.51-fabric" = _58aHDigc;
        "pkg-1.19.2-4.51-fabric" = _en1zxPSV;
        "pkg-1.16.5-4.51-forge" = _wYescTDX;
        "pkg-1.18.2-4.51-forge" = _TxqDshVG;
        "pkg-1.19.2-4.51-forge" = _SPcx8ADU;
        "pkg-1.16.5-4.52-fabric" = _7a2ZmR16;
        "pkg-1.18.2-4.52-fabric" = _txSE4rTv;
        "pkg-1.19.2-4.52-fabric" = _ADtGFhq6;
        "pkg-1.16.5-4.52-forge" = _U8mMfaEp;
        "pkg-1.18.2-4.52-forge" = _9cPokIfz;
        "pkg-1.19.2-4.52-forge" = _TCgTNzFO;
        "pkg-1.16.5-4.54-fabric" = _naW7chmp;
        "pkg-1.18.2-4.54-fabric" = _RXKgutLD;
        "pkg-1.19.2-4.54-fabric" = _QffgYmeU;
        "pkg-1.16.5-4.54-forge" = _j2d90Z68;
        "pkg-1.18.2-4.54-forge" = _tua0AhT0;
        "pkg-1.19.2-4.54-forge" = _EkfgF5hZ;
        "pkg-1.16.5-4.55-fabric" = _tm0jdAxT;
        "pkg-1.18.2-4.55-fabric" = _HeTJtN5g;
        "pkg-1.19.2-4.55-fabric" = _WAWhlRTC;
        "pkg-1.16.5-4.55-forge" = _WmEZOaNp;
        "pkg-1.18.2-4.55-forge" = _UlIUGksj;
        "pkg-1.19.2-4.55-forge" = _aGiCCmxd;
        "pkg-1.16.5-4.56-fabric" = _BAcfv6tG;
        "pkg-1.18.2-4.56-fabric" = _A3d7nEnO;
        "pkg-1.19.2-4.56-fabric" = _PmzxGbPx;
        "pkg-1.16.5-4.56-forge" = _S3Cuo4Lp;
        "pkg-1.18.2-4.56-forge" = _F3ONlUSO;
        "pkg-1.19.2-4.56-forge" = _ZcqNR3vC;
        "pkg-1.16.5-4.57-fabric" = _SE37mln1;
        "pkg-1.18.2-4.57-fabric" = _VEHNsT4U;
        "pkg-1.19.2-4.57-fabric" = _Ig2Ol066;
        "pkg-1.16.5-4.57-forge" = _YUtELJU6;
        "pkg-1.18.2-4.57-forge" = _FoXlZuPB;
        "pkg-1.19.2-4.57-forge" = _6QRFfcE9;
        "pkg-1.16.5-4.63-fabric" = _oVFXzu5A;
        "pkg-1.18.2-4.63-fabric" = _B1BOkfap;
        "pkg-1.19.2-4.63-fabric" = _Orj2bXvF;
        "pkg-1.16.5-4.64-fabric" = _NIs9W91F;
        "pkg-1.18.2-4.64-fabric" = _EytdzFLt;
        "pkg-1.19.2-4.64-fabric" = _FupxQuSZ;
        "pkg-1.16.5-4.64-forge" = _Co4pZHdN;
        "pkg-1.18.2-4.64-forge" = _1K8c5iLl;
        "pkg-1.19.2-4.64-forge" = _kiGHG0uS;
        "pkg-1.16.5-4.65-fabric" = _9GxJjPZ6;
        "pkg-1.18.2-4.65-fabric" = _IyVvcx4p;
        "pkg-1.19.2-4.65-fabric" = _ThfQmKxn;
        "pkg-1.16.5-4.65-forge" = _AfDjpIaa;
        "pkg-1.18.2-4.65-forge" = _B5xGHe3B;
        "pkg-1.19.2-4.65-forge" = _B4ahhTqG;
        "pkg-1.16.5-4.68-fabric" = _WV0FP7fX;
        "pkg-1.18.2-4.68-fabric" = _IpQzGuDG;
        "pkg-1.19.2-4.68-fabric" = _wcpbCBuz;
        "pkg-1.16.5-4.68-forge" = _m8EFP2Nx;
        "pkg-1.18.2-4.68-forge" = _6Jmp7x4n;
        "pkg-1.19.2-4.68-forge" = _7GaIObci;
        "pkg-1.16.5-4.69-fabric" = _TlXkRgTI;
        "pkg-1.18.2-4.69-fabric" = _LKtLAy3i;
        "pkg-1.19.2-4.69-fabric" = _Fsx8FvlO;
        "pkg-1.16.5-4.69-forge" = _zGHCuYtv;
        "pkg-1.18.2-4.69-forge" = _2XwuYNRy;
        "pkg-1.19.2-4.69-forge" = _YkWnkOa4;
        "pkg-1.16.5-4.70-fabric" = _UfN2ORVB;
        "pkg-1.18.2-4.70-fabric" = _RpEVMN9G;
        "pkg-1.19.2-4.70-fabric" = _hbDOA9WZ;
        "pkg-1.16.5-5.0-fabric" = _Yzkht9vp;
        "pkg-1.18.2-5.0-fabric" = _RdtZ7KTg;
        "pkg-1.19.2-5.0-fabric" = _wItZM6Ay;
        "pkg-1.16.5-5.0-forge" = _RJLX6921;
        "pkg-1.18.2-5.0-forge" = _aq9iJHpI;
        "pkg-1.19.2-5.0-forge" = _XGwsZhdf;
        "pkg-1.16.5-5.1-fabric" = _UuKpB7rl;
        "pkg-1.18.2-5.1-fabric" = _6vqOUUV9;
        "pkg-1.19.2-5.1-fabric" = _fHUAICta;
        "pkg-1.16.5-5.2-fabric" = _33vFA4Rw;
        "pkg-1.18.2-5.2-fabric" = _8ILNbXON;
        "pkg-1.19.2-5.2-fabric" = _igtHbiEf;
        "pkg-1.16.5-5.3-fabric" = _q0CrlnGw;
        "pkg-1.18.2-5.3-fabric" = _SJJKVNC3;
        "pkg-1.19.2-5.3-fabric" = _JYhFFMDN;
        "pkg-1.16.5-5.4-fabric" = _BsTi72qT;
        "pkg-1.18.2-5.4-fabric" = _VSeyRLDC;
        "pkg-1.19.2-5.4-fabric" = _2BBNiaxn;
        "pkg-1.16.5-5.5-forge" = _iYAkFr9u;
        "pkg-1.18.2-5.5-forge" = _qKKO8WDP;
        "pkg-1.19.2-5.5-forge" = _ob3TOUMg;
        "pkg-1.16.5-5.7-fabric" = _Ry07tYnF;
        "pkg-1.18.2-5.7-fabric" = _4bLpWjXP;
        "pkg-1.19.2-5.7-fabric" = _DUHESSpw;
        "pkg-1.16.5-5.7-forge" = _TImZvX4i;
        "pkg-1.18.2-5.7-forge" = _hcZX3LzL;
        "pkg-1.19.2-5.7-forge" = _woDOSBbR;
        "pkg-1.16.5-5.8-fabric" = _uPUL2a8f;
        "pkg-1.18.2-5.8-fabric" = _1EVtjc70;
        "pkg-1.19.2-5.8-fabric" = _kG7dYlbf;
        "pkg-1.16.5-5.8-forge" = _Ru7CZbJ6;
        "pkg-1.18.2-5.8-forge" = _BzFhrKgf;
        "pkg-1.19.2-5.8-forge" = _zlm1xN4C;
        "pkg-1.16.5-5.10-fabric" = _gWj7k53B;
        "pkg-1.18.2-5.10-fabric" = _UdOuyNuu;
        "pkg-1.19.2-5.10-fabric" = _XwW9QjGj;
        "pkg-1.16.5-5.10-forge" = _DKY2R6AP;
        "pkg-1.18.2-5.10-forge" = _Uql0V2oi;
        "pkg-1.19.2-5.10-forge" = _87hK2Nin;
        "pkg-1.16.5-5.11-fabric" = _mOdtTzSR;
        "pkg-1.18.2-5.11-fabric" = _CkuwnyGj;
        "pkg-1.19.2-5.11-fabric" = _WqnnA6ZT;
        "pkg-1.16.5-5.11-forge" = _QRT505td;
        "pkg-1.18.2-5.11-forge" = _9cxU8hwL;
        "pkg-1.19.2-5.11-forge" = _TOiX3QgP;
        "pkg-1.16.5-5.12-fabric" = _sP1zYWNs;
        "pkg-1.18.2-5.12-fabric" = _cItvrLho;
        "pkg-1.19.2-5.12-fabric" = _E7531LyQ;
        "pkg-1.16.5-5.12-forge" = _r7w9ZE5N;
        "pkg-1.18.2-5.12-forge" = _uWL6dZd9;
        "pkg-1.19.2-5.12-forge" = _ACmvfGkT;
        "pkg-1.16.5-5.13-fabric" = _KHeENh4z;
        "pkg-1.18.2-5.13-fabric" = _PVIskBgQ;
        "pkg-1.19.2-5.13-fabric" = _awyU1egz;
        "pkg-1.16.5-5.13-forge" = _329I384J;
        "pkg-1.18.2-5.13-forge" = _S4aAd42R;
        "pkg-1.19.2-5.13-forge" = _SnJg8NYv;
        "pkg-1.16.5-5.14-fabric" = _a1vy3IfM;
        "pkg-1.18.2-5.14-fabric" = _BWgT7zC5;
        "pkg-1.19.2-5.14-fabric" = _jCggRIqo;
        "pkg-1.16.5-5.15-fabric" = _rFwr6M4a;
        "pkg-1.18.2-5.15-fabric" = _JuVfVQNh;
        "pkg-1.19.2-5.15-fabric" = _WZ0O7Fvb;
        "pkg-1.16.5-5.15-forge" = _SwZWi5dy;
        "pkg-1.18.2-5.15-forge" = _ZgkyK7yw;
        "pkg-1.19.2-5.15-forge" = _s08tDhX9;
        "pkg-1.16.5-5.16-fabric" = _glzR1sF2;
        "pkg-1.18.2-5.16-fabric" = _xx1tIil2;
        "pkg-1.19.2-5.16-fabric" = _Z5eRiXRf;
        "pkg-1.16.5-5.16-forge" = _h9MDT0mP;
        "pkg-1.18.2-5.16-forge" = _KPghyuCS;
        "pkg-1.19.2-5.16-forge" = _ga5aXjg4;
        "pkg-1.16.5-5.17-fabric" = _X0bxE6yQ;
        "pkg-1.18.2-5.17-fabric" = _7DYCoNmu;
        "pkg-1.19.2-5.17-fabric" = _QPcDpM52;
        "pkg-1.16.5-5.17-forge" = _EmXz7dPf;
        "pkg-1.18.2-5.17-forge" = _qRizL8M3;
        "pkg-1.19.2-5.17-forge" = _IMCNczMN;
        "pkg-1.16.5-5.18-fabric" = _6WM4RyY8;
        "pkg-1.18.2-5.18-fabric" = _jXsUu9Y5;
        "pkg-1.19.2-5.18-fabric" = _LkIXFBh9;
        "pkg-1.16.5-5.19-fabric" = _zdRbNPAb;
        "pkg-1.18.2-5.19-fabric" = _dxbfPuck;
        "pkg-1.19.2-5.19-fabric" = _h4IAxIcN;
        "pkg-1.16.5-5.19-forge" = _GCLh1N7B;
        "pkg-1.18.2-5.19-forge" = _A6vc8251;
        "pkg-1.19.2-5.19-forge" = _EcEMSfDp;
        "pkg-1.16.5-5.20-fabric" = _iBN0SxXI;
        "pkg-1.18.2-5.20-fabric" = _sCcutOgv;
        "pkg-1.19.2-5.20-fabric" = _tGIZtt42;
        "pkg-1.16.5-5.20-forge" = _MmcCy4pq;
        "pkg-1.18.2-5.20-forge" = _U0uW2tay;
        "pkg-1.19.2-5.20-forge" = _RIUVRIKk;
        "pkg-1.16.5-5.21-fabric" = _QnNnnJwe;
        "pkg-1.18.2-5.21-fabric" = _MTOnIVYh;
        "pkg-1.19.2-5.21-fabric" = _twlNCCQZ;
        "pkg-1.16.5-5.21-forge" = _n07ifpvg;
        "pkg-1.18.2-5.21-forge" = _H2WklRFY;
        "pkg-1.19.2-5.21-forge" = _KfifhNGa;
        "pkg-1.16.5-5.22-fabric" = _yGr27JDz;
        "pkg-1.18.2-5.22-fabric" = _53FUV1Uq;
        "pkg-1.19.2-5.22-fabric" = _2PRksvUD;
        "pkg-1.16.5-5.22-forge" = _58jAZAWn;
        "pkg-1.18.2-5.22-forge" = _SGCNNPb5;
        "pkg-1.19.2-5.22-forge" = _zx9O62g4;
        "pkg-1.19.3-5.23-fabric" = _JEMRoEAJ;
        "pkg-1.16.5-5.25-fabric" = _2Xsseho5;
        "pkg-1.18.2-5.25-fabric" = _4W9MhvVP;
        "pkg-1.19.3-5.25-fabric" = _m5VczTmy;
        "pkg-1.16.5-5.25-forge" = _HKWRRx3K;
        "pkg-1.18.2-5.25-forge" = _e59RiZAX;
        "pkg-1.19.2-5.25-forge" = _CkGJ3LhD;
        "pkg-1.19.3-5.25-forge" = _cv727Eob;
        "pkg-1.16.5-5.28-fabric" = _KYvEJ2a1;
        "pkg-1.18.2-5.28-fabric" = _vcMSY8Fi;
        "pkg-1.19.3-5.28-fabric" = _OxdtT21B;
        "pkg-1.16.5-5.28-forge" = _rEuPOJLM;
        "pkg-1.18.2-5.28-forge" = _Blq9POUC;
        "pkg-1.19.3-5.28-forge" = _ARUG4JK8;
        "pkg-1.16.5-5.34-fabric" = _aeqfLXfC;
        "pkg-1.18.2-5.34-fabric" = _wBf37HTD;
        "pkg-1.19.3-5.34-fabric" = _BgO0iWHE;
        "pkg-1.16.5-5.34-forge" = _9FqgVuam;
        "pkg-1.18.2-5.34-forge" = _gVodoy3R;
        "pkg-1.19.3-5.34-forge" = _tlHCEexk;
        "pkg-1.16.5-5.35-fabric" = _fI8lZIHR;
        "pkg-1.18.2-5.35-fabric" = _yptbfu7o;
        "pkg-1.19.3-5.35-fabric" = _JlJyCWBh;
        "pkg-1.16.5-5.35-forge" = _SLKUgOPp;
        "pkg-1.18.2-5.35-forge" = _X4rOSPgH;
        "pkg-1.19.3-5.35-forge" = _FEkFtY3h;
        "pkg-1.16.5-5.39-fabric" = _xpZSdjdC;
        "pkg-1.18.2-5.39-fabric" = _xrdIea6f;
        "pkg-1.19.3-5.39-fabric" = _846kvQa3;
        "pkg-1.16.5-5.39-forge" = _eicsb9ST;
        "pkg-1.18.2-5.39-forge" = _wFEmTWXN;
        "pkg-1.19.3-5.39-forge" = _95gGmAsU;
        "pkg-1.16.5-5.43-fabric" = _fUDCGv85;
        "pkg-1.18.2-5.43-fabric" = _xah1yaEx;
        "pkg-1.19.3-5.43-fabric" = _kWnmHBdy;
        "pkg-1.16.5-5.43-forge" = _mAk6IqQ8;
        "pkg-1.18.2-5.43-forge" = _ZtTeMhD7;
        "pkg-1.19.3-5.43-forge" = _4gmCn1j5;
        "pkg-1.16.5-5.44-fabric" = _2B54i25i;
        "pkg-1.18.2-5.44-fabric" = _kdHENWow;
        "pkg-1.19.3-5.44-fabric" = _DVUjXjID;
        "pkg-1.16.5-5.44-forge" = _Xje7BwDB;
        "pkg-1.18.2-5.44-forge" = _YOI3Xne7;
        "pkg-1.19.3-5.44-forge" = _qFhVrFHH;
        "pkg-1.16.5-5.45-fabric" = _oHf82VIY;
        "pkg-1.18.2-5.45-fabric" = _zQP1NGGG;
        "pkg-1.19.3-5.45-fabric" = _3cNwC7Aj;
        "pkg-1.16.5-5.45-forge" = _oqnNxKQu;
        "pkg-1.18.2-5.45-forge" = _yG1WG57Y;
        "pkg-1.19.3-5.45-forge" = _2NXDklr1;
        "pkg-1.18.2-6.0-forge+fabric" = _gnJ42s4o;
        "pkg-1.19.2-6.0-forge+fabric" = _4EVCsLej;
        "pkg-1.19.3-6.0-forge+fabric" = _ijrgCywa;
        "pkg-1.18.2-6.1-forge+fabric" = _YYGWMEUh;
        "pkg-1.19.2-6.1-forge+fabric" = _WrkGQzi9;
        "pkg-1.19.3-6.1-forge+fabric" = _xlI36HXp;
        "pkg-1.18.2-6.4-forge+fabric" = _C8FBulL0;
        "pkg-1.19.2-6.4-forge+fabric" = _FyXPc5Xt;
        "pkg-1.19.3-6.4-forge+fabric" = _g3GCIrpQ;
        "pkg-1.18.2-6.5-forge+fabric" = _SrKu6MTf;
        "pkg-1.19.2-6.5-forge+fabric" = _gOGGorlr;
        "pkg-1.19.3-6.5-forge+fabric" = _IRj4GHYN;
        "pkg-1.18.2-6.7-forge+fabric" = _JdMJonPk;
        "pkg-1.19.2-6.7-forge+fabric" = _HpY3QSyN;
        "pkg-1.19.3-6.7-forge+fabric" = _yZ36PvrB;
        "pkg-1.18.2-6.8-forge+fabric" = _3Rmlxe5D;
        "pkg-1.19.2-6.8-forge+fabric" = _WtJjqWbT;
        "pkg-1.19.3-6.8-forge+fabric" = _ksxBMniv;
        "pkg-1.18.2-6.9-forge+fabric" = _mZYSr5yV;
        "pkg-1.19.2-6.9-forge+fabric" = _tQFDdMS4;
        "pkg-1.19.3-6.9-forge+fabric" = _tuV0LNjg;
        "pkg-1.16.5-5.49-fabric" = _eC0mUzex;
        "pkg-1.16.5-5.49-forge" = _HMuqiDvH;
        "pkg-1.18.2-6.12-forge+fabric" = _h1Nr7YQE;
        "pkg-1.19.2-6.12-forge+fabric" = _21NuXJmg;
        "pkg-1.19.3-6.12-forge+fabric" = _qsI9UaAd;
        "pkg-1.16.5-5.50-fabric" = _diqQmTlH;
        "pkg-1.18.2-6.13-forge+fabric" = _6SaOeTxF;
        "pkg-1.19.2-6.13-forge+fabric" = _9eKucX05;
        "pkg-1.19.3-6.13-forge+fabric" = _TejH5yVN;
        "pkg-1.18.2-6.14-forge+fabric" = _VHUUVhpd;
        "pkg-1.19.2-6.14-forge+fabric" = _AiyW3zin;
        "pkg-1.19.3-6.14-forge+fabric" = _wrrTlIJF;
        "pkg-1.18.2-6.15-forge+fabric" = _ENkdohyK;
        "pkg-1.19.2-6.15-forge+fabric" = _1iTaechW;
        "pkg-1.19.3-6.15-forge+fabric" = _8QlyDLzP;
        "pkg-1.18.2-6.16-forge+fabric" = _kYcltUr3;
        "pkg-1.19.2-6.16-forge+fabric" = _DH2Uw1q0;
        "pkg-1.19.3-6.16-forge+fabric" = _QglVrie6;
        "pkg-1.18.2-6.17-forge+fabric" = _useRPkIs;
        "pkg-1.19.2-6.17-forge+fabric" = _JWejCr0E;
        "pkg-1.19.3-6.17-forge+fabric" = _qRwDLY6S;
        "pkg-1.18.2-6.18-forge+fabric" = _S9qRgvAh;
        "pkg-1.19.2-6.18-forge+fabric" = _JOZ4dnWA;
        "pkg-1.19.3-6.18-forge+fabric" = _kFYUiNdr;
        "pkg-1.18.2-6.19-forge+fabric" = _grG0cvd4;
        "pkg-1.19.2-6.19-forge+fabric" = _6gFL7JAS;
        "pkg-1.19.3-6.19-forge+fabric" = _knokhzZR;
        "pkg-1.18.2-6.20-forge+fabric" = _dOacl3VL;
        "pkg-1.19.2-6.20-forge+fabric" = _JDfU0wJN;
        "pkg-1.19.3-6.20-forge+fabric" = _QeFW2Wcv;
        "pkg-1.18.2-6.21-forge+fabric" = _a2YetAXf;
        "pkg-1.19.2-6.21-forge+fabric" = _pP8pJNYi;
        "pkg-1.19.3-6.21-forge+fabric" = _S3YWW5su;
        "pkg-1.18.2-6.22-forge+fabric" = _Viulse4H;
        "pkg-1.19.2-6.22-forge+fabric" = _HtL4kTlo;
        "pkg-1.19.3-6.22-forge+fabric" = _Yt0gz1EP;
        "pkg-1.18.2-6.23-forge+fabric" = _qoDXsKAx;
        "pkg-1.19.2-6.23-forge+fabric" = _WwbsCLJb;
        "pkg-1.19.3-6.23-forge+fabric" = _vsuIXz3R;
        "pkg-1.18.2-6.24-forge+fabric" = _S28Cqjaq;
        "pkg-1.19.2-6.24-forge+fabric" = _Wc1NXz6v;
        "pkg-1.19.3-6.24-forge+fabric" = _Ervzvnkq;
        "pkg-1.18.2-6.25-forge+fabric" = _TjEE4xxs;
        "pkg-1.19.2-6.25-forge+fabric" = _BAxGmIwF;
        "pkg-1.19.3-6.25-forge+fabric" = _M1d9XTle;
        "pkg-1.18.2-6.26-forge+fabric" = _hqVvmTb5;
        "pkg-1.19.2-6.26-forge+fabric" = _6JrAVVaY;
        "pkg-1.19.3-6.26-forge+fabric" = _HqfPw5YA;
        "pkg-1.18.2-6.27-forge+fabric" = _kFQaRYm3;
        "pkg-1.19.2-6.27-forge+fabric" = _dRA60O2n;
        "pkg-1.19.3-6.27-forge+fabric" = _6mzn39y2;
        "pkg-1.18.2-6.28-forge+fabric" = _BKf8M4dI;
        "pkg-1.19.2-6.28-forge+fabric" = _NUnjI0dq;
        "pkg-1.19.3-6.28-forge+fabric" = _R7AnNUib;
        "pkg-1.18.2-6.30-forge+fabric" = _m0EUfHd1;
        "pkg-1.19.2-6.30-forge+fabric" = _984tJ6qq;
        "pkg-1.19.3-6.30-forge+fabric" = _wpPA6EBu;
        "pkg-1.18.2-6.31-forge+fabric" = _6PtnrBra;
        "pkg-1.19.2-6.31-forge+fabric" = _e9pIvgtA;
        "pkg-1.19.3-6.31-forge+fabric" = _JYaTsjv4;
        "pkg-1.18.2-6.32-forge+fabric" = _fLJAeZ28;
        "pkg-1.19.2-6.32-forge+fabric" = _dngwo4jr;
        "pkg-1.19.3-6.32-forge+fabric" = _ziRAbeOw;
        "pkg-1.18.2-6.33-forge+fabric" = _f6EkKYPj;
        "pkg-1.19.2-6.33-forge+fabric" = _IxxnG7SG;
        "pkg-1.19.3-6.33-forge+fabric" = _SW4urIaE;
        "pkg-1.18.2-6.34-forge+fabric" = _bMAdpAVF;
        "pkg-1.19.2-6.34-forge+fabric" = _4OSj1ztV;
        "pkg-1.19.3-6.34-forge+fabric" = _tmd4BKmX;
        "pkg-1.18.2-6.38-forge+fabric" = _nA8IWHXW;
        "pkg-1.19.2-6.38-forge+fabric" = _x0DYC9m9;
        "pkg-1.19.3-6.38-forge+fabric" = _dMHwFGW6;
        "pkg-1.18.2-6.40-forge+fabric" = _GP6BBULx;
        "pkg-1.19.2-6.40-forge+fabric" = _hHHql4Ti;
        "pkg-1.19.3-6.40-forge+fabric" = _AnttraZr;
        "pkg-1.18.2-6.42-forge+fabric" = _p3nMHNNk;
        "pkg-1.19.2-6.42-forge+fabric" = _SNrP8xeR;
        "pkg-1.19.3-6.42-forge+fabric" = _LyyOu5dB;
        "pkg-1.18.2-6.43-forge+fabric" = _nxB16vx3;
        "pkg-1.19.2-6.43-forge+fabric" = _1pG1r1Zc;
        "pkg-1.19.3-6.43-forge+fabric" = _MoqPkrag;
        "pkg-1.18.2-6.45-forge+fabric" = _qnvzgvXC;
        "pkg-1.19.2-6.45-forge+fabric" = _WyB1pD5P;
        "pkg-1.19.3-6.45-forge+fabric" = _HWWPFuKO;
        "pkg-1.18.2-6.46-forge+fabric" = _vZE5q1pn;
        "pkg-1.19.2-6.46-forge+fabric" = _QDixcC6l;
        "pkg-1.19.3-6.46-forge+fabric" = _oXgmhznx;
        "pkg-1.18.2-6.47-forge+fabric" = _YAOoGe5E;
        "pkg-1.19.2-6.47-forge+fabric" = _WJBnGzXa;
        "pkg-1.19.3-6.47-forge+fabric" = _IJXvAPTN;
        "pkg-1.18.2-6.48-forge+fabric" = _1OdssahL;
        "pkg-1.19.2-6.48-forge+fabric" = _yxt2wRUF;
        "pkg-1.19.3-6.48-forge+fabric" = _fyn1QoRi;
        "pkg-1.18.2-6.49-forge+fabric" = _6F6qhu3P;
        "pkg-1.19.2-6.49-forge+fabric" = _fivbVDW8;
        "pkg-1.19.3-6.49-forge+fabric" = _v4m23B3y;
        "pkg-1.18.2-6.50-forge+fabric" = _TImdHmU5;
        "pkg-1.19.2-6.50-forge+fabric" = _uaq4XVNx;
        "pkg-1.19.3-6.50-forge+fabric" = _XdrIqz81;
        "pkg-1.18.2-6.51-forge+fabric" = _jpMdJtbS;
        "pkg-1.19.2-6.51-forge+fabric" = _aLJDDfeG;
        "pkg-1.19.3-6.51-forge+fabric" = _pUEgyfV4;
        "pkg-1.18.2-6.52-forge+fabric" = _xa9F4mD3;
        "pkg-1.19.2-6.52-forge+fabric" = _GCWD4JZi;
        "pkg-1.19.3-6.52-forge+fabric" = _8OkXVJtn;
        "pkg-1.18.2-6.53-forge+fabric" = _zTteSpme;
        "pkg-1.19.2-6.53-forge+fabric" = _ODKDGTON;
        "pkg-1.19.3-6.53-forge+fabric" = _tMeJbimo;
        "pkg-1.19.4-6.53-forge+fabric" = _DRXb4Ayc;
        "pkg-1.19.4-6.54-forge+fabric" = _PvuijvUl;
        "pkg-1.18.2-6.55-forge+fabric" = _tslDnj0T;
        "pkg-1.19.2-6.55-forge+fabric" = _64LWNqvg;
        "pkg-1.19.3-6.55-forge+fabric" = _w1vSb4TN;
        "pkg-1.19.4-6.55-forge+fabric" = _sokPQo6T;
        "pkg-1.20-6.55-forge+fabric" = _3MsEmAm0;
        "pkg-1.18.2-6.56-forge+fabric" = _kePBaq4a;
        "pkg-1.19.2-6.56-forge+fabric" = _ZxrOfQ2y;
        "pkg-1.19.4-6.56-forge+fabric" = _qgYAmMsK;
        "pkg-1.20-6.56-forge+fabric" = _sAE6MBPb;
        "pkg-1.18.2-6.57-forge+fabric" = _fE0ohius;
        "pkg-1.19.2-6.57-forge+fabric" = _fJuKhc8n;
        "pkg-1.19.4-6.57-forge+fabric" = _urM2VWqU;
        "pkg-1.20-6.57-forge+fabric" = _RNhYJa64;
        "pkg-1.20.1-6.57-forge+fabric" = _RXxjawWd;
        "pkg-1.18.2-6.59-forge+fabric" = _Iej5Urj6;
        "pkg-1.19.2-6.59-forge+fabric" = _3juidFTP;
        "pkg-1.19.4-6.59-forge+fabric" = _KczM4P88;
        "pkg-1.20.1-6.59-forge+fabric" = _LH8LDr4p;
        "pkg-1.18.2-6.60-forge+fabric" = _S3BtKtUw;
        "pkg-1.19.2-6.60-forge+fabric" = _ptTsBckw;
        "pkg-1.19.4-6.60-forge+fabric" = _BZRw9oKS;
        "pkg-1.20.1-6.60-forge+fabric" = _lUnfbPY3;
        "pkg-1.18.2-6.61-forge+fabric" = _db1q4qln;
        "pkg-1.19.2-6.61-forge+fabric" = _GiHLPR1f;
        "pkg-1.19.4-6.61-forge+fabric" = _TOmpATtJ;
        "pkg-1.20.1-6.61-forge+fabric" = _cwE1632c;
        "pkg-1.18.2-6.62-forge+fabric" = _JuOp9xUf;
        "pkg-1.19.2-6.62-forge+fabric" = _aBtrJprE;
        "pkg-1.19.4-6.62-forge+fabric" = _YYkIVCj7;
        "pkg-1.20.1-6.62-forge+fabric" = _EbteiHrL;
        "pkg-1.18.2-6.64-forge+fabric" = _NvHia9jD;
        "pkg-1.19.2-6.64-forge+fabric" = _Hr8gBVQf;
        "pkg-1.19.4-6.64-forge+fabric" = _CsJl6p1o;
        "pkg-1.20.1-6.64-forge+fabric" = _GIf7e4gX;
        "pkg-1.18.2-6.65-forge+fabric" = _Xz9KMXXo;
        "pkg-1.19.2-6.65-forge+fabric" = _MTb34BGn;
        "pkg-1.19.4-6.65-forge+fabric" = _YZdu9B77;
        "pkg-1.20.1-6.65-forge+fabric" = _W1CQ9UCz;
        "pkg-1.20.2-6.65-forge+fabric" = _3zY4oi5q;
        "pkg-1.18.2-6.66-forge+fabric" = _5ZoQQu2t;
        "pkg-1.19.2-6.66-forge+fabric" = _iOFH8ipX;
        "pkg-1.19.4-6.66-forge+fabric" = _1qPWXAIs;
        "pkg-1.20.1-6.66-forge+fabric" = _TobnIU5c;
        "pkg-1.20.2-6.66-forge+fabric" = _84QjDeoH;
        "pkg-1.18.2-6.72-forge+fabric" = _HupVHdCo;
        "pkg-1.19.2-6.72-forge+fabric" = _SqveMGRg;
        "pkg-1.20.1-6.72-forge+fabric" = _DWDAffzK;
        "pkg-1.20.2-6.72-forge+fabric" = _Unqy4gjy;
        "pkg-1.18.2-6.74-forge+fabric" = _hCxE3SS7;
        "pkg-1.19.2-6.74-forge+fabric" = _4ttoKXrw;
        "pkg-1.20.1-6.74-forge+fabric" = _18sTwL0R;
        "pkg-1.20.2-6.74-forge+fabric" = _CCKW4Xd1;
        "pkg-1.18.2-6.75-forge+fabric" = _VW8K8GR3;
        "pkg-1.19.2-6.75-forge+fabric" = _xCsh50Sx;
        "pkg-1.20.1-6.75-forge+fabric" = _Tkb68j4y;
        "pkg-1.20.2-6.75-forge+fabric" = _KziooBLq;
        "pkg-1.18.2-6.80-forge+fabric" = _mrTmqUOB;
        "pkg-1.19.2-6.80-forge+fabric" = _191cluA2;
        "pkg-1.20.1-6.80-forge+fabric" = _q5nfGCvh;
        "pkg-1.20.2-6.80-forge+fabric" = _FecmNcI4;
        "pkg-1.18.2-6.82-forge+fabric" = _SxoZltP1;
        "pkg-1.19.2-6.82-forge+fabric" = _xePFzQOH;
        "pkg-1.20.1-6.82-forge+fabric" = _ZkBUSkql;
        "pkg-1.20.2-6.82-forge+fabric" = _if3kU0mN;
        "pkg-1.18.2-7.0-forge+fabric" = _1gvBaGCT;
        "pkg-1.19.2-7.0-forge+fabric" = _NiZNvZHA;
        "pkg-1.20.1-7.0-forge+fabric" = _XN7ZRMQl;
        "pkg-1.20.2-7.0-forge+fabric" = _ZNn94mQX;
        "pkg-1.18.2-7.3-forge+fabric" = _Qm8iagWR;
        "pkg-1.19.2-7.3-forge+fabric" = _uaxyvM6e;
        "pkg-1.20.1-7.3-forge+fabric" = _It15JS95;
        "pkg-1.20.2-7.3-forge+fabric" = _NnjgoN9X;
        "pkg-1.20.2-7.5-forge+fabric" = _a0nxaF4M;
        "pkg-1.18.2-7.6-forge+fabric" = _Utdhu6D3;
        "pkg-1.19.2-7.6-forge+fabric" = _U1weAjEr;
        "pkg-1.20.1-7.6-forge+fabric" = _Vs95Wipv;
        "pkg-1.20.2-7.6-forge+fabric" = _BlMZE4KG;
        "pkg-1.18.2-7.7-fabric+forge+neo" = _sITn4lge;
        "pkg-1.19.2-7.7-fabric+forge" = _reFHsVre;
        "pkg-1.20.1-7.7-fabric+forge+neo" = _xR4GpQQO;
        "pkg-1.20.2-7.7-fabric+forge+neo" = _Guw1MFbD;
        "pkg-1.19.2-7.8-fabric+forge" = _XLkFOqrG;
        "pkg-1.20.1-7.8-fabric+forge+neo" = _x9soA5VO;
        "pkg-1.20.2-7.8-fabric+forge+neo" = _dOF7dUCs;
        "pkg-1.19.2-7.9-fabric+forge" = _RIBgWcFh;
        "pkg-1.20.1-7.9-fabric+forge+neo" = _VwFgkeo3;
        "pkg-1.20.2-7.9-fabric+forge+neo" = _floVDJu4;
        "pkg-1.19.2-7.11-fabric+forge" = _iCJLK7gw;
        "pkg-1.20.1-7.11-fabric+forge+neo" = _H2n1R6pS;
        "pkg-1.20.2-7.11-fabric+forge+neo" = _689M13Hw;
        "pkg-1.19.2-7.12-fabric+forge" = _IWqe0xhd;
        "pkg-1.20.1-7.12-fabric+forge+neo" = _Iye1knaH;
        "pkg-1.20.2-7.12-fabric+forge+neo" = _fxbfpj3Q;
        "pkg-1.20.3-7.12-fabric+forge+neo" = _eSwJ6Jur;
        "pkg-1.19.2-7.13-fabric+forge" = _ErE39oIR;
        "pkg-1.20.1-7.13-fabric+forge+neo" = _Ma5eCRpx;
        "pkg-1.20.2-7.13-fabric+forge+neo" = _o3b1sVZ4;
        "pkg-1.20.3-7.13-fabric+forge+neo" = _O8eC3inz;
        "pkg-1.20.4-7.13-fabric+forge+neo" = _G3H5BH6z;
        "pkg-1.19.2-7.14-fabric+forge" = _7S0oIe5q;
        "pkg-1.20.1-7.14-fabric+forge+neo" = _fUL01Mt7;
        "pkg-1.20.2-7.14-fabric+forge+neo" = _FzLytMNQ;
        "pkg-1.20.4-7.14-fabric+forge+neo" = _sER08lZE;
        "pkg-1.19.2-7.15-fabric+forge" = _524eYd9e;
        "pkg-1.20.1-7.15-fabric+forge+neo" = _7IuTQBwp;
        "pkg-1.20.2-7.15-fabric+forge+neo" = _VilhXhrg;
        "pkg-1.20.4-7.15-fabric+forge+neo" = _KLFxHRAy;
        "pkg-1.19.2-7.16-fabric+forge" = _bgReRnUX;
        "pkg-1.20.1-7.16-fabric+forge+neo" = _2VtKfyeT;
        "pkg-1.20.2-7.16-fabric+forge+neo" = _EVFQgeo7;
        "pkg-1.20.4-7.16-fabric+forge+neo" = _OSw2lM2Y;
        "pkg-1.19.2-7.19-fabric+forge" = _REuBA2oB;
        "pkg-1.20.1-7.19-fabric+forge+neo" = _UrqWvr3J;
        "pkg-1.20.2-7.19-fabric+forge+neo" = _sIdf5Lkv;
        "pkg-1.20.4-7.19-fabric+forge+neo" = _NdYHdmxw;
        "pkg-1.19.2-7.21-fabric+forge" = _C3XJ3LnC;
        "pkg-1.20.1-7.21-fabric+forge+neo" = _qFiBy1Qm;
        "pkg-1.20.2-7.21-fabric+forge+neo" = _YNou8kTM;
        "pkg-1.20.4-7.21-fabric+forge+neo" = _jSFlnx4D;
        "pkg-1.19.2-7.22-fabric+forge" = _fS2VaQGO;
        "pkg-1.20.1-7.22-fabric+forge+neo" = _iaBJ2MRO;
        "pkg-1.20.2-7.22-fabric+forge+neo" = _ifJ5Az1U;
        "pkg-1.20.4-7.22-fabric+forge+neo" = _uiw4BKPp;
        "pkg-1.19.2-7.23-fabric+forge" = _UrAMPQpD;
        "pkg-1.20.1-7.23-fabric+forge+neo" = _po8Pd5zJ;
        "pkg-1.20.2-7.23-fabric+forge+neo" = _iaSdmMZ2;
        "pkg-1.20.4-7.23-fabric+forge+neo" = _HlrfNV7P;
        "pkg-1.19.2-7.24-fabric+forge" = _6xMJF02f;
        "pkg-1.20.1-7.24-fabric+forge+neo" = _HI2IPht1;
        "pkg-1.20.2-7.24-fabric+forge+neo" = _muhm6F0r;
        "pkg-1.20.4-7.24-fabric+forge+neo" = _VV7HqVW3;
        "pkg-1.19.2-7.25-fabric+forge" = _9lOTexdV;
        "pkg-1.20.1-7.25-fabric+forge+neo" = _yStH1hUM;
        "pkg-1.20.2-7.25-fabric+forge+neo" = _Lw2ywQ8i;
        "pkg-1.20.4-7.25-fabric+forge+neo" = _vnbusFN0;
        "pkg-1.19.2-7.26-fabric+forge" = _luHV2zbl;
        "pkg-1.20.1-7.26-fabric+forge+neo" = _eAG9mbhM;
        "pkg-1.20.2-7.26-fabric+forge+neo" = _bjtOpW4b;
        "pkg-1.20.4-7.26-fabric+forge+neo" = _J9HudrYI;
        "pkg-1.19.2-7.28-fabric+forge" = _UszXS78Y;
        "pkg-1.20.1-7.28-fabric+forge+neo" = _iJJ449Mi;
        "pkg-1.20.2-7.28-fabric+forge+neo" = _qTGyg6iv;
        "pkg-1.20.4-7.28-fabric+forge+neo" = _ue6lfFHY;
        "pkg-1.19.2-7.30-fabric+forge" = _jRip6SNP;
        "pkg-1.20.1-7.30-fabric+forge+neo" = _5Wg6Ceg4;
        "pkg-1.20.2-7.30-fabric+forge+neo" = _uPswIBHn;
        "pkg-1.20.4-7.30-fabric+forge+neo" = _Avo0Ze46;
        "pkg-1.19.2-7.31-fabric+forge" = _J8FzLWCm;
        "pkg-1.20.1-7.31-fabric+forge+neo" = _ip1SDHWi;
        "pkg-1.20.4-7.31-fabric+forge+neo" = _N3gJuMPK;
        "pkg-1.19.2-7.32-fabric+forge" = _nRIeqGRL;
        "pkg-1.20.1-7.32-fabric+forge+neo" = _XlI8NkVB;
        "pkg-1.20.4-7.32-fabric+forge+neo" = _Tfw8EHZB;
        "pkg-1.19.2-7.34-fabric+forge" = _KBvHrjeP;
        "pkg-1.20.1-7.34-fabric+forge+neo" = _jxVCaujA;
        "pkg-1.20.4-7.34-fabric+forge+neo" = _M6itXlHc;
        "pkg-1.19.2-7.36-fabric+forge" = _p3bUjtjB;
        "pkg-1.20.1-7.36-fabric+forge+neo" = _W3Nc1IMI;
        "pkg-1.20.4-7.36-fabric+forge+neo" = _nXqSt7Bl;
        "pkg-1.19.2-7.37-fabric+forge" = _9NXU59oU;
        "pkg-1.20.1-7.37-fabric+forge+neo" = _VzIh9jNk;
        "pkg-1.20.4-7.37-fabric+forge+neo" = _2dw1vkeD;
        "pkg-1.19.2-7.39-fabric+forge" = _v97SBC0t;
        "pkg-1.20.1-7.39-fabric+forge+neo" = _1zbEORsv;
        "pkg-1.20.4-7.39-fabric+forge+neo" = _KRFMwjJo;
        "pkg-1.19.2-7.40-fabric+forge" = _X5xn9Kl9;
        "pkg-1.20.1-7.40-fabric+forge+neo" = _wipAhCa0;
        "pkg-1.20.4-7.40-fabric+forge+neo" = _n9TNesVV;
        "pkg-1.19.2-7.41-fabric+forge" = _9TOlk3Td;
        "pkg-1.20.1-7.41-fabric+forge+neo" = _WQlLYDH6;
        "pkg-1.20.4-7.41-fabric+forge+neo" = _TyRZxRtk;
        "pkg-1.19.2-7.42-fabric+forge" = _F7gj2nfI;
        "pkg-1.20.1-7.42-fabric+forge+neo" = _S2EeMHg4;
        "pkg-1.20.4-7.42-fabric+forge+neo" = _Xpk7wmaD;
        "pkg-1.19.2-7.43-fabric+forge" = _M830kCW8;
        "pkg-1.20.1-7.43-fabric+forge+neo" = _kvzKHLkx;
        "pkg-1.20.4-7.43-fabric+forge+neo" = _TBZZ5bBc;
        "pkg-1.19.2-7.45-fabric+forge" = _1fwO1EYj;
        "pkg-1.20.1-7.45-fabric+forge+neo" = _snPU1UdY;
        "pkg-1.20.4-7.45-fabric+forge+neo" = _m1BId9fm;
        "pkg-1.19.2-7.46-fabric+forge" = _Y4d8roqC;
        "pkg-1.20.1-7.46-fabric+forge+neo" = _EoDPrw5V;
        "pkg-1.20.4-7.46-fabric+forge+neo" = _wr8FDooA;
        "pkg-1.19.2-7.47-fabric+forge" = _kvdC8nko;
        "pkg-1.20.1-7.47-fabric+forge+neo" = _4yoITBxh;
        "pkg-1.20.4-7.47-fabric+forge+neo" = _CC97dyED;
        "pkg-1.19.2-7.49-fabric+forge" = _Dhc2pLuW;
        "pkg-1.20.1-7.49-fabric+forge+neo" = _hwGW33qv;
        "pkg-1.20.4-7.49-fabric+forge+neo" = _a0zM6RiQ;
        "pkg-1.19.2-7.50-fabric+forge" = _aWMkM9hL;
        "pkg-1.20.1-7.50-fabric+forge+neo" = _nuJkNPys;
        "pkg-1.20.4-7.50-fabric+forge+neo" = _wbm1k1Uy;
        "pkg-1.19.2-7.51-fabric+forge" = _N0LGCA4x;
        "pkg-1.20.1-7.51-fabric+forge+neo" = _QAOn2FAA;
        "pkg-1.20.4-7.51-fabric+forge+neo" = _4aycctag;
        "pkg-1.20.5-7.51-fabric+neo" = _FlDkuCuI;
        "pkg-1.19.2-7.52-fabric+forge" = _f4tbzQaV;
        "pkg-1.20.1-7.52-fabric+forge+neo" = _Naj0SudU;
        "pkg-1.20.4-7.52-fabric+forge+neo" = _PIpWqJOc;
        "pkg-1.20.5-7.52-fabric+neo" = _4T0oqkvt;
        "pkg-1.19.2-7.53-fabric+forge" = _3yzltsrI;
        "pkg-1.20.1-7.53-fabric+forge+neo" = _xHMYc1JC;
        "pkg-1.20.4-7.53-fabric+forge+neo" = _KusUWajf;
        "pkg-1.20.5-7.53-fabric+neo" = _7TtePiZG;
        "pkg-1.19.2-7.54-fabric+forge" = _WEalMFiB;
        "pkg-1.20.1-7.54-fabric+forge+neo" = _ENGS2tc8;
        "pkg-1.20.4-7.54-fabric+forge+neo" = _RvihQRkv;
        "pkg-1.20.5-7.54-fabric+neo" = _I3HtlXHN;
        "pkg-1.20.6-7.54-fabric+forge+neo" = _nB61R9dH;
        "pkg-1.20.6-7.55-fabric+forge+neo" = _4iHuNLfn;
        "pkg-1.19.2-7.56-fabric+forge" = _6iMYiZxi;
        "pkg-1.20.1-7.56-fabric+forge+neo" = _MPpjuvwT;
        "pkg-1.20.4-7.56-fabric+forge+neo" = _o1macqEn;
        "pkg-1.20.6-7.56-fabric+forge+neo" = _ctANGjyc;
        "pkg-1.19.2-7.57-fabric+forge" = _K9Y5Tmuu;
        "pkg-1.20.1-7.57-fabric+forge+neo" = _HHgevNRj;
        "pkg-1.20.4-7.57-fabric+forge+neo" = _yXljDige;
        "pkg-1.20.6-7.57-fabric+forge+neo" = _MBk0FFCh;
        "pkg-1.20.6-7.58-fabric+forge+neo" = _NYnB3DcI;
        "pkg-1.19.2-7.59-fabric+forge" = _qr3pOf0t;
        "pkg-1.20.1-7.59-fabric+forge+neo" = _g5tMPpdR;
        "pkg-1.20.4-7.59-fabric+forge+neo" = _80qlTsCw;
        "pkg-1.20.6-7.59-fabric+forge+neo" = _MHJyqCC3;
        "pkg-1.19.2-7.60-fabric+forge" = _DdVIUqCP;
        "pkg-1.20.1-7.60-fabric+forge+neo" = _tbkgq2aL;
        "pkg-1.20.4-7.60-fabric+forge+neo" = _MCG5iTwv;
        "pkg-1.20.6-7.60-fabric+forge+neo" = _qw4UzDLO;
        "pkg-1.19.2-7.61-fabric+forge" = _PvBc4Jcz;
        "pkg-1.20.1-7.61-fabric+forge+neo" = _bB57FIWR;
        "pkg-1.20.4-7.61-fabric+forge+neo" = _jVuY2dwJ;
        "pkg-1.20.6-7.61-fabric+forge+neo" = _Uy25T54i;
        "pkg-1.21.0-7.61-fabric+forge+neo" = _rfJmYdeg;
        "pkg-1.19.2-7.62-fabric+forge" = _pUnlL3bs;
        "pkg-1.20.1-7.62-fabric+forge+neo" = _xzRso0Yk;
        "pkg-1.20.4-7.62-fabric+forge+neo" = _qrcWWO62;
        "pkg-1.20.6-7.62-fabric+forge+neo" = _SHI1hwZq;
        "pkg-1.21.0-7.62-fabric+forge+neo" = _24TEOmrb;
        "pkg-1.19.2-7.63-fabric+forge" = _smscFOAi;
        "pkg-1.20.1-7.63-fabric+forge+neo" = _O9BbrXZa;
        "pkg-1.20.4-7.63-fabric+forge+neo" = _Pm14gLLo;
        "pkg-1.20.6-7.63-fabric+forge+neo" = _QO93UsDJ;
        "pkg-1.21.0-7.63-fabric+forge+neo" = _B7vmr30U;
        "pkg-1.19.2-7.64-fabric+forge" = _RKCtWE4y;
        "pkg-1.20.1-7.64-fabric+forge+neo" = _mNrI5n8S;
        "pkg-1.20.4-7.64-fabric+forge+neo" = _qXM06FG6;
        "pkg-1.20.6-7.64-fabric+forge+neo" = _Vyv3JQDD;
        "pkg-1.21.0-7.64-fabric+forge+neo" = _hYoENexj;
        "pkg-1.20.1-7.65-fabric+forge+neo" = _V0tdocI5;
        "pkg-1.20.6-7.65-fabric+forge+neo" = _GnBmHCCb;
        "pkg-1.21.0-7.65-fabric+forge+neo" = _fdXbFXqd;
        "pkg-1.20.1-7.66-fabric+forge+neo" = _msNO319F;
        "pkg-1.20.6-7.66-fabric+forge+neo" = _57G5AqzS;
        "pkg-1.21.0-7.66-fabric+forge+neo" = _L1MNl4Le;
        "pkg-1.20.1-7.67-fabric+forge+neo" = _4wd19NbF;
        "pkg-1.20.6-7.67-fabric+forge+neo" = _2zKjwrE1;
        "pkg-1.21.0-7.67-fabric+forge+neo" = _CTDXt4Os;
        "pkg-1.20.1-7.68-fabric+forge+neo" = _atnFXlWd;
        "pkg-1.20.6-7.68-fabric+forge+neo" = _hbmYqtdl;
        "pkg-1.21.0-7.68-fabric+forge+neo" = _JJEzOZro;
        "pkg-1.20.1-7.70-fabric+forge+neo" = _HhsvWQiL;
        "pkg-1.20.6-7.70-fabric+forge+neo" = _saNWZItW;
        "pkg-1.21.0-7.70-fabric+forge+neo" = _ZaTRzQs8;
        "pkg-1.20.1-7.71-fabric+forge+neo" = _4PHvK72M;
        "pkg-1.20.6-7.71-fabric+forge+neo" = _lnq6mhee;
        "pkg-1.21.0-7.71-fabric+forge+neo" = _Z5MOP6R2;
        "pkg-1.20.1-7.72-fabric+forge+neo" = _XWSLaPrf;
        "pkg-1.20.6-7.72-fabric+forge+neo" = _2TNlNeWA;
        "pkg-1.21.0-7.72-fabric+forge+neo" = _ZKVNl16R;
        "pkg-1.20.1-7.73-fabric+forge+neo" = _luRG8yDn;
        "pkg-1.20.6-7.73-fabric+forge+neo" = _FyLSxR6l;
        "pkg-1.21.0-7.73-fabric+forge+neo" = _FIkyMwC7;
        "pkg-1.20.1-7.74-fabric+forge+neo" = _CACoN3MX;
        "pkg-1.20.6-7.74-fabric+forge+neo" = _6vIosX3x;
        "pkg-1.21.0-7.74-fabric+forge+neo" = _XxKKmaIQ;
        "pkg-1.20.1-7.75-fabric+forge+neo" = _S6Wxy9id;
        "pkg-1.20.6-7.75-fabric+forge+neo" = _zqXCzv7h;
        "pkg-1.21.0-7.75-fabric+forge+neo" = _psosJ1H7;
        "pkg-1.20.1-7.77-fabric+forge+neo" = _AK50QSYw;
        "pkg-1.20.6-7.77-fabric+forge+neo" = _y0V56lSF;
        "pkg-1.21.0-7.77-fabric+forge+neo" = _9JlIYT4f;
        "pkg-1.20.1-7.78-fabric+forge+neo" = _8H8qNCfg;
        "pkg-1.20.6-7.78-fabric+forge+neo" = _jQzdODij;
        "pkg-1.21.0-7.78-fabric+forge+neo" = _gBU0FtR1;
        "pkg-1.20.1-7.80-fabric+forge+neo" = _mLJbbJPj;
        "pkg-1.20.6-7.80-fabric+forge+neo" = _H9p5Jgm9;
        "pkg-1.21.0-7.80-fabric+forge+neo" = _LLEkBFJV;
        "pkg-1.21.1-7.80-fabric+forge+neo" = _RN03Mkrs;
        "pkg-1.20.1-7.81-fabric+forge+neo" = _vddVmQmc;
        "pkg-1.20.6-7.81-fabric+forge+neo" = _Ix6FZ6dd;
        "pkg-1.21.0-7.81-fabric+forge+neo" = _X11matRJ;
        "pkg-1.21.1-7.81-fabric+forge+neo" = _4jghdgE7;
        "pkg-1.20.1-7.83-fabric+forge+neo" = _e8tFPGEH;
        "pkg-1.20.6-7.83-fabric+forge+neo" = _VQ1BJ3bn;
        "pkg-1.21.1-7.83-fabric+forge+neo" = _6IXUZYAe;
        "pkg-1.20.1-7.84-fabric+forge+neo" = _jo7YkyNS;
        "pkg-1.20.6-7.84-fabric+forge+neo" = _ygrSylbq;
        "pkg-1.21.1-7.84-fabric+forge+neo" = _13do3Fe4;
        "pkg-1.21.2-7.84-fabric+neo" = _TwRIor6v;
        "pkg-1.20.1-7.85-fabric+forge+neo" = _cOVyfKx2;
        "pkg-1.21.1-7.85-fabric+forge+neo" = _xBgJJeLc;
        "pkg-1.21.2-7.85-fabric+neo" = _FR4M3jGT;
        "pkg-1.21.2-7.86-fabric+neo" = _atzqfGFc;
        "pkg-1.20.1-7.87-fabric+forge+neo" = _aNzU64AT;
        "pkg-1.21.1-7.87-fabric+forge+neo" = _nwmUrrgY;
        "pkg-1.21.2-7.87-fabric+neo" = _BrKN9KUu;
        "pkg-1.21.2-7.88-fabric+neo" = _OXrk2aYg;
        "pkg-1.21.2-7.89-fabric+neo" = _GnwIlslS;
        "pkg-1.21.3-7.89-fabric+forge+neo" = _UqTBXnWC;
        "pkg-1.21.4-7.89-fabric+forge+neo" = _F3ciVO4i;
        "pkg-1.20.1-7.90-fabric+forge+neo" = _DsTfJqjw;
        "pkg-1.21.1-7.90-fabric+forge+neo" = _NZaNwTU1;
        "pkg-1.21.4-7.90-fabric+forge+neo" = _Ruo2lWiZ;
        "pkg-1.20.1-7.91-fabric+forge+neo" = _kRVILcx8;
        "pkg-1.21.1-7.91-fabric+forge+neo" = _QIVuPeva;
        "pkg-1.21.4-7.91-fabric+forge+neo" = _bbDHLo2p;
        "pkg-1.20.1-7.92-fabric+forge+neo" = _xourzx0y;
        "pkg-1.21.1-7.92-fabric+forge+neo" = _UFZB33AX;
        "pkg-1.21.4-7.92-fabric+forge+neo" = _ccU3gpvs;
        "pkg-1.20.1-7.93-fabric+forge+neo" = _k2Ch7TrO;
        "pkg-1.21.1-7.93-fabric+forge+neo" = _XglaW5sN;
        "pkg-1.21.4-7.93-fabric+forge+neo" = _L7tqI2Lg;
        "pkg-1.20.1-7.94-fabric+forge+neo" = _35WC69l2;
        "pkg-1.21.1-7.94-fabric+forge+neo" = _T4M8TBiR;
        "pkg-1.21.4-7.94-fabric+forge+neo" = _SmRj4qMG;
        "pkg-1.21.5-7.94-fabric+forge+neo" = _ShVBApDt;
        "pkg-1.21.5-7.98-fabric+forge+neo" = _spCUDVBV;
        "pkg-1.21.5-7.99-fabric+forge+neo" = _i0vDgxqx;
        "pkg-1.20.1-8.0-fabric+forge+neo" = _H3YqbdzS;
        "pkg-1.21.1-8.0-fabric+forge+neo" = _Kq85VO76;
        "pkg-1.21.4-8.0-fabric+forge+neo" = _Q8kCwsCX;
        "pkg-1.21.5-8.0-fabric+forge+neo" = _RQI795zM;
        "pkg-1.20.1-8.1-fabric+forge+neo" = _jcKaR4j8;
        "pkg-1.21.1-8.1-fabric+forge+neo" = _1Zu68XS4;
        "pkg-1.21.4-8.1-fabric+forge+neo" = _F611XL3k;
        "pkg-1.21.5-8.1-fabric+forge+neo" = _TVxkXnUs;
        "pkg-1.21.5-8.2-fabric+forge+neo" = _rSeksOK9;
        "pkg-1.20.1-8.3-fabric+forge+neo" = _P0uRrvF9;
        "pkg-1.21.1-8.3-fabric+forge+neo" = _ao7rZsss;
        "pkg-1.21.4-8.3-fabric+forge+neo" = _I5jY2gQ2;
        "pkg-1.21.5-8.3-fabric+forge+neo" = _aCWSF57s;
        "pkg-1.21.6-8.3-fabric+forge+neo" = _7bICOv60;
        "pkg-1.21.6-8.4-fabric+forge+neo" = _XLJXEnQw;
        "pkg-1.21.7-8.4-fabric+forge+neo" = _1vOnuu89;
        "pkg-1.21.8-8.4-fabric+forge+neo" = _mld0ZPD9;
        "pkg-1.21.9-8.4-fabric+forge+neo" = _5V8QOGQm;
        "pkg-1.20.1-8.5-fabric+forge+neo" = _aCPOmYsR;
        "pkg-1.21.1-8.5-fabric+forge+neo" = _X9oCIbX0;
        "pkg-1.21.8-8.5-fabric+forge+neo" = _YspdaqOd;
        "pkg-1.21.9-8.5-fabric+forge+neo" = _MR6ZhTOB;
        "pkg-1.21.9-8.6-fabric+forge+neo" = _Kdr4OHyk;
        "pkg-1.20.1-8.7-fabric+forge+neo" = _XP7bFyNy;
        "pkg-1.21.1-8.7-fabric+forge+neo" = _QZ8hTzIf;
        "pkg-1.21.8-8.7-fabric+forge+neo" = _HXF4XRYh;
        "pkg-1.21.9-8.7-fabric+forge+neo" = _eHu2w7cC;
        "pkg-1.21.9-8.8-fabric+forge+neo" = _A9BCeuWm;
        "pkg-1.21.10-8.8-fabric+forge+neo" = _brP8kTNe;
        "pkg-1.21.9-8.9-fabric+forge+neo" = _eJb8QANu;
        "pkg-1.21.10-8.9-fabric+forge+neo" = _WbocY1dZ;
        "pkg-1.20.1-8.10-fabric+forge+neo" = _c067xnvC;
        "pkg-1.21.1-8.10-fabric+forge+neo" = _MFErUWoP;
        "pkg-1.21.8-8.10-fabric+forge+neo" = _dEkcqsFL;
        "pkg-1.21.10-8.10-fabric+forge+neo" = _hfIrbsoZ;
        "pkg-1.20.1-8.11-fabric+forge+neo" = _B1guLZlO;
        "pkg-1.21.1-8.11-fabric+forge+neo" = _VgvgzdVi;
        "pkg-1.21.8-8.11-fabric+forge+neo" = _8tJ3qV5y;
        "pkg-1.21.10-8.11-fabric+forge+neo" = _Gi3mtnzR;
        "pkg-1.20.1-8.12-fabric+forge+neo" = _Cq0K5Ked;
        "pkg-1.21.1-8.12-fabric+forge+neo" = _FFOc67PN;
        "pkg-1.21.10-8.12-fabric+forge+neo" = _q26eQtHl;
        "pkg-1.20.1-8.13-fabric+forge+neo" = _9fUQXa48;
        "pkg-1.21.1-8.13-fabric+forge+neo" = _VTg6femX;
        "pkg-1.21.10-8.13-fabric+forge+neo" = _A0CFMmGr;
        "pkg-1.21.11-8.13-fabric+forge+neo" = _T8rv7kwo;
        "pkg-26.1.0-8.13-fabric+forge+neo" = _RXXtkZKe;
        "pkg-26.1.0-8.14-fabric+forge+neo" = _rdtoEHGR;
        "pkg-26.1.0-8.15-fabric+forge+neo" = _iVL4ArGv;
        "pkg-26.1.0-8.16-fabric+forge+neo" = _20oNLyvX;
        "pkg-26.1.1-8.16-fabric+forge+neo" = _WJCcw5K1;
        "pkg-1.20.1-8.17-fabric+forge+neo" = _uS8VfP6E;
        "pkg-1.21.1-8.17-fabric+forge+neo" = _bmhlgYst;
        "pkg-1.21.11-8.17-fabric+forge+neo" = _W6jhRGR1;
        "pkg-26.1.1-8.17-fabric+forge+neo" = _4c8b0rES;
        "pkg-26.1.2-8.17-fabric+forge+neo" = _cwnz0NPs;
        "pkg-1.20.1-8.19-fabric+forge+neo" = _rbFaiVhz;
        "pkg-1.21.1-8.19-fabric+forge+neo" = _2IIsqWOB;
        "pkg-1.21.11-8.19-fabric+forge+neo" = _TpanGjwZ;
        "pkg-26.1.2-8.19-fabric+forge+neo" = _IGnRAcKT;
        "pkg-1.20.1-8.20-fabric+forge+neo" = _27IPdmJc;
        "pkg-1.21.1-8.20-fabric+forge+neo" = _QS3LpoNt;
        "pkg-1.21.11-8.20-fabric+forge+neo" = _1AikiD1Q;
        "pkg-26.1.2-8.20-fabric+forge+neo" = _9smDW0F0;
        "pkg-1.20.1-8.21-fabric+forge+neo" = _mqC4eQ0N;
        "pkg-1.21.1-8.21-fabric+forge+neo" = _yrD77nVa;
        "pkg-1.21.11-8.21-fabric+forge+neo" = _ypHoHtrK;
        "pkg-26.1.2-8.21-fabric+forge+neo" = _GyloFJNa;
        "pkg-1.20.1-8.22-fabric+forge+neo" = _VaV1h0dI;
        "pkg-1.21.1-8.22-fabric+forge+neo" = _6xEh8Qbr;
        "pkg-1.21.11-8.22-fabric+forge+neo" = _6EPDFSpU;
        "pkg-26.1.2-8.22-fabric+forge+neo" = _ZnNSwSh3;
        "pkg-1.20.1-8.23-fabric+forge+neo" = _oNQJ2QEr;
        "pkg-1.21.1-8.23-fabric+forge+neo" = _BV3sMDFA;
        "pkg-1.21.11-8.23-fabric+forge+neo" = _ABVIZRLL;
        "pkg-26.1.2-8.23-fabric+forge+neo" = _rureE08S;
        "pkg-1.20.1-8.24-fabric+forge+neo" = _RzyCp8tj;
        "pkg-1.21.1-8.24-fabric+forge+neo" = _RrgdXPcx;
        "pkg-1.21.11-8.24-fabric+forge+neo" = _M8aFJiqP;
        "pkg-26.1.2-8.24-fabric+forge+neo" = _YwIBswrE;
        "pkg-1.20.1-8.25-fabric+forge+neo" = _lH1VBD4w;
        "pkg-1.21.1-8.25-fabric+forge+neo" = _IocRsdQH;
        "pkg-1.21.11-8.25-fabric+forge+neo" = _J5qWzsUu;
        "pkg-26.1.2-8.25-fabric+forge+neo" = _Pj1ElnST;
        "pkg-1.20.1-8.27-fabric+forge+neo" = _vY8pUTQD;
        "pkg-1.21.1-8.27-fabric+forge+neo" = _Rv1uOLbY;
        "pkg-1.21.11-8.27-fabric+forge+neo" = _5CiAbYVx;
        "pkg-26.1.2-8.27-fabric+forge+neo" = _ZQRPhcVr;
        "pkg-1.20.1-8.28-fabric+forge+neo" = _v150Kayb;
        "pkg-1.21.1-8.28-fabric+forge+neo" = _4ZSJruAA;
        "pkg-1.21.11-8.28-fabric+forge+neo" = _MuYyVagF;
        "pkg-26.1.2-8.28-fabric+forge+neo" = _qoW0RMj3;
        "pkg-26.2.0-8.28-fabric+forge+neo" = _vGP3Ir3X;
        "pkg-1.20.1-8.29-fabric+forge+neo" = _JXygO4NK;
        "pkg-1.21.1-8.29-fabric+forge+neo" = _lCnTeZAm;
        "pkg-26.1.2-8.29-fabric+forge+neo" = _11JlKy3W;
        "pkg-26.2.0-8.29-fabric+forge+neo" = _lpCfhWoS;
        "pkg-26.2.0-8.30-fabric+forge+neo" = _tJVsljd6;
        "pkg-1.20.1-8.31-fabric+forge+neo" = _j0eS32aA;
        "pkg-1.21.1-8.31-fabric+forge+neo" = _mofpoWGq;
        "pkg-1.21.11-8.31-fabric+forge+neo" = _dwKdiJKa;
        "pkg-26.1.2-8.31-fabric+forge+neo" = _Suzgp5q9;
        "pkg-26.2.0-8.31-fabric+forge+neo" = _dXKIKfOk;
        "pkg-1.20.1-8.32-fabric+forge+neo" = _NUeIFwIZ;
        "pkg-1.21.1-8.32-fabric+forge+neo" = _c3Qkrklx;
        "pkg-1.21.11-8.32-fabric+forge+neo" = _e4SDY5SX;
        "pkg-26.1.2-8.32-fabric+forge+neo" = _iXqgYZEw;
        "pkg-26.2.0-8.32-fabric+forge+neo" = _hMbANJu3;
        "pkg-1.20.1-8.37-fabric+forge+neo" = _OvcGSJ21;
        "pkg-1.21.1-8.37-fabric+forge+neo" = _FmzAojI6;
        "pkg-26.2.0-8.37-fabric+forge+neo" = _AlchqKWy;
        "pkg-1.20.1-8.38-fabric+forge+neo" = _zfBVSl0s;
        "pkg-1.21.1-8.38-fabric+forge+neo" = _d5BBCbgH;
        "pkg-26.2.0-8.38-fabric+forge+neo" = _gCJVHEL0;
