...
let
    ...
    in {
        ...
        "pkg-1.8.0-B12" = _XfKJiKQ8;
        "pkg-1.8.1-B13" = _sP9rUU3H;
        "pkg-1.8.2-B14" = _TMVb3wST;
        "pkg-1.8.3-B15" = _vevrlwHm;
        "pkg-1.8.4-B16" = _PmvNiQ1f;
        "pkg-1.8.5-B17" = _cejhtAy8;
        "pkg-1.8.5-B18" = _Lh9moXF6;
        "pkg-1.8.5-B19" = _CGDrbkIj;
        "pkg-1.8.6-B20" = _Hg19JBJD;
        "pkg-1.8.7-B21" = _erC1vItA;
        "pkg-1.8.8-B22" = _9vRdSzIz;
        "pkg-1.8.9-B23" = _SJXTj9vo;
        "pkg-1.8.9-B22" = _CVPe4bA7;
        "pkg-1.8.10-B23" = _ZxMi0ws8;
        "pkg-1.8.10-B24" = _FIfvYYyR;
        "pkg-1.8.11-B25" = _DDQcWdY0;
        "pkg-1.8.11-B24" = _U6qaFnkB;
        "pkg-1.8.12-B26" = _LYCXKgiD;
        "pkg-1.8.12-B25" = _xfC3W3eJ;
        "pkg-1.8.13-B27" = _txzRWNcL;
        "pkg-1.8.13-B26" = _XHJr1mNG;
        "pkg-1.8.14-B28" = _k0J8tjdN;
        "pkg-1.8.15-B29" = _8P8yF0UP;
        "pkg-1.8.16-B30" = _1N9H9G1s;
        "pkg-1.8.17-B31" = _PVjnY7Ym;
        "pkg-1.8.18-B32" = _3GTxJnCy;
        "pkg-1.8.19-B33" = _q5cdDDuS;
        "pkg-1.8.20-B35" = _bST9A5y2;
        "pkg-1.8.21-B36" = _XJRKNa7C;
        "pkg-1.8.22-B37" = _H2NP6ajc;
        "pkg-1.8.23-B38" = _LI9xpnDD;
        "pkg-1.8.24-B39" = _Gy2ElbHJ;
        "pkg-1.8.25-B40" = _SFXmbAn7;
        "pkg-1.8.26-B41" = _pgcAdhbb;
        "pkg-1.9.0-42" = _IQAp0oBM;
        "pkg-1.9.1-43" = _92Evz44a;
        "pkg-1.9.2-44" = _y33jL8Qu;
        "pkg-1.9.3-45" = _m173hr9Y;
        "pkg-1.9.4-46" = _NG0KaQuG;
        "pkg-1.9.5-47" = _jNH2Ja6H;
        "pkg-1.9.6-48" = _pIIwwNJq;
        "pkg-1.9.7-49" = _YVBzgVnz;
        "pkg-1.9.8-50" = _TzNEFY9v;
        "pkg-1.9.9-51" = _rN628bRp;
        "pkg-1.10.0-B52" = _SYpz1UZE;
        "pkg-1.9.10-52" = _ku0tyTiN;
        "pkg-1.10.1-B53" = _Si7EWoVG;
        "pkg-1.9.11-53" = _gV5W98Dp;
        "pkg-1.9.12-54" = _MbkImmIN;
        "pkg-1.9.13-55" = _iK6XQex2;
        "pkg-1.9.14-56" = _WfsGhvzS;
        "pkg-1.10.2-B58" = _MNpaM1En;
        "pkg-1.9.15-59" = _XR86I9SK;
        "pkg-1.9.16-60" = _qkf1OM5Y;
        "pkg-1.10.3-B61" = _IhmsNRqB;
        "pkg-1.10.3-B64" = _ikQou3M4;
        "pkg-1.10.4-B65" = _ruta6I1j;
        "pkg-1.9.17-66" = _bkDzUKmY;
        "pkg-1.10.5-B66" = _OyLr73Nf;
        "pkg-1.10.6-B67" = _Yu55qL9J;
        "pkg-1.9.18-69" = _qPCcGtcc;
        "pkg-1.9.19-70" = _YHn4HoP2;
        "pkg-1.10.7-B71" = _jTZ50yL6;
        "pkg-1.10.8-B72" = _6833G2hF;
        "pkg-1.9.20-71" = _pMnJKV6N;
        "pkg-1.9.21-72" = _1lNrSxYE;
        "pkg-1.9.22-73" = _MD5YpBSC;
        "pkg-1.9.22-74" = _yYek1zod;
        "pkg-1.9.22-75" = _QKbVkmZx;
        "pkg-1.10.9-B76" = _6dWZbakU;
        "pkg-1.10.10-B77" = _1xqS6fYw;
        "pkg-1.10.11-B78" = _NyEQXIrz;
        "pkg-1.9.23-79" = _FLn3akA2;
        "default" = _FLn3akA2;
    });
