...
let
    ...
    in {
        ...
        "pkg-1.1.8" = _iCFTZGxN;
        "pkg-1.1.9" = _rVfhED36;
        "pkg-1.1.10" = _22eLwG7A;
        "pkg-1.1.11" = _rVDd5j6m;
        "pkg-1.1.12" = _Gb2oEgcN;
        "pkg-1.1.13" = _PXOLH82S;
        "pkg-1.1.14" = _GKZqnkU2;
        "pkg-1.1.15" = _8fmeqjR0;
        "pkg-1.1.16.Legacy" = _Qj6x0wKe;
        "pkg-1.1.16" = _B4RwGsJ4;
        "default" = _B4RwGsJ4;
    });
