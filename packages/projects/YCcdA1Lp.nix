...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.16.4" = _PZoHxtj7;
        "pkg-1.0.0+mc1.15.2" = _mL5pKGwm;
        "pkg-1.0.0+mc1.14.4" = _Hj5BG4Jj;
        "pkg-1.0.0+mc20w51a" = _mlYKiiir;
        "pkg-1.0.0+mc21w16a" = _IdgYdQsH;
        "pkg-1.0.0+mc1.17" = _tVcNp2jk;
        "pkg-1.0.1+mc1.17" = _LLDQeXRZ;
        "pkg-1.0.1+mc1.18-pre1" = _kdPfvZnX;
        "pkg-1.0.1+mc22w17a" = _tNzcisCf;
        "pkg-1.0.1+mc1.19" = _U1IsTa2s;
        "pkg-1.0.1+mc22w44a" = _6M9aN8Tv;
        "pkg-1.0.1+mc1.19.3" = _HFMPvZQK;
        "pkg-1.0.2+mc1.19.3" = _YB9F0peO;
        "pkg-1.0.2+mc1.19.2" = _zn6IiTSe;
        "pkg-1.1.0+mc1.16.4" = _ct9ftD7q;
        "pkg-1.1.0+mc1.15.2" = _txIAjimH;
        "pkg-1.1.0+mc1.14.4" = _Yzjqg5MR;
        "pkg-1.1.0+mc1.17" = _B6liXVTg;
        "pkg-1.1.0+mc1.18-pre1" = _uCgajRAw;
        "pkg-1.1.0+mc1.19" = _86YRKAbB;
        "pkg-1.1.0+mc1.19.2" = _M7uGVxUD;
        "pkg-1.1.0+mc1.19.3" = _73LPTLm4;
        "pkg-1.1.0+mc1.19.4" = _KsdAeh56;
        "pkg-1.1.0+mc1.20-pre2" = _YN7romjU;
        "pkg-1.1.0+mc1.20.1" = _Skc8LGrP;
        "pkg-1.1.1+mc1.16.4" = _v7b9dfDP;
        "pkg-1.1.1+mc1.15.2" = _o9nkUM5K;
        "pkg-1.1.1+mc1.14.4" = _72J951UA;
        "pkg-1.1.1+mc1.17" = _kIqf1NP4;
        "pkg-1.1.1+mc1.18-pre1" = _AwZ80DEI;
        "pkg-1.1.1+mc1.19" = _H3xPf3r7;
        "pkg-1.1.1+mc1.19.2" = _O9I1CHr1;
        "pkg-1.1.1+mc1.19.3" = _rsSnC995;
        "pkg-1.1.1+mc1.19.4" = _QuOkR1hh;
        "pkg-1.1.1+mc1.20.1" = _wX0qDRqE;
        "pkg-1.1.1+mc1.20.4" = _JHauE0Gf;
        "pkg-1.2.0" = _2UZLoAnT;
        "pkg-1.2.1+mc1.16.5" = _9JQyDM36;
        "pkg-1.2.1+mc1.17.1" = _KBSJKOoN;
        "pkg-1.2.1+mc1.18.2" = _5XBW472D;
        "pkg-1.2.1+mc1.19" = _WnDaWWu5;
        "pkg-1.2.1+mc1.19.4" = _XGhZsma6;
        "pkg-1.2.1+mc1.20" = _SLPXwn6o;
        "pkg-1.2.1+mc1.20.5" = _os1RZ9UZ;
        "pkg-1.2.1+mc1.21.1" = _YHFGUlIe;
        "pkg-1.2.1+mc25w37a" = _CV01BeWn;
        "pkg-1.2.2" = _Te4YBVee;
        "pkg-1.2.2+mc1.15.2" = _3ZkuZ3VI;
        "pkg-1.2.2+mc1.16.5" = _obioiZFl;
        "pkg-1.2.2+mc1.17.1" = _JlVUlXGy;
        "pkg-1.2.2+mc1.18.2" = _eMJTGiST;
        "pkg-1.2.2+mc1.19" = _ESeVBZpl;
        "pkg-1.2.2+mc1.19.3" = _IALyAg1V;
        "pkg-1.2.2+mc1.19.4" = _6hkyL6uU;
        "pkg-1.2.2+mc1.20" = _Nf1hD9f3;
        "pkg-1.2.2+mc1.20.2" = _mkzeH0Mj;
        "pkg-1.2.2+mc1.20.4" = _WNDt37w4;
        "pkg-1.2.2+mc1.20.5" = _55650Mu0;
        "pkg-1.2.2+mc1.21.1" = _RfSWPD7d;
        "pkg-1.2.2+mc1.21.3" = _fMkmscXt;
        "pkg-1.2.2+mc1.21.8" = _Y6t3LWhK;
        "pkg-1.2.2+mc1.21.9" = _GNULkwFL;
        "pkg-1.2.3+mc1.14.4" = _1XxJtf0w;
        "pkg-1.2.3+mc1.15.2" = _uBObDw9x;
        "pkg-1.2.3+mc1.16.5" = _UTXCIOOT;
        "pkg-1.2.3+mc1.17.1" = _D1cFYrgz;
        "pkg-1.2.3+mc1.18.2" = _d2c9FeDU;
        "pkg-1.2.3+mc1.19" = _pyLVzB7o;
        "pkg-1.2.3+mc1.19.3" = _qqIw1ElZ;
        "pkg-1.2.3+mc1.19.4" = _IszzfPOc;
        "pkg-1.2.3+mc1.20" = _wJsXWUpF;
        "pkg-1.2.3+mc1.20.2" = _x3a2Vhy4;
        "pkg-1.2.3+mc1.20.4" = _EONau9Mp;
        "pkg-1.2.3+mc1.20.5" = _Xy7I3pd2;
        "pkg-1.2.3+mc1.21.1" = _Hkno9rJj;
        "pkg-1.2.3+mc1.21.3" = _zxJKamrW;
        "pkg-1.2.3+mc1.21.8" = _pWcrTEqM;
        "pkg-1.2.3+mc1.21.9" = _n9eTnV4o;
        "pkg-1.2.3+mc26.1-rc-1" = _Ebs3y1HV;
        "pkg-1.2.4+mc1.15.2" = _aqh5gI4a;
        "pkg-1.2.4+mc1.16.5" = _PoIm4WgN;
        "pkg-1.2.4+mc1.17.1" = _QLLTuogw;
        "pkg-1.2.4+mc1.18.2" = _6A5hwTI0;
        "pkg-1.2.4+mc1.19" = _XAV3Zev2;
        "pkg-1.2.4+mc1.19.3" = _ad67jiuu;
        "pkg-1.2.4+mc1.19.4" = _UOvaq6XS;
        "pkg-1.2.4+mc1.20" = _fjnLzI9z;
        "pkg-1.2.4+mc1.20.2" = _xJYf3pMp;
        "pkg-1.2.4+mc1.20.4" = _Qpp8I6rk;
        "pkg-1.2.4+mc1.20.5" = _gmEs3W0h;
        "pkg-1.2.4+mc1.21.1" = _lRYzNzTu;
        "pkg-1.2.4+mc1.21.3" = _R5jitmaO;
        "pkg-1.2.4+mc1.21.8" = _LwwRAHRG;
        "pkg-1.2.4+mc26.2-pre-2" = _6LPdcMbO;
        "default" = _6LPdcMbO;
    });
