...
let
    ...
    in {
        ...
        "pkg-16" = _WazGO9jL;
        "pkg-17" = _1hZ9jpOq;
        "pkg-1.19.2-0.2.2.1" = _atIuLIWW;
        "pkg-1.19.2-0.2.2.2" = _Z8fZMp2Z;
        "pkg-1.20.0-2.1.2" = _n8nskXZu;
        "pkg-1.21.1-2.1.8" = _d7ZmOwtr;
        "pkg-1.21.1-2.1.9" = _3oaVWbQz;
        "pkg-1.21.1-2.2.1" = _ZQSzbHiL;
        "default" = _ZQSzbHiL;
    });
