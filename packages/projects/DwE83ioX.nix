...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.0.9" = _kHiFCiai;
        "pkg-1.18.2-1.0.11" = _yct3Rjsa;
        "pkg-1.19.2-1.2.17" = _USYHyz39;
        "pkg-1.19.2-1.2.18" = _VOS3vUrB;
        "pkg-1.19.3-1.3.18" = _e1JYnMvn;
        "pkg-1.19.3-1.3.19" = _9QrDOpsb;
        "pkg-1.16.5-1.0.10" = _y0iUEYGL;
        "pkg-1.18.2-1.0.12" = _mlfdtYXk;
        "pkg-1.19.3-1.3.20" = _pPTiktN4;
        "pkg-1.19.2-1.2.19" = _N6jVCv4R;
        "pkg-1.16.5-1.0.11" = _TmPoQUBE;
        "pkg-1.3.20" = _IsY3tzN0;
        "pkg-1.5.23" = _hYYftIDa;
        "pkg-1.6.23" = _IPXhZ6gt;
        "pkg-1.3.22" = _uRlT67j3;
        "pkg-1.6.24" = _nU1ZOFsZ;
        "pkg-1.5.24" = _7rBYKrs7;
        "pkg-1.7.24" = _L2f7Cjfd;
        "pkg-1.8.24" = _406LiFwu;
        "pkg-1.8.25" = _WZbjQ9hB;
        "pkg-1.8.26" = _ELRsHJWm;
        "pkg-1.8.28" = _Yhk8U5Nh;
        "pkg-1.5.28" = _mXTmBlxj;
        "pkg-1.6.28" = _SJ15udm8;
        "pkg-1.8.29" = _grkRxyDG;
        "pkg-1.3.29" = _dBxrqaAH;
        "pkg-1.8.30" = _Hfl5PvHl;
        "pkg-1.8.31" = _wuonHkrO;
        "pkg-1.8.32" = _hUhcvSkR;
        "pkg-1.3.32" = _P2TaHEKp;
        "pkg-1.5.31" = _VaQ60bvD;
        "pkg-1.2.32" = _hxRxVDub;
        "pkg-1.3.33" = _3sQAAW5F;
        "pkg-1.9.32" = _qnV2wmo3;
        "pkg-1.9.33" = _lCXyBLO6;
        "pkg-1.10.33" = _HN7BEpks;
        "pkg-1.11.33" = _4kqRtzg0;
        "pkg-1.11.34" = _k53qmAjo;
        "pkg-1.11.35" = _vRKj97w0;
        "pkg-1.11.36" = _sZeFFHaX;
        "pkg-1.11.37" = _L4xJGL1A;
        "pkg-1.8.33" = _NYE64vSu;
        "pkg-1.8.37" = _zT03YuxV;
        "pkg-1.11.38" = _PD4gveOm;
        "pkg-1.11.39" = _mvaNW9tt;
        "pkg-1.11.40" = _CD0NjKQ3;
        "pkg-1.11.41" = _YTeKrKFv;
        "pkg-1.11.42" = _lpcV2XTc;
        "pkg-1.11.43" = _JcLfGDLR;
        "default" = _JcLfGDLR;
    });
