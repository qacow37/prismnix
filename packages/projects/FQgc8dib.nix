...
let
    ...
    in {
        ...
        "pkg-v20.4.0-1.20.4-Forge" = _q9bSw0mY;
        "pkg-v20.4.0-1.20.4-NeoForge" = _QxBZhKSB;
        "pkg-v8.0.3-1.20.1-Forge" = _BOsg18ZA;
        "pkg-v8.0.3-1.20.1-Fabric" = _ISD6tUmP;
        "pkg-v20.4.1-1.20.4-Fabric" = _lfD849Zm;
        "pkg-v20.4.1-1.20.4-Forge" = _2isYdFws;
        "pkg-v20.4.1-1.20.4-NeoForge" = _Oyq299Iq;
        "pkg-v21.0.0-1.21-Fabric" = _K0LiNTc4;
        "pkg-v21.0.0-1.21-NeoForge" = _m23IrUei;
        "pkg-v21.1.0-1.21.1-Fabric" = _9vsCOD7L;
        "pkg-v21.1.0-1.21.1-NeoForge" = _nJQ2U0Ru;
        "pkg-v8.0.4-1.20.1-Forge" = _ISQPtPH5;
        "pkg-v8.0.4-1.20.1-Fabric" = _uAsQHTvk;
        "pkg-v21.1.1-1.21.1-Fabric" = _8tm2VTlY;
        "pkg-v21.1.1-1.21.1-NeoForge" = _kaEyeuaX;
        "pkg-v21.3.0-1.21.3-Fabric" = _PkPt0KkM;
        "pkg-v21.3.0-1.21.3-NeoForge" = _aLePYjrd;
        "pkg-v21.1.2-1.21.1-Fabric" = _CeH1sDcA;
        "pkg-v21.1.2-1.21.1-NeoForge" = _2k3GCxEt;
        "pkg-v21.4.0-1.21.4-Fabric" = _buFgj5oh;
        "pkg-v21.4.0-1.21.4-NeoForge" = _8eyqnWAp;
        "pkg-v21.5.0-1.21.5-Fabric" = _Wap1TMYq;
        "pkg-v21.5.0-1.21.5-NeoForge" = _CRuCXWYB;
        "pkg-v21.6.0-1.21.6-Fabric" = _JWuIVBwn;
        "pkg-v21.6.0-1.21.6-NeoForge" = _WwNhXFrR;
        "pkg-v21.7.0-1.21.7-Fabric" = _XkzIsiis;
        "pkg-v21.7.0-1.21.7-NeoForge" = _wWt0VBEo;
        "pkg-v21.8.0-1.21.8-Fabric" = _Dwl01ctU;
        "pkg-v21.8.0-1.21.8-NeoForge" = _FjOmzpZ6;
        "pkg-v21.8.1-1.21.8-Fabric" = _o9pF5uPO;
        "pkg-v21.8.1-1.21.8-NeoForge" = _URY186Aq;
        "pkg-21.9.0" = _rEW3Tc2H;
        "pkg-21.10.0" = _IEzdo6sR;
        "pkg-21.11.0" = _fNkOw5Nf;
