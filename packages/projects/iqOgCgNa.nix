...
let
    ...
    in {
        ...
        "pkg-3.0.0" = _zLFI2PiW;
        "pkg-3.0.0-fabric-waystones" = _LF4hDIgq;
        "pkg-3.0.0-waystones" = _FdpKxZht;
        "pkg-4.0.0" = _vBhuid9F;
        "pkg-4.0.0-fabric-waystones" = _koYstDfq;
        "pkg-4.0.0-waystones" = _tbg2qhVM;
        "pkg-4.0.1" = _lcjRt64Q;
        "pkg-4.0.1-fabric-waystones" = _4UcirAld;
        "pkg-4.0.1-waystones" = _E30OqO4j;
        "pkg-4.0.2" = _Nk2TY1uR;
        "pkg-4.0.2-fabric-waystones" = _ypqPzcjG;
        "pkg-4.0.2-waystones" = _mgpODaQm;
        "pkg-4.1.0" = _jWHUwsvB;
        "pkg-4.1.0-fabric-waystones" = _RqSYumXx;
        "pkg-4.1.0-waystones" = _IHKCgguV;
        "pkg-4.2.0" = _u9CesuEV;
        "pkg-4.2.0-fabric-waystones" = _ehSBuJQN;
        "pkg-4.2.0-waystones" = _BtoeuosU;
        "pkg-4.2.1" = _2xpnMA4t;
        "pkg-4.2.1-fabric-waystones" = _73MHh4Hr;
        "pkg-4.2.1-waystones" = _o9i4UwGH;
        "pkg-2.2.0" = _K7tAmyzp;
        "pkg-1.1.0-beta" = _6wIyzXI7;
        "pkg-4.0.3" = _Sw88431R;
        "pkg-4.0.3-fabric-waystones" = _1eAOdibG;
        "pkg-4.0.3-waystones" = _unuOcw0v;
        "pkg-4.2.2" = _1FubeLMA;
        "pkg-4.2.2-waystones" = _qgrkU1fO;
        "pkg-4.2.2-fabric-waystones" = _6nH0w4PS;
        "pkg-4.3.0" = _4Kwlzedb;
        "pkg-4.3.0-waystones" = _QwFu1Ag5;
        "pkg-v4.3.0-fabric-waystones" = _dfKxgIOb;
        "pkg-v4.4.0+1.21.2-1.21.3" = _nWYNlRFs;
        "pkg-v4.4.0+1.21.2-1.21.3-waystones" = _MFiaHkXf;
        "pkg-v4.4.0+1.21.2-1.21.3-fwaystones" = _l9L3myQt;
        "pkg-v4.4.0+1.21.4" = _K4wQo7M9;
        "pkg-v4.4.0+1.21.4-waystones" = _3wbivRI5;
        "pkg-v4.4.0+1.21.4-fwaystones" = _UdfHEqXD;
        "pkg-v4.4.0+1.21.5" = _wPfvzMrd;
        "pkg-v4.4.0+1.21.5-waystones" = _4rZ3BRRC;
        "pkg-v4.4.0+1.21.6" = _txmwvLEm;
        "pkg-v4.4.0+1.21.6-waystones" = _5eUaVixv;
        "pkg-v4.4.0+1.21.7-1.21.8" = _qapq8SMY;
        "pkg-v4.4.0+1.21.7-1.21.8-waystones" = _mnBxQeNs;
        "pkg-v4.4.0+1.21.9-26.1.2" = _Bvpk2Lm4;
        "pkg-v4.4.0+1.21.9-26.1.2-waystones" = _C5TX1lvH;
        "pkg-v4.4.1" = _8J2JVIGm;
        "pkg-v4.4.4" = _xGAiKHVY;
        "default" = _xGAiKHVY;
    });
