...
let
    ...
    in {
        ...
        "pkg-51.0.0" = _YMPDJKAb;
        "pkg-55.0.0" = _fh9NqSjE;
        "pkg-55.0.1" = _6TAPTYVp;
        "pkg-55.0.2" = _nYTZfBSu;
        "pkg-55.1.0" = _2A6XU9BA;
        "pkg-55.1.1" = _OL4KsuMx;
        "pkg-55.1.2" = _TtDOWw4s;
        "pkg-55.2.0" = _Qs4dgSF6;
        "pkg-55.2.1" = _SvLqP73m;
        "pkg-55.3.0" = _HTn8EAbg;
        "pkg-55.3.1" = _Ve3rtEdg;
        "pkg-55.3.2" = _7RoNNwec;
        "pkg-55.3.3" = _AZnUG9mW;
        "pkg-55.4.0" = _Y3mc9CLR;
        "pkg-55.4.1" = _nRnjXZNs;
        "pkg-56.0.0" = _aKh20stV;
        "pkg-56.0.1" = _YeeCb8w0;
        "pkg-56.0.2" = _6wWBJz3O;
        "pkg-56.0.3" = _IRembMu0;
        "pkg-56.1.0" = _GsXBkeOl;
        "pkg-56.1.1" = _bbAZ9ZHf;
        "pkg-57.0.0" = _ZKBiUhjF;
        "pkg-57.0.1" = _4ogT3bql;
        "pkg-57.0.2" = _tQKGLiwz;
        "pkg-57.0.3" = _nUtPjS6Y;
        "pkg-57.1.0" = _PxpN1bYh;
        "pkg-57.2.0" = _OXPgmMsz;
        "pkg-57.2.1" = _le0Fcbjy;
        "pkg-57.2.2" = _tKzlVOvI;
        "pkg-57.2.3" = _w1C2GWYZ;
        "pkg-57.2.4" = _3cBbCZJd;
        "pkg-57.2.5" = _gTnDvGei;
        "pkg-57.2.6" = _myLvzPXX;
        "pkg-57.2.7" = _8dSqLgZ0;
        "pkg-57.2.8" = _hdsumuhF;
        "pkg-57.2.9" = _F4zq1lU5;
        "pkg-57.3.0" = _p0WVi3Xz;
        "pkg-57.3.1" = _HlqEHqH6;
        "pkg-59.0.0" = _UPuWWeUo;
        "pkg-59.0.1" = _hOHPLp1a;
        "pkg-59.0.2" = _ODMOtwTB;
        "pkg-59.0.3" = _7mwHVWBk;
        "pkg-59.0.4" = _pjclv7sM;
        "pkg-59.0.5" = _vBAzZmwC;
        "pkg-59.0.6" = _Ark3bs6Q;
        "pkg-59.0.7" = _mARVbrD4;
        "pkg-59.1.0" = _WQOu99Mx;
        "pkg-59.1.1" = _l6YHramQ;
        "pkg-59.1.10" = _BXr8N3eC;
        "pkg-59.1.11" = _l20BLn6Q;
        "pkg-59.1.12" = _wLUXgZs5;
        "pkg-59.1.2" = _enCKMKdE;
        "pkg-59.1.3" = _1HV5FY2y;
        "pkg-59.1.4" = _KCUnsise;
        "pkg-59.1.5" = _EjWmyaFW;
        "pkg-59.1.6" = _EyVoOWAw;
        "pkg-59.1.7" = _GB5Yk4Ma;
        "pkg-59.1.8" = _PplNxGTW;
        "pkg-59.1.9" = _YXoOb5Kk;
        "pkg-58.0.0" = _gvF5pU8a;
        "pkg-58.0.1" = _N8Npe99u;
        "pkg-58.0.2" = _Z5Ate70Z;
        "pkg-58.1.0" = _xrIxQZpG;
        "pkg-58.1.1" = _ayg4a5cu;
        "pkg-58.1.2" = _8e2BfsvV;
        "pkg-58.1.3" = _5SZcKUC9;
        "pkg-59.1.13" = _4d1lifVP;
        "default" = _4d1lifVP;
    });
