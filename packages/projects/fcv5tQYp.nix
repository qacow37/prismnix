...
let
    ...
    in {
        ...
        "pkg-v1.3.0-mc26.1-snapshot-5" = _JsYdU9Wu;
        "pkg-v1.3.0-mc1.21.11" = _yRJyWfDA;
        "pkg-v1.3.0-mc1.21.10" = _wPAjYKC8;
        "pkg-v1.3.1-mc1.21.11" = _bfhiWPAq;
        "pkg-v1.3.1-mc1.21.10" = _LvSbsd4p;
        "pkg-v1.3.1-mc26.1-snapshot-5" = _bi19bY4B;
        "pkg-v1.4.0-mc1.21.11" = _NsP1Gq26;
        "pkg-v1.4.0-mc26.1-snapshot-6" = _Ivhqfatx;
        "pkg-v1.4.0-mc1.21.10" = _aKA6EjLc;
        "pkg-v1.4.1-mc1.21.11" = _hDTshqsR;
        "pkg-v1.4.1-mc26.1-snapshot-7" = _mpeokjjW;
        "pkg-v1.4.1-mc1.21.8" = _9SYOlje5;
        "pkg-v1.4.1-mc1.21.10" = _ingHXVmS;
        "pkg-v1.4.2-mc1.21.10" = _mNVXRXwm;
        "pkg-v1.4.2-mc1.21.8" = _py9uH5wI;
        "pkg-v1.4.2-mc1.21.11" = _LLYIrJA0;
        "pkg-v1.4.2-mc26.1-snapshot-10" = _V3usmZkd;
        "pkg-v1.4.3-mc1.21.8" = _52O4Ytfr;
        "pkg-v1.4.3-mc1.21.10" = _XRaG6ReA;
        "pkg-v1.4.3-mc26.1-snapshot-10" = _xmGhHszS;
        "pkg-v1.4.3-mc1.21.11" = _R1t4yAZB;
        "pkg-v1.5.0-mc1.21.8" = _rwbCfis9;
        "pkg-v1.5.0-mc26.1" = _kr9f7Kpt;
        "pkg-v1.5.0-mc1.21.11" = _bcN5Td8M;
        "pkg-v1.5.0-mc1.21.10" = _UZ32i4N7;
        "pkg-v1.6.0-mc1.21.11" = _UQiE1APn;
        "pkg-v1.6.0-mc26.1" = _6vZmXsdR;
        "pkg-v1.6.0-mc1.21.10" = _7DQ2r6pF;
        "pkg-v1.6.0-mc1.21.8" = _xW5KpKHm;
        "pkg-v1.6.1-mc1.21.8" = _sFX9NXZ8;
        "pkg-v1.6.1-mc1.21.10" = _H2sqnVh3;
        "pkg-v1.6.1-mc1.21.11" = _B6r3XqAs;
        "pkg-v1.6.1-mc26.1.1" = _1n3SvaxO;
        "pkg-v1.7.0-mc1.21.10" = _2FWJ2ew9;
        "pkg-v1.7.0-mc1.21.11" = _16ErHlGK;
        "pkg-v1.7.0-mc26.1.1" = _YLIqbjlP;
        "pkg-v1.7.0-mc1.21.8" = _8c5IW0P6;
        "pkg-v1.7.1-mc1.21.3" = _IYpvbwXY;
        "pkg-v1.7.1-mc1.21.1" = _ok5A3yTh;
        "pkg-v1.7.1-mc1.21.4" = _VDOg4AqP;
        "pkg-v1.7.1-mc1.21.5" = _z12cBLuh;
        "pkg-v1.7.1-mc1.21.8" = _xQ49pfsE;
        "pkg-v1.7.1-mc1.21.10" = _LU6vzQwT;
        "pkg-v1.7.1-mc26.1.2" = _I5oPCoVU;
        "pkg-v1.7.1-mc26.2-snapshot-2" = _mGkZmP8h;
        "pkg-v1.7.1-mc1.21.11" = _PpyQttD2;
        "pkg-v1.8.0-mc1.21.4" = _DjIxeWTi;
        "pkg-v1.8.0-mc1.21.1" = _qwqDVhX1;
        "pkg-v1.8.0-mc1.21.5" = _Q5HmoEt5;
        "pkg-v1.8.0-mc1.21.8" = _y3qw3vQ0;
        "pkg-v1.8.0-mc1.21.3" = _UW8DOZ9v;
        "pkg-v1.8.0-mc1.21.10" = _N3M2R0D4;
        "pkg-v1.8.0-mc1.21.11" = _JHxkooXF;
        "pkg-v1.8.0-mc26.2-snapshot-3" = _fx7YWSCB;
        "pkg-v1.8.0-mc26.1.2" = _fT4ejOmh;
        "pkg-v1.8.1-mc1.21.4" = _tOTTZdKg;
        "pkg-v1.8.1-mc1.21.5" = _930QAPrl;
        "pkg-v1.8.1-mc1.21.1" = _scQcplSl;
        "pkg-v1.8.1-mc1.21.3" = _LlWd9Jri;
        "pkg-v1.8.1-mc1.21.10" = _H6dSsjjL;
        "pkg-v1.8.1-mc1.21.8" = _jM2TzX15;
        "pkg-v1.8.1-mc1.21.11" = _cRMmp1Rj;
        "pkg-v1.8.1-mc26.2-snapshot-3" = _DQXnDoci;
        "pkg-v1.8.1-mc26.1.2" = _9isOpGsv;
        "pkg-v1.8.2-mc1.21.3" = _Kh53VdP1;
        "pkg-v1.8.2-mc1.21.4" = _ncLJkhA9;
        "pkg-v1.8.2-mc1.21.5" = _mvEQJHrO;
        "pkg-v1.8.2-mc1.21.1" = _rAbtyLEX;
        "pkg-v1.8.2-mc1.21.8" = _LYPzEMjf;
        "pkg-v1.8.2-mc1.21.10" = _oFBe9GX8;
        "pkg-v1.8.2-mc1.21.11" = _1Y2Urjt4;
        "pkg-v1.8.2-mc26.2-snapshot-3" = _ArBnBkfR;
        "pkg-v1.8.2-mc26.1.2" = _sCbk8X9I;
        "pkg-v1.8.3-mc1.21.4" = _qppBgNpv;
        "pkg-v1.8.3-mc1.21.5" = _HehVfTbX;
        "pkg-v1.8.3-mc1.21.3" = _Q4aNfSbp;
        "pkg-v1.8.3-mc1.21.1" = _xYxWCM3b;
        "pkg-v1.8.3-mc1.21.10" = _L8rXN6Xw;
        "pkg-v1.8.3-mc1.21.8" = _trLjL30M;
        "pkg-v1.8.3-mc1.21.11" = _Nxc9OZI3;
        "pkg-v1.8.3-mc26.2-snapshot-3" = _JYgkKHJL;
        "pkg-v1.8.3-mc26.1.2" = _eDaXhi8H;
        "pkg-v1.8.4-mc1.21.1" = _zafAeJ0z;
        "pkg-v1.8.4-mc1.21.5" = _AVD0ZGlj;
        "pkg-v1.8.4-mc1.21.4" = _si9PYi6D;
        "pkg-v1.8.4-mc1.21.3" = _fnFq5abv;
        "pkg-v1.8.4-mc1.21.10" = _dYkxEV0n;
        "pkg-v1.8.4-mc26.1.2" = _uVag5Fyj;
        "pkg-v1.8.4-mc1.21.11" = _nVtzKFLi;
        "pkg-v1.8.4-mc1.21.8" = _F0n0ex4L;
        "pkg-v1.8.4-mc26.2-snapshot-4" = _8lPpsXAk;
        "pkg-v1.8.5-mc1.21.1" = _Zg0WgDhd;
        "pkg-v1.8.5-mc1.21.3" = _FGnXSDMa;
        "pkg-v1.8.5-mc1.21.4" = _qYS9xmsx;
        "pkg-v1.8.5-mc1.21.5" = _lPunvt8G;
        "pkg-v1.8.5-mc1.21.8" = _NZK3WY1m;
        "pkg-v1.8.5-mc26.1.2" = _1CzRwNQm;
        "pkg-v1.8.5-mc26.2-snapshot-4" = _tzjAlqNE;
        "pkg-v1.8.5-mc1.21.11" = _Fei7dL7e;
        "pkg-v1.8.5-mc1.21.10" = _9eslbGTk;
        "pkg-v1.9.0-mc1.21.4" = _bmop9ydb;
        "pkg-v1.9.0-mc1.21.1" = _lQ351xG1;
        "pkg-v1.9.0-mc1.21.5" = _3nk3BkHe;
        "pkg-v1.9.0-mc1.21.3" = _1IAJwUJu;
        "pkg-v1.9.0-mc26.1.2" = _IkIxNb7C;
        "pkg-v1.9.0-mc1.21.10" = _Me9gW3sl;
        "pkg-v1.9.0-mc1.21.8" = _neU5p853;
        "pkg-v1.9.0-mc1.21.11" = _fVbOkesB;
        "pkg-v1.9.0-mc26.2-snapshot-4" = _avhsPwv9;
        "pkg-v1.9.1-mc1.21.5" = _hKqESjh8;
        "pkg-v1.9.1-mc1.21.1" = _Q7egAeRu;
        "pkg-v1.9.1-mc1.21.3" = _RMY2WFxF;
        "pkg-v1.9.1-mc1.21.4" = _oXrT2u14;
        "pkg-v1.9.1-mc1.21.8" = _GjkXM9Xa;
        "pkg-v1.9.1-mc1.21.10" = _4TzusgMb;
        "pkg-v1.9.1-mc1.21.11" = _JkRT0d1m;
        "pkg-v1.9.1-mc26.1.2" = _pBxLTBjA;
        "pkg-v1.9.1-mc26.2-snapshot-4" = _G20Koci9;
        "pkg-v1.9.2-mc1.21.3" = _6WjR6qBN;
        "pkg-v1.9.2-mc1.21.1" = _dt9H4bi7;
        "pkg-v1.9.2-mc1.21.4" = _oksyGH93;
        "pkg-v1.9.2-mc1.21.5" = _ldUj3kCJ;
        "pkg-v1.9.2-mc1.21.8" = _IW88vWX7;
        "pkg-v1.9.2-mc26.1.2" = _XlKjD2TH;
        "pkg-v1.9.2-mc1.21.11" = _vRTMZtRx;
        "pkg-v1.9.2-mc1.21.10" = _kUuLZ98R;
        "pkg-v1.10.0-mc1.21.1" = _Vd6uDXJV;
        "pkg-v1.10.0-mc1.21.5" = _CqD7IKdu;
        "pkg-v1.10.0-mc1.21.3" = _pwGsRmss;
        "pkg-v1.10.0-mc1.21.4" = _huowZcnj;
        "pkg-v1.10.0-mc1.21.8" = _g7EVhGFW;
        "pkg-v1.10.0-mc1.21.11" = _ELEKdwrM;
        "pkg-v1.10.0-mc1.21.10" = _Y3bZ0YM3;
        "pkg-v1.10.0-mc26.1.2" = _zPcjneTV;
        "pkg-v1.10.0-mc26.2-snapshot-4" = _79farEFJ;
        "pkg-v1.10.1-mc1.21.4" = _TroJByjD;
        "pkg-v1.10.1-mc1.21.5" = _BB1v3ppC;
        "pkg-v1.10.1-mc1.21.3" = _mr04T2Pd;
        "pkg-v1.10.1-mc1.21.1" = _ayH6AGME;
        "pkg-v1.10.1-mc1.21.10" = _QFNQ2MhV;
        "pkg-v1.10.1-mc1.21.8" = _V9xbVUt8;
        "pkg-v1.10.1-mc1.21.11" = _Otn4P8UZ;
        "pkg-v1.10.1-mc26.1.2" = _9ZXGZsTP;
        "pkg-v1.10.1-mc26.2-snapshot-4" = _UV5gUgA2;
        "pkg-v1.10.2-mc1.21.3" = _NvcGeCGC;
        "pkg-v1.10.2-mc1.21.5" = _8SmPGgA6;
        "pkg-v1.10.2-mc1.21.1" = _xsb9NQy4;
        "pkg-v1.10.2-mc1.21.4" = _MLKOp9kL;
        "pkg-v1.10.2-mc1.21.10" = _DMu2y35U;
        "pkg-v1.10.2-mc26.1.2" = _nB5AT6rD;
        "pkg-v1.10.2-mc1.21.11" = _AzFgdf2E;
        "pkg-v1.10.2-mc1.21.8" = _RwexlIb0;
        "pkg-v1.10.2-mc26.2-snapshot-4" = _BePBnxI2;
        "pkg-v1.11.0-mc1.21.5" = _apw2yGuS;
        "pkg-v1.11.0-mc1.21.4" = _5TKTDXxI;
        "pkg-v1.11.0-mc1.21.1" = _ivGPZTyw;
        "pkg-v1.11.0-mc1.21.3" = _gi7BqDRo;
        "pkg-v1.11.0-mc1.21.8" = _NAun4QgC;
        "pkg-v1.11.0-mc1.21.10" = _3ljDboPU;
        "pkg-v1.11.0-mc1.21.11" = _MsC1pWQd;
        "pkg-v1.11.0-mc26.1.2" = _k6DE3mMS;
        "pkg-v1.11.0-mc26.2-snapshot-4" = _jaxYuO53;
        "pkg-v1.11.1-mc1.21.5" = _fYogcrge;
        "pkg-v1.11.1-mc1.21.4" = _MMHzEe7B;
        "pkg-v1.11.1-mc1.21.3" = _OMNxxt2V;
        "pkg-v1.11.1-mc1.21.1" = _JPHjgMdG;
        "pkg-v1.11.1-mc1.21.8" = _NBuH2ZbC;
        "pkg-v1.11.1-mc1.21.10" = _2hDwrMXo;
        "pkg-v1.11.1-mc26.1.2" = _SbBBE5cl;
        "pkg-v1.11.1-mc1.21.11" = _Eit8LF5Z;
        "pkg-v1.11.1-mc26.2-snapshot-4" = _UWa65nLy;
        "pkg-v1.11.2-mc1.21.3" = _WfGRszU1;
        "pkg-v1.11.2-mc1.21.1" = _iAYBctcH;
        "pkg-v1.11.2-mc1.21.5" = _NcKo1EIx;
        "pkg-v1.11.2-mc1.21.4" = _wqFtMCeb;
        "pkg-v1.11.2-mc26.1.2" = _HNNq5DzT;
        "pkg-v1.11.2-mc1.21.8" = _I8ADCmRJ;
        "pkg-v1.11.2-mc1.21.11" = _QumyybBW;
        "pkg-v1.11.2-mc1.21.10" = _fD5yh762;
        "pkg-v1.11.2-mc26.2-snapshot-4" = _jVYOgXx1;
        "pkg-v1.12.0-mc1.21.3" = _RuT430QP;
        "pkg-v1.12.0-mc1.21.4" = _4HN0unyG;
        "pkg-v1.12.0-mc1.21.1" = _7t7wj3Yv;
        "pkg-v1.12.0-mc1.21.5" = _6V5ODVq7;
        "pkg-v1.12.0-mc1.21.8" = _Sa46FMV9;
        "pkg-v1.12.0-mc1.21.10" = _o8x33GNt;
        "pkg-v1.12.0-mc1.21.11" = _AoXGU5Er;
        "pkg-v1.12.0-mc26.1.2" = _EtcoJG6z;
        "pkg-v1.12.0-mc26.2-snapshot-4" = _1ZpyvEDV;
        "pkg-v1.12.1-mc1.21.1" = _7yIH1dBD;
        "pkg-v1.12.1-mc1.21.3" = _r3phmZXa;
        "pkg-v1.12.1-mc1.21.4" = _UNkF4bs7;
        "pkg-v1.12.1-mc1.21.5" = _5w2XwBU8;
        "pkg-v1.12.1-mc1.21.10" = _oXpGvgGI;
        "pkg-v1.12.1-mc26.1.2" = _92TeIY7D;
        "pkg-v1.12.1-mc1.21.11" = _LX8IsVQd;
        "pkg-v1.12.1-mc1.21.8" = _C78zDXaX;
        "pkg-v1.12.1-mc26.2-snapshot-4" = _a1JryUKl;
        "pkg-v1.12.2-mc1.21.1" = _uRItA2U4;
        "pkg-v1.12.2-mc1.21.4" = _oFnQr7he;
        "pkg-v1.12.2-mc1.21.5" = _qHG6ud17;
        "pkg-v1.12.2-mc1.21.3" = _eY2L9U6M;
        "pkg-v1.12.2-mc1.21.8" = _Z5NyotuX;
        "pkg-v1.12.2-mc1.21.10" = _gPW9PI06;
        "pkg-v1.12.2-mc1.21.11" = _mvxr6uiu;
        "pkg-v1.12.2-mc26.1.2" = _FtvabRZp;
        "pkg-v1.12.2-mc26.2-snapshot-4" = _wGosuI5A;
        "pkg-v1.13.0-mc1.21.1" = _Vlj8pZ8d;
        "pkg-v1.13.0-mc1.21.3" = _MPssK6Tf;
        "pkg-v1.13.0-mc1.21.4" = _Rn12Uoia;
        "pkg-v1.13.0-mc1.21.5" = _QsVVTZUM;
        "pkg-v1.13.0-mc1.21.10" = _exWoRV5r;
        "pkg-v1.13.0-mc1.21.8" = _KtYWuICA;
        "pkg-v1.13.0-mc1.21.11" = _hM11VtwM;
        "pkg-v1.13.0-mc26.1.2" = _xBpNbDtX;
        "pkg-v1.13.0-mc26.2-snapshot-4" = _aQGgyknx;
        "pkg-v1.13.1-mc1.21.3" = _nprLUGOn;
        "pkg-v1.13.1-mc1.21.1" = _Mw9wpXh1;
        "pkg-v1.13.1-mc1.21.5" = _Z5CcjOzl;
        "pkg-v1.13.1-mc1.21.4" = _adhw20fg;
        "pkg-v1.13.1-mc1.21.8" = _rQh6lNBh;
        "pkg-v1.13.1-mc1.21.11" = _B1ijtqSn;
        "pkg-v1.13.1-mc1.21.10" = _RH2KSI0R;
        "pkg-v1.13.1-mc26.1.2" = _omh41yE1;
        "pkg-v1.13.1-mc26.2-snapshot-4" = _P33UPuND;
        "pkg-v1.14.0-mc1.21.4" = _sxNxuJ64;
        "pkg-v1.14.0-mc1.21.5" = _7xpIyJst;
        "pkg-v1.14.0-mc1.21.1" = _lAMrjkP6;
        "pkg-v1.14.0-mc1.21.3" = _wAPRKp6f;
        "pkg-v1.14.0-mc1.21.10" = _XjnUTSkP;
        "pkg-v1.14.0-mc1.21.11" = _3gYbZ5TT;
        "pkg-v1.14.0-mc26.1.2" = _jLxC4Aj4;
        "pkg-v1.14.0-mc1.21.8" = _gJDVBRwZ;
        "pkg-v1.14.0-mc26.2-snapshot-4" = _BlBysWfU;
        "pkg-v1.14.1-mc1.21.1" = _6kgyFNX9;
        "pkg-v1.14.1-mc1.21.4" = _U4Ocmvz7;
        "pkg-v1.14.1-mc1.21.5" = _tq8GYmLi;
        "pkg-v1.14.1-mc1.21.3" = _z2CAla6g;
        "pkg-v1.14.1-mc1.21.8" = _A48ZW9IY;
        "pkg-v1.14.1-mc1.21.11" = _428bGK7Y;
        "pkg-v1.14.1-mc26.1.2" = _bqr0ETUY;
        "pkg-v1.14.1-mc1.21.10" = _K1bXt2Uk;
        "pkg-v1.14.1-mc26.2-rc-2" = _vhrJOHGs;
        "pkg-v1.15.0-mc1.21.5" = _seUXtF1K;
        "pkg-v1.15.0-mc1.21.1" = _NeNrz4xH;
        "pkg-v1.15.0-mc1.21.4" = _Nm3rYzk1;
        "pkg-v1.15.0-mc1.21.3" = _Za5aO7U3;
        "pkg-v1.15.0-mc1.21.10" = _aIcDYBij;
        "pkg-v1.15.0-mc1.21.8" = _rKoMTCa3;
        "pkg-v1.15.0-mc1.21.11" = _2qvHMmCA;
        "pkg-v1.15.0-mc26.1.2" = _wlXGsIHv;
        "pkg-v1.15.0-mc26.2" = _Mgp5gYCZ;
        "default" = _Mgp5gYCZ;
    });
