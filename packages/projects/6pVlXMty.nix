...
let
    ...
    in {
        ...
        "pkg-1.0.5" = _Gjpl0XU5;
        "pkg-1.0.6" = _4Z240eyj;
        "pkg-1.0.7+1.21" = _FfSsW4Ob;
        "pkg-1.0.8+1.21" = _8V9L8lsG;
        "pkg-1.0.9+1.21" = _PnIxfZIp;
        "pkg-1.0.10+1.21" = _GnDEUKsA;
        "pkg-1.0.10+1.20.1" = _2mehTqCN;
        "pkg-1.0.11+1.20.1" = _b2p60f4K;
        "pkg-1.0.11+1.21" = _7iQRlapD;
        "pkg-1.0.12+1.20.1" = _8fdNqDoL;
        "pkg-1.0.13+1.20.1" = _ZiYC48Eb;
        "pkg-1.0.12+1.21.1" = _qQxA6O27;
        "pkg-2.0.0" = _Es23iLbC;
        "pkg-2.0.1" = _yAl2dMcE;
        "pkg-2.0.2" = _5PZsVN80;
        "pkg-2.0.3" = _LgNvFRhP;
        "pkg-2.1.0+1.21.10" = _8nTASdfE;
        "pkg-2.0.4" = _aiPi5Det;
        "pkg-2.1.1" = _u3jn0aJh;
        "pkg-2.1.2" = _fnyqvgOC;
        "pkg-2.1.3" = _AeJGNYCY;
        "pkg-2.1.4+1.21.11" = _y0qd6Kla;
        "pkg-2.1.5+1.21.11" = _c42Eg4Nx;
        "pkg-2.0.5+1.21.1" = _AutBtJSd;
        "pkg-2.1.6+1.21.11" = _kXapgAO0;
        "pkg-2.0.6+1.21.1" = _3Ji0UTaT;
        "pkg-2.2.0+26.1.x" = _ijZgErnI;
        "pkg-2.2.1+26.1.x" = _sPNkptsh;
        "pkg-2.2.2+26.1.x" = _HjZ7LgcL;
        "default" = _HjZ7LgcL;
    });
