...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.4-forge" = _NF1FcAxe;
        "pkg-1.18.2-1.6-forge" = _K3I6ae59;
        "pkg-1.19.2-1.7-forge" = _lOUDU89z;
        "pkg-1.19.3-1.7-forge" = _IUEFyuub;
        "pkg-1.18.2-2.0-forge+fabric" = _ZevBh40H;
        "pkg-1.19.2-2.0-forge+fabric" = _fNEisHt4;
        "pkg-1.19.3-2.0-forge+fabric" = _VLSUx2W1;
        "pkg-1.18.2-2.1-forge+fabric" = _oAOtJaVl;
        "pkg-1.19.2-2.1-forge+fabric" = _c9AWqqFZ;
        "pkg-1.19.3-2.1-forge+fabric" = _1XSWdcvg;
        "pkg-1.18.2-2.2-forge+fabric" = _YGjZOBBt;
        "pkg-1.19.2-2.2-forge+fabric" = _SRxr1lOe;
        "pkg-1.19.3-2.2-forge+fabric" = _qtOixbZV;
        "pkg-1.19.4-2.2-forge+fabric" = _9ZuHqA69;
        "pkg-1.20-2.2-forge+fabric" = _xmNUr6gJ;
        "pkg-1.20.1-2.2-forge+fabric" = _H2Xs71dd;
        "pkg-1.18.2-2.3-forge+fabric" = _zcPOd5og;
        "pkg-1.19.2-2.3-forge+fabric" = _HfUlG720;
        "pkg-1.19.4-2.3-forge+fabric" = _fN0AM5qq;
        "pkg-1.20.1-2.3-forge+fabric" = _NabARDdx;
        "pkg-1.20.2-2.3-forge+fabric" = _OMqwgnNm;
        "pkg-1.18.2-2.4-forge+fabric" = _ELdz8sz3;
        "pkg-1.19.2-2.4-forge+fabric" = _ciaK6zU3;
        "pkg-1.20.1-2.4-forge+fabric" = _ymRbWVCv;
        "pkg-1.20.2-2.4-forge+fabric" = _rQIOvUzG;
        "pkg-1.20.2-2.5-forge+fabric" = _c1wgAN7n;
        "pkg-1.20.3-2.5-fabric+forge+neo" = _gvYbpLYE;
        "pkg-1.20.4-2.5-fabric+forge+neo" = _71ydYyEy;
        "pkg-1.19.2-2.6-fabric+forge+neo" = _X7yERsc3;
        "pkg-1.20.1-2.6-fabric+forge+neo" = _B8ddnLZY;
        "pkg-1.20.2-2.6-fabric+forge+neo" = _qwhyyRqk;
        "pkg-1.20.4-2.6-fabric+forge+neo" = _y1By0j4o;
        "pkg-1.19.2-2.7-fabric+forge+neo" = _KRW7SyYA;
        "pkg-1.20.1-2.7-fabric+forge+neo" = _kkhAR1ib;
        "pkg-1.20.2-2.7-fabric+forge+neo" = _MsE7BZON;
        "pkg-1.20.4-2.7-fabric+forge+neo" = _gcg5oATN;
        "pkg-1.20.5-2.7-fabric+neo" = _DrxmmSHQ;
        "pkg-1.20.5-2.8-fabric+neo" = _doGjpitL;
        "pkg-1.20.6-2.8-fabric+forge+neo" = _wy0JL9HG;
        "pkg-1.21.0-2.8-fabric+forge+neo" = _XrY25rhF;
        "pkg-1.20.1-2.9-fabric+forge+neo" = _R53TaS8m;
        "pkg-1.20.6-2.9-fabric+forge+neo" = _Wsz4ZYfU;
        "pkg-1.21.0-2.9-fabric+forge+neo" = _Rcvrm1n2;
        "pkg-1.21.1-2.9-fabric+forge+neo" = _W9F80lKW;
        "pkg-1.21.2-2.9-fabric+neo" = _2RsNrPwf;
        "pkg-1.21.3-2.9-fabric+forge+neo" = _MhRBpoyI;
        "pkg-1.21.4-2.9-fabric+forge+neo" = _VWuXb7mw;
        "pkg-1.21.5-2.9-fabric+forge+neo" = _k0b70Sy7;
        "pkg-1.21.6-2.9-fabric+forge+neo" = _dlS6a1Mb;
        "pkg-1.21.7-2.9-fabric+forge+neo" = _Hmv3jtit;
        "pkg-1.21.8-2.9-fabric+forge+neo" = _kQfxWQDc;
