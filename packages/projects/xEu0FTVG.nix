...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge" = _EHSp3kYv;
        "pkg-1.0.0-fabric" = _qRQMQAMH;
        "pkg-2.0.0-forge-1.18.2" = _RJmTe9Ct;
        "pkg-2.0.0-fabric-1.18.2" = _4tMxFtYO;
        "pkg-2.0.0-forge-1.19.2" = _MOAerwcG;
        "pkg-2.0.0-fabric-1.19.2" = _qHVTM4Ke;
        "pkg-2.0.0-forge-1.20.1" = _rkue97AH;
        "pkg-2.0.0-fabric-1.20.1" = _elm1Dk46;
        "pkg-2.1.0-forge-1.18.2" = _UJrlfIOM;
        "pkg-2.1.0-fabric-1.18.2" = _GeZCwE7k;
        "pkg-2.1.0-forge-1.19.2" = _1Cyl8lX3;
        "pkg-2.1.0-fabric-1.19.2" = _39OC7Etr;
        "pkg-2.1.0-forge-1.20.1" = _eqMHFIFL;
        "pkg-2.1.0-fabric-1.20.1" = _AI7JseRW;
        "pkg-2.2.0-forge-1.18.2" = _zBrJu6vS;
        "pkg-2.2.0-fabric-1.18.2" = _a69VSHBd;
        "pkg-2.2.0-forge-1.19.2" = _THp6AdZB;
        "pkg-2.2.0-fabric-1.19.2" = _7Wc1hVyd;
        "pkg-2.2.0-forge-1.20.1" = _HZTbx3r3;
        "pkg-2.2.0-fabric-1.20.1" = _bPcvcsD0;
        "pkg-2.2.1-forge-1.18.2" = _Erv5hmkv;
        "pkg-2.2.1-fabric-1.18.2" = _Gfr6TRVr;
        "pkg-2.2.1-forge-1.19.2" = _n1RURY8q;
        "pkg-2.2.1-fabric-1.19.2" = _G9xwNBy6;
        "pkg-2.2.1-forge-1.20.2" = _EcwbBDOW;
        "pkg-2.2.1-fabric-1.20.2" = _TuVAWlla;
        "pkg-2.2.1-forge-1.20.4" = _XbP7Cip9;
        "pkg-2.2.1-fabric-1.20.4" = _ZUQziFie;
        "pkg-2.3.0-forge-1.18.2" = _aj9Inlch;
        "pkg-2.3.0-fabric-1.18.2" = _iovDYYVP;
        "pkg-2.3.0-forge-1.19.2" = _oKdY7gTc;
        "pkg-2.3.0-fabric-1.19.2" = _OLqTmbnp;
        "pkg-2.3.0-forge-1.20.4" = _VTPwZsA9;
        "pkg-2.3.0-fabric-1.20.4" = _gQ3P9F3t;
        "pkg-2.4.0-forge-1.18.2" = _opSQlCjj;
        "pkg-2.4.0-fabric-1.18.2" = _8ewmjatR;
        "pkg-2.4.0-forge-1.19.2" = _W2N7jwBk;
        "pkg-2.4.0-fabric-1.19.2" = _tmpO5L8f;
        "pkg-2.4.0-forge-1.20.4" = _Vc3AcUb6;
        "pkg-2.4.0-fabric-1.20.4" = _8DvYXnfm;
        "pkg-2.5.0-forge-1.20.4" = _T92ZXqZU;
        "pkg-2.5.0-fabric-1.20.4" = _bkTM4Hzh;
        "pkg-2.5.0-forge-1.21.1" = _GX1y7Y9M;
        "pkg-2.5.0-fabric-1.21.1" = _uNQ4QP38;
        "pkg-2.5.0-forge-1.21.4" = _69BwefV8;
        "pkg-2.5.0-fabric-1.21.4" = _4CVDoA8H;
        "pkg-2.6.0-forge-1.20.4" = _h5OQibnN;
        "pkg-2.6.0-fabric-1.20.4" = _6HzV26zj;
        "pkg-2.6.0-forge-1.21.1" = _DDaxB87G;
        "pkg-2.6.0-fabric-1.21.1" = _ExWN8clV;
        "pkg-2.6.0-neoforge-1.21.4" = _nRKLk3sb;
        "pkg-2.6.0-fabric-1.21.4" = _Odr7jUif;
        "pkg-2.6.1-neoforge-1.21.1" = _dydDWiau;
        "pkg-2.6.1-fabric-1.21.1" = _Tl6k9oo4;
        "pkg-2.6.1-neoforge-1.21.4" = _DkBb5TES;
        "pkg-2.6.1-fabric-1.21.4" = _HEsjjriq;
        "default" = _HEsjjriq;
    });
