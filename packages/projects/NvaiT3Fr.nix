...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.5-55.1.4" = _1vdWcSGO;
        "pkg-1.0.0-forge-1.21.8-58.1.11" = _5qSF9Ghc;
        "pkg-1.0.0-forge-1.21.10-60.1.0" = _zG9YXHUq;
        "pkg-1.0.0-forge-1.21.11-1.0.0" = _chJmhXql;
        "pkg-1.0.0-neoforge-1.21.1-21.1.219" = _xpZ6BIIW;
        "pkg-1.0.0-neoforge-1.21.4-21.4.156" = _6DgLOFN8;
        "pkg-1.0.0-neoforge-1.21.5-21.5.96" = _Hf8G9Prl;
        "pkg-1.0.0-neoforge-1.21.8-21.8.52" = _5tAK8UvW;
        "pkg-1.0.0-neoforge-1.21.10-21.10.64" = _tYgl52Cj;
        "pkg-1.0.0-neoforge-1.21.11-21.11.38" = _7TncFxED;
        "pkg-1.0.1-fabric-1.21.11-0.141.3" = _xruP7HjL;
        "pkg-1.0.1-fabric-1.21.10-0.138.4" = _J4ePMYg9;
        "pkg-1.0.1-fabric-1.21.8-0.136.1" = _7sQ4D8Uf;
        "pkg-1.0.1-fabric-1.21.5-0.128.2" = _VDdVjqwX;
        "pkg-1.0.1-fabric-1.21.4-0.119.4" = _DcMVV87D;
        "pkg-1.0.1-fabric-1.21.1-0.116.8" = _xihDx3d5;
        "pkg-1.0.1-fabric-1.20.1-0.92.7" = _1OT61gms;
        "pkg-1.0.1-fabric-26.1.1-0.145.3" = _sCkeeAwH;
        "pkg-1.0.1-forge-26.1.1-63.0.0" = _3qewh9Nu;
        "pkg-1.0.1-neoforge-26.1.1.1" = _6PaYumu9;
