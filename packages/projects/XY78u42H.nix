...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.18.1" = _VDUBon7T;
        "pkg-1.0.1-1.18.2" = _9UHp30uw;
        "pkg-1.0.1-1.19.4" = _jNQEzpjW;
        "pkg-1.0.1-1.20.2" = _pV0pRYPL;
        "pkg-1.0.3+mc1.20.2" = _gmW5XyiE;
        "pkg-1.0.3+mc1.20.3" = _DbIe0IE6;
        "pkg-1.0.3+mc1.20.4" = _9HTItfyW;
        "pkg-1.0.0" = _UgB0aloN;
        "pkg-1.0.4+mc1.20.4" = _5EVcbCKR;
        "pkg-1.0.4+mc1.20.5" = _qqBlbJEE;
        "pkg-1.0.4+mc1.20.6" = _Vu2VV0VM;
        "pkg-1.0.4+mc1.21" = _b8vuKhkn;
        "pkg-1.0.4+mc1.21.1" = _Ju29TTbG;
        "pkg-1.0.4+mc1.21.2" = _Lvg1C65i;
        "pkg-1.0.4+mc1.21.3" = _tqGyI4EG;
        "pkg-1.0.4+mc1.21.4" = _hZtvnBbA;
        "pkg-1.1.0+mc1.21.4" = _obYhfYHk;
        "pkg-1.1.1+mc1.21.5" = _mhPgmAWO;
        "pkg-1.1.2+neo+mc1.21.4" = _Sz2v56G5;
        "pkg-1.1.2+neo+mc1.21.5" = _6qRMrYGH;
        "pkg-1.1.3+neo+mc1.21.5" = _f02VSqHk;
        "pkg-1.1.3+fabric+mc1.21.5" = _LNs5CoXg;
        "pkg-1.1.3+fabric+mc1.21.6" = _G5K5IMJ8;
        "pkg-1.1.3+neo+mc1.21.6" = _82b15yK7;
        "pkg-1.1.3+fabric+mc1.21.7" = _Qs90WDFB;
        "pkg-1.1.3+neo+mc1.21.7" = _oBpoAteh;
        "pkg-1.1.3+fabric+mc1.21.8" = _EoUux0jf;
        "pkg-1.1.3+neo+mc1.21.8" = _BDlI2Q6i;
        "pkg-1.1.3+fabric+mc1.21.9" = _qOznqHQD;
        "pkg-1.1.3+neo+mc1.21.9" = _fQdCwBZF;
        "pkg-1.1.3+fabric+mc1.21.10" = _ny8CwJIz;
        "pkg-1.1.3+neo+mc1.21.10" = _w18vc1K9;
        "pkg-1.1.4+neo+mc1.21.9" = _DYoUy8jn;
        "pkg-1.1.3+fabric+mc1.21.11" = _uOWLA67G;
        "pkg-1.1.4+neo+mc1.21.11" = _FsoONghT;
        "pkg-1.1.5+fabric+mc1.21.11" = _uSGUzUds;
        "pkg-1.1.5+neo+mc1.21.11" = _7EQc6SJt;
        "pkg-1.1.6+fabric+mc1.21.11" = _VlR88tvX;
        "pkg-1.1.6+neo+mc1.21.11" = _VIGqB2Cs;
        "pkg-1.1.7+fabric+mc26.1.1" = _W3POAtWw;
        "pkg-1.1.7+neo+mc26.1.1" = _vcVbQvS1;
        "pkg-1.1.8+fabric+mc26.1.1" = _y1GRGXib;
        "pkg-1.1.8+fabric+mc26.1.2" = _7NShAFOF;
        "pkg-1.1.8+fabric+mc26.2" = _U3hoQW4N;
        "pkg-1.1.8+neo+mc26.1.1" = _paRA9VWx;
        "pkg-1.1.8+neo+mc26.1.2" = _fSAfHTQN;
        "pkg-1.1.8+neo+mc26.2" = _RfbdOUSJ;
        "default" = _RfbdOUSJ;
    });
