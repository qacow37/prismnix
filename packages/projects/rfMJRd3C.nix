...
let
    ...
    in {
        ...
        "pkg-0.0.1+1.20.6" = _b5UouyDs;
        "pkg-0.0.2+1.20.6" = _SQqoJmdr;
        "pkg-0.0.3+1.20.6" = _xtakEOmr;
        "pkg-0.0.3+1.21.1" = _nJKVQph6;
        "pkg-0.0.4+1.20.6" = _xV4PsxhF;
        "pkg-0.0.4+1.21.1" = _SPn3K8PS;
        "pkg-0.0.4+1.21.3" = _fnPu1VQX;
        "pkg-0.0.5+1.21.3" = _VwSuJRbQ;
        "pkg-0.0.6+1.21.3" = _L8GG4IrP;
        "pkg-0.0.6+1.21.1" = _WOSpfbv7;
        "pkg-0.0.6+1.20.6" = _ITxvOWVn;
        "pkg-0.0.7+1.20.6" = _4aieukdI;
        "pkg-0.0.7+1.21.1" = _26LJjM1c;
        "pkg-0.0.7+1.21.3" = _yl4YeCV9;
        "pkg-0.1.0+1.20.6" = _ZAhCmpCM;
        "pkg-0.1.0+1.21.1" = _H1ZKrZmk;
        "pkg-0.1.0+1.21.3" = _rRtTnCHE;
        "pkg-0.1.1+1.20.6" = _a4a2TwWW;
        "pkg-0.1.1+1.21.1" = _xtyoUuNn;
        "pkg-0.1.1+1.21.3" = _oovt9gNE;
        "pkg-0.1.2+1.20.6" = _fKvYPoDh;
        "pkg-0.1.2+1.21.1" = _ufREl8uE;
        "pkg-0.1.2+1.21.3" = _qdHRTpOF;
        "pkg-0.1.3+1.20.6" = _50VQHN4m;
        "pkg-0.1.3+1.21.1" = _i9xZqnrY;
        "pkg-0.1.3+1.21.3" = _FnZkBB6S;
        "pkg-0.1.4+1.20.6" = _YwsXz4Gt;
        "pkg-0.1.4+1.21.1" = _nIbZtpCR;
        "pkg-0.2.0+1.20.4" = _rEtp8Mbo;
        "pkg-0.2.0+1.20.6" = _m9TKPj6S;
        "pkg-0.2.0+1.21.1" = _p3D9MdCt;
        "pkg-0.2.0+1.21.3" = _IgAvTUan;
        "pkg-0.2.0+1.21.4" = _LlIb2Wh0;
        "pkg-0.2.0+1.21.5" = _H081flAx;
        "default" = _H081flAx;
    });
