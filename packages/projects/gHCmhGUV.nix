...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _OIU2E9ix;
        "pkg-1.18.2-2.0-fabric" = _PRwEtZxX;
        "pkg-1.19.2-2.2-fabric" = _FbS0T6iW;
        "pkg-1.16.5-1.5-forge" = _13x6626r;
        "pkg-1.18.2-1.7-forge" = _gzLm4wmj;
        "pkg-1.19.2-1.9-forge" = _8FVNZtnE;
        "pkg-1.16.5-2.3-fabric" = _cM9Nt88U;
        "pkg-1.18.2-2.3-fabric" = _uJnctkCj;
        "pkg-1.19.2-2.3-fabric" = _YVBxwMCN;
        "pkg-1.19.3-2.4-fabric" = _77x05MP7;
        "pkg-1.19.3-1.9-forge" = _MtIMoJ0y;
        "pkg-1.18.2-3.0-forge+fabric" = _p24vgVSc;
        "pkg-1.19.2-3.0-forge+fabric" = _RHizrcNz;
        "pkg-1.19.3-3.0-forge+fabric" = _k1Nu6ELd;
        "pkg-1.18.2-3.1-forge+fabric" = _DAEoD2Uh;
        "pkg-1.19.2-3.1-forge+fabric" = _VbfOZ2yL;
        "pkg-1.19.3-3.1-forge+fabric" = _nsVCTCmU;
        "pkg-1.19.3-3.2-forge+fabric" = _srfpBKZv;
        "pkg-1.18.2-3.3-forge+fabric" = _nqPt9FlZ;
        "pkg-1.19.2-3.3-forge+fabric" = _ERTUUYNs;
        "pkg-1.19.3-3.3-forge+fabric" = _w5dnxtci;
        "pkg-1.18.2-3.4-forge+fabric" = _ybTSs7rA;
        "pkg-1.19.2-3.4-forge+fabric" = _9eaL12i6;
        "pkg-1.19.3-3.4-forge+fabric" = _jKSLgXJf;
        "pkg-1.18.2-3.5-forge+fabric" = _bo6FwWHT;
        "pkg-1.19.2-3.5-forge+fabric" = _JRmQJmeT;
        "pkg-1.19.3-3.5-forge+fabric" = _CjFYcZDr;
        "pkg-1.19.4-3.5-forge+fabric" = _ODAESdoQ;
        "pkg-1.20-3.5-forge+fabric" = _qyykPTr4;
        "pkg-1.20.1-3.5-forge+fabric" = _vbnBT4Ea;
        "pkg-1.20.2-3.5-forge+fabric" = _NbLba1Jq;
        "pkg-1.18.2-3.6-forge+fabric" = _Dg1r8GwI;
        "pkg-1.19.2-3.6-forge+fabric" = _ctl8AGPL;
        "pkg-1.20.1-3.6-forge+fabric" = _A4wCUgDN;
        "pkg-1.20.2-3.6-forge+fabric" = _RvvtFjkV;
        "pkg-1.20.3-3.6-fabric+forge+neo" = _BmIxPcJG;
        "pkg-1.20.4-3.6-fabric+forge+neo" = _wSTBPr1s;
        "pkg-1.19.2-3.7-fabric+forge+neo" = _D3LU9a1F;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _AnIhYUVX;
        "pkg-1.20.2-3.7-fabric+forge+neo" = _HrJruvL1;
        "pkg-1.20.4-3.7-fabric+forge+neo" = _IQ06EaD3;
        "pkg-1.20.5-3.7-fabric+neo" = _rjrcoOlH;
        "pkg-1.20.5-3.8-fabric+neo" = _fzbvTHxL;
        "pkg-1.20.6-3.8-fabric+forge+neo" = _WGk6Yjon;
        "pkg-1.21.0-3.8-fabric+forge+neo" = _WL8aq3Lo;
        "pkg-1.20.1-3.9-fabric+forge+neo" = _SGVxphAV;
        "pkg-1.20.6-3.9-fabric+forge+neo" = _AOTzXocN;
        "pkg-1.21.0-3.9-fabric+forge+neo" = _hHBnqHGx;
        "pkg-1.20.1-4.0-fabric+forge+neo" = _hI3yBP6x;
        "pkg-1.20.6-4.0-fabric+forge+neo" = _ulvZbHJz;
        "pkg-1.21.0-4.0-fabric+forge+neo" = _7yZgXUKq;
        "pkg-1.21.1-4.0-fabric+forge+neo" = _8SOK7tp4;
        "pkg-1.21.2-4.0-fabric+neo" = _Ok1L03DP;
        "pkg-1.21.3-4.0-fabric+forge+neo" = _UMk7HOch;
        "pkg-1.21.4-4.0-fabric+forge+neo" = _zOTjpFOV;
        "pkg-1.20.1-4.1-fabric+forge+neo" = _PGGBTZmK;
        "pkg-1.21.1-4.1-fabric+forge+neo" = _zkxWsh1p;
        "pkg-1.21.4-4.1-fabric+forge+neo" = _W4fpnvF4;
        "pkg-1.21.5-4.1-fabric+forge+neo" = _qEmkUZpT;
        "pkg-1.21.6-4.1-fabric+forge+neo" = _UvsATQnO;
        "pkg-1.21.6-4.2-fabric+forge+neo" = _65UcPUJJ;
        "pkg-1.21.7-4.2-fabric+forge+neo" = _mlTGjqqt;
        "pkg-1.21.8-4.2-fabric+forge+neo" = _S0RRJmJH;
        "pkg-1.21.9-4.2-fabric+forge+neo" = _LWtFmbAh;
        "pkg-1.21.10-4.2-fabric+forge+neo" = _DG5G9e9k;
        "pkg-1.21.11-4.2-fabric+forge+neo" = _UxqGoIcn;
        "pkg-26.1.0-4.2-fabric+forge+neo" = _eV7uo35h;
        "pkg-26.1.1-4.2-fabric+forge+neo" = _tMQa8c3r;
        "pkg-26.1.2-4.2-fabric+forge+neo" = _9q3MuhjN;
        "pkg-26.2.0-4.2-fabric+forge+neo" = _uC9iday5;
        "default" = _uC9iday5;
    });
