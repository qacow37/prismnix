...
let
    ...
    in {
        ...
        "pkg-1.18.1-1.5.1" = _Fua3pqIE;
        "pkg-1.18.2-1.6.0" = _C9NYJWIT;
        "pkg-1.17.1-1.5.1" = _pVMgSg7B;
        "pkg-1.16.5-1.5.1" = _hHD4SZb4;
        "pkg-1.19-1.6.0" = _oFoWyVgr;
        "pkg-1.19-1.6.1" = _cpFH68kM;
        "pkg-1.19.2-1.6.2-Forge" = _iheZzRD3;
        "pkg-1.19.2-1.6.2-Fabric" = _iMHe8NLU;
        "pkg-1.19.2-1.6.3-Fabric" = _hSeyDLoU;
        "pkg-1.19.2-1.6.3-Forge" = _VILTsiCr;
        "pkg-1.19.3-1.6.4-Fabric" = _TGuek42A;
        "pkg-1.19.3-1.6.4-Forge" = _VWPHqiba;
        "pkg-1.19.4-1.6.4-Fabric" = _5fUhWl3D;
        "pkg-1.19.4-1.6.4-Forge" = _aDBf62L5;
        "pkg-1.20.1-1.6.4-Fabric" = _HyuM0YCO;
        "pkg-1.20.1-1.6.4-Forge" = _pdK76789;
        "pkg-1.20.4-1.6.4-Fabric" = _tBAAKy89;
        "pkg-1.20.4-1.6.4-Neoforge" = _FO8ul9ge;
        "pkg-1.20.4-1.6.4-Forge" = _r0vZrW4W;
        "pkg-1.12.2-1.7.0-Forge" = _zfNZfg0M;
        "pkg-1.12.2-1.7.1-Forge" = _8uoyqCr2;
        "pkg-1.14.4-1.7.1-Forge" = _X3RqHu3J;
        "pkg-1.15.2-1.7.1-Forge" = _FWckhpJZ;
        "pkg-1.16.5-1.7.1-Forge" = _mduUGKsV;
        "pkg-1.17.1-1.7.1-Forge" = _QFdNUbqb;
        "pkg-1.18.2-1.7.1-Forge" = _KWcVLbL5;
        "pkg-1.19.4-1.7.1-Fabric" = _Wxk7NAdI;
        "pkg-1.19.4-1.7.1-Forge" = _cc0Q6fQW;
        "pkg-1.20.4-1.7.1-NeoForge" = _7LpitXFq;
        "pkg-1.20.4-1.7.1-Fabric" = _1dIDWaAr;
        "pkg-1.20.4-1.7.1-Forge" = _3WxXuJLQ;
        "pkg-1.20.6-1.7.1-NeoForge" = _VwVGOVY9;
        "pkg-1.20.6-1.7.1-Fabric" = _HV5j6Mrn;
        "pkg-1.20.6-1.7.1-Forge" = _mmBq9ojE;
        "pkg-1.21.4-1.8.0-NeoForge" = _4oTMMZg0;
        "pkg-1.21.4-1.8.0-Fabric" = _h734T6vp;
        "pkg-1.21.4-1.8.0-Forge" = _jmc0tIe0;
        "pkg-1.21.6-1.8.0-NeoForge" = _XmRa58z5;
        "pkg-1.21.6-1.8.0-Fabric" = _YXkRHmke;
        "pkg-1.21.6-1.8.0-Forge" = _IuVtRMaV;
        "pkg-1.21.7-1.8.0-NeoForge" = _Ve2QulR7;
        "pkg-1.21.7-1.8.0-Fabric" = _m2n5A7D4;
        "pkg-1.21.7-1.8.0-Forge" = _nh93mM0h;
        "pkg-1.21.8-1.8.0-NeoForge" = _cXS5JUpC;
        "pkg-1.21.8-1.8.0-Fabric" = _U5YFl0CW;
        "pkg-1.21.8-1.8.0-Forge" = _CifRijWB;
        "pkg-1.21.10-1.8.0-NeoForge" = _C88ubReT;
        "pkg-1.21.10-1.8.0-Fabric" = _xSR9mNaA;
        "pkg-1.21.10-1.8.0-Forge" = _1ZV5kcWB;
        "default" = _1ZV5kcWB;
    });
