...
let
    ...
    in {
        ...
        "pkg-1.2.1" = _yMTet2fj;
        "pkg-1.3.0" = _j07UnIoo;
        "pkg-1.4.0-alpha0001+biometestvanilla" = _4JnvN6dn;
        "pkg-1.4.0-alpha0002+antiidconflict-and-galacticraft" = _3sjqabgv;
        "pkg-1.4.0-alpha0004+bop-and-atg" = _a1Q0LS0d;
        "pkg-1.4.0-alpha0005+hotfix" = _pOI5JOBj;
        "pkg-1.4.0-alpha0006+biomesdone" = _Yw5fOWvI;
        "pkg-1.4.0-alpha0007" = _rRJhbf2N;
        "pkg-1.4.0-alpha0008" = _duCqbC6d;
        "pkg-1.4.0-alpha0009" = _tnQAG03M;
        "pkg-1.4.0-alpha0010" = _mxkRVllC;
        "pkg-1.4.0-alpha0011" = _4biqmIro;
        "pkg-1.4.0-alpha0012-hotfix1" = _Qu5qUNtu;
        "pkg-1.4.0-beta0001" = _g2hmVTcL;
        "pkg-1.4.0-beta0002" = _1HKggfRF;
        "pkg-1.4.0-beta0002-hotfix1" = _aRt4SBQL;
        "pkg-1.4.0-beta0003" = _h9XLyr0q;
        "pkg-1.4.0" = _YiX8OWjn;
        "pkg-1.4.1" = _hWmTJUKs;
        "pkg-1.5-alpha0001" = _Ylvsn2ki;
        "pkg-1.5-alpha0002" = _cAFVAwuU;
        "pkg-1.5-alpha0003" = _wsixANKv;
        "pkg-1.5-alpha0004" = _3ah1Tnok;
        "pkg-1.5-alpha0005" = _P7KRTpgG;
        "pkg-1.5-alpha0006" = _tQzPolQA;
        "pkg-1.5-alpha0007" = _UIUT9SEO;
        "pkg-1.5-a0008-hf1" = _9Kiiyek3;
        "pkg-1.5-a0008-hf2" = _IPWUYwLK;
        "pkg-1.5-alpha0009" = _65hEQBcb;
        "pkg-1.5-beta0001" = _WtPQO3gO;
        "pkg-1.5-beta0002" = _ibHMW42K;
        "pkg-1.5-beta0003" = _IQXdpzqD;
        "pkg-1.5.0" = _rYYBJhnZ;
        "pkg-1.5.1" = _fF0rkPRZ;
        "pkg-1.5.2" = _ujAucqWo;
        "pkg-1.5.3" = _nVxyGxcf;
        ...
        "pkg-1.6.8" = _BcBBJplG;
        "pkg-1.6.9" = _hw7cWjPf;
        "pkg-1.6.10" = _l467KFoI;
        "pkg-1.6.11" = _Wju6VmBu;
        "pkg-1.6.12" = _5aul2Jsm;
        "pkg-1.6.13" = _fhei1SEl;
        "pkg-1.6.14" = _au6uthmG;
        "pkg-1.7.0" = _qSOdBikC;
        "pkg-1.7.1" = _ui2eH5SR;
        "pkg-1.7.2" = _ElDPd7Jk;
        "pkg-1.7.3" = _VbAYrfPC;
