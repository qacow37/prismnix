...
let
    ...
    in {
        ...
        "pkg-0.2.0" = _ngqHeqH3;
        "pkg-0.2.1" = _LF13fQbC;
        "pkg-mc1.19.4-v0.3.0" = _O7HoccqC;
        "pkg-mc1.20.1-v0.3.0" = _ITbNEM6h;
        "pkg-mc1.20.2-v0.3.0" = _NqLIzszp;
        "pkg-mc1.20.2-v0.4.0" = _Bqy7iCWi;
        "pkg-mc1.19.4-v0.4.0" = _TATM5KwI;
        "pkg-mc1.20.1-v0.4.0" = _OJjz0ZFC;
        "pkg-mc1.19.4-v0.4.1" = _j6ktH6NU;
        "pkg-mc1.20.1-v0.4.1" = _dkT99P2k;
        "pkg-mc1.20.2-v0.4.1" = _S23B17cQ;
        "pkg-mc1.20.1-v1.0.0" = _xSIMNNsM;
        "pkg-mc1.19.4-v1.0.0" = _Ra4c6SGa;
        "pkg-mc1.20.2-v1.0.0" = _HqldQJcO;
        "pkg-mc1.20.1-v1.0.1" = _k0AApvOP;
        "pkg-mc1.20.2-v1.0.1" = _Ejwkqy1r;
        "pkg-mc1.19.4-v1.0.1" = _F1jm7eXC;
        "pkg-mc1.20.4-rc1-v1.0.1" = _suZwX7L3;
        "pkg-mc1.20.2-v1.0.2" = _nnZoMYqc;
        "pkg-mc1.20.4-v1.0.2" = _FH4vEhh8;
        "pkg-mc1.20.1-v1.0.2" = _6fzfT7Cf;
        "pkg-mc1.19.4-v1.0.2" = _3bTW6FNo;
        "pkg-1.1.0+1.20.1" = _DSwGtEfE;
        "pkg-1.1.0+1.20.2" = _1gQj2O9q;
        "pkg-1.1.0+1.19.4" = _zF0K3L0x;
        "pkg-1.1.0+1.20.4" = _bnJANULQ;
        "pkg-1.1.1+1.19.4" = _mgf9kkw7;
        "pkg-1.1.1+1.20.2" = _lSyxcSKT;
        "pkg-1.1.1+1.20.1" = _tiTTfjK3;
        "pkg-1.1.1+1.20.4" = _sFVyhhNg;
        "pkg-1.1.2+1.19.4" = _iGPpNp47;
        "pkg-1.1.2+1.20.4" = _AE8BO4ww;
        "pkg-1.1.2+1.20.2" = _F8KRviiu;
        "pkg-1.1.2+1.20.1" = _X1mJWgFR;
        "pkg-1.1.3+1.19.4" = _cdh9PBdT;
        "pkg-1.1.3+1.20.4" = _hihMoyLO;
        "pkg-1.1.3+1.20.1" = _l2GLGVoP;
        "pkg-1.1.3+1.20.2" = _w518ScnR;
        "pkg-1.1.5+1.20.6" = _UvoIPGM4;
        "pkg-1.2.0+1.21" = _QQmu814N;
        "pkg-1.2.1+1.21" = _DPRH6Fuz;
        "pkg-1.2.2+1.21.1" = _88d7LCxi;
        "default" = _88d7LCxi;
    });
