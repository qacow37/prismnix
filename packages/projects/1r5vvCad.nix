...
let
    ...
    in {
        ...
        "pkg-1.20.2-1.0-forge+fabric" = _jR36MNka;
        "pkg-1.18.2-1.1-forge+fabric" = _3zdGl5Xj;
        "pkg-1.19.2-1.1-forge+fabric" = _zCOwiuvm;
        "pkg-1.20.1-1.1-forge+fabric" = _FbEhqPZs;
        "pkg-1.20.2-1.1-forge+fabric" = _bJAodvK5;
        "pkg-1.18.2-1.2-forge+fabric" = _3Tte3v4j;
        "pkg-1.19.2-1.2-forge+fabric" = _MbohGWEy;
        "pkg-1.20.1-1.2-forge+fabric" = _dThw7sEw;
        "pkg-1.20.2-1.2-forge+fabric" = _Es7FecbY;
        "pkg-1.18.2-1.3-forge+fabric" = _HaufhCNW;
        "pkg-1.19.2-1.3-forge+fabric" = _CwY85nGs;
        "pkg-1.20.1-1.3-forge+fabric" = _Z0h6WcsY;
        "pkg-1.20.2-1.3-forge+fabric" = _v42Zs7Is;
        "pkg-1.20.2-1.4-forge+fabric" = _sr7GhGdU;
        "pkg-1.19.2-1.5-fabric+forge+neo" = _yChvX0J7;
        "pkg-1.20.1-1.5-fabric+forge+neo" = _RjgkftL1;
        "pkg-1.20.2-1.5-fabric+forge+neo" = _Pvo2qevf;
        "pkg-1.20.3-1.5-fabric+forge+neo" = _S67pwouy;
        "pkg-1.20.4-1.5-fabric+forge+neo" = _pYLDMqCm;
        "pkg-1.19.2-1.6-fabric+forge+neo" = _u2ay6rG8;
        "pkg-1.20.1-1.6-fabric+forge+neo" = _Xtn46r6T;
        "pkg-1.20.2-1.6-fabric+forge+neo" = _7Bx0expr;
        "pkg-1.20.4-1.6-fabric+forge+neo" = _cvtmKDen;
        "pkg-1.19.2-1.7-fabric+forge" = _acgeEYAr;
        "pkg-1.20.1-1.7-fabric+forge+neo" = _xGx1Urvx;
        "pkg-1.20.2-1.7-fabric+forge+neo" = _UTtBeCZu;
        "pkg-1.20.4-1.7-fabric+forge+neo" = _IwkzvqXK;
        "pkg-1.20.5-1.7-fabric+neo" = _OLku96Q1;
        "pkg-1.20.5-1.8-fabric+neo" = _UW6ywnnF;
        "pkg-1.20.6-1.8-fabric+forge+neo" = _lUy3vDBO;
        "pkg-1.21.0-1.8-fabric+forge+neo" = _du9Z6raJ;
        "pkg-1.20.1-1.9-fabric+forge+neo" = _rVAEUK5J;
        "pkg-1.20.6-1.9-fabric+forge+neo" = _HV3My9Rd;
        "pkg-1.21.0-1.9-fabric+forge+neo" = _E8orVVWo;
        "pkg-1.20.1-2.0-fabric+forge+neo" = _cE0nrb3J;
        "pkg-1.20.6-2.0-fabric+forge+neo" = _kecTQdkj;
        "pkg-1.21.0-2.0-fabric+forge+neo" = _ZXajkWdj;
        "pkg-1.21.1-2.0-fabric+forge+neo" = _Gb88VteC;
        "pkg-1.21.2-2.0-fabric+neo" = _nHGluznQ;
        "pkg-1.21.3-2.0-fabric+forge+neo" = _1eL1fc2E;
        "pkg-1.21.4-2.0-fabric+forge+neo" = _1pWk53kk;
        "pkg-1.20.1-2.1-fabric+forge+neo" = _QcOJuorE;
        "pkg-1.21.1-2.1-fabric+forge+neo" = _cfWBChDy;
        "pkg-1.21.4-2.1-fabric+forge+neo" = _HqlEIlj5;
        "pkg-1.21.5-2.1-fabric+forge+neo" = _hPnT3UIY;
        "pkg-1.21.6-2.1-fabric+forge+neo" = _XQguhf7J;
        "pkg-1.21.7-2.1-fabric+forge+neo" = _TlfIjDE1;
        "pkg-1.21.8-2.1-fabric+forge+neo" = _ue9Yh3hb;
        "pkg-1.21.9-2.1-fabric+forge+neo" = _vv48ZJM8;
        "pkg-1.21.10-2.1-fabric+forge+neo" = _yvyeMiVw;
        "pkg-1.21.11-2.1-fabric+forge+neo" = _H3O91Y6J;
        "pkg-26.1.0-2.1-fabric+forge+neo" = _TGxRyd80;
        "pkg-26.1.0-2.2-fabric+forge+neo" = _pUOYfv67;
