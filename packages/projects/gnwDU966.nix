...
let
    ...
    in {
        ...
        "pkg-4.89" = _bMJUCvWX;
        "pkg-4.891" = _r0LqcQzq;
        "pkg-4.8911" = _WOCthZSW;
        "pkg-4.89112" = _vfNFlKvz;
        "pkg-4.891123" = _whZXsdpN;
        "pkg-4.891124" = _qoW7hAc3;
        "pkg-4.89113" = _HhgPFbvN;
        "pkg-4.8912" = _SlZeBGom;
        "pkg-4.8913" = _oE2EpBQv;
        "pkg-4.8914" = _1jCe7vS8;
        "pkg-4.8915" = _ICDVee0g;
        "pkg-4.8942" = _F1xsF5RX;
        "pkg-4.89666" = _smeWEe1S;
        "pkg-4.89667" = _EoCaZyXe;
        "pkg-4.89999" = _ey77e2w6;
        "pkg-4.899999" = _QuQtESJs;
        "pkg-4.8999999c" = _RFZgsptS;
        "pkg-4.89999999" = _hjGi3VWd;
        "pkg-4.89PHILLIP" = _QSyKywwF;
        "pkg-4.9M" = _epguR7nW;
        "pkg-4.99999A0CbM" = _WiUrHtI0;
        "pkg-4.99999A0DM" = _ehjWYWD3;
        "pkg-4.99999A0EbM" = _7wITOq01;
        "pkg-4.99999A0FbM" = _AP6dlSAd;
        "pkg-4.AD" = _uQCu9iwt;
        "pkg-4.A1HC" = _Va43V0lR;
        "pkg-4.A2TRb" = _qBctpr9I;
        "pkg-4.A3HB" = _snBGUnVA;
        "pkg-4.A4KB" = _BOFv9LpZ;
        "pkg-4.A5PP" = _fz0Ym1tT;
        "pkg-4.A6SS" = _YIhIL14b;
        "pkg-4.A7SAS" = _kBKJwgGN;
        "pkg-4.A8MAT" = _JYl5Ko3a;
        "pkg-4.A9PLb" = _b6ORoPZE;
        "pkg-4.AAAAAAAAAAHHHHeeeeeeeeee" = _DKstP0nR;
        "pkg-4.AAAAAAABBB" = _9RLyHaJT;
        "pkg-4.AAABBBA" = _u9GFJGV4;
        "pkg-4.AABABABA" = _Y5hqivRm;
        "pkg-4.AABBBbbbbbb" = _EystEmrC;
        "pkg-4.AACK" = _qRo9rbrF;
        "pkg-4.AAHHHHHHhhhhhh" = _Or6I7ghE;
        "pkg-4.AB4B" = _mDCqS4Jp;
        "pkg-4.ABBBBURNBABYBURNAHAHAHAHAHAb" = _Bst8eJHg;
        "pkg-4.ABCDEFPc" = _V3ll91yz;
        "pkg-4.ABCEEEEE" = _cZQvLv9m;
        "pkg-4.ABCEEEEF" = _Xn7r0t4D;
        "pkg-4.ABCEEEFAb" = _LnqNeAKr;
        "pkg-4.ABCEEFABc" = _Lmy32nP4;
        "pkg-4.4.ABCFDPDb" = _VlzjJmgY;
        "pkg-4.ABCFAFAFAb" = _mZAblBJm;
        "pkg-4.ABCFAFBFC" = _lJ3wqLbb;
        "pkg-4.ABCFEFEe" = _7XheD2Fm;
        "pkg-4.AFFFFFFFd" = _2Gr64kav;
        "pkg-4.B00b" = _8QmBY93Z;
        "pkg-4.B0000001b" = _DVyQMIOf;
        "pkg-4.B0000002" = _niTE1WcG;
        "pkg-4.B0000003" = _Tt1vF8u3;
        "default" = _Tt1vF8u3;
    });
