...
let
    ...
    in {
        ...
        "pkg-1.12.2" = _rvIRt4mz;
        "pkg-1.13.0" = _8sh3tTa5;
        "pkg-1.13.1-forge" = _Gwf8cwDF;
        "pkg-1.14.0-forge" = _UPAslOyc;
        "pkg-1.14.0-fabric" = _2WKCbuZE;
        "pkg-1.14.1-fabric" = _7IqMGvHj;
        "pkg-1.14.1-forge" = _2pwiL2TQ;
        "pkg-2.0.0-fabric" = _383nJzeN;
        "pkg-2.1.0-fabric" = _99EyBvCq;
        "pkg-2.1.1-fabric" = _553zlUtR;
        "pkg-2.1.2-fabric" = _4RfmRbUE;
        "pkg-2.1.3-fabric" = _uzDB33Kd;
        "pkg-2.1.4" = _IngkxAua;
        "pkg-2.1.5" = _PMcVhh7K;
        "pkg-1.14.2-fabric" = _7CvioQCT;
        "pkg-2.2.0-fabric" = _3gGVHSPk;
        "pkg-2.2.0-forge" = _jocY10P5;
        "pkg-2.3.0-fabric" = _WG33KUPR;
        "pkg-2.3.0-forge" = _BKSq19tp;
        "pkg-2.3.1-fabric" = _bciIHcBm;
        "pkg-3.0.0-rc.1-fabric" = _VbrAthlY;
        "pkg-3.0.0-fabric" = _Ndi42e3c;
        "pkg-3.0.0-forge" = _t9VFXWNG;
        "pkg-3.1.0-fabric" = _2K9FTOV5;
        "pkg-3.1.0-forge" = _rBM3GcWE;
        "pkg-3.2.0-fabric" = _uiwt5onG;
        "pkg-3.2.0-forge" = _cTe5YvYo;
        "pkg-3.3.0-fabric" = _h89F6BBN;
        "pkg-3.3.0-forge" = _zoInuRAp;
        "pkg-3.3.1-fabric" = _VyILUVlk;
        "pkg-3.3.1-forge" = _dH8xTSgO;
        "pkg-3.4.0-fabric" = _lwoxDIta;
        "pkg-3.4.0-forge" = _HjjhPSx9;
        "pkg-3.4.heart-fabric" = _UyHPXrWK;
        "pkg-1.14.3-forge" = _b0oPwH4h;
        "pkg-3.5.0-fabric" = _6N5U8wzl;
        "pkg-3.5.0-forge" = _6knpxJnp;
        "pkg-3.5.1-fabric" = _7a1r0Rer;
        "pkg-3.5.1-forge" = _cwn9kRFA;
        "pkg-3.5.2-fabric" = _dQVrWzdZ;
        "pkg-3.5.2-forge" = _mCRuvFoE;
        "pkg-3.5.3-fabric" = _mtq3Zw9I;
        "pkg-3.5.4-forge" = _UxOzO4Br;
        "pkg-3.5.4-fabric" = _79Xs1SLJ;
        "pkg-3.6.0-forge" = _lc8sYvos;
        "pkg-3.6.0-fabric" = _29z5H9g0;
        "pkg-3.6.1-forge" = _fOGhb31J;
        "pkg-3.6.1-fabric" = _45LD5USO;
        "pkg-3.7.0-forge" = _Hx0Ekh1c;
        "pkg-3.7.0-fabric" = _w75vVdsH;
        "pkg-3.8.0-forge" = _FPOYuTLe;
        "pkg-3.8.0-fabric" = _EoQErNld;
        "pkg-3.8.1-fabric" = _E0HCy6sV;
        "pkg-3.8.1-forge" = _lYSclF7q;
        "pkg-4.0.0-forge" = _T5VlltjZ;
        "pkg-4.0.0-fabric" = _FOiK0Cja;
        "pkg-4.0.1-forge" = _9eZjcLJ4;
        "pkg-4.0.1-fabric" = _678daGDK;
        "pkg-3.8.2-fabric" = _hIgE4jl7;
        "pkg-3.8.2-forge" = _V8eVUHAF;
        "pkg-4.1.0-fabric" = _ixKoKZM9;
        "pkg-4.1.0-forge" = _36hRh67O;
        "pkg-4.2.0-or-fabric" = _yzxXmre0;
        "pkg-3.8.3-fabric" = _qgNP6oDb;
        "pkg-3.8.3-forge" = _TlG46lVG;
        "pkg-4.1.1-fabric" = _FmYnXMSp;
        "pkg-4.1.1-forge" = _vlqX58Xh;
        "pkg-4.2.0-fabric" = _etfAlZVu;
        "pkg-4.2.0-forge" = _vFIZArQa;
        "pkg-3.9.0-fabric" = _roZ7W6JF;
        "pkg-3.9.0-forge" = _t50WnNob;
        "pkg-3.9.1-fabric" = _4Af8VkZs;
        "pkg-3.9.1-forge" = _DIlg7tt2;
        "pkg-4.3.0-fabric" = _3NPeFBhu;
        "pkg-4.3.0-forge" = _7vyW4EmZ;
        "pkg-5.0.0-fabric" = _HXibuobl;
        "pkg-5.0.0-forge" = _1gIaqVd1;
        "pkg-5.1.0-fabric" = _KTfJVYwj;
        "pkg-5.2.0-fabric" = _jQZSOH31;
        "pkg-5.0.1-fabric" = _67OSh58o;
        "pkg-5.0.1-forge" = _crm4v5Vc;
        "pkg-5.3.0-fabric" = _hZiNFh15;
        "pkg-5.3.0-neoforge" = _Uk5XJvV6;
        "pkg-6.0.0-fabric" = _iL4gBcjA;
        "pkg-6.0.0-neoforge" = _mmsaJjzI;
        "pkg-6.0.1-fabric" = _uF2u0C0O;
        "pkg-6.0.1-neoforge" = _MG4Ds320;
        "pkg-7.0.0-c-fabric" = _MG9o0jzX;
        "pkg-7.0.0-fabric" = _cUVr8yDs;
        "pkg-7.0.0-neoforge" = _6tTJVMXu;
        "pkg-7.0.1-fabric" = _pHn0Uy7U;
        "pkg-7.0.1-neoforge" = _hYsWSi23;
        "pkg-6.0.2-fabric" = _NVgPyiHS;
        "pkg-6.0.2-neoforge" = _Cp4Ra70x;
        "pkg-6.0.3-fabric" = _wsf8mJFn;
        "pkg-6.0.3-neoforge" = _yTnNRwA0;
        "pkg-7.0.2-fabric" = _qU9ssSfr;
        "pkg-7.0.2-neoforge" = _OOLrKlR0;
        "pkg-6.1.0-fabric" = _y25OJevv;
        "pkg-6.1.0-neoforge" = _s0LBuHoc;
        "pkg-7.1.0-fabric" = _pDGQQONs;
        "pkg-7.1.0-neoforge" = _nbZEyTJa;
        "pkg-6.1.1-fabric" = _eNfTmN5a;
        "pkg-6.1.1-neoforge" = _Gd5qxHt7;
        "pkg-7.1.1-fabric" = _d3LENErZ;
        "pkg-7.1.1-neoforge" = _tzbuJCq8;
        "pkg-7.2.0-fabric" = _40xWzlwf;
        "pkg-7.2.0-neoforge" = _rWjpQu3L;
        "pkg-6.1.2-fabric" = _eOTfiVsw;
        "pkg-6.1.2-neoforge" = _n7mQbgXg;
        "pkg-7.2.1+1.21.8-fabric" = _p6bBmEYO;
        "pkg-7.2.1+1.21.8-neoforge" = _8CXua2XP;
        "pkg-7.2.1-fabric" = _gS4jrF5C;
        "pkg-7.2.1-neoforge" = _X3OhXiWk;
        "pkg-7.3.1-fabric" = _SABfdLJK;
        "pkg-7.3.1-neoforge" = _cU418Rgf;
        "pkg-7.4.0-fabric" = _PzPua57i;
        "pkg-7.4.0-neoforge" = _PIFytArz;
        "pkg-7.5.0-fabric" = _eW0xhYRM;
        "pkg-7.5.0-neoforge" = _sV6ij7TV;
        "pkg-6.1.3-fabric" = _3yXb5kwa;
        "pkg-6.1.3-neoforge" = _DyOuL4lv;
        "pkg-6.1.4-fabric" = _GqfLWLs3;
        "pkg-6.1.4-neoforge" = _qiSpWQKr;
        "pkg-7.4.1-fabric" = _59AMhjQl;
        "pkg-7.4.1-neoforge" = _G5TBwHjT;
        "pkg-6.2.0-fabric" = _BIevXXZ2;
        "pkg-6.2.0-neoforge" = _9rHgmZTU;
        "pkg-7.4.2-fabric" = _QjlrC0X8;
        "pkg-7.4.2-neoforge" = _gWZpFi71;
        "pkg-6.3.0-fabric" = _bHGRP1JJ;
        "pkg-6.3.0-neoforge" = _iIwDTJeB;
        "pkg-7.6.0-fabric" = _MwMpNgec;
        "pkg-7.6.0-neoforge" = _fWGDuwai;
        "pkg-6.3.1-fabric" = _kxeS10s2;
        "pkg-6.3.1-neoforge" = _QbzMhTAO;
        "pkg-7.6.1-fabric" = _tyOUUBLZ;
        "pkg-7.6.1-neoforge" = _G6IxYA4z;
        "pkg-8.0.0-fabric" = _cnNQTddq;
        "pkg-8.0.0-neoforge" = _wj0Rz7R5;
        "pkg-9.0.0-fabric" = _OmRBvMca;
        "pkg-9.0.0-neoforge" = _S8nvVHAc;
        "default" = _S8nvVHAc;
    });
