...
let
    ...
    in {
        ...
        "pkg-v4.0.0-1.19-Forge" = _G9u47YRO;
        "pkg-v4.1.0-1.19.1-Forge" = _qmlcUv5U;
        "pkg-v4.1.1-1.19.1-Forge" = _4XAK1Tfg;
        "pkg-v4.2.0-1.19.2-Forge" = _f8iZf2Mc;
        "pkg-v4.2.1-1.19.2-Forge" = _mx4Ie6P6;
        "pkg-v5.0.0-1.19.3-Forge" = _lxr3Vxao;
        "pkg-v6.0.0-1.19.4-Forge" = _9q1PD9nO;
        "pkg-v7.0.0-1.20-Forge" = _eZTutajr;
        "pkg-v3.2.4-1.18.2-Forge" = _Q8WB6DXG;
        "pkg-v4.2.2-1.19.2-Forge" = _7cBlN049;
        "pkg-v8.0.0-1.20.1-Forge" = _LSEFxsl5;
        "pkg-v8.0.1-1.20.1-Forge" = _I5lgByN3;
        "pkg-v4.2.4-1.19.2-Forge" = _XJQlBJYK;
        "pkg-v8.0.2-1.20.1-Forge" = _bSoVaTgS;
        "pkg-v20.4.0-1.20.4-Forge" = _GUTxpChz;
        "pkg-v20.4.0-1.20.4-NeoForge" = _Od6xmslE;
        "pkg-v21.0.0-1.21-NeoForge" = _a7LtbTqx;
        "pkg-v21.0.1-1.21-Forge" = _7Y5UqTQO;
        "pkg-v21.0.1-1.21-NeoForge" = _E4CEOkfu;
        "pkg-v21.0.2-1.21-Forge" = _5jEZocbm;
        "pkg-v21.0.2-1.21-NeoForge" = _eqSZDZmC;
        "pkg-v21.1.0-1.21.1-Forge" = _rNUCxWuG;
        "pkg-v21.1.0-1.21.1-NeoForge" = _Yqmy3U2b;
        "pkg-v21.3.0-1.21.3-Forge" = _Se8C6ZPT;
        "pkg-v21.3.0-1.21.3-NeoForge" = _4PKSqyVG;
        "pkg-v21.4.0-1.21.4-Forge" = _wvzoTd8W;
        "pkg-v21.4.0-1.21.4-NeoForge" = _Ozo2uZTQ;
        "pkg-v21.4.1-1.21.4-NeoForge" = _lmczB61Y;
        "pkg-v21.5.0-1.21.5-NeoForge" = _aMp5JbyG;
        "pkg-v21.6.0-1.21.6-NeoForge" = _RH68OuwK;
        "pkg-v21.7.0-1.21.7-NeoForge" = _bK5HK0nl;
        "pkg-v21.8.0-1.21.8-NeoForge" = _VcbhTptd;
        "pkg-21.9.4" = _eE7CBkl8;
        "pkg-21.9.6" = _WceZt9ZR;
        "pkg-21.9.7" = _9DMcE9tq;
        "pkg-21.10.0" = _VC6pK1Wf;
        "pkg-21.10.1" = _KgBenKhi;
        "pkg-21.11.0" = _w3q0TdGH;
        "pkg-26.1.0" = _U8J4AbVl;
        "pkg-26.1.1" = _YgXEIfjD;
        "default" = _YgXEIfjD;
    });
