...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.1.0-forge" = _Aqqubmwf;
        "pkg-1.19.4-1.1.0-forge" = _Xa9QbmuY;
        "pkg-1.20-1.1.0-forge" = _vfbmMtdP;
        "pkg-1.16.5-1.1.0-forge" = _Npao3DPL;
        "pkg-1.17.1-1.1.0-forge" = _W7nyv7hj;
        "pkg-1.20.1-1.1.0-forge" = _tA7WLZPY;
        "pkg-1.18.2-1.1.0-fabric" = _h6ymgyUD;
        "pkg-1.19.2-1.1.0-fabric" = _9fsng1Cj;
        "pkg-1.19.4-1.1.0-fabric" = _3GLzZVE2;
        "pkg-1.20.1-1.1.0-fabric" = _GkdgxqCw;
        "pkg-1.16.5-1.1.1-forge" = _C927Q7hp;
        "pkg-1.17.1-1.1.1-forge" = _6ccKFobt;
        "pkg-1.18.2-1.1.1-forge" = _2uxZ6Zmp;
        "pkg-1.19.2-1.1.1-forge" = _k0IWcm1x;
        "pkg-1.19.4-1.1.1-forge" = _5EsFPoNr;
        "pkg-1.20.1-1.1.1-forge" = _18SyeyxV;
        "pkg-1.18.2-1.1.1-fabric" = _jQxqkI5b;
        "pkg-1.19.2-1.1.1-fabric" = _dAVIDZGX;
        "pkg-1.19.4-1.1.1-fabric" = _ZelbucYr;
        "pkg-1.20.1-1.1.1-fabric" = _YuzgkkLd;
        "pkg-1.18.2-1.1.2-fabric" = _OAMc55BN;
        "pkg-1.19.2-1.1.2-fabric" = _g4lBUiFY;
        "pkg-1.19.4-1.1.2-fabric" = _dxZkGoYj;
        "pkg-1.20.1-1.1.2-fabric" = _yiuGLqKZ;
        "pkg-1.18.2-1.2.0-forge" = _yvQMMcfk;
        "pkg-1.19.2-1.2.0-forge" = _JY4uKyF1;
        "pkg-1.19.4-1.2.0-forge" = _VOSeoGZH;
        "pkg-1.20.1-1.2.0-forge" = _NEvWqSWB;
        "pkg-1.18.2-1.2.0-fabric" = _8lc5PkEN;
        "pkg-1.19.2-1.2.0-fabric" = _F6ybuGQk;
        "pkg-1.19.4-1.2.0-fabric" = _rJpKjZYb;
        "pkg-1.20.1-1.2.0-fabric" = _VT6Oi6wz;
        "pkg-1.18.2-1.2.1-forge" = _jtjLUHH5;
        "pkg-1.19.2-1.2.1-forge" = _z2JCrrSn;
        "pkg-1.19.4-1.2.1-forge" = _NZg5k7gH;
        "pkg-1.20.1-1.2.1-forge" = _OMxuA4Eb;
        "pkg-1.18.2-1.2.1-fabric" = _dXGUKHvm;
        "pkg-1.19.2-1.2.1-fabric" = _taZiRAjs;
        "pkg-1.19.4-1.2.1-fabric" = _CBe9TE3C;
        "pkg-1.20.1-1.2.1-fabric" = _flw7pIbW;
        "pkg-1.18.2-1.2.2-forge" = _QNObtDxg;
        "pkg-1.19.2-1.2.2-forge" = _9k5MEaNy;
        "pkg-1.19.4-1.2.2-forge" = _SZPN6K9G;
        "pkg-1.20.1-1.2.2-forge" = _NeLJrCn7;
        "pkg-1.20.2-1.2.2-forge" = _82JbyK9b;
        "pkg-1.18.2-1.2.2-fabric" = _zktrRcPn;
        "pkg-1.19.2-1.2.2-fabric" = _IXmj4E56;
        "pkg-1.19.4-1.2.2-fabric" = _Vjnprimp;
        "pkg-1.20.1-1.2.2-fabric" = _mEWq6qQv;
        "pkg-1.20.2-1.2.2-fabric" = _HcPb3Hf9;
        "pkg-1.18.2-1.2.3-forge" = _n8O5cpcR;
        "pkg-1.19.2-1.2.3-forge" = _wYcWnhLr;
        "pkg-1.19.4-1.2.3-forge" = _La5lv8Rw;
        "pkg-1.20.1-1.2.3-forge" = _PVW5X8bX;
        "pkg-1.20.2-1.2.3-forge" = _bpPsXZeE;
        "pkg-1.18.2-1.2.3-fabric" = _NBLDiRiy;
        "pkg-1.19.2-1.2.3-fabric" = _2XXWPClO;
        "pkg-1.19.4-1.2.3-fabric" = _EMMbY5NX;
        "pkg-1.20.1-1.2.3-fabric" = _XUCLqtyN;
        "pkg-1.20.2-1.2.3-fabric" = _baAXRSdL;
        "pkg-1.20.2-1.2.3-neoforge" = _KcNGo3Rr;
        "pkg-1.18.2-1.2.4-fabric" = _GU8t1EoW;
        "pkg-1.18.2-1.2.4-forge" = _UDsrdkC2;
        "pkg-1.19.2-1.2.4-fabric" = _jmb4zmds;
        "pkg-1.19.2-1.2.4-forge" = _NrtrW0FL;
        "pkg-1.20.1-1.2.4-fabric" = _gwevBEr1;
        "pkg-1.20.1-1.2.4-forge" = _SVA4djOt;
        "pkg-1.20.3-1.2.4-fabric" = _LgTCzmjt;
        "pkg-1.20.3-1.2.4-forge" = _aGb5FR73;
        "pkg-1.20.3-1.2.4-neoforge" = _TV6TK21Y;
        "pkg-1.18.2-1.2.5-fabric" = _QUUaDcN6;
        "pkg-1.19.2-1.2.5-fabric" = _wLzZe2V1;
        "pkg-1.19.4-1.2.5-fabric" = _4xgv9mV8;
        "pkg-1.20.1-1.2.5-fabric" = _jXni6wnz;
        "pkg-1.20.4-1.2.5-fabric" = _H2nU8O0E;
        "pkg-1.18.2-1.2.5-forge" = _BV0PQPC5;
        "pkg-1.19.2-1.2.5-forge" = _sWnje3Oa;
        "pkg-1.19.4-1.2.5-forge" = _lD2A9N2B;
        "pkg-1.20.1-1.2.5-forge" = _8wFUNdRm;
        "pkg-1.20.4-1.2.5-forge" = _msrVR95u;
        "pkg-1.20.4-1.2.5-neoforge" = _NgHl0DXO;
        "pkg-1.18.2-1.2.6-fabric" = _mufppswQ;
        "pkg-1.19.2-1.2.6-fabric" = _TFGTu7Ys;
        "pkg-1.19.4-1.2.6-fabric" = _qnfFqkhc;
        "pkg-1.20.1-1.2.6-fabric" = _SmViEfNo;
        "pkg-1.20.4-1.2.6-fabric" = _AZItIuTz;
        "pkg-1.18.2-1.3.0-fabric" = _TOgtLbE8;
        "pkg-1.19.2-1.3.0-fabric" = _lKUd8gUc;
        "pkg-1.19.4-1.3.0-fabric" = _6ptEaGFP;
        "pkg-1.20.1-1.3.0-fabric" = _yQFRqWWC;
        "pkg-1.20.4-1.3.0-fabric" = _TeTTBCGE;
        "pkg-1.18.2-1.3.0-forge" = _Q7xMGM4n;
        "pkg-1.19.2-1.3.0-forge" = _OUBbLB9q;
        "pkg-1.19.4-1.3.0-forge" = _M6c0OZfc;
        "pkg-1.20.1-1.3.0-forge" = _BqZaEKeh;
        "pkg-1.20.4-1.3.0-forge" = _TF7h2AI8;
        "pkg-1.20.4-1.3.0-neoforge" = _r7TcVjwM;
        "pkg-1.18.2-1.3.1-fabric" = _dRBs4iIn;
        "pkg-1.19.2-1.3.1-fabric" = _PubRWcZ6;
        "pkg-1.19.4-1.3.1-fabric" = _76tbMfnz;
        "pkg-1.20.1-1.3.1-fabric" = _gNGjzyP0;
        "pkg-1.20.5-1.3.1-fabric" = _LiPQuuC1;
        "pkg-1.18.2-1.3.1-forge" = _dXIIR3mV;
        "pkg-1.19.2-1.3.1-forge" = _mDsLAk9B;
        "pkg-1.19.4-1.3.1-forge" = _K5YG1vLr;
        "pkg-1.20.1-1.3.1-forge" = _3XCO2zln;
        "pkg-1.20.5-1.3.1-neoforge" = _wWSesapP;
        "pkg-1.20.6-1.3.1-fabric" = _pVdhQlUy;
        "pkg-1.20.6-1.3.1-neoforge" = _e5Hz3zYs;
        "pkg-1.20.6-1.3.1-forge" = _fNI8KJbp;
        "pkg-1.21-1.3.1-fabric" = _I3ZsymJi;
        "pkg-1.21-1.3.1-forge" = _WrYxYYWy;
        "pkg-1.21-1.3.1-neoforge" = _iwYu8Ztq;
        "pkg-1.20.4-1.3.1-fabric" = _rBMS9XdJ;
        "pkg-1.20.4-1.3.1-forge" = _qL35yYkl;
        "pkg-1.20.4-1.3.1-neoforge" = _8TUA2bGv;
        "pkg-1.21-1.3.2-forge" = _qwpgCRla;
        "pkg-1.18.2-1.3.3-fabric" = _SPWJHDLb;
        "pkg-1.19.2-1.3.3-fabric" = _C0QWXLvU;
        "pkg-1.19.4-1.3.3-fabric" = _mhUFCs6y;
        "pkg-1.20.1-1.3.3-fabric" = _KPUw9GWS;
        "pkg-1.20.4-1.3.3-fabric" = _FbQB4ptZ;
        "pkg-1.20.6-1.3.3-fabric" = _HsmZZeVB;
        "pkg-1.21-1.3.3-fabric" = _MRiYmIf8;
        "pkg-1.18.2-1.3.3-forge" = _sKchCzJT;
        "pkg-1.19.2-1.3.3-forge" = _TPnBruV4;
        "pkg-1.19.4-1.3.3-forge" = _oTl2iRe9;
        "pkg-1.20.1-1.3.3-forge" = _nbqNmWdg;
        "pkg-1.20.4-1.3.3-forge" = _wcTU8y1s;
        "pkg-1.20.4-1.3.3-neoforge" = _QNsf0DNj;
        "pkg-1.20.6-1.3.3-forge" = _sa2VCZPU;
        "pkg-1.20.6-1.3.3-neoforge" = _kemxoSjC;
        "pkg-1.21-1.3.3-forge" = _z7eKGvhO;
        "pkg-1.21-1.3.3-neoforge" = _VU13TDNs;
        "pkg-1.18.2-1.3.4-fabric" = _HZUWME08;
        "pkg-1.18.2-1.3.4-forge" = _WDZ8WQZ6;
        "pkg-1.19.2-1.3.4-fabric" = _Zo7lkUJg;
        "pkg-1.19.2-1.3.4-forge" = _syhTtQmQ;
        "pkg-1.19.4-1.3.4-fabric" = _XBALYvLD;
        "pkg-1.19.4-1.3.4-forge" = _uB04g94X;
        "pkg-1.20.1-1.3.4-fabric" = _alYci9ME;
        "pkg-1.20.1-1.3.4-forge" = _gxN7XrX2;
        "pkg-1.20.4-1.3.4-fabric" = _dSE2dfMZ;
        "pkg-1.20.4-1.3.4-forge" = _dadLpY11;
        "pkg-1.20.4-1.3.4-neoforge" = _QaXRfLR9;
        "pkg-1.20.6-1.3.4-fabric" = _wUc512bb;
        "pkg-1.20.6-1.3.4-neoforge" = _D6VDpNRb;
        "pkg-1.21-1.3.4-fabric" = _mBWpILDj;
        "pkg-1.21-1.3.4-neoforge" = _4gsePunG;
        "pkg-1.20.6-1.3.4-forge" = _m5kUMw77;
        "pkg-1.21-1.3.4-forge" = _aI0xJ5JP;
        "pkg-1.19.2-1.3.5-fabric" = _zoXQTP4j;
        "pkg-1.19.2-1.3.5-forge" = _Q866uXLA;
        "pkg-1.19.4-1.3.5-fabric" = _yuWKtVpz;
        "pkg-1.19.4-1.3.5-forge" = _BBd5hWks;
        "pkg-1.20.1-1.3.5-fabric" = _8yKcZdx3;
        "pkg-1.20.1-1.3.5-forge" = _9uEv2GiQ;
        "pkg-1.20.4-1.3.5-fabric" = _PHPplCDu;
        "pkg-1.20.4-1.3.5-forge" = _1AGTK4Ag;
        "pkg-1.20.4-1.3.5-neoforge" = _wTsEySr9;
        "pkg-1.20.6-1.3.5-fabric" = _6dgy6kU7;
        "pkg-1.20.6-1.3.5-forge" = _f2Lg2rgP;
        "pkg-1.20.6-1.3.5-neoforge" = _W73ZoLRQ;
        "pkg-1.21.1-1.3.5-fabric" = _D2glznYX;
        "pkg-1.21.1-1.3.5-forge" = _pTJ2ZlSE;
        "pkg-1.21.1-1.3.5-neoforge" = _am9kBcOq;
        "pkg-1.18.2-1.3.5-fabric" = _Yt4kJk3U;
        "pkg-1.18.2-1.3.5-forge" = _Pe0G935e;
        "pkg-1.18.2-1.3.6-fabric" = _CkfPkFwL;
        "pkg-1.18.2-1.3.6-forge" = _vJZybTZk;
        "pkg-1.19.2-1.3.6-fabric" = _xXhRewKf;
        "pkg-1.19.2-1.3.6-forge" = _2kLqiTfd;
        "pkg-1.19.4-1.3.6-fabric" = _KRNoYiwB;
        "pkg-1.19.4-1.3.6-forge" = _eLYHQER9;
        "pkg-1.20.1-1.3.6-fabric" = _w14EUqVu;
        "pkg-1.20.1-1.3.6-forge" = _L24Uz54K;
        "pkg-1.20.4-1.3.6-fabric" = _NKuNdcC8;
        "pkg-1.20.4-1.3.6-forge" = _NpyCfgps;
        "pkg-1.20.4-1.3.6-neoforge" = _eKVOXQcJ;
        "pkg-1.20.6-1.3.6-fabric" = _RojNJm2N;
        "pkg-1.20.6-1.3.6-forge" = _5M6HDlpA;
        "pkg-1.20.6-1.3.6-neoforge" = _6Xr5YuG1;
        "pkg-1.21.1-1.3.6-fabric" = _TQPtxkSB;
        "pkg-1.21.1-1.3.6-forge" = _2haCNvi8;
        "pkg-1.21.1-1.3.6-neoforge" = _LyhHgxQR;
        "pkg-1.18.2-1.3.7-fabric" = _kxNWkVQO;
        "pkg-1.18.2-1.3.7-forge" = _q5Nzp5oo;
        "pkg-1.19.2-1.3.7-fabric" = _WWUJd5DG;
        "pkg-1.19.2-1.3.7-forge" = _bcj6WhwY;
        "pkg-1.19.4-1.3.7-fabric" = _v7Q2tewX;
        "pkg-1.19.4-1.3.7-forge" = _xDZhDEi9;
        "pkg-1.20.1-1.3.7-fabric" = _eOUsWXdM;
        "pkg-1.20.1-1.3.7-forge" = _ZFkkvyAt;
        "pkg-1.20.4-1.3.7-fabric" = _OkkL8Fx1;
        "pkg-1.20.4-1.3.7-forge" = _d8Ze7eKQ;
        "pkg-1.20.4-1.3.7-neoforge" = _LHkxj5O1;
        "pkg-1.20.6-1.3.7-fabric" = _75uApEbF;
        "pkg-1.20.6-1.3.7-forge" = _E2My9nXU;
        "pkg-1.20.6-1.3.7-neoforge" = _UJKfPLhd;
        "pkg-1.21.1-1.3.7-fabric" = _G5ydhDEV;
        "pkg-1.21.1-1.3.7-forge" = _DS21bj7j;
        "pkg-1.21.1-1.3.7-neoforge" = _8vVFKuvv;
        "pkg-1.18.2-1.3.8-fabric" = _aklVL6Pe;
        "pkg-1.18.2-1.3.8-forge" = _P6NGNxzn;
        "pkg-1.19.2-1.3.8-fabric" = _k7ImEasH;
        "pkg-1.19.2-1.3.8-forge" = _YjFnhzat;
        "pkg-1.19.4-1.3.8-fabric" = _g9zu5EOB;
        "pkg-1.19.4-1.3.8-forge" = _LRgoMZCq;
        "pkg-1.20.1-1.3.8-fabric" = _MFZCw1zq;
        "pkg-1.20.1-1.3.8-forge" = _7Kzjt4hm;
        "pkg-1.20.4-1.3.8-fabric" = _6WnjAAvD;
        "pkg-1.20.4-1.3.8-forge" = _zg3zLI9x;
        "pkg-1.20.4-1.3.8-neoforge" = _W0UeUnRs;
        "pkg-1.20.6-1.3.8-fabric" = _8WPF55My;
        "pkg-1.20.6-1.3.8-forge" = _HLLTqSZX;
        "pkg-1.20.6-1.3.8-neoforge" = _eXRUGRbg;
        "pkg-1.21.1-1.3.8-fabric" = _dDqCbuS1;
        "pkg-1.21.1-1.3.8-forge" = _hbrsflyx;
        "pkg-1.21.1-1.3.8-neoforge" = _lpU6xIMB;
        "pkg-1.18.2-1.3.9-fabric" = _p5XJ1Cqj;
        "pkg-1.18.2-1.3.9-forge" = _2g27GhSK;
        "pkg-1.19.2-1.3.9-fabric" = _S1EEbFr9;
        "pkg-1.19.2-1.3.9-forge" = _ZSwvpzpk;
        "pkg-1.19.4-1.3.9-fabric" = _iRip125z;
        "pkg-1.19.4-1.3.9-forge" = _CeTO2ti8;
        "pkg-1.20.1-1.3.9-fabric" = _AMYeBbmn;
        "pkg-1.20.1-1.3.9-forge" = _Ez7keJkJ;
        "pkg-1.20.4-1.3.9-fabric" = _JfLicg1b;
        "pkg-1.20.4-1.3.9-forge" = _nxzn7Vr4;
        "pkg-1.20.4-1.3.9-neoforge" = _btLUZDRj;
        "pkg-1.20.6-1.3.9-fabric" = _S1kl85tc;
        "pkg-1.20.6-1.3.9-forge" = _GkJfW0Nd;
        "pkg-1.20.6-1.3.9-neoforge" = _CkhZ23el;
        "pkg-1.21.1-1.3.9-fabric" = _P9ueeNSy;
        "pkg-1.21.1-1.3.9-forge" = _XRkdrVAc;
        "pkg-1.21.1-1.3.9-neoforge" = _yR4f0KrB;
        "pkg-1.21.1-1.3.10-forge" = _woWp7nGr;
        "pkg-1.18.2-1.4.0-fabric" = _ndce2t6F;
        "pkg-1.18.2-1.4.0-forge" = _8uPlCKHF;
        "pkg-1.19.2-1.4.0-fabric" = _L3GPANUt;
        "pkg-1.19.2-1.4.0-forge" = _114TUcws;
        "pkg-1.19.4-1.4.0-fabric" = _NtrjVGuj;
        "pkg-1.19.4-1.4.0-forge" = _Dc0kxJPa;
        "pkg-1.20.1-1.4.0-fabric" = _iaQuaOGD;
        "pkg-1.20.1-1.4.0-forge" = _cVTQHqCR;
        "pkg-1.20.4-1.4.0-fabric" = _F7QYxcMm;
        "pkg-1.20.4-1.4.0-forge" = _RPzWBhHU;
        "pkg-1.20.4-1.4.0-neoforge" = _culk9njN;
        "pkg-1.20.6-1.4.0-fabric" = _3r0ZxmHY;
        "pkg-1.20.6-1.4.0-forge" = _vuZnKm9W;
        "pkg-1.20.6-1.4.0-neoforge" = _1YJIMCl1;
        "pkg-1.21.1-1.4.0-fabric" = _DPrCuGaH;
        "pkg-1.21.1-1.4.0-forge" = _3rpvJIIa;
        "pkg-1.21.1-1.4.0-neoforge" = _fnyOEl9F;
        "pkg-1.21.3-1.4.0-fabric" = _ozGB3plK;
        "pkg-1.21.3-1.4.0-neoforge" = _n7WtkIqN;
        "pkg-1.21.3-1.4.0-forge" = _qmfpAE9n;
        "pkg-1.18.2-1.4.1-fabric" = _aynuyoUH;
        "pkg-1.18.2-1.4.1-forge" = _G4oAFXoS;
        "pkg-1.19.2-1.4.1-fabric" = _wL9so63q;
        "pkg-1.19.2-1.4.1-forge" = _LYAtwDVA;
        "pkg-1.19.4-1.4.1-fabric" = _tubxMXC1;
        "pkg-1.19.4-1.4.1-forge" = _onoxuM5V;
        "pkg-1.21.3-1.4.1-fabric" = _xkNc7R14;
        "pkg-1.21.3-1.4.1-forge" = _vSAK6Dub;
        "pkg-1.21.3-1.4.1-neoforge" = _5P9Xu0YW;
        "pkg-1.21.4-1.4.1-fabric" = _MEdNoVhs;
        "pkg-1.21.4-1.4.1-neoforge" = _SAsKHrrZ;
        "pkg-1.21.4-1.4.1-forge" = _vw6rzCBs;
        "pkg-1.21.3-1.4.2-fabric" = _fO3oAaJu;
        "pkg-1.21.3-1.4.2-forge" = _UIRp2RqR;
        "pkg-1.21.3-1.4.2-neoforge" = _DrpGnUkU;
        "pkg-1.21.4-1.4.2-fabric" = _kaQHi4L8;
        "pkg-1.21.4-1.4.2-forge" = _apYgJBie;
        "pkg-1.21.4-1.4.2-neoforge" = _HAtGlZS7;
        "pkg-1.21.3-1.4.3-neoforge" = _YIBkFdyI;
        "pkg-1.21.4-1.4.3-neoforge" = _YC7Xb820;
        "pkg-1.18.2-1.4.4-fabric" = _dcUl85bO;
        "pkg-1.18.2-1.4.4-forge" = _6iTeHcfO;
        "pkg-1.19.2-1.4.4-fabric" = _wj2FvYb0;
        "pkg-1.19.2-1.4.4-forge" = _ip6dooJh;
        "pkg-1.19.4-1.4.4-fabric" = _QUSzhIei;
        "pkg-1.19.4-1.4.4-forge" = _5SSx94D1;
        "pkg-1.20.1-1.4.4-fabric" = _CaZJa4dV;
        "pkg-1.20.1-1.4.4-forge" = _JbGYMEa6;
        "pkg-1.20.4-1.4.4-fabric" = _LNbHfe80;
        "pkg-1.20.4-1.4.4-forge" = _8opl2a8Y;
        "pkg-1.20.4-1.4.4-neoforge" = _orp0ufac;
        "pkg-1.20.6-1.4.4-fabric" = _MO2UY3YF;
        "pkg-1.20.6-1.4.4-forge" = _P5Flgugu;
        "pkg-1.20.6-1.4.4-neoforge" = _qNOtcm9D;
        "pkg-1.21.1-1.4.4-fabric" = _Shcd1zCx;
        "pkg-1.21.1-1.4.4-forge" = _bPqIORH8;
        "pkg-1.21.1-1.4.4-neoforge" = _NNAIEvAK;
        "pkg-1.21.3-1.4.4-fabric" = _XKR6gG5n;
        "pkg-1.21.3-1.4.4-forge" = _Icq0Sr3c;
        "pkg-1.21.3-1.4.4-neoforge" = _kYnOCiWd;
        "pkg-1.21.4-1.4.4-fabric" = _zxaREtcR;
        "pkg-1.21.4-1.4.4-forge" = _ouMnSsyq;
        "pkg-1.21.4-1.4.4-neoforge" = _isYBBLDB;
        "pkg-1.18.2-1.4.5-fabric" = _3OZcMjsM;
        "pkg-1.18.2-1.4.5-forge" = _aAMEnYKG;
        "pkg-1.19.2-1.4.5-fabric" = _MKE7JbGj;
        "pkg-1.19.2-1.4.5-forge" = _8estybPf;
        "pkg-1.19.4-1.4.5-fabric" = _ZD35GFYd;
        "pkg-1.19.4-1.4.5-forge" = _tF5IZDI2;
        "pkg-1.20.1-1.4.5-fabric" = _WfCng3Sw;
        "pkg-1.20.1-1.4.5-forge" = _87AeovPr;
        "pkg-1.20.4-1.4.5-fabric" = _dcrJfEn2;
        "pkg-1.20.4-1.4.5-forge" = _RfFyebNr;
        "pkg-1.20.4-1.4.5-neoforge" = _dA1WZwgf;
        "pkg-1.20.6-1.4.5-fabric" = _AsBN9pbi;
        "pkg-1.20.6-1.4.5-forge" = _R6SOWfaY;
        "pkg-1.20.6-1.4.5-neoforge" = _FHx3mZbD;
        "pkg-1.21.1-1.4.5-fabric" = _Z12zyOCA;
        "pkg-1.21.1-1.4.5-forge" = _TNSFDnUH;
        "pkg-1.21.1-1.4.5-neoforge" = _Hezsv22X;
        "pkg-1.21.3-1.4.5-fabric" = _3v0Iv4bV;
        "pkg-1.21.3-1.4.5-forge" = _P3QUBWTi;
        "pkg-1.21.3-1.4.5-neoforge" = _llwjyi5u;
        "pkg-1.21.4-1.4.5-fabric" = _7o8HdmvU;
        "pkg-1.21.4-1.4.5-forge" = _H1n65kz6;
        "pkg-1.21.4-1.4.5-neoforge" = _LkE8Hwt3;
        "pkg-1.20.1-1.4.6-fabric" = _coX0rRej;
        "pkg-1.20.1-1.4.6-forge" = _XGs1OC6u;
        "pkg-1.20.6-1.4.6-fabric" = _CatL1D09;
        "pkg-1.21.1-1.4.6-fabric" = _2VJFCU0t;
        "pkg-1.21.3-1.4.6-fabric" = _O3XA4jhq;
        "pkg-1.21.4-1.4.6-fabric" = _prXPYVT3;
        "pkg-1.18.2-1.4.7-fabric" = _IoIpJTmN;
        "pkg-1.18.2-1.4.7-forge" = _VITjYd62;
        "pkg-1.19.2-1.4.7-fabric" = _HZDsWFqw;
        "pkg-1.19.2-1.4.7-forge" = _Xaiu2Vwe;
        "pkg-1.19.4-1.4.7-fabric" = _5axFZSMf;
        "pkg-1.19.4-1.4.7-forge" = _m7TZ8qHO;
        "pkg-1.20.1-1.4.7-fabric" = _CKD2fGHU;
        "pkg-1.20.1-1.4.7-forge" = _SV7GFCy9;
        "pkg-1.20.4-1.4.7-fabric" = _pwrStjhK;
        "pkg-1.20.4-1.4.7-forge" = _NJHNjeHZ;
        "pkg-1.20.4-1.4.7-neoforge" = _hPQWt947;
        "pkg-1.20.6-1.4.7-fabric" = _el59dCSA;
        "pkg-1.20.6-1.4.7-forge" = _yfDyfWca;
        "pkg-1.20.6-1.4.7-neoforge" = _lNRGNKll;
        "pkg-1.21.1-1.4.7-fabric" = _2oEUqDzW;
        "pkg-1.21.1-1.4.7-forge" = _JD3rx1Eu;
        "pkg-1.21.1-1.4.7-neoforge" = _ZX2jVPgt;
        "pkg-1.21.3-1.4.7-fabric" = _z9QKpSpg;
        "pkg-1.21.3-1.4.7-forge" = _mbR10aXs;
        "pkg-1.21.3-1.4.7-neoforge" = _r5deg9oj;
        "pkg-1.21.4-1.4.7-fabric" = _iBT0dN1I;
        "pkg-1.21.4-1.4.7-forge" = _juh4EfQn;
        "pkg-1.21.4-1.4.7-neoforge" = _x6e6Eh4O;
        "pkg-1.18.2-1.4.8-fabric" = _pDzgL0gW;
        "pkg-1.18.2-1.4.8-forge" = _NnvVC4s0;
        "pkg-1.19.2-1.4.8-fabric" = _TJtcnxFW;
        "pkg-1.19.2-1.4.8-forge" = _1VE8gI0q;
        "pkg-1.19.4-1.4.8-fabric" = _RJcUYmtF;
        "pkg-1.19.4-1.4.8-forge" = _4C8ri7Zh;
        "pkg-1.20.1-1.4.8-fabric" = _ryB6Cl9E;
        "pkg-1.20.1-1.4.8-forge" = _gAt3yEFd;
        "pkg-1.20.4-1.4.8-fabric" = _JweqijUL;
        "pkg-1.20.4-1.4.8-forge" = _jfjt6bCq;
        "pkg-1.20.4-1.4.8-neoforge" = _Nfanb8F4;
        "pkg-1.20.6-1.4.8-fabric" = _oh7Cs6rv;
        "pkg-1.20.6-1.4.8-forge" = _u0nI1kim;
        "pkg-1.20.6-1.4.8-neoforge" = _LfQYhWcG;
        "pkg-1.21.1-1.4.8-fabric" = _yLr2dRHD;
        "pkg-1.21.1-1.4.8-forge" = _xB3ewFX7;
        "pkg-1.21.1-1.4.8-neoforge" = _GyXSOygB;
        "pkg-1.21.3-1.4.8-fabric" = _YGNo35iD;
        "pkg-1.21.3-1.4.8-forge" = _kLhpDIzU;
        "pkg-1.21.3-1.4.8-neoforge" = _kX5SM2OW;
        "pkg-1.21.4-1.4.8-fabric" = _7ciSB11o;
        "pkg-1.21.4-1.4.8-forge" = _PuCN2dYM;
        "pkg-1.21.4-1.4.8-neoforge" = _zqqLyOt4;
        "pkg-1.18.2-1.4.9-fabric" = _gUAKGVwN;
        "pkg-1.18.2-1.4.9-forge" = _4DZl77Um;
        "pkg-1.19.2-1.4.9-fabric" = _zp1b7loR;
        "pkg-1.19.2-1.4.9-forge" = _5GciD0wx;
        "pkg-1.19.4-1.4.9-fabric" = _ogDUmV2E;
        "pkg-1.19.4-1.4.9-forge" = _fBCZMINB;
        "pkg-1.20.1-1.4.9-fabric" = _ouUjc5yH;
        "pkg-1.20.1-1.4.9-forge" = _NOZNzk8N;
        "pkg-1.20.4-1.4.9-fabric" = _MRX9IExS;
        "pkg-1.20.4-1.4.9-forge" = _ZCmNPsBe;
        "pkg-1.20.4-1.4.9-neoforge" = _LzCfejTo;
        "pkg-1.20.6-1.4.9-fabric" = _Lq5QnlUR;
        "pkg-1.20.6-1.4.9-forge" = _sIkk9xs6;
        "pkg-1.20.6-1.4.9-neoforge" = _px8KNydC;
        "pkg-1.21.1-1.4.9-fabric" = _ClEQP8Je;
        "pkg-1.21.1-1.4.9-forge" = _bvt813x6;
        "pkg-1.21.1-1.4.9-neoforge" = _29t6zC9o;
        "pkg-1.21.3-1.4.9-fabric" = _Y30IGlGx;
        "pkg-1.21.3-1.4.9-forge" = _RYFSKBWQ;
        "pkg-1.21.3-1.4.9-neoforge" = _EqxnmC2C;
        "pkg-1.21.4-1.4.9-fabric" = _ZWFoIvyt;
        "pkg-1.21.4-1.4.9-forge" = _SckvSSho;
        "pkg-1.21.4-1.4.9-neoforge" = _HEI9i2Qv;
        "pkg-1.21.5-1.4.9-fabric" = _yWSKHLqp;
        "pkg-1.21.5-1.4.9-neoforge" = _j31aZx0j;
        "pkg-1.21.5-1.4.9-forge" = _5NOw8x6c;
        "pkg-1.18.2-1.4.10-fabric" = _kKH48A9e;
        "pkg-1.18.2-1.4.10-forge" = _tmLLgXGQ;
        "pkg-1.19.2-1.4.10-fabric" = _f74CrIMS;
        "pkg-1.19.2-1.4.10-forge" = _X8qd0dKq;
        "pkg-1.19.4-1.4.10-fabric" = _zCRSFKO7;
        "pkg-1.19.4-1.4.10-forge" = _k66ZwMk2;
        "pkg-1.20.1-1.4.10-fabric" = _Fw8snfhQ;
        "pkg-1.20.1-1.4.10-forge" = _nNlkCgwI;
        "pkg-1.20.4-1.4.10-fabric" = _cQibZLcT;
        "pkg-1.20.4-1.4.10-forge" = _toV0p9SU;
        "pkg-1.20.4-1.4.10-neoforge" = _kFYLYIDP;
        "pkg-1.20.6-1.4.10-fabric" = _obGPf17Z;
        "pkg-1.20.6-1.4.10-forge" = _bAPqgZmr;
        "pkg-1.20.6-1.4.10-neoforge" = _OAmGc87J;
        "pkg-1.21.1-1.4.10-fabric" = _X9NucQOA;
        "pkg-1.21.1-1.4.10-forge" = _u3Fg1z6y;
        "pkg-1.21.1-1.4.10-neoforge" = _vzHEzMFX;
        "pkg-1.21.3-1.4.10-fabric" = _8V4W8IbQ;
        "pkg-1.21.3-1.4.10-forge" = _gCwgVw48;
        "pkg-1.21.3-1.4.10-neoforge" = _53n4BW10;
        "pkg-1.21.4-1.4.10-fabric" = _C164I09x;
        "pkg-1.21.4-1.4.10-forge" = _ZnNGXrm3;
        "pkg-1.21.4-1.4.10-neoforge" = _ZUFajrkc;
        "pkg-1.21.5-1.4.10-fabric" = _ftEOgKbK;
        "pkg-1.21.5-1.4.10-forge" = _udkCpEdl;
        "pkg-1.21.5-1.4.10-neoforge" = _i7eDUsRr;
        "pkg-1.21.6-1.4.10-fabric" = _oGbpVh1g;
        "pkg-1.21.6-1.4.10-neoforge" = _yPyHWD6R;
        "pkg-1.21.6-1.4.10-forge" = _4tObXnJB;
        "pkg-1.18.2-1.4.11-fabric" = _BJwAzAVb;
        "pkg-1.18.2-1.4.11-forge" = _tneufUZb;
        "pkg-1.19.2-1.4.11-fabric" = _FPI8Kqms;
        "pkg-1.19.2-1.4.11-forge" = _1Zq7RfKw;
        "pkg-1.19.4-1.4.11-fabric" = _Z7A2EjjV;
        "pkg-1.19.4-1.4.11-forge" = _yisVlpk7;
        "pkg-1.20.1-1.4.11-fabric" = _J8YNfDbI;
        "pkg-1.20.1-1.4.11-forge" = _hOQxwlYz;
        "pkg-1.20.4-1.4.11-fabric" = _lDGArYax;
        "pkg-1.20.4-1.4.11-forge" = _DREir5rj;
        "pkg-1.20.4-1.4.11-neoforge" = _2ENwuPfY;
        "pkg-1.20.6-1.4.11-fabric" = _jtJAJ4ar;
        "pkg-1.20.6-1.4.11-forge" = _9KvZ0Fvy;
        "pkg-1.20.6-1.4.11-neoforge" = _pRVyv6gR;
        "pkg-1.21.1-1.4.11-fabric" = _xlk51zaH;
        "pkg-1.21.1-1.4.11-forge" = _enGqW70e;
        "pkg-1.21.1-1.4.11-neoforge" = _ROkjV5oc;
        "pkg-1.21.3-1.4.11-fabric" = _ID7sQPLK;
        "pkg-1.21.3-1.4.11-forge" = _zVLgf5rM;
        "pkg-1.21.3-1.4.11-neoforge" = _KnAjend8;
        "pkg-1.21.4-1.4.11-fabric" = _RYeeFyt6;
        "pkg-1.21.4-1.4.11-forge" = _mPicstrn;
        "pkg-1.21.4-1.4.11-neoforge" = _3ZYhLGXk;
        "pkg-1.21.5-1.4.11-forge" = _vcI8nBg1;
        "pkg-1.21.5-1.4.11-neoforge" = _QYpqY6B1;
        "pkg-1.21.7-1.4.11-forge" = _RX3fcSbD;
        "pkg-1.21.5-1.4.11-fabric" = _gcoP1IZG;
        "pkg-1.21.7-1.4.11-fabric" = _at0q6I7L;
        "pkg-1.21.7-1.4.11-neoforge" = _lab0WtQA;
        "pkg-1.21.8-1.4.11-fabric" = _8iNejFfk;
        "pkg-1.21.8-1.4.11-forge" = _J6Tf6DsL;
        "pkg-1.21.8-1.4.11-neoforge" = _RsmYNSS4;
        "pkg-1.21.9-1.4.11-fabric" = _Qgt5bXjL;
        "pkg-1.21.9-1.4.11-neoforge" = _PfuEXyra;
        "pkg-1.21.9-1.4.11-forge" = _WhgwqIPa;
        "pkg-1.21.10-1.4.11-fabric" = _VIGQm7I6;
        "pkg-1.21.10-1.4.11-forge" = _evEnDFTr;
        "pkg-1.21.10-1.4.11-neoforge" = _T2mrjqnb;
        "pkg-1.21.11-1.4.11-fabric" = _UImDrwFF;
        "pkg-1.21.11-1.4.11-forge" = _HJRMy2lk;
        "pkg-1.21.11-1.4.11-neoforge" = _jgijCRvC;
        "pkg-26.1.2-1.4.11-forge" = _tU5KmMP1;
        "pkg-26.1.2-1.4.11-neoforge" = _31JuKAPJ;
        "pkg-26.1.2-1.4.11-fabric" = _WNDoUK8g;
        "pkg-26.1.2-1.4.12-fabric" = _V164X9AA;
        "pkg-26.1.2-1.4.12-forge" = _PMdHRpZZ;
        "pkg-26.1.2-1.4.12-neoforge" = _tJJ96pKC;
        "pkg-1.20.1-1.4.13-fabric" = _zEgq4fvm;
        "pkg-1.20.1-1.4.13-forge" = _2wERqS5q;
        "pkg-1.21.1-1.4.13-fabric" = _tdWLCdOV;
        "pkg-1.21.1-1.4.13-forge" = _JvnqtoMB;
        "pkg-1.21.1-1.4.13-neoforge" = _A57xxobI;
        "pkg-1.21.11-1.4.13-fabric" = _kpnogMzQ;
        "pkg-1.21.11-1.4.13-forge" = _bplr64Zf;
        "pkg-1.21.11-1.4.13-neoforge" = _mVYKPPLv;
        "pkg-26.1.2-1.4.13-fabric" = _eD0InRSa;
        "pkg-26.1.2-1.4.13-forge" = _lEfTmIQ0;
        "pkg-26.1.2-1.4.13-neoforge" = _fWOwqIvN;
        "pkg-26.2-1.4.13-fabric" = _1nmhyD8y;
