...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _Devv7GEb;
        "pkg-1.0.9" = _YWOFuQPh;
        "pkg-1.0.10" = _QOS88ejF;
        "pkg-1.0.1-1.21.1-forge" = _doPmNnJ2;
        "pkg-1.0.12" = _eRp2w8mU;
        "pkg-1.0.0" = _9iIY9v3d;
        "pkg-1.0.3-1.21.1-forge" = _g46G2Rbh;
        "pkg-1.0.3-1.21.1-Fabric" = _RqiuTl9x;
        "pkg-1.0.13" = _o28puzf2;
        "pkg-1.0.4" = _iWMQoTBW;
        "pkg-1.1.0-1.18.2-Forge" = _AaFnQHUm;
        "pkg-1.1.0-1.18.2-Fabric" = _xhCr96j1;
        "pkg-1.1.0" = _nxkuAAf7;
        "pkg-1.1.0-1.20.1-Fabric" = _JIGHuPBx;
        "pkg-1.1.0-1.21.1-neoforge" = _aSkJn8tS;
        "pkg-1.1.0-1.21.1-Fabric" = _fMxq09nq;
        "pkg-1.1.0-1.18.2-forge-fix" = _3txmMj1I;
        "pkg-1.1.0-1.21.1-fabric-fix" = _o1fRZaUk;
        "pkg-1.1.0-1.21.1-neoforge-fix" = _kYYfPS7x;
        "pkg-1.1.0-1.20.1-forge-fix" = _IMrtSyZK;
        "pkg-1.1.0-1.18.2-fabric-fix" = _HxVfFpjS;
        "pkg-1.1.0-1.20.1-fabric-fix" = _W90tlUPs;
        "pkg-1.1.1-1.18.2-fabric" = _XyL7YldQ;
        "pkg-1.1.1-1.18.2-forge" = _XgAA1o2t;
        "pkg-1.1.1-1.21.1-fabric" = _upTWWWfK;
        "pkg-1.1.1-1.21.1-neoforge" = _poAyuXSa;
        "pkg-1.1.1-1.20.1-fabric" = _sWmbLcmJ;
        "pkg-1.1.1-1.20.1-forge" = _TJxFrPYq;
        "pkg-1.1.2-1.18.2-fabric" = _6K9xgCC3;
        "pkg-1.1.2-1.18.2-forge" = _jH7Nn8JD;
        "pkg-1.1.2-1.21.1-fabric" = _NjK1qf82;
        "pkg-1.1.2-1.21.1-neoforge" = _GYMvjFwu;
        "pkg-1.1.2-1.20.1-fabric" = _nsJi7BzY;
        "pkg-1.1.2-1.20.1-forge" = _ZgZGTUaD;
        "pkg-1.1.4-1.20.1-forge" = _o2XAFxRK;
        "pkg-1.1.4-1.20.1-fabric" = _VXkAwKLu;
        "pkg-1.1.4-1.21.1-neoforge" = _XW0ePPxE;
        "pkg-1.1.4-1.21.1-fabric" = _vYdiceJB;
        "default" = _vYdiceJB;
    });
