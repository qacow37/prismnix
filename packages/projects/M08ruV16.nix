...
let
    ...
    in {
        ...
        "pkg-5.0.2" = _AzrQtK1e;
        "pkg-5.0.3" = _Byj5ahzr;
        "pkg-5.1.0+mc1.20.2" = _9gq2a64I;
        "pkg-5.1.0+mc1.20.4" = _jGGumR4a;
        "pkg-5.2.0+mc1.20.6" = _ELPibYhN;
        "pkg-5.2.1+mc1.20.6" = _70sKyIMv;
        "pkg-5.2.2+mc1.21" = _ntgSlrrW;
        "pkg-5.2.3+mc1.21" = _hL2qgP4K;
        "pkg-5.2.4+mc1.21" = _oeSOphtG;
        "pkg-5.2.5+mc1.21.2" = _8eV5MZGw;
        "pkg-5.2.6+mc1.21.4" = _9cevkjj6;
        "pkg-5.2.7+mc1.21.5" = _FdlWKxsL;
        "pkg-5.2.8+mc1.21.6" = _ODwC9dEb;
        "pkg-5.2.9+mc1.21.6" = _b4wSwWuv;
        "pkg-5.2.10+mc1.21.9" = _xiXouhmS;
        "pkg-5.2.11+mc1.21.11" = _y6wx9vV9;
        "pkg-5.2.12+mc26.1" = _8gsFUovP;
        "pkg-5.2.13+mc26.1" = _njaTBYvt;
        "pkg-5.2.14+mc26.2" = _9O9VU4Wh;
        "pkg-5.0.1.1" = _Uh3M3z1g;
        "pkg-5.2.4.1+mc1.21" = _a8r0n94h;
