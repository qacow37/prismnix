...
let
    ...
    in {
        ...
        "pkg-extended-ae-1.0.1" = _Ca9CNOqI;
        "pkg-ae2wtlib-1.0.1" = _F012q7Np;
        "pkg-ae2-1.0.1" = _8gEfPDbJ;
        "pkg-extended-ae-1.0.2" = _bV22ab1N;
        "pkg-ae2-1.0.2" = _tIyEspsO;
        "pkg-appliede-1.0.0" = _mhU4eqGI;
        "pkg-advancedae-1.0.0" = _WxszFR06;
        "pkg-ae2wtlib-1.0.2" = _1CpoSPMH;
        "pkg-ae2wtlib-1.0.3" = _nQ2sTaLB;
        "pkg-ae2-1.0.3" = _nzbCoCOp;
        "pkg-ae2-integration-2.0.0" = _dt1gDyb7;
        "pkg-ae2-integration-2.1.0" = _S4SAvVZk;
        "pkg-ae2-integration-2.1.1" = _KpcgMFVd;
        "pkg-ae2-integration-2.2.0" = _MGd4IS17;
        "pkg-ae2-integration-2.2.1" = _ggunoUpe;
        "pkg-ae2-integration-2.2.2" = _hN0qKOPu;
        "pkg-ae2-integration-2.3.0" = _3d3Y8rHA;
        "pkg-ae2-integration-2.3.1" = _k3tXDLgy;
        "pkg-ae2-integration-2.3.2" = _XuuTG4mQ;
