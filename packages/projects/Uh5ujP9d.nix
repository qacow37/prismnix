...
let
    ...
    in {
        ...
        "pkg-1.7.0" = _8a6P9mfB;
        "pkg-1.7.1" = _6kPxEXTJ;
        "pkg-1.7.2-beta" = _VZ1yrb7E;
        "pkg-1.7.2" = _Z41mm8Tu;
        "pkg-1.7.3" = _wel2F3Nm;
        "pkg-1.7.4" = _MMOBWQ8j;
        "pkg-1.7.5-FABRIC-1.21.1" = _HDG6vONk;
        "pkg-1.7.5-FABRIC-1.21.4" = _4AhVFkTR;
        "pkg-1.7.5-NEOFORGE-1.21.1" = _4EVTt8jV;
        "pkg-1.7.5-NEOFORGE-1.21.4" = _L7r4HNlW;
        "pkg-1.7.6-Fabric-1.21.1" = _EQNBFLTH;
        "pkg-1.7.6-Fabric-1.21.4" = _seN4qgVV;
        "pkg-1.7.6-NeoForge-1.21.1" = _mvOwyxm8;
        "pkg-1.7.6-NeoForge-1.21.4" = _pw7gw5N4;
        "pkg-1.7.7-Fabric-1.21.1" = _JP9f9ddF;
        "pkg-1.7.7-Fabric-1.21.4" = _HFT5qzPw;
        "pkg-1.7.7-NeoForge-1.21.1" = _WKDBDSjS;
        "pkg-1.7.7-NeoForge-1.21.4" = _igBFaZvd;
        "pkg-1.7.8-Fabric-1.21.1" = _ODU9zm7O;
        "pkg-1.7.8-Fabric-1.21.4" = _rlTjzo6p;
        "pkg-1.7.8-NeoForge-1.21.1" = _xch510Go;
        "pkg-1.7.8-NeoForge-1.21.4" = _LZ0XXG3b;
        "pkg-1.7.9-Fabric-1.21.4" = _hmBzbB7w;
        "pkg-1.7.9-Fabric-1.21.1" = _iItifejn;
        "pkg-1.7.9-NeoForge-1.21.4" = _x5zuqslp;
        "pkg-1.7.9-NeoForge-1.21.1" = _udYtLRB6;
        "pkg-1.7.9-Fabric-1.21.10" = _7cUxGidf;
        "pkg-1.7.9-NeoForge-1.21.10" = _DxPVINdR;
        "pkg-1.8-alpha-1-Fabric-1.21.1" = _VxgTwSu5;
        "pkg-1.8-alpha-1-Fabric-1.21.4" = _lxW04UXy;
        "pkg-1.8-alpha-1-Fabric-1.21.5" = _aBICt4ew;
        "pkg-1.8-alpha-1-Fabric-1.21.8" = _VzUiYDzo;
        "pkg-1.8-alpha-1-Fabric-1.21.10" = _IhCORzoL;
        "pkg-1.8-alpha-1-Fabric-1.21.11" = _BhulzxSm;
        "pkg-1.8-alpha-1-NeoForge-1.21.1" = _ntQdBxzH;
        "pkg-1.8-alpha-1-NeoForge-1.21.4" = _buOJprdB;
        "pkg-1.8-alpha-1-NeoForge-1.21.5" = _YEi5uQbX;
        "pkg-1.8-alpha-1-NeoForge-1.21.10" = _sbR2eyGh;
        "pkg-1.8-alpha-1-NeoForge-1.21.11" = _efXggr5e;
        "pkg-1.8-alpha-1-NeoForge-1.21.8" = _sWpBhU11;
        "pkg-1.8-Fabric-1.21.1" = _k7eeGkhj;
        "pkg-1.8-Fabric-1.21.10" = _yRoJmdS0;
        "pkg-1.8-Fabric-1.21.11" = _FIAJ0qm9;
        "pkg-1.8-Fabric-1.21.4" = _3vmBBZeq;
        "pkg-1.8-Fabric-1.21.5" = _rOCb5gke;
        "pkg-1.8-Fabric-1.21.8" = _f0cSWrOV;
        "pkg-1.8-NeoForge-1.21.1" = _sTATZaVx;
        "pkg-1.8-NeoForge-1.21.10" = _Z48qsfoK;
        "pkg-1.8-NeoForge-1.21.11" = _OFR6zzaY;
        "pkg-1.8-NeoForge-1.21.4" = _Q8oh32gx;
        "pkg-1.8-NeoForge-1.21.5" = _tyUDcrhc;
        "pkg-1.8-NeoForge-1.21.8" = _C7uWRJhm;
        "pkg-1.8.1-Fabric-1.21.4" = _EeuEd86x;
        "pkg-1.8.1-Fabric-1.21.11" = _SdSF1Pv4;
        "pkg-1.8.1-Fabric-1.21.10" = _1eh0SMBz;
        "pkg-1.8.1-Fabric-1.21.5" = _PeEP5vpn;
        "pkg-1.8.1-Fabric-1.21.1" = _gmX02lXe;
        "pkg-1.8.1-Fabric-1.21.8" = _m3sI5HWn;
        "pkg-1.8.1-NeoForge-1.21.1" = _Y04VFrwI;
        "pkg-1.8.1-NeoForge-1.21.11" = _FOqWImTV;
        "pkg-1.8.1-NeoForge-1.21.10" = _EftZl0dd;
        "pkg-1.8.1-NeoForge-1.21.4" = _4v7Ldj4z;
        "pkg-1.8.1-NeoForge-1.21.5" = _wHXbcTee;
        "pkg-1.8.1-NeoForge-1.21.8" = _bYJLkYF0;
        "default" = _bYJLkYF0;
    });
