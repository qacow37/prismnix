...
let
    ...
    in {
        ...
        "pkg-4.0.1c" = _nwog0MGO;
        "pkg-4.0.1ca" = _w009uTvV;
        "pkg-4.0.1d" = _gUK3WBeM;
        "pkg-4.0.1d+mod" = _6hcuSnGg;
        "pkg-4.0.1e" = _weSPLiL4;
        "pkg-4.0.1" = _qoAG0gQB;
        "pkg-4.0.1f+mod" = _AjsfHQ3V;
        "pkg-4.0.1g" = _CKBmzXzc;
        "pkg-4.0.2" = _EoB2Sb2N;
        "pkg-4.0.2+mod" = _YDxg0m47;
        "pkg-4.0.2a" = _EWkywxSA;
        "pkg-4.0.2a+mod" = _xaHNSnw0;
        "pkg-4.0.2b" = _fpgl5CH5;
        "pkg-4.0.2b+mod" = _FKYAQ8yk;
        "pkg-4.0.2c" = _8H1FrusG;
        "pkg-4.0.2c+mod" = _9NMZ5ruu;
        "pkg-4.0.2d" = _Dr1ESuo9;
        "pkg-4.0.2d+mod" = _QDfWFeJM;
        "pkg-4.0.2e" = _QCTOU92s;
        "pkg-4.0.2e+mod" = _3nhbYzuu;
        "pkg-4.0.2f" = _vzzvSKDg;
        "pkg-4.0.2f+mod" = _8k6k55Pe;
        "pkg-4.0.2fa" = _jKYOSpR1;
        "pkg-4.0.2fa+mod" = _ZMlfG1ay;
        "pkg-4.0.2g" = _IMbaaWuH;
        "pkg-4.0.2g+mod" = _XV2L76zL;
        "pkg-4.0.3" = _lprQB0tj;
        "pkg-4.0.4" = _Kc25vkJ7;
        "pkg-4.0.4a" = _YQoSeChR;
        "pkg-4.0.4b" = _K6b4q24Y;
        "pkg-4.0.5" = _cZz0QqJd;
        "pkg-4.0.5a" = _SoaqbAGj;
        "pkg-4.0.5a+mod" = _NRU4nxKo;
        "pkg-4.0.5b" = _OKPo58Kk;
        "pkg-4.0.5c" = _tKbrbqXj;
        "pkg-4.0.5c+mod" = _Fa1TZV6C;
        "pkg-4.0.5d" = _ZM6cQvyp;
        "pkg-4.0.5d+mod" = _b5MSAOBx;
        "pkg-4.0.5e" = _CNlUvpmO;
        "pkg-4.0.5e+mod" = _XRjyvceu;
        "pkg-4.0.5f" = _veYwPTBm;
        "pkg-4.0.5f+mod" = _Fylno7kb;
        "pkg-4.0.5g" = _mZzDXRSJ;
        "pkg-4.0.5g+mod" = _t2PB8GHU;
        "pkg-4.0.5h" = _ITdeVs95;
        "pkg-4.0.5h+mod" = _FOyjJM18;
        "pkg-4.0.5i" = _1f57DEc4;
        "pkg-4.0.5i+mod" = _W0Zaww1L;
        "pkg-4.0.5j" = _ckTyHIMa;
        "pkg-4.0.5k" = _R5A68Qn5;
        "pkg-4.0.5k+mod" = _NutHU0Kz;
        "pkg-4.0.5L" = _O9TWbnfL;
        "pkg-4.0.5L+mod" = _xqJIh00D;
        "pkg-4.0.5m" = _nxtkgmc5;
        "pkg-4.1.0" = _Ai5wMauF;
        "pkg-4.1.0a" = _fv249zF6;
        "pkg-4.1.0b" = _y9puct5D;
        "pkg-4.1.0c" = _A6hR4XOD;
        "pkg-4.1.1" = _S6DqzGRi;
        "pkg-4.1.2" = _PPViTXva;
        "pkg-4.1.2a" = _AYZsuKK8;
        "pkg-4.1.3" = _Q0cUhBj9;
        "pkg-4.1.2b" = _pRNr44t4;
        "pkg-4.1.4" = _cp9mQupp;
        "pkg-4.1.5" = _34F22vDQ;
        "pkg-4.1.6" = _lbt3FQOO;
        "pkg-4.1.6a" = _sgONXJds;
        "pkg-4.1.6b" = _rvWFGVbi;
        "default" = _rvWFGVbi;
    });
