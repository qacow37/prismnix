...
let
    ...
    in {
        ...
        "pkg-1.18.1-1.0.9" = _at6BNcZH;
        "pkg-1.18.1-1.0.10" = _zZH9j4Ej;
        "pkg-1.18.1-1.0.11" = _yjefpnUS;
        "pkg-1.18.1-1.0.12" = _Vx06BCS5;
        "pkg-1.18.2-1.0.13" = _lPIjbK6B;
        "pkg-1.18.2-1.0.14" = _Ykl0cLdl;
        "pkg-1.18.2-1.0.15" = _DYzNlqMJ;
        "pkg-1.19-1.0.0-alpha+20220614-1441" = _hMjrD2qS;
        "pkg-1.19-1.0.0-alpha+20220720-1601" = _URAyBbht;
        "pkg-1.19.1-1.0.0" = _vg05HZA5;
        "pkg-1.19.1-1.0.1" = _SJtFzRY9;
        "pkg-1.19.1-1.0.2" = _9f9fBXTh;
        "pkg-1.19.3-1.1.0-alpha+20221218-1404" = _yKNWWzYb;
        "pkg-1.19.3-1.1.0" = _JA1WwgNu;
        "pkg-1.19.3-1.1.2" = _lJQk4Ohw;
        "pkg-1.19.4-1.1.3-alpha+20230505-1603" = _R2sueHhn;
        "pkg-1.16.5-1.0.9" = _GyciNH4F;
        "pkg-1.17.1-1.0.7" = _JT26EaUS;
        "pkg-1.20.1-1.1.3-beta.1" = _AAqq2Uw4;
        "pkg-1.20.1-1.1.3" = _2yp6KKvQ;
        "pkg-1.20.1-1.1.4" = _V6YvHm9q;
        "pkg-1.21.1-1.1.5-alpha+20240911-1742" = _sVc61dku;
        "pkg-1.21.1-1.1.5-beta.1" = _1DauNuzA;
        "pkg-1.21.1-1.1.5" = _HtfQDMyO;
        "pkg-1.21.1-1.2.0" = _QAqjbLfC;
        "default" = _QAqjbLfC;
    });
