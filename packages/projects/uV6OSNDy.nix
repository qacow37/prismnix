...
let
    ...
    in {
        ...
        "pkg-1.18-v1.0.0" = _9soPABaI;
        "pkg-1.19.3-v1.0.0" = _nis65ev4;
        "pkg-1.19.4-v1.0.0" = _ZyqCOLvf;
        "pkg-1.20-v1.0.0" = _zPBWaC63;
        "pkg-1.18-v1.1.0" = _tHbcJvdy;
        "pkg-1.19-v1.1.0" = _lVDmwUOK;
        "pkg-1.19.3-v1.1.0" = _Z7MxBi1f;
        "pkg-1.19.4-v1.1.0" = _BA9MgQQP;
        "pkg-1.20-v1.1.0" = _uixPJ7tv;
        "pkg-2.0.0-mc1.20" = _912HRy6o;
        "pkg-2.0.1-mc1.20.2" = _ywjxVw9G;
        "pkg-2.0.2-mc1.20.2" = _ZzX8DI8p;
        "pkg-2.0.2-mc1.20" = _POowLKQg;
        "pkg-2.0.4-mc1.20" = _FJbDz8KW;
        "pkg-2.0.4-mc1.20.2" = _xdCqMtIh;
        "pkg-2.0.5-mc1.20" = _3gPRD1nb;
        "pkg-2.0.5-mc1.20.2" = _5fi4chtl;
        "pkg-2.1.0-fabric1.20.2" = _pg5dZJLt;
        "pkg-2.1.0-fabric1.20" = _MnV09kij;
        "pkg-2.1.1-fabric1.20" = _gI5EUEgD;
        "pkg-2.1.1-fabric1.21" = _zqlMHbk7;
        "pkg-2.1.1-fabric1.20.2" = _UGdepUom;
        "pkg-2.1.1-fabric1.20.5" = _tBCp8JYQ;
        "pkg-2.2.0-fabric1.21" = _L7nPQCz7;
        "pkg-2.2.0-fabric1.20" = _wQnLt2QW;
        "pkg-2.2.0-fabric1.20.2" = _2FKxtraN;
        "pkg-2.2.0-fabric1.20.5" = _Cq9a9dZt;
        "pkg-2.2.2-fabric.1.21" = _CQYjnDxb;
        "pkg-2.2.2-fabric.1.20" = _TmuedEPT;
        "pkg-2.2.2-fabric.1.20.2" = _Nq6Q3lhY;
        "pkg-2.2.2-fabric.1.20.5" = _DUdEzX00;
        "default" = _DUdEzX00;
    });
