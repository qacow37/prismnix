...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _26JJMPuP;
        "pkg-1.9.2" = _e48fGEJt;
        "pkg-1.10.0" = _uPXSyBQb;
        "pkg-1.10.1" = _gSvUgMgn;
        "pkg-1.10.4" = _LsvOFSWt;
        "pkg-2.0.0.0" = _QYkDSs0c;
        "pkg-2.0.1.4" = _ZaH1mZgU;
        "pkg-2.0.1.5" = _oXJvXQFa;
        "pkg-2.0.1.6" = _3XunbpMq;
        "pkg-2.0.3.5" = _z7npcqAM;
        "default" = _z7npcqAM;
    });
