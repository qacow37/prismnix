...
let
    ...
    in {
        ...
        "pkg-1.19.2" = _h6s4Z0zL;
        "pkg-1.19.1" = _aVvLEe8k;
        "pkg-1.19.0" = _Lb5bYODn;
        "pkg-1.18.3" = _kRyZ6phk;
        "pkg-1.20.2" = _y7WHveqR;
        "pkg-1.20.3" = _FkteV6ot;
        "pkg-1.20.4" = _Oo9Pdayh;
        "pkg-1.21.6" = _S1VUD1PK;
        "pkg-1.21.7" = _PDepj5gi;
        "pkg-1.21.8" = _RsQnqB0C;
        "pkg-1.21.9" = _1OEGAgO5;
        "pkg-1.22.0" = _pWqWOBQE;
        "pkg-1.22.1" = _zeBKXjJn;
        "pkg-1.22.3" = _E0qs8quQ;
        "pkg-1.22.4" = _jVyOYztL;
        "pkg-1.22.6" = _N5JLnX72;
        "pkg-1.23.0" = _MV5BuyVo;
        "pkg-1.23.6" = _zTB6oWVM;
        "pkg-1.24.1" = _YUgb2iJs;
        "pkg-1.24.3" = _dhwlHKIA;
        "pkg-1.24.4" = _A8fwHUBJ;
        "pkg-1.24.5" = _dzduia7S;
        "pkg-1.24.6" = _8paVmn5j;
        "default" = _8paVmn5j;
    });
