...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _bK1tJHja;
        "pkg-1.0.1" = _Ys9drNVW;
        "pkg-1.0.1+mod" = _tOQRH7DL;
        "pkg-1.0.2" = _VWbEjxs0;
        "pkg-1.0.2+mod" = _cUykMBeV;
        "pkg-1.0.3" = _iSeVxAHB;
        "pkg-1.0.3+mod" = _8WdwBRLa;
        "pkg-1.0.4" = _8x0ZuMhf;
        "pkg-1.0.4+mod" = _q4HJTHMN;
        "pkg-1.0.5" = _pffGtoX3;
        "pkg-1.0.5+mod" = _d0COLpzA;
        "pkg-1.0.6" = _K62ixj5R;
        "pkg-1.0.6+mod" = _nZ26pBtx;
        "pkg-1.0.7" = _THsB5yaP;
        "pkg-1.0.7+mod" = _USQRzTaf;
        "pkg-1.0.8" = _oqQ9tXQk;
        "pkg-1.0.8+mod" = _MVKweag5;
        "pkg-1.0.9" = _1isbl1tH;
        "pkg-1.0.9+mod" = _J5S2vfJL;
        "pkg-1.0.10" = _NWjkzY3Y;
        "pkg-1.0.10+mod" = _27ERL466;
        "pkg-1.0.11" = _XXZ3ga6V;
        "pkg-1.0.11+mod" = _oCPkZh81;
        "pkg-1.1.0" = _q7fBC1dd;
        "pkg-1.1.0+mod" = _jLyVmjOp;
        "pkg-1.1.1" = _4SHAD0JK;
        "pkg-1.1.1+mod" = _2QovBkiC;
        "pkg-1.1.2" = _JfjYKocO;
        "pkg-1.1.2+mod" = _mZDOTdM0;
        "default" = _mZDOTdM0;
    });
