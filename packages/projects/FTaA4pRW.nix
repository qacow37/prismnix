...
let
    ...
    in {
        ...
        "pkg-1.5.8" = _GvJfiVwR;
        "pkg-1.5.9" = _rupk9JbA;
        "pkg-1.5.10" = _Lh11FHAc;
        "pkg-1.5.12" = _YZPzk1k3;
        "pkg-3.0.1" = _KswuBxhO;
        "pkg-2.0.2" = _EMnK174Q;
        "pkg-3.0.2" = _M8zG590p;
        "pkg-4.0.1" = _rfiKofmi;
        ...
        "pkg-9.0.1" = _O3LIJowd;
        "pkg-8.0.3" = _B8m43lcF;
        "pkg-10.0.1" = _twhYP5RJ;
        "pkg-11.0.1" = _h1wb6jgb;
        "pkg-11.0.2" = _72i8wvDk;
        "pkg-12.0.1" = _fDNhoWG4;
        "pkg-12.0.2" = _rTcL138e;
        "pkg-13.0.1" = _GaqkctOz;
        "pkg-14.0.1" = _LUIcknGn;
        "pkg-14.0.2" = _XPmcLu1p;
        "pkg-14.0.3" = _llBmaJFm;
        "pkg-11.0.3" = _gmUU5CDK;
        "pkg-14.0.4" = _PzAKSkmT;
        "pkg-11.0.4" = _59SM3VQJ;
        "pkg-16.0.2" = _mUxpC3lc;
        "pkg-16.0.3" = _WLYt4HpR;
        "pkg-14.0.5" = _wIM7k9JY;
        "pkg-17.0.1" = _VMHyAlkT;
        "pkg-18.0.1" = _TXiI2v3g;
        "pkg-18.0.2" = _xAbPYu2f;
        "pkg-18.0.3" = _ENpGHKm8;
        "pkg-18.0.4" = _EGGd1e0u;
        "pkg-18.0.5" = _e7p89ZPT;
        "pkg-19.0.1" = _bI3v0ZW4;
        "pkg-19.0.2" = _eeX3NVce;
        "pkg-20.0.1" = _osRkezcA;
        "pkg-21.0.1" = _bfL3jxQr;
        "pkg-21.0.2" = _V1VdYTVA;
        "pkg-18.0.6" = _MKjm3QYb;
        "pkg-21.0.3" = _RxhJojfc;
        "pkg-18.0.7" = _1P0gcoT2;
        "pkg-21.0.4" = _a5Zo4Zgh;
        "pkg-18.0.8" = _84v7M1Wv;
