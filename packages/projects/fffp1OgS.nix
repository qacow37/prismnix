...
let
    ...
    in {
        ...
        "pkg-1.0" = _qNX7fTiV;
        "pkg-1.0_mod" = _TVJTsidj;
        "pkg-1.1" = _3TOCh1PZ;
        "pkg-1.2" = _k4YLtaon;
        "pkg-1.2+mod" = _22oyuniC;
        "pkg-1.3" = _ULmeea5k;
        "pkg-1.3+mod" = _9RIm4fTi;
        "pkg-2.0" = _fgquNEvP;
        "pkg-2.0+mod" = _jro9JgOV;
        "pkg-3.0" = _YtxNPu7d;
        "pkg-3.0+mod" = _poFmPdEZ;
        "pkg-3.1" = _nH4R2gyn;
        "pkg-3.2" = _OxVlJAmX;
        "pkg-3.2+mod" = _UFMWMVMW;
        "pkg-4.0" = _xYMH5xAW;
        "pkg-4.0+mod" = _BvOa4aQc;
        "pkg-4.1" = _fQSHAd29;
        "pkg-4.1+mod" = _bW2WUUmG;
        "pkg-4.2" = _YKK2MKDi;
        "pkg-4.2+mod" = _eav3WZRF;
        "pkg-4.3" = _ekj5enjY;
        "pkg-4.3+mod" = _SS2tttHM;
        "pkg-4.4" = _lafMYLKA;
        "pkg-4.4+mod" = _jp4wjXQs;
        "pkg-4.5" = _xz0xisFm;
        "pkg-4.5+mod" = _jsiNvC6t;
        "pkg-4.6" = _KCfdDIYO;
        "pkg-4.6+mod" = _b2uXtcsW;
        "pkg-4.7" = _UOj8j0nW;
        "pkg-4.7+mod" = _mpw3wIuO;
        "pkg-4.8" = _JyXJTeUr;
        "pkg-4.8-fabric" = _r2uW58sv;
        "pkg-4.8-forge" = _tGAwKFyc;
        "pkg-4.12" = _TIQ4kLlE;
        "pkg-4.12-fabric" = _OcdNMacR;
        "pkg-4.12-quilt" = _UDGW2GTf;
        "pkg-4.12-forge" = _1XW6QGGv;
        "pkg-4.12-neoforge" = _KoPJuECL;
        "pkg-4.13" = _ZGM0hZUj;
        "pkg-4.13-fabric" = _l5pJUTXF;
        "pkg-4.13-quilt" = _Yqeiilaq;
        "pkg-4.13-forge" = _1OqCao8W;
        "pkg-4.13-neoforge" = _yVt5la8Q;
        "default" = _yVt5la8Q;
    });
