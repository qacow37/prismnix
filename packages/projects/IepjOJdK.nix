...
let
    ...
    in {
        ...
        "pkg-1.2.0+1.17.1" = _2Q8M7FHw;
        "pkg-1.2.0+1.18.2" = _x2PDCE5Y;
        "pkg-1.2.0+1.19.2" = _XhufOHzK;
        "pkg-1.2.0+1.19.3" = _TCDmUtEG;
        "pkg-1.2.0+1.19.4" = _nOXIZsDb;
        "pkg-1.2.0+1.20.1" = _humfAdMH;
        "default" = _humfAdMH;
    });
