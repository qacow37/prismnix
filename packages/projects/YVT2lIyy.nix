...
let
    ...
    in {
        ...
        "pkg-1.21.3" = _bGMEhASh;
        "pkg-1.21.4" = _bdDYOeNp;
        "pkg-1.21.5" = _sypdurVP;
        "pkg-1.21.6" = _w48L0bww;
        "pkg-1.21.7" = _vktomqcu;
        "pkg-1.21.8" = _NKjWy0jD;
        "pkg-1.21.9" = _R8iGQ6Dk;
        "pkg-1.21.10" = _Rv7K02Wo;
        "pkg-1.21.11" = _rVEpRKx2;
        "pkg-26.1" = _INQnU4bm;
