...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.1-fabric" = _XonKrUIN;
        "pkg-1.18.2-2.1-fabric" = _eJgh1kye;
        "pkg-1.19.2-2.2-fabric" = _woqHHAYZ;
        "pkg-1.16.5-1.6-forge" = _Bkph5U77;
        "pkg-1.18.2-1.8-forge" = _DkeoP7Ka;
        "pkg-1.19.2-2.0-forge" = _2UKQBIb6;
        "pkg-1.16.5-2.3-fabric" = _MOEfUpPs;
        "pkg-1.18.2-2.3-fabric" = _arSd0QTJ;
        "pkg-1.19.2-2.3-fabric" = _wTDahE3e;
        "pkg-1.19.3-2.4-fabric" = _upFZ5klH;
        "pkg-1.19.3-2.0-forge" = _ZqrcaHql;
        "pkg-1.18.2-3.0-forge+fabric" = _H1Fwhe0b;
        "pkg-1.19.2-3.0-forge+fabric" = _bMQ9LdU3;
        "pkg-1.19.3-3.0-forge+fabric" = _q6o8SMjt;
        "pkg-1.19.4-3.0-forge+fabric" = _VV6jiBVp;
        "pkg-1.20-3.0-forge+fabric" = _fXlJaGrZ;
        "pkg-1.20.1-3.0-forge+fabric" = _Q9lWKJJh;
        "pkg-1.20.2-3.0-forge+fabric" = _W5ql9ZbQ;
        "pkg-1.18.2-3.1-forge+fabric" = _lbN345qk;
        "pkg-1.19.2-3.1-forge+fabric" = _yGXxpzkb;
        "pkg-1.20.1-3.1-forge+fabric" = _wjLFNSpc;
        "pkg-1.20.2-3.1-forge+fabric" = _q1N0gAbe;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _Kkl3PvXE;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _8M4p9Jwd;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _rTIaFmYP;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _30ClZeUN;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _wEvsMPa3;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _BOi9Fpgi;
        "pkg-1.19.2-3.3-fabric+forge" = _BiKg9NwY;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _PLOByAzT;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _bbLUq5sl;
        "pkg-1.20.5-3.3-fabric+neo" = _lB6gkFH1;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _JWtl0h6A;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _zBlkJIVz;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _ULbLAcjx;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _vdCIxSWD;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _TKrcqivg;
        "pkg-1.20.1-3.8-fabric+forge+neo" = _EIVEE0BH;
        "pkg-1.20.6-3.8-fabric+forge+neo" = _R4ecguT9;
        "pkg-1.21.0-3.8-fabric+forge+neo" = _LdWietPz;
        "pkg-1.21.1-3.8-fabric+forge+neo" = _xBoAYRE8;
        "pkg-1.21.2-3.8-fabric+neo" = _MhtXH9FM;
        "pkg-1.21.2-3.9-fabric+neo" = _OjbTbWB5;
        "pkg-1.21.3-3.9-fabric+forge+neo" = _2ecakozc;
        "pkg-1.21.4-3.9-fabric+forge+neo" = _sjozeBgc;
        "pkg-1.20.1-4.0-fabric+forge+neo" = _xFDnAS8R;
        "pkg-1.21.1-4.0-fabric+forge+neo" = _5Qka8LfN;
        "pkg-1.21.4-4.0-fabric+forge+neo" = _n0VdEOkQ;
        "pkg-1.21.5-4.0-fabric+forge+neo" = _DKpFUjXB;
        "pkg-1.21.6-4.0-fabric+forge+neo" = _LA2QZTBA;
        "pkg-1.21.7-4.0-fabric+forge+neo" = _vA2Sk0zM;
        "pkg-1.21.8-4.0-fabric+forge+neo" = _mNWXpzrm;
        "pkg-1.21.9-4.0-fabric+forge+neo" = _Xy4j1dXL;
        "pkg-1.21.10-4.0-fabric+forge+neo" = _7OJRbPyT;
        "pkg-1.21.11-4.0-fabric+forge+neo" = _XFlaLilP;
        "pkg-26.1.0-4.0-fabric+forge+neo" = _Oe2W6U22;
        "pkg-26.1.1-4.0-fabric+forge+neo" = _nmZamuYN;
        "pkg-26.1.2-4.0-fabric+forge+neo" = _l9R5U4ye;
        "pkg-1.20.1-4.1-fabric+forge+neo" = _mqbnwjVe;
        "pkg-1.21.1-4.1-fabric+forge+neo" = _IFWMImfs;
        "pkg-1.21.11-4.1-fabric+forge+neo" = _TCOma8qe;
        "pkg-26.1.2-4.1-fabric+forge+neo" = _iNDf3HBj;
        "pkg-26.2.0-4.1-fabric+forge+neo" = _dHTpgRuW;
        "default" = _dHTpgRuW;
    });
