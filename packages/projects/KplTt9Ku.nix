...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.5-fabric" = _WHzZSLKD;
        "pkg-1.18.2-2.5-fabric" = _8QEXEhTX;
        "pkg-1.19.2-2.5-fabric" = _N0LXLVGI;
        "pkg-1.16.5-2.5-forge" = _OzQTZCtX;
        "pkg-1.18.2-2.5-forge" = _ETRIfBbo;
        "pkg-1.19.2-2.5-forge" = _1IFSJP8h;
        "pkg-1.16.5-2.6-forge" = _7v5fGbpf;
        "pkg-1.18.2-2.6-forge" = _KLglvs1C;
        "pkg-1.19.2-2.6-forge" = _swO4RXXU;
        "pkg-1.16.5-2.7-fabric" = _m0CD24Rh;
        "pkg-1.18.2-2.7-fabric" = _7SXkp3YO;
        "pkg-1.19.2-2.7-fabric" = _sMimH4IZ;
        "pkg-1.16.5-2.9-fabric" = _sQlhuE3x;
        "pkg-1.18.2-2.9-fabric" = _wbfO3PgS;
        "pkg-1.19.2-2.9-fabric" = _NGN8Wr0Z;
        "pkg-1.16.5-2.9-forge" = _RMgpoxcB;
        "pkg-1.18.2-2.9-forge" = _ianuLvQ5;
        "pkg-1.19.2-2.9-forge" = _wfSdFPfN;
        "pkg-1.16.5-3.0-fabric" = _HVDv199h;
        "pkg-1.18.2-3.0-fabric" = _bqlOMowv;
        "pkg-1.19.2-3.0-fabric" = _uz6kDzlX;
        "pkg-1.16.5-3.0-forge" = _diXdQb8P;
        "pkg-1.18.2-3.0-forge" = _BXXev1Sv;
        "pkg-1.19.2-3.0-forge" = _uWmFxaGF;
        "pkg-1.19.3-3.1-fabric" = _BcsRwMq7;
        "pkg-1.19.3-3.0-forge" = _5hkJe1Sq;
        "pkg-1.18.2-4.0-forge+fabric" = _2orB0Qo5;
        "pkg-1.19.2-4.0-forge+fabric" = _pvqQ0iaa;
        "pkg-1.19.3-4.0-forge+fabric" = _LYLsMVCc;
        "pkg-1.19.4-4.0-forge+fabric" = _ljynbeAG;
        "pkg-1.20-4.0-forge+fabric" = _oZz3D98i;
        "pkg-1.20.1-4.0-forge+fabric" = _NPYG35Ur;
        "pkg-1.20.2-4.0-forge+fabric" = _w3jqtMxt;
        "pkg-1.18.2-4.1-forge+fabric" = _dpemVPW1;
        "pkg-1.19.2-4.1-forge+fabric" = _fA8UJDWI;
        "pkg-1.20.1-4.1-forge+fabric" = _YB7TafJ6;
        "pkg-1.20.2-4.1-forge+fabric" = _O3aJ4TG4;
        "pkg-1.20.3-4.1-fabric+forge+neo" = _QTJDhTKc;
        "pkg-1.20.4-4.1-fabric+forge+neo" = _fgu4fNqx;
        "pkg-1.19.2-4.2-fabric+forge+neo" = _aJ2VCyjt;
        "pkg-1.20.1-4.2-fabric+forge+neo" = _4Tzb8ngB;
        "pkg-1.20.2-4.2-fabric+forge+neo" = _UE9lBWoG;
        "pkg-1.20.4-4.2-fabric+forge+neo" = _Ueetajqa;
        "pkg-1.20.5-4.2-fabric+neo" = _NcFXnaT6;
        "pkg-1.20.5-4.3-fabric+neo" = _QBD7Mt8H;
        "pkg-1.20.6-4.3-fabric+forge+neo" = _aY5HlgAw;
        "pkg-1.21.0-4.3-fabric+forge+neo" = _xfyEepHb;
        "pkg-1.20.1-4.4-fabric+forge+neo" = _pmuo4Sz9;
        "pkg-1.20.6-4.4-fabric+forge+neo" = _7erNgNWY;
        "pkg-1.21.0-4.4-fabric+forge+neo" = _nVCjk1UD;
        "pkg-1.21.1-4.4-fabric+forge+neo" = _Vl3DreYU;
        "pkg-1.21.2-4.4-fabric+neo" = _5LdUPaXH;
        "pkg-1.21.3-4.4-fabric+forge+neo" = _nJPU1dvG;
        "pkg-1.21.4-4.4-fabric+forge+neo" = _ZhE9TvSt;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _fCv0fAKU;
        "pkg-1.21.1-4.5-fabric+forge+neo" = _mJvAnExd;
        "pkg-1.21.4-4.5-fabric+forge+neo" = _2YvZmV7D;
        "pkg-1.21.5-4.5-fabric+forge+neo" = _1dOAf6VD;
        "pkg-1.20.1-4.6-fabric+forge+neo" = _iFxBy0Mn;
        "pkg-1.21.1-4.6-fabric+forge+neo" = _YKnDyG5w;
        "pkg-1.21.4-4.6-fabric+forge+neo" = _EzxRbI8L;
        "pkg-1.21.5-4.6-fabric+forge+neo" = _ntccUn5Y;
        "pkg-1.21.6-4.6-fabric+forge+neo" = _EtujvnJn;
        "pkg-1.21.6-4.7-fabric+forge+neo" = _frt9GvQS;
        "pkg-1.21.7-4.7-fabric+forge+neo" = _jFAsDTFo;
        "pkg-1.21.8-4.7-fabric+forge+neo" = _iXTpJzSt;
        "pkg-1.21.9-4.7-fabric+forge+neo" = _OVjtWMoq;
        "pkg-1.21.10-4.7-fabric+forge+neo" = _uYqgYtt5;
        "pkg-1.21.11-4.7-fabric+forge+neo" = _AvTIGBQ2;
        "pkg-26.1.0-4.7-fabric+forge+neo" = _CYYoykR5;
        "pkg-26.1.1-4.7-fabric+forge+neo" = _i7kMMNLm;
        "pkg-26.1.2-4.7-fabric+forge+neo" = _LN6N6TzO;
        "pkg-26.2.0-4.7-fabric+forge+neo" = _Pr8px6cB;
        "default" = _Pr8px6cB;
    });
