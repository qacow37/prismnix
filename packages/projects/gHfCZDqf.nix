...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.4.4-forge" = _PXqpah54;
        "pkg-1.19.4-1.4.4-forge" = _BvDz4l9T;
        "pkg-1.20-1.4.4-forge" = _xelweabW;
        "pkg-1.18.2-1.4.5-forge" = _KGkTvwVP;
        "pkg-1.19.2-1.4.5-forge" = _TbivwqFU;
        "pkg-1.19.4-1.4.5-forge" = _xNzwQMJn;
        "pkg-1.20-1.4.5-forge" = _geViUWB3;
        "pkg-1.18.2-1.4.6-forge" = _iO0Rznok;
        "pkg-1.19.2-1.4.6-forge" = _croxF1op;
        "pkg-1.19.4-1.4.6-forge" = _65SbHGVe;
        "pkg-1.20.1-1.4.6-forge" = _UZFCWdau;
        "pkg-1.20.1-1.4.7-forge" = _xWvPzOl5;
        "pkg-1.16.5-1.4.2-forge" = _ihoQ9gXS;
        "pkg-1.17.1-1.3.6-forge" = _Un5uijvV;
        "pkg-1.18.2-1.4.8-forge" = _qvgyScTC;
        "pkg-1.19.2-1.4.8-forge" = _ma9dbBV8;
        "pkg-1.19.4-1.4.8-forge" = _7pYMQyel;
        "pkg-1.20.1-1.4.8-forge" = _Cp4rj11g;
        "pkg-1.18.2-1.4.9-forge" = _92MkDvOO;
        "pkg-1.19.2-1.4.9-forge" = _gPzfkmiV;
        "pkg-1.19.4-1.4.9-forge" = _DW0Ra3G4;
        "pkg-1.20.1-1.4.9-forge" = _MXa2LMRi;
        "pkg-1.19.2-1.4.9-fabric" = _SeI6jrwN;
        "pkg-1.19.4-1.4.9-fabric" = _yN7kQJCB;
        "pkg-1.20.1-1.4.9-fabric" = _X1zPd9Yv;
        "pkg-1.18.2-1.5.0-forge" = _2dQEg718;
        "pkg-1.19.2-1.5.0-forge" = _px0Y98Km;
        "pkg-1.19.4-1.5.0-forge" = _ceE7W5jB;
        "pkg-1.20.1-1.5.0-forge" = _GVD5o5qi;
        "pkg-1.19.2-1.5.0-fabric" = _YzBqUoaW;
        "pkg-1.19.4-1.5.0-fabric" = _NIJw4bOv;
        "pkg-1.20.1-1.5.0-fabric" = _RN9PGiGe;
        "pkg-1.18.2-1.5.1-forge" = _tJMibN2n;
        "pkg-1.19.2-1.5.1-forge" = _aIjP6OIf;
        "pkg-1.19.4-1.5.1-forge" = _Q6ZQ1XBi;
        "pkg-1.20.1-1.5.1-forge" = _7IGf2n9h;
        "pkg-1.20.2-1.5.1-forge" = _z22uR2iN;
        "pkg-1.19.2-1.5.1-fabric" = _A5pwemuB;
        "pkg-1.19.4-1.5.1-fabric" = _ykJhQMJz;
        "pkg-1.20.1-1.5.1-fabric" = _Rfano596;
        "pkg-1.20.2-1.5.1-fabric" = _bGqAuCOe;
        "pkg-1.18.2-1.5.2-forge" = _Bg66A4tv;
        "pkg-1.19.2-1.5.2-forge" = _CHSDk6ES;
        "pkg-1.19.4-1.5.2-forge" = _dQRtNGna;
        "pkg-1.20.1-1.5.2-forge" = _pIwkLtGs;
        "pkg-1.20.2-1.5.2-forge" = _8dGNmLr5;
        "pkg-1.19.2-1.5.2-fabric" = _g7VIP5GL;
        "pkg-1.19.4-1.5.2-fabric" = _XT1sA5Bs;
        "pkg-1.20.1-1.5.2-fabric" = _3tSzbdmo;
        "pkg-1.20.2-1.5.2-fabric" = _3viZ2o2G;
        "pkg-1.20.2-1.5.2-neoforge" = _WGjShbDs;
        "pkg-1.18.2-1.5.3-forge" = _mhb6dHXx;
        "pkg-1.19.2-1.5.3-fabric" = _MOfnr19R;
        "pkg-1.19.2-1.5.3-forge" = _YeLCR9iu;
        "pkg-1.19.4-1.5.3-fabric" = _dvlRy66I;
        "pkg-1.19.4-1.5.3-forge" = _NIIeRO9u;
        "pkg-1.20.1-1.5.3-fabric" = _5WjHWfXA;
        "pkg-1.20.1-1.5.3-forge" = _nKuul5Cz;
        "pkg-1.20.3-1.5.3-fabric" = _qQPxIkv5;
        "pkg-1.20.3-1.5.3-forge" = _GPjEwvHj;
        "pkg-1.20.3-1.5.3-neoforge" = _MPrAIIvk;
        "pkg-1.19.2-1.5.4-fabric" = _U7XYFK8n;
        "pkg-1.19.4-1.5.4-fabric" = _Io8RKst8;
        "pkg-1.20.1-1.5.4-fabric" = _uzvfOgFf;
        "pkg-1.20.4-1.5.4-fabric" = _5P0rqDlR;
        "pkg-1.18.2-1.5.4-forge" = _v8jcDduY;
        "pkg-1.19.2-1.5.4-forge" = _vLea0Cof;
        "pkg-1.19.4-1.5.4-forge" = _FAHtj9jT;
        "pkg-1.20.1-1.5.4-forge" = _XN7VBlUW;
        "pkg-1.20.4-1.5.4-forge" = _DPScR9Fi;
        "pkg-1.20.4-1.5.4-neoforge" = _yhbD4arz;
        "pkg-1.18.2-1.6.0-fabric" = _X3SA8agm;
        "pkg-1.19.2-1.6.0-fabric" = _4DTvW373;
        "pkg-1.19.4-1.6.0-fabric" = _e7PHKHnE;
        "pkg-1.20.1-1.6.0-fabric" = _GOK4p4uF;
        "pkg-1.20.4-1.6.0-fabric" = _dfkNkEQh;
        "pkg-1.18.2-1.6.0-forge" = _EIf58Tt8;
        "pkg-1.19.2-1.6.0-forge" = _Y9kR0QX3;
        "pkg-1.19.4-1.6.0-forge" = _DlVQyk3n;
        "pkg-1.20.1-1.6.0-forge" = _suOI1uwX;
        "pkg-1.20.4-1.6.0-forge" = _BfUBMfZ3;
        "pkg-1.20.4-1.6.0-neoforge" = _dkR4arAC;
        "pkg-1.18.2-1.6.1-fabric" = _BEwdYgMI;
        "pkg-1.19.2-1.6.1-fabric" = _K65L9I9F;
        "pkg-1.19.4-1.6.1-fabric" = _wdkLXTk1;
        "pkg-1.20.1-1.6.1-fabric" = _2KggHIiT;
        "pkg-1.20.5-1.6.1-fabric" = _MCwkEMDb;
        "pkg-1.18.2-1.6.1-forge" = _uZgPSDx7;
        "pkg-1.19.2-1.6.1-forge" = _NxvVLFcn;
        "pkg-1.19.4-1.6.1-forge" = _2qURgF30;
        "pkg-1.20.1-1.6.1-forge" = _rEgo6iLk;
        "pkg-1.20.5-1.6.1-neoforge" = _KswEXTgg;
        "pkg-1.20.6-1.6.1-fabric" = _GMcGRE6S;
        "pkg-1.20.6-1.6.1-neoforge" = _feTcs5cV;
        "pkg-1.20.6-1.6.1-forge" = _OZS1OgI1;
        "pkg-1.20.6-1.6.2-fabric" = _jFQRocFm;
        "pkg-1.20.6-1.6.2-forge" = _m6qWYNPi;
        "pkg-1.20.6-1.6.2-neoforge" = _ZpLYQz4P;
        "pkg-1.21-1.6.2-fabric" = _gbmBUUKn;
        "pkg-1.21-1.6.2-forge" = _XXG6qDrk;
        "pkg-1.21-1.6.2-neoforge" = _9USdWorb;
        "pkg-1.18.2-1.6.3-fabric" = _eeqQ2AU3;
        "pkg-1.19.2-1.6.3-fabric" = _TCIe5piz;
        "pkg-1.19.4-1.6.3-fabric" = _YxFI46r6;
        "pkg-1.20.1-1.6.3-fabric" = _odcn1InA;
        "pkg-1.20.6-1.6.3-fabric" = _MaaaZ8LV;
        "pkg-1.21-1.6.3-fabric" = _6Rw07bg2;
        "pkg-1.18.2-1.6.3-forge" = _GA9uSoFi;
        "pkg-1.19.2-1.6.3-forge" = _rGbAdmla;
        "pkg-1.19.4-1.6.3-forge" = _NZJv9vGg;
        "pkg-1.20.1-1.6.3-forge" = _3dVST2oK;
        "pkg-1.20.6-1.6.3-forge" = _cZ9NpNkC;
        "pkg-1.20.6-1.6.3-neoforge" = _w7R3S8OI;
        "pkg-1.21-1.6.3-forge" = _rL47xH4X;
        "pkg-1.21-1.6.3-neoforge" = _4zOvMjKr;
        "pkg-1.20.4-1.6.3-fabric" = _7v5Ih2KP;
        "pkg-1.20.4-1.6.3-forge" = _GKGLcIZf;
        "pkg-1.20.4-1.6.3-neoforge" = _wrCZynTM;
        "pkg-1.18.2-1.6.4-fabric" = _8SF9HnZy;
        "pkg-1.19.2-1.6.4-fabric" = _x6OHTy50;
        "pkg-1.19.4-1.6.4-fabric" = _fQ6dFq74;
        "pkg-1.20.1-1.6.4-fabric" = _5sbcasIv;
        "pkg-1.20.4-1.6.4-fabric" = _fBVsDeMo;
        "pkg-1.20.6-1.6.4-fabric" = _UMr2mnJ5;
        "pkg-1.21-1.6.4-fabric" = _kPcNTJFx;
        "pkg-1.18.2-1.6.4-forge" = _1dO4JHs2;
        "pkg-1.19.2-1.6.4-forge" = _FEBgxKhs;
        "pkg-1.19.4-1.6.4-forge" = _Xu9a3Q98;
        "pkg-1.20.1-1.6.4-forge" = _oWy22Ejb;
        "pkg-1.20.4-1.6.4-forge" = _yxk1wZvq;
        "pkg-1.20.4-1.6.4-neoforge" = _wJpdwQNM;
        "pkg-1.20.6-1.6.4-forge" = _V6hhVrVv;
        "pkg-1.20.6-1.6.4-neoforge" = _heryiakl;
        "pkg-1.21-1.6.4-forge" = _NGCdNAit;
        "pkg-1.21-1.6.4-neoforge" = _dUO0lVyo;
        "pkg-1.18.2-1.6.5-fabric" = _fPWNv6Pp;
        "pkg-1.19.2-1.6.5-fabric" = _EciiglR3;
        "pkg-1.19.4-1.6.5-fabric" = _Pf0PdY9A;
        "pkg-1.20.1-1.6.5-fabric" = _YeCAHwql;
        "pkg-1.20.4-1.6.5-fabric" = _RffCGfis;
        "pkg-1.20.6-1.6.5-fabric" = _4vsMIjb8;
        "pkg-1.21-1.6.5-fabric" = _RTtwEl45;
        "pkg-1.18.2-1.6.5-forge" = _SZHNAQPf;
        "pkg-1.19.2-1.6.5-forge" = _pxeXEshe;
        "pkg-1.19.4-1.6.5-forge" = _7HmUX5XB;
        "pkg-1.20.1-1.6.5-forge" = _BnWgLI8o;
        "pkg-1.20.4-1.6.5-forge" = _mNO3hleU;
        "pkg-1.20.4-1.6.5-neoforge" = _IR9orqNu;
        "pkg-1.20.6-1.6.5-forge" = _Hmc6OW6A;
        "pkg-1.20.6-1.6.5-neoforge" = _Ext4dyX7;
        "pkg-1.21-1.6.5-forge" = _c8HUrEIG;
        "pkg-1.21-1.6.5-neoforge" = _KbQoE5sh;
        "pkg-1.21-1.6.6-forge" = _foycmzCv;
        "pkg-1.18.2-1.7.0-fabric" = _ohgMDkBs;
        "pkg-1.18.2-1.7.0-forge" = _78AgsWTv;
        "pkg-1.19.2-1.7.0-fabric" = _Q6RaHM7n;
        "pkg-1.19.2-1.7.0-forge" = _KN1gBLmg;
        "pkg-1.19.4-1.7.0-fabric" = _4IVvzDVr;
        "pkg-1.19.4-1.7.0-forge" = _OASXHqAc;
        "pkg-1.20.1-1.7.0-fabric" = _YhjhHOKW;
        "pkg-1.20.1-1.7.0-forge" = _KClnVkE0;
        "pkg-1.20.4-1.7.0-fabric" = _MwARRLTZ;
        "pkg-1.20.4-1.7.0-forge" = _rwf6q1ug;
        "pkg-1.20.4-1.7.0-neoforge" = _m3TiRRkN;
        "pkg-1.20.6-1.7.0-fabric" = _YOCyPKj3;
        "pkg-1.20.6-1.7.0-forge" = _ng74ZXZA;
        "pkg-1.20.6-1.7.0-neoforge" = _3dGKT34W;
        "pkg-1.21-1.7.0-fabric" = _OXumEoG6;
        "pkg-1.21-1.7.0-forge" = _wrdMC988;
        "pkg-1.21-1.7.0-neoforge" = _yITki1fZ;
        "pkg-1.18.2-1.7.1-fabric" = _U8MJL4va;
        "pkg-1.18.2-1.7.1-forge" = _ZDNqPYnR;
        "pkg-1.19.2-1.7.1-fabric" = _B5yjq2DU;
        "pkg-1.19.2-1.7.1-forge" = _iJcsHc6J;
        "pkg-1.19.4-1.7.1-fabric" = _hn7We3EX;
        "pkg-1.19.4-1.7.1-forge" = _6Ie6TF8v;
        "pkg-1.20.1-1.7.1-fabric" = _a1h1ruXj;
        "pkg-1.20.1-1.7.1-forge" = _6I1HJkBR;
        "pkg-1.20.4-1.7.1-fabric" = _ZDImsKa3;
        "pkg-1.20.4-1.7.1-forge" = _oj7uzuGz;
        "pkg-1.20.4-1.7.1-neoforge" = _S9IfJppo;
        "pkg-1.20.6-1.7.1-fabric" = _T5XI47rA;
        "pkg-1.20.6-1.7.1-neoforge" = _dbtL2rW3;
        "pkg-1.21-1.7.1-fabric" = _35VEQByM;
        "pkg-1.21-1.7.1-neoforge" = _wvrOWjsi;
        "pkg-1.20.6-1.7.1-forge" = _1MtROAlp;
        "pkg-1.21-1.7.1-forge" = _KJL8Y7Z0;
        "pkg-1.21.1-1.7.1-fabric" = _xdxiV9De;
        "pkg-1.21.1-1.7.1-forge" = _aViScZcH;
        "pkg-1.21.1-1.7.1-neoforge" = _IEvXf8PM;
        "pkg-1.19.2-1.7.2-fabric" = _YUjwApQC;
        "pkg-1.19.2-1.7.2-forge" = _WI1pqN8g;
        "pkg-1.19.4-1.7.2-fabric" = _ssUE8PTC;
        "pkg-1.19.4-1.7.2-forge" = _d6g52thK;
        "pkg-1.20.1-1.7.2-fabric" = _49R3nOQh;
        "pkg-1.20.1-1.7.2-forge" = _qJUElLBN;
        "pkg-1.20.4-1.7.2-fabric" = _YfbfEJts;
        "pkg-1.20.4-1.7.2-forge" = _OubYkdt2;
        "pkg-1.20.4-1.7.2-neoforge" = _jzfUxd4i;
        "pkg-1.20.6-1.7.2-forge" = _LxuGX0g9;
        "pkg-1.20.6-1.7.2-neoforge" = _pKwOb8nq;
        "pkg-1.21.1-1.7.2-forge" = _8Dm7eywp;
        "pkg-1.21.1-1.7.2-neoforge" = _JXZaVrSz;
        "pkg-1.18.2-1.7.2-fabric" = _WPMqiB3L;
        "pkg-1.18.2-1.7.2-forge" = _wwB3oT5W;
        "pkg-1.20.6-1.7.2-fabric" = _9WN19iiv;
        "pkg-1.21.1-1.7.2-fabric" = _iqj2sAI0;
        "pkg-1.18.2-1.7.3-fabric" = _vdufOlGK;
        "pkg-1.18.2-1.7.3-forge" = _oYTQY7ux;
        "pkg-1.19.2-1.7.3-fabric" = _CNIOe6pH;
        "pkg-1.19.2-1.7.3-forge" = _HzCxh28H;
        "pkg-1.19.4-1.7.3-fabric" = _8w6Vm4N5;
        "pkg-1.19.4-1.7.3-forge" = _6YaM4BFs;
        "pkg-1.20.1-1.7.3-fabric" = _YkdRKOvV;
        "pkg-1.20.1-1.7.3-forge" = _WuEUSjK8;
        "pkg-1.20.4-1.7.3-fabric" = _fxeh5fXi;
        "pkg-1.20.4-1.7.3-forge" = _XxxaSIJF;
        "pkg-1.20.4-1.7.3-neoforge" = _v5DTuhdO;
        "pkg-1.20.6-1.7.3-fabric" = _fFkI4yZa;
        "pkg-1.20.6-1.7.3-forge" = _B9PHEfvV;
        "pkg-1.20.6-1.7.3-neoforge" = _a0iudGKJ;
        "pkg-1.21.1-1.7.3-fabric" = _yp4LKBVY;
        "pkg-1.21.1-1.7.3-forge" = _oSlwj9dy;
        "pkg-1.21.1-1.7.3-neoforge" = _JOtgmho7;
        "pkg-1.18.2-1.7.4-fabric" = _eHs75ViV;
        "pkg-1.18.2-1.7.4-forge" = _scEe4tBt;
        "pkg-1.19.2-1.7.4-fabric" = _AhCdggWr;
        "pkg-1.19.2-1.7.4-forge" = _EJIi4Umh;
        "pkg-1.19.4-1.7.4-fabric" = _QoeoXF8A;
        "pkg-1.19.4-1.7.4-forge" = _UkTbO8VU;
        "pkg-1.20.1-1.7.4-fabric" = _8eyT5M1L;
        "pkg-1.20.1-1.7.4-forge" = _IBpFdJma;
        "pkg-1.20.4-1.7.4-fabric" = _V7vbrXYv;
        "pkg-1.20.4-1.7.4-forge" = _qpyHQMdn;
        "pkg-1.20.4-1.7.4-neoforge" = _A3z3Waa9;
        "pkg-1.20.6-1.7.4-fabric" = _kl2HBuhA;
        "pkg-1.20.6-1.7.4-forge" = _ZNTOlfsz;
        "pkg-1.20.6-1.7.4-neoforge" = _RUGF6475;
        "pkg-1.21.1-1.7.4-fabric" = _DBye0tIy;
        "pkg-1.21.1-1.7.4-forge" = _ISUWEc9j;
        "pkg-1.21.1-1.7.4-neoforge" = _lRykUgP6;
        "pkg-1.18.2-1.7.5-fabric" = _RAN3Awnn;
        "pkg-1.18.2-1.7.5-forge" = _Zyf5bTY6;
        "pkg-1.19.2-1.7.5-fabric" = _99pEYQcA;
        "pkg-1.19.2-1.7.5-forge" = _UpkBqDb2;
        "pkg-1.19.4-1.7.5-fabric" = _rEsHk4il;
        "pkg-1.19.4-1.7.5-forge" = _1sDUvI8v;
        "pkg-1.20.1-1.7.5-fabric" = _RkdKWjNM;
        "pkg-1.20.1-1.7.5-forge" = _fFgiZLJk;
        "pkg-1.20.4-1.7.5-fabric" = _urXgXzf1;
        "pkg-1.20.4-1.7.5-forge" = _5g5pDDbo;
        "pkg-1.20.4-1.7.5-neoforge" = _NVQb8Ymj;
        "pkg-1.20.6-1.7.5-fabric" = _l6W6BghM;
        "pkg-1.20.6-1.7.5-forge" = _s0EfuzpT;
        "pkg-1.20.6-1.7.5-neoforge" = _1lAna22S;
        "pkg-1.21.1-1.7.5-fabric" = _23MW6nWK;
        "pkg-1.21.1-1.7.5-forge" = _EolRrxwp;
        "pkg-1.21.1-1.7.5-neoforge" = _K3U2RsQM;
        "pkg-1.18.2-1.7.6-fabric" = _T7uJ4oFZ;
        "pkg-1.18.2-1.7.6-forge" = _wmUIu477;
        "pkg-1.19.2-1.7.6-fabric" = _MD1RVSEk;
        "pkg-1.19.2-1.7.6-forge" = _KlvH6lKO;
        "pkg-1.19.4-1.7.6-fabric" = _5rOP4wGh;
        "pkg-1.19.4-1.7.6-forge" = _7HhCzoDV;
        "pkg-1.20.1-1.7.6-fabric" = _slKSei4j;
        "pkg-1.20.1-1.7.6-forge" = _DsNulsO2;
        "pkg-1.20.4-1.7.6-fabric" = _jgXaXUvA;
        "pkg-1.20.4-1.7.6-forge" = _8yHSs0WP;
        "pkg-1.20.4-1.7.6-neoforge" = _CiiukaIt;
        "pkg-1.20.6-1.7.6-fabric" = _fjMbbRcf;
        "pkg-1.20.6-1.7.6-forge" = _yDgPfbuD;
        "pkg-1.20.6-1.7.6-neoforge" = _KAndbCsa;
        "pkg-1.21.1-1.7.6-fabric" = _WrmEBcaP;
        "pkg-1.21.1-1.7.6-forge" = _pBXvdWFU;
        "pkg-1.21.1-1.7.6-neoforge" = _zfg0kxjT;
        "pkg-1.21.1-1.7.7-fabric" = _O4s6IEQy;
        "pkg-1.21.1-1.7.7-forge" = _WDvv3lVA;
        "pkg-1.21.1-1.7.7-neoforge" = _km1OWtKF;
        "pkg-1.18.2-1.7.8-fabric" = _sTe8auMk;
        "pkg-1.18.2-1.7.8-forge" = _ooGA7KYV;
        "pkg-1.19.2-1.7.8-fabric" = _lv0WEobc;
        "pkg-1.19.2-1.7.8-forge" = _LwUgpt8k;
        "pkg-1.19.4-1.7.8-fabric" = _t640SEQH;
        "pkg-1.19.4-1.7.8-forge" = _P8346Phq;
        "pkg-1.20.1-1.7.8-fabric" = _nidc9KlX;
        "pkg-1.20.1-1.7.8-forge" = _B55fmYri;
        "pkg-1.20.4-1.7.8-fabric" = _Hoh4fZuU;
        "pkg-1.20.4-1.7.8-forge" = _2nN4BtxT;
        "pkg-1.20.4-1.7.8-neoforge" = _idEfBzdl;
        "pkg-1.20.6-1.7.8-fabric" = _yf6UNAzd;
        "pkg-1.20.6-1.7.8-forge" = _wG3j8QhS;
        "pkg-1.20.6-1.7.8-neoforge" = _DROlkm9x;
        "pkg-1.21.1-1.7.8-fabric" = _4HX0T06j;
        "pkg-1.21.1-1.7.8-forge" = _W9ib1baH;
        "pkg-1.21.1-1.7.8-neoforge" = _EQPeMGFP;
        "pkg-1.21.3-1.7.8-fabric" = _WOjEY69L;
        "pkg-1.21.3-1.7.8-neoforge" = _PPktn9Z3;
        "pkg-1.21.3-1.7.8-forge" = _iCoBJMFk;
        "pkg-1.18.2-1.7.9-fabric" = _VOMsdEKq;
        "pkg-1.18.2-1.7.9-forge" = _CS6hcGyF;
        "pkg-1.19.2-1.7.9-fabric" = _vFkSpVvx;
        "pkg-1.19.2-1.7.9-forge" = _B1WIHpN1;
        "pkg-1.19.4-1.7.9-fabric" = _QS5sJnql;
        "pkg-1.19.4-1.7.9-forge" = _5jbg6vqY;
        "pkg-1.20.1-1.7.9-fabric" = _oGTzrq3R;
        "pkg-1.20.1-1.7.9-forge" = _mvaFbnGJ;
        "pkg-1.20.4-1.7.9-fabric" = _nqFgQRvv;
        "pkg-1.20.4-1.7.9-forge" = _m37eP59v;
        "pkg-1.20.4-1.7.9-neoforge" = _wm7tmnPM;
        "pkg-1.20.6-1.7.9-fabric" = _uDhqbETi;
        "pkg-1.20.6-1.7.9-forge" = _Qdxbbgeh;
        "pkg-1.20.6-1.7.9-neoforge" = _6QTk6Ohb;
        "pkg-1.21.1-1.7.9-fabric" = _7g0SAr1Y;
        "pkg-1.21.1-1.7.9-forge" = _I88tlWHo;
        "pkg-1.21.1-1.7.9-neoforge" = _wZSoFD1j;
        "pkg-1.21.3-1.7.9-fabric" = _O2f0XKSj;
        "pkg-1.21.3-1.7.9-forge" = _52BnixQX;
        "pkg-1.21.3-1.7.9-neoforge" = _uYmldchL;
        "pkg-1.18.2-1.7.10-fabric" = _HBmUnuLZ;
        "pkg-1.18.2-1.7.10-forge" = _cgKfAMhz;
        "pkg-1.19.2-1.7.10-fabric" = _swIEouqY;
        "pkg-1.19.2-1.7.10-forge" = _79ubIP7I;
        "pkg-1.19.4-1.7.10-fabric" = _iEPKR21Q;
        "pkg-1.19.4-1.7.10-forge" = _5ASGJmLD;
        "pkg-1.20.1-1.7.10-fabric" = _s1CLIcLJ;
        "pkg-1.20.1-1.7.10-forge" = _KWbVD4Dc;
        "pkg-1.20.4-1.7.10-fabric" = _CTYTf0kK;
        "pkg-1.20.4-1.7.10-forge" = _4PL4ZqiU;
        "pkg-1.20.4-1.7.10-neoforge" = _BJEexP4G;
        "pkg-1.20.6-1.7.10-fabric" = _fWqLH6TT;
        "pkg-1.20.6-1.7.10-forge" = _zHxMcAuv;
        "pkg-1.20.6-1.7.10-neoforge" = _BsvlcCEX;
        "pkg-1.21.1-1.7.10-fabric" = _wI6JhiJt;
        "pkg-1.21.1-1.7.10-forge" = _an6Kjcpg;
        "pkg-1.21.1-1.7.10-neoforge" = _phedZpZ4;
        "pkg-1.21.3-1.7.10-fabric" = _N4RKNbRO;
        "pkg-1.21.3-1.7.10-forge" = _GPapuB7S;
        "pkg-1.21.3-1.7.10-neoforge" = _uCSdzlJ9;
        "pkg-1.21.4-1.7.10-fabric" = _FfSnXmd2;
        "pkg-1.21.4-1.7.10-neoforge" = _VwyMhuqU;
        "pkg-1.21.4-1.7.10-forge" = _YXLFDPTZ;
        "pkg-1.21.3-1.7.11-fabric" = _AAEdOfHE;
        "pkg-1.21.3-1.7.11-forge" = _u4EriqFc;
        "pkg-1.21.3-1.7.11-neoforge" = _OEyB6qHM;
        "pkg-1.21.4-1.7.11-fabric" = _IaatC24X;
        "pkg-1.21.4-1.7.11-forge" = _tWBO9S2A;
        "pkg-1.21.4-1.7.11-neoforge" = _eJJ9AyKe;
        "pkg-1.21.4-1.7.12-neoforge" = _7YmCXvI2;
        "pkg-1.18.2-1.8.0-fabric" = _vXcTkx6m;
        "pkg-1.18.2-1.8.0-forge" = _fpomYzQX;
        "pkg-1.19.2-1.8.0-fabric" = _QcvCqRCJ;
        "pkg-1.19.2-1.8.0-forge" = _p5EahWwN;
        "pkg-1.19.4-1.8.0-fabric" = _e9fnT2PL;
        "pkg-1.19.4-1.8.0-forge" = _u3Nz1MHk;
        "pkg-1.20.1-1.8.0-fabric" = _xAw51dGW;
        "pkg-1.20.1-1.8.0-forge" = _zeyLRdiX;
        "pkg-1.20.4-1.8.0-fabric" = _eiY1eRSW;
        "pkg-1.20.4-1.8.0-forge" = _qiKeSyOK;
        "pkg-1.20.4-1.8.0-neoforge" = _qvFpMtKL;
        "pkg-1.20.6-1.8.0-fabric" = _AFbYvgnb;
        "pkg-1.20.6-1.8.0-forge" = _Y7ME9pJi;
        "pkg-1.20.6-1.8.0-neoforge" = _BNb0J7Fp;
        "pkg-1.21.1-1.8.0-fabric" = _WlzGD1Dk;
        "pkg-1.21.1-1.8.0-forge" = _fJRjo6fw;
        "pkg-1.21.1-1.8.0-neoforge" = _oEnjFW3n;
        "pkg-1.21.3-1.8.0-fabric" = _OLnDH6BJ;
        "pkg-1.21.3-1.8.0-forge" = _mXeOeC6z;
        "pkg-1.21.3-1.8.0-neoforge" = _QDLKqni0;
        "pkg-1.21.4-1.8.0-fabric" = _Xeossm9Z;
        "pkg-1.21.4-1.8.0-forge" = _MH4ZIJoN;
        "pkg-1.21.4-1.8.0-neoforge" = _7841nDxK;
        "pkg-1.18.2-1.8.1-fabric" = _kX1NCzCF;
        "pkg-1.18.2-1.8.1-forge" = _dDvCeQy6;
        "pkg-1.19.2-1.8.1-fabric" = _sRh32AUj;
        "pkg-1.19.2-1.8.1-forge" = _Fj3LWoQz;
        "pkg-1.19.4-1.8.1-fabric" = _jsIPaEOk;
        "pkg-1.19.4-1.8.1-forge" = _U2lBYJQp;
        "pkg-1.20.1-1.8.1-fabric" = _qTUrUcKC;
        "pkg-1.20.1-1.8.1-forge" = _pa3RTGc9;
        "pkg-1.20.4-1.8.1-fabric" = _7OUtzGjy;
        "pkg-1.20.4-1.8.1-forge" = _61uUq2RJ;
        "pkg-1.20.4-1.8.1-neoforge" = _iRMylS6c;
        "pkg-1.21.3-1.8.1-fabric" = _SdHnbNpM;
        "pkg-1.21.3-1.8.1-forge" = _g2QXbc4a;
        "pkg-1.21.3-1.8.1-neoforge" = _AqrvyAis;
        "pkg-1.21.4-1.8.1-fabric" = _FMwc6tZV;
        "pkg-1.21.4-1.8.1-forge" = _6Jn21LeL;
        "pkg-1.21.4-1.8.1-neoforge" = _9l87TtPx;
        "pkg-1.20.6-1.8.1-fabric" = _Xltm2EIf;
        "pkg-1.20.6-1.8.1-forge" = _MLUUBIoe;
        "pkg-1.20.6-1.8.1-neoforge" = _D7gpZymT;
        "pkg-1.21.1-1.8.1-fabric" = _FmpH1oOZ;
        "pkg-1.21.1-1.8.1-forge" = _8h0kCfxR;
        "pkg-1.21.1-1.8.1-neoforge" = _dd4WzMDc;
        "pkg-1.20.1-1.8.2-fabric" = _yHzdYBQy;
        "pkg-1.20.1-1.8.2-forge" = _gj1C1sDJ;
        "pkg-1.18.2-1.8.3-fabric" = _aQTn1DZo;
        "pkg-1.18.2-1.8.3-forge" = _iiBRBTnV;
        "pkg-1.19.2-1.8.3-fabric" = _1RwuWJv8;
        "pkg-1.19.2-1.8.3-forge" = _AFKUGdDT;
        "pkg-1.19.4-1.8.3-fabric" = _BXiQX9aB;
        "pkg-1.19.4-1.8.3-forge" = _uXRqbnxN;
        "pkg-1.20.1-1.8.3-fabric" = _J3I9edT1;
        "pkg-1.20.1-1.8.3-forge" = _M1rEMNn1;
        "pkg-1.20.4-1.8.3-fabric" = _9OCG6Iex;
        "pkg-1.20.4-1.8.3-forge" = _UFSlhY3K;
        "pkg-1.20.4-1.8.3-neoforge" = _eAC9TsFJ;
        "pkg-1.20.6-1.8.3-fabric" = _ahxMZ7tz;
        "pkg-1.20.6-1.8.3-forge" = _FiTFKV5F;
        "pkg-1.20.6-1.8.3-neoforge" = _PiN3FSxV;
        "pkg-1.21.1-1.8.3-fabric" = _sWU8CxYZ;
        "pkg-1.21.1-1.8.3-forge" = _Y7WCPBag;
        "pkg-1.21.1-1.8.3-neoforge" = _Fu0TX8Jy;
        "pkg-1.21.3-1.8.3-fabric" = _oDgBWf6J;
        "pkg-1.21.3-1.8.3-forge" = _h06DwBsZ;
        "pkg-1.21.3-1.8.3-neoforge" = _f6A5yk5t;
        "pkg-1.21.4-1.8.3-fabric" = _hH9S4Um1;
        "pkg-1.21.4-1.8.3-forge" = _1FxsioHx;
        "pkg-1.21.4-1.8.3-neoforge" = _buqU4QXT;
        "pkg-1.18.2-1.8.4-fabric" = _lE9S7W6q;
        "pkg-1.18.2-1.8.4-forge" = _zXnQ1JTG;
        "pkg-1.19.2-1.8.4-fabric" = _F4w7zjm7;
        "pkg-1.19.2-1.8.4-forge" = _Jmmcbq8D;
        "pkg-1.19.4-1.8.4-fabric" = _9XHmvIci;
        "pkg-1.19.4-1.8.4-forge" = _urUC9dBz;
        "pkg-1.20.1-1.8.4-fabric" = _Htr98EIt;
        "pkg-1.20.1-1.8.4-forge" = _kCZH1k7O;
        "pkg-1.20.4-1.8.4-fabric" = _UJtJzr5y;
        "pkg-1.20.4-1.8.4-forge" = _PRycw2o9;
        "pkg-1.20.4-1.8.4-neoforge" = _ADtyzT4Q;
        "pkg-1.20.6-1.8.4-fabric" = _yZKBYwEj;
        "pkg-1.20.6-1.8.4-forge" = _ALgnNA3F;
        "pkg-1.20.6-1.8.4-neoforge" = _BSf0Qgr6;
        "pkg-1.21.1-1.8.4-fabric" = _y8ECtzey;
        "pkg-1.21.1-1.8.4-forge" = _ggpskgs5;
        "pkg-1.21.1-1.8.4-neoforge" = _jidY2XyG;
        "pkg-1.21.3-1.8.4-fabric" = _vUE4jOvH;
        "pkg-1.21.3-1.8.4-forge" = _AMfPOgH6;
        "pkg-1.21.3-1.8.4-neoforge" = _OnrPyX37;
        "pkg-1.21.4-1.8.4-fabric" = _GTLgrOnz;
        "pkg-1.21.4-1.8.4-forge" = _FhbZBL4Q;
        "pkg-1.21.4-1.8.4-neoforge" = _8Pvf0Fjq;
        "pkg-1.21.5-1.8.4-fabric" = _NMuQqS7b;
        "pkg-1.21.5-1.8.4-neoforge" = _pZ8nvNen;
        "pkg-1.18.2-1.8.5-fabric" = _QAON9eSA;
        "pkg-1.18.2-1.8.5-forge" = _wLQWPZ6q;
        "pkg-1.19.2-1.8.5-fabric" = _Tdo9w01U;
        "pkg-1.19.2-1.8.5-forge" = _2eX3ZJjA;
        "pkg-1.19.4-1.8.5-fabric" = _CpDTFsx3;
        "pkg-1.19.4-1.8.5-forge" = _v6HD8Kem;
        "pkg-1.20.1-1.8.5-fabric" = _yIdHI7ey;
        "pkg-1.20.1-1.8.5-forge" = _KDdCBkx5;
        "pkg-1.20.4-1.8.5-fabric" = _ozLZFMT0;
        "pkg-1.20.4-1.8.5-forge" = _ZXXpVweI;
        "pkg-1.20.4-1.8.5-neoforge" = _ceygSRlV;
        "pkg-1.20.6-1.8.5-fabric" = _UNAG9OED;
        "pkg-1.20.6-1.8.5-forge" = _6fgN3acT;
        "pkg-1.20.6-1.8.5-neoforge" = _ck94TKk0;
        "pkg-1.21.1-1.8.5-fabric" = _B1EH92Ki;
        "pkg-1.21.1-1.8.5-forge" = _1TWEXlnM;
        "pkg-1.21.1-1.8.5-neoforge" = _MQec7Ryz;
        "pkg-1.21.3-1.8.5-fabric" = _vwD9zYqN;
        "pkg-1.21.3-1.8.5-forge" = _42xvJl4R;
        "pkg-1.21.3-1.8.5-neoforge" = _76Dqh8QT;
        "pkg-1.21.4-1.8.5-fabric" = _msUDIXVd;
        "pkg-1.21.4-1.8.5-forge" = _wN1hdDdc;
        "pkg-1.21.4-1.8.5-neoforge" = _J2pVhwZE;
        "pkg-1.21.5-1.8.5-fabric" = _dj7yJcpO;
        "pkg-1.21.5-1.8.5-neoforge" = _Aq5Vicem;
        "pkg-1.21.5-1.8.5-forge" = _HIsXyMe2;
        "pkg-1.20.1-1.8.6-fabric" = _LTHqrMGL;
        "pkg-1.20.1-1.8.6-forge" = _EaGAYsgG;
        "pkg-1.20.4-1.8.6-fabric" = _Lc69XsU4;
        "pkg-1.20.4-1.8.6-forge" = _N8PbGJng;
        "pkg-1.20.4-1.8.6-neoforge" = _BefcDg6E;
        "pkg-1.20.6-1.8.6-fabric" = _Et7Pkex3;
        "pkg-1.20.6-1.8.6-forge" = _ph5RZEeh;
        "pkg-1.20.6-1.8.6-neoforge" = _8pJzWQCR;
        "pkg-1.21.1-1.8.6-fabric" = _Q5QLNHGj;
        "pkg-1.21.1-1.8.6-forge" = _9I3jttMh;
        "pkg-1.21.1-1.8.6-neoforge" = _vkSFnfRV;
        "pkg-1.21.3-1.8.6-fabric" = _VE9tLUal;
        "pkg-1.21.3-1.8.6-forge" = _qP5P1mR4;
        "pkg-1.21.3-1.8.6-neoforge" = _CaIurLbg;
        "pkg-1.21.4-1.8.6-fabric" = _BZMsK9kS;
        "pkg-1.21.4-1.8.6-forge" = _dsHOQOFR;
        "pkg-1.21.4-1.8.6-neoforge" = _uq3DhC5H;
        "pkg-1.21.5-1.8.6-fabric" = _19ujFeJ8;
        "pkg-1.21.5-1.8.6-forge" = _EBe0H4j4;
        "pkg-1.21.5-1.8.6-neoforge" = _U41xdoyV;
        "pkg-1.21.6-1.8.6-fabric" = _3cWPaKiN;
        "pkg-1.21.6-1.8.6-neoforge" = _qzomk0zd;
        "pkg-1.21.6-1.8.6-forge" = _fucThXna;
        "pkg-1.21.7-1.8.6-fabric" = _UWGUfTrU;
        "pkg-1.21.7-1.8.6-forge" = _5hrOit5g;
        "pkg-1.21.7-1.8.6-neoforge" = _hJkFJrDD;
        "pkg-1.21.8-1.8.6-fabric" = _XLfbPDYv;
        "pkg-1.21.8-1.8.6-forge" = _QabujLsQ;
        "pkg-1.21.8-1.8.6-neoforge" = _9Q0Q7lwB;
        "pkg-1.21.9-1.8.6-fabric" = _r7TQcvln;
        "pkg-1.21.9-1.8.6-neoforge" = _KLymY8py;
        "pkg-1.21.9-1.8.6-forge" = _LL3Sps73;
        "pkg-1.21.10-1.8.6-forge" = _TuaFr1ob;
        "pkg-1.21.10-1.8.6-neoforge" = _yQs9KLqB;
        "pkg-1.21.11-1.8.6-fabric" = _hcRj4ShY;
        "pkg-26.1.2-1.8.6-neoforge" = _b6hJTRzA;
        "pkg-26.1.2-1.8.6-forge" = _a6alwQIa;
        "pkg-26.1.2-1.8.6-fabric" = _oVnM0E0Z;
        "pkg-26.1.2-1.8.7-fabric" = _qT4hqrqN;
        "pkg-26.1.2-1.8.7-forge" = _pgfVfBTL;
        "pkg-26.1.2-1.8.7-neoforge" = _JnMufig5;
        "pkg-1.20.1-1.8.8-fabric" = _hEE9L4GK;
        "pkg-1.20.1-1.8.8-forge" = _wsEa45ds;
        "pkg-1.21.1-1.8.8-fabric" = _1mafNjf9;
        "pkg-1.21.1-1.8.8-forge" = _Als7Yg1C;
        "pkg-1.21.1-1.8.8-neoforge" = _IQrleGrF;
        "pkg-1.21.11-1.8.8-fabric" = _T3MG6KYv;
        "pkg-1.21.11-1.8.8-neoforge" = _fmezeYzT;
        "pkg-26.1.2-1.8.8-fabric" = _aSnfbwW3;
        "pkg-26.1.2-1.8.8-forge" = _MskU0BBq;
        "pkg-26.1.2-1.8.8-neoforge" = _Bxp1x7Ga;
        "pkg-1.21.11-1.8.8-forge" = _xCulxiou;
