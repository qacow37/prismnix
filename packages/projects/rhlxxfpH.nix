...
let
    ...
    in {
        ...
        "pkg-1.3.0+mc1.19.4" = _tkVADWO5;
        "pkg-1.3.1+mc1.19.4" = _hA0tFBV2;
        "pkg-1.4.0+mc1.19.4" = _oxjcOa5y;
        "pkg-1.4.0+mc1.20.1" = _b1IS5Olv;
        "pkg-1.4.1+mc1.20.1" = _9fFrM0Vr;
        "pkg-1.4.1+mc1.19.4" = _bV9wYDzg;
        "pkg-1.4.2+mc1.19.4" = _A0LfvdAO;
        "pkg-1.4.2+mc1.20.1" = _wQ4IBWju;
        "pkg-1.4.3+mc1.19.4" = _VL9yOfkf;
        "pkg-1.4.3+mc1.20.1" = _C5LLcGYB;
        "pkg-1.4.4+mc1.19.4" = _VPRCe1gy;
        "pkg-1.4.4+mc1.20.1" = _6OjahMDr;
        "pkg-1.4.4+mc1.20.2" = _6YNB7DYL;
        "pkg-1.4.4+mc1.20.4" = _ZiVR01wN;
        "pkg-1.4.4+mc1.21" = _djxsPfhb;
        "pkg-1.4.4+mc1.21.2" = _ZwRs750n;
        "pkg-1.4.4+mc1.21.5" = _7o39WGGh;
        "pkg-1.4.4+mc1.21.6" = _RRs2pYNU;
        "pkg-1.4.5+mc1.19.4" = _i0eYnFU3;
        "pkg-1.4.5+mc1.20.1" = _nYQHhtp0;
        "pkg-1.4.5+mc1.20.2" = _tl82IYgT;
        "pkg-1.4.5+mc1.20.4" = _7aas362K;
        "pkg-1.4.5+mc1.21.2" = _A80CPyJq;
        "pkg-1.4.5+mc1.21.5" = _HSWgE1qQ;
        "pkg-1.4.5+mc1.21.6" = _RHEFGviO;
        "pkg-1.4.5+mc1.21.9" = _U4dHIKCU;
        "pkg-1.4.5+mc1.21.11" = _cCifK5ly;
        "pkg-1.5.0+mc1.20.1" = _UCJsD68g;
        "pkg-1.5.0+mc1.21" = _7zMuIgfV;
