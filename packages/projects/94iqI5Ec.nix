...
let
    ...
    in {
        ...
        "pkg-v.1.0.0" = _SvKSYiY9;
        "pkg-v.1.1.0" = _CnCMRZmR;
        "pkg-v.1.1.1" = _vKSU4GDG;
        "pkg-v.1.2.0" = _WJzK8WxD;
        "pkg-v.1.3.0" = _j89tJQbc;
        "pkg-v.1.4.0" = _rfXdFILH;
        "pkg-v.1.5.0" = _91HXYkxM;
        "pkg-v.1.5.1" = _SFbVssSC;
        "pkg-v.1.6.0" = _BLpuN8TQ;
        "pkg-v.1.6.1" = _ZUZPBZ8h;
        "pkg-v.1.6.2" = _jMrGenRT;
        "pkg-v.1.6.3" = _j3OA6BC3;
        "pkg-v.1.6.4" = _NdevDcp6;
        "pkg-v.1.6.5" = _zdA7IY9L;
        "pkg-v.1.7.0" = _KOqbTIbG;
        "pkg-v.1.8.0" = _K6hTWwIN;
        "pkg-v.2.0.0" = _BryPpoGs;
        "pkg-v.2.0.1" = _anS9viAQ;
        "pkg-v.2.1.0" = _NwcrOGKZ;
        "pkg-v.2.2.0" = _RPWz8flC;
        "pkg-v.2.3.0" = _XYtv7C6O;
        "pkg-v.2.3.1" = _BpbZiUzt;
        "pkg-v.2.4.0" = _CmcUuKmP;
        "pkg-v.2.5.0" = _7VUBw0BY;
        "pkg-v.2.6.0" = _FwlqzyMJ;
        "pkg-v.2.7.0" = _7mMqbvGx;
        "pkg-v.2.8.0" = _8yZ6h7d0;
        "pkg-v.2.9.0" = _kky5tONq;
        "pkg-v.2.10.0" = _qAphhQVB;
        "pkg-v.2.11.0" = _FD0nnvAp;
        "pkg-v.2.11.1" = _kOxU3lak;
        "pkg-v.2.11.2" = _mQH1e5Po;
        "default" = _mQH1e5Po;
    });
