...
let
    ...
    in {
        ...
        "pkg-1.3.3-1.14.4" = _SsS4fgsD;
        "pkg-1.3.3-1.15.2" = _i3HjBIox;
        "pkg-1.3.3-1.16.5" = _EsAykzB4;
        "pkg-1.3.4-1.14.4" = _XsXGXrIt;
        "pkg-1.3.4-1.15.2" = _ZCviHxV9;
        "pkg-1.3.4-1.16.5" = _ImQyZbq8;
        "pkg-1.3.4-20w05b" = _nH8fQ50x;
        "pkg-1.3.5-1.14.4" = _zHitnPws;
        "pkg-1.3.5-1.15.2" = _2FGKHU5L;
        "pkg-1.3.5-1.16.5" = _rgR0JStE;
        "pkg-1.3.5-20w05b" = _evs5PdMC;
        "pkg-1.4.0-1.17.1" = _UzgfnPdI;
        "pkg-1.17.1-1.4.1" = _F7qmG7pd;
        "pkg-1.4.2-1.17.1" = _S4Gpxyvh;
        "pkg-1.4.3-1.16.5" = _zsWyZ8Xd;
        "pkg-1.4.3-1.17.1" = _m2QVwYcR;
        "pkg-1.4.3-1.15.2" = _fOshsljV;
        "pkg-1.4.4-1.17.1" = _kEx6Nf4K;
        "pkg-1.4.4-1.16.5" = _kKSwoue4;
        "pkg-1.4.4-1.15.2" = _rpyNPOqM;
        "pkg-v1.4.5-1.18" = _RgRxMIB9;
        "pkg-1.4.5-1.14" = _A5Y9jTIc;
        "pkg-1.4.5-1.15" = _3oiFJyNc;
        "pkg-1.4.5-1.16" = _YgN7TXiv;
        "pkg-1.4.5-1.17" = _1dCUqgZQ;
        "pkg-1.5.3-1.18.2" = _ErwiOhDO;
        "pkg-1.6.1-lite-1.19" = _2sPGGYEc;
        "pkg-v1.6.1-1.19" = _P69TbSwI;
        "pkg-1.6.2" = _nLMQCoje;
        "pkg-1.6.3" = _dMpJKWXU;
        "pkg-1.7-pre1-1.19.3" = _kWWaro1B;
        "pkg-1.7-1.19.3" = _6XrKFTCR;
        "pkg-1.7-1.18.2" = _uP4AP0rE;
        "pkg-1.7-1.19.2" = _1rbdW9J5;
        "pkg-1.7-1.17.1" = _wDShFP5u;
        "pkg-1.7.1-1.19.4" = _BKElQNJb;
        "pkg-1.7.1-1.17.1" = _tqQpCcsc;
        "pkg-1.7.1-1.18.2" = _hd5iOuwq;
        "pkg-1.7.1-1.19.2" = _IO971sCD;
        "pkg-1.7.1-1.20.2" = _tbcQYkFL;
        "pkg-1.7.2-1.20.2" = _DPD7mNfu;
        "pkg-1.7.2-1.19.4" = _pxeQrCb4;
        "pkg-1.7.2-1.19.2" = _gUj8lF08;
        "pkg-1.7.2-1.18.2" = _S3R19Vp9;
        "pkg-1.7.2-1.17.1" = _yGWaXhav;
        "pkg-1.7.2-1.20.1" = _xY16zX6k;
        "pkg-1.7.2-1.20.4" = _Y4RVodRm;
        "pkg-1.7.2-1.20.6" = _JFRpihhS;
        "pkg-1.7.2-1.21.1" = _iNR8IwQB;
        "pkg-1.8.0-pre1-1.21.3" = _GO0kjkc6;
        "pkg-1.8.0-1.21.4" = _igRv9uEK;
        "pkg-1.8.1-1.21.5" = _FwDFh2hj;
        "pkg-1.8.1-1.21.6" = _gfh7zWBk;
        "pkg-1.8.3-1.21.5" = _LvRkhJ2b;
        "pkg-1.8.3-1.21.8" = _GFeJWPre;
        "pkg-fabric-2.0.0-beta" = _9Q3R6sIz;
        "pkg-neoforge-2.0.0-beta" = _WkZpr27g;
        "pkg-2.0.0-beta.2-1.21.8-neoforge" = _LyUMI2iw;
        "pkg-2.0.0-beta.2-1.21.8-fabric" = _xI3olqDC;
        "pkg-2.0.0-beta.3-1.21.8-neoforge" = _JbjLAujH;
        "pkg-2.0.0-beta.3-1.21.8-fabric" = _oU67tdwk;
        "pkg-2.0.0-beta.4-1.21.8-fabric" = _1yznbJf5;
        "pkg-2.0.0-beta.4-1.21.8-neoforge" = _QKsjqvth;
        "pkg-2.0.0-beta.5-1.21.8-fabric" = _eN30uqdi;
        "pkg-2.0.0-beta.5-1.21.8-neoforge" = _ZRJgzy2l;
        "pkg-2.0.0-beta.6-1.21.8-fabric" = _RvglHtwd;
        "pkg-2.0.0-beta.6-1.21.8-neoforge" = _u7SIE1Gc;
        "pkg-2.0.0-beta.7-1.21.8-fabric" = _Kxqr4BII;
        "pkg-2.0.0-beta.7-1.21.8-neoforge" = _KqoM93Ru;
        "pkg-2.0.0-beta.8+1.21.8-fabric" = _1p2WsM5H;
        "pkg-2.0.0-beta.8+1.21.8-neoforge" = _BxV7UE8X;
        "pkg-2.0.0+1.21.8-fabric" = _SeQp6hZC;
        "pkg-2.0.0+1.21.8-neoforge" = _JLTe0SB1;
        "pkg-2.0.1+1.21.8-fabric" = _vSY17iQp;
        "pkg-2.0.1+1.21.8-neoforge" = _5hhaXnTT;
        "default" = _5hhaXnTT;
    });
