...
let
    ...
    in {
        ...
        "pkg-4.1" = _UQsYw7dF;
        "pkg-4.2" = _ysmuKXsp;
        "pkg-5.0+neoforge" = _ASQ4IHRr;
        "pkg-5.0+fabric" = _KRwWovD9;
        "pkg-5.1+fabric" = _1sNk6vla;
        "pkg-5.1+neoforge" = _MRzard3M;
        "pkg-5.2+fabric" = _9MW9lnzw;
        "pkg-5.2+neoforge" = _U3PFi6yH;
        "pkg-5.2+forge" = _Pb17EN5p;
        "pkg-5.3+fabric" = _LlQym0OA;
        "pkg-5.3+neoforge" = _gw4sDrWE;
        "pkg-5.3.1+fabric" = _LLwxDM11;
        "pkg-5.4+neoforge" = _7U8U65v4;
        "pkg-5.5+fabric" = _P7W6G01M;
        "pkg-5.5+neoforge" = _o2Y164Xb;
        "pkg-5.6+fabric" = _1am3G4y7;
        "pkg-5.6+neoforge" = _thcrhhB2;
        "default" = _thcrhhB2;
    });
