...
let
    ...
    in {
        ...
        "pkg-1.5.3.7" = _tRv67ty0;
        "pkg-1.5.3.8" = _KbH00yy8;
        "pkg-1.5.3.9" = _s5LcryK5;
        "pkg-1.5.3.10" = _z4Hz4Jpy;
        "pkg-1.5.3.11" = _eV9MrkGO;
        "pkg-1.5.3.12" = _nqGeQAus;
        "pkg-1.5.3.13" = _qgTJvRbM;
        "pkg-1.5.3.14" = _bE4i1wfJ;
        "pkg-1.5.3.15" = _PO9FBc3S;
        "pkg-1.5.3.16" = _fcjeG3Fq;
        "pkg-1.5.3.17" = _6pPYfsSK;
        "pkg-1.5.3.18" = _tw6io81L;
        "pkg-1.5.3.19" = _sz19fsSc;
        "pkg-1.5.3.20" = _ezd7dOam;
        "pkg-1.5.3.21" = _KqC6TpBE;
        "pkg-1.5.3.22" = _mqNkEo5w;
        "pkg-1.5.3.23" = _RhHfY2tJ;
        "pkg-1.5.3.24" = _U8avubEB;
        "pkg-1.5.3.25" = _B4ZHYvXp;
        "pkg-1.5.3.26vs" = _5zLGypFh;
        "pkg-1.5.3.27vs" = _OKaqW1hT;
        "pkg-1.5.3.28" = _ZtIdj1Cv;
        "pkg-1.5.3.29" = _DB0Ltnz1;
        "pkg-1.5.3.30" = _v7Pt58tT;
        "pkg-1.5.3.31" = _5zOPWBv4;
        "pkg-1.5.3.32" = _m9LnauVT;
        "pkg-1.5.3.33" = _Uv6yV7Ma;
        "pkg-1.5.3.34" = _a7Q4tvIz;
        "pkg-1.5.3.35" = _3kR3A2kE;
        "pkg-1.5.3.36" = _1FzBB3l4;
        "pkg-1.5.3.36.1" = _oZC4fRwa;
        "pkg-1.5.3.36.2" = _Y8mjFzcP;
        "pkg-1.5.3.36.3" = _1o8EpgwD;
        "pkg-1.5.3.36.4" = _q3BDmE5o;
        "pkg-1.5.3.36.5" = _obHItVKX;
        "default" = _obHItVKX;
    });
