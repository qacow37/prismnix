...
let
    ...
    in {
        ...
        "pkg-0.1.0-1.19.4" = _HUDL1og2;
        "pkg-0.1.1-1.19.4" = _5q7dcuWm;
        "pkg-0.1.2-1.19.4" = _jZo6x4bn;
        "pkg-0.1.3-1.19.4" = _wmauYenL;
        "pkg-0.1.4-1.19.4" = _BsoJMs23;
        "pkg-0.1.5-1.19.4" = _kI1Dw7bs;
        "pkg-0.1.6-1.19.4" = _c9lbnDVx;
        "pkg-0.1.7-1.19.4" = _T0eJxtcs;
        "pkg-0.1.8-1.19.4" = _lttN9G20;
        "pkg-0.1.9-1.19.4" = _3Z5u33mU;
        "pkg-0.1.10-1.19.4" = _C7gZaIp6;
        "pkg-0.1.11-1.19.4" = _u9f88rJd;
        "pkg-0.1.12-1.19.4" = _Xl6bby7k;
        "pkg-1.0.0-1.19.4" = _X4dkprst;
        "pkg-1.0.1-1.19.4" = _zfzwxpDi;
        "pkg-1.0.2-1.19.4" = _Zt3fHhkO;
        "pkg-1.1.0-1.20.1" = _EGNqJlSH;
        "pkg-1.1.1-1.20.1" = _oqlDeKkt;
        "pkg-1.1.2-1.20.1" = _TVphugKF;
        "pkg-1.1.3-1.20.1" = _EmDkORLy;
        "pkg-1.1.4-1.20.2" = _YifSEUaf;
        "pkg-1.1.5-1.20.4" = _UV7J5164;
        "pkg-1.1.6-1.20.6" = _JzsthuUC;
        "pkg-1.1.7-1.20.6" = _NPrF6Xbq;
        "pkg-1.2.0-1.21" = _7gBBpQpg;
        "pkg-1.2.0.a-1.21" = _TBmw0fzk;
        "pkg-1.2.0.b-1.21" = _p2C7UarQ;
        "pkg-1.2.1-1.21" = _cVjoM8TK;
        "pkg-1.2.2-1.21.1" = _VlAypjZI;
        "default" = _VlAypjZI;
    });
