...
let
    ...
    in {
        ...
        "pkg-0.9.3" = _x8lBmqOE;
        "pkg-0.9.4" = _Ls36dt3Y;
        "pkg-0.10.0.01" = _JAQ3OctN;
        "pkg-0.10.0.02" = _9hRKzNEp;
        "pkg-0.10.0.03" = _MkhTgUPx;
        "pkg-0.10.0.05" = _7qBEOwRx;
        "pkg-0.10.0.06" = _bXFDcLvX;
        "pkg-0.10.2" = _JcHBTqEM;
        "pkg-0.10.4" = _6E0ClaYk;
        "pkg-0.10.5" = _I0EEVnb2;
        "pkg-0.10.6" = _8Joe2uR3;
        "pkg-0.10.7" = _bqp1THOw;
        "pkg-0.10.8" = _YR26NztA;
        "pkg-0.11.1" = _EKDWdLn9;
        "pkg-0.11.2" = _KfwLfJg1;
        "pkg-0.11.3" = _JAYMv4UQ;
        "pkg-0.11.4" = _Xeuhtbha;
        "pkg-0.12.0" = _zMV6eano;
        "pkg-0.12.1" = _R96bS2Mx;
        "pkg-0.12.2" = _2QC5Q7rh;
        "pkg-0.12.3" = _9uwyDknm;
        "pkg-0.12.3-1" = _COovdcBO;
        "pkg-0.12.4" = _CrPgSHBq;
        "pkg-0.12.6-1" = _BEAchAf9;
        "pkg-0.12.7" = _StcRWXAO;
        "pkg-0.12.8" = _nypkpMTO;
        "pkg-0.12.9" = _MN93biwp;
        "pkg-0.12.10" = _I4fiG416;
        "pkg-0.12.12" = _hykKg1L1;
        "pkg-0.12.13" = _oIFMFXvb;
        "pkg-0.13.0" = _SiIBtvjx;
        "pkg-0.13.1" = _4EuaOYrA;
        "pkg-0.13.3" = _VdM4hi2e;
        "pkg-0.12.15" = _mvtbOxmI;
        "pkg-0.13.4" = _Tpo46axW;
        "pkg-0.13.5" = _tZdHnX6x;
        "pkg-0.14.0" = _l6NmcMHK;
        "pkg-1.0.0-beta.2" = _TBYS5ZMU;
        "pkg-1.0.0-beta.3" = _G1ZC7oxr;
        "pkg-0.13.10-beta.3" = _zZM6zYbw;
        "pkg-1.0.0-beta.5" = _8WrXfE8a;
        "pkg-0.13.10-beta.5" = _AD6nxCvf;
        "pkg-1.0.0-rc.1" = _KB50WmeV;
        "pkg-0.13.10-rc.1" = _9Pc2hv8j;
        "pkg-0.13.10" = _ESsQHMwF;
        "pkg-1.0.0" = _I82Hmj1f;
        "pkg-1.0.1" = _pWpbFIY1;
        "pkg-0.13.11" = _2vs428T2;
        "pkg-0.12.16" = _YmhghtlO;
        "pkg-0.13.12" = _GWf3DXWB;
        "pkg-1.0.2" = _xA0T8EiQ;
        "pkg-0.13.14" = _atQ3rHwI;
        "pkg-1.0.4" = _IdDDrwMp;
        "pkg-1.0.6" = _LH2L9lVo;
        "pkg-0.13.16" = _5gBV1Bhc;
        "pkg-1.0.7" = _69qUKkgg;
        "pkg-0.13.17" = _BjtL1ETY;
        "pkg-1.0.7+folia.1" = _7N84LZUL;
        "pkg-1.0.8" = _NBoU37CZ;
        "pkg-0.13.18" = _m64vU3AE;
        "pkg-1.0.9" = _Fgr6PeBs;
        "pkg-0.13.19" = _D9tZAlWr;
        "pkg-1.0.9+folia.1" = _tnhxaNHr;
        "pkg-1.0.9-folia.2" = _uMh08yjr;
        "pkg-1.0.10" = _Anopi5Gm;
        "pkg-1.0.10+folia.1" = _F1ghuX92;
        "pkg-0.13.20" = _dufwYDAy;
        "pkg-1.0.12" = _9FH0W4ar;
        "pkg-1.0.12+folia.1" = _VdLFjrFc;
        "pkg-1.0.13" = _UDnsaKd5;
        "pkg-1.0.14" = _luM9uIBa;
        "pkg-1.0.15" = _wL67ZpTN;
        "pkg-1.1.0-beta.1" = _KulnLoGr;
        "pkg-1.1.0-beta.2" = _eIXNhqG2;
        "pkg-1.0.17" = _S8kK94Tk;
        "pkg-1.1.0-beta.3" = _6OHyfYy9;
        "pkg-1.1.0-beta.4" = _w0GSziz1;
        "pkg-1.1.0-beta.5" = _RUwm9kSz;
        "pkg-1.1.0-beta.6" = _R4QjMCET;
        "pkg-1.1.0-beta.7" = _PXjT02nl;
        "pkg-1.1.0-beta.8" = _oKL6kPZY;
        "pkg-1.1.0" = _ov9TZk7Z;
        "pkg-1.1.1" = _jQ8jw1mJ;
        "pkg-1.1.2" = _GskMPeDo;
        "pkg-1.1.3" = _uqmxpoZM;
        ...
        "pkg-1.3.0" = _bEuLEnrr;
        "pkg-1.3.1" = _RgQdPOLm;
        "pkg-1.4.0.alpha2" = _nFQYqsJs;
        "pkg-1.3.2" = _esPqhaz7;
        "pkg-1.4.0.alpha4" = _hZGbY89a;
        "pkg-1.3.3" = _Rio3APZv;
        "pkg-1.4.0.beta1" = _X3T3cmcQ;
        "pkg-1.5.0.beta1" = _B3MSMB4p;
        "pkg-1.5.0.rc1" = _Yy3zWVYB;
        "pkg-1.5.0.rc2" = _sINvToY2;
        "pkg-1.5.0.rc3" = _WTCScU56;
        "pkg-1.5.0.rc4" = _KmBgF0xW;
        "pkg-1.5.1" = _OKrxEJEk;
        "pkg-1.3.5" = _JXKgTNe0;
        "pkg-1.5.3" = _ce6hnfsZ;
        "pkg-1.5.4" = _z1f5TxwN;
        ...
        "pkg-1.5.7" = _zs0bVt9j;
        "pkg-1.3.8" = _oVGVwMsK;
        "pkg-1.3.10" = _Po2LWC1t;
        "pkg-1.5.8" = _rNn5a7bO;
        "pkg-1.5.9" = _ewXijsDS;
        "pkg-2.1.0.beta1" = _ReC8lggM;
        "pkg-2.1.0.beta2" = _C36v98Dk;
        "pkg-2.1.0.beta3" = _cyrkDbe3;
        "pkg-2.1.0.beta6" = _HtkgG2HP;
        "pkg-2.0.0.beta6" = _Ar9Ze9GF;
        "pkg-2.0.0.rc1" = _2xgBc06D;
        "pkg-2.1.0.rc1" = _tQXbZqLp;
        "pkg-2.1.0.rc3" = _6PlYykUI;
        "pkg-2.0.0.rc3" = _KHhiqgeO;
        "pkg-2.1.0.rc4" = _Z3FlKimO;
        "pkg-2.0.0.rc4" = _YgcbiKnp;
        "pkg-2.1.0.rc5" = _p5iS3cP9;
        "pkg-2.0.0.rc5" = _B7JFw2I8;
        "pkg-2.1.0" = _L2TS7JAh;
        "pkg-2.0.0" = _JMBdiHSO;
        "pkg-2.2.0" = _65gieBfk;
        "pkg-2.2.1" = _F4LQCAKd;
        ...
        "pkg-2.4.2" = _C54UQckV;
        "pkg-2.4.3" = _liea1ksH;
        "pkg-2.5.0-beta.2" = _LLsBQEOU;
        "pkg-2.5.0-beta.3" = _f7eXnVF1;
        "pkg-2.5.0-beta.5" = _dgvOm9cI;
        "pkg-2.4.4" = _TzMTMQFl;
        "pkg-2.5.0-beta.6" = _8KdTLtJr;
        "pkg-2.5.0-rc.2" = _4wHJnhZv;
        "pkg-2.4.5" = _g2tNw1X6;
        "pkg-2.5.0-rc.3" = _aFLp4UK3;
        "pkg-2.5.0-rc.4" = _MByOCP54;
        "pkg-2.4.6" = _HbdZKueG;
        "pkg-2.5.0-rc.5" = _IcvcDhr6;
        "pkg-2.5.1" = _godIyKO0;
        "pkg-2.5.2" = _hjzUkUKd;
        "pkg-2.6.0-alpha.2" = _VcR6GLZO;
        "pkg-2.7.0" = _XY53OdOJ;
        "pkg-2.8.0-alpha.1" = _RT8Yvehs;
        "pkg-2.6.0-alpha.3" = _iA2HAWze;
        "pkg-2.8.0-alpha.2" = _snfPQ1UD;
        "pkg-2.7.1" = _wJpYlJ4M;
        "pkg-2.8.0-beta.2" = _DTX5rLCT;
        "pkg-2.6.0-alpha.4" = _9urHMTUP;
        "pkg-2.8.0-beta.4" = _RJmkp3bh;
        "pkg-2.8.0-rc.1" = _BFlVRV3c;
        "pkg-2.8.0-rc.3" = _M869S9hz;
        "pkg-2.8.0-rc.5" = _h4XBbzym;
        "pkg-2.8.0-rc.6" = _OAcbE8Ii;
        "pkg-2.8.0" = _YdvnuvLJ;
        "pkg-2.8.1" = _tdu2RLua;
        "default" = _tdu2RLua;
    });
