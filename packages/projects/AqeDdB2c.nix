...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.18.x-fabric" = _vgKwViAV;
        "pkg-1.0.0-1.18.x-forge" = _zpDIrd62;
        "pkg-1.0.0-1.17.x-fabric" = _a401Ouf2;
        "pkg-1.0.0-1.17.x-forge" = _5aepC7Rs;
        "pkg-1.0.0-1.19.x-fabric" = _94GoG8a9;
        "pkg-1.0.0-1.19.x-forge" = _6P1ejhqb;
        "pkg-1.0.0-1.16.5-fabric" = _gbveYOGH;
        "pkg-1.0.0-1.16.5-forge" = _rUTFuXbj;
        "pkg-1.0.0-1.15.x-fabric" = _CANum4IE;
        "pkg-1.0.0-1.15.x-forge" = _noLtTeEY;
        "pkg-1.0.1-1.19.x-fabric" = _NPAODQPZ;
        "pkg-1.0.1-1.19.x-forge" = _6TWpFOsr;
        "pkg-1.0.1-1.18.x-fabric" = _4RSOfZgl;
        "pkg-1.0.1-1.18.x-forge" = _w16YfLNR;
        "pkg-1.0.1-Hotfix-1.15.x-forge" = _4Eo7T7l8;
        "pkg-1.0.1-Hotfix-1.15.x-fabric" = _LObXf0ky;
        "pkg-1.0.1-Hotfix-1.16.5-forge" = _8XytztMq;
        "pkg-1.0.1-Hotfix-1.16.5-fabric" = _XbFsyKaB;
        "pkg-1.0.1-Hotfix-1.17.x-forge" = _LsTqKtz6;
        "pkg-1.0.1-Hotfix-1.17.x-fabric" = _iaKb1IQa;
        "pkg-1.0.1-Hotfix-1.18.x-forge" = _msizLmQ2;
        "pkg-1.0.1-Hotfix-1.18.x-fabric" = _4MDnE9Gv;
        "pkg-1.0.1-Hotfix-1.19.x-forge" = _VzBRYoha;
        "pkg-1.0.1-Hotfix-1.19.x-fabric" = _4TUmuDvg;
        "pkg-1.0.1-Hotfix-1.19.3" = _TLymuy0Y;
        "default" = _TLymuy0Y;
    });
