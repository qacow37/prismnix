...
let
    ...
    in {
        ...
        "pkg-1.18.2-2.1.0-beta2" = _4YuActwY;
        "pkg-1.19-2.1.0-beta1" = _JsWvPsUI;
        "pkg-1.18.2-2.1.0-beta3" = _Mm3VBNp0;
        "pkg-1.19.2-2.1.0-beta-1" = _E0lZAzl0;
        "pkg-1.19.2-2.1.0-beta-2" = _yxN2TTcC;
        "pkg-1.19.3-2.2.0-beta1" = _L59g8yQk;
        "pkg-1.19.3-2.2.0-beta2" = _eVvFZNTt;
        "pkg-1.19.2-2.1.1" = _dIsWpg1l;
        "pkg-1.19.3-2.2.0-beta3" = _2f3Fb1NY;
        "pkg-1.19.4-2.2.0-beta1" = _hLiOruBp;
        "pkg-1.19.2-2.1.3" = _VCvd65wu;
        "pkg-1.19.4-2.2.0-beta2" = _odK9XN60;
        "pkg-1.18.2-2.1.2" = _nJL608HQ;
        "pkg-1.19.4-2.2.0" = _roneg9Zg;
        "pkg-1.20.1-2.2.0-beta1" = _TM3JcdVN;
        "pkg-1.18.2-2.1.3" = _KO6gqmze;
        "pkg-1.20.1-2.2.0" = _H7IZIeUp;
        "pkg-1.20.1-2.2.1" = _tR0oXIjC;
        "pkg-1.19.2-2.1.4" = _BXCN3YVB;
        "pkg-1.20.1-2.2.2" = _sI6YSJ8T;
        "pkg-1.19.2-2.1.5" = _DtMZ6pWv;
        "pkg-1.20.1-2.2.3" = _7wisJy8J;
        "pkg-1.20.1-2.2.4" = _LvmRjE21;
        "pkg-1.20.1-2.2.5" = _8lkKUJfk;
        "pkg-1.20.1-2.2.6" = _1GswR5qC;
        "pkg-2.5.0-beta" = _qgT6tU8i;
        "pkg-2.5.2-beta" = _CSwZsZk1;
        "pkg-2.5.3-beta" = _Rh7AbMEY;
        "pkg-2.5.4-beta" = _2DVcxlKS;
        "pkg-2.5.5-beta" = _qMQwlbF4;
        "pkg-2.5.6-beta" = _vdycLbTW;
        "pkg-2.5.8-beta" = _Q4QOLNEh;
        "pkg-2.5.9" = _bCvurLnl;
        "pkg-2.5.10" = _MA0PE0Y7;
        "pkg-2.5.11" = _FG8VPcRN;
        "pkg-2.5.12" = _ouDzX2ri;
        "pkg-2.5.13" = _jhKG197X;
        "pkg-2.5.14" = _er8jgHaa;
        "pkg-2.5.15" = _GWRHF5VL;
        "pkg-2.5.16" = _y6P1R9lv;
        "pkg-2.5.17" = _UNFuOlOR;
        "pkg-2.6.0" = _tYMWHdzV;
        "pkg-2.6.1" = _fNjxgZPH;
        "pkg-2.7.0-beta.1" = _JGCijuSn;
        "pkg-2.7.0-beta.2" = _27K9qDN5;
        "pkg-2.7.0-beta.3" = _8JWxXs1Y;
        "pkg-2.7.0-beta.4" = _RpmqwBlf;
        "pkg-2.7.0-beta.5" = _XuZ4oWt3;
        "pkg-2.7.0" = _tT8xf1VM;
        "pkg-2.7.1" = _5uFu0fJ5;
        "pkg-2.7.2" = _o5OOKrZw;
        "pkg-2.8.0-beta.1" = _UHJOBsIt;
        "pkg-2.8.0-beta.2" = _sJkHLj3l;
        "default" = _sJkHLj3l;
    });
