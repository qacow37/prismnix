...
let
    ...
    in {
        ...
        "pkg-GTCE-1.12.2-1.0.0.5" = _OeM4uFrt;
        "pkg-GTCEu-1.12.2-1.0.1.6" = _6dLicDrg;
        "pkg-GTCEu-1.19.2-2.0.1.4" = _RxA7UBtU;
        "pkg-GTCEu-1.20.1-2.1.1.4" = _gZShLtpl;
        "pkg-GT4-1.7.10-1.0.0.4" = _CNWn3kLv;
        "pkg-GT5-1.7.10-1.0.0.2" = _DzoxinEM;
        "pkg-GTCEu-1.19.2-2.0.1.5" = _5KOOLHSc;
        "pkg-GTCEu-1.20.1-2.1.1.5" = _bQbDVp0P;
        "pkg-GTCEu-1.21-3.0.a.0" = _7T5WuWZ5;
        "pkg-GT4-1.7.10-1.0.0.5" = _7qQwyHqi;
        "pkg-GT5-1.7.10-1.0.0.3" = _7mfGHdkW;
        "pkg-GTCE-1.12.2-1.0.0.6" = _zIP8xiM2;
        "pkg-GTCEu-1.12.2-1.0.1.7" = _PGOZFwYB;
        "pkg-GTCEu-1.19.2-2.0.1.6" = _sj1gzykT;
        "pkg-GTCEu-1.20.1-2.1.1.6" = _TuzHL2Js;
        "pkg-GTCEu-1.21-3.0.0.0" = _hla6YhpR;
        "pkg-GTCEu-1.20.1-2.1.1.7" = _W3VLSh7P;
        "pkg-GTCEu-1.21.1-3.0.0.1" = _o6faed5C;
        "pkg-GT4-1.7.10-1.0.0.6" = _ipozp2b9;
        "pkg-GT5-1.7.10-1.0.0.4" = _7kbmvTyT;
        "pkg-GTCE-1.12.2-1.0.0.7" = _RAgVy96v;
        "pkg-GTCEu-1.12.2-1.0.1.8" = _J42QYF5L;
        "pkg-GTCEu-1.19.2-2.0.1.7" = _svFpA1Ch;
        "pkg-GTCEu-1.20.1-2.1.1.8" = _ZD11rjzN;
        "pkg-GTCEu-1.21.1-3.0.0.2" = _N1fglYre;
        "pkg-GTCEu-1.20.1-2.1.2.9" = _7gOiLPZ2;
        "pkg-GTCEu-1.21.1-3.0.1.3" = _2vcUDdb2;
        "pkg-GTCEu-1.20.1-2.1.2.10" = _SBUCsOKx;
        "default" = _SBUCsOKx;
    });
