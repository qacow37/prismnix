...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _8UTjrpzj;
        "pkg-1.0.2" = _cGPkfn7M;
        "pkg-1.0.2+1.18" = _a6Yd7Tm0;
        "pkg-1.0.3+1.18.2" = _Q7aYerrQ;
        "pkg-1.0.3+1.19" = _4aMmeYrq;
        "pkg-1.0.3+1.19-forge" = _P0a8dsz3;
        "pkg-1.0.3+1.19-quilt" = _F6lVrbUq;
        "pkg-1.0.3+1.19.2" = _d5N1JKks;
        "pkg-1.0.3+1.19.2-forge" = _haCeiyHz;
        "pkg-1.0.3+1.19.2-quilt" = _d3QtufTj;
        "pkg-1.0.3+1.19.3" = _rioKstyr;
        "pkg-1.0.3+1.19.3-quilt" = _aKjxx2dQ;
        "pkg-1.0.3+1.19.3-forge" = _5GrOmusu;
        "pkg-1.0.3+1.19.4" = _YH0j9o2I;
        "pkg-1.0.3+1.19.4-forge" = _V2rfCV51;
        "pkg-1.0.3+1.19.4-quilt" = _Q19h2h4r;
        "pkg-1.0.3+1.20-quilt" = _yb5WiKkq;
        "pkg-1.0.3+1.20-forge" = _bzZIJI3P;
        "pkg-1.0.3+1.20" = _OcTZukzY;
        "pkg-1.0.3+1.20.1" = _e7lJtonz;
        "pkg-1.0.3+1.20.1-forge" = _OUspyt2Y;
        "pkg-1.0.3+1.20.1-quilt" = _5bSC5C8d;
        "pkg-1.0.3+1.20.1-neoforge" = _SCrRuD4v;
        "pkg-1.0.3+1.20.2" = _BkgCgj6k;
        "pkg-1.0.3+1.20.2-forge" = _4zO4wOA3;
        "pkg-1.0.3+1.20.4-neoforge" = _3Pdx5M8G;
        "pkg-1.0.3+1.20.4" = _n7sCIOln;
        "pkg-1.1.0+1.20.1" = _WkJeqkhZ;
        "pkg-1.1.0+1.20.1-forge" = _xdtARhJP;
        "pkg-1.1.0+1.20.1-neoforge" = _s7eNnMU7;
        "pkg-1.1.0+1.20.1-quilt" = _3DvEaqXt;
        "pkg-1.1.0+1.20.6" = _eYmkjntQ;
        "pkg-1.1.1+1.21" = _iWvDjYox;
        "pkg-1.1.1+1.21-neoforge" = _LTE7N4LJ;
        "pkg-1.1.2+1.21(.1)-neoforge" = _9u4bmtUp;
        "pkg-1.1.2+1.21" = _eiiM9p7j;
        "pkg-1.1.2+1.21.1" = _BgW2cRLu;
        "pkg-1.1.3+1.21.3-neoforge" = _kMXlFEz4;
        "pkg-1.1.3+1.21.3" = _MYBYAlNP;
        "pkg-1.1.3+1.21.4-neoforge" = _3OcQu7sL;
        "pkg-1.1.3+1.21.4" = _BOHV0dRS;
        "pkg-1.1.4+1.21.4" = _tfDWilqJ;
        "pkg-1.1.4+1.21.5" = _QaRs9tK6;
        "pkg-1.1.4+1.21.5-neoforge" = _QtIL6fMS;
        "pkg-1.1.4+1.21.4-neoforge" = _lSTv7dnv;
        "pkg-1.1.5" = _ObKvWPAD;
        "pkg-1.1.5+1.21.6" = _tmQ23wUn;
        "pkg-1.1.5+1.21.7" = _fQFSojj3;
        "pkg-1.2.0+1.21.10" = _YvGQHPv3;
        "pkg-1.2.0+1.21.11-neoforge" = _TLNU4xDL;
        "pkg-1.2.0+1.21.11" = _aTRE6QT1;
        "pkg-1.2.0+26.1.2-neoforge" = _6HQb8AKF;
        "pkg-1.2.0+26.1.2" = _7D48qSJJ;
        "pkg-1.2.1+26.1.2-neoforge" = _CNejDxr9;
        "pkg-1.2.1+26.1.2" = _HwX7awp8;
        "pkg-1.2.1+26.2-neoforge" = _Inz4VnfB;
        "pkg-1.2.1+26.2" = _HIUVmKsY;
        "default" = _HIUVmKsY;
    });
