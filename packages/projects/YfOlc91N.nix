...
let
    ...
    in {
        ...
        "pkg-3.6.2" = _aZwgPXIV;
        "pkg-LightOverlay-4.1-unstable.201912010451" = _yjJJzdnS;
        "pkg-LightOverlay-4.1" = _KuF8TTFS;
        "pkg-LightOverlay-4.2" = _AC2EDzJE;
        "pkg-LightOverlay-4.3" = _ZxynmmuO;
        "pkg-LightOverlay-4.4" = _9mfEH0k2;
        "pkg-LightOverlay-4.5" = _OlSHztui;
        "pkg-LightOverlay-4.6" = _TSfCEPK5;
        "pkg-4.6.1" = _9HEqLY7n;
        "pkg-5.3.0" = _jWtxUKDg;
        "pkg-4.7.0" = _DvlzEJhJ;
        "pkg-3.7.0" = _QwxTbNlW;
        ...
        "pkg-5.8.0" = _qd0Mqkmx;
        "pkg-5.8.1" = _Mrmbdkpe;
        "pkg-6.0.0-fabric" = _XP5ewI23;
        "pkg-6.0.1-forge" = _GrXB9ehT;
        "pkg-6.0.1-fabric" = _tP91dWlN;
        "pkg-6.0.3" = _i5aEjdq2;
        "pkg-6.0.4" = _rj0cNuPC;
        "pkg-6.0.4-forge" = _3Vz4wTHa;
        "pkg-6.1.0-fabric" = _VyRVRcRk;
        "pkg-6.0.5" = _f74N4LqG;
        "pkg-6.0.5-forge" = _BD2yRQrH;
        "pkg-7.0.0+fabric" = _8MLUOCy0;
        "pkg-7.0.0+forge" = _vczCEl80;
        "pkg-7.0.1" = _MCXtDQmP;
        "pkg-7.0.2" = _G4yb772E;
        "pkg-7.0.3" = _xscp6J7o;
        "pkg-8.0.0" = _xHBA44Di;
        "pkg-12.0.0" = _McTw1faU;
        "pkg-13.0.0" = _rAaqtMzV;
        "default" = _rAaqtMzV;
    });
