...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.20" = _MX2VUl01;
        "pkg-1.1.0-1.20.2" = _QTQEChPS;
        "pkg-1.1.0-1.20.5" = _12h6y8ea;
        "pkg-1.1.1-1.21.2" = _yHsapCTh;
        "pkg-1.2.0-1.21.4" = _g2Ovut5r;
        "pkg-1.2.0-1.21.6" = _LwZgw85p;
