...
let
    ...
    in {
        ...
        "pkg-2.2.0" = _jcIEvFxk;
        "pkg-2.2.1" = _eW8iqMSk;
        "pkg-2.2.1+1.18" = _gTu6NAOm;
        "pkg-2.2.2" = _3p0u6sLp;
        "pkg-2.2.3" = _EJMNnpuo;
        "pkg-3.0.0" = _ooo30NML;
        "pkg-3.0.0+1.18" = _QCfyH9qB;
        "pkg-3.0.1" = _nyMe6MAm;
        "pkg-3.0.1+1.18" = _PabKbqH6;
        "pkg-3.0.2" = _PLtmYGC0;
        "pkg-3.0.2+1.18" = _yADrVoH6;
        "pkg-3.0.3" = _Al0epawJ;
        "pkg-3.0.3+1.18" = _VBZO8oG0;
        "pkg-3.0.4" = _6QSDKai6;
        "pkg-3.0.4+1.18" = _M0qz6mxs;
        "pkg-3.0.5" = _j8IQIvHm;
        "pkg-3.0.5+1.18" = _1oRKXqo0;
        "pkg-3.0.6+1.18" = _Ht8H2Aow;
        "pkg-3.0.6" = _wiXkAJY5;
        "pkg-3.0.7" = _zGlCpqO9;
        "pkg-3.1.0+1.19.3" = _GR9VyFJZ;
        "pkg-3.1.0+1.19-1.19.2" = _SC8X8AQr;
        "pkg-3.1.0+1.19.4" = _FK8LxI3m;
        "pkg-3.1.1+1.19.4" = _qjjOLMND;
        "pkg-3.1.1+1.19.3" = _Rceo1Lys;
        "pkg-3.1.1+1.19-1.19.2" = _T4fgYlvd;
        "pkg-3.2.0+1.19.x" = _ds6Od7Ln;
        "pkg-3.2.0+1.19.4-forge" = _6UB9tmMB;
        "pkg-3.2.0+1.19.3-forge" = _ODYb6KMo;
        "pkg-3.2.0+1.19.2-forge" = _NzWxdLJB;
        "pkg-3.2.0+1.18.2-forge" = _CwPvIPfG;
        "pkg-3.2.1+1.19.x-fabric" = _yaJDysDM;
        "pkg-3.2.2+1.19.x-1.20-fabric" = _nWrWPvzb;
        "pkg-3.2.0+1.20-forge" = _WyeJkmcd;
        "pkg-3.2.0+1.20.1-forge" = _U5PmUQja;
        "pkg-3.2.2+1.19.x-1.20.1-fabric" = _YiwK4aDu;
        "pkg-3.2.3+1.19.x-1.20.1-fabric" = _4UWabEWo;
        "pkg-3.2.3+1.20.1-forge" = _FhoXR7D3;
        "pkg-3.2.3+1.19.2-forge" = _cuNPl7Fo;
        "pkg-4.0.0" = _F7sTQZZ9;
        "pkg-4.0.1" = _Y6e9Udsf;
        "pkg-4.0.2" = _QBiJWhVW;
        "pkg-4.1.0+1.20.2" = _GC3LXChx;
        "pkg-4.1.1+1.20.2" = _iIj91Dx4;
        "pkg-4.1.2+1.20.4" = _c0ZJbvF8;
        "pkg-4.1.3+1.20.4" = _wjTjqt4b;
        "pkg-4.1.3+1.20.2" = _6uMhoC5h;
        "pkg-4.1.4+1.20.4" = _ThitsJB6;
        "pkg-4.2.0+1.20.4" = _ZsWzaplz;
        "pkg-4.2.0+1.20.6" = _4owLyzrm;
        "pkg-4.2.0+1.21" = _UCgPgLUs;
        "pkg-4.3.0+1.21" = _4R1YFTOu;
        "pkg-4.3.0+1.20.6" = _tI4FYwmu;
        "pkg-4.3.1+1.21" = _G8rHINcW;
        "pkg-4.4.0+1.21.1" = _d9OIXKVh;
        "pkg-4.4.1+1.21.1" = _4Z5uW1zU;
        "pkg-4.4.1+1.21.3" = _kADp4B9i;
        "pkg-4.4.2+1.21.3" = _f16XMxFV;
        "pkg-4.4.2+1.21.1" = _3RgLmik1;
        "pkg-4.4.3+1.21.3" = _Mc5k7ZY1;
        "pkg-4.4.3+1.21.1" = _LB2hxSyJ;
        "pkg-4.4.4+1.21.1" = _anCbosw8;
        "pkg-4.4.4+1.21.3" = _PNNieswk;
        "pkg-4.4.4+1.21.4" = _QFdkKh7J;
        "pkg-4.5.0+1.21.4" = _8DgbGH7m;
        "pkg-4.5.0+1.21.3" = _3ya0W6B7;
        "pkg-4.5.0+1.21.1" = _CrcLQWuB;
        "pkg-4.5.1+1.21.1" = _GSIQz1Hv;
        "pkg-4.5.1+1.21.3" = _tvkhOJgP;
        "pkg-4.5.1+1.21.4" = _74Y3YG6e;
        "pkg-3.2.4+1.20.1-forge" = _iVVvz2GU;
        "pkg-4.5.2+1.21.4" = _8mrOUaqE;
        "pkg-4.5.2+1.21.3" = _Fb3Nud22;
        "pkg-4.5.2+1.21.1" = _LlDN4JUe;
        "pkg-3.2.5+1.20.1-forge" = _EmzPBXfI;
        "pkg-4.5.3+1.21.4" = _C3XEcdgq;
        "pkg-4.5.3+1.21.4-patch.1" = _ilSmuwZP;
        "pkg-4.5.3+1.21.3" = _rr78jydH;
        "pkg-4.5.3+1.21.1" = _uSaO8tUd;
        "pkg-4.5.3+1.20.1" = _9vLC6WwT;
        "pkg-4.5.3+1.21.5" = _9jOYB5rp;
        "pkg-4.5.3+1.21.6" = _5FvVSLkX;
        "pkg-4.5.3+1.21.7" = _CtM24eVY;
        "pkg-4.5.3+1.21.8" = _Z5ACdUuA;
        "pkg-4.6.0+1.21.8" = _Nefe8z6u;
        "pkg-4.6.0+1.21.5" = _kPl3EDD1;
        "pkg-4.6.0+1.21.4" = _9n8tn1AX;
        "pkg-4.6.0+1.21.1" = _fVhkJu1j;
        "pkg-4.6.0+1.20.1" = _7hivte1d;
        "pkg-4.6.0+1.21.9" = _cnKkTVuE;
        "pkg-4.6.0+1.21.10" = _rRRwqZ3J;
        "pkg-4.6.0+1.21.11" = _Pn7w6lwv;
        "pkg-4.6.1+1.21.11" = _8SnX8Vj7;
        "pkg-4.6.1+1.21.10" = _Af0tdLOl;
        "pkg-4.6.1+1.21.1" = _djt0zS53;
