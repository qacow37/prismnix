...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _YqOppkSg;
        "pkg-1.2.0" = _h3JqGSSb;
        "pkg-1.19.4-v1.3.0" = _LFugRPa9;
        "pkg-1.20-v1.3.0" = _yTNVUsnq;
        "pkg-1.20.1-v1.3.0" = _r1v03gvU;
        "pkg-1.19.2-v2.0.0" = _6xs8SRJT;
        "pkg-1.19.4-v2.0.0" = _6wR5mryu;
        "pkg-1.20.1-v2.0.0" = _nnlvUWyr;
        "pkg-1.19.4-v2.1.0" = _BadP0e5q;
        "pkg-1.19.2-v2.1.0" = _DsaZ0BUO;
        "pkg-1.20.1-v2.1.0" = _xqKrdmOq;
        "pkg-2.1.1+1.19.2.fabric" = _zcozWtd3;
        "pkg-2.1.1+1.19.2.forge" = _PJkOhs2H;
        "pkg-2.1.1+1.19.4.fabric" = _m8TfoN0p;
        "pkg-2.1.1+1.19.4.forge" = _XzomVDIm;
        "pkg-2.1.1+1.20.1.fabric" = _Md1pABfm;
        "pkg-2.1.1+1.20.1.forge" = _RCHTTJiW;
        "pkg-2.1.1+1.18.2.fabric" = _kNCGNu04;
        "pkg-2.1.1+1.18.2.forge" = _mmP0rfF1;
        "pkg-2.1.1+1.20.2.fabric" = _8kPGaeyt;
        "pkg-2.1.1+1.20.2.forge" = _z9CBLHMn;
        "pkg-2.2.0+1.18.2.fabric" = _kqmh3gHv;
        "pkg-2.2.0+1.18.2.forge" = _CQ9HyJOn;
        "pkg-2.2.0+1.19.4.fabric" = _t4CCN85c;
        "pkg-2.2.0+1.19.4.forge" = _ohTQJwnl;
        "pkg-2.2.0+1.20.2.fabric" = _3B9s6l6Q;
        "pkg-2.2.0+1.20.2.forge" = _yrQt1PrB;
        "pkg-2.2.0+1.20.4.fabric" = _Ank8plVb;
        "pkg-2.2.0+1.20.4.forge" = _jLRSiICV;
        "pkg-2.2.0+1.20.4.neoforge" = _m7y5bIOg;
        "pkg-2.2.0+1.20.1.fabric" = _up5LdO1D;
        "pkg-2.2.0+1.20.1.forge" = _hg5wcOxE;
        "pkg-2.2.1+1.20.4.fabric" = _JU2NYEWS;
        "pkg-2.2.1+1.20.4.neoforge" = _KeKfwpr3;
        "pkg-2.2.1+1.20.4.forge" = _J7mHGDeB;
        "pkg-2.2.1+1.20.2.fabric" = _1kFu1S6N;
        "pkg-2.2.1+1.20.2.forge" = _nTJ6L8XC;
        "pkg-2.2.1+1.20.1.fabric" = _nZc5F6Qy;
        "pkg-2.2.1+1.20.1.forge" = _pCUrsDpM;
        "pkg-2.2.1+1.19.4.fabric" = _ZChesz7n;
        "pkg-2.2.1+1.19.4.forge" = _2gAgGXuo;
        "pkg-2.2.1+1.18.2.fabric" = _rSQ3nOSC;
        "pkg-2.2.1+1.18.2.forge" = _wFUZViWX;
        "pkg-2.3.0+1.20.4.fabric" = _qaaFTKfE;
        "pkg-2.3.0+1.20.4.neoforge" = _PQPjfKUk;
        "pkg-2.3.0+1.20.4.forge" = _AJjhVz6L;
        "pkg-2.3.0+1.20.2.fabric" = _QhKmgs9U;
        "pkg-2.3.0+1.20.2.forge" = _3wArZjEO;
        "pkg-2.3.0+1.20.1.fabric" = _ZfbymFHi;
        "pkg-2.3.0+1.20.1.forge" = _gHF5V7Wk;
        "pkg-2.3.0+1.19.4.fabric" = _8DeNh2sh;
        "pkg-2.3.0+1.19.4.forge" = _xfHJfpl6;
        "pkg-2.3.0+1.18.2.fabric" = _Jm7D59xq;
        "pkg-2.3.0+1.18.2.forge" = _uCkYMkoq;
        "pkg-2.3.1+1.20.6.fabric" = _8QaWVT57;
        "pkg-2.3.1+1.20.6.neoforge" = _TxG62Fx7;
        "pkg-2.3.2+1.20.1.fabric" = _4hiQWKki;
        "pkg-2.3.2+1.20.1.forge" = _5Hwf4wz1;
        "pkg-2.4.0+1.21.fabric" = _FNlqVlTN;
        "pkg-2.4.0+1.21.neoforge" = _sgyBDUJH;
        "pkg-2.4.0+1.20.6.fabric" = _5nGd3oN2;
        "pkg-2.4.0+1.20.6.neoforge" = _iFfDMak4;
        "pkg-2.4.0+1.20.4.fabric" = _ked7IsIw;
        "pkg-2.4.0+1.20.4.forge" = _NQqXYQWo;
        "pkg-2.4.0+1.20.4.neoforge" = _qNznx1JJ;
        "pkg-2.4.0+1.20.1.fabric" = _hqqTAk8y;
        "pkg-2.4.0+1.20.1.forge" = _heyAgmAO;
        "pkg-2.5.0+1.21.1.fabric" = _teCyfBp9;
        "pkg-2.5.0+1.21.1.neoforge" = _VV5mCDKO;
        "pkg-2.5.0+1.20.6.fabric" = _KlLqaVA8;
        "pkg-2.5.0+1.20.6.neoforge" = _y47UsmaL;
        "pkg-2.5.1+1.20.1.fabric" = _PcPvYHBC;
        "pkg-2.5.1+1.20.1.forge" = _gzg9vbI3;
        "pkg-2.5.1+1.21.3.fabric" = _nSvYye8H;
        "pkg-2.5.1+1.21.3.neoforge" = _55ZukOEm;
        "pkg-2.5.2+1.21.3.fabric" = _rR8OtwY1;
        "pkg-2.5.2+1.21.3.neoforge" = _PizVpSIf;
        "pkg-2.6.0+1.21.4.fabric" = _xE1jPEU8;
        "pkg-2.6.0+1.21.4.neoforge" = _rg40tq88;
        "pkg-2.6.1+1.21.4.fabric" = _l4WnhSWZ;
        "pkg-2.6.1+1.21.4.neoforge" = _YHh7giFv;
        "pkg-2.6.1+1.21.1.fabric" = _59KgP2hc;
        "pkg-2.6.1+1.21.1.neoforge" = _fo1RzIjV;
        "pkg-2.6.2+1.21.3.fabric" = _N16ViW2x;
        "pkg-2.6.2+1.21.3.neoforge" = _L8kCpMKP;
        "pkg-2.6.2+1.21.1.fabric" = _gzES5dh5;
        "pkg-2.6.2+1.21.1.neoforge" = _GiR8tHNc;
        "pkg-2.6.2+1.21.5.fabric" = _yUJu2Uge;
        "pkg-2.6.2+1.21.5.neoforge" = _6n0geOe2;
        "pkg-2.6.3+1.21.5.fabric" = _OIh9UYOh;
        "pkg-2.6.3+1.21.5.neoforge" = _3YZOfJ4i;
        "pkg-2.6.3+1.21.8.fabric" = _fmWdHH1a;
        "pkg-2.6.3+1.21.8.neoforge" = _gCg9mP9l;
        "pkg-2.6.3+1.21.10.fabric" = _jZK4g4qM;
        "pkg-2.6.3+1.21.10.neoforge" = _aEEffmyg;
        "pkg-2.6.3+1.21.11.fabric" = _SG12ySmn;
        "pkg-2.6.3+1.21.11.neoforge" = _MtiB3jky;
        "pkg-2.6.4+1.21.11.fabric" = _PgIuiBj7;
        "pkg-2.6.4+1.21.11.neoforge" = _KssjJLYX;
        "pkg-2.6.5+26.1.neoforge" = _tdHa63Kj;
        "pkg-2.6.5+26.1.fabric" = _39CQqvXE;
        "pkg-2.6.6+26.1.fabric" = _NvkT6Vw4;
