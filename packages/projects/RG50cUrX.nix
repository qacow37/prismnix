...
let
    ...
    in {
        ...
        "pkg-1.1.1+1.18" = _KoSoBrF5;
        "pkg-1.1.2+1.18" = _IaCmFu8i;
        "pkg-1.1.3+1.18" = _WuBCRB76;
        "pkg-1.1.3+1.18.2" = _ItKxI7jS;
        "pkg-1.1.4+1.18.2" = _N6JSh58p;
        "pkg-1.1.3-patch1+1.18.2" = _Sc31x6S9;
        "pkg-1.1.4-patch1+1.18.2" = _UhU4AOoo;
        "pkg-1.1.4-patch2+1.18.2" = _qd1qPy5c;
        "pkg-1.1.4-patch3+1.18.2" = _gimBMUbN;
        "pkg-1.1.3-patch2+1.18.2" = _4ytUmjmn;
        "pkg-2.0.0-beta.5+1.19" = _UK1btLwT;
        "pkg-2.0.0-beta.6+1.19" = _Mi2J7Bze;
        "pkg-2.0.0-beta.7+1.19" = _pPIkiIvu;
        "pkg-2.0.0-beta.8+1.19" = _1LnwQNyw;
        "pkg-2.0.0-beta.9+1.19-fabric" = _YeenQwCj;
        "pkg-1.1.4-patch4+1.18.2-forge" = _sIYrgOPN;
        "pkg-3.0.0" = _TYrvquHL;
        "pkg-3.0.1" = _3vp46egv;
        "pkg-3.1.0" = _aJj6NXkv;
        "pkg-1.20.1-3.1.0" = _yCvCXepd;
        "pkg-1.20.1-3.1.1" = _lDSfygeN;
        "pkg-1.21.1-3.1.2" = _r1egimV5;
        "default" = _r1egimV5;
    });
