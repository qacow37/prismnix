...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _CVbkkMmu;
        "pkg-1.0.0-fabric" = _kitmzUBI;
        "pkg-1.0.0-forge" = _9W6HwIa4;
        "pkg-2.0.0" = _xUJNc1iM;
        "pkg-2.0.0-fabric" = _u2M6CudT;
        "pkg-2.0.0-forge" = _mX92WfeA;
        "pkg-2.1.0" = _tFYoBanI;
        "pkg-2.1.0-fabric" = _AvIjA1ZO;
        "pkg-2.1.0-forge" = _Wl7F0joI;
        "pkg-2.1.1" = _tt0tCNeR;
        "pkg-2.1.1-fabric" = _UEjKVm9j;
        "pkg-2.1.1-forge" = _uJHZsEnz;
        "pkg-2.2.0" = _pXUczJ3q;
        "pkg-2.2.0-fabric" = _whgxyqIh;
        "pkg-2.2.0-forge" = _nYwCRtbP;
        "pkg-2.3.0" = _yFCJwQ18;
        "pkg-2.3.0-fabric" = _4p9FXsDe;
        "pkg-2.3.0-forge" = _qKdk7OlS;
        "pkg-2.4.0" = _gf7pqZ0O;
        "pkg-2.4.0-fabric" = _3URUoDWg;
        "pkg-2.4.0-forge" = _YMuQDyL8;
        "pkg-2.5.0" = _JFUjZTcg;
        "pkg-2.5.0-fabric" = _bhtVsGZ0;
        "pkg-2.5.0-forge" = _eMJwqct9;
        "pkg-2.6.0" = _uHaHfn0o;
        "pkg-2.6.0-fabric" = _4gRzVe3V;
        "pkg-2.6.0-forge" = _xoM7tOwS;
        "pkg-2.6.1" = _YFdQRSEe;
        "pkg-2.6.1-forge" = _QLQDJ2w6;
        "pkg-2.6.1-fabic" = _LTcRaXq8;
        "pkg-2.6.2" = _idTxrqQb;
        "pkg-2.6.2-forge" = _7l8TmVB1;
        "pkg-2.6.2-fabric" = _6nQBLJB5;
        "default" = _6nQBLJB5;
    });
