...
let
    ...
    in {
        ...
        "pkg-0.1+1.20.1" = _K2C8n7Zi;
        "pkg-0.2+1.20.1" = _q7SCgvKj;
        "pkg-0.3+1.20.1" = _coEn5ieO;
        "pkg-0.4+1.20.1" = _DLW2L0g5;
        "pkg-1.0+1.21.1+fabric" = _B2nSA8kE;
        "pkg-1.0+1.21.1+neoforge" = _KjmLncjl;
        "pkg-1.0+1.20.1+fabric" = _DY6srqZU;
        "pkg-1.0+1.20.1+forge" = _9lPVsy7y;
        "pkg-1.0+1.19.2+fabric" = _dv1bd2Fd;
        "pkg-1.0+1.19.2+forge" = _cxNCFqex;
        "pkg-1.1+1.21.1+fabric" = _HSzmUgeP;
        "pkg-1.1+1.21.1+neoforge" = _LoBSEn4x;
        "pkg-1.2+1.19.2+fabric" = _kHs2Yuix;
        "pkg-1.2+1.19.2+forge" = _kT7saqqu;
        "pkg-1.2+1.20.1+fabric" = _Gg0pscgP;
        "pkg-1.2+1.20.1+forge" = _o0r0h2yg;
        "pkg-1.2+1.21.1+fabric" = _OwDhxsDZ;
        "pkg-1.2+1.21.1+neoforge" = _1jY6MIrK;
        "pkg-1.3+1.19.2+fabric" = _V9MBlo0q;
        "pkg-1.3+1.19.2+forge" = _CWmRy3QO;
        "pkg-1.3+1.20.1+fabric" = _MFaIVu0T;
        "pkg-1.3+1.20.1+forge" = _JeMEQHWY;
        "pkg-1.3+1.21.1+fabric" = _HpfyBzQQ;
        "pkg-1.3+1.21.1+neoforge" = _V2MXZKsX;
        "default" = _V2MXZKsX;
    });
