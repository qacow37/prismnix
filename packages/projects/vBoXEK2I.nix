...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _pZeJGAzQ;
        "pkg-fabric-1.21-1.0.1" = _SyzB7yYX;
        "pkg-neoforge-1.21-1.0.1" = _vOsij9iL;
        "pkg-fabric-1.21.1-1.1.0-beta" = _gwyHgLfZ;
        "pkg-neoforge-1.21.1-1.1.0-beta" = _PNry1iYx;
        "pkg-fabric-1.21.3-1.1.0-beta" = _GUJsJwu9;
        "pkg-neoforge-1.21.3-1.1.0-beta" = _8ZJpLIgn;
        "pkg-fabric-1.21.1-1.1.1" = _F1TGq4Po;
        "pkg-neoforge-1.21.1-1.1.1" = _mGGXD9HS;
        "pkg-fabric-1.21.3-1.1.1-beta" = _f9fZtUIK;
        "pkg-neoforge-1.21.3-1.1.1-beta" = _hBKIhguu;
        "pkg-fabric-1.21.1-1.1.2" = _w0nAShrn;
        "pkg-neoforge-1.21.1-1.1.2" = _aYBkks4F;
        "pkg-fabric-1.21.3-1.1.2" = _eH8v3xNc;
        "pkg-neoforge-1.21.3-1.1.2" = _RpYdJlg0;
        "pkg-fabric-1.21.1-1.2.0" = _f2kHCVN6;
        "pkg-neoforge-1.21.1-1.2.0" = _q9HmRpda;
        "pkg-fabric-1.21.3-1.2.0" = _kSyCEpQA;
        "pkg-neoforge-1.21.3-1.2.0" = _S0TKxaSv;
        "pkg-fabric-1.21.1-1.2.1" = _55qYcDwR;
        "pkg-neoforge-1.21.1-1.2.1" = _E3lHRhN2;
        "pkg-fabric-1.21.3-1.2.1" = _6X0TiSwI;
        "pkg-neoforge-1.21.3-1.2.1" = _kaL6NTJF;
        "pkg-fabric-1.21.4-1.2.1" = _KeFPsyZ7;
        "pkg-neoforge-1.21.4-1.2.1" = _zCBqmc8O;
        "pkg-fabric-1.21.5-1.2.1" = _8ZOo8OCj;
        "pkg-neoforge-1.21.5-1.2.1" = _D4lBXti2;
        "pkg-fabric-1.21.1-1.3.0" = _2R2azT5z;
        "pkg-neoforge-1.21.1-1.3.0" = _votSqWhL;
        "pkg-fabric-1.21.5-1.3.0" = _YAFWHxZ1;
        "pkg-neoforge-1.21.5-1.3.0" = _MS26kpKX;
        "pkg-fabric-1.21.8-1.3.0" = _JTva3QqQ;
        "pkg-neoforge-1.21.8-1.3.0" = _b0Bot9Ka;
        "pkg-fabric-1.21.10-1.3.0" = _dw2kyl0r;
        "pkg-neoforge-1.21.10-1.3.0" = _FQznAYUX;
        "pkg-fabric-1.21.11-1.3.0" = _51RtVVMo;
        "pkg-neoforge-1.21.11-1.3.0" = _f4NvNwQJ;
        "pkg-fabric-1.21.11-1.3.1" = _LDE97mMJ;
        "pkg-neoforge-1.21.11-1.3.1" = _rGyCpEdn;
        "pkg-fabric-26.1-1.3.1" = _cIeJpBzO;
        "pkg-neoforge-26.1-1.3.1" = _vejCprNp;
        "pkg-fabric-26.1.2-1.3.2" = _MX6EUmfA;
        "pkg-neoforge-26.1.2-1.3.2" = _8oVD3Vcy;
        "default" = _8oVD3Vcy;
    });
