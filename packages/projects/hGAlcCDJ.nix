...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _tC0Figx2;
        "pkg-1.1.0" = _E4By6xAg;
        "pkg-1.19.2-1.3.2.i" = _4rpzz6ie;
        "pkg-1.18.2-1.3.2.i" = _EYBoTYs2;
        "pkg-1.18.2-1.4.1.b-30" = _tNrvSYSW;
        "pkg-1.19.2-1.4.1.b-30" = _p9O1j1Kj;
        "pkg-1.19.2-1.5.0.c-36" = _JQgyvvsV;
        "pkg-1.19.2-1.5.2.c-36" = _IrR4dPhS;
        "pkg-1.20.1-1.5.2.d-9" = _JPmuEb8b;
        "pkg-1.18.2-1.4.2.c-297" = _7hPyKbRO;
        "pkg-1.20.1-1.5.3.d-9" = _Ru1R0U4e;
        "pkg-1.20.1-1.5.4.d-9" = _g5j6LKFp;
        "pkg-1.19.2-1.5.3.c-36" = _zM9fwvFu;
        "pkg-1.19.2-1.5.4.c-36" = _tYXspbhf;
        "pkg-1.19.2-1.5.5.c-36" = _8Tl8996k;
        "pkg-1.19.2-1.5.6.c-36" = _7NCKR1Fk;
        "pkg-1.20.1-1.5.6.d-9" = _76djUHrd;
        "pkg-1.20.1-1.5.7.e-22" = _QHHmejIY;
        "pkg-1.19.2-1.5.7.e-44" = _NiRctAnE;
        "pkg-1.18.2-1.4.4.e-318" = _7uNcLffs;
        "pkg-1.20.1-1.6.0.h-48" = _zLbdvrZw;
        "pkg-1.20.1-1.6.1.h-48" = _eA845nmr;
        "pkg-1.20.1-1.6.2.h-48" = _pFNckCzq;
        "pkg-1.20.1-1.6.3.i-51" = _SEb21Xtm;
        "pkg-1.20.1-1.6.3.j-55" = _umyDyLgf;
        "pkg-1.20.1-1.6.4-6.0.1" = _mW8iVCeQ;
        "pkg-1.20.1-1.6.5-6.0.2" = _n7IumC9b;
        "pkg-1.20.1-1.6.6-6.0.2" = _cWiaMYNq;
        "pkg-1.21.1-2.0.0-6.0.4" = _fKdmbpit;
        "pkg-1.21.1-2.0.2-6.0.4" = _2c2o7TiV;
        "pkg-1.20.1-1.6.7-6.0.4" = _osJEcjfk;
        "pkg-1.20.1-1.6.8-6.0.4" = _NTA1RVge;
        "pkg-1.21.1-2.0.3-6.0.4" = _eEt3KVSA;
        "pkg-1.21.1-2.0.4-6.0.4" = _i0s1eb1X;
        "pkg-1.20.1-1.6.9-6.0.4" = _xrCoD99D;
        "pkg-1.21.1-2.0.5-6.0.4" = _tHwjqTEj;
        "pkg-1.21.1-2.1.0-6.0.4" = _FO6A7nYt;
        "pkg-1.21.1-2.1.1-6.0.4" = _BDpuaojx;
        "pkg-1.21.1-2.1.2-6.0.6" = _KcJtf800;
        "pkg-1.20.1-1.6.10-6.0.6" = _VNMBNgGY;
        "pkg-1.20.1-1.6.11-6.0.6" = _hXjb2B03;
        "pkg-1.21.1-2.2.0-6.0.8" = _Wr4oLYoH;
        "pkg-1.21.1-2.2.1-6.0.10" = _H6QnWJuG;
        "pkg-1.21.1-2.2.2-6.0.10" = _fFDOEXAA;
        "default" = _fFDOEXAA;
    });
