...
let
    ...
    in {
        ...
        "pkg-0.1-1.20-1.20.1" = _gMET3bXv;
        "pkg-0.2.0+1.21" = _XZJavies;
        "pkg-0.2.0+1.21.1" = _1ERt1rfi;
        "pkg-0.2.0+1.21.2" = _z6qNBWtt;
        "pkg-0.2.0+1.21.3" = _vuFPd10I;
        "pkg-0.2.0+1.21.4" = _IdFAiMGi;
        "pkg-0.2.0+1.21.5" = _3IQNSavm;
        "pkg-0.2.0+1.21.6" = _ACzpVEuC;
        "pkg-0.2.0+1.21.7" = _DPB1XoXP;
        "pkg-0.2.0+1.21.8" = _6DVBfaHx;
        "pkg-0.2.0+1.21.9" = _6qgsVMza;
        "pkg-0.2.0+1.21.10" = _Omb8Bqv9;
        "pkg-0.2.0+1.20.6" = _xKYKT4LD;
        "pkg-0.2.0+1.20.5" = _phe2ZLa1;
        "pkg-0.2.0+1.20.4" = _mA6dsOb0;
        "pkg-0.2.0+1.20.3" = _9nLpYBy6;
        "pkg-0.2.0+1.20.2" = _vl4iethW;
        "pkg-0.2.0+1.20.1" = _qhH8XpUJ;
        "pkg-0.2.0+1.19.4" = _PuJStlhE;
        "pkg-0.2.0+1.19.3" = _Wgzjhxmv;
        "pkg-0.2.0+1.19.2" = _fz3xddKb;
        "pkg-0.2.0+1.19.1" = _MCn1uMB4;
        "pkg-0.2.0+1.19" = _bDnxrnTe;
        "pkg-0.2.0+1.18.2" = _dl9nSBR2;
        "pkg-0.2.0+1.18-1.18.1" = _ZfmmEx4e;
        "pkg-0.2.0+1.17-1.17.1" = _edBbpCzu;
        "pkg-0.2.0+neoforge-1.21.1" = _Rcrp5ZAz;
        "pkg-0.2.0+neoforge-1.21.7" = _jLwuKOBm;
        "pkg-0.2.0+neoforge-1.21.8" = _EUvGagqu;
        "pkg-0.2.0+neoforge-1.21.9" = _ucbovPL0;
        "pkg-0.2.0+neoforge-1.21.6" = _OmqqW5ZU;
        "pkg-0.2.0+neoforge-1.21.10" = _j4NtK1DK;
        "pkg-0.2.0+neoforge-1.21.5" = _qtDTSyOJ;
        "pkg-0.2.0+neoforge-1.21.3" = _79xC27TP;
        "pkg-0.2.0+neoforge-1.21.2" = _8a6pe1J3;
        "pkg-0.2.0+neoforge-1.20.6" = _luouKauE;
        "pkg-0.2.0+neoforge-1.20.5" = _PFDPfDLt;
        "pkg-0.2.0+quilt-1.21" = _I1EgPU2g;
        "pkg-0.2.0+quilt-1.20.1" = _j5aysxn6;
        "pkg-0.2.2-turbo+1.19.3-1.19.4" = _qxMRhryu;
        "pkg-0.3.0+1.20.1" = _TxLlOjy9;
        "pkg-0.3.1+1.20-1.20.1" = _VCAMct5C;
        "pkg-0.3.2+1.20.2-1.20.4" = _zW8CZ4Nq;
        "pkg-0.3.3+1.21" = _6dtkSnUG;
        "pkg-0.3.4+1.21-1.21.1" = _3HonQm9D;
        "pkg-0.3.5+1.21-1.21.1" = _xhMb0cXl;
        "pkg-0.3.6+1.21.2" = _AfDnGj88;
        "pkg-0.3.65+1.21.3" = _AVsG7T2p;
        "pkg-0.3.7+1.21.4" = _gmaZrk5l;
        "pkg-0.3.75+26.1.1" = _UYquobTG;
        "pkg-0.3.75+1.21.11" = _IO8vrQPv;
        "pkg-0.3.5+neoforge-1.21.1" = _KUDC8Jhh;
        "default" = _KUDC8Jhh;
    });
