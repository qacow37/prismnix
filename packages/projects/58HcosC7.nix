...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _EZytk06E;
        "pkg-1.0.2" = _jzLX6EK0;
        "pkg-2.0.0-mc1.16.5" = _Eq4hTcw3;
        "pkg-2.0.0-mc1.19.2" = _vl8x3JiB;
        "pkg-2.0.0-mc1.20.1" = _k9lqg1W1;
        "pkg-2.0.0-mc1.20.2" = _annkndeZ;
        "pkg-2.0.0-mc1.19.4" = _eDdrWrlU;
        "pkg-2.0.0-mc1.18.2" = _s93CbrNf;
        "pkg-2.0.0-mc1.20.4" = _VvhJrYu7;
        "pkg-2.0.0-mc1.17.1" = _55XAsFZh;
        "pkg-2.1.0-mc1.21" = _8BXltvZ2;
        "pkg-2.1.0-mc1.17.1" = _opfKGcLD;
        "pkg-2.1.0-mc1.20.6" = _QPBobqq6;
        "pkg-2.1.0-mc1.20.4" = _iC9K4Ghp;
        "pkg-2.1.0-mc1.20.2" = _y1e8I19S;
        "pkg-2.1.0-mc1.16.5" = _qxBnIGIs;
        "pkg-2.1.0-mc1.20.1" = _4cxgYTnG;
        "pkg-2.1.0-mc1.19.2" = _nI1Pth3S;
        "pkg-2.1.0-mc1.19.4" = _HiIE0Q0L;
        "pkg-2.1.0-mc1.18.2" = _B3xFKoHE;
        "pkg-2.3.0-mc1.21.11" = _AiJ3ltcl;
        "pkg-2.3.0-mc1.19.2" = _lUqTJNw0;
        "pkg-2.3.0-mc1.21" = _nd8rKWju;
        "pkg-2.3.0-mc1.20.1" = _3Rc81QOU;
        "pkg-2.3.0-mc1.20.6" = _KcVaxOgv;
        "pkg-2.3.0-mc1.20.4" = _3VN718WJ;
        "pkg-2.3.0-mc1.19.4" = _UMhEYjkh;
        "pkg-2.3.0-mc1.20.2" = _CCNfqamL;
        "pkg-2.3.0-mc1.18.2" = _YTJT8QXw;
        "default" = _YTJT8QXw;
    });
