...
let
    ...
    in {
        ...
        "pkg-1.0.10+MC1.18" = _dZZ93z70;
        "pkg-1.0.11+MC1.18-1.18.1" = _N4oMRD32;
        "pkg-1.0.12+MC1.18-1.18.2" = _SNdZpFMC;
        "pkg-1.0.13+MC1.18-1.18.2" = _5mAwYn4Z;
        "pkg-1.0.14+MC1.19" = _Vkn6MiPR;
        "pkg-1.0.15+MC1.19-1.19.1" = _Pu2HJGvz;
        "pkg-1.0.16+MC1.19-1.19.2" = _2yDAUiDl;
        "pkg-1.0.17+MC1.19.4" = _RKVikHWR;
        "pkg-1.0.18+MC1.20-1.20.1" = _PmR5wc8Q;
        "pkg-1.0.19+MC1.20.2" = _TLGBjj37;
        "pkg-1.0.20+MC1.20.2-1.20.4" = _ydnPXZyX;
        "pkg-1.0.21+MC1.20.2-1.20.5" = _fNMiXy7u;
        "pkg-1.0.22+MC1.20.2-1.20.6" = _YMTIaaf2;
        "pkg-1.1.0+MC1.21" = _7aDYxzkp;
        "pkg-1.1.1+MC1.21-1.21.1" = _CSG51dav;
        "pkg-1.2.0+MC1.21.2-1.21.3" = _iCtX9qnK;
        "pkg-1.2.1+MC1.21.2-1.21.4" = _45tM7YDt;
        "pkg-1.3.0+MC1.21.5" = _TZlADsnF;
        "pkg-1.3.1+MC1.21.5-1.21.6" = _dtlnMbTn;
        "pkg-1.3.2+MC1.21.5-1.21.7" = _UKp4qTEJ;
        "pkg-1.3.3+MC1.21.5-1.21.8" = _SAROnCgz;
        "pkg-1.4.0+MC1.21.9" = _osivK6q9;
        "pkg-1.4.1+MC1.21.9-1.21.10" = _wAPuN9aH;
        "pkg-1.5.0+MC1.21.11" = _UK2OGWWH;
        "pkg-1.3.4+MC1.21.5-1.21.8" = _po913mHO;
        "pkg-1.4.2+MC1.21.9-1.21.10" = _U56UShou;
