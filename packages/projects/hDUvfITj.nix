...
let
    ...
    in {
        ...
        "pkg-v1.0.1-mc1.17" = _OGK1BdWR;
        "pkg-v1.0.1-mc1.18" = _tSy410dj;
        "pkg-v1.0.1-mc1.20" = _MdZsYV3Q;
        "pkg-v1.0.1-mc1.14.4" = _A8knFSSQ;
        "pkg-v1.0.1-mc1.19" = _ZIgAi58e;
        "pkg-v1.0.1-mc1.21" = _jzYxZMUJ;
        "pkg-v1.0.1-mc1.16" = _QPXtsmIC;
        "pkg-v1.0.1-mc1.15" = _8uvQadSn;
        "pkg-v1.0.2-mc1.21" = _xJutFYvh;
        "pkg-v1.0.2-mc1.20" = _XiCtbGGZ;
        "pkg-v1.0.2-mc1.15" = _KjfEAEhX;
        "pkg-v1.0.2-mc1.19" = _QClDVhvp;
        "pkg-v1.0.2-mc1.18" = _3xWla3X4;
        "pkg-v1.0.2-mc1.17" = _OZWnfJuq;
        "pkg-v1.0.2-mc1.14.4" = _nv7gYumQ;
        "pkg-v1.0.2-mc1.16" = _HxorLKA4;
        "pkg-v1.0.3-mc1.18" = _mpkijpsa;
        "pkg-v1.0.3-mc1.20" = _zEVdDd7r;
        "pkg-v1.0.3-mc1.15" = _EPSau4Nj;
        "pkg-v1.0.3-mc1.17" = _PUKVIaAc;
        "pkg-v1.0.3-mc1.21" = _i3wh1yoP;
        "pkg-v1.0.3-mc1.19" = _SF8lNIye;
        "pkg-v1.0.3-mc1.14.4" = _Ritmkbuw;
        "pkg-v1.0.3-mc1.16" = _cOz26Nk6;
        "pkg-v1.0.4-mc1.17" = _lSnfYdgZ;
        "pkg-v1.0.4-mc1.14.4" = _SDE1MK4o;
        "pkg-v1.0.4-mc1.21" = _v1iF8m9u;
        "pkg-v1.0.4-mc1.15" = _nGgpGx3p;
        "pkg-v1.0.4-mc1.16" = _9zA7D8lA;
        "pkg-v1.0.4-mc1.18" = _WAXxtkeV;
        "pkg-v1.0.4-mc1.19" = _uALPLswY;
        "pkg-v1.0.4-mc1.20" = _HWmwDO68;
        "pkg-v1.0.4-mc26.1" = _F2QwipAu;
        "pkg-v1.1.0-mc1.20" = _8n7FMnV5;
        "pkg-v1.1.0-mc26.1" = _5KFrUPEq;
        "pkg-v1.1.0-mc1.15" = _1PxaEWHt;
        "pkg-v1.1.0-mc1.19" = _w9My0mGg;
        "pkg-v1.1.0-mc1.16" = _g1NSlGZ7;
        "pkg-v1.1.0-mc1.14.4" = _yIqugAjv;
        "pkg-v1.1.0-mc1.18" = _7vkX3m1E;
        "pkg-v1.1.0-mc1.21" = _4moLC8eW;
        "pkg-v1.1.1-mc1.16" = _2xUrRooW;
        "pkg-v1.1.1-mc1.17" = _dVeLJCyx;
        "pkg-v1.1.1-mc1.15" = _tKgYfI4B;
        "pkg-v1.1.1-mc1.18" = _Fa8XS1PI;
        "pkg-v1.1.1-mc1.21" = _ATe30fyB;
        "pkg-v1.1.1-mc1.20" = _ydTVMh5Z;
        "pkg-v1.1.1-mc1.14.4" = _2ZdjWRTK;
        "pkg-v1.1.1-mc1.19" = _CFKT6snk;
        "pkg-v1.1.1-mc26.1" = _Ce9Vgj3i;
        "pkg-v1.1.2-mc1.17" = _5SlOULZG;
        "pkg-v1.1.2-mc1.14.4" = _VmMy3j5x;
        "pkg-v1.1.2-mc1.21" = _FQeFfaDV;
        "pkg-v1.1.2-mc1.20" = _ejDiHD4W;
        "pkg-v1.1.2-mc1.19" = _OIGWQBFo;
        "pkg-v1.1.2-mc1.18" = _YNDPoEeL;
        "pkg-v1.1.2-mc26.1" = _FVbbEu2w;
        "pkg-v1.1.2-mc1.16" = _o1D6G0zx;
        "pkg-v1.1.2-mc1.15" = _hb2wYCz0;
        "pkg-v1.1.3-mc26.1" = _StZ8D1mE;
        "pkg-v1.1.3-mc1.20" = _oVnOnM0Q;
        "pkg-v1.1.3-mc1.21" = _zh72BEcr;
        "pkg-v1.1.3-mc1.15" = _tU8QY2JE;
        "pkg-v1.1.3-mc1.17" = _VF0Xrb5B;
        "pkg-v1.1.3-mc1.19" = _7lDgSnWa;
        "pkg-v1.1.3-mc1.14.4" = _anAEjbe4;
        "pkg-v1.1.3-mc1.16" = _TSHQDAhT;
        "pkg-v1.1.3-mc1.18" = _saD5qXig;
        "pkg-v1.1.4-mc26.1" = _8GGuXesO;
        "pkg-v1.1.4-mc1.17" = _B9mn5bVp;
        "pkg-v1.1.4-mc26.2" = _lz1lkbqm;
        "pkg-v1.1.4-mc1.14.4" = _2yPNXgtP;
        "pkg-v1.1.4-mc1.16" = _1tW1FqPo;
        "pkg-v1.1.4-mc1.15" = _C9swJLeu;
        "pkg-v1.1.4-mc1.19" = _jYxlyTXS;
        "pkg-v1.1.4-mc1.18" = _zzaarc7d;
        "pkg-v1.1.4-mc1.21" = _yyktDTYN;
        "pkg-v1.1.4-mc1.20" = _YYeIy4OV;
        "default" = _YYeIy4OV;
    });
