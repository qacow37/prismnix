...
let
    ...
    in {
        ...
        "pkg-1.16.4-1.5.0" = _GUFg9m4q;
        "pkg-1.12.2-1.3.0" = _m8vmgbIi;
        "pkg-1.16.5-1.5.1" = _qb9aknHS;
        "pkg-1.16.5-1.6.0-alpha+20210714-2301" = _IRT0Vs90;
        "pkg-1.16.5-1.6.0-beta.1" = _h7GD4rFG;
        "pkg-1.16.5-1.6.0" = _Qf6z4VUN;
        "pkg-1.16.5-1.7.0-alpha+20211107-1428" = _x6pZpL1K;
        "pkg-1.16.5-1.7.0-alpha+20211128-1226" = _vmwA8uQY;
        "pkg-1.16.5-1.6.1" = _hwSFmm73;
        "pkg-1.18.2-1.7.0-alpha+20220703-0014" = _2nbRoApt;
        "pkg-1.18.2-1.7.0-alpha+20220820-2300" = _oODE1oIL;
        "pkg-1.18.2-1.7.0-alpha+20220820-2317" = _DFcORfcg;
        "pkg-1.18.2-1.7.0-beta.1" = _TEVh9etl;
        "pkg-1.19.2-1.7.0-alpha+20220918-1759" = _W1TZfplx;
        "pkg-1.19.2-1.8.0-alpha+20221105-1524" = _fRYxjOkO;
        "pkg-1.19.2-1.8.0-beta.1" = _E7rCTrCT;
        "pkg-1.19.2-1.8.0-beta.2" = _efo5TcXe;
        "pkg-1.19.2-1.8.0-beta.3" = _1YW1Hfvb;
        "pkg-1.19.2-1.8.0" = _UIwlsAjU;
        "pkg-1.19.3-1.8.0-beta.1" = _NL4CDKWO;
        "pkg-1.20.1-1.8.0-beta.1" = _F9cBW7Nt;
        "pkg-1.8.0" = _FCWlXprr;
        "pkg-1.9.0" = _Rgs0vJqh;
        "pkg-1.9.1" = _UTvzbRFz;
        "pkg-1.20.1-1.8.1" = _dsE1VyaZ;
        "pkg-1.20.1-1.8.2" = _vmpNGzMC;
        "pkg-1.21.1-1.10.0" = _lUZ3VFxN;
        "pkg-1.21.1-1.10.2" = _ua6OU2jv;
        "default" = _ua6OU2jv;
    });
