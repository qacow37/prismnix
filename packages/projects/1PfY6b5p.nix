...
let
    ...
    in {
        ...
        "pkg-6.5.436" = _duLjfOOU;
        "pkg-7.4.456" = _AekMcm56;
        "pkg-6.5.433" = _zL5gCgo3;
        "pkg-8.2.479+jei-internals-workaround" = _cZvXFMY1;
        "pkg-9.0.480+jei-internals-workaround" = _tEkjggYf;
        "pkg-9.0.482+jei-internals-workaround" = _KvxElpZc;
        "pkg-8.2.481+jei-internals-workaround" = _lu8oUV0I;
        "pkg-8.2.483+jei-internals-workaround" = _7YsbcgzW;
        "pkg-9.0.484+jei-internals-workaround" = _4wMUdI2u;
        "pkg-8.2.485+jei-internals-workaround" = _5alAySEo;
        "pkg-9.0.486+jei-internals-workaround" = _k0fFHgbq;
        "pkg-9.0.488+jei-internals-workaround" = _jpdKlt37;
        "pkg-8.2.487+jei-internals-workaround" = _D0m9bgtU;
        "pkg-9.0.489+jei-internals-workaround" = _WFlYZPt5;
        "pkg-8.2.490+jei-internals-workaround" = _yIt6Ttxw;
        "pkg-9.0.491+jei-internals-workaround" = _4xmddMta;
        "pkg-8.2.492+jei-internals-workaround" = _QZ8jGbw8;
        "pkg-9.0.493+jei-internals-workaround" = _NsmaajOh;
        "pkg-8.3.494+jei-internals-workaround" = _bBUkxiQC;
        "pkg-8.3.495+jei-internals-workaround" = _CtQvdFfV;
        "pkg-8.3.497+jei-internals-workaround" = _JQs1zDNe;
        "pkg-8.3.498+jei-internals-workaround" = _pcYMQWLz;
        "pkg-9.1.499+jei-internals-workaround" = _o7Y7IYdA;
        "pkg-9.1.500+jei-internals-workaround" = _GhOoSz7J;
        "pkg-8.3.501+jei-internals-workaround" = _PKa6IXvd;
        "pkg-8.3.502+jei-internals-workaround" = _z4z1vP3e;
        "pkg-9.1.503+jei-internals-workaround" = _eaDbJyiq;
        "pkg-9.1.504+jei-internals-workaround" = _N4CHuYyY;
        "pkg-9.1.509+jei-internals-workaround" = _AUuUF3ol;
        "pkg-8.3.508+jei-internals-workaround" = _llbb0Hcr;
        "pkg-8.3.510+jei-internals-workaround" = _JtDgkWwO;
        "pkg-9.1.511+jei-internals-workaround" = _utFuYds1;
        "pkg-9.1.514+jei-internals-workaround" = _fVAfr7PC;
        "pkg-9.1.517+jei-internals-workaround" = _8QWZZSUP;
        "pkg-9.1.518+jei-internals-workaround" = _DRp5Q0Qa;
        "pkg-8.3.519+jei-internals-workaround" = _pQkjAyZ2;
        "pkg-9.1.520+jei-internals-workaround" = _X25cygtK;
        "pkg-9.1.522+jei-internals-workaround" = _ahQ82B7T;
        "pkg-8.3.521+jei-internals-workaround" = _LdOAivW3;
        "pkg-9.1.524+jei-internals-workaround" = _sZ1ZrEVs;
        "pkg-9.1.526+jei-internals-workaround" = _1n6ynzdF;
        "pkg-8.3.525+jei-internals-workaround" = _2cCgVe9c;
        "pkg-9.1.528+jei-internals-workaround" = _1NGV5xuf;
        "pkg-8.3.527+jei-internals-workaround" = _JkChgzxt;
        "pkg-9.1.530+jei-internals-workaround" = _ertPN6Uw;
        "pkg-8.3.529+jei-internals-workaround" = _4cecgoBY;
        "pkg-8.0.4" = _OTmaVGNe;
        "pkg-8.0.7" = _bBqw7zAB;
        "pkg-9.0.8" = _Vmp22HeW;
        "pkg-9.0.9" = _aovVt7z6;
        "pkg-8.0.11" = _uTqcawz6;
        "pkg-9.0.13" = _xPAp92c6;
        "pkg-8.0.14" = _Sn3gDIzc;
        "pkg-9.0.16" = _558DzFxT;
        "pkg-9.0.17" = _LsEndJtD;
        "pkg-8.0.18" = _HHYu0QSD;
        "pkg-8.0.19" = _LuZ6wAjK;
        "pkg-9.0.20" = _3QhAJB5Z;
        "pkg-9.0.21" = _W9WPKERe;
        "pkg-8.0.22" = _ygKft3fz;
        "pkg-9.0.23" = _8qZ9UFH8;
        "pkg-8.0.24" = _ThcgXfmQ;
        "pkg-8.0.25" = _CsPI6ES4;
        "pkg-9.0.26" = _JKFQIYLO;
        "pkg-8.0.27" = _DTAlAKAa;
        "pkg-8.0.28" = _yQQ9JMmy;
        "pkg-8.0.29" = _lJLCExcp;
        "pkg-8.0.31" = _CLJ3n0yM;
        "pkg-8.0.32" = _gmSivK3u;
        "pkg-8.0.33" = _BOrfe16c;
        "pkg-9.0.34" = _pvH3iJRE;
        "pkg-8.0.35" = _Ef6JUyyD;
        "pkg-8.0.36" = _MsiwTOg3;
        "pkg-9.0.37" = _oxXYznEj;
        "pkg-8.0.38" = _aZIKzHdX;
        "pkg-9.0.39" = _Qhl15ogd;
        "pkg-9.0.43" = _JsYqOhKJ;
        "pkg-8.0.42" = _aYzCrgrG;
        "pkg-9.0.44" = _r9hO3WpB;
        "pkg-10.0.45" = _iTyg0vRe;
        "pkg-8.0.46" = _lHuQQvms;
        "pkg-9.0.47" = _DEA8SzQu;
        "pkg-9.0.48" = _PMFl23RM;
        "pkg-10.0.49" = _TJp09FKM;
        "pkg-10.0.52" = _UApfWXRv;
        "pkg-11.0.53" = _gLocpMCl;
        "pkg-12.0.54" = _G7ceo6lO;
        "pkg-12.0.55" = _Lrg5RvVL;
        "pkg-8.0.57" = _DPZsYh5a;
        "pkg-8.0.58" = _Q8Olp5Of;
        "pkg-9.0.60" = _vtbo0d4P;
        "pkg-11.0.61" = _vRHpzB76;
        "pkg-9.0.63" = _8srgLs0h;
        "pkg-8.0.64" = _o3LBgZPP;
        "pkg-8.0.65" = _v0GImez7;
        "pkg-9.0.66" = _vNlGRvPP;
        "pkg-11.0.67" = _bgowbFmw;
        "pkg-12.0.68" = _RfBaWe4F;
        "pkg-11.0.71" = _uzzpttGx;
        "pkg-8.0.69" = _i1QGUucW;
        "pkg-12.0.72" = _7GGazNiP;
        "pkg-9.0.70" = _AYKvRYvq;
        "pkg-11.0.75" = _ovF7giEH;
        "pkg-8.0.73" = _DIfIPDly;
        "pkg-9.0.74" = _kkTEixVC;
        "pkg-12.0.76" = _MkiJkcfd;
        "pkg-8.0.77" = _8dukmUOY;
        "pkg-11.0.79" = _raBaF7ZW;
        "pkg-9.0.78" = _EzA1j7v1;
        "pkg-12.0.80" = _gVesiJkO;
        "pkg-8.0.83" = _FfHqSBzo;
        "pkg-9.0.84" = _Y9n2xFHU;
        "pkg-11.0.85" = _Vyu6OfNX;
        "pkg-12.0.88" = _CqC2HR3H;
        "pkg-8.0.89" = _7TWHgIxN;
        "pkg-9.0.90" = _VRug9EYM;
        "pkg-12.0.93" = _XwQE7XRH;
        "pkg-11.0.92" = _bdVhPDkn;
        "default" = _bdVhPDkn;
    });
