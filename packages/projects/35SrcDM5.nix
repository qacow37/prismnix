...
let
    ...
    in {
        ...
        "pkg-0.1.0-1.19.4" = _gfebZhl2;
        "pkg-0.1.1-1.19.4" = _KqQSt25r;
        "pkg-0.1.2-1.19.4" = _dKeEb9hb;
        "pkg-0.1.3-1.19.4" = _zxBRdBjH;
        "pkg-0.1.4-1.19.4" = _R6zd3Sl9;
        "pkg-0.1.5-1.19.4" = _QpopecpJ;
        "pkg-0.1.6-1.19.4" = _kli2NKoo;
        "pkg-0.1.7-1.19.4" = _aWnLUdPv;
        "pkg-0.1.8-1.19.4" = _HfO4OGoB;
        "pkg-0.1.9-1.19.4" = _7eOLS6vk;
        "pkg-0.1.9+bettercombat-1.19.4" = _lOz3rvCP;
        "pkg-0.1.10-1.19.4" = _HG9y3NLr;
        "pkg-0.1.11-1.19.4" = _kb27v6ji;
        "pkg-0.1.11+bettercombat-1.19.4" = _LQyRyvfw;
        "pkg-0.1.12-1.19.4" = _w4JL9W5T;
        "pkg-0.1.12+bettercombat-1.19.4" = _4I5FHKoy;
        "pkg-1.0.0-1.19.4" = _3OtTmd66;
        "pkg-1.0.0+bettercombat-1.19.4" = _sQlNtgl5;
        "pkg-1.0.1-1.19.4" = _W89UU105;
        "pkg-1.0.1-1.19.4+bettercombat" = _sb8El0IQ;
        "pkg-1.1.0-1.20.1" = _AS98rDyy;
        "pkg-1.1.0-1.20.1+bettercombat" = _pUKfXHSM;
        "pkg-1.1.1-1.20.1" = _nbUgYXfS;
        "pkg-1.1.1-1.20.1+bettercombat" = _dVUnpREA;
        "pkg-1.1.2-1.20.1" = _hQydcszw;
        "pkg-1.1.2-1.20.1+bettercombat" = _x3su3byS;
        "pkg-1.1.3-1.20.1" = _RWGWu73v;
        "pkg-1.1.3-1.20.1+bettercombat" = _q9wCD4yL;
        "pkg-1.1.3.a-1.20.1" = _wrrNzmmW;
        "pkg-1.1.3.a-1.20.1+bettercombat" = _TNBHbyI3;
        "pkg-1.1.4-1.20.2" = _h3v3RHPI;
        "pkg-1.1.4-1.20.2+bettercombat" = _gn9gsEiv;
        "pkg-1.1.5-1.20.4" = _CzNsQ6Wi;
        "pkg-1.1.5-1.20.4+bettercombat" = _IgJxg28n;
        "pkg-1.1.6-1.20.6" = _aDp0Vld2;
        "pkg-1.1.7-1.20.6" = _pr6cl59s;
        "pkg-1.2.0-1.21" = _CLnu51jV;
        "pkg-1.2.0.a-1.21" = _jH8n7STZ;
        "pkg-1.2.1-1.21" = _kL92ek09;
        "pkg-1.2.2-1.21.1" = _r3009Xjp;
        "pkg-1.2.2-1.21.1+bettercombat" = _My8pVCrd;
        "default" = _My8pVCrd;
    });
