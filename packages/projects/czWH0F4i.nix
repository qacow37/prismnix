...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.19" = _VROO57oo;
        "pkg-0.1.1+1.19" = _mUuBHWOK;
        "pkg-0.1.2+1.19" = _HnPbSgCN;
        "pkg-0.1.2+1.19.3" = _wkJtbQCF;
        "pkg-0.1.3+1.19" = _sGg7wC5A;
        "pkg-0.1.3+1.19.3" = _Caqg6YsV;
        "pkg-0.2.0+1.19" = _WzzMt3F9;
        "pkg-0.2.0+1.19.3" = _euQpG12B;
        "pkg-0.2.1+1.19" = _K88aOnPd;
        "pkg-0.2.1+1.19.3" = _FHE2xPAG;
        "pkg-0.2.2+1.19" = _KIjWmgXe;
        "pkg-0.2.2+1.19.3" = _2bbtPqPW;
        "pkg-0.2.3+1.19" = _pFqsJJPr;
        "pkg-0.2.3+1.19.3" = _kUhqxO8g;
        "pkg-0.2.4+1.19" = _R0Ao7RLV;
        "pkg-0.2.4+1.19.3" = _9UQYJb7t;
        "pkg-0.2.5+1.19" = _nejYIWvF;
        "pkg-0.2.5+1.19.3" = _meaOuLf2;
        "pkg-0.3.0+1.19" = _BXhMkYzT;
        "pkg-0.3.0+1.19.3" = _zlCRj7lX;
        "pkg-0.3.0+1.19.4" = _l94uQL4K;
        "pkg-0.3.0+1.20.1" = _PKXfOYtK;
        "pkg-0.3.1+1.19.4" = _LvERiOLd;
        "pkg-0.3.1+1.20.1" = _ETlZbcSR;
        "default" = _ETlZbcSR;
    });
