...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.1.5" = _jiqMfYvN;
        "pkg-1.16.5-1.1.5" = _LgNXAHTb;
        "pkg-1.16.5-1.1.6" = _O7g8Rkxn;
        "pkg-1.19.2-1.1.6" = _11Ozha8y;
        "pkg-1.16.5-1.1.7" = _VpX8DK7F;
        "pkg-1.19.2-1.1.7" = _IJxxTBLU;
        "pkg-1.20.1-1.1.7" = _oOgtEfPe;
        "pkg-1.16.5-1.1.8" = _6jV1Fm1z;
        "pkg-1.19.2-1.1.8" = _3GDIH3NR;
        "pkg-1.20.1-1.1.8" = _4TiP70ky;
        "pkg-1.18.2-1.1.9" = _bSCsFMR3;
        "pkg-1.16.5-1.1.9" = _oYeMoPGw;
        "pkg-1.19.2-1.1.9" = _WMeHnQnQ;
        "pkg-1.20.1-1.1.9" = _Jdg4SYrS;
        "pkg-1.20.1-1.2.0" = _CjkKvWX8;
        "pkg-1.20.1-1.2.2" = _QqPGHZ4s;
        "pkg-1.20.1-1.2.3" = _DAeeG3kI;
        "pkg-1.20.1-1.2.4" = _1XDMmsqc;
        "pkg-1.16.5-1.2.4" = _uhOFqsLA;
        "pkg-1.20.1-1.2.4.1" = _ylXGHFXE;
        "pkg-1.2.5" = _UVHro3kG;
        "pkg-1.2.6" = _Wo4tnGxa;
        "pkg-1.2.7" = _4R7Nxxza;
        "default" = _4R7Nxxza;
