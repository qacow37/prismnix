...
let
    ...
    in {
        ...
        "pkg-0.1.0-fabric" = _zlqlWLHV;
        "pkg-0.1.0-forge" = _UX8BffVp;
        "pkg-0.1.1-fabric" = _MrusfalF;
        "pkg-0.1.1-forge" = _PdKkYeIn;
        "pkg-0.1.1b-fabric" = _EfuQ2Az4;
        "pkg-0.1.1b-forge" = _252cjNuE;
        "pkg-0.1.1c-forge" = _cxNUR6T6;
        "pkg-0.1.2-fabric" = _gJMxvG3r;
        "pkg-0.1.2-forge" = _r0GIA86R;
        "pkg-0.2.0-fabric" = _Z8omf70R;
        "pkg-0.2.0-forge" = _8zavDDS5;
        "pkg-0.2.0b-forge" = _hBLTDgWO;
        "pkg-0.2.1-fabric" = _AblbZlhp;
        "pkg-0.2.1-forge" = _AinoXiz8;
        "pkg-0.2.2-fabric" = _hwGHXw7r;
        "pkg-0.2.2-forge" = _vnhB7Gst;
        "pkg-0.2.3-fabric" = _4hIMa6NC;
        "pkg-0.2.3-forge" = _QX9iT4GF;
        "pkg-1.0.0" = _A1Rn1h5T;
        "pkg-1.1.0" = _zdbRxuMH;
        "pkg-1.1.1" = _jpLFRyo4;
        "pkg-1.1.2" = _EUzm3A2k;
