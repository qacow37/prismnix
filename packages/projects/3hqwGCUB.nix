...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.5-fabric" = _P6DHeDdg;
        "pkg-1.18.2-2.5-fabric" = _UfoeFaFF;
        "pkg-1.19.2-2.6-fabric" = _62jLbgvt;
        "pkg-1.16.5-2.1-forge" = _FFAOOk8A;
        "pkg-1.18.2-2.2-forge" = _p3CLCCfI;
        "pkg-1.19.2-2.4-forge" = _gNHxktMU;
        "pkg-1.16.5-3.0-fabric" = _R3VYLoTd;
        "pkg-1.18.2-3.0-fabric" = _piQygCPN;
        "pkg-1.19.2-3.0-fabric" = _zNFtMvNl;
        "pkg-1.16.5-3.0-forge" = _ibcNctOb;
        "pkg-1.18.2-3.0-forge" = _cvFePezC;
        "pkg-1.19.2-3.0-forge" = _xkCbTb1f;
        "pkg-1.16.5-3.1-fabric" = _7HTWG1Az;
        "pkg-1.18.2-3.1-fabric" = _Up2Oq4iZ;
        "pkg-1.19.2-3.1-fabric" = _S6OiCji6;
        "pkg-1.16.5-3.2-fabric" = _IYZyrUbG;
        "pkg-1.18.2-3.2-fabric" = _DyS0gf3a;
        "pkg-1.19.2-3.2-fabric" = _GFsZ2KKV;
        "pkg-1.19.3-3.3-fabric" = _p2yO37IJ;
        "pkg-1.19.3-3.0-forge" = _pHRf9nFa;
        "pkg-1.18.2-4.0-forge+fabric" = _T8zDjHpf;
        "pkg-1.19.2-4.0-forge+fabric" = _5ahwtb21;
        "pkg-1.19.3-4.0-forge+fabric" = _Nw7fbsco;
        "pkg-1.19.4-4.0-forge+fabric" = _4LqHZQi8;
        "pkg-1.20-4.0-forge+fabric" = _cDkjIedq;
        "pkg-1.20.1-4.0-forge+fabric" = _7JnWgFvA;
        "pkg-1.20.2-4.0-forge+fabric" = _88SMSO6v;
        "pkg-1.18.2-4.1-forge+fabric" = _1hUFUwXf;
        "pkg-1.19.2-4.1-forge+fabric" = _lL86arX5;
        "pkg-1.20.1-4.1-forge+fabric" = _nvVrt8ft;
        "pkg-1.20.2-4.1-forge+fabric" = _awLqAsq8;
        "pkg-1.20.3-4.1-fabric+forge+neo" = _8aabAiYa;
        "pkg-1.20.4-4.1-fabric+forge+neo" = _AdoQDOK4;
        "pkg-1.19.2-4.2-fabric+forge+neo" = _aQHYS7BG;
        "pkg-1.20.1-4.2-fabric+forge+neo" = _hya1UIhv;
        "pkg-1.20.2-4.2-fabric+forge+neo" = _rTrEUuhN;
        "pkg-1.20.4-4.2-fabric+forge+neo" = _W7SW9TPy;
        "pkg-1.20.5-4.2-fabric+neo" = _NddjiWjT;
        "pkg-1.20.5-4.3-fabric+neo" = _pUo5LvFR;
        "pkg-1.20.6-4.3-fabric+forge+neo" = _iSD9aKrt;
        "pkg-1.21.0-4.3-fabric+forge+neo" = _kO0JxLTJ;
        "pkg-1.20.1-4.4-fabric+forge+neo" = _SNRYcqIe;
        "pkg-1.20.6-4.4-fabric+forge+neo" = _siPhM6CD;
        "pkg-1.21.0-4.4-fabric+forge+neo" = _vXIjwoCB;
        "pkg-1.21.1-4.4-fabric+forge+neo" = _A5ElRaly;
        "pkg-1.21.2-4.4-fabric+neo" = _ngVEbeyC;
        "pkg-1.21.3-4.4-fabric+forge+neo" = _7pj1oy7P;
        "pkg-1.21.4-4.4-fabric+forge+neo" = _RFef4kAG;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _JBhBlmby;
        "pkg-1.21.1-4.5-fabric+forge+neo" = _7JjYvNu3;
        "pkg-1.21.4-4.5-fabric+forge+neo" = _xBq7pdsy;
        "pkg-1.21.5-4.5-fabric+forge+neo" = _3dwFGkOm;
        "pkg-1.21.6-4.5-fabric+forge+neo" = _h33kOOWx;
        "pkg-1.21.7-4.5-fabric+forge+neo" = _4GkN6w6m;
        "pkg-1.21.8-4.5-fabric+forge+neo" = _60YP8IZc;
        "pkg-1.21.9-4.5-fabric+forge+neo" = _zTAJKeJE;
        "pkg-1.21.10-4.5-fabric+forge+neo" = _FHv71PSV;
        "pkg-1.21.11-4.5-fabric+forge+neo" = _CVTWxSA5;
        "pkg-26.1.0-4.5-fabric+forge+neo" = _gqYmABWD;
        "pkg-26.1.1-4.5-fabric+forge+neo" = _BccxOPX4;
        "pkg-26.1.2-4.5-fabric+forge+neo" = _nVLVFt6W;
        "pkg-26.2.0-4.5-fabric+forge+neo" = _7Aba4chS;
        "default" = _7Aba4chS;
    });
