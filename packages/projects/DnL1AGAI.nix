...
let
    ...
    in {
        ...
        "pkg-1.0" = _fnYT7f4a;
        "pkg-1.1.0+mc1.20.4" = _2nm7nVco;
        "pkg-1.2.0+mc1.21.x" = _icYblK7E;
        "pkg-1.2.0+mc1.20.6" = _oH4gfyPc;
        "pkg-1.2.0+mc1.20.4" = _RS5Jk3mQ;
        "pkg-1.2.1+mc1.21.4" = _nVZSf2ho;
        "pkg-1.2.1+mc1.20.4" = _l3tZQ0Ht;
        "pkg-1.2.1+mc1.20.6" = _2WvBpcMq;
        "pkg-1.3.0+mc1.21.4" = _ISsI4tZ0;
        "pkg-1.3.0+mc1.20.6" = _FxeoXWZp;
        "pkg-1.3.0+mc1.20.4" = _mJDIVf1e;
        "pkg-1.3.1+mc1.21.5" = _SAVEdZB5;
        "pkg-1.4.0+mc1.21.8" = _sPAF8FJj;
        "pkg-1.4.0+mc1.21.5" = _jWW7qFrD;
        "pkg-1.4.0+mc1.20.6" = _YJafeQJs;
        "pkg-1.4.0+mc1.20.4" = _aSiRovdV;
        "pkg-1.4.0+mc1.21.9" = _dfpeeOqt;
        "pkg-1.4.1+mc1.21.10" = _epzVvDut;
        "pkg-1.4.2+mc1.21.10" = _GZ9coFPY;
        "pkg-1.4.2+mc1.21.11" = _54qpkztb;
        "pkg-1.5.0+mc1.21.5" = _FEpqJokv;
        "pkg-1.5.0+mc1.21.8" = _EYrLtuV9;
        "pkg-1.5.0+mc1.21.10" = _flTNYVPL;
        "pkg-1.5.0+mc1.21.11" = _xHfDOWcV;
        "pkg-1.5.0+mc1.20.4" = _7y9wMNSS;
        "pkg-1.5.0+mc1.20.6" = _EkAKnDG5;
        "pkg-1.6.0+mc26.1.2" = _EDKCdJHU;
        "pkg-1.6.0+mc1.21.11" = _WHlzrmYt;
        "pkg-1.6.0+mc1.20.4" = _7HYD2I2R;
        "pkg-1.6.0+mc1.20.6" = _1GX46Qn3;
        "pkg-1.6.0+mc1.21.5" = _bt7XHLNp;
        "pkg-1.6.0+mc1.21.8" = _1MMYT4k5;
        "pkg-1.6.0+mc1.21.10" = _HnbGSTkc;
        "default" = _HnbGSTkc;
    });
