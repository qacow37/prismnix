...
let
    ...
    in {
        ...
        "pkg-1.17-0.0.2" = _9PqukzkA;
        "pkg-1.17-0.0.2-forge" = _aTd1oyKQ;
        "pkg-1.18-0.0.3-fabric" = _n8Cenodv;
        "pkg-1.18-0.0.3-forge" = _LTlP4Rft;
        "pkg-1.19-0.0.3-fabric" = _dLJpu25F;
        "pkg-1.19-0.0.3-forge" = _ZZmwr4IG;
        "pkg-1.19.1-1.19.2-fabric" = _6ntFgSkW;
        "pkg-1.19.x-0.0.4" = _sfI1Ijd2;
        "pkg-1.19.3-1.19.4-0.0.4" = _ggcaKnQr;
        "pkg-1.20.x-0.0.5-forge" = _msJBWPLN;
        "pkg-1.20.x-0.0.5-fabric" = _Q3Z6GESL;
        "pkg-1.21-1.21.1-0.0.6-fabric" = _2fKkBn4m;
        "pkg-1.21-1.21.1-0.0.6-forge" = _45Y36wzm;
        "pkg-1.21-1.21.1-0.0.6-neoforge" = _6EYLZUOH;
        "pkg-1.21.2-1.21.3-0.0.6-fabric" = _mYziuRMS;
        "pkg-1.21.2-1.21.3-0.0.6-forge" = _FCKK2wE6;
        "pkg-1.21.2-1.21.3-0.0.6-neoforge" = _ZcTSUfYY;
        "pkg-1.21.4-0.0.6-fabric" = _s2YYGiGA;
        "pkg-1.21.4-0.0.6-forge" = _jFkoF1eJ;
        "pkg-1.21.4-0.0.6-neoforge" = _7MojCr1j;
        "pkg-1.21.2-1.21.3-p-0.0.6-neoforge" = _UOyQ7wkA;
        "pkg-1.21-1.21.1-p-0.0.6-forge" = _JjESd6xc;
        "pkg-1.21.2-1.21.3-p-0.0.6-forge" = _Fz02Ua5w;
        "pkg-1.21.4-p-0.0.6-forge" = _WD3e72Ci;
        "pkg-1.21.5-0.0.6-fabric" = _UcxRRnAH;
        "pkg-1.21.5-0.0.6-forge" = _Tk6cWWDW;
        "pkg-1.21.5-0.0.6-neoforge" = _FKDhmXB7;
        "pkg-1.21.6-0.0.6-fabric" = _BpoRrU6M;
        "pkg-1.21.6-0.0.6-forge" = _ygHRJKJ0;
        "pkg-1.21.6-0.0.6-neoforge" = _m9UPBTwL;
        "pkg-1.21.7-0.0.6-fabric" = _3jQMMjhx;
        "pkg-1.21.7-0.0.6-forge" = _EkQ30GyI;
        "pkg-1.21.7-0.0.6-neoforge" = _zWBSNfND;
        "pkg-1.21.10-0.0.7-fabric" = _wRxhoGia;
        "pkg-1.21.10-0.0.7-forge" = _Y1HcY3vR;
        "pkg-1.21.10-0.0.7-neoforge" = _EGRnrr1S;
        "pkg-1.21.11-0.0.8-fabric" = _zgsaYcVL;
        "pkg-1.21.11-0.0.8-forge" = _Om5IvikM;
        "pkg-1.21.11-0.0.8-neoforge" = _1SEQtCzO;
        "pkg-26.1-0.0.9-fabric" = _szWtRpyh;
        "pkg-26.1-0.0.9-forge" = _EfeF7Gyy;
        "pkg-26.1-0.0.9-neoforge" = _HtB2OIOY;
