...
let
    ...
    in {
        ...
        "pkg-1.0.0.0-beta" = _IweZxVhj;
        "pkg-1.0.1.0-beta" = _E5VAMLOE;
        "pkg-1.0.2.0-beta" = _wFh0sUIp;
        "pkg-1.0.2.1-beta" = _3bgW2MNG;
        "pkg-1.0.2.2-beta" = _xKYbCay0;
        "pkg-1.0.2.3-beta" = _ZjwUEGcp;
        "pkg-1.1.0.0-beta" = _qo024bgB;
        "pkg-1.2.0.0-beta" = _xwm8yYtm;
        "pkg-1.0.2.4-beta" = _VOd6WoNj;
        "pkg-1.0.2.5-beta" = _yX1hxvVn;
        "pkg-1.1.0.1-beta" = _UE9kCXwh;
        "pkg-1.2.0.1-beta" = _9NyMImHf;
        "pkg-1.1.0.2-beta" = _sThyz7WH;
        "pkg-1.0.2.6-beta" = _FAPLBEtS;
        "pkg-1.3.0.0-beta" = _q1RfV9Ph;
        "pkg-1.0.3.0-beta" = _s4OwR9Ep;
        "pkg-1.1.1.0-beta" = _Znlwk7o0;
        "pkg-1.2.1.0-beta" = _5W715YzJ;
        "pkg-1.3.1.0-beta" = _jzYfPTo1;
        "pkg-1.0.3.1-beta" = _ou8zHe5S;
        "pkg-1.1.1.1-beta" = _Yof4vLSS;
        "pkg-1.2.1.1-beta" = _n8ERZjh7;
        "pkg-1.3.1.1-beta" = _V4hURVmP;
        "pkg-1.4.0.0-beta" = _LCmYAJFT;
        "pkg-1.3.1.2-beta" = _MrKVMYmL;
        "pkg-1.0.4.0-beta" = _OoDuRvIX;
        "pkg-1.1.2.0-beta" = _SF3SMoJ9;
        "pkg-1.2.2.0-beta" = _XK55gQzK;
        "pkg-1.4.1.0-beta" = _a9CRi3jV;
        "pkg-1.3.2.0-beta" = _B3SxaOUA;
        "pkg-20.6.0.0-beta" = _735McMGe;
        "pkg-20.4.0.0-beta" = _ykz7kfgH;
        "pkg-20.6.0.1-beta" = _68XPJ9iI;
        "pkg-20.1.0.0-beta" = _2tlnoPvP;
        "pkg-21.0.0.0-beta" = _fAUVHz3c;
        "pkg-21.0.0.1-beta" = _A8lG4a2W;
        "pkg-20.6.0.2-beta" = _PEbUhN0I;
        "pkg-20.4.0.1-beta" = _2gxqq92g;
        "pkg-20.1.0.1-beta" = _K8BWVGM4;
        "pkg-19.4.0.0-beta" = _PGzzqedA;
        "pkg-21.0.0.2-beta" = _7eMBdsol;
        "pkg-20.6.0.3-beta" = _W2xrXoqb;
        "pkg-20.4.0.2-beta" = _O1SeG2rJ;
        "pkg-20.1.0.2-beta" = _gYetzFfh;
        "pkg-19.4.0.1-beta" = _h8uFbLER;
        "pkg-21.0.0.3-beta+forge" = _SUomSrY0;
        "pkg-21.0.0.3-beta+neoforge" = _hbe7wUsM;
        "pkg-21.0.0.3-beta+fabric" = _cXKnFHrj;
        "pkg-21.1.0.0-beta+forge" = _7L3haqpI;
        "pkg-21.1.0.0-beta+neoforge" = _3bOQTNUB;
        "pkg-21.1.0.0-beta+fabric" = _E8CCBrEa;
        "pkg-19.4.0.3-beta+forge" = _eHRj3yAh;
        "pkg-19.4.0.3-beta+fabric" = _XyqBE3iG;
        "pkg-19.2.0.0-beta+forge" = _iiC4UZUa;
        "pkg-19.2.0.0-beta+fabric" = _Ljiml8FQ;
        "pkg-19.2.0.1-beta+forge" = _uOa6pn5S;
        "pkg-19.2.0.1-beta+fabric" = _aalsEkK7;
        "pkg-18.2.0.0-beta+forge" = _uj6hzNrz;
        "pkg-18.2.0.0-beta+fabric" = _A70wg0KP;
        "pkg-17.1.0.0-beta+forge" = _XLr0LWdW;
        "pkg-17.1.0.0-beta+fabric" = _q2Dl9kUG;
        "pkg-16.5.0.0-beta+forge" = _fWThjsFN;
        "pkg-20.1.0.3-beta+forge" = _Adi6VhbS;
        "pkg-20.1.0.3-beta+fabric" = _1rA9ITTx;
        "pkg-21.1.0.1-beta+forge" = _5gcqdwJS;
        "pkg-21.1.0.1-beta+neoforge" = _81FnumsI;
        "pkg-21.1.0.1-beta+fabric" = _N7fKGpsL;
        "pkg-21.0.0.4-beta+forge" = _1rpIDdXo;
        "pkg-21.0.0.4-beta+neoforge" = _5Tnbm24F;
        "pkg-21.0.0.4-beta+fabric" = _akr2wvHk;
        "pkg-20.6.0.4-beta+forge" = _bFVgmRWd;
        "pkg-20.6.0.4-beta+neoforge" = _TG8NR7ND;
        "pkg-20.6.0.4-beta+fabric" = _gpfTl7cC;
        "pkg-20.4.0.4-beta+forge" = _jnkYMTt7;
        "pkg-20.4.0.4-beta+neoforge" = _THQk8ItY;
        "pkg-20.4.0.4-beta+fabric" = _nLtleyFY;
        "pkg-20.1.0.4-beta+forge" = _Ur9rbaHC;
        "pkg-20.1.0.4-beta+fabric" = _quBuBiXB;
        "pkg-19.4.0.4-beta+forge" = _CYRtK7MS;
        "pkg-19.4.0.4-beta+fabric" = _7LBVBdPX;
        "pkg-19.2.0.2-beta+forge" = _VHQ74Hh2;
        "pkg-19.2.0.2-beta+fabric" = _rbVxnhZR;
        "pkg-18.2.0.1-beta+forge" = _XIGI5lGJ;
        "pkg-18.2.0.1-beta+fabric" = _NvVFNznf;
        "pkg-17.1.0.1-beta+forge" = _nw7rMs9y;
        "pkg-17.1.0.1-beta+fabric" = _a21AAtYD;
        "pkg-16.5.0.1-beta+forge" = _n8UPDPYS;
        "pkg-20.6.0.5-beta+forge" = _WXgbnC4g;
        "pkg-20.6.0.5-beta+neoforge" = _F3v4oaBA;
        "pkg-20.6.0.5-beta+fabric" = _8aBZNSwO;
        "pkg-20.4.0.5-beta+forge" = _rk2nKmeq;
        "pkg-20.4.0.5-beta+neoforge" = _H6yeMYy8;
        "pkg-20.4.0.5-beta+fabric" = _Om84Ox4n;
        "pkg-20.1.0.5-beta+forge" = _VdKLrk5e;
        "pkg-20.1.0.5-beta+fabric" = _YNyN1su2;
        "pkg-19.4.0.5-beta+forge" = _APJlgQWO;
        "pkg-19.4.0.5-beta+fabric" = _Oo1gOvgs;
        "pkg-19.2.0.3-beta+forge" = _mP5X5PQl;
        "pkg-19.2.0.3-beta+fabric" = _dEs7ucAV;
        "pkg-18.2.0.2-beta+forge" = _vyFD9Eiy;
        "pkg-18.2.0.2-beta+fabric" = _LMoXB0o8;
        "pkg-17.1.0.2-beta+forge" = _K10QyYpX;
        "pkg-17.1.0.2-beta+fabric" = _uXeTwhvk;
        "pkg-16.5.0.2-beta+forge" = _hCUSqzj4;
        "pkg-16.5.1.0+forge" = _nqdXeQNt;
        "pkg-17.1.1.0+forge" = _reTqbrzJ;
        "pkg-17.1.1.0+fabric" = _2j3uAbNj;
        "pkg-18.2.1.0+forge" = _AyzKuDwe;
        "pkg-18.2.1.0+fabric" = _rdyhmWft;
        "pkg-19.2.1.0+forge" = _JLJM24Nx;
        "pkg-19.2.1.0+fabric" = _EbSzZZNp;
        "pkg-19.4.1.0+forge" = _jBsPJFZ1;
        "pkg-19.4.1.0+fabric" = _g6tDDxd0;
        "pkg-20.1.1.0+forge" = _zLHa2hxa;
        "pkg-20.1.1.0+fabric" = _TmQDpGEq;
        "pkg-20.4.1.0+forge" = _PYJ8S9SD;
        "pkg-20.4.1.0+neoforge" = _3tL12det;
        "pkg-20.4.1.0+fabric" = _r3EQQiXW;
        "pkg-20.6.1.0+forge" = _iWvEhEwC;
        "pkg-20.6.1.0+neoforge" = _kly6sA9Y;
        "pkg-20.6.1.0+fabric" = _llhoxmKY;
        "pkg-21.0.1.0+forge" = _9uzQxgmB;
        "pkg-21.0.1.0+neoforge" = _V36VrVCy;
        "pkg-21.0.1.0+fabric" = _J028tHne;
        "pkg-21.1.1.0+forge" = _McGHLwgH;
        "pkg-21.1.1.0+neoforge" = _iG19OBsR;
        "pkg-21.1.1.0+fabric" = _NfZAee8O;
        "pkg-16.5.1.1+forge" = _UVWiSg7W;
        "pkg-17.1.1.1+forge" = _w5SV26nX;
        "pkg-17.1.1.1+fabric" = _LjkiKfla;
        "pkg-18.2.1.1+forge" = _LFK4hMR2;
        "pkg-18.2.1.1+fabric" = _KGvMS8tJ;
        "pkg-19.2.1.1+forge" = _ixklOiOw;
        "pkg-19.2.1.1+fabric" = _cPHp9RrM;
        "pkg-19.4.1.1+forge" = _Gpn2wmix;
        "pkg-19.4.1.1+fabric" = _zKySk8Nw;
        "pkg-20.1.1.1+forge" = _gJ9d0Uge;
        "pkg-20.1.1.1+fabric" = _wNI5PdOC;
        "pkg-20.4.1.1+forge" = _MRANrUOa;
        "pkg-20.4.1.1+neoforge" = _aqb32JBI;
        "pkg-20.4.1.1+fabric" = _zPDnxLNA;
        "pkg-20.6.1.1+forge" = _8lZyjQim;
        "pkg-20.6.1.1+neoforge" = _iPv1vs1x;
        "pkg-20.6.1.1+fabric" = _lZ7D4l3G;
        "pkg-21.0.1.1+forge" = _56K7t4jn;
        "pkg-21.0.1.1+neoforge" = _S4hvQnQT;
        "pkg-21.0.1.1+fabric" = _oFJ34dRO;
        "pkg-21.1.1.1+forge" = _d60rpd3r;
        "pkg-21.1.1.1+neoforge" = _rOEvddqb;
        "pkg-21.1.1.1+fabric" = _7i4DxOsD;
        "pkg-20.6.1.2+forge" = _qhfybuQR;
        "pkg-20.6.1.2+neoforge" = _AryaPIRg;
        "pkg-20.6.1.2+fabric" = _ZRVlKNoI;
        "pkg-21.0.1.2+forge" = _8EQGhZd6;
        "pkg-21.0.1.2+neoforge" = _uGQxuZ8u;
        "pkg-21.0.1.2+fabric" = _aDSYsAiL;
        "pkg-21.1.1.2+forge" = _lro87UrA;
        "pkg-21.1.1.2+neoforge" = _zZGOih8s;
        "pkg-21.1.1.2+fabric" = _4M6BDlMK;
        "pkg-21.3.0.0-beta+forge" = _gZpP7n0e;
        "pkg-21.3.0.0-beta+neoforge" = _8RsMhwk7;
        "pkg-21.3.0.0-beta+fabric" = _CqBXv1UC;
        "pkg-16.5.2.0+forge" = _NylqgMYk;
        "pkg-18.2.2.0+forge" = _eTdzogGz;
        "pkg-18.2.2.0+fabric" = _x9GGL4TC;
        "pkg-19.2.2.0+forge" = _ERQHyYH1;
        "pkg-19.2.2.0+fabric" = _a9Z9ji8w;
        "pkg-19.4.2.0+forge" = _On4HqQUZ;
        "pkg-19.4.2.0+fabric" = _CbTDimV5;
        "pkg-20.1.2.0+forge" = _wXA5mTyx;
        "pkg-20.1.2.0+fabric" = _RVohNLWd;
        "pkg-20.4.2.0+forge" = _lG4S0m4J;
        "pkg-20.4.2.0+neoforge" = _8kBe20Da;
        "pkg-20.4.2.0+fabric" = _zVpVacsp;
        "pkg-20.6.2.0+forge" = _GOXc8cwR;
        "pkg-20.6.2.0+neoforge" = _tP27xl70;
        "pkg-20.6.2.0+fabric" = _BFL3VT3w;
        "pkg-21.1.2.0+forge" = _IVpTGxsk;
        "pkg-21.1.2.0+neoforge" = _vOfDb2ma;
        "pkg-21.1.2.0+fabric" = _ui9olMGX;
        "pkg-21.3.1.0+forge" = _eaGytUlO;
        "pkg-21.3.1.0+neoforge" = _L4GNpsOy;
        "pkg-21.3.1.0+fabric" = _YxQy53pR;
        "pkg-21.4.0.0-beta+neoforge" = _n1L1lLXn;
        "pkg-21.4.0.0-beta+fabric" = _u6BIt8z7;
        "pkg-21.3.1.1+forge" = _A6vpaAWb;
        "pkg-21.3.1.1+neoforge" = _fKHSn5u0;
        "pkg-21.3.1.1+fabric" = _4yx3fesa;
        "pkg-21.1.2.1+forge" = _Vt4wQNKL;
        "pkg-21.1.2.1+neoforge" = _ygCIaRzN;
        "pkg-21.1.2.1+fabric" = _VXM54tuV;
        "pkg-20.1.3.0+forge" = _gZ9F7RN1;
        "pkg-20.1.3.0+fabric" = _EAn6aDJz;
        "pkg-20.4.3.0+forge" = _yHt4ZlSS;
        "pkg-20.4.3.0+neoforge" = _i70f5fYg;
        "pkg-20.4.3.0+fabric" = _l0rN8Uo2;
        "pkg-20.6.3.0+forge" = _l514JXRk;
        "pkg-20.6.3.0+neoforge" = _pPAlX6MN;
        "pkg-20.6.3.0+fabric" = _aArpsSD5;
        "pkg-21.1.3.0+neoforge" = _GMWCMSJI;
        "pkg-21.1.3.0+fabric" = _M9xEA0nk;
        "pkg-21.4.1.0+neoforge" = _FdiVqpJz;
        "pkg-21.4.1.0+fabric" = _Mldy3IzN;
        "pkg-20.1.4.0+forge" = _tT446SwZ;
        "pkg-20.1.4.0+fabric" = _GWASPxFC;
        "pkg-20.4.4.0+forge" = _X82fK13F;
        "pkg-20.4.4.0+neoforge" = _TZKrekiN;
        "pkg-20.4.4.0+fabric" = _DbolwhNN;
        "pkg-20.6.4.0+forge" = _InTnQACI;
        "pkg-20.6.4.0+neoforge" = _FcN2WOPA;
        "pkg-20.6.4.0+fabric" = _D9CD4P6o;
        "pkg-21.1.4.0+neoforge" = _Sgc1Yuie;
        "pkg-21.1.4.0+fabric" = _30zUUzVc;
        "pkg-21.4.2.0+neoforge" = _LwxPEwMh;
        "pkg-21.4.2.0+fabric" = _YfwiYVuV;
        "pkg-20.1.4.1+forge" = _ppBBI6Ob;
        "pkg-20.1.4.1+fabric" = _yXEUWV4m;
        "pkg-20.4.4.1+forge" = _aAGRYZ7k;
        "pkg-20.4.4.1+neoforge" = _mRsjuecq;
        "pkg-20.4.4.1+fabric" = _9oEdDqL0;
        "pkg-20.6.4.1+forge" = _86eSzBof;
        "pkg-20.6.4.1+neoforge" = _eDfVGNHt;
        "pkg-20.6.4.1+fabric" = _1dpmBZfb;
        "pkg-21.1.4.1+neoforge" = _81elYvlu;
        "pkg-21.1.4.1+fabric" = _5y6GroZw;
        "pkg-21.4.2.1+neoforge" = _YwqbqbND;
        "pkg-21.4.2.1+fabric" = _38leKJQy;
        "pkg-21.5.0.0-beta+neoforge" = _wSDwWIoh;
        "pkg-21.5.0.0-beta+fabric" = _nzMiYWfX;
        "pkg-21.5.0.1+neoforge" = _Mq5MoglU;
        "pkg-21.5.0.1+fabric" = _dn6Pyflv;
        "pkg-21.4.3.0+neoforge" = _ooSj4f8J;
        "pkg-21.4.3.0+fabric" = _OzqeBrGj;
        "pkg-20.1.5.0+forge" = _3lh3pw5l;
        "pkg-20.1.5.0+fabric" = _HN9CJ5Od;
        "pkg-20.1.5.1+forge" = _MXPADfd6;
        "pkg-20.1.5.1+fabric" = _NhnikdFB;
        "pkg-20.4.5.0+forge" = _xBio6aoO;
        "pkg-20.4.5.0+neoforge" = _cQwPX30w;
        "pkg-20.4.5.0+fabric" = _X9Pt9N7U;
        "pkg-20.6.5.0+forge" = _263hoEx0;
        "pkg-20.6.5.0+neoforge" = _znLttPfd;
        "pkg-20.6.5.0+fabric" = _GQ0YIoVM;
        "pkg-21.1.5.0+neoforge" = _TUJtYLLn;
        "pkg-21.1.5.0+fabric" = _ORbWNcBU;
        "pkg-21.4.3.1+neoforge" = _JjgNWRh2;
        "pkg-21.4.3.1+fabric" = _hpDsGzyL;
        "pkg-21.5.1.0+neoforge" = _5Ynyx1Kr;
        "pkg-21.5.1.0+fabric" = _qyAycUhH;
        "pkg-21.8.0.0-beta+neoforge" = _Ygtg92JG;
        "pkg-21.8.0.0-beta+fabric" = _rKAz5A31;
        "pkg-21.10.0.0-beta+neoforge" = _ZkcVMl1L;
        "pkg-21.10.0.0-beta+fabric" = _NUHZVwg1;
        "pkg-21.8.1.0-beta+neoforge" = _TBTMU7PA;
        "pkg-21.8.1.0-beta+fabric" = _1pNlWbBk;
        "pkg-21.10.1.0-beta+neoforge" = _CyCqtBnY;
        "pkg-21.10.1.0-beta+fabric" = _TvqowxCu;
        "pkg-20.1.6.0+forge" = _FEhXzzPR;
        "pkg-20.1.6.0+fabric" = _Xv0q60Qk;
        "pkg-20.4.6.0+forge" = _gpsdvy8g;
        "pkg-20.4.6.0+neoforge" = _64xmU8IY;
        "pkg-20.4.6.0+fabric" = _cfoe8EWf;
        "pkg-20.6.6.0+forge" = _vJsplCUS;
        "pkg-20.6.6.0+neoforge" = _83UlgcLL;
        "pkg-20.6.6.0+fabric" = _AhVcAPc5;
        "pkg-21.1.6.0+neoforge" = _iHU2F7zM;
        "pkg-21.1.6.0+fabric" = _di5m2wxL;
        "pkg-21.4.4.0+neoforge" = _aiAjuOXZ;
        "pkg-21.4.4.0+fabric" = _tn6SK9Ud;
        "pkg-21.5.2.0+neoforge" = _EgaiDkMZ;
        "pkg-21.5.2.0+fabric" = _E9DN3Iux;
        "pkg-21.8.2.0+neoforge" = _67eDR57t;
        "pkg-21.8.2.0+fabric" = _G829HjGX;
        "pkg-21.10.2.0+neoforge" = _SGKzrEnZ;
        "pkg-21.10.2.0+fabric" = _WcqDYvF8;
        "pkg-21.11.0.0-alpha+neoforge" = _ka3eLv6a;
        "pkg-21.11.0.0-alpha+fabric" = _TpP6ldW7;
        "pkg-26.1.2.0.0-beta+neoforge" = _Z1dKu8ha;
        "pkg-26.1.2.0.0-beta+fabric" = _B6Jg1Gp6;
        "default" = _B6Jg1Gp6;
    });
