...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.20.1-47.4.10" = _m17zCUXL;
        "pkg-1.0.0-forge-1.20.4-49.2.4" = _Y2Wl8LJC;
        "pkg-1.0.0-forge-1.20.6-50.2.4" = _SE8z0Sqa;
        "pkg-1.0.0-forge-1.21.1-52.1.8" = _szaZCAcB;
        "pkg-1.0.0-forge-1.21.3-53.1.6" = _25LkMIS5;
        "pkg-1.0.0-forge-1.21.4-54.1.11" = _4mDWai9a;
        "pkg-1.0.0-forge-1.21.5-55.1.4" = _npG71jBV;
        "pkg-1.0.0-forge-1.21.8-58.1.11" = _3hFEsNFc;
        "pkg-1.0.0-forge-1.21.10-60.1.0" = _Q4fBaaAf;
        "pkg-1.0.0-forge-1.21.11-61.0.2" = _ZE8MQYRt;
        "pkg-1.0.0-neoforge-1.20.4-20.4.251" = _IJ50mOpo;
        "pkg-1.0.0-neoforge-1.20.6-20.6.139" = _eia6Z73x;
        "pkg-1.0.0-neoforge-1.21.1-21.1.217" = _qbWl0D9T;
        "pkg-1.0.0-neoforge-1.21.3-21.3.95" = _SDt1HfNp;
        "pkg-1.0.0-neoforge-1.21.4-21.4.156" = _juyVw0H6;
        "pkg-1.0.0-neoforge-1.21.5-21.5.96" = _FiuQYEx5;
        "pkg-1.0.0-neoforge-1.21.8-21.8.52" = _sV7Awojg;
        "pkg-1.0.0-neoforge-1.21.10-21.10.64" = _J3Sw8Usq;
        "pkg-1.0.0-neoforge-1.21.11-21.11.17b" = _gVCnOpP7;
        "pkg-1.0.0-fabric-1.19.4-0.87.2" = _RaUKgfYI;
        "pkg-1.0.0-fabric-1.20.1-0.92.6" = _uAeZaUII;
        "pkg-1.0.0-fabric-1.20.4-0.97.3" = _sKMfHADT;
        "pkg-1.0.0-fabric-1.20.6-0.100.8" = _qGIp1Euq;
        "pkg-1.0.0-fabric-1.21.1-0.116.7" = _8YwPXHDH;
        "pkg-1.0.0-fabric-1.21.3-0.114.1" = _7aFKKfcY;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _d4HOduib;
        "pkg-1.0.0-fabric-1.21.5-0.128.2" = _rt4xHuxM;
        "pkg-1.0.0-fabric-1.21.8-0.136.1" = _1TkIbshw;
        "pkg-1.0.0-fabric-1.21.10-0.138.4" = _GtWaB5Mj;
        "pkg-1.0.0-fabric-1.21.11-0.140.2" = _sPPceDZH;
        "pkg-1.0.0-forge-1.20.1-47.2.30" = _oY4Cybcw;
        "pkg-1.0.1-forge-1.20.1-47.4.10" = _pF0sOAoZ;
        "pkg-1.0.1-forge-1.20.4-49.2.4" = _TwFPW6XE;
        "pkg-1.0.1-forge-1.20.6-50.2.4" = _v9sISAEy;
        "pkg-1.0.1-forge-1.21.1-52.1.8" = _jX4Ck2gp;
        "pkg-1.0.1-forge-1.21.3-53.1.6" = _Cpd1Zli9;
        "pkg-1.0.1-forge-1.21.4-54.1.11" = _d0na39X3;
        "pkg-1.0.1-forge-1.21.5-55.1.4" = _cQFN7xgN;
        "pkg-1.0.1-forge-1.21.8-58.1.11" = _hU05PKu1;
        "pkg-1.0.1-forge-1.21.10-60.1.0" = _Sv0ztb8S;
        "pkg-1.0.1-forge-1.21.11-61.0.2" = _lbRSPX8c;
        "pkg-1.0.1-fabric-1.20.1-0.92.6" = _sIwWyr7Z;
        "pkg-1.0.1-fabric-1.20.4-0.97.3" = _2NOWNPpU;
        "pkg-1.0.1-fabric-1.20.6-0.100.8" = _LPxB2oSg;
        "pkg-1.0.1-fabric-1.21.1-0.116.7" = _DXkF6OUR;
        "pkg-1.0.1-fabric-1.21.3-0.114.1" = _AZVITr7l;
        "pkg-1.0.1-fabric-1.21.4-0.119.4" = _9yb6N1J9;
        "pkg-1.0.1-fabric-1.21.5-0.128.2" = _m27RhWb5;
        "pkg-1.0.1-fabric-1.21.8-0.136.1" = _OvA967oX;
        "pkg-1.0.1-fabric-1.21.10-0.138.4" = _fJMQmJqn;
        "pkg-1.0.1-fabric-1.21.11-0.140.2" = _OMgGWDxj;
        "pkg-1.0.1-neoforge-1.21.1-21.1.217" = _av4UoeaO;
        "pkg-1.0.1-neoforge-1.21.3-21.3.95" = _E3nFyGfT;
        "pkg-1.0.1-neoforge-1.21.4-21.4.156" = _goXJ0m5k;
        "pkg-1.0.1-neoforge-1.21.5-21.5.96" = _ywtgjFuM;
        "pkg-1.0.1-neoforge-1.21.8-21.8.52" = _icIGqORx;
        "pkg-1.0.1-neoforge-1.21.10-21.10.64" = _oEXacOyO;
        "pkg-1.0.1-neoforge-1.21.11-21.11.17b" = _uAbYuKfz;
        "pkg-1.0.2-fabric-26.1-0.142.2" = _eGJnz4NX;
        "pkg-1.0.3-fabric-26.1-0.142.2" = _YbpCuCZ1;
        "pkg-1.0.1b-fabric-1.20.1-0.92.6" = _hREYQTYE;
        "pkg-1.0.1b-fabric-1.21.1-0.116.7" = _MEj81B0S;
        "pkg-1.0.3-fabric-26.1.6-0.143.2" = _yjlW813D;
        "pkg-1.0.1-forge-1.18.2-40.3.12" = _JHRsHFJz;
        "pkg-1.2.0-fabric-26.1.1-0.145.2" = _sbCK4tFT;
        "pkg-1.2.0-neoforge-26.1.1.1" = _zTNzYMsS;
        "pkg-1.2.0-forge-26.1.1-63.0.0" = _t4kXLAbW;
        "pkg-1.2.0-forge-26.2-65.0.0" = _JDml8MSx;
        "pkg-1.2.0-neoforge-26.2.0.2" = _Gi2usHZL;
        "pkg-1.2.0-fabric-26.2-0.152.1" = _mt64HJue;
        "pkg-1.2.0-fabric-1.21.11-0.140.2" = _wDOSJImr;
        "pkg-1.2.0-fabric-1.21.10-0.138.4" = _z6mP5BlI;
        "pkg-1.2.0-fabric-1.21.8-0.136.1" = _c5C4x5OY;
        "pkg-1.2.0-fabric-1.21.5-0.128.2" = _MkJDegri;
        "pkg-1.2.0-fabric-1.21.4-0.119.4" = _97tYzWXp;
        "pkg-1.2.0-fabric-1.21.1-0.116.7" = _vCDUazpO;
        "pkg-1.2.0-fabric-1.20.1-0.92.6" = _lew8gxA6;
        "pkg-1.2.0-neoforge-1.21.11-21.11.17" = _IRESzOu6;
        "pkg-1.2.0-neoforge-1.21.10-21.10.64" = _YH9YDNfZ;
        "pkg-1.2.0-neoforge-1.21.8-21.8.52" = _r5LWAoeq;
        "pkg-1.2.0-neoforge-1.21.5-21.5.96" = _OcvsriiZ;
        "pkg-1.2.0-neoforge-1.21.4-21.4.156" = _ry3yeWUH;
        "pkg-1.2.0-neoforge-1.21.1-21.1.217" = _sPrpmle3;
        "pkg-1.2.0-forge-1.21.11-61.0.2" = _TEbeqX9V;
        "pkg-1.2.0-forge-1.21.10-60.1.0" = _6naBFV1C;
        "pkg-1.2.0-forge-1.21.8-58.1.11" = _5zcjoY0b;
        "pkg-1.2.0-forge-1.21.5-55.1.4" = _jdOtZ3tP;
