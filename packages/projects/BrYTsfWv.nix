...
let
    ...
    in {
        ...
        "pkg-1.1.4" = _qfz0OY4k;
        "pkg-1.21-1.1.5" = _BQmt2SsT;
        "pkg-1.21-1.1.6" = _coEalkKS;
        "pkg-1.21-1.1.7" = _rfKLpQvL;
        "pkg-1.21-1.1.8" = _RB0qh2m1;
        "pkg-1.21-1.1.9" = _pwMFhtUC;
        "pkg-1.20-1.1.0" = _VUkkqTo5;
        "pkg-1.20-1.1.1" = _FK3oN7j1;
        "pkg-1.21-1.1.10" = _3gFBmiT0;
        "pkg-1.21-1.1.11" = _7ToddQRm;
        "pkg-1.21-1.1.12" = _9qnvlaZ2;
        "pkg-1.20-1.1.2" = _tKx7NMaG;
        "pkg-1.21-1.1.13" = _yWPyMu0Z;
        "pkg-1.20-1.1.3" = _sNRMTRgs;
        "pkg-1.21-1.1.14" = _IHCuejB6;
        "pkg-1.21-1.1.15" = _r7xt0JgL;
        "pkg-1.21-1.1.16" = _YTKZxfT6;
        "pkg-1.21-1.1.17" = _Crg1pHdM;
        "pkg-1.21-1.1.18" = _gCbGYvAd;
        "pkg-1.21-1.1.19a" = _2ayyT6t3;
        "pkg-1.21-1.1.20" = _EiNN32Hg;
        "pkg-1.21-1.1.21" = _mV3au6jM;
        "pkg-1.21-1.1.22" = _hXvMuuy6;
        "pkg-1.21-1.1.23" = _ru3o08ZE;
        "pkg-1.21-1.1.24" = _qaEWtiRT;
        "pkg-1.21-1.1.25" = _SCZNzbPM;
        "pkg-1.21-1.1.26" = _f2FaJYJa;
        "pkg-1.21-1.1.27" = _GWYB6Rpo;
        "pkg-1.21-1.2.0" = _xEn4Wy1H;
        "pkg-1.21-1.2.1" = _uqdzoorz;
        "pkg-1.21-1.2.2" = _oi9YOOGy;
        "pkg-1.21-1.2.3" = _iP98P8tv;
        "pkg-1.21-1.2.4" = _cM0hdFGT;
        "pkg-1.21-1.2.5" = _PaG9pNFF;
        "pkg-1.21-1.2.6" = _nJoV0IQP;
        "pkg-1.21-1.2.7" = _XfQXDcjc;
        "default" = _XfQXDcjc;
    });
