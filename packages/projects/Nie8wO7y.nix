...
let
    ...
    in {
        ...
        "pkg-1.0.11" = _yZYfF01K;
        "pkg-1.1.0-SNAPSHOT" = _BkpL3gQR;
        "pkg-1.1.0-SNAPSHOT-2" = _NBo0EoyD;
        "pkg-1.1.0-Pre1" = _K45kXGQK;
        "pkg-fabric-1.20.1-1.1.0-Pre2" = _tIzwbH72;
        "pkg-1.1.0-Pre3" = _89nZkFHo;
        "pkg-fabric-1.20.1-1.1.0-Pre3" = _BYOWHLKd;
        "pkg-fabric-1.20.1-1.1.0" = _s71ZOFlu;
        "pkg-1.1.0" = _N6JQETzz;
        "pkg-1.1.0.1" = _wjHOTora;
        "pkg-1.1.0.2" = _1wuiRqdw;
        "pkg-1.1.0.3" = _Jvr5qU36;
        ...
        "pkg-1.1.3" = _GF749JUG;
        "pkg-1.21.8-1.1.3" = _aD2hUV0a;
        "pkg-1.1.3.1" = _c6f8LbQn;
        "pkg-1.1.3.2" = _ROVuhGGB;
