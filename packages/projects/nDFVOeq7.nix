...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.0.0" = _xRr0GWNu;
        "pkg-1.19-1.0.1" = _28rciLgi;
        "pkg-1.18-1.0.1" = _C0COGbMW;
        "pkg-1.19.3-1.0.1" = _4Hd8v3AZ;
        "pkg-1.19-1.0.2" = _Htt42Nxr;
        "pkg-1.18.2-1.0.2" = _XoAwniMn;
        "pkg-1.19.3-1.0.2" = _FFW8HDr6;
        "pkg-1.19.4-1.0.2" = _etkAVZp5;
        "pkg-1.19-1.0.3" = _lUyhgXiE;
        "pkg-1.18.2-1.0.3" = _5ODARsJE;
        "pkg-1.19.3-1.0.3" = _831Gb82p;
        "pkg-1.19.4-1.0.3" = _H1UI5vdm;
        "pkg-1.16-1.0.3" = _NR2DLCOq;
        "pkg-1.20.1-1.0.3" = _AokKDxj8;
        "pkg-1.16-1.0.4" = _2BfQ8TUi;
        "pkg-1.18.2-1.0.4" = _pEBhE1OQ;
        "pkg-1.19-1.0.4" = _EWW1OsYx;
        "pkg-1.19.3-1.0.4" = _rzkvcFQS;
        "pkg-1.19.4-1.0.4" = _tQXTlOco;
        "pkg-1.20.1-1.0.4" = _qSOlJNb1;
        "pkg-1.18.2+-1.0.4" = _2rHyvUmz;
        "pkg-1.20.4-1.0.4" = _gdComEwQ;
        "pkg-1.20.5+-beta-1.0.5" = _L1sHi4JW;
        "pkg-1.20.5+-beta-1.0.5a" = _2PF7zsEq;
        "pkg-1.20.6-1.0.4a" = _cXHCd0tL;
        "pkg-1.21-1.0.4a" = _Nc5UMyt5;
        "pkg-1.21-1.0.5a" = _OSDtHgYX;
        "pkg-1.20.1-2.0" = _2w99fAyt;
        "pkg-1.21.1-2.0" = _4UpuXf2j;
        "pkg-1.20.1-2.0a" = _bwUZJI0D;
        "pkg-1.21.1-2.0a" = _Plzmoecj;
        "pkg-1.20.1-2.0b" = _wgG9i9J4;
        "default" = _wgG9i9J4;
    });
