...
let
    ...
    in {
        ...
        "pkg-1.1.0+mc1.21.4" = _a2ZBcDt9;
        "pkg-1.1.0+mc1.21.5" = _acjDkB3L;
        "pkg-1.1.0+mc1.21.6" = _25Cmm22P;
        "pkg-1.1.0+mc1.21.7" = _uvBsJdIz;
        "pkg-1.1.0+mc1.21.8" = _NiNeJkLN;
        "pkg-1.1.0+mc1.21.9" = _IKFtYN7O;
        "pkg-1.1.0+mc1.21" = _naZtK1bX;
        "pkg-1.1.0+mc26.1" = _VyYdvNC7;
        "pkg-1.1.0+mc26.1.2" = _44prE4DY;
        "pkg-1.2.0+mc1.21.1" = _i3a5HJL5;
        "pkg-1.2.0+mc1.21.10" = _dEkiyUpX;
        "pkg-1.2.0+mc1.21.11" = _mpVVvN7u;
        "pkg-1.2.0+mc1.21.4" = _Prycym5n;
        "pkg-1.2.0+mc1.21.5" = _PVsgOtDY;
        "pkg-1.2.0+mc1.21.6" = _9tNQfH3Q;
        "pkg-1.2.0+mc1.21.7" = _AriNWJ1J;
        "pkg-1.2.0+mc1.21.8" = _kV0mrGT5;
        "pkg-1.2.0+mc1.21.9" = _Gt2dQshk;
        "pkg-1.2.0+mc1.21" = _3zt4HtUm;
