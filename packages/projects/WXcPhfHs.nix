...
let
    ...
    in {
        ...
        "pkg-1.4.1+mc1.21" = _aEXPHNBR;
        "pkg-1.4.1+mc1.21.1" = _wMqRRBoD;
        "pkg-1.4.1+mc1.21.2" = _4WTFiYpJ;
        "pkg-1.4.1+mc1.21.3" = _TO5lWWd1;
        "pkg-1.4.1+mc1.21.4" = _YR3GD8AU;
        "pkg-1.4.1+mc1.21.5" = _fzAowvP3;
        "pkg-1.4.1+mc1.21.6" = _NJn53Rw9;
        "pkg-1.4.1+mc1.21.7" = _yUaHVfNS;
        "pkg-1.4.1+mc1.21.8" = _8z9Z7rvN;
        "pkg-1.4.1+mc1.21.9" = _nuyTeDLH;
        "pkg-1.4.1+mc1.21.10" = _mq6ljWCt;
        "pkg-1.4.1+mc1.21.11" = _mde4G6HJ;
        "pkg-1.4.4+mc1.21" = _nvyZufDK;
        "pkg-1.4.4+mc1.21.1" = _XBOOtweT;
        "pkg-1.4.4+mc1.21.2" = _1pZo8ozL;
        "pkg-1.4.4+mc1.21.3" = _yvYCY0HE;
        "pkg-1.4.4+mc1.21.4" = _TUbb62XP;
        "pkg-1.4.4+mc1.21.5" = _BauRwrP0;
        "pkg-1.4.4+mc1.21.6" = _Jq3OMV8o;
        "pkg-1.4.4+mc1.21.7" = _ganWtFwb;
        "pkg-1.4.4+mc1.21.8" = _m2hoH7H6;
        "pkg-1.4.4+mc1.21.9" = _H5Sd9YCn;
        "pkg-1.4.4+mc1.21.10" = _9g2nbe9Y;
        "pkg-1.4.4+mc1.21.11" = _UEfQzf3r;
        "pkg-1.4.6+mc1.21" = _L7r4UAwL;
        "pkg-1.4.6+mc1.21.1" = _A2GeqBjV;
        "pkg-1.4.6+mc1.21.2" = _TktOioK6;
        "pkg-1.4.6+mc1.21.3" = _QJdw8pyz;
        "pkg-1.4.6+mc1.21.4" = _Df8HC9OY;
        "pkg-1.4.6+mc1.21.5" = _WnuHeoO0;
        "pkg-1.4.6+mc1.21.6" = _uB8ytzZJ;
        "pkg-1.4.6+mc1.21.7" = _1OPjjMe9;
        "pkg-1.4.6+mc1.21.8" = _XhpyJxgG;
        "pkg-1.4.6+mc1.21.9" = _t5x5WJiN;
        "pkg-1.4.6+mc1.21.10" = _yIE2eap0;
        "pkg-1.4.6+mc1.21.11" = _23HIG1Li;
        "pkg-1.6+mc1.21" = _wgwOMslf;
        "pkg-1.6+mc1.21.1" = _OfLDSJEo;
        "pkg-1.6+mc1.21.2" = _OJ7p4wzW;
        "pkg-1.6+mc1.21.3" = _fbdfWcrE;
        "pkg-1.6+mc1.21.4" = _BISjgqB8;
        "pkg-1.6+mc1.21.5" = _ePLPdnmj;
        "pkg-1.6+mc1.21.6" = _RRaKKRmK;
        "pkg-1.6+mc1.21.7" = _7y9MLgcl;
        "pkg-1.6+mc1.21.8" = _e6PH8QJH;
        "pkg-1.6+mc1.21.9" = _ZF7w7MCV;
        "pkg-1.6+mc1.21.10" = _iPcV3Pqa;
        "pkg-1.6+mc1.21.11" = _LClGQ6Jk;
        "pkg-1.6+mc26.1" = _PfBOw9Xs;
        "pkg-1.6+mc26.1.1" = _wnzbgZa8;
        "pkg-1.6+mc26.1.2" = _Ej8Hgo3j;
        "pkg-1.7+mc1.21" = _PrcMT89L;
        "pkg-1.7+mc1.21.1" = _p1bArF4t;
        "pkg-1.7+mc1.21.2" = _WgBa62PZ;
        "pkg-1.7+mc1.21.3" = _N6EDkk0G;
        "pkg-1.7+mc1.21.4" = _eo4ng8qf;
        "pkg-1.7+mc1.21.5" = _XYbgfkPN;
        "pkg-1.7+mc1.21.6" = _F1i6pVxo;
        "pkg-1.7+mc1.21.7" = _3glHu6RL;
        "pkg-1.7+mc1.21.8" = _GidpudBs;
        "pkg-1.7+mc1.21.9" = _XUBdHK1K;
        "pkg-1.7+mc1.21.10" = _dPHmNcgQ;
        "pkg-1.7+mc1.21.11" = _VQbfPSSI;
        "pkg-1.7+mc26.1" = _Y3ZAKnqI;
        "pkg-1.7+mc26.1.1" = _iraOHf8N;
        "pkg-1.7+mc26.1.2" = _m6dHVHyx;
        "pkg-1.8+mc1.21" = _CLPEr2xU;
        "pkg-1.8+mc1.21.1" = _6KOfQhpl;
        "pkg-1.8+mc1.21.2" = _1wyH6TUD;
        "pkg-1.8+mc1.21.3" = _8DYVfudV;
        "pkg-1.8+mc1.21.4" = _DCQ2wsZr;
        "pkg-1.8+mc1.21.5" = _N9BX583I;
        "pkg-1.8+mc1.21.6" = _6X9164lw;
        "pkg-1.8+mc1.21.7" = _86jgG6C2;
        "pkg-1.8+mc1.21.8" = _o0TXUXdI;
        "pkg-1.8+mc1.21.9" = _eMwP9iu5;
        "pkg-1.8+mc1.21.10" = _1DUx2wgR;
        "pkg-1.8+mc1.21.11" = _Ua3yBHIx;
        "pkg-1.8+mc26.1" = _lGmp9q7w;
        "pkg-1.8+mc26.1.1" = _nBwD03Fl;
        "pkg-1.8+mc26.1.2" = _vadkZZkx;
        "pkg-1.8.5+mc1.21" = _OLbhcQ1H;
        "pkg-1.8.5+mc1.21.1" = _CmOlEwx8;
        "pkg-1.8.5+mc1.21.2" = _wrnAOG0q;
        "pkg-1.8.5+mc1.21.3" = _fMI6tsHW;
        "pkg-1.8.5+mc1.21.4" = _4gca2Xfq;
        "pkg-1.8.5+mc1.21.5" = _5hNzPToA;
        "pkg-1.8.5+mc1.21.6" = _hOylx5Ml;
        "pkg-1.8.5+mc1.21.7" = _3lTwcXzv;
        "pkg-1.8.5+mc1.21.8" = _JveZpr5h;
        "pkg-1.8.5+mc1.21.9" = _yDDqpeWk;
        "pkg-1.8.5+mc1.21.10" = _Csb6igsm;
        "pkg-1.8.5+mc1.21.11" = _I3VFpl2z;
        "pkg-1.8.5+mc26.1" = _1KzDZmtz;
        "pkg-1.8.5+mc26.1.1" = _EEPinlcP;
        "pkg-1.8.5+mc26.1.2" = _NHiOjbQW;
        "pkg-1.8.6+mc1.21" = _KKi3Mb4h;
        "pkg-1.8.6+mc1.21.1" = _X2Qbj2XX;
        "pkg-1.8.6+mc1.21.2" = _1LtUvy2L;
        "pkg-1.8.6+mc1.21.3" = _gQvs8MUU;
        "pkg-1.8.6+mc1.21.4" = _jKde7lly;
        "pkg-1.8.6+mc1.21.5" = _Ji131mci;
        "pkg-1.8.6+mc1.21.6" = _7GgzBEmS;
        "pkg-1.8.6+mc1.21.7" = _nQECxkwx;
        "pkg-1.8.6+mc1.21.8" = _2iRITg7k;
        "pkg-1.8.6+mc1.21.9" = _rR8P4Vpk;
        "pkg-1.8.6+mc1.21.10" = _gx7q0x7f;
        "pkg-1.8.6+mc1.21.11" = _VOzl6Egn;
        "pkg-1.8.6+mc26.1" = _8nZUb5hI;
        "pkg-1.8.6+mc26.1.1" = _FEVb7L1D;
        "pkg-1.8.6+mc26.1.2" = _SDQLr5a5;
        "pkg-1.8.6+mc1.21-neoforge" = _ulunihSy;
        "pkg-1.8.6+mc1.21.1-neoforge" = _K145P3nZ;
        "pkg-1.8.6+mc1.21.2-neoforge" = _N51YA3qT;
        "pkg-1.8.6+mc1.21.3-neoforge" = _pa6W0ybj;
        "pkg-1.8.6+mc1.21.4-neoforge" = _nq0RxnkQ;
        "pkg-1.8.6+mc1.21.5-neoforge" = _pv4n5X9l;
        "pkg-1.8.6+mc1.21.6-neoforge" = _XcE3iVNo;
        "pkg-1.8.6+mc1.21.7-neoforge" = _N5zeHlS6;
        "pkg-1.8.6+mc1.21.8-neoforge" = _c7mktEIe;
        "pkg-1.8.6+mc1.21.9-neoforge" = _bAsDyyGl;
        "pkg-1.8.6+mc1.21.10-neoforge" = _XPCKpmdO;
        "pkg-1.8.6+mc1.21.11-neoforge" = _gBVjWviz;
        "pkg-1.8.6+mc26.1-neoforge" = _xNiygQ8m;
        "pkg-1.8.6+mc26.1.1-neoforge" = _8wx2QNCQ;
        "pkg-1.8.6+mc26.1.2-neoforge" = _yJs94NIB;
        "pkg-1.10+mc1.21" = _PHOrBz7H;
        "pkg-1.10+mc1.21.1" = _Q6h6roCN;
        "pkg-1.10+mc1.21.2" = _WQr4sMlh;
        "pkg-1.10+mc1.21.3" = _tE7fmYNJ;
        "pkg-1.10+mc1.21.4" = _NKtfK5E4;
        "pkg-1.10+mc1.21.5" = _MSbr4aoK;
        "pkg-1.10+mc1.21.6" = _xPDYc8dF;
        "pkg-1.10+mc1.21.7" = _VEK6vVYl;
        "pkg-1.10+mc1.21.8" = _3Txfu7fa;
        "pkg-1.10+mc1.21.9" = _LCiIRkma;
        "pkg-1.10+mc1.21.10" = _mxSgLvpZ;
        "pkg-1.10+mc1.21.11" = _2k00egMN;
        "pkg-1.10+mc26.1" = _Saq0T00H;
        "pkg-1.10+mc26.1.1" = _5FD78o1U;
        "pkg-1.10+mc26.1.2" = _CKBucECQ;
        "pkg-1.11+mc1.21" = _fyt3F028;
        "pkg-1.11+mc1.21.1" = _HX5RTWzI;
        "pkg-1.11+mc1.21.2" = _ngWdsxu1;
        "pkg-1.11+mc1.21.3" = _tOD4W4Jp;
        "pkg-1.11+mc1.21.4" = _fUGaOgOk;
        "pkg-1.11+mc1.21.5" = _U3htlcHC;
        "pkg-1.11+mc1.21.6" = _PLSyt7gq;
        "pkg-1.11+mc1.21.7" = _iZtjTXSC;
        "pkg-1.11+mc1.21.8" = _cQv3Gt88;
        "pkg-1.11+mc1.21.9" = _DeqewIXH;
        "pkg-1.11+mc1.21.10" = _gYp6Ik2v;
        "pkg-1.11+mc1.21.11" = _EOjWlVil;
        "pkg-1.11+mc26.1" = _lIKSCeDY;
        "pkg-1.11+mc26.1.1" = _ftdXVMgY;
        "pkg-1.11+mc26.1.2" = _XIPwQnhY;
        "pkg-1.12+mc1.21" = _TPHdzz0h;
        "pkg-1.12+mc1.21.1" = _Q1z2Ozjr;
        "pkg-1.12+mc1.21.2" = _IMIcfheb;
        "pkg-1.12+mc1.21.3" = _J79ttksA;
        "pkg-1.12+mc1.21.4" = _H4vKdmAW;
        "pkg-1.12+mc1.21.5" = _auVRzice;
        "pkg-1.12+mc1.21.6" = _1MERFcBI;
        "pkg-1.12+mc1.21.7" = _REtElgcK;
        "pkg-1.12+mc1.21.8" = _qZRAhSXx;
        "pkg-1.12+mc1.21.9" = _GKIwjaUM;
        "pkg-1.12+mc1.21.10" = _PtOPujJy;
        "pkg-1.12+mc1.21.11" = _GlnV5xYI;
        "pkg-1.12+mc26.1" = _vJVoxCEx;
        "pkg-1.12+mc26.1.1" = _ZFMJ4MOX;
        "pkg-1.12+mc26.1.2" = _KC2jbMAM;
        "pkg-1.13+mc1.21" = _QADWYz7Q;
        "pkg-1.13+mc1.21.1" = _HlXOfph6;
        "pkg-1.13+mc1.21.2" = _G1wrPQWc;
        "pkg-1.13+mc1.21.3" = _jEQEcdDT;
        "pkg-1.13+mc1.21.4" = _GSTPlgnh;
        "pkg-1.13+mc1.21.5" = _MrlfG9kD;
        "pkg-1.13+mc1.21.6" = _tV7wN9ig;
        "pkg-1.13+mc1.21.7" = _e2f9PcVh;
        "pkg-1.13+mc1.21.8" = _npH90MgI;
        "pkg-1.13+mc1.21.9" = _2kDvQRRs;
        "pkg-1.13+mc1.21.10" = _TBCJMWKZ;
        "pkg-1.13+mc1.21.11" = _U35z4AOO;
        "pkg-1.13+mc26.1" = _ZGWKA6F5;
        "pkg-1.13+mc26.1.1" = _Lwz26jRy;
        "pkg-1.13+mc26.1.2" = _f3CkKvO1;
        "pkg-1.14+mc1.21" = _owmrWV0v;
        "pkg-1.14+mc1.21.1" = _SYDZaWkx;
        "pkg-1.14+mc1.21.2" = _qVViXT1p;
        "pkg-1.14+mc1.21.3" = _nZfVd3Uo;
        "pkg-1.14+mc1.21.4" = _TL6dEWNW;
        "pkg-1.14+mc1.21.5" = _XhJibSc3;
        "pkg-1.14+mc1.21.6" = _xyrQ0Vwp;
        "pkg-1.14+mc1.21.7" = _Ok3PX1BI;
        "pkg-1.14+mc1.21.8" = _WDNPy913;
        "pkg-1.14+mc1.21.9" = _qUSslD33;
        "pkg-1.14+mc1.21.10" = _cjf7VDld;
        "pkg-1.14+mc1.21.11" = _FhxAyMVE;
        "pkg-1.14+mc26.1" = _xqjIxIE2;
        "pkg-1.14+mc26.1.1" = _NgllOzOT;
        "pkg-1.14+mc26.1.2" = _17pDdGpZ;
        "pkg-1.14+mc1.21-neoforge" = _MfVOJkHk;
        "pkg-1.14+mc1.21.1-neoforge" = _z46ALF5u;
        "pkg-1.14+mc1.21.2-neoforge" = _GxiiwJMG;
        "pkg-1.14+mc1.21.3-neoforge" = _JGsfwKSb;
        "pkg-1.14+mc1.21.4-neoforge" = _PrLE5Ahm;
        "pkg-1.14+mc1.21.5-neoforge" = _F5M5Q146;
        "pkg-1.14+mc1.21.6-neoforge" = _BmKDLCTm;
        "pkg-1.14+mc1.21.7-neoforge" = _U9wCHIyg;
        "pkg-1.14+mc1.21.8-neoforge" = _BJMk8EUS;
        "pkg-1.14+mc1.21.9-neoforge" = _h8LKWWSN;
        "pkg-1.14+mc1.21.10-neoforge" = _ftWNWAA5;
        "pkg-1.14+mc1.21.11-neoforge" = _t3DPSkmA;
        "pkg-1.15+mc1.21" = _Cgicjx4B;
        "pkg-1.15+mc1.21.1" = _F3GW6wPF;
        "pkg-1.15+mc1.21.2" = _VRjUZMpu;
        "pkg-1.15+mc1.21.3" = _RwWCX2sF;
        "pkg-1.15+mc1.21.4" = _KoItH5ca;
        "pkg-1.15+mc1.21.5" = _AMFgiTX8;
        "pkg-1.15+mc1.21.6" = _ah3KbjYn;
        "pkg-1.15+mc1.21.7" = _c4eYqoiz;
        "pkg-1.15+mc1.21.8" = _wmQkJB0A;
        "pkg-1.15+mc1.21.9" = _KZ8EN6SG;
        "pkg-1.15+mc1.21.10" = _30MNubO1;
        "pkg-1.15+mc1.21.11" = _3ID2valQ;
        "pkg-1.15+mc26.1" = _nzNZladY;
        "pkg-1.15+mc26.1.1" = _fo03BkYe;
        "pkg-1.15+mc26.1.2" = _Dfhjsf9v;
        "default" = _Dfhjsf9v;
    });
