...
let
    ...
    in {
        ...
        "pkg-1.21.2-b1.1.0" = _uRkfLIpf;
        "pkg-1.21.3-a1.2.0" = _DMwmvOUE;
        "pkg-1.21.4-b1.2.1" = _cmmwictd;
        "pkg-1.21.5-1.2.2" = _BJJwb6tU;
        "pkg-1.21.6-1.2.3" = _QNzf7nue;
        "pkg-1.21.7-1.2.3" = _31uFRSzi;
        "pkg-1.21.8-1.2.3" = _vHStrdyO;
        "pkg-1.21.8-1.2.4" = _E3ILdPuQ;
        "pkg-1.21.8-1.2.5" = _W5SAk0VS;
        "pkg-1.21.9-1.2.5" = _yJaQaemI;
        "pkg-1.21.10-1.2.5" = _92cMbjCm;
        "pkg-1.21.10-1.2.6" = _w7VwwgsA;
        "pkg-1.21.11-1.2.6" = _xN4y2ysd;
        "pkg-1.21.11-1.2.7" = _RsOGyjNq;
        "pkg-1.21.11-1.2.8" = _SB92kyrf;
        "pkg-1.21.11-1.3.0" = _lhywiSjR;
        "pkg-1.21.11-1.3.1" = _3imiB98N;
        "pkg-1.21.11-1.3.2" = _CnilTI1J;
        "pkg-26.1.1-1.3.3" = _ydSZcbFs;
        "pkg-26.1-1.3.4" = _UXvah2tY;
