...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.5-forge" = _BQLDWjkl;
        "pkg-1.18.2-1.6-forge" = _OcgVhsCf;
        "pkg-1.19.2-1.7-forge" = _9zkqqAhT;
        "pkg-1.19.3-1.7-forge" = _JdeRe7q4;
        "pkg-1.18.2-2.0-forge+fabric" = _m53rJXHr;
        "pkg-1.19.2-2.0-forge+fabric" = _o2ddCkqW;
        "pkg-1.19.3-2.0-forge+fabric" = _imtN4iP7;
        "pkg-1.19.4-2.0-forge+fabric" = _ngNZInla;
        "pkg-1.20-2.0-forge+fabric" = _Gjd75y6m;
        "pkg-1.20.1-2.0-forge+fabric" = _iZYGB3cn;
        "pkg-1.20.2-2.0-forge+fabric" = _hfOX7xcp;
        "pkg-1.18.2-2.1-forge+fabric" = _Qm3UT1Uy;
        "pkg-1.19.2-2.1-forge+fabric" = _7OLDeGfc;
        "pkg-1.20.1-2.1-forge+fabric" = _aSqPiOQI;
        "pkg-1.20.2-2.1-forge+fabric" = _Ow35F5PU;
        "pkg-1.20.3-2.1-fabric+forge+neo" = _40g9nDg9;
        "pkg-1.20.4-2.1-fabric+forge+neo" = _f10LHpPA;
        "pkg-1.19.2-2.2-fabric+forge+neo" = _CK4stfyn;
        "pkg-1.20.1-2.2-fabric+forge+neo" = _kUNsbVDn;
        "pkg-1.20.2-2.2-fabric+forge+neo" = _7p08SQPV;
        "pkg-1.20.4-2.2-fabric+forge+neo" = _jk2YnFWy;
        "pkg-1.19.2-2.3-fabric+forge" = _IGQgz8dq;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _arzF1UXp;
        "pkg-1.20.4-2.3-fabric+forge+neo" = _C8Rq1xF7;
        "pkg-1.20.5-2.3-fabric+neo" = _8WSKnjym;
        "pkg-1.20.5-2.4-fabric+neo" = _DPnmnKYg;
        "pkg-1.20.6-2.4-fabric+forge+neo" = _ORIYpGkD;
        "pkg-1.21.0-2.4-fabric+forge+neo" = _2C6PT9O6;
        "pkg-1.20.1-2.5-fabric+forge+neo" = _BF7JggbP;
        "pkg-1.20.6-2.5-fabric+forge+neo" = _qVXphvTM;
        "pkg-1.21.0-2.5-fabric+forge+neo" = _ugolHS4G;
        "pkg-1.21.1-2.5-fabric+forge+neo" = _T1EQv3LZ;
        "pkg-1.21.2-2.5-fabric+neo" = _eWQhuNSu;
        "pkg-1.21.3-2.5-fabric+forge+neo" = _H9pb3lZw;
        "pkg-1.21.4-2.5-fabric+forge+neo" = _DezN6zSj;
        "pkg-1.20.1-2.6-fabric+forge+neo" = _gAkT68ow;
        "pkg-1.21.1-2.6-fabric+forge+neo" = _SGqWBBJh;
        "pkg-1.21.4-2.6-fabric+forge+neo" = _nTVchKF9;
        "pkg-1.21.5-2.6-fabric+forge+neo" = _1QZWLAJr;
        "pkg-1.21.6-2.6-fabric+forge+neo" = _NK6KWWgd;
        "pkg-1.21.7-2.6-fabric+forge+neo" = _gDjPeFfm;
        "pkg-1.21.8-2.6-fabric+forge+neo" = _LR4VgFj9;
        "pkg-1.21.9-2.6-fabric+forge+neo" = _k5WtxKrE;
        "pkg-1.21.10-2.6-fabric+forge+neo" = _gCZn3pUE;
        "pkg-1.21.11-2.6-fabric+forge+neo" = _YYV4eJlv;
        "pkg-26.1.0-2.6-fabric+forge+neo" = _cn3X8sNW;
        "pkg-26.1.1-2.6-fabric+forge+neo" = _83JtdIPc;
        "pkg-26.1.2-2.6-fabric+forge+neo" = _B3bfs8LI;
        "pkg-1.20.1-2.7-fabric+forge+neo" = _SXFtXQJG;
        "pkg-1.21.1-2.7-fabric+forge+neo" = _YozqwJRl;
        "pkg-1.21.11-2.7-fabric+forge+neo" = _gxEv5xlb;
        "pkg-26.1.2-2.7-fabric+forge+neo" = _79XjbFsY;
        "pkg-26.2.0-2.7-fabric+forge+neo" = _wJclnANL;
        "default" = _wJclnANL;
    });
