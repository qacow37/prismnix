...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0-fabric+forge+neo" = _N4BRAdLe;
        "pkg-1.19.2-1.1-fabric+forge+neo" = _Vo2lApXo;
        "pkg-1.20.1-1.1-fabric+forge+neo" = _lD4kwBIb;
        "pkg-1.20.2-1.1-fabric+forge+neo" = _3OvxWAbV;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _vDNZG6Py;
        "pkg-1.20.5-1.1-fabric+neo" = _mg3JNKTs;
        "pkg-1.20.5-1.2-fabric+neo" = _4m8Bojsy;
        "pkg-1.20.6-1.2-fabric+forge+neo" = _hcqqoCph;
        "pkg-1.19.2-1.3-fabric+forge" = _IWpENXyP;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _7QV93R0V;
        "pkg-1.20.6-1.3-fabric+forge+neo" = _4eTLikcT;
        "pkg-1.21.0-1.3-fabric+forge+neo" = _pbcHcFaO;
        "pkg-1.20.1-1.4-fabric+forge+neo" = _5PmUFTZE;
        "pkg-1.20.6-1.4-fabric+forge+neo" = _262v50JR;
        "pkg-1.21.0-1.4-fabric+forge+neo" = _CywDYfVh;
        "pkg-1.21.1-1.4-fabric+forge+neo" = _R24qYeOO;
        "pkg-1.21.2-1.4-fabric+neo" = _HYZhxMH6;
        "pkg-1.21.3-1.4-fabric+forge+neo" = _txxOEJ4R;
        "pkg-1.21.4-1.4-fabric+forge+neo" = _aYL32r7e;
        "pkg-1.20.1-1.5-fabric+forge+neo" = _Gzos2Wgi;
        "pkg-1.21.1-1.5-fabric+forge+neo" = _akcZiKPv;
        "pkg-1.21.4-1.5-fabric+forge+neo" = _aah7uwoh;
        "pkg-1.21.5-1.5-fabric+forge+neo" = _5Ylnqjxc;
        "pkg-1.21.6-1.5-fabric+forge+neo" = _qGaCv3JE;
        "pkg-1.21.7-1.5-fabric+forge+neo" = _OuXxV8v3;
        "pkg-1.21.8-1.5-fabric+forge+neo" = _MlYNLB8J;
        "pkg-1.21.9-1.5-fabric+forge+neo" = _cKuxIQGO;
        "pkg-1.21.9-1.6-fabric+forge+neo" = _mxVnpBG8;
        "pkg-1.21.10-1.6-fabric+forge+neo" = _6n0pwuTH;
        "pkg-1.21.11-1.6-fabric+forge+neo" = _bGudoxkg;
        "pkg-26.1.0-1.6-fabric+forge+neo" = _VowZT40i;
