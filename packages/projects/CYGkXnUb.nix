...
let
    ...
    in {
        ...
        "pkg-1.0.4a" = _aXlLjkA8;
        "pkg-1.0.8" = _kXcwdKG1;
        "pkg-1.0.9" = _GHP1FFxx;
        "pkg-1.0.9+mod" = _IjENUQf6;
        "pkg-1.1.0" = _qEOvvMU0;
        "pkg-1.1.0+mod" = _8zo3eD5r;
        "pkg-1.1.0a" = _FKcgReND;
        "pkg-1.1.0a+mod" = _3dPtk7t0;
        "pkg-1.1.0b" = _vs6luVu4;
        "pkg-1.1.0b+mod" = _6htVMDgE;
        "pkg-1.1.0c" = _LUI5E5fR;
        "pkg-1.1.0c+mod" = _nb8lLMAv;
        "pkg-1.1.1" = _m57M0Kus;
        "pkg-1.1.1+mod" = _TUNHcGAV;
        "pkg-1.1.2" = _I4nRSF6W;
        "pkg-1.1.2+mod" = _vW4I68qm;
        "pkg-1.1.3" = _wYehLALm;
        "pkg-1.1.3+mod" = _Eae7wP0C;
        "pkg-1.1.4" = _JhF4LjLV;
        "pkg-1.1.4+mod" = _CDDjjORs;
        "pkg-1.1.5" = _4a4134Ih;
        "pkg-1.1.5+mod" = _P1i1a8DT;
        "pkg-1.1.6" = _rwy5Kdw2;
        "pkg-1.1.6+mod" = _jyLDOcvy;
        "default" = _jyLDOcvy;
    });
