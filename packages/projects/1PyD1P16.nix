...
let
    ...
    in {
        ...
        "pkg-1+mod" = _NxSkH8yG;
        "pkg-1.1" = _8CR4bp14;
        "pkg-1.1+mod" = _u9kP3ZMI;
        "pkg-1.2" = _bJMPCFCM;
        "pkg-1.2+mod" = _mzwz0xZA;
        "pkg-1.2.1" = _JQ0iyFFa;
        "pkg-1.2.1+mod" = _lxDSuPUx;
        "pkg-1.3" = _4N2oyk84;
        "pkg-1.3+mod" = _dF1tEmj1;
        "pkg-1.4" = _PGCIW4Dm;
        "pkg-1.4+mod" = _hUCNi8Uv;
        "pkg-1.4.1" = _fH07N29j;
        "pkg-1.4.1+mod" = _iutAf42O;
        "pkg-1.5" = _SUvst2eR;
        "pkg-1.5+mod" = _gOfLK7Nv;
        "pkg-1.5.1" = _fNpL20Cl;
        "pkg-1.5.1+mod" = _pyjPzbNN;
        "pkg-1.6-1.20.x" = _zRt6DHN4;
        "pkg-1.6-1.20.x+mod" = _F2uPY7Bm;
        "pkg-1.6" = _KRXTHMqE;
        "pkg-1.6+mod" = _EY2hfhov;
        "pkg-1.6.1" = _XfD7tvNr;
        "pkg-1.6.1+mod" = _DFjFpl4H;
        "pkg-1.6.2" = _TebeLKJz;
        "pkg-1.6.2+mod" = _k2huwspQ;
        "pkg-1.6.3" = _Pg9TRkkW;
        "pkg-1.6.3+mod" = _Hqk1BrRQ;
        "pkg-1.6.4" = _w8emEZS6;
        "pkg-1.6.4+mod" = _sscwWSDT;
        "pkg-2.0" = _Lp9eOfG7;
        "pkg-2.0+mod" = _kq5QLLtP;
        "pkg-2.1" = _tder4gfq;
        "pkg-2.1+mod" = _u3GKDtlI;
        "pkg-2.2" = _4z7E0OM7;
        "pkg-2.2+mod" = _yMy2jZmd;
        "default" = _yMy2jZmd;
    });
