...
let
    ...
    in {
        ...
        "pkg-V1-1.20+1.20.1" = _1KlkB5bm;
        "pkg-V1-1.20.2+1.20.3" = _NttSI9pe;
        "pkg-V1-1.20.4" = _DfrEjF2U;
        "pkg-V1-1.20.5+1.20.6" = _rue5ZYjL;
        "pkg-V1-1.21+1.21.1" = _aui53KfQ;
        "pkg-V1-1.21.2+1.21.3" = _SbcNWH0q;
        "pkg-V1-1.21.4" = _CXG0e1Il;
        "pkg-V1-1.21.5" = _l6h0z49w;
        "pkg-V1-1.21.6" = _6JINtBpk;
        "pkg-V1-1.21.7+1.21.8" = _NsJVxfzx;
        "pkg-V1-1.21.9+1.21.10" = _EgwnzTXd;
        "pkg-V1-1.21.11" = _UFucbO8e;
        "pkg-OLD-V1-1.19+1.19.1" = _W54m4ZBY;
        "pkg-OLD-V1-1.19.2+1.19.3" = _KTDj8wcF;
        "pkg-OLD-V1-1.19.4" = _Jr2N5tKd;
        "pkg-OLD-V1-1.18+1.18.2" = _fBydkMzr;
        "pkg-OLD-V1-1.17+1.17.1" = _HSb9wjfH;
        "pkg-OLD-V1-1.16.2+1.16.5" = _4Tv2Pbgg;
        "pkg-V2-1.16.2+1.16.5" = _X5DXw8S1;
        "pkg-V2-1.17+1.17.1" = _QmlwVdHd;
        "pkg-V2-1.18+1.18.2" = _g37kNGnj;
        "pkg-V2-1.19+1.19.1" = _Ai0JvX8o;
        "pkg-V2-1.19.2+1.19.3" = _t67zPmpw;
        "pkg-V2-1.19.4" = _fxu2e1sU;
        "pkg-V2-1.20+1.20.1" = _bprmf7kh;
        "pkg-V2-1.20.2+1.20.3" = _rNMn3jgt;
        "pkg-V2-1.20.4" = _iwHkSwoW;
        "pkg-V2-1.20.5+1.20.6" = _L2aNpUQW;
        "pkg-V2-1.21+1.21.1" = _qlXB1cdW;
        "pkg-V2-1.21.2+1.21.3" = _4WClTAPW;
        "pkg-V2-1.21.4" = _ni9uqrkT;
        "pkg-V2-1.21.5" = _BPcHXbXY;
        "pkg-V2-1.21.6" = _rksd4twm;
        "pkg-V2-1.21.7+1.21.8" = _2ZAGa54E;
        "pkg-V2-1.21.9+1.21.10" = _KQKI4J9q;
        "pkg-V2-1.21.11" = _wtdIjFTj;
        "pkg-V3-1.16.2+1.16.5" = _tYrmku3q;
        "pkg-V3-1.17+1.17.1" = _lxLpDi5S;
        "pkg-V3-1.18+1.18.2" = _1nNQUOAo;
        "pkg-V3-1.19+1.19.1" = _8wG89BEk;
        "pkg-V3-1.19.2+1.19.3" = _skUCMHUN;
        "pkg-V3-1.19.4" = _4XfYaYsV;
        "pkg-V3-1.20+1.20.1" = _NXIks26c;
        "pkg-V3-1.20.2+1.20.3" = _RDao90IV;
        "pkg-V3-1.20.4" = _SiplvJz2;
        "pkg-V3-1.20.5+1.20.6" = _xc4PUdRI;
        "pkg-V3-1.21+1.21.1" = _5eclGRnv;
        "pkg-V3-1.21.2+1.21.3" = _85DCwpRP;
        "pkg-V3-1.21.4" = _z45gCKFu;
        "pkg-V3-1.21.5" = _On8GoPLc;
        "pkg-V3-1.21.6" = _b96xzDUs;
        "pkg-V3-1.21.7+1.21.8" = _an8c3Scc;
        "pkg-V3-1.21.9+1.21.10" = _DL4ie9dK;
        "pkg-V3-1.21.11" = _pVONGJEs;
        "pkg-V3-26.1-26.1.2" = _qZcB5gub;
        "default" = _qZcB5gub;
    });
