...
let
    ...
    in {
        ...
        "pkg-1.12.2-V1.0" = _2lDuBKWy;
        "pkg-1.12.2-V1.01" = _dk2k6pH1;
        "pkg-1.15.2-V1.0" = _gBJ872Pc;
        "pkg-1.16.5-V1.0" = _A49Suqx1;
        "pkg-1.17.1-V1.0" = _fRQOiqz3;
        "pkg-1.18.2-V1.0" = _47w9I69i;
        "pkg-1.19.2-V1.0" = _VHh050Z7;
        "pkg-1.19.4-V1.0" = _l1k4C4Fn;
        "pkg-1.20.1-V1.0" = _JHTEFmdX;
        "pkg-1.21.1-V1.0" = _2pYGhnbe;
        "pkg-1.21.4-V1.0" = _zSa2LeJK;
        "pkg-1.12.2-V1.02" = _Xm39hqTd;
        "pkg-1.16.5-V1.01" = _978npqYJ;
        "pkg-1.20.1-V1.01" = _KG8habw9;
        "pkg-1.21.1-V1.01NeoForge" = _cyAz0BXv;
        "pkg-1.20.1-V1.0Fabric" = _MNZaAmvV;
        "pkg-1.21.1-V1.0Fabric" = _SykeJRet;
        "pkg-1.21.11-V1.0Fabric" = _TpLGcA0L;
        "pkg-26.2-V1.0Fabric" = _sjeRdHIN;
        "pkg-1.21.11-V1.0NeoForge" = _H0u17GRB;
        "pkg-26.2-V1.0NeoForge" = _cpN18RB7;
        "pkg-1.12.2-V1.1" = _uLdPwVOR;
        "pkg-1.16.5-V1.1" = _90FGis6C;
        "default" = _90FGis6C;
    });
