...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.18" = _r0Jwffrr;
        "pkg-1.0.0-1.19" = _CmFXRq3P;
        "pkg-1.0.1-1.18" = _jWOt1f90;
        "pkg-1.0.1-1.19" = _yOD6zWc6;
        "pkg-1.0.2-1.19.2" = _jh2xE4a5;
        "pkg-1.0.3-1.19.3" = _QFalDyL5;
        "pkg-1.0.3-1.19.4" = _MaOM64pW;
        "pkg-1.0.2-mc1.19.2-hotfix" = _2UOKWlBe;
        "pkg-1.1.0-1.19.4" = _BDuZe3FM;
        "pkg-1.1.1-1.19.4" = _UoODOgsC;
        "pkg-1.1.2-1.19.4" = _43KZxX8a;
        "pkg-1.1.3-1.20.1" = _xRf3HPfb;
        "pkg-1.1.3.1-1.20.1" = _RcKrSqkK;
        "pkg-1.1.4-1.20.1" = _K6M9zSF8;
        "pkg-1.2.0-1.20.1" = _zFVSmoQg;
        "pkg-1.2.1-1.20.1" = _fROHV9gC;
        "pkg-1.2.1-1.20.2" = _SotsZlJ6;
        "pkg-1.2.1-1.20.4" = _WyhKYeMf;
        "pkg-1.3.0" = _VrgThn48;
        "pkg-1.4.0" = _GiTLikRM;
        "pkg-1.4.1" = _map5Ojxn;
        "pkg-2.0.0" = _lt06DPop;
