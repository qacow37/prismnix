...
let
    ...
    in {
        ...
        "pkg-1.18.1-1.3.2.0" = _vhqa67dH;
        "pkg-1.19-1.4.2.0" = _VIInTUO6;
        "pkg-1.18.1-1.3.2.1" = _pIG6eEyH;
        "pkg-1.19-1.4.2.1" = _rwcrA6pw;
        "pkg-1.19.3-1.4.3.0" = _219fmQfO;
        "pkg-1.19.3-1.4.3.1" = _S9jd6Fi3;
        "pkg-1.19.4-1.5.0.0" = _c0OoZn8s;
        "pkg-1.20-1.6.0.0" = _NokRT0Dp;
        "pkg-1.20.1-1.6.1.0" = _ghTdp8sc;
        "pkg-1.20.1-1.7.0.0" = _4DJsLhYV;
        "pkg-1.20.1-1.7.0.1" = _lKvPKCot;
        "pkg-1.19.4-1.5.0.1" = _40rHElaY;
        "pkg-1.20.2-1.8.0.0" = _svPIO2Uh;
        "pkg-1.20.2-2.0.0.0" = _MyYNPKzD;
        "pkg-1.20.4-2.1.0.0" = _1RRLh3kL;
        "pkg-1.20.4-2.1.0.1" = _eHMYw6it;
        "pkg-1.20.4-2.2.0.0" = _hO2ErGQH;
        "pkg-1.20.4-2.2.0.1" = _yVxfZrEL;
        "pkg-1.20.4-2.2.1.0" = _uGU9DrWQ;
        "pkg-1.20.6-2.3.0.0" = _Lmf4zK1w;
        "pkg-1.21-3.0.0.0" = _Bk2Erw4A;
        "pkg-1.21-3.1.0.0" = _SAZwxMZ3;
        "pkg-1.21-3.1.1.0" = _KN6yB6NK;
        "pkg-1.21.1-3.2.0.0" = _TC76K6Be;
        "pkg-1.21.3-3.3.0.0" = _ZIuq4KNl;
        "pkg-1.21.4-3.4.0.0" = _JQPJXohk;
        "pkg-1.21.5-3.5.0.0" = _kavFU7IU;
        "pkg-1.21.6-3.6.0.0" = _3IAB9mrx;
        "pkg-1.21.9-3.7.0.0" = _b7ct0SlD;
