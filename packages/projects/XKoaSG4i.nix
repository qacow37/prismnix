...
let
    ...
    in {
        ...
        "pkg-1.1.1+1.21" = _KheJ74I6;
        "pkg-1.1.1+1.21.9" = _xo6Rzfd8;
        "pkg-1.2+1.21" = _gH7ofpXc;
        "pkg-1.2+1.21.9" = _qiDCCXj6;
        "pkg-1.2.1+1.21" = _xIB9B4K2;
        "pkg-1.2.1+1.21.9" = _yNkR9VWq;
        "pkg-1.2.1+1.20" = _5rBVzgcv;
        "pkg-1.3+1.21.9" = _zIRrQ1YR;
        "pkg-1.3+1.20" = _i46UvdOC;
        "pkg-1.3+1.21" = _PwzJ02KF;
        "pkg-1.3.1+1.20" = _bPjuaeZL;
        "pkg-1.3.1+26.1" = _CcxsZRPb;
        "pkg-1.3.1+1.21" = _hZwBo63z;
        "pkg-1.3.1+1.21.9" = _bhdUtlA0;
        "pkg-1.3.2+26.1" = _eeYbDreD;
        "pkg-1.3.2+1.20" = _J1ljRQy1;
        "pkg-1.3.2+1.21" = _1Db0PZ6f;
        "pkg-1.3.2+1.21.9" = _xMmmlgz6;
        "pkg-1.4+1.20" = _K10UwWJa;
        "pkg-1.4+1.21" = _qOgXAXZ0;
        "pkg-1.4+26.1" = _q9Yu1auX;
        "pkg-1.4+1.21.9" = _5qwKzsRb;
        "pkg-1.4.1+1.20" = _4G1qjfYU;
        "pkg-1.4.1+1.21" = _MgXMYKHi;
        "pkg-1.4.1+1.21.9" = _Xd4tpd8L;
        "pkg-1.4.1+26.1" = _FAzfhbat;
        "pkg-1.5+1.20" = _LzfmyoPa;
        "pkg-1.5+1.21" = _H0jZBTNG;
        "pkg-1.5+26.1" = _BKkOPhjJ;
        "pkg-1.5+1.21.9" = _PKqZYad2;
        "pkg-1.6+1.21" = _RhCSAFks;
        "pkg-1.6+1.21.9" = _W4LWI4EW;
        "pkg-1.6+26.1" = _77BUJJ88;
        "pkg-1.6+26.2" = _BQCRMs3n;
        "pkg-2.0+1.21" = _vF7UmgDK;
        "pkg-2.0+1.21.9" = _N0gdcwQd;
        "pkg-2.0+26.2" = _qefe0Cqg;
        "pkg-2.0+26.1" = _wRPw57GM;
        "pkg-2.1+1.21" = _j4e8tjWH;
        "pkg-2.1+1.21.9" = _gf7bvKCs;
