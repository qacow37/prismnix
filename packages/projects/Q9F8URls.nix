...
let
    ...
    in {
        ...
        "pkg-2.0.0.0" = _VVws7FIv;
        "pkg-2.1.0.0" = _uzk8bLXn;
        "pkg-2.1.0.1" = _z4IKiFX0;
        "pkg-3.0.0.0" = _EiA5U8JO;
        "pkg-3.1.0.0" = _uUWPKrVB;
        "pkg-3.1.1.0" = _iwIkCGth;
        "pkg-4.0.0.0" = _6VdOaMXR;
        "pkg-4.1.0.0" = _eSnW7HrK;
        "pkg-4.1.1.0" = _ddpxXXGX;
        "pkg-4.1.2.0" = _kTmYR9yb;
        "pkg-4.1.2.1" = _HyCsP72C;
        "pkg-4.1.3.0" = _HaYaAlLJ;
        "pkg-4.1.4.0" = _tyYDYfU3;
        "pkg-5.0.0.0-beta" = _WAMerOQR;
        "pkg-5.0.1.0-beta" = _YogaZ1XB;
        "pkg-5.1.0.0-beta" = _53B3xBjy;
        "pkg-5.1.0.1-beta" = _5tvPl4Zt;
        "pkg-5.1.1.0-beta" = _JGBtTT5F;
        "pkg-5.2.0.0-beta" = _AfqvJ8Tn;
        "pkg-5.2.1.0-beta" = _zOAZWmS0;
        "pkg-2.2.0.0" = _lK79VCb1;
        "pkg-5.2.1.1-beta" = _34bRStca;
        "pkg-5.2.2.0" = _KDHHwhWH;
        "pkg-5.2.2.1" = _CrF0jSyP;
        "pkg-5.2.2.2" = _5Vio66Kf;
        "default" = _5Vio66Kf;
    });
