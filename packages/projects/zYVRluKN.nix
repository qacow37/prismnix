...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20+fabric" = _vwFhepLn;
        "pkg-1.0.0+1.20.1+fabric" = _AkrJseIJ;
        "pkg-1.0.0+1.20.2+fabric" = _gTOtqrNF;
        "pkg-1.0.0+1.20.3+fabric" = _QGyCpMXl;
        "pkg-1.0.0+1.20.4+fabric" = _Y3csMXLo;
        "pkg-1.0.0+1.20.5+fabric" = _Z17UatMK;
        "pkg-1.0.0+1.20.6+fabric" = _nZkaZaHJ;
        "pkg-1.0.0+1.21+fabric" = _5wiPEhOw;
        "pkg-1.0.0+1.21.1+fabric" = _b6JLNzb6;
        "pkg-1.0.0+1.21.2+fabric" = _vpatcX8K;
        "pkg-1.0.0+1.21.3+fabric" = _vtYHMliN;
        "pkg-1.0.0+1.21.4+fabric" = _K3BOf6ju;
        "pkg-1.0.0+1.21.5+fabric" = _VutLKS4J;
        "pkg-1.0.0+1.21.6+fabric" = _g0vNyK7U;
        "pkg-1.0.0+1.21.7+fabric" = _yO6WnrU3;
        "pkg-1.0.0+1.21.8+fabric" = _OO7Dza8u;
        "pkg-1.0.0+1.21.9+fabric" = _8FnNxTM0;
        "pkg-1.0.0+1.21.10+fabric" = _H3gQbjqd;
        "pkg-1.0.0+1.21.11+fabric" = _Xfd2IGAU;
        "pkg-1.0.1+1.20.1+forge" = _XYulrul1;
        "pkg-1.0.1+1.21.1+neoforge" = _rb7uJr6o;
        "pkg-1.0.1+1.21.11+neoforge" = _u1lqgxLv;
        "pkg-1.0.1+26.1+neoforge" = _QidrlQW8;
        "pkg-1.0.1+26.2+neoforge" = _KSSCYX4W;
        "pkg-1.0.1+1.20.1+fabric" = _IUuoCYVN;
        "pkg-1.0.1+1.21.1+fabric" = _ptgDVWqk;
        "pkg-1.0.1+1.21.11+fabric" = _N9HM4RyC;
        "pkg-1.0.1+26.1+fabric" = _JBFhlhgC;
        "pkg-1.0.1+26.2+fabric" = _RWOcyEeR;
        "default" = _RWOcyEeR;
    });
