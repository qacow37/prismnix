...
let
    ...
    in {
        ...
        "pkg-v1.0.1" = _8pGX7WXm;
        "pkg-1.19.4-v1.1.0" = _nMOfefQG;
        "pkg-1.19.3-v1.1.0" = _yGgquj90;
        "pkg-1.19-v1.1.0" = _SjzWGbzp;
        "pkg-1.18-v1.1.0" = _leWJZQlb;
        "pkg-1.18-v1.1.1" = _VweWlWfd;
        "pkg-1.19-v1.1.1" = _W8p4rPN9;
        "pkg-1.19.3-v1.1.1" = _BNJEix4Y;
        "pkg-1.19.4-v1.1.1" = _GUDpvxZM;
        "pkg-1.20-v1.1.1" = _vSzWNcKp;
        "pkg-1.18-v1.2.0" = _M0yNEN2W;
        "pkg-1.19-v1.2.0" = _O2d3O0Qd;
        "pkg-1.19.3-v1.2.0" = _UoRBTrWI;
        "pkg-1.19.4-v1.2.0" = _O4V42nfd;
        "pkg-1.20-v1.2.0" = _8cRTQ7SL;
        "pkg-2.0.0-mc1.20" = _Fpenf1R6;
        "pkg-2.0.1-mc1.20" = _1Irm7sCX;
        "pkg-2.0.3-mc1.20" = _dJ2hgpfP;
        "pkg-2.0.4-mc1.20" = _g37A4Gxy;
        "pkg-2.1.0-fabric1.20" = _efvNlDkn;
        "pkg-2.1.0-fabric1.21" = _6XucrX7b;
        "pkg-2.1.0-fabric1.20.5" = _bnLRG0tT;
        "pkg-2.1.1-fabric.1.21" = _Ktzbblxh;
        "pkg-2.1.1-fabric.1.20" = _gbmdebcS;
        "pkg-2.1.1-fabric.1.20.5" = _ygORymL4;
        "default" = _ygORymL4;
    });
