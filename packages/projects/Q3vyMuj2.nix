...
let
    ...
    in {
        ...
        "pkg-v1.3" = _IzNdMwzN;
        "pkg-v1.1.5" = _F7nbTCnz;
        "pkg-v1.3.1" = _Sdb6K176;
        "pkg-v1.4" = _VnIfWWY7;
        "pkg-v1.4.1" = _Wt1kNH3h;
        "pkg-v1.4.2" = _dO9o7xWe;
        "pkg-v1.4.3" = _RfMOxne8;
        "pkg-v1.4.4" = _5IoCIQbq;
        "pkg-v1.4.5" = _SWdyOG5y;
        "pkg-v1.4.6" = _goJUMPOh;
        "pkg-v1.4.7" = _NUj6R1WD;
        "pkg-v1.4.8" = _kBJzvnMC;
        "pkg-v1.4.9" = _CaASo0kx;
        "pkg-v1.4.10" = _ach8FnTE;
        "pkg-v1.4.11" = _Vaq6PzoN;
        "pkg-v1.4.12" = _IOLH1DP5;
        "pkg-v1.5" = _3okkMHY1;
        "pkg-v1.6" = _CtyrwIxX;
