...
let
    ...
    in {
        ...
        "pkg-4.1.1" = _Y8kIVs8Y;
        "pkg-4.0.2" = _8MpZi9eL;
        "pkg-4.2.0+1.21" = _MBaW6p3N;
        "pkg-4.2.0+1.21.3" = _s6yQVjoH;
        "pkg-4.2.1+1.21" = _oqnmGNXM;
        "pkg-4.2.1+1.21.3" = _gzskc6sN;
        "pkg-4.2.1+1.21.4" = _UIwZUUMF;
        "pkg-4.3.0+1.21" = _jYv2JKKI;
        "pkg-4.3.0+1.21.3" = _A96ZUIIO;
        "pkg-4.3.0+1.21.4" = _ZmPI0dKW;
        "pkg-4.3.1+1.21" = _iCyp0DDS;
        "pkg-4.3.1+1.21.3" = _YpxEHZ8u;
        "pkg-4.3.1+1.21.4" = _ZMM8EC4R;
        "pkg-4.4.0+1.21.1" = _z30g07sc;
        "pkg-4.4.0+1.21.3" = _vkJmvyVO;
        "pkg-4.4.0+1.21.4" = _T4o333wm;
        "pkg-4.4.1+1.21.1" = _Tzf2WBGP;
        "pkg-4.4.1+1.21.3" = _vqOyYVqN;
        "pkg-4.4.1+1.21.4" = _ujydF9cH;
        "pkg-4.4.1.1+1.21.4" = _nbimcyz0;
        "pkg-4.4.1.2+1.21.4" = _z9hTQwH8;
        "pkg-4.4.1.2+1.21.5" = _sp2PiUN2;
        "pkg-4.4.2+1.21.10" = _Y1FABYek;
