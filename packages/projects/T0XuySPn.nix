...
let
    ...
    in {
        ...
        "pkg-1.1.5" = _QmxTWzAC;
        "pkg-1.1.6" = _ML8mfrwg;
        "pkg-1.1.2.1" = _7V9Jwmj7;
        "pkg-1.1.3.1" = _2NI18W9w;
        "pkg-1.1.4.1" = _M3L9pynV;
        "pkg-1.1.5.1" = _f7cjL02s;
        "pkg-1.1.6.1" = _EWzQ8p4W;
        "pkg-1.1.2.2" = _yp4rXhEF;
        "pkg-1.1.3.2" = _VM5A5tgk;
        "pkg-1.1.4.2" = _1iDXDoIg;
        "pkg-1.1.5.2" = _67yIEY5n;
        "pkg-1.1.6.2" = _5f2kkHeO;
        "pkg-1.1.7" = _kMHLRYil;
        "pkg-1.1.8" = _mu1JEdAT;
        "pkg-1.1.7.1" = _TzXySDSS;
        "pkg-1.1.8.1" = _B6F6slJw;
        "pkg-1.1.7.1.1" = _SsRnDhfw;
        "pkg-1.1.7.1.2" = _NSChzCG4;
        "pkg-1.1.7.1.3" = _94nkoPIf;
        "pkg-1.1.8.1.1" = _GAn53g5n;
        "pkg-1.1.7.2" = _V5qNPHS1;
        "pkg-1.1.8.2" = _LSEvKfTK;
        "pkg-2.0.0" = _Ak8zAcWK;
        "pkg-2.0.1" = _wD8WkvuS;
        "pkg-2.0.0.1" = _X4Ex1pdK;
        "pkg-2.0.1.1" = _O5un54OT;
        "pkg-2.0.0.2" = _O11ilHoe;
        "pkg-2.0.1.2" = _IfuWivwi;
        "pkg-2.5.0" = _c2OE1Ymi;
        "pkg-2.5.1" = _Lf2nl4IE;
        "pkg-2.5.0.1" = _nA0UF7dy;
        "pkg-2.5.1.1" = _ECioCSQH;
        "default" = _ECioCSQH;
    });
