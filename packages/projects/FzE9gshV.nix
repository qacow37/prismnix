...
let
    ...
    in {
        ...
        "pkg-6.7.5" = _C8AdUuNs;
        "pkg-6.7.6" = _ADXbJ6cT;
        "pkg-6.7.6+lts" = _JzzMNKkT;
        "pkg-6.8.0" = _x4MdlFPh;
        "pkg-6.9.0" = _2G0yFfO1;
        "pkg-6.9.2" = _7suUUiTB;
        "pkg-6.10.0+1.20" = _BfeauCtk;
        "pkg-6.10.1+1.20" = _x0kr9ikB;
        "pkg-6.10.1+1.19.3" = _XV0LLez4;
        "pkg-6.10.1+1.19.2" = _jH1sVAKE;
        "pkg-6.10.1+1.19.4" = _QJOapu4X;
        "pkg-6.10.2+1.19.2" = _Sr9sMYUf;
        "pkg-6.10.2+1.19.3" = _pNFPFQfT;
        "pkg-6.10.2+1.19.4" = _d99ALXIi;
        "pkg-6.10.2+1.20" = _1Jdf1Be1;
        "pkg-6.11.0+1.20.2" = _qweuNYjF;
        "pkg-6.11.1+1.20.2" = _GryjAmep;
        "pkg-6.12.1+1.20.4" = _22fYMQZv;
        "pkg-6.10.3+1.20" = _P4i1BHrE;
        "pkg-6.10.3+1.20.1" = _ipK4gJzR;
        "pkg-6.11.2+1.20.2" = _mOGVGrAM;
        "pkg-6.12.2+1.20.4" = _S8JrKOlZ;
        "pkg-6.12.3+1.20.5" = _gjrAQqoH;
        "pkg-6.13.0+1.21" = _HPVkYuXA;
        "pkg-6.13.1+1.21" = _UqulJosX;
        "pkg-6.14.0+1.21.3" = _uzI6IfWE;
        "pkg-6.14.0+1.21" = _SkjMf5w6;
        "pkg-6.14.1+1.21" = _ZaNFlqvF;
        "pkg-6.14.1+1.21.3" = _RlbfmaJk;
        "pkg-6.14.2+1.21.4" = _vjpMTcMC;
        "pkg-6.14.2+1.21" = _7M3sBYeh;
        "pkg-6.14.2+1.21.3" = _Ry5rt8QT;
        "pkg-6.14.3+1.21.4" = _k4e9TduA;
        "pkg-6.12.4+1.20.5" = _W4aIsorf;
        "pkg-6.12.4+1.20.4" = _mTirvHX2;
        "pkg-6.12.4+1.20.2" = _bjgrwBPD;
        "pkg-6.14.3+1.21.3" = _GWbWv6hQ;
        "pkg-6.14.3+1.21.1" = _O2lsak3E;
        "pkg-6.12.5+1.20.5" = _uiHhVanj;
        "pkg-6.12.5+1.20.2" = _wqhvVb7N;
        "pkg-6.12.5+1.20.4" = _A6nPpM4v;
        "pkg-6.14.4+1.21.4" = _vENgg24z;
        "pkg-6.14.4+1.21.5" = _Fb1WGK4p;
        "pkg-6.14.4+25w14craftmine" = _lTm5dtX4;
        "pkg-6.14.4+1.21.1" = _IVIMNw9l;
        "pkg-6.14.4+1.21.3" = _RUnkzI62;
        "pkg-6.14.5+1.21.4" = _GlQiDaUe;
        "pkg-6.14.5+1.21.5" = _50RGYoRN;
        "pkg-6.14.6+1.21.7" = _43qGf0x0;
        "pkg-6.14.6+1.21.4" = _w4sK78wK;
        "pkg-6.14.6+1.21.5" = _j5FYEFJu;
        "pkg-6.14.6+1.21.3" = _mrNQKkaD;
        "pkg-6.14.6+1.21.1" = _TfObOUvU;
        "pkg-6.15.0+1.21.10" = _Lky6liFf;
        "pkg-6.10.6+1.20.1" = _cEh0dO3U;
        "pkg-6.15.2+1.21.10" = _H4dfOW1Y;
        "pkg-6.15.3+1.21.10" = _LrLNg2aZ;
        "pkg-6.15.3+1.21.11" = _mvB8kUFY;
        "pkg-6.15.4+26.1" = _PScrZ3A4;
