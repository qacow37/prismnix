...
let
    ...
    in {
        ...
        "pkg-0.0.2-1.20.1" = _ZCws70Mr;
        "pkg-0.1.0-1.20.1" = _q9bMvwp6;
        "pkg-0.1.1-1.20.1" = _akv2idqH;
        "pkg-0.1.2-1.20.1" = _Ugl9yAJd;
        "pkg-0.1.3-1.20.1" = _GWzcAhZt;
        "pkg-0.1.4-1.20.1" = _AUnXFVm9;
        "pkg-0.1.5-1.20.1" = _mi1W8TV7;
        "pkg-0.1.6-1.20.1" = _p0JHjbwE;
        "pkg-0.2.3-1.20.1" = _ZlXnnVaO;
        "pkg-0.2.4-1.20.1" = _ab9Fx0Ly;
        "pkg-1.0.0-1.20.1" = _ArIrGErM;
        "pkg-1.0.1-1.20.1" = _SM6qKhBm;
        "pkg-1.0.2-1.20.1" = _q2Wq7Ew7;
        "pkg-1.0.3-1.20.1" = _ZR61NFKR;
        "pkg-1.0.4-1.20.1" = _N25hDi8S;
        "pkg-1.0.5-1.20.1" = _bI3ViGzW;
        "pkg-1.0.6-1.20.1" = _kSzmZzip;
        "pkg-1.1.1-1.20.1" = _V3JSVMqJ;
        "pkg-1.1.2-1.20.1" = _XpgyfAYq;
        "pkg-1.1.3-1.20.1" = _NOlXxFa1;
        "pkg-1.1.4-1.20.1" = _umnY8aJj;
        "pkg-1.1.5-1.20.1" = _bebiVoGn;
        "pkg-1.1.6-1.20.1" = _xC39zQUU;
        "pkg-1.1.7-1.20.1" = _P1A3tJnZ;
        "pkg-1.1.8-1.20.1" = _Eo0Ojt3q;
        "pkg-1.1.9-1.20.1" = _n59fTpXn;
        "pkg-1.1.10-1.20.1" = _D9S0ua9V;
        "pkg-1.2.0-1.20.1" = _ffgWpFS1;
        "pkg-1.2.1-1.20.1" = _PwhBr7d6;
        "pkg-1.2.2-1.20.1" = _XB1YPwyH;
        "pkg-1.2.3-1.20.1" = _D3JxTPgz;
        "pkg-1.2.4-1.20.1" = _mYfZjuOw;
        "pkg-1.2.5-1.20.1" = _XlYPrAwx;
        "default" = _XlYPrAwx;
    });
