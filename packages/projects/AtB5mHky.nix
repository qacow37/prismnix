...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.7" = _crrPsvZt;
        "pkg-1.20.1-1.0.8" = _mbJiWmm8;
        "pkg-1.20.1-1.0.9" = _p6YWAFe3;
        "pkg-1.20.1-1.0.10" = _oxvEhRck;
        "pkg-1.20.1-1.0.11" = _zWFqdD3k;
        "pkg-1.20.1-1.0.12" = _JP2vgQ8o;
        "pkg-1.20.1-1.0.13" = _bkchZCMz;
        "pkg-1.16.5-1.0.14" = _VTlIWZCY;
        "pkg-1.18.2-1.0.14" = _6HslThOA;
        "pkg-1.19.4-1.0.14" = _U5WvMCan;
        "pkg-1.19.2-1.0.14" = _L63H84ys;
        "pkg-1.20.1-1.1.0" = _QmpSP6yj;
        "pkg-1.20.1-1.1.1" = _nbHfJbTd;
        "pkg-1.20.1-1.1.2" = _UqqNIn4t;
        "pkg-1.20.1-1.1.3" = _Sp0NpaDe;
        "pkg-1.20.4-1.1.3" = _VJlcs6xM;
        "pkg-1.20.6-1.1.3" = _sAyLhVnQ;
        "pkg-1.21.0-1.1.3" = _Ub02iR6p;
        "pkg-1.21.0-1.1.4" = _eh0XuALr;
        "pkg-1.20.1-1.2.0" = _oamhKt3H;
        "pkg-1.20.1-1.2.1.1" = _C3DPdRIW;
        "pkg-1.20.1-1.2.1" = _HuSSEaOg;
        "pkg-1.20.1-1.2.2" = _4Z4r1IL1;
        "pkg-1.20.1-1.2.3" = _GpiXMxvP;
        "pkg-1.21.0-1.2.3" = _BecIHPxZ;
        "pkg-1.21.3-1.2.3" = _faOuOHwq;
        "pkg-1.21.3-1.2.4" = _5ZRIZ0kq;
        "pkg-1.21.4-1.2.5" = _K1Qp2Cga;
        "pkg-1.21.0-1.2.6" = _y1ZYGDCs;
        "pkg-1.21.0-1.2.7" = _uWr2aTW9;
        "default" = _uWr2aTW9;
    });
