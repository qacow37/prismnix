...
let
    ...
    in {
        ...
        "pkg-1.12-0.0.1beta" = _iBGdiQMR;
        "pkg-1.12-0.0.2beta" = _kUlree4n;
        "pkg-1.12-1.0.0" = _xScNVou3;
        "pkg-1.12-1.1.0" = _ae6gMXN3;
        "pkg-1.12-1.2.0-alpha" = _R5BVDWEA;
        "pkg-1.12-1.2.0" = _FD4iMZqk;
        "pkg-1.12-1.2.1" = _isvpiVhG;
        "pkg-1.12-1.3.0" = _VH6fT3IS;
        "pkg-1.14-1.3.0-alpha" = _o6gRbqRr;
        "pkg-1.14-1.3.1-alpha" = _EnYRyTT3;
        "pkg-1.14-1.3.2-alpha" = _30ygxjda;
        "pkg-1.14-1.3.3-alpha" = _cvQCmMJe;
        "pkg-1.14-1.3.4-alpha" = _k3thwfQP;
        "pkg-1.14-1.3.5-alpha" = _zv8z8Dia;
        "pkg-1.14-1.3.6-alpha" = _Unl481Gq;
        "pkg-1.14-1.3.7" = _dmTXW3cR;
        "pkg-1.14-1.3.8" = _uyvvWj6B;
        "pkg-1.14-1.3.9" = _ZGpOsnq9;
        "pkg-1.14-1.3.10" = _q2UNJXfW;
        "pkg-1.15-2.0.0-beta" = _94gBKDea;
        "pkg-1.16-3.0.0-beta" = _PoIblFaX;
        "pkg-1.16-3.0.1-beta" = _qWSCQo3S;
        "pkg-1.15-2.0.1-beta" = _u7pAEXN6;
        "pkg-1.16-3.0.2-beta" = _BqOlehtp;
        "pkg-1.15-2.0.2" = _gVmyYzZw;
        "pkg-1.16-3.0.3" = _sWfpUUDG;
        "pkg-1.16-3.0.4" = _AwLbPEtb;
        "pkg-1.16-3.0.5" = _YqaEbCv8;
        "pkg-1.16-3.0.6" = _iSBt72DF;
        "pkg-1.18-4.0.0" = _G71SDMkj;
        "pkg-1.19-5.0.0" = _cjwbIcGe;
        "pkg-1.19-5.1.0" = _BBVSzcaw;
        "pkg-1.19-5.1.1" = _p2C2eaUQ;
        "pkg-1.20-6.0.0" = _rqfikM8d;
        "pkg-1.19-5.1.2" = _o8Se0Vtq;
        "pkg-1.20-6.0.1" = _AdeXiEhT;
        "pkg-1.20-6.0.2" = _QtlMlI1l;
        "pkg-1.21-7.0.0" = _F4ifdW0I;
        "pkg-1.21-7.0.1" = _gWkyV1zT;
        "pkg-1.21-7.0.2" = _PuhKO5Oh;
        "pkg-1.21-7.0.3" = _QiLugx4P;
        "pkg-1.20-6.0.3" = _eAQhSX9S;
        "default" = _eAQhSX9S;
    });
