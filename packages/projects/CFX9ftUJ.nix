...
let
    ...
    in {
        ...
        "pkg-fabric-1.5.0-1.18.2" = _fvk2vZay;
        "pkg-fabric-1.5.0-1.19pre.x" = _6jBqcJaS;
        "pkg-forge-1.11.0-1.16.5" = _2vPyWBkE;
        "pkg-forge-1.11.1-1.18.2" = _WMUGB6BF;
        "pkg-fabric-1.5.1-1.18.2" = _gikU54Vd;
        "pkg-fabric-1.5.1-1.19rc" = _6DHhpzVM;
        "pkg-forge-1.12.0-1.16.5" = _5Ak35ZLk;
        "pkg-forge-1.12.0-1.18.2" = _uJS9gCpo;
        "pkg-forge-1.12.1-1.16.5" = _oigoDI6E;
        "pkg-forge-1.12.1-1.18.2" = _dxQYBm0X;
        "pkg-forge-1.12.3-1.16.5" = _L2rrOQeR;
        "pkg-forge-1.12.3-1.18.2" = _8Ckn0hvu;
        "pkg-fabric-1.6.0-1.19" = _HpIFPBle;
        "pkg-forge-1.13.0-1.19" = _ejNqJwin;
        "pkg-forge-1.13.1-1.19" = _gjSBomen;
        "pkg-fabric-1.6.1-1.19" = _7Moaa3g0;
        "pkg-forge-1.13.2-1.19" = _eWCRo7cm;
        "pkg-forge-1.13.3-1.19" = _oAer4ejP;
        "pkg-forge-1.13.4-1.19" = _HjxifcAx;
        "pkg-forge-1.13.5-1.19" = _JJsQfL2d;
        "pkg-forge-1.12.4-1.16.5" = _Bi7nYNRv;
        "pkg-forge-1.12.4-1.18.2" = _YTfL6MzT;
        "pkg-fabric-1.6.2-1.19" = _y0KrrOYU;
        "pkg-fabric-1.6.3-1.19.1" = _JEz8lEpz;
        "pkg-forge-1.13.5-1.19.1" = _9JPRJ96Y;
        "pkg-forge-1.13.5-1.19.2" = _4KzsoqDU;
        "pkg-fabric-1.6.4-1.19.2" = _fMz56414;
        "pkg-forge-1.13.6-1.19.2" = _hJqM6o9W;
        "pkg-forge-1.13.7-1.19.2" = _TIVVBMI0;
        "pkg-forge-1.14.0-1.18.2" = _CcJoekq9;
        "pkg-forge-1.14.0-1.19.2" = _yrt7Sv8a;
        "pkg-forge-1.14.1-1.18.2" = _8tAvszf3;
        "pkg-forge-1.14.1-1.19.2" = _83xOyaw2;
        "pkg-fabric-1.6.5-1.19.2" = _N9m54zno;
        "pkg-forge-1.14.2-1.18.2" = _OZCyznvX;
        "pkg-forge-1.14.2-1.19.2" = _TQFuk0vP;
        "pkg-fabric-1.6.6-1.19.3" = _KC8G94Qs;
        "pkg-forge-1.14.3-1.19.3" = _cQadX21N;
        "pkg-forge-1.14.4-mc1.19.3" = _jlMOut9J;
        "pkg-forge-1.14.5-mc1.19.3" = _KEsHZlNs;
        "pkg-forge-1.14.6-mc1.18.2" = _jLMa5WuW;
        "pkg-forge-1.14.6-mc1.19.2" = _9zjAXtbT;
        "pkg-forge-1.14.6-mc1.19.3" = _3vdPinGB;
        "pkg-fabric-1.6.6-mc1.19.2" = _ALsjZaoa;
        "pkg-forge-1.14.7-mc1.18.2" = _hncu429t;
        "pkg-forge-1.14.7-mc1.19.2" = _VoNMv3pI;
        "pkg-forge-1.14.7-mc1.19.3" = _berBRGQx;
        "pkg-forge-1.14.7-mc1.19.4" = _995mMqJY;
        "pkg-fabric-1.6.6-mc1.19.4" = _rZWb6PHD;
        "pkg-fabric-1.6.7-mc1.19.2" = _OBpDv0Zd;
        "pkg-fabric-1.6.7-mc1.19.4" = _mvN8W5P6;
        "pkg-fabric-2.0.0-mc1.19.4" = _UQurJJpR;
        "pkg-forge-2.0.0-mc1.19.4" = _TgHu2cVP;
        "pkg-fabric-2.0.1-mc1.19.4" = _2DJ4aLlo;
        "pkg-forge-2.0.1-mc1.19.4" = _Qh2oK9IG;
        "pkg-fabric-2.0.1-mc1.20" = _k9q6SjwU;
        "pkg-forge-2.0.1-mc1.20" = _Msai2bCS;
        "pkg-fabric-2.0.2-mc1.19.4" = _YBYzQHXb;
        "pkg-forge-2.0.2-mc1.19.4" = _aYvpwZsM;
        "pkg-fabric-2.0.2-mc1.20" = _Hv4nMPEU;
        "pkg-forge-2.0.2-mc1.20" = _477qOuWy;
        "pkg-fabric-2.0.2-mc1.20.1" = _4Kg6Ecte;
        "pkg-forge-2.0.2-mc1.20.1" = _bUx8Uw1Z;
        "pkg-fabric-2.0.2-mc1.20.2" = _uEfeM6WY;
        "pkg-forge-2.0.2-mc1.20.2" = _ETcKoAk1;
        "pkg-fabric-2.0.2-mc1.20.3" = _USS6rmGF;
        "pkg-forge-2.0.2-mc1.20.3" = _lDMuYjxk;
        "pkg-fabric-2.0.2-mc1.20.4" = _w1I2zUEB;
        "pkg-forge-2.0.2-mc1.20.4" = _YhdjfcuM;
        "pkg-fabric-2.0.3-mc1.20.1" = _VVq8iSpa;
        "pkg-forge-2.0.3-mc1.20.1" = _qEqIjQpe;
        "pkg-fabric-2.0.3-mc1.20.4" = _ZPIJVLq2;
        "pkg-forge-2.0.3-mc1.20.4" = _zQaFi2FM;
        "pkg-neoforge-2.0.3-mc1.20.4" = _tuS74YmM;
        "pkg-fabric-2.1.0-mc1.20.1" = _YXxzfT2a;
        "pkg-forge-2.1.0-mc1.20.1" = _ry7t39fl;
        "pkg-fabric-2.1.0-mc1.20.4" = _eCVcia1i;
        "pkg-forge-2.1.0-mc1.20.4" = _WV0JY3gP;
        "pkg-neoforge-2.1.0-mc1.20.4" = _Nu8sDOz7;
        "pkg-fabric-2.1.0-mc1.20.6" = _IorlCLxc;
        "pkg-neoforge-2.1.0-mc1.20.6" = _8PjyFpRM;
        "pkg-fabric2.1.1-mc1.20.6" = _T7ESyDyO;
        "pkg-forge-2.1.1-mc1.20.6" = _tXcwp5En;
        "pkg-neoforge-2.1.1-mc1.20.6" = _lv3zkKlr;
        "pkg-fabric-2.1.2-mc1.20.6" = _8N4d7uRM;
        "pkg-forge-2.1.2-mc1.20.6" = _xciJhfUF;
        "pkg-neoforge-2.1.2-mc1.20.6" = _nS06OLYJ;
        "pkg-fabric-2.1.3-mc1.20.1" = _KLFf6PpA;
        "pkg-forge-2.1.3-mc1.20.1" = _DW4je0EN;
        "pkg-fabric-2.1.3-mc1.20.6" = _g0FjAYWn;
        "pkg-forge-2.1.3-mc1.20.6" = _L4yjUmBm;
        "pkg-neoforge-2.1.3-mc1.20.6" = _CO7Lq21v;
        "pkg-fabric-2.1.4-mc1.20.6" = _KGG6fy7N;
        "pkg-forge-2.1.4-mc1.20.6" = _1nyMZwaI;
        "pkg-neoforge-2.1.4-mc1.20.6" = _Pc9NoX06;
        "pkg-fabric-2.1.5-mc1.21" = _tbzPiOQy;
        "pkg-forge-2.1.5-mc1.21" = _es55v6SN;
        "pkg-neoforge-2.1.5-mc1.21" = _7nuaemwY;
        "pkg-fabric-2.1.6-mc1.21" = _f50pNkNh;
        "pkg-forge-2.1.6-mc1.21" = _NonQRvEa;
        "pkg-neoforge-2.1.6-mc1.21" = _WwXQtETI;
        "pkg-fabric-2.1.6-mc1.21.1" = _h21eIeqK;
        "pkg-forge-2.1.6-mc1.21.1" = _yHsVW0xn;
        "pkg-neoforge-2.1.6-mc1.21.1" = _E5SznCWs;
        "pkg-fabric-2.1.7-mc1.21.3" = _6GZP47X2;
        "pkg-neoforge-2.1.7-mc1.21.3" = _KpLaLO42;
        "pkg-fabric-2.2.0-mc1.21.1" = _wbu3DZME;
        "pkg-forge-2.2.0-mc1.21.1" = _kg9mDy8L;
        "pkg-neoforge-2.2.0-mc1.21.1" = _9Jqzdtew;
        "pkg-fabric-2.2.0-mc1.21.3" = _7dTEtPKW;
        "pkg-forge-2.2.0-mc1.21.3" = _OQB9eaMG;
        "pkg-neoforge-2.2.0-mc1.21.3" = _Qo4n7A9v;
        "pkg-fabric-2.2.1-mc1.21.1" = _V6q02QPT;
        "pkg-forge-2.2.1-mc1.21.1" = _Mt684MBZ;
        "pkg-neoforge-2.2.1-mc1.21.1" = _bMwjxpyK;
        "pkg-fabric-2.2.1-mc1.21.4" = _FiMM9HPA;
        "pkg-forge-2.2.1-mc1.21.4" = _RFjesqgN;
        "pkg-neoforge-2.2.1-mc1.21.4" = _AnXESehr;
        "pkg-fabric-2.2.2-mc1.21.4" = _o2Yh8wg9;
        "pkg-forge-2.2.2-mc1.21.4" = _KRctr98J;
        "pkg-neoforge-2.2.2-mc1.21.4" = _RyWcGlgI;
        "pkg-fabric-2.2.3-mc1.21.5" = _ktpNQJ54;
        "pkg-neoforge-2.2.3-mc1.21.5" = _Gz0wj9BP;
        "pkg-fabric-2.2.4-mc1.21.5" = _lNYkKDdZ;
        "pkg-forge-2.2.4-mc1.21.5" = _hsoDmQCb;
        "pkg-neoforge-2.2.4-mc1.21.5" = _eXdzhr5v;
        "pkg-fabric-2.3.0-mc1.21.1" = _GQHtLM3G;
        "pkg-forge-2.3.0-mc1.21.1" = _7EAWqQ9i;
        "pkg-neoforge-2.3.0-mc1.21.1" = _WjAccruu;
        "pkg-fabric-2.3.0-mc1.21.4" = _bUM1pEYH;
        "pkg-forge-2.3.0-mc1.21.4" = _yWwSiMOt;
        "pkg-neoforge-2.3.0-mc1.21.4" = _lsOtBU0G;
        "pkg-fabric-2.3.0-mc1.21.5" = _1YMOmVBz;
        "pkg-forge-2.3.0-mc1.21.5" = _uJLKJ9yl;
        "pkg-neoforge-2.3.0-mc1.21.5" = _dwXQZtCr;
        "pkg-fabric-2.3.0-mc1.21.6" = _IPfamyba;
        "pkg-neoforge-2.3.0-mc1.21.6" = _DnLMhF2r;
        "pkg-fabric-2.3.0-mc1.21.7" = _NyJu8VX5;
        "pkg-neoforge-2.3.0-mc1.21.7" = _vHNz8Ase;
        "pkg-fabric-2.3.0-mc1.21.8" = _ooJl5N0U;
        "pkg-neoforge-2.3.0-mc1.21.8" = _jPlVofif;
        "pkg-fabric-2.3.1-mc1.21.1" = _sfkuLHyi;
        "pkg-forge-2.3.1-mc1.21.1" = _PXMTRAq7;
        "pkg-neoforge-2.3.1-mc1.21.1" = _tsu9b2K9;
        "pkg-fabric-2.3.1-mc1.21.4" = _lguXwNOL;
        "pkg-forge-2.3.1-mc1.21.4" = _CEYvWZpn;
        "pkg-neoforge-2.3.1-mc1.21.4" = _z4cdcE4H;
        "pkg-fabric-2.3.1-mc1.21.5" = _JkzmUJHL;
        "pkg-forge-2.3.1-mc1.21.5" = _jPYPBCHa;
        "pkg-neoforge-2.3.1-mc1.21.5" = _Il0QNyrO;
        "pkg-fabric-2.3.1-mc1.21.8" = _3qVFW34g;
        "pkg-neoforge-2.3.1-mc1.21.8" = _Nmc8N4BO;
        "pkg-fabric-2.3.1-mc1.21.9" = _v1dwhTYp;
        "pkg-neoforge-2.3.1-mc1.21.9" = _RyYXefSs;
        "pkg-fabric-2.3.1-mc1.21.10" = _iDY9z8PQ;
        "pkg-neoforge-2.3.1-mc1.21.10" = _Om9xaoDd;
        "pkg-fabric-2.3.1-mc1.21.11" = _Dt6CV64u;
        "pkg-neoforge-2.3.1-mc1.21.11" = _BGEBG0ay;
        "pkg-fabric-2.4.0-mc1.21.11" = _i62tulJa;
        "pkg-neoforge-2.4.0-mc1.21.11" = _1hr3mBSY;
        "pkg-fabric-2.4.1-mc26.1.2" = _vudH2Rjv;
