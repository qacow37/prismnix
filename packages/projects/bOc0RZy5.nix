...
let
    ...
    in {
        ...
        "pkg-712w04a" = _CSxf54vz;
        "pkg-712w05a" = _7plPKJwE;
        "pkg-712w06a" = _85MaH32r;
        "pkg-712w07a" = _8E35IzCR;
        "pkg-712w08a-xlgm" = _sCC5ffGe;
        "pkg-712w08a-xyjz" = _F5AIbAWv;
        "pkg-712w09a-xlgm" = _4MKsblkW;
        "pkg-712w09a-xyjz" = _XFTYHsmB;
        "pkg-712w10a-pre1" = _4CbQGNgz;
        "pkg-712w10a-pre2" = _juc5a6YV;
        "pkg-712w10a" = _XEFJMPOg;
        "pkg-712w10b" = _x8Zss7Um;
        "pkg-712w11a" = _iKZHiMi2;
        "pkg-712w12a" = _qSNVaHuS;
        "pkg-712w12b" = _qbb236xj;
        "pkg-712w13a" = _U34DxhhD;
        "pkg-712w14a" = _ha1VfxZm;
        "pkg-712w14b" = _cMKv27CG;
        "pkg-712w26.1-snapshot-2" = _7IeuxG73;
        "pkg-712w26.1" = _LuqH6C7M;
        "pkg-712w26.1.1" = _ULhLgaJU;
        "pkg-712w26.2-snapshot-1" = _zm2ZFhS1;
        "pkg-712w26.2" = _XVXU4Doa;
        "default" = _XVXU4Doa;
    });
