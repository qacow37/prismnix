...
let
    ...
    in {
        ...
        "pkg-1.19.2-5.1.0.1" = _DVeGrPzl;
        "pkg-1.19-5.0.1.8" = _huVmO7Sq;
        "pkg-1.18.2-4.3.1.4" = _7hgs7eZD;
        "pkg-1.18.1-4.0.1.0" = _tzSJ0FlH;
        "pkg-1.17.1-3.0.5.3" = _3ageTTO3;
        "pkg-1.16.5-2.0.8.22" = _x3rc8Dea;
        "pkg-1.16.4-2.0.4.3" = _I6kxYwMJ;
        "pkg-1.16.3-2.0.1.2" = _g1lZ4XFX;
        "pkg-1.12.2-1.7.3.4" = _bgjYJFZ1;
        "pkg-1.11.2-1.5.4.0" = _E8l3yott;
        "pkg-1.10.2-1.4.5.1" = _sokef9hC;
        "pkg-1.8.9-1.2.5.2" = _DtDaZSuV;
        "pkg-1.7.10-1.1.1.3" = _xX01JAyU;
        "pkg-1.7.10-2.0.0" = _DSHomo4J;
        "pkg-1.19.2-5.1.0.2" = _akHYfjAe;
        "pkg-1.19-5.0.1.9" = _eo9mIIQy;
        "pkg-1.20.1-6.0.0.3" = _gK8ubYXE;
        "pkg-1.20.1-6.0.0.6" = _Gnxk7Y7H;
        "pkg-1.20.1-6.0.0.7" = _XvSvzLni;
        "pkg-1.20.1-6.0.1.0" = _gnGf7GAJ;
        "pkg-1.20.1-6.0.1.1" = _XNm5IqBE;
        "pkg-1.20.1-6.0.1.2" = _BgMT8cxQ;
        "pkg-1.20.6-7.0.1.5" = _GACSVdFv;
        "pkg-1.20.6-7.0.2.1" = _s3bWQxCo;
        "pkg-1.20.6-7.0.3.0" = _1S9P1u9Q;
        "pkg-1.20.6-7.0.3.1" = _OhHheLL1;
        "pkg-1.20.6-7.0.3.2" = _as1a7IC8;
        "pkg-1.20.6-7.0.3.5" = _f7nBhuYS;
        "pkg-1.20.6-7.0.4.0" = _lGlJ8GYx;
        "pkg-1.20.6-7.0.4.2" = _55z5BsmM;
        "pkg-1.20.6-7.0.5.0" = _tTyQmQHI;
        "pkg-1.20.6-7.0.5.3" = _NXMUlakx;
        "default" = _NXMUlakx;
    });
