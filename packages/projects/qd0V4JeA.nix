...
let
    ...
    in {
        ...
        "pkg-1.3-mc1.18.2" = _6Ns6W0Y5;
        "pkg-1.5.0+mc1.21" = _r1FTKY06;
        "pkg-1.6.0+mc1.21" = _tYaB2rax;
        "pkg-1.7.0+mc1.21.6" = _RoeBeilF;
        "pkg-1.7.1+mc1.21.6" = _PEaTI8gq;
        "pkg-1.8.0+mc1.21.6" = _CslCDPSw;
