...
let
    ...
    in {
        ...
        "pkg-0.8.0-4+forge-1.19" = _jmKnsKLV;
        "pkg-0.8.0-4+fabric-1.19" = _VwmyBiDA;
        "pkg-0.9.0-1+forge-1.20" = _NFxldQKC;
        "pkg-0.9.0-1+fabric-1.20" = _sBJVykLz;
        "pkg-1.0.0+1.19" = _AkSDsM9l;
        "pkg-1.0.0+1.20" = _w9Rna7JF;
        "pkg-1.0.1+1.19" = _1hy0PkwH;
        "pkg-1.0.1+1.20" = _a8RRbcKA;
        "pkg-1.1.0+1.19" = _gLzaGg1i;
        "pkg-1.1.0+1.20" = _TJp7Re3p;
        "pkg-1.1.1+1.19" = _BL3pFIvu;
        "pkg-1.1.1+1.20" = _F7pkC2OZ;
        "pkg-1.1.2+1.19" = _ZfLYPWol;
        "pkg-1.1.2+1.20" = _puAhDoH9;
        "pkg-1.1.3+1.19" = _Rh6q7ePV;
        "pkg-1.1.3+1.20" = _CJxhWhhv;
        "pkg-1.1.4+1.19" = _ofAoD66g;
        "pkg-1.1.4+1.20" = _Dtza4204;
        "pkg-1.2.0+1.19" = _vQzJ1EjO;
        "pkg-1.2.0+1.20" = _tg8SQ6SV;
        "pkg-1.3.0+1.19" = _36LllmXT;
        "pkg-1.3.0+1.20" = _9nVgd2cR;
        "pkg-1.4.0+1.19" = _tzPKesUb;
        "pkg-1.4.0+1.20" = _Numb0F7v;
        "pkg-1.4.1+1.19" = _1LM5i0Tw;
        "pkg-1.4.1+1.20" = _wMJ3AVde;
        "pkg-1.4.2+1.19" = _92mXdK61;
        "pkg-1.4.2+1.20" = _EB5pbWCN;
        "pkg-1.4.3+1.19" = _SzzAe6KM;
        "pkg-1.4.3+1.20" = _aotdezQJ;
        "pkg-2.0.0+1.20" = _DhC3Uy0k;
        "pkg-2.1.0+1.20" = _axrw6xrL;
        "pkg-2.2.0+1.20" = _hQJUfNG8;
        "pkg-2.2.1+1.20" = _whjccHyO;
        "pkg-2.2.2+1.20" = _SU4M7D42;
        "pkg-2.2.3+1.20" = _6r7RlLaW;
        "pkg-2.3.0+1.20" = _XY93vFiG;
        "pkg-2.4.0+1.20" = _UBb2Texi;
        "pkg-2.5.0+1.20" = _Yq2RlgBa;
        "pkg-2.6.0+1.20" = _D2tCwaT4;
        "pkg-2.7.0+1.20" = _E7xoWQpk;
        "pkg-2.7.1+1.20" = _bfUBWdHY;
        "pkg-2.7.2+1.20" = _a4NKDiey;
        "pkg-2.7.3+1.20" = _n9Ledyqg;
        "pkg-2.8.0+1.20" = _hBZaYtWJ;
        "pkg-2.8.1+1.20" = _tWI2JCWn;
        "pkg-2.8.2+1.20" = _pR64eYUW;
        "pkg-2.9.0+1.20" = _YROwSnGN;
        "pkg-2.9.1+1.20" = _nZQkQWf8;
        "pkg-2.9.2+1.20" = _IaIVlBC2;
        "pkg-2.9.3+1.20" = _LY1k4mlA;
        "pkg-2.9.4+1.20" = _oITpe89T;
        "pkg-2.9.4+1.21" = _PFV3hkkv;
        "pkg-2.9.5+1.20" = _3Xx431eD;
        "pkg-2.9.5+1.21" = _L5AGS829;
        "pkg-2.9.6+1.20" = _pQazZrWd;
        "pkg-2.9.6+1.21" = _R5kEq9pT;
        "pkg-2.9.7+1.20" = _fhFvrYdg;
        "pkg-2.9.8+1.20" = _fY6NXQdq;
        "pkg-2.9.8+1.21" = _VZB8t2Mg;
        "pkg-2.9.9+1.20" = _puUhvgHM;
        "pkg-2.9.9+1.21" = _QxPVFKsw;
        "pkg-2.9.10+1.20" = _tg171Xsl;
        "pkg-2.9.10+1.21" = _J4ywHAw8;
        "pkg-2.9.11+1.20" = _4ZrQ1yW1;
        "pkg-2.9.11+1.21" = _HjVkSyfh;
        "pkg-2.9.12+1.20" = _F5bMEgOe;
        "pkg-2.9.12+1.21" = _ckTy9ATl;
        "pkg-2.9.13+1.20" = _x4gOhuty;
        "pkg-2.9.13+1.21" = _UAmzVuph;
        "pkg-2.9.14+1.20" = _2Im4plHI;
        "pkg-2.9.14+1.21" = _fjF41vAO;
        "pkg-2.9.15+1.21" = _Y5R1H6eo;
        "pkg-2.9.16+1.21" = _gfZDTATa;
        "pkg-2.9.17+1.20" = _9Olt7kwm;
        "pkg-2.9.17+1.21" = _pAIARq00;
        "pkg-2.10.0+1.20" = _lFYHSK5X;
        "pkg-2.10.0+1.21" = _lBjCM3kU;
        "pkg-2.10.1+1.20" = _5mJvK4sc;
        "pkg-2.10.1+1.21" = _HMgMkIP1;
        "pkg-2.11.0+1.20" = _GMkWhENa;
        "pkg-2.11.0+1.21" = _1oR4wCD0;
        "pkg-2.11.1+1.20" = _YCVj1dCz;
        "pkg-2.11.1+1.21" = _Czov6frI;
        "pkg-2.11.2+1.20" = _r8e868KR;
        "pkg-2.11.2+1.21" = _ukm2ktTw;
        "pkg-2.12.0+1.20" = _ddJjxF5n;
        "pkg-2.12.0+1.21" = _utFwd9ms;
        "pkg-3.0.0+1.20" = _XucqxdO3;
        "pkg-3.0.0+1.21" = _mLTFQAkS;
        "pkg-3.1.0+1.20" = _74pAgjG1;
        "pkg-3.1.0+1.21" = _LevfNEph;
        "pkg-3.1.1+1.20" = _8F1hrMpk;
        "pkg-3.1.1+1.21" = _1hx9KIr0;
        "pkg-3.1.2+1.20" = _yIV6zMoy;
        "pkg-3.1.2+1.21" = _2sDsTAId;
        "default" = _2sDsTAId;
    });
