...
let
    ...
    in {
        ...
        "pkg-v.1.5.5" = _4AId9oPO;
        "pkg-v.1.5.7" = _8NP2tLTv;
        "pkg-v.2.1.2" = _ZCXHDr9f;
        "pkg-v.2.2.0" = _8AFqw41j;
        "pkg-v.2.2.3" = _c51ARAkA;
        "pkg-v.2.2.4" = _v5wtiu5k;
        "pkg-v.2.2.5" = _d4kCsEFZ;
        "pkg-v.2.3.0" = _MOCeG4cF;
        "pkg-v.2.4.0" = _ZuRsXmaa;
        "pkg-v.2.4.1" = _7XRAAQwm;
        "pkg-v.2.4.2" = _3wx3KRjp;
        "pkg-v.2.3.1" = _UWolTOfn;
        "pkg-v.2.2.6" = _lyFyN0x2;
        "pkg-v.2.2.4a" = _AVtu3sor;
        "pkg-v.2.2.3a" = _r69P9MsS;
        "pkg-v.2.2.0a" = _w86PWFNj;
        "pkg-v.2.2.3b" = _TiozyUTa;
        "pkg-v.2.3.2" = _8ZZs9D5i;
        "pkg-v.2.4.3" = _CX0wcUho;
        "pkg-v.3.0.0" = _3UR6oqTP;
        "pkg-v.3.0.1" = _dJ0NBtpl;
        "pkg-v.3.0.2" = _gwt6lyD7;
        "pkg-v.4.0.0" = _Hyo5uXzr;
        "pkg-v.3.0.3" = _fVNZCGcW;
        "pkg-v.4.1.0" = _GcUWYL9K;
        "pkg-v.4.2.0" = _cohmUVLS;
        "pkg-v.5.0.0" = _9L62FLe3;
        "pkg-v.5.1.0" = _QMp97KxJ;
        "pkg-v.5.2.0" = _2rluoQBv;
        "pkg-v.5.3.0" = _R8HtRCmE;
        "pkg-v.5.4.0" = _qtm3JULV;
        "pkg-v.5.5.0" = _McoABk5r;
        "pkg-v.5.5.1" = _dYi50axT;
        "pkg-v.6.0.0" = _rLmdmWM0;
        "pkg-v.6.1.0" = _qhuljEVr;
        "pkg-v.6.1.1" = _bnQKcNnA;
        "pkg-v.6.1.2" = _WBV0d50U;
        "pkg-v.6.2.0" = _TYIa1fJg;
        "pkg-v.6.3.0" = _JW9cMZoL;
        "default" = _JW9cMZoL;
    });
