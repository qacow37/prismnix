...
let
    ...
    in {
        ...
        "pkg-0.1-1.20.1" = _ECYKSqg4;
        "pkg-v0.2" = _yMmjEyNB;
        "pkg-0.2-hotfix" = _ndnQ6thV;
        "pkg-0.3" = _BD6e90jQ;
        "pkg-0.4" = _o5emOzDi;
        "pkg-0.4-1.20.x" = _HriQgpzB;
        "pkg-0.4.1-1.19.2" = _rA4pGO1R;
        "pkg-0.4.1-1.20.x" = _FFtk4Enh;
        "pkg-0.4.1-mc1.19.2-fabric" = _9KPnoeeH;
        "pkg-0.4.2-mc1.19.2" = _zrFdIRHB;
        "pkg-0.4.3-mc1.20.x" = _uvnfNUsp;
        "pkg-0.4.3-mc1.19.2" = _S4AoKm70;
        "pkg-0.4.4-mc1.19.2-fabric" = _aP2tFPwc;
        "pkg-0.4.4-1.19.2-forge" = _zgdMDJ9K;
        "pkg-0.4.4-mc1.20.x-fabric" = _u5lJsgAe;
        "pkg-0.4.4-hotfix+mc1.20.1" = _qZxVwvcx;
        "pkg-0.4.5-mc1.20.1-fabric" = _m0GUubvz;
        "pkg-0.4.1-mc.1.18.2" = _eUPBuLLJ;
        "pkg-0.4.5-1.20.x" = _kW8DoegV;
        "pkg-v0.4.5-1.21.1" = _VIF3aQsw;
        "pkg-v0.4.6-mc1.21.1" = _lJSs0H26;
        "pkg-v0.4.7-1.21.1" = _w0mifib8;
        "default" = _w0mifib8;
    });
