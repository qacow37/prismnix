...
let
    ...
    in {
        ...
        "pkg-1.7.10-35.4.2" = _nXZFNBJw;
        "pkg-1.12.2-35.4.2" = _HBsJYI0H;
        "pkg-1.7.10-35.4.2.1" = _rwOPbQiZ;
        "pkg-1.12.2-35.4.2.1" = _naVnQCLK;
        "pkg-1.7.10-35.4.2.2" = _6gxewPm3;
        "pkg-1.12.2-35.4.2.2" = _znmC7VV1;
        "pkg-1.7.10-35.4.2.4" = _Ei7Ztjb2;
        "pkg-1.12.2-35.4.2.4" = _vIwRZ6kf;
        "pkg-1.7.10-35.4.3" = _CKQrNJKq;
        "pkg-1.12.2-35.4.3" = _Lavf9mJh;
        "pkg-1.7.10-35.4.4" = _nnyDF7Gd;
        "pkg-1.12.2-35.4.4" = _kavdpvEo;
        "pkg-1.7.10-35.4.5" = _Iwnl1FCo;
        "pkg-1.12.2-35.4.5" = _74eqoInM;
        "pkg-1.7.10-35.4.6" = _zyIFTDUI;
        "pkg-1.12.2-35.4.6" = _u6NbTzkL;
        "pkg-1.7.10-35.4.7" = _3WBCx6r6;
        "pkg-1.12.2-35.4.7" = _7s1IKWqg;
        "pkg-1.7.10-35.4.8" = _McIkr6Bz;
        "pkg-1.12.2-35.4.8" = _FySvjdtl;
        "pkg-1.7.10-36" = _vnekGdjF;
        "pkg-1.12.2-36" = _8AjZMfvG;
        "pkg-1.7.10-36.0.1" = _uC0HAPwp;
        "pkg-1.12.2-36.0.1" = _IEb5FUk2;
        "default" = _IEb5FUk2;
    });
