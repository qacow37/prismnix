...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _BgKPOJVt;
        "pkg-1.0.9" = _Edsce9xz;
        "pkg-1.0.10" = _JZBAcqDE;
        "pkg-1.0.11" = _YzOIkD1k;
        "pkg-1.0.12" = _kLXg747l;
        "pkg-1.1.0" = _dXwuNo2r;
        "pkg-1.1.1" = _bgtGVKfP;
        "pkg-1.1.2" = _cp7OIssP;
        "pkg-1.1.3" = _bRKdPYMl;
        ...
        "pkg-1.1.6" = _HvnTVlTJ;
        "pkg-1.1.7" = _HGrksius;
        "pkg-1.1.7.1" = _mzuXxAgf;
        "pkg-1.1.8" = _1g3ivUKb;
        "pkg-1.1.9" = _7wzvs8Uh;
        "pkg-1.1.10" = _7fLBkJrE;
        "pkg-1.0.13" = _YvQmuZ7X;
        "pkg-1.1.11" = _HHnnyfd4;
        "pkg-1.1.12" = _d0c3K40E;
        "pkg-1.0.14" = _sMjnKy5B;
        "pkg-1.1.13" = _A4mI6Dod;
        "pkg-1.1.14" = _W7fZ5V8c;
        "pkg-1.1.15" = _zdEcLypF;
        "pkg-1.1.16" = _UoFFFLI3;
        "pkg-1.1.17" = _DrUV0jjs;
        "pkg-1.1.19" = _qX1zPH9h;
        "pkg-1.1.20" = _Hxpi9281;
