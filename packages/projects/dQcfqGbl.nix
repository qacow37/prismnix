...
let
    ...
    in {
        ...
        "pkg-0.0.2.1-alpha" = _trBUG3L5;
        "pkg-0.0.2.2-alpha" = _wHrWQ4xY;
        "pkg-0.0.2.3-alpha" = _4rGx6ELS;
        "pkg-0.0.2.4-alpha" = _do3p32dF;
        "pkg-0.0.2.5-alpha" = _nnogfhIm;
        "pkg-1.20.4-0.0.2.6-alpha" = _8zJOv8da;
        "pkg-1.20.4-0.0.3.0-beta" = _x7Wbw9us;
        "pkg-1.20.2-0.0.3.0-beta" = _m3o5TWWF;
        "pkg-1.20.4-0.0.3.1-beta" = _jtqYkmcT;
        "pkg-1.20.4-0.0.3.2-beta" = _DL8Tyoh4;
        "pkg-1.20.4-0.0.3.3-beta" = _MN2npcEf;
        "pkg-1.20.4-0.0.3.4-beta" = _crLKLkfF;
        "pkg-1.20.4-0.0.3.5-beta" = _vyp0Bhfv;
        "pkg-1.20.2-0.0.3.5-beta" = _w0ISh7VW;
        "pkg-1.20.2-0.0.3.6-beta" = _I2PdDtm7;
        "pkg-1.19.4-0.0.3.6-beta" = _NsFNbPJZ;
        "pkg-1.19.2-0.0.3.6-beta" = _LFuRzWFL;
        "pkg-1.19.2-0.0.3.7-beta" = _y0TcmvEu;
        "pkg-1.18.2-0.0.3.7-beta" = _z9SAztsT;
        "pkg-0.4.0-beta" = _wF3xJPSW;
        "pkg-0.5.0-beta" = _7bFJiLPK;
        "pkg-0.5.1-beta" = _CqFB56iD;
        "pkg-0.5.2-beta" = _TPoAfDnB;
        "pkg-0.5.3-beta" = _S5kfcBNg;
        "pkg-0.5.4-beta" = _TS0nO2rb;
        "pkg-0.5.5-beta" = _viV4lWPM;
        "pkg-0.5.6-beta" = _ZCuLEHfX;
        "pkg-0.5.7-beta" = _QJ3pday0;
        "pkg-0.5.8-beta" = _nPOPx9Ji;
        "pkg-0.5.9-beta" = _j954ic5S;
        "pkg-1.0.0" = _XOpQKdJn;
        "pkg-1.1.0" = _oD0BXMcV;
        "pkg-1.1.1" = _djiqlqk0;
        "pkg-1.1.2" = _EfcSwuSz;
