...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.0.2" = _fpLPwA6O;
        "pkg-1.19.2-1.0.2" = _7aodQbZU;
        "pkg-1.20.1-1.0.2" = _F6eUKBkr;
        "pkg-1.20.1-1.0.3" = _hWPkQEyN;
        "pkg-1.16.5-1.0.4" = _ijwfVlaD;
        "pkg-1.19.2-1.0.4" = _H38DopHs;
        "pkg-1.20.1-1.0.4" = _qSgUyZRJ;
        "pkg-1.16.5-1.0.5" = _CrJHXRaP;
        "pkg-1.19.2-1.0.5" = _vCb9icZN;
        "pkg-1.20.1-1.0.5" = _uRQglqBE;
        "pkg-1.18.2-1.0.5" = _LRu8uCKq;
        "pkg-1.20.1-1.0.7" = _cW2ukofE;
        "pkg-1.19.2-1.0.6" = _HtUwpZGz;
        "pkg-1.19.2-1.0.7" = _9dMBjDfj;
        "pkg-1.16.5-1.0.8" = _BV5rSTE0;
        "pkg-1.18.2-1.0.8" = _sbEEmxfa;
        "pkg-1.19.2-1.0.8" = _lEbJPn3a;
        "pkg-1.20.1-1.0.8" = _dqLcEZrn;
        "pkg-1.16.5-1.1.0" = _g1r4G5ka;
        "pkg-1.16.5-1.1.1" = _B4ZlsK8Z;
        "pkg-1.16.5-1.1.2" = _LluqUEBo;
        "pkg-1.16.5-1.1.3" = _2clP5t9Z;
        "pkg-1.16.5-1.1.4" = _2p4Ehlvm;
        "pkg-1.16.5-1.1.5" = _4Tdj8qWr;
        "pkg-1.20.1-1.1.5" = _IzF23v9s;
        "pkg-1.20.1-1.1.6" = _JNaGIiYv;
        "pkg-1.20.1-1.1.7" = _S7RGb3OL;
        "pkg-1.20.1-1.1.8" = _kXAE6cCu;
        "pkg-1.1.9" = _kLYoEuB2;
        "pkg-1.20.1-1.2.0" = _EMghLVvE;
        "pkg-1.20.1-1.2.1" = _YSbKsdxV;
        "pkg-1.20.1-1.2.2" = _a3MrvrA5;
        "pkg-1.16.5-1.2.2" = _GOoGFX3I;
        "pkg-1.20.1-1.2.3" = _aPMQHPwy;
        "pkg-1.20.1-1.2.4" = _IvkwfAN8;
        "pkg-1.20.1-1.2.5" = _RFVm8UC7;
        "pkg-1.3.2" = _UCsbIJX7;
        "pkg-1.3.3" = _SIO7DRtm;
        "default" = _SIO7DRtm;
    });
