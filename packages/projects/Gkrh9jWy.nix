...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.19.2" = _Et6m5BCf;
        "pkg-1.0.0-1.19.3" = _FVigGp95;
        "pkg-1.0.0-1.19.4" = _wSV8gPg7;
        "pkg-1.0.0-1.20" = _g6d9doqS;
        "pkg-1.0.0-1.20.1" = _Pjl2g68q;
        "pkg-1.0.0-1.21.1" = _1ggkyeD4;
        "pkg-1.0.0-1.19.4-ht" = _DV7331TF;
        "pkg-1.0.0-1.20-hf" = _px6YOI6O;
        "pkg-1.0.0-1.20.1-hf" = _eB1ivU8C;
        "pkg-1.0.0-1.21.1-hf" = _Y4xgNekm;
        "pkg-2.0.0-1.19.2" = _vsMhbshd;
        "pkg-2.0.0-1.19.3" = _QWNBNYUt;
        "pkg-2.0.0-1.19.4" = _B5nZ6ou4;
        "pkg-2.0.0-1.20" = _L9FoEdVW;
        "pkg-2.0.0-1.20.1" = _3DP2JAbB;
        "pkg-2.0.0-1.21.1" = _txUAfZVs;
        "pkg-2.0.1-1.19.2" = _TLzHQmST;
        "pkg-2.0.1-1.19.3" = _3AFYWInU;
        "pkg-2.0.1-1.19.4" = _tMs0zmSJ;
        "pkg-2.0.1-1.20" = _4lKhvuoM;
        "pkg-2.0.1-1.20.1" = _tLlmFXaC;
        "pkg-2.0.1-1.21.1" = _Gw8iUh0u;
        "pkg-3.0.0-1.19.2" = _4CwvDvNK;
        "pkg-3.0.0-1.19.3" = _uL1kEjZr;
        "pkg-3.0.0-1.20.1" = _bWBnwonV;
        "pkg-3.0.0-1.21.1" = _6YCKIx5b;
        "pkg-3.0.1-1.19.2" = _RvjMRNQ3;
        "default" = _RvjMRNQ3;
    });
