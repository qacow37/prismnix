...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _AR82pROt;
        "pkg-1.2.0" = _MCN5iNdc;
        "pkg-1.3.0-beta" = _J5Ms8IIB;
        "pkg-1.4.0-alpha" = _6kMnUVwX;
        "pkg-1.4.0-alpha.2" = _lCZWPZWR;
        "pkg-1.4.0-alpha.3" = _zpM6D9az;
        "pkg-1.4.0-super-evil-alpha.4" = _fqNsLk4c;
        "pkg-1.4.1-beta.1" = _gcGqwtyo;
        "default" = _gcGqwtyo;
    });
