...
let
    ...
    in {
        ...
        "pkg-1.18.2-0-fabric" = _ej3vz1DG;
        "pkg-1.18.2-0-forge" = _KDjOrYWr;
        "pkg-1.19.2-0-fabric" = _GNWn8djb;
        "pkg-1.19.2-0-forge" = _FfR915bv;
        "pkg-1.19.4-0-fabric" = _QMURt07o;
        "pkg-1.19.4-0-forge" = _MYSlpxBp;
        "pkg-1.20-0-fabric" = _zggZEZ2K;
        "pkg-1.20-0-forge" = _dVfk0zu1;
        "pkg-1.20.1-0-fabric" = _fhEwm1lu;
        "pkg-1.20.1-0-forge" = _VLW3ceDe;
        "pkg-1.20.2-0-neoforge" = _e5KXNRH0;
        "pkg-1.20.2-0-fabric" = _grBx3Z56;
        "pkg-1.20.2-0-forge" = _ZfmiOAAs;
        "pkg-1.20.4-0-neoforge" = _1oxurjjm;
        "pkg-1.20.4-0-fabric" = _6pOGtplO;
        "pkg-1.20.4-0-forge" = _BxOLY3MU;
        "pkg-1.20.6-0-neoforge" = _89zuXVFp;
        "pkg-1.20.6-0-fabric" = _YBk3EyRf;
        "pkg-1.20.6-0-forge" = _bBHt5c5K;
        "pkg-1.21.1-0-neoforge" = _wV0bR3Ug;
        "pkg-1.21.1-0-fabric" = _IosL7Skz;
        "pkg-1.21.1-0-forge" = _piOCtAjc;
        "default" = _piOCtAjc;
    });
