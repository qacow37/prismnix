...
let
    ...
    in {
        ...
        "pkg-0.2.9-1.21.4" = _tfwirg8v;
        "pkg-0.2.9-1.21.1" = _6l0cO4UO;
        "pkg-0.2.9-1.20.6" = _7tZokWaR;
        "pkg-0.2.10-1.20.2" = _CkC2UyLP;
        "pkg-0.2.10-1.21.1" = _FB1LotKH;
        "pkg-0.2.11-1.21.1" = _x0VxmW6f;
        "pkg-0.2.11-1.20.6" = _62Jmgymy;
        "pkg-0.2.11-1.20.2" = _ELir8BnN;
        "pkg-0.2.12-1.21.4" = _d3SYIj57;
        "pkg-0.2.13-1.21.4" = _txHfs7uI;
        "pkg-0.2.12-1.21.1" = _fozbd8hS;
        "pkg-0.2.14-1.21.4" = _uvIutS34;
        "pkg-0.2.14-1.21.1" = _dC5N38u0;
        "pkg-0.2.15-1.20.6" = _mfR2FC3G;
        "pkg-0.2.16-1.21.4" = _E3vCPksb;
        "pkg-0.2.18-1.21.4" = _jn3RvLAT;
        "pkg-0.2.18-1.21.1" = _us4DAHzc;
        "pkg-0.2.19-1.21.4" = _3EE85Hln;
        "pkg-0.2.19-1.21.1" = _3hHcy4hV;
        "pkg-0.2.20-lite-1.20.1" = _kPodu6lT;
        "pkg-0.2.20-lite-1.19.2" = _bAV3RjIN;
        "pkg-0.2.21-1.21.4" = _bXhNgQ8E;
        "pkg-0.2.20-1.21.1" = _ppmRjkMj;
        "pkg-0.2.22-1.21.4" = _3gYVskCK;
        "pkg-0.2.22-1.21.1" = _CMsFddh5;
        "pkg-0.2.23-1.21.4" = _L7ioIHc4;
        "pkg-0.2.23-1.21.1" = _P4TGV7np;
        "pkg-0.2.23.1-lite-1.20.1" = _LET8NtSp;
        "pkg-0.2.23-lite-1.19.2" = _mdchhwDB;
        "pkg-0.2.24-1.21.4" = _AQALbsMD;
        "pkg-0.2.25-1.21.9" = _3GOL1AKB;
        "pkg-0.2.24-lite-1.20.1" = _3OHXI5Fu;
        "pkg-0.2.24-1.18.2" = _d0xgYqbH;
        "pkg-0.2.25-1.20.1" = _K356ekrG;
        "pkg-0.2.26-1.21.9" = _pNgvew99;
        "pkg-0.2.27-1.21.9" = _KtWhSLPX;
        "pkg-0.2.27-1.20.1" = _BziBbWdf;
        "pkg-0.2.27-1.21.1" = _RtBVhKYW;
        "pkg-0.2.28-1.21.1" = _pnPd1p3K;
        "pkg-0.2.28-1.21.9" = _k8lfxTBM;
        "pkg-0.2.28.1-1.21.1" = _SUeOFygw;
        "pkg-0.2.28-1.20.1" = _3xHrqcJV;
        "pkg-0.2.28.2-1.20.1" = _e37D0ChM;
        "pkg-0.2.28.2-1.21.11" = _oXS0Sbmf;
        "pkg-0.2.28.2-1.21.9" = _u1tkguLk;
        "pkg-26.1.0-1.21.6" = _OqHWqtY5;
        "pkg-26.1.0-1.21.4" = _BbcP16Ho;
        "pkg-26.1.0-1.21.9" = _nGvrv1fN;
        "pkg-26.1.0-1.18.2" = _q3AEoaQY;
        "pkg-26.2.0-26.1" = _iiRvYzAg;
        "pkg-26.2.0-1.21.11" = _pT3q2YHm;
        "pkg-26.2.1-1.21.11" = _MgEswKWK;
        "pkg-26.2.1-26.1" = _g2mjhI0W;
        "pkg-26.1.0-1.20.1" = _zuPljrqA;
        "pkg-26.1.1-1.20.1" = _sEH8i7QQ;
        "pkg-26.3.0-26.1.2" = _1u8Xfrmd;
        "pkg-26.3.1-26.2" = _X90Hm6fM;
        "pkg-26.3.1-26.1.2" = _C9ZaT8Rm;
        "pkg-26.3.2-26.1.2" = _5JQ4Ovsk;
        "pkg-26.3.2-26.2" = _LZhWw0t7;
        "default" = _LZhWw0t7;
    });
