...
let
    ...
    in {
        ...
        "pkg-mc1.15.2-v2.0.0" = _Xy7mkBRa;
        "pkg-mc1.15.2-v2.1.0" = _q9TLx9jg;
        "pkg-mc1.16.5-v2.1.0" = _OXWCm9zg;
        "pkg-mc1.14.4-v2.1.0" = _F0Kxjfdc;
        "pkg-mc1.17.1-v2.1.0" = _zppWhDzg;
        "pkg-mc1.18.2-v2.1.0" = _DIfrYQlQ;
        "pkg-mc1.19-v2.1.0" = _Bzr5Oa1x;
        "pkg-mc1.15.2-v2.2.0" = _E9Af1lRR;
        "pkg-mc1.19.3-v2.2.0" = _cZaag0t9;
        "pkg-mc1.18.2-v2.2.0" = _41bB8zub;
        "pkg-mc1.17.1-v2.2.0" = _Ztk42SCj;
        "pkg-mc1.14.4-v2.2.0" = _R2TFf0gn;
        "pkg-mc1.16.5-v2.2.0" = _XkrVg0tH;
        "pkg-mc1.19.4-v2.2.1" = _Tbjaq3JG;
        "pkg-mc1.20-v2.2.1" = _zesG4AMA;
        "pkg-mc1.15.2-v2.2.1" = _iFSPnalz;
        "pkg-mc1.17.1-v2.2.1" = _KCJBP6dn;
        "pkg-mc1.14.4-v2.2.1" = _kaf3ghY2;
        "pkg-mc1.18.2-v2.2.1" = _GkTQbkYL;
        "pkg-mc1.16.5-v2.2.1" = _bB6HnEaM;
        "pkg-mc1.18.2-v2.3.0" = _aL2vndDh;
        "pkg-mc1.14.4-v2.3.0" = _dSzUOjR2;
        "pkg-mc1.20.2-v2.3.0" = _EIdfEzcy;
        "pkg-mc1.16.5-v2.3.0" = _REsgUkzx;
        "pkg-mc1.15.2-v2.3.0" = _8aQeCSwu;
        "pkg-mc1.17.1-v2.3.0" = _1uBFWdAj;
        "pkg-mc1.19.4-v2.3.0" = _fxjWJk2s;
        "pkg-mc1.15.2-v2.3.1" = _3BKKVaUe;
        "pkg-mc1.18.2-v2.3.1" = _4NNZ21Fj;
        "pkg-mc1.20.4-v2.3.1" = _N9qCI38i;
        "pkg-mc1.17.1-v2.3.1" = _nLbE2PD0;
        "pkg-mc1.16.5-v2.3.1" = _p2lXsK4D;
        "pkg-mc1.19.4-v2.3.1" = _LIkcnnqy;
        "pkg-mc1.14.4-v2.3.1" = _t1U1zJlC;
        "pkg-mc1.21-v2.3.2" = _IbxSAvSX;
        "pkg-mc1.16.5-v2.3.2" = _UfArEFnv;
        "pkg-mc1.15.2-v2.3.2" = _RkWd7lhg;
        "pkg-mc1.19.4-v2.3.2" = _BLi3EpE7;
        "pkg-mc1.20.6-v2.3.2" = _v85N4wvz;
        "pkg-mc1.18.2-v2.3.2" = _mHsnep5F;
        "pkg-mc1.17.1-v2.3.2" = _fEtmNJxS;
        "pkg-mc1.14.4-v2.3.2" = _kG1qXW4w;
        "pkg-mc1.14.4-v2.3.3" = _FXnSQldT;
        "pkg-mc1.17.1-v2.3.3" = _6njNt9VY;
        "pkg-mc1.20.6-v2.3.3" = _KxTV4agL;
        "pkg-mc1.18.2-v2.3.3" = _SZyY05KS;
        "pkg-mc1.16.5-v2.3.3" = _CjuQQZpw;
        "pkg-mc1.15.2-v2.3.3" = _aUCu6lN5;
        "pkg-mc1.21-v2.3.3" = _txhdksye;
        "pkg-mc1.19.4-v2.3.3" = _mSlZKDP9;
        "pkg-v2.3.4-mc1.20.6" = _iTEJaamc;
        "pkg-v2.3.4-mc1.17.1" = _p0S72dK2;
        "pkg-v2.3.4-mc1.21" = _jAt3JXqJ;
        "pkg-v2.3.4-mc1.16.5" = _gxxg9qmk;
        "pkg-v2.3.4-mc1.19.4" = _UIYNM6SW;
        "pkg-v2.3.4-mc1.14.4" = _W3FeeGvy;
        "pkg-v2.3.4-mc1.18.2" = _qy5gkTHK;
        "pkg-v2.3.4-mc1.15.2" = _1Yl64Uyb;
        "pkg-v2.3.5-mc1.19.4" = _DnXjVG6F;
        "pkg-v2.3.5-mc1.18.2" = _SbavaRzl;
        "pkg-v2.3.5-mc1.16.5" = _qq3pntZB;
        "pkg-v2.3.5-mc1.21.2" = _hpyoAKlM;
        "pkg-v2.3.5-mc1.20.4" = _Hgj3S2nt;
        "pkg-v2.3.5-mc1.17.1" = _n8587o1K;
        "pkg-v2.3.5-mc1.20.6" = _Q4Nrayca;
        "pkg-v2.3.5-mc1.14.4" = _HWHmSB0N;
        "pkg-v2.3.5-mc1.15.2" = _LZWi8KN0;
        "pkg-v2.3.5-mc1.21.1" = _fWI7vtAl;
        "pkg-v2.3.6-mc1.18.2" = _BdFKH0ab;
        "pkg-v2.3.6-mc1.17.1" = _cYjRtSch;
        "pkg-v2.3.6-mc1.20.6" = _witSc0lX;
        "pkg-v2.3.6-mc1.15.2" = _u3E6ENNs;
        "pkg-v2.3.6-mc1.21.3" = _kn7SaFyM;
        "pkg-v2.3.6-mc1.20.4" = _DSBD8hKV;
        "pkg-v2.3.6-mc1.14.4" = _iuAgDKJw;
        "pkg-v2.3.6-mc1.21.1" = _XkWipL6P;
        "pkg-v2.3.6-mc1.16.5" = _n0j3dlXz;
        "pkg-v2.3.6-mc1.19.4" = _Fn9sb6mn;
        "pkg-v2.3.7-mc1.14.4" = _WJGrMYm4;
        "pkg-v2.3.7-mc1.17.1" = _ia7LYZdw;
        "pkg-v2.3.7-mc1.20.6" = _xMMehe58;
        "pkg-v2.3.7-mc1.21.1" = _fCs6hhrh;
        "pkg-v2.3.7-mc1.15.2" = _VCg05oXk;
        "pkg-v2.3.7-mc1.20.4" = _YtxvfQl9;
        "pkg-v2.3.7-mc1.16.5" = _de0dt6Cg;
        "pkg-v2.3.7-mc1.21.3" = _QOdvrLHm;
        "pkg-v2.3.7-mc1.18.2" = _zcb1LcU7;
        "pkg-v2.3.7-mc1.19.4" = _dNnEjQ27;
        "pkg-v2.3.8-mc1.16.5" = _PzrJ8FJy;
        "pkg-v2.3.8-mc1.17.1" = _D3i3EJfM;
        "pkg-v2.3.8-mc1.14.4" = _KKAScf3t;
        "pkg-v2.3.8-mc1.20.6" = _Iwf1BqqS;
        "pkg-v2.3.8-mc1.21.4" = _8zYtGDA8;
        "pkg-v2.3.8-mc1.21.1" = _beXsMTFC;
        "pkg-v2.3.8-mc1.15.2" = _pfvxrhAZ;
        "pkg-v2.3.8-mc1.18.2" = _GDjhI8sj;
        "pkg-v2.3.8-mc1.20.4" = _5WEnEpWb;
        "pkg-v2.3.8-mc1.19.4" = _BwDIPcmY;
        "pkg-v2.3.8-mc1.21.3" = _SySlgKCR;
        "pkg-v2.3.9-mc1.18.2" = _lKU9ij9i;
        "pkg-v2.3.9-mc1.14.4" = _uZtX1hop;
        "pkg-v2.3.9-mc1.16.5" = _DGUpqkCV;
        "pkg-v2.3.9-mc1.21.4" = _pq9BcKsD;
        "pkg-v2.3.9-mc1.21.1" = _Pfpz050B;
        "pkg-v2.3.9-mc1.21.3" = _COsQ2lu5;
        "pkg-v2.3.9-mc1.20.4" = _t5IjLVSF;
        "pkg-v2.3.9-mc1.17.1" = _wT3TGsX0;
        "pkg-v2.3.9-mc1.20.6" = _zreDTeck;
        "pkg-v2.3.9-mc1.21.5" = _Jh3wGnwk;
        "pkg-v2.3.9-mc1.19.4" = _sg3HZqWA;
        "pkg-v2.3.9-mc1.15.2" = _h1BmoviS;
        "pkg-v2.3.10-mc1.21.4" = _3K0g6xmr;
        "pkg-v2.3.10-mc1.15.2" = _f6j7RGGx;
        "pkg-v2.3.10-mc1.21.1" = _2wtMHPB4;
        "pkg-v2.3.10-mc1.16.5" = _OkxPEErn;
        "pkg-v2.3.10-mc1.20.4" = _tmCbPiHK;
        "pkg-v2.3.10-mc1.20.6" = _OVIRhnm8;
        "pkg-v2.3.10-mc1.19.4" = _jnrkTU2k;
        "pkg-v2.3.10-mc1.21.5" = _vhrEiWKg;
        "pkg-v2.3.10-mc1.21.3" = _tsqQMid6;
        "pkg-v2.3.10-mc1.18.2" = _8r40pAxa;
        "pkg-v2.3.10-mc1.14.4" = _SVaEjOx1;
        "pkg-v2.3.10-mc1.17.1" = _iOYcdUYZ;
        "pkg-v2.3.10-mc1.21.6" = _nHWsTpNO;
        "pkg-v2.3.11-mc1.19.4" = _W6ISWFw6;
        "pkg-v2.3.11-mc1.20.6" = _O4YCIB99;
        "pkg-v2.3.11-mc1.20.4" = _TS9wz8w8;
        "pkg-v2.3.11-mc1.21.1" = _wCTvK4GV;
        "pkg-v2.3.11-mc1.21.6" = _HXd9cHJ7;
        "pkg-v2.3.11-mc1.21.5" = _ZHxrKaSj;
        "pkg-v2.3.11-mc1.14.4" = _MqWOsw2T;
        "pkg-v2.3.11-mc1.18.2" = _xoGk5abJ;
        "pkg-v2.3.11-mc1.15.2" = _Hv3V1DuC;
        "pkg-v2.3.11-mc1.16.5" = _vgQjViir;
        "pkg-v2.3.11-mc1.17.1" = _OA3V27HW;
        "pkg-v2.3.11-mc1.21.4" = _hpaJZrP0;
        "pkg-v2.3.11-mc1.21.3" = _zIeNwQBK;
        "pkg-v2.3.12-mc1.20.4" = _amDUo5Ey;
        "pkg-v2.3.12-mc1.14.4" = _L1DmpPo1;
        "pkg-v2.3.12-mc1.20.6" = _4w8ZYWi1;
        "pkg-v2.3.12-mc1.21.4" = _on9mWJvh;
        "pkg-v2.3.12-mc1.19.4" = _PJ4ubc0D;
        "pkg-v2.3.12-mc1.21.7" = _4VdXJgNR;
        "pkg-v2.3.12-mc1.21.3" = _GLKWIUjf;
        "pkg-v2.3.12-mc1.21.5" = _fGnRC6Mc;
        "pkg-v2.3.12-mc1.15.2" = _9hjZQqNU;
        "pkg-v2.3.12-mc1.18.2" = _gdVcl3f4;
        "pkg-v2.3.12-mc1.17.1" = _poTfA1Of;
        "pkg-v2.3.12-mc1.21.1" = _BoJV8GBA;
        "pkg-v2.3.12-mc1.16.5" = _3PCoqzdN;
        "pkg-v2.3.13-mc1.21.4" = _48Ifc9Dx;
        "pkg-v2.3.13-mc1.17.1" = _P7JX0qI8;
        "pkg-v2.3.13-mc1.19.4" = _UU2XbYcN;
        "pkg-v2.3.13-mc1.21.3" = _JYGoPWu1;
        "pkg-v2.3.13-mc1.21.1" = _ckSeAlRk;
        "pkg-v2.3.13-mc1.18.2" = _QdhLd4Ad;
        "pkg-v2.3.13-mc1.20.4" = _V3JgxBrC;
        "pkg-v2.3.13-mc1.21.5" = _yvN5IMFI;
        "pkg-v2.3.13-mc1.20.6" = _Gu8Lj4JL;
        "pkg-v2.3.13-mc1.16.5" = _CCqySKa0;
        "pkg-v2.3.13-mc1.14.4" = _cDbOPZbp;
        "pkg-v2.3.13-mc1.15.2" = _hMYxUHym;
        "pkg-v2.3.13-mc1.21.8" = _2Z7wn6ez;
        "pkg-v2.3.14-mc1.15.2" = _rwExT6hs;
        "pkg-v2.3.14-mc1.21.4" = _5CvmakwT;
        "pkg-v2.3.14-mc1.21.1" = _rhvQKEze;
        "pkg-v2.3.14-mc1.19.4" = _9y0KP53Y;
        "pkg-v2.3.14-mc1.16.5" = _QMR7DJO5;
        "pkg-v2.3.14-mc1.20.6" = _36VoG9gq;
        "pkg-v2.3.14-mc1.21.3" = _aFFHRu0g;
        "pkg-v2.3.14-mc1.20.4" = _JOsDZjBr;
        "pkg-v2.3.14-mc1.14.4" = _T9aJDUWg;
        "pkg-v2.3.14-mc1.18.2" = _Oj1mUvTT;
        "pkg-v2.3.14-mc1.17.1" = _dsT4Te2z;
        "pkg-v2.3.14-mc1.21.5" = _p264Stwi;
        "pkg-v2.3.14-mc1.21.8" = _l32IGIO3;
        "pkg-v2.3.15-mc1.16.5" = _uNYk5Jn4;
        "pkg-v2.3.15-mc1.20.6" = _mQHQTP8c;
        "pkg-v2.3.15-mc1.21.4" = _EOWsn17U;
        "pkg-v2.3.15-mc1.14.4" = _NwY46Juu;
        "pkg-v2.3.15-mc1.20.4" = _KhVi0zSQ;
        "pkg-v2.3.15-mc1.21.5" = _CbTXA2dC;
        "pkg-v2.3.15-mc1.21.8" = _NRqPoAjo;
        "pkg-v2.3.15-mc1.21.1" = _Cn0CrVEu;
        "pkg-v2.3.15-mc1.18.2" = _uzNAxTUW;
        "pkg-v2.3.15-mc1.17.1" = _CRk3cSTm;
        "pkg-v2.3.15-mc1.19.4" = _rpBRXPSq;
        "pkg-v2.3.15-mc1.15.2" = _ucK3eyWR;
        "pkg-v2.3.15-mc1.21.3" = _WVZLyXGr;
        "pkg-v2.3.15-mc1.21.9" = _vQL8Wxsc;
        "pkg-v2.3.16-mc1.21.8" = _lcHd5YvP;
        "pkg-v2.3.16-mc1.16.5" = _TyXAmTUN;
        "pkg-v2.3.16-mc1.20.1" = _a7dTP6gm;
        "pkg-v2.3.16-mc1.20.4" = _WBfD5ZXd;
        "pkg-v2.3.16-mc1.14.4" = _aMnVINgB;
        "pkg-v2.3.16-mc1.21.11" = _azRFfcCb;
        "pkg-v2.3.16-mc1.20.6" = _Edg6ak1R;
        "pkg-v2.3.16-mc1.21.10" = _ArmoKn2D;
        "pkg-v2.3.16-mc1.17.1" = _2sW8yGBD;
        "pkg-v2.3.16-mc1.21.3" = _oOB4yy3t;
        "pkg-v2.3.16-mc1.20.2" = _uPc0RGFH;
        "pkg-v2.3.16-mc1.18.2" = _2BSiXkKV;
        "pkg-v2.3.16-mc1.19.4" = _Yzh0TUDA;
        "pkg-v2.3.16-mc1.21.4" = _gWGsfbWH;
        "pkg-v2.3.16-mc1.21.1" = _6891ACia;
        "pkg-v2.3.16-mc1.21.5" = _1e1vcrR7;
        "pkg-v2.3.16-mc1.15.2" = _HHhv6Sys;
        "default" = _HHhv6Sys;
    });
