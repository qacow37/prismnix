...
let
    ...
    in {
        ...
        "pkg-v1.0_1.7-1.8" = _TRF5tsRd;
        "pkg-v1.0_1.9-1.13" = _XqInIQw1;
        "pkg-v1.0_1.14-1.19.2" = _5kgxwfFs;
        "pkg-v1.0_1.19.4or1.19.3" = _Gbgr7h4m;
        "pkg-v1.0_1.20.x" = _uKL2psCG;
        "pkg-v1.0.1" = _XNEgcCCQ;
        "pkg-v1.1_1.7-1.8" = _3gEpRlR5;
        "pkg-v1.1_1.9-1.13" = _C7XSP9RS;
        "pkg-v1.1_1.14-1.19.2" = _pSjAJq76;
        "pkg-v1.1_1.19.3" = _RLU339Rk;
        "pkg-v1.1_1.19.4" = _SkMU6iWt;
        "pkg-v1.1_1.20-1.21" = _XKQOX5hG;
        "pkg-v1.1.1_1.7-1.8" = _x5aBHv13;
        "pkg-v1.1.1_1.9-1.13" = _8ALCcf7N;
        "pkg-v1.1.2_1.14-1.19.2" = _3cAbUBTu;
        "pkg-v1.1.2_1.19.3" = _TRkeG1BX;
        "pkg-v1.1.2_1.19.4" = _pQKoLQhV;
        "pkg-v1.1.2_1.20-1.21" = _bh9wYcve;
        "pkg-v1.1.2_1.7-1.8" = _Ybp8WJWn;
        "pkg-v1.1.2_1.9-1.13" = _gOskcOHR;
        "pkg-v1.1.3" = _jNBA7OwT;
        "pkg-v1.2.0_1.9-1.13" = _w9Lebaz5;
        "pkg-v1.2.0_1.14-1.19.2" = _8OAQwQ9S;
        "pkg-v1.2.0_1.19.3" = _msCk5RGm;
        "pkg-v1.2.0_1.19.4" = _U4OkqOB4;
        "pkg-v1.2.0_1.20-26.1" = _lrI48IVU;
        "default" = _lrI48IVU;
    });
