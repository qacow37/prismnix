...
let
    ...
    in {
        ...
        "pkg-1.19.2-v1.3.0" = _kLgNKP1z;
        "pkg-1.19.2-v1.4.0" = _p9HztZI7;
        "pkg-1.19.4-v1.5.0" = _DWknIrtq;
        "pkg-1.19.3-v1.5.0" = _i06Y4r7L;
        "pkg-1.20-v1.5.0" = _kNJyMvhi;
        "pkg-1.20.1-v1.5.0" = _mRMPgfmH;
        "pkg-1.20.2-v1.5.0" = _fPxD8fBa;
        "pkg-1.20.3-v1.5.0" = _AZBUOnLC;
        "pkg-1.20.4-v1.5.0" = _55kPyoNL;
        "pkg-1.20.4-v1.5.1" = _e5qvJT45;
        "pkg-1.20.3-v1.5.1" = _zT1bzdqj;
        "pkg-1.20.2-v1.5.1" = _ZulCdnsB;
        "pkg-1.20-v1.5.1" = _TpiCufVe;
        "pkg-1.20.1-v1.5.1" = _mAca64ew;
        "pkg-1.19.2-v1.4.2" = _nr6M1PSW;
        "pkg-1.20.4-v1.5.2" = _c5Kg6aZA;
        "pkg-1.20.4-v1.5.3" = _wO1RbNDI;
        "pkg-1.20.4-v1.5.4" = _V1XB3aCx;
        "pkg-1.20.4-v1.5.5" = _Is2u0NnU;
        "pkg-1.21.6-v1.7.0" = _PbUwwhno;
        "pkg-1.21.7-v1.7.0" = _EWMwybru;
        "pkg-1.21.8-1.7.0" = _PsZ2aMvr;
        "pkg-1.21.9-v1.7.1" = _7WyQdKLz;
        "pkg-1.21.10-v1.8.0" = _PjZ2Jcn9;
        "pkg-2.0.0" = _GWft7Ppq;
        "pkg-3.0.0-beta" = _9xWCcBaS;
        "pkg-3.1.0-beta" = _NxxVKNRP;
        "pkg-3.2.0-beta+neoforge" = _cFHrkqN8;
        "pkg-3.2.0-beta+fabric" = _1IhozFfn;
        "default" = _1IhozFfn;
    });
