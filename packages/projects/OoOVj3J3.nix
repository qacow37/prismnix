...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Fabric" = _zgQZfzW9;
        "pkg-v4.0.2-1.19.2-Fabric" = _32S9AzUT;
        "pkg-v4.0.2-1.19.2-Forge" = _Ls45joM5;
        "pkg-v4.0.3-1.19.2-Forge" = _5q2DCza2;
        "pkg-v4.0.3-1.19.2-Fabric" = _p395MkGS;
        "pkg-v4.0.4-1.19.2-Forge" = _zwg9BU3Z;
        "pkg-v4.0.4-1.19.2-Fabric" = _bIxMP7eu;
        "pkg-v4.0.5-1.19.2-Forge" = _Hf33v5Jd;
        "pkg-v4.0.5-1.19.2-Fabric" = _Gsjt5pf5;
        "pkg-v5.0.0-1.19.3-Fabric" = _AKIMrpDG;
        "pkg-v5.0.0-1.19.3-Forge" = _4C4VggVc;
        "pkg-v6.0.0-1.19.4-Fabric" = _4rcIZpBp;
        "pkg-v6.0.0-1.19.4-Forge" = _cxuYKRSc;
        "pkg-v3.0.0-1.18.2-Fabric" = _dsbu6UYN;
        "pkg-v3.0.0-1.18.2-Forge" = _7NeeeUF4;
        "pkg-v7.0.0-1.20-Forge" = _loxcBWgW;
        "pkg-v7.0.0-1.20-Fabric" = _BeXom2jP;
        "pkg-v8.0.0-1.20.1-Forge" = _IWYoMQYX;
        "pkg-v8.0.0-1.20.1-Fabric" = _MHbM03Bv;
        "pkg-v20.4.0-1.20.4-Fabric" = _ZfWCXtTl;
        "pkg-v20.4.0-1.20.4-Forge" = _7smB31bv;
        "pkg-v20.4.0-1.20.4-NeoForge" = _WzdlD1lh;
        "pkg-v21.0.0-1.21-Fabric" = _8GlyEr6o;
        "pkg-v21.0.0-1.21-NeoForge" = _TkBeLVd3;
        "pkg-v21.1.0-1.21.1-Fabric" = _ZVumUwIy;
        "pkg-v21.1.0-1.21.1-NeoForge" = _tlFY9zBb;
        "pkg-v21.3.0-1.21.3-Fabric" = _LHw4Uub6;
        "pkg-v21.3.0-1.21.3-NeoForge" = _6XcO2Bqi;
        "pkg-v21.3.1-1.21.3-Fabric" = _iaDr0g8l;
        "pkg-v21.3.1-1.21.3-NeoForge" = _ww1nEljQ;
        "pkg-v21.4.0-1.21.4-Fabric" = _JtD4T40r;
        "pkg-v21.4.0-1.21.4-NeoForge" = _Lqe7Z1DZ;
        "pkg-v21.5.0-1.21.5-Fabric" = _327jWshN;
        "pkg-v21.5.0-1.21.5-NeoForge" = _iexXBC1s;
        "pkg-v21.6.0-1.21.6-Fabric" = _nsQPHcSK;
        "pkg-v21.6.0-1.21.6-NeoForge" = _dYJTLr0c;
        "pkg-v21.7.0-1.21.7-Fabric" = _m4ghvvLX;
        "pkg-v21.7.0-1.21.7-NeoForge" = _ZuoGXXna;
        "pkg-v21.8.0-1.21.8-Fabric" = _u01GjkMv;
        "pkg-v21.8.0-1.21.8-NeoForge" = _oc9wqBwl;
        "pkg-v21.1.1-1.21.1-Fabric" = _viLbr66Z;
        "pkg-v21.1.1-1.21.1-NeoForge" = _3sJ71XQz;
        "pkg-v8.0.1-1.20.1-Forge" = _3V51q1QN;
        "pkg-v8.0.1-1.20.1-Fabric" = _wXIbbZf0;
        "pkg-21.9.0" = _ANO1o3p4;
        "pkg-21.10.0" = _oAGdi4Ii;
        "pkg-21.11.0" = _wEYQtQLY;
