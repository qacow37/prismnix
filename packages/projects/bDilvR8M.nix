...
let
    ...
    in {
        ...
        "pkg-mc1.15.2-v1.0.0-SNAPSHOT" = _IpeVS5q9;
        "pkg-mc1.15.2-v1.0.0" = _XYVYP1Gd;
        "pkg-mc1.16.5-v1.0.0" = _jLqoZIxg;
        "pkg-mc1.17.1-v1.0.0" = _zjn3NA72;
        "pkg-mc1.14.4-v1.0.0" = _4b9GAECj;
        "pkg-mc1.18.2-v1.0.0" = _ySm0pnrv;
        "pkg-mc1.15.2-v1.0.1" = _aFmQaRjL;
        "pkg-mc1.16.5-v1.0.1" = _aGuTJliD;
        "pkg-mc1.18.2-v1.0.1" = _ZPR1LUiR;
        "pkg-mc1.17.1-v1.0.1" = _vZjN6914;
        "pkg-mc1.14.4-v1.0.1" = _XqycYwHJ;
        "pkg-mc1.15.2-v1.0.2" = _Ul9CjaoF;
        "pkg-mc1.14.4-v1.0.2" = _x7f7cQ4W;
        "pkg-mc1.16.5-v1.0.2" = _aky5LTKj;
        "pkg-mc1.17.1-v1.0.2" = _hRqxaHLO;
        "pkg-mc1.18.2-v1.0.2" = _vrP1oOaH;
        "pkg-mc1.15.2-v1.1.0" = _CunUQbxe;
        "pkg-mc1.16.5-v1.1.0" = _gYg5a483;
        "pkg-mc1.14.4-v1.1.0" = _8ZTJq61M;
        "pkg-mc1.18.2-v1.1.0" = _Kd6tswPZ;
        "pkg-mc1.17.1-v1.1.0" = _KFiin3Vx;
        "pkg-mc1.15.2-v1.2.0" = _qa3FAVhN;
        "pkg-mc1.14.4-v1.2.0" = _iBEncpXp;
        "pkg-mc1.18.2-v1.2.0" = _kdEZw3ok;
        "pkg-mc1.17.1-v1.2.0" = _CCtR0wQO;
        "pkg-mc1.16.5-v1.2.0" = _TZDbSzs5;
        "pkg-mc1.19.1-v1.2.0" = _qaWF2qHu;
        "pkg-mc1.15.2-v1.3.0" = _tLtbghpZ;
        "pkg-mc1.16.5-v1.3.0" = _YngaHcTC;
        "pkg-mc1.14.4-v1.3.0" = _dZQp0L7Z;
        "pkg-mc1.17.1-v1.3.0" = _o713ZZ0R;
        "pkg-mc1.19.2-v1.3.0" = _ejWxx4eD;
        "pkg-mc1.18.2-v1.3.0" = _wQ4aqbhn;
        "pkg-mc1.15.2-v1.3.1" = _4YON84ts;
        "pkg-mc1.14.4-v1.3.1" = _JlIp5fOO;
        "pkg-mc1.16.5-v1.3.1" = _ZGneTFDM;
        "pkg-mc1.17.1-v1.3.1" = _tbSJuNi9;
        "pkg-mc1.19.3-v1.3.1" = _mvwtb7vp;
        "pkg-mc1.18.2-v1.3.1" = _cP1FFr0P;
        "default" = _cP1FFr0P;
    });
