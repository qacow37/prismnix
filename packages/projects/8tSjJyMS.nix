...
let
    ...
    in {
        ...
        "pkg-9.0.1" = _j5YzFiMb;
        "pkg-9.0.2" = _AyQChZVT;
        "pkg-10.0.1" = _s9CApzNU;
        "pkg-10.0.2" = _M9Zo5aqs;
        "pkg-11.0.1" = _EopDdi5F;
        "pkg-12.0.1" = _zBQHpKMc;
        "pkg-13.0.1" = _XDslzbWj;
        "pkg-13.0.2" = _wWQ13qWs;
        "pkg-14.0.1" = _gIhEy6aO;
        "pkg-14.0.3" = _5IF8TYEX;
        "pkg-15.0.1" = _sIiT5zPY;
        "pkg-16.0.1" = _f86XbURW;
        "pkg-16.0.2" = _tGM9nWpc;
        "pkg-16.0.3" = _Ne3P2KGv;
        "pkg-13.0.3" = _dJX0jTll;
