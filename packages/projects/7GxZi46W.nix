...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.5-fabric" = _bpa58oNb;
        "pkg-1.18.2-2.5-fabric" = _3fQbwnjm;
        "pkg-1.19.2-2.7-fabric" = _nuoVbtac;
        "pkg-1.16.5-2.5-forge" = _l0EpFIhE;
        "pkg-1.18.2-2.5-forge" = _aHGOFHKf;
        "pkg-1.19.2-2.5-forge" = _HcNlmIGh;
        "pkg-1.16.5-2.8-forge" = _viPFz83g;
        "pkg-1.18.2-2.8-forge" = _DbP2l0jb;
        "pkg-1.19.2-2.8-forge" = _KBC2AwN7;
        "pkg-1.16.5-2.9-fabric" = _QbuVMcmC;
        "pkg-1.18.2-2.9-fabric" = _XrAAkCGu;
        "pkg-1.19.2-2.9-fabric" = _JO4lxrA3;
        "pkg-1.19.3-3.0-fabric" = _y1h1fOAU;
        "pkg-1.19.3-2.8-forge" = _k3yI5kvG;
        "pkg-1.18.2-4.0-forge+fabric" = _jh10d82j;
        "pkg-1.19.2-4.0-forge+fabric" = _UA4HDTAh;
        "pkg-1.19.3-4.0-forge+fabric" = _6jp67Xmi;
        "pkg-1.18.2-4.1-forge+fabric" = _fdrmkPLu;
        "pkg-1.19.2-4.1-forge+fabric" = _BTUouQJ3;
        "pkg-1.19.3-4.1-forge+fabric" = _2R5FBWpb;
        "pkg-1.18.2-4.2-forge+fabric" = _HZKiBYLF;
        "pkg-1.19.2-4.2-forge+fabric" = _wkPP39AB;
        "pkg-1.19.3-4.2-forge+fabric" = _7lp9Mo5N;
        "pkg-1.19.4-4.2-forge+fabric" = _9OkC6QK3;
        "pkg-1.20-4.2-forge+fabric" = _7DIgfC6J;
        "pkg-1.20.1-4.2-forge+fabric" = _WIU5XtK3;
        "pkg-1.20.2-4.2-forge+fabric" = _YNX8cjSc;
        "pkg-1.18.2-4.3-forge+fabric" = _V77WDvZK;
        "pkg-1.19.2-4.3-forge+fabric" = _mu0hAC6T;
        "pkg-1.20.1-4.3-forge+fabric" = _LIdnN7lD;
        "pkg-1.20.2-4.3-forge+fabric" = _sAcUe3di;
        "pkg-1.20.2-4.4-forge+fabric" = _1sPzloVH;
        "pkg-1.20.3-4.4-fabric+forge+neo" = _M8z84mX6;
        "pkg-1.20.4-4.4-fabric+forge+neo" = _PP5wv344;
        "pkg-1.19.2-4.5-fabric+forge+neo" = _U2fPBVUn;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _mL7M27eN;
        "pkg-1.20.2-4.5-fabric+forge+neo" = _iO59T5dI;
        "pkg-1.20.4-4.5-fabric+forge+neo" = _SACCNAL7;
        "pkg-1.19.2-4.6-fabric+forge+neo" = _7NMtpx47;
        "pkg-1.20.1-4.6-fabric+forge+neo" = _yuS4dzqq;
        "pkg-1.20.2-4.6-fabric+forge+neo" = _493Br27c;
        "pkg-1.20.4-4.6-fabric+forge+neo" = _sZb5YCcN;
        "pkg-1.20.5-4.6-fabric+neo" = _S0OKPsup;
        "pkg-1.20.5-4.7-fabric+neo" = _SnoQYq6i;
        "pkg-1.20.6-4.7-fabric+forge+neo" = _HXXSYUA9;
        "pkg-1.21.0-4.7-fabric+forge+neo" = _Qc1AanHa;
        "pkg-1.20.1-4.8-fabric+forge+neo" = _CEv7pIW1;
        "pkg-1.20.6-4.8-fabric+forge+neo" = _aVJXTOjG;
        "pkg-1.21.0-4.8-fabric+forge+neo" = _QwwE74Tt;
        "pkg-1.21.1-4.8-fabric+forge+neo" = _xwsfyOOZ;
        "pkg-1.21.2-4.8-fabric+neo" = _GT014iRc;
        "pkg-1.21.3-4.8-fabric+forge+neo" = _T4dJ1HOz;
        "pkg-1.21.4-4.8-fabric+forge+neo" = _IZHcpmvI;
        "pkg-1.20.1-4.9-fabric+forge+neo" = _mstXG0GO;
        "pkg-1.21.1-4.9-fabric+forge+neo" = _U77F6FLq;
        "pkg-1.21.4-4.9-fabric+forge+neo" = _e3BgP6FE;
        "pkg-1.21.5-4.9-fabric+forge+neo" = _zu42W86l;
        "pkg-1.21.6-4.9-fabric+forge+neo" = _hMZQfN5s;
        "pkg-1.21.5-5.0-fabric+forge+neo" = _ZgCuEY3s;
        "pkg-1.21.6-5.0-fabric+forge+neo" = _plh7sBcx;
        "pkg-1.21.7-5.0-fabric+forge+neo" = _NxzrWUeH;
        "pkg-1.21.8-5.0-fabric+forge+neo" = _9SbT8o7w;
        "pkg-1.21.9-5.0-fabric+forge+neo" = _1dSKifsd;
        "pkg-1.21.10-5.0-fabric+forge+neo" = _u3qFYL6m;
        "pkg-1.21.11-5.0-fabric+forge+neo" = _dxirURcL;
        "pkg-26.1.0-5.0-fabric+forge+neo" = _MYLREh2w;
        "pkg-26.1.1-5.0-fabric+forge+neo" = _aJRCeO7s;
        "pkg-26.1.2-5.0-fabric+forge+neo" = _eGx3Tcc6;
        "pkg-26.2.0-5.0-fabric+forge+neo" = _rYc7v0Td;
        "default" = _rYc7v0Td;
    });
