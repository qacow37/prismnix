...
let
    ...
    in {
        ...
        "pkg-0.0.6" = _imy1idC2;
        "pkg-0.0.7" = _R2Lg8cNK;
        "pkg-0.0.8+1.20.1" = _hIxLHKJQ;
        "pkg-0.0.8+1.21" = _dYxTLXM0;
        "pkg-0.0.8+1.21.2" = _WZBxU8Bs;
        "pkg-0.0.8+1.21.4" = _dcnLG3iQ;
        "pkg-0.0.8+1.21.5" = _fhoVaxRI;
        "pkg-0.0.9+1.20.1" = _l6zb1T6B;
        "pkg-0.0.9+1.21" = _jKt0ida9;
        "pkg-0.0.9+1.21.2" = _c0UD7IYN;
        "pkg-0.0.9+1.21.4" = _WvtYeAvL;
        "pkg-0.0.9+1.21.5" = _hy4thegK;
        "pkg-0.0.9+1.21.9" = _ATfgEn9c;
        "pkg-0.0.9-bugfix+1.20.1" = _Qrq24umv;
        "pkg-0.0.9-bugfix+1.21" = _I2zAkzQd;
        "pkg-0.0.10+1.21.2" = _ggN7RdSQ;
        "pkg-0.0.10+1.21.4" = _hDqlQ9Ro;
        "pkg-0.0.10+1.21.5" = _7D6mkbKH;
        "pkg-0.0.10+1.21.9" = _LQcatUeb;
        "pkg-0.0.10+1.20.1" = _akadRAKE;
        "pkg-0.0.10+1.21" = _3Yki4BfD;
        "pkg-0.0.10+1.21.11" = _KzjfDqli;
        "pkg-0.0.10+1.21.6" = _Ybm46ezM;
        "pkg-0.0.10+26.1" = _AnQv1HgJ;
        "pkg-0.0.10+26.2" = _MYD31GxC;
        "default" = _MYD31GxC;
    });
