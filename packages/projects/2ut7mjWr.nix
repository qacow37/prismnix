...
let
    ...
    in {
        ...
        "pkg-0.0.4" = _AndS8rCj;
        "pkg-0.0.5" = _1Y65moW8;
        "pkg-0.0.5.5" = _VWeAw8vj;
        "pkg-0.0.6" = _Rxu0vhDH;
        "pkg-0.0.7" = _euW192VH;
        "pkg-0.0.8" = _Zwab0Cfz;
        "pkg-0.0.8.5" = _WnQdcnlo;
        "pkg-0.0.9" = _T1dbCMLR;
        "pkg-0.0.9.5" = _Og2CqBTw;
        "pkg-0.1.0" = _TaRp3LAC;
        "pkg-0.1.1" = _K3jAnkGr;
        "pkg-0.1.1.5" = _BSJO1kS2;
        "pkg-0.1.2" = _SNDA3Xsy;
        "pkg-0.1.3" = _P5v7cbb3;
        "pkg-0.1.4" = _xT0Djvud;
        "pkg-0.1.5" = _xzuUCVgl;
        "pkg-0.1.5.5" = _gx9S1WdR;
        "pkg-0.1.6" = _XFn3XRHy;
        "pkg-0.1.6.5" = _aU84cFTo;
        "pkg-0.1.7" = _eeEbjA8Y;
        "pkg-0.1.7.5" = _STB3x7gr;
        "pkg-0.1.8" = _UfjrfETA;
        "pkg-0.1.9" = _C3TZSveb;
        "pkg-0.1.9.5" = _lkBFJ827;
        "pkg-0.2.0" = _dxo5THNZ;
        "pkg-0.2.1" = _owhwepzn;
        "pkg-0.2.2" = _AxEBgSUj;
        "pkg-0.2.3" = _9gO76ZZ6;
