...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _I7BDyXyv;
        "pkg-1.0.9" = _3OK6JuMZ;
        "pkg-1.0.10" = _jxKLZJur;
        "pkg-1.0.11" = _wcMTRNQ0;
        "pkg-1.0.12" = _AbtXqRqK;
        "pkg-1.0.13" = _Tb26Sdxt;
        "pkg-1.0.14" = _cn7D4Snh;
        "pkg-1.0.15" = _lK506MMq;
        "pkg-1.0.17" = _3khIuSv5;
        "pkg-1.0.18" = _1Vn8toOF;
        "pkg-1.0.19" = _vL71AKIr;
        "pkg-1.0.20" = _9ckJSw76;
        "pkg-1.0.36" = _7PmawLmM;
        "pkg-1.0.38" = _afzwwfSy;
        "pkg-1.0.46" = _tH1Gvnnj;
        "pkg-1.0.47" = _4F6eQ7iY;
        "pkg-1.0.48" = _2z2d31IU;
        "pkg-1.0.49" = _onW3nueu;
        "pkg-1.0.50" = _sPLJwTjr;
        "pkg-1.0.51" = _pWvT9Ts6;
        "pkg-1.0.52" = _RGhuMDMk;
        "pkg-1.0.53" = _wxtRDXX5;
        "pkg-1.0.54" = _2OrqSuzv;
        "pkg-1.0.59" = _MMD4zs0M;
        "pkg-1.0.60" = _YWUwnB0k;
        "pkg-1.0.61" = _wOBaZ773;
        "pkg-1.0.62" = _333nCLDz;
        "pkg-1.0.63" = _bgWCSkrP;
        "pkg-1.0.64" = _knCBHT13;
        "pkg-1.0.65" = _wiBpB2gR;
        "pkg-1.0.66" = _Pe83bnok;
        "pkg-1.0.67" = _ZmZAb6my;
        "pkg-1.0.68" = _jkeWCnP4;
        "pkg-1.0.69" = _cJs7TozY;
        "pkg-1.0.70" = _4MeFRV03;
        "pkg-1.0.71" = _QedjVcF6;
        "pkg-1.0.72" = _TLqFx6cN;
        "pkg-1.0.73" = _xzw0USLq;
        "pkg-1.0.74" = _ELpE0mTw;
        "pkg-1.0.75" = _WHxBk1p5;
        "pkg-1.0.76" = _utfPUcgK;
        "pkg-1.0.77" = _UnTqA9xw;
        "pkg-1.0.78" = _EtBGBYx6;
        "pkg-1.0.79" = _baju8plk;
        "pkg-1.0.80" = _SHIF4riR;
        "pkg-1.0.81" = _v9Hgobf7;
        "pkg-1.0.82" = _g4UCpXP6;
        "pkg-1.0.83" = _Ua4OKuV0;
        "pkg-1.0.84" = _3cWwom3w;
        "pkg-1.0.85" = _GrBjcquu;
        "pkg-1.0.86" = _6SK1pR61;
        "pkg-2.0.90" = _Kq7hlD44;
        "pkg-2.0.91" = _vO3lc78t;
        "pkg-2.0.93" = _1GR4ivDC;
        "pkg-2.0.94" = _1oemYMCb;
        "pkg-2.0.95" = _u3KRAvl3;
        "pkg-2.0.96" = _hCcYeYYG;
        "pkg-2.0.97" = _tzk5m4G0;
        "pkg-2.0.98" = _oqd9oY8t;
        "pkg-2.0.102" = _bttC0T4S;
        "pkg-2.0.103" = _nhEJGu36;
        "pkg-2.0.104" = _Y3FeZojr;
        "pkg-2.0.105" = _d669lxJu;
        "pkg-2.0.106" = _nP9nSgab;
        "pkg-2.0.107" = _ved0ew1n;
        "pkg-2.0.108" = _CfJK1Jwt;
        "pkg-2.0.109" = _Ssrj7FWg;
        "pkg-2.0.110" = _NHugON7D;
        "pkg-2.0.111" = _idlDZeC5;
        "pkg-2.0.112" = _X2T006yb;
        "pkg-2.0.113" = _8JAsUfwA;
        "pkg-2.0.114" = _yNgizaZ1;
        "pkg-2.0.115" = _s065aYmF;
        "pkg-3.0.2" = _aabh76Ou;
        "pkg-4.0.2" = _RTaRYaPf;
        "pkg-4.0.4" = _JaSn49iw;
        "pkg-4.0.5" = _mUIRmysN;
        ...
        "pkg-4.1.8" = _aIKonYQw;
        "pkg-4.1.9" = _qGmKs51n;
        "pkg-4.1.10" = _xIaez0jT;
        "pkg-4.2.11" = _saE9A5K2;
        "pkg-2.0.116" = _coKLSHNb;
        "pkg-3.0.3" = _KA5QpM7n;
        "pkg-4.2.12" = _k4Yk5cdr;
        "pkg-3.0.4" = _2osHepzZ;
        "pkg-4.2.14" = _Rp4da4Tr;
        "pkg-2.0.117" = _pCJragpu;
        "pkg-4.2.15" = _eVnJzoOA;
        "pkg-5.0.2" = _sXc8y5Dz;
        "pkg-2.0.118" = _uPFaB2l1;
        "pkg-2.0.119" = _9Oqi30vX;
        "pkg-2.0.120" = _rQmAvL7Y;
        "pkg-2.0.121" = _lGmLO1RB;
        "pkg-2.0.122" = _geBJcYFE;
        "pkg-2.0.123" = _yZOGAZFy;
        "pkg-3.0.5" = _YGtmaaSa;
        "pkg-3.1.7" = _7cJfpYdP;
        "pkg-3.1.8" = _u5oR82N7;
        "pkg-4.0.1" = _rIiraACm;
        ...
        "pkg-7.2.8" = _QzUX5VAW;
        "pkg-7.3.9" = _hsKNVMXZ;
        "pkg-7.3.10" = _HXLtZMfT;
        "pkg-7.3.11" = _PW52rbsI;
        "pkg-7.3.12" = _8lNFCLWn;
        "pkg-7.3.13" = _xaKm9WBk;
        "pkg-7.3.14" = _Q2oqGWsK;
        "pkg-8.0.1" = _PvrqlALI;
        "pkg-8.0.2" = _1LzxQJps;
        "pkg-9.0.1" = _scUVogN9;
        "pkg-9.1.2" = _5JukTx1w;
        "pkg-10.0.1" = _tAKOKbWk;
        "pkg-11.0.2" = _wB2SSIk8;
        "pkg-8.1.3" = _1qQ9ip7i;
        "pkg-11.0.3" = _yj7RDtRx;
        "pkg-11.1.4" = _lgigfqZI;
        "pkg-13.0.1" = _CPDHhRNs;
        "pkg-14.0.10" = _7FJT93VX;
        "pkg-15.0.1" = _KTIYBB6X;
        "pkg-16.0.1" = _FVYvVq8w;
        "pkg-17.0.1" = _2kzjw4a3;
        "pkg-15.0.2" = _El97XbC9;
        "default" = _El97XbC9;
    });
