...
let
    ...
    in {
        ...
        "pkg-1.2-BETA" = _LhCaMIzy;
        "pkg-1.2-BETA-1.17" = _jQoWa0il;
        "pkg-1.2.1-BETA+1.17" = _zQt9Dd2v;
        "pkg-1.2.2-BETA+1.17" = _McebIuW7;
        "pkg-1.2.0.1-BETA+1.16" = _gtoXC9cr;
        "pkg-1.3-BETA+1.17" = _t3cqWJpS;
        "pkg-1.3.1-BETA+1.17" = _ZSlExvBh;
        "pkg-1.3-BETA+1.18" = _nBxZtduO;
        "pkg-1.4-BETA+1.18" = _k55LHPVG;
        "pkg-1.4-BETA+1.19" = _hNV4laag;
        "pkg-2.0+1.19" = _UBlv1O6X;
        "pkg-2.0+1.19.3" = _JoW6p4c5;
        "pkg-2.0+1.19.4" = _tXjlq5P9;
        "pkg-2.0.1+1.19.4" = _SgKuDqln;
        "pkg-2.0.2+1.19" = _UYBTrmgB;
        "pkg-2.0.2+1.19.3" = _tjP6OtOn;
        "pkg-2.0.2+1.19.4" = _FWErjNOd;
        "pkg-2.1+1.19" = _Gil5sfVD;
        "pkg-2.1+1.19.3" = _G7yrUl8Y;
        "pkg-2.1+1.19.4" = _866aPKAj;
        "pkg-2.2+1.19" = _k9JfRwVM;
        "pkg-2.2+1.19.3" = _3wVgEG0u;
        "pkg-2.2+1.19.4" = _7EU0UwXc;
        "pkg-2.2.1+1.19" = _rLlocL2I;
        "pkg-2.2.1+1.19.3" = _5yFOnFEL;
        "pkg-2.2.1+1.19.4" = _QlPte8FN;
        "pkg-2.2.1+1.20" = _dJtxMqxE;
        "pkg-2.3+1.19" = _5TNKN9aR;
        "pkg-2.3+1.19.3" = _sX1BCX14;
        "pkg-2.3+1.19.4" = _hp6m6aJl;
        "pkg-2.3+1.20" = _uMEzKato;
        "pkg-2.4-BETA+1.20" = _bLvuhMT5;
        "pkg-2.4-BETA+1.20.2" = _h5nPuT4U;
        "pkg-2.4-BETA+1.20.4" = _eAnbDsZ4;
        "pkg-2.4-BETA+1.21" = _SgG5rslx;
        "pkg-2.4.1-BETA+1.20" = _AoFUONjx;
        "pkg-2.4.1-BETA+1.20.2" = _u5TkcQdd;
        "pkg-2.4.1-BETA+1.20.4" = _bFsJQDC7;
        "pkg-2.4.1-BETA+1.21" = _vPuQOuvv;
        "pkg-2.4.2-BETA+1.20" = _sdV8aBn8;
        "pkg-2.4.2-BETA+1.20.2" = _G7LfguQy;
        "pkg-2.4.2-BETA+1.20.4" = _kSoN9Hi9;
        "pkg-2.4.2-BETA+1.21" = _2mIvRTNp;
        "default" = _2mIvRTNp;
    });
