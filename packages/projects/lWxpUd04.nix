...
let
    ...
    in {
        ...
        "pkg-0.1.0-BETA" = _uQMXwRUQ;
        "pkg-0.2.0-BETA" = _W73vX2vm;
        "pkg-0.2.0-BETA-6" = _K86YEZxx;
        "pkg-0.2.2-BETA-8" = _FKdoEKna;
        "pkg-0.2.2-BETA-10" = _YuTEgxcq;
        "pkg-0.2.2-BETA-13" = _6cyqqB3W;
        "pkg-0.3-14" = _HuL7xsNn;
        "pkg-0.3-16" = _HfDgeIf1;
        "pkg-1.0-BETA-15" = _MO3kK0TE;
        "pkg-1.0-BETA-16" = _pkJsh6cc;
        "pkg-1.0-BETA-17" = _66evaU1R;
        "pkg-0.3-17" = _iJwbYez3;
        "pkg-0.3-19" = _42wEpT9u;
        "pkg-1.0-BETA-22" = _6fgB3rLt;
        "pkg-1.1-23" = _7thlC9p2;
        "pkg-1.1-24" = _OqtYPoRP;
        "pkg-0.3-20" = _JJ3spJ5m;
        "pkg-1.1-25" = _3lZrynOw;
        "pkg-1.1.1-27" = _UpKVmMS6;
        "pkg-1.1.1-33" = _VDbWY7Je;
        "pkg-1.2.1-48" = _xFKk7yLd;
        "pkg-1.3-58" = _VElSDQG2;
        "pkg-1.3.1-61" = _BFrQu0Ys;
        "pkg-1.4.1-68" = _ZweSzLp1;
        "pkg-1.4.2-69" = _EFAWukYC;
        "pkg-1.4.3-74" = _VzeQIZwm;
        "pkg-1.5.0-83" = _4bj3vtwm;
        "pkg-1.5.1-84" = _zLGZcQrj;
        "pkg-1.5.2-85" = _1ZQVU3a6;
        "pkg-1.5.3-88" = _HPjCfeRS;
        "pkg-1.5.4-91" = _mCqsJ135;
        "pkg-1.5.5-92" = _xk9gv6EW;
        "pkg-1.5.6-93" = _asClMJEw;
        "pkg-1.5.8-95" = _SlGjcNjR;
        "pkg-1.5.9-96" = _ATto1AxA;
        "pkg-1.5.10-98" = _iBvhcxXv;
        "pkg-1.5.11-100" = _CMAA7Zhv;
        "pkg-1.5.12-101" = _xYpEFEqa;
        "pkg-1.5.13-103" = _tcYeHUn2;
        "pkg-1.6.0-104" = _zMM6FNyl;
        "pkg-1.6.2-106" = _NOsfZKJ9;
        "pkg-1.6.3-107" = _IpWjx15M;
        "pkg-1.6.4-111" = _gXZ7FsYn;
        "pkg-1.6.5-112" = _L8h0U3hN;
        "pkg-1.6.6-113" = _dFpdcwzZ;
        "pkg-1.7.0-114" = _YkbSHnzj;
        "pkg-1.7.1-116" = _Az2a5neg;
        "pkg-1.7.2-117" = _l91TWUS7;
        "pkg-1.8.0-118" = _6luomlcF;
        "pkg-1.8.1-120" = _76Kb6n5z;
        "pkg-1.8.2-121" = _Ii4dFup6;
        "pkg-1.8.3-122" = _VRaQzXGI;
        "pkg-1.8.4-124" = _KNVaMznv;
        "pkg-1.8.5-127" = _nGDQt1RV;
        "pkg-1.8.6-131" = _kIImCqNd;
        "pkg-1.8.7-132" = _VhKAUKoo;
        "pkg-1.8.8-136" = _ofRVVXMv;
        "pkg-1.8.9-138" = _woLlg1t9;
        "pkg-1.8.10-141" = _1OvDqcOB;
        "pkg-1.8.10-142" = _Tmtz5dzF;
        "pkg-1.8.10-143" = _ngTZKiCH;
        "pkg-1.8.11-147" = _BOmm3Ftp;
        "pkg-1.9.0-163" = _wZaWSDrd;
        "pkg-1.9.1-166" = _M2WOkmPD;
        "pkg-1.9.2-170" = _AVgclXrr;
        "pkg-1.10.0-173" = _xCuYHfqQ;
        "pkg-1.10.1-176" = _esRxYY5S;
        "pkg-1.10.2-178" = _zx1nZ2iP;
        "pkg-1.10.3-181" = _9KLS9awp;
        "pkg-1.10.4-187" = _l64tvlIg;
        "pkg-1.10.5-189" = _eJFQsBnS;
        "pkg-1.10.6-192" = _ZnyFuAOb;
        "pkg-1.10.7-204" = _Kdks4YO0;
        "pkg-1.11.0-205" = _aJziXak1;
        "pkg-1.11.1-206" = _zRJDdfbH;
        "pkg-1.11.2-212" = _oNp37Drh;
        "pkg-1.11.3-213" = _N7iB4j6D;
        "pkg-1.11.4-214" = _MHEbrqts;
        "pkg-1.11.5-215" = _E3Wbx8wj;
        "pkg-1.11.6-216" = _O9dO0sdK;
        "pkg-1.11.9-222" = _zX63tb3b;
        "pkg-1.11.10-223" = _MPeMOLyY;
        "pkg-1.12.0-224" = _m2dXdKbI;
        "pkg-1.12.1-225" = _gEjYDhGM;
        "pkg-1.12.2-226" = _xSHL7Wh8;
        "pkg-1.12.3-227" = _5gbgWiNz;
        "pkg-1.12.4-228" = _g0Tbh5Bt;
        "pkg-1.12.5-229" = _ETJEemfL;
        "pkg-1.12.6-230" = _8Eg7ckog;
        "pkg-1.12.7-231" = _fPE3EiI3;
        "pkg-1.12.8-232" = _MTEYoTVj;
        "pkg-1.12.9-233" = _MJb8oeKE;
        "pkg-1.12.10-234" = _Qp5apwge;
        "pkg-1.12.11-235" = _JJLEFYqz;
        "pkg-1.12.12-236" = _eGc6EoNg;
        "pkg-2.0.2" = _oodEevLj;
        "pkg-1.12.13-237" = _kCY68l3Y;
        "pkg-2.1.0" = _auD4AHVc;
        "pkg-2.1.1" = _ZfCSy8c9;
        "pkg-2.1.2" = _vt40O4T1;
        "pkg-2.2.0" = _YwIXTIjb;
        ...
        "pkg-3.2.6" = _MJAUWDIH;
        "pkg-3.2.7" = _I3HQybVl;
        "pkg-3.2.8.1" = _YO25znfz;
        "pkg-3.2.8.2" = _rOnBktkm;
        "pkg-3.2.8.3" = _ymOHtsRx;
        "pkg-3.2.8.4" = _ZNHRC1U6;
        "pkg-3.2.9" = _6qdA2xNW;
        "pkg-3.2.9.1" = _IJ9eoPWl;
        "pkg-3.2.9.2" = _ddSpCUUA;
        "pkg-3.2.10" = _ueMvofkj;
        "pkg-3.2.10.1" = _LMWeTY5z;
        "pkg-3.2.10.2" = _xBPXRTVQ;
        "pkg-3.2.11" = _9mFVYPLa;
        "pkg-3.2.12" = _Cw4HVKcl;
        "pkg-3.2.13" = _6suIdxwe;
        "pkg-3.2.13.1" = _e9PltNgD;
        "pkg-3.2.14" = _E2sNGvIc;
        "pkg-3.2.14.1" = _tSW1e6tp;
        "pkg-3.2.14.2" = _72UOUBYZ;
        "pkg-3.2.14.3" = _4KcYmv5N;
        "pkg-3.2.14.4" = _UjawFxz9;
        "pkg-3.2.14.5" = _znKSWMQt;
        "pkg-3.2.14.6" = _3uQyRXcF;
        "pkg-3.2.14.7" = _bXOVIT2t;
        "pkg-3.3.1.0" = _HiucIZvQ;
        "pkg-3.3.1.1" = _OVjvQtmz;
        "pkg-3.3.1.2" = _nq7p6zGC;
        "pkg-3.3.1.3" = _LtpVrWDw;
        "pkg-3.3.1.4" = _Ri0pnZAI;
        "pkg-3.3.1.5" = _G03p1Keb;
        "pkg-3.3.2.0" = _60WykrhP;
        "pkg-3.3.2.1" = _Y40Qeuu0;
        "pkg-3.3.1.6" = _xrK5TYz5;
        "pkg-3.3.2.2" = _ba1FJeHu;
        "pkg-3.3.2.3" = _fZMC747p;
        "pkg-1.20.1-3.5.0-2" = _GWizNHD8;
        "pkg-1.20.1-3.5.3" = _UvPW8Hhq;
        "pkg-1.20.1-3.5.4" = _PwMACpdr;
        "pkg-1.20.1-3.5.5" = _QqSSkJJV;
        "pkg-1.20.1-3.5.6" = _ad0ZgomY;
        "pkg-1.20.1-3.5.8" = _r1lrAzEv;
        "pkg-1.20.1-3.5.9" = _JGY5Chvk;
        "pkg-1.20.1-3.5.10" = _J3VuwToS;
        "pkg-1.20.1-3.5.12" = _HJHhTaaM;
        "pkg-1.20.1-3.5.13" = _61vWWgVF;
        "pkg-1.20.1-3.5.14" = _yYofjSyP;
        "pkg-1.20.1-3.5.15" = _BsvFuXnX;
        "pkg-1.20.1-3.5.16" = _RBpuIKLB;
        "pkg-1.20.1-3.5.17" = _dmSYlUqv;
        "pkg-1.20.1-3.5.18" = _EZf4o99h;
        "pkg-1.20.1-3.5.19" = _O8YO7ORj;
        "pkg-1.21-3.6.2" = _eLFnzQED;
        "pkg-1.21-3.6.4" = _ZoeQMxNQ;
        "pkg-1.21-3.6.5" = _hrAmkZNB;
        "pkg-1.21-3.6.6" = _jslzENUv;
        "pkg-1.21-3.6.7" = _3H96Vbs8;
        "pkg-1.21-3.6.8" = _VDkJwPDR;
        "pkg-1.21-3.6.9" = _WoFuCVy0;
        "pkg-1.21-3.6.10" = _IJ48dsLD;
        "pkg-1.21-3.6.11" = _iNtAJDTZ;
        "pkg-1.21-3.6.12" = _HU12cCW9;
        "pkg-1.21-3.6.13" = _Bxd7BYb9;
        "pkg-1.21-3.6.14" = _AybMKAQK;
        "pkg-1.21-3.6.15" = _AHnGPNjO;
        "pkg-1.21-3.6.16" = _eNQp9Jaj;
        "pkg-1.21-3.6.17" = _vgC06mi1;
        "pkg-1.21-3.6.18" = _ya5aHJ8B;
        "pkg-1.21-3.6.19" = _NNY8y74a;
        "pkg-1.21-3.6.20" = _XvsGVeuy;
        "pkg-1.21-3.6.21" = _knpYGSI0;
        "pkg-1.21-3.6.22" = _os8Rg1zK;
        "pkg-1.21-3.6.23" = _it1Ger39;
        "pkg-1.21-3.6.24" = _aKL8me1V;
        "pkg-1.21-3.6.25" = _91A40Y2T;
        "pkg-1.21-3.6.27" = _erRsRPki;
        "pkg-1.21-3.6.28" = _5fwoNtnY;
        "pkg-1.21-3.6.29" = _W8Gq6xsQ;
        "pkg-1.21-3.6.30" = _kHkAHEUV;
        "pkg-1.21-3.6.33" = _jjGVPHsB;
        "pkg-1.21-3.6.34" = _yZ5KCbgI;
        "pkg-1.20.1-3.5.20" = _yv1oeAG4;
        "pkg-1.20.1-3.5.21" = _4dYJmLsJ;
        "pkg-1.21-3.6.35" = _eLE7eF86;
        "pkg-1.21-3.6.36" = _yNQzysGO;
        "pkg-1.21-3.6.37" = _c5iewpoX;
        "pkg-1.21-3.6.38" = _os5V2Plx;
        "pkg-1.20.1-3.5.22" = _5XXYqEMK;
        "pkg-1.21-3.6.39" = _7otXKx1D;
        "default" = _7otXKx1D;
    });
