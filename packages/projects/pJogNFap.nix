...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _hat2V3ej;
        "pkg-1.0.1-1.18.2" = _BAooAzeQ;
        "pkg-1.0.1-1.19" = _nPdDWO3e;
        "pkg-1.1.0-1.18.2" = _cqjw7MUW;
        "pkg-1.1.0-1.19" = _KyZlYcfx;
        "pkg-1.1.0" = _lwulkVw1;
        "pkg-1.1.0-1.19.4" = _9BANQ8EQ;
        "pkg-2.0.0-1.19" = _Gg6LbVHk;
        "pkg-2.0.0-1.19.3" = _Ve79vCW9;
        "pkg-2.0.0-1.19.4" = _d0XgO2zY;
        "pkg-1.2.0+1.19.2" = _70rTjHs3;
        "pkg-2.2.0-1.19.3" = _beQbBWY8;
        "pkg-2.2.0-1.19.4" = _CkREsIMs;
        "pkg-2.2.1-1.19" = _ghQM9rO1;
        "pkg-2.2.1-1.19.3" = _zj5lSkQD;
        "pkg-2.2.1-1.19.4" = _MZziOSmo;
        "pkg-2.2.1" = _2miscRXW;
        "pkg-2.3.0" = _pVtBmxB6;
        "pkg-2.4.0" = _VlyxAVWS;
        "pkg-2.4.1" = _oXi6DwzD;
        ...
        "pkg-2.5.1" = _fQnpir9a;
        "pkg-2.6.0" = _tL8QATRD;
        "pkg-2.6.1-1.21.3" = _oLNkDNOw;
        "pkg-2.6.1+1.21.4" = _9c0Bw8AD;
        "pkg-2.7.0+1.21.5" = _wT0Haedt;
        "pkg-2.7.0+1.21.7" = _1QkxroMt;
        "pkg-2.7.0+1.21.8" = _jtIrQTQV;
        "pkg-2.8.0+1.21.9" = _WzL9PGHD;
        "pkg-2.7.0+1.21.9" = _FjDze4Ju;
        "pkg-2.8.0+1.21.11" = _wXMkMWnp;
        "pkg-2.8.1+1.21.11" = _VhIGcQJE;
        "pkg-2.8.0+26.1" = _4c7iLjw0;
        "pkg-2.8.1+26.1-neoforge" = _JhGykz7o;
        "pkg-2.8.2+26.1-neoforge" = _cOBUCq6i;
        "pkg-2.8.0+26.2" = _Ra3zz0eG;
        "pkg-2.8.2+26.2-neoforge" = _B8C7aIUR;
        "default" = _B8C7aIUR;
    });
