...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _24sLOfgy;
        "pkg-1.0.4" = _P78GGMUY;
        "pkg-1.0.4+mod" = _F3Ny9LK1;
        "pkg-1.0.5" = _6DQeir6q;
        "pkg-1.0.5+mod" = _XNcoTf8D;
        "pkg-1.0.6" = _SPEScWyl;
        "pkg-1.0.6+mod" = _o7z6On2R;
        "pkg-1.1.0" = _UgXdn4Am;
        "pkg-1.1.0+mod" = _HhXNm8YM;
        "pkg-1.1.1" = _Td3QTrtm;
        "pkg-1.1.1+mod" = _fKW3uV2c;
        "pkg-1.1.2" = _ZX01qige;
        "pkg-1.1.2+mod" = _wBAn70GY;
        "pkg-1.1.3" = _ZOV8ePcX;
        "pkg-1.1.3+mod" = _S8EVCIjZ;
        "pkg-1.2.0" = _DSIGKtex;
        "pkg-1.2.0+mod" = _W3puXdVx;
        "pkg-1.2.1" = _UuUNLXLO;
        "pkg-1.2.1+mod" = _GujfjSQn;
        "pkg-1.2.2" = _sm9lmlvc;
        "pkg-1.2.2+mod" = _ceLuroTv;
        "default" = _ceLuroTv;
    });
