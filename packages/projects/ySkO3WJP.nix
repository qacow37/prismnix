...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.21.2" = _MfTbiGQ6;
        "pkg-1.0.1+1.21.4" = _TAu0pRP3;
        "pkg-1.0.1+1.21.5" = _1UmIrqee;
        "pkg-1.0.2+1.21.5" = _d95PgWGC;
        "pkg-1.0.3+1.21.5" = _1tLxtTB3;
        "pkg-1.0.3+1.21.6" = _EgHbNrZm;
        "pkg-1.0.4+1.21.9-rc1" = _znhd9lkD;
