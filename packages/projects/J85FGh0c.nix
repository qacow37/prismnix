...
let
    ...
    in {
        ...
        "pkg-1.0.0-SNAPSHOT" = _ghfXClR1;
        "pkg-1.0.0-SNAPSHOT2" = _fdGr1wog;
        "pkg-1.0.0-SNAPSHOT3" = _EE2NYftf;
        "pkg-1.0.0-SNAPSHOT4" = _p9eYk2HB;
        "pkg-1.0.0-SNAPSHOT5" = _ka3fGPui;
        "pkg-1.0.0-SNAPSHOT6" = _l7k1USfA;
        "pkg-1.0.0-SNAPSHOT7" = _BJTVxBX7;
        "pkg-1.0.0-SNAPSHOT8" = _N8eP8jN4;
        "pkg-1.0.0-SNAPSHOT9" = _TDl3t5P6;
        "pkg-1.0.0-SNAPSHOT10" = _Kg4dsAGE;
        "pkg-1.0.0-SNAPSHOT11" = _cXrJCl3d;
        "pkg-1.0.0-SNAPSHOT12" = _h5hhJuLh;
        "pkg-1.0.0-SNAPSHOT13" = _1z5ma9vF;
        "pkg-1.0.0-SNAPSHOT14" = _yIdVPFYs;
        "pkg-1.0.0-SNAPSHOT15" = _nCBDw2hg;
        "pkg-1.0.0-SNAPSHOT16" = _AK9MSJ8p;
        "pkg-1.0.0-SNAPSHOT17" = _mGTl2akt;
        "pkg-1.0.0-SNAPSHOT18" = _uZW0ZeLc;
        "pkg-1.0.0-SNAPSHOT19" = _UKaokbWc;
        "pkg-1.0.0-SNAPSHOT20" = _GXHxlaTZ;
        "pkg-1.0.0-SNAPSHOT22" = _c9Vc4e7L;
        "pkg-1.0.0-SNAPSHOT23" = _mmIJ7PcH;
        "pkg-1.0.0-SNAPSHOT24" = _F1JE5YcB;
        "pkg-1.0.0-SNAPSHOT25" = _LGwciChC;
        "pkg-1.0.0-SNAPSHOT26" = _YvS3GZZV;
        "pkg-1.0.0-SNAPSHOT27" = _ORYdILv8;
        "default" = _ORYdILv8;
    });
