...
let
    ...
    in {
        ...
        "pkg-2.1.1" = _PQ0ChNnl;
        "pkg-2.1.2" = _eIgPpJgi;
        "pkg-2.1.3+forge" = _nIutO2R7;
        "pkg-2.1.3+fabric" = _aZ3nWQL6;
        "pkg-2.1.4+forge" = _WZSLTrd3;
        "pkg-2.1.4+fabric" = _rRQykCKd;
        "pkg-2.1.5+forge" = _12KZPU5M;
        "pkg-2.1.5+fabric" = _CCYTIafA;
        "default" = _CCYTIafA;
    });
