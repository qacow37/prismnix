...
let
    ...
    in {
        ...
        "pkg-1.0.0.1" = _JXAZ6UrL;
        "pkg-1.0.0.2" = _KoW0CM5e;
        "pkg-1.0.0.3" = _rSw0W6p8;
        "pkg-1.0.0.4" = _VX4cjxKw;
        "pkg-1.0.0.5" = _nHsLcEU4;
        "pkg-1.0.0.6" = _1AmRQGlH;
        "pkg-1.0.0.7" = _FN4wg0j8;
        "pkg-1.0.0.8" = _8uScEYMv;
        "pkg-1.0.0.9" = _M7KKHvHX;
        "pkg-1.0.0.10" = _RVSUWLDW;
        "pkg-1.0.0.11" = _D5LaaVrY;
        "pkg-1.0.0.12" = _c0lWP2QO;
        "pkg-1.0.0.13" = _E1dSgGIg;
        "pkg-1.0.0.14" = _krCaXBeV;
        "pkg-1.0.0.15" = _m9VJpzrs;
        "pkg-1.0.0.16" = _qmdlsy8x;
        "pkg-1.0.0.17" = _b19Cu4b3;
        "pkg-1.0.0.19" = _dcM65ay7;
        "pkg-1.0.0.20" = _zxY1c3jM;
        "pkg-1.0.0.21" = _oDpN6X1C;
        "pkg-1.0.0.22" = _IbAmm4aG;
        "pkg-1.0.0.23" = _wXpljCLg;
        "pkg-1.0.0.24" = _Dq2Qo6b0;
        "pkg-1.0.0.25" = _5DXoaC9C;
        "pkg-1.0.0.26" = _KJUC8Nfd;
        "pkg-1.0.0.27" = _wjrCpMKb;
        "pkg-1.0.0.28" = _nTn4GH9e;
        "pkg-1.0.0.29" = _WmIhTor8;
        "pkg-1.0.0.30" = _xLb67o4n;
        "pkg-1.0.0.31" = _qa6uffdK;
        "pkg-1.0.0.32" = _aglv1wno;
        "pkg-1.0.0.33" = _lSJeRDpA;
        "pkg-1.0.0.34" = _i61bu6BU;
        "pkg-1.0.0.35" = _KS8A5lKU;
        "pkg-1.0.0.36" = _HRlF7bSf;
        "pkg-1.0.0.37" = _xNX3BDki;
        "pkg-1.0.0.38" = _22WAv7Cf;
        "pkg-1.0.0.39" = _dk9NBb38;
        "pkg-1.0.0.40" = _9335hjeD;
        "pkg-1.0.0.41" = _xYm26re0;
        "pkg-1.0.0.42" = _M8zWtZcc;
        "pkg-1.0.0.43" = _W9OjEIzZ;
        "pkg-1.0.0.44" = _Ntp8FxWx;
        "pkg-1.0.0.45" = _XV55faHx;
        "pkg-1.0.0.46" = _4uou1Py7;
        "pkg-1.0.0.47" = _7l2wXCQG;
        "pkg-1.0.0-pre1" = _ImDrZYWh;
        "pkg-1.0.0-pre2" = _5XTZIbqc;
        "pkg-1.0.0-pre3" = _D4gG3dQg;
        "pkg-1.0.0-pre4" = _EDSNpc7D;
        "pkg-1.0.0-pre5" = _UR8HKPcL;
        "pkg-1.0.0-rc1" = _JzxvHgMW;
        "pkg-1.0.0" = _Tuq2ZMQ6;
        "pkg-1.0.1" = _C2rwy2rF;
        "pkg-1.0.2" = _bVjV8J8F;
        "pkg-1.0.3.1" = _cMOIVL8S;
        "pkg-1.0.3.2" = _cwvrrqit;
        "pkg-1.0.3-rc1" = _cUm8hKTQ;
        "pkg-1.0.3" = _NtfJEyY6;
        "pkg-1.0.4" = _q6ZOAQx5;
        "pkg-1.1.0.1" = _eMlpgjvw;
        "pkg-1.0.5" = _w5zDNQZx;
        "pkg-1.1.0.2" = _UXoJV2BV;
        "pkg-1.1.0.3" = _e6GH3Dm7;
        "pkg-1.1.0.4" = _PkxBy6Og;
        "pkg-1.1.0-pre1" = _SzWNJASe;
        "pkg-1.1.0-pre2" = _wYp7Mi0e;
        "pkg-1.1.0-rc1" = _E9tXBzTe;
        "pkg-1.1.0" = _xxsqGNEu;
        "pkg-1.1.1" = _TNuA1oyw;
        "pkg-1.1.2" = _AD27tzLn;
        "pkg-1.1.3" = _acmvA6U1;
        ...
        "pkg-1.1.7" = _vHF0t7uL;
        "pkg-1.1.8" = _NQE5zWhL;
        "pkg-1.2.0.1" = _vTlTlvOX;
        "pkg-1.2.0.2" = _PKbSVzgF;
        "pkg-1.2.0.3" = _4B4B5P1f;
        "pkg-1.2.0.4" = _HkfWZBgs;
        "pkg-1.2.0-pre1" = _HV1gYrgB;
        "pkg-1.2.0-rc1" = _mPDMhcbA;
        "pkg-1.2.0" = _EYR0BEhp;
        "pkg-1.2.1" = _HQr2NrUz;
        "pkg-1.2.2" = _NngAy8KX;
        "pkg-1.2.3" = _Cvx3liXH;
        "pkg-1.3.0.1" = _UZjiWQ2s;
        "pkg-1.1.9" = _XV8NZ8XK;
        "pkg-1.2.4" = _orijMMeu;
        "pkg-1.3.0.2" = _58e9gQvo;
        "pkg-1.2.5" = _P8aar4cV;
        "pkg-1.3.0.3" = _9mZNJO32;
        "pkg-1.3.0.4" = _YcA5mAqq;
        "pkg-1.3.0-pre1" = _VuLUxap6;
        "pkg-1.3.0-pre2" = _FPLw0em3;
        "pkg-1.1.10" = _PoNGFYo2;
        "pkg-1.3.0-rc1" = _IrAEnYPl;
        "pkg-1.3.0" = _YBIwMJpK;
        "pkg-1.3.1" = _LbVPJi66;
        "default" = _LbVPJi66;
    });
