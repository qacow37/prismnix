...
let
    ...
    in {
        ...
        "pkg-1.14.4-1.0.0" = _qr0E9NFF;
        "pkg-1.14.4-1.0.1" = _DDOqvwIN;
        "pkg-1.14.4-1.0.2" = _gV2819LL;
        "pkg-1.14.4-1.0.3" = _yTM58cg0;
        "pkg-1.14.4-1.0.4" = _zW2fjpLd;
        "pkg-1.14.4-1.0.5" = _yeKn0ygm;
        "pkg-1.14.4-1.0.6" = _3ES0j9nN;
        "pkg-1.14.4-1.0.6b" = _h9X4TvMQ;
        "pkg-1.14.4-1.0.7" = _kdlc3yFx;
        "pkg-1.14.4-1.0.7b" = _aJJ1tBIt;
        "pkg-1.14.4-1.0.8" = _bKyTAjyc;
        "pkg-1.14.4-1.1.0" = _HugPgo14;
        "pkg-1.14.4-1.1.1" = _G9GBlp2X;
        "pkg-1.14.4-1.1.2" = _LGfi7Nra;
        "pkg-1.14.4-1.1.3" = _CdxB0Q6x;
        "pkg-1.14.4-1.2.0" = _7zYkGxsl;
        "pkg-1.14.4-1.2.1" = _QW6gaPYv;
        "pkg-1.14.4-1.2.2" = _pTKb4i7t;
        "pkg-1.14.4-1.3.0" = _dJhGsN2H;
        "pkg-1.14.4-1.3.0b" = _aryK9Zkc;
        "pkg-1.15.2-1.2.2" = _So0fwWwW;
        "pkg-1.15.2-1.3.0" = _jiLe6efM;
        "pkg-1.16.4-1.3.0" = _q6yjXGf4;
        "pkg-1.16.5-1.0.0" = _keBMC05P;
        "pkg-1.16.5-1.4.0" = _2Ix8XpEW;
        "pkg-1.16.5-2.1.0" = _rJCKst0T;
        "pkg-1.16.5-2.2.0" = _olEhoVwT;
        "pkg-1.16.5-2.3.0" = _K3PTEDdv;
        "pkg-1.16.5-2.3.1" = _NGYFaMvv;
        "pkg-1.16.5-2.3.2" = _1L92ozer;
        "pkg-1.18.1-2.3.2" = _yBTybhIP;
        "pkg-1.18.1-2.3.3" = _5zUJbkue;
        "pkg-1.18.2-2.3.3" = _tsQZM1Ka;
        "pkg-1.18.2-2.3.4" = _Bv323sLg;
        "pkg-1.19.2-2.3.4.1" = _YLYYNjmz;
        "pkg-1.19.2-2.3.4.2" = _HFjaF9CG;
        "pkg-1.19.2-2.3.4" = _SslWnCkB;
        "pkg-1.19.2-2.3.4.2b" = _gQeO65E6;
        "pkg-1.19.2-2.3.5" = _wRC7J0DT;
        "pkg-1.19.4-2.3.5" = _7XbDKyYQ;
        "pkg-1.19.3-2.3.5" = _jyL3uT0P;
        "pkg-1.20.1-2.3.5" = _bGJzzdmK;
        "pkg-1.20.1-2.3.6" = _OtAtsIcL;
        "pkg-1.19.2-2.3.6" = _2e6JZJqm;
        "pkg-1.20.1-2.3.7" = _NmhKqRxF;
        "pkg-1.20.1-2.3.8" = _dZBtndf9;
        "pkg-1.20.1-2.3.9" = _KK4OZz0e;
        "default" = _KK4OZz0e;
    });
