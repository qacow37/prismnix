...
let
    ...
    in {
        ...
        "pkg-1.20.1-4.0.0" = _7vnhXGzH;
        "pkg-1.20.1-5.0.1" = _V6GPAonK;
        "pkg-1.19.2-5.0.1" = _cOYUgtA7;
        "pkg-1.19.2-5.0.2" = _twYh6oLo;
        "pkg-1.20.1-5.1.0" = _kua1PFpL;
        "pkg-1.20.1-6.0.0" = _y9ci2U2M;
        "pkg-1.21.1-6.0.0" = _WOcZWh5F;
        "default" = _WOcZWh5F;
    });
