...
let
    ...
    in {
        ...
        "pkg-0.1.0b" = _5Q4seJ7I;
        "pkg-0.1.0c" = _ctgUc323;
        "pkg-0.1.0d" = _JqI5onjN;
        "pkg-0.1.1a" = _KpeovyWk;
        "pkg-0.1.2a" = _yIFmA2af;
        "pkg-0.1.2b" = _fL1nnfiY;
        "pkg-0.1.2c" = _5TTixp0o;
        "pkg-0.1.3a" = _Vp7FDW9t;
        "pkg-0.1.3b" = _KxkGftl7;
        "pkg-0.1.3c" = _xPvXQFd3;
        "pkg-0.1.4a" = _mdP2jxMw;
        "pkg-0.1.4b" = _h7Y0xGqf;
        "pkg-0.1.5a" = _CI5FCfL0;
        "pkg-0.1.5b" = _qAB9sW0I;
        "pkg-0.1.5c" = _kVFs5Mpj;
        "pkg-0.1.6a" = _kWgwUrLy;
        "pkg-0.1.6b" = _983aIIdv;
        "pkg-0.1.7a" = _ZcNwj4T3;
        "pkg-0.1.7b" = _BHOH3yHy;
        "pkg-0.1.8a" = _cU0BLYSW;
        "pkg-0.1.8b" = _jd9uXzlY;
        "pkg-0.1.8c" = _LMZ5oEXd;
        "pkg-0.1.9a" = _e9oSdmnV;
        "pkg-0.1.9b" = _DDnRpkXQ;
        "pkg-0.1.9c" = _h3XzrGRg;
        "pkg-0.1.9d" = _qERv8pIn;
        "pkg-0.2.0a" = _huIzynTx;
        "pkg-0.2.0b" = _Myan0TPZ;
        "pkg-0.2.0c" = _BXKqXOqR;
        "pkg-0.2.0d" = _Yf1lktxd;
        "pkg-0.2.0e" = _6fvsGam2;
        "pkg-0.2.1a" = _w0HEDdOK;
        "pkg-0.2.1b" = _8KqLL07r;
        "pkg-0.2.1c" = _mA44Wlmq;
        "pkg-0.2.2a" = _Ur3XWPSH;
        "default" = _Ur3XWPSH;
    });
