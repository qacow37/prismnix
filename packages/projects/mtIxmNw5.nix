...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.3-fabric" = _HbZccZli;
        "pkg-1.18.2-1.3-fabric" = _ICecpzdE;
        "pkg-1.16.5-1.0-forge" = _lS9jJR0W;
        "pkg-1.18.2-1.1-forge" = _RtNlMDYo;
        "pkg-1.19.2-1.2-forge" = _OBSXZBLF;
        "pkg-1.16.5-1.4-fabric" = _ufR5Wban;
        "pkg-1.18.2-1.4-fabric" = _EjgeDlAf;
        "pkg-1.19.3-1.2-forge" = _A3XjLkWl;
        "pkg-1.18.2-2.0-forge+fabric" = _giJfdEHQ;
        "pkg-1.19.2-2.0-forge+fabric" = _akEtGX5A;
        "pkg-1.19.3-2.0-forge+fabric" = _Xu2C5Uh4;
        "pkg-1.18.2-2.1-forge+fabric" = _6o7BgeQT;
        "pkg-1.19.2-2.1-forge+fabric" = _p0ynk2EC;
        "pkg-1.19.3-2.1-forge+fabric" = _j7O5Drht;
        "pkg-1.18.2-2.2-forge+fabric" = _f2JYjvMh;
        "pkg-1.19.2-2.2-forge+fabric" = _BQosWOm5;
        "pkg-1.19.3-2.2-forge+fabric" = _KFHEu13L;
        "pkg-1.19.4-2.2-forge+fabric" = _HY8RtnaD;
        "pkg-1.20-2.2-forge+fabric" = _DN9Ba2oF;
        "pkg-1.20.1-2.2-forge+fabric" = _RmvGb8QA;
        "pkg-1.20.2-2.2-forge+fabric" = _50a3SYhQ;
        "pkg-1.18.2-2.3-forge+fabric" = _h537vgeM;
        "pkg-1.19.2-2.3-forge+fabric" = _K1OZ5i6g;
        "pkg-1.20.1-2.3-forge+fabric" = _HW0mDSQG;
        "pkg-1.20.2-2.3-forge+fabric" = _mTTyZYln;
        "pkg-1.20.3-2.3-fabric+forge+neo" = _11oqNbmB;
        "pkg-1.20.4-2.3-fabric+forge+neo" = _KCVqhdAd;
        "pkg-1.19.2-2.4-fabric+forge+neo" = _a2m4KbVj;
        "pkg-1.20.1-2.4-fabric+forge+neo" = _ktV9znlj;
        "pkg-1.20.2-2.4-fabric+forge+neo" = _YHugyEJu;
        "pkg-1.20.4-2.4-fabric+forge+neo" = _pbD5CJb4;
        "pkg-1.20.5-2.4-fabric+neo" = _49oxLrY5;
        "pkg-1.20.6-2.4-fabric+forge+neo" = _JjbNEKxj;
        "pkg-1.19.2-2.5-fabric+forge" = _mB18gdqL;
        "pkg-1.20.1-2.5-fabric+forge+neo" = _btRYPafH;
        "pkg-1.20.4-2.5-fabric+forge+neo" = _c67g93wS;
        "pkg-1.20.6-2.5-fabric+forge+neo" = _GZH6Zg8L;
        "pkg-1.21.0-2.5-fabric+forge+neo" = _g4i0JvP8;
        "pkg-1.20.1-2.6-fabric+forge+neo" = _L4DZu2GJ;
        "pkg-1.20.6-2.6-fabric+forge+neo" = _3vh1WOki;
        "pkg-1.21.0-2.6-fabric+forge+neo" = _nov4NOAU;
        "pkg-1.21.1-2.6-fabric+forge+neo" = _Fyj9kAJx;
        "pkg-1.21.2-2.6-fabric+neo" = _bZRXjEAb;
        "pkg-1.21.3-2.6-fabric+forge+neo" = _8amYoiuO;
        "pkg-1.21.4-2.6-fabric+forge+neo" = _AzUoqwI3;
        "pkg-1.20.1-2.7-fabric+forge+neo" = _7hR11cdx;
        "pkg-1.21.1-2.7-fabric+forge+neo" = _pZx92IVZ;
        "pkg-1.21.4-2.7-fabric+forge+neo" = _Oap19ZAB;
        "pkg-1.21.5-2.7-fabric+forge+neo" = _p12aUQb8;
        "pkg-1.21.6-2.7-fabric+forge+neo" = _3RqXgzRK;
        "pkg-1.21.7-2.7-fabric+forge+neo" = _APX7D0A0;
        "pkg-1.21.8-2.7-fabric+forge+neo" = _UiEnUDWT;
        "pkg-1.21.9-2.7-fabric+forge+neo" = _Qo5Dd4mg;
        "pkg-1.21.9-2.8-fabric+forge+neo" = _OjBmEpgX;
        "pkg-1.21.10-2.8-fabric+forge+neo" = _QFVjKrp6;
        "pkg-1.21.11-2.8-fabric+forge+neo" = _i1zJ2y0r;
        "pkg-26.1.0-2.8-fabric+forge+neo" = _MiRXku7g;
        "pkg-26.1.0-2.9-fabric+forge+neo" = _JvGwDn8m;
        "pkg-26.1.1-2.9-fabric+forge+neo" = _R1MT6zcM;
        "pkg-26.1.2-2.9-fabric+forge+neo" = _S3tGMg61;
        "pkg-26.2.0-2.9-fabric+forge+neo" = _Z48JKtJp;
        "default" = _Z48JKtJp;
    });
