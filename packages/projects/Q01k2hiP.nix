...
let
    ...
    in {
        ...
        "pkg-1.1.8" = _wGWsPqht;
        "pkg-1.1.9" = _Wx4NV9jI;
        "pkg-1.1.10" = _hbL6IZAl;
        "pkg-1.1.11" = _1aQeDJ2b;
        "pkg-1.1.12" = _r7w9447X;
        "pkg-1.1.13" = _NvHyVvZ0;
        "pkg-1.1.14" = _9P7hygsD;
        "pkg-1.1.15" = _2TzYGxvI;
        "pkg-1.1.16" = _6uEAqNLr;
        "pkg-1.1.17" = _daUu1Gu9;
        "pkg-1.1.18" = _Nd3LqHk4;
        "default" = _Nd3LqHk4;
    });
