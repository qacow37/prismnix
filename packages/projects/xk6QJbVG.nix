...
let
    ...
    in {
        ...
        "pkg-fabric-0.1.0-1.20.1" = _I3psV2uH;
        "pkg-forge-0.1.0-1.20.1" = _xEQDnJwG;
        "pkg-fabric-0.1.0-1.21" = _rU62QQ6Q;
        "pkg-neoforge-0.1.0-1.21" = _CAcWrQGN;
        "pkg-neoforge-0.1.1-1.21" = _yrMOIjWW;
        "default" = _yrMOIjWW;
    });
