...
let
    ...
    in {
        ...
        "pkg-1.17" = _UW7k36Ci;
        "pkg-1.17.1" = _uaav3A0f;
        "pkg-1.18" = _wcxO9tuy;
        "pkg-1.18.1" = _sPcynvHl;
        "pkg-1.18.2" = _xt9h1ORZ;
        "pkg-1.19" = _6yUU0dad;
        "pkg-1.19.1" = _lrJnRPG4;
        "pkg-1.19.2" = _GIVTSOwK;
        "pkg-1.19.3" = _Taz8Ae4G;
        "pkg-1.19.4" = _gV3zrOfF;
        "pkg-1.20" = _QV8DZHge;
        "pkg-1.20.1" = _EtaLjbuT;
        "pkg-1.20.2" = _IKR9ifgt;
        "pkg-1.20.3" = _CTIbUGtx;
        "pkg-1.20.4" = _OXWgRY4z;
        "pkg-1.21" = _WRKoer5D;
        "pkg-1.0.0" = _PsRaK3Nh;
        "pkg-1.21.1" = _WawF48ip;
        "pkg-1.21.2" = _BnOhi1Mj;
        "pkg-1.21.3" = _PVRsWX86;
        "pkg-1.21.4-1.0.0" = _YHd5KeIs;
        "pkg-1.21.5-1.0.0" = _lFmOTFbH;
        "default" = _lFmOTFbH;
    });
