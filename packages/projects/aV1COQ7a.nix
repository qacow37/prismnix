...
let
    ...
    in {
        ...
        "pkg-2.3.3" = _1hJuekS7;
        "pkg-2.4.0" = _zz7EL9j5;
        "pkg-1.20.5-2.6.0" = _RgvVQfIZ;
        "pkg-1.20.6-2.6.1" = _I5tPVSIi;
        "pkg-1.21-2.7.0" = _7lAqbP6Q;
        "pkg-1.21.1-2.7.1" = _c7G8h5PL;
        "pkg-1.21.1-2.7.2" = _6IJXNRan;
        "pkg-1.21.1-2.7.3" = _ddFC8ZOi;
        "pkg-1.21.1-2.7.4" = _A6m2d7By;
        "default" = _A6m2d7By;
    });
