...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _xp9Y5eiJ;
        "pkg-1.5_01.1" = _8oCUoulj;
        "pkg-1.5_01.2" = _tuW4QFnt;
        "pkg-1.5_01.3" = _g7Ef9LX5;
        "pkg-3.2.0" = _TBKOJuoP;
        "pkg-3.2.1" = _SiUEDIyh;
        "pkg-3.2.2" = _rCk2nUqQ;
        "pkg-3.2.0pre1" = _vFI8rvom;
        "pkg-3.2.0pre2" = _c78oy5ri;
        "pkg-3.2.0pre3" = _7NBxsYKK;
        "pkg-3.2.0pre4" = _dE0mzC6N;
        "pkg-3.2.0pre5" = _NvODeg1p;
        "pkg-3.2.0pre6" = _KCowlXAp;
        "pkg-3.2.0pre7" = _igd6IQV3;
        "pkg-3.3.0" = _XBIrzw0l;
        "pkg-3.4.0" = _7ozcZZ9R;
        "pkg-3.4.2" = _WM5ghax3;
        "pkg-3.4.3" = _bjZPAwI3;
        ...
        "pkg-6.0.8" = _QJZtaw6c;
        "pkg-6.0.9" = _F7ukB4Xo;
        "pkg-6.0.10" = _hhb1jVSn;
        "pkg-6.0.11" = _F5y6UBdA;
        "pkg-6.0.12" = _J3kIqIr1;
        "pkg-6.0.13" = _mhUDjs57;
        "pkg-6.0.14" = _eNECkxVr;
        "pkg-6.0.15" = _MEFktl4t;
        "pkg-6.0.16" = _JzK8SkNr;
        "pkg-6.0.17" = _hCZneExj;
        "pkg-6.0.18" = _XErBDziU;
        "pkg-6.1.0" = _Ctaq8UnP;
        "pkg-6.1.1" = _8mesPtrc;
        "pkg-6.1.2" = _huU9i7Cp;
        "pkg-6.1.3" = _P5Y9tRNT;
        ...
        "pkg-6.4.8" = _ZMAZIMQd;
        "pkg-6.4.9" = _FtjSnjfK;
        "pkg-6.4.10" = _NBv1R9Qf;
        "pkg-6.4.11" = _Z3uab6LD;
        "pkg-6.4.12" = _NRUX3hjR;
        "pkg-6.4.13" = _2xS69PHk;
        "pkg-6.4.14" = _gOVK79iJ;
        "pkg-6.4.15" = _PtEuX2yX;
        "pkg-6.4.16" = _35Gew83a;
        "pkg-6.4.17" = _wJmw3RA0;
        "pkg-6.4.18" = _yYsAIZNn;
        "pkg-7.0.0" = _A1HNZbdP;
        "pkg-7.0.1" = _3rOUm3gD;
        "pkg-7.0.2" = _FWEozrOD;
        "pkg-7.0.3" = _fikulxgO;
        ...
        "pkg-7.0.8" = _qD2IbaH0;
        "pkg-7.0.9" = _XMQNRVDN;
        "pkg-7.0.10" = _mmf30zh4;
        "pkg-7.0.11" = _bPtGYhL2;
        "pkg-7.0.12" = _6Gllp3zq;
        "pkg-7.0.13" = _uvi0ItFC;
        "pkg-7.0.14" = _LqeqhixB;
        "pkg-7.0.15" = _YA4RzvNd;
        "pkg-7.0.16" = _AhwABe1U;
        "pkg-7.0.17" = _XxvMra06;
        "pkg-7.0.18" = _TnWF5yYI;
        "pkg-7.0.19" = _ookeupWi;
        "pkg-7.0.20" = _70T91gQG;
        "pkg-7.0.21" = _SYImJnhl;
        "pkg-7.0.22" = _b590PscK;
        "pkg-7.0.23" = _iosrD1m0;
        "pkg-7.0.24" = _1JK8gldn;
        "pkg-7.0.25" = _CvZqTWrk;
        "pkg-7.0.26" = _MouxCEnh;
        "pkg-7.1.0" = _Kt3ePzG1;
        "pkg-7.1.1" = _p2JWC0TT;
        "pkg-7.1.2" = _LD4gHCbB;
        "pkg-7.1.3" = _IhQDCABX;
        ...
        "pkg-7.1.8" = _9ppdkf2z;
        "pkg-7.1.9" = _hncrNJsf;
        "pkg-7.1.10" = _N6QNGqeM;
        "pkg-7.1.11" = _hFW781JA;
        "pkg-7.1.12" = _jDOw7pNs;
        "pkg-7.1.13" = _WCb65Wub;
        "pkg-7.1.14" = _eF8mOxyf;
        "pkg-7.1.15" = _rgQG2S9W;
        "pkg-7.1.16" = _hSP4qiy2;
        "pkg-7.1.17" = _8TmoNofy;
        "pkg-7.1.18" = _Fr64SDED;
        "pkg-7.1.19" = _Z8Z2GIQL;
        "pkg-7.1.20" = _X1bfTpz5;
        "pkg-7.2.0" = _SPiR42d0;
        "pkg-7.2.1" = _ZQVfpNdU;
        "pkg-7.2.2" = _8VeWsDLN;
        "pkg-7.2.3" = _naNLhn9e;
        ...
        "pkg-7.2.7" = _anL9gxAE;
        "pkg-7.2.8" = _b6IRhKDz;
        "pkg-7.1.21" = _48riNMFK;
        "pkg-7.1.22" = _2CqAVwZq;
        "pkg-7.1.23" = _8fK9j0oy;
        "pkg-7.1.24" = _ViyoCrKW;
        "pkg-7.1.25" = _sMbzfhJy;
        "pkg-3.4.5" = _hYxfmgS8;
        "pkg-3.7.3" = _rLUalQva;
        "pkg-7.1.26" = _BiTYhSlB;
        "pkg-7.99.0" = _1i9SDwKl;
        "pkg-7.99.1" = _5gO2YQY5;
        "pkg-7.99.2" = _KGxVZY7b;
        "pkg-7.99.3" = _NtpMCmtj;
        "pkg-7.99.4" = _3VxHLeWs;
        "pkg-7.99.5" = _PL5oclZF;
        "pkg-7.99.6" = _mUHIShtz;
        "pkg-7.99.7" = _VWlwEc3S;
        "pkg-7.99.8" = _ejNGvEwY;
        "pkg-7.99.8.1" = _RJl1C96o;
        "pkg-7.99.8.2" = _pyQPscXJ;
        "pkg-7.99.12" = _dvYtFMwT;
        "pkg-7.99.13" = _h6r9KPz9;
        "pkg-7.99.14" = _u1EsxkXt;
        "pkg-7.99.15" = _EBKPj8DP;
        "pkg-7.99.16" = _Tu7xt0iw;
        "pkg-7.99.17" = _mSlRkteT;
        "pkg-7.99.18" = _UqdM8TdB;
        "pkg-7.99.19" = _USWX4Qr9;
        "pkg-7.99.20" = _JqzSYs8c;
        "pkg-7.99.21" = _CQ1DCggn;
        "pkg-7.99.22" = _FIHxZr8b;
        "pkg-7.99.23" = _XZ3LuQgS;
        "pkg-7.99.24" = _UNegEMAq;
        "pkg-7.99.24.1" = _GzorFb1m;
        "pkg-7.99.24.2" = _imZQAh6G;
        "pkg-7.99.24.3" = _MYlzmfMj;
        "pkg-7.99.24.4" = _PtKnjXwb;
        "pkg-7.99.24.5" = _rvz7KxwD;
        "pkg-7.99.24.6" = _s4MgRVKk;
        "pkg-7.99.24.7" = _5W5pPHp8;
        "pkg-7.99.24.8" = _XTvlyqvk;
        "pkg-7.1.27" = _piN3RkPa;
        "pkg-8.0.0" = _6Nm5Msmd;
        "pkg-3.4.6" = _h90CHvwb;
        "pkg-3.7.4" = _hYyWfNmt;
        "default" = _hYyWfNmt;
