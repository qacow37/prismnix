...
let
    ...
    in {
        ...
        "pkg-1" = _xu6mi1rj;
        "pkg-1.0_mod" = _foc8x9Dc;
        "pkg-1.1" = _aZq6lLmN;
        "pkg-1.2" = _OOBR5VQx;
        "pkg-1.2+mod" = _EEtiHXjn;
        "pkg-1.3" = _DJCJy2Z4;
        "pkg-1.3+mod" = _Q9HXiluK;
        "pkg-2.0" = _rfoD4kSU;
        "pkg-2.0+mod" = _A9dyc7ct;
        "pkg-3.0" = _gVKYrtdi;
        "pkg-3.0+mod" = _W7heRVLF;
        "pkg-3.1" = _fvyKpszs;
        "pkg-4.0" = _KPGfak6y;
        "pkg-4.0+mod" = _6lxcGogm;
        "pkg-4.1" = _ztZXRRxS;
        "pkg-4.1+mod" = _F7PPxCRG;
        "pkg-4.2" = _VekWTrA9;
        "pkg-4.2+mod" = _zIxCICSi;
        "pkg-4.3" = _1LUB88Wd;
        "pkg-4.3+mod" = _ACZgDmXE;
        "pkg-4.4" = _wi7KZSfp;
        "pkg-4.4+mod" = _DVD4UvRl;
        "pkg-4.5" = _iW09EFWI;
        "pkg-4.5+mod" = _yGsh6Hyi;
        "pkg-4.6" = _RU8FwXh5;
        "pkg-4.6+mod" = _uR14ilNy;
        "pkg-4.7" = _RcAHPRzP;
        "pkg-4.7-fabric" = _8VrQc0BW;
        "pkg-4.7-forge" = _C9Wu7N5U;
        "pkg-4.11" = _7c4LHNde;
        "pkg-4.11-fabric" = _erjQBu64;
        "pkg-4.11-quilt" = _IptC1umD;
        "pkg-4.11-forge" = _wPNnnNDR;
        "pkg-4.11-neoforge" = _2KW4vY8f;
        "pkg-4.12" = _EuD7xxN7;
        "pkg-4.12-fabric" = _ajZYqAuP;
        "pkg-4.12-quilt" = _XcQ7binZ;
        "pkg-4.12-forge" = _LJDglTnx;
        "pkg-4.12-neoforge" = _Umm4aoFM;
        "default" = _Umm4aoFM;
    });
