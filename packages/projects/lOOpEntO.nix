...
let
    ...
    in {
        ...
        "pkg-9.0.2" = _5i8cnhHt;
        "pkg-9.0.5" = _GqHS3No8;
        "pkg-10.0.1" = _ekJQu9eX;
        "pkg-10.1.2" = _V2sZfGZ9;
        "pkg-10.1.3" = _9GJHTfue;
        "pkg-11.0.1" = _uEbi6Xkg;
        "pkg-12.0.1" = _U19owoad;
        "pkg-13.0.1" = _TQiqNvD9;
        "pkg-13.0.2" = _ZxUp6vgd;
        "pkg-12.0.2" = _8RGearAk;
        "pkg-11.0.2" = _th3YfV05;
        "pkg-11.0.3" = _hVsa3JJd;
        "pkg-12.0.3" = _Vbz8pwb8;
        "pkg-13.0.3" = _WOvxX2lr;
        "pkg-11.0.4" = _jnhW5VaZ;
        "pkg-13.0.4" = _TJFB90aP;
        "pkg-13.0.5" = _Ki9VOsWw;
        "pkg-14.0.1" = _ZfLj4Yv8;
        "pkg-10.1.4" = _8us1FakC;
        "pkg-14.0.2" = _faBIQKaU;
        "pkg-15.0.1" = _2CqoWXFe;
        "pkg-15.0.2" = _mFAudhGF;
        "pkg-15.1.3" = _z0Cg572G;
        "pkg-16.0.1" = _cSTWE9cu;
        "pkg-17.0.1" = _A8NdzVY8;
        "pkg-17.1.2" = _CpvfFwkw;
        "pkg-17.1.3" = _tpBJqwWE;
        "pkg-18.0.1" = _EAAquIie;
        "pkg-1.0.12" = _ip7KQeBK;
        "pkg-17.2.4" = _I65bHWcF;
        "pkg-17.2.5" = _X3nlVK64;
        "pkg-17.2.6" = _wkhqxp1Q;
        "pkg-18.0.2" = _RI4sWcBO;
        "pkg-19.0.1" = _nXXStfhl;
        "pkg-19.1.2" = _xlL1HNMV;
        "pkg-20.0.1" = _YCmZhRO9;
        "pkg-20.0.2" = _pstYUA40;
        "pkg-17.2.7" = _SD6j6TWD;
        "pkg-21.0.1" = _6AiILf8q;
        "pkg-21.0.2" = _Y09GwS1A;
        "pkg-21.0.3" = _XAsKgBxc;
        "pkg-22.0.1" = _oAPOEZOh;
        "pkg-22.0.2" = _ZPZI5mAG;
        "pkg-21.0.4" = _Y42wjyly;
        "pkg-22.0.3" = _umTqvP2X;
        "pkg-23.0.1" = _cZrgJ3bC;
        "pkg-24.0.1" = _eMw4fAKK;
        "pkg-24.0.2" = _xnk0kHVU;
        "pkg-21.1.1" = _ZCwf6Z1s;
        "pkg-21.1.2" = _a0oKmnPU;
        "pkg-21.2.1" = _hjnL1mh0;
        "pkg-21.3.1" = _LAPepqOd;
        "pkg-21.4.1" = _u1cXWyB9;
        "pkg-21.5.1" = _2CznbMv6;
        "pkg-21.6.2" = _pXFCSc8V;
        "pkg-21.7.1" = _edtlA58C;
        "pkg-21.8.1" = _BvSsyK23;
        "pkg-21.10.1" = _ncDm5UcE;
        "pkg-21.2.2" = _AA1STvOE;
        "pkg-21.2.3" = _l1SPIN08;
        "pkg-21.3.2" = _Ne7Ltxcu;
        "pkg-21.4.2" = _pwlfFBQ9;
        "pkg-21.5.2" = _yhqaj6IH;
        "pkg-21.6.3" = _wKnMK8qC;
        "pkg-21.7.2" = _iBC98CLJ;
        "pkg-21.8.2" = _fls1ys3y;
        "pkg-21.9.2" = _4x9Sfyqs;
        "pkg-21.10.2" = _D2Z5kaC0;
        "pkg-21.1.3" = _XwbErf6s;
        "pkg-21.11.1" = _1dUbnqyo;
        "pkg-21.0.5" = _9PvB3nqH;
        "pkg-26.1.2.1" = _gDPpvyOb;
