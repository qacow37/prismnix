...
let
    ...
    in {
        ...
        "pkg-8.0.4" = _EX1o1SQ2;
        "pkg-8.0.5" = _NITbgx8t;
        "pkg-10.0.1" = _GwR5SgCf;
        "pkg-10.0.4" = _xx5IJyF3;
        "pkg-11.0.1" = _wc7EF3RO;
        "pkg-12.0.1" = _84workll;
        "pkg-12.1.2" = _RoC9yOWQ;
        "pkg-13.0.1" = _OjvUVcI8;
        "pkg-14.0.1" = _UFdRYX63;
        "pkg-16.0.1" = _Dpoi26Uy;
        "pkg-17.0.1" = _mlgiNYkq;
        "pkg-18.0.1" = _xOkNSe39;
        "pkg-18.0.2" = _kJ2qphQ5;
        "pkg-19.0.1" = _L5UN9KgL;
        "pkg-19.0.3" = _2N0l7V0L;
        "pkg-19.0.4" = _LCqResV8;
        "pkg-20.0.1" = _YQmpciwC;
        "pkg-21.0.1" = _EB3djB0x;
        "pkg-21.0.2" = _mB8FU2lO;
        "pkg-21.1.1" = _CQXbbFTw;
        "pkg-21.1.2" = _Cx9DFSjg;
        "pkg-18.0.3" = _aMi8rtag;
