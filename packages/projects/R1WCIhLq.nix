...
let
    ...
    in {
        ...
        "pkg-1" = _iyYmjuGm;
        "pkg-1.0_mod" = _EbI4r2uJ;
        "pkg-1.1" = _CS79bSSP;
        "pkg-1.2" = _9YHjq13T;
        "pkg-1.2+mod" = _TNJkNsAJ;
        "pkg-1.3" = _Q1wGM1ki;
        "pkg-1.3+mod" = _sa5i7KHV;
        "pkg-2.0" = _A1QzW5kO;
        "pkg-2.0+mod" = _LHDJ39K1;
        "pkg-3.0" = _xL3gmI2j;
        "pkg-3.0+mod" = _1ToEb5aL;
        "pkg-3.1" = _fi39scMy;
        "pkg-4.0" = _zh6dOkhr;
        "pkg-4.0+mod" = _1udhyrfc;
        "pkg-4.1" = _LGYqFj6B;
        "pkg-4.1+mod" = _rRP5r8yI;
        "pkg-4.2" = _yAJVYZ0d;
        "pkg-4.2+mod" = _InxpyECb;
        "pkg-4.3" = _QvXpoZr0;
        "pkg-4.3+mod" = _UA2TNxwv;
        "pkg-4.4" = _i8uybCKM;
        "pkg-4.4+mod" = _TpxfPf8o;
        "pkg-4.5" = _Q7Fnlre4;
        "pkg-4.5+mod" = _tqkS3NMa;
        "pkg-4.6" = _kdB5wsRF;
        "pkg-4.6+mod" = _R4c2gLiZ;
        "pkg-4.7" = _r5j3YAun;
        "pkg-4.7-fabric" = _YQDWIVeb;
        "pkg-4.7-forge" = _DT6TnmZq;
        "pkg-4.8" = _RIrTyX31;
        "pkg-4.8-fabric" = _ch5M0GCD;
        "pkg-4.8-forge" = _HmchPuLr;
        "pkg-4.12" = _X67eLXYu;
        "pkg-4.12-fabric" = _sdPtTVfH;
        "pkg-4.12-quilt" = _txvYJ0pT;
        "pkg-4.12-forge" = _aHYtryXY;
        "pkg-4.12-neoforge" = _JriKWBlu;
        "pkg-4.13" = _LmjJhMk7;
        "pkg-4.13-fabric" = _TCHlqmn0;
        "pkg-4.13-quilt" = _Q6nTjn9C;
        "pkg-4.13-forge" = _pXgph4dJ;
        "pkg-4.13-neoforge" = _m8WZqSe8;
        "default" = _m8WZqSe8;
    });
