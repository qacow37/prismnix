...
let
    ...
    in {
        ...
        "pkg-1.0.1-beta.2+fabric" = _1qSlX6cx;
        "pkg-1.0.1-beta.2+forge" = _1uEftdBn;
        "pkg-1.0.1+fabric" = _tzY4iL49;
        "pkg-1.0.1+forge" = _pVzXA2yS;
        "pkg-1.1.0-beta.1+fabric" = _dNLsZIi9;
        "pkg-1.1.0-beta.1+forge" = _AqO1Si72;
        "pkg-1.0.2+fabric" = _TFc1NVqS;
        "pkg-1.0.2+forge" = _2uq3BLSY;
        "pkg-1.1.0-beta.2+fabric" = _p5liIPc1;
        "pkg-1.1.0-beta.2+forge" = _TubAnGbr;
        "pkg-1.0.3+fabric" = _YW1VnhIW;
        "pkg-1.0.3+forge" = _nNRa0Bs7;
        "pkg-1.1.0+forge" = _bn0ghnST;
        "pkg-1.1.0+fabric" = _6b2qZboD;
        "pkg-1.2.0+1.19.3+fabric" = _TNZncDs2;
        "pkg-1.2.0+1.19.3+forge" = _T3MdPRXZ;
        "pkg-1.2.0+1.20.1+fabric" = _ZR9K8kfv;
        "pkg-1.2.0+1.20.1+forge" = _PyXrBJgF;
        "pkg-1.2.2+1.19.3+fabric" = _j3QKdCoZ;
        "pkg-1.2.2+1.19.3+forge" = _YRU8ndCR;
        "pkg-1.2.2+1.20.1+forge" = _u77jHajt;
        "pkg-1.2.2+1.20.1+fabric" = _wYpASxDG;
        "pkg-1.3.0-1.19.3+forge" = _AdY1IBYa;
        "pkg-1.3.0-1.19.3+fabric" = _SErO8cZF;
        "pkg-1.3.0-1.20.1+fabric" = _aNjnAI02;
        "pkg-1.3.0-1.20.1+forge" = _MWxmPdEh;
        "pkg-1.4.0-1.19.3+fabric" = _EcSwCRdd;
        "pkg-1.4.0-1.19.3+forge" = _4TABo7aB;
        "pkg-1.4.0-1.20.1+fabric" = _nMpVupIW;
        "pkg-1.4.0-1.20.1+forge" = _J8ThGPgs;
        "pkg-1.4.3-1.20.1+fabric" = _P6bG9Yy3;
        "pkg-1.4.3-1.20.1+forge" = _7AHybrra;
        "pkg-1.4.3-1.19.3+forge" = _uLUTt8wD;
        "pkg-1.4.3-1.19.3+fabric" = _eRvjWsUp;
        "pkg-1.5.0-1.20.4+forge" = _KcBnyvRg;
        "pkg-1.5.0-1.20.4+fabric" = _BHoonkM7;
        "pkg-1.5.1+1.20.4" = _6nRAKtIv;
        "pkg-1.5.2+1.20.4-fabric" = _jSkR7UbP;
        "pkg-1.5.2+1.20.4-forge" = _B7Yijwt9;
        "pkg-1.5.3+1.20.4-fabric" = _Y98o1wRl;
        "pkg-1.5.3+1.20.4-forge" = _NLM6nTOE;
        "pkg-1.6.1+1.20.6" = _Qjyg4hRy;
        "pkg-1.7.0+1.21-fabric" = _PrQ3bjSU;
        "pkg-1.7.0+1.21-neoforge" = _DJH1cCbY;
        "pkg-1.8.0+1.21.1-fabric" = _LeFzY9bu;
        "pkg-1.8.0+1.21.1-neoforge" = _2dTBdZ5S;
        "pkg-1.9.0-beta.1+neoforge" = _xuxJOAnJ;
        "pkg-1.9.0-beta.1+fabric" = _CoeTEsFm;
        "pkg-1.9.0+fabric" = _uukxV4sy;
        "pkg-1.9.0+neoforge" = _u5EaZfEG;
        "pkg-1.10.0+fabric" = _pb7gpHSW;
        "pkg-1.10.0+neoforge" = _tpdFG45n;
        "pkg-1.10.1+neoforge" = _1NnkyyOP;
        "pkg-1.10.1+fabric" = _Bjiel8Bo;
        "pkg-1.10.2+fabric" = _y9gJIX0S;
        "pkg-1.10.2+neoforge" = _zpx7VlJd;
        "pkg-1.10.3+fabric" = _ag7pNnnF;
        "pkg-1.10.3+neoforge" = _AW1nMdTX;
        "pkg-1.11.0+fabric" = _XcfW0cFz;
        "pkg-1.11.0+neoforge" = _mu4N42Is;
        "pkg-1.11.1+neoforge" = _ccKXuI1W;
        "pkg-1.11.1+fabric" = _KFvXVlRV;
        "pkg-1.12.0-alpha.1+fabric" = _QYrOHixG;
        "pkg-1.12.0-alpha.1+neoforge" = _qK2uIDT4;
        "pkg-1.12.0-alpha.2+neoforge" = _B0P9TIjV;
