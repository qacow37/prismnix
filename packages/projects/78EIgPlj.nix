...
let
    ...
    in {
        ...
        "pkg-1.20.2-1.1.0+forge" = _BkaH6dOp;
        "pkg-1.20.2-2.0.0+neoforge" = _O3caoghX;
        "pkg-1.20.2-3.0.0+fabric" = _ytENPazq;
        "pkg-1.20.2-3.0.0+forge" = _XGfimpcA;
        "pkg-1.20.2-3.0.0+neoforge" = _OK012jYV;
        "pkg-1.20.2-3.0.1+fabric" = _JSWft5tb;
        "pkg-1.20.2-3.0.1+forge" = _LoFEygaz;
        "pkg-1.20.2-3.0.1+neoforge" = _23KSv0rZ;
        "pkg-1.20.4-3.1.0+fabric" = _Q8yC5KtI;
        "pkg-1.20.4-3.1.0+forge" = _AQSjRVgP;
        "pkg-1.20.4-3.1.0+neoforge" = _tzXhT0mN;
        "pkg-1.20.4-3.1.1+forge" = _uLQBlRUd;
        "pkg-1.20.4-3.1.1+neoforge" = _bMPPoWAE;
        "pkg-1.20.4-3.1.1+fabric" = _mkBMN1nv;
        "pkg-1.20.1-2.1.0+forge" = _qjzwV0D0;
        "pkg-1.20.1-2.1.0+fabric" = _l11yTrOp;
        "pkg-1.20.2-3.0.2+forge" = _kvUyot7F;
        "pkg-1.20.2-3.0.2+neoforge" = _7rJv95N4;
        "pkg-1.20.2-3.0.2+fabric" = _nrjSXWTQ;
        "pkg-1.20.4-4.0.0+fabric" = _bhJQRD4T;
        "pkg-1.20.4-4.0.0+forge" = _c3cEJg6d;
        "pkg-1.20.4-4.0.0+neoforge" = _waQTkhpr;
        "pkg-1.20.4-4.0.1+fabric" = _ubRkr8WI;
        "pkg-1.20.4-4.0.1+forge" = _f2g7fONP;
        "pkg-1.20.4-4.0.1+neoforge" = _DLEuIv6J;
        "pkg-1.20.6-4.1.0+fabric" = _ANGKeLRb;
        "pkg-1.20.6-4.1.0+forge" = _mfcnzE8C;
        "pkg-1.20.6-4.1.0+neoforge" = _Zo4SJMh0;
        "pkg-1.21-4.2.0+fabric" = _JQeQZYZa;
        "pkg-1.21-4.2.0+forge" = _SEifGlJz;
        "pkg-1.21-4.2.0+neoforge" = _pbpiFEbD;
        "pkg-1.20.1-2.2.0+fabric" = _R62RiHAk;
        "pkg-1.20.1-2.2.0+forge" = _LseccB3p;
        "pkg-1.20.4-4.3.0+fabric" = _BU8nIUdy;
        "pkg-1.20.4-4.3.0+forge" = _1H6MhMUx;
        "pkg-1.20.4-4.3.0+neoforge" = _AtWeLVdx;
        "pkg-1.21.3-5.0.0+fabric" = _WyrSYDi4;
        "pkg-1.21.3-5.0.0+forge" = _nwAvjzZp;
        "pkg-1.21.3-5.0.0+neoforge" = _lrmUxtLc;
        "pkg-1.21.X-6.0.0+fabric" = _ovctbiER;
        "pkg-1.21.X-6.0.0+forge" = _a29wRClP;
        "pkg-1.21.X-6.0.0+neoforge" = _1JuVSBMB;
        "pkg-1.21.X-6.1.0+fabric" = _pUjd4bWy;
        "pkg-1.21.X-6.1.0+forge" = _IM6fBwei;
        "pkg-1.21.X-6.1.0+neoforge" = _RHKUGqbz;
        "pkg-26.1-6.1.0+fabric" = _wC1vL4NH;
        "pkg-26.1-6.1.0+forge" = _s1ZXWThs;
        "pkg-26.1-6.1.0+neoforge" = _HM5TVznz;
