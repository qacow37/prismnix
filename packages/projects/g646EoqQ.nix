...
let
    ...
    in {
        ...
        "pkg-1.12.2-1.0" = _GXx4KhFP;
        "pkg-1.13.2-2.0-pre1" = _cbxkRsEM;
        "pkg-FORGE-1.14.4-2.0" = _ORaXRx93;
        "pkg-FORGE-1.15.1-3.0" = _9lE0TN05;
        "pkg-1.16.5-5.0.0.3" = _l2NJlmVs;
        "pkg-1.3.0-1.16.4" = _SS64hPxu;
        "pkg-1.17.1-5.0.0.5" = _gvq62EqJ;
        "pkg-1.4.0-1.17" = _Nvq2GuUt;
        "pkg-1.18-5.1.0.0" = _HvAGre6I;
        "pkg-1.4.1-1.18.2" = _iAHWCSm6;
        "pkg-6.0.0+1.19.2" = _alGS0Kqw;
        "pkg-6.0.1+1.19.3" = _cn7mn3lM;
        "pkg-6.0.1+1.19.4" = _P1fckW4E;
        "pkg-6.1.0+1.20.1" = _Re0JYf63;
        "pkg-7.0.0+1.20.2" = _kZ0Isz4Z;
        "pkg-6.1.1+1.20.1" = _HiPCHCmr;
        "pkg-8.0.0+1.20.4" = _Frv9dzwW;
        "pkg-6.2.0+1.20.1" = _dp0wT78Q;
        "pkg-9.0.0+1.20.6" = _YFKRsJe8;
        "pkg-10.0.0+1.21" = _pvFt0A8W;
        "pkg-10.0.1+1.21.1" = _EaDMwEYt;
        "pkg-11.0.0+1.21.3" = _aNElr6kt;
        "pkg-12.0.0+1.21.4" = _wsDlIzIT;
        "pkg-12.1.0+1.21.8" = _EVHfqZR2;
        "pkg-12.2.0+1.21.10" = _I618fd6e;
        "default" = _I618fd6e;
    });
