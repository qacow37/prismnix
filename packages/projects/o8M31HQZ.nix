...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _2zUnFPpI;
        "pkg-1.1.1" = _pbJk0WLi;
        "pkg-1.2.0-1.20" = _o86TmlXs;
        "pkg-1.2.1-1.20.2" = _CgCRgNdO;
        "pkg-1.3.0-1.20" = _OX9rJWkM;
        "pkg-1.3.0-1.20.2" = _2cf57mYi;
        "pkg-1.3.1-1.20" = _7csjgwAM;
        "pkg-1.3.1-1.20.2" = _q5Qp726E;
        "pkg-1.4.0-1.20.3" = _T0giH6S4;
        "pkg-2.0.0-1.20" = _n6M1JMzl;
        "pkg-2.0.0-1.20.2" = _GcOdzmNd;
        "pkg-2.0.0-1.20.5" = _aEtOMCcG;
        "pkg-2.1.0-1.20.5" = _f6UDT2eq;
        "pkg-2.1.1-1.21.2" = _RyGG3xsv;
        "pkg-2.1.2-1.21.2" = _xAzKmUkG;
        "pkg-2.2.0-1.21.2" = _pqPdid9n;
        "pkg-2.2.1-1.21.2" = _taDwJT1L;
        "pkg-2.2.1-1.21.9" = _hy79Yd0J;
        "pkg-2.2.2-1.21.11" = _77w6OZjT;
