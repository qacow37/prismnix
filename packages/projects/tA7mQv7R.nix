...
let
    ...
    in {
        ...
        "pkg-5.6.6g" = _gsMg2C38;
        "pkg-5.6.7" = _oEVO5MM0;
        "pkg-5.6.7b" = _VKYjuZwf;
        "pkg-5.6.7c" = _x49u4bbN;
        "pkg-5.6.7d" = _TZCwbOmX;
        "pkg-5.6.7e" = _JkiG3uS8;
        "pkg-5.6.7f" = _ghR3Iz5N;
        "pkg-5.6.7f+mod" = _4KcNqmI2;
        "pkg-5.6.7g" = _rSdJ8CBO;
        "pkg-5.6.7g+mod" = _WjNWO6NS;
        "pkg-5.6.8" = _gokNKuNC;
        "pkg-5.6.8a" = _ePKYle7q;
        "pkg-5.6.8a+mod" = _nu0PqeXJ;
        "pkg-5.6.8b" = _aksyr6ry;
        "pkg-5.6.8b+mod" = _3yDCHY0w;
        "pkg-5.6.8c" = _aHeGWXNS;
        "pkg-5.6.8ca" = _HJAgHqr4;
        "pkg-5.6.8d" = _bDfHirWu;
        "pkg-5.6.8d+mod" = _m6lQMrmz;
        "pkg-5.6.9" = _ugLGoexA;
        "pkg-5.6.9+mod" = _IgH2lJbO;
        "pkg-5.6.9a" = _wW3wfnmc;
        "pkg-5.6.9a+mod" = _onAwwxDJ;
        "pkg-5.6.9b" = _iVV1sz2t;
        "pkg-5.6.9b+mod" = _VeZX2TRB;
        "pkg-5.6.9c" = _yXWpWVyM;
        "pkg-5.6.9c+mod" = _2V8JegEj;
        "default" = _2V8JegEj;
    });
