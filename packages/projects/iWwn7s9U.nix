...
let
    ...
    in {
        ...
        "pkg-1.16.5-3.1-fabric" = _fazFLUeU;
        "pkg-1.18.2-3.1-fabric" = _nep0eNW3;
        "pkg-1.19.2-3.2-fabric" = _yV223ens;
        "pkg-1.16.5-2.7-forge" = _60ka3x61;
        "pkg-1.18.2-2.8-forge" = _KkGALKWX;
        "pkg-1.19.2-3.0-forge" = _D7aFRHxQ;
        "pkg-1.16.5-3.3-fabric" = _SO3GziaG;
        "pkg-1.18.2-3.3-fabric" = _4gt8jimS;
        "pkg-1.19.2-3.3-fabric" = _KF9DAKU0;
        "pkg-1.19.3-3.4-fabric" = _TUqnG8oL;
        "pkg-1.19.3-3.0-forge" = _Xz2zU6sr;
        "pkg-1.18.2-4.0-forge+fabric" = _soz4VpBt;
        "pkg-1.19.2-4.0-forge+fabric" = _S0gBa4cj;
        "pkg-1.19.3-4.0-forge+fabric" = _3wdRAWIi;
        "pkg-1.18.2-4.1-forge+fabric" = _ALIVeLPe;
        "pkg-1.19.2-4.1-forge+fabric" = _M2VXrPcC;
        "pkg-1.19.3-4.1-forge+fabric" = _zEFLWgtZ;
        "pkg-1.18.2-4.2-forge+fabric" = _gT33M4bJ;
        "pkg-1.19.2-4.2-forge+fabric" = _gNma2cu9;
        "pkg-1.19.3-4.2-forge+fabric" = _4XyxcZbV;
        "pkg-1.18.2-4.3-forge+fabric" = _RSDqcS4U;
        "pkg-1.19.2-4.3-forge+fabric" = _oWyTc5fS;
        "pkg-1.19.3-4.3-forge+fabric" = _cjJ6tqsI;
        "pkg-1.18.2-4.4-forge+fabric" = _pf3iCGM3;
        "pkg-1.19.2-4.4-forge+fabric" = _kiebY7Wl;
        "pkg-1.19.3-4.4-forge+fabric" = _fNEwUr2w;
        "pkg-1.18.2-4.5-forge+fabric" = _R231NWBI;
        "pkg-1.19.2-4.5-forge+fabric" = _fZdTZVjW;
        "pkg-1.19.3-4.5-forge+fabric" = _nE82hfsy;
        "pkg-1.19.4-4.5-forge+fabric" = _5DWQQw9E;
        "pkg-1.20-4.5-forge+fabric" = _VgLxLqJx;
        "pkg-1.20.1-4.5-forge+fabric" = _nhg51bKo;
        "pkg-1.18.2-4.6-forge+fabric" = _sJMpAQtC;
        "pkg-1.19.2-4.6-forge+fabric" = _Yu0JdK0E;
        "pkg-1.19.4-4.6-forge+fabric" = _63RUtJtg;
        "pkg-1.20.1-4.6-forge+fabric" = _jrvNGfvq;
        "pkg-1.20.2-4.6-forge+fabric" = _EBvnUxQk;
        "pkg-1.18.2-4.7-forge+fabric" = _HxpfOibn;
        "pkg-1.19.2-4.7-forge+fabric" = _drnERoGX;
        "pkg-1.20.1-4.7-forge+fabric" = _yoQ1gZH0;
        "pkg-1.20.2-4.7-forge+fabric" = _3YBdnoDT;
        "pkg-1.20.2-4.8-forge+fabric" = _oR90hDEk;
        "pkg-1.20.3-4.8-fabric+forge+neo" = _d0gJ6mAs;
        "pkg-1.20.4-4.8-fabric+forge+neo" = _46RMVyuX;
        "pkg-1.19.2-4.9-fabric+forge+neo" = _eM0mgQAr;
        "pkg-1.20.1-4.9-fabric+forge+neo" = _HexLnjGE;
        "pkg-1.20.2-4.9-fabric+forge+neo" = _oPuXyljV;
        "pkg-1.20.4-4.9-fabric+forge+neo" = _7sD61pX4;
        "pkg-1.19.2-5.0-fabric+forge" = _tNoZRemN;
        "pkg-1.20.1-5.0-fabric+forge+neo" = _Q6XB1AWg;
        "pkg-1.20.2-5.0-fabric+forge+neo" = _ZOtbaw5e;
        "pkg-1.20.4-5.0-fabric+forge+neo" = _mhLH6xep;
        "pkg-1.20.5-5.0-fabric+neo" = _RFUApIOw;
        "pkg-1.20.5-5.1-fabric+neo" = _D4w3cTPg;
        "pkg-1.20.6-5.1-fabric+forge+neo" = _O5g4Bh19;
        "pkg-1.21.0-5.1-fabric+forge+neo" = _d6rN0BOR;
        "pkg-1.20.1-5.2-fabric+forge+neo" = _WCUmBJ90;
        "pkg-1.20.6-5.2-fabric+forge+neo" = _IZCHJ8vs;
        "pkg-1.21.0-5.2-fabric+forge+neo" = _UlhSEQaJ;
        "pkg-1.21.1-5.2-fabric+forge+neo" = _WcCfUo0W;
        "pkg-1.21.2-5.2-fabric+neo" = _I5KmO6S9;
        "pkg-1.21.3-5.2-fabric+forge+neo" = _mw6AE4Rs;
        "pkg-1.21.4-5.2-fabric+forge+neo" = _YMbsXdSz;
        "pkg-1.20.1-5.3-fabric+forge+neo" = _7QESwGii;
        "pkg-1.21.1-5.3-fabric+forge+neo" = _zgSwmV99;
        "pkg-1.21.4-5.3-fabric+forge+neo" = _nrTIAiIr;
        "pkg-1.21.5-5.3-fabric+forge+neo" = _5YAYHDcC;
        "pkg-1.21.6-5.3-fabric+forge+neo" = _npl7nUFJ;
        "pkg-1.21.7-5.3-fabric+forge+neo" = _6aAUzPpk;
        "pkg-1.21.8-5.3-fabric+forge+neo" = _W3mYXClp;
        "pkg-1.21.9-5.3-fabric+forge+neo" = _jdqr4hNm;
        "pkg-1.21.10-5.3-fabric+forge+neo" = _nHbPGQlT;
        "pkg-1.21.11-5.3-fabric+forge+neo" = _ZXIaITrF;
        "pkg-26.1.0-5.3-fabric+forge+neo" = _VJRD9fXy;
        "pkg-26.1.1-5.3-fabric+forge+neo" = _7BB7s7G3;
        "pkg-26.1.2-5.3-fabric+forge+neo" = _w3Ur42Uz;
        "pkg-26.2.0-5.3-fabric+forge+neo" = _8tNj2gMn;
        "default" = _8tNj2gMn;
    });
