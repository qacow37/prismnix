...
let
    ...
    in {
        ...
        "pkg-2.0.0" = _vUEzioPM;
        "pkg-2.1.0" = _T3mS1HZV;
        "pkg-2.1.0-fabric" = _XpCjMrFQ;
        "pkg-2.1.1-fabric" = _CkmWtJ5I;
        "pkg-2.1.2-fabric" = _SM4UJwrY;
        "pkg-2.1.3-forge" = _bZlsJF0i;
        "pkg-2.1.3-fabric" = _qAyQ399B;
        "pkg-2.1.4-fabric" = _S5HS166D;
        "pkg-2.1.4-forge" = _LFELJPr2;
        "pkg-2.1.5-forge" = _OGjeARIS;
        "pkg-2.1.5-fabric" = _xIKNnVto;
        "pkg-2.1.6-fabric" = _2jpLGZMq;
        "pkg-2.1.7-fabric" = _W5cmy6Bh;
        "pkg-2.1.8-fabric" = _b3PPL6Rw;
        "pkg-2.1.9-fabric" = _2WW13K8D;
        "pkg-2.2.0-forge" = _nFAR2jwC;
        "pkg-2.2.0-fabric" = _odFeKNqe;
        "pkg-2.2.1-fabric" = _wnT4Ues1;
        "pkg-2.2.1-forge" = _QrJwm8XG;
        "pkg-2.3.0-fabric" = _2RyaGsIV;
        "pkg-2.3.0-forge" = _SrTKkMNx;
        "pkg-2.3.1-fabric" = _UUTs3FPM;
        "pkg-2.4.0-fabric" = _jp86UBCj;
        "pkg-2.4.0-forge" = _iPHGCgdp;
        "pkg-2.4.1-fabric" = _sXER6Cyf;
        "pkg-2.4.2-fabric" = _QPIbFawd;
        "pkg-2.4.3-fabric" = _lCkz2dUC;
        "pkg-2.4.4-fabric" = _tPkuN7mn;
        "pkg-2.4.4-forge" = _XWkK0wK7;
        "pkg-2.4.5-fabric" = _Sy4c3rpC;
        "default" = _Sy4c3rpC;
    });
