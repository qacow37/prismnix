...
let
    ...
    in {
        ...
        "pkg-random_1.15-1.20.6" = _2L34CgNc;
        "pkg-name-specified_1.15-1.20.6" = _69ltNliF;
        "pkg-random_1.21.x" = _qSr54Pvr;
        "pkg-name-specified_1.21.x" = _9nmydPvX;
        "pkg-latest" = _XMlfmBb4;
        "default" = _XMlfmBb4;
    });
