...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.21.11-fabric" = _bbaXU29b;
        "pkg-1.1.0+1.21.11-neoforge" = _fpySs5z9;
        "pkg-1.1.1+0.8.4-mc1.21.11-fabric" = _9lCV5s7X;
        "pkg-1.1.1+0.8.4-mc1.21.11-neoforge" = _bYl1Wd2l;
        "pkg-1.1.2+0.8.5-mc1.21.11-fabric" = _vhhjLLO7;
        "pkg-1.1.2+0.8.5-mc1.21.11-neoforge" = _rN4oKsmO;
        "pkg-1.1.3+0.8.6-mc1.21.11-fabric" = _veXSKTqv;
        "pkg-1.1.3+0.8.6-mc1.21.11-neoforge" = _nLb8mYsQ;
        "pkg-1.1.4+0.8.7-mc1.21.11-fabric" = _ONK2677Q;
        "pkg-1.1.4+0.8.7-mc1.21.11-neoforge" = _9jY0ZJpc;
        "pkg-1.1.4+0.8.7-mc26.1-fabric" = _ZbVIBVly;
        "pkg-1.1.5+0.8.9-mc26.1.1-fabric" = _ekqQU9By;
        "pkg-1.1.5+0.8.9-mc26.1.1-neoforge" = _ss1z3dAC;
        "pkg-1.2.0+0.8.10-mc26.1.2-fabric" = _1lP2OZuF;
        "pkg-1.2.0+0.8.10-mc26.1.2-neoforge" = _LgEG6JUs;
        "pkg-1.1.6+0.8.11-mc1.21.11-fabric" = _PhZxQYfw;
        "pkg-1.1.6+0.8.11-mc1.21.11-neoforge" = _No8xRM1e;
        "pkg-1.2.1+0.8.11-mc26.1.2-fabric" = _TUCMwgkI;
        "pkg-1.2.1+0.8.11-mc26.1.2-neoforge" = _khmJEW9K;
        "pkg-1.2.2+0.8.12-mc26.1.2-fabric" = _p8p8RzcR;
        "pkg-1.2.2+0.8.12-mc26.1.2-neoforge" = _vScOC6dG;
        "pkg-1.1.7+0.8.12-mc1.21.11-fabric" = _jzf2v8eZ;
        "pkg-1.1.7+0.8.12-mc1.21.11-neoforge" = _NdSfzzxY;
        "pkg-1.1.8+0.8.12-mc1.21.11-fabric" = _HYeHw7Mp;
        "pkg-1.1.8+0.8.12-mc1.21.11-neoforge" = _yzDr7Q4v;
        "pkg-1.3.0+0.9.0-mc26.1.2-fabric" = _5vlSHoEa;
        "pkg-1.3.0+0.9.0-mc26.1.2-neoforge" = _GfGXKgYT;
        "pkg-1.3.0+0.9.0-mc26.2-fabric" = _swS2zLbu;
        "pkg-1.3.0+0.9.0-mc26.2-neoforge" = _MssiOFDc;
        "pkg-1.3.1+0.9.1-mc26.1.2-fabric" = _cZKqeV24;
