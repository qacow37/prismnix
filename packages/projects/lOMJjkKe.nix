...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _iGAjgwAg;
        "pkg-1.0.1" = _i9oME4of;
        "pkg-1.1.0-beta.3" = _7J1RIGRE;
        "pkg-1.1.0-pre.1" = _iLKPMwkv;
        "pkg-1.1.0-pre.2" = _QdBGUQpD;
        "pkg-1.1.0" = _fWsBtsmA;
        "pkg-1.1.1" = _AqyU9z3U;
        "pkg-1.2.0-alpha.1" = _jmfQS4eK;
        "pkg-1.2.0-alpha.2" = _2v6xDgMZ;
        "pkg-1.2.0-beta.1" = _ET5zNyVB;
        "pkg-1.2.0-beta.2" = _8shAl53r;
        "pkg-1.2.0-beta.3" = _P4Mf3d8I;
        "pkg-1.2.0-beta.3.1" = _jQiibows;
        "pkg-1.2.0" = _mmzlKkf3;
        "pkg-1.2.1" = _O47po8eb;
        "pkg-1.2.2" = _LpIrr5pi;
        "pkg-1.2.3" = _7vTQ923B;
        "pkg-1.2.3.1" = _Z8BFO9Pn;
        "pkg-1.2.4" = _5G2AfbmY;
        "pkg-1.3.0-alpha.1+mc1.20.1" = _L5tADM8K;
        "pkg-1.3.0-alpha.1+mc1.20.2" = _jITwJUsK;
        "pkg-1.3.0-alpha.1+mc1.20.5" = _MlfE0GSa;
        "pkg-1.3.0-alpha.2+mc1.20.1" = _1kUhsIAg;
        "pkg-1.3.0-alpha.2+mc1.20.2" = _Lip79B1J;
        "pkg-1.3.0-alpha.2+mc1.20.5" = _5Q66E8wo;
        "pkg-1.3.0-alpha.3+mc1.20.1" = _4XRz3Y16;
        "pkg-1.3.0-alpha.3+mc1.20.2" = _7dTtatmt;
        "pkg-1.3.0-alpha.3+mc1.20.5" = _5OUPzqQy;
        "pkg-1.3.0-beta.1+mc1.20.1" = _nEgzXp5e;
        "pkg-1.3.0-beta.1+mc1.20.5" = _kOqHURQV;
        "pkg-1.3.0-beta.1.1+mc1.20.1" = _oUkKDdjH;
        "pkg-1.3.0-beta.1.1+mc1.20.5" = _oAZwJUm5;
        "pkg-1.3.0-beta.2+mc1.20.1" = _BhoZMTHX;
        "pkg-1.3.0-beta.2+mc1.20.5" = _XJiJ2CG9;
        "pkg-2.0.0-alpha.1" = _NlcfnCPI;
        "pkg-2.0.0-alpha.2" = _Ty0nwm7Q;
        "pkg-2.0.0-alpha.2.1" = _pEnYWHnj;
        "pkg-2.0.0-alpha.2.2+mc1.21.8" = _8xwMF67S;
        "pkg-2.0.0-alpha.3+mc26.2" = _q1wZutEF;
        "pkg-2.0.0-alpha.3.1" = _Ds8MWuip;
        "default" = _Ds8MWuip;
    });
