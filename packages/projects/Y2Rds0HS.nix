...
let
    ...
    in {
        ...
        "pkg-4.0.3" = _6Xl2tU8K;
        "pkg-4.0.4" = _GtIsq3lV;
        "pkg-4.1.0+forge" = _IW19pLPR;
        "pkg-4.1.0+fabric" = _ts61kSE5;
        "pkg-4.1.1+forge" = _LydHtOPs;
        "pkg-4.1.1+fabric" = _jQENT2Q1;
        "pkg-4.1.2+fabric" = _YBz3w2EU;
        "pkg-4.1.2+forge" = _FZUkMnCt;
        "default" = _FZUkMnCt;
    });
