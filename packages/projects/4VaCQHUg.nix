...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _m7nXIJrp;
        "pkg-1.18.2-1.0.1" = _flvJC16W;
        "pkg-1.19.2-1.0.1" = _AVikE0yO;
        "pkg-1.20.1-1.0.1" = _ZbNZNUBr;
        "pkg-1.21.1-1.0.1" = _WzgkQ57Z;
        "pkg-1.18.2-1.0.2" = _M6QZcvKN;
        "pkg-1.19.2-1.0.2" = _9BB1zaEd;
        "pkg-1.20.1-1.0.2" = _D5ipFvqr;
        "pkg-1.21.1-1.0.2" = _ctZWzu9N;
        "pkg-1.18.2-1.0.3" = _bimWUFt5;
        "pkg-1.19.2-1.0.3" = _q3UiBCCh;
        "pkg-1.20.1-1.0.3" = _VXeS92aP;
        "pkg-1.21.1-1.0.3" = _YJI5NcyQ;
        "pkg-1.18.2-1.0.4" = _ZPAGgLBP;
        "pkg-1.19.2-1.0.4" = _14CZjyYq;
        "pkg-1.20.1-1.0.4" = _1TbtAp9S;
        "pkg-1.21.1-1.0.4" = _WQ1B2lDA;
        "pkg-1.18.2-1.0.5" = _crsan4FF;
        "pkg-1.19.2-1.0.5" = _h3BxnwsD;
        "pkg-1.20.1-1.0.5" = _YJGkoRRW;
        "pkg-1.21.1-1.0.5" = _Wi6LLYAE;
        "pkg-1.18.2-1.0.6" = _8pvPpPOU;
        "pkg-1.19.2-1.0.6" = _qmHMdPsK;
        "pkg-1.20.1-1.0.6" = _Vbn4gdUx;
        "pkg-1.21.1-1.0.6" = _qnOZkEmJ;
        "pkg-1.21.3-1.0.6" = _p07HB7hY;
        "pkg-1.18.2-1.1.0" = _F94imh5K;
        "pkg-1.19.2-1.1.0" = _vtAq6NVR;
        "pkg-1.20.1-1.1.0" = _SssQlHMO;
        "pkg-1.18.2-1.1.1" = _FQ4O4HS3;
        "pkg-1.19.2-1.1.1" = _frQTNLAd;
        "pkg-1.20.1-1.1.1" = _DdEmzJI1;
        "pkg-1.18.2-1.1.2" = _KSclPS6i;
        "pkg-1.19.2-1.1.2" = _qKDh05Zo;
        "pkg-1.20.1-1.1.2" = _CHDfSRHP;
        "pkg-1.18.2-1.1.3" = _OarJJMOD;
        "pkg-1.19.2-1.1.3" = _OURLwZNa;
        "pkg-1.20.1-1.1.3" = _vXNGDzM3;
        "pkg-1.18.2-1.1.4" = _ufgZh8P2;
        "pkg-1.19.2-1.1.4" = _1wS9uzF7;
        "pkg-1.20.1-1.1.4" = _PdKkjaWJ;
        "pkg-1.18.2-1.1.5" = _HpkOjYDD;
        "pkg-1.19.2-1.1.5" = _jVvCQZsI;
        "pkg-1.20.1-1.1.5" = _MfUdUrKp;
        "pkg-1.18.2-1.1.6" = _ewwWQVJs;
        "pkg-1.19.2-1.1.6" = _Cfn2g3Ci;
        "pkg-1.20.1-1.1.6" = _cljmhwZC;
        "default" = _cljmhwZC;
    });
