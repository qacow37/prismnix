...
let
    ...
    in {
        ...
        "pkg-2.0.16" = _w60BBWjS;
        "pkg-2.0.17" = _toPTsfcD;
        "pkg-2.0.18" = _oVQoqyvk;
        "pkg-2.0.19" = _tgRLDh35;
        "pkg-2.0.20" = _YOKwId5Z;
        "pkg-2.0.21" = _GwmUQu29;
        "pkg-2.0.22" = _7km3QixP;
        "pkg-2.0.23" = _mFv4apLy;
        "pkg-2.0.24" = _jI1BUvWL;
        "pkg-2.0.25" = _Z2ompZ97;
        "pkg-2.0.26" = _QKns6hTI;
        "pkg-2.0.27" = _5qdIMp3y;
        "pkg-2.0.28" = _QFJ3rpAX;
        "pkg-2.0.29" = _HzuCK5ny;
        "pkg-2.0.30" = _GCpJV8zZ;
        "pkg-2.0.31" = _fUdn8MeF;
        "pkg-2.0.32" = _hy5sDLG6;
        "pkg-2.0.33" = _y9UKeWmz;
        "pkg-2.0.34" = _PF4xleRQ;
        "pkg-2.0.35" = _6DBtG2Iz;
        "pkg-2.0.36" = _CoZtKUy9;
