...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _5irf3zeo;
        "pkg-1.1.0" = _Mczwf5Dx;
        "pkg-1.1.0+mod" = _NsRq7deU;
        "pkg-1.2.0" = _GLREO4Aj;
        "pkg-1.2.0+mod" = _cmuWb6VM;
        "pkg-1.3.0" = _sfX3yflN;
        "pkg-1.3.0+mod" = _grBzk3L1;
        "pkg-1.4.0" = _GdbVco4E;
        "pkg-1.4.0+mod" = _TndkkPmc;
        "pkg-1.4.1" = _XbzXwnkD;
        "pkg-1.4.1+mod" = _5s1AnuME;
        "pkg-1.4.2" = _C8Uhs8Ij;
        "pkg-1.4.2+mod" = _uh7J2Ajw;
        "pkg-1.4.3" = _50dnUZ5j;
        "pkg-1.4.3+mod" = _o8XuBQFi;
        "pkg-1.4.4" = _hbxxPwUx;
        "pkg-1.4.4+mod" = _XT1TFNID;
        "pkg-1.4.5" = _O3H6ZUkl;
        "pkg-1.4.5+mod" = _Tr1Wf675;
        "pkg-1.5.0-rc1" = _lHHrk48g;
        "pkg-1.5.0-rc1+mod" = _wW2HVE2s;
        "pkg-1.5.0-rc2" = _8Y2N24Jn;
        "pkg-1.5.0-rc2+mod" = _maZZcups;
        "pkg-1.5.0" = _rQueKJoU;
        "pkg-1.5.0+mod" = _SAAvMiiO;
        "pkg-1.5.1" = _19wFgOws;
        "pkg-1.5.1+mod" = _gsZD2FEE;
        "pkg-1.5.1.1+mod" = _tSgum8ON;
        "pkg-1.6.0" = _1OoLDOpA;
        "pkg-1.6.0+mod" = _xx0tlHCj;
        "pkg-1.4.5.1+mod" = _X1s2esDE;
        "pkg-1.6.1" = _b8vTAbYu;
        "pkg-1.6.1+mod" = _gNxqVuhV;
        "pkg-1.7.0.1" = _gaXNJDcM;
        "pkg-1.7.0.1+mod" = _HqQqbiWQ;
        "pkg-1.7.0.0" = _BapcAD2o;
        "pkg-1.7.0.0+mod" = _Cb6btGux;
        "pkg-1.7.1.0" = _tbp2tSgy;
        "pkg-1.7.1.0+mod" = _K3oGrTja;
        "pkg-1.7.1.1" = _gY7DwrqJ;
        "pkg-1.7.1.1+mod" = _JB7irEFK;
        "pkg-1.7.2.0" = _9pSRO8tw;
        "pkg-1.7.2.0+mod" = _Gz1gE3wP;
        "pkg-1.7.2.1" = _692jjjkx;
        "pkg-1.7.2.1+mod" = _F08KFibA;
        "pkg-1.7.3.0" = _p3ym3QJE;
        "pkg-1.7.3.0+mod" = _jXYJ4ZNW;
        "pkg-1.7.3.1" = _2Lz26S7z;
        "pkg-1.7.3.1+mod" = _zS1kjIeR;
        "pkg-1.7.4.0" = _GabhB9p6;
        "pkg-1.7.4.0+mod" = _Ml4rzGQ1;
        "pkg-1.7.4.1" = _o3wudD43;
        "pkg-1.7.4.1+mod" = _GiceBInv;
        "pkg-1.8.0.0" = _fBuO6EwR;
        "pkg-1.8.0.0+mod" = _G2qf1m7s;
        "pkg-1.8.0.1" = _9IKtpipN;
        "pkg-1.8.0.1+mod" = _iQtYXWwR;
        "pkg-1.8.1.1" = _kAB3u9g5;
        "pkg-1.8.1.1+mod" = _BHBjoimy;
        "pkg-1.8.1.0(fix)" = _wKsEknl5;
        "pkg-1.8.1.0(fix)+mod" = _zPQOdKCL;
        "pkg-1.8.2.0" = _laHSwCTq;
        "pkg-1.8.2.0+mod" = _wKXksy8I;
        "pkg-1.8.2.1" = _EivDdWyk;
        "pkg-1.8.2.1+mod" = _kbE4LONQ;
        "pkg-1.8.3.0" = _8b4EvyZd;
        "pkg-1.8.3.0+mod" = _ccvh2xrr;
        "pkg-1.8.3.1" = _PFXLUNiK;
        "pkg-1.8.3.1+mod" = _cJFMQm3t;
        "pkg-1.8.4.0" = _LhF7xlFk;
        "pkg-1.8.4.0+mod" = _dNHUQme7;
        "pkg-1.8.4.1" = _RmOg2lRY;
        "pkg-1.8.4.1+mod" = _NbUlTYPe;
        "pkg-1.8.5.0" = _xSAPoP28;
        "pkg-1.8.5.0+mod" = _7ZuM2NEM;
        "pkg-1.8.5.1" = _QB4D8SGa;
        "pkg-1.8.5.1+mod" = _9GIElVx3;
        "pkg-1.8.5.2" = _azJuhj7p;
        "pkg-1.8.5.2+mod" = _3TbPnoNG;
        "pkg-1.8.6.0" = _orSZZzO4;
        "pkg-1.8.6.0+mod" = _cXax4zdn;
        "pkg-1.8.6.1" = _FqEf9xbT;
        "pkg-1.8.6.1+mod" = _aYR9UO4e;
        "pkg-1.8.6.2" = _BSwX8n7W;
        "pkg-1.8.6.2+mod" = _LRy2dv63;
        "pkg-1.8.7.0" = _UEWmRrmt;
        "pkg-1.8.7.0+mod" = _3pnLPbiB;
        "pkg-1.8.7.1" = _u6fmTIMa;
        "pkg-1.8.7.1+mod" = _i08FQH8b;
        "pkg-1.8.7.2" = _1hF1z8OF;
        "pkg-1.8.7.2+mod" = _lA78TDB9;
        "pkg-1.8.8.0" = _Lbm8tvLF;
        "pkg-1.8.8.0+mod" = _fuELR2p8;
        "pkg-1.8.8.1" = _lnyWr4si;
        "pkg-1.8.8.1+mod" = _9o7CPhnn;
        "pkg-1.8.8.2" = _hT9HKB52;
        "pkg-1.8.8.2+mod" = _XyyQaG9i;
        "pkg-1.8.9.0" = _6rJodQUX;
        "pkg-1.8.9.0+mod" = _gyrIHR1K;
        "pkg-1.8.9.1" = _uPmEThNI;
        "pkg-1.8.9.1+mod" = _6CkkoLBA;
        "pkg-1.8.9.2" = _QU7EUGhF;
        "pkg-1.8.9.2+mod" = _YNPqDxzk;
        "pkg-1.9.0.0" = _uYGb8yxp;
        "pkg-1.9.0.0+mod" = _fCXqaKmf;
        "pkg-1.9.0.1" = _frdLDAOU;
        "pkg-1.9.0.1+mod" = _J7dnOcwA;
        "pkg-1.9.0.2" = _d50qX2KN;
        "pkg-1.9.0.2+mod" = _a4DAEtDS;
        "pkg-1.9.1.0" = _QGwvrNad;
        "pkg-1.9.1.0+mod" = _I5BrILom;
        "pkg-1.9.1.1" = _HixRI4rP;
        "pkg-1.9.1.1+mod" = _Nw08d7DX;
        "pkg-1.9.1.2" = _u4AFr71o;
        "pkg-1.9.1.2+mod" = _ZefqHEh6;
        "pkg-1.9.1.3" = _5CrwWq6f;
        "pkg-1.9.1.3+mod" = _VS5daqbw;
        "pkg-1.9.1.4" = _1szYaMym;
        "pkg-1.9.1.4+mod" = _8Yu2qkXv;
        "pkg-1.9.2.0" = _PDprIFn1;
        "pkg-1.9.2.1" = _cL0UuBAJ;
        "pkg-1.9.2.2" = _rYE0b3wT;
        "pkg-1.9.2.3" = _d05sjQvD;
        "pkg-1.9.2.0+mod" = _xoiG4Lje;
        "pkg-1.9.2.1+mod" = _892RacNJ;
        "pkg-1.9.2.2+mod" = _G2pzMQ7O;
        "pkg-1.9.2.3+mod" = _OakS83gK;
        "default" = _OakS83gK;
    });
