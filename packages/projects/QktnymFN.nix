...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _hI0s7CpB;
        "pkg-1.0.9" = _swskwjBS;
        "pkg-1.0.10" = _NN0kTmV2;
        "pkg-1.0.11" = _qKcA42BD;
        "pkg-1.0.12" = _9RYqJpi0;
        "pkg-1.0.13" = _syivp4Qe;
        "pkg-1.0.14" = _5hzajkE4;
        "pkg-1.0.15" = _HQQdJ4XS;
        "pkg-1.0.16" = _IGCsnFYK;
        "pkg-1.0.17" = _H7DtdbNU;
        "pkg-1.0.18" = _NkWRvtiJ;
        "default" = _NkWRvtiJ;
    });
