...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _FIhmjUEc;
        "pkg-v1.1.1" = _6tOcIAQz;
        "pkg-v1.1.2" = _yHpmuQyF;
        "pkg-v1.2" = _pVcPElxA;
        "pkg-v1.2.1" = _5kEuDC4c;
        "pkg-v1.2.1+mod" = _h64T72kT;
        "pkg-v1.2.2" = _WouOO2lW;
        "pkg-v1.2.2+mod" = _tJZAYcxU;
        "pkg-v1.3.0" = _Wrcln29Y;
        "pkg-v1.3.0+mod" = _XM22JETA;
        "pkg-v1.5.0" = _QY6CBUNJ;
        "pkg-v1.5.0+mod" = _5RyiKCpp;
        "pkg-1.0.0+mod" = _dJqoN5vT;
        "pkg-v1.5.1" = _WIaOrYjR;
        "pkg-v1.5.1+mod" = _X9Fvin5S;
        "pkg-v1.5.2" = _I5fLUlkk;
        "pkg-v1.5.2+mod" = _291na2cv;
        "pkg-v1.6.0" = _GdbqykBF;
        "pkg-v1.6.0+mod" = _rAIBQgL3;
        "pkg-v1.6.1" = _LNHAXfR5;
        "pkg-v1.6.1+mod" = _DizyT41w;
        "pkg-v1.6.2" = _9ll09WOK;
        "pkg-v1.6.2+mod" = _363AFEd4;
        "default" = _363AFEd4;
    });
