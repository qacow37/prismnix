...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0-forge+fabric" = _vGQDP12E;
        "pkg-1.19.2-1.0-forge+fabric" = _cGoEXVRG;
        "pkg-1.19.4-1.0-forge+fabric" = _pqCFmnzw;
        "pkg-1.20.1-1.0-forge+fabric" = _aDObrf6s;
        "pkg-1.20.2-1.0-forge+fabric" = _3v4NKlii;
        "pkg-1.18.2-1.1-forge+fabric" = _tvIXKhVy;
        "pkg-1.19.2-1.1-forge+fabric" = _RJNJbypy;
        "pkg-1.20.1-1.1-forge+fabric" = _zpcPiXw4;
        "pkg-1.20.2-1.1-forge+fabric" = _WL6KG3ZJ;
        "pkg-1.20.2-1.2-forge+fabric" = _SgTyPWap;
        "pkg-1.20.3-1.2-fabric+forge+neo" = _TwyU47YG;
        "pkg-1.20.4-1.2-fabric+forge+neo" = _z5841nnQ;
        "pkg-1.19.2-1.3-fabric+forge+neo" = _OTZGdWMq;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _mfDKROPf;
        "pkg-1.20.2-1.3-fabric+forge+neo" = _eiJCf0wu;
        "pkg-1.20.4-1.3-fabric+forge+neo" = _S9KqptHZ;
        "pkg-1.19.2-1.4-fabric+forge+neo" = _ehAlOmd4;
        "pkg-1.20.1-1.4-fabric+forge+neo" = _U53AOJz7;
        "pkg-1.20.2-1.4-fabric+forge+neo" = _zSBBf4SJ;
        "pkg-1.20.4-1.4-fabric+forge+neo" = _nl4TDekD;
        "pkg-1.20.5-1.4-fabric+neo" = _CUGQnYYa;
        "pkg-1.20.6-1.4-fabric+forge+neo" = _AS2LPNjU;
        "pkg-1.21.0-1.4-fabric+forge+neo" = _lHnqayb6;
        "pkg-1.20.1-1.5-fabric+forge+neo" = _z9JQjTTG;
        "pkg-1.20.6-1.5-fabric+forge+neo" = _Bu5TqBXL;
        "pkg-1.21.0-1.5-fabric+forge+neo" = _NtkzkX0K;
        "pkg-1.21.1-1.5-fabric+forge+neo" = _238BAlok;
        "pkg-1.21.2-1.5-fabric+neo" = _9o5g4XIU;
        "pkg-1.21.3-1.5-fabric+forge+neo" = _O9XoZLHX;
        "pkg-1.21.4-1.5-fabric+forge+neo" = _cdW57cIY;
        "pkg-1.21.5-1.5-fabric+forge+neo" = _jnK0xc3H;
        "pkg-1.21.5-1.6-fabric+forge+neo" = _OtPZjy1F;
        "pkg-1.21.6-1.6-fabric+forge+neo" = _b7giL8ap;
        "pkg-1.21.7-1.6-fabric+forge+neo" = _sMXjyDjC;
        "pkg-1.21.8-1.6-fabric+forge+neo" = _x5IbowyM;
        "pkg-1.21.9-1.6-fabric+forge+neo" = _HxzWxHsK;
        "pkg-1.21.10-1.6-fabric+forge+neo" = _6ZU2SpRe;
        "pkg-1.21.11-1.6-fabric+forge+neo" = _Pl1WaiXe;
        "pkg-26.1.0-1.6-fabric+forge+neo" = _atWpgHUe;
        "pkg-26.1.1-1.6-fabric+forge+neo" = _vHj8wWqP;
        "pkg-26.1.2-1.6-fabric+forge+neo" = _uL8odm77;
        "pkg-26.2.0-1.6-fabric+forge+neo" = _Wez9F4Fu;
        "default" = _Wez9F4Fu;
    });
