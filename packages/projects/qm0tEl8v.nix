...
let
    ...
    in {
        ...
        "pkg-1.8" = _PlOuK3lM;
        "pkg-1.8.1" = _3NfzfnRX;
        "pkg-1.8.2-1.20.1" = _SZHyLm50;
        "pkg-1.8.2-1.20.5" = _HsvBymUa;
        "pkg-1.8.2-1.21" = _PE8koKTa;
        "pkg-1.8.3-1.20.1" = _bSCO1rLG;
        "pkg-1.8.3-1.20.5" = _gU2FIgyu;
        "pkg-1.8.3-1.21" = _7UvpbRZZ;
        "pkg-1.9" = _IKBI14gh;
        "pkg-1.9.1" = _PfD0WsmU;
        "pkg-1.9.2" = _TkmhNL6u;
        "pkg-2.0.0" = _7J59IaiM;
