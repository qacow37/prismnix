...
let
    ...
    in {
        ...
        "pkg-v1.1.1" = _x1vVkBbH;
        "pkg-v1.1.1+mod" = _GPaocLwy;
        "pkg-v1.2.0" = _ef2kKDEb;
        "pkg-v1.2.0+mod" = _Oh8mOwIO;
        "pkg-v1.2.1" = _mp3EP3oz;
        "pkg-v1.2.1+mod" = _KZackbzS;
        "pkg-v1.2.2" = _wiqfrGdl;
        "pkg-v1.2.2+mod" = _GRlyIzJh;
        "pkg-v1.2.3" = _3c6cBgA5;
