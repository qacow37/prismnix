...
let
    ...
    in {
        ...
        "pkg-1.3.2" = _vbUujrJJ;
        "pkg-1.3.2+mod" = _QZV4rSyt;
        "pkg-1.4+1.20.4" = _BpJxn5gp;
        "pkg-1.4+1.20.4+mod" = _yVSB8KpI;
        "pkg-1.4+1.20.6" = _6DbIFXLp;
        "pkg-1.4+1.20.6+mod" = _VMMP9Bqy;
        "pkg-1.4.1+1.21" = _u1KXTssB;
        "pkg-1.4.1+1.21+mod" = _EnqDqeuD;
        "pkg-1.5-mc1.21.2" = _T2Dj4Smj;
        "pkg-1.5-mc1.21.2+mod" = _Gpd6IZ42;
        "pkg-1.5-mc1.21.4" = _bn2qVTEq;
        "pkg-1.5-mc1.21.4+mod" = _ylN1Ni39;
        "pkg-1.5.1-mc1.21.4" = _HQeBqptB;
        "pkg-1.5.1-mc1.21.4+mod" = _8NEGwk3X;
        "pkg-1.5.2-mc1.21.5" = _a9VKvlho;
        "pkg-1.5.2-mc1.21.5+mod" = _GRkNIQIV;
        "pkg-1.5.2-mc1.21.6" = _tK5zxCtQ;
        "pkg-1.5.2-mc1.21.6+mod" = _oKy52uiF;
        "pkg-1.5.2-mc1.21.9" = _ayoT5rP0;
        "pkg-1.5.2-mc1.21.9+mod" = _AHZQp87K;
        "pkg-1.5.3-mc1.21.9" = _Vmf8XUB9;
        "pkg-1.5.3-mc1.21.9+mod" = _8cToxW8n;
        "pkg-1.5.3-mc1.21.11" = _r3SWGda8;
        "pkg-1.5.3-mc1.21.11+mod" = _a15aJ0XJ;
        "pkg-1.5.3-mc26.1" = _dEn1jxO7;
        "pkg-1.5.3-mc26.1+mod" = _naQzqwdf;
        "pkg-1.5.4-mc26.1" = _22m3ULmw;
