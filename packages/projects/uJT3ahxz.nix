...
let
    ...
    in {
        ...
        "pkg-2.2.8" = _plZHhRQx;
        "pkg-2.2.9" = _jpeQlFtu;
        "pkg-2.2.10" = _A8zJume5;
        "pkg-2.2.11" = _2xfPVuDv;
        "pkg-2.2.12" = _5U3s2X4X;
        "pkg-3.0.0+6" = _pPU3PWNi;
        "pkg-3.0.0+7" = _WCd47OEY;
        "pkg-2.2.13" = _XfuQoAo5;
        "pkg-2.2.14" = _kqK81OuS;
        "pkg-2.2.15" = _cWtVovcy;
        "pkg-3.0.0+9" = _Ybwv58Gy;
        "pkg-3.0.0+10" = _hKTXvEPk;
        "pkg-2.2.16" = _YYQumrss;
        "pkg-2.2.17" = _rWEBtiV4;
        "pkg-3.0.1" = _slSkNwem;
        "pkg-3.0.2" = _pUh2rpAE;
        "pkg-2.2.18" = _RpI1SB0r;
        "pkg-2.3.0" = _IYRLZGo2;
        "pkg-3.0.3" = _TdzQQMBL;
        "pkg-2.3.1" = _2h1QHKVs;
        "pkg-3.0.4" = _wx2nGTqT;
        ...
        "pkg-2.3.8" = _8B9gMvCt;
        "pkg-2.3.9" = _tLEIJydT;
        "pkg-2.3.10" = _pKJ5zenE;
        "pkg-2.3.11" = _KYjXEKAM;
        "pkg-2.3.12" = _BKcZHq9T;
        "pkg-2.3.13" = _Re2EFm4Q;
        "pkg-2.3.14" = _jWiaEmk9;
        "pkg-3.0.8" = _vu5Xy9Dk;
        "pkg-2.3.15" = _RG9TFkOF;
        "pkg-2.3.16" = _1PQOxmSJ;
        "pkg-2.3.17" = _37ptiz9Z;
        "pkg-2.3.18" = _g9ss54Ki;
        "pkg-2.3.19" = _RFBCL80b;
        "pkg-2.3.20" = _KORGut98;
        "pkg-2.3.21" = _j70ht1cN;
        "pkg-2.3.24" = _xyUPzOdD;
        "pkg-2.3.25" = _aNZHScy0;
        "pkg-2.4.1" = _XGvneJPu;
        "pkg-2.4.2" = _p5a0jdWk;
        "pkg-2.4.3" = _jEnLmVsn;
        "pkg-2.4.4" = _xvEnVK5X;
        ...
        "pkg-2.4.8" = _ho4IQS14;
        "pkg-2.4.9" = _NUPWratL;
        "pkg-2.4.10" = _LjfYGHLO;
        "pkg-2.4.11" = _SjqBFbec;
        "pkg-2.4.12" = _72zU9a5q;
        "pkg-2.4.13" = _fQYQDT9Z;
        "pkg-2.4.14" = _V6FHXtmM;
        "pkg-2.4.15" = _OFjUYxI0;
        "pkg-2.4.16" = _jmWN98x0;
        "pkg-2.5.0" = _o1EocYvU;
        "pkg-2.5.1" = _4zhE8o8B;
        "pkg-2.5.2" = _YKkAxQjD;
        "pkg-2.5.3" = _SwkVl5Rj;
