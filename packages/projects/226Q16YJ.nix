...
let
    ...
    in {
        ...
        "pkg-1.0" = _X4GjtPx6;
        "pkg-1.1" = _7Su5NDCz;
        "pkg-1.2-1.20.1" = _AK9xbZbP;
        "pkg-1.2-1.20.4" = _K3UsG8eo;
        "pkg-1.2-1.20.6" = _8KoJeGPz;
        "pkg-1.2-1.21.1" = _VjEwesyN;
        "pkg-1.3" = _i0Dy75nw;
        "pkg-1.3.1" = _VwU9vGEG;
        "pkg-2.0-beta.1-1.20.1-forge" = _ll0TP2Tc;
        "pkg-2.0-beta.1-1.20.4-fabric" = _OFIvStQT;
        "pkg-2.0-beta.1-1.20.6-neoforge" = _vBh1msYv;
        "pkg-2.0-beta.1-1.21.1-fabric" = _RMlbxDgO;
        "pkg-2.0-beta.1-1.21.1-neoforge" = _jjqykchn;
        "pkg-2.0-beta.1-1.21.3-neoforge" = _Z2DOA84j;
        "pkg-2.0-beta.1-1.21.8-fabric" = _wx2lH2a0;
        "pkg-2.0-beta.1-1.21.10-fabric" = _GjYS7AEA;
        "pkg-2.0-beta.1-1.21.10-neoforge" = _ixDKcGw7;
        "pkg-2.0-beta.2-1.20.1-forge" = _C1a0iPBD;
        "pkg-2.0-beta.2-1.20.4-fabric" = _XyLkAxJZ;
        "pkg-2.0-beta.2-1.20.6-neoforge" = _wFaAi4AP;
        "pkg-2.0-beta.2-1.21.1-fabric" = _MgGk7jYS;
        "pkg-2.0-beta.2-1.21.1-neoforge" = _AQHqV39a;
        "pkg-2.0-beta.2-1.21.3-neoforge" = _V1SsB9I0;
        "pkg-2.0-beta.2-1.21.8-fabric" = _pfIYZqww;
        "pkg-2.0-beta.2-1.21.10-fabric" = _6s6U7gUR;
        "pkg-2.0-beta.2-1.21.10-neoforge" = _74fNSef6;
        "pkg-2.0-beta.3-1.20.1-forge" = _93tNTU53;
        "pkg-2.0-beta.3-1.20.4-fabric" = _ZoYu8W78;
        "pkg-2.0-beta.3-1.20.6-neoforge" = _7m0IeX7p;
        "pkg-2.0-beta.3-1.21.1-fabric" = _el60JNKw;
        "pkg-2.0-beta.3-1.21.1-neoforge" = _Y8hbHHHq;
        "pkg-2.0-beta.3-1.21.3-neoforge" = _GeQTNJWV;
        "pkg-2.0-beta.3-1.21.8-fabric" = _8VlIuc7K;
        "pkg-2.0-beta.3-1.21.10-fabric" = _BdrPGkFw;
        "pkg-2.0-beta.3-1.21.10-neoforge" = _8wPkf3aS;
        "default" = _8wPkf3aS;
    });
