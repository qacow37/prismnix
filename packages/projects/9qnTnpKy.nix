...
let
    ...
    in {
        ...
        "pkg-0.2.0" = _exGJwonw;
        "pkg-0.2.1" = _m8FxZ2AM;
        "pkg-1.19.3-1.0.0" = _6NVSGxgs;
        "pkg-1.19.2-1.0.1" = _MzTThKoA;
        "pkg-1.19.3-1.0.1" = _wwEKIXvu;
        "pkg-1.19.4-2.0.0" = _VhRnFiQQ;
        "pkg-1.20.1-3.0.0" = _mMGhPo7B;
        "pkg-1.20.1-3.1.0" = _SOY413m9;
        "pkg-1.20.2-4.0.0" = _cRbbBgH4;
        "pkg-1.20.1-4.0.0" = _QXAhP9Sx;
        "pkg-1.20.6-5.0.0" = _3KE8ny4y;
        "pkg-1.21-6.0.0" = _Fvq8fd20;
        "pkg-1.21-6.0.1" = _csLQzcg3;
        "pkg-1.19.2-1.1.0" = _agAbk7j6;
        "pkg-1.19.2-1.2.0" = _fxA2vZlb;
        "pkg-1.20.1-4.1.0" = _zoPpogsy;
        "pkg-1.21.1-6.1.0" = _tXyduabo;
        "pkg-1.19.2-1.3.0" = _4ofuKRHv;
        "pkg-1.20.1-4.2.0" = _1qPnD79e;
        "pkg-1.21.1-6.2.0" = _ZTcrWWti;
        "pkg-1.19.2-1.4.0" = _cpvLI6zh;
        "pkg-1.20.1-4.3.0" = _fEJq04N2;
        "pkg-1.21.1-6.2.1" = _n62Lr22h;
        "pkg-1.19.2-1.4.1" = _NCBY4Uc7;
        "pkg-1.20.1-4.3.1" = _XIjFvDtx;
        "pkg-1.21.1-6.2.2" = _VlF3kAc6;
        "pkg-1.21.4-7.0.0" = _fqPH1pTG;
        "pkg-1.20.1-4.4.0" = _Xuqwo1Q0;
        "pkg-1.21.1-6.3.0" = _8C1DtK8N;
        "pkg-1.21.8-8.0.0" = _TZKsqdHO;
        "pkg-1.20.1-4.4.1" = _pZkFizHT;
        "pkg-1.21.1-6.3.1" = _w6FJMQQF;
        "pkg-1.21.8-8.0.1" = _Xj5enSHA;
        "pkg-1.20.1-4.4.2" = _5ItRafPg;
        "pkg-1.21.1-6.3.2" = _qcdkmjkP;
        "pkg-1.21.9-9.0.0" = _Rlp6dg37;
        "default" = _Rlp6dg37;
    });
