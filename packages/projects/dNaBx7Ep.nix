...
let
    ...
    in {
        ...
        "pkg-0.3.2" = _9ouqUZiQ;
        "pkg-0.4.0" = _KcvMTH2U;
        "pkg-0.4.0-1.21.1" = _5a3OcQgH;
        "pkg-0.4.0-26.1" = _hSE1lABN;
        "pkg-0.4.0+1.20.1+Fabric" = _9Sfm0muC;
        "pkg-0.4.0+1.21.1+Fabric" = _yI4iM71M;
        "pkg-0.4.0-26.1b" = _WVvjb8wC;
        "pkg-0.4.0-26.1-Fabric" = _poe4N6Pg;
        "default" = _poe4N6Pg;
    });
