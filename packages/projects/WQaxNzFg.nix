...
let
    ...
    in {
        ...
        "pkg-1.21.4-1-neoforge" = _uhJ3l54Q;
        "pkg-1.18.2-1-forge" = _wJegTKWb;
        "pkg-1.19.2-1-forge" = _uc7IkO2S;
        "pkg-1.19.3-1-forge" = _uCYEpjGZ;
        "pkg-1.19.4-1-forge" = _q7vsWGkf;
        "pkg-1.20.1-1-forge" = _kqR2wFIL;
        "pkg-1.20.2-1-forge" = _MH5csoNt;
        "pkg-1.20.4-1-forge" = _93a0JAWq;
        "pkg-1.20.6-1-forge" = _dXLiyrqH;
        "pkg-1.21.1-1-forge" = _9Agi6uQE;
        "pkg-1.21.3-1-forge" = _Vd1NinTv;
        "pkg-1.21.4-1-forge" = _5deVrYTO;
        "pkg-1.18.2-1-fabric" = _Wd3TjYzQ;
        "pkg-1.19-1-fabric" = _L3esd306;
        "pkg-1.19.1-1-fabric" = _iHDjjUR5;
        "pkg-1.19.2-1-fabric" = _aKb8saLL;
        "pkg-1.20.1-1-fabric" = _ID4vnT3b;
        "pkg-1.19.3-1-fabric" = _jdvX2964;
        "pkg-1.19.4-1-fabric" = _Mr1PayW3;
        "pkg-1.20.2-1-fabric" = _6VaTMlbh;
        "pkg-1.20.4-1-fabric" = _VpP2CYzL;
        "pkg-1.20.6-1-fabric" = _JMEHTuFj;
        "pkg-1.21.1-1-fabric" = _CJY8c9ny;
        "pkg-1.21.3-1-fabric" = _vFfZahaF;
        "pkg-1.21.4-1-fabric" = _X5NkMWsF;
        "pkg-1.18.2-forge-2" = _BxFgmJ3n;
        "pkg-1.18.2-fabric-2" = _C6CIJIZg;
        "pkg-1.19.2-fabric-2" = _YTu2KCd5;
        "pkg-1.19.2-forge-2" = _dZ5NG8Na;
        "pkg-1.19.4-fabric-2" = _BfOEnUL1;
        "pkg-1.19.4-forge-2" = _husgtiet;
        "pkg-1.20.1-fabric-2" = _P7Xxjbvp;
        "pkg-1.20.1-forge-2" = _CBRig7WJ;
        "pkg-1.20.2-fabric-2" = _3EmpVqSt;
        "pkg-1.20.2-forge-2" = _CDuihUQy;
        "pkg-1.20.4-fabric-2" = _fQCFOB3l;
        "pkg-1.20.4-forge-2" = _FDXEiY8r;
        "pkg-1.20.6-fabric-2" = _QGruCvFR;
        "pkg-1.20.6-forge-2" = _nsWXRJS4;
        "pkg-1.20.6-neoforge-2" = _f1AiqXrs;
        "pkg-1.21.1-fabric-2" = _lAnKt8p5;
        "pkg-1.21.1-forge-2" = _wgcuZ3vr;
        "pkg-1.21.1-neoforge-2" = _fgEk9QB5;
        "pkg-1.21.3-fabric-2" = _efI4qbyP;
        "pkg-1.21.3-forge-2" = _QNQ1uLPr;
        "pkg-1.21.3-neoforge-2" = _XRrSrU97;
        "pkg-1.21.4-fabric-2" = _z1zZZxC9;
        "pkg-1.21.4-forge-2" = _1YyEWHnU;
        "pkg-1.21.4-neoforge-2" = _UKZy9nXw;
        "pkg-1.18.2-fabric-2.1" = _TZ2OVpXd;
        "pkg-1.18.2-forge-2.1" = _zPtPLoeo;
        "pkg-1.19.2-fabric-2.1" = _wJQ2RU5d;
        "pkg-1.19.2-forge-2.1" = _9zSRAZs2;
        "pkg-1.19.4-fabric-2.1" = _YFNW7N3l;
        "pkg-1.19.4-forge-2.1" = _7WboStME;
        "pkg-1.20.1-fabric-2.1" = _S20civNx;
        "pkg-1.20.1-forge-2.1" = _QLSiHOiV;
        "pkg-1.20.2-fabric-2.1" = _9WJHkfKB;
        "pkg-1.20.2-forge-2.1" = _366QGxs2;
        "pkg-1.20.4-fabric-2.1" = _1220Bqhh;
        "pkg-1.20.4-forge-2.1" = _ZGoozBkg;
        "pkg-1.20.6-fabric-2.1" = _ZU2xPW6V;
        "pkg-1.20.6-forge-2.1" = _8Anaovus;
        "pkg-1.20.6-neoforge-2.1" = _bUkdtFxi;
        "pkg-1.21.1-fabric-2.1" = _ufoFEJq6;
        "pkg-1.21.1-forge-2.1" = _q28u8igA;
        "pkg-1.21.1-neoforge-2.1" = _5b8hCt8u;
        "pkg-1.21.4-fabric-2.1" = _u1vMpGpQ;
        "pkg-1.21.4-forge-2.1" = _Dr9aVtLD;
        "pkg-1.21.4-neoforge-2.1" = _vK4WH799;
        "pkg-1.21.3-fabric-2.1" = _musgJY4p;
        "pkg-1.21.3-neoforge-2.1" = _1VpsIUuB;
        "pkg-1.21.3-forge-2.1" = _KIMFvmik;
        "pkg-1.21.5-fabric-2.1" = _S4fFUl3w;
        "pkg-1.21.5-forge-2.1" = _qVLkneVX;
        "pkg-1.21.5-neoforge-2.1" = _CIOozmAj;
        "pkg-1.20.1-fabric-2.2" = _iUVAo3IR;
        "pkg-1.20.1-forge-2.2" = _z9bxb1zd;
        "pkg-1.20.2-fabric-2.2" = _H5z7syIU;
        "pkg-1.20.2-forge-2.2" = _4EGha5PX;
        "pkg-1.20.4-fabric-2.2" = _Dymjv4qk;
        "pkg-1.20.4-forge-2.2" = _7Nwz01nc;
        "pkg-1.20.6-fabric-2.2" = _yuaasOyE;
        "pkg-1.20.6-forge-2.2" = _kJFGe6Al;
        "pkg-1.20.6-neoforge-2.2" = _vLFNvXB3;
        "pkg-1.21.1-fabric-2.2" = _dOj5SlxO;
        "pkg-1.21.1-forge-2.2" = _1PHPL8rm;
        "pkg-1.21.1-neoforge-2.2" = _CYN0GpDO;
        "pkg-1.21.3-fabric-2.2" = _35lHHYqJ;
        "pkg-1.21.3-forge-2.2" = _9Aw78jtj;
        "pkg-1.21.3-neoforge-2.2" = _xjMsLY0i;
        "pkg-1.21.4-fabric-2.2" = _ZDkBtndv;
        "pkg-1.21.4-forge-2.2" = _fec1raOW;
        "pkg-1.21.4-neoforge-2.2" = _1GBWXcJM;
        "pkg-1.21.5-fabric-2.2" = _bG9wJcvD;
        "pkg-1.21.5-forge-2.2" = _53U7NYGk;
        "pkg-1.21.5-neoforge-2.2" = _lUZCg95n;
        "pkg-1.18.2-fabric-2.2" = _LExmqzDW;
        "pkg-1.18.2-forge-2.2" = _gqJIOfou;
        "pkg-1.19.2-fabric-2.2" = _GmxF6IpU;
        "pkg-1.19.2-forge-2.2" = _AtjkVQ6h;
        "pkg-1.19.4-fabric-2.2" = _FwVpAT2P;
        "pkg-1.19.4-forge-2.2" = _71SGCLJP;
        "pkg-1.21.6-fabric-2.2" = _luc0ofrT;
        "pkg-1.21.6-forge-2.2" = _yZwFMQYt;
        "pkg-1.21.6-neoforge-2.2" = _Iw4ibcnm;
        "pkg-1.21.7-fabric-2.2" = _agxGwdcq;
        "pkg-1.21.7-forge-2.2" = _U33nR5QG;
        "pkg-1.21.7-neoforge-2.2-bad" = _nlFUSRhS;
        "pkg-1.21.7-neoforge-2.2" = _zXWDXZsz;
        "pkg-1.21.8-fabric-2.2" = _KFEpMvgl;
        "pkg-1.21.8-forge-2.2" = _HTOhbiEv;
        "pkg-1.21.8-neoforge-2.2" = _PxBySB1j;
        "pkg-1.18.2-fabric-2.3" = _yb2VRUuV;
        "pkg-1.18.2-forge-2.3" = _9jPL1n5x;
        "pkg-1.19.2-fabric-2.3" = _jjDeq9mE;
        "pkg-1.19.2-forge-2.3" = _zDoXCsl0;
        "pkg-1.19.4-fabric-2.3" = _QUm0u8qb;
        "pkg-1.19.4-forge-2.3" = _9ndWcUhI;
        "pkg-1.20.1-fabric-2.3" = _Q7u5L16m;
        "pkg-1.20.1-forge-2.3" = _CxeGAmL7;
        "pkg-1.20.2-fabric-2.3" = _65wcP4W2;
        "pkg-1.20.2-forge-2.3" = _ZypQh2BO;
        "pkg-1.20.4-fabric-2.3" = _lP6K3jqm;
        "pkg-1.20.4-forge-2.3" = _DdCLLigv;
        "pkg-1.20.6-fabric-2.3" = _iCOncNqM;
        "pkg-1.20.6-forge-2.3" = _TuxniYhR;
        "pkg-1.20.6-neoforge-2.3" = _xLxpIMob;
        "pkg-1.21.1-fabric-2.3" = _pUnm6S8m;
        "pkg-1.21.1-forge-2.3" = _xxJrbGh8;
        "pkg-1.21.1-neoforge-2.3" = _QWjXt6Ew;
        "pkg-1.21.3-fabric-2.3" = _es5Bw1AQ;
        "pkg-1.21.3-forge-2.3" = _wRkdRep6;
        "pkg-1.21.3-neoforge-2.3" = _OpVGT2KF;
        "pkg-1.21.4-fabric-2.3" = _8iOubyep;
        "pkg-1.21.4-forge-2.3" = _NvQHSO5j;
        "pkg-1.21.4-neoforge-2.3" = _Qu8AgLjo;
        "pkg-1.21.5-fabric-2.3" = _iewK76vC;
        "pkg-1.21.5-forge-2.3" = _otVGM2fA;
        "pkg-1.21.5-neoforge-2.3" = _Mk84nBx3;
        "pkg-1.21.8-fabric-2.3" = _92sujMgc;
        "pkg-1.21.8-forge-2.3" = _BEzEoc6z;
        "pkg-1.21.8-neoforge-2.3" = _kfSkcTPG;
        "pkg-1.18.2-fabric-2.4" = _bcgjV3h4;
        "pkg-1.18.2-forge-2.4" = _NO69kTHZ;
        "pkg-1.19.2-fabric-2.4" = _AIlSCK5Z;
        "pkg-1.19.2-forge-2.4" = _ySr2EBuX;
        "pkg-1.19.4-fabric-2.4" = _bYVQzjME;
        "pkg-1.19.4-forge-2.4" = _YQcjMu0F;
        "pkg-1.20.1-fabric-2.4" = _mvBEs5e7;
        "pkg-1.20.1-forge-2.4" = _Ggc26XfC;
        "pkg-1.20.2-fabric-2.4" = _Ozh9XmWd;
        "pkg-1.20.2-forge-2.4" = _XwQ7zxJF;
        "pkg-1.20.4-fabric-2.4" = _8xBqB2UT;
        "pkg-1.20.4-forge-2.4" = _oZUBEaQP;
        "pkg-1.20.6-fabric-2.4" = _DWy9ZyC3;
        "pkg-1.20.6-forge-2.4" = _TUuJnXQx;
        "pkg-1.20.6-neoforge-2.4" = _seNESPXX;
        "pkg-1.21.1-fabric-2.4" = _OXVzID8d;
        "pkg-1.21.1-forge-2.4" = _iqZ4ZFH0;
        "pkg-1.21.1-neoforge-2.4" = _C0ZfjOdD;
        "pkg-1.21.3-fabric-2.4" = _K7m1ExuF;
        "pkg-1.21.3-forge-2.4" = _qT0gUmw2;
        "pkg-1.21.3-neoforge-2.4" = _skzX7f79;
        "pkg-1.21.4-fabric-2.4" = _j0kaRMpG;
        "pkg-1.21.4-forge-2.4" = _mbf4TEW2;
        "pkg-1.21.4-neoforge-2.4" = _a5N2DZyx;
        "pkg-1.21.5-fabric-2.4" = _BXpBNAT8;
        "pkg-1.21.5-forge-2.4" = _mK21Y2f2;
        "pkg-1.21.5-neoforge-2.4" = _Wytx4Fq7;
        "pkg-1.21.8-fabric-2.4" = _ZfShJG3i;
        "pkg-1.21.8-forge-2.4" = _92KXcFoR;
        "pkg-1.21.8-neoforge-2.4" = _s2tK4lMS;
        "pkg-1.21.9-fabric-2.4" = _U1fTYkDU;
        "pkg-1.21.9-forge-2.4" = _ppu58Hkl;
        "pkg-1.21.9-neoforge-2.4" = _D5LBsy6k;
        "pkg-1.21.10-fabric-2.4" = _3Or9eoMO;
        "pkg-1.21.10-forge-2.4" = _tCs1rZ7g;
        "pkg-1.21.10-neoforge-2.4" = _DVT5LIaw;
        "pkg-1.18.2-fabric-2.5" = _jlRKXs7R;
        "pkg-1.18.2-forge-2.5" = _qds2jQpM;
        "pkg-1.19.2-fabric-2.5" = _KQosWFHY;
        "pkg-1.19.2-forge-2.5" = _nOVMBkBI;
        "pkg-1.19.4-fabric-2.5" = _pPZBNmlA;
        "pkg-1.19.4-forge-2.5" = _CAbifMy8;
        "pkg-1.20.1-fabric-2.5" = _U2deza7C;
        "pkg-1.20.1-forge-2.5" = _OBaYPNQL;
        "pkg-1.20.2-fabric-2.5" = _YDUJarGi;
        "pkg-1.20.2-forge-2.5" = _u0VMvxA5;
        "pkg-1.20.4-fabric-2.5" = _jUuz3byY;
        "pkg-1.20.4-forge-2.5" = _8XWficl6;
        "pkg-1.20.6-fabric-2.5" = _RdRPle1m;
        "pkg-1.20.6-forge-2.5" = _y9QdGZFx;
        "pkg-1.20.6-neoforge-2.5" = _BayTHC8z;
        "pkg-1.21.1-fabric-2.5" = _NsfkBCPY;
        "pkg-1.21.1-forge-2.5" = _OLQrQzBR;
        "pkg-1.21.1-neoforge-2.5" = _iNBWHgNC;
        "pkg-1.21.10-fabric-2.5" = _Xu5jZxkJ;
        "pkg-1.21.10-forge-2.5" = _ae9BMUb9;
        "pkg-1.21.10-neoforge-2.5" = _dcioVjW9;
        "pkg-1.21.3-fabric-2.5" = _mO3z6AJZ;
        "pkg-1.21.3-forge-2.5" = _PkaUc5Vf;
        "pkg-1.21.3-neoforge-2.5" = _BSC945YK;
        "pkg-1.21.4-fabric-2.5" = _BeLlCUDh;
        "pkg-1.21.4-forge-2.5" = _8kb12zaF;
        "pkg-1.21.4-neoforge-2.5" = _Pz96HE0q;
        "pkg-1.21.5-fabric-2.5" = _DkDWJL7d;
        "pkg-1.21.5-forge-2.5" = _sq29nllm;
        "pkg-1.21.5-neoforge-2.5" = _x8A3kFEl;
        "pkg-1.21.8-fabric-2.5" = _WyIOh96G;
        "pkg-1.21.8-forge-2.5" = _gAo12Uv5;
        "pkg-1.21.8-neoforge-2.5" = _vVHN9xzz;
        "pkg-1.21.11-fabric-2.5" = _X6igL7Ew;
        "pkg-1.21.11-forge-2.5" = _X1cek0S1;
        "pkg-1.21.11-neoforge-2.5" = _dTRaHI7X;
        "pkg-26.1-fabric-2.5" = _k2R8Yt99;
        "pkg-26.1-neoforge-2.5" = _HttCO0fz;
        "pkg-2.5" = _2SZ8GB4P;
        "pkg-26.1.1-fabric-2.5" = _5qMjUnLi;
        "pkg-26.1.1-forge-2.5" = _fVeFIBOE;
        "pkg-26.1.1-neoforge-2.5" = _lWLwdu2J;
        "pkg-26.1.2-fabric-2.5" = _dBwBjeP7;
        "pkg-26.1.2-forge-2.5" = _L6wFDCgU;
        "pkg-26.1.2-neoforge-2.5" = _4trenLvL;
        "pkg-1.18.2-fabric-2.6" = _Qw1GnyKi;
        "pkg-1.18.2-forge-2.6" = _tffdpJ4L;
        "pkg-1.19.2-fabric-2.6" = _Xxc3uWb5;
        "pkg-1.19.2-forge-2.6" = _fXF5X4AR;
        "pkg-1.19.4-fabric-2.6" = _GTI3qW13;
        "pkg-1.19.4-forge-2.6" = _dFwFpSqG;
        "pkg-1.20.1-fabric-2.6" = _etBtnCE1;
        "pkg-1.20.1-forge-2.6" = _xhJAxuoy;
        "pkg-1.20.2-fabric-2.6" = _28ToracG;
        "pkg-1.20.2-forge-2.6" = _M8d1Stez;
        "pkg-1.20.4-fabric-2.6" = _6EVvkJ5Z;
        "pkg-1.20.4-forge-2.6" = _frtC4rnF;
        "pkg-1.20.6-fabric-2.6" = _V3y1NhXb;
        "pkg-1.20.6-forge-2.6" = _E1e8XYGp;
        "pkg-1.20.6-neoforge-2.6" = _PFHnbLgO;
        "pkg-1.21.1-fabric-2.6" = _CZeWmoxW;
        "pkg-1.21.1-forge-2.6" = _v7Wn3SAf;
        "pkg-1.21.1-neoforge-2.6" = _SW2WCTYz;
        "pkg-1.21.10-fabric-2.6" = _FNCiIRKB;
        "pkg-1.21.10-forge-2.6" = _In2yDpja;
        "pkg-1.21.10-neoforge-2.6" = _yBlyXwUi;
        "pkg-1.21.11-fabric-2.6" = _zFqTtD6H;
        "pkg-1.21.11-forge-2.6" = _aPVaZxA1;
        "pkg-1.21.11-neoforge-2.6" = _q4SarbqY;
        "pkg-1.21.3-fabric-2.6" = _WglSGujA;
        "pkg-1.21.3-forge-2.6" = _jv5yxUdE;
        "pkg-1.21.3-neoforge-2.6" = _IBjeaODs;
        "pkg-1.21.4-fabric-2.6" = _FCUvyIyP;
        "pkg-1.21.4-forge-2.6" = _SJCrkNLn;
        "pkg-1.21.4-neoforge-2.6" = _xTSmqJvf;
        "pkg-1.21.5-fabric-2.6" = _gAmvfWtM;
        "pkg-1.21.5-forge-2.6" = _cx9hri3X;
        "pkg-1.21.5-neoforge-2.6" = _WKr3m9eR;
        "pkg-1.21.8-fabric-2.6" = _thunBxdE;
        "pkg-1.21.8-forge-2.6" = _2xT84r2y;
        "pkg-1.21.8-neoforge-2.6" = _hmoLrS2h;
        "pkg-26.1.2-fabric-2.6" = _8fJiDtQ2;
        "pkg-26.1.2-forge-2.6" = _3F4SusP4;
        "pkg-26.1.2-neoforge-2.6" = _HM2XHHC3;
        "pkg-1.21.10-fabric-2.6.1" = _NabeFKao;
        "pkg-1.21.10-forge-2.6.1" = _AN6f9WCV;
        "pkg-1.21.10-neoforge-2.6.1" = _GrSzGPnz;
        "pkg-1.21.11-fabric-2.6.1" = _hg1Bd9KA;
        "pkg-1.21.11-forge-2.6.1" = _rywEM57x;
        "pkg-1.21.11-neoforge-2.6.1" = _8nxPnzkF;
        "pkg-1.21.3-fabric-2.6.1" = _xTRpPFPy;
        "pkg-1.21.3-forge-2.6.1" = _2gOdDMOi;
        "pkg-1.21.3-neoforge-2.6.1" = _ovfwfBVA;
        "pkg-1.21.4-fabric-2.6.1" = _c1pn9SxC;
        "pkg-1.21.4-forge-2.6.1" = _7e4rJckl;
        "pkg-1.21.4-neoforge-2.6.1" = _guWh4t4S;
        "pkg-1.21.5-fabric-2.6.1" = _aMjCj8Hd;
        "pkg-1.21.5-forge-2.6.1" = _rSA9jwJX;
        "pkg-1.21.5-neoforge-2.6.1" = _izMlGYRl;
        "pkg-1.21.8-fabric-2.6.1" = _zTzhclrE;
        "pkg-1.21.8-forge-2.6.1" = _BzvS28Jq;
        "pkg-1.21.8-neoforge-2.6.1" = _YMkyJ3Wy;
        "pkg-26.1.2-fabric-2.6.1" = _8fDxk2zr;
        "pkg-26.1.2-forge-2.6.1" = _dF365h8K;
        "pkg-26.1.2-neoforge-2.6.1" = _3R1IzU3C;
        "pkg-1.18.2-fabric-2.7" = _jNpWwFDZ;
        "pkg-1.18.2-forge-2.7" = _K60w1mYP;
        "pkg-1.19.2-fabric-2.7" = _Qoh6ClYb;
        "pkg-1.19.2-forge-2.7" = _oQBJ2MRq;
        "pkg-1.19.4-fabric-2.7" = _Eo4peCcd;
        "pkg-1.19.4-forge-2.7" = _MNYHA7Fr;
        "pkg-1.20.1-fabric-2.7" = _xlSsGjNY;
        "pkg-1.20.1-forge-2.7" = _kvQsIOHl;
        "pkg-1.20.2-fabric-2.7" = _U8JFe9xA;
        "pkg-1.20.2-forge-2.7" = _doMM8Q8Y;
        "pkg-1.20.4-fabric-2.7" = _p82jWVzs;
        "pkg-1.20.4-forge-2.7" = _A8P9gptT;
        "pkg-1.20.6-fabric-2.7" = _3gUcphZU;
        "pkg-1.20.6-forge-2.7" = _LwA4EjOY;
        "pkg-1.20.6-neoforge-2.7" = _3dyBXZaN;
        "pkg-1.21.1-fabric-2.7" = _mxzk31z4;
        "pkg-1.21.1-forge-2.7" = _vqxHy7nU;
        "pkg-1.21.1-neoforge-2.7" = _COaBPCdu;
        "pkg-1.21.10-fabric-2.7" = _M3jQz9aj;
        "pkg-1.21.10-forge-2.7" = _hWSnOdcH;
        "pkg-1.21.10-neoforge-2.7" = _I4nL1Avc;
        "pkg-1.21.11-fabric-2.7" = _FDm1puwQ;
        "pkg-1.21.11-forge-2.7" = _e8EpIj1w;
        "pkg-1.21.11-neoforge-2.7" = _nSLbj6Zz;
        "pkg-1.21.3-fabric-2.7" = _DknK22de;
        "pkg-1.21.3-forge-2.7" = _hJ0Fi1i7;
        "pkg-1.21.3-neoforge-2.7" = _2bCwOEi2;
        "pkg-1.21.4-fabric-2.7" = _Nl4EJsjb;
        "pkg-1.21.4-forge-2.7" = _tLcu90Wj;
        "pkg-1.21.4-neoforge-2.7" = _Cjnl5OML;
        "pkg-1.21.5-fabric-2.7" = _4sMZLfae;
        "pkg-1.21.5-forge-2.7" = _cs87w4Kt;
        "pkg-1.21.5-neoforge-2.7" = _15ZGYF6V;
        "pkg-1.21.8-fabric-2.7" = _v2c24J5p;
        "pkg-1.21.8-forge-2.7" = _WLOVbyJz;
        "pkg-1.21.8-neoforge-2.7" = _mbgGhZFj;
        "pkg-26.1.2-fabric-2.7" = _gmkET70j;
        "pkg-26.1.2-forge-2.7" = _xBXEHDoX;
        "pkg-26.1.2-neoforge-2.7" = _7mbGgUSb;
