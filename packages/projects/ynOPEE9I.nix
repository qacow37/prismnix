...
let
    ...
    in {
        ...
        "pkg-1.5" = _ssjTv2qL;
        "pkg-1.5.1" = _EsNaC7T6;
        "pkg-1.5.1-bugfix" = _ZsWmXtOr;
        "pkg-2.0-beta.1-1.20.1-fabric" = _5b6aYyE5;
        "pkg-2.0-beta.1-1.20.1-forge" = _Kat2mWu2;
        "pkg-2.0-beta.1-1.21.1-fabric" = _PqX9N0bW;
        "pkg-2.0-beta.1-1.21.1-neoforge" = _C3GafTTY;
        "pkg-2.0-beta.2-1.20.1-fabric" = _18wua02A;
        "pkg-2.0-beta.2-1.20.1-forge" = _b4XHZ0zF;
        "pkg-2.0-beta.2-1.21.1-fabric" = _xf0ELaxW;
        "pkg-2.0-beta.2-1.21.1-neoforge" = _WfI8bZWM;
        "pkg-2.0-1.20.1-fabric" = _lksjRRJh;
        "pkg-2.0-1.20.1-forge" = _bzbLEnqH;
        "pkg-2.0-1.21.1-fabric" = _TbTY4ynd;
        "pkg-2.0-1.21.1-neoforge" = _9xhcjwC8;
        "default" = _9xhcjwC8;
    });
