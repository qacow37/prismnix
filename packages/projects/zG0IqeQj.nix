...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.0-forge" = _q9TyqVyz;
        "pkg-1.20.1-1.0.0-fabric" = _CfVQrVxG;
        "pkg-1.20.1-1.0.1-fabric" = _HtqOI9ct;
        "pkg-1.20.1-1.0.1-forge" = _X3Mfg7mA;
        "pkg-1.20.1-1.1.0-fabric" = _MKiTtyHJ;
        "pkg-1.20.1-1.1.0-forge" = _E7WKfz6U;
        "pkg-1.20.1-1.2.0-fabric" = _1axXi8RO;
        "pkg-1.20.1-1.2.0-forge" = _EyUZ8cPx;
        "pkg-1.20.1-1.3.0-fabric" = _yEwm72KU;
        "pkg-1.20.1-1.3.0-forge" = _J4eWUHXr;
        "pkg-1.20.1-1.4.0-fabric" = _Ft0lXAQA;
        "pkg-1.20.1-1.4.0-forge" = _IB6QrVFN;
        "pkg-1.20.1-1.5.0-fabric" = _xx5WiSgk;
        "pkg-1.20.1-1.5.0-forge" = _GJDGOguF;
        "pkg-1.20.1-1.6.0-fabric" = _RuYuBbWO;
        "pkg-1.20.1-1.6.0-forge" = _tj4fE2Tt;
        "pkg-1.20.1-1.7.0-fabric" = _uhIff9hb;
        "pkg-1.20.1-1.7.0-forge" = _XzPoP6FG;
        "pkg-1.20.1-1.8.0-fabric" = _ZPLhB60n;
        "pkg-1.20.1-1.8.0-forge" = _WvYvadTR;
        "pkg-1.20.1-1.9.0-fabric" = _pZ0eGRm7;
        "pkg-1.20.1-1.9.0-forge" = _wkpf2fxU;
        "pkg-1.20.1-1.9.1-fabric" = _PlSPfzkW;
        "pkg-1.20.1-1.9.1-forge" = _3CHl82gt;
        "pkg-1.20.1-1.9.2-fabric" = _m4ApMsG5;
        "pkg-1.20.1-1.9.2-forge" = _cX16qAh2;
        "default" = _cX16qAh2;
    });
