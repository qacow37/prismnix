...
let
    ...
    in {
        ...
        "pkg-0.07" = _EzkaTH06;
        "pkg-0.08" = _Gn0ZEVlx;
        "pkg-0.08+mod" = _KObA4DzV;
        "pkg-0.09" = _aYgzsrOo;
        "pkg-0.09+mod" = _zVkXfzI5;
        "pkg-0.10" = _pQAp7ZEB;
        "pkg-0.10+mod" = _X7hoTA7C;
        "pkg-0.11" = _r47E5mtK;
        "pkg-0.11+mod" = _rUDpSGu1;
        "pkg-0.11-back" = _7PRh2En9;
        "pkg-0.12" = _QDeYb65b;
        "pkg-0.12+mod" = _ix7K7NTf;
        "pkg-0.12-2" = _Z7hrDd9B;
        "pkg-0.12-2+mod" = _yiod76Q4;
        "pkg-0.11-back+mod" = _tPIPXIqh;
        "pkg-0.13" = _UZPXmJph;
        "pkg-0.13+mod" = _262JIwjI;
        "pkg-0.14" = _3ZB6knRg;
        "pkg-0.14+mod" = _PRsmjauu;
        "pkg-0.15" = _DO0nWjX6;
        "pkg-0.15+mod" = _mTttT4fM;
        "pkg-0.16" = _WgztGZ5G;
        "pkg-0.16+mod" = _aCWndzpQ;
        "pkg-0.17" = _2BAoOSLM;
        "pkg-0.17+mod" = _3x6HPrK2;
        "pkg-0.18" = _1LCKgwk4;
        "pkg-0.18+mod" = _wz3WyXca;
        "pkg-0.19" = _SKZ7mAUY;
        "pkg-0.19+mod" = _WxE3y3j1;
        "pkg-0.20" = _NnVISo5j;
        "pkg-0.20+mod" = _hWJ5d1Wn;
        "pkg-0.21" = _mHF5phr3;
        "pkg-0.21+mod" = _MCElGU4f;
        "pkg-0.21.01" = _YrTPZMJf;
        "pkg-0.21.01+mod" = _QYKwG81n;
        "pkg-0.21.02" = _r03bSG1G;
        "pkg-0.21.03" = _OyBxI0sa;
        "pkg-0.21.03+mod" = _uUDncBpM;
        "pkg-0.22" = _ZKEBvwmG;
        "pkg-0.22+mod" = _kuBYtTvz;
        "pkg-0.22.NE" = _m1azp9Jg;
        "pkg-0.22.NE+mod" = _TMDil4Af;
        "pkg-0.23" = _aKqBfrgx;
        "pkg-0.23+mod" = _BnSRXmTm;
        "pkg-0.23p" = _J9BmOLn0;
        "pkg-0.23p+mod" = _UNLPvLpR;
        "pkg-1.0.0" = _yRGAxGyG;
        "pkg-1.0.0+mod" = _uR1ESGdh;
        "pkg-1.0.0p" = _Y0K0l2je;
        "pkg-1.0.0p+mod" = _p2G7Ztkb;
        "pkg-1.1.0" = _d8wAajdp;
        "pkg-1.1.0+mod" = _g8dO2QvE;
        "pkg-1.1.0p" = _rolwdBFo;
        "pkg-1.1.0p+mod" = _92nCybfT;
        "pkg-1.1.1" = _yCHXAsOj;
        "pkg-1.1.1+mod" = _prz4s70M;
        "pkg-1.1.1p" = _6uZ7YsMc;
        "pkg-1.1.1p+mod" = _mcXeTpWH;
        "default" = _mcXeTpWH;
    });
