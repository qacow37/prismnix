...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.4-fabric" = _sEb6mmcX;
        "pkg-1.18.2-2.4-fabric" = _Ucvl6m6R;
        "pkg-1.19.2-2.6-fabric" = _w5xdV7Ki;
        "pkg-1.16.5-1.9-forge" = _1hPtrm7p;
        "pkg-1.18.2-2.1-forge" = _WOZUlfLq;
        "pkg-1.19.2-2.3-forge" = _8tV1GHfK;
        "pkg-1.16.5-2.7-fabric" = _Nb0Ul3im;
        "pkg-1.18.2-2.7-fabric" = _RvWgAo33;
        "pkg-1.19.2-2.7-fabric" = _SRCTf7Xt;
        "pkg-1.19.3-2.8-fabric" = _gnmLA3ZE;
        "pkg-1.19.3-2.3-forge" = _zJ4gx9m0;
        "pkg-1.18.2-3.0-forge+fabric" = _tVjRbLRc;
        "pkg-1.19.2-3.0-forge+fabric" = _vGNrzFmQ;
        "pkg-1.19.3-3.0-forge+fabric" = _mH3kdMdB;
        "pkg-1.19.4-3.0-forge+fabric" = _utukkn37;
        "pkg-1.20-3.0-forge+fabric" = _QBOhZsCU;
        "pkg-1.20.1-3.0-forge+fabric" = _B53itOp6;
        "pkg-1.20.2-3.0-forge+fabric" = _qnsF8bjs;
        "pkg-1.18.2-3.1-forge+fabric" = _7fJnGcKP;
        "pkg-1.19.2-3.1-forge+fabric" = _DW8UzzCD;
        "pkg-1.20.1-3.1-forge+fabric" = _3HoXHta2;
        "pkg-1.20.2-3.1-forge+fabric" = _H0uU4wfy;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _2vtGfM92;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _KuVFAc6d;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _VbIUoBZo;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _5mz6TDTX;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _XYHuI9mc;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _Z9foRN4D;
        "pkg-1.19.2-3.3-fabric+forge" = _hAPEBtXP;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _hv5rwq8B;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _CcyeKCqp;
        "pkg-1.20.5-3.3-fabric+neo" = _FjfcvhT8;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _D93ZptOK;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _gJm2psyH;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _V9GdgOX9;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _BxhPTTHK;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _86eV07Tu;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _3cCK0rYj;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _XUNrU9Qz;
        "pkg-1.21.2-3.5-fabric+neo" = _z3GcjQLG;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _sE4at9rR;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _U0E7CXO2;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _oOI8HiNB;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _CF5U4nct;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _Y1JpPsnR;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _9dqVSdcJ;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _zwJUzErq;
        "pkg-1.21.6-3.7-fabric+forge+neo" = _IgNeL4tn;
        "pkg-1.21.7-3.7-fabric+forge+neo" = _AkuOhaoR;
        "pkg-1.21.8-3.7-fabric+forge+neo" = _yA33Lv5O;
        "pkg-1.21.9-3.7-fabric+forge+neo" = _IxXOwp08;
        "pkg-1.21.10-3.7-fabric+forge+neo" = _S4QxZxFg;
        "pkg-1.21.11-3.7-fabric+forge+neo" = _9OjT5Nao;
        "pkg-26.1.0-3.7-fabric+forge+neo" = _z4UYL1P2;
        "pkg-26.1.0-3.8-fabric+forge+neo" = _MWyoBEaF;
        "pkg-26.1.1-3.8-fabric+forge+neo" = _8rUXI8Ae;
        "pkg-26.1.2-3.8-fabric+forge+neo" = _gudWczU0;
        "pkg-1.20.1-3.9-fabric+forge+neo" = _Yd0PFHu8;
        "pkg-1.21.1-3.9-fabric+forge+neo" = _s7syux7E;
        "pkg-1.21.11-3.9-fabric+forge+neo" = _M7kPlMHL;
        "pkg-26.1.2-3.9-fabric+forge+neo" = _R65JqRdi;
        "pkg-1.20.1-4.0-fabric+forge+neo" = _Cvd7i080;
        "pkg-1.21.1-4.0-fabric+forge+neo" = _dhZfhQMY;
        "pkg-1.21.11-4.0-fabric+forge+neo" = _ExgU5Xmf;
        "pkg-26.1.2-4.0-fabric+forge+neo" = _MrblgOT7;
        "pkg-26.2.0-4.0-fabric+forge+neo" = _zwDCmFX8;
        "default" = _zwDCmFX8;
    });
