...
let
    ...
    in {
        ...
        "pkg-1.0-SNAPSHOT-fabric" = _eKfJ7Tec;
        "pkg-1.0-SNAPSHOT-forge" = _xWONCCHM;
        "pkg-1.0.1" = _4Wm0FV8R;
        "pkg-1.0.2" = _i0jwauMN;
        "pkg-1.0.3" = _C3GO1LZq;
        "pkg-1.0.4-fabric" = _BVd0uXU4;
        "pkg-1.0.4-forge" = _N1kk9Bxq;
        "pkg-1.0.5-forge" = _f3KG5aMc;
        "pkg-1.0.5-fabric" = _AaPUniGp;
        "pkg-1.0.6-fabric" = _CgQ2csaj;
        "pkg-1.0.6-forge" = _MDeskzlQ;
        "pkg-1.0.7-forge" = _50rSJqEU;
        "pkg-1.0.7-fabric" = _V7pfD7nJ;
        "pkg-2.0.0-fabric" = _Poa5zTPe;
        "pkg-2.0.0-forge" = _xY1aZ969;
        "pkg-2.0.1-forge-1.19.3" = _qoXwofec;
        "pkg-2.0.1-fabric-1.19.3" = _e2QE0shZ;
        "pkg-2.0.1-fabric-1.19.2" = _ngGOmqz8;
        "pkg-2.0.1-forge-1.19.2" = _UpdRUfhy;
        "pkg-show_kebinds-forge-1.19.2-2.0.2" = _SixoZatk;
        "pkg-show_keybinds-2.0.2-fab-1.19.2" = _6sfhMKG3;
        "pkg-show_keybinds-2.0.2-forge-1.19.3" = _iW66ruzo;
        "pkg-show_keybinds-2.0.2-fab-1.19.3" = _5zzj1O3o;
        "pkg-2.0.3" = _DE3xcfKK;
        "pkg-forge-2.0.3" = _1C9re4IL;
        "pkg-fabric-2.0.4" = _zrIVTTpX;
        "pkg-forge-2.0.4" = _JyE2WNOp;
        "pkg-fabric-2.0.5" = _8YiDAplS;
        "pkg-forge-2.0.5" = _7U6DHXGX;
        "pkg-fabric-3.0.0" = _8iXgemf5;
        "pkg-forge-3.0.0" = _bIwQDdOl;
        "pkg-fabric-3.1.0" = _6MP4oeSP;
        "pkg-forge-3.2.0" = _6yhni7ML;
        "pkg-fabric-3.2.0" = _KYzoyvY9;
        "pkg-4.0.0" = _uovNyLj7;
        "pkg-4.0.0-neoforge" = _JXaZ2Sry;
        "pkg-3.3.0-fabric" = _IVsNeJPg;
        "pkg-1.20.1-v-3.4.0-fabric" = _eJ1vtTed;
        "pkg-1.21-v-4.1.0-fabric" = _scEHUS53;
        "pkg-1.21.4-v-4.1.0-fabric" = _w30EwLVF;
        "pkg-1.21.4-v-4.1.0-neoforge" = _KXckQ89N;
        "pkg-1.21.1-v-4.1.0-fabric" = _o8DVRmiD;
        "pkg-1.21.1-v-4.1.0-neoforge" = _7dpZe9td;
        "pkg-1.21-v-4.1.0-neoforge" = _xTkbxAh5;
        "pkg-1.21.4-v-4.1.1-neoforge" = _nn4AYs5y;
        "pkg-1.21.4-v-4.1.1-fabric" = _1bDHjHsx;
        "pkg-1.21.1-v-4.1.1-fabric" = _OcfjdIbG;
        "pkg-1.21.1-v-4.1.1-neoforge" = _AfQ9kvvI;
        "pkg-1.21-v-4.1.1-fabric" = _OBV3du0q;
        "pkg-1.21-v-4.1.1-neoforge" = _P98b05mW;
        "pkg-1.20.1-v-3.4.1-fabric" = _AwviQBT9;
        "pkg-1.20.1-v-3.4.2-fabric" = _UhGnSeJN;
        "pkg-1.21.1-v-4.1.2-fabric" = _TamZizZ2;
        "pkg-1.21.1-4.1.2-neoforge" = _LrG6hIZj;
        "pkg-1.20.1-v-3.4.3-fabric" = _uuhXanEi;
        "pkg-1.20.1-v-3.5.0-fabric" = _CgLRgjOD;
        "pkg-1.21.1-4.2.0-neoforge" = _4BnwJDZR;
        "pkg-1.21.1-v-4.2.0-fabric" = _QQyqVGmF;
        "pkg-1.21.4-4.2.0-neoforge" = _u1WRsme1;
        "pkg-1.21.4-v-4.2.0-fabric" = _eTVww5eq;
        "pkg-1.21.5-4.3.0-neoforge" = _pY3c3KGP;
        "pkg-1.21.5-v-4.3.0-fabric" = _tBPwM1Dv;
        "pkg-1.21.1-4.3.1-neoforge" = _6ByjTNYM;
        "pkg-1.21.10-21.10.0.0-neoforge" = _iEHTmNfh;
        "pkg-1.21.10-v-21.10.0.0-fabric" = _NAZFKkyH;
        "pkg-1.21.8-v-21.8.0.0-fabric" = _Pzsbglq7;
        "pkg-1.21.8-21.8.0.0-neoforge" = _UTrLbSKF;
        "pkg-1.21.8-21.8.0.1-neoforge" = _TCvLDnD7;
        "pkg-1.21.8-v-21.8.0.1-fabric" = _vhZU5o3G;
        "pkg-1.21.10-21.10.0.1-neoforge" = _QivkdyeB;
        "pkg-1.21.10-v-21.10.0.1-fabric" = _dA3lYR7Z;
        "pkg-showkeybinds-21.8.0.2-fabric" = _1gNYdoOT;
        "pkg-showkeybinds-21.8.0.2-neoforge" = _unms8UZC;
        "pkg-showkeybinds-21.10.0.2-neoforge" = _vRgSQXHt;
        "pkg-showkeybinds-21.10.0.2-fabric" = _mwlZtZtR;
        "pkg-showkeybinds-21.10.0.3-fabric" = _dUIS2p9r;
        "pkg-showkeybinds-21.10.0.3-neoforge" = _u8YjJ8kq;
        "pkg-showkeybinds-21.8.0.3-neoforge" = _Q9CIAlJC;
        "pkg-showkeybinds-21.8.0.3-fabric" = _dFStS28V;
        "pkg-showkeybinds-21.11.0.0-neoforge" = _bjIHEhcW;
        "pkg-showkeybinds-21.11.0.0-fabric" = _s8KvLctN;
        "pkg-showkeybinds-21.11.0.1-neoforge" = _2X05ipOX;
        "pkg-showkeybinds-21.11.0.1-fabric" = _5DH4RG6S;
        "pkg-showkeybinds-21.11.0.2" = _gqDVw1GT;
        "pkg-showkeybinds-26.1.2.0" = _qMy0wfJh;
        "pkg-showkeybinds-26.1.2.1" = _vSUa5iIa;
        "pkg-showkeybinds-21.11.0.3" = _5PV9Yvfj;
        "default" = _5PV9Yvfj;
    });
