...
let
    ...
    in {
        ...
        "pkg-0.0.5" = _PlU7ISiO;
        "pkg-0.0.6" = _pgOB69Jg;
        "pkg-0.0.6.1" = _mnKkBu6X;
        "pkg-0.0.6.2" = _HocIpcMP;
        "pkg-0.0.7" = _qzIGAgjk;
        "pkg-0.0.8fix" = _MqhYkJm0;
        "pkg-0.0.9" = _HdR0RiGE;
        "pkg-0.0.9.1" = _OBrpAYeY;
        "pkg-0.1" = _RDasmyu3;
        "pkg-0.1.1" = _U3ZX1BCF;
        "pkg-0.1.2" = _pf5u7VAo;
        "pkg-0.1.3" = _tPHB7ZVN;
        "pkg-0.1.4" = _azTzaqPA;
        "pkg-0.1.5.1" = _41Tlwx61;
        "pkg-0.1.6" = _VmUK325F;
        "pkg-0.1.7" = _vg36z1Z7;
        "pkg-0.1.7.1" = _1GkOymKC;
        "pkg-0.1.7.2" = _1hmbjcrI;
        "pkg-0.1.7.3" = _j5JzuYC8;
        "pkg-0.1.8.1" = _Fw1UJSsq;
        "default" = _Fw1UJSsq;
    });
