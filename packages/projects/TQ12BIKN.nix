...
let
    ...
    in {
        ...
        "pkg-1.18.2-2.0.0" = _5PWDNF0f;
        "pkg-1.19.2-3.0.0" = _AhdPbz68;
        "pkg-1.19.2-3.0.1" = _vNCSrhEv;
        "pkg-1.16.4-1.0.2" = _yNjcW0tF;
        "pkg-1.16.4-1.0.3" = _ticNXVRs;
        "pkg-1.16.4-1.0.4" = _K7w8WZMq;
        "default" = _K7w8WZMq;
    });
