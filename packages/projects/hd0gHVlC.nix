...
let
    ...
    in {
        ...
        "pkg-1.18.2-230713T23" = _n4F8K2rH;
        "pkg-1.19.2-0.5.1.f-a" = _B1k6vHzt;
        "pkg-1.20.1-0.5.1.f-a" = _XrTQCgvW;
        "pkg-1.18.2-0.5.1.f-b" = _BzAd11Gz;
        "pkg-1.19.2-0.5.1.f-b" = _K1rp3EUN;
        "pkg-1.20.1-0.5.1.f-b" = _w2M45255;
        "pkg-1.18.2-0.5.1.f-c" = _pRG6dWyt;
        "pkg-1.19.2-0.5.1.f-c" = _ydlRADBN;
        "pkg-1.20.1-0.5.1.f-c" = _TZidvXDo;
        "pkg-1.20.1-0.5.1.f-d" = _J0kgfK7B;
        "pkg-1.18.2-0.5.1.f-e" = _dzTaDe3J;
        "pkg-1.19.2-0.5.1.f-e" = _mY0bEAGz;
        "pkg-1.20.1-0.5.1.f-e" = _EpNXYm6r;
        "pkg-1.18.2-0.5.1.f-f" = _zWO0Xqru;
        "pkg-1.19.2-0.5.1.f-f" = _4Iq5DWhD;
        "pkg-1.20.1-0.5.1.f-f" = _UxW5FUlg;
        "pkg-1.18.2-0.5.1.f-g" = _rSKQXx1N;
        "pkg-1.19.2-0.5.1.f-g" = _VdFKXV3j;
        "pkg-1.20.1-0.5.1.f-g" = _dOFp2y8D;
        "pkg-1.18.2-0.5.1.f-h" = _kdXUVW1O;
        "pkg-1.19.2-0.5.1.f-h" = _DHlPIdp9;
        "pkg-1.20.1-0.5.1.f-h" = _hxFzlolk;
        "pkg-1.20.1-0.5.1.f-i" = _jujVkSeL;
        "pkg-1.20.1-6.0.1-1" = _iOfp88Xh;
        "pkg-1.21.1-6.0.1-1" = _GqvUUMjv;
        "pkg-1.20.1-6.0.2-2" = _8Nf51nuQ;
        "pkg-1.20.1-6.0.2-3" = _bAfZ5oVO;
        "pkg-1.21.1-6.0.2-3" = _oBz6ZWq8;
        "pkg-1.20.1-6.0.6-4" = _Oaf5YSFP;
        "pkg-1.21.1-6.0.6-4" = _Pw3ISURS;
        "pkg-1.20.1-6.0.8-2" = _feGWUw6z;
        "pkg-1.21.1-6.0.8-2" = _KdPFOZz6;
        "pkg-1.20.1-6.0.8-3" = _EeHyODjh;
        "pkg-1.21.1-6.0.9-1" = _gAQkRHAM;
        "pkg-1.20.1-6.0.8-4" = _Vp7W4GHf;
        "pkg-1.21.1-6.0.9-2" = _wGMlTQBq;
        "pkg-1.20.1-6.0.8-5" = _fbFWva90;
        "pkg-1.21.1-6.0.10-1" = _AkPhHye9;
        "pkg-1.21.1-6.0.10-2" = _o0s0ljR0;
        "default" = _o0s0ljR0;
    });
