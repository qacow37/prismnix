...
let
    ...
    in {
        ...
        "pkg-v21.8.1-1.21.8-Fabric" = _lw0zXBJb;
        "pkg-v21.8.1-1.21.8-NeoForge" = _VaPSjkV2;
        "pkg-21.10.1" = _wIbmDZz4;
        "pkg-21.10.2" = _GKoKTEBe;
        "pkg-21.11.0" = _N5v197bf;
        "pkg-21.11.1" = _ElUh38mZ;
        "pkg-26.1.0" = _d82aouRt;
        "pkg-26.1.1" = _YWQWuJlq;
