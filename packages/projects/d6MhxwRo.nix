...
let
    ...
    in {
        ...
        "pkg-3.0.0.1" = _ZKYmv3xL;
        "pkg-3.0.1.0" = _VjE0B0IS;
        "pkg-3.1.0.0" = _7E9chxvh;
        "pkg-3.1.0.0-final" = _ZpIwwcWd;
        "pkg-3.2.0.0" = _DWBwvxYf;
        "pkg-3.2.0.1" = _hDJV6eSE;
        "pkg-3.2.0.1-final" = _p2HkEFX8;
        "pkg-3.2.1.0" = _71hDkVmW;
        "pkg-1.20.4-3.3.0-alpha" = _9d7iesdC;
        "pkg-1.20.4-3.3.1-alpha" = _BQHcArq1;
        "pkg-1.20.4-3.3.2-alpha" = _KYNsHkd2;
        "pkg-1.20.4-3.3.3-alpha" = _36ptZs9K;
        "pkg-1.20.4-3.3.4-alpha" = _SUHUdySr;
        "pkg-1.20.4-3.3.5-alpha" = _30Ejre5Z;
        "pkg-1.20.4-3.4.0-beta" = _l55HWxx1;
        "pkg-1.20.4-3.4.1-beta" = _SYZl6n7d;
        "pkg-1.20.4-3.4.2-beta" = _Bqt8w9ru;
        "pkg-1.20.2-3.4.3-beta" = _VHRSO7ZQ;
        "pkg-4.0.0" = _uJTVdT5m;
        "pkg-4.0.1" = _R5JVbd4C;
        "pkg-4.0.2" = _Rv24sN2I;
        "pkg-5.0.0" = _fUws6aVz;
        ...
        "pkg-4.0.9" = _kn0UbpDg;
        "pkg-5.1.3" = _SP2RFSmQ;
        "pkg-4.0.10" = _ECNOTMWq;
        "pkg-5.1.4" = _z8KdQjlp;
        "pkg-4.0.11" = _sBKGyqW4;
        "pkg-5.1.5" = _qnDdbthI;
        "pkg-5.1.6" = _lWsJwi6v;
        "pkg-6.0.0" = _ugHcChia;
        "pkg-6.0.1" = _ccYmKs1l;
