...
let
    ...
    in {
        ...
        "pkg-0.3.0" = _owDkCJsB;
        "pkg-0.4.0" = _g3Rsk02v;
        "pkg-0.4.0.3" = _zzE8Lf6B;
        "pkg-0.4.1" = _buwTLACR;
        "pkg-0.5.0" = _duiXHMVW;
        "pkg-0.5.0.1" = _Eg5m6U5y;
        "pkg-0.6.0" = _IN4TquEC;
        "pkg-0.7.0" = _Lij30jRn;
        "pkg-0.7.1" = _t6feIJG7;
        "pkg-0.7.2" = _WubrtBHd;
        ...
        "pkg-0.9.0" = _zouDZKi5;
        "pkg-0.9.1" = _Mxtfnssi;
        "pkg-0.9.1.1" = _ILwimRIx;
        "pkg-0.9.1.2" = _3ODHk1fd;
        "pkg-0.9.1.3" = _6MQXL2pt;
        "pkg-0.9.1.4" = _IqeEuv04;
        "pkg-0.9.2" = _agZa1igs;
        "pkg-0.10.0" = _iwvgOhvw;
        "pkg-0.10.1" = _Q7MQm2v2;
        "pkg-0.10.2" = _mA2XPiwl;
        "pkg-0.11.0" = _vZbox6kk;
        "pkg-0.12.0" = _NG6XFFee;
        "pkg-0.12.1" = _6MCJvt8V;
        "pkg-0.12.2" = _G0ZXslP9;
        "default" = _G0ZXslP9;
    });
