...
let
    ...
    in {
        ...
        "pkg-0.0.3+1.20.1" = _FVM6NXkt;
        "pkg-0.0.3+1.19.3" = _zh3kHCXF;
        "pkg-0.1.1+1.19.2" = _qFVPJ6vv;
        "pkg-0.1.1+1.19.3" = _8d1FUELd;
        "pkg-0.1.1+1.20.1" = _XZELV3gz;
        "pkg-0.1.2+1.19.2" = _r5xCzBSN;
        "pkg-0.1.2+1.19.3" = _xoJm1Zpa;
        "pkg-0.1.2+1.20.1" = _xa9C4bvp;
        "pkg-0.1.4+1.19.2" = _AS4GTmHe;
        "pkg-0.1.4+1.19.3" = _PsiBr3FT;
        "pkg-0.1.4+1.20.1" = _D0Q1QXID;
        "pkg-0.1.5+1.19.2" = _XrxPLp7u;
        "pkg-0.1.5+1.19.3" = _tCtrYe7f;
        "pkg-0.1.5+1.20.1" = _50XDXx56;
        "pkg-0.1.6+1.19.2" = _xlBwSY56;
        "pkg-0.1.6+1.19.3" = _Fxvr2ngB;
        "pkg-0.1.6+1.20.1" = _oNsIbpWf;
        "pkg-0.1.7+1.19.2" = _yAmMpORk;
        "pkg-0.1.7+1.19.3" = _rRp1SXaC;
        "pkg-0.1.7+1.20.1" = _Xafz6dMj;
        "pkg-0.1.7+1.20.5" = _bcVn1njX;
        "pkg-0.1.7+1.21" = _Jbz0HPNl;
        "pkg-0.1.8+1.21" = _26GBNcEo;
        "pkg-0.1.8+1.21.3" = _bsH6WhXZ;
        "pkg-0.1.8+1.21.4" = _oAAYZPQj;
        "pkg-0.1.8+1.21.5" = _ymttiV0a;
        "pkg-0.1.8+1.21.6" = _fADoynu8;
        "pkg-0.1.9+1.21" = _xM25oxky;
        "pkg-0.1.9+1.21.3" = _NIOt2eFj;
        "pkg-0.1.9+1.21.4" = _xA1UeXe6;
        "pkg-0.1.9+1.21.5" = _pMBqrnI8;
        "pkg-0.1.9+1.21.6" = _Szxds01I;
        "pkg-0.1.9+1.21.9" = _7cbPvbZP;
        "pkg-0.1.10+1.21.9" = _ndXOEZHN;
