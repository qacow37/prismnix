...
let
    ...
    in {
        ...
        "pkg-0.0.1+dev-d3be8486" = _HZ9cWq5P;
        "pkg-0.0.1+dev-b646c939" = _lwNgogpE;
        "pkg-0.0.1+dev-0b06dba1" = _ddAOFzTo;
        "pkg-0.0.1+dev-3eb4d5d0" = _uuSz3hr0;
        "pkg-0.0.1+dev-cd9c17dd" = _gaMdNDnh;
        "pkg-0.0.1+dev-4c1e9fff" = _SkKhIuCK;
        "pkg-0.0.1+dev-91c1ecc6" = _yFvuON9Y;
        "pkg-0.0.1+dev-5c15f801" = _KRZ27juE;
        "pkg-0.0.1+dev-c6c4996b" = _wVVjnYb4;
        "pkg-0.0.1+dev-b672c739" = _zQGWzX7D;
        "pkg-0.0.1+dev-f039da13" = _mLYeyGbD;
        "pkg-0.0.1+dev-c1cb1ca8" = _PEBa0Ae8;
        "pkg-0.0.1+dev-92ec80b7" = _ihIZP2Ip;
        "pkg-0.0.1+dev-a086b39a" = _RKNaX3BY;
        "pkg-0.0.1+dev-e7a00751" = _m8Vx0CNV;
        "pkg-0.0.1+dev-fade5039" = _Nroxc3iK;
        "pkg-0.0.1+dev-51223420" = _bp42fIdH;
        "pkg-0.0.1+dev-20788815" = _QeKEiocj;
        "pkg-0.0.1+dev-1ab7a921" = _4lqNULKV;
        "pkg-0.0.1+dev-fbac025c" = _XSSNV0ES;
        "pkg-0.0.1+dev-25ca174e" = _TdRlLKSS;
        "pkg-0.0.1+dev-6caae1fa" = _X8PfoZZr;
        "pkg-0.0.1+dev-eb04a533" = _6sBpPxhc;
        "pkg-0.0.1+dev-04bb66a1" = _kGIXv5F4;
        "pkg-0.0.1+dev-58967a81" = _P8nZ9DKB;
        "pkg-0.0.1+dev-d26cfa0f" = _AFkSqh1k;
        "pkg-0.0.1+dev-36e2b042" = _o3WkqLRz;
        "pkg-0.0.1+dev-cad31a9c" = _9o3Tajlo;
        "pkg-0.0.1+dev-dcc7c3cf" = _xDVhY4eJ;
        "pkg-0.0.1+dev-261cdb99" = _f9IDaBRR;
        "pkg-0.0.1+dev-794ce7f5" = _eb41j3Ez;
        "pkg-0.0.1+dev-44f61698" = _KfJxdrpT;
        "pkg-0.0.1+dev-0bf19c1e" = _VfndMFvf;
        "pkg-0.0.1+dev-e613564e" = _dmwPrjYT;
        "pkg-0.0.1+dev-f2954fbf" = _JBPaH3Yj;
        "pkg-0.0.1+dev-02b16103" = _menOXtRs;
        "pkg-0.0.1+dev-5a1712cd" = _zSVmW6U5;
        "pkg-0.0.1+dev-4588830d" = _2m4zFq8g;
        "pkg-0.0.1+dev-ca233b25" = _xoIKYFuk;
        "pkg-0.0.1+dev-cf4eb5df" = _15FXyAJw;
        "pkg-0.0.1+dev-ef24eeaf" = _hMdQocjH;
        "pkg-0.0.1+dev-adfdb577" = _a9wjXCHN;
        "pkg-0.0.1+dev-9aad05ab" = _ibI444m5;
        "pkg-0.0.1+dev-9412bda6" = _jq7B641D;
        "pkg-0.0.1+dev-2a38d49b" = _SLHVmfU4;
        "pkg-0.0.1+dev-5e05a560" = _aFQX7bVb;
        "pkg-0.0.1+dev-fe304de1" = _ylchuRl8;
        "pkg-0.0.1+dev-a6039b5f" = _amPznVnI;
        "pkg-0.0.1+dev-cd6c89c4" = _Wi34pLVF;
        "pkg-0.0.1+dev-69729c3f" = _j0IxOIZK;
        "pkg-0.0.1+dev-950b4d8c" = _YLTEFx6I;
        "pkg-0.0.1+dev-d3ba36f5" = _MZ0zg1E3;
        "pkg-0.0.1+dev-83e94353" = _TA7tv6IA;
        "pkg-0.0.1+dev-20246767" = _vesn4ezu;
        "pkg-0.0.1+dev-89d36c50" = _WNEzTxbn;
        "pkg-0.0.1+dev-16e6305a" = _2SVVKRPL;
        "pkg-0.0.2" = _yUuNkdN3;
        "pkg-0.0.3" = _TozT14BV;
        "pkg-0.0.4" = _bXEFAYSj;
        "pkg-0.0.5" = _pEvEjYMI;
        "pkg-0.0.6" = _TawBT8Vl;
        "pkg-0.0.7+fabric" = _kirCyiP9;
        "pkg-0.0.7+neoforge" = _GqzSZjxF;
        "pkg-0.0.8+neoforge" = _3X4abreG;
        "pkg-0.0.8+fabric" = _VTUJql0y;
        "pkg-0.0.9+fabric" = _iBa704Bh;
        "pkg-0.0.9+neoforge" = _bstw8RWl;
        "pkg-0.0.10+neoforge" = _erSHTCUj;
        "pkg-0.0.10+fabric" = _JxpOIlqm;
        "default" = _JxpOIlqm;
    });
