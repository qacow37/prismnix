...
let
    ...
    in {
        ...
        "pkg-1.0.0-SNAPSHOT+1.20" = _Svm5KhTZ;
        "pkg-1.0.0-SNAPSHOT+1.20.1" = _kDNMTCUp;
        "pkg-1.0.0-SNAPSHOT+1.20.2" = _XzmMZl1g;
        "pkg-1.0.0-SNAPSHOT+1.20.3" = _nhRqqNtW;
        "pkg-1.0.0-SNAPSHOT+1.20.4" = _zabpextf;
        "pkg-1.0.0-SNAPSHOT+1.20.5" = _tV9Z61rV;
        "pkg-1.0.0-SNAPSHOT+1.20.6" = _6bNb6iUF;
        "pkg-1.0.0-SNAPSHOT+1.21" = _VUkQBC87;
        "pkg-1.0.0-SNAPSHOT+1.21.1" = _6dKo6XwH;
        "pkg-1.0.0-SNAPSHOT+1.21.2" = _GwHf0zcI;
        "pkg-1.0.0-SNAPSHOT+1.21.3" = _A5T5lh8N;
        "pkg-1.0.0-SNAPSHOT+1.21.4" = _SOZfRkqa;
        "pkg-1.0.0-SNAPSHOT+1.21.5" = _OaKtsqN4;
        "pkg-1.0.0-SNAPSHOT+1.21.6" = _ULeZzCOM;
        "pkg-1.0.0-SNAPSHOT+1.21.7" = _dEWlD9tT;
        "pkg-1.0.0-SNAPSHOT+1.21.8" = _AW3sGjva;
        "pkg-1.0.0-SNAPSHOT+1.21.9" = _o13ESv6m;
        "pkg-1.0.0-SNAPSHOT+1.21.10" = _AzzQgHyh;
        "pkg-1.0.0-SNAPSHOT+1.21.11" = _91t7rVgP;
        "pkg-1.0.0-SNAPSHOT+26.1" = _cbXhYlDr;
        "pkg-1.0.0-SNAPSHOT+26.1.1" = _FNqSmhz4;
        "pkg-1.0.0-SNAPSHOT+26.1.2" = _1NNhJTAG;
        "pkg-1.0.0-SNAPSHOT" = _Q1ADqagI;
        "default" = _Q1ADqagI;
    });
