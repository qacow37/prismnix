...
let
    ...
    in {
        ...
        "pkg-1.4.1+1.21.5" = _haZmUJaY;
        "pkg-1.4.1+1.21.6" = _mJLBcsON;
        "pkg-1.5.1+1.21.6" = _NT16NGb2;
        "pkg-1.5.1+1.21.11" = _9ypwOMPi;
        "pkg-1.5.2+1.21.11" = _YgHoEXHN;
        "pkg-1.5.3+1.21.11" = _Mgnx9WEw;
        "pkg-1.5.4" = _7tmj7tAp;
        "pkg-1.6.0" = _uIz7Znoi;
        "pkg-1.6.1" = _z072sf6I;
        "pkg-1.6.1+1.21.1" = _twLXh8Bx;
        "pkg-1.7.0+1.21.1" = _KBKmL1IG;
        "pkg-1.7.0+1.20.1" = _V8LAGRuM;
        "pkg-1.7.1+1.20.1" = _oZhJ5v1x;
        "pkg-1.7.2" = _5D4OoqiL;
        "pkg-1.7.2+1.21.1" = _pGCWhUMd;
        "pkg-1.7.2+1.21.2" = _hUaIKY22;
        "pkg-1.7.2+1.21.3" = _Aa9Bugjc;
        "pkg-1.7.2+1.21.4" = _iRS6o7by;
        "pkg-1.7.2+1.21.5" = _HMQzsaPv;
        "pkg-1.7.2+1.21.6" = _xoD3xo7Y;
        "pkg-1.7.2+1.21.7" = _5amOOAfH;
        "pkg-1.7.2+1.21.8" = _Q9hqc0yF;
        "pkg-1.7.2+1.21.9" = _FtmZ84fv;
        "pkg-1.7.2+1.21.10" = _qbUgaLkW;
