...
let
    ...
    in {
        ...
        "pkg-1.0.3-1.21.11" = _3ySIngwM;
        "pkg-1.0.4-1.21.11" = _rlWNnoL6;
        "pkg-1.0.5-1.21.11" = _zCsBkBDT;
        "pkg-1.0.5-26.1.2" = _fpW2iMmk;
        "pkg-1.0.5b-1.20.1" = _l8OWhZtp;
        "pkg-1.0.5-26.2" = _b2ZFCEAD;
        "pkg-1.0.6-1.20.1" = _4rIYPVJR;
