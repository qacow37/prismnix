...
let
    ...
    in {
        ...
        "pkg-1.19.2-Forge-3.0" = _fZAUUop4;
        "pkg-1.19.2-Fabric-3.0" = _PGslvGfk;
        "pkg-1.19.2-Forge-3.0.1" = _nAUDoZw6;
        "pkg-1.19.2-Fabric-3.0.1" = _guE4gNYH;
        "pkg-1.19.3-Forge-3.1.0" = _QzQxGeh0;
        "pkg-1.19.4-Forge-3.2.0" = _ncI5s51y;
        "pkg-1.19.3-Fabric-3.1.0" = _PndwEY0C;
        "pkg-1.19.4-Fabric-3.2.0" = _t0EvcKWk;
        "pkg-1.20-Forge-4.0" = _C7buFh0l;
        "pkg-1.20-Fabric-4.0" = _UVPLKCqf;
        "pkg-1.20.4-Forge-4.4.0" = _dfKKJWz8;
        "pkg-1.20.4-Fabric-4.4.0" = _kOPN246o;
        "pkg-1.20.4-Forge-4.4.1" = _ocPyiL4C;
        "pkg-1.20.4-NeoForge-4.4.1" = _DMlcRLLS;
        "pkg-1.20.4-Fabric-4.4.1" = _QGaIWzeS;
        "pkg-1.21-Fabric-5.0.0" = _uZ8fe7Rg;
        "pkg-1.21-Forge-5.0.0" = _U1iCcvJ6;
        "pkg-1.21-NeoForge-5.0.0" = _SELXigfX;
        "pkg-1.21.1-Fabric-5.1.0" = _QfkVzJ93;
        "pkg-1.21.1-Forge-5.1.0" = _aSfqiRNd;
        "pkg-1.21.1-NeoForge-5.1.0" = _zAUb7QiZ;
        "pkg-1.21.1-Forge-5.1.1" = _19NbIuyu;
        "pkg-1.21.1-NeoForge-5.1.1" = _fSHYi7qY;
        "pkg-1.21.1-Fabric-5.1.1" = _EktOl8s2;
        "pkg-1.21.1-Forge-5.1.2" = _CMoswD8b;
        "pkg-1.21.1-NeoForge-5.1.2" = _1nkCPaBG;
        "pkg-1.21.1-Fabric-5.1.2" = _8NOIMjA6;
        "pkg-1.21.1-Fabric-5.1.3" = _FfXyVbds;
        "pkg-1.21.1-Forge-5.1.3" = _j0kfms7p;
        "pkg-1.21.1-NeoForge-5.1.3" = _CLZfFbCx;
        "pkg-26.1.2-Fabric-6.1.0" = _2FGUtGfp;
        "pkg-26.1.2-NeoForge-6.1.0" = _FrDboTrJ;
        "default" = _FrDboTrJ;
    });
