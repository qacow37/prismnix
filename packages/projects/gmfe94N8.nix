...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.21.9" = _i8NxOZ3X;
        "pkg-1.0.0+mc1.18.2" = _DmNh5CEE;
        "pkg-1.0.0+mc1.19" = _LKsxe0Bc;
        "pkg-1.0.0+mc1.19.1" = _rpEw37W1;
        "pkg-1.0.0+mc1.19.2" = _boM8uUvb;
        "pkg-1.0.0+mc1.19.3" = _yth1XI9T;
        "pkg-1.0.0+mc1.19.4" = _U7MA24oh;
        "pkg-1.0.0+mc1.20" = _FkhoouBW;
        "pkg-1.0.0+mc1.20.1" = _v0qu0BUd;
        "pkg-1.0.0+mc1.20.2" = _X8dCnkv8;
        "pkg-1.0.0+mc1.20.3" = _RiHamj7i;
        "pkg-1.0.0+mc1.20.4" = _b3ov3MMT;
        "pkg-1.0.0+mc1.20.5" = _1K8WEILr;
        "pkg-1.0.0+mc1.20.6" = _sQ62zW3U;
        "pkg-1.0.0+mc1.21" = _UacshkEW;
        "pkg-1.0.0+mc1.21.1" = _7fa9X44r;
        "pkg-1.0.0+mc1.21.2" = _2wJ39mjc;
        "pkg-1.0.0+mc1.21.3" = _1DrAjQhm;
        "pkg-1.0.0+mc1.21.4" = _4tdIcGxu;
        "pkg-1.0.0+mc1.21.5" = _um7spak0;
        "pkg-1.0.0+mc1.21.6" = _Xm93NeCg;
        "pkg-1.0.0+mc1.21.7" = _tvf5oKOc;
        "pkg-1.0.0+mc1.21.8" = _vLZ2R3hy;
        "pkg-1.0.0+mc1.21.10" = _umYitJiB;
        "pkg-1.0.0+mc25w41a" = _AkNCAy4O;
        "pkg-1.0.0+mc25w42a" = _6UX8KH91;
        "pkg-1.0.0+mc25w43a" = _7OpyAhKE;
        "pkg-1.1.0+mc1.21.11" = _xWl6WdYX;
        "default" = _xWl6WdYX;
    });
