...
let
    ...
    in {
        ...
        "pkg-7.0.3" = _DlznJuJV;
        "pkg-8.0.1" = _l62DYpJc;
        "pkg-10.0.1" = _zawi6Kw5;
        "pkg-9.0.1" = _8z4hpSAO;
        "pkg-10.0.2" = _j4wTZ2mW;
        "pkg-10.0.3" = _S3QijWDv;
        "pkg-10.0.4" = _bWxXrO9d;
        "pkg-11.0.2" = _64gdl0n6;
        "pkg-11.0.3" = _sd9PQ15G;
        "pkg-12.0.1" = _H2ijFbSK;
        "pkg-12.0.2" = _jmt5fqWc;
        "pkg-13.0.1" = _pLJcgjMM;
        "pkg-14.0.1" = _orFMyvwL;
        "pkg-14.0.2" = _haUw4C0a;
        "pkg-14.0.3" = _ZKhX6wNG;
        "pkg-15.0.1" = _eBjevwFA;
        "pkg-16.0.1" = _JLSXVo0r;
        "pkg-16.0.2" = _fZISZc6d;
        "pkg-16.0.3" = _JdHRh6p8;
        "pkg-17.0.1" = _gaiLlYCu;
        "pkg-18.0.2" = _pRRqfn7e;
        "pkg-18.1.3" = _HPp9Uid1;
        "pkg-18.1.4" = _jRCyPTmj;
        "default" = _jRCyPTmj;
    });
