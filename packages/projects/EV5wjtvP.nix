...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _L6cTSF8T;
        "pkg-1.1.3" = _x201sG7Y;
        "pkg-26.1.2-1.3.0+forge" = _o6KaaqsV;
        "pkg-26.1.2-1.3.0+neoforge" = _crgHC5Bb;
        "pkg-26.1.2-1.3.0+paper" = _Ols1os2l;
        "pkg-26.1.2-1.3.0+fabric" = _p0qx7OVf;
        "pkg-1.21.1-1.3.0+fabric" = _JSHpcA8e;
        "pkg-1.21.1-1.3.0+forge" = _BjIZJ000;
        "pkg-1.21.1-1.3.0+neoforge" = _TAPzFI5i;
        "pkg-1.2.0" = _GcXPpPpp;
        "pkg-26.2-1.3.1+forge" = _YoOPELk0;
        "pkg-26.2-1.3.1+neoforge" = _M8NbYcKc;
        "pkg-26.2-1.3.1+paper" = _99aAW151;
        "pkg-26.2-1.3.1+fabric" = _hfUjzXdr;
        "pkg-26.1.2-1.3.1+fabric" = _Qn9lQs3g;
        "pkg-26.1.2-1.3.1+forge" = _oQpDv3wC;
        "pkg-26.1.2-1.3.1+neoforge" = _2UW4p5nG;
        "pkg-26.1.2-1.3.1+paper" = _mloTP9Gz;
