...
let
    ...
    in {
        ...
        "pkg-1.19.2-2.0" = _diM9dXxk;
        "pkg-1.19.3-2.0" = _odi3dDIP;
        "pkg-1.19.4-2.0" = _uTdN51zn;
        "pkg-1.20-2.0" = _i80emWP2;
        "pkg-1.20.1-2.1" = _mGs8g8Wo;
        "pkg-1.20.2-2.1" = _sxn37AkA;
        "pkg-1.20.1-2.2" = _fJOwvDCm;
        "pkg-1.20.2-2.2" = _r21SZj4Z;
        "pkg-1.20.1-2.2.1" = _nfZD8U8u;
        "pkg-1.20.2-2.2.1" = _VWvv6MnY;
        "pkg-1.20.2-2.3" = _hDyIlvwb;
        "pkg-1.20.1-2.3-LTS" = _FjDGIEWM;
        "pkg-1.20.1-2.3.1-LTS" = _agNvOHZs;
        "pkg-1.20.2-2.3.1" = _rQrOJsXM;
        "pkg-1.20.1+3.0-beta.1" = _C1Xk0KJw;
        "pkg-1.20.1+3.0-beta.2" = _fRnq6ebs;
        "pkg-1.20.1+3.0-beta.2a" = _R8x229rW;
        "pkg-1.20.1+3.0-beta.3" = _EWFtDXJv;
        "pkg-1.20.1+3.0-beta.4" = _J9SJuClz;
        "pkg-1.20.1+3.0-LTS" = _ELMV5TPG;
        "pkg-1.20.2+3.0" = _UAcfGhJF;
        "pkg-1.20.4+3.0" = _IOl6MLjy;
        "pkg-1.20.6+3.0" = _5PWMFwzH;
        "pkg-1.20.1+3.0.1-LTS" = _991EnS5A;
        "pkg-1.20.1+3.0.2-LTS" = _n5cXpY7E;
        "pkg-1.20.1+3.0.3" = _RnGVkHxb;
        "pkg-1.20.1+3.0.4" = _6pdARGEH;
        "pkg-1.20.1+3.0.5" = _WmufpC7S;
