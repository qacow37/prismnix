...
let
    ...
    in {
        ...
        "pkg-2.8.0" = _3fCTjY6F;
        "pkg-2.9.0" = _Gvp62YmC;
        "pkg-2.10.0" = _6u8Qmehi;
        "pkg-2.11.0" = _ddN4U9xl;
        "pkg-2.11.1" = _SoZgtBtT;
        "pkg-2.11.2" = _qD990J7Z;
        "pkg-2.12.0" = _VcgOQZo1;
        "pkg-2.12.1" = _RMgTVnMg;
        "pkg-2.12.2" = _JnqIQ9EH;
        "pkg-2.13.0" = _2ElSdr6d;
        "pkg-2.13.1" = _Ibd7c2Fc;
        "pkg-2.13.2" = _ezez6gBY;
        "pkg-2.14.0" = _ouvHO2eC;
        "pkg-2.14.1" = _Bv0pzXbu;
        "pkg-3.0.0-alpha.6+1.21.1-neoforge" = _B3hk1sBo;
        "pkg-3.0.0-alpha.6+1.21.1-fabric" = _MXS8yUik;
        "pkg-3.0.0-alpha.6+1.20.1-fabric" = _XN4wSTTl;
        "pkg-3.0.0-alpha.6+1.20.1-forge" = _jOS5Wi4j;
        "pkg-3.0.0-alpha.7+1.21.1-fabric" = _iaTvG07O;
        "pkg-3.0.0-alpha.7+1.20.1-fabric" = _eNAH2It5;
        "pkg-3.0.0-alpha.7+1.20.1-forge" = _YUvghP7B;
        "pkg-3.0.0-alpha.7+1.21.1-neoforge" = _NVVV990u;
        "pkg-3.0.0-alpha.8+1.21.1-fabric" = _nBzzEr5x;
        "pkg-3.0.0-alpha.8+1.20.1-fabric" = _fI9yHaYe;
        "pkg-3.0.0-alpha.8+1.20.1-forge" = _83uAGlVf;
        "pkg-3.0.0-alpha.8+1.21.1-neoforge" = _aSdd0KCA;
        "pkg-3.0.0-alpha.9+1.20.1-forge" = _9gj4VxTX;
        "pkg-3.0.0-alpha.9+1.20.1-fabric" = _EVRjbdD8;
        "pkg-3.0.0-alpha.9+1.21.1-fabric" = _rhbBrVtI;
        "pkg-3.0.0-alpha.9+1.21.1-neoforge" = _LX0abTbh;
        "pkg-3.0.0-alpha.10+1.20.1-fabric" = _jwKYozYB;
        "pkg-3.0.0-alpha.10+1.21.1-fabric" = _wEKCLlcc;
        "pkg-3.0.0-alpha.10+1.20.1-forge" = _arow8rck;
        "pkg-3.0.0-alpha.10+1.21.1-neoforge" = _wM9iqFmt;
        "pkg-2.14.2" = _PVCsSn4e;
        "default" = _PVCsSn4e;
    });
