...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.0" = _GRxJKAXg;
        "pkg-1.19.2-1.0b" = _eSmqqzOx;
        "pkg-1.19.2-1.0c" = _vTAgqyta;
        "pkg-1.19.2-1.0d" = _53C44mFW;
        "pkg-1.19.2-1.1" = _32D6oMNq;
        "pkg-1.19.2-1.1b" = _zPVoSrJ3;
        "pkg-1.20.1-1.1b" = _KIa5uQ8Q;
        "pkg-1.19.2-1.1c" = _NyJqIpPn;
        "pkg-1.20.1-1.1c" = _6vlLtdrS;
        "pkg-1.18.2-1.1d" = _GJQN0Dcp;
        "pkg-1.19.2-1.1d" = _AkpSpCcq;
        "pkg-1.20.1-1.1d" = _F3B2uDeY;
        "pkg-1.18.2-1.2" = _4DEuR0zs;
        "pkg-1.19.2-1.2" = _7suTgRUM;
        "pkg-1.20.1-1.2" = _oiR1p6NB;
        "pkg-1.18.2-1.2b" = _8s0VwrpH;
        "pkg-1.19.2-1.2b" = _NAQGZB5e;
        "pkg-1.20.1-1.2b" = _uXIUgAks;
        "pkg-1.18.2-1.2c" = _BygoWrb5;
        "pkg-1.19.2-1.2c" = _ISN0XG1f;
        "pkg-1.20.1-1.2c" = _IC16ynbh;
        "pkg-1.18.2-1.2d" = _mb8OBq9q;
        "pkg-1.19.2-1.2d" = _sdhOxxQU;
        "pkg-1.20.1-1.2d" = _kE9ZDFHW;
        "pkg-1.18.2-1.2e" = _k79e94qa;
        "pkg-1.19.2-1.2e" = _odFsSUNk;
        "pkg-1.20.1-1.2e" = _WNZ4u6ej;
        "pkg-1.18.2-1.2f" = _RTfgMUq6;
        "pkg-1.19.2-1.2f" = _rHmPQHn4;
        "pkg-1.20.1-1.2f" = _f0wGwbTR;
        "pkg-1.18.2-1.2g" = _p4vL30pk;
        "pkg-1.19.2-1.2g" = _GQMYymO5;
        "pkg-1.20.1-1.2g" = _fXiIG7ZQ;
        "pkg-1.20.1-1.2h" = _TkW9mOTh;
        "pkg-1.19.2-1.2h" = _i0FKUeRP;
        "pkg-1.18.2-1.2h" = _240H0dbT;
        "pkg-1.20.1-1.2i" = _R6vueHQB;
        "pkg-1.20.1-1.3" = _vL3bm27C;
        "pkg-1.20.1-1.3.1" = _aiB3aZJU;
        "pkg-1.20.1-1.3.2" = _C5orwyhl;
        "pkg-1.20.1-1.3.3" = _rhxQsell;
        "pkg-1.20.1-1.3.4" = _FNKIQlNA;
        "pkg-1.21.1-1.3.4" = _AqYLcPqA;
        "pkg-1.20.1-1.3.5" = _1dUfq2IK;
        "pkg-1.21.1-1.3.5" = _2kgUc4x9;
        "pkg-1.21.1-1.3.6" = _UweAP2HW;
        "pkg-1.21.1-1.3.7" = _GJ3rLH0C;
        "pkg-1.21.1-1.3.8" = _ZUPcgHTb;
        "pkg-1.20.1-1.3.8" = _co8qZn3O;
        "pkg-1.20.1-1.3.9" = _NJpDn3VZ;
        "pkg-1.20.1-1.3.10" = _ZxfogApf;
        "pkg-1.20.1-1.3.11" = _TyM6bdEi;
        "pkg-1.21.1-1.3.11" = _uxgzKkcD;
        "pkg-1.20.1-1.3.12" = _DTQVvA5H;
        "pkg-1.21.1-1.3.12" = _3PddTDD8;
        "pkg-1.21.1-1.3.13" = _7TPYyw7R;
        "pkg-1.21.1-1.3.14" = _Kijd1iDy;
        "pkg-1.21.1-1.3.15" = _UoPH8lO1;
        "default" = _UoPH8lO1;
    });
