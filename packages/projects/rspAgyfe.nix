...
let
    ...
    in {
        ...
        "pkg-0.1-neoforged" = _4KaOxHVD;
        "pkg-0.1.1-neoforged" = _DCJYzO5l;
        "pkg-0.2-neoforged" = _efaDQcvG;
        "pkg-0.2.1-neoforged" = _L7G3qapC;
        "pkg-0.2.2-neoforged" = _dd9cSCss;
        "pkg-0.2.2+1.21.1" = _oOYhGsqb;
        "default" = _oOYhGsqb;
    });
