...
let
    ...
    in {
        ...
        "pkg-1.12.2-1.0.4" = _dLRrRS4R;
        "pkg-1.13.2-1.0.3" = _hpMHA9vT;
        "pkg-1.12.2-1.3.6.a" = _mWSY9YzR;
        "pkg-1.12.2-1.4.0.1" = _qfywR6ZE;
        "pkg-1.14.4-1.4.0" = _klpLELUU;
        "pkg-1.15.2-1.4.0.1" = _V6Jnimez;
        "pkg-1.16.3-1.4.2" = _5I73tu6X;
        "pkg-1.16.4-1.5.0.1" = _Enp1Ywoy;
        "pkg-1.16.3+4+5-1.5.10" = _wdznF9hb;
        "pkg-1.16.5-1.6.1.1" = _zwdb8KdZ;
        "pkg-1.17.1-1.7.1" = _9aGWDZRX;
        "pkg-1.18.1-1.7.1" = _KChjsx0N;
        "pkg-1.19-1.9.0" = _SJ6WNk5J;
        "pkg-1.9.0" = _7sqwx371;
        "pkg-10.0" = _VC1R3yJ6;
        "pkg-1.19.2-11.0" = _HSdbzrpF;
        "pkg-1.19.2-11.1" = _pYULLvAz;
        "pkg-11.2" = _HkT1Cwur;
        "pkg-1.19.3-11.2" = _abaIXei2;
        "pkg-1.19.3-11.2-dapper" = _rhxnXUV5;
        "pkg-1.18.2-11.2" = _klvZPBrI;
        "pkg-1.19.3-11.3" = _Nprurnih;
        "pkg-1.19.3-11.4" = _Otmchy43;
        "pkg-1.19.2-11.4" = _XFVOM5Rn;
        "pkg-1.18.2-11.4" = _rUD6C3AF;
        "pkg-1.19.4-11.4" = _xIetVcNI;
        "pkg-1.20.1-11.5" = _IrOYz9Fh;
        "pkg-1.20.1-11.6" = _ryBgYGy3;
        "pkg-1.20.1-11.7" = _juJOcAVP;
        "pkg-1.20.1-12.0" = _YsdksQfp;
        "pkg-1.16.5-6.1.2" = _bfiTI6I6;
        "pkg-1.20.1-12.1" = _qazJUqW8;
        "pkg-1.19.2-11.5" = _aqA3XqyD;
        "pkg-1.20.1-12.2" = _H6RUqJQF;
        "pkg-1.19.2-12.3" = _QN104iTo;
        "pkg-1.20.1-12.3" = _JEClG7aA;
        "pkg-1.18.2-11.5" = _9UHuDFhc;
        "pkg-1.20.1-12.4" = _HodnIomh;
        "pkg-1.20.1-12.4-april-01-2024" = _F9hTLi10;
        "pkg-1.20.1-12.6" = _YBItyvRD;
        "pkg-1.20.1-13.0" = _d8lb2pf6;
        "pkg-1.20.1-13.1" = _LyTBDU0e;
        "pkg-1.19.2-13.1" = _W9LGEhWA;
        "pkg-1.20.1-13.2" = _OJUfYNVh;
        "pkg-1.20.1-13.3" = _Wt1Uee8K;
        "pkg-1.20.1-13.4" = _gJlWMhhS;
        "pkg-1.20.1-13.5" = _TugfovvI;
        "pkg-1.20.2-13.5" = _OqZJYWX9;
        "pkg-1.20.4-13.5" = _ELNItR5X;
        "pkg-1.18.2-11.6" = _dCvlqCTR;
        "default" = _dCvlqCTR;
    });
