...
let
    ...
    in {
        ...
        "pkg-v.1.1.0+mod" = _Qt1NnxcU;
        "pkg-v2.0.0" = _HIRgfaFH;
        "pkg-v2.0.0+mod" = _wdbc65zz;
        "pkg-v2.0.1" = _KzzNQChz;
        "pkg-v2.0.1+mod" = _QtpGLny6;
        "pkg-v2.0.2" = _apoPIftj;
        "pkg-v2.0.2+mod" = _Hg3l8LEW;
        "pkg-v2.0.2.1" = _yYOaCptH;
