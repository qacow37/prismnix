...
let
    ...
    in {
        ...
        "pkg-1.038" = _nvKhrnLQ;
        "pkg-1.1" = _kfVvVhrT;
        "pkg-1.b2002" = _GyoYb29i;
        "pkg-1.2b003" = _vqnJaML0;
        "pkg-1.b2004" = _jBdxYHvt;
        "pkg-1.b2005" = _fQlH76BK;
        "pkg-1.b2006" = _cP83NV54;
        "pkg-1.b2007" = _YKNyMiQJ;
        "pkg-1.b2008" = _D5jDtzma;
        "pkg-1.b2009" = _tUBbuHbZ;
        "pkg-1.b2010" = _d0ihpsF6;
        "pkg-1.b2011" = _nmYySg8S;
        "pkg-1.b2012" = _hb4JZ6YB;
        "pkg-1.b2013" = _jLqzq5df;
        "pkg-1.b2014" = _5Z3smVLQ;
        "pkg-1.2b015" = _TXlwzGmg;
        "pkg-1.2b016" = _QpvF09LB;
        "pkg-1.2b017" = _uOZ85yDp;
        "pkg-1.2b018" = _uM82UkRi;
        "pkg-1.2b019" = _tJIOSlSW;
        "pkg-1.2b020" = _tTewtWrW;
        "pkg-1.2b021" = _7esrUhB4;
        "pkg-1.2b022" = _rls7Hf4J;
        "pkg-1.2b023" = _T9CzzPxw;
        "pkg-1.2b024" = _ylh53eZN;
        "pkg-1.2b025" = _zS65KvNa;
        "pkg-1.2b026" = _QmLx4sYM;
        "pkg-1.2b027" = _VEnSvQPb;
        "pkg-1.2b028" = _nlCEptT7;
        "pkg-1.2b029" = _92glicMc;
        "pkg-1.2b030" = _gPs6JfEg;
        "pkg-1.2b031" = _mDR1LMMp;
        "pkg-1.2b032" = _9IeMpXp9;
        "pkg-1.2b033" = _XL12I0Bh;
        "pkg-1.2b034" = _KCVofRph;
        "pkg-1.2b035" = _hpji4gSk;
        "pkg-1.2b036" = _BYODCcXJ;
        "pkg-1.2b037" = _bAcLjFnd;
        "pkg-1.2b038" = _Yzshns3V;
        "pkg-1.2b039" = _HwdONtmy;
        "pkg-1.2b040" = _PoaAAVNt;
        "pkg-1.2b041" = _fmH8x9hr;
        "pkg-1.2b042" = _p6mrniXE;
        "pkg-1.2b043" = _7FbTCgGR;
        "pkg-1.2b044" = _1bBe8snW;
        "pkg-1.2b045" = _7PoEwmHt;
        "pkg-1.2b046" = _qMAhB7j3;
        "pkg-1.2b047" = _iRMKFfGJ;
        "pkg-1.2b048" = _kVMHg6xW;
        "pkg-1.2b049" = _Qi1e1Qo3;
        "pkg-1.2b050" = _mm9tOA8i;
        "pkg-1.2b051" = _Qz9xlPVl;
        "pkg-1.2b052" = _yml52FKN;
        "pkg-1.2b053" = _Z1K8b1HX;
        "pkg-1.2b054" = _McV4lxru;
        "pkg-1.2b055" = _PJhNLUXi;
        "pkg-1.2b056" = _2M1Zlzpo;
        "pkg-1.2b057" = _b8PWorQ3;
        "pkg-1.2" = _xXKGfJ7l;
        "pkg-1.2.1" = _5eofN3Nc;
        "pkg-1.2.2" = _vFdw7JfD;
        "pkg-1.2.3" = _QYw7sigI;
        "pkg-1.2.31" = _m0UzpZsK;
        "pkg-1.2.32" = _5gEem7TY;
        "pkg-1.2.33" = _O7sGvYJh;
        "pkg-1.2.34" = _6LfcvO65;
        "pkg-1.2.4" = _nesKPrb4;
        "default" = _nesKPrb4;
    });
