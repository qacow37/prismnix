...
let
    ...
    in {
        ...
        "pkg-1.2.8" = _nZ5LKTCS;
        "pkg-1.2.9" = _rlk3KsiB;
        "pkg-2.3.10" = _qh549DtR;
        "pkg-1.0.2" = _EPns2jh4;
        "pkg-2.2.10" = _l1DUB2Ah;
        "pkg-2.4.12" = _ZiEpwnCj;
        "pkg-4.0.1" = _T83qQ43y;
        "pkg-3.0.1" = _PlFAb4Mr;
        "pkg-5.2.3" = _mngMZGDF;
        "pkg-6.3.4" = _Y82SyuUN;
        ...
        "pkg-7.1.8" = _zCd4ZWwJ;
        "pkg-6.1.4" = _Q4sEfm6d;
        "pkg-5.2.11" = _1VanCAbL;
        "pkg-4.1.8" = _avmIOZMt;
        "pkg-9.1.4" = _mjPvieYu;
        "pkg-8.0.4" = _lsmg0IAn;
        "pkg-7.1.9" = _GsYveSdc;
        "pkg-6.1.5" = _DRXa1ouL;
        "pkg-5.2.12" = _Bihv5GEE;
        "pkg-5.2.13" = _I6RR7DjY;
        "pkg-6.1.6" = _2VzgrrH6;
        "pkg-7.1.10" = _PvggYwng;
        "pkg-8.0.5" = _adgMRANp;
        "pkg-9.1.5" = _xyCvzI7e;
        "pkg-5.2.14" = _7WDvIlZj;
        "pkg-10.0.0" = _YD3cSdvJ;
        "pkg-4.2.11" = _5fjIyC3U;
        "pkg-4.2.13" = _Micu6xhs;
        "pkg-4.3.13" = _h661Jr4Z;
        "pkg-5.3.17" = _ZZRJmoPR;
        "pkg-6.2.7" = _nnx1LOsb;
        "pkg-7.2.11" = _6ibxBdBK;
        "pkg-8.1.6" = _5dDoJsEI;
        "pkg-9.2.6" = _21ftRAqm;
        "pkg-10.1.1" = _EB0TKURa;
        "pkg-10.1.2" = _IMAstosK;
        "pkg-9.2.7" = _3fSs3R60;
        "pkg-8.1.7" = _46dWTgMl;
        "pkg-10.1.3" = _6lYVRgr8;
        "pkg-10.3.3" = _mqoGDqPI;
        "pkg-7.2.12" = _qisAC3yK;
        "pkg-9.2.8" = _EFcf2dG4;
        "pkg-10.3.4" = _Z0PRt04j;
        "pkg-9.2.9" = _YpDBQ4Mq;
        "pkg-7.2.13" = _jx40y7PA;
        "pkg-4.3.15" = _fBlIZMlg;
        "pkg-10.3.5" = _pgJj6CnC;
        "pkg-4.3.16" = _eBE7QD7E;
        "pkg-7.2.14" = _xXBnKxq4;
        "pkg-9.2.10" = _unzbuy9b;
        "pkg-10.3.7" = _jvY6sw9y;
        "pkg-10.3.8" = _r2mnc8w2;
        "pkg-10.5.9" = _us0gze50;
        "pkg-26.1.2.0" = _YC1JE0Uv;
        "pkg-21.4.0" = _j0dXhfLr;
        "pkg-21.11.0" = _ojk3nnCm;
        "pkg-26.2.0.0" = _zOFPqPBG;
        "default" = _zOFPqPBG;
    });
