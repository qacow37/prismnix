...
let
    ...
    in {
        ...
        "pkg-0.1.0-1.20.1-build.47" = _154fUbpD;
        "pkg-0.2.0-1.20.1-build.54" = _5WcRBiPr;
        "pkg-0.2.1-1.20.1-build.58" = _DT9MUggS;
        "pkg-0.2.1-1.20.4-build.59" = _Zl3Tn6If;
        "pkg-0.2.2-1.20.1-build.63" = _Z3P9ef7U;
        "pkg-0.2.2-1.20.4-build.64" = _S2aJklol;
        "pkg-0.3.0-1.20.4-build.2" = _tsFXwo6U;
        "pkg-0.3.0-1.20.1-build.1" = _AYr65tyn;
        "pkg-0.3.1-1.20.4-build.4" = _K13nGmt3;
        "pkg-0.3.1-1.20.1-build.3" = _TuLyGcE0;
        "pkg-0.3.2-1.20.1-build.5" = _8ENdxUj3;
        "pkg-0.3.2-1.20.4-build.6" = _IaJVCMRN;
        "pkg-0.4.0-1.20.1-build.9" = _wKZQRHor;
        "pkg-0.4.0-1.20.4-build.10" = _AeHVKpVl;
        "pkg-0.4.1-1.20.1-build.11" = _qxqBJX9b;
        "pkg-0.4.1-1.20.4-build.12" = _u2H8wmBl;
        "pkg-0.5.0-1.20.1-build.13" = _hiiJqtOJ;
        "pkg-0.5.0-1.20.4-build.14" = _qsS9ASnB;
        "pkg-0.6.0-1.20.1-build.15" = _UiDLXvOM;
        "pkg-0.6.0-1.20.4-build.16" = _NHCkgrrg;
        "pkg-0.7.0-1.20.1-build.17" = _DCvJJQTQ;
        "pkg-0.7.0-1.20.4-build.18" = _wvRKZ0m7;
        "pkg-0.7.0-1.21-build.19" = _ADPnvKMX;
        "pkg-0.8.0-1.20.1-build.20" = _9PoqSbkx;
        "pkg-0.8.0-1.20.4-build.21" = _Kwj4ukI8;
        "pkg-0.8.0-1.21-build.22" = _BU0JfrKI;
        "pkg-0.9.0-1.20.1-build.23" = _YmzYMOJz;
        "pkg-0.9.0-1.21-build.24" = _IUsm0utP;
        "default" = _IUsm0utP;
    });
