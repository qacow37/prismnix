...
let
    ...
    in {
        ...
        "pkg-0.4.4.0" = _gUBYZCZD;
        "pkg-0.4.3.1" = _YkmCn2xL;
        "pkg-0.4.3.0" = _HoBIPSpG;
        "pkg-0.3.4.0" = _tHse2KHN;
        "pkg-0.5.0" = _N6E9Gemy;
        "pkg-0.6.0" = _2D5AOwaK;
        "pkg-0.7.0" = _HuqCYELJ;
        "pkg-0.8.0" = _NygLYmWP;
        ...
        "pkg-0.9.1" = _iEYjbNXS;
        "pkg-0.9.2" = _Uq2MoVkW;
        "pkg-0.10.0" = _3JuGGZWn;
        "pkg-0.11.0" = _GDjavHGG;
        "pkg-0.8.4" = _sxNMV37z;
        "pkg-0.11.1" = _8d7L24jp;
        "pkg-0.11.2" = _dk9IcYxN;
        "pkg-0.12.0" = _aRdErlDs;
        "pkg-0.13.0" = _lyJpLqTn;
        "pkg-0.14.0" = _R5TbeJL9;
        "pkg-0.15.0" = _moqbmqi9;
        "default" = _moqbmqi9;
    });
