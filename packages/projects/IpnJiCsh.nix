...
let
    ...
    in {
        ...
        "pkg-0.0.2" = _jbMThbSf;
        "pkg-0.0.3" = _vZGenXYP;
        "pkg-0.0.3_1.19.3" = _azTNcDzn;
        "pkg-0.0.4_1.19.4" = _gsTbYbHa;
        "pkg-0.0.4_1.19.3" = _ZieUJG1m;
        "pkg-0.0.5_1.19.4" = _jhehiDK6;
        "pkg-0.0.5_1.19.3" = _9wEIrSva;
        "pkg-1.19.4-0.0.6" = _gffd6aEf;
        "pkg-1.20-0.0.6" = _o1XIQUpq;
        "pkg-1.20.1-0.0.6" = _iCGJm4W8;
        "pkg-1.20.1-0.0.6_b" = _PbqerqJT;
        "pkg-1.19.4-0.0.6_b" = _mNI0RXEs;
        "pkg-1.20.1-0.0.7" = _OrKvtu6D;
        "pkg-1.19.4-0.0.7" = _AMH8yqFG;
        "pkg-1.20.1-0.0.8" = _1eyciZrP;
        "pkg-1.20.1-0.0.9" = _iYo1fpva;
        "pkg-1.20.1-0.0.9_b" = _cQfGxJWI;
        "pkg-1.20.2-0.0.9_b" = _2eyZxOoO;
        "pkg-1.20.4-0.0.9_b" = _jxD18MAg;
        "pkg-1.20.1-0.0.10" = _zc2mw2jr;
        "pkg-1.20.2-0.0.10" = _5CUWT2lv;
        "pkg-1.20.4-0.0.10" = _fzuZGiR0;
        "pkg-1.20.1-0.0.10-b" = _mdup7MxI;
        "pkg-1.20.2-0.0.10-b" = _RGmg8TjC;
        "pkg-1.20.4-0.0.10-b" = _FVQPYXi7;
