...
let
    ...
    in {
        ...
        "pkg-1.16.5-4.0.8.2" = _BcHPbGLy;
        "pkg-0.0.13-1.16.5" = _Hm7rMu2c;
        "pkg-1.17.1-5.0.2.7" = _bE5ThdZW;
        "pkg-1.18.2-5.0.7.1" = _kWbiHplj;
        "pkg-1.19.2-5.1.1.0" = _L0vjJCcV;
        "pkg-1.19.3-5.1.2.0" = _FgmAnDM9;
        "pkg-1.19.3-5.1.3.0" = _tnz2VF5O;
        "pkg-1.19.2-5.1.2.0" = _EOOHEkth;
        "pkg-1.19.2-5.1.2.1" = _vMbFvqVI;
        "pkg-1.19.3-5.1.3.1" = _T123DHPM;
        "pkg-1.19.2-5.1.2.2" = _N0zclyEx;
        "pkg-1.18.2-5.0.8.0" = _WhjxWZUb;
        "pkg-1.19.3-5.1.4.0" = _9eeEgj08;
        "pkg-1.19.2-5.1.3.0" = _FK7tyAY3;
        "pkg-1.18.2-5.0.9.0" = _M9lGrwqm;
        "pkg-1.16.5-4.1.0.0" = _5qPuCFYD;
        "pkg-1.19.3-5.1.4.1" = _zkj9iD0D;
        "pkg-1.19.4-5.1.4.2" = _46cAcdnU;
        "pkg-1.19.4-5.1.4.3" = _tl7biScA;
        "pkg-1.19.2-5.1.4.0" = _cpywqo8V;
        "pkg-1.19.4-5.1.5.0" = _BenekUpa;
        "pkg-1.19.4-5.1.5.1" = _jVW2AKPB;
        "pkg-1.19.4-5.1.5.2" = _hTLLayrx;
        "pkg-1.19.2-5.1.4.1" = _uvQEq1xO;
        "pkg-1.19.4-5.1.5.3" = _hW3XKfcj;
        "pkg-5.2.0-beta.1+1.20" = _p4wqBrgO;
        "pkg-5.2.0-beta.2+1.20" = _h3K3CopK;
        "pkg-5.2.0-beta.3+1.20.1" = _SeLn387u;
        "pkg-1.18.2-5.0.9.1" = _dlv1r8No;
        "pkg-5.2.0+1.20.1" = _GbHsY4Wa;
        "pkg-5.3.0+1.20.1" = _9yUPTnRR;
        "pkg-5.3.1+1.20.1" = _q9hLiOWr;
        "pkg-5.3.2+1.20.1" = _mZaeXk5V;
        "pkg-5.3.3+1.20.1" = _CQtJcas9;
        "pkg-5.3.4+1.20.1" = _Kw26k0tE;
        "pkg-6.0.0+1.20.2" = _XdwwXlEI;
        "pkg-5.3.5+1.20.1" = _HgHicKvP;
        "pkg-6.0.1+1.20.2" = _l0t6GlWP;
        "pkg-5.4.0+1.20.1" = _opCpnbhi;
        "pkg-6.0.2+1.20.2" = _8zBiV8Xc;
        "pkg-5.4.1+1.20.1" = _SdxNj4Fa;
        "pkg-1.19.2-5.1.4.2" = _BKMikxx0;
        "pkg-1.19.4-5.1.5.4" = _NI17MAnS;
        "pkg-5.4.2+1.20.1" = _nEba8UUT;
        "pkg-1.19.2-5.1.4.3" = _9fDBKv2o;
        "pkg-5.4.3+1.20.1" = _wOH4YWOv;
        "pkg-5.4.4+1.20.1" = _y3sKrQEo;
        "pkg-5.4.5+1.20.1" = _RmUMdDtP;
        "pkg-6.1.0+1.20.2" = _usPjZolF;
        "pkg-7.0.0-beta+1.20.3" = _VykFFfeC;
        "pkg-7.0.0-beta.2+1.20.4" = _69B5WqQH;
        "pkg-7.0.0-beta.3+1.20.4" = _aKokCTY6;
        "pkg-5.4.6+1.20.1" = _nSNsIPLm;
        "pkg-1.18.2-5.0.9.2" = _sVuCrC2E;
        "pkg-1.19.2-5.1.4.4" = _DtYuKcQY;
        "pkg-5.4.7+1.20.1" = _3VUlU5Ga;
        "pkg-5.5.0+1.20.1" = _rAPky5mo;
        "pkg-1.19.2-5.1.5.0" = _iy9E6HF4;
        "pkg-7.1.0+1.20.4" = _MjnZWw5h;
        "pkg-1.19.2-5.1.6.0" = _fPjcw2f6;
        "pkg-5.6.0+1.20.1" = _anCi5HAr;
        "pkg-1.19.2-5.1.6.1" = _U8r7nIbi;
        "pkg-5.6.1+1.20.1" = _9hjtlBBI;
        "pkg-7.2.0+1.20.4" = _nxZSj82i;
        "pkg-5.7.0+1.20.1" = _PeTgKttm;
        "pkg-7.3.0+1.20.4" = _LgpxZ1yG;
        "pkg-7.3.1+1.20.4" = _1aZiIHQO;
        "pkg-7.3.2+1.20.4" = _nRQ4FbAf;
        "pkg-5.7.1+1.20.1" = _UfNitWgy;
        "pkg-7.3.3+1.20.4" = _1C6lBZmu;
        "pkg-5.7.2+1.20.1" = _L0Tw2xgL;
        "pkg-7.3.4+1.20.4" = _9ro67WYY;
        "pkg-7.4.0-beta+1.20.4" = _TOk3Lved;
        "pkg-5.8.0-beta+1.20.1" = _WHmuOhGH;
        "pkg-7.4.0-beta.2+1.20.4" = _DmFR6XO3;
        "pkg-5.8.0-beta.2+1.20.1" = _nJQvdzJp;
        "pkg-5.8.0+1.20.1" = _YGa5gGxr;
        "pkg-5.8.1+1.20.1" = _6EgL0aP4;
        "pkg-5.9.0+1.20.1" = _7UxKaIU0;
        "pkg-7.4.0+1.20.4" = _wlGMHF77;
        "pkg-1.19.2-5.1.6.2" = _29pH8hdz;
        "pkg-8.0.0-beta+1.20.6" = _BiiqnvUy;
        "pkg-7.4.1+1.20.4" = _suXbeF6v;
        "pkg-8.0.0-beta.2+1.20.6" = _tF9CH5Oa;
        "pkg-7.4.2+1.20.4" = _78rIk4rg;
        "pkg-8.0.0-beta.3+1.20.6" = _d3pyf6MJ;
        "pkg-5.9.1+1.20.1" = _moWmAnjY;
        "pkg-8.0.0-beta.4+1.20.6" = _PEjKT9iG;
        "pkg-7.4.3+1.20.4" = _LlDgDtwS;
        "pkg-8.0.0-beta.5+1.20.6" = _g5BlLWVo;
        "pkg-8.0.0-beta.6+1.20.6" = _LP78nWgP;
        "pkg-8.0.0+1.20.6" = _uV8dKuBO;
        "pkg-8.0.1+1.20.6" = _iLBQZb4J;
        "pkg-1.19.2-5.1.6.3" = _S9Xq7LzJ;
        "pkg-5.10.0+1.20.1" = _8HlBRHsc;
        "pkg-8.0.2+1.20.6" = _YbataWB7;
        "pkg-8.1.0+1.20.6" = _Ru79duQs;
        "pkg-5.11.0+1.20.1" = _QBtodtmR;
        "pkg-1.19.2-5.1.6.4" = _uUAY30IE;
        "pkg-5.11.1+1.20.1" = _6NzPdjtb;
        "pkg-9.2.0+1.21.1" = _DWBpfpw1;
        "pkg-9.2.2+1.21.1" = _yfxrEL4z;
        "pkg-5.12.0+1.20.1" = _Ck06wnhs;
        "pkg-5.12.1+1.20.1" = _aFw6K2Jy;
        "pkg-9.2.3+1.21.1" = _c8YhNFSr;
        "pkg-9.3.0+1.21.1" = _7zHR2MbT;
        "pkg-9.3.1+1.21.1" = _BOIl0oEz;
        "pkg-9.4.0+1.21.1" = _aOzmr3vR;
        "pkg-9.4.1+1.21.1" = _2l5i8Qm7;
        "pkg-5.13.0+1.20.1" = _oxt4Evn7;
        "pkg-9.4.2+1.21.1" = _6PllU1Iq;
        "pkg-5.14.0+1.20.1" = _r8awEXjr;
        "pkg-5.14.1+1.20.1" = _IPQlZkz1;
        "pkg-9.5.0+1.21.1" = _Z3EsTkg0;
        "pkg-9.5.1+1.21.1" = _yohfFbgD;
        "pkg-10.0.0+1.21.4" = _NmMW8YAv;
        "pkg-11.0.0+1.21.5" = _v3j2e3VB;
        "pkg-11.0.1+1.21.5" = _ecox6vKI;
        "pkg-10.0.1+1.21.4" = _jtt92CXj;
        "pkg-12.0.0+1.21.8" = _UW476H0a;
        "pkg-13.0.0+1.21.10" = _jWUxU4dD;
        "pkg-14.0.0+1.21.11" = _MPGhs9Rw;
        "pkg-15.0.0-beta.1+26.1" = _YRKJX6vt;
