...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.2.4-forge" = _QNoLqlpJ;
        "pkg-1.19.2-2.0.0-fabric" = _8uivKeQV;
        "pkg-1.19.2-1.2.5-forge" = _MV7SQc07;
        "pkg-1.19.4-2.1.0-fabric" = _hmCKUO5l;
        "pkg-1.19.4-1.3.0-forge" = _qu4IxSdt;
        "pkg-1.20.1-2.1.0-fabric" = _W9lwYk5g;
        "pkg-1.20.1-1.3.0-forge" = _IsK6Fio9;
        "pkg-1.20.2-2.1.0-fabric" = _jniw6LeH;
        "pkg-1.20.2-1.3.0-forge" = _9dhnQqEv;
        "pkg-1.20.3-2.1.0-fabric" = _2QIwouCO;
        "pkg-1.20.3-1.3.0-forge" = _8NFRD9QP;
        "pkg-1.20.4-2.1.0-fabric" = _LWDAcvwk;
        "pkg-1.20.4-1.3.0-forge" = _CPOHvpD3;
        "pkg-1.20.4-3.0.0-neoforge" = _9q7sIX5a;
        "pkg-1.20.6-3.0.0-neoforge" = _LKqGPiuw;
        "pkg-1.20.6-2.1.0-fabric" = _CZQgrLma;
        "pkg-1.20.6-1.3.0-forge" = _YB38BzQL;
        "pkg-1.21-3.0.1-neoforge" = _XxYelDNf;
        "pkg-1.21-2.1.1-fabric" = _m6ndJAcO;
        "pkg-1.21-1.3.1-forge" = _tNCHx6lR;
        "pkg-1.21.3-1.3.1-forge" = _RG07ON8Q;
        "pkg-1.21.3-2.1.1-fabric" = _dMK6pOuh;
        "pkg-1.21.3-3.0.1-neoforge" = _8U5hBGc7;
        "pkg-1.21.4-1.3.1-forge" = _D9nDSFiQ;
        "pkg-1.21.4-2.1.1-fabric" = _h4aknqvl;
        "pkg-1.21.4-3.0.1-neoforge" = _m2KbFdq8;
        "pkg-1.21.5-1.3.1-forge" = _MOwrVW6J;
        "pkg-1.21.5-2.1.1-fabric" = _1lw2vMqQ;
        "pkg-1.21.5-3.0.1-neoforge" = _KbPYA7WV;
        "pkg-1.21.6-2.1.1-fabric" = _uEQHRqkB;
        "pkg-1.21.6-3.0.1-neoforge" = _wH1N3pCX;
        "pkg-1.21.7-2.1.1-fabric" = _3vRnL0sY;
        "pkg-1.21.7-3.0.1-neoforge" = _ipfheBKL;
        "pkg-1.21.8-2.1.1-fabric" = _WMRaijDQ;
        "pkg-1.21.8-3.0.1-neoforge" = _lWJYLfrJ;
        "pkg-1.21.10-2.1.1-fabric" = _BiN5MOFB;
        "pkg-1.21.10-3.0.1-neoforge" = _4nnmnzZi;
        "pkg-1.21.11-2.1.1-fabric" = _4IubzWJ2;
        "pkg-1.21.11-3.0.1-neoforge" = _tVzJiwNn;
        "pkg-26.1-2.2.0-fabric" = _TpU4GWvJ;
