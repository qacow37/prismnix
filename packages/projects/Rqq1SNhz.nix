...
let
    ...
    in {
        ...
        "pkg-1.3.3" = _H7jiWhSw;
        "pkg-1.4.0" = _XGOiKqrd;
        "pkg-1.4.0+1.20.2" = _lU4n0xyS;
        "pkg-1.4.1-old" = _EenYzmRz;
        "pkg-1.0.0" = _yYxtmEzL;
        "pkg-1.1.0" = _Q0977f5O;
        "pkg-1.2.0" = _Rk2QWwWg;
        "pkg-1.2.1" = _zTA5ZqbR;
        ...
        "pkg-1.4.4" = _XSoS27RS;
        "pkg-1.4.5" = _Peugy9W0;
        "pkg-1.4.6-alpha.1" = _rPZfV97s;
        "pkg-1.4.6-alpha.2" = _iG6wmf9O;
        "pkg-1.4.6-alpha.3" = _o8X44j1g;
        "pkg-1.4.6-alpha.4" = _XeiBO6gp;
        "pkg-1.4.6-alpha.5" = _2qGK3OVH;
        "default" = _2qGK3OVH;
    });
