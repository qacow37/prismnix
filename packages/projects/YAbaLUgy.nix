...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _B55EUXi2;
        "pkg-1.0.0-1.20" = _C8RDec49;
        "pkg-1.0.0-1.20.2" = _G9exPVyL;
        "pkg-2.0.0-1.18" = _2FCmiNnI;
        "pkg-2.0.0-1.18.1" = _5pjFgQY7;
        "pkg-2.0.0-1.18.2" = _INSusHrc;
        "pkg-2.0.0-1.19" = _BChxuv8u;
        "pkg-2.0.0-1.19.1" = _b4rF365n;
        "pkg-2.0.0-1.19.2" = _WHFdvqWB;
        "pkg-2.0.0-1.19.3" = _codaWCU6;
        "pkg-2.0.0-1.19.4" = _8eAS168Z;
        "pkg-2.0.0-1.20" = _GUkiuGnm;
        "pkg-2.0.0-1.20.1" = _CucsR2zg;
        "pkg-2.0.0-1.20.2" = _VqwHMCYa;
        "pkg-2.0.0-1.20.3" = _jDRQUneZ;
        "pkg-2.0.0-1.20.4" = _2LpNNr3Q;
        "pkg-1.0.1-1.20.6" = _Caljt1Wr;
        "pkg-2.0.0-1.21" = _QXJXvv9A;
        "pkg-2.0.0-1.21.1" = _PjH7eebl;
        "pkg-2.0.0-1.21.2" = _RndOKRew;
        "pkg-2.0.0-1.21.3" = _AEboqBU8;
        "pkg-2.0.0-1.21.4" = _zs9ToTiz;
        "pkg-3.0.0-1.20.1" = _kLFTE1hj;
        "pkg-3.0.0-1.20.4" = _txMvwgLb;
        "pkg-3.0.0-1.20.6" = _RK0G9oSB;
        "pkg-3.0.0-1.21.1" = _zKxo2XJz;
        "pkg-3.0.0-1.21.5" = _vtgCzhAh;
        "pkg-3.0.0-1.21.6" = _lIEHeO4K;
        "pkg-3.0.0-1.21.7" = _Jw5X7Uuo;
        "pkg-3.0.0-1.21.8" = _C9AWq9ZT;
        "default" = _C9AWq9ZT;
    });
