...
let
    ...
    in {
        ...
        "pkg-1.18.1-1.2" = _vTvvzlLV;
        "pkg-1.17.1-1.2" = _k9lhFJya;
        "pkg-1.16.5-1.2" = _R1aibjR8;
        "pkg-1.19-1.2" = _ZopPxOrc;
        "pkg-1.17.1-1.3-Fabric" = _Wpl3DJDm;
        "pkg-1.17.1-1.3-Forge" = _PF17eYk8;
        "pkg-1.18.2-1.3-Fabric" = _pklQRL8R;
        "pkg-1.18.2-1.3-Forge" = _XRTlFqRt;
        "pkg-1.19.3-1.3-Fabric" = _UFuhKM8x;
        "pkg-1.19.3-1.3-Forge" = _twxZxuVh;
        "pkg-1.16.5-1.3-Fabric" = _1nXnHKuP;
        "pkg-1.16.5-1.3-Forge" = _XNlsqhg6;
        "pkg-1.19.4-1.3-Fabric" = _PYXJDI1l;
        "pkg-1.19.4-1.3-Forge" = _9GbdzNEO;
        "pkg-1.20.1-1.3-Fabric" = _McFUnEHI;
        "pkg-1.20.1-1.3-Forge" = _jbcJGMqh;
        "pkg-1.20.4-1.3-Fabric" = _mMVkIIIh;
        "pkg-1.20.4-1.3-Neoforge" = _Lbsk6UXz;
        "pkg-1.20.4-1.3-Forge" = _93gpyoAU;
        "pkg-1.15.2-1.4-Forge" = _hKzzlDd6;
        "pkg-1.15.2-1.4.1-Forge" = _cdQVrNLE;
        "pkg-1.16.5-1.4.1-Fabric" = _KJ4Il8eg;
        "pkg-1.16.5-1.4.1-Forge" = _syRbcIhm;
        "pkg-1.17.1-1.4.1-Fabric" = _kEzqnSw2;
        "pkg-1.17.1-1.4.1-Forge" = _3Ha9aZqV;
        "pkg-1.18.2-1.4.1-Fabric" = _1h68PJNK;
        "pkg-1.18.2-1.4.1-Forge" = _F4z0Hn1a;
        "pkg-1.19.4-1.4.1-Fabric" = _fxgxKpQP;
        "pkg-1.19.4-1.4.1-Forge" = _6UYA3811;
        "pkg-1.20.1-1.4.1-Fabric" = _sC4O9oam;
        "pkg-1.20.1-1.4.1-Forge" = _kWNEg2BJ;
        "pkg-1.20.4-1.4.1-NeoForge" = _IOruSzpm;
        "pkg-1.20.4-1.4.1-Fabric" = _fpYRQuls;
        "pkg-1.20.4-1.4.1-Forge" = _Wld9RAjs;
        "pkg-1.20.6-1.4.1-NeoForge" = _smbzPLgB;
        "pkg-1.20.6-1.4.1-Fabric" = _K2geN7Av;
        "pkg-1.20.6-1.4.1-Forge" = _6Ym0HL20;
        "pkg-1.21-1.4.1-NeoForge" = _jTD9zFuh;
        "pkg-1.21-1.4.1-Fabric" = _PvmBWWMt;
        "pkg-1.21-1.4.1-Forge" = _dHvqLX9w;
        "pkg-1.21.1-1.4.1-NeoForge" = _UZKgfQc6;
        "pkg-1.21.1-1.4.1-Fabric" = _B6KibeIX;
        "pkg-1.21.1-1.4.1-Forge" = _NelcJULj;
        "pkg-1.21.3-1.4.1-NeoForge" = _urFouxSZ;
        "pkg-1.21.3-1.4.1-Fabric" = _Cvwoz4AS;
        "pkg-1.21.3-1.4.1-Forge" = _htM91a4h;
        "pkg-1.21.4-1.4.2-NeoForge" = _JvfOtm7S;
        "pkg-1.21.4-1.4.2-Fabric" = _JgavRUqB;
        "pkg-1.21.4-1.4.2-Forge" = _hzWvPk9I;
        "pkg-1.21.5-1.4.2-NeoForge" = _VNqWBbxm;
        "pkg-1.21.5-1.4.2-Fabric" = _O4bIKJRD;
        "pkg-1.21.5-1.4.2-Forge" = _ao5gXON4;
        "pkg-1.21.8-1.4.2-NeoForge" = _5p8hfPXa;
        "pkg-1.21.8-1.4.2-Fabric" = _WK5wg4eA;
        "pkg-1.21.8-1.4.2-Forge" = _hZia4Yas;
        "pkg-1.21.10-1.4.2-NeoForge" = _5ahSrIve;
        "pkg-1.21.10-1.4.2-Fabric" = _WMDNH5Mo;
        "pkg-1.21.10-1.4.2-Forge" = _x98Bh6VP;
        "default" = _x98Bh6VP;
    });
