...
let
    ...
    in {
        ...
        "pkg-1.7.10" = _atwtQ416;
        "pkg-1.8" = _ogS4Zvgg;
        "pkg-1.1.0.8" = _VteFOg8T;
        "pkg-1.1.0.9" = _fB0Va9pR;
        "pkg-1.1.0.11" = _ZeZxTQjQ;
        "pkg-1.1.0.10" = _JKPsDMV8;
        "pkg-1.1.0.12" = _fARZ3myp;
        "pkg-1.1.0.13" = _H3wlXjix;
        "pkg-1.1.0.15" = _rxM2FRGe;
        "pkg-1.2.0.16" = _CIy7G5wn;
        "pkg-1.2.0.17" = _csOGItjA;
        "pkg-1.2.0.18" = _AHaQhmcv;
        "pkg-1.0.19" = _BzvxiW0J;
        "pkg-1.0.20" = _UBCO2dVU;
        "pkg-1.0.21" = _LuqqiJ1y;
        "pkg-1.0.22" = _JJCeGBxo;
        "pkg-1.0.23" = _MNBO3uYz;
        "pkg-1.0.24" = _rCCaUSnS;
        "pkg-1.0.25" = _zGCSBf80;
        "pkg-1.1.26" = _Ir9lgIAv;
        "pkg-1.1.27" = _vbrxELnV;
        "pkg-1.1.28" = _X2KwDwWf;
        "pkg-1.1.31" = _wrkjxSPh;
        "pkg-1.1.32" = _QrogzVpy;
        "pkg-1.1.36" = _Fu7POkeC;
        "pkg-1.1.38" = _VRrWvR7q;
        "pkg-2.0.6" = _6ZaczZfV;
        "pkg-2.0.7" = _iWu94wuE;
        "pkg-2.0.8" = _nVPYFYw0;
        "pkg-2.0.9" = _wi2MZRyI;
        "pkg-2.0.11" = _l2go1Xp6;
        "pkg-2.0.12" = _5skqYMVq;
        "pkg-2.0.13" = _BVFLTQB3;
        "pkg-2.0.14" = _r7Y9UUth;
        "pkg-2.0.16" = _RynPKLgl;
        "pkg-2.0.19" = _bzRpk9My;
        "pkg-3.0.1" = _6OYFvYaD;
        "pkg-1.1.39" = _E0cU6jlt;
        "pkg-1.1.40" = _c4u2CMoo;
        "pkg-5.0.2" = _PWFKVcVR;
        "pkg-6.0.1" = _RvqJHFt3;
        "pkg-6.0.2" = _2rOUNZpz;
        "pkg-7.0.1" = _srzMmrKp;
        ...
        "pkg-13.01" = _acUHEpWP;
        "pkg-14.01" = _Dn0Lt73s;
        "pkg-14.0.2" = _cbeKWkgM;
        "pkg-9.1.8" = _4cbiZN49;
        "pkg-9.1.9" = _SuM7sas2;
        "pkg-14.0.3" = _ImkhJyR2;
        "pkg-14.1.4" = _hYUOdHjq;
        "pkg-15.0.1" = _XEEgPGjY;
        "pkg-16.0.1" = _7G0OjEAL;
        "pkg-16.1.2" = _gBB9ulvp;
        "pkg-16.1.3" = _QgXMG9ZH;
        "pkg-18.0.1" = _QN3OvNP9;
        "pkg-11.0.1" = _AZkPSRCf;
        "pkg-12.0.1" = _gqSI3yvL;
        "pkg-21.1.1" = _dXIUORLX;
        "default" = _dXIUORLX;
    });
