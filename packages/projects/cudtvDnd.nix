...
let
    ...
    in {
        ...
        "pkg-7.0.7-fo1.13.2" = _zKdil3yS;
        "pkg-7.0.7-fo1.14.4" = _YiezTGok;
        "pkg-7.0.7-fo1.15.2" = _1VdPHpvz;
        "pkg-7.0.7-fo1.16.5" = _cms3XKKh;
        "pkg-7.0.7-fa1.14.4" = _h9DPstqB;
        "pkg-7.0.7-fa1.15.2" = _UMymgsDN;
        "pkg-7.0.7-fa1.16.5" = _LMdK0Pog;
        "pkg-7.1.1-fo1.7.10" = _Uvj9QQKR;
        "pkg-7.1.1-fo1.8.9" = _qWvmI57Y;
        "pkg-7.1.1-fo1.12.2" = _qQvb4sJf;
        "pkg-7.1.1-fo1.13.2" = _XAiK1vH0;
        "pkg-7.1.1-fo1.14.4" = _4kTkDbpR;
        "pkg-7.1.1-fo1.15.2" = _N0fDfKtd;
        "pkg-7.1.1-fo1.16.5" = _Tg3xP5mj;
        "pkg-7.1.1-fo1.17.1" = _QVGbWKdG;
        "pkg-7.1.1-fa1.14.4" = _KKrUWPr9;
        "pkg-7.1.1-fa1.15.2" = _sKetwDfe;
        "pkg-7.1.1-fa1.16.5" = _zjtTgEZu;
        "pkg-7.1.1-fa1.17.1" = _zQv2rjWG;
        "pkg-7.1.2-fo1.8.9" = _uI9n4nDb;
        "pkg-7.1.2-fo1.12.2" = _ZR3n7ejW;
        "pkg-7.1.2-fo1.14.4" = _mHOlMy8d;
        "pkg-7.1.2-fo1.15.2" = _Nqgm8P9i;
        "pkg-7.1.2-fo1.16.5" = _T9qEiazE;
        "pkg-7.1.2-fo1.17.1" = _Xga5l7r9;
        "pkg-7.1.2-fa1.14.4" = _XlRlOpX7;
        "pkg-7.1.2-fa1.15.2" = _mmiZyqZh;
        "pkg-7.1.2-fa1.16.5" = _DoZW6Bj6;
        "pkg-7.1.2-fa1.17.1" = _msCERWKo;
        "pkg-7.1.3-fo1.8.9" = _PQE1EUAX;
        "pkg-7.1.3-fo1.12.2" = _pNS7XUUG;
        "pkg-7.1.3-fo1.14.4" = _prEiieGu;
        "pkg-7.1.3-fo1.15.2" = _WEIcaEQL;
        "pkg-7.1.3-fo1.16.5" = _VnyxeExv;
        "pkg-7.1.3-fo1.17.1" = _2fkyLXwi;
        "pkg-7.1.3-fa1.14.4" = _4JF49lqX;
        "pkg-7.1.3-fa1.15.2" = _faX1a26g;
        "pkg-7.1.3.-fa1.16.5" = _40jfr6Li;
        "pkg-7.1.3-fa1.17.1" = _wIfvXioV;
        "pkg-7.1.3.1-fo1.12.2" = _oUCatzSF;
        "pkg-7.1.3-fa1.18" = _9ack9d79;
        "pkg-7.1.3-fo1.18.1" = _waJRjcFX;
        "pkg-7.1.3.1-fo1.8.9" = _y15owUB1;
        "pkg-7.2.0-fo1.14.4" = _sC33UiCL;
        "pkg-7.2.0-fo1.15.2" = _XNJstYZa;
        "pkg-7.2.0-fo1.16.5" = _PE83YLV5;
        "pkg-7.2.0-fo1.17.1" = _9ZoxKTpC;
        "pkg-7.2.0-fo1.18.2" = _HuVAEZop;
        "pkg-7.2.0-fo1.19" = _vXa66z9Z;
        "pkg-7.2.0-fa1.14.4" = _5GphQOEZ;
        "pkg-7.2.0-fa1.15.2" = _7gtukLbD;
        "pkg-7.2.0-fa1.16.5" = _w3j7vgi3;
        "pkg-7.2.0-fa1.17.1" = _hBIaQGvU;
        "pkg-7.2.0-fa1.18.2" = _QlAbSbMb;
        "pkg-7.2.0-fa1.19" = _qlROlHx1;
        "pkg-8.0.0-fo1.7" = _xyeurGi4;
        "pkg-8.0.0-fo1.8" = _QlONjSte;
        "pkg-8.0.0-fo1.12" = _Mfi93Vas;
        "pkg-8.0.0-fo1.14" = _834Ryb91;
        "pkg-8.0.0-fo1.15" = _vlb3QVSx;
        "pkg-8.0.0-fo1.16" = _f9LP9iK1;
        "pkg-8.0.0-fo1.17" = _7WSnRGqT;
        "pkg-8.0.0-fo1.18" = _j6BJWy3Y;
        "pkg-8.0.0-fo1.19" = _2lVlNYo0;
        "pkg-8.0.0-fa1.14" = _SRbJdDLc;
        "pkg-8.0.0-fa1.15" = _QNTuCSVT;
        "pkg-8.0.0-fa1.16" = _bWLVCWle;
        "pkg-8.0.0-fa1.17" = _6MdXoP9K;
        "pkg-8.0.0-fa1.18" = _LHqtJmq9;
        "pkg-8.0.0-fa1.19" = _icAY3LzM;
        "pkg-8.0.1-forge1.7" = _IEcVEZWR;
        "pkg-8.0.1-forge1.8" = _fytQEqFH;
        "pkg-8.0.1-forge1.12" = _1wXRJWXV;
        "pkg-8.0.1-forge1.14" = _IYvaCx2d;
        "pkg-8.0.1-forge1.15" = _Tsgsrtt5;
        "pkg-8.0.1-forge1.16" = _ieat1cvJ;
        "pkg-8.0.1-forge1.17" = _Bh8UElbF;
        "pkg-8.0.1-forge1.18" = _r7WtVbAD;
        "pkg-8.0.1-forge1.19" = _h4gDIlZf;
        "pkg-8.0.1-fabric1.14" = _MidF4yKS;
        "pkg-8.0.1-fabric1.15" = _XcxlpKMU;
        "pkg-8.0.1-fabric1.16" = _9FC4X1sc;
        "pkg-8.0.1-fabric1.17" = _AnE32y9G;
        "pkg-8.0.1-fabric1.18" = _W7qr1Gxp;
        "pkg-8.0.1-fabric1.19" = _Gfoy4CTP;
        "pkg-8.0.1.1-forge1.19" = _sCaGP8Dv;
        "pkg-8.0.1.1-fabric1.19" = _rEirnYuQ;
        "pkg-8.0.1.2-fabric1.19" = _OQZPp5Se;
        "pkg-8.0.1.2-forge1.19" = _fQoCff5v;
        "pkg-8.0.2-forge1.18" = _4HLfU2Ys;
        "pkg-8.0.2-forge1.19" = _fjHj64hK;
        "pkg-8.0.2-forge1.20" = _fSrtJsXN;
        "pkg-8.0.2-fabric1.18" = _UfteI7Ln;
        "pkg-8.0.2-fabric1.19" = _3khGbSG3;
        "pkg-8.0.2-fabric1.20" = _cfngDlue;
        "pkg-8.0.2-fabric1.20.2" = _3n8w27Oj;
        "pkg-8.0.2-fabric1.20.4" = _tvfSHYuI;
        "pkg-9.0.0-alpha.1" = _9EO5MGn6;
        "pkg-9.0.0-beta.1" = _14eMztsH;
        "pkg-9.0.0-beta.4" = _OjaPW8q2;
        "pkg-9.0.0-beta.5" = _1rIb5AwL;
        "pkg-9.0.0" = _KbdPbnwP;
        "pkg-9.0.1" = _q76a8nJX;
        "pkg-9.0.2-alpha.1" = _f0eRgN9C;
        "pkg-9.0.2" = _ldQRqpLN;
        "pkg-9.0.3" = _ey8TsH0m;
        "pkg-9.0.4" = _bxPb5zqK;
        "pkg-9.0.5" = _eQRA4vob;
        "pkg-9.0.6-alpha.1+1.21.10-fabric" = _LgfVj4KS;
        "pkg-9.0.6-alpha.1+1.21.10-forge" = _tNyZdqcz;
        "pkg-9.0.6-alpha.1+1.21.10-neoforge" = _Hxcr4q1n;
        "pkg-9.0.6-alpha.2+1.21.11-fabric" = _oSzaukGT;
        "pkg-9.0.6-alpha.2+1.21.11-forge" = _OZHVbURZ;
        "pkg-9.0.6+1.18.2-fabric" = _3Z8lzWSg;
        "pkg-9.0.6+1.18.2-forge" = _BZXyMVm3;
        "pkg-9.0.6+1.19.2-fabric" = _TYNLykKQ;
        "pkg-9.0.6+1.19.2-forge" = _30boX8Ze;
        "pkg-9.0.6+1.19.4-fabric" = _C7ZjmN9C;
        "pkg-9.0.6+1.19.4-forge" = _IoVwRozF;
        "pkg-9.0.6+1.20.1-fabric" = _D8kwlD58;
        "pkg-9.0.6+1.20.1-forge" = _UzhOItBS;
        "pkg-9.0.6+1.20.1-neoforge" = _pDpdnA1G;
        "pkg-9.0.6+1.20.2-fabric" = _xLq5h36b;
        "pkg-9.0.6+1.20.2-forge" = _BF38F6Pg;
        "pkg-9.0.6+1.20.2-neoforge" = _aoIvuGnq;
        "pkg-9.0.6+1.20.4-fabric" = _zvG6bGJn;
        "pkg-9.0.6+1.20.4-forge" = _WKmFsWwa;
        "pkg-9.0.6+1.20.4-neoforge" = _k8gs9sdv;
        "pkg-9.0.6+1.20.6-fabric" = _vZ2IOSDc;
        "pkg-9.0.6+1.20.6-forge" = _xLbJWgop;
        "pkg-9.0.6+1.20.6-neoforge" = _tZJHkFVT;
        "pkg-9.0.6+1.21.1-fabric" = _ZuV4kGzO;
        "pkg-9.0.6+1.21.1-forge" = _2QRc0a7k;
        "pkg-9.0.6+1.21.1-neoforge" = _YsOMUSD4;
        "pkg-9.0.6+1.21.3-fabric" = _ZqMsHjkG;
        "pkg-9.0.6+1.21.3-forge" = _jmHjVUKd;
        "pkg-9.0.6+1.21.3-neoforge" = _93JJrIsD;
        "pkg-9.0.6+1.21.4-fabric" = _c6vr5evd;
        "pkg-9.0.6+1.21.4-forge" = _bBQLIeGH;
        "pkg-9.0.6+1.21.4-neoforge" = _mv5vuXzE;
        "pkg-9.0.6+1.21.5-fabric" = _TLXcVxC8;
        "pkg-9.0.6+1.21.5-forge" = _Ic5qHNtg;
        "pkg-9.0.6+1.21.5-neoforge" = _tu4QBgwG;
        "pkg-9.0.6+1.21.8-fabric" = _OqjOUdNs;
        "pkg-9.0.6+1.21.8-forge" = _YBbr6F2p;
        "pkg-9.0.6+1.21.8-neoforge" = _JyiVt7hf;
        "pkg-9.0.6+1.21.10-fabric" = _fgPKk2RF;
        "pkg-9.0.6+1.21.10-forge" = _VoBQLE8e;
        "pkg-9.0.6+1.21.10-neoforge" = _kADNUotF;
        "pkg-9.0.6+1.21.11-fabric" = _YUbSyjUy;
        "pkg-9.0.6+1.21.11-forge" = _Y8JFi53j;
        "pkg-9.0.6+1.21.11-neoforge" = _HBPVhrgR;
        "pkg-9.0.6+26.1.2-fabric" = _2ea1OpDg;
        "pkg-9.0.6+26.1.2-forge" = _qmHscayx;
        "pkg-9.0.6+26.1.2-neoforge" = _Rfr3IBwz;
        "pkg-9.0.7+1.18.2-fabric" = _LwctUz1W;
        "pkg-9.0.7+1.18.2-forge" = _YtH8n6Js;
        "pkg-9.0.7+1.19.2-fabric" = _x6sUVQQh;
        "pkg-9.0.7+1.19.2-forge" = _gYl2GUIa;
        "pkg-9.0.7+1.19.4-fabric" = _Ppk4VmpK;
        "pkg-9.0.7+1.19.4-forge" = _fkNSsdLg;
        "pkg-9.0.7+1.20.1-fabric" = _F5ljcaL7;
        "pkg-9.0.7+1.20.1-forge" = _bXH4pzVA;
        "pkg-9.0.7+1.20.1-neoforge" = _TfslyiMe;
        "pkg-9.0.7+1.20.2-fabric" = _AG1Xsz1a;
        "pkg-9.0.7+1.20.2-forge" = _cPFX0nzI;
        "pkg-9.0.7+1.20.2-neoforge" = _F0zSX65h;
        "pkg-9.0.7+1.20.4-fabric" = _FnHsuaDN;
        "pkg-9.0.7+1.20.4-forge" = _YuQcmE6S;
        "pkg-9.0.7+1.20.4-neoforge" = _7ZWDWwxi;
        "pkg-9.0.7+1.20.6-fabric" = _yqhlrNY9;
        "pkg-9.0.7+1.20.6-forge" = _RqwFCHEw;
        "pkg-9.0.7+1.20.6-neoforge" = _HLszQC6g;
        "pkg-9.0.7+1.21.1-fabric" = _UvDJxEv7;
        "pkg-9.0.7+1.21.1-forge" = _wDoft0xW;
        "pkg-9.0.7+1.21.1-neoforge" = _c1DGJNQM;
        "pkg-9.0.7+1.21.3-fabric" = _SBaEsGhZ;
        "pkg-9.0.7+1.21.3-forge" = _n9OSdEUi;
        "pkg-9.0.7+1.21.3-neoforge" = _vQ1FGbpk;
        "pkg-9.0.7+1.21.4-fabric" = _Ks4d60aS;
        "pkg-9.0.7+1.21.4-forge" = _KVkXzt9l;
        "pkg-9.0.7+1.21.4-neoforge" = _yUrCh532;
        "pkg-9.0.7+1.21.5-fabric" = _awdLZBZV;
        "pkg-9.0.7+1.21.5-forge" = _JSR4KLlb;
        "pkg-9.0.7+1.21.5-neoforge" = _9PjjPVRk;
        "pkg-9.0.7+1.21.8-fabric" = _VTaAw61i;
        "pkg-9.0.7+1.21.8-forge" = _66LVSSq0;
        "pkg-9.0.7+1.21.8-neoforge" = _Gq7UyMsS;
        "pkg-9.0.7+1.21.10-fabric" = _pz7XlpgO;
        "pkg-9.0.7+1.21.10-forge" = _GtutO61R;
        "pkg-9.0.7+1.21.10-neoforge" = _buyL2bx8;
        "pkg-9.0.7+1.21.11-fabric" = _U7tHV3dB;
        "pkg-9.0.7+1.21.11-forge" = _f0OYKRvg;
        "pkg-9.0.7+1.21.11-neoforge" = _A3AlMydI;
        "pkg-9.0.7+26.1.2-fabric" = _ve7VmwRr;
        "pkg-9.0.7+26.1.2-forge" = _3uIkaui0;
        "pkg-9.0.7+26.1.2-neoforge" = _Q8gwuR5I;
