...
let
    ...
    in {
        ...
        "pkg-1.0.45" = _FdzVLDky;
        "pkg-1.1.2" = _UJsiu2dC;
        "pkg-1.1.4" = _VoOBBJRg;
        "pkg-1.1.5" = _9bBGjbU5;
        "pkg-1.1.8" = _puRtyl3V;
        "pkg-1.1.10" = _nE38KiNU;
        "pkg-1.1.9.1" = _3lLfxs9z;
        "pkg-1.1.11" = _cqJP89n5;
        "pkg-1.1.12" = _sOqIWJ9P;
        "pkg-1.1.13" = _iP294YId;
        "pkg-1.1.14" = _Pp4dRoJ9;
        "pkg-1.1.15" = _D2tqnVgT;
        "pkg-1.1.16" = _ZU8xMA8r;
        "pkg-1.1.17" = _ByWltyMl;
        "pkg-1.1.18" = _ZioCfzuX;
        "pkg-1.1.19" = _PV85ACAe;
        "pkg-1.1.20" = _iIPGBAEi;
        "pkg-1.1.21" = _boNnPeth;
        "pkg-1.1.22" = _on8rI52b;
        "pkg-1.1.23" = _bzpNVY0n;
        "pkg-1.1.24" = _xs03Scvd;
        "pkg-1.2.0" = _O29o2aJ6;
        "pkg-1.2.1" = _xv4REAKm;
        "pkg-1.2.3" = _s6y2ff9n;
        "pkg-1.2.4" = _JZY5iUsi;
        ...
        "pkg-1.2.8" = _DiUhdzPp;
        "pkg-1.2.9" = _YxBxQV4C;
        "pkg-1.1.25" = _AiO84cp2;
        "pkg-1.2.10" = _qbVreZDf;
        "pkg-1.2.9.1" = _53nmXQA7;
        "pkg-1.2.9.2" = _8w9heVpo;
        "pkg-1.2.11" = _wSPWGm3N;
        "pkg-1.2.12" = _UQCiFFZM;
        "pkg-1.2.13" = _Hb4tQHRp;
        "pkg-1.3.0" = _ADoNC8jN;
        "pkg-1.3.1" = _gXkaAXxO;
        "pkg-1.3.2" = _ikFbuYBy;
        "pkg-1.4.0" = _LgipNgQG;
        "pkg-1.4.0.1" = _sDMtegeU;
        "pkg-1.4.1" = _bmgyGrjW;
