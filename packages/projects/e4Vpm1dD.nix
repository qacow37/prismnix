...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.19.2" = _iuCXB2hd;
        "pkg-1.0.0+mc1.19.3" = _iLc5YZrv;
        "pkg-1.0.1+mc1.19.4" = _HrM4LsgW;
        "pkg-1.0.2+mc1.19.2" = _GUtvRewn;
        "pkg-1.0.2+mc1.19.3" = _5LpFHehF;
        "pkg-1.0.2+mc1.19.4" = _A9dnfJCB;
        "pkg-1.1.0+mc1.19.2" = _rtKztrd3;
        "pkg-1.1.0+mc1.19.3" = _mOvqz3eP;
        "pkg-1.1.0+mc1.19.4" = _OEeXNrTd;
        "pkg-1.2.0+mc1.19.2" = _Mq3MXgVR;
        "pkg-1.2.0+mc1.19.3" = _WM51OThi;
        "pkg-1.2.0+mc1.19.4" = _WuqGnvbz;
        "pkg-1.2.1+mc1.19.2" = _BgHbrqAt;
        "pkg-1.2.1+mc1.19.3" = _kPULWL6W;
        "pkg-1.2.1+mc1.19.4" = _3KWUyMMR;
        "pkg-1.3.0+mc1.19.2" = _2mOQ1GsH;
        "pkg-1.3.0+mc1.19.3" = _Kk2JugdW;
        "pkg-1.3.0+mc1.19.4" = _6tPzVkTf;
        "pkg-1.3.1+mc1.19.2" = _QuLl2y6K;
        "pkg-1.3.1+mc1.19.3" = _2SGEbxLV;
        "pkg-1.3.1+mc1.19.4" = _MR5FWE1V;
        "pkg-1.4.0+mc1.19.2" = _4fZRXNzn;
        "pkg-1.4.0+mc1.19.3" = _GMqeptKJ;
        "pkg-1.4.0+mc1.19.4" = _VHCoKTst;
        "pkg-1.4.1+mc1.19.2" = _ngR02rLQ;
        "pkg-1.4.1+mc1.19.3" = _kr5asPTh;
        "pkg-1.4.1+mc1.19.4" = _S4svw5BU;
        "pkg-1.4.2+mc1.19.2" = _zVMOWlGs;
        "pkg-1.4.2+mc1.19.3" = _eYmHSBEJ;
        "pkg-1.4.2+mc1.19.4" = _12pRBvrK;
        "pkg-1.4.3+mc1.19-1.19.2" = _7fudSric;
        "pkg-1.4.3+mc1.19.3" = _Edm2ZRxt;
        "pkg-1.4.3+mc1.19.4" = _pc3Y01qT;
        "pkg-1.4.3+mc1.20-1.20.1" = _4c5D1XyG;
        "pkg-1.4.4+mc1.19-1.19.2" = _mQkOEl2I;
        "pkg-1.4.4+mc1.19.3" = _NjRoyguM;
        "pkg-1.4.4+mc1.19.4" = _VKhxHFRo;
        "pkg-1.4.4+mc1.20-1.20.1" = _iVGVsbWw;
        "pkg-1.4.5+mc1.19-1.19.2" = _xhHb9f30;
        "pkg-1.4.5+mc1.19.3" = _ieDIg3mz;
        "pkg-1.4.5+mc1.19.4" = _LT8gMnDn;
        "pkg-1.4.5+mc1.20-1.20.2" = _ndgUv7Mb;
        "pkg-1.4.6+mc1.20.3-1.20.4" = _sH5fSdPB;
        "pkg-1.4.7+mc1.19-1.19.2" = _Be6IURFY;
        "pkg-1.4.7+mc1.19.3" = _KroOc49w;
        "pkg-1.4.7+mc1.19.4" = _ab3QEojU;
        "pkg-1.4.7+mc1.20-1.20.1" = _fjuUyijE;
        "pkg-1.4.7+mc1.20.2" = _X4aCFDQD;
        "pkg-1.4.7+mc1.20.3-1.20.4" = _H3vVW9rp;
        "pkg-1.4.8+mc1.19-1.19.2" = _VPt86rzX;
        "pkg-1.4.8+mc1.19.3" = _eJgP6MQM;
        "pkg-1.4.8+mc1.19.4" = _erl8wzFZ;
        "pkg-1.4.8+mc1.20-1.20.1" = _wwMQbb4v;
        "pkg-1.4.8+mc1.20.2" = _WfG74Cqk;
        "pkg-1.4.8+mc1.20.3-1.20.4" = _6Prueaqs;
        "pkg-1.4.9+mc1.19-1.19.2" = _qi3D92f8;
        "pkg-1.4.9+mc1.19.3" = _V456VDnK;
        "pkg-1.4.9+mc1.19.4" = _71WODZbV;
        "pkg-1.4.9+mc1.20-1.20.1" = _HM0bBnrB;
        "pkg-1.4.9+mc1.20.2" = _KJos6LNu;
        "pkg-1.4.9+mc1.20.3-1.20.4" = _NnHrife9;
        "pkg-1.4.9.1+mc1.20-1.20.1" = _FkK0xTTO;
        "pkg-1.5.0+mc1.20.3" = _T09dVuf5;
        "pkg-1.5.0+mc1.20.4" = _BgCeZqU5;
        "default" = _BgCeZqU5;
    });
