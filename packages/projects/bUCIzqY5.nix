...
let
    ...
    in {
        ...
        "pkg-1.0.4+1.21.9-1.21.10" = _UP2vqjlM;
        "pkg-1.0.5+1.21.9-1.21.10" = _UlmCuq5E;
        "pkg-1.0.6+1.21.9-1.21.10" = _dv18C0E1;
        "pkg-1.0.7+1.21.9-1.21.10" = _f4o5TjXw;
        "pkg-1.0.7.1+1.21.9-1.21.10" = _9GHoSfyZ;
        "pkg-1.0.8+1.21.9-1.21.10" = _LW1YarzG;
        "pkg-1.0.9+1.21.9-1.21.10" = _PWZwCMVX;
        "pkg-1.0.10+1.21.9-1.21.10" = _KfJcumDz;
        "pkg-1.0.11+1.21.9-1.21.10" = _EaMnhsEO;
        "pkg-1.0.12+1.21.9-1.21.10" = _l6IMrqfB;
        "pkg-1.0.13+1.21.9-1.21.10" = _Q7XGhdS7;
        "pkg-1.0.14+1.21.9-1.21.10" = _NjuD78ht;
        "pkg-1.0.15+1.21.9-1.21.10" = _XP2BZLoW;
        "pkg-1.0.16+1.21.9-1.21.10" = _dH4UvaEg;
        "pkg-1.0.17+1.21.9-1.21.10" = _kU1Eskba;
        "pkg-1.0.18+1.21.9-1.21.10" = _tbhZdyj8;
        "pkg-1.0.19+1.21.9-1.21.10" = _j4KP3N9S;
        "pkg-1.0.20+1.21.9-1.21.10" = _U7DtWaLj;
        "pkg-1.0.21+1.21.9-1.21.10" = _AiUAGnfd;
        "pkg-1.0.22+1.21.9-1.21.10" = _yIylO54f;
        "pkg-1.0.23+1.21.9-1.21.10" = _GLqOP69R;
        "pkg-1.0.24+1.21.9-1.21.10" = _WIZlnvws;
        "pkg-1.0.25+1.21.9-1.21.10" = _63hN92Vc;
        "pkg-1.0.26+1.21.9-1.21.10" = _sy8ZTRm3;
        "pkg-1.0.27+1.21.9-1.21.10" = _pa4leg4y;
        "pkg-1.0.28+1.21.9-1.21.10" = _LWRas2pR;
        "pkg-1.0.29+1.21.9-1.21.10" = _TxgdJxAh;
        "pkg-1.0.30.0+1.21.9-1.21.10" = _c69EJQWN;
        "pkg-1.0.30.1+1.21.9-1.21.10" = _3IYr1avD;
        "pkg-1.0.30.2+1.21.9-1.21.10" = _wIng3ifi;
        "pkg-1.0.30.3+1.21.9-1.21.10" = _4Q0fOtcV;
