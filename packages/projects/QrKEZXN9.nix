...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _wukBRgzo;
        "pkg-1.3.1" = _wOKgxcQN;
        "pkg-2.0.0-1.21" = _GIj31j92;
        "pkg-2.0.0-1.21.2" = _K18EkHCV;
        "pkg-2.0.0-1.21.4" = _lPlZsqpM;
        "pkg-2.0.0-1.21.5" = _oONOHLCk;
        "pkg-2.0.0-1.21.6" = _OFVBLkAp;
        "pkg-2.0.0-1.21.9" = _MBI7UJFC;
        "pkg-2.1.0-1.21" = _NNkGzMks;
        "pkg-2.1.0-1.21.2" = _3eId0VL4;
        "pkg-2.1.0-1.21.4" = _ZZOvScaJ;
        "pkg-2.1.0-1.21.5" = _eRG3gY0U;
        "pkg-2.1.0-1.21.6" = _P8AgEAJi;
        "pkg-2.1.0-1.21.9" = _IMrV6fLb;
        "pkg-2.1.0-1.21.11" = _hh4BRUmO;
        "pkg-2.1.0+26.1" = _tvnUxtnF;
        "pkg-2.1.2-26.1" = _d1MTPsAC;
        "pkg-2.1.3-26.1" = _DgaOCbpw;
        "pkg-2.1.4-26.1" = _pls7n2kq;
        "pkg-2.1.4-26.2" = _jTmDvZTS;
        "default" = _jTmDvZTS;
    });
