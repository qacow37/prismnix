...
let
    ...
    in {
        ...
        "pkg-1.8.1" = _5njhNHNC;
        "pkg-1.9.0" = _3rGbH9xO;
        "pkg-1.10.0" = _OdNHB7Bh;
        "pkg-1.11.0" = _9GbfwGMo;
        "pkg-1.11.1" = _yyZzxW20;
        "pkg-1.11.2" = _FoH4jAej;
        "pkg-1.11.3" = _ggjlmxDp;
        "pkg-1.12.0" = _2E2jNIrg;
        "pkg-1.12.1" = _Yz1kSKZr;
        "pkg-1.12.2" = _oospKtTH;
        "pkg-1.12.3" = _rx79pal8;
        "pkg-1.12.4" = _XG3lRWVZ;
        "pkg-1.12.5" = _eCWpYrXo;
        "pkg-1.12.6" = _CDMBMADM;
        "pkg-1.12.7" = _9PfpqdfM;
        "pkg-1.12.8" = _SsaYNzi0;
        "pkg-1.12.9" = _FKLI0q4x;
        "pkg-1.12.10" = _8IXlk541;
        "pkg-1.13.0-alpha.1+mc.1.20.4" = _iKLPNJ7M;
        "pkg-1.13.0-alpha.2+mc.1.20.4" = _Bv3ybsmX;
        "pkg-1.13.0-alpha.3+mc.1.20.4" = _79PVsIwV;
        "pkg-1.13.0-alpha.4+mc.1.20.4" = _iNpBhEID;
        "pkg-1.13.0-alpha.5+mc.1.21.x" = _dmfsTyQU;
        "pkg-1.13.0-alpha.6+mc.1.21.x" = _gLtbSVWh;
        "pkg-1.13.0-alpha.7+mc.1.21.x" = _Id29Bg5V;
        "pkg-1.13.0-alpha.8+mc.1.21.x" = _vo8NtpKy;
        "pkg-1.13.0-alpha.9+mc.1.21.x" = _BUZYwxOO;
        "pkg-1.13.0-alpha.10+mc.1.21.x" = _nznoDHZS;
        "pkg-1.13.0-alpha.11+mc.1.21.1" = _wWB8cMrv;
        "pkg-1.13.0-alpha.12+mc.1.21.1" = _RzhrT8Th;
        "pkg-1.10.1+mc.1.20.1" = _uZ5btjkO;
        "pkg-1.10.2+mc.1.20.1" = _S03WNOkQ;
        "pkg-1.13.0-pre.1+mc.1.21.1" = _1PP0NxoS;
        "pkg-1.13.0-pre.2+mc.1.21.1" = _5o5sFcLS;
        "pkg-1.13.0-pre.3+mc.1.21.1" = _fcGzZVGn;
        "default" = _fcGzZVGn;
    });
