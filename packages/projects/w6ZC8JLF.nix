...
let
    ...
    in {
        ...
        "pkg-1.11" = _o9Rjz1MV;
        "pkg-1.12" = _WjEUmmh6;
        "pkg-1.12.1" = _lavEM99D;
        "pkg-Paper-1.0-1.21" = _a0Ua4iNn;
        "pkg-1.13" = _VI6uApUT;
        "pkg-Paper-1.1-1.21" = _2ykKjSGf;
        "pkg-Paper-1.1-1.17" = _zJiwj53I;
        "pkg-Paper-1.2-1.21" = _xPjkCKNO;
        "pkg-Paper-1.2-1.17" = _IdCdugrR;
        "pkg-1.14" = _x1w808JG;
        "pkg-1.15" = _HgGJ3PFR;
        "pkg-1.16" = _SLZ7u4ea;
        "pkg-Paper-1.3-1.21" = _EEKCKoQf;
        "pkg-Paper-1.3-1.17" = _mzAqvDFZ;
        "pkg-Paper-1.3.1-1.17" = _oymyaCie;
        "pkg-Paper-1.3.1-1.21" = _qCuhj30n;
        "pkg-1.16.1" = _vtVRpNAX;
        "pkg-2.0.0-1.21.1" = _egrMp1de;
        "pkg-Paper-2.0.0" = _Zo4W15kt;
        "pkg-2.1.0-1.21.5" = _91bMq8Ks;
        "pkg-Paper-2.1.0" = _UuzcnRTa;
        "pkg-Paper-2.1.1" = _lZ3hPPxu;
        "pkg-2.1.1-1.21.5" = _pVhUEJXz;
        "pkg-2.1.1-1.21.4" = _1CAx7waC;
        "pkg-2.2.0-1.21.5" = _z5j56VMU;
        "pkg-2.2.0" = _wxTwUXzJ;
        "default" = _wxTwUXzJ;
    });
