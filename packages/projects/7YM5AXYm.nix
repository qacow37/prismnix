...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0-fabric+forge+neo" = _KZGwNWDG;
        "pkg-1.19.2-1.1-fabric+forge+neo" = _ixwY7M1D;
        "pkg-1.20.1-1.1-fabric+forge+neo" = _ms4fZUxE;
        "pkg-1.20.2-1.1-fabric+forge+neo" = _uB7VlDKy;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _xR67JgVy;
        "pkg-1.20.5-1.1-fabric+neo" = _now8bseS;
        "pkg-1.20.6-1.1-fabric+forge+neo" = _V3NwPm7Y;
        "pkg-1.21.0-1.1-fabric+forge+neo" = _AmIvKEeO;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _RIzY810a;
        "pkg-1.20.6-1.2-fabric+forge+neo" = _tORLNt1s;
        "pkg-1.21.0-1.2-fabric+forge+neo" = _W4FDNh1p;
        "pkg-1.21.1-1.2-fabric+forge+neo" = _NA7TkDk6;
        "pkg-1.21.2-1.2-fabric+neo" = _yfJ34cxE;
        "pkg-1.21.3-1.2-fabric+forge+neo" = _ZMc0qgvw;
        "pkg-1.21.4-1.2-fabric+forge+neo" = _WQzFPCbP;
        "pkg-1.21.5-1.2-fabric+forge+neo" = _SyYUJUu4;
        "pkg-1.21.6-1.2-fabric+forge+neo" = _xvPXATzm;
        "pkg-1.21.7-1.2-fabric+forge+neo" = _TKt9roTT;
        "pkg-1.21.8-1.2-fabric+forge+neo" = _RWXHcqXn;
        "pkg-1.21.9-1.2-fabric+forge+neo" = _c0xayFjF;
        "pkg-1.21.10-1.2-fabric+forge+neo" = _BmrnfR4Y;
        "pkg-1.21.11-1.2-fabric+forge+neo" = _KjOjNNvN;
        "pkg-26.1.0-1.2-fabric+forge+neo" = _mIre4h20;
