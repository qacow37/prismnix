...
let
    ...
    in {
        ...
        "pkg-V1.7" = _YrKV5AEO;
        "pkg-V2.0" = _XQEzWiLH;
        "pkg-V2.0.1" = _vDYJ7Hyp;
        "pkg-V2.0.2" = _cnS2ViSX;
        "pkg-V2.1" = _3cb1wAnA;
        "pkg-V2.1.1" = _5Lrandu3;
        "pkg-V2.2" = _3K4VCh64;
        "pkg-V2.2.1" = _pcHdhQEP;
        "pkg-V2.2.2" = _Gq7RzINX;
        "pkg-V2.3" = _C3NTgX9i;
        "pkg-V3.0" = _kz6G371d;
        "pkg-V3.0.1" = _3cX3B6GX;
        "pkg-V3.0.2" = _RgynQpz9;
        "pkg-V3.0.3" = _rf4bdpjt;
        "pkg-V3.1" = _XMNH1Ojp;
        "pkg-B-3.2" = _SuP3ltA8;
        "pkg-V3.2" = _KaWMwBjQ;
        "pkg-P1-4.0" = _PTkYJAbC;
        "pkg-Add-on-P1-4.0" = _klR1ixGN;
        "pkg-V4.0" = _X0oODDrz;
        "pkg-Add-On-V4.0" = _LbAu070I;
        "pkg-Add-On-V4.0-C1" = _yLX6dE3x;
        "pkg-V4.0-C1" = _TBx9LsRh;
        "default" = _TBx9LsRh;
    });
