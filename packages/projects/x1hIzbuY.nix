...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _72tmtFD5;
        "pkg-2.0.0" = _KVfjDHhB;
        "pkg-2.1.0+1.19-1.19.2" = _ahUi4sBL;
        "pkg-2.1.0+1.19.3" = _5HxlwbWf;
        "pkg-3.0.0-beta.1+1.20+" = _E1amq7WP;
        "pkg-3.0.0-beta.2+1.20+" = _A9KTdfFF;
        "pkg-3.0.0+1.20+" = _tNgyOUMr;
        "pkg-3.0.0+1.20.4" = _vOAKK0JB;
        "pkg-3.0.0+1.20.6" = _dIGKewCo;
        "pkg-3.0.0+1.21.3" = _880U5Kcb;
        "pkg-3.0.0+1.21.4" = _HdbAWjaF;
        "pkg-3.1.0+mc1.21.6" = _PiKgGcQz;
        "pkg-3.1.1+mc1.21.6" = _ah71vPRw;
        "pkg-3.1.2+mc1.21.10" = _ZgHqClek;
        "pkg-3.1.3+mc1.21.11" = _ip2tVKLp;
        "pkg-3.1.4+mc26.1.x" = _ly8rADfr;
        "pkg-3.1.5+mc26.2" = _ZZ5dfboC;
        "default" = _ZZ5dfboC;
    });
