...
let
    ...
    in {
        ...
        "pkg-1.1.1+1.21.3" = _JfXgsCKQ;
        "pkg-1.2.0+1.21.3" = _kduyyyZe;
        "pkg-1.2.1+1.21.4" = _4KBIn3CP;
        "pkg-1.3.0+1.21.5" = _ijxqJc7C;
        "pkg-1.3.0+1.21.6" = _vWg1NfMG;
        "pkg-1.3.1+1.21.7" = _Z893lbrC;
        "pkg-1.4.0+1.21.7" = _pyQOffNG;
        "pkg-1.4.0+1.21.8" = _XAnOXF3Z;
        "pkg-1.4.0+1.21.9" = _CoCPzTNs;
        "pkg-1.4.0+1.21.10" = _zNZVwi42;
        "pkg-1.4.0+1.21" = _kTy54FMj;
        "pkg-1.4.0+1.21.1" = _ETujDcDh;
        "pkg-1.4.0+1.21.4" = _yOMGGwCk;
        "pkg-1.4.0+1.21.5" = _4zzXQr4B;
        "pkg-1.4.0+1.21.11" = _F7EyJcex;
        "pkg-1.4.1+1.21.9" = _NtxcAtEB;
        "pkg-1.4.1+1.21.10" = _Yb5kEep1;
        "pkg-1.4.1+1.21.11" = _qLVqQrkq;
        "pkg-1.4.2+26.1" = _Ko7oHFZl;
