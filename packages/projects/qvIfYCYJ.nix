...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta.4+0.48.0-1.18.2" = _cmqWpwyC;
        "pkg-1.0.0-beta.5+0.48.0-1.18.2" = _w6Z1WEDi;
        "pkg-1.0.0-beta.6+0.51.1-1.18.2" = _VtK9e93B;
        "pkg-1.0.0-beta.7+0.51.1-1.18.2" = _zrMlJA87;
        "pkg-1.0.0-beta.8+0.51.1-1.18.2" = _t1xewTPM;
        "pkg-1.0.0-beta.9+0.51.1-1.18.2" = _PAE9ujTn;
        "pkg-1.0.0-beta.10+0.51.1-1.18.2" = _GAyycZIm;
        "pkg-1.0.0-beta.11+0.51.1-1.18.2" = _VvjoqNcy;
        "pkg-1.0.0-beta.12+0.51.1-1.18.2" = _9QT3b4mE;
        "pkg-1.0.0-beta.13+0.51.1-1.18.2" = _Qocje47u;
        "pkg-1.0.0-beta.14+0.51.1-1.18.2" = _45CcbAvo;
        "pkg-1.0.0-beta.15+0.53.4-1.18.2" = _RUKOwGTz;
        "pkg-1.0.0-beta.16+0.53.4-1.18.2" = _I9rPSfaR;
        "pkg-1.0.0-beta.17+0.54.0-1.18.2" = _lz767pA6;
        "pkg-1.0.0-beta.18+0.55.1-1.18.2" = _L1XD5HAW;
        "pkg-1.0.0-beta.19+0.55.1-1.18.2" = _hPStWdDs;
        "pkg-1.0.0-beta.20+0.55.1-1.18.2" = _pwp94ACs;
        "pkg-2.0.0-alpha.2+0.55.3-1.19" = _HwOyG7I5;
        "pkg-2.0.0-alpha.3+0.55.3-1.19" = _3u6Qbhdw;
        "pkg-1.0.0-beta.22+0.56.0-1.18.2" = _IhFPlQD2;
        "pkg-2.0.0-alpha.4+0.56.1-1.19" = _6PllArdw;
        "pkg-2.0.0-beta.1+0.56.3-1.19" = _rahw4ZIK;
        "pkg-2.0.0-beta.3+0.57.0-1.19" = _Sq6bz7rT;
        "pkg-2.0.0-beta.4+0.57.0-1.19" = _zEy1plMo;
        "pkg-3.0.0-alpha.1+0.57.1-1.19.1" = _UU6RE2F3;
        "pkg-2.0.0-beta.5+0.57.0-1.19" = _BM67Isrd;
        "pkg-3.0.0-alpha.2+0.57.2-1.19.1" = _OAY06QzZ;
        "pkg-2.0.0-beta.6+0.57.0-1.19" = _pnrewaSX;
        "pkg-3.0.0-alpha.3+0.57.2-1.19.1" = _gfkHVL2e;
        "pkg-2.0.0-beta.7+0.57.0-1.19" = _CkDCzjJ0;
        "pkg-3.0.0-alpha.4+0.57.3-1.19.1" = _x7fqy7dc;
        "pkg-2.0.0-beta.8+0.57.0-1.19" = _dFp106HY;
        "pkg-3.0.0-alpha.5+0.58.0-1.19.1" = _QngFBFZl;
        "pkg-2.0.0-beta.9+0.58.0-1.19" = _ddaofVmY;
        "pkg-3.0.0-alpha.6+0.58.1-1.19.1" = _MM1jFJNL;
        "pkg-4.0.0-beta.1+0.58.5-1.19.1" = _MrInA5CW;
        "pkg-4.0.0-beta.2+0.58.5-1.19.1" = _P1gbVJ0v;
        "pkg-4.0.0-beta.3+0.58.5-1.19.1" = _j0ZcDm2x;
        "pkg-4.0.0-beta.4+0.58.5-1.19.1" = _8BeDPO6l;
        "pkg-4.0.0-beta.5+0.58.5-1.19.1" = _f7DTnkIq;
        "pkg-4.0.0-beta.6+0.58.5-1.19.1" = _obMVHg7L;
        "pkg-4.0.0-beta.7+0.59.0-1.19.2" = _J4qgCouL;
        "pkg-1.0.0-beta.23+0.58.0-1.18.2" = _brNZ0tRC;
        "pkg-1.0.0-beta.24+0.58.0-1.18.2" = _H1soL5Sq;
        "pkg-4.0.0-beta.8+0.59.0-1.19.2" = _wMtZiptr;
        "pkg-4.0.0-beta.9+0.60.0-1.19.2" = _HpHTJI6P;
        "pkg-4.0.0-beta.10+0.60.0-1.19.2" = _SHjwCrR0;
        "pkg-4.0.0-beta.11+0.60.0-1.19.2" = _UUGSby2q;
        "pkg-4.0.0-beta.12+0.61.0-1.19.2" = _VNZ3SkYT;
        "pkg-1.0.0-beta.25+0.59.0-1.18.2" = _VJj4Lc8d;
        "pkg-4.0.0-beta.13+0.62.0-1.19.2" = _RMRJccdH;
        "pkg-4.0.0-beta.14+0.62.0-1.19.2" = _x1bEhzoO;
        "pkg-4.0.0-beta.15+0.63.0-1.19.2" = _qg8B4tEe;
        "pkg-4.0.0-beta.16+0.64.0-1.19.2" = _sSSwdqie;
        "pkg-1.0.0-beta.26+0.59.1-1.18.2" = _X7Z3WAXh;
        "pkg-4.0.0-beta.17+0.64.0-1.19.2" = _1RL57ufH;
        "pkg-4.0.0-beta.18+0.64.0-1.19.2" = _ue0SvAIA;
        "pkg-4.0.0-beta.19+0.64.0-1.19.2" = _zzHaJbi0;
        "pkg-5.0.0-alpha.1+0.65.2-1.19.3" = _Y8jT2hZ4;
        "pkg-4.0.0-beta.20+0.66.0-1.19.2" = _TwxGzxIl;
        "pkg-1.0.0-beta.27+0.66.0-1.18.2" = _zmdteZF3;
        "pkg-1.0.0-beta.28+0.67.0-1.18.2" = _U0wSVcD2;
        "pkg-4.0.0-beta.21+0.67.0-1.19.2" = _LKDRXFIa;
        "pkg-4.0.0-beta.22+0.67.1-1.19.2" = _NRjGGNrs;
        "pkg-4.0.0-beta.23+0.68.0-1.19.2" = _WmdTkZ6I;
        "pkg-5.0.0-alpha.2+0.68.1-1.19.3" = _ae1ofda7;
        "pkg-4.0.0-beta.24+0.68.0-1.19.2" = _hmX9pHvE;
        "pkg-5.0.0-alpha.3+0.68.1-1.19.3" = _NxpdXpm6;
        "pkg-5.0.0-alpha.4+0.68.1-1.19.3" = _3fkx18f5;
        "pkg-5.0.0-alpha.5+0.68.1-1.19.3" = _VRQm0KLG;
        "pkg-5.0.0-alpha.6+0.69.1-1.19.3" = _cEh00xLw;
        "pkg-5.0.0-alpha.7+0.70.0-1.19.3" = _TbQBjHUn;
        "pkg-4.0.0-beta.25+0.70.0-1.19.2" = _bRcRsE72;
        "pkg-5.0.0-alpha.8+0.71.0-1.19.3" = _MoSNH4oo;
        "pkg-5.0.0-alpha.9+0.72.0-1.19.3" = _5I6Al1Gw;
        "pkg-4.0.0-beta.26+0.72.0-1.19.2" = _i7UY2LFx;
        "pkg-5.0.0-beta.1+0.73.0-1.19.3" = _Dvj5P1fV;
        "pkg-5.0.0-beta.3+0.73.0-1.19.3" = _wKBO3Xkk;
        "pkg-4.0.0-beta.27+0.73.0-1.19.2" = _o9KoJqZQ;
        "pkg-5.0.0-beta.4+0.73.0-1.19.3" = _ZUB07xly;
        "pkg-4.0.0-beta.28+0.73.2-1.19.2" = _WKziOmCZ;
        "pkg-5.0.0-beta.5+0.73.2-1.19.3" = _t8snEhsc;
        "pkg-5.0.0-beta.6+0.74.0-1.19.3" = _oQbYgY9f;
        "pkg-5.0.0-beta.7+0.75.1-1.19.3" = _spTTmhS4;
        "pkg-4.0.0-beta.29+0.75.1-1.19.2" = _kMDIFsRI;
        "pkg-5.0.0-beta.8+0.75.1-1.19.3" = _MYbIY8g7;
        "pkg-6.0.0-alpha.1+0.75.2-1.19.4" = _RAIWeVLH;
        "pkg-6.0.0-alpha.2+0.75.3-1.19.4" = _JYRztVNW;
        "pkg-6.0.0-beta.1+0.75.3-1.19.4" = _3isqQyAk;
        "pkg-6.0.0-beta.2+0.76.0-1.19.4" = _AmlAy82C;
        "pkg-4.0.0-beta.30+0.76.0-1.19.2" = _BTCxVi75;
        "pkg-6.0.0-beta.3+0.76.0-1.19.4" = _9gcIrw5Z;
        "pkg-5.0.0-beta.9+0.76.0-1.19.3" = _eaoB99I6;
        "pkg-6.0.0-beta.4+0.78.0-1.19.4" = _cpRPaFBn;
        "pkg-6.0.0-beta.5+0.78.0-1.19.4" = _8eRjIPoA;
        "pkg-6.0.0-beta.6+0.79.0-1.19.4" = _Ng2kCEiP;
        "pkg-6.0.0-beta.6+0.81.1-1.19.4" = _Gxq4k3Vt;
        "pkg-6.0.0-beta.7+0.81.1-1.19.4" = _jCiJggRO;
        "pkg-7.0.0-alpha.1+0.81.3-1.20" = _Xhv4rEIJ;
        "pkg-6.0.0-beta.8+0.82.0-1.19.4" = _x86qltyO;
        "pkg-7.0.0-alpha.2+0.82.1-1.20" = _Y4qL3XEB;
        "pkg-7.0.0-alpha.3+0.83.0-1.20" = _b1Y1Otv7;
        "pkg-7.0.0-alpha.4+0.83.0-1.20" = _YiAkMxMf;
        "pkg-6.0.0-beta.9+0.83.0-1.19.4" = _QPXihdoB;
        "pkg-7.0.0+0.83.0-1.20" = _csBGi8FI;
        "pkg-7.0.1+0.83.0-1.20" = _rS9Tm10P;
        "pkg-7.0.2+0.83.0-1.20.1" = _uw5SkGdQ;
        "pkg-7.0.3+0.83.1-1.20.1" = _di82eiyL;
        "pkg-7.0.4+0.84.0-1.20.1" = _cFCbC3OH;
        "pkg-7.0.5+0.84.0-1.20.1" = _BAwbsZ2r;
        "pkg-7.0.6+0.85.0-1.20.1" = _4JBkYQUF;
        "pkg-7.1.0+0.86.1-1.20.1" = _fFx48erS;
        "pkg-7.1.1+0.86.1-1.20.1" = _ugK6veHN;
        "pkg-7.1.2+0.87.0-1.20.1" = _aWl2Qw6u;
        "pkg-7.2.0+0.88.0-1.20.1" = _PmZhDLt6;
        "pkg-7.2.1+0.88.0-1.20.1" = _DzBePwtf;
        "pkg-7.2.2+0.88.1-1.20.1" = _vTQynnGn;
        "pkg-7.3.0+0.89.0-1.20.1" = _Ycmh3qg8;
        "pkg-7.3.1+0.89.3-1.20.1" = _ftu8PpDD;
        "pkg-6.0.0-beta.10+0.87.0-1.19.4" = _jOT4fzXf;
        "pkg-7.4.0+0.90.0-1.20.1" = _GjvWb8WQ;
        "pkg-6.0.0-beta.11+0.87.0-1.19.4" = _BQoiDT9n;
        "pkg-8.0.0-alpha.1+0.91.2-1.20.2" = _g6CMDJLy;
        "pkg-8.0.0-alpha.2+0.91.2-1.20.2" = _Xo36xpLR;
        "pkg-8.0.0-alpha.3+0.91.2-1.20.2" = _gIUtHixU;
        "pkg-7.5.0+0.91.0-1.20.1" = _qAYOU2Af;
        "pkg-4.0.0-beta.30+0.77.0-1.19.2" = _aaucrsnr;
        "pkg-8.0.0-alpha.4+0.91.6-1.20.2" = _z7EhOm3D;
        "pkg-8.0.0-alpha.5+0.91.6-1.20.2" = _vZbU3nyq;
        "pkg-9.0.0-alpha.5+0.96.11-1.20.4" = _DWVsGxzN;
        "pkg-9.0.0-alpha.6+0.96.11-1.20.4" = _rfATdsrM;
        "pkg-8.0.0-alpha.6+0.91.6-1.20.2" = _zHVlrS0A;
        "pkg-9.0.0-alpha.7+0.96.11-1.20.4" = _DiaeDvXG;
        "pkg-9.0.0-alpha.8+0.97.0-1.20.4" = _AljqyvST;
        "pkg-7.5.0+0.92.2-1.20.1" = _Gydw2vxY;
        "pkg-10.0.0-alpha.2+0.100.4-1.20.6" = _3TIQBIMy;
        "pkg-11.0.0-alpha.1+0.100.4-1.21" = _ztVCwkjV;
        "pkg-10.0.0-alpha.3+0.100.4-1.20.6" = _IQQyeJNR;
        "pkg-11.0.0-alpha.2+0.100.4-1.21" = _Zs4kU6Dw;
        "pkg-7.6.0+0.92.2-1.20.1" = _zEhzQDsY;
        "pkg-11.0.0-alpha.3+0.100.7-1.21" = _PNhUOnZI;
        "pkg-11.0.0-alpha.3+0.102.0-1.21" = _WDWNp8qJ;
        "pkg-7.7.0+0.92.2-1.20.1" = _s8dfz9Xa;
        "default" = _s8dfz9Xa;
    });
