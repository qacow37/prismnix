...
let
    ...
    in {
        ...
        "pkg-0.1.7" = _h7hTP6KV;
        "pkg-0.1.8" = _W99W25ze;
        "pkg-v0.1.9" = _SgfjPH7n;
        "pkg-0.2.0" = _Ql35SUY7;
        "pkg-v0.2.1-alpha" = _32O2layD;
        "pkg-v0.3.0-alpha" = _hvZdNv8s;
        "pkg-v0.4.0-alpha" = _yuEBo6I7;
        "pkg-v0.4.1-alpha" = _XxZodZEI;
        "pkg-v0.4.2-alpha" = _XsLJOlqz;
        "pkg-v0.5.0-alpha" = _hm33uK2X;
        "pkg-v0.6.0-alpha" = _7ybnKHuh;
        "pkg-v0.6.1-alpha" = _Iug1GqWi;
        "pkg-v0.6.2-alpha" = _bnYHiERX;
        "pkg-v0.6.4-alpha" = _mUwTHCdc;
        "pkg-v0.7.0-alpha" = _SKXbI03o;
        "pkg-v0.8.0-alpha+1.21.1" = _mPo3gtQP;
        "pkg-v0.8.0-alpha+1.21.4" = _tNVYLSW8;
        "pkg-v0.8.1-alpha+1.21.1" = _9ZMdgieh;
        "pkg-v0.8.1-alpha+1.21.4" = _JwFDaHSh;
        "pkg-v0.9.0-alpha+1.21.4" = _h0r5hJPr;
        "pkg-v0.9.1-alpha+1.21.4" = _WvBelwnV;
        "pkg-v0.9.1-alpha+1.21.1" = _ZtLZRQzx;
        "pkg-v0.9.2-alpha+1.21.1" = _fdpDp8qv;
        "pkg-v0.9.3-alpha+1.21.1" = _BeoDQJHJ;
        "pkg-v0.10.0-alpha+1.21.1" = _5F4VMoSJ;
        "pkg-v0.10.1-alpha+1.21.1" = _mmFFrwnZ;
        "pkg-v0.10.2-alpha+1.21.1" = _Ob05zEy0;
        "pkg-v0.10.3-alpha+1.21.1" = _Zq6obheE;
        "default" = _Zq6obheE;
    });
