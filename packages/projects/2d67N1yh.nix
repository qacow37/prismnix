...
let
    ...
    in {
        ...
        "pkg-1.0.11-1.16.5" = _q9kauE64;
        "pkg-1.0.11-1.17-1.19.2" = _p3LM5utm;
        "pkg-1.0.11-1.19.3-1.20.2" = _HiXBdxws;
        "pkg-1.0.11-1.20.3-1.20.4" = _Awgs9K9b;
        "pkg-1.0.11-1.20.5-1.21.1" = _1npYTm5f;
        "pkg-1.0.12-1.16.5" = _DODFnz31;
        "pkg-1.0.12-1.17-1.19.2" = _ms4VsSaj;
        "pkg-1.0.12-1.19.3-1.20.2" = _AqyXYty4;
        "pkg-1.0.12-1.20.3-1.20.4" = _XqWbS5s4;
        "pkg-1.0.12-1.20.5-1.21.1" = _eFF7mb4x;
        "pkg-1.0.13-1.16.5" = _LkxtrUOj;
        "pkg-1.0.13-1.17-1.19.2" = _4bhPSHQw;
        "pkg-1.0.13-1.19.3-1.20.2" = _H3PRovTx;
        "pkg-1.0.13-1.20.3-1.20.4" = _TrzieQFv;
        "pkg-1.0.13-1.20.5-1.21.1" = _4QhK3r21;
        "pkg-1.0.14-1.16.5" = _purmaZuv;
        "pkg-1.0.14-1.17-1.19.2" = _Y9OZLUDj;
        "pkg-1.0.14-1.19.3-1.20.2" = _oHJa1OzU;
        "pkg-1.0.14-1.20.3-1.20.4" = _kHk1kM74;
        "pkg-1.0.14-1.20.5-1.21.1" = _hNlsYOG8;
        "pkg-1.0.15-1.16.5" = _7XYHW6ss;
        "pkg-1.0.15-1.17-1.19.2" = _EgJXGmaJ;
        "pkg-1.0.15-1.19.3-1.20.2" = _3ak1MDdf;
        "pkg-1.0.15-1.20.3-1.20.4" = _PELRQsKw;
        "pkg-1.0.15-1.20.5-1.21.3" = _SvpodAID;
        "pkg-1.0.16-1.16.5" = _97fa88Y3;
        "pkg-1.0.16-1.17-1.19.2" = _WjKNEgOq;
        "pkg-1.0.16-1.19.3-1.20.2" = _XVijAfI8;
        "pkg-1.0.16-1.20.3-1.20.4" = _ibhc9DkF;
        "pkg-1.0.16-1.20.5-1.21.3" = _Tkk80aMu;
        "pkg-1.1.0-1.17-1.19.2" = _oCgxZKDL;
        "pkg-1.1.0-1.19.3-1.20.2" = _Tvx7nRZn;
        "pkg-1.1.0-1.20.5-1.21.3" = _RyUTNJTF;
        "pkg-1.1.1-1.17-1.19.2" = _efP49eGV;
        "pkg-1.1.1-1.19.3-1.20.2" = _DPFubMKB;
        "pkg-1.1.1-1.20.3-1.20.4" = _4GV3XvzB;
        "pkg-1.1.1-1.20.5-1.21.4" = _XfosMaBS;
        "pkg-1.1.2-1.19.3-1.20.2" = _tYTyhBjd;
        "pkg-1.1.2-1.20.3-1.20.4" = _iflzIN0m;
        "pkg-1.1.2-1.20.5-1.21.4" = _7cVUKFpM;
        "pkg-1.1.3-1.19.3-1.20.2" = _E6AegIWG;
        "pkg-1.1.3-1.20.3-1.20.4" = _KwSzEOdj;
        "pkg-1.1.3-1.20.5-1.21.4" = _ximOkz6k;
        "pkg-1.1.4-1.19.3-1.20.2" = _1CLUbWv3;
        "pkg-1.1.4-1.20.3-1.20.4" = _yAaprVzf;
        "pkg-1.1.4-1.20.5-1.21.5" = _G3vMX8Qb;
        "pkg-1.2.0-1.19.3-1.20.2" = _3VyHdeJ4;
        "pkg-1.2.0-1.20.3-1.20.4" = _rOmHmHmt;
        "pkg-1.2.0-1.20.5-1.21.5" = _pbb2yuSV;
        "pkg-1.2.1-1.19.3-1.20.2" = _MiBLcAHM;
        "pkg-1.2.1-1.20.3-1.20.4" = _G3nTNyyp;
        "pkg-1.2.1-1.20.5-1.21.5" = _68GRUgmh;
        "pkg-1.2.2-1.19.3-1.20.2" = _JQl6laoh;
        "pkg-1.2.2-1.20.3-1.20.4" = _FbNy2pIr;
        "pkg-1.2.2-1.20.5-1.21.5" = _120InqM0;
        "pkg-1.2.3" = _t7YdKZHy;
        "pkg-1.2.3.1" = _AAbfQofk;
        "pkg-1.2.3.2" = _r2yXqe74;
        "pkg-1.2.3.3" = _O03GacK3;
        "pkg-1.2.3.4" = _dRXDXogU;
        "pkg-1.2.4" = _MCwVGpeS;
        "pkg-1.2.4.1" = _VmLYmGBx;
        "pkg-1.2.5" = _xkq7vER8;
        "default" = _xkq7vER8;
    });
