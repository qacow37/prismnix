...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _gVMDSRMu;
        "pkg-1.0.1" = _kXYPAeyk;
        "pkg-1.2.0-alpha" = _vHaVdNWK;
        "pkg-1.2.0" = _r2FNti0e;
        "pkg-1.3.0" = _P5hSCzPX;
        "pkg-1.20.1-1.3.1" = _X25KjBgw;
        "pkg-1.3.4" = _reOp4ANM;
        "pkg-1.4.0" = _LeoXs7uo;
        "pkg-1.5.0" = _Q74yM83j;
        "pkg-1.5.1" = _4AC08MaE;
        ...
        "pkg-1.6.3" = _V8SyD3Sa;
        "pkg-1.6.4" = _3NCvqvX8;
        "pkg-21.0.0-alpha1" = _v14bCrXq;
        "pkg-21.0.0-alpha2" = _uq5jhisd;
        "pkg-21.0.1" = _BlFlsF2P;
        "pkg-1.6.5" = _pXkOA3cH;
        "pkg-1.6.6" = _lT9k32xe;
        "pkg-21.0.2" = _7z2AnyJY;
        "pkg-21.1.0" = _zshk2MXk;
        "pkg-21.1.1" = _i2Kfys5f;
        "pkg-1.6.7" = _309LIQ2b;
        "pkg-21.1.2" = _dOOluRhi;
        "pkg-21.1.3" = _5mUJMatg;
        "pkg-21.1.4" = _Ufb9o5eb;
        "pkg-21.1.5" = _a2XxgryW;
        "pkg-21.1.6" = _tKSFIos5;
        "pkg-21.2.0" = _BSLKcNdS;
        "pkg-21.2.2" = _VS35BpPs;
        "pkg-21.2.3" = _B0CEA8jG;
        "pkg-21.3.0" = _aQ0r5GD2;
        "default" = _aQ0r5GD2;
    });
