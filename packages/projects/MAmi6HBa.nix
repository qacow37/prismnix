...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19" = _zYyqgbus;
        "pkg-1.1.0+1.19" = _8QJm48D4;
        "pkg-1.1.0+1.19.3" = _qf3tZzkt;
        "pkg-1.1.0+1.20" = _wITFMAnN;
        "pkg-1.1.1+1.19" = _mzPMclou;
        "pkg-1.1.1+1.19.3" = _5Q2npBYt;
        "pkg-1.1.1+1.20" = _1iDZpG79;
        "pkg-1.1.2+1.19" = _EZwHBLLd;
        "pkg-1.1.2+1.19.3" = _QmK7dLzl;
        "pkg-1.1.2+1.20" = _IIALrvaw;
        "pkg-1.2.0+1.19" = _oQedWbn0;
        "pkg-1.2.0+1.19.3" = _gT36junK;
        "pkg-1.2.0+1.20" = _idXXdf76;
        "pkg-1.2.0+1.18" = _J3GFUaFu;
        "pkg-1.3.0+1.18" = _YzXUqD9T;
        "pkg-1.3.0+1.19" = _eLqJ2ZoJ;
        "pkg-1.3.0+1.19.3" = _oANB6oSe;
        "pkg-1.3.0+1.20" = _EIXxMcex;
        "pkg-1.3.0+1.20.4" = _AqoDCMEp;
        "pkg-1.3.1+1.20.4" = _KT5FwmFO;
        "pkg-1.3.2+1.18" = _MMEYkyDx;
        "pkg-1.3.2+1.19" = _UKo9Ac2G;
        "pkg-1.3.2+1.19.3" = _kUW77UWS;
        "pkg-1.3.2+1.20" = _fFDB9l70;
        "pkg-1.3.2+1.20.4" = _Ue6NuQTB;
        "pkg-1.3.3+1.20" = _KnGvBQfO;
        "pkg-1.3.4+1.18" = _9QDGs0PU;
        "pkg-1.3.4+1.19" = _AAQEHFv8;
        "pkg-1.3.4+1.19.3" = _YIaSm5jF;
        "pkg-1.3.4+1.20" = _z4qChwEw;
        "pkg-1.3.4+1.20.4" = _uNTBn5hM;
        "pkg-1.3.4+1.21" = _By1RwoDW;
        "pkg-1.3.5+1.20" = _KtRDEOSN;
        "pkg-1.3.5+1.21" = _UaXDXnEE;
        "pkg-1.3.5+26.1" = _Y6WJdEzw;
        "default" = _Y6WJdEzw;
    });
