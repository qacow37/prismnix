...
let
    ...
    in {
        ...
        "pkg-0.7.0a-7" = _1ocaMLkQ;
        "pkg-0.7.0b-1" = _WlsFWrAg;
        "pkg-0.7.0b3-1" = _RgRFgBrs;
        "pkg-0.7.0b4.3" = _knUnYjmf;
        "pkg-0.7.0-release" = _gtYpDobG;
        "pkg-0.8.0a-1" = _MNqkfGAi;
        "pkg-0.8.0a-2" = _vvwachAd;
        "pkg-0.8.0a-3" = _YCSQRpQL;
        "pkg-0.8.0beta-2" = _yo0idmFZ;
        "pkg-0.8.0-release" = _LvKKaTg6;
        "pkg-0.8.1" = _XSwSLdGq;
        "pkg-0.8.2-dev" = _O2K0tp3N;
        "pkg-0.0.1" = _bhAeRADW;
        "pkg-0.0.2" = _TTsJWqkd;
        "pkg-0.0.3" = _zuk8Xz0l;
        "pkg-0.0.4" = _TYcxAjfV;
