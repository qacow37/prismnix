...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.3.3" = _cqs9a2To;
        "pkg-1.19.3-1.3.3" = _RcdltVJd;
        "pkg-1.19.4-1.3.3" = _m5ZeERhY;
        "pkg-1.20-1.3.3" = _hFJYJgOY;
        "pkg-1.20.2-1.3.3" = _fVG9iIz7;
        "pkg-1.18.2-1.3.4" = _b8zEjJeC;
        "pkg-1.19.2-1.3.4" = _V1AZ9P05;
        "pkg-1.19.3-1.3.4" = _uVAUDzlk;
        "pkg-1.19.4-1.3.4" = _dfEphzAN;
        "pkg-1.20" = _2E9xilz6;
        "pkg-1.20-1.3.4" = _qslj8BHt;
        "pkg-1.20.1-1.3.4" = _nNDXWQKZ;
        "pkg-1.20.2-1.3.4" = _T2jYbOTO;
        "pkg-1.18.2-1.3.5" = _aRDr4KkH;
        "pkg-1.19.2-1.3.5" = _pPbx0GEW;
        "pkg-1.19.3-1.3.5" = _cP6huwFr;
        "pkg-1.19.4-1.3.5" = _boJKuOkI;
        "pkg-1.20-1.3.5" = _UODMeAyR;
        "pkg-1.20.1-1.3.5" = _gwoiUkYO;
        "pkg-1.20.2-1.3.5" = _uzUhu63L;
        "pkg-1.18.2-1.3.6" = _ICFrkvbS;
        "pkg-1.19.2-1.3.6" = _6iwMKrgB;
        "pkg-1.19.3-1.3.6" = _P22y6CK5;
        "pkg-1.19.4-1.3.6" = _qpBdOmVV;
        "pkg-1.20-1.3.6" = _iUEzBO1h;
        "pkg-1.20.1-1.3.6" = _SaWcEnBO;
        "pkg-1.20.2-1.3.6" = _j0kDaInM;
        "pkg-1.18.2-1.3.7" = _zq7mzPa7;
        "pkg-1.19.2-1.3.7" = _ph87TjCg;
        "pkg-1.19.3-1.3.7" = _2XY7yziL;
        "pkg-1.19.4-1.3.7" = _ieabMtJl;
        "pkg-1.20-1.3.7" = _DB0l95rV;
        "pkg-1.20.1-1.3.7" = _gIVxfJ0R;
        "pkg-1.20.2-1.3.7" = _SCXGoSqT;
        "pkg-1.20.3-1.3.6" = _iEFC9HC5;
        "pkg-1.20.3-1.3.7" = _cx8Ng9c1;
        "pkg-1.20.4-1.3.6" = _OEWKOhW4;
        "pkg-1.20.4-1.3.7" = _h9wDFG4R;
        "pkg-1.18.2-1.3.8" = _B2Vx2w3A;
        "pkg-1.19.2-1.3.8" = _2gw2ykUz;
        "pkg-1.19.3-1.3.8" = _dJGIhwgm;
        "pkg-1.19.4-1.3.8" = _ymHHQXmn;
        "pkg-1.20-1.3.8" = _2y6VAD7R;
        "pkg-1.20.1-1.3.8" = _zZy69OiJ;
        "pkg-1.20.2-1.3.8" = _gi2yzoXn;
        "pkg-1.20.3-1.3.8" = _YakCmPPW;
        "pkg-1.20.4-1.3.8" = _TNJlOCEH;
        "pkg-1.20.5-1.3.8" = _CxnlsuQa;
        "pkg-1.20.6-1.3.8" = _913XRXuG;
        "pkg-1.21-1.3.8" = _rFzr2yrd;
        "pkg-1.21-1.3.9" = _AmikGda1;
        "pkg-1.21.2-1.3.9" = _ou0wgkNr;
        "pkg-1.21.4-1.3.9" = _bWQLP97X;
        "pkg-1.21.4-1.3.10" = _fzU46VbX;
        "pkg-1.21.5-1.3.11" = _PqTAuCHp;
        "pkg-1.21.1-1.3.11" = _TtNHrpXm;
        "pkg-1.21.3-1.3.11" = _ElM5TUYa;
        "pkg-1.21.4-1.3.11" = _8TA34pXB;
        "pkg-1.21.6-1.3.11" = _uyvEol2K;
        "pkg-1.21.7-1.3.11" = _UQRdDsOU;
        "pkg-1.21.8-1.3.11" = _riMRlhDh;
        "pkg-1.21.9-1.3.11" = _TflQQiYd;
        "pkg-1.21.10-1.3.11" = _bmcGdb76;
        "pkg-1.20-1.3.12" = _umU22AuF;
        "pkg-1.20.1-1.3.12" = _OgPIMTyQ;
        "pkg-1.20.2-1.3.12" = _B08eaqeF;
        "pkg-1.20.3-1.3.12" = _ZNMiIEqB;
        "pkg-1.20.4-1.3.12" = _gh5IIjck;
        "pkg-1.21-1.3.12" = _E87R4ncQ;
        "pkg-1.21.1-1.3.12" = _iH2cOaHf;
        "pkg-1.21.2-1.3.12" = _YaUFsVD0;
        "pkg-1.21.3-1.3.12" = _tUMCIDsH;
        "pkg-1.21.4-1.3.12" = _y2uuk759;
        "pkg-1.21.5-1.3.12" = _RSWThczw;
        "pkg-1.21.6-1.3.12" = _kut7AotP;
        "pkg-1.21.7-1.3.12" = _36LO0F0m;
        "pkg-1.21.8-1.3.12" = _pTyDyWVm;
        "pkg-1.21.9-1.3.12" = _9tnzZaiF;
        "pkg-1.21.10-1.3.12" = _GlTE8dft;
        "pkg-1.21.11-1.3.12" = _HlH08oed;
        "pkg-1.21.11-1.3.13" = _fjIwykTO;
        "pkg-1.20-1.3.13" = _uq9gGoj3;
        "pkg-1.20.1-1.3.13" = _J7g0lhGV;
        "pkg-1.20.2-1.3.13" = _GxlBcodX;
        "pkg-1.20.3-1.3.13" = _Clhz6M9q;
        "pkg-1.20.4-1.3.13" = _Qo7hLdKh;
        "pkg-1.21-1.3.13" = _3US1utrp;
        "pkg-1.21.1-1.3.13" = _kvMv5Lch;
        "pkg-1.21.2-1.3.13" = _maCILpMO;
        "pkg-1.21.3-1.3.13" = _E2IuHxyG;
        "pkg-1.21.4-1.3.13" = _eSQ5mxlL;
        "pkg-1.21.5-1.3.13" = _UsRmf5ln;
        "pkg-1.21.6-1.3.13" = _sWCDtDxY;
        "pkg-1.21.7-1.3.13" = _q2QOpyVA;
        "pkg-1.21.8-1.3.13" = _jf47KmFF;
        "pkg-1.21.9-1.3.13" = _vdutycCI;
        "pkg-1.21.10-1.3.13" = _bUyKRQTj;
        "pkg-26.1-1.3.13" = _vupv0hAL;
        "pkg-26.1-1.3.14" = _4D0D6T3D;
