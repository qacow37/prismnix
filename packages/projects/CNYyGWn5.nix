...
let
    ...
    in {
        ...
        "pkg-5.0.2_1.19.3" = _KXeJGo2q;
        "pkg-5.0.1_1.19.2" = _zUbUlUjV;
        "pkg-5.0.1-1.18.2" = _B3UIW8eK;
        "pkg-5.0.1-1.19.3" = _L0jqD8OU;
        "pkg-5.0.1-1.19.2" = _e4GzePcU;
        "pkg-5.0.3_1.19.3" = _oR7uIP57;
        "pkg-5.0.3_1.19.2" = _mT2gO7uS;
        "pkg-5.0.3-1.18.2" = _NLVmtWA2;
        "pkg-6.0.0.47" = _trBPJLzl;
        "pkg-6.0.0.60" = _f003FE46;
        "pkg-6.0.0.61" = _CQvqO47g;
        "pkg-6.1.0.64" = _bvDJBykb;
        "pkg-6.0.1.70" = _tK4TOpc0;
        "pkg-6.2.0.66" = _MTM5qVEy;
        "pkg-7.0.71" = _Lxmmz9QR;
        "pkg-7.0.72" = _mjRHu0JL;
        "pkg-6.0.1.64" = _iaFSn2o9;
        "pkg-8.0.74" = _MtIWTZQM;
        "pkg-8.0.75" = _qePaOrBM;
        "pkg-7.0.78" = _MDIXlpCW;
        "pkg-7.1.82" = _jvDkoE6c;
        "pkg-7.1.84" = _uZpYTAej;
        "pkg-8.2.86" = _Fvlf2ymb;
        "pkg-8.2.91" = _8UJ7mgqS;
        "pkg-8.2.93" = _wMSuHvCW;
        "pkg-21.11.104" = _oCLlTEwo;
        "pkg-21.11.106" = _VvvGk9gH;
        "pkg-26.1.2.108" = _pUXRGjxY;
        "pkg-26.1.5+fabric-26.1.2" = _1sQFiRlY;
        "pkg-26.1.5+forge-26.1.2" = _KeEtT68k;
        "pkg-26.1.5+neoforge-26.1.2" = _NdgSIYQv;
        "pkg-26.1.6+forge-26.1.2" = _fn15MQQq;
        "pkg-26.1.6+neoforge-26.1.2" = _5VTTt0n5;
        "pkg-26.1.6+fabric-26.1.2" = _3v0xejjb;
        "pkg-26.1.7+fabric-26.1.2" = _4NDVJfLK;
        "pkg-26.1.7+forge-26.1.2" = _sGWlvvW2;
        "pkg-26.1.7+neoforge-26.1.2" = _3J7CqC2U;
        "pkg-26.1.8+neoforge-26.2" = _bjapJVj3;
        "pkg-26.1.8+fabric-26.2" = _IFsBQSRC;
        "pkg-26.1.9+fabric-26.2" = _QQnLwJc6;
        "pkg-26.1.9+neoforge-26.2" = _ArHyggbE;
        "pkg-26.1.10+fabric-26.1.2" = _NVk8BtrP;
        "pkg-26.1.10+forge-26.1.2" = _NggGbF9M;
        "pkg-26.1.10+neoforge-26.1.2" = _jMh2h4do;
        "pkg-21.11.13+fabric-1.21.11" = _n0J2pVWy;
        "pkg-21.11.13+forge-1.21.11" = _T8I2BHYB;
        "pkg-21.11.13+neoforge-1.21.11" = _PJ0Pqshz;
        "pkg-26.2.14+neoforge-26.2" = _gD45P4yr;
        "pkg-26.2.14+fabric-26.2" = _VaH31uEA;
        "pkg-26.2.15+neoforge-26.2" = _nIOL2PLd;
        "pkg-26.2.15+fabric-26.2" = _mehMI8pF;
        "pkg-26.1.16+fabric-26.1.2" = _t9oMvYdv;
        "pkg-26.1.16+forge-26.1.2" = _tpqjh8XB;
        "pkg-26.1.16+neoforge-26.1.2" = _Ry1MMuwp;
        "default" = _Ry1MMuwp;
    });
