...
let
    ...
    in {
        ...
        "pkg-1.1.0+mc1.20.1" = _7zWyAJZv;
        "pkg-1.1.1+mc1.20.1" = _SkiZz7s4;
        "pkg-1.1.2+mc1.20.1" = _aGgJChiF;
        "pkg-1.1.2+mc1.21.1" = _pPc1KxEA;
        "pkg-1.1.3+mc1.20.1" = _VtTcJc3g;
        "pkg-1.1.3+mc1.21.1" = _8u2tkdZ3;
        "pkg-1.1.4+mc1.20.1" = _wvJxGHsx;
        "pkg-1.1.4+mc1.21.1" = _9onx6pe8;
        "pkg-1.1.5+mc1.20.1" = _jRm6NGJX;
        "pkg-1.1.5+mc1.21.1" = _YYjkxsQE;
        "pkg-1.2.0+mc1.20.1" = _FrBY0e5K;
        "pkg-1.2.0+mc1.21.1" = _4PU1XkM0;
        "pkg-1.2.1+mc1.21.1" = _bgS31Bjx;
        "pkg-1.2.2+mc1.21.1" = _6sDft9Q7;
        "pkg-1.2.3+mc1.20.1" = _eoc4DxWG;
        "pkg-1.2.3+mc1.21.1" = _PbewApgs;
        "pkg-1.2.4+mc1.20.1" = _Bryvfj9z;
        "pkg-1.2.4+mc1.21.1" = _2DsbQTZg;
        "pkg-1.2.5+mc1.20.1" = _snFnLaLJ;
        "pkg-1.2.5+mc1.21.1" = _zFZlaBKL;
        "pkg-1.2.6+mc1.20.1" = _76MDKrby;
        "pkg-1.2.6+mc1.21.1" = _1AtiIyw7;
        "pkg-1.2.7+mc1.20.1" = _icUP9BMe;
        "pkg-1.2.7+mc1.21.1" = _rHNb5cLT;
        "pkg-1.2.8+mc1.20.1" = _81EAWr4e;
        "pkg-1.2.8+mc1.21.1" = _MMeLDd2d;
        "pkg-1.2.9+mc1.21.1" = _WWbs0OgJ;
        "pkg-1.2.10+mc1.20.1" = _SqeBo51p;
        "pkg-1.2.10+mc1.21.1" = _A7fZMYDm;
        "pkg-1.2.11+mc1.20.1" = _8JYTo0fW;
        "pkg-1.2.11+mc1.21.1" = _qTCFoIr9;
        "pkg-1.2.12+mc1.21.1" = _cntMriMR;
        "pkg-1.3.0+mc1.20.1" = _L2tlTdJI;
        "pkg-1.3.0+mc1.21.1" = _MdMMmVkj;
        "pkg-1.3.1+mc1.21.1" = _TEtWGAxC;
        "pkg-1.3.2+mc1.21.1" = _h6qIzmIx;
        "default" = _h6qIzmIx;
    });
