...
let
    ...
    in {
        ...
        "pkg-2.0.0" = _dYlsBME2;
        "pkg-2.1.0+1.18" = _ffwvZnJ2;
        "pkg-2.1.0+1.17" = _fZyzUSdK;
        "pkg-2.1.0+1.16" = _8TsSYo1O;
        "pkg-2.2.0" = _2OcMrFH7;
        "pkg-3.0.0" = _VRLlE4j7;
        "pkg-3.1.0" = _w249CMfp;
        "pkg-4.0.0" = _s7bVM6wi;
        ...
        "pkg-6.0.0" = _kHOHwnYe;
        "pkg-6.1.0" = _rAzISn2Q;
        "pkg-7.0.0+1.20" = _kqQ5j4Wj;
        "pkg-7.0.1+1.20" = _TyXRb1be;
        "pkg-6.1.1+1.19.4" = _zKpvqQ0C;
        "pkg-7.0.2+1.20" = _RiTU8rGC;
        "pkg-8.0.0+1.20.2" = _bONvp1zp;
        "pkg-8.0.0+1.20.4" = _HhWVxCH0;
        "pkg-8.0.0+1.20.5" = _KYWLxVNO;
        "pkg-8.0.0+1.21" = _WrVFwS4j;
        "pkg-8.0.0+1.21.3" = _P5KdF8uU;
        "pkg-8.0.0+1.21.4" = _TaEUeoLe;
        "pkg-v9.0.0+1.21.1" = _Aw5cSPET;
        "pkg-v9.0.1+1.21.1" = _NinhKHNO;
        "pkg-v9.0.1+1.21.3" = _3FHqBDEc;
        "pkg-v9.0.1+1.21.4" = _1jWoapyO;
        "pkg-v9.0.1+1.21.5" = _h1B6bAD8;
        "pkg-v9.0.1+1.21.6" = _hn7DSJGB;
        "pkg-v9.0.1+1.21.7" = _UyvjxOPw;
        "pkg-v9.0.1+1.21.9" = _LM6s11PI;
        "pkg-v9.1.0+1.21.11" = _E5rCr6gU;
