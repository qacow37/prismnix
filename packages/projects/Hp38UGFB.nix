...
let
    ...
    in {
        ...
        "pkg-2.5.0" = _RkIJv2v5;
        "pkg-3.0.0" = _gGIdmL64;
        "pkg-3.0.2+1.18.2" = _Y3j4D2JA;
        "pkg-3.0.3+1.18.2" = _hZaVsnbb;
        "pkg-3.1.0+1.18.2" = _ctCcevFP;
        "pkg-3.2.0+1.18.2" = _DSCHXLh4;
        "pkg-3.2.1+1.18.2" = _1DburLdB;
        "pkg-3.2.2+1.18.2" = _dAtE5eOZ;
        "pkg-3.2.3+1.18.2" = _n3TwOYiH;
        "pkg-3.2.4+1.18.2" = _YKlLSQFH;
        "pkg-3.2.5+1.18.2" = _He1lyNLm;
        "pkg-4.0.0+1.19" = _16zYmmRk;
        "pkg-4.0.1+1.19" = _iAInqCRK;
        "pkg-4.0.2+1.19" = _ZoTwWkph;
        "pkg-4.1.0+1.19" = _tmcq0bfm;
        "pkg-4.3.0+1.19" = _ITrEmhT3;
        "pkg-5.0.0+1.19" = _mHGmdYEx;
        "pkg-5.0.0+1.19.4" = _1tA76sne;
        "pkg-5.0.0+1.20.1" = _83TMyorw;
        "pkg-5.0.1+1.19" = _jmfEtvx4;
        "pkg-5.0.1+1.19.4" = _q951cH9V;
        "pkg-5.0.1+1.20.1" = _S7ixtNLR;
        "pkg-5.0.2+1.20.1" = _HQc51Reg;
        "pkg-5.0.3+1.20.1" = _UCkFdkaG;
        "pkg-5.0.4+1.20.1" = _jEsrQBlv;
        "default" = _jEsrQBlv;
    });
