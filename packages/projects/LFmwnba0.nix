...
let
    ...
    in {
        ...
        "pkg-13.9" = _6Bktu9M2;
        "pkg-14" = _BlnA9863;
        "pkg-1.21.11-14.3+v260225" = _eGbLHM61;
        "pkg-1.21.11-14.5+v260228" = _s4k9vMhN;
        "pkg-1.21.11-14.6+v260307" = _V8Rv1RII;
        "pkg-12.2.1" = _xbjPlUoi;
        "pkg-11.2" = _BGlli0sD;
        "pkg-1.21.11-14.6+v260308" = _LlcTrJfp;
        "pkg-1.21.11-14.9+v260308" = _fHVdHDfV;
        "pkg-1.21.11-14.9+v260317" = _RKWeEvdd;
        "pkg-1.21.11-15.1+v260318" = _9SHkZnL6;
        "pkg-1.21.11-15.2+v260318" = _VMTbjcRE;
        "pkg-1.21.11-15.3+v260322" = _tYmAjZzk;
        "pkg-1.21.11-15.4+v260324" = _LxUbt2sp;
        "pkg-1.21.11-15.5+v260324" = _XGRF4J8P;
        "pkg-1.21.11-15.6+v260324" = _VAnEEIBu;
