...
let
    ...
    in {
        ...
        "pkg-1.12.2-1.0.10.38" = _V1aHxTtv;
        "pkg-1.16.5-2.0.5.27" = _KD0OgaVp;
        "pkg-1.18.2-3.1.6.31" = _qh8qOOk5;
        "pkg-1.19.2-3.2.5.20" = _l6F90xpn;
        "pkg-1.20.1-3.4.2.9" = _VgUbhk1E;
        "pkg-1.12.2-1.0.10.39" = _vVRlg6W4;
        "pkg-1.16.5-2.0.5.28" = _qtxHOsLG;
        "pkg-1.18.2-3.1.6.32" = _e3SmQMRY;
        "pkg-1.19.2-3.2.5.21" = _sBmdst4t;
        "pkg-1.20.1-3.4.2.10" = _9rxr3ygC;
        "pkg-1.12.2-1.0.11.40" = _JHSm24OL;
        "pkg-1.16.5-2.0.6.29" = _cEhcGAjX;
        "pkg-1.18.2-3.1.7.33" = _BfqXRZ1g;
        "pkg-1.19.2-3.2.6.22" = _ajUR5Mrj;
        "pkg-1.20.1-3.4.3.11" = _XQfXfipy;
        "pkg-1.12.2-1.0.11.41" = _Nl3pHRAG;
        "pkg-1.16.5-2.0.6.30" = _HpOl6uXN;
        "pkg-1.18.2-3.1.7.34" = _J3pUKWiL;
        "pkg-1.19.2-3.2.6.23" = _CV1FjDUw;
        "pkg-1.20.1-3.4.3.12" = _Ak7T5jnN;
        "pkg-1.20.4-4.a.0.0" = _daPJzSYs;
        "pkg-1.18.2-3.1.7.35" = _ETigH7El;
        "pkg-1.19.2-3.2.6.24" = _5Kqa5UXL;
        "pkg-1.20.1-3.4.3.13" = _I5kxwAKU;
        "pkg-1.20.4-4.a.0.1" = _nVFCIFcU;
        "pkg-1.12.2-1.0.12.42" = _qLmpy4lI;
        "pkg-1.16.5-2.0.7.31" = _aPTJ8TYv;
        "pkg-1.18.2-3.1.8.36" = _OMCp832x;
        "pkg-1.19.2-3.2.7.25" = _wUr866Iu;
        "pkg-1.20.1-3.4.4.14" = _hEmXQrmZ;
        "pkg-1.20.4-4.a.0.2" = _gBK9F49c;
        "pkg-1.18.2-3.1.8.37" = _UwdqbapH;
        "pkg-1.19.2-3.2.7.26" = _qXjlMGWa;
        "pkg-1.20.1-3.4.4.15" = _Ez8ApqBs;
        "pkg-1.20.4-4.a.0.3" = _zqEe2g0p;
        "pkg-1.12.2-1.0.12.43" = _S4InyILx;
        "pkg-1.16.5-2.0.7.32" = _8KU1dKzv;
        "pkg-1.18.2-3.1.8.38" = _pGcHTFFX;
        "pkg-1.19.2-3.2.7.27" = _ArjDSHT0;
        "pkg-1.20.1-3.4.4.16" = _cuwDzAEv;
        "pkg-1.20.4-4.a.0.4" = _UE5sUSrn;
        "pkg-1.12.2-1.0.12.44" = _zhjTzO1L;
        "pkg-1.16.5-2.0.7.33" = _9tmIWbsl;
        "pkg-1.18.2-3.1.8.39" = _AHbEA19I;
        "pkg-1.19.2-3.2.8.28" = _xFhm27KN;
        "pkg-1.20.1-3.4.5.17" = _6kQ8Wd6O;
        "pkg-1.20.4-4.a.0.5" = _pHjoHMI5;
        "pkg-1.12.2-1.0.12.45" = _Bx678U17;
        "pkg-1.16.5-2.0.7.34" = _jvcRvHoA;
        "pkg-1.18.2-3.1.8.40" = _XhJjspXD;
        "pkg-1.19.2-3.2.8.29" = _5CX7bqru;
        "pkg-1.20.1-3.4.5.18" = _b0R93iG5;
        "pkg-1.20.4-4.a.0.6" = _g8t9zU3A;
        "pkg-1.12.2-1.0.12.46" = _VzVyRW6W;
        "pkg-1.12.2-1.0.13.47" = _8S9xEgyC;
        "pkg-1.16.5-2.0.8.35" = _5PNMF56j;
        "pkg-1.18.2-3.1.9.41" = _qgoxbSwE;
        "pkg-1.19.2-3.2.9.30" = _nQGVwIVN;
        "pkg-1.20.1-3.4.6.19" = _GVATGbuS;
        "pkg-1.20.4-4.a.0.7" = _8QpC2hkv;
        "pkg-1.12.2-1.0.13.48" = _gCfW4Wjp;
        "pkg-1.16.5-2.0.8.36" = _ZCmfDDCw;
        "pkg-1.18.2-3.1.9.42" = _fbJYwERS;
        "pkg-1.19.2-3.2.9.31" = _VHj8zl0o;
        "pkg-1.20.1-3.4.6.20" = _3GBYveHM;
        "pkg-1.20.4-4.a.0.8" = _tBYcJtjE;
        "pkg-1.12.2-1.0.13.49" = _6GxKWgzw;
        "pkg-1.18.2-3.1.9.43" = _N02z7Dl5;
        "pkg-1.19.2-3.2.9.32" = _slvcLENH;
        "pkg-1.20.1-3.4.6.21" = _IzYqISaH;
        "pkg-1.20.4-4.a.0.9" = _nJBYowYn;
        "pkg-1.16.5-2.0.8.37" = _Jtx5ybR9;
        "pkg-1.12.2-1.0.13.50" = _97sbLzkB;
        "pkg-1.16.5-2.0.8.38" = _XqQjPADq;
        "pkg-1.18.2-3.1.9.44" = _U7WjFtSB;
        "pkg-1.19.2-3.2.9.33" = _PeDv7Xzu;
        "pkg-1.20.1-3.4.6.22" = _QEfiNF1B;
        "pkg-1.20.4-4.a.0.10" = _rUT6QRL2;
        "pkg-1.12.2-1.0.13.51" = _PY6GuPDd;
        "pkg-1.12.2-1.0.14.52" = _ebmAfsgj;
        "pkg-1.16.5-2.0.9.39" = _QcyASRaX;
        "pkg-1.18.2-3.1.10.45" = _aREfjSAx;
        "pkg-1.19.2-3.2.10.34" = _LZHIicdU;
        "pkg-1.20.1-3.4.7.23" = _Lc0Xyhqm;
        "pkg-1.20.4-4.0.a.11" = _tiG4jdvD;
        "pkg-1.21-4.0.b.0" = _4m9M2gFA;
        "pkg-1.16.5-2.0.9.40" = _ZsgcGHYM;
        "pkg-1.18.2-3.1.10.46" = _PReLatEU;
        "pkg-1.19.2-3.2.10.35" = _krVk3K9F;
        "pkg-1.20.1-3.4.7.24" = _Z8HwM734;
        "pkg-1.20.4-4.0.a.12" = _sHdIcZjz;
        "pkg-1.21-4.0.b.1" = _Pg07oFtM;
        "pkg-1.21-4.0.b.2" = _uHSg2bQE;
        "pkg-1.12.2-1.0.14.53" = _eR03sWBG;
        "pkg-1.16.5-2.0.9.41" = _ESU6Ek76;
        "pkg-1.18.2-3.1.10.47" = _fpLcae7X;
        "pkg-1.19.2-3.2.10.36" = _wDGPc4PK;
        "pkg-1.20.1-3.4.7.25" = _csordqbc;
        "pkg-1.20.4-4.0.a.13" = _znZ1EnZU;
        "pkg-1.21-4.0.0.0" = _Sahlrdpm;
        "pkg-1.12.2-1.0.14.54" = _4ffMrjaz;
        "pkg-1.12.2-1.0.14.55" = _elrLWM6m;
        "pkg-1.16.5-2.0.9.42" = _6ayZ8aWC;
        "pkg-1.18.2-3.1.11.48" = _Xjtr9T9h;
        "pkg-1.19.2-3.2.11.37" = _8VnHHnXL;
        "pkg-1.20.1-3.4.8.26" = _8ZiQr0qQ;
        "pkg-1.21.1-4.0.1.1" = _rqfMOKb8;
        "pkg-1.12.2-1.0.15.56" = _2OOxrhT6;
        "pkg-1.16.5-2.0.9.43" = _SNYoHBhK;
        "pkg-1.18.2-3.1.12.49" = _yS5oI0Bf;
        "pkg-1.19.2-3.2.12.38" = _mYnjIo93;
        "pkg-1.20.1-3.4.9.27" = _gojxQz8j;
        "pkg-1.21.1-4.0.2.2" = _7YU2SApe;
        "pkg-1.21.1-4.0.2.3" = _PmwTc5XK;
        "pkg-1.12.2-1.0.15.57" = _Dy8izQog;
        "pkg-1.18.2-3.1.12.50" = _2B9jbwnD;
        "pkg-1.19.2-3.2.12.39" = _wIG8i0aM;
        "pkg-1.20.1-3.4.9.28" = _kJTOHH1K;
        "pkg-1.12.2-1.0.15.58" = _zTZPDyv1;
        "pkg-1.16.5-2.0.9.44" = _eEy3kJMN;
        "pkg-1.18.2-3.1.12.51" = _zDhN0qFp;
        "pkg-1.19.2-3.2.12.40" = _4Bn8nTMG;
        "pkg-1.20.1-3.4.9.29" = _TFRxBLMB;
        "pkg-1.21.1-4.0.2.4" = _JXYONrBB;
        "pkg-1.12.2-1.0.16.59" = _UeQ9ZOHY;
        "pkg-1.16.5-2.0.10.45" = _IWQDPehc;
        "pkg-1.18.2-3.1.13.52" = _xKEuTdTt;
        "pkg-1.19.2-3.2.13.41" = _Lmeb1I26;
        "pkg-1.20.1-3.4.10.30" = _dSXOMMO3;
        "pkg-1.21.1-4.0.3.5" = _Y3yzwftS;
        "pkg-1.12.2-1.0.17.60" = _Mga8emUi;
        "pkg-1.16.5-2.0.11.46" = _1T5qC2m8;
        "pkg-1.18.2-3.1.14.53" = _G2ohxRa0;
        "pkg-1.19.2-3.2.14.42" = _UDrztP3U;
        "pkg-1.20.1-3.4.11.31" = _EkhKbwcB;
        "pkg-1.21.1-4.0.4.6" = _zO2BGGwd;
        "pkg-1.16.5-2.0.11.47" = _R0TSvfdO;
        "pkg-1.20.1-3.4.11.32" = _rXMIT0I9;
        "pkg-1.21.1-4.0.4.7" = _qNoNq9ws;
        "pkg-1.12.2-1.0.17.61" = _gp1mb0Ez;
        "pkg-1.16.5-2.0.11.48" = _3IhdU98O;
        "pkg-1.18.2-3.1.14.54" = _NDwGJ9hk;
        "pkg-1.19.2-3.2.14.43" = _ogmLDCDh;
        "pkg-1.20.1-3.4.11.33" = _a9GjWSjJ;
        "pkg-1.21.1-4.0.4.8" = _MxyLcWzW;
        "pkg-1.12.2-1.0.17.62" = _u9JIaRBB;
        "pkg-1.16.5-2.0.11.49" = _A1lScDIj;
        "pkg-1.18.2-3.1.14.55" = _7a51P8PJ;
        "pkg-1.19.2-3.2.14.44" = _P00R0ZXg;
        "pkg-1.20.1-3.4.11.34" = _NEf3QEnf;
        "pkg-1.21.1-4.0.4.9" = _RjyDnuaK;
        "pkg-1.18.2-3.1.14.56" = _fwaGk5j2;
        "pkg-1.19.2-3.2.14.45" = _j8SMtkcQ;
        "pkg-1.20.1-3.4.11.35" = _RW6dnyBP;
        "pkg-1.21.1-4.0.4.10" = _rCBWBzUH;
        "pkg-1.16.5-2.0.12.50" = _l7dBMfX5;
        "pkg-1.12.2-1.0.18.63" = _zHShWyEH;
        "pkg-1.16.5-2.0.12.51" = _RiJKPRWg;
        "pkg-1.12.2-1.0.18.64" = _kpfeTaaJ;
        "pkg-1.16.5-2.0.12.52" = _QFCNivVL;
        "pkg-1.18.2-3.1.14.58" = _XpOq0diE;
        "pkg-1.19.2-3.2.14.47" = _zz6SZ5NT;
        "pkg-1.20.1-3.4.11.37" = _Xk27xIAW;
        "pkg-1.21.1-4.0.4.12" = _LyOjOlxk;
        "pkg-1.12.2-1.0.19.65" = _V0sMvqvu;
        "pkg-1.16.5-2.0.13.53" = _AVdCsKho;
        "pkg-1.18.2-3.1.15.59" = _L2f8RZje;
        "pkg-1.19.2-3.2.15.48" = _nyudL42N;
        "pkg-1.20.1-3.4.12.38" = _1lHo5OKp;
        "pkg-1.21.1-4.0.5.13" = _md77h68A;
        "pkg-1.12.2-1.0.19.66" = _SRWYCMO9;
        "pkg-1.16.5-2.0.13.54" = _O0nZejeX;
        "pkg-1.18.2-3.1.15.60" = _BKPe0760;
        "pkg-1.19.2-3.2.15.49" = _ykcXq2Be;
        "pkg-1.20.1-3.4.12.39" = _Pze0MHjQ;
        "pkg-1.21.1-4.0.5.14" = _MMi93AyC;
        "pkg-1.16.5-2.0.13.55" = _HNDZP9VW;
        "pkg-1.18.2-3.1.15.61" = _lOcv1j4t;
        "pkg-1.19.2-3.2.15.50" = _bKXSODwa;
        "pkg-1.20.1-3.4.12.40" = _18LYe7e6;
        "pkg-1.21.1-4.0.5.15" = _exPgk4Rq;
        "pkg-1.16.5-2.0.13.56" = _rwtrDBDh;
        "pkg-1.12.2-1.0.20.67" = _HAwFSSrX;
        "pkg-1.12.2-1.0.21.68" = _mErqMTaA;
        "pkg-1.16.5-2.0.14.57" = _Ppimxina;
        "pkg-1.18.2-3.1.16.62" = _T2jmjcSA;
        "pkg-1.19.2-3.2.16.51" = _goRzmcoE;
        "pkg-1.20.1-3.4.13.41" = _BqaVjEIJ;
        "pkg-1.21.1-4.0.6.16" = _HsGsn5wU;
        "pkg-1.12.2-1.0.22.69" = _PkAfitGW;
        "pkg-1.18.2-3.1.16.63" = _e03PVkHk;
        "pkg-1.19.2-3.2.16.52" = _thmzIR4J;
        "pkg-1.20.1-3.4.13.42" = _F0JL6ZNs;
        "pkg-1.21.1-4.0.6.17" = _66HviaJl;
        "pkg-1.12.2-1.0.23.70" = _HPRUTVF2;
        "pkg-1.16.5-2.0.15.58" = _naoh3Ggj;
        "pkg-1.18.2-3.1.17.64" = _MkEzia0u;
        "pkg-1.19.2-3.2.17.53" = _pZjSew3A;
        "pkg-1.20.1-3.4.14.43" = _zQYjUOzt;
        "pkg-1.21.1-4.0.7.18" = _ykFlyCo3;
        "pkg-1.12.2-1.0.23.71" = _PyDI9lMM;
        "pkg-1.16.5-2.0.15.59" = _N9PckAVt;
        "pkg-1.18.2-3.1.17.65" = _quIChrzV;
        "pkg-1.19.2-3.2.17.54" = _XRNL0F8I;
        "pkg-1.20.1-3.4.14.44" = _bNR0pASi;
        "pkg-1.21.1-4.0.7.19" = _zW8Iw5AR;
        "pkg-1.12.2-1.0.23.72" = _9BUYeGg8;
        "pkg-1.16.5-2.0.15.60" = _jHp6toWz;
        "pkg-1.18.2-3.1.17.66" = _JgLVWVPA;
        "pkg-1.19.2-3.2.17.55" = _ADvKMc2J;
        "pkg-1.20.1-3.4.14.45" = _sw4rNQv2;
        "pkg-1.21.1-4.0.7.20" = _UnIygbfA;
        "pkg-1.12.2-1.0.24.73" = _rrNfoM4Z;
        "pkg-1.16.5-2.0.16.61" = _ZU1Tsrn0;
        "pkg-1.18.2-3.1.18.67" = _tbfARSKU;
        "pkg-1.19.2-3.2.18.56" = _SXYYeEjX;
        "pkg-1.20.1-3.4.15.46" = _JlONTeuu;
        "pkg-1.21.1-4.0.8.21" = _ErYy5Im9;
        "default" = _ErYy5Im9;
    });
