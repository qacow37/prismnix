...
let
    ...
    in {
        ...
        "pkg-v20.4.0-1.20.4-NeoForge" = _tocwAHlJ;
        "pkg-v21.1.0-1.21.1-Fabric" = _9jG1yq5w;
        "pkg-v21.1.0-1.21.1-NeoForge" = _MDQFFZ5Z;
        "pkg-v21.3.0-1.21.3-Fabric" = _TQC2TLof;
        "pkg-v21.3.0-1.21.3-NeoForge" = _NJ2VCBeK;
        "pkg-v21.4.0-1.21.4-Fabric" = _5rjgOjCE;
        "pkg-v21.4.0-1.21.4-NeoForge" = _sbmFFQEy;
        "pkg-v21.5.0-1.21.5-Fabric" = _2Vc9MsQw;
        "pkg-v21.5.0-1.21.5-NeoForge" = _3iMEm1hf;
        "pkg-v21.8.0-1.21.8-Fabric" = _XgD5dRKd;
        "pkg-v21.8.0-1.21.8-NeoForge" = _jRSf0Ukl;
        "pkg-v21.1.1-1.21.1-Fabric" = _WOvCaRRO;
        "pkg-v21.1.1-1.21.1-NeoForge" = _OYv2KbjN;
        "pkg-21.11.0" = _1LH9fDhE;
        "pkg-v21.4.1-1.21.4-Fabric" = _h0iVBoif;
        "pkg-v21.4.1-1.21.4-NeoForge" = _CaUj65RW;
        "pkg-26.1.0" = _eXjAXmp5;
        "pkg-v20.1.0-1.20.1-Fabric" = _kN43e3H6;
        "pkg-v20.1.0-1.20.1-Forge" = _HSOzUZb0;
        "pkg-v21.1.2-1.21.1-Fabric" = _edLa7tJj;
        "pkg-v21.1.2-1.21.1-NeoForge" = _hX5hYT5c;
        "pkg-21.11.1" = _5zJKhkHi;
        "pkg-26.1.1" = _vfddQ26J;
        "pkg-v20.1.1-1.20.1-Fabric" = _6yTHvCv9;
        "pkg-v20.1.1-1.20.1-Forge" = _IMo3JqE9;
        "pkg-v20.4.1-1.20.4-Fabric" = _u9lufKqf;
        "pkg-v20.4.1-1.20.4-Forge" = _tUq1oX7a;
