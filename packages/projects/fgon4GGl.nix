...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _wCldsGi4;
        "pkg-1.0.0+mod" = _MUTiZADR;
        "pkg-1.0.1" = _drcOtDaw;
        "pkg-1.0.1+mod" = _12VoObMV;
        "pkg-1.0.3" = _2afqxycF;
        "pkg-1.0.3+mod" = _q5ako09F;
        "pkg-1.0.4" = _MF81EfMX;
        "pkg-1.0.4+mod" = _7OccdOHz;
        "pkg-1.0.5" = _cWP2XbHR;
        "pkg-1.0.5+mod" = _ez161CNc;
        "pkg-1.0.5.1" = _4PPxS7if;
        "pkg-1.0.5.1+mod" = _4tFvwTMu;
        "pkg-1.0.6" = _wQwSk17j;
        "pkg-1.0.6+mod" = _Ta7pPXxB;
        "pkg-1.0.7" = _4NzcRfEx;
        "pkg-1.0.7+mod" = _rnScm8yi;
        "pkg-1.0.8" = _Be5pPoOP;
        "pkg-1.0.8+mod" = _NmTvWtFY;
        "pkg-1.1.0" = _rl3w5u6y;
        "pkg-1.1.0+mod" = _R2mI8se8;
        "pkg-1.1.0.1" = _eGNErYEk;
        "pkg-1.1.0.1+mod" = _HuonODdU;
        "pkg-1.1.0.2" = _lJvxHPQa;
        "pkg-1.1.0.2+mod" = _jsfY9Tv4;
        "pkg-1.1.1.0" = _nNvAigK8;
        "pkg-1.1.1.0+mod" = _SlLZ9hv4;
        "default" = _SlLZ9hv4;
    });
