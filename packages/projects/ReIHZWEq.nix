...
let
    ...
    in {
        ...
        "pkg-0.1.0-beta.1" = _EVdvbji5;
        "pkg-0.1.0-beta.2" = _Dl2rJp4y;
        "pkg-0.1.0" = _2LUJieMD;
        "pkg-0.1.1" = _WdtnMWXK;
        "pkg-0.1.2" = _76qarcE8;
        "pkg-0.1.3" = _cxA90c9Q;
        "pkg-0.1.4" = _rI0VBjug;
        "pkg-1.0.0-alpha.1+1.21.4" = _av3dMUHb;
        "pkg-1.0.0-alpha.2+1.21.4" = _1syawRrg;
        "pkg-1.0.0-alpha.2+1.21.2" = _zVFkkTo4;
        "pkg-1.0.0-alpha.2+1.21" = _CudvUOFY;
        "pkg-1.0.0-alpha.3+1.21.4" = _uy8DbVY8;
        "pkg-1.0.0-alpha.3+1.21.2" = _uZoTRYnx;
        "pkg-1.0.0-alpha.3+1.21" = _a7tzyVSq;
        "pkg-1.0.0-alpha.4+1.21.4" = _AKjqiA0F;
        "pkg-1.0.0-alpha.4+1.21" = _2xtob6QI;
        "pkg-1.0.0-alpha.4+1.21.2" = _3rGqffm4;
        "pkg-1.0.0-alpha.5+1.21.2" = _qU0XN9mZ;
        "pkg-1.0.0-alpha.5+1.21" = _nK9lkNOD;
        "pkg-1.0.0-alpha.5+1.21.4" = _LdV1C1V0;
        "pkg-1.0.0-alpha.6+1.21" = _LN7frPPW;
        "pkg-1.0.0-alpha.6+1.21.4" = _uojuusDR;
        "pkg-1.0.0-alpha.6+1.21.2" = _wRBwKRoc;
        "pkg-1.0.0-alpha.7+1.21.4" = _5sOOqg1C;
        "pkg-1.0.0-alpha.7+1.21.2" = _zFe0z1GU;
        "pkg-1.0.0-alpha.7+1.21" = _d0NShpGQ;
        "pkg-1.0.0+1.21.4" = _WyBQMX3t;
        "pkg-1.0.0+1.21.2" = _WEuBPKsL;
        "pkg-1.0.0+1.21" = _ANGIpStm;
        "pkg-1.0.1+1.21.2" = _Wz5HdAT8;
        "pkg-1.0.1+1.21.5" = _nDpdD2zL;
        "pkg-1.0.1+1.21.4" = _kQ95p9NT;
        "pkg-1.0.1+1.21" = _BOaV3Lqh;
        "pkg-1.0.2+1.21.4" = _okH845Ft;
        "pkg-1.0.2+1.21.5" = _OX2J79BL;
        "pkg-1.0.2+1.21.2" = _9unAdAL9;
        "pkg-1.0.2+1.21" = _VPCEKY2T;
        "pkg-1.0.2+1.21.9" = _t6mMTlrs;
        "default" = _t6mMTlrs;
    });
