...
let
    ...
    in {
        ...
        "pkg-1.8.0" = _UkZr1bC7;
        "pkg-1.9.0" = _PCUdThwq;
        "pkg-1.10.0" = _BflOgVQ4;
        "pkg-1.11.0" = _43mhxHJF;
        "pkg-1.12.0" = _v0EVDVXU;
        "pkg-1.13.0" = _9xS7D9YJ;
        "pkg-1.14.0" = _DWamUihV;
        "pkg-1.15.0" = _Lrb8X7g9;
        "pkg-1.16.0" = _uvcK797g;
        "pkg-1.17.0" = _IEzWjYDF;
        "pkg-1.18.0-paper-test" = _ptRRMda2;
        "default" = _ptRRMda2;
    });
