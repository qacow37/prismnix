...
let
    ...
    in {
        ...
        "pkg-2.0.0-BETA-01" = _EJzrJVDi;
        "pkg-2.0.0-BETA-02" = _8yEFNPRc;
        "pkg-UltimateTeams-2.0.0-BETA-03.jar" = _D7rp64WC;
        "pkg-2.0.0-BETA-05" = _59FGYvAV;
        "pkg-2.0.0" = _oOeOgOEc;
        "pkg-2.0.1" = _GDVMEVhl;
        "pkg-2.0.2" = _k4lkAu7l;
        "pkg-2.0.3" = _LM3iGbBF;
        ...
        "pkg-2.4.1" = _uFK5waML;
        "pkg-2.5" = _Pye2JW7d;
        "pkg-2.6-ALPHA" = _qlBiLzzi;
        "pkg-3.0-ALPHA" = _eXnv4eiM;
        "pkg-3.1-BETA" = _ruHG8jIX;
        "pkg-3.2" = _WLMn0CsM;
        "pkg-3.2.1-ALPHA" = _18qKhIpZ;
        "pkg-3.2.1" = _kXaDQkhm;
        "pkg-3.3" = _IBZoSVPm;
        "pkg-4.0-BETA" = _g1dS2lLy;
        "pkg-4.0.1-BETA" = _eZvUezNe;
        "pkg-4.0.2-BETA" = _ddvtdlVS;
        "pkg-4.0.3-BETA" = _VBEper0r;
        "pkg-4.0.4-BETA" = _Cxlp9Ib6;
        "pkg-4.0.5-BETA" = _qhwejKRc;
        "pkg-4.0.6-BETA" = _URXWMhSO;
        "pkg-4.1.0" = _KhrGvB7o;
        "pkg-4.2" = _q494Jlu9;
        "pkg-4.2.1" = _bkGdD3QV;
        "pkg-4.3" = _WGdIIiNK;
