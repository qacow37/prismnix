...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _YjJbl1X4;
        "pkg-1.1.0" = _nLNh4vdy;
        "pkg-1.2.0-fabric" = _kasftb87;
        "pkg-1.2.0-neoforge" = _i0Jbq8Fx;
        "pkg-1.2.0-quilt" = _KWumZ2eO;
        "pkg-1.3.0-neoforge" = _M1iOMU7U;
        "pkg-1.3.0-fabric" = _tXpFXcVH;
        "pkg-1.3.0-quilt" = _Gu6TmX3o;
        "pkg-1.4.0-neoforge" = _uesgzLWx;
        "pkg-1.4.0-quilt" = _BtG0PMKX;
        "pkg-1.4.0-fabric" = _U7FR3NJ3;
        "pkg-1.5.0-fabric" = _b4H4sYmS;
        "pkg-1.5.0-neoforge" = _sGEzFJq4;
        "pkg-1.6.0-neoforge" = _WiPhbscN;
        "pkg-1.6.0-fabric" = _lxFsz6LV;
        "pkg-1.6.1-forge" = _FmYUlnew;
        "pkg-1.6.1-fabric" = _SRdHcAvf;
        "pkg-1.6.1-neoforge" = _jjkIVmcJ;
        "pkg-1.6.2-fabric" = _vYHEHjdi;
        "pkg-1.6.2-neoforge" = _pa54R8F4;
        "pkg-1.6.6-neoforge" = _louRNALm;
        "pkg-1.6.6-fabric" = _kqJRR8ZY;
        "pkg-1.6.6-forge" = _wQO47crV;
        "default" = _kqJRR8ZY;
    });
