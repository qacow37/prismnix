...
let
    ...
    in {
        ...
        "pkg-0.1-1.20.1" = _aNcN8x0V;
        "pkg-1.0-1.20.1" = _FMnGO3ux;
        "pkg-1.1-1.20.1" = _qsgG42vO;
        "pkg-1.2-1.20.1" = _5mnSulA7;
        "pkg-1.2.1-1.20.1" = _Q29hxhEt;
        "pkg-1.3-1.20.1" = _nYdHgwj0;
        "pkg-1.3.1-1.20.1" = _bJTTlGQp;
        "pkg-1.3.1-1.21" = _iB2XVlNG;
        "pkg-1.4-1.21" = _Q5erUc9A;
        "pkg-1.4.1-1.21" = _jujCBPpo;
        "pkg-1.4-1.20.1" = _5UUfmgNZ;
        "pkg-1.5-1.21" = _kfBSK79B;
        "pkg-1.5-1.21.5" = _O2IkjXHx;
        "pkg-1.5.1-1.21" = _U2rc0hbE;
        "pkg-1.4.1-1.20.1" = _JyzdfHBt;
        "pkg-1.5.1-1.21.5" = _1AKsvu4b;
        "pkg-1.5.1-1.21.6" = _1XzIfQpN;
        "pkg-1.5.2-1.21.6" = _6LbPZTlD;
        "pkg-1.5.2-1.21.9" = _U8AeQQue;
        "pkg-19.0.0" = _TijBhvuC;
        "pkg-19.0.1" = _etEM5ywW;
        "pkg-19.1.0" = _UJwiYMGl;
        "pkg-1.5.2-1.21" = _OOSafBRY;
        "pkg-19.1.1" = _MKTfkiAp;
        "pkg-20.1.0" = _qM4IDqMV;
        "pkg-21.1.0" = _o31sBxrX;
        "default" = _o31sBxrX;
    });
