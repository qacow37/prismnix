...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _jThmBoSK;
        "pkg-1.0.8" = _tyOcdYnF;
        "pkg-1.0.11" = _Elgqa3Sh;
        "pkg-1.0.12" = _DJdDhMJy;
        "pkg-1.0.15" = _eJojzBCW;
        "pkg-1.0.16-rc.1" = _viniVfAQ;
        "pkg-1.0.16-rc.2" = _wGw3dm7g;
        "pkg-1.0.19" = _uPBXaGuI;
        "pkg-1.0.20" = _1S3WBQ8S;
        "pkg-1.1.21-beta1" = _TFlP4hXQ;
        "pkg-1.1.21-rc1" = _ZcPo1T86;
        "pkg-1.1.21-rc2" = _EOLD9F7B;
        "pkg-1.0.21" = _1WQ9EjRb;
        "pkg-1.1.22" = _xcLyQpyC;
        "pkg-1.1.23" = _IoN0WykF;
        "pkg-1.0.22" = _1NbsuJ3W;
        "pkg-1.0.23" = _FxFLsq3p;
        "pkg-1.1.25" = _maAHpoei;
        "pkg-1.0.24" = _iaeWIcX6;
        "pkg-1.0.25" = _m4FvOWNK;
        "pkg-1.1.26" = _NhrGwh9J;
