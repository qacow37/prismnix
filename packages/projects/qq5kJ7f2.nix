...
let
    ...
    in {
        ...
        "pkg-1.21.4-1.1.0" = _YQwGLFx1;
        "pkg-1.21.1-1.1.1" = _Oe9tMvOM;
        "pkg-1.21.4-1.1.1" = _ShGQDlyu;
        "pkg-1.20.1-1.1.1" = _fKdJ0922;
        "pkg-1.20.1-1.1.2" = _tn4L47tB;
        "pkg-1.21.1-1.1.2" = _dYW03dEM;
        "pkg-1.21.4-1.1.2" = _qt0B1xnj;
        "pkg-1.20.1-1.1.2.1" = _h1X87P40;
        "pkg-1.20.1-1.1.3" = _gu1ZcJy4;
        "pkg-1.21.1-1.1.3" = _3dRoZnOF;
        "pkg-1.20.1-1.1.4" = _dpqmMXNd;
        "pkg-1.21.1-1.1.4" = _mQNxfUfw;
        "pkg-1.20.1-1.1.5" = _hA9NObQZ;
        "pkg-1.21.1-1.1.5" = _z0BVwyUT;
        "pkg-1.20.1-1.1.6" = _UeGHPHxc;
        "pkg-1.21.1-1.1.6" = _eiJNDrPl;
        "pkg-1.20.1-1.2.0" = _3a94WPpj;
