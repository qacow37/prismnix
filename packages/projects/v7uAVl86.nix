...
let
    ...
    in {
        ...
        "pkg-1.19-1.0.1" = _5VgMwIh4;
        "pkg-1.19-1.0.2" = _p2c4Devb;
        "pkg-1.19-1.0.3" = _zfTpfDrt;
        "pkg-1.19-1.0.4" = _OxSnHkMA;
        "pkg-1.19.1-1.1.0" = _Qy6zh8Qc;
        "pkg-1.19.1-1.1.1" = _verAA5Pq;
        "pkg-1.19.1-1.1.2" = _oFZrP7Py;
        "pkg-1.19.1-1.1.3" = _MUGMxfuZ;
        "pkg-1.19.1-1.1.4" = _yyZiJHSC;
        "pkg-1.19.1-1.1.5" = _GhTuAEpj;
        "pkg-1.19.2-1.2.0" = _6S5Vq7VL;
        "pkg-1.19.2-1.2.1" = _qrcr0s1g;
        "pkg-1.19.4-1.3.0" = _c6d4U6oJ;
        "pkg-1.20.1-2.0.0" = _8Ptkx20N;
        "pkg-1.20.1-2.0.1" = _pGnDrwnw;
        "pkg-1.20.1-2.0.2" = _Er6OK6br;
        "pkg-1.20.1-2.0.3" = _nIy3hiqy;
        "pkg-1.20.1-2.0.4" = _b8hSmbut;
        "pkg-1.20.1-2.0.5" = _LByMbtAP;
        "pkg-1.20.1-2.0.6" = _gzZeeOE7;
        "pkg-1.20.1-2.0.7" = _8QeGuhSQ;
        "pkg-1.20.1-2.0.8" = _WAuDF3CQ;
        "pkg-21.1.0" = _dJAGHUpa;
        "pkg-21.1.1" = _9izF4PC0;
        "pkg-21.1.2" = _7bdNoOVX;
        "pkg-21.1.3" = _atmziQQo;
        "default" = _atmziQQo;
    });
