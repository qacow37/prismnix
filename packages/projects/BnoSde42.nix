...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.18.2" = _Yavl8Jvh;
        "pkg-1.0.0-1.19.2" = _L33lC4Sc;
        "pkg-1.0.0-1.19.3" = _kMpG6jN2;
        "pkg-1.1.0-1.18.2" = _105hGj5i;
        "pkg-1.1.0-1.19.2" = _mSLsvxaH;
        "pkg-1.1.0-1.19.3" = _FKKToKPD;
        "pkg-1.1.1-1.19.2" = _VPQOoT9n;
        "pkg-1.1.1-1.19.3" = _Udv8oATS;
        "pkg-1.1.1-1.18.2" = _2uV2HNZU;
        "pkg-1.1.2-1.18.2" = _sN0JaLHS;
        "pkg-1.1.2-1.19.2" = _1Fnphlk8;
        "pkg-1.1.2-1.19.3" = _PfQuCB7t;
        "pkg-1.0.0-1.19.4" = _7pRL9Oot;
        "pkg-1.0.1-1.19.4" = _Y1CKVRSY;
        "pkg-0.1.0-1.20" = _PB6Zu4cj;
        "pkg-1.0.0-1.20" = _I4161qrL;
        "pkg-1.0.0-1.21" = _6d8WMEmA;
        "pkg-1.1-1.20" = _Jp4oZZzn;
        "pkg-1.1-1.21" = _LDRiI2xE;
        "pkg-1.2-1.21" = _GNUH4aYW;
        "pkg-1.0-1.21.2" = _9BjDInl1;
        "pkg-1.0-1.21.5" = _mVQakYNx;
        "pkg-2.2-1.21" = _ragU2iZq;
        "pkg-2.0-1.21.2" = _laKJ6dT0;
        "pkg-2.0-1.21.5" = _WlCwLwAv;
        "default" = _WlCwLwAv;
    });
