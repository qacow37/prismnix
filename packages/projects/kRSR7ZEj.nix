...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.1-fabric" = _B83Q3gSZ;
        "pkg-1.0.0+1.21.1-neoforge" = _pin3HWah;
        "pkg-1.1.0+1.21.1-neoforge" = _7ujLdjH7;
        "pkg-1.1.0+1.21.1-fabric" = _dpdfsvaz;
        "pkg-1.2.0+1.21.1-neoforge" = _r8wzIEVg;
        "pkg-1.2.0+1.21.1-fabric" = _IZaggaTB;
        "pkg-1.2.1+1.21.1-neoforge" = _GZkcpx3S;
        "pkg-1.2.1+1.21.1-fabric" = _ioTU5hVa;
        "pkg-1.2.2+1.21.1-fabric" = _LlSCh4mS;
        "pkg-1.2.2+1.21.1-neoforge" = _IdXKp9OJ;
        "pkg-1.2.3+1.21.1-fabric" = _aXboqMlJ;
        "pkg-1.2.3+1.21.1-neoforge" = _PoTdDtPg;
        "pkg-1.3.0+1.21.1-neoforge" = _nvMbjTzI;
        "pkg-1.3.0+1.21.1-fabric" = _xskmqHU7;
        "pkg-2.0.0+1.21.1-neoforge" = _lTHULB8j;
        "pkg-2.0.0+1.21.1-fabric" = _8Dr3dcOn;
        "pkg-2.0.1+1.21.1-fabric" = _dzczzoPl;
        "pkg-2.0.1+1.21.1-neoforge" = _rtmBvu3H;
        "pkg-2.0.2+1.21.1-fabric" = _qZLfjW6S;
        "pkg-2.0.2+1.21.1-neoforge" = _17KRZKqd;
        "pkg-2.0.3+1.21.1-fabric" = _o6fVG8T7;
        "pkg-2.0.3+1.21.1-neoforge" = _FeFheKQy;
        "pkg-2.0.4+1.21.1-fabric" = _53MeR0P9;
        "pkg-2.0.4+1.21.1-neoforge" = _URluJjfC;
        "pkg-2.0.5+1.21.1-fabric" = _EfnvcvdK;
        "pkg-2.0.5+1.21.1-neoforge" = _BrbO5rWH;
        "pkg-2.0.6+1.21.1-neoforge" = _uHUr01ZA;
        "pkg-2.0.6+1.21.1-fabric" = _721LCnwK;
        "pkg-2.0.7+1.21.1-fabric" = _qZbdht7D;
        "pkg-2.0.7+1.21.1-neoforge" = _sqxVq910;
        "pkg-3.0.0-alpha.1+1.21.5-fabric" = _H88QNSeL;
        "pkg-3.0.0-alpha.2+1.21.5-fabric" = _WtWXNQ2p;
        "pkg-3.0.0-alpha.3+1.21.5-fabric" = _DkD6CrYh;
        "pkg-3.0.0-alpha.4+1.21.5-fabric" = _ykVta68V;
        "pkg-3.0.0-alpha.5+1.21.5-fabric" = _FZo8E54r;
        "pkg-3.0.0-beta.1+26.1.1" = _5ioh5evs;
        "pkg-3.0.0-beta.2+26.1.1" = _U3gapnVc;
        "pkg-3.0.0-beta.3+26.1.1" = _mYBrKrTO;
        "pkg-3.0.0-beta.4+26.1.2" = _dNwaDelG;
        "default" = _dNwaDelG;
    });
