...
let
    ...
    in {
        ...
        "pkg-0.1.0-Forge-1.17.1" = _CbXTFSF3;
        "pkg-0.1.0-Forge-1.18.2" = _aM1zKo5L;
        "pkg-0.1.0-Forge-1.19.2" = _GH0oIjdq;
        "pkg-0.1.0-Fabric-1.17.1" = _5KLhizpM;
        "pkg-0.1.0-Fabric-1.18.2" = _p60KJekn;
        "pkg-0.1.0-Fabric-1.19.2" = _8enuTtR9;
        "pkg-0.1.1-Forge-1.17.1" = _WYn731qD;
        "pkg-0.1.1-Forge-1.18.2" = _MfxfVrG2;
        "pkg-0.1.1-Forge-1.19.2" = _Ai7ERJDH;
        "pkg-0.1.1-Fabric-1.17.1" = _62BBqgR2;
        "pkg-0.1.1-Fabric-1.18.2" = _XxNgdhOg;
        "pkg-0.1.1-Fabric-1.19.2" = _Lu8agwCL;
        "pkg-0.1.2-Forge-1.17.1" = _8U5brPfo;
        "pkg-0.1.2-Forge-1.18.2" = _DX5lEMAy;
        "pkg-0.1.2-Forge-1.19.2" = _YeN2xB0G;
        "pkg-0.1.2-Fabric-1.17.1" = _f0DdltoT;
        "pkg-0.1.2-Fabric-1.18.2" = _woK046GQ;
        "pkg-0.1.2-Fabric-1.19.2" = _uke3Il3O;
        "pkg-0.1.3-Forge-1.17.1" = _YyHDfqJ3;
        "pkg-0.1.3-Forge-1.18.2" = _l4VcL7QR;
        "pkg-0.1.3-Forge-1.19.2" = _egT7aWEf;
        "pkg-0.1.3-Fabric-1.17.1" = _mEMMgf7Q;
        "pkg-0.1.3-Fabric-1.18.2" = _X4RjIXog;
        "pkg-0.1.3-Fabric-1.19.2" = _Dz1fR8Aa;
        "pkg-0.2.0-Forge-1.17.1" = _4376gFV8;
        "pkg-0.2.0-Forge-1.18.2" = _Z9bKIihh;
        "pkg-0.2.0-Forge-1.19.2" = _wdItxbYi;
        "pkg-0.2.0-Forge-1.19.3" = _IkUp8ukh;
        "pkg-0.2.0-Fabric-1.17.1" = _YlBprpp3;
        "pkg-0.2.0-Fabric-1.18.2" = _xYXMkOLv;
        "pkg-0.2.0-Fabric-1.19.2" = _XRrlMSrU;
        "pkg-0.2.0-Fabric-1.19.3" = _PNLqmGbX;
        "pkg-0.2.1-Forge-1.17.1" = _cMOifVHj;
        "pkg-0.2.1-Forge-1.18.2" = _kPXd5nvM;
        "pkg-0.2.1-Forge-1.19.2" = _Mxyq4tTm;
        "pkg-0.2.1-Forge-1.19.3" = _1Y5RHdNx;
        "pkg-0.2.1-Fabric-1.17.1" = _T6Vl6XtC;
        "pkg-0.2.1-Fabric-1.18.2" = _rBo2MZRQ;
        "pkg-0.2.1-Fabric-1.19.2" = _9DA6jQAm;
        "pkg-0.2.1-Fabric-1.19.3" = _aJaxZxY2;
        "pkg-0.2.2-Forge-1.17.1" = _8Wlk6sxN;
        "pkg-0.2.2-Forge-1.18.2" = _RQNp0DYc;
        "pkg-0.2.2-Forge-1.19.2" = _CwEa4Qwy;
        "pkg-0.2.2-Forge-1.19.3" = _etSJ2x1B;
        "pkg-0.2.2-Fabric-1.17.1" = _3H7DTRYT;
        "pkg-0.2.2-Fabric-1.18.2" = _JAUbPk7d;
        "pkg-0.2.2-Fabric-1.19.2" = _uanBFYmN;
        "pkg-0.2.2-Fabric-1.19.3" = _GzmlE5cf;
        "pkg-0.2.3-Forge-1.17.1" = _wZkwJNWV;
        "pkg-0.2.3-Forge-1.18.2" = _qXXRjMOm;
        "pkg-0.2.3-Forge-1.19.2" = _SXtAwYTH;
        "pkg-0.2.3-Forge-1.19.3" = _ZjOiTAg3;
        "pkg-0.2.3-Fabric-1.17.1" = _4Kfj2KEt;
        "pkg-0.2.3-Fabric-1.18.2" = _uApHvwIo;
        "pkg-0.2.3-Fabric-1.19.2" = _1AzMZV0b;
        "pkg-0.2.3-Fabric-1.19.3" = _3YHF84J4;
        "pkg-0.3.0-Forge-1.17.1" = _hoybQmSC;
        "pkg-0.3.0-Forge-1.18.2" = _Q2AzMp2E;
        "pkg-0.3.0-Forge-1.19.2" = _aSbLNPZd;
        "pkg-0.3.0-Forge-1.19.3" = _vMYC4go1;
        "pkg-0.3.0-Forge-1.19.4" = _M6KVigbB;
        "pkg-0.3.0-Fabric-1.17.1" = _xIMO0MrG;
        "pkg-0.3.0-Fabric-1.18.2" = _D7OLQJxz;
        "pkg-0.3.0-Fabric-1.19.2" = _DqBT12eY;
        "pkg-0.3.0-Fabric-1.19.3" = _EkVL79wc;
        "pkg-0.3.0-Fabric-1.19.4" = _WjmdoP2j;
        "pkg-0.3.1-Forge-1.17.1" = _8ZQDtNXp;
        "pkg-0.3.1-Forge-1.18.2" = _OtwumeNb;
        "pkg-0.3.1-Forge-1.19.2" = _fFLRW7xX;
        "pkg-0.3.1-Forge-1.19.3" = _IqtRx9Ir;
        "pkg-0.3.1-Forge-1.19.4" = _1MJjqluW;
        "pkg-0.3.1-Fabric-1.17.1" = _nC37JlFX;
        "pkg-0.3.1-Fabric-1.18.2" = _exVdfM3d;
        "pkg-0.3.1-Fabric-1.19.2" = _PrPCJpb4;
        "pkg-0.3.1-Fabric-1.19.3" = _rysfrsJw;
        "pkg-0.3.1-Fabric-1.19.4" = _G3UEW9Km;
        "pkg-0.3.2-Forge-1.17.1" = _YO8kqYM4;
        "pkg-0.3.2-Forge-1.18.2" = _gCRStnJM;
        "pkg-0.3.2-Forge-1.19.2" = _7ycg0mzl;
        "pkg-0.3.2-Forge-1.19.3" = _kPkaEBhc;
        "pkg-0.3.2-Forge-1.19.4" = _1uOixGmu;
        "pkg-0.3.2-Fabric-1.17.1" = _ZQsiiUXk;
        "pkg-0.3.2-Fabric-1.18.2" = _j5N2x7r5;
        "pkg-0.3.2-Fabric-1.19.2" = _OFWNxAkw;
        "pkg-0.3.2-Fabric-1.19.3" = _ks7p1BXw;
        "pkg-0.3.2-Fabric-1.19.4" = _9ezsb6yB;
        "pkg-0.3.3-Forge-1.17.1" = _nZCVpVdm;
        "pkg-0.3.3-Forge-1.18.2" = _QvMqb0Y5;
        "pkg-0.3.3-Forge-1.19.2" = _rX1JWDfZ;
        "pkg-0.3.3-Forge-1.19.3" = _IF8XpErJ;
        "pkg-0.3.3-Forge-1.19.4" = _SIVMdgTU;
        "pkg-0.3.3-Fabric-1.17.1" = _mt3mnrdh;
        "pkg-0.3.3-Fabric-1.18.2" = _LhSyyi7C;
        "pkg-0.3.3-Fabric-1.19.2" = _hwV8kBZM;
        "pkg-0.3.3-Fabric-1.19.3" = _Ew4ezv8u;
        "pkg-0.3.3-Fabric-1.19.4" = _RdxupimH;
        "pkg-0.4.0+1.17.1" = _LrKfZgCc;
        "pkg-0.4.0+1.18.2" = _QT3PkJrN;
        "pkg-0.4.0+1.19.2" = _cMJpMBlV;
        "pkg-0.4.0+1.19.3" = _ZPF7uxjS;
        "pkg-0.4.0+1.19.4" = _UJBEBeax;
        "pkg-0.4.1+1.17.1" = _1Na220yd;
        "pkg-0.4.1+1.18.2" = _Vp7tcVZa;
        "pkg-0.4.1+1.19.2" = _KsEFojWD;
        "pkg-0.4.1+1.19.3" = _Vcju0JXL;
        "pkg-0.4.1+1.19.4" = _pLOLAVw4;
        "pkg-0.4.2+1.17.1" = _W41AwMxo;
        "pkg-0.4.2+1.18.2" = _CIdyojUj;
        "pkg-0.4.2+1.19.2" = _LYMRCdSM;
        "pkg-0.4.2+1.19.3" = _GZwt5gSL;
        "pkg-0.4.2+1.19.4" = _JGBzCm4v;
        "pkg-0.5.0+1.17.1" = _32sIVtSf;
        "pkg-0.5.0+1.18.2" = _JcbvR9yu;
        "pkg-0.5.0+1.19.2" = _s8spwz5Y;
        "pkg-0.5.0+1.19.3" = _xfXoe0if;
        "pkg-0.5.0+1.19.4" = _ers23UK2;
        "pkg-0.5.0+1.20.1" = _S8VLXpd8;
        "pkg-0.5.1+1.17.1" = _owZ6ITIc;
        "pkg-0.5.1+1.18.2" = _ouBbOoxg;
        "pkg-0.5.1+1.19.2" = _EVNzXnkT;
        "pkg-0.5.1+1.19.3" = _TS11RkdQ;
        "pkg-0.5.1+1.19.4" = _NomLlJR3;
        "pkg-0.5.1+1.20.1" = _6RYFSYeC;
        "pkg-0.5.2+1.17.1" = _6tJ8ewOP;
        "pkg-0.5.2+1.18.2" = _qv0p1m18;
        "pkg-0.5.2+1.19.2" = _t6W3sW39;
        "pkg-0.5.2+1.19.3" = _F9HDDQl2;
        "pkg-0.5.2+1.19.4" = _JcADLY4p;
        "pkg-0.5.2+1.20.1" = _GzGXRgXC;
        "default" = _GzGXRgXC;
    });
