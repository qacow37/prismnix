...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18" = _akyUsMok;
        "pkg-1.0.0+1.19" = _YIZ1ZpsB;
        "pkg-1.0.1+1.19" = _dREYvE5W;
        "pkg-1.0.1+1.18" = _mfVeW00n;
        "pkg-1.0.2+1.19" = _Tf9SvFOt;
        "pkg-1.0.3+1.19" = _sONYCSrj;
        "pkg-1.0.3+1.18" = _6YMaAwBP;
        "pkg-1.0.4+1.19.1" = _QH7O1DTJ;
        "pkg-1.0.5+1.18" = _tC9XUQJU;
        "pkg-1.0.5+1.19" = _4pU24ZIN;
        "pkg-1.0.6+1.19.1" = _AZrG0PF3;
        "pkg-f2d-1.0.7+1.19.2-test" = _DZqSLyEi;
        "pkg-2.0.0-beta+1.19.2" = _o0vc4Yv3;
        "pkg-2.0.1-beta+1.19.2" = _qhBBIe9h;
        "pkg-2.0.1-beta+1.18.2" = _xtNZQqun;
        "pkg-2.0.2-beta+1.19.2" = _INWNBaEg;
        "pkg-2.0.2-beta+1.18.2" = _GiBawlTF;
        "pkg-2.0.3-beta-1.19.2" = _eDpQ1ypm;
        "pkg-2.0.3-beta-1.18.2" = _cYfKZH8k;
        "pkg-2.1.0+1.19.3" = _G6lU62mx;
        "pkg-2.1.0+1.18.2" = _44kg8Ypz;
        "pkg-2.2.0+1.19.4" = _TMaCVxtZ;
        "pkg-2.2.1+1.19.x" = _iMUkgOhs;
        "pkg-2.3.0+1.20.x" = _pxzrYXdb;
        "pkg-3.0.0+1.20.4" = _GRMft2bc;
        "pkg-3.0.0-beta+1.19.4" = _ZKmLhUC0;
        "pkg-3.1.0+1.19.4+hotfix" = _kqvW6oBL;
        "pkg-3.1.0+1.20.4" = _3XLVQzv8;
        "default" = _3XLVQzv8;
    });
