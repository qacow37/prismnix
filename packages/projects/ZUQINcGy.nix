...
let
    ...
    in {
        ...
        "pkg-fabric-1.19.1-2.0.0" = _VoIrXhxz;
        "pkg-forge-1.19.2-2.0.0" = _XUV6F4fi;
        "pkg-fabric-1.19.2-2.0.0" = _5sGYFd9C;
        "pkg-forge-1.19.2-2.0.1" = _JV1YCof4;
        "pkg-fabric-1.19.2-2.0.1" = _YS0RsB69;
        "pkg-forge-1.19.3-2.0.1" = _CgBC79dj;
        "pkg-fabric-1.19.3-2.0.1" = _U5nDyJA1;
        "pkg-forge-1.19.4-2.0.1" = _VmC0TjwL;
        "pkg-fabric-1.19.4-2.0.1" = _10NHiKz5;
        "pkg-forge-1.19.2-2.0.2" = _ZW3Mtzfp;
        "pkg-fabric-1.19.2-2.0.2" = _Hw7vBhOw;
        "pkg-forge-1.19.4-2.0.2" = _US0NOiVA;
        "pkg-fabric-1.19.4-2.0.2" = _agfyqW3G;
        "pkg-forge-1.20-2.0.2" = _yI8JUzT1;
        "pkg-fabric-1.20-2.0.2" = _6H4Ajzx7;
        "pkg-forge-1.20.1-2.0.2" = _XrwDxY7Z;
        "pkg-fabric-1.20.1-2.0.2" = _Y6rJobQE;
        "pkg-forge-1.20.1-2.0.3" = _iM9qUKao;
        "pkg-fabric-1.20.1-2.0.3" = _9UACmQLs;
        "pkg-forge-1.20.2-2.0.3" = _IFgQHUK4;
        "pkg-fabric-1.20.2-2.0.3" = _FkjwHOkD;
        "pkg-neoforge-1.20.2-2.0.3" = _1USykgZo;
        "pkg-forge-1.20.4-2.0.3" = _CmZ0X2dc;
        "pkg-neoforge-1.20.4-2.0.3" = _DOabmyM7;
        "pkg-fabric-1.20.4-2.0.3" = _rnwzd9h1;
        "pkg-forge-1.19.2-2.0.4" = _bVHfwXki;
        "pkg-fabric-1.19.2-2.0.4" = _8SH2WzKy;
        "pkg-forge-1.20.1-2.0.4" = _8jy5CAJM;
        "pkg-fabric-1.20.1-2.0.4" = _JDoOjAwA;
        "pkg-forge-1.20.4-2.0.4" = _fdSVpiRs;
        "pkg-neoforge-1.20.4-2.0.4" = _RU9FOjQN;
        "pkg-fabric-1.20.4-2.0.4" = _8tqIOsXL;
        "pkg-forge-1.20.4-2.0.5" = _ukjmtOY7;
        "pkg-neoforge-1.20.4-2.0.5" = _zjXoenW6;
        "pkg-fabric-1.20.4-2.0.5" = _57LV5ESJ;
        "pkg-fabric-1.20.5-2.0.5" = _vbyYSiqq;
        "pkg-neoforge-1.20.5-2.0.5" = _vwVfCns3;
        "pkg-forge-1.20.6-2.0.5" = _N9si195I;
        "pkg-neoforge-1.20.6-2.0.5" = _fHiQpC0K;
        "pkg-fabric-1.20.6-2.0.5" = _UfDF2TYh;
        "pkg-forge-1.21-2.0.5" = _ZAha9bTa;
        "pkg-neoforge-1.21-2.0.5" = _Fho33sJp;
        "pkg-fabric-1.21-2.0.5" = _EaWtxaKD;
        "pkg-forge-1.21-2.0.6" = _YSbj8FZ2;
        "pkg-neoforge-1.21-2.0.6" = _FeTx2pZY;
        "pkg-fabric-1.21-2.0.6" = _6lI5xlZn;
        "pkg-forge-1.21.1-2.0.6" = _I1QDsaFX;
        "pkg-neoforge-1.21.1-2.0.6" = _Sb4rhlG1;
        "pkg-fabric-1.21.1-2.0.6" = _iuO86CEb;
        "pkg-forge-1.21.3-2.0.6" = _JXSfIGoK;
        "pkg-neoforge-1.21.3-2.0.6" = _fHRswN94;
        "pkg-fabric-1.21.3-2.0.6" = _mh8tyqNS;
        "pkg-forge-1.21.4-2.0.6" = _ZMV0AJhx;
        "pkg-neoforge-1.21.4-2.0.6" = _1BTzWoeC;
        "pkg-fabric-1.21.4-2.0.6" = _LdchMSAO;
        "pkg-forge-1.21.5-2.0.6" = _Eug2AaPD;
        "pkg-neoforge-1.21.5-2.0.6" = _Fw8jLi2X;
        "pkg-fabric-1.21.5-2.0.6" = _2HZ8S1hU;
        "pkg-forge-1.21.6-2.0.6" = _xr0gW5BP;
        "pkg-neoforge-1.21.6-2.0.6" = _oD1BsiyQ;
        "pkg-fabric-1.21.6-2.0.6" = _cAgnV4Fk;
        "pkg-forge-1.21.7-2.0.6" = _c69mnmnv;
        "pkg-neoforge-1.21.7-2.0.6" = _1bvhiAoF;
        "pkg-fabric-1.21.7-2.0.6" = _mBwkMEUD;
        "pkg-forge-1.21.8-2.0.6" = _qa8krUTS;
        "pkg-neoforge-1.21.8-2.0.6" = _PtuV1cJT;
        "pkg-fabric-1.21.8-2.0.6" = _t0YjBvc3;
        "pkg-forge-1.21.9-2.0.6" = _7NVsELA7;
        "pkg-neoforge-1.21.9-2.0.6" = _p2ojI3Tm;
        "pkg-fabric-1.21.9-2.0.6" = _EcQZqJWO;
        "pkg-forge-1.21.10-2.0.6" = _VYcrMdEu;
        "pkg-neoforge-1.21.10-2.0.6" = _nRsfjjwU;
        "pkg-fabric-1.21.10-2.0.6" = _kAAly4WV;
        "pkg-forge-1.21.11-2.0.6" = _LHG4mM81;
        "pkg-neoforge-1.21.11-2.0.6" = _l8GQ0nDA;
        "pkg-fabric-1.21.11-2.0.6" = _JWjSPLr9;
        "pkg-neoforge-2.0.6+26.1" = _10Y0Bvbx;
        "pkg-fabric-2.0.6+26.1" = _NQ0Pa1Y5;
        "pkg-forge-2.0.6+26.1" = _kX23xKz8;
        "pkg-forge-2.0.6+26.1.1" = _Ug30dR71;
        "pkg-neoforge-2.0.6+26.1.1" = _mAWVEVZB;
        "pkg-fabric-2.0.6+26.1.1" = _FqNo4L7J;
        "pkg-forge-2.0.6+26.1.2" = _Jg6TNdRt;
        "pkg-neoforge-2.0.6+26.1.2" = _3YmBmYMN;
        "pkg-fabric-2.0.6+26.1.2" = _BTkvDTIk;
