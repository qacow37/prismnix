...
let
    ...
    in {
        ...
        "pkg-0.1.0-0.1.0p+1.19.3" = _UQZzwyhl;
        "pkg-0.1.0-0.1.0p+1.19.2" = _j7WImTAC;
        "pkg-0.1.0-0.1.0p+1.19.-" = _kw98paBp;
        "pkg-0.1.1-0.1.1r+1.19.-" = _5HSeBb3Y;
        "pkg-0.1.1-0.1.1r+1.19.2" = _dqOUO29w;
        "pkg-0.1.1-0.1.1r+1.19.3" = _CFx3y8U4;
        "pkg-0.1.1-0.1.1r+1.19.4" = _c8TEdJ8W;
        "pkg-0.1.2-0.1.2u+1.19.-" = _C8CkXA3R;
        "pkg-0.1.2-0.1.2u+1.19.2" = _UetrMl7R;
        "pkg-0.1.2-0.1.2u+1.19.3" = _V8Mlbo3E;
        "pkg-0.1.2-0.1.2u+1.19.4" = _gF5xvsXX;
        "pkg-0.1.3-0.1.3u+1.19.-" = _amzWMCy4;
        "pkg-0.1.3-0.1.3u+1.19.2" = _Lfc0SjxO;
        "pkg-0.1.3-0.1.3u+1.19.3" = _xGJT9FgH;
        "pkg-0.1.3-0.1.3u+1.19.4" = _HwUfPKjI;
        "pkg-0.1.4-0.1.4r+1.19.-" = _qfDsG1nG;
        "pkg-0.1.4-0.1.4r+1.19.2" = _jflyQ3BG;
        "pkg-0.1.4-0.1.4r+1.19.3" = _fzYOTiIv;
        "pkg-0.1.4-0.1.4r+1.19.4" = _Nn11DHZW;
        "pkg-0.2.0-0.2i.0+1.19.-" = _FYp78ynO;
        "pkg-0.2.0-0.2i.0+1.19.2" = _o5oFKri5;
        "pkg-0.2.0-0.2i.0+1.19.3" = _pNK40CRL;
        "pkg-0.2.0-0.2i.0+1.19.4" = _i7Mr37CM;
        "pkg-0.2.1-0.2i.1r+1.19.-" = _NmzMQNv3;
        "pkg-0.2.1-0.2i.1r+1.19.2" = _m6lgDoY3;
        "pkg-0.2.1-0.2i.1r+1.19.3" = _nuxnnonn;
        "pkg-0.2.1-0.2i.1r+1.19.4" = _RF04s8oX;
        "pkg-0.2.2-0.2i.2u+1.19.-" = _a6qD8r3n;
        "pkg-0.2.2-0.2i.2u+1.19.2" = _ilidpz1N;
        "pkg-0.2.2-0.2i.2u+1.19.3" = _NRGcCppD;
        "pkg-0.2.2-0.2i.2u+1.19.4" = _XNbSvJ57;
        "pkg-0.3.0-0.3b.0+1.19.-" = _BVRsdRvy;
        "pkg-0.3.0-0.3b.0+1.19.2" = _IUHrhYTO;
        "pkg-0.3.0-0.3b.0+1.19.3" = _vUrMhcxJ;
        "pkg-0.3.0-0.3b.0+1.19.4" = _MGEMt0mY;
        "pkg-0.3.1-0.3b.1r+1.19.-" = _4B4yATjT;
        "pkg-0.3.1-0.3b.1r+1.19.2" = _dGcD1gFu;
        "pkg-0.3.1-0.3b.1r+1.19.3" = _TyxLDq4k;
        "pkg-0.3.1-0.3b.1r+1.19.4" = _p0LYJsoQ;
        "pkg-0.4.0-0.4i.0+1.19.-" = _dLZbaZyg;
        "pkg-0.4.0-0.4i.0+1.19.2" = _lriea3zX;
        "pkg-0.4.0-0.4i.0+1.19.3" = _3BnHR8dc;
        "pkg-0.4.0-0.4i.0+1.19.4" = _w4weXQRE;
        "pkg-0.4.1-0.4i.1u+1.19.-" = _tGiH6TwS;
        "pkg-0.4.1-0.4i.1u+1.19.2" = _1HFsC2jK;
        "pkg-0.4.1-0.4i.1u+1.19.3" = _HKdhGN1k;
        "pkg-0.4.1-0.4i.1u+1.19.4" = _NFA8BFg2;
        "pkg-0.4.2-0.4i.2r+1.18.2" = _We61kZR1;
        "pkg-0.4.2-0.4i.2r+1.19.-" = _E3dwRUtV;
        "pkg-0.4.2-0.4i.2r+1.19.2" = _hTtVh5oN;
        "pkg-0.4.2-0.4i.2r+1.19.3" = _Nd5yHqJ1;
        "pkg-0.4.2-0.4i.2r+1.19.4" = _gYtZakdW;
        "pkg-0.4.3-0.4i.3d+1.18.2" = _ML4oXuMk;
        "pkg-0.4.3-0.4i.3d+1.19.-" = _q7o3CkPs;
        "pkg-0.4.3-0.4i.3d+1.19.2" = _95nK9Ayb;
        "pkg-0.4.3-0.4i.3d+1.19.3" = _MwV665MB;
        "pkg-0.4.3-0.4i.3d+1.19.4" = _I8IgtLuh;
        "pkg-0.4.4-0.4i.4u+1.18.2" = _ztmdLTye;
        "pkg-0.4.4-0.4i.4u+1.19.-" = _touacSwP;
        "pkg-0.4.4-0.4i.4u+1.19.2" = _u2KsYczc;
        "pkg-0.4.4-0.4i.4u+1.19.3" = _bA9BFP3l;
        "pkg-0.4.4-0.4i.4u+1.19.4" = _6xphCX3f;
        "pkg-0.4.5-0.4i.5u+1.18.2" = _RpE2YAiP;
        "pkg-0.4.5-0.4i.5u+1.19.-" = _Z8KEEcvW;
        "pkg-0.4.5-0.4i.5u+1.19.2" = _o8iNYVHe;
        "pkg-0.4.5-0.4i.5u+1.19.3" = _raLNCJfI;
        "pkg-0.4.5-0.4i.5u+1.19.4" = _BQtRphGz;
        "pkg-0.4.5-0.4i.5u+1.20.-" = _wlF1xy8W;
        "pkg-0.4.6-0.4i.6f+1.18.2" = _2MHVtLgi;
        "pkg-0.4.6-0.4i.6f+1.19.-" = _E4MSo3y9;
        "pkg-0.4.6-0.4i.6f+1.19.2" = _2N1EKRcK;
        "pkg-0.4.6-0.4i.6f+1.19.3" = _GoHcGjaU;
        "pkg-0.4.6-0.4i.6f+1.19.4" = _WWn3PQHL;
        "pkg-0.4.6-0.4i.6f+1.20.-" = _ee7HHnje;
        "pkg-0.4.7-0.4i.7f+1.18.2" = _J6yERsa6;
        "pkg-0.4.7-0.4i.7f+1.19.-" = _RN78fzOi;
        "pkg-0.4.7-0.4i.7f+1.19.2" = _ut6trBTt;
        "pkg-0.4.7-0.4i.7f+1.19.3" = _blvxSzAV;
        "pkg-0.4.7-0.4i.7f+1.19.4" = _as9QCE79;
        "pkg-0.4.7-0.4i.7f+1.20.-" = _2Ke5onf7;
        "pkg-0.4.8-0.4i.8p+1.18.2" = _7sB6SnrZ;
        "pkg-0.4.8-0.4i.8p+1.19.-" = _rFZCF2LZ;
        "pkg-0.4.8-0.4i.8p+1.19.2" = _JbHShvXL;
        "pkg-0.4.8-0.4i.8p+1.19.3" = _Enw9kfM3;
        "pkg-0.4.8-0.4i.8p+1.19.4" = _Bgq7L7aT;
        "pkg-0.4.8-0.4i.8p+1.20.-" = _apqaD2Gb;
        "pkg-0.5.0-0.5b.0f+1.18.2" = _yzEDS5Vn;
        "pkg-0.5.0-0.5b.0f+1.19.-" = _7kF9AC7L;
        "pkg-0.5.0-0.5b.0f+1.19.2" = _V4DXZz9G;
        "pkg-0.5.0-0.5b.0f+1.19.3" = _LjmzgGvF;
        "pkg-0.5.0-0.5b.0f+1.19.4" = _RULQX541;
        "pkg-0.5.0-0.5b.0f+1.20.-" = _4kqcajTG;
        "pkg-0.5.1-0.5b.1f+1.18.2" = _bbXHgYBY;
        "pkg-0.5.1-0.5b.1f+1.19.2" = _OneoGaTQ;
        "pkg-0.5.1-0.5b.1f+1.19.3" = _To2X6WLf;
        "pkg-0.5.1-0.5b.1f+1.19.4" = _EXpVjoJR;
        "pkg-0.5.1-0.5b.1f+1.20.-" = _y9feZuY0;
        "pkg-1.20+0.5.2.beta" = _5T2jvNt5;
        "pkg-1.20-0.5.2-beta2" = _dOwmDxu7;
        "pkg-1.20-0.5.2+beta3" = _tZO5eqw9;
        "pkg-1.20-0.5.2+beta4" = _IQNKByNY;
        "pkg-1.20.2-0.5.2+beta1" = _Lc1Py9Q4;
        "pkg-1.20-0.5.2+bp" = _AFkfUiUz;
        "pkg-1.20.2-0.5.2+bp" = _prm3EJc0;
        "pkg-1.20.3-0.5.2+bp" = _fYGWLNj2;
        "pkg-1.20.4-0.5.2+bp" = _ogPPTU5W;
        "pkg-1.20-0.5.3+bf" = _BpE2752i;
        "pkg-1.20.2-0.5.3+bf" = _Cei1ng1Z;
        "pkg-1.20.4-0.5.3+bf" = _mjOZVDZo;
        "pkg-1.20-0.5.4+bu" = _udF0JI9B;
        "pkg-1.20.2-0.5.4+bu" = _sN5XskMJ;
        "pkg-1.20.4-0.5.4+bu" = _EIKRJwQ6;
        "pkg-1.20-0.5.4+bu.2" = _ZqWOzhTI;
        "pkg-1.20-0.5.5+bu" = _qNYfAf0D;
        "pkg-1.20.2-0.5.5+bu" = _KycOoTw8;
        "pkg-1.20.4-0.5.5+bu" = _JOX5CCkg;
        "pkg-1.20-0.5.6+bf" = _q4OBxBHo;
        "pkg-1.20.2-0.5.6+bf" = _8rV83eNg;
        "pkg-1.20.4-0.5.6+bf" = _E3qsuhhD;
        "pkg-1.20-0.5.7+bu" = _zkR5hlVV;
        "pkg-1.20.2-0.5.7+bu" = _aXPAdiLC;
        "pkg-1.20.4-0.5.7+bu" = _KuGNQT6H;
        "pkg-1.20.5-0.5.7+ba.2" = _8SJQ3LvZ;
        "pkg-1.20.5-0.5.7+bu" = _T65ER5cy;
        "pkg-1.20.4-1.0.0+bu" = _6kPkw5TW;
        "pkg-1.0.0+bu+1.20.4" = _hFTnFGKK;
        "pkg-1.0.1+bf+1.20.6" = _CReTyiF0;
        "pkg-1.0.1+bf+1.21.1" = _VXlTdRX5;
        "default" = _VXlTdRX5;
    });
