...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.16.5" = _vLg0D4k3;
        "pkg-1.0.0-1.19.2" = _d7GvwLIP;
        "pkg-1.0.0-1.20.1" = _sUeDl0Ne;
        "pkg-1.0.0-1.21.1" = _510A32qc;
        "pkg-1.1.0-1.16.5" = _ngNVjtWj;
        "pkg-1.1.0-1.19.2" = _U9a1YWm7;
        "pkg-1.1.0-1.20.1" = _w0SgqAx7;
        "pkg-1.1.0-1.21.1" = _jQM64j9u;
        "pkg-1.1.1-1.16.5" = _2aOP6t2Y;
        "pkg-1.1.1-1.19.2" = _9G6WYOrn;
        "pkg-1.1.1-1.20.1" = _lGEn4TJK;
        "pkg-1.1.1-1.21.1" = _NPpIVpR2;
        "pkg-1.2.0-1.16.5" = _VosuR2KY;
        "pkg-1.2.0-1.19.2" = _KVjZn7bf;
        "pkg-1.2.0-1.20.1" = _gGwqdh4y;
        "pkg-1.2.0-1.21.1" = _mykB32JC;
        "pkg-1.2.1-1.16.5" = _K3UHT5Ry;
        "pkg-1.2.1-1.19.2" = _iTMZs7FU;
        "pkg-1.2.1-1.20.1" = _vobY5ROn;
        "pkg-1.2.1-1.21.1" = _3SZHI4Ha;
        "pkg-1.2.2-1.16.5" = _CkLeOiA3;
        "pkg-1.2.2-1.19.2" = _cerRtn8E;
        "pkg-1.2.2-1.20.1" = _CoyUQj3n;
        "pkg-1.2.2-1.21.1" = _WTlRX8NL;
        "pkg-1.2.3-1.16.5" = _sehkYaQU;
        "pkg-1.2.3-1.19.2" = _izy3nNMK;
        "pkg-1.2.3-1.20.1" = _5RNB3dc0;
        "pkg-1.2.3-1.21.1" = _5lwBo1gk;
        "pkg-1.2.4-1.16.5" = _GDNdp5r5;
        "pkg-1.2.4-1.19.2" = _vrSZWsBC;
        "pkg-1.2.4-1.20.1" = _sPn8wAXZ;
        "pkg-1.2.4-1.21.1" = _pX4lRzA8;
        "pkg-1.3.0-1.16.5" = _uQPxQkxB;
        "pkg-1.3.0-1.19.2" = _L1tvQCib;
        "pkg-1.3.0-1.20.1" = _MDAEqCGQ;
        "pkg-1.3.0-1.21.1" = _JjP01vdq;
        "default" = _JjP01vdq;
    });
