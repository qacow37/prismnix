...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _KJh8f8S2;
        "pkg-1.0.1-1.19.4" = _2dozLA4V;
        "pkg-1.0.1-1.19.2" = _3xo2p1Bm;
        "pkg-1.0.2" = _O4Hl3eA5;
        "pkg-1.1.0-1.20.6" = _uXXdv7Iz;
        "pkg-1.2.0-1.20.6" = _fGwTWbf6;
        "pkg-1.2.1-1.20.6" = _yal9qOvS;
        "pkg-1.2.2-1.20.1" = _yOORv0uv;
        "pkg-1.2.2-1.20.6" = _H0QXaDlU;
        "pkg-1.2.2-1.20.4" = _TAaJviHy;
        "pkg-1.2.3-1.20.6" = _7j3TEG87;
        "pkg-1.2.3-1.20.4" = _qevV5OZF;
        "pkg-1.2.3-1.20.1" = _JXZCYftq;
        "pkg-1.2.4-1.20.6" = _M29B0u4C;
        "pkg-1.2.4-1.20.4" = _6fPmGm87;
        "pkg-1.2.4-1.20.1" = _9ScdJQCW;
        "pkg-1.2.5" = _9fTR567A;
        "pkg-1.2.5-1.21.6" = _RIhKa6R5;
