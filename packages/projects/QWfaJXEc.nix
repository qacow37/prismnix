...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _DN8JIjOb;
        "pkg-1.0.0+mod" = _kA7X98r6;
        "pkg-2.0.0" = _h74oiz5C;
        "pkg-2.0.0+mod" = _iCt2qwi3;
        "pkg-1.0.0-(1.17.1-1.19.2)" = _QdMDlAdd;
        "pkg-1.0.0-(1.17.1-1.19.2)+mod" = _PDTxgOOd;
        "pkg-1.0.0-(1.16.5)" = _WAL0dUv5;
        "pkg-1.0.0-(1.16.5)+mod" = _Mrb7PEm0;
        "pkg-1.21-2.0.0-fabric" = _RHFy7cXd;
        "pkg-1.21-2.0.0-fabric+mod" = _ErfSMjj4;
        "pkg-1.20.1-1.1.0-fabric" = _lHUgL3Uu;
        "pkg-1.20.1-1.1.0-fabric+mod" = _1os5RzTd;
        "pkg-1.1.0-1.20.1" = _YkElfnzo;
        "pkg-1.1.0-1.20.1+mod" = _xroQMKdK;
        "pkg-1.21.5-3.0.0-fabric" = _Pk8PP45e;
        "pkg-1.21.5-3.0.0-fabric+mod" = _2GXnf6EV;
        "pkg-1.21.5-3.0.1-fabric" = _w8GhUNZz;
        "pkg-1.21.5-3.0.1-fabric+mod" = _HaPjrvMU;
        "pkg-1.21.8-4.0-fabric" = _GceYfZky;
        "pkg-1.21.8-4.0-fabric+mod" = _y5rFSj8s;
        "pkg-1.21.10-4.0-fabric" = _FNpIY3lW;
        "pkg-1.21.10-4.0-fabric+mod" = _zyFxfYBR;
        "pkg-1.21.11-4.0-fabric" = _fbgaydmI;
        "pkg-1.21.11-4.0-fabric+mod" = _Zg4dsWUx;
        "default" = _Zg4dsWUx;
    });
