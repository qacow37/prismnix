...
let
    ...
    in {
        ...
        "pkg-2.0" = _NFhyfuUq;
        "pkg-2.1" = _IpMtecVK;
        "pkg-2.1+1.21.2" = _k3al8aBI;
        "pkg-2.1+1.21" = _PM0rAnNj;
        "pkg-2.1+1.20" = _mnIFI2gN;
        "pkg-2.1+1.20.3" = _RvQpICup;
        "pkg-2.2+1.20" = _fvSgfOxT;
        "pkg-2.2+1.20.3" = _hAvJkdrw;
        "pkg-2.2+1.21" = _cC42joJw;
        "pkg-2.2+1.21.2" = _ljvbo4jt;
        "pkg-2.2+1.21.5" = _jaXclpI5;
        "pkg-2.3+1.20" = _mIaBzWgH;
        "pkg-2.3+1.20.3" = _wt4Ck36B;
        "pkg-2.3+1.21" = _ddywe0w5;
        "pkg-2.3+1.21.2" = _VtopHnpK;
        "pkg-2.3+1.21.5" = _af76RoFJ;
        "pkg-3.0+1.21.5" = _EfuXSBtb;
        "pkg-3.0+26.1" = _WzDp5uG9;
        "pkg-3.1+26.1" = _1rtXtiJt;
        "pkg-4.0+26.1" = _dTgGeEII;
        "pkg-4.1+26.1" = _l5THNPRj;
        "pkg-4.2+26.1" = _ACuk4tj7;
