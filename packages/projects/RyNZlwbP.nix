...
let
    ...
    in {
        ...
        "pkg-0.1.1-beta" = _JHUgR06c;
        "pkg-0.1.4-beta" = _yT5pXr9p;
        "pkg-0.1.5" = _UtgMPJIt;
        "pkg-0.1.6" = _egKeJnBf;
        "pkg-0.2.0" = _fBYiGRNT;
        "pkg-0.2.1" = _PzpwzxE2;
        ...
        "pkg-1.1.0" = _6rkwHSJy;
        "pkg-1.2.0" = _wgn4Qbu3;
        "pkg-1.3.0+1.21" = _Jkv6xcD6;
        "pkg-1.3.1+1.21" = _tuoFYwQQ;
        "pkg-1.3.2+1.21" = _wRAViM1U;
        "pkg-1.3.3+1.21" = _i9fRtZXm;
        "pkg-1.3.4+1.21" = _6NYlGnUw;
        "pkg-1.3.5+1.21" = _RUmJRfuX;
        "pkg-1.3.6+1.21" = _CfU7uyNV;
        "pkg-1.3.7+1.21" = _fkEkaDmu;
        "pkg-1.3.8+1.21" = _JAnh0DtV;
        "pkg-1.3.9+1.21" = _mRdnE5Vr;
        "pkg-1.4.0+1.21" = _sy552vfB;
        "pkg-1.2.1" = _Ug6JeESV;
        "pkg-1.4.1+1.21" = _XeKnVFW7;
        "pkg-1.4.2+1.21" = _Lf5BQpYs;
        "pkg-1.2.2" = _Zr8fkDIm;
        "pkg-1.4.3+1.21" = _652dgxwU;
        "pkg-1.2.3" = _I9pjPS3s;
        "pkg-1.4.4+1.21" = _LC7UDnPb;
        "pkg-1.5.0+1.21" = _2HM4miCy;
        "pkg-1.5.1+1.21" = _u90UR0a1;
        "pkg-1.6.0+1.21" = _wdLg7g5W;
        "pkg-1.6.1+1.21" = _ian7vJ4z;
        "pkg-1.2.4" = _sXt9oUw2;
        "default" = _sXt9oUw2;
    });
