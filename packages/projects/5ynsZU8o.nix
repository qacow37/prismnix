...
let
    ...
    in {
        ...
        "pkg-0.0.1-alpha" = _NqAt8k8Z;
        "pkg-0.1.0" = _UHyfgwVK;
        "pkg-0.1.0-1.20.5" = _zycYZXXN;
        "pkg-0.2.0-0-1.21" = _LiRID8kX;
        "pkg-0.2.0-2-702f05cd-1.20.5" = _m9wctmMO;
        "pkg-0.2.0-2-32f36688-1.20.1" = _slPfQMiu;
        "pkg-0.3.0-0-26.1" = _lv61hD7H;
        "default" = _lv61hD7H;
    });
