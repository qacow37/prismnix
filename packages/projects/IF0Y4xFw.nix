...
let
    ...
    in {
        ...
        "pkg-0.1.0+mc.1.19.2" = _a1cGU5yf;
        "pkg-0.1.1+mc.1.19.2" = _VWsy5gR4;
        "pkg-0.1.2+mc.1.19.2" = _jTQC2kfv;
        "pkg-0.1.3+mc.1.19.2" = _ahXh8u2G;
        "pkg-0.2.0+mc.1.19.2" = _VPbyYXoP;
        "pkg-0.3.0+mc.1.19.2" = _l2Mm9yV9;
        "pkg-0.3.1+mc.1.19.2" = _N6JFUQKg;
        "pkg-0.3.2+mc.1.19.3" = _1YNXrLiO;
        "pkg-0.3.2+mc.1.19.2" = _8AgZMs4M;
        "pkg-1.0.0+mc.1.19.3" = _8FrfMtvr;
        "pkg-1.0.0+mc.1.19.2" = _Yed2CJBO;
        "pkg-1.0.1+mc.1.19.3" = _yWjDAOxU;
        "pkg-1.0.1+mc.1.19.2" = _EVPpUuch;
        "pkg-1.0.1+mc.1.19.4" = _ig1DtwJM;
        "pkg-1.0.2+mc.1.19.3" = _BBmRyb5k;
        "pkg-1.0.2+mc.1.19.2" = _7uNSyEQB;
        "pkg-1.0.2+mc.1.19.4" = _K9advANX;
        "pkg-1.0.3+mc.1.19.2" = _VW28CIMy;
        "pkg-1.0.3+mc.1.19.4" = _Pi9E9Hhd;
        "pkg-1.0.3+mc.1.19.3" = _G5gKxlt4;
        "pkg-2.0.0+mc.1.20.1" = _gRWLyoS9;
        "pkg-2.0.1+mc.1.20.1" = _WJfOksaj;
        "pkg-2.0.2+mc.1.20.1" = _nFBubnVV;
        "pkg-2.0.3+mc.1.20.1" = _hgcUCnca;
        "pkg-3.0.0+mc.1.20.2" = _qEAPwmVk;
        "pkg-3.0.1+mc.1.20.4" = _YEvps5nE;
        "pkg-3.0.1+mc.1.20.2" = _UkBNLTAt;
        "pkg-3.1.0+mc.1.20.4" = _FQ4hwS8G;
        "pkg-4.0.0-beta.1+mc.1.20.6" = _XsjHoCxb;
        "pkg-4.0.0+mc.1.21" = _rL5WIyiH;
        "pkg-4.0.2+mc.1.21.1" = _MYWKPLbl;
        "pkg-4.2.0+mc.1.21.6" = _ITwJj1JC;
        "default" = _ITwJj1JC;
    });
