...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.0" = _iuqBUWsK;
        "pkg-1.18.2-1.0.1" = _1LWIkYqu;
        "pkg-1.18.2-1.0.2" = _gbYxDmgF;
        "pkg-1.18.2-1.0.3" = _Jg6Yqeh3;
        "pkg-1.18.2-1.1.0" = _hXpQBXY5;
        "pkg-1.18.2-1.1.1" = _blphxNM3;
        "pkg-1.18.2-1.1.2" = _a66jOywB;
        "pkg-1.18.2-1.1.3" = _cI0l7l0O;
        "pkg-1.18.2-1.1.4" = _mxMh1StQ;
        "pkg-1.18.2-1.2.0" = _tXcABwgY;
        "pkg-1.18.2-2.0.0" = _rRyfxQv9;
        "pkg-v3.0.0" = _j2c58QbC;
        "pkg-v3.1.0" = _dU8u7tkz;
        "pkg-v3.1.1" = _6NCE2PLc;
        "pkg-v3.1.2" = _pfKtbMUT;
        "pkg-v3.1.3" = _DZGCiBsn;
        "pkg-v3.1.4+1.21.10" = _U2ctttOg;
        "pkg-v3.1.5+1.21.4" = _wGRANqRD;
        "pkg-v3.1.5+1.21.10" = _3ZoGxts4;
        "pkg-v3.1.5+1.21.5" = _mjoY9KGw;
        "pkg-v3.1.5+1.21.8" = _gByDFGD5;
        "pkg-3.2.0+1.21.11" = _pWy9z7dg;
        "pkg-3.2.0+1.21.10" = _HBkbM69f;
        "pkg-3.2.0+1.21.4" = _XkioNOsC;
        "pkg-3.2.0+1.21.5" = _EPb5whaV;
        "pkg-3.2.0+1.21.8" = _6hdhlyeP;
        "pkg-3.3.0+1.21.11" = _GehCBQMf;
        "pkg-3.3.0+1.21.10" = _scJ8uFM8;
        "pkg-3.3.0+1.21.4" = _1uhLkrLt;
        "pkg-3.3.0+1.21.5" = _xMcoGoPl;
        "pkg-3.3.0+1.21.8" = _ANMhbEto;
        "pkg-3.4.0+1.21.10" = _NlGUtDpC;
        "pkg-3.4.0+1.21.11" = _bczYg5zM;
        "pkg-3.4.0+1.21.4" = _n0SGgrgb;
        "pkg-3.4.0+1.21.5" = _XFF69qHh;
        "pkg-3.4.0+1.21.8" = _u8eLOjr5;
        "pkg-3.4.0+26.1.2" = _RY4F1myL;
        "default" = _RY4F1myL;
    });
