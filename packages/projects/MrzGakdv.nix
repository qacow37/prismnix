...
let
    ...
    in {
        ...
        "pkg-v1.1+1.16.5" = _PAXyQusq;
        "pkg-v1.1.1+1.16.5" = _IpdBwwJF;
        "pkg-1.2-Beta1" = _3TKxAWfg;
        "pkg-1.2-Beta2" = _fOMb1bSl;
        "pkg-1.2-Beta2-HF1" = _MEY4W69M;
        "pkg-v1.2+1.16.5" = _mKMLWNra;
        "pkg-v1.2.1+1.16.5" = _AmLGspRB;
        "pkg-v1.2.2+1.16.5" = _LZSV7tIy;
        "pkg-v1.2.3+1.16.5" = _HGu07NYe;
        "pkg-v1.2.4+1.16.5" = _bFDyiJvu;
        "pkg-v1.3-Beta1+1.16.5" = _gL9y6UBx;
        "pkg-v1.3-Beta2+1.16.5" = _HBZe5IeL;
        "pkg-v1.3+1.16.5" = _pArh7VD0;
        "pkg-v1.3.1+1.16.5" = _rHMLxYCb;
        "pkg-v1.3.2+1.16.5" = _VMIFykj1;
        "pkg-v1.3.3+1.16.5" = _Z8VuN4yE;
        "pkg-v1.4+1.16.5" = _hEDuz3ox;
        "pkg-v1.4.1+1.16.5" = _PTJ60kbb;
        "pkg-v1.4.2+1.16.5/1.17" = _9LjNm9dV;
        "pkg-v1.4.3+1.16.5/21w20a" = _Klexr2Dv;
        "pkg-v1.5.0-Beta1+1.17" = _Q7KQvENV;
        "pkg-v1.5" = _GlnhE8BH;
        "default" = _GlnhE8BH;
    });
