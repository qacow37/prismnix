...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.4-fabric" = _LLdcSXS6;
        "pkg-1.18.2-2.4-fabric" = _wUZRfoDE;
        "pkg-1.19.2-2.6-fabric" = _UsyCP5IB;
        "pkg-1.16.5-2.0-forge" = _Zh2qvQ2k;
        "pkg-1.18.2-2.1-forge" = _WWDrB96q;
        "pkg-1.19.2-2.3-forge" = _lMG8tVBM;
        "pkg-1.16.5-2.7-fabric" = _p7oR628D;
        "pkg-1.18.2-2.7-fabric" = _p2eXql0v;
        "pkg-1.19.2-2.7-fabric" = _SggYYlbJ;
        "pkg-1.16.5-2.7-forge" = _XRCAhZ8J;
        "pkg-1.18.2-2.7-forge" = _Y9GRx500;
        "pkg-1.19.2-2.7-forge" = _KgGChVQD;
        "pkg-1.16.5-2.8-fabric" = _iI5mN8PD;
        "pkg-1.18.2-2.8-fabric" = _jfKrTIUu;
        "pkg-1.19.2-2.8-fabric" = _2fQE3F09;
        "pkg-1.19.3-2.9-fabric" = _NhBu85Ie;
        "pkg-1.19.3-2.7-forge" = _xZSg8ddk;
        "pkg-1.18.2-3.0-forge+fabric" = _RCTxX7CW;
        "pkg-1.19.2-3.0-forge+fabric" = _gZL5c2Qw;
        "pkg-1.19.3-3.0-forge+fabric" = _4QfyYHBS;
        "pkg-1.18.2-3.1-forge+fabric" = _lns4Tfd3;
        "pkg-1.19.2-3.1-forge+fabric" = _H5LGb3r9;
        "pkg-1.19.3-3.1-forge+fabric" = _k2tyR7FH;
        "pkg-1.18.2-3.2-forge+fabric" = _4sO34HEl;
        "pkg-1.19.2-3.2-forge+fabric" = _pLP6eSa0;
        "pkg-1.19.3-3.2-forge+fabric" = _NHIlW8U3;
        "pkg-1.19.4-3.2-forge+fabric" = _1Xbspqne;
        "pkg-1.20-3.2-forge+fabric" = _lRhNtS9H;
        "pkg-1.20.1-3.2-forge+fabric" = _aItQo0ly;
        "pkg-1.20.2-3.2-forge+fabric" = _Vf6ymu8V;
        "pkg-1.18.2-3.3-forge+fabric" = _PMP984TA;
        "pkg-1.19.2-3.3-forge+fabric" = _xnmHJr0a;
        "pkg-1.20.1-3.3-forge+fabric" = _jJcPpFSo;
        "pkg-1.20.2-3.3-forge+fabric" = _y64pimyg;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _BQ6u8HSL;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _Boa6ca3h;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _P23h60QI;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _PRdI6lkd;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _Ef2LJTi6;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _6l7kElRy;
        "pkg-1.20.5-3.4-fabric+neo" = _QaIIU7rR;
        "pkg-1.20.5-3.5-fabric+neo" = _poD9h7y0;
        "pkg-1.20.5-3.6-fabric+neo" = _feZ7tvmD;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _Q1HfJTox;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _i16RLaZR;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _OZhj7dPg;
        "pkg-1.20.6-3.7-fabric+forge+neo" = _gkB4X7oM;
        "pkg-1.21.0-3.7-fabric+forge+neo" = _uCNtIqI1;
        "pkg-1.21.1-3.7-fabric+forge+neo" = _wP9WiZ3h;
        "pkg-1.21.2-3.7-fabric+neo" = _WJoopxnE;
        "pkg-1.21.3-3.7-fabric+forge+neo" = _auAPrLzX;
        "pkg-1.21.4-3.7-fabric+forge+neo" = _hBpzx3QA;
        "pkg-1.20.1-3.8-fabric+forge+neo" = _rck0jB5V;
        "pkg-1.21.1-3.8-fabric+forge+neo" = _V9fO9wka;
        "pkg-1.21.4-3.8-fabric+forge+neo" = _OgUP3Ym0;
        "pkg-1.21.5-3.8-fabric+forge+neo" = _HTflp7fQ;
        "pkg-1.21.6-3.8-fabric+forge+neo" = _eVkQN1h3;
        "pkg-1.21.6-3.9-fabric+forge+neo" = _AKZDrkRo;
        "pkg-1.21.7-3.9-fabric+forge+neo" = _KUbnssGq;
        "pkg-1.21.8-3.9-fabric+forge+neo" = _HqdcWin6;
        "pkg-1.21.9-3.9-fabric+forge+neo" = _u4HlwDRD;
        "pkg-1.21.10-3.9-fabric+forge+neo" = _n3h8NUf3;
        "pkg-1.21.11-3.9-fabric+forge+neo" = _K3D0y80V;
        "pkg-26.1.0-3.9-fabric+forge+neo" = _gh4NMJ3K;
        "pkg-26.1.1-3.9-fabric+forge+neo" = _fpiRMnTa;
        "pkg-26.1.2-3.9-fabric+forge+neo" = _DgZNW1k0;
        "pkg-26.2.0-3.9-fabric+forge+neo" = _BpqOYuD4;
        "default" = _BpqOYuD4;
    });
