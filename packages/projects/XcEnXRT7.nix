...
let
    ...
    in {
        ...
        "pkg-1.5.0+98a361d36e" = _AATQe8tk;
        "pkg-1.5.0+619bc4b72c" = _o4nOb8Z1;
        "pkg-1.5.1+250830a839" = _C8QnrMVR;
        "pkg-1.5.1+5ac82e01c9" = _W7bLNEgZ;
        "pkg-1.5.2+2090972a50" = _dWChlBD7;
        "default" = _dWChlBD7;
    });
