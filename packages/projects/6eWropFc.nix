...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc.1.20.1" = _evdRBl9K;
        "pkg-1.0.1+mc.1.20.1" = _FeA2CJMB;
        "pkg-1.0.2+mc.1.20.1" = _GDEPZoSW;
        "pkg-1.0.3+mc.1.20.1" = _61qSvT5L;
        "pkg-1.0.4+mc.1.20.4" = _EdQ4vgJM;
        "pkg-1.0.5+mc.1.20.4" = _CL65J9AP;
        "pkg-1.0.6+mc.1.20.4" = _NoGJ5ZMW;
        "pkg-1.0.7+mc.1.20.4" = _jm2iFPZ2;
        "pkg-1.0.8+mc.1.20.4" = _SMVDwoAo;
        "pkg-1.0.9+mc.1.20.4" = _oo26D6rH;
        "pkg-1.0.10+mc.1.20.4" = _FFqmsODm;
        "pkg-1.0.11+mc.1.20.4" = _YI7iJQNi;
        "pkg-1.0.12+mc.1.20.4" = _CDMPlqCt;
        "pkg-1.0.13+mc.1.20.4" = _3u2MWnMo;
        "pkg-1.0.14+mc.1.20.4" = _nEhlH2LD;
        "pkg-1.1.0+mc.1.21-fabric" = _nDU2nJ9i;
        "pkg-1.1.0+mc.1.21-neoforge" = _smsuG7oT;
        "pkg-1.1.1+mc.1.21.1-neoforge" = _uPEVs4JJ;
        "pkg-1.1.1+mc.1.21.1-fabric" = _RFoa1fbK;
        "pkg-1.1.2+mc.1.21.1-fabric" = _NR9UdZq1;
        "pkg-1.1.2+mc.1.21.1-neoforge" = _5yYwguWk;
        "pkg-1.1.3+mc.1.21.1-neoforge" = _jonLzyfh;
        "pkg-1.1.3+mc.1.21.1-fabric" = _DqtuLsRl;
        "pkg-1.1.4+mc.1.21.1-neoforge" = _SrmuTqb5;
        "pkg-1.1.5+mc.1.21.1-neoforge" = _9wYXbOMX;
        "pkg-1.1.6+mc.1.21.1-neoforge" = _bJzVBjOe;
        "pkg-1.1.7+mc.1.21.1-neoforge" = _Yw9tcnpU;
        "pkg-1.1.8+mc.1.21.1-neoforge" = _kH9FeSpb;
        "pkg-1.1.8+mc.1.21.1-fabric" = _uI0tHIjU;
        "pkg-1.1.9+mc.1.21.1-neoforge" = _YhKVrs0T;
        "pkg-1.1.9+mc.1.21.1-fabric" = _r2yLtPiI;
        "pkg-1.1.10+mc.1.21.1-neoforge" = _V9WGfrZf;
        "pkg-1.1.10+mc.1.21.1-fabric" = _O3XGbO3o;
        "pkg-1.1.11+mc.1.21.1-fabric" = _VRkzlx02;
        "pkg-1.1.11+mc.1.21.1-neoforge" = _nHt7GtFg;
        "pkg-1.1.12+mc.1.21.1-fabric" = _eH2E2jw8;
        "pkg-1.1.12+mc.1.21.1-neoforge" = _LLUZGlLk;
        "pkg-1.1.13+mc.1.21.1-fabric" = _YEUrr52B;
        "pkg-1.1.14+mc.1.21.1-fabric" = _WJrdQtCK;
        "pkg-1.1.15+mc.1.21.1-fabric" = _yFv5eBUV;
        "pkg-1.1.15+mc.1.21.1-neoforge" = _OKEaLO9C;
        "pkg-1.1.16+mc.1.21.1-fabric" = _kEmwCfUU;
        "pkg-1.1.18+mc.1.21.1-fabric" = _UATnaiHO;
        "pkg-1.1.18+mc.1.21.1-neoforge" = _Sf76K57m;
        "default" = _Sf76K57m;
    });
