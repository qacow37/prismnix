...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.8-58.1.7" = _UUdaTPG2;
        "pkg-1.0.0-forge-1.21.4-54.1.8" = _KjPZZ6kN;
        "pkg-1.0.0-forge-1.21.1-52.1.5" = _Wc8bcwN2;
        "pkg-1.0.0-forge-1.20.1-47.4.10" = _Bjq5AJZf;
        "pkg-1.0.0-fabric-1.21.8-0.134.0" = _6YzceoPj;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _xnXod0K6;
        "pkg-1.0.0-fabric-1.21.1-0.116.7" = _YExJb745;
        "pkg-1.0.0-neoforge-1.21.8-21.8.47" = _U7JSpJlp;
        "pkg-1.0.0-neoforge-1.21.4-21.4.155" = _JjvSWRBk;
        "pkg-1.0.0-neoforge-1.21.1-21.1.210" = _I3WwZ18h;
        "pkg-1.1.0-forge-1.21.10-60.0.0" = _BzIEBIL6;
        "pkg-1.1.0-fabric-1.21.10-0.135.0" = _dGks3ZIp;
        "pkg-1.1.0-neoforge-1.21.10-21.10.10-" = _A8NTUPWQ;
        "pkg-1.1.0-forge-1.21.8-58.1.7" = _UTIUjsFD;
        "pkg-1.1.0-neoforge-1.21.8-21.8.47." = _vkQ5Q8cb;
        "pkg-1.1.0-fabric-1.21.8-0.134.0" = _G3Q07NXV;
        "pkg-1.1.0-forge-1.21.4-54.1.8" = _b9z4smqL;
        "pkg-1.1.0-fabric-1.21.4-0.119.4" = _xKxmVAe6;
        "pkg-1.1.0-neoforge-1.21.4-21.4.155" = _PDFSraD8;
        "pkg-1.1.0-neoforge-1.21.1-21.1.210" = _Of71g6MR;
        "pkg-1.1.0-forge-1.21.1-52.1.5" = _PcdZaPBO;
        "pkg-1.1.0-fabric-1.21.1-0.116.7" = _oGDUiVAt;
        "pkg-1.1.0-forge-1.20.1-47.4.10" = _9aoDs8OD;
        "pkg-1.1.1-forge-1.21.11-61.0.2" = _pEXWjqlg;
        "pkg-1.1.1-neoforge-1.21.11-21.11.8-b" = _iQxFxbf8;
        "pkg-1.1.1-fabric-1.21.11-0.139.5" = _MfztXQNT;
        "pkg-1.1.1-fabric-1.21.5-0.128.2" = _jgTKg6FM;
        "pkg-1.1.1-fabric-1.20.1-0.92.7" = _D5yZZ0aD;
        "pkg-1.1.1-fabric-26.1.1-0.145.4" = _GvYmw7YI;
