...
let
    ...
    in {
        ...
        "pkg-2.0.2" = _X9Uy0cqY;
        "pkg-2.1.0" = _qjU7zY5H;
        "pkg-2.2.0+1.19.2" = _IAVwKKRQ;
        "pkg-2.2.0+1.19.3" = _w0aEvuq4;
        "pkg-2.2.0" = _NhfPIODK;
        "pkg-2.2.0+1.18.2" = _GRYeB6gc;
        "pkg-2.2.1+1.19.3" = _etvZA79F;
        "pkg-2.2.1+1.19.2" = _hY5n8XJ1;
        "pkg-2.2.1+1.18.2" = _ynarhnbZ;
        "pkg-2.3.0+1.18.2" = _fNQuYAQj;
        "pkg-2.3.0+1.19.2" = _v2k80pUN;
        "pkg-2.3.0+1.19.3" = _YrlvNUZF;
        "pkg-2.4.0+1.19.4" = _uIO3eSAd;
        "pkg-2.4.0+1.19.3" = _sntVzSDd;
        "pkg-2.4.0+1.18.2" = _r5V7F4Ug;
        "pkg-2.4.0+1.19.2" = _KFoS6drW;
        "pkg-3.0+1.20.1" = _SLmQVnRo;
        "pkg-3.1.0+1.20.2" = _6dr2LDHb;
        "pkg-3.1.0+1.20.1" = _vh1AuRDo;
        "pkg-3.1.0+1.19.4" = _72Wl1WB0;
        "pkg-3.1.0+1.19.2" = _pLmBP6b3;
        "pkg-3.1.0+1.20.4" = _noiwXZwN;
        "pkg-3.1.1+1.20.4" = _pLPGWZ62;
        "pkg-3.1.1+1.20.1" = _W76nQ5GJ;
        "pkg-4.0.0+1.20.4" = _h5NhpyzV;
        "pkg-4.0.0+1.20.1" = _Mm6RMmgp;
        "pkg-4.1.0+1.21.1" = _Q5rEbjWE;
        "pkg-4.1.1+1.21.1" = _zEoEeyvu;
        "pkg-4.2.0+1.21.1" = _d9CICWIp;
        "default" = _d9CICWIp;
    });
