...
let
    ...
    in {
        ...
        "pkg-1.0.13" = _YYgJDCR6;
        "pkg-1.0.14" = _YVLIBslE;
        "pkg-1.0.17" = _nNciA1da;
        "pkg-2.1.0" = _CnetLmWE;
        "pkg-2.1.2" = _KGmyTge6;
        "pkg-2.2.1" = _ZANfJnvI;
        "pkg-2.3.4" = _MO4nsdTK;
        "pkg-2.12.2" = _sCcKrOF0;
        "pkg-2.12.3" = _14rlZYlX;
        "pkg-2.12.6" = _Jk9aa6SY;
        "pkg-2.13.2" = _3ya85wiP;
        "pkg-2.14.0" = _Z9ipjwCK;
        "pkg-2.14.1" = _1YjjDj2b;
        "pkg-2.17.5" = _ceryBh1l;
        "pkg-2.17.7" = _E8CqIWr1;
        "pkg-2.18.11" = _20BaDqjQ;
        "pkg-2.19.7" = _EmzVvj5U;
        "pkg-2.19.15" = _WIw41jc2;
        "pkg-2.19.16" = _nXmr9L17;
        "pkg-3.0.4" = _J24PTP4A;
        "pkg-3.0.7" = _lcSTC3ja;
        "pkg-2.23.2" = _I5OgbMr2;
        "pkg-2.24.11" = _dYcvHXrw;
        "pkg-2.24.13" = _jriE03Fw;
        "pkg-3.0.8" = _jEBp93BM;
        "pkg-3.0.9" = _5MJjcBtF;
        "default" = _5MJjcBtF;
    });
