...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _AASJDT7v;
        "pkg-1.4.0" = _maIt60gL;
        "pkg-1.4.1-1.18" = _93siPg0e;
        "pkg-1.4.1" = _RLQP9U6b;
        "pkg-1.5.0+1.18" = _XraETmwy;
        "pkg-1.5.0+1.19" = _M3xjZE2k;
        "pkg-1.6.0" = _CTvplHoe;
        "pkg-1.7.0+1.19" = _m0i6g5E7;
        "pkg-1.7.1+1.19" = _flDrm4to;
        "pkg-1.7.1+22w43a" = _Tt3zyzzz;
        "pkg-1.7.2-1.19.3" = _azYrtNJ9;
        "pkg-1.7.3+1.19" = _UwWXm6bt;
        "pkg-1.7.3+1.19.3" = _MxwJqK5T;
        "pkg-1.7.4+1.19" = _HuoYq3E7;
        "pkg-1.8.0+1.19.4" = _9XWTMlED;
        "pkg-1.8.1+1.19.4" = _zAWwNTEr;
        "pkg-1.8.2+1.20" = _Ek4mkpRw;
        "pkg-1.9.0+1.20.2" = _N7rxLFKx;
        "pkg-1.9.1+1.20.4" = _zHrMiw65;
        "pkg-1.9.2+1.20.4" = _lRG4BJIp;
        "pkg-1.9.3+1.20.4" = _RJNC7iNo;
        "pkg-1.9.3+1.20" = _6PaMvgjC;
        "pkg-1.9.4+1.20.4" = _Wv0OBKYv;
        "pkg-1.9.4+1.20" = _xHOdr9un;
        "pkg-1.9.5+1.20.5" = _HWizO7gR;
        "pkg-1.9.7+1.21" = _rEUOfNLj;
        "pkg-1.10.0-beta.1-neoforge" = _wagi46pr;
        "pkg-1.10.0-beta.1-fabric" = _PGbMYGjB;
        "pkg-1.10.0-rc.1-fabric" = _7WIYCNhg;
        "pkg-1.10.0-rc.1-neoforge" = _UjN5ymNQ;
        "pkg-1.10.0-rc.2-neoforge" = _cYa9RB2c;
        "pkg-1.10.0-rc.2-fabric" = _mGb7rPpp;
        "pkg-1.10.0-neoforge" = _ddpGQC3p;
        "pkg-1.10.0-fabric" = _bwBto4CW;
        "pkg-1.10.1-neoforge" = _Clzdu8VZ;
        "pkg-1.10.1-fabric" = _V5zb0rx9;
        "pkg-1.10.2-neoforge" = _Cv0qjbNF;
        "pkg-1.10.2-fabric" = _9cbwfnOm;
        "pkg-1.10.3-neoforge" = _l3zgys4J;
        "pkg-1.10.3-fabric" = _3bg8IbA5;
        "pkg-1.10.4-neoforge" = _RMph1jhX;
        "pkg-1.10.4-fabric" = _JsJTIdUG;
        "pkg-1.10.5-neoforge" = _2Wr3PWby;
        "pkg-1.10.5-fabric" = _TEaYVxcN;
        "pkg-1.10.6-neoforge" = _nggDAnG0;
        "pkg-1.10.6-fabric" = _EK9zpQvX;
        "pkg-1.11.0-fabric" = _XInFdguf;
        "pkg-1.11.0-neoforge" = _iavZIQQO;
        "pkg-1.10.0.1-fabric" = _mZMBB8jx;
        "pkg-1.10.0.1-neoforge" = _oz41N6Dp;
        "pkg-1.11.1-neoforge" = _NeLlV9sm;
        "pkg-1.11.1-fabric" = _4wij8vWf;
        "pkg-1.11.2-fabric" = _IxI6CWSa;
        "pkg-1.11.2-neoforge" = _pLPrTcuU;
        "pkg-1.11.3-alpha.1-fabric" = _TldWAm98;
        "pkg-1.11.3-alpha.2-fabric" = _icNAxZqo;
        "pkg-1.11.3-beta.1-fabric" = _AaupPdUl;
        "pkg-1.11.3-beta.2-fabric" = _5fSRGerX;
        "pkg-1.11.3-beta.3-fabric" = _bsfTDtIw;
        "pkg-1.11.4-beta.1-fabric" = _uNOnRw8H;
        "pkg-1.12.0+1.21.11-neoforge" = _ZqQubSbK;
        "pkg-1.12.0+1.21.11-fabric" = _yXQyceiT;
        "pkg-1.12.1+26.1-fabric" = _EjUXGuCH;
        "pkg-1.12.1+26.1-neoforge" = _xtlHlwja;
        "pkg-1.12.1+26.2-fabric" = _5kdN2hnR;
        "pkg-1.12.1+26.2-neoforge" = _1QSUCrJj;
        "default" = _1QSUCrJj;
    });
