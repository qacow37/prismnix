...
let
    ...
    in {
        ...
        "pkg-1.5.0-fabric" = _IRCDI5zT;
        "pkg-1.5.1-fabric" = _b2awkCZ8;
        "pkg-1.5.0-forge" = _CKkw09C4;
        "pkg-1.5.1-forge" = _krfNCpOU;
        "pkg-1.5.2-fabric" = _4fsQChxF;
        "pkg-v1.5.2-forge" = _n0S2wlok;
        "pkg-1.5.2" = _z9CyKuJg;
        "default" = _z9CyKuJg;
    });
