...
let
    ...
    in {
        ...
        "pkg-1.3.5+mc.1.16.3" = _7G0hfqZr;
        "pkg-1.3.5+mc.1.17" = _G270m8rK;
        "pkg-1.3.5+mc.1.18" = _fotcMxN1;
        "pkg-1.3.6+mc.1.16.3" = _A73DkYik;
        "pkg-1.3.6+mc.1.17" = _Hj8EBboB;
        "pkg-1.3.6+mc.1.18" = _iWjDS07J;
        "pkg-1.3.7+mc.1.16.3" = _vepSCLeU;
        "pkg-1.3.7+mc.1.17" = _nQWZIen0;
        "pkg-1.3.7+mc.1.18" = _vUJRVHN4;
        "pkg-1.3.7+mc.1.18.2" = _XnFA9lqj;
        "pkg-1.3.7+mc.22w17a" = _WvPkOvFZ;
        "pkg-1.3.8+mc.1.16.3" = _KaleBGA3;
        "pkg-1.3.8+mc.1.17" = _i3TbPUzE;
        "pkg-1.3.8+mc.1.18.2" = _FlJ0SOQk;
        "pkg-1.3.8+mc.1.19-rc2" = _RcXP5WO3;
        "pkg-1.3.8+mc.1.19.3" = _zwIAbfoF;
        "pkg-1.3.9+mc.1.16.3" = _H6mZxcWb;
        "pkg-1.3.9+mc.1.17" = _N6wjlPEs;
        "pkg-1.3.9+mc.1.18.2" = _Nw8oGV0R;
        "pkg-1.3.9+mc.1.19-rc2" = _xQ9OkeHH;
        "pkg-1.3.9+mc.1.19.3" = _gjR89WbD;
        "pkg-1.3.9+mc.1.19.4" = _XceegAxv;
        "pkg-1.3.9+mc.1.20-pre2" = _cxa4Xr5x;
        "pkg-1.3.9+mc.1.20.1" = _97ZA8JmI;
        "pkg-1.3.10+mc.1.16.3" = _evNolzDf;
        "pkg-1.3.10+mc.1.17" = _CWoIEzQR;
        "pkg-1.3.10+mc.1.18.2" = _Mk9nOxT5;
        "pkg-1.3.10+mc.1.19-rc2" = _gvXiKlkm;
        "pkg-1.3.10+mc.1.19.3" = _ncvtVmYJ;
        "pkg-1.3.10+mc.1.19.4" = _VXFF5GSZ;
        "pkg-1.3.10+mc.1.20.1" = _HuXAp0GB;
        "pkg-1.3.10+mc.1.20.2" = _VYqXMuuW;
        "pkg-1.3.11+mc.1.20.2" = _vHqgt9Ra;
        "pkg-1.3.11+mc.1.20.4" = _DvE3qJNM;
        "pkg-1.4.0+mc1.16.5" = _LVr6SrIH;
        "pkg-1.4.0+mc1.17.1" = _zCQNKtup;
        "pkg-1.4.0+mc1.18.2" = _kva6819W;
        "pkg-1.4.0+mc1.19" = _eGSHKegn;
        "pkg-1.4.0+mc1.19.3" = _3dMwNAeH;
        "pkg-1.4.0+mc1.19.4" = _re9sU35w;
        "pkg-1.4.0+mc1.20" = _9BRqBVZY;
        "pkg-1.4.0+mc1.20.2" = _wTGbtrBt;
        "pkg-1.4.0+mc1.20.5" = _GYkA4Arc;
        "pkg-1.4.0+mc1.21.1" = _psHyetPO;
        "pkg-1.4.0+mc1.21.8" = _HQMpqsDI;
        "pkg-1.4.0+mc25w37a" = _LP9G0FBx;
        "pkg-1.4.1" = _dip3b30m;
        "pkg-1.5.0+mc1.20.2" = _n34lnmGr;
        "pkg-1.5.0+mc1.20.5" = _5EdhDR7X;
        "pkg-1.5.0+mc1.21.1" = _8VycPzXj;
        "pkg-1.5.0+mc1.21.3" = _shHHZ314;
        "pkg-1.5.0+mc1.21.8" = _3aM5Odwc;
        "pkg-1.5.1+mc1.21.9" = _Qb8vVIm2;
        "pkg-1.5.1+mc1.20.4" = _ME6JZqxQ;
        "pkg-1.6.1+mc1.14.4" = _LKGSCSQ9;
        "pkg-1.6.1+mc1.15.2" = _eTvjOOq1;
        "pkg-1.6.1+mc1.16.5" = _FHRoh4rn;
        "pkg-1.6.1+mc1.17.1" = _Oqwma594;
        "pkg-1.6.1+mc1.18.2" = _cGRUlLyl;
        "pkg-1.6.1+mc1.19" = _1jR2IN2d;
        "pkg-1.6.1+mc1.19.3" = _4yXjkyKr;
        "pkg-1.6.1+mc1.19.4" = _YDCDZrYD;
        "pkg-1.6.1+mc1.20" = _xZ7sIniM;
        "pkg-1.6.1+mc1.20.2" = _fXCLBpxv;
        "pkg-1.6.1+mc1.20.4" = _BDD4KLYQ;
        "pkg-1.6.1+mc1.20.5" = _fVm7tc0b;
        "pkg-1.6.1+mc1.21.1" = _hOq6QvqD;
        "pkg-1.6.1+mc1.21.3" = _532TvFss;
        "pkg-1.6.1+mc1.21.8" = _hWmaQI8k;
        "pkg-1.6.1+mc1.21.9" = _DJFf2P5H;
        "pkg-1.6.2+mc1.14.4" = _dFOWTTe3;
        "pkg-1.6.2+mc1.15.2" = _i4G1gsv2;
        "pkg-1.6.2+mc1.16.5" = _w8Eeb6D2;
        "pkg-1.6.2+mc1.17.1" = _n55WpGGL;
        "pkg-1.6.2+mc1.18.2" = _CaMfjaVH;
        "pkg-1.6.2+mc1.19" = _rUV07SC8;
        "pkg-1.6.2+mc1.19.3" = _kwP3eCkt;
        "pkg-1.6.2+mc1.19.4" = _aFodipnK;
        "pkg-1.6.2+mc1.20" = _jtO1Ca6P;
        "pkg-1.6.2+mc1.20.2" = _UmYMdtg2;
        "pkg-1.6.2+mc1.20.4" = _5MMe7T0B;
        "pkg-1.6.2+mc1.20.5" = _RMifuM72;
        "pkg-1.6.2+mc1.21.1" = _ne9dlbUN;
        "pkg-1.6.2+mc1.21.3" = _EbvVGBwU;
        "pkg-1.6.2+mc1.21.8" = _zrawiqTa;
        "pkg-1.6.2+mc1.21.9" = _Ns8Ir695;
        "pkg-1.6.3+mc1.14.4" = _tHq38cJQ;
        "pkg-1.6.3+mc1.15.2" = _OnVwWrgJ;
        "pkg-1.6.3+mc1.16.5" = _yPlhhGwD;
        "pkg-1.6.3+mc1.17.1" = _VOoQHCHU;
        "pkg-1.6.3+mc1.18.2" = _HevwHZzP;
        "pkg-1.6.3+mc1.19" = _zfqFHiy0;
        "pkg-1.6.3+mc1.19.3" = _Qzrjj7BR;
        "pkg-1.6.3+mc1.19.4" = _KiKmI7qO;
        "pkg-1.6.3+mc1.20" = _quQYWYit;
        "pkg-1.6.3+mc1.20.2" = _KTjkC1Ix;
        "pkg-1.6.3+mc1.20.4" = _ZMrHuYCn;
        "pkg-1.6.3+mc1.20.5" = _H25AfgeK;
        "pkg-1.6.3+mc1.21.1" = _A4ni2nvH;
        "pkg-1.6.3+mc1.21.3" = _rcQzMZgW;
        "pkg-1.6.3+mc1.21.8" = _b5gH7iNI;
        "pkg-1.6.3+mc1.21.9" = _kYMaHnSI;
        "pkg-1.6.3+mc26.1-rc-1" = _lLqrcOIz;
        "pkg-1.6.4+mc26.1-rc-1" = _fv4mBH9D;
        "pkg-1.6.5+mc26.1-rc-1" = _OsFcXOik;
        "pkg-1.6.5+mc26.2-pre-2" = _amSqflWR;
        "default" = _amSqflWR;
    });
