...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _g1p5MqMp;
        "pkg-1.0.2" = _BzywkPzd;
        "pkg-2.0.0-1.20.1" = _Ti9Dq7s6;
        "pkg-2.0.1-1.20.1" = _tDP1YmWv;
        "pkg-2.0.2-1.20.1" = _Hhva9FOV;
        "pkg-2.0.1" = _wOgxIUyq;
        "pkg-2.1.0-1.20.1-Forge-Neoforge" = _7cSWlz1C;
        "pkg-2.1.0-NeoForge" = _nfemOv8t;
        "pkg-2.1.1-forge-neoforge-1.20.1" = _4gp3yd2E;
        "pkg-2.1.1-neoforge-1.21" = _IHKB1Ito;
        "pkg-2.1.2-Forge-NeoForge-1.20.1" = _Twli25gV;
        "pkg-2.1.2-NeoForge-1.21" = _x6yOUGxm;
        "pkg-2.2.0-neoforge-1.21" = _1ZT3rZYz;
        "pkg-2.2.0-forge-neoforge-1.20.1" = _v8dqL2AF;
        "pkg-2.2.1-forge-neoforge-1.20.1" = _BJfpNaz4;
        "pkg-2.2.1-neoforge-1.21" = _fYxwiPlC;
        "pkg-2.3.0-forge-neoforge-1.20.1" = _RMoa7q0G;
        "pkg-2.3.0-neoforge-1.21" = _IZhnAaEy;
        "pkg-2.4.0-forge-neoforge-1.20.1" = _M1HtO1H9;
        "pkg-2.4.0-neoforge-1.21" = _iqs3hBsM;
        "pkg-2.4.1_forge-neoforge-1.20.1" = _CTyictyu;
        "pkg-2.4.1_neoforge_1.21" = _lIA14iXS;
        "pkg-2.4.2" = _YFu5nvtT;
        "default" = _YFu5nvtT;
    });
