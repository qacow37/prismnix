...
let
    ...
    in {
        ...
        "pkg-2.9.3" = _80agkavo;
        "pkg-2.9.4" = _J4vEvOpk;
        "pkg-2.10.0" = _u82BSDBU;
        "pkg-2.10.1" = _3RYkksXm;
        "pkg-2.11.1" = _EwSAJHdI;
        "pkg-2.12.0" = _Zcz1nEg0;
        "pkg-2.12.1" = _cTB2K2OQ;
        "pkg-2.12.2" = _9sXcP300;
        "pkg-2.13.0" = _cJQIja93;
        "pkg-2.13.1" = _bXZo6Xhg;
        "pkg-2.14.0" = _J7JiP1PS;
        "pkg-2.14.1" = _5ECc44Zq;
        "pkg-2.14.2" = _SxMmygiB;
        "pkg-2.15.0" = _KBcoHUln;
        "pkg-2.15.1" = _pdHEBjsU;
        "pkg-2.15.2" = _pYjoHAtr;
        "pkg-2.15.3" = _iL4FlGFK;
        "default" = _iL4FlGFK;
    });
