...
let
    ...
    in {
        ...
        "pkg-8.1.1" = _Rziogm0v;
        "pkg-9.0.1" = _bwGVYMXA;
        "pkg-10.0.1" = _TkuhVy9z;
        "pkg-10.0.2" = _50StgD2R;
        "pkg-11.0.1" = _rn9YJS3L;
        "pkg-12.0.1" = _xbuuVi0y;
        "pkg-13.0.1" = _BvgreCnw;
        "pkg-13.0.2" = _pcHsjY2j;
        "pkg-14.0.1" = _k9qzBf7j;
        "pkg-14.0.2" = _eikaL3OE;
        "pkg-15.0.1" = _S1i3XBc4;
        "pkg-16.0.2" = _kdcpWy9Q;
        "pkg-16.0.3" = _OVtF9iCU;
        "pkg-13.0.3" = _SyZy5nab;
        "pkg-16.0.4" = _ETEjy4DZ;
        "pkg-21.1.1" = _drofPZEo;
        "pkg-21.1.2" = _W15ZbWlR;
        "pkg-13.0.4" = _b4yBJsLD;
        "pkg-26.1.2.1" = _mVxDL2ji;
        "pkg-26.1.2.3" = _dDBL1FfO;
