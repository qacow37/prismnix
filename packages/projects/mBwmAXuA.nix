...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _os08Loyg;
        "pkg-1.1.1+mod" = _uwonGiLN;
        "pkg-1.1.3" = _dNUSaSgm;
        "pkg-1.1.3+mod" = _IuyWZSip;
        "pkg-1.1.3-mc1.20.4" = _lPHnd2Z5;
        "pkg-1.1.3-mc1.20.4+mod" = _J2sonFeH;
        "pkg-1.2+1.20.6" = _a3puGYuj;
        "pkg-1.2+1.20.6+mod" = _72cyN8af;
        "pkg-1.2.1+1.21" = _63MBgLjB;
        "pkg-1.2.1+1.21+mod" = _XB9n6qXB;
        "pkg-1.2.2-mc1.21.3" = _ZOnA7HwI;
        "pkg-1.2.2-mc1.21.3+mod" = _qG5oC5ou;
        "pkg-1.2.2-mc1.21.4" = _1a3coYza;
        "pkg-1.2.2-mc1.21.4+mod" = _lSRM0gMW;
        "pkg-1.2.3-mc1.21.5" = _S7PZh0gZ;
        "pkg-1.2.3-mc1.21.5+mod" = _QN0UGdqI;
        "pkg-1.2.4-mc1.21.6" = _uEmrxz1R;
        "pkg-1.2.4-mc1.21.6+mod" = _UNI6ikiq;
        "pkg-1.3-mc1.21.9" = _3hT2Vf6b;
        "pkg-1.3-mc1.21.9+mod" = _L2CUkvdd;
        "pkg-1.3.1-mc1.21.10" = _asTuAu24;
        "pkg-1.3.1-mc1.21.10+mod" = _cFRVEQOH;
        "pkg-1.3.1-mc1.21.11" = _YerLanfG;
        "pkg-1.3.1-mc1.21.11+mod" = _umWh2she;
        "pkg-1.3.1-mc26.1" = _U9SAkAH1;
        "pkg-1.3.1-mc26.1+mod" = _mi5BAzWb;
        "pkg-1.3.2-mc26.1" = _fow6ZqfK;
