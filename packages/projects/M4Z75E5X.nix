...
let
    ...
    in {
        ...
        "pkg-1.0.27X4277" = _yUgoxVOA;
        "pkg-1.0.27X4291" = _g5Z0DhM7;
        "pkg-1.0.27X4312" = _mPVlXFhn;
        "pkg-1.0.27X4327" = _euhfez1Y;
        "pkg-1.0.27X4333" = _RHQ0Hicm;
        "pkg-1.0.27X4347" = _b0E3M3Sc;
        "pkg-1.0.27X4395" = _TeB1StnZ;
        "pkg-1.0.27X4410" = _wqRCPFd2;
        "pkg-1.0.27X4417" = _REbbIYaU;
        "pkg-1.0.27X4438" = _yH59kIRq;
        "pkg-1.0.27X4522" = _3qlKxYpH;
        "pkg-X4655" = _sNdZuiI7;
        "pkg-X4704" = _hy7FHxfY;
        "pkg-X4705" = _PXJcTQXp;
        "pkg-X4746" = _DU5FIMnI;
