...
let
    ...
    in {
        ...
        "pkg-v1.2.0Beta23(1.7.10)" = _RHWtV7WV;
        "pkg-v1.1.0(1.7.10)" = _J8Sb1lv3;
        "pkg-v1.1.0(1.7.2)" = _FRIuggx6;
        "pkg-v1.2.0Beta24(1.7.10)" = _eDpFP1aq;
        "pkg-v1.2.0(1.7.10)" = _5lL8eoSC;
        "pkg-v1.2.0a(1.7.10)" = _YdoAfXVe;
        "pkg-v1.2.0b(1.7.10)" = _CAZNylAx;
        "pkg-1.7.10-1.2.1-1" = _K66t3LGa;
        "pkg-1.7.10-1.2.1a-1" = _BngWxfXp;
        "pkg-1.7.10-1.2.1b-1" = _UJsTLp6J;
        "pkg-1.7.10-1.3.0Beta-4" = _P5H8510Z;
        "pkg-1.7.10-1.3.0Beta-5" = _ii9JKzUv;
        "pkg-1.7.10-1.3.0Beta-6" = _gNujuIyb;
        "pkg-1.7.10-1.3.0-1" = _KitIGxc1;
        "pkg-1.7.10-1.3.0a-1" = _YJyU4oK2;
        "pkg-1.7.10-1.3.0b-3" = _4bmWYUJ8;
        "pkg-1.7.10-1.3.1-1" = _ZtaBMbyg;
        "pkg-1.7.10-1.3.1-2" = _oIKdCFMm;
        "pkg-1.7.10-1.3.1-3" = _l7asfPgz;
        "pkg-1.7.10-1.3.1-4" = _tTouQiUp;
        "pkg-1.7.10-1.3.1-5" = _EWRKP5Z5;
        "pkg-1.7.10-1.3.1-7" = _hDzbUduo;
        "pkg-1.7.10-1.3.2-1" = _Ll47gv5n;
        "pkg-1.7.10-1.3.3-2" = _GrTyolpy;
        "pkg-1.7.10-1.3.3-3" = _OzPm6fkD;
        "pkg-1.7.10-1.3.3-4" = _ATE7861p;
        "pkg-1.7.10-1.3.3-5" = _stzqLEB8;
        "pkg-1.7.10-1.3.3-6" = _RhpbiCDl;
        "pkg-1.7.10-1.3.3-7" = _MSoMVFnz;
        "pkg-1.7.10-1.3.3-10" = _nBd9XPBa;
        "pkg-1.7.10-1.3.3-11" = _fJHw6e6o;
        "pkg-1.7.10-1.3.3-12" = _tUFmJlw8;
        "pkg-1.7.10-1.3.3-13" = _tKfLwokW;
        "pkg-1.7.10-1.3.3-15" = _k1aknywe;
        "pkg-1.7.10-1.3.3-17" = _zNdLXvCW;
        "pkg-1.8.9-2.0.0-1" = _2gop79L6;
        "pkg-1.8.9-2.0.0-2" = _RmHetikK;
        "pkg-1.8.9-2.0.0-3" = _opw4W2ed;
        "pkg-1.8.9-2.0.0-4" = _CponSuiu;
        "pkg-1.8.9-2.0.0-5" = _9ErYbCNZ;
        "pkg-1.8.9-2.0.0-6" = _pZO7SitR;
        "pkg-1.8.9-2.0.0-7" = _CN2IzYZY;
        "pkg-1.8.9-2.0.0-8" = _VdFxMbWX;
        "pkg-1.8.9-2.0.0-9" = _d4BQw8ml;
        "pkg-1.8.9-2.0.0-10" = _KPrALD8D;
        "pkg-1.8.9-2.0.0-11" = _kY3F2BsD;
        "pkg-1.8.9-2.0.0-13" = _uvVxmBPR;
        "pkg-1.8.9-2.0.0-14" = _H9X4kOOJ;
        "pkg-1.8.9-2.0.0-15" = _fYs45YDQ;
        "pkg-1.8.9-2.0.0-16" = _Z95SAAB8;
        "pkg-1.8.9-2.0.0-17" = _Y1zZedTO;
        "pkg-1.8.9-2.0.0-18" = _ISjdJRi9;
        "pkg-1.8.9-2.0.0-19" = _FrM4rycO;
        "pkg-1.8.9-2.0.0-20" = _bOVRt5OL;
        "pkg-1.9-2.0.0-21" = _nnwgOnUq;
        "pkg-1.9-2.0.0-22" = _8UQgQ7G7;
        "pkg-1.9-2.0.0-25" = _Ji4NYwNA;
        "pkg-1.9-2.0.0-26" = _oTNjRU1T;
        "pkg-1.9-2.0.0-27" = _LQ4v6pTS;
        "pkg-1.9-2.0.0-28" = _68PjJecg;
        "pkg-1.9-2.0.0-29" = _1eE3f67W;
        "pkg-1.9-2.0.0-30" = _A7Q6hSRn;
        "pkg-1.9-2.0.0-31" = _XGr2mnug;
        "pkg-1.9-2.0.0-32" = _LNEc0bdD;
        "pkg-1.9-2.0.0-33" = _6FKpnabS;
        "pkg-1.9-2.0.0-34" = _V4sQz6kX;
        "pkg-1.9-2.0.0-35" = _Us4Xm3XG;
        "pkg-1.9-2.0.0-36" = _cg7MaZKz;
        "pkg-1.9-2.0.0-37" = _FS61G2Lx;
        "pkg-1.9-2.0.0-38" = _friNu5Lh;
        "pkg-1.9.4-2.0.0-39" = _L51sD8IB;
        "pkg-1.9.4-2.0.1-40" = _BsUmjGLu;
        "pkg-1.9.4-2.0.1-42" = _5Wah7wmt;
        "pkg-1.9.4-2.0.1-43" = _lyyYnTc2;
        "pkg-1.9.4-2.0.1-44" = _VZHnxiTm;
        "pkg-1.9.4-2.0.2-45" = _YBkUeiQW;
        "pkg-1.9.4-2.0.2-46" = _PD5E4KSD;
        "pkg-1.9.4-2.0.2-47" = _yNG0bLPp;
        "pkg-1.9.4-2.0.2-48" = _X3PFcgoy;
        "pkg-1.9.4-2.0.2-49" = _G4iYKHZy;
        "pkg-1.9.4-2.0.2-50" = _SMb6Twzr;
        "pkg-1.9.4-2.0.3-51" = _OvvS8Mgy;
        "pkg-1.9.4-2.0.3-52" = _kmy6rPsD;
        "pkg-1.9.4-2.0.3-53" = _cb6o6Eq8;
        "pkg-1.9.4-2.0.3-54" = _VYJbifoQ;
        "pkg-1.9.4-2.0.4-55" = _nOLvBDJ1;
        "pkg-1.9.4-2.0.4-56" = _ruj8EP2y;
        "pkg-1.9.4-2.0.4-58" = _ejBWZDEa;
        "pkg-1.9.4-2.1.0-59" = _IC3d48vd;
        "pkg-1.9.4-2.1.0-60" = _PwEhftHy;
        "pkg-1.9.4-2.1.0-61" = _rsJ7C5Sy;
        "pkg-1.9.4-2.1.0-63" = _5e3iWkIB;
        "pkg-1.9.4-2.1.0-64" = _RoEUfzXV;
        "pkg-1.9.4-2.1.0-65" = _yQoyAoi0;
        "pkg-1.9.4-2.1.0-66" = _pDHXdUSI;
        "pkg-1.9.4-2.1.0-67" = _xu1VgR0y;
        "pkg-1.9.4-2.1.0-68" = _VuTD225e;
        "pkg-1.9.4-2.1.0-69" = _sAMx7oa0;
        "pkg-1.10.2-2.1.1-70" = _uZTNUokr;
        "pkg-1.11-2.1.1-70" = _tKZIVR8T;
        "pkg-1.11-2.1.2-71" = _bPLpo9dI;
        "pkg-1.10.2-2.1.2-71" = _AfsYB9lo;
        "pkg-1.11-2.1.3-72" = _5BlulgDO;
        "pkg-1.10.2-2.1.3-72" = _WKkurFWl;
        "pkg-1.10.2-2.1.4-73" = _2CIuZygx;
        "pkg-1.11-2.1.4-73" = _XGEIJWdp;
        "pkg-1.11-2.1.5-74" = _tPyFSrSJ;
        "pkg-1.10.2-2.1.5-74" = _7Ro7J109;
        "pkg-1.11-2.1.6-75" = _9IRh5w4N;
        "pkg-1.10.2-2.1.6-75" = _BNMVivU1;
        "pkg-1.11-2.1.7-76" = _O04ppeXy;
        "pkg-1.10.2-2.1.7-76" = _7HxKZLDl;
        "pkg-1.11-2.1.8-77" = _CyM0kR9Z;
        "pkg-1.10.2-2.1.8-77" = _V2vlexIp;
        "pkg-1.11-2.1.9-78" = _STN1fmPG;
        "pkg-1.10.2-2.1.9-78" = _8btjXmcT;
        "pkg-1.11-2.1.10-79" = _BPmIJ7Gx;
        "pkg-1.10.2-2.1.10-79" = _NwmqDJN3;
        "pkg-1.11-2.1.11-80" = _G01XBOLS;
        "pkg-1.10.2-2.1.11-80" = _cqvrhWdZ;
        "pkg-1.12.2-2.2.0-82" = _kdCJGnDS;
        "pkg-1.12.2-2.2.1-83" = _jxoVgwYd;
        "pkg-1.12.2-2.2.2-85" = _KQo1SKFY;
        "pkg-1.12.2-2.2.3-86" = _Iu8YeUSI;
        "pkg-1.12.2-2.2.4-87" = _8x6c9ouc;
        "pkg-1.12.2-2.2.5-88" = _Hyn44fHJ;
        "pkg-1.12.2-2.2.6-89" = _UdnzPppM;
        "pkg-1.12.2-2.2.7-90" = _GMLrIukd;
        "pkg-1.12.2-2.2.8-91" = _GKa8Q35O;
        "pkg-1.12.2-2.2.8-92" = _lagzDiOS;
        "pkg-1.12.2-2.2.10-93" = _ZDeaTBMZ;
        "pkg-1.12.2-2.2.11-96" = _riFrJREI;
        "pkg-1.12.2-2.2.12-97" = _YJnMeDev;
        "pkg-1.12.2-2.3.0-98" = _k0glNwcf;
        "pkg-1.12.2-2.3.1-99" = _NlLLm0mc;
        "pkg-1.12.2-2.3.2-100" = _YZe8I31Z;
        "pkg-1.12.2-2.3.3-101" = _eHzvvDZd;
        "pkg-1.12.2-2.4.0-102" = _yoFaqlB8;
        "pkg-1.12.2-2.4.1-103" = _x7WSA1ox;
        "pkg-1.12.2-2.4.2-104" = _bmUYP45D;
        "pkg-1.12.2-2.4.3-105" = _GtMIuGOR;
        "pkg-1.16.3-3.0.0-1" = _EIfCCjTV;
        "pkg-1.16.3-3.0.0-3" = _l1rv9D8D;
        "pkg-1.16.3-3.0.1-6" = _sNtJkPuj;
        "pkg-1.16.3-3.0.2-7" = _GU2ugrvh;
        "pkg-1.16.3-3.0.3-8" = _HNlePk2w;
        "pkg-1.16.3-3.0.4-9" = _6NUrENXk;
        "pkg-1.16.3-3.0.5-10" = _gWl0bqMV;
        "pkg-1.16.3-3.0.6-11" = _kdAfe1sa;
        "pkg-1.16.4-3.1.0-15" = _nuiro8Sg;
        "pkg-1.16.4-3.1.1-16" = _pzyijacJ;
        "pkg-1.16.4-3.1.2-17" = _tHOd5trS;
        "pkg-1.16.4-3.1.3-18" = _Nmw1Zs60;
        "pkg-1.16.4-3.1.4-24" = _UbFLpwDf;
        "pkg-1.16.4-3.1.5-25" = _5wtqCfA3;
        "pkg-1.16.4-3.1.6-26" = _FcuOxrUU;
        "pkg-1.16.4-3.1.7-27" = _VtjGMLY9;
        "pkg-1.16.4-3.1.8-28" = _iuU2pnAL;
        "pkg-1.16.4-3.1.9-29" = _22S7kRJK;
        "pkg-1.16.4-3.1.9-30" = _Vkw6iuHa;
        "pkg-1.16.4-3.1.10-31" = _InO0Os3P;
        "pkg-1.16.4-3.1.10-32" = _b73UZ2R9;
        "pkg-1.16.4-3.1.11-34" = _6D9lsJNQ;
        "pkg-1.18.2-3.2.0-35" = _vCZrHEKc;
        "pkg-1.18.2-3.2.1-36" = _bta18uAt;
        "pkg-1.18.2-3.2.2-37" = _1eygylyc;
        "pkg-1.16.4-3.1.12-38" = _O059qIY6;
        "pkg-1.18.2-3.2.3-38" = _xml41LtX;
        "pkg-1.16.4-3.1.13-39" = _PC6E2bcI;
        "pkg-1.18.2-3.2.4-39" = _ca9xYZXA;
        "pkg-1.18.2-3.2.5-40" = _wuMao28u;
        "pkg-1.18.2-3.2.6-41" = _cNDVGrJz;
        "pkg-1.20.1-3.3.0-42" = _7Mg53Sit;
        "pkg-1.20.1-3.3.1-43" = _9OUJc8lt;
        "pkg-3.3.2-44" = _KFYCrtLV;
        "pkg-1.20.1-3.3.3-45" = _KoL2JNWd;
        "pkg-3.3.4-46" = _iUnAsKPv;
        "pkg-3.3.5-47" = _bgY3aWtr;
        "pkg-3.3.6-48" = _Z2LN0tSB;
        "pkg-3.3.7-49" = _BAihUKjr;
        "pkg-3.3.8-50" = _1YxwR16I;
        "default" = _1YxwR16I;
    });
