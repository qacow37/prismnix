...
let
    ...
    in {
        ...
        "pkg-0.5.5-1.18.2" = _2apQsIeD;
        "pkg-0.5.6-1.18.2" = _eOvkR8wo;
        "pkg-0.6.0-1.18.2" = _OYIUq66z;
        "pkg-0.6.1-1.18.2" = _ua9UOyEe;
        "pkg-0.7.0-1.19-pre1" = _uy74O6LT;
        "pkg-1.0.0-1.19" = _GgRmGWGP;
        "pkg-1.0.1-1.19" = _AZmBuJIm;
        "pkg-1.0.2-1.19" = _1gPO8gft;
        "pkg-1.1.0-1.19" = _EUqpShig;
        "pkg-1.1.1-1.19" = _CN8Nq0UV;
        "pkg-1.1.2-1.19" = _3pmZO1e8;
        "pkg-1.2.0-1.19" = _sz05AZqZ;
        "pkg-1.2.1-1.19" = _xhpral7e;
        "pkg-1.2.2-1.19.X" = _Z975rnrW;
        "pkg-1.2.3-1.19.X" = _HeRpu3la;
        "pkg-1.2.4-1.19.X" = _MStc8Dl4;
        "pkg-1.3.0-1.19.3" = _ElUM6olt;
        "pkg-1.3.1-1.19.3" = _nSImH309;
        "pkg-1.3.2-1.19.4" = _lRXqh3pM;
        "pkg-1.3.3-1.19.4" = _Ji3TcbRG;
        "pkg-1.3.4-1.19.4" = _pnbluwta;
        "pkg-1.3.5-1.20" = _jrPRoNt0;
        "pkg-1.3.6-1.20" = _pXmkO2BV;
        "pkg-1.3.7-1.20.2" = _aEyYsuoD;
        "pkg-1.3.8-1.20.4" = _WnTOFiin;
        "pkg-1.3.9-alpha.2-1.20.6" = _oQoRtzHz;
        "pkg-1.3.9-1.20.6" = _SrFHZEcn;
        "default" = _SrFHZEcn;
    });
