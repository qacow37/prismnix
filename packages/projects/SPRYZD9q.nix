...
let
    ...
    in {
        ...
        "pkg-0.0.8" = _vyNu3F3t;
        "pkg-0.0.9" = _s60diblx;
        "pkg-0.0.10" = _DM6rzBhx;
        "pkg-0.0.11" = _AqzMDmB4;
        "pkg-0.0.12" = _68qZmIZq;
        "pkg-0.0.13" = _8cRzYZuW;
        "pkg-0.0.14" = _4UjaHNZC;
        "pkg-0.0.15" = _p5cWXopp;
        "pkg-0.0.16" = _gyCZSCbS;
        "pkg-0.0.17" = _NtIfxNX5;
        "pkg-0.0.18" = _SjccfSJd;
        "pkg-0.0.19" = _tEKX6BVr;
        "pkg-0.0.20" = _DpP4ACVv;
        "pkg-0.0.21" = _u3QV1cga;
        "pkg-0.0.22" = _zzOf5nou;
        "pkg-0.0.23" = _i0EC4MLB;
        "pkg-0.0.24" = _gv07l2V7;
        "pkg-0.0.25" = _mLupo8Hp;
        "pkg-0.0.26" = _yCfNt1DW;
        "default" = _yCfNt1DW;
    });
