...
let
    ...
    in {
        ...
        "pkg-2.0.0" = _k5AcH5Lk;
        "pkg-2.0.1" = _PZXVuNTi;
        "pkg-3.0.0.2" = _eQbiWjZO;
        "pkg-2.0.1.2" = _1EkR9RSI;
        "pkg-3.0.0.3" = _4TL5N5hL;
        "pkg-3.0.0.4" = _YNR2Mps5;
        "pkg-3.0.0.5" = _IkHvLvtn;
        "pkg-3.0.0.6" = _i9Mhfdgo;
        "pkg-3.1.0.8" = _qASEDNgB;
        "pkg-3.1.0.9" = _g4Iy4y8K;
        "pkg-3.1.0.10" = _ZGua8D4u;
        "pkg-3.1.0.11" = _Niy2RT5i;
        "pkg-3.1.0" = _5qBF4aYp;
        "pkg-3.1.0.21" = _JjyruBdG;
        "pkg-3.1.0.22" = _7Jk0cSC6;
        "pkg-3.1.0.23" = _3PoRvV6e;
        "pkg-4.0.0.3" = _fYO1VOLP;
        "pkg-4.0.0.4" = _FpcaKTFN;
        "pkg-4.0.0.5" = _7pxGX69j;
        "pkg-4.0.0.6" = _XQr4XxeX;
        "pkg-4.0.0.7" = _L9tNz4kz;
        "pkg-5.0.0.1" = _A3wzlwHL;
        "pkg-5.0.0.2" = _ZXgI7zH7;
        "pkg-5.0.0.3" = _olhs7wfo;
        "pkg-5.0.0.4" = _Q6Iv1V8f;
        "pkg-5.0.0.5" = _eNopsAEF;
        "pkg-5.0.0.6" = _BCU9v3vy;
        "pkg-6.0.0.1" = _wNorhyeG;
        "pkg-6.0.0.2" = _JzdHles0;
        "pkg-7.0.0.1" = _rtmPbSAV;
        "pkg-8.0.0.1" = _14JCT9si;
        "pkg-7.0.0.4" = _UMxOy3vl;
        "pkg-8.0.0.3" = _lRaqLM6h;
        "pkg-11.0.3" = _XmuhAZCZ;
        "pkg-12.0.1" = _QjG6kLA0;
        "pkg-13.0.2" = _ZQSCn1wK;
        "pkg-13.0.3" = _Hhr0huM0;
        "pkg-13.0.4" = _syLV0zUy;
        "pkg-14.0.2" = _F9UgAKQA;
        "pkg-15.0.1" = _3mFR5ktP;
        "pkg-17.0.2" = _ag6Pl9wZ;
        "pkg-18.0.1" = _8hAwkJXR;
        "pkg-18.0.2" = _8t6RPm52;
        "pkg-19.0.1" = _mRaWQa28;
        "pkg-20.0.1" = _bT4aHGnZ;
        "pkg-21.0.1" = _A4iw4ZmM;
        "pkg-22.0.1" = _f0C3Pfr7;
        "pkg-23.0.1" = _2ZRoQPwy;
        "pkg-24.0.1" = _LTCxKhMr;
        "pkg-26.1.0.1" = _A1wB9QZ3;
        "pkg-26.1.0.2" = _TuXoDnJ8;
        "pkg-26.1.0.3" = _yKmaE8jG;
