...
let
    ...
    in {
        ...
        "pkg-1.19-5" = _vHSutB7S;
        "pkg-1.19.1-6" = _L5HnBSxo;
        "pkg-1.19.2-7" = _RfEsoJKz;
        "pkg-1.19.3-7" = _EkmHXtMt;
        "pkg-1.16.5-7-forge" = _gaKVurfk;
        "pkg-1.17.1-7-forge" = _wHkcTEeo;
        "pkg-1.18-7-forge" = _U8vjogSM;
        "pkg-1.18.1-7-forge" = _XyTQY8GU;
        "pkg-1.18.2-7-forge" = _ERHqK4dH;
        "pkg-1.19.1-7-forge" = _u1eCZ3Yh;
        "pkg-1.19.2-7-forge" = _OkjA2IOB;
        "pkg-1.19.3-7-forge" = _cpnGZM13;
        "pkg-1.19.4-7" = _F6wLTfQg;
        "pkg-1.19.4-7-forge" = _msoqb61A;
        "pkg-1.20-7" = _D2NwZCBW;
        "pkg-1.20-7-forge" = _RHNO4qa8;
        "pkg-1.20.1-7" = _JnIp5PUV;
        "pkg-1.20.1-7-forge" = _kGDjHM7I;
        "pkg-1.20.2-7" = _ArOWapgs;
        "pkg-1.20.2-7-forge" = _pOwSxTdg;
        "pkg-1.16.5-8-fabric" = _6wNpOPCc;
        "pkg-1.18.1-8-fabric" = _29JSUPzp;
        "pkg-1.18.2-8-fabric" = _Im18dnAl;
        "pkg-1.19-8-fabric" = _2ilBjFmv;
        "pkg-1.19.1-8-fabric" = _NnFEF1j2;
        "pkg-1.19.2-8-fabric" = _mj1QOrMb;
        "pkg-1.19.3-8-fabric" = _6aB5DC1f;
        "pkg-1.19.4-8-fabric" = _V3XyWpcz;
        "pkg-1.20-8-fabric" = _RfN0WOSY;
        "pkg-1.20.1-8-fabric" = _zl71ximA;
        "pkg-1.20.2-8-fabric" = _cS7GcFwD;
        "pkg-1.20.3-9-fabric" = _283514ii;
        "pkg-1.20.3-7-forge" = _3cRHFuCU;
        "pkg-1.20.4-7-forge" = _12ZfXCAA;
        "pkg-1.20.4-9-fabric" = _8Dz92ded;
        "pkg-1.20.4-0-neoforge" = _VmRZmCyw;
        "pkg-1.20.5-9-fabric" = _FvNCAQ2E;
        "pkg-1.20.6-9-fabric" = _RFVgfVJn;
        "pkg-1.20.6-0-neoforge" = _U9TR3jUe;
        "pkg-1.20.6-7-forge" = _gXQKj70T;
        "pkg-1.21-9-fabric" = _uqjo5K2u;
        "pkg-1.21-7-forge" = _ykbnDgAs;
        "pkg-1.21-0-neoforge" = _hz6DQXw4;
        "pkg-1.21.1-0-neoforge" = _hN8Xpsjz;
        "pkg-1.21.1-9-fabric" = _gjYDS7EF;
        "pkg-1.21.1-7-forge" = _czjsyo95;
        "pkg-1.21.2-9-fabric" = _ZqyAiHMq;
        "pkg-1.21.3-7-forge" = _8kX9SQcP;
        "pkg-1.21.3-0-neoforge" = _PsAWziSD;
        "pkg-1.21.4-9-fabric" = _E3YkzAub;
        "pkg-1.21.4-0-neoforge" = _jImELfKZ;
        "pkg-1.21.4-7-forge" = _3uugGJMN;
        "pkg-1.21.5-9-fabric" = _lRMIuCl4;
        "pkg-1.21.5-9-forge" = _dz1CCXL3;
        "pkg-1.21.5-9-neoforge" = _ATz66vIZ;
        "pkg-1.18.2-fabric-10" = _fJ89B8t7;
        "pkg-1.18.2-forge-10" = _mQflQ8OX;
        "pkg-1.19.2-fabric-10" = _UHdbtV09;
        "pkg-1.19.2-forge-10" = _xM1ncNNv;
        "pkg-1.19.4-fabric-10" = _Sp5US1gm;
        "pkg-1.19.4-forge-10" = _MEsW8rka;
        "pkg-1.20.1-fabric-10" = _VmKVjcTu;
        "pkg-1.20.1-forge-10" = _KTCQIxGK;
        "pkg-1.20.2-fabric-10" = _m8pklVob;
        "pkg-1.20.2-forge-10" = _9yK9egQ2;
        "pkg-1.20.6-fabric-10" = _ZJTMkBTP;
        "pkg-1.20.6-forge-10" = _85NL8b8R;
        "pkg-1.20.6-neoforge-10" = _vsSQzhwp;
        "pkg-1.21.1-fabric-10" = _62K6nKgi;
        "pkg-1.21.1-forge-10" = _1HToRSBI;
        "pkg-1.21.1-neoforge-10" = _Tz4bEbze;
        "pkg-1.21.3-fabric-10" = _qB0vLeHV;
        "pkg-1.21.3-forge-10" = _4YQQSUsZ;
        "pkg-1.21.3-neoforge-10" = _1VcD0p9H;
        "pkg-1.21.4-fabric-10" = _axElP5MC;
        "pkg-1.21.4-forge-10" = _9TryLo2T;
        "pkg-1.21.4-neoforge-10" = _bpqwHFYA;
        "pkg-1.21.5-fabric-10" = _vOSujgr9;
        "pkg-1.21.5-forge-10" = _D647bt5S;
        "pkg-1.21.5-neoforge-10" = _HwC1SpXh;
        "pkg-1.21.6-fabric-10" = _88zXEbj0;
        "pkg-1.21.6-forge-10" = _wJ2A6HYW;
        "pkg-1.21.6-neoforge-10" = _VSqhj3e7;
        "pkg-1.21.7-fabric-10" = _t0xW0Wks;
        "pkg-1.21.7-forge-10" = _rMa2cDlu;
        "pkg-1.21.7-neoforge-10" = _pqh7aJEE;
        "pkg-1.21.7-fabric-10.1" = _r93T9sAp;
        "pkg-1.21.7-forge-10.1" = _hz84nJBL;
        "pkg-1.21.7-neoforge-10.1" = _uofhUas0;
        "pkg-1.21.8-fabric-10.1" = _TFElVTs6;
        "pkg-1.21.8-forge-10.1" = _pZPAYYGQ;
        "pkg-1.21.8-neoforge-10.1" = _t6nrwxee;
        "pkg-1.21.9-fabric-10.1" = _b7heMpoJ;
        "pkg-1.21.9-forge-10.1" = _uRtqFM8s;
        "pkg-1.21.9-neoforge-10.1" = _USRCYdwA;
        "pkg-1.21.10-fabric-10.1" = _EhHMlfuo;
        "pkg-1.21.10-forge-10.1" = _1RkQgHTu;
        "pkg-1.21.10-neoforge-10.1" = _yWLRV2Ys;
        "pkg-1.21.11-fabric-10.1" = _bIWc0fDp;
        "pkg-1.21.11-forge-10.1" = _Egp4DBd8;
        "pkg-1.21.11-neoforge-10.1" = _44IjXqZR;
        "pkg-26.1.1-fabric-10.1" = _2j3EojDv;
        "pkg-26.1.1-forge-10.1" = _4K9Ubobj;
        "pkg-26.1.1-neoforge-10.1" = _k5uyJpUk;
        "pkg-26.1.2-fabric-10.1" = _5JbPNLOb;
        "pkg-26.1.2-forge-10.1" = _KyOiH8WO;
        "pkg-26.1.2-neoforge-10.1" = _I8s4dTFV;
        "pkg-26.1.2-neoforge-10.1.1" = _W3sUPqZQ;
