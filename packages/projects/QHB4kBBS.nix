...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _3CMQlbF9;
        "pkg-1.4.2" = _TCwbFrAO;
        "pkg-1.20-1.4.7.1" = _XErW9XWj;
        "pkg-1.20-1.5.0" = _mEV3prCf;
        "pkg-1.20-1.5.1" = _pj2LND8H;
        "pkg-1.20-1.5.2" = _2cIEmret;
        "pkg-1.20-1.5.4" = _ooLPTdLV;
        "pkg-1.5.5-forge+mc1.20.1" = _FGFwQQFy;
        "pkg-1.6.1-beta.2-neoforge" = _OsbvHyMJ;
        "pkg-1.6.1.2-forge+mc1.20.1" = _hVMhfTXG;
        "pkg-1.6.2.2-forge+mc1.20.1" = _9wdkPBt6;
        "pkg-1.6.3-forge+mc1.20.1" = _qOD7J6U7;
        "pkg-1.6.3.1-forge+mc1.20.1" = _LnnoLir3;
        "pkg-1.6.3.2-forge+mc1.20.1" = _x4wNuZ6M;
        "pkg-1.6.3.4-forge+mc1.20.1" = _E8czB34q;
        "pkg-1.6.4-forge+mc1.20.1" = _SH3xCu1K;
        "pkg-1.6.5-forge+mc1.20.1" = _h5flF9s3;
        "pkg-1.6.5.1-forge+mc1.20.1" = _Y7nbOAHp;
        "pkg-1.6.5-beta.1-neoforge" = _SfYhrrgx;
        "pkg-1.6.5.2-forge+mc1.20.1" = _DlVNfD1y;
        "pkg-1.7.0-forge+mc1.20.1" = _9g04mANX;
        "pkg-1.7.1.1-forge+mc1.20.1" = _qORn3kl8;
        "pkg-1.7.1.2-forge+mc1.20.1" = _2w7Q7WXL;
        "pkg-1.7.0-neoforge" = _J50dZEPV;
        "pkg-1.7.3-forge+mc1.20.1" = _Q3Opwdqx;
        "pkg-1.7.3.1-forge+mc1.20.1" = _DQN5b7TN;
        "pkg-1.7.3.2-forge+mc1.20.1" = _SbqPXeBo;
        "pkg-1.7.3.3-forge+mc1.20.1" = _adR826l8;
        "pkg-1.7.3.4-forge+mc1.20.1" = _HOWw0wE4;
        "pkg-1.7.3.5-forge+mc1.20.1" = _XQhQ8oMF;
        "pkg-1.7.3.7-forge+mc1.20.1" = _E7VCI8Qm;
        "pkg-1.7.3-neoforge" = _aO1RQcf3;
        "pkg-1.7.3.8-forge+mc1.20.1" = _SECX0Mzr;
        "pkg-1.8.0-forge+mc1.20.1" = _KZn63pPK;
        "pkg-1.8.0.1-forge+mc1.20.1" = _ShuXJMqY;
        "pkg-1.8.0-neoforge" = _9smoQA5q;
        "pkg-1.8.1-neoforge" = _gdSnbdFe;
        "pkg-1.8.0.2-beta2-forge+mc1.20.1" = _89YQJgfs;
        "pkg-1.8.1-forge+mc1.20.1" = _VAB4tjbb;
