...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.6-forge" = _A4oCbC4c;
        "pkg-1.18.2-1.7-forge" = _nx5vJcha;
        "pkg-1.19.2-1.8-forge" = _uzfOuem8;
        "pkg-1.19.3-1.8-forge" = _kxA9s2yM;
        "pkg-1.18.2-2.0-forge+fabric" = _7xefJ1Vc;
        "pkg-1.19.2-2.0-forge+fabric" = _DqMvwVHf;
        "pkg-1.19.3-2.0-forge+fabric" = _OUC9CaES;
        "pkg-1.18.2-2.1-forge+fabric" = _gagemb6I;
        "pkg-1.19.2-2.1-forge+fabric" = _qMHhMd1s;
        "pkg-1.19.3-2.1-forge+fabric" = _zn7UtEVW;
        "pkg-1.19.4-2.1-forge+fabric" = _R5w0Ca8x;
        "pkg-1.20-2.1-forge+fabric" = _4atvkbrj;
        "pkg-1.20.1-2.1-forge+fabric" = _iNrQi0mx;
        "pkg-1.20.2-2.1-forge+fabric" = _E9zNpeLc;
        "pkg-1.18.2-2.2-forge+fabric" = _1Kv7m4o6;
        "pkg-1.19.2-2.2-forge+fabric" = _tlk936yM;
        "pkg-1.20.1-2.2-forge+fabric" = _vws7XT1Z;
        "pkg-1.20.2-2.2-forge+fabric" = _L8VtuClO;
        "pkg-1.20.3-2.2-fabric+forge+neo" = _H0ssd3Jz;
        "pkg-1.20.4-2.2-fabric+forge+neo" = _JB0pHi3G;
        "pkg-1.19.2-2.3-fabric+forge+neo" = _uI2F9fRO;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _aDIZmqFf;
        "pkg-1.20.2-2.3-fabric+forge+neo" = _NPhpX4pl;
        "pkg-1.20.4-2.3-fabric+forge+neo" = _ZqYs6cSk;
        "pkg-1.20.5-2.3-fabric+neo" = _c9gc8nD3;
        "pkg-1.20.6-2.3-fabric+forge+neo" = _mMQ57mi0;
        "pkg-1.21.0-2.3-fabric+forge+neo" = _V9DAfJKf;
        "pkg-1.21.1-2.4-fabric+forge+neo" = _oi5aImAx;
        "pkg-1.21.4-2.4-fabric+forge+neo" = _pNQHXeXk;
        "pkg-1.21.5-2.4-fabric+forge+neo" = _3JDmsq4K;
        "pkg-1.21.6-2.4-fabric+forge+neo" = _wT4jpBy5;
        "pkg-1.21.7-2.4-fabric+forge+neo" = _hN3UWi2C;
        "pkg-1.21.8-2.4-fabric+forge+neo" = _oT49oX4O;
        "pkg-1.21.9-2.4-fabric+forge+neo" = _GH3yuYvN;
        "pkg-1.21.10-2.4-fabric+forge+neo" = _BSko5tJc;
        "pkg-1.21.11-2.4-fabric+forge+neo" = _OS9Hvrpd;
        "pkg-26.1.0-2.4-fabric+forge+neo" = _zSVcnSjq;
        "pkg-26.1.1-2.4-fabric+forge+neo" = _dWGbEB5f;
        "pkg-26.1.2-2.4-fabric+forge+neo" = _wKjZCn2V;
        "pkg-26.2.0-2.4-fabric+forge+neo" = _bYKtUewI;
        "default" = _bYKtUewI;
    });
