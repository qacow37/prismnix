...
let
    ...
    in {
        ...
        "pkg-0.1.1" = _bQ2P1OBV;
        "pkg-0.1.2" = _IkpHTtIB;
        "pkg-0.2.0+fabric" = _qj8jwhaN;
        "pkg-0.2.0+forge" = _1fzfEucG;
        "pkg-0.2.1+fabric" = _V4NAx8Z7;
        "pkg-0.2.1+forge" = _J1dQrXvN;
        "pkg-0.2.2+fabric" = _Q8PJSazk;
        "pkg-0.2.2+forge" = _RaYyuwbK;
        "pkg-0.2.3+fabric" = _L3rq7yhs;
        "pkg-0.2.3+forge" = _8Q9phh59;
        "pkg-0.3.0+fabric" = _ZvRwoMOl;
        "pkg-0.3.0+forge" = _lKTszflA;
        "pkg-0.3.1+fabric" = _VNKwZvpB;
        "pkg-0.3.1+forge" = _QYPZSNqc;
        "pkg-0.4.0+forge-1.20.1" = _5g8FWCet;
        "pkg-0.4.0+fabric-1.20.1" = _x7i7t4hR;
        "pkg-0.4.0+forge-1.19.2" = _O86ekHSB;
        "pkg-0.4.0+fabric-1.19.2" = _J9IC8WFh;
        "pkg-0.4.1+fabric-1.20.1" = _SMqfDcT5;
        "pkg-0.4.1+forge-1.20.1" = _4ormSYD9;
        "pkg-0.4.1+fabric-1.19.2" = _5kScXSj3;
        "pkg-0.4.1+forge-1.19.2" = _32RSW4DC;
        "pkg-0.5.0+fabric-1.20.1" = _tuGWdBsA;
        "pkg-0.5.0+forge-1.20.1" = _QfNRyuzn;
        "pkg-0.5.0+fabric-1.18.2" = _1TD5UmuG;
        "pkg-0.5.0+forge-1.18.2" = _FgeSu16D;
        "pkg-0.5.0+fabric-1.19.2" = _FWNdp3DA;
        "pkg-0.5.0+forge-1.19.2" = _xR2RHtwX;
        "pkg-0.6.0+fabric-1.18.2" = _lHQytY8D;
        "pkg-0.6.0+fabric-1.20.1" = _GYp6XBhD;
        "pkg-0.6.0+forge-1.18.2" = _Hi1n7b2n;
        "pkg-0.6.0+forge-1.20.1" = _HMGucdkU;
        "pkg-0.6.0+fabric-1.19.2" = _nClPmR0c;
        "pkg-0.6.0+forge-1.19.2" = _wDIIddvw;
        "pkg-0.6.1+fabric-1.20.1" = _Tx7TsScp;
        "pkg-0.6.1+forge-1.20.1" = _s8AFdIae;
        "pkg-0.6.1+fabric-1.18.2" = _ksE4A8RH;
        "pkg-0.6.1+forge-1.18.2" = _eOrkHEBc;
        "pkg-0.6.1+fabric-1.19.2" = _FAptUrf9;
        "pkg-0.6.1+forge-1.19.2" = _gMYSvkPZ;
        "pkg-1.0.0+fabric-1.19.2" = _ufLH1hKl;
        "pkg-1.0.0+forge-1.19.2" = _UDMRcwBX;
        "pkg-1.0.0+fabric-1.20.1" = _MEr1HxeV;
        "pkg-1.0.0+forge-1.20.1" = _7GlP4xxC;
        "pkg-1.0.0+fabric-1.18.2" = _Gh6s4Tdv;
        "pkg-1.0.0+forge-1.18.2" = _yit6yhrA;
        "pkg-1.0.1+forge-1.18.2" = _g8wQRg6u;
        "pkg-1.0.1+fabric-1.18.2" = _3JHV4kjR;
        "pkg-1.1.0+neoforge-1.21.1" = _5FlUNeEu;
        "pkg-1.1.1+neoforge-1.21.1" = _dR2F5bfH;
        "pkg-1.1.1+fabric-1.20.1" = _gbJLq1HB;
        "pkg-1.1.1+forge-1.20.1" = _FCUyEF8Q;
        "default" = _FCUyEF8Q;
    });
