...
let
    ...
    in {
        ...
        "pkg-2.75" = _dP7GdDtY;
        "pkg-2.77" = _b4PnT0kB;
        "pkg-2.77.2" = _p9jwfyUm;
        "pkg-test2.77" = _VkDrGk1A;
        "pkg-2.77.6" = _8IScs1TR;
        "pkg-v2.77.7" = _xYXfMHFE;
        "pkg-2.77.9" = _lf81WX8b;
        "pkg-2.78" = _Vd8yavWl;
        "pkg-2.78.1" = _324JzEvr;
        "pkg-2.78.2" = _EydrvYVB;
        "pkg-2.78.3" = _CMLnqzlB;
        "pkg-2.78.6" = _tVEPVJue;
        "pkg-2.78.8" = _AxLswAZ9;
        "pkg-2.8.0-beta" = _lP2HlpGW;
        "pkg-2.8.1" = _f3p2qH7I;
        "default" = _f3p2qH7I;
    });
