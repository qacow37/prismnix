...
let
    ...
    in {
        ...
        "pkg-Beta1.3.17" = _QwO4pgp3;
        "pkg-Beta1.3.18" = _RGWaDabw;
        "pkg-Beta1.3.19" = _4dWtblpc;
        "pkg-Beta1.3.20" = _CHAXnzkE;
        "pkg-Beta1.3.21" = _Wbv7vbdT;
        "pkg-Beta1.3.22" = _Z2KufhCk;
        "pkg-Beta1.3.23" = _6t1Ybzb3;
        "pkg-Beta1.3.24" = _8EPiVrbH;
        "pkg-2.0.0" = _OMQb7xJE;
        "pkg-2.0.1" = _o5DiS1TV;
        "pkg-2.0.2" = _yEKxYW2b;
        "pkg-2.0.3" = _IyHF5ZgO;
        ...
        "pkg-2.3.8" = _E2dV5kLm;
        "pkg-2.3.9" = _TojYyq8P;
        "pkg-2.3.10" = _4J0KXY8D;
        "pkg-2.3.11" = _JAYSglog;
        "pkg-2.3.12" = _QOb8ZzmE;
        "default" = _QOb8ZzmE;
    });
