...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.7-forge" = _UkIyDcLB;
        "pkg-1.18.2-2.7-forge" = _YtAYxhoP;
        "pkg-1.19.2-2.7-forge" = _OEra4FVS;
        "pkg-1.16.5-2.8-forge" = _oOGFxK3U;
        "pkg-1.18.2-2.8-forge" = _z9fXsFLH;
        "pkg-1.19.2-2.8-forge" = _JLXHrmfP;
        "pkg-1.19.3-2.8-forge" = _N0AXdVpd;
        "pkg-1.18.2-3.0-forge+fabric" = _TySsTBOm;
        "pkg-1.19.2-3.0-forge+fabric" = _aOK4We1e;
        "pkg-1.19.3-3.0-forge+fabric" = _GSzoAvKd;
        "pkg-1.18.2-3.1-forge+fabric" = _VBfUFlJ5;
        "pkg-1.19.2-3.1-forge+fabric" = _PoDaI9X6;
        "pkg-1.19.3-3.1-forge+fabric" = _zVnkmSxW;
        "pkg-1.18.2-3.2-forge+fabric" = _NaB0yjC0;
        "pkg-1.19.2-3.2-forge+fabric" = _UlL3CLAc;
        "pkg-1.19.3-3.2-forge+fabric" = _8QTzgcCX;
        "pkg-1.18.2-3.3-forge+fabric" = _QRiZcD0G;
        "pkg-1.19.2-3.3-forge+fabric" = _FNyfvkJX;
        "pkg-1.19.3-3.3-forge+fabric" = _xTw7KdMj;
        "pkg-1.19.4-3.3-forge+fabric" = _7NSCO9MT;
        "pkg-1.19.4-3.4-forge+fabric" = _vJXNeX8p;
        "pkg-1.20-3.4-forge+fabric" = _2G8KmC7T;
        "pkg-1.20.1-3.4-forge+fabric" = _CUsIpAFd;
        "pkg-1.20.2-3.4-forge+fabric" = _AUwpuQyZ;
        "pkg-1.18.2-3.5-forge+fabric" = _lgglmUUI;
        "pkg-1.19.2-3.5-forge+fabric" = _CCuBqp52;
        "pkg-1.20.1-3.5-forge+fabric" = _smkogBn7;
        "pkg-1.20.2-3.5-forge+fabric" = _K84hyNhO;
        "pkg-1.20.2-3.6-forge+fabric" = _OtQ0Qh9s;
        "pkg-1.20.3-3.6-fabric+forge+neo" = _oMAdCMho;
        "pkg-1.20.4-3.6-fabric+forge+neo" = _1sOpcHZQ;
        "pkg-1.19.2-3.7-fabric+forge+neo" = _biBhPMWY;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _ZVTD7Qyb;
        "pkg-1.20.2-3.7-fabric+forge+neo" = _2PxJNYzt;
        "pkg-1.20.4-3.7-fabric+forge+neo" = _ngKrSzUI;
        "pkg-1.19.2-3.8-fabric+forge+neo" = _9IoOxyqe;
        "pkg-1.20.1-3.8-fabric+forge+neo" = _2fNIXorR;
        "pkg-1.20.2-3.8-fabric+forge+neo" = _jwlt4J7k;
        "pkg-1.20.4-3.8-fabric+forge+neo" = _nzHEg97Z;
        "pkg-1.20.5-3.8-fabric+neo" = _poB0mdvF;
        "pkg-1.20.6-3.8-fabric+forge+neo" = _xLAKMbWV;
        "pkg-1.20.6-3.9-fabric+forge+neo" = _xXFiSsBo;
        "pkg-1.21.0-3.9-fabric+forge+neo" = _O8HVT0z4;
        "pkg-1.20.1-4.0-fabric+forge+neo" = _LNAzS2kb;
        "pkg-1.20.6-4.0-fabric+forge+neo" = _GbwD3TKi;
        "pkg-1.21.0-4.0-fabric+forge+neo" = _dAhM116C;
        "pkg-1.21.1-4.0-fabric+forge+neo" = _PfM8Tr8S;
        "pkg-1.21.2-4.0-fabric+neo" = _xp1wYET3;
        "pkg-1.21.3-4.0-fabric+forge+neo" = _TACjKv4Q;
        "pkg-1.21.4-4.0-fabric+forge+neo" = _eQhE69wA;
        "pkg-1.20.1-4.1-fabric+forge+neo" = _29kRjX5W;
        "pkg-1.21.1-4.1-fabric+forge+neo" = _dZl0KxL7;
        "pkg-1.21.4-4.1-fabric+forge+neo" = _Ft8xOMiE;
        "pkg-1.21.5-4.1-fabric+forge+neo" = _GVwEXbqy;
        "pkg-1.20.1-4.2-fabric+forge+neo" = _44s772eG;
        "pkg-1.21.1-4.2-fabric+forge+neo" = _KTWiwQK4;
        "pkg-1.21.4-4.2-fabric+forge+neo" = _Fh0tfbkZ;
        "pkg-1.21.5-4.2-fabric+forge+neo" = _1QY9AsuZ;
        "pkg-1.21.6-4.2-fabric+forge+neo" = _kUYI82x1;
        "pkg-1.21.6-4.3-fabric+forge+neo" = _bcxMUFWY;
        "pkg-1.21.7-4.3-fabric+forge+neo" = _I3YmxcU0;
        "pkg-1.21.8-4.3-fabric+forge+neo" = _xbj16xhA;
        "pkg-1.21.9-4.3-fabric+forge+neo" = _OwmF5uY0;
        "pkg-1.21.10-4.3-fabric+forge+neo" = _WRdwZYtA;
        "pkg-1.21.11-4.3-fabric+forge+neo" = _Ymdscjj9;
        "pkg-26.1.0-4.3-fabric+forge+neo" = _T1kNJTWl;
        "pkg-26.1.1-4.3-fabric+forge+neo" = _xumEqcDd;
        "pkg-26.1.2-4.3-fabric+forge+neo" = _W9uvmLRp;
        "pkg-26.2.0-4.3-fabric+forge+neo" = _jjBdZPat;
        "default" = _jjBdZPat;
    });
