...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _pEcwrRnB;
        "pkg-1.4.0" = _RRSmH4kJ;
        "pkg-1.4.0-hotfix" = _SJtBlXjC;
        "pkg-1.4.1" = _mqTiFtUi;
        "pkg-1.4.2" = _gkansKU1;
        "pkg-1.5.0" = _iM8wChk3;
        "pkg-1.5.0-1" = _J0n9Ye4X;
        "pkg-1.6.0" = _2xbMpY06;
        "pkg-1.6.1-Beta" = _zu8QGXIe;
        "pkg-1.6.1-Beta-1-Hotfix-1" = _uOU5b1JY;
        "pkg-1.6.1-Beta-2" = _CpxbexgL;
        "pkg-1.6.1" = _XLVXYS8u;
        "pkg-1.7.0-beta-1" = _YNCeQAWI;
        "pkg-1.7.0-beta-2" = _iN1BedD9;
        "pkg-1.7.0" = _T2cTxVE4;
        "pkg-1.7.0-Cloud-Fix-2" = _gYcFi3fy;
        "pkg-1.8.0-Alpha-1" = _4AzJxJ2x;
        "pkg-1.8.0-Alpha2" = _DMMFc7G1;
        "pkg-1.8.0-Alpha-3" = _WvrEQHFq;
        "default" = _WvrEQHFq;
    });
