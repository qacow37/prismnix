...
let
    ...
    in {
        ...
        "pkg-0.1.0-build20230922" = _eq3QymLy;
        "pkg-0.2.0-build20231016" = _SF9MPgJb;
        "pkg-0.2.1-build20231127" = _kdvFcowS;
        "pkg-0.2.1-build20231218" = _CxsxopYV;
        "pkg-0.2.2-build20240130" = _82xyjCIK;
        "pkg-0.2.1-build20240307" = _gZaCdWW0;
        "pkg-0.2.3-build20240514" = _UxlFaIos;
        "pkg-0.2.3-build20240515" = _32nAxPuc;
        "pkg-0.2.4-build20240711" = _gApT6Qne;
        "pkg-0.2.3-build20240714" = _nIuqPOcB;
        "pkg-0.2.4-build20240831" = _ZPHCxm75;
        "pkg-0.3.0-build20241012" = _LJiVk9TY;
        "pkg-0.3.1-build20241013" = _tteNH8Qw;
        "pkg-0.3.1-build20250207" = _qcK05rfZ;
        "pkg-0.3.1-build20250507" = _BzyX9nki;
        "pkg-0.4.0-build20250817" = _kOno77dm;
        "pkg-0.4.0-build20250818" = _POanTvMW;
        "pkg-0.4.1-build20250823" = _OWuDPbaB;
        "pkg-0.4.2-build20250902" = _Tdo6rIYM;
        "pkg-0.4.3-build20260120-mc1.21.11" = _g8YOfGxt;
        "pkg-0.4.4-build20260318" = _A0vIkSCb;
        "pkg-0.4.5-build20250318" = _hHj7M5QU;
        "pkg-0.4.6-build20250529" = _xIEnjEw7;
        "default" = _xIEnjEw7;
    });
