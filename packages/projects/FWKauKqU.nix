...
let
    ...
    in {
        ...
        "pkg-1.1.0-Forge-1.20.1" = _Hpw4y5MG;
        "pkg-1.1.0-NeoForge-1.20.6" = _lG219ypA;
        "pkg-1.1.0-NeoForge-1.21.1" = _CtPof08X;
        "pkg-1.1.1-Forge-1.20.1" = _7Tf1IMOe;
        "pkg-1.1.1-NeoForge-1.20.6" = _rq2xbP9O;
        "pkg-1.1.1-NeoForge-1.21.1" = _WQ0gYkYF;
        "pkg-1.1.2-Forge-1.20.1" = _sif6Bf0J;
        "pkg-1.1.2-NeoForge-1.20.6" = _yIByEUxy;
        "pkg-1.1.2-NeoForge-1.21.1" = _S0Pzwd2g;
        "pkg-1.1.3-Forge-1.20.1" = _UeEbFeDi;
        "pkg-1.1.3-NeoForge-1.20.6" = _SyGKfrxK;
        "pkg-1.1.3-NeoForge-1.21.1" = _IfTESvvM;
        "pkg-1.1.4-NeoForge-1.21.1" = _gn11VqOq;
        "pkg-1.1.4-Forge-1.20.1" = _AxRG2n1v;
        "pkg-1.1.5-Forge-1.20.1" = _UELAELx5;
        "pkg-1.1.5-NeoForge-1.20.6" = _VvBa3EFI;
        "pkg-1.1.5-NeoForge-1.21.1" = _Kr2qPlhK;
        "pkg-1.1.6-Forge-1.20.1" = _EyY0jHsM;
        "pkg-1.1.6-NeoForge-1.20.6" = _ps9c7CAf;
        "pkg-1.1.6-NeoForge-1.21.1" = _1MUrQNgH;
        "pkg-1.1.6.3-Forge-1.20.1" = _lg1fJX0q;
        "pkg-1.1.6.3-NeoForge-1.20.6" = _Kop4oAb4;
        "pkg-1.1.6.3-NeoForge-1.21.1" = _c99Z2uy1;
        "pkg-1.1.6.4-Forge-1.20.1" = _BIJBrzJN;
        "pkg-1.1.6.4-NeoForge-1.20.6" = _ekjfzldu;
        "pkg-1.1.6.4-NeoForge-1.21.1" = _8KNLxOU9;
        "pkg-1.1.7.2-Forge-1.20.1" = _LGqKETOk;
        "pkg-1.1.7.2-NeoForge-1.20.6" = _Fi9McIcd;
        "pkg-1.1.7.2-NeoForge-1.21.1" = _eOqqaDeo;
        "pkg-1.1.7.4-NeoForge-1.21.1" = _1K05cxDa;
        "pkg-1.1.7.4-Forge-1.20.1" = _UzoIP0Af;
        "pkg-1.1.7.4-NeoForge-1.20.6" = _xSnC7vaN;
        "pkg-1.1.7.5-Forge-1.20.1" = _ZM9it3Ns;
        "pkg-1.1.7.5-NeoForge-1.21.1" = _aTXzVG1M;
        "pkg-1.1.7.6-Forge-1.20.1" = _owkQTVn4;
        "pkg-1.1.7.6-NeoForge-1.21.1" = _ZfMNcqNu;
        "pkg-1.2.1-Forge-1.20.1" = _OBz7LNKQ;
        "pkg-1.2.1-NeoForge-1.20.6" = _a8QgnHGt;
        "pkg-1.2.1-NeoForge-1.21.1" = _ksCLzhzw;
        "pkg-1.2.1.1-Forge-1.20.1" = _XJh4Y2TZ;
        "pkg-1.2.1.1-NeoForge-1.20.6" = _NS4dewdv;
        "pkg-1.2.1.1-NeoForge-1.21.1" = _CYAV0HCg;
        "pkg-1.2.1.2-Forge-1.20.1" = _SI43Valo;
        "pkg-1.2.1.2-NeoForge-1.20.6" = _LAzqgoQp;
        "pkg-1.2.1.2-NeoForge-1.21.1" = _Bu3JoI1W;
        "pkg-1.2.1.4-Forge-1.20.1" = _CGDRbE7I;
        "pkg-1.2.1.4-NeoForge-1.21.1" = _eYunjFsV;
        "pkg-1.2.1.5-Forge-1.20.1" = _86ixugyj;
        "pkg-1.2.1.5-NeoForge-1.21.1" = _Ss94XTsM;
        "pkg-1.2.1.6-NeoForge-1.21.1" = _OjCASAVI;
        "pkg-1.2.1.6-Forge-1.20.1" = _hWrRMnuV;
        "pkg-1.2.1.8-Forge-1.20.1" = _Gz7JFZR2;
        "pkg-1.2.1.8-NeoForge-1.21.1" = _LHzij9Nn;
        "pkg-1.2.2-Forge-1.20.1" = _KvqlWE5W;
        "pkg-1.2.2-NeoForge-1.21.1" = _tb2vRISL;
        "pkg-1.2.2.1-Forge-1.20.1" = _u6oGpTU0;
        "pkg-1.2.2.1-NeoForge-1.21.1" = _PmqS9kea;
        "pkg-1.2.3.0-Forge-1.20.1" = _ZNBdTJwY;
        "pkg-1.2.3.0-NeoForge-1.21.1" = _6z45jZNl;
        "pkg-1.2.3.1-Forge-1.20.1" = _3yMpFNcV;
        "pkg-1.2.3.1-NeoForge-1.21.1" = _Si2QPIpK;
        "pkg-1.2.3.2-Forge-1.20.1" = _nSEZjwwv;
        "pkg-1.2.3.2-NeoForge-1.21.1" = _8sYuYVhm;
        "pkg-1.2.3.3-NeoForge-1.21.1" = _ZyPdcvpC;
        "pkg-1.2.4-Forge-1.20.1" = _vmxYSrXt;
        "pkg-1.2.4-NeoForge-1.21.1" = _eXkoa7Ei;
        "pkg-1.2.4.1-Forge-1.20.1" = _9I77M89P;
        "pkg-1.2.4.1-NeoForge-1.21.1" = _1GRpDBQs;
        "pkg-1.2.4.3-Forge-1.20.1" = _zmYRC2zu;
        "pkg-1.2.4.3-NeoForge-1.21.1" = _Zv2bX8IL;
        "pkg-1.2.5-Forge-1.20.1" = _xdhmenqY;
        "pkg-1.2.5-NeoForge-1.21.1" = _B6NFWGGQ;
        "pkg-1.2.5.1-Forge-1.20.1" = _HWUdeSSz;
        "pkg-1.2.5.1-NeoForge-1.21.1" = _VjaNxnne;
        "pkg-1.2.5.2-Forge-1.20.1" = _zolXTfhM;
        "pkg-1.2.5.2-NeoForge-1.21.1" = _GqLjjn30;
        "pkg-1.2.5.3-Forge-1.20.1" = _WJTeANiw;
        "pkg-1.2.5.3-NeoForge-1.21.1" = _5hxFbR1V;
        "pkg-1.2.6.1-Forge-1.20.1" = _kcjxq9Bv;
        "pkg-1.2.6.1-NeoForge-1.21.1" = _IwXbaa4P;
        "pkg-1.2.7-Forge-1.20.1" = _WRjORpIE;
        "pkg-1.2.7-NeoForge-1.21.1" = _znn9XCm2;
        "pkg-1.2.8-Forge-1.20.1" = _z7J0XL2j;
        "pkg-1.2.8-NeoForge-1.21.1" = _9bZ0fWhD;
        "pkg-1.2.8.3-Forge-1.20.1" = _bL1fuwi3;
        "pkg-1.2.8.3-NeoForge-1.21.1" = _SPL7FgEx;
        "pkg-1.2.9-Forge-1.20.1" = _GAhlnNG7;
        "pkg-1.2.9-NeoForge-1.21.1" = _1gF4uHb6;
        "pkg-1.2.9.2-Forge-1.20.1" = _CKkiKPFt;
        "pkg-1.2.9.2-NeoForge-1.21.1" = _EE6ZpJkv;
        "pkg-1.2.9.2-NeoForge-1.21.11" = _AUiHAhuh;
        "pkg-1.2.10-Forge-1.20.1" = _2w4c8vKl;
        "pkg-1.2.10-NeoForge-1.21.1" = _BbCqHtIf;
        "pkg-1.2.10.2-Forge-1.20.1" = _VJDtsOjm;
        "pkg-1.2.10.2-NeoForge-1.21.1" = _yze63Yaf;
        "pkg-1.2.11-Forge-1.20.1" = _mG3VlSZN;
        "pkg-1.2.11-NeoForge-1.21.1" = _Rnm525bx;
        "pkg-1.3.0-NeoForge-1.21.1" = _UoaCcoFi;
        "pkg-1.3.0-Forge-1.20.1" = _QFk7kHuI;
        "pkg-1.3.0.1-Forge-1.20.1" = _MUGS3Rhs;
        "pkg-1.3.0.1-NeoForge-1.21.1" = _7TmmvVyf;
        "pkg-1.3.0.3-Forge-1.20.1" = _DivqUPB8;
        "pkg-1.3.0.3-NeoForge-1.21.1" = _2lEHd02o;
        "pkg-1.3.0.4-Forge-1.20.1" = _UmHoeFyD;
        "pkg-1.3.0.4-NeoForge-1.21.1" = _Xf9D2pPU;
        "pkg-1.3.0.5-Forge-1.20.1" = _ikQZ0wyr;
        "pkg-1.3.0.5-NeoForge-1.21.1" = _zjakr0ME;
        "pkg-1.3.0.7-Forge-1.20.1" = _oVy03XP1;
        "pkg-1.3.0.7-NeoForge-1.21.1" = _mYWCkdKQ;
        "pkg-1.3.1.1-Forge-1.20.1" = _8GVC1buk;
        "pkg-1.3.1.1-NeoForge-1.21.1" = _CGGOklz9;
        "pkg-1.3.2-Forge-1.20.1" = _D8M9VJeU;
        "pkg-1.3.2-NeoForge-1.21.1" = _Mp46H3iG;
        "pkg-1.3.2.1-Forge-1.20.1" = _6Ifv9G25;
        "pkg-1.3.2.1-NeoForge-1.21.1" = _nHee0vkX;
        "pkg-1.3.3.1-Forge-1.20.1" = _TBZ0vFEx;
        "pkg-1.3.3.1-NeoForge-1.21.1" = _oeZ0zluz;
        "pkg-1.3.3.2-Forge-1.20.1" = _bmm8eaAp;
        "pkg-1.3.3.2-NeoForge-1.21.1" = _1Mim98e6;
        "pkg-1.3.3.4-Forge-1.20.1" = _S1SoVRik;
        "pkg-1.3.3.4-NeoForge-1.21.1" = _iJggEEmh;
        "pkg-1.3.3.5-Forge-1.20.1" = _PjoYlNqw;
        "pkg-1.3.3.5-NeoForge-1.21.1" = _mf56AetO;
        "pkg-1.3.3.6-Forge-1.20.1" = _SMiJkgoE;
        "pkg-1.3.3.7-Forge-1.20.1" = _5XLhk4Kd;
        "pkg-1.3.3.7-NeoForge-1.21.1" = _PIUwZrXw;
        "pkg-1.3.3.8-Forge-1.20.1" = _tbDaC4JO;
        "pkg-1.3.3.8-NeoForge-1.21.1" = _FJ9SPyZk;
        "pkg-1.3.3.9-Forge-1.20.1" = _Czrq8ODR;
        "pkg-1.3.3.9-NeoForge-1.21.1" = _u5PqOnii;
        "pkg-1.3.3.10-Forge-1.20.1" = _A9D7RIoK;
        "pkg-1.3.3.10-NeoForge-1.21.1" = _IAuyj4jD;
        "pkg-1.3.3.11-Forge-1.20.1" = _APB8Y5bv;
        "pkg-1.3.3.11-NeoForge-1.21.1" = _5XTbYrd5;
        "default" = _5XTbYrd5;
    });
