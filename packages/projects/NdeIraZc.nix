...
let
    ...
    in {
        ...
        "pkg-v1.0.0-1.21.6" = _yd10nLn4;
        "pkg-1.0.0-1.21.6" = _XLrbQxQE;
        "pkg-2.0.0-1.21.6" = _EgHIBQGG;
        "pkg-2.0.0-1.21.5" = _Q0z8dJv9;
        "pkg-2.1.1-1.21.4" = _S3w7Ub5U;
        "pkg-2.0.0-1.21.3" = _Rjewkax6;
        "pkg-2.0.0-1.21" = _TDxB1dYn;
        "pkg-2.0.0-1.20.1" = _xUUrMMRP;
        "pkg-2.0-1.21.1" = _9arOTJqt;
        "pkg-v2.0.0-1.21.6" = _QSuArZZ4;
        "pkg-v2.0.0-1.21.5" = _lRwpmPNj;
        "pkg-v2.0.0-1.21.4" = _thMbMsGv;
        "pkg-v1.0.0-1.21.2" = _x2BgopvW;
        "pkg-2.0-1.21.4" = _j5GrXOtP;
        "pkg-2.0-1.21.5" = _529sOoQb;
        "pkg-2.0-1.21.6" = _BQVoKY1p;
        "pkg-2.0-1.21.7" = _cPHDd2BJ;
        "pkg-2.2.0-1.21" = _d1Sa8E9n;
        "pkg-2.4.0-1.21" = _qMDnd2yB;
        "pkg-2.4.0-1.20.1" = _6Xzufwdu;
        "pkg-2.4.0-1.21.4" = _TzhgzZVA;
        "pkg-2.4.1-1.20.1" = _iPoLlHWH;
        "pkg-2.4.0-1.21.5" = _L5ofEng4;
        "pkg-2.4.0-1.21.6" = _cRM1IHrW;
        "pkg-2.4.0-1.21.9" = _4qOCTo1G;
        "pkg-v2.4.0-1.21.6" = _yQ4vR8IB;
        "pkg-v2.4.0-1.21.9" = _90mzFlK1;
        "pkg-v2.4.0-1.21.5" = _Yq2A1tdL;
        "pkg-3.0.0-1.21" = _3nma0XeX;
        "pkg-3.0.0-1.20.1" = _ZflgtaH3;
        "pkg-3.0.1-1.20.1" = _phMODyW3;
        "pkg-3.0.1-1.20.2" = _vY3yVDB8;
        "pkg-3.0.0-1.20.6" = _LY1STf3K;
        "pkg-v3.0.0-1.21.4" = _SUxAAWxX;
        "pkg-v3.0.0-1.21.5" = _AUHoLvBV;
        "pkg-v3.0.0-1.21.6" = _SAMnNy6Z;
        "pkg-v3.0.0-1.21.9" = _XdIDRlBa;
        "pkg-v3.0.0-1.21.11" = _Q1Kcj8EV;
        "pkg-v3.0.0-1.21" = _iZGGrZV3;
        "pkg-v3.0.1-1.21.6" = _cB2OLjMu;
        "default" = _Q1Kcj8EV;
    });
