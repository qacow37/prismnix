...
let
    ...
    in {
        ...
        "pkg-1.19.2-0.0.6-SNAPSHOT" = _VwJ4vUle;
        "pkg-1.19.2-0.0.7" = _7VgS8Xpe;
        "pkg-1.19.2-0.0.8" = _6fQVSPVN;
        "pkg-1.19.2-0.1.0" = _XdMHnLKv;
        "pkg-1.19.2-0.1.1" = _yDhxcdlD;
        "pkg-1.19.2-0.1.1Forge" = _DIApt2UE;
        "pkg-1.19.2-0.1.2" = _dZFtsR7K;
        "pkg-1.19.2-0.2.0" = _Sd3280ej;
        "pkg-1.19.2-0.3.0-Beta2" = _wBvpiCJp;
        "pkg-1.19.2-1.0.0-Alpha1" = _d9DrKIdZ;
        "pkg-1.19.2-1.0.0-Alpha2" = _Gk8bGA2r;
        "pkg-1.19.2-1.0.0-Beta1" = _x9k02OvI;
        "pkg-1.19.2-1.0.0-Beta2" = _Y3s6AwrB;
        "pkg-1.18.2-1.0.0-Beta2" = _GzYArYRo;
        "pkg-1.18.2-1.0.0-Beta3" = _myquZahC;
        "pkg-1.19.2-1.0.0-Beta3" = _yxnii7R0;
        "pkg-1.18.2-1.0.0-Beta4" = _5ryuDs4f;
        "pkg-1.19.2-1.0.0-Beta4" = _2OoVr9nf;
        "pkg-1.18.2-1.0.0-Beta5" = _PG47SbCW;
        "pkg-1.19.2-1.0.0-Beta5" = _8DdjBi3D;
        "pkg-1.19.4-1.0.0-Alpha1" = _71s1hFJ3;
        "pkg-1.19.2-1.0.0-Beta6" = _hFornFs3;
        "pkg-1.18.2-1.0.0-Beta6" = _Qnl945II;
        "pkg-1.19.2-1.0.0Forge-Beta1" = _kkDR1pAZ;
        "pkg-1.19.4-1.0.0-Alpha2" = _IwUXL2t0;
        "pkg-1.18.2-1.0.0-Beta7" = _VVN4QGKF;
        "pkg-1.19.2-1.0.0-Beta7" = _CPiWwDXY;
        "pkg-1.20.1-1.0.0-Alpha2" = _63wGprFh;
        "pkg-1.19.2-1.1.0-Beta1" = _nrpK40aL;
        "pkg-1.20.1-1.1.0-Alpha2" = _6SfkKB6K;
        "pkg-1.18.2-1.0.0Forge-Beta1" = _L4L8eqxg;
        "pkg-1.19.2-1.0.0Forge-B3" = _AIrAZqRY;
        "pkg-1.20.1-1.1.0-Beta1" = _37V3fuJ5;
        "pkg-1.19.2-1.1.0-Beta3" = _SH9AXwMo;
        "pkg-1.20.1-1.2.0-Beta1-Fabric" = _TqknfbPO;
        "pkg-1.20.1-1.3.0-Beta1-Fabric" = _V9qSAOni;
        "pkg-1.19.2-1.1.0-Beta5-Fabric" = _n2zlJDcb;
        "pkg-1.18.2-1.0.0-Beta9-Fabric" = _uNG7RR9U;
        "pkg-1.19.4-1.0.0-Alpha4" = _6zabFrhT;
        "pkg-1.19.4-1.0.0-Beta1-Fabric" = _uiPZ0w6p;
        "pkg-1.19.2-1.1.0-Beta6-Fabric" = _ndqSsDu9;
        "pkg-1.18.2-1.0.0-Beta10-Fabric" = _Xg1bEIyD;
        "pkg-1.19.2-1.0.0Forge-B4" = _H199cxA1;
        "pkg-1.20.1-1.3.0-Fabric" = _xLLHCf9r;
        "pkg-1.18.2-1.0.0Forge-Beta4" = _FZysLIux;
        "pkg-1.18.2-1.0.0Forge-Beta5" = _aIXIpfVg;
        "pkg-1.20.1-1.3.7-Fabric" = _jSkh5o6R;
        "pkg-1.19.2-1.3.0-Fabric" = _cPmPMSme;
        "pkg-1.19.2-1.3.2-Fabric" = _IE2Xdett;
        "pkg-1.19.4-1.0.1-Fabric" = _Xjo4TQnr;
        "pkg-1.19.2-1.3.6-Fabric" = _Kpyf3o5q;
        "pkg-1.20.1-1.3.0-Forge" = _WnLF5Fl2;
        "pkg-1.20.1-1.3.11-Fabric" = _AdoEES7C;
        "pkg-1.19.2-1.3.0-Forge" = _U3IJqqRe;
        "pkg-1.19.2-1.3.1-Forge" = _50QufBpx;
        "pkg-1.19.4-1.0.2-Fabric" = _LbwK5Zbs;
        "pkg-1.20.1-1.3.12-Fabric" = _vVqwBKU0;
        "pkg-1.20.1-1.3.1-Forge" = _3uMcoEyW;
        "pkg-1.19.2-1.3.2-Forge" = _9VkCRd53;
        "pkg-1.19.2-1.3.7-Fabric" = _BjLhlFY4;
        "pkg-1.19.4-1.0.3-Fabric" = _MjzihYdN;
        "pkg-1.20.1-1.3.13-Fabric" = _SY3xy3ij;
        "pkg-1.19.2-1.3.7-Forge" = _7a0rTUyc;
        "pkg-1.20.1-1.3.5-Forge" = _kdxP8jh1;
        "pkg-1.19.2-1.3.11-Fabric" = _KuBEEij5;
        "pkg-1.3.0-1.21-Fabric" = _X7JSWgjj;
        "pkg-1.3.0-1.21-Forge" = _78L3Fwn7;
        "pkg-1.3.1-1.21-Neoforge" = _oK5cb32J;
        "pkg-1.3.1-1.21-Forge" = _CY6wS1sv;
        "pkg-1.20.1-1.3.7-Forge" = _dYOOfSid;
        "pkg-1.19.2-1.3.8-Forge" = _zPwoO7Zl;
        "pkg-1.20.1-1.3.10-Forge" = _ZK2HNhBB;
        "pkg-1.19.4-1.0.3hotfix-Fabric" = _NI0HJWsS;
        "pkg-1.20.1-1.4.0.25w03b-Fabric" = _Vk4rd66g;
        "pkg-1.3.1-1.21-Fabric" = _K3TLSS5u;
        "pkg-1.3.2-1.21-Forge" = _shGpLo8R;
        "pkg-1.20.1-1.3.11-Forge" = _Ad6rbzdq;
        "pkg-1.3.4-1.21-Forge" = _B4ugHv1n;
        "pkg-1.3.3-1.21-Fabric" = _nVInwb4R;
        "pkg-1.20.1-1.4.0-Fabric" = _uN6PcVn5;
        "pkg-1.20.1-1.4.1-Forge" = _YxQGdu3l;
        "pkg-1.20.1-1.4.1-Fabric" = _80uENMU1;
        "pkg-1.20.1-1.4.3-Forge" = _10KdMvHn;
        "pkg-1.20.1-1.4.3-Fabric" = _keKz5HG0;
        "pkg-1.4.0-1.21.1-Forge" = _mr9qSd7W;
        "pkg-1.4.0-1.21.1-Neoforge" = _7aoERiHW;
        "pkg-1.4.0-1.21.1-Fabric" = _HwdC8dTD;
        "pkg-1.4.0-1.21.4-Fabric" = _nSwzUVKy;
        "pkg-1.4.0-1.21.4-Neoforge" = _u1Q2adyr;
        "pkg-1.4.1-1.21.4-Fabric" = _pKenSAKq;
        "pkg-1.4.1-1.21.4-NeoForge" = _PP8H62st;
        "pkg-1.20.1-1.4.4-Forge" = _gLPJv9Fi;
        "pkg-1.20.1-1.4.4-Fabric" = _Q0vzttvi;
        "pkg-1.4.1-1.21.1-NeoForge" = _PEc9d7uT;
        "pkg-1.4.1-1.21.1-Forge" = _U41RBAWW;
        "pkg-1.4.1-1.21.1-Fabric" = _UnWGN1kc;
        "pkg-1.4.2-1.21.1-NeoForge" = _j2Kwrt3o;
        "pkg-1.4.2-1.21.1-Forge" = _zP9VZU1X;
        "pkg-1.20.1-1.4.5-Forge" = _FsBPYjOT;
        "pkg-1.20.1-1.4.5-Fabric" = _zntXnVAc;
        "pkg-1.4.2-1.21.1-Fabric" = _covMc40X;
        "pkg-1.4.2-1.21.4-Fabric" = _oz1Vzm9a;
        "pkg-1.4.2-1.21.4-NeoForge" = _7hfTwQVa;
        "pkg-1.4.3-1.21.1-Fabric" = _V6kWws3N;
        "pkg-1.20.1-1.4.6-Forge" = _KtCcTad3;
        "pkg-1.20.1-1.4.6-Fabric" = _Yw1Jnh0h;
        "pkg-1.4.3-1.21.4-Fabric" = _xf6QAtBB;
        "pkg-1.4.3-1.21.4-NeoForge" = _BkUbRpkx;
        "pkg-1.4.3-1.21.1-NeoForge" = _VnlEED5f;
        "pkg-1.4.3-1.21.1-Forge" = _3dqwZkIE;
        "pkg-1.20.1-1.4.7-Forge" = _HeD36fhh;
        "pkg-1.20.1-1.4.8-Fabric" = _qTfAbO14;
        "pkg-1.20.1-1.4.8-Forge" = _ke9g27u8;
        "pkg-1.4.4-1.21.4-NeoForge" = _JR8CSyf0;
        "pkg-1.4.4-1.21.4-Fabric" = _9572MMBS;
        "pkg-1.4.4-1.21.1-Fabric" = _gI3bXZOT;
        "pkg-1.4.4-1.21.1-NeoForge" = _6dz35dHh;
        "pkg-1.20.1-1.4.11-Forge" = _qVERiLnt;
        "pkg-1.20.1-1.4.11-Fabric" = _nj08syyX;
        "pkg-1.4.7-1.21.4-Fabric" = _R7TTQjPm;
        "pkg-1.4.7-1.21.4-NeoForge" = _29SrowwC;
        "pkg-1.4.6-1.21.1-NeoForge" = _ohVX5fv7;
        "pkg-1.4.6-1.21.1-Fabric" = _CJ9OgH8E;
        "pkg-1.4.10-1.21.5-Fabric" = _DMeB5YbW;
        "pkg-1.4.10-1.21.5-NeoForge" = _yUmQ9Lwx;
        "pkg-1.4.10-1.21.4-Fabric" = _j1NeG2Jm;
        "pkg-1.4.10-1.21.4-NeoForge" = _Qb9TiaYI;
        "pkg-1.20.1-1.4.13-Forge" = _6OzrywRA;
        "pkg-1.20.1-1.4.13-Fabric" = _3rPnseUl;
        "pkg-1.4.8-1.21.1-NeoForge" = _7diOMpKa;
        "pkg-1.4.8-1.21.1-Fabric" = _NaVaWkSi;
        "pkg-1.4.11-1.21.5-Fabric" = _zmKxMt1S;
        "pkg-1.4.11-1.21.4-Fabric" = _CTyvtpmc;
        "pkg-1.4.11-1.21.6-Fabric" = _zEQvyIJb;
        "pkg-1.4.11-1.21.6-NeoForge" = _YVGsJFSA;
        "pkg-1.4.12-1.21.6-Forge" = _llWmIHOH;
        "pkg-1.4.12-1.21.4-Forge" = _mZCnsFTU;
        "pkg-1.4.12-1.21.5-Forge" = _xbXGssqM;
        "pkg-1.4.9-1.21.1-Forge" = _MbtXkqgz;
        "pkg-1.4.13-1.21.5-Fabric" = _2kEz2NBS;
        "pkg-1.4.13-1.21.5-NeoForge" = _adaTFhNk;
        "pkg-1.4.13-1.21.5-Forge" = _6L1HxM17;
        "pkg-1.4.13-1.21.6-Fabric" = _X0wmmV8g;
        "pkg-1.4.13-1.21.6-NeoForge" = _Pz4ksSs3;
        "pkg-1.4.13-1.21.6-Forge" = _6YPnAgmM;
        "pkg-1.4.10-1.21.1-Fabric" = _BkKOhL3R;
        "pkg-1.4.10-1.21.1-NeoForge" = _7umTLA6d;
        "pkg-1.4.10-1.21.1-Forge" = _j4UU2Wfi;
        "pkg-1.4.13-1.21.4-Fabric" = _TKoRq52R;
        "pkg-1.4.13-1.21.4-NeoForge" = _FB8BgstL;
        "pkg-1.4.13-1.21.4-Forge" = _pUZ6kShN;
        "pkg-1.4.14-1.21.6-Forge" = _RCu94cCb;
        "pkg-1.4.14-1.21.6-NeoForge" = _2hxdT3PY;
        "pkg-1.4.14-1.21.6-Fabric" = _ySAL9unu;
        "pkg-1.4.14-1.21.5-Forge" = _UwawZVx1;
        "pkg-1.4.14-1.21.5-NeoForge" = _1UCRId1d;
        "pkg-1.4.14-1.21.4-Forge" = _FSOcmnv1;
        "pkg-1.4.14-1.21.4-NeoForge" = _Yk4TQIRi;
        "pkg-1.4.14-1.21.4-Fabric" = _jZ9qwYt0;
        "pkg-1.4.11-1.21.1-Fabric" = _k3BBoHlh;
        "pkg-1.4.11-1.21.1-Forge" = _JHZ9FsWw;
        "pkg-1.4.11-1.21.1-NeoForge" = _S2TrR4Zv;
        "pkg-1.20.1-1.4.14-Fabric" = _4ZSktwqM;
        "pkg-1.20.1-1.4.14-Forge" = _uaSnHQNJ;
        "pkg-1.4.14-1.21.9-Fabric" = _jjqZnHpd;
        "pkg-1.4.14-1.21.9-NeoForge" = _YGx7HC2M;
        "pkg-1.4.14-1.21.9-Forge" = _kHWbc3Y1;
        "pkg-1.4.14-1.21.10-Fabric" = _gY9GCE6P;
        "pkg-1.4.14-1.21.10-NeoForge" = _lBZOUGH7;
        "pkg-1.4.14-1.21.10-Forge" = _YReF3yI1;
        "pkg-1.4.15-1.21.10-Fabric" = _ZImsqbVN;
        "pkg-1.4.15-1.21.10-NeoForge" = _2Nnzsg1w;
        "pkg-1.4.15-1.21.10-Forge" = _T5PuhbRj;
        "pkg-1.4.15-1.21.6-Forge" = _Y5XonwZW;
        "pkg-1.4.15-1.21.6-NeoForge" = _EA37jOEO;
        "pkg-1.4.15-1.21.6-Fabric" = _ebVYZuQe;
        "pkg-1.4.15-1.21.5-Forge" = _BBXXaqaE;
        "pkg-1.4.15-1.21.5-NeoForge" = _C3JLHkSL;
        "pkg-1.4.15-1.21.5-Fabric" = _8msS2m5Q;
        "pkg-1.4.15-1.21.4-Forge" = _EcloHLOR;
        "pkg-1.4.15-1.21.4-NeoForge" = _ZFVCuumF;
        "pkg-1.4.15-1.21.4-Fabric" = _ij9jaqAq;
        "pkg-1.4.15-1.21.11-Forge" = _hnIUaZ7N;
        "pkg-1.4.15-1.21.11-NeoForge" = _XYx72R36;
        "pkg-1.4.15-1.21.11-Fabric" = _Rp8JGNUZ;
        "pkg-1.4.12-1.21.1-NeoForge" = _GaKZSvsp;
        "pkg-1.4.12-1.21.1-Forge" = _i0PGl6Eu;
        "pkg-1.4.13-1.21.1-NeoForge" = _e61NNx3G;
        "pkg-1.5.3-26.1.1-Fabric" = _OowAVWWE;
        "pkg-1.5.3-26.1.1-NeoForge" = _PWSt80Lv;
        "pkg-1.5.4-26.1.2-NeoForge" = _DuY3vF4q;
        "pkg-1.5.5-26.1.2-NeoForge" = _qFYlH7Sx;
        "pkg-1.5.5-26.1.2-Fabric" = _ICt3FUKU;
        "pkg-1.4.16-1.21.11-Forge" = _Qt0H80A9;
        "pkg-1.4.16-1.21.11-NeoForge" = _9GUu2k1r;
        "pkg-1.4.16-1.21.11-Fabric" = _d5kv8o6s;
        "pkg-1.4.16-1.21.10-Forge" = _ybJ6GoTu;
        "pkg-1.4.16-1.21.10-NeoForge" = _kGz2Vebt;
        "pkg-1.4.16-1.21.10-Fabric" = _xeLMVciH;
        "pkg-1.4.16-1.21.8-Forge" = _DuICyVkB;
        "pkg-1.4.16-1.21.8-NeoForge" = _yOxfFhO6;
        "pkg-1.4.16-1.21.8-Fabric" = _5AFECqjX;
        "pkg-1.4.16-1.21.5-Forge" = _pfh4NYkZ;
        "pkg-1.4.16-1.21.5-NeoForge" = _U3ycYIT8;
        "pkg-1.4.16-1.21.5-Fabric" = _FMsyCehG;
        "pkg-1.4.16-1.21.4-Forge" = _bCiRv4ZL;
        "pkg-1.4.16-1.21.4-NeoForge" = _Frwxvu1a;
        "pkg-1.4.14-1.21.1-Forge" = _kvLxRTGg;
        "pkg-1.4.14-1.21.1-NeoForge" = _F1aUEP0e;
        "default" = _F1aUEP0e;
    });
