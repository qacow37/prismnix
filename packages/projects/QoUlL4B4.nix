...
let
    ...
    in {
        ...
        "pkg-5.0.0" = _WycYGUSW;
        "pkg-5.1.11" = _h6nuQSb6;
        "pkg-5.2.0" = _SejeeRWB;
        "pkg-5.2.1" = _er0YWgSi;
        "pkg-5.2.2" = _D5YBz0ni;
        "pkg-5.2.3" = _pVBTEwQ1;
        "pkg-5.2.4" = _HszHUHKq;
        "pkg-6.0.0-ALPHA" = _TE7DKtMc;
        "pkg-6.0.1-ALPHA" = _P9cC7USo;
        "pkg-6.0.2-ALPHA" = _nO8QlXzP;
        "pkg-6.0.3-BETA" = _kRAv5pu9;
        "pkg-6.1.0" = _WeP89Jyd;
        "pkg-6.1.2" = _6jwCvvSJ;
        "pkg-6.1.3" = _DbOacwH3;
        "pkg-6.1.4" = _GkRkzdrC;
        ...
        "pkg-8.3.7" = _KS5eclmO;
        "pkg-8.3.8" = _EyO8wx6M;
        "pkg-8.3.10" = _9YkONnyE;
        "pkg-8.3.11" = _QecwHytk;
        "pkg-8.3.12" = _uk90mVJP;
        "pkg-9.0.0" = _4WLkKR4Q;
        "pkg-9.0.1" = _Orw7u5xF;
        "pkg-9.0.2" = _Jj7YGBoZ;
        "pkg-9.0.3" = _iD1Agj2U;
