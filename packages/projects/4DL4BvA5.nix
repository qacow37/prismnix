...
let
    ...
    in {
        ...
        "pkg-1.1.2" = _k84YAhYl;
        "pkg-1.4.0" = _tWsIFS5s;
        "pkg-1.4.2_1.20" = _4m373SJh;
        "pkg-1.4.2_1.20.2" = _sU250HSY;
        "pkg-1.4.2_1.21" = _c14r4mdW;
        "pkg-1.4.2_1.21.2" = _2pe7fqYH;
        "pkg-1.4.2_1.21.5" = _awAgd3xd;
        "pkg-1.4.2_1.21.9" = _nGpZ9qVJ;
        "pkg-1.4.3_26.1-26.1.2" = _ZpDWMqXU;
        "default" = _ZpDWMqXU;
    });
