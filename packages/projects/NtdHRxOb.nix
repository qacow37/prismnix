...
let
    ...
    in {
        ...
        "pkg-0.1.6-mc1.18.2" = _A9qjiKJT;
        "pkg-0.1.6-mc1.17.1" = _vhXCiL8o;
        "pkg-0.1.6-mc1.20.2" = _UCsZ7A67;
        "pkg-0.1.6-mc1.16.5" = _4FkCVzeX;
        "pkg-0.1.6-mc1.20.4" = _XPJtDs1B;
        "pkg-0.1.6-mc1.19.4" = _fvj8LnbJ;
        "pkg-0.1.6-mc1.20.1" = _iRSeUmG5;
        "pkg-0.1.6-mc1.19.2" = _czblTaHa;
        "pkg-0.1.8-mc1.18.2" = _DxayBnXl;
        "pkg-0.1.8-mc1.17.1" = _dOwEIip4;
        "pkg-0.1.8-mc1.20.2" = _6qhBH5Bj;
        "pkg-0.1.8-mc1.19.4" = _SjtSFUd3;
        "pkg-0.1.8-mc1.19.2" = _f7s8b1xP;
        "pkg-0.1.8-mc1.20.1" = _kFcLkMoy;
        "pkg-0.1.8-mc1.16.5" = _Aja7D5dU;
        "pkg-0.1.8-mc1.20.4" = _xwlUJJpR;
        "pkg-0.1.8-tiny-mc1.18.2" = _wbKmfTFV;
        "pkg-0.1.8-tiny-mc1.19.4" = _zcAnhLzw;
        "pkg-0.1.8-tiny-mc1.20.2" = _E2sPEJrN;
        "pkg-0.1.8-tiny-mc1.20.6" = _Fcua1bU3;
        "pkg-0.1.8-tiny-mc1.21" = _PT0WlRCx;
        "pkg-0.1.8-tiny-mc1.20.1" = _cjfh3FUC;
        "pkg-0.1.8-tiny-mc1.20.4" = _SowfQ7Mh;
        "pkg-0.1.8-tiny-mc1.19.2" = _4FFdA4D3;
        "pkg-0.2.2-tiny-mc1.18.2" = _3JxOWmpP;
        "pkg-0.2.2-tiny-mc1.20.6" = _gITYnyOn;
        "pkg-0.2.2-tiny-mc1.20.2" = _4XfJimXP;
        "pkg-0.2.2-tiny-mc1.19.2" = _E4H7SCaL;
        "pkg-0.2.2-tiny-mc1.21" = _adnw0MoG;
        "pkg-0.2.2-tiny-mc1.20.1" = _7maN9zC4;
        "pkg-0.2.2-tiny-mc1.19.4" = _dXqUjjXH;
        "pkg-0.2.2-tiny-mc1.20.4" = _XSTqD6i1;
        "pkg-0.2.3-mc1.20.6" = _E245aeF7;
        "pkg-0.2.3-mc1.19.4" = _MVVbLTMr;
        "pkg-0.2.3-mc1.21" = _uXIOq7Ye;
        "pkg-0.2.3-mc1.20.4" = _s3myIvP8;
        "pkg-0.2.3-mc1.19.2" = _y7Mx0vEl;
        "pkg-0.2.3-mc1.20.2" = _XQGEyzG9;
        "pkg-0.2.3-mc1.20.1" = _NOOFzUDM;
        "pkg-0.2.3-mc1.18.2" = _Vjs4vslL;
        "pkg-0.2.5-mc1.21.4" = _Z2FfzkTo;
        "pkg-0.2.5-mc1.20.6" = _T7OAqIiS;
        "pkg-0.2.5-mc1.20.1" = _lWuIJzgu;
        "pkg-0.2.5-mc1.20.2" = _g7VSrCD3;
        "pkg-0.2.5-mc1.21.3" = _R49Zh2dA;
        "pkg-0.2.5-mc1.20.4" = _k9fWNSPu;
        "pkg-0.2.5-mc1.18.2" = _cQpAn5Bv;
        "pkg-0.2.5-mc1.21.1" = _TPOhJxQe;
        "pkg-0.2.5-mc1.19.4" = _S8Xqp9aM;
        "pkg-0.2.5-mc1.19.2" = _pzOBlSaG;
        "pkg-0.2.7-mc1.19.4" = _7a22EQdS;
        "pkg-0.2.7-mc1.19.2" = _CEISfqH0;
        "pkg-0.2.7-mc1.21.1" = _Hk8Nc8tm;
        "pkg-0.2.7-mc1.20.6" = _iBplZ1lM;
        "pkg-0.2.7-mc1.21.11" = _ZLPLdCjZ;
        "pkg-0.2.7-mc1.20.4" = _RHg95wq4;
        "pkg-0.2.7-mc1.20.1" = _8qQw1gTL;
        "pkg-0.2.7-mc1.21.3" = _g9FKnYjI;
        "pkg-0.2.7-mc1.20.2" = _5EHBnk51;
        "pkg-0.2.7-mc1.21.4" = _5wxNQkhi;
        "pkg-0.2.7-mc1.18.2" = _7akwggjD;
        "pkg-0.3.1-mc1.19.2" = _meBBxc4B;
        "pkg-0.3.1-mc1.20.1" = _m1clRJiU;
        "pkg-0.3.1-mc1.21.11" = _sVcItuCc;
        "pkg-0.3.1-mc1.20.4" = _UcKNJ4Cg;
        "pkg-0.3.1-mc1.20.2" = _UEKJ2FW3;
        "pkg-0.3.1-mc1.21.4" = _tIDZbtRz;
        "pkg-0.3.1-mc1.19.4" = _loUkoOC1;
        "pkg-0.3.1-mc1.20.6" = _fACEkMph;
        "pkg-0.3.1-mc1.21.1" = _FUcSVGO7;
        "pkg-0.3.1-mc1.21.3" = _9hTxIJxN;
        "pkg-0.3.1-mc1.18.2" = _lfxRyBzZ;
        "default" = _9hTxIJxN;
    });
