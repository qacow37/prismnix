...
let
    ...
    in {
        ...
        "pkg-1.0" = _KZMXreco;
        "pkg-1.0_mod" = _Pnrk5aUb;
        "pkg-1.1" = _4VGY2mGg;
        "pkg-1.3" = _odhoTXF8;
        "pkg-1.3+mod" = _NUU8ipva;
        "pkg-1.4" = _GbKbuWWI;
        "pkg-1.4+mod" = _XMhEhgiU;
        "pkg-1.5" = _2uvlV6Z7;
        "pkg-1.5+mod" = _Z9Vt8zVX;
        "pkg-2.0" = _Xs4OpL7D;
        "pkg-2.0+mod" = _tCOg0kyM;
        "pkg-2.1" = _kYEWuVVq;
        "pkg-3.0" = _mvZ82ZyO;
        "pkg-3.0+mod" = _O8gskDi3;
        "pkg-3.1" = _OuMbfQ6q;
        "pkg-3.1+mod" = _pCUsqAC9;
        "pkg-3.2" = _Kbxt8D0c;
        "pkg-3.2+mod" = _Gv8DnWZn;
        "pkg-3.3" = _oA3uixl4;
        "pkg-3.3+mod" = _ShcWEL4H;
        "pkg-3.4" = _A84Dqsp4;
        "pkg-3.4+mod" = _juGaD2LS;
        "pkg-3.5" = _uGlaHSHz;
        "pkg-3.5+mod" = _9OirEWOL;
        "pkg-3.6" = _vhLoWKEJ;
        "pkg-3.6+mod" = _6m57g76Q;
        "pkg-3.7" = _HZME7J1u;
        "pkg-3.7-fabric" = _bCidZBDY;
        "pkg-3.7-forge" = _1EgXl1D3;
        "pkg-3.11" = _IiXW6fDB;
        "pkg-3.11-fabric" = _yRb9lvyP;
        "pkg-3.11-quilt" = _M77XvGPM;
        "pkg-3.11-forge" = _rMAe9wb8;
        "pkg-3.11-neoforge" = _wpxYpvhY;
        "pkg-3.12" = _UmiMZ9Fs;
        "pkg-3.12-fabric" = _mYUfrAc9;
        "pkg-3.12-quilt" = _QedJICq0;
        "pkg-3.12-forge" = _yglTRxdx;
        "pkg-3.12-neoforge" = _boIcOQ2S;
        "default" = _boIcOQ2S;
    });
