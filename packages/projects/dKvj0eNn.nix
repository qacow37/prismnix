...
let
    ...
    in {
        ...
        "pkg-6.0.7-1" = _6zpUOx8d;
        "pkg-6.0.7-2" = _CEAK0ioe;
        "pkg-6.0.7-3" = _D4AcOax6;
        "pkg-6.0.7-4" = _l36OQGHh;
        "pkg-6.0.7-5" = _AhcENw8Z;
        "pkg-6.0.7-6" = _NNPx1EB0;
        "pkg-6.0.7-7" = _fyxmSmQR;
        "pkg-6.0.7-8" = _zvYCm7xu;
        "pkg-6.0.7-9" = _qS2HOFnl;
        "pkg-6.0.7-10" = _2anoFMXv;
        "pkg-6.0.7-11" = _RAZbM86L;
        "pkg-6.0.7-12" = _KEtPX2Uq;
        "pkg-6.0.7-13" = _hO8jOzS1;
        "pkg-6.0.7-14" = _k3ngncHu;
        "pkg-6.0.7-15" = _T5nNxd8F;
        "pkg-6.0.7-16" = _skgRwjDE;
        "pkg-6.0.7-1.21.8-17" = _9PNersCd;
        "pkg-6.0.7-1.21.8-18" = _RYAZzgTM;
        "pkg-6.0.7-1.21.8-19" = _vzU4db2X;
        "pkg-6.0.8-1.21.10-1" = _W6mPqcEP;
        "pkg-6.0.8-1.21.10-2" = _Jf0AK9lK;
        "pkg-1.21.8-6.0.8-1" = _SRvCpl1p;
        "pkg-1.21.10-6.0.8-3" = _Ng8cSdiW;
        "pkg-1.21.8-6.0.8-2" = _xmqjlfxH;
        "pkg-1.21.10-6.0.8-4" = _gqbT1OFs;
        "pkg-25w46a_unobfuscated-6.0.8-1" = _IXAwX2Rl;
        "pkg-1.21.11-pre1_unobfuscated-6.0.8" = _6LBSD22o;
        "pkg-1.21.11-pre1-6.0.8-1" = _SoBMtbqn;
        "pkg-1.21.11-pre3_unobfuscated-6.0.8" = _tPrlMK0q;
        "pkg-1.21.11-pre3-6.0.8-1" = _tWozh1zB;
        "pkg-1.21.10-6.0.8-5" = _FPQpn6uh;
        "pkg-1.21.8-6.0.8-3" = _RHhakv00;
        "pkg-1.21.11-rc3_unobfuscated-6.0.8-1" = _74HxwZOE;
        "pkg-1.21.11-rc3-6.0.8-1" = _fpm0hx9j;
        "pkg-1.21.11-6.0.8-2" = _9g5qUul3;
        "pkg-1.21.11-6.0.8-3" = _eKrsn87N;
        "pkg-26.1-snapshot-1-6.0.8-1" = _tvEa0GJf;
        "pkg-1.21.8-6.0.8-4" = _6JrsZOPs;
        "pkg-1.21.10-6.0.8-6" = _WNyiTECO;
        "pkg-1.21.11-6.0.8-4" = _be2IkC5H;
        "pkg-1.21.11-6.0.9-1" = _nmRejCEn;
        "pkg-1.21.10-6.0.9-1" = _D7jLN6vS;
        "pkg-1.21.8-6.0.9-1" = _WY63sRhY;
        "pkg-1.21.11-6.0.9-2" = _rl6RbqSA;
        "pkg-26.1-snapshot-4-6.0.9-1" = _McDHzw2F;
        "pkg-26.1-snapshot-5-6.0.9-1" = _VCxbV6DL;
        "pkg-26.1-snapshot-5-6.0.9-2" = _hQTtTKtg;
        "pkg-1.21.11-6.0.9-3" = _OKaSuwY2;
        "pkg-26.1-snapshot-6-6.0.9-1" = _j68bOwOi;
        "pkg-1.21.10-6.0.9-2" = _oYhbStma;
        "pkg-1.21.8-6.0.9-2" = _v37IUNm0;
        "pkg-1.21.11-6.0.9-4" = _zhCA7BYS;
        "pkg-26.1-snapshot-9-6.0.9-1" = _Pikdi1ME;
        "pkg-1.21.11-6.0.9-5" = _fn0H9rSj;
        "pkg-26.1-snapshot-10-6.0.9-1" = _PQ0uI7sd;
        "pkg-26.1-snapshot-11-6.0.9-1" = _T4q32hqT;
        "pkg-26.1-pre-1-6.0.9-1" = _1X6HTcI8;
        "pkg-26.1-pre-2-6.0.9-1" = _yo8wJ3Vc;
        "pkg-26.1.2-6.0.9-1" = _x6LrDHTO;
        "pkg-26.2-pre-1-6.0.9-1" = _aSoVapQD;
        "pkg-26.1.2-6.0.9-2" = _gtTZ0Q1I;
        "pkg-26.1.2-6.0.9-3" = _vEVCWisR;
        "pkg-26.2-pre-4-6.0.9-1" = _ASrLBo5M;
        "pkg-26.2-rc-2-6.0.9-1" = _phlsMPgT;
        "pkg-26.1.2-6.0.9-4" = _wV5IQLKg;
        "default" = _wV5IQLKg;
    });
