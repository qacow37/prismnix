...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _ExOVulCA;
        "pkg-1.0.1-Fabric" = _dQKl1J2E;
        "pkg-1.0.1-Forge" = _NvSEDpdr;
        "pkg-1.0.2+1.19.2" = _KDMdqwcU;
        "pkg-1.0.3+1.19.2" = _bJpKgNxr;
        "pkg-1.0.4+1.19.2" = _TQyYS6Wi;
        "pkg-1.0.4b+1.19.2" = _217gpIhe;
        "pkg-1.1.0" = _My8BXC8o;
        "pkg-1.2.0" = _8Q3SOwlU;
        "pkg-1.2.0+1.20.1" = _hXGRSDZj;
        "pkg-1.2.1+1.20.1" = _TMc1K1Gm;
        "pkg-1.2.1" = _jIuVZUvD;
        "pkg-1.2.2" = _UDNiWugr;
        "pkg-1.2.2+1.20.1" = _PiG4GCBQ;
        "pkg-1.2.3" = _LFVKcBWV;
        "pkg-1.2.3+1.20.1" = _t5y1m8M4;
        "pkg-1.2.4" = _IVT8LiM5;
        "pkg-1.2.4+1.20.1" = _2qXJfFYa;
        "pkg-1.3.0+1.20.1" = _MAxJH6EH;
        "pkg-1.3.0" = _DC8j7ykB;
        "pkg-1.3.1+1.20.1" = _YkDqfHmy;
        "pkg-1.4.1+121.1" = _fwscjsEV;
        "pkg-1.4.2" = _oDoWm6Jm;
        "pkg-1.5.0" = _ZYtnELom;
        "default" = _ZYtnELom;
    });
