...
let
    ...
    in {
        ...
        "pkg-1.6-fabric-1.0.0" = _mvO6mdqc;
        "pkg-1.6-fabric-1.0.1" = _hR2ryZRa;
        "pkg-1.6-fabric-1.1.0" = _cMkTbFS3;
        "pkg-1.6-fabric-1.1.1" = _gJftgBil;
        "pkg-1.6-fabric-1.2.0" = _umkXHWa8;
