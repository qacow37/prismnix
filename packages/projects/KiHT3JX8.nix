...
let
    ...
    in {
        ...
        "pkg-0.2.8" = _6alhmPw3;
        "pkg-0.2.9" = _C7lbn359;
        "pkg-0.2.10" = _Pr8EB5PT;
        "pkg-0.2.11" = _m7tmShrq;
        "pkg-0.2.12" = _HQ5RVwqS;
        "pkg-0.2.13" = _aadoHSQy;
        "pkg-0.2.14" = _qdYtBWwr;
        "pkg-1.0.0" = _qQ2UzYH7;
        "pkg-1.0.1" = _BZBboRr7;
        "pkg-1.1.0" = _VtFzgB8X;
        "pkg-1.2.0-Beta.1" = _dUyp8JMY;
        "pkg-1.2.0-Beta.2" = _DCe0JwrY;
        "pkg-1.2.0-Beta.3" = _m8WFIFaf;
        "pkg-1.2.0-Beta.4" = _5v1UDHp4;
        "pkg-1.2.0" = _aoD77jLS;
        "pkg-1.2.1" = _jmHuiAf0;
        "pkg-1.2.2" = _rXqqY5Ok;
        "default" = _rXqqY5Ok;
