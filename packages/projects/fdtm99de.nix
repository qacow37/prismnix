...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _YginI4bK;
        "pkg-1.2.0" = _mSywpwjv;
        "pkg-1.0.0-1.16.5" = _OI4DNKbD;
        "pkg-1.1.0-1.16.5" = _rdiShqBH;
        "pkg-1.2.1-1.16.5" = _o2Uc7aXO;
        "pkg-1.2.1" = _Lg1s6jKt;
        "pkg-1.2.2-1.16.5" = _7tlo0rEJ;
        "pkg-1.3.0" = _nk7Ku3cU;
        "pkg-1.3.0-1.16.5" = _bMxVnae4;
        "pkg-1.4.0-1.17.1" = _40j6BLif;
        "pkg-1.4.0-1.16.5" = _FR99RMi3;
        "pkg-1.5.0-1.17.1" = _ppVmyBwi;
        "pkg-1.5.0-1.16.5" = _AHjZmnzO;
        "pkg-1.5.0-1.18" = _7eLlk7bu;
        "pkg-1.6.0-1.18.2" = _DaCSKOul;
        "pkg-2.0.0-1.18.2" = _cLBgpVIm;
        "pkg-2.0.1-1.18.2" = _l8dzMslG;
        "pkg-2.0.1-1.16.5" = _1KmioMir;
        "pkg-2.0.2-1.18.2" = _vnhX2JlS;
        "pkg-2.0.2-1.19.2" = _trFS7jC2;
        "pkg-1.2-1.16.5" = _VPkQMJsa;
        "pkg-1.2-1.18.2" = _27m4go9F;
        "pkg-1.2-1.19.2" = _roU7BQC2;
        "pkg-1.2-1.19.3" = _g1B0fOgq;
        "pkg-2.0.2-1.19.4" = _gE7VID8D;
        "pkg-2.1.0-1.20.1" = _UsAyM0cA;
        "pkg-3.0.0-1.20.1" = _w97ixzc7;
        "pkg-3.0.0-1.19.4" = _I0S6ufwt;
        "pkg-3.0.0-1.20.2" = _OE1EDHZM;
        "pkg-4.0.0-1.20.2" = _7O7c1zLO;
        "pkg-1.2-1.20.1" = _ZItltU1C;
        "pkg-4.0.0-1.21.1" = _BEfm3cNd;
        "pkg-4.1.0-1.21.4" = _EYD6YWOX;
        "pkg-4.2.0+1.21.5" = _FVfS4Ubi;
        "pkg-4.3.0+26.1" = _kyGtszbV;
        "default" = _kyGtszbV;
    });
