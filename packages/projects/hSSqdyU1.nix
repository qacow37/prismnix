...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.1.2" = _oMs4bPqU;
        "pkg-1.19.2-1.1.2-hotfix-1" = _ajXB63z0;
        "pkg-1.18.2-1.1.2-hotfix-1" = _LC5uJUV2;
        "pkg-1.19.2-1.1.2-hotfix-2" = _PMo7UfvC;
        "pkg-1.18.2-1.2" = _B8qyuecf;
        "pkg-1.19.2-1.2" = _cGUPdzW9;
        "pkg-1.18.2-1.2-hotfix-1" = _tEYqj50K;
        "pkg-1.19.2-1.2-hotfix-1" = _ZaZUxgS2;
        "pkg-1.18.2-1.2.1" = _eaxbpIn7;
        "pkg-1.19.2-1.2.1" = _sbSFRtf9;
        "pkg-1.18.2-1.3" = _kTMVacGL;
        "pkg-1.19.2-1.3" = _hXhPy3AJ;
        "pkg-1.18.2-1.3-hotfix-1" = _maGChkSB;
        "pkg-1.19.2-1.3-hotfix-1" = _7PDmefaP;
        "pkg-1.18.2-1.4" = _ba0ifPo8;
        "pkg-1.19.2-1.4" = _61Nqb9Vu;
        "pkg-1.20.1-1.4" = _bL79Qu7Y;
        "pkg-1.18.2-1.4.1" = _ofhzItfu;
        "pkg-1.19.2-1.4.1" = _W1kY0pHI;
        "pkg-1.20.1-1.4.1" = _xUogIASM;
        "pkg-1.18.2-1.4.1-hotfix-1" = _YeNAlBRf;
        "pkg-1.19.2-1.4.1-hotfix-1" = _dHCDcK8y;
        "pkg-1.18.2-1.4.2" = _9KEq9IJ0;
        "pkg-1.19.2-1.4.2" = _hD1mZq2X;
        "pkg-1.20.1-1.4.2" = _BaTNq3mq;
        "pkg-1.20.1-1.4.2-fix1" = _5HDsqk5E;
        "pkg-1.18.2-1.5.0" = _RfQT42ne;
        "pkg-1.19.2-1.5.0" = _uv84VunY;
        "pkg-1.20.1-1.5.0" = _mtRs2yNk;
        "pkg-1.18.2-1.5.0-ht1" = _HSgYHHkc;
        "pkg-1.19.2-1.5.0-ht1" = _TN3ARpcx;
        "pkg-1.20.1-1.5.0-ht1" = _JFefptFZ;
        "pkg-1.18.2-1.5.0-ht2" = _hNPZzMyo;
        "pkg-1.19.2-1.5.0-ht2" = _sOTDkFxX;
        "pkg-1.20.1-1.5.0-ht2" = _TqfQVJnX;
        "pkg-1.18.2-1.5.0-ht3" = _ZhiNbLcb;
        "pkg-1.19.2-1.5.0-ht3" = _AbMy5Utd;
        "pkg-1.20.1-1.5.0-ht3" = _WY3pxZHw;
        "pkg-1.18.2-1.6.0" = _x4rDDo0f;
        "pkg-1.19.2-1.6.0" = _plK9vMdr;
        "pkg-1.20.1-1.6.0" = _m7BIb963;
        "pkg-1.18.2-1.6.0-ht1" = _FEjKRcFY;
        "pkg-1.19.2-1.6.0-ht1" = _uCbm7pvr;
        "pkg-1.18.2-1.6.0-fix2" = _7vfDKu5p;
        "pkg-1.19.2-1.6.0-fix2" = _qNTQEWqk;
        "pkg-1.20.1-1.6.0-fix1" = _RIW3rx3g;
        "pkg-1.18.2-1.6.1" = _yeyk8TpR;
        "pkg-1.19.2-1.6.1" = _xnwRiZf3;
        "pkg-1.20.1-1.6.1" = _RtQVYLzT;
        "pkg-1.18.2-1.6.1-fix1" = _6TulqT3D;
        "pkg-1.19.2-1.6.1-fix1" = _5AxR7VfH;
        "pkg-1.20.1-1.6.1-fix1" = _hGPiOsMX;
        "pkg-1.18.2-1.6.1-fix2" = _fWcMY1CH;
        "pkg-1.19.2-1.6.1-fix2" = _MyV1x1Cg;
        "pkg-1.20.1-1.6.1-fix2" = _yFzsPaVO;
        "pkg-1.18.2-1.6.1-fix3" = _CVuWRQ9C;
        "pkg-1.19.2-1.6.1-fix3" = _OcbYnMnp;
        "pkg-1.20.1-1.6.1-fix3" = _UZ4cUfP8;
        "pkg-1.20.1-1.6.2" = _4MpIYxcS;
        "pkg-1.20.1-1.6.2-fix1" = _l0zvmFWJ;
        "pkg-1.20.1-1.6.2-fix2" = _NShFu61v;
        "pkg-1.20.1-1.6.2-fix3" = _FCvqB3ZH;
        "pkg-1.7.0" = _k0XmHBh4;
        "pkg-1.7.0-fix1" = _QExImWNo;
        "pkg-1.7.1" = _aXNbH7i5;
        "pkg-1.7.1-fix1" = _VrTTZeAX;
        "pkg-1.7.1-fix2" = _zNgF4iaI;
        "pkg-1.7.2" = _jnc2OCt3;
        "pkg-1.7.2-fix1" = _UD0ec9MP;
        "pkg-1.7.2-fix2" = _KQsWJIIJ;
        "pkg-1.8" = _dj4XhiM0;
        "pkg-1.8-ht1" = _SeSZKagl;
        "pkg-1.8-ht2" = _sjCAxK2s;
        "pkg-1.8.1" = _5ZrKxCun;
        "pkg-1.8.1-ht1" = _3sUW27Ho;
        "pkg-1.8.1-ht2" = _clv4iPn9;
        "pkg-1.21.1-1.9.0" = _rHH4OdQT;
        "pkg-1.21.1-1.9.0-ht1" = _R3MyXfQc;
        "pkg-1.21.1-1.9.0-ht2" = _qEcBfwlD;
        "pkg-1.21.1-1.9.0-ht3" = _t6MATlU9;
        "default" = _t6MATlU9;
    });
