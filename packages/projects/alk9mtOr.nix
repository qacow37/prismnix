...
let
    ...
    in {
        ...
        "pkg-6.5.1" = _f2m61BnG;
        "pkg-7.0.0" = _J2RHi4mQ;
        "pkg-7.0.0+mod" = _QG66XGsT;
        "pkg-7.0.1" = _VDt8K0sr;
        "pkg-7.0.1+mod" = _nr9c3HCZ;
        "pkg-7.0.2" = _s9p27CHZ;
        "pkg-7.0.2+mod" = _T7QC2mXw;
        "pkg-7.1.4" = _avhjPrE4;
        "pkg-7.1.4+mod" = _JkbqVUYg;
        "pkg-7.3" = _acyGuPBd;
        "pkg-7.3.1" = _9a51u3PP;
        "pkg-7.4.0" = _MfZdW62C;
        "pkg-7.4.0+mod" = _jSLQC4od;
        "pkg-7.4.1" = _5daimhNm;
        "pkg-7.4.1+mod" = _A2aZyQ9H;
        "pkg-7.4.2" = _yaUqzIbI;
        "pkg-7.4.2+mod" = _Giw7lsrJ;
        "pkg-7.4.3" = _CcErXmys;
        "pkg-7.4.3+mod" = _xjlGo5It;
        "pkg-7.5J" = _A2dhMRSF;
        "pkg-7.5J+mod" = _EUcjGJGI;
        "pkg-7.4.4" = _713jabm0;
        "pkg-7.4.4+mod" = _Zi4012Gq;
        "pkg-7.5.1J" = _clEbDue8;
        "pkg-7.5.1J+mod" = _pKzOXIBt;
        "pkg-v7.6J" = _eIu6O71j;
        "pkg-v7.6J+mod" = _pys0PUJZ;
        "pkg-7.6.1" = _Az9E2lEd;
        "pkg-7.6.1+mod" = _AH1Z46EU;
        "pkg-7.7.0-b.1" = _VWrVCVJM;
        "pkg-7.7.0-b.1+mod" = _2mHOSF2Y;
        "pkg-7.7.0-b.2" = _4zKBHjnG;
        "pkg-7.7.0-b.2+mod" = _Be0HBEYq;
        "pkg-7.7.0-b.3" = _JEsXs05z;
        "pkg-7.7.0-b.3+mod" = _HDh1OJqE;
        "pkg-7.7.0-b.4" = _so3ZTQYq;
        "pkg-7.7.0-b.4+mod" = _X5StrUTf;
        "pkg-7.6.2J" = _GgrbULiX;
        "pkg-7.7.0-b.5" = _JKuRy5qY;
        "pkg-7.7.0-b.5+mod" = _6FlrFnLr;
        "pkg-7.6.9.3" = _YQKJLjbk;
        "pkg-7.6.9.3+mod" = _1YUy5GZq;
        "pkg-7.7.0-b.6" = _Uc9YAsls;
        "pkg-7.7.0-b.6+mod" = _uabW9tJb;
        "pkg-7.7.0-b.7" = _bZykpoRz;
        "pkg-7.7.0-b.7+mod" = _Feda1opp;
        "pkg-v7.6.9.4J" = _kmzSkbpN;
        "pkg-v7.6.9.4J+mod" = _Siww4L50;
        "pkg-7.7.0-b.8" = _Dj3bEa0m;
        "pkg-7.7.0-b.8+mod" = _vxYLK79H;
        "pkg-7.6.9.5.1" = _jwci7pfd;
        "pkg-7.6.9.5.1+mod" = _1F2xATPV;
        "pkg-7.6.10J" = _19DLXcgg;
        "pkg-7.6.10J+mod" = _8gZVLn3k;
        "pkg-b8.0R" = _zrp6r7NL;
        "pkg-7.8J" = _NQF2J6xR;
        "pkg-7.8J+mod" = _5brS50i1;
        "pkg-8.0" = _ZJNtbz9x;
        "pkg-8.0+mod" = _OmKXkLHY;
        "pkg-8.1" = _d0qFCrhT;
        "pkg-8.1+mod" = _zSfAV2Kk;
        "default" = _zSfAV2Kk;
    });
