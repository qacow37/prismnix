...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _gavNr2eX;
        "pkg-1.4.2" = _TFZljdgN;
        "pkg-1.4.3-dev" = _ZCJRkBTZ;
        "pkg-1.4.3" = _E1jazuPt;
        "pkg-1.4.4" = _MSB2sYkm;
        "pkg-1.5.0-beta-01" = _zcpkwU5X;
        "pkg-1.5.0-beta-02" = _bzqQiO98;
        "pkg-1.5.0-beta-03" = _rGQOOIoz;
        "pkg-1.5.0-beta-04" = _QdLDEOJA;
        "pkg-1.5.0-beta-05" = _E3hJux6E;
        "pkg-1.5.0" = _PsSqynoa;
        "pkg-1.5.1" = _8B2X8Bti;
        "default" = _8B2X8Bti;
    });
