...
let
    ...
    in {
        ...
        "pkg-1.6.8-BETA" = _GAdVDJl4;
        "pkg-1.6.9-BETA" = _yAmtMAD7;
        "pkg-1.7-BETA" = _APAdRkJm;
        "pkg-1.7-BETA-1.17" = _FrF4BWMJ;
        "pkg-1.7.1-BETA+1.17" = _3z8ZU57O;
        "pkg-1.7.2-BETA+1.17" = _L2K4SVEE;
        "pkg-1.8-BETA+1.17" = _D167X0Q3;
        "pkg-1.8.1-BETA+1.17" = _xwjXdfpF;
        "pkg-1.9-BETA+1.17" = _SAbmeU12;
        "pkg-1.9.1-BETA+1.17" = _sscCEhIk;
        "pkg-1.9.2-BETA+1.17" = _Xbi9eKxC;
        "pkg-1.9.3-BETA+1.17" = _4NvMIZvI;
        "pkg-1.9.4-BETA+1.17" = _8R8VR8YZ;
        "pkg-1.9.4-BETA+1.18" = _Id2zyOlb;
        "pkg-1.9.5-BETA+1.18" = _pND9xDum;
        "pkg-1.9.6-BETA+1.18" = _sEbuK6OW;
        "pkg-1.9.7-BETA+1.18" = _v8Rke4sd;
        "pkg-1.9.8-BETA+1.19" = _kWbKUHEB;
        "pkg-1.9.8-BETA+1.18" = _BrYy7fU9;
        "pkg-1.9.9-BETA+1.19" = _yV6x0au5;
        "pkg-1.9.9-BETA+1.18" = _nE71ldFN;
        "pkg-1.9.10-BETA+1.18" = _bevNrLtU;
        "pkg-1.9.10-BETA+1.19" = _kdqdqgn8;
        "pkg-1.9.11-BETA+1.18" = _ONMvUMXi;
        "pkg-1.9.11-BETA+1.19" = _nfMLEeVC;
        "pkg-1.10-BETA+1.19" = _K3SjN7Sq;
        "pkg-1.10-BETA+1.20" = _cLyWULEs;
        "pkg-1.10.1-BETA+1.19" = _6GPdTrdx;
        "pkg-1.10.1-BETA+1.20" = _fhSgEP7Z;
        "pkg-2.0-BETA+1.21" = _KNpAjdqw;
        "pkg-2.1-BETA" = _WU9MuRUT;
        "pkg-2.2" = _c7F9nerD;
        "pkg-2.3" = _KqTyKIhI;
        "pkg-2.3.1" = _KgqSZphN;
        "default" = _KgqSZphN;
