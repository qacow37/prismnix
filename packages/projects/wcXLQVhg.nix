...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _6wQOhhtk;
        "pkg-0.1.1" = _Peo7AGrW;
        "pkg-1.20.x-0.2.0" = _kK7sGCre;
        "pkg-1.20.x-0.2.2" = _RvK88YAU;
        "pkg-1.20.x-0.2.4" = _5Kw91eyp;
        "pkg-1.20.x-1.0.0" = _MoMoLVq4;
        "pkg-1.20.2-0.1.0" = _iTnu1kph;
        "pkg-1.20.x-1.0.1" = _B7iCcP4Q;
        "pkg-1.1.0-fabric" = _NnyN2nJh;
        "pkg-1.1.0-forge" = _Wejgznhq;
        "pkg-1.1.0+fabric" = _S7lYr3Fj;
        "pkg-1.21-1.21.8-1.2.0+fabric" = _ECi9jVCt;
        "pkg-1.21-1.21.5-1.2.0+forge" = _8H2mQzwW;
        "pkg-1.21-1.21.5-1.2.0+neoforge" = _HNDAAz4p;
        "pkg-1.21.6-1.21.8-1.2.0+fabric" = _xTmXcpcK;
        "pkg-1.21.6-1.21.8-1.2.0+forge" = _ZEidzobp;
        "pkg-1.21.6-1.21.8-1.2.0+neoforge" = _NNqqngco;
        "pkg-1.21.9-1.21.10-1.2.0+fabric" = _TeHnmXLg;
        "pkg-1.21.9-1.21.10-1.2.0+forge" = _zexuiIEf;
        "pkg-1.21.9-1.21.10-1.2.0+neoforge" = _gxVLYBCp;
        "pkg-1.2.11-1.2.0+fabric" = _nO0jjpNY;
        "pkg-1.21.11-1.2.0+forge" = _ncT4rDCW;
        "pkg-1.21.11-1.2.0+neoforge" = _Hh6K9T5K;
        "pkg-1.20-1.20.1-1.2.0+fabric" = _MNwu47GM;
        "pkg-1.3.0+forge" = _vNbu7QxN;
        "pkg-1.3.0+neoforge" = _8tD9Or3v;
        "pkg-1.3.0+fabric" = _RAs7JF9w;
        "pkg-1.3.0-1.20-1.20.1-forge" = _vYF9TsDY;
        "pkg-1.3.0-1.20-1.20.1-fabric" = _HFZElEvu;
        "pkg-26.1-1.3.1+forge" = _a4jFp2M5;
        "pkg-26.1-1.3.1+fabric" = _auXsU4MT;
        "pkg-26.1-1.3.1+neoforge" = _PWOooLBL;
        "pkg-26.2.x-1.3.1+forge" = _EVsalx6P;
        "pkg-26.2.x-1.3.1+neoforge" = _PSUZyZLp;
        "pkg-26.2.x-1.3.1+fabric" = _8pJrGHcS;
        "default" = _8pJrGHcS;
    });
