...
let
    ...
    in {
        ...
        "pkg-1.1" = _mles9mxI;
        "pkg-1.1+mod" = _7H330ss8;
        "pkg-1.2" = _dTHyQ5Ov;
        "pkg-1.2+mod" = _fhnkvmhf;
        "pkg-1.3" = _InUsmH4y;
        "pkg-1.3+mod" = _Co9bNWxn;
        "pkg-1.3.1" = _EjUt8xht;
        "pkg-1.3.1+mod" = _qQxEvM1U;
        "pkg-1.3.2" = _eKyreUIM;
        "pkg-1.3.2+mod" = _SwxRRwxH;
        "pkg-1.4" = _s6RyXxOC;
        "pkg-1.4+mod" = _HcLUSGx2;
        "pkg-1.4.1" = _y1H7x9Rf;
        "pkg-1.4.1+mod" = _8b3teE3m;
        "pkg-1.4.2" = _JFdn4u2t;
        "pkg-1.4.2+mod" = _ux2CLJiT;
        "pkg-1.4.3" = _4sRNXQxM;
        "pkg-1.4.3+mod" = _4oTQ0aFZ;
        "pkg-1.4.4" = _5E8EQ0gT;
        "pkg-1.4.4+mod" = _p4oeqgKt;
        "pkg-1.4.5" = _hTxBcRtS;
        "pkg-1.4.5+mod" = _ZzT3xlG9;
        "pkg-v2.0.0" = _r9UQTf58;
        "pkg-v2.0.0+mod" = _QXDTr4KT;
        "pkg-v2.0.1" = _J5xKUU9Q;
        "pkg-v2.0.1+mod" = _9mppcTJD;
        "pkg-v2.0.2" = _wm2M5NVV;
