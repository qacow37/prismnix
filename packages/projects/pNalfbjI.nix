...
let
    ...
    in {
        ...
        "pkg-0.1a-1.19.2" = _UWxzyLgB;
        "pkg-0.1b-1.19.2" = _Zpkf6hJY;
        "pkg-0.5a-1.19.2" = _kSTau9wf;
        "pkg-0.8a-1.19.2" = _qfn6F3p2;
        "pkg-0.9a-1.19.2" = _PxKoqA14;
        "pkg-1.0a-1.19.2" = _mmLiPfKU;
        "pkg-1.1a-1.20.1" = _HcHW7t8d;
        "pkg-1.2a-1.20.1" = _T24f11Fe;
        "pkg-1.0b-1.19.2" = _yv5iDxP4;
        "pkg-1.2b-1.20.1" = _7eEnxlSX;
        "pkg-1.2c-1.20.1" = _Lx68rnLt;
        "pkg-1.0c-1.19.2" = _UEWKj8iN;
        "pkg-1.0d-1.19.2" = _8WvRrClF;
        "pkg-1.2.1a-1.20.1" = _iNi3op4l;
        "pkg-1.5a-1.20.1" = _fcA8wUXm;
        "pkg-1.7a-Fabric-1.20.1" = _RlLP9pUr;
        "pkg-1.7a-Forge-1.20.1" = _S7xiBC9S;
        "pkg-1.7b-Fabric-1.20.1" = _niXdvsKl;
        "pkg-1.7b-Forge-1.20.1" = _9fin2Dlj;
        "pkg-1.8a-1.20.1-Fabric" = _N2X3rOX9;
        "pkg-1.8a-1.20.1-Forge" = _Fx074lDE;
        "pkg-1.8b-1.20.1-Fabric" = _HEUG3Yat;
        "pkg-1.9.0-1.20.1-Forge" = _nq6fTmbk;
        "pkg-1.9.0-1.20.1-Fabric" = _zspWWrh8;
        "default" = _zspWWrh8;
    });
