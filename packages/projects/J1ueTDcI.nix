...
let
    ...
    in {
        ...
        "pkg-1.0+1.18-pre8" = _LduoPLjs;
        "pkg-1.0+1.19" = _Z0PuMRs6;
        "pkg-1.0.1+1.19" = _nUxEQc7a;
        "pkg-1.0.1+1.18" = _rtLUoYK5;
        "pkg-1.0.2+1.19.4" = _Faxme193;
        "pkg-1.0.2+1.20" = _E69ybICK;
        "pkg-1.0.3+1.20" = _lpiWg1KY;
        "pkg-1.0.4+1.20" = _EdYtdl7M;
        "pkg-1.1.0+1.20.1" = _rumVxhRb;
        "pkg-2.0+1.20.4-neoforge" = _dl79c7ax;
        "pkg-2.0+1.20.4-fabric" = _zUYin33t;
        "pkg-2.0+1.20.5-neoforge" = _Skmsjaxw;
        "pkg-2.0+1.20.5-fabric" = _pIlG7kMg;
        "pkg-2.1+1.20.6-fabric" = _uVR402RX;
        "pkg-2.1+1.20.6-neoforge" = _aFDWr1ID;
        "pkg-2.1+1.21-fabric" = _23zkZo1G;
        "pkg-2.1+1.21-neoforge" = _TLvxR1YD;
        "pkg-2.1+1.21.3-fabric" = _NEIuX08d;
        "pkg-2.1+1.21.3-neoforge" = _wkJmSv5I;
        "pkg-2.1+1.21.10-neoforge" = _fO17350G;
        "pkg-2.1+1.21.10-fabric" = _aOS8RAba;
        "pkg-2.1+1.21.11-fabric" = _smgHuSXq;
        "pkg-2.1+1.21.11-neoforge" = _cNxM3L8R;
        "pkg-neoforge-3.0.0+26.1.2" = _xdKtZgvv;
        "pkg-fabric-3.0.0+26.1.2" = _Sk8jR0Jt;
        "pkg-3.0.0+26.2-neoforge" = _5iPFpcef;
        "pkg-3.0.0+26.2-fabric" = _RsKpvlSf;
        "default" = _RsKpvlSf;
    });
