...
let
    ...
    in {
        ...
        "pkg-2.0.0-1.20.1" = _RWSuVcml;
        "pkg-2.1.0-1.20.1" = _PH7WmHfG;
        "pkg-2.1.0-1.20.2" = _RB13QnCb;
        "pkg-2.1.1-1.20.1" = _Vj61ZcJY;
        "pkg-3.0-1.20.1" = _EiexHXB5;
        "pkg-3.0-1.19" = _Gf2VvEVH;
        "pkg-3.0-1.19.1" = _Qavl460b;
        "pkg-3.0-1.19.2" = _porA8wZL;
        "pkg-3.0-1.19.3" = _8QM80v5J;
        "pkg-3.0-1.19.4" = _IxCDnfFq;
        "pkg-3.0-1.20.2" = _J9KvRczB;
        "pkg-3.0-1.20.3" = _hSKtYBAr;
        "pkg-4.0-1.20.1" = _z6pXOBrw;
        "pkg-4.1-1.20.1" = _BZx4oyCe;
        "pkg-4.2-1.20.1" = _qqbRCzi6;
        "pkg-4.3-1.20.1" = _EDeLWZ7i;
        "pkg-4.3.1-1.20.1" = _5rfFkfte;
        "pkg-4.3.2-1.20.1" = _tdkWabB6;
        "pkg-4.33-1.20.1" = _jytaecN6;
        "pkg-5.0-1.21.1" = _Uzcx0VSN;
        "pkg-5.1-1.21.1" = _VAsYqtcg;
        "pkg-4.3.4-1.20.1" = _wTV6UAKj;
        "default" = _wTV6UAKj;
    });
