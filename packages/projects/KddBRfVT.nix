...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.1.7" = _zvJOKfhc;
        "pkg-1.19.2-1.1.9" = _J90tzWoj;
        "pkg-1.20.1-1.0.0" = _5k0szbhh;
        "pkg-1.20.1-1.0.1" = _KvLfRjDp;
        "pkg-1.20.1-1.0.11" = _x8AXw5RW;
        "pkg-1.20.1-1.0.12" = _NLnCw7ko;
        "pkg-1.20.1-1.0.13" = _FTDV2tXy;
        "pkg-1.20.1-1.0.14" = _6ddHFvYr;
        "pkg-1.20.1-1.0.15" = _rSSOaQvD;
        "pkg-1.20.1-1.0.16" = _yp2xlD7w;
        "pkg-1.20.1-1.0.17" = _JeiqFO4y;
        "pkg-1.20.1-1.0.18" = _Ti2QZMcq;
        "pkg-1.20.1-1.0.19" = _FM6FMn3b;
        "pkg-1.20.1-1.0.20" = _XCZc3XQC;
        "pkg-1.20.1-1.0.21" = _Bt2ImgTV;
        "pkg-1.20.1-1.0.22" = _8YLkb6oa;
        "pkg-1.20.1-1.0.23" = _rfVwnr42;
        "pkg-1.20.1-1.0.24" = _CGau8QGk;
        "pkg-1.20.1-1.0.25" = _i7EdQpZC;
        "pkg-1.20.1-1.0.26" = _Y57VwgK7;
        "pkg-1.20.1-1.0.27" = _dD889WZO;
        "pkg-1.20.1-1.0.28" = _nuoiyOMa;
        "pkg-1.20.1-1.0.29" = _p8jdj36R;
        "pkg-1.20.1-1.0.30" = _EFEptkdr;
        "pkg-1.20.1-1.0.31" = _w9lNEiJv;
        "pkg-1.20.1-1.0.32" = _XkMxgGJy;
        "pkg-1.20.1-1.0.33" = _KwiWfifw;
        "pkg-1.20.1-1.0.34" = _KDzGEHUB;
        "pkg-1.20.1-1.0.35" = _DmDy5wI4;
        "pkg-1.20.1-1.0.36" = _jSmy3p1J;
        "pkg-1.20.1-1.0.37" = _WfY97Bzi;
        "pkg-1.20.1-1.0.38" = _nM3jJeg3;
        "pkg-1.20.1-1.0.40" = _h9Ke1XCL;
        "pkg-1.20.1-1.0.41" = _ccoglp3m;
        "pkg-1.0.42" = _JesmTam8;
        "pkg-1.0.43" = _AY4m6Awd;
        "default" = _AY4m6Awd;
    });
