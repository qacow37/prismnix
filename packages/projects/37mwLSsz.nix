...
let
    ...
    in {
        ...
        "pkg-OUTDATED" = _v03jhOOE;
        "pkg-1.18.2" = _kff81s5M;
        "pkg-1.19" = _mWf5VhYJ;
        "pkg-1.19.2" = _UHfyDcFE;
        "pkg-1.19.3" = _8AoZYhwp;
        "pkg-1.19.4" = _RvDHeqNv;
        "pkg-1.20" = _J0giusy3;
        "pkg-1.20.1" = _ApkQzpNo;
        "pkg-1.20.2" = _MH2ToF2d;
        "pkg-1.20.3" = _Bz5O3WBo;
        "pkg-1.20.4" = _GMS60JaZ;
        "pkg-1.20.5" = _AKqcqqik;
        "pkg-1.20.6" = _LzGm5GvJ;
        "pkg-1.21" = _KzZVJ8VD;
        "pkg-1.21.1" = _C3jhO6w6;
        "pkg-1.21.2" = _o5EoxRdo;
        "pkg-1.21.3" = _6RALMjvp;
        "pkg-1.21.4" = _zUn1D3y1;
        "pkg-1.21.5" = _h0wR2dgD;
        "pkg-1.21.6" = _wP924Sa2;
        "pkg-1.21.7" = _1Itqt7Fn;
        "pkg-1.21.8" = _V1CrQrHL;
        "pkg-1.21.9" = _cGl6XfLZ;
        "pkg-1.21.10" = _tHlnnhu5;
        "pkg-1.21.11" = _vVGuicSL;
        "pkg-26.1.X" = _DNcugqgk;
        "default" = _DNcugqgk;
    });
