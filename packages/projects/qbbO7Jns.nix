...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.18.2" = _g010jnKd;
        "pkg-0.1.0+1.19" = _YvsiPoNW;
        "pkg-0.2.0+1.18.2" = _sMYv0WU4;
        "pkg-0.2.0+1.19" = _rEZyE6x3;
        "pkg-0.3.0+1.18.2" = _hME9LTtZ;
        "pkg-0.3.0+1.19" = _iiGhUAPe;
        "pkg-0.3.1+1.18.2" = _UoqcWBE6;
        "pkg-0.3.1+1.19" = _dsAxQzyr;
        "pkg-0.3.1a+1.18.2" = _R27L5Wrs;
        "pkg-0.4.0+1.18.2" = _dDsA0q1m;
        "pkg-0.4.0+1.19" = _AnKDZCEA;
        "pkg-0.5.0+1.18.2" = _nkW4UzlO;
        "pkg-0.5.0+1.19" = _OeVpkByV;
        "pkg-0.5.0+1.19.3" = _byhOHBwi;
        "pkg-0.5.1+1.18.2" = _pFHgMv8g;
        "pkg-0.5.1+1.19" = _FzY7HsGk;
        "pkg-0.5.1+1.19.3" = _WLrmskq7;
        "pkg-0.6.0+1.18.2" = _TM0YFork;
        "pkg-0.6.0+1.19" = _h5EhjjmQ;
        "pkg-0.6.0+1.19.3" = _nH2jMxUZ;
        "pkg-0.6.1+1.18.2" = _finLaORs;
        "pkg-0.6.1+1.19" = _8VxvWtcW;
        "pkg-0.6.1+1.19.3" = _b7JoJE05;
        "pkg-0.6.2+1.18.2" = _p0Ugm9eu;
        "pkg-0.6.2+1.19" = _odt1Mqrz;
        "pkg-0.6.2+1.19.3" = _YZu0lWye;
        "pkg-0.6.3+1.19.4" = _48q801AN;
        "pkg-0.6.3+1.20.1" = _vWadFDyM;
        "pkg-0.6.4+1.19" = _ge7Vbplt;
        "pkg-0.6.4+1.19.3" = _9rpAPYB9;
        "pkg-0.6.4+1.19.4" = _Xn48U1HI;
        "pkg-0.6.4+1.20.1" = _Rp2bjZ9t;
        "pkg-0.6.4.1+1.20.1" = _mPCfosCw;
        "pkg-0.6.5+1.19" = _x6vIf3HD;
        "pkg-0.6.5+1.19.3" = _tR4xqoxp;
        "pkg-0.6.5+1.19.4" = _7rjmttb6;
        "pkg-0.6.5+1.20.1" = _7fjkgVEh;
        "pkg-0.6.5+1.19.2+forge" = _GUbMMJRo;
        "pkg-0.6.5+1.20.1+forge" = _91c49w5V;
        "pkg-0.6.6+1.19" = _95aOKine;
        "pkg-0.6.6+1.19.3" = _O3uMSDN0;
        "pkg-0.6.6+1.19.4" = _6rFgo1Px;
        "pkg-0.6.6+1.20.1" = _lwhMjJHL;
        "pkg-0.6.6+1.19.2+forge" = _DnmJpY7Z;
        "pkg-0.6.6+1.20.1+forge" = _QmFv0252;
        "pkg-0.6.6+fix1+1.19.2+forge" = _F12qyiT2;
        "pkg-0.6.6+fix1+1.20.1+forge" = _htztuG2C;
        "pkg-0.6.6+fix2+1.19.2+forge" = _bStOmyQ8;
        "pkg-0.6.6+fix2+1.20.1+forge" = _l8uqaFoj;
        "pkg-0.6.6+fix3+1.19.2+forge" = _Och9ldiP;
        "pkg-0.6.6+fix3+1.20.1+forge" = _ZkDaJFMU;
        "pkg-0.6.6+fix4+1.19.2+forge" = _VhcPzhEp;
        "pkg-0.7.0+1.20.1" = _rgVcX98h;
        "pkg-0.7.0+1.20.4" = _lGw5OBzC;
        "pkg-0.7.0+1.20.6" = _WEwLS89W;
        "pkg-0.7.0+1.21" = _SiifYwMV;
        "pkg-0.7.1+1.20.1" = _DjDkyJ8q;
        "pkg-0.7.1+1.20.4" = _w2zhhNM9;
        "pkg-0.7.1+1.20.6" = _hSLOQYCm;
        "pkg-0.7.1+1.21" = _algU98Av;
        "pkg-0.7.2+1.20.1+forge" = _CaeddDNT;
        "pkg-0.7.2+1.20.4+neoforge" = _cM5Y4w5p;
        "pkg-0.7.2+1.20.6+neoforge" = _hQv8eKjc;
        "pkg-0.7.2+1.21+neoforge" = _edADpZL3;
        "pkg-0.7.2+1.20.1+fabric" = _HbmuVnaK;
        "pkg-0.7.2+1.20.4+fabric" = _PGkXlPCO;
        "pkg-0.7.2+1.20.6+fabric" = _3ViUHMcP;
        "pkg-0.7.2+1.21+fabric" = _F2CyLf0d;
        "pkg-0.7.2+1.20.4-fix1+neoforge" = _xnUSxQLm;
        "pkg-0.7.2+1.20.6-fix1+neoforge" = _3tQT6WvA;
        "pkg-0.7.2+1.21-fix1+neoforge" = _uKuqNM7j;
        "pkg-0.7.3+1.20.1+forge" = _oQKduNIL;
        "pkg-0.7.3+1.20.4+neoforge" = _hqTYb4HY;
        "pkg-0.7.3+1.20.6+neoforge" = _dmmL2wuD;
        "pkg-0.7.3+1.21+neoforge" = _ovrqgbD9;
        "pkg-0.7.3+1.20.1+fabric" = _zOC2wmIR;
        "pkg-0.7.3+1.20.4+fabric" = _esUdj5tY;
        "pkg-0.7.3+1.20.6+fabric" = _SpqmpsN0;
        "pkg-0.7.3+1.21+fabric" = _9Bu884ww;
        "pkg-0.7.4+1.20.1+fabric" = _HsRd2NvY;
        "pkg-0.7.4+1.20.1+forge" = _muA4mic3;
        "pkg-0.7.4+1.20.4+fabric" = _wtRNt8ZC;
        "pkg-0.7.4+1.20.4+neoforge" = _DHqrTo1F;
        "pkg-0.7.4+1.20.6+fabric" = _kcSFVHSP;
        "pkg-0.7.4+1.20.6+neoforge" = _5D95JpKI;
        "pkg-0.7.4+1.21+fabric" = _uFpaYzzv;
        "pkg-0.7.4+1.21+neoforge" = _kLvgepuq;
        "pkg-0.7.5+1.20.1+forge" = _p00RUbwq;
        "pkg-0.7.5+1.20.1+fabric" = _PAjLmYPP;
        "pkg-0.7.5+1.20.4+neoforge" = _bHI3Vfm7;
        "pkg-0.7.5+1.20.4+fabric" = _4CIXfoWb;
        "pkg-0.7.5+1.20.6+neoforge" = _qj4ATp6y;
        "pkg-0.7.5+1.20.6+fabric" = _x9Et765t;
        "pkg-0.7.5+1.21+neoforge" = _fPzCTRcM;
        "pkg-0.7.5+1.21+fabric" = _mcbTU8wu;
        "pkg-0.7.5+1.20.1+fix1+forge" = _1UGIiguq;
        "pkg-0.7.5+1.20.1+fix1+fabric" = _qMVMQnTb;
        "pkg-0.7.5+1.20.4+fix1+neoforge" = _kNMI6iD2;
        "pkg-0.7.5+1.20.4+fix1+fabric" = _lnWn4zId;
        "pkg-0.7.6+1.20.1+forge" = _hWzv5ZZZ;
        "pkg-0.7.6+1.20.1+fabric" = _qGaKqaNB;
        "pkg-0.7.6+1.20.4+neoforge" = _eWvhF83b;
        "pkg-0.7.6+1.20.4+fabric" = _1yykSpuu;
        "pkg-0.7.6+1.20.6+neoforge" = _CfE1o2Vn;
        "pkg-0.7.6+1.20.6+fabric" = _XDURXNVV;
        "pkg-0.7.6+1.21+neoforge" = _ZCSyd1co;
        "pkg-0.7.6+1.21+fabric" = _9jI2tss1;
        "pkg-0.7.7+1.20.1+forge" = _nyZi3U9j;
        "pkg-0.7.7+1.20.1+fabric" = _HdW4m1io;
        "pkg-0.7.7+1.20.4+neoforge" = _S46mOs3B;
        "pkg-0.7.7+1.20.4+fabric" = _d8B2Imbi;
        "pkg-0.7.7+1.20.6+neoforge" = _AnTtv3mI;
        "pkg-0.7.7+1.20.6+fabric" = _HDbAl2ZK;
        "pkg-0.7.7+1.21+neoforge" = _mYIkAqxy;
        "pkg-0.7.7+1.21+fabric" = _ldRLAllw;
        "pkg-0.7.7+1.20.6-fix1+neoforge" = _e429xsgF;
        "pkg-0.7.7+1.21-fix1+neoforge" = _aoQx2NT2;
        "pkg-0.7.8+1.20.1+forge" = _Llipcl13;
        "pkg-0.7.8+1.20.1+fabric" = _hKkFj05j;
        "pkg-0.7.8+1.20.4+neoforge" = _c3AFAcGe;
        "pkg-0.7.8+1.20.4+fabric" = _okJJ9kF3;
        "pkg-0.7.8+1.20.6+neoforge" = _4uBjN3N5;
        "pkg-0.7.8+1.20.6+fabric" = _Mi3PSdmp;
        "pkg-0.7.8+1.21+neoforge" = _LNBoaKYt;
        "pkg-0.7.8+1.21+fabric" = _QEE2dt9g;
        "pkg-0.7.8+1.20.1-fix1+forge" = _jpsoDtJz;
        "pkg-0.7.9+1.20.1+forge" = _KKWmdLti;
        "pkg-0.7.9+1.20.1+fabric" = _vxly1O9p;
        "pkg-0.7.9+1.20.4+neoforge" = _sCPPV6Lu;
        "pkg-0.7.9+1.20.4+fabric" = _DM8cLFKY;
        "pkg-0.7.9+1.20.6+neoforge" = _CFbZWYUU;
        "pkg-0.7.9+1.20.6+fabric" = _w5M7L68X;
        "pkg-0.7.9+1.21+neoforge" = _QXkODMCT;
        "pkg-0.7.9+1.21+fabric" = _6uDAJNif;
        "default" = _6uDAJNif;
    });
