...
let
    ...
    in {
        ...
        "pkg-5.2" = _BMc2YkFF;
        "pkg-5.2.1" = _us0wiuc4;
        "pkg-6.0-alpha.1" = _uA0oVhJ8;
        "pkg-6.0-beta.1" = _qYg0yznC;
        "pkg-4.5" = _56EiXoCN;
        "pkg-5.3" = _VKzUi1Vo;
        "pkg-6.0" = _sqK7UI75;
        "pkg-4.5.1" = _xTRXI3fh;
        ...
        "pkg-8.1.1" = _uNsEi8tq;
        "pkg-9.0.0" = _GOt3itjX;
        "pkg-4.7.0+neoforge" = _738krp1v;
        "pkg-4.7.1+neoforge" = _hA14UZ98;
        "pkg-9.1.0" = _JXIL16Ku;
        "pkg-4.8.0" = _mdiwqAsQ;
        "pkg-10.0.0-alpha.1" = _nMYBknLh;
        "pkg-4.8.0-neoforge" = _ly9RhujV;
        "pkg-4.8.1-neoforge" = _T0vIbHHv;
        "pkg-10.0.0-alpha.2" = _2lQMbtEI;
        "pkg-10.0.0-beta.1" = _7swzNnFs;
        "pkg-10.0.0-beta.2" = _OWP0lpNb;
        "pkg-10.0.0-beta.3" = _VT9mM6sI;
        "pkg-10.0.0-beta.4" = _D8klPGGX;
        "pkg-10.0.0" = _jufOvaE3;
        "pkg-10.0.1" = _B4mgsFf1;
        "pkg-10.1.1" = _f0EHEE0b;
        "pkg-10.1.3" = _P4bm1zVr;
        "pkg-10.1.4" = _KHwM6LAc;
        "pkg-10.1.5" = _BeNHdIXt;
        "default" = _BeNHdIXt;
    });
