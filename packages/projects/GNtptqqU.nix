...
let
    ...
    in {
        ...
        "pkg-4.0.1" = _hfmr4gVc;
        "pkg-4.1" = _gkuxsXM0;
        "pkg-5.0.0+26.1-neoforge" = _AsGKw0co;
        "pkg-5.0.0+26.1-fabric" = _jFt6lY8S;
        "pkg-5.0.0+1.21.11-neoforge" = _1QBJE0hI;
        "pkg-5.0.0+1.21.11-fabric" = _cNz4Rak8;
        "pkg-5.0.0+1.21.6-neoforge" = _cXEVkwYW;
        "pkg-5.0.0+1.21.6-fabric" = _U0NAObdo;
        "pkg-5.0.1+26.1-fabric" = _fpikSPVC;
        "pkg-5.0.1+26.1-neoforge" = _6GSsnkDK;
        "pkg-5.0.1-1.21+fabric" = _JO28d98j;
        "pkg-5.0.1-1.21+neoforge" = _Vh5SHo6M;
        "default" = _Vh5SHo6M;
    });
