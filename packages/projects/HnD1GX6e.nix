...
let
    ...
    in {
        ...
        "pkg-1.1.9" = _RYQhXfHv;
        "pkg-1.2.3" = _pnPaValw;
        "pkg-1.1.10" = _yqdrYxad;
        "pkg-1.2.4" = _GUYaoKNJ;
        "pkg-1.1.11" = _mYvF7oBa;
        "pkg-1.2.5" = _44FRrCdT;
        "pkg-1.2.6" = _Mu1eTYYZ;
        "pkg-1.2.7" = _r7BQTeoV;
        "pkg-1.2.8" = _mnjifanN;
        "pkg-1.2.8B" = _ihh5HCHq;
        "pkg-1.2.9" = _cWD5iX3N;
        "pkg-1.2.10" = _BVDJTxNm;
        "pkg-1.2.11" = _b1p4eAuq;
        "pkg-1.2.12" = _wsmI7a40;
        "pkg-1.2.13" = _jleb5Ffb;
        "pkg-1.2.14" = _IPCxZf1C;
        "pkg-1.0.4" = _bDOOX3G2;
        "pkg-1.1.12" = _kT1zfG5S;
        "pkg-1.2.15" = _s4G03xGb;
        "pkg-1.0.5" = _KTwYQ74W;
        "pkg-1.1.13" = _Lz82Ibo7;
        "pkg-1.2.16" = _9v0MYDuP;
        "pkg-1.0.6" = _b4JPOAz4;
        "pkg-1.0.8" = _pSvgfOSK;
        "pkg-1.1.14" = _eOgYz8k9;
        "pkg-1.2.17" = _hwQLxHtU;
        "pkg-1.0.9" = _28K2bgcs;
        "pkg-1.1.15" = _qRKbgfKe;
        "pkg-1.2.18" = _LshU8ECs;
        "pkg-1.2.19" = _D6lRrYYy;
        "pkg-1.2.20" = _iS7OtabA;
        "pkg-1.2.21" = _skcV5gZ9;
        "pkg-1.3.0" = _cUVLPzlH;
        "pkg-1.2.22" = _heGnH7Kz;
        "pkg-1.3.1" = _Fj1eOuZR;
        "pkg-1.2.23" = _6ZJaZTUo;
        "pkg-1.3.2" = _nSwZqZ1K;
        "pkg-1.2.25" = _J5aVl2Yo;
        "pkg-1.3.4" = _vN6IaniW;
        "pkg-1.2.26" = _wkla0Yu8;
        "pkg-1.3.5" = _Xzvp4zMi;
        "pkg-1.4.0" = _zR42ptFz;
        "pkg-1.2.27" = _JtNyJjFF;
        "pkg-1.3.6" = _PAmIlu8M;
        "pkg-1.3.7" = _nbFsmQLW;
        "pkg-1.4.1" = _C2Q6RijC;
        "pkg-1.3.8" = _rxu65F9e;
        ...
        "pkg-1.3.9" = _N7HM8aUO;
        "pkg-1.4.3" = _DinjAR2c;
        "pkg-1.3.10" = _Rx3RSG71;
        "pkg-1.4.4" = _SG9Z39ay;
        "pkg-1.3.11" = _TfKptzPp;
        "pkg-1.4.5" = _nupZhYyW;
        "pkg-1.3.12" = _3rKvRaHS;
        "pkg-1.4.6" = _CMSQUHiU;
        "pkg-1.3.13" = _VVBeblCH;
        "pkg-1.4.7" = _6RxXcQx5;
        "pkg-1.5.0" = _NSYwKBFS;
        "pkg-1.3.14" = _tLeWq5Ic;
        "pkg-1.4.8" = _GcOrRMaw;
        "pkg-1.5.1" = _vqKHNk8s;
        "pkg-1.3.15" = _pKBVNUic;
        "pkg-1.4.9" = _RQ4Ma39V;
        "pkg-1.5.2" = _QN8JGOyp;
        "pkg-1.6.0" = _G60q9jFG;
        "pkg-2.0.0-beta.1" = _xM15tIAn;
        "pkg-2.0.0-beta.2" = _qAdzIDEl;
        "pkg-2.0.0-beta.3" = _phN3WfhQ;
        "pkg-2.0.0-beta.4" = _TZMMDqRa;
        "pkg-2.0.0-beta.5" = _WHk4eRDT;
        "pkg-2.0.0-beta.6" = _7YpT3kYv;
        "pkg-2.0.0-beta.7" = _8cRBFfoR;
        "pkg-2.0.0-beta.8" = _hQSagbTG;
        "pkg-2.0.0-beta.9" = _yo9fm92T;
        "pkg-2.0.0-beta.10" = _hiCUVv26;
        "pkg-2.0.0-beta.11" = _LXbUVLOk;
        "pkg-2.0.0-beta.12" = _qpFyVN9f;
        "pkg-2.0.0-beta.13" = _VslzbAWg;
        "pkg-2.0.0" = _KwnHQCe9;
        "pkg-2.1.0" = _FcaJ4xUf;
        "pkg-2.2.0" = _2uA4cLov;
        "pkg-2.3.0" = _WyrNGfm1;
        ...
        "pkg-2.4.9" = _1SI34cIb;
        "pkg-2.0.9" = _3zEryiam;
        "pkg-2.4.10" = _EVBEosL8;
        "pkg-2.0.10" = _q7QSIoJk;
        "pkg-2.4.11" = _eSYXte6X;
        "pkg-2.0.11" = _7xufEDM9;
        "pkg-2.4.12" = _FHdE89AK;
        "pkg-2.4.13" = _SLGToMfh;
        "pkg-2.0.12" = _cOUMC3Ev;
        "pkg-2.4.14" = _Pu0VarOT;
        "pkg-2.0.13" = _Axk4bfXT;
        "pkg-2.4.15" = _E9NRfmrv;
        "pkg-2.0.14" = _drnbguzp;
        "pkg-2.4.16" = _onYxiALI;
        "pkg-2.0.15" = _QvOCeKvA;
        "pkg-2.4.17" = _gIYHlyoT;
        "pkg-2.0.16" = _FsXdhUb2;
        "pkg-2.4.18" = _T3grMjgj;
        "default" = _Axk4bfXT;
    });
