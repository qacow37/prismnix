...
let
    ...
    in {
        ...
        "pkg-1.0-beta" = _KDrvkUz8;
        "pkg-1.0-beta+mod" = _1LbbQ6lx;
        "pkg-1.0-beta2" = _dLzo61n2;
        "pkg-1.0-beta2+mod" = _iYZlMzRc;
        "pkg-1.0-beta3" = _uxfCSvnW;
        "pkg-1.0-beta3+mod" = _ZqDmlZxy;
        "pkg-1.0-beta4" = _tdJtFcnT;
        "pkg-1.0-beta4+mod" = _GY03nqev;
        "pkg-1.0" = _rd4jUF8k;
        "pkg-1.0+mod" = _3HynTKjp;
        "pkg-2.0-beta" = _zOHAY4VS;
        "pkg-2.0-beta+mod" = _pbtiIeyM;
        "pkg-2.0-beta2" = _Pge6fhZX;
        "pkg-2.0-beta3" = _sKvsBRNg;
        "pkg-2.0-beta3+mod" = _DOkrP6bh;
        "pkg-2.0-beta4" = _YKFhEa4T;
        "pkg-2.0-beta4+mod" = _YCQIF4OL;
        "pkg-2.0-beta5" = _iFio7ikV;
        "pkg-2.0-beta5+mod" = _yQZIaESn;
        "pkg-2.0" = _RLKHzHpt;
        "pkg-2.0+mod" = _ob582HVG;
        "pkg-2.1" = _sJmxScTd;
        "pkg-2.1+mod" = _y8r605cJ;
        "pkg-2.2-beta" = _3ZVmqjCs;
        "pkg-2.2-beta+mod" = _Qfv9vB3Q;
        "pkg-2.2-beta2" = _2t40AEy7;
        "pkg-2.2-beta2+mod" = _ltyLAbzy;
        "pkg-2.2-beta3" = _G44otSa2;
        "pkg-2.2-beta3+mod" = _N8bpP3bf;
        "pkg-2.2-beta4" = _WHrFheX1;
        "pkg-2.2-beta4+mod" = _wxEksBqM;
        "pkg-2.2" = _6gegRmty;
        "pkg-2.2+mod" = _8f6H3jJN;
        "pkg-2.3" = _3ONU3iOS;
        "pkg-2.3+mod" = _7j9fhm8T;
        "pkg-2.4" = _5GUECB5k;
        "pkg-2.4+mod" = _uFQ8IQ3k;
        "pkg-2.5" = _YXLS2qTX;
        "pkg-2.5+mod" = _I35lhZ6N;
        "pkg-2.6" = _GMdhB2uw;
        "pkg-2.6+mod" = _8mpM31zj;
        "pkg-2.7" = _Iqk5jmXW;
        "pkg-2.7+mod" = _NW8f71EW;
        "pkg-2.8" = _qqkDUuVu;
        "pkg-2.8+mod" = _wFvlVmzh;
        "default" = _wFvlVmzh;
    });
