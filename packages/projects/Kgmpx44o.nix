...
let
    ...
    in {
        ...
        "pkg-1.0.0-MC1.21.5-alpha.1" = _dpixS9zS;
        "pkg-1.0.0-MC1.21.5-alpha.2" = _GK8L13Ua;
        "pkg-1.0.0-MC1.21.5-alpha.3" = _wdNz5SVJ;
        "pkg-1.0.0-MC1.21.4-alpha.SNAPSHOT-1" = _R55ubfuj;
        "pkg-1.0.0-MC1.21.4-alpha.SNAPSHOT-2" = _acLdBL38;
        "pkg-1.0.0-MC1.21.4-alpha.SNAPSHOT-5" = _P7onjOP1;
        "pkg-1.0.0-MC1.21.4-alpha.4" = _Q0zRmMpK;
        "pkg-1.0.0-MC1.21.4-alpha.5" = _7A99YvAv;
        "pkg-1.0.0-MC1.21.4-alpha.6" = _DHEcxj2h;
        "pkg-1.0.1-MC1.21.4-alpha.5" = _CN5V2A9E;
        "pkg-1.0.1-MC1.21.4-alpha.6" = _lM0ieul7;
        "pkg-1.0.1-MC1.21.4-alpha.7" = _Ds58EHeT;
        "pkg-1.0.1-MC1.21.4-alpha.8" = _xNSnT3dt;
        "pkg-1.0.1-MC1.21.4-alpha.10" = _2bkJtrvn;
        "pkg-1.0.1-MC1.21.4-alpha.11" = _OTJTTs9F;
        "pkg-1.0.2-MC1.21.4-alpha.SNAPSHOT-2" = _jReSriv4;
        "pkg-1.0.3-MC1.21.4-alpha.1" = _8VR2HbHc;
        "pkg-1.0.3-MC1.21.4-alpha.3" = _Rj5tyg5y;
        "pkg-1.0.3-MC1.21.4-alpha.3.SS-1" = _xiQbfHB9;
        "pkg-1.0.3-MC1.21.4-alpha.3.SS-2" = _k43oiFqO;
        "pkg-1.0.3-MC1.21.4-alpha.3.SS-3" = _vZo6urBw;
        "pkg-1.0.3-MC1.21.4-alpha.3.SS-4" = _HgqK40J9;
        "pkg-1.0.3-MC1.21.4-alpha.3.SS-5" = _gjUrxfFz;
        "pkg-1.0.3-MC1.21.4-alpha.3.SS-6" = _HSVrgWzq;
        "pkg-1.0.3-MC1.21.4-alpha.3.SS-7" = _NzBkTRJ0;
        "pkg-1.0.3-MC1.21.4-alpha.3.SS-8" = _MTjPpGhe;
        "pkg-1.0.3-MC1.21.4-alpha.3.SS-9" = _7NKw9kgm;
        "pkg-1.0.3-MC1.21.4-beta.4" = _QI9yXLqy;
        "pkg-1.0.3-MC1.21.4-beta.5" = _xepWVo7g;
        "pkg-1.0.3-MC1.21.4-beta.5-SS.1" = _fCLtHRc8;
        "pkg-1.0.3-MC1.21.4-beta.5-SS.2" = _JOJRUPZQ;
        "pkg-1.0.3-MC1.21.4-beta.5-SS.3" = _Lr4UjFOi;
        "pkg-1.0.3-MC1.21.4-beta.5-SS.4" = _Y90R6ULo;
        "pkg-1.0.3-MC1.21.4-beta.5-SS.5" = _2NaaKYBg;
        "pkg-1.0.3-MC1.21.4-beta.6-SS.1" = _BrQhGCsW;
        "pkg-1.0.3-MC1.21.4-beta.6-SS.2" = _pwLqQIAK;
        "pkg-1.0.3-MC1.21.4-beta.6-SS.3" = _eltgQ6cl;
        "pkg-1.0.3-MC1.21.4-beta.6-SS.4" = _QoiIVOld;
        "pkg-1.0.3-MC1.21.4-beta.6-SS.5" = _rKsNSQkd;
        "pkg-1.0.3-MC1.21.4-beta.6-SS.6" = _ljiUxmO5;
        "pkg-1.0.3-MC1.21.4-beta.6-SS.7" = _aMKqXDWy;
        "pkg-1.0.3-MC1.21.4-beta.6-SS.9" = _7cO26rLS;
        "pkg-1.0.3-MC1.21.4-beta.7" = _DAJNgPlJ;
        "pkg-1.0.5-MC1.21.4-beta.1" = _FpD9uolN;
        "pkg-1.0.5-MC1.21.4-alpha.2-SS.2" = _8vCWdXy9;
        "pkg-1.0.5-MC1.21.4-release.1" = _JtbJiaro;
        "pkg-1.0.5-MC1.21.4-release.2" = _FZnucK8s;
        "pkg-1.0.6-MC1.21.4-alpha.1.SS-1" = _PPkWiJBX;
        "pkg-1.0.6-MC1.21.4-alpha.1.SS-2" = _czXIqAO1;
        "pkg-1.0.6-MC1.21.4-alpha.1.SS-3" = _LC9aDVjF;
        "pkg-1.0.6-MC1.21.4-alpha.1.SS-4" = _TQFf76vZ;
        "pkg-1.0.6-MC1.21.4-alpha.1.SS-5" = _j0pV7KtB;
        "pkg-1.0.6-MC1.21.6-alpha.1.SS-2.1" = _snhcxiT2;
        "pkg-1.0.6-MC1.21.6-alpha.1.SS-2.2" = _c9vRMq72;
        "pkg-1.0.6-MC1.21.7-alpha.1.SS-1" = _gVI75CP1;
        "pkg-1.0.6-MC1.21.7-alpha.1.SS-2" = _HmeZJ5SB;
        "pkg-1.0.6-MC1.21.8-alpha.1.SS-1" = _NIGPZeTY;
        "pkg-1.0.6-MC1.21.8-alpha.1.SS-2" = _mcNTqQ7x;
        "pkg-1.0.6-MC1.21.8-alpha.1.SS-3.4" = _4GBQCByr;
        "pkg-1.0.6-MC1.21.8-1" = _YcKIME24;
        "pkg-1.0.6-MC1.21.8-alpha.2" = _uXaQrUYH;
        "pkg-1.0.7-MC1.21.8-beta.22.1" = _RQ2bbi1G;
        "pkg-1.0.7-MC1.21.8-alpha.1" = _z05lOvci;
        "pkg-1.0.7-MC1.21.8-alpha.2" = _gxpeFwUK;
        "pkg-1.0.7-MC1.21.8-alpha.3" = _z5g3rb3G;
        "pkg-1.0.7-MC1.21.8-alpha.4" = _6XIVxgpe;
        "pkg-1.0.7-MC1.21.8-alpha.5" = _Mz6zc2oR;
        "pkg-1.0.7-MC1.21.8-alpha.5-SS.1" = _pJMreeVM;
        "pkg-1.0.7-MC1.21.8-alpha.5-SS.2" = _T6W2tfJr;
        "pkg-1.0.7-MC1.21.8-alpha.6" = _PaGeNhVv;
        "pkg-1.0.7-MC1.21.8-alpha.6.SS-1" = _e9bUqAzR;
        "pkg-1.0.7-MC1.21.8-alpha.6.SS-3" = _B3p7oE8Q;
        "pkg-1.0.7-MC1.21.8-alpha.6.SS-4" = _PBJQ7Xnx;
        "pkg-1.0.7-MC1.21.8-alpha.6.SS-5" = _N7cZ3ns7;
        "pkg-1.0.7-MC1.21.8-alpha.6.SS-6" = _oYHhQM1S;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.1" = _HXgbjWzd;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.2" = _BjeMO4xI;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.3" = _u0aeORlk;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.4" = _2WjWzC02;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.5" = _obYzhRKw;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.6" = _PL4OwIye;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.8" = _DUnL8VBw;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.9" = _5Hjxn9mw;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.10" = _gY99yglX;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.11" = _7fMzwADW;
        "pkg-1.0.8-MC1.21.8-alpha.1-SS.12" = _E0mybcOm;
        "pkg-1.0.9-MC1.21.8-alpha.1" = _Jq8Ftfbc;
        "pkg-1.10.0-MC1.21.8-alpha.1" = _I2nZ8mw8;
        "pkg-1.10.1-MC1.21.8-alpha.1" = _Dwpj13Z9;
        "pkg-1.10.2-MC1.21.8-alpha.1" = _G2Lcfs6J;
        "pkg-1.10.2-MC1.21.8-alpha.2" = _8b5r13rW;
        "pkg-1.10.2-MC1.21.10-alpha.2" = _JCsMO49d;
        "pkg-1.10.3-MC1.21.10-alpha.1" = _bTh2Nz9E;
        "pkg-1.10.3-MC1.21.10-alpha.2" = _ZuKEo9iZ;
        "pkg-1.10.3-MC1.21.10-alpha.3" = _FPysoKTp;
        "pkg-1.10.3-MC1.21.10-alpha.4" = _rFtlXvV5;
        "pkg-1.10.3-MC1.21.11-alpha.8" = _o2s3Zcep;
        "default" = _o2s3Zcep;
    });
