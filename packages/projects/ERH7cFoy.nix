...
let
    ...
    in {
        ...
        "pkg-1.6" = _bvj5lBDH;
        "pkg-1.8.1" = _1Kmg8B4O;
        "pkg-mc1.20.1-2.2.0" = _AR1Mzi9M;
        "pkg-mc1.20.1-2.2.1" = _QnXd490v;
        "pkg-mc1.20.1-2.2.2" = _ud2gPZEV;
        "pkg-2.3.0+mc1.20.1" = _XM2ZIPwU;
        "pkg-2.3.0+mc1.20.2" = _pChMoeMT;
        "pkg-2.3.1+mc1.20.1" = _CGWUyUvR;
        "pkg-2.3.1+mc1.20.2" = _BalMdVPs;
        "pkg-2.3.2+mc1.20.1" = _6zxDjwBl;
        "pkg-2.3.2+mc1.20.2" = _FUEOIEd8;
        "pkg-2.4.0+mc1.20.1" = _fL5rYzR5;
        "pkg-2.4.0+mc1.20.2" = _C0ybESos;
        "pkg-2.4.1+mc1.20.1" = _qjvUU1PE;
        "pkg-2.4.1+mc1.20.2" = _ExAfDbd9;
        "pkg-2.4.1+mc1.20.4" = _VUoyw5kA;
        "pkg-2.4.2+mc1.20.1" = _Dxb74rbH;
        "pkg-2.4.2+mc1.20.2" = _RrFY1cXn;
        "pkg-2.4.2+mc1.20.4" = _dD866aNy;
        "pkg-3.0.0+mc1.20.1" = _I28LdQYe;
        "pkg-3.0.0+mc1.20.2" = _6FUWTkE3;
        "pkg-3.0.0+mc1.20.4" = _ZyCwS15W;
        "pkg-3.0.1+mc1.20.2" = _dPnw1bkw;
        "pkg-3.0.1+mc1.20.4" = _sdezMebk;
        "pkg-3.0.1+mc1.20.1" = _XIAUSkCg;
        "pkg-3.1.0+mc1.20.1" = _K0Oy8hqw;
        "pkg-3.1.0+mc1.20.2" = _x81YGImc;
        "pkg-3.1.0+mc1.20.4" = _rP4mfOrZ;
        "pkg-3.1.0.1+mc1.20.4" = _qcBhj2qI;
        "pkg-4.0.0+mc1.20.1" = _7upUIt84;
        "pkg-4.0.0+mc1.20.2" = _iOcV6yET;
        "pkg-4.0.0+mc1.20.4" = _tiUpiCAf;
        "pkg-4.0.1+mc1.20.1" = _CVYBhY6J;
        "pkg-4.0.1+mc1.20.2" = _QngIDLwP;
        "pkg-4.0.1+mc1.20.4" = _A2AAH7Aq;
        "pkg-4.0.2+mc1.20.1" = _zJAuidYK;
        "pkg-4.0.2+mc1.20.4" = _KqpOSqHC;
        "pkg-4.1.0" = _eBTC7XZQ;
        "pkg-4.1.1" = _gqEBYiBJ;
        "pkg-4.1.2" = _74Z2wptR;
        "pkg-4.1.3" = _KkROoKjO;
