...
let
    ...
    in {
        ...
        "pkg-1.5.1" = _PWRyGsLC;
        "pkg-1.5.2" = _cioOUB8N;
        "pkg-1.5.3+1.18.2" = _BhQBvL82;
        "pkg-1.5.3+1.19.2" = _Kb40X9Xz;
        "pkg-1.5.3+1.19.3" = _HiQIjziJ;
        "pkg-1.5.4+1.18.2" = _bA5bLV3c;
        "pkg-1.5.4+1.19.2" = _KUSFTKSq;
        "pkg-1.5.4+1.19.3" = _oXvCLSpY;
        "pkg-1.5.5+1.19.2" = _VB4nuXhA;
        "pkg-1.5.5+1.19.3" = _TDGILWIf;
        "pkg-1.5.5+1.19.4" = _Uw1vYocE;
        "pkg-1.5.6+1.19.2" = _dcnETi7o;
        "pkg-1.5.6+1.19.3" = _6MS2uDat;
        "pkg-1.5.7+1.19.2" = _IhxkJbc2;
        "pkg-1.5.7+1.19.3" = _wLBxyT2a;
        "pkg-1.5.7+1.19.4" = _BvZSi6xV;
        "pkg-1.5.7+1.20" = _lFKmtdMw;
        "pkg-1.5.8+1.19.2" = _Lpzeqtz8;
        "pkg-1.5.8+1.19.3" = _esY5Y9BI;
        "pkg-1.5.8+1.19.4" = _j1slz0RZ;
        "pkg-1.5.8+1.20.1" = _vMtWVHDJ;
        "pkg-1.5.9+1.19.2" = _3M85RLxY;
        "pkg-1.5.9+1.19.3" = _GabWmNwk;
        "pkg-1.5.9+1.19.4" = _5WpdTvxp;
        "pkg-1.5.9+1.20.1" = _Oyc76oFa;
        "pkg-1.5.9+1.20.2" = _esJ7h38a;
        "pkg-1.5.10+1.19.2" = _BM3CadZ1;
        "pkg-1.5.10+1.19.3" = _nqZQFVIg;
        "pkg-1.5.10+1.19.4" = _NuhDuYcU;
        "pkg-1.5.10+1.20.1" = _EbPl4WIQ;
        "pkg-1.5.10+1.20.2" = _fzDEYGk2;
        "pkg-1.5.10+1.20.3" = _SSvudGpI;
        "pkg-1.5.11+1.19.2" = _GbSa8NQh;
        "pkg-1.5.11+1.19.3" = _lQs8ue3C;
        "pkg-1.5.11+1.19.4" = _11LaEyWh;
        "pkg-1.5.11+1.20.1" = _DpodeUOd;
        "pkg-1.5.11+1.20.2" = _Psp4wfZn;
        "pkg-1.5.11+1.20.4" = _c7LFNVce;
        "pkg-1.5.11+1.20.6" = _eM5Rcsij;
        "pkg-1.6+1.19.2" = _d5dTLGWx;
        "pkg-1.6+1.19.3" = _BX7qJNLd;
        "pkg-1.6+1.19.4" = _evdgG9di;
        "pkg-1.6+1.20.1" = _ctumzXqF;
        "pkg-1.6+1.20.2" = _fCGXbqqU;
        "pkg-1.6+1.20.4" = _daLVsHc8;
        "pkg-1.6+1.20.6" = _FeXDkhCI;
        "pkg-1.6.1+1.19.2" = _AmPdNCPb;
        "pkg-1.6.1+1.19.3" = _7NmsHj9N;
        "pkg-1.6.1+1.19.4" = _1tLEbOZk;
        "pkg-1.6.1+1.20.1" = _kO9nUBoX;
        "pkg-1.6.1+1.20.2" = _9nyl77ml;
        "pkg-1.6.1+1.20.4" = _x824YAov;
        "pkg-1.6.1+1.20.6" = _v4nL1BsT;
        "pkg-1.6.1+1.21" = _fpDBBXvT;
        "pkg-1.7+1.20.1" = _Fo9DWwOd;
        "pkg-1.7+1.20.2" = _8fdU3vlv;
        "pkg-1.7+1.20.4" = _ocsMCL1o;
        "pkg-1.7+1.20.6" = _DI0MuX9s;
        "pkg-1.7+1.21.1" = _fgFt8epw;
        "pkg-1.7+1.21.3" = _3ZtnREDP;
        "pkg-1.7.1+1.20.1" = _bM6eLTIW;
        "pkg-1.7.1+1.20.2" = _GsFrcd1w;
        "pkg-1.7.1+1.20.4" = _34j5ltQ7;
        "pkg-1.7.1+1.20.6" = _zhmGC3pu;
        "pkg-1.7.1+1.21.1" = _ib1MuM1V;
        "pkg-1.7.1+1.21.3" = _kL6FHNUI;
        "pkg-1.7.2+1.20.1" = _1KBQXsxy;
        "pkg-1.7.2+1.20.2" = _ESWM5Zlr;
        "pkg-1.7.2+1.20.4" = _ERpxhwlr;
        "pkg-1.7.2+1.20.6" = _w8M4hNx8;
        "pkg-1.7.2+1.21.1" = _SCjXujuF;
        "pkg-1.7.2+1.21.3" = _IwVJyyyk;
        "pkg-1.7.2+1.21.4" = _G4UHbATy;
        "pkg-1.7.3+1.20.1" = _FPUn6G4h;
        "pkg-1.7.3+1.20.2" = _hHXy24RF;
        "pkg-1.7.3+1.20.4" = _R1Ir3vy9;
        "pkg-1.7.3+1.20.6" = _BCrtDeSX;
        "pkg-1.7.3+1.21.1" = _ow8QLah9;
        "pkg-1.7.3+1.21.3" = _PPGTpJ2C;
        "pkg-1.7.3+1.21.4" = _xP2jnnuU;
        "pkg-1.7.3+1.21.5" = _BMmbiHSJ;
        "pkg-1.7.4+1.20.1" = _7g8j3tHH;
        "pkg-1.7.4+1.20.2" = _efIIdc0H;
        "pkg-1.7.4+1.20.4" = _tkqfgWVo;
        "pkg-1.7.4+1.20.6" = _gHagbfXK;
        "pkg-1.7.4+1.21.1" = _fJxd1a9i;
        "pkg-1.7.4+1.21.3" = _9LDX4X67;
        "pkg-1.7.4+1.21.4" = _Y5DoDIMK;
        "pkg-1.7.4+1.21.5" = _sxZlDhki;
        "pkg-1.7.4+1.21.6" = _W8KDnevt;
        "pkg-1.7.5+1.20.1" = _UmzbPud1;
        "pkg-1.7.5+1.20.2" = _ZhSLIFLu;
        "pkg-1.7.5+1.20.4" = _kylH7OlH;
        "pkg-1.7.5+1.20.6" = _1dJu1tz6;
        "pkg-1.7.5+1.21.1" = _jCM93jJ5;
        "pkg-1.7.5+1.21.3" = _duyRIO0E;
        "pkg-1.7.5+1.21.4" = _SIYiLZdk;
        "pkg-1.7.5+1.21.5" = _57R8d09d;
        "pkg-1.7.5+1.21.8" = _aLXF2Nb4;
        "pkg-1.7.5+1.21.10" = _A4AkBYE3;
        "pkg-1.7.5+1.21.11" = _rDLJu2uE;
        "pkg-1.7.6+1.21.1" = _lLMGPiZe;
        "pkg-1.7.6+1.21.3" = _YD5x4AJP;
        "pkg-1.7.6+1.21.4" = _vxcPpG8h;
        "pkg-1.7.6+1.21.5" = _kyqQHNLB;
        "pkg-1.7.6+1.21.8" = _tmnjNpE6;
        "pkg-1.7.6+1.21.10" = _KeQdftoX;
        "pkg-1.7.6+1.21.11" = _YhcaQg5e;
        "pkg-1.7.6+26.1" = _pBt7L8Nq;
