...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.20.1" = _be3VtyLK;
        "pkg-1.0.1-1.20.1" = _chImZgXX;
        "pkg-1.0.2-1.20.1-for-0.5.1j" = _dTZ63qc9;
        "pkg-1.0.2-1.20.1" = _Vj26UuTg;
        "pkg-1.0.3-1.20.1" = _memFAlha;
        "pkg-1.1.0-1.20.1-for-0.5.1j" = _1vtFMbpN;
        "pkg-1.1.0-1.20.1" = _OJhW3xYw;
        "pkg-1.1.0-1.21.1" = _K3pcX9sN;
        "pkg-1.1.1-1.20.1" = _hFXmN4Y7;
        "pkg-1.1.1-1.21.1" = _XRvbe9om;
        "pkg-1.1.2-1.20.1" = _gRPorOnV;
        "pkg-1.1.2-1.21.1" = _OJhASMC7;
        "pkg-1.1.3-1.20.1" = _k0bqPsG1;
        "pkg-1.1.3-1.21.1" = _QnUaJfQs;
        "pkg-1.2.0-1.20.1" = _PHcfUksL;
        "pkg-1.2.0-1.21.1" = _RvV26HlU;
        "pkg-1.2.1-1.20.1" = _nr2hkiNf;
        "pkg-1.2.1-1.21.1" = _ULVdMrvO;
        "pkg-1.3.0-1.20.1" = _65yH5q9b;
        "pkg-1.3.0-1.21.1" = _kHTfojdY;
        "pkg-2.0.0-1.20.1" = _xQaVq4qA;
        "pkg-2.0.0-1.21.1" = _Ievwcun7;
        "pkg-2.0.0.0-1.20.1-fabric" = _Hm3a97ju;
        "pkg-2.0.1-1.21.1" = _BM3Pr9Mj;
        "pkg-2.0.0.1-1.20.1-fabric" = _5dAyd4ux;
        "pkg-2.0.2" = _g0PyoRas;
        "default" = _g0PyoRas;
    });
