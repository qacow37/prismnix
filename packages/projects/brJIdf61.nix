...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.6" = _LImOwnM2;
        "pkg-1.0.0+1.21.3" = _IY3o3gQJ;
        "pkg-1.0.0+1.21.1" = _7sfYer0X;
        "pkg-1.1.0+1.21.3" = _BXuVWF2f;
        "pkg-1.1.0+1.20.1" = _IvXhQmS6;
        "pkg-1.1.0+1.21.1" = _hVF9UqVn;
        "pkg-1.1.0+1.20.6" = _wUhoHF57;
        "pkg-1.1.0+1.20.4" = _iB0q2ZPu;
        "pkg-1.1.1+1.21.6" = _3wIhvEIa;
        "pkg-2.0.0+1.20.1" = _rQJuIjNK;
        "pkg-2.0.0+1.20.4" = _P1YiAYb6;
        "pkg-2.0.0+1.20.6" = _1pTXxijd;
        "pkg-2.0.0+1.21.1" = _O3X30PVd;
        "pkg-2.0.0+1.21.3" = _tpuMV1u2;
        "pkg-2.0.0+1.21.6" = _1BZR4iXB;
        "pkg-2.0.0+1.21.9" = _svkPwn6G;
        "pkg-2.0.1+1.20.1" = _ys8psuAf;
        "pkg-2.1.0+1.20.1-forge" = _ncsyGE9W;
        "pkg-2.1.0+1.20.1-fabric" = _IpyEgclm;
        "pkg-2.1.0+1.20.4-fabric" = _gV3KOg2I;
        "pkg-2.1.0+1.20.6-fabric" = _gzb8nwhj;
        "pkg-2.1.0+1.21.1-neoforge" = _7EY26yMl;
        "pkg-2.1.0+1.21.1-fabric" = _Liv7FRmx;
        "pkg-2.1.0+1.21.3-fabric" = _NO3ut3rl;
        "pkg-2.1.0+1.21.6-fabric" = _6LIEEjUY;
        "pkg-2.1.0+1.21.9-fabric" = _N8jLwVRQ;
        "pkg-2.1.1+1.21.9-fabric" = _s8Z4H9CU;
        "pkg-2.1.2+26.1-fabric" = _WRCL2N3V;
        "pkg-2.1.2+26.1-neoforge" = _LrFxQrFY;
        "pkg-2.2.0+1.20.1-forge" = _j70TCr23;
        "pkg-2.2.0+1.20.1-fabric" = _H3jJ2jiz;
        "pkg-2.2.0+1.20.4-fabric" = _buBDJwmM;
        "pkg-2.2.0+1.20.6-fabric" = _mBrF2goW;
        "pkg-2.2.0+1.21.1-neoforge" = _aj6LmJwR;
        "pkg-2.2.0+1.21.1-fabric" = _aY9MPT5Z;
        "pkg-2.2.0+1.21.3-fabric" = _iuuLXQqD;
        "pkg-2.2.0+1.21.6-fabric" = _11VJ6n8e;
        "pkg-2.2.0+1.21.9-fabric" = _GjcX412B;
