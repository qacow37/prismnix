...
let
    ...
    in {
        ...
        "pkg-1.12.2-V1.0" = _HhOud2pR;
        "pkg-1.12.2-V1.1" = _NiskWIUf;
        "pkg-1.12.2-V1.11" = _jHill4jX;
        "pkg-1.16.5-V1.0" = _s6SMgyGU;
        "pkg-1.15.2-V1.0" = _QqywBDjO;
        "pkg-1.12.2-V1.2" = _MM5MLDPZ;
        "pkg-1.15.2-V1.01" = _nuuSLKl1;
        "pkg-1.16.5-V1.01" = _yjh0QE7h;
        "pkg-1.18.2-V1.0" = _LCf2rYKb;
        "pkg-1.18.2-V1.01" = _MNmbM8zv;
        "pkg-1.19.2-V1.0" = _rWTl2i1d;
        "pkg-1.12.2-V1.21" = _rVybk0SO;
        "pkg-1.16.5-V1.03" = _BZ8UZNl2;
        "pkg-1.20.1-V1.0" = _8K2jyVqN;
        "pkg-1.21.1-V1.0" = _zncNG3DV;
        "pkg-1.19.4-V1.0" = _VFXcs2yu;
        "pkg-1.17.1-V1.0" = _ntzlQsUC;
        "pkg-1.12.2-V1.23" = _4ANTgKaq;
        "pkg-1.20.1-V1.01" = _ZQz1ba1C;
        "pkg-1.21.1-V1.01" = _1nNNaLrd;
        "pkg-1.15.2-V1.03" = _nzRxwTBf;
        "pkg-1.15.2-V1.04" = _A79t1Dg8;
        "pkg-1.16.5-V1.04" = _QqFUVl8d;
        "pkg-1.17.1-V1.01" = _pK0UA8Zr;
        "pkg-1.18.2-V1.02" = _vWmMzcrw;
        "pkg-1.19.2-V1.01" = _Y7SngnKX;
        "pkg-1.19.4-V1.01" = _CCP7gdkR;
        "pkg-1.12.2-V1.3" = _YQrcn8jc;
        "pkg-1.15.2-V1.1" = _33W63sZa;
        "pkg-1.16.5-V1.1" = _j4EDJzP0;
        "pkg-1.21.4-V1.0" = _3jpXLud2;
        "pkg-1.21-V1.0" = _7bIB8Ffe;
        "pkg-1.21.2-V1.0" = _SqsVgh1o;
        "pkg-1.21.3-V1.0" = _Vlp4Ht2P;
        "pkg-1.21-V1.1" = _NRdf9dNu;
        "pkg-1.21.1-V1.1" = _4pNnMLtr;
        "pkg-1.21.5-V1.0" = _XROgv86x;
        "pkg-1.21.5-V1.01" = _X4WyFTNW;
        "pkg-1.21.8-V1.0" = _ou3OyFH6;
        "pkg-1.21.x-V1.01" = _zbVskVhd;
        "pkg-1.12.2-V1.31" = _pgxXYztF;
        "pkg-1.16.5-V1.11" = _zq1DBUgn;
        "pkg-1.20.1-V1.02" = _wm3kLzzp;
        "pkg-1.21.1-V1.02NeoForge" = _aNb3uGQ8;
        "pkg-1.12.2-V2.0" = _XjT26uy0;
        "pkg-1.16.5-V2.0" = _cwuoePBR;
        "default" = _cwuoePBR;
    });
