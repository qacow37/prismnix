...
let
    ...
    in {
        ...
        "pkg-1.0" = _qsthMd4i;
        "pkg-1.0+mod" = _VNLz1FZA;
        "pkg-1.2" = _stFp8E8C;
        "pkg-1.2+mod" = _iS7f5jYf;
        "pkg-1.3" = _FK49Q49K;
        "pkg-1.3+mod" = _JGsyxycS;
        "pkg-2.0" = _XUmiNIjZ;
        "pkg-2.0+mod" = _lcGFimVR;
        "pkg-3.0" = _2aIh7K9W;
        "pkg-3.0+mod" = _AesgDPJF;
        "pkg-3.1" = _JQBDIFhs;
        "pkg-4.0" = _6dDfnVpS;
        "pkg-4.0+mod" = _tIgCTBLd;
        "pkg-4.1" = _b78ZrEn6;
        "pkg-4.1+mod" = _oJff6ksn;
        "pkg-4.2" = _zHZhpTH2;
        "pkg-4.2+mod" = _LaIKu9bw;
        "pkg-4.3" = _ITGQm4Gs;
        "pkg-4.3+mod" = _MDtlyYcW;
        "pkg-4.4" = _D9gQibSE;
        "pkg-4.4+mod" = _52ylDUT9;
        "pkg-4.5" = _4w5R8Ft1;
        "pkg-4.5+mod" = _hHpP7Q1F;
        "pkg-4.6" = _Jvufy9QZ;
        "pkg-4.6+mod" = _cJW0i5oS;
        "pkg-4.7" = _gmyu3UrF;
        "pkg-4.7-fabric" = _LjoysSlu;
        "pkg-4.7-forge" = _rapI2HTI;
        "pkg-4.11" = _y5eUQEln;
        "pkg-4.11-fabric" = _RvaFXaZF;
        "pkg-4.11-quilt" = _hC8h7f79;
        "pkg-4.11-forge" = _sinaQ1dy;
        "pkg-4.11-neoforge" = _V9pkLA1w;
        "pkg-4.12" = _pRGUuQna;
        "pkg-4.12-fabric" = _57AqJf8d;
        "pkg-4.12-quilt" = _YdaTa7XF;
        "pkg-4.12-forge" = _eqh6iLOj;
        "pkg-4.12-neoforge" = _ABweuwve;
        "default" = _ABweuwve;
    });
