...
let
    ...
    in {
        ...
        "pkg-1.3.2" = _lI6xW5Zm;
        "pkg-1.4.0" = _zNrgvnYJ;
        "pkg-1.5.0-1.21.5" = _DpgK9950;
        "pkg-1.5.0-1.21.8" = _fxTZS8xp;
        "pkg-1.6.0-1.21.5" = _RWeuq1fy;
        "pkg-1.6.0-1.21.8" = _H1M6OghW;
        "pkg-1.6.1-1.21.5" = _ZD5J7cqJ;
        "pkg-1.6.1-1.21.8" = _BehP9MGe;
        "pkg-1.7.0-1.21.5" = _Q3ncDQbB;
        "pkg-1.7.0-1.21.8" = _xun1zJUn;
        "pkg-1.8.0-1.21.5" = _PZTb1c9i;
        "pkg-1.8.0-1.21.8" = _sOYV0mn3;
        "pkg-1.8.1-1.21.5" = _jVeDk4JX;
        "pkg-1.8.1-1.21.8" = _CNRB4oa2;
        "pkg-1.9.0-1.21.5" = _jkXUljZr;
        "pkg-1.9.0-1.21.8" = _8ZcaSwOv;
        "pkg-1.9.0-1.21.10" = _aWnxEtda;
        "pkg-1.10.0-1.21.5" = _ljO8gsue;
        "pkg-1.10.0-1.21.8" = _dtygGVaI;
        "pkg-1.10.0-1.21.10" = _1811lAy1;
        "pkg-1.10.1-1.21.5" = _lirllnwC;
        "pkg-1.10.1-1.21.8" = _wl1sBF3I;
        "pkg-1.10.1-1.21.10" = _T9WczISg;
        "pkg-1.11.0-1.21.5" = _EnNVdNXt;
        "pkg-1.11.0-1.21.8" = _gehOXa0Y;
        "pkg-1.11.0-1.21.10" = _mZcbByRX;
        "pkg-1.11.1-1.21.5" = _JSLZ0R5t;
        "pkg-1.11.1-1.21.8" = _8Kvo9JHt;
        "pkg-1.11.1-1.21.10" = _saT3dFYh;
        "pkg-1.12.0-1.21.1" = _A9OAKK2w;
        "pkg-1.12.0-1.21.5" = _CIzfGPrH;
        "pkg-1.12.0-1.21.8" = _S0whFZLZ;
        "pkg-1.12.0-1.21.10" = _ow3sbEq5;
        "pkg-1.13.0-1.21.10" = _qnFyQxBh;
        "pkg-1.13.0-1.21.11" = _bMSzFGuq;
        "pkg-1.13.1-1.21.10" = _r0nUHcqN;
        "pkg-1.13.1-1.21.11" = _QHdpzVoS;
        "pkg-1.13.2-1.21.10" = _6P89nYHP;
        "pkg-1.13.2-1.21.11" = _hNyod8sY;
        "pkg-1.14.0" = _EQtEQt2p;
        "pkg-1.14.1" = _FsrzmHFu;
        "pkg-1.15.0" = _86USmngW;
        "pkg-1.15.1" = _yxGEcVtl;
        "pkg-1.15.2" = _XzrGVdVA;
        "pkg-1.16.0" = _ZgBjhPFZ;
        "pkg-1.16.1" = _ntms0IvC;
