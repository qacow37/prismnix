...
let
    ...
    in {
        ...
        "pkg-0.9.1" = _RYBsksw8;
        "pkg-0.9.6" = _i2R7mqWf;
        "pkg-0.9.11+1.18.2" = _9CU14w0Q;
        "pkg-0.9.12" = _kXCetPio;
        "pkg-0.9.13" = _qeI5geKj;
        "pkg-0.9.14" = _SJDzcovB;
        "pkg-0.9.15" = _R8HgPhn0;
        "pkg-0.9.16" = _TS06yQBQ;
        "pkg-0.9.17" = _t6ZT8Gbh;
        "pkg-0.10.0" = _ndGngOws;
        "default" = _ndGngOws;
    });
