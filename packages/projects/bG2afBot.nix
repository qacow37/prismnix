...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _BaxJH9vM;
        "pkg-1.18.2-2.0-fabric" = _JiD08fVz;
        "pkg-1.19.2-2.1-fabric" = _xyLCUJhr;
        "pkg-1.16.5-1.6-forge" = _lClUFgCI;
        "pkg-1.18.2-1.7-forge" = _wAhebNx7;
        "pkg-1.19.2-1.9-forge" = _jp6a1VL8;
        "pkg-1.16.5-2.2-fabric" = _xTb8rjDX;
        "pkg-1.18.2-2.2-fabric" = _fQ61Yja2;
        "pkg-1.19.2-2.2-fabric" = _KTdClEcu;
        "pkg-1.19.3-2.3-fabric" = _nNPEWspe;
        "pkg-1.19.3-1.9-forge" = _5UZwSEKD;
        "pkg-1.18.2-3.0-forge+fabric" = _VtyUs7UT;
        "pkg-1.19.2-3.0-forge+fabric" = _E0rppUrf;
        "pkg-1.19.3-3.0-forge+fabric" = _inizTtsq;
        "pkg-1.18.2-3.1-forge+fabric" = _Hd3F9cY8;
        "pkg-1.19.2-3.1-forge+fabric" = _rgUsMGB9;
        "pkg-1.19.3-3.1-forge+fabric" = _DYwbsm5x;
        "pkg-1.19.4-3.1-forge+fabric" = _aKAJES1i;
        "pkg-1.20-3.1-forge+fabric" = _h6aKg5yf;
        "pkg-1.20.1-3.1-forge+fabric" = _c4XKG3Vq;
        "pkg-1.20.2-3.1-forge+fabric" = _k1RCpY2T;
        "pkg-1.18.2-3.2-forge+fabric" = _nkUIm15c;
        "pkg-1.19.2-3.2-forge+fabric" = _MSUkknpl;
        "pkg-1.20.1-3.2-forge+fabric" = _5FJ85Nhq;
        "pkg-1.20.2-3.2-forge+fabric" = _Ax5muOcA;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _PENNO9Cm;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _VLNMWDNi;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _vWzC8pwH;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _ihoJf8sT;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _TfCHpLEP;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _50eA8lyk;
        "pkg-1.20.5-3.3-fabric+neo" = _PCWKqlkz;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _J8wgnqoe;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _mXQRGV4a;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _hx8bK2dT;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _gPP5yHto;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _1vq2gFrc;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _Y3pLVrY3;
        "pkg-1.21.2-3.4-fabric+neo" = _YrtFardC;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _Vq75a3JM;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _wAJzZ2iU;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _vo5jKfe7;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _kIrXgpPK;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _8T8aMvtT;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _YJNa5v2I;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _sa4kwE2k;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _UHCZsr0s;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _3KjCJcXb;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _aALa49Oi;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _p4Cy5pRL;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _HgHYfYi4;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _Oth91qD5;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _XlFZWXTd;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _YsIN5piX;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _2EMPtBer;
        "default" = _2EMPtBer;
    });
