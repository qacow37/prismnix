...
let
    ...
    in {
        ...
        "pkg-0.0.1+1.19.2" = _woA2XOYe;
        "pkg-0.0.1+1.19.3" = _f51sVkdj;
        "pkg-0.0.1+1.18.2" = _n3dzqMr3;
        "pkg-1.0+1.19.3" = _ARdFoZEY;
        "pkg-1.1+1.19.3" = _TgM4GbQ0;
        "pkg-1.1+1.19.2" = _IomUUqz2;
        "pkg-2.0+1.19.3" = _o8adU8bG;
        "pkg-3.0+1.20" = _eYTWQPE5;
        "pkg-3.0.1+1.20" = _nYlsZErV;
        "pkg-3.1+1.20" = _PpzoVMBW;
        "pkg-4.0+1.20" = _cfHTjGFh;
        "pkg-3.2+1.20" = _gvl8gXJY;
        "pkg-4.1+1.20-fabric" = _r90usO4s;
        "pkg-4.1+1.20-forge" = _m6BvZIrS;
        "pkg-4.2+1.20.2-fabric" = _UlCdDizf;
        "pkg-4.2+1.20.2-forge" = _7QoYWq21;
        "pkg-4.2+1.20.2-neoforge" = _Zm3E5Ylg;
        "pkg-4.3+1.20.5-fabric" = _gr3VnS7K;
        "pkg-4.3+1.21-fabric" = _pASKeeUv;
        "pkg-4.3+1.21-neoforge" = _8GwBAmHw;
        "pkg-4.3.1+1.21-neoforge" = _1RbvxWqH;
        "pkg-4.3.2+1.21.2-neoforge" = _6DPxrxuP;
        "pkg-4.3.2+1.21.2-fabric" = _LgzY2IzR;
        "pkg-5.0+1.21.3-neoforge" = _U4JDVkqv;
        "pkg-5.0+1.21.1-neoforge" = _R00pxIXg;
        "pkg-5.0+1.20.6-neoforge" = _vBccWwpz;
        "pkg-5.0+1.20.4-neoforge" = _XYFB3Yjz;
        "pkg-5.0+1.21.1-fabric" = _VpALQ0hS;
        "pkg-5.0+1.20.6-fabric" = _9UqbnKNx;
        "pkg-5.0+1.20.1-fabric" = _90sczwZx;
        "pkg-5.0+1.21.3-fabric" = _tinxsA4q;
        "pkg-5.0+1.20.4-fabric" = _UcgA1b4c;
        "pkg-5.0+1.20.1-forge" = _gGt339n7;
        "default" = _gGt339n7;
    });
