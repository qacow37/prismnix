...
let
    ...
    in {
        ...
        "pkg-1.19.3-1.3.1" = _NzOw0ASw;
        "pkg-1.19.3-1.3.2" = _OZqC3Fyd;
        "pkg-1.19.3-1.4.0" = _4Genze4Y;
        "pkg-1.19.3-1.4.1" = _BRY57cws;
        "pkg-1.19.3-1.4.3" = _WhvAjcf2;
        "pkg-1.19.3-1.4.4" = _2YuI4Qbp;
        "pkg-1.19.3-1.4.5" = _OSddY50F;
        "pkg-1.19.3-1.4.6" = _jeKbzKWV;
        "pkg-1.19.3-1.4.7" = _G3WVn5dT;
        "pkg-1.19.4-1.5.0" = _FelIzhwy;
        "pkg-1.19.4-1.5.1" = _2ibRYNbW;
        "pkg-1.19.4-1.5.2" = _nY9H55nH;
        "pkg-1.19.4-1.5.3" = _CXWxtwRq;
        "pkg-1.19.4-1.5.4" = _qJrIEm6P;
        "pkg-1.19.4-1.5.5" = _5cw16GKv;
        "pkg-1.19.4-1.5.6" = _SHR7ooj7;
        "pkg-1.19.4-1.5.7" = _TFHWQDyv;
        "pkg-1.19.4-1.5.8" = _XiFkasRx;
        "pkg-1.19.4-1.5.9" = _czSblM9n;
        "pkg-1.19.4-1.6.0" = _QgKy7ECu;
        "pkg-1.19.4-1.6.1" = _wStxPn9z;
        "pkg-1.19.4-1.6.2" = _QlpncJi1;
        "pkg-1.19.4-1.6.3" = _OGZRdXKg;
        "pkg-1.19.4-1.7.0" = _T6NiKUBX;
        "pkg-1.19.4-1.7.1" = _4Hy0ugTj;
        "pkg-1.20.1-1.8.0" = _vMCakS9h;
        "pkg-1.20.1-1.8.1" = _eZGQ9IRG;
        "pkg-1.20.1-1.8.2" = _crOC2Pjw;
        "pkg-1.20.1-1.8.3" = _TRZ4RBQA;
        "pkg-1.20.1-1.9.0" = _wchDyDgF;
        "pkg-1.20.1-1.9.1" = _nKaBHoaS;
        "pkg-1.20.1-1.9.2" = _Apd95wWi;
        "pkg-1.20.1-1.9.3" = _HUuvN85R;
        "pkg-1.20.1-1.9.4" = _5pxGGDeh;
        "pkg-1.20.1-1.9.5" = _PYoFhPiP;
        "pkg-1.20.1-1.9.6" = _207IsYA3;
        "pkg-1.20.1-1.9.7" = _42c0Ygo7;
        "pkg-1.20.1-1.10.0" = _RegJhcjp;
        "pkg-1.20.1-1.10.1" = _g3MXTZ33;
        "pkg-1.20.1-1.10.2" = _elKTU3iY;
        "pkg-1.20.1-1.10.3" = _Y1pChlDK;
        "pkg-1.20.1-1.10.4" = _OZlUuOCF;
        "pkg-1.20.1-1.10.5" = _7qFPPzjV;
        "pkg-1.20.1-1.10.6" = _2fxCEuJh;
        "pkg-1.20.1-1.11.0" = _faLq3LYM;
        "pkg-1.20.1-1.11.1" = _WwxC3iP6;
        "pkg-1.20.1-1.11.2" = _AaP12WpM;
        "pkg-1.20.1-1.11.3" = _G24pUeeq;
        "pkg-1.20.1-1.11.4" = _lbMftkMF;
        "pkg-1.20.1-1.11.6" = _GrHEV9vb;
        "pkg-1.20.1-1.11.7" = _OjFtc3oY;
        "pkg-1.20.1-1.12.0" = _d30CtSG0;
        "pkg-1.20.1-1.13.0" = _ubzrBr6J;
        "default" = _ubzrBr6J;
    });
