...
let
    ...
    in {
        ...
        "pkg-v.2.0.0+mod" = _q7NufwUz;
        "pkg-v.1.0.1" = _9xJAMkuK;
        "pkg-v.1.0.1+mod" = _2NYYtmUS;
        "pkg-v.2.1.0" = _b6aXZGgp;
        "pkg-v.2.1.0+mod" = _9303eWmM;
        "pkg-v.1.1.0" = _Xa95cFYT;
        "pkg-v.1.1.0+mod" = _lArdMOTx;
        "pkg-v.1.1.1" = _2uIGPgm6;
        "pkg-v.1.1.1+mod" = _IFIGaby7;
        "pkg-v.3.0.0" = _u2de3EDD;
        "pkg-v.3.0.0+mod" = _5DcywPaW;
        "pkg-v3.0.0" = _r9IiLfVJ;
        "pkg-v3.0.0+mod" = _i3kbVpOP;
        "pkg-v3.1.0" = _P2tuCjRo;
        "pkg-v3.1.0+mod" = _nfLEGsme;
        "pkg-v3.1.1" = _KeQUYnd8;
        "pkg-v3.1.1+mod" = _G5fv1SDE;
        "pkg-v3.1.2" = _3kpmJQmi;
        "pkg-v3.1.2+mod" = _OqrILcxr;
        "pkg-v3.1.3" = _mRnSgfPq;
        "pkg-v3.1.3+mod" = _J7HePP55;
        "pkg-v3.1.3.0" = _5fdJwEn5;
        "pkg-v3.1.3.0+mod" = _TuZD8QE6;
        "pkg-v3.1.3.1" = _j43UElwr;
        "pkg-v3.1.3.1+mod" = _cUnXAGYR;
        "pkg-v3.1.3.2" = _riYc1cLG;
        "pkg-v3.1.3.2+mod" = _xlLjFY3f;
        "pkg-v3.1.4" = _usasKMvp;
