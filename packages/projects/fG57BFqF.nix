...
let
    ...
    in {
        ...
        "pkg-1.20-1.0" = _HxwIa1DY;
        "pkg-1.20.1-1.0" = _ZeDjJYQ8;
        "pkg-1.20.2-1.0" = _BmdmXYeg;
        "pkg-1.20.3-1.0" = _w7svAJ8Q;
        "pkg-1.20.4-1.0" = _j8oFMmMY;
        "pkg-1.1.0" = _xZvgq5b4;
        "pkg-1.2.0" = _WEsssDGH;
        "pkg-1.2.1" = _scza5zf5;
        "pkg-1.2.2" = _OyaTqlet;
        "pkg-1.2.3" = _Ud0fWHMs;
        "pkg-1.2.4" = _FTTZzvqQ;
        "pkg-1.2.5-1.20" = _JOQGnP2y;
        "pkg-1.2.5-1.20.1" = _VZ3OcoT5;
        "pkg-1.2.5-1.20.2" = _7H95aAJ6;
        "pkg-1.2.5-1.20.3" = _pCF35bDS;
        "pkg-1.2.5-1.20.4" = _nP0n7fvv;
        "pkg-1.3.0-1.20" = _P9mmkplf;
        "pkg-1.3.0-1.20.1" = _LVU5pGyT;
        "pkg-1.3.0-1.20.2" = _ibKCGRmN;
        "pkg-1.3.0-1.20.3" = _NZnnkFEI;
        "pkg-1.3.0-1.20.4" = _5Nor3vQK;
        "pkg-1.4.0-1.20" = _X5rK1FRG;
        "pkg-1.4.0-1.20.1" = _SqqiFrca;
        "pkg-1.4.0-1.20.2" = _H5bupxFp;
        "pkg-1.4.0-1.20.3" = _Z1Xh8xqX;
        "pkg-1.4.0-1.20.4" = _eUtgrnAe;
        "pkg-1.5.0-1.20" = _ewMMzYiy;
        "pkg-1.6.0" = _9cq73yZT;
        "pkg-1.6.1" = _LjrlPtx1;
        "pkg-1.6.2" = _Tn1zTTQX;
        "pkg-1.6.3" = _s6tJDPwj;
