...
let
    ...
    in {
        ...
        "pkg-4.0.0.0" = _EpSYssOK;
        "pkg-1.18.2-4.0.1.0-forge" = _2F0YLPOI;
        "pkg-1.19.2-4.0.1.0-forge" = _QSMZ8nIq;
        "pkg-1.19.2-4.0.5.0-fabric" = _KbRDpl9s;
        "pkg-1.18.2-4.0.1.0-fabric" = _jhkv3JDC;
        "pkg-1.21.1-6.0.0.1-neoforge" = _w55RRckN;
        "pkg-1.21.1-6.0.0.1-fabric" = _wjRFBQX8;
        "pkg-1.20.4-6.0.0.1-neoforge" = _o9heTCue;
        "pkg-1.20.4-6.0.0.1-fabric" = _9bANT4IW;
        "pkg-1.20.4-6.0.0.1-forge" = _SjhBqfzF;
        "pkg-1.19.3-6.0.0.1-forge" = _uwA39jkx;
        "pkg-1.19.3-6.0.0.1-fabric" = _i9rtefRZ;
        "pkg-1.18.2-6.0.0.1-forge" = _sEcmAaRM;
        "pkg-1.18.2-6.0.0.1-fabric" = _5zWrPcnv;
        "pkg-1.21.4-6.0.0.1-fabric" = _SXyaAUyO;
        "pkg-1.21.4-6.0.0.1-neoforge" = _uUfpbMcG;
        "pkg-1.21.5-6.0.0.1-neoforge" = _mbw5P7xn;
        "pkg-1.21.5-6.0.0.1-fabric" = _YFIk1iPv;
        "pkg-1.21.1-6.0.0.2-neoforge" = _joWoWCow;
        "pkg-1.21.1-6.0.0.2-fabric" = _9KaCACPQ;
        "pkg-1.21.4-6.0.0.2-neoforge" = _ZUJqjppl;
        "pkg-1.21.4-6.0.0.2-fabric" = _VkdDzJFj;
        "pkg-1.21.5-6.0.0.2-neoforge" = _KspkEhms;
        "pkg-1.21.5-6.0.0.2-fabric" = _XfySWLVl;
        "pkg-1.21.8-6.0.0.2-neoforge" = _1YJcL67M;
        "pkg-1.21.8-6.0.0.2-fabric" = _a2F3QBAV;
        "pkg-1.21.10-6.0.0.2-neoforge" = _XvY1bBcS;
        "pkg-1.21.10-6.0.0.2-fabric" = _vccK28zG;
        "pkg-1.21.11-6.0.0.2-neoforge" = _PELHxwmi;
        "pkg-1.21.11-6.0.0.2-fabric" = _YQBIHj9a;
        "pkg-1.20.1-5.0.0.0-forge" = _8fu3zAos;
        "pkg-1.20.1-5.0.0.0-fabric" = _2Gjv6pZK;
        "default" = _2Gjv6pZK;
    });
