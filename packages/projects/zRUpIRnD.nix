...
let
    ...
    in {
        ...
        "pkg-v1.0.0-1.21.11" = _ikmOVWMo;
        "pkg-v1.1.0-26.2" = _yUnZIgAT;
        "pkg-v1.1.0-26.1" = _IhZxBUOC;
        "pkg-v1.1.0-1.21.11" = _Tbuqln0Y;
        "pkg-v1.2.0-26.2" = _HL3DMjsL;
        "pkg-v1.2.0-26.1" = _ufKpzBUm;
        "pkg-v1.2.0-1.21.11" = _DftbLjyj;
