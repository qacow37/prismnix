...
let
    ...
    in {
        ...
        "pkg-1.20.4" = _yPEw2Vpk;
        "pkg-1.20.5" = _vHM8I3Qp;
        "pkg-1.21" = _LMgARcct;
        "pkg-1.21.3" = _jWJjZIS7;
        "pkg-1.21.4" = _xcUt15c0;
        "pkg-1.21.5" = _UI1SMimF;
        "pkg-1.21.6" = _rUI5XY0T;
        "pkg-1.21.7" = _feQSGjNb;
        "pkg-1.21.10" = _QARMJx59;
