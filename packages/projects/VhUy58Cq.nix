...
let
    ...
    in {
        ...
        "pkg-1.2+24w37a" = _Nmm3qCua;
        "pkg-1.2+24w38a" = _ssDmO3Ei;
        "pkg-1.2+24w39a" = _zsgSYKsI;
        "pkg-1.2+24w40a" = _PBM8Vwfy;
        "pkg-1.2+1.21.2-pre1" = _n5pDOWnC;
        "pkg-1.2+1.21.2" = _BtMVxJgz;
        "pkg-1.2.1+1.21.3" = _FdVY86WR;
        "pkg-1.2.2+1.21.3" = _bfMuqvpN;
        "pkg-1.2.2+1.21.8" = _LdlFMtXl;
        "pkg-1.3+1.21.3" = _QkSsZ314;
        "pkg-1.3+1.21.4" = _spwVWD2S;
        "pkg-1.3+1.21.8" = _qjwejmxp;
        "pkg-1.3.1+1.21.3+fabric" = _bWppqAWX;
        "pkg-1.3.1+1.21.3+neoforge" = _Luh2AY71;
        "pkg-1.3.2+1.21.4+fabric" = _HnDdF4By;
        "pkg-1.3.2+1.21.4+neoforge" = _jMl77M1p;
        "pkg-1.3.2+1.21.8+fabric" = _rxSxZNvk;
        "pkg-1.3.2+1.21.8+neoforge" = _aif3DaPK;
        "pkg-1.3.2+1.21.9+fabric" = _zoBxVMfn;
        "pkg-1.3.2+1.21.9+neoforge" = _Aax5SYUU;
        "pkg-1.4.0+1.21.3+neoforge" = _dpXidMVQ;
        "pkg-1.4.0+1.21.3+fabric" = _sUTJqzjR;
        "pkg-1.4.0+1.21.10+neoforge" = _J0lCwlS3;
        "pkg-1.4.0+1.21.10+fabric" = _kw9kEWWi;
        "pkg-1.4.0+1.21.4+fabric" = _oLCMHt2Z;
        "pkg-1.4.0+1.21.8+neoforge" = _ShoglRsQ;
        "pkg-1.4.0+1.21.4+neoforge" = _clKUKufc;
        "pkg-1.4.0+1.21.8+fabric" = _6YEzgzYf;
        "pkg-1.5.0+1.21.11+neoforge" = _UgJZfCik;
        "pkg-1.5.0+1.21.11+fabric" = _kfykidA6;
        "pkg-1.6.0+1.21.10+fabric" = _wD58Mzvj;
        "pkg-1.6.0+1.21.10+neoforge" = _bQ3TUYbg;
        "pkg-1.6.0+1.21.11+fabric" = _2bcn7gXU;
        "pkg-1.6.0+1.21.11+neoforge" = _wSWljsy2;
        "pkg-1.6.0+1.21.3+fabric" = _zOT5HFUd;
        "pkg-1.6.0+1.21.3+neoforge" = _FrvID571;
        "pkg-1.6.0+1.21.4+fabric" = _yugwwKot;
        "pkg-1.6.0+1.21.4+neoforge" = _wgJzmVqr;
        "pkg-1.6.0+1.21.8+neoforge" = _enZFV8ZL;
        "pkg-1.6.0+1.21.8+fabric" = _CjtlRQDd;
        "pkg-1.6.1+1.21.3+fabric" = _cQdENWzw;
        "pkg-1.6.1+1.21.3+neoforge" = _gvKpcw6G;
        "pkg-1.6.1+1.21.4+fabric" = _vjmeoXkL;
        "pkg-1.6.1+1.21.4+neoforge" = _hn49xXcf;
        "pkg-1.6.1+1.21.8+fabric" = _nkIvKFiL;
        "pkg-1.6.1+1.21.8+neoforge" = _ySqJcebC;
        "pkg-1.6.1+1.21.10+fabric" = _LThQ32z0;
        "pkg-1.6.1+1.21.10+neoforge" = _AicZsX1s;
        "pkg-1.6.1+1.21.11+fabric" = _C87VX5Bg;
        "pkg-1.6.1+1.21.11+neoforge" = _JiUtHg7i;
        "pkg-1.6.1+26.1+fabric" = _pMFGoUw8;
        "pkg-1.6.1+26.1+neoforge" = _udzunoTF;
        "pkg-1.6.2+26.1+neoforge" = _2k1rhVLU;
        "pkg-1.6.2+26.2+neoforge" = _ZknW0BxZ;
        "pkg-1.6.2+26.2+fabric" = _H5lqJRob;
        "pkg-1.6.3+1.21.3+neoforge" = _zYG6ev9n;
        "pkg-1.6.3+1.21.3+fabric" = _uGuwiWws;
        "pkg-1.6.3+1.21.4+neoforge" = _1dhP7Utq;
        "pkg-1.6.3+1.21.4+fabric" = _yYZDpSZc;
        "pkg-1.6.3+1.21.8+neoforge" = _UUZs2E5m;
        "pkg-1.6.3+1.21.8+fabric" = _HJzL89uE;
        "pkg-1.6.3+1.21.10+neoforge" = _1QQtrNVQ;
        "pkg-1.6.3+1.21.10+fabric" = _KLqm5dkK;
        "pkg-1.6.3+1.21.11+neoforge" = _HiyKRecM;
        "pkg-1.6.3+1.21.11+fabric" = _J1kgyNoT;
        "pkg-1.6.3+26.1+neoforge" = _mXdNfzqw;
