...
let
    ...
    in {
        ...
        "pkg-0.1-ALPHA" = _aP90jTOh;
        "pkg-0.2.0b7-BETA-fabric" = _4ggu9gfp;
        "pkg-0.2.0b7-BETA-forge" = _eDggMXcE;
        "pkg-0.2.1b8-BETA-fabric" = _Wz4MxAeB;
        "pkg-0.2.1b8-BETA-forge" = _hETV1qqa;
        "pkg-0.2.2b9-BETA-forge" = _51ZzaLFg;
        "pkg-0.2.2b9-BETA-fabric" = _nfbkeCVx;
        "pkg-0.2.2b9-BETA-neoforge" = _CwjNTGHY;
        "pkg-0.2.3+1.18b10-BETA-forge" = _z0qwR2Kp;
        "pkg-0.2.3+1.18b10-BETA-fabric" = _b5PcD66Y;
        "pkg-0.2.3+1.20.2b10-BETA-fabric" = _aeJP2ppA;
        "pkg-0.2.3+1.20.2b10-BETA-forge" = _7o1PKejt;
        "pkg-0.2.3+1.20.2b10-BETA-neoforge" = _sFpmaayl;
        "pkg-0.2.4+1.18b11-BETA-forge" = _w3VopSuo;
        "pkg-0.2.4+1.18b11-BETA-fabric" = _35UlFRK3;
        "pkg-0.2.4+1.20.2b11-BETA-forge" = _p9cxjumf;
        "pkg-0.2.4+1.20.2b11-BETA-fabric" = _UhTDsu7a;
        "pkg-0.2.4+1.20.2b11-BETA-neoforge" = _3sq2ZNyr;
        "pkg-0.2.5+1.18b12-BETA-forge" = _CEulBuva;
        "pkg-0.2.5+1.18b12-BETA-fabric" = _OBV18g7X;
        "pkg-0.2.5+1.20.2b12-BETA-fabric" = _IXUF8P1V;
        "pkg-0.2.5+1.20.2b12-BETA-forge" = _9bKb8FTD;
        "pkg-0.2.5+1.20.2b12-BETA-neoforge" = _6A5FzpbW;
        "pkg-0.2.5+1.20.5b12-BETA-fabric" = _zQvYT6H3;
        "pkg-0.2.6+1.18b13-BETA-fabric" = _HeA13xao;
        "pkg-0.2.6+1.20.2b13-BETA-fabric" = _Q12RwbhU;
        "pkg-0.2.6+1.18b13-BETA-forge" = _ZVuDSmdK;
        "pkg-0.2.6+1.20.2b13-BETA-forge" = _In3XDAgT;
        "pkg-0.2.6+1.20.2b13-BETA-neoforge" = _mxZGcJJy;
        "pkg-0.2.6+1.20.5b13-BETA-fabric" = _c8UOQCzW;
        "pkg-0.2.6+1.20.5b13-BETA-neoforge" = _Ar4uyF8D;
        "pkg-0.2.7+1.18b14-BETA-fabric" = _fLVhqshg;
        "pkg-0.2.7+1.18b14-BETA-forge" = _qm1Ms09j;
        "pkg-0.2.7+1.20.2b14-BETA-fabric" = _tbVZPuEa;
        "pkg-0.2.7+1.20.2b14-BETA-forge" = _pWrt2Nkh;
        "pkg-0.2.7+1.20.2b14-BETA-neoforge" = _dvfCgw14;
        "pkg-0.2.7+1.20.5b14-BETA-fabric" = _UdIr4cyO;
        "pkg-0.2.7+1.20.5b14-BETA-neoforge" = _prLFYwgy;
        "default" = _prLFYwgy;
    });
