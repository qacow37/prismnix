...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _KjqElw7Q;
        "pkg-1.18.2-2.0-fabric" = _iZgXoXd6;
        "pkg-1.19.2-2.2-fabric" = _4RO3vQeh;
        "pkg-1.16.5-1.5-forge" = _1k6pVbrd;
        "pkg-1.18.2-1.7-forge" = _4qYwEoqS;
        "pkg-1.19.2-1.9-forge" = _JyV1iMXP;
        "pkg-1.16.5-2.3-fabric" = _8XePZkeh;
        "pkg-1.18.2-2.3-fabric" = _QGzRhQzv;
        "pkg-1.19.2-2.3-fabric" = _yaiyd6AO;
        "pkg-1.16.5-2.4-fabric" = _9u9xrE83;
        "pkg-1.18.2-2.4-fabric" = _r8FlWHRJ;
        "pkg-1.19.2-2.4-fabric" = _C4RrPfAh;
        "pkg-1.16.5-2.4-forge" = _ncFbYLWI;
        "pkg-1.18.2-2.4-forge" = _6Izdc8v6;
        "pkg-1.19.2-2.4-forge" = _72hJADYF;
        "pkg-1.19.3-2.5-fabric" = _Q5dWWCTt;
        "pkg-1.19.3-2.4-forge" = _ba3s5h4c;
        "pkg-1.18.2-3.0-forge+fabric" = _brFEmyJY;
        "pkg-1.19.2-3.0-forge+fabric" = _jbyuURue;
        "pkg-1.19.3-3.0-forge+fabric" = _VMJhbXYF;
        "pkg-1.19.4-3.0-forge+fabric" = _QCswRIBK;
        "pkg-1.20-3.0-forge+fabric" = _1wKFOaSc;
        "pkg-1.20.1-3.0-forge+fabric" = _37SAYoqz;
        "pkg-1.20.2-3.0-forge+fabric" = _KqOPZPH2;
        "pkg-1.18.2-3.1-forge+fabric" = _TximfI3V;
        "pkg-1.19.2-3.1-forge+fabric" = _Zni4u3pX;
        "pkg-1.20.1-3.1-forge+fabric" = _XNvRX5Mk;
        "pkg-1.20.2-3.1-forge+fabric" = _PumNqEq0;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _BjUBVlDp;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _tIvTHiHT;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _TV1AnMcS;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _6C51FAtQ;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _Rdf94Ihl;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _FOzsKMeg;
        "pkg-1.19.2-3.3-fabric+forge" = _7PAXlxO5;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _1fO1yczH;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _wUkKWv0i;
        "pkg-1.20.5-3.3-fabric+neo" = _cRsyjVQy;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _1eKB0M5s;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _CsFu5bBE;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _IamtKFrT;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _CneTfPaj;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _Isiw4Ooq;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _o23PeCQQ;
        "pkg-1.21.2-3.4-fabric+neo" = _TXOj9omB;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _RmhPJh6V;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _HD6fEsAz;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _QHo5kKcD;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _dPunbopN;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _B4qXcdq4;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _ZxSTDkKk;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _4krVnUbj;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _rtd4b8qh;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _vO4est2A;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _29tuCYPk;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _YMTo8zQs;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _mpn2C7Nb;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _tD4Jtwkl;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _yYR0quC2;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _kpbgR0gI;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _G8wPh4Dz;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _QgzXKIoi;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _FtvwkbtH;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _Iey4wdzf;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _nknXY5tq;
        "default" = _nknXY5tq;
    });
