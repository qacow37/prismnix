...
let
    ...
    in {
        ...
        "pkg-0.1" = _IibNIf62;
        "pkg-0.2" = _9HxM5iIZ;
        "pkg-1.0-1.20.1" = _Tvnxdvis;
        "pkg-0.3" = _ZAvPiCIz;
        "pkg-1.0.1-1.20.1" = _jnTaMdvP;
        "pkg-0.4" = _VZLUlHe4;
        "pkg-1.1-1.20.1" = _x4rPZoGX;
        "pkg-1.1.1-1.20.1" = _vNikmnZC;
        "pkg-1.1.2-1.20.1" = _xgCN4iqd;
        "pkg-0.5" = _TPyJMaoa;
        "pkg-1.1.3-1.20.1" = _GZrN4aCc;
        "pkg-1.1.4-1.20.1" = _2HuoabPy;
        "pkg-0.6" = _nd0N7Uf7;
        "pkg-1.1.5-1.20.1" = _TGhZhwgr;
        "pkg-1.1.6-1.20.1" = _8KaSePzW;
        "pkg-1.1.7-1.20.1" = _Mthq2vyU;
        "pkg-1.1.8-1.20.1" = _Fl52YlZ6;
        "pkg-1.1.9-1.20.1" = _StP0Y0C5;
        "pkg-1.0-1.21.1" = _GDBDLaKN;
        "pkg-1.0-april_fools" = _Ijqopzhz;
        "pkg-1.1-1.21.1" = _xuiwkkPi;
        "pkg-1.2-1.21.1" = _JQrw7a5Y;
        "pkg-1.2.1-1.21.1" = _H1ZXg9zE;
        "pkg-1.2.2-1.21.1" = _HrOMHViD;
        "pkg-1.2.3-1.21.1" = _if1OXcZZ;
        "pkg-1.1.10-1.20.1" = _aPXXdHuI;
        "pkg-1.2-1.20.1" = _OtmA6Gy5;
        "pkg-1.2.4-1.21.1" = _DNtmnkXg;
        "pkg-1.3-1.20.1" = _hgEYukbh;
        "pkg-1.3.1-1.20.1" = _AEk8W7Wy;
        "pkg-2.0-1.21.1" = _cJ6mm9y7;
        "pkg-2.0.1-1.21.1" = _S3gNyriF;
        "pkg-2.0.2-1.21.1" = _GAUIiiMT;
        "pkg-2.0.3-1.21.1" = _IzZRu6cT;
        "pkg-2.0.4-1.21.1" = _nJipj2lk;
        "default" = _nJipj2lk;
    });
