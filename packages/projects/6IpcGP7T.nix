...
let
    ...
    in {
        ...
        "pkg-1.18-0.1.0-forge" = _NM3HlLiR;
        "pkg-1.18-0.1.0-fabric" = _jtz99scr;
        "pkg-1.18-0.2.0-fabric" = _WLbBMU7V;
        "pkg-1.18-0.2.0-forge" = _KhbPFWzb;
        "pkg-1.20-0.3.2-fabric" = _ezkd2wAz;
        "pkg-1.20-0.3.2-forge" = _5voBKyma;
        "pkg-1.20-0.3.2-quilt" = _NRfiDB86;
        "pkg-0.4.0+1.21.4-neoforge" = _H2qicTFZ;
        "pkg-0.4.0+1.20.4-neoforge" = _XbqVj4ko;
        "pkg-0.4.0+1.20.6-neoforge" = _YDbqc49t;
        "pkg-0.4.0+1.20.4-forge" = _PDZBWENe;
        "pkg-0.4.0+1.19.4-forge" = _ukoDHVsl;
        "pkg-0.4.0+1.18.2-forge" = _QkbEMNg5;
        "pkg-0.4.0+1.17.1-forge" = _KhnfVaHK;
        "pkg-0.4.0+1.16.5-forge" = _kx2q1Tk3;
        "pkg-0.4.0+1.21.4-fabric" = _horUCcSM;
        "pkg-0.4.0+1.20.6-fabric" = _5piwf6Pl;
        "pkg-0.4.0+1.20.4-fabric" = _GRrecXBb;
        "pkg-0.4.0+1.19.4-fabric" = _nBduCNgl;
        "pkg-0.4.0+1.18.2-fabric" = _MbPvrzMt;
        "pkg-0.4.0+1.17.1-fabric" = _SMBTZspB;
        "pkg-0.4.0+1.16.5-fabric" = _sIxYsW6o;
        "pkg-0.5.0+1.21.8-neoforge" = _GjTuFGdp;
        "pkg-0.5.0+1.21.10-neoforge" = _ItIkLaGD;
        "pkg-0.5.0+1.20.6-neoforge" = _buCdvXe0;
        "pkg-0.5.0+1.20.4-neoforge" = _tflyXj0S;
        "pkg-0.5.0+1.20.4-forge" = _ZVXGk8vA;
        "pkg-0.5.0+1.19.4-forge" = _9dm0WUHg;
        "pkg-0.5.0+1.18.2-forge" = _RJ1nRKdA;
        "pkg-0.5.0+1.17.1-forge" = _QPt5KbmG;
        "pkg-0.5.0+1.16.5-forge" = _eLw73IhE;
        "pkg-0.5.0+1.21.8-fabric" = _H6eZczKg;
        "pkg-0.5.0+1.21.10-fabric" = _aNlTPSAe;
        "pkg-0.5.0+1.20.6-fabric" = _ABDXtu3b;
        "pkg-0.5.0+1.20.4-fabric" = _eRudauVi;
        "pkg-0.5.0+1.19.4-fabric" = _uuZjNovp;
        "pkg-0.5.0+1.18.2-fabric" = _LnFHDoFF;
        "pkg-0.5.0+1.17.1-fabric" = _Uv8azdbH;
        "pkg-0.5.0+1.16.5-fabric" = _YG2v9mNQ;
        "default" = _YG2v9mNQ;
    });
