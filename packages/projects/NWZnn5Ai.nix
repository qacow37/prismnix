...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _YA6gl8TN;
        "pkg-1.1.0" = _S1HUAAiM;
        "pkg-1.2.1-1.21.4" = _hBs6z2bj;
        "pkg-1.2.1-1.21.6" = _knPYwgW4;
        "pkg-1.2.2-1.21.9" = _dnZSlUD6;
        "pkg-1.2.2-26.1.1" = _RylfbqYe;
        "pkg-1.2.2+neo-26.1.1" = _Q1L5p5U8;
        "pkg-1.2.2+neo-1.21.9" = _HU1ddgTQ;
        "pkg-1.2.2+neo-1.21.11" = _ArPOVB5b;
        "pkg-1.2.2-1.21+" = _YeboAZ4a;
        "pkg-1.2.2-1.21.2+" = _wR9Os2Z3;
        "pkg-1.2.2-1.21.4+" = _NvB4pu6B;
        "pkg-1.2.2-1.21.6+" = _VQXkmIsW;
        "pkg-1.2.2-1.21.9+" = _1RpRjQqJ;
        "pkg-1.2.2-26.1.1+" = _zd7QOy0J;
        "pkg-1.3.0-26.1.1+" = _CF4wwcow;
        "pkg-1.3.0-1.21+" = _yw1JA9rj;
        "pkg-1.3.0-1.21.2+" = _vnljOEoC;
        "pkg-1.3.0-1.21.4+" = _FjQMC7LY;
        "pkg-1.3.0-1.21.6+" = _NFngmnS9;
        "pkg-1.3.0-1.21.9+" = _fxeRsAnx;
        "pkg-1.3.0-26.1.1" = _fsCV3ucc;
        "pkg-1.3.1-1.21+" = _sCGMFBfz;
        "pkg-1.3.1-1.21.2+" = _hM3ImWIj;
        "pkg-1.3.1-1.21.4+" = _rsO9v4ZV;
        "pkg-1.3.1-1.21.6+" = _YQU3PhV4;
        "pkg-1.3.1-1.21.9+" = _wEzvfNDQ;
        "pkg-1.3.1-26.1.1" = _x5yQKWuY;
        "pkg-1.3.1+neo-1.21.9" = _tCgYTK70;
        "pkg-1.3.1+neo-1.21.10" = _ac0mfXa7;
        "pkg-1.3.1+neo-1.21.11" = _RzAmQOe6;
        "pkg-1.3.1+neo-26.1.1" = _Mwq4JCfA;
        "pkg-1.3.1-1.20.1" = _ucwwzCuo;
        "pkg-1.3.3.beta-1.21+" = _ZjCzaYCx;
        "pkg-1.3.3.beta-1.21.2+" = _N2zLVOaD;
        "pkg-1.3.3.beta-1.21.4+" = _mmYOJZHv;
        "pkg-1.3.3.beta-1.21.6+" = _dnpvugzY;
        "pkg-1.3.3.beta-1.21.9+" = _HtT7juSz;
        "pkg-1.3.3.beta-26.1.1" = _4PVNkkao;
        "pkg-1.3.3.beta-1.20.1" = _Squ2lLTS;
        "pkg-1.3.3+neo-1.21.9" = _UmhHTV0i;
        "pkg-1.3.3+neo-1.21.10" = _n6oPc4GG;
        "pkg-1.3.3+neo-1.21.11" = _lJblo4Ly;
        "pkg-1.3.3+neo-26.1.1" = _U4oXv4MX;
        "pkg-1.3.4+neo-1.21.9" = _esVTdF7z;
        "pkg-1.3.4+neo-1.21.10" = _BTQxYsTy;
        "pkg-1.3.4+neo-1.21.11" = _afLBiIim;
        "pkg-1.3.4+neo-26.1.1" = _P9E2Ydit;
        "pkg-1.3.4.beta-1.20.1" = _BzISAbjA;
        "pkg-1.3.4.beta-1.21+" = _8iNaM4Ea;
        "pkg-1.3.4.beta-1.21.2+" = _kTcuHgGB;
        "pkg-1.3.4.beta-1.21.4+" = _L8RPXdnB;
        "pkg-1.3.4.beta-1.21.6+" = _Jyo8iryw;
        "pkg-1.3.4.beta-1.21.9+" = _AuWAJWm7;
        "pkg-1.3.4.beta-26.1.1" = _75sv0Y7L;
        "pkg-1.3.4+neo-1.20.1" = _9jhc6ZVo;
        "pkg-1.3.4+neo-1.21.1" = _plUQRT0c;
        "pkg-1.4.0.beta-26.1.1" = _KzNd2q9G;
        "pkg-1.4.0+neo-26.1.1" = _l45IbFDE;
        "pkg-1.4.1-1.21+" = _GqEKBjO1;
        "pkg-1.4.1-1.21.2+" = _ABUoAclY;
        "pkg-1.4.1-1.21.4+" = _1mGWG670;
        "pkg-1.4.1-1.21.6+" = _98xPkyj5;
        "pkg-1.4.1-1.21.9+" = _BvUDwYZy;
        "pkg-1.4.1-26.1.1" = _rZ6u4a1B;
        "pkg-1.4.2-neo-1.21.1" = _lhG04f1n;
        "pkg-1.4.2-neo-1.21.9" = _lQPtoVL8;
        "pkg-1.4.2-neo-1.21.10" = _4n6NhGjO;
        "pkg-1.4.2-neo-1.21.11" = _lk9GEB4B;
        "pkg-1.4.2-neo-26.1" = _rPcLzEkh;
        "pkg-1.4.2-1.21" = _me6uuqul;
        "pkg-1.4.2-1.21.3" = _9PQIXieS;
        "pkg-1.4.2-1.21.4" = _BiCO6Ytz;
        "pkg-1.4.2-1.21.6" = _rraEXPy1;
        "pkg-1.4.2-1.21.9" = _lvJ9hPuY;
        "pkg-1.4.2-26.1" = _r3cZiBLF;
        "pkg-1.4.2-26.2" = _yA3rsCG7;
        "pkg-1.5.0-mc1.21" = _Jhf9NdMH;
        "pkg-1.5.0-mc1.21.3" = _UCqYlOWm;
        "pkg-1.5.0-mc1.21.4" = _nwiiQHyd;
        "pkg-1.5.0-mc1.21.6" = _7PQZ7hiM;
        "pkg-1.5.0-mc1.21.9" = _lYrXu45D;
        "pkg-1.5.0-mc26.1" = _tT7HaC9J;
        "pkg-1.5.0-mc26.2" = _QTOh7ulo;
        "pkg-1.5.1-mc1.21" = _aPcZ4WJs;
        "pkg-1.5.1-mc1.21.2" = _5P6cyUm5;
        "pkg-1.5.1-mc1.21.4" = _ndvg9p8q;
        "pkg-1.5.1-mc1.21.6" = _UgfWxiIV;
        "pkg-1.5.1-mc1.21.9" = _yosYnmOd;
        "pkg-1.5.1-mc26.1" = _Y23KradB;
        "pkg-1.5.1-neo-26.1" = _fZdWC64o;
        "pkg-1.5.1-neo-1.21.11" = _UW77qxGZ;
        "pkg-1.5.1-neo-1.21.10" = _3gqM91AX;
        "pkg-1.5.1-neo-1.21.9" = _x0XipReb;
        "pkg-1.5.1-neo-1.21.1" = _Bv5J4Pip;
        "pkg-1.5.1-neo-26.2" = _7EHoopE6;
        "default" = _7EHoopE6;
    });
