...
let
    ...
    in {
        ...
        "pkg-v8.0.0-1.20.1-Fabric" = _vjvvLrPH;
        "pkg-v21.1.0-1.21.1-Fabric" = _Y2Mng5vN;
        "pkg-v21.1.0-1.21.1-NeoForge" = _n2jbGFJQ;
        "pkg-v21.3.0-1.21.3-Fabric" = _Gi00Drqf;
        "pkg-v21.3.0-1.21.3-NeoForge" = _zrIu3uth;
        "pkg-v21.4.0-1.21.4-Fabric" = _wx7tAslJ;
        "pkg-v21.4.0-1.21.4-NeoForge" = _TMpj97hk;
        "pkg-v21.5.0-1.21.5-Fabric" = _elVeGu79;
        "pkg-v21.5.0-1.21.5-NeoForge" = _oKkAtUPg;
        "pkg-v21.8.0-1.21.8-Fabric" = _4iKUK2mt;
        "pkg-v21.8.0-1.21.8-NeoForge" = _jBhpozmU;
        "pkg-v21.1.1-1.21.1-Fabric" = _K5T5WGul;
        "pkg-v21.1.1-1.21.1-NeoForge" = _TWC7in1y;
        "pkg-v21.3.1-1.21.3-Fabric" = _syCX0es9;
        "pkg-v21.3.1-1.21.3-NeoForge" = _qz9GYK7A;
        "pkg-21.10.1" = _u0y8hYcO;
        "pkg-v21.8.1-1.21.8-Fabric" = _jgZIdA9Z;
        "pkg-v21.5.1-1.21.5-Fabric" = _n4Itb1Gd;
        "pkg-v21.4.1-1.21.4-Fabric" = _TFf4cC6U;
        "pkg-v21.8.1-1.21.8-NeoForge" = _yo5Y5hOA;
        "pkg-v21.5.1-1.21.5-NeoForge" = _iBdzAAN4;
        "pkg-v21.4.1-1.21.4-NeoForge" = _KhNIILgC;
        "pkg-21.11.0" = _TGrMv4Kr;
        "pkg-v21.1.2-1.21.1-Fabric" = _oGfnV6U2;
        "pkg-v21.1.2-1.21.1-NeoForge" = _DZi1Jm4Y;
        "pkg-21.11.1" = _qcZHlV6y;
