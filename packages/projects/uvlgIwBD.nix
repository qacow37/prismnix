...
let
    ...
    in {
        ...
        "pkg-2.0.8" = _FFLv6S8C;
        "pkg-2.0.9" = _fogiUWJZ;
        "pkg-2.10.0" = _YqQ9Sjr4;
        "pkg-2.10.1" = _qcE19saT;
        "pkg-2.10.2" = _x9qDGItP;
        "pkg-2.10.3" = _wyWI0H01;
        "pkg-2.10.4" = _yLTbAQ9K;
        "pkg-2.10.5" = _gOyc8FIG;
        "pkg-2.10.6" = _KcyYfqou;
        "pkg-2.10.7" = _BDaonE3O;
        "pkg-2.10.8" = _FufEbyde;
        "pkg-2.10.9" = _z6Jo33DG;
        "pkg-2.10.10" = _j2jU4EUG;
        "pkg-2.10.11" = _2CziCGNb;
        "pkg-2.10.12" = _G32SmRNw;
        "pkg-2.10.13" = _R9rZFrBP;
