...
let
    ...
    in {
        ...
        "pkg-1.2.0" = _Irw8EkbH;
        "pkg-1.2.1" = _DxmhwMW6;
        "pkg-1.2.1-beta.1+mc.1.19" = _TsinvYm2;
        "pkg-1.2.2+mc.1.18.2" = _2xiaYece;
        "pkg-1.2.2+mc.1.19" = _4DxhymYW;
        "pkg-1.3.0+mc.1.18.2" = _TADmM33B;
        "pkg-1.3.0+mc.1.19" = _EU06uTZY;
        "pkg-1.3.1+mc.1.18.2" = _GUkaqQbh;
        "pkg-1.3.1+mc.1.19" = _SJ2zzjmy;
        "pkg-1.3.2+mc.1.18.2" = _y1KV1gHH;
        "pkg-1.3.2+mc.1.19" = _t5m6b25L;
        "pkg-1.3.3+mc.1.19.1" = _SzOc0Txf;
        "pkg-1.3.3+mc.1.18.2" = _oBLKNC93;
        "pkg-1.3.4+mc.1.18.2" = _acHPclOf;
        "pkg-1.3.4+mc.1.19.2" = _CZvcJ8Nm;
        "pkg-1.3.5+mc.1.19.2" = _yyAW1VEc;
        "pkg-1.3.5+mc.1.18.2" = _440BVseA;
        "pkg-1.3.5+mc.1.19.3" = _BSEUpwYf;
        "pkg-1.3.6+mc.1.18.2" = _KQWwv5Pb;
        "pkg-1.3.6+mc.1.19.2" = _vjldNGOW;
        "pkg-1.3.6+mc.1.19.3" = _8oUxVUWB;
        "pkg-1.3.7+mc.1.19.3" = _f8Uprgxb;
        "pkg-1.3.7+mc.1.19.2" = _7JFghoYj;
        "pkg-1.3.8+mc.1.19.3" = _EQiGu2ox;
        "pkg-1.3.8+mc.1.19.4" = _T1u7YzVx;
        "pkg-1.3.8+mc.1.19.2" = _l9GdhezM;
        "pkg-1.3.9+mc.1.19.4" = _U1KNzZfJ;
        "pkg-1.3.9+mc.1.19.3" = _RHzJyCes;
        "pkg-1.3.9+mc.1.19.2" = _w6MbQfF9;
        "pkg-1.3.10+mc.1.19.3" = _LX7Eoa9k;
        "pkg-1.3.10+mc.1.19.2" = _733bVMim;
        "pkg-1.3.10+mc.1.19.4" = _Y5z2ez9D;
        "pkg-1.4.0+mc.1.19.2" = _I60EiiQ4;
        "pkg-1.4.0+mc.1.19.3" = _h5SHa0HK;
        "pkg-1.3.7+mc.1.18.2" = _OWwdDLUz;
        "pkg-1.4.0+mc.1.19.4" = _upCbo2SX;
        "pkg-1.4.1+mc.1.19.2" = _M5cLmAFm;
        "pkg-1.4.1+mc.1.19.3" = _FFqDG6pf;
        "pkg-1.4.1+mc.1.19.4" = _AKlyAuoA;
        "pkg-1.4.2+mc.1.19.2" = _PrmuEpYT;
        "pkg-1.4.2+mc.1.19.4" = _ZydBqogv;
        "pkg-1.4.3+mc.1.19.2" = _rVif6c1F;
        "pkg-1.4.3+mc.1.19.4" = _teEWsREa;
        "pkg-2.0.0+mc.1.20.1" = _922YJBQU;
        "pkg-2.0.1+mc.1.20.1" = _vxhCCNsP;
        "pkg-2.0.2+mc.1.20.1" = _pwnk3LL4;
        "pkg-2.0.3+mc.1.20.1" = _sGVQ4xBa;
        "pkg-2.0.4+mc.1.20.1" = _C1W11axt;
        "pkg-2.0.5+mc.1.20.1" = _bMTgXYHf;
        "pkg-2.0.6+mc.1.20.1" = _sRZYy9TI;
        "pkg-1.4.4+mc.1.19.2" = _Yu7dw5fP;
        "pkg-1.4.4+mc.1.19.4" = _ukpWyC5M;
        "pkg-2.0.6+mc.1.20.2" = _1wAi7Fhe;
        "pkg-2.0.7+mc.1.20.2" = _RG7LdzfE;
        "pkg-2.0.7+mc.1.20.1" = _h6psg04U;
        "pkg-1.4.5+mc.1.19.4" = _Wa9Vvmlw;
        "pkg-1.4.5+mc.1.19.2" = _FEACM0Xv;
        "pkg-2.0.8+mc.1.20.2" = _T9g0Ztmr;
        "pkg-2.0.8+mc.1.20.1" = _TT5IhBIV;
        "pkg-2.1.0+mc.1.20.4" = _Wsd1sUYu;
        "pkg-2.1.0+mc.1.20.1" = _c49CW6RL;
        "pkg-2.1.0+mc.1.20.2" = _EaWbjZqx;
        "pkg-2.1.1+mc.1.20.4" = _vB7eQ3oD;
        "pkg-2.1.1+mc.1.20.2" = _zu7TfVUT;
        "pkg-2.1.1+mc.1.20.1" = _jAVkcXz6;
        "pkg-3.0.0-beta.1+mc.1.20.6" = _1fS4d2yg;
        "pkg-3.0.0+mc.1.21" = _t5cNEejY;
        "pkg-3.0.1+mc.1.21" = _YYk48t42;
        "pkg-3.0.2+mc.1.21" = _oAO9UYsd;
        "pkg-3.0.3+mc.1.21" = _lPApXobt;
        "pkg-3.0.3+mc.1.21.1" = _zs7bqK0E;
        "pkg-3.0.4+mc.1.21.1" = _7ayZB1fH;
        "pkg-4.0.0+mc.1.21.2" = _Kni3nnOS;
        "pkg-4.0.1+mc.1.21.4" = _IuNlZiqd;
        "pkg-4.1.0+mc.1.21.5" = _qAYc4RMz;
        "pkg-4.2.0+mc.1.21.6" = _byXnCYVg;
        "pkg-4.2.1+mc.1.21.6" = _coMXM3Tq;
        "pkg-4.3.0-beta.1+mc.1.21.9" = _gBNjohV9;
        "pkg-4.3.0-beta.2+mc.1.21.10" = _GSwllSSb;
        "pkg-4.3.0-beta.3+mc.1.21.11" = _5lQqC26G;
        "pkg-5.0.0+mc.26.1" = _QkTa8nh5;
        "pkg-5.1.0+mc.26.2" = _1GrnCGEz;
        "default" = _1GrnCGEz;
    });
