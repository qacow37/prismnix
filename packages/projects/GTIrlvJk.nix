...
let
    ...
    in {
        ...
        "pkg-1.8.5" = _enn83jgQ;
        "pkg-1.9.0" = _W2hfRuCy;
        "pkg-1.10.0" = _NCZokYvs;
        "pkg-1.10.1" = _zd4MJEax;
        "pkg-1.10.2+1.20.5" = _C29CbdAH;
        "pkg-1.10.3+1.20.6" = _nZ5mK4pT;
        "pkg-1.10.4+1.21" = _V5m1Mbhy;
        "pkg-1.10.5+1.21" = _5PpKEyEB;
        "pkg-1.10.6+1.21.3" = _cp7tyLQk;
        "pkg-1.10.7+1.21.4" = _oZejNTCG;
        "pkg-1.10.8+1.21.4" = _fgtQkeGk;
        "default" = _fgtQkeGk;
    });
