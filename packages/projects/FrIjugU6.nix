...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _QgOFLoDD;
        "pkg-1.1.0+1.20.1" = _I2qAHHWS;
        "pkg-1.1.0+1.20.2" = _sAYkgPx0;
        "pkg-1.1.0+1.20.4" = _NCyuofzb;
        "pkg-1.1.0+1.20.6" = _bC6NstR8;
        "pkg-1.1.0+1.21.1" = _lW1XxGjf;
        "pkg-1.2.0+1.20.1" = _iB2KyML9;
        "pkg-1.2.0+1.20.2" = _oiis038O;
        "pkg-1.2.0+1.20.4" = _Fvvxuzo4;
        "pkg-1.2.0+1.20.6" = _kLmx22C2;
        "pkg-1.2.0+1.21.1" = _D0vYAunF;
        "pkg-1.3.0+1.20.1" = _5HJMsX3U;
        "pkg-1.3.0+1.20.2" = _N2xyzGG0;
        "pkg-1.3.0+1.20.4" = _Aqj762ux;
        "pkg-1.3.0+1.20.6" = _DfS0uryn;
        "pkg-1.3.0+1.21.1" = _vEf9Bgk7;
        "pkg-1.3.0+1.21.3" = _3Loz9f1k;
        "pkg-1.3.0+1.21.4" = _9E2DD8Vl;
        "pkg-1.3.0+1.21.5" = _t9IIH8U4;
        "pkg-1.3.0+1.21.8" = _oNNfoOxl;
