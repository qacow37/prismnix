...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.5-fabric" = _zgVALaxw;
        "pkg-1.18.2-1.5-fabric" = _2QRPrw2S;
        "pkg-1.19.2-1.6-fabric" = _5RGpsNRI;
        "pkg-1.16.5-1.5-forge" = _g9UKNOTF;
        "pkg-1.18.2-1.5-forge" = _FeFKqKEh;
        "pkg-1.19.2-1.5-forge" = _4lBpiS9f;
        "pkg-1.16.5-1.7-fabric" = _2UsTUUHV;
        "pkg-1.18.2-1.7-fabric" = _TzvCRq9K;
        "pkg-1.19.2-1.7-fabric" = _uw3Im9Px;
        "pkg-1.16.5-1.7-forge" = _rUuW8gKG;
        "pkg-1.18.2-1.7-forge" = _2Q6gCwGW;
        "pkg-1.19.2-1.7-forge" = _pJtaFeyZ;
        "pkg-1.16.5-1.8-fabric" = _ZI731c9s;
        "pkg-1.18.2-1.8-fabric" = _W53HdvWk;
        "pkg-1.19.2-1.8-fabric" = _TkFgqKu7;
        "pkg-1.19.3-1.9-fabric" = _uSVwymKA;
        "pkg-1.19.3-1.7-forge" = _95DDKol2;
        "pkg-1.18.2-2.0-forge+fabric" = _6NJ4AF76;
        "pkg-1.19.2-2.0-forge+fabric" = _WqnhkFB9;
        "pkg-1.19.3-2.0-forge+fabric" = _JrGD9kHM;
        "pkg-1.18.2-2.3-forge+fabric" = _8ulG9lDX;
        "pkg-1.19.2-2.3-forge+fabric" = _Q8Va8QqQ;
        "pkg-1.19.3-2.3-forge+fabric" = _wvTrbGhe;
        "pkg-1.19.4-2.3-forge+fabric" = _tid4JzsJ;
        "pkg-1.20-2.3-forge+fabric" = _UCchDUoQ;
        "pkg-1.20.1-2.3-forge+fabric" = _l1GZ9YnO;
        "pkg-1.20.2-2.3-forge+fabric" = _u5Ajo0MP;
        "pkg-1.18.2-2.4-forge+fabric" = _Lmekw3aS;
        "pkg-1.19.2-2.4-forge+fabric" = _lgSHDKss;
        "pkg-1.20.1-2.4-forge+fabric" = _lJpsGfFw;
        "pkg-1.20.2-2.4-forge+fabric" = _oO0k7qZ9;
        "pkg-1.20.2-2.5-forge+fabric" = _R8xtLKR6;
        "pkg-1.20.3-2.5-fabric+forge+neo" = _KpjuOB9J;
        "pkg-1.20.4-2.5-fabric+forge+neo" = _toXNYkTp;
        "pkg-1.19.2-2.6-fabric+forge+neo" = _pPETNOXn;
        "pkg-1.20.1-2.6-fabric+forge+neo" = _zSVWXR05;
        "pkg-1.20.2-2.6-fabric+forge+neo" = _uGRrxW9I;
        "pkg-1.20.4-2.6-fabric+forge+neo" = _pv9RRwE1;
        "pkg-1.19.2-2.7-fabric+forge" = _D6NPcI90;
        "pkg-1.20.1-2.7-fabric+forge+neo" = _PqKrTii2;
        "pkg-1.20.2-2.7-fabric+forge+neo" = _cjWd43yL;
        "pkg-1.20.4-2.7-fabric+forge+neo" = _y1r05r59;
        "pkg-1.20.5-2.7-fabric+neo" = _qnginEEr;
        "pkg-1.20.6-2.7-fabric+forge+neo" = _ZszLC0bg;
        "pkg-1.21.0-2.7-fabric+forge+neo" = _svJWAKLa;
        "pkg-1.20.1-2.8-fabric+forge+neo" = _cB8CWBqv;
        "pkg-1.20.6-2.8-fabric+forge+neo" = _yZypMIJc;
        "pkg-1.21.0-2.8-fabric+forge+neo" = _MQZPlUWx;
        "pkg-1.21.1-2.8-fabric+forge+neo" = _Dia7FQQi;
        "pkg-1.21.2-2.8-fabric+neo" = _gauOvgBQ;
        "pkg-1.21.3-2.8-fabric+forge+neo" = _zswGe2x6;
        "pkg-1.21.4-2.8-fabric+forge+neo" = _QpqeXG7k;
        "pkg-1.21.5-2.8-fabric+forge+neo" = _a2LN7RT6;
        "pkg-1.21.5-2.9-fabric+forge+neo" = _n56WNNjy;
        "pkg-1.21.6-2.9-fabric+forge+neo" = _5OV5eweq;
        "pkg-1.21.7-2.9-fabric+forge+neo" = _5TWQtUtJ;
        "pkg-1.21.8-2.9-fabric+forge+neo" = _DDZYsGn5;
        "pkg-1.21.9-2.9-fabric+forge+neo" = _Z4rcwqCD;
        "pkg-1.21.10-2.9-fabric+forge+neo" = _9Ak5KuCn;
        "pkg-1.21.11-2.9-fabric+forge+neo" = _eVDU4NPn;
        "pkg-26.1.0-2.9-fabric+forge+neo" = _7MVJN9Rv;
        "pkg-26.1.1-2.9-fabric+forge+neo" = _4Ui11fA5;
        "pkg-26.1.2-2.9-fabric+forge+neo" = _JFu3WZp0;
        "pkg-26.2.0-2.9-fabric+forge+neo" = _EF41USAI;
        "default" = _EF41USAI;
    });
