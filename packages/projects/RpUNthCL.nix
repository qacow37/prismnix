...
let
    ...
    in {
        ...
        "pkg-1.1.1+forge1.20.1" = _b66f6wfS;
        "pkg-1.1.1+neoforge1.21" = _nhaB2BTN;
        "pkg-1.0.1-beta1+fabric1.20.4" = _R2aGQ4zl;
        "pkg-1.1.2+neoforge1.21" = _MiAVk0fg;
        "pkg-1.1.1+forge1.16.5" = _ERL5N5gJ;
        "pkg-1.1.1+forge1.18.2" = _JCMqZpLz;
        "pkg-2.0.0-rc.1" = _q8uZEFiR;
        "pkg-1.1.2+forge1.20.1" = _IbiqKM3k;
        "pkg-2.0.1" = _555UpIz7;
        "pkg-1.1.2+fabric1.20.1" = _3BZWyAXz;
        "pkg-1.1.3+forge1.20.1" = _xYGPoRKr;
        "pkg-1.1.3+fabric1.20.1" = _CnMa9XCs;
        "pkg-2.0.2" = _XY2uadN1;
        "pkg-1.1.2+forge1.16.5" = _Oe1R7eci;
        "pkg-1.1.2+forge1.18.2" = _DCFLY2IQ;
        "pkg-1.1.3+forge1.19.2" = _DdyWSHMN;
        "pkg-1.1.4+forge1.20.1" = _F025AvYN;
        "pkg-1.1.4+fabric1.20.1" = _ig50oTuk;
        "pkg-2.0.3" = _kDJi44uQ;
        "pkg-2.1.0" = _2Kw4Lcqb;
        "pkg-1.1.5+forge1.20.1" = _wBZ89Dkf;
        "pkg-1.1.5+fabric1.20.1" = _ay0zBxKj;
        "pkg-2.0.4" = _EHAMoTTT;
        "pkg-2.1.1" = _uJBZqF85;
        "pkg-3.0.0" = _NatUg2q7;
        "pkg-3.0.1" = _874IMhk9;
