...
let
    ...
    in {
        ...
        "pkg-0.1" = _8TcXhqmo;
        "pkg-0.1.1" = _ZwfiMB3y;
        "pkg-0.2-mc23w18a" = _wq3MqcUV;
        "pkg-0.1.1-alpha" = _KIwpIKRF;
        "pkg-0.1.1-alpha+rewrite.1.18" = _2aQ0nNOo;
        "pkg-0.1.2-alpha+1.20-c9650890" = _6pZXKM0t;
        "pkg-0.2-alpha+1.20-cf4c7338" = _ze8GBxma;
        "pkg-0.2" = _gkFDVcRr;
        "pkg-0.3-alpha+1.20-0de26335" = _YJbtiNZk;
        "pkg-0.3-alpha+1.19-f35bae1a" = _Egj7gbmM;
        "pkg-0.3-alpha+1.20-e2c987ae" = _hBmqAgiS;
        "pkg-0.3+1.19.4" = _DLfBCXJz;
        "pkg-0.3+1.20" = _aj5GuIed;
        "pkg-0.3.1+1.19" = _9qTtLWoH;
        "pkg-0.3.1+1.20" = _mOh1EiNv;
        "pkg-0.3.2+1.20" = _ob1oSK2u;
        "pkg-0.3.3+1.20" = _h3tlK0Tw;
        "pkg-0.3.4+1.20" = _VPtAOKh0;
        "pkg-0.3.5+1.20" = _ZJNWN8TX;
        "pkg-0.3.5+1.20.2" = _I4h4Y40k;
        "pkg-0.3.6+1.20" = _eCDIIIXI;
        "pkg-0.3.7+1.20.4" = _YTO03G6a;
        "pkg-0.4-dev+1.21-81f2e8dc" = _KG6L15i6;
        "pkg-0.4+1.21" = _zFeSYJmt;
        "pkg-0.4.2+1.21" = _WJs1WlVn;
        "pkg-0.4.4+1.21" = _GX4kHmJd;
        "pkg-0.4.5+1.21" = _O5NzJWf4;
        "pkg-0.4.7+1.21.2" = _xF23qxML;
        "default" = _xF23qxML;
    });
