...
let
    ...
    in {
        ...
        "pkg-1.20.1_1.1.2" = _oupc9t71;
        "pkg-1.20.1_1.1.3" = _iDMiaVfl;
        "pkg-1.20.1_1.1.4" = _iec9o43q;
        "pkg-0.0.1-B-1.20.1" = _UUXo42S2;
        "pkg-0.0.2-B-1.20.1" = _AeNfDGjc;
        "pkg-0.0.3-B-1.20.1" = _RFe6UMxl;
        "pkg-0.0.4-B-1.20.1" = _NxbhHVJJ;
        "pkg-0.0.5-B-1.20.1" = _CMVR1k20;
        "pkg-0.1.5-R-1.20.1" = _o5higItL;
        "pkg-0.1.6-R-1.20.1" = _IJxiL7tZ;
        "pkg-0.2.6-R-1.20.1" = _DQtPcrX3;
        "pkg-0.3.6-R-1.20.1" = _bUh6DvrM;
        "pkg-0.3.7-R-1.20.1" = _ftSZ3gkQ;
        "pkg-0.3.8-R-1.20.1" = _AadWmzMW;
        "pkg-0.4.8-R-1.20.1" = _Wr9GqXKT;
        "pkg-0.4.9-R-1.20.1" = _ybJlJlON;
