...
let
    ...
    in {
        ...
        "pkg-1.0.0_fabric" = _2ZhQJdP5;
        "pkg-1.0.1_fabric" = _wOIilPvC;
        "pkg-1.0.2_fabric" = _y4JUULeZ;
        "pkg-1.0.3_fabric" = _Ph0ABXLq;
        "pkg-1.0.4_fabric" = _MQs1oJl2;
        "pkg-1.0.5_fabric" = _OqNSRrUk;
        "pkg-1.0.6_fabric" = _Lu7bzhE1;
        "pkg-1.0.7_fabric" = _16oHi6KH;
        "pkg-1.0.8_fabric" = _Xiro856V;
        "pkg-1.0.0+1.21.1_fabric" = _eSEMwXuu;
        "pkg-1.0.1+1.21.1_fabric" = _VJT0UskL;
        "pkg-1.0.2+1.21.1_fabric" = _VsGKmKuh;
        "pkg-1.0.9_fabric" = _xDsCAHjK;
        "pkg-1.1.0_fabric" = _e5O4mpjO;
        "pkg-1.1.0+1.21.1_fabric" = _266A25yS;
        "pkg-1.1.1+1.21.1_fabric" = _YQpnmSfW;
        "pkg-1.1.1_fabric" = _qZdJw62Q;
        "pkg-1.1.2_fabric" = _E2sOv1ew;
        "pkg-1.1.3_fabric" = _Z3DSXXPH;
        "pkg-1.1.2+1.21.1_fabric" = _bjPvA9Dx;
        "pkg-1.1.4_fabric" = _rqIr8OKr;
        "pkg-1.1.3+1.21.1_fabric" = _I5KAi0sD;
        "pkg-1.1.4+1.21.1_fabric" = _eGt7GfZq;
        "pkg-v1.2.0+1.21.1_neoforge" = _kFdt4760;
        "pkg-v1.2.1+1.21.1_neoforge" = _hhi7u3o9;
        "pkg-v1.2.2+1.21.1_neoforge" = _9oBscWZX;
        "pkg-1.2.2+1.21.1_fabric" = _ICQIhURw;
        "pkg-v1.1.5_fabric" = _OnCgQR7J;
        "pkg-1.2.3+1.21.1_neoforge" = _LQ4yv2U3;
        "default" = _LQ4yv2U3;
    });
