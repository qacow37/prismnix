...
let
    ...
    in {
        ...
        "pkg-0.51" = _aI7MiNxF;
        "pkg-0.7" = _kNRCBegS;
        "pkg-0.71-1.21" = _475HSKsv;
        "pkg-0.71-1.21.1" = _wCaGX1ki;
        "pkg-0.71-1.21.2" = _FTI5x3be;
        "pkg-0.71-1.21.3" = _NGTUzmeD;
        "pkg-0.71-1.21.4" = _zXtXBR7D;
        "pkg-0.71-1.21.5" = _KPRi5ksM;
        "pkg-0.71-1.21.6" = _9ToJ4cEJ;
        "pkg-0.71-1.21.7" = _WbEnkfIS;
        "pkg-0.71-1.21.8" = _J3xJBNds;
        "pkg-0.71-1.21.9" = _fIA6lVVa;
        "pkg-0.71-1.21.10" = _X62B8P3L;
        "pkg-0.71-1.21.11" = _6SBFmpzL;
        "pkg-0.72-1.21.9" = _YEiqQ3cT;
        "pkg-0.72-1.21.10" = _b6UJsZne;
        "pkg-0.72-1.21.11" = _57NzuioC;
        "pkg-1.0" = _2IEtbuwn;
        "pkg-1.0-1.21" = _YkV8NP3a;
        "pkg-1.0-1.21.1" = _a5IplA3M;
        "pkg-1.0-1.21.2" = _UQVV00B8;
        "pkg-1.0-1.21.3" = _fy1pLxgA;
        "pkg-1.0-1.21.4" = _vv9gjtKG;
        "pkg-1.0-1.21.5" = _ziwrNGTv;
        "pkg-1.0-1.21.6" = _pxNotLs1;
        "pkg-1.0-1.21.7" = _qr9rH3bM;
        "pkg-1.0-1.21.8" = _VfP95emX;
        "pkg-1.0-1.21.9" = _43gWbQz8;
        "pkg-1.0-1.21.10" = _Cx7aubJC;
        "pkg-1.0-1.21.11" = _RuNuIvkD;
        "pkg-1.0.1-1.21" = _g4978uVL;
        "pkg-1.0.1-1.21.1" = _CggDmonE;
        "pkg-1.0.1-1.21.2" = _Kh2Zziwt;
        "pkg-1.0.1-1.21.3" = _wzQsa7Zn;
        "pkg-1.0.1-1.21.4" = _w8t3LQsg;
        "pkg-1.0.1-1.21.5" = _ZENfVT8j;
        "pkg-1.0.1-1.21.6" = _kWfM9oGM;
        "pkg-1.0.1-1.21.7" = _jfiH70Nu;
        "pkg-1.0.1-1.21.8" = _Z4USup6I;
        "pkg-1.0.1-1.21.9" = _uyafo8wD;
        "pkg-1.0.1-1.21.10" = _6nSkBg4u;
        "pkg-1.0.1-1.21.11" = _ygx1BCq7;
        "pkg-1.0.1-26.1" = _F5fUJOeY;
        "pkg-1.0.1-1.20.1" = _cfqbNAhY;
        "pkg-1.0.1-1.21-neoforge" = _Zsi4CY8l;
        "pkg-1.0.1-1.21.1-neoforge" = _TQRQiFz0;
        "pkg-1.0.1-1.21.2-neoforge" = _wZ2br1zN;
        "pkg-1.0.1-1.21.3-neoforge" = _1alR86pF;
        "pkg-1.0.1-1.21.4-neoforge" = _uwsvrgi0;
        "pkg-1.0.1-1.21.5-neoforge" = _6KXYTOar;
        "pkg-1.0.1-1.21.6-neoforge" = _fDf1W16H;
        "pkg-1.0.1-1.21.7-neoforge" = _rqIML5qN;
        "pkg-1.0.1-1.21.8-neoforge" = _2Dq54EGz;
