...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.20.1-47.4.10" = _FxP6F9Yt;
        "pkg-1.0.0-fabric-1.21.1-0.116.7" = _XNeczorg;
        "pkg-1.0.0-forge-1.21.1-52.1.5" = _CPglQi6o;
        "pkg-1.0.0-neoforge-1.21.1-21.1.213" = _xZLex6R7;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _eGXXbR3o;
        "pkg-1.0.0-forge-1.21.4-54.1.8" = _d4UXYuoU;
        "pkg-1.0.0-neoforge-1.21.4-21.4.155" = _ZnAHp35R;
        "pkg-1.0.0-fabric-1.21.8-0.136.0" = _WUk7b2DW;
        "pkg-1.0.0-forge-1.21.8-58.1.7" = _nAgOr5Xn;
        "pkg-1.0.0-neoforge-1.21.8-21.8.50" = _GHOBtYYi;
        "pkg-1.0.0-fabric-1.21.10-0.138.0" = _U149AnKV;
        "pkg-1.0.0-forge-1.21.10-60.0.9" = _NtbQEEzh;
        "pkg-1.0.0-neoforge-1.21.10-21.10.47-" = _SZgUNeUg;
        "pkg-1.1.0-forge-1.20.1-47.4.10" = _PVeJsGbw;
        "pkg-1.0.0-neoforge-1.21.11-21.11.10b" = _VdLAVBIE;
        "pkg-1.0.0-fabric-1.21.11-0.140.0" = _JYTKvfgB;
        "pkg-1.0.0-forge-1.21.11-61.0.2" = _2Ax2fJaY;
        "pkg-1.2.0-forge-1.20.1-47.4.10" = _QBRDGL2b;
        "pkg-1.2.1-forge-1.20.1-47.4.10" = _iq5inGlx;
        "pkg-1.2.1-forge-26.1.2-64.0.0" = _4W8LkMEW;
        "pkg-1.2.1-neoforge-26.1.2.43" = _bf0UYgSl;
        "pkg-1.2.1-fabric-26.1.2-0.148.0" = _172HWgIn;
        "pkg-1.2.1-fabric-26.2-0.152.2" = _OTWrGIVe;
        "pkg-1.2.1-forge-26.2-65.0.0" = _nrtOZeNS;
        "pkg-1.2.1-neoforge-26.2.0.3" = _nehxJOuB;
        "default" = _nehxJOuB;
    });
