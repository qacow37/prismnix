...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _ZwefUGJ4;
        "pkg-2.0.0" = _luUHWTpP;
        "pkg-2.0.0-LVL1" = _RKQ0PuUH;
        "pkg-2.0.0-LVL100" = _U0CJC3nW;
        "pkg-3.0.0" = _AALdqe9p;
        "pkg-4.0.0" = _uC0vmb4o;
        "pkg-5.0.0" = _1dHveAbU;
        "pkg-6.0.0" = _bRbUPsLL;
        "pkg-6.0.1" = _QuZovQiq;
        "pkg-6.0.2" = _VU2sqWN6;
        "pkg-7.0.0-neoforge" = _koMLA07n;
        "pkg-7.0.0-fabric" = _d7MaobLM;
        "pkg-8.0.0-neoforge" = _IWZMvuvp;
        "pkg-8.0.0" = _FtaeFeHZ;
        "pkg-8.0.1-neoforge" = _idC3WdY3;
        "pkg-8.0.1-fabric" = _3Ya9K2uZ;
        "pkg-8.0.2-fabric" = _cbG9GcJt;
        "pkg-8.0.2-Neoforge" = _5aJXOyuH;
        "pkg-8.0.3-fabric" = _Zw488Kho;
        "pkg-8.0.3-Neoforge" = _FK5r87A8;
        "pkg-9.0.0-Fabric" = _9Lawc9wI;
        "pkg-9.0.0" = _F9638IkA;
        "default" = _F9638IkA;
    });
