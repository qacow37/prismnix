...
let
    ...
    in {
        ...
        "pkg-0.1-1.20.1" = _sdV9mhwM;
        "pkg-0.2-1.20.1" = _LOOR7sO2;
        "pkg-0.3-1.20.1" = _A3ymvnOC;
        "pkg-0.4-1.20.1" = _loxozPpE;
        "pkg-0.5-1.20.4" = _45EheXDY;
        "pkg-0.6-1.20.4" = _Zi3V2ZsR;
        "pkg-0.7-1.20.4" = _6e9ltQBv;
        "pkg-0.8-1.20.4" = _WvRYMTBF;
        "pkg-0.9-1.20.4" = _AXzu4RUg;
        "pkg-0.10-1.20.4" = _x9D2dIpz;
        "pkg-0.11-1.20.4" = _9V5CaqfD;
        "pkg-0.12-1.20.4" = _oiuTfmqb;
        "pkg-0.13-1.20.4" = _cJhXphG3;
        "pkg-0.14-1.20.4" = _d9XEyioX;
        "pkg-0.15-1.20.4" = _FgXl9hox;
        "pkg-0.16-1.20.4" = _jsfYk4Ni;
        "pkg-0.17-1.20.4" = _7ZwX4DkI;
        "pkg-0.18-1.20.4" = _SS9EWEhS;
        "pkg-0.19-1.20.4" = _ym0wFipz;
        "pkg-0.20-1.20.4" = _dMrxSW07;
        "pkg-0.21-1.20.4" = _46Nz7XV8;
        "pkg-0.22-1.20.4" = _mZoqHsJN;
        "pkg-0.23-1.20.4" = _pACNIpzs;
        "pkg-0.24-1.20.4" = _2h49uq7x;
        "pkg-0.25-1.20.4" = _DDCJOo2z;
        "pkg-0.0.1" = _3TcNePuS;
        "pkg-0.0.2" = _rlKaJwVN;
        "pkg-0.0.3" = _nsLe2QL4;
        "pkg-0.0.4" = _wVWxALNP;
