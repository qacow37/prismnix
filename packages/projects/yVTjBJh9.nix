...
let
    ...
    in {
        ...
        "pkg-1.4.0.1-1.18.2" = _x2Ep8ROT;
        "pkg-1.4.0.1-1.19.2" = _NqbY81Fi;
        "pkg-1.4.0.1-1.20.1" = _rIG0WK0e;
        "pkg-1.4.0.2-1.18.2" = _5eulwISj;
        "pkg-1.4.0.2-1.19.2" = _Tipflmda;
        "pkg-1.4.0.2-1.20.1" = _YIaOUVIr;
        "pkg-1.4.0.3-1.18.2" = _BBSQsrBV;
        "pkg-1.4.0.3-1.19.2" = _peZ4if0Q;
        "pkg-1.4.0.3-1.20.1" = _NdUQ9owr;
        "pkg-1.4.0.4-1.18.2" = _su7909Jf;
        "pkg-1.4.0.4-1.19.2" = _IdWPZfBm;
        "pkg-1.4.0.4-1.20.1" = _mg0MGth4;
        "pkg-1.4.0.5-1.18.2" = _1OcdPW56;
        "pkg-1.4.0.5-1.19.2" = _ICeNUR77;
        "pkg-1.4.0.5-1.20.1" = _Csfuv5Po;
        "pkg-1.4.0.6-1.18.2" = _u85G9Eh8;
        "pkg-1.4.0.6-1.19.2" = _8h5jtT3o;
        "pkg-1.4.0.6-1.20.1" = _xCzPFMih;
        "pkg-1.4.1.0-1.18.2" = _1Uaav53e;
        "pkg-1.4.1.0-1.19.2" = _ZGc74gQl;
        "pkg-1.4.1.0-1.20.1" = _9lNCL21Z;
        "pkg-1.4.2.0-1.18.2" = _8s4VbBy6;
        "pkg-1.4.2.0-1.19.2" = _xIxsSxZb;
        "pkg-1.4.2.0-1.20.1" = _TTsnrMi9;
        "pkg-1.4.2.1-1.18.2" = _5WEkFp9m;
        "pkg-1.4.2.1-1.19.2" = _gdqJW1vN;
        "pkg-1.4.2.1-1.20.1" = _SHy3tak1;
        "pkg-1.4.2.2-1.18.2" = _mDnJJbUJ;
        "pkg-1.4.2.2-1.19.2" = _PZX0G6ty;
        "pkg-1.4.2.2-1.20.1" = _8vtFRJkk;
        "pkg-2.0-1.20.1" = _Cg6awGhh;
        "pkg-2.0.1-1.20.1" = _Niba3nD2;
        "default" = _Niba3nD2;
    });
