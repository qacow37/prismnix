...
let
    ...
    in {
        ...
        "pkg-1.1.8" = _MqojWR9b;
        "pkg-1.1.9" = _IGYA2ysE;
        "pkg-1.1.10" = _Pz0nnUxx;
        "pkg-1.1.11" = _hMXBIVkN;
        "pkg-1.1.12" = _Uan3Qzxx;
        "pkg-1.1.13" = _iynnEURl;
        "pkg-1.1.14" = _djY6s7JL;
        "pkg-1.1.15" = _APcfoGRC;
        "pkg-1.1.16" = _51W5FirH;
        "pkg-1.1.17" = _FxaVUHLj;
        "pkg-1.1.17HF" = _gff4h4r5;
        "pkg-1.1.18" = _GCidVC7O;
        "pkg-1.1.19" = _plZPN6m6;
        "pkg-1.1.20" = _cxzZDKPu;
        "pkg-1.1.20b" = _B7bo3bdE;
        "pkg-1.1.21" = _T9TPXJr8;
        "pkg-1.1.22" = _7d2DazOK;
        "pkg-1.1.23" = _1ZN9srzE;
        "pkg-2.0.0" = _Fj4sOKZX;
        "pkg-2.0.1" = _ZqYqL1tc;
        "pkg-2.0.2" = _dwmiSKiz;
        "pkg-2.0.3" = _T0MJy8Pu;
