...
let
    ...
    in {
        ...
        "pkg-3.1-1.19" = _bDShWmlk;
        "pkg-3.1.2-1.19" = _KxfsOmjr;
        "pkg-3.1.3-1.19" = _Vg727Ked;
        "pkg-3.4.3-1.20.1" = _noAl23LW;
        "pkg-3.5-1.20.1" = _zrhJUHEt;
        "pkg-3.5.1-1.20.1" = _ihuRSqOU;
        "pkg-3.5.2-1.20.1" = _tbDBi4m9;
        "pkg-3.5.4-1.20.1" = _RHlR4idq;
        "pkg-3.5.6-1.20.1" = _ozSPgWCd;
        "pkg-3.5.7-1.20.1" = _TeloIrF5;
        "pkg-3.5.8-1.20.1" = _1mJHBnkb;
        "pkg-3.5.9-1.20.1" = _E2BNWtJP;
        "pkg-3.6-1.20.1" = _w2tiYDkm;
        "pkg-3.6.1-1.20.1" = _Po9ii7gt;
        "pkg-3.6.2-1.20.1" = _1k0UH9LB;
        "pkg-3.4.1-1.19.2" = _3kuWUhts;
        "pkg-3.7-1.20.1" = _uzEVmDrN;
        "pkg-3.7.1-1.20.1" = _emlcyGrq;
        "pkg-3.7.2-1.20.1" = _qq76Sfi9;
        "pkg-3.7.3-1.20.1" = _8S1xBpBG;
        "pkg-3.7.4-1.20.1" = _UPHQzLuK;
        "pkg-3.7.6-1.20.1" = _VeYJRbNt;
        "pkg-3.7.7-1.20.1" = _fToCdb3j;
        "pkg-3.7.8-1.20.1" = _BVRaaYM8;
        "pkg-3.8-1.20.1" = _rStJtk6A;
        "pkg-3.8.1-1.20.1" = _HbEQIqIu;
        "default" = _HbEQIqIu;
    });
