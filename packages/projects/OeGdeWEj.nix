...
let
    ...
    in {
        ...
        "pkg-1.20.1-0.1.0" = _igjjEG4r;
        "pkg-1.20.1-0.1.1" = _e0USi8HV;
        "pkg-1.20.1-0.1.2" = _jI2u4E8k;
        "pkg-1.19.2-0.1.2" = _Tuk4Xrqa;
        "pkg-1.20.1-0.1.3" = _psUHVUSX;
        "pkg-1.19.2-0.1.3" = _HQXlvJaI;
        "pkg-1.19.2-0.2.0" = _QYol3gvb;
        "pkg-1.20.1-0.2.0" = _mOgWkw6t;
        "pkg-1.19.2-hahafunny-2024" = _kAER4UXa;
        "pkg-1.20.1-hahafunny-2024" = _p1v3RwSC;
        "pkg-1.20.1-0.2.1" = _hhy5ovwL;
        "pkg-0.2.2" = _1kTUqcJk;
        "pkg-0.2.3" = _BUK0p8gn;
        "pkg-0.2.4" = _awG57F4h;
        "pkg-0.2.4.1" = _KWEbEgub;
        "pkg-0.2.5" = _VUdHbcQD;
        "pkg-0.2.5.1" = _kpXFsE6k;
        "pkg-1.21.1-0.2.6" = _w1yMnvhH;
        "pkg-0.2.7" = _ftxhklU0;
        "pkg-1.21.1-0.3.0" = _iAEexZWm;
        "pkg-0.3.1" = _uwHdfMVO;
        "pkg-1.21.1-0.3.2" = _k45xNmP8;
        "pkg-1.21.1-0.3.3" = _ER6Bstvi;
        "pkg-1.21.1-0.3.4" = _7GTctTm8;
        "pkg-1.21.1-0.3.5" = _PhsfUFXT;
        "pkg-1.21.1-0.4.0" = _QiPzQxzl;
        "pkg-1.21.1-0.4.1" = _mH7u4nCX;
        "pkg-1.20.1-0.4.0" = _UnSWSeqq;
        "pkg-1.20.1-0.4.1" = _CCm9fz6v;
        "pkg-1.20.1-0.4.2" = _LTOnyKql;
        "pkg-1.21.1-0.4.2" = _kQdA7Ygy;
        "pkg-1.21.1-0.5.0-beta" = _YoUVUmtF;
        "pkg-1.21.1-0.5.0" = _BRpxKyDt;
        "pkg-1.21.1-0.5.1-pre1" = _K1xkNKKf;
        "default" = _K1xkNKKf;
    });
