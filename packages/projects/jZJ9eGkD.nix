...
let
    ...
    in {
        ...
        "pkg-1.2.1+1.19.3" = _rLWlJOMe;
        "pkg-1.2.1+1.19.4" = _eQS96nd7;
        "pkg-1.2.1+1.19-2" = _mey5KtRW;
        "pkg-1.2.1.1+1.19.3" = _AjLO4NCJ;
        "pkg-1.2.1.2+1.19" = _1RWZtTjJ;
        "pkg-1.2.1.2+1.19.3" = _RRvmBL2C;
        "pkg-1.2.1.3+1.19.4" = _NLCP42xN;
        "pkg-1.2.2+1.19-2" = _gMOM80JK;
        "pkg-1.2.2+1.19.3" = _cfZPx3pE;
        "pkg-1.2.2+1.19.4" = _uj4p8frK;
        "pkg-1.2.3+1.19-2" = _gEzJGB0n;
        "pkg-1.2.3+1.19.3" = _6g44WhuH;
        "pkg-1.2.3+1.19.4" = _is2XhIcO;
        "pkg-1.2.4+1.19-2" = _G0m6dz0t;
        "pkg-1.2.4+1.19.3" = _wtPS36hZ;
        "pkg-1.2.4+1.19.4" = _vEj81m1U;
        "pkg-1.2.5+1.19-2" = _VsboyaDg;
        "pkg-1.2.5+1.19.3" = _f0REwOxD;
        "pkg-1.2.5+1.19.4" = _VoW4VYrm;
        "pkg-1.2.5+1.20-1" = _NxqbRdiU;
        "pkg-1.2.6+1.19-2" = _ifBgWq8y;
        "pkg-1.2.6+1.19.3" = _dWTmSojE;
        "pkg-1.2.6+1.19.4" = _IBnk1JAq;
        "pkg-1.2.6+1.20-1" = _kT622yti;
        "pkg-1.2.7+1.20-1" = _FCsIO7VJ;
        "pkg-1.2.7+1.20.2" = _W3yUkFOz;
        "pkg-2.0.0-aprilfooledition" = _jdYOkNnX;
        "default" = _jdYOkNnX;
    });
