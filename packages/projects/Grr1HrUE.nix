...
let
    ...
    in {
        ...
        "pkg-7.0.1-forge" = _AfB53gu9;
        "pkg-7.0.1-fabric" = _RGEqrJjd;
        "pkg-7.0.2-forge" = _hOciAuDX;
        "pkg-7.1.0-fabric" = _vkaaHUDd;
        "pkg-7.1.0-forge" = _oVTj1FXB;
        "pkg-7.1.1-forge" = _HAVPQXe5;
        "pkg-7.1.1-fabric" = _xIPLdJ6I;
        "pkg-7.1.2-forge" = _UYbIgpFw;
        "pkg-7.1.2-fabric" = _sNHPYYGs;
        "pkg-7.2.0-fabric" = _9JraJKYb;
        "pkg-7.2.0-forge" = _7y63Ac7Q;
        "pkg-7.2.1-forge" = _yTUjNBmn;
        "pkg-7.2.1-fabric" = _tVGYkZmq;
        "pkg-8.0.0-forge" = _TGcWWLNj;
        "pkg-8.0.0-fabric" = _P3vNl3YJ;
        "pkg-8.1.0-fabric" = _TCTAKWfT;
        "pkg-8.1.1-forge" = _UyIlG81R;
        "pkg-8.1.1-fabric" = _D1IqnEps;
        "pkg-8.1.1-neoforge" = _aJ06bOYr;
        "pkg-8.1.2-forge" = _WQKP70Lj;
        "pkg-8.1.2-neoforge" = _OGEpgCjr;
        "pkg-8.1.2-fabric" = _4hXpDdwW;
        "pkg-8.1.3-neoforge" = _fL7XLto9;
        "pkg-8.1.3-fabric" = _BxTvs6Zm;
        "pkg-9.0.0-neoforge" = _h5KwGWEh;
        "pkg-9.0.0-fabric" = _qt7jWpqZ;
        "pkg-9.0.1-neoforge" = _1uJ78umg;
        "pkg-9.0.1-fabric" = _fUBmLCXf;
        "pkg-9.0.2-neoforge" = _6vUWuuRR;
        "pkg-9.0.2-fabric" = _777Jsq1n;
        "pkg-9.1.0-neoforge" = _axwkZI2P;
        "pkg-9.1.0-fabric" = _DpOicX2g;
        "pkg-9.1.1-neoforge" = _pi4Wfejt;
        "pkg-9.1.1-fabric" = _jZlkKzBi;
        "pkg-0.0.1-fabric" = _ACM8JSYE;
        "pkg-0.0.1-neoforge" = _WXlCikiz;
        "pkg-9.1.2-neoforge" = _8jnShXen;
        "pkg-9.1.2-fabric" = _gEQuz9Go;
        "pkg-26.2.0-neoforge" = _X6U0lObw;
