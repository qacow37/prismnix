...
let
    ...
    in {
        ...
        "pkg-1.5.0" = _DsM4h2NC;
        "pkg-1.5.1" = _QvyNGoXR;
        "pkg-v1.6.0" = _AJbopOe8;
        "pkg-v1.7.0" = _8EeoseVv;
        "pkg-v1.8.0" = _fSMdKHnD;
        "pkg-v2.0.0" = _NNFXP5Em;
        "pkg-v2.0.1" = _zZbe6bmz;
        "pkg-v2.1.0-1.19" = _8I5GlkLo;
        "pkg-v2.1.0-1.19.1" = _N2K8SB37;
        "pkg-v2.2.0" = _yAhLZCaA;
        "pkg-v2.3.0" = _YQgIbodn;
        "pkg-2.2.1" = _O9PduD1t;
        "pkg-2.3.1" = _ivOFjKKS;
        "pkg-2.4.0" = _g7MdGTEW;
        "pkg-2.4.1" = _fczwsA7x;
