...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0-fabric+forge+neo" = _cHL1CS1o;
        "pkg-1.19.2-1.1-fabric+forge+neo" = _a3dtyZfR;
        "pkg-1.20.1-1.1-fabric+forge+neo" = _GoTdCMud;
        "pkg-1.20.2-1.1-fabric+forge+neo" = _dB4fxqoG;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _oLizkBGz;
        "pkg-1.19.2-1.2-fabric+forge+neo" = _6hElcHL6;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _cLC1hpBV;
        "pkg-1.20.2-1.2-fabric+forge+neo" = _Iz7fdn40;
        "pkg-1.20.4-1.2-fabric+forge+neo" = _bZgkgRk3;
        "pkg-1.19.2-1.3-fabric+forge" = _BUHF2FkC;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _6x4qhRzO;
        "pkg-1.20.2-1.3-fabric+forge+neo" = _i3sPu2Cj;
        "pkg-1.20.4-1.3-fabric+forge+neo" = _u1nHGfJO;
        "pkg-1.19.2-2.0-fabric+forge" = _lMQ6F40T;
        "pkg-1.20.1-2.0-fabric+forge+neo" = _USMSMjUl;
        "pkg-1.20.4-2.0-fabric+forge+neo" = _ECGqsQmu;
        "pkg-1.20.5-2.0-fabric+neo" = _U03zfbcn;
        "pkg-1.20.5-2.1-fabric+neo" = _s1s5QkHL;
        "pkg-1.20.6-2.1-fabric+forge+neo" = _Np1ryVPe;
        "pkg-1.21.0-2.1-fabric+forge+neo" = _8Ze74NZx;
        "pkg-1.20.1-2.2-fabric+forge+neo" = _6Wh10nby;
        "pkg-1.20.6-2.2-fabric+forge+neo" = _QgNSzLyv;
        "pkg-1.21.0-2.2-fabric+forge+neo" = _xVPOWITm;
        "pkg-1.21.1-2.2-fabric+forge+neo" = _oHGdPeTh;
        "pkg-1.21.2-2.2-fabric+neo" = _l5Q2kXtQ;
        "pkg-1.21.3-2.2-fabric+forge+neo" = _kdpF3pap;
        "pkg-1.21.4-2.2-fabric+forge+neo" = _sHLRjZ8y;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _lG7yJmqX;
        "pkg-1.21.1-2.3-fabric+forge+neo" = _KvWMLqgJ;
        "pkg-1.21.4-2.3-fabric+forge+neo" = _NRTWBflX;
        "pkg-1.21.5-2.3-fabric+forge+neo" = _ciCoRtmL;
        "pkg-1.21.6-2.3-fabric+forge+neo" = _HpRlYpji;
        "pkg-1.21.7-2.3-fabric+forge+neo" = _FVp56vRh;
        "pkg-1.21.8-2.3-fabric+forge+neo" = _zWApvNML;
        "pkg-1.21.9-2.3-fabric+forge+neo" = _SuYyIrNw;
        "pkg-1.21.9-2.4-fabric+forge+neo" = _C3uiK8Ap;
        "pkg-1.21.10-2.4-fabric+forge+neo" = _ZmECzne0;
        "pkg-1.21.11-2.4-fabric+forge+neo" = _ff4vUThz;
        "pkg-26.1.0-2.4-fabric+forge+neo" = _dDvUJIsM;
