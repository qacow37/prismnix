...
let
    ...
    in {
        ...
        "pkg-43.0.6+forge" = _bbTphBF8;
        "pkg-43.0.7+forge" = _sAQIykRf;
        "pkg-43.0.7+fabric" = _kFmr8VlQ;
        "pkg-43.0.8+fabric" = _6yalgGyU;
        "pkg-43.0.8+forge" = _Pgh5xhPc;
        "pkg-43.0.9+fabric" = _6SdxpRxH;
        "pkg-43.0.9+forge" = _XvQkrAUe;
        "pkg-44.0.0+fabric" = _twKEnpq1;
        "pkg-44.0.0+forge" = _SuweEIyj;
        "pkg-45.0.0+fabric" = _beqCEmCU;
        "pkg-45.0.0+forge" = _zjgWyeey;
        "pkg-46.0.0+fabric" = _esUJXOAe;
        "pkg-46.0.0+forge" = _girTvaWY;
        "pkg-46.0.1+fabric" = _WGgwyPQ7;
        "pkg-46.0.1+forge" = _AW12GfDC;
        "pkg-46.0.2+fabric" = _DoWzl1gH;
        "pkg-46.0.2+forge" = _qFTRtOKP;
        "pkg-neoforge-mc1.21-v1.0.0" = _CLAfa4xT;
        "pkg-fabric-mc1.21-v1.0.0" = _OYzSDEtm;
        "pkg-fabric-mc1.21-v1.0.2" = _4PR6B7zr;
        "pkg-neoforge-mc1.21-v1.0.2" = _TBepPlOM;
        "pkg-43.1.0+fabric" = _M6eHEuCQ;
        "pkg-43.1.0+forge" = _BXLhrXcC;
        "pkg-forge-1.19.2-43.1.1" = _rQcMhnuD;
        "pkg-fabric-1.19.2-43.1.1" = _VgGKxfTQ;
        "pkg-fabric-1.19.2-43.1.2" = _Jibu6q2x;
        "pkg-forge-1.19.2-43.1.2" = _JLfptoMp;
        "pkg-46.1.0+fabric" = _1rNzfPHA;
        "pkg-46.1.0+forge" = _Iy7JoaWy;
        "pkg-forge-1.19.2-43.1.3" = _lbI6c7Ez;
        "pkg-fabric-1.19.2-43.1.3" = _Z6SmYCut;
        "pkg-46.0.4+forge" = _cQ0o2JEb;
        "pkg-46.0.4+fabric" = _jU3mJKAK;
        "pkg-fabric-1.19.2-43.1.4" = _fvePB6WG;
        "pkg-forge-1.19.2-43.1.4" = _Hr1VxALz;
        "pkg-fabric-1.19.2-43.1.5" = _rrQMMxn4;
        "pkg-forge-1.19.2-43.1.5" = _hPpqMWqn;
        "pkg-46.1.5+fabric" = _m9j7sYEQ;
