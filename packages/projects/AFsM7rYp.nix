...
let
    ...
    in {
        ...
        "pkg-v20210825" = _NEDZ40Oi;
        "pkg-v20220127" = _mnVyLH3h;
        "pkg-v20220803" = _9KeQuSgc;
        "pkg-1.16.x-20230304" = _etZoRroA;
        "pkg-1.17-1.19-20230404" = _aZ5JuRXV;
        "pkg-1.20-20230725" = _EbGT4vsB;
        "pkg-1.21.2-20250126" = _SBznREKR;
        "default" = _SBznREKR;
    });
