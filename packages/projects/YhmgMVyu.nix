...
let
    ...
    in {
        ...
        "pkg-1.12.2-v1.5.3.2" = _Y2AjVtQC;
        "pkg-1.7.10-v1.1.2.2" = _GRS6HOna;
        "pkg-1.19.4-1.0.0-beta.1-forge" = _r7EYVQoA;
        "pkg-1.19.4-1.0.0-beta.2-forge" = _WzN9EYXR;
        "pkg-1.19.4-1.0.0-beta.3-forge" = _ZoOsJhXt;
        "pkg-1.19.4-1.0.0-beta.4-forge" = _HRWVA0lM;
        "pkg-b1.7.3-1.02" = _4xnRiSYg;
        "pkg-1.0.0-1.04_1" = _mlFepX3U;
        "pkg-1.2.5-1.9-pre_release" = _xOpxDRhA;
        "pkg-1.19.4-1.0.0-beta.5-forge" = _EBNBaJel;
        "pkg-1.19.4-1.0.0-beta.5.1-forge" = _Jc2hNfUa;
        "pkg-1.19.4-1.0.0-beta.6-forge" = _dGQqA9su;
        "pkg-1.19.4-1.0.0-beta.6.1-forge" = _h01xbBRw;
        "pkg-1.19.2-1.0.0-beta.1-forge" = _aCaJ8aBC;
        "pkg-1.20.1-1.0.0-beta.1-neoforge" = _iB2YuqqI;
        "pkg-1.20.1-1.0.0-beta.1.1-neoforge" = _CK5hBPBL;
        "pkg-1.20.1-1.0.0-beta.1.2-neoforge" = _TvtkAwqS;
        "pkg-1.19.4-1.0.0-beta.6.2-forge" = _PpLPVcL4;
        "pkg-1.19.2-1.0.0-beta.1.1-forge" = _RTNrxnIL;
        "pkg-1.20.1-1.0.0-beta.1.3-neoforge" = _nI1C8SsD;
        "pkg-1.19.4-1.0.0-beta.6.3-forge" = _GMPoVcnM;
        "pkg-1.19.2-1.0.0-beta.1.2-forge" = _pVO2ur9f;
        "pkg-1.19.2-1.0.0-beta.1.3-forge" = _kt65nplT;
        "pkg-1.19.4-1.0.0-beta.6.4-forge" = _Uky6nSGz;
        "pkg-1.20.1-1.0.0-beta.1.4-neoforge" = _VItLcc9a;
        "pkg-1.19.2-1.0.0-beta.2-forge" = _n4vXCuNO;
        "pkg-1.19.4-1.0.0-beta.7-forge" = _c1JcBELZ;
        "pkg-1.20.1-1.0.0-beta.2-neoforge" = _oFts6eUq;
        "pkg-1.20.1-1.0.0-beta.2.1-neoforge" = _aazX8Jbo;
        "pkg-1.19.2-1.0.0-beta.2.1-forge" = _jx6VelcO;
        "pkg-1.19.4-1.0.0-beta.7.1-forge" = _njGjeEg9;
        "pkg-1.20.1-1.0.0-beta.2.2-neoforge" = _RHNHmZVx;
        "pkg-1.19.4-1.0.0-beta.7.2-forge" = _6hNGvPsF;
        "pkg-1.19.2-1.0.0-beta.2.2-forge" = _BfH48XIP;
        "pkg-1.20.1-1.0.0-neoforge" = _XDQGJb0B;
        "pkg-1.19.4-1.0.0-forge" = _Ox6y4Ts4;
        "pkg-1.19.2-1.0.0-forge" = _fDwmVUwl;
        "pkg-1.7.10-v1.1.2.3" = _4NuI8eHN;
        "pkg-1.12.2-v1.5.3.3" = _NaO5rVDh;
        "pkg-1.19.2-1.1.0-forge" = _UV3IuTH2;
        "pkg-1.20.1-1.1.0-neoforge" = _6caduFoz;
        "pkg-1.19.4-1.1.0-forge" = _qbstCw56;
        "pkg-1.12.2-v1.5.4.0" = _QFs0l4dS;
        "pkg-1.19.4-1.2.0-forge" = _CzXJ4LKP;
        "pkg-1.20.1-1.2.0-neoforge" = _Ut5cSfTf;
        "pkg-1.19.2-1.2.0-forge" = _TGG7G2Y6;
        "pkg-1.19.2-1.3.0-forge" = _IDfFQQJy;
        "pkg-1.19.4-1.3.0-forge" = _aVXzN04o;
        "pkg-1.20.1-1.3.0-neoforge" = _KHopDWN0;
        "pkg-1.20.2-1.3.0-neoforge" = _mbr48PlM;
        "pkg-1.19.4-1.3.1-forge" = _D2z8c0y0;
        "pkg-1.19.2-1.3.1-forge" = _UModtnbT;
        "pkg-1.20.2-1.3.1-neoforge" = _YamjzGxS;
        "pkg-1.20.1-1.3.1-neoforge" = _uoBgPC5f;
        "pkg-1.20.2-1.3.2-neoforge" = _TrREfREX;
        "pkg-1.19.2-1.4.0-forge" = _a1SWKdnq;
        "pkg-1.19.4-1.4.0-forge" = _RhVexY3F;
        "pkg-1.20.1-1.4.0-neoforge" = _Hngr5en8;
        "pkg-1.20.2-1.4.0-neoforge" = _17RrlpXt;
        "pkg-1.20.4-1.4.0-neoforge" = _9Mqr9Mxm;
        "pkg-1.19.2-1.4.1-forge" = _5bya9Ku1;
        "pkg-1.20.4-1.4.1-neoforge" = _rHmg5bDg;
        "pkg-1.20.2-1.4.1-neoforge" = _EUWG75tb;
        "pkg-1.20.1-1.4.1-neoforge" = _zC37kgR3;
        "pkg-1.19.4-1.4.1-forge" = _v4vlO89S;
        "pkg-1.19.2-1.4.2-forge" = _h8VKO9w6;
        "pkg-1.19.4-1.4.2-forge" = _EJrke2c1;
        "pkg-1.20.2-1.4.2-neoforge" = _nnegklmN;
        "pkg-1.20.1-1.4.2-neoforge" = _1iMxKMqa;
        "pkg-1.19.4-1.5.0-forge" = _9yTJE5u1;
        "pkg-1.20.4-1.5.0-neoforge" = _E6hL7Y4e;
        "pkg-1.19.2-1.5.0-forge" = _cm5EsdIg;
        "pkg-1.20.2-1.5.0-neoforge" = _Qts3bX5Y;
        "pkg-1.20.1-1.5.0-neoforge" = _J8q0a1d1;
        "pkg-1.7.10-v1.1.2.4" = _JuRUkodk;
        "pkg-1.7.10-v1.1.2.5" = _sDnmimXy;
        "pkg-1.19.4-1.5.1-forge" = _n02lF3gK;
        "pkg-1.19.2-1.5.1-forge" = _2w4abCet;
        "pkg-1.20.1-1.5.1-neoforge" = _X1JOPxMW;
        "pkg-1.20.2-1.5.1-neoforge" = _fB3r0amQ;
        "pkg-1.20.4-1.5.1-neoforge" = _lUPGijKt;
        "pkg-1.21.1-1.5.1-beta.1-neoforge" = _YgLW68wk;
        "pkg-1.21.1-1.5.1-beta.1-fabric" = _sxzEQsL5;
        "pkg-1.21.1-1.5.1-beta.2-fabric" = _z1s63Cdk;
        "pkg-1.21.1-1.5.1-beta.2-neoforge" = _RQB4ErgX;
        "pkg-1.21.1-1.5.1-beta.3-fabric" = _zNTjCnSr;
        "pkg-1.21.1-1.5.1-beta.3-neoforge" = _r6ZmPaFu;
        "pkg-1.21.1-1.5.1-beta.4-fabric" = _ZTfYLQjb;
        "pkg-1.21.1-1.5.1-beta.5-fabric" = _q3pJ65WY;
        "pkg-1.21.1-1.5.1-beta.4-neoforge" = _rYgoIjWF;
        "pkg-1.21.1-1.5.1-neoforge" = _avwuXE17;
        "pkg-1.21.1-1.5.1-fabric" = _lDKOXpkh;
        "pkg-1.21.1-1.5.2-neoforge" = _2l5YhaWR;
        "pkg-1.21.1-1.5.2-fabric" = _6spHgcDS;
        "pkg-1.21.1-1.5.3-fabric" = _l4xzX4rK;
        "pkg-1.21.1-1.5.3-neoforge" = _SpinsIaR;
        "pkg-1.20.1-1.5.2-neoforge" = _2411kUqF;
        "pkg-1.21.1-1.5.4-fabric" = _1nK76kxL;
        "pkg-1.21.1-1.5.4-neoforge" = _rB4LuqyZ;
        "pkg-1.20.1-1.5.2-beta.1-fabric" = _AAlNeEOR;
        "pkg-1.20.1-1.5.2-beta.2-fabric" = _BsVTvSbX;
        "pkg-1.20.1-1.5.2-beta.3-fabric" = _D38wHqZa;
        "pkg-1.20.1-1.5.2-beta.4-fabric" = _E4dcgfhG;
        "pkg-1.20.1-1.5.2-beta.5-fabric" = _BicqJDEP;
        "pkg-1.21.1-1.5.5-neoforge" = _VVvQ202L;
        "pkg-1.21.1-1.5.5-fabric" = _WIj13N2L;
        "pkg-1.21.1-1.5.6-fabric" = _bCmdnolT;
        "pkg-1.20.1-1.5.2-beta.6-fabric" = _yIiTWh0n;
        "pkg-1.21.1-1.5.6-neoforge" = _OqzgzB6t;
        "pkg-1.20.1-1.5.2-beta.7-fabric" = _2wEByYxA;
        "pkg-1.12.2-v1.5.4.1" = _y1tzlBx9;
        "pkg-1.21.1-1.5.7-fabric" = _rd0OgLze;
        "pkg-1.21.1-1.5.7-neoforge" = _TR8mPMWa;
        "pkg-1.21.1-1.5.8-neoforge" = _IOyjRzWX;
        "pkg-1.20.1-1.5.2-beta.8-fabric" = _vRtYRS6T;
        "pkg-1.21.1-1.5.8-fabric" = _Rnyb9mDy;
        "pkg-1.20.1-1.5.2-beta.9-fabric" = _d0gCQ3in;
        "pkg-1.21.1-1.5.9-fabric" = _xwFWoRKw;
        "pkg-1.21.1-1.5.9-neoforge" = _cyAfXgWf;
        "pkg-1.21.1-1.5.10-neoforge" = _K5X5qMwG;
        "pkg-1.21.1-1.5.10-fabric" = _kETmh8mQ;
        "pkg-1.21.1-1.5.11-fabric" = _NSqdh1i9;
        "default" = _NSqdh1i9;
    });
