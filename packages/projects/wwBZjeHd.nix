...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.16.5" = _qhtOzybx;
        "pkg-1.0.1+1.18.2" = _qVQ32FZh;
        "pkg-1.0.1+1.19.2" = _427pj401;
        "pkg-1.0.1+1.19.4" = _xDxDiEjD;
        "pkg-1.0.1+1.20.1" = _hubzMixh;
        "pkg-1.0.1+1.20.2" = _M5CAIOVH;
        "pkg-1.0.1+1.20.4" = _EKHTibve;
        "pkg-1.0.1+1.21-1.21.4" = _zE7k1wPP;
        "pkg-1.0.1+1.21.5" = _yiVl75Vh;
        "pkg-1.0.1+1.21.6" = _L7S4kkSq;
        "pkg-1.0.1+1.21.7-1.21.8" = _iAb1kukE;
        "pkg-1.0.1+1.21.9-1.21.10" = _nYGHGIYB;
        "pkg-1.0.1+1.21.11" = _12JpLnrv;
        "pkg-1.1.0+1.21-1.21.4" = _bfERkiT2;
        "pkg-1.1.0+1.21.5-1.21.6" = _yUE5XB4F;
        "pkg-1.1.0+1.21.7-1.21.8" = _AeAh5SjA;
        "pkg-1.1.0+1.21.9-1.21.11" = _OUo5l1NT;
        "pkg-1.1.0+26.1-26.1.2" = _56ecNAOp;
        "pkg-1.2.0+1.21-1.21.4" = _DqEER04n;
        "pkg-1.2.0+1.21.5-1.21.6" = _YuAZWLZu;
        "pkg-1.2.0+1.21.7-1.21.8" = _CXtnkw7x;
        "pkg-1.2.0+1.21.9-1.21.11" = _RK2fCyTf;
        "pkg-1.2.0+26.1-26.1.2" = _bPJeZmeM;
        "pkg-1.2.1+1.21-1.21.4" = _Gyb0nPm0;
        "pkg-1.2.1+1.21.5-1.21.6" = _evQ9zwQg;
        "pkg-1.2.1+1.21.7-1.21.8" = _Xa5X69Bg;
        "pkg-1.2.1+1.21.9-1.21.11" = _sFthH93a;
        "pkg-1.2.1+26.1-26.1.2" = _xy3YWKW7;
        "pkg-1.2.1+26.2" = _rvejhsWB;
        "default" = _rvejhsWB;
    });
