...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.21" = _ZacsGqJS;
        "pkg-1.0.1-mc1.21.2" = _7YrwmmWY;
        "pkg-1.0.1-mc1.21.4" = _PXK6HAYM;
        "pkg-1.0.1-mc1.21.5" = _yDu0UsdL;
        "pkg-1.0.1-mc1.21.6" = _n72jWqmY;
        "pkg-1.0.1-mc1.21.7" = _2KujiuTT;
        "pkg-1.0.1-mc1.21.9" = _sKai0ECX;
