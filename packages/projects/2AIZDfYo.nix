...
let
    ...
    in {
        ...
        "pkg-0.1" = _9PfspiV8;
        "pkg-0.2+1.19.2" = _Uuir1b0G;
        "pkg-0.2+1.19.4" = _EuvqI57t;
        "pkg-0.2+monojar" = _jJWTbDdE;
        "pkg-0.2.1" = _nR0eIYO4;
        "pkg-0.2.2" = _CdbGYhSm;
        "pkg-0.2.3" = _WkisxqR2;
        "pkg-0.2.4" = _4e3hUMKC;
        ...
        "pkg-0.2.6" = _LRLhsafw;
        "pkg-0.3.0" = _Euc7yOKr;
        "pkg-0.3.1+1.16.1-fabric" = _x5ugOezp;
        "pkg-0.3.1+1.16.5-fabric" = _4GmVirvM;
        "pkg-0.3.1+1.16.5-forge" = _B3CnfjUA;
        "pkg-0.3.1+1.18.2-fabric" = _NUIuRpVQ;
        "pkg-0.3.1+1.18.2-forge" = _iIMCErfE;
        "pkg-0.3.1+1.19.2-fabric" = _J5pUtfdc;
        "pkg-0.3.1+1.19.2-forge" = _PPljYC4r;
        "pkg-0.3.1+1.19.4-fabric" = _KtqyJS1W;
        "pkg-0.3.1+1.19.4-forge" = _wilqrT52;
        "pkg-0.3.2+1.16.1-fabric" = _RotPCiNK;
        "pkg-0.3.2+1.16.5-fabric" = _KXfbclCl;
        "pkg-0.3.2+1.16.5-forge" = _aoetk1Uh;
        "pkg-0.3.2+1.18.2-fabric" = _bSuFmgpj;
        "pkg-0.3.2+1.18.2-forge" = _k8iX1Ijv;
        "pkg-0.3.2+1.19.2-fabric" = _I4sijzXJ;
        "pkg-0.3.2+1.19.2-forge" = _HtPRZi9i;
        "pkg-0.3.2+1.19.4-fabric" = _sGR8txQa;
        "pkg-0.3.2+1.19.4-forge" = _R5cR22aX;
        "pkg-0.3.3+1.16.1-fabric" = _CwiC6xyB;
        "pkg-0.3.3+1.16.5-fabric" = _jqPoVw7d;
        "pkg-0.3.3+1.16.5-forge" = _o8y1EWs5;
        "pkg-0.3.3+1.18.2-fabric" = _A1I3paQo;
        "pkg-0.3.3+1.18.2-forge" = _XujehbCG;
        "pkg-0.3.3+1.19.2-fabric" = _cVxM2Xnf;
        "pkg-0.3.3+1.19.2-forge" = _vflDG1Yx;
        "pkg-0.3.3+1.19.4-fabric" = _1pktlrPZ;
        "pkg-0.3.3+1.19.4-forge" = _jxwPpUP2;
        "pkg-0.3.4+1.16.1-fabric" = _465nqrG1;
        "pkg-0.3.4+1.16.5-fabric" = _mqc1lQTD;
        "pkg-0.3.4+1.16.5-forge" = _VFw2sSSu;
        "pkg-0.3.4+1.18.2-fabric" = _3pjiG69D;
        "pkg-0.3.4+1.18.2-forge" = _nFYHGcdq;
        "pkg-0.3.4+1.19.2-fabric" = _Zk0GR2nj;
        "pkg-0.3.4+1.19.2-forge" = _OgNtDjRg;
        "pkg-0.3.4+1.19.4-fabric" = _9YwSbkqc;
        "pkg-0.3.4+1.19.4-forge" = _IcAo1Jur;
        "pkg-0.4.0+1.16.1-fabric" = _xIYaYYxh;
        "pkg-0.4.0+1.16.5-fabric" = _a58BWCru;
        "pkg-0.4.0+1.16.5-forge" = _TgYiZUvP;
        "pkg-0.4.0+1.17.1-fabric" = _oXZabUtf;
        "pkg-0.4.0+1.17.1-forge" = _u2nyzt27;
        "pkg-0.4.0+1.18.2-fabric" = _zDm6HAZm;
        "pkg-0.4.0+1.18.2-forge" = _CqmV35Kx;
        "pkg-0.4.0+1.19.2-fabric" = _JKfsrBC7;
        "pkg-0.4.0+1.19.2-forge" = _9eguLJnm;
        "pkg-0.4.0+1.19.4-fabric" = _3C0JqS5m;
        "pkg-0.4.0+1.19.4-forge" = _t3Ie2usV;
        "pkg-0.4.0+1.20-fabric" = _GDGYGxHr;
        "pkg-0.4.1+1.16.1-fabric" = _19q2clcZ;
        "pkg-0.4.1+1.16.5-fabric" = _8VpvizQP;
        "pkg-0.4.1+1.16.5-forge" = _LQEpgDUK;
        "pkg-0.4.1+1.17.1-fabric" = _5EhsjGgT;
        "pkg-0.4.1+1.17.1-forge" = _ikL9gzOB;
        "pkg-0.4.1+1.18.2-fabric" = _dTlz2nlf;
        "pkg-0.4.1+1.18.2-forge" = _Xas9RjtZ;
        "pkg-0.4.1+1.19.2-fabric" = _L3H6KksO;
        "pkg-0.4.1+1.19.2-forge" = _skU9SU3H;
        "pkg-0.4.1+1.19.4-fabric" = _8sjzwCja;
        "pkg-0.4.1+1.19.4-forge" = _6X7oUxrk;
        "pkg-0.4.1+1.20-fabric" = _B2kkYFa8;
        "pkg-0.4.2+1.16.1-fabric" = _DrRNz8SW;
        "pkg-0.4.2+1.16.5-fabric" = _J9lMfh4k;
        "pkg-0.4.2+1.16.5-forge" = _pHhioS2e;
        "pkg-0.4.2+1.17.1-fabric" = _sraiskbx;
        "pkg-0.4.2+1.17.1-forge" = _Dvi3CAxu;
        "pkg-0.4.2+1.18.2-fabric" = _YjM3XIfA;
        "pkg-0.4.2+1.18.2-forge" = _xF0NFHfV;
        "pkg-0.4.2+1.19.2-fabric" = _ZfjsMVQd;
        "pkg-0.4.2+1.19.2-forge" = _VyFqjHwO;
        "pkg-0.4.2+1.19.4-fabric" = _lGoJkIkW;
        "pkg-0.4.2+1.19.4-forge" = _b7DNRw9r;
        "pkg-0.4.2+1.20.1-fabric" = _tnsOxALW;
        "pkg-0.4.3+1.16.1-fabric" = _gBmxYuUN;
        "pkg-0.4.3+1.16.5-fabric" = _pic5u4fL;
        "pkg-0.4.3+1.16.5-forge" = _mLXG2vpH;
        "pkg-0.4.3+1.17.1-fabric" = _ducFgDzc;
        "pkg-0.4.3+1.17.1-forge" = _hUkp2dey;
        "pkg-0.4.3+1.18.2-fabric" = _lxOtS9Vl;
        "pkg-0.4.3+1.18.2-forge" = _tYljHDq3;
        "pkg-0.4.3+1.19.2-fabric" = _fgfcF1O2;
        "pkg-0.4.3+1.19.2-forge" = _jDW6yqFo;
        "pkg-0.4.3+1.19.4-fabric" = _ZbaDIPpM;
        "pkg-0.4.3+1.19.4-forge" = _hZOnXG3A;
        "pkg-0.4.3+1.20.1-fabric" = _q9RL62WV;
        "pkg-0.4.4+1.16.1-fabric" = _dU81iMDq;
        "pkg-0.4.4+1.16.5-fabric" = _dWPV8leb;
        "pkg-0.4.4+1.16.5-forge" = _iOxYQeLv;
        "pkg-0.4.4+1.17.1-fabric" = _Nttg41Py;
        "pkg-0.4.4+1.17.1-forge" = _z30xjJ6G;
        "pkg-0.4.4+1.18.2-fabric" = _1FWH5maM;
        "pkg-0.4.4+1.18.2-forge" = _sHs18iUV;
        "pkg-0.4.4+1.19.2-fabric" = _Ld363sM2;
        "pkg-0.4.4+1.19.2-forge" = _b7X8PPlR;
        "pkg-0.4.4+1.19.4-fabric" = _a5KEU5wg;
        "pkg-0.4.4+1.19.4-forge" = _b5w9Avyz;
        "pkg-0.4.4+1.20.1-fabric" = _rbldxKzV;
        "pkg-0.4.4+1.20.1-forge" = _W9ggWofn;
        "pkg-0.4.4+1.20.2-fabric" = _hPE11Pcs;
        "pkg-0.4.5+1.16.1-fabric" = _UB7cC7yR;
        "pkg-0.4.5+1.16.5-fabric" = _EpJP5uu6;
        "pkg-0.4.5+1.16.5-forge" = _q7HRWFT8;
        "pkg-0.4.5+1.17.1-fabric" = _HsC1QUR1;
        "pkg-0.4.5+1.17.1-forge" = _tsQ5qovF;
        "pkg-0.4.5+1.18.2-fabric" = _Kud1xkDy;
        "pkg-0.4.5+1.18.2-forge" = _cjLZh8sk;
        "pkg-0.4.5+1.19.2-fabric" = _XrghVsKZ;
        "pkg-0.4.5+1.19.2-forge" = _nzuqHx8i;
        "pkg-0.4.5+1.19.4-fabric" = _EE9sW6sw;
        "pkg-0.4.5+1.19.4-forge" = _hK8foR8f;
        "pkg-0.4.5+1.20.1-fabric" = _UcC1m8Hs;
        "pkg-0.4.5+1.20.1-forge" = _NNHLy1X2;
        "pkg-0.4.5+1.20.2-fabric" = _sdGHyyEO;
        "pkg-0.4.6+1.16.1-fabric" = _UODyiEgH;
        "pkg-0.4.6+1.16.5-fabric" = _Dr5pfXfQ;
        "pkg-0.4.6+1.16.5-forge" = _VOzH70Tz;
        "pkg-0.4.6+1.17.1-fabric" = _4XH0dAV0;
        "pkg-0.4.6+1.17.1-forge" = _89zIuajy;
        "pkg-0.4.6+1.18.2-fabric" = _yBJyY7dm;
        "pkg-0.4.6+1.18.2-forge" = _mT9JLexq;
        "pkg-0.4.6+1.19.2-fabric" = _bJpDfihp;
        "pkg-0.4.6+1.19.2-forge" = _abxdoM4E;
        "pkg-0.4.6+1.19.4-fabric" = _7UsmmtZI;
        "pkg-0.4.6+1.19.4-forge" = _eBlQHbx1;
        "pkg-0.4.6+1.20.1-fabric" = _ebhhHHQl;
        "pkg-0.4.6+1.20.1-forge" = _EFudVr52;
        "pkg-0.4.6+1.20.2-fabric" = _Cn8ZcMUV;
        "pkg-0.4.6+1.20.2-neoforge" = _JSZr1eSd;
        "pkg-0.4.7+1.16.1-fabric" = _LtiFhER1;
        "pkg-0.4.7+1.16.5-fabric" = _OJwOywWz;
        "pkg-0.4.7+1.16.5-forge" = _bEq5QCxS;
        "pkg-0.4.7+1.17.1-fabric" = _fenawDny;
        "pkg-0.4.7+1.17.1-forge" = _F4FY30yt;
        "pkg-0.4.7+1.18.2-fabric" = _QjqIuhRg;
        "pkg-0.4.7+1.18.2-forge" = _jqC01iWh;
        "pkg-0.4.7+1.19.2-fabric" = _au9RRwX1;
        "pkg-0.4.7+1.19.2-forge" = _OD2632ha;
        "pkg-0.4.7+1.19.4-fabric" = _zKbMiag6;
        "pkg-0.4.7+1.19.4-forge" = _Q2y9phBT;
        "pkg-0.4.7+1.20.1-fabric" = _EbP0vEnF;
        "pkg-0.4.7+1.20.1-forge" = _43NLbhUU;
        "pkg-0.4.7+1.20.2-fabric" = _ityoeYzp;
        "pkg-0.4.7+1.20.2-neoforge" = _5SehLv42;
        "pkg-0.4.7+1.20.3-fabric" = _sCaJuhIO;
        "pkg-0.4.7+1.20.3-neoforge" = _Y6idzKd2;
        "pkg-0.4.8+1.16.1-fabric" = _ZnbcDZGJ;
        "pkg-0.4.8+1.16.5-fabric" = _fUlAYEtQ;
        "pkg-0.4.8+1.16.5-forge" = _Z6sFUrwv;
        "pkg-0.4.8+1.17.1-fabric" = _Iha8U2iz;
        "pkg-0.4.8+1.17.1-forge" = _rBB5StnS;
        "pkg-0.4.8+1.18.2-fabric" = _thfrZQjP;
        "pkg-0.4.8+1.18.2-forge" = _XteeoDYk;
        "pkg-0.4.8+1.19.2-fabric" = _N8ThgPbA;
        "pkg-0.4.8+1.19.2-forge" = _z1PjOHBF;
        "pkg-0.4.8+1.19.4-fabric" = _gXuD95df;
        "pkg-0.4.8+1.19.4-forge" = _eg3IU3SQ;
        "pkg-0.4.8+1.20.1-fabric" = _Cpew8B2k;
        "pkg-0.4.8+1.20.1-forge" = _MjbUwf6l;
        "pkg-0.4.8+1.20.2-fabric" = _lB3iafW4;
        "pkg-0.4.8+1.20.2-neoforge" = _yupR7k0x;
        "pkg-0.4.8+1.20.4-fabric" = _KeMvifkq;
        "pkg-0.4.8+1.20.4-neoforge" = _1Tw8mKv4;
        "pkg-0.4.9+1.16.1-fabric" = _GzM9KbAo;
        "pkg-0.4.9+1.16.5-fabric" = _4VOGEGYi;
        "pkg-0.4.9+1.16.5-forge" = _Xqh7nRtZ;
        "pkg-0.4.9+1.17.1-fabric" = _nWUjzxqo;
        "pkg-0.4.9+1.17.1-forge" = _oyVlWbdc;
        "pkg-0.4.9+1.18.2-fabric" = _NfPubFkk;
        "pkg-0.4.9+1.18.2-forge" = _Z1PAMA0e;
        "pkg-0.4.9+1.19.2-fabric" = _9yqUL7iL;
        "pkg-0.4.9+1.19.2-forge" = _Vwy40JLR;
        "pkg-0.4.9+1.19.4-fabric" = _sAd1kzXW;
        "pkg-0.4.9+1.19.4-forge" = _COdoVZZV;
        "pkg-0.4.9+1.20.1-fabric" = _DycSfBwC;
        "pkg-0.4.9+1.20.1-forge" = _OmLxSKDe;
        "pkg-0.4.9+1.20.2-fabric" = _YgLhoSeH;
        "pkg-0.4.9+1.20.2-neoforge" = _ofDg1ymr;
        "pkg-0.4.9+1.20.4-fabric" = _JLm0JGbM;
        "pkg-0.4.9+1.20.4-neoforge" = _HdUX5RXQ;
        "pkg-0.4.10+1.16.1-fabric" = _mwEMwuup;
        "pkg-0.4.10+1.16.5-fabric" = _DgQoKyRf;
        "pkg-0.4.10+1.16.5-forge" = _Ew9z0WEp;
        "pkg-0.4.10+1.17.1-fabric" = _yUakan2U;
        "pkg-0.4.10+1.17.1-forge" = _90emlMEu;
        "pkg-0.4.10+1.18.2-fabric" = _a9k3IrxB;
        "pkg-0.4.10+1.18.2-forge" = _KJg4PVlI;
        "pkg-0.4.10+1.19.2-fabric" = _EwsblIna;
        "pkg-0.4.10+1.19.2-forge" = _JyL0fduR;
        "pkg-0.4.10+1.19.4-fabric" = _V1DPQMJf;
        "pkg-0.4.10+1.19.4-forge" = _eMguwlRl;
        "pkg-0.4.10+1.20.1-fabric" = _wlCd056V;
        "pkg-0.4.10+1.20.1-forge" = _3fvpextk;
        "pkg-0.4.10+1.20.2-fabric" = _dVu9PTDa;
        "pkg-0.4.10+1.20.2-neoforge" = _jyUQwcYj;
        "pkg-0.4.10+1.20.4-fabric" = _4T6rpvpc;
        "pkg-0.4.10+1.20.4-neoforge" = _NS8lZC8F;
        "pkg-0.4.11+1.17.1-fabric" = _7Fse19Qt;
        "pkg-0.4.11+1.17.1-forge" = _sk5x8164;
        "pkg-0.4.11+1.18.2-fabric" = _Gj3GumJm;
        "pkg-0.4.11+1.18.2-forge" = _EQscwjFD;
        "pkg-0.4.11+1.19.2-fabric" = _YLf4Q8Sq;
        "pkg-0.4.11+1.19.2-forge" = _y5sEcmIQ;
        "pkg-0.4.11+1.19.4-fabric" = _neYxUaQz;
        "pkg-0.4.11+1.19.4-forge" = _xqy867Nj;
        "pkg-0.4.11+1.20.1-fabric" = _msn5pEeY;
        "pkg-0.4.11+1.20.1-forge" = _ljIkVKfF;
        "pkg-0.4.11+1.20.4-fabric" = _zqMSk9xO;
        "pkg-0.4.11+1.20.4-neoforge" = _AbIPTFt8;
        "pkg-0.4.11+1.20.6-fabric" = _BTR1X0ua;
        "pkg-0.4.11+1.20.6-neoforge" = _MggBmRkA;
        "pkg-0.4.12+1.17.1-fabric" = _QNn0FLgz;
        "pkg-0.4.12+1.17.1-forge" = _uEO10vmI;
        "pkg-0.4.12+1.18.2-fabric" = _dxi6QAC0;
        "pkg-0.4.12+1.18.2-forge" = _uOyY5W7l;
        "pkg-0.4.12+1.19.2-fabric" = _Cacb6juf;
        "pkg-0.4.12+1.19.2-forge" = _Ow9nkQVx;
        "pkg-0.4.12+1.19.4-fabric" = _5sJKbVVx;
        "pkg-0.4.12+1.19.4-forge" = _MuAPCKej;
        "pkg-0.4.12+1.20.1-fabric" = _x8TrMJnY;
        "pkg-0.4.12+1.20.1-forge" = _rM6optRb;
        "pkg-0.4.12+1.20.4-fabric" = _bhIEpQpp;
        "pkg-0.4.12+1.20.4-neoforge" = _yCslsZio;
        "pkg-0.4.12+1.20.6-fabric" = _NobIPIAf;
        "pkg-0.4.12+1.20.6-neoforge" = _jtWQEMDb;
        "pkg-0.4.13+1.18.2-fabric" = _NUqagKKv;
        "pkg-0.4.13+1.18.2-forge" = _WLhRzD3V;
        "pkg-0.4.13+1.19.2-fabric" = _lqGcQXF9;
        "pkg-0.4.13+1.19.2-forge" = _4iHRNoLy;
        "pkg-0.4.13+1.19.4-fabric" = _LoqVvAfH;
        "pkg-0.4.13+1.19.4-forge" = _Krunn4rb;
        "pkg-0.4.13+1.20.1-fabric" = _dKRu6109;
        "pkg-0.4.13+1.20.1-forge" = _9iwxnUyg;
        "pkg-0.4.13+1.20.4-fabric" = _KoOfGRTU;
        "pkg-0.4.13+1.20.4-neoforge" = _h6rQCOtp;
        "pkg-0.4.13+1.20.6-fabric" = _Stqmbwri;
        "pkg-0.4.13+1.20.6-neoforge" = _9GnCBGBP;
        "pkg-0.4.13+1.21-fabric" = _yC6SPfCy;
        "pkg-0.4.13+1.21-neoforge" = _nvrpaNQn;
        "pkg-0.4.14+1.18.2-fabric" = _aw5mw2Wr;
        "pkg-0.4.14+1.18.2-forge" = _VEjMtmj6;
        "pkg-0.4.14+1.19.2-fabric" = _CsL1VsHZ;
        "pkg-0.4.14+1.19.2-forge" = _CgFTtVwR;
        "pkg-0.4.14+1.19.4-fabric" = _t7dfb5D8;
        "pkg-0.4.14+1.19.4-forge" = _j7Afe48v;
        "pkg-0.4.14+1.20.1-fabric" = _PCgTw2nU;
        "pkg-0.4.14+1.20.1-forge" = _JDc2KssJ;
        "pkg-0.4.14+1.20.4-fabric" = _vD59jV3F;
        "pkg-0.4.14+1.20.4-neoforge" = _zsY9bDrX;
        "pkg-0.4.14+1.20.6-fabric" = _yKQxziDG;
        "pkg-0.4.14+1.20.6-neoforge" = _3lj5uguI;
        "pkg-0.4.14+1.21-fabric" = _benNNbLm;
        "pkg-0.4.14+1.21-neoforge" = _kSa3EonR;
        "pkg-0.4.14+1.21.1-fabric" = _bd0Ozgi4;
        "pkg-0.5.0+1.19.2-fabric" = _YpSxAbNw;
        "pkg-0.5.0+1.19.2-forge" = _mrH6dfg3;
        "pkg-0.5.0+1.19.4-fabric" = _YiUgFj88;
        "pkg-0.5.0+1.19.4-forge" = _cxslIZh3;
        "pkg-0.5.0+1.20.1-fabric" = _JVdaKC2Q;
        "pkg-0.5.0+1.20.1-forge" = _7rDk0N8A;
        "pkg-0.5.0+1.20.4-fabric" = _8BUI6Don;
        "pkg-0.5.0+1.20.4-neoforge" = _eNoWzJdn;
        "pkg-0.5.0+1.20.6-fabric" = _hm7LeSJY;
        "pkg-0.5.0+1.20.6-neoforge" = _WH1BuaPp;
        "pkg-0.5.0+1.21.1-fabric" = _K6rdhOat;
        "pkg-0.5.0+1.21.1-neoforge" = _lMCmgbw7;
        "pkg-0.5.0+1.21.3-fabric" = _23fSHLkG;
        "pkg-0.5.0+1.21.3-neoforge" = _eoihzFD9;
        "pkg-0.5.1+1.19.2-fabric" = _qmRDKpIs;
        "pkg-0.5.1+1.19.2-forge" = _BG9KM4DK;
        "pkg-0.5.1+1.19.4-fabric" = _hWNarlcv;
        "pkg-0.5.1+1.19.4-forge" = _Z8qvbmft;
        "pkg-0.5.1+1.20.1-fabric" = _5lGpstd0;
        "pkg-0.5.1+1.20.1-forge" = _cn2i9oTx;
        "pkg-0.5.1+1.20.4-fabric" = _sZwjOhP1;
        "pkg-0.5.1+1.20.4-neoforge" = _cnfwLMiO;
        "pkg-0.5.1+1.20.6-fabric" = _oui2SHDT;
        "pkg-0.5.1+1.20.6-neoforge" = _kgsX3wHm;
        "pkg-0.5.1+1.21.1-fabric" = _t1v6yfhZ;
        "pkg-0.5.1+1.21.1-neoforge" = _SlPlEm14;
        "pkg-0.5.1+1.21.3-fabric" = _YZD4f8HX;
        "pkg-0.5.1+1.21.3-neoforge" = _Fgnri28T;
        "pkg-0.5.1+1.21.4-fabric" = _ViFuGe45;
        "pkg-0.5.1+1.21.4-neoforge" = _A4KIopXp;
        "pkg-0.5.2+1.19.2-fabric" = _z6kATqeY;
        "pkg-0.5.2+1.19.2-forge" = _Wzu2NCJ1;
        "pkg-0.5.2+1.19.4-fabric" = _xE209dZf;
        "pkg-0.5.2+1.19.4-forge" = _T6XoIoCW;
        "pkg-0.5.2+1.20.1-fabric" = _aeZLqLcC;
        "pkg-0.5.2+1.20.1-forge" = _kQaptuIo;
        "pkg-0.5.2+1.20.4-fabric" = _Nm70PqEv;
        "pkg-0.5.2+1.20.4-neoforge" = _g4MTG0qe;
        "pkg-0.5.2+1.21.1-fabric" = _blBlWzm7;
        "pkg-0.5.2+1.21.1-neoforge" = _SGnkF0Pb;
        "pkg-0.5.2+1.21.3-fabric" = _zhvOCzYj;
        "pkg-0.5.2+1.21.3-neoforge" = _ZGKhiOTa;
        "pkg-0.5.2+1.21.4-fabric" = _Ot6s04sx;
        "pkg-0.5.2+1.21.4-neoforge" = _de4zA8LY;
        "pkg-0.5.2+1.21.5-fabric" = _sPXJkxsS;
        "pkg-0.5.2+1.21.5-neoforge" = _GcAKkt60;
        "default" = _GcAKkt60;
    });
