...
let
    ...
    in {
        ...
        "pkg-1.1.5" = _FdsOGCTf;
        "pkg-1.1.6" = _WcnkE9ki;
        "pkg-1.21.1-1.1.6" = _xuv1L2r1;
        "pkg-1.1.7" = _ZGgHkc1u;
        "pkg-1.21.11-1.1.8" = _U4Bctmoq;
        "pkg-26.1.2-1.1.8" = _d5EgsNl8;
        "pkg-26.1.2-1.1.9" = _TjBTsG13;
        "pkg-26.2-1.1.10" = _YeYmXQCD;
        "pkg-1.20.1-1.1.10" = _VJkeBgK8;
        "default" = _VJkeBgK8;
    });
