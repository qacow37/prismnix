...
let
    ...
    in {
        ...
        "pkg-1.18.2-2.0.8" = _Chr5Hu9P;
        "pkg-1.19.2-3.0.0" = _uQ8np43e;
        "pkg-1.19.2-3.0.1" = _KOZ5byfq;
        "pkg-1.18.2-2.0.9" = _pkM14Fta;
        "pkg-1.19.2-3.0.2" = _WhYw0uqZ;
        "pkg-1.18.2-2.0.10" = _JnWgWqkA;
        "pkg-1.19.2-3.0.3" = _TmR0gdzd;
        "pkg-1.20.1-4.0.0" = _2s9bQnLS;
        "pkg-1.20.1-4.0.1" = _FfaVwI1D;
        "pkg-1.20.1-4.1.0" = _cX71uVog;
        "pkg-1.20.1-4.1.1" = _b9xmoLpY;
        "pkg-5.0.0" = _wKI0GUpC;
        "pkg-5.1.0" = _Q0JMolP4;
        "pkg-5.1.1" = _a1fHliwJ;
        "pkg-1.20.1-4.2.0" = _pAZObJ4k;
        "pkg-5.1.2" = _U63Q6A3m;
        "pkg-5.2.0" = _Sqi1dmJJ;
        "pkg-5.2.1" = _UVikcWDT;
        "pkg-1.20.1-4.2.1" = _2wWXmKdR;
        "pkg-5.2.2" = _ZgbWy7RA;
        "pkg-5.2.3" = _uFiVDj6D;
        "pkg-5.2.4" = _A3PPaY6G;
        "pkg-5.2.5" = _TogoRZ7W;
        "pkg-5.2.6" = _n9HAyImn;
        "pkg-1.20.1-4.2.2" = _M6ls9zrf;
        "pkg-5.2.7" = _lbuyTO5x;
        "pkg-1.20.1-4.2.3" = _36OEHU7f;
        "pkg-5.2.8" = _G8Lz8Txm;
        "default" = _G8Lz8Txm;
    });
