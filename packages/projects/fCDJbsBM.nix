...
let
    ...
    in {
        ...
        "pkg-0.1.0-alpha.1+1.20.2" = _DNiKmLvl;
        "pkg-0.1.0-alpha.2+1.20.2" = _47G9So3J;
        "pkg-0.1.0-alpha.3+1.20.2" = _qLYngA60;
        "pkg-0.1.0-alpha.4+1.20.2" = _TR2T7bp9;
        "pkg-0.1.0-alpha.5+1.20.2" = _VCx3RyXx;
        "pkg-0.1.0-alpha.6+1.20.2" = _L6xISvlY;
        "pkg-0.1.0-alpha.7+1.20.2" = _pDem7MLY;
        "pkg-0.2.0-alpha.1+1.20.1" = _lUEdmpsV;
        "pkg-0.2.0-alpha.1+1.20.2" = _HfOgLZjE;
        "pkg-0.2.0-alpha.2+1.20.1" = _P3XkRPhF;
        "pkg-0.2.0-alpha.2+1.20.2" = _6LCT5A4y;
        "pkg-0.2.0-alpha.3+1.20.1" = _bnTE4QJh;
        "pkg-0.2.0-alpha.3+1.20.2" = _CloF5frs;
        "pkg-0.2.1-alpha.1+1.20.1" = _Lx09N1KD;
        "pkg-0.2.1-alpha.1+1.20.2" = _zQPoWMwS;
        "pkg-0.2.1-alpha.1+1.20.4" = _9LJsd6ZM;
        "pkg-0.2.1-alpha.1+1.20.6" = _2awuMp32;
        "pkg-0.2.1-alpha.2+1.20.1" = _LI0qe9WP;
        "pkg-0.2.1-alpha.2+1.20.2" = _XmmZ2zOT;
        "pkg-0.2.1-alpha.2+1.20.4" = _ju37F9aN;
        "pkg-0.2.1-alpha.2+1.20.6" = _69FLnUgw;
        "pkg-0.2.1-alpha.3+1.20.1" = _YaCzsfPS;
        "pkg-0.2.1-alpha.3+1.20.2" = _cHwYdl5J;
        "pkg-0.2.1-alpha.3+1.20.4" = _C4N8JkCr;
        "pkg-0.2.1-alpha.3+1.20.6" = _QbKV3m9l;
        "pkg-0.2.1-alpha.4+1.20.1" = _YjOMsCjD;
        "pkg-0.2.1-alpha.4+1.20.2" = _7XYGH7Ze;
        "pkg-0.2.1-alpha.4+1.20.4" = _Hh1C69xV;
        "pkg-0.2.1-alpha.4+1.20.6" = _nfLmlGBd;
        "pkg-0.2.1-alpha.5+1.20.1" = _peY8sE9Z;
        "pkg-0.2.1-alpha.5+1.20.2" = _CU6w9dJf;
        "pkg-0.2.1-alpha.5+1.20.4" = _oPY81qON;
        "pkg-0.2.1-alpha.5+1.20.6" = _IflIVObW;
        "pkg-0.2.1-alpha.6+1.20.1" = _BPtRVJtu;
        "pkg-0.2.1-alpha.6+1.20.2" = _tvprAnYP;
        "pkg-0.2.1-alpha.6+1.20.4" = _CmGuOgH2;
        "pkg-0.2.1-alpha.6+1.20.6" = _YDICa33n;
        "pkg-0.2.2-alpha.1+1.20.1" = _EphseWI6;
        "pkg-0.2.2-alpha.1+1.20.2" = _ujezaZWu;
        "pkg-0.2.2-alpha.1+1.20.4" = _pb859p46;
        "pkg-0.2.2-alpha.1+1.20.6" = _pqgLqjiN;
        "pkg-0.2.2-alpha.1+1.21" = _4Er9LaNO;
        "pkg-0.2.2-alpha.2+1.20.1" = _Ix5MTerF;
        "pkg-0.2.2-alpha.2+1.20.2" = _vSzDh1jy;
        "pkg-0.2.2-alpha.2+1.20.4" = _eO5vieuN;
        "pkg-0.2.2-alpha.2+1.20.6" = _XvfJM1FO;
        "pkg-0.2.2-alpha.2+1.21" = _6rawHBNd;
        "pkg-0.3.0-alpha.1+1.20.1" = _Bw9VxK91;
        "pkg-0.3.0-alpha.1+1.20.2" = _QwA27pFB;
        "pkg-0.3.0-alpha.1+1.20.4" = _UM7u9Kyg;
        "pkg-0.3.0-alpha.1+1.20.6" = _lUKROkmp;
        "pkg-0.3.0-alpha.1+1.21" = _cKhaN4ge;
        "pkg-0.3.0-alpha.2+1.20.1" = _oegl7hjn;
        "pkg-0.3.0-alpha.2+1.20.2" = _jD0p0Vjn;
        "pkg-0.3.0-alpha.2+1.20.4" = _r8yuWZGL;
        "pkg-0.3.0-alpha.2+1.20.6" = _cFKYr68W;
        "pkg-0.3.0-alpha.2+1.21" = _bgC0QJll;
        "pkg-0.3.0-alpha.2+1.21.2" = _57WyI1s9;
        "pkg-0.3.0-alpha.3+1.19.4" = _CDrlYcgf;
        "pkg-0.3.0-alpha.3+1.20.1" = _b2VNofyo;
        "pkg-0.3.0-alpha.3+1.20.2" = _NjiJMAQs;
        "pkg-0.3.0-alpha.3+1.20.4" = _8T7X9vE7;
        "pkg-0.3.0-alpha.3+1.20.6" = _g1GurGU0;
        "pkg-0.3.0-alpha.3+1.21" = _50R4uxik;
        "pkg-0.3.0-alpha.3+1.21.2" = _gHVAJYg9;
        "pkg-0.3.0-alpha.3+1.21.4" = _xzWuyF50;
        "pkg-0.3.0-alpha.4+1.19.4" = _drqMy3di;
        "pkg-0.3.0-alpha.4+1.20.1" = _ttSDsfnJ;
        "pkg-0.3.0-alpha.4+1.20.2" = _W2b8bU38;
        "pkg-0.3.0-alpha.4+1.20.4" = _72bxkPNs;
        "pkg-0.3.0-alpha.4+1.20.6" = _QD3uPckp;
        "pkg-0.3.0-alpha.4+1.21" = _lIh8ZkBy;
        "pkg-0.3.0-alpha.4+1.21.2" = _qdNXXjXp;
        "pkg-0.3.0-alpha.4+1.21.4" = _iOvJgY33;
        "pkg-0.3.1-alpha.1+1.19.4" = _nepnJAAZ;
        "pkg-0.3.1-alpha.1+1.20.1" = _d1ccVpVU;
        "pkg-0.3.1-alpha.1+1.20.2" = _jrFEssxI;
        "pkg-0.3.1-alpha.1+1.20.4" = _yD7a2iOJ;
        "pkg-0.3.1-alpha.1+1.20.6" = _9psGcmIV;
        "pkg-0.3.1-alpha.1+1.21" = _4CgoaBv6;
        "pkg-0.3.1-alpha.1+1.21.2" = _AkCJBpUf;
        "pkg-0.3.1-alpha.1+1.21.4" = _5FYV6xmk;
        "pkg-0.3.1-alpha.2+1.19.4" = _OG6kVt4j;
        "pkg-0.3.1-alpha.2+1.20.1" = _d5LJjaV4;
        "pkg-0.3.1-alpha.2+1.20.2" = _OI0LF9zL;
        "pkg-0.3.1-alpha.2+1.20.4" = _RjdoSPOu;
        "pkg-0.3.1-alpha.2+1.20.6" = _5YMrQ67R;
        "pkg-0.3.1-alpha.2+1.21" = _aBHddT71;
        "pkg-0.3.1-alpha.2+1.21.2" = _fGETfXoQ;
        "pkg-0.3.1-alpha.2+1.21.4" = _t1SDm7I6;
        "pkg-0.3.2-alpha.1+1.19.4" = _h98LNkqc;
        "pkg-0.3.2-alpha.1+1.20.1" = _RoKbHbde;
        "pkg-0.3.2-alpha.1+1.20.2" = _CsP2068F;
        "pkg-0.3.2-alpha.1+1.20.4" = _ftomGyes;
        "pkg-0.3.2-alpha.1+1.20.6" = _1vPfFmrs;
        "pkg-0.3.2-alpha.1+1.21" = _BjKdjiXE;
        "pkg-0.3.2-alpha.1+1.21.2" = _LJHhquLo;
        "pkg-0.3.2-alpha.1+1.21.4" = _ZGyzOONv;
        "pkg-0.3.2-alpha.2+1.19.4" = _8Zgxkj0K;
        "pkg-0.3.2-alpha.2+1.20.1" = _A719U70I;
        "pkg-0.3.2-alpha.2+1.20.2" = _PwaCrMIf;
        "pkg-0.3.2-alpha.2+1.20.4" = _H4dndDMJ;
        "pkg-0.3.2-alpha.2+1.20.6" = _gJ4g12GU;
        "pkg-0.3.2-alpha.2+1.21" = _Wv6Gu4ux;
        "pkg-0.3.2-alpha.2+1.21.2" = _RZcaat95;
        "pkg-0.3.2-alpha.2+1.21.4" = _P8hdQTrb;
        "default" = _P8hdQTrb;
    });
