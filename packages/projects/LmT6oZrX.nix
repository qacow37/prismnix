...
let
    ...
    in {
        ...
        "pkg-0.1-build.20+1.20.1" = _78PZNqhY;
        "pkg-0.1.1-build.35+1.20.1" = _qk1t7i4w;
        "pkg-0.2-build.49+1.20.1" = _NOy9LYZK;
        "pkg-0.2.1-build.63+1.20.1" = _XVABYxwq;
        "pkg-0.3-build.89+1.20.1" = _MTRFQcLw;
        "pkg-0.4+fabric-mc1.20.1" = _RsteqCxR;
        "pkg-0.5+fabric-mc1.20.1" = _G3LNAUFo;
        "pkg-0.5+forge-mc1.20.1" = _kO0bQP2t;
        "pkg-0.6+fabric-mc1.20.1" = _QfLf7B5e;
        "pkg-0.6+forge-mc1.20.1" = _rwRjS1XG;
        "pkg-0.6.1+fabric-mc1.20.1" = _oktw0eXj;
        "pkg-0.6.1+forge-mc1.20.1" = _44GJFuiU;
        "pkg-0.6.2+fabric-mc1.20.1" = _ea7LNZPM;
        "pkg-0.6.2+forge-mc1.20.1" = _2hHXwuYZ;
        "pkg-0.6.3+fabric-mc1.20.1" = _AA1U2m6v;
        "pkg-0.6.3+forge-mc1.20.1" = _CqYivg15;
        "pkg-0.6.4+fabric-mc1.20.1" = _Umn7P4QS;
        "pkg-0.6.4+forge-mc1.20.1" = _ChVNsXYT;
        "pkg-0.6.5+forge-mc1.20.1" = _pm2yTqsa;
        "pkg-0.6.6+forge-mc1.20.1" = _LXJcPSbw;
        "pkg-0.6.7+forge-mc1.20.1" = _2vVpMYaP;
        "pkg-0.6.4b+fabric-mc1.20.1" = _Ne13atvt;
        "pkg-0.7+forge-mc1.20.1" = _qjpq8dDP;
        "pkg-0.7.1+forge-mc1.20.1" = _x1fgdEOw;
        "pkg-0.7.1+neoforge-mc1.21.1" = _wlHoQTUc;
        "pkg-0.7.2+neoforge-mc1.21.1" = _Ckfu9IzG;
        "pkg-0.7.3+neoforge-mc1.21.1" = _VPCEoGrO;
        "pkg-0.7.4+neoforge-mc1.21.1" = _V9HyDSFg;
        "default" = _V9HyDSFg;
    });
