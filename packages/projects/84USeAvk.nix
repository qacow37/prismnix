...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.1.16" = _8JdnD9wo;
        "pkg-1.19.2-0.1.16" = _okvheSWL;
        "pkg-1.20.1-0.1.16" = _EvNWNIMY;
        "pkg-1.20.1-0.5.0-forge" = _D8QNCsEe;
        "pkg-1.20.1-0.5.0-fabric" = _RgLAJM7M;
        "pkg-1.20.1-0.5.0-forge-HOTFIX-1" = _oFVIH04d;
        "pkg-1.20.1-0.5.0-fabric-HOTFIX-1" = _4KNSw23c;
        "pkg-1.20.1-0.5.2-fabric" = _NlXkWP1y;
        "pkg-1.20.1-0.5.2-forge" = _7fGJGTcJ;
        "pkg-1.20.1-0.5.3-forge" = _NZwO7Sji;
        "pkg-1.20.1-0.5.3-fabric" = _Jsckttl2;
        "pkg-1.20.1-fabric-0.5.4" = _I1pc2vU7;
        "pkg-1.20.1-forge-0.5.4" = _IWjRO99L;
        "pkg-1.20.1-fabric-0.5.4.1" = _yXx1wlBG;
        "pkg-1.20.1-forge-0.5.4.1" = _UdDDx8kg;
        "pkg-1.20.1-fabric-0.5.4.2" = _EUUd37iA;
        "pkg-1.20.1-forge-0.5.4.2" = _eustoh2X;
        "pkg-1.20.1-fabric-0.5.4.3" = _lmxyThrq;
        "pkg-1.20.1-forge-0.5.4.3" = _BM7snH6L;
        "pkg-1.20.1-fabric-0.5.4.4" = _TJsdayil;
        "pkg-1.20.1-forge-0.5.4.4" = _ZyJYZ6kU;
        "pkg-1.20.1-fabric-0.5.4.5" = _Lo6LhjpL;
        "pkg-1.20.1-forge-0.5.4.5" = _v9oJ9IHd;
        "pkg-1.20.1-forge-0.5.4.6" = _IP7OOk86;
        "pkg-1.20.1-fabric-0.5.4.6" = _kiBX9fNA;
        "pkg-1.20.1-fabric-0.5.5" = _D9lVV8AV;
        "pkg-1.20.1-forge-0.5.5" = _RWAvskZ6;
        "pkg-1.20.1-fabric-0.5.5.1" = _akce2D2M;
        "pkg-1.20.1-forge-0.5.5.1" = _MhrXXJMH;
        "pkg-1.20.1-fabric-0.5.5.2" = _3ksXjJZE;
        "pkg-1.20.1-forge-0.5.5.2" = _q7OCzMfX;
        "pkg-1.20.1-forge-0.5.6" = _fYK8BigB;
        "pkg-1.20.1-fabric-0.5.6" = _6V352Hop;
        "default" = _6V352Hop;
    });
