...
let
    ...
    in {
        ...
        "pkg-1.0" = _aDjfQZR5;
        "pkg-1.0_mod" = _mQc9W9bl;
        "pkg-1.1" = _MeFn2B12;
        "pkg-1.2" = _tH37q3rU;
        "pkg-1.2+mod" = _VQrO9g4E;
        "pkg-1.3" = _rNPhqbat;
        "pkg-1.3+mod" = _4SeEubOI;
        "pkg-1.4" = _zcOieFMk;
        "pkg-1.4+mod" = _77TtJ3IK;
        "pkg-2.0" = _IzWULteA;
        "pkg-2.0+mod" = _pzp5It2w;
        "pkg-2.1" = _99EPRPsS;
        "pkg-3.0" = _33CJ294r;
        "pkg-3.0+mod" = _WUyo8903;
        "pkg-3.1" = _VJUE3KoX;
        "pkg-3.1+mod" = _Rs5A9tHf;
        "pkg-3.2" = _BnCKjAm5;
        "pkg-3.2+mod" = _vsYg7dwK;
        "pkg-3.3" = _zfJ6ZrWP;
        "pkg-3.3+mod" = _Jpry7lEh;
        "pkg-3.4" = _fyl7sJ2X;
        "pkg-3.4+mod" = _JVNI0avc;
        "pkg-3.5" = _vVFafoF5;
        "pkg-3.5+mod" = _j3GE7w2S;
        "pkg-3.6" = _hWLR9lXE;
        "pkg-3.6+mod" = _vS2Qz0IS;
        "pkg-3.7" = _ZDeHiPVe;
        "pkg-3.7-fabric" = _pFLQZzwg;
        "pkg-3.7-forge" = _mFgXasvH;
        "pkg-3.11" = _TgNiKyHg;
        "pkg-3.11-fabric" = _IJyg68xP;
        "pkg-3.11-quilt" = _4QC8hEtF;
        "pkg-3.11-forge" = _axJX9loo;
        "pkg-3.11-neoforge" = _queYtHb7;
        "pkg-3.12" = _8pwm5Agx;
        "pkg-3.12-fabric" = _20IsfWyy;
        "pkg-3.12-quilt" = _nuI65rIT;
        "pkg-3.12-forge" = _mHIoVC54;
        "pkg-3.12-neoforge" = _GF0tu213;
        "default" = _GF0tu213;
    });
