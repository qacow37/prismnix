...
let
    ...
    in {
        ...
        "pkg-2.0-pre2" = _8xRjiMo4;
        "pkg-2.0-pre3+bukkit" = _ItB5MZ3u;
        "pkg-2.0-pre3" = _NpyWj8ki;
        "pkg-2.0-pre4+1.18.2-fabric" = _laCshZ9B;
        "pkg-2.0-pre4+1.18.2-forge" = _uOFgT2NP;
        "pkg-2.0+bukkit" = _XdCPczfV;
        "pkg-2.0+1.18.2-fabric" = _YUMvl8lq;
        "pkg-2.0+1.18.2-forge" = _igbgVSFa;
        "pkg-2.0+1.19.2-fabric" = _D1v1ASM1;
        "pkg-2.0+1.19.2-forge" = _tACN13GJ;
        "pkg-2.0+1.20.1-fabric" = _LCDEJc8Z;
        "pkg-2.0+1.20.1-forge" = _ffPmdYmA;
        "pkg-2.0.1+1.18.2-fabric" = _3bbsD2k2;
        "pkg-2.0.1+1.18.2-forge" = _V4dgsrqS;
        "pkg-2.0.1+1.19.2-fabric" = _IpNpbO5F;
        "pkg-2.0.1+1.19.2-forge" = _iliJh8xD;
        "pkg-2.0.1+1.20.1-fabric" = _v9Pf8bgq;
        "pkg-2.0.1+1.20.1-forge" = _XoBpSYxz;
        "pkg-2.0.2+1.18.2-fabric" = _dY1YsiUt;
        "pkg-2.0.2+1.18.2-forge" = _rdFGW6qa;
        "pkg-2.0.2+1.19.2-fabric" = _kURhycbN;
        "pkg-2.0.2+1.19.2-forge" = _hjd0cSUX;
        "pkg-2.0.2+1.20.1-fabric" = _3Jyw2Xwl;
        "pkg-2.0.2+1.20.1-forge" = _98NkXoLa;
        "pkg-2.0.5+1.18.2-fabric" = _dkcP18qG;
        "pkg-2.0.5+1.18.2-forge" = _hWplKNvi;
        "pkg-2.0.5+1.19.2-fabric" = _vgyUhWoc;
        "pkg-2.0.5+1.20.1-fabric" = _rrxOfdIe;
        "pkg-2.0.5+1.19.2-forge" = _RCnD3N5P;
        "pkg-2.0.5+1.20.1-forge" = _OVBWwlVg;
        "pkg-2.0.5+1.20.2-fabric" = _Sml1jpk5;
        "pkg-2.0.5_01+1.20.2-fabric" = _DLNLJf0g;
        "pkg-2.0.5_02+1.20.2-fabric" = _jRAvZUss;
        "pkg-2.0.6+1.21.1-fabric" = _BZnPOxeo;
        "pkg-2.0.6+1.21.1-neoforge" = _RtqkrsvL;
        "default" = _RtqkrsvL;
    });
