...
let
    ...
    in {
        ...
        "pkg-1.20.5(.6)" = _DunVpgWq;
        "pkg-1.21(.1)" = _R5dTcT0j;
        "pkg-1.21.2(.3)" = _s9NNZcQY;
        "pkg-1.21.4" = _BtShyoM8;
        "pkg-1.21.5" = _pEHP858G;
        "pkg-1.21.6" = _LhjA3cU8;
        "pkg-1.21.7(.8)" = _AtvHnNPS;
        "pkg-1.21.9(.10)" = _WVS7cxQc;
