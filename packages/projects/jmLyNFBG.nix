...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _ThR1dBiA;
        "pkg-1.18.2-2.0-fabric" = _WFJ4sKXL;
        "pkg-1.19.2-2.1-fabric" = _Ymyd6q2g;
        "pkg-1.16.5-1.6-forge" = _wDhFy4uy;
        "pkg-1.18.2-1.7-forge" = _YXOFZYhT;
        "pkg-1.19.2-1.9-forge" = _ChMWDBdM;
        "pkg-1.16.5-2.2-fabric" = _lDxoYoft;
        "pkg-1.18.2-2.2-fabric" = _UGS6d0O2;
        "pkg-1.19.2-2.2-fabric" = _OSPoMGvj;
        "pkg-1.19.3-2.3-fabric" = _7I1395ts;
        "pkg-1.19.3-1.9-forge" = _hjXvWTHX;
        "pkg-1.18.2-3.0-forge+fabric" = _p3R5hUT8;
        "pkg-1.19.2-3.0-forge+fabric" = _O8dlZ2o1;
        "pkg-1.19.3-3.0-forge+fabric" = _IrEOoo5u;
        "pkg-1.18.2-3.1-forge+fabric" = _YZdUQp8t;
        "pkg-1.19.2-3.1-forge+fabric" = _ONPV6G0A;
        "pkg-1.19.3-3.1-forge+fabric" = _qJN7GILR;
        "pkg-1.19.4-3.1-forge+fabric" = _Sf0WMO5N;
        "pkg-1.20-3.1-forge+fabric" = _pRrAErgv;
        "pkg-1.20.1-3.1-forge+fabric" = _CfKwLn0x;
        "pkg-1.20.2-3.1-forge+fabric" = _WaF1jHp8;
        "pkg-1.18.2-3.2-forge+fabric" = _KOBtBPbK;
        "pkg-1.19.2-3.2-forge+fabric" = _fsQRRQ7G;
        "pkg-1.20.1-3.2-forge+fabric" = _aHCkC7Fs;
        "pkg-1.20.2-3.2-forge+fabric" = _bgstFfD4;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _I1Fbx1rJ;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _wsPHUGKg;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _NZ4rPeLj;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _nsRDsA9n;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _QzSxzaHX;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _SPHG7Zmm;
        "pkg-1.20.5-3.3-fabric+neo" = _h2HuyG9G;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _UKtEPiLR;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _lNlGsH9c;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _wcnSdq3t;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _UffxuJMs;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _tIseq7aT;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _dyBEg7Br;
        "pkg-1.21.2-3.4-fabric+neo" = _lqZ5a9KH;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _UaEoSRHm;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _PBAE6Ypb;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _fDXv4XYw;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _Nu7LsrvO;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _4DQzcvxg;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _4fNUyw0S;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _vdRe9hX7;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _UmkEGrMA;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _xr9fPLT0;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _RXG8Qx47;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _YBnVUDfb;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _uCZEtWWi;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _Yg0kcOjo;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _f0fFzjRF;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _GziPjaOO;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _6h3yJUEW;
        "default" = _6h3yJUEW;
    });
