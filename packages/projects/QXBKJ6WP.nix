...
let
    ...
    in {
        ...
        "pkg-1.10-0.0.1alpha" = _jJluksHM;
        "pkg-1.11-0.0.1alpha" = _Fyw0RXu8;
        "pkg-1.10-0.0.15alpha" = _3VWKda82;
        "pkg-1.11-0.0.15alpha" = _th4WPZku;
        "pkg-1.10-0.0.17alpha" = _xOwjNRWf;
        "pkg-1.11-0.0.17alpha" = _te6PfCMo;
        "pkg-1.10-0.0.21alpha" = _2JsJN2pe;
        "pkg-1.11-0.0.21alpha" = _CE62Wlvd;
        "pkg-1.10-0.0.30alpha" = _2SVOcd7Z;
        "pkg-1.11-0.0.30alpha" = _oK0Czt8e;
        "pkg-1.10-0.0.33alpha" = _RNqE3qRb;
        "pkg-1.11-0.0.33alpha" = _nrdBxZGb;
        "pkg-1.10-0.0.39beta" = _iglzEU0m;
        "pkg-1.11-0.0.39beta" = _aPMcX1Aj;
        "pkg-1.10-0.1.0" = _EaB2vwzj;
        "pkg-1.11-0.1.0" = _o9R7xrIY;
        "pkg-1.10-0.1.1" = _epkWwFWT;
        "pkg-1.11-0.1.1" = _6kDfIIfi;
        "pkg-1.11-0.1.3" = _aUX6ZVhV;
        "pkg-1.10-0.1.3" = _x9r9d7Cy;
        "pkg-1.10-0.1.4" = _eJ54EgDN;
        "pkg-1.11-0.1.4" = _szMlUSkE;
        "pkg-1.10-0.1.6" = _xZUml3Vk;
        "pkg-1.11-0.1.6" = _vDO6jUkB;
        "pkg-1.11.2-0.1.6" = _FtfglFZQ;
        "pkg-1.10-0.1.7" = _2NX4GUke;
        "pkg-1.11.2-0.1.7" = _E1Laa3mG;
        "pkg-1.11-0.1.7" = _wnfWQQ06;
        "pkg-1.10-0.2.1" = _SoCxcpsM;
        "pkg-1.11.2-0.2.1" = _u99L0naS;
        "pkg-1.10-0.2.2" = _FJYgaaMH;
        "pkg-1.11.2-0.2.2" = _Ni28r4oF;
        "pkg-1.10-0.2.5" = _IIKdOnCd;
        "pkg-1.11.2-0.2.5" = _8eCP33mU;
        "pkg-1.10-0.2.8" = _iLec9Xe3;
        "pkg-1.11.2-0.2.8" = _QnwZR1LE;
        "pkg-1.10-0.2.9" = _zPlCaNYz;
        "pkg-1.11.2-0.2.9" = _YUCRTCtt;
        "pkg-1.10-0.3.0" = _b4jVIaiv;
        "pkg-1.11.2-0.3.0" = _Eu9VdthC;
        "pkg-1.10-0.3.1" = _i5gMEP72;
        "pkg-1.11.2-0.3.1" = _XZPEooqq;
        "default" = _XZPEooqq;
    });
