...
let
    ...
    in {
        ...
        "pkg-1.0.4+1.21.4" = _oaXPRIRF;
        "pkg-1.0.5+1.21.4" = _3oDqL9gb;
        "pkg-2.0.1+neoforge+1.21.1" = _aTfk8tqt;
        "pkg-2.0.1+paper+1.21.1" = _hM9WjnRf;
        "pkg-2.0.1+fabric+1.21.1" = _EErFKHNE;
        "pkg-2.0.2+fabric+1.21.1" = _IFAKynZ5;
        "pkg-2.0.2+neoforge+1.21.1" = _42c1WR1g;
        "pkg-2.0.2+paper+1.21.1" = _WOjhID2f;
        "pkg-2.0.3+fabric+26.1" = _2cK9PkVY;
        "pkg-2.0.3+neoforge+26.1" = _TTkoqZv0;
        "pkg-2.0.4+neoforge+26.1" = _QHIsDJgG;
        "pkg-2.0.4+fabric+26.1" = _wIXK3aQp;
        "pkg-2.0.4+paper+26.1" = _vCK7evKo;
        "pkg-2.1.0+fabric+26.1" = _rr511CLW;
        "pkg-2.1.0+paper+26.1" = _loBrLlZ9;
        "pkg-2.1.0+neoforge+26.1" = _BbT8birr;
