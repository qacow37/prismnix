...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha.12+1.20" = _nRtvB6o8;
        "pkg-1.0.0-alpha.13+1.20" = _DsQHkF7S;
        "pkg-1.0.0-alpha.13+1.20.4" = _RGPbaJB4;
        "pkg-1.0.0-alpha.14+1.20" = _VATX6Z6I;
        "pkg-1.0.0-alpha.15+1.20" = _ohhDVKeu;
        "pkg-1.0.0-alpha.17+1.20" = _X20bvEYB;
        "pkg-1.0.0-alpha.17+1.20.4" = _tT0z9UUk;
        "pkg-1.0.0-alpha.18+1.20" = _g5fzQg3q;
        "pkg-1.0.0-alpha.19+1.20" = _im5D3uOW;
        "pkg-1.0.0-alpha.19+1.20.4" = _LEAS0Ngb;
        "pkg-1.0.0-alpha.21+1.20" = _ofCmU74f;
        "pkg-1.0.0-alpha.22+1.20" = _Einwo5FP;
        "pkg-1.0.0-alpha.22+1.20.4" = _zpSz4FIP;
        "pkg-1.0.0-alpha.23+1.20" = _zS9BMWcZ;
        "pkg-1.0.0-alpha.23+1.20.4" = _nax07TwE;
        "pkg-1.0.0-alpha.24+1.20" = _vC3ZtxFG;
        "pkg-1.0.0-alpha.24+1.20.4" = _uIHnfmxP;
        "pkg-1.0.0-beta.2+1.21" = _S4kZlNx6;
        "pkg-1.0.0-beta.4+1.21" = _886aB9gi;
        "pkg-1.0.0-beta.5+1.21" = _yU7BguLh;
        "pkg-1.0.0-alpha.25+1.20" = _Nbdtrvd8;
        "pkg-1.0.0-alpha.25+1.20.4" = _PIrIjGxS;
        "pkg-1.0.0-beta.6+1.21" = _TIJEz3Xn;
        "pkg-1.0.0-alpha.26+1.20" = _fZLJ9rHb;
        "pkg-1.0.0-beta.7+1.21" = _qRe5euSW;
        "pkg-1.0.0-beta.8+1.21" = _iON6XUil;
        "pkg-1.0.0-beta.12+1.21" = _i86Mabic;
        "pkg-1.0.0-beta.14+1.21" = _b8nBoC3T;
        "pkg-1.0.0-alpha.27+1.20" = _N4BcSjMY;
        "pkg-1.0.0-beta.15+1.21" = _H2pFFdoE;
        "pkg-1.0.0-beta.16+1.21" = _QeI6iCJc;
        "pkg-1.0.0-beta.17+1.21" = _qN9YzTRA;
        "pkg-1.0.0-beta.18+1.21" = _6V4Vro3o;
        "pkg-1.0.0-beta.19+1.21" = _YaRObjsm;
        "pkg-1.0.0-beta.20+1.21" = _xeEqONgQ;
        "pkg-1.0.0-beta21+1.20.1" = _hiHgO20T;
        "pkg-1.0.0-beta.21+1.20.1" = _lCWG77FW;
        "pkg-1.0.0-beta21+1.21" = _qwvTGnH0;
        "pkg-1.0.0-beta.21+1.21" = _2gNTBzxJ;
        "pkg-1.0.0-beta.22+1.20.1" = _uTIEWt27;
        "pkg-1.0.0-beta.23+1.21" = _ok7jNSEY;
        "pkg-1.0.0-beta.24+1.21" = _b64rzlM6;
        "pkg-1.0.0-beta25+1.21" = _2iVwJKFY;
        "pkg-1.0.0-beta.25+1.21" = _mGGg32Ww;
        "pkg-1.0.0-beta25+1.20.1" = _EtMLIo6y;
        "pkg-1.0.0-beta.25+1.20.1" = _pbvKvMuJ;
        "pkg-1.0.0-beta26+1.20.1" = _2cgWKDry;
        "pkg-1.0.0-beta26+1.21" = _JKWFF5Y6;
        "pkg-1.0.0-beta.26+1.20.1" = _BzQ6uFHd;
        "pkg-1.0.0-beta.26+1.21" = _dHqkfQmG;
        "pkg-1.0.0-beta.27+1.20.1" = _BSX09h0Q;
        "pkg-1.0.0-beta.27+1.21" = _2FYDOJ0h;
        "pkg-1.0.0-beta.28+1.20.1" = _kiC6y5D5;
        "pkg-1.0.0-beta.28+1.21" = _HBlMwb2K;
        "pkg-1.0.0-beta28+1.20.1" = _NpARuZpu;
        "pkg-1.0.0-beta28+1.21" = _id8j4c2J;
        "pkg-1.0.0-beta.30+1.20.1" = _pjV18BAl;
        "pkg-1.0.0-beta.30+1.21" = _P0OqIgCB;
        "pkg-1.0.0-beta30+1.20.1" = _FAM1qTvS;
        "pkg-1.0.0-beta30+1.21" = _5MSeQMxC;
        "pkg-1.0.0-beta31+1.20.1" = _cYdrXlQq;
        "pkg-1.0.0-beta.31+1.21" = _tjTJQ92f;
        "pkg-1.0.0-beta.31+1.20.1" = _aEyteEvx;
        "pkg-1.0.0-beta.33+1.21" = _pclHsc43;
        "pkg-1.0.0-beta.34+1.21" = _uke5b1SA;
        "pkg-1.0.0-beta.35+1.21" = _nDjQ9Zvd;
        "pkg-1.0.0-beta35+1.20.1" = _q7J69GbN;
        "pkg-1.0.0-beta.35+1.20.1" = _SxoModSL;
        "pkg-1.0.0-beta36+1.20.1" = _FaoxARTF;
        "pkg-1.0.0-beta.36+1.20.1" = _MfufPc8e;
        "pkg-1.0.0-beta37+1.20.1" = _qCiByjnQ;
        "pkg-1.0.0-beta.37+1.20.1" = _AQqhUC8T;
        "pkg-1.0.0-beta38+1.20.1" = _JlthTM1u;
        "pkg-1.0.0-beta.38+1.20.1" = _S6987gMH;
        "pkg-1.0.0-beta.39+1.20.1" = _gGlF7UtO;
        "pkg-1.0.0-beta39+1.20.1" = _ESiPKc9e;
        "pkg-1.0.0-beta40+1.20.1" = _t7mBC14r;
        "pkg-1.0.0-beta.40+1.20.1" = _cSwoqMsT;
        "pkg-1.1.0-beta.3+1.21.1" = _tXCHeBZs;
        "pkg-1.0.0-beta41+1.20.1" = _FvEv5xZ7;
        "pkg-1.0.0-beta.41+1.20.1" = _TK44XAd7;
        "pkg-1.1.0-beta.4+1.21.1" = _N5ZoH1Nk;
        "pkg-1.1.0-beta.5+1.21.1" = _cQsHAmaU;
        "pkg-1.1.0-beta.6+1.21.1" = _D4VuX9rd;
        "pkg-1.1.0-beta.7+1.21.1" = _u560N1Ek;
        "pkg-1.1.0-beta.8+1.21.1" = _P7pV6SRU;
        "pkg-1.1.0-beta.9+1.21.1" = _v9qbu9UZ;
        "pkg-1.1.0-beta.10+1.21.1" = _eyt2SXmZ;
        "pkg-1.1.0-beta.12+1.21.1" = _dWvgVAZc;
        "pkg-1.1.0-beta.13+1.21.1" = _uxu8On9I;
        "pkg-1.1.0-beta.14+1.21.1" = _5CkHnpcM;
        "pkg-1.1.0-beta.15+1.21.1" = _gLvnHNTr;
        "pkg-1.1.0-beta.16+1.21.1" = _j6K4uRb7;
        "pkg-1.0.0-beta42+1.20.1" = _1MWeROAl;
        "pkg-1.2.3-beta+1.21.2" = _7hsuvlEg;
        "pkg-1.2.4-beta+1.21.2" = _un0ofaj0;
        "pkg-1.1.0-beta.18+1.21.1" = _qahZmSvY;
        "pkg-1.2.5-beta+1.21.4" = _IcmXXNDR;
        "pkg-1.1.0-beta.19+1.21.1" = _APxXYS5i;
        "pkg-1.2.6-beta+1.21.4" = _NKO8O2h6;
        "pkg-1.2.7-beta+1.21.4" = _QeXuQ7wW;
        "pkg-1.2.8-beta+1.21.4" = _67Wg2go6;
        "pkg-1.0.0-beta43+1.20.1" = _LFVy5GGM;
        "pkg-1.2.9-beta+1.21.4" = _rEo0zDn8;
        "pkg-1.1.0-beta.20+1.21.1" = _bsUSlsGK;
        "pkg-1.2.10-beta+1.21.4" = _Tzi5qJAI;
        "pkg-1.1.0-beta.21+1.21.1" = _KZCvt7ZC;
        "pkg-1.2.11-beta+1.21.4" = _4mxuX9Np;
        "pkg-1.0.0-beta.43+1.20.1" = _wBZWoGOv;
        "pkg-1.1.0-beta.22+1.21.1" = _Va8yNy4c;
        "pkg-1.2.13-beta+1.21.4" = _jfyUxWp4;
        "pkg-1.1.0-beta.23+1.21.1" = _wyWDZ3pi;
        "pkg-1.2.14-beta+1.21.4" = _G9pH1K2Y;
        "pkg-1.0.0-beta44+1.20.1" = _igLFsvmp;
        "pkg-1.0.0-beta.44+1.20.1" = _Xg1oFHpa;
        "pkg-1.1.0-beta.24+1.21.1" = _BAwttV6o;
        "pkg-1.2.15-beta+1.21.4" = _YGEneliu;
        "pkg-1.1.0-beta.25+1.21.1" = _1chBAFUQ;
        "pkg-1.1.0-beta.26+1.21.1" = _ltcalanr;
        "pkg-1.1.0-beta.27+1.21.1" = _Asn2SiwQ;
        "pkg-1.2.16-beta+1.21.4" = _VJKU00nm;
        "pkg-1.0.0-beta45+1.20.1" = _OKj6jvX5;
        "pkg-1.0.0-beta.45+1.20.1" = _cJpb260t;
        "pkg-1.1.0-beta.28+1.21.1" = _J2DCUCN6;
        "pkg-1.2.17-beta+1.21.4" = _Gn2u0arv;
        "pkg-1.0.0-beta46+1.20.1" = _WUQZDiqP;
        "pkg-1.0.0-beta.46+1.20.1" = _fShAEh0P;
        "pkg-1.2.18-beta+1.21.4" = _8fhXRvKl;
        "pkg-1.1.0-beta.29+1.21.1" = _rqtEHWv9;
        "pkg-1.1.0-beta.30+1.21.1" = _Iqlnuz8j;
        "pkg-1.0.0-beta.47+1.20.1" = _BmhkZr5J;
        "pkg-1.1.0-beta.31+1.21.1" = _F4KFmobM;
        "pkg-1.2.19-beta+1.21.4" = _wmLc2Y7f;
        "pkg-1.1.0-beta.32+1.21.1" = _6qoPuCbc;
        "pkg-1.1.0-beta.33+1.21.1" = _UnH2jx8v;
        "pkg-1.1.0-beta.34+1.21.1" = _Xe7f8q7s;
        "pkg-1.1.0-beta.35+1.21.1" = _9HPe0p25;
        "pkg-1.1.0-beta.36+1.21.1" = _v4WqKEp1;
        "pkg-1.1.0-beta.37+1.21.1" = _WgpCS0gK;
        "pkg-1.1.0-beta.38+1.21.1" = _GxMO9mCT;
        "pkg-1.1.0-beta.39+1.21.1" = _wYVgZ0Vh;
        "pkg-1.1.0-beta.40+1.21.1" = _8iGovHhK;
        "pkg-1.1.0-beta.41+1.21.1" = _RgCyqUyE;
        "pkg-1.1.0-beta.42+1.21.1" = _OkEXRo1t;
        "pkg-1.1.0-beta.43+1.21.1" = _tGXSkce6;
        "pkg-1.1.0-beta.44+1.21.1" = _4XDFJZks;
        "pkg-1.1.0-beta.45+1.21.1" = _o6CV5p8s;
        "pkg-1.1.0-beta.46+1.21.1" = _d6QrS0ry;
        "pkg-1.1.0-beta.47+1.21.1" = _v3eSsJ3x;
        "pkg-1.1.0-beta.48+1.21.1" = _sw4KrsN6;
        "pkg-1.3.1-beta+1.21.5" = _KJPKtJUD;
        "pkg-1.3.1-beta+1.21.8" = _2XK5yLBZ;
        "pkg-1.3.2-beta+1.21.8" = _FBIVJ8RA;
        "pkg-1.3.3-beta+1.21.5" = _nNM2tmpF;
        "pkg-1.3.3-beta+1.21.8" = _uPHXYRzq;
        "pkg-1.3.4-beta+1.21.5" = _kbxKVvUK;
        "pkg-1.3.4-beta+1.21.8" = _wJLStnNu;
        "pkg-1.1.0-beta.49+1.21.1" = _JrcLx7sg;
        "pkg-1.3.5-beta+1.21.8" = _8TRChFqE;
        "pkg-1.1.0-beta.50+1.21.1" = _pskTCKIg;
        "pkg-1.1.0-beta.51+1.21.1" = _t2XlVj4I;
        "pkg-1.1.0-beta.52+1.21.1" = _uPPIhLTH;
        "pkg-1.3.6-beta+1.21.8" = _TGPkbOmE;
        "pkg-1.3.7-beta+1.21.8" = _PZJxnt9A;
        "pkg-1.3.8-beta+1.21.8" = _MP4v9WZU;
        "pkg-1.4.0-beta+1.21.10" = _RIa8JoNX;
        "pkg-1.0.0-beta48+1.20.1" = _ALKwAjwA;
        "pkg-1.0.0-beta.48+1.20.1" = _A7wwzJ0e;
        "pkg-1.4.1-beta" = _BlpBD6EU;
        "pkg-1.4.2-beta" = _8knNuTWh;
        "pkg-1.4.3-beta" = _1xWn5eYc;
        "pkg-1.1.0-beta.53+1.21.1" = _Xlt4eWBe;
        "default" = _Xlt4eWBe;
    });
