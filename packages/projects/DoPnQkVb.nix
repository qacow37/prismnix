...
let
    ...
    in {
        ...
        "pkg-0.2.0" = _Eidy0HPV;
        "pkg-0.2.1" = _TxpPevgj;
        "pkg-0.3.0+1.21.10-fabric" = _PuiOBEBf;
        "pkg-0.3.0+1.20.1-fabric" = _NYgZ23HV;
        "pkg-0.3.0+1.21.1-fabric" = _fFmaO80X;
        "pkg-0.3.0+1.21.11-fabric" = _rulr1LFj;
        "pkg-0.3.1+1.21.11-fabric" = _lmGdyf5c;
        "pkg-0.3.1+1.21.1-fabric" = _wz5KQHKj;
        "pkg-0.3.1+1.20.1-fabric" = _fPgQcRpx;
        "pkg-0.3.1+1.21.10-fabric" = _OniqdnTz;
        "pkg-0.3.1+1.21.10-neoforge" = _7szY3zkM;
        "pkg-0.3.1+1.21.11-neoforge" = _QHxC5GLu;
        "pkg-0.3.1+1.21.1-neoforge" = _OuJ5pPrV;
        "pkg-0.4.0+1.21.1-neoforge" = _BIUo2zAz;
        "pkg-0.4.0+1.21.10-fabric" = _TIXYNWDc;
        "pkg-0.4.0+1.21.10-neoforge" = _CCjhOylX;
        "pkg-0.4.0+1.21.11-neoforge" = _58tqlarh;
        "pkg-0.4.0+1.21.11-fabric" = _xfAqPlmm;
        "pkg-0.4.0+1.20.1-fabric" = _NGYX5rSi;
        "pkg-0.4.0+1.21.1-fabric" = _VHEE2Mf0;
        "pkg-0.5.0+1.21.1-neoforge" = _xh0VlYkk;
        "pkg-0.5.0+1.20.1-fabric" = _UbjIunVB;
        "pkg-0.5.0+1.21.1-fabric" = _H52hQ9V5;
        "pkg-0.5.0+1.21.11-neoforge" = _QkU9e09w;
        "pkg-0.5.0+1.21.11-fabric" = _386crL95;
        "pkg-0.5.0+1.21.10-neoforge" = _1WStS0V1;
        "pkg-0.5.0+1.21.10-fabric" = _rQeUl0Gu;
        "pkg-0.5.0+1.20.1-forge" = _bHM3NRUJ;
        "pkg-0.5.1+1.21.1-neoforge" = _AYn4T3Lb;
        "pkg-0.5.1+1.21.11-neoforge" = _QUD3BOi4;
        "pkg-0.5.1+1.21.10-neoforge" = _srnx14GJ;
        "pkg-0.5.1+1.20.1-fabric" = _VCyctNKQ;
        "pkg-0.5.1+1.20.1-forge" = _ieR9obLy;
        "pkg-0.5.1+1.21.10-fabric" = _ZuqbMFy4;
        "pkg-0.5.1+1.21.1-fabric" = _Gb4orR8b;
        "pkg-0.5.1+1.21.11-fabric" = _ACUdGLEK;
        "pkg-0.5.3-neoforge+1.21.1" = _jLZuutYq;
        "pkg-0.5.3-neoforge+1.21.11" = _odKx3QqI;
        "pkg-0.5.3-neoforge+1.21.10" = _4sg0ux03;
        "pkg-0.5.3-fabric+26.1.2" = _f31HZ7T4;
        "pkg-0.5.3-fabric+1.20.1" = _jNzZCF4v;
        "pkg-0.5.3-forge+1.20.1" = _deuv6Qgc;
        "pkg-0.5.3-fabric+1.21.1" = _i2p1VKft;
        "pkg-0.5.3-fabric+1.21.10" = _ryPb4hWq;
        "pkg-0.5.3-fabric+1.21.11" = _3goxNINi;
        "pkg-0.5.3-neoforge+26.1.2" = _nbwHjI9N;
        "default" = _nbwHjI9N;
    });
