...
let
    ...
    in {
        ...
        "pkg-1.19-1.19.2" = _WAAeCVPO;
        "pkg-1.19.3" = _Ka3u5KSK;
        "pkg-1.19.4" = _3wwEjdHr;
        "pkg-1.20-1.20.1" = _eekVHHkB;
        "pkg-1.20.2" = _iNJXtNpd;
        "pkg-1.20.3-1.20.4" = _OKEAwiz0;
        "pkg-1.20.5-1.20.6" = _7I2ppjs5;
        "pkg-1.21" = _p0d3Tjgi;
        "pkg-1.16" = _9tacfUNO;
        "pkg-1.17" = _218hgbPH;
        "pkg-1.18" = _jYkHTszi;
        "pkg-1.19" = _kjrd3Jb0;
        "pkg-1.20" = _t41LaJsT;
        "pkg-1.21.2-1.21.3" = _PXCwdPqA;
        "pkg-1.21.4" = _rbfteZhu;
        "pkg-1.21-1.21.1" = _A758br4a;
        "pkg-1.21.5" = _Hk0D3huL;
        "pkg-N5+" = _XQN5VhOR;
        "pkg-N6" = _odFOlUIQ;
        "pkg-N6.1" = _h5MeLKYN;
        "pkg-N6.2" = _zQZD2cmS;
