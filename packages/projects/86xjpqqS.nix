...
let
    ...
    in {
        ...
        "pkg-2.4.0" = _j2dRkLlH;
        "pkg-2.4.1" = _J8adMI9b;
        "pkg-2.5.0-fabric+mc1.20.1" = _D2mgjTng;
        "pkg-2.5.0-forge+mc1.20.1" = _UtrKttta;
        "pkg-2.5.0-fabric+mc1.21.1" = _kUaC0sA1;
        "pkg-2.5.0-neoforge+mc1.21.1" = _E4XYB2II;
        "pkg-2.5.1-forge+mc1.20.1" = _4aj1O0iH;
        "pkg-2.5.1-fabric+mc1.20.1" = _idfRUdS8;
        "pkg-2.5.1-neoforge+mc1.21.1" = _ODG4m688;
        "pkg-2.5.1-fabric+mc1.21.1" = _I4T9J4du;
        "pkg-2.5.2-fabric+mc1.20.1" = _nTdqE6pr;
        "pkg-2.5.2-forge+mc1.20.1" = _Iyk8rkIt;
        "pkg-2.5.2-fabric+mc1.21.1" = _9gCrv5hX;
        "pkg-2.5.2-neoforge+mc1.21.1" = _pnv6UGY9;
        "pkg-2.5.3-fabric+mc1.20.1" = _2dRDUBnW;
        "pkg-2.5.3-forge+mc1.20.1" = _R6Br9z7G;
        "pkg-2.5.3-fabric+mc1.21.1" = _pTVoY5Gd;
        "pkg-2.5.3-neoforge+mc1.21.1" = _W3Wrogcg;
        "pkg-2.6.0-fabric+mc1.20.1" = _3daTJfgo;
        "pkg-2.6.0-forge+mc1.20.1" = _xWdKZ3jx;
        "pkg-2.6.0-fabric+mc1.21.1" = _bcK8N99N;
        "pkg-2.6.0-neoforge+mc1.21.1" = _EUj0kHse;
        "pkg-2.6.1-fabric+mc1.20.1" = _FoqVlMVr;
        "pkg-2.6.1-forge+mc1.20.1" = _Rerm6ldb;
        "pkg-2.6.1-fabric+mc1.21.1" = _Zqw4AFmA;
        "pkg-2.6.1-neoforge+mc1.21.1" = _8tJt8sKo;
        "pkg-2.6.2-forge+mc1.20.1" = _2820MGTO;
        "pkg-2.6.2-fabric+mc1.20.1" = _XJWHVIu8;
        "pkg-2.6.2-neoforge+mc1.21.1" = _1AWGcwFZ;
        "pkg-2.6.2-fabric+mc1.21.1" = _vsaCZM0r;
        "pkg-2.6.3-fabric+mc1.20.1" = _CDKpB2cg;
        "pkg-2.6.3-forge+mc1.20.1" = _dgamA1Ok;
        "pkg-2.6.3-fabric+mc1.21.1" = _AGF9m4RS;
        "pkg-2.6.3-neoforge+mc1.21.1" = _yLfwunzP;
        "pkg-2.6.4-fabric+mc1.20.1" = _Z4UvvDev;
        "pkg-2.6.4-forge+mc1.20.1" = _6tgs5ocU;
        "pkg-2.6.4-fabric+mc1.21.1" = _vSV2uMfq;
        "pkg-2.6.4-neoforge+mc1.21.1" = _CWX95o44;
        "pkg-2.6.5-fabric+mc1.20.1" = _LF0NYrRj;
        "pkg-2.6.5-forge+mc1.20.1" = _Zqooxsd2;
        "pkg-2.6.5-fabric+mc1.21.1" = _eGOUtHWJ;
        "pkg-2.6.5-neoforge+mc1.21.1" = _HZWaR0LY;
        "pkg-2.6.5-neoforge+mc26.1" = _78uaGTwW;
        "pkg-2.6.5-neoforge+mc26.1-hotfix" = _1rPJlKDJ;
        "default" = _1rPJlKDJ;
    });
