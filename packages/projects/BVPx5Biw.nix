...
let
    ...
    in {
        ...
        "pkg-1.5.1" = _dwUaqqy5;
        "pkg-1.5.2" = _5pk3UK2K;
        "pkg-1.1-OV" = _ysr5n4tF;
        "pkg-1.2-OV" = _yommAg8I;
        "pkg-1.5.3" = _sV3rqs0K;
        "pkg-1.5.3_02" = _jxwS66o5;
        "pkg-1.5.3_02-server" = _45MteQht;
        "pkg-Alpha1.5.4" = _GV6xl4Ui;
        "pkg-1.5.4" = _eU59c6XM;
        "pkg-1.1-NV" = _Ge7jHRop;
        "pkg-1.3D" = _j4Voh0bw;
        "pkg-1.5.4_01" = _XNGcjEZD;
        "pkg-1.3.1D" = _ht7227jb;
        "pkg-1.5.5" = _AvTA2rfF;
        "pkg-1.0-ADDON" = _d4ZZIkUc;
        "pkg-1.1-ADDON" = _AmFnz9PT;
        "pkg-0.5" = _KoPKYm0Q;
        "pkg-1.6" = _rgEQj9Qe;
        "pkg-1.6.1" = _msKtKD7c;
        "pkg-1.6.2" = _6ytun9Ua;
