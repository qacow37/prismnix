...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.3.0-forge" = _YkK8Bd84;
        "pkg-1.19.4-2.2.1-fabric" = _rSKjK9Um;
        "pkg-1.19.4-1.3.1-forge" = _MTVqWk7F;
        "pkg-1.20-2.2.2-fabric" = _uT6NnI6k;
        "pkg-1.20-1.3.2-forge" = _GUGRFm5k;
        "pkg-1.20.1-2.2.3-fabric" = _9ntdShFb;
        "pkg-1.20.1-1.3.3-forge" = _JS0ehUbr;
        "pkg-1.20.2-2.2.3-fabric" = _HBqrimuF;
        "pkg-1.20.2-1.3.3-forge" = _LEIJ1nqr;
        "pkg-1.20.2-1.3.4-forge" = _McHastx1;
        "pkg-1.20.3-2.2.3-fabric" = _fnGyuS1M;
        "pkg-1.20.3-1.3.4-forge" = _qrNGp7hk;
        "pkg-1.20.4-2.2.3-fabric" = _PfGCVLCo;
        "pkg-1.20.4-1.3.4-forge" = _spaa8r54;
        "pkg-1.20.2-1.3.6-forge" = _fmB2Imhp;
        "pkg-1.20.4-1.3.6-forge" = _2NHCWNgL;
        "pkg-1.20.2-3.0.0-neoforge" = _h4tPQHhq;
        "pkg-1.20.4-3.0.0-neoforge" = _P2h8tm0k;
        "pkg-1.20.5-3.0.1-neoforge" = _PheZubcO;
        "pkg-1.20.6-3.0.1-neoforge" = _u5Lx1NuZ;
        "pkg-1.20.5-2.2.4-fabric" = _Wt733DFj;
        "pkg-1.20.6-2.2.4-fabric" = _X6bg9eeC;
        "pkg-1.20.6-1.3.7-forge" = _ssYpfm9c;
        "pkg-1.21-3.0.1-neoforge" = _N07w27mM;
        "pkg-1.21-2.2.4-fabric" = _Jlcqzf5e;
        "pkg-1.21-1.3.7-forge" = _Y20y30IK;
        "pkg-1.21-3.0.2-neoforge" = _sMc2HTnr;
        "pkg-1.21-2.2.5-fabric" = _4mslBAc1;
        "pkg-1.21-1.3.8-forge" = _LEbHaAQc;
        "pkg-1.21.3-1.3.9-forge" = _9KiXKyQp;
        "pkg-1.21.3-2.2.6-fabric" = _bvMkjyGm;
        "pkg-1.21.3-3.0.4-neoforge" = _5ael0GbX;
        "pkg-1.21.1-1.3.8-forge" = _kZHy6sq5;
        "pkg-1.21.1-2.2.5-fabric" = _i1WCJNIW;
        "pkg-1.21.1-3.0.3-neoforge" = _EpWAw9bz;
        "pkg-1.21.4-1.3.9-forge" = _uL9AoNM9;
        "pkg-1.21.4-2.2.6-fabric" = _QddHC5Vo;
        "pkg-1.21.4-3.0.4-neoforge" = _mCiyA8P2;
        "pkg-1.21.5-1.3.9-forge" = _QazOo6Pd;
        "pkg-1.21.5-2.2.6-fabric" = _UOwcEqa6;
        "pkg-1.21.5-3.0.4-neoforge" = _N0uTy9y1;
        "pkg-1.21.6-2.2.7-fabric" = _4Lzd9qB4;
        "pkg-1.21.7-2.2.7-fabric" = _cf7ZZifa;
        "pkg-1.21.6-3.0.5-neoforge" = _NxUBCYuz;
        "pkg-1.21.7-3.0.5-neoforge" = _RRe1EBo0;
        "pkg-1.21.8-2.2.7-fabric" = _kLvOTDtT;
        "pkg-1.21.8-3.0.5-neoforge" = _aH10R40c;
        "pkg-1.21.10-2.2.7-fabric" = _t2uRnTCD;
        "pkg-1.21.10-3.0.5-neoforge" = _DhByTJLD;
        "pkg-1.21.11-2.2.7-fabric" = _UEWzTWDE;
        "pkg-1.21.11-3.0.5-neoforge" = _gqtEcsB5;
        "pkg-1.21.11-2.4.0-fabric" = _T9eILrdQ;
        "pkg-1.21.11-3.2.0-neoforge" = _LONKSf2n;
        "pkg-1.21.11-2.5.0-fabric" = _TNpQtzgH;
        "pkg-1.21.11-3.3.0-neoforge" = _6AAoGNs7;
        "pkg-26.1-2.5.0-fabric" = _52ln4fi6;
        "pkg-26.1-3.3.0-neoforge" = _OuPMcvp4;
        "pkg-1.20.1-1.4.0-forge" = _7ZdJbCOx;
        "pkg-1.20.1-2.6.0-fabric" = _qD2j03H6;
        "pkg-1.21.1-2.6.0-fabric" = _qSRKiE4D;
        "pkg-1.21.1-3.4.0-neoforge" = _hIJ2Ev1Q;
        "pkg-1.21.11-2.5.1-fabric" = _aS4au8gn;
