...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0-fabric+forge+neo" = _LWd7xg9N;
        "pkg-1.19.2-1.1-fabric+forge+neo" = _yug4cgEd;
        "pkg-1.20.1-1.1-fabric+forge+neo" = _jFZ2dse2;
        "pkg-1.20.2-1.1-fabric+forge+neo" = _NID8288E;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _2Wwx4ZU4;
        "pkg-1.19.2-1.2-fabric+forge+neo" = _85dqWjGV;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _wmyQkihB;
        "pkg-1.20.2-1.2-fabric+forge+neo" = _2uMBQzVu;
        "pkg-1.20.4-1.2-fabric+forge+neo" = _ahR5b6tQ;
        "pkg-1.20.5-1.2-fabric+neo" = _D1UrnoJ5;
        "pkg-1.20.5-1.3-fabric+neo" = _8kuHGjmQ;
        "pkg-1.20.6-1.3-fabric+forge+neo" = _LdKX3DEU;
        "pkg-1.21.0-1.3-fabric+forge+neo" = _QUj8FO7I;
        "pkg-1.20.1-1.4-fabric+forge+neo" = _LrkTNWhg;
        "pkg-1.20.6-1.4-fabric+forge+neo" = _qWeqLPst;
        "pkg-1.21.0-1.4-fabric+forge+neo" = _ueOgEjr5;
        "pkg-1.21.1-1.4-fabric+forge+neo" = _7pIaJBL2;
        "pkg-1.21.2-1.4-fabric+neo" = _wL1WeWit;
        "pkg-1.21.3-1.4-fabric+forge+neo" = _OAoOwi4f;
        "pkg-1.21.4-1.4-fabric+forge+neo" = _qli2arup;
        "pkg-1.20.1-1.5-fabric+forge+neo" = _LOXnpugx;
        "pkg-1.21.1-1.5-fabric+forge+neo" = _LAlrzeG0;
        "pkg-1.21.4-1.5-fabric+forge+neo" = _jlDHXarG;
        "pkg-1.21.5-1.5-fabric+forge+neo" = _NMD5xbbZ;
        "pkg-1.21.6-1.5-fabric+forge+neo" = _39Kmdjcn;
        "pkg-1.21.7-1.5-fabric+forge+neo" = _DU9xZsfo;
        "pkg-1.21.8-1.5-fabric+forge+neo" = _kJ1YT208;
        "pkg-1.21.9-1.5-fabric+forge+neo" = _fe0P69R5;
        "pkg-1.21.10-1.5-fabric+forge+neo" = _6fTT54uw;
        "pkg-1.21.10-1.6-fabric+forge+neo" = _KBOiR6Zq;
        "pkg-1.21.11-1.6-fabric+forge+neo" = _aaQeIjE6;
        "pkg-26.1.0-1.6-fabric+forge+neo" = _CqeREkbC;
