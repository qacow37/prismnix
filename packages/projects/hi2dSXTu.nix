...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.8.10" = _4BqiwruC;
        "pkg-1.20.2-1.9.3" = _5yP6idVz;
        "pkg-1.20.2-1.9.4" = _9nnOsBF6;
        "pkg-1.20.4-1.9.5" = _YRAn7e9U;
        "pkg-1.20.4-1.9.6" = _2oOG1Uk2;
        "pkg-1.20.2-1.9.1-forge" = _XfvbJcdd;
        "pkg-1.20.4-1.9.7" = _B9cWSSlA;
        "pkg-1.20.4-1.9.2-forge" = _n5ZiDknb;
        "pkg-1.20.4-1.9.8" = _Utr2Snrk;
        "pkg-1.20.5-1.9.9" = _SoqzoTkg;
        "pkg-1.20.6-1.10.0" = _OuIgYmW4;
        "pkg-1.21-1.10.1" = _v0RpBU28;
        "pkg-1.21-1.11.1" = _IYcefR0v;
        "pkg-1.21.1-1.11.3" = _GTYY4xJc;
        "pkg-1.21.3-1.11.4" = _GBRs7SRl;
        "pkg-1.21.3-1.11.5" = _V5WL7SGw;
        "pkg-fabric-1.21.3-1.11.5" = _95TAAia6;
        "pkg-neoforge-1.21.3-1.12.0" = _NYmaYbi7;
        "pkg-fabric-1.21.3-1.12.0" = _VENjyxvQ;
        "pkg-fabric-1.21.3-1.13.1" = _vAy15NvY;
        "pkg-neoforge-1.21.4-1.13.3" = _m6u12GO5;
        "pkg-fabric-1.21.4-1.13.3" = _NXon146u;
        "pkg-neoforge-1.21.1-1.11.4" = _NKEMiRIu;
        "pkg-1.18.2-1.8.4" = _XKLkDlbi;
        "pkg-neoforge-1.21.5-1.14" = _TURcrwzr;
        "pkg-fabric-1.21.5-1.14" = _AOjoN0Fx;
        "pkg-1.20.1-1.9.1-forge" = _nWSTr4AA;
        "pkg-neoforge-1.21.6-1.14.1" = _1Xz15uMd;
        "pkg-fabric-1.21.6-1.14.1" = _HlOYqqxl;
        "pkg-neoforge-1.21.7-1.14.2" = _UWl0SRn9;
        "pkg-fabric-1.21.7-1.14.2" = _inhPAQe6;
        "pkg-fabric-1.21.8-1.14.3" = _akwEXvER;
        "pkg-neoforge-1.21.8-1.14.4" = _6GEVpOlW;
        "pkg-fabric-1.21.8-1.14.4" = _1wimPzrf;
        "pkg-neoforge-1.21.9-1.14.5" = _zsmwKOUB;
        "pkg-fabric-1.21.9-1.14.5" = _HljZmdWE;
        "pkg-neoforge-1.21.11-1.15.0" = _IgV9zzL6;
        "pkg-fabric-1.21.11-1.15.0" = _GY7sN2TR;
        "pkg-neoforge-26.1-1.16.2" = _m91X4rrm;
