...
let
    ...
    in {
        ...
        "pkg-1.2.4" = _yaSYSNgh;
        "pkg-1.2.5" = _EeTtGlNs;
        "pkg-1.3.0-datapack" = _XYo8WO2T;
        "pkg-1.3.0-mod" = _efywNxQC;
        "pkg-1.3.1-datapack" = _Y0bryQjp;
        "pkg-1.3.1-mod" = _FWPdYKTe;
        "pkg-1.3.2-datapack" = _V1fuWfC5;
        "pkg-1.3.2-mod" = _h5gHugan;
        "pkg-1.4.0-datapack" = _KA8al3z1;
        "pkg-1.4.0-mod" = _PQhP5e6W;
        "pkg-1.4.1-datapack" = _PsxYd7p5;
        "pkg-1.4.1-mod" = _4YQpfwFv;
        "pkg-1.4.2-datapack" = _YZt7N610;
        "pkg-1.4.2-mod" = _VDbAW9Rb;
        "pkg-1.4.3-datapack" = _Xsyd8eIE;
        "pkg-1.4.3-mod" = _6rU5aIOC;
        "pkg-1.4.4-datapack" = _V1CyHFYK;
        "pkg-1.4.4-mod" = _cgQddKSg;
        "default" = _cgQddKSg;
    });
