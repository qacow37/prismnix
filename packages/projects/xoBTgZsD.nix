...
let
    ...
    in {
        ...
        "pkg-1.19.3-0.1" = _3rkAQBcN;
        "pkg-1.19.4-0.1" = _Rx4OvZvE;
        "pkg-1.20-0.1" = _b1vKjQqA;
        "pkg-1.20.1-0.1" = _c8NtUHiz;
        "pkg-1.20.3-0.1" = _LF6nlG2H;
        "pkg-1.20.2-0.1" = _6XYKiqoP;
        "pkg-1.20.4-0.1" = _mt8rIPa3;
        "pkg-0.1+1.19.4" = _BqnFOvsf;
        "pkg-0.1+1.20.1" = _AGcP9zFo;
        "pkg-0.1+1.20.2" = _9jZ2ErFB;
        "pkg-0.1+1.19.2" = _NPHJKtYc;
        "pkg-0.1+1.20.4" = _ilsnIjst;
        "pkg-1.20.5-0.1" = _yRU9xNRS;
        "pkg-1.20.6-0.1" = _s1NxeL9l;
        "pkg-1.21-0.1" = _nu7Oh2Wz;
        "pkg-1.21-0.2" = _GxFUUmX6;
        "pkg-1.21.1-0.1" = _mm4h00Zw;
        "pkg-1.21-0.3" = _6uRraKk0;
        "pkg-1.21.1-0.2" = _eRKRDT8B;
        "pkg-1.21.3-0.1" = _aWLVcE7u;
        "pkg-1.21.4-0.1" = _WsYHWl1Y;
        "pkg-1.21.4-0.2" = _JwOj7oiv;
        "pkg-1.21.5-0.1" = _qfSot4Yx;
        "pkg-1.21.5-0.2" = _uU3Id5E4;
        "pkg-1.21.1-0.3" = _Ht3YT5rH;
        "pkg-1.21.5-0.3" = _wElEJKkz;
        "pkg-1.21.6-0.1" = _CU9Mb5GO;
        "pkg-1.21.7-0.1" = _uPz7HkXk;
        "pkg-1.21.8-0.1" = _RYZRRrWH;
        "pkg-1.21.9-0.1" = _dqzyLQBN;
        "pkg-1.21.10-0.1" = _gLOQP3ah;
        "pkg-1.21.11-0.1" = _WeRBeQJi;
        "pkg-26.1-0.1" = _qbpwSQGT;
