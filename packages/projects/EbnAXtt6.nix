...
let
    ...
    in {
        ...
        "pkg-1.0b-1.21.1" = _plf2jOq7;
        "pkg-1.0b-1.21.4" = _Te8eu4MD;
        "pkg-1.0b-1.21.8" = _H1nO3wPp;
        "pkg-1.0b-1.21.10" = _lNwf5dFM;
        "pkg-1.0b-1.21.11" = _iBomIyQ0;
        "pkg-1.1b-1.21.1" = _C0Lxames;
        "pkg-1.1b-1.21.4" = _7bQE48sv;
        "pkg-1.1b-1.21.8" = _bhavt2cz;
        "pkg-1.1b-1.21.10" = _Gd0Y4N3B;
        "pkg-1.1b-1.21.11" = _uuaPRx7K;
        "pkg-1.2-1.21.1" = _y0tUgJBQ;
        "pkg-1.2-1.21.4" = _EePbZEKA;
        "pkg-1.2-1.21.8" = _dPNuAabU;
        "pkg-1.2-1.21.10" = _xg4gHZjM;
        "pkg-1.2-1.21.11" = _3VypzPFs;
        "pkg-1.3-1.21.1" = _9upIPp3g;
        "pkg-1.3-1.21.4" = _y77n1xtJ;
        "pkg-1.3-1.21.8" = _hSfBBMTD;
        "pkg-1.3-1.21.10" = _yVgoznAO;
        "pkg-1.3-1.21.11" = _x4flm6RJ;
        "pkg-1.3.1-1.21.1" = _gMsrVr9Y;
        "pkg-1.3.1-1.21.4" = _GqQLVKNH;
        "pkg-1.3.1-1.21.8" = _gq3yhwLi;
        "pkg-1.3.1-1.21.10" = _tHjLk76Y;
        "pkg-1.3.1-1.21.11" = _LAtGZOzE;
        "pkg-1.3.2-1.21.11" = _Acr11MXW;
        "default" = _Acr11MXW;
    });
