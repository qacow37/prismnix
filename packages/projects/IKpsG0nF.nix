...
let
    ...
    in {
        ...
        "pkg-b1.0" = _jmwWnSKi;
        "pkg-b1.0.1" = _l5Riioca;
        "pkg-b1.0.2" = _AihqlThW;
        "pkg-b1.0.3" = _7KEesXTq;
        "pkg-b1.0.4" = _KddGjTbY;
        "pkg-b1.4.1" = _fjM0qcIV;
        "pkg-b1.6.0" = _HjNjJ9kt;
        "pkg-b1.6.7" = _BViwZYbB;
        "pkg-b1.6.8" = _zfgH9Tea;
        "pkg-2.0" = _OhZH9yz9;
        "pkg-2.0.1" = _X37xpPrl;
        "pkg-2.0.2" = _qkZypRmp;
        "pkg-1.6.9" = _EK2GGFCu;
        "pkg-2.1.0" = _PsfQzXbw;
        "pkg-2.2.0-beta+1.19.2" = _sPxfkyE2;
        "pkg-2.2.1-beta+1.19.2" = _3bhQV9hJ;
        "pkg-2.2.1-beta+1.19.4" = _f8w7ic6Z;
        "pkg-2.2.1-beta+1.20" = _9DJrqJ6l;
        "pkg-2.2.2-beta+1.20" = _MWPEzB2W;
        "pkg-2.2.3-beta+1.20" = _9nscWYBi;
        "pkg-2.2.4-beta+1.20" = _IJLX3k9B;
        "pkg-2.2.4-beta+1.20.2" = _BwOhoUnP;
        "pkg-2.2.4-beta+1.20.3" = _spHOyO09;
        "pkg-2.2.5-beta+1.20.3" = _JajqQz89;
        "pkg-2.2.5-beta+1.20.5" = _1BPq9c1q;
        "pkg-2.2.6-beta+1.21.0" = _55Vrt7KM;
        "pkg-2.2.7-beta+1.21.0" = _gbfAM10e;
        "pkg-2.3.0-beta+1.21.0" = _3Bq8rTtQ;
        "pkg-2.3.1-beta+1.21.0" = _tm2SOtWv;
        "pkg-2.3.2-beta+1.21.0" = _76xFeLWT;
        "pkg-2.3.3-beta+1.21.0" = _puzv6nDd;
        "pkg-2.2.6-beta+1.20.0" = _DGp36Qov;
        "pkg-2.4.0-beta+1.21.1" = _6sazl0yf;
        "pkg-2.4.0-beta+1.21.1-SINYTRA" = _ZO8BxZrM;
        "pkg-2.4.1-beta+1.21.1" = _T6Yf3voR;
        "pkg-2.4.1-beta+1.21.1-SINYTRA" = _mM7rezUF;
        "pkg-2.4.2-beta+1.21.1" = _nKRloRKM;
        "pkg-2.4.3-beta+1.21.1" = _VwrUeCdp;
        "pkg-2.4.3-beta+1.21.1-SINYTRA" = _HAMdB4QJ;
        "pkg-2.4.4-beta+1.21.1-SINYTRA" = _aEhaKvfL;
        "pkg-2.4.5-beta+1.21.1-SINYTRA" = _NhxMSSQW;
        "pkg-2.4.5-beta+1.21.1" = _P3XQS2ui;
        "pkg-2.4.6-beta+1.21.1" = _kpnTCH47;
        "default" = _kpnTCH47;
    });
