...
let
    ...
    in {
        ...
        "pkg-v8.0.1-1.20.1-Forge" = _bvfHSMxe;
        "pkg-v3.0.0-1.18.2-Forge" = _9NFnws72;
        "pkg-v3.0.0-1.18.2-Fabric" = _wM1BkxpJ;
        "pkg-v20.4.0-1.20.4-Fabric" = _c54FwRDm;
        "pkg-v20.4.0-1.20.4-Forge" = _8PxngaDB;
        "pkg-v20.4.0-1.20.4-NeoForge" = _CnB6DriP;
        "pkg-v20.4.1-1.20.4-Fabric" = _Glnuujvo;
        "pkg-v20.4.1-1.20.4-Forge" = _4Mmc0Bsc;
        "pkg-v20.4.1-1.20.4-NeoForge" = _aq0aaOl0;
        "pkg-v3.0.1-1.18.2-Forge" = _eIhIUCoF;
        "pkg-v3.0.1-1.18.2-Fabric" = _uFYH04O9;
        "pkg-v8.0.2-1.20.1-Forge" = _ZD7nA4WX;
        "pkg-v8.0.2-1.20.1-Fabric" = _UdH7Njsc;
        "pkg-v20.4.2-1.20.4-Fabric" = _efOXwAoa;
        "pkg-v20.4.2-1.20.4-Forge" = _dEfb5pkS;
        "pkg-v20.4.2-1.20.4-NeoForge" = _jupNc7AD;
        "pkg-v21.0.0-1.21-Fabric" = _c4tG4GND;
        "pkg-v21.0.0-1.21-NeoForge" = _dm010oLX;
        "pkg-v21.1.0-1.21.1-Fabric" = _EDWIJkMA;
        "pkg-v21.1.0-1.21.1-NeoForge" = _5P5tLHSh;
        "pkg-v21.3.0-1.21.3-Fabric" = _YctaEZWL;
        "pkg-v21.3.0-1.21.3-NeoForge" = _DQXyDdh0;
        "pkg-v21.4.0-1.21.4-Fabric" = _mmm0peNW;
        "pkg-v21.4.0-1.21.4-NeoForge" = _tx8EN5Jn;
        "pkg-v21.5.0-1.21.5-Fabric" = _YxqWBwWW;
        "pkg-v21.5.0-1.21.5-NeoForge" = _zT3DCxVG;
        "pkg-v21.6.0-1.21.6-Fabric" = _DAsWvA5c;
        "pkg-v21.6.0-1.21.6-NeoForge" = _xEg5wKDq;
        "pkg-v21.7.0-1.21.7-Fabric" = _Y6Yqc0ht;
        "pkg-v21.7.0-1.21.7-NeoForge" = _QpD8yYvC;
        "pkg-v21.8.0-1.21.8-Fabric" = _twVbKUaV;
        "pkg-v21.8.0-1.21.8-NeoForge" = _wAXw0pjA;
        "pkg-21.9.0" = _56UQLsHg;
        "pkg-21.10.0" = _fEyREDWl;
