...
let
    ...
    in {
        ...
        "pkg-2.2" = _ol35lCu5;
        "pkg-3.2" = _QvnOlgfl;
        "pkg-3.1.1.1" = _y7EnvMp4;
        "pkg-2.2.1" = _25nvwYhQ;
        "pkg-3.2.1" = _x1US85Y5;
        "pkg-3.2.1.1" = _QyoE1NW1;
        "pkg-3.2.1.2" = _LCqHrCUp;
        "pkg-3.2.1.3" = _HFydyYq7;
        "pkg-3.3" = _zUFV45Xc;
        "pkg-4.0" = _P2JA5RAy;
        "pkg-3.3.1" = _3JBn4u7O;
        "pkg-4.0.1" = _JoDvCqWR;
        "pkg-3.3.1.1" = _AQKc1I2h;
        "pkg-4.0.1.1" = _7GGbqBGH;
        "pkg-3.4" = _yJ9TEpqA;
        "pkg-4.1" = _xAmOQHml;
        "pkg-3.5" = _t0BepfjM;
        "pkg-4.2" = _YcfaPucX;
        "pkg-3.5.0.1" = _eN9ClYca;
        "pkg-4.2.0.1" = _o0IE0wWF;
        "pkg-3.5.1" = _QLbr6PZC;
        "pkg-4.2.1" = _nY68hRY1;
        "default" = _nY68hRY1;
    });
