...
let
    ...
    in {
        ...
        "pkg-b1.16" = _iwwmIzO8;
        "pkg-r1.0" = _acTrnERj;
        "pkg-R1.1_(270)" = _7JMcvmbV;
        "pkg-R1.2_(280)" = _rVdT0gah;
        "pkg-R1.3_(280)" = _vHcKLs50;
        "pkg-R1.4_(320)" = _YQOSKoH2;
        "pkg-R1.5_(340)" = _56VXwFmn;
        "pkg-R1.6_(400)" = _ZwVnpFHU;
        "pkg-R1.7_(400)" = _Tz7Z0EKa;
        "pkg-R1.8_(400)" = _xWOYDplu;
        "pkg-R1.9_(410)" = _lsFwG7pU;
        "pkg-R1.10_(420)" = _u9ikMEaS;
        "pkg-R1.11" = _tVQqvahR;
        "pkg-1.12" = _qCSEACcf;
        "pkg-R1.13" = _3aH63aOD;
        "pkg-R1.14" = _ACj0fo2o;
