...
let
    ...
    in {
        ...
        "pkg-1.0.2+1.21.11" = _jG4QZOK0;
        "pkg-1.0.2+26.1.2" = _eIoWxE4o;
        "pkg-1.0.2+26.2" = _jPou9HLe;
        "pkg-1.0.3+1.21.11" = _XorCwgXU;
        "pkg-1.0.3+26.1.2" = _Uq7ZOyYl;
        "pkg-1.0.3+26.2" = _hwUBEsmf;
