...
let
    ...
    in {
        ...
        "pkg-2.2.0+1.19" = _LPxyKOQ6;
        "pkg-2.3.0+1.19" = _R60ejWO4;
        "pkg-2.3.1+1.19" = _3Xofcnqf;
        "pkg-2.3.2+1.19" = _CTHuBW0y;
        "pkg-2.3.3+1.19" = _pYZPbULG;
        "pkg-2.4.0+1.20" = _wQkxNUKe;
        "pkg-2.4.1+1.20" = _ivWX3DsP;
        "pkg-2.4.2+1.20" = _7YudDLPR;
        "pkg-2.4.3+1.20" = _oe0QTVyx;
        "pkg-2.4.4+1.20" = _aEA6OYx7;
        "pkg-2.4.5+1.20.4" = _j9ZJMEf6;
        "pkg-2.4.6+1.20" = _CaPmQMGs;
        "pkg-3.0.0+1.20" = _nGoT8s9Z;
        "pkg-3.0.1+1.21" = _2xHQAVoo;
        "pkg-3.1.0+1.21.1" = _ZhqRTohP;
        "pkg-3.0.1+1.20" = _1IkIB8SD;
        "pkg-3.1.1+1.21.1" = _AwY9P3qV;
        "pkg-3.2.0+1.21.3" = _C48tiRcY;
        "pkg-3.3.0+1.21.4" = _wT6KfZU2;
        "pkg-3.3.1+1.21.5" = _H7ZkbVAu;
        "pkg-3.3.2+1.21.5" = _dg4xesVT;
        "pkg-3.3.3+1.21.8" = _i89BsPkK;
        "pkg-3.3.4-alpha+1.21.10" = _WAsFH6fv;
        "pkg-4.0.0-beta+1.21.11" = _wwOnuAsE;
        "default" = _wwOnuAsE;
    });
