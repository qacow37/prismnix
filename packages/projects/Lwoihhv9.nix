...
let
    ...
    in {
        ...
        "pkg-v1.0-Pre2+1.17.1" = _3xvcxjK9;
        "pkg-v1.0-1.17.1" = _NI29I3F1;
        "pkg-v1.0.1-1.17.1" = _n62Rnn6f;
        "pkg-v1.1-Beta1+1.17.1" = _XNKQiFYC;
        "pkg-v1.1-Beta2+1.17.1" = _NagbPtnN;
        "pkg-v1.1+1.17.1" = _FjjrG4Kr;
        "pkg-v1.1.1+1.17.1" = _kF4K8puH;
        "pkg-v1.2-Beta1+1.17.1" = _DPJvSDRi;
        "pkg-v1.2-Beta2+1.17.1" = _8k2FAMdP;
        "pkg-v1.2-Beta3+1.17.1" = _Uamo2wD1;
        "pkg-v1.2-Beta4+1.18.1" = _BtjAk8xI;
        "pkg-v1.2+1.18.1" = _R5j8hxYu;
        "pkg-v1.2.1+1.18.1" = _KZExpGLK;
        "pkg-v1.2.2+1.18.1" = _zZruVO3S;
        "pkg-v1.3-Beta1+1.18.1" = _c9nfdo9W;
        "pkg-v1.3-Beta2+1.18.1" = _3Imm8YmY;
        "pkg-v1.3-Beta3+1.18.1" = _VEJFkD0h;
        "pkg-v1.3-Beta4+1.18.2" = _aSMhJlQN;
        "pkg-v1.3+1.18.2" = _soNuKVnZ;
        "pkg-v1.3.1+1.18.2" = _GIzSXtV0;
        "pkg-v1.3.2+1.18.2" = _fcgIVTHL;
        "pkg-v69.4.20+1.18.2" = _OI7XALjS;
        "pkg-v1.4-Beta1+1.18.2" = _3tOjjEKa;
        "default" = _3tOjjEKa;
    });
