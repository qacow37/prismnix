...
let
    ...
    in {
        ...
        "pkg-0.73-fabric-1.18.2" = _mnztSxK1;
        "pkg-1.0.3-fabric-1.20" = _XL1OAHU7;
        "pkg-1.0.4-fabric-1.20" = _ohY4Krrn;
        "pkg-1.0.5-fabric-1.20" = _aILDOms7;
        "pkg-1.0.7-fabric-1.20" = _Z3MqIzpd;
        "pkg-1.08-fabric-1.19.2" = _B00esghH;
        "pkg-1.0.9-fabric-1.20" = _bVDnF9We;
        "pkg-1.1.1-fabric-1.20" = _JangFb64;
        "pkg-1.1.2-fabric-1.20" = _QXz9IuS5;
        "pkg-1.1.3-fabric-1.20" = _fVwlxGgo;
        "pkg-1.1.4-fabric-1.20" = _7Blwivaz;
        "pkg-1.1.5-fabric-1.20" = _WIi8x0g4;
        "pkg-1.1.6-fabric-1.20" = _DEPuheuZ;
        "pkg-1.1.6b-fabric-1.20" = _wsFpoNTB;
        "pkg-1.2.0-fabric-1.20" = _tISSInfK;
        "pkg-1.2.1-fabric-1.20" = _cgl8vl6L;
        "pkg-1.2.2-fabric-1.20" = _g8O0VX0z;
        "pkg-1.2.3-fabric-1.20" = _Kzb4xk4T;
        "pkg-1.2.4-fabric-1.20" = _ZX2KFKPr;
        "pkg-1.2.6-fabric-1.20" = _ZJbPx6No;
        "pkg-1.2.7-fabric-1.20" = _TjWU92qN;
        "pkg-1.2.8-fabric-1.20" = _qxfHMCYZ;
        "pkg-1.2.9-fabric-1.20" = _NEDinMgv;
        "pkg-1.2.10-fabric-1.20" = _DCeMDhmQ;
        "pkg-1.2.11-fabric-1.20" = _penQjESu;
        "pkg-1.2.12-fabric-1.20" = _AZUIySQS;
        "pkg-1.2.13-fabric-1.20" = _mAXWUdVQ;
        "pkg-1.3.0-fabric-1.20.1" = _Vs8aFH6R;
        "pkg-1.3.1-fabric-1.20" = _vvIeHJOa;
        "pkg-1.3.2-fabric-1.20" = _Aidv78n3;
        "pkg-1.3.3-fabric-1.20" = _RCawHbXa;
        "pkg-1.3.3a-fabric-1.20" = _lAqPliGL;
        "pkg-1.3.4-fabric-1.20.1" = _LZR1M9Fq;
        "pkg-1.3.4b-fabric-1.20.1" = _iXHu0vpd;
        "pkg-1.4.0-fabric-1.20.1" = _KSRjz1ab;
        "pkg-1.4.1-fabric-1.20.1" = _9A9kqVoD;
        "pkg-1.4.2-fabric-1.20.1" = _BEmjGQSv;
        "pkg-1.4.3-fabric-1.20.1" = _Vjm4SXw5;
        "pkg-1.5.0-fabric-1.20.1" = _GocycxTu;
        "pkg-1.5.1-fabric-1.20.1" = _7N3BIFLF;
        "pkg-1.5.2-fabric-1.20.1" = _Vegaxgu8;
        "pkg-1.5.3-fabric-1.20.1" = _rIIDeqwr;
        "pkg-1.5.4-fabric-1.20.1" = _2PoUArN9;
        "pkg-1.5.5-fabric-1.20.1" = _5mDhjama;
        "pkg-1.6.0-fabric-1.20.1" = _LflJ1h4t;
        "pkg-1.6.1-fabric-1.20.1" = _YIhiYtGP;
        "default" = _YIhiYtGP;
    });
