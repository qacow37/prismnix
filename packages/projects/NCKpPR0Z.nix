...
let
    ...
    in {
        ...
        "pkg-1.7.8" = _OTVrzgpn;
        "pkg-2.1.8" = _9kQOtZdI;
        "pkg-2.1.8.1" = _n8IIJXsz;
        "pkg-1.7.9" = _1pxM2aAd;
        "pkg-2.1.9" = _Qx7uQXCU;
        "pkg-1.7.10" = _VVzbw4ab;
        "pkg-2.1.10" = _6HqZNOrS;
        "pkg-1.7.11" = _soCWwgLU;
        "pkg-2.1.11" = _hOFm4e6B;
        "pkg-2.1.12" = _acQVhzRm;
        "pkg-2.1.13" = _gqMLkzBT;
        "pkg-2.2.1-Fabric" = _HmaFvjor;
        "pkg-2.2.1-Forge" = _wcSq9RAd;
        "pkg-2.2.2-Fabric" = _1CHAex8J;
        "pkg-2.2.2-Forge" = _cUQnkGgj;
        "pkg-2.3.1-Fabric" = _4l3smkk3;
        "pkg-2.3.1-NeoForge" = _9ijJwtZA;
        "pkg-2.2.3-Fabric" = _UbkvgVr3;
        "pkg-2.2.3-Forge" = _Hp8QbZV6;
        "pkg-2.3.2-Fabric" = _aZJ52CSO;
        "pkg-2.3.2-NeoForge" = _tE2d7eF4;
        "pkg-2.2.4-Fabric" = _76Zti2GN;
        "pkg-2.2.4-Forge" = _lNxRTxLS;
        "pkg-2.3.3-Fabric" = _W5zzqvSP;
        "pkg-2.3.3-NeoForge" = _oXOFlN4S;
        "pkg-2.4.0-Fabric" = _Vn7qLPdn;
        "pkg-2.4.0-NeoForge" = _mouHHK7x;
        "pkg-2.4.1-Fabric" = _xrQuj7TO;
        "pkg-2.4.1-NeoForge" = _FW6u09ST;
        "pkg-2.4.2-Fabric" = _edpG78RT;
        "pkg-2.4.2-NeoForge" = _29dyQNct;
        "pkg-2.2.6-Fabric" = _Cd2lBLPj;
        "pkg-2.2.6-Forge" = _tEqUSkkV;
        "pkg-2.3.5-Fabric" = _Ivadr3Rv;
        "pkg-2.3.5-NeoForge" = _hsEfn34V;
        "pkg-2.2.6_1-Fabric" = _H20oKKk9;
        "pkg-2.3.6-Fabric" = _ziEe6UX5;
        "pkg-2.3.6-NeoForge" = _ml3dpcRE;
        "pkg-2.4.3-Fabric" = _pGspu3Im;
        "pkg-2.4.3-NeoForge" = _uYgq3yjJ;
        "pkg-2.5.0-NeoFab" = _gzsXKZdZ;
        "pkg-2.4.4-Fabric" = _JO4l390H;
        "pkg-2.4.4-NeoForge" = _weULuPnV;
        "pkg-2.5.1-NeoFabric" = _GzscKxxa;
        "pkg-2.4.6-Fabric" = _MdD8J4en;
        "pkg-2.4.6-NeoForge" = _vKhIyoZ5;
        "pkg-2.5.3-NeoFab" = _kmOLxPKR;
        "pkg-2.6.0-NeoFab" = _pHuIWHyx;
        "pkg-2.2.7-Fabric" = _BjQqWBo8;
