...
let
    ...
    in {
        ...
        "pkg-v1.0" = _qemPtAeo;
        "pkg-v1.0.1" = _qssZc99f;
        "pkg-v1.1" = _b6Bn0bVE;
        "pkg-v1.2" = _RbbMAURd;
        "pkg-v1.2.1" = _jRkQENPY;
        "pkg-v1.3" = _75lUPi57;
        "pkg-v1.3.1" = _chuppyqf;
        "pkg-v1.3.2" = _sNDHtD4P;
        "pkg-v1.3.3" = _HQtz0HGd;
        "pkg-v1.3.4+build1" = _QeyhPqyd;
        "pkg-v1.3.4" = _oNITaUQs;
        "pkg-v1.3.5" = _GdKlZXYP;
        "pkg-1.4" = _kF9w0lJN;
        "pkg-1.4.1" = _PL3sJg5Q;
        "pkg-1.4.2" = _DdeoeYrP;
        "pkg-1.4.3" = _h1SQGn41;
        "pkg-1.5-beta1" = _k8XcAxGc;
        "pkg-1.5" = _DncD5mNb;
        "pkg-1.5.1" = _bxbXnEpY;
        "pkg-1.5.2" = _ZTu57ECx;
        "pkg-1.5.3" = _Eg03oorD;
        "pkg-1.5.3.1" = _KjEwUQhc;
        "pkg-2.0" = _hkwa7u2F;
        "pkg-2.1" = _R7n9XVUs;
        "pkg-2.1.1" = _5UTGBHSx;
        "pkg-2.2" = _pLL30R3o;
