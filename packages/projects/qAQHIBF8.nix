...
let
    ...
    in {
        ...
        "pkg-1.9.0-beta.1-fabric-1.19.4" = _vhstp9vF;
        "pkg-1.9.0-fabric-1.19.4" = _3E45KKSi;
        "pkg-2.0.0" = _cdYcc6SJ;
        "pkg-2.0.1" = _XXSvlg0b;
        "pkg-2.0.2-fabric-1.20.1" = _z551VJE6;
        "pkg-2.0.2-fabric-1.19.3" = _Yzf6fs3j;
        "pkg-2.0.2-fabric-1.19.2" = _3oeIMGWU;
        "pkg-2.0.2-fabric-1.18.2" = _f9tsx8Hy;
        "pkg-2.0.2-fabric-1.19.4" = _Lh5yavqw;
        "pkg-2.0.3-fabric-1.20.1" = _muXwA5Uj;
        "pkg-2.0.3-fabric-1.19.4" = _CTfQKTyQ;
        "pkg-2.0.3-fabric-1.19.3" = _GQJauP2d;
        "pkg-2.0.3-fabric-1.19.2" = _Ylea7BE2;
        "pkg-2.0.3-fabric-1.18.2" = _3LwAWM3w;
        "pkg-2.0.4-fabric-1.20.2" = _ElNJEo6N;
        "pkg-2.0.5-fabric-1.18.2" = _l2pLEbeW;
        "pkg-2.0.5-fabric-1.19.2" = _eMcXMveT;
        "pkg-2.0.5-fabric-1.19.4" = _Azh7g2fm;
        "pkg-2.0.5-fabric-1.20.1" = _BAptTeWM;
        "pkg-2.0.5-fabric-1.20.2" = _QUoiJokE;
        "pkg-2.0.6-fabric-1.20.2" = _eZ0MxNaw;
        "pkg-2.0.7-fabric-1.20.4" = _pbTlTskr;
        "pkg-2.0.7-fabric-1.20.2" = _gAylgXv5;
        "pkg-2.0.7-fabric-1.20.1" = _gH5wbPOL;
        "pkg-2.1.0-fabric-1.20.4" = _mzcAbnMi;
        "pkg-2.1.0-fabric-1.20.2" = _tU6oRMmG;
        "pkg-2.1.0-fabric-1.20.1" = _j3jo83Y4;
        "pkg-2.1.0-fabric-1.19.4" = _s0UlV7Dr;
        "pkg-2.1.0-fabric-1.19.3" = _jUWeFknE;
        "pkg-2.1.0-fabric-1.19.2" = _oMGK4d8H;
        "pkg-2.1.0-fabric-1.18.2" = _4Oxleo76;
        "pkg-2.1.1-fabric-1.20.4" = _4Dl4s6AK;
        "pkg-2.1.1-fabric-1.20.2" = _1LSNy8Ak;
        "pkg-2.1.1-fabric-1.20.1" = _eNwA0hnY;
        "pkg-2.1.1-fabric-1.19.4" = _VpGjw4rC;
        "pkg-2.1.1-fabric-1.19.3" = _FuMiPrVh;
        "pkg-2.1.1-fabric-1.19.2" = _OR9LyPKc;
        "pkg-2.1.1-fabric-1.18.2" = _cSeJEqP2;
        "pkg-2.1.3-fabric-1.20.6" = _LsDEA5bo;
        "pkg-2.1.4-fabric-1.21" = _E1ub1j7T;
        "pkg-2.1.4-fabric-1.20.6" = _QOrmfVhC;
        "pkg-2.1.4-fabric-1.20.4" = _LMuD2zcB;
        "pkg-2.1.4-fabric-1.20.2" = _Opzsm6tH;
        "pkg-2.1.4-fabric-1.20.1" = _OHXEmpRq;
        "pkg-2.2.0-fabric-1.21" = _u5RPoh7G;
        "pkg-2.2.2-fabric-1.21.1" = _VbGPtRoX;
        "pkg-3.0.0-beta.1-fabric-1.21.1" = _dnrDzx5v;
        "pkg-3.0.0-beta.9-fabric-1.19.4" = _OQpoL1SK;
        "pkg-3.0.0-beta.10-fabric-1.21.1" = _mmShqsK7;
        "pkg-3.0.0-beta.10-fabric-1.20.6" = _STvFedb3;
        "pkg-3.0.0-beta.10-fabric-1.20.4" = _FW2rBfb1;
        "pkg-3.0.0-beta.10-fabric-1.20.2" = _eHI6S9HA;
        "pkg-3.0.0-fabric-1.21.1" = _yEgASoEg;
        "pkg-3.0.0-fabric-1.20.6" = _ssyoVPc8;
        "pkg-3.0.0-fabric-1.20.4" = _bVk4D13B;
        "pkg-3.0.0-fabric-1.20.2" = _thEFb009;
        "pkg-3.0.0-fabric-1.20.1" = _VO7d5S1A;
        "pkg-3.0.0-fabric-1.19.4" = _YELpbZXz;
        "pkg-3.0.2-fabric-1.21.1" = _AvmFFHb6;
        "pkg-3.0.2-fabric-1.20.6" = _LPE5C1dW;
        "pkg-3.0.2-fabric-1.20.4" = _8uKsh6fq;
        "pkg-3.0.2-fabric-1.20.2" = _Kv1XkPDG;
        "pkg-3.0.2-fabric-1.20.1" = _s1RBkUvx;
        "pkg-3.0.2-fabric-1.19.4" = _zz8QgUqO;
        "pkg-3.0.5-fabric-1.21.3" = _lVXmYNgX;
        "pkg-3.1.0-fabric-1.21.4" = _KGzrap23;
        "pkg-3.1.0-fabric-1.21.3" = _pfNdvrKD;
        "pkg-3.1.0-fabric-1.21.1" = _qjj5Eqga;
        "pkg-3.1.0-fabric-1.20.6" = _5npbiHbn;
        "pkg-3.1.0-fabric-1.20.4" = _5wzKzubQ;
        "pkg-3.1.0-fabric-1.20.2" = _YIXlp3WI;
        "pkg-3.1.0-fabric-1.20.1" = _WxgbFRZJ;
        "pkg-3.1.0-fabric-1.21.5" = _yRNGeRBX;
        "pkg-3.1.1-fabric-1.21.8" = _R6txPllG;
        "pkg-3.1.1-fabric-1.21.10" = _MfYv1XKz;
        "pkg-3.1.2-fabric-1.21.11" = _pnA6NGs9;
        "pkg-3.1.2-fabric-1.21.10" = _3YHJ3JNU;
        "pkg-3.1.3-beta.1-fabric-1.21.1" = _pVpq2bMy;
        "pkg-3.1.3-beta.1-fabric-1.21.11" = _p05A7QLN;
        "pkg-3.1.3-beta.1-fabric-26.1" = _dqT84cHU;
        "pkg-3.1.3-fabric-1.21.1" = _ppDVcXgq;
        "pkg-3.1.3-fabric-1.21.11" = _1yzoFXJ4;
        "pkg-3.1.3-fabric-26.1" = _KcSKgSEy;
        "pkg-3.1.4-fabric-26.1.1" = _918aveSM;
        "pkg-3.1.4-fabric-1.21.1" = _1eyeHS3j;
        "pkg-3.1.4-fabric-1.21.11" = _HSXjYomg;
        "pkg-3.1.5-fabric-26.2" = _eJQzzdWI;
        "pkg-3.1.5-fabric-26.1.2" = _Jzb3lMRb;
        "pkg-3.1.5-fabric-1.21.11" = _JzRbmyzD;
        "pkg-3.1.6-beta.3-fabric-26.2" = _hYzcdEhG;
        "pkg-3.1.6-fabric-26.1.2" = _ccUgc6lU;
        "pkg-3.1.6-fabric-26.2" = _DwSZxdgA;
        "default" = _DwSZxdgA;
    });
