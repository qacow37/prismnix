...
let
    ...
    in {
        ...
        "pkg-1.20-1_r1" = _OpEfduzD;
        "pkg-1.20.2-4_r1" = _vAxKggUZ;
        "pkg-1.20.5-6_r1" = _hVcG3z7r;
        "pkg-1.21-1_r1" = _X9OcctGt;
        "pkg-1.21.2-3_r1" = _CUXiEo27;
        "pkg-1.21.4_r1" = _nFg9RI1D;
        "pkg-1.21.5_r1" = _WCCaX94P;
        "pkg-1.21.6-8_r1" = _vBWWW9yz;
        "pkg-1.21.9-11_r1" = _GsHXmzx9;
        "pkg-26.1.x_r1" = _z8qT1Vec;
        "pkg-26.2_r1" = _AebqXN5M;
        "pkg-1.20-1_l" = _IfPEeimx;
        "pkg-1.20.2-4_l" = _V2wxsSik;
        "pkg-1.20.5-6_l" = _XYOQhFLr;
        "pkg-1.21-1_l" = _QAbZ9u4F;
        "pkg-1.21.2-3_l" = _I5aVpPNm;
        "pkg-1.21.4_l" = _Z1J0Zupm;
        "pkg-1.21.5_l" = _IEz77Vkw;
        "pkg-1.21.6-8_l" = _aIeXw2Os;
