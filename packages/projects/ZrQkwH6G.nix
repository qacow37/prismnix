...
let
    ...
    in {
        ...
        "pkg-2+mod" = _4UD2LTNR;
        "pkg-2.1" = _pWJEL7Gg;
        "pkg-2.1+mod" = _znuTZkdq;
        "pkg-2.2" = _RHGZlPDr;
        "pkg-2.2+mod" = _gSVy4Myc;
        "pkg-2.3" = _RVqiDavx;
        "pkg-2.3+mod" = _MreFB8SX;
        "pkg-3" = _PgD4NaDB;
        "pkg-3+mod" = _XIC1csDz;
        "pkg-3.1" = _N3BxkH1C;
        "pkg-3.1+mod" = _eXDeq1UQ;
        "pkg-4" = _XVa4OoNo;
        "pkg-4+mod" = _jfhNfSaM;
        "pkg-4.1" = _qPQUNAAc;
        "pkg-4.1+mod" = _n96CjDf3;
        "pkg-4.2" = _JEQ7ram4;
        "pkg-4.2+mod" = _DF3HzGOZ;
        "pkg-4.3" = _6vFDEX62;
        "pkg-4.3+mod" = _XgZyOldy;
        "pkg-4.4" = _TBc9TMVu;
        "pkg-4.4+mod" = _Efwv8Fk6;
        "pkg-4.5" = _frzrcWeM;
        "pkg-4.5+mod" = _4sYAFILG;
        "pkg-4.5.1" = _qX3FkYno;
        "pkg-4.5.1+mod" = _XanUuyOF;
        "pkg-4.5.2" = _zaPa0eUH;
        "pkg-4.5.2+mod" = _h3mHRADM;
        "pkg-4.5.2-fix" = _JVJp0igg;
        "pkg-4.5.2-fix+mod" = _kYjDQYJt;
        "pkg-4.5.3" = _TJZeh23k;
        "pkg-4.5.3+mod" = _EAFAPbqZ;
        "pkg-4.6-1.20.x" = _NJpl7YUp;
        "pkg-4.6-1.20.x+mod" = _n1XJzyzw;
        "pkg-4.6" = _QAYXb56R;
        "pkg-4.6+mod" = _dPESwWWl;
        "pkg-4.6.1-1.20.x" = _AV34eXPH;
        "pkg-4.6.1-1.20.x+mod" = _w9fVQlNY;
        "pkg-4.6.1" = _NsnPPSvg;
        "pkg-4.7" = _FOxtXoc6;
        "pkg-4.7+mod" = _kmt5oRQ8;
        "pkg-4.8" = _TopGOQ3b;
        "pkg-4.8+mod" = _WmhAXvuM;
        "pkg-4.9" = _3JRHZpSY;
        "pkg-4.9+mod" = _XbkzQ5ej;
        "default" = _XbkzQ5ej;
    });
