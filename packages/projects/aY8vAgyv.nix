...
let
    ...
    in {
        ...
        "pkg-1.19.4-4.6.0.1" = _RMw4vsA6;
        "pkg-1.20.1-5.0.0.1" = _Mg2GOSa5;
        "pkg-1.18.2-5.0.0.2" = _nNpOgTPk;
        "pkg-1.19-1.19.2-5.0.0.2" = _cIwxatWE;
        "pkg-1.19.4-5.0.0.2" = _xVIJkn5c;
        "pkg-1.20.1-5.0.0.2" = _P1Yy1B4f;
        "pkg-1.18.2-5.0.0.3" = _lc7JduX0;
        "pkg-1.19-1.19.2-5.0.0.3" = _TkAZMYzV;
        "pkg-1.19.4-5.0.0.3" = _LVFVVi1p;
        "pkg-1.20.1-5.0.0.3" = _ykz9zKBA;
        "pkg-1.18.2-5.1.0.0" = _Q3kKZftS;
        "pkg-1.19-1.19.2-5.1.0.0" = _RIwxw7yP;
        "pkg-1.19.4-5.1.0.0" = _jWr7ALDo;
        "pkg-1.20.1-5.1.0.0" = _MWeIAkyR;
        "pkg-1.18.2-5.1.0.1" = _81yhnzNL;
        "pkg-1.19-1.19.2-5.1.0.1" = _b1YdBcyu;
        "pkg-1.19.4-5.1.0.1" = _eqnCD62V;
        "pkg-1.20.1-5.1.0.1" = _8wAk82vU;
        "pkg-1.18.2-5.2.0.0-FORGE" = _pnM131Pb;
        "pkg-1.18.2-5.2.0.0-FABRIC" = _sNo8yRwp;
        "pkg-1.19.2-5.2.0.0-FORGE" = _X3AG5hsZ;
        "pkg-1.19.2-5.2.0.0-FABRIC" = _szoNk2QZ;
        "pkg-1.19.4-5.2.0.0-FORGE" = _oSTdksmt;
        "pkg-1.19.4-5.2.0.0-FABRIC" = _KsmPMEdx;
        "pkg-1.20.1-5.2.0.0-FORGE" = _XfY4dyZN;
        "pkg-1.20.1-5.2.0.0-FABRIC" = _dlZ2wJPe;
        "pkg-1.18.2-5.2.1.0-FABRIC" = _gUr3VHWe;
        "pkg-1.18.2-5.2.1.0-FORGE" = _PaoZuojS;
        "pkg-1.19.2-5.2.1.0-FABRIC" = _OMnYEKH3;
        "pkg-1.19.2-5.2.1.0-FORGE" = _kLf59J9t;
        "pkg-1.19.4-5.2.1.0-FABRIC" = _tKUwHjxV;
        "pkg-1.19.4-5.2.1.0-FORGE" = _AR2a0z1R;
        "pkg-1.20.1-5.2.1.0-FABRIC" = _dOLIqdyd;
        "pkg-1.20.1-5.2.1.0-FORGE" = _E5wPUa2S;
        "pkg-1.18.2-5.2.1.1-FABRIC" = _HFShwmDN;
        "pkg-1.18.2-5.2.1.1-FORGE" = _JJ57GoSr;
        "pkg-1.19.2-5.2.1.1-FABRIC" = _eCPtm3xL;
        "pkg-1.19.2-5.2.1.1-FORGE" = _RAqnzWGj;
        "pkg-1.19.4-5.2.1.1-FABRIC" = _DGTSNGT9;
        "pkg-1.19.4-5.2.1.1-FORGE" = _zmfdLvs6;
        "pkg-1.20.1-5.2.1.1-FABRIC" = _ZK19c10q;
        "pkg-1.20.1-5.2.1.1-FORGE" = _tlTvuoYx;
        "pkg-1.18.2-5.2.1.2-FABRIC" = _cHsaly8e;
        "pkg-1.18.2-5.2.1.2-FORGE" = _4RxP3hqK;
        "pkg-1.19.2-5.2.1.2-FABRIC" = _3hm0aNJW;
        "pkg-1.19.2-5.2.1.2-FORGE" = _ZUSrXNCN;
        "pkg-1.19.4-5.2.1.2-FABRIC" = _TlbuYs6J;
        "pkg-1.19.4-5.2.1.2-FORGE" = _MPVOAhPz;
        "pkg-1.20.1-5.2.1.2-FABRIC" = _rspQblak;
        "pkg-1.20.1-5.2.1.2-FORGE" = _vyDL16vj;
        "pkg-1.19.2-5.2.1.3-FABRIC" = _YnbhnUBO;
        "pkg-1.19.2-5.2.1.3-FORGE" = _OY0L4D19;
        "pkg-1.19.4-5.2.1.3-FABRIC" = _WKvfJaT3;
        "pkg-1.19.4-5.2.1.3-FORGE" = _rKm6Y5ZY;
        "pkg-1.20.1-5.2.1.3-FABRIC" = _A7kjtbIG;
        "pkg-1.20.1-5.2.1.3-FORGE" = _g09q9mKl;
        "pkg-1.19.2-5.2.1.4-FORGE" = _mKYHt6nN;
        "pkg-1.19.2-5.2.1.4-FABRIC" = _jVp82CLo;
        "pkg-1.18.2-5.2.1.3-FABRIC" = _OMVDOX8I;
        "pkg-1.18.2-5.2.1.3-FORGE" = _TUMTky6a;
        "pkg-1.20.1-5.2.1.4-FABRIC" = _Uxe6f8hZ;
        "pkg-1.20.1-5.2.1.4-FORGE" = _OIr7TAVz;
        "pkg-1.18.2-5.2.1.4-FABRIC" = _cx9RZViI;
        "pkg-1.18.2-5.2.1.4-FORGE" = _9Roh1XnJ;
        "pkg-1.19.2-5.2.1.5-FABRIC" = _vpYzBPMU;
        "pkg-1.19.2-5.2.1.5-FORGE" = _LZ6tskPC;
        "pkg-1.20.1-5.2.1.5-FABRIC" = _QJO056Si;
        "pkg-1.20.1-5.2.1.5-FORGE" = _GcztPfW0;
        "pkg-1.20.4-5.2.1.5-FABRIC" = _zcuiC1xd;
        "pkg-1.20.4-5.2.1.5-NEOFORGE" = _h97c3lV0;
        "pkg-1.20.6-5.2.1.5-FABRIC" = _6489zhlw;
        "pkg-1.20.6-5.2.1.5-NEOFORGE" = _Uyk4XQs9;
        "pkg-1.20.4-5.2.1.6-FABRIC" = _v3otvwgl;
        "pkg-1.20.4-5.2.1.6-NEOFORGE" = _ANfLUox5;
        "pkg-1.20.6-5.2.1.6-FABRIC" = _Gbk5oaty;
        "pkg-1.20.6-5.2.1.6-NEOFORGE" = _hnRlIvfT;
        "pkg-1.18.2-5.2.1.7-FABRIC" = _PGqhw422;
        "pkg-1.18.2-5.2.1.7-FORGE" = _WuAqxs5X;
        "pkg-1.19.2-5.2.1.7-FABRIC" = _5xe4d2Yz;
        "pkg-1.19.2-5.2.1.7-FORGE" = _wD0MPot8;
        "pkg-1.20.1-5.2.1.7-FABRIC" = _XG41wl0b;
        "pkg-1.20.1-5.2.1.7-FORGE" = _nYI9m8IU;
        "pkg-1.20.4-5.2.1.7-FABRIC" = _sV8h07Sq;
        "pkg-1.20.4-5.2.1.7-NEOFORGE" = _FIdcl1p1;
        "pkg-1.20.6-5.2.1.7-FABRIC" = _BQHgz8TU;
        "pkg-1.20.6-5.2.1.7-NEOFORGE" = _P10P8HnI;
        "pkg-1.21-5.2.1.7-FABRIC" = _Jo3ZzL1r;
        "pkg-1.21-5.2.1.7-NEOFORGE" = _riVzFJUs;
        "pkg-1.18.2-5.2.1.8-FABRIC" = _CqJkIK69;
        "pkg-1.18.2-5.2.1.8-FORGE" = _mMo6qCiX;
        "pkg-1.19.2-5.2.1.8-FABRIC" = _auIPRFW2;
        "pkg-1.19.2-5.2.1.8-FORGE" = _cqj7cw9G;
        "pkg-1.20.1-5.2.1.8-FABRIC" = _p5tcJFtF;
        "pkg-1.20.1-5.2.1.8-FORGE" = _fE5fUTLh;
        "pkg-1.20.4-5.2.1.8-FABRIC" = _Mz86vgm5;
        "pkg-1.20.4-5.2.1.8-NEOFORGE" = _2dlEsGIx;
        "pkg-1.20.6-5.2.1.8-FABRIC" = _ngUgV6kc;
        "pkg-1.20.6-5.2.1.8-NEOFORGE" = _MAAynNcU;
        "pkg-1.21-5.2.1.8-FABRIC" = _Sq0KTTzc;
        "pkg-1.21-5.2.1.8-NEOFORGE" = _Jb7A5iaD;
        "pkg-1.20.1-5.2.1.9-FABRIC" = _WPJ7HR0h;
        "pkg-1.20.1-5.2.1.9-FORGE" = _WNF4buFK;
        "pkg-1.20.4-5.2.1.9-FABRIC" = _FSBmdRuQ;
        "pkg-1.20.4-5.2.1.9-NEOFORGE" = _RHRiB1lz;
        "pkg-1.20.6-5.2.1.9-FABRIC" = _u1Rsibm5;
        "pkg-1.20.6-5.2.1.9-NEOFORGE" = _8gD0lDw9;
        "pkg-1.21-5.2.1.9-FABRIC" = _QXigeI7k;
        "pkg-1.21-5.2.1.9-NEOFORGE" = _XtO7VAEe;
        "pkg-1.21-5.2.1.10-FABRIC" = _pz21g181;
        "pkg-1.21-5.2.1.11-FABRIC" = _g9ohUai4;
        "pkg-1.21-5.2.1.11-NEOFORGE" = _ELVSJNAV;
        "pkg-1.18.2-5.2.1.9-FABRIC" = _pgQdsOUZ;
        "pkg-1.18.2-5.2.1.9-FORGE" = _R51sUN2w;
        "pkg-1.19.2-5.2.1.9-FORGE" = _KTwdLzOY;
        "pkg-1.19.2-5.2.1.9-FABRIC" = _ANEFUyRW;
        "pkg-1.21.1-5.2.1.11-FABRIC" = _nXnn7PaD;
        "pkg-1.21.1-5.2.1.11-NEOFORGE" = _cw0Ab8gW;
        "pkg-1.21.1-5.2.1.12-FABRIC" = _kZJmbwdW;
        "pkg-1.21.1-5.2.1.12-NEOFORGE" = _9dLmX1Ae;
        "pkg-1.20.4-5.2.1.10-FABRIC" = _E7LGCjAL;
        "pkg-1.20.4-5.2.1.10-NEOFORGE" = _JHziKFgE;
        "pkg-1.20.6-5.2.1.10-FABRIC" = _AmLmo1XI;
        "pkg-1.20.6-5.2.1.10-NEOFORGE" = _fab6lSYH;
        "pkg-1.21.1-5.2.1.13-FABRIC" = _XMYCBwck;
        "pkg-1.21.1-5.2.1.13-NEOFORGE" = _3NsCAoZF;
        "pkg-1.21.1-5.2.1.14-FABRIC" = _VXg7OJa5;
        "pkg-1.21.1-5.2.1.14-NEOFORGE" = _jUBtGfrp;
        "pkg-1.21.1-5.2.1.15-FABRIC" = _zPVbEl1R;
        "pkg-1.21.1-5.2.1.15-NEOFORGE" = _iZOjM5uR;
        "pkg-1.21.3-5.2.1.15-FABRIC" = _DD9VCPmP;
        "pkg-1.21.3-5.2.1.15-NEOFORGE" = _VRfTsr3v;
        "pkg-1.21.1-5.2.2.0-FABRIC" = _zCxAqP0P;
        "pkg-1.21.1-5.2.2.0-NEOFORGE" = _9xKPsaGt;
        "pkg-1.21.1-5.2.2.1-FABRIC" = _tu47uzFx;
        "pkg-1.21.1-5.2.2.1-NEOFORGE" = _1KUJ64HB;
        "pkg-1.20.1-5.2.2.0-FABRIC" = _N64ln60M;
        "pkg-1.20.1-5.2.2.0-FORGE" = _3qvaUAtz;
        "pkg-1.20.1-5.2.2.1-FABRIC" = _SIKfJboJ;
        "pkg-1.20.1-5.2.2.1-FORGE" = _PccgbBth;
        "pkg-1.20.1-5.2.2.2-FABRIC" = _wAVHB60C;
        "pkg-1.20.1-5.2.2.2-FORGE" = _wG7ObGRk;
        "pkg-1.21.1-5.2.2.2-FABRIC" = _YA3Yu5tU;
        "pkg-1.21.1-5.2.2.2-NEOFORGE" = _tXrZswYq;
        "pkg-1.18.2-5.2.2.0-FABRIC" = _M7zL6m0l;
        "pkg-1.18.2-5.2.2.0-FORGE" = _h7HeVVQT;
        "pkg-1.19.2-5.2.1.10-FABRIC" = _y57MKUbP;
        "pkg-1.19.2-5.2.1.10-FORGE" = _rl6HVSsL;
        "pkg-1.20.1-5.2.2.3-FABRIC" = _pxB9qfHt;
        "pkg-1.20.1-5.2.2.3-FORGE" = _JUKdLWGq;
        "pkg-1.21.1-5.2.3.0-FABRIC" = _1pBeyNmJ;
        "pkg-1.21.1-5.2.3.0-NEOFORGE" = _rWBOfjHQ;
        "pkg-1.18.2-5.2.2.1-FABRIC" = _Za8i2vlm;
        "pkg-1.18.2-5.2.2.1-FORGE" = _L7WnNA0z;
        "pkg-1.19.2-5.2.1.11-FABRIC" = _mH3ODvTL;
        "pkg-1.19.2-5.2.1.11-FORGE" = _8Exjp6Nh;
        "pkg-1.20.1-5.2.2.4-FABRIC" = _1g6ZudOJ;
        "pkg-1.20.1-5.2.2.4-FORGE" = _M1GuxIRF;
        "pkg-1.21.1-5.2.3.1-FABRIC" = _79RBlyRY;
        "pkg-1.21.1-5.2.3.1-NEOFORGE" = _L7boZ3nN;
        "pkg-1.20.1-5.2.2.5-FABRIC" = _U1E74UYD;
        "pkg-1.20.1-5.2.2.5-FORGE" = _sfmfJwlL;
        "pkg-1.21.1-5.2.3.2-FABRIC" = _oN2Z6wty;
        "pkg-1.21.1-5.2.3.2-NEOFORGE" = _eaZjdI6j;
        "pkg-1.21.10-5.2.1.15-FABRIC" = _68cvYVWT;
        "pkg-1.21.10-5.2.1.15-NEOFORGE" = _kvP1IAsX;
        "pkg-1.21.1-5.2.4.0-FABRIC" = _PifCISAB;
        "pkg-1.21.1-5.2.4.0-NEOFORGE" = _ohHhYo40;
        "pkg-1.21.10-5.2.4.0-FABRIC" = _mipBtfA5;
        "pkg-1.21.10-5.2.4.0-NEOFORGE" = _qHJ9GDHf;
        "pkg-1.21.1-5.2.5.0-FABRIC" = _img812JW;
        "pkg-1.21.1-5.2.5.0-NEOFORGE" = _D3ASzoY2;
        "pkg-1.21.10-5.2.5.0-FABRIC" = _CUSfcmI2;
        "pkg-1.21.10-5.2.5.0-NEOFORGE" = _7sw5lINE;
        "pkg-1.21.11-5.2.5.0-FABRIC" = _ubKJgvlZ;
        "pkg-1.21.11-5.2.5.0-NEOFORGE" = _3qCxYlSr;
        "pkg-1.21.1-5.2.5.1-FABRIC" = _PnLzjyjg;
        "pkg-1.21.1-5.2.5.1-NEOFORGE" = _6BSd9aZa;
        "pkg-1.21.10-5.2.5.1-FABRIC" = _w9SvVmTb;
        "pkg-1.21.10-5.2.5.1-NEOFORGE" = _IvPndjeb;
        "pkg-1.21.10-5.2.5.2-FABRIC" = _uTOiB3r9;
        "pkg-1.21.10-5.2.5.2-NEOFORGE" = _MNxM8G0Y;
        "pkg-1.21.11-5.2.5.2-FABRIC" = _J77DCyl1;
        "pkg-1.21.11-5.2.5.2-NEOFORGE" = _1RmhEQWn;
        "pkg-1.21.1-5.2.5.3-FABRIC" = _RNzCLB4t;
        "pkg-1.21.1-5.2.5.3-NEOFORGE" = _g6Ol3iwb;
        "pkg-1.21.10-5.2.5.3-FABRIC" = _Kh8gblr2;
        "pkg-1.21.10-5.2.5.3-NEOFORGE" = _dhLmBGbt;
        "pkg-1.21.11-5.2.5.3-FABRIC" = _OlBpK2cg;
        "pkg-1.21.11-5.2.5.3-NEOFORGE" = _kKnCNnOD;
        "pkg-1.21.10-5.2.6.0-FABRIC" = _qiCCPVmP;
        "pkg-1.21.10-5.2.6.0-NEOFORGE" = _c9xPDVly;
        "pkg-1.21.11-5.2.6.0-FABRIC" = _Tfgu5ST7;
        "pkg-1.21.11-5.2.6.0-NEOFORGE" = _Jfrt0Gqq;
        "pkg-26.1.1-5.2.6.0-FABRIC" = _yhBetAW8;
        "pkg-26.1.1-5.2.6.0-NEOFORGE" = _6RF8v3tG;
        "pkg-26.1.2-5.2.6.0-FABRIC" = _nl5fIddz;
        "pkg-26.1.2-5.2.6.0-NEOFORGE" = _n1tANkEL;
        "pkg-26.1.2-5.2.6.1-FABRIC" = _PBx2liGA;
        "pkg-26.1.2-5.2.6.1-NEOFORGE" = _U4kuITUj;
        "pkg-26.1.2-5.2.6.2-FABRIC" = _lQTJeKiE;
        "pkg-26.1.2-5.2.6.2-NEOFORGE" = _yRBnWOhx;
        "pkg-26.1.2-5.2.6.3-FABRIC" = _UyxK5uCv;
        "pkg-26.1.2-5.2.6.3-NEOFORGE" = _CkBIVylT;
        "pkg-1.21.1-5.2.5.4-FABRIC" = _nq6DD1u1;
        "pkg-1.21.1-5.2.5.4-NEOFORGE" = _neNsqB73;
        "pkg-26.1.2-5.2.6.4-FABRIC" = _XQ5YCP4W;
