...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19-Fabric" = _QPww2Qk8;
        "pkg-v4.1.0-1.19.1-Fabric" = _4CeRhnWx;
        "pkg-v4.1.0-1.19.1-Forge" = _u6zntC84;
        "pkg-v4.2.0-1.19.2-Forge" = _RXQK3qGY;
        "pkg-v4.2.0-1.19.2-Fabric" = _niSd08li;
        "pkg-v4.2.1-1.19.2-Fabric" = _cQRhzNOP;
        "pkg-v4.2.1-1.19.2-Forge" = _zXnTmC4z;
        "pkg-v4.2.2-1.19.2-Fabric" = _glAAHHra;
        "pkg-v4.2.2-1.19.2-Forge" = _iUYx50cN;
        "pkg-v4.2.3-1.19.2-Forge" = _caZE9dfG;
        "pkg-v4.2.3-1.19.2-Fabric" = _7J9xEqi3;
        "pkg-v4.2.4-1.19.2-Forge" = _QzTAbC3c;
        "pkg-v4.2.4-1.19.2-Fabric" = _BGJybfzA;
        "pkg-v5.0.0-1.19.3-Fabric" = _k18eee64;
        "pkg-v5.0.0-1.19.3-Forge" = _YhlYP7ND;
        "pkg-v4.2.5-1.19.2-Fabric" = _fL2zkLVB;
        "pkg-v4.2.5-1.19.2-Forge" = _jkqztbsx;
        "pkg-v6.0.0-1.19.4-Fabric" = _kPSNfa7y;
        "pkg-v6.0.0-1.19.4-Forge" = _vlfKd5Pi;
        "pkg-v3.2.0-1.18.2-Fabric" = _4Y5WjryJ;
        "pkg-v3.2.0-1.18.2-Forge" = _1UqPJhnd;
        "pkg-v7.0.0-1.20-Forge" = _eIikqz8v;
        "pkg-v7.0.0-1.20-Fabric" = _lVPz4Trj;
        "pkg-v3.2.1-1.18.2-Forge" = _9o7pjFbH;
        "pkg-v3.2.1-1.18.2-Fabric" = _RNgu6HcZ;
        "pkg-v3.2.2-1.18.2-Forge" = _ZDmWJo54;
        "pkg-v3.2.2-1.18.2-Fabric" = _BceVaZKa;
        "pkg-v8.0.0-1.20.1-Forge" = _ricYyeC9;
        "pkg-v8.0.0-1.20.1-Fabric" = _SVNWvXVS;
        "pkg-v3.2.3-1.18.2-Fabric" = _4e8wN2BF;
        "pkg-v3.2.3-1.18.2-Forge" = _zjEPdv6i;
        "pkg-v4.2.6-1.19.2-Forge" = _KbmgjzHt;
        "pkg-v4.2.6-1.19.2-Fabric" = _H6bV8m5B;
        "pkg-v8.0.1-1.20.1-Forge" = _DGpQY9FC;
        "pkg-v8.0.1-1.20.1-Fabric" = _pKppH9ZE;
        "pkg-v8.1.0-1.20.1-Forge" = _JVxkvWK8;
        "pkg-v8.1.0-1.20.1-Fabric" = _PFZTXyHA;
        "pkg-v8.1.1-1.20.1-Forge" = _KPD0zika;
        "pkg-v8.1.1-1.20.1-Fabric" = _aOhKgqSj;
        "pkg-v8.1.2-1.20.1-Forge" = _U3MMmaF4;
        "pkg-v8.1.2-1.20.1-Fabric" = _sgWVAW2l;
        "pkg-v8.1.3-1.20.1-Forge" = _1ZcXawzq;
        "pkg-v8.1.3-1.20.1-Fabric" = _1SWNH36G;
        "pkg-v20.4.0-1.20.4-Fabric" = _hIOdxem3;
        "pkg-v20.4.0-1.20.4-Forge" = _8gEkxi5V;
        "pkg-v20.4.0-1.20.4-NeoForge" = _zyuHIVP6;
        "pkg-v8.1.4-1.20.1-Forge" = _yHaWLo5t;
        "pkg-v8.1.4-1.20.1-Fabric" = _84fNDUkA;
        "pkg-v20.4.1-1.20.4-Fabric" = _vRnCnKBa;
        "pkg-v20.4.1-1.20.4-Forge" = _t5DmNPiH;
        "pkg-v20.4.1-1.20.4-NeoForge" = _q5BqKwQX;
        "pkg-v21.0.0-1.21-Fabric" = _Muht05v2;
        "pkg-v21.0.0-1.21-NeoForge" = _vRSnDLGj;
        "pkg-v21.1.0-1.21.1-Fabric" = _IGl3vXh4;
        "pkg-v21.1.0-1.21.1-NeoForge" = _T9uqSXDp;
        "pkg-v8.1.5-1.20.1-Forge" = _6eK8RyWM;
        "pkg-v8.1.5-1.20.1-Fabric" = _eJNY2Ah4;
        "pkg-v21.1.1-1.21.1-Fabric" = _9jL3vlSG;
        "pkg-v21.1.1-1.21.1-NeoForge" = _bgR1e0O5;
        "pkg-v21.3.0-1.21.3-Fabric" = _kO1SdUcb;
        "pkg-v21.3.0-1.21.3-NeoForge" = _YUMLZFfe;
        "pkg-v21.4.0-1.21.4-Fabric" = _CInGOy4w;
        "pkg-v21.4.0-1.21.4-NeoForge" = _Rl0brNhG;
        "pkg-v21.5.0-1.21.5-Fabric" = _ozPfDzU0;
        "pkg-v21.5.0-1.21.5-NeoForge" = _iIa84FWE;
        "pkg-v21.6.0-1.21.6-Fabric" = _cibYXnR5;
        "pkg-v21.6.0-1.21.6-NeoForge" = _75D67174;
        "pkg-v21.7.0-1.21.7-Fabric" = _Zk5ho96k;
        "pkg-v21.7.0-1.21.7-NeoForge" = _RoAfV0Ew;
        "pkg-v21.8.0-1.21.8-Fabric" = _xBB8Dz7w;
        "pkg-v21.8.0-1.21.8-NeoForge" = _KDCZRhLk;
        "pkg-v21.8.1-1.21.8-Fabric" = _ey6Jjbra;
        "pkg-v21.8.1-1.21.8-NeoForge" = _acEcLHde;
        "pkg-21.9.0" = _WFXvA8Kf;
        "pkg-21.10.0" = _TSePnzLa;
        "pkg-21.11.0" = _t5JYNClU;
