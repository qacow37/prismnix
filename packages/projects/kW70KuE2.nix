...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _63a2gnve;
        "pkg-1.1.0-1.21.10" = _Z3kXF28g;
        "pkg-1.1.0-1.21.11" = _Ynshl1qC;
        "pkg-1.1.0-1.21.8" = _4vbh5NCs;
        "pkg-1.2.0-1.21.10" = _3EKOOyiX;
        "pkg-1.2.0-1.21.11" = _YlfkcWya;
        "pkg-1.2.0-1.21.8" = _WHl1q9mr;
        "pkg-1.3.0-1.21.10" = _LETrsDPy;
        "pkg-1.3.0-1.21.11" = _PkN5nFzl;
        "pkg-1.3.0-1.21.8" = _diDzuKY7;
        "pkg-1.3.1-1.21.10" = _xjCTKqIv;
        "pkg-1.3.1-1.21.11" = _eFcrCjNH;
        "pkg-1.3.1-1.21.8" = _tlTCvVsn;
        "pkg-1.3.2-1.21.8" = _cPXB902y;
        "pkg-1.3.2-1.21.10" = _1kWMD2jM;
        "pkg-1.3.2-1.21.11" = _PNhVyg8w;
        "pkg-1.3.3-1.21.10" = _Skrrxvy9;
        "pkg-1.3.3-1.21.8" = _1qsT07Ef;
        "pkg-1.3.3-1.21.11" = _pNJy0lDp;
        "pkg-1.3.4-1.21.11" = _xO3ZvDmv;
        "pkg-1.3.4-1.21.10" = _tWqsIfoQ;
        "pkg-1.3.4-1.21.8" = _Gnz9Gu4h;
        "pkg-1.3.4-26.1" = _n6uE5jnc;
        "pkg-1.3.5-1.21.10" = _C2bh0vtT;
        "pkg-1.3.5-1.21.11" = _rvalkq7a;
        "pkg-1.3.5-1.21.8" = _eZj1Uk5a;
        "pkg-1.3.5-26.1" = _PppdjlB8;
        "pkg-1.3.5-26.2" = _IAgTrSzV;
        "default" = _IAgTrSzV;
    });
