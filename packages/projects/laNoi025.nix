...
let
    ...
    in {
        ...
        "pkg-1.12-1" = _dMkfnDRl;
        "pkg-1.16-fabric-1" = _U6mIvhIm;
        "pkg-1.16-forge-1" = _26H5ag6O;
        "pkg-1.18-forge-1" = _Ey9Br9mx;
        "pkg-1.18-fabric-1" = _cnYywM8P;
        "pkg-1.19-fabric-1" = _oFC0bu6m;
        "pkg-1.19-forge-1" = _44ZLtFy9;
        "pkg-1.19.3-fabric-1" = _9QuJisc7;
        "pkg-1.19.3-forge-1" = _tbJF9lrH;
        "pkg-1.19.4-forge-1" = _F853Fbtf;
        "pkg-1.19.4-fabric-1" = _432NAc1W;
        "pkg-1.20-fabric-1" = _pRiaLoXI;
        "pkg-1.20-forge-1" = _ACBE7DFS;
        "pkg-1.19-forge-2" = _oIXI7C8T;
        "pkg-1.20-fabric-2" = _hvQrztky;
        "pkg-1.20-forge-2" = _WWgSri5T;
        "pkg-1.20-fabric-3" = _ugn7KfrH;
        "pkg-1.20-forge-3" = _GkFRiRq0;
        "pkg-1.20-fabric-4" = _d859NHWh;
        "pkg-1.20-forge-4" = _qZwf8RIJ;
        "pkg-1.20.2-fabric-1" = _jYEgmG9X;
        "pkg-1.20.2-fabric-2" = _jDkmPv5l;
        "pkg-1.2.2-fabric-mc1.20.4" = _EB17vw3U;
        "pkg-1.20.4-fabric-1" = _h8cDdQ4Z;
        "pkg-1.20.4-fabric-2" = _I2nfsZOD;
        "pkg-1.20-fabric-5" = _OyLhWReL;
        "pkg-1.20-forge-5" = _GE608lKF;
        "pkg-1.20.4-fabric-3" = _1ZjpYx7G;
        "pkg-1.21-fabric-1" = _OPtoNGCV;
        "pkg-1.21.3-fabric-1" = _7CuCHKNy;
        "pkg-1.21.4-fabric-1" = _Chl5hwLw;
        "pkg-1.21.1-neoforge-1" = _efjk3jeu;
        "pkg-1.21.11-fabric-1" = _F3g7u9VM;
        "pkg-1.21.11-fabric-2" = _gTF5QTWo;
        "pkg-26.1x-fabric-1" = _vB9Q7HEA;
        "pkg-26.2-fabric-1" = _id6Yni9S;
        "pkg-1.21.11-neoforge-1" = _9iHBTfMc;
        "pkg-26.1x-neoforge-1" = _JuOOCoCp;
        "default" = _JuOOCoCp;
    });
