...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.7-fabric" = _V2VWjHuc;
        "pkg-1.18.2-1.7-fabric" = _TU0FwDFl;
        "pkg-1.19.2-1.9-fabric" = _RuNiaJgZ;
        "pkg-1.16.5-1.3-forge" = _l5o4MYZs;
        "pkg-1.18.2-1.5-forge" = _sFuK6wL7;
        "pkg-1.19.2-1.6-forge" = _hIub1aMT;
        "pkg-1.16.5-2.0-fabric" = _U7xUIOuW;
        "pkg-1.18.2-2.0-fabric" = _EqPESz34;
        "pkg-1.19.2-2.0-fabric" = _3YnemqJ4;
        "pkg-1.19.3-2.1-fabric" = _F7wOZVEm;
        "pkg-1.19.3-1.6-forge" = _hxAi5TJy;
        "pkg-1.18.2-3.0-forge+fabric" = _CEk3vhSI;
        "pkg-1.19.2-3.0-forge+fabric" = _6k3WYzpE;
        "pkg-1.19.3-3.0-forge+fabric" = _mcm6O0ZI;
        "pkg-1.19.4-3.0-forge+fabric" = _va54okul;
        "pkg-1.20-3.0-forge+fabric" = _M8dcaWDt;
        "pkg-1.20.1-3.0-forge+fabric" = _wrVEq9Tc;
        "pkg-1.20.2-3.0-forge+fabric" = _WIsWVYPG;
        "pkg-1.18.2-3.1-forge+fabric" = _8evp8zUf;
        "pkg-1.19.2-3.1-forge+fabric" = _m1s56fG6;
        "pkg-1.20.1-3.1-forge+fabric" = _dLkgTPGW;
        "pkg-1.20.2-3.1-forge+fabric" = _VQWUr9c3;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _HEoZauoQ;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _Opk0YNrI;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _BC6szLH2;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _raPA1Mru;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _7LLnDRDL;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _pHp8YFpu;
        "pkg-1.20.5-3.2-fabric+neo" = _V6jFx8AQ;
        "pkg-1.20.5-3.3-fabric+neo" = _X1nWbrRu;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _Cet0q5Km;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _oIqBYQAc;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _X3RnYdIa;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _Npvz3m4C;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _A0467RE2;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _PzqAj1gG;
        "pkg-1.21.2-3.4-fabric+neo" = _RIgCL2XL;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _AcKcRvj8;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _H5FT1t3x;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _HSkr4Fbi;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _fte02Hqv;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _2ozkf8j1;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _uSVhGY9t;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _3QH6utEC;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _GvE5dxU6;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _V71M0esm;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _1Vj4I9x7;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _WH63DOtp;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _FvgGtm6S;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _NUkMv8Bb;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _TVUeFT5c;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _1EmSooA9;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _D3TdRcC5;
        "default" = _D3TdRcC5;
    });
