...
let
    ...
    in {
        ...
        "pkg-1.18.2-2.4.5" = _3vhy3flv;
        "pkg-1.18.2-2.4.6" = _5ZkZ96HW;
        "pkg-1.19.4-2.4.6" = _6waYllVk;
        "pkg-1.20.1-2.4.6" = _8gXB5KOK;
        "pkg-1.18.2-2.4.7" = _gPRceqws;
        "pkg-1.19.4-2.4.7" = _wOV6DfBI;
        "pkg-1.20.1-2.4.7" = _8ncJzt0Z;
        "pkg-1.18.2-2.4.8" = _SvfqcWmO;
        "pkg-1.20.1-2.4.8" = _YIvCOqJl;
        "pkg-1.18.2-2.4.9" = _XWdXRE00;
        "pkg-1.20.1-2.4.9" = _3MaP6LvO;
        "pkg-1.20.5-2.4.9" = _LAsihwFg;
        "pkg-1.21.1-2.4.10" = _XUd4MHVw;
        "pkg-1.21.1-2.4.11" = _8uZ2AAT1;
        "pkg-1.21.1-2.4.12" = _NeSpULA4;
        "pkg-1.18.2-2.4.12" = _RPPZvU2G;
        "pkg-1.20.1-2.4.12" = _EA7jNW7M;
        "pkg-1.18.2-2.4.12.b" = _MSwlEjG5;
        "pkg-1.18.2-2.4.13-fabric" = _TTxoSPHz;
        "pkg-1.18.2-2.4.13-forge" = _5zX9rSm7;
        "pkg-1.20.1-2.4.13-fabric" = _a6JDytpU;
        "pkg-1.20.1-2.4.13-forge" = _WHIpJuDe;
        "pkg-1.21.1-2.4.13-fabric" = _r67DqJW6;
        "pkg-1.21.1-2.4.13-neoforge" = _DRo2fy0S;
        "pkg-1.18.2-2.5.0-fabric" = _dzpyEnai;
        "pkg-1.18.2-2.5.0-forge" = _QjJzsWlV;
        "pkg-1.20.1-2.5.0-fabric" = _M0UZWP0z;
        "pkg-1.20.1-2.5.0-forge" = _7JUt6djJ;
        "pkg-1.21.1-2.5.0-neoforge" = _udH4RAWZ;
        "pkg-1.21.1-2.5.1-fabric" = _n36ej8pE;
        "pkg-1.21.1-2.5.1-neoforge" = _6YQUHCBw;
        "pkg-1.18.2-2.5.2-fabric" = _8jsAYc0l;
        "pkg-1.18.2-2.5.2-forge" = _3zbwxT4m;
        "pkg-1.20.1-2.5.2-fabric" = _4t8445c0;
        "pkg-1.20.1-2.5.2-forge" = _MzCqdK5H;
        "pkg-1.21.1-2.5.2-fabric" = _MOuZUqgc;
        "pkg-1.21.1-2.5.2-neoforge" = _IACvVuJo;
        "pkg-1.20.1-2.5.3-fabric" = _JDjglwQu;
        "pkg-1.20.1-2.5.3-forge" = _JnhxJb0O;
        "pkg-1.21.1-2.5.3-fabric" = _g1CBQhZL;
        "pkg-1.21.1-2.5.3-neoforge" = _yNr53cS6;
        "pkg-1.21.5-2.5.3-fabric" = _AriKfGVn;
        "pkg-1.21.5-2.5.3-neoforge" = _agbteKoQ;
        "pkg-1.21.1-2.6.0-fabric" = _eqRSbgwz;
        "pkg-1.21.1-2.6.0-neoforge" = _qRI6wwUP;
        "pkg-1.21.5-2.6.0-fabric" = _r7MDTDz0;
        "pkg-1.21.5-2.6.0-neoforge" = _eeMAoMUk;
        "pkg-1.21.1-2.6.1-fabric" = _ZnBeLaht;
        "pkg-1.21.1-2.6.1-neoforge" = _dU9iQDd7;
        "pkg-1.21.5-2.6.1-fabric" = _8SkYYx0s;
        "pkg-1.21.5-2.6.1-neoforge" = _MeUPKFco;
        "pkg-1.21.1-2.6.2-fabric" = _105N6s07;
        "pkg-1.21.1-2.6.2-neoforge" = _NTh06kny;
        "pkg-1.21.5-2.6.2-fabric" = _tiMtRpwO;
        "pkg-1.21.5-2.6.2-neoforge" = _rSKIryHM;
        "pkg-1.21.1-2.7.0-neoforge" = _HcbhEKNd;
        "pkg-1.21.1-2.7.0-fabric" = _RKmFSccQ;
        "pkg-1.21.1-2.7.0.b-neoforge" = _PTE0Z27f;
        "pkg-1.21.1-2.7.1-neoforge" = _73MCANuL;
        "pkg-1.21.1-2.7.1-fabric" = _fprZgts3;
        "pkg-26.1.2-2.7.1-neoforge" = _SjHpeVyN;
        "pkg-26.1.2-2.7.1-fabric" = _NRg5bEhC;
        "pkg-1.21.1-2.8.0-neoforge" = _jN0Gh0z4;
