...
let
    ...
    in {
        ...
        "pkg-1.1.2" = _oYBpMgjc;
        "pkg-1.2-alpha1" = _KH2Vf1o6;
        "pkg-1.2-alpha.1" = _XcdClcIq;
        "pkg-1.2-beta1" = _uofTbJmU;
        "pkg-v1.2-beta2" = _Le0kIQD0;
        "pkg-1.2-beta3" = _tti8bA5i;
        "pkg-1.2-beta4" = _n6AuasA4;
        "pkg-1.2-beta5" = _W3lvWTIF;
        "pkg-1.2-rc1+1.17" = _IOaoRAtj;
        "pkg-1.2-rc1+1.16" = _jxCvNPTi;
        "pkg-1.2-rc2+1.16" = _rKMkSSk9;
        "pkg-1.2-rc2+1.17" = _TOiE1J80;
        "pkg-1.2-rc3+1.16" = _B5ghWMId;
        "pkg-1.2-rc3+1.17" = _goGGgERo;
        "pkg-1.2-rc3+1.18" = _MkoibBRz;
        "pkg-1.2-rc3A+1.17" = _KZILYZ1M;
        "pkg-1.2-rc3A+1.18" = _mnSIfFJ1;
        "pkg-1.2-rc4+1.16" = _7KHuAbIX;
        "pkg-1.2-rc4+1.17" = _SgGYmoBS;
        "pkg-1.2-rc4+1.18" = _RGaiu2kF;
        "pkg-1.2+1.16" = _qJv3HXUE;
        "pkg-1.2+1.17" = _zWZHJlpy;
        "pkg-1.2+1.18" = _U1PnvWWN;
        "pkg-1.2+1.18.2" = _ZwoaPnoN;
        "pkg-1.2.1+1.18.2" = _l2j21THi;
        "pkg-1.3+1.18.2" = _nvLzAkgL;
        "pkg-1.3+1.19" = _c8OHx32W;
        "pkg-1.3.a+1.19" = _6MzasbN6;
        "pkg-1.3.1+1.20.1" = _tLPYvIQM;
        "default" = _tLPYvIQM;
    });
