...
let
    ...
    in {
        ...
        "pkg-1.18.1-3.0.0-Beta9" = _73SE9sXp;
        "pkg-1.18.1-3.0.0-Beta10" = _51Qb6b4N;
        "pkg-1.16.5-2.0.0-rc2" = _54FdXWBK;
        "pkg-1.18.1-3.0.0-Beta11" = _zxL0Q5p1;
        "pkg-1.16.5-2.0.0" = _iSdVXYhe;
        "pkg-1.18.1-3.0.0-Beta12" = _pFknhfUk;
        "pkg-1.18.1-3.0.0-Beta13" = _sveLIHim;
        "pkg-1.16.5-2.0.1" = _URYoCv2O;
        "pkg-1.16.5-2.1.0-build2" = _9OJ8gmiL;
        "pkg-1.18.1-3.0.0-Beta14" = _bVjtG1oD;
        "pkg-1.16.5-2.2.0-Beta1" = _MeKesp89;
        "pkg-1.18.1-3.0.0-Beta15" = _ktXDLA3g;
        "pkg-1.16.5-2.2.0" = _sYmFfRQx;
        "pkg-1.18.1-3.0.0-Beta16" = _djNEt5dL;
        "pkg-1.18.1-3.0.0-Beta17" = _wxRbdaqb;
        "pkg-1.16.5-2.2.1" = _7KQ5tAK9;
        "pkg-1.18.1-3.0.0-Beta18" = _OVp7fbRI;
        "pkg-1.18.1-3.0.0-Beta19" = _inMsPmgP;
        "pkg-1.18.1-3.0.0-Beta20-build3" = _ABJSmM39;
        "pkg-1.18.1-3.0.0-Beta21" = _YwFCfQTL;
        "pkg-1.18.1-3.0.0-Beta22" = _2jv0WEEh;
        "pkg-4.0.0-alpha1" = _Bfb8Clxg;
        "pkg-4.0.0-alpha2" = _6v1hZsxE;
        "pkg-1.18.2-4.0.0-alpha3" = _gtlOYJXe;
        "pkg-1.18.2-4.0.0-alpha5" = _dRPi0aXn;
        "pkg-1.18.2-4.0.0-alpha6" = _GP2rYpL5;
        "pkg-1.18.2-4.0.0-alpha7" = _hGtyl6wX;
        "pkg-1.18.1-3.0.0-Beta23" = _7qP4g9N2;
        "pkg-1.18.2-4.0.0-alpha8" = _qCNlKHlO;
        "pkg-1.18.1-3.0.0-Beta24" = _Bw3LDzcu;
        "pkg-1.18.2-4.0.0-alpha9" = _2hSOqTfl;
        "pkg-1.16.5-2.2.2" = _KveVF1j8;
        "pkg-1.18.2-4.0.0-alpha10" = _6qWki0vh;
        "pkg-1.18.2-4.0.0-alpha11" = _6H1KCUwB;
        "pkg-1.18.2-4.0.0-beta1" = _2X7Gb15n;
        "pkg-1.18.2-do-not-use-7779" = _xBAs6GvS;
        "pkg-1.18.2-do-not-use-7780" = _ADp6O9LF;
        "pkg-1.18.1-3.0.0" = _YonahXej;
        "pkg-1.18.2-4.0.0-beta2" = _p5eR8uNt;
        "pkg-1.18.2-4.0.0-beta3" = _1o9n3ppo;
        "pkg-1.16.5-2.3.0" = _14w87CA7;
        "pkg-1.18.2-4.0.0-beta4" = _rcAWDZSe;
        "pkg-1.18.2-4.0.0" = _PlmtSTTG;
        "pkg-1.19-5.0.0-alpha1" = _kQPXcBuz;
        "pkg-1.19-5.0.0-alpha2" = _6HPaAn4z;
        "pkg-1.18.2-4.1.0" = _zqn6YpAH;
        "pkg-1.19-5.0.0-alpha3" = _5qhMxlww;
        "pkg-1.19.2-5.0.0-alpha4" = _pwgEFcp2;
        "pkg-1.20.1-1.20.1-6.0.0" = _N5YW1lFZ;
        "pkg-1.20.1-6.0.1" = _tvLTgyqx;
        "pkg-1.20.1-6.0.2" = _1qATNC96;
        "default" = _1qATNC96;
    });
