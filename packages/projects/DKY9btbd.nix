...
let
    ...
    in {
        ...
        "pkg-7.0.8" = _w0K0yycS;
        "pkg-7.0.9" = _NpagB1YQ;
        "pkg-7.0.10" = _W2ty7vtx;
        "pkg-7.0.11" = _tRzURjVY;
        "pkg-7.0.12" = _J66QOTLZ;
        "pkg-7.0.13-beta-1" = _r9yT7tvE;
        "pkg-7.0.13-beta-2" = _S1KKDczu;
        "pkg-7.0.13" = _f9NoeotB;
        "pkg-7.0.14" = _PO4MKx7e;
        "pkg-7.0.15-beta-01" = _Cm1YG6Lt;
        "pkg-7.0.15" = _WaElxvDz;
        "pkg-7.0.16-beta-01" = _oyjmf4DD;
