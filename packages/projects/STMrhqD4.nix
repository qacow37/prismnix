...
let
    ...
    in {
        ...
        "pkg-0.0.2-SNAPSHOT" = _s2GCC3DC;
        "pkg-0.0.2-SNAPSHOT-1.21.1" = _josw5Cyk;
        "pkg-0.0.3-SNAPSHOT-1.21.4" = _VPyVsGVT;
        "pkg-0.0.3-SNAPSHOT-1.21.1" = _eOx3gUOo;
        "pkg-1.0.0-1.21.4" = _cAwUmxK6;
        "pkg-1.0.0-1.21.1" = _PVd8SuNP;
        "pkg-1.0.2-1.21.4" = _AUe0YMMB;
        "pkg-1.0.2-1.21.1" = _uNrL8fEY;
        "pkg-1.1.0-1.21.4" = _leskcj8m;
        "pkg-1.1.1-1.21.4" = _G2IArGit;
        "pkg-1.1.2-1.21.4" = _N1cC7iRL;
        "pkg-1.1.2-1.21.1" = _tTpCgYgh;
        "pkg-1.1.2-1.21.2" = _7nqUNA2w;
        "pkg-1.1.2-1.21.3" = _7zDtM5hK;
        "pkg-1.1.2-1.21" = _MMy6mfjn;
        "pkg-1.1.3-1.21.6" = _aPUSFa3x;
        "pkg-1.1.3-1.21.5" = _APzMzK7R;
        "pkg-1.1.3-1.21" = _QcOKRIo3;
        "pkg-1.1.4-1.21" = _C0JjWclN;
        "pkg-1.1.4-1.21.6" = _jTtDEJrR;
        "pkg-1.2.0-1.21" = _LURO8C51;
        "pkg-1.2.0-1.21.6" = _g75W4Yz8;
        "pkg-1.3.0-1.21.6" = _mQyl4K4w;
        "pkg-1.3.1-1.21.6" = _cmpGxY4P;
        "pkg-1.3.1-1.21" = _bgeY8t6k;
        "pkg-1.3.2-1.21.6" = _NG5bEkGV;
        "pkg-1.3.2-1.21" = _SZs2Te5P;
        "pkg-1.3.3-1.21.6" = _72NJEv9G;
        "pkg-26.1-1.0.0-alpha1" = _F7MHDxma;
        "pkg-26.1-1.0.0-alpha3" = _ieu31xlz;
        "pkg-26.2-1.0.0-alpha2" = _rBPRuZNA;
        "pkg-26.2-1.0.0-alpha3" = _cLFcgDyi;
        "default" = _cLFcgDyi;
    });
