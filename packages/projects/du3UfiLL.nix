...
let
    ...
    in {
        ...
        "pkg-0.2.3-1.16.5" = _k9TVypM4;
        "pkg-0.2.3-1.17.1" = _RL4ZMqCD;
        "pkg-1.3.5" = _z7cjnSIF;
        "pkg-1.3.6" = _y0KjhYqU;
        "pkg-1.3.7" = _3k5rfU6w;
        "pkg-1.4.0" = _CTY7Q9Xs;
        ...
        "pkg-1.3.8" = _ki06LuGM;
        "pkg-1.4.6" = _wCkpCd2l;
        "pkg-1.5.1-1.19.3" = _k5GkdSyZ;
        "pkg-1.6-1.19.4" = _YH4S0vod;
        "pkg-1.7-1.20" = _s0gB9jTl;
        "pkg-1.7.2-1.20" = _Pq5PzoYI;
        "pkg-1.7.3-1.20.2" = _FjFb2iUx;
        "pkg-1.3.10-1.18.2" = _1Q2KpDg4;
        "pkg-1.7.4-1.20.1" = _GLaf28Uv;
        "pkg-1.4.7-1.19.2" = _639TWWBs;
        "pkg-1.6.1-1.19.4" = _ASi0NoBf;
        "pkg-1.7.4-1.20.2" = _J2PI77PI;
        "pkg-1.8.0-1.20.4" = _TVUDm3bh;
        "pkg-1.8.1-1.20.4" = _7q5XBhQR;
        "pkg-1.7.5-1.20.1" = _yoCCX4Cc;
        "pkg-1.7.5-1.20.2" = _7pKMIuYh;
        "pkg-1.3.11-1.18.2" = _O1BXugqn;
        "pkg-1.4.8-1.19.2" = _mI7U2FMe;
        "pkg-1.8.2-1.20.4" = _cgCAFjOh;
        "pkg-1.10.0-1.21" = _yjgcPYVA;
        "pkg-1.10.1-1.21" = _WqdFP96x;
        "pkg-1.10.2-1.21.1" = _aSCbUUL1;
        "default" = _aSCbUUL1;
    });
