...
let
    ...
    in {
        ...
        "pkg-1.0" = _j01EkBQV;
        "pkg-1.0_mod" = _s2iyZO24;
        "pkg-1.1" = _yKKu2rh1;
        "pkg-1.2" = _KRoUXiAt;
        "pkg-1.2+mod" = _10hgorx4;
        "pkg-1.3" = _Sww6kvs6;
        "pkg-1.3+mod" = _Q2dMMsU2;
        "pkg-2.0" = _6nRXOxRq;
        "pkg-2.0+mod" = _QlBruZNS;
        "pkg-3.0" = _dxiVNzXW;
        "pkg-3.0+mod" = _Kub5dVDz;
        "pkg-3.1" = _Gh79B0DL;
        "pkg-3.1+mod" = _PGrrJ395;
        "pkg-3.2" = _Ivg3cFDY;
        "pkg-4.0" = _JrjZYiiN;
        "pkg-4.0+mod" = _969kYcKo;
        "pkg-4.1" = _9LGpNTxF;
        "pkg-4.1+mod" = _ryxvdTeK;
        "pkg-4.2" = _gKqBjedl;
        "pkg-4.2+mod" = _PZWdWP93;
        "pkg-4.3" = _tmYEWsJp;
        "pkg-4.3+mod" = _skEV2TA0;
        "pkg-4.4" = _LsRGMzrx;
        "pkg-4.4+mod" = _dA6FFJRs;
        "pkg-4.5" = _mgP6Sx26;
        "pkg-4.5+mod" = _TeT4looI;
        "pkg-4.6" = _cdJ6RFC6;
        "pkg-4.6+mod" = _uI8SzAPg;
        "pkg-4.7" = _fLSMmeIg;
        "pkg-4.7-fabric" = _9rIgHyAY;
        "pkg-4.7-forge" = _asxlScjx;
        "pkg-4.11" = _444sl4GO;
        "pkg-4.11-fabric" = _cIHYZBIE;
        "pkg-4.11-quilt" = _LxR1bp09;
        "pkg-4.11-forge" = _DXsV4V24;
        "pkg-4.11-neoforge" = _ZGdnWIck;
        "pkg-4.12" = _zmEnHAoZ;
        "pkg-4.12-fabric" = _YdFElXbi;
        "pkg-4.12-quilt" = _28nXDWUs;
        "pkg-4.12-forge" = _KbJ05yM9;
        "pkg-4.12-neoforge" = _5alzSwR5;
        "pkg-4.13" = _83Tn5KRe;
        "pkg-4.13-fabric" = _o2k8tB8G;
        "pkg-4.13-quilt" = _D2z2VhYq;
        "pkg-4.13-forge" = _NCS3rZQd;
        "pkg-4.13-neoforge" = _X0NV3rZw;
        "default" = _X0NV3rZw;
    });
