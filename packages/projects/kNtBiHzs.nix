...
let
    ...
    in {
        ...
        "pkg-0.3.1" = _6DGBeivG;
        "pkg-0.4" = _moDRNetn;
        "pkg-mc1.20.1-0.4.1" = _eqa04WV9;
        "pkg-mc1.21-0.4.1" = _CbzEFsfE;
        "pkg-mc1.21-0.4.2" = _kkbLXlCg;
        "pkg-mc1.20.1-0.4.3" = _8dG0YQiO;
        "pkg-mc1.21-0.4.3" = _pwjKF4pd;
        "pkg-mc1.21-0.4.4" = _mq9CfrUV;
        "pkg-mc1.20.1-0.4.4" = _ZfoYqop0;
        "pkg-mc1.21.3-0.4.4" = _WC6mEGr2;
        "pkg-mc1.21.3-0.4.5" = _qEv4e2Xj;
        "pkg-mc1.21.3-0.4.6" = _HeqtNVIu;
        "pkg-mc1.21-0.4.6" = _XmKwdGjz;
        "pkg-mc1.20.4-0.4.10" = _5mZPEnSI;
        "pkg-mc1.21-0.4.10" = _XLW2bGkb;
        "pkg-mc1.21.3-0.4.10" = _tafzK4lS;
        "pkg-0.5.0+1.21-1.21.1" = _bKnlN35w;
        "pkg-0.5.0+1.21.3" = _zqkfvk7o;
        "pkg-0.5.0+1.21.4" = _e9CFAZiS;
        "pkg-0.5.0+1.21.5" = _iFh1jRLk;
        "pkg-0.5.0+1.21.6-1.21.8" = _clcOAY4D;
        "pkg-0.5.0+1.21.9-1.21.11" = _NJEV58WC;
        "pkg-0.5.1c+1.21-1.21.1" = _bCy6JvyI;
        "pkg-0.5.1c+1.21.3" = _NZwrRnVg;
        "pkg-0.5.1c+1.21.4" = _USbaCmJR;
        "pkg-0.5.1c+1.21.5" = _JZHDgewZ;
        "pkg-0.5.1c+1.21.6-1.21.8" = _mDkaOZQw;
        "pkg-0.5.1c+1.21.9-1.21.11" = _OWYFQnj5;
        "default" = _OWYFQnj5;
    });
