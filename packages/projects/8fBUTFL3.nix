...
let
    ...
    in {
        ...
        "pkg-0.7.2" = _hri6J2VH;
        "pkg-0.9" = _SkQaD5eF;
        "pkg-1.0-fabric" = _4O1A3vSU;
        "pkg-1.0-forge" = _JrKMGzRE;
        "pkg-1.0" = _acFDoRMu;
        "pkg-1.1" = _HthkuEsJ;
        "pkg-1.1-hotfix-1" = _zVwtM4fh;
        "pkg-1.1-hotfix-2" = _7s5QPbow;
        "pkg-1.1-hotfix-3" = _kYJcyOJb;
        "pkg-1.1-hotfix-4" = _2Am71oJq;
        "pkg-1.1-hotfix-5" = _cbCQnVbT;
        "pkg-1.2" = _ci45Rb2m;
        "pkg-1.2-hotfix-1" = _NVnjiI3T;
        "pkg-1.2.1-fabric" = _y8OW04c4;
        "pkg-1.2.1-forge" = _NrFkBETi;
        "pkg-1.3-fabric" = _HUpzx3pX;
        "pkg-1.3-forge" = _ezrFfv2W;
        "pkg-1.4+fabric-1.21" = _UEairQsB;
        "pkg-1.4+neoforged-1.21" = _9pr5e8KA;
        "pkg-1.4.1+fabric-1.21" = _YHE84Ja1;
        "pkg-1.4.1+neoforged-1.21" = _SOev5Iie;
        "pkg-1.4.1.1+fabric-1.21" = _3aKRGZNx;
        "pkg-1.4.1.2+fabric-1.21" = _l4ABWt8u;
        "pkg-1.4.1.3+fabric-1.21" = _Oq2igXo6;
        "pkg-1.4.1.4+fabric-1.21" = _65EWUs6d;
        "pkg-1.4.1.5+fabric-1.21" = _XbHaISPu;
        "pkg-1.4.1.6+fabric-1.21" = _kLzT1EuM;
        "pkg-1.4.1.6+neoforged-1.21" = _puSGwLx6;
        "pkg-1.4.1.7+fabric-1.21" = _EtsnK5DS;
        "pkg-1.4.1.7+neoforged-1.21" = _jePvGQAp;
        "pkg-1.4.1.8+fabric-1.21" = _Vm7ss9uH;
        "pkg-1.4.1.9+fabric-1.21" = _wyI5oytp;
        "pkg-1.4.1.9+neoforged-1.21" = _QwM3PGbi;
        "pkg-1.4.2+fabric-1.21" = _s8IIqKaQ;
        "pkg-1.4.2+neoforged-1.21" = _ZwkshpjF;
        "pkg-1.4.3+fabric-1.21" = _TwVlFQt5;
        "pkg-1.4.3+neoforge-1.21" = _OP0LQuBW;
        "default" = _OP0LQuBW;
    });
