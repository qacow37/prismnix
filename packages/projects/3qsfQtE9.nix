...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _Fq42foYA;
        "pkg-1.9.2" = _IkbywOGy;
        "pkg-1.10.0" = _fLwacDtJ;
        "pkg-1.10.1" = _Rduo9X24;
        "pkg-1.11.0" = _k7UzYiPs;
        "pkg-1.12.0" = _QAIZAV4p;
        "pkg-1.12.1" = _crC7YOpw;
        "pkg-1.13.0" = _jaP1LlEY;
        "pkg-1.13.1" = _qxSnvZv4;
        "pkg-1.14.0" = _aKAvBwSt;
        "pkg-1.14.1" = _HfdXLVRy;
        "pkg-1.14.2" = _EHP6TUoi;
        "pkg-1.14.3" = _4eAaapNR;
        "pkg-1.14.4" = _CULoAysC;
        "pkg-1.15" = _uigdNjoA;
        "pkg-1.16.0" = _6ua1cGVp;
        "pkg-1.16.1" = _Zi2NZDy6;
        "pkg-1.15.1" = _bv728tNJ;
        "pkg-1.16.2" = _qaV4jqYg;
        "pkg-1.16.3" = _AhvqqGWZ;
        "pkg-1.16.4" = _GLPR7u6l;
        "pkg-1.17.0" = _Y8Tsud9e;
        "default" = _Y8Tsud9e;
    });
