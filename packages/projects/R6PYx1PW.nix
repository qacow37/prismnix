...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.7-fabric" = _2T2zf4I5;
        "pkg-1.18.2-1.7-fabric" = _b8NTRlat;
        "pkg-1.19.2-1.8-fabric" = _60lSGNN8;
        "pkg-1.16.5-1.3-forge" = _3hgsddyp;
        "pkg-1.18.2-1.4-forge" = _o93ju0fB;
        "pkg-1.19.2-1.6-forge" = _DbindusS;
        "pkg-1.16.5-1.9-fabric" = _GHst6iQm;
        "pkg-1.18.2-1.9-fabric" = _jEzENH0P;
        "pkg-1.19.2-1.9-fabric" = _HEydRBNr;
        "pkg-1.16.5-2.0-fabric" = _n3ScyPHf;
        "pkg-1.18.2-2.0-fabric" = _QmVfcFMP;
        "pkg-1.19.3-2.0-fabric" = _xJDQSgrL;
        "pkg-1.16.5-2.0-forge" = _vTyLu9WA;
        "pkg-1.18.2-2.0-forge" = _uYX72x4u;
        "pkg-1.19.2-2.0-forge" = _IZybTl9K;
        "pkg-1.19.3-2.0-forge" = _DCtN0wox;
        "pkg-1.18.2-3.0-forge+fabric" = _nr49auAI;
        "pkg-1.19.2-3.0-forge+fabric" = _w75d0EJ4;
        "pkg-1.19.3-3.0-forge+fabric" = _TFKmnnrI;
        "pkg-1.19.4-3.0-forge+fabric" = _CfxdJ3Nt;
        "pkg-1.20-3.0-forge+fabric" = _vQxdD5TB;
        "pkg-1.20.1-3.0-forge+fabric" = _J6ZHf3mB;
        "pkg-1.20.2-3.0-forge+fabric" = _ZdymPXXQ;
        "pkg-1.18.2-3.1-forge+fabric" = _nXhHqXlJ;
        "pkg-1.19.2-3.1-forge+fabric" = _zT5j8ICC;
        "pkg-1.20.1-3.1-forge+fabric" = _JCAthDgS;
        "pkg-1.20.2-3.1-forge+fabric" = _LazFxAts;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _TFPeO0w0;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _r00MvmwO;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _73s2K38W;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _5CJoqJSY;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _WID2QkRt;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _KJByZJAe;
        "pkg-1.20.5-3.2-fabric+neo" = _uow7QNJP;
        "pkg-1.20.5-3.3-fabric+neo" = _R8YGvcX4;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _PQMaBZR3;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _tKgCkSM2;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _jJQ7KfHX;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _tQerTxai;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _RIUKHo6c;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _waX5ghia;
        "pkg-1.21.2-3.4-fabric+neo" = _r9hnzUYu;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _eOBujRBs;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _Mt7U4H5S;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _gWxIfLYX;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _yiFf7cwg;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _EmUevo2v;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _iybn8TCZ;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _wDS7Hefw;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _Jsg5giFY;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _aoKw6oXj;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _Htvg0lHB;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _QT2IDBg2;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _209iSL2o;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _weJ3kSsO;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _CYdk6tIy;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _nqzEJ1yQ;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _5j35APit;
        "default" = _5j35APit;
    });
