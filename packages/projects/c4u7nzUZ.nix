...
let
    ...
    in {
        ...
        "pkg-0.0.0-beta+mc1.21.4" = _S21wk70v;
        "pkg-0.0.1-beta+mc1.21.4" = _rCfCRGG6;
        "pkg-0.0.2-beta+mc1.21.4" = _v90rHywt;
        "pkg-0.0.3-beta+mc1.21.4" = _Wm682534;
        "pkg-0.1.0-beta+mc1.21.4" = _2yD3b8lB;
        "pkg-0.2.0-beta+mc1.21.4" = _Gx80ISKq;
        "pkg-0.2.1-beta+mc1.21.4" = _EiFCYpZi;
        "pkg-0.2.2-beta+mc1.21.4" = _Sor1e7Xa;
        "pkg-0.2.2-beta+mc1.21.5" = _ALlSvslN;
        "pkg-0.2.3-beta+mc1.21.5" = _6wEWoklP;
        "pkg-0.2.3-beta+mc1.21.4" = _dOTua3km;
        "pkg-0.3.0-beta+mc1.21.4" = _GKnWzgAf;
        "pkg-0.3.0-beta+mc1.21.5" = _U4Baepik;
        "pkg-0.4.0-beta+mc1.21.6" = _JABhdqvt;
        "pkg-0.4.0-beta+mc1.21.5" = _uZ1eUwHW;
        "pkg-0.4.0-beta.1+mc1.21.5" = _73XiKifS;
        "pkg-0.4.0-beta.1+mc1.21.6" = _8eOQxKpO;
        "pkg-0.4.1-beta+mc1.21.6" = _EXwBquDh;
        "pkg-0.4.1-beta+mc1.21.5" = _e6M1FZXO;
        "pkg-0.4.1-beta.1+mc1.21.6" = _5tdazLug;
        "pkg-0.4.1-beta.1+mc1.21.5" = _JY5zSh82;
        "pkg-0.5.0-beta+mc1.21.5" = _rNdd2pQw;
        "pkg-0.5.0-beta+mc1.21.6" = _v2XD9YoI;
        "pkg-0.5.0-beta" = _oaBYIs9r;
        "pkg-0.5.0-beta.1" = _sHoV2ZSf;
        "pkg-0.6.0-alpha+mc1.21.5" = _HdVQPC49;
        "pkg-0.6.0-alpha.1+mc1.21.5" = _1Y4N7mus;
        "pkg-0.6.0-alpha.2+mc1.21.5" = _BzSIfMAu;
        "pkg-0.6.0-alpha.3+mc1.21.5" = _gXmAynJq;
        "pkg-0.6.0-alpha.3+mc1.21.6" = _7uNh447Q;
        "pkg-0.6.0-beta+mc1.21.5" = _ovZ0bfbe;
        "pkg-0.6.0-beta+mc1.21.6" = _qxqfV1ja;
        "pkg-0.6.0-beta.1+mc1.21.5" = _ybSJU6ZH;
        "pkg-0.6.0-beta.1+mc1.21.6" = _S5YMVNMD;
        "pkg-0.6.1-beta.1+mc1.21.10" = _5IETw220;
        "pkg-0.6.1-beta.1+mc1.21.5" = _wyK1xngk;
        "pkg-0.6.1-beta.1+mc1.21.8" = _G0dXUnv0;
        "pkg-0.6.1-beta.2+mc1.21.10" = _NO0Nuhkt;
        "pkg-0.6.1-beta.2+mc1.21.8" = _S4C0m7aU;
        "pkg-0.6.2-beta+mc1.21.11" = _UookFWzK;
        "pkg-0.6.2-beta+mc1.21.10" = _RdwWbWd4;
        "pkg-0.6.2-beta.1+mc1.21.11" = _JmDCPma6;
        "pkg-0.6.2-beta.1+mc1.21.10" = _6YPGzLLK;
        "pkg-0.6.2-beta.3+mc1.21.11" = _Z1Lg9x3l;
        "pkg-0.6.2-beta.3+mc1.21.10" = _kj1awtUf;
        "pkg-0.6.2-beta.4+mc1.21.11" = _SFCB6Okz;
        "pkg-0.6.2-beta.4+mc1.21.10" = _H11xhaL3;
        "pkg-0.6.2-beta.4+mc26.2" = _LwxxXJfK;
        "pkg-0.6.2-beta.4+mc26.1.2" = _Mc0Norpy;
        "default" = _Mc0Norpy;
    });
