...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _tbnIIVEn;
        "pkg-1.0.1+fabric-1.21.1" = _B0Owtk4w;
        "pkg-1.0.1+neoforge-1.21.1" = _j6AIDXEP;
        "pkg-1.0.1+forge-1.21.1" = _L1N179FW;
        "pkg-1.0.2+forge-1.21.1" = _sAjD8UG1;
        "pkg-1.0.2+fabric-1.21.1" = _tJxBEtqV;
        "pkg-1.0.2+neoforge-1.21.1" = _TFh7Z7vK;
        "pkg-1.0.3-H1+forge-1.21.1" = _TMOWEqRH;
        "pkg-1.0.3-H1+fabric-1.21.1" = _hQ2NDk6o;
        "pkg-1.0.3-H1+neoforge-1.21.1" = _dH24OQnL;
        "pkg-1.0.4-E1+neoforge-1.21.1" = _cdTjz1XR;
        "pkg-1.0.4-E1+fabric-1.21.1" = _lVqUGZB1;
        "pkg-1.0.4-E1+forge-1.21.1" = _8jDMhj8Y;
        "pkg-1.0.4-E2+fabric-1.21.1" = _6ZwSxBz6;
        "pkg-1.0.4-E2+forge-1.21.1" = _xvyhSN4O;
        "pkg-1.0.4-E2+neoforge-1.21.1" = _8ZhVzi8b;
        "pkg-1.0.4+fabric-1.21.1" = _MnG8BTau;
        "pkg-1.0.4+forge-1.21.1" = _qkBH9Pda;
        "pkg-1.0.4+neoforge-1.21.1" = _ctYDHNqp;
        "pkg-1.0.4-H1+fabric-1.21.1" = _PyJ6KOId;
        "pkg-1.0.4-H1+forge-1.21.1" = _bZuzuChX;
        "pkg-1.0.4-H1+neoforge-1.21.1" = _8hcJOvIq;
        "pkg-1.0.4-H1+neoforge-1.21.5" = _J8yD3l3G;
        "pkg-1.0.4-H1+forge-1.21.5" = _s6mVI4O6;
        "pkg-1.0.4-H1+fabric-1.21.5" = _jaUAPAbP;
        "pkg-1.0.4-H2+neoforge-1.21.1" = _NWQI8rpO;
        "pkg-1.0.4-H2+forge-1.21.1" = _A9qT8lfW;
        "pkg-1.0.4-H2+fabric-1.21.1" = _kLNjwsvr;
        "pkg-1.0.4-H3+fabric-1.21.1" = _b1wuL4XJ;
        "pkg-1.0.4-H3+forge-1.21.1" = _jLJeoh3e;
        "pkg-1.0.4-H3+neoforge-1.21.1" = _DLIOYIKy;
        "pkg-1.0.4-H3+fabric-1.21.5" = _CkVMpx4u;
        "pkg-1.0.4-H3+forge-1.21.5" = _wGGO5xmM;
        "pkg-1.0.4-H3+neoforge-1.21.5" = _6PzDk8ep;
        "default" = _6PzDk8ep;
    });
