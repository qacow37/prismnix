...
let
    ...
    in {
        ...
        "pkg-1.3.8" = _imKUbKAX;
        "pkg-1.3.9" = _vMGUvIWW;
        "pkg-1.3.10" = _JkTScO5Z;
        "pkg-1.3.11" = _k0nqWf0H;
        "pkg-1.4.12" = _tySjQCOa;
        "pkg-1.4.13" = _sapk7doy;
        "pkg-1.4.14" = _y2ziXO9L;
        "pkg-1.5.14" = _N8AGPFgh;
        "pkg-1.5.15" = _wbM2hcy3;
        "pkg-1.5.16" = _BrKhajH5;
        "pkg-1.6.17" = _Do7r2PnV;
        "pkg-1.6.18" = _3tPfG19H;
        "pkg-1.6.19" = _3AUDH8Ji;
        "pkg-1.7.20" = _88NUg7qH;
        "pkg-1.7.21" = _QN80NFiV;
        "pkg-1.7.22" = _6rWhMUww;
        "pkg-1.7.23" = _d2uN3pI7;
        "pkg-1.7.24" = _yKYR2Koy;
        "pkg-1.7.25" = _QAupxQ9V;
        "pkg-1.7.26" = _FjcnNAmS;
        "pkg-1.7.27" = _tSKaXZIQ;
        "pkg-1.8.28" = _qIHQayON;
        "pkg-1.8.29" = _W0n7jRNR;
        "pkg-1.8.30" = _fKymUVhN;
        "pkg-1.9.31" = _pfbsSWZE;
        "pkg-1.9.32" = _5qzzQArv;
        "pkg-1.9.33" = _Q1N2nX6e;
        "pkg-1.10.34" = _5T5aMTJ3;
        "pkg-1.11.35" = _6U77b2vy;
        "pkg-1.11.36" = _rnICNMqv;
        "pkg-1.11.37" = _ZQlCJzjh;
        "pkg-1.11.38" = _fHJDWjFO;
        "pkg-1.11.39" = _QucbpBjx;
        "pkg-1.11.40" = _hBy9gaXZ;
        "pkg-1.12.41" = _BBOCqBbU;
        "pkg-1.12.42" = _WSAAMMTL;
        "pkg-1.13.43" = _HJ0ClFXv;
        "pkg-1.13.44" = _R1pokY2q;
        "pkg-1.13.45" = _liJnZJxw;
        "default" = _liJnZJxw;
    });
