...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21" = _FcyOOFRc;
        "pkg-1.0.1+1.21" = _U9oiWbLT;
        "pkg-1.0.1+1.21.3" = _cPLTKNOF;
        "pkg-1.1.0+1.21.3" = _42xRr9Ke;
        "pkg-1.1.0+1.21.4" = _Xy0Lit82;
        "pkg-1.1.1+1.21.4" = _h4XJpPzd;
        "pkg-1.1.1+1.21.5" = _HvKzAkFM;
        "pkg-1.1.2+1.21.5" = _mnFQ7Vvl;
        "pkg-1.1.2+1.21.6" = _aqY4pAcY;
        "pkg-1.1.2+1.21.7" = _pnc9eedW;
        "pkg-1.1.3+1.21.11" = _mbBsYJwe;
        "pkg-2.0.0+26.2" = _DeeoSj6P;
        "pkg-2.0.1+26.2" = _keqQaCSP;
        "pkg-2.0.2+26.2" = _YZdzOIS7;
        "pkg-2.0.3+26.2" = _zd8KqHBv;
        "pkg-2.0.4+26.2" = _mSXndPTr;
