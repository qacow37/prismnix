...
let
    ...
    in {
        ...
        "pkg-1.1.8" = _QL0xO4af;
        "pkg-1.1.9" = _hAy4BCXf;
        "pkg-1.1.10" = _gG8KgPus;
        "pkg-1.20.1-1.0.7" = _ahYHbvMC;
        "pkg-1.21.1-1.0.7" = _N8UJvjnw;
        "pkg-1.20.1-1.1.12" = _Sux4XDQ0;
        "pkg-1.21.1-1.1.12" = _sof4jdUi;
        "pkg-1.20.1-1.2.0-Fabric" = _dj8kHzFf;
        "pkg-1.20.1-1.2.0-Forge" = _57ZXwuL5;
        "pkg-1.21.1-1.2.0-Fabric" = _TxLAxKHB;
        "pkg-1.21.1-1.2.0-NeoForge" = _tnVf9NKS;
        "pkg-1.20.1-1.3.0-Fabric" = _MuYfwoUf;
        "pkg-1.20.1-1.3.0-Forge" = _RF9fAcP9;
        "pkg-1.21.1-1.3.0-Fabric" = _n7jktUFE;
        "pkg-1.21.1-1.3.0-NeoForge" = _L8FtTB8v;
        "pkg-1.20.1-1.4.0-Fabric" = _pai773WJ;
        "pkg-1.20.1-1.4.0-Forge" = _wFlD9yTq;
        "pkg-1.21.1-1.4.0-Fabric" = _msqQbeg3;
        "pkg-1.21.1-1.4.0-NeoForge" = _9cN9nlTk;
        "default" = _9cN9nlTk;
    });
