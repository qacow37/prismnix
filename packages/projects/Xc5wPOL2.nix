...
let
    ...
    in {
        ...
        "pkg-1.0.7" = _XWLDF4Vu;
        "pkg-1.0.9" = _cIY1HrAd;
        "pkg-1.0.10" = _Kn57xjfQ;
        "pkg-1.0.11" = _wpLw0XU0;
        "pkg-1.0.12" = _viI0DXMW;
        "pkg-1.0.13" = _cUv6UiTM;
        "pkg-1.0.14" = _Qlame73Z;
        "pkg-1.0.15" = _ruxOadpa;
        "pkg-1.0.16" = _JDlE8wbh;
        "pkg-1.0.17" = _e3GG1XZW;
        "pkg-1.0.18" = _hxhHTKA6;
        "pkg-1.0.19" = _eMYOfIOZ;
        "pkg-1.0.20" = _MYDzvBZC;
        "pkg-1.0.21" = _5lgM6FbL;
        "pkg-1.0.22" = _Pm4vW6Fb;
        "pkg-1.0.23" = _VW3kEQpZ;
        "pkg-1.0.24" = _qH3h6QEK;
        "pkg-1.0.25" = _FMVEmOZg;
        "pkg-1.0.26" = _GhlVI1pO;
        "pkg-1.0.27" = _1NGwuGfR;
        "pkg-1.0.28" = _5ZYU7RrD;
        "pkg-1.0.29" = _zPdV5FuM;
        "pkg-1.0.30" = _iCVMyk24;
        "pkg-1.0.31" = _OIHnYmMC;
        "default" = _OIHnYmMC;
    });
