...
let
    ...
    in {
        ...
        "pkg-v.2.5.0" = _stoSMZ1p;
        "pkg-v.3.1.1" = _vwCxZo0Z;
        "pkg-v.4.0.2" = _j2lk0SQT;
        "pkg-v.3.1.0" = _IVsb6CjR;
        "pkg-v.4.1.0" = _dLBh9tOs;
        "pkg-v.4.0.3" = _EzhFkj9w;
        "pkg-v.4.1.1" = _eaXhuf0I;
        "pkg-v.4.2.0" = _jMnNjoky;
        "pkg-v.4.1.2" = _Kwzpj5Nk;
        "pkg-v.4.2.1" = _Y5xnelKV;
        "pkg-v.4.0.4" = _kqZPyR2O;
        "pkg-v.5.0.0" = _2X6fpRmB;
        "pkg-v.5.0.1" = _35Xcs8k8;
        "pkg-v.6.0.0" = _46OiVxxv;
        "pkg-5.0.0" = _2lPBBaF4;
        "pkg-v.4.2.2" = _Z1oQ0Gjc;
        "pkg-v.6.0.1" = _2AMB4SVA;
        "pkg-v.5.0.2" = _q4d47ciK;
        "pkg-v.6.1.0" = _5ZEe6C6D;
        "pkg-v.6.1.1" = _bbYLP0bu;
        "pkg-v.6.2.0" = _S5p8KJxL;
        "pkg-v.6.3.0" = _BMe59n2X;
        "pkg-v.5.1.0" = _kIrYpclx;
        "pkg-v.6.3.1" = _HZLL0tfB;
        "pkg-v.5.1.1" = _ITI5YYDj;
        "pkg-v.7.0.0" = _evAvaFOT;
        "pkg-v.5.1.2" = _rJGcBQbc;
        "pkg-v.6.3.2" = _Icuq1Ueb;
        "pkg-v.5.1.3" = _RURunGvI;
        "pkg-v.8.0.0" = _qG6EPmhN;
        "pkg-v.6.4.0" = _JBnq3oC3;
        "pkg-v.5.2.0" = _ieaPytK8;
        "pkg-v.8.1.0" = _7UjBoLnc;
        "pkg-v.8.1.1" = _2wDxiq87;
        "default" = _2wDxiq87;
    });
