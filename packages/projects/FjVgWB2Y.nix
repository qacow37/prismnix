...
let
    ...
    in {
        ...
        "pkg-1.0.0-SNAPSHOT" = _djrHpSVW;
        "pkg-1.0.0-alpha.3+fabric+1.20.1" = _8smQbsLP;
        "pkg-1.0.0-alpha.3+forge+1.20.1" = _wh6AI2R7;
        "pkg-1.0.0-alpha.4+fabric+1.20.1" = _Hh0KvlCH;
        "pkg-1.0.0-alpha.5+fabric+1.20.1" = _FdaL3Ozs;
        "pkg-1.0.0-alpha.6+fabric+1.20.1" = _K1AixofX;
        "pkg-1.0.0-alpha.7+fabric+1.20.1" = _brp9NCLt;
        "pkg-1.0.0-alpha.8+fabric+1.20.1" = _q4WvSaJc;
        "pkg-1.0.0-alpha.9+fabric+1.20.1" = _1TKUUDZe;
        "pkg-1.0.0-alpha.10+fabric+1.20.1" = _Z9g1PIBL;
        "pkg-1.0.0-alpha.11+fabric+1.20.1" = _uPJhmDMI;
        "pkg-1.0.0-alpha.11+forge+1.20.1" = _HCgsAfAa;
        "pkg-1.0.0-alpha.12+fabric+1.20.1" = _XgnPH6p9;
        "pkg-1.0.0-alpha.12+forge+1.20.1" = _D5UUNP3S;
        "pkg-1.0.0-alpha.13+fabric+1.20.1" = _BOXPxLYp;
        "pkg-1.0.0-alpha.13+forge+1.20.1" = _iwOJ91RC;
        "pkg-1.0.0-alpha.14+fabric+1.20.1" = _sG4uJtvZ;
        "pkg-1.0.0-alpha.14+forge+1.20.1" = _QQxKrU1n;
        "pkg-1.0.0-alpha.15+fabric+1.20.1" = _MdNhWpM8;
        "pkg-1.0.0-alpha.15+forge+1.20.1" = _41gCxe8b;
        "pkg-1.0.0-alpha.16+fabric+1.20.1" = _iR1kHioU;
        "pkg-1.0.0-alpha.15+forge+klf+1.20.1" = _om6X5Iuv;
        "pkg-1.0.0-alpha.15+forge+kff+1.20.1" = _OI0S0hOo;
        "pkg-1.0.0-alpha.16+forge+klf+1.20.1" = _JUrQbSMq;
        "pkg-1.0.0-alpha.18+fabric+1.20.1" = _Z1KnFdL2;
        "pkg-1.0.0-alpha.18+forge+klf+1.20.1" = _50K8AxVG;
        "pkg-1.0.0-alpha.18+fabric+26.1" = _Rnfm7crE;
        "pkg-1.0.0-alpha.18+forge+kff+1.20.1" = _xnyz790K;
        "pkg-1.0.0-alpha.18+fabric+26.2" = _ecfKzz7C;
        "pkg-1.0.0-alpha.19+fabric+26.2" = _IgkgxLfu;
        "pkg-1.0.0-alpha.19+fabric+26.1" = _g7SXCeIS;
        "pkg-1.0.0-alpha.18+fabric+1.21.1" = _faZNI7M5;
        "pkg-1.0.0-alpha.18+neo+kff+1.21.1" = _GymeJquI;
        "pkg-1.0.0-alpha.18+forge++kff+1.20.1" = _eGw2R7Ff;
        "pkg-1.0.0-alpha.18+forge++klf+1.20.1" = _OMnNLoCs;
        "pkg-1.0.0-alpha.19+fabric+26.1.2" = _8mwthHJu;
        "default" = _8mwthHJu;
    });
