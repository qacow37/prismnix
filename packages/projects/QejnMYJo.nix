...
let
    ...
    in {
        ...
        "pkg-3.0.0" = _SgcjhKGg;
        "pkg-3.0.3" = _P6FDDODH;
        "pkg-3.0.4-1.19.2" = _WMRRbMso;
        "pkg-3.0.5-1.19.2" = _XqEJHDQ1;
        "pkg-3.0.6-1.20.1" = _RKePDKDu;
        "pkg-3.0.7-1.20.1" = _ek8Eo7Yb;
        "pkg-3.0.8-1.20.1" = _LxCgOIEC;
        "pkg-3.0.9-1.20.1" = _x9chz4hF;
        "pkg-3.1.0-1.20.1" = _6XwUR99y;
        "pkg-3.1.1-1.20.1" = _6e2H60Um;
        "pkg-3.1.2-1.20.1" = _RoGTd8sO;
        "pkg-3.1.3-1.20.1" = _XS7f9teJ;
        "pkg-3.1.4-1.20.1" = _yNHhsfPw;
        "pkg-3.1.5-1.20.1" = _8f8b9gMl;
        "pkg-3.1.6-1.20.1" = _D1jFqP1s;
        "pkg-3.1.7-1.20.1" = _jSTWjQ8N;
        "pkg-3.1.8-1.20.1" = _b3cfVw1l;
        "pkg-3.1.9-1.20.1" = _XWIrzCEd;
        "pkg-3.1.9b-1.20.1" = _oFNlYa8X;
        "pkg-3.2.0-1.20.1" = _MlFmXlAt;
        "pkg-3.2.1-1.20.1" = _t2IOOgrP;
        "pkg-3.2.2-1.20.1" = _eaXqNJKp;
        "pkg-3.2.3-1.20.1" = _kv4ugJgi;
        "pkg-3.2.4-1.20.1" = _Wirw22wC;
        "pkg-3.2.5-1.20.1" = _HTsL4xbn;
        "pkg-3.2.6-1.20.1" = _bleR8uk8;
        "pkg-3.2.7-1.20.1" = _Dfkr1TGN;
        "pkg-3.2.8-1.20.1" = _URhZvgrg;
