...
let
    ...
    in {
        ...
        "pkg-KS_Enchantments_v1.2+mod" = _ioMegePD;
        "pkg-KS_Enchantments_v1.2.1" = _w0lY9tI2;
        "pkg-KS_Enchantments_v1.2.1+mod" = _y0jQa89H;
        "pkg-KS_Enchantments_v1.3" = _Di5emIh9;
        "pkg-KS_Enchantments_v1.3+mod" = _LfrJ6Rfi;
        "pkg-ks_enchantments_v1.4" = _yqdmxJrr;
        "pkg-ks_enchantments_v1.4+mod" = _r9KECq6S;
        "pkg-KS_Enchantments_v1.4.1" = _GpyC2kt2;
        "pkg-KS_Enchantments_v1.4.1+mod" = _j6WDPYEv;
        "pkg-ks-enchantments-1.21.11" = _eveGfTUI;
        "pkg-ks-enchantments-1.21.11+mod" = _iU8YJHWa;
        "pkg-1.21.11-2" = _nCvIHjeX;
        "pkg-1.21.11-2+mod" = _hMGTKLqV;
        "pkg-26.1" = _Wk7hF4fV;
        "pkg-26.1+mod" = _qsgIYhdN;
        "pkg-26.1-2" = _1e4Nm88C;
        "pkg-26.1-2+mod" = _PYt0feId;
        "pkg-26.1.x-3" = _PTir09BU;
        "pkg-26.1.x-3+mod" = _7da7UFoJ;
        "pkg-26.1.x-4" = _WB5380LK;
        "pkg-26.1.x-4+mod" = _g7ANaiAD;
        "pkg-26.1.x-5" = _PNetZrwn;
        "pkg-26.1.x-5+mod" = _ewp5d1Kd;
        "pkg-26.1.x-6" = _srlYUNO2;
        "pkg-26.1.x-6+mod" = _LLp5ssRI;
        "pkg-26.1.x-7" = _SvHmveQM;
        "pkg-26.1.x-7+mod" = _HXBsyfwg;
        "pkg-26.1.x-8" = _CzzGqkFr;
        "pkg-26.1.x-8+mod" = _iXy7dZTI;
        "pkg-26.1.x-9" = _GSxlRQ4l;
