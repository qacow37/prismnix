...
let
    ...
    in {
        ...
        "pkg-0.2.0" = _BjGstwU5;
        "pkg-0.3.0" = _LME3DxLK;
        "pkg-1.0.0-mc1.21-neoforge" = _rJo07m0E;
        "pkg-1.0.0-mc1.21-fabric" = _J7hEYZmB;
        "pkg-1.1.0-mc1.21-neoforge" = _vi3RSxYT;
        "pkg-1.1.0-mc1.21-fabric" = _zWaXvXEN;
        "pkg-1.2.0-mc1.21-neoforge" = _wkmvIMr7;
        "pkg-1.2.0-mc1.21-fabric" = _UFx1kUgY;
        "pkg-1.3.0+mc1.21-neoforge" = _Z3jeiPTt;
        "pkg-1.3.0+mc1.21-fabric" = _onp7zU7h;
        "pkg-1.4.0+mc1.21-neoforge" = _p7cjvI8h;
        "pkg-1.4.0+mc1.21-fabric" = _8HcNyNRY;
        "pkg-1.4.0+mc1.21.2-neoforge" = _i0TYIuym;
        "pkg-1.4.0+mc1.21.2-fabric" = _7lbwQ7vN;
        "pkg-1.4.0+mc1.21.3-neoforge" = _TNyHvfXI;
        "pkg-1.4.0+mc1.21.3-fabric" = _3AETkHUb;
        "pkg-1.4.0+mc1.21.4-neoforge" = _crLJzOkB;
        "pkg-1.4.0+mc1.21.4-fabric" = _ZZ8z9sTz;
        "pkg-1.4.0+mc1.20.1-fabric" = _sRoa3g3g;
        "pkg-1.4.1+mc1.21-neoforge" = _NOa7f9Yn;
        "pkg-1.4.1+mc1.21-fabric" = _blEQNDFe;
        "pkg-1.4.2+mc1.21-neoforge" = _SoVRGpJH;
        "pkg-1.4.2+mc1.21-fabric" = _Ngv6PaOu;
        "pkg-1.4.2+mc1.21.2-neoforge" = _uFXvk6Mn;
        "pkg-1.4.2+mc1.21.2-fabric" = _MKz1UucE;
        "pkg-1.4.2+mc1.21.3-neoforge" = _WiEJS0ES;
        "pkg-1.4.2+mc1.21.3-fabric" = _g3oRNQa9;
        "pkg-1.4.2+mc1.21.4-neoforge" = _k6v53qCa;
        "pkg-1.4.2+mc1.21.4-fabric" = _x8SKQaum;
        "default" = _x8SKQaum;
    });
