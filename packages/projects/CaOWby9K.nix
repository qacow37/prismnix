...
let
    ...
    in {
        ...
        "pkg-1.2-SNAPSHOT" = _l8nODhUo;
        "pkg-1.2.1-SNAPSHOT-HOTFIX" = _xsrYVSJW;
        "pkg-1.3.1-SNAPSHOT" = _ZLzeLZ5r;
        "pkg-1.4.0-SNAPSHOT" = _ixDyVM5y;
        "pkg-1.4.1-SNAPSHOT" = _XpVXAhmX;
        "pkg-1.4.2-SNAPSHOT" = _UKn29rkW;
        "pkg-1.6.2-SNAPSHOT" = _9HR9lLKf;
        "pkg-1.6.3-SNAPSHOT" = _k4pCgdM6;
        "pkg-1.6.4-SNAPSHOT" = _UajtDYLU;
        "pkg-1.6.5-SNAPSHOT" = _tMZDONXE;
        "pkg-1.6.6-SNAPSHOT" = _Yh4Twflc;
        "pkg-1.7.0-SNAPSHOT" = _6O97SOuI;
        "pkg-1.7.1-SNAPSHOT" = _Gk62oBaK;
        "pkg-1.7.2-SNAPSHOT" = _SevxuGJc;
        "pkg-1.8.0-SNAPSHOT" = _iMa318AA;
        "pkg-1.8.1-SNAPSHOT" = _Qw6EcZLm;
        "pkg-1.0" = _vyO49ZJE;
        "pkg-1.1" = _Z9oooNmx;
        "pkg-1.2" = _UIazNTim;
        "pkg-1.3" = _h6BaWJke;
        "pkg-1.4" = _fHUa256e;
        "pkg-1.5" = _5rlW4NLF;
        "pkg-1.5-HOTFIX" = _FRKJQ1UC;
        "pkg-1.6" = _qGWcekrc;
        "pkg-1.6.1" = _KL20XELF;
        "pkg-1.7" = _s84RjQh0;
        "pkg-1.7.1" = _OKon5Mym;
        "pkg-1.7.2" = _ac2LJHsq;
        "pkg-1.7.2-Hotfix" = _jsHH8MxU;
        "pkg-1.8.0" = _occT2ebf;
        "pkg-1.8.1" = _YLFCi7XU;
        "pkg-1.8.2" = _Ai1RgTjV;
        "pkg-1.8.3" = _ii04Faab;
