...
let
    ...
    in {
        ...
        "pkg-1.18.2-3.5.1.145" = _Wh68Pss7;
        "pkg-1.18.2-3.5.2.149" = _Bqir7IW9;
        "pkg-1.18.2-3.5.2.150" = _AHJxf7BQ;
        "pkg-1.18.2-3.5.2.155" = _hEFa9Ofs;
        "pkg-1.19.4-3.6.3.204" = _pCyMLyh5;
        "pkg-1.20.1-3.6.3.221" = _bWPmDrnZ;
        "pkg-1.20.1-3.6.3.222" = _hCNJ0kZy;
        "pkg-1.20.1-3.6.3.229" = _CpygBTqF;
        "pkg-1.20.1-3.6.3.231" = _oSiBAIq3;
        "pkg-1.20.1-3.6.3.232" = _Yc80sCwP;
        "pkg-1.20.1-3.6.3.240" = _DKFZlTuD;
        "pkg-1.20.1-3.6.3.241" = _GqDlJtXP;
        "pkg-1.20.1-3.6.4.261" = _Os0GeJoW;
        "pkg-1.20.1-3.6.4.266" = _PVpd92Q3;
        "pkg-1.20.1-3.6.4.270" = _1VJF4oFE;
        "pkg-1.20.1-3.6.4.271" = _BipXMnyx;
        "pkg-1.20.1-3.6.4.273" = _Rib3UpsX;
        "pkg-1.20.1-3.6.4.274" = _woXXzIDr;
        "pkg-1.20.1-3.6.4.279" = _IQqKnFcN;
        "pkg-1.20.1-3.6.4.287" = _Bt5aG0F3;
        "pkg-1.20.1-3.6.4.304" = _ikbSaSbt;
        "pkg-1.20.1-3.6.4.305" = _q5lAhdfq;
        "pkg-1.18.2-3.5.2.312" = _yYTb8HzC;
        "default" = _yYTb8HzC;
    });
