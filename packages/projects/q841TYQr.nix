...
let
    ...
    in {
        ...
        "pkg-0.3" = _gPRLROOt;
        "pkg-0.4" = _x6P5qzVG;
        "pkg-1.21.1_v.0.5" = _TFpe5FBg;
        "pkg-1.20.1_v.0.5" = _WVwo9BzT;
        "pkg-1.19.4_v.0.5" = _1Ycd1yBv;
        "pkg-1.19.2_v.0.5" = _2Mpqcocm;
        "pkg-1.18.2_v.0.5" = _DU9gXCBy;
        "pkg-1.20.1_v.0.5.1" = _fnGekp4z;
        "pkg-1.19.4_v.0.5.1" = _jfuSDuEZ;
        "pkg-1.19.2_v.0.5.1" = _SSKEJIeg;
        "pkg-1.18.2_v.0.5.1" = _KDA12Su9;
        "pkg-1.21.1_v.0.6" = _OLZUgoyg;
        "pkg-1.20.1_v.0.6" = _VEHP4Kn9;
        "pkg-1.19.4_v.0.6" = _ssJ8hz2E;
        "pkg-1.19.2_v.0.6" = _DdxTpWOW;
        "pkg-1.18.2_v.0.6" = _XS04MCU9;
        "pkg-1.21.1_v.0.6.1" = _CpYYBE1W;
        "pkg-1.20.1_v.0.6.1" = _PhG9NaSj;
        "pkg-1.19.4_v.0.6.1" = _YCmdMvhj;
        "pkg-1.21.1_fabric_v.0.6.2" = _8DT37pF2;
        "pkg-1.20.1_fabric_v.0.6.2" = _8aE7qhsz;
        "pkg-1.19.4_fabric_v.0.6.2" = _3OoQVY0B;
        "pkg-1.19.2_fabric_v.0.6.2" = _69qa5C5L;
        "pkg-1.18.2_fabric_v.0.6.2" = _gwHfa1H8;
        "pkg-1.21.1_forge_v.0.6.2" = _YBccGsJg;
        "pkg-1.20.1_forge_v.0.6.2" = _h2q1p076;
        "pkg-1.19.4_forge_v.0.6.2" = _tBR2bLXm;
        "pkg-1.19.2_forge_v.0.6.2" = _99QzTQ4r;
        "pkg-1.18.2_forge_v.0.6.2" = _oFvk4QZf;
        "pkg-1.21.1_neoforge_v.0.6.2" = _38yzbkJr;
        "pkg-1.21.1_fabric_v.0.6.3" = _PiiPQcGJ;
        "pkg-1.20.1_fabric_v.0.6.3" = _cBnxI2TS;
        "pkg-1.19.4_fabric_v.0.6.3" = _XrglNWqV;
        "pkg-1.19.2_fabric_v.0.6.3" = _Z25ClKtP;
        "pkg-1.18.2_fabric_v.0.6.3" = _aFD8bRtm;
        "pkg-1.21.1_forge_v.0.6.3" = _IvJ8tpTN;
        "pkg-1.20.1_forge_v.0.6.3" = _srTMB6xQ;
        "pkg-1.19.4_forge_v.0.6.3" = _vLeTpQIm;
        "pkg-1.19.2_forge_v.0.6.3" = _GoROpRa0;
        "pkg-1.18.2_forge_v.0.6.3" = _SIWV9kUI;
        "pkg-1.21.1_neoforge_v.0.6.3" = _OlEoXrM3;
        "default" = _OlEoXrM3;
    });
