...
let
    ...
    in {
        ...
        "pkg-1.0" = _x2P5JWsK;
        "pkg-1.0+mod" = _I0IPnQ7e;
        "pkg-1.1b" = _naJk0BRp;
        "pkg-1.1b+mod" = _ABVc46Lw;
        "pkg-1.1.2" = _Mocc5ko5;
        "pkg-1.1.2+mod" = _rKn5uHas;
        "pkg-1.1.2b" = _noflaBnt;
        "pkg-1.1.2b+mod" = _J6pYiUGV;
        "pkg-113b" = _jSlQZP5p;
        "pkg-113b+mod" = _nCyn2Jo0;
        "pkg-pre3" = _R0vwcs9D;
        "pkg-pre3+mod" = _xdVYzaHm;
        "pkg-1.2" = _Rq0ZDO2d;
        "pkg-1.2+mod" = _WKbIKwEu;
        "pkg-1.2.1" = _Hei4STUn;
        "pkg-1.2.1+mod" = _QZWW3evb;
        "pkg-1.3" = _GDgxl2wk;
        "pkg-1.3+mod" = _UXOpcHF0;
        "pkg-1.3a" = _wkA8N08q;
        "pkg-1.3a+mod" = _5br5mlBR;
        "pkg-1.3b" = _leZoXqZl;
        "pkg-1.3b+mod" = _ZCSPs7sp;
        "pkg-1.3c" = _6jPtqFnk;
        "pkg-1.3c+mod" = _qe8rKVUn;
        "pkg-1.3d" = _jPhsGJlf;
        "pkg-1.3d+mod" = _bW7BIOyP;
        "pkg-1.4" = _3qoVoYXg;
        "pkg-1.4+mod" = _sDQQUNdq;
        "pkg-1.4a" = _HVYS8oxa;
        "pkg-1.4a+mod" = _bejtnsYw;
        "pkg-1.4b" = _bG2y2fnE;
        "pkg-1.4b+mod" = _PKJHx9l6;
        "pkg-1.5" = _CiqlsDbd;
        "pkg-1.5+mod" = _tEIkhV11;
        "pkg-1.5a" = _4RkBRJbM;
        "pkg-1.5a+mod" = _ZjxdR4XD;
        "pkg-v1.6" = _1p1hOBtq;
        "pkg-v1.6+mod" = _kgJumn7g;
        "pkg-1.6a" = _74ZlJThn;
        "pkg-1.6a+mod" = _lFcPMEHV;
        "pkg-1.7" = _6e7F6W69;
        "pkg-1.7+mod" = _moTjVc7t;
        "pkg-1.8" = _tLFVdWrz;
        "pkg-1.8+mod" = _7pCa5LP6;
        "default" = _7pCa5LP6;
    });
