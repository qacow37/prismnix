...
let
    ...
    in {
        ...
        "pkg-1.21.6-3" = _M3mqXrGG;
        "pkg-1.21.4-3" = _FHsws9Yn;
        "pkg-1.20.1-3" = _3slFAs4g;
        "pkg-1.21.1-1" = _sKfB15sr;
        "pkg-26.1-1" = _3is4vaqq;
        "pkg-1.21.4-5" = _bA3hDcKv;
        "pkg-26.1-2" = _2QOPbFtO;
        "pkg-1.20.1-4" = _kJ55g4Gv;
        "pkg-1.21.6-4" = _Z0trf6Vu;
        "pkg-1.21.10-2" = _RqCcUGOA;
        "pkg-1.21.1-2" = _tIWprkdq;
        "pkg-1.20.1-6" = _bSdrAYgG;
        "pkg-1.21.10-4" = _p1wTS1CJ;
        "pkg-1.21.1-4" = _HITaMnk9;
        "pkg-1.21.11-2" = _fAOTCB3D;
        "pkg-26.1-4" = _f0Q9wrSM;
        "pkg-1.21.4-6" = _A7EIDZ9M;
        "pkg-1.21.6-6" = _tritSTrp;
        "pkg-1.0.2+1.20.1" = _EGyJw7WU;
        "pkg-1.0.2+1.21.1" = _L6lfJSaE;
        "pkg-1.0.2+1.21.11" = _52gvlQEI;
        "pkg-1.0.2+1.21.6" = _87XJWtR2;
        "pkg-1.0.2+26.2" = _hkfDkuqG;
