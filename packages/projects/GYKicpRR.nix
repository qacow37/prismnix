...
let
    ...
    in {
        ...
        "pkg-1.1" = _Ey3sZrYh;
        "pkg-1.2" = _rS5V9HxO;
        "pkg-1.2.1-b1" = _x1jpDwYf;
        "pkg-1.2.1-b2" = _8wfRlyIp;
        "pkg-1.2.1-b3" = _ITmiv8ws;
        "pkg-1.2.1" = _vZG8q9bW;
        "pkg-1.2.2-b1" = _MB2fJzGu;
        "pkg-1.2.2" = _lbycbggC;
        "pkg-1.2.3-b1" = _CJuydi8g;
        "pkg-1.2.3" = _dTau9edS;
        "pkg-1.2.4-b1" = _rOonM88q;
        "pkg-1.2.4" = _xoq2tl8J;
        "pkg-1.2.5" = _1HKTKQlV;
        "pkg-1.2.6" = _qIGlObRN;
        "pkg-1.2.7" = _StFsLbgy;
        "pkg-1.2.8" = _HIkfXXhQ;
        "pkg-1.2.8-b1" = _QwJcLJAr;
        "default" = _QwJcLJAr;
    });
