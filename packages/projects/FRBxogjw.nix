...
let
    ...
    in {
        ...
        "pkg-1.10.3" = _fYjGh1iJ;
        "pkg-1.11.0" = _1xTmlkvu;
        "pkg-1.11.1" = _eKE8H3Og;
        "pkg-1.11.2" = _MCgT94hU;
        "pkg-1.12.0" = _xjo8v7OV;
        "pkg-1.12.1" = _V1sSr8KT;
        "pkg-1.13.0" = _KH7XMIO0;
        "pkg-1.13.1" = _GAccEhZ4;
        "pkg-1.13.2" = _C258ok1j;
        "pkg-1.14.0" = _9uu5SpW3;
        "pkg-1.14.1" = _pgmAlFiv;
        "pkg-1.14.2" = _H9qjl6Sp;
        "pkg-1.14.3" = _KvbRK9DH;
        "pkg-1.14.3b" = _BviJXM3W;
        "pkg-1.14.4" = _bpevGHXl;
        "pkg-1.15.0" = _DGax5TM1;
        "pkg-1.15.1" = _RVTUSNV3;
        "pkg-1.15.2" = _dZU0jhf4;
        "pkg-1.15.3" = _3LzUmZgW;
        "pkg-1.15.4" = _RZEV4Fl3;
        "pkg-1.16.0" = _ubAFWX6b;
        "pkg-1.16.1" = _hcFeBhWF;
        "pkg-1.16.2" = _cDWzWcwk;
        "pkg-1.16.3" = _X1sMC9rW;
        "pkg-1.16.4" = _H9FVXseR;
        "pkg-1.16.5" = _qry8BT2y;
        "pkg-1.17.0" = _qHFKzJbn;
        "pkg-1.17.1" = _MLcwIjbR;
        "pkg-1.17.2" = _x8tz7yUe;
        "pkg-1.18.0" = _8sDuBU1H;
        "pkg-1.18.1" = _zL9n0fcM;
        "pkg-1.18.2" = _zwicxZVb;
        "pkg-1.18.3" = _mYyWFgM2;
        "pkg-1.19.0" = _UnzcevAN;
        "pkg-1.19.1" = _P89RLA9v;
        "default" = _P89RLA9v;
    });
