...
let
    ...
    in {
        ...
        "pkg-1.0.0.0" = _icW8C61a;
        "pkg-1.0.0.1" = _TiCSflle;
        "pkg-1.0.0.2" = _nY8mxB4Q;
        "pkg-1.0.0.4" = _nnA6uxve;
        "pkg-1.0.0.5" = _k9u0VKhT;
        "pkg-1.0.7" = _MJyJLOOT;
        "pkg-1.1.8" = _dw5aOM20;
        "pkg-1.1.9" = _5CjoBqOP;
        "pkg-1.1.10" = _M0hjIuD5;
        "pkg-1.1.11" = _UhrVzetl;
        "pkg-1.1.12" = _Jx33EJnu;
        "pkg-1.1.13" = _LODLiEp6;
        "pkg-1.1.14" = _fIBLHl7G;
        "pkg-1.1.15" = _nyT8DSEN;
        "pkg-1.1.27" = _JPzzpzWZ;
        "pkg-1.1.29" = _gGAyjzqn;
        "pkg-1.1.30" = _HkXQdrSV;
        "pkg-2.0.2" = _GERyl8BH;
        "pkg-3.0.1" = _p7ONVa1h;
        "pkg-3.0.2" = _7rwqitg2;
        "pkg-2.0.3" = _8gJJNMDn;
        "pkg-2.0.4" = _WwLduBuI;
        "pkg-3.0.3" = _HSUtevZH;
        "pkg-1.1.31" = _nP9FIcj0;
        "pkg-1.1.32" = _d5A12FQB;
        "default" = _d5A12FQB;
    });
