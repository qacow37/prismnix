...
let
    ...
    in {
        ...
        "pkg-1.0.6" = _iCrqUujg;
        "pkg-1.0.8" = _AkzVK3Va;
        "pkg-1.0.8.1" = _n2QKwUZ2;
        "pkg-1.0.8.2" = _R4Xx0Tkq;
        "pkg-1.0.8.3" = _VaZRj25A;
        "pkg-1.0.8.4" = _h2tcYCr2;
        "pkg-1.0.8.5" = _ariJFAhX;
        "pkg-1.1.0" = _dDceHpEb;
        "pkg-1.1.0.1" = _ZGIJ1A4e;
        "pkg-1.1.0.2" = _HiHXxdLX;
        "pkg-1.1.0.3" = _pVUYr8RF;
        "pkg-1.1.0.4" = _OBu0UQ6f;
        "pkg-1.1.2.0" = _iCg3C7uJ;
        "pkg-1.1.2.1" = _TJgk2uQm;
        "pkg-1.2.0.0" = _ITMvOjtP;
        "pkg-1.2.0.1" = _EkSEnh6B;
        "pkg-1.2.2.0" = _R2nOyaQn;
        "pkg-1.2.2.1" = _M4ofQkRx;
        "pkg-1.2.2.2" = _mbSGJOPx;
        "pkg-1.2.4.0" = _XVaUdY5L;
        "pkg-1.2.4.1" = _s23Odhpm;
        "pkg-1.2.4.2" = _3tdyTH3t;
        "pkg-1.2.4.3" = _CdFtrukU;
        "pkg-1.2.4.4" = _mfH85Dqo;
        "pkg-1.2.6.0" = _BbHn82vi;
        "pkg-1.2.6.1" = _LMJsIblz;
        "pkg-1.2.6.2" = _w1NoG63w;
        "pkg-1.2.6.3" = _5AVo2jzy;
        "pkg-1.2.6.4" = _xuF54wMi;
        "pkg-1.2.6.5" = _Byp603qo;
        "pkg-1.2.6.6" = _EsKRnUXO;
        "pkg-1.3.0" = _UWjwpBCs;
        "pkg-1.3.0.1" = _dkvPjXwV;
        "pkg-1.3.0.2" = _UhG5c9iI;
        "pkg-1.3.0.3" = _XTECriYD;
        "pkg-1.3.2.0" = _vmZPN2Lf;
        "pkg-1.3.2.1" = _255JQvxi;
        "pkg-1.3.4.0" = _sx7pYzPg;
        "pkg-1.3.4.1" = _m5cEN7I5;
        "pkg-1.2.9.15" = _enpDEfiI;
        "pkg-1.3.4.3" = _uRb98sTw;
        "pkg-1.3.4.4" = _38TYj9RW;
        "pkg-1.4.0.1" = _PN6AZi5E;
        "pkg-1.4.0.2" = _EXDxm2Ar;
        "pkg-1.4.0.3" = _DQ7j6XwW;
        "pkg-1.4.0.4_bc2.2" = _PL9O3Naa;
        "pkg-1.4.4.0" = _nA2FlBfQ;
        "pkg-1.4.4.1" = _UCRlZPbJ;
        "pkg-1.4.4.2" = _wENH1h8G;
        "pkg-1.4.6.1_bc2.2" = _WdP86jRy;
        "pkg-1.4.6.2_bc2.2" = _vPg24BoN;
        "pkg-1.4.8.0" = _UX7v5uSC;
        "pkg-1.4.8.0_bc2.2" = _ZU6SlcPF;
        "pkg-1.4.8.1" = _SPomyjvg;
        "pkg-1.4.8.1_bc2.2" = _8irVVOpu;
        "pkg-1.4.8.2" = _7qyIQEzJ;
        "pkg-1.4.8.2_bc2.2" = _mxGSRSAf;
        "pkg-1.4.8.3" = _Anr4k3Z8;
        "pkg-1.4.8.3_bc2.2" = _NUU0pozF;
        "pkg-1.4.8.4" = _JOUFIav2;
        "pkg-1.4.8.4_bc2.2" = _GbkneNXN;
        "pkg-1.4.8.5" = _Wq7dzuKu;
        "pkg-1.4.8.5_bc2.2" = _bX2yl4Ru;
        "pkg-1.4.8.6" = _zbGklbl8;
        "pkg-1.4.8.6_bc2.2" = _fOpjH3Qf;
        "pkg-1.4.8.7_bc2.2" = _bnJncEUr;
        "pkg-1.5.0.0" = _oQJl8mO5;
        "pkg-1.5.0.1" = _FWsS6CX5;
        "pkg-1.5.0.2" = _L2JSQVqV;
        "pkg-1.6.0.0pre5" = _80NOCVnH;
        "pkg-1.6.0.0pre6" = _n89uwp8F;
        "pkg-1.6.2.0" = _3KvmKmqM;
        "pkg-1.6.2.1" = _CX7ISY9f;
        "pkg-1.6.2.2" = _ozVym4gs;
        "pkg-1.6.2.3" = _j7OJ6iAM;
        "pkg-1.6.2.4" = _7GX5RWoU;
        "pkg-1.6.2.5" = _2GyZDXAN;
        "pkg-1.6.2.6" = _UUJx1NDx;
        "pkg-1.6.2.7" = _X441pzjk;
        "pkg-1.6.2.8" = _1EzYqoGe;
        "pkg-1.6.2.9" = _8LxMqgnO;
        "pkg-1.6.3.0" = _V2V4Y0IL;
        "pkg-1.6.3.9" = _DhnweFzP;
        "pkg-1.6.4.0" = _eMLfA7R1;
        "pkg-1.6.4.1" = _1XggvObU;
        "pkg-1.6.4.2" = _2qF5DUYd;
        "pkg-1.7.0.0" = _2ZLH1Lae;
        "pkg-1.7.0.1" = _jd5ECFXG;
        "pkg-1.7.0.2" = _RNUu6xHo;
        "pkg-1.7.0.3" = _vaN1i6QK;
        "pkg-1.7.0.4" = _lUcKjLGA;
        "pkg-1.7.0.5" = _VdcQrzop;
        "pkg-2.0.0.0" = _7cUeoEd3;
        "pkg-2.0.0.1" = _ouoxe6sK;
        "pkg-2.0.0.2" = _UOqNSE4c;
        "pkg-2.0.0.3" = _eIHUn0QY;
        "pkg-2.0.0.4" = _uNBfoKmN;
        "pkg-2.0.0.5" = _4tP9PAhW;
        "pkg-2.0.0.6" = _w6Kt8CbH;
        "pkg-2.0.0.7" = _s17blmHJ;
        "pkg-2.0.0.8" = _b5EiXr0K;
        "pkg-2.0.0.9" = _DlMrTQxm;
        "pkg-2.0.0.11" = _oCKQY1wF;
        "pkg-2.2.2.0" = _D1Nsx4sJ;
        "pkg-2.2.2.1" = _tFJGMYVZ;
        "pkg-2.2.2.2" = _FGfVRtB4;
        "pkg-2.2.4.0" = _zoq7g0DI;
        "pkg-2.2.4.1" = _U7yBZrDZ;
        "pkg-2.2.4.2" = _JqKv3SRI;
        "pkg-2.2.4.3" = _Ata82gEV;
        "pkg-2.2.4.4" = _fHpBetke;
        "pkg-2.2.6.0" = _B7eHqWUl;
        "pkg-2.2.6.1" = _1FptqPqF;
        "pkg-2.2.6.2" = _oT69qxQH;
        "pkg-2.2.6.3" = _BinV0WN5;
        "pkg-2.2.8.0" = _X58VZzYq;
        "pkg-2.2.8.1" = _ev7l9ojz;
        "pkg-2.2.8.2" = _5RoPh3QK;
        "pkg-2.2.8.3" = _FBSLeriO;
        "pkg-2.2.8.4" = _oJ4NsVHY;
        "pkg-2.3.0.0" = _bLgloh4r;
        "pkg-2.3.0.1" = _O1KEYyOx;
        "pkg-2.3.0.2" = _XnGRigXZ;
        "pkg-2.3.0.3" = _uD3eByR6;
        "pkg-2.3.0.4" = _AyWWNnYO;
        "pkg-2.3.0.5" = _sGJqH3z8;
        "pkg-2.3.0.6" = _O7LQNqpc;
        "pkg-2.3.0.7" = _IFfNCx3I;
        "pkg-2.3.1.0" = _eqh9uCue;
        "pkg-2.3.1.1" = _h4lLWZF8;
        "pkg-5.8.2.427" = _zycSza6a;
        "default" = _zycSza6a;
    });
