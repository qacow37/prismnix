...
let
    ...
    in {
        ...
        "pkg-0.1.0+mc1.20.1" = _zKZvjKXn;
        "pkg-0.1.0+mc1.20.2" = _BqshuHLF;
        "pkg-0.1.0+mc1.20.4" = _5QrF7OJj;
        "pkg-0.1.1+mc1.20.4" = _48zqdydi;
        "pkg-0.1.1+mc1.20.2" = _2Ah2rRjb;
        "pkg-0.1.2+mc1.20.4" = _afWUlRD0;
        "pkg-0.1.2+mc1.20.2" = _ZWD9VNgy;
        "pkg-0.1.2+mc1.20.6" = _Z7XJjXBC;
        "pkg-0.1.2+mc1.21.0" = _IXkqjNwV;
        "pkg-0.2.0+mc1.21.0" = _VX8AdjVc;
        "pkg-0.2.0+mc1.20.2" = _j0uXgiYL;
        "pkg-0.2.1+mc1.21.0" = _hZJQ8Lte;
        "pkg-0.2.1+mc1.21.2" = _wBr6K4GP;
        "pkg-0.2.2+mc1.21.2" = _lSjcK1Oi;
        "pkg-0.2.2+mc1.21.0" = _KMJewbVO;
        "pkg-0.2.3+mc1.21.4" = _tnTAhoBd;
        "pkg-0.2.3+mc1.21.5" = _RxgMzEIQ;
        "pkg-0.2.4+mc1.21.5" = _wEtWGLRv;
        "pkg-0.3.0+mc1.21.5" = _sn1ilxiv;
        "pkg-0.3.1+mc1.21.5" = _70DsmiJU;
        "pkg-0.3.1+mc1.21.6" = _joqp1pM3;
        "pkg-0.3.2+mc1.21.9" = _bVVSdAb0;
        "pkg-0.3.2+mc1.21.11" = _4nFvTWy1;
        "pkg-0.2.3+mc1.21.0" = _ZxhIDygM;
        "default" = _ZxhIDygM;
    });
