...
let
    ...
    in {
        ...
        "pkg-Alpha.2" = _zITgjApx;
        "pkg-Alpha.3" = _7fmfxJzm;
        "pkg-7.3.0-alpha.4+1.20.1" = _QKEj2Yes;
        "pkg-7.3.0-alpha.4+1.20.4" = _mAh2CaRE;
        "pkg-7.4.0-alpha.6+1.20.1" = _k6GLIuDu;
        "pkg-7.3.0-alpha.6+1.20.4" = _s0mVzgg8;
        "pkg-7.4.0-alpha.7+1.20.1" = _oYx1AbHH;
        "pkg-7.4.0-alpha.7+1.20.4" = _Sn0KaFdi;
        "pkg-7.4.0-alpha.9+1.20" = _8POBaMJ3;
        "pkg-7.4.0-alpha.10+1.20" = _b7rl9uf7;
        "pkg-7.4.0-alpha.10+1.20.4" = _F6itmHIQ;
        "pkg-7.4.0-alpha.11+1.20" = _Qc8x8H76;
        "pkg-7.4.0-alpha.11+1.20.4" = _gHW3iBgz;
        "pkg-7.4.0-alpha.13+1.20" = _EaU5rMKT;
        "pkg-7.4.0-alpha.13+1.20.4" = _hiO0tpKe;
        "pkg-9.0.4-beta.1+1.21" = _dWrAi2BR;
        "pkg-7.4.0-alpha.14+1.20" = _S2b8VvQg;
        "pkg-7.4.0-alpha.15+1.20" = _ImC9CySJ;
        "pkg-9.0.4-beta.2+1.21" = _cSYLsnbv;
        "pkg-7.4.0-beta.3+1.20" = _Ibza6rSJ;
        "pkg-9.0.5-beta.2+1.21" = _kIp3jKTE;
        "pkg-7.4.0-beta.4+1.20" = _MSc2JxjP;
        "pkg-9.0.5-beta.4+1.21" = _IHH9GRFq;
        "pkg-7.4.0-beta.5+1.20" = _K4eMhlqv;
        "pkg-7.4.0-beta.6+1.20" = _feCTz4gA;
        "pkg-7.4.0-beta.7+1.20" = _onW0g3vn;
        "pkg-9.0.5-beta.5+1.21" = _2gkbUFCx;
        "pkg-7.4.0-beta.8+1.20.1" = _CAWeO4wc;
        "pkg-9.0.5-beta.6+1.21" = _QqH2Os1C;
        "pkg-7.4.0-beta.9+1.20.1" = _oWmlSuCy;
        "pkg-7.4.0-beta.10+1.20.1" = _vqn9jmaX;
        "pkg-7.4.0-beta.11+1.20.1" = _Eu2LH4rm;
        "pkg-9.0.5-beta.7+1.21" = _4MjjDSOy;
        "pkg-9.0.5-beta.8+1.21" = _BcyR4YV1;
        "pkg-7.4.0-beta.12+1.20.1" = _MOuRPu3G;
        "pkg-9.0.5-beta.9+1.21" = _6sNfoYGy;
        "pkg-9.0.5-beta.10+1.21" = _9aiGtCWZ;
        "pkg-9.0.5-beta.11+1.21" = _5Wclfb1o;
        "pkg-7.4.0-beta.13+1.21" = _Qw1LNVgQ;
        "pkg-7.4.0-beta.14" = _kDJWGdl4;
        "pkg-7.4.0-beta.15" = _GNh8XCfl;
        "pkg-7.4.0-beta.16" = _vPF880Lw;
        "pkg-7.4.0-beta.17" = _lcRNZTfa;
        "pkg-7.4.0-beta.18" = _kmnzFxJx;
        "pkg-9.0.12+1.21.1" = _BtkZMMXY;
        "pkg-9.0.12-beta.19+1.21.1" = _ZSg9HAaK;
        "pkg-9.2.2-beta.21" = _MUPsPs4U;
        "pkg-9.2.2-beta.22" = _blgVNH0D;
        "pkg-9.2.2-beta.23" = _cxRDwwLL;
        "pkg-9.2.2-beta.24" = _PxcOOfvx;
        "pkg-9.3.1-beta.24" = _Vxycsvmh;
        "pkg-9.3.1-beta.25" = _cKANgVIy;
        "pkg-9.3.1-beta.26" = _qjaJRJsr;
        "pkg-9.3.1-beta.27" = _eFS4Xnze;
        "pkg-9.3.1-beta.28" = _YNkFAIw4;
        "default" = _YNkFAIw4;
    });
