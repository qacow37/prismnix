...
let
    ...
    in {
        ...
        "pkg-49.0.0" = _ibY60sNU;
        "pkg-49.0.1" = _bkoiQ2rb;
        "pkg-49.0.2" = _fizEaIy9;
        "pkg-49.0.3" = _ZtEZebrU;
        "pkg-50.0.0pr1" = _D25LV5Ak;
        "pkg-50.0.1" = _V4henZ2m;
        "pkg-50.0.2" = _zllGFPLV;
        "pkg-50.0.3" = _nvSAoNyI;
        "pkg-50.1.0" = _QFXBghZy;
        "pkg-50.1.1" = _IesVjvwE;
        "pkg-50.1.2" = _lC8KpLlP;
        "pkg-50.2.0" = _fW140M8q;
        "pkg-51.0.0" = _Jt0Giz3Y;
        "pkg-51.0.1" = _M3wuxWGS;
        "pkg-51.0.2" = _BI16iZTa;
        "pkg-51.1.0" = _BGSQT7gB;
        "pkg-51.1.1" = _fG1b9h8Y;
        "pkg-52.0.0" = _3H1kiNsB;
        "pkg-52.0.1" = _75qdJxgR;
        "pkg-52.0.2" = _HwBgl3vZ;
        "pkg-52.0.3" = _ySq6CRpK;
        "pkg-52.0.4" = _hY0iCT0j;
        "pkg-52.0.5" = _wdOaiWJO;
        "pkg-52.0.6" = _feopJFhJ;
        "pkg-52.0.7" = _IMYf4YIW;
        "pkg-52.0.8" = _Os4GreqA;
        "pkg-52.1.0" = _1QRiKtXC;
        "pkg-52.1.1" = _1liKG0cM;
        "pkg-52.1.2" = _K9v9CbWA;
        "pkg-53.0.0" = _g6CJOvvr;
        "pkg-53.0.1" = _HZYn7IMh;
        "pkg-53.0.2" = _Ujc1lT5F;
        "pkg-53.0.3" = _B3YxaZJZ;
        "pkg-54.0.0" = _Axu98GbL;
        "pkg-55.0.0" = _OqAqF2bX;
        "pkg-55.0.1" = _Dsh6i6F4;
        "pkg-55.0.2" = _D1UYzMe9;
        "pkg-55.0.3" = _FWiCbREi;
        "pkg-55.0.4" = _PspUCv4o;
        "pkg-56.0.0" = _RKOhWYPS;
        "pkg-56.0.1" = _1KE4d1O3;
        "pkg-57.0.0" = _CvjnZsla;
        "pkg-57.0.1" = _c4GeFXhm;
        "pkg-57.0.2" = _Jca0hJNb;
        "pkg-57.1.0" = _fVZO1YL9;
        "pkg-59.0.0" = _M238JXhF;
        "pkg-59.0.1" = _AnyZe0Zs;
        "pkg-59.0.2" = _N8GwcDfR;
        "pkg-59.0.3" = _4L3I959N;
        "pkg-58.0.0" = _5bDwQiQ3;
        "pkg-58.1.0" = _epLb7uHM;
        "default" = _epLb7uHM;
    });
