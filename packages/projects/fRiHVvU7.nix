...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.18.2" = _y07Z99Fu;
        "pkg-0.1.1+1.18.2" = _Q6tTbo1x;
        "pkg-0.1.2+1.18.2" = _K65QAWMh;
        "pkg-0.2.0+1.18.2" = _YXPSJa6e;
        "pkg-0.2.0+1.19" = _iYEz2kTL;
        "pkg-0.3.0+1.18.2" = _Selw0HYX;
        "pkg-0.3.0+1.19" = _A8yQEzfW;
        "pkg-0.3.1+1.18.2" = _E5xVJcgc;
        "pkg-0.3.1+1.19" = _pgkoQN7L;
        "pkg-0.3.2+1.18.2" = _D3LyTAws;
        "pkg-0.3.2+1.19" = _wWQ7UZ2q;
        "pkg-0.3.3+1.18.2" = _nZGKMwAA;
        "pkg-0.3.3+1.19" = _yu6i46bx;
        "pkg-0.3.4+1.18.2" = _n7JoPQix;
        "pkg-0.3.4+1.19" = _LAmIsYNr;
        "pkg-0.4.0+1.18.2" = _RgQ7FrsH;
        "pkg-0.4.0+1.19" = _IoW80f9m;
        "pkg-0.4.1+1.18.2" = _udXqkIbu;
        "pkg-0.4.1+1.19" = _HoOD920y;
        "pkg-0.4.2+1.18.2" = _olpu7zwd;
        "pkg-0.4.2+1.19" = _cfYr580M;
        "pkg-0.4.3+1.18.2" = _Nah0xUBl;
        "pkg-0.4.3+1.19" = _QMDzRsgo;
        "pkg-0.5.0+1.19.2" = _p9jbOqyn;
        "pkg-0.5.0+1.18.2" = _tN2XQVEJ;
        "pkg-0.5.0+1.19.3" = _ftT3b1yq;
        "pkg-0.5.1+1.19.3" = _WhmdWccV;
        "pkg-0.5.1+1.19.2" = _bAyIAOBL;
        "pkg-0.5.1+1.18.2" = _ZxUKxSNd;
        "pkg-0.5.2+1.19.3" = _UUi66xPS;
        "pkg-0.5.2+1.19.2" = _e8yMWd29;
        "pkg-0.5.2+1.18.2" = _X4bOWHC2;
        "pkg-0.5.3+1.19.3" = _fI0dINR4;
        "pkg-0.5.3+1.19.2" = _XmCUxxkW;
        "pkg-0.5.3+1.18.2" = _jBccUcin;
        "pkg-0.6.0+1.19.3" = _xmDkD61V;
        "pkg-0.6.0+1.18.2" = _wMwDwu3J;
        "pkg-0.6.0+1.19.2" = _JDYyc3km;
        "pkg-0.6.1+1.19.3" = _k0JvR8fB;
        "pkg-0.6.1+1.18.2" = _YjHd11wZ;
        "pkg-0.6.1+1.19.2" = _AVh1lXN3;
        "pkg-0.6.2+1.19.3" = _foXHvGih;
        "pkg-0.6.2+1.19.2" = _7z5aEkkm;
        "pkg-0.6.2+1.18.2" = _Sr03WyB4;
        "pkg-0.6.3+1.19.3" = _FSHwx86x;
        "pkg-0.6.3+1.19.2" = _cCpcaR2M;
        "pkg-0.6.3+1.18.2" = _yQJ7B5nr;
        "pkg-0.6.4+1.19.3" = _yKTNiAdh;
        "pkg-0.6.4+1.18.2" = _57RIQAd7;
        "pkg-0.6.4+1.19.2" = _o33Kccwv;
        "pkg-0.6.5+1.19.3" = _9GlQFcnd;
        "pkg-0.6.5+1.19.2" = _vlDdC1kL;
        "pkg-0.6.5+1.18.2" = _lkS8hPC7;
        "pkg-0.6.6+1.19.3" = _fS3fm4Dd;
        "pkg-0.6.6+1.19.2" = _6mrLiOWt;
        "pkg-0.6.6+1.18.2" = _dlvl62R7;
        "pkg-0.7.0+1.19.2" = _mpzT6mBc;
        "pkg-0.7.0+1.18.2" = _PuAYjGi1;
        "pkg-0.7.0+1.19.3" = _s4KYdf4l;
        "pkg-0.7.1+1.18.2" = _rKHPdZDJ;
        "pkg-0.7.1+1.19.2" = _ZIS2bNb1;
        "pkg-0.7.1+1.19.3" = _jGpO3aCU;
        "pkg-0.7.1+1.19.4" = _wAp7hMUU;
        "pkg-0.7.2+1.18.2" = _l9ixr9Dk;
        "pkg-0.7.2+1.19.2" = _WGclw60s;
        "pkg-0.7.2+1.19.3" = _iu1dOnJl;
        "pkg-0.7.2+1.19.4" = _vy8MPD02;
        "pkg-0.7.3+1.19.2" = _RPPRwMBI;
        "pkg-0.7.3+1.18.2" = _DDkCVTmY;
        "pkg-0.7.3+1.19.4" = _jOFzj21O;
        "pkg-0.7.3+1.19.3" = _lnPekvZX;
        "pkg-1.0.0+1.19.4+fabric" = _bTjX0Jsd;
        "pkg-1.0.0+1.19.4+forge" = _gEGU5Xir;
        "pkg-1.0.0+1.19.3+fabric" = _rjkcKxdA;
        "pkg-1.0.0+1.19.3+forge" = _Xek2SeF3;
        "pkg-1.0.0+1.19.2+fabric" = _yTEBSR8Y;
        "pkg-1.0.0+1.19.2+forge" = _gokBtbDo;
        "pkg-1.0.1+1.19.4+fabric" = _t14D5ZJk;
        "pkg-1.0.1+1.19.4+forge" = _TGaxuN3i;
        "pkg-1.0.1+1.19.2+fabric" = _4pbvOVlV;
        "pkg-1.0.1+1.19.2+forge" = _OTbAVSDE;
        "pkg-1.0.1+1.19.3+fabric" = _MDskMT93;
        "pkg-1.0.1+1.19.3+forge" = _SKPXM4q6;
        "pkg-1.0.2+1.19.4+fabric" = _OwZJfOuX;
        "pkg-1.0.2+1.19.4+forge" = _DBeXPclI;
        "pkg-1.0.2+1.19.3+fabric" = _XjeprwvC;
        "pkg-1.0.2+1.19.3+forge" = _cbZWmhGq;
        "pkg-1.0.2+1.19.2+fabric" = _NUdGBKhA;
        "pkg-1.0.2+1.19.2+forge" = _luelaLAf;
        "pkg-1.0.2+1.20+fabric" = _XcvcmBXS;
        "pkg-1.0.2+1.20+forge" = _CIUgXtQR;
        "pkg-1.0.3+1.19.4+fabric" = _jrHZcUei;
        "pkg-1.0.3+1.19.4+forge" = _ppVyb7ns;
        "pkg-1.0.3+1.19.3+fabric" = _Bx4nG0q7;
        "pkg-1.0.3+1.19.3+forge" = _yAcaigy0;
        "pkg-1.0.3+1.19.2+fabric" = _VSLv9j3b;
        "pkg-1.0.3+1.19.2+forge" = _gS3G7IQC;
        "pkg-1.0.3+1.20+fabric" = _7DxyV3hH;
        "pkg-1.0.3+1.20+forge" = _BOUEFB16;
        "pkg-1.0.4+1.19.2+fabric" = _ZYREdR8e;
        "pkg-1.0.4+1.19.2+forge" = _9Sl6aEEg;
        "pkg-1.0.4+1.19.3+fabric" = _LzmUaL4c;
        "pkg-1.0.4+1.19.3+forge" = _kP4Ttjg3;
        "pkg-1.0.4+1.19.4+fabric" = _ARMJwZQk;
        "pkg-1.0.4+1.19.4+forge" = _lFlnmxZX;
        "pkg-1.0.4+1.20.1+fabric" = _99422QOb;
        "pkg-1.0.4+1.20.1+forge" = _rUnMUodd;
        "pkg-1.0.5+1.19.2+fabric" = _gXppZuUk;
        "pkg-1.0.5+1.19.2+forge" = _SRfzqUwE;
        "pkg-1.0.5+1.19.3+fabric" = _PA7CNBS1;
        "pkg-1.0.5+1.19.3+forge" = _GXDabLjD;
        "pkg-1.0.5+1.20.1+fabric" = _ZHJCnRrV;
        "pkg-1.0.5+1.20.1+forge" = _SErzvird;
        "pkg-1.0.5+1.19.4+fabric" = _fPRExx0b;
        "pkg-1.0.5+1.19.4+forge" = _lZUnNROf;
        "pkg-1.0.6+1.20.1+fabric" = _P2jD6pvi;
        "pkg-1.0.6+1.20.1+forge" = _3ZTak90f;
        "pkg-1.0.6+1.19.3+fabric" = _eo1v9M36;
        "pkg-1.0.6+1.19.3+forge" = _nxwHXyAp;
        "pkg-1.0.6+1.19.4+fabric" = _IXuWMuh3;
        "pkg-1.0.6+1.19.4+forge" = _IOTLvGDt;
        "pkg-1.0.6+1.19.2+fabric" = _nROflJT2;
        "pkg-1.0.6+1.19.2+forge" = _Of9yAFuQ;
        "pkg-1.0.7+1.19.4+fabric" = _3bWCInBV;
        "pkg-1.0.7+1.19.4+forge" = _T6JBXl6g;
        "pkg-1.0.7+1.19.3+fabric" = _higCO4E4;
        "pkg-1.0.7+1.19.3+forge" = _YxwzpJCq;
        "pkg-1.0.7+1.20.1+fabric" = _w5JiWCW7;
        "pkg-1.0.7+1.20.1+forge" = _pG5HGVTu;
        "pkg-1.0.7+1.19.2+fabric" = _MkemtDIU;
        "pkg-1.0.7+1.19.2+forge" = _VyI9Fr1W;
        "pkg-1.0.8+1.20.1+fabric" = _uWOLRJF1;
        "pkg-1.0.8+1.20.1+forge" = _dJR0haLe;
        "pkg-1.0.8+1.19.4+fabric" = _nFk08aES;
        "pkg-1.0.8+1.19.4+forge" = _ozJzwpzN;
        "pkg-1.0.8+1.19.3+fabric" = _IvAyCXEb;
        "pkg-1.0.8+1.19.3+forge" = _5Zld5CC5;
        "pkg-1.0.8+1.19.2+fabric" = _t2VUPeY1;
        "pkg-1.0.8+1.19.2+forge" = _e637x6DP;
        "pkg-1.0.9+1.19.4+fabric" = _mswL1Cx9;
        "pkg-1.0.9+1.19.4+forge" = _zA0tREKg;
        "pkg-1.0.9+1.19.3+fabric" = _VNH5f0Hi;
        "pkg-1.0.9+1.19.3+forge" = _cZIemJcR;
        "pkg-1.0.9+1.20.1+fabric" = _qnO2ZoJH;
        "pkg-1.0.9+1.20.1+forge" = _XbMku1KO;
        "pkg-1.0.9+1.19.2+fabric" = _bAYhhGqf;
        "pkg-1.0.9+1.19.2+forge" = _I3JL1sI9;
        "pkg-1.0.10+1.20.1+fabric" = _FZ64cRZE;
        "pkg-1.0.10+1.20.1+forge" = _vcybH53j;
        "pkg-1.0.10+1.19.3+fabric" = _pYDQKFeb;
        "pkg-1.0.10+1.19.3+forge" = _STIuB6G5;
        "pkg-1.0.10+1.19.4+fabric" = _10TkzyBV;
        "pkg-1.0.10+1.19.4+forge" = _LHHhqkL2;
        "pkg-1.0.10+1.19.2+fabric" = _X5W6NKzV;
        "pkg-1.0.10+1.19.2+forge" = _Qhg4LbNd;
        "pkg-1.0.11+1.20.1+fabric" = _xrNa7BYH;
        "pkg-1.0.11+1.20.1+forge" = _zuUJzYUV;
        "pkg-1.0.11+1.19.3+fabric" = _WFt4jv0T;
        "pkg-1.0.11+1.19.3+forge" = _52yAooXY;
        "pkg-1.0.11+1.19.4+fabric" = _De0PHzIx;
        "pkg-1.0.11+1.19.4+forge" = _WjW9CHfj;
        "pkg-1.0.11+1.19.2+fabric" = _CLHwCTp1;
        "pkg-1.0.11+1.19.2+forge" = _JZDbqnxr;
        "pkg-1.0.12+1.20.1+fabric" = _paDs62jv;
        "pkg-1.0.12+1.20.1+forge" = _YVPp8jzW;
        "pkg-1.0.12+1.19.3+fabric" = _Jr0Yf8u2;
        "pkg-1.0.12+1.19.3+forge" = _oA5GgOHE;
        "pkg-1.0.12+1.19.4+fabric" = _7jVTxOCF;
        "pkg-1.0.12+1.19.4+forge" = _5U4TG26Y;
        "pkg-1.0.12+1.19.2+fabric" = _lOT4MTxG;
        "pkg-1.0.12+1.19.2+forge" = _L1Ew1Lqd;
        "pkg-1.0.13+1.20.1+fabric" = _duZtEIpt;
        "pkg-1.0.13+1.19.3+fabric" = _feTe8TlD;
        "pkg-1.0.13+1.20.1+forge" = _BBCH3lGq;
        "pkg-1.0.13+1.19.3+forge" = _v23AX0tn;
        "pkg-1.0.13+1.19.4+fabric" = _mn3yNAK2;
        "pkg-1.0.13+1.19.4+forge" = _G8b88mou;
        "pkg-1.0.13+1.19.2+fabric" = _YUxVrA2Y;
        "pkg-1.0.13+1.19.2+forge" = _BPGh6SPX;
        "pkg-1.0.14+1.19.4+fabric" = _kQtM7WHz;
        "pkg-1.0.14+1.19.3+fabric" = _bkE3fS2l;
        "pkg-1.0.14+1.19.4+forge" = _MdaKz81K;
        "pkg-1.0.14+1.19.3+forge" = _O7aSkZQW;
        "pkg-1.0.14+1.20.1+fabric" = _X2ligAnL;
        "pkg-1.0.14+1.20.1+forge" = _B3nCpImc;
        "pkg-1.0.14+1.19.2+fabric" = _TEc5cW0M;
        "pkg-1.0.14+1.19.2+forge" = _1i6tvCQX;
        "pkg-1.0.15+1.19.3+fabric" = _et5qRkAD;
        "pkg-1.0.15+1.19.3+forge" = _9cfSTnIK;
        "pkg-1.0.15+1.20.1+fabric" = _BSIAesA3;
        "pkg-1.0.15+1.20.1+forge" = _tKSmt8eh;
        "pkg-1.0.15+1.19.4+fabric" = _YDTMLiJr;
        "pkg-1.0.15+1.19.4+forge" = _38WXrQH1;
        "pkg-1.0.15+1.19.2+fabric" = _CAr87JlY;
        "pkg-1.0.15+1.19.2+forge" = _Qj9KohS3;
        "pkg-1.0.16+1.20.1+fabric" = _khldbYJv;
        "pkg-1.0.16+1.20.1+forge" = _6zkJhbnx;
        "pkg-1.0.16+1.19.3+fabric" = _DBMNFHj3;
        "pkg-1.0.16+1.19.3+forge" = _ZuZUW60m;
        "pkg-1.0.16+1.19.4+fabric" = _Tg64Z6sA;
        "pkg-1.0.16+1.19.4+forge" = _r3B6x1If;
        "pkg-1.0.16+1.19.2+fabric" = _F2UmhLRv;
        "pkg-1.0.16+1.19.2+forge" = _lElIQlYu;
        "pkg-1.0.17+1.20.1+fabric" = _Tgsj5Iry;
        "pkg-1.0.17+1.20.1+forge" = _DCjY1O8T;
        "pkg-1.0.17+1.19.4+fabric" = _Vkud1bpA;
        "pkg-1.0.17+1.19.4+forge" = _7SYqsFB9;
        "pkg-1.0.17+1.19.3+fabric" = _WZsj6ARC;
        "pkg-1.0.17+1.19.3+forge" = _1D1XIvL7;
        "pkg-1.0.17+1.19.2+fabric" = _rB7RxzsG;
        "pkg-1.0.17+1.19.2+forge" = _t0oce5tQ;
        "pkg-1.0.18+1.19.3+fabric" = _DoKtwgI7;
        "pkg-1.0.18+1.19.3+forge" = _aHJUq2yS;
        "pkg-1.0.18+1.19.4+fabric" = _sSgnWL3r;
        "pkg-1.0.18+1.20.1+fabric" = _4mx41ehI;
        "pkg-1.0.18+1.19.4+forge" = _kr0VbAGZ;
        "pkg-1.0.18+1.20.1+forge" = _TEs5oCdP;
        "pkg-1.0.18+1.19.2+fabric" = _ciMqRO3M;
        "pkg-1.0.18+1.19.2+forge" = _ZiWxCd0J;
        "pkg-1.0.19+1.19.4+fabric" = _FRCRUfd3;
        "pkg-1.0.19+1.19.4+forge" = _MvPCuYYA;
        "pkg-1.0.19+1.19.3+fabric" = _VQROU1Eb;
        "pkg-1.0.19+1.19.3+forge" = _WPGlB0Q4;
        "pkg-1.0.19+1.20.1+fabric" = _K2ePWegL;
        "pkg-1.0.19+1.20.1+forge" = _r0H3gXol;
        "pkg-1.0.19+1.19.2+fabric" = _kf0WMidK;
        "pkg-1.0.19+1.19.2+forge" = _fhrIZU0y;
        "pkg-1.0.20+1.20.1+fabric" = _wGL8eTVV;
        "pkg-1.0.20+1.20.1+forge" = _E80ymIet;
        "pkg-1.0.20+1.19.2+fabric" = _CUoRjscx;
        "pkg-1.0.20+1.19.2+forge" = _y6Pchk8E;
        "pkg-1.0.20+1.19.4+fabric" = _COZQFEqG;
        "pkg-1.0.20+1.19.4+forge" = _RP9coq1M;
        "pkg-1.0.20+1.19.3+fabric" = _LqtKhfge;
        "pkg-1.0.20+1.19.3+forge" = _idoOUaCk;
        "pkg-1.0.21+1.20.1+fabric" = _mQ5vmtq6;
        "pkg-1.0.21+1.20.1+forge" = _bTfpCdYw;
        "pkg-1.0.21+1.19.2+fabric" = _WYq0OMLK;
        "pkg-1.0.21+1.19.2+forge" = _LhbqNQf1;
        "pkg-1.0.21+1.19.3+fabric" = _UCpCV4NB;
        "pkg-1.0.21+1.19.3+forge" = _EwkWJFiL;
        "pkg-1.0.21+1.19.4+fabric" = _h8uRTkMm;
        "pkg-1.0.21+1.19.4+forge" = _4P7cDZh6;
        "pkg-1.0.21+1.20.2+fabric" = _S95SltXc;
        "pkg-1.0.21+1.20.2+forge" = _uc0bAHRJ;
        "pkg-1.0.22+1.19.4+fabric" = _5EF7qT9j;
        "pkg-1.0.22+1.19.4+forge" = _yAKyNAcX;
        "pkg-1.0.22+1.20.2+fabric" = _m20CKFQP;
        "pkg-1.0.22+1.20.2+forge" = _LuKVNzSW;
        "pkg-1.0.22+1.19.2+fabric" = _C7wDPBBO;
        "pkg-1.0.22+1.19.2+forge" = _VldBzgSe;
        "pkg-1.0.22+1.19.3+fabric" = _KVRbalGS;
        "pkg-1.0.22+1.19.3+forge" = _bu1kRUXQ;
        "pkg-1.0.22+1.20.1+fabric" = _IOqjd65y;
        "pkg-1.0.22+1.20.1+forge" = _WfgfLwLP;
        "pkg-1.0.23+1.20.2+fabric" = _YnaTUIc5;
        "pkg-1.0.23+1.20.2+forge" = _Oh5hbbaI;
        "pkg-1.0.23+1.19.4+fabric" = _kZ9XQdPd;
        "pkg-1.0.23+1.19.3+fabric" = _V3N4J6qf;
        "pkg-1.0.23+1.19.4+forge" = _v5NJCWY9;
        "pkg-1.0.23+1.19.3+forge" = _SeSuTQxr;
        "pkg-1.0.23+1.19.2+fabric" = _kFb4jT7Q;
        "pkg-1.0.23+1.19.2+forge" = _DqzrW6QN;
        "pkg-1.0.23+1.20.1+fabric" = _HlfhF7AQ;
        "pkg-1.0.23+1.20.1+forge" = _ShejnJfY;
        "pkg-1.0.24+1.19.4+fabric" = _LKSxkjKD;
        "pkg-1.0.24+1.19.4+forge" = _mqiPWBzS;
        "pkg-1.0.24+1.19.2+fabric" = _qpiHDyUC;
        "pkg-1.0.24+1.19.2+forge" = _7XKOZJmG;
        "pkg-1.0.24+1.20.1+fabric" = _EY0bsln7;
        "pkg-1.0.24+1.20.1+forge" = _hIuOBjbs;
        "pkg-1.0.24+1.19.3+fabric" = _aD5TSGGI;
        "pkg-1.0.24+1.19.3+forge" = _jT5Qro6x;
        "pkg-1.0.24+1.20.2+fabric" = _hyg4KnuZ;
        "pkg-1.0.24+1.20.2+forge" = _fTlqZTyF;
        "pkg-1.0.25+1.20.2+fabric" = _P0MSenTX;
        "pkg-1.0.25+1.20.2+forge" = _gUG5ToEM;
        "pkg-1.0.25+1.19.2+fabric" = _WsJqAKp7;
        "pkg-1.0.25+1.19.2+forge" = _OakBkMPU;
        "pkg-1.0.25+1.19.4+fabric" = _Ph2khrMS;
        "pkg-1.0.25+1.19.4+forge" = _H9w4Ydog;
        "pkg-1.0.25+1.20.1+fabric" = _4AAJllHB;
        "pkg-1.0.25+1.20.1+forge" = _2cTZQ8kN;
        "pkg-1.0.25+1.19.3+fabric" = _ORJaB6VX;
        "pkg-1.0.25+1.19.3+forge" = _AoRrWyoO;
        "pkg-1.0.26+1.20.2+fabric" = _wbgMJeMX;
        "pkg-1.0.26+1.20.2+forge" = _nKHd76xj;
        "pkg-1.0.26+1.20.1+fabric" = _RNRM4uV3;
        "pkg-1.0.26+1.20.1+forge" = _pKhU2h5V;
        "pkg-1.0.26+1.19.3+fabric" = _yzBWYzer;
        "pkg-1.0.26+1.19.3+forge" = _mh0nVpvd;
        "pkg-1.0.26+1.19.4+fabric" = _oPrVxI1B;
        "pkg-1.0.26+1.19.4+forge" = _1CqxcckV;
        "pkg-1.0.26+1.19.2+fabric" = _WL0Evl7s;
        "pkg-1.0.26+1.19.2+forge" = _frxcvFif;
        "pkg-1.0.27+1.20.2+fabric" = _CT8YRMFZ;
        "pkg-1.0.27+1.20.2+forge" = _o9YEnMle;
        "pkg-1.0.27+1.19.4+fabric" = _XLFgFOY5;
        "pkg-1.0.27+1.19.4+forge" = _QaDJ9Qul;
        "pkg-1.0.27+1.19.3+fabric" = _sxxVZDxv;
        "pkg-1.0.27+1.19.3+forge" = _CuU3yQ5k;
        "pkg-1.0.27+1.19.2+fabric" = _FPU1PaZ9;
        "pkg-1.0.27+1.20.1+fabric" = _KzxcdPKP;
        "pkg-1.0.27+1.19.2+forge" = _Lz7REsqm;
        "pkg-1.0.27+1.20.1+forge" = _t6sA5eIt;
        "pkg-1.0.28+1.20.2+fabric" = _M7ynHTnb;
        "pkg-1.0.28+1.20.2+forge" = _qlOQ1Ts3;
        "pkg-1.0.28+1.19.4+fabric" = _vgP2BYpD;
        "pkg-1.0.28+1.19.2+fabric" = _LPa8R1oT;
        "pkg-1.0.28+1.19.4+forge" = _wJJNXskX;
        "pkg-1.0.28+1.20.1+fabric" = _pWonvbOv;
        "pkg-1.0.28+1.19.2+forge" = _rohQlpM0;
        "pkg-1.0.28+1.20.1+forge" = _ZP7ZK7Lj;
        "pkg-1.0.28+1.19.3+fabric" = _SFAPEnOo;
        "pkg-1.0.28+1.19.3+forge" = _EiKbj434;
        "pkg-1.0.28+1.20.4+fabric" = _79b5GcsK;
        "pkg-1.0.29+1.20.2+fabric" = _LtMXoSYI;
        "pkg-1.0.29+1.20.1+fabric" = _3KtYJ2Av;
        "pkg-1.0.29+1.19.2+fabric" = _hAbEzEta;
        "pkg-1.0.29+1.19.3+fabric" = _QXfQTnbM;
        "pkg-1.0.29+1.19.4+fabric" = _Tk1KEPaS;
        "pkg-1.0.29+1.20.2+forge" = _56E4LTxT;
        "pkg-1.0.29+1.19.2+forge" = _pORJ7GVs;
        "pkg-1.0.29+1.19.3+forge" = _wjQy6sQv;
        "pkg-1.0.29+1.20.1+forge" = _l15ilTAR;
        "pkg-1.0.29+1.19.4+forge" = _AJ1mDwj6;
        "pkg-1.0.29+1.20.4+fabric" = _jXyglcrU;
        "pkg-1.0.29+1.20.4+neoforge" = _1ocza6o7;
        "pkg-1.0.30+1.20.4+fabric" = _crPExfgb;
        "pkg-1.0.30+1.20.4+neoforge" = _arTpMrYe;
        "pkg-1.0.30+1.20.2+fabric" = _eLWsC2tY;
        "pkg-1.0.30+1.20.2+forge" = _940GsBY0;
        "pkg-1.0.30+1.19.2+fabric" = _RvMwqywq;
        "pkg-1.0.30+1.19.2+forge" = _ynMAB9G5;
        "pkg-1.0.30+1.19.4+fabric" = _eINRNebJ;
        "pkg-1.0.30+1.19.4+forge" = _cEuDNBVH;
        "pkg-1.0.30+1.19.3+fabric" = _NYZWAPDB;
        "pkg-1.0.30+1.19.3+forge" = _qTM8LiKt;
        "pkg-1.0.30+1.20.1+fabric" = _X6In4fQO;
        "pkg-1.0.30+1.20.1+forge" = _3pZIo9DE;
        "pkg-1.1.0+1.20.4+fabric" = _36EFbBVx;
        "pkg-1.1.0+1.20.4+neoforge" = _DUkvQ7If;
        "pkg-1.1.0+1.19.3+fabric" = _EaJzQKgN;
        "pkg-1.1.0+1.19.3+forge" = _danfgWqK;
        "pkg-1.1.0+1.19.4+fabric" = _XuHFpyev;
        "pkg-1.1.0+1.19.4+forge" = _qFRA5N2t;
        "pkg-1.1.0+1.19.2+fabric" = _43E0iqX3;
        "pkg-1.1.0+1.20.1+fabric" = _r10gArKs;
        "pkg-1.1.0+1.20.2+fabric" = _EJ5ehoSS;
        "pkg-1.1.0+1.19.2+forge" = _umtBPJhO;
        "pkg-1.1.0+1.20.2+forge" = _10yrqfdd;
        "pkg-1.1.0+1.20.1+forge" = _yJKM4MT2;
        "pkg-1.1.1+1.20.4+fabric" = _PABSe7Zo;
        "pkg-1.1.1+1.20.4+neoforge" = _rO3GdrOm;
        "pkg-1.1.1+1.20.1+fabric" = _x9hGUE2v;
        "pkg-1.1.1+1.20.1+forge" = _4Wza0ktp;
        "pkg-1.1.1+1.20.2+fabric" = _FPjC6tiC;
        "pkg-1.1.1+1.20.2+forge" = _jYOMGYft;
        "pkg-1.1.1+1.19.4+fabric" = _9RjArgzl;
        "pkg-1.1.1+1.19.4+forge" = _8bCpIouQ;
        "pkg-1.1.1+1.19.3+fabric" = _et3Yda8g;
        "pkg-1.1.1+1.19.3+forge" = _hWsaLfXF;
        "pkg-1.1.1+1.19.2+fabric" = _bvRrYwRL;
        "pkg-1.1.1+1.19.2+forge" = _UsF0weKt;
        "pkg-1.1.2+1.20.2+fabric" = _4xHDcgGs;
        "pkg-1.1.2+1.20.2+forge" = _fgfL6Dkb;
        "pkg-1.1.2+1.20.4+fabric" = _UJYtxEYG;
        "pkg-1.1.2+1.20.1+fabric" = _8a9CXUGo;
        "pkg-1.1.2+1.20.1+forge" = _UcPFZeeY;
        "pkg-1.1.2+1.20.4+neoforge" = _8qHA9xh2;
        "pkg-1.1.2+1.19.4+fabric" = _7eFmRnoY;
        "pkg-1.1.2+1.19.4+forge" = _dzfVGVCn;
        "pkg-1.1.2+1.19.3+fabric" = _T0I7aPo5;
        "pkg-1.1.2+1.19.3+forge" = _mB9YETyo;
        "pkg-1.1.2+1.19.2+fabric" = _QybkuIsL;
        "pkg-1.1.2+1.19.2+forge" = _WBHPrpGy;
        "pkg-1.1.3+1.20.4+fabric" = _gI8Bw8ak;
        "pkg-1.1.3+1.20.4+neoforge" = _e7RuCuSB;
        "pkg-1.1.3+1.20.2+fabric" = _wu6Lm26O;
        "pkg-1.1.3+1.20.2+forge" = _UFMTkoOy;
        "pkg-1.1.3+1.20.1+fabric" = _UTsNvm4s;
        "pkg-1.1.3+1.19.2+fabric" = _oco3Ru0n;
        "pkg-1.1.3+1.20.1+forge" = _3yd5CGg0;
        "pkg-1.1.3+1.19.2+forge" = _5grMgrk4;
        "pkg-1.1.3+1.19.4+fabric" = _8wePCvSM;
        "pkg-1.1.3+1.19.4+forge" = _61eK5Qjc;
        "pkg-1.1.3+1.19.3+fabric" = _iOJ2kiCY;
        "pkg-1.1.3+1.19.3+forge" = _251brana;
        "pkg-1.1.4+1.20.4+fabric" = _BzLRE7QI;
        "pkg-1.1.4+1.20.4+neoforge" = _5PYnL6bp;
        "pkg-1.1.4+1.20.2+fabric" = _kjfimrqy;
        "pkg-1.1.4+1.20.2+forge" = _x3JXUQXu;
        "pkg-1.1.4+1.19.3+fabric" = _nkTNGPfi;
        "pkg-1.1.4+1.19.3+forge" = _h1PlnLK8;
        "pkg-1.1.4+1.19.4+fabric" = _dx9JAxBH;
        "pkg-1.1.4+1.19.4+forge" = _SJ0JAHhd;
        "pkg-1.1.4+1.20.1+fabric" = _ab3hfPOi;
        "pkg-1.1.4+1.19.2+fabric" = _dR5R70l0;
        "pkg-1.1.4+1.20.1+forge" = _lDQkgadT;
        "pkg-1.1.4+1.19.2+forge" = _uMsufpiT;
        "pkg-1.1.5+1.20.6+fabric" = _JaMPmwPX;
        "pkg-1.1.5+1.20.6+neoforge" = _85L01eYA;
        "pkg-1.1.5+1.20.4+fabric" = _DrtzjH6o;
        "pkg-1.1.5+1.20.4+neoforge" = _WQy5U45G;
        "pkg-1.1.5+1.20.2+fabric" = _DMiNrgtQ;
        "pkg-1.1.5+1.20.2+forge" = _pnNpzsjL;
        "pkg-1.1.5+1.19.4+fabric" = _pum9p9G8;
        "pkg-1.1.5+1.19.4+forge" = _Nta4625W;
        "pkg-1.1.5+1.19.3+fabric" = _o4jnHvit;
        "pkg-1.1.5+1.19.3+forge" = _VXzF7Jf3;
        "pkg-1.1.5+1.20.1+fabric" = _6SFxCS4Z;
        "pkg-1.1.5+1.20.1+forge" = _V8GOoftG;
        "pkg-1.1.5+1.19.2+fabric" = _oAh7Recf;
        "pkg-1.1.5+1.19.2+forge" = _dkw8xrHG;
        "pkg-1.1.6+1.20.4+fabric" = _1vKrnGbh;
        "pkg-1.1.6+1.20.4+neoforge" = _4xudl8X1;
        "pkg-1.1.6+1.20.1+fabric" = _spghOu2N;
        "pkg-1.1.6+1.20.1+forge" = _5b1435Qy;
        "pkg-1.1.6+1.20.2+fabric" = _4pAJCVeU;
        "pkg-1.1.6+1.20.2+forge" = _k658ykiP;
        "pkg-1.1.6+1.20.6+fabric" = _4a8tCBWN;
        "pkg-1.1.6+1.20.6+neoforge" = _NjI7RG5g;
        "pkg-1.1.6+1.19.4+fabric" = _TwGLYmkp;
        "pkg-1.1.6+1.19.4+forge" = _axABqUYz;
        "pkg-1.1.6+1.19.2+fabric" = _zRo9xfuw;
        "pkg-1.1.6+1.19.2+forge" = _QhG3TG8L;
        "pkg-1.1.6+1.19.3+fabric" = _uzwdbmod;
        "pkg-1.1.6+1.19.3+forge" = _av8zEC0v;
        "pkg-1.1.7+1.20.4+fabric" = _fIS5SA07;
        "pkg-1.1.7+1.20.4+neoforge" = _FLK7nYsj;
        "pkg-1.1.7+1.21+fabric" = _m62N0vBZ;
        "pkg-1.1.7+1.21+neoforge" = _p8ct3Wd4;
        "pkg-1.1.7+1.20.6+fabric" = _LGqZaZLs;
        "pkg-1.1.7+1.20.6+neoforge" = _harySgCU;
        "pkg-1.1.7+1.20.1+fabric" = _MZiSLFZX;
        "pkg-1.1.7+1.20.1+forge" = _QT6oPqYH;
        "pkg-1.1.7+1.19.2+fabric" = _5qgRXRYj;
        "pkg-1.1.7+1.19.2+forge" = _AnPwoFAK;
        "pkg-1.1.7+1.20.2+fabric" = _VZf6Fgw4;
        "pkg-1.1.7+1.19.3+fabric" = _sXVTxyV4;
        "pkg-1.1.7+1.20.2+forge" = _jLNbh0qb;
        "pkg-1.1.7+1.19.3+forge" = _vPa1eDs2;
        "pkg-1.1.7+1.19.4+fabric" = _lHKRECLG;
        "pkg-1.1.7+1.19.4+forge" = _CNGDifV2;
        "pkg-1.1.8+1.21+fabric" = _ivFE6ShM;
        "pkg-1.1.8+1.21+neoforge" = _XMKed62q;
        "pkg-1.1.8+1.20.4+fabric" = _seQG8huJ;
        "pkg-1.1.8+1.20.4+neoforge" = _VddSrN3Y;
        "pkg-1.1.8+1.20.1+fabric" = _PBtTeLpA;
        "pkg-1.1.8+1.20.1+forge" = _fCSXJrtb;
        "pkg-1.1.8+1.19.3+fabric" = _BK77DVh0;
        "pkg-1.1.8+1.19.4+fabric" = _1aiiSF65;
        "pkg-1.1.8+1.19.3+forge" = _wGAgdzBB;
        "pkg-1.1.8+1.19.4+forge" = _n08CRJmF;
        "pkg-1.1.8+1.19.2+fabric" = _z5zG9Fow;
        "pkg-1.1.8+1.19.2+forge" = _3mJfd9uO;
        "pkg-1.1.8+1.20.2+fabric" = _bh3A7AVy;
        "pkg-1.1.8+1.20.2+forge" = _YmCA8nld;
        "pkg-1.1.8+1.20.6+fabric" = _axY1S64z;
        "pkg-1.1.8+1.20.6+neoforge" = _I4SRqJen;
        "pkg-1.1.9+1.21+fabric" = _g1hOAOT4;
        "pkg-1.1.9+1.21+neoforge" = _2e7gkT1o;
        "pkg-1.1.9+1.20.6+fabric" = _Wc09It2Z;
        "pkg-1.1.9+1.20.6+neoforge" = _JDfCnSAV;
        "pkg-1.1.9+1.20.4+fabric" = _zWJ8RVZN;
        "pkg-1.1.9+1.20.4+neoforge" = _3mQc1o5v;
        "pkg-1.1.9+1.20.1+fabric" = _TCiDdtjO;
        "pkg-1.1.9+1.20.1+forge" = _aFGm4ESK;
        "pkg-1.1.9+1.20.2+fabric" = _CMkQ0Hch;
        "pkg-1.1.9+1.20.2+forge" = _5RZTe6DQ;
        "pkg-1.1.9+1.19.3+fabric" = _37XeXpbT;
        "pkg-1.1.9+1.19.2+fabric" = _z42fyZ0F;
        "pkg-1.1.9+1.19.3+forge" = _4zhp4O8u;
        "pkg-1.1.9+1.19.4+fabric" = _SNTrPiyR;
        "pkg-1.1.9+1.19.2+forge" = _k8STZgoZ;
        "pkg-1.1.9+1.19.4+forge" = _b9OtrQB1;
        "pkg-1.1.10+1.21+fabric" = _KRp4lW7A;
        "pkg-1.1.10+1.21+neoforge" = _pz7GGu38;
        "pkg-1.1.10+1.20.2+fabric" = _7iQ5fd11;
        "pkg-1.1.10+1.20.2+forge" = _KjJWi09F;
        "pkg-1.1.10+1.20.6+fabric" = _ZvkFcWos;
        "pkg-1.1.10+1.20.6+neoforge" = _BFmrAz9F;
        "pkg-1.1.10+1.19.4+fabric" = _lmVVkVoj;
        "pkg-1.1.10+1.19.4+forge" = _6E85lIRF;
        "pkg-1.1.10+1.20.4+fabric" = _BeIP838d;
        "pkg-1.1.10+1.20.4+neoforge" = _S3NXM8l7;
        "pkg-1.1.10+1.19.3+fabric" = _lbtga1C5;
        "pkg-1.1.10+1.19.3+forge" = _Az4dsj6V;
        "pkg-1.1.10+1.20.1+fabric" = _8KtEM1az;
        "pkg-1.1.10+1.20.1+forge" = _HhQ69HxF;
        "pkg-1.1.10+1.19.2+fabric" = _OguvM0Pf;
        "pkg-1.1.10+1.19.2+forge" = _1z1WuvTj;
        "pkg-1.1.11+1.21+fabric" = _SUb1qcBU;
        "pkg-1.1.11+1.21+neoforge" = _ilhFPSYz;
        "pkg-1.1.11+1.20.4+fabric" = _6fblD6MH;
        "pkg-1.1.11+1.20.4+neoforge" = _ctLp6fsa;
        "pkg-1.1.11+1.20.2+fabric" = _3PhmMBp9;
        "pkg-1.1.11+1.20.2+forge" = _wmULB9bu;
        "pkg-1.1.11+1.19.4+fabric" = _s1tH07n6;
        "pkg-1.1.11+1.19.4+forge" = _KDi8Jvir;
        "pkg-1.1.11+1.19.3+fabric" = _BduaXsAB;
        "pkg-1.1.11+1.19.2+fabric" = _BHbwlThS;
        "pkg-1.1.11+1.19.3+forge" = _wKXTamt5;
        "pkg-1.1.11+1.19.2+forge" = _9gzeWU7v;
        "pkg-1.1.11+1.20.1+fabric" = _X937lDzA;
        "pkg-1.1.11+1.20.1+forge" = _qf2E1fHW;
        "pkg-1.1.11+1.20.6+fabric" = _RHEQI7Fc;
        "pkg-1.1.11+1.20.6+neoforge" = _q4ql2JIE;
        "pkg-1.1.12+1.20.4+fabric" = _vwD58Ys7;
        "pkg-1.1.12+1.20.4+neoforge" = _pijKAUf5;
        "pkg-1.1.12+1.21+fabric" = _uZ7UbDHM;
        "pkg-1.1.12+1.21+neoforge" = _IKIYLKyP;
        "pkg-1.1.12+1.20.2+fabric" = _ejRBcDws;
        "pkg-1.1.12+1.20.2+forge" = _hrxmzv7I;
        "pkg-1.1.12+1.19.4+fabric" = _sth5x8cn;
        "pkg-1.1.12+1.19.4+forge" = _sNV8HZRW;
        "pkg-1.1.12+1.20.1+fabric" = _CMFWLyX6;
        "pkg-1.1.12+1.20.1+forge" = _X6p68pI0;
        "pkg-1.1.12+1.19.2+fabric" = _1OQ73USb;
        "pkg-1.1.12+1.19.2+forge" = _TbXHNT8N;
        "pkg-1.1.12+1.19.3+fabric" = _Plj7yw6W;
        "pkg-1.1.12+1.19.3+forge" = _k0u6LhLO;
        "pkg-1.1.12+1.20.6+fabric" = _bm1PCRua;
        "pkg-1.1.12+1.20.6+neoforge" = _mhEIiLgH;
        "pkg-1.1.13+1.20.2+fabric" = _3K4AzU6L;
        "pkg-1.1.13+1.20.2+forge" = _gI3SZQBK;
        "pkg-1.1.13+1.20.4+fabric" = _zVBdS9PY;
        "pkg-1.1.13+1.20.4+neoforge" = _V2rHw2vR;
        "pkg-1.1.13+1.19.4+fabric" = _goLgvKB7;
        "pkg-1.1.13+1.19.4+forge" = _LtmSUtlk;
        "pkg-1.1.13+1.19.3+fabric" = _oJ8wExdj;
        "pkg-1.1.13+1.19.3+forge" = _4NPmYHPl;
        "pkg-1.1.13+1.20.1+fabric" = _9u5r0cLK;
        "pkg-1.1.13+1.20.1+forge" = _9BeUhlBt;
        "pkg-1.1.13+1.19.2+fabric" = _25ETHU9h;
        "pkg-1.1.13+1.19.2+forge" = _ismpJZBe;
        "pkg-1.1.13+1.20.6+fabric" = _5yw24LA8;
        "pkg-1.1.13+1.20.6+neoforge" = _cJO7tiHY;
        "pkg-1.1.13+1.21.1+fabric" = _A67gMoCl;
        "pkg-1.1.13+1.21.1+neoforge" = _ZAv4P8N7;
        "pkg-1.1.14+1.21.1+fabric" = _9DRL0tJC;
        "pkg-1.1.14+1.21.1+neoforge" = _Cv4nuaNq;
        "pkg-1.1.14+1.20.2+fabric" = _DbACssmC;
        "pkg-1.1.14+1.20.2+forge" = _Pw4clWty;
        "pkg-1.1.14+1.20.4+fabric" = _JGmFMcD5;
        "pkg-1.1.14+1.20.4+neoforge" = _9kIH48al;
        "pkg-1.1.14+1.20.1+fabric" = _yh9Ei8rv;
        "pkg-1.1.14+1.19.4+fabric" = _Ywer9FOd;
        "pkg-1.1.14+1.20.1+forge" = _HAeJ3iua;
        "pkg-1.1.14+1.19.4+forge" = _ZO0lgfIY;
        "pkg-1.1.14+1.19.2+fabric" = _GO8JMlll;
        "pkg-1.1.14+1.19.2+forge" = _CUJauQAB;
        "pkg-1.1.14+1.19.3+fabric" = _vauGoSqu;
        "pkg-1.1.14+1.19.3+forge" = _rA4lafio;
        "pkg-1.1.14+1.20.6+fabric" = _GQXykWVo;
        "pkg-1.1.14+1.20.6+neoforge" = _lVqqtG0k;
        "pkg-1.1.15+1.21.1+fabric" = _zdVFb6eU;
        "pkg-1.1.15+1.21.1+neoforge" = _ZL6HyMuy;
        "pkg-1.1.15+1.20.2+fabric" = _kksGUsS6;
        "pkg-1.1.15+1.20.2+forge" = _n8jnGh8K;
        "pkg-1.1.15+1.19.2+fabric" = _J1FjsyBL;
        "pkg-1.1.15+1.19.2+forge" = _Xp1i43OH;
        "pkg-1.1.15+1.19.3+fabric" = _SEYIMaj2;
        "pkg-1.1.15+1.19.3+forge" = _MwwvCyOr;
        "pkg-1.1.15+1.20.4+fabric" = _bGQFgISZ;
        "pkg-1.1.15+1.20.4+neoforge" = _WH7XxBev;
        "pkg-1.1.15+1.20.1+fabric" = _V8FSuszE;
        "pkg-1.1.15+1.20.1+forge" = _sPLmUFit;
        "pkg-1.1.15+1.19.4+fabric" = _fBdnSHzm;
        "pkg-1.1.15+1.19.4+forge" = _PoYqoxhn;
        "pkg-1.1.15+1.20.6+fabric" = _MtCqHse6;
        "pkg-1.1.15+1.20.6+neoforge" = _F70vdgOA;
        "pkg-1.1.16+1.21.1+fabric" = _onEgcWmL;
        "pkg-1.1.16+1.21.1+neoforge" = _cYumVNNp;
        "pkg-1.1.16+1.20.6+fabric" = _WsZCtviV;
        "pkg-1.1.16+1.20.6+neoforge" = _JUgxdJYX;
        "pkg-1.1.16+1.20.2+fabric" = _8dFh4hji;
        "pkg-1.1.16+1.20.2+forge" = _mq4YOwYd;
        "pkg-1.1.16+1.20.4+fabric" = _6KICLUoO;
        "pkg-1.1.16+1.20.4+neoforge" = _12djobjS;
        "pkg-1.1.16+1.19.3+fabric" = _CqVEunSp;
        "pkg-1.1.16+1.19.2+fabric" = _H8ORXRuw;
        "pkg-1.1.16+1.19.3+forge" = _BwONZfWp;
        "pkg-1.1.16+1.19.2+forge" = _nnzXpQnU;
        "pkg-1.1.16+1.19.4+fabric" = _VKz6kGTo;
        "pkg-1.1.16+1.19.4+forge" = _Wf1U1y4s;
        "pkg-1.1.16+1.20.1+fabric" = _L452maHz;
        "pkg-1.1.16+1.20.1+forge" = _lL5Etb2g;
        "pkg-1.1.17+1.21.1+fabric" = _mnMLEQjZ;
        "pkg-1.1.17+1.21.1+neoforge" = _QqZO9c8h;
        "pkg-1.1.17+1.20.6+fabric" = _qusBBK0Z;
        "pkg-1.1.17+1.20.6+neoforge" = _busJSlAw;
        "pkg-1.1.17+1.20.4+fabric" = _Gga5yWKt;
        "pkg-1.1.17+1.20.4+neoforge" = _vwRKfyFq;
        "pkg-1.1.17+1.19.2+fabric" = _o7bcDD4M;
        "pkg-1.1.17+1.19.2+forge" = _6HWqZ4wf;
        "pkg-1.1.17+1.19.4+fabric" = _vbMlVqBc;
        "pkg-1.1.17+1.19.4+forge" = _oQiW9lXP;
        "pkg-1.1.17+1.20.2+fabric" = _AGDnTsNM;
        "pkg-1.1.17+1.20.2+forge" = _dSWE0S2B;
        "pkg-1.1.17+1.19.3+fabric" = _OFvU4D6x;
        "pkg-1.1.17+1.19.3+forge" = _7F9lJUKG;
        "pkg-1.1.17+1.20.1+fabric" = _dX93L2Zf;
        "pkg-1.1.17+1.20.1+forge" = _oaifK5Jx;
        "pkg-1.1.18+1.21.1+fabric" = _CEJWA0sa;
        "pkg-1.1.18+1.21.1+neoforge" = _rqpS0Eks;
        "pkg-1.1.18+1.20.4+fabric" = _1U2jbRMw;
        "pkg-1.1.18+1.20.4+neoforge" = _BLFAhQvD;
        "pkg-1.1.18+1.20.6+fabric" = _x0rBxU7D;
        "pkg-1.1.18+1.20.6+neoforge" = _mWYm2vLs;
        "pkg-1.1.18+1.20.1+fabric" = _7z8wc2Iv;
        "pkg-1.1.18+1.20.1+forge" = _nD8mVPnn;
        "pkg-1.1.18+1.19.2+fabric" = _2kUBM8uZ;
        "pkg-1.1.18+1.19.2+forge" = _mXrRdcl8;
        "pkg-1.1.18+1.20.2+fabric" = _269qITND;
        "pkg-1.1.18+1.20.2+forge" = _AgtPMyz5;
        "pkg-1.1.18+1.19.4+fabric" = _dDD499l7;
        "pkg-1.1.18+1.19.4+forge" = _7qcFjx4X;
        "pkg-1.1.18+1.19.3+fabric" = _NhaY0DQ7;
        "pkg-1.1.18+1.19.3+forge" = _tWH6Nk0l;
        "pkg-1.1.19+1.20.6+fabric" = _29gyayDt;
        "pkg-1.1.19+1.20.6+neoforge" = _qbr3FRjX;
        "pkg-1.1.19+1.21.1+fabric" = _HlidHIGb;
        "pkg-1.1.19+1.21.1+neoforge" = _BzqWNbLp;
        "pkg-1.1.19+1.20.4+fabric" = _lvag1LQ4;
        "pkg-1.1.19+1.20.4+neoforge" = _pbVKDLRt;
        "pkg-1.1.19+1.20.1+fabric" = _Lo871w3V;
        "pkg-1.1.19+1.20.1+forge" = _GSmsesll;
        "pkg-1.1.19+1.19.4+fabric" = _ey8z1b2F;
        "pkg-1.1.19+1.19.4+forge" = _pR9ZE2vq;
        "pkg-1.1.19+1.19.2+fabric" = _s1RYQQiL;
        "pkg-1.1.19+1.19.2+forge" = _3HzQ7sqs;
        "pkg-1.1.19+1.20.2+fabric" = _U8RbAjr6;
        "pkg-1.1.19+1.19.3+fabric" = _2dKqBnPD;
        "pkg-1.1.19+1.19.3+forge" = _3k5znmWw;
        "pkg-1.1.19+1.20.2+forge" = _bj3O7JEj;
        "pkg-1.1.20+1.21.1+fabric" = _WjqfEAwF;
        "pkg-1.1.20+1.21.1+neoforge" = _UwFjsK2A;
        "pkg-1.1.20+1.19.3+fabric" = _aXttbTKz;
        "pkg-1.1.20+1.20.2+fabric" = _VVHeS1sd;
        "pkg-1.1.20+1.20.1+fabric" = _DXUtDziE;
        "pkg-1.1.20+1.20.6+fabric" = _N6OfG1JU;
        "pkg-1.1.20+1.19.3+forge" = _qNGRId1S;
        "pkg-1.1.20+1.20.2+forge" = _QyZJrS6y;
        "pkg-1.1.20+1.20.1+forge" = _3fJ5PcgX;
        "pkg-1.1.20+1.20.6+neoforge" = _Pv8eWTzL;
        "pkg-1.1.20+1.19.4+fabric" = _AvOmCFFM;
        "pkg-1.1.20+1.19.4+forge" = _GFAm3g3M;
        "pkg-1.1.20+1.20.4+fabric" = _KsRC6vwp;
        "pkg-1.1.20+1.20.4+neoforge" = _kM9vgiyk;
        "pkg-1.1.20+1.19.2+fabric" = _fRLNY9C9;
        "pkg-1.1.20+1.19.2+forge" = _jqCNPm8X;
        "pkg-1.1.21+1.21.1+fabric" = _Ks0Fsm8D;
        "pkg-1.1.21+1.21.1+neoforge" = _fg2JMQCp;
        "pkg-1.1.21+1.20.6+fabric" = _TiGLc3vi;
        "pkg-1.1.21+1.20.6+neoforge" = _32cXllyS;
        "pkg-1.1.21+1.19.3+fabric" = _XjSEIhci;
        "pkg-1.1.21+1.20.2+fabric" = _xCyMpfMj;
        "pkg-1.1.21+1.19.3+forge" = _r7ugBAfq;
        "pkg-1.1.21+1.19.4+fabric" = _GDrqA0aY;
        "pkg-1.1.21+1.20.2+forge" = _5NcRQfhx;
        "pkg-1.1.21+1.19.4+forge" = _6QpBkeVh;
        "pkg-1.1.21+1.19.2+fabric" = _F1VBN4WN;
        "pkg-1.1.21+1.19.2+forge" = _kR6tORLd;
        "pkg-1.1.21+1.20.1+fabric" = _PD8qRh6n;
        "pkg-1.1.21+1.20.1+forge" = _AcC9huLj;
        "pkg-1.1.21+1.20.4+fabric" = _182ifhD5;
        "pkg-1.1.21+1.20.4+neoforge" = _DwpWECAs;
        "pkg-1.1.22+1.21.1+fabric" = _mYQ3bJs5;
        "pkg-1.1.22+1.21.1+neoforge" = _ouSj7NfF;
        "pkg-1.1.22+1.20.6+fabric" = _5ztdetyO;
        "pkg-1.1.22+1.20.6+neoforge" = _9AnrMmRL;
        "pkg-1.1.22+1.19.3+fabric" = _7QqgrBjK;
        "pkg-1.1.22+1.19.3+forge" = _6zHpIk3B;
        "pkg-1.1.22+1.20.4+fabric" = _fn2hQWNs;
        "pkg-1.1.22+1.19.2+fabric" = _dv1JsP00;
        "pkg-1.1.22+1.19.2+forge" = _arXvHNCO;
        "pkg-1.1.22+1.20.4+neoforge" = _RI6C4hfK;
        "pkg-1.1.22+1.20.1+fabric" = _VvPw7Vi5;
        "pkg-1.1.22+1.20.1+forge" = _WtJS5tVw;
        "pkg-1.1.22+1.20.2+fabric" = _lqh9y6Sb;
        "pkg-1.1.22+1.20.2+forge" = _JUmAVmCV;
        "pkg-1.1.22+1.19.4+fabric" = _blPrhgDm;
        "pkg-1.1.22+1.19.4+forge" = _4DwrBBdi;
        "pkg-1.1.23+1.19.2+fabric" = _biIxYely;
        "pkg-1.1.23+1.19.2+forge" = _J6x46TtQ;
        "pkg-1.1.23+1.21.1+fabric" = _Qp9J2Yu5;
        "pkg-1.1.23+1.21.1+neoforge" = _n2jlxdLV;
        "pkg-1.1.23+1.20.1+fabric" = _v4y1JyP7;
        "pkg-1.1.23+1.20.1+forge" = _orxyrOEH;
        "pkg-1.1.24+1.19.2+fabric" = _fgTjvcl1;
        "pkg-1.1.24+1.19.2+forge" = _lvh62wOB;
        "pkg-1.1.24+1.20.1+fabric" = _YbXDHf8W;
        "pkg-1.1.24+1.20.1+forge" = _Axuu9I9R;
        "pkg-1.1.24+1.21.1+fabric" = _on5GT1qh;
        "pkg-1.1.24+1.21.1+neoforge" = _5sIPA1To;
        "default" = _5sIPA1To;
    });
