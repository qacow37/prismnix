...
let
    ...
    in {
        ...
        "pkg-babric-b1.7.3-1.0.0" = _e9W0wsO6;
        "pkg-fabric-1.21.4-1.0.0" = _LKryysne;
        "pkg-neoforge-1.21.4-1.0.0" = _Ti9cpWRD;
        "pkg-fabric-1.20.6-1.0.0" = _GS3TGL8i;
        "pkg-neoforge-1.20.6-1.0.0" = _IiJGebid;
        "pkg-fabric-1.20.4-1.0.0" = _3M7uAf05;
        "pkg-neoforge-1.20.4-1.0.0" = _5If5QJLa;
        "pkg-forge-1.20.4-1.0.0" = _EMdZttUt;
        "pkg-fabric-1.19.x-1.0.0" = _JI9LBQkm;
        "pkg-forge-1.19.x-1.0.0" = _gCl2bupK;
        "pkg-fabric-1.18.x-1.0.0" = _xWzwQfco;
        "pkg-forge-1.18.x-1.0.0" = _4n2J0GXE;
        "pkg-fabric-1.20.1-1.0.0" = _8YNy3a8m;
        "pkg-forge-1.20.1-1.0.0" = _QWk3wFbj;
        "pkg-fabric-1.21.6-1.0.0" = _NSCewte6;
        "pkg-neoforge-1.21.6-1.0.0" = _TIYw4U22;
        "pkg-fabric-1.21.7-1.0.0" = _dvGHsAJ7;
        "pkg-neoforge-1.21.7-1.0.0" = _I3R8h5cx;
        "pkg-fabric-1.21.8-1.0.0" = _sjYBA8l1;
        "pkg-neoforge-1.21.8-1.0.0" = _bPb6BEuS;
        "pkg-fabric-1.21.9-1.0.0" = _awqw4fNs;
        "pkg-neoforge-1.21.9-1.0.0" = _daS978Zb;
        "pkg-fabric-1.21.10-1.0.0" = _Gfqra6t8;
        "pkg-neoforge-1.21.10-1.0.0" = _UkGnQY0h;
        "pkg-fabric-1.21.11-1.0.0" = _biJLv3Vb;
        "pkg-neoforge-1.21.11-1.0.0" = _GW2YX76Y;
        "pkg-fabric-26.1.2-1.0.0" = _5y7Y8lKb;
