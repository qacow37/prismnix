...
let
    ...
    in {
        ...
        "pkg-mc1.16.5-0.0.1" = _n9eNLSEk;
        "pkg-mc1.16.5-0.0.2" = _1J2B1Zuu;
        "pkg-mc1.16.5-0.0.3" = _1Sxd3Dfx;
        "pkg-mc1.18.2-0.0.1" = _vrHGjzxo;
        "pkg-mc1.19.2-0.0.1" = _t8sUqMLe;
        "pkg-mc1.19.3-0.0.2" = _aRSpYiR7;
        "pkg-mc1.18.2-0.0.3" = _LPxDOi8w;
        "pkg-mc1.19.2-0.0.3" = _zLfmsKLf;
        "pkg-mc1.19.3-0.0.3" = _rH0YBt3K;
        "pkg-mc1.19.4-0.0.3" = _GzMJm5um;
        "pkg-mc1.18.2-0.0.4" = _JXNyz1Wl;
        "pkg-mc1.19.2-0.0.4" = _1QChLfwp;
        "pkg-mc1.19.3-0.0.4" = _bLcs8Z7e;
        "pkg-mc1.18.2-0.0.5" = _dEvrMNvh;
        "pkg-mc1.19.2-0.0.5" = _KJQxrQ3n;
        "pkg-mc1.19.3-0.0.5" = _LWJBVlnH;
        "pkg-mc1.19.4-0.0.5" = _1xzyttiP;
        "pkg-mc1.20.1-0.0.5" = _UJWLNJQn;
        "pkg-mc1.20.2-0.0.5" = _wNTr73ad;
        "pkg-mc1.18.2-0.0.6" = _4I61BMnf;
        "pkg-mc1.19.2-0.0.6" = _77sEBTsM;
        "pkg-mc1.19.3-0.0.6" = _xBR7ZHSi;
        "pkg-mc1.19.4-0.0.6" = _6oGzB9tY;
        "pkg-mc1.20.1-0.0.6" = _PhVgkHZ2;
        "pkg-mc1.20.2-0.0.6" = _YbITUhgt;
        "pkg-mc1.18.2-0.0.7" = _lyz9Dbhn;
        "pkg-mc1.18.2-0.0.8" = _jxFMUwfP;
        "pkg-mc1.19.2-0.0.7" = _Gjr8oTTw;
        "pkg-mc1.19.3-0.0.7" = _gexWPcDF;
        "pkg-mc1.19.4-0.0.7" = _ir0yKJaP;
        "pkg-mc1.20.1-0.0.7" = _LAASiLy4;
        "pkg-mc1.20.2-0.0.7" = _FKQRS1Zp;
        "pkg-mc1.19.2-0.0.8" = _GT9MG5ip;
        "pkg-mc1.20.1-0.0.8" = _WiNuI1hm;
        "pkg-0.0.9" = _zC86dN9S;
        "pkg-mc1.18.2-0.0.10" = _4LIvgKPS;
        "pkg-mc1.19.2-0.0.9" = _yBB0OtQl;
        "pkg-mc1.20.1-0.0.9" = _Vr88cy5P;
        "pkg-mc1.18.2-0.1.0" = _fkmmC5hv;
        "pkg-mc1.19.2-0.0.10" = _v5bx8X5F;
        "pkg-mc1.20.1-0.0.10" = _qYyTACUm;
        "pkg-mc1.18.2-0.1.1" = _Qy0SuAGb;
        "pkg-mc1.19.2-0.1.0" = _NeSyTWDU;
        "pkg-mc1.20.1-0.1.0" = _lGTKnZaj;
        "pkg-mc1.19.2-0.1.1" = _tS2CQfsV;
        "pkg-mc1.18.2-0.1.2" = _DMMxcfqC;
        "pkg-mc1.20.1-0.1.1" = _iyv9qOW4;
        "pkg-mc1.18.2-0.1.3" = _4pUIeiDI;
        "pkg-mc1.19.2-0.1.2" = _x6rsjDkq;
        "pkg-mc1.20.1-0.1.2" = _k6rz9xn2;
        "pkg-mc1.18.2-0.1.4" = _nlGrC8bG;
        "pkg-mc1.19.2-0.1.3" = _xNIsLaWp;
        "pkg-mc1.20.1-0.1.3" = _Yx85DYaG;
        "pkg-mc1.20.4-0.1.3" = _HgUSGUf8;
        "pkg-mc1.18.2-0.1.5" = _2HM7nHoH;
        "pkg-0.1.4" = _np1EcSVx;
        "pkg-mc1.20.6-0.1.3" = _XWdOuO9Z;
        "pkg-mc1.21.1-0.1.5" = _V5lIEjKs;
        "default" = _V5lIEjKs;
    });
