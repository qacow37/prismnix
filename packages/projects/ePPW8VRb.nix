...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.17.1" = _wFjN30hs;
        "pkg-1.0.1+1.17.1" = _8WTdHn4I;
        "pkg-1.0.2+1.16.5" = _PrhSppZM;
        "pkg-1.0.2+1.17.1" = _qXjvrJHV;
        "pkg-1.0.2+1.15.2" = _7Rx8RMjS;
        "pkg-1.0.3-1.17.1" = _VsViEDHA;
        "pkg-1.0.3-1.16.5" = _iDrweFAW;
        "pkg-1.0.3-1.15.2" = _s0inW8Le;
        "pkg-1.1.0-1.17.1" = _EfYSLtdQ;
        "pkg-v1.1.1-1.17.1" = _YtWWxojt;
        "pkg-1.1.1-1.18" = _JIbxVTkM;
        "pkg-1.1.1-1.16" = _R9ViZyOJ;
        "pkg-1.1.1-1.15" = _sAJXCWaL;
        "pkg-v1.2.0-1.18" = _66uVzAUt;
        "pkg-v1.2.0-1.17" = _AARgMt6I;
        "pkg-v1.2.0-1.16" = _4aphYNiu;
        "pkg-v1.2.1-1.18" = _tx2Pl01P;
        "pkg-v1.2.1-1.17" = _WBoxnU17;
        "pkg-v1.2.1-1.16" = _GswkFTiD;
        "pkg-v1.2.1-1.15" = _LGG9sG2i;
        "pkg-1.3.0-1.18.2" = _8MJPysR1;
        "pkg-v1.4.0-1.19" = _EhQHoTuR;
        "pkg-1.4.0-1.20.2" = _nDgBlpfS;
        "pkg-1.4.1-1.20.2" = _fk6BV41B;
        "default" = _fk6BV41B;
    });
