...
let
    ...
    in {
        ...
        "pkg-1.20.1-fabric-0.0.4a" = _ZYpypYGE;
        "pkg-1.20.1-forge-0.0.4a" = _EZcrmJJp;
        "pkg-1.18.2-fabric-0.0.4a" = _E7nkhrBj;
        "pkg-1.18.2-forge-0.0.4a" = _9wK76lUB;
        "pkg-1.20.1-forge-0.0.4b" = _C441wsKH;
        "pkg-1.20.1-fabric-0.0.4b" = _TTLRqxjJ;
        "pkg-1.20.1-forge-0.0.4c" = _ZEIYmz4S;
        "pkg-1.18.2-forge-0.0.4c" = _GjHUcmII;
        "pkg-1.20.1-fabric-0.0.4c" = _v9V3OqeW;
        "pkg-1.18.2-fabric-0.0.4c" = _GHKpNV7U;
        "pkg-1.20.1-forge-0.0.4d" = _GPBCir7j;
        "pkg-1.18.2-forge-0.0.4d" = _eAsjF8zQ;
        "pkg-1.20.1-fabric-0.0.4d" = _cBeNc8wS;
        "pkg-1.18.2-fabric-0.0.4d" = _QRIV0Qvo;
        "pkg-1.20.1-forge-0.0.4e" = _IMkMSPAZ;
        "pkg-1.18.2-forge-0.0.4e" = _55mqEyn4;
        "pkg-1.20.1-fabric-0.0.4e" = _vF8BL5Y5;
        "pkg-1.18.2-fabric-0.0.4e" = _wQuyPmY9;
        "pkg-1.18.2-fabric-0.0.5b" = _z8eQxlE1;
        "pkg-1.18.2-forge-0.0.5b" = _4sdJmg31;
        "pkg-1.20.1-fabric-0.0.5b" = _PUKVXCmY;
        "pkg-1.20.1-forge-0.0.5b" = _OBLoJggU;
        "pkg-1.18.2-fabric-0.0.5c" = _WwCdUMCk;
        "pkg-1.20.1-fabric-0.0.5c" = _Wwb7KKtN;
        "pkg-1.20.1-forge-0.0.5c" = _lxihQit1;
        "pkg-1.18.2-forge-0.0.5c" = _XArPvcVx;
        "pkg-1.18.2-fabric-0.0.6" = _z0qGrwPp;
        "pkg-1.18.2-forge-0.0.6" = _i4NZpez1;
        "pkg-1.20.1-fabric-0.0.6" = _ePI5AUsR;
        "pkg-1.20.1-forge-0.0.6" = _twryoQvU;
        "pkg-1.18.2-fabric-0.0.6a" = _7lYFa3Kk;
        "pkg-1.18.2-forge-0.0.6a" = _tUxQAItk;
        "pkg-1.20.1-fabric-0.0.6a" = _BJiJxlwO;
        "pkg-1.20.1-forge-0.0.6a" = _N104S1Ow;
        "pkg-1.18.2-forge-0.0.6b" = _NGELmjSx;
        "pkg-1.18.2-fabric-0.0.6b" = _gdtTJBzA;
        "pkg-1.20.1-forge-0.0.6b" = _uHXjdS7C;
        "pkg-1.20.1-fabric-0.0.6b" = _wT5jPPko;
        "pkg-1.18.2-fabric-0.0.6c" = _MR2MFPCi;
        "pkg-1.18.2-forge-0.0.6c" = _ZHDZeTvN;
        "pkg-1.20.1-forge-0.0.6c" = _C5tetcIW;
        "pkg-1.20.1-fabric-0.0.6c" = _gMK4jNRe;
        "pkg-1.20.1-fabric-0.0.6d" = _JOzHd856;
        "pkg-1.20.1-forge-0.0.6d" = _2J7Q81V6;
        "pkg-1.18.2-forge-0.0.6d" = _JzXgjWBA;
        "pkg-1.18.2-fabric-0.0.6d" = _s9LKboZt;
        "pkg-1.20.1-forge-0.0.6e" = _gtOSkLBE;
        "pkg-1.20.1-fabric-0.0.6e" = _cwI0qrVf;
        "pkg-1.18.2-forge-0.0.6e" = _pEBAj2qb;
        "pkg-1.18.2-fabric-0.0.6e" = _l0Q2bC6k;
        "pkg-1.20.1-0.0.6f" = _P5g7XRyV;
        "pkg-1.18.2-0.0.6f" = _81ZLtboH;
        "pkg-1.20.1-0.0.7" = _X02JKJ7A;
        "pkg-1.20.1-0.0.7a" = _A5nfnvPQ;
        "pkg-1.20.1-0.0.8" = _ENGAdAqw;
        "pkg-1.20.1-0.0.9" = _dkzHx5y3;
        "pkg-1.20.1-0.0.10" = _a7n43YYk;
        "default" = _a7n43YYk;
    });
