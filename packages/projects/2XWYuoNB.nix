...
let
    ...
    in {
        ...
        "pkg-0.1.0+mc1.20.1" = _TLY7p1CO;
        "pkg-0.2.0+mc1.20.1" = _9uHN6bOe;
        "pkg-0.2.0+mc1.20.6" = _h9Uq6osp;
        "pkg-0.2.0+mc1.21" = _SPgFADeE;
        "pkg-0.2.0+mc1.21.1" = _T6MUSR7P;
        "pkg-0.2.0+mc24w39a" = _b3gsLpzu;
        "pkg-0.2.1+mc1.21.1" = _NAtuG21F;
        "pkg-0.2.1+mc1.21" = _pDQFZB5r;
        "pkg-0.2.1+mc24w40a" = _10EkBeX8;
        "pkg-0.2.2+mc1.21" = _bCRDIPxn;
        "pkg-0.2.2+mc1.21.1" = _Q5gW6vkq;
        "pkg-0.2.2+mc1.20.6" = _oaSUxw2w;
        "pkg-0.2.2+mc1.20.1" = _syjbSKIF;
        "pkg-0.2.2+mc1.21.2-pre1" = _AoOqZvv2;
        "pkg-0.2.2+mc1.21.2-pre2" = _Jlfdr1Yj;
        "pkg-0.2.2+mc1.21.2-pre3" = _p1TGz9sg;
        "pkg-0.2.2+mc1.21.2-pre4" = _ucWzYE0y;
        "pkg-0.2.2+mc1.21.2-pre5" = _TvlO1skg;
        "pkg-0.2.2+mc1.21.2-rc1" = _D2em82ft;
        "pkg-0.2.2+mc1.21.2-rc2" = _NDGAOWUn;
        "pkg-0.2.2-beta.1+mc1.21.2" = _zRGxYisH;
        "pkg-0.2.2+mc24w44a" = _DWGmisGu;
        "pkg-0.2.2+mc1.21.3" = _g3nV7mmP;
        "pkg-0.2.2+mc1.21.2" = _DnZnNUfv;
        "pkg-0.2.2+mc24w45a" = _4xKXyhXW;
        "pkg-0.2.2+mc24w46a" = _D1nCgEzc;
        "pkg-0.2.2+mc1.21.4-pre1" = _G0CS7UE1;
        "pkg-0.2.2+mc1.21.4-pre2" = _ESVrWoll;
        "pkg-0.2.2+mc1.21.4-pre3" = _cK0x2Uw1;
        "pkg-0.2.2+mc1.21.4-rc1" = _X48d0CBb;
        "pkg-0.2.2+mc1.21.4-rc2" = _9QEC5vph;
        "pkg-0.2.2+mc1.21.4-rc3" = _WyEGYbTI;
        "pkg-0.2.2+mc1.21.4" = _APX03sGj;
        "pkg-0.2.2+mc25w02a" = _6WEHRHhC;
        "pkg-0.2.2+mc25w03a" = _Ls17QADJ;
        "pkg-0.2.2+mc25w04a" = _WzpEkkx7;
        "pkg-0.2.2+mc25w05a" = _nOcu0oRx;
        "pkg-0.2.2+mc25w06a" = _6yJXbbG1;
        "pkg-0.2.2+mc25w07a" = _fsVVLdxP;
        "pkg-0.2.2+mc25w09a" = _ydV5auma;
        "pkg-0.2.2+mc1.21.5" = _snOZpb1a;
        "pkg-0.2.2+mc25w14craftine" = _nY95wbOc;
        "pkg-0.2.2+mc25w15a" = _ahuWZMR6;
        "pkg-0.2.2+mc25w16a" = _gAm1VnWF;
        "pkg-0.2.2+mc25w17a" = _au54JTV4;
        "pkg-0.2.2+mc25w18a" = _vAGnOtng;
        "pkg-0.2.3+mc1.21.2" = _5U8sicOU;
        "pkg-0.2.3+mc1.21.3" = _kwp7IugW;
        "pkg-0.2.3+mc1.21.5" = _WcJLWuW4;
        "pkg-0.2.3+mc1.21.4" = _SEP0zRlv;
        "pkg-0.2.2+mc25w19a" = _p6sBSEKh;
        "pkg-0.2.3+mc25w14craftmine" = _orrO4nue;
        "pkg-0.2.3+mc25w21a" = _191HQmzt;
        "pkg-0.2.3+mc25w20a" = _YsQ52NtW;
        "pkg-0.2.3+mc1.21.6-pre1" = _BfgkSEh0;
        "pkg-0.2.3+mc1.21.6-pre2" = _Rf7uB5fV;
        "pkg-0.2.3+mc1.21.6-pre3" = _A10DIDR2;
        "pkg-0.2.3+mc1.21.6-pre4" = _R871tY05;
        "pkg-0.2.3+mc1.21.6-rc1" = _ufnY3Tr0;
        "pkg-0.2.3+mc1.21.6" = _BVLuYE2b;
        "pkg-0.2.3+mc1.21.7-rc1" = _OdtfxXan;
        "pkg-0.2.3+mc1.21.7-rc2" = _gawqc68A;
        "pkg-0.2.3+mc1.21.7" = _t1yeRkjW;
        "pkg-0.2.3+mc1.21.8-rc1" = _QTRiWQJ5;
        "pkg-0.2.3+mc1.21.8" = _pjymsjfN;
        "pkg-0.2.3+mc25w31a" = _krR8YKIm;
        "pkg-0.2.3+mc25w32a" = _a9vw4Oro;
        "pkg-0.2.3+mc25w33a" = _Prca7mLt;
        "pkg-0.2.3+mc25w34a" = _ofd6jgV2;
        "pkg-0.2.3+mc25w34b" = _ZzpaIysU;
        "pkg-0.2.3+mc25w35a" = _MwNoVnoc;
        "pkg-0.2.3+mc25w36a" = _636CW4rQ;
        "pkg-0.2.3+mc25w36b" = _lXvuBMGr;
        "pkg-0.2.4+mc1.21.9" = _Hj3675TY;
        "pkg-0.2.4+mc1.21.10" = _VfcK0zRt;
        "pkg-0.2.4+mc1.21.11" = _OVDrhAKr;
        "pkg-0.2.5+mc1.21.11" = _nEQowW7V;
        "pkg-0.2.6+mc1.21.11" = _TQlnQZAP;
        "pkg-0.2.6+mc26.1-snapshot-1" = _DbNpNWqK;
        "pkg-0.2.6+mc26.1-snapshot-2" = _fWtCIxXj;
        "pkg-0.2.6+mc26.1-snapshot-3" = _LDVadsfh;
        "pkg-0.2.6+mc26.1-snapshot-4" = _spyFeWV2;
        "pkg-0.2.6+mc26.1-snapshot-5" = _LRHu3kXZ;
        "pkg-0.2.6+mc26.1-snapshot-6" = _q0SFtFmV;
        "default" = _q0SFtFmV;
    });
