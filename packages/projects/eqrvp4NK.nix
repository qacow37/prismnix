...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _fYrWNskj;
        "pkg-1.0.1" = _EAfAeGYI;
        "pkg-1.18.2-1.0.2" = _QL9THJ3j;
        "pkg-1.20.1-1.0.2" = _MN677FpX;
        "pkg-1.0.2" = _yyhFL48V;
        "pkg-1.0.3" = _Jg9to5CW;
        "pkg-1.1.3" = _p7fL2EXJ;
        "pkg-1.2.3" = _rffDkYxV;
        ...
        "pkg-2.8.4" = _p1YNhrBD;
        "pkg-2.8.5" = _4dlfF8le;
        "pkg-mc1.20.1-2.8.6-forge" = _n4rHMOCo;
        "pkg-mc1.20.1-2.8.6-fabric" = _IsGZzDrX;
        "pkg-2.8.6-mc1.20.1-forge" = _PLIaSak7;
        "pkg-2.8.6-mc1.20.1-fabric" = _7TfUFp0l;
        "pkg-2.8.7-mc1.20.1-forge" = _HyUHcTgL;
        "pkg-2.8.7-mc1.20.1-fabric" = _rYld40dY;
        "pkg-2.8.8-mc1.20.1-forge" = _vFnHvfLE;
        "pkg-2.8.8-mc1.20.1-fabric" = _cJvX14xX;
        "pkg-2.9.8-mc1.20.1-forge" = _8dWw9IYP;
        "pkg-2.9.8-mc1.20.1-fabric" = _ZgG0CB7K;
        "pkg-2.9.9-mc1.20.1-fabric" = _TKKbSJOc;
        "pkg-2.9.9-mc1.20.1-forge" = _2vfDSz09;
        "pkg-2.9.10-mc1.20.1-forge" = _Rgkr9o3v;
        "pkg-2.9.10-mc1.20.1-fabric" = _sxRQNUtz;
        "pkg-3.0.0+mc1.21.1-neoforge" = _j5dNBmw1;
        "pkg-3.1.0+mc1.21.1-neoforge" = _csFh2t3L;
        "pkg-3.2.0+mc1.21.1-neoforge" = _jJzxn8mv;
        "pkg-3.3.0+mc1.21.1-neoforge" = _WKUoB0vk;
        "pkg-3.3.0+mc1.20.1-forge" = _DlJyVnqw;
        "pkg-3.3.1+mc1.20.1-forge" = _qOkx1hND;
        "pkg-3.3.2+mc1.20.1-forge" = _iM1n6QxA;
        "pkg-3.3.2+mc1.21.1-neoforge" = _Wl3H8uKl;
        "pkg-2.9.11-mc1.20.1-fabric" = _PhOLS9Et;
        "pkg-3.3.3+mc1.20.1-forge" = _roObsdUd;
        "pkg-3.3.3+mc1.21.1-neoforge" = _deMSPb6a;
        "pkg-3.3.4+mc1.21.1-neoforge" = _4CC2H9nf;
        "pkg-3.3.4+mc1.20.1-forge" = _mdHwnGmU;
        "pkg-3.3.5+mc1.21.1-neoforge" = _1xpoTgEz;
        "pkg-3.3.5+mc1.20.1-forge" = _ayr3EWKa;
        "pkg-3.4.0+mc1.20.1-forge" = _amaEujOs;
        "pkg-3.4.0+mc1.21.1-neoforge" = _I5p7liFU;
        "pkg-3.4.1+mc1.21.1-neoforge" = _Mgp5DPJO;
        "pkg-3.4.1+mc1.20.1-forge" = _hHW0Bm2r;
        "pkg-3.4.2+mc1.21.1-neoforge" = _Y7KuofME;
        "pkg-3.4.3+mc1.21.1-neoforge" = _Um84kCGW;
        "pkg-3.4.3+mc1.20.1-forge" = _HM6wtOMY;
        "pkg-3.5.0+mc1.21.1-neoforge" = _X9PM77mx;
        "pkg-3.5.0+mc1.20.1-forge" = _Fn9RZ8h2;
        "pkg-3.6.0+mc1.21.1-neoforge" = _Cw5k6c0a;
        "pkg-3.6.0+mc1.20.1-forge" = _xfc5brGW;
        "default" = _xfc5brGW;
    });
