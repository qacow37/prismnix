...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0-fabric+forge+neo" = _GsVkDQwC;
        "pkg-1.19.2-1.1-fabric+forge+neo" = _duJIEMqR;
        "pkg-1.20.1-1.1-fabric+forge+neo" = _6L6DKWZJ;
        "pkg-1.20.2-1.1-fabric+forge+neo" = _LA3q7QFy;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _CWk71MVT;
        "pkg-1.19.2-1.2-fabric+forge+neo" = _zuBVYKd0;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _8HDOSJgP;
        "pkg-1.20.2-1.2-fabric+forge+neo" = _o7rq83qq;
        "pkg-1.20.4-1.2-fabric+forge+neo" = _MlSVvPFg;
        "pkg-1.20.5-1.2-fabric+neo" = _9FtCJdvy;
        "pkg-1.20.6-1.2-fabric+forge+neo" = _Q8aXPDIV;
        "pkg-1.21.0-1.2-fabric+forge+neo" = _Hf6VIFUA;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _xCODJyNc;
        "pkg-1.20.6-1.3-fabric+forge+neo" = _42Mpp24E;
        "pkg-1.21.0-1.3-fabric+forge+neo" = _C6r6DkOo;
        "pkg-1.21.1-1.3-fabric+forge+neo" = _PBWeN39J;
        "pkg-1.21.2-1.3-fabric+neo" = _4LP7YklC;
        "pkg-1.21.3-1.3-fabric+forge+neo" = _E7Z49NpR;
        "pkg-1.21.4-1.3-fabric+forge+neo" = _XWeFR4OA;
        "pkg-1.21.5-1.3-fabric+forge+neo" = _gWeVEbLn;
        "pkg-1.21.6-1.3-fabric+forge+neo" = _If50Gy70;
        "pkg-1.21.7-1.3-fabric+forge+neo" = _H4FC3UYv;
        "pkg-1.21.8-1.3-fabric+forge+neo" = _T1Be86YM;
        "pkg-1.21.9-1.3-fabric+forge+neo" = _nelNYiUI;
        "pkg-1.21.10-1.3-fabric+forge+neo" = _OUQfpxro;
        "pkg-1.21.11-1.3-fabric+forge+neo" = _TXrIpdNs;
        "pkg-26.1.0-1.3-fabric+forge+neo" = _xJe1sWBm;
