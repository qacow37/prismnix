...
let
    ...
    in {
        ...
        "pkg-1.2.1-1.18.2" = _TAkT4AW3;
        "pkg-1.2.1-1.19.2" = _l2eApVjG;
        "pkg-1.2.1-1.20.1" = _BjTw5ziF;
        "pkg-1.2.1-1.20.4" = _6pPVAWil;
        "pkg-1.2.1-1.21.1" = _A39SGZna;
        "pkg-1.2.1-1.21.4" = _5owYImdx;
        "pkg-1.2.1-1.21.5" = _kSsX5iE4;
        "pkg-1.2.1-1.21.7" = _TNsQHF1T;
        "pkg-1.2.1-1.21.8" = _VQjPfvFw;
        "pkg-1.2.1-1.21" = _4nE54TI0;
        "pkg-1.2.2-1.18.2" = _GaHrc8J3;
        "pkg-1.2.2-1.19.2" = _PpnvkWnz;
        "pkg-1.2.2-1.20.1" = _27M8bwdH;
        "pkg-1.2.2-1.20.4" = _pV9ArbJS;
        "pkg-1.2.2-1.21.1" = _3ydwnjkI;
        "pkg-1.2.2-1.21.4" = _SHoQRLEr;
        "pkg-1.2.2-1.21.5" = _na8VVrO6;
        "pkg-1.2.2-1.21.7" = _C0NwbIYe;
        "pkg-1.2.2-1.21.8" = _uTbZ0RVg;
        "pkg-1.2.2-1.21" = _oqz3dvqf;
        "pkg-1.2.2+mc1.20.1-forge" = _T9AWRnpj;
        "pkg-1.2.2-1.20.1-forge" = _ySodGiOk;
        "pkg-1.2.2-1.18.2-forge" = _WRAuUd2f;
        "pkg-1.2.2-1.19.2-forge" = _spSpetrt;
        "pkg-1.2.2-1.20.4-forge" = _tX2QOQHk;
        "pkg-1.2.2-1.21.9" = _xgGJCfGc;
        "pkg-1.2.2-1.21.10" = _GtpxRGGm;
        "pkg-1.2.2-1.21.11" = _8F9h2Fxa;
        "pkg-2.0.0-alpha.1+1.20.1+fabric" = _NsUPVZwN;
        "pkg-2.0.0-alpha.2+1.20.1+fabric" = _L2vm954Z;
        "pkg-2.0.0-alpha.3+1.20.1+fabric" = _atIGy9mf;
        "pkg-2.0.0-alpha.4+1.20.1+fabric" = _7xH0CNk6;
        "pkg-2.0.0-alpha.5+1.20.1+fabric" = _PhWTN0Em;
        "pkg-2.0.0-alpha.6+1.20.1+fabric" = _w0FMxId6;
        "pkg-2.0.0-alpha.7+1.20.1+fabric" = _XID2wPj6;
        "pkg-2.0.0-alpha.8+1.20.1+fabric" = _oMjAZjDc;
        "pkg-2.0.0-alpha.8+1.20.1+forge" = _UfPcI767;
        "pkg-2.0.0-alpha.9+1.20.1+fabric" = _WXROJOZ9;
        "pkg-2.0.0-alpha.9+1.20.1+forge" = _cURRSJTy;
        "pkg-2.0.0-alpha.10+1.20.1+fabric" = _NnVfcjFy;
        "pkg-2.0.0-alpha.10+1.20.1+forge" = _awe0VpIP;
        "pkg-2.0.0-alpha.11+1.20.1+fabric" = _IGIZyNVD;
        "pkg-2.0.0-alpha.12+1.20.1+fabric" = _swbXfxeJ;
        "pkg-2.0.0-alpha.12+1.20.1+forge" = _fvPPYcQl;
        "pkg-2.0.0-alpha.13+1.20.1+fabric" = _kyQn3YzW;
        "pkg-2.0.0-alpha.13+1.20.1+forge" = _weja6XXV;
        "pkg-2.0.0-alpha.14+1.20.1+forge" = _s7cv3pQv;
        "pkg-2.0.0-alpha.14+1.20.1+fabric" = _wetgozCb;
        "pkg-2.0.0-alpha.14+26.1+fabric" = _9h5wPG34;
        "pkg-2.0.0-alpha.14+26.2+fabric" = _oGjRnH82;
        "pkg-2.0.0-alpha.14+1.21.1+fabric" = _1a9XoTmA;
        "pkg-2.0.0-alpha.14+1.21.1+neoforge" = _X20v4wAf;
        "pkg-2.0.0-alpha.14+26.1.2+fabric" = _L33QbL5I;
        "pkg-2.0.0-alpha.15+1.21.1+neoforge" = _uKoZskdr;
        "default" = _uKoZskdr;
    });
