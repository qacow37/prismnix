...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.0-fabric" = _Gt89yv3M;
        "pkg-1.18.2-1.0-fabric" = _177jUkPo;
        "pkg-1.19.2-1.0-fabric" = _mFMm99WT;
        "pkg-1.16.5-1.0-forge" = _gklzgy0B;
        "pkg-1.18.2-1.0-forge" = _9o9gINzu;
        "pkg-1.19.2-1.0-forge" = _PUIU0bzO;
        "pkg-1.16.5-1.1-fabric" = _N7l5q60z;
        "pkg-1.18.2-1.1-fabric" = _e0ZNKD84;
        "pkg-1.19.2-1.1-fabric" = _SHWg52mP;
        "pkg-1.16.5-1.1-forge" = _kSXEhXi3;
        "pkg-1.18.2-1.1-forge" = _Opd2uHL2;
        "pkg-1.19.2-1.1-forge" = _2FMpiMGO;
        "pkg-1.16.5-1.2-fabric" = _msO5v19x;
        "pkg-1.18.2-1.2-fabric" = _CJ153N1y;
        "pkg-1.19.2-1.2-fabric" = _on2RLYoF;
        "pkg-1.19.3-1.3-fabric" = _AwutReNC;
        "pkg-1.19.3-1.1-forge" = _5tXyT240;
        "pkg-1.18.2-2.0-forge+fabric" = _gkD3IRkE;
        "pkg-1.19.2-2.0-forge+fabric" = _wl6Qb8HJ;
        "pkg-1.19.3-2.0-forge+fabric" = _21C9vKvl;
        "pkg-1.18.2-2.1-forge+fabric" = _soFHIwmV;
        "pkg-1.19.2-2.1-forge+fabric" = _eW1N3kb2;
        "pkg-1.19.3-2.1-forge+fabric" = _gYZjPD8V;
        "pkg-1.19.4-2.1-forge+fabric" = _l5lgw9b3;
        "pkg-1.20-2.1-forge+fabric" = _q5HA0Y1V;
        "pkg-1.20.1-2.1-forge+fabric" = _l1myJRfM;
        "pkg-1.20.2-2.1-forge+fabric" = _Wq2JzbCv;
        "pkg-1.18.2-2.3-forge+fabric" = _B5VJgwIH;
        "pkg-1.19.2-2.3-forge+fabric" = _YZCQFH18;
        "pkg-1.20.1-2.3-forge+fabric" = _AmB1qHga;
        "pkg-1.20.2-2.3-forge+fabric" = _nFNnBMLh;
        "pkg-1.20.3-2.3-fabric+forge+neo" = _bD4dplAm;
        "pkg-1.20.4-2.3-fabric+forge+neo" = _ucO9rcWG;
        "pkg-1.19.2-2.4-fabric+forge+neo" = _G82Q4jHK;
        "pkg-1.20.1-2.4-fabric+forge+neo" = _NRBPNk3c;
        "pkg-1.20.2-2.4-fabric+forge+neo" = _eY4wHKnq;
        "pkg-1.20.4-2.4-fabric+forge+neo" = _v59Pgh0m;
        "pkg-1.20.5-2.4-fabric+neo" = _rSXUazDC;
        "pkg-1.20.6-2.4-fabric+forge+neo" = _6qHoduVZ;
        "pkg-1.21.0-2.4-fabric+forge+neo" = _Q4CtPg1n;
        "pkg-1.21.0-2.5-fabric+forge+neo" = _4iw6zpzF;
        "pkg-1.20.1-2.6-fabric+forge+neo" = _lJh7sUcy;
        "pkg-1.20.6-2.6-fabric+forge+neo" = _sDkbapgp;
        "pkg-1.21.0-2.6-fabric+forge+neo" = _cU3sf6tk;
        "pkg-1.21.1-2.6-fabric+forge+neo" = _ezouZBrl;
        "pkg-1.21.2-2.6-fabric+neo" = _GJymeF1w;
        "pkg-1.21.3-2.6-fabric+forge+neo" = _sf08aj7w;
        "pkg-1.21.4-2.6-fabric+forge+neo" = _s48s1B03;
        "pkg-1.20.1-2.7-fabric+forge+neo" = _Ega2NXxF;
        "pkg-1.21.1-2.7-fabric+forge+neo" = _dwxmxHzf;
        "pkg-1.21.4-2.7-fabric+forge+neo" = _ZQXVM2vF;
        "pkg-1.21.5-2.7-fabric+forge+neo" = _nPBiXKK4;
        "pkg-1.21.6-2.7-fabric+forge+neo" = _lmqZfa9B;
        "pkg-1.21.7-2.7-fabric+forge+neo" = _YanOzWbg;
        "pkg-1.21.8-2.7-fabric+forge+neo" = _Iyo0Uc3H;
        "pkg-1.21.9-2.7-fabric+forge+neo" = _APYzT1Oy;
        "pkg-1.21.10-2.7-fabric+forge+neo" = _67EGwDs6;
        "pkg-1.21.11-2.7-fabric+forge+neo" = _BxoH6we9;
        "pkg-26.1.0-2.7-fabric+forge+neo" = _zgrsNX5P;
        "pkg-26.1.0-2.8-fabric+forge+neo" = _MVYIdLWN;
        "pkg-26.1.1-2.8-fabric+forge+neo" = _4swMstdI;
        "pkg-26.1.2-2.8-fabric+forge+neo" = _GsVqyAo0;
        "pkg-26.2.0-2.8-fabric+forge+neo" = _a1fp0l19;
        "default" = _a1fp0l19;
    });
