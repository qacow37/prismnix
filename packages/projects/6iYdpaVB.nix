...
let
    ...
    in {
        ...
        "pkg-1.21" = _PBezWfUZ;
        "pkg-1.21+mod" = _Ud23ugFR;
        "pkg-1.21.1" = _psyIT0PR;
        "pkg-1.21.1+mod" = _9zQqlP8N;
        "pkg-1.21.2" = _Ig1jnveT;
        "pkg-1.21.2+mod" = _9yeWeRqv;
        "pkg-1.21.3" = _TbRyVPAp;
        "pkg-1.21.3+mod" = _xFlERV5k;
        "pkg-1.21.4" = _XEpMGbiD;
        "pkg-1.21.4+mod" = _wuSJ2mTJ;
        "pkg-1.21.5" = _4PXfPdjX;
        "pkg-1.21.5+mod" = _BsLBxR1a;
        "pkg-1.21.6" = _SnVZdmfk;
        "pkg-1.21.6+mod" = _1TtebZr2;
        "pkg-1.21.7" = _QDKB0Vvo;
        "pkg-1.21.7+mod" = _AFT56ALf;
        "pkg-1.21.8" = _uNkXqBsf;
        "pkg-1.21.8+mod" = _rnYi70M8;
        "pkg-1.21.9" = _l1twOMv2;
        "pkg-1.21.9+mod" = _IiDCpDiV;
        "pkg-1.21-Plus" = _ihWhjOxs;
        "pkg-1.21-Plus+mod" = _9FrH0iqH;
        "default" = _9FrH0iqH;
    });
