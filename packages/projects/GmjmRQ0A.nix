...
let
    ...
    in {
        ...
        "pkg-1.1.3" = _pRwBOCJc;
        "pkg-2.0.3" = _gCGCFJis;
        "pkg-2.1.0-fabric" = _hPDyRNw3;
        "pkg-2.1.0-forge" = _lrslRK8c;
        "pkg-2.1.1-fabric" = _fGG0Gjcv;
        "pkg-2.1.2-fabric" = _mG1fIOia;
        "pkg-2.1.3-fabric" = _akAH2F1g;
        "pkg-2.1.1-forge" = _89gCgL8n;
        "pkg-2.2.0" = _U9GIWHMX;
        "pkg-1.2.0" = _LfIs9gRN;
        "pkg-1.2.1" = _PmCarZvQ;
        "pkg-2.1.4" = _BZLiJ13y;
        ...
        "pkg-4.2.2" = _DwseRoo3;
        "pkg-3.6.0" = _YT0NEd3Q;
        "pkg-3.4.1-fabric" = _ANaMdnDG;
        "pkg-4.2.3" = _ifiWEND8;
        "pkg-4.2.4" = _tyVnEa75;
        "pkg-3.5.0-fabric" = _Xo9cblAc;
        "pkg-3.5.1-fabric" = _aCgj5ey0;
        "pkg-3.5.2-fabric" = _g0GPaHDq;
        "pkg-4.3.0" = _Xx2KJlUq;
        "pkg-4.3.1" = _ieLfP0rx;
        "pkg-4.3.2" = _cV2GZBSJ;
        "pkg-4.3.3" = _N67LJgrN;
