...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.11" = _ResXy6pG;
        "pkg-1.0.1+1.21.11" = _yMbYX9vc;
        "pkg-1.0.2+1.21.11" = _N2F6gmNm;
        "pkg-1.0.3+1.21.1" = _3tNdIJq3;
        "pkg-1.0.4+1.21.11" = _3EFbiUsN;
        "pkg-1.0.5+1.21.1" = _kF8FmzLQ;
        "pkg-1.0.6+1.21.11" = _xrfwOfpW;
        "pkg-1.0.7+1.20.1" = _pM9BkIhZ;
        "pkg-1.0.8+1.20.1" = _6isdKiMV;
        "pkg-1.0.9+1.21.1" = _TR6raF9W;
        "pkg-1.0.10+1.21.11" = _N4ofK99S;
        "pkg-1.1.0+1.20.1" = _oAOAkdKk;
        "pkg-1.1.1+1.20.1" = _hBR8LxOK;
        "pkg-1.1.2+1.21.1" = _L6KCp2Xo;
        "pkg-1.1.3+1.21.11" = _4lvMwZ8B;
        "pkg-1.1.4+1.21.1" = _iRkfnXKF;
        "pkg-1.1.5+1.21.11" = _mks79XYP;
        "pkg-1.1.6+1.20.1" = _EBNXCcs8;
        "pkg-1.1.7+1.20.1" = _U4ZmyhgR;
        "pkg-1.1.8+1.20.1" = _w3AEAY27;
        "pkg-1.1.9+1.21.1" = _LN9y72np;
        "pkg-1.1.10+1.21.1" = _l8YEjgEU;
        "pkg-1.1.11+1.21.1" = _ZUU0J7TV;
        "pkg-1.1.12+1.21.11" = _E8pIciED;
        "pkg-1.1.13+1.21.11" = _bIRj4tpd;
        "pkg-1.1.14+1.21.1" = _R2oa8Rdn;
        "pkg-1.1.15+1.20.1" = _PCZn1kz3;
        "default" = _PCZn1kz3;
    });
