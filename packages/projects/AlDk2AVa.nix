...
let
    ...
    in {
        ...
        "pkg-rv9-h" = _MRr8l7u2;
        "pkg-rv9-i" = _bAoYvIen;
        "pkg-rv10-a" = _cdwo4P57;
        "pkg-rv10-b" = _k6Dej02e;
        "pkg-rv10-c" = _XiWOYxHD;
        "pkg-rv10-d" = _xT28HxKq;
        "pkg-rv10-e" = _wG81v9OJ;
        "pkg-rv10-f" = _ba2Sm3CW;
        "pkg-rv10-g" = _C08ojJsn;
        "pkg-rv10-h" = _kECjH6Ui;
        "pkg-rv10-i" = _udk8TtKk;
        "pkg-rv10-k" = _vn85ZIRt;
        "pkg-rv10-l" = _mWmpsySL;
        "pkg-rv10-m" = _wBz51rMe;
        "pkg-rv10-n" = _bSIwd8Ui;
        "pkg-rv11-a" = _cpYt72qd;
        "pkg-rv11-b" = _a0auscn3;
        "pkg-rv11-c" = _AyOUglYx;
        "pkg-rv11-d" = _HhNSQzTi;
        "pkg-rv11-e" = _YExfTqjj;
        "pkg-rv12-a" = _sVZSZWkk;
        "pkg-rv12-b" = _JovdD90C;
        "pkg-rv13-a" = _bU08Zuxi;
        "pkg-rv13-b" = _iULmxHtv;
        "pkg-rv13-c" = _6DFwRzYC;
        "pkg-rv13-c-dev5" = _2SDp2Ryk;
        "pkg-rv14-alpha13" = _DWJHPImf;
        "pkg-rv14-dev2" = _swgaH2Ir;
        "pkg-rv14-finale" = _OoSrNqVw;
        "pkg-rv14-finale2" = _owXSwDZS;
        "pkg-rv14-finale3" = _patE6mCG;
        "default" = _patE6mCG;
    });
