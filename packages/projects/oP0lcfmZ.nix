...
let
    ...
    in {
        ...
        "pkg-1.0-1.18.2" = _6Tg9KtHD;
        "pkg-1.1-1.18.2" = _4VRH6SCq;
        "pkg-1.1.0-1.18.2" = _e6kvSJWN;
        "pkg-1.5.0-1.18.2" = _C3wj5IIN;
        "pkg-1.7.0-1.18.2" = _wth4WQtR;
        "pkg-1.9.0-1.18.2" = _7dzEGQkC;
        "default" = _7dzEGQkC;
    });
