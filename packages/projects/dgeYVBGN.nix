...
let
    ...
    in {
        ...
        "pkg-1.20.1-0.0.1" = _FJmEDm1w;
        "pkg-1.20.1-0.0.2" = _HpzapnxA;
        "pkg-1.20.1-0.0.3" = _HQF1TvGR;
        "pkg-1.20.1-0.0.4" = _BV0By7aK;
        "pkg-1.20.2-0.0.4" = _mkI6Gal2;
        "pkg-1.20.3-0.0.4" = _P2f2yQBf;
        "pkg-1.20.1-0.0.5" = _YB4RN3rF;
        "pkg-1.20.2-0.0.5" = _T6OGmOWj;
        "pkg-1.20.3-0.0.5" = _npgcIVN3;
        "pkg-1.20.4-0.0.5" = _WKLiq050;
        "pkg-1.20.4-0.0.6" = _aefCl1OX;
        "pkg-1.20.1-0.0.6" = _kB5uSBSe;
        "pkg-1.20.2-0.0.6" = _ITYm5SkN;
        "pkg-1.20.3-0.0.6" = _7JgTDLry;
        "pkg-1.20.4-0.0.7" = _Xg2CmQ4e;
        "pkg-1.20.1-0.1.0" = _LcBIhv86;
        "pkg-1.20.2-0.1.0" = _b5hgNxNw;
        "pkg-1.20.3-0.1.0" = _B0o6vbn1;
        "pkg-1.20.4-0.1.0" = _RMxKFN2N;
        "pkg-1.20.1-0.2.0" = _JjeTEGdn;
        "pkg-1.20.2-0.2.0" = _hfNGPchG;
        "pkg-1.20.3-0.2.0" = _b2dYhVyS;
        "pkg-1.20.4-0.2.0" = _vIuaZVIu;
        "pkg-1.20.1-0.3.0" = _2nVT8Y4H;
        "pkg-1.20.2-0.3.0" = _NHDt1DFL;
        "pkg-1.20.3-0.3.0" = _Ql1u9oT1;
        "pkg-1.20.4-0.3.0" = _c2BCekwT;
        "pkg-1.20.4-0.3.1" = _GVUCmt9Z;
        "pkg-1.20.5-0.3.0" = _NTdTiSiZ;
        "pkg-1.20.6-0.3.0" = _MbBc475M;
        "pkg-1.20.1-0.3.1" = _V7WSpmvE;
        "pkg-1.20.2-0.3.1" = _81ib5kmw;
        "pkg-1.20.4-0.3.2" = _YrDqh25f;
        "pkg-1.20.3-0.3.1" = _jRCZZxdf;
        "pkg-1.20.5-0.3.1" = _qPt94SxG;
        "pkg-1.20.6-0.3.1" = _GzMNKyEh;
        "pkg-1.20.1-0.3.2" = _BIXxJW8M;
        "pkg-1.20.2-0.3.2" = _oRE6O1JV;
        "pkg-1.20.4-0.3.3" = _lVeI6df2;
        "pkg-1.20.5-0.3.2" = _m3j0TINX;
        "pkg-1.20.6-0.3.2" = _RHj43NBi;
        "pkg-1.20.1-0.3.3" = _iGs9LoEz;
        "pkg-1.20.2-0.3.3" = _wmVfNnjB;
        "pkg-1.20.3-0.3.3" = _YdxfCruU;
        "pkg-1.20.4-0.3.4" = _xmV8hwnQ;
        "pkg-1.20.5-0.3.3" = _hiIAZ2mk;
        "pkg-1.20.6-0.3.3" = _oWbvLd4f;
        "pkg-1.20.1-0.4.0" = _Nd6RTZVK;
        "pkg-1.20.4-0.4.0" = _YWi22qo5;
        "pkg-1.20.6-0.4.0" = _U4Fyz1zX;
        "pkg-1.20.6-0.4.1" = _cemeDE3R;
        "pkg-1.21.0-0.4.1" = _Ha2cf00e;
        "pkg-1.20.1-0.4.2" = _wPWfJDaM;
        "pkg-1.21.0-0.4.3" = _BX2Ed0Vc;
        "pkg-1.21.0-0.4.4" = _yq8TrCfE;
        "pkg-1.20.1-0.4.5" = _dRGfiehl;
        "pkg-1.20.4-0.4.5" = _4o9tAdaT;
        "pkg-1.20.6-0.4.5" = _vmPFZoGq;
        "pkg-1.21.0-0.4.5" = _EM4Vp6E0;
        "pkg-1.21.0-0.4.6" = _1r9bJF8s;
        "pkg-1.20.1-0.5.0" = _kP6t9cvB;
        "pkg-1.20.4-0.5.0" = _brhw56aI;
        "pkg-1.20.6-0.5.0" = _7EbYYgd1;
        "pkg-1.21.0-0.5.0" = _rBLsW5ZL;
        "pkg-1.21.0-0.5.1" = _hbBYKx2q;
        "pkg-1.21.1-0.5.1" = _qF9TRsQ3;
        "pkg-1.20.1-0.6.0" = _PtwK8fcF;
        "pkg-1.20.4-0.6.0" = _IgRmBslV;
        "pkg-1.21.0-0.6.0" = _LS57twBL;
        "pkg-1.21.1-0.6.0" = _NVkfeMr0;
        "pkg-1.20.1-0.6.1" = _1FrHeKZX;
        "pkg-1.20.4-0.6.1" = _ZO0b9T4A;
        "pkg-1.21.0-0.6.1" = _sH00HCzm;
        "pkg-1.21.1-0.6.1" = _Ljd3tLmU;
        "pkg-1.20.1-0.7.0" = _YRuIxL65;
        "pkg-1.20.4-0.7.0" = _8FQVrfn8;
        "pkg-1.21.1-0.7.0" = _jNR2Ul64;
        "pkg-1.20.1-0.7.1" = _6rmQldOM;
        "pkg-1.20.4-0.7.1" = _JlEtawMo;
        "pkg-1.21.1-0.7.1" = _kNkUVzyv;
        "pkg-1.20.1-0.8.0" = _Ew3b9hT9;
        "pkg-1.20.4-0.8.0" = _RWHoInaQ;
        "pkg-1.21.1-0.8.0" = _6nkCKvH1;
        "pkg-1.21.1-0.8.1" = _Gldc0Rhr;
        "pkg-1.20.1-0.9.0" = _8wigDwNU;
        "pkg-1.20.4-0.9.0" = _jGucthKf;
        "pkg-1.21.1-0.9.0" = _i2Osyjhf;
        "pkg-1.20.1-0.9.1" = _PWMw7J9Z;
        "pkg-1.20.4-0.9.1" = _wCXemube;
        "pkg-1.21.1-0.9.1" = _pb3W8Rzr;
        "pkg-1.20.1-0.9.2" = _Yy4xiQcu;
        "pkg-1.20.4-0.9.2" = _VPQ2YGTp;
        "pkg-1.21.1-0.9.2" = _ztw5BM6F;
        "pkg-1.21.3-0.9.2" = _rxOg7gh2;
        "pkg-1.20.1-0.10.0" = _nMQcYtpT;
        "pkg-1.21.1-0.10.0" = _Zk9e6AyN;
        "pkg-1.21.3-0.10.0" = _iUhHfjKe;
        "pkg-1.20.1-0.10.1" = _asOeYlsD;
        "pkg-1.21.1-0.10.1" = _W21dVIDp;
        "pkg-1.21.3-0.10.1" = _aFJHSZo1;
        "pkg-1.20.1-0.10.2" = _1v90jyCd;
        "pkg-1.21.1-0.10.2" = _UfhyN6i3;
        "pkg-1.21.3-0.10.2" = _RljC7dih;
        "pkg-1.20.1-0.10.3" = _XBsF75ke;
        "pkg-1.21.1-0.10.3" = _Exys2mmE;
        "pkg-1.21.3-0.10.3" = _LZQZxmOD;
        "pkg-1.21.1-0.10.4" = _xKrwbu3g;
        "pkg-1.21.1-0.10.5" = _iAfo2fNE;
        "pkg-1.20.1-0.10.6" = _Xe3jOMyD;
        "pkg-1.21.1-0.10.6" = _LvIierSw;
        "pkg-1.21.3-0.10.6" = _Rx1GfkJl;
        "pkg-1.20.1-0.10.7" = _CgqDqHfW;
        "pkg-1.21.1-0.10.7" = _hXjafJjr;
        "pkg-1.21.3-0.10.7" = _Uabvxjgr;
        "pkg-1.20.1-0.10.8" = _zLXf8kHm;
        "pkg-1.21.1-0.10.8" = _9f2PlKfu;
        "pkg-1.20.1-0.10.9" = _UkJV8EI2;
        "pkg-1.21.1-0.10.9" = _roGK7Cav;
        "pkg-1.21.1-0.10.10" = _IsZUbsOk;
        "pkg-1.20.1-0.10.11" = _fjI2FDBN;
        "pkg-1.21.1-0.10.11" = _nWqsBCTt;
        "pkg-1.20.1-0.10.12" = _KLIO0qwT;
        "pkg-1.21.1-0.10.12" = _bsDqFn6W;
        "pkg-1.20.1-0.10.13" = _fxYwS9Mv;
        "pkg-1.21.1-0.10.13" = _r4TzimX0;
        "default" = _r4TzimX0;
    });
