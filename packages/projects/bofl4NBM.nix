...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.21-1.21.1" = _vSTXcrgq;
        "pkg-1.1.2-1.21.2-1.21.4" = _PnZIWMKV;
        "pkg-1.1.3-1.21.5" = _2XlMTIPq;
        "pkg-1.1.3-1.21.6-1.21.8" = _LAEN22b2;
        "pkg-1.1.3-1.21.9-1.21.10" = _NFWSzR1v;
