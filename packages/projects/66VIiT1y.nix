...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19-Fabric" = _cbXECpBI;
        "pkg-v4.1.0-1.19.1-Forge" = _3IHtHIK2;
        "pkg-v4.1.0-1.19.1-Fabric" = _DCoOF40C;
        "pkg-v4.2.0-1.19.2-Forge" = _uuvhNgzJ;
        "pkg-v4.2.0-1.19.2-Fabric" = _39MqXGHf;
        "pkg-v5.0.0-1.19.3-Fabric" = _ff3VlcTv;
        "pkg-v5.0.0-1.19.3-Forge" = _iNwepgUM;
        "pkg-v6.0.0-1.19.4-Fabric" = _TewoBa6O;
        "pkg-v6.0.0-1.19.4-Forge" = _F9KGjYOA;
        "pkg-v7.0.0-1.20-Forge" = _spH6XVJA;
        "pkg-v7.0.0-1.20-Fabric" = _G61apRiY;
        "pkg-v8.0.0-1.20.1-Forge" = _Z3cIRwID;
        "pkg-v8.0.0-1.20.1-Fabric" = _ks4SLa3W;
        "pkg-v8.0.1-1.20.1-Forge" = _RHX4KX61;
        "pkg-v8.0.1-1.20.1-Fabric" = _aiTMkkNX;
        "pkg-v3.1.0-1.18.2-Forge" = _8NHFH2aI;
        "pkg-v3.1.0-1.18.2-Fabric" = _ALiUqHbw;
        "pkg-v20.4.0-1.20.4-Fabric" = _S8uWs4mz;
        "pkg-v20.4.0-1.20.4-Forge" = _WntNrr7O;
        "pkg-v20.4.0-1.20.4-NeoForge" = _KFnq8iCL;
        "pkg-v20.4.1-1.20.4-Fabric" = _9fPJPIwM;
        "pkg-v20.4.1-1.20.4-Forge" = _4mjTeqCR;
        "pkg-v20.4.1-1.20.4-NeoForge" = _j9NktjmH;
        "pkg-v20.4.2-1.20.4-Fabric" = _obJMGu87;
        "pkg-v20.4.2-1.20.4-Forge" = _aacItDPH;
        "pkg-v20.4.2-1.20.4-NeoForge" = _IoEv8x7w;
        "pkg-v21.0.0-1.21-Fabric" = _jy8WQLZG;
        "pkg-v21.0.0-1.21-NeoForge" = _X18P3NAh;
        "pkg-v21.1.0-1.21.1-Fabric" = _WdnxEvD1;
        "pkg-v21.1.0-1.21.1-NeoForge" = _5g9aZDW0;
        "pkg-v21.3.0-1.21.3-Fabric" = _Los5rSoU;
        "pkg-v21.3.0-1.21.3-NeoForge" = _xFWBxTEt;
        "pkg-v21.4.0-1.21.4-Fabric" = _1HZGxdvJ;
        "pkg-v21.4.0-1.21.4-NeoForge" = _Uwugne2m;
        "pkg-v21.5.0-1.21.5-Fabric" = _GH8L0F0t;
        "pkg-v21.5.0-1.21.5-NeoForge" = _ZnECr1VX;
        "pkg-v21.6.0-1.21.6-Fabric" = _rLOzYuDP;
        "pkg-v21.6.0-1.21.6-NeoForge" = _LhcsrAfk;
        "pkg-v21.7.0-1.21.7-Fabric" = _rcPNwLCn;
        "pkg-v21.7.0-1.21.7-NeoForge" = _mDrmwUTX;
        "pkg-v21.8.0-1.21.8-Fabric" = _f3iGqvaL;
        "pkg-v21.8.0-1.21.8-NeoForge" = _KIsXKCJ6;
        "pkg-v21.8.1-1.21.8-Fabric" = _JzP6huYe;
        "pkg-v21.8.1-1.21.8-NeoForge" = _W7EyUIlx;
        "pkg-v21.8.2-1.21.8-Fabric" = _CmCesQNd;
        "pkg-v21.8.2-1.21.8-NeoForge" = _Q9xGNE0C;
        "pkg-21.9.0" = _YkgL1d4p;
        "pkg-21.10.0" = _Z2x18kcm;
