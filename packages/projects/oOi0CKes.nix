...
let
    ...
    in {
        ...
        "pkg-v3.0.0-1.18.2-Forge" = _Mxo3pLpK;
        "pkg-v4.0.0-1.19.2-Fabric" = _iOYIhbPz;
        "pkg-v4.0.0-1.19.2-Forge" = _a3oOIh2I;
        "pkg-v3.0.1-1.18.2-Fabric" = _PNNiwKv0;
        "pkg-v3.0.1-1.18.2-Forge" = _El0IKW8s;
        "pkg-v4.0.1-1.19.2-Fabric" = _eCBmFNMp;
        "pkg-v4.0.1-1.19.2-Forge" = _jbr5sXbb;
        "pkg-v3.0.2-1.18.2-Fabric" = _VRhbw7lq;
        "pkg-v3.0.2-1.18.2-Forge" = _mZfzmsao;
        "pkg-v4.0.2-1.19.2-Fabric" = _C4r1tHVS;
        "pkg-v4.0.2-1.19.2-Forge" = _RB86wqXd;
        "pkg-v8.0.1-1.20.1-Forge" = _FyRULqoH;
        "pkg-v8.0.1-1.20.1-Fabric" = _nUGLw5Jj;
        "pkg-v8.1.0-1.20.1-Forge" = _mCtLk4GN;
        "pkg-v8.1.0-1.20.1-Fabric" = _oKMD8Fop;
        "pkg-v8.1.1-1.20.1-Forge" = _FZAyTpxT;
        "pkg-v8.1.1-1.20.1-Fabric" = _dKRUlf2v;
        "pkg-v8.1.2-1.20.1-Forge" = _r2RINfqW;
        "pkg-v8.1.2-1.20.1-Fabric" = _jtLdyrOM;
        "pkg-v8.1.3-1.20.1-Forge" = _Wd7wQeV6;
        "pkg-v8.1.3-1.20.1-Fabric" = _xKu8mur6;
        "pkg-v20.4.0-1.20.4-Fabric" = _Mi7pBdtt;
        "pkg-v20.4.0-1.20.4-Forge" = _MbM70vzG;
        "pkg-v20.4.0-1.20.4-NeoForge" = _KAxhdCzG;
        "pkg-v8.1.4-1.20.1-Forge" = _nf44AqzV;
        "pkg-v8.1.4-1.20.1-Fabric" = _hrygyCMp;
        "pkg-v20.4.1-1.20.4-Fabric" = _1p2S1mYf;
        "pkg-v20.4.1-1.20.4-Forge" = _j6hCDPnY;
        "pkg-v20.4.1-1.20.4-NeoForge" = _D3Majojm;
        "pkg-v21.0.0-1.21-Fabric" = _XNADaGeh;
        "pkg-v21.0.0-1.21-NeoForge" = _tojstCyI;
        "pkg-v21.1.0-1.21.1-Fabric" = _PXKwbbFF;
        "pkg-v21.1.0-1.21.1-NeoForge" = _3zZVTQDG;
        "pkg-v8.1.5-1.20.1-Forge" = _IpxUHCn0;
        "pkg-v8.1.5-1.20.1-Fabric" = _mwIl45jn;
        "pkg-v21.1.1-1.21.1-Fabric" = _8Kb6Dcsd;
        "pkg-v21.1.1-1.21.1-NeoForge" = _IwUmOLxe;
        "pkg-v21.3.0-1.21.3-Fabric" = _CK7R1Ufc;
        "pkg-v21.3.0-1.21.3-NeoForge" = _uWXGa1zU;
        "pkg-v21.4.0-1.21.4-Fabric" = _h1KHbeVR;
        "pkg-v21.4.0-1.21.4-NeoForge" = _lkYS60uX;
        "pkg-v21.5.0-1.21.5-Fabric" = _bC9mdPkG;
        "pkg-v21.5.0-1.21.5-NeoForge" = _z9iGYAn6;
        "pkg-v21.6.0-1.21.6-Fabric" = _lJx4HGqX;
        "pkg-v21.6.0-1.21.6-NeoForge" = _Q0wKX40s;
        "pkg-v21.7.0-1.21.7-Fabric" = _CBJB9C7N;
        "pkg-v21.7.0-1.21.7-NeoForge" = _gwASbQfK;
        "pkg-v21.8.0-1.21.8-Fabric" = _2JIyTlsY;
        "pkg-v21.8.0-1.21.8-NeoForge" = _oZis8LbN;
        "pkg-v21.8.1-1.21.8-Fabric" = _MjzdDq4a;
        "pkg-v21.8.1-1.21.8-NeoForge" = _DkVZgxqY;
        "pkg-21.9.0" = _bv62D0Tk;
        "pkg-21.10.0" = _4LfQGJnU;
        "pkg-21.11.0" = _ehAnzhlX;
