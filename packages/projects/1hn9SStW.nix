...
let
    ...
    in {
        ...
        "pkg-Forge-1.18.2-1.0.3" = _i4wQ6eUi;
        "pkg-Fabric-1.18.2-1.0.3" = _vbnhnR44;
        "pkg-Fabric-22w14a-1.0.3" = _JNagjvFL;
        "pkg-Forge-1.18-1.0.3" = _hPegMzfu;
        "pkg-Forge-1.19-1.0.3" = _GnObiKG5;
        "pkg-Forge-1.16.5-1.0.3" = _dhxO933w;
        "pkg-Fabric-1.16.5-1.0.3" = _rS1WsOBk;
        "pkg-Forge-1.17.1-1.0.3" = _DhCatTA7;
        "pkg-Fabric-1.17.1-1.0.3" = _fm6GajhU;
        "pkg-Forge-1.16.5-1.1.0" = _ljJwHynH;
        "pkg-Fabric-1.16.5-1.1.0" = _ldBuPxnA;
        "pkg-Forge-1.17.1-1.1.0" = _PvwpNaKs;
        "pkg-Fabric-1.17.1-1.1.0" = _6AjGdafk;
        "pkg-Forge-1.18.2-1.1.0" = _47Irsq6W;
        "pkg-Fabric-1.18.2-1.1.0" = _EABVD9q8;
        "pkg-Forge-1.19.2-1.1.0" = _oYlt2cKc;
        "pkg-Fabric-1.19.2-1.1.0" = _9vUvOTvr;
        "pkg-Fabric-1.19.3-1.1.0" = _Zzizh0if;
        "pkg-Forge-1.16.5-1.1.1" = _CKVJqfrK;
        "pkg-Fabric-1.16.5-1.1.1" = _bXVo8smh;
        "pkg-Forge-1.17.1-1.1.1" = _mdcrZgmO;
        "pkg-Fabric-1.17.1-1.1.1" = _n8YHmnIw;
        "pkg-Forge-1.18.2-1.1.1" = _KuRN3O3J;
        "pkg-Fabric-1.18.2-1.1.1" = _TE0oBtYa;
        "pkg-Forge-1.19.3-1.1.1" = _rHBlwyMz;
        "pkg-Fabric-1.19.3-1.1.1" = _m4n6Ck8q;
        "pkg-Forge-1.16.5-1.1.2" = _wQfk5QNS;
        "pkg-Fabric-1.16.5-1.1.2" = _FMva8zWK;
        "pkg-Forge-1.17.1-1.1.2" = _eZTZCtYU;
        "pkg-Fabric-1.17.1-1.1.2" = _CdPeQPnP;
        "pkg-Forge-1.18.2-1.1.2" = _PBBW8lPo;
        "pkg-Fabric-1.18.2-1.1.2" = _wj7VdExW;
        "pkg-Forge-1.19.2-1.1.2" = _zOArqPsq;
        "pkg-Fabric-1.19.2-1.1.2" = _nNkXBRj9;
        "pkg-Forge-1.19.3-1.1.2" = _s0GEF2x3;
        "pkg-Fabric-1.19.3-1.1.2" = _Y9Np3zIn;
        "pkg-Forge-1.19.4-1.1.2" = _WJHxd9eW;
        "pkg-Fabric-1.19.4-1.1.2" = _UCZo2tCl;
        "pkg-Forge-1.16.5-1.1.3" = _B9gnYPQm;
        "pkg-Fabric-1.16.5-1.1.3" = _Cs1HO5Yw;
        "pkg-Forge-1.17.1-1.1.3" = _IToTWXqm;
        "pkg-Fabric-1.17.1-1.1.3" = _Q96Xvu2S;
        "pkg-Forge-1.18.2-1.1.3" = _Qs41Gk84;
        "pkg-Fabric-1.18.2-1.1.3" = _MEEiCyEF;
        "pkg-Forge-1.19.2-1.1.3" = _QH8bGfpP;
        "pkg-Fabric-1.19.2-1.1.3" = _jAfW0aIU;
        "pkg-Forge-1.19.3-1.1.3" = _fJoThqAH;
        "pkg-Fabric-1.19.3-1.1.3" = _R3y4jfls;
        "pkg-Forge-1.19.4-1.1.3" = _yXuyN3fd;
        "pkg-Fabric-1.19.4-1.1.3" = _JB02SDHN;
        "pkg-Fabric-23w12a-1.1.3" = _mQwkOTpR;
        "pkg-Forge-1.16.5-1.2.0" = _45nnFTqV;
        "pkg-Fabric-1.16.5-1.2.0" = _vfpw5DhD;
        "pkg-Forge-1.17.1-1.2.0" = _maNS0x9R;
        "pkg-Fabric-1.17.1-1.2.0" = _NOJLlGba;
        "pkg-Forge-1.18.2-1.2.0" = _goZKcMcA;
        "pkg-Fabric-1.18.2-1.2.0" = _rt15cn6I;
        "pkg-Forge-1.19.2-1.2.0" = _bDioROS9;
        "pkg-Fabric-1.19.2-1.2.0" = _kIlEIFJf;
        "pkg-Forge-1.19.3-1.2.0" = _d6Pv8ULU;
        "pkg-Fabric-1.19.3-1.2.0" = _GRAnig00;
        "pkg-Forge-1.19.4-1.2.0" = _PNgcesAJ;
        "pkg-Fabric-1.19.4-1.2.0" = _wBOiUH22;
        "pkg-Fabric-23w18a-1.2.0" = _nfRlti5d;
        "pkg-Fabric-1.20-pre1-1.2.0" = _Arpqs9JY;
        "pkg-Fabric-1.20-pre4-1.2.0" = _5AtSIAXQ;
        "pkg-Forge-1.20-1.2.0" = _th2urs1z;
        "pkg-Forge-1.16.5-1.3.0" = _1efYHy6R;
        "pkg-Fabric-1.16.5-1.3.0" = _F8f7s9ra;
        "pkg-Forge-1.17.1-1.3.0" = _946dcJT0;
        "pkg-Fabric-1.17.1-1.3.0" = _qtVJA6Et;
        "pkg-Forge-1.18.2-1.3.0" = _iKWrNrkV;
        "pkg-Fabric-1.18.2-1.3.0" = _TocZD3k2;
        "pkg-Forge-1.19.2-1.3.0" = _rUvrNvQU;
        "pkg-Fabric-1.19.2-1.3.0" = _Epjk4FlV;
        "pkg-Forge-1.19.3-1.3.0" = _3wRXMmgk;
        "pkg-Fabric-1.19.3-1.3.0" = _IcrEtTfw;
        "pkg-Forge-1.19.4-1.3.0" = _j1dItGtB;
        "pkg-Fabric-1.19.4-1.3.0" = _r0j4N6eR;
        "pkg-Forge-1.20.2-1.3.0" = _h398b4np;
        "pkg-Fabric-1.20.2-1.3.0" = _aDy9p1o7;
        "pkg-Forge-1.20.4-1.3.0" = _pWR49Vvt;
        "pkg-Fabric-1.20.4-1.3.0" = _vbdfLBm6;
        "pkg-Fabric-23w51b-1.3.0" = _zD02cJsA;
        "pkg-Forge-1.16.5-1.4.0" = _tS8euRBH;
        "pkg-Fabric-1.16.5-1.4.0" = _nLIM1ezC;
        "pkg-Forge-1.17.1-1.4.0" = _Vu1JQupu;
        "pkg-Fabric-1.17.1-1.4.0" = _DbwmvBDE;
        "pkg-Forge-1.18.2-1.4.0" = _cGczuRX2;
        "pkg-Fabric-1.18.2-1.4.0" = _MK412r6b;
        "pkg-Forge-1.19.2-1.4.0" = _DMzFCqHQ;
        "pkg-Fabric-1.19.2-1.4.0" = _i0zzAiCh;
        "pkg-Forge-1.19.3-1.4.0" = _pEgvoAPO;
        "pkg-Fabric-1.19.3-1.4.0" = _HZLqSyZf;
        "pkg-Forge-1.19.4-1.4.0" = _1odj8uaI;
        "pkg-Fabric-1.19.4-1.4.0" = _a9C6p5Js;
        "pkg-Forge-1.20.1-1.4.0" = _RCSWN0qQ;
        "pkg-Fabric-1.20.1-1.4.0" = _D2qO5vqW;
        "pkg-Forge-1.20.2-1.4.0" = _SRHlaoOI;
        "pkg-Fabric-1.20.2-1.4.0" = _qmkNGcCR;
        "pkg-NeoForge-1.20.3-1.4.0" = _5ooRTSa5;
        "pkg-Forge-1.20.4-1.4.0" = _3MqtnEl8;
        "pkg-NeoForge-1.20.4-1.4.0" = _1xHNfTcu;
        "pkg-Fabric-1.20.4-1.4.0" = _N64WBHJe;
        "pkg-Forge-1.20.6-1.4.0" = _LFegO4xq;
        "pkg-NeoForge-1.20.6-1.4.0" = _iXiPLaqt;
        "pkg-Fabric-1.20.6-1.4.0" = _6hxwyBOJ;
        "pkg-Forge-1.21.1-1.4.0" = _dUpDG1RE;
        "pkg-NeoForge-1.21.1-1.4.0" = _VboTQKPT;
        "pkg-Fabric-1.21.1-1.4.0" = _oX7fSQOM;
        "pkg-Forge-1.16.5-1.4.1" = _5lSzp4Xa;
        "pkg-Fabric-1.16.5-1.4.1" = _OprwfmN3;
        "pkg-Forge-1.17.1-1.4.1" = _6AyUo78m;
        "pkg-Fabric-1.17.1-1.4.1" = _7HxL8T1H;
        "pkg-Forge-1.18.2-1.4.1" = _tKG02Xhg;
        "pkg-Fabric-1.18.2-1.4.1" = _jdNwo1rI;
        "pkg-Forge-1.19.2-1.4.1" = _N690lRXK;
        "pkg-Fabric-1.19.2-1.4.1" = _uCZTtxgB;
        "pkg-Forge-1.19.3-1.4.1" = _HkbPKEmA;
        "pkg-Fabric-1.19.3-1.4.1" = _do4XFbSL;
        "pkg-Forge-1.19.4-1.4.1" = _PFDItSKK;
        "pkg-Fabric-1.19.4-1.4.1" = _RR6WkTe7;
        "pkg-Forge-1.20.1-1.4.1" = _Uw3dGykL;
        "pkg-Fabric-1.20.1-1.4.1" = _hnZQjFJ1;
        "pkg-Forge-1.20.2-1.4.1" = _NLAm2Pkc;
        "pkg-Fabric-1.20.2-1.4.1" = _IpWIhxcS;
        "pkg-NeoForge-1.20.3-11.4.1" = _i1A0EACe;
        "pkg-Forge-1.20.4-1.4.1" = _6IJCQeFe;
        "pkg-NeoForge-1.20.4-1.4.1" = _xJo32Dz1;
        "pkg-Fabric-1.20.4-1.4.1" = _PnZy3nsL;
        "pkg-Forge-1.20.6-1.4.1" = _l19y1RTS;
        "pkg-NeoForge-1.20.6-1.4.1" = _RnfbEAdf;
        "pkg-Fabric-1.20.6-1.4.1" = _DQ2cxzt4;
        "pkg-Forge-1.21.1-1.4.1" = _5TQQg1L9;
        "pkg-NeoForge-1.21.1-1.4.1" = _QpLcnNVH;
        "pkg-Fabric-1.21.1-1.4.1" = _OcljNFaE;
        "pkg-Forge-1.21.3-1.4.1" = _FUAEhLmI;
        "pkg-NeoForge-1.21.3-1.4.1" = _1kaYdj0Q;
        "pkg-Fabric-1.21.3-1.4.1" = _Bt5DBtZH;
        "pkg-Forge-1.21.5-1.4.1" = _iL2Lzznn;
        "pkg-NeoForge-1.21.5-1.4.1" = _PEJuIm03;
        "pkg-Fabric-1.21.5-1.4.1" = _tZtp0gbZ;
        "pkg-Forge-1.16.5-2.0.0" = _O5G3TnyV;
        "pkg-Fabric-1.16.5-2.0.0" = _XxNZFcGI;
        "pkg-Forge-1.17.1-2.0.0" = _dTWcKoXm;
        "pkg-Fabric-1.17.1-2.0.0" = _nO1g80oZ;
        "pkg-Forge-1.18.2-2.0.0" = _P84ERRB2;
        "pkg-Fabric-1.18.2-2.0.0" = _ZGxOQquy;
        "pkg-Forge-1.19.2-2.0.0" = _U2CqSjCB;
        "pkg-Fabric-1.19.2-2.0.0" = _VWFE3ISc;
        "pkg-Forge-1.19.3-2.0.0" = _dYcNR62r;
        "pkg-Fabric-1.19.3-2.0.0" = _c5z24RFr;
        "pkg-Forge-1.19.4-2.0.0" = _GAhUAeKV;
        "pkg-Fabric-1.19.4-2.0.0" = _q4YVV7Sd;
        "pkg-Forge-1.20.1-2.0.0" = _pDq6UPDa;
        "pkg-Fabric-1.20.1-2.0.0" = _QdTeebTv;
        "pkg-Forge-1.20.2-2.0.0" = _zeGGW61K;
        "pkg-Fabric-1.20.2-2.0.0" = _E4E5K8XR;
        "pkg-NeoForge-1.20.3-2.0.0" = _Lutne7g4;
        "pkg-Forge-1.20.4-2.0.0" = _jXlZOhrU;
        "pkg-NeoForge-1.20.4-2.0.0" = _cx6nxp92;
        "pkg-Fabric-1.20.4-2.0.0" = _d3s84oM5;
        "pkg-Forge-1.20.6-2.0.0" = _mHD060z2;
        "pkg-NeoForge-1.20.6-2.0.0" = _ecEfMQet;
        "pkg-Fabric-1.20.6-2.0.0" = _AtiImVMh;
        "pkg-Forge-1.21.1-2.0.0" = _8h0diR4k;
        "pkg-NeoForge-1.21.1-2.0.0" = _hU2NdPHs;
        "pkg-Fabric-1.21.1-2.0.0" = _UZZ2d57S;
        "pkg-Forge-1.21.4-2.0.0" = _KKdu6Jkt;
        "pkg-NeoForge-1.21.4-2.0.0" = _8ipWefU4;
        "pkg-Fabric-1.21.4-2.0.0" = _upsMWf8c;
        "pkg-Forge-1.21.5-2.0.0" = _6SdxXYs3;
        "pkg-NeoForge-1.21.5-2.0.0" = _QQlLQ8gq;
        "pkg-Fabric-1.21.5-2.0.0" = _lHvetiSJ;
        "pkg-Forge-1.16.5-2.0.1" = _x035VxnC;
        "pkg-Fabric-1.16.5-2.0.1" = _mgClC8tg;
        "pkg-Forge-1.17.1-2.0.1" = _HTv7Qii6;
        "pkg-Fabric-1.17.1-2.0.1" = _EjPmZ5gi;
        "pkg-Forge-1.18.2-2.0.1" = _JMVFVUpG;
        "pkg-Fabric-1.18.2-2.0.1" = _cXMZ0IDz;
        "pkg-Forge-1.19.2-2.0.1" = _RHpQ5AEL;
        "pkg-Fabric-1.19.2-2.0.1" = _aaS6twsU;
        "pkg-Forge-1.19.3-2.0.1" = _RT887b9C;
        "pkg-Fabric-1.19.3-2.0.1" = _kdMYSAdA;
        "pkg-Forge-1.19.4-2.0.1" = _tkD2C20z;
        "pkg-Fabric-1.19.4-2.0.1" = _BlKDRMaB;
        "pkg-Forge-1.20.1-2.0.1" = _odw4nKs5;
        "pkg-Fabric-1.20.1-2.0.1" = _gyRZ48g2;
        "pkg-Forge-1.20.2-2.0.1" = _iGev1gjQ;
        "pkg-Fabric-1.20.2-2.0.1" = _nXGOgvnF;
        "pkg-NeoForge-1.20.3-2.0.1" = _uM9C4iq8;
        "pkg-Forge-1.20.4-2.0.1" = _xwirIrLF;
        "pkg-NeoForge-1.20.4-2.0.1" = _hBCKTRqM;
        "pkg-Fabric-1.20.4-2.0.1" = _HmE9Miyl;
        "pkg-Forge-1.20.6-2.0.1" = _4I559zdB;
        "pkg-NeoForge-1.20.6-2.0.1" = _vN0C4oVY;
        "pkg-Fabric-1.20.6-2.0.1" = _rfsgpLtk;
        "pkg-Forge-1.21.1-2.0.1" = _OyJLVvao;
        "pkg-NeoForge-1.21.1-2.0.1" = _CUWn9qSX;
        "pkg-Fabric-1.21.1-2.0.1" = _orzxMnLI;
        "pkg-Forge-1.21.4-2.0.1" = _wub9W3ip;
        "pkg-NeoForge-1.21.4-2.0.1" = _yl77GuYF;
        "pkg-Fabric-1.21.4-2.0.1" = _BicisMzF;
        "pkg-Forge-1.21.5-2.0.1" = _j7UKOQlE;
        "pkg-NeoForge-1.21.5-2.0.1" = _s9CySCpw;
        "pkg-Fabric-1.21.5-2.0.1" = _7M3BUFgm;
        "pkg-Forge-1.16.5-2.1.0" = _D1or1XMk;
        "pkg-Fabric-1.16.5-2.1.0" = _zXiaEliX;
        "pkg-Forge-1.17.1-2.1.0" = _NJSY1FjT;
        "pkg-Fabric-1.17.1-2.1.0" = _Z8blxgbz;
        "pkg-Forge-1.18.2-2.1.0" = _5QxPLkIp;
        "pkg-Fabric-1.18.2-2.1.0" = _MKARNZh2;
        "pkg-Forge-1.19.2-2.1.0" = _MOzA6goR;
        "pkg-Fabric-1.19.2-2.1.0" = _cN7Dlznd;
        "pkg-Forge-1.19.3-2.1.0" = _59NersJ8;
        "pkg-Fabric-1.19.3-2.1.0" = _v0EWT9ng;
        "pkg-Forge-1.19.4-2.1.0" = _rsOZzYSC;
        "pkg-Fabric-1.19.4-2.1.0" = _lrNu31Xb;
        "pkg-Forge-1.20.1-2.1.0" = _15BWgxDz;
        "pkg-Fabric-1.20.1-2.1.0" = _4CXyzwTj;
        "pkg-Forge-1.20.2-2.1.0" = _QzE4W6Xn;
        "pkg-Fabric-1.20.2-2.1.0" = _DG3I70ns;
        "pkg-NeoForge-1.20.3-2.1.0" = _Hx8NTtje;
        "pkg-Forge-1.20.4-2.1.0" = _rDQ7GMSW;
        "pkg-NeoForge-1.20.4-2.1.0" = _XB1YmUhr;
        "pkg-Fabric-1.20.4-2.1.0" = _ndEqRqxo;
        "pkg-Forge-1.20.6-2.1.0" = _BC1QrQyU;
        "pkg-NeoForge-1.20.6-2.1.0" = _NXsWgIIi;
        "pkg-Fabric-1.20.6-2.1.0" = _EwmfkMep;
        "pkg-Forge-1.21.1-2.1.0" = _jNLd4yYA;
        "pkg-NeoForge-1.21.1-2.1.0" = _LZ27HUvl;
        "pkg-Fabric-1.21.1-2.1.0" = _mzJADQ3M;
        "pkg-Forge-1.21.4-2.1.0" = _OH0o5IcB;
        "pkg-NeoForge-1.21.4-2.1.0" = _MXOkQqXS;
        "pkg-Fabric-1.21.4-2.1.0" = _nQeBeO5l;
        "pkg-Forge-1.21.5-2.1.0" = _pLgszBvj;
        "pkg-NeoForge-1.21.5-2.1.0" = _ND9BUC04;
        "pkg-Fabric-1.21.5-2.1.0" = _ZyFmumbm;
        "pkg-Forge-1.21.7-2.1.0" = _w8rIY0qc;
        "pkg-NeoForge-1.21.7-2.1.0" = _26gBqb7h;
        "pkg-Fabric-1.21.7-2.1.0" = _WbBxQEYc;
        "pkg-Forge-1.16.5-2.1.1" = _hVTL2Tg5;
        "pkg-Fabric-1.16.5-2.1.1" = _B4zVhjNx;
        "pkg-Forge-1.17.1-2.1.1" = _3JSCNg7S;
        "pkg-Fabric-1.17.1-2.1.1" = _cyYCkuV2;
        "pkg-Forge-1.18.2-2.1.1" = _CfIVbPxJ;
        "pkg-Fabric-1.18.2-2.1.1" = _3EZlq30B;
        "pkg-Forge-1.19.2-2.1.1" = _SIWsFLP7;
        "pkg-Fabric-1.19.2-2.1.1" = _wr7V3p0M;
        "pkg-Forge-1.19.3-2.1.1" = _fDA9BiZU;
        "pkg-Fabric-1.19.3-2.1.1" = _YaoE5S2U;
        "pkg-Forge-1.19.4-2.1.1" = _nXJZxUiJ;
        "pkg-Fabric-1.19.4-2.1.1" = _vd10ST7x;
        "pkg-Forge-1.20.1-2.1.1" = _TZdmAYHl;
        "pkg-Fabric-1.20.1-2.1.1" = _UZBhxoPf;
        "pkg-Forge-1.20.2-2.1.1" = _ikKz2iNy;
        "pkg-Fabric-1.20.2-2.1.1" = _jdd4hnaD;
        "pkg-NeoForge-1.20.3-2.1.1" = _16nRZKyb;
        "pkg-Forge-1.20.4-2.1.1" = _e9AZfB7O;
        "pkg-NeoForge-1.20.4-2.1.1" = _ChVK1a2J;
        "pkg-Fabric-1.20.4-2.1.1" = _99tJcmzR;
        "pkg-Forge-1.20.6-2.1.1" = _BSKv9f3k;
        "pkg-NeoForge-1.20.6-2.1.1" = _oDKFXsOW;
        "pkg-Fabric-1.20.6-2.1.1" = _gl24C23M;
        "pkg-Forge-1.21.1-2.1.1" = _Lqfz1r2A;
        "pkg-NeoForge-1.21.1-2.1.1" = _8CKmVjO2;
        "pkg-Fabric-1.21.1-2.1.1" = _jFITYQ8H;
        "pkg-Forge-1.21.4-2.1.1" = _mIPtlaLz;
        "pkg-NeoForge-1.21.4-2.1.1" = _BdEpiqhf;
        "pkg-Fabric-1.21.4-2.1.1" = _2wdHSTtd;
        "pkg-Forge-1.21.5-2.1.1" = _GgM9OYH8;
        "pkg-NeoForge-1.21.5-2.1.1" = _daUmk48q;
        "pkg-Fabric-1.21.5-2.1.1" = _n3Q0yENX;
        "pkg-Forge-1.21.8-2.1.1" = _VzOLDtxm;
        "pkg-NeoForge-1.21.8-2.1.1" = _XrpoGAm3;
        "pkg-Fabric-1.21.8-2.1.1" = _toPdBJmj;
        "pkg-NeoForge-1.21.10-2.1.1" = _gGAi95v6;
        "pkg-Forge-1.16.5-3.0.0" = _583JWt8L;
        "pkg-Fabric-1.16.5-3.0.0" = _QQo3kgJq;
        "pkg-Forge-1.17.1-3.0.0" = _3YIc8Z4I;
        "pkg-Fabric-1.17.1-3.0.0" = _zysvz0Mz;
        "pkg-Forge-1.18.2-3.0.0" = _LogpX4Th;
        "pkg-Fabric-1.18.2-3.0.0" = _tMJ2bTOf;
        "pkg-Forge-1.19.2-3.0.0" = _9Ub0k5qm;
        "pkg-Fabric-1.19.2-3.0.0" = _Txd78lxS;
        "pkg-Forge-1.19.3-3.0.0" = _mCqKsTNg;
        "pkg-Fabric-1.19.3-3.0.0" = _LcCGnVrX;
        "pkg-Forge-1.19.4-3.0.0" = _uU3Pl8bL;
        "pkg-Fabric-1.19.4-3.0.0" = _IkBxqBsU;
        "pkg-Forge-1.20.1-3.0.0" = _yciaFhYg;
        "pkg-Fabric-1.20.1-3.0.0" = _kGvOvar3;
        "pkg-Forge-1.20.2-3.0.0" = _GjvIOmc2;
        "pkg-NeoForge-1.20.2-3.0.0" = _7NCf6WbV;
        "pkg-Fabric-1.20.2-3.0.0" = _O76pzDrO;
        "pkg-NeoForge-1.20.3-3.0.0" = _LLgKpxzI;
        "pkg-Forge-1.20.4-3.0.0" = _I7srrX8X;
        "pkg-NeoForge-1.20.4-3.0.0" = _DWRwi6v3;
        "pkg-Fabric-1.20.4-3.0.0" = _AUv5LP04;
        "pkg-Forge-1.20.6-3.0.0" = _Ky8XwKO0;
        "pkg-NeoForge-1.20.6-3.0.0" = _rL1gJcCB;
        "pkg-Fabric-1.20.6-3.0.0" = _dPw3MBa2;
        "pkg-Forge-1.21.1-3.0.0" = _tskb2Rqe;
        "pkg-NeoForge-1.21.1-3.0.0" = _6bYlZxdQ;
        "pkg-Fabric-1.21.1-3.0.0" = _RDh0pAJC;
        "pkg-Forge-1.21.4-3.0.0" = _97MuDJA9;
        "pkg-NeoForge-1.21.4-3.0.0" = _RS6q2Ojf;
        "pkg-Fabric-1.21.4-3.0.0" = _wHx5AD2m;
        "pkg-Forge-1.21.5-3.0.0" = _4huwUWKs;
        "pkg-NeoForge-1.21.5-3.0.0" = _V08OwMmP;
        "pkg-Fabric-1.21.5-3.0.0" = _oUh06rwB;
        "pkg-Forge-1.21.10-3.0.0" = _DzDZiPLj;
        "pkg-NeoForge-1.21.10-3.0.0" = _atBkUm0o;
        "pkg-Fabric-1.21.10-3.0.0" = _PWQUR0cf;
        "pkg-Forge-1.21.11-3.0.0" = _tHRPZb1m;
        "pkg-NeoForge-1.21.11-3.0.0" = _ILOTYFPI;
        "pkg-Fabric-1.21.11-3.0.0" = _G616FqEy;
        "pkg-Forge-1.17.1-3.0.1" = _zcKblFWs;
        "pkg-Forge-1.16.5-3.0.1" = _LXjjCTRi;
        "pkg-Forge-1.18.2-3.0.1" = _KwZxRP8X;
        "pkg-Fabric-1.17.1-3.0.1" = _AxTQ2yjT;
        "pkg-Fabric-1.18.2-3.0.1" = _ruZkGudO;
        "pkg-Fabric-1.19.3-3.0.1" = _HGPovk7X;
        "pkg-Forge-1.19.2-3.0.1" = _P88O4A5F;
        "pkg-Forge-1.19.3-3.0.1" = _yUpKzgFz;
        "pkg-Fabric-1.16.5-3.0.1" = _Apiexx11;
        "pkg-Fabric-1.19.4-3.0.1" = _iZ2jm0Av;
        "pkg-NeoForge-1.20.3-3.0.1" = _uwLEMlVH;
        "pkg-Forge-1.20.2-3.0.1" = _dCs4EHkd;
        "pkg-Forge-1.20.1-3.0.1" = _xjsgJjqZ;
        "pkg-Forge-1.19.4-3.0.1" = _KhqFggOu;
        "pkg-Forge-1.20.6-3.0.1" = _pklLdzQf;
        "pkg-NeoForge-1.20.6-3.0.1" = _huziQAXV;
        "pkg-NeoForge-1.20.2-3.0.1" = _24A31P7r;
        "pkg-Fabric-1.19.2-3.0.1" = _4jJwdUsb;
        "pkg-Forge-1.20.4-3.0.1" = _dilTuaI0;
        "pkg-Fabric-1.20.4-3.0.1" = _fj2kqVC9;
        "pkg-NeoForge-1.21.11-3.0.1" = _9dIlA72B;
        "pkg-Fabric-1.21.10-3.0.1" = _5u4CMaHV;
        "pkg-Forge-1.21.1-3.0.1" = _bGWFLZ54;
        "pkg-Forge-1.21.10-3.0.1" = _LkmeuZzU;
        "pkg-Fabric-1.20.2-3.0.1" = _kYWh3iYu;
        "pkg-NeoForge-1.21.10-3.0.1" = _etPNocZ0;
        "pkg-Fabric-1.20.1-3.0.1" = _khbiQNRR;
        "pkg-NeoForge-1.20.4-3.0.1" = _3kEXfke8;
        "pkg-NeoForge-1.21.1-3.0.1" = _MEGkLco2;
        "pkg-Fabric-1.21.4-3.0.1" = _H3ewHGAd;
        "pkg-NeoForge-1.21.3-3.0.1" = _NKy2JJ6H;
        "pkg-Forge-1.21.5-3.0.1" = _A1Xew97f;
        "pkg-Fabric-1.21.1-3.0.1" = _26aOTJHS;
        "pkg-Forge-1.21.4-3.0.1" = _NFJ3HIbm;
        "pkg-Forge-1.21.11-3.0.1" = _kVdDB4Xx;
        "pkg-Fabric-1.21.11-3.0.1" = _gds3rWvh;
        "pkg-NeoForge-1.21.5-3.0.1" = _uLKzbGAQ;
        "pkg-Fabric-1.21.5-3.0.1" = _2nmyhV8x;
        "pkg-Fabric-1.20.6-3.0.1" = _JHwzDEbE;
        "pkg-NeoForge-1.21.4-3.0.1" = _urVmj4oc;
        "pkg-NeoForge-26.1.1-3.0.1" = _i5tURu8T;
        "pkg-Fabric-26.1.1-3.0.1" = _4umTU7qF;
        "pkg-Forge-1.16.5-3.0.2" = _FobDt7bR;
        "pkg-Fabric-1.16.5-3.0.2" = _u2NxS3Nl;
        "pkg-Forge-1.17.1-3.0.2" = _25tX0aSO;
        "pkg-Forge-1.18.2-3.0.2" = _dsGrXO3z;
        "pkg-Fabric-1.17.1-3.0.2" = _YlP5eA8h;
        "pkg-Fabric-1.18.2-3.0.2" = _qMd8rwMu;
        "pkg-Forge-1.19.2-3.0.2" = _jVXrYPIl;
        "pkg-Fabric-1.19.2-3.0.2" = _Q03HGN9E;
        "pkg-Forge-1.19.3-3.0.2" = _zzDl2DtS;
        "pkg-Forge-1.19.4-3.0.2" = _cULPfYjP;
        "pkg-Fabric-1.19.3-3.0.2" = _wuIii6Dt;
        "pkg-Forge-1.20.1-3.0.2" = _gjNN02RP;
        "pkg-Fabric-1.20.1-3.0.2" = _olqW0jVM;
        "pkg-Fabric-1.19.4-3.0.2" = _wMhgmCLu;
        "pkg-Forge-1.20.2-3.0.2" = _ND4EoArn;
        "pkg-NeoForge-1.20.3-3.0.2" = _QUBRGabW;
        "pkg-NeoForge-1.20.2-3.0.2" = _e18eHrv6;
        "pkg-Forge-1.20.4-3.0.2" = _fkkrxhNc;
        "pkg-NeoForge-1.20.4-3.0.2" = _RtX3Un3f;
        "pkg-Fabric-1.20.2-3.0.2" = _pjmKZmC5;
        "pkg-Fabric-1.20.4-3.0.2" = _dkQ6QUJ6;
        "pkg-NeoForge-1.20.6-3.0.2" = _UAGpkGJT;
        "pkg-Forge-1.20.6-3.0.2" = _6wwH49T5;
        "pkg-Fabric-1.20.6-3.0.2" = _brKA0OKC;
        "pkg-NeoForge-1.21.1-3.0.2" = _MHA8uHT7;
        "pkg-Forge-1.21.1-3.0.2" = _xSqin5zV;
        "pkg-Fabric-1.21.1-3.0.2" = _mQGGBqdI;
        "pkg-Forge-1.21.10-3.0.2" = _4amlNw4N;
        "pkg-NeoForge-1.21.10-3.0.2" = _ZpvKVByz;
        "pkg-Fabric-1.21.10-3.0.2" = _GuT93AOm;
        "pkg-NeoForge-1.21.3-3.0.2" = _DblnuqUc;
        "pkg-NeoForge-1.21.11-3.0.2" = _vcvMiGHJ;
        "pkg-Forge-1.21.11-3.0.2" = _vwfZG807;
        "pkg-Fabric-1.21.11-3.0.2" = _9O4Qyyc7;
        "pkg-NeoForge-1.21.4-3.0.2" = _8PPlXDKV;
        "pkg-Forge-1.21.4-3.0.2" = _eUXJNKS8;
        "pkg-Forge-1.21.5-3.0.2" = _uGwVCS3G;
        "pkg-NeoForge-1.21.5-3.0.2" = _1rXD9sRK;
        "pkg-Fabric-1.21.4-3.0.2" = _73yVodXy;
        "pkg-Fabric-1.21.5-3.0.2" = _xsHVJfKJ;
        "pkg-NeoForge-26.1.2-3.0.2" = _hs72hvqd;
        "pkg-Fabric-26.1.2-3.0.2" = _FfP5F0Hh;
        "pkg-Forge-26.1.2-3.0.2" = _yoJnJp25;
