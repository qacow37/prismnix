...
let
    ...
    in {
        ...
        "pkg-v0.2" = _BHzsLxEi;
        "pkg-v0.2.1" = _l4iNN11w;
        "pkg-v0.3" = _Ix0Wc06O;
        "pkg-v0.3.1" = _EOJQ1IGr;
        "pkg-v0.3.2" = _In4cJ0I0;
        "pkg-v0.3.3" = _McF5ITEZ;
        "pkg-beta-v0.4" = _JqxedfJ5;
        "pkg-v0.4.1" = _jJmyKB7f;
        "pkg-v0.5" = _TBOZmi0u;
        "pkg-v0.5.1" = _kpWPo4Mj;
        "pkg-v0.5.2" = _7XDufKWN;
        "pkg-v0.5.3-prerelease-1" = _hjSCZq6j;
        "pkg-v0.5.3" = _ydZ1VaHf;
        "pkg-v0.5.4-prerelease-1" = _WjFf91cQ;
        "pkg-v0.5.4" = _ycCDhTxe;
        "pkg-v0.5.5" = _A21UxlDR;
        "pkg-v0.5.6" = _x6Lk9HS5;
        "pkg-v0.5.7" = _DarpMpej;
        "pkg-v0.5.8" = _V2Y1H7dg;
        "pkg-v0.5.9" = _UDdLJpkc;
        "pkg-v0.6-prerelease-1" = _88riDogc;
        "pkg-v0.6-prerelease-2" = _ROloU4Jx;
        "pkg-v0.6-prerelease-3" = _6uQgoN6n;
        "pkg-v0.6-prerelease-4" = _Gks4dvA5;
        "pkg-v0.6-prerelease-5" = _kMR6ilzF;
        "pkg-v0.6" = _lTMupAvF;
        "pkg-v0.6.1" = _inoxnEJB;
        "pkg-v0.6.2-prerelease-1" = _OdH5FQf8;
        "pkg-v0.6.2-prerelease-2" = _3UqiNctY;
        "pkg-v0.6.2-prerelease-3" = _jbz9ww1X;
        "pkg-v0.6.2-prerelease-4" = _qcNFDetv;
        "pkg-v0.6.2-prerelease-5" = _lSQRVxde;
        "pkg-v0.6.2-prerelease-6" = _LwFAN5V4;
        "pkg-v0.6.2-prerelease-7" = _pwxQ4NPA;
        "pkg-v0.6.2-prerelease-8" = _aXijkjwx;
        "pkg-v0.6.2-prerelease-9" = _YBADcSHf;
        "pkg-v0.6.2-prerelease-10" = _ewJHpWEo;
        "default" = _ewJHpWEo;
    });
