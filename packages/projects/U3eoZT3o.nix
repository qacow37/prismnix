...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.4-fabric" = _maYnOCd0;
        "pkg-1.18.2-2.4-fabric" = _pYuRIcYd;
        "pkg-1.19.2-2.5-fabric" = _lZv1uEX9;
        "pkg-1.16.5-1.9-forge" = _vAQ4agZQ;
        "pkg-1.18.2-2.0-forge" = _9Y4sfqTY;
        "pkg-1.19.2-2.3-forge" = _RzF3ZQ2R;
        "pkg-1.16.5-3.0-fabric" = _37KRNYeU;
        "pkg-1.18.2-3.0-fabric" = _OyBilZ7K;
        "pkg-1.19.2-3.0-fabric" = _bnGLvta4;
        "pkg-1.16.5-3.0-forge" = _poOpv8qP;
        "pkg-1.18.2-3.0-forge" = _E7qrEiJZ;
        "pkg-1.19.2-3.0-forge" = _zkxk2AGD;
        "pkg-1.16.5-3.1-fabric" = _MkUyfmpm;
        "pkg-1.18.2-3.1-fabric" = _BkF1kgKv;
        "pkg-1.19.2-3.1-fabric" = _LqrWX3q1;
        "pkg-1.19.3-3.2-fabric" = _7xdkcV2Q;
        "pkg-1.19.3-3.0-forge" = _RoTkXqg4;
        "pkg-1.18.2-4.0-forge+fabric" = _MohWwoLw;
        "pkg-1.19.2-4.0-forge+fabric" = _MXZtTtvS;
        "pkg-1.19.3-4.0-forge+fabric" = _hRxtOvfa;
        "pkg-1.19.4-4.0-forge+fabric" = _uceyDvpb;
        "pkg-1.20-4.0-forge+fabric" = _dh5Rwl5i;
        "pkg-1.20.1-4.0-forge+fabric" = _SLNyRg56;
        "pkg-1.20.2-4.0-forge+fabric" = _jnfIp0kW;
        "pkg-1.18.2-4.1-forge+fabric" = _VQwGRe7K;
        "pkg-1.19.2-4.1-forge+fabric" = _NlrNuddc;
        "pkg-1.20.1-4.1-forge+fabric" = _omzujcfH;
        "pkg-1.20.2-4.1-forge+fabric" = _XLUkeVLb;
        "pkg-1.20.3-4.1-fabric+forge+neo" = _QwmKdApH;
        "pkg-1.20.4-4.1-fabric+forge+neo" = _nTqAAgBG;
        "pkg-1.19.2-4.2-fabric+forge+neo" = _U8xsc8zm;
        "pkg-1.20.1-4.2-fabric+forge+neo" = _yF5IoloK;
        "pkg-1.20.2-4.2-fabric+forge+neo" = _E0clvVbk;
        "pkg-1.20.4-4.2-fabric+forge+neo" = _FJxSUH3J;
        "pkg-1.19.2-4.3-fabric+forge+neo" = _DPw1kx1D;
        "pkg-1.20.1-4.3-fabric+forge+neo" = _zpCesbuj;
        "pkg-1.20.2-4.3-fabric+forge+neo" = _MIgj0QJI;
        "pkg-1.20.4-4.3-fabric+forge+neo" = _ClJ1vWyy;
        "pkg-1.20.5-4.3-fabric+neo" = _aIrCYqTx;
        "pkg-1.20.6-4.3-fabric+forge+neo" = _yyyzHYg7;
        "pkg-1.21.0-4.3-fabric+forge+neo" = _ErXHkvzU;
        "pkg-1.19.2-4.4-fabric+forge" = _jCV5QRSF;
        "pkg-1.20.1-4.4-fabric+forge+neo" = _9QHGlYnz;
        "pkg-1.20.4-4.4-fabric+forge+neo" = _NwGIVEct;
        "pkg-1.20.6-4.4-fabric+forge+neo" = _4rfBkbHe;
        "pkg-1.21.0-4.4-fabric+forge+neo" = _M1kjuMTH;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _MXcvx0Go;
        "pkg-1.20.6-4.5-fabric+forge+neo" = _pdgu7W2g;
        "pkg-1.21.0-4.5-fabric+forge+neo" = _eIl8rUI7;
        "pkg-1.21.1-4.5-fabric+forge+neo" = _AqPTywmR;
        "pkg-1.21.2-4.5-fabric+neo" = _MyvtOngN;
        "pkg-1.21.3-4.5-fabric+forge+neo" = _7aNx77kp;
        "pkg-1.21.4-4.5-fabric+forge+neo" = _9orubge1;
        "pkg-1.20.1-4.6-fabric+forge+neo" = _DkRq9YKI;
        "pkg-1.21.1-4.6-fabric+forge+neo" = _QV78XqMj;
        "pkg-1.21.4-4.6-fabric+forge+neo" = _Q7D0PJy4;
        "pkg-1.21.5-4.6-fabric+forge+neo" = _go7Grpur;
        "pkg-1.21.6-4.6-fabric+forge+neo" = _VXY1x0Hr;
        "pkg-1.21.7-4.6-fabric+forge+neo" = _DpZLx8zv;
        "pkg-1.21.8-4.6-fabric+forge+neo" = _QwKnodPi;
        "pkg-1.21.9-4.6-fabric+forge+neo" = _gwfOaJV9;
        "pkg-1.21.10-4.6-fabric+forge+neo" = _HcXyoavq;
        "pkg-1.21.11-4.6-fabric+forge+neo" = _QmTnAQac;
        "pkg-26.1.0-4.6-fabric+forge+neo" = _9Vjyoxt8;
        "pkg-26.1.1-4.6-fabric+forge+neo" = _rmjjAg5J;
        "pkg-26.1.2-4.6-fabric+forge+neo" = _9iub9GYW;
        "pkg-1.20.1-5.0-fabric+forge+neo" = _bFti7Zgi;
        "pkg-1.21.1-5.0-fabric+forge+neo" = _8PGuhKWa;
        "pkg-1.21.11-5.0-fabric+forge+neo" = _aCozovzQ;
        "pkg-26.1.2-5.0-fabric+forge+neo" = _dBaY8kfF;
        "pkg-26.2.0-5.0-fabric+forge+neo" = _zQiH9AlJ;
        "default" = _zQiH9AlJ;
    });
