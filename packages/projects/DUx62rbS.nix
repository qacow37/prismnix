...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _TIGNPKWe;
        "pkg-1.0.0+mod" = _uLHDDAGY;
        "pkg-1.0.1" = _8tOaxIJq;
        "pkg-1.0.1+mod" = _3sPm6qWo;
        "pkg-1.1.0" = _bEYpW7eN;
        "pkg-1.1.0+mod" = _etnImB7b;
        "pkg-1.1.1" = _Xy4NCvTl;
        "pkg-1.1.1+mod" = _KQL0rC47;
        "pkg-1.2.0.0" = _oW2b3ir9;
        "pkg-1.2.0.0+mod" = _ies6p700;
        "pkg-1.2.0.1" = _mCQqCt4R;
        "pkg-1.2.0.1+mod" = _BKdlnAux;
        "pkg-1.2.1.0" = _Y2emD3ri;
        "pkg-1.2.1.0+mod" = _cd31ZsBp;
        "pkg-1.2.1.1" = _V7sPF4tJ;
        "pkg-1.2.1.1+mod" = _RTXCqwxs;
        "pkg-1.2.2.0" = _n5ZEeLp5;
        "pkg-1.2.2.0+mod" = _IfwZg5q6;
        "pkg-1.2.2.1" = _egW5F3c7;
        "pkg-1.2.2.1+mod" = _iDIanDOl;
        "pkg-1.2.2.2" = _MWmXwRDx;
        "pkg-1.2.2.2+mod" = _iJlA7t0W;
        "pkg-1.2.3.0-fix" = _T8ohgZTq;
        "pkg-1.2.3.0+mod" = _ACfTuVYi;
        "pkg-1.2.3.1-fix" = _i0xor0v0;
        "pkg-1.2.3.1+mod" = _SrgWKlbu;
        "pkg-1.2.3.2-fix" = _i173DqSB;
        "pkg-1.2.3.0-fix+mod" = _tBUXl990;
        "pkg-1.2.3.1-fix+mod" = _SU3QWDHC;
        "pkg-1.2.3.2-fix+mod" = _FvCjik3r;
        "pkg-1.2.4.0" = _x2E05pfA;
        "pkg-1.2.4.0+mod" = _5IynaT9J;
        "pkg-1.2.4.1" = _99Tjrmcq;
        "pkg-1.2.4.1+mod" = _zNgUQlXV;
        "pkg-1.2.4.2" = _SAUVOMtR;
        "pkg-1.2.4.2+mod" = _Hgekvl6f;
        "pkg-1.2.5.0" = _TD7JceZT;
        "pkg-1.2.5.0+mod" = _xlxDktT9;
        "pkg-1.2.5.1" = _mWXdVA7Y;
        "pkg-1.2.5.1+mod" = _zsoE28TF;
        "pkg-1.2.5.2" = _s2E49LOC;
        "pkg-1.2.5.2+mod" = _zD3Nvwcl;
        "default" = _zD3Nvwcl;
    });
