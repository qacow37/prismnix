...
let
    ...
    in {
        ...
        "pkg-4.1.0" = _wnS9y56O;
        "pkg-4.1.1" = _PSdXJEgT;
        "pkg-4.1.2+1.18.2" = _B3zVYi6f;
        "pkg-4.1.2+1.19" = _r2PYFLlf;
        "pkg-4.2.0+1.18.2" = _BT9G1Jjs;
        "pkg-4.2.0+1.19.0" = _1ZeTRX0i;
        "pkg-4.2.0+1.19.2" = _9crCgb8S;
        "pkg-4.2.1+1.19.0" = _fIoyfjg8;
        "pkg-4.2.1+1.19.2" = _bqcEuQ3T;
        "pkg-4.2.2+1.18.2" = _G0DqCthC;
        "pkg-4.2.2+1.19.0" = _eUeMUFWW;
        "pkg-4.2.2+1.19.2" = _UlK9nEGG;
        "pkg-4.4.3+1.18.2" = _qswnYO0E;
        "pkg-4.4.3+1.19.0" = _oN2E9DQH;
        "pkg-4.4.3+1.19.2" = _2HiZa6Qf;
        "pkg-4.4.4+1.18.2" = _Lmye13jl;
        "pkg-4.4.4+1.19.2" = _nGnXDTky;
        "pkg-7.0.20" = _AmwrLdwL;
        "pkg-7.0.28" = _ERzr9BNE;
        "default" = _ERzr9BNE;
    });
