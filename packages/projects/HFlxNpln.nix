...
let
    ...
    in {
        ...
        "pkg-v1.17.1-3.0.0-forge" = _F3Wg1AJu;
        "pkg-v1.17.1-3.0.0-fabric" = _ipQ7DeG5;
        "pkg-v1.16.5-3.0.0-forge" = _mGeRaIbS;
        "pkg-v1.16.5-3.0.0-fabric" = _2GQft5hc;
        "pkg-v1.17.1-3.0.1-forge" = _jFe5X8s8;
        "pkg-v1.17.1-3.0.1-fabric" = _ck4XAv6k;
        "pkg-v1.16.5-3.0.1-forge" = _zCyl5Kx8;
        "pkg-v1.16.5-3.0.1-fabric" = _dIndL9ni;
        "pkg-v1.18.1-3.0.2-forge" = _fklllvBL;
        "pkg-v1.18.1-3.0.2-fabric" = _GpiJEe2u;
        "pkg-v1.17.1-3.0.2-fabric" = _KuB8L58R;
        "pkg-v1.17.1-3.0.2-forge" = _QsZohw0J;
        "pkg-v1.16.5-3.0.2-forge" = _cImmKdRI;
        "pkg-v1.16.5-3.0.2-fabric" = _ujBszoSl;
        "pkg-v1.18.2-3.0.2-fabric" = _YnPrtuLw;
        "pkg-v1.18.2-3.0.2-forge" = _sXw8mzne;
        "pkg-v1.16.5-3.0.3-forge" = _ZQd1Uerr;
        "pkg-v1.17.1-3.0.3-forge" = _lvvwF04E;
        "pkg-v1.18.2-3.0.3-forge" = _QuL8IB7h;
        "pkg-v1.16.5-3.0.3-fabric" = _PukCRFwA;
        "pkg-v1.17.1-3.0.3-fabric" = _6oljl4jF;
        "pkg-v1.18.2-3.0.3-fabric" = _vU3wa9nm;
        "pkg-v1.19-3.0.3-fabric" = _BdNDWy13;
        "pkg-v1.19-3.0.3-forge" = _Oe0izSI4;
        "pkg-v1.16.5-3.0.4-forge" = _wEo2s3XB;
        "pkg-v1.17.1-3.0.4-forge" = _foIPT7mP;
        "pkg-v1.18.2-3.0.4-forge" = _zFKHSzXt;
        "pkg-v1.19-3.0.4-forge" = _6FY5u2cR;
        "pkg-v1.16.5-3.0.4-fabric" = _j9A1TJQA;
        "pkg-v1.17.1-3.0.4-fabric" = _8vvPmuYs;
        "pkg-v1.18.2-3.0.4-fabric" = _SjcX5Y3g;
        "pkg-v1.19-3.0.4-fabric" = _ASJdg7CD;
        "pkg-v1.16.5-3.0.5-forge" = _kNOn0AUQ;
        "pkg-v1.16.5-3.0.5-fabric" = _2G15f0Pe;
        "pkg-v1.17.1-3.0.5-forge" = _KudSTDBx;
        "pkg-v1.17.1-3.0.5-fabric" = _tPx3QCLs;
        "pkg-v1.18.2-3.0.5-forge" = _O9qdBW7Q;
        "pkg-v1.18.2-3.0.5-fabric" = _AXRLPjBo;
        "pkg-v1.19-3.0.5-fabric" = _wR5IxFwJ;
        "pkg-v1.19-3.0.5-forge" = _n8L9Cqfq;
        "pkg-v1.19.3-3.0.5-fabric" = _yL35zl88;
        "pkg-v1.19.3-3.0.5-forge" = _orJhLMTd;
        "pkg-v1.16.5-3.0.6-forge" = _GYiKkzAy;
        "pkg-v1.17.1-3.0.6-fabric" = _IjcKt732;
        "pkg-v1.18.2-3.0.6-fabric" = _4jfZlrwm;
        "pkg-v1.16.5-3.0.6-fabric" = _2rdwRZ9H;
        "pkg-v1.17.1-3.0.6-forge" = _izxTNqhi;
        "pkg-v1.18.2-3.0.6-forge" = _6e5DJDAH;
        "pkg-v1.19.3-3.0.6-fabric" = _jONeIbTi;
        "pkg-v1.19.3-3.0.6-forge" = _2Y42V4vA;
        "pkg-v1.19.4-3.0.6-fabric" = _khluYCfE;
        "pkg-v1.19.4-3.0.6-forge" = _Q9z43k5v;
        "pkg-v1.16.5-4.0.0-fabric" = _2vfOT407;
        "pkg-v1.16.5-4.0.0-forge" = _8WftncE7;
        "pkg-v1.17.1-4.0.0-fabric" = _OqMfgfCc;
        "pkg-v1.17.1-4.0.0-forge" = _KM0QkE7p;
        "pkg-v1.18.2-4.0.0-forge" = _48zsyh5D;
        "pkg-v1.18.2-4.0.0-fabric" = _i3v815Qx;
        "pkg-v1.19.4-4.0.0-forge" = _igAclL6u;
        "pkg-v1.19.4-4.0.0-fabric" = _8XzLq8xf;
        "pkg-v1.20.1-4.0.0-fabric" = _OfCMhjqu;
        "pkg-v1.20.1-4.0.0-forge" = _mJemZXtZ;
        "pkg-v1.16.5-4.0.1-fabric" = _7P6XRENV;
        "pkg-v1.16.5-4.0.1-forge" = _gFKk8xpt;
        "pkg-v1.17.1-4.0.1-fabric" = _7Yk7HI1M;
        "pkg-v1.17.1-4.0.1-forge" = _adBhRWaa;
        "pkg-v1.18.2-4.0.1-forge" = _ERo3ta8U;
        "pkg-v1.19.4-4.0.1-fabric" = _J6iW5jtk;
        "pkg-v1.20.1-4.0.1-fabric" = _DPHFUhB7;
        "pkg-v1.18.2-4.0.1-fabric" = _BtFFm8gd;
        "pkg-v1.20.1-4.0.1-forge" = _hLKYZy4o;
        "pkg-v1.19.4-4.0.1-forge" = _zsK8YwL8;
        "pkg-v1.19.2-4.0.1-forge" = _eCrTKuYn;
        "pkg-v1.19.2-4.0.1-fabric" = _88UFctwA;
        "pkg-v1.16.5-4.1.0-fabric" = _4sR3FGxi;
        "pkg-v1.16.5-4.1.0-forge" = _ywSftWXR;
        "pkg-v1.17.1-4.1.0-forge" = _hybO8dOo;
        "pkg-v1.17.1-4.1.0-fabric" = _bRYtRofV;
        "pkg-v1.18.2-4.1.0-fabric" = _NrODglEy;
        "pkg-v1.18.2-4.1.0-forge" = _H8XQ2Nue;
        "pkg-v1.20.1-4.1.0-forge" = _y9FMZ6ZI;
        "pkg-v1.19.2-4.1.0-fabric" = _F4AXJky7;
        "pkg-v1.20.1-4.1.0-fabric" = _1IiW9I3X;
        "pkg-v1.19.4-4.1.0-fabric" = _puBW2OsT;
        "pkg-v1.19.4-4.1.0-forge" = _QoBYtTMk;
        "pkg-v1.19.2-4.1.0-forge" = _CjCDA9TG;
        "pkg-v1.16.5-4.2.0-fabric" = _JmelUjHT;
        "pkg-v1.18.2-4.2.0-forge" = _haKM6s8A;
        "pkg-v1.18.2-4.2.0-fabric" = _O3vdyviG;
        "pkg-v1.17.1-4.2.0-fabric" = _Jvw3w8hI;
        "pkg-v1.17.1-4.2.0-forge" = _EorpZFdN;
        "pkg-v1.19.2-4.2.0-fabric" = _HE2UkoW3;
        "pkg-v1.19.2-4.2.0-forge" = _GTTwOnFz;
        "pkg-v1.20.1-4.2.0-fabric" = _njXLo9a0;
        "pkg-v1.19.4-4.2.0-fabric" = _Jpdjskwu;
        "pkg-v1.20.1-4.2.0-forge" = _P8zIWZ48;
        "pkg-v1.19.4-4.2.0-forge" = _xOqjqlKz;
        "pkg-v1.16.5-4.2.0-forge" = _4qNYM4CN;
        "pkg-v1.16.5-4.2.1-fabric" = _ufar54iN;
        "pkg-v1.16.5-4.2.1-forge" = _to7Jg615;
        "pkg-v1.17.1-4.2.1-forge" = _3I3DwMbg;
        "pkg-v1.17.1-4.2.1-fabric" = _F5TVxR6U;
        "pkg-v1.18.2-4.2.1-fabric" = _RybGFaow;
        "pkg-v1.18.2-4.2.1-forge" = _CjMMSJiZ;
        "pkg-v1.20.1-4.2.1-fabric" = _Zk7MiiXu;
        "pkg-v1.20.1-4.2.1-forge" = _ygHMjF4v;
        "pkg-v1.19.2-4.2.1-fabric" = _8bkKFYUL;
        "pkg-v1.19.2-4.2.1-forge" = _Uq5uxKtE;
        "pkg-v1.19.4-4.2.1-fabric" = _j77pnFrP;
        "pkg-v1.19.4-4.2.1-forge" = _BE6ITTaL;
        "pkg-v1.16.5-4.2.2-fabric" = _l6jc94Er;
        "pkg-v1.16.5-4.2.2-forge" = _1LsU1VB5;
        "pkg-v1.17.1-4.2.2-fabric" = _ch6AZKe2;
        "pkg-v1.18.2-4.2.2-fabric" = _9newFvED;
        "pkg-v1.18.2-4.2.2-forge" = _fodoLhp9;
        "pkg-v1.17.1-4.2.2-forge" = _Gj62bBrD;
        "pkg-v1.19.2-4.2.2-fabric" = _10DCQqUR;
        "pkg-v1.19.2-4.2.2-forge" = _3DW7wYcl;
        "pkg-v1.20.1-4.2.2-fabric" = _ZEib4QhP;
        "pkg-v1.20.1-4.2.2-forge" = _PsDFbNxT;
        "pkg-v1.19.4-4.2.2-fabric" = _OMlW8UfK;
        "pkg-v1.19.4-4.2.2-forge" = _5I5UqqeA;
        "pkg-v1.16.5-4.2.3-fabric" = _YaDvRSAn;
        "pkg-v1.16.5-4.2.3-forge" = _7ENRDeRj;
        "pkg-v1.18.2-4.2.3-forge" = _5KlN5Bgv;
        "pkg-v1.17.1-4.2.3-fabric" = _OKNHRmPV;
        "pkg-v1.18.2-4.2.3-fabric" = _7DEmD86u;
        "pkg-v1.17.1-4.2.3-forge" = _xffILDGE;
        "pkg-v1.19.4-4.2.3-fabric" = _zGNBoU93;
        "pkg-v1.20.1-4.2.3-forge" = _AI3XfoBW;
        "pkg-v1.20.1-4.2.3-fabric" = _jqMzuCs6;
        "pkg-v1.19.4-4.2.3-forge" = _lnpASD0K;
        "pkg-v1.19.2-4.2.3-fabric" = _c8qVbuNV;
        "pkg-v1.19.2-4.2.3-forge" = _6Akuo4ks;
        "pkg-v1.17.1-4.2.4-forge" = _9rLUeq4f;
        "pkg-v1.18.2-4.2.4-forge" = _ogJEbQph;
        "pkg-v1.17.1-4.2.4-fabric" = _6Uevcl9w;
        "pkg-v1.16.5-4.2.4-forge" = _YRZCEzVi;
        "pkg-v1.18.2-4.2.4-fabric" = _QdPrHfrw;
        "pkg-v1.16.5-4.2.4-fabric" = _U54wMBW6;
        "pkg-v1.20.1-4.2.4-forge" = _m5yiyIq3;
        "pkg-v1.20.1-4.2.4-fabric" = _M3YXnvwE;
        "pkg-v1.19.2-4.2.4-fabric" = _7uN5sN7V;
        "pkg-v1.19.4-4.2.4-fabric" = _94VpGtVR;
        "pkg-v1.19.2-4.2.4-forge" = _IPPinRX6;
        "pkg-v1.19.4-4.2.4-forge" = _xR8W5Xox;
        "pkg-v1.16.5-4.2.5-fabric" = _ghJLrB25;
        "pkg-v1.16.5-4.2.5-forge" = _RxDCOG1C;
        "pkg-v1.17.1-4.2.5-forge" = _ltW0PZsR;
        "pkg-v1.17.1-4.2.5-fabric" = _87wHHIbu;
        "pkg-v1.18.2-4.2.5-fabric" = _Tu8BJRFn;
        "pkg-v1.19.2-4.2.5-forge" = _PpXcvfwK;
        "pkg-v1.18.2-4.2.5-forge" = _ocY2PhkU;
        "pkg-v1.19.2-4.2.5-fabric" = _fum82o48;
        "pkg-v1.20.1-4.2.5-forge" = _F52W7ujS;
        "pkg-v1.20.1-4.2.5-fabric" = _JH62rZIi;
        "pkg-v1.19.4-4.2.5-fabric" = _8WljOE2U;
        "pkg-v1.19.4-4.2.5-forge" = _dsm9uIYC;
        "pkg-v1.16.5-4.3.0-fabric" = _czau3VFV;
        "pkg-v1.16.5-4.3.0-forge" = _PRPVmpTS;
        "pkg-v1.17.1-4.3.0-fabric" = _3z6xIqVD;
        "pkg-v1.17.1-4.3.0-forge" = _jecdBhim;
        "pkg-v1.18.2-4.3.0-fabric" = _rWl9zuEB;
        "pkg-v1.19.2-4.3.0-fabric" = _H2mAafen;
        "pkg-v1.19.2-4.3.0-forge" = _MZlCnFFz;
        "pkg-v1.18.2-4.3.0-forge" = _NS8Q7fK4;
        "pkg-v1.20.1-4.3.0-fabric" = _iu05y0mS;
        "pkg-v1.19.4-4.3.0-fabric" = _AW6oQPAV;
        "pkg-v1.20.1-4.3.0-forge" = _pDJkmacw;
        "pkg-v1.19.4-4.3.0-forge" = _KzwOoRK0;
        "pkg-v1.17.1-4.4.0-fabric" = _2ikFAlzg;
        "pkg-v1.17.1-4.4.0-forge" = _kJ9c6csL;
        "pkg-v1.16.5-4.4.0-forge" = _KosyL8si;
        "pkg-v1.16.5-4.4.0-fabric" = _SU8RTMee;
        "pkg-v1.18.2-4.4.0-fabric" = _4rIM4lD6;
        "pkg-v1.18.2-4.4.0-forge" = _iBhq8ll6;
        "pkg-v1.20.1-4.4.0-fabric" = _jlQ1MOqg;
        "pkg-v1.19.2-4.4.0-forge" = _pzLa5ovR;
        "pkg-v1.20.1-4.4.0-forge" = _NkQEw1qr;
        "pkg-v1.19.4-4.4.0-forge" = _UAN9urga;
        "pkg-v1.19.4-4.4.0-fabric" = _6EFuY2PZ;
        "pkg-v1.19.2-4.4.0-fabric" = _2rKV2v4p;
        "pkg-v1.20.2-4.4.0-fabric" = _ugD2s7vN;
        "pkg-v1.20.2-4.4.0-forge" = _7ufRapnL;
        "pkg-v1.20.1-4.4.1-fabric" = _8gX0c19Z;
        "pkg-v1.20.1-4.4.1-forge" = _3GXPJrjF;
        "pkg-v1.20.2-4.4.1-forge" = _51dlMP8a;
        "pkg-v1.16.5-4.4.1-forge" = _CcrzhDSP;
        "pkg-v1.19.2-4.4.1-fabric" = _QVZsduh0;
        "pkg-v1.19.2-4.4.1-forge" = _DwxNCAxU;
        "pkg-v1.19.4-4.4.1-forge" = _LG55BgJ6;
        "pkg-v1.18.2-4.4.1-forge" = _Leyu13Tj;
        "pkg-v1.16.5-4.4.1-fabric" = _EFarkR5o;
        "pkg-v1.18.2-4.4.1-fabric" = _Or94EqP3;
        "pkg-v1.19.4-4.4.1-fabric" = _1MOHyyNG;
        "pkg-v1.20.2-4.4.1-fabric" = _RyEltDgl;
        "pkg-v1.17.1-4.4.1-fabric" = _70uoeIKC;
        "pkg-v1.17.1-4.4.1-forge" = _XoAQYz1T;
        "pkg-v1.16.5-4.4.2-forge" = _crDgMXhk;
        "pkg-v1.16.5-4.4.2-fabric" = _ZBSV233L;
        "pkg-v1.17.1-4.4.2-fabric" = _T5GngdEX;
        "pkg-v1.18.2-4.4.2-fabric" = _r2NcsPaX;
        "pkg-v1.17.1-4.4.2-forge" = _oVhaAd54;
        "pkg-v1.18.2-4.4.2-forge" = _fyaXO65P;
        "pkg-v1.19.2-4.4.2-fabric" = _nWviRexS;
        "pkg-v1.20.1-4.4.2-fabric" = _aEm5K0ih;
        "pkg-v1.20.1-4.4.2-forge" = _AZRRaCJ2;
        "pkg-v1.19.4-4.4.2-forge" = _PgTEdglo;
        "pkg-v1.19.4-4.4.2-fabric" = _R7zyMZOw;
        "pkg-v1.20.2-4.4.2-forge" = _RVitR3BX;
        "pkg-v1.20.2-4.4.2-fabric" = _IPuXzlmI;
        "pkg-v1.19.2-4.4.2-forge" = _ejryvWmH;
        "pkg-v1.16.5-4.4.3-fabric" = _ihchTyyb;
        "pkg-v1.16.5-4.4.3-forge" = _y67SS7aJ;
        "pkg-v1.17.1-4.4.3-fabric" = _VL5cMnQl;
        "pkg-v1.17.1-4.4.3-forge" = _BZwMgKQ9;
        "pkg-v1.18.2-4.4.3-forge" = _LdiWfPBf;
        "pkg-v1.19.2-4.4.3-fabric" = _ni9zI56K;
        "pkg-v1.19.2-4.4.3-forge" = _WJcfeESW;
        "pkg-v1.20.1-4.4.3-fabric" = _juBFlHS0;
        "pkg-v1.19.4-4.4.3-fabric" = _90o0zasB;
        "pkg-v1.19.4-4.4.3-forge" = _FT3NnL3o;
        "pkg-v1.20.2-4.4.3-fabric" = _1hGejm3t;
        "pkg-v1.20.1-4.4.3-forge" = _EYY1ztht;
        "pkg-v1.20.2-4.4.3-forge" = _407JQotl;
        "pkg-v1.18.2-4.4.3-fabric" = _UgcFImIE;
        "pkg-v1.16.5-4.4.4-fabric" = _OpbhPEWg;
        "pkg-v1.16.5-4.4.4-forge" = _s2wAoBFV;
        "pkg-v1.18.2-4.4.4-fabric" = _7Zvt6d1G;
        "pkg-v1.18.2-4.4.4-forge" = _LBz5dWQ4;
        "pkg-v1.19.2-4.4.4-fabric" = _rLcu2SUZ;
        "pkg-v1.17.1-4.4.4-fabric" = _qEnnY9Pi;
        "pkg-v1.17.1-4.4.4-forge" = _CSQurOwN;
        "pkg-v1.19.2-4.4.4-forge" = _uPYg4bqk;
        "pkg-v1.19.4-4.4.4-fabric" = _R8s33M5C;
        "pkg-v1.19.4-4.4.4-forge" = _xZTOybgZ;
        "pkg-v1.20.1-4.4.4-forge" = _9QVUKP6g;
        "pkg-v1.20.1-4.4.4-fabric" = _39y4EDwA;
        "pkg-v1.20.2-4.4.4-forge" = _vSyEP9F2;
        "pkg-v1.20.2-4.4.4-fabric" = _s3SMztqC;
        "pkg-v1.16.5-4.4.5-fabric" = _eRSDhKGW;
        "pkg-v1.16.5-4.4.5-forge" = _5JMFjIQg;
        "pkg-v1.18.2-4.4.5-forge" = _XYZuV6bC;
        "pkg-v1.18.2-4.4.5-fabric" = _j5ZqliGE;
        "pkg-v1.17.1-4.4.5-forge" = _mDe13Xca;
        "pkg-v1.17.1-4.4.5-fabric" = _dFtrxXR5;
        "pkg-v1.20.2-4.4.5-forge" = _TgraZreB;
        "pkg-v1.19.4-4.4.5-fabric" = _oqZaig46;
        "pkg-v1.19.2-4.4.5-forge" = _XgXFCmec;
        "pkg-v1.19.2-4.4.5-fabric" = _UYawUsfs;
        "pkg-v1.20.1-4.4.5-forge" = _74pfUbC2;
        "pkg-v1.19.4-4.4.5-forge" = _B34PlZjf;
        "pkg-v1.20.2-4.4.5-fabric" = _85mSAPrB;
        "pkg-v1.20.1-4.4.5-fabric" = _dI69MReX;
        "pkg-v1.20.4-4.4.5-forge" = _udrVnQ3U;
        "pkg-v1.20.4-4.4.5-fabric" = _Vt6dRzTu;
        "pkg-v1.16.5-4.4.6-forge" = _fZ3ilQex;
        "pkg-v1.16.5-4.4.6-fabric" = _YDuwWzwt;
        "pkg-v1.17.1-4.4.6-fabric" = _jJgjqTfz;
        "pkg-v1.17.1-4.4.6-forge" = _LkA8ycIX;
        "pkg-v1.18.2-4.4.6-forge" = _f2BR87fI;
        "pkg-v1.19.2-4.4.6-fabric" = _JBGttEnc;
        "pkg-v1.18.2-4.4.6-fabric" = _kxtkQ4pE;
        "pkg-v1.19.2-4.4.6-forge" = _gKtLVgks;
        "pkg-v1.19.4-4.4.6-forge" = _rVh194au;
        "pkg-v1.20.1-4.4.6-forge" = _MTCfr5zf;
        "pkg-v1.20.4-4.4.6-forge" = _JR8BawEx;
        "pkg-v1.20.1-4.4.6-fabric" = _ATkWMaYC;
        "pkg-v1.20.4-4.4.6-fabric" = _ECEeK7uS;
        "pkg-v1.19.4-4.4.6-fabric" = _JyrrD22E;
        "pkg-v1.20.2-4.4.6-fabric" = _Ls8e7Bph;
        "pkg-v1.20.2-4.4.6-forge" = _iVDKMuew;
        "pkg-v1.16.5-4.4.7-fabric" = _wzpGCN4c;
        "pkg-v1.16.5-4.4.7-forge" = _jPr1KDet;
        "pkg-v1.18.2-4.4.7-fabric" = _c3FhOSfy;
        "pkg-v1.17.1-4.4.7-fabric" = _9y7vZxEZ;
        "pkg-v1.18.2-4.4.7-forge" = _wuF8UXD4;
        "pkg-v1.17.1-4.4.7-forge" = _YTKx6DWa;
        "pkg-v1.19.4-4.4.7-fabric" = _3qXlg3ML;
        "pkg-v1.19.4-4.4.7-forge" = _37ebLiGE;
        "pkg-v1.19.2-4.4.7-fabric" = _T4ZrNQQr;
        "pkg-v1.19.2-4.4.7-forge" = _1V218QJW;
        "pkg-v1.20.1-4.4.7-fabric" = _snE3AX6c;
        "pkg-v1.20.1-4.4.7-forge" = _jukFnzSE;
        "pkg-v1.20.4-4.4.7-forge" = _g0TXBeu8;
        "pkg-v1.20.4-4.4.7-fabric" = _iS9y1YV7;
        "pkg-v1.20.2-4.4.7-forge" = _c3NNXgie;
        "pkg-v1.20.2-4.4.7-fabric" = _OG7o6nxT;
        "pkg-v1.20.6-4.4.7-fabric" = _xrVi8gwW;
        "pkg-v1.20.6-4.4.7-forge" = _2stXK7SC;
        "pkg-v1.21-4.4.7-fabric" = _iRdvN7NN;
        "pkg-v1.21-4.4.7-forge" = _9x3wgxOd;
        "pkg-v1.20.1-4.5.0-forge" = _oX1dmWVt;
        "pkg-v1.20.6-4.5.0-forge" = _9fXcxTPN;
        "pkg-v1.20.6-4.5.0-fabric" = _Cc76XXHE;
        "pkg-v1.20.1-4.5.0-fabric" = _HiMJ4h2E;
        "pkg-v1.21-4.5.0-forge" = _8NmvF7ZE;
        "pkg-v1.21-4.5.0-fabric" = _cNKdfQGN;
        "pkg-v1.20.1-4.5.1-fabric" = _FaAuBgBG;
        "pkg-v1.20.1-4.5.1-forge" = _wBmYGKE8;
        "pkg-v1.20.6-4.5.1-fabric" = _lTqvfVbb;
        "pkg-v1.21.1-4.5.1-fabric" = _WHzbYuPP;
        "pkg-v1.20.6-4.5.1-forge" = _jGc6AV3B;
        "pkg-v1.21.1-4.5.1-forge" = _1msAFvoh;
        "pkg-v1.20.6-4.5.2-forge" = _Oma1XeKN;
        "pkg-v1.20.1-4.5.2-fabric" = _mn3Ujo3F;
        "pkg-v1.20.1-4.5.2-forge" = _1Gk4ti96;
        "pkg-v1.20.6-4.5.2-fabric" = _gICq7JsJ;
        "pkg-v1.21.1-4.5.2-forge" = _hvWXOJy3;
        "pkg-v1.21.1-4.5.2-fabric" = _S0TNCtxB;
        "pkg-v1.21.4-4.5.2-forge" = _3zdc3ysZ;
        "pkg-v1.21.4-4.5.2-fabric" = _tbz0Xjyh;
        "default" = _tbz0Xjyh;
    });
