...
let
    ...
    in {
        ...
        "pkg-1.0.0.0" = _lbtkCp8i;
        "pkg-1.0.0.1" = _uoN6JWcb;
        "pkg-1.0.0.1a" = _YhG6EoFG;
        "pkg-1.0.1.2" = _Y5aiUMgw;
        "pkg-1.0.1.2a" = _NZCtLD5U;
        "pkg-1.0.1.3" = _QC4A6e09;
        "pkg-1.0.1.4" = _waSmVgWp;
        "pkg-1.0.1.5" = _WeI8pogT;
        "pkg-1.0.2.0" = _LRqgsZqo;
        "pkg-1.1.0.0" = _hKd6XEYu;
        "pkg-1.1.0.1" = _DQpDNmm6;
        "pkg-1.1.0.2" = _LWLaOLyw;
        "pkg-1.1.0.3" = _AK8ZwJdW;
        "pkg-1.1.0.4" = _4XfrpFRV;
        "pkg-1.1.0.4b" = _m7B54T4L;
        "pkg-1.1.0.4c" = _cSiE2iQK;
        "pkg-1.2.0.0" = _x90D935C;
        "pkg-1.2.1.0" = _nxodNCW8;
        "pkg-1.2.2.1" = _AbxmXBjf;
        "pkg-1.2.2.2" = _c11ZNK05;
        "pkg-1.2.2.3" = _rqLNcrn0;
        "pkg-1.2.2.4" = _NL7NYA3b;
        "pkg-1.2.2.5" = _m2echeh9;
        "pkg-1.2.3.0" = _6XOJyU6T;
        "pkg-1.2.3.1" = _t6TqLCa9;
        "pkg-1.2.3.2" = _OHds0HS2;
        "pkg-1.2.3.3" = _dBvf0HJy;
        "default" = _dBvf0HJy;
    });
