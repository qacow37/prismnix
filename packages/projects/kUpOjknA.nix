...
let
    ...
    in {
        ...
        "pkg-1.20.1-3.1.2" = _OFX6b17u;
        "pkg-1.19.2-3.1.2" = _R16OpImr;
        "pkg-1.20.1-3.1.3" = _pe3dMikf;
        "pkg-1.20.1-3.1.4" = _pVfYD7TB;
        "pkg-1.20.1-3.1.5" = _IpDg64df;
        "pkg-1.20.1-3.1.6" = _mOHKbnTz;
        "pkg-1.20.1-3.2" = _bElejzXl;
        "pkg-1.19.2-3.2" = _QdFmUHva;
        "pkg-1.20.1-3.3" = _JSFUIrEm;
        "pkg-1.20.1-3.3.1" = _p9Cfv45y;
        "pkg-1.20.1-3.4" = _oiQKEbVA;
        "pkg-1.19.2-3.4.1" = _1mq3IdrP;
        "pkg-1.20.1-3.4.1" = _5WV9Ynq7;
        "pkg-1.20.1-3.4.2" = _sMsV0SBN;
        "pkg-1.20.1-3.4.3" = _wCTfHbkx;
        "pkg-1.21.1-3.5" = _G6aAbTi0;
        "pkg-1.20.1-3.5" = _LAQRbGDP;
        "pkg-1.21.1-3.5.1" = _r9mraZeq;
        "pkg-1.20.1-3.5.2-fabric" = _MpybJJVs;
        "pkg-1.20.1-3.5.2-forge" = _R9rST0Gu;
        "pkg-1.21.1-3.5.3-fabric" = _1Cdtj4Uq;
        "pkg-1.21.1-3.5.3-neoforge" = _fJcTU22k;
        "default" = _1Cdtj4Uq;
    });
