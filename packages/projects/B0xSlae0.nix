...
let
    ...
    in {
        ...
        "pkg-1.19.2_1.0.0" = _PBjWHqoB;
        "pkg-1.19.4_1.0.0" = _veEMAUwL;
        "pkg-1.20.11.0.0" = _74HPAzMB;
        "pkg-1.20.12.0.0" = _rPTlfXDK;
        "pkg-1.20.12.0.1" = _kmqNVxPY;
        "pkg-1.20.12.0.2" = _r47EOYEy;
        "pkg-1.20.12.0.3" = _Gf1AS9ND;
        "pkg-1.20.12.0.4" = _tQGh941d;
        "pkg-1.20.12.0.5" = _n36CfzHy;
        "pkg-1.20.12.0.6" = _UO0GHPL7;
        "pkg-1.20.12.0.7" = _cK88N4vp;
        "pkg-1.19.22.0.0" = _WeAhKFQT;
        "pkg-1.19.42.0.0" = _qrK5M6cl;
        "pkg-1.18.21.0.0" = _gvXSWxjb;
        "pkg-1.20.12.0.8" = _cwVvWWy4;
        "pkg-1.20.12.0.8f" = _jZPzkNFy;
        "pkg-1.18.22.0.8f" = _GZcXX0Kg;
        "pkg-1.19.22.0.8f" = _C3TddUjN;
        "pkg-1.19.42.0.8f" = _kqitiGBq;
        "pkg-1.161.1.2" = _DItEePTw;
        "pkg-1.20.12.0.9" = _Wbe89Dqx;
        "pkg-1.19.42.0.9" = _so3ZJetY;
        "pkg-1.19.22.0.9" = _EJVQ66yE;
        "pkg-1.12.22.0.9" = _McgHDxyJ;
        "pkg-1.18.22.0.9" = _8MN2564K;
        "pkg-1.18.22.1.0" = _llTQBH1z;
        "pkg-1.19.22.1.0" = _rM99ztQ9;
        "pkg-1.19.42.1.0" = _qcN8UFnN;
        "pkg-1.20.12.1.0" = _MPtQu3dj;
        "default" = _MPtQu3dj;
    });
