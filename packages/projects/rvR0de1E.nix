...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.4" = _EawgejPH;
        "pkg-1.0.1+1.20.4" = _pI3vz7Gc;
        "pkg-1.0.2+1.20.4" = _CgcM84UK;
        "pkg-1.0.2+1.20.3" = _LxO92vKE;
        "pkg-1.0.2+1.20.2" = _RQJCKQ3l;
        "pkg-1.0.2+1.20.1" = _f07fiKvs;
        "pkg-1.0.2+1.20" = _mM9rldwC;
        "pkg-1.0.3+1.20.4" = _F6X7sc6O;
        "pkg-1.0.3+1.20.3" = _IHCrkxYD;
        "pkg-1.0.3+1.20.2" = _sMOMKt6q;
        "pkg-1.0.3+1.20.1" = _m2N981fl;
        "pkg-1.0.3+1.20" = _rOsANU3R;
        "pkg-1.0.4+1.20.1" = _47GQ3zT8;
        "pkg-1.0.4+1.20.2" = _cBf4kOD2;
        "pkg-1.0.4+1.20.3" = _7ApcarcM;
        "pkg-1.0.4+1.20.4" = _jKIiZelf;
        "pkg-1.0.4+1.20" = _apCyTsHT;
        "pkg-1.0.5+1.20.1" = _4AoK3K6e;
        "pkg-1.0.5+1.20.2" = _i9GsbBWi;
        "pkg-1.0.5+1.20.3" = _aUCkSFNh;
        "pkg-1.0.5+1.20.4" = _L4125ybd;
        "pkg-1.0.5+1.20" = _5K9bfDzK;
        "pkg-1.0.6+1.20.1" = _1Fs22kF7;
        "pkg-1.0.6+1.20.2" = _ElDq5B1p;
        "pkg-1.0.6+1.20.3" = _L6r2dJBU;
        "pkg-1.0.6+1.20.4" = _NHT4UAmy;
        "pkg-1.0.6+1.20" = _vNuOhaed;
        "pkg-1.0.7+1.20.1" = _K3JpvTz3;
        "pkg-1.0.7+1.20.2" = _KErUJKRG;
        "pkg-1.0.7+1.20.3" = _L4ImOMIT;
        "pkg-1.0.7+1.20.4" = _NbV9AXwB;
        "pkg-1.0.7+1.20" = _xLWZzITM;
        "pkg-1.0.8+1.20.1" = _mxdLjqDI;
        "pkg-1.0.8+1.20.2" = _BMIbHvdO;
        "pkg-1.0.8+1.20.3" = _cNlqgRtT;
        "pkg-1.0.8+1.20.4" = _zd0IVx1o;
        "pkg-1.0.8+1.20" = _7qDu84Ec;
        "pkg-1.1.0+1.20.1" = _nqde9bHM;
        "pkg-1.1.0+1.20.2" = _Wf3kJx3R;
        "pkg-1.1.0+1.20.3" = _bdUm9HqO;
        "pkg-1.1.0+1.20.4" = _6Kqnyl7Z;
        "pkg-1.1.0+1.20" = _gOhzUyLw;
        "pkg-1.2.0+1.20.1" = _WNhCALpw;
        "pkg-1.2.0+1.20.2" = _CkLt7rz0;
        "pkg-1.2.0+1.20.3" = _1KE6v5YR;
        "pkg-1.2.0+1.20.4" = _5E9CjjH0;
        "pkg-1.2.0+1.20" = _spW32zcC;
        "pkg-1.2.1+1.20.1" = _9ZPLiIc1;
        "pkg-1.2.1+1.20.2" = _xW8fGNA8;
        "pkg-1.2.1+1.20.3" = _GPXfFQ3c;
        "pkg-1.2.1+1.20.4" = _KC26I91F;
        "pkg-1.2.1+1.20" = _CMsEnjKg;
        "pkg-1.3.0+1.20.1" = _jL4cEHH8;
        "pkg-1.3.0+1.20.2" = _FzhAN5LO;
        "pkg-1.3.0+1.20.3" = _FBl4x6SO;
        "pkg-1.3.0+1.20.4" = _3F73yMAe;
        "pkg-1.3.0+1.20" = _YcDXgl07;
        "pkg-2.0.0+1.20.1" = _5AGdcyb2;
        "pkg-2.0.0+1.20.2" = _4pqAUckI;
        "pkg-2.0.0+1.20.3" = _X7x1MyRL;
        "pkg-2.0.0+1.20.4" = _9ZAFKxlC;
        "pkg-2.0.0+1.20.5" = _elI8CZDI;
        "pkg-2.0.0+1.20.6" = _kFNiiqYE;
        "pkg-2.0.0+1.20" = _Pkmf2Who;
        "pkg-2.0.0+1.21.1" = _PCbRdtgw;
        "pkg-2.0.0+1.21.2" = _uA7eCeMt;
        "pkg-2.0.0+1.21.3" = _3cL1zSpa;
        "pkg-2.0.0+1.21.4" = _SGsvQxSY;
        "pkg-2.0.0+1.21" = _dvNIiwc3;
        "pkg-2.5.0+1.20.1" = _WZ0gluLh;
        "pkg-2.5.0+1.20.2" = _El9l9lPf;
        "pkg-2.5.0+1.20.3" = _r9LpWkAS;
        "pkg-2.5.0+1.20.4" = _qNucm9rh;
        "pkg-2.5.0+1.20.5" = _lYPto5wh;
        "pkg-2.5.0+1.20.6" = _6Vhc4UqL;
        "pkg-2.5.0+1.20" = _ycONzWDs;
        "pkg-2.5.0+1.21.1" = _iiIPJMBK;
        "pkg-2.5.0+1.21.2" = _yG5dYNTk;
        "pkg-2.5.0+1.21.3" = _u9Ujd7qG;
        "pkg-2.5.0+1.21.4" = _5yhRJmpR;
        "pkg-2.5.0+1.21.5" = _1YxkMk9l;
        "pkg-2.5.0+1.21.6" = _4pNVy1wy;
        "pkg-2.5.0+1.21.7" = _uFoDkJpX;
        "pkg-2.5.0+1.21" = _EygHhVvK;
        "pkg-3.0.0+1.20.1" = _UTLHvoHY;
        "pkg-3.0.0+1.20.2" = _PMo1NKzx;
        "pkg-3.0.0+1.20.3" = _JyaIjHOh;
        "pkg-3.0.0+1.20.4" = _oxTFGZfy;
        "pkg-3.0.0+1.20.5" = _McWUu9bP;
        "pkg-3.0.0+1.20.6" = _Z7lMu0JQ;
        "pkg-3.0.0+1.20" = _OBemPswz;
        "pkg-3.0.0+1.21.1" = _2s0htLQ0;
        "pkg-3.0.0+1.21.2" = _Wm8F7pJs;
        "pkg-3.0.0+1.21.3" = _GPz3jZLy;
        "pkg-3.0.0+1.21.4" = _Rt6nWOXG;
        "pkg-3.0.0+1.21.5" = _cnAAZr2M;
        "pkg-3.0.0+1.21.6" = _na1Z5NVy;
        "pkg-3.0.0+1.21.7" = _i7PodScl;
        "pkg-3.0.0+1.21" = _ey1okg5m;
        "default" = _ey1okg5m;
    });
