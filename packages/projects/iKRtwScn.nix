...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.7-fabric" = _3G1UKFNE;
        "pkg-1.18.2-2.7-fabric" = _MgdksrZZ;
        "pkg-1.19.2-2.8-fabric" = _hBfvlQD9;
        "pkg-1.16.5-2.3-forge" = _reovHRWf;
        "pkg-1.18.2-2.4-forge" = _DEvPnwQq;
        "pkg-1.19.2-2.6-forge" = _Pldukmz2;
        "pkg-1.16.5-2.9-fabric" = _ZhH1M91c;
        "pkg-1.18.2-2.9-fabric" = _mR1uZLPa;
        "pkg-1.19.2-2.9-fabric" = _JI1dwnJo;
        "pkg-1.19.3-3.0-fabric" = _VYZFsIFL;
        "pkg-1.19.3-2.6-forge" = _ihJNgqbe;
        "pkg-1.18.2-4.0-forge+fabric" = _BoMq1mvq;
        "pkg-1.19.2-4.0-forge+fabric" = _QTlGf4Jm;
        "pkg-1.19.3-4.0-forge+fabric" = _cO9hPouf;
        "pkg-1.18.2-4.1-forge+fabric" = _T6gHzQVg;
        "pkg-1.19.2-4.1-forge+fabric" = _2yn3XKf1;
        "pkg-1.19.3-4.1-forge+fabric" = _CHIGXzXz;
        "pkg-1.19.4-4.1-forge+fabric" = _clgC7ADH;
        "pkg-1.20-4.1-forge+fabric" = _kYafNGvd;
        "pkg-1.20.1-4.1-forge+fabric" = _UXY0WQrH;
        "pkg-1.20.2-4.1-forge+fabric" = _2tx9Qw8B;
        "pkg-1.18.2-4.2-forge+fabric" = _L7qKaSRo;
        "pkg-1.19.2-4.2-forge+fabric" = _QoV9dimO;
        "pkg-1.20.1-4.2-forge+fabric" = _DOXf9r7Y;
        "pkg-1.20.2-4.2-forge+fabric" = _zqXsgw3g;
        "pkg-1.20.3-4.2-fabric+forge+neo" = _zitebOP6;
        "pkg-1.20.4-4.2-fabric+forge+neo" = _wsLbFgjl;
        "pkg-1.19.2-4.3-fabric+forge+neo" = _OxJ3LkHD;
        "pkg-1.20.1-4.3-fabric+forge+neo" = _20UNJ9MI;
        "pkg-1.20.2-4.3-fabric+forge+neo" = _D911gG2P;
        "pkg-1.20.4-4.3-fabric+forge+neo" = _PRnfNOIx;
        "pkg-1.20.5-4.3-fabric+neo" = _eo4cNZF2;
        "pkg-1.20.6-4.3-fabric+forge+neo" = _CVwsP6Kh;
        "pkg-1.21.0-4.3-fabric+forge+neo" = _aaHXooE6;
        "pkg-1.20.1-4.4-fabric+forge+neo" = _Laa3NjuK;
        "pkg-1.20.6-4.4-fabric+forge+neo" = _iif7ahys;
        "pkg-1.21.0-4.4-fabric+forge+neo" = _iDhoGBKF;
        "pkg-1.21.1-4.4-fabric+forge+neo" = _9x32AMSd;
        "pkg-1.21.2-4.4-fabric+neo" = _biqpMJor;
        "pkg-1.21.3-4.4-fabric+forge+neo" = _APeG0yqO;
        "pkg-1.21.4-4.4-fabric+forge+neo" = _QjBZLaQg;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _I5LEJ06o;
        "pkg-1.21.1-4.5-fabric+forge+neo" = _LhoR7Tp8;
        "pkg-1.21.4-4.5-fabric+forge+neo" = _lQ3THZDC;
        "pkg-1.21.5-4.5-fabric+forge+neo" = _uIa9grok;
        "pkg-1.21.6-4.5-fabric+forge+neo" = _twLhRpNA;
        "pkg-1.21.7-4.5-fabric+forge+neo" = _WqJI7Kdm;
        "pkg-1.21.8-4.5-fabric+forge+neo" = _MlmGoDvK;
        "pkg-1.21.9-4.5-fabric+forge+neo" = _QK70yjXS;
        "pkg-1.21.10-4.5-fabric+forge+neo" = _AXjcJqHX;
        "pkg-1.21.11-4.5-fabric+forge+neo" = _YavMZApU;
        "pkg-26.1.0-4.5-fabric+forge+neo" = _aW4dckTh;
        "pkg-26.1.1-4.5-fabric+forge+neo" = _P83evwpP;
        "pkg-26.1.2-4.5-fabric+forge+neo" = _Pi0oPVQv;
        "pkg-26.2.0-4.5-fabric+forge+neo" = _B8hxlXnH;
        "default" = _B8hxlXnH;
    });
