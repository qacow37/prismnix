...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.5-55.1.4" = _9mecb3QH;
        "pkg-1.0.0-forge-1.21.1-52.1.8" = _9ks27BQL;
        "pkg-1.0.0-forge-1.20.1-47.4.10" = _oTM94loD;
        "pkg-1.0.0-fabric-1.20.1-0.92.7" = _Sx0OBdpq;
        "pkg-1.0.0-fabric-1.21.1-0.116.8" = _GAJVI9Ka;
        "pkg-1.0.0-fabric-1.21.5-0.128.2" = _pvVdq5X8;
        "pkg-1.0.0-fabric-1.21.8-0.136.1" = _klCCITSh;
        "pkg-1.0.0-fabric-1.21.10-0.138.4" = _JgLhEQ8z;
        "pkg-1.0.0-fabric-1.21.11-0.141.3" = _i0wtFyQv;
        "pkg-1.0.0-neoforge-1.21.11-21.11.38b" = _j99epUxO;
        "pkg-1.0.0-neoforge-1.21.10-21.10.64" = _imoElxMY;
        "pkg-1.0.0-neoforge-1.21.8-21.8.52" = _hiUuemDy;
        "pkg-1.0.0-neoforge-1.21.5-21.5.96" = _zbW9vNgl;
        "pkg-1.0.0-neoforge-1.21.1-21.1.219" = _zZqCjgUb;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _du8LlcQ6;
        "pkg-1.0.0-neoforge-1.21.4-21.4.156" = _6kPnWiN1;
        "pkg-1.0.0-forge-1.21.4-54.1.11" = _RLCSOjWf;
