...
let
    ...
    in {
        ...
        "pkg-19" = _ljqrjBDZ;
        "pkg-1.8" = _V0wpkbj8;
        "pkg-1.19.2-1.8" = _9Na0fMXG;
        "pkg-1.20-1.11" = _u2rYyWU1;
        "pkg-neoforge_1.21-1.11" = _AcR8rurx;
        "pkg-fabric_1.21-1.11" = _y1Syufqb;
        "pkg-neoforge_1.21-1.12" = _MwBKz4z2;
        "pkg-neoforge_1.21-1.13" = _GEPAdxRS;
        "pkg-fabric_1.21-1.13" = _xSFqbu1U;
        "pkg-neoforge_1.21-1.14" = _DnclMSEE;
        "default" = _DnclMSEE;
    });
