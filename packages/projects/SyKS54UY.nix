...
let
    ...
    in {
        ...
        "pkg-0.1.1-beta" = _JTjsc10W;
        "pkg-0.2.0-beta" = _wJ2Wdw4P;
        "pkg-0.2.1-beta" = _L3DxjCfi;
        "pkg-0.2.2-beta" = _iwSNawl8;
        "pkg-0.2.3-beta" = _boSRRTF2;
        "pkg-0.2.4-beta" = _jT1EWZCS;
        "pkg-0.2.5-beta" = _M6Chvkkl;
        "pkg-0.3.0-beta" = _3ttwA4V9;
        "pkg-0.3.1-beta" = _KhqYeD4r;
        "pkg-0.3.2-beta" = _HwJDrig7;
        "pkg-0.3.3-beta" = _odJskt5k;
        "pkg-0.3.4-beta" = _IhH4SNot;
        "pkg-0.4.0-beta" = _D7D6Xzek;
        "pkg-0.4.1-beta" = _ZtoVRm7u;
        "pkg-0.4.2-beta" = _GnbQwdDc;
        "pkg-0.4.3-beta" = _JfEo4CfS;
        "pkg-0.4.4-beta" = _b64L2PWR;
        "pkg-0.5.0-beta" = _HdB0nRH3;
        "pkg-0.5.1-beta" = _SQVetfZT;
        "pkg-0.5.2-beta" = _Kf2pRDTy;
        "pkg-0.5.3-beta" = _IL3p5d4h;
        "pkg-0.5.4-beta" = _jD4ot7la;
        "pkg-0.6.0-beta" = _NWG7lmrI;
        "pkg-0.6.1-beta" = _FpvcAt0x;
        "pkg-0.6.2-beta" = _fn6ndzak;
        "pkg-0.6.3-beta" = _s5TekkuE;
        "pkg-0.6.4-beta" = _loHPwJ66;
        "pkg-0.6.5-beta" = _j7msl5Wy;
        "pkg-0.7.0-beta" = _KTyQstkc;
        "pkg-0.7.1-beta" = _vxNtdDk7;
        "pkg-0.8.0-beta" = _JU2kel4E;
        "pkg-0.8.1-beta" = _eqNF3q8x;
        "pkg-0.9.0-beta" = _cn3YSO5h;
        "pkg-0.9.1-beta" = _NwVnjHc4;
        "pkg-0.9.2-beta" = _IvaBja23;
        "pkg-0.9.3-beta" = _UEoaWmSF;
        "pkg-0.9.4-beta" = _EtAoB9On;
        "pkg-0.9.5-beta" = _V6PFuIM6;
        "pkg-0.9.6-beta" = _1Ky6xSDu;
        "pkg-0.10.0-beta" = _lkHFOer6;
        "pkg-0.10.1-beta" = _exHvAnkw;
        "pkg-0.10.2-beta" = _Vw9CVmYt;
        "pkg-0.11.0-beta" = _6QHgQhs6;
        "pkg-0.11.1-beta" = _aXAfLJOE;
        "pkg-0.11.2-beta" = _ZxxCPsqs;
        "pkg-0.11.3-beta" = _ypVYeXMZ;
        "pkg-0.11.4-beta" = _lym6ODt2;
        "pkg-0.11.5-beta" = _3mFtJ0mL;
        "pkg-0.11.6-beta" = _SvvKI0EL;
        "pkg-0.11.7-beta" = _SBkgBxLR;
        "pkg-0.11.8-beta" = _EDAmGq01;
        "pkg-0.11.9-beta" = _vAjReMtu;
        "pkg-0.11.10-beta" = _QoPhJXnF;
        "pkg-0.11.11-beta" = _MFKII7y5;
        "pkg-0.11.12-beta" = _jMTy3bhE;
        "pkg-0.12.0-beta" = _yiUp9n9a;
        "pkg-0.13.0-beta" = _uOWRCEut;
        "pkg-0.13.1-beta" = _yToZBJzC;
        "pkg-0.13.2-beta" = _SWTHEcvf;
        "pkg-0.13.3-beta" = _rDAIjdJn;
        "pkg-0.14.0" = _vYxs340D;
        "pkg-0.14.1" = _Y2AAOIY1;
        "pkg-0.14.2" = _GwX2iUgN;
        "pkg-0.14.3" = _aDzdbexR;
        "pkg-1.0.0-beta" = _VKYzoChV;
        "pkg-1.0.1-beta" = _me5XWMw9;
        "pkg-1.0.2-beta" = _i2mbMwIv;
        "pkg-1.0.3-beta" = _irlHgFIN;
        "pkg-1.0.5-beta" = _ai4ZbjwR;
        "pkg-1.0.6-beta" = _lAYqx06o;
        "pkg-1.0.7-beta" = _cQyMvUcR;
        "pkg-1.0.8-beta" = _R5MXisky;
        "default" = _R5MXisky;
    });
