...
let
    ...
    in {
        ...
        "pkg-1.18.x-1.0.0" = _7ibJmhXj;
        "pkg-1.18.x-1.1.0" = _Vvxij2Ev;
        "pkg-1.18.x-1.1.1" = _6uD7cugc;
        "pkg-1.18.x-1.2.0" = _6rVJCfOK;
        "pkg-1.19-1.2.1" = _ellmLzvg;
        "pkg-1.19-1.3.0+fabric" = _qJKtlZ5Z;
        "pkg-1.19-1.3.0+forge" = _NF7NeBD4;
        "pkg-1.18.2-1.3.0+fabric" = _8BJTnrdg;
        "pkg-1.18.2-1.3.0+forge" = _LY5yBEJy;
        "pkg-1.19.1-1.3.1+fabric" = _kgF1KR0Q;
        "pkg-1.19.1-1.3.1+forge" = _MpxmTxJW;
        "pkg-1.18.2-1.4.0+fabric" = _yx4Rkjaf;
        "pkg-1.18.2-1.4.0+forge" = _1hT4LwC5;
        "pkg-1.19.1-1.4.0+fabric" = _wDQ6ZnZY;
        "pkg-1.19.1-1.4.0+forge" = _gtC7W7w2;
        "pkg-1.18.2-1.4.1+fabric" = _fseCNrGd;
        "pkg-1.18.2-1.4.1+forge" = _P4N5ckiy;
        "pkg-1.19.1-1.4.1+fabric" = _rcntiesv;
        "pkg-1.19.1-1.4.1+forge" = _jLiLhHJX;
        "pkg-1.18.2-1.4.2+fabric" = _O1jb0GZM;
        "pkg-1.18.2-1.4.2+forge" = _AHSFKQhZ;
        "pkg-1.19.1-1.4.2+fabric" = _lD7jzJGF;
        "pkg-1.19.1-1.4.2+forge" = _iCjav34s;
        "pkg-1.20-1.4.2+fabric" = _AbdvRnZx;
        "pkg-1.20-1.4.2+forge" = _jUEV9Wmi;
        "pkg-1.18.2-1.5.0+fabric" = _Lma1yzSs;
        "pkg-1.18.2-1.5.0+forge" = _gIueoFxn;
        "pkg-1.20-1.5.0+fabric" = _8XPZx1AX;
        "pkg-1.20-1.5.0+forge" = _pIuw2Ji8;
        "pkg-1.19.1-1.5.0+fabric" = _R0Ctw19S;
        "pkg-1.19.1-1.5.0+forge" = _R7E8A3ix;
        "pkg-1.18.2-1.5.1+fabric" = _JMSu2F7u;
        "pkg-1.18.2-1.5.1+forge" = _LCHjGGRM;
        "pkg-1.19.1-1.5.1+fabric" = _LfXM5ByD;
        "pkg-1.19.1-1.5.1+forge" = _qq5DMRU2;
        "pkg-1.20-1.5.1+fabric" = _RJeuHy76;
        "pkg-1.20-1.5.1+forge" = _lWhRwRPO;
        "pkg-1.18.2-1.5.2+fabric" = _2ef9PH2w;
        "pkg-1.18.2-1.5.2+forge" = _LEoYQtID;
        "pkg-1.19.1-1.5.2+fabric" = _KJRPV4Mf;
        "pkg-1.19.1-1.5.2+forge" = _A4Yuj9M3;
        "pkg-1.20-1.5.2+fabric" = _3K6uPj89;
        "pkg-1.20-1.5.2+forge" = _RloRxXzj;
        "pkg-1.20.6-1.5.2+fabric" = _mmkX2a1K;
        "pkg-1.20.6-1.5.2+neoforge" = _AU96v8OX;
        "pkg-1.20.6-1.5.3+fabric" = _FLqBdDsf;
        "default" = _FLqBdDsf;
    });
