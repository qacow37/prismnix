...
let
    ...
    in {
        ...
        "pkg-1.12.2-1.0.2.16" = _XBI4v3j6;
        "pkg-1.16.5-2.0.0.17" = _oHi6gXxT;
        "pkg-1.18.2-3.1.0.17" = _sqFUilsc;
        "pkg-1.19.2-3.2.1.15" = _B9Prlm2g;
        "pkg-1.20.1-3.4.0.6" = _hcuDSp9H;
        "pkg-1.12.2-1.0.2.17" = _Jjo18jEg;
        "pkg-1.16.5-2.0.0.18" = _Ei2UjlME;
        "pkg-1.18.2-3.1.0.18" = _WV22EWYk;
        "pkg-1.19.2-3.2.1.16" = _NAQNSprG;
        "pkg-1.20.1-3.4.0.7" = _MXU3ARCi;
        "pkg-1.12.2-1.0.2.18" = _8uAJc55A;
        "pkg-1.16.5-2.0.0.19" = _FCAn1uMG;
        "pkg-1.12.2-1.0.2.19" = _vtDan4e0;
        "pkg-1.12.2-1.0.2.20" = _pFVczz82;
        "pkg-1.18.2-3.1.0.19" = _uH2xvIsr;
        "pkg-1.19.2-3.2.1.17" = _SvpS4OOK;
        "pkg-1.20.1-3.4.0.8" = _GsW7c7cP;
        "pkg-1.20.1-3.4.0.9" = _C031QjR9;
        "pkg-1.12.2-1.0.2.21" = _ZbO4Iydk;
        "pkg-1.16.5-2.0.0.20" = _IItnZmjM;
        "pkg-1.18.2-3.1.0.20" = _ukJLtNV1;
        "pkg-1.19.2-3.2.1.18" = _Bo57hUuE;
        "pkg-1.20.1-3.4.0.10" = _4BXytzOf;
        "pkg-1.12.2-1.0.2.22" = _q2veupqH;
        "pkg-1.16.5-2.0.0.21" = _oQut5jWU;
        "pkg-1.18.2-3.1.0.21" = _eFNFdm2N;
        "pkg-1.19.2-3.2.1.19" = _PHGjF4rh;
        "pkg-1.20.1-3.4.0.11" = _7FBKNnWu;
        "pkg-1.12.2-1.0.2.23" = _8zO8z0oX;
        "pkg-1.16.5-2.0.0.22" = _ODNvMYSU;
        "pkg-1.18.2-3.1.0.22" = _ennaarmw;
        "pkg-1.19.2-3.2.1.20" = _ABS5aL0s;
        "pkg-1.20.1-3.4.0.12" = _fltO6OK4;
        "pkg-1.12.2-1.0.2.24" = _ik50ttaA;
        "pkg-1.12.2-1.0.2.25" = _KJ1EFcAj;
        "pkg-1.16.5-2.0.0.23" = _b23EbSc7;
        "pkg-1.18.2-3.1.0.23" = _v8EnlLer;
        "pkg-1.19.2-3.2.1.21" = _b89QuIn7;
        "pkg-1.20.1-3.4.0.13" = _vC7wh7bD;
        "pkg-1.21.1-4.0.0.0" = _JajvPmn7;
        "pkg-1.21.1-4.0.0.1" = _JAOsVuSp;
        "pkg-1.12.2-1.0.2.26" = _hBVnCXBu;
        "pkg-1.16.5-2.0.0.24" = _APf2LhIG;
        "pkg-1.18.2-3.1.0.24" = _lXOSL5Fj;
        "pkg-1.19.2-3.2.1.22" = _q8JlZwbH;
        "pkg-1.20.1-3.4.0.14" = _HyFy3oz8;
        "pkg-1.21.1-4.0.0.2" = _f2sL9KIW;
        "pkg-1.12.2-1.0.2.27" = _4OPQye8D;
        "pkg-1.16.5-2.0.0.25" = _5Y50wmVn;
        "pkg-1.18.2-3.1.0.25" = _BShJ2YFs;
        "pkg-1.19.2-3.2.1.23" = _9jxAtJob;
        "pkg-1.20.1-3.4.0.15" = _IE5gNxQt;
        "pkg-1.21.1-4.0.0.3" = _GHpRpejL;
        "pkg-1.12.2-1.0.2.28" = _f8HM7Ap1;
        "pkg-1.16.5-2.0.0.26" = _NBQRS1nW;
        "pkg-1.18.2-3.1.0.26" = _7zgTfX9G;
        "pkg-1.19.2-3.2.1.24" = _Tl1RI4wu;
        "pkg-1.20.1-3.4.0.16" = _VlQEZCGR;
        "pkg-1.21.1-4.0.0.4" = _I1gEboIs;
        "pkg-1.18.2-3.1.0.27" = _w8PigauP;
        "pkg-1.21.1-4.0.0.5" = _S31yNVPQ;
        "pkg-1.12.2-1.0.2.29" = _ttbgtLQX;
        "pkg-1.16.5-2.0.0.27" = _N1EBpHgI;
        "pkg-1.18.2-3.1.0.28" = _aAxGQgnZ;
        "pkg-1.19.2-3.2.1.25" = _3pUomN3E;
        "pkg-1.20.1-3.4.0.17" = _8O5EJB1P;
        "pkg-1.21.1-4.0.0.6" = _lhcSLpf8;
        "pkg-1.12.2-1.0.2.30" = _EhxDW00l;
        "pkg-1.16.5-2.0.0.28" = _Q6xszmYz;
        "pkg-1.18.2-3.1.0.29" = _mZuu5QQm;
        "pkg-1.19.2-3.2.1.26" = _UJ0QqLtk;
        "pkg-1.20.1-3.4.0.18" = _pjOOseH7;
        "pkg-1.21.1-4.0.0.7" = _f8dsVUpq;
        "pkg-1.12.2-1.0.2.31" = _kerqnIT5;
        "pkg-1.16.5-2.0.0.29" = _GnjR6wQk;
        "pkg-1.18.2-3.1.0.30" = _cViWr5lz;
        "pkg-1.19.2-3.2.1.27" = _5i5EAtLb;
        "pkg-1.20.1-3.4.0.19" = _O5oG2LIB;
        "pkg-1.21.1-4.0.0.8" = _TsyU1A3E;
        "pkg-1.21.1-4.0.0.9" = _dAnTBf4X;
        "pkg-1.19.2-3.2.1.28" = _K9nX1ipK;
        "pkg-1.20.1-3.4.0.20" = _94MnHtYM;
        "pkg-1.21.1-4.0.0.10" = _afQmIuGU;
        "pkg-1.12.2-1.0.3.32" = _1iLgf0Bw;
        "pkg-1.12.2-1.0.3.33" = _Hj7ZWWKz;
        "pkg-1.19.2-3.2.1.29" = _E9z3L1zZ;
        "pkg-1.20.1-3.4.0.21" = _OFILEfwe;
        "pkg-1.21.1-4.0.0.11" = _wCCJTI3y;
        "default" = _wCCJTI3y;
    });
