...
let
    ...
    in {
        ...
        "pkg-1.7.4" = _iIIsIYe9;
        "pkg-1.7.5" = _NvczwibW;
        "pkg-1.10.0" = _qvuAbKrL;
        "pkg-1.10.1" = _5u3rSucP;
        "pkg-1.10.2" = _nZc5PEDI;
        "pkg-1.10.3" = _s9JFK2Qd;
        "pkg-1.10.4" = _LyRtPIeC;
        "pkg-1.10.5" = _WABfYWVQ;
        "pkg-1.10.6" = _teRunM8I;
        "pkg-1.10.7" = _v8vbZbUI;
        "pkg-1.11.0" = _N4y1sSZD;
        "pkg-1.11.1" = _3KM3rGsI;
        "pkg-1.11.2" = _zb0a2IXz;
        "pkg-1.11.3" = _9iQLvYgC;
        "pkg-1.12.0" = _2MRb9fhm;
        "pkg-1.12.1" = _Op5R0IDG;
        "pkg-1.12.2" = _SmvM9Eg1;
        "pkg-1.12.3" = _K6T9oY5i;
        "pkg-1.12.4" = _RiqJuGRQ;
        "pkg-1.12.6" = _aE968ByA;
        "pkg-1.13.0" = _VOImuVRb;
        "pkg-1.13.1" = _4YQeomLK;
        "pkg-1.13.2" = _motIYIbR;
        "pkg-1.13.3" = _6AjKeqpw;
        "pkg-2.0.0" = _GjCLbROM;
        "pkg-2.1.0-A" = _9RXKlghv;
        "pkg-2.1.0" = _suK7h9SR;
        "pkg-2.1.1" = _ZSQP9iFF;
        "default" = _ZSQP9iFF;
    });
