...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _sFoCLI8p;
        "pkg-1.0.2" = _evIu0OMo;
        "pkg-1.0.2-hotfix" = _ixtFqVP3;
        "pkg-1.0.3" = _Dh2u2oPS;
        "pkg-1.0.3-hotfix" = _aZTH92tl;
        "pkg-1.0.4" = _9ceZBZoV;
        "pkg-1.0.4-hotfix" = _8Mub49i5;
        "pkg-1.0.5" = _ncnWENO0;
        "pkg-1.0.5-hotfix" = _ajFKhHhk;
        "pkg-1.1.0" = _mQkqc4Ng;
        "pkg-1.1.0-hotfix" = _C6pMndDz;
        "pkg-1.1.1" = _a4MCZInI;
        "pkg-1.1.2" = _lDqeljFC;
        "pkg-1.1.2-serverfix" = _QCamtoY0;
        "pkg-1.1.3" = _Vtd8PeOW;
        "pkg-1.1.4" = _fPDEeYMR;
        "pkg-1.1.5.1" = _8YUrp23P;
        "pkg-1.2.0-beta" = _a1m9n1C9;
        "pkg-1.2.0-260104" = _WQRTbrQi;
        "pkg-1.2.0-260110" = _88iUlGeU;
        "pkg-1.2.0-260125" = _6qv5ye31;
        "pkg-1.2.1-260128" = _dQtImrze;
        "pkg-1.2.2-260208" = _DuYw503t;
        "pkg-1.2.3.3-260215" = _16WhJIcI;
        "pkg-1.2.4-260226" = _SvvNcTJh;
        "default" = _SvvNcTJh;
    });
