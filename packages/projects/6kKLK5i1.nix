...
let
    ...
    in {
        ...
        "pkg-0.0.3-1.20.1" = _7q54Oe5r;
        "pkg-0.1.0-1.20.4" = _qe1lWnQb;
        "pkg-0.1.0-1.20.1" = _i8DP8YmM;
        "pkg-0.2.0-1.20.4" = _fdwQiZmE;
        "pkg-0.2.0-1.20.1" = _c7SE38l6;
        "pkg-0.2.1-1.19.4" = _xZWHsOZh;
        "pkg-0.2.1-1.20.1" = _44PIpJNP;
        "pkg-0.2.1-1.20.4" = _SsphfqG9;
        "pkg-0.2.2-1.19.4" = _36UbKgEi;
        "pkg-0.2.2-1.20.1" = _vmvX2AHD;
        "pkg-0.2.2-1.20.4" = _rqjdwsXT;
        "pkg-0.2.3-1.19.4" = _dUcv9jH0;
        "pkg-0.2.3-1.20.1" = _hFDmJFUa;
        "pkg-0.2.3-1.20.4" = _rW6KSrdu;
        "pkg-0.3.0-1.19.4" = _9So4vCop;
        "pkg-0.3.0-1.20.1" = _36rMtYxa;
        "pkg-0.3.0-1.20.4" = _LMwDEd8Y;
        "pkg-0.4.0-1.19.4" = _K8p5eMcH;
        "pkg-0.4.0-1.20.1" = _Mp22F1iS;
        "pkg-0.4.0-1.20.4" = _zQKS59XZ;
        "pkg-0.4.1-1.19.4" = _MAgrym7m;
        "pkg-0.4.1-1.20.1" = _FMilqdjK;
        "pkg-0.4.1-1.20.4" = _QcXkgGKD;
        "pkg-0.4.2-1.19.4" = _WL2lJSZL;
        "pkg-0.4.2-1.20.1" = _hMApsHkh;
        "pkg-0.4.2-1.20.4" = _eVBx4s7P;
        "pkg-0.4.3-1.19.4" = _jcbtzOc0;
        "pkg-0.4.3-1.20.1" = _zq06O7HY;
        "pkg-0.4.3-1.20.4" = _RItkyIMe;
        "pkg-0.4.4-1.19.4" = _dmFH7UPg;
        "pkg-0.4.4-1.20.1" = _dsXtKXOr;
        "pkg-0.4.4-1.20.4" = _tWq61ptq;
        "pkg-0.4.5-1.19.4" = _cMtGSzP5;
        "pkg-0.4.5-1.20.1" = _aA1kbETk;
        "pkg-0.4.5-1.20.4" = _nOXOwuuY;
        "pkg-0.4.6-beta.1-1.20.5+6" = _3hJfPPQR;
        "pkg-0.4.6-beta.1-1.21" = _ba9j1hua;
        "pkg-0.4.6-beta.2-1.21" = _izTCii1G;
        "pkg-0.5.0-1.21.1" = _F0YdmTfM;
        "pkg-0.5.1-1.21.1" = _Djq2ijK4;
        "pkg-0.5.2-1.21.1" = _qcRPvSRZ;
        "pkg-0.5.3-beta.1-1.21.3" = _m7QhGKr0;
        "pkg-0.6.0-1.21.6" = _xKrfLAPd;
        "pkg-0.6.1-1.21.6" = _wtofBgF6;
        "pkg-0.6.2-1.21.7" = _G8qBmIqE;
        "pkg-0.6.3-1.21.7" = _gUdDVjkh;
        "pkg-0.6.4-1.21.7" = _sg449PAp;
        "pkg-0.6.5-1.20.1" = _WtI0ij1r;
        "pkg-0.6.5-1.21.1" = _w5LZtz90;
        "pkg-0.6.5-1.21.4" = _XRc08KdX;
        "pkg-0.6.5-1.21.8" = _gOltxAo0;
        "pkg-0.6.6-1.21.8" = _mu71CLq0;
        "pkg-0.6.7-1.21.9" = _3BvdQhFr;
        "pkg-0.6.7-1.21.10" = _FeZEWBho;
        "pkg-0.6.7-1.21.11" = _uMh1n2JH;
        "pkg-0.6.8-1.21.11" = _bwlDmGK6;
        "pkg-0.6.9-1.21.11" = _SuBm6bqA;
        "pkg-0.7.0-26.1.1" = _b8MS6g1l;
        "pkg-0.7.1-26.1.1" = _bNtpTKYV;
        "pkg-0.7.2-26.1.1" = _xjCQvxFf;
        "pkg-0.7.3-26.1.1" = _5yknCiSy;
