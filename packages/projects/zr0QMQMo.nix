...
let
    ...
    in {
        ...
        "pkg-2.13.8-build-8" = _OH1xLluU;
        "pkg-2.13.9-build-9" = _ERSi6Bid;
        "pkg-2.13.10-build-10" = _Bdnijx1x;
        "pkg-2.13.10-build-12" = _UC4Zw5uc;
        "pkg-2.13.10-build-14" = _uLlcyjbp;
        "pkg-2.13.10-build-15" = _VrnWxa0L;
        "pkg-1.0.1" = _jtgxOHNA;
        "pkg-1.0.2" = _1tCKgv2D;
        "pkg-2.0.0" = _sZloD5D6;
        "pkg-3.3.0-build-0" = _GYl73pN0;
        "pkg-3.3.0-build-2" = _TACX8JQC;
        "pkg-2.1.0" = _vE4dPp5A;
        "pkg-2.2.0" = _K6NLzgWh;
        "pkg-3.3.1-build-0" = _1qV9Ew3X;
        "pkg-3.3.1-build-2" = _8ZVXN2iP;
        "pkg-3.3.1-build-3" = _B8lHtBKc;
        "pkg-3.3.1-build-4" = _7yF7bAsh;
        "pkg-3.3.1-build-5" = _p82GAsdS;
        "pkg-3.0.0" = _RaThXdt5;
        "pkg-3.3.3-build-3" = _UHwnzk4T;
        "pkg-3.3.3-build-6" = _E9BimtAr;
        "pkg-3.3.3-build-9" = _EldQSm0v;
        "pkg-3.3.3-build-10" = _aAFxAUOr;
        "pkg-3.3.3-build-12" = _AcSFfV9D;
        "pkg-3.3.3-build-15" = _xBkDCg1o;
        "pkg-3.5.0-build-1" = _i5wFABRl;
        "pkg-3.1.2" = _hFiNqs6b;
        "pkg-3.1.3" = _rEqMYJsw;
        "pkg-3.5.1-build-2" = _FeYgRO0W;
        "pkg-3.1.6" = _P24F5owr;
        "pkg-3.6.2-build-0" = _4VzniFmS;
        "pkg-3.1.8" = _rtASbMPr;
        "pkg-3.7.1-build-2" = _C00fhAK1;
        "pkg-3.7.1-build-11" = _WG1FLeZM;
        "pkg-3.7.3-build-12" = _AtUtAptS;
        "pkg-4.0.2" = _fn2wpGIN;
        "pkg-4.0.0-mc26.1.2-3.8.3" = _asZhnVh7;
        "pkg-4.0.4" = _96w3OO9P;
        "pkg-4.0.4-mc26.1.2-3.8.3-neoforge" = _dEsIIX5y;
        "pkg-4.0.4-mc26.1.2-3.8.3-forge" = _24Lvboa0;
        "pkg-4.0.5-mc26.1.2-3.8.3-neoforge" = _VLIf29jX;
        "pkg-4.0.5-mc26.1.2-3.8.3-forge" = _UUsi9TfD;
        "pkg-5.0.0" = _K9AlV4CU;
        "pkg-5.0.1-mc26.1.2-3.8.4-neoforge" = _DL3cXhAc;
        "pkg-5.0.1-mc26.1.2-3.8.4-forge" = _qo1XSh4g;
        "pkg-5.0.3-mc26.1.2-3.8.4-neoforge" = _MlDmxgsh;
