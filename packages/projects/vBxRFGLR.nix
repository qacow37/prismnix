...
let
    ...
    in {
        ...
        "pkg-mc1.16.5-v0.1.1" = _1IbpcPB9;
        "pkg-mc1.19.4-v0.1.1" = _wcKxmefZ;
        "pkg-mc1.20.4-v0.1.1" = _gftKZIVS;
        "pkg-mc1.17.1-v0.1.1" = _Jn029RWM;
        "pkg-mc1.20-v0.1.1" = _VO5za05I;
        "pkg-mc1.20.3-v0.1.1" = _YXH8FrDQ;
        "pkg-mc1.20.1-v0.1.1" = _g388DdoH;
        "pkg-mc1.20.2-v0.1.1" = _RANIuYkY;
        "pkg-mc1.18.2-v0.1.1" = _1HYRLCn2;
        "pkg-mc1.20.1-v0.1.2" = _vv95dRVJ;
        "pkg-mc1.20.3-v0.1.2" = _Ys9R80xE;
        "pkg-mc1.20.4-v0.1.2" = _yiP2m4nh;
        "pkg-mc1.19.4-v0.1.2" = _Mnz89oVh;
        "pkg-mc1.17.1-v0.1.2" = _RVTlOnOK;
        "pkg-mc1.20.2-v0.1.2" = _cAiRiG6B;
        "pkg-mc1.16.5-v0.1.2" = _SEVlJMn0;
        "pkg-mc1.20-v0.1.2" = _KcaTNQCE;
        "pkg-mc1.18.2-v0.1.2" = _eIbG7x54;
        "pkg-mc1.17.1-v0.1.3" = _EoEevODp;
        "pkg-mc1.18.2-v0.1.3" = _t4Hx8N5q;
        "pkg-mc1.20-v0.1.3" = _eRoWw84N;
        "pkg-mc1.19.4-v0.1.3" = _VLuUy0hv;
        "pkg-mc1.20.5-v0.1.3" = _GdjfOLSL;
        "pkg-mc1.20.1-v0.1.3" = _LnHPQwfP;
        "pkg-mc1.20.3-v0.1.3" = _1HzoGIBj;
        "pkg-mc1.20.2-v0.1.3" = _EQGjkngv;
        "pkg-mc1.20.4-v0.1.3" = _dc95TtX7;
        "pkg-mc1.16.5-v0.1.3" = _UOHurQkl;
        "pkg-mc1.17.1-v0.1.4" = _58xptvbH;
        "pkg-mc1.18.2-v0.1.4" = _GuvUxs4J;
        "pkg-mc1.19.4-v0.1.4" = _n4Seyh3T;
        "pkg-mc1.20-v0.1.4" = _WaUgJFAZ;
        "pkg-mc1.20.3-v0.1.4" = _HuqgjPAd;
        "pkg-mc1.20.5-v0.1.4" = _oXFp1T1Z;
        "pkg-mc1.16.5-v0.1.4" = _rW5t3lQg;
        "pkg-mc1.20.2-v0.1.4" = _K0zGglpM;
        "pkg-mc1.20.1-v0.1.4" = _iXdEeJdA;
        "pkg-mc1.20.4-v0.1.4" = _t0uxDK5J;
        "pkg-mc1.17.1-v0.1.5" = _LH9WXGPE;
        "pkg-mc1.18.2-v0.1.5" = _gLXp7o8q;
        "pkg-mc1.20.2-v0.1.5" = _VU0q0GeC;
        "pkg-mc1.16.5-v0.1.5" = _Q5W9kXRa;
        "pkg-mc1.20.4-v0.1.5" = _sZ5uasJK;
        "pkg-mc1.20-v0.1.5" = _7rifwSpo;
        "pkg-mc1.20.1-v0.1.5" = _mZrdtIL8;
        "pkg-mc1.20.3-v0.1.5" = _K1UFyMy5;
        "pkg-mc1.20.5-v0.1.5" = _D0gN2bHH;
        "pkg-mc1.19.4-v0.1.5" = _KO80tkUc;
        "pkg-mc1.20.6-v0.1.5" = _LsGLT97p;
        "pkg-mc1.16.5-v0.1.6" = _j8XcAbZp;
        "pkg-mc1.19.4-v0.1.6" = _H00BTj8g;
        "pkg-mc1.18.2-v0.1.6" = _Vk8sg9T1;
        "pkg-mc1.17.1-v0.1.6" = _q1vbRY1J;
        "pkg-mc1.20.4-v0.1.6" = _Mhbn9FQJ;
        "pkg-mc1.20.1-v0.1.6" = _279HaGRO;
        "pkg-mc1.20.6-v0.1.6" = _BbKtqSOn;
        "pkg-mc1.20.5-v0.1.6" = _9kh0akli;
        "pkg-mc1.20-v0.1.6" = _dUhzni07;
        "pkg-mc1.21-v0.1.6" = _4WHmkHDr;
        "pkg-mc1.20.3-v0.1.6" = _xqhNLHL6;
        "pkg-mc1.20.2-v0.1.6" = _P45Bhu4g;
        "pkg-mc1.17.1-v0.1.7" = _gYolQisr;
        "pkg-mc1.20.3-v0.1.7" = _FIAvk3OD;
        "pkg-mc1.21-v0.1.7" = _L7eqiqwB;
        "pkg-mc1.20.2-v0.1.7" = _y9Yp0Nfy;
        "pkg-mc1.16.5-v0.1.7" = _o6ce6HfM;
        "pkg-mc1.20-v0.1.7" = _6nzdlbkp;
        "pkg-mc1.19.4-v0.1.7" = _R2qV2XzW;
        "pkg-mc1.20.1-v0.1.7" = _5b4WxHjz;
        "pkg-mc1.20.6-v0.1.7" = _6tq0xGqB;
        "pkg-mc1.20.5-v0.1.7" = _D7aiGQeH;
        "pkg-mc1.18.2-v0.1.7" = _9R5DHMB8;
        "pkg-mc1.20.4-v0.1.7" = _c0wHUynk;
        "pkg-mc1.21.1-v0.1.7" = _7Xxfbmif;
        "pkg-mc1.20.6-v0.1.8" = _jHbSBhg0;
        "pkg-mc1.17.1-v0.1.8" = _frW6i4b0;
        "pkg-mc1.19.4-v0.1.8" = _QyZ6ZDNf;
        "pkg-mc1.21.4-v0.1.8" = _xT7wzyVM;
        "pkg-mc1.16.5-v0.1.8" = _96cZWMNa;
        "pkg-mc1.18.2-v0.1.8" = _C2ZMUKG5;
        "default" = _C2ZMUKG5;
    });
