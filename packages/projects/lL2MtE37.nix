...
let
    ...
    in {
        ...
        "pkg-3.13.21" = _UIgEX1gX;
        "pkg-3.10.16" = _2ZnkNT15;
        "pkg-3.10.17" = _zkEQntV6;
        "pkg-3.4.18" = _2CWlpXcj;
        "pkg-3.6.13" = _VEhpYK9d;
        "pkg-3.5.12" = _LEn8WmfQ;
        "pkg-3.5.10" = _7vXt7xVY;
        "pkg-3.10.18" = _pWZvwgZh;
        "pkg-3.10.18-1.18.2-Fabric" = _RhEGclON;
        "pkg-3.14.0" = _PSg6ciMe;
        "pkg-3.14.1" = _reIAsA4D;
        "pkg-3.15.1" = _iNK686xh;
        "pkg-3.16.0" = _gd0lRift;
        "pkg-3.17.0" = _QPGXdFQ8;
        "pkg-3.18.0" = _HmQSWFFH;
        "pkg-3.19.0" = _GGC87TYn;
        "pkg-3.20.0" = _QfTnZV1z;
        "pkg-3.17.1" = _fu26Y8zs;
        "pkg-3.20.1" = _8519rGNm;
        "pkg-1.20.1-3.17.1" = _fSEWl89B;
        "pkg-3.17.2" = _QpHjZgDn;
        "pkg-3.20.2" = _XSodJ47q;
        "pkg-3.20.3" = _Vg54emzq;
        "pkg-3.20.4" = _FRuLJsBp;
        "default" = _FRuLJsBp;
    });
