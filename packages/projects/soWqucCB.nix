...
let
    ...
    in {
        ...
        "pkg-1.19.2-2" = _lFMrj9Cs;
        "pkg-1.19.2-3a" = _DIuO26Lc;
        "pkg-1.19.2-3b" = _mFAHU4h0;
        "pkg-1.19.2-3c" = _MrcFc35O;
        "pkg-1.18.2-3c" = _d4pC9Fho;
        "pkg-1.19.2-3d" = _RtyPHwMa;
        "pkg-1.19.2-4" = _sg0o9rhU;
        "pkg-1.19.2-4a" = _grbjrTJw;
        "pkg-1.19.2-4b" = _6UWS7mO4;
        "pkg-1.19.2-4c" = _Y4n2J3iN;
        "pkg-1.19.2-4d" = _Kq0bvfs6;
        "pkg-1.19.2-4e" = _bGPTvnw3;
        "pkg-1.19.2-4f" = _HJUMHeMc;
        "pkg-1.19.2-5" = _Rp1RsAR1;
        "pkg-1.19.2-5a" = _N1CiqUoi;
        "pkg-1.19.2-5b" = _6c9ZajvR;
        "pkg-1.20.1-5b" = _TA3XKhZ8;
        "pkg-1.19.2-5c" = _pIXkN0Ek;
        "pkg-1.20.1-5c" = _rCPNt4IA;
        "pkg-1.19.2-5d" = _PCYSbBz4;
        "pkg-1.20.1-5d" = _fkOJO1Th;
        "pkg-1.19.2-5e" = _mqkzthMi;
        "pkg-1.19.2-6" = _lOrDjklU;
        "pkg-1.20.1-6" = _mZs7WXib;
        "pkg-1.19.2-6a" = _B1xmQ6N6;
        "pkg-1.20.1-6a" = _qQHKtMGz;
        "pkg-1.20.1-6b" = _gwauJTdu;
        "pkg-1.19.2-6b" = _IAeicVCc;
        "pkg-1.19.2-7" = _ZZQDeA3Q;
        "pkg-1.20.1-7" = _CWdsp92K;
        "pkg-1.20.1-7a" = _6zlAVbdx;
        "pkg-1.18.2-3d" = _4AfnzWD7;
        "pkg-1.19.2-7a" = _ICPJ1IGX;
        "pkg-1.20.1-7b" = _gGLrIPgm;
        "pkg-1.20.1-7c" = _ilCfbKZq;
        "pkg-1.19.2-7b" = _qyNrjQ7a;
        "pkg-1.20.1-7d" = _HVlML6Po;
        "pkg-1.20.1-7e" = _6HWoKOIT;
        "pkg-1.20.1-8" = _Vbdb1wLz;
        "pkg-1.19.2-7c" = _NC40eRmK;
        "pkg-1.20.1-8a" = _T1NRffJb;
        "pkg-1.19.2-7d" = _JpoDbFeM;
        "pkg-1.20.1-8b" = _sau0l5uV;
        "pkg-1.20.1-8c" = _cXwZviY0;
        "pkg-1.19.2-7e" = _UhLP55pY;
        "pkg-1.20.1-8d" = _v4GEo93Y;
        "pkg-1.20.1-8e" = _3QnqLhK5;
        "pkg-1.21.1-9" = _l3qDYkP8;
        "pkg-1.20.1-8f" = _zlZfEyJa;
        "pkg-1.21.1-9a" = _NUjzgZY5;
        "pkg-1.21.1-9b" = _soJKBwF8;
        "pkg-1.21.1-9c" = _YGPCd2VP;
        "pkg-1.20.1-8g" = _VPL57LkM;
        "pkg-1.21.1-9d" = _1wdxkEK3;
        "pkg-1.20.1-8h" = _NyKIoGAy;
        "pkg-1.21.1-9e" = _Vsu7sPJd;
        "pkg-1.21.1-9f" = _7LcmBb5h;
        "pkg-1.20.1-8i" = _3CTjfDSS;
        "pkg-1.21.1-9g" = _SbU3YBKn;
        "pkg-1.21.1-9h" = _11k99M0f;
        "pkg-1.21.1-9i" = _GDVnGlfE;
        "pkg-1.21.1-9j" = _fTcKOm3o;
        "pkg-1.20.1-9j.0" = _b9Z7K0GH;
        "pkg-1.20.1-9j.1" = _nUO8htkH;
        "pkg-1.21.1-9k.0" = _deJcaHsX;
        "pkg-1.20.1-9k.0" = _npoGAFwW;
        "pkg-1.20.1-9l.0" = _WJ6SyuRi;
        "pkg-1.21.1-9l.0" = _zrjIitOy;
        "pkg-1.21.1-9.13.0" = _k2K2PI2D;
        "pkg-1.20.1-9.13.0" = _QbBAbwxm;
        "pkg-1.20.1-9.13.1" = _UJ5AwiOr;
        "pkg-1.21.1-9.13.1" = _VDnbm4SW;
        "pkg-1.21.1-9.13.2" = _RgTwzQgN;
        "pkg-1.20.1-9.13.2" = _e2O6OPch;
        "pkg-1.20.1-9.13.3" = _sYvn87bA;
        "pkg-1.21.1-9.14.0" = _xsKGSBEF;
        "pkg-1.20.1-9.14.0" = _C5UIlvAv;
        "pkg-1.20.1-9.14.1" = _wPzw0NRn;
        "pkg-1.21.1-9.14.1" = _I250QUQk;
        "pkg-1.21.1-9.14.2" = _khDYODFS;
        "pkg-1.20.1-9.14.2" = _lzBdaeF5;
        "pkg-1.21.1-9.14.3" = _rFhrbXQu;
        "pkg-1.20.1-9.14.3" = _mAuo7yOZ;
        "pkg-1.20.1-9.15.0" = _FdSAlJoF;
        "pkg-1.21.1-9.15.0" = _RTZNhek0;
        "pkg-1.21.1-9.15.1" = _6fpPLyhh;
        "pkg-1.20.1-9.15.1" = _Iayfvyfb;
        "pkg-1.21.1-9.15.2" = _qtU7FZrH;
        "pkg-1.20.1-9.15.2" = _qz4dgUL6;
        "pkg-1.21.1-9.16.0" = _7pDyRKd6;
        "pkg-1.20.1-9.16.0" = _UWczt92i;
        "pkg-1.20.1-9.16.0a" = _5m3Yaxfq;
        "pkg-1.21.1-9.16.1" = _zNhc9VUx;
        "pkg-1.20.1-9.16.1" = _DYTF0MMB;
        "pkg-1.21.1-9.16.2" = _vHiFEMsv;
        "pkg-1.20.1-9.16.2" = _Ba32uuiY;
        "pkg-1.21.1-9.17.0" = _TqbKS2NO;
        "pkg-1.20.1-9.17.0" = _ivDT5DeO;
        "pkg-1.21.1-9.18.0" = _Vu9IfKnV;
        "pkg-1.20.1-9.18.0" = _xhZaLemM;
        "pkg-1.20.1-9.18.1" = _JtTlj3uP;
        "pkg-1.21.1-9.18.1" = _SS85KaeN;
        "pkg-1.20.1-9.18.2" = _uWKOFiT8;
        "pkg-1.21.1-9.18.2" = _JjZtq6QB;
        "pkg-1.21.1-9.18.3" = _m4zvINvE;
        "pkg-1.20.1-9.18.3" = _hSSPLsvg;
        "pkg-1.20.1-9.18.4" = _DL60XzAB;
        "pkg-1.21.1-10.0.0" = _SxuWt1hi;
        "pkg-1.21.1-10.0.1" = _lFEGg3Dg;
        "pkg-1.20.1-9.18.5" = _8Z09kwyN;
        "pkg-1.20.1-10.0.1" = _isygnSev;
        "pkg-1.20.1-10.0.2" = _s7ILokqu;
        "pkg-1.20.1-10.0.3" = _Dvalauz0;
        "pkg-1.21.1-10.0.2" = _a7da3pPf;
        "pkg-1.20.1-10.0.4" = _Uv6Ue7xo;
        "pkg-1.21.1-10.1.0" = _tN0or6rT;
        "pkg-1.20.1-10.1.0" = _ZAvRLOZz;
        "pkg-1.21.1-10.1.1" = _uMY9EVae;
        "pkg-1.20.1-10.1.1" = _LcgItT6Q;
        "pkg-1.21.1-10.1.2" = _BHmQzJvc;
        "pkg-1.21.1-10.1.3" = _2GyqfAMk;
        "pkg-1.20.1-10.1.3" = _s4U8tYt8;
        "pkg-1.20.1-10.1.4" = _UhOu37Kb;
