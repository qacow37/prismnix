...
let
    ...
    in {
        ...
        "pkg-0.14.15.0" = _l0HQ8nSH;
        "pkg-0.14.15.1" = _iFR5HWJi;
        "pkg-0.14.15.2" = _eRiVJijt;
        "pkg-0.14.15.3" = _1HU4PVFV;
        "pkg-0.14.15.4" = _9Lz2DrOS;
        "pkg-0.14.15.5" = _Uls8ReFr;
        "pkg-0.14.15.6" = _qZza8NIZ;
        "pkg-0.14.16.0" = _l1m28uSv;
        "pkg-0.14.16.1" = _eCtgTuuY;
        "pkg-0.14.16.2" = _LUz8UDQo;
        "pkg-0.15.0.0+rc1" = _BB2OMK2C;
        "pkg-0.15.1.0" = _Pmi3e5lp;
        "pkg-0.15.2.0" = _Tj2ns3IR;
        "pkg-0.15.3.0" = _18oAgJEq;
        "pkg-0.15.3.1" = _YCXJJyBz;
        "pkg-0.15.3.2" = _mcDWXvlw;
        "pkg-0.15.3.3-rc1" = _Pe0zD0Ox;
        "pkg-0.15.3.3-rc2" = _x2Wm71cT;
        "pkg-0.16.1.0-rc1" = _YhBPo5m0;
        "pkg-0.16.1.0-rc2" = _RSKjJTCh;
        "pkg-0.16.2.0-rc1" = _uQWaBH5X;
        "pkg-0.16.2.0-rc2" = _IM7siJ4D;
        "pkg-0.16.3.0-rc1" = _aPN3dDD6;
        "pkg-0.16.4.0-rc1" = _aArRXUPy;
        "pkg-0.16.4.0" = _2kp3C9qJ;
        "pkg-0.16.4.1" = _Fo0hi2z7;
        "default" = _Fo0hi2z7;
    });
