...
let
    ...
    in {
        ...
        "pkg-NeoForge-1.2.0-1.20.1" = _GVlT6KZg;
        ...
        "pkg-NeoForge-2.0.0-1.20.1" = _aiytLsK4;
        ...
        "pkg-NeoForge-2.2.0-1.20.1" = _dSmgYvyK;
        ...
        "pkg-NeoForge-2.3.0-1.20.1" = _OCwMlEzF;
        "pkg-Fabric_Quilt-2.3.1-1.20.1" = _hOybVd6i;
        "pkg-NeoForge-2.3.1-1.20.1" = _VSL3TJmL;
        "pkg-Fabric_Quilt-2.4.0-1.20.1" = _8mEtiz3s;
        "pkg-NeoForge-2.4.0-1.20.1" = _4I48Qcqe;
        "default" = _4I48Qcqe;
    });
