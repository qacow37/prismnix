...
let
    ...
    in {
        ...
        "pkg-3.7.4" = _eFQGe5QO;
        "pkg-3.7.5" = _SOwMLAPA;
        "pkg-3.7.5.1" = _hn5V0KK3;
        "pkg-3.7.5.2" = _sYoruNyE;
        "pkg-3.7.6" = _auVsPVtX;
        "pkg-3.7.7" = _Boh5hKx4;
        "pkg-3.7.7.1" = _NYokFhPl;
        "pkg-4.0.0" = _84IbCGwv;
        "pkg-4.0.1" = _xiOltxwf;
        "pkg-4.0.2" = _oFixz99h;
        "pkg-4.0.3" = _SnuspqWD;
        ...
        "pkg-4.6.1" = _tkNqNlRN;
        "pkg-4.6.2" = _LKYsQxii;
        "pkg-4.6.2.1" = _eih3TNq2;
        "pkg-4.6.2.2" = _UDXHPoxX;
        "pkg-4.6.2.4" = _CWYQF4By;
        "pkg-4.6.2.5" = _onbKdSBH;
        "pkg-4.6.2.6" = _CKm1gDy6;
        "pkg-4.6.2.7" = _YDOk2fMG;
        "pkg-4.6.2.8" = _FrorfYpN;
        "pkg-4.6.2.9" = _o0mknIqC;
        "pkg-5.0.0" = _oXFZnEMD;
        "pkg-5.1.0" = _GNB3woPs;
        "pkg-5.1.1" = _9g9puecc;
        "pkg-5.1.2" = _feZxeNkq;
