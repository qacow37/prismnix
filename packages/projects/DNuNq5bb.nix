...
let
    ...
    in {
        ...
        "pkg-v1.1" = _uJnNm1LG;
        "pkg-1.1" = _klEX9Ka0;
        "pkg-1.1+mod" = _I9rdoQZE;
        "pkg-v1.2" = _EwPScxPU;
        "pkg-v1.2+mod" = _HSYPLZOO;
        "pkg-v2" = _5AAIrzsA;
        "pkg-v2+mod" = _sI52k2jg;
        "pkg-v2.1" = _OGSSyy04;
        "pkg-v2.1+mod" = _vB8zbHWo;
        "pkg-v2.2" = _thr3Scem;
        "pkg-v2.2+mod" = _TcOh4Tix;
        "pkg-v3" = _8zZM9K5K;
        "pkg-v3+mod" = _OAp3Xokm;
        "pkg-v3.1" = _D2pj9RNq;
        "pkg-v3.1+mod" = _Ioz7I1Ha;
        "pkg-v3.2" = _4EW5Fyw1;
        "pkg-v3.2+mod" = _Bbc1hi1x;
        "pkg-v3.2.1" = _ArLV6MOw;
        "pkg-v3.2.1+mod" = _qXoudgdX;
        "pkg-v3.2.2" = _Lge90hHv;
        "pkg-v3.2.2+mod" = _rhOwuVUY;
        "pkg-3.2.3" = _z8x5GJoh;
        "pkg-3.2.3+mod" = _6ysxbv2i;
        "pkg-3.3" = _1AQICtEv;
