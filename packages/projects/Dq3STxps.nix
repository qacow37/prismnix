...
let
    ...
    in {
        ...
        "pkg-0.3.0-beta-1.19.2" = _tfKnhqiN;
        "pkg-0.3.0-beta-1.20.1" = _LoUFTIUl;
        "pkg-0.4.0-beta-1.18.2" = _r7Ajq4vP;
        "pkg-0.4.0-beta-1.19.2" = _u4yYaJIN;
        "pkg-0.4.0-beta" = _eb8NKRGN;
        "pkg-0.4.1-beta-1.18.2" = _YlLjNQ00;
        "pkg-0.4.1-beta-1.19.2" = _Y6GeyKkw;
        "pkg-0.4.1-beta-1.20.1" = _aLFHc6EA;
        "pkg-0.5.1-beta-1.18.2" = _8afLvFFn;
        "pkg-0.5.1-beta-1.19.2" = _bQYNnzNb;
        "pkg-0.5.1-beta-1.20.1" = _YaI3hpbO;
        "pkg-0.5.2-beta-1.18.2-forge" = _oWGFOMed;
        "pkg-0.5.2-beta-1.19.2-forge" = _NUxxOkAF;
        "pkg-0.5.2-beta-1.20.1-forge" = _iGw0N7j9;
        "pkg-0.5.2-beta-1.18.2-fabric" = _sdRdlyYR;
        "pkg-0.5.2-beta-1.19.2-fabric" = _yAo3OH96;
        "pkg-0.5.2-beta-1.20.1-fabric" = _nsOGsaH3;
        "pkg-0.5.3-beta-1.18.2-forge" = _ccY2yk6e;
        "pkg-0.5.3-beta-1.19.2-forge" = _i9Xk79Z5;
        "pkg-0.5.3-beta-1.20.1-forge" = _SncJ9EQt;
        "pkg-0.5.3-beta-1.18.2-fabric" = _qVH7Rw7o;
        "pkg-0.5.3-beta-1.19.2-fabric" = _D90FSbwo;
        "pkg-0.5.3-beta-1.20.1-fabric" = _5lYRaouO;
        "pkg-1.18.2-0.5.4" = _k6Zd9ybf;
        "pkg-1.19.2-0.5.4" = _VtQJVr4C;
        "pkg-1.20.1-0.5.4" = _dJMFMXMl;
        "pkg-1.20.1-0.5.5" = _mQxmHtke;
        "pkg-1.18.2-0.6.0" = _NvLLZECR;
        "pkg-1.19.2-0.6.0" = _pTbLDBBn;
        "pkg-1.20.1-0.6.0" = _kOUp11TX;
        "pkg-1.18.2-beta-0.7.0" = _I9l6TZKg;
        "pkg-1.19.2-beta-0.7.0" = _50ZUn6zd;
        "pkg-1.20.1-beta-0.7.0" = _9ptcjVtR;
        "pkg-1.18.2-beta-0.7.1" = _Glz3sCTU;
        "pkg-1.19.2-beta-0.7.1" = _D3bs90H2;
        "pkg-1.20.1-beta-0.7.1" = _62Gvkkdt;
        "pkg-1.18.2-beta-0.7.2" = _l7qb7ILT;
        "pkg-1.19.2-beta-0.7.2" = _mZweRgu2;
        "pkg-1.20.1-beta-0.7.2" = _zjTf90Sp;
        "pkg-1.18.2-beta-0.8.0" = _F3buI16w;
        "pkg-1.19.2-beta-0.8.0" = _vnyPX171;
        "pkg-1.20.1-beta-0.8.0" = _jb6dTIwq;
        "pkg-1.21.1-beta-0.8.0" = _IZbEm5Qs;
        "pkg-1.21.1-beta-0.8.1" = _d3EsaCji;
        "pkg-1.18.2-beta-0.8.2" = _IIFgcxWR;
        "pkg-1.19.2-beta-0.8.2" = _MzOiwlSd;
        "pkg-1.20.1-beta-0.8.2" = _kjKo6fJP;
        "pkg-1.20.1-beta-0.8.2-C6" = _jJccXzci;
        "pkg-1.18.2-beta-0.8.3" = _mHxJ9Zr2;
        "pkg-1.19.2-beta-0.8.3" = _8t4SkUNG;
        "pkg-1.20.1-beta-0.8.3" = _VHMtYM00;
        "pkg-1.20.1-beta-0.8.3-C6" = _VooLiYLH;
        "pkg-1.21.1-beta-0.8.3" = _NcmaWJXb;
        "pkg-1.18.2-beta-0.8.4" = _6HMbIJXI;
        "pkg-1.19.2-beta-0.8.4" = _Fdo0t46K;
        "pkg-1.20.1-beta-0.8.4" = _8iFL4Oi0;
        "pkg-1.20.1-beta-0.8.4-C6" = _1el6zRxn;
        "pkg-1.21.1-beta-0.8.4" = _EJvkRqz0;
        "pkg-1.20.1-beta-0.8.5-C6" = _iStEvxzQ;
        "pkg-1.21.1-beta-0.8.5" = _PrbRAPGr;
        "pkg-1.20.1-alpha-0.9.0-1-C6" = _qiy5LFDZ;
        "pkg-1.20.1-alpha-0.9.0-C6+2" = _KozSbhw6;
        "pkg-1.21.1-alpha-0.9.0-C6+2" = _9tbJbgG6;
        "pkg-1.20.1-beta-0.9.0-C6" = _TLhXHRkU;
