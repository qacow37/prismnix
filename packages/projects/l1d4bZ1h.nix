...
let
    ...
    in {
        ...
        "pkg-4.16.12.0" = _1mmbL7zd;
        "pkg-4.16.12.1" = _BkxUawCM;
        "pkg-4.16.13.0" = _mpnL3aRg;
        "pkg-4.16.14.0" = _GdMUcvwa;
        "pkg-4.16.14.1" = _h8seEawx;
        "pkg-4.16.15-beta.1" = _Fw5piY1b;
        "pkg-4.16.15-beta.2" = _BZZ0EdUo;
        "pkg-4.16.15-beta.3" = _BGgjTQCM;
        "pkg-4.16.15-beta.4" = _NYcwvFB7;
        "pkg-4.16.15-beta.5" = _vruwJGKH;
        "pkg-4.16.15-beta.6" = _AevL8YYo;
        "pkg-4.16.15-beta.7" = _MEIv5Z2s;
        "pkg-4.16.15-beta.8" = _hp9clcMX;
        "pkg-4.16.15-beta.9" = _numhYusc;
        "pkg-4.16.15-beta.10" = _ouxkPObp;
        "pkg-4.16.15-beta.11" = _ACdiIq4c;
        "pkg-4.16.15-beta.12" = _y3jwdwXl;
        "pkg-4.16.15-rc.1" = _yvf3jp4M;
        "pkg-4.16.15-rc.2" = _6SzwXRkL;
        "pkg-4.16.15" = _xCGKlFAd;
        "pkg-4.16.15.1" = _JmBLeVL9;
        "pkg-4.17-beta.1" = _acVCHztp;
        "pkg-4.17-beta.2" = _Nd2g6YKy;
        "pkg-4.17-beta.3" = _hAd3sCBW;
        "pkg-4.17-beta.4" = _VRAoB57X;
        "pkg-4.17-beta.5" = _GKHKlTbY;
        "pkg-4.17-beta.6" = _HBbaMnfP;
        "pkg-4.17-beta.7" = _svprYOEi;
        "pkg-4.18.6" = _K3gDRfFl;
        "pkg-4.19.0.0" = _dZmBpb9t;
        "pkg-4.19.1.2" = _Qy4snQke;
        "default" = _Qy4snQke;
    });
