...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.18.1" = _U0a0m1Ih;
        "pkg-1.0.0-1.18.2" = _k8g6Zy1d;
        "pkg-1.0.0-1.19" = _CfEPhnNO;
        "pkg-1.1.0-1.19" = _75AQ6hYS;
        "pkg-v1.2.0-1.19" = _rP6pWnF2;
        "pkg-v1.3.0-1.19" = _4LWZTnPI;
        "pkg-v1.4.0-1.19" = _ujUGLYaD;
        "pkg-v1.4.0-1.19.3" = _W9aZK3Js;
        "pkg-v1.4.1-1.19.3" = _Ywe02Pw0;
        "pkg-v1.5.0-1.19.3" = _k649YxHH;
        "pkg-v1.6.0-1.19.3" = _mdyDCmp9;
        "pkg-v1.7.0-1.19.4" = _y0o1QtEM;
        "pkg-v1.8.0-1.19.4" = _Brw6s7ee;
        "pkg-v1.9.0-1.20" = _we85d3Ov;
        "pkg-v1.9.1-1.20" = _aix4U4K4;
        "pkg-v1.10.0-1.20.2" = _C9fFGJmR;
        "pkg-v1.10.1-1.20.2" = _NOIjKaDR;
        "pkg-v1.10.2-1.20.2" = _eIMBMQ2k;
        "pkg-1.10.0-1.20" = _MC4DDCy3;
        "pkg-1.10.1-1.20" = _jJs10gMu;
        "pkg-1.10.2-1.20" = _fi4t493Y;
        "pkg-1.10.3-1.20" = _fsI2jtqT;
        "pkg-1.10.3-1.20.2" = _niSnTrLo;
        "pkg-1.10.4-1.20.2" = _MZpp3gQL;
        "pkg-1.10.4-1.20" = _MWFmXn1c;
        "default" = _MWFmXn1c;
    });
