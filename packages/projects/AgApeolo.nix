...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.14_1.15_1.16" = _Wm188JVi;
        "pkg-1.0.0-1.16" = _TOvM87xE;
        "pkg-1.0.0-1.17" = _ecM4OjZR;
        "pkg-1.0.0-1.18" = _gyhUcJ6D;
        "pkg-1.0.0-1.19" = _s6h4NchU;
        "pkg-1.0.1-1.19" = _RLdxaekb;
        "pkg-1.0.0-1.20" = _RSp4xc4C;
        "pkg-1.0.0-1.20.5" = _DHTnXALW;
        "pkg-1.0.1-1.20" = _NlN8j6Nm;
        "pkg-1.0.0-1.21" = _wcpfPivB;
        "pkg-1.1.0-1.14_1.15" = _6ZwEr4To;
        "pkg-1.1.0-1.16" = _5g10fF02;
        "pkg-1.1.0-1.17" = _2THex3wT;
        "pkg-1.1.0-1.18" = _p8rG4tTE;
        "pkg-1.1.0-1.19" = _41ionT9Q;
        "pkg-1.1.0-1.20" = _DMp3ay0r;
        "pkg-1.1.0-1.21" = _8eLkxj6q;
        "pkg-1.1.0-1.21.2" = _lruK7UTz;
        "pkg-1.2.0-1.14_1.15" = _vqPVBxvU;
        "pkg-1.2.0-1.16" = _pMiZOyoJ;
        "pkg-1.2.0-1.17" = _uPDPVPkR;
        "pkg-1.2.0-1.18" = _Tj6OPqQC;
        "pkg-1.2.0-1.19" = _w2RmN6lT;
        "pkg-1.2.0-1.20" = _zSH7PzH3;
        "pkg-1.2.0-1.21" = _22vQqQRd;
        "pkg-1.2.0-1.21.2" = _zfqM9Fct;
        "pkg-1.0.0-forge-1.21" = _UtsvTPOy;
        "pkg-1.0.0-neoforge-1.21" = _TjbI1Ukk;
        "pkg-1.0.0-forge-1.20" = _30Gr2YE8;
        "pkg-1.0.0-forge-1.20.5" = _zPNc0pDK;
        "pkg-1.0.0-neoforge-1.20" = _aGv6mKB5;
        "pkg-1.0.0-neoforge-1.20.5" = _bwIP72xM;
        "pkg-1.1.0-forge-1.20" = _9kiFQPiy;
        "pkg-1.1.0-forge-1.20.5" = _DVwT6jkU;
        "pkg-1.1.0-neoforge-1.20" = _AFHE135o;
        "pkg-1.1.0-neoforge-1.20.5" = _BY0rqjZ8;
        "pkg-1.0.0-forge-1.21.9" = _QbIv7pXk;
        "pkg-1.0.1-forge-1.21.9" = _ikrb2s9A;
        "pkg-1.1.0-forge-1.21" = _UqSzHEQD;
        "pkg-1.1.0-forge-1.21.2" = _20AXrKJK;
        "pkg-1.1.0-neoforge-1.21" = _Of2sIPzH;
        "pkg-1.1.0-neoforge-1.21.2" = _wK2rtI3t;
        "pkg-1.1.0-forge-1.21.6" = _doDL2jZd;
        "pkg-1.3.0-1.20" = _Sg9BRsCb;
        "pkg-1.3.0-1.20.5" = _736yGcmo;
        "pkg-1.3.0-1.21" = _E3TxoXfH;
        "pkg-1.3.0-1.21.2" = _wWz0blCa;
        "pkg-1.3.1-1.20" = _p5TJkb8r;
        "pkg-1.3.1-1.20.2" = _WZG4flLV;
        "pkg-1.3.1-1.20.5" = _Fwyd9ytR;
        "pkg-1.3.2-1.20" = _hfzmwuqr;
        "pkg-1.2.0-forge-1.20" = _j3qrtkNJ;
        "pkg-1.2.0-forge-1.20.2" = _Opxv8N82;
        "pkg-1.2.0-forge-1.20.5" = _cSNj3jqW;
        "pkg-1.2.0-neoforge-1.20.2" = _HTzKfZol;
        "pkg-1.2.0-neoforge-1.20.5" = _OTfH08Si;
        "pkg-1.2.0-forge-1.21" = _UE5aVAY9;
        "pkg-1.2.0-forge-1.21.2" = _mwvzmHdI;
        "pkg-1.2.0-forge-1.21.6" = _HX03LDEz;
        "pkg-1.2.0-forge-1.21.11" = _w6aMKl8i;
        "pkg-1.2.0-neoforge-1.21" = _DXHDUnyt;
        "pkg-1.2.0-neoforge-1.21.2" = _Xiak4Y6c;
        "pkg-1.2.0-neoforge-1.21.11" = _P2GeDrW8;
        "pkg-1.2.0-1.21.11" = _Fpnu2icV;
        "pkg-1.3.1-1.21" = _FRwHt99A;
        "pkg-1.3.1-1.21.2" = _22caf3Ke;
        "pkg-1.3.0-1.14" = _ysmoDA0m;
        "pkg-1.3.0-1.15" = _5tAw4bo4;
        "pkg-1.3.0-1.16" = _JA5cMaoL;
        "pkg-1.3.0-1.17" = _UCGkiZs2;
        "pkg-1.3.0-1.18" = _lEQRYpXR;
        "pkg-1.3.0-1.19" = _FSvin67B;
        "pkg-1.3.0-1.21.11" = _x7KT4Zl7;
        "pkg-1.3.0-forge-1.20" = _noSNwzZp;
        "pkg-1.3.0-forge-1.20.2" = _9SfcpCK5;
        "pkg-1.3.0-forge-1.20.5" = _uXJPdBTR;
        "pkg-1.3.0-forge-1.21" = _Q2Azhimg;
        "pkg-1.3.0-forge-1.21.2" = _K5xb6sZF;
        "pkg-1.3.0-forge-1.21.6" = _r53KbhYH;
        "pkg-1.3.0-forge-1.21.11" = _QozGIgaj;
        "pkg-1.3.0-neoforge-1.20.2" = _ATmAclZ3;
        "pkg-1.3.0-neoforge-1.20.5" = _sg6Wt68N;
        "pkg-1.3.0-neoforge-1.21" = _6QbARslx;
        "pkg-1.3.0-neoforge-1.21.2" = _TgGdQXZ8;
        "pkg-1.3.0-neoforge-1.21.11" = _POcnSKGu;
        "pkg-1.3.1-neoforge-1.20.2" = _oxSmRiAA;
        "pkg-1.3.0-neoforge-1.20.4" = _XAqrkmkw;
        "pkg-1.3.0-26.1" = _inTzhpDz;
        "pkg-1.3.0-neoforge-26.1" = _2A0OxFZ9;
        "pkg-1.3.2-neoforge-1.20.2" = _gYX9DsId;
        "pkg-1.3.1-forge-1.20" = _7Fb18NB9;
        "pkg-1.3.1-forge-1.20.2" = _4NceUtLi;
        "pkg-1.3.1-forge-1.20.5" = _aVeEDufz;
        "pkg-1.3.1-forge-1.21" = _vZjKks9j;
        "pkg-1.3.1-forge-1.21.2" = _3v6o0JNY;
        "pkg-1.3.2-forge-1.21.2" = _UArde862;
        "pkg-1.3.1-forge-1.21.6" = _3kttgjXC;
        "pkg-1.3.1-forge-1.21.11" = _zplihPOl;
        "pkg-1.3.2-forge-1.20.5" = _SBhz5XcX;
        "pkg-1.3.2-forge-1.21" = _8WTjZDLk;
        "pkg-1.3.1-neoforge-1.20.5" = _mPWm192W;
        "pkg-1.3.1-neoforge-1.21" = _C7UkJ8vQ;
        "pkg-1.3.1-neoforge-1.21.2" = _Vp2gAmut;
        "pkg-1.3.1-neoforge-1.21.11" = _aJ4mVcz0;
        "default" = _aJ4mVcz0;
    });
