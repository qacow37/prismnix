...
let
    ...
    in {
        ...
        "pkg-neoforge-1.21.1-1.0" = _i0I4bARY;
        "pkg-forge-1.21.1-1.0" = _K9tbGUxM;
        "pkg-fabric-1.21.1-1.0" = _mdy7Ylhl;
        "pkg-neoforge-1.21.1-1.3" = _FY3qxEBc;
        "pkg-forge.1.21.1-1.3" = _s1XfHLXE;
        "pkg-fabric-1.21.1-1.3" = _UvCTzCnV;
        "pkg-forge-1.20.1-1.3" = _QQKLY3jY;
        "pkg-fabric-1.20.1-1.3" = _3HuM5UqR;
        "pkg-neoforge-1.21.11-1.3" = _brgfzt49;
        "pkg-forge-1.21.11-1.3" = _v0ELfY1p;
        "pkg-fabric-1.21.11-1.3" = _eCCHO6sd;
        "pkg-1.20.1-2.0-forge" = _lWnxWsNn;
        "pkg-1.20.1-2.0-fabric" = _vGITEITe;
        "pkg-1.21.1-2.0-neoforge" = _PbvSSwyp;
        "pkg-1.21.1-2.0-forge" = _ZwtiB8lv;
        "pkg-1.21.1-2.0-fabric" = _YK7zOx71;
        "pkg-1.21.11-2.0-neoforge" = _uotn7XzF;
        "pkg-1.21.11-2.0-forge" = _ooXXmvLf;
        "pkg-1.21.11-2.0-fabric" = _pYYMZ328;
        "pkg-1.20.1-2.1-forge" = _m5h7JGFx;
        "pkg-1.20.1-2.1-fabric" = _kD3DLP5h;
        "pkg-1.21.1-2.1-neoforge" = _Q51w0yrq;
        "pkg-1.21.1-2.1-forge" = _mj6jyglY;
        "pkg-1.21.1-2.1-fabric" = _ecXeAXX7;
        "pkg-1.21.11-2.1-neoforge" = _JcpwkALT;
        "pkg-1.21.11-2.1-forge" = _buXaRcj0;
        "pkg-1.21.11-2.1-fabric" = _RnKC402r;
        "pkg-26.1-1.0-neoforge" = _fyrSiY2X;
        "pkg-26.1-1.0-forge" = _ScNtm0Nc;
        "pkg-26.1-1.0-fabric" = _FlGeHkw1;
        "pkg-26.1.1-2.1-neoforge" = _YiPx7G3b;
        "pkg-26.1.1-2.1-forge" = _EOhGi5Zc;
        "pkg-26.1.1-2.1-fabric" = _4yDNPNTN;
        "pkg-1.20.1-2.2-forge" = _fVV3Oa3Q;
        "pkg-1.20.1-2.2-fabric" = _12rfgBjH;
        "pkg-1.21.1-2.2-neoforge" = _1vgDPbtS;
        "pkg-1.21.1-2.2-forge" = _xtGQ7P9l;
        "pkg-1.21.1-2.2-fabric" = _ieKE19cl;
        "pkg-1.21.11-2.2-neoforge" = _sdoS018m;
        "pkg-1.21.11-2.2-forge" = _gfWeOPrw;
        "pkg-1.21.11-2.2-fabric" = _C6616zXK;
        "pkg-26.1.1-2.2-neoforge" = _CERKPSZA;
        "pkg-26.1.1-2.2-forge" = _JqPJqVl2;
        "pkg-26.1.1-2.2-fabric" = _dk8xgvuI;
        "pkg-26.1.2-2.2-neoforge" = _WnxGbwKz;
        "pkg-26.1.2-2.2-forge" = _dRNd0Swz;
        "pkg-26.1.2-2.2-fabric" = _zPccRZLt;
        "pkg-26.1.2-2.3-neoforge" = _lbWON3zW;
        "pkg-26.1.2-2.3-forge" = _SxHDpaUR;
        "pkg-26.1.2-2.3-fabric" = _RQI694YJ;
        "pkg-1.20.1-2.4-forge" = _TWF0Tcqk;
        "pkg-1.20.1-2.4-fabric" = _11gwYQoP;
        "pkg-1.21.1-2.4-neoforge" = _Y3yMwNzx;
        "pkg-1.21.1-2.4-forge" = _Nl4lDGke;
        "pkg-1.21.1-2.4-fabric" = _cIpKQafE;
        "pkg-1.21.11-2.4-neoforge" = _zhcUchNS;
        "pkg-1.21.11-2.4-forge" = _Tyy7g3zf;
        "pkg-1.21.11-2.4-fabric" = _bCksWk4c;
        "pkg-26.1.2-2.4-neoforge" = _9mRa4y3k;
        "pkg-26.1.2-2.4-forge" = _c3E3l7KN;
        "pkg-26.1.2-2.4-fabric" = _GhVs54W3;
        "pkg-1.20.1-2.5-forge" = _rjQFxI0r;
        "pkg-1.20.1-2.5-fabric" = _JR5YQIzE;
        "pkg-1.21.1-2.5-neoforge" = _5VJu2Ppv;
        "pkg-1.21.1-2.5-forge" = _rXxZRAU1;
        "pkg-1.21.1-2.5-fabric" = _CTnZDcjK;
        "pkg-1.21.11-2.5-neoforge" = _EEWgnhSV;
        "pkg-1.21.11-2.5-forge" = _L72VjA3M;
        "pkg-1.21.11-2.5-fabric" = _pcsuKaeg;
        "pkg-26.1.2-2.5-neoforge" = _gug8JZAo;
        "pkg-26.1.2-2.5-forge" = _Yk5wIZ4Z;
        "pkg-26.1.2-2.5-fabric" = _MZqPLd3h;
        "pkg-1.20.1-2.6-forge" = _6hTdeK67;
        "pkg-1.20.1-2.6-fabric" = _egPmOmX2;
        "pkg-1.21.1-2.6-neoforge" = _9TsU0rKs;
        "pkg-1.21.1-2.6-forge" = _8AbiHQmh;
        "pkg-1.21.1-2.6-fabric" = _DKZbzlTY;
        "pkg-1.21.11-2.6-neoforge" = _foIfkJex;
        "pkg-1.21.11-2.6-forge" = _GY7llpyr;
        "pkg-1.21.11-2.6-fabric" = _vWGosbfB;
        "pkg-26.1.2-2.6-neoforge" = _qL1g8VyJ;
        "pkg-26.1.2-2.6-forge" = _21feay9Q;
        "pkg-26.1.2-2.6-fabric" = _p3cTgm6w;
        "pkg-26.2-1.0-neoforge" = _EJPyyuRD;
        "pkg-26.2-1.0-forge" = _g0Cv7Rq7;
        "pkg-26.2-1.0-fabric" = _HDM1RBi1;
        "default" = _HDM1RBi1;
    });
