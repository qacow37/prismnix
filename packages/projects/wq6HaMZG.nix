...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _Uca1nUXH;
        "pkg-1.0.9" = _uyg5MfBJ;
        "pkg-1.0.10" = _In8Vqi3A;
        "pkg-1.0.11" = _i0Gs1VVx;
        "pkg-1.0.12" = _DjzeulQn;
        "pkg-1.0.13" = _YPsEUCvP;
        "pkg-1.0.14" = _JDNUrvnd;
        "pkg-1.0.15" = _YCNhjmOV;
        "pkg-1.0.16" = _cuvDtxke;
        "pkg-1.0.15-hotfix.1" = _LV4yJPx5;
        "pkg-1.0.17" = _xjZnmwp2;
        "default" = _xjZnmwp2;
    });
