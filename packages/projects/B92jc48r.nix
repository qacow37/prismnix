...
let
    ...
    in {
        ...
        "pkg-1.0" = _jRAtK9NA;
        "pkg-1.0_mod" = _VUn80tbE;
        "pkg-1.1" = _v01QIKv8;
        "pkg-1.2" = _ALXngXng;
        "pkg-1.2+mod" = _mM1u3wYE;
        "pkg-1.3" = _wvIBwt2K;
        "pkg-1.3+mod" = _TeGODzF6;
        "pkg-2.0" = _2vOZ9fg9;
        "pkg-2.0+mod" = _waUyxwy3;
        "pkg-3.0" = _QTlsNRar;
        "pkg-3.0+mod" = _kCDxW6SG;
        "pkg-3.1" = _qgzBoLEJ;
        "pkg-4.0" = _3eOBv41o;
        "pkg-4.0+mod" = _N2083YZB;
        "pkg-4.1" = _QvAU1I8P;
        "pkg-4.1+mod" = _Kl1VjKVM;
        "pkg-4.2" = _jk571yGB;
        "pkg-4.2+mod" = _bAcIF4au;
        "pkg-4.3" = _4MfxQvQV;
        "pkg-4.3+mod" = _2ocg5DwF;
        "pkg-4.4" = _hfXeBErq;
        "pkg-4.4+mod" = _9ANPrBJv;
        "pkg-4.5" = _TOXeMmFM;
        "pkg-4.5+mod" = _C1PSTjC8;
        "pkg-4.6" = _vEbs803i;
        "pkg-4.6+mod" = _IGoEULur;
        "pkg-4.7" = _gxxL7EfM;
        "pkg-4.7-fabric" = _h2vPyFRx;
        "pkg-4.7-forge" = _QPBss3OK;
        "pkg-4.11" = _HEP66zgb;
        "pkg-4.11-fabric" = _VorvuyYC;
        "pkg-4.11-quilt" = _eWtAYlwg;
        "pkg-4.11-forge" = _gPlrHU7w;
        "pkg-4.11-neoforge" = _WSypSH6B;
        "pkg-4.12" = _WgmtB6NV;
        "pkg-4.12-fabric" = _1m7F6J3L;
        "pkg-4.12-quilt" = _owMPpt8C;
        "pkg-4.12-forge" = _tiOaOzLX;
        "pkg-4.12-neoforge" = _mzA6QHCd;
        "default" = _mzA6QHCd;
    });
