...
let
    ...
    in {
        ...
        "pkg-1.12.2" = _69QKehlS;
        "pkg-1.0.0" = _tTwK8hGB;
        "pkg-1.12.3" = _3XboK3WV;
        "pkg-1.0.1" = _xDHZv6l5;
        "pkg-1.12.6" = _aBs8U26a;
        "pkg-1.0.2" = _Sh73klLE;
        "pkg-1.12.7" = _rOxFLMqs;
        "pkg-1.0.3" = _ShS2xeBe;
        "pkg-1.20.1-1.0" = _YtWCo8ZY;
        "pkg-1.0.4" = _OiADY7Su;
        "pkg-1.12.8" = _EuWEL785;
        "pkg-1.20.1-1.1" = _8LSP9S4k;
        "pkg-1.20.2-1.1" = _xRT8x20Z;
        "pkg-1.0.5" = _gUcCY8vB;
        "pkg-1.20.1-1.2" = _4Cjm2Alb;
        "pkg-1.20.2-1.2" = _bEcvTcp9;
        "pkg-1.11.14" = _rJGWgNUw;
        "pkg-1.12.9" = _a6R3zOcD;
        "pkg-1.0.6" = _UtKRrftz;
        "pkg-1.12.10" = _HneJ2Zp0;
        "pkg-1.20.1-1.3" = _sdb63xEF;
        "pkg-1.20.2-1.3" = _UMZ3hVMI;
        "pkg-1.20.4-1.3" = _ikc669T8;
        "pkg-1.9.20" = _Cq2oI4er;
        "pkg-1.11.16" = _HRoZjrBO;
        "pkg-1.12.11" = _vcadQdZ7;
        "pkg-1.0.7" = _l35vTMYo;
        "pkg-1.20.1-1.4" = _9GQWqbYK;
        "pkg-1.20.4-1.4" = _Fv3d5sFM;
        "pkg-1.21.1-0.1" = _Bxlypf0L;
        "pkg-1.9.21" = _57joPv3M;
        "pkg-1.11.17" = _MjOkvV9b;
        "pkg-1.12.12" = _LT7UVj2q;
        "pkg-1.0.8" = _rbPZ4ouW;
        "pkg-1.20.1-1.5" = _X9gp3NTf;
        "pkg-1.20.4-1.5" = _FUdGyr5F;
        "pkg-1.21.1-1.0" = _yMpTLwpa;
        "default" = _yMpTLwpa;
    });
