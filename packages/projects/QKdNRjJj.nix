...
let
    ...
    in {
        ...
        "pkg-1.9.0" = _GvxbqH8W;
        "pkg-1.10.0" = _YCdvb4Zd;
        "pkg-1.10.1" = _KQ5eJthL;
        "pkg-1.10.2" = _qSB2MUMV;
        "pkg-1.11.0" = _bRexzkFV;
        "pkg-1.11.1" = _sjhHjGVY;
        "pkg-1.11.2" = _Z9L9ZhtK;
        "pkg-1.12e" = _ffkshqWQ;
        "pkg-1.12e1" = _ikCNrFKr;
        "pkg-1.12" = _xhUnohAL;
        "pkg-1.12.1" = _oZ1jGt4s;
        "pkg-1.12.2" = _BXTK0N5H;
        "pkg-1.12.4" = _jTEjW0vf;
        "pkg-1.12.5" = _sPnnfWgg;
        "pkg-1.12.6" = _vtRoZ0zb;
        "pkg-1.12.7" = _JQW17AYv;
        "pkg-1.12.8" = _S1vZPGET;
        "pkg-1.12.9" = _tokOXZtc;
        "pkg-1.12.10" = _guzej2nX;
        "pkg-1.12.10.1" = _x8SnTLOH;
        "pkg-1.13" = _UKYWXlSB;
        "pkg-1.13.1" = _2x8aVvRY;
        "pkg-1.13.2" = _pw2UCnvl;
        "pkg-1.13.3" = _tVDMdXqy;
        "pkg-1.13.4" = _etP0dhd0;
        "pkg-1.13.5" = _rEY7lAzr;
        "pkg-1.13.6" = _dlawLS7y;
        "pkg-1.13.7" = _SnzanyVE;
        "default" = _SnzanyVE;
    });
