...
let
    ...
    in {
        ...
        "pkg-0.2.1" = _Pg3uqzyX;
        "pkg-1.2.3" = _NthB3dhp;
        "pkg-2.2.3-fabric" = _zSXedEa4;
        "pkg-2.2.3-forge" = _AGjJcbYQ;
        "pkg-3.3.0+fabric" = _Q45f86EW;
        "pkg-3.3.0+forge" = _tpUkzfwh;
        "pkg-3.3.1+fabric" = _fpdHeiWg;
        "pkg-3.3.1+forge" = _nafMXhVc;
        "pkg-4.3.1+fabric" = _9UjGHgEv;
        "pkg-4.3.1+forge" = _wxoq8Zfw;
        "pkg-4.3.3+fabric" = _e4SeGwi3;
        "pkg-4.3.3+forge" = _xryXDpvQ;
        "pkg-4.4.0+fabric" = _OEL5iDIN;
        "pkg-4.4.0+forge" = _P1VTTJju;
        "pkg-4.4.1+fabric" = _797ujtju;
        "pkg-4.4.1+forge" = _66z4rv38;
        "pkg-4.4.2+fabric" = _MprPnUls;
        "pkg-4.4.2+forge" = _QtSVNyjm;
        "pkg-5.4.2+fabric" = _rkW2iQf1;
        "pkg-5.4.2+neoforge" = _dJvQ2xkg;
        "pkg-5.4.3+fabric" = _cSO055dw;
        "pkg-5.4.3+neoforge" = _fPtQQQDl;
        "pkg-7.4.3+fabric" = _w5Y2vGQo;
        "pkg-7.4.3+neoforge" = _uuNZDU8r;
        "pkg-7.4.4+fabric" = _STfqDYFy;
        "pkg-7.4.4+neoforge" = _3NRFQstm;
        "pkg-5.4.4+fabric" = _K7DPuMxY;
        "pkg-5.4.4+neoforge" = _f8lSH3bs;
        "default" = _f8lSH3bs;
    });
