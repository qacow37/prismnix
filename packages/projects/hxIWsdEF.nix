...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.16-1.18.2" = _gpdnkMIw;
        "pkg-1.0.0+1.19-1.19.2" = _LAAGMwE3;
        "pkg-1.0.0+1.19.3-1.19.4" = _xUz4RsBj;
        "pkg-1.0.0+1.20+" = _VkfNicbF;
        "pkg-1.0.1+1.16-1.18.2" = _yUeElsgL;
        "pkg-1.0.1+1.19-1.19.2" = _4hsHkCZw;
        "pkg-1.0.1+1.19.3-1.19.4" = _7YNSuUJO;
        "pkg-1.0.1+1.20+" = _nBDCgCXS;
        "pkg-1.0.2+1.19.3-1.19.4" = _LvU5hFPP;
        "pkg-1.0.2+1.20+" = _fW6JJ2YQ;
        "pkg-1.0.2+1.19-1.19.2" = _6WryBMzn;
        "pkg-1.0.2+1.16-1.18.2" = _S5THZguK;
        "pkg-1.0.3+1.20+" = _XMayiwCe;
        "pkg-1.0.3+1.19-1.19.2" = _AXwZSvEJ;
        "pkg-1.0.3+1.16-1.18.2" = _mH3aVDcu;
        "pkg-1.0.3+1.19.3-1.19.4" = _fqzPjhck;
        "pkg-1.0.4+1.16-1.18.2" = _y8jwZz5B;
        "pkg-1.0.4+1.20+" = _bOtPXOAf;
        "pkg-1.0.4+1.19-1.19.2" = _973MaOH4;
        "pkg-1.0.4+1.19.3-1.19.4" = _Cd4ej0mI;
        "pkg-1.0.5+1.20.5-neoforge" = _O9xCCqKW;
        "pkg-1.0.5+1.20.5-forge" = _G5niHPkT;
        "pkg-1.0.5+1.20-fabric" = _lr8SIu6Z;
        "pkg-1.0.5+1.20.2-1.20.4-neoforge" = _qRRNhhUq;
        "pkg-1.0.5+1.20-1.20.4-forge" = _mUOEfcQJ;
        "pkg-1.0.5+1.19.3-1.19.4-forge" = _IhdSnVCX;
        "pkg-1.0.5+1.19.3-1.19.4-fabric" = _Vv272eW3;
        "pkg-1.0.5+1.19.1-1.19.2-forge" = _gEL3WnGv;
        "pkg-1.0.5+1.19-forge" = _IvuSHr1G;
        "pkg-1.0.5+1.19-1.19.2-fabric" = _nviiUtAZ;
        "pkg-1.0.5+1.18.x-forge" = _JWWjfewo;
        "pkg-1.0.5+1.17.x-forge" = _u8uNiWyO;
        "pkg-1.0.5+1.16.x-forge" = _i8m8AjA8;
        "pkg-1.0.5+1.16-1.18.2-fabric" = _S5s4lNOq;
        "pkg-1.0.6+1.20.5-neoforge" = _QG64N0nF;
        "pkg-1.0.6+1.20.5-forge" = _79xIHV2Q;
        "pkg-1.0.6+1.20-fabric" = _uxU1Ol0r;
        "pkg-1.0.6+1.20.2-1.20.4-neoforge" = _Rn5RgUyF;
        "pkg-1.0.6+1.20-1.20.4-forge" = _ukXyv0jv;
        "pkg-1.0.6+1.19.3-1.19.4-forge" = _ENZUgEMW;
        "pkg-1.0.6+1.19.1-1.19.2-forge" = _QM380DdQ;
        "pkg-1.0.6+1.19-forge" = _b18pZOxW;
        "pkg-1.0.6+1.18.x-forge" = _UUgMWnHB;
        "pkg-1.0.6+1.17.x-forge" = _85kh9vDe;
        "pkg-1.0.6+1.16.x-forge" = _2nPxdfnK;
        "pkg-1.0.6+1.19.3-1.19.4-fabric" = _70QgsjgF;
        "pkg-1.0.6+1.19-1.19.2-fabric" = _H9O5mPyg;
        "pkg-1.0.6+1.16-1.18.2-fabric" = _xX4Hx2kQ;
        "pkg-1.0.7+1.21-neoforge" = _rNcSk3pW;
        "pkg-1.0.7+1.19.3-1.19.4-forge" = _AZO86ai3;
        "pkg-1.0.7+1.20.5-1.20.6-neoforge" = _T6WeSQv4;
        "pkg-1.0.7+1.20-1.20.4-forge" = _ta5QuQuJ;
        "pkg-1.0.7+1.20.5-forge" = _KglT30CW;
        "pkg-1.0.7+1.20.2-1.20.4-neoforge" = _NHiPkN6T;
        "pkg-1.0.7+1.19.3-1.19.4-fabric" = _vu7F7XRX;
        "pkg-1.0.7+1.20-fabric" = _dK8uLHkQ;
        "pkg-1.0.7+1.19.1-1.19.2-forge" = _Xnp4KCJg;
        "pkg-1.0.7+1.19-1.19.2-fabric" = _mLLVpSeQ;
        "pkg-1.0.7+1.19-forge" = _uB4V5ifW;
        "pkg-1.0.7+1.18.x-forge" = _4L1LDBKq;
        "pkg-1.0.7+1.17.x-forge" = _xAXDbIeV;
        "pkg-1.0.7+1.16.x-forge" = _WQa83023;
        "pkg-1.0.7+1.16-1.18.2-fabric" = _aMMEbGwZ;
        "pkg-1.0.8+1.20-1.20.4-forge" = _7SHALizM;
        "pkg-1.0.8+1.20-fabric" = _2ZYXRniX;
        "pkg-1.0.8+1.19.3-1.19.4-forge" = _ovpqdCcJ;
        "pkg-1.0.8+1.16-1.18.2-fabric" = _oIvwmnkd;
        "pkg-1.0.8+1.16.x-forge" = _i1wnxepL;
        "pkg-1.0.8+1.20.5-forge" = _HTvXePjQ;
        "pkg-1.0.8+1.19.3-1.19.4-fabric" = _evyLoNpw;
        "pkg-1.0.8+1.17.x-forge" = _Gc5cIdeU;
        "pkg-1.0.8+1.20.5-1.20.6-neoforge" = _CKgXNaaQ;
        "pkg-1.0.9+1.21-neoforge" = _Zbcl9OrO;
        "pkg-1.0.9+1.20.5-forge" = _PLxiDJNa;
        "pkg-1.0.9+1.20-fabric" = _sqmyxwO8;
        "pkg-1.0.9+1.20.5-1.20.6-neoforge" = _X0TCuBm1;
        "pkg-1.0.9+1.20-1.20.4-forge" = _IwiYBprf;
        "pkg-1.0.9+1.19.3-1.19.4-forge" = _HFWZUqUX;
        "pkg-1.0.9+1.19.3-1.19.4-fabric" = _JSR5okUp;
        "pkg-1.0.9+1.20.2-1.20.4-neoforge" = _yeSWTMOW;
        "pkg-1.0.9+1.19.1-1.19.2-forge" = _60E6tWkq;
        "pkg-1.0.9+1.19-forge" = _pWkf1WeG;
        "pkg-1.0.9+1.18.x-forge" = _2gurLamv;
        "pkg-1.0.9+1.19-1.19.2-fabric" = _B5vlhORU;
        "pkg-1.0.9+1.17.x-forge" = _n5r3RFKH;
        "pkg-1.0.9+1.16.x-forge" = _URlW8vDO;
        "pkg-1.0.9+1.16-1.18.2-fabric" = _XmHDcbvd;
        "pkg-1.1.0+1.21.9-1.21.10-fabric" = _gEcvpE03;
        "pkg-1.1.1+1.21-neoforge" = _loDHzKZr;
        "pkg-1.1.1+1.20-1.20.4-forge" = _nrYv4Ia7;
        "pkg-1.1.1+1.20.5-1.20.6-neoforge" = _CoRaYBEi;
        "pkg-1.1.1+1.20.2-1.20.4-neoforge" = _MEhxPAex;
        "pkg-1.1.1+1.20.5-forge" = _gnV06YhE;
        "pkg-1.1.1+1.19.3-1.19.4-forge" = _UKvGFt7z;
        "pkg-1.1.1+1.19.3-1.19.4-fabric" = _MAoAb33Q;
        "pkg-1.1.1+1.20-fabric" = _mwHcOAds;
        "pkg-1.1.1+1.19.1-1.19.2-forge" = _8vIr006P;
        "pkg-1.1.1+1.19-forge" = _4I9pZZMF;
        "pkg-1.1.1+1.19-1.19.2-fabric" = _FItlQ74A;
        "pkg-1.1.1+1.18.x-forge" = _AxEjJsD3;
        "pkg-1.1.1+1.17.x-forge" = _ZtVNxG1X;
        "pkg-1.1.1+1.16.x-forge" = _1F5dIsLk;
        "pkg-1.1.1+1.16-1.18.2-fabric" = _aDhMbeIM;
        "default" = _aDhMbeIM;
    });
