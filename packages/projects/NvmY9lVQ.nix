...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _bvzWB7f8;
        "pkg-1.0.9" = _AwlcoPqf;
        "pkg-1.0.9.1" = _za4lZXFW;
        "pkg-1.0.10" = _qttSKyX6;
        "pkg-1.0.11" = _iAjm8jH0;
        "pkg-1.0.12" = _YGKfSYff;
        "pkg-1.0.13" = _xKUtG9TA;
        "pkg-1.0.14" = _LGFtBgcc;
        "pkg-1.0.14.1" = _YVU9r0tH;
        "pkg-1.0.15" = _GATZIgRC;
        "pkg-1.0.16" = _HcbieF6N;
        "pkg-1.0.17" = _EfruIpg8;
        "pkg-1.0.18" = _i9js7LSR;
        "pkg-1.0.19" = _H9yHhpL7;
        "pkg-1.0.20" = _Yxc8lXfv;
        "pkg-1.0.21" = _rZxdhUdv;
        "default" = _rZxdhUdv;
    });
