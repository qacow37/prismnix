...
let
    ...
    in {
        ...
        "pkg-1.0.0-Alpha+1.18.2" = _ArJw9n32;
        "pkg-1.0.0-Alpha+1.19.2" = _n38uy3b8;
        "pkg-1.0.0-Alpha+1.19.4" = _lioKZCo9;
        "pkg-1.0.0-Alpha+1.20.1" = _g6k9dLOM;
        "pkg-1.0.0-Alpha+1.20.4" = _ZYfFTiU7;
        "pkg-1.0.0-Alpha+1.21.1" = _BJe3AFSl;
        "pkg-1.0.0-Alpha+1.21.4" = _Q9iXTjLN;
        "pkg-1.1.0-Alpha+1.18.2" = _MQKswdgz;
        "pkg-1.1.0-Alpha+1.19.2" = _tfZYquhu;
        "pkg-1.1.0-Alpha+1.19.4" = _qVwcRwIh;
        "pkg-1.1.0-Alpha+1.20.1" = _mOrn2APh;
        "pkg-1.1.0-Alpha+1.20.4" = _elO3cjqu;
        "pkg-1.1.0-Alpha+1.21.1" = _dHFe9nik;
        "pkg-1.1.0-Alpha+1.21.4" = _m2sXbmgf;
        "pkg-1.2.0-Alpha+1.18.2" = _NT5sYUKR;
        "pkg-1.2.0-Alpha+1.19.2" = _BCzVl03y;
        "pkg-1.2.0-Alpha+1.19.4" = _31S4yD3S;
        "pkg-1.2.0-Alpha+1.20.1" = _JWv81DoI;
        "pkg-1.2.0-Alpha+1.20.4" = _igVDMGsF;
        "pkg-1.2.0-Alpha+1.21.1" = _jPyJBrjP;
        "pkg-1.2.0-Alpha+1.21.4" = _PFLLKHyx;
        "pkg-1.3.0-Alpha+1.18.2" = _EokqkTUv;
        "pkg-1.3.0-Alpha+1.19.2" = _Q6oN1qoN;
        "pkg-1.3.0-Alpha+1.19.4" = _ZLuQRZVW;
        "pkg-1.3.0-Alpha+1.20.1" = _tW1U7V2L;
        "pkg-1.3.0-Alpha+1.20.4" = _DyMacX37;
        "pkg-1.3.0-Alpha+1.21.1" = _gHYETpfN;
        "pkg-1.3.0-Alpha+1.21.4" = _p8pc70KT;
        "pkg-1.4.0-Alpha+1.18.2" = _lVflF2Zc;
        "pkg-1.4.0-Alpha+1.19.2" = _MImBeei1;
        "pkg-1.4.0-Alpha+1.19.4" = _mXAHGXyE;
        "pkg-1.4.0-Alpha+1.20.1" = _bw2GrDYb;
        "pkg-1.4.0-Alpha+1.20.4" = _EbAGHmM7;
        "pkg-1.4.0-Alpha+1.21.1" = _61F1sVBs;
        "pkg-1.4.0-Alpha+1.21.4" = _X4ozgyhi;
        "pkg-1.4.1-Alpha+1.21.4" = _aPOIyPqy;
        "pkg-1.4.1-Alpha+1.21.1" = _syQ3EbGt;
        "pkg-1.4.1-Alpha+1.20.4" = _yZM6h2QR;
        "pkg-1.4.1-Alpha+1.20.1" = _ZkFO76kp;
        "pkg-1.4.1-Alpha+1.19.4" = _AHU6u54Q;
        "pkg-1.4.1-Alpha+1.19.2" = _ms5uTETO;
        "pkg-1.4.1-Alpha+1.18.2" = _BfaDXs0x;
        "default" = _BfaDXs0x;
    });
