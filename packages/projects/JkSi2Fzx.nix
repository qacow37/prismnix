...
let
    ...
    in {
        ...
        "pkg-FP21.10.32_Forge_1.7.10" = _TnEifwpZ;
        "pkg-FP21.10.32_Forge_1.8.9" = _aC7K7Vpo;
        "pkg-FP23.4.0_Forge_1.12" = _dzszeRYQ;
        "pkg-FP23.3.3_Forge_1.14.4" = _4twI1vM2;
        "pkg-FP23.3.3_Forge_1.15.2" = _j4lW6vbO;
        "pkg-FP23.4.0_Fabric_1.16.5" = _110eeKj0;
        "pkg-FP23.4.0_Forge_1.16.5" = _OKndYubQ;
        "pkg-FP23.4.0_Fabric_1.17.1" = _NFnk6xzu;
        "pkg-FP23.4.0_Forge_1.17.1" = _MWCTgg5I;
        "pkg-FP23.4.0_Fabric_1.18.2" = _8B3gubNU;
        "pkg-FP23.4.0_Forge_1.18.2" = _5LNBDGNW;
        "pkg-FP23.4.0_Fabric_1.19.1" = _vZjSJjl8;
        "pkg-FP23.4.0_Forge_1.19.1" = _46cuH3uM;
        "pkg-FP23.4.0_Fabric_1.19.3" = _qT7qiBMI;
        "pkg-FP23.4.0_Forge_1.19.3" = _ElJRfix8;
        "pkg-FP23.4.0_Fabric_1.19.4" = _4I7b0kZz;
        "pkg-FP23.4.0_Forge_1.19.4" = _C9YKva3k;
        "pkg-FP23.4.4_Fabric_1.20" = _rKlrD9dr;
        "pkg-FP23.4.4_Forge_1.20" = _thXGBapx;
        "pkg-FP21.10.38_Forge_1.7.10" = _vPNfYFyd;
        "pkg-FP21.10.38_Forge_1.8.9" = _ceCpUQYo;
        "pkg-FP23.6.3_Forge_1.12" = _hM8nxtnI;
        "pkg-FP23.3.11_Forge_1.14.4" = _iowu3qPs;
        "pkg-FP23.3.11_Forge_1.15.2" = _Pw0YQzZn;
        "pkg-FP23.6.3_Fabric_1.16.5" = _9ZqPCnLl;
        "pkg-FP23.6.3_Forge_1.16.5" = _ry5P1GMz;
        "pkg-FP23.6.3_Fabric_1.17.1" = _lBSL5xZx;
        "pkg-FP23.6.3_Forge_1.17.1" = _ynHv3bJi;
        "pkg-FP23.6.3_Fabric_1.18.2" = _8vG2u4i8;
        "pkg-FP23.6.3_Forge_1.18.2" = _NYzjIAyl;
        "pkg-FP23.6.3_Fabric_1.19.1" = _OyyJp7Kx;
        "pkg-FP23.6.3_Forge_1.19.1" = _xOl2GQH3;
        "pkg-FP23.6.3_Fabric_1.19.3" = _eUanpmTr;
        "pkg-FP23.6.3_Forge_1.19.3" = _7jplIoI7;
        "pkg-FP23.6.3_Fabric_1.19.4" = _i1POijlz;
        "pkg-FP23.6.3_Forge_1.19.4" = _HaAUBUtk;
        "pkg-FP23.6.3_Fabric_1.20" = _6aPaqLkt;
        "pkg-FP23.6.3_Forge_1.20" = _jNeO7MUu;
        "pkg-FP23.8.2_Forge_1.12" = _Mss9l2jy;
        "pkg-FP23.8.2_Fabric_1.16.5" = _n4CQQj1d;
        "pkg-FP23.8.2_Forge_1.16.5" = _jQnyOToy;
        "pkg-FP23.8.2_Fabric_1.17.1" = _TyaidMGz;
        "pkg-FP23.8.2_Forge_1.17.1" = _IACYA6CL;
        "pkg-FP23.8.2_Fabric_1.18.2" = _sXxYKGGa;
        "pkg-FP23.8.2_Forge_1.18.2" = _zRu65ZKX;
        "pkg-FP23.8.2_Fabric_1.19.1" = _lqhxWmqQ;
        "pkg-FP23.8.2_Forge_1.19.1" = _x5k57uPw;
        "pkg-FP23.8.2_Fabric_1.19.3" = _YxmDrUTd;
        "pkg-FP23.8.2_Forge_1.19.3" = _6wDWz4xx;
        "pkg-FP23.8.2_Fabric_1.19.4" = _Dvokm57Z;
        "pkg-FP23.8.2_Forge_1.19.4" = _SSBVeJQB;
        "pkg-FP23.8.2_Fabric_1.20" = _7f16UUM1;
        "pkg-FP23.8.2_Forge_1.20" = _NOF4JTWs;
        "pkg-FP23.8.2_Fabric_1.20.2" = _s0uDL0E5;
        "pkg-FP23.8.2_Forge_1.20.2" = _O4BgIFZi;
        "pkg-FP21.10.40_Forge_1.7.10" = _gdyrh5CK;
        "pkg-FP21.10.40_Forge_1.8.9" = _s3uvtG9P;
        "pkg-FP23.9.1_Forge_1.12" = _uytnysOC;
        "pkg-FP23.3.13_Forge_1.14.4" = _Y56NGAln;
        "pkg-FP23.3.13_Forge_1.15.2" = _w3UwpLQv;
        "pkg-FP23.9.4_Forge_1.16.5" = _F1IyDhJS;
        "pkg-FP23.9.4_Fabric_1.16.5" = _Kz46rNkY;
        "pkg-FP23.9.4_Forge_1.17.1" = _toCLKxJ6;
        "pkg-FP23.9.4_Fabric_1.17.1" = _IRmSWT8T;
        "pkg-FP23.9.4_Forge_1.18.2" = _oygkJr5G;
        "pkg-FP23.9.4_Fabric_1.18.2" = _xQsxOheQ;
        "pkg-FP23.9.4_Forge_1.19.1" = _W52HdhFd;
        "pkg-FP23.9.4_Fabric_1.19.1" = _XOdawn3G;
        "pkg-FP23.9.4_Forge_1.19.3" = _pBgN8cdC;
        "pkg-FP23.9.4_Fabric_1.19.3" = _PvNcKwuw;
        "pkg-FP23.9.4_Forge_1.19.4" = _FSEB6Pur;
        "pkg-FP23.9.4_Fabric_1.19.4" = _vyS8XZ5r;
        "pkg-FP23.9.4_Forge_1.20" = _D0dQzXpG;
        "pkg-FP23.9.4_Fabric_1.20" = _qEWzPi3T;
        "pkg-FP23.9.4_Forge_1.20.2" = _6ak2Jvh6;
        "pkg-FP23.9.4_Fabric_1.20.2" = _4D2JsbtQ;
        "pkg-FP23.9.6_Forge_1.20.4" = _CvcO3Xjd;
        "pkg-FP23.9.6_Fabric_1.20.4" = _zQD90kCO;
        "pkg-FP24.1.1_Forge_1.12" = _TovnFYDJ;
        "pkg-FP24.1.1_Forge_1.16.5" = _ftaSXqNi;
        "pkg-FP24.1.1_Fabric_1.16.5" = _IVNHofpB;
        "pkg-FP24.1.1_Forge_1.18.2" = _8L5YgUaH;
        "pkg-FP24.1.1_Fabric_1.18.2" = _gOuTDbsQ;
        "pkg-FP24.1.1_Forge_1.19.1" = _7kpr1JPQ;
        "pkg-FP24.1.1_Fabric_1.19.1" = _Cmn3Rh6O;
        "pkg-FP24.1.1_Forge_1.19.4" = _iklqrazB;
        "pkg-FP24.1.1_Fabric_1.19.4" = _StCmmJsW;
        "pkg-FP24.1.1_Forge_1.20" = _tytqtHfU;
        "pkg-FP24.1.1_Fabric_1.20" = _XONxwTDV;
        "pkg-FP24.1.1_Forge_1.20.2" = _IqgNLuIg;
        "pkg-FP24.1.1_NeoForge_1.20.2" = _TVhqJeHq;
        "pkg-FP24.1.1_Fabric_1.20.2" = _mIxGtJ3j;
        "pkg-FP24.1.1_Forge_1.20.4" = _xs9iZe9F;
        "pkg-FP24.1.1_NeoForge_1.20.4" = _6jkZwp5b;
        "pkg-FP24.1.1_Fabric_1.20.4" = _Z6O2Npv4;
        "pkg-FP24.2.0_Forge_1.12" = _O0zTQopb;
        "pkg-FP24.2.1_Forge_1.16.5" = _KO08sE9V;
        "pkg-FP24.2.0_Fabric_1.16.5" = _TACu1LBs;
        "pkg-FP24.2.0_Fabric_1.18.2" = _4oJ6PHKn;
        "pkg-FP24.2.0_Forge_1.18.2" = _E0XpeOzO;
        "pkg-FP24.2.0_Fabric_1.19.1" = _7xbndVLK;
        "pkg-FP24.2.0_Forge_1.19.1" = _71bCB1ZL;
        "pkg-FP24.2.0_Fabric_1.19.4" = _EJkPZzYG;
        "pkg-FP24.2.0_Forge_1.19.4" = _kAHavE1F;
        "pkg-FP24.2.0_Fabric_1.20" = _GWbYzvo3;
        "pkg-FP24.2.0_Forge_1.20" = _kN9k0jQJ;
        "pkg-FP24.2.0_NeoForge_1.20.2" = _ezjHRjtn;
        "pkg-FP24.2.0_Fabric_1.20.2" = _ryUdXPQp;
        "pkg-FP24.2.0_Forge_1.20.2" = _PimZUZ6q;
        "pkg-FP24.2.0_Fabric_1.20.4" = _bJG9Xt9N;
        "pkg-FP24.2.0_NeoForge_1.20.4" = _wcNeVpnJ;
        "pkg-FP24.2.0_Forge_1.20.4" = _XLRSHzFh;
        "pkg-FP24.2.0_Fabric_1.20.6" = _BQ2UoDX0;
        "pkg-FP24.2.0_NeoForge_1.20.6" = _ogDYG2Py;
        "pkg-FP24.2.0_Forge_1.20.6" = _LtjsaKQp;
        "pkg-FP24.2.1_NeoForge_1.21" = _BDYdfqZh;
        "pkg-FP24.2.1_Forge_1.21" = _rVOXsYGZ;
        "pkg-FP24.2.1_Fabric_1.21" = _RSLCYMr3;
        "default" = _RSLCYMr3;
    });
