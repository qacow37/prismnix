...
let
    ...
    in {
        ...
        "pkg-1.0.0-Alpha" = _GPO4gAPc;
        "pkg-1.0.0x2" = _okHBNkCX;
        "pkg-1.0.0x4" = _t3q4I7FA;
        "pkg-1.0.0Ultra" = _rPWHaQpK;
        "pkg-1.0.0Ultra_mod" = _EUoPrRsd;
        "pkg-1.0.1x2" = _xLU9I8b4;
        "pkg-1.0.1x4" = _Zy4UlasC;
        "pkg-1.0.1Ultra" = _yMYrpREy;
        "pkg-1.0.1Ultra_mod" = _2yrSsjbC;
        "pkg-1.0.1x4_mod" = _Sw4NMTQH;
        "pkg-1.0.1x2_mod" = _xGDekjhT;
        "pkg-2.0.0x2_Alpha1" = _LAdzQOnm;
        "pkg-7.0.0Ultra" = _JpgkXI3R;
        "pkg-7.0.0x4" = _XVv2e9In;
        "pkg-7.0.0x2" = _7HPQoqo2;
        "pkg-7.0.0Ultra_mod" = _BzCamQKx;
        "pkg-7.0.0x4_mod" = _uh3Qb7WU;
        "pkg-7.0.0x2_mod" = _j89hsyaf;
        "pkg-8.0.0Ultra_Alpha1" = _OSaVr2Or;
        "pkg-9.0.0Ultra_Alpha1" = _JR81WdjJ;
        "pkg-8.0.0Ultra" = _ReiJrbxw;
        "pkg-8.0.0x4" = _3eqVk2Eg;
        "pkg-8.0.0x2" = _xJHVckbm;
        "pkg-8.0.0Ultra_mod" = _qvwXeip2;
        "pkg-8.0.0x4_mod" = _c8rguM41;
        "pkg-8.0.0x2_mod" = _Ie0VI4G1;
        "pkg-9.0.0Ultra" = _EYtQrfAX;
        "pkg-9.0.0x4" = _Y1nSQpAT;
        "pkg-9.0.0x2" = _Fj2IuVXq;
        "pkg-9.0.0Ultra_mod" = _JKvBi7c8;
        "pkg-9.0.0x4_mod" = _44YOWOMb;
        "pkg-9.0.0x2_mod" = _KgDGyHhx;
        "pkg-10.0.0Ultra_Alpha1" = _IpPqq3cA;
        "pkg-10.0.0Ultra" = _sg06wNHn;
        "pkg-10.0.0x4" = _IUn4rJcq;
        "pkg-10.0.0x2" = _KX9mRbE5;
        "pkg-10.0.0Ultra_mod" = _F9sVbSpT;
        "pkg-10.0.0x4_mod" = _xu1owXbv;
        "pkg-10.0.0x2_mod" = _SUAt0kxp;
        "pkg-12.0.0Ultra" = _piWKMfLy;
        "pkg-12.0.0x4" = _eZxkN0lA;
        "pkg-12.0.0x2" = _JqJjOaiL;
        "pkg-12.0.0Ultra_mod" = _kcG5pdiM;
        "pkg-12.0.0x4_mod" = _barm8S9x;
        "pkg-12.0.0x2_mod" = _NBl4csGO;
        "pkg-15.0.0Ultra-Alpha1" = _UPJsqtY6;
        "pkg-2.15.41.1-Alpha1_Ultra" = _2GQ4ku5T;
        "pkg-2.15.41.1-Ultra" = _BIDZgBS1;
        "pkg-2.15.41.1-x4" = _BqHwrvfH;
        "pkg-2.15.41.1-x2" = _XVat5Xt9;
        "pkg-2.15.41.1-Ultra_mod" = _iFWpqr0t;
        "pkg-2.15.41.1-x4_mod" = _ZQJnBrJs;
        "pkg-2.15.41.1-x2_mod" = _Mq0v2xW7;
        "pkg-2.48.61.1-Ultra" = _xkYk5hUc;
        "pkg-2.48.61.1-x4" = _2YwQuERo;
        "pkg-2.48.61.1-x2" = _UbShwZzZ;
        "pkg-2.48.61.1-Ultra_mod" = _z7ujKduY;
        "pkg-2.48.61.1-x4_mod" = _ssu7iCis;
        "pkg-2.48.61.1-x2_mod" = _39j83B5K;
        "pkg-2.15.41.2-Ultra" = _jdRu1ESo;
        "pkg-2.15.41.2-x4" = _nrm4d6aw;
        "pkg-2.15.41.2-x2" = _gFQOvby4;
        "pkg-2.15.41.2-Ultra_mod" = _BMvR0uIl;
        "pkg-2.15.41.2-x4_mod" = _R42xYP0M;
        "pkg-2.15.41.2-x2_mod" = _B9m0561k;
        "pkg-2.48.71.1-Ultra" = _3qM7NuJL;
        "pkg-2.48.71.1-x4" = _wZ8mDU6E;
        "pkg-2.48.71.1-x2" = _NR0awqOK;
        "pkg-2.48.71.1-Ultra_mod" = _LzPBB1g2;
        "pkg-2.48.71.1-x4_mod" = _dWS39dky;
        "pkg-2.48.71.1-x2_mod" = _LAkGcfo0;
        "pkg-2.48.80.1-Ultra" = _3U4XzXG8;
        "pkg-2.48.80.1-x4" = _ZzS6HXhP;
        "pkg-2.48.80.1-x2" = _kjgLNAuW;
        "pkg-2.48.80.1-Ultra_mod" = _KoS7Nrmr;
        "pkg-2.48.80.1-x4_mod" = _ulxb5ENK;
        "pkg-2.48.80.1-x2_mod" = _QJVZjASE;
        "pkg-2.48.81.1-Ultra" = _In0SsDQu;
        "pkg-2.48.81.1-x4" = _BwR1Wo0h;
        "pkg-2.48.81.1-x2" = _B20ixGPd;
        "pkg-2.48.81.1-Ultra_mod" = _NrySqJZg;
        "pkg-2.48.81.1-x4_mod" = _BPcakTQz;
        "pkg-2.48.81.1-x2_mod" = _EpjIyE7T;
        "pkg-2.48.81.2-Ultra" = _2uEBNHDP;
        "pkg-2.48.81.2-x4" = _YiDo2lD2;
        "pkg-2.48.81.2-x2" = _g66hVBgM;
        "pkg-2.48.81.2-Ultra_mod" = _hzCOiBiw;
        "pkg-2.48.81.2-x4_mod" = _SSKb5EaP;
        "pkg-2.48.81.2-x2_mod" = _8HeLrNjt;
        "pkg-3.88.88.0-Ultra" = _bVdUerL1;
        "pkg-3.88.88.0-x4" = _gY81pHuA;
        "pkg-3.88.88.0-x2" = _3qQqBeV6;
        "pkg-3.88.88.0-Ultra_mod" = _fZVy4Djl;
        "pkg-3.88.88.0-x4_mod" = _dZ6OrI7R;
        "pkg-3.88.88.0-x2_mod" = _3SZ7fuLH;
        "pkg-3.88.94.0-Ultra" = _Rxvz0fSR;
        "pkg-3.88.94.0-x4" = _tV2WxvIA;
        "pkg-3.88.94.0-x2" = _ewksu4oj;
        "pkg-3.88.94.0-Ultra_mod" = _WSADv4rj;
        "pkg-3.88.94.0-x4_mod" = _vIf5GMqQ;
        "pkg-3.88.94.0-x2_mod" = _n650LQHL;
        "default" = _n650LQHL;
    });
