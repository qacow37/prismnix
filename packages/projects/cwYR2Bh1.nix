...
let
    ...
    in {
        ...
        "pkg-0.1.8" = _1WEBaXE6;
        "pkg-0.1.9" = _UUQd7ZW7;
        "pkg-0.1.9.1" = _9PRTo6tt;
        "pkg-0.2.0" = _WNLM60sp;
        "pkg-0.2.1" = _UsSxg82W;
        "pkg-0.2.2" = _a225uCCb;
        "pkg-0.2.2.1" = _oCvAI0zK;
        "pkg-0.2.3" = _3KCa9Mmi;
        "pkg-0.2.4" = _YOcm0ODw;
        "pkg-0.2.5" = _NRKCRIio;
        "pkg-0.2.5.1" = _EtNQTRqc;
        "pkg-0.2.5.2" = _YN1fCPNE;
        "pkg-0.2.5.3" = _aaWQPgZq;
        "pkg-0.2.5.3-Updated" = _ndTT7k90;
        "pkg-0.2.5.3-Updated.1" = _YwVmZnuS;
        "pkg-0.2.5.3-Updated.2" = _duZdZtGa;
        "pkg-0.2.5.4" = _zeriowkH;
        "pkg-0.2.5.5" = _DPwRp5sp;
        "default" = _DPwRp5sp;
    });
