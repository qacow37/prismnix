...
let
    ...
    in {
        ...
        "pkg-1.5.0" = _KUVVVm1u;
        "pkg-1.5.1" = _NJBGAnQa;
        "pkg-1.5.2-1.21.x" = _tL8I66eB;
        "pkg-1.5.2-26.1.x" = _4SFenjIy;
        "pkg-1.5.3-26.2" = _Ey6n0bvf;
        "pkg-1.5.3-1.21.x" = _kWKsV4Bv;
        "pkg-1.5.3-26.1.x" = _PYZQtccH;
        "default" = _PYZQtccH;
    });
