...
let
    ...
    in {
        ...
        "pkg-1.43" = _Hg3LiMO3;
        "pkg-1.44" = _UvFyu8ij;
        "pkg-1.44+mod" = _6fdxfSxr;
        "pkg-1.5" = _cHc7fMi7;
        "pkg-1.5+mod" = _KnidvnID;
        "pkg-1.6" = _Zg9v5kvq;
        "pkg-1.6+mod" = _LbaJYl0N;
        "pkg-1.61" = _hcvl1YFM;
        "pkg-1.61+mod" = _mCruRITB;
        "pkg-1.62" = _gAjFvFo7;
        "pkg-1.62+mod" = _EgvAG39S;
        "pkg-1.63.2" = _LL6z0Uv9;
        "pkg-1.63.2+mod" = _mffvDLzy;
        "pkg-2.0" = _cXM0H94r;
        "pkg-2.0+mod" = _INfhFxGX;
        "pkg-2.1" = _EFdhtfhs;
        "pkg-2.1+mod" = _prbm9WHw;
        "pkg-2.1.5" = _awlLMZMn;
        "pkg-2.1.5+mod" = _U4WGcG5x;
        "pkg-2.1.6" = _pALJfgQ6;
        "pkg-2.1.6+mod" = _sSsioxPO;
        "pkg-2.1.7" = _cLhnrWOz;
        "pkg-2.1.7+mod" = _3T0eDPwp;
        "pkg-2.1.8" = _ktmoGlDy;
        "pkg-2.1.8+mod" = _RqPbby3H;
        "pkg-2.2" = _F9fnUAoz;
        "pkg-2.2+mod" = _XjU7nkzR;
        "pkg-2.1.9" = _A8Q936PX;
        "pkg-2.1.9+mod" = _ooj15aDz;
        "pkg-2.1.9b" = _rXJpQhaX;
        "pkg-2.1.9b+mod" = _4qCZuJZM;
        "pkg-v2.1.9c" = _StALGXwd;
        "pkg-v2.1.9c+mod" = _27UVQbdv;
        "pkg-v2.1.9d" = _SZkNLUNL;
        "pkg-v2.1.9d+mod" = _Qu4MAPRo;
        "pkg-2.1.9e" = _tNGZtN4I;
        "pkg-2.1.9e+mod" = _JlEMr4Px;
        "pkg-v2.19.f" = _XPt2N1Pg;
        "pkg-v2.19.f+mod" = _Nrrj1Smf;
        "pkg-2.1.9f" = _jdPDwWtm;
        "pkg-2.1.9f+mod" = _iBqObuQf;
        "pkg-pre3" = _yUoC2327;
        "pkg-pre3+mod" = _MpRpKQjX;
        "pkg-2.1.9g" = _8JvO2LWc;
        "pkg-2.1.9g+mod" = _VBwdIBN9;
        "pkg-2.2a" = _OZcpxRCu;
        "pkg-2.2a+mod" = _vS7Tr0zs;
        "pkg-2.2b" = _2jLYJH5d;
        "pkg-2.2b+mod" = _yrDMDXFi;
        "pkg-2.2d" = _XDtj25JA;
        "pkg-2.2d+mod" = _TJUBRt2l;
        "pkg-2.2e" = _kzgxRB2X;
        "pkg-2.2e+mod" = _RbF11EoM;
        "pkg-2.2f" = _TtFOLyRW;
        "pkg-2.2f+mod" = _i23kVMAk;
        "pkg-2.2g" = _XPCI2KQt;
        "pkg-2.2g+mod" = _fEjrh4cM;
        "pkg-2.2h" = _ImUQFe14;
        "pkg-2.2h+mod" = _UukLF7Aa;
        "pkg-2.2i" = _xH0KQDH0;
        "pkg-2.2i+mod" = _dfwHv7jX;
        "pkg-2.2k" = _8vMB6JXp;
        "pkg-2.2k+mod" = _dceR7GGm;
        "pkg-2.2l" = _cFbx8bKN;
        "pkg-2.2l+mod" = _TnVKnwUN;
        "pkg-2.3" = _y8ydue86;
        "pkg-2.3+mod" = _7CJExacw;
        "pkg-2.3a" = _TYOC8VAy;
        "pkg-2.3a+mod" = _ssEAvoSD;
        "pkg-2.3b" = _jlaJ7LKF;
        "pkg-2.3b+mod" = _R8haCxlT;
        "pkg-2.3c" = _LVSOVDB0;
        "pkg-2.3c+mod" = _iahvShg3;
        "pkg-2.4" = _GD1LNIT4;
        "pkg-2.4+mod" = _5UlNHImS;
        "pkg-v2.4a" = _OKsE5esW;
        "pkg-v2.4a+mod" = _grCgiyLR;
        "pkg-2.4b" = _M70TdZHx;
        "pkg-2.4b+mod" = _usPnl1XE;
        "pkg-2.5" = _b8M6xUlb;
        "pkg-2.5+mod" = _RWssGRve;
        "pkg-2.5a" = _CiC5AEb4;
        "pkg-2.5a+mod" = _g7Ieo8uL;
        "pkg-2.5b" = _V9YcQOLr;
        "pkg-2.5b+mod" = _rPdXAqIj;
        "default" = _rPdXAqIj;
    });
