...
let
    ...
    in {
        ...
        "pkg-1.20" = _jywJE1M2;
        "pkg-1.19.4" = _3ZNqyFZj;
        "pkg-1.19.3" = _kUwhNkmg;
        "pkg-1.19-1.19.2" = _qGQq6o9Q;
        "pkg-1.18.x" = _fLEnX2Ak;
        "pkg-1.17.x" = _UsumnkqF;
        "pkg-1.16.2-1.16.5" = _6q5I4DtM;
        "pkg-1.15-1.16.1" = _xFPmM22y;
        "pkg-1.13.x" = _tiKGAcWo;
        "pkg-1.14" = _lcbTxQ61;
        "pkg-1.11-1.12.2" = _FV0OEHiT;
        "pkg-1.9-1.10.2" = _AGoWrbnW;
        "pkg-1.6.1-1.8.9" = _sg33Xpzg;
        "pkg-1.20.2" = _ACEdMdDz;
        "pkg-1.20.3-1.20.4" = _wmBxHa9J;
        "pkg-1.20.6" = _KCQLXaKR;
        "pkg-1.21-1.21.1" = _ypt53jWH;
        "pkg-1.21.2-1.21.3" = _91EJ6tDg;
        "pkg-1.21.4" = _DL6hhg8t;
        "pkg-1.21.5" = _j4F5UtDF;
        "pkg-1.21.6" = _laM35DBN;
        "pkg-1.21.7-1.21.8" = _YaZg88im;
        "pkg-1.21.9-1.21.10" = _KYi005cA;
        "pkg-1.21.11" = _RDd32em3;
        "default" = _RDd32em3;
    });
