...
let
    ...
    in {
        ...
        "pkg-1.7.10-1.0-4" = _1Rv5XEbl;
        "pkg-1.7.10-1.0-5" = _HYXdFNGD;
        "pkg-1.7.10-1.0-6" = _aeiv6kiR;
        "pkg-1.7.10-1.0-7" = _WaHoP3YC;
        "pkg-1.7.10-1.0-8" = _VbQrGXaM;
        "pkg-1.7.10-1.0-9" = _iajRUniP;
        "pkg-1.7.10-1.0-10" = _Lx8pbAXQ;
        "pkg-1.7.10-1.0-11" = _joJRNvLy;
        "pkg-1.7.10-1.0-12" = _qDRa3xwH;
        "pkg-1.7.10-1.0-13" = _TCHyBau1;
        "pkg-1.7.10-1.0-14" = _hZFZqZRS;
        "pkg-1.7.10-1.0-15" = _jebhEqVm;
        "pkg-1.7.10-1.0.0-16" = _80laDMQU;
        "pkg-1.7.10-1.0.1-17" = _jvCaO6WB;
        "pkg-1.7.10-1.0.1-18" = _83OxS7R2;
        "pkg-1.7.10-1.0.1-19" = _p8nt43eN;
        "pkg-1.7.10-1.0.1-20" = _6ngqWZmF;
        "pkg-1.8-1.0.0-20" = _aOgRrRde;
        "pkg-1.8-1.0.0-21" = _KFz7Wtvi;
        "pkg-1.7.10-1.0.1-22" = _s91BWnVd;
        "pkg-1.7.10-1.0.1-23" = _lcLjOiyc;
        "pkg-1.8-2.0.0-26" = _du5pjJup;
        "pkg-1.8.9-2.0.0-27" = _G8fDwUGk;
        "pkg-1.8.9-2.0.0-28" = _W6RkNYFV;
        "pkg-1.7.10-1.0.1-29" = _fNYtjNJv;
        "pkg-1.9-2.0.0-30" = _2B9SdU04;
        "pkg-1.9-2.0.0-31" = _Co0svMJu;
        "pkg-1.9-2.0.0-32" = _EPXNqWTX;
        "pkg-1.9.4-2.0.0-33" = _GBzF7U33;
        "pkg-1.9.4-2.0.0-34" = _TacIGrtP;
        "pkg-1.9.4-2.0.0-35" = _YnEWJXKc;
        "pkg-1.9.4-2.0.0-36" = _hwmuLh21;
        "pkg-1.9.4-2.0.0-37" = _TrZQU7Cn;
        "pkg-1.9.4-2.0.0-38" = _ZA6sgEd3;
        "pkg-1.9.4-2.0.0-40" = _2N78KQBo;
        "pkg-1.9.4-2.0.0-42" = _u92sZy7h;
        "pkg-1.9.4-2.0.1-43" = _spuTgQH7;
        "pkg-1.9.4-2.0.1-44" = _spGdVcCv;
        "pkg-1.10.2-2.0.2-45" = _9jta3g5L;
        "pkg-1.11-2.0.2-46" = _m9Sb5ce7;
        "pkg-1.11-2.1.0-47" = _Urm8SN6h;
        "pkg-1.11-2.1.0-49" = _t3KjLOk8;
        "pkg-1.10.2-2.0.3-46" = _g5XrwEpe;
        "pkg-1.11-2.1.0-50" = _sHTmWFXA;
        "pkg-1.11-2.1.0-51" = _7U38Ld0D;
        "pkg-1.11.2-2.1.1-52" = _6MxocjMH;
        "pkg-1.12-2.1.2-53" = _8Bth4ZOK;
        "pkg-1.12-2.1.3-55" = _KHMQ8giD;
        "pkg-1.11.2-2.1.4-56" = _SeLxXnyg;
        "pkg-1.12-2.1.4-56" = _4HBjFV0S;
        "pkg-1.12-2.1.4-57" = _eDhfEZzO;
        "pkg-1.12-2.1.5-58" = _tnZQI5wR;
        "pkg-1.12-2.1.5-60" = _A2JpHkoM;
        "pkg-1.12-2.1.6-61" = _Wt6nH9eb;
        "pkg-1.12-2.1.7-62" = _V6cSzQSi;
        "pkg-1.12-2.1.8-63" = _2NQHu8oL;
        "default" = _2NQHu8oL;
    });
