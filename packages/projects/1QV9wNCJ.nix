...
let
    ...
    in {
        ...
        "pkg-0.9.3+1.20.1" = _qWgTtQw9;
        "pkg-0.9.3b+1.20.1" = _ZbTkjV4i;
        "pkg-0.9.4+1.20.1" = _QUpgHnxj;
        "pkg-0.9.4b+1.20.1" = _EJx4fye3;
        "pkg-0.9.4c+1.20.1" = _QRfqVxjt;
        "pkg-0.9.5+1.20.1" = _24ZXFe04;
        "pkg-0.9.6+1.20.1" = _ZZOHzIQO;
        "pkg-0.9.7+1.20.1" = _2SKDicYF;
        "pkg-0.9.9+1.20.1" = _2k0w6y2i;
        "pkg-0.9.10+1.20.1" = _k6dSvxve;
        "pkg-0.9.11+1.20.1" = _Z1crODRu;
        "pkg-0.9.12+1.20.1" = _obVD4XkY;
        "pkg-1.0.0+1.20.1" = _47VxYFDi;
        "pkg-1.1.0+1.20.1" = _18pLP2n7;
        "pkg-1.1.1+1.20.1" = _NRlmnMGT;
        "pkg-1.1.2+1.20.1" = _2bQw0o4i;
        "pkg-1.1.2+1.19.2" = _S8vgfORU;
        "pkg-1.1.2+1.5.0-rc3+1.20.1" = _JF5LJRLS;
        "pkg-1.1.3+1.5.0-rc3" = _iPUUfeu3;
        "pkg-1.1.3+1.5.0" = _YitbTSYj;
        "pkg-1.1.4+1.5.0" = _D16oTcI5;
        "pkg-1.1.5+1.5.0" = _zZDEsiZ9;
        "pkg-1.1.6+1.5.2" = _IacmDmh9;
        "pkg-1.1.7+1.5.2" = _a65XM3W6;
        "pkg-1.1.8+1.5.2" = _RsOU8glE;
        "pkg-1.1.9+1.5.2" = _M48ugRax;
        "pkg-1.1.10+1.5.2" = _QkoYmIJd;
        "pkg-1.1.11+1.5.2" = _Hvn733jo;
        "default" = _Hvn733jo;
    });
