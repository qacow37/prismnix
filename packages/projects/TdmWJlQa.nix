...
let
    ...
    in {
        ...
        "pkg-0.1.1" = _pxUXFLaI;
        "pkg-0.1.2" = _7zoxhl9U;
        "pkg-0.1.3-1.21" = _Y4YKhaFC;
        "pkg-0.1.3-1.21.1" = _sBiZMsWp;
        "pkg-0.1.3-1.21.2" = _rQYgofe6;
        "pkg-0.1.3-1.21.3" = _ZXyHTsMF;
        "pkg-0.1.3-1.21.4" = _Z8NzMJhu;
        "pkg-0.1.4-1.21" = _h4e9Gqs0;
        "pkg-0.1.4-1.21.1" = _lFBQZMIt;
        "pkg-0.1.4-1.21.2" = _Byr9QaHo;
        "pkg-0.1.4-1.21.3" = _SdFU7QIy;
        "pkg-0.1.4-1.21.4" = _TWQ7kebk;
        "pkg-0.1.4-1.21.5" = _4QniEIra;
        "pkg-0.1.4-1.21+NeoForge" = _rJMP2s2i;
        "pkg-0.1.4-1.21.1+NeoForge" = _v3OxiDJy;
        "pkg-0.1.4-1.21.2+NeoForge" = _wfB6FiCC;
        "pkg-0.1.4-1.21.3+NeoForge" = _q6DSizd0;
        "pkg-0.1.4-1.21.4+NeoForge" = _ki0SWERP;
        "pkg-0.1.4-1.21.5+NeoForge" = _eIsJl1b9;
        "pkg-0.1.5+1.21.1-NeoForge" = _fkOhSzSt;
        "pkg-0.1.5+1.21.3-NeoForge" = _IG1YENAQ;
        "pkg-0.1.5+1.21.4-NeoForge" = _VVE1HOif;
        "pkg-0.1.5+1.21.5-NeoForge" = _N1Zn1bDu;
        "pkg-0.1.5+1.21.7-NeoForge" = _t872IixO;
        "pkg-0.1.5+1.21.1-Fabric" = _DZEOE4lZ;
        "pkg-0.1.5+1.21.3-Fabric" = _cEAdgmBI;
        "pkg-0.1.5+1.21.4-Fabric" = _wyrbI92i;
        "pkg-0.1.5+1.21.5-Fabric" = _YzZ1TvPV;
        "pkg-0.1.5+1.21.7-Fabric" = _HE5Z2VP3;
        "pkg-0.1.5+1.21.8-NeoForge" = _ZK97rfRu;
        "pkg-0.2.0+1.21.8-Fabric" = _u6gc35tw;
        "pkg-0.2.0+1.21.9-Fabric" = _pgv0OQ7t;
        "pkg-0.2.0+1.21.11-Fabric" = _LrtP60zu;
        "pkg-0.2.0+1.21.8-NeoForge" = _g6sZOqjW;
        "pkg-0.2.0+1.21.9-NeoForge" = _TNqWIVqh;
        "pkg-0.2.0+1.21.11-NeoForge" = _CY0UV7Tc;
        "default" = _CY0UV7Tc;
    });
