...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.0.1+fabric" = _3MtVItFR;
        "pkg-1.18.2-0.0.1+forge" = _2wcEOODy;
        "pkg-1.18.2-0.0.2+fabric" = _gNMEuSAF;
        "pkg-1.18.2-0.0.2+forge" = _WkqGwVrR;
        "pkg-1.19.2-0.0.2+fabric" = _8pkch0HN;
        "pkg-1.19.2-0.0.2+forge" = _CyyXhd46;
        "pkg-1.19.2-0.0.3+fabric" = _TOnyf3UA;
        "pkg-1.19.2-0.0.3+forge" = _8tYnt9Zz;
        "pkg-1.18.2-0.0.4+fabric" = _jN96llGk;
        "pkg-1.18.2-0.0.4+forge" = _exSf6YcN;
        "pkg-1.19.2-0.0.4+fabric" = _SAHTtxgo;
        "pkg-1.19.2-0.0.4+forge" = _M8JGRQfG;
        "pkg-1.18.2-0.0.5+fabric" = _3Fl8hOtz;
        "pkg-1.18.2-0.0.5+forge" = _D64rZIl4;
        "pkg-1.19.2-0.0.5+fabric" = _MCF4EzVr;
        "pkg-1.19.2-0.0.5+forge" = _567oflnV;
        "pkg-1.18.2-0.0.6+fabric" = _VWoKFIjT;
        "pkg-1.18.2-0.0.6+forge" = _bZVkwKdb;
        "pkg-1.19.2-0.0.6+fabric" = _L3fu5dSI;
        "pkg-1.19.2-0.0.6+forge" = _9IPzmK1h;
        "pkg-1.19.2-0.0.7+fabric" = _BiRwHwrN;
        "pkg-1.19.2-0.0.7+forge" = _bXNVYmSJ;
        "pkg-1.19.2-0.0.8+fabric" = _cIMa4Bqm;
        "pkg-1.19.2-0.0.8+forge" = _dRmKazKT;
        "pkg-1.19.2-0.1.0+fabric" = _UksOb01G;
        "pkg-1.19.2-0.1.0+forge" = _HyrpM4NQ;
        "pkg-1.19.2-0.1.1+fabric" = _V00LVIvj;
        "pkg-1.19.2-0.1.1+forge" = _Isxn8P9F;
        "pkg-1.19.2-0.2.0+fabric" = _V0AJodYh;
        "pkg-1.19.2-0.2.0+forge" = _XuuRcB3V;
        "pkg-1.20.1-0.3.0+fabric" = _fTY8JxDk;
        "pkg-1.20.1-0.3.0+forge" = _lonDNOxc;
        "pkg-1.19.2-0.2.1+fabric" = _F4yUe4Uy;
        "pkg-1.19.2-0.2.1+forge" = _QqkcJ3Gi;
        "pkg-1.20.1-0.4.0+fabric" = _F3XpPtlJ;
        "pkg-1.20.1-0.4.0+forge" = _e6udvRDg;
        "pkg-1.20.1-0.5.0+fabric" = _HcEmNneB;
        "pkg-1.20.1-0.5.0+forge" = _8k3myJ9C;
        "pkg-1.20.1-0.6.0+fabric" = _ET9FkQ76;
        "pkg-1.20.1-0.6.0+forge" = _XvPUW3gf;
        "pkg-1.19.2-0.3.0+fabric" = _YJPQRA5h;
        "pkg-1.19.2-0.3.0+forge" = _OPrF3dPN;
        "pkg-1.20.1-0.7.0+fabric" = _piW6Q8ZF;
        "pkg-1.20.1-0.7.0+forge" = _W6I5wa0F;
        "pkg-1.20.1-0.8.0+fabric" = _ievq7gn7;
        "pkg-1.20.1-0.8.0+forge" = _95SgHHia;
        "pkg-1.20.1-0.9.0+fabric" = _qLnPqIUa;
        "pkg-1.20.1-0.9.0+forge" = _w0e9NS9X;
        "pkg-1.20.1-0.10.0+fabric" = _3CjPWRIp;
        "pkg-1.20.1-0.10.0+forge" = _1K9zkvWg;
        "pkg-1.21-0.11.0+neoforge" = _xD7b9Equ;
        "pkg-1.21-0.12.0+neoforge" = _ZUZyNNoC;
        "pkg-1.21-0.13.0+neoforge" = _YzXmdzvw;
        "pkg-1.21-0.13.1+neoforge" = _xA8Demof;
        "pkg-1.21-0.14.0+neoforge" = _aCz6gFgh;
        "pkg-1.21-0.14.1+neoforge" = _l1JUvhzx;
        "pkg-1.20.1-0.10.1+fabric" = _Pjwc6NB2;
        "pkg-1.20.1-0.10.1+forge" = _KsTniWUD;
        "pkg-1.21.1-0.16.0+neoforge" = _kyNrtsUY;
        "default" = _kyNrtsUY;
    });
