...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _D4Jpcf40;
        "pkg-1.0.1" = _wMR5e15y;
        "pkg-1.0.2-fabric.1.21.x" = _lCHpiiaR;
        "pkg-1.0.2-fabric.1.20.1" = _p8yhTWxR;
        "pkg-1.0.3-fabric.1.21.x" = _z2I4y2iE;
        "pkg-1.0.3-fabric.1.20.1" = _LtGZJfW3;
        "pkg-1.0.3-fabric.1.21.4" = _DnkDyDh1;
        "pkg-1.0.3-neoforge-1.21.1" = _ClNXf6M8;
        "pkg-1.1.0-fabric.1.20.1" = _EYT4nKXj;
        "pkg-1.1.0-fabric.1.21" = _YYi9Q65X;
        "pkg-1.1.0-fabric.1.21.4" = _WTtWEwF8;
        "pkg-1.1.0-fabric.1.21.5" = _c7R2f29f;
        "pkg-1.1.0-neoforge-1.21" = _m4hHNZmv;
        "pkg-1.2.0-fabric.1.20.1" = _dDkzV79i;
        "pkg-2.0.0-fabric.1.20.1" = _plBadKp1;
        "pkg-2.0.1-fabric.1.20.1" = _Eh0oS19D;
        "pkg-2.0.2-fabric.1.20.1" = _SeqkCIEq;
        "pkg-2.0.3-fabric.1.20.1" = _Wzx2PlWB;
        "pkg-2.0.3-fabric.1.21" = _jYAnmsbu;
        "pkg-2.0.3-neoforge-1.21" = _G35IrHgN;
        "pkg-2.0.4-fabric.1.20.1" = _lvvroJYU;
        "pkg-2.0.5-fabric.1.20.1" = _gzl71qqR;
        "pkg-2.0.6-fabric.1.20.1" = _nB426VLh;
        "pkg-2.0.6-neoforge-1.21" = _MNfiqeOC;
        "default" = _MNfiqeOC;
    });
