...
let
    ...
    in {
        ...
        "pkg-Fabric-1.0" = _WmsBbXy8;
        "pkg-Forge-1.0" = _ZlGLuQWv;
        "pkg-Forge-1.1" = _B3HmtmwI;
        "pkg-Fabric-1.1" = _v6Ek2W24;
        "pkg-Fabric-1.2" = _L6TtnKCe;
        "pkg-Forge-1.2" = _bUozcdJ8;
        "pkg-Forge-1.3" = _9JFp08ZE;
        "pkg-Fabric-1.3" = _wxznAH54;
        "pkg-Fabric-1.4" = _CysJ1Tyw;
        "pkg-NeoForge-1.4" = _GbEWKhiV;
        "pkg-Forge-1.5" = _qts7fK9W;
        "pkg-Fabric-1.5" = _EjfXSD3r;
        "pkg-Fabric-1.6" = _zZuALjsZ;
        "pkg-Forge-1.6" = _1wmqqLyr;
        "pkg-Fabric-1.7" = _Hzigp7nB;
        "pkg-Forge-1.7" = _yZHsrxCQ;
        "pkg-Forge-1.7.1" = _z1s0a0Ue;
        "pkg-Fabric-1.7.1" = _m0zpqvCa;
        "pkg-Fabric-1.4.1" = _Neiw94IT;
        "pkg-NeoForge-1.4.1" = _Xv1vh6wM;
        "pkg-Forge-1.4" = _t1y9lLgi;
        "pkg-NeoForge-1.7.1" = _rGlXuuuS;
        "pkg-Fabric-1.7.2" = _4T6fS96a;
        "pkg-Forge-1.7.2" = _hdqueFeg;
        "pkg-NeoForge-1.7.2" = _MXtY8Vhp;
        "pkg-Forge-1.8.0" = _TH8QX1yi;
        "pkg-Fabric-1.8.0" = _shB9Rvym;
        "pkg-Fabric-1.8.1" = _Ii3wj1aa;
        "pkg-Forge-1.8.1" = _LrdObW3d;
        "pkg-NeoForge-1.8.1" = _PVWFekOC;
        "default" = _Ii3wj1aa;
    });
