...
let
    ...
    in {
        ...
        "pkg-1.19.3-1.0-Forge" = _2PadH86h;
        "pkg-1.19.3-1.1-Fabric" = _tiZMUnyP;
        "pkg-1.19.3-1.1-Forge" = _mzHrIyHi;
        "pkg-1.19.2-1.1-Fabric" = _ubwQO6gM;
        "pkg-1.19.2-1.1-Forge" = _y1NXsqwU;
        "pkg-1.19.4-1.1-Fabric" = _rujHeGfE;
        "pkg-1.19.4-1.1-Forge" = _1eEjdh2C;
        "pkg-1.19.3-1.1.1-Fabric" = _75Ig225P;
        "pkg-1.19.3-1.1.1-Forge" = _HFYqNkRW;
        "pkg-1.19.4-1.2-Fabric" = _6fuis9Jq;
        "pkg-1.19.4-1.2-Forge" = _PebMCCHd;
        "pkg-1.20.1-1.2-Fabric" = _8NW0n2kC;
        "pkg-1.20.1-1.2-Forge" = _9CNj7Edh;
        "pkg-1.18.2-1.2-Fabric" = _gxbCqoKk;
        "pkg-1.18.2-1.2-Forge" = _PunV9JDu;
        "pkg-1.18.2-1.3-Fabric" = _LXpCQAnh;
        "pkg-1.18.2-1.3-Forge" = _XI4pOHv0;
        "pkg-1.19.4-1.3-Fabric" = _6m7DWSbt;
        "pkg-1.19.4-1.3-Forge" = _wULoYcjh;
        "pkg-1.20.1-1.3-Fabric" = _ZB1WSIaX;
        "pkg-1.20.1-1.3-Forge" = _mpcAdskv;
        "pkg-1.19.2-1.3-Fabric" = _p7cRC92K;
        "pkg-1.19.2-1.3-Forge" = _7zio6yBP;
        "pkg-1.18.2-2.0-Fabric" = _jYUYnHUp;
        "pkg-1.18.2-2.0-Forge" = _IyXc4fL0;
        "pkg-1.19.4-2.0-Fabric" = _Lhewnmoc;
        "pkg-1.19.4-2.0-Forge" = _33rFR8uK;
        "pkg-1.20.1-2.0-Fabric" = _edvo5WRx;
        "pkg-1.20.1-2.0-Forge" = _7Ad0ePAV;
        "pkg-1.20.4-2.0-Fabric" = _pdODJvWU;
        "pkg-1.20.4-2.0-NeoForge" = _62xWlpPm;
        "pkg-1.20.4-2.0-Forge" = _9ZTdIvJk;
        "pkg-1.20.4-2.1-Forge" = _tC0IvusW;
        "pkg-1.20.4-2.1-Fabric" = _QxekaxeS;
        "pkg-1.20.4-2.1-NeoForge" = _F2UVD80P;
        "pkg-1.18.2-2.1-Fabric" = _AITg74wE;
        "pkg-1.18.2-2.1-Forge" = _nnmjiXN0;
        "pkg-1.19.4-2.1-Fabric" = _oRJCphTV;
        "pkg-1.19.4-2.1-Forge" = _5OI5lfgU;
        "pkg-1.20.1-2.1-Fabric" = _sUqzSnAe;
        "pkg-1.20.1-2.1-Forge" = _JbLqUgXW;
        "pkg-1.20.6-2.1-NeoForge" = _nbBUkBaa;
        "pkg-1.20.6-2.1-Fabric" = _lkCjclkA;
        "pkg-1.20.6-2.1-Forge" = _e8PJuUt7;
        "pkg-1.20.1-2.1.1-Fabric" = _8YVyXvTs;
        "pkg-1.20.1-2.1.1-Forge" = _bBJr4Jrg;
        "pkg-1.20.4-2.1.1-NeoForge" = _2SjA7y35;
        "pkg-1.20.4-2.1.1-Fabric" = _GtHFhagN;
        "pkg-1.20.4-2.1.1-Forge" = _N8kKcrwx;
        "pkg-1.20.6-2.2.0-NeoForge" = _fLhqvHbE;
        "pkg-1.20.6-2.2.0-Fabric" = _aQVL1SSA;
        "pkg-1.20.6-2.2.0-Forge" = _JM7t2O4J;
        "pkg-1.21-2.2.0-NeoForge" = _TrmH6Fca;
        "pkg-1.21-2.2.0-Fabric" = _A0jwYFgJ;
        "pkg-1.21-2.2.0-Forge" = _uVq5MCI7;
        "pkg-1.18.2-2.2.1-Fabric" = _kkQEdojK;
        "pkg-1.18.2-2.2.1-Forge" = _tAks5Xxu;
        "pkg-1.19.4-2.2.1-Fabric" = _I5BHVkvr;
        "pkg-1.19.4-2.2.1-Forge" = _LjJ9RWoZ;
        "pkg-1.20.1-2.2.1-Fabric" = _B6mDKKUh;
        "pkg-1.20.1-2.2.1-Forge" = _Id2G8N9T;
        "pkg-1.20.4-2.2.1-NeoForge" = _BhdHyDeY;
        "pkg-1.20.4-2.2.1-Fabric" = _EeSAZG88;
        "pkg-1.20.4-2.2.1-Forge" = _KbK5WIQ8;
        "pkg-1.20.6-2.2.1-NeoForge" = _3jH37Ap3;
        "pkg-1.20.6-2.2.1-Fabric" = _QCm1TL5D;
        "pkg-1.20.6-2.2.1-Forge" = _HruGXe6r;
        "pkg-1.21-2.2.1-NeoForge" = _pJOcbbKM;
        "pkg-1.21-2.2.1-Fabric" = _3f5apQ0b;
        "pkg-1.21-2.2.1-Forge" = _BBxUAcsi;
        "pkg-1.18.2-2.2.2-Fabric" = _nuxDaBDb;
        "pkg-1.18.2-2.2.2-Forge" = _ep4Xke1z;
        "pkg-1.19.4-2.2.2-Fabric" = _4LlCiz6E;
        "pkg-1.19.4-2.2.2-Forge" = _uRwFNRLu;
        "pkg-1.20.1-2.2.2-Fabric" = _cpaQYf8r;
        "pkg-1.20.1-2.2.2-Forge" = _6kEi1uTL;
        "pkg-1.20.4-2.2.2-NeoForge" = _u55655wb;
        "pkg-1.20.4-2.2.2-Fabric" = _InHAW8eY;
        "pkg-1.20.4-2.2.2-Forge" = _ecKTGfJG;
        "pkg-1.20.6-2.2.2-NeoForge" = _bQwgd4aO;
        "pkg-1.20.6-2.2.2-Fabric" = _4XBCkCLs;
        "pkg-1.20.6-2.2.2-Forge" = _tCt41Chv;
        "pkg-1.21.1-2.2.2-NeoForge" = _pMMKaGfk;
        "pkg-1.21.1-2.2.2-Fabric" = _ToOBKL2y;
        "pkg-1.21.1-2.2.2-Forge" = _QhKWnExI;
        "pkg-1.20.1-2.2.3-Fabric" = _7Wv5puXc;
        "pkg-1.20.1-2.2.3-Forge" = _Oc8KkO3V;
        "pkg-1.21.4-2.2.2-NeoForge" = _8VWw0Fto;
        "pkg-1.21.4-2.2.2-Fabric" = _SHeExat8;
        "pkg-1.21.4-2.2.2-Forge" = _r72X2q9v;
        "pkg-1.21.5-2.2.2-NeoForge" = _oVy6zGCj;
        "pkg-1.21.5-2.2.2-Fabric" = _J3v3ArkC;
        "pkg-1.21.5-2.2.2-Forge" = _GhihqMPT;
        "pkg-1.21.6-2.2.2-NeoForge" = _jXiJG3Fj;
        "pkg-1.21.6-2.2.2-Fabric" = _H73NilUN;
        "pkg-1.21.6-2.2.2-Forge" = _AKJOBHxx;
        "pkg-1.21.7-2.2.2-NeoForge" = _IIVLGO4N;
        "pkg-1.21.7-2.2.2-Fabric" = _w5OLnblE;
        "pkg-1.21.7-2.2.2-Forge" = _7fmLjbnd;
        "pkg-1.21.8-2.2.2-NeoForge" = _WUgmwHN2;
        "pkg-1.21.8-2.2.2-Fabric" = _dTbDwq0x;
        "pkg-1.21.8-2.2.2-Forge" = _fdu1kDLr;
        "pkg-1.21.10-2.2.2-NeoForge" = _VO8pykpp;
        "pkg-1.21.10-2.2.2-Fabric" = _Wu9mbYtS;
        "pkg-1.21.10-2.2.2-Forge" = _yqAeS1Pg;
        "default" = _yqAeS1Pg;
    });
