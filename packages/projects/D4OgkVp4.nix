...
let
    ...
    in {
        ...
        "pkg-2.0.0.0" = _NrYqtB1L;
        "pkg-2.0.0" = _yGAXfgE3;
        "pkg-2.1.0" = _nfPJ86NH;
        "pkg-2.1.1" = _J4qn2o2I;
        "pkg-3.0-alpha" = _BSt8Gtw3;
        "pkg-3.0-alpha.2" = _xul4PYtf;
        "pkg-3.0-beta.1" = _6bR4XZrQ;
        "pkg-3.0" = _g9LKp6A2;
        "pkg-3.0.1" = _EbrKSYCL;
        "pkg-3.0.2" = _ZzNTbErc;
        "pkg-3.0.3" = _cZIaq9sy;
        "pkg-3.0.4" = _BktDYmoa;
        "pkg-3.1.0-beta.1" = _XdfxlVZw;
        "pkg-3.1.0-beta.2" = _5ASI6poF;
        "pkg-3.1.0-beta.3" = _E4fiDIYv;
        "pkg-3.1.0" = _k8ULS2hS;
        "pkg-3.1.1" = _oO12nA1t;
        "pkg-3.2.0-beta.1" = _bxfETUu6;
        "pkg-3.2.0-beta.2" = _KTxZQC4O;
        "pkg-3.2.0-beta.3" = _6yUYccKp;
        "pkg-3.2.0" = _kJgXeJ3W;
        "pkg-3.2.1" = _mVZFafqO;
        "pkg-3.2.2" = _6ZLiQtQz;
        "pkg-3.2.3" = _ZtrTkXfG;
        "pkg-4.0.0-beta.1" = _W5rmAY8f;
        "pkg-4.0.0+1.19.4" = _F120NCp8;
        "pkg-4.0.0-beta.2" = _BrLzyGXu;
        "pkg-4.0.0" = _XEzZFEU0;
        "pkg-4.0.1" = _wycuTidO;
        "pkg-4.0.2" = _1oNiyRcj;
        "pkg-4.0.3-beta.1" = _4VV8TDX4;
        "pkg-4.0.3-beta.2" = _IlokCd6Y;
        "pkg-4.0.3+1.19.4" = _Xu9UFB5M;
        "pkg-4.0.3" = _ADd6BeJX;
        "pkg-5.0.0-beta.1" = _6XdNRWMg;
        "pkg-5.0.0-beta.2" = _Nz9H1kdp;
        "pkg-5.0.0" = _4TDkvc2V;
        "pkg-5.0.0+1.19.4" = _HbdEPO1s;
        "pkg-5.1.0+1.19.4" = _Tr1WKBpZ;
        "pkg-5.1.0" = _fpCJ39ft;
        "pkg-5.2.0+1.19.4" = _fGC5E3pK;
        "pkg-5.2.0+1.20.4" = _uccfSBoo;
        "pkg-6.0.0-beta.1" = _aJruvOWf;
        "pkg-6.0.0+1.20.4" = _z6cPqaAo;
        "pkg-6.0.0+1.19.4" = _HxXanaCY;
        "pkg-6.0.0+1.20.6" = _QrbDI0Lm;
        "pkg-6.0.0+1.21" = _gn3W45qR;
        "pkg-6.0.1+1.21" = _agOwmaIb;
        "pkg-7.0.0-alpha.4+1.21" = _w42UY4hs;
        "pkg-7.0.0-beta.1+1.21.1" = _n7VzJ0qg;
        "pkg-7.0.0-beta.2+1.21.4" = _nhGJMpAt;
        "pkg-7.0.0-beta.3+1.21.4" = _1T0DPIcM;
        "pkg-7.0.0-beta.4+1.21.4" = _24mci5Tn;
        "pkg-7.0.0-beta.5+1.21.4" = _MCZF4ZXa;
        "pkg-7.0.0-beta.6+1.21.4" = _t6rAC9c1;
        "default" = _t6rAC9c1;
    });
