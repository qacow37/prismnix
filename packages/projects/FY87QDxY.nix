...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.3.1.1" = _pS49zY3U;
        "pkg-1.19-0.3.0.1" = _tEV6nis9;
        "pkg-1.18.2-0.3.1.2" = _5XcVQff8;
        "pkg-1.19-0.3.0.1a" = _7ay2ioiB;
        "pkg-1.18.2-0.3.1.2a" = _eo7VRhIq;
        "pkg-1.19-0.3.0.1b" = _Z0P3lESk;
        "pkg-1.18.2-0.3.1.2b" = _WiFhqGlA;
        "pkg-1.19-0.3.0.1c" = _3AiAbFVJ;
        "pkg-1.19-0.3.1.0" = _Z4kxUDmV;
        "pkg-1.19-0.3.1.1" = _3anuRxZb;
        "pkg-1.18.2-0.3.1.3" = _ECZyegtV;
        "pkg-1.19-0.3.1.2" = _pLrreHqU;
        "pkg-1.19-0.3.1.2a" = _bEpGXz5e;
        "pkg-1.19.3-0.3.0.0" = _hwfhpqi1;
        "pkg-1.18.2J9-0.4_Alpha_1" = _YeVVfiVe;
        "pkg-1.18.2JX-0.4_Alpha_1" = _ZVzwQcqV;
        "pkg-1.19-0.4_Alpha_1" = _ZO9XJsDM;
        "pkg-1.18.2J9-0.4_Alpha_1a" = _lxaUjUoM;
        "pkg-1.18.2JX-0.4_Alpha_1a" = _OwQ3qATX;
        "pkg-1.19-0.4_Alpha_1a" = _aQ4mQllO;
        "pkg-1.18.2J9-0.4_Alpha_2" = _C32tPpeG;
        "pkg-1.18.2JX-0.4_Alpha_2" = _isZvyre6;
        "pkg-1.19-0.4_Alpha_2" = _aQvTKbvm;
        "pkg-1.18.2-0.3.1.3a" = _NzEc0IrD;
        "pkg-1.19-0.3.1.2b" = _WA4OSAgc;
        "pkg-1.19.3-0.3.0.0a" = _50Gou2Gd;
        "pkg-1.18.2J9-0.4_Alpha_2a" = _sO8EDdHg;
        "pkg-1.18.2JX-0.4_Alpha_2a" = _ZfXEfk23;
        "pkg-1.19-0.4_Alpha_2a" = _A07crSKO;
        "pkg-1.19.3-0.4_Alpha_2a" = _Oe7NbFwJ;
        "pkg-1.19.4-0.4_Alpha_2a" = _yctXGzI5;
        "pkg-1.18.2J9-0.4_Alpha_3" = _zd2X9OHO;
        "pkg-1.18.2JX-0.4_Alpha_3" = _Vne7gZ9Y;
        "pkg-1.19-0.4_Alpha_3" = _aGzqmz2q;
        "pkg-1.19.3-0.4_Alpha_3" = _MiQCh5fx;
        "pkg-1.19.4-0.4_Alpha_3" = _A8s83OsI;
        "pkg-1.18.2J9-0.4_Alpha_4" = _Yx5FBEYe;
        "pkg-1.18.2JX-0.4_Alpha_4" = _pGWo2wr9;
        "pkg-1.19-0.4_Alpha_4" = _VO7ykynX;
        "pkg-1.19.3-0.4_Alpha_4" = _9noxWsF0;
        "pkg-1.19.4-0.4_Alpha_4" = _fYMjGsv6;
        "pkg-1.18.2-0.3.1.3b" = _ga3tHGdF;
        "pkg-1.19-0.3.1.2c" = _ZHvukHEk;
        "pkg-1.19.3-0.3.0.0b" = _8YCduRC3;
        "pkg-1.18.2J9-0.4_Beta_1" = _ZfPzeJVe;
        "pkg-1.18.2JX-0.4_Beta_1" = _xJ0r8DJM;
        "pkg-1.19-0.4_Beta_1" = _a4ngjbtt;
        "pkg-1.19.3-0.4_Beta_1" = _1eMrF2nJ;
        "pkg-1.19.4-0.4_Beta_1" = _h7jvMBXD;
        "pkg-1.20-0.4_Beta_1" = _iVy2NdcE;
        "pkg-1.18.2J9-0.4.0.0" = _g86TpJth;
        "pkg-1.18.2JX-0.4.0.0" = _nxdBC1L7;
        "pkg-1.19-0.4.0.0" = _CTYW4eIy;
        "pkg-1.19.3-0.4.0.0" = _VNhkLqGX;
        "pkg-1.19.4-0.4.0.0" = _I2v9yapZ;
        "pkg-1.20.1-0.4.0.0" = _UwpSGiZJ;
        "pkg-1.18.2J9-0.4.0.1" = _PRPiTNuN;
        "pkg-1.19-0.4.0.1" = _EZVjdsXm;
        "pkg-1.19.3-0.4.0.1" = _B3xZEADi;
        "pkg-1.19.4-0.4.0.1" = _x1uJ95rt;
        "pkg-1.20.1-0.4.0.1" = _yXwuBIKX;
        "pkg-1.18.2JX-0.4.0.1" = _CIX9dVM3;
