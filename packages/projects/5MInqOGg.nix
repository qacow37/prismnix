...
let
    ...
    in {
        ...
        "pkg-v1.7.0" = _CCmzMVa7;
        "pkg-mc1.15.2-v2.0.0" = _MAGVh3w1;
        "pkg-mc1.18.2-v2.0.0" = _zulqLClP;
        "pkg-mc1.14.4-v2.0.0" = _uHLGzjvL;
        "pkg-mc1.17.1-v2.0.0" = _75g0F4xJ;
        "pkg-mc1.16.5-v2.0.0" = _fBkr5mfk;
        "pkg-mc1.15.2-v2.0.1" = _BjB7ha31;
        "pkg-mc1.16.5-v2.0.1" = _dQ9K4Ejy;
        "pkg-mc1.14.4-v2.0.1" = _cOttTWLZ;
        "pkg-mc1.18.2-v2.0.1" = _9iXD0o8n;
        "pkg-mc1.17.1-v2.0.1" = _efoTJqLo;
        "pkg-mc22w14a-v2.0.1" = _n0Ru90kc;
        "pkg-mc1.15.2-v2.0.2" = _jjQ9vPyy;
        "pkg-mc1.16.5-v2.0.2" = _lc60X4eT;
        "pkg-mc1.14.4-v2.0.2" = _8L7HzXl2;
        "pkg-mc1.18.2-v2.0.2" = _ynAaJ0hP;
        "pkg-mc22w15a-v2.0.2" = _lkvJWayw;
        "pkg-mc1.17.1-v2.0.2" = _HvSoEbXz;
        "pkg-mc1.15.2-v2.1.0" = _OA5ajxiv;
        "pkg-mc1.16.5-v2.1.0" = _CZaIJysX;
        "pkg-mc1.14.4-v2.1.0" = _V6oAff33;
        "pkg-mc1.17.1-v2.1.0" = _wlAU8GiN;
        "pkg-mc1.18.2-v2.1.0" = _sVJUjjRG;
        "pkg-mc1.19-v2.1.0" = _TqrrApR6;
        "pkg-mc1.15.2-v2.1.1" = _9fxEHtX5;
        "pkg-mc1.16.5-v2.1.1" = _rhPr9kZw;
        "pkg-mc1.14.4-v2.1.1" = _OBwkhpab;
        "pkg-mc1.17.1-v2.1.1" = _HaUS1JSs;
        "pkg-mc1.18.2-v2.1.1" = _LsQm2sTP;
        "pkg-mc1.19-v2.1.1" = _ULcOonWr;
        "pkg-mc1.15.2-v2.2.0" = _PtsD78um;
        "pkg-mc1.14.4-v2.2.0" = _5dEPoKC7;
        "pkg-mc1.16.5-v2.2.0" = _ITdJwVn1;
        "pkg-mc1.19.1-v2.2.0" = _R47FLcnO;
        "pkg-mc1.17.1-v2.2.0" = _INWTqY21;
        "pkg-mc1.18.2-v2.2.0" = _9YU7LeeD;
        "pkg-mc1.15.2-v2.2.1" = _6GM4KLal;
        "pkg-mc1.14.4-v2.2.1" = _BV37pEYp;
        "pkg-mc1.16.5-v2.2.1" = _5v1Xciay;
        "pkg-mc1.17.1-v2.2.1" = _YSzkwMpz;
        "pkg-mc1.19.3-v2.2.1" = _kT0fWNEg;
        "pkg-mc1.18.2-v2.2.1" = _ZSaIjTqI;
        "pkg-mc1.15.2-v2.2.2" = _QDAlmQtt;
        "pkg-mc1.14.4-v2.2.2" = _agYZbZcE;
        "pkg-mc1.16.5-v2.2.2" = _r3lIDc99;
        "pkg-mc1.19.3-v2.2.2" = _AN7uhubT;
        "pkg-mc1.17.1-v2.2.2" = _vqpa6pRV;
        "pkg-mc1.18.2-v2.2.2" = _uzeH0742;
        "pkg-mc1.15.2-v3.0.0" = _vC2xduB6;
        "pkg-mc1.17.1-v3.0.0" = _l05KppHj;
        "pkg-mc1.14.4-v3.0.0" = _i6jw1eqd;
        "pkg-mc1.20.6-v3.0.0" = _4sx62Eay;
        "pkg-mc24w20a-v3.0.0" = _7NQO6igg;
        "pkg-mc1.20.2-v3.0.0" = _lslBN2xK;
        "pkg-mc1.19.2-v3.0.0" = _peUoOO7N;
        "pkg-mc1.20.1-v3.0.0" = _s1Sy5KOD;
        "pkg-mc1.18.2-v3.0.0" = _VW60UPSR;
        "pkg-mc1.20.4-v3.0.0" = _EbI5v44T;
        "pkg-mc1.19.4-v3.0.0" = _a09i1Sgo;
        "pkg-mc1.19.3-v3.0.0" = _1yxXDYGw;
        "pkg-mc1.16.5-v3.0.0" = _RaKeWITB;
        "default" = _RaKeWITB;
    });
