...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.1-fabric" = _3QKrTfRl;
        "pkg-1.18.2-2.1-fabric" = _OSlQ3cTt;
        "pkg-1.19.2-2.1-fabric" = _CVAAyBU1;
        "pkg-1.16.5-2.1-forge" = _rAku5JtQ;
        "pkg-1.18.2-2.1-forge" = _GE942ZGd;
        "pkg-1.19.2-2.1-forge" = _8IiX9ZWJ;
        "pkg-1.16.5-2.2-fabric" = _uIoTmIz8;
        "pkg-1.18.2-2.2-fabric" = _B8NPF79s;
        "pkg-1.19.2-2.2-fabric" = _jvHv8Qgt;
        "pkg-1.19.3-2.3-fabric" = _MoNv6CBZ;
        "pkg-1.19.3-2.1-forge" = _yuDiVgMz;
        "pkg-1.18.2-3.0-forge+fabric" = _a0PRitZL;
        "pkg-1.19.2-3.0-forge+fabric" = _UP2vc7fb;
        "pkg-1.19.3-3.0-forge+fabric" = _TvS908D4;
        "pkg-1.18.2-3.1-forge+fabric" = _LqfU7zcE;
        "pkg-1.19.2-3.1-forge+fabric" = _lKICDqtN;
        "pkg-1.19.3-3.1-forge+fabric" = _D7N8xmvt;
        "pkg-1.18.2-3.2-forge+fabric" = _N7tecGmK;
        "pkg-1.19.2-3.2-forge+fabric" = _eN7t8FgB;
        "pkg-1.19.3-3.2-forge+fabric" = _NlkxGjg0;
        "pkg-1.18.2-3.3-forge+fabric" = _rpqep1B4;
        "pkg-1.19.2-3.3-forge+fabric" = _nBxl5hrV;
        "pkg-1.19.3-3.3-forge+fabric" = _T4ske401;
        "pkg-1.19.4-3.3-forge+fabric" = _CYy4kQml;
        "pkg-1.20-3.3-forge+fabric" = _QD4pCIk0;
        "pkg-1.20.1-3.3-forge+fabric" = _zTJOsyEw;
        "pkg-1.20.2-3.3-forge+fabric" = _ys2Qpfzx;
        "pkg-1.18.2-3.4-forge+fabric" = _pLGkntk5;
        "pkg-1.19.2-3.4-forge+fabric" = _mcPFHeTM;
        "pkg-1.20.1-3.4-forge+fabric" = _1yEQCMY6;
        "pkg-1.20.2-3.4-forge+fabric" = _6bJ53nEf;
        "pkg-1.20.3-3.4-fabric+forge+neo" = _GJBFjqv9;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _R9TUAJHR;
        "pkg-1.19.2-3.5-fabric+forge+neo" = _b8BIYz8S;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _vFOlG8jo;
        "pkg-1.20.2-3.5-fabric+forge+neo" = _9MdiKcNW;
        "pkg-1.20.4-3.5-fabric+forge+neo" = _1D2wEQhm;
        "pkg-1.20.5-3.5-fabric+neo" = _FVfm3Y1e;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _ZyDveZlF;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _xSOexFhl;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _UuhJWrlg;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _7DoLJKHO;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _GWmXGz19;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _REYaiYmn;
        "pkg-1.21.2-3.6-fabric+neo" = _oj7wPrI1;
        "pkg-1.21.3-3.6-fabric+forge+neo" = _zhR0xQNj;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _z1exHJiu;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _mCCJz2zI;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _rKgealxN;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _aqcWIDv2;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _qE8ic0WY;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _AA4fGpBW;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _ckXNMx36;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _yiXxWP5g;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _APC6nxTb;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _2tSH9Bpj;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _G0RjzB29;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _5Bp6xRry;
        "default" = _5Bp6xRry;
    });
