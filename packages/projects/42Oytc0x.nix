...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.0" = _vuSlmJcW;
        "pkg-1.21.1-1.0.0" = _vNiFZcQg;
        "pkg-1.20.1-1.0.1" = _3pkg2g6H;
        "pkg-1.21.3-1.0.0" = _YNzRTWZc;
        "pkg-1.21.1-1.0.1" = _AVS85SMq;
        "pkg-1.21.3-1.1.0" = _tgrCIYdJ;
        "pkg-1.21.4-1.0.0" = _PD67RN40;
