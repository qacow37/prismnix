...
let
    ...
    in {
        ...
        "pkg-1.8.x" = _uAzNHXf5;
        "pkg-1.9.x" = _xAe2Hoi3;
        "pkg-1.10.x" = _njtRyYt0;
        "pkg-1.11.x" = _bjJlHkA4;
        "pkg-1.12.x" = _zby4lkoM;
        "pkg-1.13.x" = _3HTwGWe0;
        "pkg-1.14.x" = _qWWXjagL;
        "pkg-1.15.x" = _MKqF1S7q;
        "pkg-1.16-1.16.1" = _zIdFusp1;
        "pkg-1.16.2-1.16.5" = _N8l0r3Dg;
        "pkg-1.17.x" = _YTT1a8gi;
        "pkg-1.18.x" = _bl1ZHwFr;
        "pkg-1.19-1.19.2" = _uNAo4uiI;
        "pkg-1.19.3" = _FiI4Ht6Q;
        "pkg-1.19.4" = _XgkMgd9I;
        "pkg-1.20-1.20.1" = _3Lsenx8P;
        "pkg-1.20.2" = _oYz46pW3;
        "pkg-1.20.3-1.20.4" = _BdtVdUjr;
        "pkg-1.20.5-1.20.6" = _I7VPMUn3;
        "pkg-1.21-1.21.2" = _dbLrgmhk;
        "pkg-1.21.3" = _q5S5sKHi;
        "pkg-1.21.4" = _B8clYjWk;
        "pkg-1.21.5" = _8RtpelXy;
        "pkg-1.21.1" = _29UpjwuM;
        "pkg-1.21.6" = _GDTjmCE8;
        "pkg-1.21.7" = _ukKyflN1;
        "pkg-1.21.8" = _MkBE9b3U;
        "pkg-1.21.9" = _v8jDLCaK;
        "pkg-1.21.10" = _u53y7WTT;
        "pkg-1.21.11" = _eSWOOhh6;
        "pkg-26.1" = _uymzDGCd;
        "default" = _uymzDGCd;
    });
