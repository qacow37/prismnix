...
let
    ...
    in {
        ...
        "pkg-0.1.0-fabric" = _pi2Cb56C;
        "pkg-0.1.0-forge" = _YYbI5tWX;
        "pkg-0.2.0-fabric" = _kkQcu8wD;
        "pkg-0.2.1-forge" = _1JFo8vMa;
        "pkg-0.2.2-fabric" = _aA4E577z;
        "pkg-0.2.2-forge" = _JHEXKoIT;
        "pkg-0.2.3-fabric" = _98nHbrvp;
        "pkg-0.2.3-forge" = _R4mqdavy;
        "pkg-0.2.4-fabric" = _jVIH1LPX;
        "pkg-0.2.4-forge" = _zrNVaz1L;
        "pkg-0.2.5-fabric" = _Dh6HKw85;
        "pkg-0.2.5-forge" = _BDqAB5rz;
        "pkg-0.3.0-fabric" = _PMP76nMP;
        "pkg-0.3.0-forge" = _D8erTE0r;
        "pkg-0.3.1-fabric" = _XiQFpixj;
        "pkg-0.3.1-forge" = _Tz0l4ULU;
        "pkg-0.3.2-fabric" = _JoSkcbls;
        "pkg-0.3.2-forge" = _BedNub2S;
        "pkg-0.4.0-fabric" = _pjTkCkHX;
        "pkg-0.4.0-forge" = _GjkV1IpG;
        "pkg-0.4.1-fabric" = _hr4afAQK;
        "pkg-0.4.1-forge" = _U2y1byYG;
        "pkg-0.4.2-fabric" = _7hBYXuWJ;
        "pkg-0.4.2-forge" = _n1oignmK;
        "pkg-0.5.0-fabric" = _JWuWEoMp;
        "pkg-0.5.0-forge" = _mHubeX1C;
        "pkg-0.5.1-fabric" = _tuPSRb9e;
        "pkg-0.5.1-forge" = _DgM6IIUz;
        "pkg-0.5.2-fabric" = _et00cIKv;
        "pkg-0.5.2-forge" = _5pyt7CcZ;
        "pkg-0.5.3-fabric" = _xOwWrfy4;
        "pkg-0.5.3-forge" = _RXSReBha;
        "pkg-0.5.5-fabric" = _KhsKf6gt;
        "pkg-0.5.5-forge" = _PEWJ90f1;
        "pkg-0.6.0-fabric" = _AUOUJkP8;
        "pkg-0.6.0-quilt" = _ZPTYJSQ9;
        "pkg-0.6.1-forge" = _nxc6KGeo;
        "pkg-0.6.2-fabric" = _8pVuXVhc;
        "pkg-0.6.2-forge" = _KQow65TB;
        "pkg-0.6.2-quilt" = _VBSn7ucw;
        "pkg-0.6.3-1.19-forge" = _H3HKMVId;
        "pkg-0.6.3-1.19-quilt" = _CFFZptHV;
        "pkg-0.7.0-1.19-forge" = _PDfL4l2G;
        "pkg-0.7.0-1.19-quilt" = _XvlcSe6m;
        "pkg-0.7.1-1.19-forge" = _CcpZye6n;
        "pkg-0.7.1-1.19-quilt" = _13mMjIMf;
        "pkg-0.7.2-1.19-forge" = _XLhs8avv;
        "pkg-0.7.2-1.19-quilt" = _htVaTK5O;
        "pkg-0.6.4-fabric" = _f1tuKqn5;
        "pkg-0.6.4-quilt" = _BGie6FHo;
        "pkg-0.6.4-forge" = _6hwa04Cu;
        "pkg-0.7.3-1.19-forge" = _7DeIiae3;
        "pkg-0.7.3-1.19-quilt" = _6uKHuU5A;
        "pkg-0.8.0-1.19-forge" = _zbnGCilX;
        "pkg-0.8.0-1.19-quilt" = _N1S4wPqq;
        "pkg-0.8.1-1.19-quilt" = _qeNYGR3E;
        "pkg-1.0.0-1.19-forge" = _nSHihzZr;
        "pkg-1.0.0-1.19-quilt" = _vh0ruSgA;
        "pkg-1.0.1-1.19.2-quilt" = _H9XBjAew;
        "pkg-1.0.2-1.19.2-forge" = _2OMVnBGF;
        "pkg-1.0.3-1.19.2-quilt" = _jQZwE950;
        "pkg-1.0.3-1.19.2-forge" = _vmOdrOxG;
        "pkg-2.0.0" = _n58UTa0K;
        "pkg-2.0.1" = _1NjffCXI;
        "pkg-0.6.5" = _Ju95gykA;
        "pkg-2.1.0" = _Dumir1YJ;
