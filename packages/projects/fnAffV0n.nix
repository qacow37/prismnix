...
let
    ...
    in {
        ...
        "pkg-1.1.0-fabric+1.19.2" = _zmp1LB6f;
        "pkg-1.1.0-forge+1.19.2" = _gWRODK5Q;
        "pkg-1.1.1-fabric+1.19" = _qr1SDsRQ;
        "pkg-1.1.1-forge+1.19" = _vQCalsBD;
        "pkg-1.1.2-fabric+1.19.2" = _exzshERl;
        "pkg-1.1.2-forge+1.19.2" = _KgYMq0zk;
        "pkg-1.1.3-fabric+1.19.2" = _qi2DH2qg;
        "pkg-1.1.3-forge+1.19.2" = _ZbrcAoke;
        "pkg-1.1.4-fabric+1.19" = _q4LMiB6a;
        "pkg-1.1.5-fabric+1.19.2" = _YWgNPb6Z;
        "pkg-1.1.6-fabric+1.19.2" = _dW4fJEGS;
        "pkg-1.1.6-forge+1.19.2" = _BxueFKJA;
        "pkg-1.2.0-forge+1.20.1" = _bEomsNE8;
        "pkg-1.2.0-fabric+1.20" = _Z1CNQsOB;
        "pkg-1.2.1-forge+1.20.1" = _tqPSIRGd;
        "pkg-1.2.1-fabric+1.19.2" = _kzN5jWrn;
        "pkg-1.2.1-fabric+1.20" = _yt5JPvPy;
        "pkg-1.2.2-forge+1.19.2" = _29izFsIU;
        "pkg-1.2.2-fabric+1.19.2" = _QG8B6a6i;
        "pkg-1.2.2-fabric+1.20" = _pqVYNVoY;
        "pkg-1.2.3-fabric+1.19.2" = _2dsMRTRQ;
        "pkg-1.2.3-fabric+1.20" = _jb78cjt3;
        "pkg-1.2.3-fabric+1.20.2" = _X7tslFgA;
        "pkg-1.2.4-fabric+1.19.2" = _8YNGmA5A;
        "pkg-1.2.4-fabric+1.20" = _MjflezeV;
        "pkg-1.2.4-fabric+1.20.2" = _VaezarCx;
        "pkg-1.2.5-fabric+1.19.2" = _yjzDdEJ8;
        "pkg-1.2.5-fabric+1.20" = _qJBXtnKM;
        "pkg-1.2.5-fabric+1.20.2" = _1flbYGIw;
        "pkg-1.2.6-fabric+1.20" = _Ze2TE9b0;
        "pkg-1.2.6-fabric+1.20.2" = _YFALMm6i;
        "pkg-1.2.6-fabric+1.20.4" = _ymLEGdJs;
        "pkg-1.3.0-forge+1.20.1" = _IcS5UyiT;
        "pkg-1.3.0-neoforge+1.21" = _fDj737e5;
        "pkg-1.3.0-fabric+1.20" = _5R83jXVP;
        "pkg-1.3.0-fabric+1.20.4" = _KEshVc3j;
        "pkg-1.3.0-fabric+1.21" = _LTl5Kmpc;
        "pkg-1.3.1-fabric+1.20" = _2Iz4K93w;
        "pkg-1.3.1-fabric+1.20.4" = _hx9E5ogY;
        "pkg-1.3.1-fabric+1.21" = _zzgUVMQw;
        "pkg-1.3.2-fabric+1.20" = _YbgEcJGO;
        "pkg-1.3.2-fabric+1.20.4" = _s5eP0JmT;
        "pkg-1.3.2-fabric+1.21" = _H0nGVu1V;
        "pkg-1.3.1-forge+1.20.1" = _5CUO6T0S;
        "pkg-1.3.2.1-fabric+1.20" = _JcDkzJzw;
        "pkg-1.3.2.1-fabric+1.20.4" = _Meg92c7E;
        "pkg-1.3.2.1-fabric+1.21" = _RXdwJw5B;
        "pkg-1.3.2-forge+1.20.1" = _6sF2nUTB;
        "pkg-1.3.2-neoforge+1.21" = _j3yhChYm;
        "pkg-1.3.3-forge+1.20.1" = _e2oirgc2;
        "pkg-1.3.3-neoforge+1.21" = _gBoSaWJ6;
        "pkg-1.3.4-neoforge+1.21" = _5FhUw189;
        "pkg-1.3.3-fabric+1.20" = _BCzjX2ii;
        "pkg-1.3.3-fabric+1.20.4" = _1MWYg4UJ;
        "pkg-1.3.3-fabric+1.21" = _MoitXjJY;
        "pkg-1.3.3-plus-fabric+1.20" = _vk0DMgtP;
        "pkg-1.3.3-plus-fabric+1.21" = _NSF7DmXn;
        "pkg-1.3.3-plus-a-fabric+1.21" = _4qmkPbFh;
        "pkg-1.3.3-plus-b-fabric+1.21" = _3MnQb3Tb;
        "pkg-1.3.3-plus-b.rc1-fabric+1.20" = _YG1ftWn9;
        "pkg-1.3.3-plus-b.rc2-fabric+1.20" = _XVJ2mahQ;
        "pkg-1.3.3-plus-b-fabric+1.20" = _GeXcCDSS;
        "pkg-1.4-neoforge-1.21.1" = _G6YDRA79;
        "pkg-1.4.1-neoforge-1.21.1" = _TuD0Zvi3;
        "pkg-2.0.0s-alpha.1+1.20.1" = _JRleU5be;
        "default" = _JRleU5be;
    });
