...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _89e7IIJu;
        "pkg-1.0.0+split1" = _Anq0Ae7N;
        "pkg-1.0.0+split2" = _enZZV1Gg;
        "pkg-1.1.0+split1" = _LDmbmFb1;
        "pkg-1.1.0+split3" = _myEfBqpC;
        "pkg-1.1.0+split2" = _8jYLYiO3;
        "pkg-1.1.0" = _epJuiRpH;
        "pkg-1.1.1+split1" = _K0QbDmc0;
        "pkg-1.1.1+split3" = _dk5L7Cny;
        "pkg-1.1.1+split2" = _OA1gpvGy;
        "pkg-1.1.1" = _SiOocixW;
        "pkg-1.1.2+split1" = _HQZAADGz;
        "pkg-1.1.2+split3" = _dZKLCxWk;
        "pkg-1.1.2+split2" = _EPTyCD6b;
        "pkg-1.1.2" = _bul1J7yG;
        "pkg-1.2.0+split1" = _vaUM7h9d;
        "pkg-1.2.0+split3" = _f3aWNWPX;
        "pkg-1.2.0+split2" = _B2jcY0uN;
        "pkg-1.2.0" = _zOz7P3Bp;
        "pkg-1.2.1+split3" = _k0VJRsL2;
        "pkg-1.2.2+split1" = _xANxkEw4;
        "pkg-1.2.2+split3" = _jdA4z2iF;
