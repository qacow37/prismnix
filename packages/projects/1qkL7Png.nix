...
let
    ...
    in {
        ...
        "pkg-1.6.8" = _w7qFRtAt;
        "pkg-1.7.3" = _DoLnbsq9;
        "pkg-2.4.22" = _whNPEimX;
        "pkg-2.4.23" = _7JBsKYQD;
        "pkg-2.4.24" = _uj3CDTH1;
        "pkg-2.4.25" = _ofINHgId;
        "pkg-2.4.26" = _fi2oZFse;
        "pkg-3.0.5+1" = _ZFi4WnY5;
        "pkg-3.0.5+3" = _i6Ou9JUx;
        "pkg-3.0.5+4" = _3Thv7wTR;
        "pkg-3.0.5+11" = _1M6eD16R;
        "pkg-3.0.5+12" = _wNZLzBZ4;
        "pkg-3.0.6" = _7eAqc9BT;
        "pkg-2.4.27" = _tsDjJOIm;
        "pkg-3.0.7" = _iyaKcunW;
        "pkg-3.0.8" = _Ka48zbUA;
        "pkg-2.4.28" = _d9h8nsci;
        "pkg-3.0.9" = _5gR3WgPY;
        "pkg-3.0.10" = _XjdYt3V2;
        "pkg-3.0.11" = _sFZ0Bs2F;
        "pkg-3.0.12" = _c1SRqRJC;
        "pkg-2.4.29" = _9QbDmkT1;
        "pkg-2.4.30" = _QYF94NHC;
        "pkg-3.0.13" = _cWHLp2yb;
        "pkg-2.5.0" = _R1H5wvzx;
        "pkg-3.0.14" = _aTmRdQOQ;
        "pkg-3.0.15" = _3zUtvHJg;
        "pkg-2.5.1" = _h9C2bdDy;
        "pkg-3.0.17" = _lsVU3jVD;
        "pkg-2.5.2" = _wWZhfxOm;
        "pkg-3.0.18" = _Fonmfrwl;
        "pkg-3.0.19" = _GMhIC3cX;
        "pkg-2.5.3" = _roEGksTV;
        "pkg-3.0.20" = _urpDs4Uh;
        "pkg-2.5.4" = _hgYhARd5;
        "pkg-3.0.21" = _mrGGV9JH;
        "pkg-3.0.22" = _qipcirSN;
        "pkg-2.5.5" = _KQFeb9Fe;
        "pkg-3.0.23" = _O96YXTi0;
        "pkg-2.5.6" = _MClEVIln;
        "pkg-3.0.24" = _GeUXVkCx;
        "pkg-3.1.0" = _50bEIaTm;
        "pkg-2.5.7" = _iQxDnFzz;
        "pkg-2.5.8" = _brrzYSjY;
        "pkg-3.1.1" = _DKFbzPFN;
