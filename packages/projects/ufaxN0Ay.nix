...
let
    ...
    in {
        ...
        "pkg-2.2.8" = _k5tkPA2Q;
        "pkg-2.2.9" = _ldHqyJbU;
        "pkg-2.2.10" = _Gb99ulcD;
        "pkg-2.2.11" = _s5oA5xyG;
        "pkg-2.2.12" = _DinOQvvx;
        "pkg-2.3.0" = _bIxK7oLb;
        "pkg-2.3.1" = _Od9FNYvQ;
        "pkg-2.3.2" = _gVXWqhWC;
        "pkg-2.3.3" = _5KzTfHHY;
        ...
        "pkg-2.9.4" = _epppcgyH;
        "pkg-2.9.5" = _x2uyYFe9;
        "pkg-2.10.0" = _gXJ3A5Nr;
        "pkg-2.10.1" = _hxwlXk0o;
        "pkg-2.10.2" = _l22pgIgh;
        "pkg-2.10.3" = _nc7bzz1K;
        "pkg-2.10.4" = _WFaIFfRj;
        "pkg-2.10.5" = _KXcSPj08;
        "pkg-2.10.6" = _aJPQ5XYc;
        "pkg-2.10.7" = _lUzdvktt;
        "pkg-2.10.8" = _EG6OJOPt;
        "pkg-2.10.9" = _Xa6EDVRw;
        "pkg-2.10.10" = _zKdTZ0vV;
        "pkg-2.10.11" = _c5kENLeD;
        "pkg-2.10.12" = _qXXkeoTR;
        "pkg-2.10.13" = _FKDBK5yN;
        "pkg-2.10.14" = _JNiS92cT;
        "pkg-2.11.0" = _5kfsJhmi;
        "pkg-2.11.1" = _aY3rk7v8;
        "pkg-2.11.2" = _sdMLaN28;
        "pkg-2.11.3" = _30CV5m5i;
        "pkg-2.12.0" = _ZPkbHxUq;
        "pkg-3.0.0" = _jp9qCt6p;
        "pkg-3.1.0" = _wFfz8Hms;
        "pkg-3.1.1" = _sDC7KxZB;
        "pkg-3.0.2" = _oSbk8Hax;
        ...
        "pkg-3.0.9" = _aLS4pqDi;
        "pkg-3.2.5" = _jpy7YVu8;
        "pkg-3.0.10" = _pkuk5hKP;
        "pkg-3.0.11" = _XeXwKqyv;
        "pkg-3.0.12" = _mpox9jOG;
        "pkg-3.0.13" = _tKEfzW1y;
        "pkg-3.0.14" = _mzxf9Pk8;
        "pkg-3.0.15" = _HpMQzGzA;
        "pkg-3.2.6" = _tiZI9pU4;
        "pkg-3.0.16" = _4K2HPBuV;
        "pkg-3.2.7" = _NMIsdJDW;
        "pkg-3.2.8" = _Qyhk1OpJ;
        "pkg-3.0.17" = _DHlZZDOs;
        "pkg-3.0.18" = _eZ2WUPEI;
        "pkg-3.0.19" = _xgR73gLC;
        "pkg-3.0.20" = _nGGVqqQj;
        "pkg-3.0.21" = _31DmEluk;
        "pkg-3.0.22" = _hktj2IuR;
        "pkg-3.0.23" = _ucr5MvAY;
        "pkg-3.0.24" = _8dr1b7sG;
        "pkg-3.2.9" = _1lqHSUoo;
        "pkg-3.2.10" = _mK8McyY7;
        "pkg-3.0.25" = _DEBU9HdD;
        "pkg-3.2.12" = _VymiDrlS;
        "pkg-3.2.13" = _PLQlEalE;
        "pkg-3.0.26" = _9kffKcA6;
        "pkg-3.0.27" = _TktNACd0;
        "pkg-3.0.28" = _Ts6UHQH8;
        "pkg-3.0.29" = _BQJWCZu3;
        "pkg-3.2.14" = _TtKSNBbH;
        "pkg-3.2.15" = _ULSokxX1;
        "pkg-3.0.30" = _cHmIcA9e;
        "pkg-3.0.31" = _k56f0cGz;
        "pkg-3.0.32" = _2naLa4Ko;
        "pkg-3.2.16" = _omPqooLK;
        "pkg-3.0.33" = _jFPDiuM2;
        "pkg-3.0.34" = _QbJAar4C;
        "pkg-3.0.35" = _oZ1IIHXj;
        "pkg-3.2.17" = _4ll6ZnLW;
        "pkg-3.0.36" = _blHfpPCF;
        "pkg-3.0.37" = _rhjdwLZM;
        "pkg-3.0.38" = _EtaU2npQ;
        "pkg-3.2.18" = _jzdYWRdX;
        "pkg-3.2.19" = _vr5XfkUM;
        "pkg-3.2.20" = _cjVjVwPS;
        "pkg-3.0.40" = _z3wJLZO1;
        "pkg-3.0.41" = _nvPUjaxs;
        "pkg-3.2.21" = _hOV4dG6a;
        "pkg-3.0.42" = _wepRh0a3;
        "pkg-3.2.22" = _vPbtgVyY;
        "pkg-4.0.0" = _Z85VHlew;
        "pkg-4.1.0" = _gNSi7Zu1;
        "pkg-4.0.1" = _g1afAer5;
        "pkg-4.1.1" = _kCXMvrK7;
