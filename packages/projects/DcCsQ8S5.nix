...
let
    ...
    in {
        ...
        "pkg-1.12.2-2.4.1" = _5n4ik2e5;
        "pkg-1.16.5-2.4.0" = _mLvs9aL0;
        "pkg-1.18.2-2.4.0" = _O6IjVzjl;
        "pkg-1.19.2-2.4.0" = _Ym4yrk9D;
        "pkg-1.19-2.4.0" = _9q98ew6J;
        "pkg-1.20.2-2.5.0" = _MKmp2zc3;
        "pkg-1.19.2-2.5.0" = _jhV9wlLI;
        "pkg-1.18.2-2.5.0" = _S5TMg4V5;
        "pkg-1.16.5-2.5.0" = _s7ZoKU8S;
        "pkg-1.19-2.5.0" = _CLPrm55w;
        "pkg-1.20.6-2.5.0" = _KfjEiSRj;
        "pkg-1.20.1-2.5.0" = _HHXRQNB3;
        "pkg-1.21-2.5.1" = _TpCOQvyS;
        "pkg-1.16.5-2.7.0" = _jE6INrOA;
        "pkg-1.18.2-2.7.0" = _gIA7LIWk;
        "pkg-1.19.2-2.7.0" = _5C0ZTwIN;
        "pkg-1.19-2.7.0" = _ZzF0iHsO;
        "pkg-1.20.1-2.7.0" = _Br8uKl1G;
        "pkg-1.20.2-2.7.0" = _I20DcQZb;
        "pkg-1.20.6-2.7.0" = _hIElqTa8;
        "pkg-1.21-2.7.0" = _q6PrUD7I;
        "pkg-1.21-2.8.0" = _l9YUKZzP;
        "pkg-1.21.3-2.8.0" = _kWEHtwXN;
        "pkg-1.21.1-2.8.0" = _N8Nemo1Z;
        "pkg-1.20.6-2.8.0" = _neqxynrz;
        "pkg-1.20.2-2.8.0" = _JkpNnrd0;
        "pkg-1.20.1-2.8.0" = _ISPoXN12;
        "pkg-1.19-2.8.0" = _Yc05te5W;
        "pkg-1.19.2-2.8.0" = _tFrPau0n;
        "pkg-1.18.2-2.8.0" = _dz0a5w8Y;
        "pkg-1.16.5-2.8.0" = _EfYcTb6o;
        "pkg-1.21.2-2.8.0" = _1n3bKBSf;
        "pkg-1.21.1-2.8.1" = _q7HYgq43;
        "pkg-1.21.2-2.8.1" = _UdweIIgb;
        "pkg-1.21.3-2.8.1" = _FaTPjnOp;
        "pkg-1.21-2.8.1" = _1hBFgxyf;
        "pkg-1.16.5-2.8.1" = _ICDiiRCs;
        "pkg-1.18.2-2.8.1" = _w8dWhGuq;
        "pkg-1.19.2-2.8.1" = _5NVqQAix;
        "pkg-1.19-2.8.1" = _YCrQdmYE;
        "pkg-1.20.1-2.8.1" = _ERfqvppy;
        "pkg-1.20.2-2.8.1" = _AhV61dBV;
        "pkg-1.20.6-2.8.1" = _QnBYp2VB;
        "pkg-1.21.4-2.8.1" = _E0rrslIE;
        "pkg-1.21.5-2.8.1" = _tTGIHOPL;
        "pkg-1.20.1-2.8.2" = _TqBCoHyB;
        "pkg-1.21-2.8.2" = _10GTvBXc;
        "pkg-1.21.1-2.8.2" = _zGtBuvdY;
        "pkg-1.21.2-2.8.2" = _YMxSK6Cd;
        "pkg-1.21.5-2.8.2" = _rcbneQn6;
        "pkg-1.21.6-2.8.2" = _4auJqtIH;
        "pkg-1.21.10-2.8.2" = _gLktnceP;
        "pkg-1.21.3-2.8.2" = _RsPHyzBe;
        "pkg-1.21.4-2.8.2" = _1wZATb4Y;
        "pkg-1.21.8-2.8.2" = _ioFWQp8T;
        "pkg-1.21.9-2.8.2" = _2A0bhyaT;
        "pkg-1.21.7-2.8.2" = _ft1YIyEH;
        "pkg-1.20.1-2.8.3" = _oyd4Y1FZ;
        "pkg-1.21-2.8.3" = _UIfrlDXg;
        "pkg-1.21.1-2.8.3" = _IOlnqh6i;
        "pkg-1.21.10-2.8.3" = _Ma6QlesQ;
        "pkg-1.21.11-2.8.3" = _IpGLoOJo;
        "pkg-1.21.2-2.8.3" = _idO8OIb6;
        "pkg-1.21.3-2.8.3" = _2ckqTNip;
        "pkg-1.21.4-2.8.3" = _pCy66Mwl;
        "pkg-1.21.5-2.8.3" = _U7Lhkhfb;
        "pkg-1.21.6-2.8.3" = _zvUetnOi;
        "pkg-1.21.7-2.8.3" = _HdBKZwwm;
        "pkg-1.21.8-2.8.3" = _TgZzqtjP;
        "pkg-1.21.9-2.8.3" = _scDRFYZ4;
        "pkg-26.1.2-2.8.4" = _32QXluVe;
        "pkg-1.20.1-2.9.0" = _hvR5ZasC;
        "pkg-1.21-2.9.0" = _4BVKpppd;
        "pkg-1.21.2-2.9.0" = _WKRhXC1V;
        "pkg-1.21.3-2.9.0" = _j1PcpQg7;
        "pkg-1.21.4-2.9.0" = _IU85mdWE;
        "pkg-1.21.5-2.9.0" = _ttVhTia3;
        "pkg-1.21.6-2.9.0" = _ZBfI2GTP;
        "pkg-1.21.7-2.9.0" = _7lpPMVko;
        "pkg-1.21.8-2.9.0" = _yTatHRz9;
        "pkg-26.1.2-2.9.0" = _nSJjot1r;
        "pkg-26.2-2.9.0" = _UryZT1YO;
        "pkg-1.21.1-2.9.0" = _XNBtSbFS;
        "pkg-1.21.10-2.9.0" = _xZBatWfq;
        "pkg-1.21.11-2.9.0" = _9EQ4K5ZW;
        "pkg-1.21.9-2.9.0" = _dkHsgcgb;
        "default" = _XNBtSbFS;
    });
