...
let
    ...
    in {
        ...
        "pkg-0.1.2" = _CkLX1Upa;
        "pkg-0.1.2-1.19.2" = _1xPcXle1;
        "pkg-0.1.3-1.19.2" = _Hq9BG5d9;
        "pkg-0.1.3-1.20.1" = _uwRcdU4y;
        "pkg-0.1.3-p1-1.19.2" = _ml52Xc99;
        "pkg-0.1.3-p1-1.20.1" = _Gx7VoqKF;
        "pkg-0.1.4-1.19.2" = _zKSO8GuP;
        "pkg-0.1.4-1.20.1" = _rJII1xZR;
        "pkg-0.1.5" = _RQ0LsDvS;
        "pkg-0.1.5a-1.20.1" = _MNI1UCNp;
        "pkg-0.1.5b" = _bUHd7nI4;
        "pkg-fabric-1.20.1-0.1.5.3" = _J35QW9iW;
        "pkg-1.20.1-0.1.5.4" = _sMOYTsLH;
        "pkg-fabric-0.2.0-beta-1" = _3WD9NRPX;
        "pkg-forge-0.2.0-beta-1" = _Uun7iZq7;
        "pkg-fabric-0.2.0-beta-2" = _AAUOljsi;
        "pkg-forge-0.2.0-beta-2" = _ZdfrDRPs;
        "pkg-fabric-1.20.1-0.2.0-beta-3" = _fewYi2Ix;
        "pkg-forge-1.20.1-0.2.0-beta-3" = _FtnoFUcP;
        "pkg-fabric-1.20.1-0.2.0" = _1PO70vtF;
        "pkg-forge-1.20.1-0.2.0" = _SMd5xumd;
        "pkg-fabric-1.21-0.2.0-beta-1" = _frSUFVl7;
        "pkg-neoforge-1.21-0.2.0-beta-1" = _3QUX1uFw;
        "pkg-fabric-1.21-0.2.0-beta-2" = _sMjJ2aSP;
        "pkg-neoforge-1.21-0.2.0-beta-2" = _8IyrsaOL;
        "pkg-fabric-1.21-0.2.0" = _L0CZyrhq;
        "pkg-neoforge-1.21-0.2.0" = _5uB9rs4T;
        "pkg-fabric-1.20.1-0.2.1" = _nsFwzgk6;
        "pkg-forge-1.20.1-0.2.1" = _726s2HFK;
        "pkg-fabric-1.21-0.2.1" = _O05k3C7p;
        "pkg-neoforge-1.21-0.2.1" = _RdiaJkmc;
        "pkg-fabric-1.20.1-0.2.2" = _wIhSo23Q;
        "pkg-forge-1.20.1-0.2.2" = _5BE3MBy4;
        "pkg-fabric-1.21.1-0.2.2" = _jfPNwt7v;
        "pkg-neoforge-1.21.1-0.2.2" = _ku2TvQBP;
        "pkg-fabric-1.20.1-0.2.3" = _c2ubCIDG;
        "pkg-forge-1.20.1-0.2.3" = _nHNfWB1B;
        "pkg-fabric-1.21.1-0.2.3" = _40O8kGzz;
        "pkg-neoforge-1.21.1-0.2.3" = _Zd56vPhb;
        "pkg-fabric-1.20.1-0.3.0" = _C4yWURYP;
        "pkg-forge-1.20.1-0.3.0" = _trGX1xIF;
        "pkg-fabric-1.21.1-0.3.0" = _ejHrVDSH;
        "pkg-neoforge-1.21.1-0.3.0" = _LrkhauRN;
        "pkg-fabric-1.20.1-0.3.1" = _chGPsXtQ;
        "pkg-forge-1.20.1-0.3.1" = _UxRq5PEj;
        "pkg-fabric-1.21.1-0.3.1" = _xuHhTca9;
        "pkg-neoforge-1.21.1-0.3.1" = _TwekcaQz;
        "pkg-fabric-1.20.1-0.3.2" = _LwzR2W1q;
        "pkg-forge-1.20.1-0.3.2" = _KOFkSh2P;
        "pkg-fabric-1.21.1-0.3.2" = _vOlaigKV;
        "pkg-neoforge-1.21.1-0.3.2" = _qn8GchUZ;
        "pkg-fabric-1.20.1-0.3.3" = _CM4GVuTa;
        "pkg-forge-1.20.1-0.3.3" = _ddTQtrZB;
        "pkg-fabric-1.21.1-0.3.3" = _RqO3oqzb;
        "pkg-neoforge-1.21.1-0.3.3" = _Rz0eBbiK;
        "pkg-fabric-1.20.1-0.3.4" = _yk1mF6Jd;
        "pkg-forge-1.20.1-0.3.4" = _5bL3Ntdy;
        "pkg-fabric-1.21.1-0.3.4" = _7fFZ7Umr;
        "pkg-neoforge-1.21.1-0.3.4" = _3oN0GfYM;
        "pkg-fabric-1.21.1-0.4.0-3.0.0+refab" = _OmzeaunP;
        "pkg-neoforge-1.21.1-0.4.0" = _ZvTubwCQ;
        "pkg-fabric-1.20.1-0.4.1" = _54WZKZtx;
        "pkg-forge-1.20.1-0.4.1" = _BuuEqte8;
        "pkg-fabric-1.21.1-0.4.1-3.0.0+refab" = _kNiwiNPy;
        "pkg-neoforge-1.21.1-0.4.1" = _z3N4HTDl;
        "pkg-fabric-1.20.1-0.4.2" = _oYmEfI5c;
        "pkg-fabric-1.20.1-0.4.3" = _ECMrByNQ;
        "pkg-forge-1.20.1-0.4.3" = _QJyFKokI;
        "pkg-fabric-1.21.1-0.4.3-3.0.0+refab" = _tSOrsvPv;
        "pkg-neoforge-1.21.1-0.4.3" = _E6ohxLk8;
        "pkg-fabric-1.21.1-0.4.4-3.0.0+refab" = _7Fyr60vE;
        "pkg-neoforge-1.21.1-0.4.4" = _EcjdCAgj;
        "pkg-neoforge-1.21.1-0.4.5" = _c8UbZ3pg;
        "pkg-fabric-1.20.1-0.4.6" = _2XOeG36k;
        "pkg-forge-1.20.1-0.4.6" = _A6KSZaNB;
        "pkg-fabric-1.21.1-0.4.6-3.0.0+refab" = _HVd73hFr;
        "pkg-neoforge-1.21.1-0.4.6" = _JOSa8bBE;
        "pkg-fabric-1.21.1-0.4.7-3.0.0+refab" = _U6IlPTAn;
        "pkg-neoforge-1.21.1-0.4.7" = _nQ1PHrtH;
        "pkg-fabric-1.21.5-0.4.7" = _J2jEVYpB;
        "pkg-fabric-1.21.8-0.4.7" = _jWy7DZ4d;
        "pkg-fabric-1.21.10-0.4.7" = _vaHCxBhh;
        "pkg-fabric-1.21.11-0.4.8" = _WnJWUK5E;
        "pkg-forge-1.20.1-0.4.9" = _caXvmRGA;
        "pkg-fabric-1.20.1-0.4.9" = _tFNG4aAj;
        "pkg-fabric-1.21.1-0.4.9-3.0.0+refab" = _w88FG8JU;
        "pkg-neoforge-1.21.1-0.4.9" = _Du7SV4vt;
        "pkg-fabric-1.21.5-0.4.9" = _NuK4RmOv;
        "pkg-fabric-1.21.8-0.4.9" = _Dl3kWbHD;
        "pkg-fabric-1.21.10-0.4.9" = _NU4rpRXd;
        "pkg-fabric-1.21.11-0.4.9" = _c0UvhcVu;
        "pkg-fabric-1.21.11-0.4.10" = _gh9FSquQ;
        "pkg-forge-1.20.1-0.4.11" = _4OwiKsvb;
        "pkg-fabric-1.20.1-0.4.11" = _Cbt2vJ7R;
        "pkg-neoforge-1.21.1-0.4.11" = _2nLA0KoE;
        "pkg-fabric-1.21.1-0.4.11-3.0.0+refab" = _OG56IpwP;
        "pkg-fabric-1.21.5-0.4.11" = _MJCdPlna;
        "pkg-fabric-1.21.8-0.4.11" = _wIfrcEZg;
        "pkg-fabric-1.21.10-0.4.11" = _6tsaEUWX;
        "pkg-fabric-1.21.11-0.4.11" = _5CPUeaC4;
        "pkg-forge-1.20.1-0.4.12" = _wYCIvwtk;
        "pkg-fabric-1.20.1-0.4.12" = _hshjWmab;
        "pkg-forge-1.20.1-0.4.13" = _1OULB3lA;
        "pkg-fabric-1.21.1-0.4.13-3.0.0+refab" = _iDizWwTL;
        "pkg-neoforge-1.21.1-0.4.13" = _Nvae2Qs4;
        "pkg-26.1.2-0.4.13" = _HsKvFAKn;
        "pkg-forge-1.20.1-0.4.14" = _UK9qL8Nu;
        "pkg-fabric-1.21.1-0.4.14-3.0.0+refab" = _nTtwab1i;
