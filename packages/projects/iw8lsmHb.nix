...
let
    ...
    in {
        ...
        "pkg-1.6.7" = _c1AzN2pR;
        "pkg-1.6.8" = _A3HZLx1I;
        "pkg-1.6.8+1.20.6" = _NCz5DjDW;
        "pkg-1.6.9+1.21" = _lqyEzcI3;
        "pkg-1.6.10+1.21" = _TUC34dWr;
        "pkg-1.7.0+1.21.3" = _HApa82u4;
        "pkg-1.7.1+1.21.3" = _k78Z9jnz;
        "pkg-1.7.1+1.21" = _nmDPWptS;
        "pkg-1.7.2+1.21.4" = _AzCocIew;
        "pkg-1.7.2+1.21.5" = _5ukhS14T;
        "pkg-1.7.2+1.21.8" = _Zxhfi4jj;
        "pkg-1.7.3+1.21.8" = _hvnJHkkI;
        "pkg-1.7.4+1.21.11" = _M02vjvbA;
        "default" = _M02vjvbA;
    });
