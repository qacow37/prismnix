...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18.2" = _GdLlrfT6;
        "pkg-1.1.0+1.18.2" = _RUTXv3Ng;
        "pkg-1.2.0+1.18.2" = _IO7jyRHY;
        "pkg-1.3.0+1.18.2" = _zMNi9YZm;
        "pkg-1.3.1+1.18" = _bIFfnvOO;
        "pkg-1.3.1+1.19" = _rwWdbkfd;
        "pkg-1.4.0+1.18" = _iXTBKHW8;
        "pkg-1.4.0+1.19" = _2IjvmTP6;
        "pkg-1.4.0+1.19.3" = _7Var474n;
        "pkg-1.5.0+1.18" = _KdLqQEaX;
        "pkg-1.5.0+1.19" = _4J6odEjj;
        "pkg-1.5.0+1.19.3" = _qt4PP4S9;
        "pkg-1.5.1+1.18" = _iOcD8otz;
        "pkg-1.5.1+1.19" = _po6fHme2;
        "pkg-1.5.1+1.19.3" = _CWLe96pW;
        "pkg-1.5.2+1.18" = _YeqdGa0f;
        "pkg-1.5.2+1.19" = _wCxeiSMh;
        "pkg-1.5.2+1.19.3" = _JbSo6YU5;
        "pkg-1.6.0+1.18" = _aiDcl4DI;
        "pkg-1.6.0+1.19" = _3H2EXl90;
        "pkg-1.6.0+1.19.3" = _JprgOGxu;
        "pkg-1.6.0+1.20.2" = _PAWjehV5;
        "pkg-1.6.1+1.18" = _pgde412L;
        "pkg-1.6.1+1.19" = _GvGPEfd4;
        "pkg-1.6.1+1.19.3" = _DmFpqShw;
        "pkg-1.6.1+1.20.2" = _yDqACmzm;
        "pkg-1.6.2+1.20.2" = _lPw7189i;
        "pkg-1.6.3+1.19.3" = _GKQI2QfV;
        "pkg-1.7.0+1.15" = _7ze4uKb5;
        "pkg-1.7.0+1.16" = _zsRVDTSi;
        "pkg-1.7.0+1.18" = _Gn9H5MAr;
        "pkg-1.7.0+1.19" = _8dJzsOA1;
        "pkg-1.7.0+1.20" = _FjEO5apf;
        "pkg-1.7.0+1.21" = _nzAvFgxn;
        "pkg-1.7.1+1.15" = _z2mszVjA;
        "pkg-1.7.1+1.16" = _Sk5gHw67;
        "pkg-1.7.1+1.18" = _gSalYKCN;
        "pkg-1.7.1+1.19" = _juTOKq5W;
        "pkg-1.7.1+1.20" = _GZyYJFRF;
        "pkg-1.7.1+1.21" = _TdOExBgH;
        "pkg-1.7.2+1.21" = _i9iEM1sT;
        "pkg-1.7.2+26.1" = _MXHJghdb;
        "default" = _MXHJghdb;
    });
