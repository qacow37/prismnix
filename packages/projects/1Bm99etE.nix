...
let
    ...
    in {
        ...
        "pkg-1.2" = _OROrYRae;
        "pkg-2.0.0" = _3LhL7e0n;
        "pkg-mc1.21-3.0.0-1-fabric" = _W6Yxyvdw;
        "pkg-mc1.21-3.0.0-1-neoforge" = _M2NHaMkL;
        "pkg-mc1.21-3.0.0-2-fabric" = _dumJYoZU;
        "pkg-mc1.21-3.0.0-2-neoforge" = _J5oQoHKK;
        "pkg-mc1.21-3.0.0-3-fabric" = _OKpyp4yw;
        "pkg-mc1.21-3.0.0-3-neoforge" = _B9SWzKdG;
        "pkg-mc1.21-3.0.0-4-fabric" = _ZUSM6yvP;
        "pkg-mc1.21-3.0.0-4-neoforge" = _gT5iIGCK;
        "pkg-mc1.21-3.0.0-5-fabric" = _QZJF9wjn;
        "pkg-mc1.21-3.0.0-5-neoforge" = _e6w34k3H;
        "pkg-mc1.21-3.0.0-6-fabric" = _uFdKOTFn;
        "pkg-mc1.21-3.0.0-6-neoforge" = _TcQftvHB;
        "pkg-mc1.21-3.0.0-7-neoforge" = _edCVMH3M;
        "pkg-mc1.21-3.0.0-7-fabric" = _70D9BuyF;
        "pkg-mc1.21-3.0.0-8-fabric" = _REvq9jCk;
        "pkg-mc1.21-3.0.0-8-neoforge" = _QFgThjwK;
        "pkg-mc1.21-3.0.0-9-fabric" = _9H7cluEo;
        "pkg-mc1.21-3.0.0-9-neoforge" = _ai5vrLrE;
        "pkg-mc1.21-3.0.0-10-fabric" = _sNNLuPLU;
        "pkg-mc1.21-3.0.0-10-neoforge" = _eDIgc6zF;
        "pkg-mc1.21-3.0.0-11-fabric" = _FnBpxT2c;
        "pkg-mc1.21-3.0.0-11-neoforge" = _G5E3ZtEJ;
        "pkg-mc1.21-3.0.0-12-fabric" = _kBho2h6U;
        "pkg-mc1.21-3.0.0-12-neoforge" = _l7BWfAiS;
        "pkg-mc1.21-3.0.0-13-fabric" = _jO0ElXx9;
        "pkg-mc1.21-3.0.0-13-neoforge" = _vQsMRQiT;
        "pkg-mc1.21-3.0.0-14-fabric" = _Wqh2VSHt;
        "pkg-mc1.21-3.0.0-14-neoforge" = _WMMFpLku;
        "pkg-mc1.21-3.0.0-fabric" = _KYKev29Y;
        "pkg-mc1.21-3.0.0-neoforge" = _duNFjakK;
        "pkg-mc1.21-3.0.1-fabric" = _1WToD5cM;
        "pkg-mc1.21-3.0.1-neoforge" = _gUYA2lyC;
        "pkg-mc1.21-3.0.2-fabric" = _LBrSPtX9;
        "pkg-mc1.21-3.0.2-neoforge" = _IgcW2QyM;
        "pkg-mc1.21-3.0.3-fabric" = _uPioSRgB;
        "pkg-mc1.21-3.0.3-neoforge" = _sO6EXikD;
        "pkg-mc1.21-3.0.4-fabric" = _TPD7q3lI;
        "pkg-mc1.21-3.0.4-neoforge" = _KMrQf2fB;
        "pkg-3.0.5-fabric" = _wO94WqHp;
        "pkg-3.0.5-neoforge" = _Av0PfaFY;
        "pkg-3.0.6-fabric" = _cWqbqoOP;
        "pkg-3.0.6-neoforge" = _vxGSSdSX;
        "pkg-3.0.7-fabric" = _JS6OgNtC;
        "pkg-3.0.7-neoforge" = _QEW8n1Z4;
        "pkg-3.0.8-fabric" = _wkAbibeh;
        "pkg-3.0.8-neoforge" = _zZz6Ch93;
        "pkg-3.0.9-fabric" = _oPExy90l;
        "pkg-3.0.9-neoforge" = _H6xxWuZu;
        "pkg-3.0.10-neoforge" = _3LTzfNHe;
        "pkg-3.0.10-fabric" = _Bq9ihzW2;
        "pkg-3.0.11-fabric" = _E9bG5RDW;
        "pkg-3.0.11-neoforge" = _2Db2bqsX;
        "pkg-3.1.0-fabric" = _iYWAVEev;
        "pkg-3.1.0-neoforge" = _mGzvUYfu;
        "pkg-3.1.1-fabric" = _AK7Pu9g3;
        "pkg-3.1.1-neoforge" = _6LEfiWOh;
        "pkg-3.1.2-fabric" = _eKR5wPHE;
        "pkg-3.1.2-neoforge" = _ogTXMP3g;
        "pkg-4.0.0-fabric" = _P0Fk8jpm;
        "pkg-4.0.0-neoforge" = _rn6mWLAj;
        "pkg-4.0.1-fabric" = _RKu03MSt;
        "pkg-4.0.1-neoforge" = _gZ6HcXQI;
        "pkg-4.0.2-fabric" = _uvMel1PA;
        "pkg-4.0.2-neoforge" = _lE4v9dyE;
        "pkg-4.0.3-fabric" = _TdHV8pyR;
        "pkg-4.0.3-neoforge" = _k8YLSZjF;
        "pkg-4.0.4-fabric" = _n1ZlJLbn;
        "pkg-4.0.4-neoforge" = _HWk9XExf;
        "pkg-4.0.5-fabric" = _VdjPPBuZ;
        "pkg-4.0.5-neoforge" = _ktgxizYI;
        "pkg-4.0.6-fabric" = _wkxfKbxl;
        "pkg-4.0.6-neoforge" = _Wx9wbuAa;
        "pkg-4.0.7-fabric" = _kjEGd5ty;
        "pkg-4.0.7-neoforge" = _szZW3pjK;
        "pkg-4.0.8-fabric" = _Cb7DKKKo;
        "pkg-4.0.8-neoforge" = _lKv6OqZy;
        "pkg-4.1.0-fabric" = _opjjfg5f;
        "pkg-4.1.0-neoforge" = _WOCNKSBT;
        "pkg-4.1.1-fabric" = _gjzB9jGN;
        "pkg-4.1.1-neoforge" = _2SHReuZC;
        "pkg-4.1.2-neoforge" = _EBks807H;
        "pkg-4.1.2-fabric" = _paDhnMjo;
        "pkg-4.1.3-fabric" = _ynZ4uNpD;
        "pkg-4.1.3-neoforge" = _CwunLjT3;
        "pkg-4.1.4-neoforge" = _J6YlEiNi;
        "pkg-4.1.4-fabric" = _aeOppxrm;
        "pkg-4.2.0-fabric" = _VIEi3SSf;
        "pkg-4.2.0-neoforge" = _9DYrJ7kn;
        "pkg-4.2.1-neoforge" = _QjXjTVGX;
        "pkg-4.2.1-fabric" = _AIN3Ycwj;
        "pkg-4.2.2-neoforge" = _85ZgbRzH;
        "pkg-4.2.2-fabric" = _5wLDyS7i;
        "pkg-4.2.3-fabric" = _bqRAj9e9;
        "pkg-4.2.3-neoforge" = _jKZjvrj8;
        "pkg-4.2.4-fabric" = _EMX6rF8u;
        "pkg-4.2.4-neoforge" = _Jr9YLJNV;
        "pkg-4.2.5-neoforge" = _SfSIo3c0;
        "pkg-4.2.5-fabric" = _FFcIUKyE;
        "pkg-4.2.6-fabric" = _Oy7LdyBo;
        "pkg-4.2.6-neoforge" = _Fw7FtHkr;
        "pkg-4.2.7-fabric" = _67ds1g3h;
        "pkg-4.2.7-neoforge" = _S04t88HS;
        "pkg-4.2.8-fabric" = _TzeodQFB;
        "pkg-4.2.8-neoforge" = _HVuS6Y0q;
        "pkg-4.2.9-fabric" = _gGswMhJP;
        "pkg-4.2.9-neoforge" = _rMgDsmQk;
        "pkg-4.2.10-neoforge" = _ONPcLtJZ;
        "pkg-4.2.10-fabric" = _kEjkA34I;
        "pkg-4.2.11-neoforge" = _b3XG8EI6;
        "pkg-4.2.11-fabric" = _PNIKw1r4;
        "pkg-4.2.12-neoforge" = _DGrAp8Gt;
        "pkg-4.2.12-fabric" = _s1NoOQFH;
        "pkg-mc1.21-4.3.0.0-fabric" = _3ielXFT3;
        "pkg-mc1.21-4.3.0.0-neoforge" = _XW5pV1BT;
        "pkg-mc1.21-4.3.1.0-fabric" = _zFZNYcAM;
        "pkg-mc1.21-4.3.1.0-neoforge" = _cLcqKwMw;
        "pkg-mc1.21-4.3.2.0-fabric" = _hqXULyHs;
        "pkg-mc1.21-4.3.2.0-neoforge" = _OcrPJeMe;
        "pkg-mc1.21-4.3.3.0-fabric" = _AYU9TB6o;
        "pkg-mc1.21-4.3.3.0-neoforge" = _PJzp7BQe;
        "pkg-mc1.21-4.3.4.0-fabric" = _opaJVB8B;
        "pkg-mc1.21-4.3.4.0-neoforge" = _KYWvtcVf;
        "pkg-mc1.21-4.3.5.0-fabric" = _tnkxbN4I;
        "pkg-mc1.21-4.3.5.0-neoforge" = _jL2OoqPi;
        "pkg-mc1.21-4.3.6.0-fabric" = _FP59IDn9;
        "pkg-mc1.21-4.3.6.0-neoforge" = _q0koGKwU;
        "pkg-mc1.21-4.3.7.0-fabric" = _2eLg9k1q;
        "pkg-mc1.21-4.3.7.0-neoforge" = _fqrRQYlM;
        "pkg-mc1.21-4.3.8.0-fabric" = _OvGP5tn3;
        "pkg-mc1.21-4.3.8.0-neoforge" = _UP29vmrE;
        "default" = _UP29vmrE;
    });
