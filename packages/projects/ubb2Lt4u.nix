...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0-fabric+forge+neo" = _95i83qT6;
        "pkg-1.19.2-1.1-fabric+forge+neo" = _i7zcOvfQ;
        "pkg-1.20.1-1.1-fabric+forge+neo" = _d9frKLgS;
        "pkg-1.20.2-1.1-fabric+forge+neo" = _BKstTsVo;
        "pkg-1.20.4-1.1-fabric+forge+neo" = _XWd3SIbW;
        "pkg-1.19.2-1.2-fabric+forge" = _ViKEo79k;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _lO8fO2n5;
        "pkg-1.20.2-1.2-fabric+forge+neo" = _I6qr2xQZ;
        "pkg-1.20.4-1.2-fabric+forge+neo" = _yTki4aby;
        "pkg-1.20.5-1.2-fabric+neo" = _KTJGfnVf;
        "pkg-1.20.6-1.2-fabric+forge+neo" = _JLjV600s;
        "pkg-1.21.0-1.2-fabric+forge+neo" = _3xzDm7lV;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _8VzChrQC;
        "pkg-1.20.6-1.3-fabric+forge+neo" = _HIvRCQsH;
        "pkg-1.21.0-1.3-fabric+forge+neo" = _fMAWTpyx;
        "pkg-1.21.1-1.3-fabric+forge+neo" = _pMjEjjcU;
        "pkg-1.21.2-1.3-fabric+neo" = _RBvttyS6;
        "pkg-1.21.3-1.3-fabric+forge+neo" = _gVPlE0QS;
        "pkg-1.21.4-1.3-fabric+forge+neo" = _JRO1AzWV;
        "pkg-1.21.5-1.3-fabric+forge+neo" = _anvLpNRE;
        "pkg-1.21.6-1.3-fabric+forge+neo" = _IaD0akY3;
        "pkg-1.21.7-1.3-fabric+forge+neo" = _iK8bqG1K;
        "pkg-1.21.8-1.3-fabric+forge+neo" = _Fn8oGok0;
        "pkg-1.21.9-1.3-fabric+forge+neo" = _MNK7HQJ2;
        "pkg-1.21.10-1.3-fabric+forge+neo" = _40hRdYF3;
        "pkg-1.21.11-1.3-fabric+forge+neo" = _GDXIlb6P;
        "pkg-26.1.0-1.3-fabric+forge+neo" = _tDalQ8Aa;
