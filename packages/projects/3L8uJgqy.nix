...
let
    ...
    in {
        ...
        "pkg-1.2.0+1.20.6" = _K9xzEoEe;
        "pkg-1.2.0+1.20.1" = _OSHj5qem;
        "pkg-1.2.1+1.20.6" = _ChK1cN1o;
        "pkg-1.2.1+1.21" = _HY1utQe6;
        "pkg-1.2.1+1.20.1" = _x8dvXbCD;
        "pkg-1.2.2+1.21" = _fnBKtRCD;
        "pkg-1.2.2+1.20.6" = _bHUSuQ9x;
        "pkg-1.2.3+1.21" = _OScN3rXb;
        "pkg-1.2.3+1.21.2-rc2" = _5fKPUVel;
        "pkg-1.2.3+1.21.4" = _C2dh6sZR;
        "pkg-1.2.3+1.21.5-rc1" = _zFDRhIfd;
        "pkg-1.2.3+1.21.6-rc1" = _MSge7b2H;
        "pkg-1.3.0+1.21.1" = _P1vjzIjA;
        "pkg-1.3.0+1.21.5" = _etruc4yn;
        "pkg-1.3.0+1.21.8" = _T0TFGdMT;
        "pkg-1.3.0+1.21.9" = _eMVQNPl2;
        "pkg-1.3.0+1.21.11-rc2" = _ZV1qOyrw;
        "pkg-1.3.1+1.21.11" = _K1zDl2hV;
        "pkg-1.3.1+26.1" = _e2j6H7Zo;
        "pkg-1.3.1+26.2" = _QidIjvHn;
        "pkg-1.3.2+1.21.1" = _AiwfYkN5;
        "pkg-1.3.2+1.21.10" = _y16yFPgc;
        "pkg-1.3.2+1.21.11" = _DTURa658;
        "pkg-1.3.2+1.21.5" = _taDob1Fo;
