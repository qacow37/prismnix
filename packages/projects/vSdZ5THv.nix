...
let
    ...
    in {
        ...
        "pkg-1.0.3+1.20.4" = _9AaOzsWN;
        "pkg-1.0.3+1.20.6" = _uRRUY5hS;
        "pkg-1.0.3+1.21" = _dZgS84Xp;
        "pkg-1.0.3+1.20.1" = _HFQaFXSa;
        "pkg-1.0.4+1.21" = _LPrmEnPc;
        "pkg-1.0.4+1.21.2-rc1" = _GTTydQEC;
        "pkg-1.0.4+1.21.2" = _XQ3Bv2Wi;
        "pkg-1.0.4+1.21.4" = _o6fA7uei;
        "pkg-2.0.0-beta.1+1.21.5" = _yOYxklNO;
        "pkg-2.0.0-beta.2+1.21.5" = _4W8Zs4pk;
        "pkg-2.0.0+1.21.5" = _TCW5Rkkb;
        "pkg-2.0.1+1.21.5" = _NoJtHcrW;
        "pkg-2.0.2+1.21.5" = _rDJxY1zu;
        "pkg-2.0.3+1.21.5" = _jeeCQceV;
        "pkg-2.0.4+1.21.5" = _gW3n04ws;
        "pkg-2.1.0+1.21.5" = _BEOtJVMl;
        "pkg-2.1.1+1.21.5" = _lRWoRFvS;
        "pkg-2.1.2+1.21.5" = _6ZBMGbXR;
        "pkg-2.1.3+1.21.5" = _tIqr323C;
        "pkg-2.1.3+1.21.6" = _B251Ripz;
        "pkg-2.1.4+1.21.6" = _8bXNWZPi;
        "pkg-2.1.5+1.21.6" = _34ET3FVJ;
        "pkg-2.1.6+1.21.6" = _8B6ryU1G;
        "pkg-2.1.7+1.21.6" = _YPiykBUS;
        "pkg-2.2.0+1.21.6" = _tjKca5fz;
        "pkg-2.2.1+1.21.6" = _FTkA0mVn;
        "pkg-2.2.2+1.21.6" = _L77O7iOx;
        "pkg-2.2.3+1.21.7" = _6LFrhUCs;
        "pkg-2.2.4+1.21.7" = _irurFX5W;
        "pkg-2.2.5+1.21.7" = _XeyMMaEK;
        "pkg-2.2.6+1.21.7" = _pWwZ8qAr;
        "pkg-2.2.7+1.21.7" = _w8pNXoRq;
        "pkg-2.2.8+1.21.7" = _IGf3cyP2;
        "pkg-2.2.9+1.21.7" = _x38AFQzm;
        "pkg-2.2.10+1.21.9-rc1" = _fM17l2R9;
        "pkg-2.2.11+1.21.9-rc1" = _HKDsxl9w;
        "pkg-2.2.12+1.21.9" = _u4LAxQEd;
        "pkg-2.2.13+1.21.7" = _T0Th5d1y;
        "pkg-2.2.13+1.21.9" = _T0R3qOCx;
        "pkg-2.2.15+1.21.9" = _3cpNBPXF;
        "pkg-2.3.0+1.21.11" = _Zw7JLzk1;
        "pkg-2.3.1+1.21.11" = _u0lujeYT;
        "pkg-2.2.15-patch1+1.21.9" = _tbOT1kvU;
        "pkg-2.5.1+26.1" = _91BsRY4p;
        "pkg-2.5.2+26.1" = _cRSjKh6G;
        "pkg-2.5.3+26.1" = _Q8lv7yOO;
