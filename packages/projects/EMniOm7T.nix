...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.21.1" = _VKFT3eSn;
        "pkg-0.1.1+1.21.1" = _hQTw1enh;
        "pkg-0.1.2+1.21.1" = _MhOleWAo;
        "pkg-0.2.0+1.21.1" = _3PvZRQBc;
        "pkg-0.3.0+1.21.1" = _qfZ9zPqK;
        "pkg-0.4.0+1.21.1" = _yDo8tR4M;
        "pkg-0.4.1+1.21.1" = _wNLjOjuJ;
        "pkg-0.5.0+1.21.1" = _bNGKujpv;
        "pkg-0.5.1+1.21.1" = _NQ4QuvZn;
        "pkg-0.5.2+1.21.1" = _Zg59I8Lk;
        "pkg-0.5.3+1.21.1" = _PFZS8ckr;
        "pkg-0.5.4+1.21.1" = _b4nRyadE;
        "pkg-0.6.0+1.21.1" = _NfeWmrSP;
        "pkg-0.6.1+1.21.1" = _yywdBtNz;
        "pkg-0.7.0+1.21.1" = _1ySVcFBG;
        "pkg-0.7.1+1.21.1" = _HtTDA0Tj;
        "pkg-0.7.2+1.21.1" = _fivis3Ou;
        "pkg-0.7.3+1.21.1" = _y8LS8FIr;
        "pkg-0.8.0+1.21.1" = _Bd4Xwbar;
        "pkg-0.8.1+1.21.1" = _jLEXBPGj;
        "pkg-0.8.2+1.21.1" = _ED8W3ftX;
        "pkg-0.8.3+1.21.1" = _N0qrjGCR;
        "pkg-0.8.4+1.21.1" = _74cN8nGq;
        "pkg-0.8.5+1.21.1" = _95bBXJVg;
        "default" = _95bBXJVg;
    });
