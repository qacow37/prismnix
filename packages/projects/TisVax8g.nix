...
let
    ...
    in {
        ...
        "pkg-1.0.7" = _oOTeQOsp;
        "pkg-1.0.9" = _T1OAEUvm;
        "pkg-1.0.10" = _mGpxuWd0;
        "pkg-1.0.11" = _42kOYjgS;
        "pkg-1.0.12" = _7Fr1FS0x;
        "pkg-1.0.13" = _8P26tGNC;
        "pkg-1.0.14" = _uqlWyZKS;
        "pkg-1.0.15" = _NZ6yrVXw;
        "pkg-1.0.17" = _mTt2jNXP;
        "pkg-1.0.18" = _jtmMZ2tH;
        "default" = _jtmMZ2tH;
    });
