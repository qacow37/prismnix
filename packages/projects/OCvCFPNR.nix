...
let
    ...
    in {
        ...
        "pkg-1.17-v1.0.0" = _7SSfVNSC;
        "pkg-1.16.2-v1.0.0" = _9jB84ybt;
        "pkg-1.16-v1.0.0" = _DacX9iYr;
        "pkg-1.15-v1.0.0" = _9DLXoCYq;
        "pkg-1.14-v1.0.0" = _fteGsuFy;
        "pkg- 1.14-v1.0.1" = _dndsU3rL;
        "pkg-1.15-v1.0.1" = _oucqakXb;
        "pkg-1.16-v1.0.1" = _vWTDry8G;
        "pkg-1.16.2-v1.0.1" = _Uhn7iZob;
        "pkg-1.17-v1.0.1" = _tQ8vQTKE;
        "pkg-1.14-v1.1.0" = _Kr2iznPu;
        "pkg-1.15-v1.1.0" = _jgZCR2oQ;
        "pkg-1.16-v1.1.0" = _y3gK94ho;
        "pkg-1.16.2-v1.1.0" = _LESsk83p;
        "pkg-1.17-v1.1.0" = _DnfeM9U5;
        "pkg-1.14-v1.2.0" = _ASqdNs5M;
        "pkg-1.15-v1.2.0" = _dbkYLbip;
        "pkg-1.16-v1.2.0" = _3huWyYIC;
        "pkg-1.16.2-v1.2.0" = _mkfuFQe8;
        "pkg-1.17-v1.2.0" = _d0ixixKQ;
        "pkg-1.14-v2.0.0" = _ZdoLoomz;
        "pkg-1.15-v2.0.0" = _gc7D6clD;
        "pkg-1.16-v2.0.0" = _DFGXloFR;
        "pkg-1.16.2-v2.0.0" = _2iJfdCgY;
        "pkg-1.17-v2.0.0" = _FZPOD514;
        "pkg-1.14-v2.0.1" = _juik9S3u;
        "pkg-1.15-v2.0.1" = _KRJQzelt;
        "pkg-1.16-v2.0.1" = _U4QijIWl;
        "pkg-1.16.2-v2.0.1" = _sAVnqf0V;
        "pkg-1.17-v2.0.1" = _BGigi4in;
        "pkg-1.18-v2.0.1" = _jtEOcbwc;
        "pkg-1.18.2-v2.0.1" = _d1GlSCTc;
        "pkg-1.19-v2.0.1" = _G4CsLW4Q;
        "pkg-1.19-v2.0.2" = _eH0chh3r;
        "pkg-1.19-v2.0.2-1.19.1" = _5DZWes05;
        "pkg-1.19-v2.0.3" = _UCsYJYru;
        "pkg-1.19.1-v2.0.3" = _4nesitR6;
        "pkg-1.19.1-v2.0.3-1.19.2" = _XKA8F4A4;
        "pkg-1.19.1-v2.1.0" = _Xjgclc71;
        "pkg-1.19.1-v2.2.0" = _ANLbU0V6;
        "pkg-1.19.3-v2.2.1" = _j7RQJuCI;
        "pkg-1.19.4-1.19.4-v2.2.1" = _mqDB7gHo;
        "pkg-1.19.4-1.19.4-v2.2.2" = _gTrNBU0E;
        "pkg-1.20-1.20.1-v2.2.3" = _TvEi8wC6;
        "pkg-1.20.2-1.20.2-v2.2.3" = _8ZY9sQ8j;
        "pkg-1.20.2-1.20.2-v2.3.0" = _fQ230WeD;
        "pkg-1.20.3-1.20.4-v2.3.0" = _3K4y1jGg;
        "pkg-1.20-1.20.1-v2.3.0" = _4WGrth4u;
        "pkg-1.20-1.20.1-v2.3.1" = _ANxhu2rL;
        "pkg-1.20.2-1.20.2-v2.3.1" = _7QN3fFIT;
        "pkg-1.20.3-1.20.4-v2.3.1" = _CHKM0vWU;
        "pkg-1.20.5-1.20.5-v2.3.1" = _6uVygWTq;
        "pkg-1.20.5-1.20.6-v2.3.1" = _Dlty2XG9;
        "pkg-1.21-1.21-v2.3.1" = _KOWb4zcf;
        "pkg-1.21-1.21.1-v2.3.1" = _kO2Mnl5U;
        "pkg-1.21-1.21.1-v2.3.2" = _asKMD5Pp;
        "pkg-1.21.2-1.21.3-v2.3.2" = _b3mmroJr;
        "pkg-1.21.4-1.21.4-v2.3.2" = _PWPfd0A3;
        "pkg-1.21.5-1.21.5-v2.3.2" = _R8N8zDll;
        "pkg-1.21.6-1.21.6-v2.3.2" = _GpnsRHcI;
        "pkg-1.21.6-1.21.7-v2.3.2" = _1AONqV9X;
        "pkg-1.21.6-1.21.8-v2.3.2" = _WSX7n29s;
        "default" = _WSX7n29s;
    });
