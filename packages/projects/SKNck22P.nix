...
let
    ...
    in {
        ...
        "pkg-3.0.0-beta.1" = _B6LyjucQ;
        "pkg-1.0.0-beta.2" = _GP45cZOE;
        "pkg-2.0.0-beta.2" = _nw03scKg;
        "pkg-3.0.0-beta.2" = _Kd7cKEqt;
        "pkg-4.0.0-beta.4" = _TzdIZOrq;
        "pkg-1.0.0" = _3644qtlJ;
        "pkg-2.0.0" = _9fTVxmYV;
        "pkg-3.0.0" = _tuGW3SnK;
        "pkg-4.0.0" = _PkS1hTzb;
        ...
        "pkg-3.0.1" = _hkiYdc2G;
        "pkg-3.1.1" = _DF8mIJHA;
        "pkg-4.0.1-forge" = _3YRkIpp4;
        "pkg-4.0.1-neoforge" = _yHXpmquD;
        "pkg-3.2.0" = _BBEbkYWH;
        "pkg-5.0.0-forge" = _VbrURdT2;
        "pkg-5.0.0-neoforge" = _fAzxh51h;
        "pkg-6.0.0-forge" = _dx3PK4an;
        "pkg-6.0.0-neoforge" = _6szXBRsd;
        "pkg-1.1.0-beta.1" = _glcW4fjs;
        "pkg-1.1.0" = _D28xP7Rg;
        "pkg-2.1.0" = _UyU6cEF3;
        "pkg-3.0.2" = _5udctoeO;
        "pkg-3.1.2" = _IuB02G6U;
        "pkg-3.2.2" = _Eqznql0N;
        "pkg-4.1.0-forge" = _teYFpv8o;
        "pkg-5.1.0-forge" = _DKDh9uRj;
        "pkg-6.1.0-forge" = _N3vhTMED;
        "pkg-4.1.0-neoforge" = _nt5HVcWt;
        "pkg-5.1.0-neoforge" = _leRgbPPS;
        "pkg-6.1.0-neoforge" = _dCbX210J;
        "pkg-7.0.0-forge" = _wIhYq4Cf;
        "pkg-7.0.0-neoforge" = _GbugB7w1;
        "pkg-8.0.0-neoforge" = _uJKY7mhP;
        "pkg-8.0.0-forge" = _LdCiwr7p;
        "pkg-9.0.0-forge" = _Mr8OI6HE;
        "pkg-9.0.0-neoforge" = _j0vwE93A;
        "pkg-10.0.0-neoforge" = _hZWpFWmO;
        "pkg-10.0.0-forge" = _G0BxmeBP;
        "pkg-11.0.0-neoforge" = _g0gi0eJS;
        "pkg-11.0.0-forge" = _8bdtVB7q;
        "pkg-12.0.0-neoforge" = _UazPOci6;
        "pkg-12.0.0-forge" = _GraVo2K6;
        "pkg-12.1.0-neoforge" = _pX34MdM3;
        "pkg-12.1.0-forge" = _TfWfMu8t;
        "pkg-13.0.0-neoforge" = _LqjVKoLB;
        "pkg-13.0.0-forge" = _aZvFDbZ3;
        "pkg-13.1.0-neoforge" = _gJIZFCvD;
