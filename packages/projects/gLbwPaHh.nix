...
let
    ...
    in {
        ...
        "pkg-1.1" = _A75JIOGS;
        "pkg-1.2" = _mW1t3Gg7;
        "pkg-1.3_Green" = _zDFZeOta;
        "pkg-1.3_Gold" = _E479giEa;
        "pkg-1.3_Red" = _2Gs7Kyqd;
        "pkg-1.3_Purple" = _1tSLUiPR;
        "pkg-1.3" = _MXUeyGy8;
        "pkg-1.4_Green" = _hyDGpYBM;
        "pkg-1.4_Gold" = _qaUUbIGJ;
        "pkg-1.4_Red" = _bO4tzfSm;
        "pkg-1.4_Purple" = _HZgeAUIo;
        "pkg-1.4" = _oFEL9yA3;
        "pkg-1.4.1_Green" = _3ZZhuMGc;
        "pkg-1.4.1_Gold" = _IU37U1Tc;
        "pkg-1.4.1_Red" = _N0SBTAi2;
        "pkg-1.4.1_Purple" = _MPPomfyi;
        "pkg-1.4.1" = _uadYFHq3;
        "pkg-2.0" = _YWw6ei3J;
        "pkg-2.1" = _Gm2qadBw;
        "pkg-2.2" = _JEFwCaan;
