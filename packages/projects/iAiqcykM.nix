...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.19.4-forge" = _Q1byKePB;
        "pkg-1.0.2-1.16.5-forge" = _WSOuEyWT;
        "pkg-1.0.2-1.18.2-forge" = _MSieP4h1;
        "pkg-1.0.2-1.19.4-forge" = _kUbvKIxI;
        "pkg-1.0.2-1.20.1-forge" = _k3lm0FzI;
        "pkg-1.0.2-1-1.18.2-forge" = _Yd9leUAD;
        "pkg-1.0.2-2-1.16.5-forge" = _AjsXN2Tc;
        "pkg-1.0.2-1.20.2-forge" = _mLF7LVql;
        "pkg-2.0.0-1.18.2-fabric" = _WKWbIwCj;
        "pkg-2.0.0-1.18.2-forge" = _ETWomcWN;
        "pkg-2.0.0-1.19.2-fabric" = _KqtVgDAG;
        "pkg-2.0.0-1.19.2-forge" = _zG58HClB;
        "pkg-2.0.0-1.20.1-fabric" = _6ZxP81cv;
        "pkg-2.0.0-1.20.1-forge" = _YGC6k663;
        "pkg-2.0.0-1.20.4-fabric" = _6UvORl8B;
        "pkg-2.0.0-1.20.4-forge" = _hrQjDK0a;
        "pkg-2.0.0-1.20.4-neoforge" = _liVit4JB;
        "pkg-2.0.0-1.20.6-fabric" = _6ct1yDQk;
        "pkg-2.0.0-1.20.6-forge" = _g66gcbho;
        "pkg-2.0.0-1.20.6-neoforge" = _jR7JwHkd;
        "pkg-2.0.0-1.21-1.21.1-fabric" = _120aJYdJ;
        "pkg-2.0.0-1.21-1.21.1-forge" = _e1H8qgGa;
        "pkg-2.0.0-1.21-1.21.1-neoforge" = _L0TEgHcN;
        "pkg-2.0.1-1.21.4-fabric" = _4MoXDIfk;
        "pkg-2.0.1-1.21.4-forge" = _o5IXD40t;
        "pkg-2.0.1-1.21.4-neoforge" = _Lex2FOyB;
        "pkg-2.1.0-1.18.2-fabric" = _QR3pjSlD;
        "pkg-2.1.0-1.18.2-forge" = _8C8U9nB7;
        "pkg-2.1.0-1.19.2-fabric" = _yJex05am;
        "pkg-2.1.0-1.19.2-forge" = _NCqfGfEI;
        "pkg-2.1.0-1.20.1-fabric" = _9RoWFL8K;
        "pkg-2.1.0-1.20.1-forge" = _FlKcDYwF;
        "pkg-2.1.0-1.21.1-fabric" = _jCSPF9Ft;
        "pkg-2.1.0-1.21.1-forge" = _6zdm5027;
        "pkg-2.1.0-1.21.1-neoforge" = _mnCUZfmm;
        "pkg-2.1.0-1.21.4-fabric" = _XuLKI2zZ;
        "pkg-2.1.0-1.21.4-forge" = _pwSy16cR;
        "pkg-2.1.0-1.21.4-neoforge" = _Bd0CByrt;
        "pkg-2.1.1-1.20.1-forge" = _HrSzoCLd;
        "pkg-2.1.1-1.19.2-forge" = _fOIN0T7u;
        "pkg-2.1.1-1.18.2-forge" = _xapPEJpn;
        "pkg-2.1.0-1.21.5-fabric" = _HZHRCuLM;
        "pkg-2.1.0-1.21.5-forge" = _4UklIasF;
        "pkg-2.1.0-1.21.5-neoforge" = _fUdMKH9y;
        "pkg-2.1.1-1.21.6-fabric" = _N5YpomrV;
        "pkg-2.1.1-1.21.6-forge" = _VoGDgD2n;
        "pkg-2.1.1-1.21.6-neoforge" = _jp7WvtTT;
        "pkg-2.1.2-1.21.10-fabric" = _qW7H4rz2;
        "pkg-2.1.2-1.21.10-neoforge" = _ySsC0IDQ;
        "pkg-2.1.3-1.21.11-fabric" = _UWbTsh1X;
        "pkg-2.1.3-1.21.11-neoforge" = _ptpMWBAQ;
        "pkg-2.1.4-26.1.1-fabric" = _F48OIHCN;
