...
let
    ...
    in {
        ...
        "pkg-1.2.6" = _q4kZgUJ0;
        "pkg-1.3.0" = _YvsVgtJ2;
        "pkg-2.0.0-beta.1" = _7lTmIUht;
        "pkg-2.0.0-beta.2" = _urHANUlF;
        "pkg-2.0.0-beta.3" = _WQA5VnUe;
        "pkg-2.0.0-beta.4" = _8FZtemi0;
        "pkg-2.0.0-beta.5" = _7wPr8hZu;
        "pkg-2.0.0-beta.6+1.20.6" = _lqxsuFdN;
        "pkg-2.0.0-beta.6+1.20.1" = _c5XrC7um;
        "pkg-2.0.0-beta.6+1.18.2" = _yga9Qdt4;
        "pkg-2.0.0-beta.7+1.20.6" = _WNFfMYlL;
        "pkg-2.0.0-beta.7+1.20.1" = _5oomV8Xe;
        "pkg-2.0.0-beta.7+1.19.4" = _KjoOQWXx;
        "pkg-2.0.0-beta.7+1.19.2" = _RDIW1vEr;
        "pkg-2.0.0-beta.7+1.18.2" = _Rgw87vtu;
        "pkg-2.0.0-beta.8+1.20.6" = _ZnozYXy0;
        "pkg-2.0.0-beta.8+1.20.1" = _eJ0cfUYZ;
        "pkg-2.0.0-beta.8+1.19.4" = _SOynRYj3;
        "pkg-2.0.0-beta.8+1.19.2" = _zub9vqIu;
        "pkg-2.0.0-beta.8+1.18.2" = _obFkianv;
        "pkg-2.0.0-beta.9+1.20.6" = _FeUBkub6;
        "pkg-2.0.0-beta.9+1.20.1" = _HAY2a4EI;
        "pkg-2.0.0-beta.9+1.19.4" = _YGUJof15;
        "pkg-2.0.0-beta.9+1.19.2" = _DromPhtS;
        "pkg-2.0.0-beta.9+1.18.2" = _vLvFOyhZ;
        "pkg-2.0.0-beta.10+1.20.6" = _9WB5CFtn;
        "pkg-2.0.0-beta.10+1.20.1" = _CzQWOO6H;
        "pkg-2.0.0-beta.10+1.19.4" = _wQnrezRp;
        "pkg-2.0.0-beta.10+1.19.2" = _cGwAoULz;
        "pkg-2.0.0-beta.10+1.18.2" = _9qiHa4tW;
        "pkg-2.1.0-neoforge+1.21" = _DgrfPLB9;
        "pkg-2.1.0-fabric+1.21" = _QwAghAXk;
        "pkg-2.1.0-forge+1.21" = _8R0ApLFn;
        "pkg-2.1.0-neoforge+1.20.6" = _hccpN17X;
        "pkg-2.1.0-forge+1.20.6" = _tTzfQXEY;
        "pkg-2.1.0-fabric+1.20.1" = _9BTsibnM;
        "pkg-2.1.0-fabric+1.20.6" = _e4XyJNad;
        "pkg-2.1.0-forge+1.20.1" = _fO2dWV9v;
        "pkg-2.1.0-forge+1.19.4" = _8ObnCvWx;
        "pkg-2.1.0-fabric+1.19.4" = _OJCuV1A3;
        "pkg-2.1.0-forge+1.19.2" = _QlXHp3Wc;
        "pkg-2.1.0-fabric+1.19.2" = _d7rGTH8w;
        "pkg-2.1.0-forge+1.18.2" = _D73sNN1n;
        "pkg-2.1.0-fabric+1.18.2" = _85V5sG0e;
        "pkg-2.1.1-forge+1.21" = _PYAIZVdI;
        "pkg-2.1.1-neoforge+1.21" = _2pSIrUMv;
        "pkg-2.1.1-fabric+1.21" = _bby6z0lc;
        "pkg-2.1.1-neoforge+1.20.6" = _at0qQd7p;
        "pkg-2.1.1-forge+1.20.6" = _DJn40g5e;
        "pkg-2.1.1-fabric+1.20.6" = _TwrkXQRc;
        "pkg-2.1.1-fabric+1.20.1" = _IrhpPXR5;
        "pkg-2.1.1-forge+1.19.4" = _R08s5q7o;
        "pkg-2.1.1-forge+1.20.1" = _3dEDxcSK;
        "pkg-2.1.1-fabric+1.19.4" = _fJrtVaqS;
        "pkg-2.1.1-forge+1.19.2" = _7HM5BtMB;
        "pkg-2.1.1-fabric+1.19.2" = _XqItQc0B;
        "pkg-2.1.1-forge+1.18.2" = _5yYJdq0D;
        "pkg-2.1.1-fabric+1.18.2" = _xmeJROv1;
        "pkg-2.1.2-forge+1.21" = _I1JBeJGt;
        "pkg-2.1.2-fabric+1.21" = _4CJizVaD;
        "pkg-2.1.2-neoforge+1.21" = _qEswnEky;
        "pkg-2.1.2-neoforge+1.20.6" = _raa8oH4g;
        "pkg-2.1.2-fabric+1.20.1" = _weFWG4Xy;
        "pkg-2.1.2-forge+1.19.4" = _DP03RVSR;
        "pkg-2.1.2-fabric+1.19.4" = _3OAb3mLG;
        "pkg-2.1.2-forge+1.19.2" = _NHoKuO2X;
        "pkg-2.1.2-forge+1.18.2" = _F59I1x3W;
        "pkg-2.1.2-fabric+1.18.2" = _nUOybQXf;
        "pkg-2.1.2-fabric+1.19.2" = _bltk5C8G;
        "pkg-2.2.2-neoforge+1.21" = _ASlZberB;
        "pkg-2.2.2-neoforge+1.21.3" = _4migpzhI;
        "pkg-2.2.2-fabric+1.21.3" = _HxeKc8Cm;
        "pkg-2.2.2-neoforge+1.20.6" = _juR4tYHs;
        "pkg-2.2.2-fabric+1.21" = _8GJdm34j;
        "pkg-2.2.2-fabric+1.20.6" = _O3TwNiM0;
        "pkg-2.2.2-fabric+1.20.1" = _iKrQPq5k;
        "pkg-2.2.2-fabric+1.19.4" = _27uLXmq0;
        "pkg-2.2.2-fabric+1.19.2" = _aGWnprn0;
        "pkg-2.2.3-neoforge+1.21" = _xCeMUuFw;
        "pkg-2.2.3-neoforge+1.21.3" = _KBPetdBv;
        "pkg-2.2.3-fabric+1.21.3" = _XL6X48iC;
        "pkg-2.2.3-neoforge+1.20.6" = _boxxrfKh;
        "pkg-2.2.3-fabric+1.21" = _7KwP7lDU;
        "pkg-2.2.3-fabric+1.20.6" = _8Mf2zjfJ;
        "pkg-2.2.3-fabric+1.20.1" = _5qtFOClK;
        "pkg-2.2.3-fabric+1.19.4" = _Ig8OmT8D;
        "pkg-2.2.3-fabric+1.19.2" = _2QMIH66B;
        "pkg-2.2.4-neoforge+1.21" = _vMJ0PAof;
        "pkg-2.2.4-neoforge+1.21.3" = _H8lvGnzj;
        "pkg-2.2.4-fabric+1.21.3" = _ya37TeIj;
        "pkg-2.2.4-fabric+1.21" = _BiQSuaLz;
        "pkg-2.2.4-neoforge+1.20.6" = _ACPUpcNK;
        "pkg-2.2.4-fabric+1.20.6" = _4blDthMQ;
        "pkg-2.2.4-fabric+1.20.1" = _r5OGe9iP;
        "pkg-2.2.4-fabric+1.19.4" = _9jINzLJo;
        "pkg-2.2.4-fabric+1.19.2" = _p8qzTYvF;
        "pkg-2.2.5-neoforge+1.21.3" = _A88Yz8Do;
        "pkg-2.2.5-neoforge+1.21" = _GHGcHDm1;
        "pkg-2.2.5-neoforge+1.20.6" = _OZSLV4q1;
        "pkg-2.2.5-fabric+1.21.3" = _utLWbQlQ;
        "pkg-2.2.5-fabric+1.21" = _1WYXQ7wK;
        "pkg-2.2.5-fabric+1.20.6" = _mkd4xKr3;
        "pkg-2.2.5-fabric+1.20.1" = _kcJp5N12;
        "pkg-2.2.5-fabric+1.19.4" = _n3aPegz3;
        "pkg-2.2.5-fabric+1.19.2" = _54UB5FEY;
        "pkg-2.2.6-neoforge+1.21.3" = _eCK7k1CS;
        "pkg-2.2.6-fabric+1.21.3" = _QN2ssXrV;
        "pkg-2.2.6-neoforge+1.21" = _MHgiXHuD;
        "pkg-2.2.6-fabric+1.21" = _GWSWLaSC;
        "pkg-2.2.6-neoforge+1.20.6" = _opULD5N7;
        "pkg-2.2.6-fabric+1.20.6" = _4CZ60j0Y;
        "pkg-2.2.6-fabric+1.19.4" = _aAcAO5ob;
        "pkg-2.2.6-fabric+1.19.2" = _7GH3QAp3;
        "pkg-2.2.6-fabric+1.20.1" = _M9uQNAgP;
        "pkg-2.2.7-neoforge+1.21.3" = _b3WIgO1w;
        "pkg-2.2.7-neoforge+1.21" = _Vk6EcJ43;
        "pkg-2.2.7-fabric+1.21.3" = _KZCrPWf4;
        "pkg-2.2.7-fabric+1.21" = _tOIEzwnP;
        "pkg-2.2.7-fabric+1.20.6" = _VqP2fJtA;
        "pkg-2.2.7-fabric+1.20.1" = _WJkokFGw;
        "pkg-2.2.7-neoforge+1.20.6" = _5Jx6rcxM;
        "pkg-2.2.7-fabric+1.19.4" = _2lGHAJcg;
        "pkg-2.2.7-fabric+1.19.2" = _PTsjXxQC;
        "pkg-2.2.8-fabric+1.21.3" = _6msqf0R5;
        "pkg-2.2.8-neoforge+1.21.3" = _aQMw8MLL;
        "pkg-2.2.8-neoforge+1.21" = _U8bdkaH2;
        "pkg-2.2.8-fabric+1.21" = _PNMjaOGf;
        "pkg-2.2.8-fabric+1.20.1" = _go3qvSKY;
        "pkg-2.2.8-neoforge+1.20.6" = _P9P1m60E;
        "pkg-2.2.8-fabric+1.20.6" = _3K7fgPE9;
        "pkg-2.2.8-fabric+1.19.2" = _U2Q2JX3H;
        "pkg-2.2.8-fabric+1.19.4" = _6fU2rdZx;
        "pkg-2.2.11-neoforge+1.21.5" = _b7TcQ20a;
        "pkg-2.2.11-fabric+1.21.5" = _YL8DFxhd;
        "pkg-2.2.11-neoforge+1.21.3" = _jGgRXncR;
        "pkg-2.2.11-neoforge+1.21" = _7NI3OK4N;
        "pkg-2.2.11-fabric+1.21" = _gMDcZH1a;
        "pkg-2.2.11-fabric+1.21.3" = _aHPJVpCN;
        "pkg-2.2.11-neoforge+1.20.6" = _5kwPES3a;
        "pkg-2.2.11-fabric+1.20.6" = _kmiByQ7d;
        "pkg-2.2.11-fabric+1.19.4" = _rhU7R8HF;
        "pkg-2.2.11-fabric+1.20.1" = _yp1QeldV;
        "pkg-2.2.11-fabric+1.19.2" = _KanLe8oP;
        "pkg-2.3.0-beta.2-neoforge+1.21.3" = _RpOg6k0x;
        "pkg-2.3.0-beta.2-neoforge+1.21.5" = _eGM542dj;
        "pkg-2.3.0-beta.2-fabric+1.21.5" = _lRTAfxuK;
        "pkg-2.3.0-beta.2-fabric+1.21.3" = _S6nBPYaF;
        "pkg-2.3.0-beta.2-fabric+1.21" = _tc680vTr;
        "pkg-2.3.0-beta.2-neoforge+1.20.6" = _phG4kr7X;
        "pkg-2.3.0-beta.2-neoforge+1.21" = _jhIN5sB4;
        "pkg-2.3.0-beta.2-fabric+1.20.6" = _HeqnFw9v;
        "pkg-2.3.0-beta.2-fabric+1.20.1" = _x0liCVHx;
        "pkg-2.3.0-beta.2-fabric+1.19.4" = _QQyu7HRz;
        "pkg-2.3.0-beta.2-fabric+1.19.2" = _8fuEYxsa;
        "pkg-2.3.0-beta.4-neoforge+1.21.5" = _pv4FAapu;
        "pkg-2.3.0-beta.4-fabric+1.21.5" = _1getJsfP;
        "pkg-2.3.0-beta.4-neoforge+1.21.3" = _wsnX5Ab3;
        "pkg-2.3.0-beta.4-fabric+1.21.3" = _Nczy3oF4;
        "pkg-2.3.0-beta.4-neoforge+1.21" = _nJtsKeU4;
        "pkg-2.3.0-beta.4-fabric+1.21" = _JgJLPaWz;
        "pkg-2.3.0-beta.4-fabric+1.20.1" = _UULdCrkh;
        "pkg-2.3.0-beta.4-fabric+1.20.6" = _tzO8O2CS;
        "pkg-2.3.0-beta.4-neoforge+1.20.6" = _cLiMugX7;
        "pkg-2.3.0-beta.4-fabric+1.19.4" = _JAzeKbDr;
        "pkg-2.3.0-beta.4-fabric+1.19.2" = _TnH7LmPX;
        "pkg-2.3.1-beta.1-neoforge+1.21.5" = _Pr6LtAl1;
        "pkg-2.3.1-beta.1-fabric+1.21.5" = _mOZ6NUri;
        "pkg-2.3.1-beta.1-neoforge+1.21.3" = _bf75kJhC;
        "pkg-2.3.1-beta.1-neoforge+1.21" = _FG1tIsmk;
        "pkg-2.3.1-beta.1-fabric+1.21.3" = _OPboXlWP;
        "pkg-2.3.1-beta.1-fabric+1.21" = _tKvdWHca;
        "pkg-2.3.1-beta.1-neoforge+1.20.6" = _dFXWvC1H;
        "pkg-2.3.1-beta.1-fabric+1.20.1" = _NuXh08QB;
        "pkg-2.3.1-beta.1-fabric+1.20.6" = _4OXLqhvi;
        "pkg-2.3.1-beta.1-fabric+1.19.4" = _FgwcvcgV;
        "pkg-2.3.1-beta.1-fabric+1.19.2" = _BNj1qsCF;
        "pkg-3.0.0" = _DYYhW4Tj;
        "pkg-3.0.1" = _qExLSUmd;
        "pkg-3.0.2" = _hUsBu0TX;
        "pkg-3.0.3" = _m0zOmOv2;
