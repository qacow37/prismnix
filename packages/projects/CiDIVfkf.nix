...
let
    ...
    in {
        ...
        "pkg-0.0.1-1.4.7" = _qfVHKPfO;
        "pkg-0.0.2-1.4.7" = _UDPcAnek;
        "pkg-0.1-1.4.7" = _58jd3TEh;
        "pkg-0.2-1.4.7" = _SF7DX7uo;
        "pkg-0.3-1.4.7" = _e7HlPgA4;
        "pkg-0.4-1.4.7" = _XlIhNhfC;
        "pkg-0.5-1.4.7" = _twxMHPCE;
        "pkg-0.6-1.4.7" = _zMdKsFOP;
        "pkg-0.6.1-1.4.7" = _PIRcw5ZJ;
        "pkg-0.6.2-1.4.7" = _lio6Kvom;
        "pkg-0.7-1.4.7" = _1T91R1VC;
        "pkg-0.7.1-1.4.7" = _pzVN9QrQ;
        "pkg-0.7.2-1.4.7" = _MSLK0StP;
        "pkg-0.8-1.4.7" = _tVHr9RP7;
        "pkg-0.8.1-1.4.7" = _C7zOFbs9;
        "pkg-0.8.2-1.4.7" = _bAPAuFNv;
        "pkg-0.8.2-1.5.2" = _tsqgEgDA;
        "pkg-0.8.3-1.2.5" = _M3fZXoV1;
        "pkg-0.8.3-1.4.7" = _Lu97Xuy2;
        "pkg-0.8.3-1.5.2" = _UXWp9D18;
        "pkg-0.9-1.2.5" = _E9yFfULg;
        "pkg-0.9-1.4.7" = _NuQVBgBg;
        "pkg-0.9-1.5.2" = _ZEGBvcvA;
        "pkg-0.9-1.3.2" = _rij1muv0;
        "pkg-1.0.0-b1.7.3" = _5cBQOVIF;
        "pkg-1.0.0-b1.8.1" = _LwR03Yps;
        "pkg-1.0.0-1.0" = _Ox5tun0Y;
        "pkg-1.0.0-1.1" = _sDE92N5u;
        "pkg-1.0.0-1.2.3" = _mdagrbEp;
        "pkg-1.0.0-1.2.5" = _1mVBWld8;
        "pkg-1.0.0-1.3.2" = _NH4Ezfwl;
        "pkg-1.0.0-1.4" = _XxuYH4CL;
        "pkg-1.0.0-1.4.2" = _7uxbdJxu;
        "pkg-1.0.0-1.4.3" = _9PcZXNFe;
        "pkg-1.0.0-1.4.5" = _mNhNDQDl;
        "pkg-1.0.0-1.4.7" = _4tz4dUMh;
        "pkg-1.0.0-1.5.x" = _ms87g2KR;
        "pkg-1.1.0-b1.7.3" = _wzvIO9fc;
        "pkg-1.1.0-b1.8.1" = _vNS7BrXU;
        "pkg-1.1.0-1.0" = _R460N7FO;
        "pkg-1.1.0-1.1" = _8hZ76Ej1;
        "pkg-1.1.0-1.2.3" = _SaITCSgb;
        "pkg-1.1.0-1.2.5" = _ZJ75jLlW;
        "pkg-1.1.0-1.3.2" = _4Z8tqeti;
        "pkg-1.1.0-1.4" = _XvS8NdX7;
        "pkg-1.1.0-1.4.2" = _twwX3gGA;
        "pkg-1.1.0-1.4.3" = _Y4S4jkF2;
        "pkg-1.1.0-1.4.5" = _PaX85DVP;
        "pkg-1.1.0-1.4.7" = _8Nb53ZZD;
        "pkg-1.1.0-1.5.x" = _EyUo7XPF;
        "pkg-1.1.1-b1.7.3" = _HdL2gTCG;
        "pkg-1.1.1-b1.8.1" = _FkTmxTJJ;
        "pkg-1.1.1-1.0" = _MhWCJI9c;
        "pkg-1.1.1-1.1" = _CG7pxrnC;
        "pkg-1.1.1-1.2.3" = _n0hVvcln;
        "pkg-1.1.1-1.2.5" = _esSfIPt6;
        "pkg-1.1.1-1.3.2" = _dUchbLU5;
        "pkg-1.1.1-1.4" = _PUr0WqmP;
        "pkg-1.1.1-1.4.2" = _J4x54TIW;
        "pkg-1.1.1-1.4.3" = _WZRrwF1U;
        "pkg-1.1.1-1.4.5" = _l2kjoGZE;
        "pkg-1.1.1-1.4.7" = _gv0Jj78w;
        "pkg-1.1.1-1.5.x" = _NSqI2KqS;
        "pkg-1.1.2-1.3.2" = _1NowsiZh;
        "pkg-1.1.2-1.4.5" = _o2lbk775;
        "pkg-1.1.2-1.4.7" = _HxtFfDpC;
        "pkg-1.1.2-1.5.x" = _K5aoRmLO;
        "pkg-1.2.0-b1.2_02" = _9eWaU9yO;
        "pkg-1.2.0-b1.3_01" = _Ejt44tms;
        "pkg-1.2.0-b1.4_01" = _y55K1c53;
        "pkg-1.2.0-b1.5_01" = _TOhtBs6k;
        "pkg-1.2.0-b1.6.6" = _q2dXO6A6;
        "pkg-1.2.0-b1.8.1" = _JTrTEIyO;
        "pkg-1.2.0-b1.9-pre5" = _3TtNVQDB;
        "pkg-1.2.0-1.0" = _98ib4ALX;
        "pkg-1.2.0-1.1" = _CEvOVKxL;
        "pkg-1.2.0-1.2.3" = _zqKo97ka;
        "pkg-1.2.0-1.2.5" = _IepD0o8X;
        "pkg-1.2.0-1.3.2" = _mfEba1Ph;
        "pkg-1.2.0-b1.7.3" = _brSU9xAn;
        "pkg-1.2.0-1.4" = _QcPEqehp;
        "pkg-1.2.0-1.4.2" = _DMm1JM5F;
        "pkg-1.2.0-1.4.3" = _8eYyqoz9;
        "pkg-1.2.0-1.4.5" = _L4yhuRDJ;
        "pkg-1.2.0-1.4.7" = _3KmdB4Ul;
        "pkg-1.2.0-1.5.x" = _2LVVBYAT;
        "pkg-b1.1_02-2.0.0-pre1" = _BT1RUwEH;
        "pkg-b1.2_02-2.0.0-pre1" = _mQ9VU1BW;
        "pkg-b1.3_01-2.0.0-pre1" = _fq5vpgCR;
        "pkg-b1.4_01-2.0.0-pre1" = _gkmOEOjU;
        "pkg-b1.5_01-2.0.0-pre1" = _U7Gls088;
        "pkg-b1.6.6-2.0.0-pre1" = _djG62oFu;
        "pkg-b1.7.3-2.0.0-pre1" = _irElije1;
        "pkg-b1.8.1-2.0.0-pre1" = _FsbXnvHm;
        "pkg-b1.9p5-2.0.0-pre1" = _PdR9n1bI;
        "pkg-1.0-2.0.0-pre1" = _UyXYMUpD;
        "pkg-1.1-2.0.0-pre1" = _9AOsjoBG;
        "pkg-1.2.3-2.0.0-pre1" = _feIbxGdC;
        "pkg-1.2.5-2.0.0-pre1" = _n1hQu4xc;
        "pkg-1.3.2-2.0.0-pre1" = _nLYvqcLs;
        "pkg-1.4-2.0.0-pre1" = _m5WLCJt6;
        "pkg-1.4.2-2.0.0-pre1" = _FMvBjvlC;
        "pkg-1.4.3-2.0.0-pre1" = _eKhZBrIO;
        "pkg-1.4.5-2.0.0-pre1" = _IwA0vKzz;
        "pkg-1.4.7-2.0.0-pre1" = _IYCKkFlp;
        "pkg-1.5.x-2.0.0-pre1" = _RvzGt1hk;
        "pkg-b1.1_02-2.0.0-pre2" = _XFGluoH6;
        "pkg-b1.2_02-2.0.0-pre2" = _xfwD9Z6N;
        "pkg-b1.3_01-2.0.0-pre2" = _wdgDRNh4;
        "pkg-b1.4_01-2.0.0-pre2" = _j778dLx3;
        "pkg-b1.5_01-2.0.0-pre2" = _XjDIpgMT;
        "pkg-b1.6.6-2.0.0-pre2" = _fP07VMwd;
        "pkg-b1.7.3-2.0.0-pre2" = _1TUa5Ipq;
        "pkg-b1.8.1-2.0.0-pre2" = _eoZ09KkN;
        "pkg-b1.9p5-2.0.0-pre2" = _ObTybhox;
        "pkg-1.0-2.0.0-pre2" = _NrTgdUbG;
        "pkg-1.1-2.0.0-pre2" = _cQ4mvUO1;
        "pkg-1.2.3-2.0.0-pre2" = _aD3DhYV3;
        "pkg-1.2.5-2.0.0-pre2" = _GoKKAhaZ;
        "pkg-1.3.2-2.0.0-pre2" = _r2tGZVw9;
        "pkg-1.4-2.0.0-pre2" = _Roc2KkDv;
        "pkg-1.4.2-2.0.0-pre2" = _lpULW5vX;
        "pkg-1.4.3-2.0.0-pre2" = _BPXXrEyv;
        "pkg-1.4.5-2.0.0-pre2" = _Ft6VHEZ7;
        "pkg-1.4.7-2.0.0-pre2" = _2N18ajEc;
        "pkg-1.5.x-2.0.0-pre2" = _ThlBiJuw;
        "pkg-b1.1_02-2.0.0-pre3" = _DXz1vdEF;
        "pkg-b1.2_02-2.0.0-pre3" = _wfgHnxCY;
        "pkg-b1.3_01-2.0.0-pre3" = _jvBtEr4D;
        "pkg-b1.4_01-2.0.0-pre3" = _cvqKYkyM;
        "pkg-b1.5_01-2.0.0-pre3" = _lLllFroq;
        "pkg-b1.6.6-2.0.0-pre3" = _3lyPZ5HR;
        "pkg-b1.7.3-2.0.0-pre3" = _daUgK4Ms;
        "pkg-b1.8.1-2.0.0-pre3" = _LWgmjZ63;
        "pkg-b1.9p5-2.0.0-pre3" = _cxVNll6F;
        "pkg-1.0-2.0.0-pre3" = _RrOtTTU3;
        "pkg-1.1-2.0.0-pre3" = _ltQKUyZ6;
        "pkg-1.2.3-2.0.0-pre3" = _DD3U9doi;
        "pkg-1.2.5-2.0.0-pre3" = _1yXtRTpk;
        "pkg-1.3.2-2.0.0-pre3" = _F3YzGBB3;
        "pkg-1.4-2.0.0-pre3" = _eNecRrnM;
        "pkg-1.4.2-2.0.0-pre3" = _5tvPRit6;
        "pkg-1.4.3-2.0.0-pre3" = _3hyEkzaD;
        "pkg-1.4.5-2.0.0-pre3" = _aLc5TXyh;
        "pkg-1.4.7-2.0.0-pre3" = _sSaRzauB;
        "pkg-1.5.x-2.0.0-pre3" = _4dlfuCnP;
        "pkg-b1.1_02-2.0.0-pre4" = _sPfn2gEI;
        "pkg-b1.2_02-2.0.0-pre4" = _TerOl7eH;
        "pkg-b1.3_01-2.0.0-pre4" = _dI1owa2z;
        "pkg-b1.4_01-2.0.0-pre4" = _gSbaheSa;
        "pkg-b1.5_01-2.0.0-pre4" = _QC6qkhL0;
        "pkg-b1.6.6-2.0.0-pre4" = _o7lhYdI5;
        "pkg-b1.7.3-2.0.0-pre4" = _Ra8NpPY9;
        "pkg-b1.8.1-2.0.0-pre4" = _1NszujrA;
        "pkg-b1.9p5-2.0.0-pre4" = _Zqv86PbV;
        "pkg-1.0-2.0.0-pre4" = _1bZuBDeI;
        "pkg-1.1-2.0.0-pre4" = _flV0BUqf;
        "pkg-1.2.3-2.0.0-pre4" = _pNcudbQu;
        "pkg-1.2.5-2.0.0-pre4" = _zVG4cf3C;
        "pkg-1.3.2-2.0.0-pre4" = _sIAjnUNV;
        "pkg-1.4-2.0.0-pre4" = _vxXV7Cvq;
        "pkg-1.4.2-2.0.0-pre4" = _hbFIuhIs;
        "pkg-1.4.3-2.0.0-pre4" = _one6xL6f;
        "pkg-1.4.5-2.0.0-pre4" = _2T5R0gR3;
        "pkg-1.4.7-2.0.0-pre4" = _12uG1jJj;
        "pkg-1.5.x-2.0.0-pre4" = _QxBzgPi4;
        "pkg-b1.1_02-2.0.0-pre5" = _JC8V2pQk;
        "pkg-b1.2_02-2.0.0-pre5" = _gBdDguYf;
        "pkg-b1.3_01-2.0.0-pre5" = _qBcjUA9S;
        "pkg-b1.4_01-2.0.0-pre5" = _dWMKpewK;
        "pkg-b1.5_01-2.0.0-pre5" = _f3ZkywO9;
        "pkg-b1.6.6-2.0.0-pre5" = _Bxq5qo1m;
        "pkg-b1.7.3-2.0.0-pre5" = _KNPydRyg;
        "pkg-b1.8.1-2.0.0-pre5" = _H1cmFOWO;
        "pkg-b1.9p5-2.0.0-pre5" = _nQihkdsD;
        "pkg-1.0-2.0.0-pre5" = _xSDT4DLl;
        "pkg-1.1-2.0.0-pre5" = _vsKiUMav;
        "pkg-1.2.3-2.0.0-pre5" = _yNuampe2;
        "pkg-1.2.5-2.0.0-pre5" = _vaRcC7Pt;
        "pkg-1.3.2-2.0.0-pre5" = _Sc2DSH8I;
        "pkg-1.4-2.0.0-pre5" = _Q8UB84bj;
        "pkg-1.4.2-2.0.0-pre5" = _bLwsMlU1;
        "pkg-1.4.3-2.0.0-pre5" = _dQp9Tc5o;
        "pkg-1.4.5-2.0.0-pre5" = _pk0LxbKP;
        "pkg-1.4.7-2.0.0-pre5" = _eYM7YFZI;
        "pkg-1.5.x-2.0.0-pre5" = _TYFEWb0a;
        "pkg-b1.1_02-2.0.0-pre6" = _t0EypVoR;
        "pkg-b1.2_02-2.0.0-pre6" = _OvyIPFR3;
        "pkg-b1.3_01-2.0.0-pre6" = _HWUgBarM;
        "pkg-b1.4_01-2.0.0-pre6" = _MKLdjDDR;
        "pkg-b1.5_01-2.0.0-pre6" = _XcQen3Li;
        "pkg-b1.6.6-2.0.0-pre6" = _p6o9Tl7Y;
        "pkg-b1.7.3-2.0.0-pre6" = _HXxWSOYB;
        "pkg-b1.8.1-2.0.0-pre6" = _gqOHRwMN;
        "pkg-b1.9p5-2.0.0-pre6" = _QlNDrykL;
        "pkg-1.0-2.0.0-pre6" = _DfKgWvVF;
        "pkg-1.1-2.0.0-pre6" = _YfaEWozh;
        "pkg-1.2.3-2.0.0-pre6" = _pLnmNFHB;
        "pkg-1.2.5-2.0.0-pre6" = _3z8VlFi3;
        "pkg-1.3.2-2.0.0-pre6" = _OEU6gWP7;
        "pkg-1.4-2.0.0-pre6" = _adZu1uFR;
        "pkg-1.4.2-2.0.0-pre6" = _yAu8Du4G;
        "pkg-1.4.3-2.0.0-pre6" = _v3hFM1xo;
        "pkg-1.4.5-2.0.0-pre6" = _KkHTnPOq;
        "pkg-1.4.7-2.0.0-pre6" = _CDJLWCLZ;
        "pkg-1.5.x-2.0.0-pre6" = _xb6h1XOn;
        "pkg-b1.1_02-2.0.0-pre7" = _fIHMIznY;
        "pkg-b1.2_02-2.0.0-pre7" = _mmCobRQR;
        "pkg-b1.3_01-2.0.0-pre7" = _8lCLPRvG;
        "pkg-b1.4_01-2.0.0-pre7" = _9z6Qsvln;
        "pkg-b1.5_01-2.0.0-pre7" = _PrbNdEdZ;
        "pkg-b1.6.6-2.0.0-pre7" = _eL6AfHFA;
        "pkg-b1.7.3-2.0.0-pre7" = _2Ce1jpE9;
        "pkg-b1.8.1-2.0.0-pre7" = _VRBX9bhk;
        "pkg-b1.9p5-2.0.0-pre7" = _UqqQvJyy;
        "pkg-1.0-2.0.0-pre7" = _nLmCkH7I;
        "pkg-1.1-2.0.0-pre7" = _MhzkoWQL;
        "pkg-1.2.3-2.0.0-pre7" = _5qqiMFRm;
        "pkg-1.2.5-2.0.0-pre7" = _eN58REAq;
        "pkg-1.3.2-2.0.0-pre7" = _LySNcblI;
        "pkg-1.4-2.0.0-pre7" = _7NKsu2YF;
        "pkg-1.4.2-2.0.0-pre7" = _w8oNSqC0;
        "pkg-1.4.3-2.0.0-pre7" = _XgXe8qWr;
        "pkg-1.4.5-2.0.0-pre7" = _tGBlmnvM;
        "pkg-1.4.7-2.0.0-pre7" = _yTsWeAvc;
        "pkg-1.5.x-2.0.0-pre7" = _7AIkwL4R;
        "pkg-b1.1_02-2.0.0-pre8" = _Cc5iuTZx;
        "pkg-b1.2_02-2.0.0-pre8" = _7CYy52V6;
        "pkg-b1.3_01-2.0.0-pre8" = _Dqq9ppph;
        "pkg-b1.4_01-2.0.0-pre8" = _sTmIxinS;
        "pkg-b1.5_01-2.0.0-pre8" = _AikR4KbE;
        "pkg-b1.6.6-2.0.0-pre8" = _uTdE4QOs;
        "pkg-b1.7.3-2.0.0-pre8" = _tLoQ30Zo;
        "pkg-b1.8.1-2.0.0-pre8" = _JGr1HDab;
        "pkg-b1.9p5-2.0.0-pre8" = _Yl4aH8XF;
        "pkg-1.0-2.0.0-pre8" = _qCvegcXV;
        "pkg-1.1-2.0.0-pre8" = _NBzWimIh;
        "pkg-1.2.3-2.0.0-pre8" = _psryYWhs;
        "pkg-1.2.5-2.0.0-pre8" = _wj0ECzlb;
        "pkg-1.3.2-2.0.0-pre8" = _HqgCKaUP;
        "pkg-1.4-2.0.0-pre8" = _lXOJqg3s;
        "pkg-1.4.2-2.0.0-pre8" = _YMdbe8Ts;
        "pkg-1.4.3-2.0.0-pre8" = _TyBFrj4A;
        "pkg-1.4.5-2.0.0-pre8" = _iTXsdREm;
        "pkg-1.4.7-2.0.0-pre8" = _T2PPSUWl;
        "pkg-1.5.x-2.0.0-pre8" = _3uuCR2w1;
        "pkg-b1.1_02-2.0.0-pre9" = _nctHuXx6;
        "pkg-b1.2_02-2.0.0-pre9" = _OtcoXXNV;
        "pkg-b1.3_01-2.0.0-pre9" = _4IhUOCsN;
        "pkg-b1.4_01-2.0.0-pre9" = _HLeeEsTY;
        "pkg-b1.5_01-2.0.0-pre9" = _D4kL9WQB;
        "pkg-b1.6.6-2.0.0-pre9" = _ZouOicDu;
        "pkg-b1.7.3-2.0.0-pre9" = _idalyKPI;
        "pkg-b1.8.1-2.0.0-pre9" = _COQDWU9U;
        "pkg-b1.9p5-2.0.0-pre9" = _fdJg5XB4;
        "pkg-1.0-2.0.0-pre9" = _u6Xqmbp8;
        "pkg-1.1-2.0.0-pre9" = _rU3S5IAB;
        "pkg-1.2.3-2.0.0-pre9" = _d6Tm2wwz;
        "pkg-1.2.5-2.0.0-pre9" = _OXOrVdqa;
        "pkg-1.3.2-2.0.0-pre9" = _RPg8jiZH;
        "pkg-1.4-2.0.0-pre9" = _WByu9gfm;
        "pkg-1.4.2-2.0.0-pre9" = _z9alpXqK;
        "pkg-1.4.3-2.0.0-pre9" = _2kix9rDx;
        "pkg-1.4.5-2.0.0-pre9" = _N8xOtkJR;
        "pkg-1.4.7-2.0.0-pre9" = _KK7k8f2f;
        "pkg-1.5.x-2.0.0-pre9" = _XpoVfVf1;
        "pkg-b1.1_02-2.0.0-pre10" = _OS61Og8q;
        "pkg-b1.2_02-2.0.0-pre10" = _cE73Xdqz;
        "pkg-b1.3_01-2.0.0-pre10" = _OHsB1ezW;
        "pkg-b1.4_01-2.0.0-pre10" = _JpeVXD58;
        "pkg-b1.5_01-2.0.0-pre10" = _v6qEQ7S7;
        "pkg-b1.6.6-2.0.0-pre10" = _2qixSBPz;
        "pkg-b1.7.3-2.0.0-pre10" = _BROyXxV5;
        "pkg-b1.8.1-2.0.0-pre10" = _ZbQvjD7I;
        "pkg-b1.9p5-2.0.0-pre10" = _lWTs1Vw3;
        "pkg-1.0-2.0.0-pre10" = _ZYBxHFng;
        "pkg-1.1-2.0.0-pre10" = _nzh1s6NT;
        "pkg-1.2.3-2.0.0-pre10" = _Fu9XdkPY;
        "pkg-1.2.5-2.0.0-pre10" = _iOM72wov;
        "pkg-1.3.2-2.0.0-pre10" = _Mg6lTzjA;
        "pkg-1.4-2.0.0-pre10" = _3Ki5q75d;
        "pkg-1.4.2-2.0.0-pre10" = _u17TooLO;
        "pkg-1.4.3-2.0.0-pre10" = _8AFxYEMR;
        "pkg-1.4.5-2.0.0-pre10" = _wGtiiwt3;
        "pkg-1.4.7-2.0.0-pre10" = _xVDVdwU1;
        "pkg-1.5.x-2.0.0-pre10" = _yfembluN;
        "pkg-a1.2.6-2.0.0-pre10" = _Txa1p5B5;
        "pkg-a1.2.6-2.0.0-pre11" = _8xb8pdB9;
        "pkg-b1.1_02-2.0.0-pre11" = _PvvJG5R9;
        "pkg-b1.2_02-2.0.0-pre11" = _gdeNrppk;
        "pkg-b1.3_01-2.0.0-pre11" = _xGtboAFL;
        "pkg-b1.4_01-2.0.0-pre11" = _Gd3rLVed;
        "pkg-b1.5_01-2.0.0-pre11" = _zaKlf0cT;
        "pkg-b1.6.6-2.0.0-pre11" = _mCCmTC0V;
        "pkg-b1.7.3-2.0.0-pre11" = _LgAb87TJ;
        "pkg-b1.8.1-2.0.0-pre11" = _US1vZz57;
        "pkg-b1.9p5-2.0.0-pre11" = _NuKPsc4v;
        "pkg-1.0-2.0.0-pre11" = _c3zULecE;
        "pkg-1.1-2.0.0-pre11" = _JqjDWEMT;
        "pkg-1.2.3-2.0.0-pre11" = _g1Y39ha8;
        "pkg-1.2.5-2.0.0-pre11" = _ODQvrYD2;
        "pkg-1.3.2-2.0.0-pre11" = _nzDvnDNF;
        "pkg-1.4-2.0.0-pre11" = _TOmDjPbK;
        "pkg-1.4.2-2.0.0-pre11" = _1jJBWzd0;
        "pkg-1.4.3-2.0.0-pre11" = _O4fsiEtO;
        "pkg-1.4.5-2.0.0-pre11" = _3nmYiWo5;
        "pkg-1.4.7-2.0.0-pre11" = _l6clABoI;
        "pkg-1.5.x-2.0.0-pre11" = _vqQOZlaD;
        "pkg-a1.2.6-2.0.0-pre12" = _Put4u6W6;
        "pkg-b1.1_02-2.0.0-pre12" = _SveHgKyI;
        "pkg-b1.2_02-2.0.0-pre12" = _l8wK9c19;
        "pkg-b1.3_01-2.0.0-pre12" = _YmVdpD9i;
        "pkg-b1.4_01-2.0.0-pre12" = _tJDUQyhX;
        "pkg-b1.5_01-2.0.0-pre12" = _swPOwUkN;
        "pkg-b1.6.6-2.0.0-pre12" = _mdpuPwBD;
        "pkg-b1.7.3-2.0.0-pre12" = _zbTOOJdq;
        "pkg-b1.8.1-2.0.0-pre12" = _jq3b0Eb1;
        "pkg-b1.9p5-2.0.0-pre12" = _Hy6yg0l1;
        "pkg-1.0-2.0.0-pre12" = _S9BgYxcg;
        "pkg-1.1-2.0.0-pre12" = _O1OGnybx;
        "pkg-1.2.3-2.0.0-pre12" = _NlTZFakA;
        "pkg-1.2.5-2.0.0-pre12" = _hvkI4mkM;
        "pkg-1.3.2-2.0.0-pre12" = _q7gROmI4;
        "pkg-1.4-2.0.0-pre12" = _stUGD9EG;
        "pkg-1.4.2-2.0.0-pre12" = _fMLm0MIJ;
        "pkg-1.4.3-2.0.0-pre12" = _VDiaivoB;
        "pkg-1.4.5-2.0.0-pre12" = _1Hycy4i2;
        "pkg-1.4.7-2.0.0-pre12" = _T7NwiX4B;
        "pkg-1.5.x-2.0.0-pre12" = _oFdbkZKk;
        "default" = _oFdbkZKk;
    });
