...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.20.1" = _sGzItfZ4;
        "pkg-0.1.0+1.19.4" = _GuFzOWON;
        "pkg-0.1.0+1.19.2" = _fr4o8Y0n;
        "pkg-0.1.1+1.19.2" = _MSmwOBwP;
        "pkg-0.1.1+1.19.4" = _DTk6EFVU;
        "pkg-0.1.1+1.20.1" = _wmMVH7Z5;
        "pkg-0.1.2+1.20.2" = _W4gzp6Uu;
        "pkg-0.1.2+1.20.1" = _kcAmZQW7;
        "pkg-0.1.2+1.19.4" = _bsFeIwlx;
        "pkg-0.1.2+1.19.2" = _Du7pJZS9;
        "pkg-0.1.3+1.20.2" = _IpHRJF9J;
        "pkg-0.1.3+1.20.1" = _O6wCIZb2;
        "pkg-0.1.3+1.19.4" = _gJVSZ4CR;
        "pkg-0.1.3+1.19.2" = _8HCeKInE;
        "pkg-0.1.4+1.20.4" = _8QSJCLn2;
        "pkg-0.1.4+1.20.1" = _ykOysDnB;
        "pkg-0.1.4" = _mhgci5XO;
        "pkg-0.1.5+1.20.4" = _90LfQ6o0;
        "pkg-0.1.5+1.20.1" = _RtLPvt5z;
        "pkg-0.1.5+1.19.4" = _bXKSQBdT;
        "pkg-0.1.5+1.19.2" = _gukdLhU7;
        "pkg-0.1.5" = _Ow90WaMF;
        "pkg-0.1.5+1.21.3" = _llQ16R1R;
        "pkg-0.1.5+1.21.4" = _igTeTu2o;
        "default" = _igTeTu2o;
    });
