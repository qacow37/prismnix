...
let
    ...
    in {
        ...
        "pkg-0.1.3" = _qcK4zrKH;
        "pkg-1.7.10-0.1.4" = _EsA32l71;
        "pkg-1.7.10-0.1.5" = _ycwEopzo;
        "pkg-1.7.10-0.1.6" = _s4zOdUqn;
        "pkg-1.7.10-0.1.7" = _nhM7mis6;
        "pkg-1.7.10-0.1.7.1" = _imlnqLey;
        "pkg-1.7.10-0.1.8" = _NtJqg5Qh;
        "pkg-1.7.10-0.1.9" = _JYug5axm;
        "pkg-1.7.10-0.1.10" = _rE7KrViD;
        "pkg-1.7.10-0.1.11" = _fzhcx19u;
        "pkg-1.7.10-0.1.12" = _yyEbF5W7;
        "pkg-1.7.10-0.1.13" = _Fes911x3;
        "pkg-1.7.10-0.1.14" = _9cdpjwYl;
        "pkg-1.7.10-0.1.15" = _sJvTz8L9;
        "pkg-1.7.10-0.1.16" = _BCq5x4L2;
        "pkg-1.7.10-0.1.17" = _7iC7nIQ2;
        "pkg-1.7.10-01.18" = _iqZltOER;
        "pkg-1.7.10-0.1.18" = _VFkZ6RYl;
        "pkg-1.7.10-0.1.19" = _Un9U6QdP;
        "pkg-1.7.10-0.1.20" = _QJuu6UyE;
        "pkg-1.7.10-0.1.21" = _hoDTNzLL;
        "pkg-1.7.10-0.1.22" = _qszQWTGR;
        "pkg-1.7.10-0.2.1" = _QVfak9aE;
        "pkg-1.7.10-0.3.0" = _BpPBBjZU;
        "pkg-1.7.10-0.3.1" = _SeOh2lEZ;
        "default" = _SeOh2lEZ;
    });
