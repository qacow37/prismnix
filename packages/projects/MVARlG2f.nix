...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0-10" = _SkPZ9vsv;
        "pkg-1.20.1-1.0-11" = _gjOg7ubx;
        "pkg-1.20.1-1.0-12" = _b7MOkIpO;
        "pkg-1.20.1-1.0-13" = _MrJwo3MU;
        "pkg-1.20.1-1.0-14" = _v807AcrM;
        "pkg-1.20.1-1.0-15" = _dcnFHE4S;
        "pkg-1.20.1-1.0-16" = _8gI46xKb;
        "pkg-1.20.1-1.0-17" = _VZIuuK5P;
        "pkg-1.20.1-1.0-18" = _xrRcZzvP;
        "pkg-1.20.1-1.0-19" = _VDiwJ2Xr;
        "pkg-1.20.1-1.0-20" = _v6bSOlfp;
        "pkg-1.20.1-1.0-21" = _9gOvmum5;
        "pkg-1.20.1-1.0-22c" = _UXasHCi0;
        "pkg-1.20.1-1.0-23" = _1CFmQsVa;
        "pkg-1.20.1-1.0-24" = _MRyLCiek;
        "pkg-1.20-26" = _PkLhBJmH;
        "pkg-1.20-27" = _UyIrhtXm;
        "pkg-1.20.1-1.0-28" = _mJDm9MPg;
        "pkg-1.20.1-1.0-29" = _KSjIOpVa;
        "pkg-1.20.1-1.0-30" = _boj4QtcB;
        "pkg-1.20.1-1.0-31" = _mSER3jBI;
        "pkg-1.21.1-1.1-38" = _PjkPuWJo;
        "pkg-1.1-39" = _iyNxYFme;
        "pkg-1.1-40" = _9GjNW2Gf;
        "default" = _9GjNW2Gf;
    });
