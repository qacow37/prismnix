...
let
    ...
    in {
        ...
        "pkg-1.6.0-1.19-fabric" = _XLjD6Kbq;
        "pkg-1.6.0-1.19.1-1.19.2-fabric" = _OJaX8Ruf;
        "pkg-1.6.0" = _nyYTkFWh;
        "pkg-1.6.0-1.19.3-fabric" = _3kzSH4eT;
        "pkg-1.6.0-1.19.3-forge" = _qkTaRC9i;
        "pkg-1.6.0-1-1.19.3-fabric" = _OdyUMgZC;
        "pkg-1.6.0-1.19.4-forge" = _fs2RdBWK;
        "pkg-1.6.0-1.19.4-fabric" = _hGJFSkMw;
        "pkg-1.6.0-2-1.19.4-fabric" = _kiAIoQnV;
        "pkg-1.6.1-1.18-1.18.2-fabric" = _L4bTPMly;
        "pkg-1.6.1-1.19-fabric" = _Q3fMIonu;
        "pkg-1.6.1-1.19.1-1.19.2-fabric" = _pz9SoIJL;
        "pkg-1.6.1-1.19.3-fabric" = _4y9cJbpy;
        "pkg-1.6.1-1.19.4-fabric" = _njrUss7i;
        "pkg-1.6.1-1.12-1.12.2-forge" = _Nmo9ggyx;
        "pkg-1.6.1-1.16.2-1.16.5-forge" = _MFN5Cgup;
        "pkg-1.6.1-1.18-1.18.2-forge" = _drdxtCrM;
        "pkg-1.6.1-1.19-1.19.2-forge" = _a4UZ7nGe;
        "pkg-1.6.1-1.19.3-forge" = _CTjhm1dN;
        "pkg-1.6.1-1.19.4-forge" = _hOqG5qTT;
        "pkg-1.6.1-1.20-fabric" = _fNYbw69M;
        "pkg-1.6.1-2-1.20-forge" = _9o3SSmd1;
        "pkg-1.6.1-1.20.2-fabric" = _B7yILQ7L;
        "pkg-1.6.1-1.20.2-forge" = _pAy646WB;
        "pkg-1.7.0-1.20.2-fabric" = _J7P1coEq;
        "pkg-1.7.0-1.20.1-fabric" = _9RwlUq8K;
        "pkg-1.7.0-1-1.20.2-fabric" = _ekHHVgFJ;
        "pkg-1.7.0-1-1.20.1-fabric" = _Az1kEuIr;
        "pkg-1.6.1-3-1.20.2-forge" = _KI6udyr4;
        "pkg-1.7.0-2-1.20.2-fabric" = _qsYMqjlM;
        "pkg-1.7.1-1.20.4-fabric" = _sL2n2zBv;
        "pkg-1.7.1-1.20.4-forge" = _vkSbmyqP;
        "pkg-1.8.0-1.18-1.18.2-fabric" = _ZtOyno2f;
        "pkg-1.8.0-1.19.1-1.19.2-fabric" = _2XnMLMOc;
        "pkg-1.8.0-1.20.1-fabric" = _ukp6rFnW;
        "pkg-1.8.0-1.20.4-fabric" = _ntpwYmzP;
        "pkg-1.8.0-1.18-1.18.2-forge" = _bGBUWMlK;
        "pkg-1.8.0-1.19-1.19.2-forge" = _QMv1le10;
        "pkg-1.8.0-1.20-1.20.1-forge" = _skYziQQL;
        "pkg-1.8.0-1.20.4-forge" = _DpeV0fqj;
        "pkg-1.8.1-1.20.1-fabric" = _RlBGFlWp;
        "pkg-1.9.0-1.20.4-neoforge" = _sPDPwWC7;
        "pkg-1.9.1-1.20.4-fabric" = _KSRr0suP;
        "pkg-1.9.1-1.20.4-forge" = _2Bi44ubs;
        "pkg-1.9.1-1.20.4-neoforge" = _gOjPgkAM;
        "pkg-1.9.2-1.20.4-fabric" = _4W5krUSZ;
        "pkg-1.9.2-1.20.4-forge" = _3FxKHNvB;
        "pkg-1.9.3-1.20.2-fabric" = _om06rNYI;
        "pkg-1.9.3-1.20.2-forge" = _Lv44dGlN;
        "pkg-1.9.4-1.20.5-fabric" = _2YWRHuZn;
        "pkg-1.9.4-1.20.5-neoforge" = _8T4RHphB;
        "pkg-1.9.5-1.20.4-forge" = _l5t1hH7D;
        "pkg-1.9.6-1.20.6-forge" = _Pj5Q7DXJ;
        "pkg-1.9.7-1.20.6-forge" = _KtLMUCjA;
        "pkg-1.9.8-1.20.6-forge" = _UudzMb6I;
        "pkg-1.9.9-1.21-fabric" = _Qvrc7DuG;
        "pkg-1.9.9-1.21-forge" = _7AWKhwaU;
        "pkg-1.9.9-1.21-neoforge" = _stJDU839;
        "pkg-1.9.9-1.21.4-fabric" = _9I475ADm;
        "pkg-1.9.9-1.21.4-neoforge" = _1ZCnjysV;
        "pkg-1.9.10-1.21.4-forge" = _c0wZm04t;
        "pkg-1.9.11-1.21.5-fabric" = _prXF72pT;
        "pkg-1.9.11-1.21.5-forge" = _n8MthHBl;
        "pkg-1.9.11-1.21.5-neoforge" = _bGlSoHYW;
        "pkg-1.9.12-1.21.6-fabric" = _ua0GnQ25;
        "pkg-1.9.12-1.21.6-forge" = _AqQgkM2M;
        "pkg-1.9.12-1.21.6-neoforge" = _1UX5k8UJ;
        "pkg-1.9.13-1.21.10-fabric" = _kLTIGlRD;
        "pkg-1.9.13-1.21.10-neoforge" = _Em70hPwG;
        "pkg-1.9.14-1.21.11-fabric" = _59cbfF2f;
        "pkg-1.9.14-1.21.11-neoforge" = _U7nQg9tw;
        "pkg-1.9.15-1.21.11-fabric" = _7w89GFDg;
        "pkg-1.9.15-1.21.11-neoforge" = _gFY38hq8;
        "pkg-1.9.16-1.21.11-fabric" = _p0g9ooPC;
        "pkg-1.9.16-1.21.11-neoforge" = _WlfoavEM;
        "pkg-1.9.17-1.21.11-fabric" = _Slss4NJy;
        "pkg-1.9.17-1.21.11-neoforge" = _QMQAycXK;
        "pkg-1.9.18-1.21.11-fabric" = _6ypTGwlP;
        "pkg-1.9.18-1.21.11-neoforge" = _BwyWmTTW;
        "pkg-1.9.19-26.1.1-fabric" = _9AbCubhI;
        "pkg-1.9.19-26.1.1-neoforge" = _e0jecCch;
        "pkg-1.10.0-26.1.1-fabric" = _aRYAlDae;
        "pkg-1.10.0-26.1.1-neoforge" = _AVzU7BSU;
        "pkg-1.10.1-26.1.1-fabric" = _SBC2WlEa;
        "pkg-1.10.1-26.1.1-neoforge" = _S3KyS0Na;
        "pkg-1.10.2-26.1.1-fabric" = _Y6HGzcl3;
        "pkg-1.11.0-26.2-fabric" = _YnnkbRci;
