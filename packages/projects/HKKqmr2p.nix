...
let
    ...
    in {
        ...
        "pkg-1.1.2-1.20.1-Forge" = _M3BSVcGI;
        "pkg-1.2.1-1.20.1-Fabric" = _UCRi2ugG;
        "pkg-1.2.2+1.20.1-Fabric" = _t3utBPnY;
        "pkg-1.3.0+1.20.1-Fabric" = _FtGtFmMM;
        "pkg-1.3.1+1.20.1-Forge" = _zkGsVkE0;
        "pkg-1.4.0+1.20.1-Forge" = _Y0uBxNdw;
        "pkg-1.4.0+1.20.1-Fabric" = _L8nzs7BJ;
        "pkg-1.4.1+1.20(.2)-Forge" = _1CzoZkav;
        "pkg-1.4.1+1.20(.2)-Fabric" = _56SowvI6;
        "pkg-1.5.0-beta.1+1.20(.2)-Fabric" = _JZiD9xz4;
        "pkg-1.5.0-beta.2+1.19.2-Forge" = _bgzq5SoD;
        "pkg-1.5.0-beta.2+1.19.2-Fabric" = _DZpbtTEi;
        "pkg-1.5.0-beta.2+1.20.2-Forge" = _G9Z0bcCA;
        "pkg-1.5.0-beta.2+1.20.2-Fabric" = _UFmh3Kff;
        "pkg-1.5.0-beta.3+1.20.2-Forge" = _t5EEv0ZX;
        "pkg-1.5.0-beta.3+1.20.2-Fabric" = _54qNacKk;
        "pkg-1.5.0-beta.3+1.20.4-Neo" = _VxO9lXbl;
        "pkg-1.5.0-beta.3+1.20.4-Fabric" = _y4ApPXCr;
        "pkg-1.5.0" = _FyWq7taK;
        "pkg-1.5.1+1.20.2-Forge" = _6qW9dlm9;
        "pkg-1.5.1+1.20.2-Fabric" = _7hlHYjqZ;
        "pkg-1.5.1+1.20.4-Forge" = _bx00TVXs;
        "pkg-1.5.1+1.20.4-Neo" = _chmTLQ49;
        "pkg-1.5.1+1.20.4-Fabric" = _ITPfhUjH;
        "pkg-1.5.2+1.20.2-Forge" = _Fn5t5Jzd;
        "pkg-1.5.2+1.20.2-Fabric" = _M0ekItoU;
        "pkg-1.5.2+1.20.4-Forge" = _3l12ZyuL;
        "pkg-1.5.2+1.20.4-Neo" = _buSNljvE;
        "pkg-1.5.2+1.20.4-Fabric" = _pJiiCcxB;
        "pkg-1.5.3+1.20.2-Forge" = _O3zQpx8E;
        "pkg-1.5.3+1.20.2-Fabric" = _evfcslZ0;
        "pkg-1.5.3+1.20.4-Forge" = _Nv1bPXup;
        "pkg-1.5.3+1.20.4-Neo" = _UYbW9Ham;
        "pkg-1.5.3+1.20.4-Fabric" = _OLwxRjZy;
        "pkg-1.5.3+1.20.6-Neo" = _6CFSsiEa;
        "pkg-1.5.3+1.20.6-Fabric" = _ak991rzW;
        "pkg-1.5.4+1.20.2-Forge" = _l2vbFfSI;
        "pkg-1.5.4+1.20.2-Fabric" = _Xzim8Cee;
        "pkg-1.5.4+1.20.6-Neo" = _8QPZJkss;
        "pkg-1.5.4+1.20.6-Fabric" = _f4iNGflt;
        "pkg-1.5.5+1.20.2-Forge" = _q3AP6Mkn;
        "pkg-1.5.5+1.20.2-Fabric" = _D4jJgBcn;
        "pkg-1.5.5+1.20.4-Forge" = _afQya3zQ;
        "pkg-1.5.5+1.20.4-Neo" = _KImdBNdI;
        "pkg-1.5.5+1.20.4-Fabric" = _alasFHFb;
        "pkg-1.5.5+1.20.6-Neo" = _HbEjDAgq;
        "pkg-1.5.5+1.20.6-Fabric" = _j7TzFcUJ;
        "pkg-1.5.5+1.21-Neo" = _AFbLq8x1;
        "pkg-1.5.5+1.21-Fabric" = _JFsRsPmu;
        "pkg-1.5.6+1.20.2-Forge" = _nzXkg0VS;
        "pkg-1.5.6+1.20.2-Fabric" = _4RTlXzWr;
        "pkg-1.5.6+1.20.4-Forge" = _Ib5AFg4x;
        "pkg-1.5.6+1.20.4-Neo" = _cvoUOXVE;
        "pkg-1.5.6+1.20.4-Fabric" = _AL5BWAbV;
        "pkg-1.5.6+1.20.6-Neo" = _OzNRKYnw;
        "pkg-1.5.6+1.20.6-Fabric" = _bfU1riZk;
        "pkg-1.5.6+1.21-Neo" = _vNb1rjHH;
        "pkg-1.5.6+1.21-Fabric" = _EiHVohhQ;
        "pkg-1.5.7+1.21-Neo" = _cCChDmo7;
        "pkg-1.5.8+1.20.6-Neo" = _NHmsw0fx;
        "pkg-1.5.8+1.21-Neo" = _A83kdmZ4;
        "pkg-1.5.9+1.21.1-Neo" = _H9TwIeCP;
        "pkg-1.5.10+1.21.4-Fabric" = _ovJuA36e;
        "pkg-1.5.11+1.21.4-Fabric" = _tpVlB73U;
        "pkg-1.5.12+1.21.5-fabric" = _MjstdyLD;
        "pkg-1.5.13+1.21.1-Neo" = _BtahPc5o;
        "pkg-1.5.14+1.21.8-Neo" = _UqZ8hNug;
        "pkg-1.5.14+1.21.8-Fabric" = _2Wpt2c4D;
        "pkg-1.5.14+1.21.1-Neo" = _serzFzZL;
        "pkg-1.5.14+1.21.10-Neo" = _4xLfLcmu;
        "pkg-1.5.14+1.21.10-Fabric" = _DbsvowYO;
        "pkg-1.5.15+1.21.1-Neo" = _LS1lV2L7;
        "pkg-1.5.14+1.21.11-Neo" = _6UmR3cPp;
        "pkg-1.5.14+1.21.11-Fabric" = _TeC02EN7;
        "pkg-1.5.14+26.1.1-Neo" = _eXpxGY4F;
        "pkg-1.5.14+26.1.1-Fabric" = _NzCzRxh1;
        "default" = _NzCzRxh1;
    });
