...
let
    ...
    in {
        ...
        "pkg-0.0.4-SNAP" = _Sn9bZyrO;
        "pkg-0.0.6-SNAP" = _HhxzBd35;
        "pkg-1193-1206-1.0.0-BET" = _KoZ0X3Gf;
        "pkg-1212-1215-1.0.0-REL" = _cKeVGfjW;
        "pkg-1210-1211-1.0.0-BET" = _pfiLzD09;
        "pkg-1182-1192-1.0.1-REL" = _670aycck;
        "pkg-1193-1206-1.0.1-REL" = _ndtgsP5b;
        "pkg-1210-1211-1.0.2-REL" = _3CKU1ZMR;
        "pkg-1193-1206-1.1.0-REL" = _D2FaalBr;
        "pkg-1182-1192-1.1.0-REL" = _w7l015lz;
        "pkg-1210-1211-1.1.0-REL" = _CjaEz3hB;
        "pkg-1212-1215-1.1.0-REL" = _DzCNvJIw;
        "pkg-1182-1192-1.1.1-REL" = _qXyI8Bc5;
        "pkg-1193-1200-1.1.1-REL" = _6lXU0Tnv;
        "pkg-1201-1206-1.1.1-REL" = _5cO06nTZ;
        "pkg-1212-1215-1.1.1-REL" = _QVBZAHos;
        "pkg-1210-1211-1.1.1-REL" = _4OkJpTs2;
        "pkg-1.21.2-1.2.0-REL" = _yWSbOzRZ;
        "pkg-1.21.3-1.2.0-REL" = _YgJPHN8y;
        "pkg-1.21.4-1.2.0-REL" = _4Y5Rubfq;
        "pkg-1.21.5-1.2.0-REL" = _j5L0zZIZ;
        "pkg-1.21.6-1.2.0-REL" = _sTJdpcVq;
        "pkg-1.21.7-1.2.0-REL" = _m5LmXJJS;
        "pkg-1.21.2-1.2.1-REL" = _mXFfqMdp;
        "pkg-1.21.3-1.2.1-REL" = _T69EGnFt;
        "pkg-1.21.4-1.2.1-REL" = _ke3aJ44K;
        "pkg-1.21.5-1.2.1-REL" = _HCBrI6kR;
        "pkg-1.21.6-1.2.1-REL" = _74u3s9qM;
        "pkg-1.21.7-1.2.1-REL" = _wGpiXVL0;
        "pkg-f5e02d7-1.21.2-fabric" = _1OzQn5l9;
        "pkg-f5e02d7-1.21.2-neoforge" = _ZwhD1QHy;
        "pkg-a8835b4-1.21.3-fabric" = _8SvuVBnJ;
        "pkg-1b9a7fa-1.21.5-fabric" = _oEm3Yy3t;
        "pkg-a8835b4-1.21.3-neoforge" = _fzznJzN7;
        "pkg-1b9a7fa-1.21.5-neoforge" = _NF0bXHkh;
        "pkg-8988d8d-1.21.6-fabric" = _miCHwhxr;
        "pkg-8988d8d-1.21.6-neoforge" = _r9O9fFE5;
        "pkg-5cb9221-1.21.4-fabric" = _5ukuphsH;
        "pkg-5cb9221-1.21.4-neoforge" = _vjx5b7IT;
        "pkg-05b2e16-1.21.7-fabric" = _LZSDpW3z;
        "pkg-05b2e16-1.21.7-neoforge" = _U361GPYb;
        "pkg-462bb08-1.21.8-fabric" = _VfyINnwZ;
        "pkg-462bb08-1.21.8-neoforge" = _JhijxwsK;
        "pkg-a1c92cf-1.21.9-fabric" = _ARFFiOTz;
        "pkg-a1c92cf-1.21.9-neoforge" = _b9cf4QGj;
        "pkg-377a43f-1.21.10-fabric" = _YQJmPdZ2;
        "pkg-377a43f-1.21.10-neoforge" = _lq1l0Dk7;
        "pkg-4f86ea9-1.21.1-fabric" = _SDbyySx0;
        "pkg-4f86ea9-1.21.1-neoforge" = _Q1IY2hM4;
        "pkg-be2b51f-1.21-fabric" = _pxQYvMZV;
        "pkg-be2b51f-1.21-neoforge" = _KiMjYkfk;
        "pkg-1f6673f-1.21-fabric" = _BkFx3N2h;
        "pkg-1f6673f-1.21-neoforge" = _2lOvfOli;
        "pkg-ad1f9d4-1.21.1-fabric" = _iqBroL1H;
        "pkg-ad1f9d4-1.21.1-neoforge" = _reMa0bnf;
        "pkg-f697724-1.21.11-fabric" = _oIVYpeAx;
        "pkg-f697724-1.21.11-neoforge" = _IazKMMgJ;
        "pkg-3d45106-1.21.1-fabric" = _VkYpxzs4;
        "pkg-6a32500-1.21-fabric" = _zo2PHc9c;
        "pkg-6a32500-1.21-neoforge" = _4MTDEzMs;
        "pkg-3d45106-1.21.1-neoforge" = _BaRXMYRF;
        "default" = _BaRXMYRF;
    });
