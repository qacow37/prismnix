...
let
    ...
    in {
        ...
        "pkg-1.16.5-3.6-fabric" = _uMtSqq25;
        "pkg-1.18.2-3.6-fabric" = _1cCIpEN2;
        "pkg-1.19.2-3.7-fabric" = _ZMeDH05m;
        "pkg-1.16.5-3.3-forge" = _RBmJ0sL5;
        "pkg-1.18.2-3.3-forge" = _ySAnWVa4;
        "pkg-1.19.2-3.5-forge" = _GfHBpGiR;
        "pkg-1.16.5-3.8-fabric" = _Kz8m9noN;
        "pkg-1.18.2-3.8-fabric" = _GGogzoUX;
        "pkg-1.19.2-3.8-fabric" = _bjwrtdCy;
        "pkg-1.19.3-3.9-fabric" = _7YoUGcWO;
        "pkg-1.19.3-3.5-forge" = _NtQD1091;
        "pkg-1.18.2-4.0-forge+fabric" = _6ZMyUnaZ;
        "pkg-1.19.2-4.0-forge+fabric" = _IHDNX4M0;
        "pkg-1.19.3-4.0-forge+fabric" = _ldzOukBA;
        "pkg-1.18.2-4.1-forge+fabric" = _7Hq4Vu1h;
        "pkg-1.19.2-4.1-forge+fabric" = _ycQmvIga;
        "pkg-1.19.3-4.1-forge+fabric" = _VqbmtGI9;
        "pkg-1.18.2-4.2-forge+fabric" = _cczPWm1T;
        "pkg-1.19.2-4.2-forge+fabric" = _tUVGgQuz;
        "pkg-1.19.3-4.2-forge+fabric" = _X02YG8Ar;
        "pkg-1.18.2-4.3-forge+fabric" = _uE1IpYIR;
        "pkg-1.19.2-4.3-forge+fabric" = _5o1H17YL;
        "pkg-1.19.3-4.3-forge+fabric" = _zQaSjsXC;
        "pkg-1.18.2-4.4-forge+fabric" = _pMC1D1S6;
        "pkg-1.19.2-4.4-forge+fabric" = _Dv3IdFaR;
        "pkg-1.19.3-4.4-forge+fabric" = _AluVqjP1;
        "pkg-1.18.2-4.5-forge+fabric" = _x8joF98U;
        "pkg-1.19.2-4.5-forge+fabric" = _qIRwsGjm;
        "pkg-1.19.3-4.5-forge+fabric" = _5GzifXEr;
        "pkg-1.19.4-4.5-forge+fabric" = _koSEBEJN;
        "pkg-1.20-4.5-forge+fabric" = _i4vnRwZ9;
        "pkg-1.20.1-4.5-forge+fabric" = _jVeTO9sG;
        "pkg-1.18.2-5.0-forge+fabric" = _4Gl2grdz;
        "pkg-1.19.2-5.0-forge+fabric" = _VYzuL8wR;
        "pkg-1.19.4-5.0-forge+fabric" = _tc0qEExa;
        "pkg-1.20.1-5.0-forge+fabric" = _Ng9ISXia;
        "pkg-1.20.2-5.0-forge+fabric" = _DGSz62su;
        "pkg-1.18.2-5.1-forge+fabric" = _gD1pxTeg;
        "pkg-1.19.2-5.1-forge+fabric" = _T56W4nwq;
        "pkg-1.20.1-5.1-forge+fabric" = _m26JddLH;
        "pkg-1.20.2-5.1-forge+fabric" = _PYWSGxBg;
        "pkg-1.20.3-5.1-fabric+forge+neo" = _cOJlU2VV;
        "pkg-1.20.4-5.1-fabric+forge+neo" = _Svpi9MVy;
        "pkg-1.19.2-5.2-fabric+forge+neo" = _2P1hF8zC;
        "pkg-1.20.1-5.2-fabric+forge+neo" = _lVOR7EbI;
        "pkg-1.20.2-5.2-fabric+forge+neo" = _sI6nU1bI;
        "pkg-1.20.4-5.2-fabric+forge+neo" = _JgZWUQzs;
        "pkg-1.19.2-5.3-fabric+forge" = _4mNaY7Dm;
        "pkg-1.20.1-5.3-fabric+forge+neo" = _NtXNTPiD;
        "pkg-1.20.4-5.3-fabric+forge+neo" = _dIGF22CF;
        "pkg-1.19.2-5.4-fabric+forge" = _4GaDmDF5;
        "pkg-1.20.1-5.4-fabric+forge+neo" = _jQ5ZvTEg;
        "pkg-1.20.4-5.4-fabric+forge+neo" = _sW02ma9K;
        "pkg-1.19.2-5.5-fabric+forge" = _vRq35kRk;
        "pkg-1.20.1-5.5-fabric+forge+neo" = _sMh3ix8W;
        "pkg-1.20.4-5.5-fabric+forge+neo" = _zcGJKmD1;
        "pkg-1.20.5-5.5-fabric+neo" = _T5ELSHkr;
        "pkg-1.20.6-5.5-fabric+forge+neo" = _v33tCYzi;
        "pkg-1.20.6-5.6-fabric+forge+neo" = _iSrhkPRf;
        "pkg-1.19.2-5.7-fabric+forge" = _IX1EaUNx;
        "pkg-1.20.1-5.7-fabric+forge+neo" = _noOLikKt;
        "pkg-1.20.4-5.7-fabric+forge+neo" = _LnSdDS0F;
        "pkg-1.20.6-5.7-fabric+forge+neo" = _b1xhLTE3;
        "pkg-1.20.4-5.8-fabric+forge+neo" = _xY8NOS7J;
        "pkg-1.21.0-5.8-fabric+forge+neo" = _G2Uykn6q;
        "pkg-1.20.1-5.9-fabric+forge+neo" = _K8M8C81n;
        "pkg-1.20.6-5.9-fabric+forge+neo" = _j7t5kHw4;
        "pkg-1.21.0-5.9-fabric+forge+neo" = _D0X7OyKI;
        "pkg-1.21.1-5.9-fabric+forge+neo" = _r73PhzrG;
        "pkg-1.21.2-5.9-fabric+neo" = _TfsalLjm;
        "pkg-1.21.3-5.9-fabric+forge+neo" = _dIirqczO;
        "pkg-1.21.3-6.0-fabric+forge+neo" = _uffy2ryy;
        "pkg-1.21.4-6.0-fabric+forge+neo" = _nBTIX00E;
        "pkg-1.20.1-6.1-fabric+forge+neo" = _nBGjZdHy;
        "pkg-1.21.1-6.1-fabric+forge+neo" = _25hjsLNj;
        "pkg-1.21.4-6.1-fabric+forge+neo" = _MNU46Ivy;
        "pkg-1.20.1-6.2-fabric+forge+neo" = _YsYb9yPB;
        "pkg-1.21.1-6.2-fabric+forge+neo" = _1wY4fUc8;
        "pkg-1.21.4-6.2-fabric+forge+neo" = _C1GBYCRZ;
        "pkg-1.21.5-6.2-fabric+forge+neo" = _rGbyCR52;
        "pkg-1.20.1-7.0-fabric+forge+neo" = _GX8u7Pre;
        "pkg-1.21.1-7.0-fabric+forge+neo" = _JdFryWlZ;
        "pkg-1.21.4-7.0-fabric+forge+neo" = _oqgL7jds;
        "pkg-1.21.5-7.0-fabric+forge+neo" = _1gYbfoqD;
        "pkg-1.21.6-7.0-fabric+forge+neo" = _5IcgvJ6y;
        "pkg-1.21.7-7.0-fabric+forge+neo" = _hGYp81FB;
        "pkg-1.20.1-7.1-fabric+forge+neo" = _F3Sryqc5;
        "pkg-1.21.1-7.1-fabric+forge+neo" = _jkV7br3s;
        "pkg-1.21.7-7.1-fabric+forge+neo" = _Wc0EITYd;
        "pkg-1.21.8-7.1-fabric+forge+neo" = _Kaxph4k0;
        "pkg-1.21.9-7.1-fabric+forge+neo" = _rF5mEQxo;
        "pkg-1.21.10-7.1-fabric+forge+neo" = _tWEDx2bG;
        "pkg-1.20.1-7.2-fabric+forge+neo" = _JxWWE54a;
        "pkg-1.21.1-7.2-fabric+forge+neo" = _KgGapm4H;
        "pkg-1.21.10-7.2-fabric+forge+neo" = _qeyO89wf;
        "pkg-1.21.11-7.2-fabric+forge+neo" = _roVanbyg;
        "pkg-26.1.0-7.2-fabric+forge+neo" = _6FWS4jFL;
        "pkg-26.1.1-7.2-fabric+forge+neo" = _wr7KbgAV;
        "pkg-26.1.2-7.2-fabric+forge+neo" = _ut99SKb6;
        "pkg-26.2.0-7.2-fabric+forge+neo" = _uiANFlUz;
        "default" = _uiANFlUz;
    });
