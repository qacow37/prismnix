...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _98wBEsfk;
        "pkg-1.0.9" = _1r0lT5m4;
        "pkg-1.0.10" = _OKEW3vwf;
        "pkg-1.0.11" = _13eGyWVl;
        "pkg-2.0.0" = _69oS3krK;
        "pkg-2.1.0+1.20" = _tM9oqRQv;
        "pkg-2.1.0+1.20.2" = _nUHRBFUw;
        "pkg-2.1.0+1.20.3" = _t8OTjNZJ;
        "pkg-2.1.0+1.20.5" = _UXIA5rkQ;
        "pkg-2.1.0+1.21" = _DGgCbnjC;
        "pkg-2.1.0+1.21.2" = _MJmeq7hx;
        "pkg-2.1.0+1.21.4" = _6JwXeLYG;
