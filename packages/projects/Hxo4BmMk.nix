...
let
    ...
    in {
        ...
        "pkg-2.0+1.20.5-1.21.1" = _xYf1CIhu;
        "pkg-2.0+1.21.2-1.21.4" = _ZxHVIrVu;
        "pkg-2.0+1.20-1.20.4" = _TvNbUfhX;
        "pkg-2.0+1.19.3-1.19.4" = _eJL5HaLd;
        "pkg-3.0+1.20-1.20.4" = _AGT4RgpV;
        "pkg-3.0+1.21.2-1.21.4" = _vdsbn0BG;
        "pkg-3.0+1.20.5-1.21.1" = _9IqqRp6r;
        "pkg-3.0+1.19.3-1.19.4" = _c8OvJhbK;
        "pkg-3.1+1.21.2-1.21.4" = _i1l5K2vU;
        "pkg-3.2+1.21.2-1.21.4" = _ZqK8CrM6;
        "pkg-4.0+1.19.3-1.19.4" = _EkJW8M2O;
        "pkg-4.0+1.20.5-1.21.1" = _YQMD7CIs;
        "pkg-4.0+1.20-1.20.4" = _nc1PKFZE;
        "pkg-4.0+1.21.2-1.21.4" = _BcpAIhoN;
        "pkg-4.0+1.21.5" = _rU42Z0wH;
        "pkg-4.0+1.21.6-1.21.8" = _7uzt5LH5;
        "pkg-4.0+1.21.6-1.21.11" = _34OJNL2O;
        "pkg-5.0+1.19.3-1.19.4" = _HkEgLFkd;
        "pkg-5.0+1.20-1.20.4" = _u0KqoMgB;
        "pkg-5.0+1.20.5-1.21.1" = _aVtdt4G5;
        "pkg-5.0+1.21.2-1.21.4" = _saf0jP0I;
        "pkg-5.0+1.21.5" = _GtLd3J2x;
        "pkg-5.0+1.21.6-1.21.11" = _1UnVMP2d;
        "pkg-5.1+1.20.5-1.20.6" = _ZjedUvbu;
        "pkg-5.1+1.21-1.21.1" = _3Anad0uh;
        "pkg-5.0+26.1" = _IHELt54l;
        "default" = _IHELt54l;
    });
