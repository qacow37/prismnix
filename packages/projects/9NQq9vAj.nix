...
let
    ...
    in {
        ...
        "pkg-3.1" = _GsD506Qf;
        "pkg-1.0.1" = _vDByCQtZ;
        "pkg-1.0.1-forge-1.20.6" = _YirA1KUw;
        "pkg-1.0.2-forge-1.21" = _kPNjYNlO;
        "pkg-1.0.2-forge-1.21.1" = _yIQkhH8J;
        "pkg-3.2-forge-1.21.3" = _hMpraJLI;
        "pkg-1.0.2-forge-1.21.5" = _PacuUBnn;
        "pkg-3.2-forge-1.21.6" = _RuXRzbis;
        "pkg-1.0.2-forge-1.21.7" = _q8jaKsYr;
        "pkg-1.0.3" = _3npMWgGD;
        "pkg-3.2.1" = _UNkHSRW7;
        "pkg-3.2.2" = _EoGBzyvD;
        "pkg-3.2.4" = _k6DemuZJ;
