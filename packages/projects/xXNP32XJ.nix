...
let
    ...
    in {
        ...
        "pkg-1.2.5" = _UpsToi4g;
        "pkg-1.2.6" = _Fc39LzZh;
        "pkg-1.2.6-1.19.2" = _p5wCKglx;
        "pkg-1.2.7" = _TdslfKZL;
        "pkg-1.20-1.3.0" = _BGq1O1Iw;
        "pkg-1.19.4-1.2.8" = _Hb3G3VvO;
        "pkg-1.19.4-1.2.9" = _ZjoYQyX4;
        "pkg-1.2.7-1.19.2" = _MLNUj0rJ;
        "pkg-1.20-1.3.1" = _5vOiYBwb;
        "pkg-1.20.2-1.3.2" = _8rhIBwUq;
        "pkg-1.20-1.3.2" = _qA1B7dwq;
        "pkg-1.20.2-1.3.3" = _wI1l3MTw;
        "pkg-2.0.0-1.20.4" = _npkLHNKB;
        "pkg-1.20-1.3.3" = _aPalBuTF;
        "pkg-2.0.1" = _Gb1WfAJ0;
        "pkg-1.20.1-1.3.4" = _bVjROvyb;
        "pkg-2.2.0" = _i5lSFIrp;
        "pkg-1.20.1-1.3.5" = _TGFN39mu;
        "pkg-2.2.1" = _2W03jZb8;
        "pkg-2.3.0" = _wVXruy3T;
        "pkg-2.3.1" = _PVktbRbc;
        "pkg-3.0.0" = _5xQOriRF;
