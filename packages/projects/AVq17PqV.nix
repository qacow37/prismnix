...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _6LsBcPWG;
        "pkg-v5.0.0-1.19.3-Fabric" = _yycbOJ6B;
        "pkg-v5.0.0-1.19.3-Forge" = _p0AHyxv9;
        "pkg-v6.0.0-1.19.4-Fabric" = _KPUKs0oK;
        "pkg-v6.0.0-1.19.4-Forge" = _xsldiOeQ;
        "pkg-v7.0.0-1.20-Forge" = _Ed60tNZQ;
        "pkg-v7.0.0-1.20-Fabric" = _A3QLfjmK;
        "pkg-v8.0.0-1.20.1-Forge" = _slScQFdb;
        "pkg-v8.0.0-1.20.1-Fabric" = _I6xyij66;
        "pkg-v3.0.0-1.18.2-Forge" = _Ixbup4pf;
        "pkg-v3.0.0-1.18.2-Fabric" = _aCHNt9MS;
        "pkg-v20.4.0-1.20.4-Fabric" = _fSg7kLcG;
        "pkg-v20.4.0-1.20.4-Forge" = _8z3WEklI;
        "pkg-v20.4.0-1.20.4-NeoForge" = _MfRpyraZ;
        "pkg-v20.4.1-1.20.4-Fabric" = _vosgBua4;
        "pkg-v20.4.1-1.20.4-Forge" = _yWnEHVMP;
        "pkg-v20.4.1-1.20.4-NeoForge" = _aVD0nAJ4;
        "pkg-v21.0.0-1.21-Fabric" = _r96FcZia;
        "pkg-v21.0.0-1.21-NeoForge" = _gOtCosqt;
        "pkg-v21.1.0-1.21.1-Fabric" = _QPhlCsMN;
        "pkg-v21.1.0-1.21.1-NeoForge" = _TOHEOE2X;
        "pkg-v21.3.0-1.21.3-Fabric" = _a3mkIjn5;
        "pkg-v21.3.0-1.21.3-NeoForge" = _YkNCe1bK;
        "pkg-v21.3.1-1.21.3-Fabric" = _EqdF5xys;
        "pkg-v21.3.1-1.21.3-NeoForge" = _so3xJ7AF;
        "pkg-v21.4.0-1.21.4-Fabric" = _rzQ6Hrtt;
        "pkg-v21.4.0-1.21.4-NeoForge" = _g684aRNf;
        "pkg-v21.4.1-1.21.4-Fabric" = _DCgJGeg5;
        "pkg-v21.4.1-1.21.4-NeoForge" = _GAdn9fgD;
        "pkg-v21.5.0-1.21.5-Fabric" = _SeiDEibz;
        "pkg-v21.5.0-1.21.5-NeoForge" = _Xif4BhoS;
        "pkg-v21.4.2-1.21.4-Fabric" = _DKmPMw2R;
        "pkg-v21.4.2-1.21.4-NeoForge" = _ABvo1Tgy;
        "pkg-v21.5.1-1.21.5-Fabric" = _PTO2KHVS;
        "pkg-v21.5.1-1.21.5-NeoForge" = _uJQBfMws;
        "pkg-v21.4.3-1.21.4-Fabric" = _8fE8f5kT;
        "pkg-v21.4.3-1.21.4-NeoForge" = _atYAN7Cg;
        "pkg-v21.5.2-1.21.5-Fabric" = _hReXJP82;
        "pkg-v21.5.2-1.21.5-NeoForge" = _H4T0Y7Sv;
        "pkg-v21.6.0-1.21.6-Fabric" = _TqDctVFe;
        "pkg-v21.6.0-1.21.6-NeoForge" = _y1QVVcqQ;
        "pkg-v21.7.0-1.21.7-Fabric" = _SaqXbVWh;
        "pkg-v21.7.0-1.21.7-NeoForge" = _c9WKq0eb;
        "pkg-v21.8.0-1.21.8-Fabric" = _mOo6anJy;
        "pkg-v21.8.0-1.21.8-NeoForge" = _3Q27JsjO;
        "pkg-21.9.0" = _B3lXH4B3;
        "pkg-21.10.0" = _VCilAtzo;
        "pkg-21.11.0" = _RhFHpbMN;
        "pkg-v21.1.1-1.21.1-Fabric" = _hYZEEekT;
