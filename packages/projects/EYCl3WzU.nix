...
let
    ...
    in {
        ...
        "pkg-v.1.1.0+mod" = _EFDh9hg4;
        "pkg-v2.0.0" = _If7S0tvl;
        "pkg-v2.0.0+mod" = _3vwkfwLr;
        "pkg-v2.1.0" = _zaUlcDox;
        "pkg-v2.1.0+mod" = _Q9JsELHa;
        "pkg-v2.1.1+1.21.6+" = _AKQ1IezB;
        "pkg-v2.1.1+1.21.6++mod" = _olvVBTpj;
        "pkg-v2.1.2" = _mNxlNpBU;
