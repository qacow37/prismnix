...
let
    ...
    in {
        ...
        "pkg-1.0.0.6" = _sFikvicy;
        "pkg-1.0.0.7" = _kugdx752;
        "pkg-1.0.0.8" = _VKp7NSZq;
        "pkg-1.0.0.9" = _cB4KSXRZ;
        "pkg-1.0.0.12" = _jwS2Nukk;
        "pkg-1.0.0.13" = _VFNqyPLH;
        "pkg-1.0.0.14" = _HZrLbyTr;
        "pkg-1.0.0.15" = _8ZX4ECSV;
        "pkg-1.0.0.16" = _j7aLHcFF;
        "pkg-1.0.0.17" = _MVS3rLDT;
        "pkg-1.0.0.18" = _uVyttWLa;
        "pkg-1.0.0.19" = _rMfBpilR;
        "pkg-1.0.0.20" = _2eJbbIhI;
        "pkg-1.0.0.21" = _22ptusCG;
        "pkg-1.0.0.22" = _Cvp0FpmP;
        "pkg-1.0.0.23" = _PJ4CkWV2;
        "pkg-1.0.0.24" = _o429M5Fv;
        "pkg-1.0.0.25" = _zVJqyZG2;
        "pkg-1.0.0.26" = _Jvk9wCkP;
        "pkg-1.0.0.27" = _Qiq60H5H;
        "pkg-1.0.0.28" = _n06NvAvK;
        "pkg-1.0.0.29" = _4IY2jQem;
        "pkg-1.0.0.30" = _KHzJFWEg;
        "pkg-1.0.0.31" = _R9lpQ0lZ;
        "pkg-1.0.0.32" = _yAxmq9nj;
        "pkg-1.0.0.33" = _BRcGOKlk;
        "pkg-1.0.0.34" = _kwB4v0ps;
        "pkg-1.0.0.36" = _jxAjzTD9;
        "pkg-1.0.0.37" = _3tgcKReG;
        "pkg-1.0.0.38" = _PcbbiCkg;
        "pkg-1.0.0.39" = _LTP2hp8q;
        "pkg-1.0.0.40" = _bTvRjNxI;
        "pkg-1.0.0.41" = _NHGklnzY;
        "pkg-1.0.0.42" = _ZlBrtbPg;
        "pkg-1.0.0.43" = _Ll5vLmjj;
        "pkg-1.0.0.44" = _C3gnx2Ue;
        "pkg-1.0.0.45" = _1Frmjab9;
        "pkg-1.0.0.46" = _Ohn0vSjV;
        "pkg-1.0.0.47" = _QGhqC18y;
        "pkg-1.0.0.48" = _nr3PWqBf;
        "pkg-1.0.0.49" = _YKwkaex1;
        "pkg-1.0.0.50" = _n7TVwVKO;
        "pkg-1.0.0.51" = _uvuvwq4q;
        "pkg-1.0.0.52" = _Dve3b1mN;
        "pkg-1.0.0.53" = _U38oBBdd;
        "pkg-1.0.0.54" = _F42tSWbZ;
        "pkg-1.0.0.55" = _Am8V8plb;
        "pkg-1.0.0.56" = _ptuT8GgU;
        "pkg-1.0.0.57" = _AQuzGhQA;
        "pkg-1.0.0.58" = _9OIs33s2;
        "pkg-1.0.0.59" = _OdIJPwzd;
        "pkg-1.1.0.1" = _DMsVegmA;
        "pkg-1.1.0.2" = _CrSumZLW;
        "pkg-1.1.0.3" = _uCDDXGQE;
        "pkg-1.1.0.4" = _CfQ5iObj;
        "pkg-1.1.0.5" = _EfCFzC93;
        "pkg-1.1.0.6" = _8m2MZXXr;
        "pkg-1.1.0.7" = _CTmWdiZh;
        "pkg-1.1.0.8" = _r7RBM2vn;
        "pkg-1.1.0.9" = _IC6XLkAa;
        "pkg-1.1.0.10" = _MC3MbOsf;
        "pkg-2.0.0.0" = _W2MMId4W;
        "pkg-2.0.0.1" = _2WNlbRbv;
        "pkg-2.0.0.2" = _VKGMDlck;
        "pkg-2.0.0.3" = _2zGz6n4Q;
        "pkg-2.0.0.4" = _TfboZElN;
        "pkg-2.0.0.5" = _4leas2C8;
        "pkg-2.1.0.0" = _8wmCpbQ2;
        "pkg-1.0.0.60" = _WDjq6fqy;
        "pkg-0.01.0" = _lMU0lrWc;
        "pkg-0.0.1.0" = _bCDl02BW;
        "pkg-0.0.1.1" = _25HLOiOl;
        "pkg-2.2.0.0" = _ybcowyxb;
        "pkg-2.2.0.1" = _jSwoLPgg;
        "pkg-2.2.0.2" = _ZwLQiDEN;
        "pkg-2.2.0.3" = _Rx9H4ma9;
        "pkg-2.2.0.4" = _EdHBnkAZ;
        "pkg-2.2.0.5" = _WT3yZtYB;
        "pkg-2.2.0.6" = _de0wRZuA;
        "pkg-2.3.0.0" = _7HWAJwDO;
        "pkg-2.3.0.1" = _319jwnHx;
        "pkg-2.3.0.3" = _YwYXK4j2;
        "pkg-2.3.0.4" = _gBxcKjMS;
        "pkg-2.5.0.0" = _VJjnQQbF;
        "pkg-2.5.0.1" = _HQmM6EmT;
        "pkg-2.5.0.2" = _jNrLNHp6;
        "pkg-2.6.0.0" = _9OmBZc5Q;
        "pkg-2.6.0.1" = _yYigzTn8;
        "pkg-2.6.0.2" = _ovOp2ZXe;
        "pkg-2.6.0.3" = _xGtX2W15;
        "pkg-2.6.0.4" = _gZ5tcsEa;
        "pkg-2.6.0.5" = _uac4Zk8Z;
        "pkg-2.6.0.6" = _flAgQuHx;
        "pkg-21.7.0.0" = _ii4uvqS9;
        "pkg-21.7.0.1" = _5pOkw6Bq;
        "pkg-21.8.0.0" = _fUSCQ5xZ;
        "pkg-21.8.0.1" = _lTMZijP5;
        "pkg-21.9.0.0" = _10ob5gWR;
        "pkg-21.9.0.1" = _UE8n31HD;
        "pkg-21.9.0.2" = _M0gMRYW2;
        "pkg-21.10.0.0" = _7DPiyeMO;
        "pkg-21.9.0.3" = _SwHuEAfw;
        "pkg-21.10.0.1" = _oet1RKSP;
        "pkg-21.10.0.2" = _ebzLmGB6;
        "pkg-21.10.0.3" = _aIsNxLhq;
        "pkg-21.10.0.4" = _PuK3AwMh;
        "pkg-21.11.0.1" = _iCvnRMAK;
        "pkg-21.11.0.2" = _pDCgiPQN;
        "pkg-1.10.2-1.0.0" = _QvGB0LrH;
        "pkg-21.11.0.3" = _7aA3iJLE;
        "pkg-21.11.0.4" = _6dbbrOrO;
        "pkg-26.1.0.1" = _MUGYUsPG;
        "pkg-26.1.0.2" = _N3BWWonL;
        "pkg-26.1.1.0" = _sP36V3hF;
        "pkg-26.1.0.3" = _CamVyZMB;
        "pkg-26.1.1.0.0" = _fY6WOZQu;
        "pkg-26.1.0.4" = _qrM40AlT;
        "pkg-26.1.1.0.1" = _uRLGrPY7;
        "pkg-26.1.1.0.2" = _5thDPpYV;
        "pkg-26.1.1.0.3" = _fT3JDHYe;
        "pkg-26.1.1.0.4" = _rDnHpOiO;
        "pkg-26.1.1.0.5" = _ZyZbLq9P;
        "pkg-26.1.1.0.6" = _wUGQRAzh;
        "pkg-26.1.2.0.0" = _sIqUGbT4;
        "pkg-26.1.2.0.2" = _uyFrxu03;
        "pkg-26.1.1.0.7" = _PuZhTaE9;
