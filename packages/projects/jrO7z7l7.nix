...
let
    ...
    in {
        ...
        "pkg-3.9b3" = _7vKkaXxq;
        "pkg-3.9b4" = _tKc0vq53;
        "pkg-3.9u12" = _NRWrMnI1;
        "pkg-3.9u14" = _HnlvOvPw;
        "pkg-3.9u15" = _O6EJXM18;
        "pkg-3.9u16" = _4iMl4feQ;
        "pkg-3.9u17" = _xOqpVbCc;
        "pkg-3.9u18" = _kTdNKPXa;
        "pkg-3.9u19" = _I1tvFTsl;
        "pkg-3.9u20" = _RxVHGUk1;
        "pkg-3.9u21" = _weIgYUz2;
        "pkg-3.9u22" = _sQbAzZcA;
        "pkg-3.10" = _yUQBLm0M;
        "pkg-3.10.1" = _zPpMqokI;
        "pkg-3.10.2" = _WMDUepMG;
        "pkg-3.10.3" = _dXoWJmgm;
        "pkg-3.10.5" = _ZnLSm3c6;
        "pkg-3.10.6" = _do8QvJuY;
        "pkg-3.10.7" = _Ra1UEPUZ;
        "pkg-3.10.8" = _fJsME5Mf;
        "pkg-3.10.9" = _XBc0nuNW;
        "pkg-5.0.0-beta-01" = _wfXvQ1IG;
        "pkg-5.0.0-beta-02" = _DqqVzSzQ;
        "pkg-3.10.10" = _IvQ0Z7QR;
        "pkg-5.0.0-beta-03" = _7yjcMVl0;
        "pkg-3.10.11" = _cNyiEJ2p;
        "pkg-3.10.12" = _dfwPYoIv;
        "pkg-5.0.0-beta-04" = _KiMQgPhT;
        "pkg-3.10.13" = _6kl3GQSJ;
        "pkg-5.0.0-beta-05" = _5NcWuiCT;
        "default" = _5NcWuiCT;
    });
