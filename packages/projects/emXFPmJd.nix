...
let
    ...
    in {
        ...
        "pkg-1.12.0" = _WjtfOSVw;
        "pkg-v1.12.1" = _nkXb8VU6;
        "pkg-v1.11.1" = _4QkFw58D;
        "pkg-v1.12.2" = _Mgv9NRXM;
        "pkg-v1.11.2" = _n6iXeq4k;
        "pkg-v1.11.3" = _3mQ0BSF2;
        "pkg-v1.12.3" = _UwE0um6r;
        "pkg-v1.11.4" = _XqAemxD4;
        "pkg-v1.12.4" = _TTnozCqe;
        "pkg-v1.11.5" = _dkiXBtUL;
        "pkg-v1.12.5" = _22ygIL4E;
        "pkg-v1.11.6" = _rfgh4tHb;
        "pkg-v1.12.6" = _VLdGxg2p;
        "pkg-1.12.7" = _dImYsLow;
        "pkg-1.11.7" = _DZLrtTjq;
        "pkg-v1.12.8" = _qXuYARda;
        "pkg-1.12.9" = _ovH3igNz;
        "pkg-1.12.10" = _6RtkwXxE;
        "pkg-1.12.11" = _hwXLbrTC;
        "pkg-1.13.1" = _7fTLwHot;
        "pkg-1.13.2" = _pUU2JtUM;
        "pkg-1.14.0" = _wB5OwOA3;
        "pkg-1.15.0" = _Ol4juqaJ;
        "pkg-1.15.1" = _gMztAlv5;
        "pkg-1.15.2" = _1UqTBkHo;
        "pkg-1.16.0" = _8TH3gcGW;
        "pkg-1.16.1" = _UHitnuT9;
        "pkg-1.16.2" = _qxghThH0;
        "pkg-1.16.3" = _cTOjoLz3;
        "pkg-1.16.4" = _UGRkjXxG;
        "pkg-1.19.0" = _C6E0zyVM;
        "pkg-1.22.0" = _vjkT9jPZ;
        "pkg-1.23.0" = _rQ2gIFTu;
        "default" = _rQ2gIFTu;
    });
