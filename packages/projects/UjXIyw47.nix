...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.1-fabric" = _zFO8e7wM;
        "pkg-1.18.2-2.1-fabric" = _zAwwPQ51;
        "pkg-1.19.2-2.3-fabric" = _IeM9S5Tw;
        "pkg-1.16.5-1.7-forge" = _XsxJXK2n;
        "pkg-1.18.2-1.8-forge" = _QwlTKV60;
        "pkg-1.19.2-2.0-forge" = _ndqAka2J;
        "pkg-1.16.5-2.4-fabric" = _x8jPV8fi;
        "pkg-1.18.2-2.4-fabric" = _yk6oxoj6;
        "pkg-1.19.2-2.4-fabric" = _CDpfYHdi;
        "pkg-1.19.3-2.5-fabric" = _eL7bHnHJ;
        "pkg-1.19.3-2.0-forge" = _X0pJhHGs;
        "pkg-1.18.2-3.0-forge+fabric" = _cy7Peoog;
        "pkg-1.19.2-3.0-forge+fabric" = _7ki1APHm;
        "pkg-1.19.3-3.0-forge+fabric" = _2DWcg4Bw;
        "pkg-1.18.2-3.1-forge+fabric" = _hAxGpME0;
        "pkg-1.19.2-3.1-forge+fabric" = _VDo4hxJS;
        "pkg-1.19.3-3.1-forge+fabric" = _oJQCCfSG;
        "pkg-1.19.4-3.1-forge+fabric" = _C8i6rUyR;
        "pkg-1.20-3.1-forge+fabric" = _WyrDoLke;
        "pkg-1.20.1-3.1-forge+fabric" = _yIWEGt2U;
        "pkg-1.20.2-3.1-forge+fabric" = _ycEoZYfe;
        "pkg-1.18.2-3.2-forge+fabric" = _zFrpQMw1;
        "pkg-1.19.2-3.2-forge+fabric" = _vCRZzGWs;
        "pkg-1.20.1-3.2-forge+fabric" = _fSDztskq;
        "pkg-1.20.2-3.2-forge+fabric" = _WEUwAkaO;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _ASVLBAKR;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _Z8UiBPK4;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _nDp6glu3;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _8KdgGo3u;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _rgu59rCE;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _tiKbTdMQ;
        "pkg-1.20.5-3.3-fabric+neo" = _ZXGOM5BM;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _uKw6SaNB;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _vuUkWyf3;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _U1qhDmiO;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _HsDYYocW;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _BuuYTfk5;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _Q021BaQZ;
        "pkg-1.21.2-3.4-fabric+neo" = _REV0GkFY;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _GYGGSLPt;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _utGUTSA2;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _89tfEaAo;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _jBF1zfoq;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _eDJJxdh4;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _yCOg6wiT;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _O8CXC7k0;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _ZB5OTBTy;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _MI16YBtj;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _duYGkd9m;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _sn6DNtG1;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _1ERVbRKh;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _iZoTv7Bw;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _3qbyyrHc;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _UCBMX9BN;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _ZrssKY5R;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _mzY8Qbcg;
        "default" = _mzY8Qbcg;
    });
