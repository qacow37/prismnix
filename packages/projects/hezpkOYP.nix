...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0" = _ZbaGybTa;
        "pkg-1.19.2-1.0" = _AgpVRlbU;
        "pkg-1.20.1-1.0" = _1X9MjEZs;
        "pkg-1.18.2-1.1" = _74J279S6;
        "pkg-1.19.2-1.1" = _x2jbtSTC;
        "pkg-1.20.1-1.1" = _Mpdh26O7;
        "pkg-1.18.2-1.1-ht1" = _G0xwh5n5;
        "pkg-1.19.2-1.1-ht1" = _EPMBlCEl;
        "pkg-1.20.1-1.1-ht1" = _va8f6cYU;
        "pkg-1.20.1-1.1-ht2" = _iArhniwl;
        "pkg-1.18.2-1.2" = _TiPvR7A5;
        "pkg-1.19.2-1.2" = _bYNnWVsM;
        "pkg-1.20.1-1.2" = _pcsnnrac;
        "pkg-1.3.0" = _LMvbUWqX;
        "pkg-1.3.1" = _9VOKkrgw;
        "pkg-1.4" = _ku3EQFJL;
        "pkg-1.5" = _DkMD60CK;
        "pkg-1.5-ht1" = _mOuweUJi;
        "pkg-1.5.1" = _moQvefbx;
        "pkg-1.5.1-ht1" = _nQiiwOe1;
        "pkg-1.5.1-fix2" = _PJgRfPeG;
        "pkg-1.6.0" = _CyXHuAHg;
        "pkg-1.6.1" = _JnOW4dwG;
        "pkg-1.6.1-fix1" = _cIPNkUvF;
        "pkg-1.6.2" = _lmxRNvoP;
        "pkg-1.6.2-fix1" = _wo3jBGc9;
        "pkg-1.6.2-fix2" = _dtIW5G0Y;
        "pkg-1.6.3" = _zLIzQNMv;
        "pkg-1.6.3-fix1" = _S6xZzbRg;
        "default" = _S6xZzbRg;
    });
