...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _mqVXpa5F;
        "pkg-1.18.2-2.0-fabric" = _KXBdOGcF;
        "pkg-1.19.2-2.1-fabric" = _CZ6a6JZh;
        "pkg-1.16.5-1.6-forge" = _JYCxmL4H;
        "pkg-1.18.2-1.7-forge" = _kGo6IRYc;
        "pkg-1.19.2-1.9-forge" = _5s0lsiMP;
        "pkg-1.16.5-2.2-fabric" = _kHL9ecoz;
        "pkg-1.18.2-2.2-fabric" = _xgtMIKPN;
        "pkg-1.19.2-2.2-fabric" = _DT4lBNIV;
        "pkg-1.19.3-2.3-fabric" = _iVdGC6pk;
        "pkg-1.19.3-1.9-forge" = _ffuuRb6I;
        "pkg-1.18.2-3.0-forge+fabric" = _iTVhKVq8;
        "pkg-1.19.2-3.0-forge+fabric" = _EHXrUb32;
        "pkg-1.19.3-3.0-forge+fabric" = _ZHvyZGxa;
        "pkg-1.19.4-3.0-forge+fabric" = _BrpAAtMy;
        "pkg-1.20-3.0-forge+fabric" = _1rb8fsGA;
        "pkg-1.20.1-3.0-forge+fabric" = _uBkjvhko;
        "pkg-1.20.2-3.0-forge+fabric" = _cbCBj72c;
        "pkg-1.18.2-3.1-forge+fabric" = _LGxw37vf;
        "pkg-1.19.2-3.1-forge+fabric" = _Z6axpXim;
        "pkg-1.20.1-3.1-forge+fabric" = _T7KU0Wlh;
        "pkg-1.20.2-3.1-forge+fabric" = _sa031p3M;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _whhftGxN;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _CMDsUqt5;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _ISTTEmiG;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _9MiCHl44;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _35zXC4Ek;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _aWpq2Tyb;
        "pkg-1.19.2-3.3-fabric+forge" = _wuglDGh5;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _edVYgkg1;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _LMrlwPG8;
        "pkg-1.20.5-3.3-fabric+neo" = _BjbF9l5d;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _vbWOnoZN;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _Euoomzzj;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _kcFYmEX9;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _d8bvXVd5;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _qN0p764b;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _u6VcIMGd;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _xepkCqju;
        "pkg-1.21.2-3.5-fabric+neo" = _ffPwJJrS;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _YYKV7irp;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _QAm6mAXK;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _4X7VTOIE;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _9SPiCWot;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _jVtjocUE;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _OKGtXUmr;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _dADx9N8H;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _JadQlIIJ;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _Wr2K8pCi;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _mgBXaDVI;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _GexQ94vL;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _K71c33xq;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _47ptLYNc;
        "pkg-26.1.0-3.7-fabric+forge+neo" = _PTNcMRqE;
        "pkg-26.1.1-3.7-fabric+forge+neo" = _DOG6t9c4;
        "pkg-26.1.2-3.7-fabric+forge+neo" = _1cn0ZDZR;
        "pkg-1.20.1-3.8-fabric+forge+neo" = _2poDkvG0;
        "pkg-1.21.1-3.8-fabric+forge+neo" = _8lmM7k5i;
        "pkg-1.21.11-3.8-fabric+forge+neo" = _gRtEYehq;
        "pkg-26.1.2-3.8-fabric+forge+neo" = _2cOqQElF;
        "pkg-1.20.1-3.9-fabric+forge+neo" = _6xdtWdBv;
        "pkg-1.21.1-3.9-fabric+forge+neo" = _BT6HIdIf;
        "pkg-1.21.11-3.9-fabric+forge+neo" = _65IqJqEq;
        "pkg-26.1.2-3.9-fabric+forge+neo" = _i0usdr6q;
        "pkg-26.2.0-3.9-fabric+forge+neo" = _QvntyzYq;
        "default" = _QvntyzYq;
    });
