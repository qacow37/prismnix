...
let
    ...
    in {
        ...
        "pkg-3.4.1" = _6xV0guiO;
        "pkg-3.4.2" = _dDZZdPoC;
        "pkg-3.5-DEV-b1" = _mAl4qajl;
        "pkg-3.5-RELEASE" = _bMrwflJd;
        "pkg-3.6-DEV-b1" = _F5389TFe;
        "pkg-3.6-DEV-b2" = _nZfc9Pm8;
        "pkg-3.5.1-RELEASE" = _qjiaEHyw;
        "pkg-3.6-RELEASE" = _B6NwBSk3;
        "pkg-3.6.0.1-RELEASE" = _NtLyAEPg;
        "pkg-3.7-DEV-b1" = _eE54gHqe;
        "pkg-3.7-DEV-b2" = _Lf3JJeUe;
        "pkg-3.7-RELEASE" = _PjVn4ftv;
        "pkg-3.8-DEV-b1" = _c6Eq5GFx;
        "pkg-3.8-RELEASE" = _wRP75qTC;
        "pkg-3.9-RELEASE" = _fLCHVCrM;
        "pkg-3.10-RELEASE" = _nrAliGxi;
        "pkg-3.10.1-RELEASE" = _ohKoszEg;
        "pkg-3.11-RELEASE" = _JSVRj3wz;
        "pkg-3.11.1-RELEASE" = _yOwv6nlX;
        "pkg-3.11.2-RELEASE" = _Lrg9BF6N;
        "pkg-3.12-RELEASE" = _7U0B3d9m;
        "pkg-3.12.1-RELEASE" = _KdjwrULs;
        "pkg-3.13-DEV-b1" = _Q0b0eoOM;
        "pkg-3.13-RELEASE" = _snDlrfTL;
        "pkg-3.13.1-RELEASE" = _9vNWVqLW;
        "pkg-3.14-DEV-b1" = _MRULgKz1;
        "pkg-3.14-DEV-b2" = _RwoJSSxn;
        "pkg-3.14-RELEASE" = _DbExIHg5;
        "pkg-3.15-DEV-b1" = _T4ONkukU;
        "pkg-3.15-DEV-b2" = _hTSJvnOC;
        "pkg-3.15-DEV-b3" = _EUCJUFaK;
        "pkg-3.15-RELEASE" = _71GNoVNj;
        "pkg-3.15.0.1-RELEASE" = _NliHJ5Uo;
        "pkg-3.16-DEV-b1" = _lQnaKGjR;
        "pkg-3.16-RELEASE" = _G1eCU6gD;
        "default" = _G1eCU6gD;
    });
