...
let
    ...
    in {
        ...
        "pkg-1.1-beta-aaah" = _GBvI7FlK;
        "pkg-1.1" = _HZK7PmWV;
        "pkg-1.2" = _zFKTt8XV;
        "pkg-1.3" = _7lUrCxC3;
        "pkg-1.4" = _N7pbjMUS;
        "pkg-1.5" = _nT1RWrhf;
        "pkg-1.5.1192" = _pn50SzM9;
        "pkg-1.5.1201" = _pKIDFvEc;
        "pkg-1.6" = _3KKlhhB4;
        "pkg-1.6.1192" = _E3DBa5GY;
        "pkg-1.6.1201" = _FOzlqJQT;
        "pkg-1.6.1206" = _igvbqv9W;
        "pkg-1.7" = _9GZASGYs;
        "pkg-1.7.1192" = _gS23wPdb;
        "pkg-1.7.1201" = _m00sTpsh;
        "pkg-1.7.1206" = _XZZHQBiW;
        "pkg-1.8" = _jJSL85vA;
        "pkg-1.8.1192" = _5RJQHqJK;
        "pkg-1.8.1194" = _lKb204Kh;
        "pkg-1.8.1201" = _nQTGAQez;
        "pkg-1.8.1206" = _uPoWsAZ4;
        "pkg-1.8.1211" = _CXprjEKg;
        "pkg-1.9" = _6jyDf3pg;
        "pkg-1.9.1192" = _S9oxU2CH;
        "pkg-1.9.1194" = _n4pohxPQ;
        "pkg-1.9.1201" = _X6UWgGmw;
        "default" = _X6UWgGmw;
    });
