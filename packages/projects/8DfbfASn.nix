...
let
    ...
    in {
        ...
        "pkg-1.17.1-2.1.47-fabric" = _88XWxvai;
        "pkg-1.16.5-2.1.47-forge" = _OGv8ukkd;
        "pkg-1.16.5-2.1.47-fabric" = _eZNSKma4;
        "pkg-1.17.1-2.1.48-fabric" = _xMeZujmc;
        "pkg-2.1.49" = _isE2BUF0;
        "pkg-1.18.1-2.1.49" = _QYXavI9s;
        "pkg-2.1.49b" = _ByhCzmMH;
        "pkg-1.18.2-2.1.50d-beta" = _hdhQE5ld;
        "pkg-1.19-2.1.51" = _Qtvjt3qS;
        "pkg-2.1.50" = _jSukFXIg;
        "pkg-1.19.2-2.1.51-forge" = _TZo1nfwz;
        "pkg-1.18.2-2.1.52" = _THcw6Yap;
        "pkg-2.1.52" = _wtEUJaeq;
        "pkg-1.19.2-2.1.53" = _uzVTTNfe;
        "pkg-1.19.2-2.1.54" = _tKxOjh70;
        "pkg-2.1.54-1.19.3" = _K99VHylj;
        "pkg-2.1.54-1.19.4" = _8URBsGlT;
        "pkg-2.1.56" = _hzihV1uA;
        "pkg-2.1.56-1.20.1" = _uFLIFUCI;
        "pkg-2.1.56-1.19.2" = _GDuhbEYT;
        "pkg-2.1.57-1.20.1" = _Vd5XOXlj;
        "pkg-2.1.60" = _y3YlWAEi;
        "pkg-2.1.64" = _lTNnufP5;
        "pkg-2.1.58-1.20.x" = _6hQpx5Tc;
        "pkg-2.1.67" = _yJwUbwwC;
        "pkg-2.1.68" = _g8oglmT0;
        "default" = _g8oglmT0;
    });
