...
let
    ...
    in {
        ...
        "pkg-2.0.1.5" = _uDwn4Gtx;
        "pkg-2.0.1.6" = _8SryX70J;
        "pkg-2.0.1.9" = _48F25SKp;
        "pkg-2.0.1.21" = _7IxD3wk0;
        "pkg-2.0.1.23" = _bc3HMboe;
        "pkg-2.0.1.29" = _jdzwcvcR;
        "pkg-2.0.2.39" = _EpW2UPYH;
        "pkg-2.1.2.42" = _DuDmR0wP;
        "pkg-2.2.3.58" = _1WY9ifoP;
        "pkg-2.4.1.101" = _UMZWn0vy;
        "pkg-2.4.2.106" = _GKEdjsSY;
        "pkg-2.4.3.124" = _IgHGNXEF;
        "pkg-2.4.3.145" = _XNZNvIDh;
        "pkg-2.5.0.178" = _KmRjVsAh;
        "pkg-2.5.1.185" = _KJ96AAvG;
        "pkg-2.5.2.198" = _6TdWe6jp;
        "pkg-2.5.2.213" = _nZnEO5ZW;
        "pkg-2.5.3.217" = _i1DaWndx;
        "pkg-2.5.4.218" = _Ml2Ug4xb;
        "pkg-2.5.6.224" = _5HOdf5WK;
        "pkg-2.5.6.233" = _dE9azoEE;
        "pkg-2.5.7.241" = _E1Jm9nBo;
        "pkg-2.6.0.254" = _j9g6Qnpg;
        "pkg-2.5.8.255" = _h8IrdCnX;
        "pkg-2.5.9.267" = _7F6U7ZNi;
        "pkg-2.7.0.268" = _YChjvoVr;
        "pkg-3.0.0.274" = _pvuOBiUT;
        "pkg-3.1.0.277" = _TkCOXpJE;
        "pkg-3.1.0.278" = _cYWS5FDL;
        "pkg-2.5.9.283" = _dvXadRxw;
        "pkg-3.0.0.284" = _9OIp8T8I;
        "pkg-3.1.1.288" = _sfW73H6o;
        "pkg-3.0.0.298" = _g0NSiRwr;
        "pkg-3.1.2.297" = _phOiveI3;
        "pkg-3.1.3.313" = _3UmQNxB6;
        "pkg-2.5.9.320" = _AqzqDL27;
        "pkg-3.0.0.328" = _d2hpDXDq;
        "pkg-3.1.5.331" = _nGver6Nn;
        "pkg-3.1.6.339" = _hNPwXrsM;
        "pkg-3.1.7.340" = _ilHp9iNB;
        "pkg-3.1.8.341" = _WmfuhZHj;
        "pkg-3.1.9.344" = _8nrGZ4sh;
        "pkg-3.2.0.345" = _jNFHomux;
        "pkg-3.2.1.349" = _1IvJ935O;
        "pkg-3.2.1.350" = _pC76gZS0;
        "pkg-3.2.1.351" = _4EELZUgU;
        "pkg-3.2.2.353" = _9887WDiv;
        "pkg-3.2.3.357" = _wqgEizdM;
        "pkg-3.2.3.358" = _QO8CBeNu;
        "pkg-3.3.0.373" = _unPQBpRG;
        "pkg-3.2.8.374" = _o4tUpGA4;
        "pkg-3.3.1.379" = _KqWy9pSU;
        "pkg-3.3.2.383" = _Q1nTB9YQ;
        "pkg-3.3.4.395" = _spXkE16l;
        "pkg-3.5.0.398" = _VyAZdnEO;
        "pkg-3.3.4.402" = _awV71xtC;
        "pkg-3.5.0.401" = _ggeFlzej;
        "pkg-3.5.1.408" = _k9eSIaEE;
        "pkg-3.3.5.407" = _diWbdjVY;
        "pkg-3.3.6.424" = _Am5IcyiC;
        "pkg-4.0.2.427" = _K2vWksWT;
        "pkg-4.0.2.429" = _8x3J90DC;
        "pkg-4.0.3.432" = _3M2PUYAo;
        "pkg-4.0.3.433" = _C1vmhbL7;
        "pkg-4.0.3.434" = _hrZXEbz6;
        "pkg-4.0.4.435" = _u4uWxF0e;
        "pkg-4.0.5.438" = _UkfsmlZI;
        "pkg-4.0.6.443" = _SwIMrpUR;
        "pkg-4.0.7.444" = _4oQfQTXt;
        "pkg-4.0.7.445" = _BqfOof5h;
        "pkg-4.1.0.460" = _CVkBGnJo;
        "pkg-4.1.0.461" = _bUu63zpl;
        "pkg-4.1.1.462" = _rIgFK1sw;
        "pkg-4.2.0.463" = _p00OeTxk;
        "pkg-4.2.2.468" = _MIvoWtLm;
        "pkg-4.3.0.469" = _fmoqmknQ;
        "pkg-4.3.0.470" = _N37iZFvN;
        "pkg-4.1.2.475" = _YUrjhC35;
        "pkg-4.1.3.480" = _M1aTcadm;
        "pkg-4.3.1.481" = _6FgATMD5;
        "pkg-4.1.4.488" = _DKyMgZwQ;
        "pkg-4.3.2.490" = _MoblXfOv;
        "pkg-4.4.0.509" = _en274HWr;
        "pkg-4.4.0.512" = _U68JIVpX;
        "pkg-4.4.0.516" = _pxajg7Ob;
        "pkg-4.5.0.517" = _4xAJvmwX;
        "pkg-4.6.0.519" = _2IkwwsuV;
        "pkg-4.6.0.520" = _ylNjvmS4;
        "pkg-4.6.0.521" = _tQEcfeph;
        "pkg-4.6.1.524" = _bX3ALK0X;
        "pkg-4.6.1.526" = _gQ1srSKh;
        "pkg-4.4.0.528" = _5zfJEMhM;
        "pkg-4.6.1.529" = _vLDGhjNJ;
        "default" = _vLDGhjNJ;
    });
