...
let
    ...
    in {
        ...
        "pkg-1.0.6-1.19.2" = _YqFNDEfc;
        "pkg-1.0.8-1.19.2" = _Q5etWZgl;
        "pkg-1.1.0-1.19.2" = _wNVDADcm;
        "pkg-1.1.1-1.19.2" = _NyyKKTDd;
        "pkg-1.1.3-1.19.2" = _pTxhkgiF;
        "pkg-1.1.5-1.19.2" = _xTnm39V1;
        "pkg-2.0.0-1.19.2" = _FELFaa28;
        "pkg-2.0.3-1.19.2" = _UctudgeQ;
        "pkg-2.0.4-1.19.2" = _qWIB5QL5;
        "pkg-2.0.6-1.19.2" = _lqodSpif;
        "pkg-2.0.7-1.19.2" = _U13rm5MM;
        "pkg-2.1.0-1.19.2" = _WkNJGg5w;
        "pkg-2.1.1-1.19.2" = _cXvA4nA2;
        "pkg-2.1.2-1.19.2" = _chOsOZ4W;
        "pkg-2.1.3-1.19.2" = _gUvkWUb8;
        "pkg-2.1.5-1.19.2" = _Pr78JOap;
        "pkg-2.1.6-1.19.2" = _4eDExE1z;
        "pkg-2.1.7-1.19.2" = _aw8TPBcn;
        "pkg-2.1.8-1.19.2" = _E4Onb2PN;
        "pkg-2.1.9-1.19.2" = _PTDacwgi;
        "pkg-2.1.10-1.19.2" = _Ji4KdXb2;
        "pkg-2.1.11-1.19.2" = _mlxgiqP4;
        "pkg-2.1.12-1.19.2" = _eSo6Mhn6;
        "pkg-2.1.13-1.19.2" = _so1ybWXZ;
        "pkg-2.1.14-1.19.2" = _NhOYoXVp;
        "pkg-2.1.15-1.19.2" = _6L6fZ6IG;
        "pkg-2.1.16-1.19.2" = _AvDakFXi;
        "pkg-3.1.3-1.20.4" = _L1VdpeZY;
        "pkg-3.1.4-1.20.4" = _S15vRrku;
        "pkg-3.1.5-1.20.4" = _TGqwrWVc;
        "pkg-3.1.6-1.20.4" = _NUStltcM;
        "pkg-3.1.7-1.20.4" = _kIDynVYf;
        "pkg-3.1.8-1.20.4" = _tJqzFLFi;
        "pkg-3.1.9-1.20.4" = _J0DCRfuW;
        "pkg-4.1.9-1.20.1" = _oZA37nmK;
        "pkg-5.2.4-1.21.1" = _vx6FKl0v;
        "pkg-5.2.5-1.21.1" = _iduR9Vb7;
        "pkg-5.3.0-1.21.1" = _cefEklVz;
        "pkg-4.3.0-1.20.1" = _D90rElcR;
        "pkg-4.3.1-1.20.1" = _tCYFxJ3d;
        "pkg-5.3.1-1.21.1" = _kCIgxXpK;
        "pkg-5.3.2-1.21.1" = _Dayi2h5P;
        "pkg-5.3.3-1.21.1" = _Rh0rvKs7;
        "pkg-5.3.4-1.21.1" = _n185sokn;
        "pkg-5.3.5-1.21.1" = _HO5DCfDk;
        "pkg-4.4.0-1.20.1" = _ydLSHUDu;
        "pkg-4.4.2-1.20.1" = _L1b4kQ1f;
        "pkg-4.4.3-1.20.1" = _DkEDr2Kg;
        "pkg-4.4.4-1.20.1" = _yhq2K0J5;
        "pkg-4.4.5-1.20.1" = _368zJ9zA;
        "pkg-4.4.6-1.20.1" = _8t868grB;
        "pkg-4.5.0-1.20.1" = _CEJgh0yN;
        "pkg-4.6.0-1.20.1" = _RwNBc06b;
        "pkg-4.6.28-1.20.1" = _LH1GfgWN;
        "pkg-4.6.30-1.20.1" = _7lFsXE47;
        "pkg-1.4.6.31" = _QVehnFNE;
        "pkg-1.4.6.32" = _1WjGH1rJ;
        "pkg-1.4.6.33" = _jhm7qPoe;
        "pkg-1.4.6.35" = _qOkk2Afe;
        "pkg-1.4.6.36" = _optqsz2F;
        "pkg-1.4.6.37" = _oddOXqLy;
        "pkg-1.4.6.38" = _OUWJa97w;
        "pkg-1.4.6.39" = _JCyng11N;
        "pkg-1.4.6.40" = _4fapAzTi;
        "pkg-1.4.6.41" = _7fAdonfM;
        "pkg-1.4.6.43" = _pUIlUYq9;
        "pkg-1.4.6.46" = _C6gcYloD;
        "default" = _C6gcYloD;
    });
