...
let
    ...
    in {
        ...
        "pkg-0.1.0-alpha+1.21.1" = _Z6u7ighZ;
        "pkg-0.1.1-alpha+1.21.1" = _L6ZYAfvu;
        "pkg-0.1.2-alpha+1.21.1" = _wCdw6SF8;
        "pkg-0.1.3-alpha+1.21.1" = _DDouDShl;
        "pkg-0.1.4-alpha+1.21.1" = _iMcBuovL;
        "pkg-0.1.5-alpha+1.21.1" = _TgGNvUa9;
        "pkg-0.1.6-alpha+1.21.1" = _BzzFwdrx;
        "pkg-0.1.7-alpha+1.21.1" = _waWmPiIm;
        "pkg-0.1.8-alpha+1.21.1" = _4iyVwoFi;
        "pkg-0.1.9-alpha+1.21.1" = _OC90sazR;
        "pkg-0.2.0-alpha+1.21.1" = _Mdnvxrt1;
        "pkg-0.2.1-alpha+1.21.1" = _pzTJmW01;
        "pkg-0.2.2-alpha+1.21.1" = _PkE4JIBN;
        "pkg-0.2.3-alpha+1.21.1" = _k4xsaF77;
        "pkg-0.2.4-alpha+1.21.1" = _HLrqeiHw;
        "pkg-0.2.5-alpha+1.21.1" = _s5wWsUig;
        "pkg-0.2.6-alpha+1.21.1" = _DjlvZsoy;
        "pkg-0.2.7-alpha+1.21.1" = _HGrHXsFy;
        "pkg-0.2.8-alpha+1.21.1" = _yuiTvLMf;
        "pkg-0.2.9-alpha+1.21.1" = _a1PKcE5O;
        "pkg-0.3.0-alpha+1.21.1" = _r9vaKlkt;
        "pkg-0.3.1-alpha+1.21.1" = _6YHPn0ws;
        "pkg-0.3.2-alpha+1.21.1" = _PR1qYg7N;
        "pkg-0.3.3-alpha+1.21.1" = _Y0yCF7Au;
        "pkg-0.4.0-alpha+1.21.1" = _DFsmOqFD;
        "pkg-0.4.1-alpha+1.21.1" = _Ja1QPG1T;
        "pkg-0.4.2-alpha+1.21.1" = _cZ5RpOhL;
        "pkg-0.5.0-alpha+1.21.1" = _7K3Awhf3;
        "pkg-0.5.1-alpha+1.21.1" = _jq4QATVX;
        "pkg-0.5.2-alpha+1.21.1" = _xpvfv9o3;
        "pkg-0.5.3-alpha+1.21.1" = _B0xpEBh0;
        "default" = _B0xpEBh0;
    });
