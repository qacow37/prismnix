...
let
    ...
    in {
        ...
        "pkg-1.19-1.19.2" = _UWSkQaI1;
        "pkg-1.19.3" = _IvWKX49R;
        "pkg-1.19.4" = _uO0bb9QX;
        "pkg-1.20-1.20.1" = _8I9CKA3J;
        "pkg-1.20.2" = _NIzbl0rz;
        "pkg-1.20.3-1.20.4" = _75YyjXql;
        "pkg-1.20.5" = _DXzS8zTV;
        "pkg-1.20.6" = _NKlvmyyD;
        "pkg-1.16" = _RnrWOVeG;
        "pkg-1.17" = _r6d4LDVG;
        "pkg-1.18" = _KyTb5jNw;
        "pkg-1.19" = _bwSrjGuj;
        "pkg-1.20" = _1OOj4jml;
        "pkg-1.20.5-1.20.6" = _swVEWPS6;
        "pkg-1.21" = _ojwb7gKV;
        "pkg-1.21.2-1.21.3" = _4d8rPaP0;
        "pkg-1.21.4" = _XeeCWB5h;
        "pkg-6.0" = _oMLMxZxZ;
        "pkg-6.1" = _tYe6JfT5;
        "pkg-6.5" = _2Rhhnw2x;
