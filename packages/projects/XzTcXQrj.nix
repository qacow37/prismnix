...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.4-54.1.8" = _1LexNKIb;
        "pkg-1.0.0-forge-1.20.1-47.4.9" = _xVjXZGyW;
        "pkg-1.0.0-forge-1.21.1-52.1.5" = _3vhgvmPt;
        "pkg-1.0.0-fabric-1.21.5-0.128.2" = _M59mtKfb;
        "pkg-1.0.0-neoforge-1.21.9-21.9.2-b" = _Y9ADGeJW;
        "pkg-1.0.0-fabric-1.21.9-0.134.0" = _SbRwAyS9;
        "pkg-1.0.0-forge-1.21.9-59.0.1" = _RhaIprLw;
        "pkg-1.0.0-neoforge-1.21.1-21.1.209" = _VTSrsT3b;
        "pkg-1.0.1-forge-1.21.9-59.0.5" = _YjBqSPeW;
        "pkg-1.0.0-neoforge-1.21.4-21.4.155" = _XzD0B51U;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _BVvFTBpL;
        "pkg-1.0.0-fabric-1.21.1-0.116.7" = _8YlAZgTV;
        "pkg-1.0.1-forge-1.21.11-61.0.2" = _1zf6MvQk;
        "pkg-1.0.0-neoforge-1.21.11-21.11.10-" = _jRuAgMsy;
        "pkg-1.0.0-fabric-1.21.11-0.140.0" = _iMF2XqLX;
        "pkg-1.0.0-forge-1.19.4-45.4.3" = _7ptTQtXd;
        "pkg-1.0.0-forge-1.19.2-43.5.2" = _y4ABicG6;
        "pkg-1.0.0-forge-1.18.2-40.3.12" = _IAOCjJ2e;
        "pkg-1.0.0-fabric-1.20.1-0.92.6" = _Jb8GYzxs;
        "pkg-1.0.2-forge-26.1.2-64.0.0" = _T2tdIMbE;
