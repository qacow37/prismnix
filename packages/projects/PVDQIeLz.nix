...
let
    ...
    in {
        ...
        "pkg-0.20.0" = _lMobusCw;
        "pkg-0.20.1" = _AlO2kuwU;
        "pkg-0.20.2" = _C6PrK6vN;
        "pkg-0.20.2-mc1.20.4" = _cJBsAhkp;
        "pkg-0.20.3-mc1.20.4" = _UvGink3y;
        "pkg-0.21.0-mc1.21.4" = _vaIojGR5;
        "pkg-1.0.0-mc1.19" = _cbq1HIdd;
        "pkg-1.0.0-mc1.19.1" = _RZNZMduz;
        "pkg-1.0.0-mc1.19.3" = _xR72psOx;
        "pkg-1.0.0-mc1.20" = _5HyXLwzs;
        "pkg-1.0.0-mc1.20.3" = _KHFvKCPe;
        "pkg-1.0.0-mc1.21" = _hIg7e2lP;
        "pkg-1.0.1-mc1.19" = _mDrKWY3b;
        "pkg-1.0.1-mc1.19.1" = _cwFSLwvJ;
        "pkg-1.0.1-mc1.19.3" = _jdyYGmb0;
        "pkg-1.0.1-mc1.20" = _lCQeOBUI;
        "pkg-1.0.1-mc1.20.3" = _6m7bmHZM;
        "pkg-1.0.1-mc1.21" = _6LMUBD9V;
        "pkg-1.1.0-mc1.19" = _eoYH83qq;
        "pkg-1.1.0-mc1.19.1" = _WnsywxRm;
        "pkg-1.1.0-mc1.19.3" = _Gd3ULKIu;
        "pkg-1.1.0-mc1.20" = _zwP3dYLc;
        "pkg-1.1.0-mc1.20.3" = _UgY8rQfV;
        "pkg-1.1.0-mc1.21" = _zn3bFL95;
        "pkg-1.1.0-mc26.1" = _kCCPvq3q;
        "pkg-1.1.1-mc1.19" = _yn2AiW1p;
        "pkg-1.1.1-mc1.19.1" = _wY8NHHwr;
        "pkg-1.1.1-mc1.19.3" = _BekiRLnc;
        "pkg-1.1.1-mc1.20" = _lj7FXeMn;
        "pkg-1.1.1-mc1.20.3" = _YV4VRYs5;
        "pkg-1.1.1-mc1.21" = _kzYwDBaA;
        "pkg-1.1.1-mc26.1" = _aa0ShQMp;
        "default" = _aa0ShQMp;
    });
