...
let
    ...
    in {
        ...
        "pkg-2.2.0-forge" = _V8bnvWWg;
        "pkg-2.2.0-fabric" = _QPtYxCm6;
        "pkg-3.0.0-forge" = _fQJBUqth;
        "pkg-3.0.0-fabric" = _dBE2qYH7;
        "pkg-4.0.0-quilt" = _evJUvweZ;
        "pkg-4.0.0-forge" = _aa3VLM5w;
        "pkg-4.0.0-fabric" = _F67KU1uW;
        "pkg-5.0.0-quilt" = _MBYKN0ch;
        "pkg-5.0.0-forge" = _na8tZIou;
        "pkg-5.0.0-fabric" = _uc6hDxP8;
        "pkg-2.3.0+1.16.5-forge" = _Yqa1x2xP;
        "pkg-2.3.0+1.16.5-fabric" = _Vgm8D7gi;
        "pkg-3.1.0+1.17.1-forge" = _5DYYDeLp;
        "pkg-3.1.0+1.17.1-fabric" = _r9Ieqtb7;
        "pkg-4.1.0+1.18.2-quilt" = _rXDzAHUU;
        "pkg-4.1.0+1.18.2-forge" = _qbEvYzUB;
        "pkg-4.1.0+1.18.2-fabric" = _6p2TBnzZ;
        "pkg-5.1.0+1.19-quilt" = _HntJhJTa;
        "pkg-5.1.0+1.19-forge" = _ITFl4dSD;
        "pkg-5.1.0+1.19-fabric" = _oEmFtEYu;
        "pkg-5.1.2+1.19-quilt" = _OIHw59hh;
        "pkg-1.19+5.1.2-forge" = _GJxttzXR;
        "pkg-5.1.2+1.19-fabric" = _RtL14nif;
        "pkg-6.0.0-quilt" = _IyijEleI;
        "pkg-6.0.0-forge" = _VMbxmhuW;
        "pkg-6.0.0-fabric" = _UIIWeDj0;
        "pkg-6.0.1-quilt" = _X1z8XrA5;
        "pkg-6.0.1-forge" = _qO92yfYJ;
        "pkg-6.0.1-fabric" = _2TnVnJIx;
        "pkg-6.1.0-quilt" = _9w1v42V1;
        "pkg-6.1.0-forge" = _dJuW7wQ7;
        "pkg-6.1.0-fabric" = _gKw1Wgeo;
        "pkg-6.1.1-quilt" = _3Uy5PFxb;
        "pkg-6.1.1-forge" = _MTvpk7I9;
        "pkg-6.1.1-fabric" = _lFQxRITb;
        "pkg-6.1.2-quilt" = _TRSYhD8p;
        "pkg-6.1.2-forge" = _9mrUO7ZU;
        "pkg-6.1.2-fabric" = _jXIHVNN8;
        "pkg-7.0.1-quilt" = _hEfxZUjK;
        "pkg-7.0.1-forge" = _OUDzgCPB;
        "pkg-7.0.1-fabric" = _nH4MvJMp;
        "pkg-7.1.0+1.20-quilt" = _ooLZhdLX;
        "pkg-7.1.0+1.20-forge" = _BoE5daTu;
        "pkg-7.1.0+1.20-fabric" = _PUMXZiW8;
        "pkg-8.0.0+1.20.1-quilt" = _Ga0j2ZCJ;
        "pkg-8.0.0+1.20.1-forge" = _UJwSd9K6;
        "pkg-8.0.0+1.20.1-fabric" = _lZOCCEP9;
        "pkg-6.1.3" = _e3j39w8g;
        "pkg-7.1.1+1.20-quilt" = _X5IDvPFq;
        "pkg-7.1.1+1.20-forge" = _yOMkoLkz;
        "pkg-7.1.1+1.20-fabric" = _bOA8m9x1;
        "pkg-8.0.1+1.20.1-quilt" = _LGlem1Lh;
        "pkg-8.0.1+1.20.1-forge" = _pCYVczYd;
        "pkg-8.0.1+1.20.1-fabric" = _IY1tJWHA;
        "pkg-20.2.0-neoforge" = _GxPZlGbC;
        "pkg-20.2.0-forge" = _C8xwEYKg;
        "pkg-20.2.0-fabric" = _m6QhmReI;
        "pkg-20.4.0-neoforge" = _o4qeMKdA;
        "pkg-20.4.0-forge" = _xvyKa9rE;
        "pkg-20.4.0-fabric" = _EQfQVxwn;
        "pkg-20.4.1-neoforge" = _V6tVrDTR;
        "pkg-20.4.1-forge" = _rXB0uPrW;
        "pkg-20.4.1-fabric" = _1K4rbxoP;
        "pkg-20.6.0-neoforge" = _SDvwUt6y;
        "pkg-20.6.0-forge" = _fmve6gal;
        "pkg-20.6.0-fabric" = _xFu6U0Bd;
        "pkg-20.6.1-neoforge" = _ugRGBYQu;
        "pkg-20.6.1-forge" = _ati2Q55T;
        "pkg-20.6.1-fabric" = _FTKclFEV;
        "pkg-21.0.0-neoforge" = _EAbnXEZ5;
        "pkg-21.0.0-fabric" = _wroNMLS7;
        "pkg-21.0.1-neoforge" = _vf36vIvH;
        "pkg-21.0.1-fabric" = _6acdQX5t;
        "pkg-21.1.0-neoforge" = _VPG6hE9S;
        "pkg-21.1.0-fabric" = _ePXTOplH;
        "pkg-21.2.0-neoforge" = _HFehMZyA;
        "pkg-21.2.0-fabric" = _9Gx3FcN8;
        "pkg-21.3.0-neoforge" = _T9oTeqfu;
        "pkg-21.3.0-fabric" = _Un7Msdli;
        "pkg-21.4.0-neoforge" = _A4bqjfuZ;
        "pkg-21.4.0-fabric" = _Z8AYFSEr;
        "pkg-21.4.1-neoforge" = _wgJ1lXuU;
        "pkg-21.4.1-fabric" = _sTkIxMHU;
        "pkg-21.5.0-neoforge" = _zn6YZFzN;
        "pkg-21.5.0-fabric" = _cA0pvsly;
        "default" = _cA0pvsly;
    });
