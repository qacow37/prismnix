...
let
    ...
    in {
        ...
        "pkg-0.1.3-beta-1.21.1" = _E6nfbF4m;
        "pkg-0.1.4-beta-1.21.1" = _fBqxbh06;
        "pkg-0.1.5-1.21.1" = _Kv5jshni;
        "pkg-0.1.6-1.21.1" = _F9eOdxPQ;
        "pkg-0.1.6-1.21.1-neo" = _x6DJrLeN;
        "pkg-0.1.9-1.21.1" = _zdPV1EpU;
        "pkg-0.1.9-1.21.1-neo" = _81JR9wYc;
        "pkg-0.1.10-1.21.1" = _klYx0Hz3;
        "pkg-0.1.10-1.21.1-neo" = _isjtpdIZ;
        "pkg-0.1.10-1.20.1-hotifix" = _j2TLzkhm;
        "pkg-0.1.10-1.21.10" = _XPjhatPS;
        "pkg-0.1.11-1.21.1" = _tb8VUGFC;
        "pkg-0.1.11-1.21.1-neo" = _heHHIRut;
        "pkg-0.1.11-1.21.8" = _NdfkRxcE;
        "pkg-0.1.11-1.21.10" = _9Hgzf6fY;
        "pkg-0.1.12-1.21.1" = _RHndupyi;
        "pkg-0.1.12-1.21.1-neo" = _orPuiZC2;
        "pkg-0.1.12-1.21.8" = _HlToLwg4;
        "pkg-0.1.12-1.21.10" = _jyiuQKxc;
        "pkg-0.1.12-1.20.1" = _p3rpMC5N;
        "pkg-0.1.12-1.20.1-forge" = _tjx45pLC;
        "pkg-0.1.13-1.21.8" = _3wwnW2aZ;
        "pkg-0.1.13-1.21.10" = _pp2qM4cJ;
        "pkg-0.1.13-1.21.1" = _adLYGAYt;
        "pkg-0.1.13-1.21.1-neo" = _AwTFNMPv;
        "pkg-0.1.14-1.21.10" = _HpMdvi4P;
        "pkg-0.1.14-1.21.1" = _npgBinn5;
        "pkg-0.1.14-1.21.1-neo" = _BKUQLHXm;
        "pkg-0.1.14-1.21.8" = _aZ2Gh4jS;
        "pkg-0.1.14-1.20.1" = _bEfbGNZf;
        "pkg-0.1.14-1.21.11" = _BzGRlCQY;
