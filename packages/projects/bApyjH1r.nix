...
let
    ...
    in {
        ...
        "pkg-1.8.9-1.0.0" = _EOWZzzpv;
        "pkg-1.8.9-1.0.1" = _UIYfhrYq;
        "pkg-1.8.9-1.1.0" = _XbXyCcgA;
        "pkg-Beta-1.10.2-1.0.0" = _b1jQObyi;
        "pkg-Beta-1.10.2-1.0.1" = _gtwuu03O;
        "pkg-Beta-1.10.2-1.0.2" = _AamEC9UL;
        "pkg-Beta-1.10.2-1.0.3" = _CuQm3yQO;
        "pkg-1.10.2-1.0.0" = _4TP1cRBD;
        "pkg-1.10.2-1.0.1" = _rJFQRheQ;
        "pkg-1.10.2-1.0.2" = _f2op0Z6M;
        "pkg-1.10.2-1.1.0" = _SHOxJUYz;
        "pkg-1.10.2-1.1.1" = _BgYW3QqT;
        "pkg-1.12-1.2.0" = _Oeajsme1;
        "pkg-1.12-1.2.1" = _OZfo9gsR;
        "pkg-1.12.2-Lite-1.0.0" = _Ju0wYCan;
        "pkg-1.12.2-2.0.0" = _fweg4Kw6;
        "pkg-1.12.2-2.0.1" = _khVuH6WJ;
        "pkg-1.12.2-2.0.2" = _dzQxefdO;
        "pkg-1.12.2-2.0.3" = _h1bKhGrK;
        "pkg-1.12.2-2.0.4" = _Pg1yrc80;
        "pkg-1.12.2-2.0.5" = _yWSElr1Z;
        "pkg-1.12.2-2.0.6" = _dSKdldUn;
        "pkg-1.12.2-2.0.7" = _a9OlUhwH;
        "pkg-1.12.2-2.0.8" = _nRMTIPqQ;
        "pkg-1.12.2-2.0.9" = _Icwv41PP;
        "pkg-1.12.2-2.0.10" = _HSSrWAp9;
        "pkg-1.12.2-2.1.0" = _omzJa6z3;
        "pkg-1.12.2-2.1.1" = _AGJ36NYX;
        "pkg-1.12.2-2.1.2" = _6HwWsIth;
        "pkg-1.12.2-2.1.3" = _OwSWP0Kk;
        "pkg-1.12.2-2.1.4" = _lXwy9guJ;
        "pkg-1.12.2-2.2.0" = _VtMNEuEr;
        "pkg-1.12.2-2.2.1" = _wQrTs4GN;
        "default" = _wQrTs4GN;
    });
