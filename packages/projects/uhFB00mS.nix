...
let
    ...
    in {
        ...
        "pkg-0.16.0b" = _HooynL6l;
        "pkg-0.17.0b" = _XBPGLqdn;
        "pkg-0.18.0b" = _h23MsuQB;
        "pkg-0.18.1b" = _dYg5JL3c;
        "pkg-0.18.2b" = _FJIfQqtT;
        "pkg-0.19.0b" = _IGJOvoe1;
        "pkg-0.19.1b" = _JhYwVlnL;
        "pkg-0.19.2b" = _cczQf3i6;
        "pkg-0.19.3b" = _Y3b6xe52;
        "pkg-0.19.1b-REUPLOAD" = _ES1UlHLD;
        "pkg-0.19.4b" = _47pmEbRK;
        "pkg-0.19.5b" = _M5W7ys4t;
        "pkg-0.19.6b" = _y3czJ7OL;
        "pkg-0.19.7b" = _6GBDwDq9;
        "pkg-0.19.8b" = _VgZn069k;
        "pkg-0.19.9b" = _YBaDxgJG;
        "pkg-0.19.10b" = _VInWGkqi;
        "pkg-0.19.11a+559fc94" = _5Sh2QxNf;
        "pkg-0.19.11b" = _ShUXgGjh;
        "pkg-0.19.12a+c7aeb66" = _X7ckxdWR;
        "pkg-0.19.8b+fixes-backport" = _ZZqMsHqU;
        "pkg-0.20.0b" = _OThAEJ3O;
        "pkg-0.20.0a+26.1" = _PIeR91l3;
        "pkg-0.21.0b" = _BJsbrV71;
        "pkg-0.21.1b" = _P3oFFJQk;
        "pkg-0.22.0b" = _CyywWN9t;
        "pkg-0.23.0b" = _svaCvvIe;
        "pkg-0.21.1b+backport-1.21.10" = _oEutlJyi;
        "pkg-0.21.1b+backport-1.21.8" = _f4IXHk96;
        "pkg-0.21.1b+backport-1.21.5" = _lCSArNVk;
        "pkg-0.21.1b+backport-1.21.4" = _8pj3fHmO;
        "pkg-0.21.1b+backport-1.21.3" = _WQROK56O;
        "pkg-0.21.1b+backport-1.21.1" = _liOXmvE5;
        "pkg-0.23.0b+26.2" = _fdy26yv5;
        "default" = _fdy26yv5;
    });
