...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.21" = _EzyTiHYu;
        "pkg-1.1.0+1.21" = _U71bZsWj;
        "pkg-1.1.0+1.20.1" = _zpVGnnMP;
        "pkg-1.1.1+1.21" = _L9r1N0Yv;
        "pkg-1.1.2+1.20.1" = _KDqWHwF3;
        "pkg-1.2.0+1.21.1" = _vvLgjoPw;
        "pkg-1.2.0+1.21.2-rc2" = _4MdilDKm;
        "pkg-1.2.1+1.21.1" = _bSugkDU6;
        "pkg-1.2.1+1.20.1" = _CRSPo0Ue;
        "pkg-1.2.1+1.21.4" = _UZecDIT9;
        "pkg-1.2.1+1.21.5-rc1" = _Ffj5hgvv;
        "pkg-1.3.0+1.21.4" = _m5Ilat0t;
        "pkg-1.3.0+1.21.5" = _KN8OgpAb;
        "pkg-1.3.1+1.21.5" = _4AT35Owh;
        "pkg-1.3.1+1.21.4" = _14U6FatH;
        "pkg-1.3.1+1.21.1" = _sMKe6xlY;
        "pkg-1.3.2+1.21.1" = _2QYUYgtz;
        "pkg-1.3.2+1.21.4" = _8DwBm4Qe;
        "pkg-1.3.2+1.21.5" = _J6CB518u;
        "pkg-1.3.3+1.21.1" = _xgfsaoPC;
        "pkg-1.3.3+1.21.5" = _jOI5ujKZ;
        "pkg-1.3.3+1.21.4" = _zk87k03V;
        "pkg-1.3.4+1.21.4" = _v6nMbwM5;
        "pkg-1.3.4+1.21.1" = _O3zu6zkk;
        "pkg-1.3.4+1.21.5" = _iYoUfxPc;
        "pkg-1.3.5+1.21.4" = _m0l7B9Uj;
        "pkg-1.3.5+1.21.5" = _fIg8nxjB;
        "pkg-1.3.5+1.21.1" = _zJ5QDrvR;
        "pkg-1.3.6+1.21.5" = _R1r4iKtG;
        "pkg-1.3.6+1.21.4" = _p2EQy5U7;
        "pkg-1.3.6+1.21.1" = _jR9HxxKu;
        "pkg-1.3.6+1.21.6-rc1" = _ooxPe8xZ;
        "pkg-1.3.6+1.21.9" = _KF6dpMOv;
        "pkg-1.3.6+1.21.11" = _9If5qWPg;
        "pkg-1.3.7+26.1" = _2QWxHSgU;
        "pkg-1.3.7+26.2" = _xcsO2Qx9;
        "default" = _xcsO2Qx9;
    });
