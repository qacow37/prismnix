...
let
    ...
    in {
        ...
        "pkg-FABRIC-1.16.5-3.0.0-beta-6" = _zdzuHV1e;
        "pkg-FABRIC-1.16.5-3.0.0-beta-7" = _Rl1aak6s;
        "pkg-FABRIC-1.17.1-3.0.0-beta-7" = _yX5bgnBs;
        "pkg-FABRIC-1.16.5-3.0.0-beta-8-prerelease-1" = _XNqBqAbN;
        "pkg-FABRIC-1.17.1-3.0.0-beta-8-prerelease-1" = _2g8YM3fW;
        "pkg-FABRIC-1.16.5-3.0.0-beta-8" = _sL3syQNO;
        "pkg-FABRIC-1.17.1-3.0.0-beta-8" = _bPPtBS7y;
        "pkg-FABRIC-1.18-3.0.0-beta-8" = _C2NPfT9x;
        "pkg-FORGE-1.16.5-3.0.0-beta-8" = _xRBg4kfT;
        "pkg-FORGE-1.17.1-3.0.0-beta-8" = _47iWhpwR;
        "pkg-FORGE-1.18-3.0.0-beta-8" = _175zNJxd;
        "pkg-FORGE-1.18.1-3.0.0" = _uyut6H24;
        "pkg-FORGE-1.17.1-3.0.0" = _GHKOYnsh;
        "pkg-FORGE-1.16.5-3.0.0" = _5WXihlRE;
        "pkg-FABRIC-1.18.2-3.0.0" = _7zzkD8Ha;
        "pkg-FABRIC-1.18.1-3.0.0" = _uuo7aZnN;
        "pkg-FABRIC-1.17.1-3.0.0" = _n4XQAmEJ;
        "pkg-FABRIC-1.16.5-3.0.0" = _VATlWBrO;
        "pkg-FORGE-1.18.2-3.0.0" = _17MvjJvA;
        "pkg-FABRIC-1.16.5-3.0.1" = _hpG9OQxh;
        "pkg-FABRIC-1.17.1-3.0.1" = _OHOWH6Ec;
        "pkg-FABRIC-1.18.2-3.0.1" = _Pmwg3PiY;
        "pkg-FABRIC-1.19-3.0.1" = _9oyMrMXM;
        "pkg-FORGE-1.16.5-3.0.1" = _G2jXtL5t;
        "pkg-FORGE-1.17.1-3.0.1" = _t9In4ul6;
        "pkg-FORGE-1.18.2-3.0.1" = _L5PZEkXK;
        "pkg-FORGE-1.19-3.0.1" = _xtLvdX3T;
        "pkg-FABRIC-1.16.5-3.1.0" = _lCLfh2FR;
        "pkg-FABRIC-1.17.1-3.1.0" = _ginuK9Tq;
        "pkg-FABRIC-1.18.2-3.1.0" = _dNMwh2Cy;
        "pkg-FABRIC-1.19.2-3.1.0" = _WMZOZlNV;
        "pkg-FORGE-1.16.5-3.1.0" = _1t6av1io;
        "pkg-FORGE-1.17.1-3.1.0" = _PMMSZv7q;
        "pkg-FORGE-1.18.2-3.1.0" = _isJFoR5B;
        "pkg-FORGE-1.19.2-3.1.0" = _TI99tWLB;
        "pkg-FABRIC-1.16.5-3.1.1" = _CLd40M5d;
        "pkg-FABRIC-1.17.1-3.1.1" = _iMqIPfxC;
        "pkg-FABRIC-1.18.2-3.1.1" = _dSB2DqXG;
        "pkg-FABRIC-1.19.2-3.1.1" = _qGJRvWDS;
        "pkg-FORGE-1.16.5-3.1.1" = _TIGbGLOL;
        "pkg-FORGE-1.17.1-3.1.1" = _WOu9ofvU;
        "pkg-FORGE-1.18.2-3.1.1" = _L0oQC0vD;
        "pkg-FORGE-1.19.2-3.1.1" = _bWa1Yvob;
        "pkg-FABRIC-1.16.5-3.1.2" = _qZdEoHgr;
        "pkg-FORGE-1.16.5-3.1.2" = _PQSlwub9;
        "pkg-FABRIC-1.17.1-3.1.2" = _h7q3N9eJ;
        "pkg-FORGE-1.17.1-3.1.2" = _L5n4JMBt;
        "pkg-FABRIC-1.18.2-3.1.2" = _OFNMubA0;
        "pkg-FORGE-1.18.2-3.1.2" = _LLzA4TvT;
        "pkg-FABRIC-1.19.2-3.1.2" = _fiOcoExt;
        "pkg-FORGE-1.19.2-3.1.2" = _rSqhHueW;
        "pkg-FABRIC-1.16.5-3.1.3" = _v8WxALIw;
        "pkg-FORGE-1.16.5-3.1.3" = _AJ0E6SRb;
        "pkg-FABRIC-1.17.1-3.1.3" = _OO1rHHNd;
        "pkg-FORGE-1.17.1-3.1.3" = _YDFOWRdX;
        "pkg-FABRIC-1.18.2-3.1.3" = _K2c2Bd64;
        "pkg-FORGE-1.18.2-3.1.3" = _WMLDZHwE;
        "pkg-FABRIC-1.19.2-3.1.3" = _ehAnPfWu;
        "pkg-FORGE-1.19.2-3.1.3" = _m0i8nfzl;
        "pkg-FABRIC-1.16.5-3.1.4" = _Odoj4beZ;
        "pkg-FORGE-1.16.5-3.1.4" = _h9BUglpV;
        "pkg-FABRIC-1.17.1-3.1.4" = _TyObx5OU;
        "pkg-FORGE-1.17.1-3.1.4" = _SBxv1mCf;
        "pkg-FABRIC-1.18.2-3.1.4" = _kYVgGc5j;
        "pkg-FORGE-1.18.2-3.1.4" = _gu0CR9y7;
        "pkg-FABRIC-1.19.2-3.1.4" = _nGixJ0te;
        "pkg-FORGE-1.19.2-3.1.4" = _6eCcP862;
        "pkg-FABRIC-1.16.5-3.1.5" = _Gb7hsblP;
        "pkg-FORGE-1.16.5-3.1.5" = _JWowbFHz;
        "pkg-FABRIC-1.17.1-3.1.5" = _FLZPRc91;
        "pkg-FORGE-1.17.1-3.1.5" = _EifhAHft;
        "pkg-FABRIC-1.18.2-3.1.5" = _uYP11ruu;
        "pkg-FORGE-1.18.2-3.1.5" = _WpW5bOap;
        "pkg-FABRIC-1.19.2-3.1.5" = _RBrb3yZB;
        "pkg-FORGE-1.19.2-3.1.5" = _MSeQ65sc;
        "pkg-FABRIC-1.16.5-3.1.6" = _pyKkR9Mc;
        "pkg-FORGE-1.16.5-3.1.6" = _IKeapJgz;
        "pkg-FABRIC-1.17.1-3.1.6" = _ofBgTjMM;
        "pkg-FORGE-1.17.1-3.1.6" = _t4AsJaEc;
        "pkg-FABRIC-1.18.2-3.1.6" = _xuuFOL4A;
        "pkg-FORGE-1.18.2-3.1.6" = _X3CfuIam;
        "pkg-FABRIC-1.19.2-3.1.6" = _KIeCK6Dv;
        "pkg-FORGE-1.19.2-3.1.6" = _vnE3YIwj;
        "pkg-FABRIC-1.16.5-3.1.7" = _hse1r7FA;
        "pkg-FORGE-1.16.5-3.1.7" = _5FZvOSHb;
        "pkg-FABRIC-1.17.1-3.1.7" = _tUXN5wK9;
        "pkg-FORGE-1.17.1-3.1.7" = _2dbFviqD;
        "pkg-FABRIC-1.18.2-3.1.7" = _xwc5QKlX;
        "pkg-FORGE-1.18.2-3.1.7" = _sU6ReBp5;
        "pkg-FABRIC-1.19.2-3.1.7" = _TIAIeoFa;
        "pkg-FORGE-1.19.2-3.1.7" = _MafhuX8H;
        "pkg-FABRIC-1.16.5-3.1.8" = _2c5nqj6O;
        "pkg-FORGE-1.16.5-3.1.8" = _EaZXwFWR;
        "pkg-FABRIC-1.17.1-3.1.8" = _DvemClPV;
        "pkg-FORGE-1.17.1-3.1.8" = _kmfSSZq6;
        "pkg-FABRIC-1.18.2-3.1.8" = _VEmpBflh;
        "pkg-FORGE-1.18.2-3.1.8" = _KBhIpGMa;
        "pkg-FABRIC-1.19.2-3.1.8" = _24NoMgap;
        "pkg-FORGE-1.19.2-3.1.8" = _CFmBe106;
        "pkg-FABRIC-1.16.5-3.1.9" = _T5QHRDYs;
        "pkg-FORGE-1.16.5-3.1.9" = _zW0gEsU3;
        "pkg-FABRIC-1.17.1-3.1.9" = _yA2CIbt9;
        "pkg-FORGE-1.17.1-3.1.9" = _EC99Abjx;
        "pkg-FABRIC-1.18.2-3.1.9" = _h1EBrfex;
        "pkg-FORGE-1.18.2-3.1.9" = _tlMB3bW1;
        "pkg-FABRIC-1.19.2-3.1.9" = _fsq2nisK;
        "pkg-FORGE-1.19.2-3.1.9" = _msvPZxym;
        "pkg-FABRIC-1.16.5-3.1.10" = _OvY1jtYK;
        "pkg-FORGE-1.16.5-3.1.10" = _lUrJ4X8W;
        "pkg-FABRIC-1.17.1-3.1.10" = _eRcDN7QC;
        "pkg-FORGE-1.17.1-3.1.10" = _n8JbWynR;
        "pkg-FABRIC-1.18.2-3.1.10" = _ZDstHxrF;
        "pkg-FORGE-1.18.2-3.1.10" = _d0SD5Uje;
        "pkg-FABRIC-1.19.2-3.1.10" = _W2soZVLs;
        "pkg-FORGE-1.19.2-3.1.10" = _rapYMHk9;
        "pkg-FABRIC-1.16.5-3.1.11" = _gOhJbYJ0;
        "pkg-FORGE-1.16.5-3.1.11" = _WcnD96Og;
        "pkg-FABRIC-1.17.1-3.1.11" = _a2pJ9ND8;
        "pkg-FORGE-1.17.1-3.1.11" = _2nkJgYfg;
        "pkg-FABRIC-1.18.2-3.1.11" = _gWDemtZb;
        "pkg-FORGE-1.18.2-3.1.11" = _zVIfBAOA;
        "pkg-FABRIC-1.19.2-3.1.11" = _rWo9lkME;
        "pkg-FORGE-1.19.2-3.1.11" = _qM6OZMKT;
        "pkg-FABRIC-1.16.5-3.1.12" = _94blG2Pe;
        "pkg-FORGE-1.16.5-3.1.12" = _ESGLEtHA;
        "pkg-FABRIC-1.17.1-3.1.12" = _lUDPVX9K;
        "pkg-FORGE-1.17.1-3.1.12" = _FoNh3Kxr;
        "pkg-FABRIC-1.18.2-3.1.12" = _ydnDAPQM;
        "pkg-FORGE-1.18.2-3.1.12" = _EQiyrNR3;
        "pkg-FABRIC-1.19.2-3.1.12" = _s7xkvgpS;
        "pkg-FORGE-1.19.2-3.1.12" = _T0eaq9IM;
        "pkg-FABRIC-1.19.3-3.1.12" = _r6eRGpY7;
        "pkg-FORGE-1.19.3-3.1.12" = _Ji44KXuy;
        "pkg-FABRIC-1.16.5-3.1.13" = _qyu9ckyW;
        "pkg-FORGE-1.16.5-3.1.13" = _3J7MbSwH;
        "pkg-FABRIC-1.17.1-3.1.13" = _2feVvJGs;
        "pkg-FORGE-1.17.1-3.1.13" = _Y2HcdySC;
        "pkg-FABRIC-1.18.2-3.1.13" = _ZjG8Vp92;
        "pkg-FORGE-1.18.2-3.1.13" = _FnGRgUG3;
        "pkg-FABRIC-1.19.2-3.1.13" = _1gxFyPDc;
        "pkg-FORGE-1.19.2-3.1.13" = _E2Ft3wMf;
        "pkg-FABRIC-1.19.3-3.1.13" = _vDlVXBcG;
        "pkg-FORGE-1.19.3-3.1.13" = _kb4Ao4Hc;
        "pkg-FORGE-1.19.3-3.1.13-hotfix-1" = _5D8cNISO;
        "pkg-FABRIC-1.16.5-3.2.0" = _UqG1AC8T;
        "pkg-FORGE-1.16.5-3.2.0" = _LwrY1lPv;
        "pkg-FABRIC-1.17.1-3.2.0" = _Mb4IKvps;
        "pkg-FORGE-1.17.1-3.2.0" = _jhuY99Y8;
        "pkg-FABRIC-1.18.2-3.2.0" = _pskTOUcC;
        "pkg-FORGE-1.18.2-3.2.0" = _f3GHiP7H;
        "pkg-FABRIC-1.19.2-3.2.0" = _1ksOJbPs;
        "pkg-FORGE-1.19.2-3.2.0" = _wpxZbSoi;
        "pkg-FABRIC-1.19.3-3.2.0" = _pALedwoY;
        "pkg-FORGE-1.19.3-3.2.0" = _7Z8CiIfQ;
        "pkg-FABRIC-1.16.5-3.2.1" = _GWzquVTr;
        "pkg-FORGE-1.16.5-3.2.1" = _LRNYQUPj;
        "pkg-FABRIC-1.17.1-3.2.1" = _lACtSRcd;
        "pkg-FORGE-1.17.1-3.2.1" = _Fth57ewu;
        "pkg-FABRIC-1.18.2-3.2.1" = _cBcHELsi;
        "pkg-FORGE-1.18.2-3.2.1" = _FF1pWPdV;
        "pkg-FABRIC-1.19.2-3.2.1" = _igcvwkEO;
        "pkg-FORGE-1.19.2-3.2.1" = _9CMnWkY2;
        "pkg-FABRIC-1.19.3-3.2.1" = _VoHfvsh9;
        "pkg-FORGE-1.19.3-3.2.1" = _vnGatsMO;
        "pkg-FABRIC-1.19.4-3.2.1" = _47eSoLzS;
        "pkg-FORGE-1.19.4-3.2.1" = _HcPhfQGI;
        "pkg-FABRIC-1.16.5-3.2.1-hotfix-1" = _SiccQbqj;
        "pkg-FORGE-1.16.5-3.2.1-hotfix-1" = _iqdHSV6b;
        "pkg-FABRIC-1.17.1-3.2.1-hotfix-1" = _5tdy2YIi;
        "pkg-FORGE-1.17.1-3.2.1-hotfix-1" = _M7wJQtii;
        "pkg-FABRIC-1.18.2-3.2.1-hotfix-1" = _NppwLmit;
        "pkg-FORGE-1.18.2-3.2.1-hotfix-1" = _EroiRXuf;
        "pkg-FABRIC-1.19.2-3.2.1-hotfix-1" = _oAwcHbON;
        "pkg-FORGE-1.19.2-3.2.1-hotfix-1" = _XwIPNsu3;
        "pkg-FABRIC-1.19.3-3.2.1-hotfix-1" = _mGy3nGza;
        "pkg-FORGE-1.19.3-3.2.1-hotfix-1" = _g2bz3OL2;
        "pkg-FABRIC-1.19.4-3.2.1-hotfix-1" = _qgoyD9dg;
        "pkg-FORGE-1.19.4-3.2.1-hotfix-1" = _dEqPwbE7;
        "pkg-FABRIC-1.16.5-3.2.2" = _ygoSCTMM;
        "pkg-FORGE-1.16.5-3.2.2" = _CB6cGjSM;
        "pkg-FABRIC-1.17.1-3.2.2" = _MZbID2dw;
        "pkg-FORGE-1.17.1-3.2.2" = _RGfPhi9T;
        "pkg-FABRIC-1.18.2-3.2.2" = _o29tfbAm;
        "pkg-FORGE-1.18.2-3.2.2" = _vSyQaDcN;
        "pkg-FABRIC-1.19.2-3.2.2" = _we5R6iNI;
        "pkg-FORGE-1.19.2-3.2.2" = _GYN77JiZ;
        "pkg-FABRIC-1.19.3-3.2.2" = _ofttqvi3;
        "pkg-FORGE-1.19.3-3.2.2" = _bnslw9iv;
        "pkg-FABRIC-1.19.4-3.2.2" = _XwJwARn7;
        "pkg-FORGE-1.19.4-3.2.2" = _ERS3ldhj;
        "pkg-FABRIC-1.16.5-3.2.2-hotfix-1" = _YoiezDVD;
        "pkg-FORGE-1.16.5-3.2.2-hotfix-1" = _BXjGAhyU;
        "pkg-FABRIC-1.17.1-3.2.2-hotfix-1" = _wT190mxx;
        "pkg-FORGE-1.17.1-3.2.2-hotfix-1" = _bUgsbKUr;
        "pkg-FABRIC-1.18.2-3.2.2-hotfix-1" = _KD7TXFaw;
        "pkg-FORGE-1.18.2-3.2.2-hotfix-1" = _aF2FI7ui;
        "pkg-FABRIC-1.19.2-3.2.2-hotfix-1" = _H0yHV2yE;
        "pkg-FORGE-1.19.2-3.2.2-hotfix-1" = _vkmzH7aU;
        "pkg-FABRIC-1.19.3-3.2.2-hotfix-1" = _hhTms0Ge;
        "pkg-FORGE-1.19.3-3.2.2-hotfix-1" = _hn0IgH6V;
        "pkg-FABRIC-1.19.4-3.2.2-hotfix-1" = _UT2U5yfn;
        "pkg-FORGE-1.19.4-3.2.2-hotfix-1" = _PP5puu9Z;
        "pkg-FABRIC-1.20-3.2.2-hotfix-1" = _ytcma4Og;
        "pkg-FORGE-1.20-3.2.2-hotfix-1" = _pxJCTx9V;
        "pkg-1.20.1-3.2.2-hotfix-2" = _YLvg95i9;
        "pkg-FABRIC-4.0.0-beta-8+1.16.5" = _yrxpm50B;
        "pkg-FABRIC-4.0.0-beta-8+1.17.1" = _1PyohCDM;
        "pkg-FABRIC-4.0.0-beta-8+1.18.2" = _vJxANvdE;
        "pkg-FABRIC-4.0.0-beta-8+1.19.2" = _j1ImPqSZ;
        "pkg-FABRIC-4.0.0-beta-8+1.19.4" = _aD3AEiIu;
        "pkg-FABRIC-4.0.0-beta-8+1.20.1" = _w3nUlPaM;
        "pkg-FABRIC-4.0.0-beta-8+1.20.4" = _gUMwSYv5;
        "pkg-FORGE-4.0.0-beta-8+1.16.5" = _yAA3iKZ8;
        "pkg-FORGE-4.0.0-beta-8+1.17.1" = _CLJSuZff;
        "pkg-FORGE-4.0.0-beta-8+1.18.2" = _SpH7SPti;
        "pkg-FORGE-4.0.0-beta-8+1.19.2" = _ALVe5AM1;
        "pkg-FORGE-4.0.0-beta-8+1.19.4" = _5WunUz4K;
        "pkg-FORGE-4.0.0-beta-8+1.20.1" = _32xj6Zpj;
        "pkg-FORGE-4.0.0-beta-8+1.20.4" = _I1zK7TNH;
        "pkg-FORGE-4.0.0-beta-8-h1+1.17.1" = _RQGPaRx0;
        "pkg-FORGE-4.0.0-beta-8-h1+1.18.2" = _lzFvoCyI;
        "pkg-FORGE-4.0.0-beta-8-h1+1.19.2" = _ODGbovbq;
        "pkg-FABRIC-4.0.0-beta-9+1.16.5" = _JMy5YGv1;
        "pkg-FABRIC-4.0.0-beta-9+1.17.1" = _5gTXuh5u;
        "pkg-FABRIC-4.0.0-beta-9+1.18.2" = _iIOyzHnx;
        "pkg-FABRIC-4.0.0-beta-9+1.19.2" = _lTfLhgUJ;
        "pkg-FABRIC-4.0.0-beta-9+1.19.4" = _yqc4tP23;
        "pkg-FABRIC-4.0.0-beta-9+1.20.1" = _e9vzJJdB;
        "pkg-FABRIC-4.0.0-beta-9+1.20.4" = _FOmd5mim;
        "pkg-FORGE-4.0.0-beta-9+1.16.5" = _ARDJuwRP;
        "pkg-FORGE-4.0.0-beta-9+1.17.1" = _KQwQz6gD;
        "pkg-FORGE-4.0.0-beta-9+1.18.2" = _uTSRYwP7;
        "pkg-FORGE-4.0.0-beta-9+1.19.2" = _6PSGySC2;
        "pkg-FORGE-4.0.0-beta-9+1.19.4" = _dhuAd6vc;
        "pkg-FORGE-4.0.0-beta-9+1.20.1" = _eTM63lOa;
        "pkg-FORGE-4.0.0-beta-9+1.20.4" = _JH9wkBPm;
        "pkg-FABRIC-4.0.0-beta-10+1.16.5" = _WflMjLUR;
        "pkg-FORGE-4.0.0-beta-10+1.16.5" = _5icWbX6f;
        "pkg-FABRIC-4.0.0-beta-10+1.17.1" = _1CBJ6GiO;
        "pkg-FORGE-4.0.0-beta-10+1.17.1" = _7VgRNVZz;
        "pkg-FABRIC-4.0.0-beta-10+1.18.2" = _iM3J4PhG;
        "pkg-FORGE-4.0.0-beta-10+1.18.2" = _BROkek7o;
        "pkg-FABRIC-4.0.0-beta-10+1.19.2" = _iMWZxups;
        "pkg-FORGE-4.0.0-beta-10+1.19.2" = _MOTCgBR1;
        "pkg-FABRIC-4.0.0-beta-10+1.19.4" = _GE8ISziV;
        "pkg-FORGE-4.0.0-beta-10+1.19.4" = _mi0q5BMq;
        "pkg-FABRIC-4.0.0-beta-10+1.20.1" = _2vSUu5UD;
        "pkg-FORGE-4.0.0-beta-10+1.20.1" = _6OFHzcsn;
        "pkg-FABRIC-4.0.0-beta-10+1.20.4" = _hwFBUhjH;
        "pkg-FORGE-4.0.0-beta-10+1.20.4" = _P3hLIbSv;
        "pkg-FABRIC-4.0.0-beta-11+1.16.5" = _osqR7LJ6;
        "pkg-FORGE-4.0.0-beta-11+1.16.5" = _C30glOzQ;
        "pkg-FABRIC-4.0.0-beta-11+1.17.1" = _9cWW8Qkv;
        "pkg-FORGE-4.0.0-beta-11+1.17.1" = _bCWXXRhX;
        "pkg-FABRIC-4.0.0-beta-11+1.18.2" = _Ym5DXPGv;
        "pkg-FORGE-4.0.0-beta-11+1.18.2" = _XhmM20nN;
        "pkg-FABRIC-4.0.0-beta-11+1.19.2" = _HaOOpGmv;
        "pkg-FORGE-4.0.0-beta-11+1.19.2" = _fgeNzAes;
        "pkg-FABRIC-4.0.0-beta-11+1.19.4" = _xSOVOdE1;
        "pkg-FORGE-4.0.0-beta-11+1.19.4" = _cmsPgB31;
        "pkg-FABRIC-4.0.0-beta-11+1.20.1" = _XdX656BA;
        "pkg-FORGE-4.0.0-beta-11+1.20.1" = _yRyprHkN;
        "pkg-FABRIC-4.0.0-beta-11+1.20.4" = _4jeJd9mz;
        "pkg-FORGE-4.0.0-beta-11+1.20.4" = _bQNAHtpy;
        "pkg-FABRIC-4.0.0-beta.12+1.16.5" = _OCSqVALy;
        "pkg-FORGE-4.0.0-beta.12+1.16.5" = _26AuQb5f;
        "pkg-FABRIC-4.0.0-beta.12+1.17.1" = _I6ccun0c;
        "pkg-FORGE-4.0.0-beta.12+1.17.1" = _Z4NQVoyd;
        "pkg-FABRIC-4.0.0-beta.12+1.18.2" = _NbTWgHAy;
        "pkg-FORGE-4.0.0-beta.12+1.18.2" = _x3bTRnjY;
        "pkg-FABRIC-4.0.0-beta.12+1.19.2" = _42CK8ygC;
        "pkg-FORGE-4.0.0-beta.12+1.19.2" = _lH8g4U7F;
        "pkg-FABRIC-4.0.0-beta.12+1.19.4" = _c3JYdBzs;
        "pkg-FORGE-4.0.0-beta.12+1.19.4" = _Z9RChpuK;
        "pkg-FABRIC-4.0.0-beta.12+1.20.1" = _RYoFUgVw;
        "pkg-FORGE-4.0.0-beta.12+1.20.1" = _zsWs2yWU;
        "pkg-FABRIC-4.0.0-beta.12+1.20.4" = _mXICFvaQ;
        "pkg-FORGE-4.0.0-beta.12+1.20.4" = _vR0uWpmj;
        "pkg-FABRIC-4.0.0-beta.13+1.16.5" = _vPI5xdaQ;
        "pkg-FORGE-4.0.0-beta.13+1.16.5" = _JxLc82I0;
        "pkg-FABRIC-4.0.0-beta.13+1.17.1" = _kASXBsMJ;
        "pkg-FORGE-4.0.0-beta.13+1.17.1" = _pJe2NZTb;
        "pkg-FABRIC-4.0.0-beta.13+1.18.2" = _MaxO7k6A;
        "pkg-FORGE-4.0.0-beta.13+1.18.2" = _Dbza0kye;
        "pkg-FABRIC-4.0.0-beta.13+1.19.2" = _cs4ZLTEJ;
        "pkg-FORGE-4.0.0-beta.13+1.19.2" = _5NVQQDKl;
        "pkg-FABRIC-4.0.0-beta.13+1.19.4" = _wtY9o3dW;
        "pkg-FORGE-4.0.0-beta.13+1.19.4" = _phlYRLzT;
        "pkg-FABRIC-4.0.0-beta.13+1.20.1" = _FB4iCEYb;
        "pkg-FORGE-4.0.0-beta.13+1.20.1" = _vLxS77XR;
        "pkg-FABRIC-4.0.0-beta.13+1.20.4" = _dgi7x3xt;
        "pkg-FORGE-4.0.0-beta.13+1.20.4" = _znjvTeA9;
        "pkg-FABRIC-4.0.0-beta.14+1.16.5" = _wzAB63jg;
        "pkg-FORGE-4.0.0-beta.14+1.16.5" = _hQZiK5H3;
        "pkg-FABRIC-4.0.0-beta.14+1.17.1" = _FhugLlqQ;
        "pkg-FORGE-4.0.0-beta.14+1.17.1" = _sLUpgh5A;
        "pkg-FABRIC-4.0.0-beta.14+1.18.2" = _A2IlLGTd;
        "pkg-FORGE-4.0.0-beta.14+1.18.2" = _imx2fhvt;
        "pkg-FABRIC-4.0.0-beta.14+1.19.2" = _V4dv2y3k;
        "pkg-FORGE-4.0.0-beta.14+1.19.2" = _O4qpuM87;
        "pkg-FABRIC-4.0.0-beta.14+1.19.4" = _9kMQzkif;
        "pkg-FORGE-4.0.0-beta.14+1.19.4" = _zPFXDtGX;
        "pkg-FABRIC-4.0.0-beta.14+1.20.1" = _ecJih0Dp;
        "pkg-FORGE-4.0.0-beta.14+1.20.1" = _OhnFqAHH;
        "pkg-FABRIC-4.0.0-beta.14+1.20.4" = _tqUyAosA;
        "pkg-FORGE-4.0.0-beta.14+1.20.4" = _BMwgk30R;
        "pkg-FABRIC-4.0.0-beta.15+1.16.5" = _BERHtrst;
        "pkg-FORGE-4.0.0-beta.15+1.16.5" = _E2HVqHdh;
        "pkg-FABRIC-4.0.0-beta.15+1.17.1" = _p5h7A1GW;
        "pkg-FORGE-4.0.0-beta.15+1.17.1" = _QKQP7Pq5;
        "pkg-FABRIC-4.0.0-beta.15+1.18.2" = _wFCwLADa;
        "pkg-FORGE-4.0.0-beta.15+1.18.2" = _VcbL2MSW;
        "pkg-FABRIC-4.0.0-beta.15+1.19.2" = _fzIFQ4Me;
        "pkg-FORGE-4.0.0-beta.15+1.19.2" = _3P1gM3QU;
        "pkg-FABRIC-4.0.0-beta.15+1.19.4" = _3nGGYcu5;
        "pkg-FORGE-4.0.0-beta.15+1.19.4" = _izPU72YU;
        "pkg-FABRIC-4.0.0-beta.15+1.20.1" = _13GkE1TZ;
        "pkg-FORGE-4.0.0-beta.15+1.20.1" = _jj3WD93M;
        "pkg-FABRIC-4.0.0-beta.15+1.20.4" = _HrUwunPZ;
        "pkg-FORGE-4.0.0-beta.15+1.20.4" = _j4d4bU9W;
        "pkg-FABRIC-4.0.0-beta.15+h1+1.16.5" = _jjIttndU;
        "pkg-FORGE-4.0.0-beta.15+h1+1.16.5" = _x0XPZLMP;
        "pkg-FABRIC-4.0.0-beta.15+h1+1.17.1" = _TaWFkitG;
        "pkg-FORGE-4.0.0-beta.15+h1+1.17.1" = _PtR2YwWr;
        "pkg-FABRIC-4.0.0-beta.15+h1+1.18.2" = _wmMkXO4C;
        "pkg-FORGE-4.0.0-beta.15+h1+1.18.2" = _4LEKB6Xj;
        "pkg-FABRIC-4.0.0-beta.15+h1+1.19.2" = _ezXyPZ6I;
        "pkg-FORGE-4.0.0-beta.15+h1+1.19.2" = _EbdHDclv;
        "pkg-FABRIC-4.0.0-beta.15+h1+1.19.4" = _HPHko28z;
        "pkg-FORGE-4.0.0-beta.15+h1+1.19.4" = _G9D1s8c3;
        "pkg-FABRIC-4.0.0-beta.15+h1+1.20.1" = _hmZ8FVDo;
        "pkg-FORGE-4.0.0-beta.15+h1+1.20.1" = _cFlYBfRG;
        "pkg-FABRIC-4.0.0-beta.15+h1+1.20.4" = _qY0kTrcL;
        "pkg-FORGE-4.0.0-beta.15+h1+1.20.4" = _OZuXjWJQ;
        "pkg-FABRIC-4.0.0-beta.16+1.16.5" = _X9tLz0zo;
        "pkg-FORGE-4.0.0-beta.16+1.16.5" = _dfYkissy;
        "pkg-FABRIC-4.0.0-beta.16+1.17.1" = _kgb0ueHL;
        "pkg-FORGE-4.0.0-beta.16+1.17.1" = _zNAzlQNR;
        "pkg-FABRIC-4.0.0-beta.16+1.18.2" = _s02j0ffs;
        "pkg-FORGE-4.0.0-beta.16+1.18.2" = _XquU3Zhm;
        "pkg-FABRIC-4.0.0-beta.16+1.19.2" = _yYqxCcq3;
        "pkg-FORGE-4.0.0-beta.16+1.19.2" = _PS3YIuTq;
        "pkg-FABRIC-4.0.0-beta.16+1.19.4" = _VUNEyLJu;
        "pkg-FORGE-4.0.0-beta.16+1.19.4" = _p4nKKNj8;
        "pkg-FABRIC-4.0.0-beta.16+1.20.1" = _h9jrjy0t;
        "pkg-FORGE-4.0.0-beta.16+1.20.1" = _S33t7jzH;
        "pkg-FABRIC-4.0.0-beta.16+1.20.4" = _s52asPeQ;
        "pkg-FORGE-4.0.0-beta.16+1.20.4" = _isv8NFki;
        "pkg-FABRIC-4.0.0-prerelease.1+1.16.5" = _ewZsj16f;
        "pkg-FORGE-4.0.0-prerelease.1+1.16.5" = _UZkN55gY;
        "pkg-FABRIC-4.0.0-prerelease.1+1.17.1" = _KSPMjlbZ;
        "pkg-FORGE-4.0.0-prerelease.1+1.17.1" = _iIzbI3ew;
        "pkg-FABRIC-4.0.0-prerelease.1+1.18.2" = _XyQbUYFS;
        "pkg-FORGE-4.0.0-prerelease.1+1.18.2" = _amMHn1EM;
        "pkg-FABRIC-4.0.0-prerelease.1+1.19.2" = _x0ce25MU;
        "pkg-FORGE-4.0.0-prerelease.1+1.19.2" = _x9eglOpO;
        "pkg-FABRIC-4.0.0-prerelease.1+1.19.4" = _QhVWySZh;
        "pkg-FORGE-4.0.0-prerelease.1+1.19.4" = _4CP3GXPw;
        "pkg-FABRIC-4.0.0-prerelease.1+1.20.1" = _Bqd0L1xb;
        "pkg-FORGE-4.0.0-prerelease.1+1.20.1" = _jEMoufcV;
        "pkg-FABRIC-4.0.0-prerelease.1+1.20.4" = _m5FzUgYv;
        "pkg-FORGE-4.0.0-prerelease.1+1.20.4" = _l0QvutRd;
        "pkg-FABRIC-4.0.0-prerelease.2+1.16.5" = _g6WKCNSk;
        "pkg-FORGE-4.0.0-prerelease.2+1.16.5" = _tzEDjJQU;
        "pkg-FABRIC-4.0.0-prerelease.2+1.17.1" = _qDVJrmUk;
        "pkg-FORGE-4.0.0-prerelease.2+1.17.1" = _M8p0x3Ut;
        "pkg-FABRIC-4.0.0-prerelease.2+1.18.2" = _UKoqxhIP;
        "pkg-FORGE-4.0.0-prerelease.2+1.18.2" = _TbtqifpD;
        "pkg-FABRIC-4.0.0-prerelease.2+1.19.2" = _2IxrkNqs;
        "pkg-FORGE-4.0.0-prerelease.2+1.19.2" = _uAcN15Gg;
        "pkg-FABRIC-4.0.0-prerelease.2+1.19.4" = _bly3hKvK;
        "pkg-FORGE-4.0.0-prerelease.2+1.19.4" = _fpVwuky7;
        "pkg-FABRIC-4.0.0-prerelease.2+1.20.1" = _dJbU5xac;
        "pkg-FORGE-4.0.0-prerelease.2+1.20.1" = _ZnQpfPNh;
        "pkg-FABRIC-4.0.0-prerelease.2+1.20.4" = _YsD2L8qM;
        "pkg-FORGE-4.0.0-prerelease.2+1.20.4" = _z9VGMBZE;
        "pkg-FABRIC-4.0.0-prerelease.3+1.16.5" = _bac3BkXw;
        "pkg-FORGE-4.0.0-prerelease.3+1.16.5" = _W2bVKOlw;
        "pkg-FABRIC-4.0.0-prerelease.3+1.17.1" = _ZlDleP8D;
        "pkg-FORGE-4.0.0-prerelease.3+1.17.1" = _16NFCEr6;
        "pkg-FABRIC-4.0.0-prerelease.3+1.18.2" = _PzzeNd1T;
        "pkg-FORGE-4.0.0-prerelease.3+1.18.2" = _1k4EsSUG;
        "pkg-FABRIC-4.0.0-prerelease.3+1.19.2" = _AuvuoXyv;
        "pkg-FORGE-4.0.0-prerelease.3+1.19.2" = _QzDiQKg0;
        "pkg-FABRIC-4.0.0-prerelease.3+1.19.4" = _Zn54oBpQ;
        "pkg-FORGE-4.0.0-prerelease.3+1.19.4" = _bvx2Y6H2;
        "pkg-FABRIC-4.0.0-prerelease.3+1.20.1" = _skFrF2U9;
        "pkg-FORGE-4.0.0-prerelease.3+1.20.1" = _b4ieSHV5;
        "pkg-FABRIC-4.0.0-prerelease.3+1.20.4" = _yrJ1vwEM;
        "pkg-FORGE-4.0.0-prerelease.3+1.20.4" = _Fbt7hZDS;
        "pkg-FABRIC-4.0.0+1.16.5" = _DvmegREQ;
        "pkg-FORGE-4.0.0+1.16.5" = _v3527NTl;
        "pkg-FABRIC-4.0.0+1.17.1" = _s2fHbUjB;
        "pkg-FORGE-4.0.0+1.17.1" = _j4eexpSm;
        "pkg-FABRIC-4.0.0+1.18.2" = _Y7sijxJ2;
        "pkg-FORGE-4.0.0+1.18.2" = _ibC3VidX;
        "pkg-FABRIC-4.0.0+1.19.2" = _J4jLvtN3;
        "pkg-FORGE-4.0.0+1.19.2" = _QIzsRbgB;
        "pkg-FABRIC-4.0.0+1.19.4" = _XKPXn5Pw;
        "pkg-FORGE-4.0.0+1.19.4" = _CO4zr0BA;
        "pkg-FABRIC-4.0.0+1.20.1" = _CZyqzbQv;
        "pkg-FORGE-4.0.0+1.20.1" = _9lz7wQ0F;
        "pkg-FABRIC-4.0.0+1.20.4" = _MIl8r9Bx;
        "pkg-FORGE-4.0.0+1.20.4" = _Of23EioC;
        "pkg-FABRIC-4.0.1+1.16.5" = _iKJpmESD;
        "pkg-FORGE-4.0.1+1.16.5" = _Y4ugnRcJ;
        "pkg-FABRIC-4.0.1+1.17.1" = _5NZn5N2l;
        "pkg-FORGE-4.0.1+1.17.1" = _4I0nmcGj;
        "pkg-FABRIC-4.0.1+1.18.2" = _Mw76HESP;
        "pkg-FORGE-4.0.1+1.18.2" = _2ncvz6ml;
        "pkg-FABRIC-4.0.1+1.19.2" = _V496JLow;
        "pkg-FORGE-4.0.1+1.19.2" = _a3Li5QWn;
        "pkg-FABRIC-4.0.1+1.19.4" = _2Q3BknsP;
        "pkg-FORGE-4.0.1+1.19.4" = _Il1EMIM4;
        "pkg-FABRIC-4.0.1+1.20.1" = _xWPyYCJk;
        "pkg-FORGE-4.0.1+1.20.1" = _fhWeejb4;
        "pkg-FABRIC-4.0.1+1.20.4" = _C1FESmTv;
        "pkg-FORGE-4.0.1+1.20.4" = _gSOSLCVv;
        "pkg-FABRIC-4.0.2+1.16.5" = _FPIdEOOo;
        "pkg-FORGE-4.0.2+1.16.5" = _pcBT1d9l;
        "pkg-FABRIC-4.0.2+1.17.1" = _zDrDvDZd;
        "pkg-FORGE-4.0.2+1.17.1" = _gaEKfaJK;
        "pkg-FABRIC-4.0.2+1.18.2" = _oEPd7mD0;
        "pkg-FORGE-4.0.2+1.18.2" = _9c330Y7Z;
        "pkg-FABRIC-4.0.2+1.19.2" = _U0J2sctO;
        "pkg-FORGE-4.0.2+1.19.2" = _vInqIoHg;
        "pkg-FABRIC-4.0.2+1.19.4" = _CzoY0Miq;
        "pkg-FORGE-4.0.2+1.19.4" = _i0gMeqJK;
        "pkg-FABRIC-4.0.2+1.20.1" = _CbyKnqvD;
        "pkg-FORGE-4.0.2+1.20.1" = _wzDHjSmv;
        "pkg-FABRIC-4.0.2+1.20.4" = _oiT1NRd2;
        "pkg-FORGE-4.0.2+1.20.4" = _odxBerDn;
        "pkg-FABRIC-4.0.2-hotfix-1+1.16.5" = _Amw1F9eW;
        "pkg-FORGE-4.0.2-hotfix-1+1.16.5" = _DXkhuTif;
        "pkg-FABRIC-4.0.2-hotfix-1+1.17.1" = _KYyhDcz2;
        "pkg-FORGE-4.0.2-hotfix-1+1.17.1" = _XCkJoitp;
        "pkg-FABRIC-4.0.2-hotfix-1+1.18.2" = _WNLjsxUz;
        "pkg-FORGE-4.0.2-hotfix-1+1.18.2" = _dkNNFcm8;
        "pkg-FABRIC-4.0.2-hotfix-1+1.19.2" = _7dZU41Ml;
        "pkg-FORGE-4.0.2-hotfix-1+1.19.2" = _R4FlLBp2;
        "pkg-FABRIC-4.0.2-hotfix-1+1.19.4" = _TtOS845V;
        "pkg-FORGE-4.0.2-hotfix-1+1.19.4" = _ndbz20L8;
        "pkg-FABRIC-4.0.2-hotfix-1+1.20.1" = _qaNWCTnK;
        "pkg-FORGE-4.0.2-hotfix-1+1.20.1" = _sZMRP95U;
        "pkg-FABRIC-4.0.2-hotfix-1+1.20.4" = _aXtsyhTi;
        "pkg-FORGE-4.0.2-hotfix-1+1.20.4" = _gCSlVF8z;
        "pkg-FABRIC-4.0.3+1.16.5" = _xE6FklsG;
        "pkg-FORGE-4.0.3+1.16.5" = _DchG4pin;
        "pkg-FABRIC-4.0.3+1.17.1" = _TOejTISL;
        "pkg-FORGE-4.0.3+1.17.1" = _4BT9bwXn;
        "pkg-FABRIC-4.0.3+1.18.2" = _MNRLVMKl;
        "pkg-FORGE-4.0.3+1.18.2" = _ySrdvIXG;
        "pkg-FABRIC-4.0.3+1.19.2" = _uqPmm0nj;
        "pkg-FORGE-4.0.3+1.19.2" = _fEriqlpo;
        "pkg-FABRIC-4.0.3+1.19.4" = _LuWw0f6O;
        "pkg-FORGE-4.0.3+1.19.4" = _1aAAmNrS;
        "pkg-FABRIC-4.0.3+1.20.1" = _CfSOdXCI;
        "pkg-FORGE-4.0.3+1.20.1" = _Fc07qRMD;
        "pkg-FABRIC-4.0.3+1.20.4" = _ZNG177tr;
        "pkg-FORGE-4.0.3+1.20.4" = _Wrk3lHbH;
        "pkg-FABRIC-4.0.4+1.16.5" = _Pk7FRm7n;
        "pkg-FORGE-4.0.4+1.16.5" = _bznn8GXR;
        "pkg-FABRIC-4.0.4+1.17.1" = _qfNz3AZo;
        "pkg-FORGE-4.0.4+1.17.1" = _VpH5zqh7;
        "pkg-FABRIC-4.0.4+1.18.2" = _3Bc1Iv4I;
        "pkg-FORGE-4.0.4+1.18.2" = _Ct3Nxp2t;
        "pkg-FABRIC-4.0.4+1.19.2" = _ojVTxOqI;
        "pkg-FORGE-4.0.4+1.19.2" = _YzLmbjM4;
        "pkg-FABRIC-4.0.4+1.19.4" = _JNMO1sGP;
        "pkg-FORGE-4.0.4+1.19.4" = _b4UDfxUi;
        "pkg-FABRIC-4.0.4+1.20.1" = _MLndo8pq;
        "pkg-FORGE-4.0.4+1.20.1" = _9mQ07Jkk;
        "pkg-FABRIC-4.0.4+1.20.4" = _3AUEeB1V;
        "pkg-FORGE-4.0.4+1.20.4" = _H9X4mxl2;
        "pkg-FABRIC-4.1.0-beta.1+1.21.4" = _m6VCMjiR;
        "pkg-NEOFORGE-4.1.0-beta.1+1.21.4" = _7kgUfcXW;
        "pkg-FABRIC-4.1.0-beta.1+1.21.1" = _kJgdoRQY;
        "pkg-NEOFORGE-4.1.0-beta.1+1.21.1" = _UrzDVdp2;
        "pkg-FABRIC-4.0.5+1.16.5" = _Nb5Dxsek;
        "pkg-FORGE-4.0.5+1.16.5" = _m5DXsKjR;
        "pkg-FABRIC-4.0.5+1.17.1" = _cf1Xno7R;
        "pkg-FORGE-4.0.5+1.17.1" = _RkhyobQe;
        "pkg-FABRIC-4.0.5+1.18.2" = _C9xMNlKz;
        "pkg-FORGE-4.0.5+1.18.2" = _a2jX8GYL;
        "pkg-FABRIC-4.0.5+1.19.2" = _dxMyJpyd;
        "pkg-FORGE-4.0.5+1.19.2" = _XlfSP0wr;
        "pkg-FABRIC-4.0.5+1.19.4" = _X42hBwWK;
        "pkg-FORGE-4.0.5+1.19.4" = _RIlK5qil;
        "pkg-FABRIC-4.0.5+1.20.1" = _5cxaj3g8;
        "pkg-FORGE-4.0.5+1.20.1" = _R05lh1Ys;
        "pkg-FABRIC-4.0.5+1.20.4" = _Xurz5xWy;
        "pkg-FORGE-4.0.5+1.20.4" = _UZffT2wi;
        "pkg-FABRIC-4.1.0-beta.2+1.21.1" = _JSuVAgAb;
        "pkg-NEOFORGE-4.1.0-beta.2+1.21.1" = _9SDO8rYc;
        "pkg-FABRIC-4.1.0-beta.2+1.21.4" = _XCtvQnaw;
        "pkg-NEOFORGE-4.1.0-beta.2+1.21.4" = _uuC79bS1;
        "default" = _uuC79bS1;
    });
