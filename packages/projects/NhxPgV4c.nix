...
let
    ...
    in {
        ...
        "pkg-1.0" = _EdwohjPe;
        "pkg-1.0_mod" = _4bOZw5fh;
        "pkg-1.1" = _KDHPAzXC;
        "pkg-1.2" = _M32GJ5Ls;
        "pkg-1.2+mod" = _FH7UiLOF;
        "pkg-1.3" = _Npj8ygf0;
        "pkg-1.3+mod" = _p9KRlNk5;
        "pkg-2.0" = _qbfnro9Q;
        "pkg-2.0+mod" = _e3Iik9Rl;
        "pkg-2.1" = _ODQQYuE8;
        "pkg-2.1+mod" = _k3d3WldO;
        "pkg-2.2" = _m1y5coEe;
        "pkg-2.2+mod" = _EQKLpVLw;
        "pkg-3.0" = _ttcsCkqT;
        "pkg-3.0+mod" = _3IGoZHW9;
        "pkg-3.1" = _678sEEKt;
        "pkg-4.0" = _yRjWqJi1;
        "pkg-4.0+mod" = _b8u9CArE;
        "pkg-4.1" = _ANTgG4gL;
        "pkg-4.2" = _XQuZSc08;
        "pkg-4.2+mod" = _Zc00pmSH;
        "pkg-4.3" = _37hy3gkY;
        "pkg-4.3+mod" = _2YXgqRgV;
        "pkg-4.4" = _R6BzsMYg;
        "pkg-4.4+mod" = _uIdKv0iM;
        "pkg-5.0" = _7npi5aqO;
        "pkg-5.0+mod" = _YjJBXuCP;
        "pkg-5.1" = _YIZN2cVd;
        "pkg-5.1+mod" = _7hV7fS5e;
        "pkg-5.2" = _eiAzAz8z;
        "pkg-5.2-fabric" = _cFnewiQG;
        "pkg-5.2-forge" = _LLxOt79z;
        "pkg-5.6" = _7rZnPbsM;
        "pkg-5.6-fabric" = _Q8jMYj3v;
        "pkg-5.6-quilt" = _VyF1Yhxn;
        "pkg-5.6-forge" = _cVd53CiN;
        "pkg-5.6-neoforge" = _mz56Kr93;
        "pkg-5.7" = _neeDSfcL;
        "pkg-5.7-fabric" = _edHgqswd;
        "pkg-5.7-quilt" = _vJqjCZpj;
        "pkg-5.7-forge" = _ZdfOE8lp;
        "pkg-5.7-neoforge" = _UQrjWYfm;
        "default" = _UQrjWYfm;
    });
