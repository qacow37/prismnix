...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _9XGGoI9h;
        "pkg-1.0.9" = _w35Qe2Dx;
        "pkg-1.0.10" = _OkBEKFmv;
        "pkg-1.1.0" = _qba8oN2G;
        "pkg-1.1.1" = _jH6vuDJK;
        "pkg-1.0.11" = _S0uOqWuV;
        "pkg-1.0.12" = _xtTTwPl6;
        "pkg-1.0.13" = _6SNHadUt;
        "pkg-1.0.14" = _Uh7DwBKC;
        "pkg-1.0.15" = _YLocdcRM;
        "pkg-1.1.2" = _Mk1fz49U;
        "pkg-1.20.1-1.1.0" = _6IOUirgC;
        "pkg-1.20.1-1.1.1" = _6nETDLbT;
        "pkg-1.20.1-1.1.2" = _vpC7hbSt;
        "pkg-1.1.3" = _gjoGhykP;
        "pkg-1.2.0" = _vPAqRrSn;
        "pkg-1.2.1" = _BwA30pf8;
        "pkg-1.2.2" = _jOKLl9Xy;
        ...
        "pkg-1.4.1" = _EaVleUHQ;
        "pkg-1.4.2" = _bcIKtYdH;
        "pkg-1.21.1-1.5.0" = _t1hE1itS;
        "pkg-1.21.1-1.5.1" = _DFzYjpLs;
        "pkg-1.21.1-1.5.2" = _rshXgdCx;
        "pkg-1.21.1-1.5.3" = _j3n8QuGJ;
        "pkg-1.21.1-1.5.4" = _4HG65pBN;
        "pkg-1.4.3" = _yvAhnqUS;
        "pkg-1.4.4" = _tFyx1rpf;
        "pkg-1.4.5" = _DK9YyhDH;
        "pkg-1.4.6" = _5iUJj8L0;
        "pkg-1.4.7" = _pdPDVn1Y;
        "pkg-1.21.1-1.5.5" = _HeWkfn4P;
        "pkg-1.21.1-1.5.6" = _vk0tuqzk;
        "pkg-1.21.1-1.5.7" = _kX9Pps4a;
        "pkg-1.21.1-1.5.8" = _bAjFtQzT;
        "default" = _bAjFtQzT;
    });
