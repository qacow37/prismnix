...
let
    ...
    in {
        ...
        "pkg-1.8.0" = _lfCIkr2l;
        "pkg-1.9.0" = _daCXFcO2;
        "pkg-1.10.0" = _c5FpdttZ;
        "pkg-1.10.1" = _vt7W9RH2;
        "pkg-1.10.2" = _Nc0lCOWZ;
        "pkg-1.11.0" = _xZ04KCij;
        "pkg-1.7.2" = _8k9apolu;
        "pkg-1.12.0" = _kVTwWhV5;
        "pkg-1.13.0" = _kRfMRorU;
        "pkg-1.13.1" = _oVX9fGT1;
        "pkg-1.14.0" = _uNIf0CU3;
        "pkg-1.14.1" = _zSanwBJi;
