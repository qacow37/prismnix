...
let
    ...
    in {
        ...
        "pkg-1.0.0-neoforge" = _ZDiKZXOd;
        "pkg-1.0.0-fabric" = _B96fQtDr;
        "pkg-1.0.1-fabric" = _pRGJJXyq;
        "pkg-1.0.1-neoforge" = _SWb2m8BW;
        "pkg-1.0.2-fabric" = _4YxPQHXX;
        "pkg-1.0.2-neoforge" = _KIdRbjaU;
        "pkg-1.0.3-fabric" = _4c1r6QFK;
        "pkg-1.0.3-neoforge" = _aQe5Y67S;
        "pkg-1.1.0-neoforge" = _8X5mkvEg;
        "pkg-1.1.0-fabric" = _dgV6xYnu;
        "pkg-1.2.0-neoforge" = _ekBnLSOg;
        "pkg-1.2.0-fabric" = _36e4pAjG;
        "pkg-1.2.1-neoforge" = _QVuWIzFV;
        "pkg-1.2.1-fabric" = _M3cGhJrB;
        "pkg-1.2.2-fabric" = _4W4uMb6j;
        "pkg-1.2.2-neoforge" = _ept5CTIc;
        "pkg-1.2.3-fabric" = _wSB51gH7;
        "pkg-1.2.3-neoforge" = _MrEGuufB;
        "pkg-1.2.4-fabric" = _bFprRSZy;
        "pkg-1.2.4-neoforge" = _2WNsQfpV;
        "pkg-1.2.5-neoforge" = _Fk9yqwwA;
        "pkg-1.2.5-fabric" = _OW8t5Seb;
        "default" = _OW8t5Seb;
    });
