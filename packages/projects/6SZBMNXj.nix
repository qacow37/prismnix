...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _aO3IGDoT;
        "pkg-1.2.0.230528" = _FtUqMTvA;
        "pkg-1.2.0.230615" = _ZNz893ez;
        "pkg-1.2.0" = _xG9cTvVZ;
        "pkg-1.2.1" = _Iu7vTNAm;
        "pkg-1.3.0.230705" = _le0YQiho;
        "pkg-1.3.0.230707" = _UxANFFSS;
        "pkg-1.3.0.230715" = _30fGxxoj;
        "pkg-1.3.0.230718" = _iOjRhVXx;
        "pkg-1.3.0.230719" = _LOHqBD8C;
        "pkg-1.3.0" = _iiw2bGtd;
        "pkg-1.3.1" = _R3mAW8gH;
        "pkg-1.3.2" = _uEUofBHO;
        "pkg-1.3.3" = _hmBsqlOK;
        "pkg-1.3.4" = _Jc7ipIZB;
        "pkg-1.4.0.230801" = _X0YPLVDz;
        "pkg-1.3.5" = _egcqe1Ht;
        "pkg-1.3.6" = _OJPhwzOo;
        "pkg-1.4.0.230805" = _OHVEIt1f;
        "pkg-1.4.0.230810" = _5hkHXKVJ;
        "pkg-1.3.7" = _soHD66OE;
        "pkg-1.4.0.230814" = _hGVWG9MW;
        "pkg-1.4.0.230816" = _Xp5Y2ANG;
        "pkg-1.3.8" = _cYbocdeC;
        "pkg-1.3.9" = _13myhsmj;
        "pkg-1.4.0.230825" = _ysAlVD13;
        "pkg-1.3.10" = _DsoeMbeo;
        "pkg-1.4.0.231016" = _aWxqBMOv;
        "pkg-1.4.0.231025" = _W82joWXR;
        "pkg-1.4.0.231031" = _ZhjI14AX;
        "pkg-1.4.0.231111" = _8LVR26zT;
        "pkg-1.4.0.231119" = _2l4ai26g;
        "pkg-1.4.0" = _IgxVR77v;
        "pkg-1.4.1" = _YMC9gArt;
        "pkg-1.4.2" = _lwYSYIuM;
        "pkg-1.4.3" = _395giNH1;
