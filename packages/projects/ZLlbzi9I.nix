...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18.2" = _HoKkDUem;
        "pkg-1.0.1+1.18.2" = _olP6ctZX;
        "pkg-1.1.0+1.18.2" = _Rh0vKaRt;
        "pkg-1.1.0+1.19.2" = _9NLgoOkV;
        "pkg-1.1.1+1.18.2" = _2x5KRtO8;
        "pkg-1.1.1+1.19.2" = _fkxfRJxS;
        "pkg-1.1.2+1.18.2" = _jW5voHLW;
        "pkg-1.1.2+1.19.2" = _Ewpt2SCn;
        "pkg-1.2.0+1.18.2" = _G2ceGqOn;
        "pkg-1.2.0+1.19.2" = _PF3Z9KNG;
        "pkg-1.2.1+1.18.2" = _lZV6E5bq;
        "pkg-1.2.1+1.19.2" = _E99W55fz;
        "pkg-1.2.2+1.18.2" = _HJXL3RbX;
        "pkg-1.2.2+1.19.2" = _WYNfuvol;
        "pkg-1.3.0+1.18" = _kDeM6grE;
        "pkg-1.3.0+1.19" = _vX9TQHkc;
        "pkg-1.3.1+1.18" = _WEx9tLHX;
        "pkg-1.3.1+1.19" = _mMX6uUSZ;
        "pkg-1.4.0+1.18" = _WOJZvPqu;
        "pkg-1.4.0+1.19" = _EkFw0wtv;
        "pkg-1.5.3+1.19" = _dNe3rWGk;
        "pkg-1.5.4+1.19" = _livpeip8;
        "pkg-1.5.5+1.19" = _SB9fp0SP;
        "pkg-1.5.6+1.19" = _2178NY2E;
        "pkg-1.7.0+1.19" = _wNUd7Hmt;
        "pkg-1.7.1+1.19" = _WrnMIF40;
        "pkg-1.7.2+1.19" = _QEQteqQ5;
        "pkg-1.8.0+1.19" = _F0ayY4tQ;
        "pkg-1.8.1+1.19" = _5zDpzGGZ;
        "pkg-1.8.2+1.19" = _QfOTVDPG;
        "pkg-1.8.3+1.19" = _9AGPWejS;
        "pkg-1.8.3+1.21" = _JdjfOPyT;
        "pkg-1.8.4+1.19" = _8kjhRelo;
        "pkg-1.8.4+1.21" = _gJs1XWK2;
        "default" = _gJs1XWK2;
    });
