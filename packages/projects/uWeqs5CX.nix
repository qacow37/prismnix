...
let
    ...
    in {
        ...
        "pkg-1.0.0-BETA-build.5" = _aSV2zQJi;
        "pkg-1.0.0-BETA-build.7" = _lL9gl3q4;
        "pkg-1.1.0-BETA-build.1" = _oxVs6lU7;
        "pkg-1.1.0-BETA-build.2" = _XfI5dyev;
        "pkg-1.1.0-BETA-build.4" = _a287r2AB;
        "pkg-mc1.20.1-1.2.0" = _AfMkfpIn;
        "pkg-mc1.20.4-1.2.0" = _V0KiODtW;
        "pkg-mc1.20.6-1.2.0" = _hS2pLJJm;
        "pkg-mc1.21-1.2.0" = _reZD7rCv;
        "pkg-mc1.20.1-1.2.1" = _SI8QxaHZ;
        "pkg-mc1.20.4-1.2.1" = _9xjcr5b5;
        "pkg-mc1.20.6-1.2.1" = _LBTeTYOr;
        "pkg-mc1.21-1.2.1" = _alMoCpYl;
        "pkg-mc1.20.1-1.2.2" = _c4k3PiJC;
        "pkg-mc1.20.4-1.2.2" = _RK6mQN2C;
        "pkg-mc1.20.6-1.2.2" = _iIz3flAX;
        "pkg-mc1.21-1.2.2" = _Ws5s6aPz;
        "pkg-mc1.20.1-1.2.3" = _D1JI812z;
        "pkg-mc1.20.4-1.2.3" = _y6O4mSzg;
        "pkg-mc1.20.6-1.2.3" = _urfl3mx6;
        "pkg-mc1.21-1.2.3" = _DiEF6fLc;
        "pkg-mc1.20.1-1.2.4" = _HvGVHFLd;
        "pkg-mc1.20.4-1.2.4" = _b7avMFuL;
        "pkg-mc1.20.6-1.2.4" = _sGnWwxUe;
        "pkg-mc1.21-1.2.4" = _re6WKWsy;
        "pkg-mc1.21-1.3.0" = _p7uxLueC;
        "pkg-mc1.21-1.3.1" = _KErtNmBX;
        "pkg-mc1.21-1.4.0" = _7XGCBbN5;
        "pkg-mc1.21-1.5.0" = _ZvwCa3mb;
        "pkg-mc1.21-1.5.1" = _jvtfe3gU;
        "pkg-mc1.21-1.5.2" = _8tJ5KE5m;
        "pkg-mc1.21-1.5.3" = _xbxU7uec;
        "pkg-mc1.21-1.5.4" = _fhyYLNNE;
        "pkg-mc1.21.1-1.6.0-beta.1" = _x76spbvy;
        "pkg-mc1.21.1-1.6.0-beta.2-neoforge" = _IB0AVL8g;
        "pkg-mc1.21.1-1.6.0-beta.2-fabric" = _xuerjRSG;
        "pkg-mc1.21.1-1.6.0-beta.3-neoforge" = _4jdS6BaH;
        "pkg-mc1.21.1-1.6.0-beta.3-fabric" = _KCaGBl8d;
        "pkg-mc1.21.1-1.6.0-neoforge" = _qXM2Tmso;
        "pkg-mc1.21.1-1.6.0-fabric" = _8Mz3YQsU;
        "pkg-mc1.21.3-1.7.0-neoforge" = _m52DnX34;
        "pkg-mc1.21.3-1.7.0-fabric" = _3oWv0pBU;
        "pkg-mc1.21.4-1.7.1-neoforge" = _n5AAIHrR;
        "pkg-mc1.21.4-1.7.1-fabric" = _g5qm5xFE;
        "pkg-mc1.21.4-1.7.2-neoforge" = _mHZ1ffFn;
        "pkg-mc1.21.4-1.7.2-fabric" = _aRNzNo1T;
        "default" = _aRNzNo1T;
    });
