...
let
    ...
    in {
        ...
        "pkg-0.1.0-fabric" = _UwInHtnK;
        "pkg-0.1.0-forge" = _9TcaVVia;
        "pkg-0.1.1-fabric" = _VyeR13Ul;
        "pkg-0.1.1-forge" = _pd0Geu3p;
        "pkg-0.1.2-fabric" = _Tq95WStr;
        "pkg-0.1.2-forge" = _9mVr370i;
        "pkg-0.1.4d-fabric" = _CC9FFqHc;
        "pkg-0.1.4d-forge" = _oXV5YCrk;
        "pkg-0.1.5-fabric" = _nsO6f7m5;
        "pkg-0.1.5-forge" = _NfN96NpC;
        "pkg-0.2.0-fabric" = _PSUFKrvg;
        "pkg-0.2.0-forge" = _bQaK0ZR8;
        "pkg-0.2.1-fabric" = _mZnqCnCM;
        "pkg-0.2.1-forge" = _73rtMDa5;
        "pkg-0.3.0-fabric" = _fZ02oIwz;
        "pkg-0.3.0-forge" = _1lSEUa2K;
        "pkg-0.3.1-fabric" = _qAqI2FKH;
        "pkg-0.3.1-forge" = _Qy0i0wOt;
        "pkg-0.3.2-fabric" = _V9qt9iTO;
        "pkg-0.3.2-forge" = _YheZCBgc;
        "pkg-0.3.5-fabric" = _bkHaX0Iu;
        "pkg-0.3.5-forge" = _X4hzLXc4;
        "pkg-0.4.0-fabric" = _zoW4iEve;
        "pkg-0.4.0-forge" = _c0lAnzkT;
        "pkg-0.4.1-fabric" = _RNUj5Kli;
        "pkg-0.4.1-forge" = _VxZxVOrb;
        "pkg-0.4.2-fabric" = _2XdHV4Hn;
        "pkg-0.4.2-forge" = _c5ADQXQg;
        "pkg-0.4.3-fabric" = _NYCkTcYf;
        "pkg-0.4.3-forge" = _hw1r9jwP;
        "pkg-0.4.4-fabric" = _YlI57iUY;
        "pkg-0.4.4-forge" = _kiA0MBdH;
        "pkg-0.4.6-fabric" = _lZBXOSEt;
        "pkg-0.4.6-forge" = _clupv0Gj;
        "pkg-0.4.7-fabric" = _PaHYhOff;
        "pkg-0.4.7-forge" = _Dwqk4bs4;
        "pkg-0.4.8-fabric" = _xpaae7Df;
        "pkg-0.4.8-forge" = _1w9FdcOy;
        "pkg-0.4.9-fabric" = _QxsV3nI9;
        "pkg-0.4.9-forge" = _bYm4QSpd;
        "pkg-0.5.0-fabric" = _788tpQoG;
        "pkg-0.5.0-forge" = _M6m3Slbs;
        "pkg-0.5.1-fabric" = _B0pZPjA7;
        "pkg-0.5.1-forge" = _rizXlq54;
        "pkg-0.5.2-fabric" = _ZdFTJDy8;
        "pkg-0.5.2-forge" = _80wKRnEd;
        "pkg-0.6.0-fabric" = _6ZI3xnH5;
        "pkg-0.6.0-quilt" = _eIMdEbPN;
        "pkg-0.6.0-forge" = _IiRLMpBg;
        "pkg-0.6.2-fabric" = _YCA8JXFR;
        "pkg-0.6.2-quilt" = _uUqsEDsh;
        "pkg-0.6.3-forge" = _n7ozEODn;
        "pkg-0.6.3-1.19-forge" = _blFdmeJE;
        "pkg-0.6.3-1.19-fabric" = _5ZDJHeni;
        "pkg-0.6.3-1.19-quilt" = _FfvTdb01;
        "pkg-0.6.4-1.19-fabric" = _HxSQxWqB;
        "pkg-0.6.4-1.19-forge" = _hFyfdjtk;
        "pkg-0.6.4-1.19-quilt" = _Ze3RIgnS;
        "pkg-0.7.0-1.19-fabric" = _JulhGz4S;
        "pkg-0.7.0-1.19-forge" = _ZaEjK5KT;
        "pkg-0.7.0-1.19-quilt" = _N4O8ejSq;
        "pkg-0.7.1-1.19-fabric" = _vRQUQEdH;
        "pkg-0.7.1-1.19-quilt" = _L662ZW7p;
        "pkg-0.7.1-1.19-forge" = _qGktD7iQ;
        "pkg-1.0.0-1.19-fabric" = _BG5jWxpR;
        "pkg-1.0.0-1.19-forge" = _X30oWVYB;
        "pkg-1.0.0-1.19-quilt" = _9EHWe8Bn;
        "pkg-1.0.1-1.19.2-fabric" = _jxYUybJA;
        "pkg-1.0.1-1.19.2-quilt" = _XytQPP9y;
        "pkg-1.0.1-1.19.2-forge" = _nzJicnAh;
        "pkg-1.1.0-1.19.2-forge" = _bbhNiunM;
        "pkg-1.1.0-1.19.2-quilt" = _2RoV7FmU;
        "pkg-1.2.0" = _L0GthGHl;
        "pkg-2.0.0" = _EPCJoxv9;
        "pkg-3.0.0" = _IOm2PZNz;
        "pkg-3.0.1" = _vaNMC2tC;
