...
let
    ...
    in {
        ...
        "pkg-0.2.1" = _mfECfZZj;
        "pkg-0.2.2" = _Cg4tuOTd;
        "pkg-0.2.3+1.17" = _exUAMDHk;
        "pkg-0.2.3+1.16" = _K6Wtrryt;
        "pkg-0.2.4+1.17" = _D0dheJxK;
        "pkg-0.2.4+1.16" = _oJzl2nzN;
        "pkg-0.2.5+1.17" = _nLRrY5zb;
        "pkg-0.2.5+1.16" = _EyQyEjDd;
        "pkg-0.2.6+1.17" = _18YLAZ9X;
        "pkg-0.2.6+1.16" = _3BtdYLAx;
        "default" = _3BtdYLAx;
    });
