...
let
    ...
    in {
        ...
        "pkg-0.3.1" = _stIumhZm;
        "pkg-1.0.0" = _OH6jPctP;
        "pkg-1.1.0+1.21.4" = _Q8XclacO;
        "pkg-1.1.0+1.21.1" = _1O6tEbou;
        "pkg-1.1.1+1.21.4" = _c78u96hv;
        "pkg-1.1.1+1.21.1" = _obtk8b42;
        "pkg-1.1.2+1.21.4" = _XAmfdp0P;
        "pkg-1.1.2+1.21.1" = _uCUtSwe3;
        "pkg-1.2.0+1.21.4" = _FQ7B6UB3;
        "pkg-1.4.0+1.21.4" = _UlUPotHW;
        "pkg-1.4.0+1.21.1" = _fRYGK8yx;
        "pkg-1.4.1+1.21" = _TDEzfaQ1;
        "pkg-1.5.0+1.21" = _uyuRvWCo;
        "pkg-1.5.1+1.21" = _dAh3p96U;
        "pkg-1.5.1+1.21.1" = _iBIR15tQ;
        "pkg-1.5.1+1.21.2" = _SxigqJTk;
        "pkg-1.5.1+1.21.3" = _bNCQ7VFn;
        "pkg-1.5.1+1.21.4" = _NViGhdmM;
        "pkg-1.6.0+1.21" = _BCWh2aZT;
        "pkg-1.6.0+1.21.1" = _jTzB0LoC;
        "pkg-1.6.0+1.21.2" = _PSEZIvmh;
        "pkg-1.6.0+1.21.3" = _XB22aHH3;
        "pkg-1.6.0+1.21.4" = _V0bxnLjZ;
        "pkg-1.7.0+1.21" = _UpCHSd3o;
        "pkg-1.7.0+1.21.1" = _h7AWXfHX;
        "pkg-1.7.0+1.21.2" = _f5p11f0C;
        "pkg-1.7.0+1.21.3" = _F7tOFcUP;
        "pkg-1.7.0+1.21.4" = _VtOVx3Wt;
        "pkg-1.7.1+1.21" = _xkZ38NfX;
        "pkg-1.7.1+1.21.1" = _7rPmDzDC;
        "pkg-1.7.1+1.21.2" = _3TIfJIZg;
        "pkg-1.7.1+1.21.3" = _LjkUVGZT;
        "pkg-1.7.1+1.21.4" = _RZbZJ6l0;
        "pkg-1.7.2+1.21" = _yJDqNPXL;
        "pkg-1.7.2+1.21.1" = _hWNcKV86;
        "pkg-1.7.2+1.21.2" = _LCENBsKB;
        "pkg-1.7.2+1.21.3" = _ow6ON0gd;
        "pkg-1.7.2+1.21.4" = _L17yj4IU;
        "pkg-1.7.3+1.21.5" = _VsshQe99;
        "pkg-1.8.0+1.21" = _NuUi9IvY;
        "pkg-1.8.0+1.21.1" = _1nYE0kZ7;
        "pkg-1.8.0+1.21.2" = _19nmKtnN;
        "pkg-1.8.0+1.21.3" = _97LHQtHY;
        "pkg-1.8.0+1.21.4" = _od3bxaU0;
        "pkg-1.8.0+1.21.5" = _byIAQhEz;
        "pkg-1.8.1+1.21.5" = _IM5OXsr2;
        "pkg-1.8.1+1.21.4" = _trvKxJFK;
        "pkg-1.8.1+1.21.3" = _MViSYDDm;
        "pkg-1.8.1+1.21.2" = _aDBtk6xL;
        "pkg-1.8.1+1.21.1" = _H1r0XVz3;
        "pkg-1.8.1+1.21" = _nS5q0112;
        "pkg-1.8.2+1.21" = _kl0nPuqJ;
        "pkg-1.8.2+1.21.1" = _xFlUuWG1;
        "pkg-1.8.2+1.21.2" = _XR9NzDmr;
        "pkg-1.8.2+1.21.3" = _IR87c1hP;
        "pkg-1.8.2+1.21.4" = _9uplZtOO;
        "pkg-1.8.2+1.21.5" = _aqsJEyz0;
        "pkg-1.8.2+1.21.6" = _3v5VbpeU;
        "pkg-1.8.2+1.21.7" = _UdpPNkk5;
        "pkg-1.8.3+1.21" = _7IFzV9s7;
        "pkg-1.8.3+1.21.1" = _h1LV8KHC;
        "pkg-1.8.3+1.21.2" = _3FyhtIQC;
        "pkg-1.8.3+1.21.3" = _LUD7VCwO;
        "pkg-1.8.3+1.21.4" = _EHDe8kDk;
        "pkg-1.8.3+1.21.5" = _HtIlKblA;
        "pkg-1.8.3+1.21.6" = _PoAaMYYP;
        "default" = _PoAaMYYP;
    });
