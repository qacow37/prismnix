...
let
    ...
    in {
        ...
        "pkg-1.0.1-forge-1.21.5-55.1.4" = _ksDy02iz;
        "pkg-1.0.1-forge-1.21.8-58.1.11" = _c9VMZmqQ;
        "pkg-1.0.1-forge-1.21.10-60.1.0" = _eIStrqsf;
        "pkg-1.0.1-forge-1.21.11-61.1.1" = _fLaCEM10;
        "pkg-1.0.1-forge-26.1.2-64.0.0" = _U0MXIPgY;
        "pkg-1.0.1-neoforge-26.1.2.76" = _OyhKF7jJ;
        "pkg-1.0.1-fabric-26.2-0.152.1" = _pt7U76zC;
        "pkg-1.0.1-neoforge-1.21.1.234" = _KMH5rMLT;
        "pkg-1.0.1-neoforge-1.21.4.157" = _pg9VTmi1;
        "pkg-1.0.1-neoforge-1.21.5.97" = _E4NMPdlJ;
        "pkg-1.0.1-neoforge-1.21.8.53" = _72tfFtZy;
        "pkg-1.0.1-neoforge-1.21.10.64" = _r3EioVbC;
        "pkg-1.0.1-neoforge-1.21.11.42" = _ZHD4vEvK;
        "pkg-1.0.1-fabric-1.20.1-0.92.9" = _5AoqEzsy;
        "pkg-1.0.1-fabric-1.21.1-0.116.12" = _XulNUR4g;
        "pkg-1.0.1-fabric-1.21.4-0.119.4" = _zRUXawyv;
        "pkg-1.0.1-fabric-1.21.5-0.128.2" = _evmVmm7v;
