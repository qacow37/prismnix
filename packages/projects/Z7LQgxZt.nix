...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha.1" = _WJBUAGaR;
        "pkg-1.0.0-alpha.2+1.14.2" = _OhmNifcv;
        "pkg-1.0.0-alpha.3+1.14.2" = _F3hdTo2y;
        "pkg-1.0.0-alpha.4+1.14.2" = _LGHE2BTi;
        "pkg-1.0.0-alpha.5+1.14.2" = _rqJge72v;
        "pkg-1.0.0-alpha.6+1.14.2" = _x0Q9o0WU;
        "pkg-1.0.0-alpha.7+1.14.2" = _GibajazS;
        "pkg-1.0.0-alpha.8+1.14.2" = _ayxtg13H;
        "pkg-1.0.0-alpha.9+1.14.2" = _8cK0FcCT;
        "pkg-1.0.0-alpha.10+1.14.4" = _LMIpN4Ps;
        "pkg-1.0.0-alpha.11+1.14.4" = _LwkCC2U1;
        "pkg-1.0.0-alpha.12+1.14.4" = _VA3lgGOJ;
        "pkg-1.0.0-alpha.13+1.14.4" = _N7BNc1JL;
        "pkg-1.0.0-alpha.14+1.14.4" = _lktDc8he;
        "pkg-1.0.0-alpha.15+1.14.4" = _tPOu7G6N;
        "pkg-1.0.0-alpha.16" = _4W8JPjsA;
        "pkg-1.0.0-alpha.17" = _WJOqAEoV;
        "pkg-1.0.0-alpha.18" = _ChdNHsBs;
        "pkg-1.0.0-alpha.19" = _OQpcoWme;
        "pkg-1.0.0-alpha.20" = _Q9OWsymd;
        "pkg-1.0.0-alpha.21" = _TjW8TLzS;
        "pkg-1.0.0-alpha.22" = _VY9RIIEH;
        "pkg-1.0.0-alpha.23" = _pgt8forq;
        "pkg-1.0.0-alpha.24" = _a3Uo8u3k;
        "pkg-1.0.0-alpha.25" = _Tg6KisO9;
        "pkg-1.0.0-alpha.26" = _ZGxJ3GPf;
        "pkg-1.0.0-alpha.27" = _P2CQQnaa;
        "default" = _P2CQQnaa;
    });
