...
let
    ...
    in {
        ...
        "pkg-0.10.2" = _X9RIvGJl;
        "pkg-0.11c" = _hHZFP7Nc;
        "pkg-0.11.1" = _4O1OR6CC;
        "pkg-0.11.1b" = _uFQsimCl;
        "pkg-0.11.1c" = _QBbi1R5G;
        "pkg-0.11.2" = _DUjEFtv3;
        "pkg-0.11.3" = _P1lWbigl;
        "pkg-0.12" = _j07X4oTg;
        "pkg-0.12b" = _NBxyT1vm;
        "pkg-0.12.1" = _Jb4VlyQ3;
        "pkg-0.13" = _XD0TDmZj;
        "pkg-0.13.1" = _tCodJCRj;
        "pkg-0.14" = _Sa78uwsB;
        "pkg-0.14b" = _elkSLmQk;
        "pkg-0.14c" = _pYiPWhFV;
        "pkg-0.14.1" = _ZTXAVpa3;
        "pkg-0.14.1b" = _Pey8mWIH;
        "pkg-0.14.1c" = _pdJShJ6M;
        "pkg-0.15.0" = _Vy8E1gi5;
        "pkg-0.15.1" = _kfjCmoVZ;
        "pkg-0.15.2" = _9XKNH5uG;
        "pkg-0.15.3" = _c7iSTaYf;
        "pkg-0.15.4" = _iorILXPs;
        "pkg-0.15.5" = _dn53GqRk;
        "pkg-0.15.6" = _f5cjfYzj;
        "pkg-0.15.7" = _3SDIZyYX;
        "default" = _3SDIZyYX;
    });
