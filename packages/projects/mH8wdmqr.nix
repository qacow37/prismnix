...
let
    ...
    in {
        ...
        "pkg-9.0.1" = _8xqUc7yi;
        "pkg-9.0.2" = _UJO2jZrW;
        "pkg-10.0.1" = _UrASoguf;
        "pkg-11.0.1" = _HM1DC3fP;
        "pkg-11.0.2" = _AbXy0RGo;
        "pkg-5.0.4" = _aaFKGMy5;
        "pkg-12.0.1" = _KuoZuh9I;
        "pkg-12.0.2" = _6NXFsGRq;
        "pkg-13.0.1" = _O5WC7Lup;
        "pkg-13.0.2" = _YoWOh7pg;
        "pkg-14.0.1" = _koAy0xaA;
        "pkg-15.0.2" = _tbid5mCJ;
        "pkg-15.0.3" = _CdmIgWDn;
        "pkg-15.0.4" = _sHFMBi83;
        "pkg-5.0.5" = _6BbK7uZN;
        "pkg-12.0.3" = _PEvu8a2H;
        "pkg-21.1.1" = _lpTj4NHY;
        "pkg-21.1.2" = _89DVOwv1;
        "pkg-21.1.3" = _t2cb0Qn1;
        "pkg-21.1.4" = _Oh3tUtEX;
        "pkg-12.0.4" = _27cY3hS7;
