...
let
    ...
    in {
        ...
        "pkg-1.20.5-1.0-fabric+neo" = _MYinHczK;
        "pkg-1.20.5-1.1-fabric+neo" = _FiDazWzu;
        "pkg-1.20.6-1.1-fabric+forge+neo" = _CnUbCbXy;
        "pkg-1.21.0-1.1-fabric+forge+neo" = _xNLjGEIl;
        "pkg-1.20.1-1.2-fabric+forge+neo" = _gtofB3lp;
        "pkg-1.20.6-1.2-fabric+forge+neo" = _BZx5FXmd;
        "pkg-1.21.0-1.2-fabric+forge+neo" = _ZZV0jT89;
        "pkg-1.21.1-1.2-fabric+forge+neo" = _aGUITA2u;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _dmCar3Rp;
        "pkg-1.20.6-1.3-fabric+forge+neo" = _5H5yE6EQ;
        "pkg-1.21.1-1.3-fabric+forge+neo" = _WGuXuwwz;
        "pkg-1.21.2-1.3-fabric+neo" = _xgHeqsvI;
        "pkg-1.21.3-1.3-fabric+forge+neo" = _y5ptb22p;
        "pkg-1.21.4-1.3-fabric+forge+neo" = _8AagRGlY;
        "pkg-1.21.5-1.3-fabric+forge+neo" = _GC1v6BXJ;
        "pkg-1.21.6-1.3-fabric+forge+neo" = _ZBHnDk6N;
        "pkg-1.21.7-1.3-fabric+forge+neo" = _ikUy0KzL;
        "pkg-1.21.8-1.3-fabric+forge+neo" = _UmUYjbeo;
        "pkg-1.21.9-1.3-fabric+forge+neo" = _HH3rWu2o;
        "pkg-1.21.10-1.3-fabric+forge+neo" = _gi5vNRGj;
        "pkg-1.21.11-1.3-fabric+forge+neo" = _Yhl4dq82;
        "pkg-26.1.0-1.3-fabric+forge+neo" = _VASByanW;
