...
let
    ...
    in {
        ...
        "pkg-3.11.5" = _HxEvdUsV;
        "pkg-3.11.6" = _TpzBhRs2;
        "pkg-3.12.0" = _S3SUGHIw;
        "pkg-3.13.0" = _ovtRX6J4;
        "pkg-3.13.1" = _SymD0dqu;
        "pkg-3.13.2" = _YFQJS7px;
        "pkg-3.13.3" = _Z6mlaRTI;
        "pkg-3.13.4" = _ce5EOoW8;
        "pkg-3.14.0" = _fS1oMUTa;
        "pkg-3.14.1" = _gn6oQNJc;
        "pkg-3.14.2" = _kHQCT96A;
        "pkg-3.14.3" = _63y2OhCj;
        "pkg-3.14.4" = _8mE2kDfP;
        "pkg-3.15.0" = _gucy9FNP;
        "pkg-3.16.0" = _fcb3kSIX;
        "pkg-3.16.2" = _KiBqHC5S;
        "pkg-3.16.3" = _213wkZJS;
        "pkg-3.16.4" = _VIjevRzj;
        "pkg-3.16.5" = _Mji4QkNz;
        "pkg-3.17.0" = _TYUDt0hr;
        "pkg-3.17.1" = _NlnZ9yc9;
        "pkg-3.17.2" = _MrIiAdMj;
        "pkg-3.17.3" = _HnsXyyYm;
        "pkg-3.18.0" = _VeNdRRp1;
        "pkg-3.18.1" = _nho8ROLL;
        "pkg-3.19.0" = _1xFEqfei;
        "pkg-3.20.0" = _uKenFCVj;
        "pkg-3.20.1" = _UB6byWi1;
        "pkg-3.20.3" = _Du0SDk5Z;
        "pkg-3.20.4" = _aHP5Begy;
        "pkg-3.21.0" = _a81mxGjv;
        "pkg-3.22.0" = _ZSL2ieXg;
        "pkg-3.23.0" = _Hj9H0PyD;
        "pkg-3.24.1" = _2M5Y2KVf;
        "pkg-3.25.0" = _qinrmnNo;
        "pkg-3.25.1" = _R5cfs1Vx;
        "pkg-3.26.0" = _cXcGs4bl;
        "pkg-3.26.1" = _TQVVSw4y;
        "pkg-3.26.2" = _9ALa6CfR;
        "pkg-3.27.0" = _UqBnGq3L;
        "pkg-3.28.0" = _zq9Io7N7;
        "pkg-3.29.0" = _Ckp5mYns;
        "pkg-3.30.0" = _2wYjViut;
        "pkg-3.31.0" = _1rJu2ThP;
        "pkg-3.31.1" = _1A40PEkE;
        "pkg-3.31.2" = _lvb1Da69;
        "pkg-3.31.3" = _J0N2v3Hw;
        "pkg-3.32.0" = _182iRkq6;
        "pkg-3.32.1" = _gBS31szA;
        "pkg-3.33.0" = _cpSdCaI1;
        "pkg-3.33.1" = _py0wkKRu;
        "default" = _py0wkKRu;
    });
