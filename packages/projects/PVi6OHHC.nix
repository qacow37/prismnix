...
let
    ...
    in {
        ...
        "pkg-0-v0.0.1" = _FwX5oGe3;
        "pkg-0-v0.0.3" = _93HzU2Oq;
        "pkg-0-v0.0.4" = _UwxMsO30;
        "pkg-0-v0.0.5" = _lmEPqbHX;
        "pkg-0-v0.0.6" = _XZe388T0;
        "pkg-0-v0.0.7" = _CjRoi342;
        "pkg-0-v0.1.0" = _5lIElS7l;
        "pkg-0-v0.1.1" = _bxB2iZB5;
        "pkg-0-v0.1.2" = _kVOMGd9L;
        "pkg-0-v0.1.3" = _RHhFsleo;
        "pkg-0-v0.1.4" = _PbeAk67y;
        "pkg-0-v0.1.5" = _bD4fYEA1;
        "pkg-0-v0.1.6" = _1dOG8jNZ;
        "pkg-0-v0.1.7" = _FqCDQKBN;
        "pkg-0-v0.1.8" = _xRHtvNYd;
        "pkg-0-v0.1.9" = _wOWs3nvZ;
        "pkg-0-v0.1.10" = _tzhGzTF9;
        "pkg-0-v0.1.11-mc1.21.9" = _SrY7er8X;
        "pkg-0-v0.1.12-mc1.21.9" = _CXU6BkSn;
        "pkg-0-v0.1.13-mc1.21.11" = _6mL1rn2s;
        "pkg-0-v0.1.14-mc1.21.11" = _20w1JhEm;
        "pkg-0-v0.1.15-mc26.1" = _J3VXnvAg;
        "default" = _J3VXnvAg;
    });
