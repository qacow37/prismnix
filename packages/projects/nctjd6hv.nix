...
let
    ...
    in {
        ...
        "pkg-1.0.0.2" = _WACXLxqR;
        "pkg-1.0.0.3" = _KtQQxRdv;
        "pkg-1.0.0.4" = _AWpgMsGb;
        "pkg-1.0.0.5" = _Nf61U3vQ;
        "pkg-1.0.0.6" = _aqW7WeWN;
        "pkg-1.0.0.7" = _Y6rtz1jp;
        "pkg-1.0.0.8" = _GiPcAHdn;
        "pkg-1.0.1.9" = _O7xLNQQw;
        "pkg-1.0.1.10" = _1k6EqNyn;
        "pkg-1.0.1.11" = _fvG9pM6K;
        "pkg-1.0.1.12" = _s7jfdqm4;
        "pkg-1.0.1.13" = _48qv2gf7;
        "pkg-1.0.1.14" = _IE6VjOGH;
        "pkg-1.0.1.15" = _qUjojOKC;
        "pkg-1.0.1.16" = _y1osybx5;
        "pkg-1.0.1.17" = _AXYupIFm;
        "pkg-1.0.1.18" = _jFGoYRGY;
        "pkg-1.0.1.19" = _GQpv8GlF;
        "pkg-1.0.1.20" = _RxmZhQA9;
        "pkg-1.0.1.21" = _Aj1joXa3;
        "pkg-1.0.2.22" = _MxV4eiyc;
        "pkg-1.0.2.23" = _32XdKYMi;
        "pkg-1.1.0.24" = _hdfphr2g;
        "pkg-1.2.0.34" = _UekDbZGq;
        "pkg-1.2.0.35" = _2RkH1ft4;
        "pkg-1.2.0.36" = _VagYrr7w;
        "pkg-1.2.0.37" = _JQKpGGBc;
        "pkg-1.2.0.38" = _p9IRpzZc;
        "pkg-1.2.0.39" = _A8b1ue7A;
        "pkg-1.2.1.40" = _eaRb2624;
        "pkg-1.2.1.41" = _Itz6eB2Z;
        "pkg-1.2.1.42" = _d3S9e0el;
        "pkg-1.2.1.43" = _kldXWrtu;
        "pkg-1.2.1.44" = _hlCSV3Mx;
        "pkg-1.2.1.45" = _LR2CqrYY;
        "pkg-1.2.1.46" = _1P6o88T2;
        "pkg-1.2.1.47" = _5pG7CghL;
        "pkg-1.2.1.48" = _m7dwWzt8;
        "pkg-1.2.1.49" = _WEhY6Grd;
        "pkg-1.2.1.50" = _iWLOpP8V;
        "pkg-1.3.0.51" = _qUcwqMmM;
        "pkg-1.3.0.52" = _ii1RD8jr;
        "pkg-2.0.55" = _4hJ61PnX;
        "pkg-1.0.60" = _CtoQvbqC;
        "pkg-1.0.61" = _Re6QstxU;
        "pkg-1.0.62" = _RXUHcY05;
        "pkg-1.0.63" = _25OZGIE2;
        "default" = _25OZGIE2;
    });
