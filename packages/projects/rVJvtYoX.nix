...
let
    ...
    in {
        ...
        "pkg-0.1.5" = _CinCVB7a;
        "pkg-0.1.6" = _tUpsuPtK;
        "pkg-0.1.7-beta" = _a7jjF0Af;
        "pkg-0.1.8-beta" = _Co3yjopX;
        "pkg-0.1.8-beta2" = _YmfbQW9o;
        "pkg-0.1.8-beta3" = _KDKUtgr8;
        "pkg-0.1.8-beta4" = _gGoDsMNr;
        "pkg-0.1.9" = _TywoQq2L;
        "pkg-0.2.0" = _EPTXY9tH;
        "pkg-0.2.0.post1" = _QEPAdzqo;
        "pkg-0.2.0.post2" = _UKqwoDOr;
        "pkg-0.2.0.post3" = _U5ajniub;
        "pkg-0.2.5" = _IkHIGMQ5;
        "pkg-0.2.5.post1" = _QIGw96NK;
        "pkg-0.2.5.post2" = _ZKTNSpu2;
        "pkg-0.2.5.post3" = _bFpVNlkQ;
        "pkg-0.2.6" = _KZMsj6LM;
        "pkg-0.2.7" = _VYShL5YQ;
        "pkg-0.2.8" = _Qtp4pQaI;
        "pkg-0.2.9" = _GBS5Xoti;
        "pkg-0.2.11" = _VNp0JDWz;
        "pkg-0.2.13" = _Z3n5NBoI;
        "pkg-0.3.0" = _7xOQCd2z;
        "pkg-0.3.1" = _mXOOVA7p;
        "pkg-0.3.2" = _jtnTf5jS;
        "pkg-0.3.3" = _MYArBgfj;
        ...
        "pkg-0.3.6" = _BEMQMajK;
        "pkg-0.3.7" = _L196gdlm;
        "pkg-0.4.0.beta.1" = _yD7ZLbF3;
        "pkg-0.3.8" = _gpkjCQFZ;
        "pkg-0.4.1" = _xYyaIoiD;
        "pkg-0.5.0+spigot-1.12.2" = _rsOFqs9S;
        "pkg-0.5.0+spigot-1.13" = _Jiiyaxmz;
        "pkg-0.5.0+velocity-3.4.0" = _SfA7QDr3;
        "pkg-0.5.0+fabric-1.20.1" = _GpNxMfEV;
        "pkg-0.5.0+neoforge-1.21.1" = _IY6LaM4y;
        "pkg-0.5.0+velocity-3.3.0" = _N7NtdsCT;
        "pkg-0.5.0+fabric-1.21" = _MfN0fxLB;
        "pkg-0.5.0+paper-1.17.1" = _RX9ldzld;
        "pkg-0.5.0+fabric-1.18.2" = _dmv50k3T;
        "pkg-0.5.0+fabric-1.21.5" = _puu2Lv82;
        "pkg-0.5.0+fabric-1.19.2" = _97jC3HZV;
        "pkg-0.5.0+fabric-1.21.4" = _eYT1RavL;
        "pkg-0.5.0+folia-1.21.4" = _t1I1lkhd;
        "pkg-0.5.0+forge-1.20.1" = _6DE9e0Tr;
        "pkg-0.5.0+fabric-1.21.6" = _Yv3ubmn9;
        "pkg-0.5.0+forge-1.16.5" = _97hcL5Yr;
        "pkg-0.5.0+forge-1.19.2" = _JdMNhjUF;
        "pkg-0.5.0+fabric-1.20.4" = _VqihgRFo;
        "pkg-0.5.0+fabric-1.21.1" = _sdtYDALZ;
        "pkg-0.5.0+fabric-1.16.5" = _9MR1b9Dx;
        "pkg-0.5.0+fabric-1.21.11" = _9FUA4Gfk;
        "pkg-0.5.0+fabric-1.21.9" = _H7qMS7rD;
        "pkg-0.5.0+forge-1.21" = _gAsTb8GP;
        "pkg-0.5.0+forge-1.7.10" = _Tl39rGqT;
        "pkg-0.5.0+forge-1.18.2" = _4bTknwcH;
        "pkg-0.5.0+forge-1.12.2" = _cazybhRE;
        "pkg-0.5.1+spigot-26.1" = _HX6L9EGx;
        "pkg-0.5.1+neoforge-26.1" = _yT2n7w6x;
        "pkg-0.5.1+fabric-26.1" = _RMGrWkL8;
        "pkg-0.5.1+forge-26.1" = _lAeyVl4D;
        "pkg-0.5.1+paper-26.1.1" = _OWMX58Vy;
        "pkg-0.5.2+fabric-26.1" = _2ixJxiWh;
        "default" = _2ixJxiWh;
    });
