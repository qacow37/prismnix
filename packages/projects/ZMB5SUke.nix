...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.20.5" = _1Umg4PIk;
        "pkg-1.0.0+mc1.20.4" = _193gSOvb;
        "pkg-1.1.0+mc1.21" = _f3XYcww2;
        "pkg-1.1.0+mc1.21.2" = _dTUKHFJ7;
        "pkg-1.1.0+mc1.21.4" = _GU0lgWcg;
        "pkg-1.1.0+mc1.21.5" = _tfddjDVX;
        "pkg-1.2.0+mc1.21.6-7" = _UGI1dDXe;
        "pkg-1.2.0+mc1.21.5" = _G5eYKSeJ;
        "pkg-1.2.0+mc1.21.2-4" = _lKEetkLT;
        "pkg-1.2.0+mc1.21-1" = _vvLOYVgh;
        "pkg-1.2.0+mc1.20.5-6" = _hqMq2th0;
        "pkg-1.2.0+mc1.20.3-4" = _C6vGq54t;
        "pkg-1.2.0+mc1.20.2" = _UKbxK14d;
        "pkg-1.2.0+mc1.20.1" = _Nsb9qgCX;
        "pkg-1.2.0+mc1.21.6-8" = _35nHrWlm;
        "pkg-1.3.0+mc1.21.9-10" = _muas4Ze0;
        "pkg-1.3.0+mc1.21.6-8" = _641lNKOy;
