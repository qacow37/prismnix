...
let
    ...
    in {
        ...
        "pkg-1.18.2-20" = _GHMqE2ZA;
        "pkg-1.19-03" = _Mwwh7eLq;
        "pkg-1.18.2-21" = _yrlkAyXB;
        "pkg-1.19-04" = _5DabAgQm;
        "pkg-1.18.2-22" = _DCFpFlXB;
        "pkg-1.19-05" = _q21squE2;
        "pkg-1.18.2-23" = _sCFf8uup;
        "pkg-1.19-06" = _syPtJrDm;
        "pkg-1.18.2-24" = _Q05E7lG5;
        "pkg-1.19-07" = _VVLwHEzy;
        "pkg-1.18.2-25" = _VpAoXXA4;
        "pkg-1.19-08" = _AKwGYAsX;
        "pkg-1.18.2-26" = _i5CdsTzS;
        "pkg-1.19-09" = _sSV5HfHn;
        "pkg-1.18.2-27" = _NC0KX8jl;
        "pkg-1.19-10" = _WFMwOGip;
        "pkg-1.18.2-28" = _YqKAtu9n;
        "pkg-1.19-11" = _LdYeBDNW;
        "pkg-1.18.2-29" = _3Cx2Xcae;
        "pkg-1.19-12" = _YR3B8rLz;
        "pkg-1.18.2-30" = _81tMaPsz;
        "pkg-1.19-13" = _KxKJNIDo;
        "pkg-1.18.2-31" = _jNDNUr7I;
        "pkg-1.19-14" = _su6ZUrlv;
        "pkg-1.18.2-32" = _SJUIZHLG;
        "pkg-1.19-15" = _uMg0QFd8;
        "pkg-1.18.2-33" = _iDAgn6Pj;
        "pkg-1.19-16" = _4jGs7cN3;
        "pkg-1.18.2-34" = _NL5G3Ctw;
        "pkg-1.19-17" = _pdzD1xdK;
        "pkg-1.19-18" = _ZoCAJT2X;
        "pkg-1.18.2-35" = _89MmkjC6;
        "pkg-1.18.2-36" = _uOK0cdTT;
        "pkg-1.19-19" = _Ge9aURoX;
        "pkg-1.18.2-37" = _2yLE1S2V;
        "pkg-1.19-20" = _evtPuTZK;
        "pkg-1.18.2-38" = _r02jywbV;
        "pkg-1.19-21" = _qU4CcQFZ;
        "pkg-1.18.2-39" = _oCWRTRW5;
        "pkg-1.19-22" = _vwucmRS3;
        "pkg-1.18.2-40" = _LXhv2t37;
        "pkg-1.19-23" = _uMIjw76e;
        "pkg-1.18.2-41" = _CvX9VrqS;
        "pkg-1.19-24" = _ckVtSeSv;
        "pkg-1.19.3-01" = _vOPv60N0;
        "pkg-1.18.2-42" = _l8rUlQE9;
        "pkg-1.19-25" = _VjMjGs38;
        "pkg-1.18.2-43" = _Rl2fRVsj;
        "pkg-1.19-26" = _PHrVi2xk;
        "pkg-1.19.3-03" = _3taRzFAu;
        "pkg-1.18.2-44" = _KxfnMmZy;
        "pkg-1.19-27" = _dpaRKVul;
        "pkg-1.19.3-04" = _d0M2LcS0;
        "pkg-1.18.2-45" = _2nw4Em4x;
        "pkg-1.19-28" = _C5hqqY4N;
        "pkg-1.19.3-05" = _ZH5N7rlg;
        "pkg-1.19-29" = _T8X816Sn;
        "pkg-1.19.3-06" = _yaOdWv33;
        "pkg-1.19-30" = _5kiQw6iv;
        "pkg-1.19.3-07" = _xXS3D3r8;
        "pkg-1.19-31" = _G8A2Nopu;
        "pkg-1.19.3-08" = _GQg8gKms;
        "pkg-1.19-32" = _XiJXMTKw;
        "pkg-1.19.3-09" = _Bl2hqP27;
        "pkg-1.19-33" = _jUje21Qy;
        "pkg-1.19.3-10" = _r4AO8NNU;
        "pkg-1.19-34" = _n4s7mp4n;
        "pkg-1.19.3-11" = _6007OlVv;
        "pkg-1.19-35" = _OT7riHob;
        "pkg-1.19.3-12" = _B0UxnJLL;
        "pkg-1.19-36" = _WFXMTswX;
        "pkg-1.19.3-13" = _T9koZLgP;
        "pkg-1.19.4-01" = _w9tdRuFF;
        "pkg-1.20.1-01" = _qGTuZsSt;
        "pkg-1.20.1-02" = _SNo7w6qT;
        "pkg-1.20.1-03" = _1HiPqmsj;
        "pkg-1.20.1-04" = _QzYBOgIP;
        "pkg-1.19-37" = _SKDHIeVn;
        "pkg-1.19.3-14" = _aUTigD1W;
        "pkg-1.19.4-02" = _JTGpPjeW;
        "pkg-1.20.1-05" = _aMF4WHJ2;
        "pkg-1.19.4-03" = _63VESlUR;
        "pkg-1.20.1-06" = _Xzflujc8;
        "pkg-1.19-38" = _JMoKW2Tn;
        "pkg-1.19.3-15" = _etL1AB77;
        "pkg-1.19.4-04" = _a6N58kSV;
        "pkg-1.20.1-07" = _q6UrYHFW;
        "pkg-1.19-39" = _PpgLEnNl;
        "pkg-1.19.3-16" = _qJb1Ptef;
        "pkg-1.19.4-05" = _60XAjtj5;
        "pkg-1.20.1-09" = _3GAOyYup;
        "pkg-1.20.1-10" = _uhXXUNBv;
        "pkg-1.20.1-11" = _diWTsqkl;
        "pkg-1.20.1-12" = _zHDpMjnL;
        "pkg-1.20.1-13" = _ki2t3AEx;
        "pkg-1.20.1-14" = _uKOj8Udh;
        "pkg-1.20.1-15" = _dxaBkUfa;
        "pkg-1.20.1-16" = _9BCBIgtA;
        "pkg-1.20.1-17" = _URACuREQ;
        "pkg-1.20.1-18" = _VfyRZQER;
        "pkg-1.19-40" = _OPB1L1kD;
        "pkg-1.19.3-17" = _dHqLw02z;
        "pkg-1.19.4-06" = _YvJ3Irg3;
        "pkg-1.20.1-19" = _s8hc1ist;
        "pkg-1.20.1-19.1" = _tqvkr2FD;
        "pkg-1.20.1-19.2" = _dwZ8SUVg;
        "pkg-1.20.1-19.3" = _Jndfowro;
        "pkg-1.20.1-19.4" = _w5WIqueM;
        "pkg-1.19-41" = _Wt4Y0OMT;
        "pkg-1.20.1-19.6" = _iF2tALQt;
        "pkg-1.20.1-19.7" = _mfhqzDfP;
        "pkg-1.20.1-19.8" = _vRY4HxBN;
        "default" = _vRY4HxBN;
    });
