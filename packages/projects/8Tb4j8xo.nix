...
let
    ...
    in {
        ...
        "pkg-1.12.2-0.0.852.0-farlands" = _orP0q8Ba;
        "pkg-1.10.2-0.0.919.0" = _TUn0IzLp;
        "pkg-1.11.2-0.0.897.0" = _wDOAjGcq;
        "pkg-1.12.2-0.0.884.0" = _6zcqm4tN;
        "pkg-1.10.2-0.0.942.0" = _h6EQjGmq;
        "pkg-1.11.2-0.0.917.0" = _mbMi6GRT;
        "pkg-1.12.2-0.0.902.0" = _k1T8igDM;
        "pkg-1.10.2-0.0.981.0" = _dkCDM7EX;
        "pkg-1.11.2-0.0.948.0" = _TLMfuW0D;
        "pkg-1.12.2-0.0.926.0" = _LJ8IaEIU;
        "pkg-1.10.2-0.0.1027.0" = _Pjvr4aAB;
        "pkg-1.11.2-0.0.993.0" = _Rx9Jw3TO;
        "pkg-1.12.2-0.0.970.0" = _u6w0amfl;
        "pkg-1.12.2-0.0.1007.0" = _4OdyfgOz;
        "pkg-1.12.2-0.0.1011.0" = _39IgdAod;
        "pkg-1.10.2-0.0.1094.0" = _xTG02tn2;
        "pkg-1.11.2-0.0.1057.0" = _9YlCMsSy;
        "pkg-1.12.2-0.0.1028.0" = _KUKGZNG4;
        "pkg-1.12.2-0.0.1030.0" = _IB4u3ski;
        "pkg-1.12.2-0.0.1033.0" = _bm5cAeug;
        "pkg-1.12.2-0.0.1042.0" = _3GfTCHcq;
        "pkg-1.12.2-0.0.1055.0" = _Kyn8grpy;
