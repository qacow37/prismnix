...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.18.2-forge" = _6DtbOVFX;
        "pkg-1.0.0-1.20.1-1.20.4-fabric" = _6Uy5ki0Y;
        "pkg-1.0.0-1.20.1-1.20.4-forge" = _KfQ7H4WH;
        "pkg-1.0.0-1.19.2-fabric" = _cTVJuzuH;
        "pkg-1.0.0-1.19.2-forge" = _aMPsn3TO;
        "pkg-1.0.1-1.20.1-1.20.4-fabric" = _XMccgvzj;
        "pkg-1.0.1-1.20.1-1.20.4-forge" = _3OeHwNib;
        "pkg-1.0.1-1.19.2-fabric" = _QcDfYy6d;
        "pkg-1.0.1-1.19.2-forge" = _FGAAIkNn;
        "pkg-1.0.1-1.18.2-fabric" = _AUB6gMMU;
        "pkg-1.0.1-1.18.2-forge" = _aMYLdh1A;
        "pkg-1.0.2-1.20.1-1.20.4-forge" = _t7thRplt;
        "pkg-1.0.3-1.20.1-1.20.4-forge" = _lJlW5r8R;
        "pkg-1.0.4-1.20.1-1.20.4-fabric" = _2o0oW8Yv;
        "pkg-1.0.5-1.20.4-neoforge" = _KP3gMIq3;
        "pkg-1.0.6-1.20.5-fabric" = _hYM9p09l;
        "pkg-1.0.6-1.20.5-neoforge" = _E1C9lndp;
        "pkg-1.0.7-1.20.6-forge" = _mEGdB8Jg;
        "pkg-1.0.8-1.20.6-forge" = _ICDWdvtk;
        "pkg-1.0.9-1.20.6-forge" = _qujo8CZX;
        "pkg-1.0.10-1.21-fabric" = _OqxSeb4n;
        "pkg-1.0.10-1.21-forge" = _dhnytTnF;
        "pkg-1.0.10-1.21-neoforge" = _efcdRVZP;
        "pkg-1.0.11-1.21.5-fabric" = _gf84krIk;
        "pkg-1.0.11-1.21.5-forge" = _BYSPaMzs;
        "pkg-1.0.11-1.21.5-neoforge" = _ifs75r9u;
        "pkg-1.0.12-1.21.6-fabric" = _NsXvHOnn;
        "pkg-1.0.12-1.21.6-forge" = _GdUdtOfw;
        "pkg-1.0.12-1.21.6-neoforge" = _DS7coewa;
        "pkg-1.0.13-1.21.10-fabric" = _2YEyhNcZ;
        "pkg-1.0.13-1.21.10-neoforge" = _spdEBLiE;
        "pkg-1.0.14-1.21.10-fabric" = _4nd52KsY;
        "pkg-1.0.14-1.21.10-neoforge" = _GUxhbP5x;
        "pkg-1.0.15-1.21.11-fabric" = _Xo1GAiPu;
        "pkg-1.0.15-1.21.11-neoforge" = _9Jdm9sDl;
        "pkg-1.0.16-26.1.1-fabric" = _V4DQs36M;
