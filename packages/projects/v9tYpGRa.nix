...
let
    ...
    in {
        ...
        "pkg-1.0.8+1.17.1-fabric" = _xFbpaYb3;
        "pkg-1.0.8+1.17.1-forge" = _FAHkd06h;
        "pkg-1.0.8+1.18.2-fabric" = _MrOJknyg;
        "pkg-1.0.8+1.18.2-forge" = _dfEqqbt0;
        "pkg-1.0.8+1.19-fabric" = _IbBuGOw6;
        "pkg-1.0.8+1.19-forge" = _ujzqdzyU;
        "pkg-1.0.9+1.17.1-fabric" = _C4KAjNT5;
        "pkg-1.0.9+1.17.1-forge" = _ojXVunf9;
        "pkg-1.0.9+1.18.2-fabric" = _LO0uJA8c;
        "pkg-1.0.9+1.18.2-forge" = _ZNeNN8IV;
        "pkg-1.0.9+1.19-fabric" = _9bkpR9Au;
        "pkg-1.0.9+1.19-forge" = _pXsP9dNz;
        "pkg-1.0.10+1.17.1-fabric" = _JV1ndmnY;
        "pkg-1.0.10+1.17.1-forge" = _zGb9PCOJ;
        "pkg-1.0.10+1.18.2-fabric" = _xaeLhuPI;
        "pkg-1.0.10+1.18.2-forge" = _CfXOhZky;
        "pkg-1.0.10+1.19.1-fabric" = _7D6rRGau;
        "pkg-1.0.10+1.19.1-forge" = _1w97YK4j;
        "pkg-1.0.11+1.17.1-fabric" = _PuGDwQWw;
        "pkg-1.0.11+1.17.1-forge" = _xLBtlWTV;
        "pkg-1.0.11+1.18.2-fabric" = _jHJu5Q0L;
        "pkg-1.0.11+1.18.2-forge" = _UL3jyabF;
        "pkg-1.0.11+1.19.1-fabric" = _BCvTeOIV;
        "pkg-1.0.11+1.19.1-forge" = _PzLsNNTB;
        "pkg-1.0.11+1.19.3-forge" = _cQ2l9Asz;
        "pkg-1.0.11+1.19.3-fabric" = _r3cohypQ;
        "default" = _r3cohypQ;
    });
