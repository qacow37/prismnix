...
let
    ...
    in {
        ...
        "pkg-v1.2.3" = _wTPVu10T;
        "pkg-v1.1.1" = _LMOzvyOb;
        "pkg-v1.0.5" = _suZZymTM;
        "pkg-v1.2.4" = _3tpZmOx0;
        "pkg-v1.2.5" = _TPz1kC23;
        "pkg-v1.1.2" = _UXTkSVg3;
        "pkg-v1.0.6" = _TcZNW7sh;
        "pkg-v1.2.6" = _gkQ2BWKi;
        "pkg-v1.2.7" = _RYyB2eUB;
        "pkg-v1.2.8" = _YrGNH66n;
        "pkg-v1.2.9" = _guRQG5Qh;
        "pkg-v1.3.0" = _jpMfZgk3;
        "pkg-1.4.0" = _63la8BCZ;
        "pkg-1.4.1" = _T59NNT4I;
        "pkg-1.5.1" = _bmydYbie;
        "pkg-1.6.1" = _5Cm8ntlH;
        ...
        "pkg-1.8.5" = _EriBIQgx;
        "pkg-1.9.0" = _J8hGqqRO;
        "pkg-1.10.0" = _7Zvrav5y;
        "pkg-1.11.0" = _CBG9FQD7;
        "pkg-1.9.1" = _cF4OiD20;
        "default" = _cF4OiD20;
    });
