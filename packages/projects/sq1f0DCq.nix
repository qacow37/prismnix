...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.0.0-beta.1-forge" = _zXFmltBw;
        "pkg-1.19.4-1.0.0-beta.1-forge" = _LuyU74Yn;
        "pkg-1.20.1-1.0.0-beta.1-neoforge" = _ehllcqn3;
        "pkg-1.20.1-1.0.0-neoforge" = _crhMXBde;
        "pkg-1.19.4-1.0.0-forge" = _8nulXQTr;
        "pkg-1.19.2-1.0.0-forge" = _zkqaIcSt;
        "pkg-1.20.2-1.0.0-neoforge" = _MabMs17g;
        "pkg-1.20.2-1.0.1-neoforge" = _QrcfIDwk;
        "pkg-1.20.4-1.0.1-neoforge" = _dA5xlh1n;
        "pkg-1.20.1-1.0.1-neoforge" = _pFS5mTSJ;
        "pkg-1.20.2-1.0.2-neoforge" = _3wX9YJsn;
        "pkg-1.20.4-1.0.2-neoforge" = _qRq7nrGA;
        "pkg-1.21.1-1.1.0-neoforge" = _IbLUh4FA;
        "pkg-1.21.1-1.1.0-fabric" = _TWE5oc4l;
        "pkg-1.21.1-1.1.1-neoforge" = _lxNdK50T;
        "pkg-1.21.1-1.1.2-neoforge" = _fECgEOOW;
        "pkg-1.21.1-1.1.1-fabric" = _Dszdu9EA;
        "pkg-1.21.1-1.1.4-neoforge" = _cPlau0w3;
        "pkg-1.21.1-2.0.0-fabric" = _DWJHgqHT;
        "pkg-1.21.1-2.0.0-neoforge" = _u46i575s;
        "pkg-1.21.1-2.0.1-fabric" = _JdgIbW4M;
        "pkg-1.21.1-2.0.1-neoforge" = _vVb4GvvJ;
        "pkg-1.20.1-1.0.0-fabric" = _fLjgRBiW;
        "pkg-1.20.1-1.0.1-fabric" = _1Fmd6hgY;
        "pkg-1.21.1-2.0.3-fabric" = _SOBzME2u;
        "pkg-1.21.1-2.0.3-neoforge" = _jRSpQti8;
        "pkg-1.21.1-2.0.4-fabric" = _TcicDA8g;
        "pkg-1.21.1-2.0.4-neoforge" = _dxaqa9CA;
        "pkg-1.21.1-2.0.5-fabric" = _xIe0hLVv;
        "pkg-1.21.1-2.0.5-neoforge" = _BXddzUpu;
        "pkg-1.21.1-2.0.6-fabric" = _zQY8u91Q;
        "pkg-1.21.1-2.0.6-neoforge" = _LCh2g48N;
        "pkg-1.20.1-1.0.2-fabric" = _yTM5mZV1;
        "pkg-1.21.1-2.0.7-fabric" = _CLUgd4b9;
        "pkg-1.21.1-2.0.7-neoforge" = _30nL1EiU;
        "pkg-1.21.1-2.0.8-fabric" = _2tLZNRpP;
        "pkg-1.21.1-2.0.8-neoforge" = _J49frL2W;
        "default" = _J49frL2W;
    });
