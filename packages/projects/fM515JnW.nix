...
let
    ...
    in {
        ...
        "pkg-4.0.0" = _2GbdNWGc;
        "pkg-5.0.9" = _Sth6XBbQ;
        "pkg-5.0.16" = _lleFsB3J;
        "pkg-5.2.8" = _OsvzFd1y;
        "pkg-5.2.9" = _X8aI9NX6;
        "pkg-5.2.11" = _dKw2Azzg;
        "pkg-5.2.12" = _SaQNGUEW;
        "pkg-5.2.13" = _yNFnf8du;
        "pkg-5.2.13+1.19.3" = _gFtyQpNQ;
        "pkg-5.2.14" = _oO7RFtWI;
        "pkg-5.2.15" = _73cNzWIl;
        "pkg-5.2.16" = _ZQN41zUK;
        "pkg-5.2.17" = _ppyL48by;
        "pkg-5.2.18" = _S9iWVbEo;
        "pkg-5.2.19" = _OeOZOgyO;
        "pkg-5.2.20" = _YT7FF3lB;
        "pkg-5.2.21" = _LNo9BMgY;
        "pkg-5.2.22" = _UhavHRSW;
        "pkg-5.2.23" = _Axhf30fN;
        "pkg-5.2.24" = _spvQUwSs;
        "pkg-5.3.0" = _YzNTPba6;
        "pkg-5.3.1" = _9Tzh60G4;
        "pkg-5.3.2" = _4AfD1W6g;
        "pkg-5.3.3" = _mFnIDeOy;
        ...
        "pkg-6.1.8" = _4ijwwVKd;
        "pkg-6.1.9" = _nnNIkaxO;
        "pkg-6.1.10" = _ce3rLVc7;
        "pkg-6.1.11" = _GGO0vfLu;
        "pkg-6.1.12" = _ZdBRTJ6T;
        "pkg-6.2.0" = _D0eeePwc;
        "pkg-6.2.1" = _IFD5OX7n;
        "pkg-6.2.2" = _1OZ1N3BO;
        "pkg-6.2.3" = _fGJ6BOzj;
