...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _nBasuebE;
        "pkg-1.1.0" = _6S1Mdowj;
        "pkg-1.1.1-1.20" = _j6SRbPrt;
        "pkg-1.1.1-1.20.1" = _TM6GD6Uo;
        "pkg-1.1.1-1.20.2" = _ZlGR4vF3;
        "pkg-1.1.1-1.20.4" = _TpnQvBMo;
        "pkg-1.2.0-1.20" = _QIk2vstJ;
        "pkg-1.2.0-1.20.1" = _59p4LyZi;
        "pkg-1.2.0-1.20.2" = _74rn2jtU;
        "pkg-1.2.0-1.20.4" = _3D2rbnw3;
        "pkg-1.2.0-1.20.5" = _R21Dk8rM;
        "pkg-1.2.0-1.20.6" = _JVRSzEln;
        "pkg-1.2.0-1.21" = _cfGSocId;
        "pkg-1.2.0-1.21.1" = _YYJzLMFV;
        "pkg-1.3-1.20.1" = _65qMgJ7X;
        "pkg-1.3-1.20.4" = _r1pl84ln;
        "pkg-1.3-1.20.6" = _NFK4l3Zw;
        "pkg-1.3-1.21.1" = _ATWWH492;
        "pkg-1.3.0.1-1.20.1" = _1ccO7uHz;
        "pkg-1.3.0.1-1.20.4" = _w8GcyDfh;
        "pkg-1.3.0.2-1.20.1" = _vbOHACpb;
        "pkg-1.3.0.2-1.20.4" = _UdUQV8gg;
        "pkg-1.3-1.21.2" = _rTDGwXew;
        "pkg-1.3-1.21.3" = _TYzV6QNS;
        "pkg-1.3" = _pXHiRLUL;
        "pkg-1.21.1-1.3" = _vbuo9Q6v;
        "pkg-1.21.4-1.3" = _Iu9Ehexz;
        "pkg-1.21.5-1.3" = _DVl4phww;
        "pkg-1.21.8-1.3" = _iMbrKTfi;
        "pkg-1.21.10-1.3" = _oB2neipd;
