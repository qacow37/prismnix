...
let
    ...
    in {
        ...
        "pkg-0.8.5" = _IbVdtJms;
        "pkg-0.8.5-forge3.1.3.105" = _PS0B8Ivo;
        "pkg-0.8.5-forge3.2.6.131" = _JtYhBGe7;
        "pkg-0.8.6b-forge3.1.3.105" = _t7huZ7i5;
        "pkg-0.8.6b-forge3.3.7.135" = _1sj01iSZ;
        "pkg-0.9.01.0" = _r76DRslk;
        "pkg-0.9.01.0-forge3.3.8.152" = _EU7XY9Ly;
        "pkg-0.9.1.02" = _UYCbLdPN;
        "pkg-0.9.1.02-forge3.3.8.152" = _JPZuOZOA;
        "pkg-0.9.2.00" = _VDOtyUhE;
        "pkg-0.9.2.01" = _qbt2EsBu;
        "pkg-0.9.3.00" = _LL1t6mJG;
        "pkg-0.9.4.00" = _dn75NhNJ;
        "pkg-0.9.4.05" = _eRRu3tBj;
        "pkg-0.9.5.00" = _4k1woNJ2;
        "pkg-0.10.0.00" = _UxHOUUv6;
        "pkg-0.10.1.00" = _9HY826cv;
        "pkg-0.10.2.00" = _7aW2GyP8;
        "pkg-0.10.3.00" = _rH4YUF0K;
        "pkg-0.10.4.00" = _2SQWFyOF;
        "pkg-0.10.5.00" = _lpdzFew2;
        "pkg-0.10.6.00" = _27I21SC1;
        "pkg-0.10.7.00" = _VOGh9YXl;
        "pkg-0.10.8.00" = _OJeAj4Xx;
        "pkg-0.10.9.00" = _9FrHRgEi;
        "pkg-0.10.10.00" = _XqOtoZ9B;
        "pkg-0.10.11.00" = _4ah3eKTk;
        "pkg-0.10.12.00" = _z3r0SS61;
        "pkg-0.10.12.01" = _pYshHFBW;
        "pkg-0.10.13.00" = _XMLyl1IN;
        "pkg-0.10.13.01" = _SDm14gpo;
        "pkg-0.10.14.00" = _g6izhRMQ;
        "pkg-0.10.15.00" = _h9N7JiO8;
        "pkg-0.11.0.00" = _eRkL208B;
        "pkg-0.11.1.00" = _kL2RE0h0;
        "pkg-0.11.2.01" = _BmU20ea6;
        "pkg-0.11.3.00" = _kCk4BMEd;
        "pkg-0.11.4.00" = _vO5aVyhF;
        "pkg-0.11.5.00" = _KX2kJMjL;
        "pkg-0.11.6.00" = _ApcFmvyS;
        "pkg-0.11.6.01" = _B0vNFFBC;
        "pkg-0.11.6.02" = _yHEARFuj;
        "pkg-0.11.7.00" = _xW1e7LAs;
        "pkg-0.11.8.00" = _gpm6meT8;
        "pkg-0.11.9.00" = _jweUuSaz;
        "pkg-0.11.9.03" = _1cQ5gud5;
        "pkg-0.11.10.00" = _Bnsiz4yK;
        "pkg-0.11.11.00" = _kaIcXCPQ;
        "pkg-0.11.12.00" = _b6kNmU3l;
        "pkg-0.11.13.00" = _xyLZBg0B;
        "pkg-0.12.0.00" = _Mi156wXk;
        "pkg-0.12.1.00" = _ttrqR75w;
        "pkg-0.12.2.00" = _lAFG60cq;
        "pkg-0.12.3.00" = _MVawldSt;
        "pkg-0.12.3.01" = _eMPMzg3X;
        "pkg-0.12.3.02" = _kTMDwdmq;
        "pkg-0.12.3.03" = _ZVeYEh8X;
        "pkg-0.12.3.04" = _lLZP7kL5;
        "pkg-0.13.0.00" = _Y62Wrw6Z;
        "pkg-0.13.1.00" = _CN37j18e;
        "pkg-0.13.2.00" = _Eh9tUyIn;
        "pkg-0.13.2.01" = _PKDG5nLY;
        "pkg-0.13.4.00" = _R8hU9vh5;
        "pkg-0.13.4.01" = _qIQFwzid;
        "pkg-0.13.4.02" = _2CwJir3u;
        "pkg-0.13.4.03" = _ZI1O6Pde;
        "pkg-0.13.4.04" = _Avn5PLUt;
        "pkg-0.13.4.05" = _yJSszFqW;
        "pkg-0.13.5.00" = _UlyYjcZx;
        "pkg-0.13.5.01" = _kwc8NPbm;
        "pkg-0.13.5.02" = _kMZEdgr5;
        "pkg-0.13.5.03" = _UUkoAtq1;
        "pkg-0.13.7.00" = _XWIGc01F;
        "pkg-0.13.7.01" = _mTjH6IK7;
        "pkg-0.13.7.02" = _BiuFHqVh;
        "pkg-0.13.7.03" = _yZrFHdwE;
        "pkg-0.13.7.04" = _drXkQokt;
        "pkg-0.13.7.06" = _IXZatyKM;
        "default" = _IXZatyKM;
    });
