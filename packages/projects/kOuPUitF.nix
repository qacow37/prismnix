...
let
    ...
    in {
        ...
        "pkg-1.16.5-3.9-fabric" = _xuC4AmwA;
        "pkg-1.18.2-3.9-fabric" = _sy8BePKg;
        "pkg-1.19.2-3.9-fabric" = _RAuge3RE;
        "pkg-1.16.5-3.9-forge" = _cdVOVic6;
        "pkg-1.18.2-3.9-forge" = _c4C8AvwG;
        "pkg-1.19.2-3.9-forge" = _18oKpTeZ;
        "pkg-1.16.5-4.0-fabric" = _S7ZuhODI;
        "pkg-1.18.2-4.0-fabric" = _mq5Ty6uw;
        "pkg-1.19.2-4.0-fabric" = _famq0IoQ;
        "pkg-1.19.3-4.1-fabric" = _p674eHYr;
        "pkg-1.19.3-3.9-forge" = _eakGQIsH;
        "pkg-1.18.2-5.0-forge+fabric" = _QrgEd29I;
        "pkg-1.19.2-5.0-forge+fabric" = _gJhRLstp;
        "pkg-1.19.3-5.0-forge+fabric" = _ZFcNNKg6;
        "pkg-1.18.2-5.1-forge+fabric" = _HVlHpVMO;
        "pkg-1.19.2-5.1-forge+fabric" = _R5L6eIZ5;
        "pkg-1.19.3-5.1-forge+fabric" = _XD0slKRQ;
        "pkg-1.19.4-5.1-forge+fabric" = _nkFdI1sJ;
        "pkg-1.20-5.1-forge+fabric" = _M4CAqbvM;
        "pkg-1.20.1-5.1-forge+fabric" = _Af56JzSn;
        "pkg-1.20.2-5.1-forge+fabric" = _MXAszBeZ;
        "pkg-1.18.2-5.2-forge+fabric" = _hcigUwew;
        "pkg-1.19.2-5.2-forge+fabric" = _SbVOf4bu;
        "pkg-1.20.1-5.2-forge+fabric" = _WlipzkEX;
        "pkg-1.20.2-5.2-forge+fabric" = _PXM70P0q;
        "pkg-1.20.3-5.2-fabric+forge+neo" = _zdCU92Tj;
        "pkg-1.20.4-5.2-fabric+forge+neo" = _vi1lchHo;
        "pkg-1.19.2-5.3-fabric+forge+neo" = _GaNg5Wb9;
        "pkg-1.20.1-5.3-fabric+forge+neo" = _rexDJ2gs;
        "pkg-1.20.2-5.3-fabric+forge+neo" = _xIJKkSTJ;
        "pkg-1.20.4-5.3-fabric+forge+neo" = _waXIEFAB;
        "pkg-1.20.5-5.3-fabric+neo" = _XMYNDtJz;
        "pkg-1.20.5-5.4-fabric+neo" = _Cq3b8RZA;
        "pkg-1.20.6-5.4-fabric+forge+neo" = _3xSkmPJN;
        "pkg-1.21.0-5.4-fabric+forge+neo" = _7ouKWiyh;
        "pkg-1.20.1-6.0-fabric+forge+neo" = _Ki51OqEt;
        "pkg-1.20.6-6.0-fabric+forge+neo" = _nojhyfyO;
        "pkg-1.21.0-6.0-fabric+forge+neo" = _NbqXiWkB;
        "pkg-1.20.1-6.1-fabric+forge+neo" = _sfesmy1R;
        "pkg-1.20.6-6.1-fabric+forge+neo" = _qvdBQRQ2;
        "pkg-1.21.0-6.1-fabric+forge+neo" = _l8P23p0a;
        "pkg-1.21.1-6.1-fabric+forge+neo" = _6YjKZX63;
        "pkg-1.21.2-6.1-fabric+neo" = _VglE3Km5;
        "pkg-1.21.3-6.1-fabric+forge+neo" = _gZZluRVD;
        "pkg-1.21.4-6.1-fabric+forge+neo" = _F8w1hOcq;
        "pkg-1.20.1-6.2-fabric+forge+neo" = _olxRjKsI;
        "pkg-1.21.1-6.2-fabric+forge+neo" = _Dq3x3ElV;
        "pkg-1.21.4-6.2-fabric+forge+neo" = _8xCQjkYp;
        "pkg-1.21.5-6.2-fabric+forge+neo" = _z02lKXVN;
        "pkg-1.21.6-6.2-fabric+forge+neo" = _AVgvA8qa;
        "pkg-1.21.7-6.2-fabric+forge+neo" = _AkGhKKoY;
        "pkg-1.21.8-6.2-fabric+forge+neo" = _b3skB7UI;
        "pkg-1.21.9-6.2-fabric+forge+neo" = _QVwlcK92;
        "pkg-1.21.10-6.2-fabric+forge+neo" = _CufoXgxm;
        "pkg-1.21.11-6.2-fabric+forge+neo" = _FluBpCHQ;
        "pkg-26.1.0-6.2-fabric+forge+neo" = _tCoP3VFY;
        "pkg-26.1.1-6.2-fabric+forge+neo" = _BGeR6aQl;
        "pkg-26.1.2-6.2-fabric+forge+neo" = _Gor9X15r;
        "pkg-26.2.0-6.2-fabric+forge+neo" = _r7CNOnZF;
        "pkg-1.20.1-6.3-fabric+forge+neo" = _1gi7IX85;
        "pkg-1.21.1-6.3-fabric+forge+neo" = _OQXaaklM;
        "pkg-26.2.0-6.3-fabric+forge+neo" = _YA2F8AdV;
        "default" = _YA2F8AdV;
    });
