...
let
    ...
    in {
        ...
        "pkg-1.0" = _Ni4U9f4Z;
        "pkg-2.0.0-Beta-1" = _ChzG4WiM;
        "pkg-2.0.0-Beta-2" = _taHtfp2v;
        "pkg-2.0.0-beta-3" = _5kcvM04L;
        "pkg-2.0.0" = _osMjMSse;
        "pkg-2.0.1" = _WFkBRywl;
        "pkg-2.0.2" = _znDDuS7B;
        "pkg-2.0.3-1.18.2" = _qZniRYXX;
        "pkg-2.1.0-1.18.2" = _SyqkM4ch;
        "pkg-2.1.1-1.18.2" = _YuoqVRR1;
        "pkg-2.2.0-1.18.2" = _rJZuXvte;
        "pkg-2.3.1-1.18.2" = _cpTFDSEe;
        "pkg-2.3.2-1.18.2" = _xEocQtmf;
        "pkg-2.3.3-1.18.2" = _WJtiENec;
        "pkg-2.3.4-1.18.2" = _sKUcYISz;
        "pkg-2.3.5-1.18.2" = _TiLO02Rb;
        "pkg-2.3.6-1.18.2" = _VW0b4lrO;
        "pkg-2.3.7-1.18.2" = _q6RWX7Ip;
        "pkg-2.3.8-1.18.2" = _NvOuxhrQ;
        "pkg-2.4.0-1.18.2-Beta-1" = _u45odZLZ;
        "pkg-2.4.0-1.18.2-beta-2" = _CAJpOfhQ;
        "pkg-2.4.0-1.18.2-beta-3" = _Iem8aMhM;
        "pkg-2.4.0-1.18.2" = _ydtW2yfG;
        "pkg-2.5.0-1.18.2" = _28rC665F;
        "pkg-2.5.1-1.18.2" = _18gF1XLR;
        "pkg-2.5.3-1.18.2" = _YbS9zufl;
        "pkg-2.5.4-1.18.2" = _8D3OwgYv;
        "pkg-2.5.5-1.18.2" = _OCfZSVmc;
        "default" = _OCfZSVmc;
    });
