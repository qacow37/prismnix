...
let
    ...
    in {
        ...
        "pkg-3.8.0-alpha.2+1.20.1" = _SH1zBKfn;
        "pkg-3.8.0-alpha.4+1.20.4" = _i6MuEBmW;
        "pkg-3.8.0-alpha.4+1.20.1" = _dRK46oTF;
        "pkg-3.8.0-alpha.6+1.20.1" = _2dmXIWpH;
        "pkg-3.8.1-alpha.6+1.20.4" = _ZKcda7o0;
        "pkg-3.8.1-alpha.7+1.20.1" = _QgvtkwCZ;
        "pkg-3.8.1-alpha.7+1.20.4" = _qdXCk7wp;
        "pkg-3.8.1-alpha.9+1.20.1" = _vtjeKTuL;
        "pkg-3.8.1-alpha.9+1.20.4" = _aSHPW5aY;
        "pkg-3.8.1-alpha.10+1.20" = _2WPsOVu6;
        "pkg-3.8.1-alpha.10+1.20.4" = _FCFZjvvB;
        "pkg-3.8.1-alpha.11+1.20" = _A9YHGfUT;
        "pkg-3.8.1-alpha.11+1.20.4" = _CVmZq4NB;
        "pkg-3.8.1-alpha.12" = _dUONWeko;
        "pkg-3.8.1+alpha.13" = _8b9EKJCY;
        "pkg-3.8.1+alpha.14" = _la5R19oI;
        "pkg-3.10.0+beta.1" = _hq9tdMbV;
        "pkg-3.10.0+beta.2" = _SnFfiP8P;
        "pkg-3.8.1+beta.3" = _oFX3OUeC;
        "pkg-3.10.0+beta.3" = _bCvj0I3i;
        "pkg-3.8.1+beta.4" = _yJxMQbwx;
        "pkg-3.10.0+beta.4" = _FiJDmrXj;
        "pkg-3.8.1+beta.5" = _c605Bv8U;
        "pkg-3.10.0+beta.5" = _Uu3roewJ;
        "pkg-3.8.1+beta.6" = _TiOWdIUO;
        "pkg-3.10.0+beta.6" = _1UxSG6hq;
        "pkg-3.8.1+beta.7+1.20" = _CYKxqo5a;
        "pkg-3.10.0+beta.7+1.21" = _XGEce4OY;
        "pkg-3.8.1+beta.8+1.20" = _rHASxaJN;
        "pkg-3.10.0+beta.8" = _5d4ffPwD;
        "pkg-3.8.1+beta.9" = _7JH5vmCW;
        "pkg-3.10.0+beta.9" = _G5m3zOFi;
        "pkg-3.10.0+beta.10" = _4sJa5CWt;
        "pkg-3.10.0+beta.11" = _66BFHfl1;
        "pkg-3.8.1+beta.11" = _byhR4pVP;
        "pkg-3.8.1+beta.12" = _Hg2FyTt8;
        "pkg-3.8.1+beta.13" = _nUeUocAI;
        "pkg-3.8.1+beta.14" = _dfzKbUiE;
        "pkg-3.10.0+beta.14" = _Y8oIs2JE;
        "pkg-3.10.0+beta.15" = _K7vwuETO;
        "pkg-3.10.0+beta.16" = _Mn70tLTv;
        "pkg-3.10.0+beta.17" = _IJwHv80D;
        "pkg-3.10.0+beta.18" = _cDrOq5N0;
        "pkg-3.10.0+beta.19" = _7I9AESw1;
        "pkg-3.10.0+beta.20" = _pXEoBdUF;
        "pkg-3.10.0+beta.21" = _HkguJYVZ;
        "pkg-3.10.0+beta.22" = _hScpqR9D;
        "pkg-3.10.0+beta.23" = _onbWZoRr;
        "pkg-3.10.0+beta.24" = _V0qUSMyV;
        "pkg-3.10.0+beta.25" = _7yAB0Frl;
        "pkg-3.10.0+beta.26" = _HnrfmaNK;
        "pkg-3.10.0+beta.27" = _I5dSbNIC;
        "pkg-3.10.0+beta.28" = _ruFhKLpu;
        "default" = _ruFhKLpu;
    });
