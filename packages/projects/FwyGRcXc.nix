...
let
    ...
    in {
        ...
        "pkg-3.10" = _RLsb035W;
        "pkg-3.11" = _qPDkJ0id;
        "pkg-3.12beta1" = _oVs8ct7d;
        "pkg-3.20beta1" = _NZV558xG;
        "pkg-3.20" = _sFHdaUT4;
        "pkg-3.21" = _jx0AgGCT;
        "pkg-3.30" = _IVtuSPuI;
        "pkg-3.31" = _mJDUjllN;
        ...
        "pkg-4.12" = _Bqf9CkJs;
        "pkg-4.13" = _9IED41x8;
        "pkg-4.13beta1" = _5aTsnLGa;
        "pkg-4.20" = _aJnrX1he;
        "pkg-1.8.9-4.20beta2" = _kcIjryx4;
        "pkg-1.8.9-4.20beta8" = _hxWHK8br;
        "pkg-1.8.9-4.20beta11" = _y8mU3fox;
        "pkg-1.8.9-4.20beta12" = _IAkvnKnc;
        "pkg-1.8.9-4.20beta14" = _lyQuffeB;
        "pkg-4.21" = _pv1fcUb6;
        "pkg-1.8.9-4.21beta15" = _NxQKRc5G;
        "pkg-1.8.9-4.21beta16" = _6BLm6kc8;
        "pkg-4.22" = _1ApS1BLf;
        "pkg-1.8.9-4.22beta17" = _tjhTo9SD;
        "pkg-1.8.9-4.22beta18" = _bRuVlTFu;
        "pkg-1.8.9-4.22beta20" = _FqfLGhbI;
        "pkg-1.8.9-4.22beta22" = _xwuqnXyZ;
        "pkg-1.8.9-4.22beta25" = _XJLjHz4g;
        "pkg-1.8.9-4.22beta28" = _WIUOUFeL;
        "pkg-1.8.9-4.22beta30" = _cUNSTUut;
        "pkg-1.8.9-4.22beta31" = _J0fcXcMa;
        "pkg-4.23" = _yh0gvwT5;
        "pkg-1.8.9-4.23beta32" = _I2u9vICQ;
        "pkg-1.8.9-4.23beta33" = _NhLDDtq1;
        "pkg-1.9.0-4.23beta33" = _orxfdVLv;
        "pkg-1.9.0-4.23beta34" = _BrEIT8Ms;
        "pkg-1.8.9-4.23beta35" = _8kOjLwq8;
        "pkg-1.9.0-4.23beta35" = _Af3T2CdZ;
        "pkg-1.9.0-4.23beta36" = _w5MuUX6x;
        "pkg-1.8.9-4.23beta37" = _TenYcQWU;
        "pkg-1.9.0-4.23beta37" = _RDAgYQ7t;
        "pkg-1.9.0-4.23beta38" = _KFmZFuJM;
        "pkg-1.9.0-4.23beta39" = _a9TrwFQi;
        "pkg-1.9.0-4.23beta40" = _RPSPhLgx;
        "pkg-1.8.9-4.23beta38" = _fRpg5hFw;
        "pkg-1.8.9-4.23beta39" = _hutnTn5D;
        "pkg-1.9.0-4.23beta41" = _GDrwQYlW;
        "pkg-1.9.0-4.23beta42" = _l99Icm6v;
        "pkg-1.9.0-4.23beta43" = _4nOytnrq;
        "pkg-1.9.0-4.23beta44" = _rxTV0Xpe;
        "pkg-1.9.0-4.30" = _o9WM1qt7;
        "pkg-1.9.0-4.40" = _pmcaitll;
        "pkg-1.9.0-4.41" = _HEVhJB4v;
        "pkg-1.9.0-4.42" = _CLAMPrnN;
        "pkg-1.9.0-4.43" = _23DUj7oK;
        "pkg-1.9.0-4.44" = _MOrhzHNi;
        "pkg-1.9.0-4.45" = _sJkdwBoU;
        "pkg-1.8.9-4.23beta40" = _aJZSm8Qw;
        "pkg-1.9.0-4.46" = _3mJF0MHv;
        "pkg-1.9.0-4.47" = _iZGK5Hvo;
        "pkg-1.9.0-4.48" = _HpAYv23F;
        "pkg-1.9.4-4.48" = _9q4UGQ7S;
        "pkg-1.9.4-4.49" = _XGET2qcZ;
        "pkg-1.9.4-4.50" = _am4ys7FC;
        "pkg-1.9.4-4.51" = _VLETscH9;
        "pkg-1.9.4-4.60" = _JCOf5ZmY;
        "pkg-1.9.4-4.61" = _GLV969FV;
        "pkg-1.9.4-4.62" = _qwjaNfSN;
        "pkg-1.9.4-4.63" = _1A3a9XcO;
        "pkg-1.9.4-4.64" = _PP1FiB1c;
        "pkg-1.9.4-4.65" = _zPDHvaa7;
        "pkg-1.9.4-4.66" = _fsJcrXx7;
        "pkg-1.10-4.66" = _u89qQNl9;
        "pkg-1.9.4-4.67" = _NDs5sY4R;
        "pkg-1.10-4.67" = _pHJGELQe;
        "pkg-1.9.4-5.00" = _h5Sv5iCK;
        "pkg-1.10-5.00" = _5WQyPO05;
        "pkg-1.9.4-5.01" = _rYYM2VTc;
        "pkg-1.10-5.01" = _R32FXjCH;
        "pkg-1.9.4-5.02" = _XCHFI40F;
        "pkg-1.10-5.02" = _iz9NODhO;
        "pkg-1.9.4-5.03" = _hnEpB77i;
        "pkg-1.10-5.03" = _7RvKFXP5;
        "pkg-1.9.4-5.04" = _TzKbdOLu;
        "pkg-1.10-5.04" = _ruDWYF0T;
        "pkg-1.9.4-5.05" = _ZX3hBEuP;
        "pkg-1.10-5.05" = _woz2pl9k;
        "pkg-1.9.4-5.06" = _9bzvLANQ;
        "pkg-1.10-5.06" = _NPsIynXB;
        "pkg-1.9.4-5.07" = _QK2YHxxe;
        "pkg-1.10-5.07" = _8oIFJAbA;
        "pkg-1.10-5.08" = _M7PMaoVR;
        "pkg-1.10-5.09" = _mydjb9cd;
        "pkg-1.9.4-5.07a" = _16XAEKVs;
        "pkg-1.9.4-5.07b" = _xKgeuSwm;
        "pkg-1.10-5.10" = _HJJY08Rl;
        "pkg-1.10-5.11" = _PowH4gRv;
        "pkg-1.10-5.12" = _2CST2dri;
        "pkg-1.10-5.13" = _LiTE1wmr;
        "pkg-1.10-5.14" = _PshgDPE6;
        "pkg-1.10-5.15" = _JnTxSVFY;
        "pkg-1.10-5.16" = _8Iqwu9YN;
        "pkg-1.10-5.17" = _ZPWqWaJS;
        "pkg-1.10-5.18" = _h99dgOrU;
        "pkg-1.10-5.19" = _e3HnfJx2;
        "pkg-1.10-5.20" = _pbXHK5Pv;
        "pkg-1.10-5.21" = _n3slBeoA;
        "pkg-1.10-5.22" = _ZkdPJZIO;
        "pkg-1.10-5.23" = _k1YZBB06;
        "pkg-1.10-5.24" = _8wcSuA79;
        "pkg-1.10-5.25" = _DYIYPdI0;
        "pkg-1.10-5.26" = _o5SciHeB;
        "pkg-1.10-5.50" = _BOVkHm2N;
        "pkg-1.10-5.51" = _chZF2H08;
        "pkg-1.10-5.52" = _L5ZrKDqM;
        "pkg-1.10-5.53" = _GuySafqD;
        "pkg-1.10-5.54" = _vWiaTEAo;
        "pkg-1.10-5.55" = _lqDb6QJW;
        "pkg-1.10-5.56" = _YCR6ombY;
        "pkg-1.10-5.57" = _aCbJcoC9;
        "pkg-1.10-5.58" = _vdkPGcW1;
        "pkg-1.10-5.59" = _E1QTNMRl;
        "pkg-1.10-5.60" = _cLXMNgPI;
        "pkg-1.10-5.61" = _fGez1gVq;
        "pkg-1.10-5.62" = _Ynf0G9mm;
        "pkg-1.11-5.62alpha1" = _qg9Kx8ev;
        "pkg-1.11-5.62alpha2" = _z2kXMgOx;
        "pkg-1.11-5.62alpha3" = _UQmWpwIk;
        "pkg-1.11-5.62alpha4" = _XfpKHOaw;
        "pkg-1.11-5.62beta1" = _6GCuonvm;
        "pkg-1.1x-5.70" = _KhyzIK96;
        "pkg-1.1x-5.71" = _ytlRkC8D;
        "pkg-1.1x-5.72" = _1BHwvmUR;
        "pkg-1.1x-5.73" = _P4DVXMWg;
        "pkg-1.1x-5.74" = _HC77SlcC;
        "pkg-1.1x-5.75" = _LfcMJ5AS;
        "pkg-1.1x-5.76" = _YBfbW6LB;
        "pkg-1.1x-5.80" = _oS2xyfEf;
        "pkg-1.1x-5.81" = _7t91dtJH;
        "pkg-1.1x-5.82" = _FMZpNf3K;
        "pkg-1.1x-5.83" = _wytT4YpV;
        "pkg-1.1x-5.84" = _xU2lBMdb;
        "pkg-1.1x-5.85" = _vGHBisJ3;
        "pkg-1.1x-5.86" = _x6EUN7eP;
        "pkg-1.1x-5.87" = _kdnZcbeZ;
        "pkg-1.1x-5.88" = _xeQIXp7O;
        "pkg-1.1x-5.90" = _IrK8mDAk;
        "pkg-1.1x-5.91" = _qn7TKuxR;
        "pkg-1.1x-5.92" = _hOBVPRrz;
        "pkg-1.1x-6.00" = _yN0UuTYh;
        "pkg-1.1x-6.01" = _bhPkqZdZ;
        "pkg-1.12-6.02beta" = _XGxJBzN0;
        "pkg-1.12-6.03" = _9yFR9y3X;
        "pkg-1.12-6.04" = _WGL7Sqdk;
        "pkg-1.1x-6.10" = _sGrarHB6;
        "pkg-1.12-6.10beta1" = _Tq2gZrWT;
        "pkg-1.12-6.10beta2" = _UtT45Aa6;
        "pkg-1.12-6.10beta3" = _fiwIKES8;
        "pkg-1.12-6.10beta4" = _k3rdMIiW;
        "pkg-1.1x-6.11" = _gLTyAT4m;
        "pkg-1.12-6.11" = _CnsCvgba;
        "pkg-1.1x-6.12" = _EJalIRim;
        "pkg-1.12-6.12" = _Edu5vvBf;
        "pkg-1.1x-6.13" = _ueSVOMsd;
        "pkg-1.12-6.13" = _BpHpFQLg;
        "pkg-1.1x-7.00alpha1" = _tYEct2TJ;
        "pkg-1.12-7.00alpha1" = _eL7XvooJ;
        "pkg-1.1x-7.00alpha2" = _M2CNcx5Q;
        "pkg-1.12-7.00alpha2" = _Enq4do29;
        "pkg-1.1x-7.00" = _ObNOtqnG;
        "pkg-1.12-7.00" = _RqMtUH2z;
        "pkg-1.1x-7.01" = _8VXF5Y7T;
        "pkg-1.12-7.01" = _wTuWg6Wa;
        "pkg-1.1x-7.10" = _ttzyx8DW;
        "pkg-1.12-7.10" = _W3UWeIBU;
        "pkg-1.1x-7.11" = _9zhKKwSf;
        "pkg-1.12-7.11" = _AXCupF3w;
        "pkg-1.1x-7.12" = _ioPdXtTW;
        "pkg-1.12-7.12" = _nkMmus8P;
        "pkg-1.1x-7.13" = _itL5E7bo;
        "pkg-1.12-7.13" = _2aSylIAc;
        "pkg-1.1x-7.14" = _kcTv6X6H;
        "pkg-1.12-7.14" = _XjXfiOeR;
        "pkg-1.1x-7.15" = _VQEXZF0j;
        "pkg-1.12-7.15" = _vtUxmOks;
        "pkg-1.1x-7.16" = _HIg6UcMo;
        "pkg-1.12-7.20" = _ofccoZq9;
        "pkg-1.12-7.21" = _YRx2UqTi;
        "pkg-1.12-7.22" = _wHBn8QUp;
        "pkg-1.12-7.23" = _XXQFzDYM;
        "pkg-1.12-7.24" = _ZPrLDPI4;
        "pkg-1.12-7.25" = _3wLnQ3Uk;
        "pkg-1.12-7.26" = _sItSetuE;
        "pkg-1.12-7.27" = _xgUuSNRD;
        "pkg-1.12-7.28" = _djH7C000;
        "pkg-1.12-7.29" = _N2MDEx5h;
        "pkg-1.12-7.30" = _X9yIgTte;
        "pkg-1.12-7.31" = _JHV33DKA;
        "pkg-1.12-7.32" = _t3t3dkkV;
        "pkg-1.12-7.33" = _JMB6ElpP;
        "pkg-1.12-7.50-alpha" = _sBcbD2Oo;
        "pkg-1.12-7.50" = _LxMSkPMh;
        "pkg-1.12-7.51" = _Jrzg81Wh;
        "pkg-1.12-7.52" = _GoSo7yOF;
        "pkg-1.12-7.53" = _Cy1YvQmE;
        "pkg-1.12-7.54" = _hYLeQZ6h;
        "pkg-1.12-7.55" = _AyhPOIjl;
        "pkg-1.12-7.56" = _nkEzpuMQ;
        "pkg-1.12-7.57" = _1M3XkvGb;
        "pkg-1.12-7.58" = _We8LaEcp;
        "pkg-1.12-7.59" = _w6uxrQgD;
        "pkg-1.12-7.60" = _X39rU91f;
        "pkg-1.12-7.61" = _BPKRCIps;
        "pkg-1.12-7.70" = _oEFEMT40;
        "pkg-1.12-7.71" = _ZWNoRTDE;
        "pkg-1.12-7.72" = _imA7gDdl;
        "pkg-1.12-7.73" = _xRnNLLgU;
        "default" = _xRnNLLgU;
    });
