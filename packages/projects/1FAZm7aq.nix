...
let
    ...
    in {
        ...
        "pkg-3.0.0-Beta2" = _ELVWsoC4;
        "pkg-3.0.0-Beta3" = _V1CJdVCM;
        "pkg-3.0.0-b4" = _Vqsw22IT;
        "pkg-3.0.0-b5" = _jw5GnyfX;
        "pkg-3.0.0-b7" = _SzxJlewC;
        "pkg-3.0.0-b8" = _MPzLRsnx;
        "pkg-3.0.0-b12" = _R7YlWJ8p;
        "pkg-3.0.0-b11" = _sRhODk2P;
        "pkg-3.0.0" = _vryLDyRM;
        "pkg-3.0.1" = _ZGeTTnSd;
        "pkg-3.0.2" = _AiTIQFhz;
        "pkg-3.1.0" = _iYZfz9WJ;
