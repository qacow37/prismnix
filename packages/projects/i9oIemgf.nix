...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.20.1-fabric" = _AGe3jAwU;
        "pkg-1.0.0-1.20.1-forge" = _IurLf2Y1;
        "pkg-1.0.0-1.18.2-fabric" = _p0qHKTpr;
        "pkg-1.0.0-1.18.2-forge" = _ry1QKg5l;
        "pkg-1.0.0-1.19.2-fabric" = _XXqRAWpv;
        "pkg-1.0.0-1.19.2-forge" = _HXQqDdv3;
        "pkg-1.0.0-1.20.2-fabric" = _3oquPjTn;
        "pkg-1.0.0-1.20.2-forge" = _16kaVQti;
        "pkg-1.0.0-1.20.4-fabric" = _cbvN4vBn;
        "pkg-1.0.0-1.20.4-forge" = _8EyVGyr0;
        "pkg-1.0.0-1.20.4-neoforge" = _tVNygyFx;
        "pkg-1.0.0-1.20.5-fabric" = _W4eESGoO;
        "pkg-1.0.0-1.20.5-neoforge" = _VzySNBkZ;
        "pkg-1.0.1-1.18.2-fabric" = _SQ0R6JOa;
        "pkg-1.0.1-1.18.2-forge" = _UXfYpA8X;
        "pkg-1.0.1-1.19.2-fabric" = _NWidS3EP;
        "pkg-1.0.1-1.19.2-forge" = _AtAGUMO6;
        "pkg-1.0.1-1.20.1-fabric" = _sNxG4Wjk;
        "pkg-1.0.1-1.20.1-forge" = _pfk4Tavr;
        "pkg-1.0.1-1.20.2-fabric" = _NUc6niQb;
        "pkg-1.0.1-1.20.2-forge" = _Ib035min;
        "pkg-1.0.1-1.20.4-fabric" = _Hw2Z1qmF;
        "pkg-1.0.1-1.20.4-forge" = _un1qHNL7;
        "pkg-1.0.1-1.20.4-neoforge" = _pLoGvAAb;
        "pkg-1.0.1-1.20.5-1.20.6-fabric" = _ELfQoIkH;
        "pkg-1.0.1-1.20.5-1.20.6-neoforge" = _Uc9qfvWN;
        "pkg-1.0.2-1.20.6-forge" = _rig8ejVf;
        "default" = _rig8ejVf;
    });
