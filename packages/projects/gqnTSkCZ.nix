...
let
    ...
    in {
        ...
        "pkg-2.1.0.0" = _CJCyTSRm;
        "pkg-2.1.0.1" = _bGBH6LWs;
        "pkg-1.16.5-2.3.0.0" = _PVDBEzgJ;
        "pkg-1.19.2-2.3.0.0" = _lheJyejJ;
        "pkg-2.3.0.0" = _1xSMNEWQ;
        "pkg-2.4.0.0" = _UNQew1pn;
        "pkg-3.0.0.0" = _uAzCtsJj;
        "pkg-3.0.1" = _jX2a87pp;
        "pkg-3.0.2" = _1VvCAFvg;
        "pkg-3.0.3" = _J2LIgB5w;
        "pkg-3.0.4" = _aWAbj6XV;
