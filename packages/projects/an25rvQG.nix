...
let
    ...
    in {
        ...
        "pkg-1.13-1.14.4" = _9gGGH4rj;
        "pkg-1.15-1.16.1" = _12ckoF5w;
        "pkg-1.16.2-1.16.5" = _Pj004m1W;
        "pkg-1.17-1.17.1" = _qA4DG128;
        "pkg-1.18-1.18.2" = _YxYD09i9;
        "pkg-1.19-1.19.2" = _Te0KkzcZ;
        "pkg-1.19.3" = _vg6l0nUC;
        "pkg-1.19.4" = _Ygaqplti;
        "pkg-1.20-1.20.1" = _E4Td8FT5;
        "pkg-1.20.2" = _RigNpNHC;
        "pkg-1.20.3-1.20.4" = _zJZDTWF4;
        "pkg-1.20.5-1.20.6" = _IuAqE3g3;
        "pkg-1.21-1.21.1" = _kqNRMKSU;
        "pkg-1.21.2-1.21.3" = _zK6J6QbR;
        "pkg-1.21.4" = _ktSDQGd9;
        "pkg-1.21.5" = _WCVAwDci;
        "pkg-1.21.6" = _iW1OF7Qb;
        "pkg-1.21.7-1.21.8" = _375s87lK;
        "pkg-1.21.9-1.21.10" = _ZKsPgxzT;
        "pkg-1.21.11" = _rIqUQiJI;
