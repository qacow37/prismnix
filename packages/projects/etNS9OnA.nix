...
let
    ...
    in {
        ...
        "pkg-0.1-1.18" = _9JsuKILw;
        "pkg-0.2-1.18" = _RSbGkJcW;
        "pkg-0.3-1.18" = _ZdTEnGrE;
        "pkg-0.4" = _DlbycXxv;
        "pkg-0.5" = _YHF8rYwf;
        "pkg-0.6" = _21BCZIoF;
        "pkg-0.6-1.18-forge" = _O5P5NPuH;
        "pkg-0.6-1.19-forge" = _7fef64kP;
        "pkg-0.6-1.16-fabric" = _ikN5PiH6;
        "pkg-0.7" = _YzRylmIN;
        "pkg-0.7.1" = _iqsLz3Ec;
        "pkg-0.7.1-1.19.2-forge" = _V5ZubcEV;
        "pkg-0.7.1-1.18.2-forge" = _LGarySSp;
        "pkg-0.8.0-1.19.3" = _WEXmJ65X;
        "pkg-0.8.0-1.19.2" = _zjZurVRD;
        "pkg-0.8.1-1.19.2" = _AOSLmPSm;
        "pkg-0.8.0-1.19.3-forge" = _hJnp5GxW;
        "pkg-0.8.1-1.19.3" = _uRKxnmLf;
        "pkg-0.8.0-1.18" = _XHEt05Fe;
        "pkg-0.9.0-1.19.3" = _xhQtFLwf;
        "pkg-0.9.0-1.19.2" = _deCs6uEy;
        "pkg-0.8.1-1.18" = _jUfZtzXd;
        "pkg-0.9.0-1.19.4-forge" = _WARslvd4;
        "pkg-0.9.0-1.19.4" = _VzjKE22C;
        "pkg-0.9.0-1.18" = _1nFOiM4a;
        "pkg-0.9.1-1.19.4" = _mUdiVe5F;
        "pkg-0.9.1-1.19.2" = _IgL9xnir;
        "pkg-0.9.1-1.19.3" = _En0M8w16;
        "pkg-0.9.2-1.19.2" = _vcAuCHu3;
        "pkg-0.9.2-1.19.4" = _VX4EwzJ7;
        "pkg-0.9.2-1.19.3" = _PQAcKqXz;
        "pkg-0.9.0-1.16.5" = _uguKMSeg;
        "pkg-0.9.3-1.19.2" = _zOKFnNub;
        "pkg-0.9.3-1.19.3" = _v6N5M8wh;
        "pkg-0.9.3-1.19.4" = _u0oZyL3i;
        "pkg-0.9.3-1.20" = _7puIjJfi;
        "pkg-0.9.0-1.20-forge" = _MguWVKSI;
        "pkg-0.9.1-1.18" = _YWiOkjOh;
        "pkg-0.9.4-1.19.2" = _70LD02Tx;
        "pkg-0.9.4-1.19.3" = _hLlZicFf;
        "pkg-0.9.4-1.19.4" = _tQ5YU0wv;
        "pkg-0.9.4-1.20" = _NW7fWtg9;
        "pkg-0.10.0-1.18.2" = _VTCQ2ZdM;
        "pkg-0.10.0-1.19.4" = _KQ9m5Xgy;
        "pkg-0.10.0-1.20.1" = _VUF1fC4K;
        "pkg-0.10.0-1.19.2" = _6TOOC0wq;
        "pkg-0.10.0-1.19.3" = _2xILkzcs;
        "pkg-0.11.0-1.20.1" = _CZTbg5HK;
        "pkg-0.11.0-1.20.4" = _8IrMxh1o;
        "pkg-0.11.1-1.20.1-build.190" = _nqsXLrj5;
        "pkg-0.11.1-1.20.4-build.191" = _7IZiPz82;
        "pkg-0.11.2-1.20.1-build.39" = _aHav6Zvw;
        "pkg-0.11.2-1.20.6-build.41" = _CGpKOp2D;
        "pkg-0.11.2-1.20.4-build.40" = _isy1RSYY;
        "pkg-0.11.2-1.21-build.42" = _ddMD82FT;
        "pkg-1.0.0-1.20.1-build.43" = _Y33LYMG3;
        "pkg-1.0.0-1.21.11-build.44" = _7a1nQTWv;
        "pkg-1.0.0-26.1.2-build.45" = _jB5UYwon;
        "pkg-1.0.1+mc26.2+fabric" = _G5gYytKL;
        "pkg-1.0.2+mc1.20.1+forge" = _4bI60vuW;
        "pkg-1.0.2+mc1.21.11+neoforge" = _RUgM1TA3;
        "pkg-1.0.2+mc26.1.2+neoforge" = _PfN62uMO;
        "pkg-1.0.3+mc1.20.1+forge" = _iN3nmNPC;
        "default" = _iN3nmNPC;
    });
