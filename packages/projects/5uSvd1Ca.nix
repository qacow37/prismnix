...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.0" = _lgQ9fiUb;
        "pkg-1.18.2-1.0" = _UdIwhPh2;
        "pkg-1.19.2-1.0" = _SWEsHOKD;
        "pkg-1.19.3-1.0" = _hSl2zVke;
        "pkg-1.20.1-1.0" = _1Q0H3IUZ;
        "pkg-1.20.6-1.0" = _z86iPHiG;
        "pkg-1.21.1-1.0" = _1aVe5qd0;
        "pkg-1.21.3-1.0" = _rDCp3MQ2;
        "pkg-1.21.4-1.0" = _w3f33hBH;
        "pkg-1.16.5-1.1" = _nwaVW0a1;
        "pkg-1.16.5-1.1.1" = _H0AolMgr;
        "pkg-1.18.2-1.1" = _DbKUFiBT;
        "pkg-1.19.2-1.1" = _TQasVHmU;
        "pkg-1.19.3-1.1" = _bytvOJeG;
        "pkg-1.20.1-1.1" = _kSGCQUwC;
        "pkg-1.20.6-1.1" = _yelkc8xZ;
        "pkg-1.21.1-1.1" = _BRS5FyKc;
        "pkg-1.21.3-1.1" = _GFJOSRGB;
        "pkg-1.21.4-1.1" = _5UDDLwA8;
        "pkg-1.21.4-1.1.1" = _xD9hhAlr;
        "pkg-1.21.3-1.1.1" = _tPvHB9Ho;
        "pkg-1.21.4-1.1.2" = _HGhZ0iHS;
        "pkg-1.16.5-1.2" = _f7oduUwR;
        "pkg-1.18.2-1.2" = _BkRstMm4;
        "pkg-1.19.2-1.2" = _gT6zRyf1;
        "pkg-1.19.3-1.2" = _yTAET36q;
        "pkg-1.21.4-1.4" = _5MHDz7rb;
        "pkg-1.21.3-1.4" = _Y5U43LGH;
        "pkg-1.21.1-1.4" = _EZ2LXjz3;
        "pkg-1.20.6-1.4" = _5PbZZWcW;
        "pkg-1.20.6-1.4.1" = _LCrba6YV;
        "pkg-1.21.1-1.4.1" = _QUqP5lPp;
        "pkg-1.21.3-1.4.1" = _Gh2X3GmH;
        "pkg-1.21.4-1.4.1" = _HmURoTVq;
        "pkg-1.20.1-1.4" = _ryjnemuW;
        "pkg-1.19.3-1.4" = _U6EBws8u;
        "pkg-1.19.2-1.4" = _CF6jZsB2;
        "pkg-1.18.2-1.4" = _Hm23Kq5d;
        "pkg-1.16.5-1.4" = _woiLz4m5;
        "pkg-1.16.5-1.5" = _j22IQciS;
        "pkg-1.16.5-1.5.1" = _O3OcYBow;
        "pkg-1.18.2-1.5" = _X5g8sZ6J;
        "pkg-1.19.2-1.5" = _IvXwhERo;
        "pkg-1.19.3-1.5" = _O0owyyka;
        "pkg-1.20.1-1.5" = _Yb9kKWo7;
        "pkg-1.20.6-1.5" = _ICmGuUG9;
        "pkg-1.21.1-1.5" = _iWA6gFrW;
        "pkg-1.21.3-1.5" = _nWDA9hKi;
        "pkg-1.21.4-1.5" = _1QOmrOUF;
        "pkg-1.16.5-1.5.2" = _hQ4GVRCh;
        "pkg-1.18.2-1.5.1" = _F62ZAq4L;
        "pkg-1.19.2-1.5.1" = _maPk0S1N;
        "pkg-1.19.3-1.5.1" = _LGpC7oka;
        "pkg-1.21.4-1.6" = _ITKlbZ7R;
        "pkg-1.21.3-1.6" = _eMR6XXWr;
        "pkg-1.21.1-1.6" = _UnqrC4Yi;
        "pkg-1.20.6-1.6" = _gtBiyojm;
        "pkg-1.20.1-1.6" = _dNzg7oW4;
        "pkg-1.19.3-1.6" = _X2aX0kCq;
        "pkg-1.19.2-1.6" = _5gZbkdCj;
        "pkg-1.18.2-1.6" = _3rQEC47N;
        "pkg-1.16.5-1.6" = _ZQXxVJVV;
        "default" = _ZQXxVJVV;
    });
