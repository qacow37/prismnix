...
let
    ...
    in {
        ...
        "pkg-1.7.8" = _b1LpcA3Q;
        "pkg-1.7.9" = _ncDUW32A;
        "pkg-1.7.10" = _7LpSDFom;
        "pkg-1.7.11" = _bEO3MKxk;
        "pkg-1.7.12" = _wDPR5uPd;
        "pkg-1.7.13" = _hhhpUlwi;
        "pkg-1.7.14" = _mB9pIXP1;
        "pkg-1.7.14.2" = _MOnEk6bx;
        "pkg-1.7.14.4" = _YzWCtbGa;
        "pkg-1.8.0" = _yqjIUmJE;
        "pkg-1.8.1" = _Aedo7egk;
        "pkg-1.8.2" = _eeMZ9gAo;
        "pkg-1.8.3" = _59nLFBKj;
        ...
        "pkg-1.8.5" = _qUaSo3Yg;
        "pkg-1.8.7" = _jNOPvezr;
        "pkg-1.8.7.1" = _mVzHGmA9;
        "pkg-1.8.7.2" = _mdAq7Wsv;
        "pkg-1.8.7.3" = _NnI3LPQf;
        "pkg-1.8.7.4" = _ypplnMFO;
        "pkg-1.8.7.5" = _UI0zrOAY;
        "pkg-1.9.0" = _Wn6cnDkq;
        "pkg-1.9.0.1" = _33MpuWxA;
        "pkg-2026.1.0" = _8teDWj11;
        "pkg-2026.1.1" = _ZUQ4JZ0u;
        "pkg-2026.1.1.1" = _TBQgQFZU;
        "pkg-2026.1.2" = _uLDcMdEf;
        "pkg-2026.1.2.1" = _cdZMSLPv;
        "pkg-2026.1.3" = _XgQJ3r9K;
        "pkg-2026.1.4" = _nt0GWT1y;
        "default" = _nt0GWT1y;
    });
