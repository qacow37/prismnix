...
let
    ...
    in {
        ...
        "pkg-1.8.5" = _jQayilB7;
        "pkg-1.9.0" = _qJchjWIh;
        "pkg-1.21-1.0.0" = _w2kPPR59;
        "pkg-1.21-1.0.5" = _6AvJhq7l;
        "pkg-1.21-1.0.6" = _WATA6C1p;
        "pkg-1.21-1.0.7" = _M6Xsz3PV;
        "pkg-1.21-1.0.8" = _r0Gv9FTE;
        "pkg-1.21-1.1.0" = _ygYZSClZ;
        "pkg-1.21-1.1.4" = _gyB7mPL7;
        "pkg-1.21-1.1.5" = _CfQBEawq;
        "pkg-1.21-1.1.6" = _8AMFUgjA;
        "pkg-1.21-1.1.7" = _Io1D1urx;
        "pkg-1.21-1.2.0" = _cyFu9t7b;
        "pkg-1.21-1.2.5" = _YftKwfd8;
        "pkg-1.21-1.2.6" = _yGISZPoV;
        "pkg-1.21-1.3.0" = _Wwndhv7R;
        "pkg-1.21-1.3.1" = _Y1pHiMPT;
        "pkg-1.21-1.3.3" = _O3r7Frbn;
        "pkg-1.21-1.3.5" = _tGdGtqZq;
        "pkg-1.21-1.3.9" = _xl6C5Qo8;
        "pkg-1.21-1.4.5" = _J3A0fh0P;
        "pkg-1.21-1.4.7" = _8TXATUjl;
        "pkg-1.21-1.5.0" = _CEa94kTO;
        "pkg-1.21.4-1.0.0" = _7X4CWA4h;
        "pkg-1.21.4-1.0.5" = _Agw8uAf0;
        "pkg-1.21.4-1.1.5" = _BQNZkucA;
        "pkg-1.21.4-1.2.0" = _tLpOmIKi;
        "pkg-1.21.4-1.2.1" = _kxtk7Wb6;
        "pkg-1.21.4-1.2.5" = _EYJblxmP;
        "pkg-1.21.4-1.2.6" = _caT8PxqI;
        "pkg-1.21.4-1.2.7" = _KtRbx1Nj;
        "pkg-1.21.4-1.3.0" = _uW1P2Zlk;
        "pkg-1.21.4-1.3.3" = _kxBshcLx;
        "pkg-1.21.4-1.3.5" = _ZhtYOIor;
        "pkg-1.21.4-1.4.2" = _bkgDGsKf;
        "pkg-1.21-1.5.5" = _qCiJIJYa;
        "pkg-1.21-1.5.6" = _pWYsj8zj;
        "pkg-1.21-1.6.0" = _9YeQpB9g;
        "pkg-1.21-1.6.4" = _QVqWezkU;
        "pkg-1.21.4-1.4.5" = _bfpyO8vD;
        "pkg-1.21-1.7.5" = _WtvF3xlk;
        "default" = _WtvF3xlk;
    });
