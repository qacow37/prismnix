...
let
    ...
    in {
        ...
        "pkg-1.18.1-12" = _A3Uq1Mt3;
        "pkg-1.18.2-13" = _KG1Srx5U;
        "pkg-1.19-15" = _hoyXRhUT;
        "pkg-1.19.1-16" = _cVN28eoA;
        "pkg-1.19.2-18" = _Z5TvGnU8;
        "pkg-1.19.2-19" = _Vf13SDDX;
        "pkg-1.16.5-0-forge" = _JSK8m2bT;
        "pkg-1.17.1-1-forge" = _6xxUAjdI;
        "pkg-1.18.2-2-forge" = _K1jnrS3K;
        "pkg-1.19-3-forge" = _s3171Y61;
        "pkg-1.19.2-20" = _PUxltvjo;
        "pkg-1.19.2-21" = _ev3ZD1BT;
        "pkg-1.19.2-22" = _yklocEGo;
        "pkg-1.19.2-23" = _ZTWHnNA0;
        "pkg-1.19.2-24" = _cqPFu0YA;
        "pkg-1.19.1-4-forge" = _OHGSEzA7;
        "pkg-1.19.2-5-forge" = _5o3WCQHc;
        "pkg-1.19.2-25" = _k8SXHjDQ;
        "pkg-1.19.3-25" = _60GcwS51;
        "pkg-1.16.5-26" = _mFJ1XQCa;
        "pkg-1.18.2-26" = _sMe4N5xq;
        "pkg-1.19-26" = _j0XHPig1;
        "pkg-1.19.2-26" = _xFxxtjBD;
        "pkg-1.19.1-26" = _R9kjhfot;
        "pkg-1.19.3-26" = _JvdjOGsU;
        "pkg-1.19.2-27" = _nyJ7YPc6;
        "pkg-1.19.3-27" = _dwjlTvSY;
        "pkg-1.16.4-27-forge" = _EXsqNU2P;
        "pkg-1.16.5-27-forge" = _KROLhCbf;
        "pkg-1.17.1-27-forge" = _Lu044g4W;
        "pkg-1.18.1-27-forge" = _HOJ0Vf5i;
        "pkg-1.18.2-27-forge" = _777Faa16;
        "pkg-1.19.1-27-forge" = _P1IHX9g1;
        "pkg-1.19.2-27-forge" = _nVFCXm7a;
        "pkg-1.19.3-27-forge" = _sXmmZULQ;
        "pkg-1.19.4-27-fabric" = _Z75VViQu;
        "pkg-1.16.5-28-fabric" = _br01FvYr;
        "pkg-1.18.2-28-fabric" = _JY0fwpEc;
        "pkg-1.19-28-fabric" = _pgFekaZo;
        "pkg-1.19.1-28-fabric" = _6JwkV3H7;
        "pkg-1.19.2-28-fabric" = _2faZTugR;
        "pkg-1.19.3-28-fabric" = _gk6qR9X6;
        "pkg-1.19.4-28-fabric" = _voisNRa0;
        "pkg-1.19.4-27-forge" = _Ilpox1oh;
        "pkg-1.18.2-28-forge" = _74RrVIue;
        "pkg-1.19-28-forge" = _9KQKrgHb;
        "pkg-1.19.1-28-forge" = _KPwDbDRr;
        "pkg-1.19.2-28-forge" = _JSCK1ik2;
        "pkg-1.19.3-28-forge" = _2QMgTxZl;
        "pkg-1.19.4-28-forge" = _Kk7SePu2;
        "pkg-1.20-28-fabric" = _Jl65MSrG;
        "pkg-1.20-28-forge" = _bzQJG5dK;
        "pkg-1.20.1-28-fabric" = _UN8uqSVp;
        "pkg-1.20.1-28-forge" = _4M9IcI2Q;
        "pkg-1.16.5-29-fabric" = _ISRcyr6z;
        "pkg-1.16.5-29-forge" = _5PO3ic1N;
        "pkg-1.18.2-29-fabric" = _BLZruURq;
        "pkg-1.18.2-29-forge" = _j5oi39Xv;
        "pkg-1.19.2-29-fabric" = _blkkPPht;
        "pkg-1.19.2-29-forge" = _tdboGr4f;
        "pkg-1.19.4-29-fabric" = _TnsHigDd;
        "pkg-1.20-29-forge" = _Xeu26hQx;
        "pkg-1.20-29-fabric" = _66WAYbex;
        "pkg-1.20.1-29-forge" = _EiBDAmcd;
        "pkg-1.20.1-29-fabric" = _vPeM6A2e;
        "pkg-1.16.5-30-forge" = _kZuxnGZS;
        "pkg-1.16.5-30-fabric" = _8rShBzSl;
        "pkg-1.18.2-30-fabric" = _EWQcmNK1;
        "pkg-1.18.2-30-forge" = _uRlN5aRu;
        "pkg-1.19.2-30-fabric" = _Z5BhnQlk;
        "pkg-1.19.2-30-forge" = _ee6Yv7mB;
        "pkg-1.20.1-30-fabric" = _amdCP41C;
        "pkg-1.20.1-30-forge" = _Mu30CaBe;
        "pkg-1.20.2-30-fabric" = _FasBmHb0;
        "pkg-1.16.5-31-forge" = _e9dIIACR;
        "pkg-1.16.5-31-fabric" = _dItAyr3l;
        "pkg-1.18.2-31-fabric" = _o3S3U8u8;
        "pkg-1.18.2-31-forge" = _Tx1mEXA6;
        "pkg-1.19.2-31-fabric" = _MCibQ1gB;
        "pkg-1.19.2-31-forge" = _oihHRPWG;
        "pkg-1.20-31-fabric" = _qV8RcTeu;
        "pkg-1.20-31-forge" = _wjIUTgkd;
        "pkg-1.20.1-31-fabric" = _tAB3cxP6;
        "pkg-1.20.1-31-forge" = _lJYZ0z31;
        "pkg-1.20.2-31-fabric" = _ptrNxPjL;
        "pkg-1.20-32-fabric" = _QnvS8lS9;
        "pkg-1.20-32-forge" = _iKH8xNaA;
        "pkg-1.20.1-32-fabric" = _BBqauXf4;
        "pkg-1.20.1-32-forge" = _iKlv5qvC;
        "pkg-1.20.2-32-fabric" = _3RCaXU3R;
        "pkg-1.20.2-32-forge" = _KdQy88zL;
        "pkg-1.16.5-32-forge" = _EudekQ0H;
        "pkg-1.20.3-32-fabric" = _SiW3p5AG;
        "pkg-1.20.3-32-forge" = _PLqh1TG5;
        "pkg-1.20.4-32-forge" = _BInUqbxZ;
        "pkg-1.20.4-32-fabric" = _i6i9B33Q;
        "pkg-1.20.4-0-neoforge" = _8TfccFsT;
        "pkg-1.16.5-33-forge" = _Lfiw5ihH;
        "pkg-1.18.2-33-fabric" = _W78wrrmr;
        "pkg-1.18.2-33-forge" = _PhMNcDda;
        "pkg-1.19-33-fabric" = _oHeVbvO5;
        "pkg-1.19.1-33-fabric" = _B0D3RA99;
        "pkg-1.19.2-33-fabric" = _VowD54Hz;
        "pkg-1.19.2-33-forge" = _1SXj0a2Y;
        "pkg-1.19.3-33-fabric" = _A7LokPQ5;
        "pkg-1.19.4-33-fabric" = _rPLv68EG;
        "pkg-1.20.1-33-fabric" = _MU4Hsnzz;
        "pkg-1.20.1-33-forge" = _tugTpNIa;
        "pkg-1.20.2-33-fabric" = _cJxslVRa;
        "pkg-1.20.2-33-forge" = _7abscuXx;
        "pkg-1.20.3-33-fabric" = _FOXN6RUG;
        "pkg-1.20.4-33-fabric" = _7O0ihGY6;
        "pkg-1.20-33-fabric" = _S7JIfMwN;
        "pkg-1.20-33-forge" = _fIoQQPzK;
        "pkg-1.20.4-33-forge" = _pTulaJvr;
        "pkg-1.20.5-33-fabric" = _S6UHy1Vr;
        "pkg-1.20.6-0-neoforge" = _TqqQEpfM;
        "pkg-1.20.6-33-fabric" = _7FcxZzlT;
        "pkg-1.20.6-33-forge" = _BVmkdu5j;
        "pkg-1.21-33-fabric" = _iDIU5zbN;
        "pkg-1.21-34-fabric" = _uSVRHWBB;
        "pkg-1.21-33-forge" = _kW0Uzbk6;
        "pkg-1.21-0-neoforge" = _RQkJmows;
        "pkg-1.19.2-33.1-fabric" = _lhWfIoDo;
        "pkg-1.19.3-33.1-fabric" = _xmOyFL0v;
        "pkg-1.19.4-33.1-fabric" = _583UPF55;
        "pkg-1.20-33.1-fabric" = _sWzelyFa;
        "pkg-1.20.1-33.1-fabric" = _xdEiclmD;
        "pkg-1.20.3-33.1-fabric" = _T7PNZocJ;
        "pkg-1.20.4-33.1-fabric" = _oCnUNIr8;
        "pkg-1.20.5-33.1-fabric" = _Ae5VkwPG;
        "pkg-1.20.6-33.1-fabric" = _PBlgj2Xf;
        "pkg-1.19.2-33.1-forge" = _WMKSm4Zm;
        "pkg-1.19.3-27.1-forge" = _5uxdGUO0;
        "pkg-1.19.4-33.1-forge" = _oiGEKUbH;
        "pkg-1.20-33.1-forge" = _eJnlYzxr;
        "pkg-1.20.1-33.1-forge" = _j23t7R3T;
        "pkg-1.20.2-33.1-forge" = _YuF1qbUn;
        "pkg-1.20.4-33.1-forge" = _LzVRwz8O;
        "pkg-1.20.6-33.1-forge" = _bqwKHiyL;
        "pkg-1.21.1-0-neoforge" = _DUONjFPB;
        "pkg-1.21.1-34-fabric" = _EWwSr38Y;
        "pkg-1.21.1-33-forge" = _YFqs73c0;
        "pkg-1.21.3-34-fabric" = _RWJXG8aS;
        "pkg-1.21.3-0-neoforge" = _lNBYU3f3;
        "pkg-1.21.4-34-fabric" = _Z9JodWHO;
        "pkg-1.21.4-0-neoforge" = _wJwHG2Qf;
        "pkg-1.21.3-33-forge" = _XO1e0Cx0;
        "pkg-1.21.4-33-forge" = _AovuwLpb;
        "pkg-1.21.5-33-forge" = _6MPhZfcD;
        "pkg-1.21.5-33-neoforge" = _yKhgD3wR;
        "pkg-1.21.5-34-fabric" = _U3POYFfE;
        "pkg-1.18.2-fabric-35" = _nUxT3LW1;
        "pkg-1.18.2-forge-35" = _TzcvgQvD;
        "pkg-1.19.2-fabric-35" = _Ctc43BWS;
        "pkg-1.19.2-forge-35" = _SMd7zGYS;
        "pkg-1.19.4-fabric-35" = _85GA6O4V;
        "pkg-1.19.4-forge-35" = _vn1opfQU;
        "pkg-1.20.1-fabric-35" = _a66XYVQx;
        "pkg-1.20.1-forge-35" = _1zTkS8Pw;
        "pkg-1.20.2-fabric-35" = _r7gjsJxf;
        "pkg-1.20.2-forge-35" = _jF5ZGpEE;
        "pkg-1.20.4-fabric-35" = _jBqlinHw;
        "pkg-1.20.6-fabric-35" = _miW2eGoW;
        "pkg-1.20.6-forge-35" = _nX49D6IS;
        "pkg-1.20.6-neoforge-35" = _dP5CAO4o;
        "pkg-1.21.1-fabric-35" = _P4WHRlLt;
        "pkg-1.21.1-forge-35" = _Gn0uTiZ2;
        "pkg-1.21.1-neoforge-35" = _Olq5QZaS;
        "pkg-1.21.3-fabric-35" = _ZtwXyqGX;
        "pkg-1.21.3-forge-35" = _FXiVDvR9;
        "pkg-1.21.3-neoforge-35" = _ufo6Xdcw;
        "pkg-1.21.4-fabric-35" = _fVfHqEHR;
        "pkg-1.21.4-forge-35" = _aKdTpZyN;
        "pkg-1.21.4-neoforge-35" = _Z0TBHEOc;
        "pkg-1.21.5-fabric-35" = _G04nMFd5;
        "pkg-1.21.5-forge-35" = _NxXIWmCY;
        "pkg-1.21.5-neoforge-35" = _4oAtSUKz;
        "pkg-1.20.4-forge-35" = _xAjSGZbG;
        "pkg-1.21.6-fabric-35" = _Ymb11l1D;
        "pkg-1.21.6-forge-35" = _QihLyaG0;
        "pkg-1.21.6-neoforge-35" = _7IPLk4o8;
        "pkg-1.21.7-fabric-35" = _iromMot6;
        "pkg-1.21.7-forge-35" = _qYbfIPmj;
        "pkg-1.21.7-neoforge-35" = _NBRREK8A;
        "pkg-1.21.7-fabric-35.1" = _UCL1mkuM;
        "pkg-1.21.7-forge-35.1" = _RRSkziJn;
        "pkg-1.21.7-neoforge-35.1" = _qyjlbW8m;
        "pkg-1.21.8-fabric-35.1" = _jBquqoA9;
        "pkg-1.21.8-forge-35.1" = _4y51UGxg;
        "pkg-1.21.8-neoforge-35.1" = _IlvnkgwJ;
        "pkg-1.21.9-fabric-35.1" = _WGIiyoHZ;
        "pkg-1.21.9-forge-35.1" = _aXWAAAEM;
        "pkg-1.21.9-neoforge-35.1" = _h7IJCMBR;
        "pkg-1.21.10-fabric-35.1" = _MLp087GB;
        "pkg-1.21.10-forge-35.1" = _K6DUaAvH;
        "pkg-1.21.10-neoforge-35.1" = _N32o2wml;
        "pkg-1.21.11-fabric-35.1" = _6vlWPAKG;
        "pkg-1.21.11-forge-35.1" = _hfjewkPN;
        "pkg-1.21.11-neoforge-35.1" = _ItYBqPO5;
        "pkg-26.1.1-fabric-35.1" = _P3NBqywL;
        "pkg-26.1.1-forge-35.1" = _mnqh8pnl;
        "pkg-26.1.1-neoforge-35.1" = _px0hZ3VQ;
        "pkg-26.1.2-fabric-35.1" = _U36HZeKr;
        "pkg-26.1.2-forge-35.1" = _aLo8bfgp;
        "pkg-26.1.2-neoforge-35.1" = _fSYAB1IL;
        "pkg-26.1.2-neoforge-35.1.1" = _SZne1uyX;
