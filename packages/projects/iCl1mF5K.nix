...
let
    ...
    in {
        ...
        "pkg-1.1.2-beta1" = _yv6Mlldl;
        "pkg-1.1.2-beta2" = _H1LEht9d;
        "pkg-1.1.3-beta2" = _BLTwdBrq;
        "pkg-1.1.3-beta3" = _fSwkuS4H;
        "pkg-1.1.3-beta4" = _zwbHkdy9;
        "pkg-1.1.4-beta5" = _oJ0Sbl1y;
        "pkg-1.1.5-beta6" = _zSrnKbfe;
        "pkg-1.1.5-beta7" = _xcl6oKCH;
        "pkg-1.1.5-beta8" = _JLnTGga0;
        "pkg-1.1.5-beta9" = _udzBt1LG;
        "pkg-1.1.5-beta10" = _S88n4FqE;
        "pkg-1.1.5-beta11" = _NdfMWfu7;
        "pkg-1.1.6-beta12" = _T1yZRKTm;
        "pkg-1.1.6-beta13" = _aqexq3FY;
        "pkg-1.2.0-beta14" = _K4jS1NWI;
        "pkg-1.2.0-beta17" = _HtGxbSZR;
        "pkg-1.2.1" = _GEFAPvt4;
        "pkg-1.2.2" = _G8D9EXir;
        "pkg-1.2.4" = _JsPU6Qa4;
        "pkg-1.2.5" = _gEk5z2Jm;
