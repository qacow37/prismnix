...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _8EH91djL;
        "pkg-1.0.0+mod" = _HSZI0o6z;
        "pkg-1.0.1" = _OVW0TTlA;
        "pkg-1.0.1+mod" = _cDIDz6sT;
        "pkg-1.0.2" = _eVi1SsD7;
        "pkg-1.0.2+mod" = _X43NBku8;
        "pkg-1.1.0" = _IPEjCacp;
        "pkg-1.1.0+mod" = _qeuRgNpj;
        "pkg-2.0.0" = _HGI34mNF;
        "pkg-2.0.0+mod" = _dL409kGZ;
        "pkg-2.0.1" = _nx9iMGb8;
        "pkg-2.0.1+mod" = _nsnnBneQ;
        "pkg-2.0.2" = _4Mnbp7u9;
        "pkg-2.0.2+mod" = _MMLJ450G;
        "pkg-2.0.3" = _8p5VV1ly;
        "pkg-2.0.3+mod" = _APuvwzTv;
        "pkg-2.1.0" = _px8tBTlP;
        "pkg-2.1.0+mod" = _xBl4EIXd;
        "pkg-2.2.0" = _eQ0lFovV;
        "pkg-2.2.0+mod" = _syJBjfft;
        "pkg-2.2.1" = _eIUIl5KV;
        "pkg-2.2.1+mod" = _mjdXsblL;
        "pkg-2.2.2" = _yJTjYHE6;
        "pkg-2.2.2+mod" = _TXsou15A;
        "default" = _TXsou15A;
    });
