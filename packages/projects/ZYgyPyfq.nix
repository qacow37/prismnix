...
let
    ...
    in {
        ...
        "pkg-1.19.2-Forge-3.1.0" = _Ltax470w;
        "pkg-1.19.2-Fabric-3.1.0" = _oODh25Uv;
        "pkg-1.19.3-Forge-3.2.0" = _tEdVvBPJ;
        "pkg-1.19.3-Fabric-3.2.0" = _NxK9Eu2q;
        "pkg-1.19.4-Fabric-3.3.0" = _MUzrN78m;
        "pkg-1.19.4-Forge-3.3.0" = _uJ7BZWEq;
        "pkg-1.20-Forge-4.0.1" = _xV3hb9U8;
        "pkg-1.20-Fabric-4.0.1" = _jDmHcs7q;
        "pkg-1.20-Forge-4.0.2" = _ES49Icuw;
        "pkg-1.20-Fabric-4.0.2" = _TKzbRjqo;
        "pkg-1.20-Forge-4.0.3" = _h4m8J7w8;
        "pkg-1.20-Fabric-4.0.3" = _pfVTUz1L;
        "pkg-1.20.4-Forge-4.4.0" = _YTvJanVJ;
        "pkg-1.20.4-Fabric-4.4.0" = _F1adMKW8;
        "pkg-1.20.4-Forge-4.4.1" = _sPIYiD2o;
        "pkg-1.20.4-NeoForge-4.4.1" = _3R3fnian;
        "pkg-1.20.4-Fabric-4.4.1" = _OwgN09h2;
        "pkg-1.20.4-Forge-4.4.2" = _tA7Fnm1M;
        "pkg-1.20.4-NeoForge-4.4.2" = _GiY3Uibv;
        "pkg-1.20.4-Fabric-4.4.2" = _hEhjUqf6;
        "pkg-1.21.1-Fabric-5.1.0" = _dAsYjQpz;
        "pkg-1.21.1-Forge-5.1.0" = _mx6Qu9h5;
        "pkg-1.21.1-NeoForge-5.1.0" = _uE6pFqck;
        "pkg-1.21.1-Forge-5.1.1" = _7dBOlmn7;
        "pkg-1.21.1-NeoForge-5.1.1" = _N2EpMhR7;
        "pkg-1.21.1-Fabric-5.1.1" = _aVsikHca;
        "pkg-1.21.4-NeoForge-5.4.0" = _i6hi0ZAg;
        "pkg-1.21.4-Fabric-5.4.0" = _qGXmN34R;
        "pkg-26.1.2-Fabric-6.1.0" = _LxlVkvKv;
        "pkg-26.1.2-NeoForge-6.1.0" = _nxaj9k0R;
        "default" = _nxaj9k0R;
    });
