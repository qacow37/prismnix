...
let
    ...
    in {
        ...
        "pkg-0.1.0+mc1.21.1+fabric" = _VYYn4kmy;
        "pkg-0.1.0+mc1.21.1+neoforge" = _GtXg3UGj;
        "pkg-0.2.0+mc1.21.1+fabric" = _MZmcU2s8;
        "pkg-0.2.0+mc1.21.1+neoforge" = _f66IWz8y;
        "pkg-1.0.0+mc1.21.1+fabric" = _Fi02pRuv;
        "pkg-1.0.0+mc1.21.1+neoforge" = _EnBPJ4QL;
        "pkg-1.0.0a.beta.1+mc1.21.3+fabric" = _YAeYaoTp;
        "pkg-1.0.0a.beta.1+mc1.21.3+neoforge" = _w9XzD8cG;
        "pkg-1.0.0a.beta.2+mc1.21.3+neoforge" = _e5FmKTjO;
        "pkg-1.0.0a.beta.2+mc1.21.3+fabric" = _GGqltg2a;
        "pkg-1.0.1+mc1.21.1-neoforge" = _BC8b4D4G;
        "pkg-1.0.1+mc1.21.1-fabric" = _S8QKNwiK;
        "pkg-2.0.0+mc1.21.1-neoforge" = _4JwqvZHk;
        "pkg-2.0.0+mc1.21.1-fabric" = _X88sgvwS;
        "pkg-2.0.0-build.a1+mc1.21.4-neoforge" = _lX8ey0ZH;
        "pkg-2.0.0-build.a1+mc1.21.4-fabric" = _j2It5a1R;
        "pkg-3.0.0+mc1.21.1-neoforge" = _g8ujkpLe;
        "pkg-3.0.0+mc1.21.1-fabric" = _YNwnnCCd;
        "pkg-3.1.0+mc1.21.1-neoforge" = _NZucnaff;
        "pkg-3.1.0+mc1.21.1-fabric" = _L7de9t7f;
        "pkg-3.1.1+mc1.21.1-neoforge" = _QYn7gIwI;
        "pkg-3.1.1+mc1.21.1-fabric" = _81n6wgIZ;
        "pkg-3.1.1-build.a1+mc1.21.4-neoforge" = _It5AslfI;
        "pkg-3.1.1-build.a1+mc1.21.4-fabric" = _coEODybk;
        "pkg-3.2.0+mc1.21.1-neoforge" = _tvyXMCqc;
        "pkg-3.2.0+mc1.21.1-fabric" = _UQskz3vp;
        "pkg-3.2.0-build.a1+mc1.21.5-neoforge" = _AlwaXFwm;
        "pkg-3.2.0-build.a1+mc1.21.5-fabric" = _JIgncDPD;
        "pkg-3.2.1+mc1.21.1-neoforge" = _ytHVzLBY;
        "pkg-3.2.1+mc1.21.1-fabric" = _R11XyZbo;
        "pkg-3.2.1-build.a1+mc1.21.5-neoforge" = _Umtq8EKA;
        "pkg-3.2.1-build.a1+mc1.21.5-fabric" = _QB9YS4uZ;
        "pkg-3.2.1-build.b1+mc1.21.6-neoforge" = _s0nmlo34;
        "pkg-3.2.1-build.b1+mc1.21.6-fabric" = _aFDeD7sa;
        "pkg-3.2.1-build.b2+mc1.21.6-neoforge" = _67RJ4Dgs;
        "pkg-3.2.1-build.b2+mc1.21.6-fabric" = _7FMFWXnO;
        "pkg-3.2.1-build.b3+mc1.21.6-neoforge" = _IibEc0Vm;
        "pkg-3.2.1-build.b3+mc1.21.6-fabric" = _Vo937iRs;
        "pkg-3.2.1-build.b4+mc1.21.6-neoforge" = _XXDJwnaw;
        "pkg-3.2.1-build.b4+mc1.21.6-fabric" = _qoEbC9WT;
        "default" = _qoEbC9WT;
    });
