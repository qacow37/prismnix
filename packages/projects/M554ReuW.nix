...
let
    ...
    in {
        ...
        "pkg-1.9.4" = _Ozeb89P8;
        "pkg-1.9.5" = _Pb0FHZcf;
        "pkg-1.9.5a" = _pflph1BM;
        "pkg-1.10.0" = _He4MBvpJ;
        "pkg-1.10.1" = _BMH2I9Lq;
        "pkg-1.10.2" = _lKkERiJG;
        "pkg-1.10.3" = _KLXM4mBT;
        "pkg-1.10.4" = _asgf6zIH;
        "pkg-1.10.5" = _8nwDDkGc;
        "pkg-2.0" = _Xje3YpZq;
        "pkg-2.0.1" = _TiItdr64;
        "pkg-1.10.6" = _hqX4vj5i;
        "pkg-2.0.2" = _KcjINsOU;
        "pkg-2.0.3" = _Ek10QrZH;
        "pkg-3.0" = _9f8GYjuF;
        "pkg-3.0.1" = _aTE9D7WT;
