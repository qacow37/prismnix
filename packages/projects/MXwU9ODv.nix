...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta1-1.20.4" = _kRoafSSK;
        "pkg-1.0.0-beta2-1.20.4" = _bje7tEbO;
        "pkg-1.0.0-beta3-1.20.4" = _GcHoQvfG;
        "pkg-1.0.0-beta4-1.20.4" = _pzsqlZJR;
        "pkg-1.0.0-beta5-1.20.4" = _5kgxhiy3;
        "pkg-1.0.0-beta6-1.20.4" = _ODEm5dGM;
        "pkg-1.0.0-beta7-1.20.4" = _2rSUQ6uA;
        "pkg-1.0.0-beta8-1.20.4" = _WNrsUAMX;
        "pkg-1.0.0-beta9-1.20.4" = _nWJSyUJw;
        "pkg-1.0.0-beta10-1.20.4" = _6PFbMn7M;
        "pkg-1.0.0-beta12-1.20.4" = _JS1mWhZx;
        "pkg-1.0.0-beta13-1.20.6" = _uTeDFYsi;
        "pkg-1.0.0-beta14-1.20.6" = _oGQduKkn;
        "pkg-1.0.0-beta15-1.20.6" = _czMRusyu;
        "pkg-1.0.0-beta15-1.20.4" = _OMKOE4ku;
        "pkg-1.0.0-beta16-1.20.6" = _XTSwnFdC;
        "pkg-1.0.0-beta16-1.20.4" = _s1IrUUBZ;
        "pkg-1.0.0-beta17-1.20.6" = _ffrjri4s;
        "pkg-1.0.0-beta17-1.20.4" = _NHriXPzC;
        "pkg-1.0.0-beta18-1.20.6" = _VW8iQpFX;
        "pkg-1.0.0-beta18-1.20.4" = _TY3S5YXp;
        "pkg-1.0.0-beta19-1.20.6" = _FhRjCJrA;
        "pkg-1.0.0-beta19-1.20.4" = _Fs1VTI4M;
        "pkg-1.0.0-beta20-1.20.6" = _bozJl986;
        "pkg-1.0.0-beta20-1.20.4" = _SqFDq12u;
        "pkg-1.0.0-beta21-1.20.6" = _NvlmVQMZ;
        "pkg-1.0.0-beta21-1.20.4" = _XrDy8zj5;
        "pkg-1.0.0-beta22-1.21" = _luxl7yon;
        "pkg-1.0.0-beta22-1.20.6" = _O8WxThGE;
        "pkg-1.0.0-beta22-1.20.4" = _KB8cghzh;
        "pkg-1.0.0-beta23-1.21" = _qDVIN4zV;
        "pkg-1.0.0-beta23-1.20.6" = _TzBLdr2j;
        "pkg-1.0.0-beta23-1.20.4" = _OXbMZGap;
        "pkg-1.0.0-beta24-1.21" = _wBOImidv;
        "pkg-1.0.0-beta24-1.20.6" = _sz8Nsxz5;
        "pkg-1.0.0-beta24-1.20.4" = _G2gVyl3f;
        "pkg-1.0.0-beta25-1.20.6" = _fyeBuEr2;
        "pkg-1.0.0-beta25-1.21" = _7Yp3n5Zz;
        "pkg-1.0.0-beta25-1.20.4" = _kYmxHTqe;
        "pkg-1.0.0-beta26-1.21" = _l16iOCqb;
        "pkg-1.0.0-beta26-1.20.6" = _vYMQ8sat;
        "pkg-1.0.0-beta26-1.20.4" = _CHnRpy0S;
        "pkg-1.0.0-beta27-1.21" = _evLaBCV6;
        "pkg-1.0.0-beta27-1.20.6" = _HaicSMUj;
        "pkg-1.0.0-beta27-1.20.4" = _TqAD9rmd;
        "pkg-1.0.0-beta28-1.21" = _On20g6yo;
        "pkg-1.0.0-beta28-1.20.6" = _6I0sSGaR;
        "pkg-1.0.0-beta28-1.20.4" = _rKHWpmQ2;
        "pkg-1.0.0-beta29-1.21" = _dJNj1S8R;
        "pkg-1.0.0-beta29-1.20.6" = _QVcJBGtq;
        "pkg-1.0.0-beta29-1.20.4" = _I9LXh6Il;
        "pkg-1.0.0-beta30-1.21" = _lhoQV2kL;
        "pkg-1.0.0-beta30-1.20.6" = _ZdYNA49R;
        "pkg-1.0.0-beta30-1.20.4" = _sDT0WeTJ;
        "pkg-1.0.0-beta31-1.21" = _TcpsslkO;
        "pkg-1.0.0-beta31-1.20.6" = _DcysVphV;
        "pkg-1.0.0-beta31-1.20.4" = _h7VFKqdm;
        "default" = _h7VFKqdm;
    });
