...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.20.3" = _CLTWJB9L;
        "pkg-1.1.1-1.20" = _LaTkuqAY;
        "pkg-1.1.1-1.20.2" = _WgsuegcA;
        "pkg-1.1.1-1.20.3" = _u1peeUOA;
        "pkg-1.1.2-1.20" = _gNQ6x7go;
        "pkg-1.1.2-1.20.2" = _EDurKgbR;
        "pkg-1.1.2-1.20.3" = _Dh7s51Qr;
        "pkg-1.2.0-1.20" = _vzDBC3Ku;
        "pkg-1.2.0-1.20.2" = _1YuV7Xr7;
        "pkg-1.2.0-1.20.3" = _Couphg8C;
        "pkg-1.2.0-1.20.5" = _zArnEWSo;
        "pkg-1.2.0-1.21.0" = _SB5Dv6K9;
        "pkg-1.2.1-1.21.2" = _A0Nv7c1P;
        "pkg-1.2.2-1.21.4" = _A4GFx4TG;
        "pkg-1.3.0-1.21.0" = _9jztz07I;
        "pkg-1.3.0-1.21.2" = _nrCzuUaY;
        "pkg-1.3.0-1.21.4" = _WVYZzm2I;
        "pkg-1.3.0-1.21.5" = _pXLtrHXP;
        "pkg-1.3.0-1.21.6" = _fNNrc6Qa;
