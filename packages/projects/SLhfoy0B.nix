...
let
    ...
    in {
        ...
        "pkg-0.0.5-1.19.2" = _hwgnq2rw;
        "pkg-0.0.5-1.20.1" = _5ZbIXvm7;
        "pkg-0.0.6-1.19.2" = _nmdrqVdd;
        "pkg-0.0.6-1.20.1" = _AC9sBGZi;
        "pkg-0.0.7-1.19.2" = _6NDNm6C5;
        "pkg-0.0.7-1.20.1" = _QP1SfRkk;
        "pkg-0.0.9-1.19.2" = _J0Pmw3fH;
        "pkg-0.1.0-1.20.1" = _jLQIBbCs;
        "pkg-0.1.1-1.20.1" = _MzxB1F7J;
        "pkg-0.1.0-1.19.2" = _KstsErQ7;
        "pkg-0.1.2-1.20.1" = _cHFDLzQ6;
        "pkg-0.1.3-1.20.1" = _b60gE7qW;
        "pkg-0.1.1-1.19.2" = _5GaG37so;
        "pkg-0.1.4-1.20.1" = _2Q9inmUn;
        "pkg-0.1.2-1.19.2" = _t5CbP1QD;
        "pkg-0.1.5-1.20.1" = _ZoNwPx3c;
        "pkg-0.1.6-1.21.1" = _OLIqBV5d;
        "pkg-0.1.6-1.20.1" = _O13UCbwK;
        "pkg-0.1.7-1.21.1" = _njEWNxTg;
        "pkg-0.1.3-1.19.2" = _SX6bXyie;
        "pkg-0.1.7-1.20.1" = _LB5NVZba;
        "pkg-0.1.8-1.21.1" = _AR3Ef4Qe;
        "pkg-0.1.9-1.21.1" = _PHroGWhF;
        "default" = _PHroGWhF;
    });
