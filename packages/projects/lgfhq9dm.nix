...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18" = _lxa9wF5e;
        "pkg-1.0.1+1.18" = _pdQ1IwVe;
        "pkg-1.0.1+1.19" = _1rQmv15Y;
        "pkg-1.1.0+1.19" = _757w5kcq;
        "pkg-1.0.3+1.18" = _NzRRJMG4;
        "pkg-1.1.0+1.19.3" = _tz8gBtEz;
        "pkg-1.1.1+1.19" = _RwIEhmoq;
        "pkg-1.1.1+1.19.3" = _of4Nk111;
        "pkg-1.1.1+1.20.2" = _UAb51oJa;
        "pkg-1.1.2+1.20.4" = _PTpOKeuF;
        "pkg-1.1.3+1.19.3" = _QtoXAJLX;
        "pkg-1.1.3+1.19.2" = _GXil9YNj;
        "pkg-1.1.3+1.20.4" = _XwvJtiUo;
        "pkg-1.1.3+1.20.2" = _2Ic2fVTh;
        "pkg-1.1.3+1.20.6" = _wXFV8fmZ;
        "pkg-1.1.4+1.19.2" = _Vl4GIq6I;
        "pkg-1.1.4+1.19.3" = _qLVkCGKG;
        "pkg-1.1.4+1.20.2" = _p2ZxCO2w;
        "pkg-1.1.4+1.20.4" = _vgObv7R7;
        "pkg-1.1.4+1.20.6" = _VIZNmjvH;
        "pkg-1.1.5+1.20.6" = _ftN99KBu;
        "pkg-1.1.5+1.20.4" = _UsL4qgCM;
        "pkg-1.1.5+1.20.2" = _SwTlWYVw;
        "pkg-1.1.5+1.19.3" = _a6Cny0zK;
        "pkg-1.1.6+1.19.3" = _v4iEbx7W;
        "pkg-1.1.6+1.20.2" = _L1r8B4sX;
        "pkg-1.1.6+1.20.4" = _Fr9F6vLs;
        "pkg-1.1.6+1.20.6" = _KKeUv9QF;
        "default" = _KKeUv9QF;
    });
