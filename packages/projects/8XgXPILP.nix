...
let
    ...
    in {
        ...
        "pkg-1.0.0-Forge-1.20.1" = _1VL6h2iU;
        "pkg-1.0.1-Forge-1.20.1" = _rLRFQZhK;
        "pkg-1.0.2-Forge-1.20.1" = _8F1wPCwX;
        "pkg-1.0.3-Forge-1.20.1" = _ObaLZoA0;
        "pkg-1.0.4-Forge-1.20.1" = _fdKHqJtj;
        "pkg-1.0.0-NeoForge-1.21.1" = _dAgKup1F;
        "pkg-1.0.1-NeoForge-1.21.1" = _7dNMokVH;
        "pkg-1.0.2-NeoForge-1.21.1" = _FvXOBF97;
        "pkg-1.0.3-NeoForge-1.21.1" = _vpGUyAJ6;
        "pkg-1.0.5-Forge-1.20.1" = _shA1OZht;
        "pkg-1.0.4-NeoForge-1.21.1" = _NFlo5566;
        "pkg-1.0.6-Forge-1.20.1" = _I2cijmZE;
        "pkg-1.0.5-NeoForge-1.21.1" = _MjEfBAfz;
        "pkg-1.0.8-Forge-1.20.1" = _WX2Ai4CX;
        "pkg-1.0.6-NeoForge-1.21.1" = _ByzcZieI;
        "pkg-1.0.7-NeoForge-1.21.1" = _9wtJoazw;
        "pkg-1.0.9-Forge-1.20.1" = _Dj4orIFu;
        "pkg-1.0.8-NeoForge-1.21.1" = _fbPYklKD;
        "pkg-1.0.9-NeoForge-1.21.1" = _yEJQVWbk;
        "pkg-1.0.10-NeoForge-1.21.1" = _BDueIWKp;
        "pkg-1.0.11-NeoForge-1.21.1" = _GwAL1BBm;
        "pkg-1.0.10-Forge-1.20.1" = _t3713yBj;
        "default" = _t3713yBj;
    });
