...
let
    ...
    in {
        ...
        "pkg-0.1+08160912" = _sKAeFPF3;
        "pkg-0.1-beta.1+9dd00ca.github.ci.13" = _4rKRbfZP;
        "pkg-0.1-beta.1+6f85925.github.ci.17" = _frfzMfL6;
        "pkg-0.1-beta.1+cc41ac2.github.ci.23" = _dKsyX41k;
        "pkg-0.1-beta.1+995b86e.github.ci.25" = _AoHJEkfn;
        "pkg-0.1-beta.90+1ca9e1e.github.ci.35" = _6HvsFuLD;
        "pkg-0.1-beta.94+25264b8.github.ci.44" = _6EREMlbT;
        "pkg-0.1-beta+c715b95.ci.81" = _IoN5G71E;
        "pkg-0.1-beta+3af3e87.ci.87" = _aOHzO1pa;
        "pkg-0.1-beta+4dcfe8b.ci.114" = _IVqTRhD6;
        "pkg-0.1-beta+83e10b8.ci.120" = _tVrfxDWC;
        "pkg-0.1-beta+d289a9d.ci.122" = _oLnlXxOr;
        "pkg-0.1-beta+50596a0.ci.126" = _VuN4vZsH;
        "pkg-0.1-beta+65a0786.ci.128" = _ub9yWFme;
        "pkg-0.1-beta+f239761.ci.132" = _XVIGtcVG;
        "pkg-0.1-beta+27db3ac.ci.177" = _EgWENMiS;
        "pkg-0.1-beta+f5810ce.ci.180" = _V7jFOnC6;
        "pkg-0.1-beta+7759be0.ci.182" = _ED1a20fr;
        "pkg-0.1-beta+615e6f9.ci.200" = _pucMcPpF;
        "pkg-0.1-beta+2ebd994.ci.206" = _Xy8YU2Y2;
        "pkg-0.1-beta+22e3465.ci.233" = _Su1oUlzn;
        "pkg-0.1-beta+3ab9c95.ci.240" = _ZAkcYCm4;
        "pkg-0.1-beta+65d9c4b.ci.241" = _8Sv1SIMn;
        "pkg-0.1-beta+d75d165.ci.268" = _dyq36sLd;
        "pkg-0.1-beta+665f6a7.ci.294" = _rFceH5po;
        "pkg-0.1-beta+8bdb19c.ci.295" = _C4J1qELb;
        "pkg-0.1-beta+cd686ce.ci.296" = _ovc4RR64;
        "pkg-0.1-beta+4c3f24d.ci.304" = _eEPlokc6;
        "pkg-0.1-rc.2+1.20.1-stable" = _ZXrjjxXD;
        "pkg-0.1+1.20.1-stable" = _MROfj3Fa;
        "pkg-0.1.1+1.20.1-stable" = _9yRoLKJw;
        "pkg-0.2-beta+0a4505f.ci.415" = _VGCWDMqU;
        "pkg-0.1.2+1.20.1-stable" = _NCO2YAHR;
        "pkg-0.2-beta+1ec135a.ci.495" = _MGF9M1mn;
        "pkg-0.2-beta+cbc0559.ci.498" = _Bt2JmZxo;
        "pkg-0.2.556-beta+ghci.529" = _e21tycba;
        "pkg-0.2.593-beta+ghci.575" = _Y6rhYRHa;
        "pkg-0.2.611-beta+ghci.576" = _l3HvdysJ;
        "pkg-0.2.625-beta+1.20.4" = _a9DSiM4W;
        "pkg-0.1.2+1.20.1-hotfix" = _KO3ppo8x;
        "pkg-0.2.692-beta+1.21" = _eEABF96B;
        "pkg-0.3.696-beta+1.21" = _SIMkTqBl;
        "pkg-0.3.702-dev+1.21.31326ee" = _5tUigghf;
        "pkg-0.3.718-dev+1.21.44a7b51" = _Lcev7mYg;
        "pkg-0.10.0+1.21.4" = _VHI7AzEq;
        "pkg-0.10.0+1.21.1" = _bOnaZlBb;
        "pkg-0.10.0+1.21.5" = _Vi4IsYwI;
        "pkg-0.10.1+1.21.1" = _ue4LGNzF;
        "pkg-0.10.1+1.21.5" = _MRCnITd1;
        "pkg-0.10.1+1.21.4" = _GIBhQrNW;
        "pkg-0.10.1+1.21.3" = _PicOdleF;
        "pkg-0.10.1+1.21.6" = _TbsNCkP9;
        "pkg-0.10.2+1.21.3" = _padWEOGv;
        "pkg-0.10.2+1.21.1" = _pBGXKJIR;
        "pkg-0.10.2+1.21.4" = _2gLrMixz;
        "pkg-0.10.2+1.21.6" = _Yuh6jNAh;
        "pkg-0.10.3+1.21.6" = _Cqduy4EZ;
        "pkg-0.10.3+1.21.1" = _wcbWTNAy;
        "pkg-0.10.3+1.21.4" = _6CyuWkQF;
        "pkg-0.10.3+1.21.5" = _FcMy92WN;
        "pkg-0.10.3+1.21.3" = _8REId3bI;
        "default" = _8REId3bI;
    });
