...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _GBINc0lm;
        "pkg-1.10.2" = _PPtmD1v6;
        "pkg-1.11.5" = _XLSDGOWo;
        "pkg-1.11.6" = _mUYNiKoN;
        "pkg-1.11.7" = _ZKxLxf3R;
        "pkg-1.12.2" = _wSXgpnzr;
        "pkg-1.12.6" = _SGLdaEcF;
        "pkg-1.12.7" = _RVuAr5ws;
        "pkg-1.12.8" = _f16eMNJ7;
        "pkg-1.12.9" = _4Qd4qSSO;
        "pkg-1.13.0" = _jBuT9ZFi;
        "pkg-1.13.1" = _wTqmqpyu;
        "pkg-1.13.2" = _fpl2CLPT;
        "pkg-1.13.3" = _TjxK68CG;
        "pkg-1.13.5" = _MAWMW3Tu;
        "pkg-1.13.6" = _ptWu2Jht;
        "pkg-1.13.7" = _n7nkDXhM;
        "pkg-1.13.8" = _48jyJN3X;
        "pkg-1.14.0" = _SmNsfPlN;
        "pkg-1.14.3" = _yz4KVaAf;
        "pkg-1.14.4" = _wa84HaQu;
        "pkg-1.14.6" = _y0PtVZeG;
        "pkg-1.14.7" = _pFMJoCEx;
        "pkg-1.14.8" = _eOGeMjc9;
        "pkg-1.14.10" = _FBdELpkS;
        "pkg-1.14.11" = _DIbPmXMB;
        "pkg-1.14.13" = _goNmwtr2;
        "pkg-1.14.14" = _M1ppNni7;
        "pkg-1.14.15" = _jpOK2ndG;
        "pkg-1.14.16" = _MhGUzFz4;
        "pkg-1.14.17" = _xXyxvcqb;
        "pkg-2.0.1-beta" = _sIRSxwWL;
        "pkg-2.0.2-beta" = _c3Nc3wDN;
        "pkg-2.0.4" = _uQipF7fG;
        "pkg-2.0.5" = _zml6E9gS;
        "pkg-2.0.6" = _48M8DfnJ;
        "pkg-2.0.8" = _RSVE2csf;
        "pkg-2.0.9" = _GrF3L7DW;
        "pkg-2.0.10" = _OYe7I4f2;
        "pkg-2.0.13" = _PtjtFpbt;
        "pkg-2.0.16" = _hywk0q2l;
        "pkg-2.0.18" = _hk2oJA33;
        "pkg-2.0.19" = _LiDqSVbf;
        "pkg-2.0.20" = _xPFOMUfH;
        "pkg-2.0.21" = _nsTkWuNF;
        "pkg-2.0.22" = _BW8eB60S;
        "pkg-2.0.24+1.20.1" = _E3rNBZFj;
        "pkg-2.1.0+1.20.2" = _Mb3Rumzi;
        "pkg-2.1.1+1.20.2" = _aj6kf4hv;
        "pkg-2.1.2+1.20.2" = _HaE21MTV;
        "pkg-2.2.1+1.20.2" = _22AaSznG;
        "pkg-2.2.2+1.20.2" = _ibX8Tkzp;
        "pkg-2.2.3+1.20.2" = _HTygTpt6;
        "pkg-2.2.4+1.20.2" = _k6LROn1y;
        "pkg-2.2.5+1.20.2" = _UyZD6V9g;
        "pkg-2.2.5+1.20.1" = _pv5WiWjR;
        "pkg-2.2.6+1.20.2" = _Hb9zzZq3;
        "pkg-2.2.6+1.20.1" = _UzfHc4f5;
        "pkg-2.3.0+1.20.2" = _u4qF4Vz9;
        "pkg-2.3.0+1.20.1" = _ZyS4xuxy;
        "pkg-2.3.0+1.20.3" = _DBRMa8iv;
        "pkg-2.3.1+1.20.4" = _29jbVBn0;
        "pkg-2.3.1+1.20.2" = _Xy6BFuJr;
        "pkg-2.3.1+1.20.1" = _MmVeVZkG;
        "pkg-2.3.2+1.20.2" = _FZgmgv4l;
        "pkg-2.3.2+1.20.4" = _TNtRbxiH;
        "pkg-2.3.2+1.20.1" = _Kx2gkwrm;
        "pkg-2.3.3+1.20.2" = _KwTzXU8h;
        "pkg-2.3.3+1.20.1" = _27DSTuBB;
        "pkg-2.3.3+1.20.4" = _86r5Jf2t;
        "pkg-2.3.4+1.20.4" = _tXVegcrt;
        "pkg-2.3.4+1.20.2" = _YgbeRTU5;
        "pkg-2.3.4+1.20.1" = _o551CUUa;
        "pkg-2.4.0+1.20.4" = _sKf26Igi;
        "pkg-2.4.0+1.20.2" = _II4l1IvK;
        "pkg-2.4.0+1.20.5" = _ivS1LYYQ;
        "pkg-2.4.0+1.20.1" = _mCVOdFBV;
        "pkg-2.4.1+1.20.6" = _l7038n8u;
        "pkg-2.4.1+1.20.2" = _TYFTkEhP;
        "pkg-2.4.1+1.20.1" = _8Tt8HUHc;
        "pkg-2.4.1+1.20.4" = _oVPfFIxT;
        "pkg-2.4.3+1.20.6" = _e08LeEw5;
        "pkg-2.4.3+1.20.4" = _2AF3iGXQ;
        "pkg-2.4.3+1.20.1" = _QMO5B1AE;
        "pkg-2.4.3+1.20.2" = _JzyYcY2X;
        "pkg-2.5.0+1.21" = _7aXwwLYh;
        "pkg-2.6.0+1.20.4" = _IbB8ImT9;
        "pkg-2.6.0+1.20.1" = _3CDSKlSA;
        "pkg-2.6.0+1.21.1" = _cAL6uial;
        "pkg-2.6.2+1.21.1" = _TqUfWIXt;
        "pkg-2.6.2+1.20.1" = _CLLSdOh3;
        "pkg-2.6.2+1.20.4" = _aIsGLhED;
        "pkg-2.6.3+1.21.1" = _l7AnqnrL;
        "pkg-2.6.3+1.20.1" = _itk4JlZI;
        "pkg-2.6.3+1.20.4" = _1vptrP79;
        "pkg-2.6.4+1.21.2" = _K6qcgGyq;
        "default" = _K6qcgGyq;
    });
