...
let
    ...
    in {
        ...
        "pkg-1.1" = _ZPI6y61s;
        "pkg-1.2" = _adEgOJNF;
        "pkg-2.0-alpha1" = _OKvSISC2;
        "pkg-2.0-alpha2" = _j2mxyjHv;
        "pkg-2.0-alpha3" = _UwJUSOxp;
        "pkg-2.0-alpha4" = _gmwfKxd7;
        "pkg-2.0" = _3okWpB2C;
        "pkg-2.1" = _FNGSqjUN;
        "pkg-2.2" = _FZnUFUWk;
        "pkg-2.2.1" = _cfrjzyiO;
        "pkg-2.2.2" = _QbhA8LuG;
        "pkg-2.2.3" = _HWi07QOh;
        "pkg-2.3.0-beta.1-1.18.2-fabric" = _6qIicHuu;
        "pkg-2.3.0-beta.1-1.19.2-fabric" = _2h0uQQNw;
        "pkg-2.3.0-beta.1-1.19.4-fabric" = _X1pb8Oe6;
        "pkg-2.3.0-beta.1-1.20.1-fabric" = _IpYRf6YI;
        "pkg-2.3.0-beta.1-1.20.4-fabric" = _b1UwowPX;
        "pkg-2.3.0-beta.1-1.20.4-neoforge" = _pNn7MY2z;
        "pkg-2.3.0-beta.1-1.20.6-fabric" = _4yWvGDWH;
        "pkg-2.3.0-beta.1-1.20.6-neoforge" = _G9Xn3Dro;
        "pkg-2.3.0-beta.1-1.21.1-fabric" = _qHvlrxu6;
        "pkg-2.3.0-beta.1-1.21.1-neoforge" = _yXwzQPLV;
        "pkg-2.3.0-beta.1-1.21.3-fabric" = _UCUaRtIN;
        "pkg-2.3.0-beta.1-1.21.3-neoforge" = _O6ybjJ4H;
        "pkg-2.3.0-beta.1-1.21.6-neoforge" = _sAuA2DRk;
        "pkg-2.3.0-beta.1-1.21.8-fabric" = _dOxd8emQ;
        "pkg-2.3.0-beta.1-1.21.8-neoforge" = _vrU8Tjlp;
        "pkg-2.3.0-beta.1-1.21.10-fabric" = _wPok858z;
        "pkg-2.3.0-beta.1-1.21.10-neoforge" = _1vAZUx0D;
        "pkg-2.3.0-beta.2-1.18.2-fabric" = _M5mcieEH;
        "pkg-2.3.0-beta.2-1.18.2-neoforge" = _MnglVGYK;
        "pkg-2.3.0-beta.2-1.19.2-fabric" = _iuMBrsS5;
        "pkg-2.3.0-beta.2-1.19.2-neoforge" = _EnW1ktwa;
        "pkg-2.3.0-beta.2-1.19.4-fabric" = _IxPKG3lp;
        "pkg-2.3.0-beta.2-1.19.4-neoforge" = _uP2Rtci1;
        "pkg-2.3.0-beta.2-1.20.1-fabric" = _QTJ8U71H;
        "pkg-2.3.0-beta.2-1.20.1-neoforge" = _Z8RMd2f9;
        "pkg-2.3.0-beta.2-1.20.4-fabric" = _hNEZN8hi;
        "pkg-2.3.0-beta.2-1.20.4-neoforge" = _Fkqu9n2U;
        "pkg-2.3.0-beta.2-1.20.6-fabric" = _ic4NNSpk;
        "pkg-2.3.0-beta.2-1.20.6-neoforge" = _pcBYLOQS;
        "pkg-2.3.0-beta.2-1.21.1-fabric" = _7bEAjGpm;
        "pkg-2.3.0-beta.2-1.21.1-neoforge" = _R3cJUp4A;
        "pkg-2.3.0-beta.2-1.21.3-fabric" = _FQ5Z4La9;
        "pkg-2.3.0-beta.2-1.21.3-neoforge" = _rTY6oVwK;
        "pkg-2.3.0-beta.2-1.21.6-neoforge" = _osWTYcVn;
        "pkg-2.3.0-beta.2-1.21.8-fabric" = _dh3uHbVT;
        "pkg-2.3.0-beta.2-1.21.8-neoforge" = _KGxEABsJ;
        "pkg-2.3.0-beta.2-1.21.10-fabric" = _7sBFbA6L;
        "pkg-2.3.0-beta.2-1.21.10-neoforge" = _dA22pyoF;
        "pkg-2.3.0-beta.3-1.18.2-fabric" = _vZLuthvR;
        "pkg-2.3.0-beta.3-1.18.2-neoforge" = _1iOKv5tQ;
        "pkg-2.3.0-beta.3-1.19.2-fabric" = _IrTuwrEl;
        "pkg-2.3.0-beta.3-1.19.2-neoforge" = _ZynV82nm;
        "pkg-2.3.0-beta.3-1.19.4-fabric" = _H4JcY8IV;
        "pkg-2.3.0-beta.3-1.19.4-neoforge" = _lYOudDUE;
        "pkg-2.3.0-beta.3-1.20.1-fabric" = _JSQuGEfn;
        "pkg-2.3.0-beta.3-1.20.1-neoforge" = _IsAs6XV8;
        "pkg-2.3.0-beta.3-1.20.4-fabric" = _3zPm3exu;
        "pkg-2.3.0-beta.3-1.20.4-neoforge" = _52gkYcyv;
        "pkg-2.3.0-beta.3-1.20.6-fabric" = _2mrCtypS;
        "pkg-2.3.0-beta.3-1.20.6-neoforge" = _t0AosNCR;
        "pkg-2.3.0-beta.3-1.21.1-fabric" = _kTpqaA9O;
        "pkg-2.3.0-beta.3-1.21.1-neoforge" = _2UOyLunf;
        "pkg-2.3.0-beta.3-1.21.3-fabric" = _EnAPgtuI;
        "pkg-2.3.0-beta.3-1.21.3-neoforge" = _AFEbdufI;
        "pkg-2.3.0-beta.3-1.21.6-neoforge" = _gmV9VhZu;
        "pkg-2.3.0-beta.3-1.21.8-fabric" = _sCcCxwJr;
        "pkg-2.3.0-beta.3-1.21.8-neoforge" = _DeIh6fUg;
        "pkg-2.3.0-beta.3-1.21.10-fabric" = _rL98bcYZ;
        "pkg-2.3.0-beta.3-1.21.10-neoforge" = _G7H68o2q;
        "pkg-2.3.0-beta.4-1.18.2-fabric" = _8Dw6MnUY;
        "pkg-2.3.0-beta.4-1.18.2-forge" = _Z4SJm8X9;
        "pkg-2.3.0-beta.4-1.19.2-fabric" = _n5jqRzk3;
        "pkg-2.3.0-beta.4-1.19.2-forge" = _cHQvNwG8;
        "pkg-2.3.0-beta.4-1.19.4-fabric" = _bJqDxpBj;
        "pkg-2.3.0-beta.4-1.19.4-forge" = _xsJx5sUX;
        "pkg-2.3.0-beta.4-1.20.1-fabric" = _o2alRa4y;
        "pkg-2.3.0-beta.4-1.20.1-forge" = _DR8G0k03;
        "pkg-2.3.0-beta.4-1.20.4-fabric" = _p0blncr9;
        "pkg-2.3.0-beta.4-1.20.4-neoforge" = _v7oKcspw;
        "pkg-2.3.0-beta.4-1.20.6-fabric" = _xif77Vfx;
        "pkg-2.3.0-beta.4-1.20.6-neoforge" = _TVGF2SkN;
        "pkg-2.3.0-beta.4-1.21.1-fabric" = _b4Tu1yPk;
        "pkg-2.3.0-beta.4-1.21.1-neoforge" = _9GMmuV9p;
        "pkg-2.3.0-beta.4-1.21.3-fabric" = _dlBgTOb2;
        "pkg-2.3.0-beta.4-1.21.3-neoforge" = _xkCW6kpT;
        "pkg-2.3.0-beta.4-1.21.6-neoforge" = _knLBK7h3;
        "pkg-2.3.0-beta.4-1.21.8-fabric" = _jpepnzIn;
        "pkg-2.3.0-beta.4-1.21.8-neoforge" = _VyLKRoxJ;
        "pkg-2.3.0-beta.4-1.21.10-fabric" = _T9FdPrNP;
        "pkg-2.3.0-beta.4-1.21.10-neoforge" = _SQvKSLpR;
        "pkg-2.3.0-beta.5-1.18.2-fabric" = _lFmCXSjm;
        "pkg-2.3.0-beta.5-1.18.2-forge" = _3PcMjwBo;
        "pkg-2.3.0-beta.5-1.19.2-fabric" = _1e2JE0Yf;
        "pkg-2.3.0-beta.5-1.19.2-forge" = _KWWO6Eql;
        "pkg-2.3.0-beta.5-1.19.4-fabric" = _a6NlQKaj;
        "pkg-2.3.0-beta.5-1.19.4-forge" = _hr0rNrKw;
        "pkg-2.3.0-beta.5-1.20.1-fabric" = _sIZxSaPY;
        "pkg-2.3.0-beta.5-1.20.1-forge" = _OGSekQkA;
        "pkg-2.3.0-beta.5-1.20.4-fabric" = _enzU57tT;
        "pkg-2.3.0-beta.5-1.20.4-neoforge" = _mE0NeZy6;
        "pkg-2.3.0-beta.5-1.20.6-fabric" = _c5u9xbwY;
        "pkg-2.3.0-beta.5-1.20.6-neoforge" = _D048L6qT;
        "pkg-2.3.0-beta.5-1.21.1-fabric" = _gl9FOOqW;
        "pkg-2.3.0-beta.5-1.21.1-neoforge" = _NM6IEYHG;
        "pkg-2.3.0-beta.5-1.21.3-fabric" = _t4EnJEn5;
        "pkg-2.3.0-beta.5-1.21.3-neoforge" = _FaNc85E2;
        "pkg-2.3.0-beta.5-1.21.5-fabric" = _UKsXNY2j;
        "pkg-2.3.0-beta.5-1.21.5-neoforge" = _aFvMzmdO;
        "pkg-2.3.0-beta.5-1.21.6-neoforge" = _AsgIR7P9;
        "pkg-2.3.0-beta.5-1.21.8-fabric" = _9UnkXnjG;
        "pkg-2.3.0-beta.5-1.21.8-neoforge" = _bALkXysb;
        "pkg-2.3.0-beta.5-1.21.10-fabric" = _znh1Avpm;
        "pkg-2.3.0-beta.5-1.21.10-neoforge" = _Yo9lDQR0;
        "pkg-2.3.0-1.18.2-fabric" = _xoMdULF5;
        "pkg-2.3.0-1.18.2-forge" = _TyS1yHYR;
        "pkg-2.3.0-1.19.2-fabric" = _WwLEQ5Zd;
        "pkg-2.3.0-1.19.2-forge" = _uj2B8r0b;
        "pkg-2.3.0-1.19.4-fabric" = _oCWs9a8t;
        "pkg-2.3.0-1.19.4-forge" = _RJtheJqm;
        "pkg-2.3.0-1.20.1-fabric" = _YT6XLhJp;
        "pkg-2.3.0-1.20.1-forge" = _k8IXqO6g;
        "pkg-2.3.0-1.20.4-fabric" = _hgICMt3E;
        "pkg-2.3.0-1.20.4-neoforge" = _Mj38w4UG;
        "pkg-2.3.0-1.20.6-fabric" = _VUy9wPEh;
        "pkg-2.3.0-1.20.6-neoforge" = _yVmFW6MZ;
        "pkg-2.3.0-1.21.1-fabric" = _Tw6sfj3u;
        "pkg-2.3.0-1.21.1-neoforge" = _bjogSV4z;
        "pkg-2.3.0-1.21.3-fabric" = _TvN0errg;
        "pkg-2.3.0-1.21.3-neoforge" = _rNenYiZm;
        "pkg-2.3.0-1.21.5-fabric" = _38591CRB;
        "pkg-2.3.0-1.21.5-neoforge" = _VKBcQXiO;
        "pkg-2.3.0-1.21.6-neoforge" = _1OVQVtrb;
        "pkg-2.3.0-1.21.8-fabric" = _Wo5gVH11;
        "pkg-2.3.0-1.21.8-neoforge" = _Z1QGgmG8;
        "pkg-2.3.0-1.21.10-fabric" = _NLOkVLUL;
        "pkg-2.3.0-1.21.10-neoforge" = _RKouQtU9;
        "pkg-2.3.1-1.18.2-fabric" = _uOodAPAJ;
        "pkg-2.3.1-1.18.2-forge" = _EJ7M2pbA;
        "pkg-2.3.1-1.19.2-fabric" = _YIbagqFK;
        "pkg-2.3.1-1.19.2-forge" = _oXvK2wL1;
        "pkg-2.3.1-1.19.4-fabric" = _Kk2VWcEl;
        "pkg-2.3.1-1.19.4-forge" = _69zdvHJ6;
        "pkg-2.3.1-1.20.1-fabric" = _pdN7X2Mh;
        "pkg-2.3.1-1.20.1-forge" = _VoXOiwvs;
        "pkg-2.3.1-1.20.4-fabric" = _D1W7j4ya;
        "pkg-2.3.1-1.20.4-neoforge" = _ZGpcVjrO;
        "pkg-2.3.1-1.20.6-fabric" = _pKRSABh2;
        "pkg-2.3.1-1.20.6-neoforge" = _PTfH0WJN;
        "pkg-2.3.1-1.21.1-fabric" = _b1MWfU6y;
        "pkg-2.3.1-1.21.1-neoforge" = _Q76N0fGG;
        "pkg-2.3.1-1.21.3-fabric" = _kn8aPJLx;
        "pkg-2.3.1-1.21.3-neoforge" = _VxZZouF1;
        "pkg-2.3.1-1.21.5-fabric" = _HIG6vpAQ;
        "pkg-2.3.1-1.21.5-neoforge" = _XRZT2pcd;
        "pkg-2.3.1-1.21.6-neoforge" = _3Ef7m2tP;
        "pkg-2.3.1-1.21.8-fabric" = _BPwECsqg;
        "pkg-2.3.1-1.21.8-neoforge" = _mclVHOdq;
        "pkg-2.3.1-1.21.10-fabric" = _QU5mdclV;
        "pkg-2.3.1-1.21.10-neoforge" = _kQsa7ozM;
        "pkg-2.3.2-1.18.2-fabric" = _T9IsROo0;
        "pkg-2.3.2-1.18.2-forge" = _zffPnVTK;
        "pkg-2.3.2-1.19.2-fabric" = _HqV5Ip5B;
        "pkg-2.3.2-1.19.2-forge" = _IHDHjEXJ;
        "pkg-2.3.2-1.19.4-fabric" = _Z1fXBWp0;
        "pkg-2.3.2-1.19.4-forge" = _u3pwTy1B;
        "pkg-2.3.2-1.20.1-fabric" = _sRd3tYqT;
        "pkg-2.3.2-1.20.1-forge" = _visAlDuj;
        "pkg-2.3.2-1.20.4-fabric" = _fye5hPmA;
        "pkg-2.3.2-1.20.4-neoforge" = _KAaduC8k;
        "pkg-2.3.2-1.20.6-fabric" = _ADXUjoOX;
        "pkg-2.3.2-1.20.6-neoforge" = _RmfyzKC4;
        "pkg-2.3.2-1.21.1-fabric" = _lnadq2l0;
        "pkg-2.3.2-1.21.1-neoforge" = _Ypjuw83q;
        "pkg-2.3.2-1.21.3-fabric" = _neqSqp8n;
        "pkg-2.3.2-1.21.3-neoforge" = _bNge5pJZ;
        "pkg-2.3.2-1.21.5-fabric" = _uA4Rs6Mv;
        "pkg-2.3.2-1.21.5-neoforge" = _8BRSp5QT;
        "pkg-2.3.2-1.21.6-neoforge" = _Q0hvmaWX;
        "pkg-2.3.2-1.21.8-fabric" = _7vEqidxK;
        "pkg-2.3.2-1.21.8-neoforge" = _Clu9xafW;
        "pkg-2.3.2-1.21.10-fabric" = _nWpdj9xA;
        "pkg-2.3.2-1.21.10-neoforge" = _ZEpj8P8X;
        "pkg-2.3.3-1.18.2-fabric" = _znzLFXeg;
        "pkg-2.3.3-1.18.2-forge" = _O4lJuiBQ;
        "pkg-2.3.3-1.19.2-fabric" = _NBqac0rr;
        "pkg-2.3.3-1.19.2-forge" = _Q8kU6BY1;
        "pkg-2.3.3-1.19.4-fabric" = _6qnnHqpj;
        "pkg-2.3.3-1.19.4-forge" = _E8Oz3lWj;
        "pkg-2.3.3-1.20.1-fabric" = _XtWyrJfd;
        "pkg-2.3.3-1.20.1-forge" = _5Ik8zOVH;
        "pkg-2.3.3-1.20.4-fabric" = _b5cchiMF;
        "pkg-2.3.3-1.20.4-neoforge" = _m2XrUdgN;
        "pkg-2.3.3-1.20.6-fabric" = _3ezb9B2g;
        "pkg-2.3.3-1.20.6-neoforge" = _TWBUMSTU;
        "pkg-2.3.3-1.21.1-fabric" = _r9DMSCuk;
        "pkg-2.3.3-1.21.1-neoforge" = _OZmCbnsy;
        "pkg-2.3.3-1.21.3-fabric" = _6HdKuKBG;
        "pkg-2.3.3-1.21.3-neoforge" = _rIK7mCzM;
        "pkg-2.3.3-1.21.5-fabric" = _myRkk3EK;
        "pkg-2.3.3-1.21.5-neoforge" = _kwRfK6VS;
        "pkg-2.3.3-1.21.6-neoforge" = _itK7eIMS;
        "pkg-2.3.3-1.21.8-fabric" = _zy9XchJv;
        "pkg-2.3.3-1.21.8-neoforge" = _lfCyzvNx;
        "pkg-2.3.3-1.21.10-fabric" = _knkyIOn2;
        "pkg-2.3.3-1.21.10-neoforge" = _zCNPlhMO;
        "pkg-2.3.3-bugfix-1.18.2-fabric" = _YbmXOIRQ;
        "pkg-2.3.3-bugfix-1.18.2-forge" = _MZkTNtq1;
        "pkg-2.3.3-bugfix-1.19.2-fabric" = _fraeVr0m;
        "pkg-2.3.3-bugfix-1.19.2-forge" = _b5fyURw4;
        "pkg-2.3.3-bugfix-1.19.4-fabric" = _KKnXdVBl;
        "pkg-2.3.3-bugfix-1.19.4-forge" = _CthykVNo;
        "pkg-2.3.3-bugfix-1.20.1-fabric" = _TsmQ7KHX;
        "pkg-2.3.3-bugfix-1.20.1-forge" = _2YdOW2Dk;
        "pkg-2.3.3-bugfix-1.20.4-fabric" = _36S5YBN8;
        "pkg-2.3.3-bugfix-1.20.4-neoforge" = _bVr3LGVg;
        "pkg-2.3.3-bugfix-1.20.6-fabric" = _3oXpomO4;
        "pkg-2.3.3-bugfix-1.20.6-neoforge" = _GmaGkY6g;
        "pkg-2.3.3-bugfix-1.21.1-fabric" = _l7oowN0f;
        "pkg-2.3.3-bugfix-1.21.1-neoforge" = _8etuU5bu;
        "pkg-2.3.3-bugfix-1.21.3-fabric" = _SY49gOSc;
        "pkg-2.3.3-bugfix-1.21.3-neoforge" = _mlkMBcYI;
        "pkg-2.3.3-bugfix-1.21.5-fabric" = _vn425icz;
        "pkg-2.3.3-bugfix-1.21.5-neoforge" = _HhauKA6O;
        "pkg-2.3.3-bugfix-1.21.6-neoforge" = _SNMfLp2a;
        "pkg-2.3.3-bugfix-1.21.8-fabric" = _jaj2APFp;
        "pkg-2.3.3-bugfix-1.21.8-neoforge" = _VCKcQJRg;
        "pkg-2.3.3-bugfix-1.21.10-fabric" = _EERTFk36;
        "pkg-2.3.3-bugfix-1.21.10-neoforge" = _t8HpncNf;
        "pkg-2.3.4-1.18.2-fabric" = _wzjraHaJ;
        "pkg-2.3.4-1.18.2-forge" = _Jm4Oz7ri;
        "pkg-2.3.4-1.19.2-fabric" = _EDCUnfxV;
        "pkg-2.3.4-1.19.2-forge" = _zPC4uI8t;
        "pkg-2.3.4-1.19.4-fabric" = _rUeRRaQz;
        "pkg-2.3.4-1.19.4-forge" = _8ZzeyWbu;
        "pkg-2.3.4-1.20.1-fabric" = _MVbYgFJy;
        "pkg-2.3.4-1.20.1-forge" = _Z9hqGoB6;
        "pkg-2.3.4-1.20.4-fabric" = _TujFzX0s;
        "pkg-2.3.4-1.20.4-neoforge" = _VSoN22JW;
        "pkg-2.3.4-1.20.6-fabric" = _tl0lPWip;
        "pkg-2.3.4-1.20.6-neoforge" = _FuYP2Xvd;
        "pkg-2.3.4-1.21.1-fabric" = _5pNXzmee;
        "pkg-2.3.4-1.21.1-neoforge" = _m2itNS7Z;
        "pkg-2.3.4-1.21.3-fabric" = _yww2WC1a;
        "pkg-2.3.4-1.21.3-neoforge" = _eMAxNHDO;
        "pkg-2.3.4-1.21.5-fabric" = _fJKU7Pei;
        "pkg-2.3.4-1.21.5-neoforge" = _WxJNYrI6;
        "pkg-2.3.4-1.21.6-neoforge" = _gteEpyBd;
        "pkg-2.3.4-1.21.8-fabric" = _fQp374g0;
        "pkg-2.3.4-1.21.8-neoforge" = _QNLmeaM0;
        "pkg-2.3.4-1.21.10-fabric" = _fjsW2N3D;
        "pkg-2.3.4-1.21.10-neoforge" = _hfRkSCgX;
        "pkg-2.3.5-1.18.2-fabric" = _r4Ou9BCU;
        "pkg-2.3.5-1.18.2-forge" = _KTVjK8D3;
        "pkg-2.3.5-1.19.2-fabric" = _doq3VPFU;
        "pkg-2.3.5-1.19.2-forge" = _H1xLStx2;
        "pkg-2.3.5-1.19.4-fabric" = _IBkW9ucH;
        "pkg-2.3.5-1.19.4-forge" = _vlJpdQdB;
        "pkg-2.3.5-1.20.1-fabric" = _VvaiYi6J;
        "pkg-2.3.5-1.20.1-forge" = _Tc0ZQbuF;
        "pkg-2.3.5-1.20.4-fabric" = _OixskivY;
        "pkg-2.3.5-1.20.6-fabric" = _aqI1opsE;
        "pkg-2.3.5-1.20.6-neoforge" = _jB3MVQYW;
        "pkg-2.3.5-1.21.1-fabric" = _DGiG2die;
        "pkg-2.3.5-1.21.1-neoforge" = _zXyrNnQs;
        "pkg-2.3.5-1.21.3-fabric" = _ZTg9mkWf;
        "pkg-2.3.5-1.21.3-neoforge" = _9oj56R6H;
        "pkg-2.3.5-1.21.5-fabric" = _DNEcTLaR;
        "pkg-2.3.5-1.21.5-neoforge" = _ENlfLWFc;
        "pkg-2.3.5-1.21.6-neoforge" = _ebu7JEgt;
        "pkg-2.3.5-1.21.8-fabric" = _2qlyl8hI;
        "pkg-2.3.5-1.21.8-neoforge" = _2Jtp6P5Q;
        "pkg-2.3.5-1.21.10-fabric" = _20YywjT4;
        "pkg-2.3.5-1.21.10-neoforge" = _3qUx7D0I;
        "pkg-2.3.6-1.18.2-fabric" = _6y8o7tFk;
        "pkg-2.3.6-1.18.2-forge" = _JaK4CoJP;
        "pkg-2.3.6-1.19.2-fabric" = _apYtIkL5;
        "pkg-2.3.6-1.19.2-forge" = _QUXlIa4U;
        "pkg-2.3.6-1.19.4-fabric" = _j6sCb9hc;
        "pkg-2.3.6-1.19.4-forge" = _GshsR46q;
        "pkg-2.3.6-1.20.1-fabric" = _nL4PJUAm;
        "pkg-2.3.6-1.20.1-forge" = _ugyoqKE8;
        "pkg-2.3.6-1.20.4-fabric" = _Hll9km1u;
        "pkg-2.3.6-1.20.6-fabric" = _IaekrWYB;
        "pkg-2.3.6-1.20.6-neoforge" = _BRuWvaWn;
        "pkg-2.3.6-1.21.1-fabric" = _cNC2Fcrt;
        "pkg-2.3.6-1.21.1-neoforge" = _n5hVpck9;
        "pkg-2.3.6-1.21.3-fabric" = _4QSqn1I2;
        "pkg-2.3.6-1.21.3-neoforge" = _zHonK933;
        "pkg-2.3.6-1.21.5-fabric" = _oGxVxcJk;
        "pkg-2.3.6-1.21.5-neoforge" = _XVjxWUfR;
        "pkg-2.3.6-1.21.6-neoforge" = _tV1yPd92;
        "pkg-2.3.6-1.21.8-fabric" = _lHBThi5F;
        "pkg-2.3.6-1.21.8-neoforge" = _tKBjO52Q;
        "pkg-2.3.6-1.21.10-fabric" = _aEgb2Y9r;
        "pkg-2.3.6-1.21.10-neoforge" = _XQLk2pZa;
        "pkg-2.3.7-1.18.2-fabric" = _HWOaMEeb;
        "pkg-2.3.7-1.18.2-forge" = _OuK3zfg7;
        "pkg-2.3.7-1.19.2-fabric" = _2OGlS6dV;
        "pkg-2.3.7-1.19.2-forge" = _jUhbPVD7;
        "pkg-2.3.7-1.19.4-fabric" = _NeBon5hB;
        "pkg-2.3.7-1.19.4-forge" = _oJPpLYIk;
        "pkg-2.3.7-1.20.1-fabric" = _1co6rVbw;
        "pkg-2.3.7-1.20.1-forge" = _m0j5CMqc;
        "pkg-2.3.7-1.20.4-fabric" = _mh2PZrMe;
        "pkg-2.3.7-1.20.6-fabric" = _Ow9j6UHa;
        "pkg-2.3.7-1.20.6-neoforge" = _Spr7KfxM;
        "pkg-2.3.7-1.21.1-fabric" = _HzK8HDBb;
        "pkg-2.3.7-1.21.1-neoforge" = _Jpcw76rq;
        "pkg-2.3.7-1.21.3-fabric" = _DDndDYaN;
        "pkg-2.3.7-1.21.3-neoforge" = _igoCkRxD;
        "pkg-2.3.7-1.21.5-fabric" = _KlWS1sWT;
        "pkg-2.3.7-1.21.5-neoforge" = _yJWkeyE1;
        "pkg-2.3.7-1.21.6-neoforge" = _ZCHX2ZXg;
        "pkg-2.3.7-1.21.8-fabric" = _eg8nhj2U;
        "pkg-2.3.7-1.21.8-neoforge" = _22gCtBHV;
        "pkg-2.3.7-1.21.10-fabric" = _i9QyyGNu;
        "pkg-2.3.7-1.21.10-neoforge" = _zCqMIkY2;
        "pkg-2.4-26.1" = _Bn55ChNL;
        "pkg-2.4.1-26.1.2" = _wFm9rhXI;
        "default" = _wFm9rhXI;
    });
