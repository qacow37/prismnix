...
let
    ...
    in {
        ...
        "pkg-1.0" = _yWYnJPFB;
        "pkg-1.0_mod" = _KDFOlSQB;
        "pkg-1.1" = _foN9T4zQ;
        "pkg-1.2" = _hfP82JAR;
        "pkg-1.2+mod" = _juhLBfPt;
        "pkg-1.3" = _Bj9mNe1q;
        "pkg-1.3+mod" = _Cxl4iQFQ;
        "pkg-2.0" = _yrxx83uM;
        "pkg-2.0+mod" = _hGXNb81w;
        "pkg-3.0" = _hUXza952;
        "pkg-3.0+mod" = _uaUHwMqo;
        "pkg-3.1" = _A9PmiWcb;
        "pkg-4.0" = _O668fwTW;
        "pkg-4.0+mod" = _kwqVqoLc;
        "pkg-4.1" = _6mv6MwAA;
        "pkg-4.1+mod" = _gIBlJzBb;
        "pkg-4.2" = _LgVsJVkZ;
        "pkg-4.3" = _7nao5n2m;
        "pkg-4.3+mod" = _cpXe9eQb;
        "pkg-4.4" = _N0c95GTO;
        "pkg-4.4+mod" = _uxgd8u3B;
        "pkg-4.5" = _5KqJf5Wa;
        "pkg-4.5+mod" = _vUCob2gH;
        "pkg-4.6" = _bS7OCche;
        "pkg-4.6+mod" = _tjxAVnyj;
        "pkg-4.7" = _nENCfqQu;
        "pkg-4.7-fabric" = _wGeAkS8s;
        "pkg-4.7-forge" = _d8aoYGwr;
        "pkg-4.8" = _dHzRV0EP;
        "pkg-4.8-fabric" = _8BfMOAGo;
        "pkg-4.8-forge" = _K4ipm3gy;
        "pkg-4.12" = _xZObmf1J;
        "pkg-4.12-fabric" = _3h9BoJlk;
        "pkg-4.12-quilt" = _FVsPHqqJ;
        "pkg-4.12-forge" = _DhXRx2MF;
        "pkg-4.12-neoforge" = _SlVdd8me;
        "pkg-4.13" = _h3exRxkp;
        "pkg-4.13-fabric" = _WDW5FRZK;
        "pkg-4.13-quilt" = _g7x6009J;
        "pkg-4.13-forge" = _REHiTjpd;
        "pkg-4.13-neoforge" = _FgdwZIHP;
        "default" = _FgdwZIHP;
    });
