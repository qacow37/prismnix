...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _AI9a20Lx;
        "pkg-v5.0.0-1.19.3-Fabric" = _oERVEBxH;
        "pkg-v5.0.0-1.19.3-Forge" = _3q70hr5r;
        "pkg-v6.0.0-1.19.4-Fabric" = _FzMp34g3;
        "pkg-v6.0.0-1.19.4-Forge" = _66WVSoxZ;
        "pkg-v7.0.0-1.20-Forge" = _VP4Oz8u5;
        "pkg-v7.0.0-1.20-Fabric" = _gtNt1iI0;
        "pkg-v7.0.1-1.20-Forge" = _onFpY4y1;
        "pkg-v7.0.1-1.20-Fabric" = _2zYR1OcJ;
        "pkg-v8.0.0-1.20.1-Forge" = _bhfQuE7T;
        "pkg-v8.0.0-1.20.1-Fabric" = _t4FwBQrZ;
        "pkg-v3.0.0-1.18.2-Forge" = _9rq1ySrR;
        "pkg-v3.0.0-1.18.2-Fabric" = _Z1y3VqRy;
        "pkg-v4.0.2-1.19.2-Forge" = _phitYGlE;
        "pkg-v4.0.2-1.19.2-Fabric" = _hoKFSyYm;
        "pkg-v20.4.0-1.20.4-Fabric" = _iaCtNo4p;
        "pkg-v20.4.0-1.20.4-Forge" = _T5P2rTqo;
        "pkg-v20.4.0-1.20.4-NeoForge" = _4zyDoLOG;
        "pkg-v21.0.0-1.21-Fabric" = _TbNCqEk6;
        "pkg-v21.0.0-1.21-NeoForge" = _ObmvjtQO;
        "pkg-v21.1.0-1.21.1-Fabric" = _62fUqsGs;
        "pkg-v21.1.0-1.21.1-NeoForge" = _9XTU6J5n;
        "pkg-v21.3.0-1.21.3-Fabric" = _w1Uej1Vw;
        "pkg-v21.3.0-1.21.3-NeoForge" = _WiQ4ABaN;
        "pkg-v21.4.0-1.21.4-Fabric" = _frtre9EV;
        "pkg-v21.4.0-1.21.4-NeoForge" = _lqIPkuUt;
        "pkg-v21.5.0-1.21.5-Fabric" = _FnO9svZD;
        "pkg-v21.5.0-1.21.5-NeoForge" = _HIV2rRvb;
        "pkg-v21.6.0-1.21.6-Fabric" = _ILq38Qji;
        "pkg-v21.6.0-1.21.6-NeoForge" = _TEgMgu4r;
        "pkg-v21.7.0-1.21.7-Fabric" = _CRny2jsN;
        "pkg-v21.7.0-1.21.7-NeoForge" = _ObSh77W0;
        "pkg-v21.8.0-1.21.8-Fabric" = _oqt5UgUm;
        "pkg-v21.8.0-1.21.8-NeoForge" = _j8gzvjHU;
        "pkg-21.9.0" = _XSjAmwFq;
        "pkg-21.10.0" = _AQewXsXn;
