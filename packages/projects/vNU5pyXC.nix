...
let
    ...
    in {
        ...
        "pkg-8.0.1" = _wKdThPUv;
        "pkg-9.0.1" = _7Uthh0O4;
        "pkg-10.0.1" = _VUSdFE3z;
        "pkg-8.0.2" = _uix8fOXY;
        "pkg-9.0.2" = _C5j5kBGC;
        "pkg-10.0.2" = _caegOihK;
        "pkg-7.0.5" = _85eCZInc;
        "pkg-11.0.1" = _m810O8xx;
        "pkg-12.0.1" = _UVEVwK3T;
        "pkg-13.0.1" = _QyxbwbEs;
        "pkg-14.0.1" = _JcpHakJn;
        "pkg-15.0.1" = _LcGVlBkG;
        "pkg-16.0.1" = _BfFBwySj;
        "pkg-17.0.1" = _tC3OuQOG;
        "pkg-18.0.2" = _eauRn6Cx;
        "default" = _eauRn6Cx;
    });
