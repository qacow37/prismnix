...
let
    ...
    in {
        ...
        "pkg-1.5.2-2.0.00-fabric" = _iGLHR3wg;
        "pkg-1.6.4-2.0.0-fabric" = _BrZV6mgG;
        "pkg-1.7.10-2.0.0-fabric" = _fcbDAonf;
        "pkg-1.8.9-2.0.0-fabric" = _Sni2aKas;
        "pkg-1.9.4-2.0.0-fabric" = _wIzCQTkX;
        "pkg-1.10.2-2.0.0-fabric" = _Aw9S8Eng;
        "pkg-1.11.2-2.0.0-fabric" = _Y1zLrhKp;
        "pkg-1.12.2-2.0.0-fabric" = _slBOyNrr;
        "pkg-1.13.2-2.0.0-fabric" = _6XIRqTlm;
        "pkg-1.14.4-2.0.0-fabric" = _mM4qI3h2;
        "pkg-1.15.2-2.0.0-fabric" = _dZq136wk;
        "pkg-1.16.5-2.0.0-fabric" = _OQlbyT7S;
        "pkg-1.17.1-2.0.0-fabric" = _VPUKSdLD;
        "pkg-1.18.1-2.0.0-fabric" = _OmvLcSHu;
        "pkg-1.7.10-2.0.0-forge" = _yOmwoZJ3;
        "pkg-1.8.9-2.0.0-forge" = _cbbiLigu;
        "pkg-1.9.4-2.0.0-forge" = _7QoLYAB7;
        "pkg-1.10.2-2.0.0-forge" = _TCGGs6lw;
        "pkg-1.11.2-2.0.0-forge" = _APs9jB46;
        "pkg-1.12.2-2.0.0-forge" = _ldMxRgM8;
        "pkg-1.15.2-2.0.0-forge" = _W5t75RuA;
        "pkg-1.16.5-2.0.0-forge" = _brLC0jlB;
        "pkg-1.17.1-2.0.0-forge" = _pdFfRMmS;
        "pkg-1.18.1-2.0.0-forge" = _UmaRg8zE;
        "pkg-1.19-2.0.0-fabric" = _lgNyqwIG;
        "pkg-1.19-2.0.0-forge" = _cfp5EZrV;
        "pkg-1.19.4-2.0.0-fabric" = _jygdQgvj;
        "pkg-1.19.4-2.0.0-forge" = _SWsiVTRQ;
        "pkg-1.20.1-3.0.0-fabric" = _9prllKDn;
        "pkg-1.20.1-3.0.0-forge" = _1k2q6Fl6;
        "pkg-1.20.2-3.0.0-fabric" = _g30PcP8e;
        "pkg-1.20.2-3.0.0-forge" = _xSvagXhg;
        "pkg-1.20.2-3.0.0-neoforge" = _hRBeyFSa;
        "pkg-1.20.6-3.0.0-fabric" = _3BKJ4EwD;
        "pkg-1.20.6-3.0.0-forge" = _jKIU5Zmf;
        "pkg-1.20.6-3.0.0-neoforge" = _qcV0d3ew;
        "pkg-1.21.1-3.0.0-fabric" = _SmWrucGL;
        "pkg-1.21.1-3.0.0-forge" = _dKuFOgpK;
        "pkg-1.21.1-3.0.0-neoforge" = _8OUE53Nq;
        "pkg-1.21.3-3.0.0-fabric" = _JyEveiQ8;
        "pkg-1.21.3-3.0.0-forge" = _YlTtraF9;
        "pkg-1.21.3-3.0.0-neoforge" = _Q1ruPVf1;
        "pkg-1.21.4-3.0.0-fabric" = _9kGnNh7d;
        "pkg-1.21.4-3.0.0-forge" = _BwCkoIZ8;
        "pkg-1.21.4-3.0.0-neoforge" = _PXzpQwRc;
        "pkg-1.21.5-3.0.0-fabric" = _7QlkIIAk;
        "pkg-1.21.5-3.0.0-forge" = _hcf8Kx08;
        "pkg-1.21.5-3.0.0-neoforge" = _vA00dNLS;
        "pkg-1.21.6-3.0.0-fabric" = _9vCIhYTN;
        "pkg-1.21.6-3.0.0-forge" = _WcJ89dib;
        "pkg-1.21.6-3.0.0-neoforge" = _gKSOMjwN;
