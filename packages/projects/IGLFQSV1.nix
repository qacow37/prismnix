...
let
    ...
    in {
        ...
        "pkg-0.1.1+1.21.1" = _OZCduazv;
        "pkg-0.1.1+1.20.6" = _qAd00sdw;
        "pkg-0.1.1+1.20.1" = _oElMS556;
        "pkg-0.1.2+1.19" = _CcazjQWp;
        "pkg-0.1.2+1.15" = _p9UQMeRx;
        "pkg-0.1.2+1.17.1" = _lhw2N5Gx;
        "pkg-0.1.2+1.18" = _WFZ1bYd5;
        "pkg-0.1.2+1.20.6" = _k8KKuwRg;
        "pkg-0.1.3+1.15" = _471bDkoz;
        "pkg-0.1.3+1.20.6" = _mK521iXD;
        "pkg-0.1.3+1.19" = _cfv6dVTo;
        "pkg-0.1.3+1.18" = _lznx4M90;
        "pkg-0.1.3+1.17.1" = _JN8zefAK;
        "pkg-0.1.4+1.20.6" = _VPD01H6N;
        "pkg-0.1.4+1.18" = _JdGaSta9;
        "pkg-0.1.4+1.15" = _o8uGiA72;
        "pkg-0.1.4+1.19" = _dx5cEgzk;
        "pkg-0.1.4+1.17.1" = _iwkbS0lB;
        "pkg-0.1.5+1.19" = _9QFp5abS;
        "pkg-0.1.5+1.15" = _KDxJNWSo;
        "pkg-0.1.5+1.20.6" = _t4Zf0wdm;
        "pkg-0.1.5+1.18" = _lJMj3RE1;
        "pkg-0.1.5+1.17.1" = _qW84Y5B8;
        "default" = _KDxJNWSo;
    });
