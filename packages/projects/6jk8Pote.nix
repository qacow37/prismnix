...
let
    ...
    in {
        ...
        "pkg-2.0.0-1.20.1-beta" = _MtlGK715;
        "pkg-2.0.1-1.20.1-beta" = _seEG0V4q;
        "pkg-2.0.2-1.20.1" = _rEVudBZ4;
        "pkg-2.0.3-1.20.1-beta" = _904xVApK;
        "pkg-2.0.4-1.20.1-BETA" = _oCN9JnUL;
        "pkg-2.0.5-1.20.1-beta" = _C0zjnGKu;
        "pkg-2.0.6-1.20.1-beta" = _gv0ar6WT;
        "pkg-2.0.7-1.21.1-beta" = _nv2aJgcE;
        "pkg-2.0.8-1.20.1-beta" = _PwDfgvpt;
        "pkg-2.0.9-1.21.1" = _Uq9f4QnT;
        "pkg-2.0.9-1.20.1" = _hlzceqlW;
        "pkg-2.1.0-1.20.1" = _1ma80lvw;
        "pkg-2.1.1-1.20.1" = _Gh04Ns9T;
        "pkg-2.1.1-1.21.1" = _njMyshLL;
        "pkg-2.2.0-1.20.1" = _4HiX7Jbu;
        "pkg-2.2.1-1.21.1" = _kDDwgs93;
        "pkg-2.2.1-1.20.1" = _rOKJT47S;
        "pkg-2.2.1-1.21.11" = _ct7GA9nn;
        "pkg-2.2.2-1.20.1" = _2Jo2Wr3J;
        "pkg-2.2.2-1.21.1" = _zi93RooF;
        "pkg-2.3.0-1.20.1" = _7dhS67wp;
        "pkg-2.3.0-1.21.1" = _PUO3z91X;
        "pkg-2.3.1-1.21.1" = _KY1DHC8C;
        "pkg-2.3.1-1.21.1-hotfix" = _rUmD6cZc;
        "default" = _rUmD6cZc;
    });
