...
let
    ...
    in {
        ...
        "pkg-0.2.3" = _HuqApnUl;
        "pkg-0.2.4" = _nDtH1hZL;
        "pkg-0.2.5-CREATE-0.5.x" = _F0Nwn2M6;
        "pkg-0.2.5" = _QF3EwJ2N;
        "pkg-0.2.6" = _CmfBYxAt;
        "pkg-0.2.6-hotfix" = _LanBvn9M;
        "pkg-0.3.0-CREATE-0.5.x" = _CyVTUk8I;
        "pkg-0.3.0" = _ft1NGwjJ;
        "pkg-0.4.0-CREATE-0.5.x" = _Lxhj0Pd4;
        "pkg-0.4.0" = _8Tm1FSFi;
        "pkg-0.4.0-COMPAT" = _SdEofplJ;
        "pkg-0.4.0-SABLE-COMPAT" = _MsypJ6Dy;
        "pkg-0.5.0-ALPHA" = _jApbOkOC;
        "pkg-0.6.0-CREATE-0.5.x" = _YhFmU0xk;
        "pkg-0.6.0" = _qYjOyvgW;
        "default" = _qYjOyvgW;
    });
