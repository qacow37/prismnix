...
let
    ...
    in {
        ...
        "pkg-0.0.1-neo1.2.2" = _kEWUaIpf;
        "pkg-0.0.2-neo1.2.2" = _HqPFA45R;
        "pkg-0.0.3-neo1.3.6" = _I9GCBVCd;
        "pkg-0.0.3-hotfix-neo1.3.6" = _jSjnOgU1;
        "pkg-0.0.4-neo1.3.6" = _BCiNiQnN;
        "pkg-0.0.5-neo1.3.6" = _SEPa1WbJ;
        "pkg-0.0.6-neo1.3.6" = _ltX21fEt;
        "pkg-0.0.7-neo1.3.6" = _1mUOpswL;
        "pkg-0.0.8-neo1.3.7" = _dcDIQI4b;
        "pkg-0.0.9-neo1.3.7" = _uekpcS4u;
        "pkg-0.1.0-forge1.3.7" = _8fNxs2o4;
        "pkg-0.1.0-neo1.3.7" = _JGiaa4Fd;
        "pkg-0.1.1-neo1.3.7" = _XE2XuS41;
        "pkg-0.1.1-forge1.3.7" = _Kl53LaHR;
        "pkg-0.1.1-hotfix-forge1.3.7" = _IA0zjqvK;
        "pkg-0.1.2-neo1.3.7" = _BoDE6J6C;
        "pkg-0.1.2-forge1.3.7" = _v8WL605R;
        "pkg-0.1.3-neo1.3.7" = _2zUspira;
        "pkg-0.1.3-forge1.3.7" = _B1feHxzg;
        "pkg-0.1.4-neo1.3.8" = _YDica8M4;
        "pkg-0.1.4-forge1.3.8" = _ACw4jBig;
        "pkg-0.1.5-neo1.3.8" = _zL1l0lQb;
        "pkg-0.1.5-forge1.3.8" = _rvJLzROB;
        "pkg-0.1.6-neo1.3.8" = _RuDVSSPt;
        "pkg-0.1.6-forge1.3.8" = _aTQGVY6s;
        "pkg-0.1.7-neo1.3.8" = _NZTrNzaf;
        "pkg-0.1.7-forge1.3.8" = _2n4YLQde;
        "pkg-0.1.7.1-forge1.3.8" = _bZXnidc5;
        "pkg-0.1.7.1-neo1.3.8" = _NLUeRcYG;
        "pkg-0.1.7.2-neo1.3.8" = _Z0epoLWa;
        "pkg-0.1.7.2-forge1.3.8" = _jAk6duml;
        "pkg-0.1.7.3-forge1.3.8" = _xmwBJn3s;
        "pkg-0.1.7.3-neo1.3.8" = _oDZ1ozc2;
        "pkg-0.1.8-forge1.4.0" = _a6vnKr9N;
        "pkg-0.1.8-neo1.4.0" = _4GzKbbbp;
        "pkg-0.2.0-forge1.4.2" = _8SXSTwby;
        "pkg-0.2.0-neo1.4.2" = _TMFCgVp9;
        "pkg-0.3.0-forge1.4.4" = _UDOSw4Pe;
        "pkg-0.3.0-neo1.4.4" = _sH6UHDg6;
        "pkg-0.4.0-forge1.4.5" = _2rJKLj5I;
        "pkg-0.4.0-neo1.4.5" = _UjjSAee0;
        "pkg-0.4.1-forge1.4.5" = _gBO3lNlX;
        "pkg-0.4.2-forge1.4.5" = _XZ6RBthd;
        "pkg-0.4.2-neo1.4.5" = _p9AcPgVa;
        "pkg-0.4.3-forge1.4.5" = _XrRJHaDO;
        "pkg-0.4.3-neo1.4.5" = _3gBxq6gJ;
        "pkg-0.4.4-forge1.4.5" = _6pDh0U4Z;
        "pkg-0.4.4-neo1.4.5" = _M9J36fu2;
        "pkg-0.5.0-forge1.4.6" = _RWPEX1yv;
        "pkg-0.5.0-neo1.4.6" = _VI4QsUcK;
        "pkg-0.5.1-forge1.4.6" = _JoZ8zSur;
        "pkg-0.5.1-neo1.4.6" = _23G8F2YY;
        "pkg-0.6.0-forge1.5.0" = _1aPlyFcR;
        "pkg-0.6.0-neo1.5.0" = _efQ3wv7N;
        "pkg-0.6.1-forge1.5.0" = _dlvaMuwd;
        "pkg-0.6.2-forge1.5.0" = _TFYFMNAS;
        "pkg-0.6.2-neo1.5.0" = _lANWbGC2;
        "pkg-0.6.3-forge1.5.0" = _e7VZ3fFQ;
        "pkg-0.6.4-forge1.5.0" = _zbY7NQHV;
        "pkg-0.7.0-forge1.5.2" = _e7UqHp1g;
        "pkg-0.7.0-neo1.5.2" = _kVZ8OkkU;
        "pkg-0.7.1-forge1.5.2" = _XTpMta5r;
        "pkg-0.8.0-forge1.5.3+mc1.20.1" = _myyNDnaU;
        "pkg-0.8.0-neo1.5.3+mc1.21.1" = _brKZtmje;
        "pkg-0.8.1-forge1.5.3+mc1.20.1" = _m0oYKHLg;
        "pkg-0.8.1-neo1.5.3+mc1.21.1" = _r1ScaIsB;
        "pkg-0.8.2-forge1.5.3+mc1.20.1" = _DmTkaW7J;
        "pkg-0.8.2-neo1.5.3+mc1.21.1" = _xBOWZa8l;
        "default" = _xBOWZa8l;
    });
