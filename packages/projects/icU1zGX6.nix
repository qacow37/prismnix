...
let
    ...
    in {
        ...
        "pkg-1.9-1.10.2" = _gGbdbFGS;
        "pkg-1.6.1-1.8.9" = _avbTD74c;
        "pkg-1.11-1.12.2" = _UBpOmzmK;
        "pkg-1.13-1.14.4" = _OfzTUCSs;
        "pkg-1.15-1.16.1" = _4qxbrrL3;
        "pkg-1.16.2-1.16.5" = _dTaqTYKG;
        "pkg-1.17-1.17.1" = _cuND2gTc;
        "pkg-1.18-1.18.2" = _uVFpBltV;
        "pkg-1.19-1.19.2" = _8kydFVCV;
        "pkg-1.19.3" = _Dz9RqmnW;
        "pkg-1.19.4" = _RMEjXJqP;
        "pkg-1.20-1.20.1" = _mPz1DkxJ;
        "pkg-1.20.2" = _2eRdmRJq;
        "pkg-1.20.3-1.20.4" = _VbBTT1MK;
        "pkg-1.21-1.21.1" = _hO43Rr7w;
        "pkg-1.21.2-1.21.3" = _WHGjNzer;
        "pkg-1.21.4" = _uFhVXNWU;
        "pkg-1.20.5-1.20.6" = _cXogemd8;
        "pkg-1.21.5" = _VRm52kvF;
        "pkg-1.21.6" = _TYZ227qq;
        "pkg-1.21.7-1.21.8" = _nQLaukpZ;
        "pkg-1.21.9-1.21.10" = _vmmYRUXP;
        "pkg-1.21.11" = _Z8S9SxP9;
        "pkg-26.1" = _zZf9QI2B;
        "default" = _zZf9QI2B;
    });
