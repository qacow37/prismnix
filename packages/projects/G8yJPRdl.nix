...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _sOeNAEXP;
        "pkg-1.0.3" = _LQq7M0aj;
        "pkg-1.1.1-sodium0.5.11" = _k0qBOOzU;
        "pkg-1.1.2-sodium0.6.0beta.1" = _ivilQtDD;
        "pkg-1.1.3-sodium0.6.0beta.1" = _aILMgKFB;
        "pkg-1.1.4-sodium0.6.0beta.2" = _UsLVt7sX;
        "pkg-1.1.5-sodium0.6.0beta.2" = _XKvaczcJ;
        "pkg-1.2.0-sodium0.6.0beta.3" = _xRfmkPhg;
        "pkg-1.2.1-sodium0.6.0beta.3" = _9PngzS6I;
        "pkg-1.2.1-sodium0.6.0beta.4" = _JS3sMUrZ;
        "pkg-1.2.2-sodium0.6.0beta.5" = _3OAW1jUj;
        "pkg-1.2.3-sodium0.6.0" = _1bRMAdzA;
        "pkg-mc1.21.1-1.2.4-sodium0.6.0" = _u7whMgEY;
        "pkg-mc1.21.3-1.2.4-sodium0.6.0" = _Mm66TF5D;
        "pkg-mc1.21.1-1.2.5-sodium0.6.1" = _nRYsC7Mv;
        "pkg-mc1.21.3-1.2.5-sodium0.6.1" = _Ysfo0ogA;
        "pkg-mc1.21.4-1.2.6-sodium0.6.2" = _McBghe4h;
        "pkg-mc1.21.3-1.2.6-sodium0.6.2" = _BerUYcQR;
        "pkg-mc1.21.1-1.2.6-sodium0.6.2" = _84aC1OgU;
        "pkg-mc1.21.4-1.2.7-sodium0.6.3" = _k3i5aJjK;
        "pkg-mc1.21.3-1.2.7-sodium0.6.3" = _Eaboarbk;
        "pkg-mc1.21.1-1.2.7-sodium0.6.3" = _E9A3OTty;
        "pkg-mc1.21.1-1.2.8-sodium0.6.5" = _Awc5E8ah;
        "pkg-mc1.21.3-1.2.8-sodium0.6.5" = _aWPdqGG6;
        "pkg-mc1.21.4-1.2.8-sodium0.6.5" = _3uvVxO3q;
        "pkg-mc1.21.4-1.2.9-sodium0.6.6" = _CpyQx9ut;
        "pkg-mc1.21.4-1.2.10-sodium0.6.7" = _mbeWvI3k;
        "pkg-mc1.21.3-1.2.10-sodium0.6.8" = _RzAaEq9D;
        "pkg-mc1.21.1-1.2.10-sodium0.6.7" = _LAmuG4LC;
        "pkg-mc1.21.4-1.2.11-sodium0.6.9" = _JpdWZ12x;
        "pkg-mc1.21.3-1.2.11-sodium0.6.9" = _2ifEzSZ1;
        "pkg-mc1.21.1-1.2.11-sodium0.6.9" = _XztKexQB;
        "pkg-mc1.21.4-1.2.12-sodium0.6.10" = _NZwkI2dc;
        "pkg-1.3.0-sodium0.6.10-neoforge" = _m3I9kd2i;
        "pkg-1.3.0-sodium0.6.10-fabric" = _d2C9QVMv;
        "pkg-1.3.0-sodium0.6.9-neoforge" = _6VZF0fwK;
        "pkg-1.3.0-sodium0.6.9-fabric" = _VrODLOBv;
        "pkg-1.3.1-sodium0.6.10-neoforge" = _efRNsg7n;
        "pkg-1.3.1-sodium0.6.10-fabric" = _8hP8hKLH;
        "pkg-1.3.1-sodium0.6.9-neoforge" = _xAdloTms;
        "pkg-1.3.1-sodium0.6.9-fabric" = _5OTBGDI9;
        "pkg-1.3.2-sodium0.6.11-fabric" = _JWYPnZXE;
        "pkg-1.3.2-sodium0.6.11-neoforge" = _U6uQn5dd;
        "pkg-1.3.3-sodium0.6.12-neoforge" = _NUbm2JBi;
        "pkg-1.3.3-sodium0.6.12-fabric" = _QnkyT8HE;
        "pkg-1.3.4-sodium0.6.13-neoforge" = _q7tHwa2H;
        "pkg-1.3.4-sodium0.6.13-fabric" = _9GCOUw9J;
        "pkg-1.3.5-sodium0.6.13-neoforge" = _m5CKF4pO;
        "pkg-1.3.5-sodium0.6.13-fabric" = _w1I1wTNn;
        "pkg-1.3.6-sodium0.6.13-neoforge" = _Z7emu9gD;
        "pkg-1.3.6-sodium0.6.13-fabric" = _81BaGMs5;
        "pkg-1.3.7-sodium0.6.13-fabric" = _VudPb9dA;
        "pkg-1.3.8-sodium0.6.13-neoforge" = _3umepZML;
        "pkg-1.3.8-sodium0.6.13-fabric" = _2u3b4D9i;
        "pkg-1.3.9-sodium0.7.0-fabric" = _Q55Ou9qr;
        "pkg-1.3.9-sodium0.7.0-neoforge" = _Dt7FUBJl;
        "pkg-1.4.0-sodium0.7.0-neoforge" = _JfGC7Kjc;
        "pkg-1.4.0-sodium0.7.0-fabric" = _iVjlE2Ic;
        "pkg-1.4.0-sodium0.6.13-neoforge" = _Lrd3bgcn;
        "pkg-1.4.0-sodium0.6.13-fabric" = _UUsdNhfO;
        "pkg-1.4.1-sodium0.7.0-fabric" = _LRSK6OVt;
        "pkg-1.4.2-sodium0.7.2-fabric" = _v0CwpR2j;
        "pkg-1.4.2-sodium0.7.2-neoforge" = _i9slLW6f;
        "pkg-1.4.3-sodium0.7.3-fabric" = _QBZ4fzWO;
        "pkg-1.4.3-sodium0.7.3-neoforge" = _W7pQruZG;
        "pkg-1.4.4-sodium0.8.0-fabric" = _rbWcGIKD;
        "pkg-1.4.5-sodium0.8.1-fabric" = _ECvY0T4o;
        "pkg-1.4.6-sodium0.8.2-fabric" = _UAQCRalM;
        "pkg-1.4.6-sodium0.8.3-fabric" = _sAKzCXvY;
        "pkg-1.4.6-sodium0.8.4-fabric" = _UisGLdpV;
        "pkg-1.4.6-sodium0.8.6-fabric" = _Oho6OGOF;
        "pkg-1.4.6-sod0.8.7-fab1.21.11" = _RAXbl53t;
        "pkg-1.4.6-sod0.8.7-fab26.1" = _DiD1QOEK;
        "pkg-1.4.6-sod0.8.9-fab26.1.1" = _zccz7aWZ;
        "pkg-1.4.6-sod0.8.9-fab26.1.2" = _shm7sPPo;
        "pkg-1.5.0-sod0.8.7-fab1.21.11" = _gUTAcAFS;
        "pkg-1.5.0-sod0.8.10-fab26.1.2" = _8xDAdI9U;
        "pkg-1.5.0-sod0.8.11-fab26.1.2" = _nBm1YFMn;
        "pkg-1.5.0-sod0.8.11-fab1.21.11" = _Irx5XM9P;
        "pkg-1.5.0-sod0.8.12-b.2-fab1.21.11" = _FQYDXwZS;
        "pkg-1.5.0-sod0.8.12-fab26.1.2" = _CsJkcLUL;
        "pkg-1.5.0-sod0.8.12-fab1.21.11" = _J1OtL6BH;
        "pkg-1.5.0-sod0.9.0-b.1-fab26.1.2" = _cpADN6Nt;
        "default" = _cpADN6Nt;
    });
