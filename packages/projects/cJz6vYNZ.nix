...
let
    ...
    in {
        ...
        "pkg-v.0.7.3" = _cPQtY0gk;
        "pkg-v.0.7.4" = _3o2Y9Rlr;
        "pkg-v.0.7.5" = _Y3iECqiS;
        "pkg-v.0.7.6" = _JhWm2jh2;
        "pkg-v.0.8.0" = _GE0edbAX;
        "pkg-v.0.9.0" = _bOaiUBbO;
        "pkg-v.0.9.1" = _j2lC8JAL;
        "pkg-v.0.10.0" = _zGhm7aDS;
        "pkg-v.0.11.0" = _Sirm73H6;
        "pkg-v.0.12.0" = _hTbZJS23;
        "pkg-v.0.12.1" = _D3nbar15;
        "pkg-v.0.13.0" = _pfR2Br3u;
        "pkg-v.0.14.0" = _1bTWjVSx;
        "pkg-v.0.14.1" = _OEGq3tks;
        "pkg-v.0.13.1" = _oZXvAO4z;
        "pkg-v.0.15.0" = _V60fbzbU;
        "pkg-v.0.15.1" = _Yx2cgFfx;
        "pkg-0.15.1" = _6OWEzLEO;
        "pkg-v.0.16.0" = _vXP78yuA;
        "pkg-v.1.0.0" = _LkBWUyku;
        "pkg-v.1.1.0" = _sCCVIKl5;
        "pkg-v.1.2.0" = _h192zkqd;
        "pkg-v.1.2.1" = _N9bh0tUd;
        "pkg-v.1.2.2" = _fUtvS0mt;
        "pkg-v.1.2.3" = _rJaqLYlI;
        "pkg-v.1.3.0" = _h9VkFlBB;
        "pkg-v.1.3.1" = _7A44scuv;
        "pkg-v.1.4.0-pre1" = _rGu0ISj9;
        "pkg-v.1.3.2" = _uSbkymur;
        "pkg-v.1.4.0-pre2" = _d332sn1b;
        "pkg-v.1.3.3" = _TJlM9ma7;
        "pkg-v.1.4.0" = _QLF7VYsH;
        "pkg-v.1.4.1" = _4RtHFegm;
        "pkg-v.1.3.4" = _3gToL6h5;
        "pkg-v.1.3.2a" = _WMlgKYKy;
        "pkg-v.0.13.6" = _vsQom1ZT;
        "pkg-v.1.4.2" = _92H4Jruo;
        "pkg-v.0.15.2" = _cKfzEkmS;
        "pkg-v.1.4.3" = _jOeAtmel;
        "pkg-1.3.2b" = _ujnrCJYx;
        "pkg-v.1.3.5" = _NqjFITBf;
        "pkg-v.1.4.0-pre3" = _BcePhhlL;
        "pkg-v.1.4.4" = _HnySE2r7;
        "pkg-v.1.3.2c" = _EUKTY0nC;
        "default" = _EUKTY0nC;
    });
