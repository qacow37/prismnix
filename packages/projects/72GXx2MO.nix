...
let
    ...
    in {
        ...
        "pkg-4.1.2" = _9zxkXBVa;
        "pkg-4.2.0" = _NFYwjzXZ;
        "pkg-1.20.4-5.0.2" = _OJhGEArd;
        "pkg-1.21-5.1.0" = _LCCpmKXj;
        "pkg-1.21-5.1.1" = _47Gt3Wcg;
        "pkg-1.21-5.1.2" = _JDXTiDsL;
        "pkg-1.21-5.1.3" = _efYHh7Rz;
        "pkg-1.21-5.1.4" = _fAeDBCXi;
        "pkg-1.21-5.1.5" = _mn6IzXE5;
        "pkg-1.21-5.2.0a" = _gxciTwyM;
        "pkg-1.21-5.2.1" = _drIeVIkS;
        "pkg-1.21-5.2.2" = _1YlEixSY;
        "pkg-26.1.2-5.3.0a" = _4qxk1Loq;
        "pkg-26.1.2-5.3.1" = _mv7nobtg;
        "pkg-1.21-5.2.3" = _CCGuuKEr;
        "pkg-1.21-5.2.4" = _rY17Eh56;
        "pkg-26.1.2-5.3.2" = _FxtS2P4G;
        "default" = _FxtS2P4G;
    });
