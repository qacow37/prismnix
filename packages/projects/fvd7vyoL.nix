...
let
    ...
    in {
        ...
        "pkg-1.6.1" = _krBGKo7K;
        "pkg-1.7.0" = _kp7jb5KD;
        "pkg-1.8.0+1.20.4" = _G15jSWRl;
        "pkg-1.8.1+1.20.4" = _VSQvYnHa;
        "pkg-1.8.1+1.20.5" = _AneuMKd1;
        "pkg-1.8.2+1.21" = _TyUf7TPm;
        "pkg-1.8.3+1.21.3" = _h0nZVDOo;
        "pkg-1.8.3+1.21.4" = _mwdEYUrt;
        "pkg-1.8.3+1.21.5" = _lz9JtCXw;
        "default" = _lz9JtCXw;
    });
