...
let
    ...
    in {
        ...
        "pkg-1.0.0-ALPHA" = _oXyGNd4r;
        "pkg-1.1.0-ALPHA" = _PwzD0kTw;
        "pkg-1.2.0-ALPHA" = _HBLGwQsx;
        "pkg-1.2.1-ALPHA" = _6HIIciM0;
        "pkg-1.2.2-ALPHA" = _D2AEtuOc;
        "pkg-1.2.3-ALPHA" = _NaqQ46y0;
        "pkg-1.2.4-ALPHA" = _fUXmzVsV;
        "pkg-1.2.5-ALPHA" = _vIVO8LLV;
        "pkg-1.2.6-ALPHA" = _3Vq6qSlZ;
        "pkg-1.2.7-ALPHA" = _k6vzPEOi;
        "pkg-1.3.0-ALPHA" = _eQdBVpvO;
        "pkg-1.3.1-ALPHA" = _ugnlZ2HI;
        "pkg-1.4.0-ALPHA" = _76kZrrIj;
        "pkg-1.4.1-ALPHA" = _xOs29rgd;
        "pkg-1.4.2-ALPHA" = _xeJLIXgd;
        "pkg-1.5.0-ALPHA" = _J56hFKgY;
        "pkg-1.5.1-ALPHA" = _wDqbaTNz;
        "pkg-1.5.2-ALPHA" = _pWvE9FGb;
        "pkg-1.5.3-ALPHA" = _N9cmfLkX;
        "pkg-1.5.4-ALPHA" = _jbK0MfUH;
        "pkg-1.5.5-ALPHA" = _hcLiGwbv;
        "pkg-1.6.0-ALPHA" = _U8tsvFK6;
        "default" = _U8tsvFK6;
    });
