...
let
    ...
    in {
        ...
        "pkg-forge-mc1.19.3-1.2.0" = _W7lRFVtK;
        "pkg-forge-mc1.19.4-1.2.0" = _ivL8CwJa;
        "pkg-forge-mc1.20-1.3.0" = _EF7VJTkO;
        "pkg-forge-mc1.19.2-2.0.0" = _N5AGWwir;
        "pkg-forge-mc1.19.3-2.0.0" = _Bdp0Iwv2;
        "pkg-forge-mc1.19.4-2.0.0" = _8RHzu173;
        "pkg-forge-mc1.20.1-2.0.0" = _Xf3qcgni;
        "pkg-forge-mc1.20.2-2.0.0" = _kiZgHmGP;
        "pkg-neoforge-mc1.20.4-2.0.0" = _wfeZKAwA;
        "pkg-neoforge-mc1.20.2-2.0.0" = _hcgqml2v;
        "pkg-forge-mc1.19.2-2.0.1" = _Yq0ZEfbv;
        "pkg-forge-mc1.19.3-2.0.1" = _FKCa1Abf;
        "pkg-forge-mc1.19.4-2.0.1" = _aLkIfr6q;
        "pkg-forge-mc1.20.1-2.0.1" = _ilMkQEQF;
        "pkg-forge-mc1.20.2-2.0.1" = _RuqXEPUj;
        "pkg-neoforge-mc1.20.2-2.0.1" = _I15FzEeo;
        "pkg-neoforge-mc1.20.4-2.0.1" = _tCg6CAjE;
        "pkg-neoforge-mc1.20.6-2.0.1" = _rEFi3v9x;
        "pkg-neoforge-mc1.21-2.0.1" = _ih3cmsYK;
        "pkg-neoforge-3.0.0+mc1.21.4" = _5n1RJPCf;
        "pkg-neoforge-3.0.0+mc1.21.1" = _WFtWDvcX;
        "pkg-neoforge-3.0.0+mc1.21.5" = _ertg00ve;
        "pkg-neoforge-3.0.1+mc1.21.1" = _iXGvdERT;
        "pkg-neoforge-3.0.1+mc1.21.4" = _Djyygtag;
        "pkg-neoforge-3.0.1+mc1.21.5" = _gpardFAh;
        "pkg-neoforge-3.0.1+mc1.21.6" = _yySdF8SG;
        "pkg-neoforge-3.0.2+mc1.21.1" = _eLpyxNQm;
        "pkg-neoforge-3.0.2+mc1.21.4" = _XaCOndYE;
        "pkg-neoforge-3.0.2+mc1.21.5" = _Zbtw9YrA;
        "pkg-neoforge-3.0.2+mc1.21.8" = _OfGFhaAX;
        "pkg-neoforge-3.0.2+mc1.21.10" = _tmVIzeAj;
        "pkg-neoforge-3.0.2+mc1.21.11" = _S5wR1oEk;
        "pkg-neoforge-3.0.3+mc1.21.1" = _QKZLmEdf;
        "pkg-neoforge-3.0.3+mc1.21.5" = _24ZmM9Kx;
        "pkg-neoforge-3.0.3+mc1.21.4" = _f8JeL7fY;
        "pkg-neoforge-3.0.3+mc1.21.8" = _vVXX7p2n;
        "pkg-neoforge-3.0.3+mc1.21.11" = _iXiP7HML;
