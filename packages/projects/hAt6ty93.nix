...
let
    ...
    in {
        ...
        "pkg-1.2.3-1.16.5" = _edaRDih9;
        "pkg-1.2.3-1.17.1" = _RM9AYmPx;
        "pkg-2.0" = _XKEvMBGM;
        "pkg-2.1" = _RG7KyU2Q;
        "pkg-2.1.1" = _Z4ONBz5t;
        "pkg-2.1.2" = _pLGedt3U;
        ...
        "pkg-2.6" = _mdJ8Ai4Q;
        "pkg-2.6.1" = _8gFWsg7v;
        "pkg-2.6.1+1.18" = _d0CLoHDR;
        "pkg-2.6.2" = _AT0rjdJ8;
        "pkg-2.6.2-forge" = _iTZzZ0Vs;
        "pkg-2.6.2+1.19-fabric" = _CYUWiMZh;
        "pkg-2.6.2+1.19-forge" = _Sa2TbiWv;
        "pkg-2.6.3" = _iRvkeXS9;
        "pkg-2.6.4" = _jjh8za2I;
        "pkg-2.6.4+1.19.2-forge" = _kKIctwmh;
        "pkg-2.6.3+1.19.3-fabric" = _RSYgIMTl;
        "pkg-2.6.3+1.19.4-fabric" = _UbAQOuDI;
        "pkg-2.6.3+1.20.1-fabric" = _bFQ1ISy6;
        "pkg-2.6.3+1.20.2-fabric" = _wNRo7nQL;
        "pkg-2.6.3+1.20.3-fabric" = _ACU2buY9;
        "pkg-2.6.3+1.20.4-fabric" = _ftsMHwui;
        "pkg-2.6.3+1.20.5-fabric" = _s4hsjsNR;
        "pkg-14.1-beta.2+1.20.6" = _GS2aBpzK;
        "pkg-2.6.3+1.21-fabric" = _s06JVdiG;
        "pkg-2.6.3+1.21.1-fabric" = _VskXKXjg;
        "pkg-2.6.3+1.21.2-fabric" = _r95Qa99G;
        "pkg-2.6.3+1.21.3-fabric" = _LXTkh6x1;
        "default" = _LXTkh6x1;
    });
