...
let
    ...
    in {
        ...
        "pkg-1.0.2+1.21.4" = _nfWzIcbY;
        "pkg-1.0.2+1.21.3" = _7u6SyNVh;
        "pkg-1.1.0+1.21.4" = _NQ2zWu62;
        "pkg-1.1.0+1.21.1" = _WZL3K5x9;
        "pkg-1.1.0+1.21.3" = _zaedM62z;
        "pkg-1.1.0+1.20.1" = _J7zQ0Q2N;
        "pkg-1.1.1+1.21.4" = _WlhgiiA5;
        "pkg-1.1.1+1.21.1" = _GUOn5o7M;
        "pkg-1.1.1+1.20.1" = _2PStzkoS;
        "pkg-1.1.1+1.21.5" = _wMsIEw88;
        "pkg-1.1.2+1.21.5" = _7r02low8;
        "pkg-1.1.2+1.21.4" = _FizhzHCv;
        "pkg-1.1.2+1.21.1" = _9g6JVBXW;
        "pkg-1.1.2+1.20.1" = _dYnxs3c8;
        "pkg-1.1.2+1.21.7" = _Qf1hqp32;
        "pkg-1.1.3+1.21.8" = _G8MN7513;
        "pkg-1.1.3+1.21.9" = _u0iMJ5HN;
        "pkg-1.1.4+1.21.9" = _E1e7r7j3;
        "pkg-1.1.4+1.21.8" = _srMIMH9K;
        "pkg-1.1.4+1.21.5" = _c7Ay84w2;
        "pkg-1.1.4+1.21.4" = _JDrAWJ1d;
        "pkg-1.1.4+1.21.1" = _hWX2f8Sa;
        "pkg-1.1.4+1.20.1" = _mPjaIq7H;
        "pkg-1.1.4+1.21.10" = _hY8i4OTW;
        "pkg-1.1.4+1.21.11" = _llA05ZeW;
        "pkg-1.2.0+1.21.11" = _X86lXSuv;
        "pkg-1.2.0+1.21.10" = _vR6tiBsE;
        "pkg-1.2.0+1.21.1" = _XISbGXLS;
        "pkg-1.2.0+1.20.1" = _V3nQ7Sgd;
        "pkg-1.2.1+1.21.11" = _ko0X0t2c;
        "pkg-1.2.1+1.21.10" = _of8bnGFn;
        "pkg-1.2.1+1.21.1" = _3kmgMEQp;
        "pkg-1.2.1+1.20.1" = _l7xZ8bhJ;
        "pkg-1.3.0+1.21.11" = _QQ3hmOvj;
        "pkg-1.3.0+1.21.1" = _HQtOpXgx;
        "pkg-1.3.0+1.20.1" = _Gq9np4BL;
        "pkg-1.4.0+1.21.11" = _50pKffMh;
        "pkg-1.4.1+1.21.1" = _GLJLjb0z;
        "pkg-1.4.1+1.20.1" = _g8eZXTWX;
        "pkg-1.4.1+1.21.11" = _QG9ZGr0h;
        "pkg-1.4.2+1.20.1" = _vXoUcVMk;
        "pkg-1.4.2+1.21.11" = _xqdjEkwC;
        "pkg-1.4.2+1.21.1" = _li1Fe2Gv;
        "pkg-1.4.2+26.1.x" = _OUyLAPzy;
        "pkg-1.4.2+26.2.x" = _5RJEbKdL;
        "pkg-1.5.0+26.2.x" = _ngLjENZQ;
        "pkg-1.5.0+26.1.x" = _3jUoAhAi;
