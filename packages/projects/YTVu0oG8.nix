...
let
    ...
    in {
        ...
        "pkg-1.3.1" = _FS8uXlcM;
        "pkg-1.4.0" = _wMIyCBKo;
        "pkg-1.4.0+1.21" = _93N2RWsV;
        "pkg-1.4.1+1.21" = _C9QY1r1Z;
        "pkg-1.4.2+1.21" = _9NRUOuHW;
        "pkg-2.0.0+1.21.1" = _hLq0ia2s;
        "pkg-2.0.1+1.21.1" = _xWfEA0yC;
        "pkg-3.0.0+1.21.11" = _O9HLQpfJ;
