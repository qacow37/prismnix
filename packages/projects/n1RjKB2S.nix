...
let
    ...
    in {
        ...
        "pkg-1.0.22" = _v4jPwEBB;
        "pkg-1.19.2-1.1.0" = _Xiedwa9b;
        "pkg-1.19.2-1.1.1" = _dn6kbPp9;
        "pkg-1.19.2-1.1.2" = _osfXf2dZ;
        "pkg-1.2.0" = _CvSvIoYF;
        "pkg-1.2.4" = _vJJoN1sy;
        "pkg-1.2.5" = _kGQ4r9ZQ;
        "pkg-1.2.6" = _fr8fZast;
        "pkg-1.2.7" = _AJOrjRU4;
        "pkg-1.2.9" = _xSZ1IuHq;
        "pkg-1.2.10" = _KMVbnb4u;
        "pkg-1.2.11" = _84lmYf3E;
        "pkg-1.2.12" = _r6pV02e2;
        "pkg-1.2.1" = _hL3QM2hq;
        "pkg-1.2.8" = _pfDHilai;
        "pkg-1.2.13" = _SdK6BJhH;
        "pkg-1.1.3" = _kDetlUsr;
        "pkg-1.1.14" = _sgqxiIS8;
        "pkg-1.2.14" = _Xb5YYsuS;
        "pkg-1.2.16" = _4qasxVR4;
        "pkg-1.1.17" = _fWZhLElH;
        "pkg-1.2.19" = _xumA9xys;
        "pkg-1.2.20" = _gxSBhx6T;
        "pkg-1.20.1-1.1.19" = _yVkNGfZn;
        "pkg-1.20.1-1.1.21" = _FBh3y9u7;
        "default" = _FBh3y9u7;
    });
