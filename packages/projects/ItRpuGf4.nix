...
let
    ...
    in {
        ...
        "pkg-1.0" = _z7kFS1Eb;
        "pkg-1.0_mod" = _FJC0PtqH;
        "pkg-1.1" = _dd1tVwKa;
        "pkg-1.2" = _2rLvQAmF;
        "pkg-1.2+mod" = _kbRarvPx;
        "pkg-1.3" = _x63sU90Z;
        "pkg-1.3+mod" = _chIuL4J2;
        "pkg-1.4" = _UvaRi3Y0;
        "pkg-1.4+mod" = _fJp8liii;
        "pkg-2.0" = _2SoObZaF;
        "pkg-2.0+mod" = _3MpsUMhY;
        "pkg-2.1" = _JwZp2GTk;
        "pkg-3.0" = _SxL6CkmC;
        "pkg-3.0+mod" = _LvonT56V;
        "pkg-3.1" = _BofgFr2d;
        "pkg-3.1+mod" = _MRXx4AOY;
        "pkg-3.2" = _4Gu2UJV5;
        "pkg-3.2+mod" = _nw5ZxB0i;
        "pkg-3.3" = _XMYplKZo;
        "pkg-3.3+mod" = _4MjROA0e;
        "pkg-3.4" = _W2cIbkVg;
        "pkg-3.4+mod" = _UMiVTSJb;
        "pkg-3.5" = _uvOPu1Gd;
        "pkg-3.5+mod" = _5MojiWM7;
        "pkg-3.6" = _CFShEdvW;
        "pkg-3.6+mod" = _wAYJEirt;
        "pkg-3.7" = _91wE7mwu;
        "pkg-3.7-fabric" = _jTsR7MXk;
        "pkg-3.7-forge" = _MHSSHctD;
        "pkg-3.11" = _vqEcK5RR;
        "pkg-3.11-fabric" = _ql5QGZOk;
        "pkg-3.11-quilt" = _6k5SWJZn;
        "pkg-3.11-forge" = _NA1vgsao;
        "pkg-3.11-neoforge" = _rWQU0KET;
        "pkg-3.12" = _DRvafkVC;
        "pkg-3.12-fabric" = _ChnLkeKL;
        "pkg-3.12-quilt" = _lnF1604r;
        "pkg-3.12-forge" = _xdtdaPij;
        "pkg-3.12-neoforge" = _ALGP872H;
        "default" = _ALGP872H;
    });
