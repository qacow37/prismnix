...
let
    ...
    in {
        ...
        "pkg-9.6.1" = _bEeWxiza;
        "pkg-9.7.0" = _1jNJFhmj;
        "pkg-10.0.0" = _O8jSMc8Y;
        "pkg-10.0.1" = _E4NRVj0c;
        "pkg-10.1.0" = _y9GBj0qQ;
        "pkg-10.1.1" = _YePtl9Tj;
        "pkg-10.1.2" = _epl0dnHR;
        "pkg-11.0.0" = _TnNHhxjZ;
        "pkg-11.1.0" = _jKB5ZyW7;
        "pkg-11.2.0" = _wtbh8UEY;
        "pkg-12.0.0" = _akb6MVa6;
        "default" = _akb6MVa6;
    });
