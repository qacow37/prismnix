...
let
    ...
    in {
        ...
        "pkg-0.11.0" = _EDjvrIBs;
        "pkg-0.11.1" = _yBAFCefm;
        "pkg-0.11.2" = _8hK6efJy;
        "pkg-0.12.3" = _QFXpzRgL;
        "pkg-0.12.5" = _rKeAfh6o;
        "pkg-0.13.0" = _pylDVS2b;
        "pkg-0.13.1" = _DYKzxbS9;
        "pkg-0.13.2" = _PyOjuGBJ;
        "pkg-0.13.3" = _mayyjsOl;
        "pkg-0.13.4" = _oGK73iro;
        "pkg-0.13.5" = _IvSOg9vh;
        "pkg-0.13.6" = _CyksfheA;
        "pkg-0.13.7" = _bLHwNps9;
        "pkg-0.13.8" = _J67y19tL;
        "pkg-0.13.8.1" = _uK4S3Jud;
        "pkg-0.13.9" = _mIYPkRoD;
        "pkg-0.14.0" = _QpyursJU;
        "pkg-0.14.1" = _ZauLdQRs;
        "pkg-0.14.2" = _KaXOXz81;
        "pkg-0.14.3" = _MSM0c5uZ;
        "pkg-0.14.4" = _3HYEtkw5;
        "pkg-0.14.5" = _Atl16f53;
        "pkg-0.14.6" = _sJ8HRj1p;
        "pkg-0.15.0" = _icZg5D5E;
        "pkg-0.15.1" = _OGvomlP1;
        "pkg-0.15.2" = _dAoNvLYx;
        "pkg-0.16.0" = _NJ6EIK5g;
        "pkg-0.16.1" = _XCAYqUbU;
        "pkg-0.16.2" = _Numtd3XC;
        "pkg-0.16.3" = _XjiOTYJE;
        "pkg-0.16.4" = _PYQVD4l3;
        "pkg-0.16.5" = _kn2QcGK0;
        "pkg-0.16.6" = _VjEMQ4JL;
        "pkg-0.16.7" = _Hv5Seh0Q;
        "pkg-0.16.8" = _3bZMBCRw;
        "pkg-0.20.0" = _UMNyfSNz;
        "pkg-0.21.0" = _BZZeYug8;
        "pkg-0.22.0" = _3Ez2Ho1j;
        "pkg-0.23.0" = _pPs82tA2;
        "pkg-0.24.0" = _UpurB3H6;
        "default" = _UpurB3H6;
    });
