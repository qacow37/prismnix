...
let
    ...
    in {
        ...
        "pkg-1.21.1-1.0.1.0-NEOFORGE" = _p2TdX9ko;
        "pkg-1.21.1-1.0.1.2-FABRIC" = _T3C4kv1q;
        "pkg-1.21.1-1.0.1.2-NEOFORGE" = _TiNryw2P;
        "pkg-1.21.10-1.0.1.2-FABRIC" = _WNY4BRHp;
        "pkg-1.21.10-1.0.1.2-NEOFORGE" = _1vtybj31;
        "pkg-1.21.10-1.0.1.3-FABRIC" = _EzgkVDMr;
        "pkg-1.21.10-1.0.1.3-NEOFORGE" = _1BeKyM7t;
        "pkg-1.21.1-1.0.1.4-FABRIC" = _c6J9o1A3;
        "pkg-1.21.1-1.0.1.4-NEOFORGE" = _4ZkNuH38;
        "pkg-1.21.10-1.0.1.4-FABRIC" = _COngrf81;
        "pkg-1.21.10-1.0.1.4-NEOFORGE" = _sg0ci95M;
        "pkg-1.21.1-1.0.1.6-FABRIC" = _6yt3jg5A;
        "pkg-1.21.1-1.0.1.6-NEOFORGE" = _fuxh3HlB;
        "pkg-1.21.10-1.0.1.6-FABRIC" = _4L8zevWe;
        "pkg-1.21.10-1.0.1.6-NEOFORGE" = _8WygWjva;
        "pkg-1.21.1-1.0.1.7-FABRIC" = _KyHqL6IU;
        "pkg-1.21.1-1.0.1.7-NEOFORGE" = _19yvnHox;
        "pkg-1.21.10-1.0.1.7-FABRIC" = _OBzt7VH2;
        "pkg-1.21.10-1.0.1.7-NEOFORGE" = _4aZQpqZD;
        "pkg-1.21.11-1.0.1.7-FABRIC" = _xonpE727;
        "pkg-1.21.11-1.0.1.7-NEOFORGE" = _lmDXqVPg;
        "pkg-1.21.10-1.0.1.8-FABRIC" = _FuFyhAlX;
        "pkg-1.21.10-1.0.1.8-NEOFORGE" = _4EPnNADD;
        "pkg-1.21.11-1.0.1.8-FABRIC" = _oKFyXpKk;
        "pkg-1.21.11-1.0.1.8-NEOFORGE" = _Mr9nHSQr;
        "pkg-1.21.1-1.0.2.0-FABRIC" = _8pJKV1DE;
        "pkg-1.21.1-1.0.2.0-NEOFORGE" = _I7HibHPI;
        "pkg-1.21.10-1.0.2.0-FABRIC" = _5gkicy7A;
        "pkg-1.21.10-1.0.2.0-NEOFORGE" = _CyxillQV;
        "pkg-1.21.11-1.0.2.0-FABRIC" = _UTTKQBnC;
        "pkg-1.21.11-1.0.2.0-NEOFORGE" = _FgPs05Ju;
        "pkg-26.1.1-1.0.2.0-FABRIC" = _MTld9kVd;
        "pkg-26.1.1-1.0.2.0-NEOFORGE" = _d4hHvd4c;
        "pkg-26.1.2-1.0.2.0-FABRIC" = _vu34Wdma;
        "pkg-26.1.2-1.0.2.0-NEOFORGE" = _8vao6OrL;
        "pkg-1.21.1-1.0.2.1-FABRIC" = _s5l5BDFA;
        "pkg-1.21.1-1.0.2.1-NEOFORGE" = _640CLy7C;
        "pkg-26.1.2-1.0.2.1-FABRIC" = _cJAQr1UO;
        "pkg-26.1.2-1.0.2.1-NEOFORGE" = _LQRJbh2g;
        "pkg-26.2-1.0.2.1-FABRIC" = _B0uLI3mX;
        "pkg-26.2-1.0.2.1-NEOFORGE" = _EWZPPzLQ;
        "pkg-26.1.2-1.0.2.2-FABRIC" = _akSwhypj;
