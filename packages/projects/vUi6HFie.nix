...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha.1+1.18.2" = _4eRvWZS7;
        "pkg-1.0.0-alpha.1+1.19" = _Insnj5AY;
        "pkg-1.0.0-beta.1+1.19" = _YxzKwtBL;
        "pkg-1.0.0+1.19" = _jLk0GNdy;
        "pkg-1.0.0+1.18.2" = _7oh79tGp;
        "pkg-1.0.1+1.19" = _UEA2nZyd;
        "pkg-1.0.1+1.18.2" = _gXQs0fY0;
        "pkg-1.0.2+1.19" = _mOxkhGOv;
        "pkg-1.0.2+1.18.2" = _9Cb04Gex;
        "pkg-1.0.3+1.19+" = _cqIsAyQO;
        "pkg-1.0.3+1.18.2" = _5jgl1MIj;
        "pkg-1.0.4+1.18.2" = _KRk1bnxM;
        "pkg-1.0.4+1.19+" = _QxRvomUF;
        "pkg-1.0.5+1.19.3" = _j8YGlTos;
        "pkg-1.1.0+1.19.3" = _9RRoqgwb;
        "pkg-1.1.1+1.19.3" = _BfOwL7wb;
        "pkg-1.1.2+1.19.4" = _dG2rSwWZ;
        "pkg-1.1.3+1.20.1" = _XiXTpl2Z;
        "pkg-1.2.0+1.20.4" = _FRbCuYVK;
        "pkg-1.2.0+1.20.1" = _ll04HPfK;
        "pkg-1.2.0+1.20.2" = _3Ogg5vkg;
        "pkg-1.2.0+1.19.4" = _U8KSJJIL;
        "pkg-1.2.1+1.20.1" = _3SNsyaTx;
        "pkg-1.2.1+1.20.2" = _B1B0eVJf;
        "pkg-1.2.1+1.20.4" = _A7Qs0ZTX;
        "pkg-1.2.1+1.19.4" = _pNpvcXmB;
        "pkg-1.2.2+1.20.1" = _ywil25Ps;
        "pkg-1.2.2+1.20.4" = _3HEK39pS;
        "pkg-1.2.2+1.19.4" = _SrrZmYux;
        "pkg-1.2.2+1.20.2" = _AvxIsuk6;
        "pkg-1.2.3+1.19.4" = _zzATL7AN;
        "pkg-1.2.3+1.20.1" = _4CqP6Sc7;
        "pkg-1.2.3+1.20.2" = _sB0cquxv;
        "pkg-1.2.3+1.20.4" = _hqxFQKZY;
        "pkg-1.2.4+1.20.4" = _DbiMJZZz;
        "pkg-1.2.4+1.20.1" = _4YXMZuAk;
        "pkg-1.2.4+1.19.4" = _Y2IJVLOl;
        "pkg-1.2.4+1.20.2" = _NXIEFV5p;
        "default" = _NXIEFV5p;
    });
