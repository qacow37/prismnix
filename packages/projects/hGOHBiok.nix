...
let
    ...
    in {
        ...
        "pkg-v0.3.1-mc1.19.2" = _2PTDaaIx;
        "pkg-v0.3.1-mc1.19.4" = _q5JSVpVg;
        "pkg-v0.3.1-mc1.20.1" = _eAzpYVNd;
        "pkg-v0.3.1-mc1.20.6" = _3OBAnilT;
        "pkg-v0.4.0-mc1.16.5" = _bNxn9xGT;
        "pkg-v0.4.0-mc1.17.1" = _WLIfNgdJ;
        "pkg-v0.4.0-mc1.18.2" = _a9lGvbPI;
        "pkg-v0.4.0-mc1.20.6" = _RupTujis;
        "pkg-v0.4.0-mc1.20.1" = _xxXKRO7m;
        "pkg-v0.4.0-mc1.19.4" = _wJqNhHoz;
        "pkg-v0.4.1-mc1.16.5" = _bRb0Fs5p;
        "pkg-v0.4.1-mc1.17.1" = _AcReu8bO;
        "pkg-v0.4.1-mc1.18.2" = _jD67CTGR;
        "pkg-v0.4.1-mc1.20.6" = _JsFPaB9s;
        "pkg-v0.4.1-mc1.19.4" = _oGoCKxWF;
        "pkg-v0.4.1-mc1.20.1" = _BrRYOVnU;
        "pkg-v0.4.2-mc1.16.5" = _rUpyN3gA;
        "pkg-v0.4.2-mc1.17.1" = _3a07ItRN;
        "pkg-v0.4.2-mc1.18.2" = _aqljjsWk;
        "pkg-v0.4.2-mc1.19.4" = _lz0KcQDQ;
        "pkg-v0.4.2-mc1.20.1" = _akTJrE9t;
        "pkg-v0.4.2-mc1.20.6" = _SZkzv62D;
        "pkg-v0.4.3-mc1.16.5" = _50WHbd7U;
        "pkg-v0.4.3-mc1.17.1" = _EkjZepDv;
        "pkg-v0.4.3-mc1.18.2" = _QX1k5C7H;
        "pkg-v0.4.3-mc1.20.1" = _FFKyuwEk;
        "pkg-v0.4.3-mc1.20.6" = _jJhqqlAX;
        "pkg-v0.4.3-mc1.21.1" = _YYHlm1Um;
        "pkg-v0.4.3-mc1.19.4" = _UvfcD8i0;
        "pkg-v0.4.3-mc1.21.4" = _IahxLgV1;
        "pkg-v0.4.4-mc1.14.4" = _KXmuR8n6;
        "pkg-v0.4.4-mc1.15.2" = _Mn3FkZk1;
        "pkg-v0.4.4-mc1.16.5" = _JNgg6I7b;
        "pkg-v0.4.4-mc1.17.1" = _6MpRXsYX;
        "pkg-v0.4.4-mc1.18.2" = _qntdvjEo;
        "pkg-v0.4.4-mc1.19.4" = _xxztCmjL;
        "pkg-v0.4.4-mc1.20.1" = _QUMJbRt1;
        "pkg-v0.4.4-mc1.20.6" = _ArqCGJoc;
        "pkg-v0.4.4-mc1.21.1" = _DX22xFhO;
        "pkg-v0.4.4-mc1.21.4" = _rmQn8JCt;
        "pkg-v0.4.5-mc1.14.4" = _vwPtyb3z;
        "pkg-v0.4.5-mc1.15.2" = _jGet6S4y;
        "pkg-v0.4.5-mc1.16.5" = _IFJTcoe2;
        "pkg-v0.4.5-mc1.17.1" = _NIfF2eKD;
        "pkg-v0.4.5-mc1.18.2" = _8VhsL8gh;
        "pkg-v0.4.5-mc1.19.4" = _PQ6e6gPl;
        "pkg-v0.4.5-mc1.20.1" = _fJhcLsvI;
        "pkg-v0.4.5-mc1.20.6" = _QFCQ84im;
        "pkg-v0.4.5-mc1.21.1" = _XaKtXXHT;
        "pkg-v0.4.5-mc1.21.4" = _L6bpNpr5;
        "pkg-v0.4.6-mc1.14.4" = _tKErOFVH;
        "pkg-v0.4.6-mc1.15.2" = _plHMGNN4;
        "pkg-v0.4.6-mc1.16.5" = _v8NDJpg9;
        "pkg-v0.4.6-mc1.17.1" = _N1bS1XEj;
        "pkg-v0.4.6-mc1.18.2" = _ziNY7G3t;
        "pkg-v0.4.6-mc1.19.4" = _8AjRvWHu;
        "pkg-v0.4.6-mc1.20.1" = _AN5xtpqe;
        "pkg-v0.4.6-mc1.20.6" = _dEEc2iiF;
        "pkg-v0.4.6-mc1.21.1" = _sIHC8h41;
        "pkg-v0.4.6-mc1.21.4" = _2PcfZlKj;
        "pkg-v0.5.0-mc1.14.4" = _CAl7EafC;
        "pkg-v0.5.0-mc1.15.2" = _JXMYkMWT;
        "pkg-v0.5.0-mc1.16.5" = _ohcnpyxI;
        "pkg-v0.5.0-mc1.17.1" = _mlOydkkg;
        "pkg-v0.5.0-mc1.18.2" = _UGviEW1S;
        "pkg-v0.5.0-mc1.19.4" = _lPwlup5a;
        "pkg-v0.5.0-mc1.20.1" = _WxO5pxKv;
        "pkg-v0.5.0-mc1.20.6" = _qs7aGy8Q;
        "pkg-v0.5.0-mc1.21.1" = _DrXlGmX4;
        "pkg-v0.5.0-mc1.21.4" = _4f4qE101;
        "pkg-v0.5.1-mc1.14.4" = _c7S6EKUT;
        "pkg-v0.5.1-mc1.15.2" = _2rUrA7hf;
        "pkg-v0.5.1-mc1.16.5" = _NWBGvPnj;
        "pkg-v0.5.1-mc1.17.1" = _Hu9OySIj;
        "pkg-v0.5.1-mc1.18.2" = _GHZvF22T;
        "pkg-v0.5.1-mc1.19.4" = _I7c6faDV;
        "pkg-v0.5.1-mc1.20.1" = _vI929fO1;
        "pkg-v0.5.1-mc1.20.6" = _J50STXhP;
        "pkg-v0.5.1-mc1.21.1" = _Q4aLpxOn;
        "pkg-v0.5.1-mc1.21.4" = _SJPrGm5i;
        "pkg-v0.6.0-mc1.14.4" = _RCh39QwN;
        "pkg-v0.6.0-mc1.15.2" = _TUYZSXz1;
        "pkg-v0.6.0-mc1.16.5" = _zSSCVN1u;
        "pkg-v0.6.0-mc1.17.1" = _UwRV0H8M;
        "pkg-v0.6.0-mc1.18.2" = _fqk8L6It;
        "pkg-v0.6.0-mc1.19.4" = _LlEn1ioD;
        "pkg-v0.6.0-mc1.20.1" = _5lcQSEWC;
        "pkg-v0.6.0-mc1.20.6" = _kBqODcMi;
        "pkg-v0.6.0-mc1.21.1" = _ZHWnqGmz;
        "pkg-v0.6.0-mc1.21.4" = _Dr3R2Mgx;
        "pkg-v0.6.1-mc1.14.4" = _505E5uad;
        "pkg-v0.6.1-mc1.15.2" = _qdPWAyB2;
        "pkg-v0.6.1-mc1.16.5" = _2ZTBz2uH;
        "pkg-v0.6.1-mc1.17.1" = _EoTa04pu;
        "pkg-v0.6.1-mc1.18.2" = _JMmVRqjW;
        "pkg-v0.6.1-mc1.19.4" = _wXfCl9aR;
        "pkg-v0.6.1-mc1.20.1" = _CclKZqcD;
        "pkg-v0.6.1-mc1.20.6" = _yXx6VMQV;
        "pkg-v0.6.1-mc1.21.1" = _ZHDCB5vY;
        "pkg-v0.6.1-mc1.21.4" = _BO2lZDp3;
        "pkg-v0.6.2-mc1.14.4" = _hmS6jwdN;
        "pkg-v0.6.2-mc1.15.2" = _cZISya61;
        "pkg-v0.6.2-mc1.16.5" = _rovg8Jhw;
        "pkg-v0.6.2-mc1.17.1" = _djpstkeC;
        "pkg-v0.6.2-mc1.18.2" = _OAMJjZx5;
        "pkg-v0.6.2-mc1.19.4" = _QyoNIW6E;
        "pkg-v0.6.2-mc1.20.1" = _1gBKQeQh;
        "pkg-v0.6.2-mc1.20.6" = _TcEAwoda;
        "pkg-v0.6.2-mc1.21.1" = _92e4MYbD;
        "pkg-v0.6.2-mc1.21.4" = _Kj7hDVRM;
        "pkg-v0.6.3-mc1.14.4" = _Y4EvA5Gd;
        "pkg-v0.6.3-mc1.15.2" = _NuRKJ50s;
        "pkg-v0.6.3-mc1.16.5" = _CvNKPqhN;
        "pkg-v0.6.3-mc1.17.1" = _SPV5MTmH;
        "pkg-v0.6.3-mc1.18.2" = _RB1v44uT;
        "pkg-v0.6.3-mc1.19.4" = _40PyFnrs;
        "pkg-v0.6.3-mc1.20.1" = _tbzYyI1L;
        "pkg-v0.6.3-mc1.20.6" = _2vPdLKSl;
        "pkg-v0.6.3-mc1.21.1" = _8WTvIy3H;
        "pkg-v0.6.3-mc1.21.4" = _SOWildNB;
        "pkg-v0.6.4-mc1.14.4" = _MdStGAzx;
        "pkg-v0.6.4-mc1.15.2" = _azNk3n2H;
        "pkg-v0.6.4-mc1.16.5" = _xN9oU53q;
        "pkg-v0.6.4-mc1.17.1" = _RpRfQsk0;
        "pkg-v0.6.4-mc1.18.2" = _Q0o1ttcu;
        "pkg-v0.6.4-mc1.19.4" = _mdotQpkj;
        "pkg-v0.6.4-mc1.20.1" = _no25PonT;
        "pkg-v0.6.4-mc1.20.6" = _cKYD846U;
        "pkg-v0.6.4-mc1.21.1" = _cTNJYPny;
        "pkg-v0.6.4-mc1.21.4" = _32g2zArr;
        "pkg-v0.7.0-mc1.14.4" = _K0l062RO;
        "pkg-v0.7.0-mc1.15.2" = _nd3Uyw3x;
        "pkg-v0.7.0-mc1.16.5" = _FJJzzXaN;
        "pkg-v0.7.0-mc1.17.1" = _QX5zD3ge;
        "pkg-v0.7.0-mc1.18.2" = _euGJKFr6;
        "pkg-v0.7.0-mc1.19.4" = _ToRZKut1;
        "pkg-v0.7.0-mc1.20.1" = _NS4vJ6dt;
        "pkg-v0.7.0-mc1.20.6" = _SHAFCcvO;
        "pkg-v0.7.0-mc1.21.1" = _bbIiRh8O;
        "pkg-v0.7.0-mc1.21.4" = _WmwgUSWB;
        "pkg-v0.7.1-mc1.14.4" = _J7h3LUhF;
        "pkg-v0.7.1-mc1.15.2" = _4Yr7zapQ;
        "pkg-v0.7.1-mc1.16.5" = _vn2CLCGM;
        "pkg-v0.7.1-mc1.17.1" = _kKKlw2bM;
        "pkg-v0.7.1-mc1.18.2" = _4vVMkutY;
        "pkg-v0.7.1-mc1.19.4" = _ybtZNG4y;
        "pkg-v0.7.1-mc1.20.1" = _Bhmpav7W;
        "pkg-v0.7.1-mc1.20.6" = _QBCrljiU;
        "pkg-v0.7.1-mc1.21.1" = _pb3Y4VPI;
        "pkg-v0.7.1-mc1.21.4" = _SMMIjLye;
        "pkg-v0.7.1-mc1.21.5" = _Ph1lxVy8;
        "pkg-v0.7.2-mc1.14.4" = _fjWR5vFK;
        "pkg-v0.7.2-mc1.15.2" = _omXC15ZJ;
        "pkg-v0.7.2-mc1.16.5" = _560HVbHU;
        "pkg-v0.7.2-mc1.17.1" = _37E7Bnq1;
        "pkg-v0.7.2-mc1.18.2" = _Zp4gBGQU;
        "pkg-v0.7.2-mc1.19.4" = _5WcAwYv3;
        "pkg-v0.7.2-mc1.20.1" = _JOu8Zj2k;
        "pkg-v0.7.2-mc1.20.6" = _aNwQvCHo;
        "pkg-v0.7.2-mc1.21.1" = _he3vE2BF;
        "pkg-v0.7.2-mc1.21.4" = _N5I93mSi;
        "pkg-v0.7.2-mc1.21.5" = _QY2UqL09;
        "pkg-v0.7.3-mc1.14.4" = _4BQAh0wk;
        "pkg-v0.7.3-mc1.15.2" = _2WjVqhZq;
        "pkg-v0.7.3-mc1.16.5" = _j4ukdaTV;
        "pkg-v0.7.3-mc1.17.1" = _uzrbFAmP;
        "pkg-v0.7.3-mc1.18.2" = _l6Alb5Kn;
        "pkg-v0.7.3-mc1.19.4" = _ThAvovMe;
        "pkg-v0.7.3-mc1.20.1" = _5x7cOi33;
        "pkg-v0.7.3-mc1.20.6" = _mlqj3tMS;
        "pkg-v0.7.3-mc1.21.1" = _a8EUer7r;
        "pkg-v0.7.3-mc1.21.5" = _UeGBKaEm;
        "pkg-v0.7.3-mc1.21.4" = _E6AL4nXy;
        "pkg-v0.7.4-mc1.14.4" = _maQJZMIj;
        "pkg-v0.7.4-mc1.15.2" = _m87jSsYI;
        "pkg-v0.7.4-mc1.16.5" = _RznVIWMh;
        "pkg-v0.7.4-mc1.17.1" = _N4JGZy3V;
        "pkg-v0.7.4-mc1.18.2" = _Cd45Ki6Z;
        "pkg-v0.7.4-mc1.19.4" = _a3Te5JEv;
        "pkg-v0.7.4-mc1.20.1" = _HyJIEzJc;
        "pkg-v0.7.4-mc1.20.6" = _qoy1ZjZe;
        "pkg-v0.7.4-mc1.21.1" = _A2B3AYWj;
        "pkg-v0.7.4-mc1.21.4" = _VnN4SokB;
        "pkg-v0.7.4-mc1.21.5" = _ZlsBSwdX;
        "pkg-v0.7.4-mc1.21.6" = _Pn9HFEZl;
        "pkg-v0.8.0-mc1.14.4" = _tqKN4LYj;
        "pkg-v0.8.0-mc1.15.2" = _ixMF2JQc;
        "pkg-v0.8.0-mc1.16.5" = _U6xC3GH8;
        "pkg-v0.8.0-mc1.17.1" = _oALR7meC;
        "pkg-v0.8.0-mc1.18.2" = _nLmfN9z9;
        "pkg-v0.8.0-mc1.19.4" = _aSKnxpeS;
        "pkg-v0.8.0-mc1.20.1" = _NWSGH7zM;
        "pkg-v0.8.0-mc1.20.6" = _eXDrG9lj;
        "pkg-v0.8.0-mc1.21.1" = _nGwJJ788;
        "pkg-v0.8.0-mc1.21.4" = _goNw8Tie;
        "pkg-v0.8.0-mc1.21.5" = _cK47dIbL;
        "pkg-v0.8.0-mc1.21.6" = _kEnhpbUK;
        "pkg-v0.8.1-mc1.14.4" = _EFFT7mJG;
        "pkg-v0.8.1-mc1.15.2" = _ShEdHLj5;
        "pkg-v0.8.1-mc1.16.5" = _NH7nQ50D;
        "pkg-v0.8.1-mc1.17.1" = _ELtJamSX;
        "pkg-v0.8.1-mc1.18.2" = _ca24ZeOm;
        "pkg-v0.8.1-mc1.19.4" = _Qk7yDUvT;
        "pkg-v0.8.1-mc1.20.1" = _bHMtMpZm;
        "pkg-v0.8.1-mc1.20.6" = _QzPsXik4;
        "pkg-v0.8.1-mc1.21.1" = _5siRGzij;
        "pkg-v0.8.1-mc1.21.4" = _sQvi6dCa;
        "pkg-v0.8.1-mc1.21.5" = _c90hkTH1;
        "pkg-v0.8.1-mc1.21.6" = _Z6FJLUnt;
        "pkg-v0.8.2-mc1.14.4" = _zNXYIEnk;
        "pkg-v0.8.2-mc1.15.2" = _PVzxeicV;
        "pkg-v0.8.2-mc1.16.5" = _2L9wynsn;
        "pkg-v0.8.2-mc1.17.1" = _Zuh7CfUS;
        "pkg-v0.8.2-mc1.18.2" = _SgHLAyJp;
        "pkg-v0.8.2-mc1.19.4" = _ymJW516g;
        "pkg-v0.8.2-mc1.20.1" = _K8yPAZGO;
        "pkg-v0.8.2-mc1.20.6" = _Mwe9dgHz;
        "pkg-v0.8.2-mc1.21.1" = _htPX2ol0;
        "pkg-v0.8.2-mc1.21.4" = _3T8xE3IR;
        "pkg-v0.8.2-mc1.21.5" = _UI2FTrGO;
        "pkg-v0.8.2-mc1.21.6" = _KY5QuZC1;
        "pkg-v0.8.2-mc1.21.7" = _7nA84x0z;
        "pkg-v0.9.0-mc1.14.4" = _SsigUo7N;
        "pkg-v0.9.0-mc1.15.2" = _5A5Wkgbd;
        "pkg-v0.9.0-mc1.16.5" = _6QhhWA98;
        "pkg-v0.9.0-mc1.17.1" = _yxp56HIL;
        "pkg-v0.9.0-mc1.18.2" = _LNwXYUJW;
        "pkg-v0.9.0-mc1.19.4" = _LypvWs0U;
        "pkg-v0.9.0-mc1.20.1" = _fWk4RhaH;
        "pkg-v0.9.0-mc1.20.6" = _tbO3P3Fl;
        "pkg-v0.9.0-mc1.21.1" = _zEumX9Uj;
        "pkg-v0.9.0-mc1.21.4" = _Vdb90E22;
        "pkg-v0.9.0-mc1.21.5" = _mFz8UAS0;
        "pkg-v0.9.0-mc1.21.6" = _Rpa0fJQk;
        "pkg-v0.9.0-mc1.21.7" = _K0JkGJVN;
        "pkg-v0.10.0-mc1.14.4" = _iT4HyaWg;
        "pkg-v0.10.0-mc1.15.2" = _s2OxCk9q;
        "pkg-v0.10.0-mc1.16.5" = _o5ja2t1s;
        "pkg-v0.10.0-mc1.17.1" = _v2PEXgoE;
        "pkg-v0.10.0-mc1.18.2" = _hyqBgAmz;
        "pkg-v0.10.0-mc1.19.4" = _QyxmjR4R;
        "pkg-v0.10.0-mc1.20.1" = _JDNUatxe;
        "pkg-v0.10.0-mc1.20.6" = _TXk318IN;
        "pkg-v0.10.0-mc1.21.1" = _XZhgZR1X;
        "pkg-v0.10.0-mc1.21.4" = _EsakoMI8;
        "pkg-v0.10.0-mc1.21.5" = _EuDt9TMl;
        "pkg-v0.10.0-mc1.21.6" = _V54AXp3x;
        "pkg-v0.10.0-mc1.21.7" = _zZVjt88c;
        "pkg-v0.11.0-mc1.14.4" = _I7tWwano;
        "pkg-v0.11.0-mc1.15.2" = _NvMbAtL1;
        "pkg-v0.11.0-mc1.16.5" = _hPtIw95l;
        "pkg-v0.11.0-mc1.17.1" = _9YkgSyaU;
        "pkg-v0.11.0-mc1.18.2" = _XfZEdcqa;
        "pkg-v0.11.0-mc1.19.4" = _l0DsXLfN;
        "pkg-v0.11.0-mc1.20.1" = _TQtJhlLh;
        "pkg-v0.11.0-mc1.20.6" = _W0yualtL;
        "pkg-v0.11.0-mc1.21.1" = _RbK63K2Q;
        "pkg-v0.11.0-mc1.21.4" = _Uks8TrIt;
        "pkg-v0.11.0-mc1.21.5" = _fVLBKPqd;
        "pkg-v0.11.0-mc1.21.6" = _iCIXhPQm;
        "pkg-v0.11.0-mc1.21.7" = _YpIqQLny;
        "pkg-v0.11.0-mc1.21.8" = _keUGUf9Y;
        "pkg-v0.12.0-mc1.14.4" = _4tlg4JKL;
        "pkg-v0.12.0-mc1.15.2" = _VWULqg9A;
        "pkg-v0.12.0-mc1.16.5" = _X4zB9Idi;
        "pkg-v0.12.0-mc1.17.1" = _fsTwgciz;
        "pkg-v0.12.0-mc1.18.2" = _XTA6gEKE;
        "pkg-v0.12.0-mc1.19.4" = _Sh3OPLQK;
        "pkg-v0.12.0-mc1.20.1" = _jzG3Ks7s;
        "pkg-v0.12.0-mc1.20.6" = _pLDV0MJw;
        "pkg-v0.12.0-mc1.21.1" = _ErWrClTP;
        "pkg-v0.12.0-mc1.21.4" = _fogqan3y;
        "pkg-v0.12.0-mc1.21.5" = _RDj5GdUc;
        "pkg-v0.12.0-mc1.21.6" = _NyePxoGz;
        "pkg-v0.12.0-mc1.21.7" = _rphF6Fnb;
        "pkg-v0.12.0-mc1.21.8" = _1N2npiRZ;
        "pkg-v0.12.1-mc1.14.4" = _PJ8pu03n;
        "pkg-v0.12.1-mc1.15.2" = _GiGXVlsK;
        "pkg-v0.12.1-mc1.16.5" = _yMyCo7Wk;
        "pkg-v0.12.1-mc1.17.1" = _ZOOl2YV0;
        "pkg-v0.12.1-mc1.18.2" = _hiu8JoSQ;
        "pkg-v0.12.1-mc1.19.4" = _AvyLq1re;
        "pkg-v0.12.1-mc1.20.1" = _C4qXUmvf;
        "pkg-v0.12.1-mc1.20.6" = _9w1DusLv;
        "pkg-v0.12.1-mc1.21.1" = _sIId8CIg;
        "pkg-v0.12.1-mc1.21.4" = _3UMWPb59;
        "pkg-v0.12.1-mc1.21.5" = _92OdW6Y7;
        "pkg-v0.12.1-mc1.21.6" = _sIn6vkHA;
        "pkg-v0.12.1-mc1.21.7" = _IHHXropu;
        "pkg-v0.12.1-mc1.21.8" = _Kbkwrvib;
        "pkg-v0.12.2-mc1.14.4" = _lYD45pC9;
        "pkg-v0.12.2-mc1.15.2" = _BEGyyLeK;
        "pkg-v0.12.2-mc1.16.5" = _FYEXr58n;
        "pkg-v0.12.2-mc1.17.1" = _nqEzLYq9;
        "pkg-v0.12.2-mc1.18.2" = _eKmdY0An;
        "pkg-v0.12.2-mc1.19.4" = _hPWl5mhK;
        "pkg-v0.12.2-mc1.20.1" = _upl6gr3R;
        "pkg-v0.12.2-mc1.20.6" = _4KJnCP6I;
        "pkg-v0.12.2-mc1.21.1" = _R6OIwn78;
        "pkg-v0.12.2-mc1.21.4" = _aat6Midk;
        "pkg-v0.12.2-mc1.21.5" = _HNCRix6r;
        "pkg-v0.12.2-mc1.21.6" = _Vu7dnXKU;
        "pkg-v0.12.2-mc1.21.7" = _otKi8fwF;
        "pkg-v0.12.2-mc1.21.8" = _QQORN0pT;
        "pkg-v0.12.3-mc1.14.4" = _bslgHz3M;
        "pkg-v0.12.3-mc1.15.2" = _nA6CYkTD;
        "pkg-v0.12.3-mc1.16.5" = _AhJCos9Z;
        "pkg-v0.12.3-mc1.17.1" = _gMI6e0G7;
        "pkg-v0.12.3-mc1.18.2" = _JQs3EAen;
        "pkg-v0.12.3-mc1.19.4" = _3xB3Pixj;
        "pkg-v0.12.3-mc1.20.1" = _HSb3tFqm;
        "pkg-v0.12.3-mc1.20.6" = _Nh3bkP0j;
        "pkg-v0.12.3-mc1.21.1" = _TvspmAzK;
        "pkg-v0.12.3-mc1.21.4" = _FYadflfr;
        "pkg-v0.12.3-mc1.21.5" = _WqEWUWfT;
        "pkg-v0.12.3-mc1.21.6" = _mEU6fef9;
        "pkg-v0.12.3-mc1.21.7" = _P03b5Eh2;
        "pkg-v0.12.3-mc1.21.8" = _n1qwGX7h;
        "pkg-v0.13.0-mc1.14.4" = _9hTALDxd;
        "pkg-v0.13.0-mc1.15.2" = _xKxkxXN9;
        "pkg-v0.13.0-mc1.16.5" = _laOHoAFf;
        "pkg-v0.13.0-mc1.17.1" = _8OX2VUdi;
        "pkg-v0.13.0-mc1.18.2" = _6rQtNFJG;
        "pkg-v0.13.0-mc1.19.4" = _VOsuwiK5;
        "pkg-v0.13.0-mc1.20.1" = _bZTQ1evx;
        "pkg-v0.13.0-mc1.20.6" = _l8GYbX9c;
        "pkg-v0.13.0-mc1.21.1" = _iEcUlbkt;
        "pkg-v0.13.0-mc1.21.3" = _Igy6qzgP;
        "pkg-v0.13.0-mc1.21.4" = _GqGKINPq;
        "pkg-v0.13.0-mc1.21.5" = _rO4IqHA2;
        "pkg-v0.13.0-mc1.21.8" = _nyqfMxnb;
        "pkg-v0.13.0-mc1.21.9" = _TDlXZFCR;
        "pkg-v0.14.0-mc1.14.4" = _TCngsorh;
        "pkg-v0.14.0-mc1.15.2" = _srMf1wjr;
        "pkg-v0.14.0-mc1.16.5" = _1PENDj6t;
        "pkg-v0.14.0-mc1.17.1" = _uKZjMZic;
        "pkg-v0.14.0-mc1.18.2" = _udSBMs48;
        "pkg-v0.14.0-mc1.19.4" = _mYYlqLAO;
        "pkg-v0.14.0-mc1.20.1" = _aKbJNwXK;
        "pkg-v0.14.0-mc1.20.6" = _ylHBetLH;
        "pkg-v0.14.0-mc1.21.1" = _yQFUKj99;
        "pkg-v0.14.0-mc1.21.10" = _QPPxIug2;
        "pkg-v0.14.0-mc1.21.3" = _1sAwgyXz;
        "pkg-v0.14.0-mc1.21.4" = _ZDrrl0U1;
        "pkg-v0.14.0-mc1.21.5" = _UyOcVRQd;
        "pkg-v0.14.0-mc1.21.8" = _aRhcDe6s;
        "pkg-v0.14.1-mc1.14.4" = _ty54u0rm;
        "pkg-v0.14.1-mc1.15.2" = _eQTXZSzT;
        "pkg-v0.14.1-mc1.16.5" = _6aOgNZV1;
        "pkg-v0.14.1-mc1.17.1" = _CHbKTG9H;
        "pkg-v0.14.1-mc1.18.2" = _yjHxr1ac;
        "pkg-v0.14.1-mc1.19.4" = _MpYlHyFR;
        "pkg-v0.14.1-mc1.20.1" = _i2Wxpqfw;
        "pkg-v0.14.1-mc1.20.6" = _4VkD5S7J;
        "pkg-v0.14.1-mc1.21.1" = _v4EPbq2X;
        "pkg-v0.14.1-mc1.21.10" = _TkJe39qe;
        "pkg-v0.14.1-mc1.21.3" = _r8Bc9V6q;
        "pkg-v0.14.1-mc1.21.4" = _fyHWuAhP;
        "pkg-v0.14.1-mc1.21.5" = _DQ352ydo;
        "pkg-v0.14.1-mc1.21.8" = _4tqnhL8c;
        "pkg-v0.15.0-mc1.14.4" = _6aGEpig8;
        "pkg-v0.15.0-mc1.15.2" = _x2GihV6X;
        "pkg-v0.15.0-mc1.16.5" = _bWI2K1Kq;
        "pkg-v0.15.0-mc1.17.1" = _2FLnEeTh;
        "pkg-v0.15.0-mc1.18.2" = _Rrc0r0PV;
        "pkg-v0.15.0-mc1.19.4" = _edErR2nW;
        "pkg-v0.15.0-mc1.20.1" = _lDKBAiXh;
        "pkg-v0.15.0-mc1.20.6" = _GjWjVw3H;
        "pkg-v0.15.0-mc1.21.1" = _SgMNREkO;
        "pkg-v0.15.0-mc1.21.10" = _CYkwMKcH;
        "pkg-v0.15.0-mc1.21.3" = _b9SriizA;
        "pkg-v0.15.0-mc1.21.4" = _CYi1Z178;
        "pkg-v0.15.0-mc1.21.5" = _Tn3DG3L1;
        "pkg-v0.15.0-mc1.21.8" = _XvqpnLLL;
        "pkg-v0.15.1-mc1.14.4" = _A3iYVhqe;
        "pkg-v0.15.1-mc1.15.2" = _2Ez9bF22;
        "pkg-v0.15.1-mc1.16.5" = _m2EvdsHF;
        "pkg-v0.15.1-mc1.17.1" = _8UCCrpiU;
        "pkg-v0.15.1-mc1.18.2" = _pQl01CiA;
        "pkg-v0.15.1-mc1.19.4" = _soyChiDc;
        "pkg-v0.15.1-mc1.20.1" = _64HoZr5S;
        "pkg-v0.15.1-mc1.20.6" = _UfwS9WF4;
        "pkg-v0.15.1-mc1.21.1" = _a8lIJKsF;
        "pkg-v0.15.1-mc1.21.10" = _VpV3Qum8;
        "pkg-v0.15.1-mc1.21.3" = _83f9U8LD;
        "pkg-v0.15.1-mc1.21.4" = _9IZ64Ys4;
        "pkg-v0.15.1-mc1.21.5" = _LpToECO5;
        "pkg-v0.15.1-mc1.21.8" = _FXck75Cc;
        "pkg-v0.15.1-mc25w46a" = _B4tG2wou;
        "pkg-v0.16.0-mc1.14.4" = _AC8eujyp;
        "pkg-v0.16.0-mc1.15.2" = _HyqAewPZ;
        "pkg-v0.16.0-mc1.16.5" = _RRuTQpxz;
        "pkg-v0.16.0-mc1.17.1" = _zxvh4RjC;
        "pkg-v0.16.0-mc1.18.2" = _DflXI9e0;
        "pkg-v0.16.0-mc1.19.4" = _kqr2OWry;
        "pkg-v0.16.0-mc1.20.1" = _Hz85jfNl;
        "pkg-v0.16.0-mc1.20.6" = _2Nd0Lz4U;
        "pkg-v0.16.0-mc1.21.1" = _L9nSHysF;
        "pkg-v0.16.0-mc1.21.10" = _Qhh9kNOd;
        "pkg-v0.16.0-mc1.21.11" = _hxIppCl4;
        "pkg-v0.16.0-mc1.21.3" = _4ecaeqLM;
        "pkg-v0.16.0-mc1.21.4" = _LpgSXWbO;
        "pkg-v0.16.0-mc1.21.5" = _dDuFaa2L;
        "pkg-v0.16.0-mc1.21.8" = _ICsM5XGb;
        "pkg-v0.17.0-mc1.14.4" = _V6Jbygm1;
        "pkg-v0.17.0-mc1.15.2" = _xaSBhY6c;
        "pkg-v0.17.0-mc1.16.5" = _VVRHGO2t;
        "pkg-v0.17.0-mc1.17.1" = _EdXTlMjL;
        "pkg-v0.17.0-mc1.18.2" = _shvttsTX;
        "pkg-v0.17.0-mc1.19.4" = _oZ9PaiMo;
        "pkg-v0.17.0-mc1.20.1" = _IPp5vJ18;
        "pkg-v0.17.0-mc1.20.6" = _BnR8vpS4;
        "pkg-v0.17.0-mc1.21.1" = _H7CmZoTE;
        "pkg-v0.17.0-mc1.21.10" = _KxtdzbDQ;
        "pkg-v0.17.0-mc1.21.11" = _Mtmqjftv;
        "pkg-v0.17.0-mc1.21.3" = _TJ7nhDA1;
        "pkg-v0.17.0-mc1.21.4" = _3VGtXHLK;
        "pkg-v0.17.0-mc1.21.5" = _zh7yUVRT;
        "pkg-v0.17.0-mc1.21.8" = _yKMmnsJw;
        "pkg-v0.17.0-mc26.1-snapshot-2" = _LZv5i5EI;
        "pkg-v0.17.1-mc1.14.4" = _ktc8BcmX;
        "pkg-v0.17.1-mc1.15.2" = _uB4WhgR4;
        "pkg-v0.17.1-mc1.16.5" = _PCklNchn;
        "pkg-v0.17.1-mc1.17.1" = _IMvgL1DL;
        "pkg-v0.17.1-mc1.18.2" = _pUaQGmwZ;
        "pkg-v0.17.1-mc1.19.4" = _EDnaHwI4;
        "pkg-v0.17.1-mc1.20.1" = _w7fBDFT1;
        "pkg-v0.17.1-mc1.20.6" = _Ey4wOUH4;
        "pkg-v0.17.1-mc1.21.1" = _S6J0SxYf;
        "pkg-v0.17.1-mc1.21.10" = _kWHTEMpt;
        "pkg-v0.17.1-mc1.21.11" = _f9D3jhIc;
        "pkg-v0.17.1-mc1.21.3" = _qL8ghTqx;
        "pkg-v0.17.1-mc1.21.4" = _32koNecW;
        "pkg-v0.17.1-mc1.21.5" = _vE5tVX9w;
        "pkg-v0.17.1-mc1.21.8" = _2trXxSA9;
        "pkg-v0.17.1-mc26.1-snapshot-3" = _xMuZSDco;
        "pkg-v0.18.0-mc1.14.4" = _5LjzoQea;
        "pkg-v0.18.0-mc1.15.2" = _ri3BpiZs;
        "pkg-v0.18.0-mc1.16.5" = _dVEWNLcn;
        "pkg-v0.18.0-mc1.17.1" = _t9sxuIWo;
        "pkg-v0.18.0-mc1.18.2" = _SKWpygEh;
        "pkg-v0.18.0-mc1.19.4" = _5WPIHAEQ;
        "pkg-v0.18.0-mc1.20.1" = _gEcQD2qX;
        "pkg-v0.18.0-mc1.20.6" = _TSs4RZOb;
        "pkg-v0.18.0-mc1.21.1" = _xB3OOrij;
        "pkg-v0.18.0-mc1.21.10" = _Yo4Qgjdo;
        "pkg-v0.18.0-mc1.21.11" = _bsehmZrv;
        "pkg-v0.18.0-mc1.21.3" = _olJ4FeAh;
        "pkg-v0.18.0-mc1.21.4" = _ikRA20kC;
        "pkg-v0.18.0-mc1.21.5" = _9JYH607w;
        "pkg-v0.18.0-mc1.21.8" = _OP5WR5QE;
        "pkg-v0.18.0-mc26.1-snapshot-3" = _TIihqcrn;
        "pkg-v0.18.1-mc1.14.4" = _Nj5iG2af;
        "pkg-v0.18.1-mc1.15.2" = _hzYpeWie;
        "pkg-v0.18.1-mc1.16.5" = _Dnv2yKpe;
        "pkg-v0.18.1-mc1.17.1" = _OfOF8DR0;
        "pkg-v0.18.1-mc1.18.2" = _UsbL3y8m;
        "pkg-v0.18.1-mc1.19.4" = _25iYhU6H;
        "pkg-v0.18.1-mc1.20.1" = _9iuuSj1W;
        "pkg-v0.18.1-mc1.20.6" = _TQY9WusQ;
        "pkg-v0.18.1-mc1.21.1" = _L1HJIy3B;
        "pkg-v0.18.1-mc1.21.10" = _JM3dHeUs;
        "pkg-v0.18.1-mc1.21.11" = _er17IYmG;
        "pkg-v0.18.1-mc1.21.3" = _V0A3Ypko;
        "pkg-v0.18.1-mc1.21.4" = _TWXjV8sO;
        "pkg-v0.18.1-mc1.21.5" = _eq0gS4T5;
        "pkg-v0.18.1-mc1.21.8" = _MN0sw0TF;
        "pkg-v0.18.1-mc26.1-snapshot-3" = _DMSs58rD;
        "pkg-v0.19.0-mc1.14.4" = _22cRTqrP;
        "pkg-v0.19.0-mc1.15.2" = _uk6mS8GB;
        "pkg-v0.19.0-mc1.16.5" = _cGpRFPHE;
        "pkg-v0.19.0-mc1.17.1" = _W1EPYn66;
        "pkg-v0.19.0-mc1.18.2" = _NvvKjmvQ;
        "pkg-v0.19.0-mc1.19.4" = _s6eDb8B4;
        "pkg-v0.19.0-mc1.20.1" = _OefyOMw1;
        "pkg-v0.19.0-mc1.20.6" = _O7mgPR6W;
        "pkg-v0.19.0-mc1.21.1" = _KU40lpKa;
        "pkg-v0.19.0-mc1.21.10" = _aqEv05p1;
        "pkg-v0.19.0-mc1.21.11" = _q8fW2HmZ;
        "pkg-v0.19.0-mc1.21.3" = _fjJ9kUBV;
        "pkg-v0.19.0-mc1.21.4" = _TriMEJrh;
        "pkg-v0.19.0-mc1.21.5" = _1LmSokuc;
        "pkg-v0.19.0-mc1.21.8" = _IQ6AdMgK;
        "pkg-v0.19.0-mc26.1-snapshot-4" = _LlmKJDse;
        "pkg-v0.20.0-mc1.14.4" = _PUo0gvxV;
        "pkg-v0.20.0-mc1.15.2" = _kYUA3Ehx;
        "pkg-v0.20.0-mc1.16.5" = _larEzc2g;
        "pkg-v0.20.0-mc1.17.1" = _4n1BO8tI;
        "pkg-v0.20.0-mc1.18.2" = _PsrqLolZ;
        "pkg-v0.20.0-mc1.19.4" = _Uk7452wh;
        "pkg-v0.20.0-mc1.20.1" = _aLZrBP0Z;
        "pkg-v0.20.0-mc1.20.6" = _gnb0aSLH;
        "pkg-v0.20.0-mc1.21.1" = _KM4pDVez;
        "pkg-v0.20.0-mc1.21.10" = _rlimBqqu;
        "pkg-v0.20.0-mc1.21.11" = _2MNIDQIL;
        "pkg-v0.20.0-mc1.21.3" = _knucrilU;
        "pkg-v0.20.0-mc1.21.4" = _yVZcJchI;
        "pkg-v0.20.0-mc1.21.5" = _91IFFrnx;
        "pkg-v0.20.0-mc1.21.8" = _h3Hq2sv6;
        "pkg-v0.20.0-mc26.1-snapshot-5" = _p6mUubGg;
        "pkg-v0.20.1-mc1.14.4" = _OC0cWkyY;
        "pkg-v0.20.1-mc1.15.2" = _9q91gaBL;
        "pkg-v0.20.1-mc1.16.5" = _UxiXw3Lc;
        "pkg-v0.20.1-mc1.17.1" = _wT1cy5k4;
        "pkg-v0.20.1-mc1.18.2" = _QnqyPTf5;
        "pkg-v0.20.1-mc1.19.4" = _SXV22tP0;
        "pkg-v0.20.1-mc1.20.1" = _I2BgL07u;
        "pkg-v0.20.1-mc1.20.6" = _uQ8v5Wx4;
        "pkg-v0.20.1-mc1.21.1" = _SgVP03Ny;
        "pkg-v0.20.1-mc1.21.10" = _xiB0E50O;
        "pkg-v0.20.1-mc1.21.11" = _vMXEPDGi;
        "pkg-v0.20.1-mc1.21.3" = _xGH0LTMM;
        "pkg-v0.20.1-mc1.21.4" = _oCtiGhWd;
        "pkg-v0.20.1-mc1.21.5" = _6cRTVqAV;
        "pkg-v0.20.1-mc1.21.8" = _MJdbpIac;
        "pkg-v0.20.1-mc26.1-snapshot-7" = _yqrAUlzA;
        "pkg-v0.21.0-mc1.14.4" = _3OmnufQr;
        "pkg-v0.21.0-mc1.15.2" = _sCXfWSgd;
        "pkg-v0.21.0-mc1.16.5" = _Lk1LsDNt;
        "pkg-v0.21.0-mc1.17.1" = _kehtYeM7;
        "pkg-v0.21.0-mc1.18.2" = _yaEznFAw;
        "pkg-v0.21.0-mc1.19.4" = _Tv7JrE5q;
        "pkg-v0.21.0-mc1.20.1" = _9ZD7hKUs;
        "pkg-v0.21.0-mc1.20.6" = _VY6os9na;
        "pkg-v0.21.0-mc1.21.1" = _4HDFp6ao;
        "pkg-v0.21.0-mc1.21.10" = _pfnv7AIm;
        "pkg-v0.21.0-mc1.21.11" = _1wBghBl0;
        "pkg-v0.21.0-mc1.21.3" = _kCAGH54u;
        "pkg-v0.21.0-mc1.21.4" = _ZzFDAhmn;
        "pkg-v0.21.0-mc1.21.5" = _hX0Eanbz;
        "pkg-v0.21.0-mc1.21.8" = _Rodyj3BJ;
        "pkg-v0.21.0-mc26.1" = _bJEexEtg;
        "pkg-v0.22.0-mc1.14.4" = _YtViTfq6;
        "pkg-v0.22.0-mc1.15.2" = _ixcPiLtj;
        "pkg-v0.22.0-mc1.16.5" = _CCEOL6A4;
        "pkg-v0.22.0-mc1.17.1" = _nARfkZIE;
        "pkg-v0.22.0-mc1.18.2" = _L1AO87gD;
        "pkg-v0.22.0-mc1.19.4" = _94lOv4zj;
        "pkg-v0.22.0-mc1.20.1" = _PJEKszgF;
        "pkg-v0.22.0-mc1.20.6" = _LEa21d3H;
        "pkg-v0.22.0-mc1.21.1" = _fHXaRjNt;
        "pkg-v0.22.0-mc1.21.10" = _Jsh3lqT6;
        "pkg-v0.22.0-mc1.21.11" = _7YZTNmgJ;
        "pkg-v0.22.0-mc1.21.3" = _pRsMbaqU;
        "pkg-v0.22.0-mc1.21.4" = _HbcaSzkS;
        "pkg-v0.22.0-mc1.21.5" = _whG81CvS;
        "pkg-v0.22.0-mc1.21.8" = _7HKCuK1y;
        "pkg-v0.22.0-mc26.1.1" = _ax5nkrDQ;
        "pkg-v0.23.0-mc1.14.4" = _qxHkQn9P;
        "pkg-v0.23.0-mc1.15.2" = _zirxuKGG;
        "pkg-v0.23.0-mc1.16.5" = _Hj1iUYa5;
        "pkg-v0.23.0-mc1.17.1" = _6r5CGVXu;
        "pkg-v0.23.0-mc1.18.2" = _QvfvYqpR;
        "pkg-v0.23.0-mc1.19.4" = _DCdCoW07;
        "pkg-v0.23.0-mc1.20.1" = _5rn1jjUb;
        "pkg-v0.23.0-mc1.20.6" = _EbLpZi6S;
        "pkg-v0.23.0-mc1.21.1" = _5j60HLnZ;
        "pkg-v0.23.0-mc1.21.10" = _GcPUjilB;
        "pkg-v0.23.0-mc1.21.11" = _Li5iX2S5;
        "pkg-v0.23.0-mc1.21.3" = _6glXPkpL;
        "pkg-v0.23.0-mc1.21.4" = _LYugjxlV;
        "pkg-v0.23.0-mc1.21.5" = _supq8h8F;
        "pkg-v0.23.0-mc1.21.8" = _4FGLECTH;
        "pkg-v0.23.1-mc1.14.4" = _oI52Oaaq;
        "pkg-v0.23.1-mc1.15.2" = _uEAgCXxS;
        "pkg-v0.23.1-mc1.16.5" = _IplBL1PZ;
        "pkg-v0.23.1-mc1.17.1" = _ix6I9w2t;
        "pkg-v0.23.1-mc1.18.2" = _POSJSCDL;
        "pkg-v0.23.1-mc1.19.4" = _JctYD909;
        "pkg-v0.23.1-mc1.20.1" = _sKwSIO7x;
        "pkg-v0.23.1-mc1.20.6" = _DcPKbIul;
        "pkg-v0.23.1-mc1.21.1" = _iHVHdk0k;
        "pkg-v0.23.1-mc1.21.10" = _uLhI5F33;
        "pkg-v0.23.1-mc1.21.11" = _UJBATtYR;
        "pkg-v0.23.1-mc1.21.3" = _fsnG5neD;
        "pkg-v0.23.1-mc1.21.4" = _vw53dMrb;
        "pkg-v0.23.1-mc1.21.5" = _jEjwuAat;
        "pkg-v0.23.1-mc1.21.8" = _Y5cU0RX6;
        "pkg-v0.23.1-mc26.1.2" = _vtVnAnIt;
        "pkg-v0.23.2-mc1.14.4" = _57Ej9xPl;
        "pkg-v0.23.2-mc1.15.2" = _iPtaK6R4;
        "pkg-v0.23.2-mc1.16.5" = _o9dbaygY;
        "pkg-v0.23.2-mc1.17.1" = _5KGGE5YK;
        "pkg-v0.23.2-mc1.18.2" = _LNfOzcMF;
        "pkg-v0.23.2-mc1.19.4" = _nLec4vvo;
        "pkg-v0.23.2-mc1.20.1" = _hDpcRju1;
        "pkg-v0.23.2-mc1.20.6" = _qrN5l2lQ;
        "pkg-v0.23.2-mc1.21.1" = _AlQo6R7r;
        "pkg-v0.23.2-mc1.21.10" = _EthuOAuv;
        "pkg-v0.23.2-mc1.21.11" = _S7zYPxLK;
        "pkg-v0.23.2-mc1.21.3" = _rFgGQeLG;
        "pkg-v0.23.2-mc1.21.4" = _da6OuY8j;
        "pkg-v0.23.2-mc1.21.5" = _9iRQvJJM;
