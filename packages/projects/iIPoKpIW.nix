...
let
    ...
    in {
        ...
        "pkg-1.17.1-v1.0.0" = _hE5Wyk72;
        "pkg-1.18.2-v1.0.0" = _uLpGuFSV;
        "pkg-1.19.4-v1.0.0" = _XghhuNwh;
        "pkg-1.17.1-v1.1.0" = _pl9x9Sy2;
        "pkg-1.18.2-v1.1.0" = _OM3K4T2E;
        "pkg-1.19.4-v1.1.0" = _2D5ch7Me;
        "pkg-1.17.1-v1.2.0" = _71bXkvOD;
        "pkg-1.18.2-v1.2.0" = _PRR5Y6vv;
        "pkg-1.19.4-v1.2.0" = _ZcTCjDBg;
        "pkg-1.17.1-v1.2.1" = _LtcuzVC3;
        "pkg-1.18.2-v1.2.1" = _YF80Fusl;
        "pkg-1.19.4-v1.2.1" = _PAj1Z1La;
        "pkg-1.17.1-v1.2.2" = _IMmhgOJg;
        "pkg-1.18.2-v1.2.2" = _onoUtwCl;
        "pkg-1.19.4-v1.2.2" = _JkamjWgM;
        "pkg-1.17.1-v1.3.0" = _aq8HQaHB;
        "pkg-1.18.2-v1.3.0" = _MWmO2EDR;
        "pkg-1.19.4-v1.3.0" = _6IttiNHQ;
        "pkg-1.17.1-v1.3.1" = _XxJPZfbQ;
        "pkg-1.18.2-v1.3.1" = _gTYzlhxs;
        "pkg-1.19.4-v1.3.1" = _UraVO4lZ;
        "pkg-1.20.2-v1.3.1" = _4YBtFP61;
        "pkg-.20.6-v1.3.1" = _D9pItZ5E;
        "pkg-.21.1-v1.3.1" = _AuVuotcF;
        "pkg-2.0.0" = _vC185BsJ;
        "pkg-2.1.0" = _rJ8Dt6H4;
        "pkg-2.2.0" = _gte8A81q;
        "pkg-2.2.1" = _v2fVZRt0;
