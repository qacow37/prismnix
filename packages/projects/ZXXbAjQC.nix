...
let
    ...
    in {
        ...
        "pkg-1.4.2" = _YCHU8oDX;
        "pkg-1.4.3" = _fiv5RieO;
        "pkg-1.4.3.1" = _xM3Bu6RN;
        "pkg-1.5.1" = _bB9loCFN;
        "pkg-1.5.2" = _Ud4dY9GE;
        "pkg-1.5.3" = _PVQac3bG;
        "pkg-2.0.0" = _flfsLBLh;
        "pkg-2.1.1.1" = _bpnX2moO;
        "pkg-2.2.0" = _v6m4tCVb;
        "pkg-2.2.1" = _TZyujMDG;
        "pkg-2.2.2" = _yn2z7doT;
        "pkg-2.2.3.1" = _5KhXLEJz;
        "pkg-1.9.2-neoforge-dev" = _CNI4fzCk;
        "pkg-2.0.0-neoforge-dev" = _N470kfyM;
        "pkg-2.0.1-neoforge-dev" = _pQxshtiR;
        "pkg-2.0.2-neoforge-dev" = _uCNdWNPH;
        "pkg-2.3.0" = _LvrLrNv8;
        "pkg-2.0.3-neoforge-dev" = _vom2chcp;
        "pkg-2.0.4-neoforge-dev" = _JrTHksB3;
        "pkg-2.3.1" = _zrnJZhmH;
        "pkg-2.0.5-neoforge-dev" = _TXA17nKP;
        "pkg-2.0.7-neoforge-dev" = _jWkBjwjS;
        "pkg-2.4.2" = _GcjZVZOk;
        "pkg-2.0.8-neoforge-dev" = _RFURVwzG;
        "pkg-2.4.5" = _fTSvkWkY;
        "pkg-2.6.0.1" = _fdRAwf5M;
        "pkg-2.6.0-neoforge-beta" = _oTa6PVtQ;
        "pkg-2.7.0-beta" = _pmppkr5f;
        "pkg-2.7.0-neoforge-beta" = _Ui74NaKs;
        "pkg-2.7.0.1-beta" = _yA7Xzeh7;
        "pkg-2.7.0.2-beta" = _PIjNwMz8;
        "pkg-2.7.0.2-neoforge-beta" = _UHyWjd4Z;
        "pkg-2.7.0.3-neoforge-beta" = _fHnmUyWn;
        "pkg-2.7.1-beta" = _YAS8JRAI;
        "pkg-2.7.1-neoforge-beta" = _DV1pHLE3;
        "pkg-2.8.0-neoforge-beta" = _AqdoS1MF;
        "pkg-3.0.0" = _P0goQLth;
        "pkg-3.1.0-neoforge" = _WMvDV42l;
        "pkg-3.1.0" = _S1KYLWKo;
        "pkg-3.1.0.1-neoforge" = _zvkfKz5F;
        "pkg-3.3.1" = _Dwb2KKkU;
