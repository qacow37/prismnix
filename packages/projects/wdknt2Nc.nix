...
let
    ...
    in {
        ...
        "pkg-1.1+MC1.18" = _svt9ttkm;
        "pkg-1.1.1+MC1.18-1.18.1" = _sVCHaNRt;
        "pkg-1.1.2+MC1.18.2" = _2TMPKzQ4;
        "pkg-1.1.3+MC1.19" = _LxYoLMt8;
        "pkg-1.1.5+MC1.19-1.19.1" = _ZMg4dCj3;
        "pkg-1.1.6+MC1.19-1.19.2" = _t3HgW82x;
        "pkg-1.1.7+MC1.19-1.19.2" = _cKPb8ahP;
        "pkg-1.1.8+MC1.19.3-1.19.4" = _uEj8LSCO;
        "pkg-1.1.9+MC1.20-1.20.1" = _WjZr8VaQ;
        "pkg-1.1.10+MC1.20.2" = _24VBoMWx;
        "pkg-1.1.11+MC1.20.2-1.20.4" = _kLovHlAI;
        "pkg-1.1.12+MC1.20.2-1.20.4" = _7dU0cXzo;
        "pkg-1.1.13+MC1.20-1.20.1" = _vx6PH2qq;
        "pkg-1.1.13+MC1.20.2-1.20.4" = _fiiKGlF4;
        "pkg-1.1.14+MC1.20.2-1.20.5" = _DtCYrHJG;
        "pkg-1.1.15+MC1.20.2-1.20.6" = _4Y0Gz3Xb;
        "pkg-1.2.0+MC1.21" = _xyn5qTP9;
        "pkg-1.2.1+MC1.21" = _ET3ttJib;
        "pkg-1.2.2+MC1.21-1.21.1" = _75mMwUGv;
        "pkg-1.3.0+MC1.21.2-1.21.4" = _p8958KQs;
        "pkg-1.4.0+MC1.21.5" = _ERGRTUu9;
        "pkg-1.4.1+MC1.21.5-1.21.6" = _COU7WVQq;
        "pkg-1.4.2+MC1.21.5-1.21.7" = _coZ6jKYb;
        "pkg-1.4.3+MC1.21.5-1.21.8" = _yIQWHav8;
        "pkg-1.5.0+MC1.21.9-1.21.10" = _Br2soOqt;
        "pkg-1.4.4+MC1.21.5-1.21.8" = _rZtxD9ow;
        "pkg-1.5.1+MC1.21.9-1.21.10" = _VcqpUOVA;
