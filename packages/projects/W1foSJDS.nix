...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19.2" = _Lu5xkaaS;
        "pkg-1.0.0+1.18.2-1.19.2" = _PtesSAlB;
        "pkg-1.0.1+1.18.2" = _ntlFSDMJ;
        "pkg-1.0.1+1.19.2" = _4Ueco6Xy;
        "pkg-1.1.0+1.19.2" = _2zJuZYAE;
        "pkg-1.2.0+1.19.2" = _TZtFL0CL;
        "pkg-1.2.1+1.19.2" = _ejATIUrQ;
        "pkg-1.2.2+1.19.2" = _9s1ONeoq;
        "pkg-1.2.2+1.19.3" = _ruREM3te;
        "pkg-1.2.2+1.19.4" = _dNWLG3Mo;
        "pkg-1.2.2+1.20" = _z0nf1MJR;
        "pkg-1.2.4+1.19.2" = _W9Mdh2ho;
        "pkg-1.2.4+1.19.3" = _T44f64V3;
        "pkg-1.2.4+1.19.4" = _NdXrGtAj;
        "pkg-1.2.4+1.20" = _uprFHCoN;
        "pkg-1.2.5+1.19.2" = _X5OF7hn5;
        "pkg-1.2.5+1.19.3" = _kcvMIBLD;
        "pkg-1.2.5+1.19.4" = _I6PJ6wpY;
        "pkg-1.2.5+1.20" = _HOzLg1EP;
        "pkg-1.2.5+1.18.2" = _wyr4YXTR;
        "pkg-1.2.7+1.18" = _J0TFhjwn;
        "pkg-1.2.7+1.19" = _sSi13Elm;
        "pkg-1.2.7+1.20" = _z11cHkVt;
        "pkg-1.2.7+1.21" = _i7dG9qla;
        "default" = _i7dG9qla;
    });
