...
let
    ...
    in {
        ...
        "pkg-1.0.6" = _7TBbpRbe;
        "pkg-1.0.7" = _L7UNHCIl;
        "pkg-1.21.1-neoforge-1.0.8" = _dvvmNdOS;
        "pkg-1.21.1-neoforge-1.0.9" = _k8hoLlqt;
        "pkg-1.20.1-forge-1.0.9" = _kYtWHca6;
        "pkg-1.21.1-neoforge-1.1.0" = _Bir2gnNP;
        "pkg-1.20.1-forge-1.1.0" = _JBe5OWbw;
        "pkg-1.1.1" = _zkjeRiwf;
        "pkg-1.1.2-1.21.1-neoforge" = _1lkawT4u;
        "pkg-1.1.2-1.20.1-forge" = _ueCNdyUK;
        "pkg-1.1.3-1.21.1-neoforge" = _h8UWOmtB;
        "pkg-1.1.3-1.20.1-forge" = _3NVVHqF8;
        "pkg-1.1.4-1.21.1-neoforge" = _P6M9mwVF;
        "pkg-1.1.4-1.20.1-forge" = _3qiTt5ar;
        "pkg-1.1.5-1.21.1-neoforge" = _vNGFCKAg;
        "pkg-1.1.5-26.1.2-neoforge" = _KYNs5kxx;
        "pkg-1.1.5-1.20.1-forge" = _gnBZi8mD;
        "pkg-1.1.6-1.21.1-neoforge" = _k444ySGT;
