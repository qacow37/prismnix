...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _U090sb8j;
        "pkg-1.2.0" = _gGPKJvDO;
        "pkg-1.2.1+06d85ae3" = _jA1eNDsY;
        "pkg-1.2.2+c3c4ee24" = _Iv9wvknb;
        "pkg-1.2.2" = _ELcfRlhN;
        "pkg-1.2.3+e8e172fb" = _L4PV1kAz;
        "pkg-1.2.3" = _2xFPXC8u;
        "pkg-1.2.4+0e437f1f" = _K328m8ph;
        "pkg-1.2.4+b91c901d" = _nJmn6JAH;
        "pkg-1.2.4+f9c58448" = _b3Ol4JXr;
        "pkg-1.2.4+2c01614d" = _QMtvzo2W;
        "pkg-1.3.0" = _D1Uu9xIB;
        "pkg-1.4.0+12ad5c7c" = _2s6NxOIn;
        "pkg-1.4.0+ccc315b2" = _LFNB5GU4;
        "pkg-1.4.0+0ac22c44" = _ATOfbKPf;
        "pkg-1.4.0+157cddc9" = _WzpHHObV;
        "pkg-1.4.0+6a84368d" = _URPXTyf2;
        "pkg-1.4.0+3b9279c5" = _fHIWnmXA;
        "pkg-1.4.0+bd177c8e" = _7PnyE8oc;
        "pkg-1.4.0+fa28238a" = _xKFBR0yc;
        "pkg-1.4.0+912ba2da" = _MnXRwmU6;
        "pkg-1.5.0+3a79d189" = _vhplqJym;
        "pkg-1.5.0+2d869e03" = _on0mlAN4;
        "pkg-1.5.0+c1856e59" = _fNWeRgd6;
        "pkg-1.5.0+101039fb" = _fWTzUWr9;
        "pkg-1.5.0" = _rhcHQwnS;
        "pkg-2.0.0+78858d18" = _6Kmnm0Y7;
        "pkg-2.0.0+2c5f5142" = _5sD4DRHi;
        "default" = _5sD4DRHi;
    });
