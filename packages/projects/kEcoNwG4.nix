...
let
    ...
    in {
        ...
        "pkg-0.5.3" = _xvMYNUYh;
        "pkg-0.6" = _bGjN7GLK;
        "pkg-0.6+mod" = _WbvMR4ac;
        "pkg-0.6.1" = _oHSWlhdh;
        "pkg-0.6.1+mod" = _5E4lNB0v;
        "pkg-0.6.2" = _7sngce47;
        "pkg-0.6.2+mod" = _5Yj9Ucrq;
        "pkg-0.1.0" = _2fWvZVJi;
        "pkg-0.1.0+mod" = _Y0bQjK4v;
        "pkg-0.2" = _9UH6TK1n;
        "pkg-0.2+mod" = _moN0nDMq;
        "pkg-Beta-0.2.4" = _5Ly4e1O6;
        "pkg-Beta-0.2.4+mod" = _rJFWpXrK;
        "pkg-Beta-0.2.5" = _5blaTlJK;
        "pkg-Beta-0.2.5+mod" = _OuABXDsq;
        "pkg-Beta-0.2.6" = _OXPEqdJO;
        "pkg-Beta-0.2.6-Unsupported" = _TZyF18c3;
        "pkg-Beta-03.0" = _tb1AgvS7;
        "pkg-Beta-03.0+mod" = _ZMwuyYAD;
        "pkg-Beta-0.3.4" = _MDbpQMfs;
        "pkg-Beta-0.3.4+mod" = _g1HooUfl;
        "pkg-Beta-0.3.5" = _kT4ciZ9m;
        "pkg-Beta-0.3.6" = _jyuxC3E0;
        "pkg-Beta-0.3.7" = _xpzKwnDI;
        "pkg-Beta-0.3.8" = _6jm7ucru;
        "pkg-beta-0.3.9" = _cRvIMC5b;
        "pkg-Beta-0.4.0" = _mc9jrtu4;
        "pkg-Beta-0.4.1" = _upcEvaaR;
        "pkg-Beta-0.4.2" = _RQgUHxgy;
        "pkg-Beta-0.5.0" = _Cj1RECpE;
        "pkg-Beta-0.6.0" = _pemUpulF;
        "pkg-Beta-0.6.1" = _LXdxKa3Q;
        "pkg-Beta-0.6.3" = _h5bc0JFt;
        "default" = _h5bc0JFt;
    });
