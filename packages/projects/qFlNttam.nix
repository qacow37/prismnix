...
let
    ...
    in {
        ...
        "pkg-2.7.0" = _SKde017I;
        "pkg-2.7.1" = _a1fzV7ME;
        "pkg-2.7.2+1.21.10" = _mxNPXKKS;
        "pkg-2.7.2+1.21.11" = _C4Wm7OaO;
        "pkg-2.7.3+26.1" = _1ades4DQ;
        "pkg-2.7.3+26.1.1" = _taHyaW82;
        "pkg-2.7.4+26.1" = _BqM9DRHg;
        "pkg-2.7.4+26.1.1" = _rwE0Vazm;
        "pkg-2.7.4+26.1.2" = _iVnCmcOX;
        "pkg-2.7.4+26.2" = _p71kPQ66;
        "default" = _p71kPQ66;
    });
