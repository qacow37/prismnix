...
let
    ...
    in {
        ...
        "pkg-9.0.480+forge" = _vqTYXVGW;
        "pkg-9.0.482+forge" = _92NctcEy;
        "pkg-8.2.481+forge" = _K06sxswL;
        "pkg-8.2.483+forge" = _Pi79wDrk;
        "pkg-9.0.484+forge" = _Ylo1fV0a;
        "pkg-8.2.485+forge" = _7vaQjXon;
        "pkg-9.0.486+forge" = _ltelSW3A;
        "pkg-9.0.488+forge" = _9ofYPdpt;
        "pkg-8.2.487+forge" = _ZiKI4UHc;
        "pkg-9.0.489+forge" = _xMslkKkL;
        "pkg-8.2.490+forge" = _vD9fjwoX;
        "pkg-9.0.491+forge" = _cCH2VRM4;
        "pkg-8.2.492+forge" = _UzSOi07I;
        "pkg-9.0.493+forge" = _lOlZuytF;
        "pkg-8.3.494+forge" = _QEG0RGzC;
        "pkg-8.3.495+forge" = _ojxB5t4S;
        "pkg-8.3.497+forge" = _oVMbrcy0;
        "pkg-8.3.498+forge" = _DIpTlOGa;
        "pkg-9.1.499+forge" = _6bFm7ksE;
        "pkg-9.1.500+forge" = _3uORdWKN;
        "pkg-8.3.501+forge" = _YzI77IDM;
        "pkg-8.3.502+forge" = _6CHxlvon;
        "pkg-9.1.503+forge" = _ESk0nlyN;
        "pkg-9.1.504+forge" = _T1l6tbqT;
        "pkg-9.1.509+forge" = _cBcomVct;
        "pkg-8.3.508+forge" = _IpVwN8j8;
        "pkg-8.3.510+forge" = _klE1ECfc;
        "pkg-9.1.511+forge" = _puePavXQ;
        "pkg-9.1.514+forge" = _yfEiPboG;
        "pkg-9.1.517+forge" = _JEo0rCFA;
        "pkg-9.1.518+forge" = _a0nhSo1Q;
        "pkg-8.3.519+forge" = _9D1wJYxO;
        "pkg-9.1.520+forge" = _MS01firm;
        "pkg-9.1.522+forge" = _7tpJRbNX;
        "pkg-8.3.521+forge" = _NLvf5AJ0;
        "pkg-9.1.524+forge" = _pPdpWJrE;
        "pkg-9.1.526+forge" = _wpuwbir8;
        "pkg-8.3.525+forge" = _iGf2nNL5;
        "pkg-9.1.528+forge" = _gGQqbY4H;
        "pkg-8.3.527+forge" = _KXLZaQQ7;
        "pkg-9.1.530+forge" = _uzJBV3sA;
        "pkg-8.3.529+forge" = _9hVVzgbo;
        "pkg-9.1.537+forge" = _3QUWCjpT;
        "pkg-8.3.542+forge" = _GAO6kcIw;
        "pkg-8.3.543+forge" = _DhLKbzgM;
        "pkg-9.1.544+forge" = _DceS548O;
        "pkg-8.3.545+forge" = _VASHFURB;
        "pkg-9.1.546+forge" = _61tL6xdK;
        "pkg-9.1.548+forge" = _O1vdIqxd;
        "pkg-8.3.547+forge" = _RP3fv3G7;
        "pkg-9.1.550+forge" = _9FKqAFYu;
        "pkg-8.3.549+forge" = _Zj0ZK1LK;
        "pkg-8.3.551+forge" = _d70ksFIH;
        "pkg-9.1.552+forge" = _Ged2MEVg;
        "pkg-9.1.554+forge" = _YBzESlMQ;
        "pkg-8.3.553+forge" = _LxpISnor;
        "pkg-9.1.555+forge" = _2hDNDl10;
        "pkg-8.3.556+forge" = _SFQOXrQJ;
        "pkg-8.3.557+forge" = _FpIfVqzU;
        "pkg-9.1.558+forge" = _jFM0VpnA;
        "pkg-9.1.560+forge" = _BuPJpb4D;
        "pkg-8.3.559+forge" = _hglKMgm6;
        "pkg-9.1.562+forge" = _fFyraiv2;
        "pkg-8.3.561+forge" = _7cyEEXjz;
        "pkg-8.3.563+forge" = _eEDtye6T;
        "pkg-8.3.564+forge" = _p0Kt9vHy;
        "pkg-9.1.565+forge" = _kzZpEvpT;
        "pkg-8.3.566+forge" = _rt7uKdGv;
        "pkg-8.3.567+forge" = _kJuSkDPP;
        "pkg-9.1.568+forge" = _AFDryqOU;
        "pkg-8.3.569+forge" = _CZP14tW6;
        "pkg-9.1.570+forge" = _TCTkLsmd;
        "pkg-9.1.572+forge" = _UMsaWabA;
        "pkg-8.3.571+forge" = _5KcgFJnl;
        "pkg-9.1.574+forge" = _rDumveEQ;
        "pkg-8.3.573+forge" = _tmuKkYD4;
        "pkg-9.1.577+forge" = _rGJHj95t;
        "pkg-8.3.576+forge" = _T1YWUr1P;
        "pkg-10.0.578+forge" = _v9OMzoDv;
        "pkg-8.3.579+forge" = _JMMKVLVt;
        "pkg-9.1.580+forge" = _s85RCOqJ;
        "pkg-10.0.581+forge" = _6KiCXMzQ;
        "pkg-8.3.582+forge" = _1uzNk7Ac;
        "pkg-8.3.583+forge" = _U8ZxFztO;
        "pkg-8.3.584+forge" = _kFT8Q9dy;
        "pkg-9.1.585+forge" = _v5HzJdDf;
        "pkg-10.0.586+forge" = _4qdxQWSa;
        "pkg-8.3.588+forge" = _YBecgVD8;
        "pkg-9.1.587+forge" = _2DpjyK4y;
        "pkg-9.1.591+forge" = _1AYRWQXf;
        "pkg-8.3.590+forge" = _KhZLGnWu;
        "pkg-10.0.592+forge" = _QOlslu37;
        "pkg-11.0.593+forge" = _QVjDS4Z7;
        "pkg-8.3.594+forge" = _Z76w5mpI;
        "pkg-9.1.595+forge" = _vcYFi7uq;
        "pkg-10.0.596+forge" = _2Zq6TzYW;
        "pkg-11.0.597+forge" = _XRxdXckN;
        "pkg-9.1.601+forge" = _cPfKEtYv;
        "pkg-8.3.600+forge" = _nJo0YBZy;
        "pkg-10.0.602+forge" = _LGDoT1fV;
        "pkg-11.0.603+forge" = _43PuI6JX;
        "pkg-10.0.606+forge" = _iSlTAiab;
        "pkg-8.3.604+forge" = _kKFf8yXM;
        "pkg-9.1.605+forge" = _6MfDaNSx;
        "pkg-11.0.607+forge" = _lkomhm2d;
        "pkg-10.0.611+forge" = _p6ixD5lo;
        "pkg-9.1.610+forge" = _w0uDmKi8;
        "pkg-8.3.608+forge" = _I8khRkVL;
        "pkg-11.0.612+forge" = _EWfHxOP2;
        "pkg-8.3.614+forge" = _OJ1jrDPP;
        "pkg-10.0.616+forge" = _ElJnVZP2;
        "pkg-9.1.615+forge" = _Zuuv2jTk;
        "pkg-11.0.617+forge" = _YfuVBXN1;
        "pkg-10.0.620+forge" = _QPPP82yQ;
        "pkg-9.1.619+forge" = _kxoyIG9D;
        "pkg-11.0.621+forge" = _KPyMbewy;
        "pkg-8.3.618+forge" = _e5Hhxb7r;
        "pkg-12.0.623+forge" = _Iog4LW4V;
        "pkg-12.0.624+forge" = _v2x1yNHn;
        "pkg-12.0.625+forge" = _texLJ7gz;
        "pkg-12.0.626+forge" = _VxeoipEz;
        "pkg-9.1.628+forge" = _xE1SludQ;
        "pkg-8.3.627+forge" = _fIsMNv8T;
        "pkg-12.0.630+forge" = _g4ywjoiB;
        "pkg-11.0.629+forge" = _SSnRl2nn;
        "pkg-8.3.631+forge" = _yJ7y9plh;
        "pkg-9.1.632+forge" = _ECjFhqe7;
        "pkg-11.0.633+forge" = _Ou38MAdq;
        "pkg-12.0.634+forge" = _XS5Fh0vG;
        "pkg-8.3.635+forge" = _rPQH4woK;
        "pkg-9.1.636+forge" = _WGnMmECe;
        "pkg-11.0.637+forge" = _Tapry0KP;
        "pkg-12.0.638+forge" = _1FSEClB0;
        "pkg-8.3.639+forge" = _cpK4Wp8f;
        "pkg-8.3.640+forge" = _8Ej9Skf2;
        "pkg-9.1.641+forge" = _vBFIFijq;
        "pkg-11.0.644+forge" = _La3fF0yd;
        "pkg-9.1.643+forge" = _rretgV4r;
        "pkg-12.0.645+forge" = _iEwpgPps;
        "pkg-8.3.642+forge" = _Hu5oLmx5;
        "pkg-12.0.648+forge" = _4gMrt5ay;
        "pkg-11.0.647+forge" = _F6uvOcdr;
        "pkg-10.0.646+forge" = _j18xeRbg;
        "pkg-8.3.649+forge" = _3D9cyakw;
        "pkg-9.1.650+forge" = _1Gyx9mbg;
        "pkg-11.0.651+forge" = _afC4VMaR;
        "pkg-12.0.652+forge" = _5PEhNnj5;
        "pkg-8.3.656+forge" = _QCxSKTiX;
        "pkg-9.1.657+forge" = _tpLVJu00;
        "pkg-11.0.658+forge" = _O3Sz1u4w;
        "pkg-12.0.659+forge" = _yEFaLm9F;
        "pkg-11.0.664+forge" = _1xha7zyw;
        "pkg-8.3.662+forge" = _cmfTpPki;
        "pkg-9.1.663+forge" = _bkVGHHH9;
        "pkg-12.0.665+forge" = _iZRjTztS;
        "pkg-8.3.667+forge" = _RDCULV7P;
        "pkg-9.1.668+forge" = _y9wrACm8;
        "pkg-11.0.669+forge" = _vMxflm4f;
        "pkg-13.0.671+forge" = _QXtjf0P2;
        "pkg-12.0.670+forge" = _OwSxQuCR;
        "pkg-12.0.672+forge" = _n5B2KCKG;
        "pkg-11.0.673+forge" = _F0EOR0oq;
        "pkg-12.0.674+forge" = _cVvBc304;
        "pkg-13.0.675+forge" = _mHpoxik4;
        "pkg-13.0.678+forge" = _RFHfXyNA;
        "pkg-13.0.678+neoforge" = _6fUgHx0w;
        "pkg-13.0.679+forge" = _NqwW7BnZ;
        "pkg-13.0.679+neoforge" = _xABm6TfJ;
        "pkg-14.0.680+neoforge" = _TMOpXjOF;
        "pkg-8.3.681+forge" = _hcLYVPyV;
        "pkg-9.1.682+forge" = _LmFYvWjd;
        "pkg-11.0.683+forge" = _QCMoLJ2D;
        "pkg-12.0.684+forge" = _grmPXT7i;
        "pkg-13.0.685+forge" = _LvwR35T5;
        "pkg-13.0.685+neoforge" = _rhtkStEK;
        "pkg-14.0.687+forge" = _YZixGxtC;
        "pkg-14.0.688+forge" = _UqJEvrFT;
        "pkg-14.0.688+neoforge" = _s0rJCPA3;
        "pkg-14.0.692+forge" = _IcMSSyAj;
        "pkg-14.0.692+neoforge" = _bGvFKsBs;
        "pkg-14.0.699+forge" = _naEHb2bm;
        "pkg-14.0.699+neoforge" = _UYCt913y;
        "pkg-8.3.694+forge" = _f0Gpv9Lc;
        "pkg-11.0.696+forge" = _trexoN6H;
        "pkg-9.1.695+forge" = _TWsYbrFH;
        "pkg-13.0.698+forge" = _FJkjRnvI;
        "pkg-13.0.698+neoforge" = _eDCUKptT;
        "pkg-12.0.697+forge" = _gDJDZsJp;
        "pkg-9.2.703+forge" = _mgV22cC7;
        "pkg-12.1.705+forge" = _Uhi3vbJF;
        "pkg-11.1.704+forge" = _yArmXGNt;
        "pkg-14.1.707+forge" = _VChSOTCL;
        "pkg-14.1.707+neoforge" = _H3LCsp0b;
        "pkg-8.4.702+forge" = _fmNXNiDk;
        "pkg-13.1.706+forge" = _xRufRgKn;
        "pkg-13.1.706+neoforge" = _TmCIzrVq;
        "pkg-14.1.708+forge" = _5M1ieyCb;
        "pkg-14.1.708+neoforge" = _v15SBCkR;
        "pkg-9.2.710+forge" = _zlNHTok6;
        "pkg-8.4.709+forge" = _cBkvwRwc;
        "pkg-11.1.711+forge" = _v10gUdmz;
        "pkg-14.1.714+forge" = _SktZafiV;
        "pkg-14.1.714+neoforge" = _wVb0gClA;
        "pkg-12.1.712+forge" = _F2zen9Jn;
        "pkg-13.1.713+forge" = _bwwAOdO7;
        "pkg-13.1.713+neoforge" = _7dfgjviP;
        "pkg-12.1.718+forge" = _2wuTCzEs;
        "pkg-9.2.716+forge" = _vvsmq5vF;
        "pkg-11.1.717+forge" = _jH014DhB;
        "pkg-8.4.715+forge" = _5s7WEIXi;
        "pkg-14.1.720+forge" = _sN8mzOB4;
        "pkg-14.1.720+neoforge" = _cTlKdV6x;
        "pkg-13.1.719+forge" = _OVBj6Tar;
        "pkg-13.1.719+neoforge" = _QmDqczJL;
        "pkg-15.0.722+neoforge" = _5umnxHLx;
        "pkg-14.1.727+forge" = _upFWYcVr;
        "pkg-14.1.727+neoforge" = _VQFy1aej;
        "pkg-9.2.724+forge" = _dNl39uLN;
        "pkg-13.1.726+forge" = _JzkJsvxL;
        "pkg-15.0.728+neoforge" = _fJ7Rc4lz;
        "pkg-13.1.726+neoforge" = _9CYWEioU;
        "pkg-8.4.723+forge" = _Lq6h6RZO;
        "pkg-12.1.725+forge" = _VvR2jxYh;
        "pkg-16.0.729+neoforge" = _Gp7FdNjM;
        "pkg-8.4.737+forge" = _7LgypFhh;
        "pkg-9.2.738+forge" = _dcOuyBrY;
        "pkg-12.1.740+forge" = _Us5GhxIj;
        "pkg-11.1.739+forge" = _RCOUNx5J;
        "pkg-16.0.744+neoforge" = _3pR1feNL;
        "pkg-13.1.741+forge" = _Mkz9PhIM;
        "pkg-13.1.741+neoforge" = _5yqNKf94;
        "pkg-14.1.742+forge" = _HFeCZyyq;
        "pkg-14.1.742+neoforge" = _Ptp9w2ii;
        "pkg-15.0.743+neoforge" = _JsnOhjHb;
        "pkg-12.1.745+forge" = _JsbV2A8s;
        "pkg-12.1.750+forge" = _87asecXH;
        "pkg-13.1.751+forge" = _8gdExVgF;
        "pkg-13.1.751+neoforge" = _XoeVFtWU;
        "pkg-14.1.752+forge" = _mR5IuhVP;
        "pkg-14.1.752+neoforge" = _E11YYwjz;
        "pkg-15.0.753+neoforge" = _lqeeRK02;
        "pkg-16.0.754+neoforge" = _XLFwNaPs;
        "pkg-8.4.755+forge" = _HYp2BUIl;
        "pkg-9.2.756+forge" = _MRN7cEPt;
        "pkg-11.1.757+forge" = _Xjm9MjrZ;
        "pkg-12.1.758+forge" = _E04wTkFn;
        "pkg-15.0.761+neoforge" = _bn0MQ3ny;
        "pkg-13.1.759+forge" = _it7EMKOk;
        "pkg-13.1.759+neoforge" = _OJ0bCs2w;
        "pkg-16.0.762+neoforge" = _BP16w9mH;
        "pkg-14.1.760+forge" = _I2S6DdQw;
        "pkg-14.1.760+neoforge" = _xLkl9y1J;
        "pkg-9.2.766+forge" = _MZ2J27pH;
        "pkg-8.4.765+forge" = _wi6MxKdc;
        "pkg-11.1.767+forge" = _Pqs9TX5K;
        "pkg-12.1.770+forge" = _vL7cnnin;
        "pkg-11.1.769+forge" = _lpBlwbav;
        "pkg-13.1.771+forge" = _orohwfVH;
        "pkg-13.1.771+neoforge" = _i9Wmt8eH;
        "pkg-13.1.773+forge" = _UgGG3C3C;
        "pkg-13.1.773+neoforge" = _2FIqLxCT;
        "pkg-14.1.774+forge" = _NEeyBxGV;
        "pkg-14.1.774+neoforge" = _h1vMvdl9;
        "pkg-15.0.775+neoforge" = _z38uHjSG;
        "pkg-16.0.776+neoforge" = _JKEgvc9s;
        "pkg-16.0.777+neoforge" = _yclWAKLr;
        "pkg-9.2.779+forge" = _B61NC6oD;
        "pkg-12.1.780+forge" = _zWvoSZOe;
        "pkg-8.4.778+forge" = _Ct0fNUX6;
        "pkg-15.0.782+neoforge" = _8eZ6vgP5;
        "pkg-16.0.783+neoforge" = _NZBK4XiI;
        "pkg-14.1.781+forge" = _X4g0mlzT;
        "pkg-14.1.781+neoforge" = _4BlClD6M;
        "pkg-12.1.785+forge" = _eVGbaFoc;
        "pkg-9.2.784+forge" = _oA83BkSW;
        "pkg-14.1.786+forge" = _YOMrdjGx;
        "pkg-14.1.786+neoforge" = _FHpF5ww5;
        "pkg-17.0.789+neoforge" = _lsQhf50O;
        "pkg-16.0.788+neoforge" = _ej1yrOvr;
        "pkg-15.0.787+neoforge" = _hYXE9XkX;
        "pkg-17.0.790+neoforge" = _JLn6fulc;
        "pkg-17.0.791+neoforge" = _G1AofFHH;
        "pkg-17.0.792+neoforge" = _9xpXak0B;
        "pkg-17.0.793+neoforge" = _HbbCoxjW;
        "pkg-17.0.794+neoforge" = _n9y6yGCo;
        "pkg-18.0.795+neoforge" = _wESF30su;
        "pkg-18.0.796+neoforge" = _99MjZMdp;
        "pkg-16.0.797+neoforge" = _YuJhorod;
        "pkg-16.0.799+neoforge" = _RWm3RYcq;
        "pkg-18.0.798+neoforge" = _oJxsydaX;
        "pkg-18.0.800+neoforge" = _LWeHvi5z;
        "pkg-18.0.804+neoforge" = _HrwoVYnI;
        "pkg-17.0.803+neoforge" = _VSklHSnn;
        "pkg-19.0.805+neoforge" = _XWNzOBz7;
        "pkg-19.0.806+neoforge" = _V6R6VYkO;
        "pkg-17.0.807+neoforge" = _i2ChSg8T;
        "pkg-18.0.808+neoforge" = _eYD2pPw9;
        "pkg-19.0.809+neoforge" = _1FtRuKh3;
        "pkg-20.0.810+neoforge" = _jnTYRFTr;
        "pkg-20.0.811+neoforge" = _Jx9ShdQH;
        "pkg-21.9.812+neoforge" = _inl68BOB;
        "pkg-21.9.813+neoforge" = _ACZK2sdV;
        "pkg-21.11.814+neoforge" = _NzFofUXo;
        "pkg-18.0.815+neoforge" = _VKJZna7W;
        "pkg-21.11.816+neoforge" = _LUoMUGJQ;
