...
let
    ...
    in {
        ...
        "pkg-1.18.1-0-fabric" = _cT2w1zCe;
        "pkg-1.18.2-0-fabric" = _FKFYJMAm;
        "pkg-1.19-0-fabric" = _VS9GrMM9;
        "pkg-1.19.1-0-fabric" = _P3MyToDz;
        "pkg-1.19.2-0-fabric" = _iErSvO8n;
        "pkg-1.19.3-0-fabric" = _7o1tTjBq;
        "pkg-1.19.4-0-fabric" = _ieDSsXMU;
        "pkg-1.20-0-fabric" = _fLZSjlKA;
        "pkg-1.20.1-0-fabric" = _k1y6cyA2;
        "pkg-1.20.2-0-fabric" = _rxgd2GYh;
        "pkg-1.20.3-0-fabric" = _GhlJqIf6;
        "pkg-1.20.4-0-fabric" = _5o3tKDkB;
        "pkg-1.16.5-0" = _L0mI3AU9;
        "pkg-1.18.2-0" = _XTHpvzlb;
        "pkg-1.19-0-forge" = _P4xMqqxv;
        "pkg-1.19.1-0-forge" = _7s90ss5Z;
        "pkg-1.19.2-0-forge" = _Sbh57H89;
        "pkg-1.19.3-0-forge" = _gkL7AkHG;
        "pkg-1.19.4-0-forge" = _kt4KtU38;
        "pkg-1.20-0-forge" = _kc0QiRUx;
        "pkg-1.20.1-0-forge" = _yq180ZxB;
        "pkg-1.20.2-0-forge" = _GL5VvgYK;
        "pkg-1.20.3-0-forge" = _C20qEtHc;
        "pkg-1.20.4-0-forge" = _dZakz46M;
        "pkg-1.20.4-0-neoforge" = _16q97wmi;
        "pkg-1.20.5-0-fabric" = _9kLvwGFB;
        "pkg-1.20.6-0-fabric" = _7FGBPCbE;
        "pkg-1.20.6-0-neoforge" = _w4Ha3SnI;
        "pkg-1.20.6-0-forge" = _FhhF38UR;
        "pkg-1.21-0-fabric" = _LOufVGN0;
        "pkg-1.21-0-forge" = _FVzzmnM4;
        "pkg-1.21-0-neoforge" = _J6HQskje;
        "pkg-1.20.6-0.1-neoforge" = _xmS0L8eF;
        "pkg-1.21-0.1-neoforge" = _W6U2vaJF;
        "pkg-1.21.1-0.1-neoforge" = _Rf8jYC9N;
        "pkg-1.21.1-0-fabric" = _H2Sxx3FV;
        "pkg-1.21.1-0-forge" = _2pcNsIuT;
        "pkg-1.21.2-0-fabric" = _rUHLU2it;
        "pkg-1.21.3-0-forge" = _6cq1MC84;
        "pkg-1.21.3-0.1-neoforge" = _qmOd6C7S;
        "pkg-1.21.4-0-fabric" = _dDRtYeyr;
        "pkg-1.21.4-0.1-neoforge" = _jTAwIs18;
        "pkg-1.21.4-0-forge" = _IPwI3RSX;
        "default" = _IPwI3RSX;
    });
