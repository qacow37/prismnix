...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.0" = _wDB1hErt;
        "pkg-1.0.1" = _Ix83nLaI;
        "pkg-1.0.2" = _CYuvxVEl;
        "pkg-1.19.2-1.2.0" = _aLLMRwnA;
        "pkg-1.18.2-1.2.0" = _YbS7ntFx;
        "pkg-1.20.1-1.2.1.d-9" = _5JJbEu0f;
        "pkg-1.19.2-1.2.1.c-36" = _BA8pM4zg;
        "pkg-1.20.1-1.2.2.d-9" = _NfcKWlC0;
        "pkg-1.3.1" = _VgdBE0JW;
        "pkg-1.3.2" = _Y2xHka8g;
        "pkg-1.5.0" = _QnImmUgU;
        "pkg-1.3.3" = _Gajuulxp;
        "pkg-1.20.1-1.5.1" = _8NYayRSj;
        "pkg-1.20.1-1.6.0" = _go1ZeKOa;
        "pkg-1.20.1-1.6.1" = _3Osd3SHL;
        "pkg-1.21-1.6.1" = _srTxPfcI;
        "pkg-1.21.1-1.7.0" = _Sk9d129f;
        "pkg-1.21.1-1.7.1" = _jIR7DhIl;
        "pkg-1.21.1-1.7.2" = _WOm7Ws9L;
        "pkg-1.21.1-1.8.0" = _uGzDI54j;
        "pkg-1.21.1-1.8.1" = _cJfEjLFP;
        "pkg-1.21.1-1.8.2" = _6qj6MJoe;
        "default" = _6qj6MJoe;
    });
