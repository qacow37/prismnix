...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta.1" = _9fAFasNp;
        "pkg-1.0.0-beta.2" = _i1w2CixJ;
        "pkg-1.0.0-beta.3" = _tZPKwmBD;
        "pkg-1.0.1-beta.1" = _XuFRNOby;
        "pkg-1.0.1-beta.2" = _JWui9AFv;
        "pkg-1.0.1-beta.3" = _AOoYmBwT;
        "pkg-1.0.1-beta.4" = _ooVVR2EB;
        "pkg-1.0.2-beta.1" = _W6fWLavY;
        "pkg-1.0.2-beta.2" = _2n7J6LEF;
        "pkg-1.0.2-beta.3" = _c5Nsu7rv;
        "pkg-1.1.0-beta.1" = _NU3tcOsM;
        "pkg-1.1.0-beta.2" = _R0XqB09S;
        "pkg-1.1.0-beta.3" = _piggIdl5;
        "pkg-1.1.0-beta.4" = _9zRa9jxn;
        "pkg-1.1.0-beta.5" = _W329mRU3;
        "pkg-1.1.0-beta.6" = _OCVuwRmd;
        "pkg-1.1.0-beta.7" = _bKBqBBzM;
        "pkg-1.1.0-beta.8" = _eI42qDdT;
        "pkg-1.1.1-beta.1" = _nBhcBbpG;
        "pkg-1.2.0" = _s2A7BI7i;
        "pkg-1.3.0" = _QLVASaNH;
        "pkg-1.3.1" = _qSFDpPJa;
        "pkg-1.3.2" = _SKanB27c;
