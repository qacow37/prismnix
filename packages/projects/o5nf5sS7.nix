...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _Jyf62ebg;
        "pkg-1.0.2" = _Mm4ZuZHX;
        "pkg-1.0.2.1" = _BIYgG2BT;
        "pkg-1.0.3" = _7V57whNG;
        "pkg-1.0.3.1" = _JSamMPmQ;
        "pkg-1.1" = _QzqNhGvk;
        "pkg-1.2" = _D9Npf6ep;
        "pkg-V1.2.1" = _60wukTBJ;
        "pkg-1.3" = _xeCqejw4;
        "pkg-V1.3.1" = _SPdDvhu7;
        "pkg-1.3.2" = _ZxC2HPEc;
        "pkg-V1.3.3" = _w4Bm78vZ;
        "pkg-V1.3.4" = _6ggkc1PW;
        "pkg-V1.3.5" = _aisO7S6G;
        "pkg-V1.4" = _MKA1fMjv;
        "pkg-V1.4.1" = _FAtoJwc3;
        "pkg-V1.4.1.1" = _s1ujSLWj;
        "pkg-V1.4.2" = _uD9Wj6eZ;
        "pkg-V1.4.3" = _cYzEBPOy;
        "pkg-V1.4.5" = _t7Wonlzi;
        "pkg-1.5.0" = _IyptJQnq;
        "pkg-1.5.1" = _38cplZpW;
        "default" = _38cplZpW;
    });
