...
let
    ...
    in {
        ...
        "pkg-1.6.2-1.19.3" = _EoShnJ8E;
        "pkg-1.6.2-1.19" = _VMUL2fIl;
        "pkg-1.6.2-1.17.1" = _UVOBkMPB;
        "pkg-1.6.2-1.18.2" = _O2Wsmgoz;
        "pkg-1.6.2-1.19.4" = _jaZ3g6Rt;
        "pkg-1.6.3-1.17.1" = _GDtu0LWe;
        "pkg-1.6.3-1.18.2" = _vnaHXGRh;
        "pkg-1.6.3-1.19" = _HQmlaAAM;
        "pkg-1.6.3-1.19.4" = _YhBHXcQq;
        "pkg-1.6.3" = _Msa5iMLj;
        "pkg-1.7.0" = _3zs9M8I5;
        "pkg-1.7.1" = _RdUwkgy7;
        "pkg-1.7.2-1.17.1" = _aRYeVcjQ;
        "pkg-1.7.2-1.18.2" = _fqcd6kMs;
        "pkg-1.7.2-1.19" = _GRmZTn6E;
        "pkg-1.7.2-1.20.1" = _h2cnp0GH;
        "pkg-1.8.0-1.17.1" = _Xs4sGPOu;
        "pkg-1.8.0-1.18.2" = _R3kbY7Hw;
        "pkg-1.8.0-1.19" = _hR8fXbl8;
        "pkg-1.8.0-1.20.1" = _yJB4sgpl;
        "pkg-1.8.1-1.17.1" = _v5AS6jea;
        "pkg-1.8.1-1.18.2" = _937dlgQR;
        "pkg-1.8.1-1.19" = _HQm6kTn0;
        "pkg-1.8.1-1.20.1" = _Uglu62NN;
        "pkg-1.9.0-1.19" = _s17IinIf;
        "pkg-1.9.0-1.19.4" = _a1PQwaXr;
        "pkg-1.9.0-1.20.1" = _wWlzytAt;
        "pkg-1.9.1-1.19" = _TDqeKSGB;
        "pkg-1.9.1-1.19.4" = _CmYme5s0;
        "pkg-1.9.1-1.20.1" = _YeirxOhF;
        "pkg-1.9.2-1.19" = _IEE7Uikr;
        "pkg-1.9.2-1.19.4" = _IwNFudQO;
        "pkg-1.9.2-1.20.1" = _cD6iDy5Q;
        "pkg-1.9.3-1.19" = _a6GvGkYD;
        "pkg-1.9.3-1.19.4" = _DqOMMC1I;
        "pkg-1.9.3-1.20.1" = _xGdcS2bd;
        "pkg-1.9.4-1.19" = _KtX9X5Av;
        "pkg-1.9.4-1.19.4" = _HJAt2Vrq;
        "pkg-1.9.4-1.20.1" = _1oIYOYmo;
        "pkg-1.9.5-1.19" = _yWJFYf9T;
        "pkg-1.9.5-1.19.4" = _ZgtAWFlC;
        "pkg-1.9.5-1.20.1" = _uXFPRtOn;
        "pkg-1.9.6-1.19" = _jtwPVQOc;
        "pkg-1.9.6-1.19.4" = _e7E7gvsB;
        "pkg-1.9.6-1.20.1" = _sTdyu005;
        "pkg-1.9.7-1.19" = _R1452FW7;
        "pkg-1.9.7-1.19.4" = _1SuwvQCa;
        "pkg-1.9.7-1.20.1" = _p9u2Gio1;
        "pkg-2.0.0-1.21.1" = _WaZCC6Ef;
        "default" = _WaZCC6Ef;
    });
