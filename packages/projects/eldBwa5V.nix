...
let
    ...
    in {
        ...
        "pkg-1.94.1" = _qe2k8Nte;
        "pkg-1.95.0" = _9ewOI5NO;
        "pkg-1.95.3" = _3lfWaWE9;
        "pkg-1.96.0" = _PTfzi89A;
        "pkg-v.96.1-beta" = _5WxmUb3u;
        "pkg-1.96.1-rc1" = _ASlUCa78;
        "pkg-1.97.0" = _Dil5CRTJ;
        "pkg-1.97.1-beta" = _ysPo4FIb;
        "pkg-1.97.1-beta-1" = _cSKQLjaQ;
        "pkg-1.97.2" = _JzETbjv9;
        "pkg-1.97.3" = _XdIrdkbz;
        "pkg-1.97.3.1" = _j2pLCnL6;
        "pkg-1.99.2-alpha1" = _cqqkoXt4;
        "pkg-1.96.2" = _Mrrl5RPn;
        "pkg-1.97.4" = _9xaznzFV;
        "pkg-1.100.0" = _uaLoc1k4;
        "pkg-1.96.3" = _2oN4BKaC;
        "pkg-1.97.5" = _oLUmeVKZ;
        "pkg-1.100.1" = _REPOq7j8;
        "pkg-1.100.2" = _XU9PBCE4;
        "pkg-1.100.3" = _cIwNlvBO;
        "pkg-1.100.4" = _rq99Nib9;
        "pkg-1.100.5" = _Iv1fygNW;
        "pkg-1.100.6" = _cFI8wbhG;
        "pkg-1.100.8+1.18.2" = _FbQHIk33;
        "pkg-1.101.0+1.19" = _WIndmkzf;
        "pkg-1.101.2+1.19.1" = _3S6HU7nl;
        "pkg-1.102.0+1.19.3" = _XZ4nB6es;
        "default" = _XZ4nB6es;
    });
