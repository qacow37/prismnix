...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.19.3" = _gWqUQYyY;
        "pkg-1.0.0-1.18.2" = _aY9sUIP7;
        "pkg-1.0.1+1.18.2" = _LKAcp3u2;
        "pkg-1.0.1+1.19.3" = _Y4ZDFGF2;
        "pkg-1.0.1+1.19.4" = _6qcUsaLv;
        "pkg-1.0.2+1.18" = _7SNoK0Dc;
        "pkg-1.0.2+1.18.1" = _grE0L9xm;
        "pkg-1.0.2+1.18.2" = _z46e78iY;
        "pkg-1.0.2+1.19" = _Rrf2iohZ;
        "pkg-1.0.2+1.19.1" = _EIjfemJ8;
        "pkg-1.0.2+1.19.2" = _NDOTKa2h;
        "pkg-1.0.2+1.19.3" = _E5pyCh1e;
        "pkg-1.0.2+1.19.4" = _hnCbISk4;
        "pkg-1.0.2+1.20" = _W5EJaD6Q;
        "pkg-1.0.2+1.20.1" = _at0KcxF9;
        "pkg-1.0.2+1.20.2" = _HfC2wCFq;
        "pkg-1.0.2+1.20.3" = _cL0qAf5L;
        "pkg-1.0.2+1.20.4" = _nw5ASXQS;
        "pkg-1.0.2+1.20.5" = _itxSiYAT;
        "pkg-1.0.2+1.20.6" = _ISjNx66F;
        "pkg-1.0.2+1.21" = _FwOWwzDP;
        "pkg-1.0.2+1.21.1" = _fV33p28D;
        "pkg-1.0.2+1.21.2" = _zdBfHRs1;
        "pkg-1.0.2+1.21.3" = _kE2cTKcA;
        "pkg-1.0.2+1.21.4" = _837vY78E;
        "pkg-1.0.2+1.21.5" = _vXLImLir;
        "pkg-1.0.2+1.21.6" = _FACvnEf9;
        "pkg-1.0.2+1.21.7" = _SbiTgD78;
        "pkg-1.0.2+1.21.8" = _4oAYlYZs;
        "pkg-1.0.2+1.21.9" = _EpskVusD;
        "pkg-1.0.2+1.21.10" = _yggzeTOg;
        "pkg-1.0.2+1.21.11" = _YWnGtCkv;
        "pkg-1.0.2+26.1" = _MsDuGTFI;
        "pkg-1.0.2+26.1.1" = _InUioN8g;
        "pkg-1.0.2+26.1.2" = _8zAbOUhJ;
        "default" = _8zAbOUhJ;
    });
