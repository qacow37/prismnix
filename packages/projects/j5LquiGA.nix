...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.3-fabric" = _UpNcqbTH;
        "pkg-1.18.2-2.3-fabric" = _cfdc1cS0;
        "pkg-1.19.2-2.3-fabric" = _15hN3yTR;
        "pkg-1.16.5-2.3-forge" = _Kiq6bLP9;
        "pkg-1.18.2-2.3-forge" = _K2ECWKfy;
        "pkg-1.19.2-2.3-forge" = _ATkR9lj6;
        "pkg-1.16.5-2.4-fabric" = _Cixmjsu6;
        "pkg-1.18.2-2.4-fabric" = _UgorGZ6H;
        "pkg-1.19.2-2.4-fabric" = _2SfUPDIJ;
        "pkg-1.19.3-2.5-fabric" = _zC5MyE5g;
        "pkg-1.19.3-2.3-forge" = _A88d19RL;
        "pkg-1.18.2-3.0-forge+fabric" = _KZ1C8aWc;
        "pkg-1.19.2-3.0-forge+fabric" = _xdmmRdhO;
        "pkg-1.19.3-3.0-forge+fabric" = _TjM2pEpw;
        "pkg-1.18.2-3.1-forge+fabric" = _C9GKjnoG;
        "pkg-1.19.3-3.1-forge+fabric" = _OipYEADQ;
        "pkg-1.18.2-3.2-forge+fabric" = _f8cAkpTQ;
        "pkg-1.19.2-3.2-forge+fabric" = _tufolOLZ;
        "pkg-1.19.3-3.2-forge+fabric" = _6DkQHspL;
        "pkg-1.19.4-3.2-forge+fabric" = _jZkvexLt;
        "pkg-1.20-3.2-forge+fabric" = _Mj367qtP;
        "pkg-1.20.1-3.2-forge+fabric" = _G22uj5BB;
        "pkg-1.20.2-3.2-forge+fabric" = _q7jEEAnB;
        "pkg-1.18.2-3.3-forge+fabric" = _L6dvF2sg;
        "pkg-1.19.2-3.3-forge+fabric" = _yFmVpDkm;
        "pkg-1.20.1-3.3-forge+fabric" = _WDOBiVSv;
        "pkg-1.20.2-3.3-forge+fabric" = _sLO0QGVo;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _ER0Ynaxc;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _6uBHuThH;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _pcAj6rJ2;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _Duda19mH;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _lK9scDa0;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _v6KQSZD9;
        "pkg-1.20.5-3.4-fabric+neo" = _ALkNaoRl;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _owygbN9C;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _4HVVxUvK;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _3GurnowM;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _tzOCi4dp;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _q8wVAkYz;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _r21mARlJ;
        "pkg-1.21.2-3.5-fabric+neo" = _8xJVyS3T;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _pdHr8BxY;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _s7voBaXd;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _LAbGmCYk;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _K8PJOLPj;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _q0yhV1AR;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _y3kzoFa2;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _d02haaFU;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _vzGjOgjK;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _soN9eCfd;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _XrxqaKTK;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _MLlPvoEJ;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _XuQIjNZy;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _xRAA2SdP;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _6mqGoQ0h;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _HWNQbN8w;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _A5GXifI8;
        "default" = _A5GXifI8;
    });
