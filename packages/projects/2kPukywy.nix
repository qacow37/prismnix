...
let
    ...
    in {
        ...
        "pkg-1.14.3" = _t1IbxKSJ;
        "pkg-1.14.4" = _QaYnARL1;
        "pkg-1.15.1" = _m0SAN4Xd;
        "pkg-1.15.2" = _cWqXcsjz;
        "pkg-1.15" = _q9nsqF8E;
        "pkg-1.16.1" = _qhk1P1uT;
        "pkg-1.16.2" = _diHBnZgU;
        "pkg-1.16.3" = _kxlEecZo;
        "pkg-1.16.4" = _dgFzQwaQ;
        "pkg-1.16.5" = _bGOJ1z23;
        "pkg-1.17.1" = _r6eLlJGi;
        "pkg-1.18.1" = _RP9mOSFp;
        "pkg-1.18.2" = _WBJMH9ms;
        "pkg-1.18" = _XuZrQNRs;
        "pkg-1.18.x" = _qEJOut3y;
        "pkg-1.19" = _Ep8eMezm;
        "pkg-1.19.1" = _SUYcgwmk;
        "pkg-1.19.2" = _9HdM4bQv;
        "pkg-1.19.3" = _ypM09a6P;
        "pkg-1.19.4" = _b2XcEpLn;
        "pkg-1.20.1" = _9hjlBK70;
        "pkg-1.20.4" = _rlOXSfnr;
        "pkg-1.20.6" = _njkqjb3T;
        "pkg-1.20" = _y2gk5h9T;
        "pkg-1.21" = _mijy07F4;
        "pkg-1.21.1" = _f8XM9yx1;
        "pkg-1.21.2" = _JdTfEeCe;
        "pkg-1.21.3" = _JmS37ft1;
        "pkg-1.21.4" = _5HwzHkd3;
        "pkg-1.21.5" = _Xamd3Ohq;
        "pkg-1.21.6" = _kVTDhqgS;
        "pkg-1.21.7" = _lgrFI6q7;
        "pkg-1.21.8" = _Q2gxavPD;
        "pkg-1.13.x-1.14.x" = _YzStPc1S;
        "pkg-1.15-1.16.1" = _dkLxR1He;
        "pkg-1.16.2-1.16.5" = _WvYI09v4;
        "pkg-1.17.x" = _1PzekEHC;
        "pkg-1.18.1-1.18" = _gwK5RPlY;
        "pkg-1.19-1.19.3" = _UwVZo64T;
        "pkg-1.20.1-1.20" = _tA708tRS;
        "pkg-1.21.10" = _U0BpCeaz;
        "pkg-1.21.11" = _voqMOOHj;
        "pkg-26.1.2" = _5uK6RikM;
