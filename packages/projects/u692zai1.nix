...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.7-fabric" = _24BfmQwW;
        "pkg-1.18.2-1.7-fabric" = _f4hYhyKL;
        "pkg-1.19.2-1.9-fabric" = _VZtMCqkc;
        "pkg-1.16.5-1.2-forge" = _UgXEwOPV;
        "pkg-1.18.2-1.4-forge" = _ufYQX9W9;
        "pkg-1.19.2-1.6-forge" = _KhVsfgWu;
        "pkg-1.16.5-2.0-fabric" = _J4rKSHWX;
        "pkg-1.18.2-2.0-fabric" = _65Qnq2GN;
        "pkg-1.19.2-2.0-fabric" = _Vh7N6gHW;
        "pkg-1.19.3-2.1-fabric" = _drdbdzR5;
        "pkg-1.19.3-1.6-forge" = _KSPlUdaO;
        "pkg-1.18.2-3.0-forge+fabric" = _pBBCZuaa;
        "pkg-1.19.2-3.0-forge+fabric" = _ZH9wBMDr;
        "pkg-1.19.3-3.0-forge+fabric" = _POfJc3Mr;
        "pkg-1.19.4-3.0-forge+fabric" = _2qkDTCF1;
        "pkg-1.20-3.0-forge+fabric" = _RkQ8Xm61;
        "pkg-1.20.1-3.0-forge+fabric" = _QK5DvdTg;
        "pkg-1.20.2-3.0-forge+fabric" = _t4jDgC1p;
        "pkg-1.20.2-3.1-forge+fabric" = _9vF01zYD;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _ORcnvsNq;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _Ag2vPoiX;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _7ZjN0KEz;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _Jpq8cDzc;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _OY849PgN;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _pDFhKpqY;
        "pkg-1.20.5-3.2-fabric+neo" = _CdkTI8Iz;
        "pkg-1.20.5-3.3-fabric+neo" = _uydEjwnr;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _VTIjzxCU;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _Z0u7S4u7;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _e0nZp6Cz;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _tVgX4RZk;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _lbLLqkCm;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _N9pvRoPH;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _Tos30JrV;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _iH8VhRmF;
        "pkg-1.21.2-3.6-fabric+neo" = _VElEMM7p;
        "pkg-1.21.2-3.7-fabric+neo" = _vH7p831m;
        "pkg-1.21.3-3.7-fabric+forge+neo" = _ti2gQ9bL;
        "pkg-1.21.4-3.7-fabric+forge+neo" = _dURXvSyM;
        "pkg-1.21.5-3.7-fabric+forge+neo" = _xK1fBBc4;
        "pkg-1.21.6-3.7-fabric+forge+neo" = _XfxnS4FR;
        "pkg-1.21.7-3.7-fabric+forge+neo" = _XO9B3Lrp;
        "pkg-1.21.8-3.7-fabric+forge+neo" = _ICZJArzX;
        "pkg-1.21.9-3.7-fabric+forge+neo" = _pHCi6VNs;
        "pkg-1.21.10-3.7-fabric+forge+neo" = _EhCIXEjt;
        "pkg-1.21.11-3.7-fabric+forge+neo" = _uVrpbQ2i;
        "pkg-26.1.0-3.7-fabric+forge+neo" = _QrTmelUI;
        "pkg-26.1.1-3.7-fabric+forge+neo" = _AGHoZ0fh;
        "pkg-26.1.2-3.7-fabric+forge+neo" = _FjWbtYav;
        "pkg-26.2.0-3.7-fabric+forge+neo" = _LoK7PaIr;
        "default" = _LoK7PaIr;
    });
