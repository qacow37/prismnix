...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _8iifk7Om;
        "pkg-1.1.2" = _gliG08XB;
        "pkg-1.1.3-1.21.10" = _YuWwYXkG;
        "pkg-1.1.4.1-1.21.5" = _B9fJvKIu;
        "pkg-1.1.4.1-1.21.10" = _X61POpT1;
        "pkg-1.1.4.1-1.21.8" = _5cQQvQza;
        "pkg-1.1.4.1-1.21.4" = _FCDdIyAE;
        "pkg-1.1.4.2-1.21.4" = _c7ZSFiVV;
        "pkg-1.1.4.2-1.21.8" = _y3f0uAhx;
        "pkg-1.1.4.2-1.21.10" = _RUraFnIp;
        "pkg-1.1.4.2-1.21.5" = _IDXzp7PK;
        "pkg-1.1.4.3-1.21.5" = _jJObQHPE;
        "pkg-1.1.4.3-1.21.4" = _ifJO9wRV;
        "pkg-1.1.4.4-1.21.10" = _5JV8tPqg;
        "pkg-1.1.4.4-1.21.5" = _iRwf3v1b;
        "pkg-1.1.4.4-1.21.4" = _26B2Mpyd;
        "pkg-1.1.4.5-1.21.10" = _zEnN0i8g;
        "pkg-1.1.4.5-1.21.4" = _Re8Sv0Im;
        "pkg-1.1.4.5-1.21.5" = _gHNvIK2J;
        "pkg-1.1.4.6-1.21.8" = _dZJaOSwU;
        "pkg-1.1.4.7-1.21.8" = _p4kARFwG;
        "pkg-1.1.4.7-1.21.5" = _vGEVATFq;
        "pkg-1.1.4.7-1.21.4" = _rigxwu2k;
        "pkg-1.1.4.8-1.21.10" = _PmhluuDM;
        "pkg-1.1.4.8-1.21.4" = _JxO6otyz;
        "pkg-1.1.4.8-1.21.5" = _8bZRnAhN;
        "pkg-1.1.4.8-1.21.8" = _C11E63al;
        "pkg-1.1.5-1.21.5" = _Vb35eW9L;
        "pkg-1.1.5-1.21.8" = _lckIsiAQ;
        "pkg-1.1.5-1.21.10" = _l5jh9Pzf;
        "pkg-1.1.5-1.21.4" = _Z4IuC4tK;
        "pkg-1.1.5.1-1.21.5" = _Ub1UZ9mx;
        "pkg-1.1.5.1-1.21.4" = _EZLICEgr;
        "pkg-1.1.5.1-1.21.10" = _4AdWocYr;
        "pkg-1.1.5.1-1.21.8" = _nLIkvNlU;
        "pkg-1.1.5.1-1.21.11" = _7BSVaQkY;
        "pkg-1.1.5.2-1.21.10" = _x1L782Tj;
        "pkg-1.1.5.2-1.21.11" = _G6TXPg4O;
        "pkg-1.1.5.2-1.21.8" = _8hTGDbT3;
        "pkg-1.1.5.2-1.21.4" = _MHc3UqIU;
        "pkg-1.1.5.2-1.21.5" = _5MqQAVKa;
        "pkg-1.1.5.3-1.21.11" = _kgeon200;
        "pkg-1.1.5.4-1.21.11" = _2uwwsqz0;
        "pkg-1.1.6-1.21.11" = _MHx8WntM;
        "pkg-1.1.6-1.21.10" = _jMKzfNer;
        "pkg-1.1.6-1.21.8" = _3SCcw23Y;
        "pkg-1.1.6-1.21.4" = _cEjjI3VD;
        "pkg-1.1.6-1.21.5" = _eTguFzmw;
        "pkg-1.1.6.1-1.21.4" = _3wOzkY5y;
        "pkg-1.1.6.1-1.21.5" = _a8dO2MWh;
        "pkg-1.1.6.1-1.21.8" = _M7BlkKSy;
        "pkg-1.1.6.1-1.21.10" = _DhjMNiRJ;
        "pkg-1.1.6.1-1.21.11" = _7fqgBNn3;
        "pkg-1.1.6.3-1.21.4" = _DwmCf186;
        "pkg-1.1.6.3-1.21.5" = _bPuqDgGt;
        "pkg-1.1.6.3-1.21.8" = _Ydtio687;
        "pkg-1.1.6.3-1.21.10" = _VbYGre1q;
        "pkg-1.1.6.3-1.21.11" = _zjjVXpTb;
        "pkg-1.1.7-1.21.11" = _Dhv3mTZb;
        "pkg-1.1.7-1.21.10" = _qDjIXc5j;
        "pkg-1.1.7-1.21.8" = _VYv9YeYy;
        "pkg-1.1.7-1.21.5" = _OsweFHVT;
        "pkg-1.1.7-1.21.4" = _Lmwpq20y;
        "pkg-1.1.8-1.21.11" = _gf2Zm6l0;
        "pkg-1.1.8-1.21.10" = _Plbdw2Tu;
        "pkg-1.1.8-1.21.8" = _Bu9oYkUr;
        "pkg-1.1.8-1.21.5" = _JUQ6HeL7;
        "pkg-1.1.8-1.21.4" = _221hKVGW;
        "pkg-1.9-1.21.4" = _snB3CQto;
        "pkg-1.9-1.21.5" = _No2r6Mae;
        "pkg-1.9-1.21.8" = _nIt7TUdI;
        "pkg-1.9-1.21.10" = _wWxy4fgg;
        "pkg-1.9-1.21.11" = _WeEImT62;
        "pkg-1.9.1-1.21.4" = _iqQIMKDH;
        "pkg-1.9.1-1.21.5" = _iDCvSqKf;
        "pkg-1.9.2-1.21.4" = _tC5QwUyc;
        "pkg-1.9.2-1.21.5" = _NTnfXGrQ;
        "pkg-1.9.2-1.21.8" = _nBEOVVd0;
        "pkg-1.9.2-1.21.10" = _IREfsQj7;
        "pkg-1.9.2-1.21.11" = _MUau3Tsy;
        "pkg-1.9.3-1.21.4" = _tLSNx6mx;
        "pkg-1.9.3-1.21.5" = _YztJUJaw;
        "pkg-1.9.3-1.21.8" = _klfGFmN8;
        "pkg-1.9.3-1.21.10" = _OGwzxlC7;
        "pkg-1.9.3-1.21.11" = _SAvetbJQ;
        "pkg-1.9.4-1.21.4" = _o6J4e8El;
        "pkg-1.9.4-1.21.5" = _Y6r5s8wZ;
        "pkg-1.9.4-1.21.8" = _5dPhbSQ9;
        "pkg-1.9.4-1.21.10" = _iJCSMBLW;
        "pkg-1.9.4-1.21.11" = _3rJO62Vj;
        "pkg-2.0.1-1.21.11" = _m0XQ4cQw;
        "pkg-2.0.1-1.21.10" = _wknTH9Lz;
        "pkg-2.0.1-1.21.8" = _jhZeyvjn;
        "pkg-2.0.1-1.21.5" = _nyH7HM1L;
        "pkg-2.0.1-1.21.4" = _bCyl9frf;
        "pkg-2.1-1.21.11" = _8lUHhsRK;
        "pkg-2.1-1.21.10" = _8M37tqhe;
        "pkg-2.1-1.21.8" = _Tib66yjl;
        "pkg-2.1-1.21.5" = _7Gc49ivF;
        "pkg-2.1-1.21.4" = _Hvcn4wQm;
        "pkg-2.2-1.21.11" = _ZwEL4nLS;
        "pkg-2.2-1.21.10" = _VAG1q4bT;
        "pkg-2.2-1.21.8" = _kKO7giyl;
        "pkg-2.2-1.21.5" = _4hKYVlyj;
        "pkg-2.2-1.21.4" = _Zb5j9sTY;
        "pkg-2.2.1-1.21.4" = _mBAXtXme;
        "pkg-2.2.1-1.21.5" = _ObOV2HIf;
        "pkg-2.2.1-1.21.8" = _2mb9NVdO;
        "pkg-2.2.1-1.21.10" = _sOK8ODLl;
        "pkg-2.2.1-1.21.11" = _FQQyII1b;
        "pkg-2.2.2-1.21.4" = _vLIWG7eW;
        "pkg-2.2.2-1.21.5" = _2ZHX18Lf;
        "pkg-2.2.2-1.21.8" = _b5qo86Yj;
        "pkg-2.2.2-1.21.10" = _HJnQ3APy;
        "pkg-2.2.2-1.21.11" = _mMcgJ8iZ;
        "pkg-2.2.2-26.1" = _Laj8TyDi;
        "pkg-2.2.3-26.1" = _sEjnuQyu;
        "pkg-2.2.3-26.1.1" = _nk7X3RHt;
        "pkg-2.2.3-26.1.2" = _DCBNQBnq;
        "pkg-2.3-1.21.4" = _rUHweT97;
        "pkg-2.3-1.21.5" = _86CfEhrD;
        "pkg-2.3-1.21.8" = _YfPQRfVL;
        "pkg-2.3-1.21.10" = _OObZ7d4u;
        "pkg-2.3-1.21.11" = _QfTQksOH;
        "pkg-2.3-26.1" = _Ezj3C3vI;
        "pkg-2.3-26.1.1" = _rESFaEuL;
        "pkg-2.3-26.1.2" = _owWsrNUU;
        "pkg-2.3.1-1.21.10" = _JIY3BFBS;
        "pkg-2.3.1-1.21.5" = _akA6f5oQ;
        "pkg-2.3.1-1.21.8" = _K6VLkgfl;
        "pkg-2.3.2-1.21.4" = _piitCmmW;
        "pkg-2.3.2-1.21.5" = _eQn1zsfS;
        "pkg-2.3.2-1.21.8" = _rBRqAsZ5;
        "pkg-2.3.2-1.21.10" = _cvyOA3vS;
        "pkg-2.3.2-1.21.11" = _dIStKnHF;
        "pkg-2.3.2-26.1" = _A8b0wXK3;
        "pkg-2.3.2-26.1.1" = _c9iuN1fa;
        "pkg-2.3.2-26.1.2" = _3AgSsjKb;
        "pkg-2.4-1.21.4" = _DbYUq7Qf;
        "pkg-2.4-1.21.5" = _h0VpellX;
        "pkg-2.4-1.21.8" = _EYn9nXW9;
        "pkg-2.4-1.21.10" = _yCN3RHzS;
        "pkg-2.4-1.21.11" = _RHwlfNra;
        "pkg-2.4-26.1" = _nqmaq7Cm;
        "pkg-2.4-26.1.1" = _wzMCgJnA;
        "pkg-2.4-26.1.2" = _mZkaYimq;
        "pkg-2.4.1-26.1.2" = _Dl0MZPTO;
        "pkg-2.4.1-26.1.1" = _vg7cGzNW;
        "pkg-2.4.1-26.1" = _oFhBqDyG;
        "pkg-2.4.1-1.21.11" = _tBd6pcq2;
        "pkg-2.4.1-1.21.10" = _5BrqbxWY;
        "pkg-2.4.1-1.21.8" = _tE2AO6vW;
        "pkg-2.4.1-1.21.5" = _vLKwor1x;
        "pkg-2.4.1-1.21.4" = _sHje04X6;
        "pkg-2.4.2-1.21.4" = _xU3lOtCz;
        "pkg-2.4.2-1.21.5" = _yD7ZHChE;
        "pkg-2.4.2-1.21.8" = _1QPxZ0U2;
        "pkg-2.4.2-1.21.10" = _BTSsZvFx;
        "pkg-2.4.2-1.21.11" = _qVtlHFCL;
        "pkg-2.4.2-26.1" = _82hGC3GI;
        "pkg-2.4.2-26.1.1" = _7AijjpiA;
        "pkg-2.4.2-26.1.2" = _FenPTw1a;
        "pkg-2.4.2-26.2" = _YiJ9rDRS;
        "pkg-2.6.3-1.21.11" = _82XETzOh;
        "pkg-2.6.3-1.21.4" = _4bVqtnhj;
        "pkg-2.6.3-1.21.5" = _bcEJEsXy;
        "pkg-2.6.3-1.21.8" = _a0N3KInM;
        "pkg-2.6.3-1.21.10" = _wjcVcsqE;
        "pkg-2.6.3-26.1" = _kZb9PsmX;
