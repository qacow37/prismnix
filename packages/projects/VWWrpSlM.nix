...
let
    ...
    in {
        ...
        "pkg-1.0" = _ADRXWYLK;
        "pkg-1.0+mod" = _wt1bPsAl;
        "pkg-1.1" = _FugakfSS;
        "pkg-1.1+mod" = _NwCUnFzR;
        "pkg-1.2" = _m5H4Wnfl;
        "pkg-1.2+mod" = _V5qxCiV1;
        "pkg-1.3" = _8fwqWikk;
        "pkg-1.3+mod" = _D7QVCzO7;
        "pkg-1.4" = _c9Dzr4TQ;
        "pkg-1.4+mod" = _y20v9iDm;
        "pkg-1.5" = _MDlbDSHJ;
        "pkg-1.5+mod" = _2sB7DO51;
        "pkg-1.6" = _tQKCsxPJ;
        "pkg-1.6+mod" = _Qj0SNk40;
        "pkg-1.7" = _OJQnQQzT;
        "pkg-1.7-fabric" = _13wj75JF;
        "pkg-1.7-forge" = _AiVFpZcq;
        "pkg-1.11" = _iG3m7uLI;
        "pkg-1.11-fabric" = _heKR9fzd;
        "pkg-1.11-quilt" = _IfBelkHw;
        "pkg-1.11-forge" = _Cy7dkaIM;
        "pkg-1.11-neoforge" = _O1kkzh3Y;
        "pkg-1.12" = _zxxW23RJ;
        "pkg-1.12-fabric" = _vp8UW805;
        "pkg-1.12-quilt" = _NpvxY3ht;
        "pkg-1.12-forge" = _5CQujcRO;
        "pkg-1.12-neoforge" = _80IrQ4Nf;
        "default" = _80IrQ4Nf;
    });
