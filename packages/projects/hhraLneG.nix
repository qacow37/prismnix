...
let
    ...
    in {
        ...
        "pkg-1.18.1-1.0.3" = _HCIwNolL;
        "pkg-1.19-1.0.3" = _HODrJqoG;
        "pkg-1.19-1.0.4" = _dUkaKU8X;
        "pkg-1.19.2-1.04" = _85M46WQC;
        "pkg-1.19.3-1.0.4" = _i6zk7uph;
        "pkg-1.18.2-1.0.4" = _DtW1Mw7h;
        "pkg-1.16.5-1.1.0" = _7jujCInV;
        "pkg-1.17.1-1.1.0" = _LgiRlLMK;
        "pkg-1.18.2-1.1.0" = _N6l5aDbM;
        "pkg-1.19.3-1.1.0" = _v5T5Mkiy;
        "pkg-1.19.4-1.1.0" = _NllRgS13;
        "pkg-1.20.1-1.1.0-Fabric" = _4lkprnNO;
        "pkg-1.20.1-1.1.0-Forge" = _dxBdJGM1;
        "pkg-1.18.2-1.2.0-Fabric" = _Lu67Q4oE;
        "pkg-1.18.2-1.2.0-Forge" = _RQ8E7iOO;
        "pkg-1.16.5-1.2.1-Forge" = _XIHCksEN;
        "pkg-1.18.2-1.2.1-Fabric" = _2piknNz2;
        "pkg-1.18.2-1.2.1-Forge" = _a1fjRDh7;
        "pkg-1.19.4-1.2.1-Fabric" = _Tjyvb6pf;
        "pkg-1.19.4-1.2.1-Forge" = _6n3SSFId;
        "pkg-1.16.5-1.2.2-Forge" = _aQxRK5b1;
        "pkg-1.18.2-1.2.2-Fabric" = _6Y76RbBo;
        "pkg-1.18.2-1.2.2-Forge" = _IbDT0Oxv;
        "pkg-1.19.4-1.2.2-Fabric" = _yXKCsIE0;
        "pkg-1.19.4-1.2.2-Forge" = _wPKYkrwh;
        "pkg-1.20.1-1.2.2-Fabric" = _5MWbaRIZ;
        "pkg-1.20.1-1.2.2-Forge" = _eRXBVXUH;
        "pkg-1.20.4-1.2.2-NeoForge" = _KUn0REbI;
        "pkg-1.20.4-1.2.2-Fabric" = _ZMNI1yqo;
        "pkg-1.20.4-1.2.2-Forge" = _jzMnp8Dt;
        "pkg-1.18.2-1.2.3-Fabric" = _5xErzS8R;
        "pkg-1.18.2-1.2.3-Forge" = _wxkxNDiz;
        "pkg-1.20.4-1.2.3-NeoForge" = _CjaBXoQ5;
        "pkg-1.20.4-1.2.3-Fabric" = _13lbmvq4;
        "pkg-1.20.4-1.2.3-Forge" = _XVUyfXpu;
        "pkg-1.20.6-1.2.3-NeoForge" = _V26OXtvD;
        "pkg-1.20.6-1.2.3-Fabric" = _e0rTbmTR;
        "pkg-1.20.6-1.2.3-Forge" = _lrvaM2rU;
        "pkg-1.21.1-1.2.3-NeoForge" = _YSLXUrTe;
        "pkg-1.21.1-1.2.3-Fabric" = _t6swON3d;
        "pkg-1.21.1-1.2.3-Forge" = _PulB5xHA;
        "default" = _PulB5xHA;
    });
