...
let
    ...
    in {
        ...
        "pkg-1.14.0" = _rUAK6wQf;
        "pkg-1.15.0" = _Xl5C4XqQ;
        "pkg-1.16.0" = _Q7P1I0TN;
        "pkg-1.16.1" = _r4zlVrhx;
        "pkg-1.16.2" = _1S9dgva0;
        "pkg-1.16.3" = _eadAgk6t;
        "pkg-1.16.4" = _OJM5jkcU;
        "pkg-1.16.5" = _KS5jU0l7;
        "pkg-1.16.6" = _AzzgQQcB;
        "pkg-1.16.7" = _MXGMjey9;
        "pkg-1.16.8" = _MdV6XwF4;
        "pkg-1.16.9" = _FGiUS64W;
        "pkg-1.16.10" = _IzBFfMbx;
        "pkg-1.17.0" = _YVR66WED;
        "pkg-1.17.1" = _HGo4pEeG;
        "pkg-1.18.0" = _oRDrDxBr;
        "pkg-1.18.1" = _eJIjXI47;
        "pkg-1.19.0" = _ZvQCpHFw;
        "pkg-1.20.0" = _rceQc1tt;
        "pkg-1.20.1" = _b1MQXh6q;
        "pkg-1.20.2" = _MVahFpN7;
        "pkg-1.21.0" = _wqAW46KA;
        "pkg-1.21.1" = _x47Zl7Ue;
        "pkg-1.22.0" = _77rDLZzc;
        "default" = _77rDLZzc;
    });
