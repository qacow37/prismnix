...
let
    ...
    in {
        ...
        "pkg-6.4.1" = _wN2SUIat;
        "pkg-6.4.2" = _DjVY9yuW;
        "pkg-1.12.2-6.5.0" = _Ds0EW9Zr;
        "pkg-1.16.5-6.5.0" = _t035W22g;
        "pkg-1.12.2-7.0.0-BETA1" = _OSDwmFmC;
        "pkg-1.16.5-7.0.0-BETA1" = _HlSP29Ed;
        "pkg-1.12.2-6.6.0" = _eXINBz8g;
        "pkg-1.16.5-6.0.0" = _veXuwSDe;
        "pkg-1.16.5-6.6.1" = _yXMKl62P;
        "pkg-1.12.2-6.7.0" = _MCnZXmoE;
        "pkg-1.16.5-6.7.0" = _RMdsCU2I;
        "pkg-1.12.2-6.7.1" = _FeOg7N3R;
        "pkg-1.16.5-6.7.1" = _kuXKdNDB;
        "pkg-1.12.2-6.7.2" = _Rppc8fky;
        "pkg-1.16.5-6.7.2" = _1ur9RRJi;
        "pkg-1.18.2-6.7.2" = _RIJjYZYW;
        "pkg-1.19.2-6.7.2" = _Prt2LQuc;
        "pkg-1.20.1-6.7.2" = _RYhtdX2F;
        "pkg-1.12.2-6.7.3" = _okeJkJro;
        "pkg-1.16.5-6.7.3" = _VjpyvdIF;
        "pkg-1.18.2-6.7.3" = _SwA3AFwJ;
        "pkg-1.19.2-6.7.3" = _nPMcjuZd;
        "pkg-1.20.1-6.7.3" = _i1Hf4saR;
        "default" = _i1Hf4saR;
    });
