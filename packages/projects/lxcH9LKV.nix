...
let
    ...
    in {
        ...
        "pkg-1.9.0" = _PHE2qmx7;
        "pkg-1.9.1" = _4GqPL7yR;
        "pkg-1.10.0" = _tlUvBFb5;
        "pkg-1.11.0" = _OkIRYSCJ;
        "pkg-1.11.3" = _XupLj648;
        "pkg-1.11.5" = _tSo6UhJJ;
        "pkg-1.11.6" = _rHQvjKuE;
        "pkg-1.11.7" = _p6BPjiaT;
        "pkg-1.11.8" = _KuuNY3Ng;
        "pkg-1.12.0" = _K6lzRpIb;
        "default" = _K6lzRpIb;
    });
