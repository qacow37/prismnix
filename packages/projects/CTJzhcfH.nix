...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.0" = _CdjqOcBw;
        "pkg-1.18.2-1.0.1" = _huLdQBbX;
        "pkg-1.15.2-0.1.1" = _OwaCBaUy;
        "pkg-1.16.4-0.4.6" = _FnJHYgDn;
        "pkg-1.18.2-1.0.2" = _dQBDmuNu;
        "pkg-1.19.2-2.0.0" = _VOfc9x5o;
        "pkg-1.19.2-2.0.1" = _f22kYsgI;
        "pkg-1.19.2-2.0.2" = _XVyqxbKN;
        "pkg-1.18.2-1.0.3" = _XJHHTLVY;
        "pkg-1.19.2-2.0.3" = _l12NkPAf;
        "pkg-1.19.2-2.0.4" = _DhPUKsjI;
        "pkg-1.19.2-2.0.5" = _amilfm8k;
        "pkg-1.20.1-3.0.0" = _Jlmh1oCk;
        "pkg-1.20.1-3.0.1" = _JqzxdlYD;
        "pkg-1.20.1-3.0.2" = _W2F8G5LW;
        "pkg-1.20.1-3.0.3" = _lNHrxCD9;
        "pkg-1.20.1-3.0.4" = _GaUjb0nF;
        "pkg-1.20.1-3.0.5" = _f3kszOMR;
        "pkg-1.20.1-3.0.6" = _JrNoZjrB;
        "pkg-1.20.1-3.0.7" = _i8Ont74I;
        "pkg-1.20.1-3.0.8" = _LnKoiIau;
        "pkg-1.20.1-3.0" = _nnsqWjir;
        "pkg-1.20.1-3.0.10" = _nWd5gpH8;
        "default" = _nWd5gpH8;
    });
