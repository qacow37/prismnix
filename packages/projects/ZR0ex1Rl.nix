...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.21.4" = _5hROiZPT;
        "pkg-1.1.0-1.21.1" = _2jia4W3h;
        "pkg-1.1.1-1.21.1" = _R7UUTiae;
        "pkg-1.1.1-1.21.4" = _6OIJoF2O;
        "pkg-1.1.2-1.21.1" = _2qCAscJX;
        "pkg-1.1.2-1.21.4" = _TgYx3pdu;
        "pkg-1.1.2-1.21.5" = _KRAoMhjF;
        "pkg-1.2.0-1.21.5" = _sjbOdaRf;
        "pkg-1.2.0-1.21.4" = _UZYFpzWN;
        "pkg-1.2.0-1.21.1" = _va0HY769;
        "pkg-1.2.1-1.21.6" = _zTBRtHZA;
        "pkg-1.2.1-1.21.7" = _iBSfiuqI;
        "pkg-1.2.1-1.21.8" = _CjrFrXHZ;
        "pkg-1.2.2-1.21.1" = _Jwwpsa5y;
        "pkg-1.2.2-1.21.8" = _MI5eDGt9;
        "pkg-1.2.3-1.21.8" = _2XaNhLGk;
        "pkg-1.2.3-1.21.1" = _8Elh7w9Y;
        "pkg-1.2.3-1.21.9" = _7GUKN9rR;
        "pkg-1.2.3-1.21.10" = _DBZdDu8y;
        "pkg-1.2.3-1.21.11" = _BkDz9sLU;
        "pkg-1.2.4-1.21.11" = _c7QuUDle;
