...
let
    ...
    in {
        ...
        "pkg-1.1.g" = _rozFTcwZ;
        "pkg-1.1.h" = _EEj7FInH;
        "pkg-1.2.ORANGE_2QT" = _EJeKwPzi;
        "pkg-1.2.ORANGE_2QT.3" = _B9HbqBfC;
        "pkg-1.2.ORANGE_2QT.4" = _x6vDt2ie;
        "pkg-1.2.ORANGE_2QT.6" = _9LjZzGAV;
        "pkg-1.2.ORANGE_2QT.7" = _J3akrEzc;
        "pkg-1.2.ORANGE_2QT.8" = _Xas2ULip;
        "pkg-1.2.ORANGE_2QT.9" = _E17SPiob;
        "pkg-1.2.ORANGE_2QT.10" = _lg1fsFLx;
        "pkg-1.2.ORANGE_2QT.11" = _ht8KcAxe;
        "pkg-1.2.ORANGE_2QT.12" = _yz88YRBG;
        "pkg-1.2.ORANGE_2QT.13" = _s2rdjuqJ;
        "pkg-1.2.ORANGE_2QT.14" = _PqgRHmDR;
        "pkg-1.2.ORANGE_2QT.15" = _SsE05GpM;
        "pkg-1.2.ORANGE_2QT.16" = _jSm3u73y;
        "pkg-1.2.ORANGE_2QT.17" = _MJN3Sgbu;
        "pkg-1.2.ORANGE_2QT.18" = _hPm57R8M;
        "pkg-1.2.ORANGE_3QT.1" = _bvHxU3Ih;
        "pkg-1.2.ORANGE_3QT.2" = _srq8vHcs;
        "pkg-1.2.ORANGE_3QT.3" = _D9YDgLvM;
        "pkg-1.2.ORANGE_3QT.4" = _kHTsuHut;
        "pkg-1.2.ORANGE_4QT" = _mf6Yq3CA;
        "pkg-1.2.ORANGE_4QT.1" = _tDdxffzI;
        "pkg-1.2.ORANGE_4QT.2" = _tjUNUtYn;
        "pkg-1.2.ORANGE_4QT.3" = _cG9J0BRX;
        "pkg-1.2.ORANGE_4QT.3.1" = _ldTkcijl;
        "pkg-1.2.ORANGE_4QT.3.2" = _yL4D83vo;
        "pkg-1.2.ORANGE_4QT.3.3" = _Fwj5wYCC;
        "pkg-1.2.ORANGE_4QT.3.4" = _K3bBber0;
        "default" = _K3bBber0;
    });
