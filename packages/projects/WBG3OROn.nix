...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _szcmz6uX;
        "pkg-1.0.4" = _Tq2MncQb;
        "pkg-1.1.0+1.20+A" = _2ZK6r1IJ;
        "pkg-1.1.0+1.21+A" = _m5MoOPJY;
        "pkg-1.1.0+1.21.9+A" = _LxW7406E;
        "pkg-1.1.0+1.20+B" = _qZhJcAR6;
        "pkg-1.1.1+1.20+A" = _eNejWQxC;
        "pkg-1.1.1+1.21+A" = _tqKfMazB;
        "pkg-1.1.1+1.21.9+A" = _lv3ljODw;
        "default" = _lv3ljODw;
    });
