...
let
    ...
    in {
        ...
        "pkg-1.16.2+01" = _3vT3odiy;
        "pkg-1.15.2_03" = _txotsMuM;
        "pkg-1.14.4_03" = _DbjKV92x;
        "pkg-1.16.5+01" = _dy1Nk0ab;
        "pkg-1.16.5+02" = _dstHJwW8;
        "pkg-1.18.1+01" = _d4angaJs;
        "pkg-1.18.2+01" = _beb8HAii;
        "pkg-1.19+01" = _5kdnAu2N;
        "pkg-1.19.2+01" = _firuKLWB;
        "pkg-1.19.3+01" = _pYi2ADTI;
        "pkg-1.19.4+01" = _f7MymOkk;
        "pkg-1.20+01" = _2tNTyKzy;
        "pkg-1.20.2+01" = _n5lfsxOH;
        "pkg-1.20.3+01" = _MsivFd3o;
        "pkg-1.20.6+01" = _200G26pU;
        "pkg-1.21.1+01" = _KzDaAGw6;
        "pkg-1.21.3+01" = _bddnzV2D;
        "pkg-1.21.4+01" = _CUTdWKwg;
        "pkg-1.21.5+01" = _HurcveSL;
        "pkg-1.21.7+01" = _nWaUUJzW;
        "pkg-1.21.10+01" = _GLRO8pvm;
        "pkg-1.21.11+01" = _SD1ZtHLA;
