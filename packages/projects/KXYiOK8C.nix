...
let
    ...
    in {
        ...
        "pkg-2.1.0+1.14.4" = _eE1JyDIo;
        "pkg-2.1.0+1.15.2" = _tfjrCXHx;
        "pkg-2.1.0+1.16.5" = _muCGAK0j;
        "pkg-2.2.0+1.14.4" = _QYqsGUdN;
        "pkg-2.2.0+1.15.2" = _igLOXbV3;
        "pkg-2.2.0+1.16.5" = _NyAoTjKu;
        "pkg-2.2.0+1.17.1" = _eMKyx7D4;
        "pkg-2.2.1+1.14.4" = _USD5NF8o;
        "pkg-2.2.1+1.15.2" = _JQKefA66;
        "pkg-2.2.1+1.16.5" = _KTJ3Wpia;
        "pkg-2.2.1+1.17.1" = _HheAMbX4;
        "pkg-2.3.0+1.14.4" = _I1QQeltd;
        "pkg-2.3.0+1.15.2" = _VwH1HB3L;
        "pkg-2.3.0+1.16.5" = _X3XXo7kG;
        "pkg-2.3.0+1.17.1" = _e1KGnJIa;
        "pkg-2.3.1+1.18" = _QBKIOFXV;
        "pkg-2.3.1+1.18.2" = _nmjHklJi;
        "pkg-2.3.2+1.14.4" = _604WoASX;
        "pkg-2.3.2+1.15.2" = _nTUasPO7;
        "pkg-2.3.2+1.16.5" = _XSA5TWkw;
        "pkg-2.3.2+1.17.1" = _JVWqEVo5;
        "pkg-2.3.2+1.18.1" = _5qoDMFrQ;
        "pkg-2.3.2+1.18.2" = _X2sT4bl3;
        "pkg-2.3.3+1.15.2+fabric" = _d4vtrby6;
        "pkg-2.3.3+1.16.5+fabric" = _xDdI7WhW;
        "pkg-2.3.3+1.17.1+fabric" = _bxMMOxhn;
        "pkg-2.3.3+1.18.2+fabric" = _K8kLNXqd;
        "pkg-2.3.3+1.18.2" = _glE5m1Eh;
        "default" = _glE5m1Eh;
    });
