...
let
    ...
    in {
        ...
        "pkg-0.5.109+mc1.19.2-build.40" = _QqNqBxWA;
        "pkg-0.5.109+mc1.19.4-build.38" = _RaoNSzRN;
        "pkg-0.5.108+mc1.20.1-build.39" = _ItLfCub3;
        "pkg-0.5.109+mc1.19.2-build.79" = _T7jsiW95;
        "pkg-0.5.109+mc1.19.4-build.80" = _6YZkSsKf;
        "pkg-0.5.109+mc1.20.1-build.76" = _ZNDDpG9k;
        "pkg-0.5.109+mc1.19.2-build.103" = _zb5cVAI5;
        "pkg-0.5.109+mc1.19.4-build.105" = _D4CdkfMP;
        "pkg-0.5.109+mc1.20.1-build.104" = _w3jSSP5U;
        "pkg-1.19.2-0.6.4.30" = _dR9x99e4;
        "pkg-1.20.1-0.6.33.31" = _wmAccvXm;
        "pkg-1.20.4-0.6.26.34" = _lz9g3y1m;
        "pkg-1.20.1-0.6.34.39" = _UfB5fh4Y;
        "pkg-1.20.4-0.6.26.40" = _i6yaaNV7;
        "pkg-1.20.1-0.6.35.49" = _ZmzTMNos;
        "pkg-1.21.1-0.6.50.52" = _ZyDiV6jm;
        "pkg-1.21.1-0.6.50.61" = _pMD1uLsC;
        "pkg-1.20.1-0.7.10.1.78" = _GOcxeJDW;
        "pkg-1.21.1-0.7.12.1.77" = _pJ3mPTqc;
        "pkg-1.20.4-0.6.26.79" = _2YoITtYt;
        "pkg-1.21.1-0.7.12.2.81" = _w6Clwpqw;
        "pkg-1.21.1-0.7.14.1.91" = _LazpwPnW;
        "pkg-1.20.1-0.7.12.1.90" = _EuHhzc22;
        "pkg-1.20.4-0.6.26.93" = _tFpbF1Ab;
        "pkg-1.20.1-0.7.12.2.96" = _HOD7NZlD;
        "pkg-1.21.1-0.7.14.2.101" = _Xz9ivku7;
        "pkg-1.20.1-1.0.8.1.119" = _KrzdxAak;
        "pkg-1.21.1-1.0.13.1.120" = _R1roJykF;
        "pkg-1.20.4-0.6.27.138" = _IDvJ50Tp;
        "pkg-1.20.1-1.2.7.2.139" = _nOg0wscg;
        "pkg-1.21.1-1.2.9.1.140" = _i0np3cpU;
        "pkg-1.21.1-1.2.9.2.142" = _2c4dwUCy;
        "pkg-1.21.1-1.2.9.3.145" = _N2PVEnm0;
        "pkg-1.21.1-1.2.9.5.147" = _7FKPkK7g;
        "pkg-1.21.1-1.2.9.8.148" = _qxuyLSnp;
        "pkg-1.21.1-1.2.9.10.152" = _DWa8poEQ;
        "pkg-1.21.1-1.2.9.12.153" = _tmtiWKzb;
        "pkg-1.21.1-1.2.9.14.154" = _qXLdXcsD;
        "pkg-1.20.1-1.2.7.7.156" = _9RuXVwa9;
        "pkg-1.21.1-1.2.9.17.157" = _SzENzmUL;
        "pkg-1.20.1-1.2.7.9.158" = _1LK4mYGo;
        "pkg-1.20.1-1.2.7.10.159" = _T8bJQfWs;
        "pkg-1.20.1-1.2.7.12.160" = _1knlHCsv;
        "pkg-1.21.1-1.2.9.19.161" = _16yRmlgI;
        "pkg-1.20.1-1.2.7.13.162" = _ICEMmcKC;
        "pkg-1.20.1-1.2.7.14.163" = _rmV9VK9s;
        "pkg-1.21.1-1.2.9.20.164" = _GAzmu5EF;
        "pkg-0.5.110+mc1.19.4-SNAPSHOT-local" = _H2ACp1qT;
        "pkg-1.20.1-1.2.7.15.166" = _BP3CQI2v;
        "pkg-1.21.1-1.2.9.21.168" = _ZLVrtF0Q;
        "default" = _ZLVrtF0Q;
    });
