...
let
    ...
    in {
        ...
        "pkg-1.19-1.0.1" = _2pwkQOab;
        "pkg-1.19-1.1.0" = _68Z9J1jm;
        "pkg-1.19-1.2.0" = _zbdvhxBX;
        "pkg-1.19-1.2.1" = _gYwqQrkH;
        "pkg-1.19-1.2.2" = _aEPbY2ib;
        "pkg-1.19.4-1.3.0" = _Th8LOkDF;
        "pkg-1.19.4-2.0.0" = _kVzJHQxV;
        "pkg-1.19-2.0.0" = _wU4A1GgO;
        "pkg-1.19-2.0.0b" = _vEXGEu0m;
        "pkg-2.0.0" = _5yBBBe0B;
        "pkg-2.1.0" = _LSWMMsCf;
        "pkg-2.2.0" = _unAXrpYL;
        "pkg-2.3.0" = _Tw3v1YmL;
