...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _tTTzyERr;
        "pkg-1.0.1-beta+1" = _pVkSDJnt;
        "pkg-1.0.1-beta+2" = _pkYOGJdP;
        "pkg-1.0.1-beta+3" = _yAT4pRkk;
        "pkg-1.0.1-beta+4" = _LJjh9NKI;
        "pkg-1.0.1-beta+5" = _qp3hv1tA;
        "pkg-1.0.1-beta+6" = _hOiy8yCf;
        "pkg-1.0.1-beta+7" = _ndASh9y0;
        "pkg-1.0.1-beta+8" = _kDWYtIum;
        "pkg-1.0.1-beta+9" = _ezkZ33JQ;
        "pkg-1.0.1-beta+10" = _PN8whxkq;
        "pkg-1.2.0" = _uOTp4YKZ;
        "pkg-1.2.1" = _Xio1BPAF;
        "pkg-1.2.2" = _yYnEEbgK;
        "pkg-1.3.0" = _5db3V5Wq;
        "pkg-1.3.1" = _T2sNM2Y5;
        "pkg-1.3.2-beta+1" = _H6qKQfWU;
        "pkg-1.3.2-beta+2" = _gtB7OoJV;
        "pkg-1.3.2-beta+3" = _4jkIKKDD;
        "pkg-1.3.2-beta+4" = _L6zmL7sR;
        "pkg-1.3.2" = _bYVL4hgR;
        "pkg-1.3.3-beta+1" = _6xeM1CCd;
        "pkg-1.3.3-beta+2" = _WrQyFikD;
        "pkg-1.3.3-beta+2(1.21.3)" = _ZNkfDTcJ;
        "pkg-1.3.3-beta+3" = _dd0HNSMv;
        "pkg-1.3.3-beta+3(1.21.1)" = _EMIMOBAm;
        "pkg-1.3.3-beta+4" = _iUaaHoYQ;
        "pkg-1.3.3" = _1mMN5zIV;
        "pkg-1.3.4-beta.1+1.21.1" = _yq9EKfWK;
        "pkg-1.3.4-beta.1" = _tYGTv4Km;
        "pkg-1.3.4-beta.2" = _6mr3OHtj;
        "pkg-1.3.4-beta.2+1.21.1" = _RJwzu0AJ;
        "pkg-1.3.4-beta.3+1.21.1" = _ZAV5nnYB;
        "pkg-1.3.4-beta.3" = _encvH7vd;
        "pkg-1.3.4-beta.4" = _HpBuBgiX;
        "pkg-1.3.4-beta.4+1.21.1" = _zd9JxTnb;
        "pkg-1.3.4-beta.5" = _gcdqUr6o;
        "pkg-1.3.4-beta.5+1.21.1" = _1UyEK7sV;
        "pkg-1.3.4-beta.5+1.21.4" = _23zHJ3mo;
        "pkg-1.3.4" = _vsDW7lDp;
        "pkg-1.3.4+1.21.1" = _5yt2EMR2;
        "pkg-1.3.4+1.21.4" = _yDjW3QBf;
        "pkg-1.4.0" = _107alniP;
        "pkg-1.4.0+1.21.4" = _yULjKyow;
        "pkg-1.4.0+1.21.3" = _spBxzO1V;
        "pkg-1.4.0+1.21.1" = _LGDJSRXI;
        "default" = _LGDJSRXI;
    });
