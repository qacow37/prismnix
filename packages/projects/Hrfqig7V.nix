...
let
    ...
    in {
        ...
        "pkg-1.21.1-2.2.1" = _FHNRJyYa;
        "pkg-1.21.1-3.0.0" = _xoLiF7w4;
        "pkg-1.21.1-3.1.0" = _Zg9uOTXY;
        "pkg-1.21.1-4.0.1" = _S6ArT5tr;
        "pkg-1.21.1-4.3.0" = _81hcFDN4;
        "pkg-1.21.1-4.4.0" = _5aqDKJRx;
        "pkg-1.20.1-1.0.0" = _43auhmMN;
        "pkg-1.21.1-4.4.1" = _TneDN7m9;
        "pkg-1.20.1-1.0.1" = _QU0cE2mj;
        "pkg-1.20.1-1.0.2" = _siUx1fRS;
        "pkg-1.21.1-4.4.2" = _SiAOJmSa;
        "pkg-1.20.1-1.0.3" = _FOMdJPcJ;
        "pkg-1.20.1-1.0.4" = _1hcfkHmo;
        "pkg-1.20.1-1.0.5" = _7g7g1W3l;
        "pkg-1.21.1-4.4.3" = _goq76ZIw;
        "pkg-1.20.1-1.0.6" = _U2qKaD9M;
        "pkg-1.21.1-4.4.4" = _IrWiKgHz;
        "pkg-1.21.1-5.0.0" = _eWeHpVbU;
        "pkg-1.21.1-5.0.1" = _7zVsJatQ;
        "pkg-1.21.1-5.0.2" = _bJaRppuA;
        "pkg-1.21.1-5.0.3" = _9VIHijSV;
        "pkg-1.21.1-5.0.4" = _CFhNoZPi;
        "pkg-1.21.1-5.0.6" = _qVLvKOsH;
        "pkg-1.20.1-1.0.7" = _1a6nBnG4;
        "pkg-1.21.1-5.0.5-HOTFIX" = _e5erbKyv;
        "pkg-1.20.1-1.0.7-HOTFIX" = _DpGcn3G5;
        "pkg-1.20.1-1.1.1" = _B67ISBdi;
        "pkg-1.20.1-1.1.2" = _PwlNN7om;
        "pkg-1.20.1-1.1.3" = _BPzwbH69;
        "pkg-1.21.1-5.0.7" = _hmbfal3f;
        "pkg-1.21.1-5.0.8" = _krKMKPnO;
        "pkg-1.20.1-1.1.4" = _GFsAxPwk;
        "pkg-1.20.1-1.2.2" = _eHgbOYiG;
        "pkg-1.20.1-1.2.3" = _Mp27Xto3;
        "pkg-1.20.1-1.2.4" = _i0DAosvu;
        "pkg-1.20.1-1.2.5" = _Uffgxntn;
        "pkg-1.20.1-1.3.0" = _jfYybOxz;
        "pkg-1.20.1-1.3.1" = _1Wlv08Wp;
        "pkg-1.20.1-1.3.2" = _7EU00Eca;
        "pkg-1.21.1-5.0.9" = _1cmLjpki;
        "pkg-1.20.1-1.3.3" = _xQfX3fec;
        "pkg-1.20.1-1.3.4" = _qyxjhBwQ;
        "pkg-1.21.1-5.1.0" = _QRl853JB;
        "pkg-1.21.1-5.1.1" = _ySi6ZEae;
        "pkg-1.21.1-5.2.0" = _CZzeonys;
        "pkg-1.20.1-1.4.0" = _NiRVxSBs;
        "default" = _NiRVxSBs;
    });
