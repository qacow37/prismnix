...
let
    ...
    in {
        ...
        "pkg-v1.0.0" = _rQy9EYex;
        "pkg-v1.0.0+mod" = _NKjVQVRV;
        "pkg-v1.0.1" = _zUOtgZFb;
        "pkg-v1.0.1+mod" = _6j88f7ID;
        "pkg-v1.0.2" = _gI0KN9Mf;
        "pkg-v1.0.2+mod" = _gcSEsJ7z;
        "pkg-v1.1.0b" = _xKbOKNRi;
        "pkg-v1.1.0b+mod" = _HbcxjzwX;
        "pkg-v1.1.1" = _RDqHJmhG;
        "pkg-v1.1.1+mod" = _miWR5lie;
        "pkg-v1.1.2" = _5OuQvE9Q;
        "pkg-v1.1.2+mod" = _HnaPSDmn;
        "pkg-v1.1.3" = _lRSpXgsw;
        "pkg-v1.1.3+mod" = _VWBMiksY;
        "pkg-v1.1.4" = _PQAiqayk;
        "pkg-v1.1.4+mod" = _kVXhPjDw;
        "pkg-v1.2.0" = _rREVbQrr;
        "pkg-v1.2.0b" = _lz61KhWm;
        "pkg-v1.2.0b+mod" = _KaD4vrUQ;
        "pkg-v1.2.0c" = _E4szU79i;
        "pkg-v1.2.0c+mod" = _GDhjbLMd;
        "pkg-v2.0.0" = _K5W2Km2Q;
        "pkg-v2.0.0+mod" = _pQZBzhST;
        "pkg-v2.0.1" = _NHTuAM77;
        "pkg-v2.0.1+mod" = _cB05mQB9;
        "default" = _cB05mQB9;
    });
