...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _YYzMFqTS;
        "pkg-1.1.1" = _7v5XLI1b;
        "pkg-1.1.1-1.19.4" = _pLmZERF9;
        "pkg-1.1.1-1.20.0" = _aJiMrtqD;
        "pkg-1.1.1-1.20.2" = _FGoOmEar;
        "pkg-1.1.1-1.20.4" = _6npQZyZN;
        "pkg-1.1.1-1.20.6" = _Orfwm5Ag;
        "pkg-1.1.1-1.21" = _vY0WQD77;
        "pkg-1.2.0-1.21.3" = _DQmg6YFX;
        "pkg-1.2.0+1.21.4" = _Np1Hglws;
        "pkg-1.2.1+1.21.3" = _kYfCkyOl;
        "pkg-1.2.1+1.21.4" = _TZbvwHJ3;
        "pkg-1.2.1+1.21.1" = _oM5zLt1Z;
        "pkg-1.3.0+1.21.5" = _dQwhzyb0;
        "pkg-1.3.0+1.21.8-fabric" = _BFGUzmX7;
        "pkg-1.3.0+1.21.8-neoforge" = _ySFNiuKx;
        "pkg-2.0.0+1.21.11" = _ITsW0Qgr;
        "pkg-2.1.0+1.21.11" = _wZVDuv3R;
        "pkg-2.1.1+1.21.11" = _C4IqxZ7H;
        "pkg-2.1.2+1.21.11" = _tVufhSHl;
        "pkg-2.1.2+26.1.1" = _QLe68Z8p;
        "pkg-2.1.2+26.1" = _znxxRVTP;
        "pkg-2.1.2+26.2" = _uMk0y4qS;
        "default" = _uMk0y4qS;
    });
