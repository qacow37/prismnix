...
let
    ...
    in {
        ...
        "pkg-1.15.2-1.1" = _mEfcBLrr;
        "pkg-1.16.5-1.1" = _7v9c09PZ;
        "pkg-1.17.1-1.1.1" = _ktPIeilm;
        "pkg-1.18.2-1.1.1" = _D2bLU9Wv;
        "pkg-1.19-1.1.1" = _bjFzDt1o;
        "pkg-1.19.2-1.1.1" = _DCWtLDt7;
        "pkg-1.19.3-1.1.1" = _UCr9wrly;
        "pkg-1.19.4-1.1.1" = _sy7XW3XS;
        "pkg-1.20-pre-1.1.1" = _4NOvPOE6;
        "pkg-1.20.1-1.1.1" = _FbxcDBxy;
        "pkg-1.20.2-1.1.1" = _u8ekpfw9;
        "pkg-1.20.4-1.1.1" = _cSYrag8g;
        "pkg-1.20.5-1.1.1" = _ukDmZ2d0;
        "pkg-1.20.6-1.1.1" = _5T09o4kh;
        "pkg-1.21-1.1.1" = _RYkZjRb5;
        "pkg-1.21.1-1.1.1" = _xCWQ8iLW;
        "pkg-1.21.2-1.1.1" = _vTQINH8N;
        "pkg-1.21.3-1.1.1" = _eXVJHSUI;
        "pkg-1.21.4-1.1.1" = _HwP123tD;
        "pkg-1.21.5-1.1.1" = _B9r6kFV3;
        "pkg-1.21.8-1.1.1" = _85dfy06U;
        "pkg-1.21.10-1.1.1" = _zDX9vld7;
        "pkg-1.21.11-1.1.1" = _ynn1YGnX;
        "pkg-1.21.11-1.2.0" = _HPJcBg0P;
        "default" = _HPJcBg0P;
    });
