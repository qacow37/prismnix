...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.6.7" = _I5OGheCd;
        "pkg-1.18.2-0.7.0-fabric" = _PQUfLiyd;
        "pkg-1.18.2-0.7.0-forge" = _AYobJk58;
        "pkg-1.18.2-0.7.1-fabric" = _EOEhSxFH;
        "pkg-1.18.2-0.7.1-forge" = _ig3LE5ql;
        "pkg-1.18.2-0.7.2-fabric" = _VPNW4dyN;
        "pkg-1.18.2-0.7.2-forge" = _xHYu0R6s;
        "pkg-1.18.2-0.7.3" = _gtmvDAPy;
        "pkg-1.18.2-0.7.4" = _nRJGKvJo;
        "pkg-1.18.2-0.7.5" = _dTq5OzFd;
        "pkg-1.18.2-0.7.6" = _d70gQfWU;
        "pkg-1.18.2-0.8.0" = _EV727Zik;
        "pkg-1.18.2-0.8.1" = _BIOdn666;
        "pkg-1.18.2-0.8.2" = _SJDbfe1x;
        "pkg-1.18.2-0.8.3" = _w6pZtaMZ;
        "pkg-1.18.2-0.8.4" = _JNqHLBg9;
        "pkg-1.18.2-0.8.5" = _d7CuKViX;
        "pkg-1.19.2-0.9.0" = _r3NZUlKq;
        "pkg-1.19.2-0.9.1" = _cSRZ3QYi;
        "pkg-1.18.2-0.8.6" = _Hor3yNYH;
        "pkg-1.18.2-0.8.7" = _ZzpcvJYv;
        "pkg-1.19.2-0.9.2" = _kFVEpxTM;
        "pkg-1.19.2-0.9.3" = _YLKrbd6M;
        "pkg-1.19.2-0.9.5" = _9oupYaGV;
        "pkg-1.19.2-0.9.6" = _dt2AROrO;
        "pkg-1.19.2-0.9.7" = _ihwkekMt;
        "pkg-1.19.2-0.9.8" = _p5O8bkdR;
        "pkg-1.19.2-0.9.9" = _qCKLjaRJ;
        "pkg-1.19.2-0.9.10" = _zlhGhw4o;
        "pkg-1.18.2-0.8.8" = _JLvQjBV1;
        "pkg-1.19.2-0.9.11" = _y2UFUBRb;
        "pkg-1.19.2-0.9.12" = _KGTV90x1;
        "pkg-1.19.2-0.9.13" = _nqamDuYV;
        "pkg-1.19.2-0.9.14" = _2mRdsNFQ;
        "pkg-1.18.2-0.8.9" = _rMreUzEa;
        "pkg-1.19.2-0.9.15" = _J9JzJ5lA;
        "pkg-1.19.2-0.9.16" = _O5Tq7PVt;
        "pkg-1.19.2-0.9.17" = _X11o4Zci;
        "pkg-1.19.2-0.9.18" = _NWkVJyCZ;
        "pkg-1.19.2-0.9.19" = _XxSouyhN;
        "pkg-1.19.2-0.9.20" = _DNBTM3vA;
        "pkg-1.19.2-0.9.21" = _PTxtHIuZ;
        "pkg-1.21-0.10.0" = _Y2sQfBiL;
        "pkg-1.21-0.10.1" = _eWIrHT5w;
        "pkg-1.21-0.10.2" = _TLSlkRM8;
        "pkg-1.21-0.10.3" = _XKMuZNxe;
        "pkg-1.21-0.10.4" = _yTSDC1If;
        "pkg-1.21-0.10.5" = _UO733G6n;
        "pkg-1.21-0.10.6" = _c2C261nt;
        "pkg-1.21-0.10.7" = _KQGGZnxe;
        "pkg-1.21.1-0.10.8" = _dvbiNBf1;
        "pkg-1.21.1-0.10.9" = _xzASbm4M;
        "pkg-1.21.1-0.10.10" = _PT65pKFG;
        "pkg-1.21.1-0.10.11" = _JuWLjiQs;
        "pkg-1.21.1-0.10.12" = _QadZW86C;
        "pkg-1.21.1-0.10.13" = _U13WWob2;
        "pkg-1.21.1-0.10.14" = _otE61Asv;
        "pkg-1.19.2-0.9.22" = _MCvnrTqf;
        "pkg-1.21.1-0.10.15" = _IZks5uUa;
        "pkg-1.21.1-0.10.16" = _kj15SaKE;
        "pkg-1.21.1-0.10.17" = _QdPEGkcq;
        "pkg-1.21.1-0.10.18" = _HnfO4xIF;
        "pkg-1.21.1-0.10.19" = _KzSnDLYG;
        "pkg-1.21.1-0.10.20" = _jnxfka22;
        "pkg-1.21.1-0.10.21" = _OkooASii;
        "pkg-1.21.1-0.10.22" = _zQNSSlQh;
        "pkg-1.21.1-0.10.23" = _aBSePT4T;
        "pkg-1.21.1-0.10.24" = _uMnseom3;
        "pkg-1.21.1-0.10.25" = _OTfgsNZM;
        "pkg-1.21.1-0.10.26" = _F3s3hMPR;
        "pkg-1.21.1-0.10.27" = _Li432KNU;
        "pkg-1.21.1-0.10.28" = _YwMP8z5E;
        "pkg-1.21.1-0.10.29" = _IJNYnaUH;
        "pkg-1.21.1-0.10.30" = _zgiqfCw7;
        "pkg-1.21.1-0.10.31" = _W9QwUguu;
        "pkg-1.21.1-0.10.32" = _555fw6br;
        "pkg-1.21.1-0.10.33" = _nTvhYuXZ;
        "pkg-1.21.1-0.10.34" = _9HglHTTz;
        "pkg-1.21.1-0.10.35" = _wsReKbfP;
        "pkg-1.21.1-0.10.36" = _QeVHsMom;
        "pkg-1.21.1-0.10.37" = _OoiFqtql;
        "pkg-1.21.1-0.10.38" = _U1XwwrX5;
        "pkg-1.21.1-0.10.39" = _YA5ePLGg;
        "pkg-1.21.1-0.10.40" = _EpOy5xHC;
        "pkg-1.21.1-0.10.41" = _s5RsVrtI;
        "pkg-1.21.1-0.10.42" = _s3JhcFJd;
        "pkg-1.19.2-0.9.23" = _xyUH9p0p;
        "pkg-1.21.1-0.10.43" = _gpXzXECS;
        "pkg-1.21.1-0.10.44" = _1D1scWGr;
        "pkg-1.21.1-0.10.45" = _vPtnKrf5;
        "pkg-1.21.1-0.10.46" = _V8ClYqQq;
        "pkg-1.21.1-0.10.47" = _tWCRTbBL;
        "pkg-1.21.1-0.10.48" = _4tp1j6Yr;
        "pkg-1.21.1-0.10.49" = _TNXVjOfY;
        "pkg-1.21.1-0.10.50" = _cXztl8ZE;
        "pkg-1.21.1-0.10.51" = _QncOaxCh;
        "pkg-1.21.1-0.10.52" = _fYKahj2p;
        "pkg-1.21.1-0.10.53" = _wIEqUsZv;
        "pkg-1.21.1-0.10.54" = _UGW7IEHe;
        "pkg-1.21.1-0.10.55" = _BuVSVFqd;
        "pkg-1.21.1-0.10.56" = _2V9VsZC4;
        "pkg-1.21.1-0.10.57" = _zv9PBAY5;
        "pkg-1.21.1-0.10.58" = _dNIS5HtG;
        "pkg-1.21.1-0.10.59" = _z1wlxjGq;
        "pkg-1.21.1-0.10.60" = _DZziNEla;
        "pkg-1.21.1-0.10.61" = _skb8N5WA;
        "pkg-1.21.1-0.10.62" = _Rjc5mPcc;
        "pkg-1.21.1-0.10.63" = _TaJ2Iy5K;
        "pkg-1.21.1-0.10.64" = _NTGKHswV;
        "pkg-1.21.1-0.10.65" = _HgaaEmoT;
        "pkg-1.21.1-0.10.66" = _WMhhxJEs;
