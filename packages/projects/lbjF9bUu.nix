...
let
    ...
    in {
        ...
        "pkg-1.20-0.1" = _mYCgPNZh;
        "pkg-1.20.2-0.1" = _hPJ2nvZZ;
        "pkg-1.20.1-0.1" = _RURetB47;
        "pkg-1.20.3-0.1" = _jigzGzc3;
        "pkg-1.20.4-0.1" = _lBxQwnrF;
        "pkg-1.20.6-0.1" = _5oNsJx93;
        "pkg-1.20.5-0.1" = _n6czpFVU;
        "pkg-1.20.1-0.1+1.20.1" = _bJsSXvrC;
        "pkg-1.20.2-0.1+1.20.2" = _TNhNvD3N;
        "pkg-1.20.4-0.1+1.20.4" = _qoygIRaM;
        "pkg-1.20.5-0.2" = _p4tjT2uQ;
        "pkg-1.20.6-0.2" = _pkYFSobx;
        "pkg-1.21-0.1" = _5ggQ0gRN;
        "pkg-1.21.1-0.1" = _mkM1A5Zp;
        "pkg-1.21-0.2" = _eV6pmuGF;
        "pkg-1.21.1-0.2" = _ZE81lmme;
        "pkg-1.21.3-0.1" = _gYpn0UN7;
        "pkg-1.21.4-0.1" = _l6E8MVpr;
        "pkg-1.21.5-0.1" = _p8oKLxHg;
        "pkg-1.21.5-0.2" = _56oHwJbH;
        "pkg-1.21.6-0.1" = _7RXvdPif;
        "pkg-1.21.7-0.1" = _28kYTBxz;
        "pkg-1.21.8-0.1" = _BmLm5NQw;
        "pkg-1.21.9-0.1" = _aooxFrm1;
        "pkg-1.21.10-0.1" = _B65OCwJk;
        "pkg-1.21.11-0.1" = _XFPzUpoD;
        "pkg-26.1-0.1" = _NGkg8bz8;
