...
let
    ...
    in {
        ...
        "pkg-v1.1" = _qyoANGr8;
        "pkg-v1.1+mod" = _pfZjab6N;
        "pkg-v1.2" = _g485D38Q;
        "pkg-v1.2+mod" = _LEkxbqdY;
        "pkg-v1.3" = _wdqL8sD6;
        "pkg-v1.3+mod" = _oytWDSby;
        "pkg-v1.4" = _EEYQu0RA;
        "pkg-v1.4+mod" = _1RRY7xuE;
        "pkg-v1.5" = _qusB30HS;
        "pkg-v1.5+mod" = _yBatxYP8;
        "pkg-v1.6" = _3RTiFhSV;
        "pkg-v1.6+mod" = _9BJfTFi9;
        "pkg-v1.6.1" = _AF61gcrC;
        "pkg-v1.6.1+mod" = _1Pnoo0GP;
        "pkg-v2" = _A8YDctyr;
