...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _K2Jmctca;
        "pkg-1.0.2" = _gZ7pSjxV;
        "pkg-1.0.1+1.19.3" = _AWTe1G58;
        "pkg-1.1.0+1.19.3" = _2ftvAle4;
        "pkg-1.1.0+1.19.4" = _owEu05Ro;
        "pkg-1.1.0+1.20" = _5tpNmCxa;
        "pkg-1.1.0+1.20.1" = _SQHejBlk;
        "pkg-2.0.0+1.20" = _vwtCGtEn;
        "pkg-2.0.1+1.20" = _Sq2xJKa8;
        "pkg-2.0.2+1.20" = _qLLiqPoz;
        "pkg-2.0.2+1.19.2" = _CLyCoQ4o;
        "pkg-2.0.2+1.20.2" = _HhYgUVhk;
        "pkg-2.0.3+1.20.2" = _76N29MOa;
        "pkg-2.1.0+1.20.4" = _qIFmBYrq;
        "pkg-3.0.0+1.20.2" = _VgATolxd;
        "pkg-3.0.0+1.20.1" = _b24JyMAT;
        "pkg-3.0.0+1.20.4" = _SLTFgIah;
        "pkg-3.0.0+1.20.6" = _K9AfMCoy;
        "pkg-3.0.1+1.20.1" = _Ta4zx2Co;
        "pkg-3.0.1+1.20.2" = _tMgsZI62;
        "pkg-3.0.1+1.20.4" = _j6zl8zrz;
        "pkg-3.0.1+1.20.6" = _yxk4zbqH;
        "pkg-3.1.0+1.20.6" = _wc6kmIb1;
        "pkg-3.1.0+1.20.4" = _oGrfJ3BT;
        "pkg-3.1.0+1.21" = _y9O4L6tm;
        "pkg-3.1.0+1.20.1" = _STWHerSu;
        "pkg-3.1.1+1.20.1" = _Iy15Rcw8;
        "pkg-3.1.1+1.20.4" = _Zuyen1tF;
        "pkg-3.1.1+1.21" = _cFruQdEq;
        "pkg-3.1.1+1.20.6" = _PAhrLBtU;
        "pkg-3.1.2+1.20.1" = _DycCvCNn;
        "pkg-3.1.2+1.20.6" = _7fK5McQX;
        "pkg-3.1.2+1.21" = _W01secNG;
        "pkg-3.1.2+1.20.4" = _i3LaxeYn;
        "pkg-3.1.3+1.20.1" = _ljM3G8Lt;
        "pkg-3.1.3+1.20.4" = _d0rPcyRh;
        "pkg-3.1.3+1.21" = _cge1r2wJ;
        "pkg-3.1.3+1.20.6" = _IqzpdySj;
        "default" = _IqzpdySj;
    });
