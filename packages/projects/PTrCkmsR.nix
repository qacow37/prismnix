...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _NLLkbnH2;
        "pkg-1.2.0" = _WwUwX22u;
        "pkg-1.3.0+1.21.11" = _iTxPN783;
        "pkg-1.4.0+1.21.1" = _YxmXoq5b;
        "pkg-1.4.0+1.21.2" = _IwC6jMFd;
        "pkg-1.4.0+1.21.3" = _MkDyZJ8C;
        "pkg-1.4.0+1.21.4" = _gricvBrA;
        "pkg-1.4.0+1.21.5" = _FLel8B5w;
        "pkg-1.4.0+1.21.6" = _pMZxugQn;
        "pkg-1.4.0+1.21.7" = _VVTfJAiU;
        "pkg-1.4.0+1.21.8" = _1ijz9oSX;
        "pkg-1.4.0+1.21.9" = _GjQb4qxx;
        "pkg-1.4.0+1.21.10" = _b3kl6B7A;
        "pkg-1.4.0+1.21.11" = _OuJnbld2;
        "pkg-1.4.2+1.21.1" = _kkIgW9EF;
        "pkg-1.4.2+1.21.2" = _hSahdET9;
        "pkg-1.4.2+1.21.3" = _hmQustPi;
        "pkg-1.4.2+1.21.4" = _2tHuPwE7;
        "pkg-1.4.2+1.21.5" = _moYjgesA;
        "pkg-1.4.2+1.21.6" = _1YdieXXz;
        "pkg-1.4.2+1.21.7" = _8MkJHIYi;
        "pkg-1.4.2+1.21.8" = _hxijNf3r;
        "pkg-1.4.2+1.21.9" = _4xir0euq;
        "pkg-1.4.2+1.21.10" = _COMTPEP4;
        "pkg-1.4.2+1.21.11" = _R4bzGkId;
        "pkg-1.5.1+1.21.11" = _I9rTz2XI;
        "pkg-1.5.1+1.21.10" = _fRpXXLNZ;
        "pkg-1.5.1+1.21.9" = _vM3OVCUO;
        "pkg-1.5.1+1.21.8" = _dY8Ft1ml;
        "pkg-1.5.1+1.21.7" = _o7hN8I5p;
        "pkg-1.5.1+1.21.6" = _kNrkSjIW;
        "pkg-1.5.1+1.21.5" = _KT1RMv3G;
        "pkg-1.5.1+1.21.4" = _KZ9y4fsd;
        "pkg-1.5.1+1.21.3" = _YWFB8oGR;
        "pkg-1.5.1+1.21.2" = _Hhzd4HIk;
        "pkg-1.5.1+1.21.1" = _cah1UgGW;
        "pkg-1.5.2+1.20" = _CTWnlsIy;
        "pkg-1.5.2+1.20.1" = _mI81uxo6;
        "pkg-1.5.2+1.20.2" = _NmBQV84Z;
        "pkg-1.5.2+1.20.3" = _cKEgu5JS;
        "pkg-1.5.2+1.20.4" = _4UJUlt0k;
        "pkg-1.5.2+1.20.5" = _6gnHopiJ;
        "pkg-1.5.2+1.20.6" = _8m8GfEcE;
        "pkg-1.5.2+1.21" = _G3BTd2K9;
        "pkg-1.5.2+1.21.1" = _mm5zNprQ;
        "pkg-1.5.2+1.21.2" = _gG4nwj4Y;
        "pkg-1.5.2+1.21.3" = _v9stmF3Q;
        "pkg-1.5.2+1.21.4" = _N0PpLoWY;
        "pkg-1.5.2+1.21.5" = _cPtDGStW;
        "pkg-1.5.2+1.21.6" = _QslGg93D;
        "pkg-1.5.2+1.21.7" = _AIXzvBqt;
        "pkg-1.5.2+1.21.8" = _Rg0m4gYa;
        "pkg-1.5.2+1.21.9" = _PGPPq4v6;
        "pkg-1.5.2+1.21.10" = _tEUOoB70;
        "pkg-1.5.2+1.21.11" = _4HOk6TTo;
        "pkg-1.5.2+26.1" = _VbujpLYB;
        "pkg-1.5.2+26.1.1" = _o1cQtLOe;
        "pkg-1.5.2+26.1.2" = _PVCpyrFY;
        "default" = _PVCpyrFY;
    });
