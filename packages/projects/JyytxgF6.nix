...
let
    ...
    in {
        ...
        "pkg-1.10.3" = _4KXGOeBh;
        "pkg-1.3.3" = _o6EU9wog;
        "pkg-1.10.5" = _2JnPmEOK;
        "pkg-1.3.4" = _f6rKTIpL;
        "pkg-1.10.6" = _wuLgj5ZX;
        "pkg-1.3.5" = _ayOSFfRq;
        "pkg-1.20.1-1.0" = _TdYmVZXd;
        "pkg-1.3.6" = _4qS0plB9;
        "pkg-1.10.7" = _CpfRhWJr;
        "pkg-1.20.1-1.1" = _M4QEKsOv;
        "pkg-1.20.2-1.1" = _l2AQdnd9;
        "pkg-1.2.8" = _ldsyyznh;
        "pkg-1.3.7" = _5aulPdCu;
        "pkg-1.20.1-1.2" = _pP8m9HZ0;
        "pkg-1.20.2-1.2" = _h2WfkFWO;
        "pkg-1.3.8" = _gY1kzZAZ;
        "pkg-1.10.8" = _1mKfdS97;
        "pkg-1.20.1-1.3" = _WJixhZzM;
        "pkg-1.20.2-1.3" = _PhFRZAzt;
        "pkg-1.20.4-1.3" = _PQ0nZ0rc;
        "pkg-1.21.1-0.1" = _B6PGGINc;
        "pkg-1.7.22" = _Zd2FSxrv;
        "pkg-1.10.9" = _DY7FkDTA;
        "pkg-1.20.4-1.4" = _kWWebior;
        "pkg-1.21.1-1.0" = _WoUrPFjT;
        "default" = _WoUrPFjT;
    });
