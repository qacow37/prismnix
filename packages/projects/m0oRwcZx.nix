...
let
    ...
    in {
        ...
        "pkg-1.3.1-fabric-universal" = _82Y9HLAL;
        "pkg-1.4.0-fabric-universal" = _fzCKxnmb;
        "pkg-1.4.1-fabric-universal" = _siH8aqXE;
        "pkg-2.0.0-fabric+mc.1.14.0-1.14.4" = _76WbU6l1;
        "pkg-2.0.0-fabric+mc.1.15.0-1.16.5" = _gBnuz9Hx;
        "pkg-2.0.0-fabric+mc.1.17.0-1.18.2" = _onI1q9qN;
        "pkg-2.0.0-fabric+mc.1.19.0-1.19.2" = _ZdSmFYOj;
        "pkg-2.0.0-fabric+mc.1.19.3-1.20.5" = _AQALw9w8;
        "pkg-2.0.0-fabric+mc.1.20.6-1.21.1" = _JPvsNzsT;
        "pkg-2.0.0-fabric+mc.1.21.2-plus" = _PWrOGpNk;
        "pkg-2.0.0-forge+mc.1.17.0-1.18.2" = _fqaOnIR6;
        "pkg-2.0.0-forge+mc.1.19.0-1.19.2" = _g3EZyh74;
        "pkg-2.0.0-forge+mc.1.19.3-1.20.5" = _j4yybBd2;
        "pkg-2.0.0-neoforge+mc.1.20.6-1.21.1" = _QjWWhHGW;
        "pkg-2.0.0-neoforge+mc.1.21.2-plus" = _fmYvuaAc;
        "pkg-2.0.1-forge+mc.1.17.0-1.17.1" = _QYuf6kjv;
        "pkg-2.0.1-forge+mc.1.18.0-1.18.2" = _iKpGlZa9;
        "pkg-2.0.2-neoforge+mc.1.21.0-1.21.1" = _ypX4HsXt;
        "pkg-2.0.2-neoforge+mc.1.20.6" = _6n6B0EOA;
        "pkg-2.0.2-forge+mc.1.20.0-1.20.5" = _4qdJqnPE;
        "pkg-2.0.2-neoforge+mc.1.21.2-plus" = _yTDvwFCH;
        "pkg-2.0.2-forge+mc.1.19.3-1.19.4" = _8pPbSuOK;
        "pkg-2.0.2-fabric+mc.1.21.2-plus" = _pl9AyvwH;
        "pkg-2.0.2-forge+mc.1.19.0-1.19.2" = _dI8majIo;
        "pkg-2.0.2-forge+mc.1.18.0-1.18.2" = _Pa9dJUyL;
        "pkg-2.0.2-fabric+mc.1.21.0-1.21.2" = _4qO9Ullq;
        "pkg-2.0.2-forge+mc.1.17.0-1.17.1" = _73dR8j3q;
        "pkg-2.0.2-fabric+mc.1.20.6" = _FMoAjhPR;
        "pkg-2.0.2-fabric+mc.1.20.0-1.20.5" = _YqJgaUi6;
        "pkg-2.0.2-fabric+mc.1.19.3-1.19.4" = _ysTDxBlr;
        "pkg-2.0.2-fabric+mc.1.19.0-1.19.2" = _PM1NQwFk;
        "pkg-2.0.2-fabric+mc.1.18.0-1.18.2" = _1XNvqqPo;
        "pkg-2.0.2-fabric+mc.1.16.0-1.16.5" = _nxmR795n;
        "pkg-2.0.2-fabric+mc.1.14.0-1.14.4" = _I8cjWEPg;
        "pkg-2.0.2-fabric+mc.1.17.0-1.17.1" = _Dbo3VM9V;
        "pkg-2.0.2-fabric+mc.1.15.0-1.15.2" = _PAiwrgME;
        "pkg-2.0.3-neoforge+mc.1.21.0-1.21.1" = _GM5oABnN;
        "pkg-2.0.3-neoforge+mc.1.21.2-plus" = _cTObxqcg;
        "pkg-2.0.3-neoforge+mc.1.20.6" = _f9wWDzB1;
        "pkg-2.0.3-forge+mc.1.20.0-1.20.5" = _lsLcuW1q;
        "pkg-2.0.3-forge+mc.1.19.3-1.19.4" = _Xow1R96u;
        "pkg-2.0.3-forge+mc.1.19.0-1.19.2" = _zSmt2Shu;
        "pkg-2.0.3-forge+mc.1.18.0-1.18.2" = _AbuzJBt2;
        "pkg-2.0.3-forge+mc.1.17.0-1.17.1" = _gJVaU1Jn;
        "pkg-2.0.3-fabric+mc.1.21.2-plus" = _bjMLka5b;
        "pkg-2.0.3-fabric+mc.1.21.0-1.21.2" = _aLUMU40V;
        "pkg-2.0.3-fabric+mc.1.20.6" = _th3sBFB2;
        "pkg-2.0.3-fabric+mc.1.20.0-1.20.5" = _xJ2DDo8e;
        "pkg-2.0.3-fabric+mc.1.19.3-1.19.4" = _i6NSMZ58;
        "pkg-2.0.3-fabric+mc.1.19.0-1.19.2" = _k6gfCzLg;
        "pkg-2.0.3-fabric+mc.1.18.0-1.18.2" = _Mwzxqu0j;
        "pkg-2.0.3-fabric+mc.1.17.0-1.17.1" = _tC1dTMnE;
        "pkg-2.0.3-fabric+mc.1.16.0-1.16.5" = _NIIqq1KA;
        "pkg-2.0.3-fabric+mc.1.15.0-1.15.2" = _zGhPy6m9;
        "pkg-2.0.3-fabric+mc.1.14.0-1.14.4" = _xsqCPEkK;
        "pkg-2.0.4-neoforge+mc.1.21.2-1.21.4" = _8aqf04z7;
        "pkg-2.0.4-neoforge+mc.1.21.5-plus" = _6sPkuyHI;
        "pkg-2.0.4-neoforge+mc.1.21.0-1.21.1" = _TcRjh7IY;
        "pkg-2.0.4-neoforge+mc.1.20.6" = _QEBNlgx2;
        "pkg-2.0.4-forge+mc.1.20.0-1.20.5" = _wI7mPzLg;
        "pkg-2.0.4-forge+mc.1.19.3-1.19.4" = _6m86ia4k;
        "pkg-2.0.4-forge+mc.1.19.0-1.19.2" = _xgfV84y9;
        "pkg-2.0.4-forge+mc.1.17.0-1.17.1" = _cl8QgvMB;
        "pkg-2.0.4-forge+mc.1.18.0-1.18.2" = _k3YpezZ2;
        "pkg-2.0.4-fabric+mc.1.21.5-plus" = _ISzhlRRl;
        "pkg-2.0.4-fabric+mc.1.21.2-1.21.4" = _uQYflB9n;
        "pkg-2.0.4-fabric+mc.1.21.0-1.21.2" = _9ss4EJYm;
        "pkg-2.0.4-fabric+mc.1.20.6" = _ua777NVg;
        "pkg-2.0.4-fabric+mc.1.20.0-1.20.5" = _4oWNKGuh;
        "pkg-2.0.4-fabric+mc.1.19.3-1.19.4" = _T94125uC;
        "pkg-2.0.4-fabric+mc.1.18.0-1.18.2" = _te8rkvyh;
        "pkg-2.0.4-fabric+mc.1.19.0-1.19.2" = _xWC6ukmx;
        "pkg-2.0.4-fabric+mc.1.17.0-1.17.1" = _n9lOArK9;
        "pkg-2.0.4-fabric+mc.1.16.0-1.16.5" = _wMJ2SYyF;
        "pkg-2.0.4-fabric+mc.1.15.0-1.15.2" = _Y4uneokZ;
        "pkg-2.0.4-fabric+mc.1.14.0-1.14.4" = _U1xQlQFP;
        "pkg-2.0.5-fabric+mc.1.14.0-1.14.4" = _C5fdqlYT;
        "pkg-2.0.5-fabric+mc.1.15.0-1.15.2" = _Xbdub51N;
        "pkg-2.0.5-fabric+mc.1.16.0-1.16.5" = _veejQvbK;
        "pkg-2.0.5-fabric+mc.1.17.0-1.17.1" = _sb7ay6Sh;
        "pkg-2.0.5-fabric+mc.1.18.0-1.18.2" = _UzmAlb4R;
        "pkg-2.0.5-fabric+mc.1.19.0-1.19.2" = _76RNjOnJ;
        "pkg-2.0.5-fabric+mc.1.19.3-1.19.4" = _VwXu0rVf;
        "pkg-2.0.5-fabric+mc.1.20.0-1.20.5" = _AOOtoo5Q;
        "pkg-2.0.5-fabric+mc.1.20.6" = _4AdgO45m;
        "pkg-2.0.5-fabric+mc.1.21.0-1.21.2" = _HqMGvenT;
        "pkg-2.0.5-fabric+mc.1.21.2-1.21.4" = _bCmw2oc8;
        "pkg-2.0.5-fabric+mc.1.21.5-1.21.8" = _gRB7p9n4;
        "pkg-2.0.5-fabric+mc.1.21.9-plus" = _7wU1FDlR;
        "pkg-2.0.5-forge+mc.1.17.0-1.17.1" = _YCHpPKBq;
        "pkg-2.0.5-forge+mc.1.18.0-1.18.2" = _95dNzUDU;
        "pkg-2.0.5-forge+mc.1.19.0-1.19.2" = _CqPnsZOo;
        "pkg-2.0.5-forge+mc.1.19.3-1.19.4" = _CfcfjkJK;
        "pkg-2.0.5-forge+mc.1.20.0-1.20.5" = _zBBrUmDU;
        "pkg-2.0.5-neoforge+mc.1.20.6" = _mDhPOnrL;
        "pkg-2.0.5-neoforge+mc.1.21.0-1.21.1" = _iZr6MEjg;
        "pkg-2.0.5-neoforge+mc.1.21.2-1.21.4" = _KODWNfgx;
        "pkg-2.0.5-neoforge+mc.1.21.5-1.21.8" = _rxhIta2c;
        "pkg-2.0.5-neoforge+mc.1.21.9-plus" = _8tylxO2b;
        "pkg-2.0.6-fabric+mc.1.15.0-1.15.2" = _CkHbGAKK;
        "pkg-2.0.6-fabric+mc.1.14.0-1.14.4" = _BBoyjOkf;
        "pkg-2.0.6-fabric+mc.1.16.0-1.16.5" = _QdtMC0Vs;
        "pkg-2.0.6-fabric+mc.1.17.0-1.17.1" = _nx02wWrq;
        "pkg-2.0.6-fabric+mc.1.18.0-1.18.2" = _R3E8kueM;
        "pkg-2.0.6-fabric+mc.1.19.0-1.19.2" = _o6N6rj4N;
        "pkg-2.0.6-fabric+mc.1.19.3-1.19.4" = _DHXuN306;
        "pkg-2.0.6-fabric+mc.1.20.0-1.20.5" = _ZWBJA0XZ;
        "pkg-2.0.6-fabric+mc.1.20.6" = _z4xan6vC;
        "pkg-2.0.6-fabric+mc.1.21.0-1.21.2" = _9Lrvwa1B;
        "pkg-2.0.6-fabric+mc.1.21.11-plus" = _Pq5dOFBk;
        "pkg-2.0.6-fabric+mc.1.21.2-1.21.4" = _LqLAj20i;
        "pkg-2.0.6-fabric+mc.1.21.5-1.21.8" = _k4nVb1VS;
        "pkg-2.0.6-fabric+mc.1.21.9-1.21.10" = _y8OOuYdV;
        "pkg-2.0.6-forge+mc.1.17.0-1.17.1" = _sP9J1I4C;
        "pkg-2.0.6-forge+mc.1.18.0-1.18.2" = _AMqOq4w8;
        "pkg-2.0.6-forge+mc.1.19.3-1.19.4" = _ITFzR45z;
        "pkg-2.0.6-forge+mc.1.19.0-1.19.2" = _R96Eo7MO;
        "pkg-2.0.6-forge+mc.1.20.0-1.20.5" = _st2IHj9P;
        "pkg-2.0.6-neoforge+mc.1.20.6" = _v68D0E2y;
        "pkg-2.0.6-neoforge+mc.1.21.0-1.21.1" = _zTY9SqFy;
        "pkg-2.0.6-neoforge+mc.1.21.11-plus" = _4AQYjDNH;
        "pkg-2.0.6-neoforge+mc.1.21.2-1.21.4" = _5yxcL02F;
        "pkg-2.0.6-neoforge+mc.1.21.5-1.21.8" = _C3Lh5mDA;
        "pkg-2.0.6-neoforge+mc.1.21.9-1.21.10" = _9v5ceR0D;
        "pkg-2.1.0-fabric+mc.1.15-1.15.2" = _BX9SPxEZ;
        "pkg-2.1.0-fabric+mc.1.14-1.14.4" = _Ml1RfJ6a;
        "pkg-2.1.0-fabric+mc.1.16-1.16.5" = _YawaR8lm;
        "pkg-2.1.0-fabric+mc.1.17-1.17.1" = _Zw7d3nZm;
        "pkg-2.1.0-fabric+mc.1.18-1.18.2" = _80XQUXHe;
        "pkg-2.1.0-fabric+mc.1.19-1.19.2" = _ov6LZ9ZM;
        "pkg-2.1.0-fabric+mc.1.19.3-1.19.4" = _601KSvlb;
        "pkg-2.1.0-fabric+mc.1.20.6" = _jDviiKcz;
        "pkg-2.1.0-fabric+mc.1.20-1.20.5" = _RbpkBT5P;
        "pkg-2.1.0-fabric+mc.1.21-1.21.2" = _ShYChush;
        "pkg-2.1.0-fabric+mc.1.21.11" = _op3egGJS;
        "pkg-2.1.0-fabric+mc.1.21.2-1.21.4" = _6TYtZwhI;
        "pkg-2.1.0-fabric+mc.1.21.5-1.21.8" = _SqFX19Zl;
        "pkg-2.1.0-fabric+mc.1.21.9-1.21.10" = _EOFz3zto;
        "pkg-2.1.0-fabric+mc.26.1-plus" = _1nugiUvj;
        "pkg-2.1.0-forge+mc.1.18-1.18.2" = _3MSh7LZY;
        "pkg-2.1.0-forge+mc.1.19.3-1.19.4" = _QH2i8RF2;
        "pkg-2.1.0-forge+mc.1.19-1.19.2" = _OIr2Z25A;
        "pkg-2.1.0-forge+mc.1.20-1.20.5" = _hOIitPur;
        "pkg-2.1.0-neoforge+mc.1.20.6" = _KFgsqpkE;
        "pkg-2.1.0-neoforge+mc.1.21-1.21.1" = _3vgbIV6p;
        "pkg-2.1.0-neoforge+mc.1.21.11" = _PZOTf0CF;
        "pkg-2.1.0-neoforge+mc.1.21.2-1.21.4" = _JzVdcBfc;
        "pkg-2.1.0-neoforge+mc.1.21.5-1.21.8" = _vNH5m81B;
        "pkg-2.1.0-neoforge+mc.1.21.9-1.21.10" = _hnoElOci;
        "pkg-2.1.0-neoforge+mc.26.1-plus" = _Mu3IOOMQ;
        "pkg-2.1.1-fabric+mc.1.14-1.14.4" = _bOcZiqwp;
        "pkg-2.1.1-fabric+mc.1.15-1.15.2" = _CoEW9lit;
        "pkg-2.1.1-fabric+mc.1.16-1.16.5" = _MlX1KhW9;
        "pkg-2.1.1-fabric+mc.1.17-1.17.1" = _DUw5Jwuo;
        "pkg-2.1.1-fabric+mc.1.18-1.18.2" = _oDYPquk9;
        "pkg-2.1.1-fabric+mc.1.19.3-1.19.4" = _94GAyrxY;
        "pkg-2.1.1-fabric+mc.1.19-1.19.2" = _Ed7YS4rA;
        "pkg-2.1.1-fabric+mc.1.20-1.20.5" = _GAwwsEPY;
        "pkg-2.1.1-fabric+mc.1.20.6" = _iXjmGlAH;
        "pkg-2.1.1-fabric+mc.1.21-1.21.2" = _zDas2ZO2;
        "pkg-2.1.1-fabric+mc.1.21.11" = _WmkhU8Rr;
        "pkg-2.1.1-fabric+mc.1.21.2-1.21.4" = _ox6a1aK0;
        "pkg-2.1.1-fabric+mc.1.21.5-1.21.8" = _ebGPUJjj;
        "pkg-2.1.1-fabric+mc.1.21.9-1.21.10" = _vO88sEHD;
        "pkg-2.1.1-fabric+mc.26.1-plus" = _VDq7aIuZ;
        "pkg-2.1.1-forge+mc.1.18-1.18.2" = _YccoVHNi;
        "pkg-2.1.1-forge+mc.1.19.3-1.19.4" = _m8dAFyPa;
        "pkg-2.1.1-forge+mc.1.19-1.19.2" = _ixj7KUOc;
        "pkg-2.1.1-forge+mc.1.20-1.20.5" = _VRToGhCT;
        "pkg-2.1.1-neoforge+mc.1.20.6" = _paYmsmHC;
        "pkg-2.1.1-neoforge+mc.1.21.11" = _WsitWDcz;
        "pkg-2.1.1-neoforge+mc.1.21-1.21.1" = _VJYAujQV;
        "pkg-2.1.1-neoforge+mc.1.21.2-1.21.4" = _Y76QQOv7;
        "pkg-2.1.1-neoforge+mc.1.21.5-1.21.8" = _s7snEhje;
        "pkg-2.1.1-neoforge+mc.1.21.9-1.21.10" = _ywjjaHNr;
        "pkg-2.1.1-neoforge+mc.26.1-plus" = _r4Tt2qWT;
        "default" = _r4Tt2qWT;
    });
