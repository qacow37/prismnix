...
let
    ...
    in {
        ...
        "pkg-1.16.1-1.0" = _VNIHYo4S;
        "pkg-1.16.1-1.1" = _22V51eeb;
        "pkg-1.16.1-1.2" = _BBp1Ht7h;
        "pkg-1.16.2-1.2" = _SY09VenW;
        "pkg-1.16.3-1.2" = _iNDf8mbl;
        "pkg-1.16.4-1.2" = _NgJjfCyF;
        "pkg-1.16.5-1.2" = _zUs9Vgt5;
        "pkg-1.16.5-1.2.1" = _TjLPVqmI;
        "pkg-1.16.5-1.2.2" = _hRJUG5Xo;
        "pkg-1.17.1-1.2.2" = _StKthMA6;
        "pkg-1.18-1.2.2" = _XSksSXqz;
        "pkg-1.18.1-1.2.2" = _H9dAZ15o;
        "pkg-1.18.2-1.2.2" = _x7DmS8iQ;
        "pkg-1.17.1-1.2.1" = _HyMe1SqH;
        "pkg-1.18.1-1.2.1" = _2qsF79sY;
        "pkg-1.19-22w11a-1.2.2" = _AY4rX0xw;
        "pkg-1.19-22w12a-1.2.2" = _RG1sefBd;
        "pkg-1.19-22w13a-1.2.2" = _T3itw2Db;
        "pkg-1.19-22w14a-1.2.2" = _kI9dy8G8;
        "pkg-1.19-22w15a-1.2.2" = _3vcvn13g;
        "pkg-1.19-22w16a-1.2.2" = _EMyoiwPl;
        "pkg-1.19-22w17a-1.2.2" = _XKt1bMiH;
        "pkg-1.19-22w18a-1.2.2" = _rsISLDV7;
        "pkg-1.19-22w19a-1.2.2" = _TSxHYCCz;
        "pkg-1.19-pre1-1.2.2" = _6jsTmhvc;
        "pkg-1.18.2-1.3.0" = _jza8mwaA;
        "pkg-1.19-pre2-1.2.2" = _mzY1n6x4;
        "pkg-1.19-pre3-1.2.2" = _Y0pN3hOt;
        "pkg-1.19-pre4-1.2.2" = _rwxJMXDM;
        "pkg-1.19-pre5-1.2.2" = _4U144muo;
        "pkg-1.19-rc1-1.2.2" = _mNO7kPkv;
        "pkg-1.19-rc2-1.2.2" = _HzenMeuz;
        "pkg-1.19-1.3.0" = _K7tk5koJ;
        "pkg-1.19-1.2.2" = _IowpPHxq;
        "pkg-1.19-1.3.1" = _RSnyj3e8;
        "pkg-1.19-1.3.2" = _K0ypDgDk;
        "pkg-1.18.2-1.3.1" = _VbGiDjpt;
        "pkg-1.19.2-1.2.2" = _gMUyTnza;
        "pkg-1.19.1-1.3.3" = _usg9RuS0;
        "pkg-1.19.2-1.3.3" = _4CFBTI2a;
        "pkg-1.19.3-1.3.3" = _fXamZM3X;
        "pkg-1.19.4-1.3.3" = _lKrs4UJx;
        "pkg-1.20-1.4.0" = _Dd0n7g4Q;
        "pkg-1.20.2-1.4.1" = _aY6uflgW;
        "pkg-1.20.4-1.4.1" = _tTe03F9x;
        "pkg-1.19.4-1.2.2" = _ixAWtOFc;
        "pkg-1.20.1-1.2.2" = _s70XtSBy;
        "pkg-1.20.2-1.2.2" = _2QHq3XUQ;
        "pkg-1.20.4-1.2.2" = _uy2D8ldc;
        "pkg-1.20.5-24w04a-1.2.2" = _CzYaidw6;
        "pkg-1.20.5-24w05a-1.2.2" = _LdgbH7ua;
        "pkg-1.20.5-24w05b-1.2.2" = _BXnnpWTh;
        "pkg-1.20.5-24w06a-1.2.2" = _J4Ddtomz;
        "pkg-1.20.5-24w07a-1.2.2" = _G81HTpoN;
        "pkg-1.20.5-24w09a-1.2.2" = _7jyTvWrP;
        "pkg-1.20.5-24w10a-1.2.2" = _aSkevZVq;
        "pkg-1.20.5-24w11a-1.2.2" = _k7dC0u8C;
        "pkg-1.20.5-24w12a-1.2.2" = _b5GypnFI;
        "pkg-1.20.5-24w13a-1.2.2" = _u3Nm3iIM;
        "pkg-1.20.5-24w14potato-1.2.2" = _vCd1tM1d;
        "pkg-1.20.5-24w14a-1.2.2" = _WxgoBmno;
        "pkg-1.20.5-pre1-1.2.2" = _KMf4FX9e;
        "pkg-1.20.5-pre2-1.2.2" = _8dV6Zpar;
        "pkg-1.20.5-pre3-1.2.2" = _VyR91Mvu;
        "pkg-1.20.5-pre4-1.2.2" = _r4l28cDj;
        "pkg-1.20.5-rc1-1.2.2" = _5TjCMX6H;
        "pkg-1.20.5-rc2-1.2.2" = _P8lhLtFH;
        "pkg-1.20.5-rc3-1.2.2" = _Eo67kCSl;
        "pkg-1.20.5-1.2.2" = _LDogH6Xi;
        "pkg-1.20.6-rc1-1.2.2" = _2zIzIklh;
        "pkg-1.20.6-1.2.2" = _h9MXIF0G;
        "pkg-1.20.6-1.4.1" = _1EHg9gW2;
        "pkg-1.21-1.4.2" = _khoRQHqO;
        "pkg-1.21.4-1.4.3" = _mGybFoA5;
        "pkg-1.21.1-1.2.2" = _HOk0WYYP;
        "pkg-1.21.4-1.2.2" = _AfsKacsJ;
        "pkg-1.21.5-25w08a-1.2.2" = _ev74o0YA;
        "pkg-1.21.5-25w08a-1.4.3" = _cm5jeaiv;
        "pkg-1.21.1-1.4.3" = _NYiz7wuJ;
        "pkg-1.21.5-25w09a-1.4.3" = _WPgra1JF;
        "pkg-1.21.5-25w09b-1.4.3" = _ho8EzzwG;
        "pkg-1.21.5-25w10a-1.4.3" = _Wnssdpwh;
        "pkg-1.21.5-pre1-1.4.3" = _WcPcRo2N;
        "pkg-1.21.5-pre2-1.4.3" = _L9bRFe35;
        "pkg-1.21.5-pre3-1.4.3" = _rFZWlRqj;
        "pkg-1.21.5-rc1-1.4.3" = _y25ajhDU;
        "pkg-1.21.5-rc2-1.4.3" = _w5ZdIdgZ;
        "pkg-1.21.5-1.4.3" = _zYGzenBj;
        "pkg-1.21.6-25w14craftmine-1.4.3" = _4d6yaTo7;
        "pkg-1.21.6-25w15a-1.4.3" = _7qDBLoSH;
        "pkg-1.21.5-1.4.4" = _RUbBNePS;
        "pkg-1.21.5-1.4.5" = _420RLDU8;
        "pkg-1.21.4-1.4.5" = _cTRBxHG4;
        "pkg-1.21.1-1.4.5" = _D01ZtuF7;
        "pkg-1.20.6-1.4.2" = _AEbMzSFD;
        "pkg-1.20.4-1.4.2" = _rc0fp2Iq;
        "pkg-1.20.2-1.4.2" = _alVuIKfU;
        "pkg-1.20.1-1.4.2" = _XrvMkwwJ;
        "pkg-1.21.6-25w16a-1.4.3" = _9qjr43oO;
        "pkg-1.21.6-25w17a-1.4.3" = _m5RNacSi;
        "pkg-1.21.6-25w18a-1.4.3" = _TZbkYbqk;
        "pkg-1.20.6-1.4.5" = _f5KoBI8v;
        "pkg-1.20.4-1.4.5" = _mO78d8FB;
        "pkg-1.20.2-1.4.5" = _IHvDB2AB;
        "pkg-1.21.6-25w19a-1.4.3" = _1Aj5Va3V;
        "pkg-1.21.6-25w20a-1.4.3" = _7w8WGWgh;
        "pkg-1.21.6-25w21a-1.4.3" = _p7pEfH4y;
        "pkg-1.20.6-1.4.3" = _jHAe7NSk;
        "pkg-1.20.4-1.4.3" = _8NETuJ0W;
        "pkg-1.21.6-1.4.5" = _GrQtnqYf;
        "pkg-1.21.7-1.4.3" = _PX1FjCC3;
        "pkg-1.21.8-1.4.3" = _WgeElCEM;
        "pkg-1.21.9-25w31a-1.4.3" = _30Qs9xPz;
        "pkg-1.21.9-25w32a-1.4.3" = _EUwj1ZUN;
        "pkg-1.21.9-25w33a-1.4.3" = _KSDO9iWw;
        "pkg-1.21.9-25w34a-1.4.3" = _h7NLesZ8;
        "pkg-1.21.9-25w34b-1.4.3" = _eDTctIid;
        "pkg-1.21.9-25w35a-1.4.3" = _wd6Ha4Ac;
        "pkg-1.21.10-1.4.6-forge" = _uunwexPB;
        "pkg-1.21.10-1.4.3" = _5rXJDWRl;
        "pkg-1.21.11-25w43a-1.4.3" = _hDfRH5uV;
        "pkg-1.21.11-1.4.6-forge" = _bURxdVh1;
        "pkg-1.21.11-1.4.3-fabric" = _pNZjH72w;
        "pkg-26.x.x-1.5.0-fabric" = _RlIn9b1h;
        "pkg-26.x.x-1.5.0-neo" = _xNoMlOsG;
        "pkg-26.x.x-1.5.0-forge" = _RCuesq6S;
        "default" = _RCuesq6S;
    });
