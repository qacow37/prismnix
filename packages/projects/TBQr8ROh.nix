...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _ugKijTog;
        "pkg-1.0.1" = _a3U8GCT9;
        "pkg-1.1+1.19.2" = _dLLOkSPX;
        "pkg-1.1+1.19.3" = _UP8Ibvj8;
        "pkg-1.2+1.19.2" = _bE1DWem3;
        "pkg-1.2+1.19.3" = _tLqAmW0u;
        "pkg-1.2+1.19.4" = _vrgH53KA;
        "pkg-1.2.1+1.19.4" = _oHUYmxQf;
        "pkg-1.3+1.19.4" = _3nFDKBtt;
        "pkg-1.3.1+1.19.4" = _7gGu44W1;
        "pkg-1.4+1.19.4" = _w09JT22l;
        "pkg-1.4.1+1.19.4" = _zAnvy1op;
        "pkg-1.4.1+1.20.1" = _NI8UWV2C;
        "pkg-1.4.2" = _bzbx1w2X;
        "pkg-1.4.3" = _f7rcLUbk;
        "pkg-1.5" = _bvBI1MlE;
        "pkg-1.5.1" = _5ZlC90xP;
        ...
        "pkg-1.11" = _l3hgR6J1;
        "pkg-1.12" = _TuetGBCB;
        "pkg-1.12.1+1.20.5" = _ncV729F3;
        "pkg-1.12.1+1.21" = _gxmV0HLj;
        "pkg-1.12.2+1.21" = _rMa4uVtE;
        "pkg-1.12.2+1.20.5" = _yesrhzME;
        "pkg-1.12.3+1.21.4" = _JpcS3S05;
        "pkg-1.12.3+1.21.2" = _X6oK1M8n;
        "pkg-1.12.3+1.21" = _sGrJSMEV;
        "pkg-1.12.4+1.21.5" = _eWzx5xZP;
        "pkg-1.12.4+1.21.2" = _4fGHfEmD;
        "pkg-1.12.4+1.21.4" = _Eu27pXec;
        "pkg-1.12.4+1.21" = _xg3VykwM;
        "pkg-1.12.5+1.21.5" = _HEvElO0j;
        "pkg-1.12.5+1.21.4" = _8y04gcQ7;
        "pkg-1.12.5+1.21.2" = _F4mnlUST;
        "pkg-1.12.5+1.21" = _KEoWISPo;
        "pkg-1.13+1.21.6" = _5mslNRmU;
        "pkg-1.13+1.21.5" = _hTh7LToF;
        "pkg-1.13+1.21.4" = _MFVNv3ri;
        "pkg-1.13+1.21.2" = _85m3r4gq;
        "pkg-1.13+1.21" = _yOFoBL1Z;
        "pkg-1.13.1+1.21.6" = _mLaDwkOU;
        "pkg-1.13.1+1.21.4" = _M9ejKiGu;
        "pkg-1.13.1+1.21.5" = _BtySH43a;
        "pkg-1.13.1+1.21.2" = _9mk4Z7JR;
        "pkg-1.13.1+1.21" = _q5BWikvb;
        "default" = _q5BWikvb;
    });
