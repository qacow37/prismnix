...
let
    ...
    in {
        ...
        "pkg-1.20.2-1.0-forge+fabric" = _83KPxwvQ;
        "pkg-1.18.2-1.1-forge+fabric" = _jB3AE3gK;
        "pkg-1.19.2-1.1-forge+fabric" = _LK1PKBXc;
        "pkg-1.20.1-1.1-forge+fabric" = _RfmqfcTP;
        "pkg-1.20.2-1.1-forge+fabric" = _3PBG19O5;
        "pkg-1.20.2-1.2-forge+fabric" = _aVrCJMNZ;
        "pkg-1.20.3-1.2-fabric+forge+neo" = _7ZuCTiPP;
        "pkg-1.20.4-1.2-fabric+forge+neo" = _VWj6rqbD;
        "pkg-1.19.2-1.3-fabric+forge+neo" = _lYONO726;
        "pkg-1.20.1-1.3-fabric+forge+neo" = _KeQWXgTO;
        "pkg-1.20.2-1.3-fabric+forge+neo" = _g0aL287R;
        "pkg-1.20.4-1.3-fabric+forge+neo" = _Rhb8VI0C;
        "pkg-1.19.2-1.4-fabric+forge" = _AOhzgTNy;
        "pkg-1.20.1-1.4-fabric+forge+neo" = _KMaqJIhP;
        "pkg-1.20.2-1.4-fabric+forge+neo" = _UGWOe5eL;
        "pkg-1.20.4-1.4-fabric+forge+neo" = _t87Sm1oy;
        "pkg-1.20.5-1.4-fabric+neo" = _i70jAKUT;
        "pkg-1.20.5-1.5-fabric+neo" = _tkVSjgs8;
        "pkg-1.20.6-1.5-fabric+forge+neo" = _hzXaErdJ;
        "pkg-1.19.2-1.6-fabric+forge" = _ahIi4B0h;
        "pkg-1.20.1-1.6-fabric+forge+neo" = _fnZdmKkL;
        "pkg-1.20.6-1.6-fabric+forge+neo" = _Bt9Pw4DO;
        "pkg-1.20.6-1.7-fabric+forge+neo" = _714F3sKc;
        "pkg-1.21.0-1.7-fabric+forge+neo" = _ELKbQHmF;
        "pkg-1.20.6-2.0-fabric+forge+neo" = _YMDq417r;
        "pkg-1.21.0-2.0-fabric+forge+neo" = _4C7iK3Cl;
        "pkg-1.20.6-2.1-fabric+forge+neo" = _BW5ft1v2;
        "pkg-1.21.0-2.1-fabric+forge+neo" = _UB6FYSfb;
        "pkg-1.20.1-2.2-fabric+forge+neo" = _XVduIs66;
        "pkg-1.20.6-2.2-fabric+forge+neo" = _R5LA76B5;
        "pkg-1.21.0-2.2-fabric+forge+neo" = _RPuqL2xq;
        "pkg-1.21.1-2.2-fabric+forge+neo" = _kpd30YSv;
        "pkg-1.21.2-2.2-fabric+neo" = _1N4bkqEl;
        "pkg-1.21.3-2.2-fabric+forge+neo" = _S93PGjFb;
        "pkg-1.21.4-2.2-fabric+forge+neo" = _JX4UOpl1;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _wSOkLR5u;
        "pkg-1.21.1-2.3-fabric+forge+neo" = _xIHaSWb8;
        "pkg-1.21.4-2.3-fabric+forge+neo" = _lcefPbHY;
        "pkg-1.20.1-2.4-fabric+forge+neo" = _IYK7je2o;
        "pkg-1.21.1-2.4-fabric+forge+neo" = _YY2aeHXl;
        "pkg-1.21.4-2.4-fabric+forge+neo" = _ne2ll2MP;
        "pkg-1.21.5-2.4-fabric+forge+neo" = _hL8qruP9;
        "pkg-1.21.6-2.4-fabric+forge+neo" = _buwbxwqJ;
        "pkg-1.21.7-2.4-fabric+forge+neo" = _L7bjBwei;
        "pkg-1.21.8-2.4-fabric+forge+neo" = _besfT5mx;
        "pkg-1.21.9-2.4-fabric+forge+neo" = _taQyGfnr;
        "pkg-1.21.9-2.5-fabric+forge+neo" = _tcK7IZDC;
        "pkg-1.21.10-2.5-fabric+forge+neo" = _SbblqHwe;
        "pkg-1.21.11-2.5-fabric+forge+neo" = _szdEpCK7;
        "pkg-26.1.0-2.5-fabric+forge+neo" = _GtqtKHfl;
