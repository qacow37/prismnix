...
let
    ...
    in {
        ...
        "pkg-1.0" = _SeVyvIGB;
        "pkg-1.0+mod" = _Ja6FsZWc;
        "pkg-1.1" = _RKiKBFYs;
        "pkg-1.1+mod" = _b9n3TzOI;
        "pkg-2.0-(1.21.4)" = _kCdtDFf7;
        "pkg-2.0-(1.21.4)+mod" = _YnefloSL;
        "pkg-2.0-(1.21.5)" = _CUccyujj;
        "pkg-2.0-(1.21.5)+mod" = _y3bfRPJf;
        "pkg-2.1" = _hsEiMMZI;
        "pkg-2.1+mod" = _zWEPU545;
        "pkg-2.2" = _MDT19eSN;
        "pkg-2.2+mod" = _rHTE6IKE;
        "pkg-2.2.1-(1.21.4)" = _hP2V74fe;
        "pkg-2.2.1-(1.21.4)+mod" = _pVGJx30n;
        "pkg-2.2.1-(1.21.5)" = _cFgN9orD;
        "pkg-2.2.1-(1.21.5)+mod" = _u4kDZG0G;
        "pkg-2.2.3" = _q4kAgJjD;
        "pkg-2.2.3+mod" = _UVP3Ffgk;
        "pkg-2.2.4" = _EBOb1xBn;
        "pkg-2.2.4+mod" = _6WXL9iqu;
        "pkg-2.2.5" = _jzFyNbht;
        "pkg-2.2.5+mod" = _PbwuH4lk;
        "pkg-2.2.6" = _3CG1Eo7B;
        "pkg-2.2.6+mod" = _fWwQEQEk;
        "pkg-2.3" = _OnUptx5e;
        "pkg-2.3+mod" = _wQVCe7ag;
        "pkg-2.3.1" = _RAvpsep0;
        "pkg-2.3.1+mod" = _723sVA03;
        "pkg-2.3.2" = _uMgjvPnD;
        "pkg-2.3.2+mod" = _tPFAYYH0;
        "pkg-2.3.3" = _nUD6bE1q;
        "pkg-2.3.3+mod" = _fjr6QVGh;
        "pkg-2.3.4" = _db09PJXy;
        "pkg-2.3.4+mod" = _dJSOHLA5;
        "pkg-2.3.5" = _okIQcRAd;
        "pkg-2.3.5+mod" = _QoReD2Io;
        "pkg-2.3.6" = _z6Zl70Pq;
        "pkg-2.3.6+mod" = _qXLNmRqj;
        "default" = _qXLNmRqj;
    });
