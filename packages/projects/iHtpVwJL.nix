...
let
    ...
    in {
        ...
        "pkg-0.8.60+mc1.19.2-build.40" = _ee1MemMe;
        "pkg-0.8.60+mc1.19.4-build.38" = _Etydp2Lx;
        "pkg-0.8.59+mc1.20.1-build.39" = _BRMjgBuq;
        "pkg-0.8.60+mc1.19.2-build.79" = _gTAM6Hcm;
        "pkg-0.8.60+mc1.19.4-build.80" = _vr1bfwBE;
        "pkg-0.8.60+mc1.20.1-build.76" = _Yxx4svxJ;
        "pkg-0.8.60+mc1.19.2-build.103" = _peS4MeFN;
        "pkg-0.8.60+mc1.19.4-build.105" = _JdHaQYBW;
        "pkg-0.8.60+mc1.20.1-build.104" = _VYBtjxrD;
        "pkg-1.19.2-0.9.7.19" = _TwXpjYvN;
        "pkg-1.20.1-0.10.44.23" = _48zGlJN3;
        "pkg-1.20.4-0.10.26.27" = _gWeoS9r9;
        "pkg-1.20.1-0.10.45.32" = _MYIOHAEN;
        "pkg-1.20.4-0.10.26.33" = _Q0PQjYuh;
        "pkg-1.20.1-0.10.45.44" = _PZQUlpfM;
        "pkg-1.21.1-0.10.52.47" = _yIu95YaH;
        "pkg-1.21.1-0.10.52.54" = _mdLWr3Ra;
        "pkg-1.21.1-0.10.55.1.62" = _XXhAUFk7;
        "pkg-1.20.1-0.10.50.1.63" = _qCJfzEFX;
        "pkg-1.20.1-0.11.3.1.73" = _YSSNL8GL;
        "pkg-1.21.1-0.11.5.1.76" = _xw6Q0X9w;
        "pkg-1.21.1-0.11.5.2.82" = _BioRhsFS;
        "pkg-1.20.1-1.0.10.1.100" = _ihRLMrcj;
        "pkg-1.21.1-1.0.13.1.101" = _bpVKdKAj;
        "pkg-1.20.1-1.3.5.1.114" = _QF6XmcRh;
        "pkg-1.21.1-1.3.7.1.115" = _WUdPSXsd;
        "pkg-1.21.1-1.3.7.4.123" = _YefZR2Lf;
        "pkg-1.21.1-1.3.7.5.124" = _aziDIflq;
        "pkg-1.20.1-1.3.5.4.126" = _EBbOq3Hh;
        "pkg-1.21.1-1.3.7.6.127" = _3DN9Zyve;
        "pkg-1.20.1-1.3.5.5.128" = _rEirxm6c;
        "pkg-1.20.1-1.3.5.6.130" = _5qhoat7N;
        "pkg-1.20.1-1.3.5.7.132" = _4HSdLYyr;
        "pkg-1.21.1-1.3.7.7.133" = _Qr2pggnH;
        "pkg-1.20.1-1.3.5.8.134" = _B7Vd5EyL;
        "pkg-1.21.1-1.3.7.8.135" = _wD87P4cv;
        "pkg-1.20.1-1.3.5.9.136" = _Cuu4V9Od;
        "pkg-1.21.1-1.3.7.9.139" = _kjNlOByJ;
        "pkg-1.20.1-1.3.5.10.141" = _HmBBMGjS;
        "pkg-1.20.1-1.3.5.11.142" = _xezSXA8y;
        "default" = _xezSXA8y;
    });
