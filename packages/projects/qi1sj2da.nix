...
let
    ...
    in {
        ...
        "pkg-forge-1.18.x" = _tUWRmQNy;
        "pkg-forge-1.17.1" = _dIRsIFfB;
        "pkg-forge-1.16" = _iZZeCZks;
        "pkg-1.1-fabric-1165" = _ZsWfTxvn;
        "pkg-1.1-fabric-1171" = _SnQ7Kwnc;
        "pkg-1.1-fabric-118x" = _VhIA5gZD;
        "pkg-1.1-fabric-1171m" = _2GO80JRG;
        "pkg-1.1-fabric-118xm" = _iDtN8SiU;
        "pkg-1.19-fabric-c-v1.1.0" = _tGONnWHW;
        "pkg-1.19-fabric-m-v1.1.0" = _KH9uWgno;
        "pkg-3.0.1+1.7.10" = _1v90QPAY;
        "pkg-3.0.5+1.16.5" = _dvMvZHIb;
        "pkg-3.0.5+1.19.2" = _JZgLIDIK;
        "pkg-3.0.5+1.19.3" = _cyilxHzp;
        "pkg-3.0.5+1.19.4" = _39jwWlw2;
        "pkg-3.0.6+1.19.4" = _jus61HnG;
        "pkg-3.0.5+1.20.1" = _vC06Ct3m;
        "pkg-3.0.5" = _CDKPcTlY;
        "pkg-3.0.6" = _16qDv2hy;
        "pkg-3.0.6+1.20.2+multi+forge" = _df2OykTe;
        "pkg-3.0.5+1.20.2+multi+fabric" = _c5DrfyzD;
        "pkg-3.0.6+1.20.2+forge+clientonly" = _yfwTKEf9;
        "pkg-3.0.5+1.20.2+fabric+clientonly" = _x9vWggW4;
        "pkg-1.20.4+forge+4.1.0" = _nBszPTRR;
        "pkg-1.20.1+forge+4.1.0" = _fyUPLUuB;
        "pkg-1.18.2+forge+4.1.0" = _Smmq0IDO;
        "pkg-1.19.2+forge+4.1.0" = _4nTgeQGF;
        "pkg-1.19.2+forge+4.1.1" = _iVzpQNS6;
        "pkg-1.20.4+forge+4.2.0" = _NPuZLPnu;
        "pkg-1.20.1+forge+4.2.0" = _5hURk4NG;
        "pkg-1.19.2+forge+4.2.0" = _i1drnozh;
        "pkg-1.19.4+forge+4.2.0" = _uQbOwoyK;
        "pkg-1.17.1+forge+4.2.0" = _iTdiulry;
        "pkg-1.16.5+forge+4.2.0" = _EbTFcQha;
        "pkg-1.15.2+forge+4.2.0" = _j4eRqgPT;
        "pkg-1.15.2+forge+4.2.1" = _aA1YyoRi;
        "pkg-1.16.x+forge+4.2.1" = _pGzgtc48;
        "pkg-1.18.2+forge+4.2.1" = _gCK0qBdO;
        "pkg-1.17.1+forge+4.2.1" = _gxxPe24w;
        "pkg-1.19.2+forge+4.2.1" = _kBLLu2Re;
        "pkg-1.19.4+forge+4.2.1" = _ZXE72zvG;
        "pkg-1.20.1+forge+4.2.1" = _bvlbuaiT;
        "pkg-1.20.4+forge+4.2.1" = _Qo27XvKA;
        "pkg-1.14.4+forge+4.2.1" = _9Lj10mDj;
        "pkg-1.13.2+forge+4.2.1" = _8rh5wYDJ;
        "pkg-1.12.2+forge+v4.2.1" = _Yxl5z1Hk;
        "pkg-1.11.2+forge+4.2.1" = _5gLcp9lH;
        "pkg-1.8.9+forge+4.2.3" = _nmPMdZh0;
        "pkg-1.7.10+forge+4.2.3" = _vl9ScDre;
        "pkg-1.9.4+forge+4.2.3" = _LvnpwoAM;
        "pkg-1.10.2+forge+4.2.3" = _OTUECufh;
        "pkg-1.11.2+forge+4.2.3" = _UzAMTnh2;
        "pkg-1.12.2+forge+4.2.3" = _7aAZLRmR;
        "pkg-1.13.2+forge+4.2.3" = _nnKqyS0W;
        "pkg-1.14.4+forge+4.2.3" = _yCHRU8V5;
        "pkg-1.15.2+forge+4.2.3" = _Qu4toPMA;
        "pkg-1.16.x+forge+4.2.3" = _OiMqS6nW;
        "pkg-1.17.1+forge+4.2.3" = _P4l8whAs;
        "pkg-1.18.2+forge+4.2.3" = _sRKyTEF3;
        "pkg-1.19.2+forge+4.2.3" = _krAkfZN3;
        "pkg-1.19.4+forge+4.2.3" = _2mizUCDP;
        "pkg-1.20.1+forge+4.2.3" = _D7JWWIQX;
        "pkg-1.7.10+forge+4.2.4" = _6rFP2ziB;
        "pkg-1.21+forge+4.2.3" = _GpsjiWmu;
        "pkg-1.21+neoforge+4.2.5" = _aTmIxqzV;
        "pkg-1.21+fabric+4.2.6" = _1WU1u1fM;
        "pkg-1.20.4+fabric+4.2.6" = _OlZ0qAi1;
        "pkg-1.20.1+fabric+4.2.6" = _jV5BFDGB;
        "pkg-1.21.3+forge+4.2.3" = _gO1yDj0H;
        "pkg-1.21.4+fabric+4.2.7" = _vnYh9tjm;
        "pkg-1.21.4+forge+4.3.0" = _GpuFaC4Y;
        "pkg-1.21.5+forge+4.3.0" = _ZvFYrgEO;
        "pkg-1.21.5+fabric+4.2.7" = _ehigFiA8;
        "pkg-1.21.1+neoforge+4.2.5" = _zkq1q79W;
        "pkg-1.21.1+neoforge+4.2.7" = _j4CtkXVs;
        "pkg-1.21.5+neoforge+4.2.7" = _Ae4D30qK;
        "pkg-forge-1.21.7-4.4.0" = _dG0jXAjS;
        "pkg-neoforge-1.21.7-4.4.1" = _EQR6Hb30;
        "pkg-forge-1.21.7-4.4.1" = _DGPcjI2b;
        "pkg-fabric-1.21.7-4.4.1" = _2jlDoY69;
        "pkg-fabric-1.21.1-4.4.1" = _RH0iuueJ;
        "pkg-fabric-1.21.1-4.4.2" = _XqohzxFI;
        "pkg-fabric-1.21.9-4.4.2" = _zhUbqf0T;
        "pkg-fabric-1.21.9-4.4.3" = _fpJYJY8t;
        "pkg-forge-1.21.9-4.4.3" = _Z7NWY761;
        "pkg-fabric-1.21.10-4.4.4" = _7RoW9iDJ;
        "pkg-forge-1.21.10-4.4.4" = _OMUYvaG1;
        "pkg-forge-1.21.11-4.4.4" = _HxcFxsI2;
        "pkg-fabric-1.21.11-4.4.4" = _OsMQkl4P;
        "pkg-neoforge-1.21.11-4.4.4" = _kCxr4XzK;
        "pkg-forge-26.1-4.4.4" = _vJ1z95RH;
        "pkg-neoforge-26.1.1-4.4.1" = _v5ZWAD1C;
        "pkg-fabric-26.1.1-4.4.4" = _QG0UqrtJ;
