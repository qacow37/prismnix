...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _Ke1vNEAp;
        "pkg-1.0.7" = _VftxCwu6;
        "pkg-1.0.11" = _AEkbHcw2;
        "pkg-1.1.0" = _n9s7Erb5;
        "pkg-1.1.3-beta" = _RYlOgwH0;
        "pkg-1.2.0" = _VcLGHs6J;
        "pkg-1.2.1-beta2" = _AwxVbLz4;
        "pkg-1.0.2" = _ecdBYV4r;
        "pkg-1.2.1-beta3" = _zPluXX2T;
        "pkg-1.2.1-beta4" = _6zkAnaTK;
        "pkg-1.2.1-beta5" = _QIi0Uo14;
        "pkg-1.2.1-beta6" = _Uz2Kjplv;
        "pkg-1.2.1-beta7" = _z0fOLEoT;
        "pkg-1.2.1" = _xDQuQMnm;
        "pkg-1.2.2-beta" = _B03l8We7;
        "pkg-1.2.2-beta2" = _GpDJHPmX;
        "pkg-1.2.2-beta3" = _WlISWPAJ;
        "pkg-1.2.2-beta4" = _TA59GvuB;
        "pkg-1.2.2-beta5" = _EzZgI35B;
        "pkg-1.2.2" = _cCJHyaR0;
        "pkg-1.2.3-beta2" = _j3eueu9F;
        "pkg-1.2.3" = _2yClIwmu;
        "pkg-1.0.0" = _5grl8QRu;
        "pkg-1.2.4" = _CCLRF8Cn;
        "pkg-1.2.8.1" = _sz1iWG1X;
        "default" = _sz1iWG1X;
    });
