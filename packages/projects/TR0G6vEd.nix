...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.20.1" = _a7hLw7zn;
        "pkg-1.2.0+1.19.4" = _zcedcPhp;
        "pkg-1.2.0+1.20.1" = _1ylRaweM;
        "pkg-1.2.1+1.19.4" = _SpR7VjcV;
        "pkg-1.2.1+1.20.1" = _EquYKltg;
        "pkg-1.2.2+1.20.1" = _YsXaWKXD;
        "pkg-1.2.2+1.20.5" = _ZUZpsr0N;
        "pkg-2.0.0+1.21" = _tjw8BKkf;
        "pkg-2.0.1+1.21" = _ELpMmcpA;
        "pkg-2.0.2+1.21" = _ppVzmgJv;
        "pkg-2.0.2+1.21.3" = _dMdudWGD;
        "pkg-2.1.0+1.21.3" = _d9EWkJsT;
        "pkg-2.1.0+1.21" = _grAdwRVY;
        "pkg-2.1.1+1.21.3" = _qd0y5nir;
        "pkg-2.1.1+1.21.6" = _MWiCxnki;
        "pkg-2.1.2+1.21.6" = _T708JL18;
        "pkg-2.2.0+1.21" = _TfHpNPgv;
        "pkg-2.2.0+1.21.3" = _Z5zWRcnx;
        "pkg-2.2.0+1.21.6" = _BLTfJ82S;
