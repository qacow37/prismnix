...
let
    ...
    in {
        ...
        "pkg-v1.1" = _XP3aNZ7v;
        "pkg-v1.2" = _6ucSWfDj;
        "pkg-v1.2.1" = _4QbkUm4b;
        "pkg-v1.1.1" = _T8yI8ncz;
        "pkg-v1.2.1+mod" = _gvF5cWJm;
        "pkg-v1.1.2" = _1CMipl3m;
        "pkg-v1.2.2" = _Qhbjqulr;
        "pkg-v1.2.0" = _UX0QFlNx;
        "pkg-v1.2.2+mod" = _qNmm2p0p;
        "pkg-v1.2.3" = _eERCoVX7;
        "pkg-v1.2.3+mod" = _ugSPFIG7;
        "pkg-v1.2.4" = _BCOZGpDV;
        "pkg-v1.2.4+mod" = _QxXrFkPU;
        "pkg-v1.2.5" = _TECLGlxM;
        "pkg-v1.2.5+mod" = _f6yHcjzT;
        "pkg-1.2.5+mod" = _GhQDA8uh;
        "pkg-v1.2.6" = _55CGgHrw;
        "pkg-v1.2.6+mod" = _svfGc97c;
        "pkg-1.2.3" = _7vM7VU8x;
        "pkg-1.2.3+mod" = _lo6wmF3s;
        "pkg-1.2.7" = _IPBwyCXV;
        "pkg-1.2.7+mod" = _MoxnV7Lv;
        "pkg-1.2.8" = _3g14n9cz;
        "pkg-1.2.8+mod" = _jtKH2jNe;
        "pkg-1.3.0" = _LkGBlQah;
        "pkg-1.3.0+mod" = _EebgXvdP;
        "pkg-1.3.1" = _S3NFUmjC;
        "pkg-1.3.1+mod" = _CgeWkmUG;
        "pkg-1.2.9" = _lUsBEior;
        "pkg-1.2.9+mod" = _mhSJt8LC;
        "pkg-1.3.2" = _pBMJtPsO;
        "pkg-1.3.2+mod" = _idSSj5TL;
        "pkg-1.3.3" = _nUzgAuRw;
        "pkg-1.3.3+mod" = _pMwaWv7j;
        "pkg-1.3.4" = _RyHlun0t;
        "pkg-1.3.4+mod" = _4u0p8KP6;
        "pkg-1.4.0" = _DEjxkqi2;
        "pkg-1.4.0+mod" = _aU4n05rp;
        "pkg-1.5.0" = _9nVD4hQ6;
        "pkg-1.5.0+mod" = _uHLT934O;
        "pkg-1.5.1" = _ucFIcRfn;
        "pkg-1.5.1+mod" = _8tdu52OM;
        "pkg-1.4.1" = _OQB7bxV2;
        "pkg-1.4.1+mod" = _JSUj5SvS;
        "pkg-1.4.2" = _XYqeWJea;
        "pkg-1.4.2+mod" = _K0jufe9p;
        "default" = _K0jufe9p;
    });
