...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.0.3" = _yP3rLSJS;
        "pkg-1.16.5-1.0.3" = _duPwODbJ;
        "pkg-1.16.5-1.0.4" = _dKEOJhNy;
        "pkg-1.19.2-1.0.4" = _sIFzTyJb;
        "pkg-1.16.5-1.0.5" = _Pu9Md6my;
        "pkg-1.19.2-1.0.5" = _eCaRds46;
        "pkg-1.16.5-1.0.6" = _kloyju2l;
        "pkg-1.19.2-1.0.6" = _dvuA1mtg;
        "pkg-1.16.5-1.0.7" = _GD44B3js;
        "pkg-1.19.2-1.0.7" = _QFtTRLpH;
        "pkg-1.16.5-1.0.8" = _dcQYngdZ;
        "pkg-1.19.2-1.0.8" = _aMpwQX2e;
        "pkg-1.20.1-1.0.8" = _VYKIjQnt;
        "pkg-1.16.5-1.0.9" = _T6ZRY8Lj;
        "pkg-1.20.1-1.0.9" = _p9Byv7p1;
        "pkg-1.16.5-1.1.0" = _u1u1hu0L;
        "pkg-1.20.1-1.1.0" = _DNmMyYnF;
        "pkg-1.19.2-1.1.0" = _xdxc20rf;
        "pkg-1.18.2-1.1.0" = _FzClLm9m;
        "pkg-1.19.2-1.1.0.1" = _lkeA1KOR;
        "pkg-1.16.5-1.1.1" = _E1VaeWeT;
        "pkg-1.18.2-1.1.1" = _2Sqo87u1;
        "pkg-1.19.2-1.1.1" = _lvuD0fuk;
        "pkg-1.20.1-1.1.1" = _WUQ6u3Gd;
        "pkg-1.16.5-1.1.1.1" = _6QPYuAbe;
        "pkg-1.16.5-1.1.1.2" = _QA2JnI9f;
        "pkg-1.1.1" = _Iu0XngYt;
        "default" = _Iu0XngYt;
    });
