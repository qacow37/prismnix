...
let
    ...
    in {
        ...
        "pkg-1.6" = _PM1HIQP8;
        "pkg-1.7" = _32dvzaed;
        "pkg-2.0-minnow-neo" = _TIa0peX8;
        "pkg-2.0-hippo-neo" = _MMK6l6wn;
        "pkg-2.0-minnow-fabric" = _iFb9OgXw;
        "pkg-2.0-hippo-fabric" = _BOi8f5Er;
        "pkg-2.0-hippo-forge" = _yx7ZGJGS;
        "pkg-2.0-toad-forge" = _PsoDwgQ2;
        "pkg-2.0-toad-fabric" = _OCdIQfSJ;
        "pkg-2.1-toad-forge" = _LnODBl3n;
        "pkg-2.1-toad-fabric" = _Bq3658oT;
        "pkg-2.1-gecko-forge" = _GE0T3hhd;
        "pkg-2.1-gecko-fabric" = _XGO1JLEy;
        "pkg-2.1-hippo-forge" = _BAO1kzL2;
        "pkg-2.1-hippo-neo" = _B9cHi0r5;
        "pkg-2.1-hippo-fabric" = _IeQCQzcl;
        "pkg-2.1-minnow-neo" = _b6dT6Zpe;
        "pkg-2.1-minnow-fabric" = _tm8AaXLm;
        "pkg-2.2-toad-forge" = _GdThERQS;
        "pkg-2.2-toad-fabric" = _ZbHg2jFJ;
        "pkg-2.2-gecko-forge" = _xboHiH8V;
        "pkg-2.2-gecko-fabric" = _9UekPNhk;
        "pkg-2.2-hippo-forge" = _zDYPDhUV;
        "pkg-2.2-hippo-neo" = _jlYrkpXH;
        "pkg-2.2-hippo-fabric" = _CWGaBhVV;
        "pkg-2.2-minnow-neo" = _HczDEIMo;
        "pkg-2.2-minnow-fabric" = _AS8kMlPP;
        "pkg-2.2.1-pinkeen-neo" = _ejtcWd5b;
        "pkg-3.0-toad-fabric" = _9CWQtPaE;
        "pkg-3.0-toad-forge" = _c6kqrheU;
        "pkg-3.0-gecko-forge" = _cEBqDvAA;
        "pkg-3.0-gecko-fabric" = _Ulo45oen;
        "pkg-3.0-hippo-forge" = _FDW1CjYK;
        "pkg-3.0-hippo-neo" = _gVFHwcjD;
        "pkg-3.0-hippo-fabric" = _wIpLeGkY;
        "pkg-3.0-minnow-neo" = _gVHdASLv;
        "pkg-3.0-minnow-fabric" = _AatyWY9X;
        "pkg-3.0-pinkeen-neo" = _tSrLFoLn;
        "pkg-3.0-newt-neo" = _43Ti8Llf;
        "pkg-3.0-newt-fabric" = _U8HGmS8d;
        "pkg-3.1-toad-fabric" = _SDIuF2zP;
        "pkg-3.1-toad-forge" = _6HquykQr;
        "pkg-3.1-gecko-forge" = _fFKkKvOs;
        "pkg-3.1-gecko-fabric" = _j3GkajLo;
        "pkg-3.1-hippo-forge" = _IMe3VHy4;
        "pkg-3.1-hippo-neo" = _JPQjsOqi;
        "pkg-3.1-hippo-fabric" = _yWEYAFRu;
        "pkg-3.1-minnow-neo" = _8irX8Mc6;
        "pkg-3.1-minnow-fabric" = _s4aDp6ls;
        "pkg-3.1-pinkeen-neo" = _hhDT6EJi;
        "pkg-3.1-newt-neo" = _2VXzp39X;
        "pkg-3.1-newt-fabric" = _RFvpvuiP;
        "default" = _RFvpvuiP;
    });
