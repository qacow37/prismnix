...
let
    ...
    in {
        ...
        "pkg-1.14-0.0.1-alpha" = _gDzgkIrj;
        "pkg-1.14-0.0.2-alpha" = _vCHISJ3h;
        "pkg-1.14-0.0.3-alpha" = _hgMuvX7y;
        "pkg-1.14-0.0.4-alpha" = _qmNvQ0E1;
        "pkg-1.14-0.0.5-alpha" = _Q9NwcMFE;
        "pkg-1.14-0.0.6-alpha" = _LHGmEFzs;
        "pkg-1.14-0.0.7-alpha" = _pWeuhNng;
        "pkg-1.14-0.0.8-alpha" = _ihyLP2gR;
        "pkg-1.14-0.0.9-alpha" = _2vAheKWO;
        "pkg-1.14-0.0.10-alpha" = _J6nO4ukh;
        "pkg-1.14-0.0.11-alpha" = _o32M2U0I;
        "pkg-1.14-0.0.12-alpha" = _RwSDXtZc;
        "pkg-1.15-1.0.0-alpha" = _R0mqLrp8;
        "pkg-1.15-1.0.1-alpha" = _XoeA8Yz9;
        "pkg-1.15-1.1.0-beta" = _GyXuSTof;
        "pkg-1.15-1.1.1-beta" = _qInHfXTs;
        "pkg-1.15-1.1.2-beta" = _7vETfqzz;
        "pkg-1.15-1.1.3-beta" = _bFuG2jxf;
        "pkg-1.16-2.0.0-beta" = _HtW2SydK;
        "pkg-1.15-1.1.4" = _D8fizGUE;
        "pkg-1.16-2.0.1-beta" = _yXhkKrlx;
        "pkg-1.15-1.1.5" = _tmeZmZrC;
        "pkg-1.16-2.0.2-beta" = _zV0EdwUN;
        "pkg-1.16-2.0.3-beta" = _3Eq03zkS;
        "pkg-1.15-1.1.6" = _9il2Niqb;
        "pkg-1.16-2.0.4-beta" = _48cU5Ufa;
        "pkg-1.15-1.1.7" = _TJpJxFzh;
        "pkg-1.16-2.0.5" = _vciaE5OL;
        "pkg-1.16-2.0.6" = _wno2fpAW;
        "pkg-1.15-1.1.8" = _QUlUJJFA;
        "pkg-1.16-2.0.7" = _XZRDcOhG;
        "pkg-1.15-1.1.9" = _ARrKUApf;
        "pkg-1.16-2.0.8" = _3WBqrUMJ;
        "pkg-1.15-1.1.10" = _XGna2bBj;
        "pkg-1.16-2.0.9" = _v3pzydMr;
        "pkg-1.16-2.0.10" = _5RIkPV4G;
        "pkg-1.16-2.0.11" = _Ue2VNB4T;
        "pkg-1.16-2.1.0" = _2m9mrJrA;
        "pkg-1.16-2.1.1" = _xJuHdCVl;
        "pkg-1.18-3.0.0" = _t1tB16DW;
        "pkg-1.18-3.0.1" = _b8dmWpCZ;
        "pkg-1.16-2.1.2" = _CQWtO2px;
        "pkg-1.18-3.0.2" = _gMTkDkU7;
        "pkg-1.18-3.0.3" = _SygdZxax;
        "pkg-1.18-3.0.4" = _fP1NRixq;
        "pkg-1.18-3.0.5" = _e4WBqHNm;
        "pkg-1.18-3.0.6" = _365D6BO1;
        "pkg-1.18-3.0.7" = _Jv7mcXUE;
        "pkg-1.16-2.1.3" = _Rjt9Wn28;
        "pkg-1.18-3.0.8" = _wzaFwla4;
        "pkg-1.16-2.1.4" = _dACKBFxt;
        "pkg-1.16-2.1.5" = _xSIBZdZg;
        "pkg-1.18-3.0.9" = _cn9atQK9;
        "pkg-1.19-4.0.0" = _6q4SEL8I;
        "pkg-1.19.1-4.0.1" = _IkaPSVav;
        "pkg-1.18-3.0.10" = _So4FtFmJ;
        "pkg-1.19.1-4.0.2" = _eZrH7m2h;
        "pkg-1.18-3.0.11" = _a2M8ZnoE;
        "pkg-1.19.1-4.0.3" = _xrvUaezp;
        "pkg-1.19.1-4.0.4" = _Tr1Stf0P;
        "pkg-1.19.1-4.1.0" = _Xj3fFMeo;
        "pkg-1.19.1-4.1.1" = _QyWt7uBG;
        "pkg-1.19.1-4.1.2" = _xgXxanYX;
        "pkg-1.18-3.0.12" = _e0MzHciw;
        "pkg-1.19.1-4.1.3" = _j0yOBZhn;
        "pkg-1.19.1-4.1.5" = _o3u3UPlK;
        "pkg-1.19-4.1.6" = _rF4YYFcd;
        "pkg-1.19-4.1.7" = _JmTRglCl;
        "pkg-1.20-5.0.0" = _Uu1IkVMH;
        "pkg-1.20-5.0.1" = _6bD4m9Ws;
        "pkg-1.20-5.0.2" = _SybYUK3U;
        "pkg-1.19-4.1.8" = _2dn0yxL3;
        "pkg-1.20-5.0.3" = _2BMusCMX;
        "pkg-1.19-4.1.9" = _g5BsHfQw;
        "pkg-1.20-5.0.4" = _aSq3dAzO;
        "pkg-1.19-4.1.10" = _eVoRfw4X;
        "pkg-1.20-5.0.5" = _Wk6jJT7o;
        "pkg-1.21-6.0.0" = _k34nbic2;
        "pkg-1.21-6.0.1" = _f9Bfb25X;
        "pkg-1.21-6.0.2" = _ZxaRaDiC;
        "pkg-1.21-6.0.3" = _X6sQVI65;
        "pkg-1.21-6.0.4" = _KU1ClBlp;
        "pkg-1.21-6.0.5" = _FJvULKUQ;
        "pkg-1.20-5.0.6" = _fWmfU5lV;
        "pkg-1.21-6.0.6" = _bJaZxn7C;
        "pkg-1.21-6.0.7" = _Kmch8A2o;
        "pkg-1.21-6.0.8" = _fLhf2leC;
        "pkg-1.21-6.0.9" = _QSnWurOv;
        "pkg-1.21-6.0.10" = _j6hRpxDU;
        "pkg-1.20-5.0.7" = _dYvtIH7M;
        "pkg-1.21-6.0.11" = _f8Tk2cfj;
        "default" = _f8Tk2cfj;
    });
