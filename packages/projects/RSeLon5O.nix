...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.20" = _9z36MA5Z;
        "pkg-0.1.1+1.20" = _efRnEmNA;
        "pkg-0.1.2+1.20" = _UztNGcmd;
        "pkg-0.2.0+1.20" = _cOoFD9Pm;
        "pkg-0.2.1+1.20.1" = _pB8sWtic;
        "pkg-0.2.2+1.20.1" = _pDQVsFHF;
        "pkg-0.2.2+1.20.5" = _nvqEHEjg;
        "pkg-0.2.3+1.20.1" = _EU8wWnRn;
        "pkg-0.2.3+1.20.5" = _t43pierj;
        "pkg-0.2.3+1.21" = _gwTMXpFg;
        "pkg-0.2.4+1.21" = _9vefjf6j;
        "pkg-0.2.4+1.20.6" = _B6nTO5S1;
        "pkg-0.2.4+1.20.1" = _r7cwpYnW;
        "pkg-0.2.4+1.20.4" = _aQtRAn7U;
        "pkg-0.2.5+1.20.1" = _ryjPL8AJ;
        "pkg-0.2.5+1.20.4" = _r47BJu0V;
        "pkg-0.2.5+1.20.6" = _zeqPSIgy;
        "pkg-0.2.5+1.21" = _qTfHWWep;
        "pkg-0.2.5+1.20.1+forge" = _2pgXWmty;
        "pkg-0.2.5+1.21+neoforge" = _ovrp2pXe;
        "pkg-0.2.5+1.21.2+neoforge" = _IMTDtfnc;
        "pkg-0.2.5+1.21.4+neoforge" = _2ZVw4CSK;
        "pkg-0.2.5+1.21.2" = _fQ88Ooz5;
        "pkg-0.2.5+1.21.4" = _OxN53B6o;
        "pkg-0.2.6+1.20.1" = _FvOkF1f8;
        "pkg-0.2.6+1.21" = _d68J3hm8;
        "pkg-0.2.6+1.21.2" = _ppKBtn4b;
        "pkg-0.2.6+1.21.4" = _ICRFK0J1;
        "pkg-0.2.6+1.21.5" = _k6MbmddT;
        "pkg-0.2.6+1.20.1+forge" = _bqPuw9aZ;
        "pkg-0.2.6+1.21+neoforge" = _o1Zk6Pde;
        "pkg-0.2.6+1.21.2+neoforge" = _2Pvj7cg3;
        "pkg-0.2.6+1.21.4+neoforge" = _OFlFhUq2;
        "pkg-0.2.6+1.21.5+neoforge" = _Aoj3IpcA;
        "pkg-0.2.6+1.21.6" = _ATG0vbE2;
        "pkg-0.3.0+1.20.1+forge" = _B74BWGAC;
        "pkg-0.3.0+1.21+neoforge" = _L8y45ubc;
        "pkg-0.3.0+1.21.2+neoforge" = _hrSftqrL;
        "pkg-0.3.0+1.21.4+neoforge" = _TUwZBMqS;
        "pkg-0.3.0+1.21.5+neoforge" = _HRDQRFUv;
        "pkg-0.3.0+1.21.9+neoforge" = _kMA5Cm9y;
        "pkg-0.3.0+1.21.11+neoforge" = _Fvovo0XU;
        "pkg-0.3.0+1.20.1" = _5uBna3gP;
        "pkg-0.3.0+1.21" = _e8zyMCF7;
        "pkg-0.3.0+1.21.2" = _4PZcfYZO;
        "pkg-0.3.0+1.21.4" = _8ncmP3Nv;
        "pkg-0.3.0+1.21.5" = _caOoXqJN;
        "pkg-0.3.0+1.21.6" = _qYXex0zN;
        "pkg-0.3.0+1.21.9" = _vFksc8Fb;
        "pkg-0.3.0+1.21.11" = _OPRpSdiL;
        "pkg-0.3.1+1.20.1+forge" = _dtIZJ1r3;
        "pkg-0.3.1+1.21+neoforge" = _XFmoetqP;
        "pkg-0.3.1+1.21.2+neoforge" = _fqInByIo;
        "pkg-0.3.1+1.21.4+neoforge" = _knhnl86Y;
        "pkg-0.3.1+1.21.5+neoforge" = _sCerDB1r;
        "pkg-0.3.1+1.21.9+neoforge" = _d4NqYq2o;
        "pkg-0.3.1+1.21.11+neoforge" = _degoVjFQ;
        "pkg-0.3.1+1.20.1" = _odCplXSY;
        "pkg-0.3.1+1.21" = _NcCV39PQ;
        "pkg-0.3.1+1.21.2" = _vMMKNt92;
        "pkg-0.3.1+1.21.4" = _L4ikcs8H;
        "pkg-0.3.1+1.21.5" = _3yeS9C9R;
        "pkg-0.3.1+1.21.6" = _wNnjt04J;
        "pkg-0.3.1+1.21.9" = _yvQ3Uqa4;
        "pkg-0.3.1+1.21.11" = _W3cr4exx;
        "pkg-0.3.1-fix1+1.21+neoforge" = _yDBsYwsY;
        "pkg-0.3.1-fix1+1.21.2+neoforge" = _xllmC8HZ;
        "pkg-0.3.1-fix1+1.21.4+neoforge" = _ytXwlcLT;
        "pkg-0.3.1-fix1+1.21.5+neoforge" = _6XJEGBRC;
        "pkg-0.3.1-fix1+1.21.9+neoforge" = _M3EP3wvT;
        "pkg-0.3.1-fix1+1.21.11+neoforge" = _nzTY0oNm;
        "pkg-0.3.2+1.20.1+forge" = _qSjxrRl9;
        "pkg-0.3.2+1.21+neoforge" = _D0F04XQX;
        "pkg-0.3.2+1.21.2+neoforge" = _rvACAlJT;
        "pkg-0.3.2+1.21.4+neoforge" = _W2cZLEd3;
        "pkg-0.3.2+1.21.5+neoforge" = _E488UPIs;
        "pkg-0.3.2+1.21.9+neoforge" = _qoQTV2bw;
        "pkg-0.3.2+1.21.11+neoforge" = _WZachpzm;
        "pkg-0.3.2+1.20.1" = _4o5SphzR;
        "pkg-0.3.2+1.21" = _sLLMpmAS;
        "pkg-0.3.2+1.21.2" = _t59EeQv0;
        "pkg-0.3.2+1.21.4" = _HIFWt4dT;
        "pkg-0.3.2+1.21.5" = _BgWRqZBI;
        "pkg-0.3.2+1.21.6" = _2LtM262G;
        "pkg-0.3.2+1.21.9" = _fnggOyEX;
        "pkg-0.3.2+1.21.11" = _kIlv5noY;
        "pkg-0.3.3+1.20.1+forge" = _cFafZfyr;
        "pkg-0.3.3+1.21+neoforge" = _2QF4NhZD;
        "pkg-0.3.3+1.21.2+neoforge" = _blHcptQV;
        "pkg-0.3.3+1.21.4+neoforge" = _PEmbKEfv;
        "pkg-0.3.3+1.21.5+neoforge" = _add51DOJ;
        "pkg-0.3.3+1.20.1" = _6es9W10B;
        "pkg-0.3.3+1.21" = _mau4pnKr;
        "pkg-0.3.3+1.21.2" = _8nURGsqe;
        "pkg-0.3.3+1.21.4" = _8MSsUBJM;
        "pkg-0.3.3+1.21.5" = _vqe28fXr;
        "pkg-0.3.3+1.21.6" = _Gjb9nYK0;
        "pkg-0.3.2+26.1" = _EkGqhJyz;
        "pkg-0.3.2+26.1+neoforge" = _lNjQ3lSE;
        "pkg-0.3.3+26.2+neoforge" = _Z4o2owWN;
        "pkg-0.3.3+26.2" = _VFv6uQKM;
        "default" = _VFv6uQKM;
    });
