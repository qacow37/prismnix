...
let
    ...
    in {
        ...
        "pkg-5.0.1" = _7u9PAZzG;
        "pkg-6.0.2" = _N7YFuEAc;
        "pkg-11.0.0" = _XZ3qKdoF;
        "pkg-12.0.0" = _F6GASlwH;
        "pkg-13.0.0" = _QAQoGqsh;
        "pkg-14.0.3" = _eITzhDWJ;
        "pkg-15.0.0" = _a6scSFt9;
        "pkg-15.1.0" = _6k0MFRes;
        "pkg-15.1.1" = _MgEJQfwI;
        "pkg-15.1.2" = _qhKxytiB;
        "default" = _qhKxytiB;
    });
