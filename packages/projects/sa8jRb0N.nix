...
let
    ...
    in {
        ...
        "pkg-1.0" = _CaTcRUkk;
        "pkg-1.0+mod" = _UrkIlVP6;
        "pkg-1.1" = _ocucFxlA;
        "pkg-1.1+mod" = _hYdL27wV;
        "pkg-v1.2" = _sCMUgq1m;
        "pkg-v1.2+mod" = _WhmqpQWP;
        "pkg-1.2a" = _PSw6Rodv;
        "pkg-1.2a+mod" = _EwbuCEGH;
        "pkg-1.3" = _wXWnrZ6l;
        "pkg-1.3+mod" = _blK5dsaV;
        "pkg-1.3a" = _jSmr0NuJ;
        "pkg-1.3a+mod" = _9nElIllq;
        "pkg-1.3b" = _ILfHX2Aw;
        "pkg-1.3b+mod" = _dJxvs4Wi;
        "pkg-1.4" = _r3JmmOSJ;
        "pkg-1.4+mod" = _GRMBkvSE;
        "pkg-1.4a" = _QRFhWFW2;
        "pkg-1.4a+mod" = _9v5F5nFi;
        "pkg-1.5" = _MZsKHbLa;
        "pkg-1.5+mod" = _3WZQFlkG;
        "pkg-1.6" = _5YqSug5l;
        "pkg-1.6+mod" = _eLLlWS2B;
        "pkg-1.7" = _pUg78T2x;
        "pkg-1.7+mod" = _M5KD4LtX;
        "pkg-1.7.1" = _ypLKpt7i;
        "pkg-1.7.1+mod" = _1JKYQP8P;
        "pkg-1.7.2" = _TO8CCoWy;
        "pkg-1.7.2+mod" = _XiCWd2FE;
        "default" = _XiCWd2FE;
    });
