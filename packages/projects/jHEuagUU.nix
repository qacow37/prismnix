...
let
    ...
    in {
        ...
        "pkg-6.1.0" = _KJTXPkKl;
        "pkg-7.1.0" = _RyfbRCiX;
        "pkg-fabric-1.14.4-1.2.0" = _D8o3ziGa;
        "pkg-forge-1.14.4-1.2.0" = _BQEAwU4a;
        "pkg-fabric-1.15.2-2.2.0" = _C3kgXCDQ;
        "pkg-forge-1.15.2-2.2.0" = _8VIZw7eN;
        "pkg-fabric-1.16.5-3.2.0" = _GEfFxZ7l;
        "pkg-forge-1.16.5-3.2.0" = _J8XqCcvK;
        "pkg-fabric-1.17.1-4.2.0" = _zO1Kv5hj;
        "pkg-forge-1.17.1-4.2.0" = _qXHZKLQ2;
        "pkg-fabric-1.18.2-5.2.0" = _w4z3gIjK;
        "pkg-forge-1.18.2-5.2.0" = _lzaXOGYR;
        "pkg-quilt-1.18.2-5.2.0" = _4iXgZK89;
        "pkg-fabric-1.19.2-6.2.0" = _vqi8IXS8;
        "pkg-forge-1.19.2-6.2.0" = _TvENAYUC;
        "pkg-quilt-1.19.2-6.2.0" = _Cbau0XAv;
        "pkg-fabric-1.19.3-7.2.0" = _EFIhSdKU;
        "pkg-forge-1.19.3-7.2.0" = _EA3xPLYU;
        "pkg-quilt-1.19.3-7.2.0" = _4h1ca2Ol;
        "pkg-fabric-1.19.4-8.2.0" = _7mB7qO0v;
        "pkg-forge-1.19.4-8.2.0" = _2X9EZdi3;
        "pkg-quilt-1.19.4-8.2.0" = _iQ02dw7x;
        "pkg-forge-1.14.4-1.3.0" = _dGm11oeX;
        "pkg-fabric-1.14.4-1.3.0" = _jqXoLN3C;
        "default" = _dGm11oeX;
    });
