...
let
    ...
    in {
        ...
        "pkg-v1.1" = _PZjn3RR6;
        "pkg-v1.1+mod" = _tPRYGxUB;
        "pkg-v1.2" = _jWI6GI3r;
        "pkg-v1.2+mod" = _jwKNecIA;
        "pkg-v1.3" = _LO7Ps5Nb;
        "pkg-v1.3+mod" = _wzRlJIWi;
        "pkg-v1.4" = _pNjIaDmM;
        "pkg-v1.4+mod" = _dMfAh3nw;
        "pkg-v1.5" = _ObgffIOQ;
        "pkg-v1.5+mod" = _QZNZlz7k;
        "pkg-v1.5.1" = _DCV7CzYX;
        "pkg-v1.5.1+mod" = _sRPFDrzy;
        "pkg-v2" = _SlJnnYtd;
