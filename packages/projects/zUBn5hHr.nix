...
let
    ...
    in {
        ...
        "pkg-17" = _yAbWYGvJ;
        "pkg-18" = _OmkOgujn;
        "pkg-1.20-2.0.2" = _TSz3RE0g;
        "pkg-1.20-2.1.0" = _1TPVerSt;
        "pkg-1.20-2.2.0" = _KiVcThqA;
        "pkg-1.20-2.2.1" = _SAdWwGe8;
        "pkg-1.20-2.2.2" = _3zbxXoyz;
        "pkg-1.20-2.2.3" = _AESqK5Ha;
        "pkg-1.20-2.2.5" = _axP09cNk;
        "pkg-1.20-2.2.6" = _o46bOKal;
        "pkg-1.20-2.2.7" = _DxfoqvJs;
        "pkg-neoforge_1.21-2.2.8" = _ziOyokVZ;
        "pkg-fabric_1.21-2.2.8" = _jQXkpDR8;
        "pkg-neoforge_1.21-2.2.9" = _VdSj34ob;
