...
let
    ...
    in {
        ...
        "pkg-1.7.8" = _k3GXCFCT;
        "pkg-1.7.9" = _K2Pa63Qc;
        "pkg-1.7.10" = _H3DtHHKy;
        "pkg-1.7.11" = _8NeF8648;
        "pkg-1.7.12" = _suxOT2kI;
        "pkg-1.7.13" = _J3lTXpUa;
        "pkg-1.7.14" = _OrLmBmJq;
        "pkg-1.7.15" = _yq9tXg3O;
        "pkg-1.7.16" = _urxbYSFD;
        "pkg-1.7.17" = _ZHzlwGQJ;
        "pkg-1.7.18" = _oXXTWEgx;
        "pkg-1.7.19" = _y4kqXjPR;
        "pkg-1.7.20" = _Xjp2bkz2;
        "pkg-1.7.21" = _GldzB6UW;
        "pkg-1.7.22" = _dzAl6mZv;
        "pkg-1.7.23" = _9QFgY7gm;
        "pkg-1.7.24" = _5IcjXM98;
        "pkg-1.7.25" = _sH8Ys318;
        "pkg-1.7.26" = _2kTTv9i5;
        "pkg-1.7.26a" = _1szPbfal;
        "pkg-1.7.27" = _N2suLf6V;
        "pkg-2.0.0" = _BaSvpmli;
        "pkg-2.0.1" = _aj5wzsn7;
        "pkg-2.0.2" = _qdn6Jzrt;
        "pkg-2.0.3" = _92NGx9QD;
