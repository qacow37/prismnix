...
let
    ...
    in {
        ...
        "pkg-1.18.2-2.0.2.0" = _NENgOgAf;
        "pkg-1.19.2-3.0.2.0" = _EPdKqmW9;
        "pkg-1.19.3-3.1.0.0" = _Bzi2HbZK;
        "pkg-1.19.4-3.2.0.0" = _rDwyBcFc;
        "pkg-1.18.2-2.1.0.0" = _pSqR4xLq;
        "pkg-1.20.1-4.0.0.0" = _BWag2b5P;
        "pkg-1.20.1-4.1.0.0" = _O63pmzfN;
        "pkg-1.20.1-4.2.0.0" = _whBrngyP;
        "pkg-1.20.4-5.0.0.0" = _dzcyEGAO;
        "pkg-1.20.4-5.1.0.0" = _zevovOjk;
        "pkg-1.20.4-5.1.1.0" = _lbiUvO7d;
        "pkg-1.20.4-5.1.1.1" = _G4M16qHU;
        "pkg-1.20.4-5.1.2.0" = _wVmJ5VCv;
        "pkg-1.20.4-5.1.3.0" = _WjqB20VH;
        "pkg-1.20.6-5.2.0.0" = _x7W5vd3U;
        "pkg-1.21-6.0.0.0" = _EQUsmmkz;
        "pkg-1.21-6.0.1.0" = _x6PzZ7Lr;
        "pkg-1.21-6.0.2.0" = _kLQDL0YV;
        "pkg-1.21-6.1.0.0" = _UvtpTd5b;
        "pkg-1.21-6.1.1.0" = _ZoEdk7r5;
        "pkg-1.21-6.2.0.0" = _pZ5TamEY;
        "pkg-1.20.6-5.2.0.1" = _Vw7QrIfh;
        "pkg-1.20.4-5.1.3.1" = _ErUNKk1X;
        "pkg-1.21-6.3.0.0" = _UtotdmrC;
        "pkg-1.21-6.3.1.0" = _Du1JRXxg;
        "pkg-1.21-6.4.0.0" = _LBb1KGpE;
        "pkg-1.20.6-5.2.0.2" = _7Cep57MI;
        "pkg-1.21-6.4.1.0" = _d1ArUwLe;
        "pkg-1.21.1-6.5.0.0" = _BtykDKvk;
        "pkg-1.21.1-6.5.1.0" = _TZq5Ihuf;
        "pkg-1.20.1-4.2.0.1" = _uqhIDxIP;
        "pkg-1.21.1-6.5.1.1" = _a7sG0Ned;
        "pkg-1.20.6-5.2.0.3" = _PtMt8xcR;
        "pkg-1.20.4-5.1.3.2" = _JMFZip7W;
        "pkg-1.21.3-6.6.0.0" = _MC7V5xSM;
        "pkg-1.21.4-6.7.0.0" = _gcrkidpZ;
        "pkg-1.21.5-6.8.0.0" = _sc0Nn61y;
        "pkg-1.21.1-6.5.2.0" = _1buIAh1A;
        "pkg-1.21.5-6.8.0.1" = _m86023VX;
        "pkg-1.21.6-6.9.0.0" = _lPDKHBBv;
        "pkg-1.20.6-5.2.1.0" = _86DnZ8m5;
        "pkg-1.21.1-6.5.3.0" = _LA4DEAy3;
        "pkg-1.21.3-6.6.1.0" = _RhIFQI05;
        "pkg-1.21.4-6.7.1.0" = _Dj79m7xu;
        "pkg-1.21.5-6.8.1.0" = _boa7c5Bo;
        "pkg-1.21.6-6.9.1.0" = _26GQvtzq;
        "pkg-1.21.8-6.10.0.0" = _q6n2B9tV;
        "pkg-1.21.10-6.11.0.0" = _hp1Fk4Ae;
        "pkg-1.21.10-6.11.1.0" = _GzzlNQ3U;
        "pkg-1.21.11-6.12.0.0" = _MB5WhszU;
        "pkg-1.21.4-6.7.2.0" = _WssNjQ5F;
        "pkg-1.21.5-6.8.2.0" = _WmiaaQmY;
        "pkg-1.21.8-6.10.1.0" = _RQQfskfP;
        "pkg-1.21.10-6.11.2.0" = _fxllDkow;
        "pkg-1.21.11-6.12.1.0" = _pmdDuJeA;
        "pkg-26.1-7.0.0.0" = _PLGIFwT9;
        "pkg-26.1-7.0.1.0" = _5D3xwVNW;
        "pkg-26.1-7.0.1.1" = _LG2HYKUc;
        "pkg-26.1.2-7.1.0.0" = _IYaZTTGD;
        "pkg-1.21.4-6.7.3.0" = _u2ivkrHL;
        "pkg-1.21.5-6.8.3.0" = _e87A77LR;
        "pkg-1.21.8-6.10.2.0" = _dXW10MHz;
        "pkg-1.21.10-6.11.3.0" = _rNW1xIVs;
        "pkg-1.21.11-6.12.2.0" = _qEqbNxu5;
        "pkg-26.1.2-7.1.1.0" = _o6DxoXVP;
