...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _nxfKrIjI;
        "pkg-1.0.0-1.21.10" = _xCR8JPTP;
        "pkg-1.0.0-1.21.x" = _pWckcrzV;
        "pkg-2.0.0-1.21" = _e8317Z7L;
        "pkg-3.0.0-1.21-paper" = _h8dpegPT;
        "pkg-3.0.0-1.21-fabric" = _GiAjtgbf;
        "pkg-3.0.0-1.21" = _e4xVCk9a;
        "pkg-4.0.0-1.21-paper" = _nt8uoe5t;
        "pkg-4.0.0-1.21-fabric" = _pC8XUU4x;
        "pkg-4.0.0-1.21" = _RCVdOvb8;
        "pkg-4.1.0-1.21" = _Z1h1VLKj;
        "pkg-4.1.1-1.21" = _OKESzwRe;
        "pkg-4.1.2-1.21" = _5qHspDOu;
        "pkg-5.0.0-1.21" = _JvaugP1F;
        "pkg-5.0.0-1.21.11" = _Z4CPaBml;
        "pkg-5.1.0-1.21" = _VwZMGnIu;
        "pkg-5.1.0-1.21.11" = _oFUNEFOl;
        "pkg-Paper-5.1.0-1.21" = _L5yikIQr;
        "pkg-fabric-5.1.0-1.21-1.21.5" = _E15YMnD9;
        "pkg-fabric-5.1.0-1.21.6-1.21.10" = _RCC3eEWY;
        "pkg-5.1.0-1.21.1" = _FTxUZFxL;
        "pkg-5.1.0-1.21.5" = _C7InSUPi;
        "pkg-5.1.0-1.21.10" = _TLjTVUFg;
        "pkg-Client-5.1.1" = _r5q5dcGl;
        "pkg-5.2.0-1.21.1" = _XZTk3bL6;
        "pkg-5.2.0-1.21.5" = _mGTVgF2p;
        "pkg-5.2.0-1.21.10" = _itJMUXPF;
        "pkg-5.2.0-1.21.11" = _4bnV58Bs;
        "pkg-5.2.0-paper" = _2eVNJXUv;
        "pkg-6.0.0-1.21+" = _k7Olg7V3;
        "pkg-6.0.0-1.21.x" = _7fQIcJF3;
        "pkg-6.0.0-1.21.11" = _m9LZdHmu;
        "pkg-6.0.1-1.21+" = _BdRISE1c;
        "pkg-6.0.1-1.21.x" = _m10gR5ku;
        "pkg-6.0.1-1.21.11" = _EB0veU8v;
        "pkg-6.0.2-1.21+" = _lWRa79vA;
        "pkg-6.0.2-1.21.x" = _ZSi1GWvY;
        "pkg-6.0.2-1.21.11" = _g39IE1aC;
        "pkg-7.0.0+Neoforge" = _Q3HtY4TV;
        "pkg-7.0.0+Fabric" = _DwOic6rF;
        "pkg-7.0.0-1.21+Fabric" = _Kkptmdcn;
        "pkg-7.0.0-1.21+NeoForge" = _9VesxE9O;
        "pkg-7.0.0-1.21+Paper" = _QMtq2qXB;
        "pkg-7.0.1-26.1+NeoForge" = _kCc1XqvU;
        "pkg-7.0.1-26.1+Fabric" = _AZZM7QwQ;
        "pkg-7.0.1-1.21+Paper" = _IxWhU8XV;
        "pkg-7.0.1-1.21+Fabric" = _jMuV9ydH;
        "pkg-7.0.1-1.21+NeoForge" = _y2XDrM6h;
        "default" = _y2XDrM6h;
    });
