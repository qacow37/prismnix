...
let
    ...
    in {
        ...
        "pkg-0.6.8" = _I6DkdsTF;
        "pkg-0.6.9" = _D4OOjuZX;
        "pkg-0.6.10" = _aJLlpr0S;
        "pkg-0.6.11" = _S3OEvvFu;
        "pkg-0.6.12" = _4Z8uxBiV;
        "pkg-0.6.13" = _bwkAHDO4;
        "pkg-0.6.14" = _xBcVzzAk;
        "pkg-0.6.15" = _voeO3TUM;
        "pkg-0.7.0" = _SZcGtCTp;
        "pkg-0.7.1" = _pJFbPC7k;
        "pkg-0.7.2" = _58gTIXt1;
        "pkg-v0.8.0" = _3tLma6kP;
        "pkg-0.8.1" = _vaPuBpYR;
        "pkg-0.8.2" = _qeLiSUbZ;
        "pkg-0.8.3" = _tj3wVYN7;
        "pkg-0.8.4" = _5BWFXNgY;
        ...
        "pkg-0.8.8" = _krQ4laTw;
        "pkg-0.8.9" = _yv7gfqQ6;
        "pkg-0.8.10" = _kdtXH83j;
        "pkg-0.8.11" = _zWfBq0lA;
        "pkg-0.8.12" = _wBbQLpN5;
        "pkg-0.9.0" = _e07qSH3K;
        "pkg-0.9.1" = _YpqxGTqA;
        "pkg-0.9.2" = _wTiqyU57;
        "pkg-0.9.3" = _8NrTiTni;
        ...
        "pkg-0.9.6" = _8NHvio7U;
        "pkg-0.9.7" = _wSvrXImw;
        "pkg-0.10.0" = _vLpPtJ8u;
        "pkg-0.9.8" = _P6ujxabJ;
        "pkg-0.10.1" = _Bcj0qfBm;
        "pkg-0.9.9" = _eUAmqHEG;
        "pkg-0.9.10" = _Ff9RLXlv;
        "pkg-0.10.2" = _H3l4kmFB;
        "default" = _H3l4kmFB;
    });
