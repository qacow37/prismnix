...
let
    ...
    in {
        ...
        "pkg-1.0" = _y2TnoI87;
        "pkg-1.0.1" = _mk9lWcwG;
        "pkg-1.0+mod" = _kgAXvzHl;
        "pkg-1.0.1+mod" = _LboVii1r;
        "pkg-1.0.2" = _oVVDxKU7;
        "pkg-1.0.2+mod" = _gvSHBEEu;
        "pkg-1.1" = _NjgCaOeV;
        "pkg-1.1+mod" = _1lTdWTlK;
        "pkg-1.1-(1.21.4)" = _KDQ2Ix2C;
        "pkg-1.1-(1.21.4)+mod" = _Ik2Ppj2t;
        "pkg-1.1.2-(1.21.4)" = _vF9hk6Xs;
        "pkg-1.1.2-(1.21.4)+mod" = _rEDv7U60;
        "pkg-1.1.2" = _Y4LIoPRR;
        "pkg-1.1.2+mod" = _I6xmSlDT;
        "pkg-1.2-(1.21.4)" = _qGQIHqfi;
        "pkg-1.2-(1.21.4)+mod" = _YI2DI41i;
        "pkg-v1.2-(1.21.5)" = _9wbLnvHD;
        "pkg-v1.2-(1.21.5)+mod" = _tUKPki9y;
        "pkg-2.0" = _ZXmgTX2j;
        "pkg-2.0+mod" = _kupSqABN;
        "pkg-2.1" = _Vb4yw3wU;
        "pkg-2.1+mod" = _HuFTCNj7;
        "pkg-2.0.1" = _CxPFrqQd;
        "pkg-2.0.1+mod" = _nixoYftQ;
        "pkg-2.2" = _gU5gcbM5;
        "pkg-2.2+mod" = _aUijtqs1;
        "pkg-2.2.1" = _e7fghgry;
        "pkg-2.2.1+mod" = _OU86hhQH;
        "pkg-2.2.2" = _Na9JFfti;
        "pkg-2.2.2+mod" = _ZChdrIrd;
        "pkg-2.2.3" = _9Hr7PzkT;
        "pkg-2.2.3+mod" = _bY5PjLhM;
        "pkg-2.3" = _jwnlbRNn;
        "pkg-2.3+mod" = _kzW6NCrd;
        "pkg-2.3.1" = _V0cIEyIs;
        "pkg-2.3.1+mod" = _XyNMY9S6;
        "pkg-2.3.2" = _Y8tla3lk;
        "pkg-2.3.2+mod" = _Mxue32vy;
        "pkg-2.3.3" = _pfHspanK;
        "pkg-2.3.3+mod" = _vIzTKRBP;
        "pkg-2.3.4" = _qCe93oHI;
        "pkg-2.3.4+mod" = _nMbf42vf;
        "pkg-2.3.5" = _nxzAzukA;
        "pkg-2.3.5+mod" = _h5HXJ4os;
        "pkg-2.3.6" = _NJO9513Y;
        "pkg-2.3.6+mod" = _ckjWk7Zw;
        "pkg-2.3.7" = _DAkvs2Bv;
        "pkg-2.3.7+mod" = _KElhzlZj;
        "pkg-2.3.8" = _q6YOzz3a;
        "pkg-2.3.8+mod" = _mElj8BeL;
        "pkg-2.3.9" = _28Gpcndo;
        "pkg-2.3.9+mod" = _WQngEWPv;
        "pkg-2.3.10" = _f9dQHdUs;
        "pkg-2.3.10+mod" = _4YG8Ka2h;
        "pkg-2.3.11" = _2Bmfm3T7;
        "pkg-2.3.11+mod" = _Dj11sOkk;
        "default" = _Dj11sOkk;
    });
