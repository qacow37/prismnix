...
let
    ...
    in {
        ...
        "pkg-neoforge-0.1.0-1.21.4" = _kq92QxKQ;
        "pkg-fabric-0.1.0-1.21.4" = _d2g5jQyg;
        "pkg-spigot-0.1.0" = _9uBNFPh9;
        "pkg-neoforge-0.1.1-1.21.4" = _cpPlNfzC;
        "pkg-fabric-0.1.1-1.21.4" = _urRdiAAh;
        "pkg-spigot-0.1.1" = _4KnGqN2e;
        "pkg-neoforge-1.0.0-1.21.4" = _qS5x4Mc8;
        "pkg-fabric-1.0.0-1.21.4" = _tMFEw4M6;
        "pkg-spigot-1.0.0" = _acz35cKg;
        "pkg-neoforge-1.0.0-1.21.6" = _wbIaCxZp;
        "pkg-fabric-1.0.0-1.21.6" = _Oc8pWwAT;
        "pkg-neoforge-1.0.1-1.21.4" = _XC7EHK4X;
        "pkg-fabric-1.0.1-1.21.4" = _yszmQLFm;
        "pkg-spigot-1.0.1" = _4RhbQjul;
        "pkg-neoforge-1.0.1-1.21.6" = _Ds99VoUJ;
        "pkg-fabric-1.0.1-1.21.6" = _qfjiVDbY;
        "pkg-neoforge-1.0.2-1.21.4" = _2z16Cg6d;
        "pkg-fabric-1.0.2-1.21.4" = _ce0FqRS5;
        "pkg-spigot-1.0.2" = _4Y5QSiwS;
        "pkg-neoforge-1.0.2-1.21.6" = _3WMjD0er;
        "pkg-fabric-1.0.2-1.21.6" = _eoJr5IKx;
        "pkg-neoforge-1.0.3-1.21.4" = _uwjZkjbq;
        "pkg-fabric-1.0.3-1.21.4" = _IpTu5S3a;
        "pkg-spigot-1.0.3" = _36X0dR2Y;
        "pkg-neoforge-1.0.3-1.21.6" = _yvPMBwHu;
        "pkg-fabric-1.0.3-1.21.6" = _FOzkfKDj;
        "pkg-neoforge-1.0.4-1.21.4" = _hANFsu1u;
        "pkg-fabric-1.0.4-1.21.4" = _FmL2QrKf;
        "pkg-spigot-1.0.4" = _kFgmsc3X;
        "pkg-neoforge-1.0.4-1.21.6" = _EFMjWTql;
        "pkg-fabric-1.0.4-1.21.6" = _8AKyODd0;
        "pkg-neoforge-1.0.4-1.21.1" = _8ytlqTMf;
        "pkg-fabric-1.0.4-1.21.1" = _ppbQPtBn;
        "pkg-neoforge-1.0.5-1.21.1" = _KZ8equi3;
        "pkg-fabric-1.0.5-1.21.1" = _lU5aTWd7;
        "pkg-neoforge-1.0.5-1.21.4" = _rw911LRF;
        "pkg-fabric-1.0.5-1.21.4" = _MIvTpKIf;
        "pkg-neoforge-1.0.5-1.21.6" = _lepYGaVb;
        "pkg-fabric-1.0.5-1.21.6" = _ZiNfYlF2;
        "pkg-spigot-1.0.5" = _wfXKfsE6;
        "pkg-neoforge-1.0.6-1.21.4" = _luxCcGzX;
        "pkg-fabric-1.0.6-1.21.4" = _A46UyoCI;
        "pkg-spigot-1.0.6" = _Tyd6I8HX;
        "pkg-neoforge-1.0.6-1.21.1" = _zox6BWvV;
        "pkg-fabric-1.0.6-1.21.1" = _WggYTZJX;
        "pkg-neoforge-1.0.6-1.21.6" = _srst9l9b;
        "pkg-fabric-1.0.6-1.21.6" = _k6qq6jNk;
        "pkg-neoforge-1.0.7-1.21.1" = _yVGKTB5v;
        "pkg-fabric-1.0.7-1.21.1" = _c9XFytlq;
        "pkg-neoforge-1.0.7-1.21.4" = _PawqKgCD;
        "pkg-fabric-1.0.7-1.21.4" = _dAU2Gmlr;
        "pkg-neoforge-1.0.7-1.21.6" = _75htGHwR;
        "pkg-fabric-1.0.7-1.21.6" = _hNDps8c4;
        "pkg-spigot-1.0.7" = _IFv9md5V;
        "pkg-neoforge-1.0.8-1.21.1" = _WvBnWwij;
        "pkg-fabric-1.0.8-1.21.1" = _fLXa2gDE;
        "pkg-neoforge-1.0.8-1.21.4" = _s6OTZThs;
        "pkg-fabric-1.0.8-1.21.4" = _GObIlOTc;
        "pkg-neoforge-1.0.8-1.21.6" = _ROpCqJyp;
        "pkg-fabric-1.0.8-1.21.6" = _INP7Xl1Y;
        "pkg-paper-1.0.8" = _EY8BXhTB;
        "pkg-neoforge-1.0.9-1.21.1" = _CejudEbm;
        "pkg-fabric-1.0.9-1.21.1" = _onU4xYOv;
        "pkg-neoforge-1.0.9-1.21.4" = _jWRpCIb1;
        "pkg-fabric-1.0.9-1.21.4" = _TX4GGUuU;
        "pkg-neoforge-1.0.9-1.21.7" = _tzxI776s;
        "pkg-fabric-1.0.9-1.21.7" = _kchvPhw1;
        "pkg-paper-1.0.9" = _WOwZ8E3O;
        "pkg-neoforge-1.0.10-1.21.1" = _K4eI9JlG;
        "pkg-fabric-1.0.10-1.21.1" = _bIZNMadg;
        "pkg-neoforge-1.0.10-1.21.3" = _cLuPlznV;
        "pkg-fabric-1.0.10-1.21.3" = _jz3orjMP;
        "pkg-neoforge-1.0.10-1.21.4" = _uD16u471;
        "pkg-fabric-1.0.10-1.21.4" = _vnwJ5NeS;
        "pkg-neoforge-1.0.10-1.21.7" = _KPYgLzAz;
        "pkg-fabric-1.0.10-1.21.7" = _VjekMWrX;
        "pkg-paper-1.0.10" = _j9RfMOlq;
        "pkg-neoforge-1.0.10-1.21.9" = _H2wjRSpR;
        "pkg-fabric-1.0.10-1.21.9" = _eMQRGxb0;
        "pkg-neoforge-1.0.11-1.21.1" = _XDfrgZ02;
        "pkg-fabric-1.0.11-1.21.1" = _bWYJ0kup;
        "pkg-neoforge-1.0.11-1.21.3" = _ySLlsHr1;
        "pkg-fabric-1.0.11-1.21.3" = _G1HfTztC;
        "pkg-neoforge-1.0.11-1.21.4" = _sysllX20;
        "pkg-fabric-1.0.11-1.21.4" = _oHbXJ5uC;
        "pkg-neoforge-1.0.11-1.21.7" = _JkDsiZvu;
        "pkg-fabric-1.0.11-1.21.7" = _WCkC3BK6;
        "pkg-neoforge-1.0.11-1.21.9" = _4zR3Jxhb;
        "pkg-fabric-1.0.11-1.21.9" = _RnYpDVU4;
        "pkg-paper-1.0.11" = _kg2sdfju;
        "pkg-neoforge-1.0.12-1.21.1" = _ezd5tjP2;
        "pkg-fabric-1.0.12-1.21.1" = _xD63BfuX;
        "pkg-neoforge-1.0.12-1.21.3" = _EKGdNdiE;
        "pkg-fabric-1.0.12-1.21.3" = _UuW9AVXV;
        "pkg-neoforge-1.0.12-1.21.4" = _FCNoKbxw;
        "pkg-fabric-1.0.12-1.21.4" = _LL5vCxQb;
        "pkg-neoforge-1.0.12-1.21.7" = _XpuF4siO;
        "pkg-fabric-1.0.12-1.21.7" = _3mAUJimA;
        "pkg-neoforge-1.0.12-1.21.9" = _xkIo72EA;
        "pkg-fabric-1.0.12-1.21.9" = _9bwGv9B0;
        "pkg-paper-1.0.12" = _mBsQhubX;
        "pkg-neoforge-1.0.12-1.21.11" = _9cSjPo4Q;
        "pkg-fabric-1.0.12-1.21.11" = _F8GEgaqb;
        "pkg-neoforge-1.0.12-26.1.1" = _4AuvWwIO;
