...
let
    ...
    in {
        ...
        "pkg-0.1.33" = _6ODilt1O;
        "pkg-0.2.30" = _Muwg9te8;
        "pkg-0.2.35" = _Of9TtuUq;
        "pkg-2.0.8-beta+fabric-1.21.1" = _C1Toe90x;
        "pkg-2.1.8-beta+fabric-1.21.1" = _qc9mVwA5;
        "pkg-2.1.9-beta+fabric-1.21.1" = _56SwmGyC;
        "pkg-2.2.1-beta+fabric-1.21.1" = _nVqu04UO;
        "pkg-2.2.2-beta+fabric-1.21.1" = _DPhqUYO7;
        "pkg-3.0.0-beta+fabric-1.21.1" = _oiDKTqZ6;
        "pkg-4.0.1-beta+fabric-1.21.1" = _SAOlp4Xe;
        "pkg-4.0.1-beta+fabric-1.21.2" = _48HmZaY3;
        "pkg-4.0.4-beta+fabric-1.21.1" = _tTi6UJ8g;
        "pkg-4.0.4-beta+fabric-1.21.2" = _DlFemyBD;
        "pkg-5.0.0-alpha+fabric-1.21.1" = _x0lAB8rZ;
        "pkg-5.0.0-alpha+fabric-1.21.2" = _JnIQ7s1x;
        "pkg-5.0.8-alpha+fabric-1.21.3" = _z3BoAzzt;
        "pkg-5.0.8-alpha+fabric-1.21.5" = _EuBb2Zxk;
        "pkg-5.0.8-alpha+fabric-1.21.2" = _mp0ui2Qg;
        "pkg-5.0.8-alpha+fabric-1.21.10" = _62LjB6Sw;
        "pkg-5.0.8-alpha+fabric-1.21.1" = _33scOPVP;
        "pkg-5.0.9-beta+fabric-1.21.1" = _5hFZDjja;
        "pkg-5.0.9-beta+fabric-1.21.2" = _rOXsBwem;
        "pkg-5.0.9-beta+fabric-1.21.3" = _c6vU40uf;
        "pkg-5.0.9-beta+fabric-1.21.5" = _jxPTmCBC;
        "pkg-5.0.9-beta+fabric-1.21.10" = _SxpHrEkR;
        "pkg-5.1.0-beta+fabric-1.21.1" = _T8EoIaQQ;
        "pkg-5.1.0-beta+fabric-1.21.2" = _Z930KPvE;
        "pkg-5.1.0-beta+fabric-1.21.3" = _4vwHqcas;
        "pkg-5.1.0-beta+fabric-1.21.5" = _veBXxDfu;
        "pkg-5.1.0-beta+fabric-1.21.10" = _lmhN2Xo0;
        "pkg-7.0.0-beta+fabric-1.21.1" = _oPuke8n8;
        "pkg-7.0.0-beta+fabric-1.21.6" = _FgSArblM;
        "pkg-7.0.0-beta+fabric-1.21.2" = _4c7YVJlX;
        "pkg-7.0.0-beta+fabric-1.21.11" = _It8Exr4t;
        "pkg-7.0.0-beta+fabric-1.21.9" = _15OdPLq4;
        "pkg-7.0.1-beta+fabric-1.21.1" = _W5KZqxaq;
        "pkg-7.0.1-beta+fabric-1.21.2" = _aQ080O5N;
        "pkg-7.0.1-beta+fabric-1.21.9" = _jDDgqEjR;
        "pkg-7.0.1-beta+fabric-1.21.6" = _8TA5J2kB;
        "pkg-7.0.1-beta+fabric-1.21.11" = _f7pw4avb;
        "pkg-7.0.2-beta+fabric-1.21.1" = _hoDSwWIs;
        "pkg-7.0.2-beta+fabric-1.21.2" = _zsQCrnip;
        "pkg-7.0.2-beta+fabric-1.21.6" = _sDbOTrlw;
        "pkg-7.0.2-beta+fabric-1.21.9" = _6Khr3Hkq;
        "pkg-7.0.2-beta+fabric-1.21.11" = _L6Wfm1af;
        "pkg-7.0.3-beta+fabric-1.21.1" = _yEDfvoWk;
        "pkg-7.0.3-beta+fabric-1.21.2" = _AIPuAckn;
        "pkg-7.0.3-beta+fabric-1.21.6" = _SaZGXiu6;
        "pkg-7.0.3-beta+fabric-1.21.9" = _z3eZ66WK;
        "pkg-7.0.3-beta+fabric-1.21.11" = _Pq9h5K1E;
        "pkg-7.0.4-beta+fabric-1.21.1" = _9Wl09oAw;
        "pkg-7.0.4-beta+fabric-1.21.2" = _vu4ASN3u;
        "pkg-7.0.4-beta+fabric-1.21.6" = _Tq2KNvQb;
        "pkg-7.0.4-beta+fabric-1.21.9" = _2hJL1vgt;
        "pkg-7.0.4-beta+fabric-1.21.11" = _n8txfEqH;
        "pkg-7.0.5-beta+fabric-1.21.1" = _eTYpKPdK;
        "pkg-7.0.5-beta+fabric-1.21.2" = _vk5TzHuc;
        "pkg-7.0.5-beta+fabric-1.21.6" = _5P6SYmLc;
        "pkg-7.0.5-beta+fabric-1.21.9" = _emgWBkoJ;
        "pkg-7.0.5-beta+fabric-1.21.11" = _De4neTde;
        "pkg-7.1.0-beta+fabric-1.21.2" = _YD8ww6Wm;
        "pkg-7.1.0-beta+fabric-1.21.9" = _vWh1p7q2;
        "pkg-7.1.0-beta+fabric-1.21.6" = _3swh6V7P;
        "pkg-7.1.0-beta+fabric-1.21.1" = _uUOflc0v;
        "pkg-7.1.0-beta+fabric-1.21.11" = _w6dcd7yT;
        "default" = _w6dcd7yT;
    });
