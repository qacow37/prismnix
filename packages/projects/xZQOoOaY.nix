...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _8czQ7Y4W;
        "pkg-0.2.0" = _dX8yY2d0;
        "pkg-0.2.0-1.19.3" = _sXdsEvyW;
        "pkg-0.2.1" = _o0t0GfB4;
        "pkg-0.2.1-1.19.3" = _kipiapua;
        "pkg-0.2.2" = _4jOsIOTf;
        "pkg-0.2.3" = _BhJGV80V;
        "pkg-0.2.3+1.18.2" = _zuMBw1hT;
        "pkg-0.2.3-1.19.3" = _nMK1d54q;
        "pkg-0.2.3-1.19.4" = _9rKuPKcE;
        "pkg-0.2.4" = _8KckoYYx;
        "pkg-0.2.4+1.18.2" = _APlMMuHv;
        "pkg-0.2.4-1.19.3" = _oappeRas;
        "pkg-0.2.4-1.19.4" = _orprvivD;
        "pkg-0.2.4-1.20" = _sGC5H5z7;
        "pkg-0.3.0+1.18.2" = _6CYa6C4G;
        "pkg-0.3.0-1.19.2" = _H0zlF8h0;
        "pkg-0.3.0-1.20" = _i4lOfUKi;
        "pkg-0.3.1-1.19.2" = _xWZN8gD1;
        "pkg-0.3.1b+1.18.2" = _Gq8ZA8g5;
        "pkg-0.3.1b-1.20" = _1rlbeqqq;
        "pkg-0.3.1c-mc1.18.2" = _8fGL899S;
        "pkg-0.3.1c-mc1.19.2" = _DTIvtSyv;
        "pkg-0.3.1c-mc1.20" = _BBsXPt6b;
        "pkg-0.3.2-mc1.18.2" = _gz47lkok;
        "pkg-0.3.2-mc1.19.2" = _geWFyA8q;
        "pkg-0.3.2-mc1.20" = _HBM1j40D;
        "pkg-0.3.3-mc1.16.5" = _2sSg1tdH;
        "pkg-0.3.3-mc1.18.2" = _BKHVNQ8g;
        "pkg-0.3.3-mc1.19.2" = _Kq0En79V;
        "pkg-0.3.3-mc1.20" = _b8Re9crM;
        "pkg-0.3.4-mc1.20" = _aniVb7lY;
        "pkg-0.3.4-mc1.20.2" = _RliYluUf;
        "pkg-0.4.0-mc1.16.5" = _iAeN9BAq;
        "pkg-0.4.0-mc1.18.2" = _ZBpx4EWZ;
        "pkg-0.4.0-mc1.19.2" = _OgwTbShG;
        "pkg-0.4.0-mc1.20" = _3YUU4Lh6;
        "pkg-0.4.0-mc1.20.2" = _iMJH8lvR;
        "pkg-0.5.1-mc1.16.5" = _uk1AUUFD;
        "pkg-0.5.1-mc1.18.2" = _MofRZAnx;
        "pkg-0.5.1-mc1.19.2" = _HBtclYF2;
        "pkg-0.5.1-mc1.20" = _FjpGOad8;
        "pkg-0.5.1-mc1.20.2" = _X78C8vpw;
        "pkg-0.5.2-mc1.20.6" = _MH2YH5uW;
        "pkg-0.5.2-mc1.21" = _ASNG0X9q;
        "pkg-0.5.2-mc1.16.5" = _jreq2ubp;
        "pkg-0.5.2-mc1.18.2" = _XgoQYCLr;
        "pkg-0.5.2-mc1.20.2" = _SPdYCTMI;
        "pkg-0.5.2-mc1.20" = _EmLTEZM2;
        "pkg-0.5.3-mc1.16.5" = _nhWmG3vu;
        "pkg-0.5.3-mc1.18.2" = _CTWB75oJ;
        "pkg-0.5.3-mc1.19.2" = _Jh0PK6WF;
        "pkg-0.5.3-mc1.20(.1)" = _K7Zj7e8G;
        "pkg-0.5.3-mc1.21(.1)" = _BRIqXrPM;
        "pkg-0.5.3-mc1.21.6" = _3f3eEfAp;
        "pkg-0.5.4b-mc1.16.5" = _bx1qiPWk;
        "pkg-0.5.4b-mc1.18.2" = _3Yi4S6du;
        "pkg-0.5.4b-mc1.19.2" = _mL3l3mjy;
        "pkg-0.5.4b-mc1.20(.1)" = _QMRdFypn;
        "pkg-0.5.4b-mc1.21(.1)" = _Yx9NAld9;
        "pkg-0.5.4b-mc1.21.6" = _XlA1n0hN;
        "pkg-0.5.4b-mc1.21.4" = _uI0kWEK3;
        "pkg-0.5.4-mc1.21.9" = _GME0WWRE;
        "pkg-0.5.4-mc1.21.11" = _ZN4waCov;
        "pkg-0.5.4-mc26.1" = _nnoB59O9;
        "default" = _nnoB59O9;
    });
