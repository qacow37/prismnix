...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _9tE30Vgt;
        "pkg-1.3.1" = _jLXQ5a3Q;
        "pkg-2.0.0_fabric" = _DiRpfsur;
        "pkg-2.0.0_neoforge" = _SRTt7zbI;
        "pkg-2.0.1_fabric" = _cIsGuW3z;
        "pkg-2.0.1_neoforge" = _vRcFc0PX;
        "pkg-2.0.1-hotfix_neoforge" = _FOjPjgld;
        "pkg-2.0.1-hotfix_fabric" = _KVQG54ux;
        "pkg-2.0.2_neoforge" = _X9iAR7DZ;
        "pkg-2.0.2_fabric" = _bOIQBopG;
        "pkg-2.0.3_fabric" = _VL9uK4QA;
        "pkg-2.0.3_neoforge" = _UmIRhvy6;
        "pkg-2.0.4_fabric" = _SzAPIH5V;
        "pkg-2.0.4_neoforge" = _yHQg4oFS;
        "pkg-2.0.5_fabric" = _Lb77UpuS;
        "pkg-2.0.5_neoforge" = _fBvRktNx;
        "pkg-2.0.6_fabric" = _2NEPFFL1;
        "pkg-2.0.7_fabric" = _aPboUSe7;
        "pkg-2.0.7_neoforge" = _JLh3VIlb;
        "pkg-2.0.8_fabric" = _fevRhK7n;
        "pkg-2.0.8_neoforge" = _phumsMZx;
        "pkg-2.0.9_fabric" = _gPI5NWub;
        "pkg-2.0.9_neoforge" = _wkDWg8FW;
        "pkg-3.0.0" = _dH6chD7o;
        "pkg-3.0.1" = _hbPpAMks;
        "pkg-3.1.0" = _1h818ZcR;
        "pkg-3.2.0" = _5GLmlCMj;
