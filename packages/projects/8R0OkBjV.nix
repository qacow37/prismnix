...
let
    ...
    in {
        ...
        "pkg-test" = _QoNkiocD;
        "pkg-test+mod" = _rNNQudUE;
        "pkg-1.20.6_JE-03b" = _MnuQ61es;
        "pkg-1.20.6_JE-03b+mod" = _n7WIVdfk;
        "pkg-1.21_JE-0a" = _GvpkkFDt;
        "pkg-1.21_JE-0a+mod" = _LrpQzJ2p;
        "pkg-1.21_JE-1a" = _BuqwvPZk;
        "pkg-1.21_JE-1a+mod" = _UcujSlCY;
        "pkg-1.20.6_JE-5a" = _dF2Y3vqJ;
        "pkg-1.20.6_JE-5a+mod" = _a6EHop8O;
        "pkg-1.21_JE-2a" = _Y620gBSZ;
        "pkg-1.21_JE-2a+mod" = _6aLQRUl5;
        "pkg-1.21_JE-3a" = _GUK8W0Gu;
        "pkg-1.21_JE-3a+mod" = _LVh2LDO0;
        "pkg-1.21_JE-4a" = _zGPacpIP;
        "pkg-1.21_JE-4a+mod" = _WlU5M3cw;
        "pkg-1.21.4_JE-0a" = _j2MT7O6I;
        "pkg-1.21.4_JE-0a+mod" = _8pK0IiVy;
        "pkg-1.21.4_JE-0b" = _YLmi0AB7;
        "pkg-1.21.4_JE-0b+mod" = _dFnSBbLF;
        "pkg-1.21.4_JE-0" = _uOzh8MUO;
        "pkg-1.21.4_JE-0+mod" = _CTRW1qtW;
        "pkg-1.21.5_JE-0a" = _1wTFWuPJ;
        "pkg-1.21.5_JE-0a+mod" = _G1IHwTo2;
        "pkg-1.21.5_JE-0b" = _TGdTcI3Y;
        "pkg-1.21.5_JE-0b+mod" = _NgENZmZH;
        "pkg-1.21.5_JE-0c" = _LAphqpXi;
        "pkg-1.21.5_JE-0c+mod" = _HwUDmhsJ;
        "pkg-1.21.5_JE-0d" = _HZ2z2yAk;
        "pkg-1.21.5_JE-0d+mod" = _LMzHhARy;
        "pkg-1.21.5_JE-0e" = _cO6f3eOG;
        "pkg-1.21.5_JE-0e+mod" = _lycXMC9J;
        "pkg-1.21.5_JE-0" = _SZn7N9dZ;
        "pkg-1.21.5_JE-0+mod" = _qz3o3Z18;
        "pkg-1.21.6_JE-0" = _L2IQMyif;
        "pkg-1.21.6_JE-0+mod" = _7RubgxnT;
        "pkg-1.20.6_JE-6" = _sXcw8z4f;
        "pkg-1.20.6_JE-6+mod" = _w26nZO3M;
        "pkg-1.21.8_JE-0" = _y6XMboBx;
        "pkg-1.21.8_JE-0+mod" = _6VjpI3pY;
        "pkg-1.21.8_JE-1" = _3zccglZs;
        "pkg-1.21.8_JE-1+mod" = _OnY164Rm;
        "pkg-1.21.9_JE-0a" = _KYssxrKq;
        "pkg-1.21.9_JE-0a+mod" = _TqCPzi8q;
        "pkg-1.21.9_JE-0b" = _AiI07K2O;
        "pkg-1.21.9_JE-0b+mod" = _Pvrw5omO;
        "pkg-1.21.9_JE-0c" = _4VAh5t04;
        "pkg-1.21.9_JE-0c+mod" = _6ZkWr7mH;
        "pkg-1.21.9_JE-0d" = _2f4buM9G;
        "pkg-1.21.9_JE-0d+mod" = _qrFW32yH;
        "pkg-1.21.9_JE-0e" = _O5Jt9Ei6;
        "pkg-1.21.9_JE-0e+mod" = _VUdelZIN;
        "pkg-1.21.9_JE-0" = _zvl4Urny;
        "pkg-1.21.9_JE-0+mod" = _hDpA5VJP;
        "pkg-1.21.11_JE-0a" = _skVTmqda;
        "pkg-1.21.11_JE-0a+mod" = _k92NpyU1;
        "pkg-1.21.11_JE-0" = _CoA5z4oq;
        "pkg-1.21.11_JE-0+mod" = _cHmWmLfg;
        "pkg-26.1_JE-0a" = _MxPHvAiR;
        "pkg-26.1_JE-0a+mod" = _AYo56R5S;
        "pkg-26.1_JE-0b" = _sWTblje7;
        "pkg-26.1_JE-0b+mod" = _agDfSfeK;
        "pkg-26.1_JE-0" = _T0u60THE;
        "pkg-26.1_JE-0+mod" = _RgP5N2ES;
        "pkg-26.1_JE-0_fools" = _TjGB9XqA;
        "pkg-26.1_JE-0_fools+mod" = _gyLnGpik;
        "pkg-26.2_JE-0a" = _jujoHrzV;
        "pkg-26.2_JE-0a+mod" = _8EnCGXib;
        "pkg-26.2_JE-0" = _YDWagqWz;
        "pkg-26.2_JE-0+mod" = _SONtdw7p;
        "default" = _SONtdw7p;
    });
