...
let
    ...
    in {
        ...
        "pkg-1.8.0" = _IHP5Gek8;
        "pkg-1.9.0" = _disGqDNB;
        "pkg-neoforge-2.0.0" = _YozFkF0j;
        "pkg-fabric-2.0.0" = _Mn42ikPs;
        "pkg-neoforge-2.0.1" = _hidb3m8h;
        "pkg-fabric-2.0.1" = _MDc6pUE5;
        "pkg-neoforge-2.1.0" = _zYeN9IDD;
        "pkg-fabric-2.1.0" = _es4P11Vt;
        "pkg-neoforge-2.2.0" = _Bd7LG0Ma;
        "pkg-fabric-2.2.0" = _xUGSWx4l;
        "pkg-neoforge-2.3.0" = _uRwGDNJE;
        "pkg-fabric-2.3.0" = _aKWiU1WZ;
        "pkg-neoforge-2.3.1" = _uJBA7QOq;
        "pkg-fabric-2.3.1" = _ttU5qSsI;
        "pkg-neoforge-2.3.2" = _DcBTXhoB;
        "pkg-fabric-2.3.2" = _34RAnq59;
        "pkg-neoforge-2.3.3" = _6Q2AB8f2;
        "pkg-fabric-2.3.3" = _UX6EfLSr;
        "pkg-neoforge-2.3.3.1" = _b54MtrYt;
        "pkg-fabric-2.3.3.1" = _UW7Bn1dD;
        "pkg-neoforge-2.3.3.2" = _58R4F1zp;
        "pkg-fabric-2.3.3.2" = _CVV0n7yg;
        "pkg-neoforge-2.3.3.3" = _54suBAeL;
        "pkg-fabric-2.3.3.3" = _REp2FLdU;
        "pkg-neoforge-2.3.3.4" = _uDnL95km;
        "pkg-fabric-2.3.3.4" = _i8RrQGUb;
        "pkg-neoforge-2.3.3.5" = _EfaOy9OP;
        "pkg-fabric-2.3.3.5" = _NyMu9sO5;
        "pkg-neoforge-2.3.3.6" = _5qInk9Fw;
        "pkg-fabric-2.3.3.6" = _MTPIhOsl;
        "pkg-neoforge-2.3.4" = _Hz92jALV;
        "pkg-fabric-2.3.4" = _rTlwv54u;
        "pkg-neoforge-2.3.5" = _MEHUYQpx;
        "pkg-fabric-2.3.5" = _faYB2S5D;
        "pkg-neoforge-2.3.6" = _9M0xNxDT;
        "pkg-fabric-2.3.6" = _bKG8MRgX;
        "pkg-neoforge-2.3.7" = _zKg8PDup;
        "pkg-fabric-2.3.7" = _3qRiNcLD;
        "pkg-neoforge-2.3.8" = _S5JOkD2N;
        "pkg-fabric-2.3.8" = _gYUmjNph;
        "pkg-neoforge-2.4.0" = _GcT2E79e;
        "pkg-fabric-2.4.0" = _fbWe8Nvq;
        "pkg-fabric-2.4.1" = _rqheIwfV;
        "pkg-neoforge-2.4.1" = _gOU2mwnj;
        "pkg-fabric-2.4.2" = _vpgC1ujz;
        "pkg-neoforge-2.4.2" = _udJ4sdRP;
        "pkg-fabric-2.4.3" = _AJtlNRTY;
        "pkg-neoforge-2.4.3" = _YFGbBo01;
        "default" = _YFGbBo01;
    });
