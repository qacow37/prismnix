...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _VSOkIh8g;
        "pkg-1.0.3" = _K6ZuQS2A;
        "pkg-1.21.5-1.0.4" = _Pze4gsgU;
        "pkg-1.21.5-1.0.5" = _AJNMKvzf;
        "pkg-1.20.1-1.0.6" = _xUUtwaGa;
        "pkg-1.21.1-1.0.6" = _S8MVGM6e;
        "pkg-1.21.5-1.0.6" = _6mewCRFJ;
        "pkg-1.21.6-1.0.6" = _Ny68800U;
        "pkg-1.21.8-1.0.6" = _rxbNzF9Q;
        "pkg-1.21.10-1.0.6" = _maeEQvx2;
        "pkg-1.21.10-1.0.7" = _yb2GBYZ2;
        "pkg-1.21.8-1.0.7" = _SEDJiG9B;
        "pkg-1.21.5-1.0.7" = _gzsG46Vf;
        "pkg-1.21.1-1.0.7" = _ERC5pQ1r;
        "pkg-1.20.1-1.0.7" = _nSIr1wgq;
        "pkg-1.21.11-1.0.8" = _lI1EebJO;
        "pkg-1.20.1-1.0.8a" = _poubiwle;
        "pkg-1.21.1-1.0.8a" = _XleCs4Bu;
        "pkg-1.21.5-1.0.8a" = _Jlys9eOC;
        "pkg-1.21.8-1.0.8a" = _zbJAyZY8;
        "pkg-1.21.10-1.0.8a" = _IlGttOi5;
        "pkg-1.21.11-1.0.8a" = _bezxk4Lh;
        "pkg-26.1-1.0.9" = _JA4xoBM2;
