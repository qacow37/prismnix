...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Fabric" = _ZiAXpaFx;
        "pkg-v4.0.2-1.19.2-Forge" = _cWbBHrVq;
        "pkg-v4.0.2-1.19.2-Fabric" = _bOhIfLF2;
        "pkg-v5.0.0-1.19.3-Forge" = _RXodeCao;
        "pkg-v5.0.0-1.19.3-Fabric" = _ampONFGD;
        "pkg-v6.0.0-1.19.4-Fabric" = _nNx44MUz;
        "pkg-v6.0.0-1.19.4-Forge" = _m8gDhbsJ;
        "pkg-v7.0.0-1.20-Forge" = _HI9NSi0x;
        "pkg-v7.0.0-1.20-Fabric" = _bq71IGCD;
        "pkg-v8.0.0-1.20.1-Forge" = _ccS2FE7z;
        "pkg-v8.0.0-1.20.1-Fabric" = _swZKTeT9;
        "pkg-v3.0.0-1.18.2-Forge" = _Mx07m9BE;
        "pkg-v3.0.0-1.18.2-Fabric" = _YXVxQ8hj;
        "pkg-v8.0.1-1.20.1-Forge" = _lENqGnoP;
        "pkg-v8.0.1-1.20.1-Fabric" = _Uw0uxYMJ;
        "pkg-v20.4.0-1.20.4-Fabric" = _sgyJ8ygR;
        "pkg-v20.4.0-1.20.4-Forge" = _2C6IVjq1;
        "pkg-v20.4.0-1.20.4-NeoForge" = _Q2Xv43wn;
        "pkg-v21.0.0-1.21-Fabric" = _FZ4m5G8W;
        "pkg-v21.0.0-1.21-NeoForge" = _SG66Iuyb;
        "pkg-v21.0.1-1.21-Fabric" = _urYriZWB;
        "pkg-v21.0.1-1.21-NeoForge" = _VnhAD9hV;
        "pkg-v21.1.0-1.21.1-Fabric" = _qKA8h2Ni;
        "pkg-v21.1.0-1.21.1-NeoForge" = _UVSMPjiS;
        "pkg-v21.3.0-1.21.3-Fabric" = _nEXqcATu;
        "pkg-v21.3.0-1.21.3-NeoForge" = _tSSpt8F2;
        "pkg-v21.4.0-1.21.4-Fabric" = _VS0R5MSy;
        "pkg-v21.4.0-1.21.4-NeoForge" = _QMm5M0WZ;
        "pkg-v21.5.0-1.21.5-Fabric" = _huwPvWUd;
        "pkg-v21.5.0-1.21.5-NeoForge" = _BDxqoQml;
        "pkg-v21.6.0-1.21.6-Fabric" = _87tqwWoV;
        "pkg-v21.6.0-1.21.6-NeoForge" = _lXDoZYND;
        "pkg-v21.7.0-1.21.7-Fabric" = _647DkGrq;
        "pkg-v21.7.0-1.21.7-NeoForge" = _zzVKCVnM;
        "pkg-v21.8.0-1.21.8-Fabric" = _JxG2VmQK;
        "pkg-v21.8.0-1.21.8-NeoForge" = _UM43r56z;
        "pkg-21.9.0" = _TMrB7lrU;
        "pkg-21.10.0" = _VNuGdTnX;
