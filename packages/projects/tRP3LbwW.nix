...
let
    ...
    in {
        ...
        "pkg-0.0.1" = _3MBH46Q6;
        "pkg-0.0.2" = _Bvfsiwoe;
        "pkg-mc1.20.6-0.1.0-neoforge" = _2AyLwc1B;
        "pkg-mc1.21.4-0.1.0-fabric" = _2qkNdZwc;
        "pkg-mc1.21.10-0.1.0-forge" = _djq1xERs;
        "pkg-mc1.21.3-0.1.0-forge" = _kSy2FxgG;
        "pkg-mc1.21.5-0.1.0-neoforge" = _SajL3sJh;
        "pkg-mc1.21-0.1.0-forge" = _93W50Y80;
        "pkg-mc1.21.1-0.1.0-neoforge" = _C8dXZLIt;
        "pkg-mc1.21-0.1.0-fabric" = _gmm7R0Qf;
        "pkg-mc1.21.6-0.1.0-fabric" = _ZxJmM3CZ;
        "pkg-mc1.20.1-0.1.0-forge" = _ZcL4a8Z4;
        "pkg-mc1.20.5-0.1.0-fabric" = _Ssmdsu1G;
        "pkg-mc1.21.9-0.1.0-fabric" = _g9lTJEqF;
        "pkg-mc1.20.2-0.1.0-fabric" = _vDBa8ElU;
        "pkg-mc1.21.10-0.1.0-fabric" = _3nyYJjpM;
        "pkg-mc1.20.6-0.1.0-fabric" = _mUsUdq4X;
        "pkg-mc1.20.4-0.1.0-forge" = _ip3Fi2MS;
        "pkg-mc1.21.7-0.1.0-forge" = _QC1ghTJn;
        "pkg-mc1.21.8-0.1.0-neoforge" = _UUgVBavE;
        "pkg-mc1.21.1-0.1.0-forge" = _odWQUlYN;
        "pkg-mc1.21.4-0.1.0-neoforge" = _VsauDLTE;
        "pkg-mc1.21.11-0.1.0-forge" = _IJxwA4bH;
        "pkg-mc1.20.4-0.1.0-fabric" = _mu0Hgnhq;
        "pkg-mc1.21.5-0.1.0-forge" = _B9winBgD;
        "pkg-mc1.21.5-0.1.0-fabric" = _KIzczrl1;
        "pkg-mc1.20.3-0.1.0-forge" = _cVIWLEFu;
        "pkg-mc1.20.2-0.1.0-forge" = _RBQzC6kD;
        "pkg-mc1.21.4-0.1.0-forge" = _S1j3oQdd;
        "pkg-mc1.21.3-0.1.0-fabric" = _ZKMrLqDf;
        "pkg-mc1.20.1-0.1.0-fabric" = _500mUmKC;
        "pkg-mc1.20-0.1.0-forge" = _OsrBP174;
        "pkg-mc1.20.6-0.1.0-forge" = _lcZdbdbx;
        "pkg-mc1.21.1-0.1.0-fabric" = _KGlKq1Nv;
        "pkg-mc1.21.11-0.1.0-fabric" = _Yq0kgCRE;
        "pkg-mc1.21-0.1.0-neoforge" = _s9QOyKej;
        "pkg-mc1.21.7-0.1.0-fabric" = _3iOecHqq;
        "pkg-mc1.20.3-0.1.0-fabric" = _wfuwgGNI;
        "pkg-mc1.20-0.1.0-fabric" = _13lOUZaX;
        "pkg-mc1.20.2-0.1.0-neoforge" = _Htiakz3t;
        "pkg-mc1.21.8-0.1.0-forge" = _B53YpVOy;
        "pkg-mc1.21.10-0.1.0-neoforge" = _eGOiGANu;
        "pkg-mc1.21.9-0.1.0-forge" = _qu34LsvQ;
        "pkg-mc1.20.4-0.1.0-neoforge" = _MyIwapex;
        "pkg-mc1.21.3-0.1.0-neoforge" = _Fiapq5GG;
        "pkg-mc1.21.2-0.1.0-fabric" = _ieace7fw;
        "pkg-mc1.21.6-0.1.0-forge" = _8ddaa20s;
        "pkg-mc1.21.8-0.1.0-fabric" = _BwDuywK3;
        "pkg-mc1.21.10-0.1.1-fabric" = _ubgq9LTl;
        "pkg-mc1.21.4-0.1.1-neoforge" = _RDDpnokf;
        "pkg-mc1.21.7-0.1.1-fabric" = _cdPrdGpW;
        "pkg-mc1.21.4-0.1.1-fabric" = _VZzDwiOL;
        "pkg-mc1.21.3-0.1.1-fabric" = _j6DPpOLp;
        "pkg-mc1.21.3-0.1.1-forge" = _muIHK9zv;
        "pkg-mc1.20-0.1.1-fabric" = _hWG6Vwd2;
        "pkg-mc1.20.4-0.1.1-fabric" = _vZChb8BG;
        "pkg-mc1.21.10-0.1.1-neoforge" = _irJeB9ug;
        "pkg-mc1.21.6-0.1.1-fabric" = _bnQPpVzc;
        "pkg-mc1.20.6-0.1.1-fabric" = _RAuo8dXi;
        "pkg-mc1.20.2-0.1.1-neoforge" = _fDgO5myP;
        "pkg-mc1.20.4-0.1.1-neoforge" = _yFgSmryZ;
        "pkg-mc1.20.2-0.1.1-forge" = _wB590lmD;
        "pkg-mc1.21.8-0.1.1-fabric" = _5RLAAmZJ;
        "pkg-mc1.20.6-0.1.1-neoforge" = _bg0Z9MHv;
        "pkg-mc1.20-0.1.1-forge" = _iYbyS1qz;
        "pkg-mc1.21.11-0.1.1-fabric" = _PVRPPvhl;
        "pkg-mc1.20.2-0.1.1-fabric" = _BdaNHoGH;
        "pkg-mc1.21.2-0.1.1-fabric" = _KXOkBARb;
        "pkg-mc1.21-0.1.1-forge" = _k7Q3LHV5;
        "pkg-mc1.20.1-0.1.1-forge" = _HafO9Lcd;
        "pkg-mc1.21.5-0.1.1-fabric" = _NwISavhz;
        "pkg-mc1.20.1-0.1.1-fabric" = _aAIFofas;
        "pkg-mc1.21.8-0.1.1-forge" = _g7u9JBpF;
        "pkg-mc1.21-0.1.1-fabric" = _82gDm6hW;
        "pkg-mc1.21.1-0.1.1-neoforge" = _o98APOT2;
        "pkg-mc1.21.1-0.1.1-forge" = _a1q9IZ4k;
        "pkg-mc1.21-0.1.1-neoforge" = _3MDU2xJU;
        "pkg-mc1.21.9-0.1.1-fabric" = _SLb1ug8H;
        "pkg-mc1.21.10-0.1.1-forge" = _WTTauASR;
        "pkg-mc1.21.1-0.1.1-fabric" = _9HlpBf07;
        "pkg-mc1.21.7-0.1.1-forge" = _YlvyfdE9;
        "pkg-mc1.21.6-0.1.1-forge" = _85ZCuiAg;
        "pkg-mc1.21.8-0.1.1-neoforge" = _IZ9wm0Oe;
        "pkg-mc1.20.5-0.1.1-fabric" = _xyUx8PMY;
        "pkg-mc1.20.3-0.1.1-fabric" = _lYsVdg0m;
        "pkg-mc1.20.4-0.1.1-forge" = _pn4j8cNQ;
        "pkg-mc1.21.4-0.1.1-forge" = _I9Y1RZ5a;
        "pkg-mc1.20.3-0.1.1-forge" = _uZIJAonL;
        "pkg-mc1.21.11-0.1.1-forge" = _YLlyksJN;
        "pkg-mc1.21.5-0.1.1-neoforge" = _5z5c6pwy;
        "pkg-mc1.21.5-0.1.1-forge" = _NXahkcbu;
        "pkg-mc1.21.3-0.1.1-neoforge" = _H4RM1nYI;
        "pkg-mc1.21.9-0.1.1-forge" = _95xPO7QC;
        "pkg-mc1.20.6-0.1.1-forge" = _q6xvtiv0;
        "pkg-mc1.20.1-0.1.2-fabric" = _byPm74zn;
        "pkg-mc1.21.1-0.1.2-fabric" = _g2UX0o3j;
        "pkg-mc1.20.1-0.1.2-forge" = _EATQ8ZV8;
        "pkg-mc1.21.1-0.1.2-neoforge" = _CuXwaChY;
        "pkg-mc1.20.1-0.1.3-fabric" = _qi4e8wHR;
        "pkg-mc1.21.1-0.1.3-fabric" = _TQmMoQ7a;
        "pkg-mc1.20.1-0.1.3-forge" = _lWIT6Jtt;
        "pkg-mc1.21.1-0.1.3-neoforge" = _hPgQ2Mmi;
        "pkg-mc1.20.1-0.1.4-fabric" = _H7eKJbN6;
        "pkg-mc1.21.1-0.1.4-fabric" = _UMCu7rfx;
        "pkg-mc1.20.1-0.1.4-forge" = _lIcW4jdb;
        "pkg-mc1.21.1-0.1.4-neoforge" = _3CBdFcN8;
        "pkg-mc1.20.1-0.2.0-fabric" = _7f0BQiRG;
        "pkg-mc1.21.1-0.2.0-fabric" = _5S0jOPuX;
        "pkg-mc1.20.1-0.2.0-forge" = _SmaxGNvW;
        "pkg-mc1.21.1-0.2.0-neoforge" = _NaO4UoWX;
        "default" = _NaO4UoWX;
    });
