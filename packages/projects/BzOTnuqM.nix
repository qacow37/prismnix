...
let
    ...
    in {
        ...
        "pkg-1.0.2-fabric" = _VhIIFGt9;
        "pkg-1.0.2-forge" = _vdNCYyti;
        "pkg-1.0.3-fabric" = _hKBejyCd;
        "pkg-1.0.3-forge" = _P50FjZHE;
        "pkg-1.0.4-forge" = _h6Nosgyz;
        "pkg-1.0.5-fabric" = _5AZ0Cn5X;
        "pkg-1.0.5-forge" = _wefRvjWw;
        "pkg-1.0.6-forge" = _TdYmBoin;
        "pkg-1.0.6-fabric" = _YfKT9RVq;
        "pkg-2.0.0-fabric" = _zf0MmuPR;
        "pkg-2.0.1-forge" = _oO6uNgjf;
        "pkg-2.0.1-fabric" = _QX9oQPlh;
        "pkg-2.0.2-forge" = _udqiWC1R;
        "pkg-2.0.2-fabric" = _RO1br5Ay;
        "pkg-1.0.7-fabric" = _W3PHcy5R;
        "pkg-1.0.7-forge" = _fDM4ZHB4;
        "pkg-2.0.3-fabric" = _u6Rd7ASZ;
        "pkg-2.0.3-forge" = _Abr6RN2m;
        "pkg-2.0.4-forge" = _xHCf7akP;
        "pkg-1.0.8-rc1-forge" = _BjH34LWr;
        "pkg-1.0.8-rc1-fabric" = _NnNRikDR;
        "pkg-2.0.5-rc1-fabric" = _V6Q0thC1;
        "pkg-2.0.5-rc1-forge" = _Y27PLgRK;
        "pkg-1.1.0-rc1-fabric" = _DcMeuvrm;
        "pkg-1.1.0-rc1-forge" = _iTWffk2l;
        "pkg-2.1.0-rc1-fabric" = _xOSwBLhp;
        "pkg-2.1.0-rc1-forge" = _Xn18Jd5T;
        "pkg-2.1.0-rc2-fabric" = _AP5v9jux;
        "pkg-2.1.0-rc2-forge" = _OzDNFqID;
        "pkg-1.1.0-rc2-forge" = _PkABpgt3;
        "pkg-1.1.0-rc2-fabric" = _ePrM6qB3;
        "pkg-1.1.0-rc3-forge" = _4IYeOzay;
        "pkg-1.1.0-rc3-fabric" = _ZS8LUapS;
        "pkg-2.1.0-rc3-fabric" = _sA9DiaXH;
        "pkg-2.1.0-rc3-forge" = _UERbtc6r;
        "pkg-1.1.0-rc4-fabric" = _5cmv3RJO;
        "pkg-1.1.0-rc4-forge" = _zeaBoLr1;
        "pkg-2.1.0-rc4-forge" = _PM13fmiY;
        "pkg-2.1.0-rc4-fabric" = _Digtujum;
        "pkg-2.2.0-fabric" = _4zabduUl;
        "pkg-1.1.0-forge" = _IY8LLG1z;
        "pkg-1.1.0-fabric" = _nLJ2u1G6;
        "pkg-2.1.0-forge" = _qBnKkZQl;
        "pkg-2.2.1-forge" = _qZh8hb7T;
        "pkg-2.2.1-fabric" = _PqF7nQTl;
        "pkg-2.1.0-fabric" = _kXauJ2Jc;
        "pkg-1.1.1-forge" = _fMSK9waS;
        "pkg-1.1.1-fabric" = _LttuWRES;
        "pkg-2.1.1-forge" = _izzK5EOx;
        "pkg-2.1.1-fabric" = _dgwE8hqM;
        "pkg-2.2.2-forge" = _kVaRNfWB;
        "pkg-2.2.2-fabric" = _vLU7uXVU;
        "pkg-2.2.3-forge" = _hdt350lc;
        "pkg-2.2.4-forge" = _fswDCOPq;
        "pkg-2.2.0-forge" = _qucgC54g;
        "pkg-2.3.0-forge" = _qOq9fpCE;
        "pkg-2.3.0-fabric" = _Ob0lrHqm;
        "pkg-2.3.1-forge" = _45JURpeB;
        "pkg-2.3.1-fabric" = _aHxslymz;
        "pkg-2.3.2-forge" = _JzZnvkbB;
        "pkg-2.3.2-fabric" = _9AatgNeH;
        "pkg-2.4.0-forge" = _ghVVfWYa;
        "pkg-2.4.0-fabric" = _rfb8ep0y;
        "pkg-2.2.3-fabric" = _KJWjVsXQ;
        "pkg-2.3.3-forge" = _Maq2nduT;
        "pkg-2.3.3-fabric" = _IlCSOHDp;
        "pkg-2.4.1-forge" = _yn43yCeQ;
        "pkg-2.4.1-fabric" = _i6DSxyYB;
        "pkg-2.2.4-fabric" = _nQ6qPHyR;
        "pkg-2.4.2-forge" = _XUbbB9HG;
        "pkg-2.4.2-fabric" = _RL2cGwR9;
        "pkg-3.0.0-fabric" = _YCMoHSGT;
        "pkg-3.0.0-forge" = _yrXrY7Ml;
        "pkg-3.0.1-forge" = _IAhCWFuT;
        "pkg-3.0.1-fabric" = _uChbTP8I;
        "pkg-3.0.2-forge" = _uUW5O5l0;
        "pkg-3.0.2-fabric" = _4ch5FODy;
        "pkg-2.2.5-forge" = _7udzyVBW;
        "pkg-2.2.5-fabric" = _47ezEpaQ;
        "pkg-3.0.3-forge" = _fw65hQbm;
        "pkg-3.0.3-fabric" = _WRYj0yVz;
        "pkg-2.2.6-forge" = _1nZ0xvnK;
        "pkg-2.2.6-fabric" = _Wim3JDMB;
        "pkg-3.0.4-forge" = _IYCLyKnC;
        "pkg-3.0.4-fabric" = _uDB4LDS5;
        "pkg-3.0.4-neoforge" = _RDT3qOT8;
        "pkg-2.2.7-forge" = _U9pxWMsT;
        "pkg-2.2.7-fabric" = _4OEvS496;
        "pkg-3.0.5-forge" = _p1o1D500;
        "pkg-3.0.5-fabric" = _CfLpwi5y;
        "pkg-3.0.5-neoforge" = _iwWfaSmM;
        "pkg-3.0.6-forge" = _hTIPlPe0;
        "pkg-3.0.6-fabric" = _AXNVOwQA;
        "pkg-3.0.6-neoforge" = _2fC9cF7d;
        "pkg-4.0.0-neoforge" = _sykct1KW;
        "pkg-4.0.0-fabric" = _5PKH2kNG;
        "pkg-2.2.8-forge" = _auuAN6tj;
        "pkg-2.2.8-fabric" = _CSj7ZQnq;
        "pkg-3.0.7-forge" = _SGy5onGC;
        "pkg-3.0.7-fabric" = _Ko55FDdm;
        "pkg-3.0.7-neoforge" = _mjLXnRap;
        "pkg-4.0.1-neoforge" = _nRWi52U0;
        "pkg-4.0.1-fabric" = _xAHpUB02;
        "pkg-3.0.8-forge" = _Qg1GIkSR;
        "pkg-3.0.8-fabric" = _PlT1ZWd8;
        "pkg-3.0.8-neoforge" = _MVYep1Is;
        "pkg-3.0.9-forge" = _2nNikRqo;
        "pkg-3.0.9-fabric" = _Tf0yKMOE;
        "pkg-3.0.9-neoforge" = _bFKYWI3Y;
        "pkg-4.0.2-neoforge" = _Cp4ZzLfr;
        "pkg-4.0.2-fabric" = _MWJwdSOe;
        "pkg-3.0.10-forge" = _SNy8BW2U;
        "pkg-3.0.10-fabric" = _xcz8AAAM;
        "pkg-4.0.3-neoforge" = _L8v0m3uV;
        "pkg-4.0.3-fabric" = _L7kKDJaE;
        "pkg-3.1.0-forge" = _SyXxU9Q9;
        "pkg-3.1.0-fabric" = _qjy6kipn;
        "pkg-4.1.0-neoforge" = _WyygFzg2;
        "pkg-4.1.0-fabric" = _YraQXZve;
        "pkg-3.1.1-forge" = _wKI114KD;
        "pkg-3.1.1-fabric" = _xdb8qe3o;
        "pkg-4.1.1-neoforge" = _lGXgPX6k;
        "pkg-4.1.1-fabric" = _MqPgSbpi;
        "pkg-4.1.2-neoforge" = _q4zGX3yH;
        "pkg-4.1.2-fabric" = _8I3KR1JC;
        "pkg-3.1.2-forge" = _2JiBDe8e;
        "pkg-3.1.2-fabric" = _4I0fr3sf;
        "pkg-4.1.3-neoforge" = _DE4mG0SC;
        "pkg-4.1.3-fabric" = _RVEdN7HL;
        "pkg-3.1.3-forge" = _UOx4FktP;
        "pkg-3.1.3-fabric" = _bZwS6XwO;
        "pkg-3.1.4-forge" = _39kka5WI;
        "pkg-3.1.4-fabric" = _HbW6vjdo;
        "pkg-4.1.4-neoforge" = _uo9O1Skp;
        "pkg-4.1.4-fabric" = _ezk8Sshm;
        "pkg-4.1.5-fabric" = _o6JOZWMI;
        "pkg-4.1.5-neoforge" = _JNJEaiVz;
        "pkg-4.1.6-neoforge" = _ue5OK9Nm;
        "pkg-4.1.6-fabric" = _9qF6tTGb;
        "pkg-3.1.5-fabric" = _umdFUpK5;
        "pkg-3.1.5-forge" = _XD5eeUV8;
        "pkg-4.1.7-fabric" = _x2OkUtK9;
        "pkg-4.1.7-neoforge" = _Gb5vKQcg;
        "pkg-3.1.6-fabric" = _euVWdgCE;
        "pkg-3.1.6-forge" = _wHKGw1V3;
        "pkg-3.1.7-forge" = _wUOiBcSa;
        "pkg-3.1.7-fabric" = _vOws9NgW;
        "pkg-21.1.0.0-neoforge" = _3DOm8Jt5;
        "pkg-21.1.0.0-fabric" = _pOwSW2n3;
        "pkg-21.5.0.0-neoforge" = _qo1D6nig;
        "pkg-21.5.0.0-fabric" = _3X8jtq6c;
        "pkg-21.8.0.0-fabric" = _7YOw8F66;
        "pkg-21.8.0.0-neoforge" = _CdN1yeGH;
        "pkg-21.10.0.0-neoforge" = _Pcz25Ufr;
        "pkg-21.10.0.0-fabric" = _VfZRNENR;
        "pkg-3.2.0-fabric" = _ATXLPWT0;
        "pkg-3.2.0-forge" = _XCiBzBG6;
        "pkg-21.1.1.0-neoforge" = _O3e5W525;
        "pkg-21.1.1.0-fabric" = _ffBetMZb;
        "pkg-21.5.1.0-neoforge" = _k2yPAuli;
        "pkg-21.5.1.0-fabric" = _DLw6UXfQ;
        "pkg-21.8.1.0-neoforge" = _jMeDmByD;
        "pkg-21.8.1.0-fabric" = _Iwone7mf;
        "pkg-21.10.1.0-fabric" = _jK5RPcY3;
        "pkg-21.10.1.0-neoforge" = _Z6d3xsxW;
        "pkg-21.11.0.0-neoforge" = _1EkHh2OF;
        "pkg-21.11.0.0-fabric" = _YIwkbGkX;
        "pkg-3.2.1-fabric" = _NUFuzfUv;
        "pkg-3.2.1-forge" = _JA2Q4vot;
        "pkg-21.11.0.1-neoforge" = _uYvppPui;
        "pkg-21.11.0.1-fabric" = _dXS7dGpr;
        "pkg-3.2.2-forge" = _KHKYNAXy;
        "pkg-3.2.2-fabric" = _Kdv3wEoL;
        "pkg-21.1.1.1-neoforge" = _TVK0H15R;
        "pkg-21.1.1.1-fabric" = _aJg0Rhqh;
        "pkg-21.10.1.1-neoforge" = _uETFd3e1;
        "pkg-21.10.1.1-fabric" = _ae3FnaDe;
        "pkg-21.11.0.2-fabric" = _RdVDZAv8;
        "pkg-21.11.0.2-neoforge" = _mqhpVX6n;
        "pkg-3.2.3-forge" = _EfRhxLbX;
        "pkg-3.2.3-fabric" = _hI4gvof3;
        "pkg-21.1.1.2-neoforge" = _bN7LPTYI;
        "pkg-21.1.1.2-fabric" = _g1642wTy;
        "pkg-21.10.1.2-neoforge" = _bXCGKx5M;
        "pkg-21.10.1.2-fabric" = _Wp2cbthH;
        "pkg-21.11.0.3-neoforge" = _galYfHr6;
        "pkg-21.11.0.3-fabric" = _PiLU3EcM;
        "pkg-26.1.2.0-fabric" = _hYqYKtnG;
        "pkg-26.1.2.0-neoforge" = _a35qp7ON;
        "pkg-3.2.4-fabric" = _IA2nIq7l;
        "pkg-3.2.4-forge" = _BCAasKdC;
        "pkg-21.1.1.3-neoforge" = _IgNgEq29;
        "pkg-21.1.1.3-fabric" = _VNhz553W;
        "pkg-21.11.0.4-neoforge" = _JZNmPRq9;
        "pkg-21.11.0.4-fabric" = _bU0EX8cs;
        "pkg-26.1.2.1-neoforge" = _dUFEq1pK;
        "pkg-26.1.2.1-fabric" = _Cj9Xytxb;
        "pkg-26.2.0.0-neoforge" = _qh9FRW7H;
        "pkg-26.2.0.0-fabric" = _VvHQIHN9;
        "pkg-3.3.0-forge" = _ky9CNYBq;
        "pkg-3.3.0-fabric" = _lqJPSkOV;
        "pkg-21.1.2.0-neoforge" = _XAaz1mVD;
        "pkg-21.1.2.0-fabric" = _5NsTONv3;
        "pkg-21.11.1.0-neoforge" = _eZBzIHv4;
        "pkg-21.11.1.0-fabric" = _Q4iP40O9;
        "pkg-26.1.2.2.0-neoforge" = _MgBOZG7B;
        "pkg-26.1.2.2.0-fabric" = _mc4jUNri;
        "pkg-26.2.1.0-neoforge" = _Z3iV15JU;
        "pkg-26.2.1.0-fabric" = _GqGAYLCI;
        "pkg-3.3.1-forge" = _58Ch7zOu;
        "pkg-3.3.1-fabric" = _3iHCywdy;
        "pkg-21.1.2.1-fabric" = _l3UnUslY;
        "pkg-21.1.2.1-neoforge" = _OP0UGzId;
        "pkg-21.11.1.1-neoforge" = _L8LXk9Hr;
        "pkg-21.11.1.1-fabric" = _EyaakGcA;
        "pkg-26.1.2.2.1-neoforge" = _mdF4iden;
