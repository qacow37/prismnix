...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.3" = _dtRPxMGq;
        "pkg-1.0.0+1.20.4" = _uvsqKrii;
        "pkg-1.0.0+1.20.5-6" = _hCWgKKcC;
        "pkg-1.0.0+1.21" = _HKfm8hap;
        "pkg-1.0.1+1.20" = _8YLtIaya;
        "pkg-1.0.1+1.20.1" = _KKArM1Vl;
        "pkg-1.0.1+1.20.2" = _ICIHSnrC;
        "pkg-1.0.1+1.20.3" = _oZVSnvxQ;
        "pkg-1.0.1+1.20.4" = _NwkcQY1n;
        "pkg-1.0.1+1.20.5" = _w4yvrCxb;
        "pkg-1.0.1+1.21" = _KaRM7WYe;
        "pkg-2.0.0+1.20.1" = _zWeu0Cvq;
        "pkg-2.0.0+1.21" = _1alZdQss;
        "pkg-2.0.0+1.21.1" = _AEVWiI4r;
        "pkg-2.0.0+1.21.2" = _GhDxJpMj;
        "pkg-2.0.0+1.21.3" = _3b7zFxHr;
        "pkg-2.0.0+1.21.4" = _zWbieof5;
        "pkg-2.1.0+1.21.5" = _4CGYvzMk;
        "pkg-2.1.0+1.21.4" = _4o2IlJb7;
        "pkg-2.1.0+1.21.3" = _jYzFGE4K;
        "pkg-2.1.0+1.21.2" = _ndIlENY9;
        "pkg-2.1.0+1.21" = _LuVYh6RE;
        "pkg-2.1.0+1.20.1" = _SBmg56hL;
        "pkg-2.1.0+1.21.1" = _PbYtseMR;
        "pkg-2.1.1+1.21.5" = _6o4izDZa;
        "pkg-2.1.1+1.21.4" = _bLfWG6dL;
        "pkg-2.1.1+1.21.3" = _OaMfNJNK;
        "pkg-2.1.1+1.21.2" = _ouwqYmLR;
        "pkg-2.1.1+1.21.1" = _ogya5iij;
        "pkg-2.1.1+1.21" = _FNIne0hw;
        "pkg-2.1.1+1.20.1" = _qqTirWb3;
        "pkg-2.1.2+1.21.5" = _SA236Gzf;
        "pkg-2.1.2+1.21.4" = _Jw85FOX8;
        "pkg-2.1.2+1.21.3" = _GbmtdxNw;
        "pkg-2.1.2+1.21.2" = _riYK8498;
        "pkg-2.1.2+1.21" = _O8bGPppH;
        "pkg-2.1.2+1.21.1" = _s5hSlNiH;
        "pkg-2.1.2+1.20.1" = _cdHSBOrp;
        "pkg-2.1.3+1.21.5" = _pWoZAXWn;
        "pkg-2.1.3+1.21.3" = _49DnzG6K;
        "pkg-2.1.3+1.21.2" = _LndSfMRt;
        "pkg-2.1.3+1.21" = _B1IHr5Bo;
        "pkg-2.1.3+1.21.1" = _31G9Wn7N;
        "pkg-2.1.3+1.20.1" = _JQWxKWs1;
        "pkg-2.1.3+1.21.4" = _P94Dit5O;
        "pkg-2.1.4+1.21.4" = _MQd812ym;
        "pkg-2.1.4+1.21.5" = _B9V4EtMc;
        "pkg-2.1.4+1.21.3" = _Pu53PJaG;
        "pkg-2.1.4+1.21.2" = _I5PJFGz6;
        "pkg-2.1.4+1.21.1" = _LhLkEJll;
        "pkg-2.1.4+1.21" = _i63JabqB;
        "pkg-2.1.4+1.20.1" = _FMpJw8iT;
        "pkg-2.1.5+1.20.1" = _3VFBRkpf;
        "pkg-2.1.5+1.21" = _IDa41jgg;
        "pkg-2.1.5+1.21.1" = _DVsbrVt3;
        "pkg-2.1.5+1.21.2" = _V08JKoFm;
        "pkg-2.1.5+1.21.4" = _yD9RSDJL;
        "pkg-2.1.5+1.21.3" = _8l7du5b5;
        "pkg-2.1.5+1.21.5" = _FVMbYhTM;
        "pkg-2.1.6+1.20.1" = _WPx7qZNf;
        "pkg-2.1.6+1.21" = _ZLeJTD09;
        "pkg-2.1.6+1.21.1" = _myaG4rUh;
        "pkg-2.1.6+1.21.2" = _lO6S6nf5;
        "pkg-2.1.6+1.21.3" = _H0ECYl8T;
        "pkg-2.1.6+1.21.4" = _ZBHlvLcD;
        "pkg-2.1.6+1.21.5" = _whtifLuX;
        "pkg-2.1.7+1.20.1" = _KFgJzCge;
        "pkg-2.1.7+1.21" = _oOwvNmVi;
        "pkg-2.1.7+1.21.1" = _1Z5BoJL9;
        "pkg-2.1.7+1.21.2" = _oQRnXKj3;
        "pkg-2.1.7+1.21.3" = _aKVMJJEC;
        "pkg-2.1.7+1.21.4" = _Ia1a7HKz;
        "pkg-2.1.7+1.21.5" = _Wz4UJCHc;
        "pkg-2.1.8+1.20.1" = _m9nSIp51;
        "pkg-2.1.8+1.21" = _egqRO430;
        "pkg-2.1.8+1.21.1" = _PjvcRzHj;
        "pkg-2.1.8+1.21.3" = _SmYd3hlL;
        "pkg-2.1.8+1.21.2" = _QXEW9GAF;
        "pkg-2.1.8+1.21.4" = _KdgKoyNJ;
        "pkg-2.1.8+1.21.6" = _TR7bjxzu;
        "pkg-2.1.8+1.21.5" = _LCiulGye;
        "pkg-2.1.8+1.21.7" = _SzaD0emE;
        "pkg-2.1.9+1.20.1" = _2YiiZkfi;
        "pkg-2.1.9+1.21" = _GycoRAr4;
        "pkg-2.1.9+1.21.1" = _9v7dc9mm;
        "pkg-2.1.9+1.21.3" = _Q2EWtgIk;
        "pkg-2.1.9+1.21.2" = _BBwEV0w1;
        "pkg-2.1.9+1.21.5" = _kUwWISmS;
        "pkg-2.1.9+1.21.4" = _GXppoEWi;
        "pkg-2.1.9+1.21.6" = _RiH4ZUq8;
        "pkg-2.1.9+1.21.7" = _YXtjov0o;
        "pkg-2.1.9+1.21.8" = _Ji6j1tGG;
        "pkg-2.1.10+1.21.3" = _IuBwqH9P;
        "pkg-2.1.10+1.21.1" = _X8rr3Scb;
        "pkg-2.1.10+1.21.8" = _EF7bIywa;
        "pkg-2.1.10+1.21.5" = _fPrEC0pH;
        "pkg-2.1.10+1.21.6" = _EXWhD7Qt;
        "pkg-2.1.10+1.21.2" = _9dz84B2A;
        "pkg-2.1.10+1.20.1" = _BM7nSFDN;
        "pkg-2.1.10+1.21.4" = _OoNPBIsY;
        "pkg-2.1.10+1.21" = _IKi9EZXM;
        "pkg-2.1.10+1.21.7" = _5Ln8kj0V;
        "pkg-2.2.0+1.21" = _PY2MOMGp;
        "pkg-2.2.0+1.21.1" = _gDNdVjNK;
        "pkg-2.2.0+1.21.2" = _sGxf2jbP;
        "pkg-2.2.0+1.20.1" = _lrbgQU8q;
        "pkg-2.2.0+1.21.4" = _98xA3IFS;
        "pkg-2.2.0+1.21.5" = _w843lmtV;
        "pkg-2.2.0+1.21.3" = _lUykjMXV;
        "pkg-2.2.0+1.21.6" = _56Ruspdh;
        "pkg-2.2.0+1.21.7" = _tG93AFXi;
        "pkg-2.2.0+1.21.8" = _UZ2vVmiG;
        "pkg-2.2.1+1.20.1" = _1rvUfu7j;
        "pkg-2.2.1+1.21.1" = _Gs7k3z4y;
        "pkg-2.2.1+1.21" = _es37dkXU;
        "pkg-2.2.1+1.21.2" = _yMbhicRa;
        "pkg-2.2.1+1.21.3" = _sBGwAQBk;
        "pkg-2.2.1+1.21.4" = _DO0amwCO;
        "pkg-2.2.1+1.21.5" = _OiWyLVdy;
        "pkg-2.2.1+1.21.6" = _tnZl7gib;
        "pkg-2.2.1+1.21.8" = _FQgYEeKs;
        "pkg-2.2.1+1.21.7" = _q7UeVH5W;
        "pkg-2.2.2+1.20.1" = _L5FHlOYx;
        "pkg-2.2.2+1.21" = _mtoRvncZ;
        "pkg-2.2.2+1.21.1" = _5ANOGLlJ;
        "pkg-2.2.2+1.21.2" = _LWhtIHgi;
        "pkg-2.2.2+1.21.3" = _WHcyssPh;
        "pkg-2.2.2+1.21.4" = _sh7GBmWS;
        "pkg-2.2.2+1.21.5" = _dQmqzihk;
        "pkg-2.2.2+1.21.6" = _i2v5TpxQ;
        "pkg-2.2.2+1.21.7" = _9tbHC7BE;
        "pkg-2.2.2+1.21.8" = _6ThsptrS;
        "pkg-2.2.3+1.20.1" = _i6vT4bPg;
        "pkg-2.2.3+1.21" = _ZpBDAyEQ;
        "pkg-2.2.3+1.21.1" = _ulEsE3D6;
        "pkg-2.2.3+1.21.2" = _LWK6uUfZ;
        "pkg-2.2.3+1.21.3" = _1Z7JkE90;
        "pkg-2.2.3+1.21.4" = _vK1irhnj;
        "pkg-2.2.3+1.21.5" = _JbiiFrNm;
        "pkg-2.2.3+1.21.6" = _h9VTUTEN;
        "pkg-2.2.3+1.21.7" = _4zdEhZZ6;
        "pkg-2.2.3+1.21.8" = _KCt17xSi;
        "pkg-2.3.0+1.20.1" = _Kmf0ZHpD;
        "pkg-2.3.0+1.21" = _Z1G9Dso6;
        "pkg-2.3.0+1.21.1" = _D3rBLLSp;
        "pkg-2.3.0+1.21.4" = _UYJxvrey;
        "pkg-2.3.0+1.21.5" = _s8nS40JK;
        "pkg-2.3.0+1.21.6" = _O7UWzFCZ;
        "pkg-2.3.0+1.21.7" = _DBdPMXMO;
        "pkg-2.3.0+1.21.8" = _x4c9SvdU;
        "pkg-2.3.0+1.21.9" = _yFU3gEy9;
        "pkg-2.3.0+1.21.10" = _pCDKXp47;
        "pkg-2.3.1+1.20.1" = _7Q7Qkscf;
        "pkg-2.3.1+1.21" = _Ne6OKVHD;
        "pkg-2.3.1+1.21.1" = _4cF5S54k;
        "pkg-2.3.1+1.21.4" = _xq8s8YMo;
        "pkg-2.3.1+1.21.5" = _IthGNK6m;
        "pkg-2.3.1+1.21.6" = _k6CL4XcA;
        "pkg-2.3.1+1.21.7" = _PJaniJPJ;
        "pkg-2.3.1+1.21.8" = _SUovtky5;
        "pkg-2.3.1+1.21.9" = _sgxiQMrv;
        "pkg-2.3.1+1.21.10" = _g3vVWuy7;
        "pkg-2.3.2+1.20.1" = _rXSfJJLJ;
        "pkg-2.3.2+1.21" = _MBtyiXLI;
        "pkg-2.3.2+1.21.1" = _oxjzd8iN;
        "pkg-2.3.2+1.21.4" = _al5NmjOV;
        "pkg-2.3.2+1.21.5" = _BGaoUHuu;
        "pkg-2.3.2+1.21.6" = _8DvXWpXu;
        "pkg-2.3.2+1.21.7" = _OQ4KaqmQ;
        "pkg-2.3.2+1.21.8" = _pHSP0znn;
        "pkg-2.3.2+1.21.9" = _x66v1hYF;
        "pkg-2.3.2+1.21.10" = _zkt0gEXe;
        "pkg-2.3.3+1.20.1" = _Tescmn0P;
        "pkg-2.3.3+1.21" = _3V2RuS4P;
        "pkg-2.3.3+1.21.1" = _TyyMdG0O;
        "pkg-2.3.3+1.21.4" = _Y5SC8xeB;
        "pkg-2.3.3+1.21.5" = _h8nmBID6;
        "pkg-2.3.3+1.21.6" = _fxWY91qo;
        "pkg-2.3.3+1.21.7" = _5gAVrOfM;
        "pkg-2.3.3+1.21.8" = _qSWEgHNF;
        "pkg-2.3.3+1.21.9" = _znJDCZ4V;
        "pkg-2.3.3+1.21.10" = _qe6PZyBn;
        "pkg-2.3.3+1.21.11" = _VX3p0HFg;
        "pkg-2.4.0+26.1+fabric" = _SkqKD3QB;
        "pkg-2.5.0+26.2+fabric" = _cZD93Qih;
        "pkg-2.6.0+1.20.1+fabric" = _Go5Qi7Oy;
        "pkg-2.6.0+1.20.1+forge" = _EldynNUm;
        "pkg-2.6.0+1.21.1+fabric" = _TvRGMtQ2;
        "pkg-2.6.0+1.21.1+neoforge" = _7OBALdOg;
        "pkg-2.6.0+26.1+fabric" = _pkh96Lin;
