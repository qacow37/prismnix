...
let
    ...
    in {
        ...
        "pkg-2.9.4" = _DadiWI0h;
        "pkg-2.10" = _YqmM8rUF;
        "pkg-2.10.1" = _nM993mLI;
        "pkg-2.10.2" = _RoIVOf62;
        "pkg-2.10.3" = _oMCzxfQy;
        "pkg-2.10.4" = _ecGyIsIL;
        "pkg-2.11" = _bNfwJRec;
        "pkg-2.11.1" = _ZPu6rQjn;
        "pkg-2.11.2" = _oA6oqbGz;
        "pkg-2.11.3" = _Cdbh95Vl;
        "pkg-2.11.4" = _TewPRxN5;
        "pkg-2.12" = _hRvlqvYW;
        "pkg-2.12.1" = _oaa9ptFF;
        "pkg-2.12.2" = _xvfgzpcj;
        "pkg-2.12.3" = _3yCHHHPT;
        "pkg-2.12.4" = _xKiAq86p;
        "pkg-2.13" = _s4heJOea;
        "pkg-2.13.1" = _UVq3Orix;
        "pkg-2.13.2" = _PZW8Cqaw;
        "pkg-2.13.3" = _D0whQrDX;
        "pkg-2.13.4" = _ISr5sLOx;
        "pkg-2.14" = _ouoiYoEM;
        "pkg-2.14.1" = _IuFLYeS7;
        "pkg-2.14.2" = _Y9oHwoGS;
        "pkg-2.14.3" = _WttntAGc;
        "pkg-2.14.4" = _HrUnZ88b;
        "pkg-2.15" = _OhFFBppG;
        "pkg-2.15.1" = _SUHOjYB4;
        "pkg-2.15.2" = _B9JcwXVf;
        "pkg-2.15.3" = _5OGmmVUw;
        "pkg-2.15.4" = _53HdeqtN;
        "pkg-2.16" = _Vz37m4da;
        "pkg-2.16.1" = _whhGeHlp;
        "pkg-2.16.2" = _z1iBs45e;
        "pkg-2.16.3" = _DZuUHmAI;
        "pkg-2.16.4" = _4v7cetc2;
        "pkg-2.17" = _hFXWX9SD;
        "pkg-2.17.1" = _ziYlYsA3;
        "pkg-2.17.2" = _rB0KY3Ns;
        "pkg-2.17.3" = _2KabmHr9;
        "pkg-2.17.4" = _vPhlpJoE;
        "pkg-2.18" = _AUasHpuu;
        "pkg-2.18.1" = _khuKEuQf;
        "pkg-2.18.2" = _G9kSuaHu;
        "pkg-2.18.3" = _TsQiWdt0;
        "pkg-2.18.4" = _sDokRY5z;
        "pkg-2.19" = _bCVxPthh;
        "pkg-2.19.1" = _lKPLMEHa;
        "pkg-2.19.2" = _X1dLLnSX;
        "pkg-2.19.3" = _W6FGMAAY;
        "pkg-2.19.4" = _s9ZtbfQu;
        "pkg-2.20" = _kck6xi91;
        "pkg-2.20.1" = _y6OFJlyL;
        "pkg-2.20.2" = _nc4tl4OX;
        "pkg-2.20.3" = _I5EYmf9N;
        "pkg-2.20.4" = _MYdW7Upj;
        "pkg-2.21" = _ENNqwNNt;
        "pkg-2.21.1" = _s1egxnKM;
        "pkg-2.21.2" = _S11ksAw7;
        "pkg-2.21.3" = _ZDVKVRYh;
        "pkg-2.21.4" = _u0ZbsQ7O;
        "pkg-2.22" = _Gh8xFrgV;
        "pkg-2.22a" = _C1x55kVV;
        "default" = _C1x55kVV;
    });
