...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.9-fabric" = _SCghXn4v;
        "pkg-1.18.2-1.9-fabric" = _C9Dv52X6;
        "pkg-1.19.2-2.0-fabric" = _bip0qwX6;
        "pkg-1.16.5-1.4-forge" = _FiP8sJDu;
        "pkg-1.18.2-1.6-forge" = _aMkpCVZm;
        "pkg-1.19.2-1.8-forge" = _gbuIaTzt;
        "pkg-1.16.5-2.1-fabric" = _qjNxmgxt;
        "pkg-1.18.2-2.1-fabric" = _KhMw45l9;
        "pkg-1.19.2-2.1-fabric" = _TtZwVsxT;
        "pkg-1.16.5-2.2-fabric" = _Rxpi6JjT;
        "pkg-1.18.2-2.2-fabric" = _w9LJq8RP;
        "pkg-1.19.2-2.2-fabric" = _gB55nNAi;
        "pkg-1.16.5-2.2-forge" = _XEToLbwF;
        "pkg-1.18.2-2.2-forge" = _DIjWcX1b;
        "pkg-1.19.2-2.2-forge" = _mExh1Njl;
        "pkg-1.19.3-2.3-fabric" = _F0JecHIg;
        "pkg-1.19.3-2.2-forge" = _KElslfHM;
        "pkg-1.18.2-3.0-forge+fabric" = _n65CqjkR;
        "pkg-1.19.2-3.0-forge+fabric" = _sYvjQiKC;
        "pkg-1.19.3-3.0-forge+fabric" = _J63n9yyH;
        "pkg-1.19.4-3.0-forge+fabric" = _wsDK0o66;
        "pkg-1.20-3.0-forge+fabric" = _uEH1WKpA;
        "pkg-1.20.1-3.0-forge+fabric" = _E5HpLwMG;
        "pkg-1.20.2-3.0-forge+fabric" = _kYOZ0xfX;
        "pkg-1.18.2-3.1-forge+fabric" = _3spXy8yZ;
        "pkg-1.19.2-3.1-forge+fabric" = _V5AIWo39;
        "pkg-1.20.1-3.1-forge+fabric" = _4WrOwuzP;
        "pkg-1.20.2-3.1-forge+fabric" = _9xhX1Apw;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _puAk7CRD;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _odXIEpZO;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _5e0vwBGg;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _NL5pcN5e;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _sBHaeAe3;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _v4kCP3kj;
        "pkg-1.20.5-3.2-fabric+neo" = _lMjO3JSS;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _eEE7xPCB;
        "pkg-1.21.0-3.2-fabric+forge+neo" = _fsTEdquU;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _lp00NsMn;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _TdS4klpg;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _RSl1eMPx;
        "pkg-1.21.1-3.3-fabric+forge+neo" = _ACxrFtMz;
        "pkg-1.21.2-3.3-fabric+neo" = _iDQ1EDqC;
        "pkg-1.21.3-3.3-fabric+forge+neo" = _feSKwgjC;
        "pkg-1.21.4-3.3-fabric+forge+neo" = _JHEcuaIX;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _FdstVlDW;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _uCOQDBBn;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _Gys018jh;
        "pkg-1.21.5-3.4-fabric+forge+neo" = _GBDXBng9;
        "pkg-1.21.6-3.4-fabric+forge+neo" = _q87YSMvd;
        "pkg-1.21.7-3.4-fabric+forge+neo" = _e467R417;
        "pkg-1.21.8-3.4-fabric+forge+neo" = _EKYaWQlO;
        "pkg-1.21.9-3.4-fabric+forge+neo" = _tF36oGBZ;
        "pkg-1.21.10-3.4-fabric+forge+neo" = _PJUV0qHt;
        "pkg-1.21.11-3.4-fabric+forge+neo" = _IzZmDI2F;
        "pkg-26.1.0-3.4-fabric+forge+neo" = _zWvZBxCh;
        "pkg-26.1.1-3.4-fabric+forge+neo" = _CC3GkNqk;
        "pkg-26.1.2-3.4-fabric+forge+neo" = _YmqR8FpG;
        "pkg-26.2.0-3.4-fabric+forge+neo" = _cvQahNLR;
        "default" = _cvQahNLR;
    });
