...
let
    ...
    in {
        ...
        "pkg-1.0.0-release-1.17" = _HlpiIBKr;
        "pkg-1.0.0-release-1.18" = _zEJXl564;
        "pkg-1.0.1Beta-Update1-Build1-1.17" = _8xLZSCKD;
        "pkg-1.0.1Beta-Update2-Build1-1.17" = _JIpcZ2eR;
        "pkg-1.0.1Beta-Update1-Build1-1.18" = _XAGqNvlH;
        "pkg-1.0.1Beta-Update2-Build1-1.18" = _LMBQ6Qhh;
        "pkg-1.0.1Beta-Update3-Build1-1.17" = _TtxH9V0R;
        "pkg-1.0.1Beta-Update3-Build1-1.18" = _bnCf7TF3;
        "pkg-1.0.1Release-1.19.3" = _fFVR27TR;
        "pkg-1.0.1Release-1.19" = _WbQxKWm3;
        "pkg-1.0.1Release-1.8" = _RLvfYl8N;
        "pkg-1.0.1Release-1.17" = _eKtSE261;
        "pkg-1.0.2" = _L222KrN4;
        "pkg-1.0.3+1.17-Update1" = _L5uKLV94;
        "pkg-1.0.3+1.18-Update1" = _9SyMwCmI;
        "pkg-1.0.3+1.19.2-Update1" = _31wYFTZn;
        "pkg-1.0.3+1.19.4-Update1" = _Lv05gUsJ;
        "pkg-1.0.3+1.20.1-Update1" = _4unPhWZW;
        "pkg-1.0.3+1.20.1-Update1-hotfix" = _orDkXP1v;
        "pkg-1.0.3+1.17Final" = _P0pDNE88;
        "pkg-1.0.3+1.18Final" = _WqciVUCV;
        "pkg-1.0.3+1.19.2Final" = _ErtVwShP;
        "pkg-1.0.3+1.19.4Final" = _oc91609s;
        "pkg-1.1.0+1.20.1-dev-u1" = _C0G8fkoB;
        "default" = _C0G8fkoB;
    });
