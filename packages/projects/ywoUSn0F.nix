...
let
    ...
    in {
        ...
        "pkg-0.4.9" = _cMoqQtqo;
        "pkg-0.5.0" = _5ZiLrONo;
        "pkg-0.5.1-SNAPSHOT" = _HHsXW3PA;
        "pkg-0.5.1" = _yLkh69Pk;
        "pkg-0.5.2-SNAPSHOT" = _C0D7TAU8;
        "pkg-0.5.2" = _93aDEQ8M;
        "pkg-0.5.3" = _U8JMgazd;
        "pkg-0.5.4" = _zOURhGJH;
        "pkg-0.5.5" = _QIqGe9UI;
        ...
        "pkg-0.6.2" = _mdd12orN;
        "pkg-0.6.3" = _kMO0cBTN;
        "pkg-0.6.4-LAST" = _QuzD1Nv3;
        "pkg-0.6.4-1.18" = _h8Lj4aeH;
        "pkg-0.6.5" = _chY5uh1V;
        "pkg-0.6.6" = _12hJWE9e;
        "pkg-0.6.7" = _EO4pZz8r;
        "pkg-0.6.7-PATCH" = _JKou62Xw;
        "pkg-v0.6.9" = _tvUBCtpO;
        "pkg-0.7.0" = _6x41CQoE;
        "pkg-v0.7.1" = _TFX1lhed;
        "default" = _TFX1lhed;
    });
