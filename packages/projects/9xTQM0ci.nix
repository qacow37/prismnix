...
let
    ...
    in {
        ...
        "pkg-1.0.1-mc1.21.2" = _bs7srQm2;
        "pkg-1.0.2-mc1.21.1" = _BjGoZXF2;
        "pkg-1.0.2-mc1.21.2" = _hxO64BvD;
        "pkg-1.0.3-mc1.21.2" = _M3ehZ3FP;
        "pkg-1.0.3-mc1.21.1" = _jLdMn26A;
        "pkg-1.0.4-mc1.21.1" = _fCNesBEg;
        "pkg-1.0.4-mc1.21.2" = _gzvxbIuc;
        "pkg-1.0.5-mc1.21.2" = _V9Pui5zr;
        "pkg-1.0.5-mc1.21.1" = _6rnSvNYX;
        "pkg-1.0.6-mc1.21.4" = _d4JpFUaJ;
        "pkg-1.1-mc1.21.1" = _yTcAPfzL;
        "pkg-1.1-mc1.21.2" = _cl4LPzrM;
        "pkg-1.1-mc1.21.4" = _i6jdi2FD;
        "pkg-1.1-mc1.21.5-pre2" = _jc6S1hcp;
        "pkg-1.1.1-mc1.21.1" = _CuYJSq5j;
        "pkg-1.1.1-mc1.21.2" = _8OH76plH;
        "pkg-1.1.1-mc1.21.4" = _JSDs1tDK;
        "pkg-1.1.1-mc1.21.5-pre3" = _kbwXJL6x;
        "pkg-1.1.2-mc1.21.1" = _TJGONbth;
        "pkg-1.1.2-mc1.21.2" = _njkoIV4H;
        "pkg-1.1.2-mc1.21.4" = _Uf08bgY8;
        "pkg-1.1.2-mc1.21.5" = _NUYir4M8;
        "pkg-1.1.3-mc1.21.1" = _u2xHFOSZ;
        "pkg-1.1.3-mc1.21.2" = _CqYPpvDB;
        "pkg-1.1.3-mc1.21.4" = _kHzdyVNB;
        "pkg-1.1.3-mc1.21.5" = _5ylOL7Z5;
        "pkg-1.1.4-test-mc1.21.1" = _f4mdUYxG;
        "pkg-1.1.4-mc1.21.1" = _bwe8uSIf;
        "pkg-1.1.4-mc1.21.2" = _nqV6gF0V;
        "pkg-1.1.4-mc1.21.4" = _mb0JD6Xd;
        "pkg-1.1.4-mc1.21.5" = _SEKRKgmo;
        "pkg-1.1.5-mc1.21.1" = _P9XJneuE;
        "pkg-1.1.5-mc1.21.2" = _AczMdhnV;
        "pkg-1.1.5-mc1.21.4" = _6GOmaAuw;
        "pkg-1.1.5-mc1.21.5" = _p15zU5OA;
        "pkg-1.1.6-mc1.21.1" = _V4jtOncN;
        "pkg-1.1.6-mc1.21.2" = _X53B5OxE;
        "pkg-1.1.6-mc1.21.4" = _OdCRaTaI;
        "pkg-1.1.6-mc1.21.5" = _TvtyhmW6;
        "pkg-1.1.5-mc25w19a" = _MTsFfBjY;
        "pkg-1.1.7-mc1.21.1" = _mGZbZ0BW;
        "pkg-1.1.7-mc1.21.2" = _cy7xiPEA;
        "pkg-1.1.7-mc1.21.4" = _XOmBOPkk;
        "pkg-1.1.7-mc1.21.5" = _vrdMMwNf;
        "pkg-1.1.7-mc25w20a" = _uCKNH0dS;
        "pkg-1.1.8-mc1.21.1" = _XRJSpt9v;
        "pkg-1.1.8-mc1.21.2" = _delbriNs;
        "pkg-1.1.8-mc1.21.4" = _Qht2XUFA;
        "pkg-1.1.8-mc1.21.5" = _JeARipf6;
        "pkg-1.1.8-mc25w21a" = _KxvEJyY8;
        "pkg-1.1.9-mc1.21.1" = _jTu8s2uE;
        "pkg-1.1.9-mc1.21.2" = _eS2kQrjP;
        "pkg-1.1.9-mc1.21.5" = _e5y8CgYr;
        "pkg-1.1.9-mc1.21.4" = _Yi5bCEte;
        "pkg-1.1.9-mc1.21.6" = _ANGbrMWe;
        "pkg-1.1.10-mc1.21.1" = _bNSe85ix;
        "pkg-1.1.10-mc1.21.2" = _WS4z5SsX;
        "pkg-1.1.10-mc1.21.4" = _CayBzl6H;
        "pkg-1.1.10-mc1.21.5" = _Dh74iYSR;
        "pkg-1.1.10-mc1.21.6" = _EC7VaF9h;
        "pkg-1.1.11-mc1.21.1" = _1SBuLD8v;
        "pkg-1.1.11-mc1.21.2" = _HUee4OhX;
        "pkg-1.1.11-mc1.21.4" = _6wYng7RH;
        "pkg-1.1.11-mc1.21.5" = _QOYeC1xv;
        "pkg-1.1.11-mc1.21.8" = _i1Adwwzx;
        "pkg-1.1.11-mc1.21.9" = _3CsL8z0o;
        "pkg-1.1.12-mc1.21.9" = _q6xWnGan;
        "pkg-1.1.12-mc1.21.10" = _OaBOhrGP;
        "pkg-1.1.12-mc25w41a" = _rAIGHMe3;
        "pkg-1.1.12-mc25w42a" = _7Hd1Tkrd;
        "pkg-1.1.12-mc25w43a" = _EM3brq7o;
        "pkg-1.2-mc1.21.1" = _N7r6mIBZ;
        "pkg-1.2-mc1.21.2" = _I8Ly0IBC;
        "pkg-1.2-mc1.21.4" = _QGks7KTt;
        "pkg-1.2-mc1.21.5" = _MWWpfNzO;
        "pkg-1.2-mc1.21.8" = _eelKX0s0;
        "pkg-1.2-mc1.21.9" = _gu1xL0Fk;
        "pkg-1.2-mc1.21.10" = _UXCeXDtE;
        "pkg-1.2-mc1.21.11" = _kM0sGjki;
        "pkg-1.2-mc26.1-snapshot-1" = _kXwEEVD7;
        "pkg-1.2.1-mc1.21.11" = _CmhH5Hea;
        "pkg-1.2.2-mc1.21.11" = _pDWqhb9i;
        "pkg-1.2.2-mc26.1-snapshot-4" = _1xiCTH02;
        "pkg-1.2.2-mc26.1" = _bxNOIjni;
        "pkg-1.2.3-mc26.1" = _UvrQ0I5A;
        "pkg-1.2.4-mc26.1" = _oy4kAqzF;
        "pkg-1.2.5-mc26.1" = _Gtbx31f7;
