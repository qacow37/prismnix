...
let
    ...
    in {
        ...
        "pkg-3.3" = _5XjctABA;
        "pkg-4.0" = _MLvtVawE;
        "pkg-4.0+mod" = _W9BtRgQv;
        "pkg-5.0" = _fhhDdq0B;
        "pkg-5.0+mod" = _fAtvmma9;
        "pkg-5.1" = _7OorEElW;
        "pkg-5.1+mod" = _3D8K4BnL;
        "pkg-5.2" = _Pw8tVlOG;
        "pkg-5.2+mod" = _RadQkeUf;
        "pkg-6.0" = _aDUy0YWi;
        "pkg-6.1" = _947JcpLE;
        "pkg-6.1+mod" = _NiuQELsp;
        "pkg-6.2" = _Js1v9YzI;
        "pkg-6.2+mod" = _gj7PoeN7;
        "pkg-6.3" = _vFBLEVmv;
        "pkg-6.3+mod" = _yIwRvM55;
        "pkg-6.4" = _qTejhIuJ;
        "pkg-6.4+mod" = _NT7JyVIp;
        "default" = _NT7JyVIp;
    });
