...
let
    ...
    in {
        ...
        "pkg-1.18-0.2.0" = _gFT7dxsh;
        "pkg-1.18-0.3.0" = _fuKOcONn;
        "pkg-1.18-0.3.1" = _vzqeTLD2;
        "pkg-1.19-0.3.1" = _oe61cDtb;
        "pkg-1.18-0.3.2" = _Hy5dkdXl;
        "pkg-1.19-0.3.2" = _MtG24729;
        "pkg-1.18.2-1.0.0" = _zGU3s21E;
        "pkg-1.19.2-1.0.0" = _sOKqTkKN;
        "pkg-1.18.2-1.0.1" = _H117BhqA;
        "pkg-1.19.2-1.0.1" = _IskYt7A2;
        "pkg-1.18.2-1.0.2" = _C2Nhxtof;
        "pkg-1.19.2-1.1.0" = _qx6mMakd;
        "pkg-1.19.2-1.1.0-fabric" = _XE3fozv5;
        "pkg-1.19.2-1.1.1-fabric" = _kdKQILoc;
        "pkg-1.19.2-1.1.2-fabric" = _3i08QqJg;
        "pkg-1.18.2-1.0.3" = _eyiv7lj7;
        "pkg-1.19.2-1.1.1" = _5sClF2j8;
        "pkg-1.19.2-1.1.3-fabric" = _JL5J2d35;
        "pkg-1.18.2-1.1.0" = _VjTo9z4p;
        "pkg-1.19.2-1.2.0" = _pZRErAKP;
        "pkg-1.18.2-1.1.1" = _3ZjYpSa3;
        "pkg-1.19.2-1.2.1" = _NMRkldgZ;
        "pkg-1.19.2-1.2.0-fabric" = _SiZjoeNL;
        "pkg-1.19.2-1.2.2" = _bQgJWByB;
        "pkg-1.19.2-1.2.1-fabric" = _RRvPlaLZ;
        "pkg-1.20.1-1.3.0" = _kB9UE2is;
        "pkg-1.20.1-1.3.1" = _dqBvEX2z;
        "pkg-1.20.1-1.3.0-fabric" = _UgquH4Sq;
        "pkg-1.20.1-1.4.0" = _8LUcqQUu;
        "pkg-1.20.1-1.4.0-fabric" = _P0mliaL7;
        "pkg-1.20.1-1.4.1" = _2AB3vyyN;
        "pkg-1.20.1-1.4.1-fabric" = _3QHI2SnJ;
        "pkg-1.20.1-1.4.2" = _GFgnNddX;
        "pkg-1.20.1-1.4.2-fabric" = _yK5ocMl8;
        "pkg-1.19.2-1.2.2-fabric" = _zpoHowcG;
        "pkg-1.20.1-1.4.3-fabric" = _nyYmbpDj;
        "pkg-1.20.1-1.4.4-fabric" = _15BFIdMo;
        "pkg-1.20.1-1.4.3" = _WI7OOfLA;
        "pkg-1.20.1-1.4.5-fabric" = _jmSBgUUD;
        "pkg-1.18.2-1.1.2" = _BuSFvdnU;
        "pkg-1.19.2-1.2.3" = _S7PPrW1M;
        "pkg-1.19.2-1.2.3-fabric" = _W8TwPNaE;
        "pkg-1.18.2-1.1.3" = _zu2rP6jD;
        "pkg-1.20.1-1.4.4" = _iEoTSE14;
        "pkg-1.20.1-1.4.6-fabric" = _IV4nX7By;
        "pkg-1.20.1-1.5.0" = _m5bD7RxO;
        "pkg-1.20.1-1.5.0-fabric" = _BdH5dlBG;
        "pkg-1.20.1-1.5.1" = _Lme1ajmP;
        "pkg-1.20.1-1.5.1-fabric" = _qshXYuch;
        "pkg-1.20.1-1.5.2" = _JoRQ9ZCh;
        "pkg-1.20.1-1.5.2-fabric" = _BE2oSD22;
        "pkg-1.20.1-1.5.3-fabric" = _pcVijNCT;
        "pkg-1.20.1-1.5.3" = _eJi1oefO;
        "pkg-1.20.1-1.5.4-fabric" = _O48L7huv;
        "pkg-1.20.1-1.6.0" = _UfHQimGn;
        "pkg-1.20.1-1.6.1" = _rQAZwpZs;
        "pkg-1.21.1-1.6.0" = _Vbd6b8YK;
        "pkg-1.20.1-1.6.2" = _RmGejAJm;
        "pkg-1.21.1-1.6.1" = _QJYzW4Gn;
        "pkg-1.21.1-1.6.2" = _yVsbaCDI;
        "pkg-1.20.1-1.6.3" = _CNLjZPEs;
        "pkg-1.21.1-1.6.3" = _6uJaRyzT;
        "pkg-1.20.1-1.6.4" = _MPDMsEbA;
        "pkg-1.21.1-1.6.4" = _XF4zNKFN;
        "pkg-1.21.1-1.6.5" = _mqzzsWAM;
        "pkg-1.20.1-1.6.5" = _9mCy0ePP;
        "pkg-1.20.1-1.6.0-fabric" = _VdgRcKQo;
        "pkg-1.21.1-1.6.6" = _y1IC5tEA;
