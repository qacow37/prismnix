...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _qbtllHRM;
        "pkg-1.0.1" = _JMCNpNm2;
        "pkg-2.0.0+mc1.21.11" = _aA9oqFXe;
        "pkg-2.0.0+mc1.21.9" = _dbp0UmbC;
        "pkg-2.0.0+mc1.21.1" = _Cw7yBGzo;
        "pkg-2.0.0+mc1.21.6" = _Y02ONcNZ;
        "pkg-2.0.0+mc1.21.10" = _joLp8IQ9;
        "pkg-2.0.0+mc1.21.8" = _kVIoQmk8;
        "pkg-2.0.0+mc1.21.4" = _OcstrYLn;
        "pkg-2.0.1+mc1.21.9" = _jjzcxQ5i;
        "pkg-2.0.1+mc1.21.4" = _iOlmGXZB;
        "pkg-2.0.1+mc1.21.1" = _MvdHCBTe;
        "pkg-2.0.1+mc1.21.11" = _pDINhkS3;
        "pkg-2.0.1+mc1.21.6" = _PK2FrbOA;
        "pkg-2.0.1+mc1.21.10" = _jHoGGsad;
        "pkg-2.0.1+mc1.21.8" = _WXPFJkCK;
        "pkg-2.0.2+mc1.21.11" = _Exc5nlBK;
        "pkg-2.0.2+mc1.21.6" = _rLZg404N;
        "pkg-2.0.2+mc1.21.9" = _1495jTZb;
        "pkg-2.0.2+mc1.21.1" = _YBjUAHd9;
        "pkg-2.0.2+mc1.21.4" = _41JAMrgq;
        "pkg-2.0.2+mc1.21.8" = _ykAYbtcx;
        "pkg-2.0.2+mc1.21.10" = _QvR8eFoR;
        "pkg-2.0.3+mc1.21.10" = _kgWZSKhd;
        "pkg-2.0.3+mc1.21.6" = _ByDRyOVr;
        "pkg-2.0.3+mc1.21.8" = _ep3SnfwP;
        "pkg-2.0.3+mc1.21.9" = _DJ8zA5BQ;
        "pkg-2.0.3+mc1.21.11" = _O2jkHzes;
        "pkg-2.0.3+mc1.21.1" = _grQoBXOC;
        "pkg-2.0.3+mc1.21.4" = _XxPLh9Ef;
        "default" = _XxPLh9Ef;
    });
