...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.4-forge" = _QGHk0Slm;
        "pkg-1.18.2-2.5-forge" = _AtHtWZS2;
        "pkg-1.19.2-2.6-forge" = _FDd6y3ZX;
        "pkg-1.19.3-2.6-forge" = _YElbBWUX;
        "pkg-1.18.2-3.0-forge+fabric" = _Lcdf3uao;
        "pkg-1.19.2-3.0-forge+fabric" = _Ezvagz23;
        "pkg-1.19.3-3.0-forge+fabric" = _9NYR8t5W;
        "pkg-1.18.2-3.1-forge+fabric" = _CgsWJWnE;
        "pkg-1.19.2-3.1-forge+fabric" = _HgVkk2vt;
        "pkg-1.19.3-3.1-forge+fabric" = _YTSfYiHd;
        "pkg-1.19.4-3.1-forge+fabric" = _eRXf5lPu;
        "pkg-1.20-3.1-forge+fabric" = _OtxEqfLE;
        "pkg-1.20.1-3.1-forge+fabric" = _mj2fGhaP;
        "pkg-1.20.2-3.1-forge+fabric" = _jFyU5VZZ;
        "pkg-1.18.2-3.2-forge+fabric" = _jgvI32MZ;
        "pkg-1.19.2-3.2-forge+fabric" = _JtH5A8v7;
        "pkg-1.20.1-3.2-forge+fabric" = _kjlDXKZP;
        "pkg-1.20.2-3.2-forge+fabric" = _RKGDIt32;
        "pkg-1.20.2-3.3-forge+fabric" = _36wlRBDb;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _T5qiPsGu;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _khPGJGmv;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _RlDJYyNH;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _eFhcLXLj;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _vQr85Ggp;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _7apAnti6;
        "pkg-1.19.2-4.0-fabric+forge" = _weNeDJP3;
        "pkg-1.20.1-4.0-fabric+forge+neo" = _7IFGYET6;
        "pkg-1.20.4-4.0-fabric+forge+neo" = _TPXPs9gW;
        "pkg-1.20.5-4.0-fabric+neo" = _AkDoxpP2;
        "pkg-1.20.6-4.0-fabric+forge+neo" = _tiGnQ4sG;
        "pkg-1.21.0-4.0-fabric+forge+neo" = _u7TBZWrU;
        "pkg-1.19.2-4.1-fabric+forge" = _q6Y7EFZi;
        "pkg-1.20.1-4.1-fabric+forge+neo" = _ZGbnynZ1;
        "pkg-1.20.4-4.1-fabric+forge+neo" = _TLroBw25;
        "pkg-1.20.6-4.1-fabric+forge+neo" = _hgrBag8a;
        "pkg-1.21.0-4.1-fabric+forge+neo" = _yRzjsdBO;
        "pkg-1.20.1-4.2-fabric+forge+neo" = _H0TD8Nrr;
        "pkg-1.20.6-4.2-fabric+forge+neo" = _KDqiENQc;
        "pkg-1.21.0-4.2-fabric+forge+neo" = _2EkfxZ6G;
        "pkg-1.21.1-4.2-fabric+forge+neo" = _a2w6Y58U;
        "pkg-1.21.2-4.2-fabric+neo" = _foEDqgqo;
        "pkg-1.21.3-4.2-fabric+forge+neo" = _CyG7KScO;
        "pkg-1.21.4-4.2-fabric+forge+neo" = _dOdzt501;
        "pkg-1.20.1-4.3-fabric+forge+neo" = _AhKpJOKA;
        "pkg-1.21.1-4.3-fabric+forge+neo" = _Ac6YTncp;
        "pkg-1.21.4-4.3-fabric+forge+neo" = _8yBlnZRg;
        "pkg-1.21.5-4.3-fabric+forge+neo" = _EmhV1aq9;
        "pkg-1.21.6-4.3-fabric+forge+neo" = _zbhRxfkR;
        "pkg-1.21.7-4.3-fabric+forge+neo" = _qLENbhho;
        "pkg-1.21.8-4.3-fabric+forge+neo" = _VsQUJurX;
        "pkg-1.21.9-4.3-fabric+forge+neo" = _Y7j3KfIs;
        "pkg-1.21.9-4.4-fabric+forge+neo" = _TwZFBhKI;
        "pkg-1.21.10-4.4-fabric+forge+neo" = _BZWOUSck;
        "pkg-1.21.11-4.4-fabric+forge+neo" = _5XBSU0PS;
        "pkg-26.1.0-4.4-fabric+forge+neo" = _hk5smbLA;
        "pkg-26.1.1-4.4-fabric+forge+neo" = _AbZKpCVv;
        "pkg-26.1.2-4.4-fabric+forge+neo" = _gdEBPuuc;
        "pkg-1.20.1-4.5-fabric+forge+neo" = _njX2IO13;
        "pkg-1.21.1-4.5-fabric+forge+neo" = _EjmiE5HB;
        "pkg-1.21.11-4.5-fabric+forge+neo" = _tdWsuVPi;
        "pkg-26.1.2-4.5-fabric+forge+neo" = _PWSecNmd;
        "pkg-26.2.0-4.5-fabric+forge+neo" = _rMl8iyLR;
        "default" = _rMl8iyLR;
    });
