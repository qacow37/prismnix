...
let
    ...
    in {
        ...
        "pkg-1.0.0-fabric" = _d1wGDnOg;
        "pkg-1.1.0-fabric" = _rvmKzdit;
        "pkg-1.1.0-forge" = _lFcWshUo;
        "pkg-1.2.0-fabric" = _nDA4zR8b;
        "pkg-1.2.0-forge" = _bDJ6C3ee;
        "pkg-1.2.1-fabric" = _YToHBCxz;
        "pkg-1.2.1-forge" = _SL7w72eH;
        "pkg-1.2.2-fabric" = _phRoW4cz;
        "pkg-1.2.2-forge" = _XcwsnmsZ;
        "pkg-1.3.0-fabric" = _1pnb6cGl;
        "pkg-1.3.0-forge" = _fX9fSRpc;
        "pkg-1.4.0-fabric" = _D3InZWhh;
        "pkg-1.4.0-forge" = _NR1MuP9t;
        "pkg-1.4.1-fabric" = _ez77o4vP;
        "pkg-1.4.1-forge" = _ZSOeDjPU;
        "pkg-1.5.0-fabric" = _rlPcRBXm;
        "pkg-1.5.0-forge" = _nElg9xeo;
        "pkg-1.6.0-fabric" = _J3zRK5bi;
        "pkg-1.6.0-forge" = _FatqexKs;
        "pkg-1.7.0-fabric" = _tWRyPcFL;
        "pkg-1.7.0-forge" = _NDu88Zwa;
        "pkg-1.7.1-fabric" = _hY3DKYio;
        "pkg-1.7.1-forge" = _aOxCEP3D;
        "pkg-1.7.2-fabric" = _CSWmF24f;
        "pkg-1.7.2-forge" = _pPFCiLjA;
        "pkg-1.8.0-fabric" = _BCj6Z3cx;
        "pkg-1.8.0-forge" = _TCs1cNbH;
        "pkg-1.8.1-fabric" = _7WXEKPNx;
        "pkg-1.8.1-forge" = _Tk0RAQMD;
        "pkg-1.9.0-fabric" = _rKzPCLMb;
        "pkg-1.9.0-forge" = _jlIRKhk7;
        "pkg-1.10.0-forge" = _m21FBC92;
        "pkg-1.10.0-fabric" = _XtJaW95T;
        "pkg-1.11.0-fabric" = _ltSWiXrH;
        "pkg-1.11.0-forge" = _jxiMbq1j;
        "pkg-2.0.0-fabric" = _GeIPOMAw;
        "pkg-2.0.0-forge" = _IWgfkuO9;
        "pkg-2.1.0-forge" = _vgor1UDw;
        "pkg-2.1.0-fabric" = _h7UENtbi;
        "pkg-2.2.0-forge" = _BmkonV8u;
        "pkg-2.2.0-fabric" = _LVTec1Rh;
        "pkg-2.3.0-forge" = _US297WEJ;
        "pkg-2.3.0-fabric" = _7nWg7CpV;
        "pkg-2.3.1-forge" = _2CSuLT5g;
        "pkg-2.3.1-fabric" = _4J87zok9;
        "pkg-2.3.2-forge" = _11cqAA0W;
        "pkg-2.3.2-fabric" = _1Wc2PZ7G;
        "pkg-2.3.3-forge" = _IhcW4hp4;
        "pkg-2.3.3-fabric" = _jl2bfULg;
        "pkg-2.4.0" = _qGM9M0wh;
        "pkg-2.4.1" = _9xvnFOIg;
        "pkg-2.5.0" = _KB2xqwsT;
        "pkg-2.6.0" = _W2UIVXCp;
        ...
        "pkg-2.7.1" = _pYAlD9TK;
        "pkg-2.8.0" = _UvBWAMZL;
        "pkg-1.19.3+1.0" = _l8A2i9nV;
        "pkg-1.19.3+1.1" = _fgjgGIfI;
        "pkg-1.19.4+1.0" = _GtD9tAHh;
        "pkg-1.19.4+1.1" = _v2s5aT84;
        "pkg-1.19.4+2.0" = _CQP9o8LS;
        "pkg-1.19.4+2.1" = _oevI3RPR;
        "pkg-1.19.4+2.2" = _jskCDMsk;
        "pkg-1.20+1.0" = _l6S5WIlU;
        "pkg-1.20+1.1" = _7SaNcvDx;
        "pkg-1.20.1+1.0" = _6ckEWNPu;
        "pkg-1.20.1+1.1" = _GTuKuQLA;
        "pkg-1.20.1+2.0" = _6XDJoCks;
        "pkg-1.20.2+1.0" = _ZSI78Xd3;
        "pkg-1.20.3+1.0" = _pfPFUzJF;
        "pkg-1.20.3+1.1" = _vJOKWGcy;
        "pkg-1.20.4+1.0" = _gGTvKKDk;
        "pkg-1.20.4+1.1" = _aQYNRsGo;
        "pkg-1.20.5+1.0" = _abm18PGR;
        "pkg-1.20.6+1.0" = _wJlrMn2x;
        "pkg-1.21+1.0" = _mOk69fib;
        "pkg-1.21.1+1.0" = _dO7QNiof;
        "pkg-1.21.3+1.0" = _WdrLmFvp;
        "pkg-1.21.4+1.0" = _TxwUizo2;
        "pkg-1.21.4+1.1" = _yjpSgPEw;
        "pkg-1.21.5+1.0" = _rfvoZgM1;
        "pkg-1.21.7+1.0" = _ZzhkIsJg;
        "pkg-1.21.8+1.0" = _WLSwJeXa;
        "pkg-1.21.10+1.0" = _eixLNBxx;
        "pkg-1.21.10+1.1" = _i4mzYGzu;
        "pkg-1.21.11+1.0" = _8Q49lnaU;
        "pkg-26.1.2+1.0" = _mfTTfiKn;
