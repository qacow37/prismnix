...
let
    ...
    in {
        ...
        "pkg-1.0.1929" = _mncDF509;
        "pkg-fabric-mc117-1.0.2196" = _wlz2rdu0;
        "pkg-fabric-mc117-1.0.2200" = _8urHjMDT;
        "pkg-fabric-mc117-1.0.2201" = _HFM5ODhh;
        "pkg-fabric-mc117-1.0.2202" = _kNEAmsbK;
        "pkg-fabric-mc118-1.0.2223" = _9NO7HvPS;
        "pkg-fabric-mc117-1.0.2207" = _aVFFTT7P;
        "pkg-fabric-mc118-1.0.2230" = _nK7dPLtu;
        "pkg-fabric-mc117-1.0.2219" = _vfRHoSQ8;
        "pkg-fabric-mc118-1.0.2246" = _wQmvEeSx;
        "pkg-fabric-mc117-1.0.2222" = _nOgy4p3Y;
        "pkg-fabric-mc118-1.0.2248" = _O5Ga9iFI;
        "pkg-fabric-mc118-1.0.2256" = _few5jTvK;
        "pkg-fabric-mc117-1.0.2230" = _Ahy9LaDx;
        "pkg-fabric-mc118-1.0.2264" = _vtBZZ2yi;
        "pkg-fabric-mc118-1.0.2279" = _i9y7d3jr;
        "pkg-fabric-mc118-1.0.2282" = _wMPdAc3Z;
        "pkg-fabric-mc118-1.0.2308" = _H1vElJ5L;
        "pkg-fabric-mc118-1.0.2357" = _GDx4Em8z;
        "pkg-fabric-mc118-1.0.2358" = _uyfPgZGE;
        "pkg-fabric-mc118-1.0.2360" = _sEPClXpZ;
        "pkg-fabric-mc119-1.0.2374" = _DGYhlOFj;
        "pkg-fabric-mc119-1.0.2379" = _DRHTOzIp;
        "pkg-fabric-mc119-1.0.2386" = _4aRXWMnP;
        "pkg-fabric-mc119-1.0.2387" = _dlvx86sO;
        "pkg-fabric-mc119-1.0.2390" = _XybvXFvZ;
        "pkg-fabric-mc119-1.0.2404" = _UhgGTamw;
        "pkg-fabric-mc119-1.0.2410" = _Iyn5JDnV;
        "pkg-fabric-mc118-1.0.2374" = _vXl2TEwn;
        "pkg-fabric-mc119-1.0.2425" = _IitUpHRN;
        "pkg-fabric-mc118-1.0.2397" = _l4Qowyyh;
        "pkg-fabric-mc119-1.0.2453" = _zClP8rhe;
        "pkg-fabric-mc119-1.0.2477" = _TsMVe8BU;
        "pkg-fabric-mc119-1.0.2480" = _kiPUPGRC;
        "pkg-fabric-mc119-1.0.2487" = _t8ginvQ0;
        "pkg-fabric-mc119-1.0.2494" = _WA2jBhsS;
        "pkg-fabric-mc119-1.0.2501" = _rER1H6B1;
        "pkg-fabric-mc119-1.0.2503" = _JM6r9Xb1;
        "pkg-fabric-mc119-2.0.2535" = _KG1caJgh;
        "pkg-fabric-18.2.2598" = _keS4geCp;
        "pkg-fabric-19.3.2594" = _xqhWjvtn;
        "pkg-fabric-19.4.2581" = _XtwbaqJj;
        "pkg-fabric-20.0.2590" = _eSTmgPMQ;
        "pkg-fabric-19.2.2601" = _ZR9uxvtz;
        "pkg-fabric-19.2.2611" = _oEv5j7f0;
        "pkg-fabric-18.2.2616" = _sT1BcVaI;
        "pkg-fabric-19.2.2613" = _hNEswHeL;
        "pkg-fabric-19.3.2602" = _beR8SEbp;
        "pkg-fabric-19.4.2586" = _EkoghJGu;
        "pkg-fabric-20.0.2612" = _oeE0Fbnz;
        "pkg-fabric-18.2.2621" = _f2tKY6fJ;
        "pkg-fabric-19.2.2614" = _WJ9gdUFO;
        "pkg-fabric-19.3.2607" = _dqdYnTHr;
        "pkg-fabric-19.4.2590" = _y2AJzrQK;
        "pkg-fabric-20.0.2620" = _eZku3wOE;
        "pkg-fabric-20.2.2628" = _kMZKGuRp;
        "pkg-fabric-20.0.2625" = _CzNKpSG7;
        "pkg-fabric-20.2.2640" = _8ksLqpiW;
        "pkg-fabric-20.2.2641" = _Xgag74T1;
        "default" = _Xgag74T1;
    });
