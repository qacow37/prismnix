...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _5EsgyRkR;
        "pkg-1.1.2" = _1LgAyH5c;
        "pkg-1.2.0r" = _1FcBjJ0v;
        "pkg-1.2.1r" = _UpbKVxpT;
        "pkg-1.2.2r" = _gwRKsZ52;
        "pkg-1.2.3r" = _OlC4E6sh;
        "pkg-1.2.4r" = _b24OlwTh;
        "pkg-1.3.0b" = _ATX7l9Gb;
        "pkg-1.3.1b" = _pvVM1zRQ;
        "pkg-1.3.2r" = _M68Bu7Ys;
        "pkg-1.3.3r" = _4e7sZ4RL;
        "pkg-1.3.4r" = _lJhfxjkv;
        "pkg-1.3.5r" = _cTm7RK2i;
        "pkg-1.3.6r" = _TmjnjSHN;
        "pkg-1.3.7r" = _l6A1NR4a;
        "pkg-1.3.8r" = _Oot9VL75;
        "pkg-1.3.9r" = _v0c7BtBw;
        "pkg-1.3.10r" = _rZGAh9Ty;
        "pkg-1.4.0b" = _5ya2NhVC;
        "default" = _5ya2NhVC;
    });
