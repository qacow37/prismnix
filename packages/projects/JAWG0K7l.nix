...
let
    ...
    in {
        ...
        "pkg-1.5" = _JQSKgjXf;
        "pkg-1.5+mod" = _DnQBK8kH;
        "pkg-24w21b" = _Kik4ZqDv;
        "pkg-24w21b+mod" = _oK6TAUN7;
        "pkg-pre3" = _LSw6Era7;
        "pkg-pre3+mod" = _FsukbiYl;
        "pkg-1.6" = _lWqe3sCJ;
        "pkg-1.6+mod" = _DMkhdhxA;
        "pkg-1.6a" = _vDUPNsFO;
        "pkg-1.6a+mod" = _WgTSVnHs;
        "pkg-1.6b" = _8OazhdFa;
        "pkg-1.6b+mod" = _2kmPV731;
        "pkg-1.7" = _xQsp6ScI;
        "pkg-1.7+mod" = _Cn41RDOx;
        "pkg-1.7a" = _NKYOodjt;
        "pkg-1.7a+mod" = _IfBsY7An;
        "pkg-1.7b" = _o01L4ZZN;
        "pkg-1.7b+mod" = _gs91QIWz;
        "pkg-1.7c" = _WghH5icz;
        "pkg-1.7c+mod" = _1UEbX1wj;
        "pkg-1.7d" = _tCO0fNss;
        "pkg-1.7d+mod" = _Fg6KYJnx;
        "pkg-1.8" = _8KS661jI;
        "pkg-1.8+mod" = _N0Cit01P;
        "pkg-1.9" = _EVnRF6LX;
        "pkg-1.9+mod" = _bo46oxv7;
        "pkg-2.0" = _O6BgSoZf;
        "pkg-2.0+mod" = _VeO00nIH;
        "pkg-2.1" = _JKe0GM6A;
        "pkg-2.1+mod" = _UI0d93Wz;
        "pkg-2.2" = _yE7xiZ7p;
        "pkg-2.2+mod" = _v81IVFs2;
        "pkg-2.3" = _evC9hVt5;
        "pkg-2.3+mod" = _9CUgB3P9;
        "default" = _9CUgB3P9;
    });
