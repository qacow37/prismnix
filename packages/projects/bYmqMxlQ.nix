...
let
    ...
    in {
        ...
        "pkg-1.7.8" = _QjGwuL8P;
        "pkg-1.7.9" = _KTrusH13;
        "pkg-1.7.10" = _Y6kPk15q;
        "pkg-1.7.11" = _VDtPRBPy;
        "pkg-1.7.12" = _QT8D9Jip;
        "pkg-1.7.13" = _OnUARVJ2;
        "pkg-2.0.0-alpha.1" = _xAYGab5S;
        "pkg-2.0.0-alpha.2" = _sQs8H47T;
        "pkg-2.0.0-alpha.3" = _JCc1CYSZ;
        "pkg-2.0.0-alpha.4" = _tvTvcOuO;
        "pkg-2.0.0-alpha.5" = _GZVHrR9K;
        "pkg-2.0.0-alpha.6" = _cfSW8ooh;
        "pkg-2.0.0-alpha.7" = _QkAkpk03;
        "pkg-2.0.0-alpha.8" = _ZdYPZ4AR;
        "pkg-2.0.0-alpha.9" = _THWs9cBo;
        "pkg-2.0.0-alpha.10" = _ELTREQ9b;
        "pkg-1.7.14" = _XgUMqLZQ;
        "pkg-2.0.0-alpha.11" = _b4QDhNS1;
        "pkg-2.0.0-alpha.12" = _1RaF5FEO;
        "pkg-1.7.15" = _cjV3SFAX;
        "pkg-2.0.0-alpha.13" = _75X2TtbP;
        "pkg-2.0.0-beta.1" = _WOGVOLoh;
        "pkg-2.0.0-beta.2" = _3iSdmV1D;
        "pkg-2.0.0-beta.3" = _iacSq6RZ;
        "pkg-2.0.0-beta.4" = _eIjaPOiU;
        "pkg-2.0.0-beta.5" = _nTX0Gy6U;
        "pkg-2.0.0-beta.6" = _RxAYKkr7;
        "pkg-2.0.0-beta.7" = _XBWJt4Le;
        "pkg-2.0.0-beta.8" = _F8mFPPsd;
        "pkg-2.0.0-beta.10" = _XG6NG9aX;
        "pkg-2.0.0-beta.11" = _2aqg5iHj;
        "pkg-2.0.0-beta.12" = _yiD5DE1y;
        "pkg-2.0.0-beta.13" = _T7NX3Vk3;
        "pkg-2.0.0-beta.14" = _CP2qhWyx;
        "pkg-2.0.0-beta.15" = _UPafOykI;
        "pkg-2.0.0-beta.16" = _TAqnZwVI;
        "default" = _TAqnZwVI;
    });
