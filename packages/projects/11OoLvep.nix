...
let
    ...
    in {
        ...
        "pkg-2.6.7" = _asRtbc4w;
        "pkg-2.6.3" = _Ns0PCcET;
        "pkg-2.6.3b" = _YNw71c2l;
        "pkg-2.6.8" = _uqPqGGfc;
        "pkg-1.21.8-2.7.0" = _UQSfBfl9;
        "pkg-1.21.9-2.7.0" = _kwgCxvir;
        "pkg-1.21.10-2.7.0" = _rdu12sRb;
        "pkg-1.7.10-1.0.2" = _gH4jlr0I;
        "pkg-1.10.2-1.2.4" = _8sTwSpDj;
        "pkg-1.11-1.1.2" = _9F2yggOD;
        "pkg-1.11.2-1.2.4" = _gHijGeE1;
        "pkg-1.12.2-1.5.6" = _R9lDkg5x;
        "pkg-1.13.2-2.0.1" = _MXGmNrTw;
        "pkg-1.14.2-2.0.0" = _58468xlC;
        "pkg-1.14.4-2.0.4" = _ILZ3zdf0;
        "pkg-1.15.1-2.0.5" = _Jt1dHxBT;
        "pkg-1.15.2-2.0.5" = _D8bFB1tK;
        "pkg-1.16.1-2.0.5" = _vKNPhl0L;
        "pkg-1.16.4-2.1.0" = _thxWb5zw;
        "pkg-1.16.5-2.1.1b" = _Nd03pJ9s;
        "pkg-1.17.1-2.1.1b" = _PqWpma6g;
        "pkg-1.18.2-2.1.5" = _RHkctNTO;
        "pkg-1.19-2.1.2" = _NHKpy5y0;
        "pkg-1.21.10-2.7.1" = _uSUvQltR;
        "pkg-1.21.10-2.7.2" = _M7H1Idxi;
        "pkg-1.21.10-2.7.3" = _dvyThwOd;
        "pkg-1.21.11-2.7.3" = _tzWppxF2;
        "pkg-1.21.1-2.6.4" = _GBAFY4XE;
        "pkg-26.1-2.8.0" = _q3PIpYVL;
        "pkg-26.1.1-2.8.1" = _bsb1lstJ;
        "pkg-26.1.2-2.8.1" = _MQhPTidk;
