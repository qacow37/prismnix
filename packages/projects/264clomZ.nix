...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _KS1AO2U1;
        "pkg-1.0.1" = _75lynxEh;
        "pkg-1.0.2+1.19.2" = _UQlA2mHD;
        "pkg-1.0.3+1.19.2" = _DWcOH4GI;
        "pkg-1.0.3+1.18.2" = _4oPLI3d1;
        "pkg-1.0.4+1.18.2" = _owbSI9vC;
        "pkg-1.0.4+1.19.2" = _6xWqDEAw;
        "pkg-1.0.5+1.19.2" = _F29O1fRQ;
        "pkg-1.0.5+1.18.2" = _rBJTuwjO;
        "pkg-1.0.6+1.18.2" = _PoLpxUx4;
        "pkg-1.0.6+1.19.3" = _cChQVmtu;
        "pkg-1.0.6+1.19.2" = _Thp0HFqt;
        "pkg-1.0.7+1.19.2" = _Pcx5NPIw;
        "pkg-1.0.7+1.18.2" = _NbLCCdxM;
        "pkg-1.0.7+1.19.3" = _G3G8BF5g;
        "pkg-1.0.8+1.19.2" = _MBPb1VOi;
        "pkg-1.0.8+1.18.2" = _3KDJ9hTj;
        "pkg-1.0.8+1.19.3" = _LNtAQMAD;
        "pkg-1.0.9+fabric+1.19.3" = _3uNetQA2;
        "pkg-1.0.9+fabric+1.19.2" = _GXEuVKge;
        "pkg-1.0.9+fabric+1.18.2" = _iWw5OSCn;
        "pkg-1.0.10+fabric+1.18.2" = _GGEJLdb9;
        "pkg-1.0.10+fabric+1.19.2" = _P3XuBChF;
        "pkg-1.0.10+fabric+1.19.3" = _BW2f9FN5;
        "pkg-1.0.11+fabric+1.19.2" = _x7cZ0rd4;
        "pkg-1.0.11+fabric+1.19.3" = _NJBwlwQx;
        "pkg-1.0.11+fabric+1.18.2" = _ESxbjZAU;
        "pkg-1.0.12+fabric+1.18.2" = _MeQSkbFq;
        "pkg-1.0.12+fabric+1.19.2" = _HiKPbhxV;
        "pkg-1.0.12+fabric+1.19.3" = _EEGV9l8o;
        "pkg-1.0.13+fabric+1.19.2" = _6N2gZwlK;
        "pkg-1.0.13+fabric+1.19.3" = _GYB0saqq;
        "pkg-1.0.13+fabric+1.18.2" = _hRlAULtt;
        "pkg-1.0.13+fabric+1.19.4" = _xTPrRL3M;
        "pkg-1.0.14+fabric+1.19.4" = _hHGP5jqf;
        "pkg-1.0.14+fabric+1.18.2" = _97w03s8E;
        "pkg-1.0.14+fabric+1.19.2" = _2tT4an8D;
        "pkg-1.0.14+fabric+1.19.3" = _HNVNKzwF;
        "pkg-1.0.14+fabric+1.20.1" = _iNmM5SVi;
        "pkg-2.0.0+fabric+1.18.2" = _pj0CEv2X;
        "pkg-2.0.0+forge+1.18.2" = _W2VnNxmi;
        "pkg-2.0.0+fabric+1.20.1" = _yifeXVby;
        "pkg-2.0.0+forge+1.20.1" = _pLlC13lB;
        "pkg-2.0.0+fabric+1.20.2" = _ArbMXfas;
        "pkg-2.0.0+forge+1.20.2" = _95fSK6SP;
        "pkg-1.0.15+fabric+1.21" = _bxr8NNbQ;
        "pkg-1.0.15+fabric+1.20.6" = _GzfLuCcj;
        "pkg-1.0.15.1+fabric+1.20.1" = _G1d5kL8m;
        "default" = _G1d5kL8m;
    });
