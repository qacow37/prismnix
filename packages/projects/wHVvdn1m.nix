...
let
    ...
    in {
        ...
        "pkg-1.21.0-1.3-fabric+forge+neo" = _F4rottaa;
        "pkg-1.21.0-2.0-fabric+forge+neo" = _3hQ9LJkv;
        "pkg-1.21.1-2.0-fabric+forge+neo" = _qilFp98E;
        "pkg-1.21.4-2.0-fabric+forge+neo" = _E2FIE2u2;
        "pkg-1.21.1-2.1-fabric+forge+neo" = _VowRpxV2;
        "pkg-1.21.4-2.1-fabric+forge+neo" = _P0DTiMDs;
        "pkg-1.21.1-2.2-fabric+forge+neo" = _FI0egNUI;
        "pkg-1.21.4-2.2-fabric+forge+neo" = _HqQ21OMR;
        "pkg-1.21.5-2.2-fabric+forge+neo" = _q7JmXtQY;
        "pkg-1.21.6-2.2-fabric+forge+neo" = _IEUwiGzg;
        "pkg-1.21.7-2.2-fabric+forge+neo" = _jQLb0hfS;
        "pkg-1.21.8-2.2-fabric+forge+neo" = _4Huadf9W;
        "pkg-1.21.1-2.3-fabric+forge+neo" = _EYT9J1ZO;
        "pkg-1.21.11-2.3-fabric+forge+neo" = _avnCFmTK;
        "pkg-26.1.2-2.3-fabric+forge+neo" = _DkjkXCiv;
        "pkg-1.21.1-2.4-fabric+forge+neo" = _v6wsQA2f;
