...
let
    ...
    in {
        ...
        "pkg-1.0.0-SNAPSHOT" = _VMtTpuCM;
        "pkg-1.0.0+0b2f75d" = _aRpewQRu;
        "pkg-1.0.0+a3b3eb7" = _4am31SO0;
        "pkg-1.0.0+4c62410" = _lAEKZWyG;
        "pkg-1.0.0+aab427e" = _fARuG3IS;
        "pkg-1.0.0+c6c939b" = _mxVa70ak;
        "pkg-1.0.0+4a75e10" = _MUvIoq6O;
        "pkg-1.0.0+cd7334e" = _ZtziYE65;
        "pkg-1.0.0+511fae5" = _8DpO3Af5;
        "pkg-1.0.0+1377283" = _EfIgl7dh;
        "pkg-1.0.0+430103f" = _nNG0d5Hc;
        "pkg-1.0.0+fa60827" = _qOjwYGu4;
        "pkg-1.0.0+241eb59" = _BD3urghi;
        "pkg-1.0.0+2d355f7" = _jEw64f6P;
        "pkg-1.0.0+60a8bd7" = _urEYrfds;
        "pkg-1.0.0+a30e381" = _1owyQqUl;
        "pkg-1.0.0+bcacba3" = _QxYh4C4J;
        "pkg-1.0.0+750de7b" = _F28wCxr3;
        "pkg-1.0.0+9b7fe75" = _ACfmE6A9;
        "pkg-1.0.0+8b22d89" = _dr4QY3vp;
        "pkg-1.0.0+7765702" = _L3v5H1QS;
        "pkg-1.0.0+060ab22" = _jOdkCX8S;
        "pkg-1.0.0+a0d51f3" = _pmVeYHon;
        "pkg-1.0.0+5af255b" = _7Sy0RHQV;
        "pkg-1.0.0+ef6bd7e" = _Ugn8ZtIx;
        "pkg-1.0.0+d3ed1d8" = _KU1xRpeS;
        "pkg-1.0.0+5f32645" = _WsNRDYTi;
        "pkg-1.0.0+dffdf0f" = _etTT8NLl;
        "pkg-1.0.0+bf0d70a" = _BnC95JXQ;
        "pkg-1.0.0+abda8c6" = _pHn5OC12;
        "pkg-1.0.0+300f5ae" = _HJvGFM5J;
        "pkg-1.0.0+f57f041" = _1KUv48kd;
        "pkg-1.0.0+0225d86" = _AZNJs3Mg;
        "pkg-1.0.0+14d72bf" = _1R1yNMOz;
        "pkg-1.0.0+45d6c82" = _yHci5c7D;
        "pkg-1.0.0+b9d4a51" = _47kDZeSZ;
        "pkg-1.0.0+432003f" = _YIofSsgj;
        "pkg-1.0.0+a4ef805" = _mTmA1XSl;
        "pkg-1.0.0+16dada5" = _WEZ9IlfA;
        "pkg-1.0.0+cc4de2e" = _Zn6a0tKT;
        "pkg-1.0.0+9d93b61" = _CTl2ZF6k;
        "pkg-1.0.0+49d5c84" = _n8KK9ECn;
        "pkg-1.0.0+0ad1d7a" = _hdf7nshk;
        "pkg-1.0.0+4f1d547" = _XwyDp79f;
        "pkg-1.0.0+1bfc747" = _vwE7deJa;
        "pkg-1.0.0+5fc7b34" = _qPFXqMPG;
        "pkg-1.0.0+7e931e9" = _yCcD5SGh;
        "pkg-1.0.0+d16e7bc" = _WLfnbtoA;
        "pkg-1.0.0+97eb17c" = _p0g4xwAR;
        "pkg-1.0.0+21d27ed" = _ivMhgFGN;
        "pkg-1.0.0+8a0e4f0" = _2jJ3GZGQ;
        "pkg-1.0.0+f997c7e" = _AihpTCJ0;
        "pkg-1.0.0+72fe00c" = _nBHkUbjh;
        "pkg-1.0.0+a5b5d94" = _fXTzpTSn;
        "pkg-1.0.0+71edb85" = _NoLOAQM9;
        "pkg-1.0.0+c5c23ed" = _ADfg0q5E;
        "pkg-1.0.0+5203b92" = _PrCZlkj0;
        "pkg-1.0.0+d35f63a" = _J59UdQ4P;
        "pkg-1.0.0+5cee3a8" = _QYvpsiLH;
        "pkg-1.0.0+d3d6f34" = _1hAYzpzw;
        "pkg-1.0.0+ba4263a" = _GFUn7xeD;
        "pkg-1.0.0+de1c95d" = _PYeEnudN;
        "pkg-1.0.0+d0cad85" = _z1nG0cbW;
        "default" = _z1nG0cbW;
    });
