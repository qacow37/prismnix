...
let
    ...
    in {
        ...
        "pkg-1.0" = _ANezi6sy;
        "pkg-1.0_mod" = _Ke5FCQI4;
        "pkg-1.1" = _cyFRYQKV;
        "pkg-1.2" = _q5I3vLSX;
        "pkg-1.2+mod" = _wqDaLlZh;
        "pkg-1.3" = _hPdz60jn;
        "pkg-1.3+mod" = _XnbmQMhA;
        "pkg-1.4" = _KdzDcTkB;
        "pkg-1.4+mod" = _ZavpNPfa;
        "pkg-2.0" = _EDKmpoEq;
        "pkg-2.0+mod" = _1fhIa6Yb;
        "pkg-2.1" = _GJNeX0o5;
        "pkg-3.0" = _GmzBUU3A;
        "pkg-3.0+mod" = _sCNnlp0U;
        "pkg-3.1" = _GnEIrykD;
        "pkg-3.1+mod" = _8Mi3hDCQ;
        "pkg-3.2" = _cUFIF63A;
        "pkg-3.2+mod" = _AprRAUeo;
        "pkg-3.3" = _50inZIsK;
        "pkg-3.3+mod" = _WYpLZIFk;
        "pkg-3.4" = _ZZqbpMqZ;
        "pkg-3.4+mod" = _WF5NsbhK;
        "pkg-3.5" = _MAuXVj84;
        "pkg-3.5+mod" = _yzqSFAZ3;
        "pkg-3.6" = _OfSaZpaC;
        "pkg-3.6+mod" = _m6rv9hu7;
        "pkg-3.7" = _Z7KkQMi0;
        "pkg-3.7-fabric" = _CEKo6Emf;
        "pkg-3.7-forge" = _wM2KVwy8;
        "pkg-3.11" = _oveogReS;
        "pkg-3.11-fabric" = _hgGcT4V9;
        "pkg-3.11-quilt" = _Z6XA92yW;
        "pkg-3.11-forge" = _lM1kgfay;
        "pkg-3.11-neoforge" = _tSKWFhr0;
        "pkg-3.12" = _HkA9oG9u;
        "pkg-3.12-fabric" = _jm3uozJU;
        "pkg-3.12-quilt" = _lk08tu5K;
        "pkg-3.12-forge" = _oDTkAC30;
        "pkg-3.12-neoforge" = _lSxqL89W;
        "default" = _lSxqL89W;
    });
