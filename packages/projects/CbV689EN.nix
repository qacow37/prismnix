...
let
    ...
    in {
        ...
        "pkg-2.4.27" = _uyO4NmZB;
        "pkg-2.4.28" = _Pkn6Fjuf;
        "pkg-2.4.29" = _idCYDYoC;
        "pkg-2.4.30" = _QACtq4Td;
        "pkg-2.4.32" = _1WjcYUN7;
        "pkg-2.4.33" = _9Ex9h78O;
        "pkg-3.0.0+4" = _9t5BqEbj;
        "pkg-3.0.0+5" = _50BLSoyz;
        "pkg-3.0.0+7" = _Ldg2dQtI;
        "pkg-3.0.0+9" = _UivBM1dk;
        "pkg-2.4.34" = _qa25R8yr;
        "pkg-3.0.1" = _o8OSwAXY;
        "pkg-2.4.35" = _v3EaMRYe;
        "pkg-2.5.1" = _jPsIl3Fa;
        "pkg-2.5.2" = _WhSuRoyo;
        "pkg-3.0.2" = _BGxpgRtM;
        "pkg-2.5.3" = _JEXd8Pxu;
        ...
        "pkg-2.5.5" = _lULr4bow;
        "pkg-3.0.9" = _IWRPGq2u;
        "pkg-3.0.10" = _ohgwoBxS;
        "pkg-3.0.11" = _63eSnCqQ;
        "pkg-2.5.6" = _iYXUOGI4;
        "pkg-3.0.12" = _KlvJggqG;
        "pkg-2.5.8" = _qJ3Kj0nN;
        "pkg-2.5.9" = _1seEikN7;
        "pkg-2.5.10" = _S1Gdt2wI;
        "pkg-2.5.11" = _HkM926ml;
        "pkg-2.5.12" = _mFgcyaxQ;
        "pkg-3.0.13" = _Xv925juM;
        "pkg-2.5.13" = _Wb2WZTFD;
        "pkg-2.5.14" = _ZKcTYez4;
        "pkg-3.0.14" = _ydleDVm4;
        "pkg-2.5.15" = _Vn32e0Ua;
        "pkg-2.5.16" = _ad2vjePv;
        "pkg-3.0.15" = _1gvCAeJ4;
        "pkg-2.5.17" = _fEbitUjF;
        "pkg-3.0.16" = _w8M00mGg;
        "pkg-2.5.18" = _D68QMGxA;
        "pkg-3.0.17" = _ccxZTHMR;
        "pkg-2.5.19" = _ou0FsY4Y;
        "pkg-3.0.18" = _hsGoGiGk;
        "default" = _hsGoGiGk;
    });
