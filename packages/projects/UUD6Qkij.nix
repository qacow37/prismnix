...
let
    ...
    in {
        ...
        "pkg-3.0.1" = _sJ8nPUp8;
        "pkg-3.1" = _y8jWbP7p;
        "pkg-forge-1.20.1-3.1.1" = _izCKbO59;
        "pkg-forge-1.20-3.1" = _FpOPGRxX;
        "pkg-forge-1.19.4-3.1" = _GLjiySmE;
        "pkg-forge-1.19.3-3.1" = _ytB6dgZy;
        "pkg-forge-1.19.2-3.1" = _i7Po1cEf;
        "pkg-fabric-1.20.1-3.1.1" = _W90OAHvv;
        "pkg-fabric-1.20-3.1" = _xU34bWg6;
        "pkg-fabric-1.19.4-3.1" = _LOP9HEAI;
        "pkg-fabric-1.19.3-3.1" = _HTfIismm;
        "pkg-fabric-1.19.2-3.1" = _PEdZQ0Ex;
        "pkg-fabric-1.20.1-3.1.2" = _3KrN8jEb;
        "pkg-fabric-1.20.1-3.1.2.1" = _BYHD7kh5;
        "pkg-fabric-1.20.1-3.1.2.2" = _gH4rSJgS;
        "pkg-forge-1.20.1-3.2" = _8EPULv1j;
        "pkg-forge-1.20-3.2" = _v8vc0gwo;
        "pkg-forge-1.20.1-3.2.1" = _5VeKQAAl;
        "pkg-forge-1.20-3.2.1" = _MTQerGJI;
        "pkg-forge-1.19.4-3.2.1" = _i9SrjpxE;
        "pkg-forge-1.19.3-3.2.1" = _DOl4fC4t;
        "pkg-forge-1.19.2-3.2.1" = _u2b74mus;
        "pkg-fabric-1.20.1-3.2.2" = _kBewmwU1;
        "pkg-fabric-1.20-3.2.2" = _Q63hOZZ5;
        "pkg-fabric-1.19.4-3.2.2" = _d54UP6as;
        "pkg-fabric-1.19.3-3.2.2" = _R11Xu0tH;
        "pkg-fabric-1.19.2-3.2.2" = _pg4OrvAz;
        "pkg-forge-1.20.1-3.2.3" = _83LCVYdH;
        "pkg-forge-1.20-3.2.3" = _liWJYkPD;
        "pkg-forge-1.19.4-3.2.3" = _q3vGERee;
        "pkg-forge-1.19.3-3.2.3" = _rpifIiGZ;
        "pkg-forge-1.19.2-3.2.3" = _zBYDxHov;
        "pkg-fabric-1.20.1-3.2.3" = _avhaxckH;
        "pkg-fabric-1.20-3.2.3" = _B0cmhKh0;
        "pkg-fabric-1.19.4-3.2.3" = _unCCt2NY;
        "pkg-fabric-1.19.3-3.2.3" = _Uckeg9SG;
        "pkg-fabric-1.19.2-3.2.3" = _rKrBI8dE;
        "pkg-forge-1.19.2-3.3" = _GQdpo93o;
        "pkg-fabric-1.19.2-3.3" = _orLqRDSV;
        "pkg-fabric-1.19.3-3.3" = _WhlbZFXs;
        "pkg-forge-1.19.3-3.3" = _LkULzdiq;
        "pkg-fabric-1.19.4-3.3" = _DQV4vuLo;
        "pkg-forge-1.19.4-3.3" = _WfW1zjgj;
        "pkg-fabric-1.20+1.20.1-3.3" = _6c8fQre0;
        "pkg-forge-1.20+1.20.1-3.3" = _w7NN8m3I;
        "pkg-forge-1.19.2-3.3.1" = _ZBrqUKG1;
        "pkg-fabric-1.19.2-3.3.1" = _lywO3N2e;
        "pkg-fabric-1.19.3-3.3.1" = _YzEXJAq9;
        "pkg-forge-1.19.3-3.3.1" = _JAkRaJJK;
        "pkg-fabric-1.19.4-3.3.1" = _1lvUsgTz;
        "pkg-forge-1.19.4-3.3.1" = _W1IHnUkA;
        "pkg-fabric-1.20+1.20.1-3.3.1" = _886PYLiq;
        "pkg-forge-1.20+1.20.1-3.3.1" = _T4d1Hpkx;
        "pkg-forge-1.20.2-3.3.1" = _8YraysGL;
        "pkg-fabric-1.20.2-3.3.1.1" = _tT0Qs9uC;
        "pkg-fabric-1.18.2-3.4" = _B7fjOECK;
        "pkg-forge-1.18.2-3.4" = _uJHZxYs0;
        "pkg-fabric-1.19.2-3.4" = _5yUkFOju;
        "pkg-forge-1.19.2-3.4" = _jGVZZ8KB;
        "pkg-forge-1.19.3-3.4" = _ulkgCQSS;
        "pkg-fabric-1.19.3-3.4" = _1gzivlSU;
        "pkg-fabric-1.20+1.20.1-3.4" = _BJPYR21n;
        "pkg-forge-1.19.4-3.4" = _ARcMG6yw;
        "pkg-fabric-1.20.2-3.4" = _VqoZyQ6a;
        "pkg-fabric-1.19.4-3.4" = _VJeIHSos;
        "pkg-forge-1.20+1.20.1-3.4" = _z0XEGXJ3;
        "pkg-forge-1.20.2-3.4" = _IkEn7tPc;
        "pkg-forge-1.18.2-3.4.1" = _ZwsmTPLs;
        "pkg-fabric-1.19.2-3.4.1" = _dug2TC1g;
        "pkg-forge-1.19.2-3.4.1" = _jqlEfDkk;
        "pkg-fabric-1.20+1.20.1-3.4.1" = _voKwnKp5;
        "pkg-forge-1.20+1.20.1-3.4.1" = _Fy28nVSN;
        "pkg-forge-1.20.2-3.4.1" = _V6Y8YEGR;
        "pkg-fabric-1.20.4-3.4.1" = _fSBNoBNN;
        "pkg-neoforge-3.4.1-1.20.4" = _omjOf1QT;
        "pkg-neoforge-3.4.1.1-1.20.4" = _b2zkoq8P;
        "pkg-neoforge-3.4.1.1-1.20.5" = _eqWft8pc;
        "pkg-forge-1.18.2-4.0" = _YOz6qI9Q;
        "pkg-forge-1.19.2-4.0" = _GUxVHJGS;
        "pkg-forge-1.20+1.20.1-4.0" = _AoIbNEMw;
        "pkg-fabric-1.20+1.20.1-4.0" = _EOGTVqvR;
        "pkg-fabric-1.20+1.20.1-4.0.1" = _Cv0qo31k;
        "pkg-forge-1.20.4-4.0" = _SIt4AE7m;
        "pkg-fabric-1.20.4-4.0.1" = _soLdWl5w;
        "pkg-forge-1.18.2-4.0.2" = _7lQ1m29V;
        "pkg-forge-1.19.2-4.0.2" = _2DLEQDUl;
        "pkg-forge-1.20+1.20.1-4.0.2" = _WOdaNcqX;
        "pkg-fabric-1.20+1.20.1-4.0.2" = _1er0PeLE;
        "pkg-forge-1.20.4-4.0.2" = _kIf6naZH;
        "pkg-fabric-1.20.4-4.0.2" = _3wQocfCC;
        "pkg-forge-1.20.6-4.0.2" = _F1BFCXSI;
        "pkg-fabric-1.20.6-4.0.2" = _RE89WGUE;
        "pkg-forge-1.21+1.21.1-4.0.2" = _ycq7RhY8;
        "pkg-fabric-1.21+1.21.1-4.0.2" = _ICiN0w3I;
        "pkg-forge-1.20.1-5.0-rc1" = _S1ATd9ct;
        "pkg-forge-1.20+1.20.1-5.0" = _DNcTeIAp;
        "pkg-fabric-1.20+1.20.1-5.0" = _8PJLSO5u;
        "pkg-forge-1.21+1.21.1-5.0" = _NWLebNUa;
        "pkg-fabric-1.21+1.21.1-5.0" = _Sl7fMm6b;
        "pkg-fabric-1.21+1.21.1-5.0.1" = _M3GIQCVI;
        "pkg-neoforge-1.21+1.21.1-5.1" = _SHCmhQf1;
        "default" = _SHCmhQf1;
    });
