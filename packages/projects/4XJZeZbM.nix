...
let
    ...
    in {
        ...
        "pkg-1.0.5-forge" = _ksYBt7dY;
        "pkg-1.0.5-fabric" = _HQ5RxPSS;
        "pkg-1.1.0-fabric" = _w0juloom;
        "pkg-1.1.0-forge" = _br9KuhIu;
        "pkg-1.2.0-forge" = _aEIcKcOJ;
        "pkg-1.2.0-fabric" = _W1SxUOHu;
        "pkg-1.2.1-forge" = _iBzF1P8s;
        "pkg-1.2.1-fabric" = _SERkJAg2;
        "pkg-1.2.2-forge" = _64jnf8gD;
        "pkg-1.2.2-fabric" = _7pXo4PfL;
        "pkg-1.2.3-forge" = _pRnjpSk3;
        "pkg-1.2.3-fabric" = _k7owsk71;
        "pkg-1.2.4-forge" = _95OwnjnL;
        "pkg-1.2.4-fabric" = _NkpJQXq8;
        "pkg-1.2.5-forge" = _CN7bcW4D;
        "pkg-1.2.5-fabric" = _arVwRSxS;
        "pkg-1.1.0b-forge" = _3albwtm0;
        "pkg-1.2.6-forge" = _o0DP7SgU;
        "pkg-1.2.6-fabric" = _MR1JTKce;
        "pkg-1.2.6" = _gIayaZBp;
        "pkg-1.2.7-forge" = _xhHzq7T7;
        "pkg-1.2.7-fabric" = _h5wLaNcB;
        "pkg-1.3.0-forge" = _agv1fIP1;
        "pkg-1.3.0-fabric" = _3pWnhxpG;
        "pkg-1.3.0.1-forge" = _gG0SPlXx;
        "pkg-1.3.1-forge" = _I33RUK1d;
        "pkg-1.3.1-fabric" = _MlF89rW6;
        "pkg-1.2.8-forge" = _pyVKVeSf;
        "pkg-1.2.8-fabric" = _wKMcbCEl;
        "pkg-1.3.2-forge" = _Rux0Z0be;
        "pkg-1.3.2-fabric" = _p6XjKR8c;
        "pkg-1.1.1-fabric" = _iJQvwKt6;
        "pkg-1.1.1-forge" = _dRKpSLaj;
        "pkg-1.2.9-forge" = _cfANm9l6;
        "pkg-1.2.9-fabric" = _u8VE5pSI;
        "pkg-1.2.10" = _GJmh5DMx;
        "pkg-1.2.11" = _ovLpJk3c;
        "pkg-1.2.12" = _XH19GNFf;
        "pkg-1.2.13" = _egxhEzTt;
        "pkg-1.2.14" = _UXpmGhse;
        "pkg-1.2.15" = _uEaTMht9;
        "default" = _uEaTMht9;
    });
