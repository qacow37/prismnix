...
let
    ...
    in {
        ...
        "pkg-0.0.2" = _1XGYZEBT;
        "pkg-0.0.3" = _yYpRTF1j;
        "pkg-0.0.3.1" = _FRxrm0Jt;
        "pkg-0.0.4" = _uQjO3olC;
        "pkg-0.0.5" = _gmt6R5AP;
        "pkg-0.0.5.1" = _IoBJq36l;
        "pkg-0.0.5.2" = _vAhORDo9;
        "pkg-0.0.5.3" = _EkFL8ee3;
        "pkg-0.0.5.4" = _AjA7Jebu;
        "pkg-0.0.6" = _w5BW0kd7;
        "pkg-0.0.6.1" = _xvNWAhkQ;
        "pkg-0.0.6.2" = _OhuxdnMy;
        "pkg-1.0.0-PRE_RELEASE" = _R9pnS0j2;
        "pkg-1.0.1" = _ZcGAyLbY;
        "pkg-0.0.7+1.20.1" = _X7SzsXMH;
        "pkg-0.0.7+1.20.2" = _oLDaWky4;
        "pkg-0.0.7.1+1.20.1" = _N7PTcKgP;
        "pkg-0.0.7.1+1.20.2" = _pZAuvsgS;
        "pkg-1.0.2" = _oegDQCFl;
        "pkg-1.0.2.1" = _iwQaDSLQ;
        "pkg-0.0.7.2+1.20.1" = _hzjVMjzN;
        "pkg-0.0.7.2+1.20.2" = _Wu7g9dU5;
        "pkg-1.0.3" = _eRbLp6ef;
        "pkg-1.0.3.1" = _WO1x4GEa;
        "pkg-1.0.4" = _gdSvdQ3F;
        "pkg-1.0.4.1" = _VmcO6o9E;
        "pkg-1.0.4.1-1.21.1" = _eNEWVwfw;
        "pkg-1.0.4.2" = _t8qBSQVb;
        "pkg-1.0.4.2-1.21.1" = _xSsRgiGg;
        "pkg-1.0.4.3" = _6vy9YzxA;
        "pkg-1.1.0_PRE_RELEASE" = _3pWXKIdZ;
        "pkg-1.1.0" = _Shu7PnNp;
        "pkg-1.1.0.1" = _ksUKcLqJ;
        "pkg-1.1.0.2" = _729NvdHk;
        "pkg-1.1.0.3" = _ncKRrBas;
        "pkg-1.1.0.4" = _GkBycEGZ;
        "pkg-1.1.1" = _aut01Dzm;
        "pkg-1.1.1.1" = _2fdEWlNk;
        "pkg-1.1.1.2" = _yZf3jxN4;
        "default" = _yZf3jxN4;
    });
