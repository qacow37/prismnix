...
let
    ...
    in {
        ...
        "pkg-1.18.2" = _vmhjwoXt;
        "pkg-1.19" = _fDLgV7xY;
        "pkg-1.19.1" = _FL4TxzT0;
        "pkg-1.19.2" = _bmsR7iYm;
        "pkg-1.19.3" = _wyREJAGR;
        "pkg-1.19.4" = _5lPTe1HE;
        "pkg-1.20" = _3efE7Vz6;
        "pkg-1.20.1" = _NbwiHdhJ;
        "pkg-1.20.2" = _KZhl6bMT;
        "pkg-1.20.3" = _dxkpD9oX;
        "pkg-1.20.4" = _k4ECw2We;
        "pkg-1.20.5" = _C5GZoAsT;
        "pkg-1.20.6" = _ZJKLhFQ2;
        "pkg-1.21" = _ZX6Y7xfn;
        "pkg-1.21.1" = _mQEuFLpR;
        "pkg-1.21.2" = _7aqF6MUE;
        "pkg-1.21.3" = _u4FqhLUj;
        "pkg-1.21.4" = _LGm014Sw;
        "pkg-1.21.5" = _O1H6NIJ2;
        "pkg-1.21.6" = _asDmpy5D;
        "pkg-1.21.7" = _zybxdgcJ;
        "pkg-1.21.8" = _yMdw2wll;
        "pkg-1.21.9" = _TM9wq23I;
        "pkg-1.21.10" = _BV7mg28Q;
        "pkg-1.21.11" = _CFed2Mtb;
        "pkg-26.1" = _jKgpCcRe;
        "pkg-26.1.1" = _PecRc3b7;
        "pkg-26.1.2" = _mHnvmeh7;
        "default" = _mHnvmeh7;
    });
