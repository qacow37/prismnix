...
let
    ...
    in {
        ...
        "pkg-1.17.1-1.0-Forge" = _Y8owHJfH;
        "pkg-1.17.1-1.0-Fabric" = _iOsFwp45;
        "pkg-1.18-1.1-Forge" = _kvpOPQmr;
        "pkg-1.18-1.1-Fabric" = _xCYw201w;
        "pkg-1.18-1.2-Forge" = _XIAoGLyI;
        "pkg-1.18.2-1.3-Fabric" = _GQJXWRCS;
        "pkg-1.18.2-1.3-Forge" = _POE6nsSI;
        "pkg-1.18.2-1.4-Fabric" = _Rh77h6Dz;
        "pkg-1.18.2-1.4-Forge" = _Zy0KuJhW;
        "pkg-1.18.2-1.5-Fabric" = _zYw7Pwzy;
        "pkg-1.18.2-1.5-Forge" = _602LveTO;
        "pkg-1.19.3-1.6.0-Fabric" = _UC1estyi;
        "pkg-1.19.3-1.6.0-Forge" = _Ml7bCNhi;
        "pkg-1.19.3-1.6.1-Fabric" = _Mr4Fisfa;
        "pkg-1.19.3-1.6.1-Forge" = _9nf3BeQJ;
        "pkg-1.18.2-1.5.1-Fabric" = _QRTIJ3uL;
        "pkg-1.18.2-1.5.1-Forge" = _59c1IKOl;
        "pkg-1.20-1.7.0-Fabric" = _ak8R3XJc;
        "pkg-1.20-1.7.0-Forge" = _4WDUQOLS;
        "pkg-1.20.2-1.8.0-Fabric" = _8AJfNzME;
        "pkg-1.20.2-1.8.0-Forge" = _h5b5Qnxs;
        "pkg-1.20.2-1.8.0-NeoForge" = _ltKUSacX;
        "default" = _ltKUSacX;
    });
