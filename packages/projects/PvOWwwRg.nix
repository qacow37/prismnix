...
let
    ...
    in {
        ...
        "pkg-0.12.2" = _BLqexi68;
        "pkg-v1.1.2" = _LWX6cRP9;
        "pkg-1.1.3" = _UTp1fLpq;
        "pkg-v1.2.0" = _LeKiyueW;
        "pkg-v1.2.1" = _TSsfYvs7;
        "pkg-1.10.0" = _iZ1LpD3s;
        "pkg-1.12.0" = _l0B1fN46;
        "pkg-1.12.1" = _o1m7kUgf;
        "pkg-1.13.0" = _xllyTGHx;
        "pkg-1.14.0" = _PdSU4leC;
        "pkg-1.14.1" = _8MSLgLii;
        "pkg-1.14.0.1" = _3cXD9jmk;
        "pkg-1.15.0" = _puEMxOlP;
        "pkg-1.16.0" = _HJmIYL6B;
        "pkg-1.17.0" = _o0ha58bL;
        "pkg-1.14.0.2" = _uXk9HDLk;
        "pkg-1.17.1" = _BJqV3t6I;
        "pkg-1.18.0" = _H7i9mi6h;
        "pkg-1.18.1" = _xTeyOkyN;
        "pkg-1.19.0" = _tKyHtzyf;
        "pkg-1.19.1" = _7xcmpP3V;
        "pkg-1.20.0" = _yC1Ham6Y;
        "pkg-1.20.0.1" = _JEwDmxdf;
        "pkg-1.20.1" = _OoKpCxe7;
        "pkg-1.20.1.1" = _5g5VnoNj;
        "pkg-1.20.2" = _BAjIfHf5;
        "pkg-1.20.3" = _bieyaFxV;
        "default" = _bieyaFxV;
    });
