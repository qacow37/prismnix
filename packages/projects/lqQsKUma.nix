...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.9-fabric" = _XLhZcEP7;
        "pkg-1.18.2-1.9-fabric" = _jT9UXwu8;
        "pkg-1.19.2-2.1-fabric" = _1edYtxOA;
        "pkg-1.16.5-1.3-forge" = _PPz7hEPE;
        "pkg-1.18.2-1.5-forge" = _Vqitmjpa;
        "pkg-1.19.2-1.8-forge" = _SkJzCaLn;
        "pkg-1.16.5-2.2-fabric" = _SNktEHIt;
        "pkg-1.18.2-2.2-fabric" = _KxeF7H73;
        "pkg-1.19.2-2.2-fabric" = _PFh4qJle;
        "pkg-1.16.5-2.2-forge" = _yrmKgf8s;
        "pkg-1.18.2-2.2-forge" = _sagwzIX3;
        "pkg-1.19.2-2.2-forge" = _nutyk5Kq;
        "pkg-1.16.5-2.3-fabric" = _5z9FTsOA;
        "pkg-1.18.2-2.3-fabric" = _RbTdOwWZ;
        "pkg-1.19.2-2.3-fabric" = _SBui0t35;
        "pkg-1.16.5-2.4-fabric" = _zvshY9U3;
        "pkg-1.18.2-2.4-fabric" = _XQ8S6wll;
        "pkg-1.19.2-2.4-fabric" = _41HODe7H;
        "pkg-1.19.3-2.2-forge" = _ouQtjJky;
        "pkg-1.19.3-2.5-fabric" = _BvoDvKZ4;
        "pkg-1.18.2-3.0-forge+fabric" = _84q2A0si;
        "pkg-1.19.2-3.0-forge+fabric" = _i4eUeCVm;
        "pkg-1.19.3-3.0-forge+fabric" = _TLUhJEpP;
        "pkg-1.18.2-3.1-forge+fabric" = _HWYtv3c2;
        "pkg-1.19.2-3.1-forge+fabric" = _UtQ2GZY1;
        "pkg-1.19.3-3.1-forge+fabric" = _EOv4gA9E;
        "pkg-1.19.4-3.1-forge+fabric" = _PPXBhgl1;
        "pkg-1.20-3.1-forge+fabric" = _EfU5jHBj;
        "pkg-1.20.1-3.1-forge+fabric" = _fekGgEVQ;
        "pkg-1.20.2-3.1-forge+fabric" = _TefHDHeT;
        "pkg-1.18.2-3.2-forge+fabric" = _1wR2pZIY;
        "pkg-1.19.2-3.2-forge+fabric" = _lSHMoZfz;
        "pkg-1.20.1-3.2-forge+fabric" = _PYyc9hJi;
        "pkg-1.20.2-3.2-forge+fabric" = _1bjyBBLW;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _VacUb22D;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _4ilae8OJ;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _k5NE7JsV;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _nSKhaa2J;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _osgog7SY;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _bDZ1gviV;
        "pkg-1.20.5-3.3-fabric+neo" = _Ldntswgx;
        "pkg-1.20.5-3.4-fabric+neo" = _ZYu1m0in;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _QCDou6bb;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _qw6VxDic;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _lZiGdHLg;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _Q1BY4NYw;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _vQ4AsUZP;
        "pkg-1.20.6-3.7-fabric+forge+neo" = _vd0m0Rzr;
        "pkg-1.21.0-3.7-fabric+forge+neo" = _3BK3uqNh;
        "pkg-1.21.1-3.7-fabric+forge+neo" = _F1FesBgG;
        "pkg-1.21.2-3.7-fabric+neo" = _88TzrJqq;
        "pkg-1.21.2-3.8-fabric+neo" = _cIkSZskP;
        "pkg-1.21.3-3.8-fabric+forge+neo" = _7AKqL83S;
        "pkg-1.21.4-3.8-fabric+forge+neo" = _TLLTW1Er;
        "pkg-1.20.1-3.9-fabric+forge+neo" = _nkwRjayP;
        "pkg-1.21.1-3.9-fabric+forge+neo" = _m26ZLguN;
        "pkg-1.21.4-3.9-fabric+forge+neo" = _YdZQByAt;
        "pkg-1.21.5-3.9-fabric+forge+neo" = _uvT1mFRk;
        "pkg-1.21.6-3.9-fabric+forge+neo" = _b5CsqH1x;
        "pkg-1.21.6-4.0-fabric+forge+neo" = _H5uMXhhm;
        "pkg-1.21.7-4.0-fabric+forge+neo" = _6fSIrg4o;
        "pkg-1.21.8-4.0-fabric+forge+neo" = _3A8zam3A;
        "pkg-1.21.9-4.0-fabric+forge+neo" = _S2Mcu4O6;
        "pkg-1.21.10-4.0-fabric+forge+neo" = _lfHOshCr;
        "pkg-1.21.11-4.0-fabric+forge+neo" = _54YN4yMF;
        "pkg-26.1.0-4.0-fabric+forge+neo" = _F38CJval;
        "pkg-26.1.1-4.0-fabric+forge+neo" = _bHDPhsLb;
        "pkg-26.1.2-4.0-fabric+forge+neo" = _Nqjg5j71;
        "pkg-26.2.0-4.0-fabric+forge+neo" = _mzaj1z1A;
        "default" = _mzaj1z1A;
    });
