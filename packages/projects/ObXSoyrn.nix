...
let
    ...
    in {
        ...
        "pkg-1.12.2-2.1.1" = _QPmKNRjf;
        "pkg-1.15.2-2.1.2" = _GXKKnh45;
        "pkg-1.16.5-2.1.2" = _ErCLmY1D;
        "pkg-fabric-1.15.2-2.1.1" = _7fmnkM1H;
        "pkg-fabric-1.16.5-2.1.1" = _6do0i8tj;
        "pkg-fabric-1.17-2.1.1" = _JOJVU005;
        "pkg-1.12.2-2.2" = _UmfBchq6;
        "pkg-forge-1.15.2-2.2" = _JpbKaatj;
        "pkg-forge-1.16.5-2.2" = _IM1UDlAY;
        "pkg-fabric-1.15.2-2.2" = _h0OcI93O;
        "pkg-fabric-1.16.2-2.2" = _5QaAR5p8;
        "pkg-fabric-1.17-2.2" = _Mrsj04Bd;
        "pkg-1.12.2-2.2.1" = _yiFG3eJ9;
        "pkg-forge-1.15.2-2.2.1" = _XAMaGao7;
        "pkg-forge-1.16.5-2.2.1" = _12kE8eVE;
        "pkg-fabric-1.15.2-2.2.1" = _4CIWoKrc;
        "pkg-fabric-1.16.5-2.2.1" = _xDihV8nF;
        "pkg-fabric-1.17-2.2.1" = _S9muQEaT;
        "pkg-fabric-1.15.2-2.2.2" = _koibM4yf;
        "pkg-fabric-1.16.5-2.2.2" = _6I5aJssT;
        "pkg-fabric-1.17-2.2.2" = _uK2BblEc;
        "pkg-1.16.5-3.0.1" = _RpzCOOls;
        "pkg-1.17.1-3.0.1" = _wTLie3Kn;
        "pkg-1.18.2-3.0.1" = _WJfkhTyC;
        "pkg-1.16.5-3.0.1f" = _2Q2IPbk0;
        "pkg-1.17.1-3.0.1f" = _eyB4gEFY;
        "pkg-1.18.2-3.0.1f" = _Fv7sE71b;
        "pkg-1.19-3.0.1" = _Una0ca4P;
        "pkg-1.19-3.0.2f" = _KbNKiv4y;
        "pkg-1.19-3.0.2" = _2zmnlJkK;
        "pkg-1.12.2-3.1.0" = _2Fo4uaU5;
        "pkg-1.16.5-3.1.0f" = _BRpDlIrZ;
        "pkg-1.16.5-3.1.0" = _kWJXWgcG;
        "pkg-1.17.1-3.1.0f" = _27mGaBy1;
        "pkg-1.17.1-3.1.0" = _Gpax4TsG;
        "pkg-1.18.2-3.1.0f" = _z4nj6ZWY;
        "pkg-1.18.2-3.1.0" = _4JDZEfxY;
        "pkg-1.19-3.1.0f" = _a3bggHg0;
        "pkg-1.19-3.1.0" = _vX5yYBH2;
        "pkg-1.12.2-3.1.1" = _bGX4qj1i;
        "pkg-1.16.5-3.1.1f" = _1YoQUJYq;
        "pkg-1.16.5-3.1.1" = _68UjB0KA;
        "pkg-1.17.1-3.1.1f" = _u4oBNccT;
        "pkg-1.17.1-3.1.1" = _t8A57M1Y;
        "pkg-1.18.2-3.1.1f" = _qL2eWVAq;
        "pkg-1.18.2-3.1.1" = _iFAycxSk;
        "pkg-1.19-3.1.1f" = _wYej0R3w;
        "pkg-1.19-3.1.1" = _N6c3j9P4;
        "pkg-1.16.5-3.2.0f" = _rWvLgbxN;
        "pkg-1.16.5-3.2.0" = _2Ax7Yf8k;
        "pkg-1.17.1-3.2.0f" = _rzLqDXTR;
        "pkg-1.17.1-3.2.0" = _P80jIvl6;
        "pkg-1.18.2-3.2.0f" = _V66DDmFU;
        "pkg-1.18.2-3.2.0" = _vhim5Otx;
        "pkg-1.19-3.2.0f" = _vp0eiGbL;
        "pkg-1.19-3.2.0" = _F6iNaX9z;
        "pkg-1.19.3-3.2.1f" = _6oVCaOMm;
        "pkg-1.19.3-3.2.1" = _Snuy21MJ;
        "pkg-1.16.5-3.2.2" = _LjVPCtKm;
        "pkg-1.17.1-3.2.2" = _1tCacwyL;
        "pkg-1.18.2-3.2.2" = _w8GJvDW6;
        "pkg-1.19-3.2.2" = _vdVrFfh5;
        "pkg-1.19.4-3.2.2" = _K9QOVuft;
        "pkg-1.20-3.2.2" = _T2YNbPAl;
        "pkg-1.16.5-3.2.3" = _96HmMCco;
        "pkg-1.18.2-3.2.3" = _ZJquL8dz;
        "pkg-1.19-3.2.3" = _eUuYvI61;
        "pkg-1.19.4-3.2.3" = _jwTwaeyl;
        "pkg-1.20-3.2.3" = _K02ewUAs;
        "pkg-1.18.2-3.2.4" = _kK5NNpPS;
        "pkg-1.19-3.2.4" = _XFIn7X0m;
        "pkg-1.19.4-3.2.4" = _cZAOlyqU;
        "pkg-1.20-3.2.4" = _B7eLRz3F;
        "pkg-1.20.2-3.2.4" = _8UrhQcbC;
        "pkg-1.20.2-3.2.5" = _5lTfT492;
        "pkg-1.20.4-3.2.5" = _PoFenbfK;
        "pkg-1.20.4-3.2.6" = _YyFppPGz;
        "pkg-3.3.0" = _2pUBpAqQ;
        "pkg-3.3.1" = _Uy3qsVm5;
        "pkg-3.3.2" = _JoAVJbRv;
        "pkg-3.3.3" = _kgFckjwV;
