...
let
    ...
    in {
        ...
        "pkg-1.0010" = _OPz4Qxp3;
        "pkg-1.0110" = _QF1g2Ezh;
        "pkg-1.0210" = _dTmgHwUX;
        "pkg-1.0310" = _OTnyfHM6;
        "pkg-1.0411" = _gBNZ7f0I;
        "pkg-1.0511" = _G3QWK2J1;
        "pkg-1.0612" = _tmyvKTVn;
        "pkg-1.0712" = _MXnKohiV;
        "default" = _MXnKohiV;
    });
