...
let
    ...
    in {
        ...
        "pkg-0.1-1.21.1" = _DKJZ6sDy;
        "pkg-0.1.1-1.21.1" = _FxRzfR82;
        "pkg-0.1.2-1.21.1" = _gg9ULzZ6;
        "pkg-0.1.2.1-1.21.1" = _vPc6qJkW;
        "pkg-0.2-1.21.1" = _K7FhPXuF;
        "pkg-0.2.1-1.21.1" = _LjTseUyp;
        "pkg-0.2.1.1-1.21.1" = _maRc6vdm;
        "pkg-0.2.2-1.21.1" = _aYf5ljCJ;
        "pkg-0.2.3-1.21.1" = _379uho8d;
        "pkg-0.3-1.21.1-beta" = _HvgsfcZD;
        "pkg-0.3.1-1.21.1-beta" = _eSq4g3Ep;
        "pkg-0.3.2-1.21.1-beta" = _cVIyThu1;
        "pkg-0.3.2.1-1.21.1-beta" = _guTlT8wt;
        "pkg-0.3.2.2-1.21.1-beta" = _6ZUD23Cd;
        "pkg-0.3.2.3-1.21.1-beta" = _oQ1exiB1;
        "pkg-0.3.2.4-1.21.1-beta" = _RgjnmxvJ;
        "pkg-0.3.3-1.21.1-beta" = _RiEK5PrF;
        "pkg-0.3.4-1.21.1-beta" = _3oHyT9PP;
        "pkg-0.3.5-1.21.1-beta" = _BRGFqcUS;
        "pkg-0.3.6-1.21.1-beta" = _gCMPu322;
        "pkg-0.3.6.1-1.21.1-beta" = _M2zHyFmH;
        "pkg-0.3.6.2-1.21.1-beta" = _gWQn3gYK;
        "pkg-0.3.6.3-1.21.1-beta" = _hCQUsIFl;
        "pkg-0.3.6.4-1.21.1-beta" = _zkzwc7ZT;
        "pkg-0.3.6.5-1.21.1-beta" = _xjMugfgJ;
        "default" = _xjMugfgJ;
    });
