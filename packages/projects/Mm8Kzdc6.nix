...
let
    ...
    in {
        ...
        "pkg-v1.0.1-forge-1.20.1" = _PdV735bk;
        "pkg-v1.0.1-forge-1.21.1" = _kPZpTjEV;
        "pkg-v1.0.1-forge-1.21.4" = _bSaPHfFU;
        "pkg-v1.0.1-forge-1.21.5-55.0.4" = _zt7xwToC;
        "pkg-v1.0.1-fabric-1.21.5-0.119.9" = _JdD4Xxo2;
        "pkg-v1.0.2-forge-1.21.5-55.0.4" = _pZw3T3Wd;
        "pkg-1.0.3-forge-1.21.5-55.0.4" = _qwk9YPOS;
        "pkg-1.0.3-fabric-1.21.5-0.119.9" = _LUcdLtoP;
        "pkg-1.0.3-forge-1.21.4-54.1.3" = _hABKk0s8;
        "pkg-1.0.3-fabric-1.21.4-0.116.1" = _BCiwil6C;
        "pkg-1.0.3-forge-1.21.1-52.1.1" = _APx5tU4R;
        "pkg-1.0.3-forge-1.20.1-47.4.0" = _cAomg7YT;
        "pkg-1.0.3-fabric-1.21.6-0.127.0" = _IQNcXzvH;
        "pkg-1.0.3-forge-1.21.6-56.0.7" = _iGaI38ON;
        "pkg-1.0.3-neoforge-1.21.8-21.8.39" = _98sw2nJo;
        "pkg-1.0.3-neoforge-1.21.9-21.9.2-b" = _NbFKHD7M;
        "pkg-1.0.3-fabric-1.21.9-0.134.0" = _nApsTe2b;
        "pkg-1.0.3-forge-1.21.9-59.0.1" = _YZinzqyw;
        "pkg-1.0.4-forge-1.21.9-59.0.5" = _f88zb3nY;
        "pkg-1.0.3-neoforge-1.21.4-21.4.155" = _BRMWHbIr;
        "pkg-1.0.3-neoforge-1.21.1-21.1.213" = _js5z0QH2;
        "pkg-1.0.5-forge-1.21.8-58.1.7" = _obgmYKGD;
        "pkg-1.0.5-forge-1.21.11-61.0.2" = _752G54ll;
        "pkg-1.0.5-neoforge-1.21.11-21.11.10-" = _Gksmqo2C;
        "pkg-1.0.5-fabric-1.21.11-0.140.0" = _U406gfSV;
        "pkg-1.0.6-fabric-26.1.2-0.145.4" = _EAHBvpZ1;
