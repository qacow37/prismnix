...
let
    ...
    in {
        ...
        "pkg-1.00.2" = _ZTmHuHiz;
        "pkg-4.00.5" = _v2D6yOcJ;
        "pkg-7.00.8" = _IOCqsUqC;
        "pkg-10.00.10" = _w5gcJZrn;
        "pkg-10.00.11" = _zbpL5aRs;
        "pkg-11.00.12" = _kShAzH03;
        "pkg-12.00.13" = _rkg6ajyR;
        "pkg-12.00.14" = _FOw525ab;
        "default" = _FOw525ab;
    });
