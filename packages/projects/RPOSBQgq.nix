...
let
    ...
    in {
        ...
        "pkg-0.1.0-1.19-fabric" = _X24q2iia;
        "pkg-v0.2.0" = _O2KOHSPJ;
        "pkg-v0.2.1" = _Ri0QCixj;
        "pkg-v0.3.0" = _j5VqRZlF;
        "pkg-v0.3.1" = _QmIKzS7b;
        "pkg-v0.3.2" = _rf2jLZvC;
        "pkg-plugin-0.1.0" = _ydbCLkJa;
        "pkg-v0.3.2-1.19.3" = _6cmQDpI7;
        "pkg-v0.4.0-1.19.4" = _YAMyEX1t;
        "pkg-v0.4.0-1.19.3" = _MZAKaMqE;
        "pkg-v0.4.0-1.19.2" = _WZU4j0Uk;
        "pkg-v0.4.0-1.18.2" = _OgfOEQMc;
        "pkg-v0.4.0-1.20" = _sFclEion;
        "pkg-v0.5.0-1.20" = _5SS5s8Mr;
        "pkg-v0.5.1-1.20" = _c02hnEPx;
        "pkg-v0.5.2-1.20" = _ezuMmkdM;
        "pkg-v0.5.3-1.20" = _NEBVxulw;
        "pkg-0.2.1" = _E7jCNr0p;
        "pkg-v0.5.3-1.20.2" = _Z2YZdulh;
        "pkg-v0.5.4-1.20.2" = _zUblkil8;
        "pkg-0.5.4-mc23w43a" = _eBv5OCE8;
        "pkg-v0.5.5-1.20.2" = _IIT4cam4;
        "pkg-0.5.5-1.20.4" = _UAt5HtUi;
        "pkg-0.5.6-1.20.4" = _UKVc6pCj;
        "pkg-0.6.0" = _xMkAPaKv;
        "pkg-0.6.1" = _UAeQ386q;
        "pkg-0.6.2" = _O0HEXsMx;
        "pkg-0.6.3" = _kyU5ZZC5;
