...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.20.4" = _lgUFLZMC;
        "pkg-1.0.0-1.20.3" = _p3FCOURZ;
        "pkg-1.0.0-1.20.2" = _3yC0HBuq;
        "pkg-1.0.1-1.20.4" = _HbXGJFyd;
        "pkg-1.0.1-1.20.3" = _PvhDZZZR;
        "pkg-1.0.1-1.20.2" = _2pY2HxIm;
        "pkg-1.0.2-1.20.4" = _We7jTed4;
        "pkg-1.0.2-1.20.3" = _KyE2OzBL;
        "pkg-1.0.2-1.20.2" = _RtxGRQoG;
        "pkg-1.0.3-1.20.4" = _mI53VjOG;
        "pkg-1.0.3-1.20.3" = _2WmqI4BQ;
        "pkg-1.0.3-1.20.2" = _arqVIGBH;
        "pkg-1.0.4-1.20.4" = _F0FKyq6p;
        "pkg-1.0.4-1.20.3" = _VSRi7Hrm;
        "pkg-1.0.4-1.20.2" = _3W3qA1pj;
        "pkg-1.1.0-1.20.5" = _RTrD2WmD;
        "pkg-1.1.0-1.20.6" = _wcEHbGbT;
        "pkg-1.1.1-1.20.5" = _24nuQHRs;
        "pkg-1.1.1-1.20.6" = _qvvZEr5O;
        "pkg-1.1.2-1.20.5" = _9tRgSPtJ;
        "pkg-1.1.2-1.20.6" = _K31vpw61;
        "pkg-1.1.3-1.20.5" = _wqSZnNBe;
        "pkg-1.1.3-1.20.6" = _peOuceEl;
        "pkg-1.1.4-1.20.5" = _Anhm5Ngt;
        "pkg-1.1.4-1.20.6" = _ScTlEYaX;
        "pkg-1.2.1-1.21" = _dLonhtWP;
        "pkg-1.2.1-1.21.1" = _qkkYEdFz;
        "pkg-1.2.2-1.21" = _HzTr7Zjn;
        "pkg-1.2.2-1.21.1" = _x8WzgVhC;
        "pkg-1.2.3-1.21+" = _so6PiTcZ;
        "pkg-1.2.4-1.21+" = _6EjUS9Pl;
        "pkg-1.2.5-1.21+" = _fMsAZkx8;
        "pkg-1.2.6-1.21+" = _UAS0Dt8S;
        "pkg-1.2.7-1.21+" = _xdWpXqUm;
        "pkg-1.2.8-1.21+" = _RYhLI77C;
        "pkg-1.3.0-1.21.2+" = _JkwPLRkf;
        "pkg-1.3.1-1.21.2+" = _wW4G77W6;
        "pkg-1.4.0-1.21.4+" = _5OzycPjF;
        "pkg-1.4.1-1.21.4+" = _FuFWMZNM;
        "pkg-1.2.9-1.21+" = _Poa8Yw1R;
        "pkg-1.3.2-1.21.2+" = _nA5j66TZ;
        "pkg-1.2.10-1.21+" = _WMOdm4Sf;
        "pkg-1.3.3-1.21.2+" = _rfMOjjIm;
        "pkg-1.4.2-1.21.4+" = _v93KmybI;
        "pkg-1.2.11-1.21+" = _tMAkDmr0;
        "pkg-1.3.4-1.21.2+" = _d1JNA4tV;
        "pkg-1.4.3-1.21.4+" = _f4wabZJx;
        "pkg-1.5.0-1.21.5+" = _MhScT4kf;
        "pkg-1.5.1-1.21.5+" = _bjdMaRLS;
        "pkg-1.6.0-1.21.6+" = _h2sjq94y;
        "pkg-1.7.0-1.21.9+" = _xcCw3AYd;
        "pkg-1.7.1-1.21.10+" = _KBbnEaMH;
        "default" = _KBbnEaMH;
    });
