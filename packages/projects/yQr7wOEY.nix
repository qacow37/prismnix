...
let
    ...
    in {
        ...
        "pkg-1.0" = _ObLkcmHC;
        "pkg-1.0+mod" = _NiU5gUWl;
        "pkg-1.1" = _vBbzt1F3;
        "pkg-1.1+mod" = _i9OF2oIG;
        "pkg-1.2" = _fexZP9Ok;
        "pkg-1.2+mod" = _kg47l5Fp;
        "pkg-2.0" = _E5XTW3hR;
        "pkg-2.0+mod" = _4gqOeDnJ;
        "pkg-3.0" = _2Q87L6gd;
        "pkg-3.0+mod" = _75pZC1wA;
        "pkg-3.1" = _D5JTIY3Z;
        "pkg-4.0" = _Kp5CueIj;
        "pkg-4.0+mod" = _h9siXVE3;
        "pkg-4.1" = _z8oJolhy;
        "pkg-4.1+mod" = _wLt7L2YP;
        "pkg-4.2" = _a5lKg7jI;
        "pkg-4.2+mod" = _3IH6GAdC;
        "pkg-4.3" = _WvFgHdrp;
        "pkg-4.3+mod" = _jMJw6Dfc;
        "pkg-4.4" = _Dg21V2bR;
        "pkg-4.4+mod" = _mY922tUc;
        "pkg-4.5" = _8As4zxSw;
        "pkg-4.5+mod" = _d9CfQKSP;
        "pkg-4.6" = _groUlEHm;
        "pkg-4.6+mod" = _lTZNiYef;
        "pkg-4.7" = _ScENglqN;
        "pkg-4.7-fabric" = _Lzn1ZFaJ;
        "pkg-4.7-forge" = _9GJTlWTc;
        "pkg-4.11" = _bdn1tA2U;
        "pkg-4.11-fabric" = _kGJo00iM;
        "pkg-4.11-quilt" = _NIiuXLbT;
        "pkg-4.11-forge" = _9FMZGGrz;
        "pkg-4.11-neoforge" = _iDXzHi7m;
        "pkg-4.12" = _xkJL8UNO;
        "pkg-4.12-fabric" = _KVqoJoHG;
        "pkg-4.12-quilt" = _NIcwRHxm;
        "pkg-4.12-forge" = _8kWuViDT;
        "pkg-4.12-neoforge" = _EkBzBVa2;
        "default" = _EkBzBVa2;
    });
