...
let
    ...
    in {
        ...
        "pkg-1.14" = _fbaUxdx3;
        "pkg-1.15" = _og4A1nN8;
        "pkg-1.21-1.6" = _g77ke7PC;
        "pkg-1.21-1.8" = _9fHBXiaj;
        "pkg-1.21-1.9" = _Q9L2TePN;
        "pkg-1.21-1.10" = _X2U8ceG9;
        "pkg-1.21.3-1.10" = _h47zwBfZ;
        "pkg-1.21.3-1.11" = _tgaRyAbD;
        "pkg-1.21.5-1.12" = _lQ3JGwIv;
        "pkg-1.21.10-1.12" = _WzvHpi86;
        "default" = _WzvHpi86;
    });
