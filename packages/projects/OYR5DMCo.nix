...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _9U8JSBrb;
        "pkg-1.2" = _lCtco0XK;
        "pkg-mc1.19.4-1.2.1" = _aclBuCQn;
        "pkg-mc1.19.2-1.2.1" = _VotI9dnZ;
        "pkg-mc1.20.1-1.2.1" = _qpEHqetx;
        "pkg-mc1.19.2-1.2.2" = _5lOB2toj;
        "pkg-mc1.19.4-1.2.2" = _O1kuXBz7;
        "pkg-mc1.20.1-1.2.2" = _cO6ujMWL;
        "pkg-mc1.19.2-1.2.3" = _3DKCQLtS;
        "pkg-mc1.19.4-1.2.3" = _MwFFEsZg;
        "pkg-mc1.20.1-1.2.3" = _goY8bX23;
        "pkg-1.2.4+mc1.20.2" = _MxX3k7M6;
        "pkg-1.2.4+mc1.19.4" = _NcCj7b4R;
        "pkg-1.2.4+mc1.19.2" = _g8YqXPnn;
        "pkg-1.2.5+mc1.19.2" = _a4ukNnhw;
        "pkg-1.2.5+mc1.19.4" = _yJ2ia06s;
        "pkg-1.2.5+mc1.20.1" = _KdQ0blAk;
        "pkg-1.2.5+mc1.20.2" = _Jm6fvwbi;
        "pkg-1.2.5+mc1.20.4" = _toBBe880;
        "pkg-1.2.5+mc1.20.6" = _L8i4U1Pg;
        "pkg-1.2.5+mc1.21.1" = _nhi2RkZ9;
        "default" = _nhi2RkZ9;
    });
