...
let
    ...
    in {
        ...
        "pkg-2.5.4" = _uzpgtm0g;
        "pkg-2.5.5" = _xZ5LnoXB;
        "pkg-1.0.0-1.19" = _tSm08PPY;
        "pkg-1.0.1-1.19" = _Ru7Yj8Bd;
        "pkg-2.5.6-1.18.2" = _aPLe6N4y;
        "pkg-3.0.0" = _XK2yFPi4;
        "pkg-1.1.3" = _kpw2Ptya;
        "pkg-1.2.0-1.19.2" = _cgosdcgZ;
        "pkg-1.2.2-1.19.2" = _oyues8jr;
        "pkg-1.2.3-1.19.2" = _k1MXiykY;
        "pkg-1.19.2-1.2.8" = _ZS0M41yV;
        "pkg-1.18.2-3.0.3" = _rcThWbSX;
        "pkg-1.19.2-1.2.9" = _EStZNFyM;
        "pkg-1.19.2-1.2.10" = _LQ2O7I0J;
        "pkg-1.20.1-2.0.0" = _nRi7GVCU;
        "pkg-1.20.1-2.0.1" = _f3ttCid9;
        "pkg-1.20.1-2.0.2" = _kgJdxf9D;
        "pkg-1.20.1-2.0.3" = _etC04DHn;
        "pkg-1.20.1-2.0.4" = _LyoS012u;
        "pkg-1.20.1-2.0.5" = _Fl2lADP9;
        "default" = _Fl2lADP9;
    });
