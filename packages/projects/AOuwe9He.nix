...
let
    ...
    in {
        ...
        "pkg-5.2.0" = _Iourggxi;
        "pkg-7.1.0" = _txo3bDnG;
        "pkg-6.3.0+fabric-1.21.1" = _8OjLoNTD;
        "pkg-6.3.0+neoforge-1.21.1" = _kJ2mywyR;
        "pkg-7.2.0+fabric-26.1.2" = _BGqJZGic;
        "pkg-7.2.0+neoforge-26.1.2" = _VRSTR4A8;
        "pkg-7.3.0+neoforge-26.1.2" = _9vlCrsxY;
        "pkg-7.3.0+fabric-26.1.2" = _GcqfCBr0;
        "pkg-5.3.0" = _np1e1272;
        "pkg-6.4.1+neoforge-1.21.1" = _dZHwwuLT;
        "pkg-6.4.1+fabric-1.21.1" = _ugk9t6rO;
        "pkg-7.3.1+fabric-26.1.2" = _D0qcGjwO;
        "pkg-7.3.1+neoforge-26.1.2" = _h4YyJgw1;
        "default" = _h4YyJgw1;
    });
