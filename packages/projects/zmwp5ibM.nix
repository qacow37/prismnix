...
let
    ...
    in {
        ...
        "pkg-4.3.2" = _V0WrVrMJ;
        "pkg-4.3.3" = _RnlTQR2x;
        "pkg-4.3.3.Folia" = _WmN28wgg;
        "pkg-4.3.3.Folia.R2" = _fqPkT054;
        "pkg-4.3.4" = _Y06HkTk6;
        "pkg-4.3.4.Folia" = _22fItuTF;
        "pkg-4.3.5" = _OW3yWsBH;
        "pkg-4.3.5.Folia" = _IrBMGOE2;
        "pkg-4.3.6" = _mbYHRVlJ;
        "pkg-4.3.6.Folia" = _DKeDQvUf;
        "pkg-4.3.7" = _es6hrw1N;
        "pkg-4.3.7.Folia" = _f9XVSOI2;
        "pkg-4.3.8" = _J33i19F2;
        "pkg-4.3.8.Folia" = _qoLigCHa;
        "pkg-4.3.9" = _9d32NM1Q;
        "pkg-4.3.9.Folia" = _xWjYA2m9;
        "pkg-4.4.0" = _wOKVPnIT;
        "pkg-4.4.0.Folia" = _JW4YvKbS;
        "pkg-4.4.1" = _WEErZ61i;
        "pkg-4.4.1.Folia" = _rwyHDX7e;
        "pkg-4.4.2" = _arB8fJny;
        "pkg-4.4.2.Folia" = _BXH6W9Ve;
        "pkg-4.4.3" = _4w2wHVSc;
        "pkg-4.4.3.Folia" = _yq0lcsuQ;
        "pkg-4.4.4" = _lecgItqo;
        "pkg-4.4.4.Folia" = _Qh3wxxI9;
        "pkg-4.4.5" = _S6557g28;
        "pkg-4.4.5.Folia" = _uRK90Txd;
        "pkg-4.4.6" = _3Z8GdDJn;
        "pkg-4.4.6.Folia" = _vF5owvRb;
        "pkg-4.4.7" = _GIdywGos;
        "pkg-4.4.7.Folia" = _MFRwFFO1;
        "pkg-4.4.8" = _VEuTRqsE;
        "pkg-4.4.8.Folia" = _VfVxf4SJ;
        "pkg-4.4.9" = _S4DOWTbZ;
        "pkg-4.4.9.Folia" = _Vo19KHPD;
        "pkg-4.5.0" = _AaH5ys8V;
        "pkg-4.5.0.Folia" = _YEjxMu3Y;
        "pkg-4.5.1" = _IfW6A5lP;
        "pkg-4.5.1.Folia" = _k6KPX8wk;
        "pkg-4.5.2" = _75fEXjm9;
        "pkg-4.5.2.Folia" = _sANUq70e;
        "pkg-4.5.3" = _GHPwU6zD;
        "pkg-4.5.3.Folia" = _HGWmsfVg;
        "pkg-4.5.4" = _szXAy6uK;
        "pkg-4.5.4.Folia" = _ZyCMdaaM;
        "pkg-4.5.5" = _Dla4o9cv;
        "pkg-4.5.5.Folia" = _yUdRkjrL;
        "pkg-4.5.6" = _zInIJzUg;
        "pkg-4.5.6.Folia" = _uUdtydc6;
        "pkg-4.5.7" = _GopADuWp;
        "pkg-4.5.7.Folia" = _NBNVwD01;
        "pkg-4.5.8" = _ZzDUwU8y;
        "pkg-4.5.8.Folia" = _IEAi6d4v;
        "pkg-4.5.9" = _QPXmj1X7;
        "pkg-4.5.9.Folia" = _DOSYPKfn;
        "pkg-4.6.0" = _PDGzWbJX;
        "pkg-4.6.0.Folia" = _M5OwL6LO;
        "pkg-4.6.1" = _Zq6GCzZo;
        "pkg-4.6.1.Folia" = _TJhaMesA;
        "pkg-4.6.2" = _hp2X1EHD;
        "pkg-4.6.2.Folia" = _RF9UTRpP;
        "pkg-4.6.3" = _9sKrPUTJ;
        "pkg-4.6.3.Folia" = _mD5hgG60;
        "pkg-4.6.5" = _g4Elj5mx;
        "pkg-4.6.5.Folia" = _Sqw0JApv;
        "pkg-4.6.6" = _UZpWO5VP;
        "pkg-4.6.6.Folia" = _JhU3OoSA;
        "pkg-4.6.7" = _dROu9s8P;
        "pkg-4.6.7.Folia" = _dBsmerQR;
        "pkg-4.6.8" = _BonwhtX9;
        "pkg-4.6.8.Folia" = _p0IH1cGH;
        "pkg-4.6.9" = _p7ABCmb8;
        "pkg-4.6.9.Folia" = _mU73qJu6;
        "pkg-4.7.0" = _pqeKwHlP;
        "pkg-4.7.0.Folia" = _gKYXBcXn;
        "pkg-4.7.1" = _AhSQQrHQ;
        "pkg-4.7.1.Folia" = _BLvBQQLV;
        "pkg-4.7.1.Folia.R2" = _tGe3OA1j;
        "pkg-4.7.1.Folia.R3" = _aMEaDWtl;
        "pkg-4.7.1.Folia.R4" = _DjSPX0VZ;
        "pkg-4.7.1.Folia.R5" = _jDJuO2hn;
        "pkg-4.7.2" = _2IEJ35J5;
        "pkg-4.7.3" = _wHHYM7p2;
        "pkg-4.7.4" = _EEnq0Ja2;
        "pkg-6.0.0-Alpha-Build-1" = _9ozgXia9;
        "pkg-6.0.0-Alpha-Build-3" = _x7nIst02;
        "pkg-6.0.0-Alpha-Build-4" = _fyeNcE8o;
        "pkg-6.0.0-Alpha-Build-14" = _SjeiLlf8;
        "default" = _SjeiLlf8;
    });
