...
let
    ...
    in {
        ...
        "pkg-1.2.0" = _DbBBnNIH;
        "pkg-1.2.1" = _GOif8mpV;
        "pkg-1.2.1.1" = _SOwI2gyR;
        "pkg-1.2.1.2" = _Dn9zHvBo;
        "pkg-1.2.1.3" = _mDUMdZjo;
        "pkg-1.2.1.4" = _lfkAmDkH;
        "pkg-1.3.0.1" = _9rPl6DJ4;
        "pkg-1.3.0.2" = _2zsCFGCe;
        "pkg-1.3.1" = _vnEudhry;
        "pkg-1.3.2" = _NHERrPje;
        "pkg-1.3.2.1" = _KY3nnmAp;
        "pkg-1.3.3" = _2cBCzJ58;
        "pkg-1.4" = _eyKtv7sv;
        "pkg-1.4.1" = _1eszi8gg;
        "pkg-1.4.2" = _JJVAnNC3;
        ...
        "pkg-1.5.0" = _vaJxhpu4;
        "pkg-1.5.1" = _VpskI4wt;
        "pkg-1.5.1.1" = _qJwrE9DW;
        "pkg-1.5.1.2" = _8VsScL3u;
        "pkg-1.5.2" = _Rl9ecSV1;
        "pkg-1.6.0" = _q8HATbgY;
        "pkg-1.6.0-1.19.3" = _yNZvu6OR;
        "default" = _yNZvu6OR;
    });
