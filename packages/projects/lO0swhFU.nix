...
let
    ...
    in {
        ...
        "pkg-1.0.2-1.20-0.0" = _PuksBwgp;
        "pkg-1.0.2-1.20.1-0.0" = _mA9ALYhn;
        "pkg-1.0.2-1.20.2-0.0" = _VJyV65Ud;
        "pkg-1.0.2-1.20.2-0.1" = _oPZvOtkG;
        "pkg-1.0.2-1.20.2-1.0" = _ep6q9gJ4;
        "pkg-1.0.2-1.20.4-0.0" = _DdwCxQSm;
        "pkg-1.0.2-1.20.6-0.0" = _p7dRdq1S;
        "pkg-1.0.2-1.21-0.0" = _Mo0WklXO;
        "pkg-1.0.2-1.21.1-0.0" = _zAjXmUzf;
        "pkg-1.0.2-1.21.3-0.0" = _nMczBctK;
        "pkg-1.0.2-1.21.4-0.0" = _i9hvsg23;
        "pkg-1.0.2-1.21.5-0.0" = _jAjULTiu;
        "pkg-1.0.2-1.21.6-0.0" = _kAuegYR3;
        "pkg-1.0.2-1.21.7-0.0" = _stcedPdm;
        "pkg-1.0.2-1.21.9-0.0" = _VmHyCaXW;
        "pkg-1.0.2-1.21.10-0.0" = _UKZdTG4H;
