...
let
    ...
    in {
        ...
        "pkg-spigot-1.0.1" = _on2h3VIY;
        "pkg-fabric-1.0.1-1.21.5" = _51JZJXRU;
        "pkg-fabric-1.0.1-1.21.7" = _gf6ZyIid;
        "pkg-fabric-2.0.0-1.21.4" = _4onGMoRp;
        "pkg-spigot-2.0.0" = _ncLC6m2O;
        "pkg-fabric-2.0.0-1.21.5" = _3d0CjjK3;
        "pkg-fabric-2.0.0-1.21.7" = _2yqE4t4B;
        "pkg-fabric-2.0.0-1.21.3" = _zDi57M65;
        "pkg-fabric-2.0.0-1.21.1" = _I3wxrAn8;
        "pkg-fabric-2.0.1-1.21.1" = _5OZMWekt;
        "pkg-fabric-2.0.1-1.21.3" = _OlA5y5ZT;
        "pkg-fabric-2.0.1-1.21.4" = _ToRP7Dys;
        "pkg-fabric-2.0.1-1.21.5" = _iXMsnjPu;
        "pkg-fabric-2.0.1-1.21.7" = _IBejiqWO;
        "pkg-spigot-2.0.1" = _2nUozcfH;
        "pkg-fabric-2.1.0-1.21.1" = _yTDAU420;
        "pkg-fabric-2.1.0-1.21.3" = _681WBlJR;
        "pkg-fabric-2.1.0-1.21.4" = _9W2JzCAG;
        "pkg-fabric-2.1.0-1.21.5" = _j6S3dTgU;
        "pkg-fabric-2.1.0-1.21.7" = _wx8gS3oh;
        "pkg-spigot-2.1.0" = _SpYJOJwi;
        "pkg-fabric-3.0.0-1.21.1" = _NINInpvn;
        "pkg-fabric-3.0.0-1.21.3" = _tyQdlAlo;
        "pkg-fabric-3.0.0-1.21.4" = _WeF9a4H1;
        "pkg-fabric-3.0.0-1.21.5" = _kLdAcWLR;
        "pkg-fabric-3.0.0-1.21.7" = _XHdWcr3m;
        "pkg-spigot-3.0.0" = _e0TpBejg;
        "pkg-velocity-3.0.0" = _joN42VDe;
        "pkg-fabric-4.0.0-1.21.1" = _yBXmZ3Ec;
        "pkg-fabric-4.0.0-1.21.3" = _I3mpQzbK;
        "pkg-fabric-4.0.0-1.21.4" = _VRyte0jb;
        "pkg-fabric-4.0.0-1.21.5" = _SVB35qfn;
        "pkg-fabric-4.0.0-1.21.7" = _fPf3jk1z;
        "pkg-spigot-4.0.0" = _vVhbOQXQ;
        "pkg-velocity-4.0.0" = _3toiA1rI;
        "pkg-fabric-4.1.0-1.21.1" = _icK0gE4O;
        "pkg-fabric-4.1.0-1.21.3" = _806sFKUf;
        "pkg-fabric-4.1.0-1.21.4" = _VoYPMOh1;
        "pkg-fabric-4.1.0-1.21.5" = _Y5BE0fyZ;
        "pkg-fabric-4.1.0-1.21.7" = _WVN04MQq;
        "pkg-paper-4.1.0" = _8LRd6kGx;
        "pkg-velocity-4.1.0" = _hjU7T3gM;
        "pkg-fabric-4.2.0-1.21.1" = _9jG8NJSI;
        "pkg-fabric-4.2.0-1.21.3" = _mJelBXP1;
        "pkg-fabric-4.2.0-1.21.4" = _hnflghO9;
        "pkg-fabric-4.2.0-1.21.5" = _GQ895ujq;
        "pkg-fabric-4.2.0-1.21.7" = _ehiVMGwk;
        "pkg-paper-4.2.0" = _Gf2C5QGe;
        "pkg-velocity-4.2.0" = _tBia2XUu;
        "pkg-neoforge-4.3.0-1.21.1" = _3IBSo53c;
        "pkg-fabric-4.3.0-1.21.1" = _6iokm0I9;
        "pkg-neoforge-4.3.0-1.21.3" = _jhon8BTS;
        "pkg-fabric-4.3.0-1.21.3" = _e5VRrE3y;
        "pkg-neoforge-4.3.0-1.21.4" = _3BCRXWER;
        "pkg-fabric-4.3.0-1.21.4" = _EgpE9ne2;
        "pkg-neoforge-4.3.0-1.21.5" = _sO8lDhOC;
        "pkg-fabric-4.3.0-1.21.5" = _XhUSzl8j;
        "pkg-neoforge-4.3.0-1.21.8" = _LACl0skY;
        "pkg-fabric-4.3.0-1.21.8" = _rOSQHwgU;
        "pkg-paper-4.3.0" = _i2mxqInx;
        "pkg-velocity-4.3.0" = _HMUacLey;
        "pkg-neoforge-4.4.0-1.21.1" = _MihABZCt;
        "pkg-fabric-4.4.0-1.21.1" = _lL0CheUt;
        "pkg-neoforge-4.4.0-1.21.3" = _XQ7YR7XV;
        "pkg-fabric-4.4.0-1.21.3" = _AP8pvmFm;
        "pkg-neoforge-4.4.0-1.21.4" = _CEv4bJAO;
        "pkg-fabric-4.4.0-1.21.4" = _nJHlNqis;
        "pkg-neoforge-4.4.0-1.21.5" = _eKbtN0is;
        "pkg-fabric-4.4.0-1.21.5" = _t5Zrkkjd;
        "pkg-neoforge-4.4.0-1.21.8" = _1QFkEUur;
        "pkg-fabric-4.4.0-1.21.8" = _kBAuG5X2;
        "pkg-paper-4.4.0" = _ytZ6pvYZ;
        "pkg-velocity-4.4.0" = _ZxWRZhre;
        "pkg-neoforge-4.4.0-1.21.9" = _Rp7amNv2;
        "pkg-fabric-4.4.0-1.21.9" = _a4O7z6DF;
        "pkg-neoforge-4.4.1-1.21.9" = _CIsp3iZo;
        "pkg-fabric-4.4.1-1.21.9" = _ziNwc506;
        "pkg-neoforge-4.4.1-1.21.11" = _OmSo0p4W;
        "pkg-fabric-4.4.1-1.21.11" = _dwjMzvJF;
        "pkg-neoforge-4.4.1-26.1.1" = _maNT0RF6;
