...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.4-fabric" = _WbHketBj;
        "pkg-1.18.2-1.4-fabric" = _ZN5ze6zu;
        "pkg-1.19.2-1.5-fabric" = _rTAN6cJr;
        "pkg-1.16.5-1.0-forge" = _LHJFjmyD;
        "pkg-1.18.2-1.1-forge" = _pPtPyw8Z;
        "pkg-1.19.2-1.3-forge" = _zbE21o1l;
        "pkg-1.16.5-1.6-fabric" = _x2vSZY2i;
        "pkg-1.18.2-1.6-fabric" = _KWO46CPl;
        "pkg-1.19.2-1.6-fabric" = _PU79XM2J;
        "pkg-1.16.5-1.6-forge" = _plukjRR1;
        "pkg-1.18.2-1.6-forge" = _e7wlCUT1;
        "pkg-1.19.2-1.6-forge" = _bDa4hVfY;
        "pkg-1.16.5-1.7-fabric" = _10UGQvXN;
        "pkg-1.18.2-1.7-fabric" = _GLnJndcP;
        "pkg-1.19.2-1.7-fabric" = _FczqDBJU;
        "pkg-1.19.3-1.8-fabric" = _Ikl8SXGC;
        "pkg-1.19.3-1.6-forge" = _p12Bo5Gk;
        "pkg-1.18.2-2.0-forge+fabric" = _1Nyh5swh;
        "pkg-1.19.2-2.0-forge+fabric" = _v3IldXnD;
        "pkg-1.19.3-2.0-forge+fabric" = _5OoFnRW1;
        "pkg-1.19.4-2.0-forge+fabric" = _RcmewfpT;
        "pkg-1.20-2.0-forge+fabric" = _X3jx4aSO;
        "pkg-1.20.1-2.0-forge+fabric" = _RofcbfwO;
        "pkg-1.20.2-2.0-forge+fabric" = _cAW3j1aO;
        "pkg-1.18.2-2.1-forge+fabric" = _xX3j5FMI;
        "pkg-1.19.2-2.1-forge+fabric" = _DHkKu8bZ;
        "pkg-1.20.1-2.1-forge+fabric" = _RWX92ZTF;
        "pkg-1.20.2-2.1-forge+fabric" = _DengqMwN;
        "pkg-1.20.3-2.1-fabric+forge+neo" = _hmp0AcaV;
        "pkg-1.20.4-2.1-fabric+forge+neo" = _U9d5vE1J;
        "pkg-1.19.2-2.2-fabric+forge+neo" = _CiuqKbEu;
        "pkg-1.20.1-2.2-fabric+forge+neo" = _MPAGNGUH;
        "pkg-1.20.2-2.2-fabric+forge+neo" = _1zWjPg3f;
        "pkg-1.20.4-2.2-fabric+forge+neo" = _NsdWQLIi;
        "pkg-1.20.5-2.2-fabric+neo" = _JzldmwyK;
        "pkg-1.20.6-2.2-fabric+forge+neo" = _BWGeCquU;
        "pkg-1.21.0-2.2-fabric+forge+neo" = _k2sXwx5O;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _Qn0k63lB;
        "pkg-1.20.6-2.3-fabric+forge+neo" = _mQv7K4UF;
        "pkg-1.21.0-2.3-fabric+forge+neo" = _Vt4blI06;
        "pkg-1.20.1-2.4-fabric+forge+neo" = _JW5Cb1yd;
        "pkg-1.20.6-2.4-fabric+forge+neo" = _y3SNBOh0;
        "pkg-1.21.0-2.4-fabric+forge+neo" = _54aKB91z;
        "pkg-1.21.1-2.4-fabric+forge+neo" = _tbfunHmy;
        "pkg-1.21.2-2.4-fabric+neo" = _CBglaxUz;
        "pkg-1.21.3-2.4-fabric+forge+neo" = _rYQo771V;
        "pkg-1.21.4-2.4-fabric+forge+neo" = _9zFOu4Uz;
        "pkg-1.20.1-2.5-fabric+forge+neo" = _WLWL44CC;
        "pkg-1.21.1-2.5-fabric+forge+neo" = _SR3aj6gK;
        "pkg-1.21.4-2.5-fabric+forge+neo" = _iZmJ5VJ2;
        "pkg-1.21.5-2.5-fabric+forge+neo" = _GXwpCwXu;
        "pkg-1.21.6-2.5-fabric+forge+neo" = _IqTrRIm8;
        "pkg-1.21.7-2.5-fabric+forge+neo" = _pcux4pbE;
        "pkg-1.21.8-2.5-fabric+forge+neo" = _rPwQcqQl;
        "pkg-1.21.9-2.5-fabric+forge+neo" = _ycqw01Fk;
        "pkg-1.21.10-2.5-fabric+forge+neo" = _hIXO1IfQ;
        "pkg-1.21.11-2.5-fabric+forge+neo" = _AIaTuwNx;
        "pkg-26.1.0-2.5-fabric+forge+neo" = _GdeRal9d;
        "pkg-26.1.1-2.5-fabric+forge+neo" = _ifRFWNk3;
        "pkg-26.1.2-2.5-fabric+forge+neo" = _cHclrwY8;
        "pkg-26.1.2-2.6-fabric+forge+neo" = _IABkM4c7;
        "pkg-26.2.0-2.6-fabric+forge+neo" = _dLdnCWjy;
        "default" = _dLdnCWjy;
    });
