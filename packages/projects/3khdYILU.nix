...
let
    ...
    in {
        ...
        "pkg-1.0_1.21.2-5" = _MYOxIYz0;
        "pkg-1.0_1.21-1" = _JsyXBSUG;
        "pkg-1.1_25w21a" = _qEvyhx4X;
        "pkg-1.1_1.21.5" = _14AkGw70;
        "pkg-1.1_1.21.1" = _s43eixXj;
        "pkg-1.1_1.20.6" = _QmzlNSm2;
        "pkg-1.1_1.20.4" = _s8zpu9Dq;
        "pkg-1.2_1.20.6" = _JYt3LcSt;
        "pkg-1.2_1.21.1" = _Bi4H3zsR;
        "pkg-1.2_1.21.5" = _HiYgLadz;
        "pkg-1.2_1.21.6-pre2" = _YtS6z1OX;
        "pkg-1.2_1.20.4" = _EZu6OrNd;
        "pkg-1.2_1.21.6" = _I91woIFz;
        "pkg-1.2_1.21.7" = _gLKmYFuw;
        "pkg-1.3_1.21.7" = _j3Ok69Jq;
        "pkg-1.3_1.21.1" = _IuH6hCmg;
        "pkg-1.3_1.20.6" = _yTnnQSfa;
        "pkg-1.3_1.21.8" = _OfSWbyCv;
        "pkg-1.3.1_1.21.8" = _gJnej4XR;
        "pkg-1.3.1_1.21.1" = _vE5gBo2R;
        "pkg-1.3.1_1.20.6" = _wOMq3nD9;
        "pkg-1.3.2" = _mUrZbHrN;
        "pkg-1.3.3" = _kfh8QF5q;
        "pkg-1.4.0" = _sxxiJubd;
        "pkg-2.0.0_fabric" = _sB0uc0Ug;
        "pkg-2.0.0_neoforge" = _ys4tQsXD;
        "pkg-2.0.1_neoforge" = _8hGp1d8f;
        "pkg-2.0.1_fabric" = _cKqr4lNS;
        "pkg-2.0.2_fabric" = _RtVMw22z;
        "pkg-2.0.2_neoforge" = _e98D1dsp;
        "pkg-3.0.0" = _ijSTNGSd;
        "pkg-3.1.0" = _a9v9HISf;
        "pkg-3.1.1" = _CvkQk796;
        "default" = _CvkQk796;
