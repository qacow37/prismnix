...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.9-forge" = _mCCsj2oj;
        "pkg-1.18.2-1.9-forge" = _UPmFZ3hf;
        "pkg-1.19.2-2.1-forge" = _i8a6TwRF;
        "pkg-1.16.5-2.4-fabric" = _SKeAZxLl;
        "pkg-1.18.2-2.4-fabric" = _ewcMOhWq;
        "pkg-1.19.2-2.4-fabric" = _uQ7RW57R;
        "pkg-1.19.3-2.5-fabric" = _QVSbrWwZ;
        "pkg-1.19.3-2.1-forge" = _ZmUfJ0Pv;
        "pkg-1.18.2-3.0-forge+fabric" = _6TxXcRJR;
        "pkg-1.19.2-3.0-forge+fabric" = _noffJQ5D;
        "pkg-1.19.3-3.0-forge+fabric" = _Ftj2NtJK;
        "pkg-1.18.2-3.1-forge+fabric" = _1hiClvyx;
        "pkg-1.19.2-3.1-forge+fabric" = _BItETo4J;
        "pkg-1.19.3-3.1-forge+fabric" = _qWyJPL6K;
        "pkg-1.18.2-3.2-forge+fabric" = _6aBNN8ml;
        "pkg-1.19.2-3.2-forge+fabric" = _eEu9YFif;
        "pkg-1.19.3-3.2-forge+fabric" = _yfpae46N;
        "pkg-1.19.4-3.2-forge+fabric" = _5p2qphkS;
        "pkg-1.20-3.2-forge+fabric" = _5di2eQ99;
        "pkg-1.20.1-3.2-forge+fabric" = _TDJ8Wip6;
        "pkg-1.20.2-3.2-forge+fabric" = _YcpFUUlb;
        "pkg-1.18.2-3.3-forge+fabric" = _RE27q4g9;
        "pkg-1.19.2-3.3-forge+fabric" = _A6tOGsnj;
        "pkg-1.20.1-3.3-forge+fabric" = _Xmv8V3av;
        "pkg-1.20.2-3.3-forge+fabric" = _nF4xirRG;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _uOqqcbig;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _bnRp3EsA;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _z25EtlhO;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _RB34pJ4M;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _B75sjRLE;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _Ex8VHeXk;
        "pkg-1.20.2-3.5-fabric+forge+neo" = _IfJ0uYk6;
        "pkg-1.20.4-3.5-fabric+forge+neo" = _EKKvLCgd;
        "pkg-1.20.5-3.5-fabric+neo" = _Q9yNVUMf;
        "pkg-1.20.5-3.6-fabric+neo" = _at5rLSXg;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _NJj3PtKC;
        "pkg-1.20.6-3.7-fabric+forge+neo" = _ntFwHRiF;
        "pkg-1.21.0-3.7-fabric+forge+neo" = _GvyJqK24;
        "pkg-1.20.1-3.8-fabric+forge+neo" = _KFMj3vTY;
        "pkg-1.20.6-3.8-fabric+forge+neo" = _afRozgAV;
        "pkg-1.21.0-3.8-fabric+forge+neo" = _qXdhNZQy;
        "pkg-1.21.1-3.8-fabric+forge+neo" = _AFJmSGsm;
        "pkg-1.21.2-3.8-fabric+neo" = _kl5tI8gI;
        "pkg-1.21.3-3.8-fabric+forge+neo" = _y3l29U8D;
        "pkg-1.21.4-3.8-fabric+forge+neo" = _zjSUzkdk;
        "pkg-1.20.1-3.9-fabric+forge+neo" = _i2Ttxldb;
        "pkg-1.21.1-3.9-fabric+forge+neo" = _L9aD3VMz;
        "pkg-1.21.4-3.9-fabric+forge+neo" = _IWJ6Pjsb;
        "pkg-1.20.1-4.0-fabric+forge+neo" = _Cw0gUxwP;
        "pkg-1.21.1-4.0-fabric+forge+neo" = _N61R1oET;
        "pkg-1.21.4-4.0-fabric+forge+neo" = _IlZbmlTP;
        "pkg-1.21.5-4.0-fabric+forge+neo" = _z1Bf38nz;
        "pkg-1.21.6-4.0-fabric+forge+neo" = _8BlzWlHU;
        "pkg-1.21.7-4.0-fabric+forge+neo" = _AV1veOa5;
        "pkg-1.21.8-4.0-fabric+forge+neo" = _x3xjg9hZ;
        "pkg-1.20.1-4.1-fabric+forge+neo" = _rAKOVi2T;
        "pkg-1.21.1-4.1-fabric+forge+neo" = _acGhsNYx;
        "pkg-1.21.8-4.1-fabric+forge+neo" = _WYaQFCb0;
        "pkg-1.21.9-4.1-fabric+forge+neo" = _zcGwnVea;
        "pkg-1.21.9-4.2-fabric+forge+neo" = _q5ynBPbD;
        "pkg-1.21.10-4.2-fabric+forge+neo" = _QmkU6nBe;
        "pkg-1.21.11-4.2-fabric+forge+neo" = _vS9TonWw;
        "pkg-26.1.0-4.2-fabric+forge+neo" = _6ymOLCxD;
        "pkg-26.1.0-4.3-fabric+forge+neo" = _V51cUoC2;
