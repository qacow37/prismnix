...
let
    ...
    in {
        ...
        "pkg-1.8" = _SNngfg89;
        "pkg-1.17.1-1.9-Forge" = _Q5CYqdcj;
        "pkg-1.17.1-1.11-Forge" = _hMMssXv8;
        "pkg-1.18-1.12-Forge" = _f6PT1IBN;
        "pkg-1.18-1.13-Forge" = _unE6DcJO;
        "pkg-1.18-1.14-Forge" = _Y5NWAKIW;
        "pkg-1.16.5-1.8.1-Forge" = _mEoPSLXl;
        "pkg-1.16.5-1.8.2-Forge" = _IajuUlnl;
        "pkg-1.19-1.15" = _KIObRjvQ;
        "pkg-1.19-1.16" = _tWC57b9X;
        "pkg-1.19-1.17" = _V8hrFmaR;
        "pkg-1.19-1.18" = _KiZUyAvu;
        "pkg-1.18-1.14.1-Forge" = _SIs4dNTn;
        "pkg-1.18-1.14.2-Forge" = _g7miqrw5;
        "pkg-1.19.3-2.0.0" = _DPmrCuIB;
        "pkg-1.19.4-2.1.0" = _tt4UpK36;
        "pkg-1.19.4-2.1.1" = _RljHCsum;
        "pkg-1.20-2.2.0" = _nt0dWFks;
        "pkg-1.19.2-1.18.1" = _OzJIGPw1;
        "pkg-1.19.4-2.1.2" = _oE762mcH;
        "pkg-1.20.1-2.2.1" = _mLJySGYJ;
        "pkg-1.20.2-2.3.0-Forge" = _5ZUaDllJ;
        "pkg-1.20.2-2.3.0-NeoForge" = _A3TIQDMU;
        "default" = _A3TIQDMU;
    });
