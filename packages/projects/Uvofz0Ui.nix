...
let
    ...
    in {
        ...
        "pkg-1.12.2-0.1.1" = _RkOCSwYo;
        "pkg-1.12.2-0.1.2" = _WQxHZYWM;
        "pkg-1.12.2-0.1.3" = _Fq8w5qF0;
        "pkg-1.12.2-1.0.0" = _uNjVLoHu;
        "pkg-1.12.2-1.1.0" = _oLwHectm;
        "pkg-1.12.2-1.1.1" = _vKTg6Ech;
        "pkg-1.16.5-2.0.0" = _Ja7GWp1v;
        "pkg-1.16.5-2.1.0" = _ly5aJVQy;
        "pkg-1.16.5-2.1.1" = _eujRCoPV;
        "pkg-1.16.5-2.2.0" = _BMlQBzr3;
        "pkg-1.16.5-2.2.1" = _ep9VCnSw;
        "pkg-1.12.2-1.2.0" = _3iEeNHU8;
        "pkg-1.16.5-2.3.0" = _zp5FSHb1;
        "pkg-1.16.5-2.3.1" = _cPcgMxmo;
        "pkg-1.16.5-2.3.2" = _DjXLTcQv;
        "pkg-1.16.5-2.3.3" = _ZYOt6GNP;
        "pkg-1.18.2-2.4.0" = _7Eg4pDHV;
        "pkg-1.18.2-3.0.0" = _QXo3xFB8;
        "pkg-1.19.2-3.0.0" = _wBjdnpoK;
        "pkg-1.20.1-3.0.0" = _dueesqfS;
        "pkg-1.20.1-3.0.1" = _GEFLtl8R;
        "pkg-1.20.1-3.1.0" = _uBiGrcf7;
        "pkg-1.19.2-3.1.0" = _S1DH6W52;
        "pkg-1.20.1-3.1.1" = _mo1TPvb0;
        "default" = _mo1TPvb0;
    });
