...
let
    ...
    in {
        ...
        "pkg-2+mod" = _AhJv7Vmd;
        "pkg-V2.1" = _MVz6CWLE;
        "pkg-V2.1+mod" = _ibp6wec8;
        "pkg-V2.2" = _fhOejvrA;
        "pkg-V2.2+mod" = _ALRd4mvw;
        "pkg-V2.3" = _vt36xHMO;
        "pkg-V2.3+mod" = _O0uAREyU;
        "pkg-V2.4" = _FmzHPxfp;
        "pkg-V2.4+mod" = _Br4bos2f;
        "pkg-V2.5" = _TMxcmX1d;
        "pkg-V2.5+mod" = _gpRlTlbn;
        "pkg-V2.6" = _dZP4ok8c;
        "pkg-V2.6+mod" = _oJyjM6d5;
        "pkg-V3" = _TarG2Syg;
        "pkg-V3+mod" = _lbAX2RcS;
        "pkg-3.1" = _Z2Uh50DP;
        "pkg-3.1+mod" = _bihcKxdq;
        "pkg-3.2" = _5wO0Dv8L;
        "pkg-3.3" = _3UZjYaf7;
        "pkg-3.3+mod" = _Ic9uK9mO;
        "pkg-3.3.1" = _aBgCDp21;
        "pkg-3.3.1+mod" = _hisDQNFU;
        "pkg-3.4" = _mod9AohL;
        "pkg-3.4+mod" = _kUkd00ca;
        "pkg-3.4.1" = _SqzuEjSZ;
        "pkg-3.4.1+mod" = _aPObcDGW;
        "pkg-3.4.2" = _A3Vrg3mN;
        "pkg-3.4.2+mod" = _7YfxfqAR;
        "pkg-3.4.3" = _t7SylcX4;
        "pkg-3.4.3+mod" = _qCd3h4FF;
        "pkg-3.5" = _taVn4W2W;
        "pkg-3.5+mod" = _cAvFHJWe;
        "default" = _cAvFHJWe;
    });
