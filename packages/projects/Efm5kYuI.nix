...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _rxtGubFn;
        "pkg-1.1.1+mod" = _keOvXzSZ;
        "pkg-1.2.0" = _JXD0fqUM;
        "pkg-1.2.0+mod" = _5GqnZkfe;
        "pkg-1.2.1" = _uQxfDU1h;
        "pkg-1.2.1+mod" = _UZLyYFBX;
        "pkg-1.2.2" = _GgXlBLfF;
        "pkg-1.2.2+mod" = _JkyY4JIC;
        "pkg-v1.2.3" = _jNikorHP;
        "pkg-v1.2.3+mod" = _XLs9M2s4;
        "pkg-1.3.0" = _dz9qmZpL;
        "pkg-1.3.0+mod" = _Mp9rtC91;
        "pkg-1.3.1" = _quIKPzj4;
        "pkg-1.3.1+mod" = _kIosb5S7;
        "pkg-1.3.2" = _3U6RSN7R;
        "pkg-1.3.2+mod" = _yV8IlDuL;
        "pkg-1.4.0" = _bHA23sGy;
        "pkg-1.4.0+mod" = _puROiV5O;
        "pkg-2.0.0" = _lKku9EV8;
        "pkg-2.0.0+mod" = _Zm1zpnw2;
        "pkg-1.4.1" = _qP2qrOoe;
        "pkg-1.4.1+mod" = _C7zsRP3X;
        "pkg-1.19" = _S9GWuTZk;
        "pkg-1.19+mod" = _Wln7ccpI;
        "pkg-2.0.1" = _s0MiNIzt;
        "pkg-2.0.1+mod" = _KOYfhah3;
        "default" = _KOYfhah3;
    });
