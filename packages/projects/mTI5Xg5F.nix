...
let
    ...
    in {
        ...
        "pkg-0.0.12+1.19.2" = _x6yf3o0b;
        "pkg-0.1.0+1.19.3" = _DLfsjYes;
        "pkg-0.1.1+1.19.3" = _r3vz8SNL;
        "pkg-0.2.0+1.19.4" = _SveqHFmX;
        "pkg-0.3.0+1.20.0" = _G7vtT8Ru;
        "pkg-0.4.0+1.20.1" = _aH9CXeKg;
        "pkg-0.5.0+1.20.1" = _rrvUhwSa;
        "pkg-0.5.1+1.20.1" = _wDNF3oGO;
        "pkg-0.6.0+1.20.2" = _pSqTxqtG;
        "pkg-0.7.0+1.20.4" = _msBAt80E;
        "pkg-0.8.0+1.20.5" = _FMYez6oi;
        "pkg-0.8.1+1.20.5" = _1GYSAlwD;
        "pkg-0.9.0+1.21" = _PxitWnqK;
        "pkg-0.9.1+1.21" = _5FmPmoLq;
        "pkg-0.8.2+1.20.5" = _tDqzxa3i;
        "pkg-0.8.3+1.20.6" = _uedaUGf4;
        "pkg-0.8.4+1.20.6" = _F3pWGFs5;
        "pkg-0.9.2+1.21" = _C2IrKlLx;
        "pkg-0.8.5+1.20.6" = _ZBq1jAco;
        "pkg-0.9.3+1.21" = _NLOgT4oI;
        "pkg-0.10.0+1.21.1" = _1CRSUOqi;
        "pkg-0.12.1+1.21.3" = _tIRveZmx;
        "pkg-0.13.0+1.21.4" = _O6JhzerY;
        "pkg-0.13.1+1.21.4" = _rPq4d4Oo;
        "pkg-0.13.2+1.21.4" = _tw9ek3tg;
        "pkg-0.14.0+1.21.5" = _9bVYsMZE;
        "pkg-0.14.1+1.21.5" = _Q23x8pXp;
        "pkg-0.15.0+1.21.6" = _pVWO3Xw2;
        "pkg-0.16.0+1.21.7" = _gbpWRc1W;
        "pkg-0.16.1+1.21.7" = _K67lWpKb;
        "pkg-0.17.0+1.21.8" = _jvolXqW4;
        "pkg-0.18.0+1.21.9" = _SbTURIsE;
        "pkg-0.19.0+1.21.10" = _SXOTDMsc;
        "pkg-0.20.0+1.21.11" = _2dPnMl2h;
        "pkg-0.20.1+1.21.11" = _K7zjFItZ;
        "pkg-0.20.2+1.21.11" = _G8BtMnVq;
        "pkg-0.20.3+1.21.11" = _5OePHk1C;
        "pkg-0.20.4+1.21.11" = _cORzzHkm;
        "pkg-0.21.0+26.1" = _YxcG69ec;
