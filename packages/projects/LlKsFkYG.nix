...
let
    ...
    in {
        ...
        "pkg-1+mod" = _hRizZbSS;
        "pkg-1.1" = _IkffhVg8;
        "pkg-1.1+mod" = _4tQN0YHR;
        "pkg-1.2" = _lIJaiTLY;
        "pkg-1.2+mod" = _oQ0rjPgu;
        "pkg-1.3" = _OeKZ7GLp;
        "pkg-1.3+mod" = _Bh8ZZxOy;
        "pkg-1.4" = _TwieYIBO;
        "pkg-1.4+mod" = _8nAmyZES;
        "pkg-1.4.1" = _GWJqhW9o;
        "pkg-1.4.1+mod" = _vojWXAVJ;
        "pkg-1.4.2" = _kJY1K97F;
        "pkg-1.4.2+mod" = _oSTTFlDX;
        "pkg-1.4.3" = _Ih8ueDF9;
        "pkg-1.4.3+mod" = _kSGr7U5f;
        "pkg-1.1.4" = _GZ8C4SKE;
        "pkg-1.1.4+mod" = _ugeNw5xd;
        "pkg-1.5-1.20.x" = _v0UzXqjV;
        "pkg-1.5-1.20.x+mod" = _j1PiPF7A;
        "pkg-1.5" = _tnLou5r2;
        "pkg-1.5+mod" = _ePEEQF1m;
        "pkg-1.5.1-1.20.x" = _TRJY3JyR;
        "pkg-1.5.1-1.20.x+mod" = _cAjZ73oL;
        "pkg-1.5.1" = _fysKw8Wi;
        "pkg-1.5.1+mod" = _8IMFQMkJ;
        "pkg-1.6" = _uAFGUdlA;
        "pkg-1.6+mod" = _QNeWD1ry;
        "pkg-1.6.2" = _K7AIHFfz;
        "pkg-1.6.2+mod" = _nYzptTka;
        "pkg-2.0.1" = _l8nrMkwU;
        "pkg-2.0.1+mod" = _3ot9gWGo;
        "pkg-1.6.3" = _st30sQ8z;
        "pkg-1.6.3+mod" = _BQu5uXKT;
        "pkg-2.0.2" = _Gywk53dW;
