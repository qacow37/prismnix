...
let
    ...
    in {
        ...
        "pkg-0.1-1.19.2" = _DAd7fuHc;
        "pkg-0.1.1-1.19.2" = _nFm9DvPU;
        "pkg-0.2-1.19.2" = _mRWcb4D7;
        "pkg-0.2-1.18.2" = _H9SGtvsq;
        "pkg-0.2-1.20.1" = _toxBq4RM;
        "pkg-0.2.1-1.19.2" = _rtYizmrq;
        "pkg-0.2.1-1.20.1" = _NKb52oTL;
        "pkg-0.2.1-1.18.2" = _WT9aQXHd;
        "pkg-0.3-1.20.1" = _u8KWSZAy;
        "pkg-0.3-1.18.2" = _clW8eT4Z;
        "pkg-0.3-1.19.2" = _iw9WkWgd;
        "pkg-0.4-1.20.1" = _RmEf2PTl;
        "pkg-0.4-1.19.2" = _HcvztKIr;
        "pkg-0.4-1.18.2" = _Ns9I7QqT;
        "pkg-0.5-1.20.1" = _UNl3jhQt;
        "pkg-0.5-1.19.2" = _Jsag7ysw;
        "pkg-0.5-1.18.2" = _qdqIAoWp;
        "pkg-0.6-1.20.1" = _3VWGbMPc;
        "pkg-0.6-1.19.2" = _rIKAS6ZC;
        "pkg-0.6-1.18.2" = _jygNT8lv;
        "pkg-0.7-1.20.1" = _yO39is8J;
        "pkg-0.7-1.19.2" = _PLDVwD6P;
        "pkg-0.7-1.18.2" = _q5fIXRIJ;
        "pkg-0.8-1.20.1" = _BaXCKCsy;
        "pkg-0.8-1.19.2" = _L61TmICK;
        "pkg-0.8-1.18.2" = _M1BxWg9r;
        "pkg-0.9-1.20.1" = _dPU2YGI4;
        "pkg-0.9-1.18.2" = _B0fJslpY;
        "pkg-0.9-1.19.2" = _YADX1yVP;
        "default" = _YADX1yVP;
    });
