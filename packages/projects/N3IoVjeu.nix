...
let
    ...
    in {
        ...
        "pkg-0.0.8" = _CQU4lqVZ;
        "pkg-0.0.9" = _5aqxa9RM;
        "pkg-0.0.10" = _PSgqZ2c5;
        "pkg-0.0.11" = _g69djCwe;
        "pkg-0.0.12" = _IXP38ImM;
        "pkg-0.0.13" = _IgMrOZt9;
        "pkg-0.0.14" = _AT57ObL1;
        "pkg-0.0.15" = _9XZa4jSd;
        "pkg-0.0.16" = _daRgBbZF;
        "pkg-0.0.17" = _MFiduA8n;
        "pkg-0.0.18" = _T0gLBGRb;
        "pkg-0.0.19" = _5QLDfFFY;
        "pkg-0.0.20" = _e8L6JwCS;
        "pkg-0.0.21" = _MDMGdT6N;
        "pkg-0.0.22" = _4cpyZkyX;
        "pkg-0.0.23" = _d70TCKyA;
        "pkg-0.0.24" = _s0i2iXDu;
        "pkg-0.0.25" = _va8dt4pR;
        "pkg-0.0.26" = _AKOg6OVf;
        "pkg-0.0.27" = _6DX31Jbe;
        "pkg-0.0.28" = _wtbMhdMD;
        "pkg-0.0.29" = _FHbL6XLI;
        "pkg-0.0.29+25w33a" = _WZlFga09;
        "pkg-0.0.30+25w33a" = _3iDVoMp7;
        "pkg-0.0.30+25w34b" = _q8t4cWOS;
        "pkg-0.0.30+25w35a" = _o4cE3yHD;
        "pkg-0.0.31+25w36b" = _6oJqFQYx;
        "pkg-0.0.32+25w37a" = _lspFvbfU;
        "pkg-0.0.33+1.21.9-pre1" = _6MQ09g8u;
        "pkg-0.0.33+1.21.9-pre2" = _fQ5te2Cf;
        "pkg-0.0.34+1.21.9-pre2" = _ggaF7nQQ;
        "pkg-0.0.35+1.21.9-rc1" = _DtIRlZZG;
        "pkg-0.0.35+1.21.9" = _fTgQXlxq;
        "pkg-0.0.36+1.21.9" = _dviFPxq7;
        "pkg-0.0.37+1.21.10" = _rzX9W90y;
        "pkg-0.0.37+25w41a" = _mFkcfJyv;
        "pkg-0.0.38+1.21.10" = _VPZz5Op6;
        "pkg-0.0.38+25w42a" = _uuVYLpW1;
        "pkg-0.0.39+1.21.10" = _JErus7xW;
        "pkg-0.0.39+25w43a" = _ygZyv6LO;
        "pkg-0.0.39+25w44a" = _RaQDkpFZ;
        "pkg-0.0.40+1.21.11" = _ug0imf2E;
        "pkg-0.0.40+26.1-snapshot-1" = _beIAKqrh;
        "pkg-0.0.40+26.1-snapshot-6" = _2TTXIayZ;
        "pkg-0.0.40+26.1-snapshot-7" = _lK6VTOPy;
        "pkg-0.0.40+26.1-snapshot-8" = _R668h1gR;
        "pkg-0.0.40+26.1-snapshot-10" = _uBC3Vd5z;
        "pkg-0.0.40+26.1-snapshot-11" = _LYke9QX7;
        "pkg-0.0.40+26.1-pre-2" = _vlj0VVF8;
        "pkg-0.0.40+26.1" = _vgaHXxrb;
        "pkg-0.0.40+26w14a" = _FgYQ8Ops;
        "pkg-0.0.40+26.1.2" = _2TgLeFb7;
        "pkg-0.0.40+26.2" = _ECSpljnC;
        "default" = _ECSpljnC;
    });
