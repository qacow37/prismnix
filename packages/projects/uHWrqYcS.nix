...
let
    ...
    in {
        ...
        "pkg-v5.0.0-1.19.3-Forge" = _j1cpJGIi;
        "pkg-v6.0.0-1.19.4-Forge" = _VvBPH9yY;
        "pkg-v6.0.0-1.19.4-Fabric" = _Uziybstk;
        "pkg-v6.0.1-1.19.4-Fabric" = _WkG6K7nP;
        "pkg-v6.0.1-1.19.4-Forge" = _8TFP8LUx;
        "pkg-v7.0.0-1.20-Forge" = _lV33nKe0;
        "pkg-v7.0.0-1.20-Fabric" = _3qSXcZzU;
        "pkg-v8.0.0-1.20.1-Forge" = _2JOvT1po;
        "pkg-v8.0.0-1.20.1-Fabric" = _xBwcZR5q;
        "pkg-v3.0.0-1.18.2-Forge" = _2m8bkDRb;
        "pkg-v3.0.0-1.18.2-Fabric" = _xnzcgA5P;
        "pkg-v8.0.1-1.20.1-Forge" = _kVfMYM11;
        "pkg-v8.0.1-1.20.1-Fabric" = _tnEJwEuy;
        "pkg-v20.4.0-1.20.4-Fabric" = _410H7S6D;
        "pkg-v20.4.0-1.20.4-NeoForge" = _MJxhY7W2;
        "pkg-v20.4.0-1.20.4-Forge" = _Ng4W9oFE;
        "pkg-v20.4.1-1.20.4-Fabric" = _tCnDE0Nk;
        "pkg-v20.4.1-1.20.4-Forge" = _Z9frO6wI;
        "pkg-v20.4.1-1.20.4-NeoForge" = _SHDyZWzP;
        "pkg-v20.4.2-1.20.4-Fabric" = _teUfboP6;
        "pkg-v20.4.2-1.20.4-Forge" = _hTzbDx1u;
        "pkg-v20.4.2-1.20.4-NeoForge" = _Yrhc5WNJ;
        "pkg-v21.0.0-1.21-Fabric" = _1vgJDau0;
        "pkg-v21.0.0-1.21-NeoForge" = _dSJ8cTtF;
        "pkg-v21.1.0-1.21.1-Fabric" = _Th1NMMIZ;
        "pkg-v21.1.0-1.21.1-NeoForge" = _nLff2PaZ;
        "pkg-v21.3.0-1.21.3-Fabric" = _o23jGEEf;
        "pkg-v21.3.0-1.21.3-NeoForge" = _pcYm8Wa7;
        "pkg-v21.4.0-1.21.4-Fabric" = _2m8LIprz;
        "pkg-v21.4.0-1.21.4-NeoForge" = _29nMRcIP;
        "pkg-v21.5.0-1.21.5-Fabric" = _K51nFPh2;
        "pkg-v21.5.0-1.21.5-NeoForge" = _QkWTVWeL;
        "pkg-v21.6.0-1.21.6-Fabric" = _fk8lE31N;
        "pkg-v21.6.0-1.21.6-NeoForge" = _bVvq1XRD;
        "pkg-v21.7.0-1.21.7-Fabric" = _hnQC1nw3;
        "pkg-v21.7.0-1.21.7-NeoForge" = _fcIssDhd;
        "pkg-v21.8.0-1.21.8-Fabric" = _DdMaytLK;
        "pkg-v21.8.0-1.21.8-NeoForge" = _fS9QpAGr;
        "pkg-21.9.0" = _AX73XMyg;
        "pkg-21.10.0" = _fCpxTh1H;
        "pkg-21.11.0" = _BBsEHKRf;
