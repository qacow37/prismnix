...
let
    ...
    in {
        ...
        "pkg-0.1-1.20.1" = _G8B7Q7Kb;
        "pkg-0.2-1.20.1" = _jfmKBGvW;
        "pkg-0.1.0-1.20.2" = _gtBYyaEu;
        "pkg-0.1.0-1.20.3" = _UVtx0PAP;
        "pkg-0.1.0-1.20.4" = _AQG3MJRG;
        "pkg-0.1.0-1.20.6" = _CAxPlSU1;
        "pkg-1.21.0-0.1.0" = _mq6fY29x;
        "pkg-1.21.1-0.1.0" = _4YawLlCt;
        "pkg-1.20.2-1.0.0" = _dK8qycNc;
        "pkg-1.20.4-1.0.0" = _S84Qrehk;
        "pkg-1.20.6-1.0.0" = _4qLFzyvQ;
        "pkg-1.20.6-1.1.0" = _J8OGRB7v;
        "pkg-1.21.0-1.1.0" = _f550MWAm;
        "pkg-1.21.1-1.1.0" = _smsFQqjr;
        "pkg-1.21-1.1.0" = _KMsX6qFW;
        "pkg-1.20.1-1.3.0" = _ngRbHCxf;
        "pkg-1.20.2-1.3.0" = _5YRA4nq6;
        "pkg-1.20.3-1.3.0" = _3MlSRPKd;
        "pkg-1.20.4-1.3.0" = _L38vYcJ3;
        "pkg-1.20.6-1.3.0" = _WLPoz4OL;
        "pkg-1.21.0-1.3.0" = _oGRIzBgs;
        "pkg-1.21.1-1.3.0" = _g8vPa9fy;
        "pkg-1.21-1.3.0" = _79fxx7Ro;
        "pkg-1.21.3-1.3.0" = _KwPnFfJf;
        "pkg-1.21.4-1.3.0" = _aa71afiY;
        "pkg-1.21.3-1.3.1" = _sNLdQbke;
        "pkg-1.21.4-1.3.1" = _WPULIIGE;
        "default" = _WPULIIGE;
    });
