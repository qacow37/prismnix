...
let
    ...
    in {
        ...
        "pkg-1.0.4" = _YhYUT05M;
        "pkg-2.0.0" = _VsT19VlF;
        "pkg-3.0.0+1.20.6-fabric" = _b803K3eO;
        "pkg-3.0.0+1.20.4-fabric" = _trIHuK4f;
        "pkg-3.0.0+1.20.1-fabric" = _E0pteCOu;
        "pkg-3.0.0+1.21.1-fabric" = _61Rvt5Ug;
        "pkg-3.0.0+1.21.10-fabric" = _MKWKoVF3;
        "pkg-3.0.0+1.20.4-neoforge" = _6wzYJ9EV;
        "pkg-3.0.0+1.21.1-neoforge" = _aGFwlqlB;
        "pkg-3.0.0+1.20.6-neoforge" = _uuPL90O6;
        "pkg-3.0.0+1.21.11-fabric" = _dAQmVPxW;
        "pkg-3.0.0+1.21.4-fabric" = _FdsSwOfm;
        "pkg-3.0.0+1.21.6-fabric" = _xLsuw1O5;
        "pkg-3.0.0+1.21.4-neoforge" = _6AwIV2CX;
        "pkg-3.0.0+1.21.6-neoforge" = _O0cPIwNA;
        "pkg-3.0.0+1.21.8-neoforge" = _Zt2tiYMu;
        "pkg-3.0.0+1.21.9-neoforge" = _cLS8lOSn;
        "pkg-3.0.0+1.21.10-neoforge" = _kiWQzNYX;
        "pkg-3.0.0+1.21.11-neoforge" = _lAPv4fUn;
        "default" = _lAPv4fUn;
    });
