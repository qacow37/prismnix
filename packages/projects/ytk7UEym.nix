...
let
    ...
    in {
        ...
        "pkg-0.2.5" = _Xz0Kwb81;
        "pkg-0.2.6" = _yurtgVY3;
        "pkg-0.2.6a" = _tcsLd9Z8;
        "pkg-0.2.4" = _zN72Oi6u;
        "pkg-0.2.7" = _5BfSY6Nz;
        "pkg-0.2.8" = _fgkRcQc2;
        "pkg-0.2.9" = _m7tzAwNB;
        "pkg-0.3.0-pre.1" = _u5QClTGY;
        "pkg-0.2.9-pre.1" = _vDlLDzSk;
        "pkg-0.2.10-pre.1" = _CVl4ZS3w;
        "pkg-0.2.11" = _pUDJ1DxP;
        "pkg-0.3.0-pre.2" = _WDhdep5O;
        "pkg-0.3.0-pre.3" = _CIXGXpX4;
        "pkg-0.3.0" = _9W5fphzK;
        "pkg-0.4.0" = _kAhd7Q81;
        "pkg-0.5.0" = _dTk48KDf;
        "pkg-0.5.1" = _xIRtzzMM;
        ...
        "pkg-0.5.6" = _l0l54yZE;
        "pkg-0.6.0" = _WCxbOL6z;
        "pkg-0.6.1-dev.20180529.182246" = _WwQyqgmM;
        "pkg-0.6.1-dev.20180803.030718" = _Bw9EqHwA;
        "pkg-0.6.1-dev.20180803.164859" = _aU7RdZEE;
        "pkg-0.6.1-dev.20181002.170316" = _UsUIUzOw;
        "pkg-0.6.2" = _UDuIQu9q;
        "pkg-0.6.3" = _TVdh19db;
        "pkg-0.7.0-dev.20181107.012547" = _PpClL2Pu;
        "pkg-0.7.0-dev.20181108.025215" = _7wvItkzv;
        "pkg-0.7.0-dev.20181219.233102" = _FiETAneN;
        "pkg-0.7.0-dev.20181221.003547" = _TzpFVyDx;
        "pkg-0.7.0-dev.20190108.170040" = _lskFFnQb;
        "pkg-0.7.0-dev.20190219.145540" = _5f05MwL7;
        "pkg-0.7.0-dev.20190422.231529" = _GkgpHuAc;
        "pkg-0.7.0-dev.20190610.165828" = _Nycvwit9;
        "pkg-0.7.0-dev.20190813.134204" = _ceneNP0l;
        "pkg-0.7.0-dev.20190926.165034" = _pQVPUL0t;
        "pkg-0.7.0-dev.20190926.172157" = _Z0RVfAnW;
        "pkg-0.7.0-dev.20200919.184303" = _gIfenVD4;
        "pkg-0.7.0" = _LoHReUxf;
        "pkg-0.7.1" = _nyUcNHV3;
        "pkg-0.8.0" = _QE9x2L23;
        "pkg-0.8.1" = _L1JtysAT;
        "pkg-0.8.1-beta.1" = _kvcqHQ5h;
        "pkg-0.8.0-beta.1" = _HtNb4Qhf;
        "pkg-0.9.0-alpha.1" = _SRkO8q02;
        "pkg-0.9.0" = _sPUFKAlp;
        "pkg-0.9.1-beta.1" = _ksLhU2Ww;
        "pkg-0.9.1" = _NiY53paO;
        "pkg-0.9.2+pre.1" = _Hp76wpaQ;
        "pkg-0.9.2" = _oxMy5sXi;
        "pkg-0.10.0" = _hm8JFu3z;
        "pkg-0.10.1" = _EtYbJv9D;
        "pkg-0.9.0-beta.1" = _6GKF7Cun;
        "pkg-0.9.1-pre.1" = _6s2bysgn;
        "pkg-0.9.1-pre.3" = _JW6RmjDB;
        "default" = _NiY53paO;
    });
