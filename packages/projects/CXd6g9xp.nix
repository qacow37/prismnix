...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18.2" = _Mjqr8P1i;
        "pkg-2.0.0+1.19.4" = _QXqhBqaH;
        "pkg-3.0.0+1.20.1" = _dZKz6Oow;
        "pkg-2.1.0+1.19.2" = _7K79CFL9;
        "pkg-3.1.0+1.20.2" = _6Hyt9EIK;
        "pkg-3.1.1+1.20.2" = _ohDWd4Lm;
        "pkg-3.0.1+1.20.1" = _PIoiJham;
        "pkg-2.1.1+1.19.2" = _aWeqfdnN;
        "pkg-2.0.1+1.19.4" = _cO60U6Ef;
        "pkg-1.0.1+1.18.2" = _k3RfelII;
        "pkg-3.3.0+1.20.4" = _stnZrgIW;
        "pkg-3.0.2+1.20.1" = _5NDrRgY4;
        "pkg-3.3.1+1.20.4" = _Y1j40ssQ;
        "pkg-3.4.0+1.20.6" = _khbCiVNL;
        "pkg-3.4.1+1.20.6" = _kYdyr9S8;
        "pkg-20.1.3" = _rdFxc9mZ;
        "pkg-20.6.2" = _B80EWWTW;
        "pkg-21.0.0" = _AgTmOzak;
        "pkg-21.0.1" = _IKj3ACvS;
        "pkg-21.1.0" = _f3cUjClz;
        "pkg-21.4.0" = _DJeVPai9;
        "pkg-21.5.0" = _lKoHqpa3;
        "pkg-21.1.0-hotfix" = _v1HFEOEH;
        "pkg-21.4.0-hotfix" = _uhHnOuGk;
        "pkg-21.5.0-hotfix" = _3m2p6WNZ;
        "pkg-20.1.4" = _6x7dCeu7;
        "pkg-20.1.4-hotfix" = _ErJeSdkr;
        "pkg-20.1.5-beta" = _sH3u4ru2;
        "pkg-21.1.1-beta" = _vDCbKDXw;
        "pkg-21.5.1-beta" = _osXPm8Ah;
        "pkg-21.8.0-beta" = _jZy1L1iz;
        "pkg-20.1.5" = _zyBJRh6a;
        "pkg-21.1.1" = _i6VELfmL;
        "pkg-21.5.1" = _F9jjJaJq;
        "pkg-21.8.0" = _v7MkWgFK;
        "pkg-21.11.0" = _1fnYZ4ht;
        "default" = _1fnYZ4ht;
    });
