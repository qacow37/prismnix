...
let
    ...
    in {
        ...
        "pkg-v4.1.0-1.19.1-Forge" = _kPeZYwNn;
        "pkg-v4.2.0-1.19.2-Forge" = _3F859u9l;
        "pkg-v4.2.0-1.19.2-Fabric" = _Q6BIFIhD;
        "pkg-v4.2.1-1.19.2-Forge" = _MICfoGBS;
        "pkg-v4.2.1-1.19.2-Fabric" = _ogYtTORO;
        "pkg-v4.2.2-1.19.2-Fabric" = _EK2RgQAY;
        "pkg-v4.2.2-1.19.2-Forge" = _LGxUbZZV;
        "pkg-v4.2.3-1.19.2-Forge" = _1SwrSaIR;
        "pkg-v4.2.3-1.19.2-Fabric" = _ZWnVUzlF;
        "pkg-v4.2.4-1.19.2-Fabric" = _xaPfqdbB;
        "pkg-v4.2.4-1.19.2-Forge" = _vqctzfrm;
        "pkg-v5.0.0-1.19.3-Fabric" = _svMh4VMl;
        "pkg-v5.0.0-1.19.3-Forge" = _lb3SU1xk;
        "pkg-v5.0.1-1.19.3-Fabric" = _UGpm4kAl;
        "pkg-v5.0.1-1.19.3-Forge" = _322BuMoK;
        "pkg-v6.0.0-1.19.4-Fabric" = _jgOsSWgP;
        "pkg-v6.0.0-1.19.4-Forge" = _1vOxb2Th;
        "pkg-v7.0.0-1.20-Forge" = _m5jzxKYS;
        "pkg-v7.0.0-1.20-Fabric" = _5ksHbo4w;
        "pkg-v8.0.0-1.20.1-Forge" = _LojgSWbd;
        "pkg-v8.0.0-1.20.1-Fabric" = _sdb70E1E;
        "pkg-v20.4.0-1.20.4-Fabric" = _ODJWXqEh;
        "pkg-v20.4.0-1.20.4-NeoForge" = _Ak0C03LL;
        "pkg-v20.4.0-1.20.4-Forge" = _r6MTc12j;
        "pkg-v20.4.1-1.20.4-Fabric" = _h2OTPrvy;
        "pkg-v20.4.1-1.20.4-Forge" = _Q47XfKKb;
        "pkg-v20.4.1-1.20.4-NeoForge" = _bpAsqFz2;
        "pkg-v20.4.2-1.20.4-Fabric" = _sr2lCWRH;
        "pkg-v20.4.2-1.20.4-Forge" = _oAogpttV;
        "pkg-v20.4.2-1.20.4-NeoForge" = _uB8u1Rxd;
        "pkg-v21.0.0-1.21-Fabric" = _P0E7PbKn;
        "pkg-v21.0.0-1.21-NeoForge" = _ZUi1BvRl;
        "pkg-v21.1.0-1.21.1-Fabric" = _1g84Wd50;
        "pkg-v21.1.0-1.21.1-NeoForge" = _xbbkxKdT;
        "pkg-v21.3.0-1.21.3-Fabric" = _B6wdQ9A4;
        "pkg-v21.3.0-1.21.3-NeoForge" = _jA3w1NU5;
        "pkg-v21.4.0-1.21.4-Fabric" = _yF9Y0ihX;
        "pkg-v21.4.0-1.21.4-NeoForge" = _gTyini9o;
        "pkg-v21.5.0-1.21.5-Fabric" = _uOuvYhBy;
        "pkg-v21.5.0-1.21.5-NeoForge" = _80wi2G7g;
        "pkg-v21.1.1-1.21.1-Fabric" = _4syRr8dj;
        "pkg-v21.1.1-1.21.1-NeoForge" = _5NZounJc;
        "pkg-v21.5.1-1.21.5-Fabric" = _ob5lQCi4;
        "pkg-v21.5.1-1.21.5-NeoForge" = _iXW3jdWI;
        "pkg-v21.7.0-1.21.7-Fabric" = _ddBB70nM;
        "pkg-v21.7.0-1.21.7-NeoForge" = _oPyhc4FN;
        "pkg-v21.8.0-1.21.8-Fabric" = _ZI5qvOFc;
        "pkg-v21.8.0-1.21.8-NeoForge" = _lZmuj8ZT;
        "pkg-v21.8.1-1.21.8-Fabric" = _CQxBBsyi;
        "pkg-v21.8.1-1.21.8-NeoForge" = _7W0gqY0e;
        "pkg-21.9.0" = _HHx5QjKa;
        "pkg-21.10.0" = _45l1mfiY;
        "pkg-21.11.0" = _2j46X7Ob;
