...
let
    ...
    in {
        ...
        "pkg-1.16.5-3.0-forge" = _jWkZWAxa;
        "pkg-1.18.2-3.0-forge" = _cunPeWSL;
        "pkg-1.19.2-3.0-forge" = _gpnojZB5;
        "pkg-1.16.5-3.1-forge" = _6R68p8WS;
        "pkg-1.18.2-3.1-forge" = _yFZFnfst;
        "pkg-1.19.2-3.1-forge" = _rMJuh1J9;
        "pkg-1.19.3-3.1-forge" = _oOFGrAiU;
        "pkg-1.18.2-4.0-forge+fabric" = _n4LpL8nL;
        "pkg-1.19.2-4.0-forge+fabric" = _QQESsWDy;
        "pkg-1.19.3-4.0-forge+fabric" = _eGo81M2X;
        "pkg-1.19.4-4.0-forge+fabric" = _8K6frnUz;
        "pkg-1.20-4.0-forge+fabric" = _4tNM9D06;
        "pkg-1.20.1-4.0-forge+fabric" = _5Icaj7E0;
        "pkg-1.20.2-4.0-forge+fabric" = _L3ZdTQ53;
        "pkg-1.18.2-4.1-forge+fabric" = _mpqL4dIe;
        "pkg-1.19.2-4.1-forge+fabric" = _wKxwBJnt;
        "pkg-1.20.1-4.1-forge+fabric" = _17laU6cq;
        "pkg-1.20.2-4.1-forge+fabric" = _KlXqL3cz;
        "pkg-1.20.2-4.2-forge+fabric" = _1k42jLVY;
        "pkg-1.18.2-4.3-forge+fabric" = _aWrkTeF2;
        "pkg-1.19.2-4.3-forge+fabric" = _IkYyqlVQ;
        "pkg-1.20.1-4.3-forge+fabric" = _aXroWcWw;
        "pkg-1.20.2-4.3-forge+fabric" = _C68ySOGv;
        "pkg-1.20.3-4.3-fabric+forge+neo" = _Y8ynDmB5;
        "pkg-1.20.4-4.3-fabric+forge+neo" = _4TOOhfvN;
        "pkg-1.19.2-4.4-fabric+forge+neo" = _YRpfxYRL;
        "pkg-1.20.1-4.4-fabric+forge+neo" = _it00lU2f;
        "pkg-1.20.2-4.4-fabric+forge+neo" = _5fdz6vY5;
        "pkg-1.20.4-4.4-fabric+forge+neo" = _A9EibaBf;
        "pkg-1.20.2-4.5-fabric+forge+neo" = _JiAAfug0;
        "pkg-1.20.4-4.5-fabric+forge+neo" = _S4toVc5R;
        "pkg-1.19.2-4.6-fabric+forge" = _xfW7M3DG;
        "pkg-1.20.1-4.6-fabric+forge+neo" = _HX3oUxvT;
        "pkg-1.20.4-4.6-fabric+forge+neo" = _4vJbyLos;
        "pkg-1.20.5-4.6-fabric+neo" = _3vCPneAj;
        "pkg-1.20.6-4.6-fabric+forge+neo" = _Kru1ZfGQ;
        "pkg-1.21.0-4.6-fabric+forge+neo" = _OG561oVD;
        "pkg-1.20.1-4.7-fabric+forge+neo" = _5TAPp5Il;
        "pkg-1.20.6-4.7-fabric+forge+neo" = _CAKU47Xl;
        "pkg-1.21.0-4.7-fabric+forge+neo" = _wQFCbowi;
        "pkg-1.21.1-4.7-fabric+forge+neo" = _F7au6FMZ;
        "pkg-1.21.2-4.7-fabric+neo" = _MzWLlJ98;
        "pkg-1.21.3-4.7-fabric+forge+neo" = _Voz2fimf;
        "pkg-1.21.4-4.7-fabric+forge+neo" = _5lSngBTk;
        "pkg-1.20.1-4.8-fabric+forge+neo" = _pPCs6yUa;
        "pkg-1.21.1-4.8-fabric+forge+neo" = _zNHfzliJ;
        "pkg-1.21.4-4.8-fabric+forge+neo" = _bkWrcY3t;
        "pkg-1.20.1-4.9-fabric+forge+neo" = _hYbKKbkg;
        "pkg-1.21.1-4.9-fabric+forge+neo" = _FFB4zorC;
        "pkg-1.21.4-4.9-fabric+forge+neo" = _hjPeJVVo;
        "pkg-1.21.5-4.9-fabric+forge+neo" = _DqJQlJh4;
        "pkg-1.21.6-4.9-fabric+forge+neo" = _Rzj4O8ko;
        "pkg-1.21.7-4.9-fabric+forge+neo" = _heGhoTBM;
        "pkg-1.21.8-4.9-fabric+forge+neo" = _5UK2Imb5;
        "pkg-1.20.1-5.0-fabric+forge+neo" = _2svhPEY1;
        "pkg-1.21.1-5.0-fabric+forge+neo" = _1jWUiIzh;
        "pkg-1.21.8-5.0-fabric+forge+neo" = _dUQp2jJ5;
        "pkg-1.21.9-5.0-fabric+forge+neo" = _K68hHXDQ;
        "pkg-1.21.9-5.1-fabric+forge+neo" = _7aqUa7EK;
        "pkg-1.21.10-5.1-fabric+forge+neo" = _WtX2oWUE;
        "pkg-1.21.11-5.1-fabric+forge+neo" = _flt80Pfh;
        "pkg-26.1.0-5.1-fabric+forge+neo" = _kSpnq3al;
