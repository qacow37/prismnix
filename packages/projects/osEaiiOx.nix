...
let
    ...
    in {
        ...
        "pkg-1.0.A-1.19.2" = _1lc2wTcU;
        "pkg-1.0.B-1.20.2" = _pqjkJB3a;
        "pkg-1.0.C-1.21.1" = _jDtRnjT3;
        "pkg-1.0.D-1.21.5" = _HWotKzwm;
        "pkg-1.0.A-1.19.4" = _CwwEKase;
        "pkg-1.0.B-1.20.4" = _vWJwLEqR;
        "pkg-1.0.B-1.20.6" = _xCfuH70m;
        "pkg-1.0.D-1.21.4" = _WVmJNDZy;
        "pkg-1.0.B-1.20.1" = _Pp7QvKfB;
        "pkg-1.1.A-1.19.2" = _n0rG2wNQ;
        "pkg-1.1.A-1.19.4" = _MuMxcEId;
        "pkg-1.1.B-1.20.1" = _dtl7jF53;
        "pkg-1.1.B-1.20.2" = _2ERI0qBy;
        "pkg-1.1.B-1.20.4" = _Q0el2FN0;
        "pkg-1.1.B-1.20.6" = _PKHUaC5H;
        "pkg-1.1.C-1.21.1" = _IZrls3j3;
        "pkg-1.1.D-1.21.4" = _9vynLmYG;
        "pkg-1.1.D-1.21.5" = _vLz4h8IQ;
        "pkg-1.1.D-1.21.7" = _vkF71RhA;
        "pkg-1.2.A-1.19.2" = _cNipDKCi;
        "pkg-1.2.A-1.19.4" = _uMXfVqOR;
        "pkg-1.2.B-1.20.1" = _sLkpFLzz;
        "pkg-1.2.B-1.20.2" = _kkIwpbb6;
        "pkg-1.2.B-1.20.4" = _6w98U67t;
        "pkg-1.2.B-1.20.6" = _kkWI4a8A;
        "pkg-1.2.C-1.21.1" = _GCwLZI28;
        "pkg-1.2.D-1.21.4" = _xQOM8McC;
        "pkg-1.2.D-1.21.5" = _8NHA5p6a;
        "pkg-1.2.D-1.21.7" = _2D015G2e;
        "pkg-1.3.A-1.19.2" = _fS9kTKbr;
        "pkg-1.3.A-1.19.4" = _lgiOhY3y;
        "pkg-1.3.B-1.20.1" = _QBKDbPIz;
        "pkg-1.3.B-1.20.2" = _ekc1M0Pp;
        "pkg-1.3.B-1.20.6" = _137T043k;
        "pkg-1.3.B-1.20.4" = _iBKkmjio;
        "pkg-1.3.B-1.21.1" = _IxSaRoNv;
        "pkg-1.3.D-1.21.5" = _cha8cEG3;
        "pkg-1.3.D-1.21.4" = _hVrY8HFz;
        "pkg-1.3.D-1.21.7" = _JGwdhLFx;
        "pkg-1.4.A-1.19.2" = _2VWuTlwq;
        "pkg-1.4.A-1.19.4" = _ZyWldu0c;
        "pkg-1.4.B-1.20.1" = _gEz4W3W0;
        "pkg-1.4.B-1.20.2" = _mN0m4FvF;
        "pkg-1.4.B-1.20.4" = _hQiJwXdC;
        "pkg-1.4.B-1.20.6" = _Al6gWmJP;
        "pkg-1.4.C-1.21.1" = _zhXWpZ1W;
        "pkg-1.4.D-1.21.4" = _6wSvd1qw;
        "pkg-1.4.D-1.21.5" = _TesXcih0;
        "pkg-1.4.D-1.21.7" = _51ymt9vK;
        "pkg-1.5.A-1.19.2" = _v3ck9AxX;
        "pkg-1.5.A-1.19.4" = _ieHclxBD;
        "pkg-1.5.B-1.20.1" = _uJgHXej6;
        "pkg-1.5.B-1.20.2" = _jjo5yEzk;
        "pkg-1.5.B-1.20.4" = _zCL78yYK;
        "pkg-1.5.B-1.20.6" = _ISY2yXcJ;
        "pkg-1.5.C-1.21.1" = _MA1NOGeB;
        "pkg-1.5.D-1.21.4" = _zlX920Gv;
        "pkg-1.5.E-1.21.5" = _W8pjeTks;
        "pkg-1.5.E-1.21.7" = _nbUMNTGT;
        "pkg-1.6.A-1.19.2" = _t7DPQnPN;
        "pkg-1.6.A-1.19.4" = _LLYkmYzi;
        "pkg-1.6.B-1.20.1" = _fIYUTHQJ;
        "pkg-1.6.B-1.20.2" = _g10nwf5j;
        "pkg-1.6.B-1.20.4" = _8KoexHzH;
        "pkg-1.6.B-1.20.6" = _RZeOTrWB;
        "pkg-1.6.C-1.21.1" = _xduD6hXq;
        "pkg-1.6.D-1.21.4" = _YlV419aA;
        "pkg-1.6.E-1.21.5" = _58DZKxHA;
        "pkg-1.6.E-1.21.7" = _HnygE4YH;
        "pkg-1.6.A-1.19.3" = _N6V2F3a3;
        "pkg-1.6.E-1.21.10" = _FsggnDxq;
        "pkg-1.6.E-1.21.11" = _8lomfHs4;
        "pkg-2.0.A-1.19.2" = _z5wehdXK;
        "pkg-2.0.A-1.19.3" = _6HO9jpRc;
        "pkg-2.0.A-1.19.4" = _q0MgMgDG;
        "pkg-2.0.A-EC-1.19.2" = _ErwMAXWe;
        "pkg-2.0.B-1.20.1" = _qs0zKHfQ;
        "pkg-2.0.B-1.20.2" = _qyXOda4Z;
        "pkg-2.0.B-1.20.4" = _PLrfVcsR;
        "pkg-2.0.B-1.20.6" = _tWar6GWt;
        "pkg-2.0.B-EC-1.20.1" = _7R48WSn0;
        "pkg-2.0.C-1.21.1" = _Vw0DJND0;
        "pkg-2.0.C-EC-1.21.1" = _Hf5zENMp;
        "pkg-2.0.D-1.21.4" = _nvRc3uwr;
        "pkg-2.0.E-1.21.5" = _tYl6zALo;
        "pkg-2.0.E-1.21.7" = _nF4mlsrs;
        "pkg-2.0.E-1.21.10" = _3Ey9axFZ;
        "pkg-2.0.E-1.21.11" = _TFvR3le6;
        "pkg-2.0.E-EC-1.21.5" = _SovUnUEg;
        "pkg-2.0.E-EC-1.21.11" = _n2axvKY1;
        "pkg-2.1.A-EC-1.19.2" = _MhhI8FOj;
        "pkg-2.1.A-1.19.2" = _deyurF9p;
        "pkg-2.1.A-1.19.3" = _tTp2KIyu;
        "pkg-2.1.A-1.19.4" = _9uQSMioE;
        "pkg-2.1.B-EC-1.20.1" = _UFHwar2h;
        "pkg-2.1.B-1.20.1" = _4w3gTeWu;
        "pkg-2.1.B-1.20.2" = _1EA17TtM;
        "pkg-2.1.B-1.20.4" = _rn6Mpg0S;
        "pkg-2.1.B-1.20.6" = _FVzXeV3Q;
        "pkg-2.1.C-EC-1.21.1" = _lb11jocX;
        "pkg-2.1.C-1.21.1" = _AWyTm4EN;
        "pkg-2.1.D-1.21.4" = _hw7syulE;
        "pkg-2.1.E-EC-1.21.5" = _2lUYSsE2;
        "pkg-2.1.E-1.21.5" = _LyMnqwmx;
        "pkg-2.1.E-1.21.7" = _tYnmdKEv;
        "pkg-2.1.E-1.21.10" = _bUZ3AZW3;
        "pkg-2.1.E-EC-1.21.11" = _wQXf4Hma;
        "pkg-2.1.E-1.21.11" = _LY3IqERG;
        "pkg-2.2.A-EC-1.19.2" = _xjLba989;
        "pkg-2.2.A-1.19.2" = _N14g8yrx;
        "pkg-2.2.A-1.19.3" = _gyHdjnQw;
        "pkg-2.2.A-1.19.4" = _jxAhEsTJ;
        "pkg-2.2.B-EC-1.20.1" = _hxDo5YsV;
        "pkg-2.2.B-1.20.1" = _vH5RG1Mq;
        "pkg-2.2.B-1.20.2" = _snNqDmRQ;
        "pkg-2.2.B-1.20.4" = _a3tViooM;
        "pkg-2.2.B-1.20.6" = _cSTnutJ6;
        "pkg-2.2.C-EC-1.21.1" = _UEZEx8gl;
        "pkg-2.2.C-1.21.1" = _lYj82Y6R;
        "pkg-2.2.D-1.21.4" = _YiPMlJ7B;
        "pkg-2.2.E-EC-1.21.5" = _MG25BXMo;
        "pkg-2.2.E-1.21.5" = _XKkwSPFo;
        "pkg-2.2.E-1.21.7" = _xtiURdn3;
        "pkg-2.2.E-1.21.10" = _lJKZt1uM;
        "pkg-2.2.E-EC-1.21.11" = _Y4bCqFV4;
        "pkg-2.2.E-1.21.11" = _TgLbe3nM;
        "pkg-2.3.A-EC-1.19.2" = _APQ0RHIV;
        "pkg-2.3.A-1.19.2" = _pzy6NoE4;
        "pkg-2.3.A-1.19.3" = _ZpxLRTVf;
        "pkg-2.3.A-1.19.4" = _7jHTbCkc;
        "pkg-2.3.B-EC-1.20.1" = _zR417RZX;
        "pkg-2.3.B-1.20.1" = _1yMfnmXT;
        "pkg-2.3.B-1.20.2" = _Z7ZZRAGa;
        "pkg-2.3.B-1.20.4" = _BSBcieeE;
        "pkg-2.3.B-1.20.6" = _S99O1QMj;
        "pkg-2.3.C-EC-1.21.1" = _i61C5bg7;
        "pkg-2.3.C-1.21.1" = _pn0wINfO;
        "pkg-2.3.D-1.21.4" = _pqGecAjV;
        "pkg-2.3.E-EC-1.21.5" = _IpKVvWE4;
        "pkg-2.3.E-1.21.5" = _A46SPeYr;
        "pkg-2.3.E-1.21.7" = _ARw5Fg6d;
        "pkg-2.3.E-1.21.10" = _dm2veBwL;
        "pkg-2.3.E-EC-1.21.11" = _KaJjgK6b;
        "pkg-2.3.E-1.21.11" = _gj4LURrY;
        "pkg-2.3.E-26.1" = _MmBSSsLx;
        "pkg-2.4.A-EC-1.19.2" = _WjiKin4y;
        "pkg-2.4.A-1.19.2" = _xm1ax3tu;
        "pkg-2.4.A-1.19.3" = _a8ui3TPb;
        "pkg-2.4.A-1.19.4" = _kctPCwfl;
        "pkg-2.4.B-EC-1.20.1" = _w2Fp1iPC;
        "pkg-2.4.B-1.20.1" = _TofkOO2n;
        "pkg-2.4.B-1.20.2" = _v6fYuykm;
        "pkg-2.4.B-1.20.4" = _iPNn2TOa;
        "pkg-2.4.B-1.20.6" = _E6csVaV0;
        "pkg-2.4.C-EC-1.21.1" = _MT7Pfdei;
        "pkg-2.4.C-1.21.1" = _LksP9iAL;
        "pkg-2.4.D-1.21.4" = _9W79tOWP;
        "pkg-2.4.E-1.21.5" = _ve0zwaO5;
        "pkg-2.4.E-1.21.7" = _BZ0Mu4hi;
        "pkg-2.4.F-1.21.10" = _7WI4Gt3Y;
        "pkg-2.4.F-EC-1.21.11" = _8ht1ppNB;
        "pkg-2.4.F-1.21.11" = _uwoc0LSp;
        "pkg-2.4.G-EC-26.1.2" = _MQGvHbp3;
        "pkg-2.4.G-26.1.2" = _FunYH1gJ;
        "pkg-2.5.A-EC-1.19.2" = _iYyN03fu;
        "pkg-2.5.A-1.19.3" = _JIcT9tlO;
        "pkg-2.5.A-1.19.4" = _QuLzicWK;
        "pkg-2.5.B-EC-1.20.1" = _Bkx6D2GH;
        "pkg-2.5.B-1.20.1" = _jtVfmgOm;
        "pkg-2.5.B-1.20.2" = _Ex0f72CB;
        "pkg-2.5.B-1.20.4" = _W5g1hFs9;
        "pkg-2.5.B-1.20.6" = _gvB9A4op;
        "pkg-2.5.C-EC-1.21.1" = _cwTs8ts6;
        "pkg-2.5.C-1.21.1" = _3ARuRhcg;
        "pkg-2.5.D-1.21.4" = _Hv91gEVC;
        "pkg-2.5.E-1.21.5" = _vsUVEFEn;
        "pkg-2.5.E-1.21.7" = _29zg5o9q;
        "pkg-2.5.F-1.21.10" = _W0DeUOba;
        "pkg-2.5.F-EC-1.21.11" = _hZlfRfQc;
        "pkg-2.5.F-1.21.11" = _SegOMAT9;
        "pkg-2.5.G-EC-26.1.2" = _YnfQDJ2A;
        "pkg-2.5.G-26.1.2" = _2HVdJtzv;
        "default" = _2HVdJtzv;
    });
