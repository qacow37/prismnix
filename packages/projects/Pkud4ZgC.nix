...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21" = _jCisJcpL;
        "pkg-1.0.1+1.21" = _HjN7FiRo;
        "pkg-1.0.2+1.21" = _Teu006xJ;
        "pkg-1.0.3+1.21" = _2yzbM4mr;
        "pkg-1.0.4+1.21" = _lYt6MaQi;
        "pkg-1.0.5+1.21" = _PtWfixYO;
        "pkg-1.0.6+1.21" = _YBJ2lrGH;
        "pkg-1.0.7+1.21" = _FdM5YvFX;
        "pkg-1.0.8+1.21" = _tkGCfulf;
        "pkg-1.0.9+1.21" = _SbSZQb0U;
        "pkg-1.0.10+1.21" = _KDbIM5X7;
        "pkg-1.0.11+1.21" = _lpoGuqDS;
        "pkg-1.0.12+1.21" = _OEJO2Li7;
        "pkg-1.0.13+1.21" = _KaGSVzWj;
        "pkg-1.0.14+1.21" = _FeQtN9vU;
        "pkg-1.0.15+1.21" = _E5X9L6FA;
        "pkg-1.0.16+1.21" = _FPTQdCLy;
        "pkg-1.0.17+1.21" = _OSAdPoCD;
        "pkg-1.0.18+1.21" = _Fs5PCTqQ;
        "pkg-1.0.19+1.21" = _1qejByja;
        "pkg-1.0.20+1.21" = _M18qc5rd;
        "pkg-1.0.21+1.21" = _gwVD2Y2t;
        "pkg-1.0.22+1.21" = _V0r2ZQz4;
        "pkg-1.0.23+1.21" = _59qxfDNk;
        "pkg-1.0.24+1.21" = _IUDgqAUB;
        "pkg-1.1.1+1.21.1" = _UJPvDovw;
        "pkg-1.1.2+1.21.1" = _FMdxluds;
        "pkg-1.1.3+1.21.1" = _QyrxA9Pt;
        "pkg-1.1.4+1.21.1" = _PZujl9Gy;
        "pkg-1.2.0+1.21.1" = _hGZB3v9z;
        "pkg-1.2.1+1.21.1" = _AikU0Dsf;
        "pkg-1.2.2+1.21.1" = _GBurOAUw;
        "pkg-1.2.3+1.21.1" = _gsG3h5MR;
        "pkg-1.2.4+1.21.1" = _ruX6OLiF;
        "pkg-1.2.5+1.21.1" = _IK7oZ3eO;
        "pkg-1.2.6+1.21.1" = _xfdNiPDy;
        "pkg-1.2.7+1.21.1" = _P7ExMBqJ;
        "default" = _P7ExMBqJ;
    });
