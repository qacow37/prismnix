...
let
    ...
    in {
        ...
        "pkg-5+mod" = _AxXGxUXs;
        "pkg-1.4" = _Q0J22NKA;
        "pkg-1.4+mod" = _n0EtIFhc;
        "pkg-1.41" = _1jpf4IBU;
        "pkg-1.41+mod" = _Rr8GSwiQ;
        "pkg-1.42" = _l1a7qWHX;
        "pkg-1.42+mod" = _IxSQaRk7;
        "pkg-1.5" = _7WANDzi6;
        "pkg-1.5+mod" = _syBfbc0o;
        "pkg-1.51" = _ftTlbxyo;
        "pkg-1.51+mod" = _eECJzqtw;
        "pkg-1.52" = _aCk8ekH1;
        "pkg-1.52+mod" = _BiCfUcut;
        "pkg-1.53" = _BdFXJ2ww;
        "pkg-1.53+mod" = _dN6y0gYu;
        "pkg-1.6" = _dXumqUUy;
        "pkg-1.6+mod" = _5KNoiz1W;
        "pkg-1.61" = _6of2CCFx;
        "pkg-1.61+mod" = _3QnOt4aP;
        "pkg-1.611" = _SxPYDvD3;
        "pkg-1.611+mod" = _MzZJIdV0;
        "pkg-1.62" = _mPRHFQG8;
        "pkg-1.62+mod" = _XqAMuonL;
        "pkg-1.621" = _DOfQ0dJi;
        "pkg-1.621+mod" = _JghKgV2T;
        "pkg-1.7" = _mb2bpWBK;
        "pkg-1.7+mod" = _Ik0VpZTk;
        "pkg-1.72" = _Rkk5i1PO;
        "pkg-1.72+mod" = _W2xQdbVq;
        "pkg-1.73" = _gQN1BJU3;
        "pkg-1.73+mod" = _cWYdyVEl;
        "pkg-1.74" = _dIzmUbXc;
        "pkg-1.74+mod" = _usCbxB2b;
        "pkg-1.72.1" = _JE2LWBLx;
        "pkg-1.72.1+mod" = _T5rAebdF;
        "pkg-1.75" = _Hl5KjeUF;
        "pkg-1.75+mod" = _sGtxUTDG;
        "pkg-1.76" = _x39K0Vyz;
        "pkg-1.76+mod" = _Om8rf2qt;
        "pkg-1.76.1" = _sNLo4Xca;
        "pkg-1.76.1+mod" = _HIO5nFYS;
        "pkg-1.76.2" = _cszfQc3G;
        "pkg-1.76.2+mod" = _U2Dg5Dud;
        "pkg-1.77" = _WyjQd0TB;
        "pkg-1.77+mod" = _9ZdJJA9O;
        "pkg-1.77.1" = _FgcGCjP5;
        "pkg-1.77.1+mod" = _x9PVHUBv;
        "pkg-1.77.2" = _CsCmCR1v;
        "pkg-1.77.2+mod" = _6dmbwhCK;
        "pkg-1.78" = _RHIRRQdu;
        "pkg-1.78+mod" = _Qy7a6EoM;
        "pkg-1.79" = _Pq9n26FZ;
        "pkg-1.79+mod" = _Bcbccne3;
        "pkg-1.8" = _pQo5rM2G;
        "pkg-1.8+mod" = _G2iZJzKZ;
        "pkg-1.81" = _jXbDLqA0;
        "pkg-1.81+mod" = _WmCC0LF8;
        "pkg-1.81.1" = _28vJSCCf;
        "pkg-1.81.1+mod" = _fSpZKabL;
        "pkg-1.81.2" = _Gif7wWC7;
        "pkg-1.81.2+mod" = _hxDQCU7b;
        "pkg-1.83" = _YBAZvxQ3;
        "pkg-1.83+mod" = _NOXB0LHV;
        "pkg-1.84" = _naU7ICS1;
        "pkg-1.84+mod" = _Fjo8jbaw;
        "pkg-1.85" = _Tf9NGEEO;
        "pkg-1.85+mod" = _HQqBRt5Z;
        "pkg-1.86" = _tquXqjl1;
        "pkg-1.86+mod" = _o3NT3fnQ;
        "pkg-1.86.1" = _gfWiX0pn;
        "pkg-1.86.1+mod" = _5UYlyS87;
        "default" = _5UYlyS87;
    });
