...
let
    ...
    in {
        ...
        "pkg-1.19.2-10" = _Eu5IvL21;
        "pkg-1.19.1-9" = _UwlKENFu;
        "pkg-1.19-8" = _MlN9IBQQ;
        "pkg-1.18.2-6" = _VBz8xnUq;
        "pkg-1.18.1-5" = _2vOWTJjM;
        "pkg-1.17.1-3" = _ecI72gEO;
        "pkg-1.16.5-2" = _67hMU8u0;
        "pkg-1.19.3-10" = _ByWHTAYv;
        "pkg-1.16.5-10-forge" = _yh8p77pp;
        "pkg-1.17.1-10-forge" = _pwPDeD6P;
        "pkg-1.18-10-forge" = _zARNgDrt;
        "pkg-1.18.1-10-forge" = _dtleuG9M;
        "pkg-1.18.2-10-forge" = _vv2APZP5;
        "pkg-1.19-10-forge" = _sVZoJYIB;
        "pkg-1.19.1-10-forge" = _vEoTct1p;
        "pkg-1.19.2-10-forge" = _qpKQ3vi2;
        "pkg-1.19.3-10-forge" = _pGN2jKqH;
        "pkg-1.19.4-10" = _k2oEolU9;
        "pkg-1.19.4-10-forge" = _A1nfiady;
        "pkg-1.20-10" = _5kd6GQg1;
        "pkg-1.20-10-forge" = _g1QqDYNN;
        "pkg-1.20-11-fabric" = _VXDCtyAM;
        "pkg-1.20-11-forge" = _OQh02pLE;
        "pkg-1.20.1-10-fabric" = _cTuR5SnU;
        "pkg-1.20.1-11-forge" = _O7qG8LMn;
        "pkg-1.20.2-10-fabric" = _keDtPhX0;
        "pkg-1.20.2-11-forge" = _V7hebxwJ;
        "pkg-1.20.3-10-fabric" = _yp6YWLLS;
        "pkg-1.20.3-11-forge" = _PG0xfMiS;
        "pkg-1.20.4-11-forge" = _URYCT1A6;
        "pkg-1.20.4-10-fabric" = _RMyxlyUJ;
        "pkg-1.20.4-0-neoforge" = _D2d3fYQl;
        "pkg-1.20.5-10-fabric" = _9JPgDaoE;
        "pkg-1.20.6-10-fabric" = _HMfdVR4e;
        "pkg-1.20.6-0-neoforge" = _EwTxZcfH;
        "pkg-1.20.6-11-forge" = _2aUxR266;
        "pkg-1.21-10-fabric" = _Jd4bLkdS;
        "pkg-1.21-11-forge" = _1E39jTsy;
        "pkg-1.21-0-neoforge" = _b9nj3gse;
        "pkg-1.20.6-0.1-neoforge" = _ZTjizVLj;
        "pkg-1.21-0.1-neoforge" = _B6GSz9ym;
        "pkg-1.21.1-0.1-neoforge" = _xH5fsnX1;
        "pkg-1.21.1-10-fabric" = _QD8xGsna;
        "pkg-1.21.1-11-forge" = _AzEFObSr;
        "pkg-1.21.3-10-fabric" = _vgdFKNyC;
        "pkg-1.21.3-11-forge" = _LeZKExfC;
        "pkg-1.21.3-0.1-neoforge" = _7rxA1Nar;
        "pkg-1.21.4-10-fabric" = _QICHIqIL;
        "pkg-1.21.4-0.1-neoforge" = _UmIdxRYG;
        "pkg-1.21.4-11-forge" = _zAIJoH1b;
        "pkg-fabric-1.18.2-12.jar" = _rTKIi5EO;
        "pkg-fabric-1.19.2-12.jar" = _yNnG6pjt;
        "pkg-fabric-1.19.4-12.jar" = _nHnpo2g7;
        "pkg-fabric-1.20.1-12.jar" = _lfsT2S5S;
        "pkg-fabric-1.20.2-12.jar" = _JJdLaU6K;
        "pkg-fabric-1.20.4-12.jar" = _lU0H7wvF;
        "pkg-fabric-1.20.6-12.jar" = _A4GgUOO3;
        "pkg-fabric-1.21.1-12.jar" = _jVzd203z;
        "pkg-fabric-1.21.3-12.jar" = _vbdT6FcC;
        "pkg-fabric-1.21.4-12.jar" = _3vfWgRqS;
        "pkg-forge-1.18.2-12.jar" = _cAOyI1TS;
        "pkg-forge-1.19.2-12.jar" = _v04SficA;
        "pkg-forge-1.19.4-12.jar" = _mcWHGfsw;
        "pkg-forge-1.20.1-12.jar" = _yCvGyTU2;
        "pkg-forge-1.20.2-12.jar" = _cLCP3nEk;
        "pkg-forge-1.20.4-12.jar" = _lkW5csli;
        "pkg-forge-1.20.6-12.jar" = _yXhABCDv;
        "pkg-forge-1.21.1-12.jar" = _unH6SKBO;
        "pkg-forge-1.21.3-12.jar" = _cvHp1aca;
        "pkg-forge-1.21.4-12.jar" = _dGGV9udU;
        "pkg-neoforge-1.20.6-12.jar" = _6Mmu1dBJ;
        "pkg-neoforge-1.21.1-12.jar" = _c3p0j0Cc;
        "pkg-neoforge-1.21.3-12.jar" = _GIp8HUUF;
        "pkg-neoforge-1.21.4-12.jar" = _LbOd28f8;
        "pkg-fabric-1.18.2-12.1" = _rzumoxS1;
        "pkg-fabric-1.18.2-12.2" = _iRsiOvcL;
        "pkg-fabric-1.18.2-12.3" = _EJM5ER8Z;
        "pkg-fabric-1.19.2-12.3" = _KPdNmueX;
        "pkg-fabric-1.19.4-12.3" = _c5Bel2ng;
        "pkg-fabric-1.20.1-12.3" = _RkqiCDzh;
        "pkg-fabric-1.20.2-12.3" = _253PbDYU;
        "pkg-fabric-1.20.4-12.3" = _voEEmGsw;
        "pkg-fabric-1.20.6-12.3" = _LRDcnomp;
        "pkg-fabric-1.21.1-12.3" = _aKceMX7R;
        "pkg-fabric-1.21.3-12.3" = _3DLjzelU;
        "pkg-fabric-1.21.4-12.3" = _3Rf3XxHG;
        "pkg-forge-1.18.2-12.3" = _chVGKhbu;
        "pkg-forge-1.19.2-12.3" = _eN7ks78W;
        "pkg-forge-1.19.4-12.3" = _OembuLih;
        "pkg-forge-1.20.1-12.3" = _vZ6sknnt;
        "pkg-forge-1.20.2-12.3" = _Di2RCHLO;
        "pkg-forge-1.20.4-12.3" = _Q0TMgLQ9;
        "pkg-forge-1.20.6-12.3" = _S2v18Gs7;
        "pkg-forge-1.21.1-12.3" = _eKJT7McR;
        "pkg-forge-1.21.3-12.3" = _Qo8SIKGL;
        "pkg-forge-1.21.4-12.3" = _R5aUcQSR;
        "pkg-neoforge-1.20.6-12.3" = _A4pUW8Ui;
        "pkg-neoforge-1.21.1-12.3" = _HaHbqc1Y;
        "pkg-neoforge-1.21.3-12.3" = _gPUrdlSh;
        "pkg-neoforge-1.21.4-12.3" = _ESlF37yc;
        "pkg-fabric-1.21.5-12.1" = _6vPIPE9o;
        "pkg-forge-1.21.5-12.1" = _KKL5ZCDP;
        "pkg-neoforge-1.21.5-12.1" = _jiwXcNMJ;
        "pkg-fabric-1.21.6-12.1" = _WesmVkut;
        "pkg-forge-1.21.6-12.1" = _eZJR2tSV;
        "pkg-neoforge-1.21.6-12.1" = _HF7DxhpN;
        "pkg-fabric-1.21.7-12.1" = _A9yV5wGM;
        "pkg-forge-1.21.7-12.1" = _U1YKMgAM;
        "pkg-neoforge-1.21.7-12.1" = _BUbBLZ6Q;
        "pkg-fabric-1.21.7-12.2" = _hi0gjgFL;
        "pkg-forge-1.21.7-12.2" = _XgxLRQgU;
        "pkg-neoforge-1.21.7-12.2" = _L0dIGQiS;
        "pkg-fabric-1.21.8-12.2" = _2Lc4T9o2;
        "pkg-forge-1.21.8-12.2" = _15TCgaBW;
        "pkg-neoforge-1.21.8-12.2" = _J0cVxHY3;
        "default" = _J0cVxHY3;
    });
