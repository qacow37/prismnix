...
let
    ...
    in {
        ...
        "pkg-1.6.5.1" = _qAr6MxxV;
        "pkg-1.6.6.1" = _zXRF8mNL;
        "pkg-1.6.6.2" = _VR4VPjEd;
        "pkg-1.6.6.3" = _VCmnYhDp;
        "pkg-1.6.6.4" = _20MMNesf;
        "pkg-1.7.2.1" = _Vwwy1PHz;
        "pkg-1.7.3.1" = _JdqWsUUO;
        "pkg-1.7.3.2" = _3PomycPG;
        "pkg-1.7.3.3" = _yitnSGkL;
        "pkg-1.7.3.4" = _6V1kEtLf;
        "pkg-1.8.1.1" = _YcZyhdz8;
        "pkg-2.0.1" = _2AiClhFg;
        "pkg-2.1.0" = _zLF2v1Og;
        "pkg-2.1.1" = _kag4aJnk;
        "pkg-2.2.0" = _2kpjm6yL;
        ...
        "pkg-2.2.8" = _tDDh6h17;
        "pkg-2.2.9" = _2BeZa0U2;
        "pkg-2.2.10" = _I8VHsVeB;
        "pkg-2.2.11" = _L5egMnsV;
        "pkg-2.2.12" = _jMWrbVXd;
        "pkg-2.2.13" = _huD11U31;
        "pkg-2.2.14" = _UsVNFTUv;
        "pkg-3.0.0" = _XYMcWtFy;
        "pkg-3.0.1" = _R24tFAfu;
        "pkg-3.0.2" = _DWOnHcoH;
        "pkg-3.0.3" = _yxkUQBoP;
        ...
        "pkg-7.0.8" = _LCFS8d41;
        "pkg-7.0.9" = _G5A2cnUm;
        "pkg-7.0.10" = _OQ9W1Sdh;
        "pkg-7.0.11" = _WImsR3r7;
        "pkg-7.0.12" = _ZCq9AOGY;
        "pkg-7.0.13" = _4zffBsBK;
        "pkg-7.0.14" = _5m1j42Fi;
        "pkg-7.0.15" = _mvpx9Ngo;
        "pkg-7.0.16" = _PF5q8ogb;
        "pkg-7.0.17" = _PPHsUXrp;
        "pkg-7.0.18" = _6owVUZqV;
        "pkg-7.0.19" = _RzSIHH27;
        "pkg-7.0.20" = _QNXxJFOG;
        "pkg-7.0.21" = _CF3nyHCn;
        "pkg-7.0.22" = _Jf9QTGer;
        "pkg-7.0.23" = _lL4ny9ut;
        "pkg-7.0.25" = _YwFzqs8B;
        "pkg-7.0.26" = _KOS0OFhq;
        "pkg-7.1.0" = _TSW0XG2J;
        "pkg-7.1.1" = _b2zbpPId;
        "pkg-7.1.2" = _Lm7khqbE;
        "pkg-7.1.3" = _GBq4L7Za;
        ...
        "pkg-7.1.8" = _Dj7yIfim;
        "pkg-7.1.9" = _CU002Xj3;
        "pkg-7.1.10" = _24aTP185;
        "pkg-7.1.11" = _QuOVe4Az;
        "pkg-7.1.12" = _k61De8ad;
        "pkg-7.1.13" = _WXO7f4N8;
        "pkg-7.1.14" = _JrKu9AUy;
        "pkg-7.1.15" = _plXvlNc9;
        "pkg-7.1.16" = _imUzKp7O;
        "pkg-7.1.17" = _6jhzOkKT;
        "pkg-7.1.18" = _UBvxTpAw;
        "pkg-7.1.19" = _s8Ad6RXN;
        "pkg-7.1.20" = _RGNFJA8i;
        "pkg-7.2.0" = _lXAiCpHw;
        "pkg-7.2.1" = _QEC1eDGw;
        "pkg-7.2.2" = _5COOY75Q;
        "pkg-7.2.3" = _JsdxcBwn;
        ...
        "pkg-7.2.7" = _BQkvZOat;
        "pkg-7.2.8" = _8yoEPYTn;
        "pkg-7.1.21" = _UcM0R7YS;
        "pkg-7.1.22" = _5Gth6pGC;
        "pkg-7.1.23" = _2fE3TFn6;
        "pkg-7.1.24" = _dDytmSa0;
        "pkg-7.1.25" = _trXYsJeM;
        "pkg-7.1.26" = _30aCMwhG;
        "pkg-7.99.5" = _cKvFwL94;
        "pkg-7.99.6" = _EhEzSk7Z;
        "pkg-7.99.7" = _1AvdMsyX;
        "pkg-7.99.8" = _UjvW47Xz;
        "pkg-7.99.8.1" = _qMbGC4V5;
        "pkg-7.99.8.2" = _7PjdaVb2;
        "pkg-7.99.12" = _pRkFJ8Ve;
        "pkg-7.99.13" = _K4lGFilG;
        "pkg-7.99.14" = _yWXAqcpo;
        "pkg-7.99.15" = _F0S4zYpw;
        "pkg-7.99.16" = _WR4X2dvW;
        "pkg-7.99.17" = _VNtfhN21;
        "pkg-7.99.18" = _ifK5f0CB;
        "pkg-7.99.19" = _yc9SYppt;
        "pkg-7.99.20" = _YhZvYyJD;
        "pkg-7.99.21" = _PAvsOGya;
        "pkg-7.99.22" = _DxoScxRH;
        "pkg-7.99.23" = _JnRrlACZ;
        "pkg-7.99.24" = _GUQHrrae;
        "pkg-7.99.24.1" = _c26cSxz0;
        "pkg-7.99.24.2" = _Zfz0vFu3;
        "pkg-7.99.24.3" = _NPUbGqoz;
        "pkg-7.99.24.4" = _AjOzrvOP;
        "pkg-7.99.24.5" = _oSifBeOX;
        "pkg-7.99.24.6" = _nSGmxlBc;
        "pkg-7.99.24.7" = _ba242OwW;
        "pkg-7.99.24.8" = _Pymfz1cJ;
        "pkg-7.1.27" = _hcD0Q6pK;
        "pkg-8.0.0" = _xUnJl9Jk;
        "default" = _xUnJl9Jk;
    });
