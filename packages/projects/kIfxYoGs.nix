...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _WqorGUqS;
        "pkg-1.0.9" = _phpY513s;
        "pkg-1.0.10" = _I466T38J;
        "pkg-1.0.11-SNAPSHOT" = _kDURGnoj;
        "pkg-1.0.12-TEST_1.21.1" = _mmRpTquJ;
        "pkg-1.0.13-SNAPSHOT" = _1PK766wa;
        "pkg-1.0.14-SNAPSHOT" = _iaYqJ9WW;
        "pkg-1.0.14-fix" = _cFqOQo2W;
        "pkg-1.0.14-fix2" = _Ej4y9bgq;
        "pkg-1.0.14-fix3" = _uK3bKgFI;
        "pkg-1.0.14-fix4" = _F0MgyBbn;
        "pkg-1.0.15" = _ZL2qpGOd;
        "pkg-1.0.15-fix1" = _uVJWDk7w;
        "pkg-1.0.15-fix2" = _iy4KFh1D;
        "pkg-1.0.16" = _M3QFogPn;
        "pkg-1.0.16-fix1" = _w1uSwwmZ;
        "pkg-1.0.16-fix2" = _fz24WWx1;
        "pkg-1.0.17" = _LXpu0APx;
        "default" = _LXpu0APx;
    });
