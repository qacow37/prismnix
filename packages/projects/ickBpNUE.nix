...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _CDCwsXMA;
        "pkg-1.0.0+mod" = _iScsd6mS;
        "pkg-1.0.0-1.20.1-fabric" = _2fGs6xoH;
        "pkg-1.0.0-1.20.1-fabric+mod" = _yjrczm3y;
        "pkg-1.21.1-1.0-fabric" = _yXjId5Lf;
        "pkg-1.21.1-1.0-fabric+mod" = _lBOaTf6G;
        "pkg-1.21.1-1.0-neoforge" = _D2qky0ll;
        "pkg-1.21.1-1.0-neoforge+mod" = _75OyHwwV;
        "pkg-1.21.1-2.0-fabric" = _MnYwiIFI;
        "pkg-1.21.1-2.0-fabric+mod" = _LZGeddN7;
        "pkg-1.21.1-2.0-neoforge" = _MckwO0Hx;
        "pkg-1.21.1-2.0-neoforge+mod" = _Yxue8X03;
        "pkg-1.21.1-2.0a-fabric" = _b3KH6IEx;
        "pkg-1.21.1-2.0a-fabric+mod" = _IrjCijR1;
        "pkg-1.21.1-2.0a-neoforge" = _LkoMcWo1;
        "pkg-1.21.1-2.0a-neoforge+mod" = _rE2GiA5P;
        "pkg-1.20.1-1.1-fabric" = _vmxZmwRM;
        "pkg-1.20.1-1.1-fabric+mod" = _C4JGcEVt;
        "pkg-1.20.1-1.1-forge" = _f3kBIkpw;
        "pkg-1.20.1-1.1-forge+mod" = _4pcjIbg5;
        "pkg-1.21.1-2.1-fabric" = _u1uxA6d2;
        "pkg-1.21.1-2.1-fabric+mod" = _NrAtQ6ut;
        "pkg-1.21.1-2.1-neoforge" = _hs0POBUm;
        "pkg-1.21.1-2.1-neoforge+mod" = _HxjFzjdy;
        "pkg-1.21.8-2.1-fabric" = _STddaKTE;
        "pkg-1.21.8-2.1-fabric+mod" = _nVtEqzmS;
        "pkg-1.21.10-2.1-fabric" = _yMFOFNt9;
        "pkg-1.21.10-2.1-fabric+mod" = _t64oLIJ4;
        "pkg-1.21.11-2.1-fabric" = _85VKnEIs;
        "pkg-1.21.11-2.1-fabric+mod" = _Pfaq1rKB;
        "default" = _Pfaq1rKB;
    });
