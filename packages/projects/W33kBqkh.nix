...
let
    ...
    in {
        ...
        "pkg-3.4.0+1.20.1" = _JAlJcplA;
        "pkg-3.4.1+1.20.1" = _Hx7IxqcP;
        "pkg-3.4.2+1.20.1" = _nNzW31hU;
        "pkg-4.0.0+1.20.1-alpha.1-legacy" = _bsk9gYS9;
        "pkg-4.0.0+1.20.1-alpha.2-legacy" = _kMt0dMWO;
        "pkg-4.0.0+1.20.1" = _z1oaH1IK;
        "default" = _z1oaH1IK;
    });
