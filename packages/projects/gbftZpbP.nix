...
let
    ...
    in {
        ...
        "pkg-v1.0" = _oSgKourS;
        "pkg-v2.0-1.6.1+" = _q6Z19qsd;
        "pkg-v2.0-1.9+" = _ReM3Nsta;
        "pkg-v2.0-1.11+" = _hkh7IdA7;
        "pkg-v2.0-1.13+" = _nYqLrpb3;
        "pkg-v2.0-1.15+" = _u7Q33heU;
        "pkg-v2.0-1.16.2+" = _YUQwuVwV;
        "pkg-v2.0-1.17+" = _Y2yxQq0p;
        "pkg-v2.0-1.18+" = _N7jTK9YC;
        "pkg-v2.0-1.19+" = _zgCQdEar;
        "pkg-v2.0-1.19.3" = _ztjE0YLK;
        "pkg-v2.0-1.19.4" = _hwsFJ4XG;
        "pkg-v2.0_with_trims-1.20+" = _SaKg30AC;
        "pkg-v2.0-1.20+" = _9sZLZL0A;
        "pkg-v2.0_with_trims-1.20.2+" = _q0bYzVq6;
        "pkg-v2.0-1.20.2+" = _cJoNeJA5;
        "pkg-v3.0_with_trims-1.21.4+" = _4zXSGXTv;
        "pkg-v3.0-1.21.4+" = _4tUcpdtG;
        "pkg-v3.1_with_trims-26.1+" = _5fPnvMbJ;
        "pkg-v3.1-26.1+" = _QiS3Oc6k;
        "pkg-v3.2_with_trims-1.21.11+" = _tbSMHJRS;
        "pkg-v3.2-1.21.11+" = _DNv065Rn;
        "default" = _DNv065Rn;
    });
