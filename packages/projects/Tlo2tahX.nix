...
let
    ...
    in {
        ...
        "pkg-1.18.1-2.0.1" = _dnzv5acx;
        "pkg-1.18.1-2.0.2" = _rRm7ItvQ;
        "pkg-1.18.1-2.0.3" = _38U7oeAM;
        "pkg-1.18.2-2.1.0" = _LYeqH4iy;
        "pkg-1.14.4-1.1" = _aaDVtrQ7;
        "pkg-1.15.2-1.2.2" = _u0wb1X6Q;
        "pkg-1.16.4-1.5.1" = _vKFQt8lV;
        "pkg-1.19.2-2.2.0" = _XM8tBOI6;
        "pkg-1.20.1-2.2.0" = _2UVMcW0J;
        "pkg-1.20.1-3.0.0" = _Q0mfPN7r;
        "pkg-1.20.1-3.0.1" = _TGn6e0dU;
        "pkg-1.18.2-2.1.1" = _entpBdQn;
        "pkg-1.19.2-2.2.1" = _X2qu6bTt;
        "pkg-1.20.1-3.0.2" = _gsPOqbxs;
        "pkg-1.19.2-2.2.2" = _x6uuccRJ;
        "pkg-1.21.1-4.0.0" = _xFbkSSik;
        "pkg-1.21.1-4.0.1" = _BbaU1vhA;
        "pkg-1.21.1-4.0.2" = _JBydHQYr;
        "pkg-1.21.1-4.0.3" = _4q3L4XgS;
        "pkg-1.21.1-4.0.5" = _XGRj02ux;
        "pkg-1.21.1-4.0.6" = _Qzo8ophx;
        "pkg-1.21.1-4.0.7" = _Cs0pSH1m;
        "pkg-1.20.1-3.0.3" = _bBzUlSat;
        "pkg-1.21.1-4.0.8" = _vBuSA54e;
        "pkg-1.21.1-4.0.9" = _mhhhkBAM;
        "pkg-1.21.1-4.0.10" = _1HaHaAso;
        "pkg-1.21.1-4.0.11" = _NTu6eRax;
        "pkg-1.21.1-4.0.12" = _LNOcUw04;
        "pkg-1.21.1-4.0.13" = _XjC8m1Gu;
        "pkg-1.21.1-4.0.14" = _GkyunMJt;
        "pkg-26.1.0" = _qPA3oG81;
        "pkg-1.21.1-4.0.15" = _otODJ5cv;
        "pkg-26.1.1" = _fx8hDg3a;
        "default" = _fx8hDg3a;
    });
