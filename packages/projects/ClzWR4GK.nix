...
let
    ...
    in {
        ...
        "pkg-3.2-1.20.3-1.20.4" = _iQ16QFYo;
        "pkg-3.2-1.20.2" = _6Q8LRx2R;
        "pkg-3.2-1.20-1.20.1" = _LS3IVOrk;
        "pkg-3.2-1.19.4" = _Vqr2goBM;
        "pkg-3.2-1.19.3" = _2KQSbvsY;
        "pkg-3.2-1.19.1-1.19.2" = _POrlDQX0;
        "pkg-3.2-1.19" = _dX8qtqe5;
        "pkg-3.2-1.18.2" = _Gdfe2fJa;
        "pkg-3.2-1.18.1" = _QQWI5Q1M;
        "pkg-3.2-1.18" = _QLXCHlER;
        "pkg-3.2-1.17.1" = _vqVxEhfU;
        "pkg-3.2-1.17" = _9FSKCnQK;
        "pkg-3.2-1.16.5" = _i7SwsbUq;
        "pkg-3.2-1.16.2-1.16.4" = _8jdEvcR5;
        "pkg-3.2-1.16-1.16.1" = _ICH3s6hf;
        "pkg-3.3-1.16-1.16.1" = _v9SCYHwH;
        "pkg-3.3-1.16.2-1.16.4" = _UgCULUIe;
        "pkg-3.3-1.16.5" = _pmgCV2k5;
        "pkg-3.3-1.17" = _cprBjKX7;
        "pkg-3.3-1.17.1" = _W1R4m6Nf;
        "pkg-3.3-1.18" = _q8UeTM59;
        "pkg-3.3-1.18.1" = _pAN5hmV3;
        "pkg-3.3-1.18.2" = _y1Vv5crd;
        "pkg-3.3-1.19" = _nKMWByqC;
        "pkg-3.3-1.19.1-1.19.2" = _g7hd5jyR;
        "pkg-3.3-1.19.3" = _BeA8LEkD;
        "pkg-3.3-1.19.4" = _5UvScr5m;
        "pkg-3.3-1.20-1.20.1" = _SYMv2GbY;
        "pkg-3.3-1.20.2" = _OCiTZk3T;
        "pkg-3.3-1.20.3-1.20.4" = _r8FyT9SH;
        "pkg-3.3-1.20.5-1.20.6" = _UelVw7lh;
        "pkg-3.3-1.21-1.21.1" = _6s74m8DP;
        "pkg-3.3.1-1.16-1.16.1" = _hss9I3An;
        "pkg-3.3.1-1.16.2-1.16.4" = _Fw2zNwPG;
        "pkg-3.3.1-1.16.5" = _Fi4ovBjR;
        "pkg-3.3.1-1.17" = _jD6HNDK8;
        "pkg-3.3.1-1.17.1" = _GfHJ5FQY;
        "pkg-3.3.1-1.18" = _iuGveHv1;
        "pkg-3.3.1-1.18.1" = _HaRLVC9y;
        "pkg-3.3.1-1.18.2" = _Y9dXGYzA;
        "pkg-3.3.1-1.19" = _Ylvuc9Sq;
        "pkg-3.3.1-1.19.1-1.19.2" = _q1XNNJ8D;
        "pkg-3.3.1-1.19.3" = _HnWoVZS3;
        "pkg-3.3.1-1.19.4" = _bmbJALO7;
        "pkg-3.3.1-1.20-1.20.1" = _sjqfVYX8;
        "pkg-3.3.1-1.20.2" = _pAW5B1ET;
        "pkg-3.3.1-1.20.3-1.20.4" = _1yeOUUlE;
        "pkg-3.3.1-1.20.5-1.20.6" = _8ieFfjuR;
        "pkg-3.3.1-1.21-1.21.1" = _Q5zVJv3I;
        "pkg-3.3.1-1.21.2-1.21.4" = _SwELMsmD;
        "default" = _SwELMsmD;
    });
