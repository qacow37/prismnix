...
let
    ...
    in {
        ...
        "pkg-0.1.2+1.20.1" = _m7Lgm8hK;
        "pkg-0.1.1+1.19.4" = _LZLtVgqa;
        "pkg-0.1.1+1.18.2" = _nIO7QC7M;
        "pkg-0.1.1+1.19.3" = _igllhLFS;
        "pkg-0.1.1+1.19.2" = _1erCetvG;
        "pkg-0.1.1+1.16.5" = _zWFbKQhD;
        "pkg-0.1.2+1.16.5" = _RhNYCcIM;
        "pkg-0.1.2+1.19.3" = _7dqU8eac;
        "pkg-0.1.3+1.20.1" = _BgMtpRGo;
        "pkg-0.1.2+1.19.4" = _DdwTwijv;
        "pkg-0.1.2+1.19.2" = _bwlFgqWO;
        "pkg-0.1.2+1.18.2" = _L5KtvJvn;
        "pkg-0.1.3+1.16.5" = _IZqfjY96;
        "pkg-0.1.3+1.18.2" = _jsZuXFzy;
        "pkg-0.1.4+1.16.5" = _uzzXZrCs;
        "pkg-0.1.3+1.19.2" = _RrIca7qx;
        "pkg-0.1.3+1.19.4" = _cYFh4a2b;
        "pkg-0.1.4+1.20.1" = _YgHO99D8;
        "pkg-0.1.3+1.19.3" = _kgF8B46D;
        "pkg-0.1.4+1.19.4" = _T4KlCMzj;
        "pkg-0.1.5+1.20.1" = _18FTecpJ;
        "pkg-0.1.4+1.19.3" = _xoCdiQHY;
        "pkg-0.1.4+1.19.2" = _bhpUY0SA;
        "pkg-0.1.4+1.18.2" = _d4rDqsnh;
        "pkg-0.1.5+1.16.5" = _1HYIaLuU;
        "pkg-lexforge-0.1.1+1.20.2" = _BzdfpZfe;
        "pkg-neoforge-0.1.0+1.20.2" = _BAVFDr9B;
        "pkg-0.1.6+1.20.1" = _8xdhlPCJ;
        "pkg-0.1.0+1.20.4" = _iN95aGh4;
        "pkg-0.1.6+1.16.5" = _Q5QeW2N7;
        "pkg-0.1.5+1.19.2" = _urYBzvtU;
        "pkg-0.1.5+1.18.2" = _moeCujqS;
        "pkg-0.1.1+1.20.2" = _Q3dbVMx1;
        "pkg-0.1.7+1.20.1" = _gL4xb5aw;
        "pkg-0.1.1+1.20.4" = _29VEzD1q;
        "pkg-0.2.0+mc1.20.4-fabric" = _sS8xNLfi;
        "pkg-0.2.0+mc1.20.4-neoforge" = _oN4QkegK;
        "pkg-0.2.1+mc1.20.4-fabric" = _IQ1uiXHc;
        "pkg-0.2.1+mc1.20.4-neoforge" = _3nMO9jfc;
        "pkg-0.2.2+mc1.20.4-fabric" = _AMvRSg7p;
        "pkg-0.2.2+mc1.20.4-neoforge" = _doJw68CH;
        "pkg-0.2.0+mc1.16.5-fabric" = _YyRYjgpq;
        "pkg-0.2.0+mc1.16.5-forge" = _X857RLfZ;
        "pkg-0.2.0+mc1.18.2-fabric" = _qO6GwRlw;
        "pkg-0.2.0+mc1.18.2-forge" = _wGVPnuOQ;
        "pkg-0.2.0+mc1.19.2-fabric" = _HOHsa6Ij;
        "pkg-0.2.0+mc1.19.2-forge" = _CbDFbHrH;
        "pkg-0.2.3+mc1.20.4-fabric" = _GXdBQIBF;
        "pkg-0.2.3+mc1.20.4-neoforge" = _Uz6TYn6f;
        "pkg-0.2.0+mc1.20.1-fabric" = _UGTsNdUR;
        "pkg-0.2.0+mc1.20.1-forge" = _euzZ7R0y;
        "pkg-0.2.1+mc1.20.1-fabric" = _aMDVprYS;
        "pkg-0.2.1+mc1.20.1-forge" = _WRwefikH;
        "pkg-0.2.1+mc1.16.5-fabric" = _2q05WlUa;
        "pkg-0.2.1+mc1.18.2-fabric" = _d9jnqqBp;
        "pkg-0.2.1+mc1.19.2-fabric" = _uWZt54MJ;
        "pkg-0.2.1+mc1.19.2-forge" = _Ibl9WDtW;
        "pkg-0.2.2+mc1.20.1-fabric" = _KMEZDiuh;
        "pkg-0.2.2+mc1.20.1-forge" = _zfxPcTIH;
        "pkg-0.2.4+mc1.20.4-fabric" = _1GpjHSCQ;
        "pkg-0.2.4+mc1.20.4-neoforge" = _rg95B4dn;
        "pkg-0.2.2+mc1.16.5-fabric" = _6ke1hVvZ;
        "pkg-0.2.2+mc1.16.5-forge" = _cMsJhzz1;
        "pkg-0.2.5+mc1.20.4-fabric" = _pg7wiFsB;
        "pkg-0.2.5+mc1.20.4-neoforge" = _tO1MiEO4;
        "pkg-0.2.2+mc1.18.2-fabric" = _KIUKMIXH;
        "pkg-0.2.2+mc1.19.2-fabric" = _pu9jKeK9;
        "pkg-0.2.2+mc1.19.2-forge" = _ux5bh0h1;
        "pkg-0.2.3+mc1.20.1-fabric" = _VTzHz71U;
        "pkg-0.2.3+mc1.20.1-forge" = _c2Th4NIB;
        "pkg-0.2.3+mc1.16.5-fabric" = _qGKe5QHU;
        "pkg-0.2.3+mc1.16.5-forge" = _PJHSvVOR;
        "pkg-0.2.5+mc1.20.6-fabric" = _fIzuAgUh;
        "pkg-0.2.5+mc1.20.6-neoforge" = _57hUqHDh;
        "pkg-0.2.6+mc1.20.6-fabric" = _7lXeYdGV;
        "pkg-0.2.6+mc1.20.6-neoforge" = _A1Z7TP49;
        "pkg-0.2.7+mc1.21-fabric" = _7Np8Rk9W;
        "pkg-0.2.7+mc1.21-neoforge" = _zYTGJ1uH;
        "pkg-0.2.8+mc1.21-fabric" = _cWVKZOIE;
        "pkg-0.2.8+mc1.21-neoforge" = _SZrWYqw9;
        "pkg-0.2.9+mc1.21-fabric" = _lSVpt79H;
        "pkg-0.2.9+mc1.21-neoforge" = _lvpfsK5V;
        "pkg-0.2.10+mc1.21.1-fabric" = _ojqaR5dJ;
        "pkg-0.2.10+mc1.21.1-neoforge" = _TEiHtdfP;
        "pkg-0.2.11+mc1.21.1-fabric" = _eFFsHtIr;
        "pkg-0.2.11+mc1.21.1-neoforge" = _tApwsw9C;
        "default" = _tApwsw9C;
    });
