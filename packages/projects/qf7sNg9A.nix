...
let
    ...
    in {
        ...
        "pkg-1.0.0-SNAPSHOT+f380d83" = _Lf05EDx4;
        "pkg-1.0.0-SNAPSHOT+0aa6d6b" = _I0KoM8Gu;
        "pkg-1.0.0-SNAPSHOT+2ffc72f" = _xOGxa5hs;
        "pkg-1.0.0-SNAPSHOT+d0c4a33" = _Ol4FtloL;
        "pkg-1.0.0-SNAPSHOT+5618cb5" = _S3oaiemH;
        "pkg-1.0.0-SNAPSHOT+8867f17" = _ppH06OMA;
        "pkg-1.0.0-SNAPSHOT+4947527" = _WCzU7aAh;
        "pkg-1.0.0-SNAPSHOT+797f596" = _QygVg0rU;
        "pkg-1.0.0-SNAPSHOT+40d02dc" = _sFtIQl3g;
        "pkg-1.0.0-SNAPSHOT+e6629b2" = _fwTipsRU;
        "pkg-1.0.0-SNAPSHOT+85fd9f3" = _nsCHr932;
        "pkg-1.0.0-SNAPSHOT+3" = _keY4QTkT;
        "pkg-1.0.0-SNAPSHOT+4" = _sLsQkn4p;
        "pkg-1.0.0-SNAPSHOT+5" = _ZtqzvF9g;
        "pkg-1.0.0-SNAPSHOT+6" = _GyW46CDc;
        "pkg-1.0.0-SNAPSHOT+7" = _95NZl0HQ;
        "pkg-1.0.0" = _Z4eXNNVx;
        "pkg-1.1.0-SNAPSHOT+11" = _q9tfECQy;
        "pkg-1.1.0-SNAPSHOT+12" = _Sii19gPj;
        "pkg-1.1.0-SNAPSHOT+13" = _dLIHn5YF;
        "pkg-1.1.0-SNAPSHOT+14" = _hWDAPcsZ;
        "pkg-1.1.0-SNAPSHOT+15" = _2MY9xoLT;
        "pkg-1.1.0-SNAPSHOT+16" = _YZ2fNtQn;
        "pkg-1.1.0-SNAPSHOT+17" = _5JIxtC50;
        "pkg-1.1.0-SNAPSHOT+18" = _LH0DaNHi;
        "pkg-1.1.0-SNAPSHOT+19" = _GbmAtwFb;
        "pkg-1.1.0-SNAPSHOT+20" = _sPzeIbee;
        "pkg-1.1.0-SNAPSHOT+21" = _f1vAT2yT;
        "pkg-1.1.0-SNAPSHOT+22" = _u8FK8MZY;
        "pkg-1.1.0-SNAPSHOT+28" = _UiKiG4dN;
        "pkg-1.1.0-SNAPSHOT+29" = _E2VPL15t;
        "pkg-1.1.0-SNAPSHOT+30" = _NP9OzpkK;
        "pkg-1.2.0-SNAPSHOT+31" = _d1NwyS0R;
        "pkg-1.1.0-SNAPSHOT+32" = _uhZADgN3;
        "pkg-1.1.0" = _iCJRYAlJ;
        "default" = _iCJRYAlJ;
    });
