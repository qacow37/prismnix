...
let
    ...
    in {
        ...
        "pkg-1.2.3-1.19.4" = _L5KH45lm;
        "pkg-1.3.0-1.19.4" = _vrRpPtzm;
        "pkg-1.3.0-1.20-rc1" = _pSdkZeTW;
        "pkg-1.3.0-1.20" = _6FOBLIie;
        "pkg-1.3.1-1.20.1" = _A1SZUVne;
        "pkg-1.3.2-1.20.2" = _qZuBkKeD;
        "pkg-1.4.0-1.20.2" = _8YGLHl2l;
        "pkg-1.4.1-1.20.4" = _rGLQe7tG;
        "pkg-1.4.2-1.20.4" = _isjYNkMv;
        "pkg-1.4.3-1.20.6" = _waeAwooq;
        "pkg-1.4.4-1.21" = _iqO9a2gQ;
        "pkg-1.4.5-1.21" = _hXnthJh2;
        "pkg-1.5.0-1.21" = _DNqmRdIA;
        "pkg-1.5.1-1.21.3" = _zjEvdvTm;
        "pkg-1.5.1-1.21.4" = _iFEF2fWm;
        "pkg-1.5.1-1.21.5" = _p1yMwjBz;
        "pkg-1.5.1-1.21.6" = _fearDrme;
        "pkg-1.5.1-1.21.7" = _WI8xD2ee;
        "pkg-1.6.0-1.21.10" = _V3poqkCb;
        "pkg-1.6.0-1.21.11" = _S5xAl0kC;
        "pkg-1.7.0-1.21.11" = _Vg9iZPtV;
        "pkg-1.8.0-1.21.11" = _SEonnnXT;
        "pkg-1.9.0-26.1" = _9Um2oTZ9;
        "pkg-1.9.1-26.1" = _U4diXqQG;
        "pkg-1.10.0-26.2" = _2ykDDaNM;
        "default" = _2ykDDaNM;
    });
