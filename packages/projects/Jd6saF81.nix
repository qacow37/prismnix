...
let
    ...
    in {
        ...
        "pkg-2.1-1.20" = _RBJpLKRu;
        "pkg-2.1-1.21" = _ymfJ6pAU;
        "pkg-2.1-1.21.2" = _uQgGF4Cf;
        "pkg-2.1-1.21.4" = _WXQKpDYj;
        "pkg-2.1-1.21.6-8" = _sfk1YUFH;
        "pkg-2.1-1.21.9" = _K0uD55Kx;
        "pkg-2.1-1.21.11" = _QnQpQu5D;
        "pkg-2.2.1-1.20" = _z3HxOKEu;
        "pkg-2.1.1-1.21" = _4BfStkNg;
        "pkg-2.2.1-1.21.2" = _DUjTOJDH;
        "pkg-2.2.1-1.21.4" = _QK2qvZEU;
        "pkg-2.2.1-1.21.5" = _MyIDH9bG;
        "pkg-2.2.1-1.21.8" = _4fcECF7o;
        "pkg-2.2.1-1.21.9" = _v8rIj4xT;
        "pkg-2.2.1-1.21.11" = _qfxIyJR0;
        "pkg-2.3-1.20" = _Wf55XxAr;
        "pkg-2.3-1.21" = _3hDRzaFx;
        "pkg-2.3-1.21.2-3" = _Npj8B2PW;
        "pkg-2.3-1.21.4" = _M7m09oKY;
        "pkg-2.3-1.21.5" = _vja25WpF;
        "pkg-2.3-1.21.6-8" = _7BWHVuiT;
        "pkg-2.3-1.21.9" = _9Mjm2WAn;
        "pkg-2.3-1.21.11" = _x81NMoo2;
        "pkg-2.4-1.21.11" = _22UQPedk;
        "pkg-2.4-1.21.9" = _98S1ASlo;
        "pkg-2.4-1.21.6-8" = _Ju9SeLFd;
        "pkg-2.4-1.21.5" = _pR54QwvP;
        "default" = _pR54QwvP;
    });
