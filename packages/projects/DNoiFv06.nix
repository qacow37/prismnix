...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.0" = _Vwf5mNkM;
        "pkg-1.18.2-1.0.1" = _CX8IkvXQ;
        "pkg-1.19.2-1.1.0" = _zSz2pNUT;
        "pkg-1.18.2-1.0.2" = _Y4KxMqjX;
        "pkg-1.19.2-1.1.1" = _BFXioGOb;
        "pkg-1.2.0" = _XXJGeLNX;
        "pkg-1.2.1" = _EJjCw9G1;
        "pkg-1.2.4" = _Go7tBFO0;
        "pkg-1.2.5" = _847KFer9;
