...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _NHZIP93n;
        "pkg-1.1.0-1.18.2-fabric" = _eHwZmtHq;
        "pkg-1.1.0-1.19.2-fabric" = _a07x6LCo;
        "pkg-1.1.0-1.19.3-fabric" = _7h8LRaKG;
        "pkg-1.1.0-1.19.4-fabric" = _GGvxee8c;
        "pkg-1.1.0-1.20-fabric" = _LzOSLCC2;
        "pkg-1.1.1-1.20.4-fabric" = _gSZ3DFYM;
        "pkg-1.1.2-1.20.4-fabric" = _EBQSEiFA;
        "pkg-1.1.2-1.20-fabric" = _kYBGrRfI;
        "pkg-1.1.3-1.20-fabric" = _EeDvXKwi;
        "pkg-1.1.3-1.20.4-fabric" = _Ya3uMd8M;
        "pkg-1.1.3-1.19.2-fabric" = _rjgmOoJ4;
        "pkg-1.1.3-1.18.2-fabric" = _80vueSBC;
        "pkg-1.1.4-1.18.2-forge" = _CvpRzV5E;
        "pkg-1.1.4.1-1.18.2-forge" = _GSA2446w;
        "pkg-1.1.4.1-1.18.2-fabric" = _th0s6LiY;
        "pkg-1.1.4.1-1.19.2-fabric" = _SZZ3uToc;
        "pkg-1.1.4.1-1.20.1-fabric" = _1KCOAajo;
        "pkg-1.1.4.1-1.20.4-fabric" = _eAHkv8iF;
        "pkg-1.1.4.2-1.18.2-forge" = _xlHTxWSJ;
        "pkg-1.1.4.2-1.18.2-fabric" = _rx9xYc2D;
        "pkg-1.1.4.2-1.19.2-fabric" = _5j3bf1T2;
        "pkg-1.1.4.2-1.20.1-fabric" = _8NbsppBy;
        "pkg-1.1.4.2-1.20.4-fabric" = _7oI40RjR;
        "pkg-1.1.4.3-1.18.2-forge" = _S2m04eQN;
        "pkg-1.1.4.4a-1.20.1-forge" = _u8Qyi6LV;
        "pkg-1.1.4.4b-1.20.1-forge" = _8kFqV4NC;
        "pkg-1.1.4.4c-1.20.1-forge" = _rEwuZxo7;
        "pkg-1.1.4.4d-1.20.1-forge" = _Tp3a2cKy;
        "pkg-1.1.5-1.18.2-fabric" = _eBOJI5QW;
        "pkg-1.1.5-1.18.2-forge" = _KSFkvGsU;
        "pkg-1.1.5-1.19.2-fabric" = _PkifqEkV;
        "pkg-1.1.5-1.20.1-fabric" = _p8i1nRnc;
        "pkg-1.1.5-1.20.1-forge" = _9m3rSFLT;
        "pkg-1.1.5-1.20.4-fabric" = _eQZrn026;
        "pkg-1.2-1.20.1-fabric" = _hW06nZKl;
        "pkg-1.2.1-1.20.1-fabric" = _1KxoA1ja;
        "pkg-1.2.2-1.20.1-fabric" = _OC5z6V7b;
        "pkg-1.2.2-1.20.1-forge" = _fzdG3uJn;
        "pkg-1.2.3-1.20.1-fabric" = _ExumPhsN;
        "pkg-1.2.3-1.20.1-forge" = _cdWnZKmj;
        "pkg-1.2.4-1.20.1-fabric" = _3DId1B5F;
        "pkg-1.2.4-1.20.1-forge" = _rZ2vsxRi;
        "pkg-1.3-1.20.1-fabric" = _EUygDfxH;
        "pkg-1.3.1-1.21.1-fabric" = _iIXYcJsp;
        "pkg-1.3.1-1.20.1-fabric" = _tEdCsSoG;
        "pkg-1.3.2-1.21.1-fabric" = _3zpz1gLv;
        "pkg-1.4-1.21.1-fabric" = _KwnI2r6V;
        "pkg-1.3.1-1.20.1-forge" = _BzcVOhem;
        "pkg-1.4.1-1.21.1-fabric" = _qCGm0W32;
        "pkg-1.4.2-1.20.1-fabric" = _WnLi2aI5;
        "pkg-1.4.3-1.21.1-fabric" = _vX99ppk8;
        "pkg-1.4.3-1.20.1-fabric" = _6RyDzfqz;
        "pkg-1.4.4-1.20.1-forge" = _apXxMFHS;
        "pkg-1.4.4-1.20.1-fabric" = _r8ZMmPwD;
        "pkg-1.4.4-1.21.1-fabric" = _sql1KEdb;
        "pkg-1.4.5-1.20.1-forge" = _js9Ma0Jz;
        "pkg-1.4.6-1.20.1-forge" = _9uNei0P7;
        "pkg-1.4.6-1.20.1-fabric" = _zFHKoDPL;
        "pkg-1.4.7-1.20.1-forge" = _lqJPOZnT;
        "pkg-1.4.8-1.20.1-forge" = _qGXBaWEo;
