...
let
    ...
    in {
        ...
        "pkg-1.38" = _ATdVPMvL;
        "pkg-1.39" = _N9b7cFG3;
        "pkg-1.4.0.3" = _77Uvm0UV;
        "pkg-1.4.0.4" = _ZuAUxcAI;
        "pkg-1.4.1.0" = _8WkyvErU;
        "pkg-1.4.1.1" = _rcrY6hJF;
        "pkg-1.4.1.2" = _kJEw6P8C;
        "pkg-1.4.1.3" = _2oTaJ5JJ;
        "pkg-1.4.1.4" = _UWhpMrZs;
        "pkg-1.4.1.5" = _7jmAu1xJ;
        "pkg-1.4.2.0" = _WdJajoPK;
        "pkg-1.4.3.0" = _1tSYayUj;
        "pkg-1.4.3.1" = _ypJXoyPb;
        "pkg-1.4.4.0" = _UHFBvkg6;
        "pkg-1.4.4.1" = _Wl2vSORs;
        "pkg-1.4.5.0" = _9t6VdMmP;
        "pkg-1.4.5.1" = _PPuBtlYw;
        "pkg-1.4.6.0" = _nYxtm03W;
        "pkg-1.4.6.1" = _sZgykcAN;
        "pkg-1.4.6.2" = _kTnz3vnL;
        "pkg-1.4.6.3" = _gPThL4g7;
        "pkg-1.4.6.4" = _S4WxKPXV;
        "pkg-1.4.6.5" = _PQmLg6mN;
        "pkg-1.4.6.6" = _BhhHcd94;
        "pkg-1.4.6.7" = _PqhlxyfZ;
        "default" = _PqhlxyfZ;
    });
