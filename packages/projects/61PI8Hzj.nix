...
let
    ...
    in {
        ...
        "pkg-0.0.1a" = _L8QQ3wEX;
        "pkg-0.0.2" = _p4S6MRSS;
        "pkg-0.0.3" = _b8SmCdVj;
        "pkg-0.0.3a" = _91zCjval;
        "pkg-v0.1+1.21.1-fabric" = _da1QVhEj;
        "pkg-v0.1+1.20.1-fabric" = _CbKedknB;
        "pkg-v0.1+1.21.4-fabric" = _F13ietG2;
        "pkg-v0.1+1.21.1-neoforge" = _cbxlPEDN;
        "pkg-v0.1+1.21.4-neoforge" = _V1jgTK6s;
        "pkg-v0.1+1.20.1-forge" = _mQbL9z55;
        "pkg-v0.1.1+1.20.1-fabric" = _m5Ig9dYs;
        "pkg-v0.1.1+1.21.4-fabric" = _xRGlFlbp;
        "pkg-v0.1.1+1.21.1-fabric" = _mO6nVWBw;
        "pkg-v0.1.1+1.21.1-neoforge" = _52LH8jJd;
        "pkg-v0.1.1+1.21.4-neoforge" = _OylEr4Po;
        "pkg-v0.1.1+1.20.1-forge" = _T9JcBujq;
        "pkg-v0.1.2+1.21.4-fabric" = _XuFHvzF6;
        "pkg-v0.1.2+1.20.1-fabric" = _yr2hdTPG;
        "pkg-v0.1.2+1.21.1-fabric" = _WWO3CBG8;
        "pkg-v0.1.2+1.21.1-neoforge" = _Enpo7bPg;
        "pkg-v0.1.2+1.21.4-neoforge" = _bAmC5SyK;
        "pkg-v0.1.2+1.20.1-forge" = _xz0xV5Q7;
        "pkg-v0.1.2+1.21.9+1.21.9-fabric" = _aozfDaql;
        "pkg-v0.2.0+1.20.1-fabric" = _jIWXrtCq;
        "pkg-v0.2.0+1.21.1-fabric" = _qkMluzwp;
        "pkg-v0.2.0+1.21.11-fabric" = _9yhjvcBM;
        "pkg-v0.2.0+1.21.9-fabric" = _FuVc2UVM;
        "pkg-v0.2.0+1.21.4-fabric" = _xdu0LoT5;
        "pkg-v0.2.0+1.21.1-neoforge" = _GUp49dNY;
        "pkg-v0.2.0+1.21.4-neoforge" = _CgCuTNxZ;
        "pkg-v0.2.0+1.20.1-forge" = _x37h9HPl;
        "pkg-v0.2.1+1.20.1-fabric" = _QZl8GG1r;
        "pkg-v0.2.1+1.21.1-fabric" = _NNm3q9VB;
        "pkg-v0.2.1+1.21.11-fabric" = _ZJOz8CcA;
        "pkg-v0.2.1+1.21.4-fabric" = _9gumQ4DW;
        "pkg-v0.2.1+1.21.9-fabric" = _Yr5CLrfa;
        "pkg-v0.2.1+1.21.1-neoforge" = _FSYfDH3A;
        "pkg-v0.2.1+1.21.4-neoforge" = _nGFQI7XK;
        "pkg-v0.2.1+1.20.1-forge" = _dIhmpgSQ;
        "pkg-v0.3.0+26.1-fabric" = _kLdEk8Ld;
        "pkg-v0.3.0+1.21.11-fabric" = _cnI3TNwp;
        "pkg-v0.3.0+1.21.1-fabric" = _BYq1R8Iu;
        "pkg-v0.3.0+1.20.1-fabric" = _KKkPRaNy;
        "pkg-v0.3.0+1.21.4-fabric" = _4Ctkxvo9;
        "pkg-v0.3.0+1.21.9-fabric" = _IBkSE2mj;
        "pkg-v0.3.0+1.21.1-neoforge" = _6cZ4GRV6;
        "pkg-v0.3.0+1.21.4-neoforge" = _JQIrNTPI;
        "pkg-v0.3.0+1.20.1-forge" = _VqZD4Paq;
        "pkg-v0.3.1+1.21.9-fabric" = _RrnuFB09;
        "pkg-v0.3.1+26.1-fabric" = _jZsIfOI1;
        "pkg-v0.3.1+1.21.4-fabric" = _zlcrkzwQ;
        "pkg-v0.3.1+1.20.1-fabric" = _n6jTFnpA;
        "pkg-v0.3.1+1.21.11-fabric" = _CFSPL1OY;
        "pkg-v0.3.1+1.21.1-fabric" = _Mzk6zDEZ;
        "pkg-v0.3.2+1.21.1-fabric" = _Jjx7KboT;
        "pkg-v0.3.2+1.21.4-fabric" = _qtTsJki7;
        "pkg-v0.3.2+1.21.11-fabric" = _GL9Vujrt;
        "pkg-v0.3.2+1.20.1-fabric" = _M7dSmSpc;
        "pkg-v0.3.2+1.21.9-fabric" = _1azUUEQy;
        "pkg-v0.3.2+26.1-fabric" = _YCpnZKsd;
        "pkg-v0.3.2+1.21.1-neoforge" = _xjfSBf8L;
        "pkg-v0.3.2+1.21.4-neoforge" = _ZQLXQmQc;
        "pkg-v0.3.2+1.20.1-forge" = _Z0NuiQ9A;
        "pkg-v0.3.3+1.21.1-fabric" = _VccdwSti;
        "pkg-v0.3.3+1.21.9-fabric" = _xsldufvV;
        "pkg-v0.3.3+1.21.11-fabric" = _aOgD0iSC;
        "pkg-v0.3.3+1.20.1-fabric" = _N8ow6VeJ;
        "pkg-v0.3.3+26.1-fabric" = _84KIjSOC;
        "pkg-v0.3.3+1.21.4-fabric" = _vNfVT1oS;
        "pkg-v0.3.3+1.21.1-neoforge" = _QnJ9WVDV;
        "pkg-v0.3.3+1.21.4-neoforge" = _mlXLSosy;
        "pkg-v0.3.3+1.20.1-forge" = _FXIs1tHj;
        "pkg-v0.3.3+26.2-fabric" = _BrSfHZnf;
        "default" = _BrSfHZnf;
    });
