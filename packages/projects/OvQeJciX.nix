...
let
    ...
    in {
        ...
        "pkg-1.19.3-1.1.9" = _CKjJpyrT;
        "pkg-1.19.3-1.1.10" = _zu5k1Ooq;
        "pkg-1.19.3-1.1.12" = _QbNxzvci;
        "pkg-1.19.3-1.1.13" = _ytcM6Dpx;
        "pkg-1.19.3-1.1.14" = _MbLm4qXN;
        "pkg-1.19.3-1.2.0" = _V2UVlro4;
        "pkg-1.19.3-1.2.1" = _dgbU7UmH;
        "pkg-1.19.3-1.2.3" = _5AvDbZHs;
        "pkg-1.19.3-1.2.4" = _NwVNNBoq;
        "pkg-1.19.3-1.3.1" = _WnNNPN5r;
        "pkg-1.19.3-1.3.2" = _fWqELGxW;
        "pkg-1.19.3-1.3.3" = _hrZ07OgP;
        "pkg-1.19.3-1.3.4" = _O0NNxPWk;
        "pkg-1.19.4-1.4.0" = _aOECCATW;
        "pkg-1.19.4-1.4.1" = _BRuuil6v;
        "pkg-1.19.4-1.4.2" = _fwCVhoYm;
        "pkg-1.19.4-1.4.3" = _PSkxDqE2;
        "pkg-1.19.4-1.4.4" = _i4kB8A2q;
        "pkg-1.19.4-1.4.5" = _uYLyYlme;
        "pkg-1.19.4-1.4.6" = _adBYl9tK;
        "pkg-1.19.4-1.5.0" = _lUGFFWbu;
        "pkg-1.20.1-1.6.0" = _3xS9VaAr;
        "pkg-1.20.1-1.6.1" = _HYwsmzuV;
        "pkg-1.20.1-1.7.0" = _2eDHGaY8;
        "pkg-1.20.1-1.7.1" = _ZJeuBwgj;
        "pkg-1.20.1-1.7.2" = _H21ov78q;
        "pkg-1.20.1-1.7.3" = _2ZFQvshm;
        "pkg-1.20.1-1.7.4" = _sPwljooz;
        "pkg-1.20.1-1.8.0" = _Hga7mlo2;
        "pkg-1.20.1-1.8.1" = _sSHqrgRG;
        "pkg-1.20.1-1.8.2" = _4HrliPPb;
        "pkg-1.20.1-1.8.3" = _jPrk2kUf;
        "pkg-1.20.1-1.8.4" = _NVvEFMvv;
        "pkg-1.20.1-1.9.0" = _KJl1h2Oq;
        "pkg-1.20.1-1.10.0" = _LofQlvCi;
        "pkg-1.20.1-1.10.1" = _ybTV3Vwu;
        "pkg-1.20.1-1.10.2" = _fRJ3uCSE;
        "pkg-1.20.1-1.10.3" = _jHDfsFp6;
        "pkg-1.20.1-1.10.4" = _8gxvWKDr;
        "pkg-1.20.1-1.10.5" = _1R3KY7Z1;
        "default" = _1R3KY7Z1;
    });
