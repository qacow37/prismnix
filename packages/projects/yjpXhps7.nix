...
let
    ...
    in {
        ...
        "pkg-1.4.4" = _o61y3ktj;
        "pkg-1.4.5" = _ztuKmPWj;
        "pkg-2.0.0-beta" = _BFUBguW1;
        "pkg-2.0.1-beta" = _DQIHNgU1;
        "pkg-2.0.2-beta" = _KDj7OIf0;
        "pkg-2.0.3-beta" = _ufIsis9Q;
        "pkg-2.0.4-beta" = _1lu7mjFf;
        "pkg-2.0.5-beta" = _kpsNhaNU;
        "pkg-2.1.0" = _Xwu5VFy9;
        "pkg-2.0.6-beta" = _v8FeS4FB;
        "default" = _v8FeS4FB;
    });
