...
let
    ...
    in {
        ...
        "pkg-1.19-1.19.2" = _FZaLDvn7;
        "pkg-1.19.3" = _2uzIlVFj;
        "pkg-1.19.4" = _qFrhX9n8;
        "pkg-1.20-1.20.2" = _G35ynT0n;
        "pkg-1.20.2" = _GvGrfABF;
        "pkg-1.20-1.20.1" = _UCQZvfpp;
        "pkg-1.20.3-1.20.4" = _cmJcaIDt;
        "pkg-1.16" = _8JRBJTxD;
        "pkg-1.17" = _aVH9CeoU;
        "pkg-1.18" = _Ll9yPOrf;
        "pkg-1.19" = _WtERJf9c;
        "pkg-1.20" = _916HrDPo;
        "pkg-1.20.5-1.20.6" = _2a4Tbycz;
        "pkg-1.21" = _5qCRfepW;
        "pkg-1.21.1" = _xPeTQZiK;
        "pkg-1.21.2-1.21.3" = _oLLk32OI;
        "pkg-1.21.4" = _KGGdzqQ9;
        "pkg-4.0" = _aDCmSsXu;
        "pkg-4.1" = _UvRF1Vim;
        "pkg-4.2" = _DAwDnLog;
        "pkg-4.3" = _FysTO9qs;
