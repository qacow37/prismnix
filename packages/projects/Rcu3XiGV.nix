...
let
    ...
    in {
        ...
        "pkg-1.0.3.3" = _3oq3Zzjd;
        "pkg-1.0.4" = _9EEBHXUq;
        "pkg-1.0.5" = _4x8hyUgj;
        "pkg-1.0.6" = _Xv97edAA;
        "pkg-1.0.7" = _vjeKLjbo;
        "pkg-1.0.7.1" = _wgQNGQAx;
        "pkg-1.0.8" = _EO7Edgc2;
        "pkg-1.0.8.1" = _PzfkNV5I;
        "pkg-1.0.9" = _3GK8RwH5;
        "pkg-1.1.0" = _5twHvPy4;
        "pkg-1.1.1" = _PqDjroqo;
        "pkg-1.1.2" = _Ou3cye0T;
        "pkg-1.1.3" = _uPd0j4Dx;
        "pkg-1.1.3.1" = _KZYtfdbq;
        "pkg-1.1.4" = _BrJ5Zuq6;
        "pkg-1.1.4.1" = _Yp84vxTH;
        "pkg-1.1.5" = _GJWqVUx1;
        "pkg-1.1.6" = _uRx4FeLo;
        "pkg-1.1.6.1" = _vH4O7NIY;
        "pkg-1.1.6.2" = _5dqm1Pgj;
        "pkg-1.1.7" = _bEI89WNd;
        "pkg-1.1.7.1" = _C4DfzosL;
        "default" = _C4DfzosL;
    });
