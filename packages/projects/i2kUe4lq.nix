...
let
    ...
    in {
        ...
        "pkg-0.1" = _WtDsFjzh;
        "pkg-0.2-1.20.1" = _n92y5meB;
        "pkg-0.2-1.20" = _5ckc8NzU;
        "pkg-0.2.1+1.20-1.20.1" = _xn2kV197;
        "pkg-0.3+1.20-1.20.1" = _9su4u7T0;
        "pkg-1.20-1.20.1+0.4-beta" = _wChqKomP;
        "pkg-1.19.2-1.19.3+0.4-beta" = _u1gU8ac3;
        "pkg-1.19.2-1.19.3+0.4.1-beta" = _GoZsrIV5;
        "pkg-1.20-1.20.1+0.4.2-beta" = _89s78sTK;
        "pkg-1.19.3-1.20.1+0.4.3-beta" = _7xDQbGrA;
        "pkg-1.19.2+0.4.3-beta" = _lnewxGBB;
        "pkg-1.19.3-1.20.1+0.5-beta" = _c4QtQfol;
        "pkg-1.19.3-1.20.1+0.5.1-beta" = _b2jQX3Ie;
        "pkg-1.19.3-1.20.1+0.5.2-beta" = _vSLjfELU;
        "pkg-1.19.3-1.20.1+0.5.3-beta" = _gfsCiAgB;
        "pkg-0.6-beta" = _wvior7Dr;
        "pkg-0.7-beta" = _G3wnsOjf;
        "pkg-0.8-beta" = _lPWpo0am;
        "pkg-0.9" = _EWXAuaAD;
        "pkg-0.10" = _NAOPX5Pl;
        "pkg-0.11" = _AuMeKq5o;
        "pkg-0.12" = _gMONewv1;
        "pkg-0.12.1" = _SoIjMcCy;
        "pkg-0.12.2-1.19.2" = _lm9zPoOK;
        "pkg-0.12.2-1.20" = _bU2REhDE;
        "pkg-0.12.2-1.20.5" = _qrZFteBM;
        "pkg-0.12.2-1.21" = _vZJJT3uy;
        "pkg-0.12.3" = _iTE1ekuA;
        "pkg-0.12.4" = _WHCsRgc8;
        "pkg-0.12.5" = _QlPoFI9Y;
        "pkg-0.12.6" = _I50HH2WR;
        "pkg-0.12.7" = _4Hy3Cjgh;
        "pkg-0.13" = _MEA0LFCB;
        "pkg-0.13.1" = _Pn9ulVJ6;
        "pkg-0.13.2" = _gs0LTovD;
        "pkg-0.13.3" = _3XmVbWCC;
        "pkg-0.14.0-APLHA.1" = _Wv1W0jLt;
        "pkg-0.14.0-APLHA.2.1" = _P9iMIPAu;
        "pkg-0.14.0-APLHA.2.2" = _BIDuLPvL;
        "pkg-0.14.0" = _L2rLjmWL;
        "default" = _L2rLjmWL;
    });
