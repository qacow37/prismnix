...
let
    ...
    in {
        ...
        "pkg-1.0.0-fabric" = _FkqL4PMc;
        "pkg-1.0.0-forge" = _vemiNYY1;
        "pkg-1.0.0-fabric-java8" = _IWVPuGfe;
        "pkg-1.0.0-forge-java8" = _QWm1dT59;
        "pkg-1.0.0-forge-1.12" = _uqqBA84U;
        "pkg-1.0.1-forge-1.12" = _DmbnXKDP;
        "default" = _DmbnXKDP;
    });
