...
let
    ...
    in {
        ...
        "pkg-2.2.1" = _GLGz9Rz9;
        "pkg-2.2.2" = _x6nEpSPl;
        "pkg-2.2.2a" = _aIvh3FuL;
        "pkg-2.2.2b" = _rnnPoC6y;
        "pkg-2.2.3" = _n7xTGUai;
        "pkg-2.0.0-b1" = _U6tCukil;
        "pkg-2.0.0-b2" = _tIS5F48E;
        "pkg-2.0.0-b3" = _PSsFlwW4;
        "pkg-2.0.0-b3.1" = _maFnkSm7;
        "pkg-2.0.0-b3.2" = _Azlw2kmW;
        "default" = _Azlw2kmW;
    });
