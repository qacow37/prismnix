...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge" = _WmKnAJMD;
        "pkg-1.0.0-fabric" = _pFKYf5Un;
        "pkg-1.0.1-forge" = _IgbOZUjr;
        "pkg-1.0.1-fabric" = _FFqe0V8K;
        "pkg-1.0.2-forge" = _vgmmjxvm;
        "pkg-1.0.2-fabric" = _qI1PbQl8;
        "pkg-1.0.2-neoforge" = _7sx8PFzL;
        "pkg-1.0.3-forge" = _y9339ZyI;
        "pkg-1.0.3-fabric" = _8XEvPQTM;
        "pkg-1.0.3-neoforge" = _LCXjdJtI;
        "pkg-1.0.4-neoforge" = _cCBJQL6V;
        "pkg-1.0.4-fabric" = _kYpZHJOM;
        "pkg-1.0.5-neoforge" = _WgMNsYOc;
        "pkg-1.0.5-fabric" = _MzHGSul7;
        "pkg-1.0.6-neoforge" = _AHRPCBDq;
        "pkg-1.0.6-fabric" = _euDsk0hn;
        "pkg-1.0.7-neoforge" = _OG9GnHiO;
        "pkg-1.0.7-fabric" = _Ji834mlr;
        "pkg-0.0.2-neoforge" = _FmVQVhaT;
