...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.8-forge" = _5cM5Laq1;
        "pkg-1.18.2-2.9-forge" = _BKQcdCka;
        "pkg-1.19.2-3.0-forge" = _2k4gvkHU;
        "pkg-1.16.5-3.1-forge" = _bQkwPFKy;
        "pkg-1.18.2-3.1-forge" = _8RfwIDBg;
        "pkg-1.19.2-3.1-forge" = _DDh8khxJ;
        "pkg-1.16.5-3.1-fabric" = _NdwyKh1n;
        "pkg-1.18.2-3.1-fabric" = _VUl9dAUc;
        "pkg-1.19.2-3.1-fabric" = _emXNxcY7;
        "pkg-1.19.2-1.9-fabric" = _xch25f17;
        "pkg-1.16.5-3.2-fabric" = _eBHnIv5t;
        "pkg-1.18.2-3.2-fabric" = _MWeGg2cw;
        "pkg-1.19.2-3.2-fabric" = _9F8wg1oZ;
        "pkg-1.19.3-3.3-fabric" = _PoJQIDn4;
        "pkg-1.19.3-3.0-forge" = _4fGBfAzZ;
        "pkg-1.18.2-4.0-forge+fabric" = _cIKgQGjf;
        "pkg-1.19.2-4.0-forge+fabric" = _5thEz0N2;
        "pkg-1.19.3-4.0-forge+fabric" = _p78YT0Od;
        "pkg-1.18.2-4.1-forge+fabric" = _FNEu5IBm;
        "pkg-1.19.2-4.1-forge+fabric" = _dyPOy80i;
        "pkg-1.19.3-4.1-forge+fabric" = _mSlvymPY;
        "pkg-1.18.2-4.2-forge+fabric" = _3FaB8gho;
        "pkg-1.19.2-4.2-forge+fabric" = _I3NW2c9M;
        "pkg-1.19.3-4.2-forge+fabric" = _KWIitgg8;
        "pkg-1.18.2-4.3-forge+fabric" = _KCLzvoKF;
        "pkg-1.19.2-4.3-forge+fabric" = _RQVdyPU6;
        "pkg-1.19.3-4.3-forge+fabric" = _WWfHhwLL;
        "pkg-1.19.4-4.3-forge+fabric" = _ge3VVc4s;
        "pkg-1.20-4.3-forge+fabric" = _EOJ61R6V;
        "pkg-1.20-4.4-forge+fabric" = _eZVyFVTO;
        "pkg-1.20.1-4.4-forge+fabric" = _8E5bsAMw;
        "pkg-1.18.2-5.0-forge+fabric" = _SSL8MOX6;
        "pkg-1.19.2-5.0-forge+fabric" = _mYVmfhxW;
        "pkg-1.19.4-5.0-forge+fabric" = _kF66ofbG;
        "pkg-1.20.1-5.0-forge+fabric" = _3qZWMsqx;
        "pkg-1.20.2-5.0-forge+fabric" = _j2Ivzvex;
        "pkg-1.18.2-5.1-forge+fabric" = _Ti4VOLfL;
        "pkg-1.19.2-5.1-forge+fabric" = _zvHpVAaR;
        "pkg-1.20.1-5.1-forge+fabric" = _LVVBeyNq;
        "pkg-1.20.2-5.1-forge+fabric" = _mzSBF96b;
        "pkg-1.18.2-5.2-forge+fabric" = _Q8k4BC48;
        "pkg-1.19.2-5.2-forge+fabric" = _Om1YbUgj;
        "pkg-1.20.1-5.2-forge+fabric" = _nfgpLxz2;
        "pkg-1.20.2-5.2-forge+fabric" = _mk9pEtda;
        "pkg-1.20.3-5.2-fabric+forge+neo" = _eEOk7Dn2;
        "pkg-1.20.4-5.2-fabric+forge+neo" = _6D7Ct84W;
        "pkg-1.19.2-5.3-fabric+forge+neo" = _yIwgVCoy;
        "pkg-1.20.1-5.3-fabric+forge+neo" = _haA54YVE;
        "pkg-1.20.2-5.3-fabric+forge+neo" = _41GjNQ72;
        "pkg-1.20.4-5.3-fabric+forge+neo" = _cUjYs3sL;
        "pkg-1.19.2-5.4-fabric+forge" = _TNab7A0z;
        "pkg-1.20.1-5.4-fabric+forge+neo" = _riPhtBCe;
        "pkg-1.20.4-5.4-fabric+forge+neo" = _ATeAU9bs;
        "pkg-1.19.2-5.5-fabric+forge" = _UOxULFwn;
        "pkg-1.20.1-5.5-fabric+forge+neo" = _zzxxdiDa;
        "pkg-1.20.4-5.5-fabric+forge+neo" = _LZ7G5YbU;
        "pkg-1.19.2-5.6-fabric+forge" = _dLp6njkQ;
        "pkg-1.20.1-5.6-fabric+forge+neo" = _FWeckZWH;
        "pkg-1.20.4-5.6-fabric+forge+neo" = _4TNZEyui;
        "pkg-1.20.5-5.6-fabric+neo" = _Y3Pjwmy9;
        "pkg-1.20.5-5.7-fabric+neo" = _sUibDCl2;
        "pkg-1.20.6-5.7-fabric+forge+neo" = _rfiq10Yt;
        "pkg-1.20.6-5.8-fabric+forge+neo" = _6TilKr4E;
        "pkg-1.21.0-5.8-fabric+forge+neo" = _lZp5IcJ2;
        "pkg-1.19.2-5.9-fabric+forge" = _fh62Ior5;
        "pkg-1.20.1-5.9-fabric+forge+neo" = _n5yJSGVb;
        "pkg-1.20.4-5.9-fabric+forge+neo" = _aPfhgcl3;
        "pkg-1.20.6-5.9-fabric+forge+neo" = _PaaYDUxw;
        "pkg-1.21.0-5.9-fabric+forge+neo" = _6jPnGcJ4;
        "pkg-1.20.1-6.0-fabric+forge+neo" = _UkJqXhHb;
        "pkg-1.20.6-6.0-fabric+forge+neo" = _A64ibSqe;
        "pkg-1.21.0-6.0-fabric+forge+neo" = _QQOF1V6y;
        "pkg-1.21.1-6.0-fabric+forge+neo" = _2ig46gy2;
        "pkg-1.21.2-6.0-fabric+neo" = _zbC97VRf;
        "pkg-1.21.3-6.0-fabric+forge+neo" = _JkHRd9BH;
        "pkg-1.21.4-6.0-fabric+forge+neo" = _4OR1L0MA;
        "pkg-1.20.1-6.1-fabric+forge+neo" = _z8wdbzwT;
        "pkg-1.21.1-6.1-fabric+forge+neo" = _Ppbb7pia;
        "pkg-1.21.4-6.1-fabric+forge+neo" = _4rVwgbyf;
        "pkg-1.21.5-6.1-fabric+forge+neo" = _YDtsZssR;
        "pkg-1.21.6-6.1-fabric+forge+neo" = _oFpyFwiN;
        "pkg-1.21.7-6.1-fabric+forge+neo" = _xIXoeDqM;
        "pkg-1.21.8-6.1-fabric+forge+neo" = _r2dHFv6W;
        "pkg-1.21.9-6.1-fabric+forge+neo" = _jfAAv7AN;
        "pkg-1.21.9-6.2-fabric+forge+neo" = _YbfOCjDD;
        "pkg-1.21.10-6.2-fabric+forge+neo" = _WKpBQCns;
        "pkg-1.21.11-6.2-fabric+forge+neo" = _kOWnexwt;
        "pkg-26.1.0-6.2-fabric+forge+neo" = _4JI65HTs;
        "pkg-26.1.1-6.2-fabric+forge+neo" = _S9Zmtk9n;
        "pkg-26.1.2-6.2-fabric+forge+neo" = _XbVwEfAI;
        "pkg-1.20.1-6.3-fabric+forge+neo" = _NPQCR8qQ;
        "pkg-1.21.1-6.3-fabric+forge+neo" = _LSV6lq3z;
        "pkg-1.21.11-6.3-fabric+forge+neo" = _Wv3CFXb7;
        "pkg-26.1.2-6.3-fabric+forge+neo" = _z9nXuVFm;
        "pkg-26.2.0-6.3-fabric+forge+neo" = _bR8egpco;
        "pkg-1.20.1-6.4-fabric+forge+neo" = _eZLgRjx3;
        "pkg-1.21.1-6.4-fabric+forge+neo" = _ApvQigGP;
        "pkg-26.2.0-6.4-fabric+forge+neo" = _jzAAe6Pa;
        "default" = _jzAAe6Pa;
    });
