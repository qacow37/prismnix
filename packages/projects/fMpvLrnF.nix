...
let
    ...
    in {
        ...
        "pkg-0.1.4-alpha" = _eZn0XyLK;
        "pkg-0.2.0-beta" = _DYaQtQYC;
        "pkg-0.2.1-beta" = _MuAQ22UH;
        "pkg-0.2.2-beta" = _3UqlCuSd;
        "pkg-0.2.3-beta" = _sOKjIHEo;
        "pkg-0.2.4-beta" = _Qunw9NTV;
        "pkg-0.3.0-beta" = _UxRxCwUs;
        "pkg-0.3.1-beta" = _RbKZQ0ss;
        "pkg-0.3.2-beta" = _M9Qd6xG9;
        "pkg-0.2.5-beta" = _vmXniaBm;
        "pkg-0.2.6-beta" = _pVb5b9Mx;
        "pkg-0.3.3-beta" = _Gcw2jGsw;
        "pkg-0.3.4-beta" = _Mx5Kpk9G;
        "pkg-0.4.0-alpha" = _JQTBtGp7;
        "pkg-0.4.1-beta" = _JGZ7VvuY;
        "pkg-0.4.2-beta" = _CNKRepxN;
        "pkg-0.4.3-beta" = _KDm8sOV3;
        "pkg-0.5.0-beta" = _E0w8dxFU;
        "pkg-0.5.1-beta" = _OKXkP2QE;
        "pkg-0.6.0-beta" = _GVzY1num;
        "pkg-0.6.1-beta" = _uSorcoNB;
        "pkg-0.7.0-beta" = _dLMmaJID;
        "pkg-0.8.0-beta" = _3kivFqSC;
        "pkg-0.8.1-beta" = _YdoI401Y;
        "pkg-0.8.2-beta" = _npqj1t51;
        "pkg-0.8.3-beta" = _gefWg5at;
        "pkg-0.8.4-beta" = _zZkanfIF;
        "pkg-0.8.6-beta" = _ejnAIHQf;
        "pkg-0.8.7-beta" = _tMpIGKGa;
        "pkg-0.8.8-beta" = _K13gsxym;
        "pkg-0.8.9" = _kXkWP0pp;
        "pkg-0.9.1-beta" = _MlWkxN0s;
        "pkg-0.9.2" = _rQt4tRDQ;
        "pkg-0.9.3" = _1Dxh9WwO;
        "pkg-0.9.4" = _TdPkMBLc;
        "pkg-0.9.5" = _3LlLdnuQ;
        "pkg-0.9.6" = _TTPA9hxb;
        "pkg-1.0.0-alpha" = _z2XToldP;
        "default" = _z2XToldP;
    });
