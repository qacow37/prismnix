...
let
    ...
    in {
        ...
        "pkg-1.0.5-alpha" = _FwwRSkVS;
        "pkg-1.1.0" = _YmDTOTPZ;
        "pkg-1.1.1-1.21.10" = _dHKQpy7s;
        "pkg-1.1.1-1.21.11" = _qFXdNTtg;
        "pkg-1.1.1-1.21.8" = _Zz38vqrs;
        "pkg-1.1.2-1.21.10" = _wpNnuSOh;
        "pkg-1.1.2-1.21.11" = _Y2JZKUZM;
        "pkg-1.1.2-1.21.8" = _7n5abnc3;
        "pkg-1.2.0-1.21.10" = _84MMQvRP;
        "pkg-1.2.0-1.21.11" = _ZCRTzPKj;
        "pkg-1.2.0-1.21.8" = _3mWwApV5;
        "pkg-1.2.1-alpha1-1.21.11" = _eygoHEKo;
        "pkg-1.2.1-alpha1-1.21.8" = _3PTfVpaQ;
        "pkg-1.2.1-alpha1-1.21.10" = _RMUp8KA1;
        "pkg-1.2.1-alpha2-1.21.10" = _DwjJHUgr;
        "pkg-1.2.1-alpha2-1.21.11" = _8GNWk4yd;
        "pkg-1.2.1-alpha2-1.21.8" = _cKPYfViA;
        "pkg-1.2.1-alpha3-1.21.10" = _Bl2f2Ojs;
        "pkg-1.2.1-alpha3-1.21.11" = _3zGEUGSZ;
        "pkg-1.2.1-alpha3-1.21.8" = _zWB6Khpf;
        "pkg-1.2.1-alpha4-1.21.10" = _1RXu4Vna;
        "pkg-1.2.1-alpha4-1.21.11" = _1yVqBz9a;
        "pkg-1.2.1-alpha4-1.21.8" = _CxmRbq6b;
        "pkg-1.2.1-1.21.10" = _boWkcWre;
        "pkg-1.2.1-1.21.8" = _cOmDnd4x;
        "pkg-1.2.1-1.21.11" = _6t94SgSw;
        "pkg-1.2.2-1.21.10" = _zhQ9pPHT;
        "pkg-1.2.2-1.21.11" = _9W13R4o0;
        "pkg-1.2.2-1.21.8" = _1S4cEc8w;
        "pkg-1.2.3-1.21.11" = _fUiqWZYA;
        "pkg-1.2.3-1.21.10" = _O3Vv1rxj;
        "pkg-1.2.3-1.21.8" = _SN6WlEkR;
        "pkg-1.3.0-beta1-1.21.10" = _gsUOufM0;
        "pkg-1.3.0-beta1-1.21.11" = _p8RCk0xE;
        "pkg-1.3.0-beta1-1.21.8" = _iqcTafGF;
        "pkg-1.3.0-1.21.10" = _nReUhz2Z;
        "pkg-1.3.0-1.21.8" = _ILwjog6B;
        "pkg-1.3.0-1.21.11" = _BUrhpnRb;
        "pkg-1.3.1-1.21.10" = _shsB7s5z;
        "pkg-1.3.1-1.21.8" = _xwjyX0Tg;
        "pkg-1.3.1-1.21.11" = _knBsiY4c;
        "pkg-1.3.2-1.21.10" = _Mcxl5yWw;
        "pkg-1.3.2-1.21.11" = _9sa4jJLD;
        "pkg-1.3.2-1.21.8" = _WxneGgcA;
        "pkg-1.3.3-1.21.11" = _CbUpgvjY;
        "pkg-1.3.3-1.21.10" = _GLxoODw6;
        "pkg-1.3.3-1.21.8" = _zU7eggBD;
        "pkg-1.4.0-1.21.11" = _zYFmEzHx;
        "pkg-1.4.0-1.21.8" = _SJJfwmEb;
        "pkg-1.4.0-1.21.10" = _XlHSQtl0;
        "pkg-1.4.1-1.21.10" = _Ihb7Zji8;
        "pkg-1.4.1-1.21.11" = _3cTOEC4z;
        "pkg-1.4.1-1.21.8" = _I9dMeW70;
        "pkg-1.4.2-1.21.10" = _Sde1FVMj;
        "pkg-1.4.2-1.21.11" = _rZhl3GvE;
        "pkg-1.4.2-1.21.8" = _F1L0b9xC;
        "pkg-1.4.4-1.21.11" = _qEwTpMvf;
        "pkg-1.4.4-1.21.8" = _QTjhoo92;
        "pkg-1.4.4-1.21.10" = _E67tsGnr;
        "pkg-1.4.6-1.21.10" = _oU0jKsC5;
        "pkg-1.4.6-1.21.11" = _NVUC3ugp;
        "pkg-1.4.6-26.1" = _LlG2LrMG;
        "pkg-1.4.6-1.21.8" = _DUJjYWbN;
        "pkg-1.4.7-1.21.11" = _Or5szAw7;
        "pkg-1.4.7-1.21.10" = _ZVGlS7qd;
        "pkg-1.4.7-1.21.8" = _X3l5fb9S;
        "pkg-1.4.7-26.1" = _nyC0Ihz1;
        "pkg-1.4.8-26.1" = _UuEy5q8h;
        "pkg-1.4.8-26.2" = _jHgzmiHz;
        "default" = _jHgzmiHz;
    });
