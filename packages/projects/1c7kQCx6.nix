...
let
    ...
    in {
        ...
        "pkg-0.0.5-Beta" = _Ufhbk7of;
        "pkg-1.0.0-pre.1" = _7NyFM96z;
        "pkg-1.0.0-pre.2" = _WlYlN5iy;
        "pkg-1.0.0-pre.3" = _M0GOdwyA;
        "pkg-1.0.0" = _lkfbukSZ;
        "pkg-1.0.1" = _QBxglqAI;
        "pkg-1.1.0-Alpha1" = _CcY6AeJ7;
        "pkg-1.1.0-Beta1" = _vRqeQ2HG;
        "pkg-1.1.0" = _7SYFcPke;
        "pkg-1.1.1" = _YeC3RwQC;
        "pkg-1.1.2" = _IbD3jW5X;
        "pkg-1.1.3" = _iKm0NYN9;
