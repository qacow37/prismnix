...
let
    ...
    in {
        ...
        "pkg-8.0.1" = _J3mzDV5n;
        "pkg-9.0.1" = _7prSxMwN;
        "pkg-10.0.1" = _SEbfmA2Q;
        "pkg-11.0.1" = _c4F1TilO;
        "pkg-11.0.2" = _Yz9bfcVH;
        "pkg-12.0.1" = _E46c9DCv;
        "pkg-13.0.1" = _XvAeY9KZ;
        "pkg-14.0.1" = _GremMWf0;
        "pkg-15.0.1" = _tgNqr6gM;
        "pkg-16.0.1" = _dAwR380O;
        "pkg-16.0.2" = _4ym1BPSk;
        "pkg-15.0.2" = _LrTyvjZL;
        "pkg-14.0.2" = _YjGWyepr;
        "pkg-17.0.1" = _fIOVMUXR;
        "pkg-17.0.2" = _OsThKB1E;
        "pkg-18.0.1" = _UjdxrEe4;
        "pkg-19.0.1" = _uPgjdjo4;
        "pkg-20.0.1" = _LE09A6MX;
        "pkg-21.0.3" = _yidmnHKm;
        "pkg-22.0.1" = _4kBjBkxj;
        "pkg-23.0.1" = _h68ZRmZK;
        "pkg-23.0.2" = _SoPiqO0m;
        "pkg-22.0.2" = _OsJEPMbD;
        "pkg-21.0.4" = _W3lDdYEg;
        "pkg-20.0.2" = _RpreSQTc;
        "pkg-26.1.2.4" = _hdidBz4k;
        "pkg-26.2.1" = _14MnNUIE;
        "default" = _14MnNUIE;
    });
