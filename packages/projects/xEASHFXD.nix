...
let
    ...
    in {
        ...
        "pkg-2.2.3" = _QP52fEN0;
        "pkg-2.2.4" = _5jMFqKsz;
        "pkg-2.2.45" = _i68CTvwT;
        "pkg-2.2.5" = _1o9NUrsd;
        "pkg-2.2.6" = _EPCosCMN;
        "pkg-2.2.7" = _MQmnc7AV;
        "pkg-2.2.7-PATCH" = _TvNjJkxy;
        "pkg-2.2.8" = _YJZ0mIgm;
        "pkg-0.1-1.20.1" = _KDvBgxLg;
        "pkg-0.0.2" = _LPRyC5yV;
        "pkg-0.0.3" = _LZ4Q4MUz;
        "pkg-0.2-1.20.1" = _UpWGGL7N;
        "pkg-0.0.4" = _8uyiAaP5;
        "pkg-0.0.5" = _v3VbMKkd;
        "pkg-3.0.0" = _TQr0OA1r;
        "pkg-3.0.1-1.20.1" = _PknbMsBm;
        "pkg-3.0.2-1.20.1" = _OTjAHR7l;
        "pkg-3.0.3-1.20.1" = _kxedIQg7;
        "pkg-3.0.4-1.20.1" = _d3o7mEZq;
        "pkg-3.0.5-1.20.1" = _PLjEuDXv;
        "pkg-3.0.6-1.20.1" = _aRKsodfh;
        "pkg-3.0.7" = _NClhmBvv;
        "pkg-3.0.8-1.20.1" = _sR0tqefu;
        "pkg-3.0.9-1.20.1" = _n9X4sbkJ;
        "pkg-3.1.0-1.20.1" = _OY6nS0Pl;
        "pkg-3.1.1-1.20.1" = _r7dFuSWn;
        "pkg-3.1.2-1.20.1" = _AmbQAItc;
        "default" = _AmbQAItc;
    });
