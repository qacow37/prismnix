...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21" = _UMHaXYuk;
        "pkg-1.0.0+1.20.4" = _AZIWs1AY;
        "pkg-1.0.0+1.20.1" = _z0vgli26;
        "pkg-1.0.1+1.20.1" = _IBq7zFcN;
        "pkg-1.0.1+1.20.4" = _N6XF2FVK;
        "pkg-1.0.1+1.20.6" = _3CAVNa7I;
        "pkg-1.0.1+1.21" = _yMA16ZO0;
        "pkg-1.0.1+1.19.4" = _vY67Mk4B;
        "pkg-1.0.1+1.19.2" = _c1vHRZjy;
        "pkg-1.0.1+1.18.2" = _giEBK5X1;
        "pkg-1.0.2+1.21" = _oflllDFp;
        "pkg-1.0.2+1.20.6" = _WyNe4H73;
        "pkg-1.0.3+1.20.6" = _uUFsp8lf;
        "pkg-1.0.3+1.20.4" = _NtyIDYs5;
        "pkg-1.0.4+1.20.1" = _jkrOWNh6;
        "pkg-1.0.5+1.19.4" = _x4aIIu37;
        "pkg-1.0.5+1.19.2" = _xR42Js51;
        "pkg-1.0.5+1.18.2" = _ZpZc8cmO;
        "pkg-1.0.5+1.20.1" = _hgssPEMb;
        "pkg-1.0.5+1.20.4" = _1T7XC4jq;
        "pkg-1.0.5+1.20.6" = _FUWRY2Nw;
        "pkg-1.0.6+1.21" = _bgk6ED7E;
        "pkg-1.0.6+1.21-1.21.1" = _eNQxly4k;
        "pkg-1.0.6+1.21.2" = _BrsKLMd9;
        "pkg-1.0.6+1.21.3" = _ZEMZDCVE;
        "pkg-1.0.6+1.21.4" = _ugL5IqTY;
        "pkg-1.0.6+1.21.5-pre2-1.21.5" = _U9R37TK3;
        "pkg-1.0.6.0+1.21.4-1.21.5" = _a0XaOcTb;
        "pkg-1.0.6.0+1.21.6" = _Z3rnrJIs;
        "pkg-1.0.6.0+1.21.7" = _2T7dIHVQ;
        "pkg-1.1.0.0+1.21.7" = _tru1ISYa;
        "pkg-1.1.0.0+1.21.8" = _QlwZa8au;
        "pkg-1.1.0.0+1.21.4-1.21.5" = _4qfQDVm3;
        "pkg-1.1.0.0+1.21.1" = _sOgZJ9FR;
        "pkg-1.1.0.0+1.21.9-1.21.10" = _XmeS5XR1;
        "pkg-1.1.1.0+1.21.10" = _KpV7A5op;
        "pkg-1.1.1.0+1.21.11" = _9ETpV9dK;
        "pkg-1.1.2.0+26.1" = _5JKwVFof;
        "pkg-1.1.2.0+26.1.1" = _wJMjyS8H;
