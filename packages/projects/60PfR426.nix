...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _KVHrrSTx;
        "pkg-1.0.0+mod" = _3pyDKOYT;
        "pkg-1.0.0a" = _hbt6kF1N;
        "pkg-1.0.0a+mod" = _aF3ezmnw;
        "pkg-1.0.0b" = _rUg57Ugg;
        "pkg-1.0.0b+mod" = _wUmV5YZS;
        "pkg-1.0.0c" = _gIJETifl;
        "pkg-1.0.0c+mod" = _ZAGTdB2B;
        "pkg-1.0.1" = _vmX8e6g8;
        "pkg-1.0.1+mod" = _dLuaZQ7T;
        "pkg-1.0.1a" = _iPgeA6aB;
        "pkg-1.0.1a+mod" = _DfCoZ6C0;
        "pkg-1.0.1b" = _1Xv1oxAT;
        "pkg-1.0.1b+mod" = _IWIxvCHe;
        "pkg-1.0.1c" = _rkeRGC5b;
        "pkg-1.0.1c+mod" = _WRdPGMhP;
        "pkg-1.0.1d" = _YNkHscQK;
        "pkg-1.0.1d+mod" = _KHNSeyQ9;
        "pkg-1.0.2" = _xaJXhfcl;
        "pkg-1.0.2+mod" = _sijzfpnM;
        "pkg-1.0.2a" = _jrWvesSM;
        "pkg-1.0.2a+mod" = _vHNjFkuA;
        "pkg-1.0.2b" = _gdkuWmyZ;
        "pkg-1.0.2b+mod" = _1L7aVnjN;
        "pkg-1.0.2c" = _LibddOmu;
        "pkg-1.0.2c+mod" = _E5M5JavF;
        "pkg-1.0.2d" = _d7D6UZS8;
        "pkg-1.0.2d+mod" = _kH4PnxSr;
        "pkg-1.0.3" = _K75Z9sEz;
        "pkg-1.0.3+mod" = _QdUdrKlu;
        "pkg-1.0.1e" = _urz8H4GM;
        "pkg-1.0.1e+mod" = _o4XeQIaT;
        "pkg-1.0.3a_1.19" = _ZmZRQrlw;
        "pkg-1.0.3a_1.19+mod" = _zwMfiye2;
        "pkg-1.0.3a" = _thDXsz5H;
        "pkg-1.0.3a+mod" = _5CWphCB9;
        "pkg-1.0.3b" = _sdZf0KIQ;
        "pkg-1.0.3b+mod" = _2Ge8iqkc;
        "pkg-1.0.3c" = _v7FVQTv2;
        "pkg-1.0.3c+mod" = _LZc9k1Q5;
        "pkg-1.0.3d" = _U5ldRIJM;
        "pkg-1.0.3d+mod" = _GCUduxEl;
        "pkg-1.0.4" = _iJTU5DP6;
        "pkg-1.0.4+mod" = _hBsVHQ76;
        "pkg-1.0.4a" = _YzIFcs9v;
        "pkg-1.0.4a+mod" = _lvoz36w2;
        "pkg-1.0.4b" = _kUmDnKM4;
        "pkg-1.0.4b+mod" = _BZiYuyEg;
        "pkg-1.0.5" = _qokBbLNz;
        "pkg-1.0.6" = _PvR5w1Nj;
        "pkg-1.0.7" = _JS40aUh3;
        "pkg-1.0.8" = _kr2bcuIR;
        "pkg-1.0.8a" = _7MKiJ8ZX;
        "pkg-1.0.9" = _xy4BZEoW;
        "default" = _xy4BZEoW;
    });
