...
let
    ...
    in {
        ...
        "pkg-v4.0.0" = _NLPtVsJR;
        "pkg-v4.0.0+mod" = _ovhGIJJJ;
        "pkg-v4.0.1" = _CgpN2dsD;
        "pkg-v4.0.1+mod" = _F0MygXEo;
        "pkg-4.1.0" = _KogBTf25;
        "pkg-4.1.0+mod" = _tO0H3OGg;
        "pkg-4.1.1" = _rwuO0nKE;
        "pkg-4.1.1+mod" = _b8uMxJS0;
        "pkg-4.1.2+mod" = _oyr6onGl;
        "pkg-4.1.2" = _kyslPxfQ;
        "pkg-v4.2.0+mod" = _jKv5jg71;
        "pkg-v4.2.0" = _4gWesnY8;
        "pkg-v4.2.1+mod" = _5RJdhZEB;
        "pkg-v4.2.1" = _QdXrxget;
        "pkg-v4.2.2" = _qhaTOmIV;
        "pkg-v4.2.2+mod" = _x51u46OF;
        "pkg-v4.2.3" = _xkdySocq;
        "pkg-v4.2.3+mod" = _Ow2faTtA;
        "pkg-v5.0.0" = _rm8Rs5ed;
        "pkg-v5.0.0+mod" = _VnCwbsTe;
        "pkg-v5.0.1" = _zTiKyJJO;
        "pkg-v5.0.1+mod" = _k5kf4Lg8;
        "pkg-v5.1.0" = _vxwbbob1;
        "pkg-v5.1.0+mod" = _B4zLwDpN;
        "default" = _B4zLwDpN;
    });
