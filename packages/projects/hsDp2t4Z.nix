...
let
    ...
    in {
        ...
        "pkg-1.3.1" = _Behe2aQq;
        "pkg-1.1.2" = _rZ20gxgD;
        "pkg-2.0.0+mc1.21-neoforge" = _NgM8VVrb;
        "pkg-2.0.0+mc26.1-neoforge" = _koVkJrAc;
        "pkg-2.0.0+mc26.1-fabric" = _RDwYiogn;
        "pkg-2.1.0+mc26.1-neoforge" = _fJmIy6a1;
        "pkg-2.1.0+mc1.21-neoforge" = _JPn0UduQ;
        "pkg-2.1.0+mc26.1-fabric" = _xtsI5pw0;
        "pkg-2.1.0+mc1.20.1-forge" = _MyXmjd9q;
        "pkg-2.1.0+mc26.2-neoforge" = _EDnzxA1y;
        "pkg-2.1.0+mc26.2-fabric" = _Ci1aidIK;
        "pkg-2.1.1+mc1.20.1-forge" = _oeikhIu4;
        "pkg-2.1.1+mc1.21-neoforge" = _anDRKCZZ;
        "pkg-2.1.0+mc1.21-fabric" = _sTzb9HfV;
        "pkg-2.1.1+mc26.1-neoforge" = _4pe5fTDi;
        "pkg-2.1.0+mc1.20.1-fabric" = _jU5FkBBq;
        "pkg-2.1.1+mc26.2-neoforge" = _K1Mj2TmU;
        "pkg-2.2.0+mc1.20.1-forge" = _LmrurXMk;
        "pkg-2.2.0+mc1.21-neoforge" = _Mo2PXG4v;
        "pkg-2.2.0+mc26.1-neoforge" = _eI1yZKM5;
        "pkg-2.2.0+mc26.2-neoforge" = _dH56dxdN;
        "pkg-2.2.1+mc1.20.1-forge" = _9csuKoQS;
        "pkg-2.2.2+mc1.20.1-fabric" = _VH0Mhw6K;
        "pkg-2.2.2+mc1.21-fabric" = _19ntjDUW;
        "pkg-2.2.2+mc26.1-fabric" = _hVyOjmDj;
        "pkg-2.2.2+mc26.2-fabric" = _OkzXhesL;
        "pkg-2.2.2+mc1.20.1-forge" = _dTOhOpu8;
        "pkg-2.2.2+mc1.21-neoforge" = _wikjLUBG;
        "pkg-2.2.2+mc26.1-neoforge" = _oL0MAA21;
        "pkg-2.2.2+mc26.2-neoforge" = _fNSN3pmB;
        "pkg-2.3.0+mc1.20.1-forge" = _ZjSXxd30;
        "pkg-2.4.0+mc1.20.1-forge" = _oWIZLXtn;
        "pkg-2.4.1+mc1.20.1-forge" = _7KaYShW6;
        "pkg-2.2.2+mc1.21.2-fabric" = _aQKmZbap;
        "pkg-2.2.2+mc1.21.4-fabric" = _IgYRdMCs;
        "pkg-2.2.2+mc1.21.5-fabric" = _ITdbCT5Q;
        "pkg-2.2.2+mc1.21.11-fabric" = _XrQIohLF;
        "pkg-2.2.2+mc1.21.2-neoforge" = _fasd9Qvi;
        "pkg-2.2.2+mc1.21.5-neoforge" = _LnhF93aa;
