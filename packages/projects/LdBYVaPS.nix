...
let
    ...
    in {
        ...
        "pkg-5.0.0+1.19.2" = _qT32Cno6;
        "pkg-5.1.0+1.19.2" = _KxsEhL0L;
        "pkg-5.1.1+1.20.1" = _ilfliOcq;
        "pkg-5.2.0+1.20.1-Fabric" = _mzWo58Qw;
        "pkg-5.2.0+1.20.1-Forge" = _9zcRxSGQ;
        "pkg-5.2.1+1.20.1-Fabric" = _pPEJeLcJ;
        "pkg-5.2.1+1.20.1-Forge" = _M3LiVRrJ;
        "pkg-5.2.2+1.20.1-Fabric" = _SsFmmrRu;
        "pkg-5.2.2+1.20.1-Forge" = _mlgscCME;
        "pkg-5.2.3+1.20.1-Fabric" = _kHsmRWGm;
        "pkg-5.2.3+1.20.1-Forge" = _7Roly4BQ;
        "pkg-5.2.4+1.20.1-Fabric" = _mQgCCsFa;
        "pkg-5.2.4+1.20.1-Forge" = _4m2AIWpp;
        "pkg-5.2.5+1.20.1-Fabric" = _7hC51uIp;
        "pkg-5.2.5+1.20.1-Forge" = _SUojXZnW;
        "pkg-5.2.6+1.20.1-Fabric" = _mfdqVK7W;
        "pkg-5.2.6+1.20.1-Forge" = _X4odsQrf;
        "pkg-5.2.7+1.20.1-Fabric" = _TMvkKGtB;
        "pkg-5.2.7+1.20.1-Forge" = _WdjyfQPY;
        "pkg-5.3.0+1.21.1-Fabric" = _Rw1kGsvB;
        "pkg-5.3.0+1.21.1-Neoforge" = _ohPNN2Z7;
        "pkg-5.3.1+1.21.1-Fabric" = _1YGXPmHU;
        "pkg-5.3.1+1.21.1-Neoforge" = _FhGiKl1e;
        "pkg-5.3.2+1.21.1-Fabric" = _veuhWY3h;
        "pkg-5.3.2+1.21.1-Neoforge" = _13J9Q7hP;
        "pkg-5.3.3+1.21.1-Neoforge" = _CzsKXrKC;
        "pkg-5.3.3+1.21.1-Fabric" = _BlAlkvYZ;
        "pkg-5.3.4+1.21.1-Fabric" = _1POJrl1m;
        "pkg-5.3.4+1.21.1-Neoforge" = _dW6HB3Ew;
        "pkg-5.3.5+1.21.1-Fabric" = _KwNU9SQW;
        "pkg-5.3.5+1.21.1-Neoforge" = _VaF6hkni;
        "pkg-5.2.8+1.20.1-Fabric" = _EKmfPVFZ;
        "default" = _EKmfPVFZ;
    });
