...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.20.1" = _uBf0Eyda;
        "pkg-1.1.0+1.21" = _u2PLpTiu;
        "pkg-2.0.0+beta.1+1.21.1" = _gdc8B6sb;
        "pkg-2.0.0+beta.2+1.21.1" = _bayPGgO3;
        "pkg-2.0.0+1.21.2-rc2" = _vXsv2V4r;
        "pkg-2.0.1+1.21.4" = _hipCO8sn;
        "pkg-2.0.1+1.20.1" = _YhDIXVsl;
        "pkg-2.0.1+1.21.1" = _ledGAIdv;
        "pkg-2.0.2+1.20.1" = _jNwX2486;
        "pkg-2.0.1+1.21.5-rc1" = _Cr7ndFH0;
        "pkg-2.0.1+1.21.6-rc1" = _T4FeTbCb;
        "pkg-2.1.0+1.21.6" = _Q5qfb77y;
        "pkg-2.1.0+1.21.5" = _uu86uzaT;
        "pkg-2.1.0+1.21.4" = _ku41Gttq;
        "pkg-2.1.0+1.21.1" = _yfvhFbmu;
        "pkg-2.1.0+1.21.9" = _zAFDBkuT;
        "pkg-2.1.1+1.21.1" = _nFU5cd3t;
        "pkg-2.1.1+1.21.4" = _2FZQAQhA;
        "pkg-2.1.1+1.21.5" = _7FNJSTzG;
        "pkg-2.1.1+1.21.8" = _o6dGRo57;
        "pkg-2.1.1+1.21.9" = _NyBBqMq1;
        "pkg-2.1.1+1.21.11-rc2" = _1rSOkpji;
        "pkg-2.1.2+1.21.11" = _kZCA6po3;
        "pkg-2.1.3+1.21.1" = _pg6YFFyU;
        "pkg-2.1.3+1.21.10" = _Kgjuevg1;
        "pkg-2.1.3+1.21.11" = _qNFIP2g4;
        "pkg-2.1.3+1.21.4" = _n0eHTX89;
        "pkg-2.1.3+1.21.5" = _SbHzShyh;
