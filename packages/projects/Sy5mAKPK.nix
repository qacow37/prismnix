...
let
    ...
    in {
        ...
        "pkg-0.1+1.17" = _bScrPGD8;
        "pkg-0.1.1+1.17" = _XIqoX7ia;
        "pkg-0.1.2" = _62F5RzuH;
        "pkg-0.1.3+1.17.1" = _k2rvWhtC;
        "pkg-0.1.3+1.16.5" = _zDyQhRmm;
        "pkg-0.1.3+1.18" = _NFbjUghd;
        "pkg-0.1.4+1.17.1" = _szzwGp0X;
        "pkg-0.1.4+1.18" = _5GNJs4OG;
        "pkg-0.1.5+1.18" = _YUKZLDDG;
        "pkg-0.1.6+1.18" = _6SleTTcQ;
        "pkg-0.1.7+1.18" = _H2VPy3b3;
        "pkg-0.1.9+1.18" = _AJyIF2uF;
        "pkg-0.1.10+1.18" = _iS3owknT;
        "pkg-0.1.11+1.18" = _gfA6AMKo;
        "pkg-0.1.11+1.19" = _xQ1oaxe3;
        "pkg-0.1.12+1.19" = _xU13RTDm;
        "pkg-0.1.12+1.19.3" = _bEd6ihei;
        "pkg-0.1.12+1.19.4" = _1aVyeJdX;
        "pkg-0.1.13+1.20" = _Pf1vZfiB;
        "pkg-0.1.14+1.20" = _HzFLIayb;
        "pkg-0.1.14+1.20.2" = _RQ3yzS5N;
        "pkg-0.1.15+1.20.2" = _mNBYuukm;
        "pkg-0.1.15+1.20" = _RIgShusc;
        "pkg-0.1.15-1+1.20" = _b79Ud8Xi;
        "default" = _b79Ud8Xi;
    });
