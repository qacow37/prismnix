...
let
    ...
    in {
        ...
        "pkg-1.0.0.0" = _GjP1QNJy;
        "pkg-1.0.0.2" = _WYAKURW1;
        "pkg-1.0.0.3" = _N4MLmXj4;
        "pkg-1.0.0.7" = _tfZy2tBD;
        "pkg-1.0.1.1" = _aWM0nTEQ;
        "pkg-1.0.1.4-neoforge" = _H1dYpiBc;
        "pkg-1.0.1.6-neoforge" = _ou3CXpWh;
        "pkg-1.0.2.2-neoforge" = _jiQ3LMpA;
        "pkg-1.0.2.4-neoforge" = _xkr1V5Pe;
        "pkg-1.0.1.7" = _5qZ5t2oB;
        "pkg-1.0.2.5-neoforge" = _SOeDF0uK;
        "pkg-1.0.2.7" = _hjgpmSxZ;
        "pkg-1.0.3.2-neoforge" = _Dmn8WcNc;
        "pkg-1.0.3.5" = _6gerfiyz;
        "pkg-1.0.3.7-neoforge" = _mIaKmh7B;
        "pkg-1.0.3.8" = _c949gSlk;
        "pkg-1.0.4.6" = _jUnxF9fz;
        "pkg-1.0.4.8-neoforge" = _5RJZhBnL;
        "pkg-1.0.5.0-neoforge" = _HPZSc9em;
        "pkg-1.0.5.1" = _uceZWDlS;
        "pkg-1.0.5.8" = _8HVTtW0k;
        "pkg-1.0.6.0" = _nKTlZizP;
        "default" = _nKTlZizP;
    });
