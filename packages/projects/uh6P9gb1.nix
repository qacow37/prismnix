...
let
    ...
    in {
        ...
        "pkg-0.1.1-1.19" = _8h7KhaEu;
        "pkg-0.1.1-1.19.2" = _QG9rqm8r;
        "pkg-0.1.1-forge-1.19.3" = _t3wwCIQl;
        "pkg-0.1.1-1.19.3" = _xOuIkpe7;
        "pkg-0.1.1-forge-1.19.4" = _nH6xFt7X;
        "pkg-0.1.1-1.19.4" = _cQd1ZNjz;
        "pkg-0.2.0-snapshot.1-forge-1.19.4" = _xTeOqxMl;
        "pkg-0.2.0-snapshot.1-1.19.4" = _2VtqAACS;
        "pkg-0.2.0-snapshot.2-1.19.2" = _FwZMcDV7;
        "pkg-0.2.0-snapshot.2-forge-1.19.4" = _1PUXBzZz;
        "pkg-0.2.0-snapshot.2-1.19.4" = _ltL6Th8m;
        "pkg-0.2.0-snapshot.3-forge-1.19.2" = _QZ6e0D86;
        "pkg-0.2.0-snapshot.3-1.19.2" = _4YAVeJE6;
        "pkg-0.2.0-snapshot.3-forge-1.19.4" = _iJBGxOoa;
        "pkg-0.2.0-snapshot.3-1.19.4" = _EdQ32Lc9;
        "pkg-0.2.0-snapshot.3-forge-1.20.1" = _QDoNWn0E;
        "pkg-0.2.0-snapshot.3-1.20.1" = _5Vz74ocT;
        "pkg-0.2.0-snapshot.4-neoforge-1.20.4" = _Ii1zjeTR;
        "pkg-0.2.0-snapshot.4-1.20.4" = _vC6opQ4e;
        "pkg-0.2.0-snapshot.4.1-neoforge" = _Q0xUdtIT;
        "pkg-0.2.0-snapshot.5-1.20.4" = _8Auq40Kf;
        "pkg-0.2.0-snapshot.5-neoforge-1.20.4" = _lmS4zodU;
        "default" = _lmS4zodU;
    });
