...
let
    ...
    in {
        ...
        "pkg-DEMO" = _JaqLqE6a;
        "pkg-EARLY_BETA" = _bzkMtwcL;
        "pkg-RELEASE(1.0)" = _bSfZn9pb;
        "pkg-RELEASE(1.1UNSTABLE)" = _U6jKjkex;
        "pkg-RELEASE(1.1.1UNSTABLE)" = _5bLi5Su7;
        "pkg-RELEASE(1.1.2)" = _QXNm1FZa;
        "pkg-RELEASE(1.2)" = _5F6e3ncA;
        "pkg-1.3" = _VpsNbwSw;
        "pkg-1.3.1" = _qFC1T0Qv;
        "default" = _VpsNbwSw;
    });
