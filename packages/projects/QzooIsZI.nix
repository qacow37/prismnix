...
let
    ...
    in {
        ...
        "pkg-2.1.0+beta.4" = _oBNJuEnl;
        "pkg-2.1.0-beta.7" = _aPd9UjZT;
        "pkg-2.1.0-beta.8" = _tTUfDauT;
        "pkg-2.1.0-beta.9" = _UnSRIRxW;
        "pkg-2.1.0-beta.12" = _O1X66i9u;
        "pkg-2.1.0-beta.13" = _UPRVHUnG;
        "pkg-2.1.0-beta.14" = _LEMHLZ5e;
        "pkg-2.1.0-beta.15" = _TEInVa6Q;
        "pkg-2.1.0-beta.16" = _KOzEBSLc;
        "pkg-2.1.0-beta.17" = _kL3fooby;
        "pkg-2.1.0-beta.18" = _dG8keCMJ;
        "pkg-2.1.0-beta.19" = _lVKlFO3H;
        "pkg-2.1.0-beta.20" = _mWkTUcC4;
        "pkg-2.1.0-beta.21" = _mCnZEyaN;
        "pkg-2.1.0-beta.22" = _Af90lL43;
        "pkg-2.1.0-beta.23" = _Cl4kw8hE;
        "pkg-2.1.0-beta.24" = _EIqvaybB;
        "pkg-3.0.0-beta.25" = _NqEIzb8N;
        "pkg-3.0.0-beta.26" = _6dmNHzy8;
        "pkg-3.0.0-beta.27" = _ZK8q572Z;
        "pkg-3.0.0-beta.28" = _CikM5tSz;
        "pkg-3.0.0-beta.29" = _33FIok1K;
        "pkg-3.0.0-beta.30" = _eQigEzbn;
        "pkg-3.0.0-beta.31" = _mfWWCijx;
        "pkg-3.0.0-beta.32" = _2ptKcv94;
        "pkg-3.0.0-beta.33" = _5y0GiuS9;
        "pkg-3.0.0-beta.34" = _bBtDzSKH;
        "pkg-3.0.0-beta.35" = _xkUwNXAp;
        "pkg-3.0.0-beta.36" = _ztMq4trR;
        "pkg-3.0.0-beta.37" = _yGY2bbis;
        "default" = _yGY2bbis;
    });
