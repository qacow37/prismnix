...
let
    ...
    in {
        ...
        "pkg-0.3.1-1.16.5" = _xc3YUvfV;
        "pkg-1.17.1-0.3.7" = _H948EVCb;
        "pkg-1.16.5-0.3.7" = _k310iPg5;
        "pkg-1.18_experimental-snapshot-6-0.3.7" = _LAkTPspz;
        "pkg-1.16.5-0.3.8" = _qS5r4xEJ;
        "pkg-1.17.1-0.3.8" = _JhROLfi1;
        "pkg-1.18_experimental-snapshot-6-0.3.8" = _NOdgUvvn;
        "pkg-1.17.1-0.3.9" = _LkVLvGAu;
        "pkg-1.16.5-0.3.9" = _LJGPTWzG;
        "pkg-21w40a-0.3.9" = _2XwY3cGO;
        "pkg-0.4.0-1.15.2" = _GT3O6mph;
        "pkg-0.4.0-1.17.1" = _8BQbHtuU;
        "pkg-0.4.0-1.16.5" = _iSuJNAQf;
        "pkg-0.4.0-1.18.1" = _p6QqgRGc;
        "pkg-0.4.1-1.15.2" = _4JNh1mYe;
        "pkg-0.4.1-1.17.1" = _jT16zoWm;
        "pkg-0.4.1-1.18.1" = _nWA1klLp;
        "pkg-0.4.1-1.16.5" = _6PyiM2q2;
        "pkg-0.4.2-1.17.1" = _Z4kITi1p;
        "pkg-0.4.2-1.18.2" = _GoaBEPnj;
        "pkg-0.4.2-1.16.5" = _lv7UPFnz;
        "pkg-0.4.2-1.15.2" = _J9Yg0NYR;
        "pkg-0.5" = _dO81Jt1M;
        "default" = _dO81Jt1M;
    });
