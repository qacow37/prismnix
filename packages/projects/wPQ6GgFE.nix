...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _Num0zb44;
        "pkg-1.0.1" = _gpwGiIaL;
        "pkg-1.1.0-mc1.20.1" = _xOYlYi3c;
        "pkg-1.1.1-mc1.20.1" = _OaEB97An;
        "pkg-1.1.1-mc1.19.2" = _aiEPoGmS;
        "pkg-1.1.1-mc1.18.2" = _LHQtkPQc;
        "pkg-1.2.0-mc1.20.1" = _tFrTgkoH;
        "pkg-1.2.0-mc1.19.2" = _BEzQH4gG;
        "pkg-1.2.0-mc1.18.2" = _hk1mdGdu;
        "pkg-1.2.1-mc1.20.1" = _8UwsYr7q;
        "pkg-1.2.1-mc1.19.2" = _cBfNRN0y;
        "pkg-1.2.1-mc1.18.2" = _gWONXiI5;
        "pkg-1.2.2-mc1.20.1" = _WXndTMlF;
        "pkg-1.2.2-mc1.19.2" = _iIJqSZUY;
        "pkg-1.2.2-mc1.18.2" = _1sjCuWYo;
        "pkg-1.2.3-mc1.20.1" = _aZ7rFYfd;
        "pkg-1.2.3-mc1.19.2" = _Cl1Ur3vz;
        "pkg-1.2.3-mc1.18.2" = _N1KR043o;
        "pkg-1.2.4-mc1.20.1" = _kueY12ob;
        "pkg-1.2.4-mc1.19.2" = _7bsdRln4;
        "pkg-1.2.4-mc1.18.2" = _qP9Zer65;
        "pkg-1.3.0-mc1.20.1" = _sT1WVKEX;
        "pkg-1.3.0-mc1.19.2" = _rAZ83K3S;
        "pkg-1.3.0-mc1.18.2" = _O7MlRSY5;
        "pkg-1.3.1-mc1.20.1" = _ONUZooQq;
        "pkg-1.3.1-mc1.19.2" = _pRpJmt2o;
        "pkg-1.3.1-mc1.18.2" = _yOj2UQGr;
        "pkg-1.3.2-mc1.20.1" = _Z9fWGwPf;
        "pkg-1.3.2-mc1.19.2" = _HoSVdbEP;
        "pkg-1.3.2-mc1.18.2" = _SvjAyQ7f;
        "pkg-1.3.3-mc1.20.1" = _CsCsGYcO;
        "pkg-1.3.3-mc1.19.2" = _6AMLXXle;
        "pkg-1.3.3-mc1.18.2" = _XQudF2AE;
        "pkg-1.4.0-mc1.20.1" = _gYdBvixa;
        "pkg-1.4.0-mc1.19.2" = _bQrAXwhQ;
        "pkg-1.4.0-mc1.18.2" = _iJQVeEMm;
        "pkg-1.5.0-mc1.20.1" = _qLKpNYzC;
        "pkg-1.5.0-mc1.19.2" = _GuYzoHQC;
        "pkg-1.5.0-mc1.18.2" = _tCCHINK4;
        "pkg-2.0.0-mc1.20.1" = _4LadWtSk;
        "pkg-2.0.0-mc1.21.1" = _f5Zi2sZs;
        "pkg-2.0.1-mc1.21.1" = _9tJX5zd6;
        "pkg-2.0.2-mc1.21.1" = _COiCpt2h;
        "pkg-2.0.2-mc1.20.1" = _mhZAd4kE;
        "pkg-2.0.3-mc1.21.1" = _ydVSjzJR;
        "pkg-2.0.3-mc1.20.1" = _gQuz8jcV;
        "pkg-2.0.4-mc1.21.1" = _MX6Eqw1t;
        "pkg-2.0.5-mc1.21.1" = _3Y4r0ItR;
        "default" = _3Y4r0ItR;
    });
