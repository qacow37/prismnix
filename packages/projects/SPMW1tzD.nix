...
let
    ...
    in {
        ...
        "pkg-1.2.2" = _mOw1A1xJ;
        "pkg-1.1.11" = _TqIDBAQW;
        "pkg-1.0.28" = _9wsbu6dR;
        "pkg-1.0.29" = _I4uybvdS;
        "pkg-1.2.3" = _MuuSMDD9;
        "pkg-1.2.4" = _ZYc8b2w5;
        "pkg-1.2.5" = _3doc8ZFz;
        "pkg-1.2.6" = _n7TxE7GX;
        "pkg-1.2.7" = _nxiQHLmD;
        "pkg-1.0.30" = _eCEDj8GO;
        "pkg-1.1.12" = _JUqYJxRm;
        "pkg-1.2.8" = _QxME1fdg;
        "pkg-1.2.9" = _Qharw27M;
        "pkg-1.2.10" = _hSFSawYp;
        "pkg-1.2.11" = _tq2Hov8C;
        "pkg-1.3.0" = _PS1PMgjV;
        "pkg-1.3.1" = _kRv9wnP5;
        "pkg-1.3.2" = _wQpWozM0;
        "pkg-1.3.3" = _s7pvzRk0;
        ...
        "pkg-1.4.7" = _O9Ffpqb8;
        "pkg-1.4.8" = _PkKYMet3;
        "pkg-1.4.8HF" = _L0XoA8BR;
        "pkg-1.4.9" = _xB8tZy9L;
        "pkg-1.4.10" = _pqOhSbHn;
        "pkg-1.4.11" = _NwNAI0pX;
        "pkg-1.4.12" = _mp7Q9oeC;
        "pkg-1.4.13" = _h3FLFLLi;
        "pkg-1.4.14" = _rvMUVMPm;
        "pkg-1.4.15" = _bWbL3tjq;
        "pkg-1.4.16" = _UmhMx00t;
        "pkg-1.4.17" = _uxaEVXxn;
        "pkg-1.4.18" = _kx9DsFL0;
        "pkg-1.4.19" = _7VC7iGZU;
        "pkg-1.4.20" = _Pm919rnP;
        "pkg-1.4.21" = _kmN2EE4i;
        "pkg-1.4.22" = _4gytFixM;
        "pkg-1.4.23" = _dnSCpLkK;
        "pkg-1.4.24" = _SYrYRB7H;
        "pkg-1.4.25" = _DukKK823;
        "pkg-1.4.26" = _ylpDLuyf;
        "pkg-2.0.0" = _Hrq0LBrv;
        "pkg-2.0.1" = _6ZAKXQG0;
        "pkg-2.1.0" = _StP5lNKn;
        "pkg-2.1.1" = _xzSY5FJB;
