...
let
    ...
    in {
        ...
        "pkg-0.1-1.20.1" = _7mq5DCnd;
        "pkg-0.2-1.20.2" = _bZKtOYKs;
        "pkg-0.3" = _AGhVchAR;
        "pkg-0.3-1.20.2" = _SkzP5vbD;
        "pkg-0.3.1" = _osWVvmc1;
        "pkg-0.3.3" = _VD1oo7YP;
        "pkg-0.4" = _IHYK5eA5;
        "pkg-0.4.1" = _eTqo4oG8;
        ...
        "pkg-0.4.3" = _aazrcpGq;
        "pkg-0.5" = _hAFVyCJr;
        "pkg-0.5.1-mc1.18.2" = _2Rbh73Av;
        "pkg-0.5.1-mc1.19.2" = _zGkP5Znh;
        "pkg-0.5.1-mc1.20.1" = _PiVs3PTq;
        "pkg-0.5.2-mc1.18.2" = _qC6sNz4d;
        "pkg-0.5.2-mc1.19.2" = _vBK4OJ1O;
        "pkg-0.5.2-mc1.20.1" = _WA1plK3v;
        "pkg-0.5.3+fabric-mc1.20.1" = _7QGvBpZU;
        "pkg-0.5.3+forge-mc1.20.1" = _tTCNkCHu;
        "pkg-0.5.3" = _bUZG9AJY;
        "pkg-0.5.4+forge-mc1.20.1" = _773UvJvN;
        "pkg-0.5.5+fabric-mc1.18.2" = _AXVJ5MtH;
        "pkg-0.5.5+fabric-mc1.19.2" = _U0VuiTi5;
        "pkg-0.5.5+fabric-mc1.20.1" = _SqWTQ9sy;
        "pkg-0.5.5+forge-mc1.18.2" = _YO2Q9zYY;
        "pkg-0.5.5+forge-mc1.19.2" = _Vcy0aysa;
        "pkg-0.5.5+forge-mc1.20.1" = _O1Ci5kUy;
        "pkg-0.5.6+fabric-mc1.18.2" = _rPCMTZJj;
        "pkg-0.5.6+fabric-mc1.19.2" = _KQ2MYzN0;
        "pkg-0.5.6+fabric-mc1.20.1" = _9PSq2nxO;
        "pkg-0.5.6+forge-mc1.18.2" = _8t7BjqJW;
        "pkg-0.5.6+forge-mc1.19.2" = _BRGHEQfA;
        "pkg-0.5.6+forge-mc1.20.1" = _2wGHT9kO;
        "pkg-0.5.7+forge-mc1.20.1" = _sFv3NBS4;
        "pkg-1.20.1-fabric-0.6.0" = _o01QffwP;
        "pkg-1.20.1-forge-0.6.0" = _3Gpm5qDT;
        "pkg-1.21.1-neoforge-0.6.0" = _kzxCnEpy;
        "pkg-0.6.1" = _gBrfZy6S;
        "default" = _gBrfZy6S;
    });
