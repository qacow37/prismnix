...
let
    ...
    in {
        ...
        "pkg-1.0.0.15" = _ca9Mktl4;
        "pkg-1.0.0.16" = _WleyIqct;
        "pkg-1.0.0.18" = _q2MxGSam;
        "pkg-1.0.0.20" = _LTl2Z6tM;
        "pkg-1.0.0.22" = _vEOOhNJU;
        "pkg-1.0.0.23" = _Hge9Pz5e;
        "pkg-1.0.0.25" = _zPQFanx0;
        "pkg-1.0.1.27" = _M99bTmYC;
        "pkg-1.0.2.29" = _faUIHATJ;
        "pkg-1.0.3.30" = _cgaLHiu1;
        "pkg-2.0.0.5" = _iAyNhzPp;
        "pkg-2.0.1.6" = _iOD0jM2P;
        "pkg-2.1.1.16" = _IigNW2OR;
        "pkg-2.1.2.18" = _DfgXjfM7;
        "pkg-3.0.0.23" = _QZPdPdlj;
        "pkg-3.0.1.26" = _bNMtaorp;
        "pkg-3.0.2.32" = _CBJC7JHP;
        "pkg-3.0.2.33" = _T5GchJ4d;
        "pkg-3.0.3.36" = _3UF1nl7I;
        "pkg-3.0.4.39" = _unVCSlwh;
        "pkg-3.0.5.41" = _W6jyFxlH;
        "pkg-3.0.6.43" = _D7slA35q;
        "pkg-3.1.0.50" = _hSXeJkRs;
        "pkg-3.2.0.60" = _96TH4JdK;
        "pkg-3.2.1.63" = _yGsEOZZ3;
        "pkg-3.2.2.65" = _7QtKnjdx;
        "pkg-3.3.0.72" = _BhpLg7uW;
        "pkg-3.3.1.76" = _BlpYsqVC;
        "pkg-3.3.2.79" = _OfUGFHF2;
        "pkg-3.3.3.83" = _i7Sat6Xo;
        "pkg-3.3.4.85" = _B7vrK3eA;
        "pkg-3.3.4.1" = _Tjh6DTMN;
        "pkg-4.0.0" = _vFdSVk2F;
        "pkg-4.0.1" = _e6Ak9uGu;
        "pkg-4.0.4" = _HnjXWNrR;
        "pkg-4.0.5" = _IuB130xs;
        "pkg-4.0.10" = _892pazev;
        "pkg-4.0.12" = _jSxT4KT8;
        "pkg-5.0.0" = _Nuo1NfkB;
        "pkg-5.0.1" = _kxdQZNd7;
        "pkg-5.0.2" = _vjYK8I8X;
        "pkg-5.0.3" = _BS6xdKLk;
