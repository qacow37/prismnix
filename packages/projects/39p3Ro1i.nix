...
let
    ...
    in {
        ...
        "pkg-v1.0.4-mc1.15.2" = _CXtMcHF1;
        "pkg-v1.0.4-mc1.18.2" = _fZ9hCvcY;
        "pkg-v1.0.4-mc1.20.2" = _9XH4AOhg;
        "pkg-v1.0.4-mc1.16.5" = _PFmk3HyV;
        "pkg-v1.0.4-mc1.21.1" = _arPkXG8G;
        "pkg-v1.0.4-mc1.20.4" = _44xEDedg;
        "pkg-v1.0.4-mc1.21.3" = _RH4pBkju;
        "pkg-v1.0.4-mc1.21.8" = _e1IrcN57;
        "pkg-v1.0.4-mc1.21.9" = _OeCMtdkX;
        "pkg-v1.0.4-mc1.14.4" = _J5knmEtB;
        "pkg-v1.0.4-mc1.21.5" = _3tGKAiE7;
        "pkg-v1.0.4-mc1.19.4" = _DV6dhfUz;
        "pkg-v1.0.4-mc1.21.4" = _sl7HDs3D;
        "pkg-v1.0.4-mc1.20.1" = _pjjLkFLZ;
        "pkg-v1.0.5-mc1.18.2" = _8GVokhB9;
        "pkg-v1.0.5-mc1.21.8" = _cZKwILPy;
        "pkg-v1.0.5-mc1.20.1" = _61eHkx8j;
        "pkg-v1.0.5-mc1.17.1" = _SmGbkLWf;
        "pkg-v1.0.5-mc1.21.3" = _VAAUjUkE;
        "pkg-v1.0.5-mc1.20.6" = _39Lksupv;
        "pkg-v1.0.5-mc1.15.2" = _CYgHBhCQ;
        "pkg-v1.0.5-mc1.20.2" = _v1CanOJw;
        "pkg-v1.0.5-mc1.21.5" = _As3NHBUp;
        "pkg-v1.0.5-mc1.21.4" = _LBNWOwQ0;
        "pkg-v1.0.5-mc1.16.5" = _4R0C82mQ;
        "pkg-v1.0.5-mc1.14.4" = _opFsvDcc;
        "pkg-v1.0.5-mc1.20.4" = _8PTkJfj5;
        "pkg-v1.0.5-mc1.21.10-rc1" = _osLLn8Mk;
        "pkg-v1.0.5-mc1.21.1" = _yRVMFHXS;
        "pkg-v1.0.5-mc1.19.4" = _cmYpOFCz;
        "pkg-v1.0.6-mc1.21.1" = _PhgWGgCw;
        "pkg-v1.0.6-mc1.19.4" = _KVGo3i0q;
        "pkg-v1.0.6-mc1.21.4" = _I704UOtO;
        "pkg-v1.0.6-mc1.21.11" = _cyFchCv0;
        "pkg-v1.0.6-mc1.16.5" = _rnBUhBlF;
        "pkg-v1.0.6-mc1.20.1" = _EXHOPl3s;
        "pkg-v1.0.6-mc1.21.5" = _jVELSgnA;
        "pkg-v1.0.6-mc1.20.2" = _rmXaVt50;
        "pkg-v1.0.6-mc1.17.1" = _jJowkiLb;
        "pkg-v1.0.6-mc1.20.4" = _XnOgl6pX;
        "pkg-v1.0.6-mc1.20.6" = _IRym9i5L;
        "pkg-v1.0.6-mc1.14.4" = _Kn6WPh8U;
        "pkg-v1.0.6-mc1.21.8" = _of2iAP1m;
        "pkg-v1.0.6-mc1.15.2" = _Ac7Hnzya;
        "pkg-v1.0.6-mc1.21.10" = _6i8M12l9;
        "pkg-v1.0.6-mc1.18.2" = _aZNjOvKf;
        "pkg-v1.0.6-mc1.21.3" = _8TpNbhvY;
        "pkg-v1.0.7-mc1.14.4" = _3BtfVTgN;
        "pkg-v1.0.7-mc1.20.4" = _TPKpeEpo;
        "pkg-v1.0.7-mc1.16.5" = _qzPCXym5;
        "pkg-v1.0.7-mc1.21.8" = _6ud915KY;
        "pkg-v1.0.7-mc1.18.2" = _hkpwMCvt;
        "pkg-v1.0.7-mc1.20.2" = _3sCpn6Fr;
        "pkg-v1.0.7-mc1.21.11" = _yea8ouq0;
        "pkg-v1.0.7-mc1.20.1" = _BrkMSBtP;
        "pkg-v1.0.7-mc1.17.1" = _yoWymO5f;
        "pkg-v1.0.7-mc1.21.10" = _qexMkF1e;
        "pkg-v1.0.7-mc1.20.6" = _iIFl7Ois;
        "pkg-v1.0.7-mc1.21.3" = _XMKtjY1B;
        "pkg-v1.0.7-mc1.21.1" = _dBI8PFdB;
        "pkg-v1.0.7-mc1.21.4" = _WRSEjm63;
        "pkg-v1.0.7-mc1.15.2" = _wJrA0UXc;
        "pkg-v1.0.7-mc1.19.4" = _Y54e4iHV;
        "pkg-v1.0.7-mc1.21.5" = _77DD5Dkx;
        "pkg-v1.0.8-mc1.17.1" = _BUdVjrCC;
        "pkg-v1.0.8-mc1.14.4" = _T4AaToZY;
        "pkg-v1.0.8-mc1.16.5" = _J6yHnJCu;
        "pkg-v1.0.8-mc1.15.2" = _mjavFkoX;
        "pkg-v1.0.8-mc1.19.4" = _PfdG26JR;
        "pkg-v1.0.8-mc1.20.1" = _j0eakyPt;
        "pkg-v1.0.8-mc1.18.2" = _HtYDidBN;
        "pkg-v1.0.8-mc1.20.2" = _c6u0Xjjx;
        "pkg-v1.0.8-mc1.20.6" = _9uhALnr5;
        "pkg-v1.0.8-mc1.20.4" = _h1A4oikc;
        "pkg-v1.0.8-mc1.21.1" = _uIZetBDb;
        "pkg-v1.0.8-mc1.21.4" = _dfhJgfVB;
        "pkg-v1.0.8-mc1.21.3" = _rI3DWvH1;
        "pkg-v1.0.8-mc1.21.5" = _twld6Lid;
        "pkg-v1.0.8-mc1.21.8" = _SWg28qdb;
        "pkg-v1.0.8-mc1.21.11" = _kh9YyqtK;
        "pkg-v1.0.8-mc1.21.10" = _mpQ5llei;
        "pkg-v1.0.8-mc26.1" = _ytCiqtvZ;
        "pkg-v1.0.9-mc1.16.5" = _ZWZogJiv;
        "pkg-v1.0.9-mc1.14.4" = _jZ3Py0SK;
        "pkg-v1.0.9-mc1.17.1" = _K70PFQQm;
        "pkg-v1.0.9-mc1.15.2" = _MjniLADE;
        "pkg-v1.0.9-mc1.20.1" = _XTWxkMDA;
        "pkg-v1.0.9-mc1.19.4" = _3sAVls4n;
        "pkg-v1.0.9-mc1.18.2" = _OSMiQkf7;
        "pkg-v1.0.9-mc1.20.2" = _aQLasMcL;
        "pkg-v1.0.9-mc1.20.4" = _dLRMnsQx;
        "pkg-v1.0.9-mc1.20.6" = _fG6mHuCQ;
        "pkg-v1.0.9-mc1.21.3" = _KZbuZGSz;
        "pkg-v1.0.9-mc1.21.1" = _mf9BkfDR;
        "pkg-v1.0.9-mc1.21.4" = _inQvlahG;
        "pkg-v1.0.9-mc1.21.8" = _XhZK6iw1;
        "pkg-v1.0.9-mc1.21.5" = _czLYsmN4;
        "pkg-v1.0.9-mc1.21.10" = _cBHtuRaW;
        "pkg-v1.0.9-mc1.21.11" = _EG9FvO0B;
        "pkg-v1.0.9-mc26.1.1" = _GayfkR0q;
        "pkg-v1.0.10-mc1.15.2" = _3U07EgJ5;
        "pkg-v1.0.10-mc1.17.1" = _VhdPLT5e;
        "pkg-v1.0.10-mc1.14.4" = _9d2yfBts;
        "pkg-v1.0.10-mc1.16.5" = _XZji5QUj;
        "pkg-v1.0.10-mc1.20.2" = _zjRwZu3P;
        "pkg-v1.0.10-mc1.18.2" = _BmXW0Gzq;
        "pkg-v1.0.10-mc1.20.1" = _qJNkS5IK;
        "pkg-v1.0.10-mc1.19.4" = _Wc4PpPVr;
        "pkg-v1.0.10-mc1.20.6" = _p7uQqFhn;
        "pkg-v1.0.10-mc1.20.4" = _yD117xUJ;
        "pkg-v1.0.10-mc1.21.3" = _cjGAYuGo;
        "pkg-v1.0.10-mc1.21.1" = _QRKHrHlz;
        "pkg-v1.0.10-mc1.21.4" = _HfCakQaC;
        "pkg-v1.0.10-mc1.21.8" = _BMvpqSst;
        "pkg-v1.0.10-mc1.21.5" = _RRqB4O3p;
        "pkg-v1.0.10-mc1.21.10" = _Z3CQFolu;
