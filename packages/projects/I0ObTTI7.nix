...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.21.1" = _AH3F1h2N;
        "pkg-0.1.1+1.21.1" = _wPDgWcMC;
        "pkg-0.1.1+1.21.3" = _UI17JO0E;
        "pkg-0.1.2+1.21.1" = _iRwTLMOu;
        "pkg-0.1.2+1.21.3" = _QyWpRNYX;
        "pkg-0.1.3+1.20.6" = _LzqDuE8D;
        "pkg-0.1.3+1.21.3" = _xt3EufiD;
        "pkg-0.1.3+1.20.1" = _Z5VFv6DB;
        "pkg-0.1.3+1.21.1" = _ZOvN0hld;
        "pkg-0.1.3+1.19" = _K0khiuks;
        "pkg-0.1.4+1.20.6" = _mGyPitnn;
        "pkg-0.1.4+1.21.1" = _K9ZAC1so;
        "pkg-0.1.4+1.21.3" = _kDtj1Zat;
        "pkg-0.1.4+1.20.1" = _s8YI97MX;
        "pkg-0.1.4+1.19" = _avwT78mt;
        "pkg-0.1.5+1.21.1" = _i8tnWIAz;
        "pkg-0.1.5+1.21.3" = _U2Dxp6nc;
        "pkg-0.1.5+1.20.1" = _kdC5CWdG;
        "pkg-0.1.5+1.20.6" = _3aONn1Mn;
        "pkg-0.1.5+1.19" = _hPYbZtk7;
        "pkg-0.1.6+1.19" = _fcZtftXP;
        "pkg-0.1.6+1.20.1" = _evBTl6j6;
        "pkg-0.1.6+1.20.6" = _VpmTETvD;
        "pkg-0.1.6+1.21.1" = _m9D5w3pt;
        "pkg-0.1.6+1.21.3" = _W8rZNMve;
        "pkg-0.1.7+1.19" = _Fj2V8ZKU;
        "pkg-0.1.7+1.20.1" = _G5Y0PHlm;
        "pkg-0.1.7+1.20.6" = _YMZbolpL;
        "pkg-0.1.7+1.21.1" = _BEG5Ajaj;
        "pkg-0.1.7+1.21.3" = _oTnSdvz8;
        "default" = _oTnSdvz8;
    });
