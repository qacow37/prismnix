...
let
    ...
    in {
        ...
        "pkg-1.0.7" = _AJ2t1ts8;
        "pkg-1.0.9" = _5lyfF52O;
        "pkg-1.0.10" = _aKLLyF5i;
        "pkg-1.0.11" = _R9rgpXkc;
        "pkg-1.0.12" = _HKT3k0K7;
        "pkg-1.0.13" = _2MSgF0EJ;
        "pkg-2.0.0+pre1" = _C3KSDsfS;
        "pkg-2.0.0+pre2" = _BxhFb6NM;
        "pkg-1.0.14" = _1skwUthj;
        "pkg-2.0.0+pre3" = _1y5ceoIR;
        "pkg-2.0.0+pre4" = _7Cs6DkRq;
        "pkg-2.0.0+pre5" = _Z4Gn7TD3;
        "pkg-1.0.15" = _twE3NKUz;
        "pkg-1.0.12+1.18" = _M8J4qlkS;
        "pkg-1.0.16" = _Jy7FiDB8;
        "pkg-1.0.17+1.18" = _1YzKOpc7;
        "pkg-1.0.18+1.18" = _bjj7jwyt;
        "pkg-1.0.19+1.18" = _GQRhReo0;
        "pkg-1.0.20+1.18" = _dGj7deL9;
        "pkg-1.0.21+1.18" = _zQidY0YR;
        "pkg-1.0.22+1.18" = _1UvuMKQj;
        "pkg-1.0.22+1.19" = _cXDHm4Gx;
        "pkg-1.0.23+1.19" = _iz8DRAro;
        "pkg-1.0.24+1.19" = _gzxiHVk7;
        "pkg-1.0.25+1.19" = _YQZnkMDA;
        "pkg-1.0.26+1.19" = _GrBHP1v7;
        "pkg-1.0.26+1.19.3" = _fUktuqX2;
        "pkg-1.0.27+1.19.3" = _Cglb3tJu;
        "pkg-1.0.27+1.19.4" = _cQHcyWo4;
        "pkg-1.0.28+1.20" = _xDF7ssCk;
        "pkg-1.0.28+1.20.2" = _5AdxznHY;
        "pkg-1.0.29+1.20.2" = _YlBd0idp;
        "pkg-1.0.29+1.20" = _ntapZgVV;
        "pkg-1.0.29+1.20.3" = _bvxga7B4;
        "pkg-1.0.30+1.20.3" = _zd4uSSZh;
        "default" = _zd4uSSZh;
    });
