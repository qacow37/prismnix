...
let
    ...
    in {
        ...
        "pkg-1.5.0+1.16.5" = _1PcCmYLz;
        "pkg-1.5.0+1.18.2" = _5uiUnvye;
        "pkg-1.5.0+1.19.2" = _1U3DkDVr;
        "pkg-1.5.0+1.19.3" = _NheGToLD;
        "pkg-1.5.1+1.18.2" = _86lniCMA;
        "pkg-1.5.1+1.19.3" = _8AvINxSe;
        "pkg-1.5.1+1.19.2" = _p4HOkt75;
        "pkg-1.5.2+1.18.2" = _ItFDHfOh;
        "pkg-1.5.2+1.19.2" = _iDMhZCMm;
        "pkg-1.5.2+1.19.3" = _AlYb7jho;
        "pkg-1.5.3+1.18.2" = _XSa0AGrb;
        "pkg-1.5.3+1.19.2" = _dJFvp5Wg;
        "pkg-1.5.3+1.19.3" = _sXVjEWet;
        "pkg-1.5.4+1.19.2" = _gTwv9hmK;
        "pkg-1.5.4+1.18.2" = _tvRKy6uB;
        "pkg-1.5.4+1.19.3" = _llUK5UYa;
        "pkg-1.5.5+1.18.2" = _ZznTwDbG;
        "pkg-1.5.5+1.19.2" = _bPXk0QuM;
        "pkg-1.5.5+1.19.3" = _JqkaFvnt;
        "pkg-1.5.5+1.19.4" = _MqJ5KT5k;
        "pkg-1.5.6+1.18.2" = _NMMsoxx6;
        "pkg-1.5.6+1.19.2" = _rHmDsz9m;
        "pkg-1.5.6+1.19.3" = _rv6WHkIG;
        "pkg-1.5.6+1.19.4" = _etf2tkKo;
        "pkg-1.6.0+1.20.1" = _1iL7L4Cx;
        "pkg-1.6.1+1.20.1" = _g70ZMcU2;
        "pkg-1.5.1+1.16.5" = _MIbWIfzI;
        "pkg-1.7.0+1.20.1" = _gtm6KcNE;
        "pkg-1.7.0+1.21.1" = _Cfw5l8OG;
        "pkg-1.7.1+1.20.1" = _Ivcp8xyi;
        "pkg-1.7.1+1.21.1" = _f3V07285;
        "pkg-1.7.2+1.21.1" = _zp2nhn76;
        "pkg-1.7.3+1.21.1" = _co70q6sN;
        "pkg-1.7.4+1.21.1" = _sbHuslfc;
        "pkg-1.7.5+1.21.1" = _J8fqZZG7;
        "pkg-1.7.2+1.20.1" = _ZPdUJXFG;
        "pkg-1.7.6+1.21.1" = _B2YtQYCh;
        "pkg-1.8.0+26.1.2" = _m86HqHW4;
        "pkg-1.8.0+26.2" = _I2NBM34K;
        "pkg-1.8.1+26.1.2" = _1zKCa66X;
        "pkg-1.8.1+26.2" = _hga2z8pc;
        "pkg-1.8.2+26.2" = _JJlWSXdS;
        "pkg-1.8.2+26.1.2" = _1FTqwOHX;
        "default" = _1FTqwOHX;
    });
