...
let
    ...
    in {
        ...
        "pkg-0.8.3" = _IypDP2YU;
        "pkg-0.9.0" = _QoNCi3kq;
        "pkg-0.9.0+1.20" = _Jl220nPU;
        "pkg-0.9.1+1.20" = _oETCc3sf;
        "pkg-0.9.2+1.20" = _Relg5dBM;
        "pkg-0.9.3+1.20" = _5tRFmRAm;
        "pkg-0.9.4+1.20.2" = _QExqBkrU;
        "pkg-0.9.5+1.20.4" = _Rf60vwxM;
        "pkg-0.9.6+1.20.4" = _MMwxzSjK;
        "pkg-0.10.0+1.20.4+fabric" = _UngvZnfo;
        "pkg-0.10.0+1.20.4+neoforge" = _YyPjX7fq;
        "pkg-0.10.1+1.20.4+fabric" = _8plvfEPa;
        "pkg-0.10.1+1.20.4+neoforge" = _khODZH7g;
        "pkg-0.11.0+1.21" = _SGt2iTCP;
        "pkg-0.11.1+1.21" = _h8jGqPDv;
        "pkg-0.11.2+1.21" = _71ZoZ58B;
        "default" = _71ZoZ58B;
    });
