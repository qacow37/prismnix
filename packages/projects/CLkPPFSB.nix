...
let
    ...
    in {
        ...
        "pkg-1.0-1.18.2" = _fpvY8rrN;
        "pkg-1.0.1-1.18.2" = _cCT0C4L6;
        "pkg-1.1.0-1.18.2" = _wNEYAEMm;
        "pkg-1.1.1-1.18.2" = _3OUu4gAw;
        "pkg-1.1.2-1.18.2" = _RXRricO5;
        "pkg-1.1.3-1.18.2" = _EVgpeeqs;
        "pkg-1.1.4" = _H5f1kat1;
        "pkg-1.1.5" = _OqnpcFTT;
        "pkg-1.1.6" = _okioEfPG;
        "pkg-1.1.7" = _aRqJ90c5;
