...
let
    ...
    in {
        ...
        "pkg-2.7.8" = _Z0hsPDia;
        "pkg-2.7.9" = _rnGXWihu;
        "pkg-2.7.10" = _XzGcNLV7;
        "pkg-2.7.11" = _nsn0UT4O;
        "pkg-2.7.12" = _Kq0vpK6X;
        "pkg-2.7.13" = _pKGIR8jd;
        "pkg-2.7.14" = _7JdBUrWM;
        "pkg-2.8.0" = _X4sZkYJ4;
        "pkg-2.8.1" = _VuWZOKE9;
        "pkg-2.8.2" = _tDuT2o2N;
        "pkg-2.8.3" = _2oa6SYiF;
        ...
        "pkg-2.8.7" = _bgLA8HzS;
        "pkg-2.8.8" = _WL6Qlmkt;
        "pkg-2.8.10" = _W0RIKTI1;
        "pkg-2.8.11" = _NgTlfUXj;
        "pkg-2.8.12" = _QqhGeJ2H;
        "pkg-2.8.13" = _AGESgIXL;
        "pkg-2.8.14" = _E36hiHLn;
        "pkg-2.8.15" = _dUMz42ZY;
        "pkg-2.9.0" = _by97xGiH;
        "pkg-2.9.1" = _G2E9k1hA;
        "pkg-2.9.2" = _PGCFFKYm;
        "pkg-2.9.3" = _uo7XYEYt;
        ...
        "pkg-3.0.8" = _nzXb97EV;
        "pkg-3.0.9" = _aKR5angs;
        "pkg-3.0.10" = _6Ics4NCI;
        "pkg-3.0.11" = _NQJa3kGh;
        "pkg-3.1.0" = _4kFuxLBi;
        "pkg-3.1.1" = _qJiar1Q1;
        "pkg-3.1.2" = _UHD6wIqh;
        "pkg-3.1.3" = _25dRLosf;
        ...
        "pkg-3.5.0" = _V49f4mzi;
        "pkg-3.5.1" = _IcNmW7wT;
        "pkg-4.0.0-DEV-1" = _hV9uFnSH;
        "pkg-4.0.0-DEV-2" = _vxrrqCnc;
        "pkg-4.0.0-DEV-3" = _IBC1Gcfi;
        "pkg-4.0.0-DEV-4" = _nv5SnsTg;
        "pkg-4.0.0-DEV-5" = _KPa8eb00;
        "pkg-4.0.0-DEV-6" = _AxtmQCuj;
        "pkg-4.0.0-DEV-7" = _jWw1S3sx;
        "pkg-4.0.0-DEV-8" = _vXUjSjEH;
        "pkg-4.0.0-DEV-9" = _ZCrmRfR2;
        "pkg-4.0.0" = _ww7IMHLU;
        "pkg-4.0.1" = _8BZHkGjD;
        "pkg-4.0.2" = _VVhobgJe;
        "pkg-4.0.3" = _czjVRXSW;
        ...
        "pkg-4.2.2" = _AimoGRXg;
        "pkg-4.2.3" = _Nalwyciv;
        "pkg-4.2.3.1" = _DhTMxLBv;
        "pkg-4.3.0.0" = _B4QIHPUX;
        "pkg-5.0.0-DEV-1" = _uHNwQwtn;
        "pkg-5.0.0-DEV-2" = _Uvs8ZfSd;
        "pkg-5.0.0-DEV-3" = _mcVbNFo8;
        "pkg-5.0.0-DEV-4" = _fNKM25eI;
        "pkg-5.0.0-DEV-5" = _CX9sodmW;
        "pkg-5.0.0-DEV-6" = _mOn5L81H;
        "pkg-5.0.0" = _J3cOJdNZ;
        "default" = _J3cOJdNZ;
    });
