...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.21.5-fabric" = _W2O0z483;
        "pkg-1.0.0+mc1.21.4-fabric" = _GcBcfxQA;
        "pkg-1.0.0+mc1.21-fabric" = _QUQdRRX6;
        "pkg-1.0.0+mc1.20.1-fabric" = _CcXxLww0;
        "pkg-1.0.1+mc1.20.5-fabric" = _Mr8fuzVi;
        "pkg-1.0.1+mc1.21.2-fabric" = _YfXIlgmg;
        "pkg-1.0.1+mc1.20.2-fabric" = _UAuvTtkR;
        "pkg-1.0.1+mc1.20.3-fabric" = _7dW09Lm6;
        "pkg-1.0.2+mc1.21.5-fabric" = _U9nJJQwu;
        "pkg-1.0.2+mc1.21.4-fabric" = _77WuzEn7;
        "pkg-1.0.2+mc1.21.2-fabric" = _S3JfFmG6;
        "pkg-1.0.2+mc1.21-fabric" = _dwWMfbQU;
        "pkg-1.0.2+mc1.20.5-fabric" = _VMdYamfW;
        "pkg-1.0.2+mc1.20.3-fabric" = _yt1PAmF6;
        "pkg-1.0.2+mc1.20.2-fabric" = _fp7CqRSa;
        "pkg-1.0.2+mc1.20.1-fabric" = _ASzDhR1R;
        "pkg-1.0.3+mc1.21.6-fabric" = _sfqW7WCt;
        "pkg-1.0.4+mc1.21.7-fabric" = _599p8IUv;
        "pkg-1.0.5+mc1.21.6-fabric" = _yaVznhgX;
        "pkg-1.0.6+mc1.21.9-fabric" = _sdqkdvoW;
        "pkg-1.0.7+mc1.21.9-fabric" = _KPCsi8HY;
        "pkg-1.0.8+mc1.21.11-fabric" = _ACCD4MP4;
        "default" = _ACCD4MP4;
    });
