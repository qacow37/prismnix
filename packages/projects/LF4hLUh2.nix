...
let
    ...
    in {
        ...
        "pkg-v1+1.20" = _WwBzh4KT;
        "pkg-v1+1.20.2" = _orAt9Uas;
        "pkg-v2+1.20" = _8p56OyGt;
        "pkg-v2+1.20.2" = _D0si3OGK;
        "pkg-v2+1.20.3" = _dAzQ6SyD;
        "pkg-v3+1.20" = _zktwo9wY;
        "pkg-v3+1.20.2" = _5mE7gZZ2;
        "pkg-v3+1.20.3" = _pPuFRGsk;
        "pkg-v4+1.20" = _BCPphvrY;
        "pkg-v4+1.20.2" = _mPT639fD;
        "pkg-v4+1.20.4" = _TM0vtQdy;
        "pkg-v5+1.20" = _veT1WFlo;
        "pkg-v5+1.20.2" = _u3TOf8YL;
        "pkg-v5+1.20.4" = _PxSMOUj2;
        "pkg-v6" = _RncibF9v;
        "pkg-v7" = _BTqAcbp3;
        "pkg-v8" = _oaLPSnWC;
        "pkg-v8.1" = _tqK2vrQW;
