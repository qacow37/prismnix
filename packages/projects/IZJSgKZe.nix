...
let
    ...
    in {
        ...
        "pkg-2.6.3.7" = _jL2xTD19;
        "pkg-3.0.0.0" = _WeFVYYWj;
        "pkg-3.0.0.2" = _Ge63wkwn;
        "pkg-3.0.0.3" = _qhRpfcxy;
        "pkg-2.5.2" = _nlEsinMJ;
        "pkg-2.4.2" = _mcFNvgsV;
        "pkg-3.0.0.4" = _Mf5Tje43;
        "pkg-3.0.0.5" = _ms6xjofW;
        "pkg-3.0.0.6" = _dB9TJoKu;
        "pkg-3.0.0.10" = _fkw2tuo1;
        "pkg-3.0.0.12-alpha" = _kBie8J7T;
        "pkg-3.0.0.15-alpha" = _rMG2q64e;
        "pkg-3.0.0.0-beta" = _SIt67yAF;
        "pkg-3.0.0.0-beta-1.17.1" = _yWY3gpuL;
        "pkg-3.0.0.0-beta-1.18.2" = _s2UCaFuX;
        "pkg-3.0.0.1-beta-1.17.1" = _vOcaQr40;
        "pkg-3.0.0.1-beta-1.18.2" = _SbpEEGYP;
        "pkg-3.0.0.2-beta-1.17.1" = _xN9Z95L5;
        "pkg-3.0.0.2-beta-1.18.2" = _b0aZKUaP;
        "pkg-3.0.0.3-beta" = _H4mR6GSB;
        "pkg-3.0.0.3-beta-1.17.1" = _X07ajVJW;
        "pkg-3.0.0.3-beta-1.18.2" = _ksfD8qUP;
        "pkg-3.0.0.4-beta" = _P26BhCCq;
        "pkg-3.0.0.4-beta-1.17.1" = _QtlLcqNq;
        "pkg-3.0.0.4-beta-1.18.2" = _lupFP79J;
        "pkg-3.0.0.6-beta-1.16.4" = _dX1uLP7m;
        "pkg-3.0.0.6-beta-1.17.1" = _bMpQie5w;
        "pkg-3.0.0.6-beta-1.18.2" = _s7011cPE;
        "pkg-3.0.0.7-beta-1.16.4" = _f6SCTx3B;
        "pkg-3.0.0.7-beta-1.17.1" = _fDxZCwAg;
        "pkg-3.0.0.7-beta-1.18.2" = _8RZ9Nzcn;
        "pkg-3.0.0.8-beta-1.16.4" = _xjIZ8erp;
        "pkg-3.0.0.8-beta-1.17.1" = _HA8b3zv4;
        "pkg-3.0.0.8-beta-1.18.2" = _sAuIMH2Z;
        "pkg-3.0.0.8-beta-1.19.4" = _pZV8lgT5;
        "pkg-3.0.0.8-beta-1.20.1" = _ML8C4B1k;
        "pkg-3.0.0.8.1-beta-1.20.1" = _IpGeCZsm;
        "pkg-3.0.0.8-beta-1.19.2" = _TocfJrSf;
        "pkg-3.0.0.8.3-beta-1.20.1" = _bamEVuyp;
        "pkg-3.0.0.8.4-beta-1.20.1" = _etKmNdI1;
        "pkg-3.0.0.9-beta-1.16.4" = _I2fhndsJ;
        "pkg-3.0.0.9-beta-1.17.1" = _Pan8dRB0;
        "pkg-3.0.0.9-beta-1.18.2" = _DjZI5Xdn;
        "pkg-3.0.0.9-beta-1.19.2" = _qiD2NMTG;
        "pkg-3.0.0.9-beta-1.19.4" = _QcxuST8h;
        "pkg-3.0.0.9-beta-1.20.1" = _J9yE6vNh;
        "pkg-3.0.0.10-beta-1.16.4" = _iFFLtQti;
        "pkg-3.0.0.10-beta-1.17.1" = _uDS31Jvs;
        "pkg-3.0.0.10-beta-1.18.2" = _CZXZJM8u;
        "pkg-3.0.0.10-beta-1.19.2" = _3neI4Glu;
        "pkg-3.0.0.10-beta-1.19.4" = _qxelEVqc;
        "pkg-3.0.0.10-beta-1.20.1" = _G8fO0t60;
        "pkg-3.0.0.11-beta-1.16.4" = _UCryOnKI;
        "pkg-3.0.0.11-beta-1.17.1" = _QfLZYQiq;
        "pkg-3.0.0.11-beta-1.18.2" = _ZGzyRMTQ;
        "pkg-3.0.0.11-beta-1.19.2" = _ceM2PFi7;
        "pkg-3.0.0.11-beta-1.19.4" = _pK9axJCb;
        "pkg-3.0.0.11-beta-1.20.1" = _qle4H65A;
        "pkg-3.0.0.12-beta-1.20.1" = _Tj80BJc1;
        "pkg-3.0.0.13-1.16.4" = _3pkFwkF8;
        "pkg-3.0.0.13-1.17.1" = _7bcdHMJU;
        "pkg-3.0.0.13-1.18.2" = _ZKk8vZWW;
        "pkg-3.0.0.13-1.19.2" = _dkGUe125;
        "pkg-3.0.0.13-1.19.4" = _iLI8440U;
        "pkg-3.0.0.13-1.20.1" = _1gBPKZgQ;
        "pkg-3.0.1-1.16.4" = _PU0vkXHi;
        "pkg-3.0.1-1.17.1" = _NoHJxUp0;
        "pkg-3.0.1-1.18.2" = _pDo4JcOS;
        "pkg-3.0.1-1.19.2" = _uz0ZB6xg;
        "pkg-3.0.1-1.19.4" = _FVGroCzv;
        "pkg-3.0.1-1.20.1" = _U7vaWIz2;
        "pkg-3.0.1-1.21.1" = _9TbNvwQO;
        "pkg-3.0.1-1.20" = _RBGErg9y;
        "pkg-3.0.2-1.20.1-fabric" = _NGgpwWSb;
        "pkg-3.0.2-1.21.1-fabric" = _LUBPN5vD;
        "pkg-3.0.2-1.21.1-neoforge" = _xanW2wLy;
        "pkg-3.0.3-1.20.1-fabric" = _zBdSUNTu;
        "pkg-3.0.3-1.21.1-fabric" = _UoAeItNX;
        "pkg-3.0.3-1.21.1-neoforge" = _MWpddHm9;
        "pkg-3.0.4-1.16.4" = _lHDQMBMM;
        "pkg-3.0.4-1.17.1" = _ljuVHWYI;
        "pkg-3.0.4-1.18.2" = _Gh5JhSsL;
        "pkg-3.0.4-1.19.2" = _ek8WgNXO;
        "pkg-3.0.4-1.19.4" = _ya1lIH4Z;
        "pkg-3.0.4-1.20.1" = _K6V6djNF;
        "pkg-3.0.4-1.20.1-fabric" = _o9CDG4YX;
        "pkg-3.0.4-1.21.1-fabric" = _b4CoapuP;
        "pkg-3.0.4-1.21.1-neoforge" = _DDco9Hiq;
        "pkg-decocraft-3.0.5-1.20.1-fabric" = _DugmDwjF;
        "pkg-decocraft-3.0.5-1.20.4-fabric" = _lNJ93Kdq;
        "pkg-decocraft-3.0.5-1.21.1-fabric" = _ybIGl8HA;
        "pkg-decocraft-3.0.5-1.21.1-neoforge" = _43UpRuOu;
        "pkg-decocraft-3.0.6-1.20.1-fabric" = _C2k1KKas;
        "pkg-decocraft-3.0.6-1.20.4-fabric" = _DBsTUbjI;
        "pkg-decocraft-3.0.6-1.21.1-fabric" = _7eD14pWR;
        "pkg-decocraft-3.0.6-1.21.1-neoforge" = _3GsJ5Nyz;
        "pkg-decocraft-3.0.7-1.20.1-fabric" = _MNnrYEjS;
        "pkg-decocraft-3.0.7-1.20.4-fabric" = _LCYDVEQ9;
        "pkg-decocraft-3.0.7-1.21.1-fabric" = _A6gPwaxM;
        "pkg-decocraft-3.0.7-1.21.1-neoforge" = _O3EnrZwo;
        "pkg-decocraft-3.0.7-1.21.11-fabric" = _LIVG0edU;
        "pkg-decocraft-3.0.7-1.21.11-neoforge" = _DMTVsseh;
        "pkg-decocraft-3.0.8-1.21.1-fabric" = _FX2ESgDi;
        "pkg-decocraft-3.0.8-1.21.1-neoforge" = _CuSk5jpe;
        "pkg-decocraft-3.0.9-1.21.1-neoforge" = _wkIgma15;
        "pkg-decocraft-3.0.8-1.21.11-neoforge" = _6YqDuspR;
        "pkg-decocraft-3.0.8-1.21.11-fabric" = _gQe0hcpd;
        "pkg-decocraft-3.0.10-1.21.1-neoforge" = _bmQzNtv9;
        "pkg-decocraft-3.0.9-1.21.11-neoforge" = _rDtRFGUm;
        "pkg-decocraft-3.0.9-1.21.11-fabric" = _SXWQx0NH;
        "pkg-decocraft-3.0.9-1.21.1-fabric" = _H58ogHPH;
        "pkg-decocraft-3.0.11-1.21.1-neoforge" = _Z8xm2POI;
        "default" = _Z8xm2POI;
    });
