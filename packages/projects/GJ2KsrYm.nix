...
let
    ...
    in {
        ...
        "pkg-2.1.6" = _XM6vK2NQ;
        "pkg-2.1.7" = _qcRkh41q;
        "pkg-2026.1.1" = _r3D1qn7r;
        "pkg-fabric-2.0.0+1.21.11" = _mLQlCyn3;
        "pkg-paper-2.0.0+1.21.11" = _iDwInelE;
        "pkg-fabric-3.0.0+1.21.11" = _4tX8PdUO;
        "pkg-paper-3.0.0+1.21.11" = _q8VWSyNb;
        "pkg-fabric-3.0.1+1.21.11" = _Kp3sWTAY;
        "pkg-paper-3.0.1+1.21.11" = _N3ulziYx;
        "pkg-fabric-3.0.1+26.1" = _utUFPTNr;
        "default" = _utUFPTNr;
    });
