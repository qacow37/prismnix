...
let
    ...
    in {
        ...
        "pkg-1.2.0.3" = _6bfbHsrb;
        "pkg-1.3.1.2" = _uW8FFNi1;
        "pkg-1.3.2.0" = _liFJMAJH;
        "pkg-1.3.2.1" = _nVkUp8ql;
        "pkg-1.3.2.2" = _y6e7SPK8;
        "pkg-1.3.2.5" = _pmZ1epfB;
        "pkg-1.3.2.14" = _4tv904pX;
        "pkg-1.3.3.4" = _88sRynwb;
        "pkg-1.3.4.16" = _CX2psz3t;
        "pkg-1.3.4.19" = _2oZouxrJ;
        "pkg-2.0.1.1" = _A4jhdKBQ;
        "pkg-2.0.1.22" = _EHYJQ2gZ;
        "pkg-2.0.1.25" = _YYpWMPxD;
        "pkg-2.0.1.26" = _DuFJLYXk;
        "pkg-2.0.2.32" = _6AdaDNX5;
        "pkg-2.0.2.33" = _bO73c3bd;
        "pkg-2.1.3.36" = _TxGqBlwM;
        "pkg-2.1.5.40" = _stevVYXH;
        "pkg-2.1.5.42" = _oDDib9wY;
        "pkg-2.2.0.52" = _LXxVWkDR;
        "pkg-2.3.0.63" = _p9oIPypy;
        "pkg-2.3.1.65" = _kFviXAvm;
        "pkg-2.3.1.68" = _katKg3x6;
        "pkg-2.4.0.70" = _YpnCZlal;
        "pkg-2.4.1.71" = _CZqo8nMm;
        "pkg-2.4.1.73" = _M1RKj8lT;
        "pkg-2.4.2.74" = _SJP2ATCX;
        "pkg-2.5.0.75" = _sCh6QUyp;
        "pkg-2.5.0.77" = _2x0av5Wt;
        "pkg-2.5.1.79" = _BYB42Gmj;
        "pkg-2.7.0.85" = _8e75sgfA;
        "pkg-2.8.0.86" = _dW5lcfUX;
        "pkg-2.9.0.87" = _Iq4cHuio;
        "pkg-2.9.0.88" = _Udtzd4kO;
        "pkg-2.9.1.89" = _ROhoNJN0;
        "pkg-2.9.2.95" = _NqFz2PEc;
        "pkg-2.9.3.96" = _DLYL20CH;
        "pkg-2.9.4.97" = _H6NPHtk3;
        "pkg-2.10.0.100" = _9XYNvXCn;
        "pkg-2.11.0.102" = _8Y7Ceb4r;
        "pkg-2.12.0.103" = _qjLycJpg;
        "default" = _qjLycJpg;
    });
