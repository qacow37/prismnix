...
let
    ...
    in {
        ...
        "pkg-0.0.2" = _jT1IDFyX;
        "pkg-0.0.3" = _jHTKdkwV;
        "pkg-0.0.4-pre2" = _yZ1VF0jV;
        "pkg-0.0.4" = _FeNTnDAl;
        "pkg-0.0.5-pre.1" = _oIVobwk4;
        "pkg-0.0.5-pre.2" = _igDZaIfl;
        "pkg-v0.1.0-beta.1-1.18.2" = _7xGiWJ4g;
        "pkg-v0.1.0-beta.1-1.19.2" = _95e4zK3A;
        "pkg-v0.1.0-beta.1-1.19.3" = _zJyNdoun;
        "pkg-v0.1.0-beta.2-1.19.3" = _6uMqzjrD;
        "pkg-v0.1.0-beta.2-1.19.2" = _DfjuANrQ;
        "pkg-v0.1.0-beta.2-1.18.2" = _9EDOQDBP;
        "pkg-v0.1.0-1.19.2" = _Qu5lfe6O;
        "pkg-v0.1.0-1.19.3" = _BqX0XHWW;
        "pkg-v0.1.0-1.18.2" = _pyftKJ6i;
        "pkg-v0.1.1-1.19.3" = _zgs7jokj;
        "pkg-v0.1.1-1.19.2" = _ed38F3vf;
        "pkg-v0.1.1-1.18.2" = _Tnb0M7de;
        "pkg-v0.2.0-beta.1-1.19.3" = _jdtU7AMG;
        "pkg-v0.2.0-beta.1-1.18.2" = _Z54RFCFm;
        "pkg-v0.2.0-beta.1-1.19.2" = _Lz4t9hjH;
        "pkg-v0.2.0-1.19.2" = _dqjvzPIA;
        "pkg-v0.2.0-1.18.2" = _49O18Jyh;
        "pkg-v0.2.0-1.19.3" = _fBmpN9co;
        "default" = _fBmpN9co;
    });
