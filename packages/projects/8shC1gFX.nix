...
let
    ...
    in {
        ...
        "pkg-1.2.3" = _u4bJ71r8;
        "pkg-1.2.4" = _c8vyvGaW;
        "pkg-1.2.4.0" = _bW0Ng49J;
        "pkg-1.2.5" = _Uv4tFOgl;
        "pkg-1.2.5.1" = _EWqUNavR;
        "pkg-1.3.0" = _EZ6qfsTX;
        "pkg-1.3.1" = _H4zjxa7k;
        "pkg-1.3.1.1" = _4SrIvqKy;
        "pkg-1.3.2" = _5G2kahYC;
        "pkg-1.4.0" = _P6E28y68;
        "pkg-1.5.0" = _k6xmp8cg;
        "pkg-2.0.0" = _GwlU7rpA;
        ...
        "pkg-9.0.1" = _Rbn4lbDN;
        "pkg-9.0.2" = _jmwTc5n8;
        "pkg-10.0.0-alpha.1" = _x5zYwUMW;
        "pkg-10.0.0" = _zttvITsK;
        "pkg-10.0.1" = _al1gndy9;
        "pkg-10.0.2" = _VIA6xHkC;
        "pkg-11.0.0" = _NcuBKkeE;
        "pkg-11.0.1" = _TobtOr9W;
        "pkg-10.0.3" = _e5tIjkBO;
        "pkg-11.0.2" = _535e2P1K;
        "pkg-11.0.3" = _maXNB1dn;
        "pkg-12.0.0" = _9h3xhh9m;
        "pkg-13.0.0" = _qQsaCBRd;
        "pkg-14.0.0" = _yioiBxNH;
        "pkg-15.0.0" = _GioyhafN;
        "pkg-16.0.0" = _jXPV1xrH;
        "pkg-16.0.1" = _ZX0LKxDz;
        "pkg-16.0.2" = _O4MbFLF2;
        "pkg-16.0.3" = _5QmRxbNU;
        "pkg-17.0.0" = _HTssDOs8;
        "pkg-18.0.0" = _muu5JUaM;
