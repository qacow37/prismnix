...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _VLJmDFFc;
        "pkg-1.0.9" = _neriYA1l;
        "pkg-1.0.10" = _UtZNbhGC;
        "pkg-1.0.101" = _EGNTyQxk;
        "pkg-1.0.11" = _wFVJOMo2;
        "pkg-1.0.12" = _nhyhUIin;
        "pkg-1.0.121" = _c5MsrtuL;
        "pkg-1.0.122" = _G6Zglcv4;
        "pkg-1.0.124" = _Rc6AKqUe;
        "pkg-1.0.125" = _8zOW0pAw;
        "pkg-1.0.126" = _QhIZfzKX;
        "pkg-1.0.13" = _zBVye2pt;
        "pkg-1.0.131" = _FHeIFzmE;
        "pkg-1.0.132" = _Nxppkcw6;
        "pkg-1.0.133" = _Alo94Ac4;
        "pkg-1.0.14" = _15cD0bSP;
        "pkg-1.0.15" = _4mRoGEw9;
        "pkg-1.0.16" = _GvdizvkL;
        "pkg-1.0.161" = _DtyCM5fb;
        "pkg-1.1.0" = _nfnped6M;
        "pkg-1.1.1" = _o4XGQ4ZP;
        "pkg-1.1.2" = _dzNTvsTe;
        "pkg-1.1.3" = _yrvvLXoI;
