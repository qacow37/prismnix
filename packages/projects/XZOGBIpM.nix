...
let
    ...
    in {
        ...
        "pkg-2.1.1+MC1.16.1" = _VofyOxUh;
        "pkg-2.1.1+MC1.15.2" = _V47eUZPe;
        "pkg-2.1.2+MC1.16.1" = _fXJek8zp;
        "pkg-2.1.2+MC1.15.2" = _2MHZXz8k;
        "pkg-2.2.0+MC1.15.2" = _dbQ3WN6P;
        "pkg-2.2.0+MC1.16.1" = _51fM5oyJ;
        "pkg-2.2.1+MC1.15.2" = _Rs3VJEed;
        "pkg-2.2.1+MC1.16.1" = _3WELwKj4;
        "pkg-2.3.0+MC1.15.2" = _qq31e3iR;
        "pkg-2.3.0+MC1.16.1" = _Ij9wL66B;
        "pkg-2.4.1+MC1.16.1" = _D31Mjrnz;
        "pkg-2.4.2+MC1.16.1" = _1jIUBPwz;
        "pkg-2.4.3+MC1.16.1" = _KgitS7Mc;
        "pkg-3.0.0+MC1.16.1" = _4CzQNRh5;
        "pkg-3.0.1+MC1.16.1" = _fushXNGt;
        "pkg-4.0.0+MC1.16.1" = _Hoyjt5fj;
        "pkg-4.0.1+MC1.16.1" = _aZMG4r5L;
        "pkg-5.0.0+MC1.16.1" = _NXYXDrB6;
        "pkg-5.0.1+MC1.16.1" = _nDAccNWj;
        "pkg-5.1.0+MC1.16.1" = _TcTlTNlF;
        "pkg-5.2.0+MC1.16.1" = _4IW4nMP3;
        "pkg-5.3.0+MC1.16.1" = _qc4OUmcd;
        "default" = _qc4OUmcd;
    });
