...
let
    ...
    in {
        ...
        "pkg-1.0" = _RV5DXjVR;
        "pkg-1.0_mod" = _dgxF38UU;
        "pkg-1.1" = _CTzGPLX4;
        "pkg-1.2" = _eICd42pl;
        "pkg-1.2+mod" = _aXeWyafr;
        "pkg-1.3" = _bhMuyTxG;
        "pkg-1.3+mod" = _rADFfnsS;
        "pkg-2.0" = _ZJHpSuzB;
        "pkg-2.0+mod" = _9GvYAJ1v;
        "pkg-3.0" = _Z13hAOgH;
        "pkg-3.0+mod" = _SQuSeVbI;
        "pkg-3.1" = _VpTTBrVZ;
        "pkg-4.0" = _wgUZ5TUF;
        "pkg-4.0+mod" = _NgHKO0j8;
        "pkg-4.1" = _LjLRJuTF;
        "pkg-4.1+mod" = _huaEwW7z;
        "pkg-4.2" = _UwAKmcXL;
        "pkg-4.3" = _NB3Hguht;
        "pkg-4.3+mod" = _7dxvvxfT;
        "pkg-4.4" = _ioJpT1ZJ;
        "pkg-4.4+mod" = _1kQ57GFv;
        "pkg-4.5" = _BJaKXSOQ;
        "pkg-4.5+mod" = _EH561TEj;
        "pkg-4.6" = _1XlGJuyO;
        "pkg-4.6+mod" = _JJbfQHMD;
        "pkg-4.7" = _Vjqxwsty;
        "pkg-4.7-fabric" = _UoASkmqW;
        "pkg-4.7-forge" = _BzZV8qhQ;
        "pkg-4.8" = _1NRS1W16;
        "pkg-4.8-fabric" = _aYnd2J3B;
        "pkg-4.8-forge" = _7y80r1as;
        "pkg-4.12" = _cMBMI63D;
        "pkg-4.12-fabric" = _hXTpDqhZ;
        "pkg-4.12-quilt" = _S5kYp3fl;
        "pkg-4.12-forge" = _klephO5K;
        "pkg-4.12-neoforge" = _v0lpLvDn;
        "pkg-4.13" = _YSlgj2km;
        "pkg-4.13-fabric" = _Jh88zwwt;
        "pkg-4.13-quilt" = _kOCgqLQ6;
        "pkg-4.13-forge" = _WweyGpPf;
        "pkg-4.13-neoforge" = _3fjUW38v;
        "default" = _3fjUW38v;
    });
