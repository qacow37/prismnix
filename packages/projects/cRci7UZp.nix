...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _ydd68ewP;
        "pkg-1.4.0" = _4jfKIA1o;
        "pkg-1.5.0+1.20.4" = _rnzqlLWj;
        "pkg-2.0.0" = _a7SGwes5;
        "pkg-2.1.0+1.21-NeoForge" = _ZqLmdmIh;
        "pkg-2.1.0+1.21-Fabric" = _8JgMtZ4J;
        "pkg-2.1.1" = _kiNb5sN8;
        "pkg-2.1.1+1.21-NeoForge" = _65WXhhAr;
        "pkg-2.2.0+1.21.3-Fabric" = _y05O3G0B;
        "pkg-2.2.0+1.21.3-NeoForge" = _Xe8vnkm5;
        "pkg-2.3.0+1.21.3-NeoForge" = _usXJN2fU;
        "pkg-2.3.0+1.21.3-Fabric" = _TawVtgmk;
        "pkg-2.4.0+1.21.3-NeoForge" = _ZqZ3iDud;
        "pkg-2.4.0+1.21.3-Fabric" = _3ouy1Fa3;
        "pkg-2.4.1+1.21.4-NeoForge" = _dTuY3C5u;
        "pkg-2.4.1+1.21.4-Fabric" = _JT0fNDm0;
        "pkg-2.4.2-Fabric" = _cOzf5FGy;
        "pkg-2.4.2-NeoForge" = _hEEwiIkk;
        "pkg-2.5.0-Fabric" = _qwsjNh20;
        "pkg-2.5.0-NeoForge" = _GgPGB7uW;
        "pkg-3.0.0+1.21.6-neoforge" = _j5xkmkwg;
        "pkg-3.0.0+1.21.6-fabric" = _bnQbILcA;
        "pkg-3.1.0+1.21.8-neoforge" = _FnXXCaw8;
        "pkg-3.1.0+1.21.8-fabric" = _7CX09IAr;
        "pkg-3.1.1+1.21.8-neoforge" = _9nqAJVxJ;
        "pkg-3.1.1+1.21.8-fabric" = _Tqg8vgEZ;
        "pkg-3.1.2+1.21.10-neoforge" = _FZjjHutg;
        "pkg-3.1.2+1.21.10-fabric" = _kD979Lz9;
        "pkg-3.2.0+1.21.10-fabric" = _3AyvFHZP;
        "pkg-3.2.0+1.21.11-fabric" = _lwcJJsVT;
        "pkg-3.2.0+1.21.10-neoforge" = _FLli07lm;
        "pkg-3.2.0+1.21.11-neoforge" = _xBH3M1r6;
        "pkg-3.2.1+1.21.11-fabric" = _C6iwvtoz;
        "pkg-3.2.1+1.21.5-neoforge" = _bmqftD2D;
        "pkg-3.2.1+1.21.10-fabric" = _chzbuwu0;
        "pkg-3.2.1+1.21.11-neoforge" = _W7a1mSM0;
        "pkg-3.2.1+1.21.4-fabric" = _JjB6EBxC;
        "pkg-3.2.1+1.21.10-neoforge" = _qmRq7zmD;
        "pkg-3.2.1+26.1-neoforge" = _VRcfacK1;
        "pkg-3.2.1+26.1-fabric" = _YzNJMQVQ;
        "default" = _YzNJMQVQ;
    });
