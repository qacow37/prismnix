...
let
    ...
    in {
        ...
        "pkg-Fabric-1.18.1-1.0.0" = _qeP5TOLy;
        "pkg-Fabric-1.18.2-1.0.1" = _yxhtvuvK;
        "pkg-Forge-1.18.2-1.0.2" = _tUx9Tad5;
        "pkg-Fabric-1.18.2-1.0.2" = _gDNwrABN;
        "pkg-Fabric-22w14a-1.0.2" = _5gE9Qt2i;
        "pkg-Forge-1.18-1.0.2" = _tkY0exRJ;
        "pkg-Forge-1.19-1.0.2" = _qAKaNUtl;
        "pkg-Forge-1.16.5-1.0.2" = _ihi8b5uL;
        "pkg-Fabric-1.6.5-1.0.2" = _ja8GQZij;
        "pkg-Forge-1.17.1-1.0.2" = _TqJmqN4Z;
        "pkg-Fabric-1.17.1-1.0.2" = _iwgGuhiD;
        "pkg-Forge-1.16.5-1.1.0" = _X5IDTBfK;
        "pkg-Fabric-1.16.5-1.1.0" = _HK6bjWa7;
        "pkg-Forge-1.17.1-1.1.0" = _YybF0N9U;
        "pkg-Fabric-1.17.1-1.1.0" = _i619v2t6;
        "pkg-Forge-1.18.2-1.1.0" = _4us366AW;
        "pkg-Fabric-1.18.2-1.1.0" = _YFgOYwXW;
        "pkg-Forge-1.19.2-1.1.0" = _qQLJ1xof;
        "pkg-Fabric-1.19.2-1.1.0" = _is0NPWJg;
        "pkg-Forge-1.16.5-1.1.1" = _oMbGBmUm;
        "pkg-Fabric-1.16.5-1.1.1" = _IRqX0Ioo;
        "pkg-Forge-1.17.1-1.1.1" = _CWV5YE1J;
        "pkg-Fabric-1.17.1-1.1.1" = _eEi3aGCO;
        "pkg-Forge-1.18.2-1.1.1" = _glFI4xZg;
        "pkg-Fabric-1.18.2-1.1.1" = _uyOWccEd;
        "pkg-Forge-1.19.3-1.1.1" = _4shQkKLk;
        "pkg-Fabric-1.19.3-1.1.1" = _nRPVBLAU;
        "pkg-Fabric-12w12a-1.1.1" = _YF8L0qUy;
        "pkg-Forge-1.16.5-1.1.2" = _4bezr8vG;
        "pkg-Fabric-1.16.5-1.1.2" = _oKsvnrGb;
        "pkg-Forge-1.17.1-1.1.2" = _nouoJNQ0;
        "pkg-Fabric-1.17.1-1.1.2" = _7jNF7C1q;
        "pkg-Forge-1.18.2-1.1.2" = _EY1HSaJS;
        "pkg-Fabric-1.18.2-1.1.2" = _rO5FHAc6;
        "pkg-Forge-1.19.4-1.1.2" = _2QqeTMyu;
        "pkg-Fabric-1.19.4-1.1.2" = _HRnyiq7I;
        "pkg-Fabric-23w18a-1.1.2" = _VOiC8SRs;
        "pkg-Forge-1.20-1.1.2" = _JiYUUvgN;
        "pkg-Fabric-24w05a-1.1.2" = _x4XcKoBU;
        "pkg-Fabric-24w09a-1.1.2" = _pPQg8nNw;
        "pkg-Forge-1.16.5-1.2.0" = _vZXbOk6L;
        "pkg-Fabric-1.16.5-1.2.0" = _QkrGUdGX;
        "pkg-Forge-1.17.1-1.2.0" = _wc4ArN5H;
        "pkg-Fabric-1.17.1-1.2.0" = _fIuqMBIy;
        "pkg-Forge-1.18.2-1.2.0" = _QvC5y6JH;
        "pkg-Fabric-1.18.2-1.2.0" = _KkGdrZ56;
        "pkg-Forge-1.19.4-1.2.0" = _Lag6oGnX;
        "pkg-Fabric-1.19.4-1.2.0" = _QU45WX3N;
        "pkg-Forge-1.20.4-1.2.0" = _atzIZ7nn;
        "pkg-NeoForge-1.20.4-1.2.0" = _vZMaoI6O;
        "pkg-Fabric-1.20.4-1.2.0" = _7uw2xLdS;
        "pkg-Forge-1.20.6-1.2.0" = _OVhPlueG;
        "pkg-NeoForge-1.20.6-1.2.0" = _MB5FkYiX;
        "pkg-Fabric-1.20.6-1.2.0" = _Y2qQhlrX;
        "pkg-Forge-1.21-1.2.0" = _38ZWgOXY;
        "pkg-NeoForge-1.21-1.2.0" = _UspKhKeT;
        "pkg-Fabric-1.21-1.2.0" = _1Y9mpUn0;
        "pkg-Forge-1.21.3-1.2.0" = _J8MYV9X1;
        "pkg-NeoForge-1.21.3-1.2.0" = _8qoeTNbl;
        "pkg-Fabric-1.21.3-1.2.0" = _pv8KQPKc;
        "pkg-NeoForge-1.21.4-1.2.0" = _BoOM43Xp;
        "pkg-Fabric-1.21.4-1.2.0" = _8xymVhDY;
        "pkg-Forge-1.21.4-1.2.0" = _smW7UgUo;
        "pkg-Forge-1.16.5-1.2.1" = _imVMBEQe;
        "pkg-Fabric-1.16.5-1.2.1" = _eEnq8a2o;
        "pkg-Forge-1.17.1-1.2.1" = _7c7dVkX1;
        "pkg-Fabric-1.17.1-1.2.1" = _thZ4LqQN;
        "pkg-Forge-1.18.2-1.2.1" = _idIQfamr;
        "pkg-Fabric-1.18.2-1.2.1" = _wIkUa7Rt;
        "pkg-Forge-1.19.4-1.2.1" = _tYrRyFuL;
        "pkg-Fabric-1.19.4-1.2.1" = _dHgFjhSc;
        "pkg-Forge-1.20.4-1.2.1" = _a9EFVKZb;
        "pkg-NeoForge-1.20.4-1.2.1" = _gaBxGIeP;
        "pkg-Fabric-1.20.4-1.2.1" = _DLqQduqr;
        "pkg-Forge-1.20.6-1.2.1" = _QqNa88hS;
        "pkg-NeoForge-1.20.6-1.2.1" = _hh1LuCAB;
        "pkg-Fabric-1.20.6-1.2.1" = _sP20KK6s;
        "pkg-Forge-1.21.1-1.2.1" = _3FgQvVCw;
        "pkg-NeoForge-1.21.1-1.2.1" = _WSW7EpcQ;
        "pkg-Fabric-1.21.1-1.2.1" = _kMFjZNcW;
        "pkg-Forge-1.21.3-1.2.1" = _y4SlkHMF;
        "pkg-NeoForge-1.21.3-1.2.1" = _EueF32AI;
        "pkg-Fabric-1.21.3-1.2.1" = _UTO5JGIp;
        "pkg-Forge-1.21.9-1.2.1" = _erGQDPP5;
        "pkg-NeoForge-1.21.9-1.2.1" = _8N0JjLHB;
        "pkg-Fabric-1.21.9-1.2.1" = _nPpyrY4n;
        "default" = _nPpyrY4n;
    });
