...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.16.5" = _BYe5vJdw;
        "pkg-1.0.1+mc21w16a" = _j2IJC85a;
        "pkg-1.0.1+mc1.16.5" = _GrCaHiPY;
        "pkg-1.0.2+mc1.16.5" = _wxvDckTJ;
        "pkg-1.0.2+mc21w16a" = _eIF0A8RR;
        "pkg-1.0.2+mc1.17" = _zSsKV0tr;
        "pkg-1.0.3+mc1.17" = _oKECKfsa;
        "pkg-1.0.3+mc1.16.5" = _Oj8kwJ0X;
        "pkg-1.0.3+mc1.18-rc3" = _zwfPNOSh;
        "pkg-1.1.0+mc1.16.5" = _xy6pX8Fa;
        "pkg-1.1.0+mc1.17" = _YnLV6wNH;
        "pkg-1.1.0+mc1.18-rc3" = _FeNCBKa3;
        "pkg-1.1.1+mc1.18.1" = _eq51nSpo;
        "pkg-1.1.1+mc1.18.2" = _ckY3Hixa;
        "pkg-1.1.1+mc1.16.5" = _MPN7QYv6;
        "pkg-1.1.1+mc1.17" = _cayFTZn8;
        "pkg-1.1.2+mc1.18.2" = _BTFeuqxI;
        "pkg-1.1.2+mc1.19" = _I8yZexxy;
        "pkg-1.1.3+mc1.19" = _zRzDrNTt;
        "pkg-1.2.0+mc1.16.5" = _ilXDFTUm;
        "pkg-1.2.0+mc1.17" = _NF8yNza6;
        "pkg-1.2.0+mc1.18.2" = _FHmOonbB;
        "pkg-1.2.0+mc1.19" = _KER8n0ZY;
        "pkg-1.2.0+mc1.19.3" = _cJZWDQYo;
        "pkg-1.2.1+mc1.16.5" = _bRSF1kOM;
        "pkg-1.2.1+mc1.17" = _wWaGcguY;
        "pkg-1.2.1+mc1.18.2" = _LxEjAAHI;
        "pkg-1.2.1+mc1.19" = _mkrIhLER;
        "pkg-1.2.1+mc1.19.3" = _my62jcVu;
        "pkg-1.2.1+mc1.19.4" = _c62vOTBS;
        "pkg-1.2.1+mc1.20-pre5" = _STgaTh8X;
        "pkg-1.2.1+mc1.20.2" = _4W5aZn8x;
        "pkg-1.2.1+mc1.20.4" = _eS8ugPbb;
        "default" = _eS8ugPbb;
    });
