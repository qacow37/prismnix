...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _exrZUwWt;
        "pkg-0.2.0" = _vk8MiiPj;
        "pkg-0.3.0-pre.1" = _sBOjA8vk;
        "pkg-0.3.0-pre.2" = _nMhPLPm5;
        "pkg-0.3.0-pre.3" = _Xq5Qds89;
        "pkg-0.3.0-pre.4" = _R2IdXOLK;
        "pkg-0.3.0-pre.5" = _WgGPL44U;
        "pkg-0.3.0-pre.6" = _io2Rzv1U;
        "pkg-0.3.0-pre.7" = _LXn0AFR1;
        "pkg-0.3.0-pre.8" = _BBFhYrnn;
        "pkg-0.3.0-pre.9" = _CBXnCS0i;
        "pkg-0.3.0" = _xfjrRyCw;
        "pkg-0.4.0" = _5SPYdjI7;
        "pkg-0.5.0" = _aHNT2Tkb;
        "pkg-0.6.0" = _5QYRA2Ym;
