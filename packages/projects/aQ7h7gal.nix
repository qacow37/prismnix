...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.1.1" = _jh7V89Nf;
        "pkg-1.18.2-2.0.1" = _AhC7zbHi;
        "pkg-1.19-1.2.0" = _IvxR4i2I;
        "pkg-1.19-2.0.1" = _TYnTKtAT;
        "pkg-1.16.5-1.5.0" = _vClVWbKP;
        "pkg-1.18.2-2.1.1b" = _uz5pF9B8;
        "pkg-1.19-2.1.1" = _OTryklSn;
        "pkg-1.18.2-1.3.0" = _XAuJM4sR;
        "pkg-1.19.1-1.3.0" = _E5t6aOqN;
        "pkg-1.18.2-2.1.3" = _YnEXzM4Z;
        "pkg-1.19.2-2.1.3" = _weVX0BEV;
        "pkg-1.18.2-1.3.2" = _hBusRWvO;
        "pkg-1.19.2-1.3.2" = _Qve9RNUr;
        "pkg-1.16.5-2.0.0" = _d5VcCZMm;
        "pkg-1.18.2-1.3.3_1" = _upv1JmXu;
        "pkg-1.19.2-1.3.3" = _P6pCbN5c;
        "pkg-1.18.2-1.3.5_2" = _o5R5QDMF;
        "pkg-1.19.2-1.3.5_1" = _llF7b9Dj;
        "pkg-1.18.2-2.1.5" = _yGjnVOZh;
        "pkg-1.19.2-2.1.5_1" = _ncecUvRD;
        "pkg-1.19.3-1.4.0" = _sKUZLUrL;
        "pkg-1.18.2-2.1.7" = _FIF3gRCA;
        "pkg-1.19.2-2.1.7" = _LA2Xxtsp;
        "pkg-1.19.3-2.2.1" = _UncevUrl;
        "pkg-1.19.2-1.4.0" = _7aCk9gfB;
        "pkg-1.18.2-2.1.8" = _3HBPuPB5;
        "pkg-1.19.2-2.1.8" = _DM4p15ZU;
        "pkg-1.18.2-2.1.9" = _ruxVVeNv;
        "pkg-1.19.2-2.1.9" = _Gu1SqdQB;
        "pkg-1.18.2-1.4.1" = _kX4k4j7r;
        "pkg-1.19.2-1.4.2" = _2yQ1eZv2;
        "pkg-1.19.3-1.4.1" = _jeJEd96X;
        "pkg-1.19.2-2.1.10" = _DBuAP4eE;
        "pkg-1.19.3-2.2.2" = _IFLj3PLb;
        "pkg-1.19.4-2.2.3" = _K5oGWWtm;
        "pkg-1.19.2-2.3.4_2" = _O76uaTqj;
        "pkg-1.18.2-2.3.1" = _NLei6nAH;
        "pkg-1.19.4-2.3.4" = _sWBvfRO6;
        "pkg-1.19.2-1.4.3" = _KENQBgR1;
        "pkg-1.19.4-1.4.3" = _YsLMcelr;
        "pkg-1.19.2-2.3.5" = _uB3Hd5wl;
        "pkg-1.19.4-2.3.5" = _DlzVUB7x;
        "pkg-1.20-2.3.5" = _Ydm6uQNd;
        "pkg-1.19.2-2.0.0" = _eKdHPMuc;
        "pkg-1.19.4-2.0.0" = _VQPgbqN4;
        "pkg-1.20-2.0.0" = _U6QRrOrn;
        "pkg-1.20.1-2.0.0_1" = _suCc7Zyo;
        "pkg-1.20.1-2.3.6" = _Y13qbipb;
        "pkg-1.19.2-2.3.6" = _9cuVloI5;
        "pkg-1.19.2-2.3.7_1" = _El4VYStj;
        "pkg-1.19.4-2.3.7" = _gXXwO1SF;
        "pkg-1.20.1-2.0.0_2" = _9aaOyruY;
        "pkg-1.20.1-2.3.7_1" = _Jf4RKb30;
        "pkg-1.20.1-2.0.1" = _kJVUTtpZ;
        "pkg-1.19.2-2.0.1" = _iujAGlZi;
        "pkg-1.19.4-2.0.1" = _n3gD6Ouq;
        "pkg-1.18.2-2.3.1_4" = _NCXHboLA;
        "pkg-1.20.1-2.3.8" = _g65ETEIK;
        "pkg-1.20.1-3.0.0" = _usVOEenS;
        "pkg-1.20.1-3.0.1" = _m2fwoZzo;
        "pkg-1.20.1-3.0.3" = _qZcnJ2Rk;
        "pkg-1.19.2-3.1.1" = _sXVhbbjQ;
        "pkg-1.20.1-3.1.0" = _DaktlCLV;
        "pkg-1.20.1-3.1.2" = _WFEap676;
        "pkg-1.20.1-3.1.3" = _J8HrZZB8;
        "pkg-1.19.2-3.1.3" = _EoSgzNVG;
        "pkg-1.20.1-3.1.3_3" = _4XpyFBTO;
        "pkg-1.19.2-3.1.4" = _u0Fd3hle;
        "pkg-1.19.2-3.1.5" = _eMv2nU7L;
        "pkg-1.20.1-3.1.5" = _o4QO8IBM;
        "pkg-1.20.2-3.1.5" = _bkR9AIVI;
        "pkg-1.20.4-3.2.0" = _NxZQWsTE;
        "pkg-1.20.1-3.2.0" = _6k6QwVAt;
        "pkg-1.20.1-3.2.1" = _ZuMjEUeO;
        "pkg-1.20.6-3.2.2" = _zn9MXnnn;
        "pkg-1.20.1-3.2.2" = _OoGrXof5;
        "pkg-1.20.1-3.2.3" = _4ea05KNW;
        "pkg-1.21-3.2.2" = _DGqobvk6;
        "pkg-1.21-3.2.4_1" = _9LeXJLET;
        "pkg-1.19.2-3.2.6" = _j3aZ0sxG;
        "pkg-1.19.2-3.2.7" = _vcv0tlY4;
        "pkg-1.20.1-3.2.7" = _wDW0alzi;
        "pkg-1.20.1-3.2.7_1" = _dj6BGtE5;
        "pkg-1.21.1-3.2.7" = _y70qyPca;
        "pkg-1.20.1-3.2.8" = _1UHD4FO7;
        "pkg-1.20.1-3.2.9_1" = _RB1eqnWJ;
        "pkg-1.20.1-3.3.0" = _ztR78lCs;
        "pkg-1.20.1-3.3.1" = _tRalrohW;
        "pkg-1.21.1-3.3.1" = _iURdCfMQ;
        "pkg-1.21.1-3.3.2" = _X5oMCwaA;
        "pkg-1.20.1-3.3.3" = _l7Qcp40H;
        "default" = _l7Qcp40H;
    });
