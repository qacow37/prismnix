...
let
    ...
    in {
        ...
        "pkg-1.2.4+MC1.18-1.18.1" = _Zrx3llh1;
        "pkg-1.2.5+MC1.18-1.18.2" = _M1nTNCXp;
        "pkg-1.2.6+MC1.19" = _vPjlb6Uw;
        "pkg-1.2.7+MC1.19-1.19.1" = _gwxK4lBT;
        "pkg-1.2.8+MC1.19-1.19.2" = _xr3oiUKt;
        "pkg-1.2.9+MC1.19.3-1.19.4" = _6uTgvZ09;
        "pkg-1.2.10+MC1.20-1.20.1" = _7nsYl22V;
        "pkg-1.2.11+MC1.20.2" = _CMktKmOK;
        "pkg-1.2.12+MC1.20.2-1.20.4" = _e72CXtnp;
        "pkg-1.2.13+MC1.20.2-1.20.5" = _I0NzdM1H;
        "pkg-1.2.14+MC1.20.2-1.20.6" = _tc8LROPb;
        "pkg-1.3.0+MC1.21" = _EC5umsX9;
        "pkg-1.3.1+MC1.21-1.21.1" = _KJoYtaJ1;
        "pkg-1.4.0+MC1.21.2-1.21.3" = _UssIlSAh;
        "pkg-1.4.1+MC1.21.2-1.21.4" = _wvfvLO1S;
        "pkg-1.5.0+MC1.21.5" = _ae4veZEZ;
        "pkg-1.4.2+MC1.21.2-1.21.4" = _KWCQ9zO4;
        "pkg-1.5.1+MC1.21.5" = _VTGrahkb;
        "pkg-1.5.2+MC1.21.5-1.21.6" = _el4cTNu5;
        "pkg-1.5.3+MC1.21.5-1.21.7" = _GghKmKhv;
        "pkg-1.5.4+MC1.21.5-1.21.8" = _NCrvFzww;
        "pkg-1.5.5+MC1.21.5-1.21.8" = _6xOfI56F;
        "pkg-1.6.0+MC1.21.9-1.21.10" = _hAIhe0H7;
        "pkg-1.5.6+MC1.21.5-1.21.8" = _wj234S1K;
        "pkg-1.6.1+MC1.21.9-1.21.10" = _bNwDhbIf;
