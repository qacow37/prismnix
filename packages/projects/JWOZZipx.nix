...
let
    ...
    in {
        ...
        "pkg-1.21" = _aF8XnMHx;
        "pkg-1.21+mod" = _GDWZ61pB;
        "pkg-1.21.1" = _eU4YZBuE;
        "pkg-1.21.1+mod" = _IRnJgoOn;
        "pkg-1.21.2" = _Ph2DEdhS;
        "pkg-1.21.2+mod" = _BsvwYdqD;
        "pkg-1.21.3" = _2KCgcFT4;
        "pkg-1.21.3+mod" = _rf3sc5Lk;
        "pkg-1.21.4" = _AiBTyc5L;
        "pkg-1.21.4+mod" = _wFUO7bir;
        "pkg-1.21.5" = _vgXHYili;
        "pkg-1.21.5+mod" = _UHOkATft;
        "pkg-1.21.6" = _QqT2E7Rx;
        "pkg-1.21.6+mod" = _nis6pEAI;
        "pkg-1.21.7" = _Ef73bB53;
        "pkg-1.21.7+mod" = _mk5igwYn;
        "pkg-1.21.8" = _NETb9gxx;
        "pkg-1.21.8+mod" = _SgQELS2g;
        "pkg-1.21.9" = _6NiA63De;
        "pkg-1.21.9+mod" = _aWdjRtV2;
        "pkg-1.21-Plus" = _jYt3UPJ4;
        "pkg-1.21.10+mod" = _AvvKOyjj;
        "pkg-1.21-Plus+mod" = _jDPRFHA8;
        "default" = _jDPRFHA8;
    });
