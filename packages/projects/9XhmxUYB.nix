...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _ApOWSKEB;
        "pkg-1.0.3" = _31PVU8RP;
        "pkg-1.0.4+1.21.4-1.21.8" = _7XFujoom;
        "pkg-1.0.4+1.21-1.21.3" = _25LiX8Nv;
        "pkg-1.0.4+1.20.6" = _RFn3vO0H;
        "pkg-1.0.4+1.20.5" = _5gHD8SO8;
        "pkg-1.0.4+1.20.4" = _L2FzbIEd;
        "pkg-1.0.4+1.20.3" = _QJM693cX;
        "pkg-1.0.4+1.20.2" = _wy3kOqMo;
        "pkg-1.0.4+1.20.1" = _snwNfWGZ;
        "pkg-1.0.4+1.20" = _2IhPT1R0;
        "pkg-1.0.5+1.21.9" = _vhoKXMYZ;
        "pkg-1.0.5+1.21.10" = _3ed3xpnl;
        "pkg-1.0.5+1.21.11" = _jd6tGFiY;
        "pkg-1.1.0+1.21.11" = _6TD2K5Fh;
        "pkg-1.1.0+1.21" = _adCftf8U;
        "pkg-1.1.0+1.21.9" = _EBMbGkeX;
        "pkg-1.1.0+1.21.8" = _vy4u3yRM;
        "pkg-1.1.0+1.21.7" = _SQWUulqY;
        "pkg-1.1.0+1.21.6" = _MBLTqn3K;
        "pkg-1.1.0+1.21.5" = _QDAkKJfi;
        "pkg-1.1.0+1.21.4" = _K1zB6jiZ;
        "pkg-1.1.0+1.21.3" = _DOLGxMOK;
        "pkg-1.1.0+1.21.2" = _f8srqIhr;
        "pkg-1.1.0+1.21.1" = _h2PgJt3F;
        "pkg-1.1.0+1.20" = _P1uqdVuz;
        "pkg-1.1.0+1.20.6" = _CwK8UtBr;
        "pkg-1.1.0+1.20.5" = _AgPSwq1e;
        "pkg-1.1.0+1.20.4" = _kX3gSBFW;
        "pkg-1.1.0+1.20.3" = _mISnZKq5;
        "pkg-1.1.0+1.20.2" = _GJcyUtfV;
        "pkg-1.1.0+1.20.1" = _SoYe38Va;
        "pkg-1.1.0+1.21.10" = _CxlLNYc6;
        "pkg-1.1.1+1.21.5" = _maZCV5Do;
        "pkg-1.1.1+1.21.6" = _hoS4fZBt;
        "pkg-1.1.1+1.21.7" = _TcHehqen;
        "pkg-1.1.1+1.21.8" = _P3DlRLBB;
        "pkg-1.1.1+1.21.9" = _3Q98fwTr;
        "pkg-1.1.1+1.21.10" = _Q31HgU8A;
        "pkg-1.1.1+1.21.11" = _qzzBIGxM;
        "pkg-1.1.2+1.20" = _GZPMDUik;
        "pkg-1.1.2+1.20.1" = _zKODiAbQ;
        "pkg-1.1.2+1.20.2" = _WKbirUy7;
        "pkg-1.1.2+1.20.3" = _pg943IP7;
        "pkg-1.1.2+1.20.4" = _68IJ1fAR;
        "pkg-1.1.2+1.20.5" = _TDgja12K;
        "pkg-1.1.2+1.20.6" = _el8ALZUB;
        "pkg-1.1.2+1.21" = _IrJgMiqF;
        "pkg-1.1.2+1.21.1" = _vybFqZ3w;
        "pkg-1.1.2+1.21.2" = _zBLNNvDQ;
        "pkg-1.1.2+1.21.3" = _7hGAbQ9I;
        "pkg-1.1.2+1.21.4" = _iKaUjz7s;
        "pkg-1.1.2+1.21.5" = _CDY1xAgZ;
        "pkg-1.1.2+1.21.6" = _vC9oUwL4;
        "pkg-1.1.2+1.21.7" = _jon7aUdJ;
        "pkg-1.1.2+1.21.8" = _8HWP2WkA;
        "pkg-1.1.2+1.21.9" = _b4wRQvOR;
        "pkg-1.1.2+1.21.10" = _bzafTg6L;
        "pkg-1.1.2+1.21.11" = _wOcx2nr0;
        "default" = _wOcx2nr0;
    });
