...
let
    ...
    in {
        ...
        "pkg-6.15.0" = _KBhToHdi;
        "pkg-6.16.0" = _UaYsFTLk;
        "pkg-6.16.1" = _CJnuw7We;
        "pkg-6.17.0" = _ghGGnSQj;
        "pkg-6.17.1" = _UOY9DKcf;
        "pkg-6.17.2" = _GyrrJOtv;
        "pkg-6.18.0" = _gVJR6IRK;
        "pkg-6.19.0" = _3IlRaqbB;
        "pkg-6.19.1" = _UUqzj6OU;
        "pkg-6.19.2" = _4nfgDp5M;
        "pkg-6.20.0" = _vunzKIW0;
        "pkg-6.20.1" = _1kdUkpHW;
        "pkg-6.20.2" = _ck7CsHIJ;
        "pkg-6.21.0" = _hEPDOJCE;
        "pkg-6.21.1" = _25OYu5P3;
        "pkg-6.21.2" = _34T3nIJd;
        "pkg-6.22.0" = _hI1KoSeu;
