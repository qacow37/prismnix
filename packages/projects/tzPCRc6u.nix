...
let
    ...
    in {
        ...
        "pkg-1.0" = _G44XlbgN;
        "pkg-1.0.1" = _dZSUJD6l;
        "pkg-1.1pre1" = _RdvQUhS1;
        "pkg-1.1" = _3A8TP0iI;
        "pkg-1.1+mod" = _fz3GYhQq;
        "pkg-1.2" = _PI5TsCIX;
        "pkg-1.2+mod" = _A24tLEVs;
        "pkg-1.3" = _8cKjwER7;
        "pkg-1.3+mod" = _FP42TqT3;
        "pkg-1.3.1" = _JWjDHMR3;
        "pkg-1.3.1+mod" = _cehckBcq;
        "pkg-1.4" = _9CfsYKwk;
        "pkg-1.4+mod" = _aMVETEeC;
        "pkg-1.5" = _h99Knq7i;
        "pkg-1.5+mod" = _13tlorNI;
        "pkg-1.6" = _fesDhQJH;
        "pkg-1.6+mod" = _3ZoR89nV;
        "pkg-1.6.1" = _r0GUbEbL;
        "pkg-1.6.1+mod" = _rUvAgtf4;
        "pkg-1.6.2" = _p0GNxDc3;
        "pkg-1.6.2+mod" = _gL72kEuS;
        "default" = _gL72kEuS;
    });
