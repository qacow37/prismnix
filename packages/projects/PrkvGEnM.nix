...
let
    ...
    in {
        ...
        "pkg-0.0.5+fabric-1.18.2" = _eXQ6uDMI;
        "pkg-0.0.5+fabric-1.20.4" = _2bWanS5P;
        "pkg-0.0.5+fabric-1.19.4" = _qBPvgn3u;
        "pkg-0.0.7+fabric-1.18.2" = _r4psnMNq;
        "pkg-0.0.7+fabric-1.20.4" = _U0dLGTUD;
        "pkg-0.0.7+fabric-1.19.4" = _yIGgfjMS;
        "pkg-0.0.8+fabric-1.18.2" = _xsUJDUrS;
        "pkg-0.0.8+fabric-1.19.4" = _KY964poS;
        "pkg-0.0.8+fabric-1.20.5" = _zvIlNroc;
        "pkg-0.0.8+fabric-1.20.4" = _P31pQITN;
        "pkg-0.0.9+fabric-1.20.4" = _IRYONuPI;
        "pkg-0.0.9+fabric-1.20.6" = _4GBVRxBg;
        "pkg-0.0.9+fabric-1.18.2" = _y8mlFGmJ;
        "pkg-0.0.9+fabric-1.19.4" = _QYMXxs7E;
        "pkg-0.0.10+fabric-1.20.6" = _XT6UcHd6;
        "pkg-0.0.10+fabric-1.20.4" = _c0KG9pyb;
        "pkg-0.0.10+fabric-1.19.4" = _Hmk2D3vj;
        "pkg-0.0.10+fabric-1.18.2" = _ynt8yIZr;
        "pkg-0.0.10+fabric-1.21" = _cgjJs1yY;
        "pkg-0.0.11+fabric-1.18.2" = _5E2Mmy6u;
        "pkg-0.0.11+fabric-1.19.4" = _1d4lDezN;
        "pkg-0.0.11+fabric-1.20.6" = _6Mza1w8h;
        "pkg-0.0.11+fabric-1.20.4" = _GMPNH5UQ;
        "pkg-0.0.11+fabric-1.21.1" = _rPbTY462;
        "pkg-0.0.12+fabric-1.18.2" = _AQp0yJYm;
        "pkg-0.0.12+fabric-1.19.4" = _O83HDM0q;
        "pkg-0.0.12+fabric-1.20.6" = _jHxRN6nF;
        "pkg-0.0.12+fabric-1.20.4" = _LnaMgtDB;
        "pkg-0.0.12+fabric-1.21.4" = _Sx29wObm;
        "pkg-0.0.13+fabric-1.18.2" = _HI2afQSz;
        "pkg-0.0.13+fabric-1.20.4" = _jawMvZRl;
        "pkg-0.0.13+fabric-1.19.4" = _WN9rQUeP;
        "pkg-0.0.13+fabric-1.20.6" = _GZMAbP5y;
        "pkg-0.0.13+fabric-1.21.4" = _xJsROCuC;
        "pkg-0.0.14+fabric-1.18.2" = _ALQqjZPT;
        "pkg-0.0.14+fabric-1.19.4" = _kU1QUGtC;
        "pkg-0.0.14+fabric-1.20.6" = _yNUWGmZb;
        "pkg-0.0.14+fabric-1.20.4" = _FlTXFabY;
        "pkg-0.0.14+fabric-1.21.5" = _uXIx4zSy;
        "default" = _uXIx4zSy;
    });
