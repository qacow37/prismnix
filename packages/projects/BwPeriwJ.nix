...
let
    ...
    in {
        ...
        "pkg-1.20-1.2.2" = _aFvxqkAo;
        "pkg-1.20-1.2.3" = _MTYfx20U;
        "pkg-1.20-1.2.4" = _S5lSgsCp;
        "pkg-1.21-1.2.4" = _mxSw6cXj;
        "pkg-fabric_1.21-1.2.5" = _8DTxQ4ue;
        "pkg-neoforge_1.21-1.2.5" = _BwXmUtdV;
        "pkg-1.20-1.2.5" = _qvLmEwiA;
        "pkg-1.21.3-1.2.6" = _PkWVPrqb;
        "pkg-1.21.3-1.2.8" = _1vFUOUZJ;
        "pkg-1.21.3-1.2.9" = _wYMfi2fP;
        "pkg-1.20-1.2.6" = _WIXskKvg;
        "pkg-1.21.4-1.2.10" = _kD90q4La;
        "pkg-neoforge_1.21-1.2.6" = _vERjAa36;
        "pkg-fabric_1.21-1.2.6" = _3xNxyWWQ;
        "pkg-1.20-1.2.7" = _jHRARwp9;
        "pkg-1.20-1.2.8" = _k6rtjTCX;
        "pkg-1.21.11-1.3.0" = _u6T06BCP;
        "pkg-26.1-1.3.0" = _7J8LltKl;
        "pkg-26.1-1.3.1" = _HXK0pjys;
        "pkg-1.21.11-1.3.2" = _eLquoP9F;
        "pkg-26.1.2-1.3.4" = _LUGqcJO5;
