...
let
    ...
    in {
        ...
        "pkg-1.0" = _2cBUVJhQ;
        "pkg-1.0_mod" = _RvPxHfMd;
        "pkg-1.1" = _V1CAdYkS;
        "pkg-1.2" = _INN4W56A;
        "pkg-1.2+mod" = _uYWAzo52;
        "pkg-1.3" = _GoaEcsxW;
        "pkg-1.3+mod" = _yCvlJJvs;
        "pkg-1.4" = _VV9u5M2O;
        "pkg-1.4+mod" = _77S21kHr;
        "pkg-2.0" = _L72CZcFM;
        "pkg-2.0+mod" = _ir5byR2n;
        "pkg-2.1" = _qyXJ02WS;
        "pkg-3.0" = _vwKxLvfs;
        "pkg-3.0+mod" = _4lU2Qr9h;
        "pkg-3.1" = _rlq6VnBu;
        "pkg-3.1+mod" = _X9Oa6Ytu;
        "pkg-3.2" = _YeI76Ot4;
        "pkg-3.2+mod" = _6nG0yero;
        "pkg-3.3" = _3Wtjsjkg;
        "pkg-3.3+mod" = _6idTnsKD;
        "pkg-3.4" = _GXpqlraB;
        "pkg-3.4+mod" = _a5v47vL5;
        "pkg-3.5" = _9xFjdbRM;
        "pkg-3.5+mod" = _F7YO85I7;
        "pkg-3.6" = _dkuu0psZ;
        "pkg-3.6+mod" = _GX4lbWLK;
        "pkg-3.7" = _8n6H0Uuo;
        "pkg-3.7-fabric" = _Zf6u0P1l;
        "pkg-3.7-forge" = _miKGuolK;
        "pkg-3.11" = _CCjPyLlR;
        "pkg-3.11-fabric" = _ZvFMD2Ea;
        "pkg-3.11-quilt" = _7CiBDvgK;
        "pkg-3.11-forge" = _tlD0y3ey;
        "pkg-3.11-neoforge" = _ByTax474;
        "pkg-3.12" = _L8knrx48;
        "pkg-3.12-fabric" = _lrhGrLxh;
        "pkg-3.12-quilt" = _m5DZckHL;
        "pkg-3.12-forge" = _SB2fXhLl;
        "pkg-3.12-neoforge" = _3rRCd6bG;
        "default" = _3rRCd6bG;
    });
