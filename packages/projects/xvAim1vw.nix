...
let
    ...
    in {
        ...
        "pkg-forge-1.12-3.0.3" = _RsfhM7ap;
        "pkg-forge-1.18-3.0.1" = _BZHRQUfw;
        "pkg-forge-1.16-3.0.2" = _pd2wiB46;
        "pkg-fabric-1.18-3.0.1" = _PgSRzpUQ;
        "pkg-forge-1.19-3.0.4" = _ZAAMEeUV;
        "pkg-fabric-1.19-3.0.3" = _szOAm5hT;
        "pkg-fabric-1.19-3.0.5" = _N9WVXXRi;
        "pkg-forge-1.16-3.0.6" = _VSFZvWcO;
        "pkg-forge-1.19-3.0.7" = _l2soOHb2;
        "pkg-forge-1.19-3.0.8" = _tiF9fPv4;
        "pkg-forge-1.12-3.0.9" = _fwYV1Q4d;
        "pkg-forge-1.16.5-3.0.9" = _oHSbrdPF;
        "pkg-forge-1.18.2-3.0.9" = _O6GteZ3c;
        "pkg-forge-1.19.3-3.0.9" = _TXzMPwTs;
        "pkg-fabric-1.18-3.0.9" = _XYBnWHxd;
        "pkg-fabric-1.19-3.0.9" = _XkuZbwoc;
        "pkg-fabric-1.19.3-3.0.9" = _EnzXnRub;
        "pkg-fabric-1.19.4-3.0.9" = _igo7Sh54;
        "pkg-forge-1.12-3.1.0-beta1" = _ratNCv1G;
        "pkg-forge-1.16.5-3.1.0-beta1" = _doAXdjqn;
        "pkg-forge-1.18.2-3.1.0-beta1" = _3NpVE5wf;
        "pkg-fabric-1.18.2-3.1.0-beta1" = _meONww6S;
        "pkg-forge-1.19.4-3.1.0-beta1" = _TDTNaTQt;
        "pkg-fabric-1.19.2-3.1.0-beta1" = _WQJuJmfA;
        "pkg-fabric-1.19.3-3.1.0-beta1" = _QSXtSxlx;
        "pkg-fabric-1.19.4-3.1.0-beta1" = _bLWDIXal;
        "pkg-forge-1.18.2-3.1.0-beta2" = _Njo0yfC7;
        "pkg-forge-1.19.4-3.1.0-beta2" = _oK3I8YOl;
        "pkg-forge-1.12-3.1.0" = _3FoOzKVP;
        "pkg-forge-1.16.5-3.1.0" = _frJGwns0;
        "pkg-forge-1.18.2-3.1.0" = _50JMpTaz;
        "pkg-fabric-1.18.2-3.1.0" = _TO7HWZy5;
        "pkg-forge-1.19.4-3.1.0" = _TLxWZ0Ls;
        "pkg-fabric-1.19.2-3.1.0" = _HwPjxror;
        "pkg-fabric-1.19.3-3.1.0" = _pfHvYYgw;
        "pkg-fabric-1.19.4-3.1.0" = _HM0hAiuH;
        "pkg-forge-1.19.2-3.1.0" = _G66xGiej;
        "pkg-fabric-1.20-3.1.0" = _7gRNIgVq;
        "pkg-forge-1.20-3.1.0" = _DCRckWDi;
        "pkg-forge-1.20-3.1.1" = _Uf0tqswT;
        "pkg-fabric-1.20-3.1.1" = _44Sm8tOg;
        "pkg-fabric-1.20-3.1.2" = _NJD8sOJg;
        "pkg-forge-1.12-3.1.3" = _Ob9mSaEO;
        "pkg-fabric-1.20-3.1.3" = _xBkzBfYL;
        "pkg-forge-1.12-3.1.4" = _OW3S86E5;
        "pkg-forge-1.16.5-3.1.4" = _WpH7eMGq;
        "pkg-forge-1.20.2-3.1.4" = _66ulbdfo;
        "pkg-forge-1.20.2-3.1.5" = _FJl8n6Lp;
        "pkg-fabric-1.20.3-3.1.5" = _Oa7j459D;
        "pkg-forge-1.20.3-3.1.5" = _hyLv68O0;
        "default" = _hyLv68O0;
    });
