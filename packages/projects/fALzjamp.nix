...
let
    ...
    in {
        ...
        "pkg-1.2.54" = _iwbcBiUq;
        "pkg-1.2.86" = _BszkqxWc;
        "pkg-1.2.93" = _KJ2eDK9s;
        "pkg-1.2.124" = _yhBANmmU;
        "pkg-1.2.147" = _IoMvLDHx;
        "pkg-1.2.153" = _6r6Fq7fr;
        "pkg-1.2.164" = _T7Yrm4uq;
        "pkg-1.2.123" = _YACETPfH;
        "pkg-1.2.202" = _s488XwTT;
        "pkg-1.2.203" = _e0nMbV6Y;
        "pkg-1.2.217" = _fIg7SKWd;
        "pkg-1.3.38" = _wFqA1p32;
        "pkg-1.3.52" = _fA3P7zqW;
        "pkg-1.3.53" = _F7XrnmdD;
        "pkg-1.3.74" = _MpJo7JH4;
        "pkg-1.3.90" = _g7X03gUa;
        "pkg-1.3.92" = _t8SbUchF;
        "pkg-1.3.113" = _AaJXNTvl;
        "pkg-1.3.136" = _lSushBci;
        "pkg-1.3.138" = _iwsbfPGg;
        "pkg-1.3.146" = _NHWYq9at;
        "pkg-1.4.10" = _ZrmnYk7q;
        "pkg-1.4.14" = _nstsfdMu;
        "pkg-1.4.16" = _dPliWter;
        "pkg-1.4.13" = _1kvxUrh5;
        "pkg-1.4.27" = _VkAgASL1;
        "pkg-1.4.28" = _ytBhnGfO;
        "pkg-1.4.23" = _RVFHfo1D;
        "pkg-1.4.36" = _mhLtMoLk;
        "pkg-1.4.40" = _inWDi2cf;
        "pkg-1.4.51" = _kkEljQ4R;
        "pkg-1.4.52" = _F3FNq8Q9;
        "pkg-1.4.54" = _bk9YUabA;
        "pkg-1.4.55" = _1CpEkmcD;
        "pkg-1.4.58" = _DCgX52a5;
        "pkg-1.5.3" = _4Eotm6ov;
        "pkg-1.5.4" = _EyCqftOK;
        "default" = _EyCqftOK;
    });
