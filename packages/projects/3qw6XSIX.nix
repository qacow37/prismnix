...
let
    ...
    in {
        ...
        "pkg-0.2.5" = _LhB5vFZ2;
        "pkg-0.2.6" = _dkTOjDe1;
        "pkg-0.2.6.1" = _NF4H043y;
        "pkg-0.2.6.2" = _kI262wn4;
        "pkg-0.2.6.3" = _csO2ktpG;
        "pkg-0.2.6.4" = _4qIo5pnM;
        "pkg-0.2.7" = _MJtXydpo;
        "pkg-0.3.0" = _NBlwXciJ;
        "pkg-0.4.0" = _pw630EgC;
        "pkg-0.4.1" = _UQKjxcz8;
        ...
        "pkg-0.8.0" = _1v4km0SO;
        "pkg-0.8.1" = _5Eg1VBwL;
        "pkg-0.8.1-rev1" = _Ga0WUTU2;
        "pkg-0.8.2" = _2DaX0poO;
        "pkg-1.0.0" = _8ZtHP882;
        "pkg-1.0.0-rev1" = _pvASmfHU;
        "pkg-1.0.0-rev2" = _Gh2jJyHf;
        "pkg-1.0.0-rev3" = _7439eCqC;
        "pkg-1.0.0-rev4" = _AMDWm1kv;
        "pkg-1.0.0-rev5" = _DxjjGo2G;
        "pkg-1.0.0-rev6" = _MCKM1PTB;
        "pkg-1.0.0-rev7" = _19Ms7BZG;
        "pkg-1.1.0" = _r8JmNeoY;
        "pkg-1.1.1" = _hQwQd7TN;
        "pkg-1.1.2" = _vZEqpZW9;
        "pkg-1.1.3" = _JtHkm3ih;
