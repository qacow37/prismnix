...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _HXiJFnTK;
        "pkg-1.0.9" = _hUbLZbKN;
        "pkg-1.0.10" = _BhE8jUVg;
        "pkg-1.0.11" = _jGS0JTjN;
        "pkg-1.0.12" = _IBkbU31T;
        "pkg-1.0.13" = _L2te8ZN3;
        "pkg-1.0.14" = _Jvu5R12U;
        "pkg-1.0.15" = _aNydStgD;
        "pkg-1.0.16" = _BXcNaYVf;
        "pkg-1.0.17-SNAPSHOT" = _hQWxnuJj;
        "pkg-1.0.18-SNAPSHOT" = _dZ0BqLRR;
        "pkg-1.0.19-SNAPSHOT" = _a2C52H2w;
        "pkg-1.0.20-SNAPSHOT" = _pFRVJ8ym;
        "pkg-1.0.21-FIX" = _Tg8cqY6d;
        "pkg-1.0.22" = _Dj9kguI2;
        "pkg-1.0.22-FIX" = _CS5T4zzn;
        "pkg-1.0.22-FIX2" = _hJmIdSWc;
        "pkg-1.0.23" = _Qz2UNEFH;
        "pkg-1.0.23-compatible" = _KVceeQAY;
        "pkg-1.0.24" = _kfCLrRv6;
        "pkg-1.0.24-fix" = _gg6YfVN8;
        "pkg-1.0.24-compatible" = _Xe8qTrzL;
        "pkg-1.0.25" = _XG6eRn5k;
        "pkg-1.0.26" = _gRJkLuVP;
        "pkg-1.0.26-fix" = _9GuzzW8h;
        "pkg-1.0.27" = _fmlWmLbA;
        "pkg-1.0.28" = _1mV2hHOi;
        "pkg-1.0.29" = _b2UnLA8k;
        "pkg-1.0.30" = _VXTUkhf7;
        "pkg-1.0.30-fix" = _7rJLYwqS;
        "pkg-1.0.30-fix2" = _bnY9cKAs;
        "pkg-1.0.30-fix3" = _5f7u5kbo;
        "default" = _5f7u5kbo;
    });
