...
let
    ...
    in {
        ...
        "pkg-1.0+1.18" = _hht7UZh4;
        "pkg-1.0+1.18.2" = _rHANuYB0;
        "pkg-1.1+1.18.2" = _RaFEKc6f;
        "pkg-1.1.1+1.18.2" = _SKjIJChV;
        "pkg-1.2+1.18.2" = _rlhn0JEU;
        "pkg-1.3+1.18.2" = _GRF6z11N;
        "pkg-1.4+1.18.2" = _cNfI91sD;
        "pkg-1.4.1+1.18.2" = _4dDqpI7P;
        "pkg-1.4.2+1.18.2" = _zv4dtII9;
        "pkg-1.4.3+1.19" = _LtSiGclh;
        "pkg-1.4.4+1.19" = _PLtFdZQ8;
        "pkg-1.4.5+1.19" = _eMyb3XP2;
        "pkg-1.4.7+1.19.4" = _6qApZ02J;
        "pkg-1.4.8+1.19.4" = _qjA8li9z;
        "pkg-1.4.9+1.20" = _e3GJyQKs;
        "pkg-1.4.10+1.20" = _rW21He2h;
        "pkg-1.4.11+1.20" = _dUMLEAwC;
        "pkg-1.4.5-hotpatch+1.19" = _irPENzKg;
        "pkg-1.4.8-hotpatch+1.19.4" = _SRM7ccoi;
        "pkg-1.4.12+1.20.1" = _pIJgfSV2;
        "pkg-1.4.13+1.20.1" = _1NVfDCRA;
        "pkg-1.5+1.21" = _sA7yfuxn;
        "pkg-1.5+1.21-neoforge" = _b76ebTuA;
        "default" = _b76ebTuA;
    });
