...
let
    ...
    in {
        ...
        "pkg-v0.1.0-rc2-1.19.0" = _Otmt9F7J;
        "pkg-v0.1.0-rc2-1.19.2" = _Pvx0b4RT;
        "pkg-v0.1.0-rc2-1.19.3" = _74lt6nw8;
        "pkg-v0.1.0-1.19.0" = _4s8f4UhR;
        "pkg-v0.1-1.19.2" = _PBELmdV7;
        "pkg-v0.1-1.19.3" = _iipIl9mM;
        "pkg-v0.1.1-1.19.4" = _6XgddAKb;
        "pkg-v0.1.1-1.20" = _A7BU8uJV;
        "pkg-0.1.2-0-1.20.5" = _Sb4kf7ic;
        "pkg-0.1.2-1-24a007f6-1.20.4" = _GNJkrSfc;
        "pkg-0.1.2-3-dc2c4c37-1.20.0" = _pUxhC5VC;
        "pkg-0.1.2-4-13a931ff-1.19.4" = _oGJ9nqBK;
        "pkg-0.1.2-4-fa6604fa-1.19" = _h0dEun25;
        "pkg-0.1.2-4-d4cdf914-1.19.2" = _lJtMo7ez;
        "pkg-0.1.2-4-9fc3f3bb-1.19.3" = _xhavzirX;
        "pkg-0.2.0-0-1.21" = _TMNQYgCc;
        "pkg-0.1.3-1-f93d88e4-1.20.4" = _JgQ8oq8C;
        "pkg-0.1.3-0-1.20.5" = _UIvwqo38;
        "pkg-0.2.1-1-4149749f-1.21" = _O6V5LP8g;
        "pkg-0.2.1-0-1.21.2" = _FGwHflhz;
        "pkg-0.2.2-0-1.21.4" = _jVLB9OIg;
        "pkg-0.2.2-1.21.5" = _QVBheCkF;
        "pkg-0.2.3-1.21.5" = _7TcAhR8l;
        "pkg-0.2.3-1.21.4" = _j4owr9hp;
        "pkg-0.2.3-1.21.9" = _5QQyZPhN;
        "pkg-0.2.3-1.21.11" = _HtjpZOjV;
        "pkg-0.3.0-0-26.1" = _6ZJXzJoA;
        "pkg-0.3.1-0-26.1" = _uyYKhuHh;
        "default" = _uyYKhuHh;
    });
