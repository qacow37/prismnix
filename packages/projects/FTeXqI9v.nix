...
let
    ...
    in {
        ...
        "pkg-1.0d" = _CqRrkNGx;
        "pkg-1.0.1" = _jqMmLNLe;
        "pkg-1.0.1b" = _a6W08wcK;
        "pkg-1.1.pre0" = _B7bCM6IZ;
        "pkg-1.1.pre1" = _1PPcbRSB;
        "pkg-1.1.pre2" = _ioExlpoB;
        "pkg-1.1.pre3" = _9w7r8hfq;
        "pkg-1.1.pre4" = _vMKWsHwr;
        "pkg-1.1.pre5" = _dWpdPzIU;
        "pkg-1.1.pre5.hf1" = _rrNIuoca;
        "pkg-1.1" = _UMQnwuOr;
        "pkg-1.1.fix1" = _N9ynh7Qk;
        "pkg-1.1.1" = _rvYVvldk;
        "pkg-1.1.2" = _2BEeSV7E;
        "pkg-1.1.3" = _YS0a9QFJ;
        "pkg-1.1.4" = _8pm2JUQy;
        "pkg-1.1.5" = _BwDq3HzX;
        "pkg-1.1.6+mc1.21.1" = _tBGTUHm8;
        "pkg-1.1.7+mc1.21.1" = _ZyNyY0OA;
        "pkg-1.1.7+mc1.20.1" = _md9ccTF9;
        "pkg-1.1.7b+mc1.20.1" = _SFEQocaa;
        "pkg-1.1.7c+mc1.20.1" = _pkgslFCg;
        "pkg-1.1.7a+mc1.21.1" = _jKQGO6gz;
        "pkg-1.1.7d+mc1.20.1" = _CNraMMfg;
        "pkg-1.1.7b+mc1.21.1" = _18k5Q2Hd;
        "pkg-1.1.7c+mc1.21.1" = _eQ9rbApE;
        "pkg-1.1.7e+mc1.20.1" = _mBY9X7fu;
        "pkg-1.1.7f+mc1.20.1" = _zQStvTFw;
        "pkg-1.2.0+mc1.20.1" = _7vnwbouk;
        "pkg-1.2.0+mc1.21.1" = _IwtuwMZy;
        "default" = _IwtuwMZy;
    });
