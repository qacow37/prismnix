...
let
    ...
    in {
        ...
        "pkg-jmi-forge-1.18.2-0.11-75" = _rmBiDTXK;
        "pkg-jmi-fabric-1.18.2-0.11-75" = _jiBQ6ztF;
        "pkg-jmi-1.16.5-0.8.1-47" = _qNTaAUcG;
        "pkg-jmi-fabric-1.19-0.12-6" = _mLrMVZly;
        "pkg-jmi-forge-1.19-0.12-6" = _uHxiYGCQ;
        "pkg-jmi-fabric-1.19-0.12-10" = _Lo1us511;
        "pkg-jmi-forge-1.19-0.12-10" = _E7TsoVvA;
        "pkg-jmi-fabric-1.18.2-0.12-17" = _Sc8IVlbf;
        "pkg-jmi-forge-1.18.2-0.12-17" = _raj0EAc0;
        "pkg-jmi-fabric-1.18.2-0.12-18" = _RMSo2xw1;
        "pkg-jmi-forge-1.18.2-0.12-18" = _99hh8zms;
        "pkg-jmi-fabric-1.19-0.12-19" = _cF1zT4P9;
        "pkg-jmi-forge-1.19-0.12-19" = _aqn6rU6g;
        "pkg-jmi-forge-1.19-0.12-20" = _t7A8VAo4;
        "pkg-jmi-fabric-1.19-0.12-20" = _tzaunX9d;
        "pkg-jmi-forge-1.18.2-0.12-21" = _hoBxA9GF;
        "pkg-jmi-fabric-1.18.2-0.12-21" = _xvSI5Tn5;
        "pkg-jmi-fabric-1.18.2-0.12-22" = _uBPusKMQ;
        "pkg-jmi-forge-1.18.2-0.12-22" = _2kp3NLpP;
        "pkg-jmi-forge-1.19-0.12-23" = _vJHlpkFI;
        "pkg-jmi-fabric-1.19-0.12-23" = _hdOh4EAX;
        "pkg-jmi-fabric-1.18.2-0.13-24" = _dIQ53UCE;
        "pkg-jmi-forge-1.18.2-0.13-24" = _a7MxuQ6U;
        "pkg-jmi-fabric-1.18.2-0.13-25" = _FKV209TN;
        "pkg-jmi-forge-1.18.2-0.13-25" = _OMo9KOKI;
        "pkg-jmi-fabric-1.19-0.12-28" = _cb4o2irW;
        "pkg-jmi-forge-1.19-0.12-28" = _10nnoOcG;
        "pkg-jmi-fabric-1.19.2-0.13-30" = _O4q1xkMh;
        "pkg-jmi-forge-1.19.2-0.13-30" = _esYC5wov;
        "pkg-jmi-fabric-1.18.2-0.13-31" = _N3JV2Sub;
        "pkg-jmi-forge-1.18.2-0.13-31" = _aOH3RQr1;
        "pkg-jmi-fabric-1.19.2-0.13-33" = _y2Z31g3w;
        "pkg-jmi-forge-1.19.2-0.13-33" = _IPxXYSZY;
        "pkg-jmi-fabric-1.18.2-0.13-32" = _ww5pmRRD;
        "pkg-jmi-forge-1.18.2-0.13-32" = _U0EWHKEq;
        "pkg-1.20.1-0.14-38+forge" = _MvItMCPv;
        "pkg-1.20.1-0.14-38+fabric" = _witOJTpq;
        "pkg-jmi-fabric-1.18.2-0.13-41" = _pb9wArR6;
        "pkg-jmi-forge-1.18.2-0.13-41" = _SwpTpSHz;
        "pkg-jmi-fabric-1.19.2-0.13-40" = _QwvhecXE;
        "pkg-jmi-forge-1.19.2-0.13-40" = _LYIixqqR;
        "pkg-1.20.1-0.14-42+forge" = _bnywfeGR;
        "pkg-1.20.1-0.14-42+fabric" = _o5TGhCrJ;
        "pkg-jmi-forge-1.18.2-0.13-43" = _yPf7w0Q7;
        "pkg-jmi-fabric-1.18.2-0.13-43" = _QrXk1lBA;
        "pkg-jmi-forge-1.19.2-0.13-44" = _36AZVu1g;
        "pkg-jmi-fabric-1.19.2-0.13-44" = _MlxyjJ0B;
        "pkg-1.20.1-0.14-45+forge" = _9Aowcu07;
        "pkg-1.20.1-0.14-45+fabric" = _K25QJ6AR;
        "pkg-1.20.2-1.0-49+fabric" = _DgbzkWAz;
        "pkg-1.20.2-1.0-49+forge" = _VrAJlNTu;
        "pkg-1.20.1-0.14-47+fabric" = _YdY0BGLR;
        "pkg-1.20.1-0.14-47+forge" = _dkEb56nS;
        "pkg-1.20.4-1.1-51+forge" = _3pIRoD5J;
        "pkg-1.20.4-1.1-51+fabric" = _bsjHuKmM;
        "pkg-1.20.4-1.1-51+neoforge" = _HBMhNYgu;
        "pkg-1.20.4-1.1-52+forge" = _CjwBuutF;
        "pkg-1.20.4-1.1-52+fabric" = _rIEyMiQQ;
        "pkg-1.20.4-1.1-52+neoforge" = _TK6WNGIU;
        "pkg-1.20.4-1.2-53+forge" = _OOBOXYDr;
        "pkg-1.20.4-1.2-53+fabric" = _Ld7hKNPn;
        "pkg-1.20.4-1.2-53+neoforge" = _58qt2BDX;
        "pkg-1.20.1-0.14-48+fabric" = _DBfyewqk;
        "pkg-1.20.1-0.14-48+forge" = _BBbIV2h1;
        "pkg-1.21-1.3+fabric" = _8uTVC3fy;
        "pkg-1.21-1.3+neoforge" = _YVhDdFqh;
        "pkg-1.21-1.4+fabric" = _McUKLrMH;
        "pkg-1.21-1.4+neoforge" = _EQp0YrfZ;
        "pkg-1.21.1-1.5+neoforge" = _S8HXetTq;
        "pkg-1.21.1-1.5+fabric" = _2mLeyvPG;
        "pkg-1.21.1-1.6+neoforge" = _KJWs1PHh;
        "pkg-1.21.1-1.6+fabric" = _Du8wxEDs;
        "pkg-1.21.1-1.6.1+neoforge" = _AvyyAzgC;
        "pkg-1.21.1-1.6.2+fabric" = _gjvY5Too;
        "pkg-1.21.1-1.6.2+neoforge" = _AfRpgA08;
        "pkg-1.21.1-1.7+neoforge" = _IrHQrSuu;
        "pkg-1.21.1-1.7+fabric" = _TPl9tIUZ;
        "pkg-1.21.1-1.7.1+neoforge" = _rUayDK51;
        "pkg-1.21.1-1.7.1+fabric" = _ZedYJ6Vl;
        "pkg-1.21.1-1.8+fabric" = _FhHdaOLx;
        "pkg-1.21.1-1.8+neoforge" = _1tG7tp5O;
        "pkg-1.21.1-1.8.1+fabric" = _XSpLNmMY;
        "pkg-1.21.1-1.8.1+neoforge" = _GySb79GV;
        "pkg-1.21.1-1.8.2+fabric" = _8pq3rXkM;
        "pkg-1.21.1-1.8.2+neoforge" = _3WdHeuHI;
        "pkg-1.21.1-1.8.3+fabric" = _9ERYm3g5;
