...
let
    ...
    in {
        ...
        "pkg-1.0.7" = _8TgG3oMx;
        "pkg-1.0.8" = _XZI2TLjS;
        "pkg-1.0.1+mod" = _2oTlRgAU;
        "pkg-1.0.3+mod" = _9tBFVUEL;
        "pkg-1.0.4+mod" = _EJ6amwLv;
        "pkg-1.0.5+mod" = _HgCjBfwo;
        "pkg-1.0.6+mod" = _cMhdawA5;
        "pkg-1.0.7+mod" = _BfsedtrB;
        "pkg-1.0.8+mod" = _NemZ1k1o;
        "default" = _NemZ1k1o;
    });
