...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge" = _Bcs6Rw6A;
        "pkg-1.0.0-fabric" = _lNKhgA7b;
        "pkg-1.0.1-forge" = _aiLHEHR0;
        "pkg-1.0.1-fabric" = _yyZXHfQi;
        "pkg-1.0.2-forge" = _1gK4OdG8;
        "pkg-1.0.2-fabric" = _4gdeleYF;
        "pkg-1.0.3-forge" = _vEIQYfMG;
        "pkg-1.0.3-fabric" = _MCKyLoER;
        "pkg-1.0.4-forge" = _1YG0DxzU;
        "pkg-1.0.4-fabric" = _DFsAhn6J;
        "pkg-1.1.0-neoforge" = _88gRTWio;
        "pkg-1.1.0-fabric" = _4YFIf5BK;
        "pkg-1.1.1-neoforge" = _mlmDIRfH;
        "pkg-1.1.1-fabric" = _hCSnhacZ;
        "pkg-1.2.0-neoforge" = _D6ApPYRh;
        "pkg-1.2.0-fabric" = _xZXLQA27;
        "pkg-1.2.1-fabric" = _JSKxnPhT;
        "pkg-1.2.1-neoforge" = _L0WomdO4;
        "pkg-1.2.2-neoforge" = _3Qzl8RjA;
        "pkg-1.2.2-fabric" = _30BSSIek;
        "pkg-1.2.3-neoforge" = _8L6V6XAQ;
        "pkg-1.2.3-fabric" = _4Dhi8PUE;
        "pkg-1.2.4-neoforge" = _XcyHDbK8;
        "pkg-1.2.4-fabric" = _bjXfpSCg;
        "default" = _bjXfpSCg;
    });
