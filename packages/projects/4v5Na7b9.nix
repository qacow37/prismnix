...
let
    ...
    in {
        ...
        "pkg-v3.0.1-1.18.2-Fabric" = _m2BF5Uwr;
        "pkg-v8.0.1-1.20.1-Forge" = _TmYa7rep;
        "pkg-v8.0.1-1.20.1-Fabric" = _zScUVKoM;
        "pkg-v20.4.0-1.20.4-Fabric" = _3YLgaGoV;
        "pkg-v20.4.0-1.20.4-Forge" = _m8NiQyuY;
        "pkg-v20.4.0-1.20.4-NeoForge" = _XovuCiEm;
        "pkg-v20.4.1-1.20.4-Fabric" = _mV4PrCX9;
        "pkg-v20.4.1-1.20.4-Forge" = _FOPniu9M;
        "pkg-v20.4.1-1.20.4-NeoForge" = _1WXPi8Hp;
        "pkg-v21.1.0-1.21.1-Fabric" = _d9rx5Ses;
        "pkg-v21.1.0-1.21.1-NeoForge" = _v1ym9Jqa;
        "pkg-v8.0.2-1.20.1-Forge" = _yd8QMVU1;
        "pkg-v8.0.2-1.20.1-Fabric" = _doX5BlP7;
        "pkg-v21.1.1-1.21.1-Fabric" = _Ju7tR6NH;
        "pkg-v21.1.1-1.21.1-NeoForge" = _JwYLe1Y0;
        "pkg-v21.3.0-1.21.3-Fabric" = _q2LB3DUD;
        "pkg-v21.3.0-1.21.3-NeoForge" = _sEqpwYlv;
        "pkg-v21.3.1-1.21.3-Fabric" = _uiVXAQEL;
        "pkg-v21.3.1-1.21.3-NeoForge" = _ZJGW8o18;
        "pkg-v21.4.0-1.21.4-Fabric" = _U6xnnaqL;
        "pkg-v21.4.0-1.21.4-NeoForge" = _scKn0EE7;
        "pkg-v21.5.0-1.21.5-Fabric" = _qYGtoSAX;
        "pkg-v21.5.0-1.21.5-NeoForge" = _Xrl8TYQg;
        "pkg-v21.7.0-1.21.7-Fabric" = _FKhN7DOJ;
        "pkg-v21.7.0-1.21.7-NeoForge" = _ICArto1v;
        "pkg-v21.8.0-1.21.8-Fabric" = _q8EDh9FG;
        "pkg-v21.8.0-1.21.8-NeoForge" = _cXsBlFHy;
        "pkg-21.9.0" = _24hNQE9h;
        "pkg-21.10.0" = _eyqAaLjO;
