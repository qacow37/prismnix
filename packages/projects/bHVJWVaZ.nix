...
let
    ...
    in {
        ...
        "pkg-1.7.8" = _7Y2sry65;
        "pkg-1.7.9" = _T9WjDVZ7;
        "pkg-1.7.10" = _NW0tCm99;
        "pkg-1.7.11" = _QRGoTqlE;
        "pkg-1.7.12" = _of4imoZP;
        "pkg-1.7.13" = _g69aWpgx;
        "pkg-1.7.14" = _gwKWEICW;
        "pkg-1.7.15" = _i74cvh8k;
        "pkg-1.7.16" = _nQqrGN1Z;
        "pkg-1.7.17" = _QeDpXtoK;
        "pkg-1.7.18" = _QYdg2XzL;
        "pkg-1.7.19" = _iOcaeNNj;
        "pkg-1.7.20" = _h6jLfFJw;
        "pkg-1.7.21" = _wkfdhobm;
        "pkg-1.7.22" = _eQ2bM8zT;
        "pkg-1.7.23" = _K9CpaeJt;
        "pkg-1.7.24" = _OsOQY91A;
        "pkg-1.7.25" = _gASyIE3H;
        "pkg-1.7.26" = _oIWytWhn;
        "pkg-1.7.27" = _T2OnaMgz;
        "pkg-1.7.28" = _geQRrqp0;
        "pkg-1.7.29" = _fQfaUuFN;
        "pkg-1.7.30" = _OFlSd4mC;
        "pkg-1.7.31" = _qtBL4TqE;
        "pkg-1.7.32" = _FUDBhZoy;
        "pkg-1.7.33" = _Gok5XRHU;
        "pkg-1.7.34" = _SlNyxqn2;
        "default" = _SlNyxqn2;
    });
