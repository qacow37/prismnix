...
let
    ...
    in {
        ...
        "pkg-52.0.0" = _kGXeAYEL;
        "pkg-52.0.1" = _XWBdnD1K;
        "pkg-52.0.2" = _zdsIOba8;
        "pkg-52.0.3" = _yKfcoLej;
        "pkg-52.0.4" = _RONoxmra;
        "pkg-52.0.5" = _EiWlW7IC;
        "pkg-52.0.6" = _4um7PrUF;
        "pkg-52.0.7" = _QHO0DQvc;
        "pkg-52.0.8" = _8QKroYbK;
        "pkg-52.0.9" = _KpVaan3b;
        "pkg-52.1.0" = _i27YO1TH;
        "pkg-52.1.1" = _5KuCqb3J;
        "pkg-52.1.2" = _Eneulsqm;
        "pkg-53.0.0" = _Coc6HP7Y;
        "pkg-54.0.0" = _tTmJcFfH;
        "pkg-54.0.1" = _bM6kd7Rj;
        "pkg-54.0.2" = _iNvhuYrc;
        "pkg-54.0.3" = _Z2DomDsG;
        "pkg-54.0.4" = _YqQn2DQF;
        "pkg-54.0.5" = _6hPOpBRl;
        "pkg-54.0.6" = _3QEIJ9eo;
        "pkg-54.0.7" = _giV8J8Fv;
        "pkg-54.0.8" = _5zmSFwXQ;
        "pkg-54.0.9" = _3TvjjywV;
        "pkg-55.0.0" = _IiBk4lgb;
        "pkg-55.0.1" = _tmAA3IhV;
        "pkg-55.0.2" = _CQuU8tML;
        "pkg-55.0.3" = _prQJHIXJ;
        "pkg-55.0.4" = _uY6VBJOi;
        "pkg-55.0.5" = _sAleZF2K;
        "pkg-55.0.6" = _kHMpCGdv;
        "pkg-55.0.7" = _3gleMdts;
        "pkg-56.0.0" = _83Pq6WpU;
        "pkg-56.0.1" = _xWVGvkdR;
        "pkg-56.0.2" = _mlMAszvj;
        "pkg-56.0.3" = _FkMdJErv;
        "pkg-56.0.4" = _WXcqj0QZ;
        "pkg-56.0.5" = _fkqlDNnv;
        "pkg-57.0.0" = _3TkdRb0f;
        "pkg-57.0.1" = _pAvZ71vb;
        "pkg-57.1.0" = _3Sfum2K7;
        "pkg-57.1.1" = _Z7tiqOxJ;
        "pkg-57.2.0" = _a2Yhwk78;
        "pkg-57.2.1" = _iEfLJ64N;
        "pkg-57.2.2" = _hqVgAL8w;
        "pkg-57.2.3" = _nTesn28L;
        "pkg-57.3.0" = _3ILJsx6A;
        "pkg-57.3.1" = _swBSayDT;
        "pkg-57.3.2" = _C0K7YptI;
        "pkg-57.3.3" = _KW289sBR;
        "pkg-57.4.0" = _qME0yubM;
        "pkg-57.4.1" = _b4OdH91s;
        "pkg-57.5.0" = _ka8NZC9g;
        "pkg-57.6.0" = _VAZjiGIz;
        "pkg-57.6.1" = _ty5v4lon;
        "pkg-57.6.2" = _w9UaTd1c;
        "pkg-57.6.3" = _llHeAzQR;
        "pkg-57.6.4" = _GIRzF2cL;
        "pkg-59.0.0" = _NAwVyEya;
        "pkg-59.0.1" = _8MiFyYOe;
        "pkg-59.0.2" = _kabzg5Ch;
        "pkg-59.0.3" = _ZRwU6Wng;
        "pkg-59.0.4" = _ECqxtcGq;
        "pkg-59.0.5" = _Ck2jOIyD;
        "pkg-59.1.0" = _LTxbils4;
        "pkg-59.1.1" = _RolOphcG;
        "pkg-59.1.2" = _BhKiCJSq;
        "pkg-58.0.0" = _g7wZBQvW;
        "pkg-58.1.0" = _DJNrVE2h;
        "pkg-58.1.1" = _noqTTGxQ;
        "pkg-58.1.2" = _PgJk9oLQ;
        "pkg-58.1.3" = _z94P8vZF;
        "pkg-58.1.4" = _PzaQVCuL;
        "pkg-58.1.5" = _IkPhxSk0;
        "default" = _IkPhxSk0;
    });
