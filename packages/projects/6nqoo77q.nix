...
let
    ...
    in {
        ...
        "pkg-1.2.2" = _SwVZHCjn;
        "pkg-1.2.3" = _5RWznzl2;
        "pkg-1.2.3+mod" = _cY3ue2DP;
        "pkg-1.2.4" = _o0Dx9v2B;
        "pkg-1.2.4+mod" = _1Nqe6SxA;
        "pkg-1.2.5" = _h4jd9wHh;
        "pkg-1.2.5+mod" = _YZeuICfR;
        "pkg-1.3.0" = _uLMhf8i2;
        "pkg-1.3.0+mod" = _UEcp9Hzd;
        "pkg-v1.3.1_mc1.20.0-1.20.4" = _DQJssrjW;
        "pkg-v1.3.1_mc1.20.5-1.21.4" = _nM6JJJ5K;
        "pkg-v1.3.1_mc1.20.0-1.20.4+mod" = _Gc8EPINP;
        "pkg-v1.3.1_mc1.20.5-1.21.4+mod" = _U1BkX4ok;
        "pkg-1.3.2_mc1.20.0-1.20.4" = _TLjtnwOT;
        "pkg-1.3.2_mc1.20.5-1.20.6" = _8PLc00n8;
        "pkg-1.3.2_mc1.21.0-1.21.4" = _iovNAMQ5;
        "pkg-1.3.2_mc1.20.0-1.20.4+mod" = _qoHDVeJL;
        "pkg-1.3.2_mc1.20.5-1.20.6+mod" = _r2T99fdt;
        "pkg-1.3.2_mc1.21.0-1.21.4+mod" = _uaov0jep;
        "pkg-1.3.3_mc1.21.6" = _eecpKtFW;
        "pkg-1.3.3_mc1.21.6+mod" = _LzQ3sHEC;
        "pkg-1.3.4+mc1.21.6" = _Yo0oQd9r;
        "pkg-1.3.4+mc1.21.6+mod" = _PnfAEnWh;
        "pkg-1.3.4+mc1.21.7" = _r0x4QbYJ;
        "pkg-1.3.4+mc1.21.7+mod" = _zsttnfl7;
        "pkg-1.3.4+mc1.21.8" = _4mJMsmEN;
        "pkg-1.3.4+mc1.21.8+mod" = _mgPxFNgG;
        "pkg-1.3.5+mc1.21.8" = _lKauLoui;
        "pkg-1.3.5+mc1.21.8+mod" = _gxdT4E8c;
        "pkg-1.3.6+mc1.21.8" = _W6v9vCLU;
        "pkg-1.3.6+mc1.21.8+mod" = _RAzuP7Zq;
        "default" = _RAzuP7Zq;
    });
