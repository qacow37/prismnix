...
let
    ...
    in {
        ...
        "pkg-2.7.2" = _nSHKtZGa;
        "pkg-2.7.3+1.16.5" = _dR3f0VFc;
        "pkg-2.7.3+1.17" = _TWNEuuTr;
        "pkg-2.7.5+1.16.5" = _fg6Y5F4i;
        "pkg-2.7.5+1.17" = _tugCByn2;
        "pkg-2.7.5+1.18" = _qoQiBLA2;
        "pkg-2.7.6+1.16.5" = _4CxHfWTt;
        "pkg-2.7.6+1.17" = _sjzLTT1K;
        "pkg-2.7.6+1.18" = _7OwQOwyc;
        "pkg-2.7.7+1.16.5" = _8730gXqT;
        "pkg-2.7.7+1.17" = _xmlDj8SG;
        "pkg-2.7.7+1.18" = _K1qIGolb;
        "pkg-2.7.7+1.18.2" = _tfSXLJQs;
        "pkg-2.7.8+1.16.5" = _LPiJjGgQ;
        "pkg-2.7.8+1.17" = _L9tNafmV;
        "pkg-2.7.8+1.18" = _GcQVzJEi;
        "pkg-2.7.8+1.18.2" = _P2po0Y9O;
        "pkg-2.8.0+1.16.5" = _nUeGeWnf;
        "pkg-2.8.0+1.17" = _zvXX0kZy;
        "pkg-2.8.0+1.18" = _BqQzF9jC;
        "pkg-2.8.0+1.18.2" = _tkRAMUb0;
        "pkg-2.8.0+1.19" = _Lo0m6XEB;
        "pkg-2.8.1+1.18.2" = _qsUOkjD3;
        "pkg-2.8.1+1.19" = _QuUvdOpw;
        "pkg-2.8.2+1.18.2" = _ltclqiQA;
        "pkg-2.8.2+1.19" = _lv4TKVp3;
        "pkg-2.8.2+1.19.1" = _QkxpPkGy;
        "pkg-2.8.3+1.19.3" = _rGBAYiHT;
        "pkg-2.8.3+1.19.4" = _gtyUYmxc;
        "pkg-2.8.3+1.20" = _1ry30aMb;
        "pkg-2.8.3+1.20.2" = _I8jf0z1o;
        "pkg-2.8.4+1.20.2" = _CYIcdzDm;
        "pkg-2.8.5+1.20.3" = _L9251osp;
        "pkg-2.8.5+1.20.5" = _CWZD2XfU;
        "pkg-2.8.7+1.21" = _wRsxnY7Y;
        "pkg-2.8.7+1.21.2" = _UtMmJcZL;
        "pkg-2.8.7+1.21.4" = _yduCHdg0;
        "pkg-2.8.7+1.21.5" = _8ie5mnlA;
        "pkg-2.8.7+1.21.6" = _IO0skwHn;
        "pkg-2.8.7+1.21.9" = _wd1h921i;
        "pkg-2.8.8+1.21.11" = _ISgthgZp;
        "pkg-2.8.8+26.1" = _SDXQT0GM;
        "pkg-2.9.0+26.1" = _ijnkcdTu;
        "default" = _ijnkcdTu;
    });
