...
let
    ...
    in {
        ...
        "pkg-1.0.1+fabric" = _57iE0oTd;
        "pkg-1.1.0+neoforge" = _54QP3Flw;
        "pkg-1.1.0+fabric" = _Jb9JfeX7;
        "pkg-1.1.1+neoforge" = _EK2KAh3C;
        "pkg-1.1.1+fabric" = _hv0ECb0V;
        "pkg-1.1.2+neoforge" = _3jEaf9Qp;
        "pkg-1.1.2+fabric" = _aaKTz4ax;
        "pkg-2.0.0+neoforge" = _qCEQkfXT;
        "pkg-2.0.0+fabric" = _LdKk73VX;
        "pkg-2.1.0+neoforge" = _HXxvLiEI;
        "pkg-2.1.0+fabric" = _4sW5NszA;
        "pkg-2.2.0+neoforge" = _tJRavfqO;
        "pkg-2.2.0+fabric" = _aisTVmhh;
        "pkg-2.3.0+neoforge" = _eRGRi2vW;
        "pkg-2.3.0+fabric" = _yFh5m9sh;
        "pkg-1.2.0+neoforge" = _ahjAWOJ4;
        "pkg-1.2.0+fabric" = _fSWahBb2;
        "pkg-2.4.0+neoforge" = _j43bNJej;
        "pkg-2.4.0+fabric" = _NP9ajMKV;
        "pkg-2.5.0+neoforge" = _KsAtf2lB;
        "pkg-2.5.0+fabric" = _H4UZZeQ1;
        "pkg-3.0.0+neoforge" = _EUEWxyAc;
        "pkg-3.0.0+fabric" = _1mlDPoQE;
        "pkg-4.0.0+neoforge" = _wnRZGzWE;
        "pkg-4.0.0+fabric" = _JdGHqwYk;
        "pkg-4.1.0+neoforge" = _9EAnEmkm;
        "pkg-4.1.0+fabric" = _FWYLKFwg;
        "pkg-4.2.0+neoforge" = _RlBXhQkC;
        "pkg-4.2.0+fabric" = _SVHUvygx;
        "pkg-5.0.0+neoforge" = _14uENqMB;
        "pkg-5.0.0+fabric" = _FvrIXJzl;
        "pkg-1.3.0+neoforge" = _IoJyWhsU;
        "pkg-1.3.0+fabric" = _CzcbXKZC;
        "pkg-5.0.1+neoforge" = _z5ZLnQ33;
        "pkg-5.0.1+fabric" = _iMZAv4q1;
        "pkg-5.1.0+neoforge" = _8X7EYexB;
        "pkg-5.1.0+fabric" = _htDnbiw5;
        "pkg-5.1.1+neoforge" = _FKxX7oKq;
        "pkg-5.1.1+fabric" = _bZWNr7JC;
        "pkg-5.2.0+neoforge" = _sOmOt6b8;
        "pkg-5.2.0+fabric" = _LqHSW4zX;
        "pkg-5.2.1+neoforge" = _hRbUWCdm;
        "pkg-5.2.1+fabric" = _tUu91bOs;
        "pkg-6.0.0+neoforge" = _iFMYP53F;
        "pkg-6.0.0+fabric" = _DlRMiUVm;
        "pkg-6.1.0+neoforge" = _SJ8khxaz;
        "pkg-6.1.0+fabric" = _ybzv0aCp;
        "pkg-6.1.1+neoforge" = _Jp7FEgJd;
        "pkg-6.1.1+fabric" = _JGRVOarD;
        "pkg-6.2.0+neoforge" = _WSwa9OLr;
        "pkg-6.2.0" = _mk4CEbfF;
        "pkg-6.3.0+neoforge" = _rwc295Vk;
        "pkg-6.3.0+fabric" = _44YOMxPp;
        "pkg-6.3.1+neoforge" = _WUd9qlUD;
        "pkg-6.3.1+fabric" = _aVc3lyUu;
        "pkg-6.3.2+neoforge" = _7QGHtWkv;
        "pkg-6.3.2+fabric" = _4c38pOla;
        "pkg-7.0.0+neoforge" = _Rr74u1ZW;
        "pkg-7.0.0+fabric" = _mu5P8dVs;
        "pkg-7.0.1+fabric" = _kzqeHK1v;
        "pkg-7.1.0+neoforge" = _9q2PDxne;
        "pkg-7.1.0+fabric" = _S7PiEyS4;
        "pkg-1.3.1+neoforge" = _Di5IdlOu;
        "pkg-1.3.1+fabric" = _PG2izvyB;
        "pkg-1.3.2+neoforge" = _BZX0cluI;
        "pkg-1.3.2+fabric" = _RDzcLg7a;
        "pkg-7.2.0+fabric" = _s6yWmk6G;
        "pkg-7.2.0+neoforge" = _K2jA1vQl;
        "pkg-7.2.1+fabric" = _ey9a2PM8;
        "pkg-7.2.1+neoforge" = _IkE77rn7;
        "pkg-7.2.2+fabric" = _2p8nJsvX;
        "pkg-7.2.2+neoforge" = _8sfpWnF4;
        "pkg-1.4.0+fabric" = _5EzqYxuV;
        "pkg-1.4.0+neoforge" = _AClRaIb4;
        "pkg-7.2.3+fabric" = _fDD5LFni;
        "pkg-7.2.3+neoforge" = _DRrkRjZU;
        "pkg-7.2.4+fabric" = _2VOta6vP;
        "pkg-7.2.4+neoforge" = _KdtVIRjo;
        "pkg-7.3.0+fabric" = _GCPvRnHv;
        "pkg-7.3.0+neoforge" = _LI8E19Wi;
        "pkg-7.4.0+fabric" = _3ytQCylI;
        "pkg-7.4.0+neoforge" = _T3Has1dS;
        "pkg-7.4.1+fabric" = _Du08DoMh;
        "pkg-7.4.1+neoforge" = _xCusrnMT;
        "pkg-7.4.2+fabric" = _mr61vc0b;
        "pkg-7.4.2+neoforge" = _YKPvxaTh;
        "pkg-7.4.3+fabric" = _kFl1O5C0;
        "pkg-7.4.3+neoforge" = _x75A5LCJ;
        "pkg-7.5.0+fabric" = _nskh2NG6;
        "pkg-7.5.0+neoforge" = _FAJzpixB;
        "pkg-7.6.0+fabric" = _vmdYFfhX;
        "pkg-7.6.0+neoforge" = _XVBMaLpu;
        "pkg-7.6.1+fabric" = _2l3bhplU;
        "pkg-7.6.1+neoforge" = _JUGq0823;
        "pkg-1.4.1+fabric" = _M3FgwIrp;
        "pkg-1.4.1+neoforge" = _6XVCxqRr;
        "pkg-7.7.0+fabric" = _4J9xenRj;
        "pkg-7.7.0+neoforge" = _bOD0Mvof;
        "pkg-7.7.1+fabric" = _bi5peZIm;
        "pkg-7.7.1+neoforge" = _rbWEZnyT;
        "pkg-1.4.2+fabric" = _773jdIGX;
        "pkg-1.4.2+neoforge" = _3BznSTWa;
        "pkg-1.5.0+fabric" = _fSnwhwBz;
        "pkg-1.5.0+neoforge" = _GggTElKJ;
        "pkg-7.7.2+fabric" = _ov0rAzEO;
        "pkg-7.7.2+neoforge" = _yKDnw2sW;
        "pkg-7.8.0+fabric" = _AVqJTmt4;
        "pkg-7.8.0+neoforge" = _bNv5LHI1;
        "pkg-1.6.0+fabric" = _cf7aCyap;
        "pkg-1.6.0+neoforge" = _DLpKAv4J;
        "pkg-7.9.1+fabric" = _ClPUfdMb;
        "pkg-7.9.1+neoforge" = _n8kW4DKw;
        "pkg-7.10.0+fabric" = _mi8C9nQo;
        "pkg-7.10.0+neoforge" = _1fiK1vcr;
        "pkg-7.10.1+fabric" = _ja4myyrQ;
        "pkg-7.10.1+neoforge" = _s3R5pstE;
        "pkg-7.11.0+fabric" = _bm4sgs0N;
        "pkg-7.11.0+neoforge" = _qWjiHf8P;
        "pkg-7.11.1+fabric" = _YxmyA9TX;
        "pkg-7.11.1+neoforge" = _Jt1wkIk0;
        "pkg-7.12.0+fabric" = _bf0lQw2z;
        "pkg-7.12.0+neoforge" = _ZcL716wN;
        "pkg-8.0.0+fabric" = _yXoczYPc;
        "pkg-8.0.0+neoforge" = _KO8w4HQ8;
        "pkg-8.1.0+fabric" = _hRirVt1R;
        "pkg-8.1.0+neoforge" = _3dyPRqui;
        "pkg-8.2.0+fabric" = _eOpg6mp1;
        "pkg-8.2.0+neoforge" = _bWpp8nai;
        "pkg-8.2.1+fabric" = _3H3RyLhI;
        "pkg-8.2.1+neoforge" = _sV36WhsY;
        "pkg-8.3.0+fabric" = _yoE0ifVI;
        "pkg-8.3.0+neoforge" = _xKgh3Dyu;
        "pkg-8.4.0+fabric" = _fuo8JqYc;
        "pkg-8.4.0+neoforge" = _vZUGyU4B;
        "pkg-8.4.1+fabric" = _ArlxkqFs;
        "pkg-8.4.1+neoforge" = _jjSgPuUi;
        "pkg-9.0.0+fabric" = _TdCqnUNd;
        "pkg-9.0.0+neoforge" = _SAcAedHm;
        "pkg-9.1.0+fabric" = _s7EizA7W;
        "pkg-9.1.0+neoforge" = _9aElQMSY;
        "pkg-9.2.0+fabric" = _Qzg5QsNm;
        "pkg-9.2.0+neoforge" = _gsepAeUn;
        "pkg-1.7.0+fabric" = _2LuDpnAO;
        "pkg-8.5.0+fabric" = _kM1sD0xM;
        "pkg-1.7.0+neoforge" = _jfjzj43G;
        "pkg-8.5.0+neoforge" = _KOJlCFt8;
        "pkg-9.2.1+fabric" = _fubu3LMP;
        "pkg-9.2.1+neoforge" = _uJ3dUEK2;
        "pkg-8.5.1+fabric" = _HOqJJBiq;
        "pkg-8.5.1+neoforge" = _hCP7Uqq1;
        "pkg-9.3.0+fabric" = _FfToDAsT;
        "pkg-9.3.0+neoforge" = _AIPrllKP;
        "pkg-9.3.1+fabric" = _OYxcfVpH;
        "pkg-9.3.1+neoforge" = _ZQNnCVpo;
        "pkg-1.8.0+fabric" = _kNgkUwwf;
        "pkg-1.8.0+neoforge" = _FP53oPsS;
        "pkg-9.3.2+fabric" = _bwfLDXyF;
        "pkg-9.3.2+neoforge" = _BKEU0tQ8;
        "pkg-1.9.0+fabric" = _7lKNte53;
        "pkg-1.9.0+neoforge" = _7VmRCoOx;
        "pkg-9.3.3+fabric" = _c6o5KfOH;
        "pkg-9.3.3+neoforge" = _cN9Uyeb2;
        "pkg-9.3.4+fabric" = _oN84q85l;
        "pkg-9.3.4+neoforge" = _yM9aV3Eu;
        "pkg-1.10.0+fabric" = _xSK6BsIm;
        "pkg-1.10.0+neoforge" = _eHcEWZhO;
        "pkg-9.4.0+fabric" = _wzO4UHTn;
        "pkg-9.4.0+neoforge" = _jlM8MzrE;
        "pkg-8.5.2+fabric" = _rUacGY2U;
        "pkg-8.5.2+neoforge" = _Miw3vq9n;
        "pkg-9.4.1+fabric" = _gYsXrzSO;
        "pkg-9.4.1+neoforge" = _6r5vpbXI;
        "pkg-1.10.1+fabric" = _k83kPVQZ;
        "pkg-1.10.1+neoforge" = _TZeGiWOH;
        "pkg-10.0.0+fabric" = _fhcZQ4Qd;
        "pkg-10.0.0+neoforge" = _mCKIipDr;
        "pkg-10.1.0+fabric" = _Swq2pB48;
        "pkg-10.1.0+neoforge" = _7S825rOf;
        "pkg-10.2.0+fabric" = _ttYFRW4s;
        "pkg-10.2.0+neoforge" = _qzxEAemH;
        "pkg-1.10.2+fabric" = _DnYf9RqP;
        "pkg-1.10.2+neoforge" = _j3igEgCO;
        "pkg-10.2.1+fabric" = _1KuTiIzQ;
        "pkg-10.2.1+neoforge" = _dxa6Hp7s;
        "pkg-10.3.0+fabric" = _arGu4NTA;
        "pkg-10.3.0+neoforge" = _UFWJLjra;
        "pkg-10.4.0+fabric" = _z3rQpJly;
        "pkg-10.4.0+neoforge" = _X6Xmcbqe;
        "pkg-10.5.0+fabric" = _y19nsuJw;
