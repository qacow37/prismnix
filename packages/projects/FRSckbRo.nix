...
let
    ...
    in {
        ...
        "pkg-15.1-1.12" = _Kv3xb7OX;
        "pkg-15.1-1.13" = _EeFhK4sl;
        "pkg-15.1-1.14" = _uHuWA2fe;
        "pkg-15.1-1.15" = _h0sJJ5AV;
        "pkg-15.1-1.16" = _gPG7kGjR;
        "pkg-15.1-1.17" = _VVcKgjN5;
        "pkg-15.1-1.18" = _X6FttvmN;
        "pkg-15.1-1.19" = _Efajc29w;
        "pkg-15.2-1.19.3" = _8LO93Xf4;
        "pkg-v2.0.0-alpha.1-1.13" = _rA0z9GCA;
        "pkg-v2.0.0-alpha.1-1.14" = _l8vCIBWj;
        "pkg-v2.0.0-alpha.1-1.15" = _9XN1xYHQ;
        "pkg-v2.0.0-alpha.1-1.16" = _MBcwGtK9;
        "pkg-v2.0.0-alpha.1-1.17" = _cOSiOOAG;
        "pkg-v2.0.0-alpha.1-1.18" = _WHBunPm2;
        "pkg-v2.0.0-alpha.1-1.19" = _Umunv0A3;
        "pkg-v2.0.0-alpha.1-1.20" = _Tcwn9462;
        "pkg-v2.0.0-alpha.1-1.21" = _Aj2fZbyb;
        "pkg-v2.0.0-a.2-1.9" = _oH3Jqydr;
        "pkg-v2.0.0-a.2-1.10" = _8l54E5Pm;
        "pkg-v2.0.0-a.2-1.11" = _qFXpDvrt;
        "pkg-v2.0.0-a.2-1.12" = _43DZWQnH;
        "pkg-v2.0.0-a.2-1.13" = _APkZItxE;
        "pkg-v2.0.0-a.2-1.14" = _64PCKKxR;
        "pkg-v2.0.0-a.2-1.15" = _37QsYa2y;
        "pkg-v2.0.0-a.2-1.16" = _vO4rHY5Y;
        "pkg-v2.0.0-a.2-1.17" = _5C3EUHro;
        "pkg-v2.0.0-a.2-1.18" = _m54UrYTY;
        "pkg-v2.0.0-a.2-1.19" = _Ev1P5t1x;
        "pkg-v2.0.0-a.2-1.20" = _wGCeOZW1;
        "pkg-v2.0.0-a.2-1.21" = _1fRiYxeS;
        "pkg-v2.0.0-a.3-1.9" = _1bAFgXtx;
        "pkg-v2.0.0-a.3-1.10" = _SjyXdNpv;
        "pkg-v2.0.0-a.3-1.11" = _useHnAWH;
        "pkg-v2.0.0-a.3-1.12" = _4vr2Z2gr;
        "pkg-v2.0.0-a.3-1.13" = _IMpqbi70;
        "pkg-v2.0.0-a.3-1.14" = _Z0zkQltH;
        "pkg-v2.0.0-a.3-1.15" = _fU1y3qJd;
        "pkg-v2.0.0-a.3-1.16" = _aQJEO6w7;
        "pkg-v2.0.0-a.3-1.17" = _XU9ZZWTM;
        "pkg-v2.0.0-a.3-1.18" = _2p5Sb2bc;
        "pkg-v2.0.0-a.3-1.19" = _pRhOZu37;
        "pkg-v2.0.0-a.3-1.20" = _VLD048s2;
        "pkg-v2.0.0-a.3-1.21" = _EyhCkeER;
        "pkg-v2.0.0-a.4-1.9" = _JkrV6Nfq;
        "pkg-v2.0.0-a.4-1.10" = _kAucAPQH;
        "pkg-v2.0.0-a.4-1.11" = _zUSf9stP;
        "pkg-v2.0.0-a.4-1.12" = _QfhAtzGD;
        "pkg-v2.0.0-a.4-1.13" = _Tr0IenS8;
        "pkg-v2.0.0-a.4-1.14" = _duRnEY1U;
        "pkg-v2.0.0-a.4-1.15" = _EYtxMyF0;
        "pkg-v2.0.0-a.4-1.16" = _auPC8moU;
        "pkg-v2.0.0-a.4-1.17" = _WjX2KmrR;
        "pkg-v2.0.0-a.4-1.18" = _YkoHajtB;
        "pkg-v2.0.0-a.4-1.19" = _aTDZ9laO;
        "pkg-v2.0.0-a.4-1.20" = _W3VV8bAj;
        "pkg-v2.0.0-a.4-1.21" = _etMfPUJ1;
        "pkg-v2.0.0-a.5-1.9" = _pdPG5a1o;
        "pkg-v2.0.0-a.5-1.10" = _ySlYSat6;
        "pkg-v2.0.0-a.5-1.11" = _VhNlwypV;
        "pkg-v2.0.0-a.5-1.12" = _d6ZjlHhV;
        "pkg-v2.0.0-a.5-1.13" = _saI71tSA;
        "pkg-v2.0.0-a.5-1.14" = _vkctQ6jc;
        "pkg-v2.0.0-a.5-1.15" = _BW9lgQSJ;
        "pkg-v2.0.0-a.5-1.16" = _ULNhTTfM;
        "pkg-v2.0.0-a.5-1.17" = _oFGAviYf;
        "pkg-v2.0.0-a.5-1.18" = _kXpO3MGp;
        "pkg-v2.0.0-a.5-1.19" = _BffToBjV;
        "pkg-v2.0.0-a.5-1.20" = _MJ5zoLWs;
        "pkg-v2.0.0-a.5-1.21" = _MmPYwzqa;
        "pkg-v2.0.0-a.6-1.9" = _OzvScZPV;
        "pkg-v2.0.0-a.6-1.10" = _csVK4p3b;
        "pkg-v2.0.0-a.6-1.11" = _eJEFaxMW;
        "pkg-v2.0.0-a.6-1.12" = _qHOncy9P;
        "pkg-v2.0.0-a.6-1.13" = _HymrGCvz;
        "pkg-v2.0.0-a.6-1.14" = _bEAGy2Wu;
        "pkg-v2.0.0-a.6-1.15" = _bStbNohJ;
        "pkg-v2.0.0-a.6-1.16" = _gsvb8KZD;
        "pkg-v2.0.0-a.6-1.17" = _bz7St7oU;
        "pkg-v2.0.0-a.6-1.18" = _DdYacTAP;
        "pkg-v2.0.0-a.6-1.19" = _zIdpVvou;
        "pkg-v2.0.0-a.6-1.20" = _ycSlm8dP;
        "pkg-v2.0.0-a.6-1.21" = _2v4V0dfc;
        "pkg-v2.0.0-a.7-1.9" = _fY4Usg2q;
        "pkg-v2.0.0-a.7-1.10" = _Ss1MvTFK;
        "pkg-v2.0.0-a.7-1.11" = _1mf1UeOC;
        "pkg-v2.0.0-a.7-1.12" = _w42ozjA2;
        "pkg-v2.0.0-a.7-1.13" = _7MIbwvFR;
        "pkg-v2.0.0-a.7-1.14" = _uPOGebGp;
        "pkg-v2.0.0-a.7-1.15" = _fTCFuU5u;
        "pkg-v2.0.0-a.7-1.16" = _URk8kFrj;
        "pkg-v2.0.0-a.7-1.17" = _9u0eBRXC;
        "pkg-v2.0.0-a.7-1.18" = _Xr6IoVMo;
        "pkg-v2.0.0-a.7-1.20" = _WwjqFuTb;
        "pkg-v2.0.0-a.7-1.21" = _q2KDnMsl;
        "pkg-v2.0.0-a.8-1.9" = _oH2tjVYw;
        "pkg-v2.0.0-a.8-1.10" = _FFeAh1qq;
        "pkg-v2.0.0-a.8-1.11" = _Csr6IJx1;
        "pkg-v2.0.0-a.8-1.12" = _yVzSzmRR;
        "pkg-v2.0.0-a.8-1.13" = _DQqXjvu8;
        "pkg-v2.0.0-a.8-1.14" = _uPyAjjZ0;
        "pkg-v2.0.0-a.8-1.15" = _fRlWf12z;
        "pkg-v2.0.0-a.8-1.16" = _Q8QcgcDp;
        "pkg-v2.0.0-a.8-1.17" = _bNWtClOP;
        "pkg-v2.0.0-a.8-1.18" = _zrPEOW9P;
        "pkg-v2.0.0-a.8-1.19" = _4faSzORj;
        "pkg-v2.0.0-a.8-1.20" = _xtA3uoT7;
        "pkg-v2.0.0-a.8-1.21" = _qaUvhNlo;
        "pkg-v2.0.0-a.9-1.9" = _WpJxWV1S;
        "pkg-v2.0.0-a.9-1.10" = _AoEtLJD8;
        "pkg-v2.0.0-a.9-1.11" = _6wGRv2R5;
        "pkg-v2.0.0-a.9-1.12" = _s8rRwhAz;
        "pkg-v2.0.0-a.9-1.13" = _QwH07BmQ;
        "pkg-v2.0.0-a.9-1.14" = _XzdhzhYd;
        "pkg-v2.0.0-a.9-1.15" = _dwnCpdQQ;
        "pkg-v2.0.0-a.9-1.16" = _35iIRwR2;
        "pkg-v2.0.0-a.9-1.17" = _ISPK0wYh;
        "pkg-v2.0.0-a.9-1.18" = _9RosIk2e;
        "pkg-v2.0.0-a.9-1.19" = _4yECtpxR;
        "pkg-v2.0.0-a.9-1.20" = _zbVnofRR;
        "pkg-v2.0.0-a.9-1.21" = _kxAXta7M;
        "default" = _kxAXta7M;
    });
