...
let
    ...
    in {
        ...
        "pkg-1.0" = _klZAnBQe;
        "pkg-1.0_mod" = _F9Hf7UGD;
        "pkg-1.1" = _EbrRSA4g;
        "pkg-1.2" = _aMJslB3d;
        "pkg-1.2+mod" = _91tZhuB1;
        "pkg-1.3" = _FOz0bXu5;
        "pkg-1.3+mod" = _fxGo3o6J;
        "pkg-1.4" = _i5FuIyGn;
        "pkg-1.4+mod" = _OHQd8lqw;
        "pkg-2.0" = _ZJv7kRiK;
        "pkg-2.0+mod" = _n4GYtdlx;
        "pkg-2.1" = _zhiEOObM;
        "pkg-3.0" = _6VjqPCho;
        "pkg-3.0+mod" = _RF7HM7m2;
        "pkg-3.1" = _IYr118DJ;
        "pkg-3.1+mod" = _XCHzReXB;
        "pkg-3.2" = _7pVi5hPE;
        "pkg-3.2+mod" = _9apZ2wyl;
        "pkg-3.3" = _WWg39OWX;
        "pkg-3.3+mod" = _BpWBYX1L;
        "pkg-3.4" = _vxrWa8Hq;
        "pkg-3.4+mod" = _xWh9Ewnz;
        "pkg-3.5" = _vVkyoB2k;
        "pkg-3.5+mod" = _FMioonxw;
        "pkg-3.6" = _22BNOROr;
        "pkg-3.6+mod" = _xenQF2LB;
        "pkg-3.7" = _I64LriVl;
        "pkg-3.7-fabric" = _PuEv01uu;
        "pkg-3.7-forge" = _SWZjaL42;
        "pkg-3.11" = _ZYjSDmqs;
        "pkg-3.11-fabric" = _vMtfi843;
        "pkg-3.11-quilt" = _Y66p07oC;
        "pkg-3.11-forge" = _jNQDODuV;
        "pkg-3.11-neoforge" = _mFTzsq3J;
        "pkg-3.12" = _FlTAwlqg;
        "pkg-3.12-fabric" = _xa7cupYm;
        "pkg-3.12-quilt" = _IZ195IoV;
        "pkg-3.12-forge" = _KeOFCNQo;
        "pkg-3.12-neoforge" = _9NMpls3p;
        "default" = _9NMpls3p;
    });
