...
let
    ...
    in {
        ...
        "pkg-0.3" = _zzoO6aQu;
        "pkg-0.3.1" = _GqiYKKfa;
        "pkg-0.4.0-1.20.6" = _7vvbHbDl;
        "pkg-1.0.0-1.20.6" = _fSv9FO7c;
        "pkg-1.0.1-1.20.6" = _puum4TWK;
        "pkg-1.0.1-1.20.2" = _BUKYf6Ki;
        "pkg-1.0.2-1.20.6-fabric" = _RfUvRcab;
        "pkg-1.0.2-1.20.2-fabric" = _ZgBOJFN5;
        "pkg-1.1.0-1.20.6-fabric" = _lsKvu5Nf;
        "pkg-1.1.0-1.21-fabric" = _tEw7zxTy;
        "pkg-1.2.0-1.21-fabric" = _tp0Tz2UO;
        "pkg-1.3.0-1.21-fabric" = _vurTlUQP;
        "pkg-1.3.1-1.21-fabric" = _yGLhWxhC;
        "pkg-1.3.1-1.20.6-fabric" = _LB8si690;
        "pkg-1.4.0-1.21-fabric" = _dcXEeThE;
        "pkg-1.4.0-1.20.6-fabric" = _f2qr3XVp;
        "pkg-1.5.0+1.21+fabric" = _BwsgnE9X;
        "pkg-1.5.0+1.20.6+fabric" = _xYYBg6g1;
        "pkg-1.5.0+1.21-1.21.1+fabric" = _77M8O0I9;
        "pkg-1.6.0+1.21-1.21.1+fabric" = _pOc3ZeWc;
        "pkg-1.6.0+1.21.3+fabric" = _iCjsdk0l;
        "pkg-1.6.0+1.21.4+fabric" = _HVpLDnDB;
        "pkg-1.6.0+1.21.5+fabric" = _YuFoVeaO;
        "pkg-1.6.0+1.21.6+fabric" = _uJEz1tZO;
        "pkg-1.6.0+1.21.6-1.21.8+fabric" = _JQx2P6sr;
        "pkg-1.6.0+1.21.9+fabric" = _CwAs6DBQ;
        "pkg-1.6.0+1.21.9-1.21.10+fabric" = _k8PaK1A0;
        "pkg-1.6.0+1.21.11+fabric" = _y2MSTpAO;
        "pkg-1.7.0+1.21.11+fabric" = _xYXf7tjW;
        "pkg-1.8.0+26.1+fabric" = _548XWz1Z;
        "pkg-1.8.1+26.1+fabric" = _JbGEkffr;
        "pkg-1.8.2+26.1+fabric" = _lZljzuxX;
        "pkg-1.5.0+1.20.1+fabric" = _NVZH0Ge6;
        "default" = _NVZH0Ge6;
    });
