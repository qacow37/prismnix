...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _RBFZJ18h;
        "pkg-1.0.4" = _QkHfjGjp;
        "pkg-1.15.2-2.0.0" = _SgLHRY6X;
        "pkg-1.15.2-2.0.1" = _pkfExev8;
        "pkg-2.0.1.3" = _lmYXvc9f;
        "pkg-3.0.0.2" = _hvA5B6fR;
        "pkg-3.0.0.3" = _y1FrrjDQ;
        "pkg-2.0.1.4" = _5JLQ5fDN;
        "pkg-3.0.0.4" = _6h8ieVSJ;
        "pkg-3.0.0.5" = _YRIB36Q9;
        "pkg-3.0.0.6" = _YRPwhcBd;
        "pkg-3.0.0.7" = _ys70OiDq;
        "pkg-3.0.0.8" = _WA6ehvjO;
        "pkg-3.0.0.9" = _1B2Hz9hN;
        "pkg-3.0.0.10" = _sUf90kVr;
        "pkg-3.0.0.11" = _pB5nnm34;
        "pkg-3.0.0.12" = _KbCx8I9R;
        "pkg-3.0.0.13" = _Ou2YJFcZ;
        "pkg-3.0.0.14" = _pfdmshXV;
        "pkg-3.0.0.15" = _PiE4nTpf;
        "pkg-1.0.0+1" = _nWb8zjjO;
        "pkg-1.0.0+2" = _PLwJfWro;
        "pkg-4.0.0+3" = _OCypHvjZ;
        "pkg-5.0.0+1" = _7tZyMq3L;
        "pkg-5.0.0+2" = _aZPxtZ7p;
        "pkg-5.0.3" = _uaNKgzSd;
        "pkg-5.0.4" = _H4aTEPed;
        "pkg-5.0.5" = _c02XOu3r;
        "pkg-5.0.6" = _7TuirRLl;
        ...
        "pkg-6.0.7" = _OBvwLOte;
        "pkg-6.0.9" = _mygkM0j4;
        "pkg-6.0.10" = _KyVDWbuw;
        "pkg-6.0.11" = _TjOOd3xH;
        "pkg-7.0.0.1" = _D3H5mDwH;
        "pkg-7.0.0.2" = _NLWzgBGD;
        "pkg-8.0.0.2" = _1l2f3fXP;
        "pkg-9.0.0.1" = _tUH9rFUZ;
        "pkg-10.0.0.1" = _3aTHD4gQ;
        "pkg-10.0.0.3" = _mmINqNq1;
        "pkg-11.0.0.1" = _CuvS0nPS;
        "pkg-12.0.0.3" = _GMFwMJDH;
        "pkg-13.0.0.1" = _mlqpL2az;
        "pkg-13.0.0.3" = _WAaOMMxy;
        "pkg-14.0.0.1" = _2BdudZaB;
        "pkg-14.0.0.2" = _gnpVvLEI;
        "pkg-15.0.0.1" = _gObNVj0w;
        "pkg-16.0.0.1" = _BoA5odNn;
        "pkg-17.0.0.1" = _EvMvnzOb;
        "pkg-18.0.0.1" = _2GeggDJq;
        "pkg-19.0.0.1" = _sp5bwvg7;
        "pkg-20.0.0.1" = _h2QjB9qj;
        "pkg-21.0.0.1" = _wsIdnx9I;
        "pkg-22.0.0.1" = _pfefXpAa;
        "pkg-23.0.0.1" = _530kbRxa;
        "pkg-24.0.0.1" = _HDXYdfZA;
        "pkg-25.0.0.1" = _XJPg5Weo;
        "pkg-26.1.0.1" = _bKGXtwbM;
