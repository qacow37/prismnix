...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.21" = _yrJwYtZK;
        "pkg-1.0.0-1.21.1" = _tAyYXE5u;
        "pkg-1.0.0-1.21.2" = _5MYcCzA1;
        "pkg-1.0.0-1.21.3" = _gIqAexAT;
        "pkg-1.0.0-1.21.4" = _flpSM2Zz;
        "pkg-1.0.0-1.14.4" = _ff2xnnFK;
        "pkg-1.0.0-1.15" = _O0XrglTT;
        "pkg-1.0.0-1.15.1" = _PksCmEmt;
        "pkg-1.0.0-1.15.2" = _ikhDJe37;
        "pkg-1.0.0-1.16" = _KpkMi9pI;
        "pkg-1.0.0-1.16.1" = _b7aPLyOX;
        "pkg-1.0.0-1.16.2" = _ANoy7udN;
        "pkg-1.0.0-1.16.3" = _2JNu4NKQ;
        "pkg-1.0.0-1.16.4" = _yqoxSzhU;
        "pkg-1.0.0-1.16.5" = _ooHm3FO0;
        "pkg-1.0.0-1.17" = _vajlR5Dw;
        "pkg-1.0.0-1.17.1" = _doJqlJ2F;
        "pkg-1.0.0-1.18" = _IJblZWmN;
        "pkg-1.0.0-1.18.1" = _uL6FipZs;
        "pkg-1.0.0-1.18.2" = _Vd2JTk61;
        "pkg-1.0.0-1.19" = _eRjdX6Rc;
        "pkg-1.0.0-1.19.1" = _5VyVtalC;
        "pkg-1.0.0-1.19.2" = _BYpucLdZ;
        "pkg-1.0.0-1.19.3" = _tRmsnQ1d;
        "pkg-1.0.0-1.19.4" = _yqzw6uZH;
        "pkg-1.0.0-1.20" = _TqaZQ8zy;
        "pkg-1.0.0-1.20.1" = _6lBtExYq;
        "pkg-1.0.0-1.20.2" = _cevPH79u;
        "pkg-1.0.0-1.20.3" = _4zyFRI9y;
        "pkg-1.0.0-1.20.4" = _p8Dacm1T;
        "pkg-1.0.0-1.20.5" = _HaFDlY37;
        "pkg-1.0.0-1.20.6" = _KhAdJTj1;
        "pkg-1.0.0-1.21.5" = _YSnYWzXv;
        "pkg-1.0.0-1.21.6" = _ZQCOITUT;
        "pkg-1.0.0-1.21.7" = _kKpVmrMP;
        "pkg-1.0.0-1.21.8" = _4CYkqgJ7;
        "pkg-1.0.0-1.21.9" = _Ic2AaBYX;
        "pkg-1.0.0-1.21.10" = _3lLd8Abx;
        "default" = _3lLd8Abx;
    });
