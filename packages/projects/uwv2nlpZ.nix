...
let
    ...
    in {
        ...
        "pkg-0.9.0+1.16.5-fabric" = _nTXtQfOJ;
        "pkg-0.9.0+1.18.2-fabric" = _w31sFykU;
        "pkg-0.9.0+1.19.4-fabric" = _SLvvMSoU;
        "pkg-0.9.0+1.21.1-fabric" = _psZLmQNH;
        "pkg-0.9.0+1.21.1-neoforge" = _KWP1mwBa;
        "pkg-0.9.0+1.21.5-fabric" = _s77IsbsE;
        "pkg-0.9.0+1.21.11-fabric" = _9aGgOxIk;
        "pkg-1.0.0+1.19.4-fabric" = _Sbuv4Gjg;
        "pkg-1.0.0+1.18.2-fabric" = _JtHwyCW6;
        "pkg-1.0.0+1.16.5-fabric" = _JBVgXpHc;
        "pkg-1.0.0+1.21.1-fabric" = _KjhaYtIr;
        "pkg-1.0.0+1.21.1-neoforge" = _HhUZeJ8M;
        "pkg-1.0.0+1.21.5-fabric" = _aEdfSRSL;
        "pkg-1.0.0+1.21.11-fabric" = _LtD5zGTK;
        "pkg-1.0.0+1.20.1-forge" = _QnL8aC4E;
        "pkg-1.0.0+26.1-fabric" = _8kN29QJe;
        "pkg-1.1.0+1.16.5-fabric" = _CoNWcMAd;
        "pkg-1.1.0+1.18.2-fabric" = _oBv3y0pV;
        "pkg-1.1.0+1.19.4-fabric" = _lbVBGCED;
        "pkg-1.1.0+1.20.1-forge" = _U06vBk5O;
        "pkg-1.1.0+1.21.1-fabric" = _YCFTdiSV;
        "pkg-1.1.0+1.21.1-neoforge" = _XvXnMEpn;
        "pkg-1.1.0+1.21.5-fabric" = _Mbgw54AD;
        "pkg-1.1.0+1.21.11-fabric" = _b7eATCDY;
        "pkg-1.1.0+26.1-fabric" = _BQHiDSSD;
        "pkg-1.1.0+26.1-neoforge" = _qJoVQCMb;
        "default" = _qJoVQCMb;
    });
