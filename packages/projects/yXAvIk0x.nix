...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.20.6" = _a924mZ1T;
        "pkg-1.0.0+mc1.20.4" = _hmMUFeDo;
        "pkg-1.0.0+mc1.20.1" = _WaNMwPDY;
        "pkg-1.0.0+mc1.21" = _alw2GEXP;
        "pkg-1.0.1+mc1.21" = _kQeLfbQY;
        "pkg-1.0.1+mc1.20.6" = _waoJ2gKU;
        "pkg-1.0.1+mc1.20.4" = _tw72NCL0;
        "pkg-1.0.1+mc1.20.1" = _naCDYEgw;
        "pkg-1.1.0+mc1.20.6" = _29Xcfd86;
        "pkg-1.1.0+mc1.21" = _TG5KGCLf;
        "pkg-1.1.0+mc1.20.4" = _aCsCQOb6;
        "pkg-1.1.0+mc1.20.1" = _7NbXG2mn;
        "pkg-1.1.1+mc1.20.6" = _Fw71BNHT;
        "pkg-1.1.1+mc1.20.4" = _pbCfRJ8E;
        "pkg-1.1.1+mc1.20.1" = _nGaOIFEs;
        "pkg-1.1.2+mc1.20.6" = _HRQVFWXQ;
        "pkg-1.1.2+mc1.21" = _z1kZ2AiS;
        "pkg-1.1.2+mc1.20.4" = _gVPd4ak5;
        "pkg-1.1.2+mc1.20.1" = _PYXhli26;
        "pkg-1.2.0+mc1.21" = _hckPmRU6;
        "pkg-1.2.0+mc1.20.6" = _yCb55BKU;
        "pkg-1.2.0+mc1.20.4" = _JHkfym5C;
        "pkg-1.2.0+mc1.20.1" = _5IFiwXlX;
        "pkg-1.2.1+mc1.21" = _upcGxu14;
        "pkg-1.2.1+mc1.20.6" = _VALrIOCB;
        "pkg-1.2.1+mc1.20.4" = _NIXRC6s9;
        "pkg-1.2.1+mc1.20.1" = _ED1Or31a;
        "pkg-1.2.2+mc1.21" = _lbM3CgOQ;
        "pkg-1.3.0+mc1.20.6" = _igeLivNn;
        "pkg-1.3.0+mc1.21" = _KVIrl9Qa;
        "pkg-1.3.0+mc1.20.4" = _U7v6jO0C;
        "pkg-1.3.0+mc1.20.1" = _zmOh40vI;
        "pkg-1.3.1+mc1.21" = _USZ5smHm;
        "pkg-1.3.1+mc1.20.6" = _S0f9xmuZ;
        "pkg-1.3.1+mc1.20.4" = _IqfZ9ErA;
        "pkg-1.3.1+mc1.20.1" = _IlVeKwmi;
        "pkg-1.3.2+mc1.21" = _xtO4K7oI;
        "pkg-1.3.2+mc1.20.6" = _jk8oQNya;
        "pkg-1.3.2+mc1.20.4" = _XfmLV0Qi;
        "pkg-1.3.2+mc1.20.1" = _sLxi0ZUm;
        "pkg-1.3.3+mc1.21.2" = _GeU8sHLE;
        "pkg-1.3.4+mc1.21.3" = _dfIwTBun;
        "pkg-1.4.0+mc1.21.3" = _ktEipZTw;
        "pkg-1.4.0+mc1.21" = _vJzu6633;
        "pkg-1.4.0+mc1.20.1" = _GCV1djgb;
        "pkg-1.4.1-beta+mc1.21.3-fabric" = _6JNpa9VS;
        "pkg-1.4.1-beta+mc1.21.3-neoforge" = _Cxg70l06;
        "pkg-1.4.1-beta+mc1.21-fabric" = _Gysraf0G;
        "pkg-1.4.1-beta+mc1.21-neoforge" = _YqIgYiJ7;
        "pkg-1.4.1-beta+mc1.20.1-forge" = _WGDCFT87;
        "pkg-1.4.1-beta+mc1.20.1-fabric" = _yJTRyrMR;
        "pkg-1.4.2+mc1.21.3-fabric" = _ZRfL1QBA;
        "pkg-1.4.2+mc1.21.3-neoforge" = _NClj53kg;
        "pkg-1.4.2+mc1.21-neoforge" = _2cGOyqW9;
        "pkg-1.4.2+mc1.21-fabric" = _2j0K0s54;
        "pkg-1.4.2+mc1.20.1-forge" = _CKCGJVzO;
        "pkg-1.4.2+mc1.20.1-fabric" = _QznaODGw;
        "pkg-1.4.3+mc1.21.4-neoforge" = _xoyKC3I8;
        "pkg-1.4.3+mc1.21.4-fabric" = _k0eKcEMN;
        "pkg-1.4.4+mc1.21.4-fabric" = _YGNS2c9T;
        "pkg-1.4.4+mc1.21-neoforge" = _qZCwBy8M;
        "pkg-1.4.4+mc1.21-fabric" = _InexVr2D;
        "pkg-1.4.4+mc1.20.1-fabric" = _Jzdyv0Cx;
        "pkg-1.4.4+mc1.20.1-forge" = _ayIarfmD;
        "pkg-1.4.4+mc1.21.4-neoforge" = _26xI7u36;
        "pkg-1.5.0+mc1.21.4-fabric" = _i6VI20QP;
        "pkg-1.5.0+mc1.21.4-neoforge" = _uxnFf4fm;
        "pkg-1.5.0+mc1.21-neoforge" = _k0OMN8t5;
        "pkg-1.5.0+mc1.21-fabric" = _27o09fak;
        "pkg-1.5.0+mc1.20.1-forge" = _ZQgzDEWu;
        "pkg-1.5.0+mc1.20.1-fabric" = _AQ3XAMJx;
        "pkg-1.5.1+mc1.21-neoforge" = _I0KbSlL9;
        "pkg-1.5.1+mc1.21.4-neoforge" = _PWd3JGaj;
        "pkg-1.5.1+mc1.20.1-forge" = _aiNs4ig8;
        "pkg-1.5.1+mc1.21.4-fabric" = _QQn0OzZw;
        "pkg-1.5.1+mc1.21-fabric" = _C2cLg27a;
        "pkg-1.5.1+mc1.20.1-fabric" = _JfU9T1bG;
        "pkg-1.5.2+mc1.21.5-fabric" = _N99ennkW;
        "pkg-1.5.2+mc1.21.5-neoforge" = _wudJc87b;
        "pkg-1.6.0+mc1.21.6-neoforge" = _qrYpEjuT;
        "pkg-1.6.0+mc1.21.6-fabric" = _sTp4CgMI;
        "pkg-1.6.1+mc1.21.7-neoforge" = _SMbR3OjR;
        "pkg-1.6.1+mc1.21.7-fabric" = _P2e4dAWA;
        "pkg-1.6.2+mc1.21.7-fabric" = _8xgA8E7X;
        "pkg-1.6.2+mc1.21.6-fabric" = _iIP0GISj;
        "pkg-1.6.2+mc1.21.6-neoforge" = _WQGiDypz;
        "pkg-1.6.2+mc1.21.7-neoforge" = _e9lK7aPN;
        "pkg-1.6.3+mc1.21.8-neoforge" = _KxLuotcG;
        "pkg-1.6.3+mc1.21.8-fabric" = _IugLIpVZ;
        "pkg-1.6.4+mc1.21.8-fabric" = _scvJXccj;
        "pkg-1.6.4+mc1.21.8-neoforge" = _7E5WZQU3;
        "pkg-1.6.4+mc1.21.6-fabric" = _OOKoDm2k;
        "pkg-1.6.4+mc1.21.6-neoforge" = _GJCiVM8N;
        "pkg-1.6.4+mc1.21.7-fabric" = _2PzTZn12;
        "pkg-1.6.4+mc1.21.7-neoforge" = _C6IfEb4L;
        "pkg-1.6.5+mc1.21.9-fabric" = _yQzpdIGr;
        "pkg-1.6.5+mc1.21.9-neoforge" = _L9CBYuLO;
        "pkg-1.6.6+mc1.21.9-neoforge" = _12Z3btUt;
        "pkg-1.6.6+mc1.21.9-fabric" = _yLZjJfxn;
        "pkg-1.6.7+mc1.21.11-neoforge" = _tST2CowR;
        "pkg-1.6.7+mc1.21.11-fabric" = _wVSgcUae;
        "pkg-2.0.0-beta1+mc1.21.11-fabric" = _UOTYcNE1;
        "pkg-2.0.0-beta1+mc1.21.11-neoforge" = _otG0HtmI;
        "pkg-2.0.0-beta2+mc1.21.11-neoforge" = _TRdBgUyu;
        "pkg-2.0.0-beta2+mc1.21.11-fabric" = _AGehryPO;
        "pkg-2.0.0+mc26.1" = _4D5wt4SA;
        "pkg-2.0.0+mc26.1.1" = _tC09v0nE;
        "pkg-2.0.1+mc26.1.2" = _xCqITCJE;
