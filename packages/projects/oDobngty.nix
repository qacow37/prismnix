...
let
    ...
    in {
        ...
        "pkg-1.20.1-2.9.4.2" = _SWU0es1t;
        "pkg-1.18.2-1.3.6.0" = _G2yksoWn;
        "pkg-1.18.2-2.9.4.4" = _n76wqHnr;
        "pkg-1.19.2-2.9.4.4" = _1JmZOYXj;
        "pkg-1.19.4-2.9.4.4" = _pEs3Ir2g;
        "pkg-1.20.1-2.9.4.4" = _667agQgf;
        "pkg-1.18.2-2.9.4.5" = _ZO3recA2;
        "pkg-1.19.2-2.9.4.5" = _IPGYP5Cn;
        "pkg-1.19.4-2.9.4.5" = _QLsnZtYC;
        "pkg-1.20.1-2.9.4.5" = _H3UVcvtj;
        "pkg-1.18.2-2.9.4.6" = _ZBQ8BjIa;
        "pkg-1.19.2-2.9.4.6" = _QYpkbmCD;
        "pkg-1.19.4-2.9.4.6" = _fvIRdC9U;
        "pkg-1.20.1-2.9.4.6" = _HI8hHLYT;
        "pkg-1.18.2-2.9.4.7" = _kgtnopK7;
        "pkg-1.19.2-2.9.4.7" = _4cy0DNI4;
        "pkg-1.19.4-2.9.4.7" = _TA8c2B7A;
        "pkg-1.20.1-2.9.4.7" = _r1EA2fMZ;
        "pkg-1.18.2-2.9.5.0" = _WLt6K5bS;
        "pkg-1.19.2-2.9.5.0" = _uVRBZKOj;
        "pkg-1.19.4-2.9.5.0" = _I9k0VNay;
        "pkg-1.20.1-2.9.5.0" = _obv3E7NA;
        "pkg-1.19.2-2.9.5.1" = _MCVWBRHm;
        "pkg-1.20.1-2.9.5.1" = _OZTPwFzE;
        "pkg-1.20.1-2.9.6.0-FABRIC" = _16r5SdYb;
        "pkg-1.20.1-2.9.6.0-FORGE" = _JdeIEQeq;
        "pkg-1.19.2-2.9.5.3" = _dlC88Ot2;
        "pkg-1.20.4-2.9.6.0-NEOFORGE" = _Da7MjgQk;
        "pkg-1.20.4-2.9.6.1-FABRIC" = _RFAycn8Y;
        "pkg-1.20.4-2.9.6.1-NEOFORGE" = _pERt6sWo;
        "pkg-1.20.1-2.9.6.1-FABRIC" = _HDMBQp13;
        "pkg-1.20.1-2.9.6.1-FORGE" = _mTPrwLfJ;
        "pkg-1.21-2.9.6.1-FABRIC" = _kQCajkwF;
        "pkg-1.21-2.9.6.1-NEOFORGE" = _bKgADZv8;
        "pkg-1.18.2-2.9.6.0" = _uJITC0Cz;
        "pkg-1.19.2-2.9.6.0" = _hlIz3buu;
        "pkg-1.20.1-2.9.6.2-FABRIC" = _SYEYufM2;
        "pkg-1.20.1-2.9.6.2-FORGE" = _BJceDTez;
        "pkg-1.20.4-2.9.6.2-FABRIC" = _uD1xRlk5;
        "pkg-1.20.4-2.9.6.2-NEOFORGE" = _BzwAgavo;
        "pkg-1.21-2.9.6.2-FABRIC" = _5DpFRN2Z;
        "pkg-1.21-2.9.6.2-NEOFORGE" = _vCx96x9n;
        "pkg-1.21-2.9.6.3-FABRIC" = _pR1U1ejc;
        "pkg-1.21-2.9.6.3-NEOFORGE" = _pdIGsktU;
        "pkg-1.21-2.9.6.4-FABRIC" = _LosJXPh4;
        "pkg-1.21-2.9.6.4-NEOFORGE" = _gw559PVu;
        "pkg-1.21-2.9.6.5-FABRIC" = _k7fvLPpB;
        "pkg-1.21-2.9.6.5-NEOFORGE" = _AD9NNKL3;
        "pkg-1.21-2.9.6.6-FABRIC" = _eANr7XNx;
        "pkg-1.21-2.9.6.6-NEOFORGE" = _lcN3GcdF;
        "pkg-1.21-2.9.6.7-FABRIC" = _X5Xa6RuP;
        "pkg-1.21-2.9.6.7-NEOFORGE" = _DExwY6bJ;
        "pkg-1.20.1-2.9.6.3-FABRIC" = _uIaXQ0sK;
        "pkg-1.20.1-2.9.6.3-FORGE" = _6VMUOvVd;
        "pkg-1.21-2.9.7.0-FABRIC" = _zD117UA2;
        "pkg-1.21-2.9.7.0-NEOFORGE" = _ceQlgXaK;
        "pkg-1.20.1-2.9.7.1-FABRIC" = _olfjiGVk;
        "pkg-1.20.1-2.9.7.1-FORGE" = _TGGdNt5N;
        "pkg-1.20.1-2.9.8.0-FABRIC" = _ZdnZLLp2;
        "pkg-1.20.1-2.9.8.0-FORGE" = _BSQkB579;
        "pkg-1.21-2.9.8.0-FABRIC" = _O4N7AXrT;
        "pkg-1.21-2.9.8.0-NEOFORGE" = _4LtQxhAm;
        "pkg-1.20.1-2.9.8.1-FABRIC" = _wEQvZjEi;
        "pkg-1.20.1-2.9.8.1-FORGE" = _toET9h5k;
        "pkg-1.20.4-2.9.6.3-FABRIC" = _UM2tlwuV;
        "pkg-1.20.4-2.9.6.3-NEOFORGE" = _CZQ4qo8D;
        "pkg-1.21-2.9.8.1-NEOFORGE" = _V4KaoQ90;
        "pkg-1.21-2.9.8.1-FABRIC" = _fH76upna;
        "pkg-1.21.1-2.9.8.1-FABRIC" = _UzbM4Smf;
        "pkg-1.21.1-2.9.8.1-NEOFORGE" = _U3yOgInC;
        "pkg-1.18.2-2.9.6.1" = _4LJTuTiX;
        "pkg-1.19.2-2.9.6.1" = _x4RQGAsB;
        "pkg-1.20.1-2.9.8.2-FABRIC" = _E4e4GzuM;
        "pkg-1.20.1-2.9.8.2-FORGE" = _8pyQrCPw;
        "pkg-1.20.4-2.9.6.4-FABRIC" = _l32sP66S;
        "pkg-1.20.4-2.9.6.4-NEOFORGE" = _geMF6kGi;
        "pkg-1.21.1-2.9.8.2-FABRIC" = _di3XGtfz;
        "pkg-1.21.1-2.9.8.2-NEOFORGE" = _hLIMDEv4;
        "pkg-1.21.1-2.9.9.0-FABRIC" = _666ZRawY;
        "pkg-1.21.1-2.9.9.0-NEOFORGE" = _oZppsBpP;
        "pkg-1.20.1-2.9.9.1-FABRIC" = _aGQCFeKJ;
        "pkg-1.20.1-2.9.9.1-FORGE" = _i1u3GX7v;
        "pkg-1.20.4-2.9.9.1-FABRIC" = _Ql64fDQD;
        "pkg-1.20.4-2.9.9.1-NEOFORGE" = _DIBwjHEx;
        "pkg-1.21.1-2.9.9.1-FABRIC" = _UvDElIEF;
        "pkg-1.21.1-2.9.9.1-NEOFORGE" = _zVryBnu0;
        "pkg-1.18.2-2.9.10.1" = _ACf27c5w;
        "pkg-1.19.2-2.9.10.1" = _Xc5DOa8x;
        "pkg-1.20.1-2.9.10.1-FABRIC" = _vbQX8woQ;
        "pkg-1.20.1-2.9.10.1-FORGE" = _GKNWkQik;
        "pkg-1.21.1-2.9.10.1-NEOFORGE" = _7dJhdPRy;
        "pkg-1.21.1-2.9.10.1-FABRIC" = _nVyHygBw;
        "pkg-1.21.1-2.9.11.0-FABRIC" = _RPVlC0YM;
        "pkg-1.21.1-2.9.11.0-NEOFORGE" = _YMLnMair;
        "pkg-1.21.1-2.9.11.1-FABRIC" = _mwwmewcH;
        "pkg-1.21.1-2.9.11.1-NEOFORGE" = _1rdTQ0s9;
        "pkg-1.21.1-2.9.11.2-FABRIC" = _UpuPoLUJ;
        "pkg-1.21.1-2.9.11.2-NEOFORGE" = _CUwMAOCb;
        "pkg-1.20.1-2.9.11.2-FABRIC" = _T3wfLFAl;
        "pkg-1.20.1-2.9.11.2-FORGE" = _6QrO6X0k;
        "pkg-1.21.1-2.9.12.0-FABRIC" = _8saCOnot;
        "pkg-1.21.1-2.9.12.0-NEOFORGE" = _SnkpmxUV;
        "pkg-1.21.1-2.9.12.1-FABRIC" = _EtVbeOZb;
        "pkg-1.21.1-2.9.12.1-NEOFORGE" = _wgvMHLJz;
        "pkg-1.21.1-2.9.13.0-FABRIC" = _nQ4BHDk5;
        "pkg-1.21.1-2.9.13.0-NEOFORGE" = _ECShN4GP;
        "pkg-1.21.1-2.9.13.1-FABRIC" = _hZOJw70a;
        "pkg-1.21.1-2.9.13.1-NEOFORGE" = _ClkKmLTo;
        "pkg-1.20.1-2.9.12.0-FABRIC" = _MsB3jVdk;
        "pkg-1.20.1-2.9.12.0-FORGE" = _rnBlmj9n;
        "pkg-1.21.1-2.9.14.0-FABRIC" = _E8yi2dLI;
        "pkg-1.21.1-2.9.14.0-NEOFORGE" = _xh02arKe;
        "pkg-1.20.1-2.9.13.0-FABRIC" = _85uarKpQ;
        "pkg-1.20.1-2.9.13.0-FORGE" = _O8kJZWf6;
        "pkg-1.21.1-2.9.15.0-FABRIC" = _g7blbeZE;
        "pkg-1.21.1-2.9.15.0-NEOFORGE" = _1lh7J1bs;
        "pkg-1.20.1-2.9.13.1-FABRIC" = _DjPY8EZC;
        "pkg-1.20.1-2.9.13.1-FORGE" = _498UOWmB;
        "pkg-1.20.1-2.9.13.2-FABRIC" = _AKQhL38b;
        "pkg-1.20.1-2.9.13.2-FORGE" = _HdKkUae2;
        "pkg-1.21.8-2.9.15.0-FABRIC" = _iy3h8sZJ;
        "pkg-1.21.8-2.9.15.0-NEOFORGE" = _vAJtutQY;
        "pkg-1.18.2-2.9.10.2" = _2J6KMIa1;
        "pkg-1.19.2-2.9.10.2" = _ZbxuzeLG;
        "pkg-1.20.1-2.9.13.3-FABRIC" = _boou4R6S;
        "pkg-1.20.1-2.9.13.3-FORGE" = _S9Cwhupx;
        "pkg-1.21.1-2.9.16.0-FABRIC" = _xtiueXoS;
        "pkg-1.21.1-2.9.16.0-NEOFORGE" = _dH4gsTmb;
        "pkg-1.21.8-2.9.16.0-FABRIC" = _TrNigtzK;
        "pkg-1.21.8-2.9.16.0-NEOFORGE" = _2OGtJe5k;
        "pkg-1.20.1-2.9.14.0-FABRIC" = _RhaudBFx;
        "pkg-1.20.1-2.9.14.0-FORGE" = _c0JqOAHz;
        "pkg-1.21.1-2.9.17.0-FABRIC" = _13fQA23c;
        "pkg-1.21.1-2.9.17.0-NEOFORGE" = _31YtJoWp;
        "pkg-1.21.8-2.9.17.0-FABRIC" = _5eABg1q1;
        "pkg-1.21.8-2.9.17.0-NEOFORGE" = _g9IzcF2h;
        "pkg-1.21.8-2.9.17.1-FABRIC" = _QshVrRFW;
        "pkg-1.21.8-2.9.17.1-NEOFORGE" = _FHBqbw6H;
        "pkg-1.18.2-2.9.10.3" = _PPaAdeqy;
        "pkg-1.19.2-2.9.10.3" = _UGcT9nsS;
        "pkg-1.20.1-2.9.14.1-FABRIC" = _F4SDl1DL;
        "pkg-1.20.1-2.9.14.1-FORGE" = _7muR8vvP;
        "pkg-1.20.1-2.9.14.2-FABRIC" = _Lz8jdLiT;
        "pkg-1.20.1-2.9.14.2-FORGE" = _SU23XHT4;
        "pkg-1.21.1-2.9.18.0-FABRIC" = _k70qLJou;
        "pkg-1.21.1-2.9.18.0-NEOFORGE" = _7ahkxuI2;
        "pkg-1.21.8-2.9.17.2-FABRIC" = _UbemtwzS;
        "pkg-1.21.8-2.9.17.2-NEOFORGE" = _3fjyfjXw;
        "pkg-1.21.6-2.9.17.2-FABRIC" = _p8jAqXut;
        "pkg-1.21.6-2.9.17.2-NEOFORGE" = _oorfauSu;
        "pkg-1.20.1-2.9.14.3-FABRIC" = _LIaitHhl;
        "pkg-1.20.1-2.9.14.3-FORGE" = _S9fnbY74;
        "pkg-1.21.1-2.9.18.1-FABRIC" = _Z7bQMMsD;
        "pkg-1.21.1-2.9.18.1-NEOFORGE" = _dqJKfrPi;
        "pkg-1.20.1-2.9.14.4-FABRIC" = _QWtB7NHT;
        "pkg-1.20.1-2.9.14.4-FORGE" = _7aftkcN4;
        "pkg-1.21.1-2.9.18.2-FABRIC" = _InkfTE4w;
        "pkg-1.21.1-2.9.18.2-NEOFORGE" = _9nI9Bs9V;
        "pkg-1.20.1-2.9.14.5-FABRIC" = _Xf4OxmTd;
        "pkg-1.20.1-2.9.14.5-FORGE" = _UJKeQPra;
        "pkg-1.21.8-2.9.17.3-FABRIC" = _UHz5OYtR;
        "pkg-1.21.8-2.9.17.3-NEOFORGE" = _BaCSIt9o;
        "pkg-1.20.1-2.9.14.6-FABRIC" = _dKP6Pkmo;
        "pkg-1.20.1-2.9.14.6-FORGE" = _rDBwv3vW;
        "pkg-1.21.1-2.9.18.3-FABRIC" = _ilwdYK3h;
        "pkg-1.21.1-2.9.18.3-NEOFORGE" = _2KEzMYam;
        "pkg-1.21.6-2.9.17.3-FABRIC" = _MtyH4car;
        "pkg-1.21.6-2.9.17.3-NEOFORGE" = _YgzjmmzY;
        "pkg-1.21.8-2.9.17.4-FABRIC" = _U9h8BCFo;
        "pkg-1.21.8-2.9.17.4-NEOFORGE" = _wAD1JTO2;
        "pkg-1.21.1-2.9.19.0-FABRIC" = _B9aBnjvV;
        "pkg-1.21.1-2.9.19.0-NEOFORGE" = _PLYtv66K;
        "pkg-1.20.1-2.9.15.0-FABRIC" = _t1Eqlp7F;
        "pkg-1.20.1-2.9.15.0-FORGE" = _uY9ZZXY8;
        "pkg-1.21.1-2.10.0.0-FABRIC" = _i6Q4Rp3x;
        "pkg-1.21.1-2.10.0.0-NEOFORGE" = _VKV3GtVR;
        "pkg-1.21.9-2.10.0.0-FABRIC" = _GyAowH2X;
        "pkg-1.21.9-2.10.0.0-NEOFORGE" = _jEaECA03;
        "pkg-1.21.10-2.10.0.0-FABRIC" = _yB7YVmwe;
        "pkg-1.21.10-2.10.0.0-NEOFORGE" = _rcTDBmPN;
        "pkg-1.21.1-2.10.1.0-FABRIC" = _TTj7c8IQ;
        "pkg-1.21.1-2.10.1.0-NEOFORGE" = _3fwK5yv2;
        "pkg-1.21.1-2.10.1.1-FABRIC" = _DmJoMy9D;
        "pkg-1.21.1-2.10.1.1-NEOFORGE" = _8yUyWaYB;
        "pkg-1.21.10-2.10.1.1-FABRIC" = _ipMIHfZC;
        "pkg-1.21.10-2.10.1.1-NEOFORGE" = _3hEt4kRh;
        "pkg-1.21.1-2.10.2.0-FABRIC" = _qlmMGe0f;
        "pkg-1.21.1-2.10.2.0-NEOFORGE" = _zrkQZVKh;
        "pkg-1.21.10-2.10.2.0-FABRIC" = _JIP2B5Xa;
        "pkg-1.21.10-2.10.2.0-NEOFORGE" = _AZED5CuP;
        "pkg-1.20.1-2.9.16.0-FABRIC" = _Zjf77k1W;
        "pkg-1.20.1-2.9.16.0-FORGE" = _SAikPFud;
        "pkg-1.21.1-2.10.3.0-FABRIC" = _XcbH7SqQ;
        "pkg-1.21.1-2.10.3.0-NEOFORGE" = _XgS5UJFd;
        "pkg-1.21.10-2.10.3.0-FABRIC" = _FBCZ0vzj;
        "pkg-1.21.10-2.10.3.0-NEOFORGE" = _FNbrz4O7;
        "pkg-1.21.1-2.10.3.1-FABRIC" = _WgvOTeZQ;
        "pkg-1.21.1-2.10.3.1-NEOFORGE" = _bDpmSuBJ;
        "pkg-1.21.10-2.10.3.1-FABRIC" = _Mt3vzYsy;
        "pkg-1.21.10-2.10.3.1-NEOFORGE" = _NpEbFcYf;
        "pkg-1.21.10-2.10.3.2-FABRIC" = _cA8aoRqv;
        "pkg-1.21.10-2.10.3.2-NEOFORGE" = _xvyuo4eV;
        "pkg-1.20.1-2.9.16.1-FORGE" = _5TkLP9dA;
        "pkg-1.21.1-2.10.4.0-FABRIC" = _pdJ7i5gh;
        "pkg-1.21.1-2.10.4.0-NEOFORGE" = _oXhrMvG1;
        "pkg-1.21.10-2.10.4.0-FABRIC" = _JFnTcjIh;
        "pkg-1.21.10-2.10.4.0-NEOFORGE" = _yCRrna3F;
        "pkg-1.20.1-2.9.16.2-FABRIC" = _pzJh0p9r;
        "pkg-1.20.1-2.9.16.2-FORGE" = _lxSJN2lX;
        "pkg-1.21.1-2.11.0.2" = _Q0TZhICa;
        "pkg-1.21.10-2.11.0.2" = _BrBRymvT;
        "pkg-1.21.11-2.11.0.2" = _SNh95ROf;
        "pkg-1.21.10-2.11.2.0" = _4P2XW8q4;
        "pkg-1.21.11-2.11.0.3" = _T5K0aKmk;
        "pkg-1.21.1-2.11.0.4" = _PbetH35p;
        "pkg-26.1.1-2.11.0.3" = _2RG5rswV;
        "pkg-26.1.2-2.11.0.3" = _qhG1KhhC;
        "pkg-26.1.2-2.11.0.4" = _OxXZmEeb;
        "pkg-26.1.2-2.11.0.5" = _4JZDTg7i;
        "pkg-26.1.2-2.11.0.6" = _NmqIv3bz;
        "pkg-1.21.1-2.11.0.8" = _Nx81sxvv;
        "pkg-26.1.2-2.11.0.7" = _15Bem0Bx;
        "pkg-1.21.1-2.11.0.9" = _8wvlkheG;
        "pkg-26.1.2-2.11.0.9" = _Qu6v8ozF;
        "pkg-26.1.2-2.12.0.0" = _Ol6n3Fj2;
        "pkg-1.21.1-2.11.0.10" = _APHSAyfU;
        "pkg-1.21.1-2.12.0.0" = _ElJcztcv;
