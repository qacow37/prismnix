...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.19.3" = _x7I4TrKH;
        "pkg-1.1.0-1.18.2" = _lSAjPTHL;
        "pkg-1.2.0" = _6ZoH69wa;
        "pkg-1.2.0-1.17.1" = _kRDYmhaU;
        "pkg-1.0.0-1.19.3-forge" = _tujSrpKu;
        "pkg-1.0.0-1.18.2-forge" = _vuXAkBNE;
        "pkg-1.0.0-1.19.2-forge" = _c9zRO0ID;
        "pkg-2.0.0-1.19.3" = _5dkn8DH7;
        "pkg-2.0.0-1.18.2" = _uySmkyRa;
        "pkg-2.1.0-1.18.2" = _VJv4YcNr;
        "pkg-2.1.0-1.19.3" = _FumXOcKA;
        "pkg-2.0.0-1.19.3-forge" = _AlcNWZ9G;
        "pkg-2.1.1-1.19.x" = _2lhiZY7B;
        "pkg-2.1.2-1.19.x" = _xHGCOafx;
        "pkg-2.1.1-1.20" = _onB4XAFb;
        "pkg-2.1.2-1.20.x" = _3DPuGeEn;
        "pkg-3.0.0-1.19.x" = _rvUEh58B;
        "pkg-3.0.0-1.20.x" = _Yoe3n7jT;
        "pkg-4.0.0-1.19.2" = _J0jQKNa4;
        "pkg-4.0.0-1.19.4" = _aDPFvExk;
        "pkg-4.0.0-1.20.1" = _8rGyjKDG;
        "pkg-4.0.0-1.20.4" = _g0qyrRoY;
        "pkg-4.1.0-1.20.4" = _4VkUBSXC;
        "pkg-4.1.0-1.20.1" = _rxpO9O9J;
        "pkg-4.1.0-1.19.4" = _NpiaBE7I;
        "pkg-4.1.0-1.19.2" = _iwXgShLf;
        "pkg-4.1.0-1.20.6" = _5QShtnhB;
        "pkg-5.0.0-1.20.1" = _HQt85FTJ;
        "pkg-5.0.0-1.20.4" = _wLU12UdM;
        "pkg-5.0.0-1.20.6" = _j15BP1H1;
        "pkg-5.0.0-1.21" = _NUeXXvnO;
        "pkg-5.0.0-1.21.1" = _3qTKNGHG;
        "pkg-5.1.0-1.21.1" = _WTmB37VN;
        "pkg-5.1.0-1.20.6" = _PdFv9TjJ;
        "pkg-5.1.0-1.20.4" = _JojOrFdH;
        "pkg-5.1.0-1.20.1" = _s5ww6N7E;
        "pkg-5.1.0-1.21.2" = _q9lzr0Dg;
        "pkg-5.1.0-1.21.3" = _wdNh8Gj1;
        "pkg-5.1.0-1.21.6" = _AxpwVnVL;
        "pkg-5.1.1-1.21.6" = _flrUpODZ;
        "pkg-5.1.1-1.21.10" = _w7OaOzm0;
        "default" = _w7OaOzm0;
    });
