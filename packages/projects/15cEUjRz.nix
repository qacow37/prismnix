...
let
    ...
    in {
        ...
        "pkg-1.21.1-0.1.0" = _Ln6wdxk2;
        "pkg-1.21.1-0.1.1" = _mo42LG9i;
        "pkg-1.21.1-0.1.2" = _b8RYYs1H;
        "pkg-1.21.1-0.1.3" = _x1ZsYsTc;
        "pkg-1.21.1-0.1.4" = _L0B6n3ak;
        "pkg-1.21.1-0.2.0" = _rJCIZhpg;
        "pkg-1.21.1-0.3.0" = _I5MsNGTo;
        "pkg-1.21.1-0.3.1" = _lTBnuPym;
        "pkg-1.21.1-0.3.2" = _5kspNpzU;
        "pkg-1.21.1-0.3.3" = _n4Pxgnys;
        "pkg-1.21.1-0.3.4" = _lYak7wJc;
        "pkg-1.21.1-0.4.0" = _uT7ttmhz;
        "pkg-1.21.1-0.4.1" = _b7Jm8HXQ;
        "pkg-1.21.1-0.4.2" = _u82LMHme;
        "pkg-1.21.1-0.4.3" = _KCq1MVNq;
        "pkg-1.21.1-0.4.4" = _yBqvuOe2;
        "pkg-1.21.1-0.4.5" = _9GpdJHsV;
        "pkg-1.21.1-0.4.6" = _6YpzbvY0;
        "pkg-1.21.1-0.4.7" = _C5lsJfCj;
        "pkg-1.21.1-0.4.8" = _X6HrJEog;
        "pkg-1.21.1-0.4.9" = _fUpHDwiK;
        "pkg-1.21.1-0.4.10" = _agSaCybU;
        "pkg-1.21.1-0.5.0" = _kEt8yzA0;
        "pkg-1.21.1-0.5.1" = _LKkuCKKc;
        "pkg-1.21.1-0.5.2" = _AiMFcFD2;
        "pkg-1.21.1-0.6.0" = _mMOozcgA;
        "pkg-1.21.1-0.6.1" = _jI1Gr2m4;
        "pkg-1.21.1-0.6.2" = _63QmRVPl;
        "pkg-1.21.1-0.6.3" = _2cPmGYnN;
        "pkg-1.21.1-0.7.0" = _vkxI6oGI;
        "pkg-1.21.1-0.7.1" = _DH2njHxt;
        "pkg-1.21.1-0.7.2" = _NpQIro75;
        "pkg-1.21.1-0.7.3" = _t6YNI9Hx;
        "pkg-1.21.1-0.8.0" = _ToE42Pdl;
        "pkg-1.21.1-0.8.1" = _EeMIgJ8r;
        "pkg-1.21.1-0.8.2" = _a0pt6gbe;
        "pkg-1.21.1-0.8.3" = _blmd1Ju6;
        "pkg-1.21.1-0.8.4" = _YFEasOvo;
        "pkg-1.21.1-0.9.0-alpha.1" = _tUDExeVe;
        "pkg-0.9.0-alpha.2" = _rwO0YiIN;
        "pkg-0.9.0-alpha.3" = _p5rj3X6E;
        "pkg-1.21.1-0.9.1-fabric" = _oTKFWcWE;
        "pkg-1.21.1-0.9.1-neoforge" = _cqq11QcV;
        "pkg-1.21.1-0.9.2-neoforge" = _HQSe8nyS;
        "pkg-1.21.1-0.9.2-fabric" = _YGBcVZB5;
        "pkg-1.21.1-0.9.3-neoforge" = _cAMmXymD;
        "pkg-1.21.1-0.9.3-fabric" = _ZsiHa0TN;
        "pkg-1.21.1-0.9.4-neoforge" = _pGYf4OZX;
        "pkg-1.21.1-0.9.4-fabric" = _uVC8Dcpn;
        "default" = _uVC8Dcpn;
    });
