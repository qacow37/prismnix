...
let
    ...
    in {
        ...
        "pkg-stale-v1.4.2" = _G2qkSzU9;
        "pkg-stale-v1.4.3" = _2vGBbYcS;
        "pkg-stale-v2.0.0" = _vSVtPRIo;
        "pkg-stale-v2.0.1" = _uMb6tBFU;
        "pkg-1.18-v3.0.0" = _9RwXxUmO;
        "pkg-1.19-v3.0.0" = _QLRgbynH;
        "pkg-1.18-v3.0.1" = _XXIeqV6C;
        "pkg-1.19-v3.0.1" = _iA7BEipT;
        "pkg-1.18-v3.1.1" = _S5crfrQe;
        "pkg-1.19-v3.1.1" = _UTKiEXss;
        "pkg-1.19-v3.2.2" = _5AIg0Vg0;
        "pkg-1.18-v3.1.2" = _MkpTrz2r;
        "pkg-1.19-v3.1.3" = _fl9d4cTO;
        "pkg-1.18-v3.1.3" = _4wuDtGdw;
        "pkg-1.19-v3.2.0" = _VTweMTkn;
        "pkg-1.18-v3.2.0" = _aoZgqvZa;
        "pkg-1.19-v3.2.1" = _SUMKCaw1;
        "pkg-1.18-v3.2.1" = _8p16tupL;
        "pkg-1.18-v3.2.2" = _U0UZvXJS;
        "pkg-1.18-v3.3.0" = _J7mXiQOi;
        "pkg-1.19-v3.3.0" = _Hl9ODLv5;
        "pkg-1.19.4-v4.0.0" = _NIDoTZGB;
        "pkg-1.19.4-v4.0.1" = _FNcNMqzi;
        "pkg-1.19.4-v4.0.3" = _3oYbSIz4;
        "pkg-1.19.4-v4.0.4" = _eT5xFajJ;
        "pkg-1.19.3-v4.0.4-beta" = _ZGk2iPVu;
        "pkg-1.19-v4.0.4-beta" = _ST8BFi10;
        "pkg-1.18-v4.0.4-beta" = _qbeB27l7;
        "pkg-1.19.3-v4.0.4" = _a1hujDpl;
        "pkg-1.19-v4.0.4" = _Qx9Q7SKw;
        "pkg-1.18-v4.0.4" = _Vo8ps72w;
        "pkg-1.20-v4.0.4-beta" = _9iGrkTxV;
        "pkg-1.20-v4.0.4" = _EGffAX7U;
        "pkg-1.18-v4.0.5" = _xFK34zzp;
        "pkg-1.19-v4.0.5" = _LOfLldvt;
        "pkg-1.19.3-v4.0.5" = _855cwqJE;
        "pkg-1.19.4-v4.0.5" = _LEvHiFv3;
        "pkg-1.20-v4.0.5" = _6Nu9nlcX;
        "pkg-fabric-1.18.2-v4.0.6" = _dLMVpDsM;
        "pkg-forge-1.18.2-v4.0.6" = _bh3Eybfu;
        "pkg-fabric-1.19.4-v4.0.6" = _WQdIDmF9;
        "pkg-forge-1.19.4-v4.0.6" = _Bfh5ZwaK;
        "pkg-fabric-1.19.3-v4.0.6" = _eTOxA5Ya;
        "pkg-forge-1.19.3-v4.0.6" = _dynloURO;
        "pkg-fabric-1.19.2-v4.0.6" = _n22wr3hX;
        "pkg-forge-1.19.2-v4.0.6" = _lceUjqoo;
        "pkg-fabric-1.20.1-v4.0.6" = _nZLvFJeq;
        "pkg-forge-1.20.1-v4.0.6" = _4rBI71Gi;
        "pkg-fabric-1.18.2-v4.0.7" = _hLsiOy6A;
        "pkg-forge-1.18.2-v4.0.7" = _f77VYKiL;
        "pkg-fabric-1.19.2-v4.0.7" = _9m7nfYB9;
        "pkg-forge-1.19.2-v4.0.7" = _neAUAqcN;
        "pkg-fabric-1.19.4-v4.0.7" = _pPgxT9pc;
        "pkg-forge-1.19.4-v4.0.7" = _6OLabN5j;
        "pkg-fabric-1.19.3-v4.0.7" = _uibdEaZO;
        "pkg-forge-1.19.3-v4.0.7" = _aOPEzrn9;
        "pkg-fabric-1.20.1-v4.0.7" = _SdgOtszX;
        "pkg-forge-1.20.1-v4.0.7" = _Iswax2DY;
        "pkg-5.0.0-mc1.20" = _M6WhhL3J;
        "pkg-5.0.0-1.20.2-lexforge" = _lmFCE1Yh;
        "pkg-5.0.0-1.20.2-neoforge" = _KU2dhiBs;
        "pkg-5.0.1-1.20.2-lexforge" = _m4wuQoKR;
        "pkg-5.0.1-1.20.2-neoforge" = _gn8ShQQE;
        "pkg-5.0.1-mc1.20" = _lktXjOYP;
        "pkg-6.0.0-mc1.20" = _PVX4rIqU;
        "pkg-6.0.1-mc1.20" = _ZRQr0u0R;
        "pkg-6.0.2-mc1.20" = _zgoFAs1r;
        "pkg-6.0.3-mc1.20-forge" = _mwEHvLZX;
        "pkg-6.0.3-mc1.20.4" = _t094oMJM;
        "pkg-6.1.0-fabric1.20" = _uL5uQolp;
        "pkg-6.1.0-fabric1.20.3" = _eTHk7av5;
        "pkg-6.1.0-neoforge1.20.4" = _lXnNs8Eg;
        "pkg-6.1.0-forge1.20.1" = _wcHeeFrR;
        "pkg-6.2.0-fabric1.21" = _H8XOvQDi;
        "pkg-6.2.0-fabric1.20" = _gtoNK8dP;
        "pkg-6.2.0-fabric1.20.3" = _Gd2TQyB6;
        "pkg-6.2.1-fabric1.21" = _MRY9ox6J;
        "pkg-6.2.1-fabric1.20" = _Zbxi9oxb;
        "pkg-6.2.1-fabric1.20.3" = _FiI0HGH0;
        "pkg-6.2.3-fabric.1.21" = _kjXJWd8H;
        "pkg-6.2.3-fabric.1.20" = _NIkgFllJ;
        "pkg-6.2.3-fabric.1.20.3" = _dyJOXSBK;
        "pkg-6.2.3-neoforge.1.21.1" = _LnGbS0hL;
        "default" = _LnGbS0hL;
    });
