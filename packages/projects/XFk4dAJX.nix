...
let
    ...
    in {
        ...
        "pkg-1.0-1.20-forge" = _UUzcqgtd;
        "pkg-1.0-1.20-fabric" = _zht8hG5L;
        "pkg-1.0-1.20-quilt" = _ZmhcSGs5;
        "pkg-1.0-1.20.2-forge" = _sS47GUoc;
        "pkg-1.0-1.20.2-fabric" = _a1mDx5Em;
        "pkg-1.0-1.20.1-quilt" = _KECGs2sA;
        "pkg-1.0-1.20.1-forge" = _K1788jGu;
        "pkg-1.0-1.20.1-fabric" = _5u5lsFsu;
        "pkg-1.0-1.19.4-quilt" = _BmcFYBFw;
        "pkg-1.0-1.19.4-forge" = _cZf3ubhM;
        "pkg-1.0-1.19.4-fabric" = _dKRkPrf1;
        "pkg-1.0-1.19.3-quilt" = _wc1glQ9F;
        "pkg-1.0-1.19.3-forge" = _eP0ZJ846;
        "pkg-1.0-1.19.3-fabric" = _csdbCnkb;
        "pkg-1.0-1.19.2-fabric" = _Ygw5zbcF;
        "pkg-1.0-1.19.2-forge" = _FqhndMyk;
        "pkg-1.0-1.19.2-quilt" = _PF0F7cG6;
        "pkg-1.1-1.19.3-fabric" = _ujvZczet;
        "pkg-1.1-1.19.3-forge" = _OMkdc8RC;
        "pkg-1.1-1.19.3-quilt" = _HBmXwdoA;
        "pkg-1.1-1.19.4-fabric" = _MjTKARPV;
        "pkg-1.1-1.19.4-forge" = _CIGnby6c;
        "pkg-1.1-1.19.4-quilt" = _yK0ryDpO;
        "pkg-1.1-1.20-fabric" = _tyt6BdMq;
        "pkg-1.1-1.20-forge" = _MQrN0U7g;
        "pkg-1.1-1.20-quilt" = _wy4ryXYn;
        "pkg-1.1-1.20.1-fabric" = _tb1vL8nt;
        "pkg-1.1-1.20.1-forge" = _q5UN6c6o;
        "pkg-1.1-1.20.1-quilt" = _93H2G3MS;
        "pkg-1.1-1.20.2-fabric" = _5A44cM2h;
        "pkg-1.1-1.20.2-forge" = _SxcSaHYo;
        "pkg-1.1-1.20.2-neoforge" = _RuNSfARV;
        "pkg-1.1-1.20.4-fabric" = _hvGDqtNB;
        "pkg-1.1-1.20.4-forge" = _jgEgaCXI;
        "pkg-1.1-1.20.4-neoforge" = _y5aeaLcL;
        "pkg-1.1-1.19.1-fabric" = _jubZWPDe;
        "pkg-1.1-1.19.1-forge" = _n2rPuwRt;
        "pkg-1.1-1.19.1-quilt" = _klSGqcxI;
        "pkg-1.1-1.21-fabric" = _s6A4RVf0;
        "pkg-1.1-1.21-quilt" = _N0YChLQL;
        "pkg-1.1-1.21-forge" = _7dTft6EA;
        "pkg-1.1-1.21-neoforge" = _MMMjP11k;
        "pkg-1.1-1.21.1-fabric" = _ppmtfyDG;
        "pkg-1.1-1.21.1-neoforge" = _NKbtWc8O;
        "pkg-1.1" = _uZYiNHQJ;
        "pkg-2.0.0" = _I09ponNL;
        "default" = _I09ponNL;
    });
