...
let
    ...
    in {
        ...
        "pkg-1.4.4" = _iTD6I6Ed;
        "pkg-1.4.5" = _SxiAveF9;
        "pkg-1.3.12" = _DkMFggNc;
        "pkg-1.4.6" = _10tQdbP9;
        "pkg-1.4.7" = _Sw5iO5kw;
        "pkg-1.4.8" = _6RYNXMDN;
        "pkg-1.4.9" = _exu0aR0O;
        "pkg-1.4.10" = _bCufqzzM;
        "pkg-1.4.11" = _iEhTNXxg;
        "pkg-1.4.12" = _HsOk4roi;
        "pkg-1.4.12-1" = _OulbdMSe;
        "pkg-1.4.13" = _RwyCi1mD;
        "pkg-1.4.14" = _wIoIWRsg;
        "pkg-1.4.15" = _aHaHa2xz;
        "pkg-1.4.16" = _TYYP1RWX;
        "pkg-1.4.17" = _ZTULBwbf;
        "pkg-1.4.18" = _WJSNSxPE;
        "pkg-1.4.19" = _TSdxeNhU;
        "pkg-1.4.20" = _3G8ZawAt;
        "pkg-1.4.21" = _B6KkN9lK;
        "pkg-1.4.22" = _IxMe7sqx;
        "pkg-1.4.23" = _jrIJAads;
        "pkg-1.4.24" = _YRCNCga1;
        "pkg-1.4.25" = _BIM3xvPA;
        "pkg-1.4.26" = _IVgBjB7L;
        "pkg-1.4.27" = _XPGuV4sB;
        "pkg-1.4.28" = _xXv88P3U;
        "pkg-1.4.29" = _CGfV1FJf;
        "pkg-1.4.30" = _bdRdPwLk;
        "pkg-1.4.31" = _geDiTFIm;
        "pkg-1.4.32" = _XwXTv2Qd;
        "pkg-1.4.33" = _j0UhMuoM;
        "pkg-1.4.34" = _JKjZUzrO;
        "pkg-1.4.35" = _ahOz4oRL;
        "pkg-1.4.36" = _HX9jlTpD;
        "pkg-1.4.37" = _I163Yg5i;
        "pkg-1.4.37.1" = _7g8av78y;
        "pkg-1.4.38" = _ZnUrEL2E;
        "pkg-1.4.39" = _WdjalkV8;
        "pkg-1.4.40" = _f2WnLIoU;
        "pkg-1.4.41" = _2I4cH49O;
        "pkg-1.5.0" = _AIbG2E4k;
        "pkg-1.5.1" = _inwgjOIq;
        "pkg-1.5.2" = _QJfHhHfs;
        "pkg-1.5.3" = _BV45cdzS;
