...
let
    ...
    in {
        ...
        "pkg-3.4.2" = _NXPVk0Ym;
        "pkg-3.4.3" = _Hcatfmo7;
        "pkg-4.0.0-neoforge+1.21" = _qXKvk2Wc;
        "pkg-4.0.0-fabric+1.21" = _OKSRpEKZ;
        "pkg-4.0.1-neoforge+1.21" = _zoICew1E;
        "pkg-4.0.1-fabric+1.21" = _zsznAmbR;
        "pkg-4.0.2-neoforge+1.21" = _XdNd7D5g;
        "pkg-4.0.2-fabric+1.21" = _YaYyRqQO;
        "pkg-4.0.3-neoforge+1.21" = _wI8kOCQQ;
        "pkg-4.0.3-fabric+1.21" = _LkCkj7VN;
        "pkg-4.0.4-neoforge+1.21" = _3Ud2rMxo;
        "pkg-4.0.4-fabric+1.21" = _ToqLSCBW;
        "pkg-4.0.5-neoforge+1.21" = _1Jx6yDXi;
        "pkg-4.0.5-fabric+1.21" = _3IlZdaQL;
        "pkg-4.0.6-neoforge+1.21" = _iyahWdbg;
        "pkg-4.0.6-fabric+1.21" = _MKdjRY76;
        "pkg-4.0.7-neoforge+1.21" = _jeNzVPRA;
        "pkg-4.0.7-fabric+1.21" = _H1YKpjvr;
        "pkg-4.0.8-neoforge+1.21" = _WDozS97N;
        "pkg-4.0.8-fabric+1.21" = _aMID6vOn;
        "pkg-5.0.0-neoforge+1.21" = _3kVUcob2;
        "pkg-5.0.0-fabric+1.21" = _NbDq0nWK;
        "pkg-5.0.1-fabric+1.21" = _xUFWApCx;
        "pkg-5.0.1-neoforge+1.21" = _h5Zbk0kV;
        "default" = _h5Zbk0kV;
    });
