...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _bONEDEHN;
        "pkg-1.20.5" = _KEQ0yJFz;
        "pkg-2.0.0" = _XSEk0U3A;
        "pkg-3.0.0" = _OlIwnSWQ;
        "pkg-4.0.0-1.21" = _mwMPnsCJ;
        "pkg-4.0.0-1.21.2" = _1EmaRsnX;
        "pkg-4.0.0-1.21.4" = _ET9bVxI6;
        "pkg-4.0.0-1.21.5" = _xIBaM08c;
        "pkg-4.0.0-1.21.6" = _ZUymV0wz;
        "pkg-4.0.0-1.21.7" = _1jn7jufQ;
        "pkg-4.0.0-1.21.9" = _t7XMUcOQ;
        "pkg-4.0.1-1.21.9" = _Ky1R3Kha;
        "pkg-4.1.0-1.21" = _shtPthEa;
        "pkg-4.1.0-1.21.2" = _hcB9mMiE;
        "pkg-4.1.0-1.21.4" = _RYs861T2;
        "pkg-4.1.0-1.21.5" = _YMJuJIfz;
        "pkg-4.1.0-1.21.6" = _gwXztquE;
        "pkg-4.1.0-1.21.7" = _DSdD2ufx;
        "pkg-4.1.0-1.21.9" = _NzdRz6HV;
        "pkg-4.1.1-1.21" = _vctMalQ7;
        "pkg-4.1.1-1.21.2" = _Dq8ePPdu;
        "pkg-4.1.1-1.21.4" = _Z69XgxQP;
        "pkg-4.1.1-1.21.5" = _IDLbzuAm;
        "pkg-4.1.1-1.21.6" = _rXYxigcV;
        "pkg-4.1.1-1.21.7" = _lHNyy4SF;
        "pkg-4.1.1-1.21.9" = _JwlsnbxL;
        "pkg-4.1.1-1.21.11" = _cPpVs8aF;
        "pkg-4.1.2+1.21.9-1.21.10" = _pMPaMsKe;
        "pkg-4.1.2+1.21.11" = _TceBEtTK;
        "pkg-4.1.3+26.1" = _Xr2MAPK7;
        "pkg-4.1.4+26.1" = _OwomG3tF;
        "pkg-4.1.5+26.1" = _W0TXl31X;
        "pkg-4.1.6+26.1" = _VUpSD2XE;
        "pkg-4.1.7+26.1" = _a6kf4pAQ;
        "pkg-4.1.8+26.1" = _Mp9jTN00;
        "pkg-4.1.8+26.2" = _gG6ArGwZ;
        "default" = _gG6ArGwZ;
    });
