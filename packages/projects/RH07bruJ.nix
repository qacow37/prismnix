...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.8-fabric" = _Ih9djoRd;
        "pkg-1.18.2-1.8-fabric" = _GRgtnAj0;
        "pkg-1.19.2-1.9-fabric" = _m1nKEU1d;
        "pkg-1.16.5-1.3-forge" = _aLa8UuEN;
        "pkg-1.18.2-1.5-forge" = _qh7fkOHX;
        "pkg-1.19.2-1.7-forge" = _Fhqjcc4Q;
        "pkg-1.16.5-2.0-fabric" = _jh4qR3xt;
        "pkg-1.18.2-2.0-fabric" = _RFNIdFlS;
        "pkg-1.19.2-2.0-fabric" = _gQNxQWw5;
        "pkg-1.19.3-2.1-fabric" = _jlGFZCAp;
        "pkg-1.19.3-1.7-forge" = _Z0o6rYCG;
        "pkg-1.18.2-3.0-forge+fabric" = _jhw4MejS;
        "pkg-1.19.2-3.0-forge+fabric" = _9OAwpnUy;
        "pkg-1.19.3-3.0-forge+fabric" = _Wt1z7Tws;
        "pkg-1.19.4-3.0-forge+fabric" = _Go2zq1D1;
        "pkg-1.20-3.0-forge+fabric" = _oYQWLimL;
        "pkg-1.20.1-3.0-forge+fabric" = _wXuJ312Q;
        "pkg-1.20.2-3.0-forge+fabric" = _ZyKe9STj;
        "pkg-1.18.2-3.1-forge+fabric" = _Hv2qOJHQ;
        "pkg-1.19.2-3.1-forge+fabric" = _uWlNcqFy;
        "pkg-1.20.1-3.1-forge+fabric" = _sXiidsbG;
        "pkg-1.20.2-3.1-forge+fabric" = _jm7ioyHy;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _pobIeJRB;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _5lXVdk70;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _xTugRJ4q;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _QLoXqk9M;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _ZVjpIAp0;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _DyJQ8zLh;
        "pkg-1.20.5-3.2-fabric+neo" = _UT1Iibzn;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _KvR41bAY;
        "pkg-1.21.0-3.2-fabric+forge+neo" = _JMmwinIU;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _x5Ec2HLD;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _KG0J4GK6;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _BjKm1yF5;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _f9XThotF;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _HS0WinMj;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _lNzRHY8Y;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _mp7mElkI;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _j8zZ95IU;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _IttQvcU2;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _uJ47QbXb;
        "pkg-1.21.2-3.5-fabric+neo" = _q5WKyT8G;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _pFxNm4rZ;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _C0Kogu6e;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _QDsyEw7v;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _BicQoVZF;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _VYgtPoUW;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _2xs0HJ2g;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _2RaxuwB8;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _6zCvH3MH;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _CLzxDzaY;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _PGkylW3Z;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _3Habvqlq;
        "pkg-26.1.1-3.6-fabric+forge+neo" = _gonL8jpp;
        "pkg-26.1.2-3.6-fabric+forge+neo" = _6kPADnrD;
        "pkg-26.2.0-3.6-fabric+forge+neo" = _mxvT29TY;
        "default" = _mxvT29TY;
    });
