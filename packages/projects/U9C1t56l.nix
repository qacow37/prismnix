...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.1.4" = _9va2uLQ8;
        "pkg-1.19.4-1.1.4" = _Z0vptbQ7;
        "pkg-1.20.1-1.1.4" = _hij0T6Ab;
        "pkg-1.20.2-1.1.4" = _4qdJvcDU;
        "pkg-1.20.2-1.1.5" = _B5yMQptZ;
        "pkg-1.20.1-1.1.5" = _XUEArIkY;
        "pkg-1.19.4-1.1.5" = _1RjPyZR8;
        "pkg-1.19.2-1.1.5" = _OQEMAU9W;
        "pkg-1.20.1-1.1.8" = _3b7TsxIk;
        "pkg-1.19.2-1.1.8" = _XXNbrcne;
        "pkg-1.19.4-1.1.8" = _1afIWScj;
        "pkg-1.20.2-1.1.8" = _ycSbBrtX;
        "pkg-1.19.2-1.1.9.1" = _dQ4LMG6p;
        "pkg-1.19.4-1.1.9.1" = _EivAjgSr;
        "pkg-1.20.1-1.1.9.1" = _DWQhxk3L;
        "pkg-1.20.2-1.1.9.1" = _uCICSYYE;
        "pkg-1.19.2-1.1.9.2" = _Q5x5pkon;
        "pkg-1.19.4-1.1.9.2" = _N96QyE7q;
        "pkg-1.20.1-1.1.9.2" = _NIMyNm0g;
        "pkg-1.20.2-1.1.9.2" = _J9SrNJRD;
        "pkg-1.19.2-1.2" = _8FlsNIBB;
        "pkg-1.19.4-1.2" = _2sxpezqW;
        "pkg-1.20.1-1.2" = _VDrQtVU9;
        "pkg-1.20.2-1.2" = _K5ugbkch;
        "pkg-1.19.2-2.0" = _1oUfwTEH;
        "pkg-1.19.4-2.0" = _AcNiHtqg;
        "pkg-1.20.1-2.0" = _Go4LV7BC;
        "pkg-1.20.2-2.0" = _KeADJByY;
        "pkg-1.19.2-2.1" = _JK2FlXFQ;
        "pkg-1.19.4-2.1" = _bY308ZoS;
        "pkg-1.20.1-2.1" = _mGoCFcTQ;
        "pkg-1.20.2-2.1" = _AaLdWYre;
        "pkg-1.21-2.1" = _vSgsSZQ3;
        "pkg-1.20.1-2.2.9.2" = _3iGoHYyJ;
        "pkg-1.20.1-2.3" = _sm1sP3Jt;
