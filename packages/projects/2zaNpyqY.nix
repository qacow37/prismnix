...
let
    ...
    in {
        ...
        "pkg-1.2.8" = _H12eV2Zn;
        "pkg-1.2.9" = _1E9p3klr;
        "pkg-1.2.10" = _n1ypDILX;
        "pkg-1.2.11" = _rTX5Rqpw;
        "pkg-1.2.12" = _Z9SHvWpP;
        "pkg-1.3.0" = _M8qcK7aG;
        "pkg-1.4.0" = _Bum5CdKz;
        "pkg-a1.4.0" = _sb7QHUc4;
        "pkg-a2-1.4.0" = _SKJFGjsw;
        "pkg-1.4.1" = _1CwznCqt;
        "pkg-1.4.2" = _x6tQeT7e;
        "pkg-1.4.4" = _zKnIRPTR;
        "pkg-1.5.0" = _n0OsI1Mb;
        "pkg-1.5.0-1.21.1" = _1BAnmrLl;
        "pkg-1.5.0-1.21" = _6fLEaBd6;
        "pkg-1.6.0" = _s87DwkeU;
        "pkg-1.6.1" = _etJu4Mxy;
        "pkg-1.6.2" = _IxrvrR5m;
        "pkg-1.7.0" = _7wQw3fIB;
        "pkg-1.7.1" = _JtxDTlka;
        "pkg-2.0.0-alpha" = _d6dUwu8q;
        "pkg-2.0.1-alpha" = _MZBtsUHw;
        "pkg-2.0.2-alpha" = _cQXklRhy;
        "pkg-2.0.3-alpha" = _G1E8GFjV;
        "pkg-2.0.4-alpha" = _U6F3fTGf;
        "pkg-2.0.5-beta" = _b4Zyz0Mf;
        "pkg-2.0.6-beta" = _XonGFYL4;
        "pkg-2.0.7-beta" = _2a872HAj;
        "pkg-2.0.8-beta" = _lJ5Qauso;
        "pkg-2.0.9-beta" = _QF5z82hl;
        "pkg-2.0.10-beta" = _cxEKm0sc;
        "pkg-2.0.11-beta" = _Y8N7mAno;
        "pkg-2.0.12-beta" = _lT5UdMpf;
        "pkg-2.0.15-alpha" = _c5Vy2UDo;
        "pkg-2.0.13-beta" = _CCCpQYZS;
        "pkg-2.0.16-alpha" = _ftQGqJmM;
        "pkg-2.0.17-alpha" = _Svml79Hm;
        "pkg-2.0.18-beta" = _Xl3H0Ply;
        "pkg-2.0.19-beta" = _3L38McaY;
        "pkg-2.1.0" = _8DSFYUSS;
        "pkg-2.1.1" = _HsPkf0qf;
        "pkg-2.1.2" = _FGjHA9KH;
        "pkg-2.1.3" = _z3qjoPQY;
