...
let
    ...
    in {
        ...
        "pkg-1.0-1.20.1" = _wm5ZCTPr;
        "pkg-1.0-1.20.2" = _h2lBIA8o;
        "pkg-1.1-1.20.2" = _KU5b51N0;
        "pkg-1.1-1.20.1" = _uhRKYFjn;
        "pkg-1.2-1.20.1" = _lD41LrDa;
        "pkg-1.2-1.20.2" = _TzzhEhAl;
        "pkg-1.2-1.20.4" = _Dvc8f2Ij;
        "pkg-1.3-1.21.8" = _LF4pypAJ;
