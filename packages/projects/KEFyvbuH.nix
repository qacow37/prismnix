...
let
    ...
    in {
        ...
        "pkg-1.3.2" = _wQD5K1QL;
        "pkg-1.3.3" = _bKNolcQw;
        "pkg-1.3.3+1.18.1" = _9PKkmHwY;
        "pkg-1.4.0" = _IbATUd0j;
        "pkg-1.4.1" = _aluQWhgD;
        "pkg-1.4.2" = _SCfBIlNo;
        "pkg-1.4.3+1.18.1" = _ISC2s9qt;
        "pkg-1.4.3" = _c3QvE50z;
        "pkg-1.4.4+1.18.1" = _wuLALckU;
        "pkg-1.4.4+1.18.2" = _9nC8gjXy;
        "pkg-1.4.6+1.18.2" = _VsImNAWX;
        "pkg-1.5.0+mc1.18.2" = _V4Y8rqJQ;
        "pkg-1.5.0+mc1.19" = _TDZlmLzu;
        "pkg-1.5.0+mc1.19.1" = _LjjSy38y;
        "pkg-2.0.0+mc1.19.2" = _HJnW98BB;
        "pkg-2.0.0+mc1.18.2" = _swU8yX5T;
        "pkg-2.0.1+mc1.19.2" = _qqDRrXCY;
        "pkg-2.0.1+mc1.18.2" = _1auweZWd;
        "pkg-2.0.2+mc1.18.2" = _O8noC8R5;
        "pkg-2.0.2+mc1.19.2" = _KNMxBuGm;
        "pkg-2.0.3+mc1.18.2" = _Z8mmDDDt;
        "pkg-2.0.3+mc1.19.2" = _1LoLWcZS;
        "pkg-2.0.4+mc1.18.2" = _rxbCNGRw;
        "pkg-2.0.4+mc1.19.2" = _yMILv9Qf;
        "pkg-2.0.5+mc1.18.2" = _XB1vJIea;
        "pkg-2.0.5+mc1.19.2" = _tntZQDpY;
        "pkg-2.0.6+mc1.18.2" = _FJYrRyTg;
        "pkg-2.0.6+mc1.19.2" = _YQgCwaMR;
        "pkg-2.0.7+mc1.18.2" = _Dg9jmobb;
        "pkg-2.0.7+mc1.19.2" = _sX96csRm;
        "pkg-2.0.8+mc1.18.2" = _xT8mOgyQ;
        "pkg-2.1.0+mc1.19.3" = _Obx7HWK2;
        "pkg-2.1.1+mc1.18.2" = _WkK5wXJL;
        "pkg-2.1.1+mc1.19.3" = _BtDeXMAh;
        "pkg-2.1.1+mc1.19.4" = _sEfMDbfL;
        "pkg-2.1.1+mc1.20.1" = _gMpDeb8i;
        "pkg-2.1.1+mc1.20.2" = _EgoQu3dI;
        "pkg-2.1.2+mc1.21" = _IBOfRJPO;
        "pkg-2.1.3+mc1.21" = _vNEaHOJc;
        "pkg-2.1.4+mc1.21.1" = _RA2zOJ5S;
        "default" = _RA2zOJ5S;
    });
