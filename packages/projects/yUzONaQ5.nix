...
let
    ...
    in {
        ...
        "pkg-7.4.1.0" = _AYkJ0a7G;
        "pkg-8.0.0.0" = _DuU3cfjB;
        "pkg-8.2.0.0" = _QoaVOBoP;
        "pkg-8.3.0.0" = _gmJDYEbG;
        "pkg-8.4.1.0" = _TM3lyAld;
        "pkg-8.5.0.0" = _CkEhvRvb;
        "pkg-8.5.20.0" = _PqhL2H2v;
        "pkg-8.5.40.0" = _6B8X7HYv;
        "pkg-7.5.0.0" = _Db6EKT3b;
        "pkg-8.6.0.0" = _GFDUKuE1;
        "pkg-8.6.0.10" = _i2jJT1gj;
        "pkg-8.7.0.0" = _FpyQo36a;
        "pkg-8.8.0.0" = _Px3QmgUx;
        "pkg-8.8.5.0" = _BjoeMQxw;
        "pkg-8.8.15.0" = _QJWChejG;
        "pkg-8.9.0.0" = _U0yvbW2X;
        "pkg-8.9.20.0" = _kidmCm3k;
        "pkg-8.10.0.0" = _XF9pFrjl;
        "pkg-8.10.14.0" = _Xl6nkf1k;
        "pkg-8.10.21.0" = _buXHVqt7;
        "pkg-8.11.0.0" = _gNlX6w75;
        "pkg-8.11.4.0" = _JWMzDCTZ;
        "pkg-8.11.6.0" = _vuoyWSsY;
        "pkg-8.11.7.0" = _Ww6rfpXA;
        "pkg-8.11.10.0" = _IC2ebTCq;
        "pkg-8.12.0.0" = _KWwS5emw;
        "pkg-8.13.0.0" = _BdBmpa8F;
        "default" = _BdBmpa8F;
    });
