...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta.4" = _N59NJiRE;
        "pkg-1.0.0-beta.5-mc26.1.2" = _6DPq9z2l;
        "pkg-1.0.0-beta.5-mc1.21.11" = _qtnjQNF9;
        "pkg-1.0.0-beta.5-mc1.21.10" = _AwFTsnXO;
        "pkg-1.0.0-beta.5-mc1.21.8" = _DhQE0Rfj;
        "pkg-1.0.0-beta.5-mc1.21.5" = _BI2Rv6lx;
        "pkg-1.0.0-beta.5-mc1.21.4" = _AvofJlCl;
        "pkg-1.0.0-beta.5-mc1.21.3" = _giYvMVlP;
        "pkg-1.0.0-beta.5-mc1.21.1" = _7WEO47pF;
        "pkg-1.0.0-beta.5-mc1.20.4" = _YNWaSQWJ;
        "pkg-1.0.0-beta.5-mc1.20.1" = _xMnnl1Cj;
        "pkg-1.0.0-alpha.5.0-mc26.2" = _NKlyBDxS;
        "pkg-1.0.0-beta.6-mc1.21.11" = _qq2pnv8s;
        "pkg-1.0.0-beta.6-mc1.21.5" = _uEEfusud;
        "pkg-1.0.0-beta.6-mc1.21" = _DpwPlDt9;
        "pkg-1.0.0-beta.6-mc26.1" = _XPYIRuNg;
        "pkg-1.0.0-beta.6-mc26.2" = _qixWPHH2;
        "pkg-1.0.0-beta.6-mc1.20.3" = _L2w5b5Dq;
        "pkg-1.0.0-beta.6-mc1.20" = _fxv3hgFD;
        "pkg-1.0.0-beta.6-mc1.21.9" = _WW3N3rWR;
        "pkg-1.0.0-beta.6-mc1.21.6" = _EGq0wQ31;
        "pkg-1.0.0-beta.6-mc1.21.4" = _nMZWYCtB;
        "pkg-1.0.0-beta.6-mc1.21.2" = _jSwSHilh;
        "pkg-1.0.0-beta.7-mc26.2" = _QYbyi2Mh;
        "pkg-1.0.0-beta.7-mc26.1" = _DaKZ80SD;
        "pkg-1.0.0-beta.7-mc1.21.11" = _bVgPptUy;
        "pkg-1.0.0-beta.7-mc1.21.5" = _fUnx66sl;
