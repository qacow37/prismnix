...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.20.1" = _tz3PZSPN;
        "pkg-1.0.2-fix-1.20.1" = _N3GnU6Ep;
        "pkg-1.0.3-1.20.1" = _WvDG1LKD;
        "pkg-1.0.3-fix-1.20.1" = _HgnH0FQ8;
        "pkg-1.0.4-1.20.1" = _qAJyWhcq;
        "pkg-1.0.5-1.20.1" = _959c534W;
        "pkg-1.0.6-1.20.1" = _iUhlbRzW;
        "pkg-1.0.6-fix-1.20.1" = _iIMHCspO;
        "pkg-1.0.1-1.21.1" = _PBaWOMoK;
        "pkg-1.0.2-1.21.1" = _rbH2kgU9;
        "pkg-1.0.6-fix2-1.20.1" = _JHSKm7Wv;
        "pkg-1.0.4-1.21.1" = _tKtUblFZ;
        "pkg-1.0.7-1.20.1" = _XOy50W5l;
        "pkg-1.0.4-fix-1.21.1" = _YGinNVkI;
        "pkg-1.1.0-beta-1.20.1" = _q6I8UgAw;
        "pkg-1.0.5-1.21.1" = _i7Io2ySz;
        "pkg-1.0.5-fix-1.21.1" = _Jjgkma3Q;
        "pkg-1.1.2-forge+mc1.20.1" = _EijTbt6m;
        "pkg-1.0.6-neoforge+mc1.21.1" = _pAMElErn;
        "pkg-1.1.3-forge+mc1.20.1" = _Si8gqHM6;
        "pkg-1.0.7-neoforge+mc1.21.1" = _FAu7FKJZ;
        "pkg-1.1.4-forge+mc1.20.1" = _5BzbjXtb;
        "pkg-1.1.5-forge+mc1.20.1" = _LWvEUtnZ;
        "pkg-1.1.6-forge+mc1.20.1" = _5eSrDGQV;
        "pkg-1.0.8-neoforge+mc1.21.1" = _lMoWM4sH;
        "pkg-1.0.9-neoforge+mc1.21.1" = _CE5OGdp2;
        "pkg-1.1.7-forge+mc1.20.1" = _mNt9lEae;
        "pkg-1.1.0-neoforge+mc1.21.1" = _4MhLLu9x;
        "pkg-1.1.1-neoforge+mc1.21.1" = _wTsbWt17;
        "pkg-1.1.2-neoforge+mc1.21.1" = _PpoOMArg;
        "pkg-1.1.8-forge+mc1.20.1" = _kn43NNqm;
        "pkg-1.1.4-neoforge+mc1.21.1" = _Xk6e2JID;
        "default" = _Xk6e2JID;
    });
