...
let
    ...
    in {
        ...
        "pkg-1.21-1.21.1_1.0.0" = _vFTXb2J5;
        "pkg-1.21.4_1.0.0" = _vqEhe1GQ;
        "pkg-1.21.4_1.1.0" = _9tNKFdrt;
        "pkg-1.21-1.21.2_1.1.0" = _isjhDCWN;
        "pkg-1.1.0" = _WClGeOoP;
        "pkg-1.1.0+1.21.6" = _qQW9aNed;
        "pkg-1.1.0+1.21.9" = _6j1SjQhR;
        "default" = _6j1SjQhR;
    });
