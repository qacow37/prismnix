...
let
    ...
    in {
        ...
        "pkg-1.6.2" = _HMGYFN4F;
        "pkg-1.6.3" = _YXh1eV8O;
        "pkg-1.7.0-beta.1+1.6.0" = _ST8hlkDz;
        "pkg-1.7.0+1.5.2" = _uPBaCB61;
        "pkg-1.7.0+1.6.0" = _TRWuydOM;
        "pkg-1.8.0+1.5.2" = _7KMkOokH;
        "pkg-1.8.0+1.6.1" = _uMF4Y3qe;
        "pkg-1.8.1+1.5.2" = _KfeGcQox;
        "pkg-1.8.1+1.6.1" = _Boart2Le;
        "pkg-1.8.1+1.7.0" = _JMVpUk7J;
        "pkg-1.8.1+1.7.1" = _ccxRBh2B;
        "pkg-1.9.0+1.20.1" = _LqviqM37;
        "pkg-1.9.0+1.21.1" = _449QExoH;
        "default" = _449QExoH;
    });
