...
let
    ...
    in {
        ...
        "pkg-1.0-1.21.6" = _XQ38h7wH;
        "pkg-1.0-1.21.7" = _ZEM5dqFt;
        "pkg-1.0-1.21.8" = _jbxKHcX7;
        "pkg-1.1-1.20.1" = _CdtW8jbT;
        "pkg-1.1-1.20.2" = _3cOzYggy;
        "pkg-1.1-1.20.3" = _yI7yWWiA;
        "pkg-1.1-1.20.4" = _lAvosGqY;
        "pkg-1.1-1.20.5" = _Z8lEkZY0;
        "pkg-1.1-1.20.6" = _TnxbVgK4;
        "pkg-1.1-1.21" = _DmkoXSlk;
        "pkg-1.1-1.21.1" = _jeu5CxGH;
        "pkg-1.1-1.21.2" = _fSJCR3i3;
        "pkg-1.1-1.21.3" = _RhvVo9LU;
        "pkg-1.1-1.21.4" = _mtJvSoSQ;
        "pkg-1.1-1.21.5" = _a9KRPFUw;
        "pkg-1.1-1.21.6" = _nTwHrGUq;
        "pkg-1.1-1.21.7" = _Ut8wbhVy;
        "pkg-1.1-1.21.8" = _9qPjiRaa;
        "pkg-1.2-1.20.1" = _mVH9rHMa;
        "pkg-1.2-1.20.2" = _WWv2gMJW;
        "pkg-1.2-1.20.3" = _9qCc5JdP;
        "pkg-1.2-1.20.4" = _broe6nDN;
        "pkg-1.2-1.20.5" = _ESyXmumu;
        "pkg-1.2-1.20.6" = _ihOJkK4C;
        "pkg-1.2-1.21" = _BzTslgPA;
        "pkg-1.2-1.21.1" = _YDoK4prk;
        "pkg-1.2-1.21.2" = _e92fpF5x;
        "pkg-1.2-1.21.3" = _dVOr2JBj;
        "pkg-1.2-1.21.4" = _djqfAhAV;
        "pkg-1.2-1.21.5" = _LYxIZD5E;
        "pkg-1.2-1.21.6" = _5IAWlhgO;
        "pkg-1.2-1.21.7" = _dZ81XrxD;
        "pkg-1.2-1.21.8" = _1P5l1j0z;
        "pkg-1.2-1.21.9" = _Vo3SoQUB;
        "pkg-1.2-1.21.10" = _L5U8bRuT;
        "pkg-1.2-1.21.11" = _FgqCd5dj;
        "default" = _FgqCd5dj;
    });
