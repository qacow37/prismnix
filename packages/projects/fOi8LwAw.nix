...
let
    ...
    in {
        ...
        "pkg-1.0" = _Rlxd27fl;
        "pkg-1.0_mod" = _wbp5A6h3;
        "pkg-1.1" = _BOgvrhNm;
        "pkg-1.2" = _udq0yh48;
        "pkg-1.2+mod" = _V9iwm162;
        "pkg-1.3" = _DHnKgewt;
        "pkg-1.3+mod" = _jOSwgt25;
        "pkg-2.0" = _vqECmgn9;
        "pkg-2.0+mod" = _GM6YHULh;
        "pkg-3.0" = _XPs07WWe;
        "pkg-3.0+mod" = _z2yhj6EB;
        "pkg-3.1" = _tjL7llkz;
        "pkg-4.0" = _ejKp87H7;
        "pkg-4.0+mod" = _rGQuVaFY;
        "pkg-4.1" = _FWJjKYoR;
        "pkg-4.1+mod" = _BzFU4irP;
        "pkg-4.2" = _6uUAhfLj;
        "pkg-4.2+mod" = _Qo3jOkG8;
        "pkg-4.3" = _aASxCgyf;
        "pkg-4.3+mod" = _hRw6na2g;
        "pkg-4.4" = _mpO0vF9A;
        "pkg-4.4+mod" = _wv9eN0fi;
        "pkg-4.5" = _A7nQHlQv;
        "pkg-4.5+mod" = _v59ujo9q;
        "pkg-4.6" = _mFfWv8d6;
        "pkg-4.6+mod" = _VsHYuZlJ;
        "pkg-4.7" = _OdcyrUJj;
        "pkg-4.7-fabric" = _1BN8emvr;
        "pkg-4.7-forge" = _MCcc491d;
        "pkg-4.8" = _LESMR4fU;
        "pkg-4.8-fabric" = _ruZY2JqK;
        "pkg-4.8-forge" = _ahaQb7Zi;
        "pkg-4.12" = _e03LQQVy;
        "pkg-4.12-fabric" = _sLwrqZax;
        "pkg-4.12-quilt" = _kdXBvdxD;
        "pkg-4.12-forge" = _pravk4of;
        "pkg-4.12-neoforge" = _dXEd6LxL;
        "pkg-4.13" = _ChjutDsP;
        "pkg-4.13-fabric" = _6QWPIHXw;
        "pkg-4.13-quilt" = _ox4hFiyY;
        "pkg-4.13-forge" = _l9x8nosY;
        "pkg-4.13-neoforge" = _Yc5K6tKT;
        "default" = _Yc5K6tKT;
    });
