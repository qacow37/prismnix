...
let
    ...
    in {
        ...
        "pkg-v.2.0.0+mod" = _r56ceiXa;
        "pkg-v.2.0.1" = _iweK11G2;
        "pkg-v.2.0.1+mod" = _m3DmpX6K;
        "pkg-v.2.1.1" = _UYHuJm8P;
        "pkg-v.2.1.1+mod" = _5heHjkB2;
        "pkg-v.1.0.1" = _YjE7bi7B;
        "pkg-v.1.0.1+mod" = _JR4cClP9;
        "pkg-v.2.1.2" = _aiMcDhFT;
        "pkg-v.2.1.2+mod" = _1yDmKKJO;
        "pkg-v.2.1.3" = _Lwg6ww7o;
        "pkg-v.2.1.3+mod" = _udl0RiUn;
        "pkg-v.2.1.4" = _xIPG3BIR;
        "pkg-v.2.1.4+mod" = _fdD8i8Dk;
        "pkg-v.2.1.5" = _XkX4xcMb;
        "pkg-v.2.1.5+mod" = _cULeCu6J;
        "pkg-1.1.0" = _pfR7OkJX;
        "pkg-1.1.0+mod" = _OLfh0Lnc;
        "pkg-v.2.6.1" = _QMhAKA3t;
        "pkg-v.2.6.1+mod" = _yfNDE5BC;
        "pkg-v.1.1.1" = _aSfhcuDt;
        "pkg-v.1.1.1+mod" = _6u9bkKZt;
        "pkg-v.2.1.0" = _KjGA0W4Z;
        "pkg-v.2.1.0+mod" = _f2SvPvWY;
        "pkg-v2.0.0" = _BDxQFOpz;
        "pkg-v2.0.0+mod" = _lOypb5bg;
        "pkg-v2.1.0" = _XdxebXXk;
        "pkg-v2.1.0+mod" = _vUsGSaRW;
        "pkg-v2.2.0" = _xcg4UfjP;
        "pkg-v2.2.0+mod" = _ONKPWiqA;
        "pkg-v2.3.0" = _6p9lxcny;
        "pkg-v2.3.0+mod" = _5MZ8Pz8H;
        "pkg-v2.3.1" = _xiJw2pSB;
        "pkg-v2.3.1+mod" = _fsCMsZNO;
        "pkg-v2.3.2-mc1.21.6+" = _RULgVFix;
        "pkg-v2.3.2-mc1.21.6++mod" = _35bVbYq2;
        "pkg-v2.3.3" = _tLkQehpQ;
        "pkg-v2.3.3+mod" = _ytg2naUg;
        "pkg-v2.3.3.1" = _TfWq23F0;
