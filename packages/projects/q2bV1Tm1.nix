...
let
    ...
    in {
        ...
        "pkg-1.0.5" = _4Ozy52f7;
        "pkg-1.0.6" = _Ku3gKcHE;
        "pkg-1.0.6.1" = _nNSh5zwP;
        "pkg-1.0.6.2" = _BBVv9b7n;
        "pkg-1.0.7" = _CWgP9Gtw;
        "pkg-1.0.7.2" = _Xnlqy8mV;
        "pkg-1.0.8" = _JPhS0r4U;
        "pkg-1.0.9" = _ibfdrOaT;
        "pkg-1.0.9.1" = _XwJrNVqb;
        "pkg-1.0.9.2.b" = _pwPCK6tY;
        "pkg-2.0.0" = _5XENWqz3;
        "pkg-2.0.1" = _HNfuXpga;
        "pkg-2.0.2" = _x6HC0WNa;
        "pkg-2.0.3" = _GiXG7poI;
        "pkg-2.0.3a" = _ORUs0zGT;
        "pkg-2.0.4" = _KvIIbg6A;
        "pkg-2.0.5" = _Vsg3i9f5;
        "pkg-2.0.6" = _cEJIcoBG;
        "pkg-2.0.7" = _6X9JbANZ;
        "pkg-2.0.8" = _bwmCG759;
        "pkg-2.0.9" = _dfs3DNYm;
        "pkg-2.0.10" = _atCX8RAe;
        "pkg-2.0.11" = _wpeymTE7;
        "pkg-2.0.12" = _ac2ec3Mz;
        "pkg-2.0.13" = _r4Y3IifM;
        "pkg-2.1.0" = _se23TKwn;
        "pkg-2.1.1" = _FQB6F9rj;
        "pkg-2.1.2" = _lE9PF6Wp;
        "default" = _lE9PF6Wp;
