...
let
    ...
    in {
        ...
        "pkg-1.8.5+1.19.2" = _ed79HiWB;
        "pkg-1.8.6+1.19.2" = _s3YC542U;
        "pkg-1.8.6+1.19.4" = _ACzqsFJ4;
        "pkg-1.8.7+1.19.2" = _Gmb5gMTs;
        "pkg-1.8.7+1.19.4" = _HfCy3P2g;
        "pkg-1.8.8+1.19.2" = _OVHSTVqs;
        "pkg-1.8.8+1.19.4" = _yD4snRp7;
        "pkg-1.8.9+1.19.4" = _paOphkzV;
        "pkg-1.8.10+1.19.2" = _DskGHcKe;
        "pkg-1.8.10+1.19.4" = _lck7k1um;
        "pkg-1.9+1.20.1" = _7j2T3UyX;
        "pkg-1.9.1+1.20.1" = _jQsNDhGi;
        "pkg-1.9.2+1.20.2" = _xQMRQsL1;
        "pkg-1.9.3+1.20.4" = _uMjhede7;
        "pkg-1.9.2+1.20.1" = _I2VLRFTp;
        "pkg-1.9.3+1.20.2" = _yYXDViUf;
        "pkg-1.9.3+1.20.1" = _Hd71R2sk;
        "pkg-1.9.4+1.20.4" = _EHTOlWy7;
        "pkg-1.9.4+1.20.1" = _YDl7nsUn;
        "pkg-1.9.5+1.20.2" = _6BTLudqJ;
        "pkg-1.9.5+1.20.4" = _TOWx1q0p;
        "pkg-1.9.6+1.20.4" = _LFQJhaws;
        "pkg-1.9.6+1.20.2" = _rsXVhDbL;
        "pkg-1.9.5+1.20.1" = _WrlCpfJI;
        "pkg-1.9.7+1.20.5" = _DAYg7IPC;
        "pkg-1.9.8+1.20.6" = _BJLei4Gz;
        "pkg-1.9.9+1.20.6" = _An7vTcMA;
        "pkg-1.9.10+1.20.6" = _pvZzfwmo;
        "pkg-1.9.11+1.20.6" = _MsCDfkrs;
        "pkg-1.10.0+1.21" = _DDAeR2nn;
        "pkg-1.10.1+1.21" = _Zduw8zDo;
        "pkg-1.10.2+1.21.3" = _KJUspiqE;
        "pkg-1.10.2+1.21.4" = _xD3CbWpV;
        "pkg-1.10.3+1.21.5" = _lfxcuol1;
        "pkg-1.10.4+1.21.5" = _sgFFnQaf;
        "pkg-1.10.5+1.21.8" = _9cmnfp8s;
        "pkg-1.10.6+1.21.8" = _uUylvtGL;
        "pkg-1.10.6+1.21.6" = _Na62uR6X;
        "pkg-1.10.7+1.21.8" = _8x9Hjjmh;
        "pkg-2.0.0+1.21.8" = _YFEN1rlT;
        "pkg-2.0.1+1.21.8" = _58d4meVm;
        "pkg-2.1.0+1.21.10" = _uxrph0Lm;
        "pkg-2.1.1+1.21.10" = _JvXTS1IC;
        "pkg-2.0.2+1.21.8" = _nKwKiwIR;
        "pkg-2.1.2+1.21.10" = _Uqx8rrwk;
        "pkg-2.2.0+1.21.11" = _EN5PLDuT;
        "pkg-2.1.3+1.21.10" = _dkuZqHKf;
        "pkg-2.2.1+1.21.11" = _W3bxTEIQ;
        "pkg-2.1.4+1.21.10" = _cX1JLUc4;
        "pkg-2.2.2+1.21.11" = _8a1FaBBb;
        "pkg-2.1.5+1.21.10" = _sLUVMfpP;
        "pkg-2.2.3+1.21.11" = _hr0JRw2d;
        "pkg-2.3.0+26.1" = _UadVpO0G;
        "pkg-2.1.6+1.21.10" = _x6GdNnCd;
