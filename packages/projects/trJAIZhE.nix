...
let
    ...
    in {
        ...
        "pkg-8.0.2" = _S6SJ2RQb;
        "pkg-9.0.1" = _RksFoiy1;
        "pkg-10.0.1" = _im5rMK5F;
        "pkg-10.0.2" = _YwBS8aC5;
        "pkg-10.0.3" = _yaUeIP1N;
        "pkg-10.0.4" = _7H4nw1sS;
        "pkg-21.1.1" = _X1kuIngU;
        "pkg-21.1.2" = _84vUMebx;
        "pkg-10.0.5" = _rL9kKqMo;
        "pkg-21.1.3" = _I220wmm9;
        "pkg-7.0.3" = _hELAojWZ;
        "pkg-26.1.2.2" = _rmPsWqSU;
        "pkg-26.1.2.3" = _6yBBQFzr;
