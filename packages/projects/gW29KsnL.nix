...
let
    ...
    in {
        ...
        "pkg-1.4.6-mc1.21" = _Ot6dbUYm;
        "pkg-1.4.7-mc1.21.1" = _QKCrgBYm;
        "pkg-1.4.8-mc1.21.1" = _IbzzEGlv;
        "pkg-1.4.9-mc1.20.6" = _5UlFCLbl;
        "pkg-1.4.9-mc1.21.2" = _2xakrmHu;
        "pkg-1.4.9-mc1.21.3" = _oPV7qsy2;
        "pkg-1.4.9-mc1.21.4" = _Bm5LDXmq;
        "pkg-1.4.10-mc1.20.5" = _21WhIMbl;
        "pkg-1.4.10-mc1.20.6" = _OEJXwWw4;
        "pkg-1.4.10-mc1.21.2" = _Ot3G9c5P;
        "pkg-1.4.10-mc1.21.3" = _N5imXVNo;
        "pkg-1.4.10-mc1.21.4" = _pIEcP51X;
        "pkg-1.4.11-mc1.20.6" = _g1EJ30Lc;
        "pkg-1.4.11-mc1.21.5" = _5JFRioay;
        "pkg-1.4.11-mc1.21.6" = _JANAkeI4;
        "pkg-1.4.11-mc1.21.7" = _a8MGp9rE;
        "pkg-1.4.11-mc1.21.8" = _79PNDape;
        "pkg-1.4.11-mc1.21.9" = _EeVNw2gz;
        "pkg-1.4.11-mc1.21.10" = _wuTOdm6S;
        "pkg-1.4.12-mc1.20.6" = _4SovPMmF;
        "pkg-1.4.12-mc1.21.10" = _ddzOMsQW;
        "pkg-1.4.13-mc1.21.10" = _JxwWCUN9;
        "pkg-1.4.13-mc1.21.11" = _WWVPhE7z;
        "pkg-1.4.14-mc1.21.11" = _np7vydFn;
        "pkg-1.5.2-mc1.21.11" = _fpltuF95;
        "pkg-1.5.2-mc26.1" = _7Wjnvh09;
        "pkg-1.5.2-mc26.1.1" = _q5WMzC4X;
        "pkg-1.5.2-mc26.1.2" = _SRXkQggn;
        "pkg-1.6.1-mc1.20.6" = _QPjZCVU0;
