...
let
    ...
    in {
        ...
        "pkg-1.6.9" = _BnXAniBw;
        "pkg-1.7.9" = _BhJy7lMa;
        "pkg-1.7.10" = _UwHotGBv;
        "pkg-1.7.11" = _88Pc3OFM;
        "pkg-1.8.12" = _fRiIHJbm;
        "pkg-1.8.13" = _cK3Zd9Ba;
        "pkg-1.8.14" = _yja32gws;
        "pkg-1.9.15" = _cFX2rS3A;
        "pkg-1.9.16" = _88FWrvaN;
        "pkg-1.9.17" = _gieCvANC;
        "pkg-1.10.18" = _uLAh77Oy;
        "pkg-1.10.19" = _vyTnAW3y;
