...
let
    ...
    in {
        ...
        "pkg-v0.1-1.0.0(Forge)" = _cXNMJYN1;
        "pkg-v0.4-1.0.0(Forge)" = _9694Swkq;
        "pkg-v0.4-1.0.0(ModLoader)" = _Q3DbPmhq;
        "pkg-v0.6-1.0.0(ModLoader" = _7F6iFjFK;
        "pkg-v0.6-1.1(ModLoader)" = _ab6n0Ci0;
        "pkg-v0.7-1.1(ModLoader)" = _iykMgHEh;
        "pkg-v0.71-1.2.3(ModLoader)" = _P0qHzKuI;
        "pkg-v0.8pre2-1.2.4(Forge)" = _gUlfqOlv;
        "pkg-v0.8pre3-1.2.5(Forge)" = _O2CE5L6Q;
        "pkg-v0.83-1.2.5(Forge)" = _U8FLUXik;
        "pkg-v0.9pre-1.3.2(Forge)" = _uYQvH0sy;
        "pkg-v0.9pre2-1.3.2(ModLoader)" = _fX0bdweX;
        "pkg-v0.9pre2-1.3.2(Forge)" = _1CLxw5iu;
        "pkg-v0.9pre4-1.4.4(ModLoader)" = _dJCPxc6p;
        "pkg-v0.92-1.4.6(ModLoader)" = _ts146cjs;
        "pkg-v0.92-1.4.6(Forge)" = _ky9c9x3t;
        "pkg-v0.93-1.4.7(Modloader)" = _Fgx5jM6M;
        "pkg-v0.93-1.4.7(Forge)" = _Tjx0p8Aa;
        "pkg-v0.99.2-1.5.x" = _fTtYb5PM;
        "pkg-v0.99.2-1.5.2" = _HeNGsrWS;
        "pkg-r33-1.6.x" = _RxMrqa8j;
        "pkg-r35-1.6.x" = _pwALUL8V;
        "pkg-r36-1.6.x" = _VB3lcih3;
        "pkg-r38-1.7.2" = _miV9WV8v;
        "pkg-r40-1.7.2" = _5xXxHnac;
        "pkg-r39-1.7.10" = _PDxDyFyh;
        "pkg-r40-1.7.10" = _UAilxnOG;
        "pkg-r41-1.7.10" = _4rui9OZ8;
        "pkg-r42-1.8" = _kPs5Alnq;
        "pkg-r43-1.8" = _TiPNsaVz;
        "pkg-r44-1.8.9" = _lA1RppuK;
        "pkg-r45-1.9" = _lSNbjji8;
        "pkg-r46-1.9.0" = _8j5JGnE7;
        "pkg-r45-1.9.4" = _A2yCWNfn;
        "pkg-r46-1.9.4" = _DRfKCgos;
        "pkg-r46-1.10.2" = _UmnrRAi3;
        "pkg-1.11.2-snapshot" = _WafowJa1;
        "default" = _WafowJa1;
    });
