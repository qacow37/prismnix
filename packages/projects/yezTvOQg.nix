...
let
    ...
    in {
        ...
        "pkg-2.4.9" = _ojd27NmC;
        "pkg-2.5.2" = _T2c665e8;
        "pkg-2.4.10" = _spuS9uPq;
        "pkg-2.6.0" = _3nMjkRI8;
        "pkg-2.6.1" = _GdXbJ8iV;
        "pkg-2.6.1b" = _DO9LEXpu;
        "pkg-2.6.2" = _htubcM2x;
        "pkg-2.6.3" = _VkKlm4rG;
        "pkg-2.7.2" = _uOccOFIK;
        "pkg-2.7.3" = _II1fXmbn;
        "pkg-2.8.0" = _qvEfr506;
        "pkg-2.8.0b" = _eUfmU6MT;
        "pkg-1.2.3b" = _VehPhUOC;
        "pkg-1.2.3" = _cE4Liz1l;
        "pkg-1.1.6" = _4aPiDvF4;
        "pkg-1.4.1" = _i78Sz13u;
        "pkg-2.0.3" = _gTuvTmQV;
        "pkg-2.0.5b" = _9fYPU4GN;
        "pkg-2.1.0" = _i5s9U2Gw;
        "pkg-2.0.6" = _u8YRKyiD;
        "pkg-2.1.1" = _guJ7eNht;
        "pkg-2.8.2" = _YTSA2lJd;
        "pkg-2.8.3" = _rvb4dASU;
        "pkg-2.8.4" = _S2xCpLAX;
        "pkg-1.21.8-2.9.0" = _645mn3e8;
        "pkg-1.21.9-2.9.0" = _ZpGMumr1;
        "pkg-1.21.10-2.9.0" = _2WfQHDvA;
        "pkg-1.21.10-2.9.1" = _lvZq6Lvq;
        "pkg-1.21.10-2.9.2" = _yUSjR0fd;
        "pkg-1.21.10-2.9.3" = _kbykmYDq;
        "pkg-1.21.11-2.9.3" = _RTDoNe80;
        "pkg-1.21-2.6.3b" = _P0iBDUjp;
        "pkg-1.21.1-2.7.1b" = _SzxgYkoa;
        "pkg-26.1-snapshot-2-2.9.3" = _oIykMoA9;
        "pkg-1.21.1-2.7.2c" = _8BhWK6Jc;
        "pkg-1.21.11-2.9.4" = _717155kA;
        "pkg-26.1-snapshot-2.9.4" = _ZtL4wCh6;
        "pkg-26.1-2.9.5" = _z1Qbs7RJ;
        "pkg-26.1-2.9.5b" = _4WgkX3FC;
