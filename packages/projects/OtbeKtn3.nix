...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _laJOYgff;
        "pkg-1.0.2-hotfix" = _aE9i3qZi;
        "pkg-1.0.2-hotfix2" = _FGHSo8ax;
        "pkg-1.0.3" = _jynrmBxG;
        "pkg-1.0.4" = _gZn1ekCh;
        "pkg-1.0.4-datafix" = _V01loUVV;
        "pkg-1.0.5-beta1" = _ZqVdFy5O;
        "pkg-1.0.5-alpha3" = _qxxVvgNX;
        "pkg-1.0.5" = _zWNIQEes;
        "pkg-1.0.5-hf1" = _SbBpzuRh;
        "pkg-1.0.5-hf2" = _zhRuA37m;
        "pkg-1.0.6" = _O04FYo8m;
        "pkg-1.0.6-hf1" = _m8eb9qv5;
        "pkg-1.0.6-hf2" = _2Km3bpp6;
        "pkg-1.0.6-pre" = _2ZJZW5Pi;
        "pkg-1.0.6-cct" = _drk3ameL;
        "pkg-1.1.0" = _BWS2VnVN;
        "pkg-1.2.0" = _t6ildmBm;
        "pkg-1.2.1" = _DeMlQ8AZ;
        "pkg-1.2.2" = _nYdZeV9a;
        "pkg-1.2.2.1" = _DFXaH56U;
        "pkg-1.2.3" = _yMkV8iW0;
        "pkg-1.2.4" = _RfgiP9nN;
        "pkg-1.2.5" = _SSV3MDof;
        "pkg-1.2.5.1" = _YdnYD5Mu;
        "default" = _YdnYD5Mu;
    });
