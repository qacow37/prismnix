...
let
    ...
    in {
        ...
        "pkg-1.21.0-1.1-fabric+forge+neo" = _YDQb2WPA;
        "pkg-1.20.6-1.2-fabric+forge+neo" = _sNS3c6sF;
        "pkg-1.21.0-1.2-fabric+forge+neo" = _Qvk9TpL5;
        "pkg-1.20.6-1.3-fabric+forge+neo" = _eKflKv7U;
        "pkg-1.21.0-1.3-fabric+forge+neo" = _3W0b5vJl;
        "pkg-1.21.1-1.3-fabric+forge+neo" = _hLlXLCv4;
        "pkg-1.21.2-1.3-fabric+neo" = _qV2l5wX2;
        "pkg-1.21.3-1.3-fabric+forge+neo" = _yYshoQA0;
        "pkg-1.21.4-1.3-fabric+forge+neo" = _pPsCHs2c;
        "pkg-1.21.1-1.4-fabric+forge+neo" = _vzNiDm09;
        "pkg-1.21.4-1.4-fabric+forge+neo" = _MpN7UCAL;
        "pkg-1.21.1-1.5-fabric+forge+neo" = _XRcikRVs;
        "pkg-1.21.4-1.5-fabric+forge+neo" = _IPLU2H7C;
        "pkg-1.21.5-1.5-fabric+forge+neo" = _ycyYVrCt;
        "pkg-1.21.6-1.5-fabric+forge+neo" = _RmP2lRtk;
        "pkg-1.21.7-1.5-fabric+forge+neo" = _GvMCoDyZ;
        "pkg-1.21.8-1.5-fabric+forge+neo" = _fiZtCREY;
        "pkg-1.21.9-1.5-fabric+forge+neo" = _drEVlt3G;
        "pkg-1.21.10-1.5-fabric+forge+neo" = _NvbiZ2KO;
        "pkg-1.21.11-1.5-fabric+forge+neo" = _DIBtsHvs;
        "pkg-26.1.0-1.5-fabric+forge+neo" = _px5S8XlJ;
