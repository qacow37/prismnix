...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _A9qu7ToP;
        "pkg-1.1.2" = _kbweidhO;
        "pkg-1.2.0-fabric-21.1" = _PVOGQIH6;
        "pkg-1.2.0-neoforge-21.1" = _IcUlcX5J;
        "pkg-1.2.0-fabric-26.1" = _DJCXNEwT;
        "pkg-1.2.0-neoforge-26.1" = _Ad3auwsa;
        "pkg-1.2.0-fabric-26.2" = _6hW9Z7bg;
        "pkg-1.2.0-neoforge-26.2" = _6j2huCYM;
        "default" = _6j2huCYM;
    });
