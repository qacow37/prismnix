...
let
    ...
    in {
        ...
        "pkg-1.1.1+1.21.1-neoforge" = _CZVmpnxc;
        "pkg-1.1.1+1.21.1-fabric" = _XMloR0bQ;
        "pkg-1.2.0+1.21.1-neoforge" = _d1Ghqv9D;
        "pkg-1.2.0+1.21.1-fabric" = _HUI0Y3VV;
        "pkg-1.3.0+1.21.1-neoforge" = _L5kUiOKz;
        "pkg-1.3.0+1.21.1-fabric" = _bbAqapE1;
        "pkg-1.4.0+1.21.1-neoforge" = _l3nZGhKi;
        "pkg-1.4.0+1.21.1-fabric" = _j8am7cbl;
        "pkg-1.4.1+1.21.1-fabric" = _bcyGsMTH;
        "pkg-1.4.1+1.21.1-neoforge" = _PNbHfR6b;
        "pkg-1.5.0+1.21.1-neoforge" = _TZdwLhYm;
        "pkg-1.5.0+1.21.1-fabric" = _b4w6gvw8;
        "pkg-1.6.0+1.21.1-neoforge" = _nii53lBd;
        "pkg-1.6.0+1.21.1-fabric" = _iA38Ow8g;
        "pkg-1.7.0+1.21.1-neoforge" = _w990hLz2;
        "pkg-1.7.0+1.21.1-fabric" = _uuwdIwwA;
        "pkg-1.7.1+1.21.1-neoforge" = _cnlqDFRj;
        "pkg-1.7.1+1.21.1-fabric" = _C1TAf1ZT;
