...
let
    ...
    in {
        ...
        "pkg-1.1.5" = _pxvENJQC;
        "pkg-1.1.6" = _6kRFNFVI;
        "pkg-1.1.6+1.20.1" = _9W63dtSE;
        "pkg-1.1.7+1.20.4" = _PqnWsasD;
        "pkg-1.1.7+1.20.1" = _vdJSNq1d;
        "pkg-1.1.8+1.20.4" = _EVxfeXyM;
        "pkg-1.1.8+1.20.1" = _oPCUGaUg;
        "pkg-1.1.8+1.20.6" = _knnTnDuW;
        "pkg-1.1.8+1.21" = _PPuwCnlU;
        "pkg-1.1.9+1.20.1" = _lmup3BRl;
        "pkg-1.1.9+1.20.4" = _oCutbGlE;
        "pkg-1.1.9+1.20.6" = _mhrtVQcl;
        "pkg-1.1.9+1.21" = _p3IKd4po;
        "pkg-1.1.10+1.21" = _TsrnOZ9m;
        "pkg-1.1.12+1.20.1" = _8erOeehC;
        "pkg-1.1.12+1.20.4" = _7vWVlgp9;
        "pkg-1.1.12+1.20.6" = _50hkPn90;
        "pkg-1.1.12+1.21" = _zeM8k5kF;
        "pkg-1.1.12+1.21.2-rc1" = _guqh1JWD;
        "pkg-1.1.12+1.21.2" = _Y3XfvFc0;
        "pkg-1.1.13+1.21" = _vQ3B3Hyz;
        "pkg-1.1.13+1.21.2" = _GuwmfS2k;
        "pkg-1.1.14+1.21" = _XKprbgdw;
        "pkg-1.1.14+1.21.2" = _RKPjaNZU;
        "pkg-1.1.14+1.21.4" = _1OvV232o;
        "pkg-1.1.15+1.21.4" = _54i4XfkF;
        "pkg-1.1.17+1.21" = _oDg5VxUI;
        "pkg-1.1.17+1.21.2" = _TL8T7DIH;
        "pkg-1.1.17+1.21.4" = _g4FjebYn;
        "pkg-1.1.18+1.21" = _Hzx3TLnV;
        "pkg-1.1.18+1.21.2" = _meqpXQVz;
        "pkg-1.1.18+1.21.4" = _RGJiQP3v;
        "pkg-1.1.19+1.21" = _92hDb3rq;
        "pkg-1.1.19+1.21.2" = _1228KFsG;
        "pkg-1.1.19+1.21.4" = _rVJMM9WH;
        "pkg-1.1.20+1.21" = _x6iwzGt9;
        "pkg-1.1.20+1.21.2" = _xTp4kpbk;
        "pkg-1.1.20+1.21.4" = _GXITPix1;
        "pkg-1.2.0+1.21" = _eofNFmbw;
        "pkg-1.2.0+1.21.4" = _STVzqDrQ;
        "pkg-1.2.2+1.21" = _9sK4504v;
        "pkg-1.2.2+1.21.4" = _JMrzEadQ;
        "pkg-1.2.2+1.21.5-rc1" = _cWspuWpd;
        "pkg-1.2.4+1.21.5-rc1" = _WN458RI6;
        "pkg-1.3.0+1.21.5" = _LfETI3nm;
        "pkg-1.4.1+1.21.6" = _J5df3dcB;
        "pkg-1.4.2+1.21.6" = _lQLDr161;
        "pkg-1.5.0+1.21.6" = _O4lH7Qum;
        "pkg-1.5.6+1.21.6" = _PmHnXpHx;
        "pkg-1.6.0+1.21.9" = _1wzC3DMk;
        "pkg-1.2.5+1.21" = _LXPD3P3k;
        "pkg-1.7.0+1.21.6" = _Hfnd2WzH;
        "pkg-1.7.0+1.21.9" = _jHKrtarp;
        "pkg-1.7.2+1.21.9" = _KmIjIv5N;
