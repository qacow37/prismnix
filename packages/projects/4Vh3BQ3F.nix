...
let
    ...
    in {
        ...
        "pkg-1.9.3" = _l8moXGVf;
        "pkg-1.9.8" = _tCOk76vP;
        "pkg-2.4.16" = _n7bA5mf5;
        "pkg-2.4.20" = _UJA3LfJQ;
        "pkg-2.4.28" = _kE0Y2Dbf;
        "pkg-3.0.2" = _lX1VrAZK;
        "pkg-3.0.2+1" = _pEP3ZT9M;
        "pkg-3.0.2+2" = _hvfHycVX;
        "pkg-3.0.2+3" = _Sq19WbA6;
        "pkg-3.0.2+4" = _iTh5chQW;
        "pkg-3.0.2+5" = _SXux8xY6;
        "pkg-3.0.2+6" = _YtHp3Z17;
        "pkg-2.4.29" = _KFsgK9Tq;
        "pkg-3.0.2+7" = _cZLIOE3H;
        "pkg-3.0.2+8" = _eKwys5Hb;
        "pkg-3.0.2+9" = _3X4aie17;
        "pkg-3.0.3+1" = _DfeyBEqW;
        "pkg-2.4.30" = _C1nd6WQr;
        "pkg-2.4.31" = _ct1ifJ23;
        "pkg-3.0.3+2" = _lfj9YFdX;
        "pkg-3.0.4" = _s1e7Zh5G;
        "pkg-2.5.0" = _N2xeCrrq;
        "pkg-2.5.1" = _kA5EZD9y;
        "pkg-3.0.5" = _enkPVvxo;
        ...
        "pkg-2.5.3" = _lg7mW3eS;
        "pkg-3.0.8" = _640EOvKh;
        "pkg-26.1.2.0" = _EE6A4ig6;
        "pkg-26.1.2.1" = _le4xvxLg;
        "pkg-26.1.2.1+1" = _HYydf66X;
        "pkg-26.1.2.1+2" = _CE92Otiu;
        "default" = _CE92Otiu;
    });
