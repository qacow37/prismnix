...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19.2" = _UO5MagVa;
        "pkg-1.1.0+1.19.2" = _TbGfmWL2;
        "pkg-1.1.0+1.20.1" = _JUktf4M2;
        "pkg-1.2.0+1.20.1" = _gkGG3lX6;
        "pkg-1.3.0+1.20.1" = _SDmym7mA;
        "pkg-1.3.1+1.20.4" = _j8JO5r3x;
        "pkg-1.3.1+1.20.6" = _SlUH0sXi;
        "pkg-1.3.1+1.21" = _kfkPQzl4;
        "pkg-1.3.2+1.21" = _oYqEMz7G;
        "pkg-1.3.3+1.21" = _gv9CKQMU;
        "pkg-1.4.0+1.21" = _vfQxGe2S;
        "pkg-1.5.0+1.21" = _NnRboPHW;
        "pkg-1.5.1+1.21" = _P23jXeIq;
        "pkg-1.6.0+1.21" = _tcEi73bc;
        "pkg-1.7.1+1.21" = _novpRXUd;
        "pkg-1.7.2+1.21" = _bVOCtJxa;
        "pkg-1.7.3+1.21" = _kOE5UGXi;
        "pkg-1.7.4+1.21" = _q3Xr7bjb;
        "pkg-1.7.6+1.21" = _VUUM7K32;
        "pkg-1.8.0+1.21" = _uBr3wwcx;
        "pkg-1.9.0+1.21" = _7QphoNUo;
        "pkg-2.0.0-alpha.2+1.21" = _XBKMm3F3;
        "pkg-2.0.0-alpha.3+1.21" = _ueegMMgK;
        "pkg-2.0.0-alpha.4+1.21" = _SL4fnzjH;
        "pkg-2.0.0-alpha.5+1.21" = _wXNgZo3X;
        "pkg-2.0.0+1.21" = _HOV0aekW;
        "pkg-2.1.0+1.21" = _sTm2lWdz;
        "pkg-2.1.1+1.21" = _WHFo80Bp;
        "pkg-2.1.2+1.21" = _wfyEsIre;
        "pkg-2.1.3+1.21" = _RIXZtlxc;
        "pkg-2.1.4+1.21" = _1UlITWf4;
        "pkg-2.1.5+1.21" = _EPw6xWWM;
        "pkg-2.1.6+1.21" = _p8DkjMtl;
        "pkg-2.2.0+1.21" = _Az6jLcfB;
        "pkg-2.3.0+1.21" = _RE0gBB42;
        "pkg-2.3.3+1.21.7" = _WkfVpIzt;
        "pkg-2.3.4+1.21.7" = _5QrMo15f;
        "pkg-2.4.0+26.1" = _daivgI4v;
        "pkg-2.4.1+26.1" = _9pM5mfSY;
        "pkg-2.4.2+26.1" = _vnk4rYvS;
        "pkg-2.5.0+26.1" = _BBw79uCA;
        "pkg-2.5.1+26.1" = _YtnsPVY1;
        "pkg-2.5.2+26.1" = _wWS7xZGg;
        "pkg-2.5.3+26.1" = _Dc4YGj1O;
        "pkg-2.5.4+26.1" = _DekhIVkZ;
        "default" = _DekhIVkZ;
    });
