...
let
    ...
    in {
        ...
        "pkg-1.0" = _vEYaISvP;
        "pkg-1.0+mod" = _Yl4mIW9H;
        "pkg-1.1" = _x5lWE29V;
        "pkg-2.0" = _tSzaEUST;
        "pkg-2.0+mod" = _I23TJAdB;
        "pkg-2.1" = _3T5FRlrJ;
        "pkg-2.1+mod" = _1SF29EFS;
        "pkg-2.2" = _TFdExYbc;
        "pkg-2.2+mod" = _js7Bg6jl;
        "pkg-2.3" = _52a98U5c;
        "pkg-2.3+mod" = _m51P1B53;
        "pkg-2.4" = _6imu4jLF;
        "pkg-2.4+mod" = _gRNRcP5x;
        "pkg-2.5" = _7pD2RufB;
        "pkg-2.6" = _dovOBe1q;
        "pkg-2.6+mod" = _sFU6lpUV;
        "pkg-2.7" = _OjyxiE0N;
        "pkg-2.7-fabric" = _UAd11So6;
        "pkg-2.7-forge" = _fw4ittpN;
        "pkg-2.11" = _CMpR9LSj;
        "pkg-2.11-fabric" = _Ey2lX2vJ;
        "pkg-2.11-quilt" = _bIijD873;
        "pkg-2.11-forge" = _wO0KZlbZ;
        "pkg-2.11-neoforge" = _sE6pvGX9;
        "pkg-2.12" = _juoc3bFs;
        "pkg-2.12-fabric" = _Cm8dNMKx;
        "pkg-2.12-quilt" = _M7PqtCCF;
        "pkg-2.12-forge" = _pvCU0IFa;
        "pkg-2.12-neoforge" = _aHe5PwMn;
        "default" = _aHe5PwMn;
    });
