...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.6-fabric" = _wxypOusk;
        "pkg-1.18.2-2.6-fabric" = _k6gdAhF0;
        "pkg-1.19.2-2.6-fabric" = _pn1eVBL1;
        "pkg-1.16.5-2.6-forge" = _c5KiZDvF;
        "pkg-1.18.2-2.6-forge" = _olBPOfAo;
        "pkg-1.19.2-2.6-forge" = _6ZhOulfH;
        "pkg-1.16.5-2.7-fabric" = _Z9vT1dkx;
        "pkg-1.18.2-2.7-fabric" = _mNAmtlp4;
        "pkg-1.19.2-2.7-fabric" = _RByKTIHR;
        "pkg-1.19.3-2.8-fabric" = _GftrOEYT;
        "pkg-1.19.3-2.6-forge" = _dAojxzT1;
        "pkg-1.18.2-3.0-forge+fabric" = _GKh8TJ92;
        "pkg-1.19.2-3.0-forge+fabric" = _pcraDLsm;
        "pkg-1.19.3-3.0-forge+fabric" = _HAhv98wG;
        "pkg-1.18.2-3.1-forge+fabric" = _Z12iR42E;
        "pkg-1.19.2-3.1-forge+fabric" = _qp1Q2x77;
        "pkg-1.19.3-3.1-forge+fabric" = _BMYV12qP;
        "pkg-1.18.2-3.2-forge+fabric" = _3JnYwAOa;
        "pkg-1.19.2-3.2-forge+fabric" = _Awk8Damf;
        "pkg-1.19.3-3.2-forge+fabric" = _lbBzHy80;
        "pkg-1.19.4-3.2-forge+fabric" = _J0CvZbYi;
        "pkg-1.20-3.2-forge+fabric" = _lbyhqa8k;
        "pkg-1.20.1-3.2-forge+fabric" = _btcTXMLP;
        "pkg-1.20.2-3.2-forge+fabric" = _QJV7IKed;
        "pkg-1.18.2-3.3-forge+fabric" = _Ctw7pwzg;
        "pkg-1.19.2-3.3-forge+fabric" = _5vCrPvn4;
        "pkg-1.20.1-3.3-forge+fabric" = _aQhJd4db;
        "pkg-1.20.2-3.3-forge+fabric" = _QxmRftUL;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _aGDaqm76;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _COzMXSEj;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _uuBHMdCX;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _fL58Yb76;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _FFwBmdh4;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _Mc5jGUNy;
        "pkg-1.20.5-3.4-fabric+neo" = _5X0oSu29;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _AZ11BHkl;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _kwfX67rG;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _z3ULiTbM;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _JwgZZeki;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _ulgyAbA4;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _60RkurUE;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _JHDwkSNU;
        "pkg-1.21.2-3.6-fabric+neo" = _hFJ7jTxW;
        "pkg-1.21.3-3.6-fabric+forge+neo" = _ABQKF6oy;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _wZC5hYP3;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _A1S3DRBc;
        "pkg-1.21.1-3.7-fabric+forge+neo" = _qCIUvQPR;
        "pkg-1.21.4-3.7-fabric+forge+neo" = _oGORdY9y;
        "pkg-1.21.5-3.7-fabric+forge+neo" = _88mp68Ab;
        "pkg-1.21.6-3.7-fabric+forge+neo" = _ekZxI3pP;
        "pkg-1.21.7-3.7-fabric+forge+neo" = _TJqJnGP7;
        "pkg-1.21.8-3.7-fabric+forge+neo" = _xl9avL2V;
        "pkg-1.21.9-3.7-fabric+forge+neo" = _f8nDPK2k;
        "pkg-1.21.9-3.8-fabric+forge+neo" = _hXTHEi37;
        "pkg-1.21.10-3.8-fabric+forge+neo" = _vACcLeFW;
        "pkg-1.21.11-3.8-fabric+forge+neo" = _aaXXPW0v;
        "pkg-26.1.0-3.8-fabric+forge+neo" = _2rgcPHx0;
        "pkg-26.1.0-3.9-fabric+forge+neo" = _NUnPSWZE;
        "pkg-26.1.1-3.9-fabric+forge+neo" = _KwhhAO5e;
        "pkg-26.1.2-3.9-fabric+forge+neo" = _B5XPzeDF;
        "pkg-26.2.0-3.9-fabric+forge+neo" = _TrbW20G4;
        "default" = _TrbW20G4;
    });
