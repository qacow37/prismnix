...
let
    ...
    in {
        ...
        "pkg-1.7.0" = _ldNhCrA3;
        "pkg-1.7.1" = _sbuRv8om;
        "pkg-2.0.0+forge" = _swwWZcJ5;
        "pkg-2.0.0+fabric" = _7qL5VHdw;
        "pkg-2.0.1+fabric" = _gxTrKEHE;
        "pkg-2.0.1+forge" = _pLeS69So;
        "pkg-2.0.2+forge" = _CLYREBbv;
        "pkg-2.0.2+fabric" = _XecEkebf;
        "pkg-2.1.0+fabric" = _FEO7mysY;
        "pkg-2.1.0+forge" = _Y5eUsDgh;
        "pkg-2.1.1" = _QQMV3yW5;
        "pkg-2.1.2" = _Tqzkh6MT;
        "pkg-2.1.3" = _yMYjAGI1;
        "pkg-2.1.4" = _f15T3Wse;
        "pkg-2.1.5" = _ij24zuaB;
        "pkg-2.2.0-fabric" = _OYv3XsMi;
        "pkg-2.2.0-forge" = _pTMhQVCR;
        "pkg-2.2.0-quilt" = _3bTxgusI;
        "pkg-3.0.0" = _90Rv07Eq;
        "pkg-3.0.1" = _p6mXHsAR;
        "pkg-3.0.1+1.20.4" = _NIqynnPm;
        "pkg-3.1.0+1.20.4" = _FJJCE6dC;
        "pkg-3.1.0+1.20.6" = _8XzwJMwM;
        "pkg-3.1.0+1.21" = _dScuoP88;
        "pkg-4.0.0+26.1.x" = _5kOUTmp6;
        "pkg-4.0.0+26.2.x" = _aScSXu22;
        "default" = _aScSXu22;
    });
