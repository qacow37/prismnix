...
let
    ...
    in {
        ...
        "pkg-1.0.0.13" = _aScyaaLb;
        "pkg-1.0.0.14" = _bj1hHkPZ;
        "pkg-1.0.0.17" = _mF9UAJ1u;
        "pkg-1.0.0.18" = _FXVmoBuE;
        "pkg-1.0.0.19" = _gigcHzac;
        "pkg-1.0.0.20" = _CQFCiNyY;
        "pkg-1.0.0.21" = _KF0tW8QK;
        "pkg-1.0.0.22" = _olt09M6U;
        "pkg-1.0.0.23" = _PEdujLvH;
        "pkg-1.0.0.24" = _iNh81NtW;
        "pkg-1.1.0.26" = _v0V951Ah;
        "pkg-1.1.0.28" = _F8wLNLEE;
        "pkg-1.1.0.29" = _KUudludY;
        "pkg-1.1.0.30" = _1X45bIh6;
        "pkg-1.1.0.31" = _CYO9LVmT;
        "pkg-1.1.0.32" = _Ol8uNODa;
        "pkg-1.1.0.33" = _mN2WguBY;
        "pkg-1.1.0.35" = _VyCeijL6;
        "pkg-1.1.0.37" = _fyG9xni5;
        "pkg-1.1.0.39" = _WjZcJl8o;
        "pkg-1.1.0.40" = _CBu5QS6B;
        "pkg-1.1.0.41" = _DRBPMUBV;
        "pkg-1.1.0.43" = _FR5mvdMH;
        "pkg-1.1.0.44" = _wLnfaWUz;
        "pkg-1.1.0.45" = _dHrdmYai;
        "pkg-1.1.0.46" = _W98INPub;
        "pkg-1.1.0.47" = _OuDODdbW;
        "pkg-1.1.0.48" = _jFgqc7VY;
        "pkg-1.1.0.49" = _MdtfhF56;
        "pkg-1.1.0.50" = _l7kuXRU2;
        "pkg-1.1.0.51" = _VVNBuXzH;
        "pkg-1.1.0.52" = _wHvBeW2E;
        "pkg-1.1.0.53" = _GQm2HSTs;
        "pkg-1.1.0.54" = _XtVuvbmQ;
        "pkg-1.1.0.55" = _pTI1MLSA;
        "pkg-1.1.0.57" = _EFg6bMVd;
        "pkg-1.1.0.56" = _sI3lGvqG;
        "pkg-1.1.0.58" = _PFDKDY6T;
        "pkg-1.1.0.59" = _hJ9OAyhI;
        "pkg-1.1.0.60" = _59NLmD8h;
        "pkg-1.1.0.61" = _hjIPbA3l;
        "pkg-1.1.0.62" = _YpBcsAD7;
        "pkg-1.1.0.63" = _sQtspQn4;
        "pkg-1.1.0.64" = _nXbC3bi9;
        "pkg-1.1.0.65" = _hVGadld9;
        "pkg-1.1.0.67" = _m8Qb8dGG;
        "pkg-1.1.0.68" = _r8NjV7Qj;
        "pkg-1.1.0.69" = _wkEhdDz0;
        "pkg-1.1.0.70" = _iiGtfFce;
        "pkg-1.1.0.71" = _UcRtHLmf;
        "pkg-1.1.0.72" = _WAzQUZ1A;
        "pkg-1.1.0.73" = _MfY1c0QZ;
        "pkg-1.1.0.75" = _QsTQiTVc;
        "pkg-1.1.0.76" = _Gq0MqmOl;
        "pkg-1.1.0.77" = _LcgBIvC6;
        "pkg-2.1.0.80" = _tashH8sv;
        "pkg-1.1.0.82" = _Bawyxiss;
        "pkg-1.1.0.83" = _BsKjbTBv;
        "pkg-1.1.0.84" = _C0Jypg2m;
        "pkg-1.1.0.85" = _xUYdZQ7t;
        "pkg-1.1.0.86" = _t59WOLu9;
        "pkg-1.1.0.87" = _AdXlu0CA;
        "pkg-1.1.0.88" = _FcS0iYh3;
        "pkg-1.1.0.90" = _bjtRZUxw;
        "pkg-1.1.0.91" = _mcpmpMGw;
        "pkg-1.1.0.92" = _ZbpOnSVr;
        "pkg-1.1.0.93" = _DgXfKyKD;
        "pkg-1.1.0.94" = _yV08RLMF;
        "pkg-1.1.0.95" = _kIq25rmI;
        "pkg-1.1.0.96" = _hNzU35iS;
        "pkg-1.1.0.97" = _prICYTwg;
        "pkg-1.1.0.98" = _C9lnWgOg;
        "pkg-1.1.0.99" = _zCLKwgqI;
        "pkg-1.1.0.100" = _VPXM1H0w;
        "pkg-1.1.0.101" = _sBXQQlUV;
        "pkg-1.1.0.102" = _b15PC6xJ;
        "pkg-2.0.0.108" = _NvfrZQFv;
        "pkg-2.0.0.109" = _LEShZYdW;
        "pkg-2.0.0.110" = _W2FL9kpt;
        "pkg-2.0.0.111" = _YH99nabV;
        "pkg-2.0.0.112" = _vxNBwfRj;
        "pkg-2.0.0.113" = _ATMo6RM4;
        "pkg-2.0.0.117" = _qBqPXZ7o;
        "pkg-2.0.0.118" = _ErMgVqlI;
        "pkg-2.0.0.119" = _UpJEL4yB;
        "pkg-2.0.0.120" = _2usds9Ky;
        "pkg-2.0.0.121" = _7fO9yhfn;
        "pkg-2.0.0.122" = _Cnwlsdvf;
        "pkg-2.0.1.123" = _CAd3rMDR;
        "pkg-2.0.1.124" = _xigWyXa8;
        "pkg-2.0.1.125" = _baK4eX3b;
        "pkg-1.2.0.126" = _YIUL3PEn;
        "pkg-2.0.1.127" = _VRjBM77b;
        "pkg-2.0.1.128" = _iteCKoP9;
        "pkg-2.0.1.129" = _Rj98OiYR;
        "pkg-2.0.1.130" = _ywiJhcuG;
        "pkg-2.1.0.131" = _O47xVod1;
        "pkg-2.1.0.132" = _3nPeLY1p;
        "pkg-2.1.0.133" = _5xw3P2qN;
        "pkg-2.1.0.134" = _jGx3iN5F;
        "pkg-2.0.1.136" = _nZwFn2MJ;
        "pkg-2.1.0.137" = _UcEhlQra;
        "pkg-2.1.0.138" = _XXnWoSih;
        "pkg-2.1.0.139" = _hDr2nn7q;
        "pkg-1.1.0.42" = _OTf7pBak;
        "pkg-2.1.0.145" = _2WuUmLZ1;
        "pkg-2.1.0.151" = _26maC79e;
        "pkg-2.1.0.152" = _alUPTpIC;
        "pkg-2.1.0.153" = _CR9rGBvb;
        "pkg-2.2.0.154" = _2NOgeyWL;
        "pkg-2.2.0.155" = _mZ41EnfG;
        "pkg-2.2.0.156" = _C9vVmqMI;
        "pkg-2.2.0.157" = _KLz9dQtt;
        "pkg-2.2.0.158" = _LDj6JRk9;
        "pkg-2.2.0.159" = _znCGEN4K;
        "pkg-2.2.0.161" = _MWBWLGTG;
        "pkg-3.0.0.163" = _LxnQ8tFk;
        "pkg-3.0.0.164" = _iCdIqcFv;
        "pkg-3.0.0.165" = _YlwVJumN;
        "pkg-2.0.1.166" = _qpCqqA93;
        "pkg-3.0.0.167" = _OsRvalxg;
        "pkg-2.2.0.168" = _BSKkuhsh;
        "pkg-3.0.0.169" = _f0r1SsWG;
        "pkg-3.0.0.170" = _WoEvuFC4;
        "pkg-3.1.0.15" = _FsEnag6P;
        "pkg-2.3.0.16" = _HdFY06Z7;
        "pkg-3.1.0.19" = _1BMJMxlx;
        "pkg-2.3.0.20" = _Cmt9jpg5;
        "pkg-3.1.0.21" = _xyaCkIUL;
        "pkg-2.3.0.22" = _qQWxMxU7;
        "pkg-3.2.0.6" = _fCaaCuTy;
        "pkg-3.2.0.10" = _M9KCFWno;
        "pkg-3.2.0.11" = _V0r5LAQh;
        "pkg-3.2.0.12" = _HEPVhvwM;
        "pkg-3.2.0.13" = _OTamV6SO;
        "pkg-3.2.0.14" = _ifr7FJnd;
        "pkg-3.3.0.0" = _s0s2MCHE;
        "pkg-3.3.0.1" = _6xeo7obi;
        "pkg-3.3.0.2" = _KF97dJcF;
        "pkg-3.3.0.3" = _IM4hwwGH;
        "pkg-3.3.0.4" = _T1FKe1B4;
        "pkg-3.0.0" = _3j9ON2qd;
        "pkg-3.3.0.5" = _ADHJnwVA;
        "pkg-3.0.1.2" = _zzgNcnwe;
        "pkg-3.3.0.6" = _P2C11Z4o;
        "pkg-3.3.0.7" = _3orAWPg1;
        "pkg-3.3.0.8" = _234Gi0p1;
        "pkg-3.3.0.9" = _xtBdyFtA;
        "pkg-3.3.0.10" = _6xuhVFC9;
        "pkg-3.0.1.4" = _htFwnGWu;
        "pkg-3.3.0.12" = _IPdVGfJl;
        "pkg-3.4.0.2" = _p54gG9xp;
        "pkg-3.5.0.0" = _xbNuzFJi;
        "pkg-3.5.0.1" = _rGKbHaah;
        "pkg-3.5.0.2" = _Hmw9PMaH;
        "pkg-3.0.1.5" = _FnfW1JJL;
        "pkg-3.0.1.6" = _3XLPwLnV;
        "pkg-3.5.0.3" = _rJjif5b1;
        "pkg-3.5.0.4" = _wtCOTHGT;
        "pkg-3.0.1.7" = _FZV63yhg;
        "pkg-3.5.0.5" = _h96HEGgV;
        "pkg-4.0.0.0" = _XLPAoSOd;
        "pkg-4.0.0.1" = _xBeonLfL;
        "pkg-4.0.0.2" = _N1JhLbFM;
        "pkg-4.1.0.0" = _IcvHBa7N;
        "pkg-4.1.0.1" = _AcaBshzA;
        "pkg-4.1.0.2" = _G84OjZxK;
        "pkg-4.1.0.3" = _cNsceBWL;
        "pkg-4.2.0.0" = _xmlEEAIw;
        "pkg-4.1.0.4" = _PJoCA4qz;
        "pkg-4.2.0.1" = _73WfNXvd;
        "pkg-4.1.0.5" = _yHeHBZPt;
        "pkg-4.2.0.2" = _gC8yQOAy;
        "pkg-4.3.0.0" = _h28tJLLW;
        "pkg-4.3.0.1" = _frO7oAJE;
        "pkg-4.1.0.7" = _mXxFGvhp;
        "pkg-4.1.0.8" = _6e8GCrLb;
        "pkg-4.3.0.2" = _BVtalJ0e;
        "pkg-3.0.1.8" = _tpqQb8cZ;
        "pkg-3.0.1.10" = _J1S3aA8i;
        "pkg-5.0.0.0" = _eaXt7fnK;
        "pkg-5.0.0.1" = _v0Ne8HdC;
        "pkg-5.0.0.2" = _Kvc1lRqg;
        "pkg-6.0.0.0" = _yw4ZmJk4;
        "pkg-6.0.0.1" = _b6LwUDZP;
        "pkg-6.0.0.2" = _vBy1kI6X;
        "pkg-6.0.0.3" = _JhTdGSxz;
        "pkg-6.0.0.4" = _eBgWzTJb;
        "pkg-21.9.0.0" = _xsvVYe10;
        "pkg-21.9.0.1" = _apNR53tH;
        "pkg-21.10.0.0" = _kzbTmNaX;
        "pkg-21.10.0.1" = _5OgocdYH;
        "pkg-21.11.0.0" = _xjrV1Uvq;
        "pkg-26.1.0.1" = _lLFGL2nQ;
        "pkg-26.1.0.2" = _SxOLUPMN;
        "pkg-21.11.0.1" = _PdGzWcSS;
        "pkg-26.1.1.0.0" = _lXCgknx5;
        "pkg-26.1.1.0.1" = _KQ9hm3eZ;
        "pkg-26.1.2.0.0" = _m6gU7xLR;
        "pkg-26.1.2.0.1" = _p5GaGbYj;
        "pkg-26.1.2.0.2" = _WIoDeApz;
        "pkg-26.1.2.0.3" = _QtQ34tp7;
