...
let
    ...
    in {
        ...
        "pkg-3.0.0-pre.05-forge" = _Kv7GFXWf;
        "pkg-3.0.0-alpha-fabric" = _nu7tOUhe;
        "pkg-3.0.0-alpha-forge" = _ut60QP2N;
        "pkg-3.0.1-beta-fabric" = _NMMythXk;
        "pkg-3.0.1-beta-forge" = _okeDk4c4;
        "pkg-3.0.2-beta-fabric" = _PVsCaOax;
        "pkg-3.0.2-beta-forge" = _u1MLnVDh;
        "pkg-4.0.0-alpha-fabric" = _cGr8CGDv;
        "pkg-4.0.0-alpha-forge" = _9vf5AKyb;
        "pkg-4.0.1-alpha-fabric" = _hLrNFQUy;
        "pkg-4.0.1-alpha-forge" = _8E6Zh2mP;
        "pkg-3.0.3-beta-fabric" = _kohN2rFW;
        "pkg-3.0.3-beta-forge" = _JnEcXFWp;
        "pkg-3.0.4-beta-fabric" = _sM062BcO;
        "pkg-3.0.4-beta-forge" = _L09KPsAz;
        "pkg-4.0.2-alpha-fabric" = _xu1rIKiO;
        "pkg-4.0.2-alpha-forge" = _cAs0dkho;
        "pkg-4.0.3-alpha-fabric" = _A7WcTAA3;
        "pkg-4.0.3-alpha-forge" = _H2hun0ip;
        "pkg-3.0.5-beta-fabric" = _MnNr8C0T;
        "pkg-3.0.5-beta-forge" = _ThozQnKO;
        "pkg-4.0.4-beta-fabric" = _KTYGEev3;
        "pkg-4.0.4-beta-forge" = _mc3ZKYgQ;
        "pkg-4.0.5-fabric" = _6HJj9GWP;
        "pkg-4.0.5-forge" = _wad5sun5;
        "pkg-3.0.6-fabric" = _EdxX31P0;
        "pkg-3.0.6-forge" = _3k9LFZXL;
        "pkg-3.0.7-fabric" = _BuLHdKF3;
        "pkg-3.0.7-forge" = _ETImAAwl;
        "pkg-4.0.6-fabric" = _jKWnlerH;
        "pkg-4.0.6-forge" = _URES72g6;
        "pkg-4.0.7-fabric" = _v4BvEaFT;
        "pkg-4.0.7-forge" = _GJLQBRFv;
        "pkg-4.0.8-fabric" = _Dv0tb7ET;
        "pkg-4.0.8-forge" = _hUUlH0NS;
        "pkg-4.0.9-fabric" = _TMGY7C2E;
        "pkg-4.0.9-forge" = _mVGPJAvg;
        "pkg-3.0.8-fabric" = _RACwFvDP;
        "pkg-3.0.8-forge" = _q6LoUb7z;
        "pkg-4.0.10-fabric" = _p5SUopUK;
        "pkg-4.0.10-forge" = _prKFKqO5;
        "pkg-5.0.0-alpha-fabric" = _rEH6HVk3;
        "pkg-5.0.0-alpha-forge" = _24d2oY4u;
        "pkg-5.0.1-fabric" = _Gta0D7FF;
        "pkg-5.0.1-forge" = _VKSn9hIs;
        "pkg-4.0.11-fabric" = _uK9hCoDv;
        "pkg-4.0.11-forge" = _oKOZ4cAb;
        "pkg-5.0.2-fabric" = _s2WleM2W;
        "pkg-5.0.2-forge" = _cvq6V79j;
        "pkg-5.0.3-fabric" = _SKenTSHl;
        "pkg-5.0.3-forge" = _9ugS3aid;
        "pkg-5.0.4-fabric" = _5r9RUzX9;
        "pkg-5.0.4-forge" = _2jdpacF3;
        "pkg-5.1.0-alpha-neoforge" = _hDWHU5On;
        "pkg-5.2.0-alpha-neoforge" = _WhoJEMms;
        "pkg-5.2.1-alpha-neoforge" = _CeSMBmWl;
        "pkg-5.3.0-beta-neoforge" = _NcvX1YvW;
        "pkg-5.4.0-beta-neoforge" = _Pn7owH4g;
        "pkg-5.0.5-fabric" = _zrPCk4ZJ;
        "pkg-5.0.5-forge" = _LRcOcX8Y;
        "pkg-6.0.0-beta-neoforge" = _6kuKDHdP;
        "pkg-6.0.1-beta-neoforge" = _hnwlJA0i;
        "pkg-6.0.2-beta-neoforge" = _uJnRUb6p;
        "pkg-6.0.3-beta-neoforge" = _WvNBMtw8;
        "pkg-6.0.4-beta-neoforge" = _wbmbFX75;
        "pkg-6.0.5-beta-neoforge" = _6X8t5SEs;
        "pkg-6.0.6-beta-neoforge" = _x31tlGza;
        "pkg-6.0.7-beta-neoforge" = _jnlxbBNg;
        "pkg-5.0.6-fabric" = _BpXWzgae;
        "pkg-5.0.6-forge" = _Fa0LadrL;
        "pkg-6.0.8-neoforge" = _2Tv5QKIC;
        "pkg-5.0.7-fabric" = _qaz6sfch;
        "pkg-5.0.7-forge" = _nUwRVMI3;
        "pkg-6.1.0-neoforge" = _FqFCEkWq;
        "pkg-6.1.1-neoforge" = _WfP33kMs;
        "pkg-6.1.2-neoforge" = _YKRidpaM;
        "pkg-5.0.8-fabric" = _jgjDBmKm;
        "pkg-5.0.8-forge" = _QXAwyBnp;
        "pkg-6.1.3-neoforge" = _EpSwB3Y6;
        "pkg-6.1.4-neoforge" = _SL0TtMGp;
        "pkg-6.1.5-neoforge" = _sVFU7vpT;
        "pkg-6.1.6-neoforge" = _4U5QdR3U;
        "pkg-6.2.0-neoforge" = _9am4jTrF;
        "pkg-6.2.1-neoforge" = _L7sDURWx;
        "pkg-5.0.9-fabric" = _PGob6XHN;
        "pkg-5.0.9-forge" = _hyf3i0Ht;
        "pkg-6.2.2-neoforge" = _PuIQUi4x;
        "pkg-6.2.3-neoforge" = _KrZFWlUk;
        "pkg-5.0.10-fabric" = _EWDexyqc;
        "pkg-5.0.10-forge" = _vjK6oB6P;
        "pkg-6.2.4-neoforge" = _yu53tpA7;
        "pkg-5.0.11-fabric" = _6beFT60p;
        "pkg-5.0.11-forge" = _xDOvxyqP;
        "pkg-6.2.5-neoforge" = _LDNi1VB5;
        "pkg-6.2.6-neoforge" = _9AqCIlz0;
        "pkg-6.2.7-neoforge" = _K5Vhgari;
        "pkg-7.0.0-alpha-neoforge" = _DSUE1EYq;
        "pkg-7.0.1-alpha-neoforge" = _kSn9pTpD;
        "pkg-7.0.2-alpha-neoforge" = _6vVoXJq4;
        "pkg-6.2.8-neoforge" = _y2Y1fHd2;
        "pkg-7.0.3-alpha-neoforge" = _3TWED6OH;
        "pkg-6.2.9-neoforge" = _gjeq54EP;
        "pkg-6.2.10-neoforge" = _1prWLuga;
        "pkg-7.0.4-alpha-neoforge" = _bymXTkIP;
        "default" = _bymXTkIP;
    });
