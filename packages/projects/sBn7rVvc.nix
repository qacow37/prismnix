...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.21.5" = _KlJzOB1g;
        "pkg-1.2.0-1.21.1" = _2oupKwHa;
        "pkg-1.2.0-1.21.4" = _1gISMlEG;
        "pkg-1.2.0-1.21.5" = _yaX0OgSi;
        "pkg-1.2.1-1.21.1" = _Ap2cb3DE;
        "pkg-1.2.1-1.21.4" = _kIiTrRJB;
        "pkg-1.2.1-1.21.5" = _FMmnFKYR;
        "pkg-1.2.2-1.21.1" = _2VEfCY0R;
        "pkg-1.2.2-1.21.4" = _nivtPtF8;
        "pkg-1.2.2-1.21.5" = _JhS7dF2T;
        "pkg-1.2.2-1.21.6" = _N1ms5ZPe;
        "pkg-1.3.0-1.21.1" = _u0ZoNxgc;
        "pkg-1.3.0-1.21.4" = _6JfkFDZ2;
        "pkg-1.3.0-1.21.5" = _Z2q75DHf;
        "pkg-1.3.0-1.21.6" = _Wc55qveP;
        "pkg-1.3.0-1.21.7" = _lqRaqxbW;
        "pkg-1.3.0-1.21.8" = _NSAR8WrU;
        "pkg-1.3.1-1.21.6" = _Jj7t2LKv;
        "pkg-1.3.1-1.21.9-beta" = _OFZQyUFy;
        "pkg-1.4.1-1.20.1" = _am20L1VD;
        "pkg-1.4.1-1.21.1" = _cm852I16;
        "pkg-1.4.1-1.21.5" = _UJ2nJzka;
        "pkg-1.4.1-1.21.8" = _OF2unNOl;
        "pkg-1.4.1-1.21.10" = _xdWnjjss;
        "pkg-1.4.1-1.21.11" = _X81glAaz;
        "pkg-1.5.0-1.20.1" = _j8E43KMc;
        "pkg-1.5.0-1.21.1" = _A2LHY83S;
