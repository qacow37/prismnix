...
let
    ...
    in {
        ...
        "pkg-1.15" = _3LVlOvXj;
        "pkg-1.15.1" = _FVSp2l4c;
        "pkg-1.15.2" = _kay76451;
        "pkg-1.16" = _9HuyQD5n;
        "pkg-1.16.1" = _s32V9WiM;
        "pkg-1.16.2" = _DXl8rebz;
        "pkg-1.16.3" = _WPWtdGd1;
        "pkg-1.15.4" = _sc4YMSZc;
        "pkg-1.15.5" = _y4yZt5sU;
        "pkg-1.16.4" = _pdY9NWjD;
        "pkg-1.16.5.zip" = _GDPDysyv;
        "pkg-1.15.6" = _ZORKbu6k;
        "pkg-2.0.1.5" = _nZ8OTtG1;
        "pkg-2.0.1.6" = _eVq1B5so;
        "pkg-2.0.3" = _QKC7vX08;
        "pkg-2.0.3.1" = _NddYGuIp;
        "pkg-3.0.0a1" = _I6doQbK2;
        "pkg-2.0.4" = _CME9WrsH;
        "pkg-3.0.0a2" = _E5Quvg4e;
        "pkg-3.0.1" = _Gv5yYlRN;
        "pkg-d" = _4k6sJB6t;
        "pkg-3.1.0a1" = _NtLWSioy;
        "pkg-4.1.0.101" = _JUKeVr5y;
        "pkg-4.1.0.103" = _AU4KlUND;
        "pkg-4.1.0.104" = _l2kZQft8;
        "pkg-4.1.0.105" = _tJJ71ATE;
        "pkg-4.1.0.106" = _OJkBvFUk;
        "pkg-4.1.0.107" = _krbyeJNN;
        "pkg-4.1.0.108" = _r9DaKh4W;
        "pkg-4.1.0.112" = _SJAzBlIV;
        "pkg-4.1.0.113" = _DPrhePIM;
        "pkg-4.1.0.114" = _39AQvc2z;
        "pkg-4.1.0.115" = _OBO76rb9;
        "pkg-4.1.0.116" = _j890cHbu;
        "pkg-4.1.0.117" = _sJnVebo0;
        "pkg-4.1.0.118" = _P2xMhsAd;
        "pkg-5.0.164" = _wxlMRh6i;
        "pkg-5.0.167" = _4Kj3KlMx;
        "pkg-5.0.168" = _DF4NvRW4;
        "pkg-5.0.169" = _vVDwXchh;
        "pkg-5.0.170" = _taPaPkpP;
        "pkg-5.0.171" = _1uUGeaBl;
        "pkg-5.0.172" = _kaaWC3z9;
        "pkg-5.0.173" = _z59qyG1n;
        "pkg-5.0.174" = _7KSjAZIN;
        "pkg-5.0.175" = _YAZYWJZL;
        "pkg-5.0.176" = _1Pn6KeTZ;
        "pkg-5.0.177" = _ADb7U6ao;
        "pkg-5.0.178" = _NuvLIP0z;
        "pkg-5.0.179" = _14k9zxG5;
        "default" = _14k9zxG5;
    });
