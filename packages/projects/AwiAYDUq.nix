...
let
    ...
    in {
        ...
        "pkg-1.20.1-2.7.0.4-FORGE" = _EnlyT7sS;
        "pkg-1.20.1-2.7.0.4-FABRIC" = _jq7DWlcS;
        "pkg-1.19.2-2.8.0.0-FORGE" = _c1Z7FBUk;
        "pkg-1.19.2-2.8.0.0-FABRIC" = _3pyzXaxh;
        "pkg-1.19.4-2.8.0.0-FORGE" = _fnrMr3N8;
        "pkg-1.19.4-2.8.0.0-FABRIC" = _gQHxQtDy;
        "pkg-1.20.1-2.8.0.0-FORGE" = _eEodbQxD;
        "pkg-1.20.1-2.8.0.0-FABRIC" = _enHJ7ovu;
        "pkg-1.19.2-2.8.0.1-FABRIC" = _FlynDQ0N;
        "pkg-1.19.2-2.8.0.1-FORGE" = _sJAKP1VR;
        "pkg-1.20.1-2.8.0.1-FABRIC" = _vqqeLJPV;
        "pkg-1.20.1-2.8.0.1-FORGE" = _T9rUny00;
        "pkg-1.18.2-2.8.1.0" = _aJFRPrMR;
        "pkg-1.19.2-2.8.1.0-FORGE" = _z9wvva9C;
        "pkg-1.19.2-2.8.1.0-FABRIC" = _C6e9a1Jb;
        "pkg-1.19.4-2.8.1.0-FABRIC" = _pAjsg2Yi;
        "pkg-1.19.4-2.8.1.0-FORGE" = _YJMFxjfH;
        "pkg-1.20.1-2.8.1.0-FABRIC" = _wG5g5UHp;
        "pkg-1.20.1-2.8.1.0-FORGE" = _8cHvHAU6;
        "pkg-1.20.4-2.8.1.0-FABRIC" = _8BiKuqgm;
        "pkg-1.20.6-2.8.1.0-FABRIC" = _F01Pbnkm;
        "pkg-1.20.6-2.8.1.0-NEOFORGE" = _F1zyI9Qn;
        "pkg-1.20.4-2.8.1.0-NEOFORGE" = _mVFt1q5d;
        "pkg-1.21-2.8.1.0-NEOFORGE" = _pe2uwwWV;
        "pkg-1.21-2.8.1.0-FABRIC" = _a14dTlhG;
        "pkg-1.21-2.8.1.1-FABRIC" = _2OfACezc;
        "pkg-1.21-2.8.1.1-NEOFORGE" = _lpTfUIDw;
        "pkg-1.21.1-2.8.1.1-FABRIC" = _9tLA4d2b;
        "pkg-1.21.1-2.8.1.1-NEOFORGE" = _9Ox0eudK;
        "pkg-1.21.1-2.8.1.2-FABRIC" = _7sj95ayM;
        "pkg-1.21.1-2.8.1.2-NEOFORGE" = _I8Fso782;
        "pkg-1.20.1-2.9.0.0-FABRIC" = _XsZGTsle;
        "pkg-1.20.1-2.9.0.0-FORGE" = _HdMdhkP4;
        "pkg-1.21.1-2.9.0.0-FABRIC" = _3JCEateP;
        "pkg-1.21.1-2.9.0.0-NEOFORGE" = _mEQNPifZ;
        "pkg-1.20.1-2.9.0.1-FABRIC" = _VYOX6qL9;
        "pkg-1.20.1-2.9.0.1-FORGE" = _bGslU2Jx;
        "pkg-1.21.1-2.9.0.1-FABRIC" = _qi239pde;
        "pkg-1.21.1-2.9.0.1-NEOFORGE" = _v2e96gKA;
        "pkg-1.19.2-2.9.0.1-FABRIC" = _L2nRnpw6;
        "pkg-1.19.2-2.9.0.1-FORGE" = _vRgYm932;
        "pkg-1.18.2-2.9.0.1" = _bUquAWug;
        "pkg-1.21.1-2.9.0.2-FABRIC" = _4Dh2AtzD;
        "pkg-1.21.1-2.9.0.2-NEOFORGE" = _ehLsJI0R;
        "pkg-1.18.2-2.9.0.2" = _bTmKS2lB;
        "pkg-1.19.2-2.9.0.2-FABRIC" = _Vw8ATXEY;
        "pkg-1.19.2-2.9.0.2-FORGE" = _U78YmVxS;
        "pkg-1.20.1-2.9.0.2-FABRIC" = _siAx9JkU;
        "pkg-1.20.1-2.9.0.2-FORGE" = _nPalHcmT;
        "pkg-1.18.2-2.9.0.3" = _swCUXQFm;
        "pkg-1.19.2-2.9.0.3-FORGE" = _pxnn7QGz;
        "pkg-1.19.2-2.9.0.3-FABRIC" = _PjmSS40y;
        "pkg-1.20.1-2.9.0.3-FABRIC" = _7M9c8DgN;
        "pkg-1.20.1-2.9.0.3-FORGE" = _MDkAmRFs;
        "pkg-1.21.1-2.9.0.3-FABRIC" = _aQSIBZxf;
        "pkg-1.21.1-2.9.0.3-NEOFORGE" = _ka4CakEc;
        "pkg-1.18.2-3.0.0.0" = _bWjIQ3WR;
        "pkg-1.19.2-3.0.0.0-FABRIC" = _H1cgSy3F;
        "pkg-1.19.2-3.0.0.0-FORGE" = _HYZh6Nn6;
        "pkg-1.20.1-3.0.0.0-FABRIC" = _bSC2FX2e;
        "pkg-1.20.1-3.0.0.0-FORGE" = _DT11uS2U;
        "pkg-1.21.1-3.0.0.0-FABRIC" = _3duns4LG;
        "pkg-1.21.1-3.0.0.0-NEOFORGE" = _WeKWKqwB;
        "pkg-1.18.2-3.0.0.1" = _uM5xI3CH;
        "pkg-1.19.2-3.0.0.1-FABRIC" = _hJQz2eBu;
        "pkg-1.19.2-3.0.0.1-FORGE" = _seDVpsX1;
        "pkg-1.20.1-3.0.1.0-FABRIC" = _XWWFvtaa;
        "pkg-1.20.1-3.0.1.0-FORGE" = _7PM0DA5r;
        "pkg-1.21.1-3.0.1.0-FABRIC" = _FxlopWW5;
        "pkg-1.21.1-3.0.1.0-NEOFORGE" = _4aiuuINB;
        "pkg-1.21.8-3.0.0.1-FABRIC" = _cIvQqpVF;
        "pkg-1.21.8-3.0.0.1-NEOFORGE" = _Kgff7pQl;
        "pkg-1.18.2-3.0.0.2" = _HmSD9A3t;
        "pkg-1.19.2-3.0.0.2-FABRIC" = _IbpbMN6Z;
        "pkg-1.19.2-3.0.0.2-FORGE" = _MLuc8Vb5;
        "pkg-1.20.1-3.0.1.1-FABRIC" = _LpBiyImh;
        "pkg-1.20.1-3.0.1.1-FORGE" = _McqCZpxI;
        "pkg-1.21.1-3.0.1.1-FABRIC" = _V892Rum0;
        "pkg-1.21.1-3.0.1.1-NEOFORGE" = _92Z7N9wU;
        "pkg-1.21.8-3.1.0.0-FABRIC" = _GwPRM2eb;
        "pkg-1.21.8-3.1.0.0-NEOFORGE" = _6YKXnMrL;
        "pkg-1.20.1-3.0.1.2-FABRIC" = _l32WALHv;
        "pkg-1.20.1-3.0.1.2-FORGE" = _t4YcNELq;
        "pkg-1.21.1-3.0.1.2-FABRIC" = _E8DiEzVk;
        "pkg-1.21.1-3.0.1.2-NEOFORGE" = _KcChnWdL;
        "pkg-1.21.8-3.1.0.1-FABRIC" = _LCjjVMCo;
        "pkg-1.21.8-3.1.0.1-NEOFORGE" = _GaM18Yz9;
        "pkg-1.21.10-3.1.0.1-FABRIC" = _CkW5hqmO;
        "pkg-1.21.10-3.1.0.1-NEOFORGE" = _L5m01hy7;
        "pkg-1.21.1-3.0.1.3-FABRIC" = _YRaVVct3;
        "pkg-1.21.1-3.0.1.3-NEOFORGE" = _GQtnrIVG;
        "pkg-1.21.10-3.1.0.2-FABRIC" = _GFMWjgC4;
        "pkg-1.21.10-3.1.0.2-NEOFORGE" = _3EroOSoq;
        "pkg-1.21.11-3.1.0.2-FABRIC" = _UytF2SJ4;
        "pkg-1.21.11-3.1.0.2-NEOFORGE" = _OFw3TjVn;
        "pkg-26.1.1-3.1.0.2-FABRIC" = _ztHtO8RT;
        "pkg-26.1.1-3.1.0.2-NEOFORGE" = _8IeQA8xm;
        "pkg-26.1.2-3.1.0.2-FABRIC" = _la9JWXPk;
        "pkg-26.1.2-3.1.0.2-NEOFORGE" = _INriVWh1;
        "pkg-1.21.1-3.0.1.4-FABRIC" = _JBf5R06i;
        "pkg-1.21.1-3.0.1.4-NEOFORGE" = _1D7dDzGg;
        "pkg-26.1.2-3.1.0.3-FABRIC" = _TfahntBo;
        "pkg-26.1.2-3.1.0.3-NEOFORGE" = _B5vZdlqQ;
        "pkg-1.21.1-3.0.1.5" = _ig4WmVEo;
        "pkg-1.21.1-3.0.1.5-NEOFORGE" = _aWP826oQ;
        "pkg-26.1.2-3.1.0.5-FABRIC" = _CZxZLWcx;
