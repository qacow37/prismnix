...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge" = _mCir6VwH;
        "pkg-1.0.0-neoforge" = _WDTOIWS0;
        "pkg-1.0.0-fabric" = _iR0RT89C;
        "pkg-2.0.0-fabric" = _rWefIb9z;
        "pkg-2.0.0-forge" = _p8SADTm8;
        "pkg-2.0.0-neoforge" = _CtmmnGQ3;
        "pkg-3.0.0-fabric" = _wLhdzvNC;
        "pkg-3.0.0-forge" = _zxirJJLS;
        "pkg-3.0.0-neoforge" = _q1hMpR0u;
        "pkg-4.0.0-forge" = _8B4dkSoJ;
        "pkg-4.0.0-neoforge" = _AqiEnlKe;
        "pkg-4.0.0-fabric" = _oqvA0WL7;
        "pkg-5.0.0-forge" = _spucjDGT;
        "pkg-5.0.0-neoforge" = _wp3ENqsx;
        "pkg-5.0.0-fabric" = _YJpGc8zp;
        "pkg-6.0.0-forge" = _SrerFeIo;
        "pkg-6.0.0-neoforge" = _8XC6jMcO;
        "pkg-6.0.0-fabric" = _cmysi9Tw;
        "pkg-6.0.1-forge" = _JKM1yWab;
        "pkg-6.0.1-neoforge" = _VP0yCuJS;
        "pkg-6.0.1-fabric" = _VOtB7PYN;
        "pkg-1.0.1-fabric" = _1xUFYact;
        "pkg-1.0.1-forge" = _6OL6pB04;
        "pkg-1.0.1-neoforge" = _ia174lZ4;
        "pkg-2.0.1-forge" = _UrglYSc1;
        "pkg-2.0.1-neoforge" = _btx3Fegz;
        "pkg-2.0.1-fabric" = _AQYcC1YW;
        "pkg-3.0.1-forge" = _z0TqiTBq;
        "pkg-3.0.1-neoforge" = _puNnr8fg;
        "pkg-3.0.1-fabric" = _4iZRmfEU;
        "pkg-5.0.1-forge" = _c731b06W;
        "pkg-5.0.1-neoforge" = _kcFPxrg3;
        "pkg-5.0.1-fabric" = _PJ9CQhyG;
        "pkg-4.0.1-fabric" = _3yQ78isT;
        "pkg-4.0.1-forge" = _nw2yxZcD;
        "pkg-4.0.1-neoforge" = _vl2StjBV;
        "pkg-6.0.2-forge" = _Y07dSLvl;
        "pkg-6.0.2-neoforge" = _wjg5f9kq;
        "pkg-6.0.2-fabric" = _IaE7mvxR;
        "pkg-7.0.0-forge" = _GwIIFfzp;
        "pkg-7.0.0-neoforge" = _hSRvI2bX;
        "pkg-7.0.0-fabric" = _NTV13ilI;
        "pkg-8.0.0-fabric" = _oFn97fcO;
        "pkg-9.0.0" = _375sAHD1;
        "pkg-10.0.0" = _IPuXjWYa;
        "default" = _IPuXjWYa;
    });
