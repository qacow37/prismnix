...
let
    ...
    in {
        ...
        "pkg-0.3.1" = _81a5dJBk;
        "pkg-0.3.2" = _tQCz0o0o;
        "pkg-0.3.2.5" = _gV4Xmgws;
        "pkg-0.3.2.7" = _z7WRdSWm;
        "pkg-0.3.8" = _mcSZcv9v;
        "pkg-0.3.9" = _6dVgXVmJ;
        "pkg-0.3.4.0" = _jG2WIuAE;
        "pkg-0.3.4.1" = _arifll6o;
        "pkg-0.4.4" = _P2nNhYV3;
        "pkg-0.4.6" = _R7IDQUSr;
        "pkg-0.4.6.5" = _VcOqCbob;
        "pkg-0.4.7.5" = _KXeK0vse;
        "pkg-0.4.8" = _KNIDpJx6;
        "pkg-0.4.8.5" = _wj6YPflz;
        "pkg-0.4.9" = _LpR0Reo9;
        "pkg-0.5.0" = _6FNcxEtg;
        "pkg-0.5.1" = _dRRimdxF;
        "pkg-0.5.2" = _x2XaPrxD;
