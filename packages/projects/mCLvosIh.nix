...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.21.5" = _66SSIkH0;
        "pkg-1.0.2+1.21.5" = _yl0I1F1f;
        "pkg-1.0.3+1.21.5" = _qPRy1Rfk;
        "pkg-1.0.4+1.21.5" = _BPQ4q1Q0;
        "pkg-1.0.4+1.21.6" = _AX2FZHDJ;
        "pkg-1.0.5+1.21.9" = _zgFnIBAV;
