...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.5-fabric" = _hkUj2ViG;
        "pkg-1.18.2-2.5-fabric" = _YIfyoUkd;
        "pkg-1.19.2-2.6-fabric" = _2VQu9sEo;
        "pkg-1.16.5-2.2-forge" = _oNgydOp6;
        "pkg-1.18.2-2.2-forge" = _ZvO4jzYe;
        "pkg-1.19.2-2.4-forge" = _qimwhaYL;
        "pkg-1.16.5-2.7-fabric" = _kz9mKPR9;
        "pkg-1.18.2-2.7-fabric" = _hfzwvzNk;
        "pkg-1.19.2-2.7-fabric" = _girTwqSa;
        "pkg-1.16.5-2.7-forge" = _QfvQALSB;
        "pkg-1.18.2-2.7-forge" = _OK69qakH;
        "pkg-1.19.2-2.7-forge" = _tagWBKXi;
        "pkg-1.16.5-2.8-fabric" = _aCm65ctS;
        "pkg-1.18.2-2.8-fabric" = _OOHNbVi1;
        "pkg-1.19.2-2.8-fabric" = _qdNvCdW3;
        "pkg-1.16.5-2.9-fabric" = _f8myW7up;
        "pkg-1.18.2-2.9-fabric" = _FGUUflbl;
        "pkg-1.19.2-2.9-fabric" = _2NSRrvMX;
        "pkg-1.16.5-2.9-forge" = _qwF07yAK;
        "pkg-1.18.2-2.9-forge" = _wGKsOXmC;
        "pkg-1.19.2-2.9-forge" = _HIr4x1dV;
        "pkg-1.19.3-2.9-forge" = _cNbUjYNG;
        "pkg-1.19.3-3.0-fabric" = _GsC7mA2F;
        "pkg-1.18.2-4.0-forge+fabric" = _Wq32XvXm;
        "pkg-1.19.2-4.0-forge+fabric" = _BDg9cj62;
        "pkg-1.19.3-4.0-forge+fabric" = _4lrgww2F;
        "pkg-1.18.2-4.1-forge+fabric" = _gflwsxNG;
        "pkg-1.19.2-4.1-forge+fabric" = _rJbcw2Cr;
        "pkg-1.19.3-4.1-forge+fabric" = _iYAd8XyT;
        "pkg-1.18.2-4.2-forge+fabric" = _y3iP0aYU;
        "pkg-1.19.2-4.2-forge+fabric" = _P8CiH7jB;
        "pkg-1.19.3-4.2-forge+fabric" = _koE7pMyL;
        "pkg-1.19.4-4.2-forge+fabric" = _CiqqoNgW;
        "pkg-1.20-4.2-forge+fabric" = _xDnQ1BuF;
        "pkg-1.20.1-4.2-forge+fabric" = _zwXYtaeA;
        "pkg-1.20.2-4.2-forge+fabric" = _AT37Pzna;
        "pkg-1.18.2-4.3-forge+fabric" = _hmdiIqRG;
        "pkg-1.19.2-4.3-forge+fabric" = _26tBpUL7;
        "pkg-1.20.1-4.3-forge+fabric" = _FOYdFytU;
        "pkg-1.20.2-4.3-forge+fabric" = _MwenIW8R;
        "pkg-1.20.3-4.3-fabric+forge+neo" = _qo7U3Ign;
        "pkg-1.20.4-4.3-fabric+forge+neo" = _rY40CcyZ;
        "pkg-1.19.2-4.4-fabric+forge+neo" = _IoMKW4jA;
        "pkg-1.20.1-4.4-fabric+forge+neo" = _IDNrJ0dg;
        "pkg-1.20.2-4.4-fabric+forge+neo" = _GQUPZ02J;
        "pkg-1.20.4-4.4-fabric+forge+neo" = _USt0GUai;
        "pkg-1.20.5-4.4-fabric+neo" = _lChtp9yC;
        "pkg-1.20.6-4.4-fabric+forge+neo" = _JKcHdTuO;
        "pkg-1.20.6-4.5-fabric+forge+neo" = _enp1u1LU;
        "pkg-1.19.2-4.6-fabric+forge" = _Nxc497Z7;
        "pkg-1.20.1-4.6-fabric+forge+neo" = _WjB6PpPT;
        "pkg-1.20.4-4.6-fabric+forge+neo" = _nZhiSoZf;
        "pkg-1.20.6-4.6-fabric+forge+neo" = _xRDpMdOO;
        "pkg-1.20.4-4.7-fabric+forge+neo" = _G0d9Kf3f;
        "pkg-1.21.0-4.7-fabric+forge+neo" = _lXUKABT8;
        "pkg-1.20.1-4.8-fabric+forge+neo" = _L37HLUzm;
        "pkg-1.20.6-4.8-fabric+forge+neo" = _hdlqCyxC;
        "pkg-1.21.0-4.8-fabric+forge+neo" = _bCXp3L4B;
        "pkg-1.21.1-4.8-fabric+forge+neo" = _aadF29hI;
        "pkg-1.21.2-4.8-fabric+neo" = _jJp64krN;
        "pkg-1.21.3-4.8-fabric+forge+neo" = _8IIUxQVc;
        "pkg-1.21.4-4.8-fabric+forge+neo" = _SztaAE6S;
        "pkg-1.20.1-4.9-fabric+forge+neo" = _9DiaGkWm;
        "pkg-1.21.1-4.9-fabric+forge+neo" = _bWnbJPUG;
        "pkg-1.21.4-4.9-fabric+forge+neo" = _dAi1KIqh;
        "pkg-1.21.5-4.9-fabric+forge+neo" = _t6olO0Jh;
        "pkg-1.21.6-4.9-fabric+forge+neo" = _tyhTsNBi;
        "pkg-1.21.7-4.9-fabric+forge+neo" = _RWOrbRwt;
        "pkg-1.21.8-4.9-fabric+forge+neo" = _mIculsPk;
        "pkg-1.21.9-4.9-fabric+forge+neo" = _NtXUUlts;
        "pkg-1.21.10-4.9-fabric+forge+neo" = _FuH8MD8p;
        "pkg-1.21.11-4.9-fabric+forge+neo" = _927igUFh;
        "pkg-26.1.0-4.9-fabric+forge+neo" = _jWXT2wdF;
        "pkg-26.1.1-4.9-fabric+forge+neo" = _nVvCHlH0;
        "pkg-26.1.2-4.9-fabric+forge+neo" = _fgRFIXg2;
        "pkg-26.2.0-4.9-fabric+forge+neo" = _BSY8cdGB;
        "default" = _BSY8cdGB;
    });
