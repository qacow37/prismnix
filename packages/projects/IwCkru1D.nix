...
let
    ...
    in {
        ...
        "pkg-0.6.2+1.20.1-and-below" = _PEImAedd;
        "pkg-0.7.0+1.20.2-and-above" = _luIegII0;
        "pkg-0.7.0+1.20.1" = _u8cWgFE6;
        "pkg-0.7.0+1.19.4-and-below" = _ZkQKFAbJ;
        "pkg-0.7.1+1.20.2-1.20.4" = _wpHUQeA4;
        "pkg-0.7.1+1.20.5-and-above" = _2f39XjN4;
        "pkg-0.7.1+1.20.1" = _hhopxVRV;
        "pkg-0.7.1+1.19.4-and-below" = _XM0YCIBB;
        "pkg-0.7.2+1.20.1" = _WpV6Y82S;
        "pkg-0.7.2+1.20.2-1.20.4" = _bDA9VZEp;
        "pkg-0.7.2+1.19.4-and-below" = _6VmwaWJr;
        "pkg-0.7.2+1.20.5-and-above" = _rRMwOU3h;
        "pkg-0.8.0+1.21-and-above" = _HfP4bdJn;
        "pkg-0.8.0+1.19.4-and-below" = _OQhW8FBI;
        "pkg-0.8.0+1.20.2-1.20.4" = _E0WgVnaa;
        "pkg-0.8.0+1.20.1" = _9psK23zq;
        "pkg-0.8.0+1.20.5-1.20.6" = _oFEpIdEv;
        "pkg-0.8.1+1.19.4-and-below" = _5CEpk8Co;
        "pkg-0.8.1+1.20.5-1.20.6" = _fSCl6zUx;
        "pkg-0.8.1+1.21-and-above" = _i13D9AEP;
        "pkg-0.8.1+1.20.1" = _ZSSZMYi4;
        "pkg-0.8.1+1.20.2-1.20.4" = _ReqAfjII;
        "pkg-0.8.2+1.21-and-above" = _Y5lU0K1M;
        "pkg-0.8.2+1.20.5-1.20.6" = _2EipZmzD;
        "pkg-0.8.2+1.19.4-and-below" = _YoG4zfKf;
        "pkg-0.8.2+1.20.2-1.20.4" = _dr9LtKHe;
        "pkg-0.8.2+1.20.1" = _4l5JfWtt;
        "pkg-0.8.3+1.21-and-above" = _cIHtzziG;
        "pkg-0.8.3+1.20.2-1.20.4" = _RvdY0Fah;
        "pkg-0.8.3+1.20.1" = _Kuqg1f1T;
        "pkg-0.8.3+1.20.5-1.20.6" = _ByQwgWWG;
        "pkg-0.8.3+1.19.4-and-below" = _5SnYrYGj;
        "pkg-0.9.0+1.21.2-and-above" = _BqfYve3z;
        "pkg-0.9.0+1.21-1.21.1" = _YFPHyMDg;
        "pkg-0.9.0+1.20.2-1.20.4" = _eoQEj0cL;
        "pkg-0.9.0+1.20.5-1.20.6" = _cFtmfnWj;
        "pkg-0.9.0+1.20.1" = _K98WxFOc;
        "pkg-0.9.0+1.19.4-and-below" = _ueWHEQmP;
        "pkg-0.9.1+1.20.5-1.20.6" = _K8LQRFZZ;
        "pkg-0.9.1+1.21.2-and-above" = _DymgmgKi;
        "pkg-0.9.1+1.20.1" = _6jlAIocM;
        "pkg-0.9.1+1.21-1.21.1" = _HWeAZGqJ;
        "pkg-0.9.1+1.19.4-and-below" = _5n1IKWjE;
        "pkg-0.9.1+1.20.2-1.20.4" = _zGZbAXEg;
        "pkg-0.9.2+1.21-1.21.1" = _zpRIMOsj;
        "pkg-0.9.2+1.20.5-1.20.6" = _WgpwlaHH;
        "pkg-0.9.2+1.20.2-1.20.4" = _DuwrbkXd;
        "pkg-0.9.2+1.19.4-and-below" = _wO1Z3rOO;
        "pkg-0.9.2+1.21.2-and-above" = _L7wJtcR6;
        "pkg-0.9.2+1.20.1" = _vQa9oDJZ;
        "pkg-0.10.0+1.21-1.21.1" = _uLxpBgtR;
        "pkg-0.10.0+1.21.4-and-above" = _jm7JnLJs;
        "pkg-0.10.0+1.19.4-and-below" = _7qFZQ5Jm;
        "pkg-0.10.0+1.20.5-1.20.6" = _wBfwSQBI;
        "pkg-0.10.0+1.20.2-1.20.4" = _KBueHJTu;
        "pkg-0.10.0+1.21.2-1.21.3" = _MBT0IhQ6;
        "pkg-0.10.0+1.20.1" = _QqUlBANU;
        "pkg-0.10.1+1.21.4-and-above" = _MenI4DME;
        "pkg-0.10.1+1.20.2-1.20.4" = _gaffZvps;
        "pkg-0.10.1+1.21-1.21.1" = _R4DkAEz6;
        "pkg-0.10.1+1.21.2-1.21.3" = _FZRif7hC;
        "pkg-0.10.1+1.19.4-and-below" = _97szMfqV;
        "pkg-0.10.1+1.20.1" = _Sp7RYsJr;
        "pkg-0.10.1+1.20.5-1.20.6" = _bI45rRlg;
        "pkg-0.10.2+1.19.4-and-below" = _eOGA04sa;
        "pkg-0.10.2+1.21.4-and-above" = _PslsnPn1;
        "pkg-0.10.2+1.21.2-1.21.3" = _ozxXgJUC;
        "pkg-0.10.2+1.20.1" = _cdcYbTHt;
        "pkg-0.10.2+1.20.2-1.20.4" = _jevgCg03;
        "pkg-0.10.2+1.21-1.21.1" = _D0uiTidv;
        "pkg-0.10.2+1.20.5-1.20.6" = _5riacEFu;
        "pkg-0.11.0+1.21.4-and-above" = _ykfc8AAr;
        "pkg-0.11.0+1.21.2-1.21.3" = _u2gPcvDu;
        "pkg-0.11.0+1.20.1" = _Hg6XTHNL;
        "pkg-0.11.0+1.20.2-1.20.4" = _LZSpRwDU;
        "pkg-0.11.0+1.21-1.21.1" = _vBT7gghL;
        "pkg-0.11.0+1.19.4-and-below" = _5xZnYSbg;
        "pkg-0.11.0+1.20.5-1.20.6" = _nJJZ9Tq9;
        "pkg-0.11.1+1.21.4-and-above" = _1qLj5Ww4;
        "pkg-0.11.1+1.21-1.21.1" = _KM72VmlH;
        "pkg-0.11.1+1.21.2-1.21.3" = _a359HjIU;
        "pkg-0.11.1+1.20.5-1.20.6" = _fwrC5shs;
        "pkg-0.11.1+1.20.2-1.20.4" = _mJmS9h8h;
        "pkg-0.11.1+1.19.4-and-below" = _Ampw8KQk;
        "pkg-0.11.1+1.20.1" = _ZIltZXAZ;
        "pkg-0.11.2+1.20.5-1.20.6" = _F6ZDcicg;
        "pkg-0.11.2+1.21-1.21.1" = _HFIKqFiU;
        "pkg-0.11.2+1.20.2-1.20.4" = _M5mftUva;
        "pkg-0.11.2+1.20.1" = _zye7FOUT;
        "pkg-0.11.2+1.21.4-and-above" = _pc93tKpk;
        "pkg-0.11.2+1.19.4-and-below" = _h354mpjj;
        "pkg-0.11.2+1.21.2-1.21.3" = _M6ZzZpds;
        "pkg-0.11.3+1.20.1" = _zQgVBm8e;
        "pkg-0.11.3+1.21.2-1.21.3" = _D5D9Ds80;
        "pkg-0.11.3+1.20.2-1.20.4" = _jGVjPILM;
        "pkg-0.11.3+1.19.4-and-below" = _gysFsg46;
        "pkg-0.11.3+1.21-1.21.1" = _5mIzloNr;
        "pkg-0.11.3+1.20.5-1.20.6" = _BFoNZVTR;
        "pkg-0.11.3+1.21.4-and-above" = _Qf80NyTf;
        "pkg-0.11.4+1.20.5-1.20.6" = _6XvAYM1d;
        "pkg-0.11.4+1.20.2-1.20.4" = _zgFUd8D6;
        "pkg-0.11.4+1.21.4-and-above" = _cZAAvr8q;
        "pkg-0.11.4+1.20.1" = _ljc06vny;
        "pkg-0.11.4+1.19.4-and-below" = _o2H8SA32;
        "pkg-0.11.4+1.21.2-1.21.3" = _E2YdcA6S;
        "pkg-0.11.4+1.21-1.21.1" = _qlX3f2e4;
        "pkg-0.11.5+1.20.5-1.20.6" = _N1KQ31eJ;
        "pkg-0.11.5+1.21.2-1.21.3" = _V2Euf3U9;
        "pkg-0.11.5+1.20.2-1.20.4" = _bxTZqN1r;
        "pkg-0.11.5+1.21-1.21.1" = _1qr5DKrA;
        "pkg-0.11.5+1.21.4-and-above" = _MTnsmntc;
        "pkg-0.11.5+1.19.4-and-below" = _6OBnu0bY;
        "pkg-0.11.5+1.20.1" = _uSccIM3o;
        "pkg-0.11.6+1.20.5-1.20.6" = _F5uKi7LD;
        "pkg-0.11.6+1.21.2-1.21.3" = _i5zk2VIi;
        "pkg-0.11.6+1.21-1.21.1" = _GSIdLHAk;
        "pkg-0.11.6+1.20.2-1.20.4" = _EDyrKZCp;
        "pkg-0.11.6+1.21.4-and-above" = _AdjO0f78;
        "pkg-0.11.6+1.19.4-and-below" = _EHnHWkkA;
        "pkg-0.11.6+1.20.1" = _5wG0PPOy;
        "pkg-0.11.7+1.21.4-and-above" = _eJXy78Wf;
        "pkg-0.11.7+1.19.4-and-below" = _C0PZgWvE;
        "pkg-0.11.7+1.20.2-1.20.4" = _fmxMQeAE;
        "pkg-0.11.7+1.21.2-1.21.3" = _Z4ycSEN9;
        "pkg-0.11.7+1.21-1.21.1" = _ij1QE2dg;
        "pkg-0.11.7+1.20.5-1.20.6" = _l09QBupR;
        "pkg-0.11.7+1.20.1" = _j8S6ewbl;
        "pkg-0.11.8+1.20.5-1.20.6" = _yHtLhfZV;
        "pkg-0.11.8+1.21.4" = _aRZPEhnV;
        "pkg-0.11.8+1.21.5-and-above" = _Dz03NFew;
        "pkg-0.11.8+1.21-1.21.1" = _E2dzuYiD;
        "pkg-0.11.8+1.20.2-1.20.4" = _xt6qC0A3;
        "pkg-0.11.8+1.21.2-1.21.3" = _3s6M34bv;
        "pkg-0.11.8+1.20.1" = _9tOpS3GP;
        "pkg-0.11.8+1.19.4-and-below" = _wa1DgUMK;
        "pkg-0.11.9+1.20.1" = _b5hR26aK;
        "pkg-0.11.9+1.20.2-1.20.4" = _71CnkUtA;
        "pkg-0.11.9+1.21.5-and-above" = _PgAWAiwk;
        "pkg-0.11.9+1.21-1.21.1" = _6GUNKeaz;
        "pkg-0.11.9+1.21.4" = _bnYVU2TT;
        "pkg-0.11.9+1.21.2-1.21.3" = _CT1rdyHG;
        "pkg-0.11.9+1.20.5-1.20.6" = _lI8zGNgx;
        "pkg-0.11.9+1.19.4-and-below" = _px17UrQs;
        "pkg-0.12.0+1.21.5-and-above" = _jqJJRvqa;
        "pkg-0.12.0+1.21.2-1.21.3" = _ev0PKGdA;
        "pkg-0.12.0+1.19.4-and-below" = _PKI0U7rQ;
        "pkg-0.12.0+1.21-1.21.1" = _W8AU5brJ;
        "pkg-0.12.0+1.21.4" = _I91yvkNV;
        "pkg-0.12.0+1.20.5-1.20.6" = _lnCulnHV;
        "pkg-0.12.0+1.20.1" = _xWe2dDoQ;
        "pkg-0.12.0+1.20.2-1.20.4" = _rCRxfo4A;
        "pkg-0.13.0+1.21.4" = _g9JEgL4s;
        "pkg-0.13.0+1.21.5-and-above" = _l8eap2NP;
        "pkg-0.13.0+1.20.1" = _V4Hke1bi;
        "pkg-0.13.0+1.21.2-1.21.3" = _RwVwdGX7;
        "pkg-0.13.0+1.21-1.21.1" = _Rc7ndpKI;
        "pkg-0.13.0+1.20.2-1.20.4" = _atRhYVNZ;
        "pkg-0.13.0+1.20.5-1.20.6" = _ZCB7eZyB;
        "pkg-0.13.0+1.19.4-and-below" = _r1QsSSEd;
        "pkg-0.13.1+1.21.4" = _H07jRmMJ;
        "pkg-0.13.1+1.21.5-and-above" = _2LuLtZUC;
        "pkg-0.13.1+1.20.5-1.20.6" = _TLdT7VZK;
        "pkg-0.13.1+1.20.1" = _bloIrVc5;
        "pkg-0.13.1+1.21.2-1.21.3" = _Dc6fGjIi;
        "pkg-0.13.1+1.21-1.21.1" = _W9GCQZ1l;
        "pkg-0.13.1+1.20.2-1.20.4" = _J8SxGI7z;
        "pkg-0.13.1+1.19.4-and-below" = _ysWVylNy;
        "pkg-0.14.0+1.21.5" = _q8Bu2TKC;
        "pkg-0.14.0+1.21.6-and-above" = _dZvST0VN;
        "pkg-0.14.0+1.20.2-1.20.4" = _7lbGs9aU;
        "pkg-0.14.0+1.21.4" = _G7xBVWC7;
        "pkg-0.14.0+1.21-1.21.1" = _Zi45JWSs;
        "pkg-0.14.0+1.20.5-1.20.6" = _kXPe8gKo;
        "pkg-0.14.0+1.19.4-and-below" = _tyKgmwWn;
        "pkg-0.14.0+1.20.1" = _JJSNQ0UP;
        "pkg-0.14.0+1.21.2-1.21.3" = _FWq4hiyX;
        "pkg-0.14.1+1.21.5" = _eIVm4ToW;
        "pkg-0.14.1+1.21.6-and-above" = _UWpvo0Hg;
        "pkg-0.14.1+1.21.2-1.21.3" = _SMeZO20X;
        "pkg-0.14.1+1.21-1.21.1" = _sB6kdZvO;
        "pkg-0.14.1+1.21.4" = _sHj9gA1U;
        "pkg-0.14.1+1.20.5-1.20.6" = _ReGOoPEZ;
        "pkg-0.14.1+1.20.1" = _BX4nXjub;
        "pkg-0.14.1+1.20.2-1.20.4" = _WWJThyJK;
        "pkg-0.14.1+1.19.4-and-below" = _2zB5KZ92;
        "pkg-0.14.2+1.21.6-and-above" = _IuhIWrCl;
        "pkg-0.14.2+1.21.4" = _zyeNFEKi;
        "pkg-0.14.2+1.20.5-1.20.6" = _P4QtfATY;
        "pkg-0.14.2+1.19.4-and-below" = _xXLpaO8Z;
        "pkg-0.14.2+1.21-1.21.1" = _WShXU7Bd;
        "pkg-0.14.2+1.21.2-1.21.3" = _LB6EPkmT;
        "pkg-0.14.2+1.20.1" = _NnSiZSe6;
        "pkg-0.14.2+1.21.5" = _PUmgNaEH;
        "pkg-0.14.2+1.20.2-1.20.4" = _haZikdEl;
        "pkg-0.14.2+1.21.9-1.21.10" = _iG23acuk;
        "pkg-0.14.2+1.21.6-1.21.8" = _qqkFe1AL;
        "pkg-0.14.3+1.21.9-1.21.10" = _CqAskfnS;
        "pkg-0.14.3+1.21.6-1.21.8" = _Ezsw7hJc;
        "pkg-0.14.3+1.21.5" = _Ty20g6YD;
        "pkg-0.14.3+1.21-1.21.1" = _ulZDYpW0;
        "pkg-0.14.3+1.21.4" = _Lg1UhwXg;
        "pkg-0.14.3+1.20.1" = _BWXjXtWI;
        "pkg-0.14.3+1.20.5-1.20.6" = _BhCWku9R;
        "pkg-0.14.3+1.20.2-1.20.4" = _vnDCWnzc;
        "pkg-0.14.3+1.21.2-1.21.3" = _yEeBo4X0;
        "pkg-0.14.3+1.19.4-and-below" = _AeKVY91b;
        "pkg-0.15.0+26.1" = _NkXK7GTK;
