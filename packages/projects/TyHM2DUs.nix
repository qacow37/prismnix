...
let
    ...
    in {
        ...
        "pkg-1.0.2-beta+1.21.4" = _k2HTidyh;
        "pkg-1.0.3-beta+1.21.4" = _16xw5v5o;
        "pkg-1.0.4-beta+1.21.4" = _yA0U0gjb;
        "pkg-1.0.5-beta+1.21.4" = _AMEW5c6t;
        "pkg-1.0.7-beta+1.21.4" = _bzUeD488;
        "pkg-1.0.8-beta+1.21.5" = _LgnfI5wi;
        "pkg-1.0.8-beta+1.21.1" = _9QbdfFR7;
        "pkg-1.0.9-beta+1.21.1" = _ZEaOLnj0;
        "pkg-1.0.9-beta+1.21.5" = _WH1SRIXh;
        "pkg-1.0.9-beta+1.21.7" = _ewJqICLd;
        "pkg-1.0.9-beta+1.21.8" = _oD0WCOvR;
        "pkg-1.0.10-beta+1.21.8" = _8GEgJQHq;
        "pkg-1.0.11-beta+1.21.8" = _6ihqOL1d;
        "pkg-1.0.11-beta+1.21.10" = _Rjx96Sky;
        "pkg-1.0.11-beta+1.21.11" = _z6EecwPo;
        "pkg-v1.0.12+1.21.11" = _18lsdsn4;
