...
let
    ...
    in {
        ...
        "pkg-1.0.0-mc1.20" = _hTVPhWVA;
        "pkg-1.0.0-mc1.19.4" = _KEX5gJAl;
        "pkg-1.1.0-mc1.20-beta1" = _wSRNkrOi;
        "pkg-1.1.0-mc1.19.4-beta1" = _yVcOLZN5;
        "pkg-1.1.0-mc1.20-beta2" = _S63xujZs;
        "pkg-1.1.0-mc1.19.4-beta2" = _dRS7zEe7;
        "pkg-1.1.0-mc1.20" = _dYguUutE;
        "pkg-1.1.0-mc1.19.4" = _JvM2bzQX;
        "pkg-1.1.1-mc1.20" = _MHQ9ycoY;
        "pkg-1.1.1-mc1.19.4" = _7471i2lu;
        "pkg-1.1.2-mc1.19.4-beta1" = _O3hu94no;
        "pkg-1.1.2-mc1.20-beta1" = _8o2iZ9vW;
        "pkg-1.1.2-mc1.19.4-beta2" = _PvcjXyee;
        "pkg-1.1.2-mc1.20-beta2" = _4y1Z18Hm;
        "pkg-1.1.2-mc1.19.4" = _Cq9odRSO;
        "pkg-1.1.2-mc1.20" = _4k3ZUaSe;
        "pkg-1.1.2-mc1.20.2" = _s5jpWoML;
        "pkg-1.2.0-mc1.19.4" = _jTR0hwQO;
        "pkg-1.2.0-mc1.20.2" = _IVuY0Wpn;
        "pkg-1.2.0-mc1.20.4" = _yu30WQJg;
        "pkg-1.2.0-mc1.20" = _ceLvGwxS;
        "pkg-1.2.0-mc1.20.6" = _Ony0qa0S;
        "default" = _Ony0qa0S;
    });
