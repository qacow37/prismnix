...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _A10j624p;
        "pkg-1.1.1" = _YiPF54vj;
        "pkg-1.1.1+mod" = _1ppPKmpb;
        "pkg-1.2.0" = _RTCEE8Jo;
        "pkg-1.2.0+mod" = _PaTd6fbS;
        "pkg-1.2.1" = _cNa0UD5M;
        "pkg-1.2.1+mod" = _Xz7BNT03;
        "pkg-1.2.2" = _P7ohZqZB;
        "pkg-1.2.2+mod" = _dEQBfAN7;
        "pkg-1.3.0" = _rggIHOPY;
        "pkg-1.3.0+mod" = _MBZQY1fA;
        "pkg-1.3.1-beta" = _YuFiZhfU;
        "pkg-1.3.1-beta+mod" = _uUMEL112;
        "pkg-1.3.1" = _Qka7W5uU;
        "pkg-1.4.0" = _o1kqRIVh;
        "pkg-1.4.0+mod" = _tl9RXvGA;
        "pkg-1.5.0" = _l2AoyidA;
        "pkg-1.5.0+mod" = _WsgpZZ6i;
        "pkg-1.5.1" = _TpI5wO2Q;
        "pkg-1.5.1+mod" = _zYiVpKb7;
        "pkg-1.6.0" = _zWUopK6v;
        "pkg-1.6.0+mod" = _UgfNDxE9;
        "pkg-1.6.1" = _eYWfsvLo;
        "pkg-1.6.1+mod" = _33kBdKie;
        "default" = _33kBdKie;
    });
