...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21" = _uei0hnVx;
        "pkg-1.0.0+1.21.1" = _OE4Wldj8;
        "pkg-1.0.0+1.21.2" = _ybrik4rL;
        "pkg-1.0.0+1.21.3" = _IQ6t6Jxx;
        "pkg-1.0.0+1.21.4" = _n4zRjDEi;
        "pkg-1.1.0+1.21.4" = _lawbZhWw;
        "pkg-1.1.0+1.21.3" = _eFih0DRj;
        "pkg-1.1.0+1.21.2" = _YVyvsT96;
        "pkg-1.1.0+1.21.1" = _KsGhsBI6;
        "pkg-1.1.0+1.21" = _CcOFKK6L;
        "pkg-1.2.0+1.21.4" = _YFHRDeeh;
        "pkg-1.2.0+1.21.3" = _UKfNzslp;
        "pkg-1.2.0+1.21.2" = _ASMIBptK;
        "pkg-1.2.0+1.21.1" = _EU8lRlBP;
        "pkg-1.2.0+1.21" = _HYW4L1dz;
        "pkg-1.2.1+1.21.5" = _UJqX77wm;
        "pkg-1.2.1+1.21.4" = _H3KCmalD;
        "pkg-1.2.1+1.21.3" = _GzeIpKo4;
        "pkg-1.2.1+1.21.2" = _rYnjWWzc;
        "pkg-1.2.1+1.21.1" = _dAF2gBj0;
        "pkg-1.2.1+1.21" = _kk27xUd4;
        "pkg-1.2.2+1.21" = _9NTEUD5Q;
        "pkg-1.2.2+1.21.1" = _yxmL5q2D;
        "pkg-1.2.2+1.21.2" = _Af7JtF8B;
        "pkg-1.2.2+1.21.3" = _acJvpV4K;
        "pkg-1.2.2+1.21.4" = _dMNjNOAT;
        "pkg-1.2.2+1.21.5" = _qylmwt5w;
        "pkg-1.2.2+1.21.6" = _qc8DJAAY;
        "pkg-1.2.2+1.21.7" = _nT7TEjoN;
        "pkg-1.3.0+1.21" = _UGThPkuI;
        "pkg-1.3.0+1.21.1" = _z76rJ3ym;
        "pkg-1.3.0+1.21.2" = _UL54kock;
        "pkg-1.3.0+1.21.3" = _HXMJLpYT;
        "pkg-1.3.0+1.21.4" = _WmozyTWu;
        "pkg-1.3.0+1.21.5" = _pYLKlV6k;
        "pkg-1.3.0+1.21.7" = _Cvx4OoFd;
        "pkg-1.3.0+1.21.6" = _Nyiw6wsA;
        "pkg-1.3.0+1.21.8" = _aWjjGwYZ;
        "default" = _aWjjGwYZ;
    });
