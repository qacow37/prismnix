...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.21.8" = _bK6zbDCR;
        "pkg-0.2.0+1.21.8" = _aghiez1U;
        "pkg-0.3.0+1.21.8" = _LH8TOHiX;
        "pkg-1.0.0+1.21.8" = _ahu4hl0l;
        "pkg-1.1.0+1.21.8" = _ZVg2cqok;
        "pkg-1.2.0+1.21.10" = _mpLa3SeG;
        "pkg-1.1.1+1.21.8" = _AnxFStPh;
        "pkg-1.2.1+1.21.10" = _8fR6hRVz;
        "pkg-1.3.1+1.21.10" = _F5ENTlpC;
        "pkg-1.2.1+1.21.8" = _MCCSq02K;
        "pkg-1.2.2+1.21.8" = _UYOqZSC4;
        "pkg-1.3.2+1.21.10" = _487OnELW;
        "pkg-1.3.2+1.21.5" = _a53LJIua;
        "pkg-1.4.0+1.21.5" = _p0hx7z2D;
        "pkg-1.4.0+1.21.10" = _3fZnwo04;
        "pkg-1.4.0+1.21.8" = _R1dD3BMy;
        "pkg-1.4.1+1.21.10" = _lML20caO;
        "pkg-1.4.1+1.21.5" = _TkuMp7Dm;
        "pkg-1.4.1+1.21.8" = _lhaEcL4h;
        "pkg-1.5.0+1.21.10" = _B6d6Ei4e;
        "pkg-1.5.0+1.21.5" = _goVkDvaI;
        "pkg-1.5.0+1.21.8" = _MIp2HeMp;
        "pkg-1.5.1+1.21.10" = _3DGcxcIT;
        "pkg-1.5.1+1.21.11" = _N0KMvU8w;
        "pkg-1.5.1+1.21.5" = _QG9amiW9;
        "pkg-1.5.1+1.21.8" = _kV9GS1DQ;
        "pkg-2.0.0+1.21.8" = _I7QPijKJ;
        "pkg-2.0.0+1.21.10" = _CQKEXYxg;
        "pkg-2.0.0+1.21.5" = _Jn3BYsdd;
        "pkg-2.0.0+26.1.2" = _yEZRzIod;
        "pkg-2.0.0+1.21.11" = _oSnKYe5f;
        "pkg-2.0.0+26.2" = _wJ9UZEeB;
        "pkg-2.1.0+1.21.5" = _BoabLUsH;
        "pkg-2.1.0+26.1.2" = _9p3IRUzO;
        "pkg-2.1.0+1.21.8" = _gYrcuVQ8;
        "pkg-2.1.0+1.21.11" = _XzSohLBY;
        "pkg-2.1.0+26.2" = _bWsPvrL0;
        "pkg-2.1.0+1.21.10" = _7L2ugCQU;
        "pkg-2.1.1+1.21.10" = _UO9mcGYK;
        "pkg-2.1.1+26.2" = _PHqHDtCb;
        "pkg-2.1.1+1.21.11" = _Oid4DMbp;
        "pkg-2.1.1+1.21.5" = _5rPBTKne;
        "pkg-2.1.1+1.21.8" = _WQJu5xpC;
        "pkg-2.1.1+26.1.2" = _4TKHme9h;
        "pkg-3.0.0+26.1.2-neoforge" = _ZSBxtdMv;
        "pkg-3.0.0+26.2-neoforge" = _422qlh2O;
        "pkg-3.0.0+1.21.11-neoforge" = _snfvSmjE;
        "pkg-3.0.0+1.21.10-neoforge" = _dSn5j8Xg;
        "pkg-3.0.0+1.21.8-neoforge" = _w0tQSsxM;
        "pkg-3.0.0+1.21.5-neoforge" = _O72ld6Qd;
        "pkg-3.0.0+26.1.2-fabric" = _LCoChXSz;
        "pkg-3.0.0+1.21.5-fabric" = _Dz88eXRY;
        "pkg-3.0.0+26.2-fabric" = _QDfnlPu0;
        "pkg-3.0.0+1.21.8-fabric" = _5fW1Lhpk;
        "pkg-3.0.0+1.21.10-fabric" = _xiglfz7M;
        "pkg-3.0.0+1.21.11-fabric" = _UofPKQ0X;
        "default" = _UofPKQ0X;
    });
