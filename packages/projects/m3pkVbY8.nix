...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _OD4Usd0B;
        "pkg-v4.0.2-1.19.2-Fabric" = _3k3bHylY;
        "pkg-v4.0.2-1.19.2-Forge" = _T0Ez2ktf;
        "pkg-v5.0.0-1.19.3-Forge" = _t5sItqM4;
        "pkg-v5.0.0-1.19.3-Fabric" = _jkMnlu9X;
        "pkg-v6.0.0-1.19.4-Fabric" = _i61fFeRh;
        "pkg-v6.0.0-1.19.4-Forge" = _1FnEHjuD;
        "pkg-v7.0.0-1.20-Forge" = _ERoeRHqK;
        "pkg-v7.0.1-1.20-Forge" = _cz1vs2su;
        "pkg-v7.0.1-1.20-Fabric" = _2e5pNAk7;
        "pkg-v8.0.0-1.20.1-Forge" = _aQcerSRS;
        "pkg-v8.0.0-1.20.1-Fabric" = _ppi4nxw2;
        "pkg-v20.4.0-1.20.4-Fabric" = _WHajTItR;
        "pkg-v20.4.0-1.20.4-Forge" = _SMRLZtwh;
        "pkg-v20.4.0-1.20.4-NeoForge" = _vFcGXfZU;
        "pkg-v20.4.1-1.20.4-Fabric" = _yIxYwyrT;
        "pkg-v20.4.1-1.20.4-Forge" = _my890QJd;
        "pkg-v20.4.1-1.20.4-NeoForge" = _sTAgP73Z;
        "pkg-v21.0.0-1.21-Fabric" = _Wh7KL2Qo;
        "pkg-v21.0.0-1.21-NeoForge" = _ZsUylc3Q;
        "pkg-v21.1.0-1.21.1-Fabric" = _ZzetGLxh;
        "pkg-v21.1.0-1.21.1-NeoForge" = _oL3CaIJ1;
        "pkg-v21.3.0-1.21.3-Fabric" = _u0Cu4vnA;
        "pkg-v21.3.0-1.21.3-NeoForge" = _wQI21hZA;
        "pkg-v21.4.0-1.21.4-Fabric" = _uO2rsKIh;
        "pkg-v21.4.0-1.21.4-NeoForge" = _xKqtgJzn;
        "pkg-v21.5.0-1.21.5-Fabric" = _h75YwIlj;
        "pkg-v21.5.0-1.21.5-NeoForge" = _cnlyKPNd;
        "pkg-v21.1.1-1.21.1-Fabric" = _APmtBE6m;
        "pkg-v21.1.1-1.21.1-NeoForge" = _S5sNyRsY;
        "pkg-v21.5.1-1.21.5-Fabric" = _EdjjGXJn;
        "pkg-v21.5.1-1.21.5-NeoForge" = _mICf6KEE;
        "pkg-v21.6.0-1.21.6-Fabric" = _tdsEwZoZ;
        "pkg-v21.6.0-1.21.6-NeoForge" = _k3d4Umm7;
        "pkg-v21.7.0-1.21.7-Fabric" = _SuDWSl7A;
        "pkg-v21.7.0-1.21.7-NeoForge" = _LK428vkg;
        "pkg-v21.8.0-1.21.8-Fabric" = _QHcfdO5N;
        "pkg-v21.8.0-1.21.8-NeoForge" = _amcoPawS;
        "pkg-21.9.0" = _EHNpoBWh;
        "pkg-21.10.0" = _GCoO1wZb;
        "pkg-21.11.0" = _UnrA4zZi;
