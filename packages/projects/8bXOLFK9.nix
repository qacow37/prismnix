...
let
    ...
    in {
        ...
        "pkg-+1.21.8-neoforge" = _3yzDDOAL;
        "pkg-+1.21.7-neoforge" = _QiO4g7Al;
        "pkg-+1.21.6-neoforge" = _DVfqWr4P;
        "pkg-+1.21.1-neoforge" = _C4i417X7;
        "pkg-+1.21.8-paper" = _ZBR5NKd5;
        "pkg-+1.21.3-neoforge" = _MMrTRmco;
        "pkg-+1.21.7-paper" = _JBxdAYpR;
        "pkg-+1.21.10-fabric" = _o4rynR6Z;
        "pkg-+1.21.3-fabric" = _m1ZCYQMI;
        "pkg-+1.21.6-paper" = _THgqKKfu;
        "pkg-+1.21.5-fabric" = _v1sumXrd;
        "pkg-+1.21.1-fabric" = _XneqUawA;
        "pkg-+1.21.5-paper" = _Kd6h16xB;
        "pkg-+1.21.10-neoforge" = _6nWqZPwy;
        "pkg-+1.21.4-paper" = _wlwmhJNc;
        "pkg-+1.21.6-fabric" = _Z0D7MhHV;
        "pkg-+1.21.1-paper" = _l1nE7sag;
        "pkg-+1.21.9-paper" = _RZItEQhH;
        "pkg-+1.21.8-fabric" = _V1j3zFrs;
        "pkg-+1.21.3-paper" = _BuOu1r0t;
        "pkg-+1.21.9-fabric" = _T80fFUPb;
        "pkg-+1.21.10-paper" = _hOYV8f2u;
        "pkg-+1.21.7-fabric" = _wIzdDpe2;
        "pkg-+1.21.4-fabric" = _QxMLZKNe;
        "pkg-+1.21.4-neoforge" = _tJZmR6Ed;
        "pkg-+1.21.9-neoforge" = _igGFi2R6;
        "pkg-+1.21.5-neoforge" = _rGhswVCo;
        "pkg-1.1.0+1.21.3-paper" = _eGn25XP0;
        "pkg-1.1.0+1.21.1-paper" = _62QYEzoR;
        "pkg-1.1.0+1.21.10-paper" = _pFYq8Lqn;
        "pkg-1.1.0+1.21.11-paper" = _SVb24nnw;
        "pkg-1.1.0+1.21.1-fabric" = _6Jn5K34F;
        "pkg-1.1.0+1.21.10-fabric" = _7NJAlaRM;
        "pkg-1.1.0+1.21.9-paper" = _M7EMba5O;
        "pkg-1.1.0+1.21.4-paper" = _t1CHgRxE;
        "pkg-1.1.0+1.21.3-fabric" = _LReJDsuL;
        "pkg-1.1.0+1.21.6-paper" = _mWHNjhgL;
        "pkg-1.1.0+1.21.5-fabric" = _z1je6vhT;
        "pkg-1.1.0+1.21.5-paper" = _pmNI7nBA;
        "pkg-1.1.0+1.21.11-fabric" = _9nbyPcH3;
        "pkg-1.1.0+1.21.9-fabric" = _Wt5C8rYh;
        "pkg-1.1.0+1.21.7-paper" = _mkgAG95h;
        "pkg-1.1.0+1.21.7-fabric" = _wg6y8w7I;
        "pkg-1.1.0+1.21.6-fabric" = _3zwPIv6F;
        "pkg-1.1.0+1.21.8-fabric" = _IqDaX2KV;
        "pkg-1.1.0+1.21.4-fabric" = _sjrGHB1t;
        "pkg-1.1.0+1.21.3-neoforge" = _JKyM2ckZ;
        "pkg-1.1.0+1.21.6-neoforge" = _Fs83gUIc;
        "pkg-1.1.0+1.21.10-neoforge" = _s190svIy;
        "pkg-1.1.0+1.21.1-neoforge" = _nxxM2TKF;
        "pkg-1.1.0+1.21.7-neoforge" = _7S5Nn4sW;
        "pkg-1.1.0+1.21.8-neoforge" = _RqXyfvpD;
        "pkg-1.1.0+1.21.4-neoforge" = _xb856gLy;
        "pkg-1.1.0+1.21.9-neoforge" = _fCkWN79j;
        "pkg-1.1.0+1.21.5-neoforge" = _9ENjkQew;
        "pkg-1.1.0+1.21.11-neoforge" = _wy4ufP9v;
        "default" = _wy4ufP9v;
    });
