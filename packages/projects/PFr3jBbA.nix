...
let
    ...
    in {
        ...
        "pkg-1.0.0-neoforge-1.21.1-21.1.213" = _O1LBkakk;
        "pkg-1.0.0-fabric-1.21.4-0.119.4" = _pftJShyz;
        "pkg-1.0.0-forge-1.21.4-54.1.8" = _6Ryqm8mL;
        "pkg-1.0.0-neoforge-1.21.4-21.8.49" = _Ga09BbkS;
        "pkg-1.0.0-fabric-1.21.8-0.136.0" = _nDWESYGv;
        "pkg-1.0.0-forge-1.21.8-58.1.7" = _jRvMmQjA;
        "pkg-1.0.0-neoforge-1.21.8-21.8.49" = _qNUuAzY2;
        "pkg-1.0.0-fabric-1.21.10-0.136.0" = _MlK76BN6;
        "pkg-1.0.0-forge-1.21.10-60.0.9" = _cecypA99;
        "pkg-1.0.0-neoforge-1.21.10-21.10.43-" = _xoX5Zctk;
        "pkg-1.1.0-forge-1.21.10-60.0.9" = _sWTo21xV;
        "pkg-1.1.0-neoforge-1.21.10-21.10.43-" = _ekcGfOS6;
        "pkg-1.1.0-fabric-1.21.10-0.136.0" = _sDMJ3Prv;
        "pkg-1.1.0-forge-1.21.8-58.1.7" = _hp3ZNjEu;
        "pkg-1.1.0-neoforge-1.21.8-21.8.49" = _Z3JAhlOh;
        "pkg-1.1.0-fabric-1.21.8-0.136.0" = _kJ4S1hZi;
        "pkg-1.1.0-forge-1.21.4-54.1.8" = _3JF1kxeZ;
        "pkg-1.1.0-fabric-1.21.4-0.119.4" = _hf30EEk0;
        "pkg-1.1.0-neoforge-1.21.4-21.8.49" = _82Y21613;
        "pkg-1.1.0-forge-1.21.1-52.1.5" = _51J1zNHt;
        "pkg-1.1.0-neoforge-1.21.1-21.1.213" = _Oo6zhzrW;
        "pkg-1.1.0-fabric-1.21.1-0.116.7" = _fPihijLn;
        "pkg-1.1.0-forge-1.20.1-47.4.10" = _lW88BCSg;
        "pkg-1.1.0-forge-1.21.11-61.0.2" = _VDPA1rOi;
        "pkg-1.1.0-neoforge-1.21.11-21.11.10-" = _zwknBqap;
        "pkg-1.1.0-fabric-1.21.11-0.140.0" = _q884O4YC;
        "pkg-1.1.0-fabric-1.21.5-0.128.2" = _A0Naa33h;
        "pkg-1.1.1-fabric-26.1.2-0.145.4" = _K67V0kSv;
        "pkg-1.1.1-forge-26.1.2-64.0.0" = _5sQio0K8;
        "pkg-1.1.1-neoforge-26.1.2.3" = _LAXXhLTc;
        "pkg-1.1.1-forge-1.20.1-47.4.10" = _fPMpAPzZ;
