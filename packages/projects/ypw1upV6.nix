...
let
    ...
    in {
        ...
        "pkg-2.0.1+1.19.3" = _4FIqV9ar;
        "pkg-2.1.0+1.19.4" = _CkgUCTI3;
        "pkg-2.1.0+1.20" = _5mjQVQon;
        "pkg-2.2.0+1.20.2" = _ivlCttXK;
        "pkg-2.3.0+1.20.3" = _OtK4Daic;
        "pkg-2.5.0-alpha.1+1.21-noui" = _Zbnq4v0j;
        "pkg-2.4.0-alpha.8+1.20.5" = _OEYJDEBv;
        "pkg-3.0.0-beta.2+1.20.5" = _pKwab1fZ;
        "pkg-3.0.0-beta.2+1.21" = _ChT2CnPP;
        "pkg-3.0.0-beta.2+1.21.2" = _gmIbsG1c;
        "pkg-3.0.0+1.20.5" = _ns8mRI5p;
        "pkg-3.0.0+1.21" = _Q4w53L2C;
        "pkg-3.0.0+1.21.2" = _BlM4lX2V;
        "pkg-3.0.0+1.21.4" = _ukG98Wbl;
        "pkg-3.0.1+1.20.5" = _zT8IKuzR;
        "pkg-3.0.1+1.21" = _c5PaZHvV;
        "pkg-3.0.1+1.21.2" = _BijkLGEo;
        "pkg-3.0.1+1.21.4" = _Yz6W44iy;
        "pkg-3.0.1+1.21.5" = _X25OYjyW;
        "pkg-3.0.2+1.21.5" = _79DpwUdO;
        "pkg-3.0.2+1.21.6" = _DO0yJOpp;
        "pkg-3.0.3+1.21.5" = _B8OKTj4l;
        "pkg-3.0.3+1.21.6" = _7pHTILpG;
        "pkg-3.1.0+1.21.6" = _cwh61KvW;
        "pkg-3.1.0+1.21.9" = _x64lddyV;
        "pkg-3.1.1+1.21.6" = _U6xO3Nvr;
        "pkg-3.1.1+1.21.9" = _TKF4tvBG;
        "pkg-3.2.0+1.21.11" = _QvxryG71;
        "pkg-3.2.1+1.21.11" = _bQodxQmI;
        "pkg-3.2.2+1.21.11" = _SssKDaKw;
        "pkg-3.2.2+26.1" = _SRjz9XZF;
        "pkg-4.0.1+26.1-forge" = _vQIL1smh;
        "pkg-4.0.1+26.1-neoforge" = _Yvhw51G9;
        "pkg-4.0.1+26.1-fabric" = _bN86sb1g;
