...
let
    ...
    in {
        ...
        "pkg-1.20.1-3.0.0.1-FORGE" = _VaNOkVJS;
        "pkg-1.19.2-1.1.0.2-FORGE" = _VdjYMDVE;
        "pkg-1.19.4-2.0.0.2-FORGE" = _ibKtyTIG;
        "pkg-1.19.2-3.0.0.2-FORGE" = _9oJK1FwS;
        "pkg-1.19.2-3.0.0.2-FABRIC" = _Dghw70lA;
        "pkg-1.19.4-3.0.0.2-FORGE" = _qFEeN1Wp;
        "pkg-1.20.1-3.0.0.2-FORGE" = _o8hjQvLV;
        "pkg-1.20.1-3.0.0.2-FABRIC" = _wywWx0Ub;
        "pkg-1.19.4-3.0.0.2-FABRIC" = _xUcSpIZd;
        "pkg-1.18.2-3.1.0.1-FORGE" = _Mqwb9p92;
        "pkg-1.18.2-3.1.0.1-FABRIC" = _TzICWvRb;
        "pkg-1.19.2-3.1.0.1-FORGE" = _JzqHlPKT;
        "pkg-1.19.2-3.1.0.1-FABRIC" = _5hMNExru;
        "pkg-1.19.4-3.1.0.1-FORGE" = _TSERS24K;
        "pkg-1.19.4-3.1.0.1-FABRIC" = _5yfcESSM;
        "pkg-1.20.1-3.1.0.1-FORGE" = _Vz8xARIh;
        "pkg-1.20.1-3.1.0.1-FABRIC" = _e1jJjulH;
        "pkg-1.18.2-3.1.0.2-FORGE" = _chsCXxGC;
        "pkg-1.18.2-3.1.0.2-FABRIC" = _byzCvNSG;
        "pkg-1.19.2-3.1.0.2-FORGE" = _5doFox3Y;
        "pkg-1.19.2-3.1.0.2-FABRIC" = _ftsoxL1c;
        "pkg-1.19.4-3.1.0.2-FORGE" = _EC94faYu;
        "pkg-1.19.4-3.1.0.2-FABRIC" = _LmJGq8Ff;
        "pkg-1.20.1-3.1.0.2-FORGE" = _7eS9eKJN;
        "pkg-1.20.1-3.1.0.2-FABRIC" = _McOXQE2j;
        "pkg-1.18.2-3.1.0.3-FORGE" = _MSEo61mh;
        "pkg-1.19.2-3.1.0.3-FORGE" = _CEKbQT8h;
        "pkg-1.19.4-3.1.0.3-FORGE" = _IOxiu3gK;
        "pkg-1.20.1-3.1.0.3-FORGE" = _2EB4O0kI;
        "pkg-1.19.2-3.1.0.4-FORGE" = _R6IsBztY;
        "pkg-1.19.4-3.1.0.4-FORGE" = _QNhCPEEp;
        "pkg-1.19.2-3.1.0.4-FABRIC" = _SDmq2hzt;
        "pkg-1.19.4-3.1.0.4-FABRIC" = _rP0FLAoT;
        "pkg-1.20.1-3.1.0.4-FABRIC" = _YgNXRO7d;
        "pkg-1.20.1-3.1.0.4-FORGE" = _vF9W1o3N;
        "pkg-1.20.4-3.1.0.4-FABRIC" = _qn4IfUVj;
        "pkg-1.20.4-3.1.0.5-NEOFORGE" = _nQlHeruW;
        "pkg-1.20.6-3.1.0.4-FABRIC" = _niRfpLxC;
        "pkg-1.20.6-3.1.0.4-NEOFORGE" = _jucWHRBG;
        "pkg-1.21-3.1.0.4-FABRIC" = _CWvq1YC3;
        "pkg-1.21-3.1.0.4-NEOFORGE" = _vGAvbEzd;
        "pkg-1.18.2-3.1.0.4-FABRIC" = _vlF0ze6H;
        "pkg-1.18.2-3.1.0.4-FORGE" = _oJv5gnwY;
        "pkg-1.19.2-3.1.0.5-FABRIC" = _RlnttnHw;
        "pkg-1.19.2-3.1.0.5-FORGE" = _kJHxJxjM;
        "pkg-1.20.1-3.1.0.5-FABRIC" = _T6V583JM;
        "pkg-1.20.1-3.1.0.5-FORGE" = _jzG7tvOS;
        "pkg-1.20.4-3.1.0.6-FABRIC" = _tOVRc3Kq;
        "pkg-1.20.4-3.1.0.6-NEOFORGE" = _Q43766Y7;
        "pkg-1.20.6-3.1.0.5-FABRIC" = _3b3TxUFb;
        "pkg-1.20.6-3.1.0.5-NEOFORGE" = _G5qA9aia;
        "pkg-1.21-3.1.0.5-FABRIC" = _ITetSBkZ;
        "pkg-1.21-3.1.0.5-NEOFORGE" = _OQgQhAgg;
        "pkg-1.18.2-3.1.0.5-FORGE" = _k6Si34c8;
        "pkg-1.18.2-3.1.0.5-FABRIC" = _Pj5Qyqa9;
        "pkg-1.19.2-3.1.0.6-FABRIC" = _2PydmNtZ;
        "pkg-1.19.2-3.1.0.6-FORGE" = _QlpGYGPV;
        "pkg-1.20.1-3.1.0.6-FABRIC" = _5RVVPZvB;
        "pkg-1.20.1-3.1.0.6-FORGE" = _P9DX2WaT;
        "pkg-1.21-3.1.0.6-FABRIC" = _jUwhtX5C;
        "pkg-1.21-3.1.0.6-NEOFORGE" = _Q4TNWg1f;
        "pkg-1.21.1-3.1.0.6-FABRIC" = _DvikdE88;
        "pkg-1.21.1-3.1.0.6-NEOFORGE" = _YCkwRV1a;
        "pkg-1.21.1-3.1.0.7-FABRIC" = _bkzXIlVC;
        "pkg-1.21.1-3.1.0.7-NEOFORGE" = _ivr6Igde;
        "pkg-1.21.3-3.1.0.7-FABRIC" = _RaPb1u7s;
        "pkg-1.21.3-3.1.0.7-NEOFORGE" = _jg4LV0PU;
        "pkg-1.18.2-3.1.1.1-FABRIC" = _DDKR5guu;
        "pkg-1.18.2-3.1.1.1-FORGE" = _J712m5Di;
        "pkg-1.19.2-3.1.1.1-FABRIC" = _cDFfGK5p;
        "pkg-1.19.2-3.1.1.1-FORGE" = _51R2shTf;
        "pkg-1.20.1-3.1.1.1-FABRIC" = _vBPw1HR6;
        "pkg-1.20.1-3.1.1.1-FORGE" = _7hKBiPWL;
        "pkg-1.21.1-3.1.1.1-FABRIC" = _qCHel9SW;
        "pkg-1.21.1-3.1.1.1-NEOFORGE" = _tDStMRRk;
        "pkg-1.21.3-3.1.1.1-FABRIC" = _KT2XGPaY;
        "pkg-1.21.3-3.1.1.1-NEOFORGE" = _js4xWs8H;
        "pkg-1.21.4-3.1.1.1-FABRIC" = _41R14ee5;
        "pkg-1.21.4-3.1.1.1-NEOFORGE" = _Mj9XkfTw;
        "pkg-1.21.5-3.1.1.1-FABRIC" = _TiN14Sw5;
        "pkg-1.21.5-3.1.1.1-NEOFORGE" = _XvMPQ3pf;
        "pkg-1.21.8-3.1.1.1-NEOFORGE" = _w2VaFAyW;
        "pkg-1.21.8-3.1.1.1.1-FABRIC" = _gTz12dYx;
        "pkg-1.20.1-3.2.0.0-FORGE" = _DwDiN7PE;
        "pkg-1.21.1-3.2.0.0-FABRIC" = _1V2jFsWs;
        "pkg-1.21.1-3.2.0.0-NEOFORGE" = _6KFQCE6Z;
        "pkg-1.21.8-3.2.0.0-FABRIC" = _WjBrbVlA;
        "pkg-1.21.8-3.2.0.0-NEOFORGE" = _s3rOL6uN;
        "pkg-1.20.1-3.2.0.1-FABRIC" = _XYDeWz1m;
        "pkg-1.20.1-3.2.0.1-FORGE" = _NSZRo6r6;
        "pkg-1.20.1-3.3.0.0-FABRIC" = _WQ2vMtgx;
        "pkg-1.20.1-3.3.0.0-FORGE" = _EqSJKvIo;
        "pkg-1.21.8-3.3.0.0-FABRIC" = _HogkkKbW;
        "pkg-1.21.8-3.3.0.0-NEOFORGE" = _xx9hDjgx;
        "pkg-1.18.2-3.2.0.1-FABRIC" = _xQbZ41Yd;
        "pkg-1.18.2-3.2.0.1-FORGE" = _yp46iAFx;
        "pkg-1.19.2-3.1.1.2-FABRIC" = _Hq5qn7Rq;
        "pkg-1.19.2-3.1.1.2-FORGE" = _siWM0ZtC;
        "pkg-1.20.1-3.3.0.1-FABRIC" = _Bkyg1GGJ;
        "pkg-1.20.1-3.3.0.1-FORGE" = _6tnJxYz1;
        "pkg-1.21.1-3.3.1.0-FABRIC" = _OyBlMD9f;
        "pkg-1.21.1-3.3.1.0-NEOFORGE" = _DYMnTIPr;
        "pkg-1.21.8-3.3.1.0-FABRIC" = _Tw9taM12;
        "pkg-1.21.8-3.3.1.0-NEOFORGE" = _jKZPegPu;
        "pkg-1.18.2-3.3.4.0-FABRIC" = _JTz0KYrG;
        "pkg-1.18.2-3.3.4.0-FORGE" = _EHKGtaQA;
        "pkg-1.18.2-3.3.4.1-FABRIC" = _crjmaLMW;
        "pkg-1.18.2-3.3.4.1-FORGE" = _iKJx7nKB;
        "pkg-1.19.2-3.3.4.1-FABRIC" = _xkWH5IPX;
        "pkg-1.19.2-3.3.4.1-FORGE" = _6fnk7Rtq;
        "pkg-1.20.1-3.3.4.1-FABRIC" = _bMWDD9kj;
        "pkg-1.20.1-3.3.4.1-FORGE" = _cYPBdYi0;
        "pkg-1.21.1-3.3.4.1-FABRIC" = _xGhxIWXs;
        "pkg-1.21.1-3.3.4.1-NEOFORGE" = _I7WAg9QI;
        "pkg-1.21.8-3.3.4.1-FABRIC" = _EU9KR9Hb;
        "pkg-1.21.8-3.3.4.1-NEOFORGE" = _e6ywv29K;
        "pkg-1.18.2-3.3.4.2-FABRIC" = _ClUmB3Ct;
        "pkg-1.18.2-3.3.4.2-FORGE" = _ZAOOuyKo;
        "pkg-1.19.2-3.3.4.2-FABRIC" = _hHHaUtot;
        "pkg-1.19.2-3.3.4.2-FORGE" = _5wLL2wl9;
        "pkg-1.20.1-3.3.4.2-FABRIC" = _Hxivck9P;
        "pkg-1.20.1-3.3.4.2-FORGE" = _lS8vNAax;
        "pkg-1.21.1-3.3.4.2-FABRIC" = _PEZPcoLk;
        "pkg-1.21.1-3.3.4.2-NEOFORGE" = _8CGtI06c;
        "pkg-1.21.8-3.3.4.2-FABRIC" = _X4XERCvW;
        "pkg-1.21.8-3.3.4.2-NEOFORGE" = _j2YvEDCe;
        "pkg-1.21.1-3.3.4.3-FABRIC" = _yedMfWC6;
        "pkg-1.21.1-3.3.4.3-NEOFORGE" = _zn4hx9Mb;
        "pkg-1.21.8-3.3.4.3-FABRIC" = _AXAwYo1X;
        "pkg-1.21.8-3.3.4.3-NEOFORGE" = _4W234QLp;
        "pkg-1.21.8-3.3.4.4-FABRIC" = _xKR1boKe;
        "pkg-1.21.8-3.3.4.4-NEOFORGE" = _Zsy9SveF;
        "pkg-1.18.2-3.3.4.3-FABRIC" = _wsIzR4cW;
        "pkg-1.18.2-3.3.4.3-FORGE" = _9I70bzSm;
        "pkg-1.19.2-3.3.4.3-FABRIC" = _Tvbm9xt4;
        "pkg-1.19.2-3.3.4.3-FORGE" = _MdGdgayz;
        "pkg-1.20.1-3.3.4.3-FABRIC" = _T6RZ0kFM;
        "pkg-1.20.1-3.3.4.3-FORGE" = _i7wCr3Ed;
        "pkg-1.20.1-3.3.4.4-FABRIC" = _bjZfXnUK;
        "pkg-1.20.1-3.3.4.4-FORGE" = _4P2SF6kI;
        "pkg-1.21.1-3.3.4.4-FABRIC" = _toEm684q;
        "pkg-1.21.1-3.3.4.4-NEOFORGE" = _oVNmqhey;
        "pkg-1.21.8-3.3.4.5-FABRIC" = _4XuNnTzx;
        "pkg-1.21.8-3.3.4.5-NEOFORGE" = _1WOwSCL9;
        "pkg-1.20.1-3.3.4.5-FABRIC" = _cwWtzkRW;
        "pkg-1.20.1-3.3.4.5-FORGE" = _gWa5dl34;
        "pkg-1.21.1-3.3.4.5-FABRIC" = _ScKQmaMS;
        "pkg-1.21.1-3.3.4.5-NEOFORGE" = _m1erAVaJ;
        "pkg-1.21.8-3.3.4.6-FABRIC" = _N91mBtwr;
        "pkg-1.21.8-3.3.4.6-NEOFORGE" = _QxXSr5FY;
        "pkg-1.21.1-3.3.5.0-FABRIC" = _y74BiTWO;
        "pkg-1.21.1-3.3.5.0-NEOFORGE" = _rziiPOO1;
        "pkg-1.21.9-3.3.5.0-FABRIC" = _RRqfbm2k;
        "pkg-1.21.9-3.3.5.0-NEOFORGE" = _CE4to6r1;
        "pkg-1.21.10-3.3.5.0-FABRIC" = _5quPM93E;
        "pkg-1.21.10-3.3.5.0-NEOFORGE" = _3SfYfygZ;
        "pkg-1.21.1-3.3.6.0-FABRIC" = _TqC3EONp;
        "pkg-1.21.1-3.3.6.0-NEOFORGE" = _mARowwzg;
        "pkg-1.21.10-3.3.6.0-FABRIC" = _IIcYeu6W;
        "pkg-1.21.10-3.3.6.0-NEOFORGE" = _mbGKlwIi;
        "pkg-1.21.1-3.3.6.1-FABRIC" = _ZdiCCJNN;
        "pkg-1.21.1-3.3.6.1-NEOFORGE" = _8V3xP6uy;
        "pkg-1.21.1-3.3.6.2-FABRIC" = _xlclI4Mf;
        "pkg-1.21.1-3.3.6.2-NEOFORGE" = _O3sUSfWA;
        "pkg-1.21.10-3.3.6.2-FABRIC" = _ZZ8gbfVy;
        "pkg-1.21.10-3.3.6.2-NEOFORGE" = _Dm9nsOR6;
        "pkg-1.21.11-3.3.6.2-FABRIC" = _TnL0P0Of;
        "pkg-1.21.11-3.3.6.2-NEOFORGE" = _o2IWb9d9;
        "pkg-1.21.11-3.3.6.3-FABRIC" = _J9YqBuRw;
        "pkg-1.21.11-3.3.6.3-NEOFORGE" = _NnPm56BY;
        "pkg-26.1.2-4.1.0.1-FABRIC" = _CV7nbIwk;
        "pkg-26.1.2-4.1.0.1-NEOFORGE" = _Ex1UGAew;
        "pkg-26.1.2-4.1.1.1-FABRIC" = _HxZZWTYS;
        "pkg-26.1.2-4.1.1.1-NEOFORGE" = _HrlHqrm7;
        "pkg-26.1.2-4.1.1.2-FABRIC" = _aThuOVhQ;
        "pkg-26.1.2-4.1.1.2-NEOFORGE" = _tM4fOTTa;
        "pkg-26.1.2-4.1.1.3-FABRIC" = _2JKugwxn;
        "pkg-26.1.2-4.1.1.3-NEOFORGE" = _JyWflSY2;
        "pkg-1.21.1-3.3.6.3-FABRIC" = _dTNbe6uN;
        "pkg-1.21.1-3.3.6.3-NEOFORGE" = _Ho93yCC3;
        "pkg-26.1.2-4.1.1.4-FABRIC" = _MpS8NGtJ;
        "pkg-26.1.2-4.1.1.4-NEOFORGE" = _hoRsZdZS;
        "pkg-26.1.2-4.1.1.5-FABRIC" = _dYU8qRl5;
        "pkg-26.1.2-4.1.1.5-NEOFORGE" = _SX9wKHAK;
        "pkg-26.1.2-4.1.1.6-FABRIC" = _pYWJOBHq;
        "pkg-26.1.2-4.1.1.6-NEOFORGE" = _fkX07tGx;
        "pkg-26.1.2-4.1.1.7-FABRIC" = _P73zAmiF;
