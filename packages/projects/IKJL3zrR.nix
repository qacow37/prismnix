...
let
    ...
    in {
        ...
        "pkg-2.0.1" = _j3WgxQqE;
        "pkg-build.10" = _p0bi47kc;
        "pkg-build.9" = _VvLsLdqd;
        "pkg-build.8" = _KlIq0tNL;
        "pkg-build.7" = _3gImittD;
        "pkg-build.6" = _tFZ10H4j;
        "pkg-build.4" = _6kXpdSt5;
        "pkg-build.2" = _M226vXVc;
        "pkg-build.1" = _6fF0vxLZ;
        "pkg-1.0.6" = _6cqnURR2;
        "pkg-1.0.5" = _LzMTZBQU;
        "pkg-1.0.4" = _tauC6MoA;
        "pkg-1.0.3" = _wVpIuEx9;
        "pkg-1.0.2" = _ofhF07LY;
        "pkg-1.0.1" = _zIQhMgFt;
        "pkg-84.0.0" = _VL7QT7wH;
        "pkg-87.0.0" = _WVkre3tN;
