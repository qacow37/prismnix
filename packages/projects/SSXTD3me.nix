...
let
    ...
    in {
        ...
        "pkg-2.3" = _iAzrxJ7D;
        "pkg-2.4+rev.1e3856a-indev" = _97uSxlGh;
        "pkg-2.4+rev.0fa9137-indev" = _zUPmgQGW;
        "pkg-2.4+rev.4ecce40-indev" = _v4wbWdEX;
        "pkg-2.4+rev.a522a0a-indev" = _WNa0NUs9;
        "pkg-2.4+rev.dcbacf3-indev" = _L6Og3iCW;
        "pkg-2.4+rev.ebc7a05-indev" = _CpytXxYy;
        "pkg-2.4+rev.5577ab6-indev" = _Hav3O06k;
        "pkg-2.4+rev.a188b50-indev" = _wuYrutJq;
        "pkg-2.4-5c2bec6-indev" = _wn0QoUcV;
        "pkg-2.4" = _BHYvM9Uv;
        "pkg-2.4.1-05d4caa-indev" = _T7E7ApxF;
        "pkg-2.4.1" = _hEu3Vlau;
        "pkg-2.4.1-7159cf9-indev" = _Xpw8H7xq;
        "pkg-2.4.2-c3c6ed1" = _aRu1mAPv;
        "pkg-2.4.2-292e9e1" = _1Kdbqhpt;
        "pkg-2.4.2-9be17da-javadoc" = _7LVgIyxZ;
        "pkg-2.4.2-d6a5e83" = _HebuEnIl;
        "pkg-2.4.2-2ef92d1" = _3Q0JvFeE;
        "pkg-2.5-8ee6918" = _brkOoHzJ;
        "pkg-2.5-d11ee08" = _9xETMoRQ;
        "pkg-2.5-9668d1f" = _H1syVAWF;
        "pkg-2.5-e4067a7" = _HOTomTlz;
        "pkg-2.5-5c933b2" = _SXVblftc;
        "pkg-2.5-1189f20" = _6XHPH5eh;
        "pkg-2.5-1eba0a9" = _7c4TkwAp;
        "pkg-2.5-6fbdae7" = _8oiZMNJI;
        "pkg-2.5-6403bdc" = _pOiX6psP;
        "pkg-2.5" = _GOApKhS8;
        "pkg-2.5-f9f1306" = _m7EcUC2E;
        "pkg-2.5.1-602fb8f" = _zCUypv39;
        "pkg-2.5.1-255cd3a" = _kNqcXZAW;
        "pkg-2.5.1-fe86fdc" = _lM5SN0sa;
        "pkg-2.5.1-b802053" = _4GwSHSeE;
        "pkg-2.5.1" = _X8Is5g8e;
        "pkg-2.6-4434272" = _F3U8oys6;
        "pkg-2.6-e751a02" = _S9a3pfLj;
        "pkg-2.6-10ea6d5" = _PDYnGZpu;
        "pkg-2.6-6fb417b" = _V9Wlb4cW;
        "pkg-2.6-1b9fc8e" = _M2zjrySj;
        "pkg-2.6-6b1a2d0" = _DJ2WnUvG;
        "pkg-2.6-be30a2b" = _9BIHF11H;
        "pkg-2.6-e3f804d" = _rHPL6qGM;
        "pkg-2.6" = _K0oWsRQf;
        "pkg-2.6-8bb5524" = _1XXMSQ6h;
        "pkg-2.6-54aeacd" = _Y78wjhID;
        "pkg-2.6.1-c2f4dc7" = _Z5WU9vXP;
        "pkg-2.6.1" = _TLiKj15G;
        "pkg-2.6.2-e27cc55" = _1ozdzLdq;
        "pkg-2.6.2" = _X2KIQqbU;
        "pkg-2.6.2-d053d95" = _TqoVvTV1;
        "pkg-2.6.3-f1ce19c" = _t8SzSQR6;
        "pkg-2.6.3-06a1c2d" = _8R64m5lv;
        "pkg-2.6.3-756c23d" = _EJox4Dp8;
        "pkg-2.6.3-a35012e" = _VIbmU7BX;
        "pkg-2.7-7f7bc93" = _xLu2z09I;
        "pkg-2.7-1380c7b" = _xjfGYyo9;
        "pkg-2.7" = _WqFiXs7z;
        "pkg-2.7-5d41615" = _2SXButga;
        "pkg-2.7.1-83c5833" = _CLJHZ4jA;
        "pkg-2.7.1" = _vyOfGsar;
        "pkg-2.7.1-01a1e17" = _mYjLXEJG;
        "pkg-2.7.1-247a0b2" = _REyrDogO;
        "pkg-2.7.1-b552909" = _I65D7xfo;
        "pkg-2.7.1-33e59b4" = _eQ41Pyqh;
        "pkg-2.7.1-07f8cd2" = _bZpsquJ2;
        "pkg-2.7.1-56aa805" = _lXZ64GMl;
        "pkg-2.7.1-0cbf52c" = _rV70dZfR;
        "pkg-2.7.1-7c9977f" = _RbuPX7Tb;
        "pkg-2.7.1-b6ff5bf" = _lKBLENoN;
        "pkg-2.7.1-9f637f5" = _NA3UKJ8t;
        "pkg-2.7.1-f53d276" = _hQ61F0fJ;
        "pkg-3.0-7d9cba9" = _vPsIFTxc;
        "pkg-3.0-8771648" = _riFMjhkE;
        "pkg-3.0" = _Bt2GUYDZ;
        "pkg-3.0.1" = _IuLkIn5U;
        "pkg-3.0.2-a91e683" = _nqwJAu4V;
        "pkg-3.0.2-c0d5cd3" = _FwJ2EDam;
        "pkg-3.0.2" = _J3qUFPJ9;
        "pkg-3.0.3-bdd25b9" = _br8KcaPf;
        "pkg-3.0.3-f05ae4a" = _Ss0DBaeR;
        "pkg-3.0.3-7dc8f36" = _WKvS51uj;
        "pkg-3.0.3-8b8417e" = _S1dBwOlc;
        "pkg-3.0.3-e806523" = _I6EBWFfS;
        "pkg-3.0.3-c9b0ea6" = _PqKgsg9U;
        "pkg-3.0.3" = _w073NhWE;
        "pkg-3.0.3-4502098" = _k6ZFYbDq;
        "pkg-3.0.3-5b1880b" = _40eZdfhS;
        "pkg-3.0.4-111dffb" = _wVG6WtVi;
        "pkg-3.0.4-a5a6f8f" = _NWRfBVzY;
        "pkg-3.0.4-015ba3a" = _PqDIw97p;
        "pkg-3.0.4" = _SZxRjPf7;
        "pkg-3.0.4-8ad4c4d" = _hZnV0qVN;
        "pkg-3.0.4-0b73c5a" = _hVnL4Nl9;
        "pkg-3.0.4-75b7614" = _1qr4w6xg;
        "pkg-3.0.4-8bbc393" = _6IPT4XsC;
        "pkg-3.0.4-98eb365" = _8jNHoKcG;
        "pkg-3.0.4-0e02a61" = _acqAbHWR;
        "pkg-3.0.4-e0d86a8" = _Znuv2y3x;
        "pkg-3.0.4-e6887d0" = _3JWtPx4g;
        "pkg-3.0.4-02cbf5a" = _1isUcFtj;
        "pkg-3.0.4-cd1c8e3" = _9iY0DPAA;
        "pkg-3.0.4-a01ac31" = _lB7gCEPs;
        "pkg-3.0.4-dbb7117" = _2hww6nwW;
        "pkg-3.0.4-a788412" = _WrOaxWDy;
        "pkg-3.0.4-45d6b24" = _Gjv0FwH8;
        "pkg-3.0.4-0f2ea07" = _iWoaF5tg;
        "pkg-3.0.4-0b8d954" = _p6kQfVAl;
        "pkg-3.0.4-e19bf0e" = _cnWKfW3h;
        "pkg-3.0.4-f801aee" = _sYYVxz3l;
        "pkg-3.0.4-dc1701a" = _DP8JjAWA;
        "default" = _DP8JjAWA;
    });
