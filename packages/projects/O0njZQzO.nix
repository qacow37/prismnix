...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _gMPF1jHe;
        "pkg-1.0.2" = _KnnwTWA9;
        "pkg-v1.0.3-mc1.21.4" = _ZMeZOBsm;
        "pkg-v1.0.3-mc1.20.2" = _3ViQqOpf;
        "pkg-v1.0.3-mc1.21.1" = _QF6WrcbH;
        "pkg-v1.0.3-mc1.20.1" = _kCnEgNWt;
        "pkg-v1.0.3-mc1.19.4" = _SYsLEcy5;
        "pkg-v1.0.3-mc1.20.6" = _vfTaoRxN;
        "pkg-v1.0.3-mc1.21.3" = _GUmiFGs2;
        "pkg-v1.0.3-mc1.20.4" = _81rmU4rw;
        "pkg-v2.0.0-mc1.20.2" = _mHblsvTo;
        "pkg-v2.0.0-mc1.19.4" = _NCC6mZKF;
        "pkg-v2.0.0-mc1.20.1" = _7hgk7aFz;
        "pkg-v2.0.0-mc1.21.4" = _zFIAPCec;
        "pkg-v2.0.0-mc1.20.4" = _W7fQDprs;
        "pkg-v2.0.0-mc1.21.1" = _6Og0lauE;
        "pkg-v2.0.0-mc1.21.3" = _7JeUAaZQ;
        "pkg-v2.0.0-mc1.20.6" = _C2zAYf6e;
        "pkg-v2.1.0-mc1.20.4" = _dN5AhnCm;
        "pkg-v2.1.0-mc1.21.8" = _TadmdHFr;
        "pkg-v2.1.0-mc1.21.5" = _CTE0J9bm;
        "pkg-v2.1.0-mc1.20.1" = _Bp16KvQs;
        "pkg-v2.1.0-mc1.21.11" = _CQ5IXSJ0;
        "pkg-v2.1.0-mc1.20.2" = _QhejnvXi;
        "pkg-v2.1.0-mc1.21.10" = _qeTBau0w;
        "pkg-v2.1.0-mc1.20.6" = _dbvf4oyO;
        "pkg-v2.1.0-mc1.19.4" = _EsvSDd25;
        "pkg-v2.1.0-mc1.21.1" = _kx8svF1X;
        "pkg-v2.1.0-mc1.21.4" = _O0bxx3wD;
        "pkg-v2.1.0-mc1.21.3" = _m5DsFPK1;
        "pkg-v2.1.0-mc26.1" = _rmpr1oLO;
        "pkg-v2.2.0-mc1.20.6" = _3Kz6jbMz;
        "pkg-v2.2.0-mc1.20.1" = _X5lquSlj;
        "pkg-v2.2.0-mc1.21.11" = _mYSSpH9c;
        "pkg-v2.2.0-mc1.21.10" = _eN2SNjBi;
        "pkg-v2.2.0-mc1.21.4" = _g6qPpmzK;
        "pkg-v2.2.0-mc1.21.8" = _ZCIdaG0H;
        "pkg-v2.2.0-mc1.21.3" = _BVxpYutT;
        "pkg-v2.2.0-mc1.21.1" = _DoOPS1GF;
        "pkg-v2.2.0-mc26.1" = _Naq6Mk6a;
        "pkg-v2.2.0-mc1.20.4" = _S2OHuQxY;
        "pkg-v2.2.0-mc1.19.4" = _LooyWuog;
        "pkg-v2.2.0-mc1.20.2" = _obkGLv1C;
        "pkg-v2.2.0-mc1.21.5" = _YxWBRElq;
        "pkg-v2.2.1-mc1.20.6" = _BC9FN3cR;
        "pkg-v2.2.1-mc1.21.4" = _88MtxenA;
        "pkg-v2.2.1-mc1.20.1" = _oAoUEOXM;
        "pkg-v2.2.1-mc1.21.8" = _2YlUWfMe;
        "pkg-v2.2.1-mc1.20.2" = _9PqqMyUS;
        "pkg-v2.2.1-mc1.21.10" = _6obaCimV;
        "pkg-v2.2.1-mc1.21.5" = _HVMuhrrj;
        "pkg-v2.2.1-mc26.1" = _BXVdAdOx;
        "pkg-v2.2.1-mc1.21.11" = _KdwZDvc7;
        "pkg-v2.2.1-mc1.21.3" = _S5La3PaL;
        "pkg-v2.2.1-mc1.19.4" = _PgYzS8wD;
        "pkg-v2.2.1-mc1.20.4" = _QRrPoHT0;
        "pkg-v2.2.1-mc1.21.1" = _4QF6GmsX;
        "default" = _4QF6GmsX;
    });
