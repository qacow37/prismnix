...
let
    ...
    in {
        ...
        "pkg-1.6.5-1.18-1.18.2-fabric" = _gy9pkdkD;
        "pkg-1.6.5-1.19-1.19.2-fabric" = _3tGURi2a;
        "pkg-1.6.6-1.18-1.18.2-fabric" = _PP0LMkSk;
        "pkg-1.6.6-1.19-1.19.2-fabric" = _5ZssA41J;
        "pkg-1.6.6-1.16.2-1.16.5-forge" = _5Teur9Zr;
        "pkg-1.6.6-1.18-1.18.2-forge" = _K0vx4x3c;
        "pkg-1.6.6-1.19-1.19.2-forge" = _9aYNIa7J;
        "pkg-1.6.6-1.19.3-fabric" = _ktDr83XR;
        "pkg-1.6.6-1.19.3-forge" = _Cvn32Yxn;
        "pkg-2.0.0-1.16.5-forge" = _bG2EYSh7;
        "pkg-2.0.0-1.18.2-forge" = _OXc19sY4;
        "pkg-2.0.0-1.19.1-1.19.2-forge" = _EbdzP103;
        "pkg-2.0.0-1.19.3-forge" = _pojOPzn2;
        "pkg-2.0.0-1.18.2-fabric" = _KBTgFjIv;
        "pkg-2.0.0-1.19-1.19.2-fabric" = _SPO6bm6b;
        "pkg-2.0.0-1.19.3-fabric" = _8nnyNbqQ;
        "pkg-2.0.1-1.16.5-forge" = _rs9LY37w;
        "pkg-2.0.1-1.18.2-forge" = _gjUsKo2r;
        "pkg-2.0.1-1.19.1-1.19.2-forge" = _zW52HF29;
        "pkg-2.0.1-1.19.3-forge" = _lwkzHxDI;
        "pkg-2.0.1-1.18.2-fabric" = _1055iFK3;
        "pkg-2.0.1-1.19-1.19.2-fabric" = _YUREag3z;
        "pkg-2.0.1-1.19.3-fabric" = _qTN58ewX;
        "pkg-2.1.0-1.18.2-fabric" = _6AHaY0Jt;
        "pkg-2.1.0-1.19-1.19.2-fabric" = _qabMs85y;
        "pkg-2.1.0-1.19.3-fabric" = _7rsaaFgr;
        "pkg-2.1.0-1.16.5-forge" = _ZRvTUjTn;
        "pkg-2.1.0-1.18.2-forge" = _pqaIiXwE;
        "pkg-2.1.0-1.19.1-1.19.2-forge" = _8bRPfAFo;
        "pkg-2.1.0-1.19.3-forge" = _ode1NuR2;
        "pkg-2.1.1-1.18.2-fabric" = _puRZMBq4;
        "pkg-2.1.1-1.19-1.19.2-fabric" = _uNWw6g0W;
        "pkg-2.1.1-1.19.3-fabric" = _II2vqLil;
        "pkg-2.1.1-1.16.5-forge" = _xXQFRRNH;
        "pkg-2.1.1-1.18.2-forge" = _HQNZdBOf;
        "pkg-2.1.1-1.19.1-1.19.2-forge" = _6DU9V9gB;
        "pkg-2.1.1-1.19.3-forge" = _3OI3kRMr;
        "pkg-2.1.1-1.19.4-forge" = _dLCTdJ7B;
        "pkg-2.1.1-1.19.4-fabric" = _SRF2JSmg;
        "pkg-2.1.2-1.18.2-fabric" = _Ji0eTgzU;
        "pkg-2.1.2-1.19-1.19.2-fabric" = _ZYrKdCGm;
        "pkg-2.1.2-1.19.3-fabric" = _73XVPa1o;
        "pkg-2.1.2-1.19.4-fabric" = _7AHIC7Je;
        "pkg-2.1.2-1.16.5-forge" = _p50JuKKZ;
        "pkg-2.1.2-1.18.2-forge" = _VLdP9K4D;
        "pkg-2.1.2-1.19.1-1.19.2-forge" = _K0kD7mZq;
        "pkg-2.1.2-1.19.3-forge" = _JZiInpYS;
        "pkg-2.1.2-1.19.4-forge" = _QGNM645b;
        "pkg-2.1.3-1.18.2-fabric" = _YBPMNcG3;
        "pkg-2.1.3-1.19-1.19.2-fabric" = _Eaat8Iro;
        "pkg-2.1.3-1.19.3-fabric" = _JLNXHp0n;
        "pkg-2.1.3-1.19.4-fabric" = _JKSiNXCA;
        "pkg-2.1.3-1.16.5-forge" = _uEo8i3DF;
        "pkg-2.1.3-1.18.2-forge" = _5vRMNIFH;
        "pkg-2.1.3-1.19.1-1.19.2-forge" = _oOfXeqYs;
        "pkg-2.1.3-1.19.3-forge" = _YkaBAnHW;
        "pkg-2.1.3-1.19.4-forge" = _broLaqNJ;
        "pkg-2.1.4-1.18.2-fabric" = _lVpt9NdT;
        "pkg-2.1.4-1.19-1.19.2-fabric" = _wZaYkwts;
        "pkg-2.1.4-1.19.3-fabric" = _RldXx1rI;
        "pkg-2.1.4-1.19.4-fabric" = _ytGOj4Ks;
        "pkg-2.1.4-1.16.5-forge" = _rfXT3VlT;
        "pkg-2.1.4-1.18.2-forge" = _jQj9wKtD;
        "pkg-2.1.4-1.19.1-1.19.2-forge" = _oKQASKNl;
        "pkg-2.1.4-1.19.3-forge" = _Yh85QX46;
        "pkg-2.1.4-1.19.4-forge" = _fxK7fjgu;
        "pkg-2.2.0-1.18.2-fabric" = _osHnRsYW;
        "pkg-2.2.0-1.19-1.19.2-fabric" = _b9gWCOYz;
        "pkg-2.2.0-1.19.3-fabric" = _lhJYugmf;
        "pkg-2.2.0-1.19.4-fabric" = _bLP1v9Z3;
        "pkg-2.2.0-1.16.5-forge" = _YiE5trBF;
        "pkg-2.2.0-1.18.2-forge" = _h0niUiv2;
        "pkg-2.2.0-1.19.1-1.19.2-forge" = _CvnG2ItM;
        "pkg-2.2.0-1.19.3-forge" = _MkyBYSkB;
        "pkg-2.2.0-1.19.4-forge" = _D0A80Ka4;
        "pkg-2.2.0-1-1.16.5-forge" = _sGDbhEWI;
        "pkg-2.2.1-1.16.5-forge" = _U99828d5;
        "pkg-2.2.1-1.18.2-forge" = _xlaTxrSp;
        "pkg-2.2.1-1.19.1-1.19.2-forge" = _hSmm4Otf;
        "pkg-2.2.1-1.19.3-forge" = _fYZ4OC32;
        "pkg-2.2.1-1.19.4-forge" = _kEpgNeYv;
        "pkg-2.2.1-1.18.2-fabric" = _Ek4uoM2G;
        "pkg-2.2.1-1.19-1.19.2-fabric" = _TgjCRoUg;
        "pkg-2.2.1-1.19.3-fabric" = _yxBCqBp1;
        "pkg-2.2.1-1.19.4-fabric" = _eYN7YRo8;
        "pkg-2.2.1-1.20-forge" = _lyhATsD1;
        "pkg-2.2.1-1.20-fabric" = _pVag0Gdc;
        "pkg-2.2.2-1.18.2-fabric" = _qP2JfND4;
        "pkg-2.2.2-1.19-1.19.2-fabric" = _qofBtkpb;
        "pkg-2.2.2-1.19.3-fabric" = _LfT10cXT;
        "pkg-2.2.2-1.19.4-fabric" = _84G1n2xJ;
        "pkg-2.2.2-1.20-1.20.1-fabric" = _naoDWUmF;
        "pkg-2.2.2-1.16.5-forge" = _imvcEjQK;
        "pkg-2.2.2-1.18.2-forge" = _WcCpxWot;
        "pkg-2.2.2-1.19.1-1.19.2-forge" = _MWBvD0nQ;
        "pkg-2.2.2-1.19.3-forge" = _VELi1zF4;
        "pkg-2.2.2-1.19.4-forge" = _NinqbGJL;
        "pkg-2.2.2-1.20-1.20.1-forge" = _EJVKvj8V;
        "pkg-2.2.3-1.20.1-forge" = _yMuZs46P;
        "pkg-2.2.3-1-1.20.1-forge" = _oQsxpqMS;
        "pkg-2.2.4-1.20.1-forge" = _KE14rbIp;
        "pkg-2.2.4-1.20.2-forge" = _RnSDLFIi;
        "pkg-2.2.4-1.20.2-fabric" = _WyrsCBFW;
        "pkg-2.2.5-1.20.2-fabric" = _RwTS7R6w;
        "pkg-2.2.5-1.20.1-fabric" = _yXiMaAx0;
        "pkg-2.2.6-1.20.4-fabric" = _LOrE4hI8;
        "pkg-2.2.6-1.20.4-forge" = _tXGTU75w;
        "pkg-3.0.0-1.18.2-fabric" = _RMbs4gLf;
        "pkg-3.0.0-1.18.2-forge" = _Qx1Oj64S;
        "pkg-3.0.0-1.19.2-fabric" = _2SvesE7f;
        "pkg-3.0.0-1.19.2-forge" = _6CtIX9GN;
        "pkg-3.0.0-1.20.1-fabric" = _by8ymhVz;
        "pkg-3.0.0-1.20.1-forge" = _u0Bxzufp;
        "pkg-3.0.0-1.20.4-fabric" = _5ps07o9X;
        "pkg-3.0.0-1.20.4-forge" = _6HQJ2eSO;
        "pkg-3.0.1-1.18.2-fabric" = _puTbAXYd;
        "pkg-3.0.1-1.18.2-forge" = _3XGc0UEE;
        "pkg-3.0.1-1.19.2-fabric" = _mtbgCGa9;
        "pkg-3.0.1-1.19.2-forge" = _Pv3GojUX;
        "pkg-3.0.1-1.20.1-fabric" = _y8cXxfLc;
        "pkg-3.0.1-1.20.1-forge" = _TuWe7Vwp;
        "pkg-3.0.1-1.20.4-fabric" = _EVbmveMm;
        "pkg-3.0.1-1.20.4-forge" = _cWZhSj1v;
        "pkg-3.0.2-1.20.1-fabric" = _m3VjrnDR;
        "pkg-3.0.3-1.20.4-neoforge" = _IL67Fv91;
        "pkg-3.0.4-1.20.6-fabric" = _9NhhywN9;
        "pkg-3.0.4-1.20.6-neoforge" = _1Qu40UZq;
        "pkg-3.0.6-1.20.6-forge" = _Y2RRaEUI;
        "pkg-3.0.7-1.21-fabric" = _ePC1ZDSz;
        "pkg-3.0.7-1.21-forge" = _nskW0Gk2;
        "pkg-3.0.7-1.21-neoforge" = _BMTF7mn7;
        "pkg-3.0.8-1.18.2-fabric" = _jMDasm1L;
        "pkg-3.0.8-1.18.2-forge" = _cX0JQG9a;
        "pkg-3.0.8-1.19.2-fabric" = _liJp26S5;
        "pkg-3.0.8-1.19.2-forge" = _Gw29WymV;
        "pkg-3.0.8-1.20.1-fabric" = _9x0lKayP;
        "pkg-3.0.8-1.20.1-forge" = _hrNM8h5D;
        "pkg-3.0.8-1.20.4-fabric" = _cP69QquJ;
        "pkg-3.0.8-1.20.4-forge" = _O5cT2PPc;
        "pkg-3.0.8-1.20.4-neoforge" = _Rvh3ZjwB;
        "pkg-3.0.8-1.20.6-fabric" = _SxM4Wsqu;
        "pkg-3.0.8-1.20.6-forge" = _L6ezmvkg;
        "pkg-3.0.8-1.20.6-neoforge" = _O5rUYGi1;
        "pkg-3.0.8-1.21.1-fabric" = _HjSqIrjJ;
        "pkg-3.0.8-1.21.1-forge" = _3lrnnTOH;
        "pkg-3.0.8-1.21.1-neoforge" = _lDRjFPt1;
        "pkg-3.0.9-1.18.2-forge" = _AWMisq0G;
        "pkg-3.0.9-1.19.2-forge" = _rI13fb1n;
        "pkg-3.0.9-1.20.1-forge" = _ou3ZJvJg;
        "pkg-3.0.9-1.20.4-forge" = _TdeAFusI;
        "pkg-3.0.10-1.21.4-fabric" = _XjbKCKsz;
        "pkg-3.0.10-1.21.4-forge" = _iAi49cJy;
        "pkg-3.0.10-1.21.4-neoforge" = _NXHLZ1V2;
        "pkg-3.0.11-1.18.2-fabric" = _hGC7nziW;
        "pkg-3.0.11-1.18.2-forge" = _NbM1Roug;
        "pkg-3.0.11-1.19.2-fabric" = _1etu6sl8;
        "pkg-3.0.11-1.19.2-forge" = _Y6eo20q6;
        "pkg-3.0.11-1.20.1-fabric" = _POfkx8T4;
        "pkg-3.0.11-1.20.1-forge" = _iR874weD;
        "pkg-3.0.11-1.21.1-fabric" = _JYjCgVVp;
        "pkg-3.0.11-1.21.1-forge" = _WmUCEgUi;
        "pkg-3.0.11-1.21.1-neoforge" = _sg4aRmk7;
        "pkg-3.0.11-1.21.4-fabric" = _c262Ulvk;
        "pkg-3.0.11-1.21.4-forge" = _O7q5VZQT;
        "pkg-3.0.11-1.21.4-neoforge" = _GFnplkzr;
        "pkg-3.0.12-1.18.2-fabric" = _R77IVpJI;
        "pkg-3.0.12-1.18.2-forge" = _BtNGh8kI;
        "pkg-3.0.12-1.19.2-fabric" = _VT408HzA;
        "pkg-3.0.12-1.19.2-forge" = _OiRdGjHi;
        "pkg-3.0.12-1.20.1-fabric" = _nIQb1yEH;
        "pkg-3.0.12-1.20.1-forge" = _SCbkqLQR;
        "pkg-3.0.12-1.21.1-fabric" = _KDC30qwk;
        "pkg-3.0.12-1.21.1-forge" = _ORd6lagW;
        "pkg-3.0.12-1.21.1-neoforge" = _EPNdj6T1;
        "pkg-3.0.12-1.21.4-fabric" = _Gy4XDhII;
        "pkg-3.0.12-1.21.4-forge" = _QnCDiefU;
        "pkg-3.0.12-1.21.4-neoforge" = _WS1rUug0;
        "pkg-3.0.13-1.21.5-fabric" = _xY9bPtQt;
        "pkg-3.0.13-1.21.5-forge" = _jWfxhnq4;
        "pkg-3.0.13-1.21.5-neoforge" = _VJOql42D;
        "pkg-3.0.14-1.21.6-fabric" = _i5RGYRdP;
        "pkg-3.0.14-1.21.6-forge" = _zpMuuCJv;
        "pkg-3.0.14-1.21.6-neoforge" = _EIwCLDWV;
        "pkg-3.0.15-1.21.6-fabric" = _4OQ0QIuW;
        "pkg-3.0.15-1.21.6-forge" = _hfwPPgh5;
        "pkg-3.0.15-1.21.6-neoforge" = _Hjc5KwVg;
        "pkg-3.0.16-1.21.10-fabric" = _Yza4nUYH;
        "pkg-3.0.16-1.21.10-neoforge" = _ibIlGnoZ;
        "pkg-3.1.0-1.19.2-fabric" = _tbqyZZo6;
        "pkg-3.1.0-1.19.2-forge" = _OrTlSh7D;
        "pkg-3.1.0-1.20.1-fabric" = _7b8iQUhq;
        "pkg-3.1.0-1.20.1-forge" = _68GEZSYA;
        "pkg-3.1.0-1.21.1-fabric" = _wW1UHXfu;
        "pkg-3.1.0-1.21.1-neoforge" = _2BfDBRBV;
        "pkg-3.1.0-1.21.10-fabric" = _m2WyWgf2;
        "pkg-3.1.0-1.21.10-neoforge" = _s9huokVL;
        "pkg-3.1.1-1.21.11-fabric" = _93oCkXyU;
        "pkg-3.1.1-1.21.11-neoforge" = _7PhaW7x6;
        "pkg-3.1.1-26.1.1-fabric" = _RuUf1n8e;
        "pkg-3.1.1-26.1.1-neoforge" = _F1ruuwVV;
        "pkg-3.1.2-1.19.2-fabric" = _rQPlJZfy;
        "pkg-3.1.2-1.19.2-forge" = _uB1eonW8;
        "pkg-3.1.2-1.20.1-fabric" = _XS1Pe1xJ;
        "pkg-3.1.2-1.20.1-forge" = _4wF1Mfez;
        "pkg-3.1.2-1.21.1-fabric" = _MGOO5xG7;
        "pkg-3.1.2-1.21.1-neoforge" = _lb0Z0bXA;
        "pkg-3.1.2-1.21.11-fabric" = _UMvWdGM5;
        "pkg-3.1.2-1.21.11-neoforge" = _qS8WNad5;
        "pkg-3.1.2-26.1.1-fabric" = _RQj0HpPO;
        "pkg-3.1.2-26.1.1-neoforge" = _mzUb7tCw;
        "pkg-3.1.3-1.21.11-fabric" = _JQZrwJWk;
        "pkg-3.1.3-1.21.11-neoforge" = _sIK1W0yF;
        "pkg-3.1.3-26.1.1-26.1.2-fabric" = _soK6x7So;
        "pkg-3.1.3-26.1.1-26.1.2-neoforge" = _2bPSrkHa;
        "pkg-3.1.4-26.2-fabric" = _VaX0kK2p;
        "pkg-3.1.4-26.2-neoforge" = _sxkxXQKY;
        "pkg-3.1.5-1.19.2-fabric" = _geLhgXph;
        "pkg-3.1.5-1.19.2-forge" = _53y4dYKJ;
        "pkg-3.1.5-1.20.1-fabric" = _ewn2Ljq2;
        "pkg-3.1.5-1.20.1-forge" = _Nof419YS;
        "pkg-3.1.5-1.21.1-fabric" = _7zThwKvH;
        "pkg-3.1.5-1.21.1-neoforge" = _MVgsDsSB;
        "pkg-3.1.5-1.21.11-fabric" = _368DAeeI;
        "pkg-3.1.5-1.21.11-neoforge" = _cpffdTlq;
        "pkg-3.1.5-26.1.2-fabric" = _pcBKNtEk;
