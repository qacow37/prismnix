...
let
    ...
    in {
        ...
        "pkg-0.9.8" = _iaU326bk;
        "pkg-0.9.9" = _9rqnyshU;
        "pkg-0.9.10" = _4lzcpx07;
        "pkg-0.9.11" = _wxFkw2kx;
        "pkg-1.0.0" = _hGQAtxk1;
        "pkg-1.1.1" = _Sva2uUdC;
        "pkg-1.2.0" = _4E9XckLo;
        "pkg-1.2.1" = _7Fk46okd;
        "pkg-1.2.2" = _M59kTtHb;
        "pkg-1.2.3+1.20.1" = _R5wOArqd;
        "pkg-1.2.3+1.20.6" = _RwCc0DKd;
        "pkg-1.2.3+1.21" = _EdWrANJ4;
        "pkg-1.2.3" = _iQQjVnm2;
        "pkg-1.2.3+1.21.3" = _ZuFSCtcg;
        "pkg-1.2.4+1.19.4" = _NqSjZRm8;
        "pkg-1.2.4+1.20.1" = _dNKsX3ST;
        "pkg-1.2.4+1.20.6" = _4TC9NDE2;
        "pkg-1.2.4+1.21" = _flxQ6ycT;
        "pkg-1.2.4+1.21.3" = _iezWhB9e;
        "pkg-1.2.4+1.21.4" = _lh3ICFX0;
        "pkg-1.2.5" = _9UenLoHM;
        "pkg-1.2.5+1.19.4" = _E94Q9LxZ;
        "pkg-1.2.5+1.20.1" = _DcFbok8W;
        "pkg-1.2.5+1.20.6" = _lOhWNO2w;
        "pkg-1.2.5+1.21" = _kEStLl3x;
        "pkg-1.2.5+1.21.3" = _2RNM2Fq6;
        "pkg-1.2.5+1.21.4" = _VhPHuQtI;
        "pkg-1.2.6" = _ruRf4tVf;
        "pkg-1.2.6+1.19.4" = _wYOqaaO4;
        "pkg-1.2.6+1.20.1" = _kEOK0A51;
        "pkg-1.2.6+1.20.6" = _Cig9GAXk;
        "pkg-1.2.6+1.21" = _OpWUKgxn;
        "pkg-1.2.6+1.21.3" = _XpqxCp4Y;
        "pkg-1.2.6+1.21.4" = _arM4ahkI;
        "pkg-1.2.7+1.20.1" = _fZ9dx42u;
        "pkg-1.2.7+1.20.6" = _YsNENIDH;
        "pkg-1.2.7+1.21" = _B0gzPbox;
        "pkg-1.2.7+1.21.3" = _ReWJ84VZ;
        "pkg-1.2.7+1.21.4" = _6S3rfctb;
        "pkg-1.2.7+1.21.5" = _wh6cFo8l;
        "pkg-1.2.8+1.20.1" = _5sTd4YP2;
        "pkg-1.2.8+1.20.6" = _lp1LPv9I;
        "pkg-1.2.8+1.21" = _Kh8aU8n6;
        "pkg-1.2.8+1.21.3" = _3phQ5yfm;
        "pkg-1.2.8+1.21.4" = _8jSvWE9Z;
        "pkg-1.2.8+1.21.5" = _j5D213WL;
        "pkg-1.2.9" = _K8z4wVFz;
        "pkg-1.2.10+1.20.1" = _YUIgQ1Tc;
        "pkg-1.2.10+1.20.6" = _NRGfhR7v;
        "pkg-1.2.10+1.21" = _EWQ2nSYo;
        "pkg-1.2.10+1.21.3" = _raFUWtnE;
        "pkg-1.2.10+1.21.4" = _e67teei9;
        "pkg-1.2.10+1.21.5" = _bBFii9a1;
        "pkg-1.2.11+1.20.1" = _yStW42hK;
        "pkg-1.2.11+1.20.6" = _4Oiycbo2;
        "pkg-1.2.11+1.21" = _2OaM4y3G;
        "pkg-1.2.11+1.21.3" = _wtcb85MU;
        "pkg-1.2.11+1.21.4" = _pdVy1b7p;
        "pkg-1.2.11+1.21.5" = _TTJt0Pkq;
        "pkg-1.2.12" = _XVFr9V0C;
        "pkg-1.2.12+1.20.1" = _apBMxlGA;
        "pkg-1.2.12+1.20.6" = _1LOXFuPN;
        "pkg-1.2.12+1.21" = _SWxhr1g5;
        "pkg-1.2.12+1.21.3" = _EsrKVP1p;
        "pkg-1.2.12+1.21.4" = _Ox587SiE;
        "pkg-1.2.12+1.21.5" = _Nz5wHale;
        "pkg-1.2.12+1.21.7" = _FalojI38;
        "pkg-1.2.12+1.21.10" = _qmWiW1Ep;
        "pkg-1.2.13+1.21.3" = _FHIqVLZ4;
        "pkg-1.2.13+1.21.4" = _ODV3HlzR;
        "pkg-1.2.13+1.21.5" = _iIzb62ab;
        "pkg-1.2.13+1.21.7" = _eLdyecqW;
        "pkg-1.2.13+1.21.10" = _6A3FhRz0;
        "pkg-1.2.14+1.20.1" = _Qx85dXEq;
        "pkg-1.2.14+1.20.6" = _93W77SZc;
        "pkg-1.2.14+1.21" = _84VZ1Mf0;
        "pkg-1.2.14+1.21.3" = _C1tb9gCq;
        "pkg-1.2.14+1.21.4" = _H7QDosA0;
        "pkg-1.2.14+1.21.5" = _nDl4XUVh;
        "pkg-1.2.14+1.21.7" = _XPioaw16;
        "pkg-1.2.14+1.21.10" = _igiz3fc4;
        "pkg-1.2.14+1.21.11" = _8LyiOGxw;
        "pkg-1.2.14" = _ceeJTY4b;
        "pkg-1.2.14+26.1" = _idnztFjm;
        "pkg-1.2.15+1.20.1" = _ucsLa1LE;
        "pkg-1.2.15+1.20.6" = _5RQvQjK0;
        "pkg-1.2.15+1.21" = _cfEBcwJi;
        "pkg-1.2.15+1.21.3" = _VQYbXFX5;
        "pkg-1.2.15+1.21.4" = _rqnaQAsj;
        "pkg-1.2.15+1.21.5" = _Ub6EKcp0;
        "pkg-1.2.15+1.21.7" = _6W0p78cQ;
        "pkg-1.2.15+1.21.10" = _ircI8RSu;
