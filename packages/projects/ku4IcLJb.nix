...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha" = _rfsogXRV;
        "pkg-1.0.0" = _kaknlO8x;
        "pkg-1.1.0" = _rAhP8dBA;
        "pkg-1.1.1" = _lWEzADhC;
        "pkg-1.1.2" = _FHXcM9mB;
        "pkg-1.1.3+fabric-1.21.1" = _fszMQOfN;
        "pkg-1.1.3+fabric-1.21.4" = _CReyRLMP;
        "pkg-1.1.3+fabric-1.21.9" = _hwHv3kZn;
        "pkg-1.1.3+fabric-1.21-1.21.11" = _FfRGih9A;
        "pkg-1.2.0-b40-f1201-1202" = _IcHN3ESr;
        "pkg-1.2.0-b40-f1203-1204" = _rq0VJQYH;
        "pkg-1.2.0-b40-f1205-1206" = _sMWtp5Jn;
        "pkg-1.2.0-b40-f121-1211" = _9cg3lCxY;
        "pkg-1.2.0-b40-f1212-1214" = _PYt8q1z1;
        "pkg-1.2.0-b40-f1215-1219" = _tSPyTatw;
        "pkg-1.2.0-b40-f12110-12111" = _vPh5vcBh;
        "pkg-1.2.0-b40-f261" = _SIYyT7v8;
        "pkg-1.2.0-b40-g1201-1202" = _tRu6SaWG;
        "pkg-1.2.0-b40-g1203-1204" = _Ja0WCw3r;
        "pkg-1.2.0-b40-g1205-1206" = _NRed1Srn;
        "pkg-1.2.0-b40-g121-1211" = _YEOMKj5E;
        "pkg-1.2.0-b40-n1201-1202" = _H7ONDsMc;
        "pkg-1.2.0-b40-n1203-1204" = _fTC9stsd;
        "pkg-1.2.0-b40-n1205-1206" = _gMPD30yc;
        "pkg-1.2.0-b40-n121-1211" = _YjJspM2T;
        "pkg-1.2.0-b40-n1212-1214" = _C2YVutbZ;
        "pkg-1.2.0-b40-n1215-12111" = _8OYyehau;
        "pkg-1.2.0-b40-n261" = _Il1Pax2j;
        "pkg-1.2.0+fabric-1.20.1-1.20.2" = _1XhsVpuv;
        "pkg-1.2.0+fabric-1.20.4" = _Ywqb5TNY;
        "pkg-1.2.0+fabric-1.20.3-1.20.6" = _T5ah3uGV;
        "pkg-1.2.0+fabric-1.21.1" = _Fi7oM0t8;
        "pkg-1.2.0+fabric-1.21.4" = _fcUtApGo;
        "pkg-1.2.0+fabric-1.21.9" = _CmzqMYP7;
        "pkg-1.2.0+fabric-1.21-1.21.11" = _nYZMq79z;
        "pkg-1.2.0+fabric-26.1" = _QcCGHDPX;
        "pkg-1.2.0+forge-1.20.1-1.20.2" = _CmqehQQK;
        "pkg-1.2.0+forge-1.20.4" = _7pat8Xm3;
        "pkg-1.2.0+forge-1.20.3-1.20.6" = _bE7aZ9jo;
        "pkg-1.2.0+forge-1.21.1" = _opCIFwf8;
        "pkg-1.2.0+neoforge-1.20.1-1.20.2" = _yRtYBavt;
        "pkg-1.2.0+neoforge-1.20.4" = _HR71GNKA;
        "pkg-1.2.0+neoforge-1.20.6" = _zn2ZJgaF;
        "pkg-1.2.0+neoforge-1.21.1" = _hfSfyeKY;
        "pkg-1.2.0+neoforge-1.21.4" = _DUjaRx7Q;
        "pkg-1.2.0+neoforge-1.21-1.21.11" = _yUvJSCU1;
        "pkg-1.2.0+neoforge-26.1" = _H1U8wTmo;
        "pkg-1.2.1-b43-f1201-1202" = _kXDj9ZeH;
        "pkg-1.2.1-b43-f1203-1204" = _eo5ViSx0;
        "pkg-1.2.1-b43-f1205-1206" = _O5cGyOxp;
        "pkg-1.2.1-b43-f121-1211" = _y3G63AJE;
        "pkg-1.2.1-b43-f1212-1214" = _FDAsPN1s;
        "pkg-1.2.1-b43-f1215-1219" = _yQsONnXR;
        "pkg-1.2.1-b43-f12110-12111" = _nHJ2F8yt;
        "pkg-1.2.1-b43-f261" = _SgRjMdUV;
        "pkg-1.2.1-b43-g1201-1202" = _OCCyQta9;
        "pkg-1.2.1-b43-g1203-1204" = _xS4vSCoU;
        "pkg-1.2.1-b43-g1205-1206" = _m7PfCKEO;
        "pkg-1.2.1-b43-g121-1211" = _eog2xaKl;
        "pkg-1.2.1-b43-n1201-1202" = _jYg6s9Aj;
        "pkg-1.2.1-b43-n1203-1204" = _DdP8YFC1;
        "pkg-1.2.1-b43-n1205-1206" = _LtHK9aHr;
        "pkg-1.2.1-b43-n121-1211" = _eWePqDDX;
        "pkg-1.2.1-b43-n1212-1214" = _QcUv7m1a;
        "pkg-1.2.1-b43-n1215-12111" = _SeNtVfJH;
        "pkg-1.2.1-b43-n261" = _5XeNOgQ5;
        "pkg-1.2.1+fabric-1.20.1-1.20.2" = _x1Ot6BUz;
        "pkg-1.2.1+fabric-1.20.4" = _jtd2HSxW;
        "pkg-1.2.1+fabric-1.20.3-1.20.6" = _mEpaxNT3;
        "pkg-1.2.1+fabric-1.21.1" = _ohC94ljC;
        "pkg-1.2.1+fabric-1.21.4" = _YZOZVXH2;
        "pkg-1.2.1+fabric-1.21.9" = _umxF8pXX;
        "pkg-1.2.1+fabric-1.21-1.21.11" = _85MqxH6z;
        "pkg-1.2.1+fabric-26.1" = _d8gQOIHc;
        "pkg-1.2.1+forge-1.20.1-1.20.2" = _eIylDKzE;
        "pkg-1.2.1+forge-1.20.4" = _n8pc6qMn;
        "pkg-1.2.1+forge-1.20.3-1.20.6" = _5uctRbD9;
        "pkg-1.2.1+forge-1.21.1" = _omzLZVex;
        "pkg-1.2.1+neoforge-1.20.1-1.20.2" = _EAuCOJNT;
        "pkg-1.2.1+neoforge-1.20.4" = _qa0Q3XZE;
        "pkg-1.2.1+neoforge-1.20.6" = _5sDYLSfn;
        "pkg-1.2.1+neoforge-1.21.1" = _oS72A3ox;
        "pkg-1.2.1+neoforge-1.21.4" = _rrNyimmS;
        "pkg-1.2.1+neoforge-1.21-1.21.11" = _onu1TUfB;
        "pkg-1.2.1+neoforge-26.1" = _qiVZbbFH;
        "pkg-1.3.0-b45-f1201-1202" = _U8ke854v;
        "pkg-1.3.0-b45-f1203-1204" = _kJ77JnDS;
        "pkg-1.3.0-b45-f1205-1206" = _qwm682VN;
        "pkg-1.3.0-b45-f121-1211" = _q7CiHZNX;
        "pkg-1.3.0-b45-f1212-1214" = _Mh7z1U6N;
        "pkg-1.3.0-b45-f1215-1219" = _ZdQW08ZX;
        "pkg-1.3.0-b45-f12110-12111" = _kPETTcDy;
        "pkg-1.3.0-b45-f261" = _pEfuK9kV;
        "pkg-1.3.0-b45-g1201-1202" = _x9uPVtxS;
        "pkg-1.3.0-b45-g1203-1204" = _AvFkrkR8;
        "pkg-1.3.0-b45-g1205-1206" = _pbm7IROj;
        "pkg-1.3.0-b45-g121-1211" = _4GGrINxC;
        "pkg-1.3.0-b45-n1201-1202" = _rIirIym9;
        "pkg-1.3.0-b45-n1203-1204" = _RwrFKav4;
        "pkg-1.3.0-b45-n1205-1206" = _TnUaFBth;
        "pkg-1.3.0-b45-n121-1211" = _ceiuRETW;
        "pkg-1.3.0-b45-n1212-1214" = _GxLaJZSP;
        "pkg-1.3.0-b45-n1215-12111" = _a3Vv65fi;
        "pkg-1.3.0-b45-n261" = _DYewr5xl;
        "pkg-2.0.0+fabric-1.20.1-1.20.2" = _edtSNLPc;
        "pkg-2.0.0+fabric-1.20.4" = _eSdejdrW;
        "pkg-2.0.0+fabric-1.20.3-1.20.6" = _kjFVHHJr;
        "pkg-2.0.0+fabric-1.21.1" = _dwDjcQKx;
        "pkg-2.0.0+fabric-1.21.4" = _brUA5cqs;
        "pkg-2.0.0+fabric-1.21.9" = _IaoK5ci9;
        "pkg-2.0.0+fabric-1.21-1.21.11" = _UDzkZ0u5;
        "pkg-2.0.0+fabric-26.1" = _zhu2U1Bh;
        "pkg-2.0.0+forge-1.20.1-1.20.2" = _sbLAeOwn;
        "pkg-2.0.0+forge-1.20.4" = _1MKrd3Mb;
        "pkg-2.0.0+forge-1.20.3-1.20.6" = _PKIF69uN;
        "pkg-2.0.0+forge-1.21.1" = _9bZ787nL;
        "pkg-2.0.0+neoforge-1.20.1-1.20.2" = _cdh1zxWn;
        "pkg-2.0.0+neoforge-1.20.4" = _uSBY3dVT;
        "pkg-2.0.0+neoforge-1.20.6" = _Uff734D1;
        "pkg-2.0.0+neoforge-1.21.1" = _PGoNlH2z;
        "pkg-2.0.0+neoforge-1.21.4" = _tGPIfO5z;
        "pkg-2.0.0+neoforge-1.21-1.21.11" = _Zxrjk3gQ;
        "pkg-2.0.0+neoforge-26.1" = _cGEgpH7z;
        "default" = _cGEgpH7z;
    });
