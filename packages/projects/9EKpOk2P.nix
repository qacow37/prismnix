...
let
    ...
    in {
        ...
        "pkg-0.1" = _yPlWYeFX;
        "pkg-0.1.1+mod" = _GB8tfY1W;
        "pkg-0.2" = _7tKdwCu6;
        "pkg-0.2.1+mod" = _BsocR9Dl;
        "pkg-1.0" = _6w7HqF90;
        "pkg-1.0+mod" = _gVORw1UD;
        "pkg-1.1" = _RI9srV7B;
        "pkg-1.1+mod" = _F3Eb3x6g;
        "pkg-1.2" = _cBCWYoLq;
        "pkg-1.2+mod" = _odpiCr2d;
        "pkg-1.3" = _oRNyxkKx;
        "pkg-1.3+mod" = _x2sRcbjQ;
        "pkg-1.4" = _gb3JIYqs;
        "pkg-1.4+mod" = _WlXFxHUy;
        "pkg-1.5" = _Ez1rHMdJ;
        "pkg-1.5+mod" = _k5DQSr3V;
        "pkg-1.6" = _Xr9jT10v;
        "pkg-1.7" = _rCGKWMdx;
        "pkg-1.6+mod" = _7ho7Ls10;
        "pkg-1.7+mod" = _jtDKXfeo;
        "pkg-1.7fixed" = _vkznHLRW;
        "pkg-1.7.1fixed+mod" = _ER6gnQuG;
        "default" = _ER6gnQuG;
    });
