...
let
    ...
    in {
        ...
        "pkg-v8.0.1-1.20.1-Fabric" = _q5oA3CiD;
        "pkg-v3.0.0-1.18.2-Forge" = _jKypw7vF;
        "pkg-v3.0.0-1.18.2-Fabric" = _SS1KbtEr;
        "pkg-v3.0.1-1.18.2-Forge" = _Rn4Cpk3l;
        "pkg-v3.0.1-1.18.2-Fabric" = _HRC8zXkN;
        "pkg-v8.0.2-1.20.1-Forge" = _1cLzn1rF;
        "pkg-v8.0.2-1.20.1-Fabric" = _R8HU2Dhp;
        "pkg-v20.4.0-1.20.4-Fabric" = _NlUT8J1k;
        "pkg-v20.4.0-1.20.4-Forge" = _UP0xkHtX;
        "pkg-v20.4.0-1.20.4-NeoForge" = _2jX7yERK;
        "pkg-v21.0.0-1.21-Fabric" = _smcsDpcM;
        "pkg-v21.0.0-1.21-NeoForge" = _N7gQ6wAm;
        "pkg-v21.0.1-1.21-Fabric" = _9x6j8hXl;
        "pkg-v21.0.1-1.21-NeoForge" = _x5OuWpwe;
        "pkg-v21.1.0-1.21.1-Fabric" = _VH6GJvlP;
        "pkg-v21.1.0-1.21.1-NeoForge" = _GzqnnBSS;
        "pkg-v21.3.0-1.21.3-Fabric" = _cOLqkcvV;
        "pkg-v21.3.0-1.21.3-NeoForge" = _Nb2qvSv8;
        "pkg-v21.1.1-1.21.1-Fabric" = _9zU4JMGw;
        "pkg-v21.1.1-1.21.1-NeoForge" = _gKgYWwEQ;
        "pkg-v21.3.1-1.21.3-Fabric" = _Ucj4OVsl;
        "pkg-v21.3.1-1.21.3-NeoForge" = _rHgRQYRG;
        "pkg-v21.4.0-1.21.4-Fabric" = _uBnWf9cg;
        "pkg-v21.4.0-1.21.4-NeoForge" = _Fz3aQ6Ej;
        "pkg-v21.5.0-1.21.5-Fabric" = _sTPOxd6C;
        "pkg-v21.5.0-1.21.5-NeoForge" = _tYxaoT8w;
        "pkg-v21.7.0-1.21.7-Fabric" = _G0MSi58m;
        "pkg-v21.7.0-1.21.7-NeoForge" = _E1sU37ZN;
        "pkg-v21.8.0-1.21.8-Fabric" = _3oMuszA2;
        "pkg-v21.8.0-1.21.8-NeoForge" = _2uAGr7BG;
        "pkg-v21.8.1-1.21.8-Fabric" = _xBesFhac;
        "pkg-v21.8.1-1.21.8-NeoForge" = _JWgM8NnF;
        "pkg-v21.8.2-1.21.8-Fabric" = _93BCdy3V;
        "pkg-v21.8.2-1.21.8-NeoForge" = _zzpaEtsp;
        "pkg-v21.8.3-1.21.8-Fabric" = _vXmOJZMY;
        "pkg-v21.8.3-1.21.8-NeoForge" = _GkCaxYpa;
        "pkg-21.9.0" = _8D0VyyQm;
        "pkg-21.10.0" = _pw5yWAs1;
        "pkg-21.10.1" = _Mz7869Np;
        "pkg-21.11.0" = _QY6Zhlwx;
        "pkg-21.11.1" = _cGz1JvBI;
        "pkg-21.11.2" = _QgVRHlX6;
        "pkg-21.11.3" = _8d40aLN9;
        "pkg-21.11.4" = _SiOvFe9P;
        "pkg-26.1.0" = _H8YJiXKB;
        "pkg-26.2.0" = _gUDlRCDj;
        "pkg-26.1.1" = _BShnSDQ6;
