...
let
    ...
    in {
        ...
        "pkg-v.2.0.0+mod" = _8Piu9lbL;
        "pkg-v.3.0.0" = _uDWMvLSW;
        "pkg-v.3.0.0+mod" = _RuKpyAyZ;
        "pkg-v.3.1.0" = _mxyNlMiW;
        "pkg-v.3.1.0+mod" = _v0kVtKDQ;
        "pkg-v.1.0.0" = _rez7c7vp;
        "pkg-v.1.0.0+mod" = _T4l7f80D;
        "pkg-v.3.2.0" = _RKdONxlG;
        "pkg-v.3.2.1" = _q4g0XxmX;
        "pkg-v.3.2.1+mod" = _MNnPQNjW;
        "pkg-v.3.3.1" = _U7iNbqBP;
        "pkg-v.3.3.1+mod" = _EVEA3oXs;
        "pkg-v.1.1.0" = _fzGfkcGE;
        "pkg-v.1.1.0+mod" = _AO47l0Jz;
        "pkg-v.1.1.1" = _DvvQa8gy;
        "pkg-v.1.1.1+mod" = _NHn9L5ib;
        "pkg-v.2.1.0" = _JfAXdyIC;
        "pkg-v.2.1.0+mod" = _gQtSGXor;
        "pkg-v3.4.1" = _T9T5ZC9y;
        "pkg-v3.4.1+mod" = _JVA3SQni;
        "pkg-v3.5.1" = _5Bp4Uxxb;
        "pkg-v3.6.1" = _bplVlnJ1;
        "pkg-v3.6.1+mod" = _PmwK19I0;
        "pkg-v3.6.2" = _ZcmZOjyM;
        "pkg-v3.6.2+mod" = _OwTBgs4l;
        "pkg-v3.6.2.1" = _fqyVaR4x;
