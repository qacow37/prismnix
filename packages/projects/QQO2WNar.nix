...
let
    ...
    in {
        ...
        "pkg-1.3+1.20.6" = _UI6Xnfvk;
        "pkg-1.3+1.21" = _8N4Qz7ky;
        "pkg-1.3+1.21+mod" = _n3TcbAhe;
        "pkg-1.3-mc1.21.3" = _XTt1oPcE;
        "pkg-1.3-mc1.21.3+mod" = _WACPOlHI;
        "pkg-1.3.1-mc1.21.4" = _6F4tdFfe;
        "pkg-1.3.1-mc1.21.4+mod" = _JeLesUvN;
        "pkg-1.3.2-mc1.21.5" = _3uX88PoX;
        "pkg-1.3.2-mc1.21.5+mod" = _cT2geQin;
        "pkg-1.3.2-mc1.21.6" = _AbJeDbtU;
        "pkg-1.3.2-mc1.21.6+mod" = _uRjBquJk;
        "pkg-1.4-mc1.21.9" = _oD6hBysX;
        "pkg-1.4-mc1.21.9+mod" = _IM7IzbYu;
        "pkg-1.4.1-mc1.21.10" = _XuKsqGD6;
        "pkg-1.4.1-mc1.21.10+mod" = _jZmnOT0i;
        "pkg-1.4.1-mc1.21.11" = _bfqgDb2s;
        "pkg-1.4.1-mc1.21.11+mod" = _ZZzu3Wo2;
        "pkg-1.4.2-mc26.1" = _yBoKXD01;
        "pkg-1.4.2-mc26.1+mod" = _cHPDBM0z;
        "pkg-1.4.3-mc26.1" = _Wq128Apf;
        "pkg-1.4.3-mc26.1+mod" = _oJT3nXJa;
        "pkg-1.3.3-mc1.21.5" = _t8xMGtZN;
        "pkg-1.3.3-mc1.21.5+mod" = _MTkrmrFf;
        "pkg-1.3.3-mc1.21.6" = _QYFd5Isn;
        "pkg-1.3.3-mc1.21.6+mod" = _BZpd35eO;
        "pkg-1.3.3-mc1.21.7" = _lNxskpNz;
        "pkg-1.3.3-mc1.21.7+mod" = _wxjUHWw7;
        "pkg-1.4.4+mc1.21.9-26.1.x" = _AFo4MhZ2;
