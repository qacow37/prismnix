...
let
    ...
    in {
        ...
        "pkg-1.0.3+MC1.18-1.18.1" = _S7JS9bgY;
        "pkg-1.0.4+MC1.18-1.18.2" = _2r391Irb;
        "pkg-1.0.5+MC1.18-1.18.2" = _4pMdsmka;
        "pkg-1.0.6+MC1.19" = _hfLUxqVr;
        "pkg-1.0.7+MC1.19-1.19.1" = _IlKG6RLT;
        "pkg-1.0.8+MC1.19-1.19.1" = _3WcRkc77;
        "pkg-1.0.9+MC1.19-1.19.2" = _Tjo1iB39;
        "pkg-1.0.10+MC1.19-1.19.2" = _W45YEJKO;
        "pkg-1.0.11+MC1.18.2" = _1XQUjVSl;
        "pkg-1.0.12+MC1.19-1.19.2" = _wmjUkVMe;
        "pkg-1.0.14+MC1.19.3-1.19.4" = _RZvYIJLh;
        "pkg-1.0.16+MC1.20-1.20.1" = _RQjbeCLy;
        "pkg-1.0.17+MC1.20-1.20.1" = _TB0tOHRp;
        "pkg-1.0.18+MC1.20.2" = _NtwBw1lM;
        "pkg-1.0.19+MC1.20.2-1.20.4" = _Mo41aMtz;
        "pkg-1.0.20+MC1.20.2-1.20.5" = _NyJHFJ1T;
        "pkg-1.0.21+MC1.20.2-1.20.5" = _uLRRKQA7;
        "pkg-1.0.22+MC1.20.2-1.20.6" = _cZIWnreB;
        "pkg-1.1.0+MC1.21" = _fL0IKjH6;
        "pkg-1.1.1+MC1.21" = _m9tpfiQt;
        "pkg-1.1.2+MC1.21" = _INSSvMhV;
        "pkg-1.1.3+MC1.21-1.21.1" = _MkN7qZDO;
        "pkg-1.2.0+MC1.19-1.19.2" = _qwmYVITx;
        "pkg-1.3.0+MC1.19.3-1.19.4" = _m3TX2Jf5;
        "pkg-1.4.0+MC1.20-1.20.1" = _l5qQvsRc;
        "pkg-1.5.0+MC1.20.2-1.20.6" = _M2qwuVGi;
        "pkg-1.6.0+MC1.21-1.21.1" = _qs2YQhJe;
        "pkg-1.2.1+MC1.19-1.19.2" = _NfCbzVF5;
        "pkg-1.3.1+MC1.19.3-1.19.4" = _Q2VYSczz;
        "pkg-1.4.1+MC1.20-1.20.1" = _MYVJNBB4;
        "pkg-1.5.1+MC1.20.2-1.20.6" = _s0G9rYLr;
        "pkg-1.6.1+MC1.21-1.21.1" = _jf4X0dtk;
        "pkg-1.7.1+MC1.21.2-1.21.3" = _cW6NuBlp;
        "pkg-1.7.2+MC1.21.2-1.21.4" = _Gkpianfc;
        "pkg-1.8.0+MC1.21.5" = _Epz8gO6h;
        "pkg-1.7.3+MC1.21.2-1.21.4" = _xDbiodfz;
        "pkg-1.8.1+MC1.21.5" = _8ThdqLVp;
        "pkg-1.5.2+MC1.20.2-1.20.6" = _nJaB6RtQ;
        "pkg-1.6.2+MC1.21-1.21.1" = _shnOyAwN;
        "pkg-1.7.4+MC1.21.2-1.21.4" = _9doWMfek;
        "pkg-1.8.2+MC1.21.5" = _c3l3SK7W;
        "pkg-1.9.0+MC1.21.6" = _l2q05kM5;
        "pkg-1.9.1+MC1.21.6-1.21.7" = _eJYqPIsF;
        "pkg-1.9.2+MC1.21.6-1.21.8" = _jWyB5H6a;
        "pkg-1.10.0+MC1.21.9" = _Iwn4jIyJ;
        "pkg-1.10.1+MC1.21.9-1.21.10" = _y4hKlUXy;
        "pkg-1.10.2+MC1.21.9-1.21.10" = _dqy0gaas;
        "pkg-1.11.0+MC1.21.11" = _RKif20A8;
        "pkg-1.9.3+MC1.21.6-1.21.8" = _2iCahCNM;
        "pkg-1.10.3+MC1.21.9-1.21.10" = _pQyF1kuo;
        "pkg-1.11.1+MC1.21.11" = _HY4FHFIu;
        "pkg-1.11.2+MC1.21.11" = _FynUj3nV;
