...
let
    ...
    in {
        ...
        "pkg-3.8.0" = _HdPESCZd;
        "pkg-3.9.0" = _Qswqa9nw;
        "pkg-3.10.0" = _pkmtv5KA;
        "pkg-3.10.1" = _RD3NjdZR;
        "pkg-3.11.0" = _d4seJHFO;
        "pkg-3.12.0" = _vDkE69Sm;
        "pkg-3.13.0" = _kquXTglI;
        "pkg-3.13.1" = _nOwyrYyx;
        "pkg-3.14.0" = _AwgHHu3B;
