...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _N5xORiOh;
        "pkg-1.18.2-2.0-fabric" = _iskTA68k;
        "pkg-1.19.2-2.2-fabric" = _7JD63FeU;
        "pkg-1.16.5-1.6-forge" = _jQfneayg;
        "pkg-1.18.2-1.7-forge" = _58TfTcjL;
        "pkg-1.19.2-1.9-forge" = _KNfKmmOr;
        "pkg-1.16.5-2.3-fabric" = _dOwem7s5;
        "pkg-1.18.2-2.3-fabric" = _GJ3buarv;
        "pkg-1.19.2-2.3-fabric" = _NrxZCA3E;
        "pkg-1.16.5-2.4-fabric" = _IiWjYLyf;
        "pkg-1.18.2-2.4-fabric" = _9jGzTTye;
        "pkg-1.19.2-2.4-fabric" = _vLtJCr7R;
        "pkg-1.16.5-2.4-forge" = _TPuEH5bY;
        "pkg-1.18.2-2.4-forge" = _2tJ6iECg;
        "pkg-1.19.2-2.4-forge" = _B85RmoWX;
        "pkg-1.19.3-2.5-fabric" = _7QoegZJR;
        "pkg-1.19.3-2.4-forge" = _vEEn8dG5;
        "pkg-1.18.2-3.0-forge+fabric" = _7NOU75Wq;
        "pkg-1.19.2-3.0-forge+fabric" = _KZzSkEmJ;
        "pkg-1.19.3-3.0-forge+fabric" = _MbrDtQAc;
        "pkg-1.18.2-3.1-forge+fabric" = _Qn8sWtsv;
        "pkg-1.19.2-3.1-forge+fabric" = _46u8UYmb;
        "pkg-1.19.3-3.1-forge+fabric" = _z2l0fgYU;
        "pkg-1.19.4-3.1-forge+fabric" = _8iYOaqzI;
        "pkg-1.20-3.1-forge+fabric" = _RG0KobR2;
        "pkg-1.20.1-3.1-forge+fabric" = _LRAT5mj0;
        "pkg-1.20.2-3.1-forge+fabric" = _x50HOvh5;
        "pkg-1.18.2-3.2-forge+fabric" = _USxftcHz;
        "pkg-1.19.2-3.2-forge+fabric" = _nFbjWZdo;
        "pkg-1.20.1-3.2-forge+fabric" = _TC3B4h6Z;
        "pkg-1.20.2-3.2-forge+fabric" = _uo32eXid;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _DMowLlrf;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _GthPQjle;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _saQABLE3;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _rnTXFzm5;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _jEbSWubn;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _CRs1ZKiL;
        "pkg-1.20.5-3.3-fabric+neo" = _MWVPlIlk;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _2MVYxbDs;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _KUgVZcvR;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _mdyXqw6k;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _jasmL2jJ;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _kjda99Z1;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _XZXkPtkO;
        "pkg-1.21.2-3.4-fabric+neo" = _qFr416rm;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _PpSwj8Fb;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _Pd2N11qB;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _cAS0cH03;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _VRpzuFdq;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _6jjblggo;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _9mnhFH8p;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _4yI6gICX;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _7eX2XQco;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _lcoJfMHV;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _exJJ7lhZ;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _k6W6Yran;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _bU7gYb4k;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _Fu8sZmT9;
        "pkg-26.1.1-3.5-fabric+forge+neo" = _b9R1s8cl;
        "pkg-26.1.2-3.5-fabric+forge+neo" = _hBHJ5l2u;
        "pkg-26.2.0-3.5-fabric+forge+neo" = _QY1oUWmN;
        "default" = _QY1oUWmN;
    });
