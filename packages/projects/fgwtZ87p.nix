...
let
    ...
    in {
        ...
        "pkg-v.1.0.5" = _fA4R95op;
        "pkg-v.2.0.0-pre3" = _GoRTGA2G;
        "pkg-v.2.0.0-pre6" = _RHmrXd5k;
        "pkg-v.2.0.0-pre7" = _nnxtrrug;
        "pkg-v.2.0.0-pre8" = _sDxWSUgb;
        "pkg-v.2.0.0-pre9" = _K5lb7MkC;
        "pkg-v.2.1.0" = _FLjFi78r;
        "pkg-v.2.1.1" = _jZLI2Dji;
        "pkg-v.2.2.0" = _hMEFkjGI;
        "pkg-v.2.3.0" = _OFihwDgE;
        "pkg-v.2.2.1" = _rtZ92riC;
        "pkg-v.3.0.0" = _vGiGd7EL;
        "pkg-v.3.0.1" = _WQdm6dPN;
        "pkg-v.3.0.2" = _7D0BgHpz;
        "pkg-v.4.0.0" = _G0wE3YG5;
        "pkg-v.2.2.2" = _osPIYUj8;
        "pkg-v.3.0.3" = _R2imJf00;
        "pkg-v.4.1.0" = _df9O71bP;
        "pkg-v.4.1.1" = _e4i1fLRn;
        "pkg-v.4.2.0" = _Y1ucbjQi;
        "pkg-v.4.1.2" = _CNBADnLs;
        "pkg-v.4.3.0" = _YXribtIK;
        "pkg-v.4.4.0" = _KBM1LRhw;
        "pkg-v.5.0.0" = _4zgfSn9U;
        "pkg-v.5.1.0" = _T3dvxrY5;
        "default" = _T3dvxrY5;
    });
