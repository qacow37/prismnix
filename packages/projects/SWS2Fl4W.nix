...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.9-fabric" = _y2oaWuTp;
        "pkg-1.18.2-1.9-fabric" = _cL1td1kd;
        "pkg-1.19.2-2.0-fabric" = _m28DtvZQ;
        "pkg-1.16.5-1.4-forge" = _jIWPeYoL;
        "pkg-1.18.2-1.6-forge" = _nW9PbpuH;
        "pkg-1.19.2-1.8-forge" = _Rtb9z0o4;
        "pkg-1.16.5-2.1-fabric" = _PVHosuTT;
        "pkg-1.18.2-2.1-fabric" = _bv75veI5;
        "pkg-1.19.2-2.1-fabric" = _pz0crC42;
        "pkg-1.19.3-2.2-fabric" = _TrlhEH59;
        "pkg-1.19.3-1.8-forge" = _i3r4YTgC;
        "pkg-1.18.2-3.0-forge+fabric" = _fRYLD9D9;
        "pkg-1.19.2-3.0-forge+fabric" = _I4rfRXZn;
        "pkg-1.19.3-3.0-forge+fabric" = _atPaWjTO;
        "pkg-1.18.2-3.1-forge+fabric" = _BLOq2iJj;
        "pkg-1.19.2-3.1-forge+fabric" = _axFQxbfh;
        "pkg-1.19.3-3.1-forge+fabric" = _knCVyHav;
        "pkg-1.19.4-3.1-forge+fabric" = _KrmpgOPF;
        "pkg-1.20-3.1-forge+fabric" = _PauSJHwC;
        "pkg-1.20.1-3.1-forge+fabric" = _7mEkiRUi;
        "pkg-1.20.2-3.1-forge+fabric" = _JUWe9PY2;
        "pkg-1.18.2-3.2-forge+fabric" = _jrIqx4ON;
        "pkg-1.19.2-3.2-forge+fabric" = _eqYptNys;
        "pkg-1.20.1-3.2-forge+fabric" = _FS4Uhbu1;
        "pkg-1.20.2-3.2-forge+fabric" = _alBY82yE;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _KKb4RZZl;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _h1eLlYBU;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _4vXVaYdh;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _SqWhcjfM;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _DHYVch89;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _Wi1XC8xS;
        "pkg-1.20.5-3.3-fabric+neo" = _fk08z057;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _R05DFIFw;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _ddcNRcWF;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _Ezmdygye;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _B5hVOsZF;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _fksmdl6k;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _4VTHf3AP;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _busvax3F;
        "pkg-1.21.2-3.5-fabric+neo" = _19BHXyxY;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _HC7Vvpyw;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _4LqEF4DE;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _bLom9xHd;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _jrLnqiYp;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _DW1uQwMA;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _m8W74pEi;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _SFYzLGY8;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _JURdkQgz;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _i6FB5pEs;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _bbvIV9FM;
        "pkg-1.21.9-3.7-fabric+forge+neo" = _bLb5z60X;
        "pkg-1.21.10-3.7-fabric+forge+neo" = _xhSAA7Wg;
        "pkg-1.21.11-3.7-fabric+forge+neo" = _EQvizoJy;
        "pkg-26.1.0-3.7-fabric+forge+neo" = _NRPG5Ali;
        "pkg-26.1.1-3.7-fabric+forge+neo" = _VvlcA9Es;
        "pkg-26.1.2-3.7-fabric+forge+neo" = _kUKCIArg;
        "pkg-26.2.0-3.7-fabric+forge+neo" = _Kavc2gWp;
        "default" = _Kavc2gWp;
    });
