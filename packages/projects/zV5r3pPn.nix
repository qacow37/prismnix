...
let
    ...
    in {
        ...
        "pkg-1.4.4-forge-1.18" = _m401inUa;
        "pkg-1.2.0-forge-1.12.2" = _9MFKDRpJ;
        "pkg-1.2.0-forge-1.8.9" = _ki0fDpDd;
        "pkg-1.4.3-fabric-1.19-pre1" = _1OrwaNHG;
        "pkg-1.4.5-forge-1.18" = _HM61ICGu;
        "pkg-1.4.5-fabric-1.18" = _oQWsE3Wl;
        "pkg-1.4.6-forge-1.18" = _IqccHU1l;
        "pkg-1.4.6-fabric-1.18" = _KF3i2ecz;
        "pkg-1.4.6-fabric-1.19" = _BOufxDjE;
        "pkg-1.4.7-fabric-1.19" = _uzmcbsZh;
        "pkg-1.4.7-forge-1.19" = _letBuiJY;
        "pkg-1.5.0-forge-1.19" = _vdoCq9uW;
        "pkg-1.5.0-fabric-1.19" = _rjpN6yq4;
        "pkg-1.5.1-forge-1.19" = _AcWr0Hgh;
        "pkg-1.5.1-fabric-1.19" = _KW20Mnwk;
        "pkg-1.5.2-forge-1.18" = _bvBPpRE4;
        "pkg-1.5.2-fabric-1.18" = _SuL3Z1P0;
        "pkg-1.5.2-forge-1.19" = _6beaDHvq;
        "pkg-1.5.2-fabric-1.19" = _JHapWF9O;
        "pkg-1.5.2-1.19.3-fabric" = _lt0gHTA6;
        "pkg-1.5.2-1.19.3-forge" = _JAPfHv5N;
        "pkg-1.5.3-1.19.3" = _p5nYXh23;
        "pkg-1.5.3-1.19.4" = _3oaS3k10;
        "pkg-1.5.3-1.20" = _gEExwPWP;
        "pkg-1.5.4-1.20" = _M8d2bZuk;
        "pkg-1.5.5-1.20.2" = _RudceNn0;
        "pkg-1.5.6-1.20.2" = _q77puo5I;
        "pkg-1.6.0" = _eO7cGpDH;
        "pkg-1.6.1" = _UxVYrBiD;
        "pkg-1.6.2" = _kJmEO0xO;
        "pkg-1.6.3" = _KyLUxGPU;
        ...
        "pkg-1.9.1" = _xbG00TLu;
        "pkg-1.9.2" = _yXY9jslg;
        "pkg-1.10.0" = _37woBJWT;
        "pkg-1.10.1" = _Bgo7sNrv;
        "pkg-1.10.2" = _jfnXr80J;
