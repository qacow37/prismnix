...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.0" = _VcoeGadQ;
        "pkg-1.20.1-1.0.1" = _IhxKg4hw;
        "pkg-1.20.1-1.1.0" = _N0CfZ4Ls;
        "pkg-1.20.1-1.1.1" = _DEJpDFbw;
        "pkg-1.20.1-1.1.2" = _rstwgpbo;
        "pkg-1.20.1-1.1.3" = _azDLc9kS;
        "pkg-1.20.1-1.1.4" = _nhyxhAYO;
        "pkg-1.20.1-1.1.5" = _u6MFceIr;
        "pkg-1.20.1-1.1.6" = _SMmDcnZR;
        "pkg-1.20.1-1.1.7" = _X9L11IQm;
        "pkg-1.20.1-1.1.8" = _qCcpn8u4;
        "pkg-1.20.1-1.1.9" = _tRZDBcfV;
        "pkg-1.20.1-1.1.10" = _VD3VXauB;
        "pkg-1.20.1-1.1.11" = _Wr7z2jFy;
        "pkg-1.20.1-1.1.12" = _sRIXOHTq;
        "pkg-1.20.1-1.1.13" = _6NwixnqT;
        "pkg-1.20.1-1.1.14" = _5gL5RjlP;
        "pkg-1.20.1-1.1.15" = _DkDxxNyr;
        "pkg-1.20.1-1.1.16" = _Iwsm9SQR;
        "pkg-1.20.1-1.1.17" = _9HrBBs5e;
        "pkg-1.20.1-1.1.18" = _MRsw4bi5;
        "pkg-1.20.1-1.1.19" = _P8vYq96F;
        "pkg-1.20.1-1.1.20" = _x7syVor8;
        "default" = _x7syVor8;
    });
