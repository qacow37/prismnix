...
let
    ...
    in {
        ...
        "pkg-1.1" = _ydYZtaKI;
        "pkg-2.0" = _AnwDDqJO;
        "pkg-2.0+mod" = _uPCGjvAE;
        "pkg-2.1" = _xEfmoFL6;
        "pkg-2.1+mod" = _rstijhAd;
        "pkg-2.2" = _H3uTfsQB;
        "pkg-2.2+mod" = _wWi4CCUu;
        "pkg-2.3" = _hqBDYQMj;
        "pkg-2.3+mod" = _k14t5cGj;
        "pkg-2.4" = _M13mTX5u;
        "pkg-2.4+mod" = _7SFzN365;
        "pkg-2.5" = _aElv8nIN;
        "pkg-2.5+mod" = _bqwPkLMl;
        "pkg-2.6" = _8FyKjNd5;
        "pkg-2.6+mod" = _nNCFLBOX;
        "pkg-2.7" = _LUnznAEN;
        "pkg-2.7-fabric" = _lR2LmoLA;
        "pkg-2.7-forge" = _MPSuwBiU;
        "pkg-2.11" = _KqPzsqki;
        "pkg-2.11-fabric" = _6J61zSPV;
        "pkg-2.11-quilt" = _blCNkYqP;
        "pkg-2.11-forge" = _PY43AHA1;
        "pkg-2.11-neoforge" = _rABB4sNO;
        "pkg-2.12" = _JK2B6g34;
        "pkg-2.12-fabric" = _hOfTFKAq;
        "pkg-2.12-quilt" = _BTBiiiJX;
        "pkg-2.12-forge" = _gotn8VPW;
        "pkg-2.12-neoforge" = _A0VmUQcX;
        "pkg-2.13" = _isqp75NV;
        "pkg-2.13-fabric" = _6An318ui;
        "pkg-2.13-quilt" = _xHYSxleA;
        "pkg-2.13-forge" = _TnQXy6K9;
        "pkg-2.13-neoforge" = _WAPL9nW2;
        "default" = _WAPL9nW2;
    });
