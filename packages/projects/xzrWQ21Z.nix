...
let
    ...
    in {
        ...
        "pkg-1.0.3-mc1.21.9" = _K2TPkP9g;
        "pkg-1.0.3-mc1.21.10" = _lBcl89vU;
        "pkg-1.0.4-mc1.21.9" = _OvjShjU7;
        "pkg-1.0.4-mc1.21.10" = _oAfPlzVl;
        "pkg-1.0.4-mc25w41a" = _tF1naAhg;
        "pkg-1.0.5-mc1.21.9" = _2jZUcffn;
        "pkg-1.0.5-mc1.21.10" = _Px3D4506;
        "pkg-1.0.5-mc25w42a" = _OUsOmREv;
        "pkg-1.0.5-mc25w43a" = _RnF0mpyC;
        "pkg-1.0.6-mc1.21.9" = _MGWwSkrj;
        "pkg-1.0.6-mc1.21.10" = _gGNjh8r8;
        "pkg-1.0.6-mc1.21.11" = _WFbswUaF;
        "pkg-1.0.6-mc26.1-snapshot-1" = _NNhD9L8a;
        "pkg-1.1-mc1.21.9" = _udB7d3k3;
        "pkg-1.1-mc1.21.10" = _7gm19c7H;
        "pkg-1.1-mc1.21.11" = _VdRdiCyV;
        "pkg-1.1-mc26.1" = _1uiJPGVq;
        "pkg-1.1.1-mc26.1" = _hKQJJk8d;
        "pkg-1.1.2-mc26.1" = _J5R9iaTr;
        "pkg-1.1.3-mc1.21.9" = _a1lgLVID;
        "pkg-1.1.3-mc1.21.10" = _rDHKlkET;
        "pkg-1.1.3-mc1.21.11" = _rbvjKlWU;
        "pkg-1.1.3-mc26.1" = _V2Omke8s;
        "pkg-1.1.4-mc26.2" = _xSSyfTw7;
        "pkg-1.1.5-mc26.1" = _UVses0y0;
        "pkg-1.1.5-mc26.2" = _hQ8jnpnD;
