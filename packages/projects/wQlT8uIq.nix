...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.0-fabric" = _Upz1BVtA;
        "pkg-1.18.2-2.0-fabric" = _oouTHoD6;
        "pkg-1.19.2-2.2-fabric" = _hXaHSDeR;
        "pkg-1.16.5-1.5-forge" = _jjUc8aMy;
        "pkg-1.18.2-1.7-forge" = _WSrjOSGq;
        "pkg-1.19.2-1.9-forge" = _oRhCQAJ3;
        "pkg-1.16.5-2.3-fabric" = _Vf24PNhj;
        "pkg-1.18.2-2.3-fabric" = _Uh7vFRSn;
        "pkg-1.19.2-2.3-fabric" = _lNH62dby;
        "pkg-1.19.3-2.4-fabric" = _nbxr5aFi;
        "pkg-1.19.3-1.9-forge" = _qZVFK3ow;
        "pkg-1.18.2-3.0-forge+fabric" = _bq5kSMzq;
        "pkg-1.19.2-3.0-forge+fabric" = _g98eT2xm;
        "pkg-1.19.3-3.0-forge+fabric" = _B0TXMmI8;
        "pkg-1.18.2-3.1-forge+fabric" = _fKqToVJC;
        "pkg-1.19.2-3.1-forge+fabric" = _Kyz6gD7d;
        "pkg-1.19.3-3.1-forge+fabric" = _WHVdHeia;
        "pkg-1.18.2-3.2-forge+fabric" = _q9Rg4etN;
        "pkg-1.19.2-3.2-forge+fabric" = _V5J3XbEc;
        "pkg-1.19.3-3.2-forge+fabric" = _UkHqe87S;
        "pkg-1.18.2-3.3-forge+fabric" = _Lr7cpyZs;
        "pkg-1.19.2-3.3-forge+fabric" = _ILt9nr4s;
        "pkg-1.19.3-3.3-forge+fabric" = _tYASx9Zb;
        "pkg-1.18.2-3.4-forge+fabric" = _1mEcMhB7;
        "pkg-1.19.2-3.4-forge+fabric" = _uU0LQRoX;
        "pkg-1.19.3-3.4-forge+fabric" = _nya9AJLg;
        "pkg-1.19.4-3.4-forge+fabric" = _yrBnNZh5;
        "pkg-1.20-3.4-forge+fabric" = _k8ywVZjc;
        "pkg-1.20.1-3.4-forge+fabric" = _NppDpOnH;
        "pkg-1.20.2-3.4-forge+fabric" = _UVRO3qfK;
        "pkg-1.18.2-3.6-forge+fabric" = _7ubsD7VK;
        "pkg-1.19.2-3.6-forge+fabric" = _WwGTFhvD;
        "pkg-1.20.1-3.6-forge+fabric" = _MmS7vgdM;
        "pkg-1.20.2-3.6-forge+fabric" = _iKhVX2Hk;
        "pkg-1.20.3-3.6-fabric+forge+neo" = _b2WEj56U;
        "pkg-1.20.4-3.6-fabric+forge+neo" = _ztkx49bd;
        "pkg-1.19.2-3.7-fabric+forge+neo" = _9WhrA8QB;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _lk9JyCAL;
        "pkg-1.20.2-3.7-fabric+forge+neo" = _qk6UcvEk;
        "pkg-1.20.4-3.7-fabric+forge+neo" = _c4vTcKzi;
        "pkg-1.20.5-3.7-fabric+neo" = _QjqUjqd6;
        "pkg-1.20.5-3.8-fabric+neo" = _92KZknHc;
        "pkg-1.20.6-3.8-fabric+forge+neo" = _V3ResVGX;
        "pkg-1.21.0-3.8-fabric+forge+neo" = _6JSpOEQs;
        "pkg-1.20.1-3.9-fabric+forge+neo" = _gPc95crv;
        "pkg-1.20.6-3.9-fabric+forge+neo" = _ukqfyQOM;
        "pkg-1.21.0-3.9-fabric+forge+neo" = _ekIKmkJr;
        "pkg-1.21.1-3.9-fabric+forge+neo" = _b1mOwcgQ;
        "pkg-1.21.2-3.9-fabric+neo" = _JtqGKo3W;
        "pkg-1.21.3-3.9-fabric+forge+neo" = _2f31pAWp;
        "pkg-1.21.4-3.9-fabric+forge+neo" = _SmuLyTjG;
        "pkg-1.21.5-3.9-fabric+forge+neo" = _r7gYm0k2;
        "pkg-1.21.6-3.9-fabric+forge+neo" = _WRX2fDlv;
        "pkg-1.21.7-3.9-fabric+forge+neo" = _70eAhUDK;
        "pkg-1.21.8-3.9-fabric+forge+neo" = _lZNb5P66;
        "pkg-1.21.9-3.9-fabric+forge+neo" = _bmaapx4z;
        "pkg-1.21.10-3.9-fabric+forge+neo" = _ob9AqaZ9;
        "pkg-1.21.11-3.9-fabric+forge+neo" = _Xsf9Gm37;
        "pkg-26.1.0-3.9-fabric+forge+neo" = _CeLKVctn;
        "pkg-26.1.1-3.9-fabric+forge+neo" = _P4AHUkuO;
        "pkg-26.1.2-3.9-fabric+forge+neo" = _pxFVsOGx;
        "pkg-26.2.0-3.9-fabric+forge+neo" = _o0T9yo3P;
        "default" = _o0T9yo3P;
    });
