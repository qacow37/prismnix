...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _MZGNjPkc;
        "pkg-1.1.0-alpha.1" = _usVTG0Bj;
        "pkg-1.1.0-alpha.2" = _kJei4Hzl;
        "pkg-1.1.0-alpha.3" = _2hd2nolx;
        "pkg-1.1.0-alpha.4" = _a2UeHo6L;
        "pkg-1.1.0-alpha.5" = _qVbfHDi8;
        "pkg-1.1.0-alpha.6" = _PghMcuuL;
        "pkg-1.1.0-alpha.7" = _9inXqUj9;
        "pkg-1.1.0-beta.1" = _6FEyRYap;
        "pkg-1.1.0-beta.2" = _Ext6G4hR;
        "pkg-1.1.0-beta.3" = _YZg45Us8;
        "pkg-1.1.0-beta.4" = _LY6Hy79O;
        "pkg-2.0.0-alpha.1" = _CqkpnJ9T;
        "pkg-2.0.0-alpha.2" = _aeOSlaHO;
        "pkg-2.0.0-alpha.3" = _Ka74wMPX;
        "pkg-2.0.0-alpha.3.1" = _d6Ml8Czr;
        "pkg-2.0.0-alpha.4" = _7sQj1W7U;
        "pkg-2.0.0-alpha.5" = _wzYmP4nJ;
        "pkg-2.0.0-alpha.5.1" = _akJ70eHt;
        "pkg-2.0.0-alpha.6" = _3d1w6v2G;
        "pkg-2.0.0-alpha.7" = _oFZFdqC4;
        "pkg-2.0.0-alpha.7.1" = _ETufDuVB;
        "pkg-2.0.0-alpha.8" = _jTACR9vk;
        "pkg-2.0.0-alpha.9" = _SpD7vCgX;
        "pkg-2.0.0-beta.1" = _zmVM4Yjl;
        "pkg-2.0.0-beta.2" = _5Gkpbxhv;
        "pkg-2.0.0-beta.3" = _hpwqqBO4;
        "pkg-2.0.0-beta.3.1" = _hPoNt2W0;
        "pkg-2.0.0-beta.4" = _wcU6B4yH;
        "pkg-2.0.0-beta.5" = _Aqijxasj;
        "pkg-2.0.0-beta.6" = _cmpE6B9N;
        "pkg-2.0.0-beta.7" = _qE3GP5Zb;
        "pkg-2.0.0-beta.8" = _UkW2TYyf;
        "pkg-2.0.0-beta.9" = _BEx6TFPf;
        "pkg-2.0.0-beta.10" = _EzY0gVEO;
        "pkg-2.0.0-beta.11" = _bOIHLQmQ;
        "pkg-2.0.0-beta.12" = _PBkMdzIb;
        "pkg-2.0.0-rc.1" = _z96GSPub;
        "pkg-2.0.0" = _B2w8upO6;
        "pkg-2.0.0+for-mc1.20.1" = _V0L1E5n6;
        "pkg-2.1.0-alpha.1" = _Rqp6sKIl;
        "pkg-2.1.0-alpha.1.1" = _BLm1KCgK;
        "pkg-2.1.0-alpha.2+mc1.20.1" = _UWxHslGq;
        "pkg-2.1.0-alpha.2+mc1.20.2" = _xEgPkS6a;
        "pkg-2.1.0-alpha.3+mc1.20.1" = _nKZhXOmL;
        "pkg-2.1.0-alpha.3+mc1.20.2" = _SEf1hGRr;
        "pkg-2.0.1" = _taP9kWLB;
        "pkg-2.0.1+for-mc1.20.1" = _J9o94Wxm;
        "pkg-2.1.0-alpha.4+mc1.20.2" = _Q8mKpiRY;
        "pkg-2.1.0-alpha.4+mc1.20.1" = _Ka36CzsD;
        "pkg-2.1.0-alpha.5+mc1.20.2" = _Kwibojp1;
        "pkg-2.1.0-alpha.5+mc1.20.1" = _u8gPfzd0;
        "pkg-2.1.0-alpha.5.1+mc1.20.2" = _Qwe7ISKl;
        "pkg-2.1.0-alpha.5.1+mc1.20.1" = _7oIsZIWC;
        "pkg-2.1.0-alpha.6+mc1.20.2" = _G5FR9Gp3;
        "pkg-2.1.0-alpha.6+mc1.20.1" = _iq5lLpnT;
        "pkg-2.0.2" = _eDFNDqNd;
        "pkg-2.1.0-alpha.7+mc1.20.2" = _yEuD57po;
        "pkg-2.1.0-alpha.7+mc1.20.1" = _JjLElPq6;
        "pkg-2.1.0-alpha.7.1+mc1.20.2" = _qI8oe1Bg;
        "pkg-2.1.0-alpha.7.1+mc1.20.1" = _NrbWQgXq;
        "pkg-2.1.0-alpha.8+mc1.20.2" = _osPpTioo;
        "pkg-2.1.0-alpha.8+mc1.20.1" = _VnRS2ypb;
        "pkg-2.1.0-alpha.8.1+mc1.20.2" = _5VwQV013;
        "pkg-2.1.0-alpha.8.1+mc1.20.1" = _qYwSCWhU;
        "pkg-2.1.0-alpha.8.2+mc1.20.2" = _Z98gl40v;
        "pkg-2.1.0-alpha.8.2+mc1.20.1" = _2NHhhg5k;
        "pkg-2.1.0-alpha.8.3+mc1.20.2" = _h71KClf9;
        "pkg-2.1.0-alpha.8.3+mc1.20.1" = _7cj2yGf1;
        "pkg-2.1.0-alpha.8.4+mc1.20.1" = _K9sngP6H;
        "pkg-2.1.0-alpha.8.4+mc1.20.2" = _fGfvHOo0;
        "pkg-2.1.0-alpha.9+mc1.20.2" = _tC2Y3zVP;
        "pkg-2.1.0-alpha.9+mc1.20.1" = _NYsoQfI4;
        "pkg-2.1.0-alpha.9.1+mc1.20.2" = _IkpxPIuH;
        "pkg-2.1.0-alpha.9.1+mc1.20.1" = _ArDwgElD;
        "pkg-2.1.0-alpha.9.2+mc1.20.2" = _uLBbjgcm;
        "pkg-2.1.0-alpha.9.2+mc1.20.1" = _oylFcGny;
        "pkg-2.1.0-alpha.9.2+mc24w34a" = _nNUbcQ1p;
        "pkg-2.1.0-alpha.10+mc1.20.1" = _WqYwpeiC;
        "pkg-2.1.0-alpha.10+mc1.20.2" = _SsNTnGmn;
        "pkg-2.1.0-alpha.10+mc24w34a" = _fIa7eifF;
        "pkg-2.1.0-beta.1+mc1.20.1" = _IArNdV8a;
        "pkg-2.1.0-beta.1+mc1.20.2" = _GVZj6ofK;
        "pkg-2.1.0-beta.1+mc24w35a" = _L5myl2e2;
        "pkg-2.1.0-beta.2+mc1.20.1" = _ZTCX6jF6;
        "pkg-2.1.0-beta.2+mc1.20.2" = _GoEqSeEm;
        "pkg-2.1.0-beta.2+mc24w35a" = _mI2vXumZ;
        "pkg-2.1.0-beta.3+mc1.20.1" = _jAUi5b40;
        "pkg-2.1.0-beta.3+mc1.20.2" = _vkIVTvWe;
        "pkg-2.1.0-beta.3+mc24w35a" = _H2v7yyWk;
        "pkg-2.1.0-beta.4+mc1.20.1" = _OAbmGlxt;
        "pkg-2.1.0-beta.4+mc1.20.2" = _8uy4tm2M;
        "pkg-2.1.0-beta.4+mc24w38a" = _QC7XGaMi;
        "pkg-2.1.0-beta.5+mc1.20.1" = _yQHvgUaw;
        "pkg-2.1.0-beta.5+mc1.20.2" = _nPYdW1QQ;
        "pkg-2.1.0-beta.5+mc24w38a" = _DuuQNhve;
        "pkg-2.1.0-rc.1+mc1.20.1" = _v8QmsXwk;
        "pkg-2.1.0-rc.1+mc1.20.2" = _ZhxJbmKN;
        "pkg-2.1.0-rc.1+mc24w38a" = _R0Uwm01U;
        "pkg-2.1.0-rc.1.1+mc1.20.1" = _jnNK1BFG;
        "pkg-2.1.0-rc.1.1+mc1.20.2" = _OQ34PT7z;
        "pkg-2.1.0-rc.1.1+mc24w38a" = _qANoomDu;
        "pkg-2.1.0+mc1.20.1" = _kOpwCoNy;
        "pkg-2.1.0+mc1.20.2" = _8SGBUPPT;
        "pkg-2.1.0+mc24w38a" = _CQcw7eC4;
        "pkg-2.1.1+mc1.20.1" = _mDjiRetN;
        "pkg-2.1.1+mc1.20.2" = _4nrivlIw;
        "pkg-2.1.1+mc1.21.2-pre3" = _Yc8TgXLS;
        "pkg-2.1.2+mc1.20.1" = _h62nmXFH;
        "pkg-2.1.2+mc1.20.2" = _KTnRJRIB;
        "pkg-2.1.2+mc1.21.2-pre3" = _EBewUo0E;
        "pkg-2.1.3-beta.1+mc1.21" = _MovBz8EY;
        "pkg-2.1.3-beta.1+mc1.21.3" = _n0Temk9I;
        "pkg-2.1.3-beta.2" = _NxznoCuu;
        "pkg-2.1.3-beta.2+mc1.21.3" = _2yQe1jho;
        "pkg-2.1.3-beta.2.1+mc1.21.3" = _KVKYlTyx;
        "pkg-2.1.3-beta.2.1+mc1.21" = _monwxjqy;
        "pkg-2.1.3-beta.3" = _DYO91QRq;
        "pkg-2.1.3-beta.3.0.1+mc1.21.3" = _cZW3446O;
        "pkg-2.1.3-beta.3.1+mc1.21" = _5FEbBvfl;
        "pkg-2.1.3-beta.3.1+mc1.21.3" = _iZVZi6ug;
        "pkg-2.1.3-beta.4" = _Z6P4TyXP;
        "pkg-2.1.3" = _Lqp2kcEV;
        "pkg-2.1.4" = _wGp8PM6k;
        "pkg-2.1.4.1" = _xampNBvT;
        "pkg-2.1.5" = _y2zCQE1V;
        "pkg-2.1.6" = _PN1nOU4U;
        "default" = _PN1nOU4U;
    });
