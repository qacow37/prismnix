...
let
    ...
    in {
        ...
        "pkg-fabric-1.0.0b-1.19.2" = _famNO8rx;
        "pkg-forge-1.0.0b-1.19.2" = _Oc7WrShV;
        "pkg-common-1.0.0b-1.19.2" = _c6PBIGGI;
        "pkg-forge-1.0.1b-1.19x" = _NHTpdRZL;
        "pkg-fabric-1.0.1b-1.19x" = _qsYrEsdS;
        "pkg-common-1.0.1b-1.19x" = _oRY7UP3R;
        "pkg-forge-1.0.2b-1.19x" = _Az2NFvtv;
        "pkg-forge-1.0.3b-1.19x" = _HouNbfGB;
        "pkg-fabric-1.0.3b-1.19x" = _QrelVXld;
        "pkg-common-1.0.3b-1.19x" = _U9Q00Ltd;
        "pkg-fabric-1.0.4b-1.19x" = _2gi7u32E;
        "pkg-common-1.0.4b-1.19x" = _xIqGgdtf;
        "pkg-forge-1.0.4b-1.19x" = _FcifoUOv;
        "pkg-forge-2.0-1.19x" = _b5tCCWTT;
        "pkg-fabric-2.0-1.19x" = _4eaOKJkk;
        "pkg-fabric-2.1.0-1.19x" = _JLQQobhL;
        "pkg-forge-2.1.0-1.19x" = _JYBhA6kb;
        "pkg-forge-3.0.1-1.19x" = _BK3aVTKF;
        "pkg-fabric-3.0.1-1.19x" = _he6fNF0S;
        "pkg-forge-3.0.1-1.18.2" = _QB48GeX5;
        "pkg-fabric-3.0.1-1.18.2" = _nAci8BAQ;
        "pkg-fabric-3.0.2-1.19x" = _GYomXWkq;
        "pkg-forge-3.0.2-1.19x" = _ZpmfYfcA;
        "pkg-fabric-3.0.2-1.20x" = _OXXBHbnz;
        "pkg-forge-3.0.2-1.20x" = _woKbFKN9;
        "default" = _woKbFKN9;
    });
