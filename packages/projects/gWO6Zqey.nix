...
let
    ...
    in {
        ...
        "pkg-1.4.5b" = _A681n0Ku;
        "pkg-1.4.5c" = _x1In29ih;
        "pkg-1.4.5e" = _U9yLDtcb;
        "pkg-1.4.6" = _aCZqvWIE;
        "pkg-1.4.7" = _VLPQFQ8x;
        "pkg-1.4.7a" = _vfbxOcfl;
        "pkg-1.4.8" = _fizmkiNh;
        "pkg-1.4.8a" = _tgf1cE9x;
        "pkg-1.4.8b" = _HmxLl5PY;
        "pkg-1.4.8c" = _MaWEPomc;
        "pkg-1.4.9" = _D8QAO6Vi;
        "pkg-1.4.9+mod" = _YBayxFEZ;
        "pkg-1.4.9a" = _sGumKsxi;
        "pkg-1.4.9a+mod" = _i8XiOSCi;
        "pkg-1.4.9b" = _XZAZOkia;
        "pkg-1.4.9b+mod" = _OLnYMgrO;
        "pkg-1.4.9c" = _FcyE1UCS;
        "pkg-1.4.9c+mod" = _75z4GdDe;
        "pkg-1.4.9d" = _iA7XfAUL;
        "pkg-1.4.9d+mod" = _Gs4cPRaR;
        "pkg-1.4.9e" = _nNkUMozh;
        "pkg-1.4.9e+mod" = _CTnwtv4f;
        "pkg-1.4.10" = _CkjwAUEQ;
        "pkg-1.4.10+mod" = _C9dyOJyf;
        "pkg-1.4.10a" = _nk6qZkTg;
        "pkg-1.4.10a+mod" = _BcS1c0o9;
        "pkg-1.4.11" = _79oRGGLA;
        "pkg-1.4.11+mod" = _c3K4w2lv;
        "pkg-1.4.11a" = _3mJp8WuF;
        "pkg-1.4.11a+mod" = _MZTe8f3z;
        "pkg-1.4.11b" = _VsTtPTRs;
        "pkg-1.4.11b+mod" = _4EpkF86w;
        "pkg-1.4.11c" = _GFi4GM4I;
        "pkg-1.4.11c+mod" = _zuj4s2tC;
        "pkg-1.4.12" = _U7IvvRBw;
        "pkg-1.4.12+mod" = _OeL7I6bI;
        "pkg-1.4.12b" = _TaxxqrJ0;
        "pkg-1.4.12b+mod" = _9gtPLABF;
        "pkg-1.4.12c" = _sJ8y5IA4;
        "pkg-1.4.12c+mod" = _piqcI5v9;
        "pkg-1.4.12d" = _jl25uYVC;
        "pkg-1.4.12d+mod" = _H0SsPJkV;
        "pkg-1.4.12e" = _ITrKvmSe;
        "pkg-1.4.12e+mod" = _Ucll9YTR;
        "pkg-1.4.13" = _pDzPVWjD;
        "pkg-1.4.13+mod" = _YyCNoEMR;
        "pkg-1.4.13a" = _AcLQjO2f;
        "pkg-1.4.13a+mod" = _ZMGDgGST;
        "pkg-1.4.13b" = _sU41mfX4;
        "pkg-1.4.13b+mod" = _as6ojMMq;
        "pkg-1.4.13c" = _YFMmUEFg;
        "pkg-1.4.13c+mod" = _1WXv6wbX;
        "pkg-1.4.13d" = _uZVbe0hz;
        "pkg-1.4.13d+mod" = _GzkCJNoq;
        "pkg-1.4.13e" = _I3pTnYp7;
        "pkg-1.4.13e+mod" = _1teTZjV9;
        "pkg-1.4.13f" = _TRTVJCxv;
        "pkg-1.4.13f+mod" = _LS83lT7i;
        "pkg-1.4.13g" = _fDPql2oC;
        "pkg-1.4.13g+mod" = _e19uulnb;
        "pkg-1.4.13h" = _6cUCKhNb;
        "pkg-1.4.13h+mod" = _T9KmLph2;
        "pkg-1.4.13i" = _Ue6ofKGA;
        "pkg-1.4.13i+mod" = _PwT2iVpk;
        "pkg-1.4.13j" = _iuxpUni5;
        "pkg-1.4.13j+mod" = _3SjUggG5;
        "pkg-1.4.13k" = _OgAOMB7P;
        "pkg-1.4.13k+mod" = _fsPPcWIh;
        "pkg-1.4.13l" = _kF5xHb7d;
        "pkg-1.4.13l+mod" = _1liY0Bpz;
        "pkg-1.4.14" = _lELrYwus;
        "pkg-1.4.14+mod" = _HSukAfwX;
        "pkg-1.4.15" = _2T4SoZqT;
        "pkg-1.4.15+mod" = _RXCu7WR4;
        "pkg-1.4.15a+mod" = _AJdGModm;
        "pkg-1.4.15a" = _nNy5tBUY;
        "pkg-1.4.15b" = _mz1m5C19;
        "pkg-1.4.15b+mod" = _ygS3ey3u;
        "pkg-1.4.15c" = _habuedYO;
        "pkg-1.4.15c+mod" = _aq4nxVJF;
        "pkg-1.4.15d" = _QoL60k9P;
        "pkg-1.4.15d+mod" = _R8cFXdLA;
        "pkg-1.4.15e" = _fUrBBKwI;
        "pkg-1.4.15e+mod" = _lvOoloN2;
        "pkg-1.4.15f" = _yZUZIqEd;
        "pkg-1.4.14a" = _V19KZ3Xi;
        "pkg-1.4.14a+mod" = _oetTxOrS;
        "pkg-1.4.15f+mod" = _aNqaMNNR;
        "pkg-1.4.16" = _A3eftYLj;
        "pkg-1.4.16+mod" = _Bw7pcHg0;
        "pkg-1.4.16a" = _dnPIk2hF;
        "pkg-1.4.16a+mod" = _8foVIgG1;
        "pkg-1.4.16b" = _6Yp61rpZ;
        "pkg-1.4.16b+mod" = _eLq7QwhQ;
        "pkg-v1.4.16c" = _9ZMSaKvl;
        "pkg-v1.4.16c+mod" = _TvTKdtrw;
        "pkg-1.4.16d" = _9nJL1oYr;
        "pkg-1.4.16d+mod" = _57jwwXu9;
        "pkg-1.4.16e" = _SPqWpsV1;
        "pkg-1.4.16e+mod" = _rYLj6IXD;
        "pkg-1.4.16f" = _UL2xQasB;
        "pkg-1.4.16f+mod" = _gpD1vV4R;
        "pkg-1.4.16g" = _ACGOlhZe;
        "pkg-1.4.16g+mod" = _7N0rgHKc;
        "pkg-1.4.16h" = _rH6JiyrL;
        "pkg-1.4.16h+mod" = _6L2svftd;
        "pkg-1.4.17" = _tyXrza1L;
        "pkg-1.4.17+mod" = _B9gSKBFl;
        "pkg-1.4.17a" = _JqR5y86a;
        "pkg-1.4.17a+mod" = _UKZrIANC;
        "pkg-1.4.17b" = _7AbuG1kT;
        "pkg-1.4.17b+mod" = _oCmddDGX;
        "pkg-1.4.17c" = _R7DWuPk6;
        "pkg-1.4.17c+mod" = _YNnfAskz;
        "pkg-1.4.18" = _5dQXqNnl;
        "pkg-1.4.18+mod" = _rXQnkTeq;
        "pkg-1.4.18a" = _TqBbct5X;
        "pkg-1.4.18a+mod" = _RvNrgpKE;
        "pkg-1.4.18b+mod" = _SIUxl4r1;
        "pkg-1.4.18b" = _AAYL2Ojj;
        "pkg-1.4.18d" = _43e5vo6L;
        "pkg-1.4.18d+mod" = _mLG5PaRR;
        "pkg-1.4.18e" = _cSjtjImV;
        "pkg-1.4.18e+mod" = _7ovtve5m;
        "pkg-1.4.18f" = _9D5jbkco;
        "pkg-1.4.18f+mod" = _FVZapXVm;
        "pkg-1.4.19" = _ECH35QUd;
        "pkg-1.4.19+mod" = _pXWxdS3V;
        "pkg-1.4.19a" = _J1Z1ZvQV;
        "pkg-1.4.19a+mod" = _HT6gTdM1;
        "pkg-1.4.19b" = _ngM4HGGK;
        "pkg-1.4.19b+mod" = _JqxjEhPr;
        "pkg-1.4.19c" = _EVwf2QUZ;
        "pkg-1.4.19d" = _vH3PH56W;
        "pkg-1.4.19e" = _wrkmz1Dj;
        "pkg-1.4.19f" = _693ujEiZ;
        "pkg-1.4.19g" = _hJUtSV0a;
        "pkg-1.4.19g+mod" = _Mf9eefVp;
        "pkg-1.4.19h" = _mJeePxHx;
        "pkg-1.4.19h+mod" = _NPi0svI8;
        "pkg-1.4.20" = _9VZBBdnJ;
        "pkg-1.4.20+mod" = _zjcMXKsD;
        "pkg-1.4.20a" = _4MDcvuU0;
        "pkg-1.4.20a+mod" = _jjZ4losJ;
        "pkg-1.4.20b" = _ggfrxFW4;
        "pkg-1.4.20b+mod" = _R9qWY5IW;
        "pkg-1.4.21" = _dcEnQikD;
        "pkg-1.4.22" = _uUaIX2j4;
        "pkg-1.4.22a" = _v46P2TPw;
        "pkg-1.4.22b" = _jqxspImq;
        "pkg-1.4.22c" = _USqph4DH;
        "pkg-1.4.23" = _wJULEcXg;
        "pkg-1.4.23a" = _WIo1D3tf;
        "pkg-1.4.23b" = _bCNG0fAq;
        "pkg-1.4.24" = _zQZPbOLz;
        "pkg-1.4.24a" = _dpiCf2Li;
        "pkg-1.4.24b" = _BhJXL6o1;
        "pkg-1.4.24c" = _c5zUax8h;
        "pkg-1.4.24d" = _wASRKWHN;
        "pkg-1.4.24e" = _P3ZJswBp;
        "pkg-1.4.24f" = _kgO764wt;
        "pkg-1.4.24g" = _9pBNbc5j;
        "pkg-1.4.24h" = _aNlvxwUT;
        "pkg-1.4.24i" = _btxPrKvC;
        "pkg-1.4.24j" = _RYTdk7nc;
        "pkg-1.4.25" = _TvzkWk5w;
        "pkg-1.4.25a" = _3r5v1KRB;
        "pkg-1.4.25b" = _Pz6uissL;
        "pkg-1.4.25c" = _oFgKjIfc;
        "pkg-1.4.26" = _kmDSUUKd;
        "pkg-1.4.26a" = _OIG3tQbV;
        "pkg-1.4.26b" = _IaBmUQEM;
        "pkg-1.4.26c" = _A8QA6lsv;
        "pkg-1.4.26d" = _A24q8045;
        "pkg-1.4.26e" = _iZWeGQEX;
        "pkg-1.4.27" = _pfsIBVPc;
        "pkg-1.4.27a" = _zoG7SIUH;
        "pkg-1.4.27b" = _iAkYoYXi;
        "pkg-1.4.27c" = _vxNxCczg;
        "pkg-1.4.27d" = _Gme6KbuX;
        "pkg-1.4.27e" = _mJIzTnlm;
        "pkg-1.4.27g" = _CvxqgNIJ;
        "pkg-1.4.28" = _OG7eyAvw;
        "pkg-1.4.28a" = _EHjk5kzY;
        "pkg-1.4.28b" = _S5lgkZMv;
        "pkg-1.4.29" = _v0Fz6vu7;
        "pkg-1.4.30" = _Zf5WC8ox;
        "pkg-1.4.31" = _e4Gn0vUO;
        "default" = _e4Gn0vUO;
    });
