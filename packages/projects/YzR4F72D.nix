...
let
    ...
    in {
        ...
        "pkg-0.2.5" = _WZ8t6g3R;
        "pkg-0.2.6" = _eu3gdNqe;
        "pkg-1.19-0.2.6" = _phhrUwQ2;
        "pkg-0.2.7" = _imbQCZqp;
        "pkg-0.2.7-19" = _cGfgWtKy;
        "pkg-0.2.8" = _IxZOiD5t;
        "pkg-0.4.0" = _VwdwtVES;
        "pkg-1.0.2" = _CIs0rJhi;
        "pkg-1.0.1" = _eR3fdoNf;
        "pkg-0.4.2" = _RIOF1ReM;
        "pkg-0.9.0" = _N6mYp3C9;
        "pkg-0.9.9-1.20.1" = _7R30b1kl;
        "pkg-1.1.1" = _KtbMzIPr;
        "pkg-2.0.0-1.19.2-Forge" = _CidLkil5;
        "pkg-2.1.0" = _DOjFRshg;
        "pkg-2.2.0" = _GhisKS3l;
        "pkg-2.1.1" = _Ek5UvuUY;
        "pkg-2.1.2" = _HhCD61P9;
        ...
        "pkg-2.5.0" = _wtBqaql7;
        "pkg-2.5.1" = _S9Q9ciST;
        "pkg-2.5.1a" = _eerg3MaD;
        "pkg-2.5.2" = _Tg0Wft0J;
        "pkg-2.5.3" = _9KL2qirv;
        "pkg-2.5.4" = _7Vmco4Wl;
        "pkg-2.5.1atm" = _nwfadWsK;
        "pkg-3.0.0b" = _mgaB4dNd;
        "pkg-3.0.0" = _PGqARJch;
        "pkg-3.0.1" = _6BKNSaCo;
        "pkg-3.0.2" = _tdT4aZR2;
        "pkg-3.1.0" = _4QsG6tYd;
        ...
        "pkg-4.0.1" = _htwihKmg;
        "pkg-4.1.0" = _tcQZjC5J;
        "pkg-4.1.0-1.20.1" = _iNVzJsGu;
        "pkg-4.2.0-1.21.1" = _IZNgnUi2;
        "pkg-4.2.1-1.21.1" = _YWPSF5Pi;
        "pkg-4.2.2-1.21.1" = _WtJFTpC4;
        "pkg-4.1.1-1.20.1" = _ckFeaGoo;
        "pkg-chicken_roost-26.1-snapshot-4-1" = _bDbcOKsv;
        "pkg-4.2.3b" = _PF7FL3hb;
        "default" = _PF7FL3hb;
    });
