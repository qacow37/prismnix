...
let
    ...
    in {
        ...
        "pkg-0.1.0+mc.1.16.5" = _rAVnCi5t;
        "pkg-0.2.2+mc.1.17" = _q0dUtI4w;
        "pkg-0.2.3+mc.1.17" = _eN3veIQj;
        "pkg-0.4.0-1.17.1" = _aP9ZWEpt;
        "pkg-0.5.0-1.17.1" = _x2oALgdZ;
        "pkg-0.6.0-1.18" = _PfQdMSCT;
        "pkg-0.6.1+1.18" = _EL40C7dX;
        "pkg-0.6.2+1.18" = _2AtgwcVV;
        "pkg-0.6.4" = _uQjMY91P;
        "pkg-0.7.0" = _lsbzzwcb;
        "pkg-1.0.0+1.18.2" = _LWAGIiVU;
        "pkg-1.0.1+1.19.3" = _xYr12uKy;
        "pkg-1.0.1+1.19.4" = _wVgSAw2T;
        "pkg-1.0.2+1.19.2" = _8oeGwkE3;
        "pkg-1.0.3+1.20.1" = _FrLkTZon;
        "pkg-1.0.4+1.20.1" = _cD8610CW;
        "pkg-1.0.5+1.20.6" = _Z64kDLcd;
        "pkg-1.1.0+1.20.6" = _cEq3FfIE;
        "pkg-1.2.0" = _KHaSOiV0;
        "pkg-1.3.0+1.21" = _knct79tj;
        "pkg-1.3.1+1.21.4" = _iqABtuOH;
        "pkg-1.3.2+1.21.5" = _zZoWoJ9P;
        "pkg-1.3.3+1.21.7" = _r6MtcSbp;
        "default" = _r6MtcSbp;
    });
