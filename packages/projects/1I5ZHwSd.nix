...
let
    ...
    in {
        ...
        "pkg-1.0.0-fabric" = _OQ7akpWe;
        "pkg-1.0.0-forge" = _zxTAuABT;
        "pkg-1.0.0-neoforge" = _iJdZvIhA;
        "pkg-1.0.0-quilt" = _i6DmQ5rp;
        "pkg-1.0.0-neoforge-1.21plus" = _mb8gX11Z;
        "pkg-1.0.0-quilt-1.21plus" = _i2ZzQIBG;
        "default" = _i2ZzQIBG;
    });
