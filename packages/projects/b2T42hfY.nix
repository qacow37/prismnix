...
let
    ...
    in {
        ...
        "pkg-1.1.6" = _soo7PMaM;
        "pkg-1.2.3" = _MIGrdLPm;
        "pkg-1.2.4-mc1.20.1" = _mI0xsiVL;
        "pkg-1.2.3-mc1.20" = _xAKwIBPH;
        "pkg-1.1.7-mc1.19.4" = _NVoGD0VU;
        "pkg-1.1.7-mc1.19.3" = _XLEBdy9e;
        "pkg-1.1.7-mc1.19.2" = _sqLicTdO;
        "pkg-1.3.0-mc1.20.2" = _yudwRwwZ;
        "pkg-1.3.0-mc1.20.1" = _Oc2Z9RU7;
        "pkg-1.3.0-mc1.20" = _CTPFomLZ;
        "pkg-1.3.0-mc1.19.4" = _fL8yqgZb;
        "pkg-1.3.0-mc1.19.3" = _qnKDK1oj;
        "pkg-1.3.0-mc1.19.2" = _ZGh1z4lK;
        "pkg-1.3.1" = _5YesHMXJ;
        "pkg-1.3.0" = _RoTVjipd;
        "pkg-1.4.0-forge" = _WUpUROO7;
        "pkg-1.4.0-fabric" = _tVQTr18q;
        "pkg-1.4.3-fabric" = _rnJok9Ed;
        "pkg-1.4.3-forge" = _4s3Il90S;
        "pkg-1.4.4-fabric" = _YQJlWzJG;
        "pkg-1.4.4-forge" = _nS0mn34X;
        "pkg-1.4.5-fabric" = _YjPjC4kl;
        "pkg-1.4.5-forge" = _fSbYHkvs;
        "pkg-1.5.0-fabric" = _75irfu4k;
        "pkg-1.5.0-forge" = _txrrEhwT;
        "pkg-1.5.0-neoforge" = _VMUizaei;
        "pkg-1.5.1-fabric" = _7WzdpK4h;
        "pkg-1.5.1-forge" = _AGHLKVBx;
        "pkg-1.5.1-neoforge" = _zq8WHArv;
        "pkg-1.5.2-fabric" = _DXYzvBVL;
        "pkg-1.5.2-forge" = _pvfw3RKL;
        "pkg-1.6.0" = _rDqvSrbq;
        "pkg-1.6.1" = _h9SAvGRi;
        "pkg-1.6.2" = _JBKBcwO5;
        "pkg-1.6.3" = _rbN2zN7E;
