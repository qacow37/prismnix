...
let
    ...
    in {
        ...
        "pkg-fabric-mc116-2.1.128" = _4a3YTeKJ;
        "pkg-fabric-mc117-3.0.159" = _xjOGW7lU;
        "pkg-forge-mc117-3.0.159" = _7Rf9eJrb;
        "pkg-fabric-mc118-3.0.167" = _h4V2TBrx;
        "pkg-forge-mc118-3.0.167" = _szRURjTR;
        "pkg-fabric-mc118-3.0.171" = _gJ8x41sb;
        "pkg-forge-mc118-3.0.171" = _9Qedcjvl;
        "pkg-fabric-mc117-3.0.161" = _txgi9YFM;
        "pkg-forge-mc117-3.0.161" = _SRXL2sE0;
        "pkg-fabric-mc118-3.0.173" = _Fr0Fsndz;
        "pkg-forge-mc118-3.0.173" = _5gdXNZKf;
        "pkg-fabric-mc118-3.0.175" = _FQbyfbAv;
        "pkg-forge-mc118-3.0.175" = _e3v5IF4g;
        "pkg-fabric-mc118-3.0.178" = _edVk62Nq;
        "pkg-forge-mc118-3.0.178" = _bL2D2nye;
        "pkg-fabric-mc119-3.0.179" = _dj6Noj1f;
        "pkg-fabric-mc119-3.0.181" = _RzfE2bDd;
        "pkg-forge-mc119-3.0.181" = _SXbWFTAk;
        "pkg-fabric-mc119-3.0.183" = _LaDkNcUy;
        "pkg-forge-mc119-3.0.183" = _4Z4A6Lc1;
        "pkg-fabric-mc119-3.0.186" = _Vk2LTA2d;
        "pkg-forge-mc119-3.0.186" = _IfDAucef;
        "default" = _IfDAucef;
    });
