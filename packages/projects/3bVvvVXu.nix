...
let
    ...
    in {
        ...
        "pkg-v0.1.3-mc1.14.4" = _sMDyIWOr;
        "pkg-v0.1.3-mc1.18.2" = _69PqlGd1;
        "pkg-v0.1.3-mc1.19.3" = _MNNn4d9d;
        "pkg-v0.1.3-mc1.20.4" = _T2IDI5eq;
        "pkg-v0.1.3-mc1.20.1" = _9B4Jtgtp;
        "pkg-v0.1.3-mc1.20.2" = _3jw4CFnO;
        "pkg-v0.1.3-mc1.19.4" = _sI2RsWb7;
        "pkg-v0.1.3-mc1.20.6" = _4JOTJgro;
        "pkg-v0.1.3-mc1.21.5" = _TtZkwW83;
        "pkg-v0.1.3-mc1.21.10" = _O0jWKXGT;
        "pkg-v0.1.3-mc1.21.3" = _CdmQzyTD;
        "pkg-v0.1.3-mc1.21.11" = _GK5DEquk;
        "pkg-v0.1.3-mc1.19.2" = _DVRQfycB;
        "pkg-v0.1.3-mc1.16.5" = _f54bODUC;
        "pkg-v0.1.3-mc1.21.4" = _oolZR8Hr;
        "pkg-v0.1.3-mc1.21.1" = _zxXAOixt;
        "pkg-v0.1.3-mc1.21.8" = _Jbss7vl6;
        "pkg-v0.1.4-mc1.16.5" = _qbgSbiHN;
        "pkg-v0.1.4-mc1.21.3" = _9edmLRK1;
        "pkg-v0.1.4-mc1.20.6" = _Qmo50dMr;
        "pkg-v0.1.4-mc1.21.4" = _y07EW5a5;
        "pkg-v0.1.4-mc1.19.3" = _x5lKU9sf;
        "pkg-v0.1.4-mc1.17.1" = _7eJtzqSB;
        "pkg-v0.1.4-mc1.15.2" = _6ocEYIUJ;
        "pkg-v0.1.4-mc1.20.4" = _3TU54jZY;
        "pkg-v0.1.4-mc1.18.2" = _DfH27YIW;
        "pkg-v0.1.4-mc1.20.1" = _hV4Jy3Ot;
        "pkg-v0.1.4-mc1.21.11" = _wEwvhJce;
        "pkg-v0.1.4-mc1.21.5" = _8IP26gxv;
        "pkg-v0.1.4-mc1.19.4" = _ZdqmgQHM;
        "pkg-v0.1.4-mc1.21.8" = _ephs5SdG;
        "pkg-v0.1.4-mc1.14.4" = _3byWjVxQ;
        "pkg-v0.1.4-mc1.19.2" = _IX6KTRor;
        "pkg-v0.1.4-mc1.21.1" = _uPuAnPPY;
        "pkg-v0.1.4-mc1.21.10" = _exEfqav6;
        "pkg-v0.1.4-mc1.20.2" = _gUIXQCmm;
        "pkg-v0.1.5-mc1.19.4" = _KErwK0fo;
        "pkg-v0.1.5-mc1.20.2" = _7d4RIXxn;
        "pkg-v0.1.5-mc1.21.8" = _w02xwelv;
        "pkg-v0.1.5-mc1.16.5" = _r5u0Hovl;
        "pkg-v0.1.5-mc1.20.4" = _Ll201n1q;
        "pkg-v0.1.5-mc1.20.6" = _erUMl02Z;
        "pkg-v0.1.5-mc1.19.2" = _DIlejBDV;
        "pkg-v0.1.5-mc1.21.4" = _awGGXudm;
        "pkg-v0.1.5-mc1.15.2" = _FMuZLZEP;
        "pkg-v0.1.5-mc1.19.3" = _Geg1m7Qr;
        "pkg-v0.1.5-mc1.21.10" = _VKgSupvB;
        "pkg-v0.1.5-mc1.21.5" = _nDC3PNS4;
        "pkg-v0.1.5-mc1.21.3" = _Avia0YTA;
        "pkg-v0.1.5-mc1.20.1" = _U4rAZ8kw;
        "pkg-v0.1.5-mc1.17.1" = _28hdvhYA;
        "pkg-v0.1.5-mc1.18.2" = _5EYtWn5k;
        "pkg-v0.1.5-mc1.14.4" = _m3uQgGGc;
        "pkg-v0.1.5-mc1.21.1" = _vgWQLicG;
        "pkg-v0.1.5-mc1.21.11" = _tXYcZXho;
        "pkg-v0.1.6-mc1.21.11" = _APxF9VZr;
        "pkg-v0.1.6-mc1.21.3" = _FncvkayU;
        "pkg-v0.1.6-mc1.15.2" = _ZRsMGjmk;
        "pkg-v0.1.6-mc1.16.5" = _ryfd9Xm5;
        "pkg-v0.1.6-mc1.20.4" = _H1PXmUr9;
        "pkg-v0.1.6-mc1.19.4" = _Ochw6Hfb;
        "pkg-v0.1.6-mc1.18.2" = _gdqTBb2I;
        "pkg-v0.1.6-mc1.20.6" = _aGlgJcTA;
        "pkg-v0.1.6-mc1.17.1" = _pq0jobe8;
        "pkg-v0.1.6-mc1.21.1" = _Yl9ryADu;
        "pkg-v0.1.6-mc1.20.2" = _hSf1RFtH;
        "pkg-v0.1.6-mc1.21.5" = _yoZEZm8P;
        "pkg-v0.1.6-mc1.19.3" = _keWJsdsN;
        "pkg-v0.1.6-mc1.21.8" = _Mgk2yPZl;
        "pkg-v0.1.6-mc1.21.10" = _QxId1gFp;
        "pkg-v0.1.6-mc1.19.2" = _6ATZv7BR;
        "pkg-v0.1.6-mc1.21.4" = _H5vgqisx;
        "pkg-v0.1.6-mc1.20.1" = _a8bQVfvp;
        "pkg-v0.1.6-mc1.14.4" = _UodpJjGo;
        "pkg-v0.1.7-mc1.21.1" = _Ud1wROoP;
        "pkg-v0.1.7-mc1.19.2" = _DQh5tvLP;
        "pkg-v0.1.7-mc1.21.11" = _ZF2F74ew;
        "pkg-v0.1.7-mc1.21.4" = _fgH1T2Lq;
        "pkg-v0.1.7-mc1.20.2" = _zZiTAIrR;
        "pkg-v0.1.7-mc1.20.4" = _oyPGYDfL;
        "pkg-v0.1.7-mc1.21.3" = _sWotyNJt;
        "pkg-v0.1.7-mc1.18.2" = _fsDu8jsv;
        "pkg-v0.1.7-mc1.20.6" = _EamWlNCu;
        "pkg-v0.1.7-mc1.19.4" = _6ui9SVmY;
        "pkg-v0.1.7-mc1.20.1" = _M4HuP9mx;
        "pkg-v0.1.7-mc1.21.10" = _F8Vrlqq6;
        "pkg-v0.1.7-mc1.21.5" = _fgezVy8E;
        "pkg-v0.1.7-mc1.19.3" = _DkuVIu1C;
        "pkg-v0.1.7-mc1.17.1" = _anAtqO02;
        "pkg-v0.1.7-mc1.16.5" = _SPUe25wV;
        "pkg-v0.1.7-mc1.15.2" = _sbbydnw4;
        "pkg-v0.1.7-mc1.21.8" = _f5IyDORu;
        "pkg-v0.1.7-mc1.14.4" = _IbGfyHHt;
        "pkg-v0.1.8-mc1.16.5" = _3oKV9drr;
        "pkg-v0.1.8-mc1.14.4" = _hBvOJDpq;
        "pkg-v0.1.8-mc1.15.2" = _fjnXLHXB;
        "pkg-v0.1.8-mc1.17.1" = _hNXPJIMa;
        "pkg-v0.1.8-mc1.19.2" = _7vBksIbt;
        "pkg-v0.1.8-mc1.19.4" = _WQbcSUlZ;
        "pkg-v0.1.8-mc1.18.2" = _zA8QjtSs;
        "pkg-v0.1.8-mc1.19.3" = _DjmeGk5R;
        "pkg-v0.1.8-mc1.20.1" = _DqnUGceG;
        "pkg-v0.1.8-mc1.20.4" = _R010QGvW;
        "pkg-v0.1.8-mc1.20.2" = _zy398719;
        "pkg-v0.1.8-mc1.21.1" = _5SRQsgJ0;
        "pkg-v0.1.8-mc1.20.6" = _Cll3IXdL;
        "pkg-v0.1.8-mc1.21.3" = _JJIHwG9J;
        "pkg-v0.1.8-mc1.21.4" = _kALGUy0e;
        "pkg-v0.1.8-mc1.21.5" = _5BZjAyJ9;
        "pkg-v0.1.8-mc1.21.8" = _et105s8o;
        "pkg-v0.1.8-mc1.21.10" = _TfkFOgla;
        "pkg-v0.1.8-mc1.21.11" = _e2BtLMzp;
        "pkg-v0.1.8-mc26.1" = _RsFKL3Td;
        "pkg-v0.1.9-mc1.17.1" = _ff4sUpox;
        "pkg-v0.1.9-mc1.14.4" = _NIrT3bmR;
        "pkg-v0.1.9-mc1.15.2" = _qAILcDKk;
        "pkg-v0.1.9-mc1.16.5" = _XLZAUTH7;
        "pkg-v0.1.9-mc1.19.3" = _VOjTj66w;
        "pkg-v0.1.9-mc1.18.2" = _ZjeNRasD;
        "pkg-v0.1.9-mc1.19.2" = _enxW5OTt;
        "pkg-v0.1.9-mc1.19.4" = _GnoAtIXJ;
        "pkg-v0.1.9-mc1.20.4" = _LH87wf77;
        "pkg-v0.1.9-mc1.20.1" = _zmjXO9Jh;
        "pkg-v0.1.9-mc1.20.2" = _Ymm0laEM;
        "pkg-v0.1.9-mc1.20.6" = _hkPw1U1H;
        "pkg-v0.1.9-mc1.21.3" = _etgLV232;
        "pkg-v0.1.9-mc1.21.1" = _zHi82TQ0;
        "pkg-v0.1.9-mc1.21.5" = _MLebdRBc;
        "pkg-v0.1.9-mc1.21.4" = _YdX3jIWL;
        "pkg-v0.1.9-mc1.21.8" = _xSOUyzms;
        "pkg-v0.1.9-mc1.21.11" = _wt14u8L5;
        "pkg-v0.1.9-mc1.21.10" = _ioAs8GrD;
        "pkg-v0.1.9-mc26.1.1" = _rBMc6uDq;
        "pkg-v0.1.10-mc1.16.5" = _TgB7tClX;
        "pkg-v0.1.10-mc1.15.2" = _ULftZSWi;
        "pkg-v0.1.10-mc1.14.4" = _ux73arOw;
        "pkg-v0.1.10-mc1.17.1" = _ZdiMvNyB;
        "pkg-v0.1.10-mc1.18.2" = _PBY6YKXn;
        "pkg-v0.1.10-mc1.19.3" = _kl7z7zU3;
        "pkg-v0.1.10-mc1.19.4" = _xTK1ZPeP;
        "pkg-v0.1.10-mc1.20.1" = _jm1U6Qct;
        "pkg-v0.1.10-mc1.19.2" = _Nc5rmuPa;
        "pkg-v0.1.10-mc1.20.6" = _csuArnP1;
        "pkg-v0.1.10-mc1.20.2" = _Jb0JyAJs;
        "pkg-v0.1.10-mc1.21.1" = _yFffRRP3;
        "pkg-v0.1.10-mc1.20.4" = _KeCFxr0d;
        "pkg-v0.1.10-mc1.21.4" = _4s8bnXv0;
        "pkg-v0.1.10-mc1.21.3" = _xYIMjhwL;
        "pkg-v0.1.10-mc1.21.5" = _gX6rmc9h;
        "pkg-v0.1.10-mc1.21.8" = _F3QBApE0;
        "pkg-v0.1.10-mc1.21.10" = _w5m4SZjb;
