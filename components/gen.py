...
def create_version(mc, pkgs):
    def important_struct(name, uid, version):
        return f'{name}={{uid="{uid}";version="{version}";important=true;}};'
    def struct(name, uid, version):
        return f'{name}={{uid="{uid}";version="{version}";}};'
    ...
    str_game = important_struct("game", "net.minecraft", mc);
    ...
    str_neoforge = struct(
        ...
        "net.neoforged",
        neoforge
    ) if neoforge != None else ""

    str_liteloader = struct(
        "liteloader",
        "com.mumfrey.liteloader",
        liteloader
    ) if liteloader != None else ""
    ...
    return f'{{{str_game}{str_fabric}{str_quilt}{str_forge}{str_neoforge}{str_liteloader}}}'
